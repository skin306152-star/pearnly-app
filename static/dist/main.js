...
`))}</pre>
    ...
    `,s?f.querySelectorAll("[data-field]").forEach(c=>{c.addEventListener("input",onFieldEdit)}):f.querySelectorAll("[data-field]").forEach(c=>{c.setAttribute("readonly","readonly")}),document.getElementById("drawer-mask").classList.add("show"),document.getElementById("drawer").classList.add("show"),injectOcrPushButton(),typeof window.bindDrawerClient=="function"){const c=n._historyId||n.history_id||null;window.bindDrawerClient(c,n.client_id||null)}typeof window.fillCategoryDatalist=="function"&&window.fillCategoryDatalist(),setTimeout(()=>{const c=document.getElementById("drawer-cat-input");c&&!c.value&&!c.readOnly&&c.focus()},80)}function ra(e){return e?`<span class="wht-badge">${escapeHtml(e)}%</span>`:""}function be(e,n,a,o,s,i,r){const f=_results[_drawerIdx],l=f&&f.edits[e]!==void 0?f.edits[e]:a,d=f&&f.edits[e]!==void 0&&f.edits[e]!==a,c=escapeHtml(l??""),p=s?"":"readonly",u=o==="textarea"?`<textarea data-field="${e}" rows="2">${c}</textarea>`:`<input type="text" data-field="${e}" value="${c}">`;return`
    ...
    `,e.appendChild(n),document.getElementById("btn-save-history").addEventListener("click",ka),document.getElementById("btn-push-erp").addEventListener("click",wa)}async function ba(e){}async function wa(){showToast(t("erp-push-coming-soon")||"ERP 推送即将开放，敬请期待","info")}async function ka(){const e=_results[_drawerIdx];if(!e||!e._historyId)return;const n=JSON.parse(JSON.stringify(e.pages||[]));if(n.length>0){const o=n.findIndex(f=>!f.is_duplicate&&!f.is_copy),s=o>=0?o:0,i=n[s].fields||(n[s].fields={}),r={...e.edits};r.category_tag!==void 0&&(r.category=r.category_tag,delete r.category_tag),Object.assign(i,r)}const a=document.getElementById("btn-save-history");a&&(a.disabled=!0);try{if(!(await fetch(`/api/history/${encodeURIComponent(e._historyId)}`,{method:"PUT",headers:{Authorization:"Bearer "+token,"Content-Type":"application/json"},body:JSON.stringify({pages:n})})).ok)throw new Error("save failed");showAlert("info",t("history-save-ok")),setTimeout(hideAlerts,1500),closeDrawer(),e._historyMode&&_results.pop(),loadHistoryPage()}catch{showAlert("error",t("history-save-fail")),a&&(a.disabled=!1)}}function _a(e,n){document.querySelectorAll(".history-popover").forEach(d=>d.remove());const a=n.getBoundingClientRect(),o=(_historyState.items||[]).find(d=>d.id===e),s=o&&o.invoice_no?String(o.invoice_no):"",i=o&&o.has_pdf===!0,r=document.createElement("div");r.className="history-popover",r.innerHTML=`
...
`)}function w(){const G=Date.now();fetch("/api/health").then(function(W){const te=Date.now()-G;W.ok?u(f("tc-toast-health-ok","后端健康 ✓ {ms}ms",{ms:te}),"success"):u(f("tc-toast-health-fail","后端无响应")+" ("+W.status+")","error")}).catch(function(){u(f("tc-toast-health-fail","后端无响应"),"error")})}function L(){try{localStorage.removeItem(n),localStorage.removeItem("pearnly_current_client_id"),o={},(window._pearnlyTcLogs||[]).length=0,s="all",window.setCurrentClientId}catch{}j(),u(f("tc-toast-cleared","session 状态已清空"),"success")}function C(){try{fetch("/api/clients",{headers:{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||"")}}).then(function(G){return G.json()}).then(function(G){window._clientsCache=G.clients||[],typeof window._refreshClientSwitcher=="function"&&window._refreshClientSwitcher(),typeof window._refreshExcClientFilter=="function"&&window._refreshExcClientFilter(),u("客户缓存已刷新 · "+(G.clients||[]).length+" 个客户","success")}).catch(function(){u("刷新失败","error")})}catch{}}function D(){if(i||!document.getElementById("page-test-center"))return;i=!0;const W=document.getElementById("tc-checklist-body");W&&W.addEventListener("click",function(le){const ie=le.target.closest(".tc-status-btn");if(!ie)return;const V=ie.getAttribute("data-id"),Q=ie.getAttribute("data-kind");!V||!Q||(o[V]===Q?delete o[V]:o[V]=Q,d(),I(),M())});const te=document.getElementById("tc-btn-reset-checklist");te&&te.addEventListener("click",function(){o={},d(),I(),M()});const re=document.getElementById("tc-btn-copy-all");re&&re.addEventListener("click",function(){m(k())});const H=document.getElementById("tc-btn-copy-logs");H&&H.addEventListener("click",function(){m(h())});const E=document.getElementById("tc-btn-clear-logs");E&&E.addEventListener("click",function(){(window._pearnlyTcLogs||[]).length=0,$(),F()});const g=document.getElementById("tc-logs-filter");g&&g.addEventListener("click",function(le){const ie=le.target.closest(".tc-filter-chip");ie&&(s=ie.getAttribute("data-filter")||"all",$())});const q=document.getElementById("tc-logs-body");q&&q.addEventListener("click",function(le){const ie=le.target.closest(".tc-log-item");ie&&ie.classList.toggle("expanded")});const N=document.getElementById("tc-tool-health");N&&N.addEventListener("click",w);const K=document.getElementById("tc-tool-clear-session");K&&K.addEventListener("click",L);const Z=document.getElementById("tc-tool-reload-clients");Z&&Z.addEventListener("click",C)}function B(){}window._tcApplyVisibility=B;let P=0;const J=setInterval(function(){P++,_userInfo&&clearInterval(J),P>60&&clearInterval(J)},500);window.loadTestCenterPage=function(){l(),D(),j()},typeof window.subscribeI18n=="function"&&window.subscribeI18n("test-center",function(){F(),currentRoute==="test-center"&&document.getElementById("page-test-center")&&document.getElementById("page-test-center").classList.contains("active")&&j()})})();(function(){const e="pearnly_active_workspace_client_id",n="pearnly_work_mode";function a(y,$){if(typeof window.t=="function"){const S=window.t(y);if(S&&S!==y)return S}return $}function o(){const y=window._userInfo||{},$=String(y.role||"").toLowerCase(),S=String(y.tenant_role||"").toLowerCase();return y.is_super_admin===!0||y.is_owner===!0||$==="owner"||$==="admin"||S==="owner"||S==="admin"}function s(){return localStorage.getItem(n)==="client"?"client":"personal"}function i(){const y=localStorage.getItem(e);if(!y||y==="null"||y==="0"||y==="")return null;const $=parseInt(y,10);return isNaN($)?null:$}function r(y){try{window.dispatchEvent(new CustomEvent("pearnly:workspace-changed",{detail:{id:y,mode:s()}}))}catch{}}function f(y){const $=i();y==null||y===0?localStorage.removeItem(e):(localStorage.setItem(e,String(y)),localStorage.setItem(n,"client")),String($)!==String(y)&&r(y)}function l(){const y=i();localStorage.setItem(n,"personal"),localStorage.removeItem(e),y!=null&&r(null)}async function d(){try{const y=window.apiGet;if(typeof y!="function")return[];const $=await y("/api/workspace/clients");return $&&($.clients||$.items)||[]}catch{return[]}}async function c(y){if(s()==="client"&&i()!=null)return typeof y=="function"&&y(),!0;const $=a("ws-need-client","这个功能需要先选择工作空间"),S=a("ws-btn-pick","选择工作空间"),F=a("ws-btn-cancel","取消");return typeof window.showConfirm=="function"?await window.showConfirm($,{okText:S,cancelText:F})&&p(y):window.confirm($+`

[`+S+" / "+F+"]")&&p(y),!1}async function p(y){const $=await d();if(typeof y=="function"&&s()!=="personal"&&$.length===1){f(Number($[0].id)),y();return}if(typeof window.openWorkspaceChooserUI=="function"){window.openWorkspaceChooserUI({clients:$,canCreate:o(),active:i(),onPersonal:l,onPick:function(S){f(Number(S)),typeof y=="function"&&y()},emptyHint:$.length?null:o()?a("ws-empty-owner","还没有工作空间。创建一个公司后,上传、对账和 ERP 推送都会归属到该公司。"):a("ws-empty-employee","你还没有可用的工作空间,请联系管理员分配。")});return}if(!$.length){const S=o()?a("ws-empty-owner","还没有工作空间。创建一个公司后,上传、对账和 ERP 推送都会归属到该公司。"):a("ws-empty-employee","你还没有可用的工作空间,请联系管理员分配。");typeof window.showToast=="function"&&window.showToast(S,"info")}}function u(y){const $=y||document.getElementById("workspace-switcher-root");if(!$)return;const S=s(),F=i();let j,k;if(S==="client"&&F!=null){const L=(window._workspaceClientsCache||[]).find(C=>Number(C.id)===Number(F));j=b("building"),k=L?L.name:a("ws-current-label","当前工作空间")}else j=b("user"),k=a("ws-personal","个人事务");$.innerHTML='<button class="ws-ctrl-btn" id="ws-ctrl-btn" type="button">'+j+'<span class="ws-ctrl-label">'+m(k)+"</span></button>";const h=$.querySelector("#ws-ctrl-btn");h&&h.addEventListener("click",()=>p(null))}function m(y){return String(y??"").replace(/[&<>"']/g,function($){return{"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"}[$]})}function b(y){const $='<svg class="ws-ic" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">';return y==="building"?$+'<rect x="2" y="7" width="20" height="14" rx="2"/><path d="M16 21V5a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v16"/></svg>':$+'<path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/></svg>'}function M(y){y=y||{};const $=y.clients||[],S=y.active,F=document.getElementById("ws-modal");F&&F.remove();const j=document.createElement("div");j.id="ws-modal",j.className="ws-modal";const h='<button type="button" class="ws-modal-item'+(s()==="personal"||S==null?" active":"")+'" data-ws-personal="1"><span class="ws-modal-item-ic">'+b("user")+'</span><span class="ws-modal-item-text" style="display:flex;flex-direction:column;align-items:flex-start;min-width:0;"><span class="ws-modal-item-name">'+m(a("ws-personal","个人事务"))+'</span><span class="ws-modal-item-desc" style="font-size:11px;color:#6b7280;font-weight:400;margin-top:2px;line-height:1.35;white-space:normal;">'+m(a("ws-personal-desc","用于临时识别、测试或处理不归属任何公司的文件。"))+"</span></span></button>";let w="";if($.length){const P=['<option value="">'+m(a("ws-select-ph","— 选择账套主体 —"))+"</option>"].concat($.map(function(J){const G=S!=null&&Number(S)===Number(J.id);return'<option value="'+m(J.id)+'"'+(G?" selected":"")+">"+m(J.name||"#"+J.id)+"</option>"}));w='<div class="ws-modal-select-row"><label class="ws-modal-select-label">'+m(a("ws-select-label","账套主体"))+'</label><select class="ws-modal-select" data-ws-select="1">'+P.join("")+"</select></div>"}const L=!$.length&&y.emptyHint?'<div class="ws-modal-empty">'+m(y.emptyHint)+"</div>":"",C=y.canCreate?'<div class="ws-modal-create"><button type="button" class="ws-modal-create-toggle" data-ws-create-toggle="1">+ '+m(a("ws-create-client","新建工作空间"))+'</button><div class="ws-modal-create-form" data-ws-create-form style="display:none;"><input type="text" class="ws-modal-create-input" data-ws-create-name placeholder="'+m(a("ws-create-ph","公司名称,例如 BAKELAB"))+'"><button type="button" class="ws-modal-create-submit" data-ws-create-submit="1">'+m(a("ws-create-submit","创建"))+"</button></div></div>":"";j.innerHTML='<div class="ws-modal-box" role="dialog" aria-modal="true"><div class="ws-modal-head"><span class="ws-modal-title">'+m(a("ws-chooser-title","选择工作空间"))+'</span><button type="button" class="ws-modal-close" data-ws-close="1" aria-label="close">✕</button></div><div class="ws-modal-subtitle" style="font-size:12px;color:#6b7280;padding:2px 4px 12px;line-height:1.45;white-space:normal;">'+m(a("ws-chooser-subtitle","账套主体 = 你的公司(发票卖方/开票方)。选择正在为哪家公司做账。"))+'</div><div class="ws-modal-list">'+h+w+"</div>"+L+C+"</div>",document.body.appendChild(j);const D=j.querySelector("[data-ws-select]");D&&D.addEventListener("change",function(){const P=D.value;P&&(typeof y.onPick=="function"&&y.onPick(P),B(),u())});function B(){j.remove()}j.addEventListener("click",function(P){if(P.target===j||P.target.closest("[data-ws-close]")){B();return}if(P.target.closest("[data-ws-personal]")){typeof y.onPersonal=="function"&&y.onPersonal(),B(),u();return}const G=P.target.closest("[data-ws-pick]");if(G){const re=G.getAttribute("data-ws-pick");typeof y.onPick=="function"&&y.onPick(re),B(),u();return}if(P.target.closest("[data-ws-create-toggle]")){const re=j.querySelector("[data-ws-create-form]");if(re){re.style.display=re.style.display==="none"?"flex":"none";const H=re.querySelector("[data-ws-create-name]");H&&H.focus()}return}if(P.target.closest("[data-ws-create-submit]")){I(j,y,B);return}})}async function I(y,$,S){const F=y.querySelector("[data-ws-create-name]"),j=F?(F.value||"").trim():"";if(!j){F&&F.focus();return}let k=null;try{if(typeof window.apiPost=="function"){const w=await window.apiPost("/api/workspace/clients",{name:j});k=w&&typeof w.json=="function"?await w.json().catch(()=>null):w}}catch{k=null}const h=k&&(k.id||k.client&&k.client.id);if(!h){typeof window.showToast=="function"&&window.showToast(a("ws-create-fail","新建工作空间失败 · 请重试"),"error");return}window._workspaceClientsCache=await d(),f(Number(h)),$.onPick,S(),u()}window.openWorkspaceChooserUI=M,window.addEventListener("pearnly:workspace-changed",function(){u()}),window.getWorkMode=s,window.getActiveWorkspaceClientId=i,window.setActiveWorkspaceClientId=f,window.enterPersonalMode=l,window.requireWorkspace=c,window.openWorkspaceChooser=p,window.renderWorkspaceControl=u,window.fetchWorkspaceClients=d;function x(){try{if(sessionStorage.getItem("pearnly_ws_login_prompted")==="1"||i()!=null||localStorage.getItem(n)==="personal")return;sessionStorage.setItem("pearnly_ws_login_prompted","1"),setTimeout(function(){p(null)},800)}catch{}}d().then(y=>{window._workspaceClientsCache=y,u(),x()}),typeof window.subscribeI18n=="function"&&window.subscribeI18n("workspace-switcher",u)})();(function(){const e=S=>document.querySelector('[data-num-target="'+S+'"]');function n(S){if(!S)return t("reconcile-last-activity-none");try{const F=new Date(S),j=new Date,k=j-F;if(k/6e4<5)return t("reconcile-last-activity-just-now");if(F.toDateString()===j.toDateString())return t("reconcile-last-activity-today");const w=Math.max(1,Math.floor(k/(24*3600*1e3)));return t("reconcile-last-activity-days-ago").replace("{n}",w)}catch{return t("reconcile-last-activity-none")}}function a(S,F,j){const k=e(S);k&&(k.textContent=j?"-":String(F),k.classList.toggle("is-empty",!!j))}function o(S){const F=document.getElementById("reconcile-error");F&&(F.style.display=S?"flex":"none")}function s(S){const F=document.getElementById("reconcile-empty");F&&(F.style.display=S?"flex":"none")}function i(S,F){const j=document.getElementById("reconcile-last-activity");j&&(j.textContent=S,j.classList.toggle("has-data",!!F))}function r(S){const F=!S||(S.total_sessions||0)===0;a("pending",S.pending||0,F),a("matched",S.matched||0,F),a("unmatched",S.unmatched||0,F),i(n(S.last_activity_at),!!S.last_activity_at),o(!1),s(F)}function f(S){const F=S.toUpperCase();return F==="KBANK"?"bank-chip-kbank":F==="SCB"?"bank-chip-scb":F==="BBL"?"bank-chip-bbl":F==="KTB"?"bank-chip-ktb":F==="TTB"?"bank-chip-ttb":"bank-chip-other"}function l(S,F){const j=k=>k?String(k).slice(0,10):"?";return!S&&!F?"":j(S)+" ~ "+j(F)}function d(S){return S==null?"":String(S).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function c(S){const F=document.getElementById("reconcile-recent"),j=document.getElementById("reconcile-recent-list");if(!F||!j)return;const k=(S||[]).slice(0,20);if(k.length===0){F.style.display="none";return}F.style.display="",s(!1),j.innerHTML=k.map(h=>{const w=h.parse_status==="parse_failed",L=h.bank_code||"OTHER",C=h.account_last4?" ···"+d(h.account_last4):"",D=l(h.period_start,h.period_end),B=d(h.source_filename||""),P=Number(h.tx_count||0),J=w?'<span class="recon-card-fail" data-i18n="reconcile-card-parse-failed">'+t("reconcile-card-parse-failed")+"</span>":'<span class="recon-card-tx">'+t("reconcile-card-tx").replace("{n}",P)+"</span>";return'<div class="recon-card" data-session-id="'+d(h.id)+'" data-session-name="'+B+'"><span class="bank-chip '+f(L)+'">'+d(L)+'</span><div class="recon-card-main"><div class="recon-card-title">'+B+C+'</div><div class="recon-card-sub">'+d(D)+'</div></div><div class="recon-card-right">'+J+'</div><button class="recon-card-trash" data-trash="'+d(h.id)+'" title="'+d(t("bank-session-delete-tip")||"删除")+'"><svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"><path d="M3 5h10M6 5V3h4v2M5 5l1 9h4l1-9"/></svg></button><svg class="recon-card-arrow" viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M6 4l4 4-4 4"/></svg></div>'}).join(""),j.querySelectorAll(".recon-card").forEach(h=>{h.addEventListener("click",w=>{w.target.closest(".recon-card-trash")||(h.dataset.sessionId,p())})}),j.querySelectorAll(".recon-card-trash").forEach(h=>{h.addEventListener("click",w=>{w.stopPropagation();const L=h.dataset.trash,C=h.closest(".recon-card"),D=C&&C.dataset.sessionName||"";typeof window._deleteBankSession=="function"&&window._deleteBankSession(L,D)})})}function p(S){typeof window.routeTo=="function"&&window.routeTo("reconcile"),setTimeout(function(){const F=document.querySelector('[data-recon-tab="bank"]');F&&F.click()},150)}function u(){o(!0),s(!1)}function m(){typeof window.routeTo=="function"&&window.routeTo("reconcile"),setTimeout(function(){const S=document.querySelector('[data-recon-tab="bank"]');S&&S.click()},150)}async function b(){a("pending",0,!0),a("matched",0,!0),a("unmatched",0,!0),i("",!1),o(!1),s(!1);const S=document.getElementById("reconcile-recent");S&&(S.style.display="none");const F={Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||"")};try{const[j,k]=await Promise.all([fetch("/api/bank-recon/stats",{headers:F}),fetch("/api/bank-recon/sessions?limit=20",{headers:F})]);if(!j.ok)throw new Error("http "+j.status);const h=await j.json(),w=k.ok?await k.json():[];r(h||{}),c(w||[])}catch(j){console.warn("[reconcile] load failed",j),u()}}function M(S){if(!S||!S.length)return;const F="Bearer "+(localStorage.getItem("mrpilot_token")||"");let j=0;const k=S.length;Array.from(S).forEach(function(h){const w=new FormData;w.append("file",h,h.name);const L=new XMLHttpRequest;L.open("POST","/api/bank-recon/upload"),L.setRequestHeader("Authorization",F),L.onload=function(){j++;try{const C=JSON.parse(L.responseText);L.status===200&&C.tx_count!==void 0?showToast((t("bank-upload-ok")||"解析成功 · 共 {n} 条流水").replace("{n}",C.tx_count),"success"):showToast(h.name+" "+(t("upload-failed")||"上传失败"),"error")}catch{showToast(h.name+" "+(t("upload-failed")||"上传失败"),"error")}j===k&&setTimeout(b,600)},L.onerror=function(){j++,showToast(h.name+" "+(t("upload-failed")||"上传失败"),"error"),j===k&&setTimeout(b,600)},L.send(w)}),showToast((t("bank-queue-status-uploading")||"上传中")+"…","info")}function I(){if(window.__reconcileBound)return;window.__reconcileBound=!0;const S=document.getElementById("reconcile-bank-file-input");S&&S.addEventListener("change",function(){M(this.files),this.value=""}),document.addEventListener("click",F=>{if(F.target.closest("#btn-reconcile-upload-top")||F.target.closest("#btn-reconcile-upload-empty")){m();return}if(F.target.closest("#btn-reconcile-retry")){b();return}if(F.target.closest("#btn-reconcile-dev-seed")){$();return}})}const x=["468b50c1-5593-4fd6-990d-515ce8085563"];function y(){const S=document.getElementById("btn-reconcile-dev-seed");if(!S)return;const F=typeof _userInfo<"u"?_userInfo:null,j=F&&F.id&&x.indexOf(String(F.id))>=0;S.style.display=j?"":"none"}async function $(){try{const S=await fetch("/api/bank-recon/_dev/seed",{method:"POST",headers:{Authorization:"Bearer "+token}});if(!S.ok)throw new Error("seed:"+S.status);const F=await S.json(),j=(t("reconcile-dev-seed-ok")||"").replace("{n}",F.tx_count||0);showToast(j,"success"),typeof window.navigateTo=="function"?window.navigateTo("automation"):location.hash="#/automation",setTimeout(()=>{const k=document.querySelector('[data-auto-tab="bank"]');k&&k.click(),F.session_id&&typeof window._openBankSession=="function"&&window._openBankSession(F.session_id)},300)}catch(S){console.warn("[reconcile] dev seed failed",S),showToast(t("reconcile-dev-seed-fail")||"Seed failed","error")}}window.loadReconcilePage=async function(){I(),y(),typeof window._bankReconV2Init=="function"&&window._bankReconV2Init();try{await b()}catch{}},window._rerenderReconcile=function(){typeof currentRoute=="string"&&currentRoute==="reconcile"&&b().catch(()=>{})},typeof window.subscribeI18n=="function"&&window.subscribeI18n("reconcile",window._rerenderReconcile)})();(function(){const e=document.getElementById("assign-clients-modal");if(!(!e||e.dataset.wbInjected==="1")){e.innerHTML=`
    <div class="modal" style="max-width:480px">
        ...
        <div class="modal-foot">
    ...
    </div>`,e.dataset.wbInjected="1";try{const n=window._currentLang||localStorage.getItem("mrpilot_lang")||"th",a=window.I18N;a&&a[n]&&e.querySelectorAll("[data-i18n]").forEach(o=>{const s=o.getAttribute("data-i18n");a[n][s]&&(o.textContent=a[n][s])})}catch{}}})();(function(){let e={employeeId:null,employeeName:"",clients:[],selected:new Set,opened:!1};function n(){return document.getElementById("assign-clients-modal")}function a(){return document.getElementById("assign-clients-list")}function o(){return document.getElementById("assign-select-all")}function s(){return document.getElementById("assign-selected-count")}function i(){return document.getElementById("assign-modal-target")}function r(){const b=a();if(b){if(!e.clients.length){b.innerHTML='<div class="assign-empty">'+escapeHtml(t("assign-no-clients")||"暂无客户 · 请先到「客户管理」添加")+"</div>";return}b.innerHTML=e.clients.map(M=>{const I=String(M.id),x=e.selected.has(I)?"checked":"",y=escapeHtml(M.name||M.label||"#"+I),$=M.code?'<span class="assign-row-code">'+escapeHtml(M.code)+"</span>":"";return'<label class="assign-row"><input type="checkbox" data-cid="'+escapeHtml(I)+'" '+x+'><span class="assign-row-name">'+y+"</span>"+$+"</label>"}).join(""),f()}}function f(){const b=s();if(b){const I=t("assign-selected-count")||"已选 {n} / {total}";b.textContent=I.replace("{n}",e.selected.size).replace("{total}",e.clients.length)}const M=o();M&&(M.checked=e.clients.length>0&&e.selected.size===e.clients.length)}function l(){const b=i();b&&(b.textContent=e.employeeName?" · "+e.employeeName:"")}async function d(b,M){e.employeeId=b,e.employeeName=M||"",e.opened=!0,e.selected=new Set,e.clients=[],l();const I=a();I&&(I.innerHTML='<div class="assign-empty">'+escapeHtml(t("assign-loading")||"加载中...")+"</div>");const x=n();x&&(x.style.display="flex");try{const[y,$]=await Promise.all([apiGet("/api/clients?include_inactive=false"),apiGet("/api/team/employees/"+encodeURIComponent(b)+"/assignments")]);e.clients=y&&y.clients||[];const S=$&&$.client_ids||[];e.selected=new Set(S.map(String)),r()}catch(y){console.error("[assign-clients] load failed",y);const $=a();$&&($.innerHTML='<div class="assign-empty">'+escapeHtml(t("assign-load-failed")||"加载失败 · 请重试")+"</div>")}}function c(){e.opened=!1;const b=n();b&&(b.style.display="none")}async function p(){if(!e.employeeId)return;const b=Array.from(e.selected).map(I=>parseInt(I,10)).filter(I=>!isNaN(I)),M=document.getElementById("assign-modal-save");M&&(M.disabled=!0);try{const I=await apiPost("/api/team/employees/"+encodeURIComponent(e.employeeId)+"/assignments",{client_ids:b});I&&I.ok!==!1?(showToast((t("assign-saved")||"已保存 {n} 个客户分配").replace("{n}",b.length),"success"),c(),typeof loadTeamList=="function"&&loadTeamList()):showToast(t("assign-save-failed")||"保存失败","error")}catch(I){console.error("[assign-clients] save failed",I),showToast(t("assign-save-failed")||"保存失败","error")}finally{M&&(M.disabled=!1)}}function u(){const b=n();if(!b||b.dataset.bound==="1")return;b.dataset.bound="1";const M=document.getElementById("assign-modal-close");M&&M.addEventListener("click",c);const I=document.getElementById("assign-modal-cancel");I&&I.addEventListener("click",c);const x=document.getElementById("assign-modal-save");x&&x.addEventListener("click",p),b.addEventListener("click",function(S){S.target===b&&c()});const y=o();y&&y.addEventListener("change",function(){y.checked?e.selected=new Set(e.clients.map(S=>String(S.id))):e.selected=new Set,r()});const $=a();$&&$.addEventListener("change",function(S){const F=S.target.closest('input[type="checkbox"][data-cid]');if(!F)return;const j=F.dataset.cid;F.checked?e.selected.add(j):e.selected.delete(j),f()})}function m(){e.opened&&(l(),r())}typeof window.subscribeI18n=="function"&&window.subscribeI18n("assign-clients-modal",m),window.openAssignClientsModal=function(b,M){u(),d(b,M)}})();(function(){const e={page:1,per_page:50,q:"",total:0,rows:[],loaded:!1};function n(c){if(!c)return"";try{return new Date(c).toLocaleString()}catch{return c}}function a(c){const p=document.getElementById("access-log-table");p&&(p.innerHTML='<div class="access-log-empty">'+escapeHtml(c)+"</div>");const u=document.getElementById("access-log-pager");u&&(u.innerHTML="")}function o(){const c=document.getElementById("access-log-table");if(!c)return;const p=e.rows||[];if(!p.length){a(t("set-access-log-empty"));return}const u=`
            <div class="access-log-row access-log-head">
                ...
                </div>`}).join("");c.innerHTML=u+m}function s(){const c=document.getElementById("access-log-pager");if(!c)return;const p=e.total||0;if(!p){c.innerHTML="";return}const u=e.page||1,m=e.per_page,b=Math.max(1,Math.ceil(p/m)),M=(t("set-access-log-pager-total")||"Total {n}").replace("{n}",p),I=(t("set-access-log-pager-page")||"Page {p} / {t}").replace("{p}",u).replace("{t}",b);c.innerHTML=`
            ...
            </div>`}async function i(c){const p=localStorage.getItem("mrpilot_token");if(p){e.page=c||1,a(t("set-access-log-loading"));try{const u="/api/me/access_log?page="+e.page+"&per_page="+e.per_page+"&q="+encodeURIComponent(e.q||""),m=await fetch(u,{headers:{Authorization:"Bearer "+p}});if(m.status===403){a(t("set-access-log-empty"));return}if(!m.ok)throw new Error("http_"+m.status);const b=await m.json();e.rows=b.logs||[],e.total=b.total||0,e.loaded=!0,o(),s()}catch{a(t("set-access-log-fail"))}}}async function r(){const c=localStorage.getItem("mrpilot_token");if(c)try{const p="/api/me/access_log.csv?q="+encodeURIComponent(e.q||""),u=await fetch(p,{headers:{Authorization:"Bearer "+c}});if(!u.ok){showToast(t("set-access-log-csv-fail")||"Export failed","error");return}const m=await u.blob(),b=document.createElement("a"),M=URL.createObjectURL(m);b.href=M,b.download="pearnly_access_log.csv",document.body.appendChild(b),b.click(),setTimeout(function(){URL.revokeObjectURL(M),b.remove()},100),showToast(t("set-access-log-csv-ok")||"Exported","success")}catch{showToast(t("set-access-log-csv-fail")||"Export failed","error")}}function f(){const c=document.querySelectorAll(".set-tab-owner-only"),p=!!(_userInfo&&(_userInfo.role==="owner"||_userInfo.is_super_admin));c.forEach(function(u){u.style.display=p?"":"none"})}document.addEventListener("click",function(c){if(c.target.closest('.settings-tab[data-tab="access-log"]')){setTimeout(function(){(!e.loaded||e.page!==1)&&i(1)},50);return}if(c.target.closest("#access-log-csv-btn")){c.preventDefault(),r();return}const m=c.target.closest(".access-log-pager-btn[data-access-log-page]");if(m&&!m.disabled){const b=parseInt(m.dataset.accessLogPage,10);i(b)}}),document.addEventListener("input",function(c){c.target&&c.target.id==="access-log-search"&&(clearTimeout(window.__accessLogSearchTimer),window.__accessLogSearchTimer=setTimeout(function(){e.q=(c.target.value||"").trim(),i(1)},350))});let l=0;const d=setInterval(function(){l++,_userInfo&&(f(),clearInterval(d)),l>60&&clearInterval(d)},500);typeof window.subscribeI18n=="function"&&window.subscribeI18n("me-access-log",function(){f(),e.loaded&&(o(),s())})})();(function(){const e=document.getElementById("notif-new-modal");if(!(!e||e.dataset.wbInjected==="1")){e.innerHTML=`
...
`,e.dataset.wbInjected="1";try{const n=window._currentLang||localStorage.getItem("mrpilot_lang")||"th",a=window.I18N;a&&a[n]&&(e.querySelectorAll("[data-i18n]").forEach(o=>{const s=o.getAttribute("data-i18n");a[n][s]&&(o.textContent=a[n][s])}),e.querySelectorAll("[data-i18n-placeholder]").forEach(o=>{const s=o.getAttribute("data-i18n-placeholder");a[n][s]&&(o.placeholder=a[n][s])}))}catch{}}})();(function(){const e=j=>document.getElementById(j);async function n(j,k){return await fetch(j,{method:"PATCH",headers:{Authorization:"Bearer "+token,"Content-Type":"application/json"},body:JSON.stringify(k||{})})}async function a(j){return await fetch(j,{method:"DELETE",headers:{Authorization:"Bearer "+token}})}let o=null;async function s(){try{o=await apiGet("/api/line/binding")}catch{o={bound:!1}}return o}function i(j,k){if(!j)return;j.style.display="",j.className="notif-line-check "+(k?"bound":"unbound");const h=k?'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M20 6 9 17l-5-5"/></svg>':'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><path d="M12 8v4M12 16h.01"/></svg>';j.innerHTML=h+"<span>"+escapeHtml(t(k?"notif-line-bound":"notif-line-not-bound"))+"</span>"}function r(j){if(j==null)return"-";const k=Number(j);return isNaN(k)?String(j):"฿ "+k.toLocaleString("en-US",{minimumFractionDigits:2,maximumFractionDigits:2})}function f(j){if(!j)return"-";try{const k=new Date(j),h=(k.getMonth()+1).toString().padStart(2,"0"),w=k.getDate().toString().padStart(2,"0"),L=k.getHours().toString().padStart(2,"0"),C=k.getMinutes().toString().padStart(2,"0");return`${h}-${w} ${L}:${C}`}catch{return j}}function l(j){const k=e("notif-rules-list"),h=e("notif-rules-empty"),w=e("notif-rules-count");if(!(!k||!h)){if(w.textContent=String(j.length),w.className="auto-status-pill "+(j.length>0?"active":"none"),!j.length){h.style.display="",k.style.display="none",k.innerHTML="";return}h.style.display="none",k.style.display="",k.innerHTML=j.map(L=>{const C=L.template_code==="large_invoice",D=C?"notif-rule-large-tag":"notif-rule-exception-tag",B=C?"large":"";let P=[];if(C){const G=L.params&&L.params.threshold?r(L.params.threshold):"-";P.push(escapeHtml(t("notif-rule-threshold-prefix"))+" "+G)}L.enabled||P.push('<span style="color:#9ca3af;">'+escapeHtml(t("notif-rule-disabled"))+"</span>");const J=P.length?P.join(' <span class="dot"></span> '):"";return`
                ...
                </div>`}).join("")}}function d(j){const k=e("notif-logs-list");if(k){if(!j.length){k.innerHTML='<div class="notif-logs-empty">'+escapeHtml(t("notif-logs-empty"))+"</div>";return}k.innerHTML=j.map(h=>{const w=h.status==="sent",L=h.event_type==="exception_high"?"notif-event-exception-high":h.event_type==="large_invoice"?"notif-event-large-invoice":"notif-event-test-send",C=w?"":" · "+escapeHtml(h.error||"failed");return`
                ...
                </div>`}).join("")}}async function c(){try{const j=await apiGet("/api/notifications/rules");p=j&&j.items||[],l(p)}catch(j){console.warn("load rules fail",j)}try{const j=await apiGet("/api/notifications/logs?limit=20");u=j&&j.items||[],d(u)}catch(j){console.warn("load logs fail",j)}}let p=null,u=null;function m(){p&&l(p),u&&d(u);const j=e("notif-new-modal");j&&j.style.display!=="none"&&o&&i(e("notif-line-check"),!!(o&&o.bound))}function b(){const j=e("notif-new-modal");j&&(j.style.display="",e("notif-new-name").value="",e("notif-new-threshold").value="",e("notif-new-threshold-row").style.display="none",document.querySelectorAll('input[name="notif-template"]').forEach(k=>k.checked=!1),s().then(k=>i(e("notif-line-check"),!!(k&&k.bound))))}function M(){const j=e("notif-new-modal");j&&(j.style.display="none")}function I(){const j=document.querySelector('input[name="notif-template"]:checked'),k=e("notif-new-threshold-row");if(!j){k.style.display="none";return}k.style.display=j.value==="large_invoice"?"":"none";const h=e("notif-new-name");h&&!h.value.trim()&&(h.value=j.value==="large_invoice"?t("notif-tmpl-large-name"):t("notif-tmpl-exception-name"))}async function x(){const j=document.querySelector('input[name="notif-template"]:checked');if(!j){showToast(t("notif-new-template"),"error");return}const k=(e("notif-new-name").value||"").trim();if(!k){showToast(t("notif-name-required"),"error");return}const h={name:k,template_code:j.value,params:{},enabled:!0};if(j.value==="large_invoice"){const w=parseFloat(e("notif-new-threshold").value||"0");if(!w||w<=0){showToast(t("notif-threshold-required"),"error");return}h.params.threshold=w}try{const w=await apiPost("/api/notifications/rules",h);if(w&&w.ok)showToast(t("notif-toast-created"),"success"),M(),c();else{const L=await(w&&w.json&&w.json().catch(()=>({})))||{};showToast(L&&L.detail||"save failed","error")}}catch{showToast("save failed","error")}}async function y(j,k,h){if(j==="toggle"){const w=h.classList.contains("on"),L=await n("/api/notifications/rules/"+k,{enabled:!w});L&&L.ok?(showToast(t(w?"notif-toast-toggled-off":"notif-toast-toggled-on"),"success"),c()):showToast("toggle failed","error");return}if(j==="test"){const w=await s();if(!w||!w.bound){showToast(t("notif-line-error-bind-first"),"error");return}const L=await apiPost("/api/notifications/rules/"+k+"/test",{});if(L&&L.ok)showToast(t("notif-toast-test-sent"),"success"),c();else{const C=await(L&&L.json&&L.json().catch(()=>({})))||{},D=C&&C.detail||"";showToast(D||t("notif-toast-test-failed"),"error"),c()}return}if(j==="delete"){if(!await showConfirm(t("notif-confirm-delete"),{danger:!0}))return;const L=await a("/api/notifications/rules/"+k);L&&L.ok?(showToast(t("notif-toast-deleted"),"success"),c()):showToast("delete failed","error");return}}let $=!1;function S(){if($)return;$=!0;const j=e("notif-btn-new");j&&j.addEventListener("click",b);const k=e("notif-btn-refresh-logs");k&&k.addEventListener("click",c);const h=e("notif-new-close");h&&h.addEventListener("click",M);const w=e("notif-new-cancel");w&&w.addEventListener("click",M);const L=e("notif-new-save");L&&L.addEventListener("click",x),document.querySelectorAll('input[name="notif-template"]').forEach(B=>{B.addEventListener("change",I)});const C=e("notif-rules-list");C&&C.addEventListener("click",B=>{const P=B.target.closest("button[data-action]");if(!P)return;const J=P.closest("[data-rule-id]");J&&y(P.getAttribute("data-action"),J.getAttribute("data-rule-id"),P)});const D=e("notif-new-modal");D&&D.addEventListener("click",B=>{B.target===D&&M()})}async function F(){S(),await c()}window._loadNotificationsPanel=F,window._rerenderNotifications=m})();(function(){function n(x,y){try{return window.t&&window.t(x)||y}catch{return y}}function a(){var x="";try{x=localStorage.getItem("mrpilot_token")||""}catch{}return x?{Authorization:"Bearer "+x}:{}}var o=[{tbody:"vex-task-tbody",api:"/api/recon/tasks/batch_delete",reload:function(){try{window.loadRecentTasks&&window.loadRecentTasks()}catch{}},kind:"vex"},{tbody:"glv-history-tbody",api:"/api/recon/gl-vat/tasks/batch_delete",reload:function(){try{window._loadGlvHistory&&window._loadGlvHistory()}catch{}},kind:"glv"},{tbody:"brv2-history-tbody",api:"/api/recon/bank-v2/tasks/batch_delete",reload:function(){try{window._brv2LoadHistory&&window._brv2LoadHistory()}catch{}},kind:"brv2"}];function s(){if(!document.getElementById("recon-batch-style")){var x=document.createElement("style");x.id="recon-batch-style",x.textContent=".recon-sel-cell{width:36px;text-align:center;padding-left:10px!important;padding-right:6px!important}.recon-sel-cb,.recon-master-cb{cursor:pointer;width:14px;height:14px;accent-color:#111;margin:0;vertical-align:middle}th.recon-time-col,td.recon-time-col{white-space:nowrap}tr.recon-thead-batch{display:none}thead.recon-batch-mode tr.recon-thead-default{display:none}thead.recon-batch-mode tr.recon-thead-batch{display:table-row}tr.recon-thead-batch th{background:#fafaf8;border-bottom:1px solid #e8e8e3;padding:8px 12px}tr.recon-thead-batch .recon-batch-inline{display:flex;align-items:center;gap:10px;font-size:12px;color:#111;font-weight:normal}tr.recon-thead-batch .recon-batch-count-inline{font-weight:600;color:#111;margin-right:4px}tr.recon-thead-batch .recon-batch-del-inline{background:#dc2626;color:#fff;border:none;border-radius:6px;padding:4px 10px;font-size:12px;font-weight:600;cursor:pointer;font-family:inherit;display:inline-flex;align-items:center;gap:4px}tr.recon-thead-batch .recon-batch-del-inline:hover{background:#b91c1c}tr.recon-thead-batch .recon-batch-clear-inline{background:transparent;border:none;color:#555;cursor:pointer;font-size:12px;font-family:inherit;text-decoration:underline;padding:4px 2px}tr.recon-thead-batch .recon-batch-clear-inline:hover{color:#111}.recon-batch-bar{display:none!important}",document.head.appendChild(x)}}function i(x){return x?x.dataset&&x.dataset.taskId?x.dataset.taskId:x.dataset&&x.dataset.taskid?x.dataset.taskid:"":""}function r(x){var y=document.getElementById(x.tbody);if(!y)return null;var $=y.closest("table");if(!$)return null;var S=$.querySelector("thead");if(!S)return null;if(S._reconReady)return S;var F=S.querySelector("tr");if(!F)return null;if(F.classList.add("recon-thead-default"),!F.querySelector(".recon-master-cb")){var j=document.createElement("th");j.className="recon-sel-cell";var k=document.createElement("input");k.type="checkbox",k.className="recon-master-cb",k.setAttribute("aria-label","select all"),k.addEventListener("change",function(){c(x,k.checked)}),j.appendChild(k),F.insertBefore(j,F.firstElementChild)}var h=F.children[1];h&&!h.classList.contains("recon-time-col")&&h.classList.add("recon-time-col");var w=F.children.length,L=document.createElement("tr");L.className="recon-thead-batch";var C=document.createElement("th");C.className="recon-sel-cell";var D=document.createElement("input");D.type="checkbox",D.className="recon-master-cb",D.checked=!0,D.setAttribute("aria-label","select all"),D.addEventListener("change",function(){c(x,D.checked)}),C.appendChild(D);var B=document.createElement("th");return B.setAttribute("colspan",String(w-1)),B.innerHTML='<div class="recon-batch-inline"><span class="recon-batch-count-inline" data-recon-count></span><button type="button" class="recon-batch-del-inline" data-recon-del><svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" width="13" height="13"><polyline points="3 4 13 4"/><path d="M6 4V2.5a.5.5 0 0 1 .5-.5h3a.5.5 0 0 1 .5.5V4"/><path d="M5 4l1 9a1 1 0 0 0 1 1h2a1 1 0 0 0 1-1l1-9"/></svg><span data-recon-del-label></span></button><button type="button" class="recon-batch-clear-inline" data-recon-clear></button></div>',L.appendChild(C),L.appendChild(B),S.appendChild(L),B.querySelector("[data-recon-del]").addEventListener("click",function(){b(x)}),B.querySelector("[data-recon-clear]").addEventListener("click",function(){m(x)}),S._reconReady=!0,u(x),S}function f(x){var y=document.getElementById(x.tbody);if(y){var $=y.querySelectorAll("tr");$.forEach(function(S){var F=i(S);if(F&&!S.querySelector(".recon-sel-cb")){var j=S.querySelector("td");if(j){var k=document.createElement("td");k.className="recon-sel-cell";var h=document.createElement("input");h.type="checkbox",h.className="recon-sel-cb",h.dataset.taskId=F,h.dataset.kind=x.kind,h.addEventListener("click",function(L){L.stopPropagation()}),h.addEventListener("change",function(){p(x)}),k.appendChild(h),S.insertBefore(k,j);var w=S.children[1];w&&!w.classList.contains("recon-time-col")&&w.classList.add("recon-time-col")}}}),p(x)}}function l(x){var y=document.getElementById(x.tbody);return y?Array.prototype.slice.call(y.querySelectorAll(".recon-sel-cb")):[]}function d(x){return l(x).filter(function(y){return y.checked}).map(function(y){return y.dataset.taskId})}function c(x,y){l(x).forEach(function($){$.checked=!!y}),p(x)}function p(x){var y=d(x),$=l(x),S=document.getElementById(x.tbody);if(S){var F=S.closest("table"),j=F&&F.querySelector("thead");if(j){y.length>0?j.classList.add("recon-batch-mode"):j.classList.remove("recon-batch-mode"),j.querySelectorAll(".recon-master-cb").forEach(function(h){if($.length===0){h.checked=!1,h.indeterminate=!1;return}y.length===$.length?(h.checked=!0,h.indeterminate=!1):y.length===0?(h.checked=!1,h.indeterminate=!1):(h.checked=!1,h.indeterminate=!0)});var k=j.querySelector("[data-recon-count]");k&&(k.textContent=n("recon-batch-selected-n","已选 {n} 条").replace("{n}",y.length))}}}function u(x){var y=document.getElementById(x.tbody);if(y){var $=y.closest("table"),S=$&&$.querySelector("thead");if(S){var F=S.querySelector("[data-recon-del-label]"),j=S.querySelector("[data-recon-clear]");F&&(F.textContent=n("recon-batch-delete","批量删除")),j&&(j.textContent=n("recon-batch-clear","取消")),p(x)}}}function m(x){l(x).forEach(function(y){y.checked=!1}),p(x)}async function b(x){var y=d(x);if(y.length){var $=n("recon-batch-delete-confirm","确定删除选中的 {n} 条对账任务?此操作不可恢复").replace("{n}",y.length),S=!1;try{typeof window.pearnlyConfirm=="function"?S=await window.pearnlyConfirm($,n("recon-batch-delete-title","批量删除")):S=window.confirm($)}catch{S=!1}if(S)try{var F=Object.assign({"Content-Type":"application/json"},a()),j=x.kind==="glv"?y.map(function(L){return parseInt(L,10)}):y,k=await fetch(x.api,{method:"POST",headers:F,body:JSON.stringify({ids:j})});if(!k.ok){typeof window.showToast=="function"&&window.showToast(n("recon-batch-delete-fail","批量删除失败"),"error");return}var h=await k.json(),w=h&&(h.deleted!=null?h.deleted:h.count)||y.length;typeof window.showToast=="function"&&window.showToast(n("recon-batch-delete-ok","已删除 {n} 条").replace("{n}",w),"success"),x.reload()}catch{typeof window.showToast=="function"&&window.showToast(n("recon-batch-delete-fail","批量删除失败"),"error")}}}function M(x){r(x),f(x);var y=document.getElementById(x.tbody);if(!(!y||y._reconBatchWatched)){y._reconBatchWatched=!0;var $=new MutationObserver(function(){f(x)});$.observe(y,{childList:!0,subtree:!1})}}function I(){s(),o.forEach(M),document.querySelectorAll(".recon-batch-bar").forEach(function(x){try{x.remove()}catch{}})}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",I):I(),setTimeout(I,1500),setTimeout(I,4e3),document.addEventListener("keydown",function(x){x.key==="Escape"&&o.forEach(function(y){d(y).length>0&&m(y)})}),typeof window.subscribeI18n=="function"&&window.subscribeI18n("recon-batch-thead",function(){o.forEach(u)})})();(function(){let e={role:"",monthly_volume:"",country:"",line_id:""},n=1;const a=4,o="pilot_ob_dismiss",s="pilot_ob_done";window.maybeShowOnboarding=function(d){};function i(d){n=d;for(let u=1;u<=a;u++){const m=document.getElementById("ob-step-"+u);m&&(m.style.display=u===d?"block":"none")}document.querySelectorAll(".ob-dot").forEach(u=>{const m=parseInt(u.dataset.step,10);u.classList.toggle("active",m===d),u.classList.toggle("done",m<d)});const c=document.getElementById("ob-step-label");c&&(c.textContent=d+" / "+a);const p=document.getElementById("ob-next");if(p&&(p.textContent=d===a?t("ob-finish"):t("ob-next")),d===4){const u=document.getElementById("ob-line-input");u&&(u.value=e.line_id||"")}}function r(d){const c=document.querySelector(".onboarding-modal");if(!c)return;let p=c.querySelector(".ob-feedback");p||(p=document.createElement("div"),p.className="ob-feedback",c.appendChild(p)),p.textContent=d,p.classList.add("show"),setTimeout(()=>p.classList.remove("show"),1800)}document.addEventListener("click",d=>{const c=d.target.closest(".ob-option");if(!c)return;const p=c.parentElement;if(!p||!p.classList.contains("ob-options"))return;p.querySelectorAll(".ob-option").forEach(m=>m.classList.remove("selected")),c.classList.add("selected");const u=c.dataset.value;p.id==="ob-role-options"?e.role=u:p.id==="ob-volume-options"?e.monthly_volume=u:p.id==="ob-country-options"&&(e.country=u)}),document.addEventListener("click",d=>{d.target.id==="ob-skip"&&f()}),document.addEventListener("click",d=>{if(d.target.id==="ob-next"){if(n===4){const c=document.getElementById("ob-line-input");e.line_id=(c&&c.value||"").trim().replace(/^@+/,"")}f()}}),document.addEventListener("click",d=>{if(d.target.closest("#ob-close")){localStorage.setItem(o,String(Date.now()));const c=document.getElementById("onboarding-modal");c&&(c.style.display="none")}});function f(){n===1&&e.role?r(t("ob-fb-role")):n===2&&e.monthly_volume?r(t("ob-fb-volume")):n===3&&e.country?r(t("ob-fb-country")):n===4&&e.line_id&&r(t("ob-fb-line")),n<a?setTimeout(()=>i(n+1),e[Object.keys(e)[n-1]]?350:0):l()}async function l(){const d=document.getElementById("onboarding-modal");localStorage.setItem(s,"1"),localStorage.removeItem(o);const c={};if(e.role&&(c.role=e.role),e.monthly_volume&&(c.monthly_volume=e.monthly_volume),e.country&&(c.country=e.country),e.line_id&&(c.line_id=e.line_id),Object.keys(c).length===0){d&&(d.style.display="none");return}try{const p=await fetch("/api/me/profile",{method:"PUT",headers:{Authorization:"Bearer "+(window.token||localStorage.getItem("mrpilot_token")),"Content-Type":"application/json"},body:JSON.stringify(c)});p.ok?(r(t("ob-fb-done")),window._userInfo&&Object.assign(window._userInfo,c),setTimeout(()=>{d&&(d.style.display="none")},1200)):(localStorage.setItem("pilot_ob_pending",JSON.stringify(c)),console.warn("onboarding profile save failed",p.status),r(t("ob-fb-saved-local")),setTimeout(()=>{d&&(d.style.display="none")},1500))}catch(p){console.error("onboarding submit",p),localStorage.setItem("pilot_ob_pending",JSON.stringify(c)),d&&(d.style.display="none")}}})();(function(){const e=document.getElementById("archive-rule-modal");if(!(!e||e.dataset.wbInjected==="1")){e.innerHTML=`
...
`,e.dataset.wbInjected="1";try{const n=window._currentLang||localStorage.getItem("mrpilot_lang")||"th",a=window.I18N;a&&a[n]&&(e.querySelectorAll("[data-i18n]").forEach(o=>{const s=o.getAttribute("data-i18n");a[n][s]&&(o.textContent=a[n][s])}),e.querySelectorAll("[data-i18n-placeholder]").forEach(o=>{const s=o.getAttribute("data-i18n-placeholder");a[n][s]&&(o.placeholder=a[n][s])}))}catch{}}})();(function(){const e=document.getElementById("archive-token-modal");if(!(!e||e.dataset.wbInjected==="1")){e.innerHTML=`
        ...
        `}async function c(){try{const k=await fetch("/api/settings/dup-check",{headers:{Authorization:"Bearer "+token}});if(!k.ok)return;const h=await k.json(),w=document.getElementById("pref-dup-check");w&&(w.checked=!!h.enabled)}catch(k){console.warn("load prefs failed",k)}}const p=document.getElementById("pref-dup-check");p&&!p.dataset.bound&&(p.dataset.bound="1",p.addEventListener("change",async k=>{const h=k.target.checked;try{(await fetch("/api/settings/dup-check",{method:"PUT",headers:{Authorization:"Bearer "+token,"Content-Type":"application/json"},body:JSON.stringify({enabled:h})})).ok?showToast(h?t("pref-dup-check-on-toast"):t("pref-dup-check-off-toast"),"success"):(k.target.checked=!h,showToast(t("pref-save-failed"),"error"))}catch{k.target.checked=!h,showToast(t("pref-save-failed"),"error")}}));async function u(){const k=!!(_userInfo&&_userInfo.can_customize_archive);o=!k;const h=document.getElementById("archive-upgrade-banner");h&&(h.style.display=k?"none":"");const w=document.getElementById("archive-plus-badge");w&&(w.style.display=k?"none":"");try{const L=await fetch("/api/archive/settings",{headers:{Authorization:"Bearer "+token}});if(!L.ok)throw new Error("load failed");const C=await L.json();e=Array.isArray(C.name_template)?C.name_template:[],n=C.folder_strategy||"by_month_seller"}catch(L){console.error("load archive settings failed",L),showToast(t("archive-load-failed"),"error");return}m(),b(),M(),I()}function m(){const k=document.getElementById("archive-rule-canvas");if(k){if(e.length===0){k.innerHTML=`<div class="archive-empty">${escapeHtml(t("archive-rule-empty"))}</div>`;return}k.innerHTML=e.map((h,w)=>{const L=i[h.type]||{label:h.type},C=s[h.type]||"",D=h.type==="sep"?`"${escapeHtml(h.val||"_")}"`:escapeHtml(t(L.label));return`
            ...
            `}).join("")}}function b(){const k=document.getElementById("archive-field-palette");if(!k)return;const h=["date","seller","category","amount","invoice","buyer","sep"];k.innerHTML=h.map(w=>{const L=i[w],C=s[w]||"";return`
                <button class="archive-palette-btn ${w}" data-add-field="${w}" ${o?"disabled":""}>
                    <span class="token-icon">${C}</span>
                    <span>${escapeHtml(t(L.label))}</span>
                </button>
            `}).join("")}function M(){document.querySelectorAll('input[name="folder-strategy"]').forEach(k=>{k.checked=k.value===n,k.disabled=o})}async function I(){const k=document.getElementById("archive-preview-name"),h=document.getElementById("archive-preview-hint");if(h&&(h.textContent=t("archive-preview-hint",{category:r()})),!!k){if(e.length===0){k.textContent="-";return}try{const L=await(await fetch("/api/archive/rename-preview",{method:"POST",headers:{Authorization:"Bearer "+token,"Content-Type":"application/json"},body:JSON.stringify({merged_fields:l().merged_fields,name_template:e})})).json();k.textContent=(L.name||"-")+".pdf"}catch{k.textContent="("+t("archive-preview-error")+")"}}}window._rerenderArchiveAll=function(){const k=document.getElementById("archive-rule-modal");!k||k.style.display==="none"||(m(),b(),I())};let x=-1;document.addEventListener("dragstart",k=>{const h=k.target.closest(".archive-token");!h||o||(x=parseInt(h.dataset.tokenIdx,10),h.classList.add("dragging"),k.dataTransfer.effectAllowed="move")}),document.addEventListener("dragend",k=>{document.querySelectorAll(".archive-token").forEach(h=>h.classList.remove("dragging","drop-target")),x=-1}),document.addEventListener("dragover",k=>{const h=k.target.closest(".archive-token");h&&(k.preventDefault(),k.dataTransfer.dropEffect="move",document.querySelectorAll(".archive-token").forEach(w=>w.classList.remove("drop-target")),h.classList.add("drop-target"))}),document.addEventListener("drop",k=>{const h=k.target.closest(".archive-token");if(!h||x<0||o)return;k.preventDefault();const w=parseInt(h.dataset.tokenIdx,10);if(w===x)return;const L=e.splice(x,1)[0];e.splice(w,0,L),x=-1,m(),I()}),document.addEventListener("click",k=>{if(k.target.closest("#btn-open-archive-rule")||k.target.closest("#btn-open-archive-rule-from-settings")){const C=document.getElementById("archive-rule-modal");C&&(C.style.display="",u());return}if(k.target.closest("#archive-rule-modal-close")||k.target.id==="archive-rule-modal"){const C=document.getElementById("archive-rule-modal");C&&(C.style.display="none");return}const h=k.target.closest(".settings-nav-item");if(h){switchSettingsTab(h.dataset.settingsTab);return}if(o&&k.target.closest(".archive-token, [data-add-field], #btn-archive-save, #btn-archive-reset")){showToast(t("feature-contact-us"),"info");return}const w=k.target.closest("[data-add-field]");if(w){const C=w.dataset.addField,D=i[C],B={type:C,...D.defaultCfg};e.push(B),m(),I();return}const L=k.target.closest(".archive-token");if(L&&!o){y(parseInt(L.dataset.tokenIdx,10));return}if(k.target.closest("#btn-archive-save"))return F();if(k.target.closest("#btn-archive-reset"))return j();(k.target.closest("#archive-token-close")||k.target.id==="archive-token-modal")&&(document.getElementById("archive-token-modal").style.display="none"),k.target.closest("#btn-archive-token-ok")&&$(),k.target.closest("#btn-archive-token-delete")&&S()}),document.addEventListener("change",k=>{k.target.name==="folder-strategy"&&(n=k.target.value)});function y(k){a=k;const h=e[k];if(!h)return;const w=document.getElementById("archive-token-body");let L="";h.type==="date"?L=`
                <div class="form-group">
                ...
                </div>`:L=`<div class="form-hint">${escapeHtml(t("archive-token-no-option"))}</div>`,w.innerHTML=L,document.getElementById("archive-token-modal").style.display="",w.querySelectorAll(".sep-chip").forEach(C=>{C.addEventListener("click",()=>{w.querySelectorAll(".sep-chip").forEach(B=>B.classList.remove("active")),C.classList.add("active");const D=document.getElementById("token-sep-custom");D&&(D.value="")})})}function $(){const k=e[a];if(k){if(k.type==="date")k.format=document.getElementById("token-date-format").value;else if(k.type==="seller")k.short=document.getElementById("token-seller-short").checked;else if(k.type==="amount")k.with_currency=document.getElementById("token-amount-currency").checked;else if(k.type==="sep"){const h=document.querySelector("#archive-token-body .sep-chip.active"),w=document.getElementById("token-sep-custom").value;k.val=w||(h?h.dataset.sep:"_")}document.getElementById("archive-token-modal").style.display="none",m(),I()}}function S(){a<0||(e.splice(a,1),document.getElementById("archive-token-modal").style.display="none",m(),I())}async function F(){if(e.length===0){showToast(t("archive-rule-cannot-empty"),"error");return}try{if(!(await fetch("/api/archive/settings",{method:"PUT",headers:{Authorization:"Bearer "+token,"Content-Type":"application/json"},body:JSON.stringify({name_template:e,folder_strategy:n})})).ok)throw new Error("save failed");showToast(t("archive-save-ok"),"success");const h=document.getElementById("archive-rule-modal");h&&(h.style.display="none")}catch{showToast(t("archive-save-fail"),"error")}}async function j(){await showConfirm(t("archive-reset-confirm"),{danger:!0})&&(e=[{type:"date",format:"YYYY-MM-DD"},{type:"sep",val:"_"},{type:"seller",short:!0},{type:"sep",val:"_"},{type:"category"},{type:"sep",val:"_"},{type:"amount",with_currency:!0}],n="by_month_seller",m(),M(),I())}})();(function(){const o="pearnly_big_batch_tip_shown";let s=null,i=null,r=0,f=0,l=!1;function d(y){const $=typeof t=="function"?t("big-batch-unload-warn"):"Batch OCR running · close anyway?";return y.preventDefault(),y.returnValue=$,$}function c(){l||(l=!0,window.addEventListener("beforeunload",d))}function p(){l&&(l=!1,window.removeEventListener("beforeunload",d))}function u(){if(document.getElementById("big-batch-progress"))return;const y=document.getElementById("file-list");if(!y||!y.parentNode)return;const $=document.createElement("div");$.id="big-batch-progress",$.className="big-batch-progress",$.innerHTML='<div class="bbp-row"><svg class="bbp-icon" viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><circle cx="8" cy="8" r="6.5"/><path d="M8 4.5v3.5l2.5 1.5"/></svg><span class="bbp-text" id="bbp-text"></span></div><div class="bbp-track"><div class="bbp-fill" id="bbp-fill" style="width:0%"></div></div>',y.parentNode.insertBefore($,y);const S=document.getElementById("bbp-text");S&&(S.textContent=typeof t=="function"?t("big-batch-progress-init"):"Starting...")}function m(){const y=document.getElementById("big-batch-progress");y&&y.remove()}function b(){if(!i)return;let y=0;for(let L=0;L<i.length;L++){const C=i[L].status;(C==="success"||C==="error"||C==="cancelled")&&y++}const $=r,S=$>0?Math.min(100,Math.floor(100*y/$)):0,F=(Date.now()-f)/1e3;let j;if(y>=3&&F>1){const L=F/y;j=($-y)*L}else j=($-y)*6/6;const k=Math.max(1,Math.ceil(j/60)),h=document.getElementById("bbp-fill"),w=document.getElementById("bbp-text");h&&(h.style.width=S+"%"),w&&(y>=$?w.textContent=t("big-batch-progress-done").replace("{total}",$):w.textContent=t("big-batch-progress-running").replace("{done}",y).replace("{total}",$).replace("{min}",k))}function M(y){try{if(localStorage.getItem(o)==="1")return}catch{}const $=Math.max(1,Math.ceil(y*6/6/60)),S=t("big-batch-first-tip").replace("{n}",y).replace("{min}",$);typeof showToast=="function"&&showToast(S,"info",8e3);try{localStorage.setItem(o,"1")}catch{}}function I(y){!y||y.length<100||(i=y,r=y.length,f=Date.now(),u(),c(),M(r),s&&clearInterval(s),s=setInterval(b,250),b())}function x(){s&&(clearInterval(s),s=null),p(),i&&r>=100?(b(),setTimeout(m,1200)):m(),i=null,r=0}window._bigBatchStart=I,window._bigBatchStop=x,typeof window.subscribeI18n=="function"&&window.subscribeI18n("big-batch-progress",function(){i&&b()})})();(function(){let e=null,n=!1,a=!1;function o(h){return typeof escapeHtml=="function"?escapeHtml(h==null?"":String(h)):String(h??"")}function s(h,w){try{typeof showToast=="function"&&showToast(h,w||"info")}catch{}}function i(){const h=typeof _userInfo<"u"?_userInfo:null;return!!(h&&(h.role==="owner"||h.is_super_admin))}function r(){try{return(typeof _results<"u"?_results:[])[typeof _drawerIdx<"u"?_drawerIdx:-1]||null}catch{return null}}function f(h){if(!h)return!1;const w=String(h.status||"").toLowerCase();return w==="exception"||w==="exception_pending"||w==="rejected"}async function l(h){if(n&&!h)return e;const w=localStorage.getItem("mrpilot_token");if(!w)return null;try{const L=await fetch("/api/erp/xero/status",{headers:{Authorization:"Bearer "+w}});if(!L.ok)throw new Error("http_"+L.status);e=await L.json(),n=!0}catch{e={configured:!1,connected:!1,organisations:[]},n=!1}return e}function d(){const h=document.getElementById("erp-connect-cards");if(!h)return;const w=e;let L,C=!1;w?w.configured?w.connected?(C=!0,L='<span class="mrerp-card-pill mrerp-pill-ok">'+o(t("xero-card-connected"))+"</span>"):L='<span class="mrerp-card-pill mrerp-pill-neutral">'+o(t("xero-card-not-connected"))+"</span>":L='<span class="mrerp-card-pill mrerp-pill-neutral">'+o(t("xero-card-not-configured"))+"</span>":L='<span class="mrerp-card-pill mrerp-pill-neutral">'+o(t("xero-card-not-connected"))+"</span>";let D="";if(!w||!w.configured)D='<button type="button" class="int-btn-configure" id="btn-xero-connect">'+o(t("xero-connect-btn"))+"</button>";else if(!w.connected)i()&&(D='<button type="button" class="int-btn-configure" id="btn-xero-connect">'+o(t("xero-connect-btn"))+"</button>");else{const E=!!w.auto_push,g=E?t("card-btn-disable"):t("card-btn-enable");D='<button type="button" class="'+(E?"mrerp-card-toggle mrerp-card-toggle-disable":"mrerp-card-toggle mrerp-card-toggle-enable")+'" id="btn-xero-toggle-enabled" data-xero-enabled="'+(E?"1":"0")+'" title="'+o(E?t("erp-auto-push-on-tip"):t("erp-auto-push-off-tip"))+'">'+o(g)+'</button><button type="button" class="int-btn-configure" id="btn-xero-edit-toggle">'+o(t("card-btn-edit"))+"</button>"}const B=w&&w.connected?"xero-card-desc-connected":"xero-card-desc-default",P=w&&w.connected?t("xero-card-connected")||"Connected · default org will receive pushes":"Cloud accounting · push invoices to your default Xero org",J=(function(){const E=t(B);return E===B?P:E})();let G='<div class="integration-row erp-connect-xero'+(C?" connected":"")+'"><div class="int-icon ic-xero"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="9"/><circle cx="9" cy="10" r="1.3" fill="currentColor"/><circle cx="15" cy="14" r="1.3" fill="currentColor"/><path d="M9 14l6-4"/></svg></div><div class="int-info"><div class="int-name"><span>'+o(t("xero-card-title")||"Xero")+"</span>"+L+'</div><div class="int-desc">'+o(J)+'</div></div><div class="int-actions">'+D+"</div></div>";if(w&&w.configured&&w.connected&&i()){const E=w.organisations||[];let g="";if(E.length>0){g+='<div class="erp-cc-meta">'+o((t("xero-org-count")||"").replace("{n}",String(E.length)))+"</div>",g+='<div class="erp-cc-org-label">'+o(t("xero-default-org"))+":</div>",g+='<div class="erp-cc-orgs">',E.forEach(function(K){g+='<label class="erp-cc-org-row"><input type="radio" name="xero-default-org" value="'+o(K.id)+'"'+(K.is_default?" checked":"")+'><span class="erp-cc-org-name">'+o(K.organisation_name||K.organisation_id)+"</span></label>"}),g+="</div>";const q=!!w.auto_push,N=q?t("erp-auto-push-on-tip"):t("erp-auto-push-off-tip");g+='<div class="erp-cc-auto-push" title="'+o(N)+'"><label class="erp-cc-toggle"><input type="checkbox" id="xero-auto-push-toggle"'+(q?" checked":"")+'><span class="erp-cc-toggle-slider"></span><span class="erp-cc-toggle-label">'+o(t("erp-auto-push-label"))+"</span></label></div>",g+='<div class="erp-cc-actions"><button class="btn btn-ghost btn-tiny" type="button" id="btn-xero-disconnect">'+o(t("xero-disconnect-btn"))+"</button></div>"}G+='<div class="erp-xero-details" id="erp-xero-details" style="display:none; margin:8px 0 16px; padding:12px 14px; border:1px solid var(--line); border-radius:8px; background:var(--bg);">'+g+"</div>"}const W=h.querySelector(".erp-connect-xero"),te=h.querySelector("#erp-xero-details");te&&te.remove(),W?W.outerHTML=G:h.insertAdjacentHTML("afterbegin",G);const re=document.getElementById("btn-xero-edit-toggle");re&&re.addEventListener("click",function(E){E.preventDefault();const g=document.getElementById("erp-xero-details");g&&(g.style.display=g.style.display==="none"?"":"none")});const H=document.getElementById("btn-xero-toggle-enabled");H&&H.addEventListener("click",async function(E){if(E.preventDefault(),H.disabled)return;const q=!(H.getAttribute("data-xero-enabled")==="1");if(!q)try{if(!await window.pearnlyConfirm(t("card-toggle-disable-confirm")))return}catch{}H.disabled=!0,await m(q,null)})}async function c(){const h=localStorage.getItem("mrpilot_token");if(h)try{const w=await fetch("/api/erp/xero/auth/start",{method:"GET",headers:{Authorization:"Bearer "+h}});if(!w.ok){let C="unknown";try{C=(await w.json()).detail||"unknown"}catch{}const D=String(C).replace(/^xero\./,"").toLowerCase();s(t("xero-push-fail").replace("{err}",t("xero-err-"+D)||C),"error");return}const L=await w.json();L.redirect_url&&(window.location.href=L.redirect_url)}catch(w){s(t("xero-push-fail").replace("{err}",w.message||"network"),"error")}}async function p(){if(!await window.pearnlyConfirm(t("xero-disconnect-confirm")))return;const w=localStorage.getItem("mrpilot_token");try{const L=await fetch("/api/erp/xero/disconnect",{method:"POST",headers:{Authorization:"Bearer "+w}});if(!L.ok)throw new Error("http_"+L.status);await l(!0),d()}catch(L){s(t("xero-push-fail").replace("{err}",L.message),"error")}}async function u(h){const w=localStorage.getItem("mrpilot_token");try{const L=await fetch("/api/erp/xero/select_org",{method:"POST",headers:{Authorization:"Bearer "+w,"Content-Type":"application/json"},body:JSON.stringify({token_id:h})});if(!L.ok)throw new Error("http_"+L.status);await l(!0),d()}catch(L){s(t("xero-push-fail").replace("{err}",L.message),"error")}}async function m(h,w){const L=localStorage.getItem("mrpilot_token");w&&(w.disabled=!0);try{const C=await fetch("/api/erp/xero/auto-push",{method:"POST",headers:{Authorization:"Bearer "+L,"Content-Type":"application/json"},body:JSON.stringify({on:!!h})});if(!C.ok){let D="unknown";try{D=(await C.json()).detail||"unknown"}catch{}throw new Error(D)}s(h?t("erp-auto-push-toggled-on"):t("erp-auto-push-toggled-off"),"success"),n=!1,await l(!0),d()}catch(C){w&&(w.checked=!h),s(t("erp-auto-push-toggle-fail").replace("{err}",C.message||"network"),"error")}finally{w&&(w.disabled=!1)}}async function b(){const h=document.getElementById("drawer-history-save");if(!h||h.querySelector("#btn-xero-push")||h.querySelector("#pn-push-wrap")||(await l(!1),h.querySelector("#pn-push-wrap"))||h.querySelector("#btn-xero-push"))return;const w=r();if(!(w&&(w._historyId||w.history_id)))return;let C=!1,D="xero-push-tip";!e||!e.configured?(C=!0,D="xero-err-not_configured"):e.connected?f(w)&&(C=!0,D="xero-push-disabled-exc"):(C=!0,D="xero-push-disabled-no-conn");const B=document.createElement("button");B.type="button",B.id="btn-xero-push",B.className="btn btn-ghost"+(C?" disabled":""),B.disabled=C,B.title=t(D)||"",B.innerHTML='<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"><circle cx="8" cy="8" r="6"/><path d="M5 8l2 2 4-4"/></svg><span style="margin-left:4px;">'+o(t("xero-push-btn"))+"</span>",B.addEventListener("click",M);const P=document.getElementById("btn-push-erp");P&&P.parentNode?P.parentNode.insertBefore(B,P.nextSibling):h.insertBefore(B,h.firstChild)}async function M(){const h=r(),w=h&&(h._historyId||h.history_id);if(!w)return;const L=document.getElementById("btn-xero-push");L&&(L.disabled=!0,L.classList.add("loading"));const C=localStorage.getItem("mrpilot_token");try{const D=await fetch("/api/erp/xero/push/"+encodeURIComponent(w),{method:"POST",headers:{Authorization:"Bearer "+C}});if(!D.ok){let B="unknown";try{B=(await D.json()).detail||"unknown"}catch{}const P=String(B).replace(/^xero\./,"").toLowerCase(),J=t("xero-"+P),G=J&&J!=="xero-"+P?J:B;s(t("xero-push-fail").replace("{err}",G),"error");return}s(t("xero-push-ok"),"success")}catch(D){s(t("xero-push-fail").replace("{err}",D.message||"network"),"error")}finally{L&&(L.disabled=!1,L.classList.remove("loading"))}}async function I(){await l(!0),d(),x()}async function x(){const h=document.getElementById("erp-global-push-mode");if(!h)return;const w=localStorage.getItem("mrpilot_token");if(w)try{const L=await fetch("/api/settings/erp-push-mode",{headers:{Authorization:"Bearer "+w}});if(L.ok){const C=await L.json();C.mode&&(h.value=C.mode,h.dataset.prev=C.mode)}}catch{}}async function y(h){const w=h.value,L=localStorage.getItem("mrpilot_token");try{(await fetch("/api/settings/erp-push-mode",{method:"PUT",headers:{Authorization:"Bearer "+L,"Content-Type":"application/json"},body:JSON.stringify({mode:w})})).ok?(h.dataset.prev=w,s(t("pref-erp-mode-saved"),"success")):(h.value=h.dataset.prev||"smart",s(t("pref-save-failed"),"error"))}catch{h.value=h.dataset.prev||"smart",s(t("pref-save-failed"),"error")}}function $(){try{const h=String(window.location.hash||"");if(h.indexOf("xero=ok")>=0){const w=h.match(/n=(\d+)/),L=w?w[1]:"1";s((t("xero-toast-redirected-ok")||"").replace("{n}",L),"success"),history.replaceState(null,"",window.location.pathname+"#automation"),l(!0).then(d)}else h.indexOf("xero=err")>=0&&(s(t("xero-toast-redirected-err"),"error"),history.replaceState(null,"",window.location.pathname+"#automation"))}catch{}}function S(){if(a)return;a=!0,document.addEventListener("click",function(w){if(w.target.closest('.erp-subtab[data-erp-subtab="connect"]')){setTimeout(I,50);return}if(w.target.closest('.auto-nav-item[data-auto-tab="erp"]')){setTimeout(I,80);return}if(w.target.closest("#btn-xero-connect")){w.preventDefault(),c();return}if(w.target.closest("#btn-xero-disconnect")){w.preventDefault(),p();return}}),document.addEventListener("change",function(w){w.target&&w.target.matches('input[name="xero-default-org"]')&&u(w.target.value),w.target&&w.target.id==="xero-auto-push-toggle"&&m(w.target.checked,w.target),w.target&&w.target.id==="erp-global-push-mode"&&y(w.target)});const h=function(){return document.getElementById("drawer-body")};try{const w=new MutationObserver(function(){document.getElementById("drawer-history-save")&&!document.getElementById("btn-xero-push")&&b()}),L=h();if(L)w.observe(L,{childList:!0,subtree:!0});else{const C=new MutationObserver(function(){const D=h();D&&(w.observe(D,{childList:!0,subtree:!0}),C.disconnect())});C.observe(document.body,{childList:!0,subtree:!0})}}catch{}setTimeout($,500)}function F(){e&&d();const h=document.getElementById("btn-xero-push");if(h){const w=h.querySelector("span");w&&(w.textContent=t("xero-push-btn"))}}S(),typeof window.subscribeI18n=="function"&&window.subscribeI18n("xero-adapter",F);async function j(h){const w=Date.now();for(;Date.now()-w<h;){if(typeof _userInfo<"u"&&_userInfo&&_userInfo.id)return _userInfo;await new Promise(L=>setTimeout(L,80))}return null}async function k(){await j(5e3);const h=document.querySelector('.auto-nav-item.active[data-auto-tab="erp"]'),w=document.querySelector('.erp-subtab.active[data-erp-subtab="connect"]');h&&w&&await I()}setTimeout(k,200)})();(function(){const e={};function n(){if(document.getElementById("report-modal"))return;const d=`
        ...
        </div>`,c=document.createElement("div");c.innerHTML=d,document.body.appendChild(c.firstElementChild),document.getElementById("report-modal-close-x").addEventListener("click",a),document.getElementById("report-modal-cancel").addEventListener("click",a),document.getElementById("report-modal").addEventListener("click",p=>{p.target.id==="report-modal"&&a()})}function a(){const d=document.getElementById("report-modal");d&&(d.style.display="none"),o=null}let o=null;async function s(d,c){const p=d+":"+(c||"");if(e[p])return e[p];let u;try{const m=localStorage.getItem("mrpilot_token"),b=await fetch(`/api/reports/templates?lang=${encodeURIComponent(d)}`,{headers:{Authorization:"Bearer "+m}});if(!b.ok)throw new Error("templates fetch failed");u=(await b.json()).templates||[]}catch(m){console.error("fetchTemplates fail",m),u=[{code:"input_vat",name:t("tpl-input-vat"),desc:t("tpl-input-vat-desc"),recommended:!0},{code:"standard",name:t("tpl-standard"),desc:t("tpl-standard-desc"),recommended:!1},{code:"print",name:t("tpl-print"),desc:t("tpl-print-desc"),recommended:!1}]}if(u=u.filter(m=>m.code!=="erp"),c==="history-batch"){const m=u.findIndex(M=>M.code==="standard"),b=m>=0?m+1:u.length;u.splice(b,0,{code:"sales_detail_th",name:t("export-tpl-sales-detail"),desc:t("export-tpl-sales-detail-desc"),recommended:!1,is_new:!0})}return e[p]=u,u}function i(d){const c=document.getElementById("report-tpl-list"),p=d.map((m,b)=>`
        ...
        `}function C(){const B=document.getElementById("btn-email-bind");B&&B.addEventListener("click",()=>c("new"));const P=document.getElementById("btn-email-edit");P&&P.addEventListener("click",()=>c("edit"));const J=document.getElementById("btn-email-unbind");J&&J.addEventListener("click",j);const G=document.getElementById("btn-email-trigger");G&&G.addEventListener("click",k);const W=document.getElementById("email-enabled-toggle");W&&W.addEventListener("change",h);const te=document.getElementById("email-modal-close");te&&te.addEventListener("click",p);const re=document.getElementById("btn-email-modal-cancel");re&&re.addEventListener("click",p);const H=document.getElementById("btn-email-modal-test");H&&H.addEventListener("click",S);const E=document.getElementById("btn-email-modal-save");E&&E.addEventListener("click",F);const g=document.getElementById("email-preset");g&&g.addEventListener("change",K=>u(K.target.value));const q=document.getElementById("email-address");q&&!q.dataset.autoBound&&(q.dataset.autoBound="1",q.addEventListener("blur",K=>b((K.target.value||"").trim())),q.addEventListener("input",K=>{const Z=(K.target.value||"").trim();Z.includes("@")&&Z.split("@")[1].includes(".")&&b(Z)}));const N=document.getElementById("btn-email-refresh-logs");N&&N.addEventListener("click",()=>{N.classList.add("spinning"),setTimeout(()=>N.classList.remove("spinning"),600),w()})}C(),window._loadEmailIngestPanel=i,window._rerenderEmailIngest=function(){if(!o)return;r();const B=document.getElementById("email-logs-section");e&&B&&B.open&&w()};let D=null;window._startEmailLogAutoRefresh=function(){D||(D=setInterval(()=>{e&&o&&w()},3e4))},window._stopEmailLogAutoRefresh=function(){D&&(clearInterval(D),D=null)}})();(function(){let e=[],n=null,a=[],o="all",s=null,i=!1;async function r(){if(i){C();return}i=!0,f(),await l(),C()}function f(){const v=document.getElementById("bank-file-input");v&&!v._bound&&(v._bound=!0,v.addEventListener("change",b));const R=document.getElementById("btn-bank-queue-clear-done");R&&!R._bound&&(R._bound=!0,R.addEventListener("click",S));const O=document.getElementById("btn-bank-back");O&&!O._bound&&(O._bound=!0,O.addEventListener("click",()=>{n=null,a=[],te()}));const Y=document.getElementById("btn-bank-delete");Y&&!Y._bound&&(Y._bound=!0,Y.addEventListener("click",h));const X=document.getElementById("btn-bank-run-match");X&&!X._bound&&(X._bound=!0,X.addEventListener("click",k)),document.querySelectorAll(".bank-filter-btn").forEach(fe=>{fe._bound||(fe._bound=!0,fe.addEventListener("click",()=>{o=fe.dataset.bankFilter||"all",document.querySelectorAll(".bank-filter-btn").forEach(me=>{me.classList.toggle("active",me===fe)}),Z()}))}),document.querySelectorAll("[data-bank-cand-close]").forEach(fe=>{fe._bound||(fe._bound=!0,fe.addEventListener("click",ne))});const de=document.getElementById("btn-bank-cand-pane-close");de&&!de._bound&&(de._bound=!0,de.addEventListener("click",ne));const se=document.getElementById("btn-bank-cand-ignore");se&&!se._bound&&(se._bound=!0,se.addEventListener("click",w));const ce=document.getElementById("btn-bank-cand-ignore-pane");ce&&!ce._bound&&(ce._bound=!0,ce.addEventListener("click",w));const ae=document.getElementById("bank-client-badge");ae&&!ae._bound&&(ae._bound=!0,ae.addEventListener("click",E)),document.querySelectorAll("[data-bank-client-picker-close]").forEach(fe=>{fe._bound||(fe._bound=!0,fe.addEventListener("click",g))});const pe=document.getElementById("btn-bank-client-picker-save");pe&&!pe._bound&&(pe._bound=!0,pe.addEventListener("click",N)),document.querySelectorAll(".bank-sessions-chip").forEach(fe=>{fe._bound||(fe._bound=!0,fe.addEventListener("click",()=>{D=fe.dataset.sessFilter||"all",document.querySelectorAll(".bank-sessions-chip").forEach(me=>{me.classList.toggle("active",me===fe)}),B()}))})}async function l(){try{const v=await fetch("/api/bank-recon/sessions?limit=30",{headers:{Authorization:"Bearer "+token}});if(!v.ok)throw new Error("sessions:"+v.status);e=await v.json(),B()}catch(v){console.warn("[bank-recon] loadSessions failed",v),e=[],B()}}async function d(v){try{const R="/api/bank-recon/sessions/"+encodeURIComponent(v)+(o!=="all"?"?filter="+o:""),O=await fetch(R,{headers:{Authorization:"Bearer "+token}});if(!O.ok)throw new Error("detail:"+O.status);const Y=await O.json();n=Y.session,a=Y.transactions||[],W()}catch(R){console.warn("[bank-recon] loadSessionDetail failed",R),showToast(t("bank-load-failed"),"error")}}let c=[],p=0;const u=3;function m(){return p+=1,"q"+p+"_"+Date.now()}async function b(v){const R=Array.from(v.target.files||[]);if(v.target.value="",R.length!==0){for(const O of R){const Y={id:m(),file:O,name:O.name,size:O.size,status:"pending",progress:0,error_code:null,tx_count:0,session_id:null};O.name.toLowerCase().endsWith(".pdf")?O.size>20*1024*1024&&(Y.status="failed",Y.error_code="bank_recon.file_too_large"):(Y.status="failed",Y.error_code="bank_recon.only_pdf"),c.push(Y)}M(),I(),F()}}function M(){const v=document.getElementById("bank-upload-queue");v&&(v.style.display=""),oe(),ue()}function I(){const v=document.getElementById("bank-upload-queue-list"),R=document.getElementById("bank-upload-queue-summary");if(!v)return;if(c.length===0){v.innerHTML="",R&&(R.textContent="");const se=document.getElementById("bank-upload-queue");se&&(se.style.display="none");return}let O=0,Y=0,X=0,de=0;for(const se of c)se.status==="ok"?O++:se.status==="failed"?Y++:se.status==="uploading"||se.status==="parsing"?X++:de++;R&&(R.textContent=t("bank-queue-summary").replace("{ok}",O).replace("{run}",X).replace("{wait}",de).replace("{fail}",Y)),v.innerHTML=c.map(x).join(""),v.querySelectorAll("[data-q-act]").forEach(se=>{const ce=se.dataset.qAct,ae=se.dataset.qId;se.addEventListener("click",()=>{ce==="retry"&&y(ae),ce==="remove"&&$(ae)})})}function x(v){const R=(v.size/1024).toFixed(0)+" KB";let O="",Y="";if(v.status==="pending")O='<span class="bq-stat bq-wait">'+t("bank-queue-status-wait")+"</span>",Y='<button data-q-act="remove" data-q-id="'+z(v.id)+'" class="bq-act">×</button>';else if(v.status==="uploading")O='<span class="bq-stat bq-run">'+t("bank-queue-status-uploading")+'</span><div class="bq-bar"><div class="bq-bar-fill" style="width:'+(v.progress||0)+'%"></div></div>';else if(v.status==="parsing")O='<span class="bq-stat bq-run">'+t("bank-queue-status-parsing")+'</span><div class="bq-bar"><div class="bq-bar-fill bq-bar-indet"></div></div>';else if(v.status==="ok")O='<span class="bq-stat bq-ok">'+t("bank-queue-status-ok").replace("{n}",v.tx_count||0)+"</span>",Y='<button data-q-act="remove" data-q-id="'+z(v.id)+'" class="bq-act">×</button>';else if(v.status==="failed"){const X=_(v.error_code||"unknown");O='<span class="bq-stat bq-fail" title="'+z(X)+'">'+z(X)+"</span>",Y='<button data-q-act="retry" data-q-id="'+z(v.id)+'" class="bq-act bq-act-retry">'+t("bank-queue-retry")+'</button><button data-q-act="remove" data-q-id="'+z(v.id)+'" class="bq-act">×</button>'}return'<div class="bq-row" data-q-row="'+z(v.id)+'"><div class="bq-name" title="'+z(v.name)+'">'+z(v.name)+'</div><div class="bq-size">'+R+'</div><div class="bq-status">'+O+'</div><div class="bq-actions">'+Y+"</div></div>"}function y(v){const R=c.find(O=>O.id===v);R&&(R.status="pending",R.error_code=null,R.progress=0,I(),F())}function $(v){const R=c.findIndex(Y=>Y.id===v);if(R<0)return;const O=c[R];O.status==="uploading"||O.status==="parsing"||(c.splice(R,1),I())}function S(){c=c.filter(v=>v.status!=="ok"),I()}async function F(){for(;;){if(c.filter(O=>O.status==="uploading"||O.status==="parsing").length>=u)return;const R=c.find(O=>O.status==="pending");if(!R){c.every(O=>O.status==="ok"||O.status==="failed")&&(await l(),typeof window.loadReconcilePage=="function"&&window.loadReconcilePage());return}j(R).then(()=>F())}}async function j(v){v.status="uploading",v.progress=0,I();try{const R=new FormData;R.append("file",v.file,v.name);const O=await new Promise((X,de)=>{const se=new XMLHttpRequest;se.open("POST","/api/bank-recon/upload"),se.setRequestHeader("Authorization","Bearer "+token),se.upload.onprogress=ce=>{ce.lengthComputable&&(v.progress=Math.min(99,Math.round(ce.loaded/ce.total*100)),I())},se.upload.onload=()=>{v.status="parsing",I()},se.onload=()=>{se.status>=200&&se.status<300?X({status:se.status,text:se.responseText}):X({status:se.status,text:se.responseText})},se.onerror=()=>de(new Error("network")),se.send(R)});let Y={};try{Y=JSON.parse(O.text||"{}")}catch{Y={}}if(O.status>=400){v.status="failed",v.error_code=Y&&Y.detail||"unknown",I();return}if(Y.parse_status==="parse_failed"){v.status="failed",v.error_code=Y.error==="scanned_pdf_not_yet"?"bank_recon.scanned":"bank_recon.no_tx",I();return}v.status="ok",v.tx_count=Y.tx_count||0,v.session_id=Y.session_id||null,I()}catch(R){console.warn("[bank-recon] upload failed",R),v.status="failed",v.error_code="network",I()}}async function k(){if(!n)return;const v=document.getElementById("btn-bank-run-match"),R=v.innerHTML;v.disabled=!0,v.innerHTML="<span>"+t("bank-matching")+"</span>";try{const O=await fetch("/api/bank-recon/sessions/"+encodeURIComponent(n.id)+"/match",{method:"POST",headers:{Authorization:"Bearer "+token}});if(!O.ok)throw new Error("match:"+O.status);const Y=await O.json();showToast(t("bank-match-done").replace("{matched}",Y.matched).replace("{suggested}",Y.suggested).replace("{unmatched}",Y.unmatched),"success"),await d(n.id),await l()}catch(O){console.warn("[bank-recon] match failed",O),showToast(t("bank-match-failed"),"error")}finally{v.disabled=!1,v.innerHTML=R}}async function h(){if(!(!n||!await showConfirm(t("bank-delete-confirm"),{danger:!0})))try{const R=await fetch("/api/bank-recon/sessions/"+encodeURIComponent(n.id),{method:"DELETE",headers:{Authorization:"Bearer "+token}});if(!R.ok)throw new Error("delete:"+R.status);showToast(t("bank-deleted"),"success"),n=null,a=[],te(),await l()}catch(R){console.warn("[bank-recon] delete failed",R),showToast(t("bank-delete-failed"),"error")}}async function w(){if(s)try{const v=await fetch("/api/bank-recon/tx/"+encodeURIComponent(s.id)+"/override",{method:"POST",headers:{Authorization:"Bearer "+token,"Content-Type":"application/json"},body:JSON.stringify({status:"ignored"})});if(!v.ok)throw new Error("ignore:"+v.status);ne(),await d(n.id)}catch{showToast(t("bank-action-failed"),"error")}}async function L(v){if(s)try{const R=await fetch("/api/bank-recon/tx/"+encodeURIComponent(s.id)+"/override",{method:"POST",headers:{Authorization:"Bearer "+token,"Content-Type":"application/json"},body:JSON.stringify({status:"matched",history_id:v})});if(!R.ok)throw new Error("pick:"+R.status);showToast(t("bank-matched-ok"),"success"),ne(),await d(n.id)}catch{showToast(t("bank-action-failed"),"error")}}function C(){const v=document.getElementById("bank-status-summary");if(!v)return;if(e.length===0){v.textContent=t("bank-pill-none");return}let O=0;for(const Y of e)Y.parse_status==="parsed"&&(Y.unmatched_count||0)>0&&O++;v.textContent=O>0?t("bank-pill-pending").replace("{n}",O):t("bank-pill-ok")}let D="all";function B(){const v=document.getElementById("bank-sessions-list");if(!v)return;let R=e||[];if(D==="parsed"?R=R.filter(O=>O.parse_status==="parsed"):D==="failed"&&(R=R.filter(O=>O.parse_status==="parse_failed")),!e||e.length===0){v.innerHTML='<div class="bank-empty" data-i18n="bank-sessions-empty">'+t("bank-sessions-empty")+"</div>";return}if(R.length===0){v.innerHTML='<div class="bank-empty">'+t("bank-sess-filter-empty")+"</div>";return}v.innerHTML=R.map(O=>J(O)).join(""),v.querySelectorAll(".bank-session-row").forEach(O=>{O.addEventListener("click",Y=>{Y.target.closest(".bank-session-trash")||d(O.dataset.sessionId)})}),v.querySelectorAll(".bank-session-trash").forEach(O=>{O.addEventListener("click",Y=>{Y.stopPropagation();const X=O.dataset.sessionId,de=O.dataset.sessionName||"";P(X,de)})})}async function P(v,R){if(!v)return;const O=(t("bank-session-delete-confirm")||"确定删除这条对账记录吗?").replace("{name}",R||"");if(await showConfirm(O,{danger:!0}))try{const X=await fetch("/api/bank-recon/sessions/"+encodeURIComponent(v),{method:"DELETE",headers:{Authorization:"Bearer "+token}});if(!X.ok)throw new Error("delete:"+X.status);showToast(t("bank-deleted"),"success"),n&&n.id===v&&(n=null,a=[],te()),await l(),typeof window.loadReconcilePage=="function"&&window.loadReconcilePage()}catch(X){console.warn("[bank-recon] delete failed",X),showToast(t("bank-delete-failed"),"error")}}window._deleteBankSession=P;function J(v){const R=(v.bank_code||"OTHER").toUpperCase(),O=U(v.period_start,v.period_end),Y=v.account_last4?"···"+v.account_last4:"",X=G(v),de=A(v.created_at);return`
...
`,e.dataset.wbInjected="1";try{const n=window._currentLang||localStorage.getItem("mrpilot_lang")||"th",a=window.I18N;a&&a[n]&&(e.querySelectorAll("[data-i18n]").forEach(o=>{const s=o.getAttribute("data-i18n");a[n][s]&&(o.textContent=a[n][s])}),e.querySelectorAll("[data-i18n-placeholder]").forEach(o=>{const s=o.getAttribute("data-i18n-placeholder");a[n][s]&&(o.placeholder=a[n][s])}))}catch{}}})();(function(){let e={statsCache:null,listCache:[],currentRule:null,currentClient:"",currentStatus:"pending",loading:!1,selectedIds:new Set,offset:0,pageSize:50,total:0,loadFailed:!1,listScrollY:0};function n(H,E){let g=t(H)||H;if(E)for(const q in E)g=g.replace(new RegExp("\\{"+q+"\\}","g"),String(E[q]));return g}async function a(){try{const H=e.currentClient||"",E="/api/exceptions/stats?status=pending"+(H?"&client_id="+encodeURIComponent(H):""),g=await fetch(E,{headers:{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||"")}});if(!g.ok)return;const q=await g.json(),N=document.getElementById("nav-exc-badge");if(!N)return;const K=parseInt(q.pending||0,10);K>0?(N.textContent=K>99?"99+":String(K),N.style.display=""):N.style.display="none"}catch{}}function o(H){return H==="high"?`<svg viewBox="0 0 14 14" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
        ...
        `;const le=H.severity||"medium",ie=t("exc-rule-"+H.rule_code)||H.rule_code,V=w(H.rule_code,H.detail||{}),Q=k(x.history),ee=x.history===null,ne=x.history&&x.history._err,oe=new Set;H.rule_code==="math_mismatch"?(oe.add("subtotal"),oe.add("vat"),oe.add("total_amount")):H.rule_code==="tax_id_format_invalid"?oe.add("seller_tax"):H.rule_code==="amount_missing"&&(oe.add("total_amount"),oe.add("invoice_number"));const ue=!!x.editing,_=x.editFields||{},T=(ae,pe,fe)=>{if(ee)return`<div class="exc-field-row"><label>${escapeHtml(t(pe))}</label><span class="val empty">…</span></div>`;const me=ue?_[ae]!==void 0?_[ae]:Q[ae]!==void 0&&Q[ae]!==null?Q[ae]:"":Q[ae],ge=oe.has(ae)?"flagged":"";if(ue){const ze=fe?"number":"text",Te=fe?' step="0.01" inputmode="decimal"':"",He=me==null?"":String(me).replace(/"/g,"&quot;");return`<div class="exc-field-row ${ge} editing">
        ...
        `;const z=document.getElementById("exc-fld-edit");z&&z.addEventListener("click",()=>{x.editing=!0,x.editFields={...k(x.history)},L()});const v=document.getElementById("exc-fld-cancel");v&&v.addEventListener("click",()=>{x.editing=!1,x.editFields=null,L()});const R=document.getElementById("exc-fld-save");R&&R.addEventListener("click",()=>C()),document.querySelectorAll(".exc-field-input").forEach(ae=>{ae.addEventListener("input",()=>{x.editFields||(x.editFields={}),x.editFields[ae.dataset.editKey]=ae.value})});const Y=document.getElementById("exc-pdf-retry");Y&&x.openExcId&&Y.addEventListener("click",()=>{x.excRow&&$(x.excRow.history_id,x.openExcId)});const X=H.status==="pending",de=!!(H.seller_name&&H.seller_name.trim()),se=document.getElementById("exc-btn-resolve"),ce=document.getElementById("exc-btn-ignore");se.disabled=!X,ce.disabled=!X||!de,ce.title=de?t("exc-ignore-hint"):t("exc-ignore-no-seller")}async function C(){if(!x.openExcId||!x.history||!x.history.pages||x.loading)return;x.loading=!0;const H=showToast(t("exc-fld-saving"),"loading",0);try{const E=JSON.parse(JSON.stringify(x.history.pages||[]));let g=E.findIndex(ie=>!ie.is_duplicate&&!ie.is_copy);g<0&&(g=0),E[g]||(E[g]={fields:{}});const q=E[g].fields||{},N=x.editFields||{},K=new Set(["subtotal","vat","total_amount"]),Z={...q};for(const ie in N){let V=N[ie];if((V===""||V===void 0)&&(V=null),K.has(ie)&&V!==null){const Q=parseFloat(V);V=isNaN(Q)?null:Q}Z[ie]=V}E[g].fields=Z;const le=await fetch("/api/history/"+encodeURIComponent(x.history.id),{method:"PUT",headers:{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||""),"Content-Type":"application/json"},body:JSON.stringify({pages:E})});if(!le.ok)throw new Error("http "+le.status);H(),showToast(t("exc-fld-save-ok"),"success"),F(),await u(),await b(),a()}catch(E){H(),console.warn("save fields fail",E),showToast(t("exc-fld-save-fail"),"error")}finally{x.loading=!1}}async function D(){if(!(!x.openExcId||x.loading)){x.loading=!0;try{const H=await fetch("/api/exceptions/"+x.openExcId+"/resolve",{method:"POST",headers:{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||"")}});if(!H.ok)throw new Error("http "+H.status);showToast(t("exc-toast-resolved"),"success"),F(),await u(),await b(),a()}catch(H){console.warn("resolve fail",H),showToast(t("exc-toast-action-fail"),"error")}finally{x.loading=!1}}}async function B(){if(!(!x.openExcId||x.loading)){x.loading=!0;try{const H=await fetch("/api/exceptions/"+x.openExcId+"/ignore",{method:"POST",headers:{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||"")}});if(!H.ok)throw new Error("http "+H.status);showToast(t("exc-toast-ignored"),"success"),F(),await u(),await b(),a()}catch(H){console.warn("ignore fail",H),showToast(t("exc-toast-action-fail"),"error")}finally{x.loading=!1}}}let P=!1;async function J(){if(P)return;const H=Array.from(e.selectedIds);if(H.length===0||!await showConfirm(n("exc-batch-confirm-resolve",{n:H.length})))return;P=!0;const g=showToast(n("exc-batch-count",{n:H.length})+" …","loading",0);try{const q=await fetch("/api/exceptions/batch",{method:"POST",headers:{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||""),"Content-Type":"application/json"},body:JSON.stringify({ids:H,action:"resolve"})});if(!q.ok)throw new Error("http "+q.status);const N=await q.json();g(),showToast(n("exc-toast-batch-resolved",{n:N.processed||0}),"success"),e.selectedIds.clear(),await u(),await b(),a()}catch(q){g(),console.warn("batch resolve fail",q),showToast(t("exc-toast-batch-fail"),"error")}finally{P=!1}}async function G(){if(P)return;const H=Array.from(e.selectedIds);if(H.length===0||!await showConfirm(n("exc-batch-confirm-ignore",{n:H.length}),{danger:!1}))return;P=!0;const g=showToast(n("exc-batch-count",{n:H.length})+" …","loading",0);try{const q=await fetch("/api/exceptions/batch",{method:"POST",headers:{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||""),"Content-Type":"application/json"},body:JSON.stringify({ids:H,action:"ignore"})});if(!q.ok)throw new Error("http "+q.status);const N=await q.json();g(),showToast(n("exc-toast-batch-ignored",{n:N.processed||0,wl:N.whitelist_added||0}),"success"),e.selectedIds.clear(),await u(),await b(),a()}catch(q){g(),console.warn("batch ignore fail",q),showToast(t("exc-toast-batch-fail"),"error")}finally{P=!1}}function W(){e.selectedIds.clear(),d(e.listCache)}document.addEventListener("click",H=>{H.target.closest("#exc-drawer-close")&&F(),H.target.closest("#exc-drawer-mask")&&F(),H.target.closest("#exc-btn-resolve")&&D(),H.target.closest("#exc-btn-ignore")&&B(),H.target.closest("#exc-batch-resolve")&&J(),H.target.closest("#exc-batch-ignore")&&G(),H.target.closest("#exc-batch-clear")&&W(),H.target.closest("#exc-loadmore")&&M()}),document.addEventListener("keydown",H=>{H.key==="Escape"&&x.openExcId&&F()}),document.addEventListener("click",H=>{H.target.closest("#btn-exc-refresh")&&(typeof window.loadExceptionsPage=="function"&&window.loadExceptionsPage(),a())}),document.addEventListener("change",H=>{if(!H.target.closest("#exc-client-filter"))return;const E=H.target;e.currentClient=E.value||"",e.currentRule=null,e.selectedIds.clear(),e.listCache=[],typeof window.loadExceptionsPage=="function"&&window.loadExceptionsPage(),a()}),document.addEventListener("click",H=>{const E=H.target.closest("#exc-status-tabs .exc-status-tab");if(!E)return;const g=E.dataset.status||"pending";g!==e.currentStatus&&(e.currentStatus=g,e.currentRule=null,e.selectedIds.clear(),e.listCache=[],typeof window.loadExceptionsPage=="function"&&window.loadExceptionsPage())}),window.addEventListener("online",()=>{e.loadFailed&&document.getElementById("page-exceptions")?.classList.contains("show")&&window.loadExceptionsPage&&window.loadExceptionsPage()}),setTimeout(a,1500),setInterval(a,6e4);function te(H){if(!H)return"—";try{const E=new Date(H),g=q=>String(q).padStart(2,"0");return`${E.getFullYear()}-${g(E.getMonth()+1)}-${g(E.getDate())} ${g(E.getHours())}:${g(E.getMinutes())}`}catch{return H.slice(0,16).replace("T"," ")}}async function re(){const H=document.getElementById("learned-list");if(H){H.innerHTML=`<div class="learned-empty">${escapeHtml(t("set-learned-loading"))}</div>`;try{const E=await fetch("/api/exception-whitelist",{headers:{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||"")}});if(!E.ok)throw new Error("http "+E.status);const q=(await E.json()).items||[];if(q.length===0){H.innerHTML=`<div class="learned-empty">${escapeHtml(t("set-learned-empty"))}</div>`;return}const N=`<svg viewBox="0 0 14 14" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round">
                ...
                `}).join("")}catch(E){console.warn("loadLearnedRules fail",E),H.innerHTML=`<div class="learned-empty">${escapeHtml(t("exc-toast-load-fail"))}</div>`}}}window.loadLearnedRules=re,document.addEventListener("click",async H=>{const E=H.target.closest("[data-del-wl]");if(!E)return;const g=parseInt(E.dataset.delWl,10);if(!g)return;const q=E.closest(".learned-row"),N=q&&q.querySelector(".learned-seller"),K=N?N.textContent.trim():"",Z=t("set-learned-del-confirm").replace("{seller}",K);if(await showConfirm(Z,{danger:!0}))try{const ie=await fetch("/api/exception-whitelist/"+g,{method:"DELETE",headers:{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||"")}});if(!ie.ok)throw new Error("http "+ie.status);showToast(t("set-learned-del-ok"),"success"),re(),typeof window.loadExceptionsPage=="function"&&document.getElementById("page-exceptions")?.classList.contains("show")&&window.loadExceptionsPage()}catch(ie){console.warn("delete whitelist fail",ie),showToast(t("set-learned-del-fail"),"error")}})})();(function(){let e={items:[],q:"",cat:"",selected:new Set,total:0,categories:{},pageSize:30,loading:!1,focusSearch:!1,searchCaret:0},n=null;function a(){return localStorage.getItem("mrpilot_token")||""}function o(p){const u=typeof currentLang=="string"&&currentLang||window._currentLang||"th",m=p.error_friendly&&p.error_friendly[u];if(m)return m;if(typeof humanizeError=="function"&&p.error_msg)try{return humanizeError(p.error_msg)}catch{}return t("erp-exc-reason-"+(p.category||"other"))}function s(){const p=document.getElementById("erp-exc-batch");if(!p)return;const u=e.selected.size;p.hidden=u===0;const m=p.querySelector(".erp-exc-batch-count");m&&(m.textContent=String(u))}function i(){const p=document.getElementById("erp-exc-block");if(!p)return;const u=e;if(!(u.total>0||!!u.q||!!u.cat)){p.hidden=!0,p.innerHTML="";return}p.hidden=!1;const b=u.categories||{},M=Object.keys(b).reduce((w,L)=>w+b[L],0);let I=`<button class="erp-exc-chip ${u.cat===""?"active":""}" data-erpexc-cat=""><span>${escapeHtml(t("erp-exc-cat-all"))}</span><span class="erp-exc-chip-count">${M}</span></button>`;Object.keys(b).forEach(w=>{I+=`<button class="erp-exc-chip ${u.cat===w?"active":""}" data-erpexc-cat="${escapeHtml(w)}"><span>${escapeHtml(t("erp-exc-cat-"+w))}</span><span class="erp-exc-chip-count">${b[w]}</span></button>`});const x=u.items||[],y=x.length>0&&x.every(w=>u.selected.has(w.id)),$=x.map(w=>{const L=w.state==="needs_action"?"needs":w.state==="retrying"?"retry":"fail",C=t("erp-exc-state-"+(w.state||"failed")),D=o(w),B=u.selected.has(w.id)?"checked":"";return`<div class="erp-exc-row" data-erpexc-id="${escapeHtml(w.id)}">
            ...
            <div class="erp-exc-foot">${F}</div>`;const j=document.getElementById("erp-exc-search");if(j){if(u.focusSearch){j.focus();try{j.setSelectionRange(u.searchCaret,u.searchCaret)}catch{}}j.addEventListener("input",()=>{u.q=j.value,u.focusSearch=!0,u.searchCaret=j.selectionStart||j.value.length,clearTimeout(n),n=setTimeout(()=>l(!1),350)}),j.addEventListener("blur",()=>{u.focusSearch=!1})}p.querySelectorAll(".erp-exc-chip").forEach(w=>{w.addEventListener("click",()=>{u.cat=w.dataset.erpexcCat||"",l(!1)})}),p.querySelectorAll("[data-erpexc-retry]").forEach(w=>{w.addEventListener("click",L=>{L.stopPropagation(),r(w.dataset.erpexcRetry,w)})}),p.querySelectorAll(".erp-exc-cb").forEach(w=>{w.addEventListener("change",()=>{const L=w.dataset.erpexcCb;w.checked?u.selected.add(L):u.selected.delete(L);const C=document.getElementById("erp-exc-cb-all");C&&(C.checked=x.length>0&&x.every(D=>u.selected.has(D.id))),s()})});const k=document.getElementById("erp-exc-cb-all");k&&k.addEventListener("change",()=>{x.forEach(w=>{k.checked?u.selected.add(w.id):u.selected.delete(w.id)}),p.querySelectorAll(".erp-exc-cb").forEach(w=>{w.checked=k.checked}),s()}),p.querySelectorAll("[data-erpexc-batch]").forEach(w=>{w.addEventListener("click",()=>f(w.dataset.erpexcBatch))});const h=document.getElementById("erp-exc-more");h&&h.addEventListener("click",()=>l(!0)),p.querySelectorAll(".erp-exc-row:not(.erp-exc-row-head)").forEach(w=>{w.addEventListener("click",L=>{L.target.closest("input,button")||typeof window._erpExcOpenEdit=="function"&&window._erpExcOpenEdit(w.dataset.erpexcId)})})}async function r(p,u){if(p){u&&(u.disabled=!0,u.textContent=t("erp-exc-retrying"));try{const m=await fetch("/api/erp/logs/"+encodeURIComponent(p)+"/retry",{method:"POST",headers:{Authorization:"Bearer "+a()}}),b=await m.json().catch(()=>({}));showToast(m.ok&&b.ok?t("erp-exc-retry-ok"):t("erp-exc-retry-fail"),m.ok&&b.ok?"success":"error")}catch{showToast(t("erp-exc-retry-fail"),"error")}if(e.selected.delete(p),l(!1),typeof window.refreshExcBadge=="function")try{window.refreshExcBadge()}catch{}}}async function f(p){const u=Array.from(e.selected);if(p==="clear"){e.selected.clear(),i();return}if(u.length!==0){if(p==="delete"){if(!await showConfirm(t("erp-exc-batch-delete-confirm",{n:u.length}),{danger:!0}))return;try{const b=await fetch("/api/erp/logs/batch-delete",{method:"POST",headers:{Authorization:"Bearer "+a(),"Content-Type":"application/json"},body:JSON.stringify({log_ids:u.slice(0,200)})}),M=await b.json().catch(()=>({}));showToast(b.ok?t("erp-exc-batch-delete-ok",{n:M.deleted||0}):t("erp-exc-retry-fail"),b.ok?"success":"error")}catch{showToast(t("erp-exc-retry-fail"),"error")}}else if(p==="retry")try{const m=await fetch("/api/erp/logs/batch-retry",{method:"POST",headers:{Authorization:"Bearer "+a(),"Content-Type":"application/json"},body:JSON.stringify({log_ids:u.slice(0,50)})}),b=await m.json().catch(()=>({}));showToast(m.ok?t("erp-exc-batch-retry-ok",{ok:b.succeeded||0,fail:(b.failed||0)+(b.skipped||0)}):t("erp-exc-retry-fail"),m.ok?"success":"error")}catch{showToast(t("erp-exc-retry-fail"),"error")}if(e.selected.clear(),l(!1),typeof window.refreshExcBadge=="function")try{window.refreshExcBadge()}catch{}}}async function l(p){const u=document.getElementById("erp-exc-block");if(!(!u||e.loading)){e.loading=!0;try{const m=new URLSearchParams;e.q&&m.set("q",e.q),e.cat&&m.set("category",e.cat),m.set("limit",String(e.pageSize)),m.set("offset",String(p?e.items.length:0));const b=await fetch("/api/erp/exceptions?"+m.toString(),{headers:{Authorization:"Bearer "+a()}});if(!b.ok){p||(u.hidden=!0);return}const M=await b.json(),I=M.items||[];e.items=p?e.items.concat(I):I,e.total=M.total||0,e.categories=M.categories||{},i()}catch{p||(u.hidden=!0)}finally{e.loading=!1}}}let d={};function c(){const p=document.getElementById("erp-exc-modal");p&&p.remove()}window._erpExcOpenEdit=function(p){const u=(e.items||[]).find(S=>String(S.id)===String(p));if(!u)return;const m=!!u.history_client_id&&u.category==="customer_mismatch",b=u.category==="product_mismatch"&&!!u.history_id&&!!u.endpoint_id,M=o(u),I=u.state==="needs_action"?"needs":u.state==="retrying"?"retry":"fail",x=(S,F)=>`<div class="erp-exc-m-row"><span class="erp-exc-m-k">${escapeHtml(S)}</span><span class="erp-exc-m-v">${escapeHtml(F||"—")}</span></div>`;let y="";if(m)y=`
                ...
                </div>`;else{const S="erp-exc-edit-hint-"+(u.category||"other");let F=t(S);(!F||F===S)&&(F=M),y=`<div class="erp-exc-m-hint">${escapeHtml(F)}</div>`}const $=document.createElement("div");if($.id="erp-exc-modal",$.className="erp-exc-modal-overlay",$.innerHTML=`
            ...
            <div class="vex-pp-pagination" id="vex-pp-${V}-pg"></div>`;const T=o("vex-pp-search-"+V);T&&T.addEventListener("input",U=>{V==="inv"?(m=U.target.value,p=50):(b=U.target.value,u=50),H(V)});const A=o("vex-pp-clearall-"+V);A&&A.addEventListener("click",()=>{V==="inv"?(f=[],m="",p=50):(l=[],b="",u=50),P()}),H(V)}function H(V){const Q=o("vex-pp-"+V+"-list"),ee=o("vex-pp-"+V+"-pg");if(!Q)return;const ne=V==="inv"?f:l,oe=V==="inv"?m:b,ue=V==="inv"?p:u,_=V==="inv"?J:G,T=ne.map((z,v)=>({f:z,i:v})),A=oe?T.filter(({f:z})=>z.name.toLowerCase().includes(oe.toLowerCase())):T,U=A.slice(0,ue);if(Q.innerHTML=U.map(({f:z,i:v})=>`
            ...
            <table style="width:100%;border-collapse:collapse;font-size:12px;margin-bottom:4px">
              ...
              <td>${O?"L"+O:"—"}</td>
            </tr>`}).join("")}async function Z(){const _=localStorage.getItem("mrpilot_token")||"";try{const A=await(await fetch("/api/recon/bank-v2/tasks",{headers:{Authorization:"Bearer "+_}})).json();ee(A.tasks||[])}catch{const A=l("brv2-history-empty"),U=window._currentLang||"zh",z={zh:"加载失败",th:"โหลดประวัติไม่ได้",en:"Load failed",ja:"読み込み失敗"}[U]||"加载失败";A&&(A.textContent=z,A.style.display="");const v=l("brv2-history-table-wrap");v&&(v.style.display="none")}}const le=10;let ie=1;function V(){const _=l("brv2-history-pager"),T=l("brv2-history-pager-info"),A=l("brv2-history-prev"),U=l("brv2-history-next");if(!_)return;if(f.length<=le){_.style.display="none";return}_.style.display="";const z=Math.ceil(f.length/le);T&&(T.textContent=ie+" / "+z),A&&(A.disabled=ie<=1),U&&(U.disabled=ie>=z)}function Q(){const _=l("brv2-history-prev"),T=l("brv2-history-next");_&&!_._brv2Bound&&(_._brv2Bound=!0,_.addEventListener("click",()=>{ie>1&&(ie--,ee(f))})),T&&!T._brv2Bound&&(T._brv2Bound=!0,T.addEventListener("click",()=>{const A=Math.ceil(f.length/le);ie<A&&(ie++,ee(f))}))}function ee(_){_!==void 0&&(f=_||[],ie=1);const T=f,A=l("brv2-history-empty"),U=l("brv2-history-table-wrap"),z=l("brv2-history-tbody");if(!z)return;const v=window._currentLang||"zh";if(!T.length){const ae={zh:"暂无对账记录",th:"ยังไม่มีประวัติ",en:"No records yet",ja:"記録なし"}[v]||"暂无对账记录";A&&(A.textContent=ae,A.style.display=""),U&&(U.style.display="none"),V();return}A&&(A.style.display="none"),U&&(U.style.display="");const R=Math.ceil(T.length/le);ie>R&&(ie=R);const O=(ie-1)*le,Y=T.slice(O,O+le),X=localStorage.getItem("mrpilot_token")||"",de='<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" width="14" height="14"><circle cx="8" cy="8" r="6"/><polyline points="6 8 8 10 10 8"/><line x1="8" y1="4" x2="8" y2="10"/></svg>',se='<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" width="14" height="14"><path d="M8 2v9M4 7l4 4 4-4M3 14h10"/></svg>',ce='<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" width="14" height="14"><polyline points="3 4 13 4"/><path d="M6 4V2.5a.5.5 0 0 1 .5-.5h3a.5.5 0 0 1 .5.5V4"/><path d="M5 4l1 9a1 1 0 0 0 1 1h2a1 1 0 0 0 1-1l1-9"/></svg>';z.innerHTML="",Y.forEach(ae=>{const pe=Number(ae.formula_diff||0),fe=Math.abs(pe)<.05,me=(ae.stmt_files||"").split(";").map(_e=>_e.trim().split(/[/\\]/).pop()).filter(Boolean).join(", "),ge=(ae.gl_files||"").split(";").map(_e=>_e.trim().split(/[/\\]/).pop()).filter(Boolean).join(", "),ye=ae.created_at?String(ae.created_at).slice(0,16).replace("T"," "):"",xe=document.createElement("tr");xe.dataset.taskId=ae.id;const ze=document.createElement("td");ze.textContent=ye;const Te=document.createElement("td");Te.className="glv-history-file",Te.title=me+" + "+ge,Te.textContent=me+" + "+ge;const He=document.createElement("td");He.className="glv-num",He.textContent=(ae.stmt_row_count||0)+" / "+(ae.gl_row_count||0);const it=document.createElement("td");it.className="glv-num",it.textContent=ae.matched_count||0;const rt=document.createElement("td");rt.className="glv-num",rt.textContent=ae.unmatched_gl||0;const lt=document.createElement("td");lt.className="glv-num",lt.textContent=ae.unmatched_stmt||0;const Oe=document.createElement("td");Oe.className="glv-num",Oe.style.color=fe?"#059669":"#dc2626",Oe.textContent=fe?"✓":d(pe);const Ae=document.createElement("td");Ae.className="glv-history-actions";const ct=(_e,Ct,St,kn)=>{const Ie=document.createElement("button");return Ie.type="button",Ie.title=Ct,Ie.setAttribute("aria-label",Ct),St&&(Ie.className=St),Ie.innerHTML=_e,Ie.onclick=_n=>{_n.stopPropagation(),kn()},Ie},gn={zh:"删除这条记录?",th:"ลบรายการนี้?",en:"Delete this record?",ja:"この記録を削除しますか?"}[v]||"删除?",yn={zh:"加载",th:"โหลด",en:"Load",ja:"読込"}[v]||"加载",bn={zh:"导出",th:"ส่งออก",en:"Export",ja:"エクスポート"}[v]||"导出",wn={zh:"删除",th:"ลบ",en:"Delete",ja:"削除"}[v]||"删除";Ae.appendChild(ct(de,yn,"",()=>oe(ae.id,X))),Ae.appendChild(ct(se,bn,"",()=>g(ae.id))),Ae.appendChild(ct(ce,wn,"glv-del",async()=>{await showConfirm(gn,{danger:!0})&&(await fetch("/api/recon/bank-v2/"+ae.id,{method:"DELETE",headers:{Authorization:"Bearer "+X}}),Z())})),[ze,Te,He,it,rt,lt,Oe,Ae].forEach(_e=>xe.appendChild(_e)),xe.style.cursor="pointer",xe.addEventListener("click",async _e=>{_e.target.closest(".glv-del")||_e.target.closest("button")||await oe(ae.id,X)}),z.appendChild(xe)}),V(),ne()}function ne(){const _=((l("brv2-hist-search")||{}).value||"").trim().toLowerCase(),T=l("brv2-history-tbody");T&&T.querySelectorAll("tr").forEach(A=>{A.dataset.taskId&&(A.style.display=!_||A.textContent.toLowerCase().includes(_)?"":"none")})}async function oe(_,T){try{const U=await(await fetch("/api/recon/bank-v2/"+_,{headers:{Authorization:"Bearer "+T}})).json();if(!U.ok)return;o={task_id:U.task_id,...U},i=U.detail||[],s="all",document.querySelectorAll(".brv2-filter-btn").forEach(z=>z.classList.toggle("active",z.dataset.filter==="all")),N(o)}catch{}}function ue(){if(e){Z();return}e=!0,J("brv2-stmt-zone","brv2-stmt-input","stmt"),J("brv2-gl-zone","brv2-gl-input","gl");const _=["brv2-anchor-gl-closing","brv2-anchor-stmt-closing","brv2-anchor-stmt-opening","brv2-anchor-gl-opening"];function T(){const O=parseFloat((l("brv2-anchor-stmt-opening")||{}).value),Y=parseFloat((l("brv2-anchor-gl-opening")||{}).value),X=l("brv2-anchor-eq"),de=l("brv2-anchor-eq-val");if(!(!X||!de))if(Number.isFinite(O)&&Number.isFinite(Y)){const se=O-Y;de.textContent=se.toLocaleString(void 0,{minimumFractionDigits:2,maximumFractionDigits:2}),X.style.display=""}else X.style.display="none"}_.forEach(O=>{const Y=l(O);Y&&(Y.addEventListener("input",T),Y.addEventListener("input",()=>{const X=Y.closest(".brv2-anchor-cell");X&&X.classList.remove("is-prefilled"),k()}))}),j();const A=l("brv2-run-btn");A&&A.addEventListener("click",te);const U=l("brv2-reset-btn");U&&U.addEventListener("click",()=>{o=null,i=[],n=[],a=[],m("stmt"),m("gl"),P(),H(!1);const O=l("brv2-acct-select");O&&(O.style.display="none"),_.forEach(de=>{const se=l(de);if(se){se.value="";const ce=se.closest&&se.closest(".brv2-anchor-cell");ce&&ce.classList.remove("is-prefilled")}});const Y=l("brv2-anchor-eq");Y&&(Y.style.display="none");const X=l("brv2-anchor-prefill-banner");X&&X.classList.remove("show")});const z=l("brv2-new-btn");z&&z.addEventListener("click",()=>{o=null,i=[],n=[],a=[],m("stmt"),m("gl"),P(),H(!1)});const v=l("brv2-filter-tabs");v&&v.addEventListener("click",O=>{O.stopPropagation();const Y=O.target.closest(".brv2-filter-btn");Y&&(s=Y.dataset.filter,v.querySelectorAll(".brv2-filter-btn").forEach(X=>X.classList.toggle("active",X===Y)),K())}),B(),Q();const R=l("brv2-hist-search");R&&R.addEventListener("input",ne),Z(),P(),window._brv2LoadHistory=Z,Array.isArray(window.__i18nSubs)||(window.__i18nSubs=[]),window.__i18nSubs=window.__i18nSubs.filter(O=>O.name!=="brv2"),window.__i18nSubs.push({name:"brv2",fn:function(){P(),m("stmt"),m("gl"),o&&N(o),ee()}})}window._loadBankReconV2Panel=function(_){const T=_?document.getElementById(_):null;T&&T.id!=="recon-pane-bank"&&(T.innerHTML=`<div style="padding:16px;font-size:13px;color:var(--ink-3)">
                银行对账 v2 · 请前往对账中心使用</div>`),ue()},document.addEventListener("DOMContentLoaded",()=>{l("brv2-run-btn")&&ue()}),window._bankReconV2Init=ue})();(function(){const e=document.getElementById("general-lang");if(!e)return;e.addEventListener("change",a=>{const o=a.target.value;o&&applyLang(o)});const n=typeof currentLang=="string"&&currentLang||localStorage.getItem("mrpilot_lang")||"th";e.value=n})();(function(){const n="pearnly_general_tz",a="pearnly_general_date_format",o="pearnly_general_number_format",s={tz:"Asia/Bangkok",date:"YYYY-MM-DD",number:"comma_dot"};function i(){const d=document.getElementById("general-tz"),c=document.getElementById("general-date"),p=document.getElementById("general-number");if(!(!d||!c||!p))try{d.value=localStorage.getItem(n)||s.tz,c.value=localStorage.getItem(a)||s.date,p.value=localStorage.getItem(o)||s.number}catch{d.value=s.tz,c.value=s.date,p.value=s.number}}async function r(){const d=document.getElementById("btn-save-general"),c=document.getElementById("general-save-msg");if(!d)return;const p=d.innerHTML;d.disabled=!0,d.innerHTML="<span>"+(t("msg-saving")||"保存中...")+"</span>",c&&(c.textContent="",c.classList.remove("error"));try{const u=(document.getElementById("general-tz")||{}).value||s.tz,m=(document.getElementById("general-date")||{}).value||s.date,b=(document.getElementById("general-number")||{}).value||s.number;try{localStorage.setItem(n,u),localStorage.setItem(a,m),localStorage.setItem(o,b)}catch{}window._pearnlyGeneral={tz:u,date_format:m,number_format:b},c&&(c.textContent=t("msg-saved")||"已保存")}catch{c&&(c.textContent=t("msg-save-failed")||"保存失败",c.classList.add("error"))}finally{d.disabled=!1,d.innerHTML=p,setTimeout(function(){c&&(c.textContent="")},3e3)}}function f(){const d=document.getElementById("btn-save-general");if(!d){setTimeout(f,200);return}d._pearnlyGenBound||(d._pearnlyGenBound=!0,d.addEventListener("click",r),i())}function l(){i();const d=document.getElementById("general-lang");if(d){const c=typeof currentLang=="string"&&currentLang||localStorage.getItem("mrpilot_lang")||"th";d.value=c}}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",f):f(),typeof window.subscribeI18n=="function"&&window.subscribeI18n("settings-general",l)})();(function(){const e="mrpilot_nav_collapsed",n={ocr:"sales",history:"sales",reconcile:"sales","sales-invoices":"sales",receivables:"sales",vouchers:"expense"};function a(){try{const r=localStorage.getItem(e);return r?JSON.parse(r):{}}catch{return{}}}function o(r){try{localStorage.setItem(e,JSON.stringify(r))}catch{}}function s(){const r=a();document.querySelectorAll(".nav-collapsible").forEach(function(f){const l=f.dataset.collapsible;r[l]?f.classList.add("collapsed"):f.classList.remove("collapsed")})}function i(r){const f=a();f[r]=!f[r],o(f),s()}(function(){const f=a();let l=!1;f.sales===void 0&&(f.sales=!1,l=!0),f.expense===void 0&&(f.expense=!0,l=!0),l&&o(f)})(),s(),document.querySelectorAll(".nav-group-toggle").forEach(function(r){r.addEventListener("click",function(){i(r.dataset.toggleGroup)})}),window.expandNavGroupForRoute=function(r){const f=n[r];if(!f)return;const l=a();l[f]&&(l[f]=!1,o(l),s())}})();const qa=`
