...
LINE_I18N = {
    "zh": {
        ...
        "exp_correct_multiline_amount": "这张票有多行明细,金额需到明细页逐行确认 · 在 pearnly.com 采购里改 🧾",
    ...
    "en": {
        ...
        "exp_correct_multiline_amount": "This receipt has multiple line items — amounts must be confirmed line by line on the detail page at pearnly.com Purchases 🧾",
    ...
    "th": {
        ...
        "exp_correct_multiline_amount": "ใบนี้มีหลายรายการ ต้องยืนยันยอดทีละรายการที่หน้ารายละเอียดบน pearnly.com เมนูจัดซื้อ 🧾",
    ...
    "ja": {
        ...
        "exp_correct_multiline_amount": "この伝票は明細が複数あります。金額は pearnly.com 仕入の明細ページで1行ずつ確認してください 🧾",
