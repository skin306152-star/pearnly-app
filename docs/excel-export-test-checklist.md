...
- [ ] 「银行对账单明细」(รายละเอียดSTATEMENT / Statement Detail / 明細)
...
### 4.3 泰文 (th)
- [ ] §3.1 Sheet 名:สรุป / ผลการจับคู่ / รายละเอียดSTATEMENT / รายละเอียดบัญชีแยกประเภท
- [ ] §3.2 三个 section header:reconciliation summary / ข้อมูลไฟล์ / วิธีใช้งาน
- [ ] §3.3 状态列有 "✓ จับคู่แล้ว" / "GL เดบิตเท่านั้น" / "GL เครดิตเท่านั้น" / "รายการถอนเท่านั้น" / "รายการฝากเท่านั้น"
