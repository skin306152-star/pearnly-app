...
このデバイスは自動的にログアウトされました。`},s={zh:"确定，去登录",en:"OK, Sign in",th:"ตกลง เข้าสู่ระบบ",ja:"OK、ログイン"},o=n[e]?e:"th",i=document.createElement("div");i.id="pn-session-revoked-modal",i.style.cssText="position:fixed;inset:0;z-index:99999;background:rgba(0,0,0,.5);display:flex;align-items:center;justify-content:center;padding:16px;",i.innerHTML='<div style="background:#fff;border-radius:14px;padding:32px 24px 24px;max-width:360px;width:100%;box-shadow:0 12px 40px rgba(0,0,0,.2);text-align:center;"><div style="width:52px;height:52px;border-radius:50%;background:#FEF2F2;display:flex;align-items:center;justify-content:center;margin:0 auto 18px;flex-shrink:0;"><svg width="26" height="26" fill="none" stroke="#DC2626" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" viewBox="0 0 24 24"><circle cx="12" cy="12" r="10"/><line x1="12" y1="8" x2="12" y2="12"/><circle cx="12" cy="16" r=".5" fill="#DC2626"/></svg></div><div style="font-size:16px;font-weight:700;color:#111827;margin-bottom:10px;line-height:1.4;">'+n[o]+'</div><div style="font-size:13px;color:#6B7280;line-height:1.7;margin-bottom:24px;white-space:pre-line;">'+a[o]+'</div><button id="pn-srm-ok" style="width:100%;padding:11px 0;background:#111111;color:#fff;border:none;border-radius:8px;font-size:14px;font-weight:600;cursor:pointer;">'+s[o]+"</button></div>",document.body.appendChild(i),document.getElementById("pn-srm-ok").addEventListener("click",function(){window.location.href="/"})}}function da(){try{if(typeof window.getActiveWorkspaceClientId=="function"){const e=window.getActiveWorkspaceClientId();if(e!=null)return{"X-Workspace-Client-Id":String(e)}}}catch{}return{}}async function el(e){const n=await fetch(e,{headers:{Authorization:"Bearer "+token,...da()}});if(n.status===401||n.status===403){const a=await n.json().catch(()=>({})),s=a&&a.detail;let o="";if(typeof s=="string"?o=s:s&&typeof s=="object"&&(o=s.code||""),n.status===401||typeof o=="string"&&o.indexOf("auth.")>=0){if(console.warn("[auth-fail-redirect]",e,n.status,s),localStorage.removeItem("mrpilot_token"),o==="auth.session_revoked")ca();else{const l=o==="auth.password_changed_relogin"?"alert-password-changed-relogin":"alert-session";showToast(la(l),"error"),setTimeout(()=>{window.location.href="/"},1500)}return null}const r=new Error("biz_403");throw r.detail=s,r}if(!n.ok)throw new Error("fetch failed");return await n.json()}async function tl(e,n){const a=await fetch(e,{method:"POST",headers:{Authorization:"Bearer "+token,"Content-Type":"application/json",...da()},body:JSON.stringify(n)});if(a.status===401||a.status===403){const o=await a.clone().json().catch(()=>({})),i=o&&o.detail;let r="";if(typeof i=="string"?r=i:i&&typeof i=="object"&&(r=i.code||""),a.status===401||typeof r=="string"&&r.indexOf("auth.")>=0){if(console.warn("[auth-fail-redirect]",e,a.status,i),localStorage.removeItem("mrpilot_token"),r==="auth.session_revoked")ca();else{const m=r==="auth.password_changed_relogin"?"alert-password-changed-relogin":"alert-session";showToast(la(m),"error"),setTimeout(()=>{window.location.href="/"},1500)}return null}return a}return a}async function nl(e,n){try{const a=await fetch(e,{method:"PUT",headers:{Authorization:"Bearer "+token,"Content-Type":"application/json",...da()},body:JSON.stringify(n)});if(a.status===401||a.status===403){const o=await a.json().catch(()=>({})),i=o&&o.detail;let r="";if(typeof i=="string"?r=i:i&&typeof i=="object"&&(r=i.code||""),a.status===401||typeof r=="string"&&r.indexOf("auth.")>=0){if(console.warn("[auth-fail-redirect]",e,a.status,i),localStorage.removeItem("mrpilot_token"),r==="auth.session_revoked")ca();else{const m=r==="auth.password_changed_relogin"?"alert-password-changed-relogin":"alert-session";showToast(la(m),"error"),setTimeout(()=>{window.location.href="/"},1500)}return{ok:!1}}return{ok:!1,status:a.status,detail:i}}const s=await a.json().catch(()=>({}));return{ok:a.ok&&s.ok!==!1,...s}}catch(a){return{ok:!1,error:String(a)}}}window.apiGet=el;window.apiPost=tl;window.t=la;window.escapeHtml=Zr;window.svgIcon=Qr;window._showSessionRevokedModal=ca;window._wsHeader=da;window.apiPut=nl;window.getMaxFiles=Yr;window.getMaxPagesPerFile=Jr;window.getMaxMbPerFile=Xr;function $e(e,n){const a=document.getElementById(e);if(!(!a||a.dataset.wbInjected==="1")){a.innerHTML=n,a.dataset.wbInjected="1";try{const s=window._currentLang||localStorage.getItem("mrpilot_lang")||"th",o=window.I18N;if(!o||!o[s])return;a.querySelectorAll("[data-i18n]").forEach(i=>{const r=i.getAttribute("data-i18n");r&&o[s][r]&&(i.textContent=o[s][r])}),a.querySelectorAll("[data-i18n-placeholder]").forEach(i=>{const r=i.getAttribute("data-i18n-placeholder");r&&o[s][r]&&(i.placeholder=o[s][r])})}catch{}}}const al=`
        <!-- v85 · 模块头 · 视觉对齐其他页 -->
...
`,e.dataset.wbInjected="1";try{const n=window._currentLang||localStorage.getItem("mrpilot_lang")||"th",a=window.I18N;a&&a[n]&&(e.querySelectorAll("[data-i18n]").forEach(s=>{const o=s.getAttribute("data-i18n");a[n][o]&&(s.textContent=a[n][o])}),e.querySelectorAll("[data-i18n-placeholder]").forEach(s=>{const o=s.getAttribute("data-i18n-placeholder");a[n][o]&&(s.placeholder=a[n][o])}))}catch{}}})();(function(){const e=document.getElementById("page-settings");if(!(!e||e.dataset.wbInjected==="1")){e.innerHTML=`
        ...
        <!-- /settings-layout -->
`,e.dataset.wbInjected="1";try{const n=window._currentLang||localStorage.getItem("mrpilot_lang")||"th",a=window.I18N;a&&a[n]&&(e.querySelectorAll("[data-i18n]").forEach(s=>{const o=s.getAttribute("data-i18n");a[n][o]&&(s.textContent=a[n][o])}),e.querySelectorAll("[data-i18n-placeholder]").forEach(s=>{const o=s.getAttribute("data-i18n-placeholder");a[n][o]&&(s.placeholder=a[n][o])}))}catch{}}})();const vl=`
        <div class="page-head-clean">
            <div class="page-head-icon">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
...
`;(function(){const e=document.getElementById("page-automation");if(!(!e||e.dataset.wbInjected==="1")){e.innerHTML=vl+fl,e.dataset.wbInjected="1";try{const n=window._currentLang||localStorage.getItem("mrpilot_lang")||"th",a=window.I18N;a&&a[n]&&(e.querySelectorAll("[data-i18n]").forEach(s=>{const o=s.getAttribute("data-i18n");o&&a[n][o]&&(s.textContent=a[n][o])}),e.querySelectorAll("[data-i18n-placeholder]").forEach(s=>{const o=s.getAttribute("data-i18n-placeholder");o&&a[n][o]&&(s.placeholder=a[n][o])}))}catch{}}})();(function(){const e={"page-integration":`
        <div class="coming-soon">
            <svg class="cs-icon" viewBox="0 0 48 48" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
...
`,e.dataset.wbInjected="1";try{const n=window._currentLang||localStorage.getItem("mrpilot_lang")||"th",a=window.I18N;a&&a[n]&&e.querySelectorAll("[data-i18n]").forEach(s=>{const o=s.getAttribute("data-i18n");a[n][o]&&(s.textContent=a[n][o])})}catch{}}})();function hl(e,n){const a=document.getElementById("alert-"+e);a&&(document.getElementById("alert-"+e+"-text").textContent=n,a.classList.add("show"))}function gl(){["info","warn","error"].forEach(e=>{document.getElementById("alert-"+e).classList.remove("show")})}function bl(e,n){if(e==null)return n||"操作失败";if(typeof e=="string")return e;if(Array.isArray(e)){const a=e[0]||{};return a.msg?a.msg:n||"请求格式错误"}if(typeof e=="object"){if(e.code){const a="err."+e.code;try{const s=t(a,e);if(s&&s!==a)return s}catch(s){console.warn("[i18n] t() failed for key:",a,s)}return e.code}if(e.message)return e.message;if(e.error)return e.error;if(e.detail&&typeof e.detail=="string")return e.detail;try{return JSON.stringify(e).slice(0,160)}catch{}}return n||String(e)}function yl(e){if(!e)return"";const n=String(e);return/ECONNREFUSED|Connection refused/i.test(n)?"连接被拒绝 · ERP 地址可能错了,或服务没启动":/listing fetch failed|wait_for_selector/i.test(n)?"拉取 MR.ERP 客户/商品列表超时 · 已重试 3 次仍不通 · 可能 MR.ERP 响应慢 · 稍后再试":/ETIMEDOUT|timeout/i.test(n)?"连接超时 · MR.ERP 响应慢 · 稍后再试":/ENOTFOUND|getaddrinfo/i.test(n)?"域名解析失败 · ERP 地址拼错了":/certificate|SSL/i.test(n)?"SSL 证书问题 · ERP 站点证书异常":/401|Unauthorized/i.test(n)?"HTTP 401 · 认证失败,检查 Token 是否正确":/403|Forbidden/i.test(n)?"HTTP 403 · 权限不足,ERP 拒绝访问":/404|Not Found/i.test(n)?"HTTP 404 · URL 路径不存在":/^5\d\d/.test(n)||/500|502|503|504/.test(n)?"ERP 服务器错误 · 不是你的问题,等会儿再试":n}function wl(e,n,a){let s=document.getElementById("mp-toast-wrap");s||(s=document.createElement("div"),s.id="mp-toast-wrap",document.body.appendChild(s)),n=n||"success",n==="ok"&&(n="success"),n==="warning"&&(n="warn"),n==="danger"&&(n="error");const o={success:'<path d="M3 8l3 3 7-7"/>',error:'<circle cx="8" cy="8" r="6"/><path d="M5.5 5.5l5 5M10.5 5.5l-5 5"/>',warn:'<path d="M8 2L1.5 13h13L8 2z"/><path d="M8 7v3M8 12v.01"/>',info:'<circle cx="8" cy="8" r="6"/><path d="M8 5.5v.01M8 8v3"/>',loading:'<path d="M8 1a7 7 0 017 7" stroke-linecap="round" class="mp-toast-spin"/>'},i=document.createElement("div");i.className="mp-toast "+n,i.innerHTML=`
    ...
    `,s.appendChild(i),requestAnimationFrame(()=>i.classList.add("show"));const r=typeof a=="number"?a:2500;let l=null;const m=()=>{l&&(clearTimeout(l),l=null),i.classList.remove("show"),setTimeout(()=>{try{i.remove()}catch{}},300)};return r>0&&(l=setTimeout(m,r)),m}window.showAlert=hl;window.hideAlerts=gl;window._humanizeBackendError=bl;window.humanizeError=yl;window.showToast=wl;function kl(e,n){return n=n||{},new Promise(a=>{const s=document.getElementById("confirm-modal"),o=document.getElementById("confirm-modal-body"),i=document.getElementById("confirm-modal-ok"),r=document.getElementById("confirm-modal-cancel"),l=document.getElementById("confirm-modal-close"),m=document.getElementById("confirm-modal-title");if(!s||!o||!i||!r){a(!1);return}m.textContent=n.title||t("confirm-default-title");const d=n.promptInput?"cm_in_"+Date.now():null;if(n.promptInput){const v=(e||"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;"),f=(n.placeholder||"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;");o.innerHTML=`
        ...
        `;const s=document.getElementById("api-key-card");s&&(s.style.display="");return}Bl(n,e);const a=document.getElementById("api-key-card");if(a){const s=tt==="byo_api"||_userInfo&&_userInfo.is_super_admin;a.style.display=s?"":"none"}}function Bl(e,n){const a=escapeHtml(e.username||e.email||"");n.innerHTML=`
        <table style="width:100%; font-size:13px; border-collapse: collapse;">
            <tr>
    ...
    `}window.switchSettingsTab=xl;window.fillSettingsForms=_l;window.saveProfile=El;window.saveCompany=Il;window.renderSettings=Fa;function pa(e){return e=e||_userInfo,!!(e&&e.is_super_admin)}function ls(e){return e=e||_userInfo,!!e&&(e.role==="owner"||pa(e))}function ci(e){return e=e||_userInfo,!!e&&e.role==="member"&&!pa(e)}function Ll(e){return e=e||_userInfo,!!e&&(e.effective_plan==="trial"||e.plan==="trial")&&!pa(e)}function di(e){return e=e||_userInfo,!!e&&e.tenant_type==="byo_api"}function pi(e){return ci(e)}function $l(e){return ls(e)}function Sl(e){return ls(e)&&di(e)}window.isMoneyHidden=pi;window.isSuperAdmin=pa;window.isOwner=ls;window.isEmployee=ci;window.isTrial=Ll;window.isLifetime=di;window.shouldHideMoney=pi;window.canManageTeam=$l;window.canManageApiKey=Sl;function Cl(){const e=document.getElementById("quota-banner");if(!e)return;if(!_userInfo){e.style.display="none";return}if(_userInfo.is_super_admin||_userInfo.tenant_type==="admin"||_userInfo.tenant_type==="byo_api"){e.style.display="none";return}let n=0,a=0;if(_userInfo.plan==="free"&&_quota&&_quota.ip_daily_limit)n=_quota.ip_used_today||0,a=_quota.ip_daily_limit;else if(_userInfo.tenant_quota!=null&&_userInfo.tenant_quota>0)n=_userInfo.tenant_used||0,a=_userInfo.tenant_quota;else if(_userInfo.monthly_quota&&_userInfo.monthly_quota>0)n=_userInfo.used_this_month||0,a=_userInfo.monthly_quota;else{e.style.display="none";return}if(a<=0){e.style.display="none";return}const s=Math.max(0,a-n),o=n/a*100,i="quota_banner_dismiss_"+new Date().toISOString().slice(0,10);if(localStorage.getItem(i)){e.style.display="none";return}let r,l;if(s===0)r="danger",l=t("quota-banner-exhausted");else if(o>=90)r="danger",l=t("quota-banner-very-low",{n:s});else if(o>=70)r="warn",l=t("quota-banner-low",{n:s});else{e.style.display="none";return}e.className="quota-banner "+r,e.innerHTML=`
    ...
    `,e.style.display="flex";const m=e.querySelector(".quota-banner-close");m&&m.addEventListener("click",()=>{localStorage.setItem(i,"1"),e.style.display="none"})}function Tl(){const e=_userInfo;if(!e)return;const n=shouldHideMoney(e),a=canManageTeam(e),s=canManageApiKey(e),o=document.querySelector('.nav-item[data-route="templates"]');o&&(o.classList.remove("locked-for-plan"),o.removeAttribute("data-locked-target"));const i=document.querySelector('.nav-item[data-route="api-keys"]');i&&(i.classList.remove("locked-for-plan"),i.removeAttribute("data-locked-target"));const r=document.getElementById("btn-custom-template");r&&(r.style.display="",r.classList.remove("locked-for-plan"));const l=document.querySelector('.settings-tab[data-tab="team"]');l&&(l.style.display=a?"":"none");const m=document.querySelector('.settings-panel[data-settings-panel="team"]');m&&(m.dataset.permHidden=a?"0":"1");const d=document.querySelector('.settings-tab[data-tab="api"]');d&&(d.style.display=s||isSuperAdmin(e)?"":"none");const p=document.querySelector('.settings-tab[data-tab="plan"]');p&&(p.style.display=n?"none":"");const c=document.querySelector('.settings-tab[data-tab="company"]');c&&(c.style.display=n?"none":"");const u=document.getElementById("info-bar");u&&(u.style.display=n?"none":"");const v=document.getElementById("trial-banner");v&&n&&(v.style.display="none");const f=document.getElementById("plan-banner");f&&n&&(f.style.display="none",document.body.classList.remove("has-plan-banner")),document.querySelectorAll("[data-upgrade-cta], .btn-upgrade, .topbar-upgrade").forEach(y=>{y.style.display="none"}),document.body.classList.toggle("role-employee",isEmployee(e)),document.body.classList.toggle("role-owner",isOwner(e)),document.body.classList.toggle("role-super",isSuperAdmin(e));try{const y=document.querySelector(".settings-tab.active");y&&y.style.display==="none"&&(typeof window.switchSettingsTab=="function"?window.switchSettingsTab("profile"):typeof switchSettingsTab=="function"&&switchSettingsTab("profile"))}catch(y){console.warn("[v118.12.3] failed to fix active tab:",y)}if(window.PEARNLY_ADMIN_MODE){const y=document.getElementById("admin-mode-banner");y&&(y.style.display="flex"),document.querySelectorAll(".nav-item").forEach(g=>{g.classList.contains("nav-admin-only")||(g.style.display="none")}),document.querySelectorAll(".nav-group").forEach(g=>{g.classList.contains("nav-group-admin-only")||(g.style.display="none")});const b=document.getElementById("client-switcher");b&&(b.style.display="none"),document.body.classList.add("admin-mode");const h=["profile","security","notifications","about"];document.querySelectorAll(".settings-tab").forEach(g=>{const _=g.dataset.tab;_&&!h.includes(_)&&(g.style.display="none")}),document.querySelectorAll(".settings-pane").forEach(g=>{const _=g.dataset.pane;_&&!h.includes(_)&&(g.style.display="none")}),document.querySelectorAll(".settings-nav-group").forEach(g=>{const _=g.querySelectorAll(".settings-tab");Array.from(_).some(k=>k.style.display!=="none")||(g.style.display="none")})}}function Ml(){const e=_userInfo,n=document.getElementById("info-bar");if(!e||shouldHideMoney(e)){n&&(n.innerHTML="");return}let a="";const s=e.tenant_type;if(s==="byo_api")e.has_own_gemini_key?a=`
        ...
        `;else{const o=e.tenant_used!=null?e.tenant_used:e.used_this_month||0,i=e.tenant_quota!=null&&e.tenant_quota>0?e.tenant_quota:e.monthly_quota||0,r=i>0?Math.min(100,o/i*100):0;let l="";r>=95?l="danger":r>=80&&(l="warn"),i>0?a=`
            ...
            `:a=""}n&&(n.innerHTML=a)}window.renderQuotaBanner=Cl;window.applySidebarVisibility=Tl;window.renderInfoBar=Ml;async function ui(e,n){try{const a=await fetch(e,{method:"POST",headers:{Authorization:"Bearer "+token,"Content-Type":"application/json"},body:JSON.stringify(n)});if(a.status===401){localStorage.removeItem("mrpilot_token");const s=await a.json().catch(()=>({}));return(typeof s.detail=="string"?s.detail:s.detail&&s.detail.code||"")==="auth.session_revoked"?(_showSessionRevokedModal(),null):(window.location.href="/",null)}return await a.json()}catch{return{ok:!1,error:"network"}}}function mi(e){return{invalid_format:"rd-err-format",not_found:"rd-err-not-found",rd_unreachable:"rd-err-unreachable",parse_error:"rd-err-unknown",network:"rd-err-unreachable"}[e]||"rd-err-unknown"}function Gn(e){const n=document.querySelector(`[data-field="${e}"]`);return n?(n.value||"").trim():""}function Lt(e,n,a){const s=document.querySelector(`[data-rd-status="${e}"]`);s&&(s.innerHTML=n,s.className="rd-status"+(a?" "+a:""))}async function Hl(e){const a=Gn(e==="seller"?"seller_tax":"buyer_tax");Lt(e,t("rd-verifying"),"loading");const s=await ui("/api/rd/verify",{tax_id:a});if(!s)return;if(!s.ok){Lt(e,t(mi(s.error)),"error");return}s.data&&s.data.valid?Lt(e,`<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="2"><path d="M3 8l3 3 7-7"/></svg> ${escapeHtml(t("rd-status-valid"))}`,"valid"):Lt(e,t("rd-status-invalid"),"invalid")}async function Al(e){const a=Gn(e==="seller"?"seller_tax":"buyer_tax");Lt(e,t("rd-syncing"),"loading");const s=await ui("/api/rd/lookup",{tax_id:a,branch:0});if(s){if(!s.ok){Lt(e,t(mi(s.error)),"error");return}Lt(e,`<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="2"><path d="M3 8l3 3 7-7"/></svg> ${escapeHtml(t("rd-status-valid"))}`,"valid"),jl(e,s.data)}}function jl(e,n){const a=e==="seller"?"seller_name":"buyer_name",s=e==="seller"?"seller_addr":"buyer_addr",o=Gn(a),i=Gn(s),r=[];n.name&&n.name!==o&&r.push({field:a,label:t("rd-field-name"),current:o,official:n.name}),n.address&&n.address!==i&&r.push({field:s,label:t("rd-field-address"),current:i,official:n.address});const l=[];n.branch_label&&l.push(`<strong>${t("rd-field-branch")}:</strong> ${escapeHtml(n.branch_label)}`),n.post_code&&l.push(`<strong>${t("rd-field-postcode")}:</strong> ${escapeHtml(n.post_code)}`);let m=document.getElementById("rd-sync-modal");if(m||(m=document.createElement("div"),m.id="rd-sync-modal",m.className="rd-modal-mask",document.body.appendChild(m)),r.length===0)m.innerHTML=`
            <div class="rd-modal">
    ...
    `;let o=_results.map((r,l)=>({...r,_idx:l}));if(_searchKeyword){const r=_searchKeyword.toLowerCase();o=o.filter(l=>(l.filename||"").toLowerCase().includes(r)||(l.merged_fields.invoice_number||"").toLowerCase().includes(r))}_sortKey&&o.sort((r,l)=>{let m,d;return _sortKey==="filename"?(m=r.filename,d=l.filename):_sortKey==="invoice_no"?(m=r.merged_fields.invoice_number,d=l.merged_fields.invoice_number):_sortKey==="invoice_date"?(m=r.merged_fields.date,d=l.merged_fields.date):_sortKey==="total"?(m=parseFloat(r.merged_fields.total_amount)||0,d=parseFloat(l.merged_fields.total_amount)||0):_sortKey==="confidence"?(m=r.confidence,d=l.confidence):(m="",d=""),m<d?_sortDir==="asc"?-1:1:m>d?_sortDir==="asc"?1:-1:0});const i=document.getElementById("results-tbody");i.innerHTML=o.map((r,l)=>{const m=r.merged_fields,d=`<span class="empty-cell">${t("empty-val")}</span>`,p="conf-tip-"+(r.confidence||"low"),c="conf-"+(r.confidence||"low"),u=t(p),v=t(c);return`
        ...
        `}).join(""),document.querySelectorAll("#results-table th").forEach(r=>{r.classList.remove("sort-asc","sort-desc"),r.dataset.sort===_sortKey&&r.classList.add("sort-"+_sortDir)}),i.querySelectorAll("tr").forEach(r=>{r.addEventListener("click",()=>{const l=parseInt(r.dataset.idx,10);hi(l)})})}document.querySelectorAll("#results-table th").forEach(e=>{e.classList.contains("no-sort")||e.addEventListener("click",()=>{const n=e.dataset.sort;_sortKey===n?_sortDir=_sortDir==="asc"?"desc":"asc":(_sortKey=n,_sortDir="asc"),ua()})});let Qs=null;document.getElementById("search-input").addEventListener("input",e=>{const n=e.target.value;document.getElementById("search-clear").style.display=n?"":"none",clearTimeout(Qs),Qs=setTimeout(()=>{_searchKeyword=n.trim(),ua(),fi()},200)});document.getElementById("search-clear").addEventListener("click",()=>{const e=document.getElementById("search-input");e.value="",_searchKeyword="",document.getElementById("search-clear").style.display="none",ua(),fi(),e.focus()});function fi(){const e=document.getElementById("search-matches");if(!e)return;if(!_searchKeyword){e.textContent="";return}const n=_searchKeyword.toLowerCase();let a=0;for(const s of _results)[s.filename,s.merged_fields?.invoice_number,s.merged_fields?.seller_name,s.merged_fields?.buyer_name].filter(Boolean).join(" ").toLowerCase().includes(n)&&a++;e.textContent=t("search-matches",{n:a})}function hi(e){_drawerIdx=e;const n=_results[e];if(!n)return;document.getElementById("drawer-title").textContent=n.filename;const a=n.engine==="cache"||n.from_cache,s=a?t("badge-cached-hint"):`${(n.elapsed_ms/1e3).toFixed(1)}s`;document.getElementById("drawer-sub").innerHTML=`
    ...
    `,d=i?"":`<span class="tax-badge unverified" data-tip="${escapeHtml(t("tax-tip-unverified"))}">${t("tax-unverified")}</span>`;if(l.innerHTML=`
        ...
        <div class="drawer-section">
            ...
            ${r.wht_amount||r.wht_rate?`
                ${Se("wht_amount","drawer-lbl-wht-amount",r.wht_amount,"input",o,Rl(r.wht_rate))}
            `:""}
        </div>
        ...
        <div class="drawer-section">
            ...
            ${Se("seller_tax","drawer-lbl-tax",r.seller_tax,"input",o,d,eo("seller"))}
        ...
        <div class="drawer-section">
            ...
            ${Se("buyer_tax","drawer-lbl-tax",r.buyer_tax,"input",o,d,eo("buyer"))}
        ...
        <div class="drawer-section">
            ...
            ${r.items&&r.items.length>0?Fl(r.items):`<div class="drawer-items-empty">${t("drawer-items-empty")}</div>`}
        </div>
...
`))}</pre>
    ...
    `,o?l.querySelectorAll("[data-field]").forEach(p=>{p.addEventListener("input",onFieldEdit)}):l.querySelectorAll("[data-field]").forEach(p=>{p.setAttribute("readonly","readonly")}),document.getElementById("drawer-mask").classList.add("show"),document.getElementById("drawer").classList.add("show"),injectOcrPushButton(),typeof window.bindDrawerClient=="function"){const p=n._historyId||n.history_id||null;window.bindDrawerClient(p,n.client_id||null)}typeof window.fillCategoryDatalist=="function"&&window.fillCategoryDatalist(),setTimeout(()=>{const p=document.getElementById("drawer-cat-input");p&&!p.value&&!p.readOnly&&p.focus()},80)}function Rl(e){return e?`<span class="wht-badge">${escapeHtml(e)}%</span>`:""}function Se(e,n,a,s,o,i,r){const l=_results[_drawerIdx],m=l&&l.edits[e]!==void 0?l.edits[e]:a,d=l&&l.edits[e]!==void 0&&l.edits[e]!==a,p=escapeHtml(m??""),c=o?"":"readonly",u=s==="textarea"?`<textarea data-field="${e}" rows="2">${p}</textarea>`:`<input type="text" data-field="${e}" value="${p}">`;return`
    ...
    `;n.innerHTML=s+o,e.appendChild(n)}function Ea(){const e=document.getElementById("export-dropdown");e&&e.remove()}const Ia=document.getElementById("btn-export-arrow");Ia&&Ia.addEventListener("click",e=>{e.stopPropagation(),!Ia.disabled&&Gl()});document.addEventListener("click",e=>{const n=e.target.closest(".export-dd-item");if(n){const a=n.getAttribute("data-tpl");if(a==="__custom"){Ea(),showToast(t("cs-coming-soon"),"info");return}Ul(a),Ea(),yi(a);return}e.target.closest("#btn-export-arrow")||Ea()});function Wl(){const e=document.getElementById("btn-export-arrow"),n=document.getElementById("btn-export");e&&n&&(e.disabled=n.disabled)}setInterval(Wl,300);const Kl=`
        <div class="page-head-clean">
            <div class="page-head-icon">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
...
`;(function(){const e=document.getElementById("page-history");if(!(!e||e.dataset.wbInjected==="1")){e.innerHTML=Kl,e.dataset.wbInjected="1";try{const n=window._currentLang||localStorage.getItem("mrpilot_lang")||"th",a=window.I18N;a&&a[n]&&(e.querySelectorAll("[data-i18n]").forEach(s=>{const o=s.getAttribute("data-i18n");a[n][o]&&(s.textContent=a[n][o])}),e.querySelectorAll("[data-i18n-placeholder]").forEach(s=>{const o=s.getAttribute("data-i18n-placeholder");a[n][o]&&(s.placeholder=a[n][o])}))}catch{}}})();function cs(){const e=document.getElementById("history-batch-bar"),n=document.getElementById("history-batch-count"),a=document.getElementById("history-check-all");if(!e||!n)return;const s=_historySelected.size;if(s>0?(e.style.display="",n.textContent=t("history-batch-count",{n:s})):e.style.display="none",a){const o=_historyState.items||[];if(o.length===0)a.checked=!1,a.indeterminate=!1;else{const i=o.filter(r=>_historySelected.has(r.id)).length;a.checked=i===o.length,a.indeterminate=i>0&&i<o.length}}}function Yl(){_historySelected.clear(),cs()}async function ds(){if(!_userInfo){setTimeout(()=>ds(),300);return}const e=document.getElementById("history-free-block"),n=document.getElementById("history-main"),a=document.getElementById("history-empty");if(!e||!n||!a){console.warn("[History] container missing");return}if(!_userInfo.can_view_history){e.style.display="",n.style.display="none",a.style.display="none";return}e.style.display="none",_historyState.loading=!0;try{const s=_historyState.page*_historyState.pageSize,o=new URLSearchParams({limit:_historyState.pageSize,offset:s});_historyState.keyword&&o.set("keyword",_historyState.keyword);const i=typeof window.getCurrentClientId=="function"?window.getCurrentClientId():null;i&&o.set("client_id",String(i));const r=await fetch(`/api/history?${o}`,{headers:{Authorization:"Bearer "+token}});if(r.status===401){localStorage.removeItem("mrpilot_token");const d=await r.json().catch(()=>({}));if((typeof d.detail=="string"?d.detail:d.detail&&d.detail.code||"")==="auth.session_revoked"){_showSessionRevokedModal();return}window.location.href="/";return}const l=await r.json();_historyState.items=l.items||[],_historyState.total=l.total||0;const m=new Set(_historyState.items.map(d=>d.id));for(const d of Array.from(_historySelected))m.has(d)||_historySelected.delete(d);wi()}catch(s){console.error("load history failed",s)}finally{_historyState.loading=!1}}function wi(){const e=document.getElementById("history-main"),n=document.getElementById("history-empty"),a=_historyState.items,s=document.getElementById("history-search-matches");if(s&&(s.textContent=_historyState.keyword?t("search-matches",{n:_historyState.total}):""),a.length===0&&_historyState.total===0&&!_historyState.keyword){e.style.display="none",n.style.display="";return}e.style.display="",n.style.display="none";let o=0;a.forEach(d=>{d.confidence==="high"&&o++});const i=a.length>0?Math.round(o/a.length*100):0;document.getElementById("history-stats").innerHTML=`
    ...
    `;const r=document.getElementById("history-tbody");a.length===0?r.innerHTML=`<div class="history-row-empty">${escapeHtml(t("history-empty-title"))}</div>`:r.innerHTML=a.map(d=>{const p=new Date(d.created_at),c=String(p.getMonth()+1).padStart(2,"0"),u=String(p.getDate()).padStart(2,"0"),v=String(p.getHours()).padStart(2,"0"),f=String(p.getMinutes()).padStart(2,"0"),y=`${c}-${u} ${v}:${f}`,b=escapeHtml(d.filename||""),h=b.length>50?b.substring(0,50)+"…":b,g=d.invoice_no?escapeHtml(d.invoice_no):h,_=[];d.seller_name&&_.push(escapeHtml(d.seller_name)),d.invoice_no&&d.filename&&_.push(h);const w=_.join(" · ")||"-",k=d.category_tag?`<span class="history-badge category">${escapeHtml(d.category_tag)}</span>`:"",x=d.source_total&&d.source_total>1?`<span class="history-badge multi">${escapeHtml(t("invoice-part-of",{i:d.source_index||1,n:d.source_total}))}</span>`:"",E=d.total_amount!==null&&d.total_amount!==void 0?Number(d.total_amount).toLocaleString(void 0,{minimumFractionDigits:2,maximumFractionDigits:2}):'<span class="history-cell-amount-empty">—</span>',I=[];(d.total_amount===null||d.total_amount===void 0)&&I.push(t("field-amount")),d.invoice_no||I.push(t("field-invoice-no")),d.invoice_date||I.push(t("field-invoice-date")),d.seller_name||I.push(t("field-seller-name")),I.length>0&&`${escapeHtml(d.id)}${escapeHtml(t("history-needs-review-tip")+" · "+I.join(" · "))}${escapeHtml(t("history-needs-review-tip"))}${svgIcon("alert",14)}`,d.edited&&`${escapeHtml(t("history-edited",{n:d.edit_count||1}))}`;const B=d.smart_assigned_flag?`<span class="history-badge smart-assigned" title="${escapeHtml(t("history-smart-assigned"))}">${svgIcon("sparkle",11)}</span>`:"",L=d.confidence==="high"?"high":d.confidence==="medium"?"mid":"low",$=d.confidence==="high"?t("conf-high"):d.confidence==="medium"?t("conf-medium"):t("conf-low"),S=`<span class="history-badge conf-${L}">${escapeHtml($)}</span>`;let M="";const R=d.source||"manual";return R==="email"?M=`<span class="history-badge source source-email" title="${escapeHtml(t("history-source-email"))}">${svgIcon("mail",11)}<span>${escapeHtml(t("history-source-email"))}</span></span>`:R==="folder"?M=`<span class="history-badge source source-folder" title="${escapeHtml(t("history-source-folder"))}">${svgIcon("folder",11)}<span>${escapeHtml(t("history-source-folder"))}</span></span>`:R==="api"&&(M=`<span class="history-badge source source-api" title="${escapeHtml(t("history-source-api"))}">${svgIcon("api",11)}<span>${escapeHtml(t("history-source-api"))}</span></span>`),`
            ...
            `}).join(""),cs();const l=a.length>0?_historyState.page*_historyState.pageSize+1:0,m=_historyState.page*_historyState.pageSize+a.length;document.getElementById("history-pager-info").textContent=t("history-pager",{from:l,to:m,total:_historyState.total}),document.getElementById("history-prev").disabled=_historyState.page===0,document.getElementById("history-next").disabled=(_historyState.page+1)*_historyState.pageSize>=_historyState.total}window.loadHistoryPage=ds;window.renderHistoryList=wi;window.updateHistoryBatchBar=cs;window.clearHistorySelection=Yl;typeof currentRoute<"u"&&currentRoute==="history"&&ds();async function Wn(e){try{const n=await fetch(`/api/history/${encodeURIComponent(e)}`,{headers:{Authorization:"Bearer "+token}});if(!n.ok)return;const a=await n.json(),s=mergeFields(a.pages||[]),o={filename:a.filename,pages:a.pages,page_count:a.page_count,elapsed_ms:a.elapsed_ms,engine:"history",merged_fields:s,edits:{},confidence:a.confidence,archive_name:a.archive_name||null,category_tag:a.category_tag||null,_historyId:a.id,_historyMode:!0,client_id:a.client_id||null};_results.push(o),_drawerIdx=_results.length-1,openDrawer(_drawerIdx),Xl(),typeof window.bindDrawerClient=="function"&&window.bindDrawerClient(a.id,a.client_id||null),Zl(a.id)}catch(n){console.error("open history detail failed",n)}}async function Jl(e){await Wn(e),requestAnimationFrame(()=>{const n=document.querySelector('[data-field="total_amount"]');if(n){try{n.focus()}catch{}try{n.select()}catch{}try{n.scrollIntoView({block:"center",behavior:"smooth"})}catch{}}})}function Xl(){const e=document.getElementById("drawer-body");if(!e||document.getElementById("drawer-history-save"))return;const n=document.createElement("div");n.id="drawer-history-save",n.className="drawer-history-save-bar",n.innerHTML=`
    ...
    `,e.appendChild(n),document.getElementById("btn-save-history").addEventListener("click",ec),document.getElementById("btn-push-erp").addEventListener("click",Ql)}async function Zl(e){}async function Ql(){showToast(t("erp-push-coming-soon")||"ERP 推送即将开放，敬请期待","info")}async function ec(){const e=_results[_drawerIdx];if(!e||!e._historyId)return;const n=JSON.parse(JSON.stringify(e.pages||[]));if(n.length>0){const s=n.findIndex(l=>!l.is_duplicate&&!l.is_copy),o=s>=0?s:0,i=n[o].fields||(n[o].fields={}),r={...e.edits};r.category_tag!==void 0&&(r.category=r.category_tag,delete r.category_tag),Object.assign(i,r)}const a=document.getElementById("btn-save-history");a&&(a.disabled=!0);try{if(!(await fetch(`/api/history/${encodeURIComponent(e._historyId)}`,{method:"PUT",headers:{Authorization:"Bearer "+token,"Content-Type":"application/json"},body:JSON.stringify({pages:n})})).ok)throw new Error("save failed");showAlert("info",t("history-save-ok")),setTimeout(hideAlerts,1500),closeDrawer(),e._historyMode&&_results.pop(),loadHistoryPage()}catch{showAlert("error",t("history-save-fail")),a&&(a.disabled=!1)}}function tc(e,n){document.querySelectorAll(".history-popover").forEach(d=>d.remove());const a=n.getBoundingClientRect(),s=(_historyState.items||[]).find(d=>d.id===e),o=s&&s.invoice_no?String(s.invoice_no):"",i=s&&s.has_pdf===!0,r=document.createElement("div");r.className="history-popover",r.innerHTML=`
...
`;$e("camera-tips-modal",oc);async function Kn(e){return new Promise(n=>{const a=new FileReader;a.onerror=()=>n({warnings:[],width:0,height:0,brightness:128}),a.onload=()=>{const s=new Image;s.onerror=()=>n({warnings:[],width:0,height:0,brightness:128}),s.onload=()=>{const o=[],i=s.naturalWidth,r=s.naturalHeight;(i<1e3||r<1e3)&&o.push("low_res");try{const l=document.createElement("canvas");l.width=64,l.height=64;const m=l.getContext("2d");m.drawImage(s,0,0,64,64);const d=m.getImageData(0,0,64,64).data;let p=0,c=0;for(let v=0;v<d.length;v+=4)p+=.299*d[v]+.587*d[v+1]+.114*d[v+2],c++;const u=c?p/c:128;u<70?o.push("too_dark"):u>235&&o.push("too_bright"),n({warnings:o,width:i,height:r,brightness:u})}catch{n({warnings:o,width:i,height:r,brightness:128})}},s.src=a.result},a.readAsDataURL(e)})}async function xi(e){if(!e||e.length===0)return null;const{jsPDF:n}=window.jspdf,a=210,s=297,o=new n({unit:"mm",format:"a4",orientation:"p"});for(let d=0;d<e.length;d++){const p=e[d],{dataUrl:c,naturalW:u,naturalH:v}=await ic(p);d>0&&o.addPage("a4","p");const f=u/v;let y=a-10,b=y/f;b>s-10&&(b=s-10,y=b*f);const h=(a-y)/2,g=(s-b)/2,_=p.type==="image/png"?"PNG":"JPEG";o.addImage(c,_,h,g,y,b,void 0,"FAST")}const i=o.output("blob"),r=new Date,l=r.getFullYear().toString()+String(r.getMonth()+1).padStart(2,"0")+String(r.getDate()).padStart(2,"0")+String(r.getHours()).padStart(2,"0")+String(r.getMinutes()).padStart(2,"0")+String(r.getSeconds()).padStart(2,"0"),m=e.length>1?`_${e.length}p`:"";return new File([i],`photo_${l}${m}.pdf`,{type:"application/pdf"})}function ic(e){return new Promise((n,a)=>{const s=new FileReader;s.onerror=a,s.onload=()=>{const o=new Image;o.onerror=a,o.onload=()=>n({dataUrl:s.result,naturalW:o.naturalWidth,naturalH:o.naturalHeight}),o.src=s.result},s.readAsDataURL(e)})}(function(){const n=document.getElementById("upload-alt-row"),a=document.getElementById("gallery-input"),s=document.getElementById("camera-input");if(!n)return;n.style.display="";const o=document.getElementById("btn-scan-doc");o&&s&&(o.addEventListener("click",async()=>{!(localStorage.getItem("mrpilot_camera_tips_skip")==="1")&&!await lc()||s.click()}),s.addEventListener("change",async l=>{const m=Array.from(l.target.files||[]);if(l.target.value="",m.length!==0)for(const d of m)await Na([d],"camera")}));const i=document.getElementById("btn-upload-pic");i&&a&&i.addEventListener("click",()=>a.click());const r=l=>async m=>{const d=Array.from(m.target.files||[]);if(m.target.value="",d.length===0)return;const p=d.filter(u=>u.type==="application/pdf"||/\.pdf$/i.test(u.name)),c=d.filter(u=>!p.includes(u));p.length>0&&await rc(p),c.length>0&&await Na(c,l)};a&&a.addEventListener("change",r("gallery"))})();async function rc(e){for(const a of e)_selectedFiles.push({file:a,name:a.name,size:a.size,status:"waiting",errorKey:null,errorParams:null});const n=getMaxFiles();_selectedFiles.length>n&&(showAlert("warn",t("alert-file-count",{n})),_selectedFiles=_selectedFiles.slice(0,n)),renderFileList(),updateStartButton()}function lc(){return new Promise(e=>{const n=document.getElementById("camera-tips-modal"),a=document.getElementById("camera-tips-ok"),s=document.getElementById("camera-tips-cancel"),o=document.getElementById("camera-tips-skip");if(!n||!a){e(!0);return}o&&(o.checked=!1),n.style.display="flex";const i=l=>{n.style.display="none",o&&o.checked&&localStorage.setItem("mrpilot_camera_tips_skip","1"),a.onclick=null,s&&(s.onclick=null),n.onclick=null,document.removeEventListener("keydown",r),e(l)},r=l=>{l.key==="Escape"&&i(!1)};a.onclick=()=>i(!0),s&&(s.onclick=()=>i(!1)),n.onclick=l=>{l.target===n&&i(!1)},document.addEventListener("keydown",r),setTimeout(()=>a.focus(),50)})}let Ue=[],Bt=null;async function Na(e,n){if(hideAlerts(),!(!e||e.length===0)){var a=typeof window.getOcrDocumentMode=="function"?window.getOcrDocumentMode():"invoice";if(a==="thai_id_card"){for(const o of e)_selectedFiles.push({file:o,name:o.name,size:o.size,status:"waiting",errorKey:null,errorParams:null});const s=getMaxFiles();_selectedFiles.length>s&&(showAlert("warn",t("alert-file-count",{n:s})),_selectedFiles=_selectedFiles.slice(0,s)),renderFileList(),updateStartButton();return}if(typeof window.jspdf>"u"||!window.jspdf.jsPDF){showToast(t("camera-loading"),"info");for(let s=0;s<30&&(await new Promise(o=>setTimeout(o,100)),!(window.jspdf&&window.jspdf.jsPDF));s++);if(!window.jspdf||!window.jspdf.jsPDF){showToast(t("camera-lib-fail"),"error");return}}if(n==="camera"&&e.length===1){const s=e[0];let o={};try{o=await Kn(s)}catch{}Ue.push({file:s,quality:o}),Bt="camera",zt();return}if(n==="gallery"&&(e.length>=2||Ue.length>0)){for(const s of e){let o={};try{o=await Kn(s)}catch{}Ue.push({file:s,quality:o})}Bt="gallery",zt();return}await _i(e)}}async function cc(e){const n=new Set;for(const s of e)try{((await Kn(s)).warnings||[]).forEach(i=>n.add(i))}catch{}try{const s=await xi(e);s&&_selectedFiles.push({file:s,name:s.name,size:s.size,status:"waiting",errorKey:null,errorParams:null})}catch(s){console.error("[camera] convert failed",s),showToast(t("camera-convert-fail"),"error");return}const a=getMaxFiles();_selectedFiles.length>a&&(showAlert("warn",t("alert-file-count",{n:a})),_selectedFiles=_selectedFiles.slice(0,a)),renderFileList(),updateStartButton(),showToast(t("camera-added-merged",{n:e.length}),"success"),n.size>0&&setTimeout(()=>{n.has("too_dark")?showToast(t("camera-quality-dark"),"warn"):n.has("low_res")?showToast(t("camera-quality-lowres"),"warn"):n.has("too_bright")&&showToast(t("camera-quality-overexposed"),"warn")},1e3)}function zt(){let e=document.getElementById("camera-buffer-bar");if(Ue.length===0){e&&e.remove(),Bt=null;return}e||(e=document.createElement("div"),e.id="camera-buffer-bar",e.className="camera-buffer-bar",document.body.appendChild(e));const n=Ue.length,a=n>=2,s=Bt==="gallery",o=s?t("camera-buffer-more-gallery"):t("camera-buffer-more");let i;a?s?i=`
...
`,e.dataset.wbInjected="1";try{const n=window._currentLang||localStorage.getItem("mrpilot_lang")||"th",a=window.I18N;a&&a[n]&&(e.querySelectorAll("[data-i18n]").forEach(s=>{const o=s.getAttribute("data-i18n");o&&a[n][o]&&(s.textContent=a[n][o])}),e.querySelectorAll("[data-i18n-placeholder]").forEach(s=>{const o=s.getAttribute("data-i18n-placeholder");o&&a[n][o]&&(s.placeholder=a[n][o])}))}catch{}}})();(function(){const e=document.getElementById("archive-token-modal");if(!(!e||e.dataset.wbInjected==="1")){e.innerHTML=`
        ...
        `;p.innerHTML=c+u}function r(d){return d==null?"":String(d).replace(/[&<>"']/g,p=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[p])}function l(d){const p=new Date,c=p.getFullYear(),u=p.getMonth()+1;if(d==="all")return"all";if(d==="this-month")return`${c}-${String(u).padStart(2,"0")}`;if(d==="last-month"){const v=new Date(c,u-2,1);return`${v.getFullYear()}-${String(v.getMonth()+1).padStart(2,"0")}`}return d==="this-year"?`${c}`:d==="this-quarter"?`${c}-Q${Math.floor((u-1)/3)+1}`:"all"}window.openReportModal=async function(d){d=d||{},n(),typeof applyLang=="function"?applyLang(currentLang):document.querySelectorAll("#report-modal [data-i18n]").forEach(y=>{const b=y.getAttribute("data-i18n");I18N[currentLang]&&I18N[currentLang][b]&&(y.textContent=I18N[currentLang][b])});const p=document.getElementById("report-period-section");p&&(p.style.display=d.mode==="client"?"":"none");const c=document.getElementById("report-tpl-list");c.innerHTML=`<div class="report-tpl-loading">${r(t("report-modal-loading"))}</div>`,document.getElementById("report-modal").style.display="";const u=await o(currentLang,d&&d.mode);i(u),s=d;const v=document.getElementById("report-modal-download"),f=v.cloneNode(!0);v.parentNode.replaceChild(f,v),f.addEventListener("click",()=>m(s))};async function m(d){if(!d)return;const p=document.querySelector('input[name="report-tpl"]:checked');if(!p){showToast(t("report-toast-no-selection"),"info");return}const c=p.value,u=document.querySelector('input[name="report-period"]:checked'),v=u?u.value:"all",f=l(v),y=document.getElementById("report-modal-download"),b=y.innerHTML;y.disabled=!0,y.innerHTML=`<span>${r(t("report-modal-loading"))}</span>`;try{const h=localStorage.getItem("mrpilot_token");let g,_;if(d.mode==="records")g=await fetch("/api/reports/export",{method:"POST",headers:{Authorization:"Bearer "+h,"Content-Type":"application/json"},body:JSON.stringify({template:c,lang:currentLang,records:d.records||[],meta:d.meta||{}})}),_=`mrpilot-${c}-${Date.now()}.xlsx`;else if(d.mode==="client"){const L=`/api/reports/clients/${d.clientId}/export?template=${encodeURIComponent(c)}&lang=${encodeURIComponent(currentLang)}&month=${encodeURIComponent(f)}`;g=await fetch(L,{headers:{Authorization:"Bearer "+h}}),_=`${(d.clientName||"client").replace(/[^a-zA-Z0-9\u0e00-\u0e7f\u4e00-\u9fff]/g,"_").slice(0,40)}-${c}.xlsx`}else if(d.mode==="history-batch")c==="sales_detail_th"?(g=await fetch("/api/ocr/export-by-history-ids",{method:"POST",headers:{Authorization:"Bearer "+h,"Content-Type":"application/json"},body:JSON.stringify({template:"sales_detail_th",lang:currentLang,history_ids:d.historyIds||[],client_id:d.clientId||null})}),_=`Pearnly_SalesDetail_${Date.now()}.xlsx`):(g=await fetch("/api/reports/history/batch_export",{method:"POST",headers:{Authorization:"Bearer "+h,"Content-Type":"application/json"},body:JSON.stringify({template:c,lang:currentLang,history_ids:d.historyIds||[],client_id:d.clientId||null})}),_=`mrpilot-batch-${c}-${Date.now()}.xlsx`);else throw new Error("unknown mode: "+d.mode);if(!g.ok){let L="HTTP "+g.status;try{const $=await g.json();$&&$.detail&&(L=$.detail)}catch($){console.warn("[batch-export] resp.json err.detail parse failed:",$)}g.status===404?showToast(t("report-toast-empty"),"info"):showToast(t("report-toast-fail")+" · "+L,"error");return}const w=await g.blob();let k=_;const E=(g.headers.get("Content-Disposition")||"").match(/filename\*=UTF-8''([^;]+)/i);if(E)try{k=decodeURIComponent(E[1])}catch{}const I=URL.createObjectURL(w),B=document.createElement("a");B.href=I,B.download=k,document.body.appendChild(B),B.click(),document.body.removeChild(B),URL.revokeObjectURL(I),showToast(t("report-toast-success"),"success"),a()}catch(h){console.error("doDownload fail",h),showToast(t("report-toast-fail")+" · "+(h.message||""),"error")}finally{y.disabled=!1,y.innerHTML=b}}document.addEventListener("DOMContentLoaded",()=>{const d=document.getElementById("btn-export");if(d){const c=d.cloneNode(!0);d.parentNode.replaceChild(c,d),c.addEventListener("click",()=>{if(typeof _results>"u"||!_results||_results.length===0){showToast(t("report-toast-no-selection"),"info");return}openReportModal({mode:"records",records:_results.map(u=>({filename:u.filename,merged_fields:u.merged_fields||{}}))})})}const p=document.getElementById("history-batch-export");p&&p.addEventListener("click",()=>{if(typeof _historySelected>"u"||_historySelected.size===0){showToast(t("report-toast-no-selection"),"info");return}openReportModal({mode:"history-batch",historyIds:Array.from(_historySelected)})})}),window.openClientExportModal=function(d,p){openReportModal({mode:"client",clientId:d,clientName:p||""})}})();const Lc=/\.(pdf|jpe?g|png|webp)$/i,$c="mrpilot_folder_watcher",Sc=1;let Cn=null;function va(){return Cn||(Cn=new Promise((e,n)=>{const a=indexedDB.open($c,Sc);a.onupgradeneeded=s=>{const o=s.target.result;o.objectStoreNames.contains("handles")||o.createObjectStore("handles"),o.objectStoreNames.contains("seen")||o.createObjectStore("seen"),o.objectStoreNames.contains("config")||o.createObjectStore("config")},a.onsuccess=s=>e(s.target.result),a.onerror=s=>n(s.target.error)}),Cn)}function ln(e,n){return va().then(a=>new Promise((s,o)=>{const r=a.transaction(e,"readonly").objectStore(e).get(n);r.onsuccess=()=>s(r.result),r.onerror=()=>o(r.error)}))}function _t(e,n,a){return va().then(s=>new Promise((o,i)=>{const r=s.transaction(e,"readwrite");r.objectStore(e).put(a,n),r.oncomplete=()=>o(),r.onerror=()=>i(r.error)}))}function sn(e,n){return va().then(a=>new Promise((s,o)=>{const i=a.transaction(e,"readwrite");i.objectStore(e).delete(n),i.oncomplete=()=>s(),i.onerror=()=>o(i.error)}))}function oo(e){return va().then(n=>new Promise((a,s)=>{const o=n.transaction(e,"readwrite");o.objectStore(e).clear(),o.oncomplete=()=>a(),o.onerror=()=>s(o.error)}))}async function io(e){if(!e)return!1;try{const n={mode:"read"};let a=await e.queryPermission(n);return a==="granted"?!0:(a=await e.requestPermission(n),a==="granted")}catch(n){return console.warn("[folder] permission check failed:",n),!1}}async function Cc(e){const n=new FormData;n.append("file",e,e.name),n.append("source","folder");const a=await fetch("/api/ocr/recognize?source=folder",{method:"POST",headers:{Authorization:"Bearer "+token,"X-Source":"folder"},body:n});if(!a.ok){let s="http_"+a.status;try{const o=await a.json();s=o&&o.detail?typeof o.detail=="string"?o.detail:o.detail.code||JSON.stringify(o.detail):s}catch{}throw new Error(s)}return await a.json()}async function Tc(e){try{const a=(await e.getFile()).size;return await new Promise(o=>setTimeout(o,3e3)),(await e.getFile()).size===a&&a>0}catch{return!1}}async function Ti(e,n,a,s){if(s>10)return;let o;try{o=await e.queryPermission({mode:"read"})}catch{o="denied"}if(o==="granted")for await(const i of e.values()){const r=n?`${n}/${i.name}`:i.name;if(i.kind==="file"){if(!Lc.test(i.name))continue;let l;try{l=await i.getFile()}catch{continue}const m=`${r}::${l.size}::${l.lastModified}`;if(await ln("seen",m))continue;a.push({entry:i,file:l,seenKey:m,relPath:r})}else if(i.kind==="directory")try{await Ti(i,r,a,s+1)}catch{}}}(function(){const n=typeof window<"u"&&"showDirectoryPicker"in window;let a=null,s=null,o=60,i=!1,r=!1,l=0,m=0,d=0,p=[],c=null,u=!1;function v(V,O){const Y=document.getElementById("folder-status-summary");Y&&(Y.setAttribute("data-i18n",V),Y.textContent=t(V),Y.className="auto-status-pill"+(O?" "+O:""))}function f(V){["folder-unsupported","folder-empty","folder-active"].forEach(O=>{const Y=document.getElementById(O);Y&&(Y.style.display=O===V?"":"none")})}function y(V){if(!V)return"-";const O=V instanceof Date?V:new Date(V),Y=String(O.getHours()).padStart(2,"0"),de=String(O.getMinutes()).padStart(2,"0"),re=String(O.getSeconds()).padStart(2,"0");return`${Y}:${de}:${re}`}function b(){f("folder-active");const V=document.getElementById("folder-config-path");V&&a&&(V.textContent=a.name||"-");const O=document.getElementById("folder-interval-select");O&&(O.value=String(o)),document.getElementById("folder-stat-last").textContent=c?y(c):"-",document.getElementById("folder-stat-processed").textContent=String(l),document.getElementById("folder-stat-failed").textContent=String(m),document.getElementById("folder-stat-queue").textContent=String(d);const Y=document.getElementById("btn-folder-pause"),de=document.getElementById("btn-folder-resume");Y&&(Y.style.display=i?"none":""),de&&(de.style.display=i?"":"none"),i?v("folder-status-paused","paused"):v("folder-status-running","running");const re=document.getElementById("folder-status-text");re&&(re.setAttribute("data-i18n",i?"folder-status-paused":"folder-status-running"),re.textContent=t(i?"folder-status-paused":"folder-status-running"));const Ne=document.getElementById("folder-status-pulse");Ne&&(Ne.className="folder-status-pulse"+(i?" paused":"")),h()}function h(){const V=document.getElementById("folder-recent-list");if(V){if(p.length===0){V.innerHTML=`<div class="folder-recent-empty">${escapeHtml(t("folder-recent-empty"))}</div>`;return}V.innerHTML=p.slice(0,20).map(O=>{let Y;O.status==="ok"?Y=`<span class="folder-recent-icon ok">${svgIcon("check",12)}</span>`:O.status==="dup"?Y=`<span class="folder-recent-icon dup" title="${escapeHtml(t("folder-recent-dup"))}">${svgIcon("copy",12)}</span>`:O.status==="skip"?Y=`<span class="folder-recent-icon skip" title="${escapeHtml(t("folder-recent-skip"))}">${svgIcon("minus",12)}</span>`:Y=`<span class="folder-recent-icon fail">${svgIcon("alert",12)}</span>`;const de=O.status==="fail"&&O.error?O.error:O.status==="dup"&&O.reason||O.status==="skip"&&O.reason?O.reason:"",re=de?`<div class="folder-recent-err">${escapeHtml(de)}</div>`:"";return`
            ...
            `}).join("")}}function g(V){p.unshift(V),p.length>50&&(p.length=50),_t("config","recent_list",p).catch(()=>{})}async function _(){if(!(r||i||!a)){r=!0;try{if(await a.queryPermission({mode:"read"})!=="granted"){console.warn("[folder] permission lost · stop"),S(),showToast("warn",t("folder-permission-lost"));return}c=new Date;const O=[];await Ti(a,"",O,0),d=O.length,b();for(const Y of O){if(i)break;if(!await Tc(Y.entry)){d=Math.max(0,d-1),b();continue}try{let re;try{re=await Y.entry.getFile()}catch{re=Y.file}const Ne=await Cc(re);await _t("seen",Y.seenKey,{name:re.name,relPath:Y.relPath,size:re.size,lastModified:re.lastModified,processed_at:Date.now()});const xt=Ne.history_ids||(Ne.history_id?[Ne.history_id]:[]),xa=Ne.duplicate_warnings||[],_a=Y.relPath||re.name;xt.length>0?(l+=xt.length,g({name:_a,status:"ok",time:new Date,history_id:xt[0],count:xt.length}),await _t("config","processed_count",l)):xa.length>0?g({name:_a,status:"dup",time:new Date,reason:t("folder-recent-dup-reason")}):g({name:_a,status:"skip",time:new Date,reason:t("folder-recent-skip-reason")})}catch(re){m++,g({name:Y.relPath||Y.file.name,status:"fail",time:new Date,error:String(re.message||re)}),await _t("config","failed_count",m)}d=Math.max(0,d-1),b()}}catch(V){console.warn("[folder] scan error:",V)}finally{r=!1,b()}}}function w(){s&&clearInterval(s),s=setInterval(_,o*1e3)}function k(){s&&(clearInterval(s),s=null)}function x(V){if(!a||i)return;const O=typeof t=="function"?t("folder-unload-warn"):"Folder watcher running · close anyway?";return V.preventDefault(),V.returnValue=O,O}function E(){window._pearnlyFolderUnloadAttached||(window._pearnlyFolderUnloadAttached=!0,window.addEventListener("beforeunload",x))}function I(){window._pearnlyFolderUnloadAttached&&(window._pearnlyFolderUnloadAttached=!1,window.removeEventListener("beforeunload",x))}function B(){i=!1,w(),E(),b(),_()}function L(){i=!0,k(),I(),b()}function $(){i=!1,w(),E(),b(),_()}function S(){i=!0,k(),I()}async function M(){try{const V=await window.showDirectoryPicker({mode:"read",startIn:"documents"});if(!await io(V)){showToast("warn",t("folder-permission-denied"));return}a=V,await _t("handles","main",V),l=0,m=0,d=0,p=[],await _t("config","processed_count",0),await _t("config","failed_count",0),await oo("seen"),B()}catch(V){V&&V.name!=="AbortError"&&console.warn("[folder] pick failed:",V)}}async function R(){await showConfirm(t("folder-confirm-remove"),{danger:!0})&&(S(),a=null,l=0,m=0,d=0,p=[],await sn("handles","main"),await sn("config","processed_count"),await sn("config","failed_count"),await oo("seen"),f("folder-empty"),v("folder-status-empty",""))}async function G(){p=[];try{await sn("config","recent_list")}catch{}h()}async function se(){if(u)return;if(u=!0,!n){f("folder-unsupported"),v("folder-status-unsupported",""),ke();return}ce();let V=null;try{V=await ln("handles","main")}catch{}if(!V){f("folder-empty"),v("folder-status-empty","");return}if(!await io(V)){f("folder-empty"),v("folder-status-empty",""),await sn("handles","main"),showToast("warn",t("folder-permission-lost-restart"));return}a=V;try{l=await ln("config","processed_count")||0}catch{}try{m=await ln("config","failed_count")||0}catch{}try{const Y=await ln("config","recent_list");Array.isArray(Y)&&(p=Y.map(de=>({...de,time:de.time?new Date(de.time):new Date})))}catch{}B()}function ce(){const V=document.getElementById("btn-folder-pick"),O=document.getElementById("btn-folder-pause"),Y=document.getElementById("btn-folder-resume"),de=document.getElementById("btn-folder-scan-now"),re=document.getElementById("btn-folder-remove"),Ne=document.getElementById("btn-folder-clear-recent"),xt=document.getElementById("folder-interval-select");V&&V.addEventListener("click",M),O&&O.addEventListener("click",L),Y&&Y.addEventListener("click",$),de&&de.addEventListener("click",()=>{_()}),re&&re.addEventListener("click",R),Ne&&Ne.addEventListener("click",G),xt&&xt.addEventListener("change",xa=>{o=parseInt(xa.target.value,10)||60,i||w()}),Ee()}function Ee(){document.querySelectorAll('[data-auto-panel="folder"] [data-tab-jump]').forEach(V=>{V.dataset.tabJumpBound||(V.dataset.tabJumpBound="1",V.addEventListener("click",O=>{const Y=O.currentTarget.dataset.tabJump;if(Y==="email")typeof switchAutomationTab=="function"&&switchAutomationTab("email");else if(Y==="upload"){const de=document.querySelector('[data-page="recognize"]')||document.querySelector('[data-page="upload"]');de&&de.click()}}))})}function ke(){Ee()}window._loadFolderWatcherPanel=se})();function Mc(){try{if(navigator.userAgentData&&Array.isArray(navigator.userAgentData.brands))return navigator.userAgentData.brands.some(n=>/chromium|google chrome|microsoft edge/i.test(n.brand||""))}catch{}const e=navigator.userAgent||"";return!!(/Edg\//.test(e)||/Chrome\//.test(e)&&!/OPR\/|YaBrowser|Opera/.test(e))}function Va(){try{if(Mc()||localStorage.getItem("pearnly_chrome_banner_dismissed")==="1")return;const e=document.getElementById("chrome-only-banner");if(!e)return;const n=e.querySelector('[data-i18n="chrome-banner-msg"]'),a=e.querySelector('[data-i18n="chrome-banner-dismiss"]');n&&typeof t=="function"&&(n.textContent=t("chrome-banner-msg")),a&&typeof t=="function"&&(a.textContent=t("chrome-banner-dismiss")),e.style.display="";const s=document.getElementById("chrome-only-banner-close");s&&!s.dataset.bound&&(s.dataset.bound="1",s.addEventListener("click",()=>{e.style.display="none";try{localStorage.setItem("pearnly_chrome_banner_dismissed","1")}catch{}}))}catch{}}typeof document<"u"&&(document.readyState==="loading"?document.addEventListener("DOMContentLoaded",Va):setTimeout(Va,0));window._refreshChromeBanner=Va;const Hc=`
        <div class="modal">
            <div class="modal-head">
    ...
    `;$e("email-modal",Hc);const F={account:null,presets:null,modalMode:"new",loaded:!1,triggering:!1,autoRefreshTimer:null};function ro(e){F.modalMode=e;const n=document.getElementById("email-modal");if(!n)return;const a=document.getElementById("email-preset");a.innerHTML="";const s=F.presets||{},o=["gmail","outlook","yahoo","icloud","qq","163","custom"],i={gmail:"Gmail",outlook:"Outlook / Office365",yahoo:"Yahoo Mail",icloud:"iCloud",qq:"QQ 邮箱",163:"网易 163"};o.forEach(h=>{if(!s[h])return;const g=document.createElement("option");g.value=h,g.textContent=h==="custom"?t("email-preset-custom"):i[h]||h,a.appendChild(g)});const r=document.getElementById("email-modal-title"),l=document.getElementById("email-address"),m=document.getElementById("email-password"),d=document.getElementById("email-imap-host"),p=document.getElementById("email-imap-port"),c=document.getElementById("email-imap-ssl"),u=document.getElementById("email-folder"),v=document.getElementById("email-mark-read"),f=document.getElementById("email-bind-enabled"),y=document.getElementById("email-test-result"),b=document.getElementById("email-adv-details");if(y&&(y.style.display="none",y.textContent=""),e==="edit"&&F.account){r.setAttribute("data-i18n","email-modal-title-edit"),r.textContent=t("email-modal-title-edit"),l.value=F.account.email_address||"",m.value="",m.setAttribute("data-i18n-placeholder","email-field-password-edit-ph"),m.placeholder=t("email-field-password-edit-ph"),d.value=F.account.imap_host||"",p.value=F.account.imap_port||993,c.checked=F.account.imap_use_ssl!==!1,u.value=F.account.folder||"INBOX",v.checked=F.account.mark_as_read!==!1,f.checked=F.account.enabled!==!1;const h=document.getElementById("email-filter-sender"),g=document.getElementById("email-filter-subject");h&&(h.value=F.account.filter_sender||""),g&&(g.value=F.account.filter_subject||""),co(F.account.interval_min||15),a.value=jc(F.account.imap_host)||"custom",b&&(b.open=!0)}else{r.setAttribute("data-i18n","email-modal-title-new"),r.textContent=t("email-modal-title-new"),l.value="",m.value="",m.setAttribute("data-i18n-placeholder","email-field-password-ph"),m.placeholder=t("email-field-password-ph"),a.value="gmail",ys("gmail"),u.value="INBOX",v.checked=!0,f.checked=!0;const h=document.getElementById("email-filter-sender"),g=document.getElementById("email-filter-subject");h&&(h.value=""),g&&(g.value=""),co(15),b&&(b.open=!1)}Pc(),n.style.display="flex",setTimeout(()=>l.focus(),60)}function La(){const e=document.getElementById("email-modal");e&&(e.style.display="none")}function ys(e){const n=(F.presets||{})[e];if(!n||e==="custom")return;const a=document.getElementById("email-imap-host"),s=document.getElementById("email-imap-port"),o=document.getElementById("email-imap-ssl");a&&(a.value=n.host||""),s&&(s.value=n.port||993),o&&(o.checked=n.ssl!==!1)}const Ac={"gmail.com":"gmail","googlemail.com":"gmail","outlook.com":"outlook","hotmail.com":"outlook","live.com":"outlook","office365.com":"outlook","msn.com":"outlook","yahoo.com":"yahoo","yahoo.co.jp":"yahoo","icloud.com":"icloud","me.com":"icloud","mac.com":"icloud","qq.com":"qq","foxmail.com":"qq","163.com":"163","126.com":"163","yeah.net":"163"};function lo(e){if(!e||!e.includes("@"))return;const n=e.split("@")[1].toLowerCase().trim(),a=Ac[n];if(!a)return;const s=document.getElementById("email-preset");if(!s)return;const o=s.value;o&&o!=="custom"&&o!==""&&o===a||(s.value=a,ys(a))}function jc(e){if(!e)return null;const n=F.presets||{};for(const a in n)if(a!=="custom"&&n[a]&&n[a].host===e)return a;return null}function Mi(){const e=document.querySelector("#email-interval-options .email-interval-btn.active"),n=e?parseInt(e.dataset.interval,10):15;return{email_address:(document.getElementById("email-address").value||"").trim(),password:document.getElementById("email-password").value||"",imap_host:(document.getElementById("email-imap-host").value||"").trim(),imap_port:parseInt(document.getElementById("email-imap-port").value||"993",10)||993,imap_use_ssl:document.getElementById("email-imap-ssl").checked,folder:(document.getElementById("email-folder").value||"INBOX").trim()||"INBOX",mark_as_read:document.getElementById("email-mark-read").checked,enabled:document.getElementById("email-bind-enabled").checked,interval_min:[5,15,60].includes(n)?n:15,filter_sender:(document.getElementById("email-filter-sender").value||"").trim()||null,filter_subject:(document.getElementById("email-filter-subject").value||"").trim()||null}}function Pc(){const e=document.getElementById("email-interval-options");!e||e._bound||(e._bound=!0,e.addEventListener("click",n=>{const a=n.target.closest(".email-interval-btn");a&&(e.querySelectorAll(".email-interval-btn").forEach(s=>s.classList.remove("active")),a.classList.add("active"))}))}function co(e){const n=[5,15,60].includes(e)?e:15,a=document.getElementById("email-interval-options");a&&a.querySelectorAll(".email-interval-btn").forEach(s=>{s.classList.toggle("active",parseInt(s.dataset.interval,10)===n)})}function Ce(e,n){const a=document.getElementById("email-test-result");a&&(a.style.display="",a.textContent=n,a.className="form-test-result "+(e==="ok"?"ok":e==="running"?"running":"fail"))}async function Dc(){const e=Mi();if(!e.email_address){Ce("fail",t("email-addr-required"));return}if(!e.password){Ce("fail",t("email-password-required"));return}if(!e.imap_host){Ce("fail",t("email-host-required"));return}const n=document.getElementById("btn-email-modal-test");n&&(n.disabled=!0),Ce("running",t("email-test-running"));try{const a=await fetch("/api/email-ingest/test",{method:"POST",headers:{Authorization:"Bearer "+token,"Content-Type":"application/json"},body:JSON.stringify({email_address:e.email_address,password:e.password,imap_host:e.imap_host,imap_port:e.imap_port,imap_use_ssl:e.imap_use_ssl,folder:e.folder})}),s=await a.json().catch(()=>({}));if(a.ok&&s.success)Ce("ok",t("email-test-ok",{folder:e.folder,n:s.folder_count??"?"}));else{const o=s.error_msg||"";o==="auth_failed"||/auth/i.test(o)?Ce("fail",t("email-test-auth-fail")):Ce("fail",t("email-test-fail",{msg:o||a.status}))}}catch(a){Ce("fail",t("email-test-fail",{msg:String(a).slice(0,120)}))}finally{n&&(n.disabled=!1)}}(function(){async function e(){const u=document.getElementById("email-empty"),v=document.getElementById("email-account-card");if(document.getElementById("email-logs-section"),!(!u||!v))try{const f=await fetch("/api/email-ingest/account",{headers:{Authorization:"Bearer "+token}});if(f.status===401){localStorage.removeItem("mrpilot_token");const b=await f.json().catch(()=>({}));if((typeof b.detail=="string"?b.detail:b.detail&&b.detail.code||"")==="auth.session_revoked"){_showSessionRevokedModal();return}window.location.href="/";return}if(!f.ok){a("none");return}const y=await f.json();F.account=y.account||null,F.presets=y.presets||{},F.loaded=!0,n(),F.account&&d()}catch(f){console.error("[email-ingest] load failed",f),a("none")}}function n(){const u=document.getElementById("email-empty"),v=document.getElementById("email-account-card"),f=document.getElementById("email-logs-section");if(!F.account){u.style.display="",v.style.display="none",f&&(f.style.display="none"),a("none");return}u.style.display="none",v.style.display="",f&&(f.style.display="");const y=document.getElementById("email-account-addr"),b=document.getElementById("email-account-host"),h=document.getElementById("email-account-last"),g=document.getElementById("email-last-error"),_=document.getElementById("email-enabled-toggle");if(y&&(y.textContent=F.account.email_address||"-"),b&&(b.textContent=`${F.account.imap_host||"-"}:${F.account.imap_port||993}`),h){const w=F.account.last_fetched_at;if(!w)h.textContent=t("email-last-never");else{const k=s(w),x=!F.account.last_error;h.textContent=x?t("email-last-ok",{time:k}):t("email-last-fail",{time:k})}}g&&(F.account.last_error?(g.style.display="",g.textContent=o(F.account.last_error)):g.style.display="none"),_&&(_.checked=!!F.account.enabled),F.account.enabled?F.account.last_error?a("error"):a("on"):a("off")}function a(u){const v=document.getElementById("email-status-summary");if(!v)return;v.classList.remove("none","ready","active","coming");let f="auto-status-loading";u==="none"?(f="email-status-none",v.classList.add("none")):u==="on"?(f="email-status-on",v.classList.add("active")):u==="off"?(f="email-status-off",v.classList.add("coming")):u==="error"&&(f="email-status-error",v.classList.add("none")),v.setAttribute("data-i18n",f),v.textContent=t(f)}function s(u){if(!u)return"";const v=new Date(u);if(isNaN(v.getTime()))return"";const f=y=>String(y).padStart(2,"0");return`${f(v.getMonth()+1)}-${f(v.getDate())} ${f(v.getHours())}:${f(v.getMinutes())}`}function o(u){if(!u)return"";const v=String(u);return/auth|AUTHENTICATIONFAILED|invalid credentials/i.test(v)?t("email-test-auth-fail"):/timeout|timed out/i.test(v)?t("email.timeout"):(/ENOTFOUND|getaddrinfo/i.test(v),v)}async function i(){const u=Mi();if(!u.email_address){Ce("fail",t("email-addr-required"));return}if(F.modalMode==="new"&&!u.password){Ce("fail",t("email-password-required"));return}if(!u.imap_host){Ce("fail",t("email-host-required"));return}const v=document.getElementById("btn-email-modal-save");v&&(v.disabled=!0);const f={...u};F.modalMode==="edit"&&!f.password&&delete f.password;try{const y=await fetch("/api/email-ingest/account",{method:"PUT",headers:{Authorization:"Bearer "+token,"Content-Type":"application/json"},body:JSON.stringify(f)}),b=await y.json().catch(()=>({}));if(y.ok&&b.ok)F.account=b.account,showToast(t("email-save-ok"),"success"),La(),n(),d();else{const g="email."+(b.detail||"").split(".").slice(-1)[0];Ce("fail",t(g)!==g?t(g):t("email-save-fail"))}}catch{Ce("fail",t("email-save-fail"))}finally{v&&(v.disabled=!1)}}async function r(){if(!(!F.account||!await showConfirm(t("email-unbind-confirm",{email:F.account.email_address}),{danger:!0,okText:t("email-btn-unbind")})))try{if((await fetch("/api/email-ingest/account",{method:"DELETE",headers:{Authorization:"Bearer "+token}})).ok){F.account=null,showToast(t("email-unbind-ok"),"success"),n();const f=document.getElementById("email-logs-list");f&&(f.innerHTML="")}else showToast(t("email-unbind-fail"),"error")}catch{showToast(t("email-unbind-fail"),"error")}}async function l(){if(!F.account||F.triggering)return;if(!F.account.enabled){showToast(t("email.disabled"),"error");return}F.triggering=!0;const u=document.getElementById("btn-email-trigger"),v=u?u.innerHTML:"";u&&(u.disabled=!0,u.innerHTML=`<span>${escapeHtml(t("email-trigger-running"))}</span>`);try{const f=await fetch("/api/email-ingest/trigger",{method:"POST",headers:{Authorization:"Bearer "+token}}),y=await f.json().catch(()=>({}));if(f.ok){const b=y.emails_scanned||0,h=y.ocr_succeeded||0,g=y.ocr_failed||0;b===0&&h===0&&g===0?showToast(t("email-trigger-empty"),"success"):showToast(t("email-trigger-result",{scanned:b,ok:h,fail:g}),g>0?"warn":"success")}else{const h="email."+(y.detail||"").split(".").slice(-1)[0];showToast(t(h)!==h?t(h):t("email-trigger-fail"),"error")}await e()}catch{showToast(t("email-trigger-fail"),"error")}finally{F.triggering=!1,u&&(u.disabled=!1,u.innerHTML=v)}}async function m(){if(!F.account)return;const u=document.getElementById("email-enabled-toggle"),v=!!(u&&u.checked),f=F.account.enabled;try{const y=await fetch("/api/email-ingest/account",{method:"PUT",headers:{Authorization:"Bearer "+token,"Content-Type":"application/json"},body:JSON.stringify({email_address:F.account.email_address,imap_host:F.account.imap_host,imap_port:F.account.imap_port,imap_use_ssl:F.account.imap_use_ssl,folder:F.account.folder||"INBOX",filter_subject:F.account.filter_subject||null,filter_sender:F.account.filter_sender||null,mark_as_read:F.account.mark_as_read!==!1,enabled:v})}),b=await y.json().catch(()=>({}));y.ok&&b.ok?(F.account=b.account,n()):(u&&(u.checked=f),showToast(t("email-toggle-fail"),"error"))}catch{u&&(u.checked=f),showToast(t("email-toggle-fail"),"error")}}async function d(){const u=document.getElementById("email-logs-list");if(u){u.innerHTML=`<div class="erp-logs-empty">${escapeHtml(t("erp-logs-loading"))}</div>`;try{const v=await fetch("/api/email-ingest/logs?limit=20",{headers:{Authorization:"Bearer "+token}});if(!v.ok){u.innerHTML=`<div class="erp-logs-empty">${escapeHtml(t("erp-logs-error"))}</div>`;return}const f=await v.json();if(!Array.isArray(f)||f.length===0){u.innerHTML=`<div class="erp-logs-empty">${escapeHtml(t("email-logs-empty"))}</div>`;return}u.innerHTML=f.map(p).join("")}catch{u.innerHTML=`<div class="erp-logs-empty">${escapeHtml(t("erp-logs-error"))}</div>`}}}function p(u){const v=s(u.created_at),f=u.status||"failed",y=f==="success"?"ok":f==="partial"?"partial":"fail",b=f==="success"?"✓":f==="partial"?"◐":"✗",h=u.trigger==="manual"?`<span class="log-tag manual">${escapeHtml(t("email-log-tag-manual"))}</span>`:`<span class="log-tag auto">${escapeHtml(t("email-log-tag-auto"))}</span>`,g=t("email-log-counts",{scanned:u.emails_scanned||0,att:u.attachments_found||0,ok:u.ocr_succeeded||0,fail:u.ocr_failed||0}),_=(u.elapsed_ms||0)+"ms";return`
        ...
        `}function c(){const u=document.getElementById("btn-email-bind");u&&u.addEventListener("click",()=>ro("new"));const v=document.getElementById("btn-email-edit");v&&v.addEventListener("click",()=>ro("edit"));const f=document.getElementById("btn-email-unbind");f&&f.addEventListener("click",r);const y=document.getElementById("btn-email-trigger");y&&y.addEventListener("click",l);const b=document.getElementById("email-enabled-toggle");b&&b.addEventListener("change",m);const h=document.getElementById("email-modal-close");h&&h.addEventListener("click",La);const g=document.getElementById("btn-email-modal-cancel");g&&g.addEventListener("click",La);const _=document.getElementById("btn-email-modal-test");_&&_.addEventListener("click",Dc);const w=document.getElementById("btn-email-modal-save");w&&w.addEventListener("click",i);const k=document.getElementById("email-preset");k&&k.addEventListener("change",I=>ys(I.target.value));const x=document.getElementById("email-address");x&&!x.dataset.autoBound&&(x.dataset.autoBound="1",x.addEventListener("blur",I=>lo((I.target.value||"").trim())),x.addEventListener("input",I=>{const B=(I.target.value||"").trim();B.includes("@")&&B.split("@")[1].includes(".")&&lo(B)}));const E=document.getElementById("btn-email-refresh-logs");E&&E.addEventListener("click",()=>{E.classList.add("spinning"),setTimeout(()=>E.classList.remove("spinning"),600),d()})}c(),window._loadEmailIngestPanel=e,window._rerenderEmailIngest=function(){if(!F.loaded)return;n();const u=document.getElementById("email-logs-section");F.account&&u&&u.open&&d()},window._startEmailLogAutoRefresh=function(){F.autoRefreshTimer||(F.autoRefreshTimer=setInterval(()=>{F.account&&F.loaded&&d()},3e4))},window._stopEmailLogAutoRefresh=function(){F.autoRefreshTimer&&(clearInterval(F.autoRefreshTimer),F.autoRefreshTimer=null)}})();const qc=`
...
`;$e("bank-cand-drawer",qc);const Rc=`
    <div class="modal" style="max-width: 420px;">
        <div class="modal-head">
...
`;$e("bank-client-picker-modal",Rc);const H={sessions:[],currentSession:null,currentTxs:[],currentFilter:"all",currentTxForDrawer:null,loaded:!1,queue:[],qSeq:0,sessionFilter:"all",pickerSelected:null};function Fc(e){const n=Number(e||0);let a="score-low";return n>=85?a="score-high":n>=60&&(a="score-mid"),'<span class="bank-cand-score '+a+'">'+n.toFixed(0)+" "+t("bank-cand-score-unit")+"</span>"}function zc(e){const n=document.getElementById("bank-upload-progress");n&&(n.style.display="none")}function Nc(){const e=document.getElementById("bank-upload-error");e&&(e.style.display="none")}function Oc(e){return{"bank_recon.only_pdf":t("bank-err-only-pdf"),"bank_recon.empty_file":t("bank-err-empty"),"bank_recon.file_too_large":t("bank-err-too-large"),"bank_recon.save_failed":t("bank-err-server"),"bank_recon.scanned":t("bank-err-scanned"),"bank_recon.no_tx":t("bank-err-no-tx"),network:t("bank-err-network")}[e]||t("bank-err-unknown")+" ("+e+")"}function St(e){if(e==null)return"-";const n=Number(e);return isNaN(n)?"-":n.toLocaleString("en-US",{minimumFractionDigits:2,maximumFractionDigits:2})}function Kt(e){if(!e)return"-";const n=String(e);return n.length>=10?n.slice(0,10):n}function Hi(e,n){return!e&&!n?"":(Kt(e)||"?")+" ~ "+(Kt(n)||"?")}function X(e){return e==null?"":String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}async function Vc(e){H.currentTxForDrawer=e;const n=document.getElementById("bank-detail-body");n&&n.classList.add("has-pane");const a=document.getElementById("bank-cand-pane-title"),s=document.getElementById("bank-cand-pane-sub"),o=document.getElementById("bank-cand-pane-foot");if(a&&(a.textContent=t("bank-cand-pane-current")),s){const r=e.direction==="OUT"?"-":"+",l=e.direction==="OUT"?"bank-out":"bank-in";s.innerHTML=`${X(Kt(e.tx_date))}
            <span style="margin:0 6px;color:#D1D5DB">·</span>
            <span>${X(e.description||"-")}</span>
            <span style="margin:0 6px;color:#D1D5DB">·</span>
            <strong class="${l}">${r}${St(e.amount)}</strong>`}o&&(o.style.display="");const i=document.getElementById("bank-cand-pane-body");if(i){i.innerHTML=`<div class="bank-empty">${t("bank-cand-loading")}</div>`;try{const r=await fetch("/api/bank-recon/tx/"+encodeURIComponent(e.id)+"/candidates",{headers:{Authorization:"Bearer "+token}});if(!r.ok)throw new Error("cands:"+r.status);const l=await r.json();Gc(e,l.candidates||[])}catch{i.innerHTML=`<div class="bank-empty">${t("bank-cand-load-failed")}</div>`}}}function Uc(e,n,a){const s=n.history_id,o=n.invoice_no||"-",i=n.vendor||"-",r=n.amount_total!==null&&n.amount_total!==void 0?St(n.amount_total):"-",l=n.invoice_date?Kt(n.invoice_date):"-",m=n.filename||"",d=!!a&&e.matched_history_id===s,p="bank-cand-card"+(n.is_auto_picked?" is-auto":"")+(d?" is-picked":"");let c="";return d?c='<button class="btn btn-ghost btn-small" data-act="unmatch"><span>'+t("bank-cand-unmatch")+"</span></button>":c='<button class="btn btn-primary btn-small" data-act="pick" data-hid="'+X(s)+'"><span>'+t(n.is_auto_picked?"bank-cand-confirm":"bank-cand-pick-this")+"</span></button>",'<div class="'+p+'" data-hid="'+X(s)+'"><div class="bank-cand-card-head"><div class="bank-cand-card-vendor">'+X(i)+"</div>"+Fc(n.score)+'</div><div class="bank-cand-card-fields"><span class="bank-cand-field"><span class="bank-cand-flabel">'+t("bank-cand-fld-invoice-no")+"</span> "+X(o)+'</span><span class="bank-cand-field"><span class="bank-cand-flabel">'+t("bank-cand-fld-amount")+"</span> "+r+'</span><span class="bank-cand-field"><span class="bank-cand-flabel">'+t("bank-cand-fld-date")+"</span> "+X(l)+"</span></div>"+(m?'<div class="bank-cand-card-file" title="'+X(m)+'">'+X(m)+"</div>":"")+(n.reason?'<div class="bank-cand-card-reason">'+X(n.reason)+"</div>":"")+'<div class="bank-cand-card-actions">'+c+"</div></div>"}function Gc(e,n){const a=document.getElementById("bank-cand-pane-body");if(!a)return;const s=n||[];let o="";if(e.match_status==="matched")o='<div class="bank-cand-hint hint-matched">'+t("bank-cand-hint-matched").replace("{n}",s.length)+"</div>";else if(e.match_status==="suggested")o='<div class="bank-cand-hint hint-suggested">'+t("bank-cand-hint-suggested").replace("{n}",s.length)+"</div>";else if(s.length>0)o='<div class="bank-cand-hint hint-low">'+t("bank-cand-hint-low").replace("{n}",s.length)+"</div>";else{a.innerHTML='<div class="bank-empty">'+t("bank-cand-no-match-detail")+"</div>";return}const i=e.match_status==="matched",r=s.map(l=>Uc(e,l,i)).join("");a.innerHTML=o+'<div class="bank-cand-list">'+r+"</div>",a.querySelectorAll('[data-act="pick"]').forEach(l=>{l.addEventListener("click",()=>{Yc(l.dataset.hid)})}),a.querySelectorAll('[data-act="unmatch"]').forEach(l=>{l.addEventListener("click",async()=>{try{await fetch("/api/bank-recon/tx/"+encodeURIComponent(e.id)+"/override",{method:"POST",headers:{Authorization:"Bearer "+token,"Content-Type":"application/json"},body:JSON.stringify({status:"unmatched"})}),kn(),await Zt(H.currentSession.id)}catch{showToast(t("bank-action-failed"),"error")}})})}function kn(){const e=document.getElementById("bank-detail-body");e&&e.classList.remove("has-pane");const n=document.getElementById("bank-cand-pane-title"),a=document.getElementById("bank-cand-pane-sub"),s=document.getElementById("bank-cand-pane-body"),o=document.getElementById("bank-cand-pane-foot");n&&(n.textContent=t("bank-cand-pane-empty-title")),a&&(a.textContent=t("bank-cand-pane-empty-sub")),o&&(o.style.display="none"),s&&(s.innerHTML='<div class="bank-cand-pane-empty"><svg viewBox="0 0 64 64" fill="none" stroke="currentColor" stroke-width="1.4" stroke-linecap="round" stroke-linejoin="round"><rect x="14" y="10" width="36" height="44" rx="3"/><path d="M22 22h20M22 30h20M22 38h12"/></svg><div>'+t("bank-cand-pane-empty-hint")+"</div></div>");const i=document.getElementById("bank-tx-tbody");i&&i.querySelectorAll("tr.is-selected").forEach(r=>r.classList.remove("is-selected")),H.currentTxForDrawer=null}async function Zt(e){try{const n="/api/bank-recon/sessions/"+encodeURIComponent(e)+(H.currentFilter!=="all"?"?filter="+H.currentFilter:""),a=await fetch(n,{headers:{Authorization:"Bearer "+token}});if(!a.ok)throw new Error("detail:"+a.status);const s=await a.json();H.currentSession=s.session,H.currentTxs=s.transactions||[],td()}catch(n){console.warn("[bank-recon] loadSessionDetail failed",n),showToast(t("bank-load-failed"),"error")}}async function Wc(){if(!H.currentSession)return;const e=document.getElementById("btn-bank-run-match"),n=e.innerHTML;e.disabled=!0,e.innerHTML="<span>"+t("bank-matching")+"</span>";try{const a=await fetch("/api/bank-recon/sessions/"+encodeURIComponent(H.currentSession.id)+"/match",{method:"POST",headers:{Authorization:"Bearer "+token}});if(!a.ok)throw new Error("match:"+a.status);const s=await a.json();showToast(t("bank-match-done").replace("{matched}",s.matched).replace("{suggested}",s.suggested).replace("{unmatched}",s.unmatched),"success"),await Zt(H.currentSession.id),await Qt()}catch(a){console.warn("[bank-recon] match failed",a),showToast(t("bank-match-failed"),"error")}finally{e.disabled=!1,e.innerHTML=n}}async function Kc(){if(!(!H.currentSession||!await showConfirm(t("bank-delete-confirm"),{danger:!0})))try{const n=await fetch("/api/bank-recon/sessions/"+encodeURIComponent(H.currentSession.id),{method:"DELETE",headers:{Authorization:"Bearer "+token}});if(!n.ok)throw new Error("delete:"+n.status);showToast(t("bank-deleted"),"success"),H.currentSession=null,H.currentTxs=[],xs(),await Qt()}catch(n){console.warn("[bank-recon] delete failed",n),showToast(t("bank-delete-failed"),"error")}}async function po(){if(H.currentTxForDrawer)try{const e=await fetch("/api/bank-recon/tx/"+encodeURIComponent(H.currentTxForDrawer.id)+"/override",{method:"POST",headers:{Authorization:"Bearer "+token,"Content-Type":"application/json"},body:JSON.stringify({status:"ignored"})});if(!e.ok)throw new Error("ignore:"+e.status);kn(),await Zt(H.currentSession.id)}catch{showToast(t("bank-action-failed"),"error")}}async function Yc(e){if(H.currentTxForDrawer)try{const n=await fetch("/api/bank-recon/tx/"+encodeURIComponent(H.currentTxForDrawer.id)+"/override",{method:"POST",headers:{Authorization:"Bearer "+token,"Content-Type":"application/json"},body:JSON.stringify({status:"matched",history_id:e})});if(!n.ok)throw new Error("pick:"+n.status);showToast(t("bank-matched-ok"),"success"),kn(),await Zt(H.currentSession.id)}catch{showToast(t("bank-action-failed"),"error")}}function Ai(){if(!H.currentSession)return;const e=H.currentSession;document.getElementById("bank-detail-title").textContent=(e.bank_code||"-")+(e.account_last4?" ···"+e.account_last4:"")+" · "+(e.source_filename||""),document.getElementById("bank-meta-period").textContent=Hi(e.period_start,e.period_end)||"-",document.getElementById("bank-meta-opening").textContent=St(e.opening_balance),document.getElementById("bank-meta-inflow").textContent="+"+St(e.total_inflow),document.getElementById("bank-meta-outflow").textContent="-"+St(e.total_outflow),document.getElementById("bank-meta-closing").textContent=St(e.closing_balance);const n=H.currentTxs||[],a=n.length;let s=0,o=0,i=0;for(const r of n){const l=r.match_status||"unmatched";l==="matched"?s++:l==="suggested"?o++:i++}document.getElementById("bank-stat-total").textContent=a,document.getElementById("bank-stat-matched").textContent=s,document.getElementById("bank-stat-suggested").textContent=o,document.getElementById("bank-stat-unmatched").textContent=i}function ws(){const e=document.getElementById("bank-tx-tbody");if(!e)return;let n=H.currentTxs||[];if(H.currentFilter!=="all"&&(n=n.filter(a=>H.currentFilter==="matched"?a.match_status==="matched":H.currentFilter==="suggested"?a.match_status==="suggested":H.currentFilter==="unmatched"?a.match_status==="unmatched"||a.match_status==="ignored":!0)),n.length===0){e.innerHTML=`<tr><td colspan="4" class="bank-empty">${t("bank-tx-empty")}</td></tr>`;return}if(e.innerHTML=n.map(a=>Jc(a)).join(""),e.querySelectorAll("tr[data-tx-id]").forEach(a=>{a.addEventListener("click",()=>{const s=a.dataset.txId,o=H.currentTxs.find(i=>i.id===s);o&&(e.querySelectorAll("tr.is-selected").forEach(i=>i.classList.remove("is-selected")),a.classList.add("is-selected"),Vc(o))})}),H.currentTxForDrawer){const a=e.querySelector('tr[data-tx-id="'+H.currentTxForDrawer.id+'"]');a&&a.classList.add("is-selected")}}function Jc(e){const n=e.direction==="OUT",a=n?"-":"+",s=n?"bank-out":"bank-in",o=e.match_status||"unmatched",i=t("bank-match-"+o)||o,r=Kt(e.tx_date),l=e.channel?`<span class="bank-tx-channel">${X(e.channel)}</span>`:"";return`
        <tr data-tx-id="${X(e.id)}">
            <td class="bank-tx-date">${X(r)}</td>
            <td class="bank-tx-desc">${l}${X(e.description||"-")}</td>
            <td class="bank-td-amount ${s}">${a}${St(e.amount)}</td>
            <td><span class="bank-tx-match mt-${o}">${X(i)}</span></td>
        </tr>
    `}function ks(){const e=document.getElementById("bank-client-badge");if(!e||!H.currentSession)return;const n=H.currentSession.client_id,a=document.getElementById("bank-client-badge-dot"),s=document.getElementById("bank-client-badge-name"),o=document.getElementById("bank-client-badge-caret"),i=typeof _userInfo<"u"?_userInfo:null,r=!(i&&i.role==="member");if(n!=null){const l=(window._clientsCache||[]).find(m=>Number(m.id)===Number(n));e.classList.remove("is-empty"),a&&(a.style.background=l&&l.color||"#111111"),s&&(s.textContent=l&&(l.short_name||l.name)||"#"+n)}else e.classList.add("is-empty"),a&&(a.style.background=""),s&&(s.textContent=t("bank-client-none"));r?(e.classList.remove("is-readonly"),e.disabled=!1,o&&(o.style.display="")):(e.classList.add("is-readonly"),e.disabled=!0,o&&(o.style.display="none")),e.style.display=""}function Xc(){if(!H.currentSession)return;const e=typeof _userInfo<"u"?_userInfo:null;if(!!(e&&e.role==="member"))return;H.pickerSelected=H.currentSession.client_id!=null?Number(H.currentSession.client_id):null,Pi();const a=document.getElementById("bank-client-picker-modal");a&&(a.style.display="")}function ji(){const e=document.getElementById("bank-client-picker-modal");e&&(e.style.display="none"),H.pickerSelected=null}function Pi(){const e=document.getElementById("bank-client-picker-list");if(!e)return;const n=(window._clientsCache||[]).filter(s=>s&&(s.is_active===!0||s.is_active===void 0)),a=[];a.push('<div class="bank-client-picker-row is-none'+(H.pickerSelected==null?" is-selected":"")+'" data-cid=""><span class="bank-cp-dot"></span><span>'+X(t("bank-client-picker-none"))+"</span></div>"),n.forEach(s=>{const o=Number(s.id)===Number(H.pickerSelected)?" is-selected":"";a.push('<div class="bank-client-picker-row'+o+'" data-cid="'+X(s.id)+'"><span class="bank-cp-dot" style="background:'+X(s.color||"#111111")+'"></span><span>'+X(s.short_name||s.name||"#"+s.id)+"</span></div>")}),e.innerHTML=a.join(""),e.querySelectorAll(".bank-client-picker-row").forEach(s=>{s.addEventListener("click",()=>{const o=s.dataset.cid;H.pickerSelected=o?Number(o):null,Pi()})})}async function Zc(){if(H.currentSession)try{const e=await fetch("/api/bank-recon/sessions/"+encodeURIComponent(H.currentSession.id)+"/client",{method:"PATCH",headers:{Authorization:"Bearer "+token,"Content-Type":"application/json"},body:JSON.stringify({client_id:H.pickerSelected})});if(!e.ok)throw new Error("client:"+e.status);H.currentSession.client_id=H.pickerSelected,ks(),showToast(t("bank-client-changed"),"success"),ji();try{await Qt()}catch{}}catch(e){console.warn("[bank-recon] save client failed",e),showToast(t("bank-client-change-failed"),"error")}}async function Qt(){try{const e=await fetch("/api/bank-recon/sessions?limit=30",{headers:{Authorization:"Bearer "+token}});if(!e.ok)throw new Error("sessions:"+e.status);H.sessions=await e.json(),Jn()}catch(e){console.warn("[bank-recon] loadSessions failed",e),H.sessions=[],Jn()}}function uo(){const e=document.getElementById("bank-status-summary");if(!e)return;if(H.sessions.length===0){e.textContent=t("bank-pill-none");return}let a=0;for(const s of H.sessions)s.parse_status==="parsed"&&(s.unmatched_count||0)>0&&a++;e.textContent=a>0?t("bank-pill-pending").replace("{n}",a):t("bank-pill-ok")}function Jn(){const e=document.getElementById("bank-sessions-list");if(!e)return;let n=H.sessions||[];if(H.sessionFilter==="parsed"?n=n.filter(a=>a.parse_status==="parsed"):H.sessionFilter==="failed"&&(n=n.filter(a=>a.parse_status==="parse_failed")),!H.sessions||H.sessions.length===0){e.innerHTML='<div class="bank-empty" data-i18n="bank-sessions-empty">'+t("bank-sessions-empty")+"</div>";return}if(n.length===0){e.innerHTML='<div class="bank-empty">'+t("bank-sess-filter-empty")+"</div>";return}e.innerHTML=n.map(a=>Qc(a)).join(""),e.querySelectorAll(".bank-session-row").forEach(a=>{a.addEventListener("click",s=>{s.target.closest(".bank-session-trash")||Zt(a.dataset.sessionId)})}),e.querySelectorAll(".bank-session-trash").forEach(a=>{a.addEventListener("click",s=>{s.stopPropagation();const o=a.dataset.sessionId,i=a.dataset.sessionName||"";Di(o,i)})})}async function Di(e,n){if(!e)return;const a=(t("bank-session-delete-confirm")||"确定删除这条对账记录吗?").replace("{name}",n||"");if(await showConfirm(a,{danger:!0}))try{const o=await fetch("/api/bank-recon/sessions/"+encodeURIComponent(e),{method:"DELETE",headers:{Authorization:"Bearer "+token}});if(!o.ok)throw new Error("delete:"+o.status);showToast(t("bank-deleted"),"success"),H.currentSession&&H.currentSession.id===e&&(H.currentSession=null,H.currentTxs=[],xs()),await Qt(),typeof window.loadReconcilePage=="function"&&window.loadReconcilePage()}catch(o){console.warn("[bank-recon] delete failed",o),showToast(t("bank-delete-failed"),"error")}}function Qc(e){const n=(e.bank_code||"OTHER").toUpperCase(),a=Hi(e.period_start,e.period_end),s=e.account_last4?"···"+e.account_last4:"",o=ed(e),i=Kt(e.created_at);return`
    ...
    `}function ed(e){if(e.parse_status==="parse_failed")return`<span class="bank-session-count cnt-failed">${t("bank-count-parse-failed")}</span>`;if(e.parse_status!=="parsed")return`<span class="bank-session-count">${t("bank-count-parsing")}</span>`;const n=e.tx_count||0,a=e.matched_count||0,s=e.unmatched_count||0,o=[`<span class="bank-session-count">${n} ${t("bank-count-tx")}</span>`];return a>0&&o.push(`<span class="bank-session-count cnt-matched">${a} ${t("bank-count-matched")}</span>`),s>0&&o.push(`<span class="bank-session-count cnt-unmatched">${s} ${t("bank-count-unmatched")}</span>`),o.join("")}function td(){document.getElementById("bank-detail").style.display="",document.querySelector(".bank-sessions-section").style.display="none",Ai(),ws(),ks()}function xs(){document.getElementById("bank-detail").style.display="none",document.querySelector(".bank-sessions-section").style.display="";const e=document.getElementById("bank-detail-body");e&&e.classList.remove("has-pane"),H.currentTxForDrawer=null}const nd=3;function ad(){return H.qSeq+=1,"q"+H.qSeq+"_"+Date.now()}async function sd(e){const n=Array.from(e.target.files||[]);if(e.target.value="",n.length!==0){for(const a of n){const s={id:ad(),file:a,name:a.name,size:a.size,status:"pending",progress:0,error_code:null,tx_count:0,session_id:null};a.name.toLowerCase().endsWith(".pdf")?a.size>20*1024*1024&&(s.status="failed",s.error_code="bank_recon.file_too_large"):(s.status="failed",s.error_code="bank_recon.only_pdf"),H.queue.push(s)}od(),Pe(),_s()}}function od(){const e=document.getElementById("bank-upload-queue");e&&(e.style.display=""),zc(),Nc()}function Pe(){const e=document.getElementById("bank-upload-queue-list"),n=document.getElementById("bank-upload-queue-summary");if(!e)return;if(H.queue.length===0){e.innerHTML="",n&&(n.textContent="");const r=document.getElementById("bank-upload-queue");r&&(r.style.display="none");return}let a=0,s=0,o=0,i=0;for(const r of H.queue)r.status==="ok"?a++:r.status==="failed"?s++:r.status==="uploading"||r.status==="parsing"?o++:i++;n&&(n.textContent=t("bank-queue-summary").replace("{ok}",a).replace("{run}",o).replace("{wait}",i).replace("{fail}",s)),e.innerHTML=H.queue.map(id).join(""),e.querySelectorAll("[data-q-act]").forEach(r=>{const l=r.dataset.qAct,m=r.dataset.qId;r.addEventListener("click",()=>{l==="retry"&&rd(m),l==="remove"&&ld(m)})})}function id(e){const n=(e.size/1024).toFixed(0)+" KB";let a="",s="";if(e.status==="pending")a='<span class="bq-stat bq-wait">'+t("bank-queue-status-wait")+"</span>",s='<button data-q-act="remove" data-q-id="'+X(e.id)+'" class="bq-act">×</button>';else if(e.status==="uploading")a='<span class="bq-stat bq-run">'+t("bank-queue-status-uploading")+'</span><div class="bq-bar"><div class="bq-bar-fill" style="width:'+(e.progress||0)+'%"></div></div>';else if(e.status==="parsing")a='<span class="bq-stat bq-run">'+t("bank-queue-status-parsing")+'</span><div class="bq-bar"><div class="bq-bar-fill bq-bar-indet"></div></div>';else if(e.status==="ok")a='<span class="bq-stat bq-ok">'+t("bank-queue-status-ok").replace("{n}",e.tx_count||0)+"</span>",s='<button data-q-act="remove" data-q-id="'+X(e.id)+'" class="bq-act">×</button>';else if(e.status==="failed"){const o=Oc(e.error_code||"unknown");a='<span class="bq-stat bq-fail" title="'+X(o)+'">'+X(o)+"</span>",s='<button data-q-act="retry" data-q-id="'+X(e.id)+'" class="bq-act bq-act-retry">'+t("bank-queue-retry")+'</button><button data-q-act="remove" data-q-id="'+X(e.id)+'" class="bq-act">×</button>'}return'<div class="bq-row" data-q-row="'+X(e.id)+'"><div class="bq-name" title="'+X(e.name)+'">'+X(e.name)+'</div><div class="bq-size">'+n+'</div><div class="bq-status">'+a+'</div><div class="bq-actions">'+s+"</div></div>"}function rd(e){const n=H.queue.find(a=>a.id===e);n&&(n.status="pending",n.error_code=null,n.progress=0,Pe(),_s())}function ld(e){const n=H.queue.findIndex(s=>s.id===e);if(n<0)return;const a=H.queue[n];a.status==="uploading"||a.status==="parsing"||(H.queue.splice(n,1),Pe())}function cd(){H.queue=H.queue.filter(e=>e.status!=="ok"),Pe()}async function _s(){for(;;){if(H.queue.filter(a=>a.status==="uploading"||a.status==="parsing").length>=nd)return;const n=H.queue.find(a=>a.status==="pending");if(!n){H.queue.every(a=>a.status==="ok"||a.status==="failed")&&(await Qt(),typeof window.loadReconcilePage=="function"&&window.loadReconcilePage());return}dd(n).then(()=>_s())}}async function dd(e){e.status="uploading",e.progress=0,Pe();try{const n=new FormData;n.append("file",e.file,e.name);const a=await new Promise((o,i)=>{const r=new XMLHttpRequest;r.open("POST","/api/bank-recon/upload"),r.setRequestHeader("Authorization","Bearer "+token),r.upload.onprogress=l=>{l.lengthComputable&&(e.progress=Math.min(99,Math.round(l.loaded/l.total*100)),Pe())},r.upload.onload=()=>{e.status="parsing",Pe()},r.onload=()=>{r.status>=200&&r.status<300?o({status:r.status,text:r.responseText}):o({status:r.status,text:r.responseText})},r.onerror=()=>i(new Error("network")),r.send(n)});let s={};try{s=JSON.parse(a.text||"{}")}catch{s={}}if(a.status>=400){e.status="failed",e.error_code=s&&s.detail||"unknown",Pe();return}if(s.parse_status==="parse_failed"){e.status="failed",e.error_code=s.error==="scanned_pdf_not_yet"?"bank_recon.scanned":"bank_recon.no_tx",Pe();return}e.status="ok",e.tx_count=s.tx_count||0,e.session_id=s.session_id||null,Pe()}catch(n){console.warn("[bank-recon] upload failed",n),e.status="failed",e.error_code="network",Pe()}}async function qi(){if(H.loaded){uo();return}H.loaded=!0,pd(),await Qt(),uo()}function pd(){const e=document.getElementById("bank-file-input");e&&!e._bound&&(e._bound=!0,e.addEventListener("change",sd));const n=document.getElementById("btn-bank-queue-clear-done");n&&!n._bound&&(n._bound=!0,n.addEventListener("click",cd));const a=document.getElementById("btn-bank-back");a&&!a._bound&&(a._bound=!0,a.addEventListener("click",()=>{H.currentSession=null,H.currentTxs=[],xs()}));const s=document.getElementById("btn-bank-delete");s&&!s._bound&&(s._bound=!0,s.addEventListener("click",Kc));const o=document.getElementById("btn-bank-run-match");o&&!o._bound&&(o._bound=!0,o.addEventListener("click",Wc)),document.querySelectorAll(".bank-filter-btn").forEach(p=>{p._bound||(p._bound=!0,p.addEventListener("click",()=>{H.currentFilter=p.dataset.bankFilter||"all",document.querySelectorAll(".bank-filter-btn").forEach(c=>{c.classList.toggle("active",c===p)}),ws()}))}),document.querySelectorAll("[data-bank-cand-close]").forEach(p=>{p._bound||(p._bound=!0,p.addEventListener("click",kn))});const i=document.getElementById("btn-bank-cand-pane-close");i&&!i._bound&&(i._bound=!0,i.addEventListener("click",kn));const r=document.getElementById("btn-bank-cand-ignore");r&&!r._bound&&(r._bound=!0,r.addEventListener("click",po));const l=document.getElementById("btn-bank-cand-ignore-pane");l&&!l._bound&&(l._bound=!0,l.addEventListener("click",po));const m=document.getElementById("bank-client-badge");m&&!m._bound&&(m._bound=!0,m.addEventListener("click",Xc)),document.querySelectorAll("[data-bank-client-picker-close]").forEach(p=>{p._bound||(p._bound=!0,p.addEventListener("click",ji))});const d=document.getElementById("btn-bank-client-picker-save");d&&!d._bound&&(d._bound=!0,d.addEventListener("click",Zc)),document.querySelectorAll(".bank-sessions-chip").forEach(p=>{p._bound||(p._bound=!0,p.addEventListener("click",()=>{H.sessionFilter=p.dataset.sessFilter||"all",document.querySelectorAll(".bank-sessions-chip").forEach(c=>{c.classList.toggle("active",c===p)}),Jn()}))})}window._deleteBankSession=Di;window._loadBankReconPanel=qi;window._rerenderBankRecon=function(){if(currentRoute==="automation"){if(Jn(),H.currentSession&&(Ai(),ws(),ks(),!H.currentTxForDrawer)){const e=document.getElementById("bank-cand-pane-title"),n=document.getElementById("bank-cand-pane-sub");e&&(e.textContent=t("bank-cand-pane-empty-title")),n&&(n.textContent=t("bank-cand-pane-empty-sub"))}Pe()}};typeof window.subscribeI18n=="function"&&window.subscribeI18n("bank-recon",window._rerenderBankRecon);window._openBankSession=async function(e){e&&(H.loaded||await qi(),await Zt(e))};(function(){const e=document.getElementById("page-clients");if(!(!e||e.dataset.wbInjected==="1")){e.innerHTML=`
        <div class="page-head">
            <div class="page-head-icon">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
...
`,e.dataset.wbInjected="1";try{const n=window._currentLang||localStorage.getItem("mrpilot_lang")||"th",a=window.I18N;a&&a[n]&&(e.querySelectorAll("[data-i18n]").forEach(s=>{const o=s.getAttribute("data-i18n");a[n][o]&&(s.textContent=a[n][o])}),e.querySelectorAll("[data-i18n-placeholder]").forEach(s=>{const o=s.getAttribute("data-i18n-placeholder");a[n][o]&&(s.placeholder=a[n][o])}))}catch{}}})();const ud=`
    ...
    `;$e("client-modal-mask",ud);$e("wsclient-modal-mask",md);const U={clients:[],editingClientId:null,historyClientFilter:"",custTab:"seller",sellerClients:[],editingWsClientId:null,catCache:{fetched:0,items:[],supplier_count:0}},Be={page:0,pageSize:12,keyword:""},nt=new Set,Xn={keyword:""};function vd(){return{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||"")}}async function Ke(e,n={}){const a=await fetch(e,{...n,headers:{"Content-Type":"application/json",...vd(),...n.headers||{}}});if(!a.ok){const s=await a.json().catch(()=>({}));throw new Error(s.detail||"HTTP "+a.status)}return a.json()}function fd(){const e=document.querySelector("#client-color-picker .color-swatch.active");return e?e.dataset.color:"#111111"}function mo(e){const n=document.getElementById("drawer-cat-learned-tag");n&&e>0&&(n.textContent=(t("drawer-suggest-learned-with-count")||"已学 {n}").replace("{n}",String(e)))}async function en(){try{const e=await Ke("/api/clients");U.clients=e.clients||[],window._clientsCache=U.clients}catch(e){console.error("loadClientsCache fail",e),U.clients=[]}try{typeof window._refreshExcClientFilter=="function"&&window._refreshExcClientFilter()}catch{}try{typeof window._refreshClientSwitcher=="function"&&window._refreshClientSwitcher()}catch{}return U.clients}function hd(){const e=Be.keyword.trim().toLowerCase();return e?U.clients.filter(n=>(n.name||"").toLowerCase().includes(e)||(n.short_name||"").toLowerCase().includes(e)||(n.tax_id||"").toLowerCase().includes(e)):U.clients}function Es(){const e=hd(),n=Be.pageSize,a=Math.max(0,Math.ceil(e.length/n)-1);Be.page>a&&(Be.page=a);const s=Be.page*n;return{all:e,items:e.slice(s,s+n),start:s,ps:n,total:e.length,maxPage:a}}function Xe(){const e=document.getElementById("buyer-tbody");if(!e)return;const{items:n,start:a,ps:s,total:o,maxPage:i}=Es();o?e.innerHTML=n.map(d=>{const p=nt.has(d.id);return`<div class="cust-row buyer-grid${p?" selected":""}" data-cid="${d.id}">
            ...
            </div>`}).join(""):e.innerHTML=`<div class="cust-empty">${escapeHtml(t(Be.keyword?"cust-no-match":"clients-empty"))}</div>`;const r=document.getElementById("buyer-pager-info");r&&(r.textContent=o?`${a+1}–${Math.min(a+s,o)} / ${o}`:"0");const l=document.getElementById("buyer-prev");l&&(l.disabled=Be.page<=0);const m=document.getElementById("buyer-next");m&&(m.disabled=Be.page>=i),Ri()}function Ri(){const e=nt.size,n=document.getElementById("buyer-batch-bar");n&&(n.style.display=e?"flex":"none");const a=document.getElementById("buyer-batch-count");a&&(a.textContent=t("cust-selected-n").replace("{n}",e));const s=document.getElementById("buyer-check-all");if(s){const{items:o}=Es(),i=o.map(l=>l.id),r=i.filter(l=>nt.has(l)).length;s.checked=i.length>0&&r===i.length,s.indeterminate=r>0&&r<i.length}}function gd(){nt.clear(),Xe()}async function bd(){const e=Array.from(nt);if(!(!e.length||!await showConfirm(t("cust-batch-del-confirm").replace("{n}",e.length),{danger:!0})))try{await Ke("/api/clients/batch-delete",{method:"POST",body:JSON.stringify({ids:e})}),showToast(t("client-msg-deleted"),"success"),nt.clear(),await en(),Xe(),fa(),Is()}catch{showToast(t("client-msg-save-fail"),"fail")}}function vn(e){U.editingClientId=e?e.id:null;const n=!!e;document.getElementById("client-modal-title").textContent=t(n?"client-modal-edit":"client-modal-new"),document.getElementById("client-input-name").value=e&&e.name||"",document.getElementById("client-input-short").value=e&&e.short_name||"",document.getElementById("client-input-tax").value=e&&e.tax_id||"",document.getElementById("client-input-address").value=e&&e.address||"",document.getElementById("client-input-contact").value=e&&e.contact_person||"",document.getElementById("client-input-phone").value=e&&e.contact_phone||"",document.getElementById("client-input-email").value=e&&e.contact_email||"",document.getElementById("client-input-notes").value=e&&e.notes||"",document.getElementById("client-input-party-type").value=e&&e.party_type||"",document.getElementById("client-input-branch").value=e&&e.branch||"",document.getElementById("client-input-promptpay").value=e&&e.promptpay_id||"";const a=e&&e.color||"#111111";document.querySelectorAll("#client-color-picker .color-swatch").forEach(s=>{s.classList.toggle("active",s.dataset.color===a)}),document.getElementById("client-modal-delete").style.display=n?"":"none",document.getElementById("client-modal-mask").style.display="flex",setTimeout(()=>document.getElementById("client-input-name").focus(),50)}function fn(){document.getElementById("client-modal-mask").style.display="none",U.editingClientId=null}async function yd(){const e=document.getElementById("client-input-name").value.trim();if(!e){showToast(t("client-msg-name-required"),"fail");return}const n={name:e,short_name:document.getElementById("client-input-short").value.trim()||null,tax_id:document.getElementById("client-input-tax").value.trim()||null,address:document.getElementById("client-input-address").value.trim()||null,contact_person:document.getElementById("client-input-contact").value.trim()||null,contact_phone:document.getElementById("client-input-phone").value.trim()||null,contact_email:document.getElementById("client-input-email").value.trim()||null,notes:document.getElementById("client-input-notes").value.trim()||null,color:fd(),party_type:document.getElementById("client-input-party-type").value||null,branch:document.getElementById("client-input-branch").value.trim()||null,promptpay_id:document.getElementById("client-input-promptpay").value.trim()||null};try{U.editingClientId?(await Ke(`/api/clients/${U.editingClientId}`,{method:"PATCH",body:JSON.stringify(n)}),showToast(t("client-msg-updated"),"success")):(await Ke("/api/clients",{method:"POST",body:JSON.stringify(n)}),showToast(t("client-msg-created"),"success")),fn(),await en(),currentRoute==="clients"&&Xe(),fa(),Is()}catch(a){console.error("saveClient fail",a);const s=a&&a.message?a.message:t("client-msg-save-fail");showToast(t("client-msg-save-fail")+" · "+s,"fail")}}async function wd(){if(!U.editingClientId)return;const e=U.clients.find(s=>s.id===U.editingClientId);if(!e)return;const n=t("client-delete-confirm").replace("{name}",e.name);if(await showConfirm(n,{danger:!0}))try{await Ke(`/api/clients/${U.editingClientId}`,{method:"DELETE"}),showToast(t("client-msg-deleted"),"success"),fn(),await en(),currentRoute==="clients"&&Xe(),fa(),Is()}catch(s){console.error(s),showToast(t("client-msg-save-fail"),"fail")}}async function kd(e){const n=U.clients.find(a=>a.id===e);if(typeof window.openClientExportModal=="function"){window.openClientExportModal(e,n?n.name:"");return}try{const a=localStorage.getItem("mrpilot_token"),s=await fetch(`/api/clients/${e}/export?month=all`,{headers:{Authorization:"Bearer "+a}});if(!s.ok){let m="HTTP "+s.status;try{const d=await s.json();d&&d.detail&&(m=d.detail)}catch{}throw new Error(m)}const o=await s.blob();if(o.size<200){showToast(t("client-export-month-empty"),"info");return}const i=n&&n.name?n.name.replace(/[^a-zA-Z0-9\u0e00-\u0e7f\u4e00-\u9fff]/g,"_").slice(0,40):"client",r=URL.createObjectURL(o),l=document.createElement("a");l.href=r,l.download=`${i}_export.csv`,l.click(),URL.revokeObjectURL(r)}catch(a){console.error("exportClient fail",a),showToast(t("client-msg-save-fail")+" · "+(a.message||""),"fail")}}function fa(){const e=document.getElementById("drawer-client-select");if(!e)return;const n=e.value;e.innerHTML=`<option value="">${escapeHtml(t("drawer-client-none"))}</option>`+U.clients.map(a=>`<option value="${a.id}">${escapeHtml(a.name)}</option>`).join(""),e.value=n||""}function Is(){const e=document.getElementById("history-client-filter");if(!e)return;const n=e.value;e.innerHTML=`<option value="">${escapeHtml(t("history-client-all"))}</option>`+U.clients.map(a=>`<option value="${a.id}">${escapeHtml(a.name)}</option>`).join(""),e.value=n||""}function xd(e){U.custTab=e==="buyer"?"buyer":"seller",document.querySelectorAll("[data-cust-tab]").forEach(s=>s.classList.toggle("active",s.dataset.custTab===U.custTab));const n=document.getElementById("cust-pane-seller"),a=document.getElementById("cust-pane-buyer");n&&n.classList.toggle("active",U.custTab==="seller"),a&&a.classList.toggle("active",U.custTab==="buyer")}function _d(){const e=window._userInfo||{},n=String(e.role||"").toLowerCase(),a=String(e.tenant_role||"").toLowerCase();return e.is_super_admin===!0||e.is_owner===!0||n==="owner"||n==="admin"||a==="owner"||a==="admin"}function Fi(){window._workspaceClientsCache=U.sellerClients,typeof window.renderWorkspaceControl=="function"&&window.renderWorkspaceControl()}async function Bs(){try{const e=await Ke("/api/workspace/clients");U.sellerClients=e&&(e.clients||e.items)||[],window._workspaceClientsCache=U.sellerClients}catch(e){console.error("loadSellerCache fail",e),U.sellerClients=[]}return U.sellerClients}function Ed(){const e=Xn.keyword.trim().toLowerCase();return e?U.sellerClients.filter(n=>(n.name||"").toLowerCase().includes(e)||(n.tax_id||"").toLowerCase().includes(e)):U.sellerClients}function Tt(){const e=document.getElementById("seller-tbody");if(!e)return;const n=_d(),a=document.getElementById("btn-seller-new");a&&(a.style.display=n?"":"none");const s=Ed(),o=typeof window.getActiveWorkspaceClientId=="function"?window.getActiveWorkspaceClientId():null;if(!s.length){e.innerHTML=`<div class="cust-empty">${escapeHtml(t(Xn.keyword?"cust-no-match":"seller-empty"))}</div>`;return}e.innerHTML=s.map(i=>{const l=o!=null&&Number(o)===Number(i.id)?`<span class="cust-badge-current"><svg viewBox="0 0 14 14" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M2 7.5l3.2 3.2L12 4"/></svg>${escapeHtml(t("seller-current"))}</span>`:`<button class="cust-row-btn primary" data-saction="activate" data-wid="${i.id}">${escapeHtml(t("seller-set-current"))}</button>`,m=n?`
        ...
        </div>`}).join("")}function vo(e){U.editingWsClientId=e?e.id:null,document.getElementById("wsclient-modal-title").textContent=t(e?"wsclient-modal-edit":"wsclient-modal-new"),document.getElementById("wsclient-input-name").value=e&&e.name||"",document.getElementById("wsclient-input-tax").value=e&&e.tax_id||"",document.getElementById("wsclient-input-address").value=e&&e.address||"",document.getElementById("wsclient-input-branch").value=e&&e.branch||"",document.getElementById("wsclient-input-phone").value=e&&e.phone||"",document.getElementById("wsclient-input-vat").checked=e?e.vat_registered!==!1:!0,document.getElementById("wsclient-modal-archive").style.display=e?"":"none",document.getElementById("wsclient-modal-mask").style.display="flex",setTimeout(()=>document.getElementById("wsclient-input-name").focus(),50)}function hn(){document.getElementById("wsclient-modal-mask").style.display="none",U.editingWsClientId=null}async function Id(){const e=document.getElementById("wsclient-input-name").value.trim(),n=document.getElementById("wsclient-input-tax").value.trim(),a=document.getElementById("wsclient-input-address").value.trim(),s=document.getElementById("wsclient-input-branch").value.trim(),o=document.getElementById("wsclient-input-phone").value.trim(),i=document.getElementById("wsclient-input-vat").checked;if(!e){showToast(t("client-msg-name-required"),"fail");return}const r={address:a||null,branch:s||null,phone:o||null,vat_registered:i};try{U.editingWsClientId?(await Ke("/api/workspace/clients/"+U.editingWsClientId,{method:"PATCH",body:JSON.stringify({name:e,tax_id:n,...r})}),showToast(t("client-msg-updated"),"success")):(await Ke("/api/workspace/clients",{method:"POST",body:JSON.stringify({name:e,tax_id:n||null,...r})}),showToast(t("client-msg-created"),"success")),hn(),await Bs(),Tt(),Fi()}catch(l){const m=l&&l.message?l.message:t("client-msg-save-fail");showToast(t("client-msg-save-fail")+" · "+m,"fail")}}async function fo(){if(!U.editingWsClientId)return;const e=U.sellerClients.find(a=>Number(a.id)===Number(U.editingWsClientId));if(await showConfirm(t("wsclient-archive-confirm").replace("{name}",e?e.name:""),{danger:!0}))try{const a=U.editingWsClientId;await Ke("/api/workspace/clients/"+a,{method:"DELETE"}),showToast(t("wsclient-archived"),"success"),typeof window.getActiveWorkspaceClientId=="function"&&Number(window.getActiveWorkspaceClientId())===Number(a)&&typeof window.enterPersonalMode=="function"&&window.enterPersonalMode(),hn(),await Bs(),Tt(),Fi()}catch{showToast(t("client-msg-save-fail"),"fail")}}window.loadClientsPage=async function(){const e=document.getElementById("seller-tbody");e&&(e.innerHTML=`<div class="cust-loading">${escapeHtml(t("clients-loading"))}</div>`);const n=document.getElementById("buyer-tbody");n&&(n.innerHTML=`<div class="cust-loading">${escapeHtml(t("clients-loading"))}</div>`),await Promise.all([Bs(),en()]),Tt(),Xe()};window.addEventListener("pearnly:workspace-changed",function(){typeof currentRoute<"u"&&currentRoute==="clients"&&Tt()});window.bindDrawerClient=function(e,n){const a=document.getElementById("drawer-client-select");if(!a)return;if(fa(),a.value=n?String(n):"",!e){a.onchange=null;const o=document.getElementById("drawer-client-add");o&&(o.onclick=()=>vn(null));return}a.onchange=async()=>{const o=a.value?parseInt(a.value,10):null;try{await Ke(`/api/history/${e}/assign_client`,{method:"POST",body:JSON.stringify({client_id:o})}),showToast(t("client-msg-updated"),"success");const i=_results[_drawerIdx];i&&(i.client_id=o),await en()}catch(i){console.error(i),showToast(t("client-msg-save-fail"),"fail"),a.value=n?String(n):""}};const s=document.getElementById("drawer-client-add");s&&(s.onclick=()=>vn(null))};window.fillCategoryDatalist=async function(){try{const e=document.getElementById("drawer-cat-datalist"),n=Date.now();if(n-U.catCache.fetched<300*1e3){e&&(e.innerHTML=U.catCache.items.map(s=>`<option value="${escapeHtml(s)}">`).join("")),mo(U.catCache.supplier_count);return}const a=await Ke("/api/categories",{method:"GET"});U.catCache.fetched=n,U.catCache.items=a&&a.categories||[],U.catCache.supplier_count=a&&a.supplier_count||0,e&&(e.innerHTML=U.catCache.items.map(s=>`<option value="${escapeHtml(s)}">`).join("")),mo(U.catCache.supplier_count)}catch(e){console.warn("fillCategoryDatalist failed",e)}};window.getHistoryClientFilter=function(){return U.historyClientFilter};document.addEventListener("DOMContentLoaded",()=>{const e=document.querySelector(".cust-tab-bar");e&&e.addEventListener("click",L=>{const $=L.target.closest("[data-cust-tab]");$&&xd($.dataset.custTab)});const n=document.getElementById("btn-buyer-new");n&&n.addEventListener("click",()=>vn(null));const a=document.getElementById("buyer-tbody");a&&a.addEventListener("click",L=>{const $=L.target.closest(".buyer-row-check");if($){const R=parseInt($.dataset.cid,10);$.checked?nt.add(R):nt.delete(R);const G=$.closest(".cust-row");G&&G.classList.toggle("selected",$.checked),Ri();return}const S=L.target.closest(".cust-row-btn");if(S){L.stopPropagation();const R=parseInt(S.dataset.cid,10);if(S.dataset.action==="edit"){const G=U.clients.find(se=>se.id===R);G&&vn(G)}else S.dataset.action==="export"&&kd(R);return}const M=L.target.closest(".cust-row");if(M&&!L.target.closest(".cust-cell-check")){const R=U.clients.find(G=>G.id===parseInt(M.dataset.cid,10));R&&vn(R)}});const s=document.getElementById("buyer-check-all");s&&s.addEventListener("change",()=>{const{items:L}=Es();L.forEach($=>{s.checked?nt.add($.id):nt.delete($.id)}),Xe()});const o=document.getElementById("buyer-batch-cancel");o&&o.addEventListener("click",gd);const i=document.getElementById("buyer-batch-delete");i&&i.addEventListener("click",bd);const r=document.getElementById("buyer-prev");r&&r.addEventListener("click",()=>{Be.page>0&&(Be.page--,Xe())});const l=document.getElementById("buyer-next");l&&l.addEventListener("click",()=>{Be.page++,Xe()});const m=document.getElementById("buyer-search");if(m){let L;m.addEventListener("input",()=>{clearTimeout(L),L=setTimeout(()=>{Be.keyword=m.value,Be.page=0;const $=document.getElementById("buyer-search-clear");$&&($.style.display=m.value?"":"none"),Xe()},200)})}const d=document.getElementById("buyer-search-clear");d&&d.addEventListener("click",()=>{const L=document.getElementById("buyer-search");L&&(L.value=""),Be.keyword="",Be.page=0,d.style.display="none",Xe()});const p=document.getElementById("btn-seller-new");p&&p.addEventListener("click",()=>vo(null));const c=document.getElementById("seller-tbody");c&&c.addEventListener("click",L=>{const $=L.target.closest("[data-saction]");if(!$)return;L.stopPropagation();const S=parseInt($.dataset.wid,10),M=$.dataset.saction,R=U.sellerClients.find(G=>Number(G.id)===S);M==="activate"?(typeof window.setActiveWorkspaceClientId=="function"&&window.setActiveWorkspaceClientId(S),Tt(),typeof window.renderWorkspaceControl=="function"&&window.renderWorkspaceControl(),showToast(t("seller-activated").replace("{name}",R?R.name:""),"success")):M==="edit"?R&&vo(R):M==="archive"&&(U.editingWsClientId=S,fo())});const u=document.getElementById("seller-search");if(u){let L;u.addEventListener("input",()=>{clearTimeout(L),L=setTimeout(()=>{Xn.keyword=u.value;const $=document.getElementById("seller-search-clear");$&&($.style.display=u.value?"":"none"),Tt()},200)})}const v=document.getElementById("seller-search-clear");v&&v.addEventListener("click",()=>{const L=document.getElementById("seller-search");L&&(L.value=""),Xn.keyword="",v.style.display="none",Tt()});const f=document.getElementById("wsclient-modal-close");f&&f.addEventListener("click",hn);const y=document.getElementById("wsclient-modal-cancel");y&&y.addEventListener("click",hn);const b=document.getElementById("wsclient-modal-save");b&&b.addEventListener("click",Id);const h=document.getElementById("wsclient-modal-archive");h&&h.addEventListener("click",fo);const g=document.getElementById("wsclient-modal-mask");g&&g.addEventListener("click",L=>{L.target===g&&hn()});const _=document.getElementById("client-modal-close");_&&_.addEventListener("click",fn);const w=document.getElementById("client-modal-cancel");w&&w.addEventListener("click",fn);const k=document.getElementById("client-modal-save");k&&k.addEventListener("click",yd);const x=document.getElementById("client-modal-delete");x&&x.addEventListener("click",wd);const E=document.getElementById("client-modal-mask");E&&E.addEventListener("click",L=>{L.target===E&&fn()});const I=document.getElementById("client-color-picker");I&&I.addEventListener("click",L=>{const $=L.target.closest(".color-swatch");$&&(I.querySelectorAll(".color-swatch").forEach(S=>S.classList.remove("active")),$.classList.add("active"))});const B=document.getElementById("history-client-filter");B&&B.addEventListener("change",()=>{U.historyClientFilter=B.value,typeof renderHistoryList=="function"&&renderHistoryList()})});setTimeout(()=>en(),1e3);(function(){const e=document.getElementById("page-exceptions");if(!(!e||e.dataset.wbInjected==="1")){e.innerHTML=`
        <div class="page-head">
            <div class="page-head-icon">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round">
...
`,e.dataset.wbInjected="1";try{const n=window._currentLang||localStorage.getItem("mrpilot_lang")||"th",a=window.I18N;a&&a[n]&&(e.querySelectorAll("[data-i18n]").forEach(s=>{const o=s.getAttribute("data-i18n");a[n][o]&&(s.textContent=a[n][o])}),e.querySelectorAll("[data-i18n-placeholder]").forEach(s=>{const o=s.getAttribute("data-i18n-placeholder");a[n][o]&&(s.placeholder=a[n][o])}))}catch{}}})();const q={statsCache:null,listCache:[],currentRule:null,currentClient:"",currentStatus:"pending",loading:!1,selectedIds:new Set,offset:0,pageSize:50,total:0,loadFailed:!1,listScrollY:0},D={openExcId:null,excRow:null,history:null,loading:!1,pdfUrl:null,pdfStatus:"idle",editing:!1,editFields:null},Nt={batchLoading:!1};function gt(e,n){let a=t(e)||e;if(n)for(const s in n)a=a.replace(new RegExp("\\{"+s+"\\}","g"),String(n[s]));return a}function Bd(e){return e==="high"?`<svg viewBox="0 0 14 14" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
    ...
    `;const l=e.severity||"medium",m=Ls(e),d=Ad(e.rule_code,e.detail||{}),p=ho(D.history),c=D.history===null,u=D.history&&D.history._err,v=new Set,f=e.rule_code||"";["math_mismatch","R-VAT-01","R-VAT-02","R-SUM-01","R-LINE-01"].includes(f)?(v.add("subtotal"),v.add("vat"),v.add("total_amount")):f==="R-MULTIPAGE-01"||f==="R-LIMIT-01"?v.add("total_amount"):f==="tax_id_format_invalid"||f==="R-TAXID-01"?v.add("seller_tax"):f==="R-TAXID-02"?v.add("buyer_tax"):f==="R-TAXID-03"?(v.add("seller_tax"),v.add("buyer_tax")):f==="R-DATE-01"||f==="R-DATE-02"?v.add("date"):f==="R-DUP-01"||f==="R-DUP-02"?v.add("invoice_number"):f==="R-SUP-01"||f==="R-SUP-02"?(v.add("seller_name"),v.add("seller_tax")):f==="amount_missing"&&(v.add("total_amount"),v.add("invoice_number"));const y=!!D.editing,b=D.editFields||{},h=(M,R,G)=>{if(c)return`<div class="exc-field-row"><label>${escapeHtml(t(R))}</label><span class="val empty">…</span></div>`;const se=y?b[M]!==void 0?b[M]:p[M]!==void 0&&p[M]!==null?p[M]:"":p[M],ce=v.has(M)?"flagged":"";if(y){const V=G?"number":"text",O=G?' step="0.01" inputmode="decimal"':"",Y=se==null?"":String(se).replace(/"/g,"&quot;");return`<div class="exc-field-row ${ce} editing">
                <label>${escapeHtml(t(R))}</label>
                <input class="exc-field-input" type="${V}"${O} data-edit-key="${escapeHtml(M)}" value="${Y}">
            </div>`}const Ee=G?rt(se):se||"",ke=se==null||se===""?`<span class="val empty">${escapeHtml(t("exc-empty-val"))}</span>`:`<span class="val">${escapeHtml(Ee)}</span>`;return`<div class="exc-field-row ${ce}"><label>${escapeHtml(t(R))}</label>${ke}</div>`};let g="";u?g=`<div class="exc-drawer-error">${escapeHtml(t("exc-drawer-error"))}</div>`:g=`
    ...
    `;const w=document.getElementById("exc-fld-edit");w&&w.addEventListener("click",()=>{D.editing=!0,D.editFields={...ho(D.history)},ct()});const k=document.getElementById("exc-fld-cancel");k&&k.addEventListener("click",()=>{D.editing=!1,D.editFields=null,ct()});const x=document.getElementById("exc-fld-save");x&&x.addEventListener("click",()=>Dd()),document.querySelectorAll(".exc-field-input").forEach(M=>{M.addEventListener("input",()=>{D.editFields||(D.editFields={}),D.editFields[M.dataset.editKey]=M.value})});const I=document.getElementById("exc-pdf-retry");I&&D.openExcId&&I.addEventListener("click",()=>{D.excRow&&zi(D.excRow.history_id,D.openExcId)});const B=e.status==="pending",L=!!(e.seller_name&&e.seller_name.trim()),$=document.getElementById("exc-btn-resolve"),S=document.getElementById("exc-btn-ignore");$.disabled=!B,S.disabled=!B||!L,S.title=L?t("exc-ignore-hint"):t("exc-ignore-no-seller")}function $s(){if(D.pdfUrl){try{URL.revokeObjectURL(D.pdfUrl)}catch{}D.pdfUrl=null}D.pdfStatus="idle"}async function zi(e,n){D.pdfStatus="loading",ct();try{const a=await fetch("/api/history/"+encodeURIComponent(e)+"/pdf",{headers:{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||"")}});if(D.openExcId!==n)return;if(a.status===404){D.pdfStatus="empty",ct();return}if(!a.ok)throw new Error("http "+a.status);const s=await a.blob();if(D.openExcId!==n)return;$s(),D.pdfUrl=URL.createObjectURL(s),D.pdfStatus="ready",ct()}catch(a){if(D.openExcId!==n)return;console.warn("loadDrawerPdf fail",a),D.pdfStatus="error",ct()}}function jd(e){const n=(q.listCache||[]).find(a=>a.id===e);if(!n){showToast(t("exc-drawer-error"),"error");return}q.listScrollY=window.scrollY||document.documentElement.scrollTop||0,$s(),D.editing=!1,D.editFields=null,D.openExcId=e,D.excRow=n,D.history=null,document.getElementById("exc-drawer-mask").classList.add("show"),document.getElementById("exc-drawer").classList.add("show"),ct(),Pd(n.history_id),zi(n.history_id,e)}function Yt(){$s(),D.editing=!1,D.editFields=null,D.openExcId=null,D.excRow=null,D.history=null,document.getElementById("exc-drawer-mask").classList.remove("show"),document.getElementById("exc-drawer").classList.remove("show");const e=q.listScrollY||0;e>0&&requestAnimationFrame(()=>window.scrollTo(0,e))}async function Pd(e){try{const n=await fetch("/api/history/"+encodeURIComponent(e),{headers:{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||"")}});if(!n.ok)throw new Error("http "+n.status);D.history=await n.json()}catch(n){console.warn("loadHistoryDetail fail",n),D.history={_err:!0}}D.excRow&&ct()}function ho(e){if(!e||!e.pages)return{};const n=e.pages,a=n.find(s=>!s.is_duplicate&&!s.is_copy)||n[0];return a&&a.fields||{}}async function Dd(){if(!D.openExcId||!D.history||!D.history.pages||D.loading)return;D.loading=!0;const e=showToast(t("exc-fld-saving"),"loading",0);try{const n=JSON.parse(JSON.stringify(D.history.pages||[]));let a=n.findIndex(m=>!m.is_duplicate&&!m.is_copy);a<0&&(a=0),n[a]||(n[a]={fields:{}});const s=n[a].fields||{},o=D.editFields||{},i=new Set(["subtotal","vat","total_amount"]),r={...s};for(const m in o){let d=o[m];if((d===""||d===void 0)&&(d=null),i.has(m)&&d!==null){const p=parseFloat(d);d=isNaN(p)?null:p}r[m]=d}n[a].fields=r;const l=await fetch("/api/history/"+encodeURIComponent(D.history.id),{method:"PUT",headers:{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||""),"Content-Type":"application/json"},body:JSON.stringify({pages:n})});if(!l.ok)throw new Error("http "+l.status);e(),showToast(t("exc-fld-save-ok"),"success"),Yt(),await tn(),await wt(),at()}catch(n){e(),console.warn("save fields fail",n),showToast(t("exc-fld-save-fail"),"error")}finally{D.loading=!1}}async function qd(){if(!(!D.openExcId||D.loading)){D.loading=!0;try{const e=await fetch("/api/exceptions/"+D.openExcId+"/resolve",{method:"POST",headers:{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||"")}});if(!e.ok)throw new Error("http "+e.status);showToast(t("exc-toast-resolved"),"success"),Yt(),await tn(),await wt(),at()}catch(e){console.warn("resolve fail",e),showToast(t("exc-toast-action-fail"),"error")}finally{D.loading=!1}}}async function Rd(){if(!(!D.openExcId||D.loading)){D.loading=!0;try{const e=await fetch("/api/exceptions/"+D.openExcId+"/ignore",{method:"POST",headers:{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||"")}});if(!e.ok)throw new Error("http "+e.status);showToast(t("exc-toast-ignored"),"success"),Yt(),await tn(),await wt(),at()}catch(e){console.warn("ignore fail",e),showToast(t("exc-toast-action-fail"),"error")}finally{D.loading=!1}}}async function at(){try{const e=q.currentClient||"",n="/api/exceptions/stats?status=pending"+(e?"&client_id="+encodeURIComponent(e):""),a=await fetch(n,{headers:{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||"")}});if(!a.ok)return;const s=await a.json(),o=document.getElementById("nav-exc-badge");if(!o)return;const i=parseInt(s.pending||0,10);i>0?(o.textContent=i>99?"99+":String(i),o.style.display=""):o.style.display="none"}catch{}}function Ni(e){document.getElementById("exc-kpi-pending").textContent=e.pending||0,document.getElementById("exc-kpi-high").textContent=e.high_severity||0,document.getElementById("exc-kpi-resolved").textContent=e.resolved||0,document.getElementById("exc-kpi-learned").textContent=e.learned_rules||0;const n=document.getElementById("exc-status-tab-count-pending"),a=document.getElementById("exc-status-tab-count-resolved"),s=document.getElementById("exc-status-tab-count-ignored");n&&(n.textContent=e.pending||0),a&&(a.textContent=e.resolved||0),s&&(s.textContent=e.ignored||0),document.querySelectorAll("#exc-status-tabs .exc-status-tab").forEach(i=>{i.classList.toggle("active",i.dataset.status===(q.currentStatus||"pending"))})}function Oi(e,n){return n.split(",").reduce((a,s)=>a+(e[s]||0),0)}function Ss(e){const n=document.getElementById("exc-chips");if(!n)return;const a=e.by_rule||{};let o=`<button class="exc-chip ${!q.currentRule?"active":""}" data-rule="">
        <span>${escapeHtml(t("exc-chip-all"))}</span>
        <span class="exc-chip-count">${e.pending||0}</span>
    </button>`;for(const i of Td){const r=i.codes.join(","),l=Oi(a,r),m=q.currentRule===r;l===0&&!m||(o+=`<button class="exc-chip ${m?"active":""}" data-rule="${escapeHtml(r)}">
            <span>${escapeHtml(t(i.labelKey))}</span>
            <span class="exc-chip-count">${l}</span>
        </button>`)}n.innerHTML=o,n.querySelectorAll(".exc-chip").forEach(i=>{i.addEventListener("click",()=>{const r=i.dataset.rule||null;q.currentRule=r,wt()})})}function Cs(e){const n=document.getElementById("exc-list");if(!n)return;if(!e||e.length===0){n.innerHTML=`<div class="exc-empty">
            ${Ld()}
            <div class="exc-empty-title">${escapeHtml(t("exc-empty-title"))}</div>
            <div>${escapeHtml(t("exc-empty-desc"))}</div>
        </div>`,bo();return}const a='<svg viewBox="0 0 14 14" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M3 7l3 3 5-5"/></svg>',s=(q.currentStatus||"pending")==="pending";n.innerHTML=e.map(o=>{const i=o.severity||"medium",r=Ls(o),l=o.seller_name&&o.seller_name.trim()?o.seller_name:t("exc-no-seller"),m=o.filename||"—",d=Sd(o.invoice_date||o.created_at),p=o.status==="pending",c=q.selectedIds.has(o.id),u=s&&p;return`
            <div class="exc-row sev-${escapeHtml(i)} ${c?"selected":""}" data-exc-id="${escapeHtml(String(o.id))}">
                ...
                <div class="exc-row-sev">${Bd(i)}</div>
                ...
                <div class="exc-row-amount">${escapeHtml($d(o.total_amount))}</div>
            </div>
        `}).join(""),n.querySelectorAll(".exc-row").forEach(o=>{o.addEventListener("click",i=>{if(i.target.closest(".exc-row-check"))return;const r=o.dataset.excId;r&&jd(parseInt(r,10))})}),n.querySelectorAll(".exc-row-check").forEach(o=>{o.addEventListener("click",i=>{i.stopPropagation();const r=parseInt(o.dataset.checkId,10);r&&(q.selectedIds.has(r)?(q.selectedIds.delete(r),o.classList.remove("checked"),o.closest(".exc-row").classList.remove("selected")):(q.selectedIds.add(r),o.classList.add("checked"),o.closest(".exc-row").classList.add("selected")),go())})}),go(),bo()}function go(){const e=document.getElementById("exc-batch-bar"),n=document.getElementById("exc-batch-count");if(!e||!n)return;const a=q.selectedIds.size;a===0?e.style.display="none":(e.style.display="",n.textContent=gt("exc-batch-count",{n:a}))}function bo(){const e=document.getElementById("exc-list-foot"),n=document.getElementById("exc-list-count"),a=document.getElementById("exc-loadmore");if(!e||!n||!a)return;const s=q.listCache.length;if(s===0){e.style.display="none";return}e.style.display="";let o=s;const i=q.statsCache;i&&(q.currentRule?o=Oi(i.by_rule||{},q.currentRule)||s:o=i.pending||s),q.total=o,n.textContent=gt("exc-list-count",{shown:s,total:o});const r=s<o&&s<500;a.style.display=r?"":"none"}async function tn(){try{if(navigator.onLine===!1)throw new Error("offline");const e=q.currentClient||"",n=q.currentStatus||"pending",a=new URLSearchParams;a.set("status",n),e&&a.set("client_id",e);const s="/api/exceptions/stats?"+a.toString(),o=await fetch(s,{headers:{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||"")}});if(!o.ok)throw new Error("http "+o.status);const i=await o.json();return q.statsCache=i,Ni(i),Ss(i),i}catch(e){return console.warn("loadExceptionsStats fail",e),null}}function Fd(e){const n=document.getElementById("exc-list");if(!n)return;const a=`<svg class="exc-error-icon" viewBox="0 0 36 36" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round">
        <circle cx="18" cy="18" r="14"/>
        ...
        </div>`;const i=document.getElementById("exc-retry-btn");i&&i.addEventListener("click",()=>window.loadExceptionsPage&&window.loadExceptionsPage())}async function wt(e){e=e||{};const n=!!e.append,a=document.getElementById("exc-list");!n&&a&&q.listCache.length===0&&(a.innerHTML=`<div class="exc-loading">${escapeHtml(t("exc-loading"))}</div>`);const s=new URLSearchParams;s.set("status",q.currentStatus||"pending"),q.currentRule&&s.set("rule_code",q.currentRule),q.currentClient&&s.set("client_id",q.currentClient);const o=n?q.listCache.length:0;s.set("limit",String(q.pageSize)),s.set("offset",String(o));try{if(navigator.onLine===!1)throw new Error("offline");const i=await fetch("/api/exceptions/list?"+s.toString(),{headers:{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||"")}});if(!i.ok)throw new Error("http "+i.status);const l=(await i.json()).items||[];n?q.listCache=q.listCache.concat(l):(q.listCache=l,q.selectedIds.clear()),q.loadFailed=!1,Cs(q.listCache),q.statsCache&&Ss(q.statsCache)}catch(i){console.warn("loadExceptionsList fail",i),q.loadFailed=!0;const r=navigator.onLine===!1||String(i.message||"").includes("offline");n?showToast(t("exc-toast-load-fail"),"error"):(Fd(r),showToast(r?t("exc-offline"):t("exc-toast-load-fail"),"error"))}}async function zd(){if(!q.loading&&!(q.listCache.length>=500)){q.loading=!0;try{await wt({append:!0})}finally{q.loading=!1}}}function Ts(){const e=document.getElementById("exc-client-filter");if(!e)return;const n=window._clientsCache||[],a=q.currentClient||"",s=typeof t=="function"?t("history-client-all"):"全部客户";e.innerHTML=`<option value="">${escapeHtml(s)}</option>`+n.map(o=>`<option value="${o.id}">${escapeHtml(o.name)}</option>`).join(""),e.value=a}async function Nd(){if(Nt.batchLoading)return;const e=Array.from(q.selectedIds);if(e.length===0||!await showConfirm(gt("exc-batch-confirm-resolve",{n:e.length})))return;Nt.batchLoading=!0;const a=showToast(gt("exc-batch-count",{n:e.length})+" …","loading",0);try{const s=await fetch("/api/exceptions/batch",{method:"POST",headers:{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||""),"Content-Type":"application/json"},body:JSON.stringify({ids:e,action:"resolve"})});if(!s.ok)throw new Error("http "+s.status);const o=await s.json();a(),showToast(gt("exc-toast-batch-resolved",{n:o.processed||0}),"success"),q.selectedIds.clear(),await tn(),await wt(),at()}catch(s){a(),console.warn("batch resolve fail",s),showToast(t("exc-toast-batch-fail"),"error")}finally{Nt.batchLoading=!1}}async function Od(){if(Nt.batchLoading)return;const e=Array.from(q.selectedIds);if(e.length===0||!await showConfirm(gt("exc-batch-confirm-ignore",{n:e.length}),{danger:!1}))return;Nt.batchLoading=!0;const a=showToast(gt("exc-batch-count",{n:e.length})+" …","loading",0);try{const s=await fetch("/api/exceptions/batch",{method:"POST",headers:{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||""),"Content-Type":"application/json"},body:JSON.stringify({ids:e,action:"ignore"})});if(!s.ok)throw new Error("http "+s.status);const o=await s.json();a(),showToast(gt("exc-toast-batch-ignored",{n:o.processed||0,wl:o.whitelist_added||0}),"success"),q.selectedIds.clear(),await tn(),await wt(),at()}catch(s){a(),console.warn("batch ignore fail",s),showToast(t("exc-toast-batch-fail"),"error")}finally{Nt.batchLoading=!1}}function Vd(){q.selectedIds.clear(),Cs(q.listCache)}async function Vi(){const e=document.getElementById("learned-list");if(e){e.innerHTML=`<div class="learned-empty">${escapeHtml(t("set-learned-loading"))}</div>`;try{const n=await fetch("/api/exception-whitelist",{headers:{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||"")}});if(!n.ok)throw new Error("http "+n.status);const s=(await n.json()).items||[];if(s.length===0){e.innerHTML=`<div class="learned-empty">${escapeHtml(t("set-learned-empty"))}</div>`;return}const o=`<svg viewBox="0 0 14 14" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round">
            <path d="M3 4h8M5.5 4V2.5h3V4M4 4l0.6 8.5h4.8L10 4"/>
        </svg>`;e.innerHTML=s.map(i=>{const r=Ls(i);return`
                <div class="learned-row" data-wl-id="${escapeHtml(String(i.id))}">
                    ...
                    <div class="learned-date">${escapeHtml(Md(i.created_at))}</div>
                    <button class="learned-del-btn" data-del-wl="${escapeHtml(String(i.id))}" title="${escapeHtml(t("set-learned-del"))}" type="button">${o}</button>
                </div>
            `}).join("")}catch(n){console.warn("loadLearnedRules fail",n),e.innerHTML=`<div class="learned-empty">${escapeHtml(t("exc-toast-load-fail"))}</div>`}}}window.loadExceptionsPage=async function(){if(!q.loading){q.loading=!0;try{Ts(),await tn(),await wt()}finally{q.loading=!1}}};window.refreshExcBadge=at;window._refreshExcClientFilter=Ts;window._excState=q;window._rerenderExceptions=function(){try{Ts()}catch{}q.statsCache&&(Ni(q.statsCache),Ss(q.statsCache)),q.listCache&&q.listCache.length&&Cs(q.listCache);try{window._erpExcState&&window._erpExcState.items&&window._erpExcState.items.length&&typeof window._rerenderErpExceptions=="function"&&window._rerenderErpExceptions()}catch{}D.openExcId&&ct()};document.addEventListener("click",e=>{e.target.closest("#exc-drawer-close")&&Yt(),e.target.closest("#exc-drawer-mask")&&Yt(),e.target.closest("#exc-btn-resolve")&&qd(),e.target.closest("#exc-btn-ignore")&&Rd(),e.target.closest("#exc-batch-resolve")&&Nd(),e.target.closest("#exc-batch-ignore")&&Od(),e.target.closest("#exc-batch-clear")&&Vd(),e.target.closest("#exc-loadmore")&&zd()});document.addEventListener("keydown",e=>{e.key==="Escape"&&D.openExcId&&Yt()});document.addEventListener("click",e=>{e.target.closest("#btn-exc-refresh")&&(typeof window.loadExceptionsPage=="function"&&window.loadExceptionsPage(),at())});document.addEventListener("change",e=>{if(!e.target.closest("#exc-client-filter"))return;const n=e.target;q.currentClient=n.value||"",q.currentRule=null,q.selectedIds.clear(),q.listCache=[],typeof window.loadExceptionsPage=="function"&&window.loadExceptionsPage(),at()});document.addEventListener("click",e=>{const n=e.target.closest("#exc-status-tabs .exc-status-tab");if(!n)return;const a=n.dataset.status||"pending";a!==q.currentStatus&&(q.currentStatus=a,q.currentRule=null,q.selectedIds.clear(),q.listCache=[],typeof window.loadExceptionsPage=="function"&&window.loadExceptionsPage())});window.addEventListener("online",()=>{q.loadFailed&&document.getElementById("page-exceptions")?.classList.contains("show")&&window.loadExceptionsPage&&window.loadExceptionsPage()});setTimeout(at,1500);setInterval(at,6e4);window.loadLearnedRules=Vi;document.addEventListener("click",async e=>{const n=e.target.closest("[data-del-wl]");if(!n)return;const a=parseInt(n.dataset.delWl,10);if(!a)return;const s=n.closest(".learned-row"),o=s&&s.querySelector(".learned-seller"),i=o?o.textContent.trim():"",r=t("set-learned-del-confirm").replace("{seller}",i);if(await showConfirm(r,{danger:!0}))try{const m=await fetch("/api/exception-whitelist/"+a,{method:"DELETE",headers:{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||"")}});if(!m.ok)throw new Error("http "+m.status);showToast(t("set-learned-del-ok"),"success"),Vi(),typeof window.loadExceptionsPage=="function"&&document.getElementById("page-exceptions")?.classList.contains("show")&&window.loadExceptionsPage()}catch(m){console.warn("delete whitelist fail",m),showToast(t("set-learned-del-fail"),"error")}});let le={items:[],q:"",cat:"",adapter:"",selected:new Set,total:0,categories:{},pageSize:30,loading:!1,focusSearch:!1,searchCaret:0},yo=null;function Ze(){return localStorage.getItem("mrpilot_token")||""}function wo(e){return/<!?\s*doctype|<html|<\/?[a-z]+>|\bTraceback\b|^\s*ERR_[A-Z]/i.test(e)||e.length>200}function Ui(e){const n=typeof currentLang=="string"&&currentLang||window._currentLang||"th",a=e.error_friendly&&e.error_friendly[n];if(a)return a;if(typeof humanizeError=="function"&&e.error_msg&&!wo(e.error_msg))try{const s=humanizeError(e.error_msg);if(s&&!wo(s))return s}catch{}return t("erp-exc-reason-"+(e.category||"other"))}function ko(){const e=document.getElementById("erp-exc-batch");if(!e)return;const n=le.selected.size;e.hidden=n===0;const a=e.querySelector(".erp-exc-batch-count");a&&(a.textContent=String(n))}function Ms(){const e=document.getElementById("erp-exc-block");if(!e)return;const n=le;if(!(n.total>0||!!n.q||!!n.cat)){e.hidden=!0,e.innerHTML="";return}e.hidden=!1;const s=n.categories||{},o=Object.keys(s).reduce((x,E)=>x+s[E],0);let i=`<button class="erp-exc-chip ${n.cat===""?"active":""}" data-erpexc-cat=""><span>${escapeHtml(t("erp-exc-cat-all"))}</span><span class="erp-exc-chip-count">${o}</span></button>`;Object.keys(s).forEach(x=>{i+=`<button class="erp-exc-chip ${n.cat===x?"active":""}" data-erpexc-cat="${escapeHtml(x)}"><span>${escapeHtml(t("erp-exc-cat-"+x))}</span><span class="erp-exc-chip-count">${s[x]}</span></button>`});const r=n.items||[],l=r.length>0&&r.every(x=>n.selected.has(x.id)),m=r.map(x=>{const E=x.state==="needs_action"?"needs":x.state==="retrying"?"retry":"fail",I=t("erp-exc-state-"+(x.state||"failed")),B=Ui(x),L=n.selected.has(x.id)?"checked":"",$=x.push_type==="id_card",S=$?`<span class="erp-exc-type-idcard">${escapeHtml(t("erp-log-type-idcard"))}</span> `:"",M=$?`<span class="ex-inv" title="${escapeHtml(t("erp-log-col-booking"))}">${S}${escapeHtml(x.invoice_no||"—")}</span>`:`<span class="ex-inv" title="${escapeHtml(x.invoice_no||"")}">${escapeHtml(x.invoice_no||"—")}</span>`,R=$?`<span class="ex-seller" title="${escapeHtml(t("erp-log-col-customer"))}">${escapeHtml(x.seller_name||"—")}</span>`:`<span class="ex-seller" title="${escapeHtml(x.seller_name||"")}">${escapeHtml(x.seller_name||"—")}</span>`,G=$?`<span class="ex-buyer" title="${escapeHtml(t("erp-log-col-idcard"))}">${x.id_card_tail?"••••"+escapeHtml(x.id_card_tail):"—"}</span>`:`<span class="ex-buyer" title="${escapeHtml(x.ocr_buyer_name||"")}">${escapeHtml(x.ocr_buyer_name||"—")}</span>`;return`<div class="erp-exc-row" data-erpexc-id="${escapeHtml(x.id)}">
        ...
        <div class="erp-exc-foot">${p}</div>`;const g=document.getElementById("erp-exc-search");if(g){if(n.focusSearch){g.focus();try{g.setSelectionRange(n.searchCaret,n.searchCaret)}catch{}}g.addEventListener("input",()=>{n.q=g.value,n.focusSearch=!0,n.searchCaret=g.selectionStart||g.value.length,clearTimeout(yo),yo=setTimeout(()=>Ct(!1),350)}),g.addEventListener("blur",()=>{n.focusSearch=!1})}e.querySelectorAll(".erp-exc-chip").forEach(x=>{x.addEventListener("click",()=>{n.cat=x.dataset.erpexcCat||"",Ct(!1)})});const _=document.getElementById("erp-exc-erp-select");_&&_.addEventListener("change",()=>{n.adapter=_.value||"",Ct(!1)}),e.querySelectorAll("[data-erpexc-retry]").forEach(x=>{x.addEventListener("click",E=>{E.stopPropagation(),Fn(x.dataset.erpexcRetry,x)})}),e.querySelectorAll(".erp-exc-cb").forEach(x=>{x.addEventListener("change",()=>{const E=x.dataset.erpexcCb;x.checked?n.selected.add(E):n.selected.delete(E);const I=document.getElementById("erp-exc-cb-all");I&&(I.checked=r.length>0&&r.every(B=>n.selected.has(B.id))),ko()})});const w=document.getElementById("erp-exc-cb-all");w&&w.addEventListener("change",()=>{r.forEach(x=>{w.checked?n.selected.add(x.id):n.selected.delete(x.id)}),e.querySelectorAll(".erp-exc-cb").forEach(x=>{x.checked=w.checked}),ko()}),e.querySelectorAll("[data-erpexc-batch]").forEach(x=>{x.addEventListener("click",()=>Ud(x.dataset.erpexcBatch))});const k=document.getElementById("erp-exc-more");k&&k.addEventListener("click",()=>Ct(!0)),e.querySelectorAll(".erp-exc-row:not(.erp-exc-row-head)").forEach(x=>{x.addEventListener("click",E=>{E.target.closest("input,button")||typeof window._erpExcOpenEdit=="function"&&window._erpExcOpenEdit(x.dataset.erpexcId)})})}async function Fn(e,n){if(e){n&&(n.disabled=!0,n.textContent=t("erp-exc-retrying"));try{const a=await fetch("/api/erp/logs/"+encodeURIComponent(e)+"/retry",{method:"POST",headers:{Authorization:"Bearer "+Ze()}}),s=await a.json().catch(()=>({}));showToast(a.ok&&s.ok?t("erp-exc-retry-ok"):t("erp-exc-retry-fail"),a.ok&&s.ok?"success":"error")}catch{showToast(t("erp-exc-retry-fail"),"error")}if(le.selected.delete(e),Ct(!1),typeof window.refreshExcBadge=="function")try{window.refreshExcBadge()}catch{}}}async function Ud(e){const n=Array.from(le.selected);if(e==="clear"){le.selected.clear(),Ms();return}if(n.length!==0){if(e==="delete"){if(!await showConfirm(t("erp-exc-batch-delete-confirm",{n:n.length}),{danger:!0}))return;try{const s=await fetch("/api/erp/logs/batch-delete",{method:"POST",headers:{Authorization:"Bearer "+Ze(),"Content-Type":"application/json"},body:JSON.stringify({log_ids:n.slice(0,200)})}),o=await s.json().catch(()=>({}));showToast(s.ok?t("erp-exc-batch-delete-ok",{n:o.deleted||0}):t("erp-exc-retry-fail"),s.ok?"success":"error")}catch{showToast(t("erp-exc-retry-fail"),"error")}}else if(e==="retry")try{const a=await fetch("/api/erp/logs/batch-retry",{method:"POST",headers:{Authorization:"Bearer "+Ze(),"Content-Type":"application/json"},body:JSON.stringify({log_ids:n.slice(0,50)})}),s=await a.json().catch(()=>({}));showToast(a.ok?t("erp-exc-batch-retry-ok",{ok:s.succeeded||0,fail:(s.failed||0)+(s.skipped||0)}):t("erp-exc-retry-fail"),a.ok?"success":"error")}catch{showToast(t("erp-exc-retry-fail"),"error")}if(le.selected.clear(),Ct(!1),typeof window.refreshExcBadge=="function")try{window.refreshExcBadge()}catch{}}}async function Ct(e){const n=document.getElementById("erp-exc-block");if(!(!n||le.loading)){le.loading=!0;try{if(!Array.isArray(window._erpEndpoints)||!window._erpEndpoints.length)try{const r=await fetch("/api/erp/endpoints",{headers:{Authorization:"Bearer "+Ze()}});if(r.ok){const l=await r.json();window._erpEndpoints=l&&(l.items||l)||[]}}catch{}const a=new URLSearchParams;le.q&&a.set("q",le.q),le.cat&&a.set("category",le.cat),le.adapter&&a.set("adapter",le.adapter),a.set("limit",String(le.pageSize)),a.set("offset",String(e?le.items.length:0));const s=await fetch("/api/erp/exceptions?"+a.toString(),{headers:{Authorization:"Bearer "+Ze()}});if(!s.ok){e||(n.hidden=!0);return}const o=await s.json(),i=o.items||[];le.items=e?le.items.concat(i):i,le.total=o.total||0,le.categories=o.categories||{},Ms()}catch{e||(n.hidden=!0)}finally{le.loading=!1}}}window._rerenderErpExceptions=Ms;window.loadErpExceptions=Ct;window._erpExcState=le;let Tn={};function Dt(){const e=document.getElementById("erp-exc-modal");e&&e.remove()}window._erpExcOpenEdit=function(e){const n=(le.items||[]).find(p=>String(p.id)===String(e));if(!n)return;const a=n.push_type==="id_card",s=!!n.history_client_id&&n.category==="customer_mismatch",o=n.category==="product_mismatch"&&!!n.history_id&&!!n.endpoint_id,i=Ui(n),r=n.state==="needs_action"?"needs":n.state==="retrying"?"retry":"fail",l=(p,c)=>`<div class="erp-exc-m-row"><span class="erp-exc-m-k">${escapeHtml(p)}</span><span class="erp-exc-m-v">${escapeHtml(c||"—")}</span></div>`;let m="";if(s)m=`
...
`;let _o=!1,ha=[],Ua=null,Ge="amount_limit",Hs="global";const Kd="/api/knowledge/rules";function Yd(){return localStorage.getItem("mrpilot_token")||""}async function Jt(e,n,a){return fetch(Kd+n,{method:e,headers:{Authorization:"Bearer "+Yd(),"Content-Type":"application/json"},body:a?JSON.stringify(a):void 0})}function Jd(e){const n=Number(e);return Number.isFinite(n)?"฿ "+n.toLocaleString("en-US"):String(e)}function Xd(e){const n=fe(),a=s=>e===s?" selected":"";return`<option value="high"${a("high")}>${n.sevHigh}</option><option value="medium"${a("medium")}>${n.sevMid}</option><option value="low"${a("low")}>${n.sevLow}</option>`}function Eo(e,n){const a=n&&n.subject_key?escapeHtml(n.subject_key):"";return`<div class="rs-mlbl">${e}</div><input class="rs-field" id="rs-f-key" value="${a}"${n?" disabled":""}>`}function Zd(e){const n=fe(),a=e.subject_key?escapeHtml(e.subject_key):"";if(e.rule_type==="amount_limit"){const s=Jd(e.rule_body.limit);let o=n.gAmount;e.subject_type==="global"?o=n.anyInvoice:e.subject_type==="supplier"?o=`${n.fSupplierTax} <b>${a}</b>`:o=`「${a}」`;const i=e.rule_body.notify_line?` <span class="rs-line">${ft("bell",12)} ${n.alsoLine}</span>`:"";return`${o} &gt; <b>${s}</b>${i}`}if(e.rule_type==="supplier_force_review")return`<b>${a}</b> · ${n.tForceDesc}`;if(e.rule_type==="no_auto_push_category")return`「${a}」 · ${n.tCategoryDesc}`;if(e.rule_type==="accounting_period"){const o=e.rule_body.mode==="prev_month"?n.pmPrev:n.pmCurrent;return`${n.gPeriodDesc} · <b>${o}</b>`}return e.rule_type}function Qd(e){const n=fe(),a=e.severity||"medium",s=a==="high"?n.sevHigh:a==="low"?n.sevLow:n.sevMid;return`<div class="rs-rule"><div class="rs-rm"><div class="rs-rt">${Zd(e)}</div></div><span class="rs-sev ${a}">${s}</span><button class="rs-sw${e.is_active?"":" off"}" data-toggle="${e.id}" aria-label="toggle"></button><button class="rs-icobtn" data-edit="${e.id}" aria-label="edit">${ft("pencil",14)}</button><button class="rs-icobtn" data-del="${e.id}" aria-label="delete">${ft("trash",14)}</button></div>`}function Mn(e,n,a,s,o){const i=fe(),l=ha.filter(m=>o.includes(m.rule_type)).map(Qd).join("")||`<div class="rs-empty">${i.empty}</div>`;return`<div class="rs-group"><div class="rs-ghead"><div class="rs-gico">${ft(e,17)}</div><div><div class="rs-gt">${n}</div><div class="rs-gd">${a}</div></div><button class="rs-addbtn" data-add-type="${s}">${ft("plus",14)} ${i.add}</button></div><div class="rs-gbody">${l}</div></div>`}function Gi(){const e=fe(),n=document.querySelector("#rules-settings-modal .rs-head h2");n&&(n.textContent=e.title);const a=document.getElementById("rs-body");a&&(a.innerHTML=`<p class="rs-lead">${e.lead}</p>`+Mn("building",e.gSupplier,e.gSupplierDesc,"supplier_force_review",["supplier_force_review"])+Mn("wallet",e.gAmount,e.gAmountDesc,"amount_limit",["amount_limit"])+Mn("calendar",e.gPeriod,e.gPeriodDesc,"accounting_period",["accounting_period"])+Mn("octagon",e.gCategory,e.gCategoryDesc,"no_auto_push_category",["no_auto_push_category"]))}async function As(){try{const e=await Jt("GET","?include_inactive=1");if(!e.ok)throw new Error("http "+e.status);ha=(await e.json()).rules||[],Gi()}catch{showToast(fe().loadFail,"error")}}function Ga(e){const n=fe(),a=e?e.severity:Ge==="supplier_force_review"?"high":"medium",s=`<div class="rs-mlbl">${n.fSeverity}</div><select class="rs-field" id="rs-f-sev">${Xd(a)}</select>`;if(Ge==="amount_limit"){const i=e?e.subject_type:Hs,r=e&&e.subject_key?escapeHtml(e.subject_key):"",l=e?String(e.rule_body.limit??""):"",m=e?!!e.rule_body.notify_line:!0,d=i==="global"?"":`<div class="rs-mlbl">${i==="category"?n.fCategory:n.fSupplierTax}</div><input class="rs-field" id="rs-f-key" value="${r}">`;return`<div class="rs-mlbl">${n.gAmountDesc}</div><select class="rs-field" id="rs-f-scope"${e?" disabled":""}><option value="global"${i==="global"?" selected":""}>${n.anyInvoice}</option><option value="supplier"${i==="supplier"?" selected":""}>${n.tForce}</option><option value="category"${i==="category"?" selected":""}>${n.fCategory}</option></select><div id="rs-f-subj">${d}</div><div class="rs-two"><div><div class="rs-mlbl">${n.fAmountLimit}</div><input class="rs-field" id="rs-f-limit" type="number" min="1" value="${l}"></div><div>${s}</div></div><label class="rs-check"><input type="checkbox" id="rs-f-line"${m?" checked":""}>${ft("bell",14)} ${n.fAlsoLine}</label>`}if(Ge==="supplier_force_review")return Eo(n.fSupplierTax,e)+s;if(Ge==="no_auto_push_category")return Eo(n.fCategory,e)+s;const o=e?e.rule_body.mode:"current_month";return`<div class="rs-mlbl">${n.fPeriodMode}</div><select class="rs-field" id="rs-f-mode"><option value="current_month"${o==="current_month"?" selected":""}>${n.pmCurrent}</option><option value="prev_month"${o==="prev_month"?" selected":""}>${n.pmPrev}</option></select>`+s}function Hn(e,n,a){return`<button class="rs-type${Ge===e?" on":""}" data-type-pick="${e}"><div class="tt">${n}</div><div class="td">${a}</div></button>`}function ep(e){const n=fe(),a=document.getElementById("rs-add-modal");if(!a)return;const s=e?"":`<div class="rs-mlbl">${n.rType}</div><div class="rs-types">`+Hn("supplier_force_review",n.tForce,n.tForceDesc)+Hn("amount_limit",n.tAmount,n.tAmountDesc)+Hn("accounting_period",n.tPeriod,n.tPeriodDesc)+Hn("no_auto_push_category",n.tCategory,n.tCategoryDesc)+"</div>";a.innerHTML=`<div class="rs-pop" style="max-width:460px;"><div class="rs-head"><h2>${e?n.editTitle:n.addTitle}</h2><button class="rs-close" id="rs-add-close">${ft("x",18)}</button></div><div class="rs-body">${s}<div id="rs-add-fields">${Ga(e)}</div></div><div class="rs-foot" style="gap:10px;"><button class="rs-btn rs-btn-ghost" id="rs-add-cancel">${n.cancel}</button><button class="rs-btn rs-btn-primary" id="rs-add-save">${n.save}</button></div></div>`,a.classList.add("rs-open")}function Et(e){const n=document.getElementById(e);return n?String(n.value).trim():""}function tp(){const e=fe(),n=Et("rs-f-sev")||"medium";if(Ge==="amount_limit"){const a=Et("rs-f-scope")||"global",s=Number(Et("rs-f-limit"));if(!Number.isFinite(s)||s<=0)return showToast(e.needAmount,"error"),{ok:!1};const o=a==="global"?null:Et("rs-f-key");if(a!=="global"&&!o)return showToast(a==="category"?e.needCategory:e.needSupplier,"error"),{ok:!1};const i=document.getElementById("rs-f-line")?.checked;return{ok:!0,payload:{rule_type:"amount_limit",subject_type:a,subject_key:o,severity:n,rule_body:{limit:s,basis:"total",period:"per_invoice",notify_line:!!i}}}}if(Ge==="supplier_force_review"){const a=Et("rs-f-key");return a?{ok:!0,payload:{rule_type:"supplier_force_review",subject_type:"supplier",subject_key:a,severity:n,rule_body:{}}}:(showToast(e.needSupplier,"error"),{ok:!1})}if(Ge==="no_auto_push_category"){const a=Et("rs-f-key");return a?{ok:!0,payload:{rule_type:"no_auto_push_category",subject_type:"category",subject_key:a,severity:n,rule_body:{}}}:(showToast(e.needCategory,"error"),{ok:!1})}return{ok:!0,payload:{rule_type:"accounting_period",subject_type:"global",subject_key:null,severity:n,rule_body:{mode:Et("rs-f-mode")||"current_month"}}}}async function np(){const e=tp();if(!(!e.ok||!e.payload))try{let n;if(Ua!==null){const a=e.payload;n=await Jt("PATCH","/"+Ua,{rule_body:a.rule_body,severity:a.severity})}else n=await Jt("POST","",e.payload);if(!n.ok)throw new Error("http "+n.status);showToast(fe().saved,"success"),document.getElementById("rs-add-modal")?.classList.remove("rs-open"),await As()}catch{showToast(fe().saveFail,"error")}}async function ap(e){const n=ha.find(o=>o.id===e);if(!n)return;const a=!n.is_active;n.is_active=a;const s=document.querySelector(`#rules-settings-modal [data-toggle="${e}"]`);s&&s.classList.toggle("off",!a);try{const o=await Jt("PATCH","/"+e,{is_active:a});if(!o.ok)throw new Error("http "+o.status);showToast(a?fe().enabled:fe().disabled,"success")}catch{n.is_active=!a,s&&s.classList.toggle("off",a),showToast(fe().saveFail,"error")}}async function sp(e){if(await showConfirm(fe().delConfirm,{danger:!0}))try{const a=await Jt("DELETE","/"+e);if(!a.ok)throw new Error("http "+a.status);showToast(fe().deleted,"success"),await As()}catch{showToast(fe().saveFail,"error")}}function Io(e,n){Ge=e,Hs="global",Ua=n?n.id:null,ep(n)}function op(){if(_o)return;const e=document.createElement("style");e.textContent=Wd,document.head.appendChild(e);const n=fe(),a=document.createElement("div");a.id="rules-settings-modal",a.innerHTML=`<div class="rs-pop"><div class="rs-head"><h2>${n.title}</h2><span class="rs-tag">●</span><button class="rs-close" id="rs-main-close">${ft("x",18)}</button></div><div class="rs-body" id="rs-body"></div><div class="rs-foot"><button class="rs-btn rs-btn-primary" id="rs-done">${n.done}</button></div></div>`,document.body.appendChild(a);const s=document.createElement("div");s.id="rs-add-modal",document.body.appendChild(s),document.addEventListener("click",o=>{const i=o.target;(i.id==="rules-settings-modal"||i.closest("#rs-main-close")||i.closest("#rs-done"))&&a.classList.remove("rs-open"),(i.id==="rs-add-modal"||i.closest("#rs-add-close")||i.closest("#rs-add-cancel"))&&s.classList.remove("rs-open");const r=i.closest("[data-add-type]");r&&Io(r.dataset.addType);const l=i.closest("[data-edit]");if(l){const c=ha.find(u=>u.id===Number(l.dataset.edit));c&&Io(c.rule_type,c)}const m=i.closest("[data-del]");m&&sp(Number(m.dataset.del));const d=i.closest("[data-toggle]");d&&ap(Number(d.dataset.toggle));const p=i.closest("[data-type-pick]");if(p){Ge=p.dataset.typePick,document.querySelectorAll("#rs-add-modal .rs-type").forEach(u=>u.classList.toggle("on",u.dataset.typePick===Ge));const c=document.getElementById("rs-add-fields");c&&(c.innerHTML=Ga())}i.closest("#rs-add-save")&&np()}),document.addEventListener("change",o=>{const i=o.target;if(i.id==="rs-f-scope"){Hs=i.value;const r=document.getElementById("rs-add-fields");r&&(r.innerHTML=Ga())}}),document.addEventListener("keydown",o=>{o.key==="Escape"&&(s.classList.contains("rs-open")?s.classList.remove("rs-open"):a.classList.contains("rs-open")&&a.classList.remove("rs-open"))}),_o=!0}window.openRulesSettings=function(){op(),document.getElementById("rules-settings-modal").classList.add("rs-open"),As()};function ip(){const e=document.querySelector("#page-exceptions .page-head-actions");if(!e||document.getElementById("exc-rules-btn"))return;const n=document.createElement("button");n.id="exc-rules-btn",n.type="button",n.className="btn btn-ghost",n.innerHTML=ft("settings",16)+`<span class="rs-btn-label">${fe().btn}</span>`,n.addEventListener("click",()=>window.openRulesSettings&&window.openRulesSettings()),e.insertBefore(n,e.firstChild)}let Bo=!1;async function rp(){if(!Bo){Bo=!0;try{(await Jt("GET","")).ok&&ip()}catch{}}}const Lo=window.loadExceptionsPage;window.loadExceptionsPage=function(){rp(),Lo&&Lo()};Array.isArray(window.__i18nSubs)||(window.__i18nSubs=[]);window.__i18nSubs.push({name:"rules-settings",fn:()=>{const e=document.querySelector("#exc-rules-btn .rs-btn-label");e&&(e.textContent=fe().btn),document.getElementById("rules-settings-modal")?.classList.contains("rs-open")&&Gi()}});(function(){const e=document.getElementById("page-knowledge");if(!(!e||e.dataset.wbInjected==="1")){if(!document.getElementById("kb-center-style")){const n=document.createElement("style");n.id="kb-center-style",n.textContent=`
...
`,e.dataset.wbInjected="1";try{const n=window._currentLang||localStorage.getItem("mrpilot_lang")||"th",a=window.I18N;a&&a[n]&&e.querySelectorAll("[data-i18n]").forEach(s=>{const o=s.getAttribute("data-i18n");a[n][o]&&(s.textContent=a[n][o])})}catch{}}})();const lp="/api/knowledge",yt="/static/brand/kb-cat.png?v=2";function cp(){return localStorage.getItem("mrpilot_token")||""}function N(e,n){if(typeof window.t=="function"){const a=window.t(e);if(a&&a!==e)return a}return n}function K(e){return typeof escapeHtml=="function"?escapeHtml(String(e??"")):String(e??"")}const $o={file:'<path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><path d="M14 2v6h6"/>',"file-text":'<path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><path d="M14 2v6h6"/><path d="M16 13H8"/><path d="M16 17H8"/><path d="M10 9H8"/>',sheet:'<rect width="18" height="18" x="3" y="3" rx="2"/><path d="M3 9h18"/><path d="M3 15h18"/><path d="M9 3v18"/><path d="M15 3v18"/>',image:'<rect width="18" height="18" x="3" y="3" rx="2"/><circle cx="9" cy="9" r="2"/><path d="m21 15-3.1-3.1a2 2 0 0 0-2.8 0L6 21"/>',upload:'<path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><path d="M14 2v6h6"/><path d="M12 18v-6"/><path d="m9 15 3-3 3 3"/>',message:'<path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/>',"shield-check":'<path d="M20 13c0 5-3.5 7.5-7.7 9a1 1 0 0 1-.7 0C7.5 20.5 4 18 4 13V6a1 1 0 0 1 1-1c2 0 4.5-1.2 6.2-2.7a1.2 1.2 0 0 1 1.6 0C14.5 3.8 17 5 19 5a1 1 0 0 1 1 1z"/><path d="m9 12 2 2 4-4"/>',check:'<path d="M20 6 9 17l-5-5"/>',x:'<path d="M18 6 6 18"/><path d="M6 6l12 12"/>'};function We(e){return`<svg class="kb-ic" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round">${$o[e]||$o.file}</svg>`}function Wi(e){const n=`kb-${e}-mask`,a=`kb-${e}-modal`,s=()=>document.getElementById(n)?.classList.add("open"),o=()=>document.getElementById(n)?.classList.remove("open");let i=document.getElementById(n);if(!i){i=document.createElement("div"),i.id=n,i.className=`kb-${e}-mask`,i.innerHTML=`<div class="kb-${e}-modal" id="${a}" role="dialog" aria-modal="true"></div>`,document.body.appendChild(i);const r=i;r.addEventListener("click",l=>{(l.target===r||l.target.closest(`[data-kb-${e}-close]`))&&o()}),document.addEventListener("keydown",l=>{l.key==="Escape"&&r.classList.contains("open")&&o()})}return{modal:document.getElementById(a),open:s,close:o}}function ga(){const e=window.getActiveWorkspaceClientId;if(typeof e!="function")return null;const n=e(),a=Number(n);return Number.isFinite(a)&&a>0?a:null}function Ki(){const e=ga();if(!e)return"";const a=(window._workspaceClientsCache||[]).find(s=>Number(s.id)===e);return a&&a.name?String(a.name):"#"+e}async function nn(e,n,a,s={}){const o=new URL(lp+n,location.origin),i=ga();if(s.query)for(const[d,p]of Object.entries(s.query))p!=null&&o.searchParams.set(d,String(p));const r=s.withWorkspace!==!1&&i!=null;r&&(e==="GET"||e==="DELETE")&&o.searchParams.set("workspace_client_id",String(i));const l={Authorization:"Bearer "+cp()};let m=s.raw;if(!s.raw&&a!==void 0){const d=r?{workspace_client_id:i,...a}:a;l["Content-Type"]="application/json",m=JSON.stringify(d)}try{const d=await fetch(o.toString(),{method:e,headers:l,body:m});let p=null,c;const u=await d.text();if(u)try{const v=JSON.parse(u);d.ok?p=v:c=v?.detail?.error_code||v?.message_key||v?.detail||void 0}catch{}return{ok:d.ok,status:d.status,data:p,error:c}}catch{return{ok:!1,status:0,data:null,error:"network"}}}async function dp(e,n){const a=new FormData;a.append("file",e);const s=ga();return s!=null&&a.append("workspace_client_id",String(s)),nn("POST","/documents",void 0,{raw:a,withWorkspace:!1})}let An=null;async function Yi(){if(An!==null)return An;const e=await nn("GET","/bases",void 0,{withWorkspace:!1});return An=e.status===200||e.status===401||e.status===403,An}let So=!1;function Ji(){const e=document.getElementById("kb-ws-bar"),n=document.getElementById("kb-ws-label");if(!e||!n)return;ga()?(e.classList.remove("kb-ws-empty"),n.innerHTML=N("kb-ws-current","账套主体")+"：<b>"+K(Ki())+"</b>"):(e.classList.add("kb-ws-empty"),n.textContent=N("kb-ws-none","请先在右上角选择账套主体,再使用客户私有文档与问答。"))}function pp(e){document.querySelectorAll(".kb-tab-bar .recon-tab-btn").forEach(n=>{n.classList.toggle("active",n.dataset.kbTab===e)}),document.querySelectorAll(".kb-pane").forEach(n=>{n.classList.toggle("active",n.id==="kb-pane-"+e)}),e==="docs"&&typeof window._kbRenderDocs=="function"&&window._kbRenderDocs(),e==="qa"&&typeof window._kbRenderAsk=="function"&&window._kbRenderAsk()}function up(){if(So)return;const e=document.querySelector(".kb-tab-bar");if(!e)return;e.addEventListener("click",s=>{const o=s.target.closest(".recon-tab-btn");o&&o.dataset.kbTab&&pp(o.dataset.kbTab)});const n=document.getElementById("kb-open-rules");n&&n.addEventListener("click",()=>{typeof window.openRulesSettings=="function"&&window.openRulesSettings()});const a=document.getElementById("kb-info-btn");a&&a.addEventListener("click",()=>{typeof window._kbOpenInfo=="function"&&window._kbOpenInfo()}),So=!0}window.loadKnowledgePage=function(){up(),Ji(),document.querySelector('.kb-tab-bar .recon-tab-btn[data-kb-tab="docs"]')?.classList.contains("active")&&typeof window._kbRenderDocs=="function"&&window._kbRenderDocs()};async function Co(){if(!window._knowledgeProbed){window._knowledgeProbed=!0;try{if(await Yi()){const e=document.getElementById("nav-knowledge");e&&(e.style.display="")}}catch{}}}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",Co):Co();Array.isArray(window.__i18nSubs)||(window.__i18nSubs=[]);window.__i18nSubs.push({name:"knowledge-center",fn:Ji});let Wa=!1,dt=[];function mp(e){if(e.status==="ready")return`<span class="kb-badge ready"><span class="kb-bdot"></span>${K(N("kb-doc-ready","已就绪"))}</span>`;if(e.status==="failed")return`<span class="kb-badge failed"><span class="kb-bdot"></span>${K(N("kb-doc-failed","失败"))}</span>`;const n=e.status==="uploading"?N("kb-doc-uploading","上传中…"):N("kb-doc-parsing","解析中");return`<span class="kb-badge parsing"><span class="kb-bdot"></span>${K(n)}</span>`}function vp(e){return e==="unsupported_document"?N("kb-err-unsupported_document","不支持的文件类型"):e==="embedding_failed"?N("kb-err-embedding_failed","向量化失败，可重试"):e==="processing_failed"?N("kb-err-processing_failed","文件无法解析，可能已损坏或加密"):e?N("kb-doc-failed","失败"):""}function fp(e){return(e||"").slice(0,10)}function hp(e){let n;e.status==="failed"&&e.error_code?n=`<div class="kb-doc-sub err">${K(vp(e.error_code))}</div>`:e.status==="uploading"?n=`<div class="kb-doc-sub">${K(N("kb-doc-uploading","上传中…"))}</div>`:n=`<div class="kb-doc-sub">${K((e.source_type||"").toUpperCase())} · ${K(fp(e.created_at))}</div>`;const a=e.status==="uploading"?"":`<button class="btn btn-sm btn-ghost kb-doc-del" data-id="${e.id}">${K(N("kb-doc-delete","删除"))}</button>`;return`<div class="kb-doc-row" data-id="${e.id}">
        <div class="kb-doc-ic">${gp(e.source_type)}</div>
        <div class="kb-doc-meta"><div class="kb-doc-name">${K(e.filename)}</div>${n}</div>
        ${mp(e)}${a}
    </div>`}function gp(e){const n=(e||"").toLowerCase();return n==="doc"||n==="docx"?We("file-text"):n==="xls"||n==="xlsx"||n==="csv"?We("sheet"):["png","jpg","jpeg","webp"].includes(n)?We("image"):We("file")}function Xi(){return document.getElementById("kb-doc-list")}function xn(){const e=Xi();if(e){if(!dt.length){e.innerHTML=`<div class="kb-empty">
        ...
        </div>`;return}e.innerHTML=dt.map(hp).join("")}}function To(e){const n=Xi();n&&(n.innerHTML=e)}async function Zi(){To('<div class="kb-skel"><div class="kb-skrow"></div><div class="kb-skrow"></div><div class="kb-skrow"></div></div>');const e=await nn("GET","/documents");if(!e.ok){To(`<div class="kb-empty err">
            <div>${K(N("kb-doc-error","加载失败"))}</div>
            <button class="btn btn-sm kb-doc-reload" style="margin-top:12px">${K(N("kb-doc-retry","重试"))}</button>
        </div>`);return}dt=(e.data?.documents||[]).filter(n=>n.status!=="deleted"),xn()}async function Mo(e){const n=Array.from(e);if(n.length)for(const a of n){const s=-Date.now()-Math.floor(Math.random()*1e3);dt.unshift({id:s,filename:a.name,source_type:(a.name.split(".").pop()||"").toLowerCase(),status:"uploading",error_code:null,created_at:new Date().toISOString()}),xn();const o=await dp(a),i=dt.findIndex(r=>r.id===s);i<0||(o.ok&&o.data?.document?(dt[i]=o.data.document,o.data.document.status==="failed"&&showToast(N("kb-doc-failed","失败")+"："+a.name,"error")):(dt.splice(i,1),showToast(N("kb-upload-fail","上传失败")+"："+a.name,"error")),xn())}}async function bp(e){if(!(typeof showConfirm=="function"?await showConfirm(N("kb-doc-del-confirm","确定删除这份文档？删除后 AI 将不再引用它。")):!0))return;(await nn("DELETE","/documents/"+e)).ok?(dt=dt.filter(s=>s.id!==e),xn()):showToast(N("kb-doc-del-fail","删除失败"),"error")}function yp(){const e=document.getElementById("kb-pane-docs");if(!e||Wa&&e.querySelector("#kb-doc-list"))return;if(!document.getElementById("kb-docs-style")){const s=document.createElement("style");s.id="kb-docs-style",s.textContent=`
...
`,document.head.appendChild(s)}e.innerHTML=`
    ...
    `;try{const s=window._currentLang||localStorage.getItem("mrpilot_lang")||"th",o=window.I18N;o&&o[s]&&e.querySelectorAll("[data-i18n]").forEach(i=>{const r=i.getAttribute("data-i18n");o[s][r]&&(i.textContent=o[s][r])})}catch{}const n=e.querySelector("#kb-up"),a=e.querySelector("#kb-file");n.addEventListener("click",s=>{s.target.closest("input")||a.click()}),a.addEventListener("change",()=>{a.files&&Mo(a.files),a.value=""}),["dragenter","dragover"].forEach(s=>n.addEventListener(s,o=>{o.preventDefault(),n.classList.add("drag")})),["dragleave","drop"].forEach(s=>n.addEventListener(s,o=>{o.preventDefault(),n.classList.remove("drag")})),n.addEventListener("drop",s=>{const o=s.dataTransfer;o?.files?.length&&Mo(o.files)}),e.addEventListener("click",s=>{const o=s.target,i=o.closest(".kb-doc-del");if(i?.dataset.id){bp(Number(i.dataset.id));return}o.closest(".kb-doc-reload")&&Zi()}),Wa=!0}function wp(){yp(),Zi()}window._kbRenderDocs=wp;Array.isArray(window.__i18nSubs)||(window.__i18nSubs=[]);window.__i18nSubs.push({name:"knowledge-documents",fn:()=>{Wa&&xn()}});let Zn=null;function kp(){if(Zn)return;const e=document.createElement("style");e.id="kb-src-style",e.textContent=`
...
`,document.head.appendChild(e),Zn=Wi("src")}function xp(e){const n=K(e.text).replace(/\n/g,"<br>");return`<span class="seg${e.matched?" hit":""}">${n}</span>`}function _p(e){return e.segments.map(xp).join("<br><br>")}async function Ep(e){kp();const n=Zn?.modal;if(!n)return;const a=e.filename||N("kb-src-unknown","未知来源"),s=typeof e.score=="number"?Math.round(Math.max(0,Math.min(1,e.score))*100):null,o=typeof e.chunk_id=="number";if(n.innerHTML=`
    ...
    `,Zn?.open(),!o)return;const i=await nn("GET","/chunks/"+e.chunk_id),r=n.querySelector("#kb-src-preview");r&&(i.ok&&i.data?.segments?.length?r.innerHTML=_p(i.data):r.innerHTML=`<div class="kb-src-fail">${K(N("kb-src-load-fail","原文片段暂时取不到,可在文档库打开原件核对。"))}</div>`)}window._kbOpenSource=e=>{Ep(e)};function Ip(e){return`<div class="kb-msg user"><div class="kb-bub">${K(e)}</div></div>`}function Bp(e){const n=e.filename||N("kb-src-unknown","未知来源");return`<button class="kb-cite" data-cite='${K(JSON.stringify(e))}'>
        ...
        ${K(n)}<span class="ch">›</span></button>`}function Lp(e){if(e.no_answer){const a=N(e.message_key||"ask.no_source","资料不足，无法判断。");return`<div class="kb-msg ai"><div class="kb-ava"><img src="${yt}" alt=""></div>
            <div class="kb-bub no-src">${K(a)}</div></div>`}const n=(e.citations||[]).map(a=>Bp(a)).join("");return`<div class="kb-msg ai"><div class="kb-ava"><img src="${yt}" alt=""></div>
        <div class="kb-bub">${K(e.answer)}${n?`<div class="kb-cites">${n}</div>`:""}</div></div>`}function $p(e){return nn("POST","/ask",{question:e})}function Ho(e){return`<div class="kb-msg ai"><div class="kb-ava"><img src="${yt}" alt=""></div><div class="kb-bub no-src">${K(e)}</div></div>`}function Qi(e,n,a){if(e.dataset.kbWired==="1")return;e.dataset.kbWired="1";let s=!1;function o(r){const l=document.createElement("div");l.innerHTML=r;const m=l.firstElementChild;return e.appendChild(m),e.scrollTop=e.scrollHeight,m}async function i(){const r=n.value.trim();if(!r||s)return;s=!0,n.value="",o(Ip(r));const l=o(`<div class="kb-msg ai"><div class="kb-ava"><img src="${yt}" alt=""></div><div class="kb-bub kb-thinking">${K(N("kb-ask-thinking","思考中…"))}</div></div>`),m=await $p(r);if(l.remove(),m.status===402){const d=N("kb-ask-low-balance","余额不足，请先充值后再提问。");o(Ho(d)),typeof showToast=="function"&&showToast(d,"error")}else if(!m.ok||!m.data){const d=N("kb-ask-error","出错了，请稍后重试。");o(Ho(d)),typeof showToast=="function"&&showToast(d,"error")}else o(Lp(m.data));s=!1}a.addEventListener("click",i),n.addEventListener("keydown",r=>{r.key==="Enter"&&!r.shiftKey&&(r.preventDefault(),i())}),e.addEventListener("click",r=>{const l=r.target.closest(".kb-cite");if(!(!l||!l.dataset.cite))try{const m=JSON.parse(l.dataset.cite);typeof window._kbOpenSource=="function"&&window._kbOpenSource(m)}catch{}})}window._kbWireAsk=Qi;function Sp(){if(document.getElementById("kb-ask-style"))return;const e=document.createElement("style");e.id="kb-ask-style",e.textContent=`
...
`,document.head.appendChild(e)}function Cp(){const e=document.getElementById("kb-pane-qa");if(!e||e.dataset.kbBuilt==="1")return;Sp();const n=K(N("kb-ask-ex1","这家客户有金额上限吗？")),a=K(N("kb-ask-ex2","合同约定的付款周期是多久？")),s=K(N("kb-ask-ex3","哪些供应商需要人工复核？")),o=typeof window._kbFabEnabled=="function"&&window._kbFabEnabled();e.innerHTML=`
        <div class="kb-ft">
            <span class="ft-cat"><img src="${yt}" alt=""></span>
            <div class="ft-txt">
        ...
        <div class="kb-qa">
            <div class="kb-qa-thread" id="kb-qa-thread">
                <div class="kb-msg ai"><div class="kb-ava"><img src="${yt}" alt=""></div>
    ...
    `,e.dataset.kbBuilt="1";const i=e.querySelector("#kb-qa-thread"),r=e.querySelector("#kb-qa-input"),l=e.querySelector("#kb-qa-send");Qi(i,r,l),e.querySelectorAll(".kb-chip").forEach(d=>{d.addEventListener("click",()=>{r.value=d.dataset.q||"",l.click()})});const m=e.querySelector("#kb-fab-switch");m?.addEventListener("click",()=>{const d=!m.classList.contains("on");m.classList.toggle("on",d),m.setAttribute("aria-checked",String(d)),typeof window._kbFabSetEnabled=="function"&&window._kbFabSetEnabled(d)})}window._kbRenderAsk=Cp;const js="pearnly_kb_fab",Ka=yt,pt=14;let Ya=!1,Ao=!1;function Tp(){if(document.getElementById("kb-fab-style"))return;const e=document.createElement("style");e.id="kb-fab-style",e.textContent=`
...
`,document.head.appendChild(e)}let Z,vt,zn,Me;function Mp(){Ya||(Tp(),Z=document.createElement("div"),Z.className="kb-fab",Z.id="kb-fab",Z.innerHTML=`
        <span class="kb-say" id="kb-say">${N("kb-fab-hi","喵~")}</span>
        <button class="kb-fab-btn" id="kb-fab-btn" aria-label="${N("kb-fab-aria","问 AI")}"><img src="${Ka}" alt=""></button>`,document.body.appendChild(Z),Me=document.createElement("div"),Me.className="kb-card",Me.id="kb-card",Me.innerHTML=`
        <div class="kb-card-top">
            <div class="tt"><span class="mini"><img src="${Ka}" alt=""></span> ${N("kb-fab-title","客户知识助手")}</div>
        ...
        </div>`,document.body.appendChild(Me),vt=Z.querySelector("#kb-fab-btn"),zn=Z.querySelector("#kb-say"),document.getElementById("kb-card-x")?.addEventListener("click",Ja),document.addEventListener("keydown",e=>{e.key==="Escape"&&Ja()}),Fp(),qp(),Rp(),Ya=!0)}function Hp(){const e=document.getElementById("kb-card-thread"),n=document.getElementById("kb-card-input"),a=document.getElementById("kb-card-send");!Ao&&typeof window._kbWireAsk=="function"&&(e.innerHTML=`<div class="kb-msg ai"><div class="kb-ava"><img src="${Ka}" alt=""></div><div class="kb-bub">${N("kb-ask-empty","问点关于这家客户的事，答案都带出处；查不到时如实说「资料不足」。")}</div></div>`,window._kbWireAsk(e,n,a),Ao=!0);const s=document.getElementById("kb-card-ws");s&&(s.textContent=Ki()||N("kb-fab-no-ws","未选账套")),Ap(),Me.classList.add("open"),Pp(),er(["💛","✨","💙","🐾"])}function Ja(){Me?.classList.remove("open")}function Ap(){const e=Z.getBoundingClientRect(),n=520,a=e.left+e.width/2<window.innerWidth/2,s=Math.min(Math.max(pt,e.top+e.height/2-n/2),window.innerHeight-n-pt);Me.style.top=s+"px",a?(Me.style.left=e.right+12+"px",Me.style.right="auto"):(Me.style.right=window.innerWidth-e.left+12+"px",Me.style.left="auto")}let jo;function jp(e,n=1500){zn.textContent=e,zn.classList.add("show"),clearTimeout(jo),jo=setTimeout(()=>zn.classList.remove("show"),n)}function Pp(){vt.classList.remove("jump"),vt.classList.add("cheer"),setTimeout(()=>vt.classList.remove("cheer"),650)}function Dp(){Z.classList.contains("lifted")||(vt.classList.remove("cheer"),vt.classList.add("jump"),setTimeout(()=>vt.classList.remove("jump"),720))}function er(e){for(let n=0;n<5;n++){const a=document.createElement("span");a.className="kb-spark",a.textContent=e[n%e.length],a.style.setProperty("--dx",n*14-28+"px"),a.style.left=30+n*10+"%",a.style.animationDelay=n*40+"ms",Z.appendChild(a),setTimeout(()=>a.remove(),1100)}}function qp(){const e=[N("kb-fab-hi","喵?"),N("kb-fab-ask","问我呀!"),"🐾"];vt.addEventListener("mouseenter",()=>{Z.classList.contains("lifted")||jp(e[(Date.now()/1e3|0)%e.length],1400)}),setInterval(()=>{!Z.classList.contains("on")||Z.classList.contains("lifted")||Me.classList.contains("open")||(Date.now()/1e3|0)%2===0&&(Dp(),er(["✨","🐾"]))},5400)}function Sa(e){return Math.min(Math.max(pt,e),window.innerHeight-Z.offsetHeight-pt)}function Rp(){Z.classList.add("snapping"),Z.style.left=window.innerWidth-56-pt+"px",Z.style.top="62%"}function Fp(){let e,n=!1,a=!1,s=0,o=0,i=0,r=0;function l(c){s=c.clientX,o=c.clientY,a=!1,n=!1;const u=Z.getBoundingClientRect();i=u.left,r=u.top,Z.classList.remove("snapping"),e=setTimeout(()=>{Z.classList.add("lifted")},180),window.addEventListener("pointermove",m),window.addEventListener("pointerup",d),c.preventDefault()}function m(c){const u=c.clientX-s,v=c.clientY-o;!n&&Math.hypot(u,v)>6&&(n=!0,Z.classList.add("lifted"),clearTimeout(e)),n&&(a=!0,Z.style.left=i+u+"px",Z.style.top=Sa(r+v)+"px")}function d(){if(clearTimeout(e),window.removeEventListener("pointermove",m),window.removeEventListener("pointerup",d),Z.classList.remove("lifted"),!a){Hp();return}p()}function p(){const c=Z.getBoundingClientRect();Z.classList.add("snapping"),Z.style.top=Sa(c.top)+"px",Z.style.left=(c.left+c.width/2<window.innerWidth/2?pt:window.innerWidth-Z.offsetWidth-pt)+"px"}vt.addEventListener("pointerdown",l),window.addEventListener("resize",()=>{if(!Ya)return;const c=Z.getBoundingClientRect();Z.style.top=Sa(c.top)+"px",Z.style.left=(c.left+c.width/2<window.innerWidth/2?pt:window.innerWidth-Z.offsetWidth-pt)+"px"})}function tr(e){Mp(),localStorage.setItem(js,e?"1":"0"),Z.classList.toggle("on",e),e||Ja()}window._kbFabSetEnabled=tr;window._kbFabEnabled=()=>localStorage.getItem(js)==="1";async function Po(){if(localStorage.getItem(js)==="1")try{await Yi()&&tr(!0)}catch{}}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",Po):Po();let Qn=null;function zp(){if(Qn)return;const e=document.createElement("style");e.id="kb-info-style",e.textContent=`
...
`,document.head.appendChild(e),Qn=Wi("info")}function jn(e,n){return`<li><span class="ck">${We("check")}</span><span>${K(N(e,n))}</span></li>`}function Ca(e,n,a,s,o,i,r){return`<div class="row"><div class="pi">${e}</div>
        <div class="pm"><b>${K(N(n,a))}</b><div class="d">${K(N(s,o))}</div></div>
        <span class="amt">${K(N(i,r))}</span></div>`}function Np(){const e=Qn?.modal;e&&(e.innerHTML=`
        <div class="kb-info-head">
            <span class="ic"><img src="${yt}" alt=""></span>
            <div>
        ...
        <div class="kb-info-body">
            ...
            <div class="kb-info-price">
                ${Ca(We("upload"),"kb-info-c1-n","上传建库","kb-info-c1-d","PDF / 图片按页、文档按字符 —— 跟现在 OCR 同价","kb-info-c1-amt","฿1.50/页起")}
                ${Ca(We("message"),"kb-info-c2-n","AI 问答","kb-info-c2-d","每次带合同原文出处的回答","kb-info-c2-amt","฿0.50/次")}
                ${Ca(We("shield-check"),"kb-info-c3-n","自动发票检查","kb-info-c3-d","死规则:算术 / 税号 / 查重 / 客户规矩","kb-info-c3-amt","免费")}
            </div>
    ...
    `)}function Op(){zp(),Np(),Qn?.open()}window._kbOpenInfo=Op;const nr={tax_invoice:"sx-dt-tax_invoice",tax_invoice_receipt:"sx-dt-tax_invoice_receipt",tax_invoice_simple:"sx-dt-tax_invoice_simple",receipt:"sx-dt-receipt",quotation:"sx-dt-quotation",credit_note:"sx-dt-credit_note",debit_note:"sx-dt-debit_note"};function Ps(e){const n=e?nr[e]:null;return n?t(n):e||"—"}function De(e){return Number(e||0).toLocaleString("en-US",{minimumFractionDigits:2,maximumFractionDigits:2})}function Ds(e){return e?e.slice(0,10):"—"}function ye(e){return escapeHtml(e==null?"":String(e))}function Vp(){const e={Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||"")};try{const n=window._wsHeader&&window._wsHeader();n&&Object.assign(e,n)}catch{}return e}function kt(e,n={}){return fetch(e,{...n,headers:{...Vp(),...n.headers||{}}})}const Up=Object.freeze(Object.defineProperty({__proto__:null,DOC_TYPE_KEY:nr,docTypeLabel:Ps,fmtDate:Ds,fmtMoney:De,htmlVal:ye,salesFetch:kt},Symbol.toStringTag,{value:"Module"})),Te={x:'<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.9"><path d="M18 6 6 18M6 6l12 12"/></svg>',dl:'<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.9"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4M7 10l5 5 5-5M12 15V3"/></svg>',print:'<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.9"><path d="M6 9V2h12v7M6 18H4a2 2 0 0 1-2-2v-5a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2v5a2 2 0 0 1-2 2h-2M6 14h12v8H6z"/></svg>',send:'<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.9"><path d="m22 2-7 20-4-9-9-4Z"/></svg>',ban:'<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.9"><circle cx="12" cy="12" r="9"/><path d="m5 5 14 14"/></svg>',undo:'<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.9"><path d="M3 7v6h6M3 13a9 9 0 1 0 3-7.7L3 8"/></svg>',copy:'<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.9"><path d="M9 9h11v11H9zM5 15H4V4h11v1"/></svg>',qr:'<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.9"><rect x="3" y="3" width="7" height="7"/><rect x="14" y="3" width="7" height="7"/><rect x="3" y="14" width="7" height="7"/><path d="M14 14h3v3h-3zM21 14v7M17 21h4"/></svg>'};let Xa={},Do=null;function ze(){return document.getElementById("sales-detail-mask")}function ve(){return document.getElementById("sales-action-mask")}function Mt(){ze().style.display="none",ze().innerHTML=""}function _e(){ve().style.display="none",ve().innerHTML=""}async function Gp(){if(!Object.keys(Xa).length)try{const e=await apiGet("/api/sales/sellers"),n=e&&(e.sellers||e.items||e)||[];if(Array.isArray(n))for(const a of n)Xa[String(a.workspace_client_id??a.id)]=a}catch{}}function Wp(e){const n=Xa[String(e.seller_workspace_client_id??"")]||{},a=(e.lines||[]).map((s,o)=>`<tr><td>${o+1}</td><td>${escapeHtml(String(s.description||"—"))}</td><td style="text-align:right">${De(s.amount??Number(s.qty||0)*Number(s.unit_price||0))}</td></tr>`).join("");return`<div class="sx-inv">
        <div class="sx-cb">ต้นฉบับ</div>
        <h4>${escapeHtml(n.name||t("sx-seller"))}</h4>
        <div class="sx-no">${escapeHtml(Ps(e.doc_type))} · ${escapeHtml(e.doc_number||t("sx-draft-tag"))} · ${escapeHtml(Ds(e.issue_date))}</div>
        <div class="sx-pp">
        ...
        <div class="sx-tot">
    ...
    </div>`}function Kp(e,n,a){return`<button class="btn btn-ghost btn-sm" data-soft="${escapeHtml(a)}">${n}<span>${escapeHtml(e)}</span></button>`}function Yp(e){const n=e.status==="void",a=e.doc_type==="quotation",s=e.status==="issued"&&(e.payment?.status||"unpaid")!=="paid",o=n?`<span style="color:var(--ink-3)">${escapeHtml(t("sx-voided-note"))}</span>`:`<button class="btn btn-ghost btn-sm" data-act="download">${Te.dl}<span>${escapeHtml(t("sx-download"))}</span></button>
           ...
           ${Kp(t("sx-copy"),Te.copy,"sx-copy-soon")}`,i=n?"":`${a?`<button class="btn btn-ghost btn-sm" data-act="convert">${escapeHtml(t("sx-convert"))}</button>`:""}
        ...
        <div class="modal-footer" style="justify-content:space-between">
    ...
    </div>`,ze().style.display="flex",Jp(e)}function Jp(e){document.getElementById("sx-detail-close").onclick=Mt,document.getElementById("sx-detail-close2").onclick=Mt,ze().onclick=n=>{n.target===ze()&&Mt()},ze().querySelectorAll("[data-soft]").forEach(n=>n.onclick=()=>showToast(t(n.dataset.soft),"info")),ze().querySelectorAll("[data-act]").forEach(n=>n.onclick=()=>nu(n.dataset.act,e))}async function qo(e,n){try{const a=await kt(`/api/sales/documents/${e.id}/pdf?page=A4&copy=original`);if(!a.ok){showToast(t("sx-pdf-fail"),"error");return}const s=URL.createObjectURL(await a.blob()),o=window.open(s,"_blank");n&&o&&o.addEventListener("load",()=>o.print()),setTimeout(()=>URL.revokeObjectURL(s),6e4)}catch{showToast(t("sx-pdf-fail"),"error")}}async function Xp(e){try{const n=await kt(`/api/sales/documents/${e.id}/promptpay-qr`);if(!n.ok){const o=await n.json().catch(()=>({})),i=String(o.detail||"").replace("sales.","");showToast(t("sx-pp-"+i)||t("sx-pp-fail"),"error");return}const a=URL.createObjectURL(await n.blob()),s=Number(e.grand_total||0)-Number(e.payment?.paid_amount||0);ve().innerHTML=`<div class="modal" role="dialog" style="max-width:380px">
            ...
            </div></div>`,ve().style.display="flex",document.getElementById("sx-pp-close").onclick=_e,ve().onclick=o=>{o.target===ve()&&_e()},setTimeout(()=>URL.revokeObjectURL(a),12e4)}catch{showToast(t("sx-pp-fail"),"error")}}function Ro(e,n){const a=n==="credit_note"?t("sx-credit-title"):t("sx-debit-title");ve().innerHTML=`<div class="modal" role="dialog" style="max-width:460px">
        ...
        </div></div>`,ve().style.display="flex",document.getElementById("sx-note-close").onclick=_e,document.getElementById("sx-note-cancel").onclick=_e,ve().onclick=s=>{s.target===ve()&&_e()},document.getElementById("sx-note-ok").onclick=async()=>{const s=document.getElementById("sx-note-reason").value.trim(),o=Number(document.getElementById("sx-note-amount").value);if(!(o>0)){showToast(t("sx-note-amount-required"),"error");return}await qs(`/api/sales/documents/${e.id}/${n==="credit_note"?"credit-note":"debit-note"}`,{reason:s||a,vat_rate:Number(e.vat_rate||7),wht_rate:0,lines:[{description:s||a,qty:1,unit_price:o,vat_applicable:!0}]})&&(_e(),Mt(),showToast(t("sx-done"),"success"),window.dispatchEvent(new CustomEvent("pearnly:sales-changed")))}}function Zp(e){ve().innerHTML=`<div class="modal" role="dialog" style="max-width:440px">
        ...
        </div></div>`,ve().style.display="flex",document.getElementById("sx-void-close").onclick=_e,document.getElementById("sx-void-cancel").onclick=_e,ve().onclick=n=>{n.target===ve()&&_e()},document.getElementById("sx-void-ok").onclick=async()=>{await qs(`/api/sales/documents/${e.id}/void`,{})&&(_e(),Mt(),showToast(t("sx-done"),"success"),window.dispatchEvent(new CustomEvent("pearnly:sales-changed")))}}async function Qp(e){await qs(`/api/sales/documents/${e.id}/convert`,{target_doc_type:"tax_invoice"})&&(Mt(),showToast(t("sx-converted"),"success"),window.dispatchEvent(new CustomEvent("pearnly:sales-changed")))}async function qs(e,n){try{const a=await apiPost(e,n);if(a&&a.ok)return!0;const s=a?await a.json().catch(()=>({})):{};return showToast(t("sx-action-fail")+(s.detail?" · "+s.detail:""),"error"),!1}catch{return showToast(t("sx-action-fail"),"error"),!1}}let cn="email";function eu(e,n,a){return`<div class="sx-seg" style="width:100%">${e.map(s=>`<button type="button" data-${a}="${s[0]}" class="${n===s[0]?"on":""}" style="flex:1">${escapeHtml(s[1])}</button>`).join("")}</div>`}function ar(e){const n=cn==="email"?`<div class="sx-banner" style="margin-top:4px">${escapeHtml(t("sx-send-email-hint"))}</div>
               <div class="form-row" style="margin-top:12px"><label>${escapeHtml(t("sx-send-buyer-email"))}</label><input type="email" id="sx-send-email" placeholder="buyer@example.com"></div>`:`<div class="sx-banner" style="margin-top:4px">${escapeHtml(t("sx-send-line-hint"))}</div>`;ve().innerHTML=`<div class="modal" role="dialog" style="max-width:460px">
        ...
        <div class="modal-body">
            <div class="form-row"><label>${escapeHtml(t("sx-send-how"))}</label>
                ${eu([["email",t("sx-send-opt-email")],["line",t("sx-send-opt-line")]],cn,"ch")}</div>
            ${n}
        </div>
        <div class="modal-footer" style="justify-content:flex-end;gap:8px">
        ...
        </div></div>`,ve().style.display="flex",document.getElementById("sx-send-close").onclick=_e,document.getElementById("sx-send-cancel").onclick=_e,ve().onclick=a=>{a.target===ve()&&_e()},ve().querySelectorAll("[data-ch]").forEach(a=>a.onclick=()=>(cn=a.dataset.ch,ar(e))),document.getElementById("sx-send-do").onclick=()=>tu(e)}async function tu(e){if(cn==="email"){const o=document.getElementById("sx-send-email").value.trim();if(!o)return showToast(t("sx-send-email-required"),"error");const i=await apiPost(`/api/sales/documents/${e.id}/send`,{channel:"email",to:o});i&&i.ok?(_e(),showToast(t("sx-send-email-ok"),"success")):showToast(t("sx-send-fail"),"error");return}const n=await apiPost(`/api/sales/documents/${e.id}/send`,{channel:"line"}),a=n?await n.json().catch(()=>({})):{};if(!n||!n.ok||!a.share_url)return showToast(t("sx-send-fail"),"error");const s=String(a.share_url);ve().innerHTML=`<div class="modal" role="dialog" style="max-width:480px">
        ...
        <div class="modal-footer" style="justify-content:flex-end;gap:8px">
            ...
            <button class="btn btn-primary" id="sx-link-copy">${escapeHtml(t("sx-send-copy"))}</button>
        </div></div>`,document.getElementById("sx-link-close").onclick=_e,document.getElementById("sx-link-done").onclick=_e,document.getElementById("sx-link-copy").onclick=()=>{document.getElementById("sx-link-url").select(),navigator.clipboard?.writeText(s).catch(()=>{}),showToast(t("sx-send-copied"),"success")}}function nu(e,n){if(e==="download")return void qo(n,!1);if(e==="print")return void qo(n,!0);if(e==="send")return ar(n);if(e==="promptpay")return void Xp(n);if(e==="credit")return Ro(n,"credit_note");if(e==="debit")return Ro(n,"debit_note");if(e==="void")return Zp(n);if(e==="convert")return void Qp(n)}window.openSalesDetail=async function(e){ze().innerHTML=`<div class="modal" role="dialog" style="max-width:640px"><div class="modal-body"><div class="sx-state">${escapeHtml(t("sx-loading"))}</div></div></div>`,ze().style.display="flex",await Gp();try{const n=await apiGet(`/api/sales/documents/${e}`);if(!n)return;Do=n.document,Yp(Do)}catch{ze().innerHTML=`<div class="modal" role="dialog" style="max-width:480px"><div class="modal-body"><div class="sx-state error">${escapeHtml(t("sx-error"))}</div></div></div>`;const a=ze();a.onclick=s=>{s.target===a&&Mt()}}};const au='<svg width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.4"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8Z"/><path d="M14 2v6h6M8 13h8M8 17h5"/></svg>',su='<svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.9"><circle cx="12" cy="12" r="3"/><path d="M19.4 13a7 7 0 0 0 0-2l2-1.5-2-3.5-2.3 1a7 7 0 0 0-1.7-1L15 3H9l-.4 2.5a7 7 0 0 0-1.7 1l-2.3-1-2 3.5L4.6 11a7 7 0 0 0 0 2l-2 1.5 2 3.5 2.3-1a7 7 0 0 0 1.7 1L9 21h6l.4-2.5a7 7 0 0 0 1.7-1l2.3 1 2-3.5-2-1.5Z"/></svg>',ou='<svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="#fff" stroke-width="2.2"><path d="M12 5v14M5 12h14"/></svg>',iu='<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.9"><path d="m9 18 6-6-6-6"/></svg>',ru=["paid","unpaid","partial"];let ea=[],ta="all",Rs="";function sr(e){const n=e.payment&&e.payment.status||"";return ru.indexOf(n)>=0?n:"unpaid"}function or(e){return e.buyer&&e.buyer.name||"—"}function lu(e){if(!e)return!1;const n=new Date,a=n.getFullYear()+"-"+String(n.getMonth()+1).padStart(2,"0");return e.slice(0,7)===a}function cu(){const e=ea.filter(i=>i.status==="issued"),n=e.filter(i=>lu(i.issue_date)),a=n.reduce((i,r)=>i+Number(r.grand_total||0),0),s=ea.filter(i=>i.status==="draft").length,o=e.filter(i=>sr(i)!=="paid").reduce((i,r)=>i+(Number(r.grand_total||0)-Number(r.payment.paid_amount||0)),0);return{count:n.length,amount:a,drafts:s,due:o}}function du(){let e=ea;ta!=="all"&&(e=e.filter(a=>a.status===ta));const n=Rs.trim().toLowerCase();return n&&(e=e.filter(a=>(a.doc_number||"").toLowerCase().indexOf(n)>=0||or(a).toLowerCase().indexOf(n)>=0)),e}function ir(){const e=du();return e.length?e.map(n=>{const a=sr(n),s=n.doc_number||t("sx-draft-tag");return`<tr class="click" data-doc="${escapeHtml(n.id)}">
                <td><b>${escapeHtml(s)}</b></td>
                <td style="color:var(--ink-3)">${escapeHtml(Ds(n.issue_date))}</td>
                <td>${escapeHtml(Ps(n.doc_type))}</td>
                <td>${escapeHtml(or(n))}</td>
                ...
                <td class="r"><button class="sx-chev" data-doc="${escapeHtml(n.id)}" aria-label="${escapeHtml(t("sx-detail-title"))}">${iu}</button></td>
            </tr>`}).join(""):`<tr><td colspan="8"><div class="sx-state">${au}<div>${escapeHtml(t("sx-empty"))}</div></div></td></tr>`}function rr(){const e=cu(),n=["all","draft","issued","void"].map(a=>`<button data-flt="${a}" class="${ta===a?"on":""}">${escapeHtml(t("sx-f-"+a))}</button>`).join("");return`<div class="sx-cards">
    ...
    <div class="sx-toolbar">
        ...
        <div class="sx-search"><input type="text" id="sx-wb-search" value="${escapeHtml(Rs)}" placeholder="${escapeHtml(t("sx-search-ph"))}"></div>
    </div>
    <div class="sx-panel"><table class="sx-tbl">
        ...
        <tbody id="sx-wb-tbody">${ir()}</tbody>
    </table></div>`}function pu(){return`<div class="sx-page">
        <div class="sx-head">
            <h2 data-i18n="sx-wb-title">${escapeHtml(t("sx-wb-title"))}</h2>
            <span class="sx-sub">ใบกำกับภาษี</span>
            <div class="sx-actions">
                <button class="btn btn-ghost" id="sx-settings-btn">${su}<span>${escapeHtml(t("sx-settings"))}</span></button>
                <button class="btn btn-primary" id="sx-new-btn">${ou}<span>${escapeHtml(t("sx-new"))}</span></button>
            </div>
        </div>
        <div id="sx-wb-body"></div>
    </div>`}function Nn(e){const n=document.getElementById("sx-wb-body");n&&(n.innerHTML=e)}function uu(){const e=document.getElementById("sx-wb-tbody");e&&(e.innerHTML=ir()),lr()}function lr(){document.querySelectorAll("#sx-wb-body [data-doc]").forEach(e=>{e.onclick=n=>{n.stopPropagation(),window.openSalesDetail&&window.openSalesDetail(e.dataset.doc)}})}function cr(){document.querySelectorAll("#sx-wb-body [data-flt]").forEach(n=>{n.onclick=()=>{ta=n.dataset.flt,Nn(rr()),cr()}});const e=document.getElementById("sx-wb-search");e&&(e.oninput=()=>{Rs=e.value,uu()}),lr()}function mu(){const e=document.getElementById("sx-new-btn");e&&(e.onclick=()=>window.openSalesWizard?.());const n=document.getElementById("sx-settings-btn");n&&(n.onclick=()=>window.openSalesSettings?.())}async function Fs(){Nn(`<div class="sx-state">${escapeHtml(t("sx-loading"))}</div>`);try{const e=await apiGet("/api/sales/documents");if(!e)return;ea=e.documents||[],Nn(rr()),cr()}catch{Nn(`<div class="sx-state error">${escapeHtml(t("sx-error"))}<br><button class="btn btn-ghost" id="sx-retry">${escapeHtml(t("sx-retry"))}</button></div>`);const n=document.getElementById("sx-retry");n&&(n.onclick=()=>Fs())}}window.loadSalesWorkbench=function(){const e=document.getElementById("page-sales-invoices");e&&(e.dataset.sxInit!=="1"&&(e.innerHTML=pu(),e.dataset.sxInit="1",mu()),Fs())};window.addEventListener("pearnly:sales-changed",()=>{typeof currentRoute<"u"&&currentRoute==="sales-invoices"&&Fs()});(function(){const n=document.querySelector(".nav-sales-head"),a=document.querySelector(".nav-sub2");if(!n||!a)return;const s=i=>{a.classList.toggle("show",i),n.classList.toggle("sx-open",i)},o=(location.hash||"").replace(/^#\//,"");(o==="sales-invoices"||o==="sales-account")&&s(!0),n.addEventListener("click",()=>s(!a.classList.contains("show")))})();const vu='<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6"><path d="M21 8 12 3 3 8l9 5 9-5ZM3 8v8l9 5 9-5V8"/></svg>',fu='<svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8"><path d="M11 4H4v16h16v-7M18.5 2.5a2.1 2.1 0 0 1 3 3L12 15l-4 1 1-4Z"/></svg>',hu='<svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8"><path d="M3 6h18M8 6V4h8v2M6 6l1 14h10l1-14"/></svg>',dr='<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.9"><path d="M18 6 6 18M6 6l12 12"/></svg>';let na=[],zs="";function pr(e){let n=document.getElementById(e);return n||(n=document.createElement("div"),n.id=e,n.className="modal-mask",n.style.display="none",document.body.appendChild(n)),n}function Ht(e){const n=document.getElementById(e);n&&(n.style.display="none",n.innerHTML="")}function gu(){const e=zs.trim().toLowerCase();return e?na.filter(n=>[n.code,n.name_th,n.name_en,n.name_zh,n.barcode].filter(Boolean).some(a=>a.toLowerCase().indexOf(e)>=0)):na}function ur(){const e=gu();return e.length?e.map(n=>{const a=n.name_th||n.name_en||n.name_zh||"—";return`<tr>
                <td>${n.image_url?`<img src="${escapeHtml(n.image_url)}" alt="" style="width:34px;height:34px;border-radius:7px;object-fit:cover">`:`<div class="sx-thumb">${vu}</div>`}</td>
                ...
                <td class="r"><button class="sx-chev" data-edit="${escapeHtml(n.id)}">${fu}</button><button class="sx-chev" data-del="${escapeHtml(n.id)}">${hu}</button></td>
            </tr>`}).join(""):`<tr><td colspan="7"><div class="sx-state">${escapeHtml(t("sx-empty"))}</div></td></tr>`}function bu(){return`<div class="sx-toolbar">
    ...
    <div class="sx-panel"><table class="sx-tbl">
        ...
        <tbody id="sx-p-tbody">${ur()}</tbody>
    </table></div>`}function Ta(e){const n=document.getElementById("sx-p-body");n&&(n.innerHTML=e)}function yu(){const e=document.getElementById("sx-p-search");e&&(e.oninput=()=>{zs=e.value;const n=document.getElementById("sx-p-tbody");n&&(n.innerHTML=ur()),Fo()}),document.getElementById("sx-p-add").onclick=()=>mr(null),document.getElementById("sx-p-import").onclick=_u,Fo()}function Fo(){document.querySelectorAll("#sx-p-body [data-edit]").forEach(e=>{e.onclick=()=>mr(na.find(n=>n.id===e.dataset.edit)||null)}),document.querySelectorAll("#sx-p-body [data-del]").forEach(e=>{e.onclick=()=>xu(e.dataset.del)})}function mr(e){const n=pr("sales-prod-mask");n.innerHTML=`<div class="modal" role="dialog" style="max-width:560px">
        <div class="modal-header"><div class="modal-title">${escapeHtml(t(e?"sx-p-edit":"sx-p-new"))}</div>
            <button class="modal-close" id="sx-p-close">${dr}</button></div>
        <div class="modal-body">
            <div class="form-row form-row-2col">
        ...
        </div></div>`,n.style.display="flex",document.getElementById("sx-p-close").onclick=()=>Ht("sales-prod-mask"),document.getElementById("sx-p-cancel").onclick=()=>Ht("sales-prod-mask"),n.onclick=a=>{a.target===n&&Ht("sales-prod-mask")},document.getElementById("sx-p-save").onclick=()=>ku(e)}function wu(){const e=n=>document.getElementById(n).value.trim();return{name_th:e("sx-pf-th"),code:e("sx-pf-code")||null,barcode:e("sx-pf-barcode")||null,name_en:e("sx-pf-en")||null,name_zh:e("sx-pf-zh")||null,unit:e("sx-pf-unit")||null,unit_price:Number(e("sx-pf-price"))||0,vat_applicable:document.getElementById("sx-pf-vat").checked,image_url:e("sx-pf-image")||null}}async function vr(e,n){const a=await e.json().catch(()=>({})),s=a&&a.detail?String(a.detail):"HTTP "+e.status;return t(n)+" · "+s}async function ku(e){const n=wu();if(!n.name_th)return showToast(t("sx-p-name-required"),"error");const a=e?`/api/sales/products/${e.id}`:"/api/sales/products";try{const s=await kt(a,{method:e?"PATCH":"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(n)});if(!s.ok){showToast(await vr(s,"sx-p-save-fail"),"error");return}Ht("sales-prod-mask"),showToast(t("sx-p-saved"),"success"),await In()}catch{showToast(t("sx-p-save-fail"),"error")}}async function xu(e){if(window.pearnlyConfirm){if(!await window.pearnlyConfirm(t("sx-p-del-confirm")))return}else if(!confirm(t("sx-p-del-confirm")))return;try{const n=await kt(`/api/sales/products/${e}`,{method:"DELETE"});if(!n.ok){showToast(await vr(n,"sx-p-del-fail"),"error");return}showToast(t("sx-p-deleted"),"success"),await In()}catch{showToast(t("sx-p-del-fail"),"error")}}function _u(){const e=pr("sales-prod-mask");e.innerHTML=`<div class="modal" role="dialog" style="max-width:480px">
        <div class="modal-header"><div class="modal-title">${escapeHtml(t("sx-p-import-title"))}</div>
            <button class="modal-close" id="sx-imp-close">${dr}</button></div>
        <div class="modal-body">
        ...
        </div></div>`,e.style.display="flex",document.getElementById("sx-imp-close").onclick=()=>Ht("sales-prod-mask"),document.getElementById("sx-imp-cancel").onclick=()=>Ht("sales-prod-mask"),document.getElementById("sx-imp-go").onclick=Eu}async function Eu(){const e=document.getElementById("sx-imp-file").files?.[0];if(!e)return showToast(t("sx-p-import-pick"),"error");const n=new FormData;n.append("file",e);try{const a=await kt("/api/sales/products/import",{method:"POST",body:n}),s=await a.json().catch(()=>({}));if(!a.ok)throw new Error;Ht("sales-prod-mask"),showToast(t("sx-p-import-done").replace("{n}",String(s.imported??0)),"success"),await In()}catch{showToast(t("sx-p-import-fail"),"error")}}async function In(){Ta(`<div class="sx-state">${escapeHtml(t("sx-loading"))}</div>`);try{const e=await apiGet("/api/sales/products");if(!e)return;na=e.products||[],Ta(bu()),yu()}catch{Ta(`<div class="sx-state error">${escapeHtml(t("sx-error"))}<br><button class="btn btn-ghost" id="sx-p-retry">${escapeHtml(t("sx-retry"))}</button></div>`);const n=document.getElementById("sx-p-retry");n&&(n.onclick=()=>In())}}window.loadSalesProducts=function(){const e=document.getElementById("page-sales-products");e&&(e.dataset.sxInit!=="1"&&(e.innerHTML=`<div class="sx-page"><div class="sx-head"><h2>${escapeHtml(t("nav-sales-products"))}</h2><span class="sx-sub">สินค้า</span></div><div id="sx-p-body"></div></div>`,e.dataset.sxInit="1"),In())};const Iu=["classic","clean","brand","compact","official","mono"],Bu=["#2563eb","#0f766e","#b45309","#7c3aed","#be123c","#111827"];let Ns=[],ba=0,Qe="classic",jt="#2563eb";function Bn(){return Ns[ba]}function Lu(){const e=Bn();if(!e)return`<div class="sx-state">${escapeHtml(t("sx-acc-none"))}</div>`;const n=Ns.map((o,i)=>`<option value="${i}" ${i===ba?"selected":""}>${escapeHtml(o.name||"—")}</option>`).join(""),a=Iu.map(o=>{const i=o==="brand"||o==="official"?jt:"#111827",r=o==="brand"?`<div class="sx-tpl-bar" style="background:${i}"></div>`:"";return`<div class="sx-tpl ${Qe===o?"on":""}" data-tpl="${o}"><div class="sx-tpl-pv">${r}<div class="sx-tpl-co" style="color:${i};${o==="official"?"text-align:center;":""}">บริษัท ตัวอย่าง</div><div class="sx-tpl-ln">รายการ … 1,000</div><div class="sx-tpl-tt">รวม 1,070</div></div><div class="sx-tpl-nm">${escapeHtml(t("sx-acc-tpl-"+o))}</div></div>`}).join(""),s=Bu.map(o=>`<span class="sx-sw ${jt===o?"on":""}" data-color="${o}" style="background:${o}"></span>`).join("");return`<div class="sx-acc-2col">
      ...
      <div class="sx-acc-preview-col">
        ...
        <div id="sx-acc-prev">${fr()}</div>
      </div>
    </div>`}function fr(){const e=Bn();if(!e)return"";const n=Qe==="brand"||Qe==="official"?jt:"#111827",a=Qe==="brand"?`<div style="height:7px;background:${n};margin:-18px -18px 12px;border-radius:8px 8px 0 0"></div>`:"";return`<div class="sx-prev-inv" style="${Qe==="brand"?"border-color:"+n+"55":""}">
        ${a}
        <div class="sx-prev-co" style="color:${n};${Qe==="official"?"text-align:center":""}">${escapeHtml(e.name||"—")}</div>
    ...
    </div>`}function Ma(){const e=document.getElementById("sx-acc-prev");e&&(e.innerHTML=fr())}function $u(){const e=document.getElementById("sx-acc-body");e&&(e.innerHTML=Lu(),Su())}function hr(e){ba=e;const n=Bn();Qe=n&&n.template_id||"classic",jt=n&&n.brand_color||"#2563eb",$u()}function Su(){const e=document.getElementById("sx-acc-sel");e&&(e.onchange=()=>hr(+e.value)),document.querySelectorAll("[data-tpl]").forEach(s=>{s.onclick=()=>{Qe=s.dataset.tpl,document.querySelectorAll("[data-tpl]").forEach(o=>o.classList.toggle("on",o.dataset.tpl===Qe)),Ma()}}),document.querySelectorAll("[data-color]").forEach(s=>{s.onclick=()=>{jt=s.dataset.color,document.querySelectorAll("[data-color]").forEach(o=>o.classList.toggle("on",o.dataset.color===jt)),Ma()}}),[["sx-a-name",s=>Pn().name=s],["sx-a-tax",s=>Pn().tax_id=s],["sx-a-branch",s=>Pn().branch=s],["sx-a-footer",s=>Pn().footer_text=s]].forEach(([s,o])=>{const i=document.getElementById(s);i&&(i.oninput=()=>{o(i.value),Ma()})});const a=document.getElementById("sx-a-save");a&&(a.onclick=Cu)}function Pn(){return Bn()}async function Cu(){const e=Bn();if(!e)return;const n=s=>document.getElementById(s).value.trim(),a={name:n("sx-a-name"),tax_id:n("sx-a-tax")||null,address:n("sx-a-addr")||null,branch:n("sx-a-branch")||null,phone:n("sx-a-phone")||null,promptpay_id:n("sx-a-pp")||null,logo_url:n("sx-a-logo")||null,seal_url:n("sx-a-seal")||null,signature_url:n("sx-a-sign")||null,footer_text:document.getElementById("sx-a-footer").value.trim()||null,template_id:Qe,brand_color:jt};try{if(!(await kt(`/api/sales/sellers/${e.id}`,{method:"PUT",headers:{"Content-Type":"application/json"},body:JSON.stringify(a)})).ok)throw new Error;Object.assign(e,a),showToast(t("sx-acc-saved"),"success")}catch{showToast(t("sx-acc-save-fail"),"error")}}async function gr(){const e=document.getElementById("sx-acc-body");e&&(e.innerHTML=`<div class="sx-state">${escapeHtml(t("sx-loading"))}</div>`);try{const n=await apiGet("/api/sales/sellers");if(!n)return;Ns=n.sellers||[],ba=0,hr(0)}catch{e&&(e.innerHTML=`<div class="sx-state error">${escapeHtml(t("sx-error"))}<br><button class="btn btn-ghost" id="sx-acc-retry">${escapeHtml(t("sx-retry"))}</button></div>`);const a=document.getElementById("sx-acc-retry");a&&(a.onclick=()=>gr())}}window.loadSalesAccount=function(){const e=document.getElementById("page-sales-account");e&&(e.dataset.sxInit!=="1"&&(e.innerHTML=`<div class="sx-page"><div class="sx-head"><h2>${escapeHtml(t("nav-sales-account"))}</h2><span class="sx-sub">กิจการ / ข้อมูลออกบิล</span></div><div id="sx-acc-body" style="max-width:1040px"></div></div>`,e.dataset.sxInit="1"),gr())};const Tu='<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.9"><path d="M18 6 6 18M6 6l12 12"/></svg>',Mu=["0","1","2","3","5"];let we;function et(){let e=document.getElementById("sales-settings-mask");return e||(e=document.createElement("div"),e.id="sales-settings-mask",e.className="modal-mask",e.style.display="none",document.body.appendChild(e)),e}function aa(){const e=document.getElementById("sales-settings-mask");e&&(e.style.display="none",e.innerHTML="")}function on(e,n){return`<div class="sx-seg" data-seg="${String(e)}" style="width:100%">${n.map(a=>`<button type="button" data-seg-v="${a[0]}" class="${String(we[e])===a[0]?"on":""}" style="flex:1">${escapeHtml(a[1])}</button>`).join("")}</div>`}function br(){const e=we.number_prefix||"INV",n=new Date().getFullYear();return`${escapeHtml(e)}${n}-00001`}function Hu(){const e=Mu.map(n=>`<option value="${n}" ${String(Number(we.default_wht_rate))===n?"selected":""}>${n}%</option>`).join("");et().innerHTML=`<div class="modal" role="dialog" style="max-width:560px">
        <div class="modal-header"><div class="modal-title">${escapeHtml(t("sx-set-title"))}</div>
            <button class="modal-close" id="sx-set-close">${Tu}</button></div>
        <div class="modal-body">
            <div class="sx-set-card">
                <div class="sx-set-h">${escapeHtml(t("sx-set-num"))}</div>
                <div class="sx-set-row3">
                    <div class="sx-field"><label>${escapeHtml(t("sx-set-prefix"))}</label><input type="text" id="sx-set-prefix" value="${escapeHtml(we.number_prefix||"")}" maxlength="20" placeholder="INV"></div>
                    <div class="sx-field"><label>${escapeHtml(t("sx-set-reset"))}</label>${on("number_reset",[["yearly",t("sx-set-reset-yearly")],["monthly",t("sx-set-reset-monthly")],["never",t("sx-set-reset-never")]])}</div>
                    <div class="sx-field"><label>${escapeHtml(t("sx-set-start"))}</label><input type="number" id="sx-set-start" value="${we.number_start||1}" min="1"></div>
                </div>
                <div class="sx-hint">${escapeHtml(t("sx-set-num-preview"))}: <b id="sx-set-preview">${br()}</b> · ${escapeHtml(t("sx-set-num-preview-note"))}</div>
            </div>
            <div class="sx-set-card">
            ...
            <div class="sx-set-card">
                ...
                <select id="sx-set-wht" style="max-width:280px">${e}</select>
                <div class="sx-hint">${escapeHtml(t("sx-set-wht-hint"))}</div>
            </div>
            <div class="sx-set-card">
                <div class="sx-set-h">${escapeHtml(t("sx-set-output"))}</div>
                <div class="sx-field"><label>${escapeHtml(t("sx-set-lang"))}</label>${on("default_doc_lang",[["th",t("sx-set-lang-th")],["th_en",t("sx-set-lang-then")],["th_zh",t("sx-set-lang-thzh")]])}</div>
                <div class="sx-field"><label>${escapeHtml(t("sx-set-paper"))}</label>${on("default_paper",[["A4","A4"],["A5","A5"],["80mm","80mm"]])}</div>
                <label style="display:flex;align-items:center;gap:8px;margin-top:8px;cursor:pointer"><input type="checkbox" id="sx-set-2up" ${we.default_copies_layout==="two_up"?"checked":""} style="width:auto"> ${escapeHtml(t("sx-set-copies-2up"))}</label>
            </div>
        </div>
        <div class="modal-footer" style="justify-content:space-between">
        ...
        <div class="sw-sectitle">${escapeHtml(C("orManual"))}</div><div class="sw-choices">${s}</div></div>`}function im(e){const n=Ln(),a=kr(),s=a[e.sellerIdx],o=a.map((f,y)=>`<option value="${y}" ${y===e.sellerIdx?"selected":""}>${escapeHtml(f.name||"—")}</option>`).join(""),i=n.bt.map(f=>`<div class="sw-choice ${e.buyer.type===f[0]?"on":""}" data-bt="${f[0]}" style="padding:10px 12px"><div class="sw-ck">${be.check}</div><div><div class="sw-t">${escapeHtml(f[1])}</div><div class="sw-d">${escapeHtml(f[2])}</div></div></div>`).join(""),r=e.buyer,l=r.type==="anonymous",m=r.type==="company",d=r.type==="individual"?C("natid"):r.type==="foreigner"?C("passport"):C("tin"),p=l?"":'<span class="sw-req">*</span>';let c="";l||(r.type==="foreigner"?r.tin&&!/^[A-Za-z0-9]{4,20}$/.test(r.tin)&&(c=`<div class="sw-hint err">${escapeHtml(C("passErr"))}</div>`):r.tin&&!/^\d{13}$/.test(r.tin)?c=`<div class="sw-hint err">${escapeHtml(C("tinErr"))}</div>`:r.type==="individual"&&(c=`<div class="sw-hint info">${be.info} ${escapeHtml(C("tinHintInd"))}</div>`));const u=s?`${escapeHtml(s.name||"")} · ${escapeHtml(s.tax_id||"")} · ${escapeHtml(s.branch||"")}`:"—",v=l?`<div class="sw-banner warn">${be.info}<span>${escapeHtml(C("anonNote"))}</span></div>
           ...
           ${m?rm(e):""}`;return`<div class="sw-card"><h2>${escapeHtml(C("s2h"))}</h2><div class="sw-sub">${escapeHtml(C("s2sub"))}</div>
        ...
        <div style="margin-top:16px">${v}</div></div>`}function rm(e){const n=e.buyer,a=n.branchNo&&!/^\d{5}$/.test(n.branchNo);return`<div class="sw-field"><label>${escapeHtml(C("branch"))} <span class="sw-req">*</span></label>
        ...
        ${n.branchType==="branch"?`<input type="text" id="sw-brno" value="${escapeHtml(n.branchNo)}" placeholder="${escapeHtml(C("brno"))} (5)">${a?`<div class="sw-hint err">${escapeHtml(C("brErr"))}</div>`:""}`:""}</div>`}function lm(e){const n=ya(e),a=xr(),s=a.map((l,m)=>`<div class="sw-pcard" data-add="${m}"><div class="sw-pimg" style="background:${Vo[m%Vo.length]}">${l.image_url?`<img src="${escapeHtml(l.image_url)}" alt="">`:be.box}</div><div class="sw-pn">${escapeHtml(Er(l))}</div><div class="sw-pp">฿${ge(l.unit_price)}${l.vat_applicable?"":` <span class="sw-muted" style="font-size:10px">${escapeHtml(C("taxFree"))}</span>`}</div></div>`).join(""),o=a.length?"":'<div class="sw-muted" style="padding:20px;text-align:center">—</div>',r=e.lines.some(l=>l.desc||+l.price||l.custom)?e.lines.map((l,m)=>`<div class="sw-citem">
        ...
        </div></div>`}function cm(e){const n=Ln(),a=ya(e);if(!Os(e))return`<div class="sw-card"><h2>${escapeHtml(C("s4h"))}</h2><div class="sw-sub">${escapeHtml(C("s4sub"))}</div>
            <div class="sw-banner">${be.info}<span>${escapeHtml(C("payNA"))}</span></div>${Uo(e)}</div>`;const s=e.pay,o=n.methods.map(i=>`<option value="${i[0]}" ${s.method===i[0]?"selected":""}>${escapeHtml(i[1])}</option>`).join("");return`<div class="sw-card"><h2>${escapeHtml(C("s4h"))}</h2><div class="sw-sub">${escapeHtml(C("s4sub"))}</div>
        ${On(e)?`<div class="sw-banner warn">${be.info}<span>${escapeHtml(C("payReqWarn"))}</span></div>`:""}
        ...
        ${Uo(e)}</div>`}function Uo(e){return`<div class="sw-sectitle">${escapeHtml(C("issueDate"))}</div><div class="sw-row3">
        ...
        <div class="sw-field"><label>${escapeHtml(C("calendar"))}</label><div class="sw-seg">
            ...
            <button type="button" data-cal="be" class="${e.be?"on":""}">${escapeHtml(C("be"))}</button></div></div></div>`}function dm(e){const n=yr(e).map(i=>i.na?`<div class="sw-check"><div class="sw-ci" style="background:#eee;color:#999">${be.checkG}</div><div><div class="sw-ct">${escapeHtml(C(i.key))} <span class="sw-pill">${escapeHtml(C("ckNa"))}</span></div></div></div>`:`<div class="sw-check ${i.pass?"pass":"fail"}"><div class="sw-ci">${i.pass?be.checkG:be.x}</div><div><div class="sw-ct">${escapeHtml(C(i.key))}${i.req&&!i.pass?' <span class="sw-req">*</span>':""}</div><div class="sw-cd">${escapeHtml(C(i.descKey))}</div></div></div>`).join(""),a={a4:"paperA4",a5:"paperA5",pos:"paperPos"},s=["a4","a5","pos"].map(i=>`<button type="button" data-paper="${i}" class="${e.paper===i?"on":""}">${escapeHtml(C(a[i]))}</button>`).join(""),o=["th","th_en","th_zh"].map(i=>`<button type="button" data-dlang="${i}" class="${e.docLang===i?"on":""}">${escapeHtml(C(i==="th"?"dlTh":i==="th_en"?"dlThEn":"dlThZh"))}</button>`).join("");return`<div class="sw-card"><h2>${escapeHtml(C("s5h"))}</h2><div class="sw-sub">${escapeHtml(C("s5sub"))}</div>
        ...
        <div id="sw-print">${sm(e,C("tear"),be.info)}</div></div>`}function es(){const e=new Date;return e.getFullYear()+"-"+String(e.getMonth()+1).padStart(2,"0")+"-"+String(e.getDate()).padStart(2,"0")}let qe=0,z;function Ir(){return{docType:"tax_invoice_receipt",sellerIdx:0,buyer:{type:"company",name:"",addr:"",tin:"",branchType:"hq",branchNo:""},lines:[{desc:"",qty:1,price:0,disc:0,vat:!0}],hdisc:0,vatRate:7,whtRate:0,pay:{status:"paid",method:"transfer",date:es(),paidAmt:null},issueDate:es(),dueDate:"",be:!1,paper:"a4",docLang:"th_en",layout:"single",draftId:null}}function ue(){let e=document.getElementById("sales-wizard-mask");return e||(e=document.createElement("div"),e.id="sales-wizard-mask",e.className="sw-mask",document.body.appendChild(e)),e}function ts(){const e=document.getElementById("sales-wizard-mask");e&&(e.style.display="none",e.innerHTML="")}function me(){const n=Ln().steps.map((s,o)=>{const i=o===qe?"active":o<qe?"done":"",r=o<qe?be.check:o+1;return`<div class="sw-step ${i}"><div class="sw-num">${r}</div><div class="sw-lbl">${escapeHtml(s)}</div>${o<4?'<div class="sw-bar"></div>':""}</div>`}).join(""),a=[om,im,lm,cm,dm][qe](z);ue().innerHTML=`<div class="sw-wrap">
        <div class="sw-topbar">
    ...
    </div>`,ue().style.display="flex",pm()}function Ve(e,n,a=!1){const s=document.getElementById(e);s&&(s.oninput=()=>n(s.value),a&&(s.onblur=me))}function pm(){document.getElementById("sw-close").onclick=ts,document.getElementById("sw-back").onclick=()=>Go(-1),document.getElementById("sw-next").onclick=()=>Go(1),document.getElementById("sw-draft").onclick=ym,ue().querySelectorAll("[data-doc]").forEach(o=>o.onclick=()=>(z.docType=o.dataset.doc,me())),ue().querySelectorAll("[data-sc]").forEach(o=>o.onclick=()=>gm(+o.dataset.sc));const e=document.getElementById("sw-seller");e&&(e.onchange=()=>(z.sellerIdx=+e.value,me())),ue().querySelectorAll("[data-bt]").forEach(o=>o.onclick=()=>um(o.dataset.bt)),ue().querySelectorAll("[data-brt]").forEach(o=>o.onclick=()=>(z.buyer.branchType=o.dataset.brt,o.dataset.brt==="hq"&&(z.buyer.branchNo=""),me())),Ve("sw-bname",o=>z.buyer.name=o),Ve("sw-baddr",o=>z.buyer.addr=o),Ve("sw-btin",o=>(z.buyer.tin=o,z.buyer.verified=!1),!0),Ve("sw-brno",o=>z.buyer.branchNo=o,!0);const n=document.getElementById("sw-rd");n&&(n.onclick=bm),ue().querySelectorAll("[data-add]").forEach(o=>o.onclick=()=>mm(+o.dataset.add)),ue().querySelectorAll("[data-q]").forEach(o=>o.onclick=()=>vm(+o.dataset.q,+o.dataset.d)),ue().querySelectorAll("[data-rm]").forEach(o=>o.onclick=()=>fm(+o.dataset.rm)),ue().querySelectorAll("[data-ln]").forEach(o=>{const i=+o.dataset.ln,r=o.dataset.f;o.oninput=()=>z.lines[i][r]=o.value,o.onblur=me});const a=document.getElementById("sw-addcustom");a&&(a.onclick=()=>(z.lines.push({desc:"",qty:1,price:0,disc:0,vat:!0,custom:!0}),me())),ue().querySelectorAll("[data-save]").forEach(o=>o.onchange=()=>z.lines[+o.dataset.save].save=o.checked),Ve("sw-hdisc",o=>z.hdisc=o,!0),Ve("sw-vat",o=>z.vatRate=o,!0),Ve("sw-wht",o=>z.whtRate=o,!0),ue().querySelectorAll("[data-ps]").forEach(o=>o.onclick=()=>(z.pay.status=o.dataset.ps,me()));const s=document.getElementById("sw-pm");s&&(s.onchange=()=>z.pay.method=s.value),Ve("sw-pdate",o=>z.pay.date=o),Ve("sw-paid",o=>z.pay.paidAmt=o),Ve("sw-idate",o=>z.issueDate=o),Ve("sw-ddate",o=>z.dueDate=o),ue().querySelectorAll("[data-cal]").forEach(o=>o.onclick=()=>(z.be=o.dataset.cal==="be",me())),ue().querySelectorAll("[data-paper]").forEach(o=>o.onclick=()=>(z.paper=o.dataset.paper,me())),ue().querySelectorAll("[data-dlang]").forEach(o=>o.onclick=()=>(z.docLang=o.dataset.dlang,me())),ue().querySelectorAll("[data-layout]").forEach(o=>o.onclick=()=>(z.layout=o.dataset.layout,me()))}function Go(e){const n=qe+e;if(!(n<0||n>4)){if(e>0&&qe===4)return void wm();qe=n,me()}}function um(e){z.buyer.type!==e&&(z.buyer.type=e,z.buyer.tin="",z.buyer.verified=!1,z.buyer.branchType="hq",z.buyer.branchNo="",me())}function mm(e){const n=xr()[e];if(!n)return;const a=Er(n),s=z.lines.find(o=>o.product_id===n.id);s?s.qty=(+s.qty||0)+1:z.lines.length===1&&!z.lines[0].desc&&!z.lines[0].price?z.lines[0]={desc:a,qty:1,price:n.unit_price,disc:0,vat:n.vat_applicable,product_id:n.id}:z.lines.push({desc:a,qty:1,price:n.unit_price,disc:0,vat:n.vat_applicable,product_id:n.id}),me()}function vm(e,n){z.lines[e].qty=Math.max(0,(+z.lines[e].qty||0)+n),+z.lines[e].qty==0&&z.lines.splice(e,1),z.lines.length||(z.lines=[{desc:"",qty:1,price:0,disc:0,vat:!0}]),me()}function fm(e){z.lines.splice(e,1),z.lines.length||(z.lines=[{desc:"",qty:1,price:0,disc:0,vat:!0}]),me()}const hm=[["tax_invoice_receipt","individual","paid","cash"],["tax_invoice","company","unpaid","transfer"],["tax_invoice_receipt","individual","paid","transfer"],["tax_invoice_simple","anonymous","paid","cash"]];function gm(e){const n=hm[e];if(!n)return;const[a,s,o,i]=n;z.docType=a,z.buyer={type:s,name:"",addr:"",tin:"",branchType:"hq",branchNo:""},z.pay={status:o,method:i,date:es(),paidAmt:null},qe=0,me()}async function bm(){const e=z.buyer;if(!e.tin)return showToast(C("rdNeedTin"),"error");if(e.type==="company"){if(!/^\d{13}$/.test(e.tin))return showToast(C("rdCo13"),"error");const n=await Gu(e.tin,0);if(!n.found)return showToast(C("lookupFail"),"error");n.name&&(e.name=n.name),n.address&&(e.addr=n.address),e.branchType="hq",e.branchNo="",e.verified=!0}else{if(!(await Uu(e.tin)).valid)return showToast(C("verifyFail"),"error");e.verified=!0}me()}async function ym(){if(!z.lines.some(n=>(n.desc||"").trim()))return showToast(C("needLines"),"error");const e=await _r(z);e.ok?(z.draftId=e.id||z.draftId,showToast(C("draftSaved"),"success"),window.dispatchEvent(new CustomEvent("pearnly:sales-changed"))):showToast(C("saveFail")+(e.error?" · "+e.error:""),"error")}async function wm(){const e=yr(z).filter(a=>a.req&&!a.pass);if(e.length)return showToast(C("blockers")+" "+e.map(a=>C(a.key)).join(", "),"error");if(!z.lines.some(a=>(a.desc||"").trim()))return showToast(C("needLines"),"error");const n=await Ku(z);n.ok&&n.id?(km(n.id),window.dispatchEvent(new CustomEvent("pearnly:sales-changed"))):showToast(C("issueFail")+(n.error?" · "+n.error:""),"error")}function km(e){ue().innerHTML=`<div class="sw-okwrap"><div class="sw-okbox">
        ...
        </div></div></div>`,ue().style.display="flex",document.getElementById("sw-ok-done").onclick=ts,document.getElementById("sw-ok-new").onclick=()=>{z=Ir(),qe=0,me()},document.getElementById("sw-ok-view").onclick=()=>{ts(),window.openSalesDetail&&window.openSalesDetail(e)}}window.openSalesWizard=async function(){z=Ir(),qe=0;const e=typeof currentLang<"u"&&currentLang||localStorage.getItem("mrpilot_lang")||"th";Qu(e),ue().innerHTML=`<div class="sw-wrap"><div class="sw-card"><div class="sx-state">${escapeHtml(C("s1h"))}…</div></div></div>`,ue().style.display="flex",await Vu(),me()};const xm=`
    <div class="cmdk">
...
`;$e("cmdk-mask",xm);(function(){function e(c){try{if(location.search.indexOf("test_center=1")>=0||localStorage.getItem("pearnly_test_mode")==="1"||c&&c.id&&String(c.id)==="468b50c1-5593-4fd6-990d-515ce8085563")return!0}catch{}return!1}window.applyRoleVisibility=function(){var u=window._userInfo,v=!1,f=!0,y=!1,b=!1;u&&(v=typeof canManageTeam=="function"?canManageTeam(u):!!(u.role==="owner"||u.is_super_admin),f=typeof shouldHideMoney=="function"?shouldHideMoney(u):u.role==="member"&&!u.is_super_admin,y=typeof isSuperAdmin=="function"?isSuperAdmin(u):!!u.is_super_admin,b=e(u)),document.querySelectorAll("[data-show-if-team]").forEach(function(g){g.style.display=v?"":"none"}),document.querySelectorAll("[data-show-if-money]").forEach(function(g){g.style.display=f?"none":""}),document.querySelectorAll("[data-show-if-admin]").forEach(function(g){g.style.display=y?"":"none"}),document.querySelectorAll("[data-show-if-test]").forEach(function(g){g.style.display=b?"":"none"});var h=y||b;document.querySelectorAll("[data-show-if-special]").forEach(function(g){g.style.display=h?"":"none"})},window.renderAvatarMenu=function(u){if(u){var v=document.getElementById("avatar-btn"),f=document.getElementById("avatar-popup-name"),y=document.getElementById("avatar-popup-email");if(!(!v||!f||!y)){var b=(u.username||"").trim(),h=b.split("@")[0]||b||"—",g=(b.charAt(0)||"?").toUpperCase(),_=(u.avatar_url||"").trim();if(_){var w=_.replace(/"/g,"&quot;"),k=g.replace(/'/g,"\\'");v.innerHTML='<img src="'+w+'" alt="'+g+`" referrerpolicy="no-referrer" onerror="this.parentNode.textContent='`+k+`'">`}else v.textContent=g;f.textContent=h,y.textContent=b||"—",v.setAttribute("title",b||"")}}};function n(){var c=document.getElementById("avatar-wrap"),u=document.getElementById("avatar-btn"),v=document.getElementById("avatar-popup");if(!c||!u||!v)return;function f(){v.classList.remove("show"),u.setAttribute("aria-expanded","false")}function y(){v.classList.add("show"),u.setAttribute("aria-expanded","true")}u.addEventListener("click",function(b){b.stopPropagation(),v.classList.contains("show")?f():y()}),document.addEventListener("click",function(b){v.classList.contains("show")&&!c.contains(b.target)&&f()}),v.addEventListener("click",function(b){var h=b.target.closest(".avatar-popup-item");if(h){var g=h.dataset.action;switch(f(),g){case"settings":typeof openSettingsModal=="function"?openSettingsModal():typeof routeTo=="function"&&routeTo("settings");break;case"team":typeof openSettingsModal=="function"?openSettingsModal():typeof routeTo=="function"&&routeTo("settings"),setTimeout(function(){typeof switchSettingsTab=="function"&&switchSettingsTab("team")},50);break;case"billing":typeof openSettingsModal=="function"?openSettingsModal():typeof routeTo=="function"&&routeTo("settings"),setTimeout(function(){typeof switchSettingsTab=="function"&&switchSettingsTab("plan")},50);break;case"shortcuts":if(typeof showToast=="function"){var _=typeof t=="function"?t("feature-coming-soon"):"即将上线";showToast(_||"即将上线","info")}break;case"admin":window.location.href="/admin/cost";break;case"test-center":typeof routeTo=="function"&&routeTo("test-center");break;case"help":var w=document.getElementById("help-modal");w&&(w.style.display="flex");break;case"logout":try{localStorage.removeItem("mrpilot_token")}catch{}try{localStorage.removeItem("mrpilot_user")}catch{}window.location.href="/";break}}}),window._closeAvatarPopup=f}function a(){return[].slice.call(document.querySelectorAll(".cmdk-item")).filter(function(c){return c.style.display!=="none"})}function s(c){var u=a();u.forEach(function(v){v.classList.remove("focus")}),u[c]&&(u[c].classList.add("focus"),u[c].scrollIntoView({block:"nearest"}))}function o(c){var u=a();if(u.length){var v=u.findIndex(function(y){return y.classList.contains("focus")});v<0&&(v=0);var f=(v+c+u.length)%u.length;s(f)}}function i(c){c=(c||"").toLowerCase().trim();var u=0,v=window._userInfo,f=typeof isSuperAdmin=="function"?isSuperAdmin(v):!!(v&&v.is_super_admin),y=e(v);document.querySelectorAll(".cmdk-item").forEach(function(h){if(h.dataset.showIfAdmin==="1"&&!f){h.style.display="none";return}if(h.dataset.showIfTest==="1"&&!y){h.style.display="none";return}var g=(h.dataset.cmdkText||h.textContent||"").toLowerCase(),_=!c||g.indexOf(c)>=0;h.style.display=_?"":"none",h.classList.remove("focus"),_&&u++}),document.querySelectorAll("[data-cmdk-section]").forEach(function(h){for(var g=h.nextElementSibling,_=!1;g&&!g.hasAttribute("data-cmdk-section");){if(g.classList&&g.classList.contains("cmdk-item")&&g.style.display!=="none"){_=!0;break}g=g.nextElementSibling}h.style.display=_?"":"none"});var b=document.getElementById("cmdk-empty");b&&(b.style.display=u===0?"flex":"none"),s(0)}window.openCmdk=function(){var u=document.getElementById("cmdk-mask");u&&(typeof window._closeAvatarPopup=="function"&&window._closeAvatarPopup(),u.classList.add("show"),typeof window.applyRoleVisibility=="function"&&window.applyRoleVisibility(),setTimeout(function(){var v=document.getElementById("cmdk-input");v&&(v.value="",i(""),v.focus(),s(0))},50))},window.closeCmdk=function(){var u=document.getElementById("cmdk-mask");u&&u.classList.remove("show")};function r(c){if(c){if(c.classList.contains("cmdk-item-locked")){if(typeof showToast=="function"){var u=typeof t=="function"?t("feature-coming-soon"):"即将上线";showToast(u||"即将上线","info")}return}var v=c.dataset.cmdkRoute,f=c.dataset.cmdkAction;if(window.closeCmdk(),v){typeof routeTo=="function"&&routeTo(v);return}if(f){if(f==="open-admin"){window.location.href="/admin/cost";return}if(f.indexOf("lang-")===0){var y=f.slice(5);typeof applyLang=="function"&&applyLang(y)}}}}function l(){var c=document.getElementById("cmdk-mask"),u=document.getElementById("cmdk-input"),v=document.getElementById("cmdk-body");if(!(!c||!u||!v)){c.addEventListener("click",function(b){b.target===c&&window.closeCmdk()});var f=document.getElementById("cmdk-esc-btn");f&&f.addEventListener("click",function(){window.closeCmdk()}),u.addEventListener("input",function(b){i(b.target.value)}),u.addEventListener("keydown",function(b){b.key==="ArrowDown"?(b.preventDefault(),o(1)):b.key==="ArrowUp"?(b.preventDefault(),o(-1)):b.key==="Enter"?(b.preventDefault(),r(c.querySelector(".cmdk-item.focus"))):b.key==="Escape"&&(b.preventDefault(),window.closeCmdk())}),v.addEventListener("click",function(b){var h=b.target.closest(".cmdk-item");h&&r(h)}),v.addEventListener("mousemove",function(b){var h=b.target.closest(".cmdk-item");!h||h.style.display==="none"||h.classList.contains("cmdk-item-locked")||(a().forEach(function(g){g.classList.remove("focus")}),h.classList.add("focus"))});var y=document.getElementById("topbar-search");y&&(y.addEventListener("click",function(){window.openCmdk()}),y.addEventListener("keydown",function(b){(b.key==="Enter"||b.key===" ")&&(b.preventDefault(),window.openCmdk())}))}}document.addEventListener("keydown",function(c){if((c.metaKey||c.ctrlKey)&&(c.key==="k"||c.key==="K")){c.preventDefault(),window.openCmdk();return}if(c.key==="Escape"){var u=document.getElementById("cmdk-mask");if(u&&u.classList.contains("show")){window.closeCmdk();return}var v=document.getElementById("avatar-popup");v&&v.classList.contains("show")&&typeof window._closeAvatarPopup=="function"&&window._closeAvatarPopup()}});try{var m=(navigator.userAgent||"").toLowerCase(),d=m.indexOf("mac")>=0||m.indexOf("iphone")>=0||m.indexOf("ipad")>=0;d||document.body.classList.add("is-windows")}catch{}function p(){n(),l(),typeof window.subscribeI18n=="function"&&window.subscribeI18n("nav-ia-phase1-role",function(){try{typeof window.applyRoleVisibility=="function"&&window.applyRoleVisibility()}catch{}})}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",p):p()})();(function(){function n(f){return String(f??"").replace(/[&<>"']/g,function(y){return{"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"}[y]})}function a(f){if(!f||isNaN(f))return"";var y=Number(f);return y<1024?y+" B":y<1024*1024?(y/1024).toFixed(1)+" KB":(y/1024/1024).toFixed(1)+" MB"}document.addEventListener("click",function(f){var y=f.target.closest&&f.target.closest(".recon-collapse-head");if(y&&!(f.target.closest("button")||f.target.closest("a"))){var b=y.closest(".recon-collapse");if(b){var h=b.getAttribute("data-collapsed")==="true";b.setAttribute("data-collapsed",h?"false":"true"),h&&(b.id==="vex-summary-collapse"&&p(),b.id==="vex-detail-collapse"&&c())}}}),document.addEventListener("keydown",function(f){if(!(f.key!=="Enter"&&f.key!==" ")){var y=f.target.closest&&f.target.closest(".recon-collapse-head");y&&(f.preventDefault(),y.click())}});var s={vat:"",gl:""};window._glvClearPreviewSearch=function(){s.vat="",s.gl=""};var o='<svg class="vex-pp-fi-icon" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#111111" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/></svg>',i='<svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg>';function r(){m("vat"),m("gl")}function l(f){try{if(typeof window._glvPreviewFiles=="function")return window._glvPreviewFiles(f)||[]}catch{}var y=document.getElementById(f==="vat"?"glv-vat-input":"glv-gl-input");return y&&y.files?Array.from(y.files):[]}function m(f){var y=document.getElementById(f==="vat"?"glv-pp-vat-col":"glv-pp-gl-col");if(y){var b=l(f),h=f==="vat"?"glv-up-vat-title":"glv-up-gl-title",g=f==="vat"?"① 销项税报告":"② 总账 GL",_=window.t&&window.t(h)||g,w=n(window.t&&window.t("vex-preview-search")||"搜索文件名..."),k=n(window.t&&window.t("vex-preview-clear-all")||"全清"),x=s[f]||"",E=b.length;y.innerHTML='<div class="vex-pp-col-title"><span class="vex-pp-col-name">'+n(_)+' <span class="vex-pp-col-count">'+E+'</span></span></div><div class="vex-pp-search-row"><input class="vex-pp-search" id="glv-pp-search-'+f+'" type="text" placeholder="'+w+'" value="'+n(x)+'" autocomplete="off"><button class="vex-pp-clear-btn" id="glv-pp-clearall-'+f+'" type="button">'+k+'</button></div><div class="vex-pp-file-list" id="glv-pp-'+f+'-list"></div><div class="vex-pp-pagination" id="glv-pp-'+f+'-pg"></div>';var I=document.getElementById("glv-pp-search-"+f);I&&I.addEventListener("input",function(L){s[f]=L.target.value,d(f)});var B=document.getElementById("glv-pp-clearall-"+f);B&&B.addEventListener("click",function(){window._glvRemoveFile&&window._glvRemoveFile(f)}),d(f)}}function d(f){var y=document.getElementById("glv-pp-"+f+"-list"),b=document.getElementById("glv-pp-"+f+"-pg");if(y){var h=l(f),g=(s[f]||"").toLowerCase(),_=h.map(function(x,E){return{f:x,i:E}}),w=g?_.filter(function(x){return x.f.name.toLowerCase().indexOf(g)>=0}):_;if(y.innerHTML=w.map(function(x){var E=x.f;return'<div class="vex-pp-file-row">'+o+'<span class="vex-pp-fi-name" title="'+n(E.name)+'">'+n(E.name)+'</span><span class="vex-pp-fi-size">'+a(E.size)+'</span><button class="vex-pp-fi-del" type="button" data-kind="'+f+'" data-idx="'+x.i+'" aria-label="remove">'+i+"</button></div>"}).join(""),y.querySelectorAll(".vex-pp-fi-del").forEach(function(x){x.addEventListener("click",function(){var E=x.dataset.kind,I=parseInt(x.dataset.idx,10);window._glvRemoveFile&&window._glvRemoveFile(E,isNaN(I)?null:I)})}),b){var k=window.t&&window.t("vex-preview-count")||"显示前 {n} / 共 {m}";b.textContent=k.replace("{n}",w.length).replace("{m}",w.length)}}}function p(){var f=function(b,h){var g=document.getElementById(b);g&&(g.textContent=h==null?"—":String(h))},y=window._vexLastTask||{};f("vex-sum-total",y.total),f("vex-sum-matched",y.matched),f("vex-sum-diff",y.diff),f("vex-sum-incomplete",y.incomplete),f("vex-sum-cash",y.cash),document.getElementById("vex-summary-sub")}function c(){var f=window._vexLastTask&&window._vexLastTask.diff_rows||[],y=document.getElementById("vex-detail-tbody"),b=document.getElementById("vex-detail-table"),h=document.getElementById("vex-detail-empty");if(!(!y||!b||!h)){if(f.length===0){b.style.display="none",h.style.display="";return}h.style.display="none",b.style.display="";var g=f.map(function(w){return'<tr><td class="recon-detail-cell-mono">'+n(w.invoice_no||"")+"</td><td>"+n(w.field||"")+"</td><td>"+n(w.report_value||"")+"</td><td>"+n(w.invoice_value||"")+"</td><td>"+n(w.kind||"")+"</td></tr>"}).join("");y.innerHTML=g;var _=document.getElementById("vex-detail-sub");_&&(_.textContent=String(f.length))}}function u(){var f=document.getElementById("glv-toggle-preview");f&&!f._reconBound&&(f._reconBound=!0,f.addEventListener("click",function(){var y=document.getElementById("glv-preview-panel"),b=document.getElementById("glv-toggle-preview-label"),h=y&&y.style.display!=="none";y&&(y.style.display=h?"none":""),f.classList.toggle("open",!h),b&&(b.textContent=h?window.t&&window.t("vex-toggle-preview-open")||"查看清单":window.t&&window.t("vex-toggle-preview-close")||"收起清单"),h||r()})),["glv-vat-input","glv-gl-input"].forEach(function(y){var b=document.getElementById(y);!b||b._reconWatched||(b._reconWatched=!0,b.addEventListener("change",function(){var h=document.getElementById("glv-preview-panel");h&&h.style.display!=="none"&&r()}))})}function v(){var f=document.getElementById("vex-summary-collapse"),y=document.getElementById("vex-detail-collapse");f&&(f.style.display=""),y&&(y.style.display=""),p(),c()}window._fillVexSummary=p,window._fillVexDetail=c,window._onVexResultShown=v,document.addEventListener("DOMContentLoaded",function(){u()}),setTimeout(u,1500),typeof window.subscribeI18n=="function"&&window.subscribeI18n("recon-collapse",function(){var f=document.getElementById("glv-preview-panel");f&&f.style.display!=="none"&&r();var y=document.getElementById("glv-toggle-preview-label"),b=document.getElementById("glv-toggle-preview");y&&b&&(y.textContent=b.classList.contains("open")?window.t&&window.t("vex-toggle-preview-close")||"收起清单":window.t&&window.t("vex-toggle-preview-open")||"查看清单")}),window._reconCollapse={renderGlvPreview:r,fillVexSummary:p,fillVexDetail:c}})();(function(){function e(i){}function n(){const i=document.querySelectorAll("[data-recon-tab]");i.forEach(l=>{l.addEventListener("click",()=>{i.forEach(u=>u.classList.remove("active")),l.classList.add("active");const m=l.dataset.reconTab,d=document.getElementById("recon-pane-bank"),p=document.getElementById("recon-pane-sale-vat"),c=document.getElementById("recon-pane-gl-vat");d&&(d.style.display=m==="bank"?"":"none"),p&&(p.style.display=m==="sale-vat"?"":"none"),c&&(c.style.display=m==="gl-vat"?"":"none"),m==="gl-vat"&&window.GlVatRecon&&window.GlVatRecon.ensureInit(),m==="bank"&&typeof window._bankReconV2Init=="function"&&window._bankReconV2Init()})});const r=document.querySelector("[data-recon-tab].active");r&&(r.dataset.reconTab,void 0)}function a(){const i=document.getElementById("page-settings");if(!i)return null;let r=document.getElementById("settings-modal-overlay");if(r)return r;r=document.createElement("div"),r.id="settings-modal-overlay",r.className="settings-modal-overlay",r.style.display="none",i.parentElement.insertBefore(r,i),r.appendChild(i);const l=document.createElement("button");return l.id="settings-modal-close",l.className="settings-modal-close",l.setAttribute("aria-label","close"),l.innerHTML='<svg viewBox="0 0 20 20" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M5 5l10 10M15 5L5 15"/></svg>',i.insertBefore(l,i.firstChild),l.addEventListener("click",o),r.addEventListener("click",m=>{m.target===r&&o()}),r}function s(){const i=a();if(!i)return;i.style.display="flex",document.body.classList.add("settings-modal-open");const r=document.getElementById("page-settings");r&&(r.style.display="block"),setTimeout(()=>{try{typeof renderSettings=="function"&&renderSettings()}catch(m){console.warn("renderSettings:",m)}let l=document.querySelector(".settings-tab.active")||document.querySelector('.settings-tab[data-tab="profile"]');l&&l.click()},50)}function o(){const i=document.getElementById("settings-modal-overlay");i&&(i.style.display="none"),document.body.classList.remove("settings-modal-open")}window.openSettingsModal=s,window.closeSettingsModal=o,document.addEventListener("keydown",i=>{if(i.key==="Escape"){const r=document.getElementById("settings-modal-overlay");r&&r.style.display==="flex"&&o()}}),window.addEventListener("hashchange",()=>{location.hash==="#/settings"&&s()}),window.addEventListener("DOMContentLoaded",()=>{location.hash==="#/settings"&&s()}),document.readyState==="loading"?document.addEventListener("DOMContentLoaded",n):n()})();const Aa=1e3,ja=30,Gs=/\.(pdf|jpe?g|png|webp|tiff?|xlsx?|xlsm|csv|tsv|docx?)$/i,te=e=>document.getElementById(e);function At(){return{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||"")}}function He(e){const n={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"};return String(e??"").replace(/[&<>"']/g,a=>n[a])}function Br(e){return e<1024?e+" B":e<1024*1024?(e/1024).toFixed(1)+" KB":(e/1024/1024).toFixed(1)+" MB"}const A={invoiceFiles:[],reportFiles:[],running:!1,vexAllRows:[],previewLimitInv:50,previewLimitRep:50,previewSearchInv:"",previewSearchRep:"",vexPage:1};async function Vn(){try{const e=await fetch("/api/vat_excel/tasks?page=1&page_size=1",{headers:At()});if(!e.ok)return;const a=(await e.json()).kpi||{};[["vex-kpi-month-val",a.this_month],["vex-kpi-running-val",a.running],["vex-kpi-done-val",a.done],["vex-kpi-failed-val",a.failed]].forEach(([s,o])=>{const i=document.getElementById(s);i&&(i.textContent=o??0)})}catch{}}async function Un(){try{const e=await fetch("/api/vat_excel/tasks?page=1&page_size=100",{headers:At()});if(!e.ok)return;const n=await e.json();sa(n.rows||[])}catch{}}const Ot=10;function Lr(){var e=((document.getElementById("vex-task-search")||{}).value||"").trim().toLowerCase();if(A.vexPage=1,sa(A.vexAllRows),!!e){var n=document.getElementById("vex-task-tbody");n&&n.querySelectorAll("tr").forEach(function(a){a.dataset.taskId&&(a.style.display=a.textContent.toLowerCase().indexOf(e)>=0?"":"none")})}}function sa(e){A.vexAllRows=e||A.vexAllRows;const n=document.getElementById("vex-task-tbody");if(!n)return;if(!A.vexAllRows.length){n.innerHTML='<tr><td colspan="9" class="vex-task-empty">'+(t("sv-empty-title")||"还没有对账任务")+"</td></tr>",Wo(0);return}const a=Math.ceil(A.vexAllRows.length/Ot);A.vexPage>a&&(A.vexPage=a);const s=(A.vexPage-1)*Ot;_m(A.vexAllRows.slice(s,s+Ot)),Wo(A.vexAllRows.length)}function Wo(e){const n=document.getElementById("vex-task-pager"),a=document.getElementById("vex-task-pager-info"),s=document.getElementById("vex-task-prev"),o=document.getElementById("vex-task-next");if(!n)return;if(e<=Ot){n.style.display="none";return}n.style.display="";const i=Math.ceil(e/Ot);a&&(a.textContent=A.vexPage+" / "+i),s&&(s.disabled=A.vexPage<=1),o&&(o.disabled=A.vexPage>=i)}function _m(e){const n=document.getElementById("vex-task-tbody");if(!n)return;const a={pending:t("vex-status-pending")||"待处理",running:t("vex-status-running")||"处理中",done:t("vex-status-done")||"已完成",failed:t("vex-status-failed")||"失败"},s={pending:"badge-gray",running:"badge-blue",done:"badge-green",failed:"badge-red"},o='<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M8 2v9M4 7l4 4 4-4M3 14h10"/></svg>',i='<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M3 4h10M6 4V3h4v1M5 4v8a1 1 0 001 1h4a1 1 0 001-1V4"/></svg>';n.innerHTML=e.map(r=>{const l=r.created_at?new Date(r.created_at).toLocaleString([],{year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",minute:"2-digit"}):"—",m=r.period||"—",d=r.matched_count!=null?r.matched_count+" ✓ · "+r.mismatched_count+" ⚠":"—",p=r.mismatch_amount!=null?"฿ "+Number(r.mismatch_amount).toLocaleString():"—",c=r.elapsed_seconds!=null?r.elapsed_seconds.toFixed(1)+" s":"—",u=r.status||"pending",v=r.client_name&&r.client_name!=="client"?r.client_name:t("vex-client-all")||"全部客户";return`<tr class="vex-task-row" data-task-id="${He(r.id)}" style="cursor:pointer">
            ...
            <td><div class="vex-task-actions">
                <button class="vex-task-dl-btn" data-task-id="${He(r.id)}" title="${t("hist_export")||"导出"}">${o}</button>
                <button class="vex-task-del-btn" data-task-id="${He(r.id)}" title="${t("vex-task-delete-confirm-title")||"删除"}">${i}</button>
            </div></td>
        </tr>`}).join(""),n.querySelectorAll(".vex-task-dl-btn").forEach(r=>{r.addEventListener("click",async l=>{l.stopPropagation();const m=r.dataset.taskId;try{const d=await fetch("/api/vat_excel/tasks/"+encodeURIComponent(m)+"/download",{credentials:"include",headers:At()});if(d.status===410){showToast(t("vex-toast-expired")||"数据已过期 · 请重新对账","warn");return}if(!d.ok){showToast(t("vex-toast-dl-fail")||"下载失败 · 请重试","error");return}const p=await d.blob(),u=(d.headers.get("Content-Disposition")||"").match(/filename\*?=(?:UTF-8''|")?([^";]+)/i),v=u?decodeURIComponent(u[1]):"vat_recon_"+m+".xlsx",f=URL.createObjectURL(p),y=document.createElement("a");y.href=f,y.download=v,y.click(),setTimeout(()=>URL.revokeObjectURL(f),1e3)}catch{showToast(t("vex-toast-dl-fail")||"下载失败 · 请重试","error")}})}),n.querySelectorAll(".vex-task-del-btn").forEach(r=>{r.addEventListener("click",l=>{l.stopPropagation(),Im(r.dataset.taskId)})}),Lr()}function Em(){var e=document.getElementById("vex-task-prev"),n=document.getElementById("vex-task-next");e&&!e._vexBound&&(e._vexBound=!0,e.addEventListener("click",function(){A.vexPage>1&&(A.vexPage--,sa())})),n&&!n._vexBound&&(n._vexBound=!0,n.addEventListener("click",function(){var a=Math.ceil(A.vexAllRows.length/Ot);A.vexPage<a&&(A.vexPage++,sa())}))}async function Im(e){const n=t("vex-task-delete-confirm-title")||"删除对账任务?",a=t("vex-task-delete-confirm-body")||"同时清掉对应的发票识别缓存 · 不可恢复";if(await showConfirm(a,{title:n,danger:!0,okText:t("vex-task-delete-confirm-title")||"确认删除"}))try{const o=await fetch("/api/vat_excel/tasks/"+encodeURIComponent(e),{method:"DELETE",credentials:"include",headers:At()});if(!o.ok)throw new Error(o.status);showToast(t("vex-task-delete-ok")||"已删除","success"),Un(),Vn()}catch{showToast(t("vex-task-delete-fail")||"删除失败","error")}}function $r(e){const n=window._currentLang||"th",a={zh:`已忽略 ${e} 个不支持的文件 · 仅支持 PDF / 图片 / Excel / CSV / Word`,th:`ข้ามไฟล์ที่ไม่รองรับ ${e} ไฟล์ · รองรับเฉพาะ PDF / รูปภาพ / Excel / CSV / Word`,en:`Ignored ${e} unsupported file(s) · only PDF / image / Excel / CSV / Word are supported`,ja:`非対応ファイル ${e} 件をスキップ · 対応形式は PDF / 画像 / Excel / CSV / Word のみ`};showToast(a[n]||a.th,"warn")}function Bm(e){const n=new Set(A.invoiceFiles.map(s=>s.name+"|"+s.size));let a=0;for(const s of e){if(!Gs.test(s.name)){a++;continue}const o=s.name+"|"+s.size;if(!n.has(o)&&(n.add(o),A.invoiceFiles.push(s),A.invoiceFiles.length>=Aa))break}a>0&&$r(a),A.invoiceFiles.length>Aa&&(A.invoiceFiles=A.invoiceFiles.slice(0,Aa),showToast(t("vex-toast-cap-inv"),"warn")),bt()}function Lm(e){const n=new Set(A.reportFiles.map(s=>s.name+"|"+s.size));let a=0;for(const s of e){if(!Gs.test(s.name)){a++;continue}const o=s.name+"|"+s.size;if(!n.has(o)&&(n.add(o),A.reportFiles.push(s),A.reportFiles.length>=ja))break}a>0&&$r(a),A.reportFiles.length>ja&&(A.reportFiles=A.reportFiles.slice(0,ja),showToast(t("vex-toast-cap-rep"),"warn")),bt()}function Sr(e){A.invoiceFiles.splice(e,1),bt()}function Cr(e){A.reportFiles.splice(e,1),bt()}function bt(){const e=te("vex-list-invoice"),n=te("vex-list-report"),a=te("vex-count-invoice"),s=te("vex-count-report");a&&(a.textContent=A.invoiceFiles.length),s&&(s.textContent=A.reportFiles.length);const o=(l,m,d)=>`<div class="vex-fi">
        ...
        <table style="width:100%;border-collapse:collapse;font-size:12px;margin-bottom:4px">
          ...
          <td>${l?"L"+l:"—"}</td>
        </tr>`}).join("")}async function bn(){const e=localStorage.getItem("mrpilot_token")||"";try{const a=await(await fetch("/api/recon/bank-v2/tasks",{headers:{Authorization:"Bearer "+e}})).json();ra(a.tasks||[])}catch{const a=j("brv2-history-empty"),s=window._currentLang||"zh",o={zh:"加载失败",th:"โหลดประวัติไม่ได้",en:"Load failed",ja:"読み込み失敗"}[s]||"加载失败";a&&(a.textContent=o,a.style.display="");const i=j("brv2-history-table-wrap");i&&(i.style.display="none")}}const Ut=10;function Qo(){const e=j("brv2-history-pager"),n=j("brv2-history-pager-info"),a=j("brv2-history-prev"),s=j("brv2-history-next");if(!e)return;if(P.cachedHistoryTasks.length<=Ut){e.style.display="none";return}e.style.display="";const o=Math.ceil(P.cachedHistoryTasks.length/Ut);n&&(n.textContent=P.brv2Page+" / "+o),a&&(a.disabled=P.brv2Page<=1),s&&(s.disabled=P.brv2Page>=o)}function vv(){const e=j("brv2-history-prev"),n=j("brv2-history-next");e&&!e._brv2Bound&&(e._brv2Bound=!0,e.addEventListener("click",()=>{P.brv2Page>1&&(P.brv2Page--,ra(P.cachedHistoryTasks))})),n&&!n._brv2Bound&&(n._brv2Bound=!0,n.addEventListener("click",()=>{const a=Math.ceil(P.cachedHistoryTasks.length/Ut);P.brv2Page<a&&(P.brv2Page++,ra(P.cachedHistoryTasks))}))}function ra(e){e!==void 0&&(P.cachedHistoryTasks=e||[],P.brv2Page=1);const n=P.cachedHistoryTasks,a=j("brv2-history-empty"),s=j("brv2-history-table-wrap"),o=j("brv2-history-tbody");if(!o)return;const i=window._currentLang||"zh";if(!n.length){const v={zh:"暂无对账记录",th:"ยังไม่มีประวัติ",en:"No records yet",ja:"記録なし"}[i]||"暂无对账记录";a&&(a.textContent=v,a.style.display=""),s&&(s.style.display="none"),Qo();return}a&&(a.style.display="none"),s&&(s.style.display="");const r=Math.ceil(n.length/Ut);P.brv2Page>r&&(P.brv2Page=r);const l=(P.brv2Page-1)*Ut,m=n.slice(l,l+Ut),d=localStorage.getItem("mrpilot_token")||"",p='<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" width="14" height="14"><circle cx="8" cy="8" r="6"/><polyline points="6 8 8 10 10 8"/><line x1="8" y1="4" x2="8" y2="10"/></svg>',c='<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" width="14" height="14"><path d="M8 2v9M4 7l4 4 4-4M3 14h10"/></svg>',u='<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" width="14" height="14"><polyline points="3 4 13 4"/><path d="M6 4V2.5a.5.5 0 0 1 .5-.5h3a.5.5 0 0 1 .5.5V4"/><path d="M5 4l1 9a1 1 0 0 0 1 1h2a1 1 0 0 0 1-1l1-9"/></svg>';o.innerHTML="",m.forEach(v=>{const f=Number(v.formula_diff||0),y=Math.abs(f)<.05,b=(v.stmt_files||"").split(";").map(ce=>ce.trim().split(/[/\\]/).pop()).filter(Boolean).join(", "),h=(v.gl_files||"").split(";").map(ce=>ce.trim().split(/[/\\]/).pop()).filter(Boolean).join(", "),g=v.created_at?String(v.created_at).slice(0,16).replace("T"," "):"",_=document.createElement("tr");_.dataset.taskId=v.id;const w=document.createElement("td");w.textContent=g;const k=document.createElement("td");k.className="glv-history-file",k.title=b+" + "+h,k.textContent=b+" + "+h;const x=document.createElement("td");x.className="glv-num",x.textContent=(v.stmt_row_count||0)+" / "+(v.gl_row_count||0);const E=document.createElement("td");E.className="glv-num",E.textContent=v.matched_count||0;const I=document.createElement("td");I.className="glv-num",I.textContent=v.unmatched_gl||0;const B=document.createElement("td");B.className="glv-num",B.textContent=v.unmatched_stmt||0;const L=document.createElement("td");L.className="glv-num",L.style.color=y?"#059669":"#dc2626",L.textContent=y?"✓":ut(f);const $=document.createElement("td");$.className="glv-history-actions";const S=(ce,Ee,ke,V)=>{const O=document.createElement("button");return O.type="button",O.title=Ee,O.setAttribute("aria-label",Ee),ke&&(O.className=ke),O.innerHTML=ce,O.onclick=Y=>{Y.stopPropagation(),V()},O},M={zh:"删除这条记录?",th:"ลบรายการนี้?",en:"Delete this record?",ja:"この記録を削除しますか?"}[i]||"删除?",R={zh:"加载",th:"โหลด",en:"Load",ja:"読込"}[i]||"加载",G={zh:"导出",th:"ส่งออก",en:"Export",ja:"エクスポート"}[i]||"导出",se={zh:"删除",th:"ลบ",en:"Delete",ja:"削除"}[i]||"删除";$.appendChild(S(p,R,"",()=>ei(v.id,d))),$.appendChild(S(c,G,"",()=>Pr(v.id))),$.appendChild(S(u,se,"glv-del",async()=>{await showConfirm(M,{danger:!0})&&(await fetch("/api/recon/bank-v2/"+v.id,{method:"DELETE",headers:{Authorization:"Bearer "+d}}),bn())})),[w,k,x,E,I,B,L,$].forEach(ce=>_.appendChild(ce)),_.style.cursor="pointer",_.addEventListener("click",async ce=>{ce.target.closest(".glv-del")||ce.target.closest("button")||await ei(v.id,d)}),o.appendChild(_)}),Qo(),qr()}function qr(){const e=((j("brv2-hist-search")||{}).value||"").trim().toLowerCase(),n=j("brv2-history-tbody");n&&n.querySelectorAll("tr").forEach(a=>{a.dataset.taskId&&(a.style.display=!e||a.textContent.toLowerCase().includes(e)?"":"none")})}async function ei(e,n){try{const s=await(await fetch("/api/recon/bank-v2/"+e,{headers:{Authorization:"Bearer "+n}})).json();if(!s.ok)return;P.currentTask={task_id:s.task_id,...s},P.allRows=s.detail||[],P.currentFilter="all",document.querySelectorAll(".brv2-filter-btn").forEach(o=>o.classList.toggle("active",o.dataset.filter==="all")),Js(P.currentTask)}catch{}}function Je(e){const n=e==="stmt"?P.stmtFiles:P.glFiles,a=j(`brv2-${e}-name`);if(a)if(n.length===0)a.textContent="";else{const o=window._currentLang||"zh",i={zh:"个文件",th:" ไฟล์",en:" file(s)",ja:" ファイル"};a.textContent=n.length+(i[o]||" 个文件")}const s=j("brv2-preview-panel");s&&s.style.display!=="none"&&ss(e),fv()}function fv(){const e=j("brv2-toggle-preview"),n=j("brv2-preview-panel"),a=P.stmtFiles.length+P.glFiles.length>0;e&&(e.style.display=a?"":"none"),!a&&n&&(n.style.display="none",e&&e.classList.remove("open"))}function hv(){ss("stmt"),ss("gl")}function ss(e){const n=j(e==="stmt"?"brv2-pp-stmt-col":"brv2-pp-gl-col");if(!n)return;const a=e==="stmt"?P.stmtFiles:P.glFiles,s=window._currentLang||"zh",o={stmt:{zh:"① 银行账单",th:"① บัญชีธนาคาร",en:"① Bank Stmt",ja:"① 銀行明細"},gl:{zh:"② 总账 GL",th:"② GL รายงาน",en:"② GL Report",ja:"② GL帳簿"}},i=(o[e]||{})[s]||o[e].zh,r=pe(window.t&&window.t("vex-preview-search")||"搜索文件名..."),l=pe(window.t&&window.t("vex-preview-clear-all")||"全清"),m=P.brv2Search[e]||"";n.innerHTML='<div class="vex-pp-col-title"><span class="vex-pp-col-name">'+pe(i)+' <span class="vex-pp-col-count">'+a.length+'</span></span></div><div class="vex-pp-search-row"><input class="vex-pp-search" id="brv2-pp-search-'+e+'" type="text" placeholder="'+r+'" value="'+pe(m)+'" autocomplete="off"><button class="vex-pp-clear-btn" id="brv2-pp-clearall-'+e+'" type="button">'+l+'</button></div><div class="vex-pp-file-list" id="brv2-pp-'+e+'-list"></div><div class="vex-pp-pagination" id="brv2-pp-'+e+'-pg"></div>';const d=j("brv2-pp-search-"+e);d&&d.addEventListener("input",function(c){P.brv2Search[e]=c.target.value,ti(e)});const p=j("brv2-pp-clearall-"+e);p&&p.addEventListener("click",function(){e==="stmt"?P.stmtFiles.length=0:P.glFiles.length=0,Je(e),mt()}),ti(e)}function ti(e){const n=j("brv2-pp-"+e+"-list"),a=j("brv2-pp-"+e+"-pg");if(!n)return;const s=e==="stmt"?P.stmtFiles:P.glFiles,o=(P.brv2Search[e]||"").toLowerCase(),i=o?s.filter(m=>m.name.toLowerCase().includes(o)):s.slice(),r='<svg class="vex-pp-fi-ico" viewBox="0 0 14 16" fill="none" stroke="currentColor" stroke-width="1.4" width="12" height="14"><path d="M3 1h6l3 3v11H3V1z"/><path d="M9 1v3h3"/></svg>',l='<svg viewBox="0 0 14 14" fill="none" stroke="currentColor" stroke-width="1.6" width="11" height="11"><path d="M2 4h10M5 4V2h4v2M5.5 7v4M8.5 7v4M3 4l1 8h6l1-8"/></svg>';if(n.innerHTML=i.map((m,d)=>'<div class="vex-pp-file-row">'+r+'<span class="vex-pp-fi-name" title="'+pe(m.name)+'">'+pe(m.name)+'</span><span class="vex-pp-fi-size">'+ov(m.size)+'</span><button class="vex-pp-fi-del" type="button" data-zone="'+e+'" data-idx="'+s.indexOf(m)+'" aria-label="remove">'+l+"</button></div>").join(""),n.querySelectorAll(".vex-pp-fi-del").forEach(function(m){m.addEventListener("click",function(){const d=parseInt(m.dataset.idx,10);m.dataset.zone==="stmt"?P.stmtFiles.splice(d,1):P.glFiles.splice(d,1),Je(m.dataset.zone),mt()})}),a){const m=window.t&&window.t("vex-preview-count")||"显示 {n} / 共 {m}";a.textContent=m.replace("{n}",i.length).replace("{m}",s.length)}}function gv(){const e=j("brv2-toggle-preview");e&&!e._reconBound&&(e._reconBound=!0,e.addEventListener("click",function(){const n=j("brv2-preview-panel"),a=j("brv2-toggle-preview-label"),s=n&&n.style.display!=="none";n&&(n.style.display=s?"none":""),e.classList.toggle("open",!s),a&&(a.textContent=s?window.t&&window.t("vex-toggle-preview-open")||"查看清单":window.t&&window.t("vex-toggle-preview-close")||"收起清单"),s||hv()}))}function mt(){const e=j("brv2-run-btn"),n=j("brv2-status"),a=P.stmtFiles.length>0,s=P.glFiles.length>0;if(e&&(e.disabled=!(a&&s)),n){const o=window._currentLang||"zh";if(!a&&!s){const i={zh:"请上传银行账单和 GL 文件",th:"กรุณาอัปโหลดบัญชีธนาคารและ GL",en:"Upload bank statement and GL files",ja:"銀行明細と GL を両方アップロードしてください"};n.textContent=i[o]||i.zh}else if(a)if(s){const i={zh:"两份文件已就绪",th:"พร้อมสอบทาน",en:"Ready to reconcile",ja:"照合を開始できます"};n.textContent=i[o]||i.zh}else{const i={zh:"还缺 GL 文件",th:"ยังขาดไฟล์ GL",en:"Missing GL file",ja:"GL ファイルが未アップロード"};n.textContent=i[o]||i.zh}else{const i={zh:"还缺银行账单 PDF",th:"ยังขาดไฟล์บัญชีธนาคาร PDF",en:"Missing bank statement PDF",ja:"銀行明細 PDF が未アップロード"};n.textContent=i[o]||i.zh}}}function ni(e,n,a){const s=j(e),o=j(n);!s||!o||(s.addEventListener("click",()=>o.click()),s.addEventListener("keydown",i=>{(i.key==="Enter"||i.key===" ")&&(i.preventDefault(),o.click())}),s.addEventListener("dragover",i=>{i.preventDefault(),s.classList.add("drag-over")}),s.addEventListener("dragleave",()=>s.classList.remove("drag-over")),s.addEventListener("drop",i=>{i.preventDefault(),s.classList.remove("drag-over");const r=Array.from(i.dataTransfer.files||[]);a==="stmt"?P.stmtFiles.push(...r):P.glFiles.push(...r),Je(a),mt()}),o.addEventListener("change",()=>{const i=Array.from(o.files||[]);a==="stmt"?P.stmtFiles.push(...i):P.glFiles.push(...i),o.value="",Je(a),mt()}))}function Ae(e){const n=j("brv2-progress"),a=j("brv2-run-btn"),s=j("brv2-error");n&&(n.style.display=e?"":"none"),a&&(a.disabled=e),s&&(s.style.display="none")}function Ye(e){const n=j("brv2-error");n&&(n.textContent=e,n.style.display="",n.scrollIntoView({behavior:"smooth",block:"nearest"})),Ae(!1),mt(),window.showToast&&window.showToast(e,"error")}async function os(){if(P.stmtFiles.length===0||P.glFiles.length===0)return;const e=localStorage.getItem("mrpilot_token")||"",n=window._currentLang||"zh",a=(j("brv2-acct-select")||{}).value||"";ia(!1),Ae(!0);try{const s=new FormData;P.stmtFiles.forEach(v=>s.append("stmt_files",v)),P.glFiles.forEach(v=>s.append("gl_files",v)),s.append("gl_account",a),s.append("lang",n);const o=parseFloat((j("brv2-anchor-gl-closing")||{}).value),i=parseFloat((j("brv2-anchor-stmt-closing")||{}).value),r=parseFloat((j("brv2-anchor-stmt-opening")||{}).value),l=parseFloat((j("brv2-anchor-gl-opening")||{}).value);Number.isFinite(o)&&s.append("gl_closing_override",o),Number.isFinite(i)&&s.append("stmt_closing_override",i),Number.isFinite(r)&&s.append("stmt_opening_override",r),Number.isFinite(l)&&s.append("gl_opening_override",l);const m=await fetch("/api/recon/bank-v2/submit",{method:"POST",headers:{Authorization:"Bearer "+e},body:s});let d=null;try{d=await m.json()}catch{d=null}if(d&&d.needs_mapping){Ae(!1),window.ReconMapping?window.ReconMapping.show(d,{token:e,lang:n,onConfirmed:function(){os()}}):Ye(t("brv2-err-server")||"服务器繁忙,请稍后重试");return}if(!m.ok||!d||!d.ok||!d.job_id){Ae(!1),d&&(d.detail||d.error)?Ye(_humanizeBackendError(d.detail||d.error,"Error "+m.status)):Ye(t("brv2-err-server")||"服务器繁忙,请稍后重试");return}const p=j("brv2-progress-sub"),c=await window._reconPollJob(d.job_id,e,{onProgress:v=>{p&&(p.textContent=window._reconProgressText(v,n))}});if(c&&c.status==="needs_mapping"&&c.mapping){Ae(!1),window.ReconMapping?window.ReconMapping.show(c.mapping,{token:e,lang:n,onConfirmed:function(){os()}}):Ye(t("brv2-err-server")||"服务器繁忙,请稍后重试");return}if(c&&c.status==="needs_review"&&c.review){Ae(!1),window.ReconReview?window.ReconReview.show(c.review,{token:e,lang:n,jobId:d.job_id,onConfirmed:async function(v){Ae(!0);const f=await window._reconPollJob(v,e,{onProgress:y=>{p&&(p.textContent=window._reconProgressText(y,n))}});await u(f)}}):Ye(t("brv2-err-server")||"服务器繁忙,请稍后重试");return}if(c&&c.status==="failed"){Ae(!1),Ye(sv(c.error_code,n));return}await u(c);async function u(v){try{if(!v||v.status!=="done"||!v.result_id){Ae(!1),Ye(t("brv2-err-server")||"服务器繁忙,请稍后重试");return}const f=await fetch("/api/recon/bank-v2/"+encodeURIComponent(v.result_id),{headers:{Authorization:"Bearer "+e}});let y=null;try{y=await f.json()}catch{y=null}if(!f.ok||y===null||!y.ok){Ae(!1),Ye(t("brv2-err-server")||"服务器繁忙,请稍后重试");return}(y.gl_accounts||[]).length>1&&bv(y.gl_accounts),P.currentTask=y,P.allRows=y.detail||[],P.currentFilter="all",document.querySelectorAll(".brv2-filter-btn").forEach(h=>h.classList.toggle("active",h.dataset.filter==="all")),iv(y&&y.summary),Ae(!1),Js(y),bn();const b=j("brv2-summary-collapse");b&&b.scrollIntoView({behavior:"smooth",block:"nearest"})}catch(f){Ae(!1),Ye(f.message||"Network error")}}}catch(s){Ye(s.message||"Network error")}}function bv(e){const n=j("brv2-acct-select");if(!n)return;const a=window._currentLang||"zh",s={zh:"全部账户",th:"ทุกบัญชี",en:"All Accounts",ja:"すべての口座"}[a]||"全部账户";n.innerHTML=`<option value="">${s}</option>`+e.map(o=>`<option value="${pe(o)}">${pe(o)}</option>`).join(""),n.style.display=""}function Xs(){if(P.initialized){bn();return}P.initialized=!0,ni("brv2-stmt-zone","brv2-stmt-input","stmt"),ni("brv2-gl-zone","brv2-gl-input","gl");const e=["brv2-anchor-gl-closing","brv2-anchor-stmt-closing","brv2-anchor-stmt-opening","brv2-anchor-gl-opening"];function n(){const l=parseFloat((j("brv2-anchor-stmt-opening")||{}).value),m=parseFloat((j("brv2-anchor-gl-opening")||{}).value),d=j("brv2-anchor-eq"),p=j("brv2-anchor-eq-val");if(!(!d||!p))if(Number.isFinite(l)&&Number.isFinite(m)){const c=l-m;p.textContent=c.toLocaleString(void 0,{minimumFractionDigits:2,maximumFractionDigits:2}),d.style.display=""}else d.style.display="none"}e.forEach(l=>{const m=j(l);m&&(m.addEventListener("input",n),m.addEventListener("input",()=>{const d=m.closest(".brv2-anchor-cell");d&&d.classList.remove("is-prefilled"),cv()}))}),lv();const a=j("brv2-run-btn");a&&a.addEventListener("click",os);const s=j("brv2-reset-btn");s&&s.addEventListener("click",()=>{P.currentTask=null,P.allRows=[],P.stmtFiles=[],P.glFiles=[],Je("stmt"),Je("gl"),mt(),ia(!1);const l=j("brv2-acct-select");l&&(l.style.display="none"),e.forEach(p=>{const c=j(p);if(c){c.value="";const u=c.closest&&c.closest(".brv2-anchor-cell");u&&u.classList.remove("is-prefilled")}});const m=j("brv2-anchor-eq");m&&(m.style.display="none");const d=j("brv2-anchor-prefill-banner");d&&d.classList.remove("show")});const o=j("brv2-new-btn");o&&o.addEventListener("click",()=>{P.currentTask=null,P.allRows=[],P.stmtFiles=[],P.glFiles=[],Je("stmt"),Je("gl"),mt(),ia(!1)});const i=j("brv2-filter-tabs");i&&i.addEventListener("click",l=>{l.stopPropagation();const m=l.target.closest(".brv2-filter-btn");m&&(P.currentFilter=m.dataset.filter,i.querySelectorAll(".brv2-filter-btn").forEach(d=>d.classList.toggle("active",d===m)),Dr())}),gv(),vv();const r=j("brv2-hist-search");r&&r.addEventListener("input",qr),bn(),mt(),window._brv2LoadHistory=bn,Array.isArray(window.__i18nSubs)||(window.__i18nSubs=[]),window.__i18nSubs=window.__i18nSubs.filter(l=>l.name!=="brv2"),window.__i18nSubs.push({name:"brv2",fn:function(){mt(),Je("stmt"),Je("gl"),P.currentTask&&Js(P.currentTask),ra()}})}window._loadBankReconV2Panel=function(e){const n=e?document.getElementById(e):null;n&&n.id!=="recon-pane-bank"&&(n.innerHTML=`<div style="padding:16px;font-size:13px;color:var(--ink-3)">
            银行对账 v2 · 请前往对账中心使用</div>`),Xs()};document.addEventListener("DOMContentLoaded",()=>{j("brv2-run-btn")&&Xs()});window._bankReconV2Init=Xs;(function(){const e=document.getElementById("general-lang");if(!e)return;e.addEventListener("change",a=>{const s=a.target.value;s&&applyLang(s)});const n=typeof currentLang=="string"&&currentLang||localStorage.getItem("mrpilot_lang")||"th";e.value=n})();(function(){const n="pearnly_general_tz",a="pearnly_general_date_format",s="pearnly_general_number_format",o={tz:"Asia/Bangkok",date:"YYYY-MM-DD",number:"comma_dot"};function i(){const d=document.getElementById("general-tz"),p=document.getElementById("general-date"),c=document.getElementById("general-number");if(!(!d||!p||!c))try{d.value=localStorage.getItem(n)||o.tz,p.value=localStorage.getItem(a)||o.date,c.value=localStorage.getItem(s)||o.number}catch{d.value=o.tz,p.value=o.date,c.value=o.number}}async function r(){const d=document.getElementById("btn-save-general"),p=document.getElementById("general-save-msg");if(!d)return;const c=d.innerHTML;d.disabled=!0,d.innerHTML="<span>"+(t("msg-saving")||"保存中...")+"</span>",p&&(p.textContent="",p.classList.remove("error"));try{const u=(document.getElementById("general-tz")||{}).value||o.tz,v=(document.getElementById("general-date")||{}).value||o.date,f=(document.getElementById("general-number")||{}).value||o.number;try{localStorage.setItem(n,u),localStorage.setItem(a,v),localStorage.setItem(s,f)}catch{}window._pearnlyGeneral={tz:u,date_format:v,number_format:f},p&&(p.textContent=t("msg-saved")||"已保存")}catch{p&&(p.textContent=t("msg-save-failed")||"保存失败",p.classList.add("error"))}finally{d.disabled=!1,d.innerHTML=c,setTimeout(function(){p&&(p.textContent="")},3e3)}}function l(){const d=document.getElementById("btn-save-general");if(!d){setTimeout(l,200);return}d._pearnlyGenBound||(d._pearnlyGenBound=!0,d.addEventListener("click",r),i())}function m(){i();const d=document.getElementById("general-lang");if(d){const p=typeof currentLang=="string"&&currentLang||localStorage.getItem("mrpilot_lang")||"th";d.value=p}}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",l):l(),typeof window.subscribeI18n=="function"&&window.subscribeI18n("settings-general",m)})();(function(){const e="mrpilot_nav_collapsed",n={ocr:"sales",history:"sales",reconcile:"sales","sales-invoices":"sales","sales-account":"sales",receivables:"sales",vouchers:"expense"};function a(){try{const r=localStorage.getItem(e);return r?JSON.parse(r):{}}catch{return{}}}function s(r){try{localStorage.setItem(e,JSON.stringify(r))}catch{}}function o(){const r=a();document.querySelectorAll(".nav-collapsible").forEach(function(l){const m=l.dataset.collapsible;r[m]?l.classList.add("collapsed"):l.classList.remove("collapsed")})}function i(r){const l=a();l[r]=!l[r],s(l),o()}(function(){const l=a();let m=!1;l.sales===void 0&&(l.sales=!1,m=!0),l.expense===void 0&&(l.expense=!0,m=!0),m&&s(l)})(),o(),document.querySelectorAll(".nav-group-toggle").forEach(function(r){r.addEventListener("click",function(){i(r.dataset.toggleGroup)})}),window.expandNavGroupForRoute=function(r){const l=n[r];if(!l)return;const m=a();m[l]&&(m[l]=!1,s(m),o())}})();const yv=`
    <div class="modal" style="max-width:440px">
    ...
    </div>`;function ai(){const e=document.getElementById("help-modal");if(!e||e.children.length)return;e.innerHTML=yv;const n=window._currentLang||"th",a=window.I18N&&window.I18N[n]||{};e.querySelectorAll("[data-i18n]").forEach(s=>{const o=s.getAttribute("data-i18n");o&&a[o]&&(s.textContent=a[o])})}document.readyState,ai();(function(){function e(){const n=document.getElementById("help-modal"),a=document.getElementById("help-modal-close");n&&(a&&!a.dataset.bound&&(a.addEventListener("click",function(){n.style.display="none"}),a.dataset.bound="1"),n.dataset.maskBound||(n.addEventListener("click",function(s){s.target===n&&(n.style.display="none")}),n.dataset.maskBound="1"),window._helpModalEscBound||(document.addEventListener("keydown",function(s){s.key==="Escape"&&n.style.display==="flex"&&(n.style.display="none")}),window._helpModalEscBound=!0))}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",e):e()})();(function(){const e={line:"line",folder:"folder",gmail:"email",erp:"erp",alert:"alert"};document.addEventListener("click",function(n){const a=n.target.closest(".int-btn-configure");if(!a)return;const s=a.closest(".integration-row"),o=s?s.dataset.intAnchor:null;if(o&&e[o]){const i=s.querySelector(".int-name"),r=i?(i.textContent||i.innerText||"").trim():"配置";typeof window.openIntegrationDrawer=="function"&&window.openIntegrationDrawer(e[o],r)}})})();let Fe=[];window._erpEndpoints=Fe;let En=null;async function wa(){try{const e=await fetch("/api/erp/endpoints",{headers:{Authorization:"Bearer "+token}});if(e.status===401){localStorage.removeItem("mrpilot_token");const a=await e.json().catch(()=>({}));if((typeof a.detail=="string"?a.detail:a.detail&&a.detail.code||"")==="auth.session_revoked"){_showSessionRevokedModal();return}window.location.href="/";return}Fe=(await e.json()).items||[],window._erpEndpoints=Fe,Fr()}catch(e){console.error("load endpoints failed",e)}}window._refreshErpEndpointsCache=function(){return wa()};async function Rr(){const e=document.getElementById("erp-today-stats");if(e){e.innerHTML="";try{const n=await fetch("/api/erp/stats/today",{headers:{Authorization:"Bearer "+token}});if(!n.ok)return;const a=await n.json(),s=a.total||0,o=a.success||0,i=a.failed||0,r=a.auto_cnt||0;if(s===0){e.innerHTML=`<span class="erp-today-empty">${escapeHtml(t("erp-today-none"))}</span>`;return}const l=[];l.push(`<span class="erp-today-item"><strong>${s}</strong> ${escapeHtml(t("erp-today-total"))}</span>`),o>0&&l.push(`<span class="erp-today-item ok"><strong>${o}</strong> ${escapeHtml(t("erp-today-success"))}</span>`),i>0&&l.push(`<span class="erp-today-item fail"><strong>${i}</strong> ${escapeHtml(t("erp-today-failed"))}</span>`),r>0&&l.push(`<span class="erp-today-item auto"><strong>${r}</strong> ${escapeHtml(t("erp-today-auto"))}</span>`),e.innerHTML=l.join("")}catch(n){console.warn("loadErpTodayStats failed",n)}}}function Fr(){const e=document.getElementById("erp-endpoints-list"),n=document.getElementById("erp-status-summary"),a=document.getElementById("btn-add-endpoint");if(!e){console.warn("erp-endpoints-list 容器不存在");return}if(a&&_userInfo){const o=_userInfo.endpoints_limit;o!==-1&&Fe.length>=o?(a.disabled=!0,a.title=t("ep-limit-reached",{limit:o}),a.classList.add("btn-disabled-plus")):(a.disabled=!1,a.title="",a.classList.remove("btn-disabled-plus"))}if(Fe.length===0){e.innerHTML=`<div class="erp-empty">${escapeHtml(t("ep-list-empty"))}</div>`,n&&(n.textContent=t("auto-status-none"),n.className="auto-status-pill none");return}const s=Fe.some(o=>o.auto_push&&o.enabled);if(n&&(n.textContent=t("auto-status-active",{n:Fe.length,mode:s?t("auto-status-on"):t("auto-status-off")}),n.className="auto-status-pill "+(s?"active":"ready")),Rr(),e.innerHTML=Fe.map(o=>{const i=o.config||{},r=escapeHtml(i.url||"");i._token_set;const l=o.enabled!==!1,m=[];o.is_default&&m.push(`<span class="ep-badge default">${escapeHtml(t("ep-default"))}</span>`),o.auto_push&&m.push(`<span class="ep-badge auto">${escapeHtml(t("ep-auto-push-on"))}</span>`),l||m.push(`<span class="ep-badge disabled">${escapeHtml(t("ep-disabled"))}</span>`);const d=[];return o.success_count>0&&d.push(`<span class="ep-stat ok">${escapeHtml(t("ep-success",{n:o.success_count}))}</span>`),o.failure_count>0&&d.push(`<span class="ep-stat fail">${escapeHtml(t("ep-failure",{n:o.failure_count}))}</span>`),`
        ...
        `}).join(""),_userInfo&&_userInfo.endpoints_limit!==-1){const o=Fe.length,i=_userInfo.endpoints_limit,r=_userInfo.plan,l=document.createElement("div");l.className="erp-limit-hint",r==="free"?l.innerHTML=`${escapeHtml(t("ep-free-limit-hint",{used:o,limit:i}))} <a data-upgrade="plus">${escapeHtml(t("upgrade-to-plus"))}</a>`:l.textContent=t("ep-plus-limit-hint",{used:o,limit:i}),e.appendChild(l)}}function wv(e){En=e||null;const n=document.getElementById("endpoint-modal"),a=document.getElementById("endpoint-modal-title");a.textContent=e?t("ep-modal-title-edit"):t("ep-modal-title-new");const s=document.getElementById("ep-name"),o=document.getElementById("ep-url"),i=document.getElementById("ep-token"),r=document.getElementById("ep-is-default"),l=document.getElementById("ep-auto-push"),m=document.getElementById("ep-test-result");m.style.display="none",m.textContent="";const d=document.getElementById("ep-save-error");if(d&&d.remove(),e){const c=Fe.find(u=>u.id===e);if(!c)return;s.value=c.name||"",o.value=(c.config||{}).url||"",i.value=(c.config||{})._token_set&&c.config.token||"",i.placeholder=(c.config||{})._token_set?"（已保存 · 留空保持不变）":t("ep-token-ph"),r.checked=!!c.is_default,l.checked=!!c.auto_push}else s.value="",o.value="",i.value="",i.placeholder=t("ep-token-ph"),r.checked=Fe.length===0,l.checked=!0;const p=l.closest(".form-switch-row");if(l.disabled=!1,p){p.classList.remove("disabled-plus"),p.title="",p.style.cursor="",p.onclick=null;const c=p.querySelector(".plus-badge");c&&c.remove()}n.style.display="",setTimeout(()=>s.focus(),50)}function zr(){document.getElementById("endpoint-modal").style.display="none",En=null;const e=document.getElementById("ep-save-error");e&&e.remove()}function Nr(e){if(!e)return"";let n=e.trim();const a=n.search(/\s/);return a>=0&&(n=n.slice(0,a)),n}function Or(){const e=document.getElementById("ep-name").value.trim(),n=Nr(document.getElementById("ep-url").value),a=document.getElementById("ep-token").value,s=document.getElementById("ep-is-default").checked,o=document.getElementById("ep-auto-push").checked,i={url:n};return a&&(i.token=a),{name:e,url:n,tokenVal:a,isDefault:s,autoPush:o,config:i}}async function kv(){const{url:e,config:n}=Or(),a=document.getElementById("ep-test-result");if(!e){a.style.display="",a.className="form-test-result fail",a.textContent=t("ep-required");return}a.style.display="",a.className="form-test-result running",a.textContent=t("ep-test-running");try{const o=await(await fetch("/api/erp/test-connection",{method:"POST",headers:{Authorization:"Bearer "+token,"Content-Type":"application/json"},body:JSON.stringify({adapter:"webhook",config:n})})).json();o.success?(a.className="form-test-result ok",a.textContent=t("ep-test-ok",{status:o.http_status,ms:o.elapsed_ms})):(a.className="form-test-result fail",a.textContent=t("ep-test-fail",{err:o.error_msg||"unknown"}))}catch(s){a.className="form-test-result fail",a.textContent=t("ep-test-fail",{err:s.message})}}async function xv(){const e=Or(),n=document.getElementById("ep-save-error");if(n&&(n.style.display="none"),!e.name||!e.url){si(t("ep-required"));return}const a={name:e.name,adapter:"webhook",config:e.config,is_default:e.isDefault,auto_push:e.autoPush},s=document.getElementById("btn-ep-save"),o=s.innerHTML;s.disabled=!0,s.classList.add("loading");try{let i;if(En?i=await fetch(`/api/erp/endpoints/${encodeURIComponent(En)}`,{method:"PATCH",headers:{Authorization:"Bearer "+token,"Content-Type":"application/json"},body:JSON.stringify(a)}):i=await fetch("/api/erp/endpoints",{method:"POST",headers:{Authorization:"Bearer "+token,"Content-Type":"application/json"},body:JSON.stringify(a)}),!i.ok){const l=(await i.json().catch(()=>({}))).detail||`HTTP ${i.status}`;throw new Error(typeof l=="string"?l:JSON.stringify(l))}zr(),showToast(t("ep-save-ok")),wa()}catch(i){si(`${t("ep-save-fail")} · ${i.message||"unknown"}`)}finally{s.disabled=!1,s.classList.remove("loading"),s.innerHTML=o}}function si(e){let n=document.getElementById("ep-save-error");if(!n){const a=document.querySelector("#endpoint-modal .modal-foot");if(!a)return;n=document.createElement("div"),n.id="ep-save-error",n.className="ep-inline-error",a.parentNode.insertBefore(n,a)}n.textContent=e,n.style.display=""}async function _v(e){const n=Fe.find(s=>s.id===e);if(!(!n||!await showConfirm(t("ep-delete-confirm",{name:n.name}),{danger:!0})))try{if(!(await fetch(`/api/erp/endpoints/${encodeURIComponent(e)}`,{method:"DELETE",headers:{Authorization:"Bearer "+token}})).ok)throw new Error;showToast(t("ep-delete-ok")),wa()}catch{showToast(t("ep-save-fail"),"fail")}}window.loadErpEndpoints=wa;window.loadErpTodayStats=Rr;window.renderErpEndpointsList=Fr;window.openEndpointModal=wv;window.closeEndpointModal=zr;window.saveEndpoint=xv;window.deleteEndpoint=_v;window.testEndpointConnection=kv;window._sanitizeUrl=Nr;async function Vr(e){if(e=(e||"").trim(),!!e)try{await navigator.clipboard.writeText(e),showToast(t("erp-doc-copy-ok",{no:e}),"success")}catch{try{const a=document.createElement("textarea");a.value=e,a.style.position="fixed",a.style.opacity="0",document.body.appendChild(a),a.select(),document.execCommand("copy"),a.remove(),showToast(t("erp-doc-copy-ok",{no:e}),"success")}catch{showToast(t("erp-doc-copy-fail"),"error")}}}async function Ev(e){const n=document.createElement("div");n.className="log-detail-modal",n.innerHTML=`
        <div class="log-detail-box">
            <div class="log-detail-loading">${escapeHtml(t("log-detail-loading"))}</div>
        </div>
    `,document.body.appendChild(n),n.addEventListener("click",async a=>{if(a.target===n||a.target.classList.contains("log-detail-close")){n.remove();return}const s=a.target.closest("[data-receipt-copy]");if(s){Vr(s.dataset.receiptCopy);return}const o=a.target.closest("[data-receipt-action]");if(o){const i=o.dataset.receiptAction;i==="retry"?window.retryPushLog(o.dataset.logId):i==="exceptions"?typeof routeTo=="function"&&routeTo("exceptions"):i==="mappings"&&typeof routeTo=="function"&&routeTo("integrations"),n.remove();return}});try{const a=await fetch(`/api/erp/logs/${encodeURIComponent(e)}`,{headers:{Authorization:"Bearer "+token}});if(!a.ok){n.remove();return}const s=await a.json(),o=window._erpEndpoints.find(S=>S.id===s.endpoint_id),i=s.endpoint_name||(o?o.name:s.endpoint_id?t("erp-log-endpoint-deleted"):"-"),r=(s.endpoint_adapter||o&&o.adapter||"").toLowerCase(),l=new Date(s.created_at).toLocaleString(),m=s.trigger==="auto"?t("log-tag-auto"):s.trigger==="retry"?t("log-tag-retry"):t("log-tag-manual"),d=s.request_body?JSON.stringify(s.request_body,null,2):t("erp-receipt-no-tech"),p=s.response_body||t("erp-receipt-no-tech"),c=s.status==="success";let u=typeof p=="string"?p:JSON.stringify(p,null,2);if(c)try{const S=typeof s.response_body=="string"?JSON.parse(s.response_body):s.response_body||{},M=S.row_count||(Array.isArray(S.imported_rows)?S.imported_rows.length:0);M>0&&(u=t("log-push-rows").replace("{n}",String(M)))}catch{}const v=(s.external_doc_no||"").trim(),f=(s.external_url||"").trim(),y=(s.external_doc_hint||"").trim(),b=(s.ocr_buyer_name||"").trim()||s.client_name||"-",h=s.seller_name||"-",g=s.push_type==="id_card";let _="-";const w=Number(s.total_amount);s.total_amount!=null&&s.total_amount!==""&&!isNaN(w)&&(_=w.toLocaleString("en-US",{minimumFractionDigits:2,maximumFractionDigits:2}));const k=c?t("erp-receipt-title-ok"):t("erp-receipt-title-fail"),x=c?"✓":"✗",E=[],I=(S,M)=>{E.push(`
                <div class="erp-receipt-row">
                    <span class="erp-receipt-key">${escapeHtml(S)}</span>
                    <span class="erp-receipt-val">${M}</span>
                </div>`)};if(I(g?t("erp-log-col-booking"):t("erp-receipt-invoice-no"),`<strong>${escapeHtml(s.invoice_no||"-")}</strong>`),I(t("erp-receipt-erp-name"),escapeHtml(i)),c){let S;v?S=`<strong class="erp-receipt-docno">${escapeHtml(v)}</strong><button class="erp-receipt-copy-btn" type="button" data-receipt-copy="${escapeHtml(v)}" title="${escapeHtml(t("erp-doc-copy-tip"))}">${escapeHtml(t("erp-receipt-copy-btn"))}</button>`:S=`<span class="erp-receipt-docno-missing">${escapeHtml(t("erp-log-doc-missing"))}</span>`,I(t("erp-receipt-doc-no"),S)}g||I(t("erp-receipt-client"),escapeHtml(b)),I(g?t("erp-log-col-customer"):t("erp-receipt-seller"),escapeHtml(h)),c&&I(t("erp-receipt-amount"),escapeHtml(_)),I(t("erp-receipt-time"),escapeHtml(l)),I(t("erp-receipt-elapsed"),escapeHtml((s.elapsed_ms!=null?s.elapsed_ms:"-")+"ms"));let B="";c&&f?B=`<a class="erp-receipt-primary-btn" href="${escapeHtml(f)}" target="_blank" rel="noopener">${escapeHtml(t("erp-receipt-open-erp"))}</a>`:c&&v&&(B=`<button class="erp-receipt-primary-btn" type="button" data-receipt-copy="${escapeHtml(v)}">${escapeHtml(t("erp-receipt-copy-docno"))}</button>`);let L="";if(c&&v&&y){const S="erp-receipt-hint-"+y,M=t(S);M&&M!==S&&(L=`<div class="erp-receipt-hint"><svg class="erp-receipt-hint-ic" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><circle cx="12" cy="12" r="9"/><line x1="12" y1="11" x2="12" y2="16"/><line x1="12" y1="8" x2="12.01" y2="8"/></svg><span>${escapeHtml(M)}</span></div>`)}let $="";if(!c){const S=(s.error_msg||"").match(/ERR_[A-Z0-9_]+/),M=S?S[0]:"",R=typeof currentLang=="string"&&currentLang||window._currentLang||"th",se=s.error_friendly&&s.error_friendly[R]||(s.error_msg?humanizeError(s.error_msg):t("erp-receipt-no-error")),ce=/ERR_NO_CUSTOMER_MAPPING|ERR_NO_CLIENT|ERR_NO_SEED_CUSTOMER|ERR_NO_SEED_PRODUCT/.test(s.error_msg||""),Ee=!!(s.history_id&&s.endpoint_id),ke=[];ke.push(`<button class="erp-receipt-action-btn" type="button" data-receipt-action="exceptions">${escapeHtml(t("erp-receipt-act-exceptions"))}</button>`),ce&&ke.push(`<button class="erp-receipt-action-btn" type="button" data-receipt-action="mappings">${escapeHtml(t("erp-receipt-act-mapping"))}</button>`),Ee&&ke.push(`<button class="erp-receipt-action-btn primary" type="button" data-receipt-action="retry" data-log-id="${escapeHtml(s.id)}">${escapeHtml(t("erp-receipt-act-retry"))}</button>`),$=`
                ...
                <div class="erp-receipt-actions">${ke.join("")}</div>`}n.querySelector(".log-detail-box").innerHTML=`
        ...
        `}catch(a){console.error(a),n.remove()}}window.copyErpDocNo=Vr;window.showLogDetail=Ev;const Iv=`
        <div class="modal">
            <div class="modal-head">
    ...
    `;$e("endpoint-modal",Iv);let pn={key:"all",val:""},yn="",qa=!1,lt=new Set;window._erpSelected=lt;async function Bv(){const e=document.getElementById("erp-logs-erp-select");if(!(!e||qa)){qa=!0;try{let n=window._erpEndpoints;if(!Array.isArray(n)||n.length===0){const o=await fetch("/api/erp/endpoints",{headers:{Authorization:"Bearer "+token}});if(o.ok){const i=await o.json();n=i&&(i.items||i)||[]}}Array.isArray(n)||(n=[]);const a=new Set,s=[];n.forEach(o=>{const i=(o&&o.adapter||"").toLowerCase();!i||a.has(i)||(a.add(i),s.push({val:i,label:o&&o.name||i}))}),e.innerHTML=`<option value="">${escapeHtml(t("erp-logs-erp-all"))}</option>`+s.map(o=>`<option value="${escapeHtml(o.val)}"${o.val===yn?" selected":""}>${escapeHtml(o.label)}</option>`).join("")}catch{qa=!1}}}async function Gt(e){const n=document.getElementById("erp-logs-list");if(n){e||(n.innerHTML=`<div class="erp-logs-empty">${escapeHtml(t("erp-logs-loading"))}</div>`),window.loadErpTodayStats(),Bv();try{const a=new URLSearchParams({limit:"30"});pn.key==="status"&&a.set("status",pn.val),pn.key==="trigger"&&a.set("trigger",pn.val),yn&&a.set("adapter",yn);const s=await fetch(`/api/erp/logs?${a}`,{headers:{Authorization:"Bearer "+token}});if(!s.ok){n.innerHTML=`<div class="erp-logs-empty">${escapeHtml(t("erp-logs-error"))}</div>`;return}const i=(await s.json()).items||[];if(window._erpLogPollTimer&&(clearTimeout(window._erpLogPollTimer),window._erpLogPollTimer=null),i.some(function(v){return v.status==="pending"})&&(window._erpLogPollTimer=setTimeout(function(){Gt(!0)},4e3)),i.length===0){n.innerHTML=`<div class="erp-logs-empty">${escapeHtml(t("erp-logs-empty"))}</div>`;return}const r=i.filter(function(v){var f=v.status==="failed"&&v.next_retry_at&&new Date(v.next_retry_at).getTime()>Date.now()-6e4;return!f}).map(function(v){return v.id}),l=yn==="mrerp_dms",m=l?t("erp-log-col-booking"):t("erp-log-col-invoice"),d=l?t("erp-log-col-customer"):t("erp-log-col-seller"),p=l?t("erp-log-col-idcard"):t("erp-log-col-client"),c='<div class="erp-log-row erp-log-row-header" data-log-header>'+(r.length>0?`<input type="checkbox" class="erp-log-cb erp-log-cb-all" data-log-select-all title="${escapeHtml(t("erp-log-select-all-tip"))}">`:'<span class="erp-log-cb-spacer"></span>')+`<span class="log-time">${escapeHtml(t("erp-log-col-time"))}</span><span class="log-status">${escapeHtml(t("erp-log-col-status"))}</span><span class="log-tag-header">${escapeHtml(t("erp-log-col-trigger"))}</span><span class="log-invoice">${escapeHtml(m)}</span><span class="log-workspace">${escapeHtml(t("erp-log-col-workspace"))}</span><span class="log-client">${escapeHtml(p)}</span><span class="log-seller">${escapeHtml(d)}</span><span class="log-erp">${escapeHtml(t("erp-log-col-erp"))}</span><span class="log-doc">${escapeHtml(t("erp-log-col-doc"))}</span><span class="log-http">${escapeHtml(t("erp-log-col-http"))}</span><span class="log-elapsed">${escapeHtml(t("erp-log-col-elapsed"))}</span><span class="log-actions"></span></div>`;n.innerHTML=c+i.map(v=>{const f=new Date(v.created_at),y=`${String(f.getMonth()+1).padStart(2,"0")}-${String(f.getDate()).padStart(2,"0")} ${String(f.getHours()).padStart(2,"0")}:${String(f.getMinutes()).padStart(2,"0")}`,b=v.status==="failed"&&v.next_retry_at&&new Date(v.next_retry_at).getTime()>Date.now()-6e4;let h,g,_;v.status==="pending"?(h="retrying",g="⟳",_=t("erp-status-pending")):v.status==="success"?(h="ok",g="✓",_=t("erp-status-success")):v.status==="skipped_dup"?(h="skipped",g="⏭",_=t("erp-status-skipped")):b?(h="retrying",g="↻",_=t("erp-status-retrying")):(h="fail",g="✗",_=t("erp-status-failed"));let w;v.trigger==="auto"?w=`<span class="log-tag auto">${escapeHtml(t("log-tag-auto"))}</span>`:v.trigger==="retry"?w=`<span class="log-tag retry">${escapeHtml(t("log-tag-retry"))}</span>`:w=`<span class="log-tag manual">${escapeHtml(t("log-tag-manual"))}</span>`;const k=v.push_type==="id_card",x=k?`<span class="log-tag log-type-idcard">${escapeHtml(t("erp-log-type-idcard"))}</span>`:"",E=v.error_friendly&&(v.error_friendly[currentLang]||v.error_friendly.en)||"";let I="";const B=v.retry_count||0,L=v.max_retries||3;if(b){const Y=new Date(v.next_retry_at).getTime()-Date.now(),de=Math.max(0,Math.round(Y/6e4)),re=de<=0?t("erp-retry-next-soon"):t("erp-retry-next-min",{n:de});I=`${t("erp-retry-attempt",{n:B,max:L})} · ${re}`}else v.status==="failed"&&B>=L&&!v.next_retry_at&&(I=t("erp-retry-exhausted",{n:B}));const $=v.status==="failed"&&!b?`<button class="log-retry-btn btn btn-icon" data-log-retry="${escapeHtml(v.id)}" title="${escapeHtml(t("log-retry-title"))}">↻</button>`:"",S=!b,M=lt.has(v.id)?"checked":"",R=S?`<input type="checkbox" class="erp-log-cb" data-log-cb="${escapeHtml(v.id)}" ${M}>`:'<span class="erp-log-cb-spacer"></span>',G=(v.ocr_buyer_name||"").trim()||(v.client_name||"").trim(),se=k?`<span class="log-client" title="${escapeHtml(t("erp-log-col-idcard"))}">${v.id_card_tail?"••••"+escapeHtml(v.id_card_tail):"—"}</span>`:G?`<span class="log-client" title="${escapeHtml(G)}">${escapeHtml(G.substring(0,18))}</span>`:`<span class="log-client log-client-empty" title="${escapeHtml(t("erp-log-client-unassigned-tip"))}">${escapeHtml(t("erp-log-client-unassigned"))}</span>`,ce=k?'<span class="log-workspace log-workspace-unresolved">—</span>':v.workspace_name?`<span class="log-workspace">${escapeHtml((v.workspace_name||"").substring(0,16))}</span>`:`<span class="log-workspace log-workspace-unresolved" title="${escapeHtml(t("erp-log-ws-unresolved-tip"))}">${escapeHtml(t("erp-log-ws-unresolved"))}</span>`,Ee=v.endpoint_name?`<span class="log-erp">${escapeHtml((v.endpoint_name||"").substring(0,14))}</span>`:`<span class="log-erp log-erp-deleted">${escapeHtml(t("erp-log-endpoint-deleted"))}</span>`,ke=(v.external_doc_no||"").trim(),V=(v.external_url||"").trim();let O;return V?O=`<span class="log-doc"><a href="${escapeHtml(V)}" target="_blank" rel="noopener" class="log-doc-open" title="${escapeHtml(ke||"")}">${escapeHtml(t("erp-log-doc-open"))}</a></span>`:ke?O=`<span class="log-doc log-doc-copy" data-copy-doc="${escapeHtml(ke)}" title="${escapeHtml(t("erp-log-doc-copy-tip"))}">${escapeHtml(ke.substring(0,18))}</span>`:v.status==="success"?O=`<span class="log-doc log-doc-missing" title="${escapeHtml(t("erp-log-doc-missing-tip"))}">${escapeHtml(t("erp-log-doc-missing"))}</span>`:O='<span class="log-doc log-doc-empty">-</span>',`
        ...
        `,document.body.appendChild(v);const f=()=>v.remove();v.querySelector("#cpw-forgot-close").addEventListener("click",f),v.querySelector("#cpw-forgot-cancel").addEventListener("click",f),v.addEventListener("click",y=>{y.target===v&&f()}),v.querySelector("#cpw-forgot-send").addEventListener("click",async()=>{const y=v.querySelector("#cpw-forgot-send"),b=v.querySelector("#cpw-forgot-msg");y.disabled=!0;const h=y.textContent;y.textContent=a("cpw-forgot-sending");try{const g=await fetch("/api/auth/forgot_password",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:c})}),_=await g.json().catch(()=>({}));g.ok?(b.textContent=a("cpw-forgot-success"),b.className="cpw-forgot-msg success",y.style.display="none",v.querySelector("#cpw-forgot-cancel").textContent=a("cpw-forgot-close-btn")):(b.textContent=_.detail||a("cpw-forgot-fail"),b.className="cpw-forgot-msg error",y.disabled=!1,y.textContent=h)}catch{b.textContent=a("cpw-forgot-fail"),b.className="cpw-forgot-msg error",y.disabled=!1,y.textContent=h}})}function m(p){if(!p||!p.includes("@"))return p||"";const[c,u]=p.split("@");return c.length<=2?c+"****@"+u:c.slice(0,2)+"****@"+u}function d(p){return p==null?"":String(p).replace(/[&<>"']/g,c=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[c])}document.readyState==="complete"||document.readyState==="interactive"?r():document.addEventListener("DOMContentLoaded",r)})();(function(){let e=null,n=!1;async function a(){if(n)return;const o=localStorage.getItem("mrpilot_token");if(o){n=!0;try{const i=await fetch("/api/me",{headers:{Authorization:"Bearer "+o},cache:"no-store"});if(i.status===401){const r=await i.json().catch(()=>({})),l=r&&r.detail;let m="";if(typeof l=="string"?m=l:l&&typeof l=="object"&&(m=l.code||""),console.warn("[heartbeat] session revoked",m),localStorage.removeItem("mrpilot_token"),e&&(clearInterval(e),e=null),m==="auth.session_revoked")try{_showSessionRevokedModal()}catch{window.location.href="/"}else{const d=m==="auth.password_changed_relogin"?"alert-password-changed-relogin":"alert-session";try{typeof showToast=="function"&&typeof t=="function"?showToast(t(d),"error"):alert("Session expired")}catch{}setTimeout(()=>{window.location.href="/"},1500)}}}catch{}finally{n=!1}}}function s(){e&&clearInterval(e),e=setInterval(a,15e3)}localStorage.getItem("mrpilot_token")&&s(),window.addEventListener("focus",a),document.addEventListener("visibilitychange",function(){document.hidden||a()}),window._sessionCheck=a})();async function ka(){const e=document.getElementById("team-loading"),n=document.getElementById("team-list"),a=document.getElementById("team-empty"),s=document.getElementById("team-count");if(n){e&&(e.style.display=""),n.style.display="none",a&&(a.style.display="none");try{const o=await apiGet("/api/team/employees"),i=o&&o.employees||[];if(e&&(e.style.display="none"),s&&(s.textContent=(t("team-count")||"共 {n} 名员工").replace("{n}",i.length)),i.length===0){a&&(a.style.display="");return}n.style.display="",n.innerHTML=i.map(r=>{const l=r.last_login_at?new Date(r.last_login_at).toLocaleDateString():t("team-never-login")||"从未登录",m=r.is_active===!1?"team-status-off":"team-status-on",d=r.is_active===!1?t("team-status-disabled")||"已禁用":t("team-status-active")||"正常",p=r.email?`<span class="team-meta-sep">·</span><span>${escapeHtml(r.email)}</span>`:"";return`
            ...
            </div>`}).join("")}catch(o){console.error("loadTeamList failed:",o),e&&(e.textContent=t("team-load-failed")||"加载失败")}}}async function Lv(){document.querySelectorAll(".add-emp-overlay").forEach(s=>s.remove());const e=document.createElement("div");e.className="add-emp-overlay",e.innerHTML=`
