...
from team_routes import (  # REFACTOR-B1 · 员工管理 7 路由 · 2026-05-25
...
from tenant_routes import (
    ...
    # 下两 model 单一来源在 tenant_routes · admin user quota/status 路由复用(REFACTOR-B1)
...
# ============================================================
# v0.17 · M6 · 邮箱抓取(IMAP)· 2 model + 6 路由 + _email_presets
# 已抽到 email_ingest_routes.py(REFACTOR-B1 · 2026-05-25)·
# @router 注册 + app.include_router(email_ingest_router)
# ============================================================
...
# v0.18 · M10 · 银行对账 API
# ============================================================
# 已抽到 bank_recon_routes.py(REFACTOR-B1 · 2026-05-25 · 11 路由 + _TEST_USER_IDS)·
# @router 注册 + app.include_router(bank_recon_router)
...
# 仅 /api/history/{id}/assign_client 留此(属 history 组 · 待 history_routes 抽出时一并搬)
# ============================================================
