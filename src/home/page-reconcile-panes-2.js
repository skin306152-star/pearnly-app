// ============================================================
// REFACTOR-WB-C1 (2026-05-30) · 对账中心页壳 HTML(下半)· 从 page-reconcile.js 抽出为数据模块
// 纯静态 HTML 模板数据(0 逻辑 / 0 状态)· 销项税对账 pane + GL-VAT 对账 pane + 收尾。
// ============================================================
export const RECON_HTML_2 = `        <!-- ── 销项税对账面板(v118.32.0 · 屏 A) ── -->
