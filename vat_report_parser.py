...
from field_comparator import normalize_tax_id, normalize_branch

# v118.35.0.3 · 包装 pydantic ValidationError 为单行用户友好提示
from services.ocr.error_format import short_error as _short_err

from vat_parser_common import _to_float, _filter_garbage_rows, PARSER_VERSION
from vat_parser_excel import parse_excel
from vat_parser_pdf import parse_pdf_text, _parse_vat_pdf_text_lines
from vat_parser_gemini import (
    parse_with_gemini,
