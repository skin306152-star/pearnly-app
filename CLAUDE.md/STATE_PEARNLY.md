...
## 🎯 状态卡（2026-06-27 · **B8 RLS · 孤儿 re-enroll 连推 4 棒 enroll 上线:sales(`8a7d8485`)+ suppliers(`4cc03b42`)+ line 绑定(`cd3cc12d`)+ tenant 批 products/client_rules/member_scopes(`2041e719`)**· CI 6 闸全绿 + prod 金丝雀 PASS · companion 未动 · 交接 `docs/refactor/b8-rls-HANDOFF-2026-06-25.md` §7.11~§7.14）
