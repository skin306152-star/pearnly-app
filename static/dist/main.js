...
`,Ns=`                    <!-- Tab: 邮箱抓取 (v0.17 · M6 · v93 在 Vultr 复活) -->
...
`;(function(){const e=document.getElementById("page-automation");if(!(!e||e.dataset.wbInjected==="1")){e.innerHTML=zs+Ns,e.dataset.wbInjected="1";try{const n=window._currentLang||localStorage.getItem("mrpilot_lang")||"th",a=window.I18N;a&&a[n]&&(e.querySelectorAll("[data-i18n]").forEach(o=>{const s=o.getAttribute("data-i18n");s&&a[n][s]&&(o.textContent=a[n][s])}),e.querySelectorAll("[data-i18n-placeholder]").forEach(o=>{const s=o.getAttribute("data-i18n-placeholder");s&&a[n][s]&&(o.placeholder=a[n][s])}))}catch{}}})();(function(){const e={"page-integration":`
        <div class="coming-soon">
            <svg class="cs-icon" viewBox="0 0 48 48" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
...
`,e.dataset.wbInjected="1";try{const n=window._currentLang||localStorage.getItem("mrpilot_lang")||"th",a=window.I18N;a&&a[n]&&e.querySelectorAll("[data-i18n]").forEach(o=>{const s=o.getAttribute("data-i18n");a[n][s]&&(o.textContent=a[n][s])})}catch{}}})();function Os(e,n){const a=document.getElementById("alert-"+e);a&&(document.getElementById("alert-"+e+"-text").textContent=n,a.classList.add("show"))}function Vs(){["info","warn","error"].forEach(e=>{document.getElementById("alert-"+e).classList.remove("show")})}function Us(e,n){if(e==null)return n||"操作失败";if(typeof e=="string")return e;if(Array.isArray(e)){const a=e[0]||{};return a.msg?a.msg:n||"请求格式错误"}if(typeof e=="object"){if(e.code){const a="err."+e.code;try{const o=t(a,e);if(o&&o!==a)return o}catch(o){console.warn("[i18n] t() failed for key:",a,o)}return e.code}if(e.message)return e.message;if(e.error)return e.error;if(e.detail&&typeof e.detail=="string")return e.detail;try{return JSON.stringify(e).slice(0,160)}catch{}}return n||String(e)}function Gs(e){if(!e)return"";const n=String(e);return/ECONNREFUSED|Connection refused/i.test(n)?"连接被拒绝 · ERP 地址可能错了,或服务没启动":/listing fetch failed|wait_for_selector/i.test(n)?"拉取 MR.ERP 客户/商品列表超时 · 已重试 3 次仍不通 · 可能 MR.ERP 响应慢 · 稍后再试":/ETIMEDOUT|timeout/i.test(n)?"连接超时 · MR.ERP 响应慢 · 稍后再试":/ENOTFOUND|getaddrinfo/i.test(n)?"域名解析失败 · ERP 地址拼错了":/certificate|SSL/i.test(n)?"SSL 证书问题 · ERP 站点证书异常":/401|Unauthorized/i.test(n)?"HTTP 401 · 认证失败,检查 Token 是否正确":/403|Forbidden/i.test(n)?"HTTP 403 · 权限不足,ERP 拒绝访问":/404|Not Found/i.test(n)?"HTTP 404 · URL 路径不存在":/^5\d\d/.test(n)||/500|502|503|504/.test(n)?"ERP 服务器错误 · 不是你的问题,等会儿再试":n}function Ks(e,n,a){let o=document.getElementById("mp-toast-wrap");o||(o=document.createElement("div"),o.id="mp-toast-wrap",document.body.appendChild(o)),n=n||"success",n==="ok"&&(n="success"),n==="warning"&&(n="warn"),n==="danger"&&(n="error");const s={success:'<path d="M3 8l3 3 7-7"/>',error:'<circle cx="8" cy="8" r="6"/><path d="M5.5 5.5l5 5M10.5 5.5l-5 5"/>',warn:'<path d="M8 2L1.5 13h13L8 2z"/><path d="M8 7v3M8 12v.01"/>',info:'<circle cx="8" cy="8" r="6"/><path d="M8 5.5v.01M8 8v3"/>',loading:'<path d="M8 1a7 7 0 017 7" stroke-linecap="round" class="mp-toast-spin"/>'},i=document.createElement("div");i.className="mp-toast "+n,i.innerHTML=`
    ...
    `,o.appendChild(i),requestAnimationFrame(()=>i.classList.add("show"));const r=typeof a=="number"?a:2500;let c=null;const m=()=>{c&&(clearTimeout(c),c=null),i.classList.remove("show"),setTimeout(()=>{try{i.remove()}catch{}},300)};return r>0&&(c=setTimeout(m,r)),m}window.showAlert=Os;window.hideAlerts=Vs;window._humanizeBackendError=Us;window.humanizeError=Gs;window.showToast=Ks;function Js(e,n){return n=n||{},new Promise(a=>{const o=document.getElementById("confirm-modal"),s=document.getElementById("confirm-modal-body"),i=document.getElementById("confirm-modal-ok"),r=document.getElementById("confirm-modal-cancel"),c=document.getElementById("confirm-modal-close"),m=document.getElementById("confirm-modal-title");if(!o||!s||!i||!r){a(!1);return}m.textContent=n.title||t("confirm-default-title");const d=n.promptInput?"cm_in_"+Date.now():null;if(n.promptInput){const f=(e||"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;"),v=(n.placeholder||"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;");s.innerHTML=`
        ...
        `;const o=document.getElementById("api-key-card");o&&(o.style.display="");return}Qs(n,e);const a=document.getElementById("api-key-card");if(a){const o=tt==="byo_api"||_userInfo&&_userInfo.is_super_admin;a.style.display=o?"":"none"}}function Qs(e,n){const a=escapeHtml(e.username||e.email||"");n.innerHTML=`
        <table style="width:100%; font-size:13px; border-collapse: collapse;">
            <tr>
    ...
    `}window.switchSettingsTab=Ws;window.fillSettingsForms=Ys;window.saveProfile=Xs;window.saveCompany=Zs;window.renderSettings=jn;function mn(e){return e=e||_userInfo,!!(e&&e.is_super_admin)}function Jn(e){return e=e||_userInfo,!!e&&(e.role==="owner"||mn(e))}function ho(e){return e=e||_userInfo,!!e&&e.role==="member"&&!mn(e)}function ei(e){return e=e||_userInfo,!!e&&(e.effective_plan==="trial"||e.plan==="trial")&&!mn(e)}function go(e){return e=e||_userInfo,!!e&&e.tenant_type==="byo_api"}function bo(e){return ho(e)}function ti(e){return Jn(e)}function ni(e){return Jn(e)&&go(e)}window.isMoneyHidden=bo;window.isSuperAdmin=mn;window.isOwner=Jn;window.isEmployee=ho;window.isTrial=ei;window.isLifetime=go;window.shouldHideMoney=bo;window.canManageTeam=ti;window.canManageApiKey=ni;function ai(){const e=document.getElementById("quota-banner");if(!e)return;if(!_userInfo){e.style.display="none";return}if(_userInfo.is_super_admin||_userInfo.tenant_type==="admin"||_userInfo.tenant_type==="byo_api"){e.style.display="none";return}let n=0,a=0;if(_userInfo.plan==="free"&&_quota&&_quota.ip_daily_limit)n=_quota.ip_used_today||0,a=_quota.ip_daily_limit;else if(_userInfo.tenant_quota!=null&&_userInfo.tenant_quota>0)n=_userInfo.tenant_used||0,a=_userInfo.tenant_quota;else if(_userInfo.monthly_quota&&_userInfo.monthly_quota>0)n=_userInfo.used_this_month||0,a=_userInfo.monthly_quota;else{e.style.display="none";return}if(a<=0){e.style.display="none";return}const o=Math.max(0,a-n),s=n/a*100,i="quota_banner_dismiss_"+new Date().toISOString().slice(0,10);if(localStorage.getItem(i)){e.style.display="none";return}let r,c;if(o===0)r="danger",c=t("quota-banner-exhausted");else if(s>=90)r="danger",c=t("quota-banner-very-low",{n:o});else if(s>=70)r="warn",c=t("quota-banner-low",{n:o});else{e.style.display="none";return}e.className="quota-banner "+r,e.innerHTML=`
    ...
    `,e.style.display="flex";const m=e.querySelector(".quota-banner-close");m&&m.addEventListener("click",()=>{localStorage.setItem(i,"1"),e.style.display="none"})}function oi(){const e=_userInfo;if(!e)return;const n=shouldHideMoney(e),a=canManageTeam(e),o=canManageApiKey(e),s=document.querySelector('.nav-item[data-route="templates"]');s&&(s.classList.remove("locked-for-plan"),s.removeAttribute("data-locked-target"));const i=document.querySelector('.nav-item[data-route="api-keys"]');i&&(i.classList.remove("locked-for-plan"),i.removeAttribute("data-locked-target"));const r=document.getElementById("btn-custom-template");r&&(r.style.display="",r.classList.remove("locked-for-plan"));const c=document.querySelector('.settings-tab[data-tab="team"]');c&&(c.style.display=a?"":"none");const m=document.querySelector('.settings-panel[data-settings-panel="team"]');m&&(m.dataset.permHidden=a?"0":"1");const d=document.querySelector('.settings-tab[data-tab="api"]');d&&(d.style.display=o||isSuperAdmin(e)?"":"none");const p=document.querySelector('.settings-tab[data-tab="plan"]');p&&(p.style.display=n?"none":"");const l=document.querySelector('.settings-tab[data-tab="company"]');l&&(l.style.display=n?"none":"");const u=document.getElementById("info-bar");u&&(u.style.display=n?"none":"");const f=document.getElementById("trial-banner");f&&n&&(f.style.display="none");const v=document.getElementById("plan-banner");v&&n&&(v.style.display="none",document.body.classList.remove("has-plan-banner")),document.querySelectorAll("[data-upgrade-cta], .btn-upgrade, .topbar-upgrade").forEach(w=>{w.style.display="none"}),document.body.classList.toggle("role-employee",isEmployee(e)),document.body.classList.toggle("role-owner",isOwner(e)),document.body.classList.toggle("role-super",isSuperAdmin(e));try{const w=document.querySelector(".settings-tab.active");w&&w.style.display==="none"&&(typeof window.switchSettingsTab=="function"?window.switchSettingsTab("profile"):typeof switchSettingsTab=="function"&&switchSettingsTab("profile"))}catch(w){console.warn("[v118.12.3] failed to fix active tab:",w)}if(window.PEARNLY_ADMIN_MODE){const w=document.getElementById("admin-mode-banner");w&&(w.style.display="flex"),document.querySelectorAll(".nav-item").forEach(h=>{h.classList.contains("nav-admin-only")||(h.style.display="none")}),document.querySelectorAll(".nav-group").forEach(h=>{h.classList.contains("nav-group-admin-only")||(h.style.display="none")});const g=document.getElementById("client-switcher");g&&(g.style.display="none"),document.body.classList.add("admin-mode");const b=["profile","security","notifications","about"];document.querySelectorAll(".settings-tab").forEach(h=>{const _=h.dataset.tab;_&&!b.includes(_)&&(h.style.display="none")}),document.querySelectorAll(".settings-pane").forEach(h=>{const _=h.dataset.pane;_&&!b.includes(_)&&(h.style.display="none")}),document.querySelectorAll(".settings-nav-group").forEach(h=>{const _=h.querySelectorAll(".settings-tab");Array.from(_).some(k=>k.style.display!=="none")||(h.style.display="none")})}}function si(){const e=_userInfo,n=document.getElementById("info-bar");if(!e||shouldHideMoney(e)){n&&(n.innerHTML="");return}let a="";const o=e.tenant_type;if(o==="byo_api")e.has_own_gemini_key?a=`
        ...
        `;else{const s=e.tenant_used!=null?e.tenant_used:e.used_this_month||0,i=e.tenant_quota!=null&&e.tenant_quota>0?e.tenant_quota:e.monthly_quota||0,r=i>0?Math.min(100,s/i*100):0;let c="";r>=95?c="danger":r>=80&&(c="warn"),i>0?a=`
            ...
            `:a=""}n&&(n.innerHTML=a)}window.renderQuotaBanner=ai;window.applySidebarVisibility=oi;window.renderInfoBar=si;async function yo(e,n){try{const a=await fetch(e,{method:"POST",headers:{Authorization:"Bearer "+token,"Content-Type":"application/json"},body:JSON.stringify(n)});if(a.status===401){localStorage.removeItem("mrpilot_token");const o=await a.json().catch(()=>({}));return(typeof o.detail=="string"?o.detail:o.detail&&o.detail.code||"")==="auth.session_revoked"?(_showSessionRevokedModal(),null):(window.location.href="/",null)}return await a.json()}catch{return{ok:!1,error:"network"}}}function wo(e){return{invalid_format:"rd-err-format",not_found:"rd-err-not-found",rd_unreachable:"rd-err-unreachable",parse_error:"rd-err-unknown",network:"rd-err-unreachable"}[e]||"rd-err-unknown"}function en(e){const n=document.querySelector(`[data-field="${e}"]`);return n?(n.value||"").trim():""}function Ye(e,n,a){const o=document.querySelector(`[data-rd-status="${e}"]`);o&&(o.innerHTML=n,o.className="rd-status"+(a?" "+a:""))}async function ii(e){const a=en(e==="seller"?"seller_tax":"buyer_tax");Ye(e,t("rd-verifying"),"loading");const o=await yo("/api/rd/verify",{tax_id:a});if(!o)return;if(!o.ok){Ye(e,t(wo(o.error)),"error");return}o.data&&o.data.valid?Ye(e,`<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="2"><path d="M3 8l3 3 7-7"/></svg> ${escapeHtml(t("rd-status-valid"))}`,"valid"):Ye(e,t("rd-status-invalid"),"invalid")}async function ri(e){const a=en(e==="seller"?"seller_tax":"buyer_tax");Ye(e,t("rd-syncing"),"loading");const o=await yo("/api/rd/lookup",{tax_id:a,branch:0});if(o){if(!o.ok){Ye(e,t(wo(o.error)),"error");return}Ye(e,`<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="2"><path d="M3 8l3 3 7-7"/></svg> ${escapeHtml(t("rd-status-valid"))}`,"valid"),li(e,o.data)}}function li(e,n){const a=e==="seller"?"seller_name":"buyer_name",o=e==="seller"?"seller_addr":"buyer_addr",s=en(a),i=en(o),r=[];n.name&&n.name!==s&&r.push({field:a,label:t("rd-field-name"),current:s,official:n.name}),n.address&&n.address!==i&&r.push({field:o,label:t("rd-field-address"),current:i,official:n.address});const c=[];n.branch_label&&c.push(`<strong>${t("rd-field-branch")}:</strong> ${escapeHtml(n.branch_label)}`),n.post_code&&c.push(`<strong>${t("rd-field-postcode")}:</strong> ${escapeHtml(n.post_code)}`);let m=document.getElementById("rd-sync-modal");if(m||(m=document.createElement("div"),m.id="rd-sync-modal",m.className="rd-modal-mask",document.body.appendChild(m)),r.length===0)m.innerHTML=`
            <div class="rd-modal">
    ...
    `;let s=_results.map((r,c)=>({...r,_idx:c}));if(_searchKeyword){const r=_searchKeyword.toLowerCase();s=s.filter(c=>(c.filename||"").toLowerCase().includes(r)||(c.merged_fields.invoice_number||"").toLowerCase().includes(r))}_sortKey&&s.sort((r,c)=>{let m,d;return _sortKey==="filename"?(m=r.filename,d=c.filename):_sortKey==="invoice_no"?(m=r.merged_fields.invoice_number,d=c.merged_fields.invoice_number):_sortKey==="invoice_date"?(m=r.merged_fields.date,d=c.merged_fields.date):_sortKey==="total"?(m=parseFloat(r.merged_fields.total_amount)||0,d=parseFloat(c.merged_fields.total_amount)||0):_sortKey==="confidence"?(m=r.confidence,d=c.confidence):(m="",d=""),m<d?_sortDir==="asc"?-1:1:m>d?_sortDir==="asc"?1:-1:0});const i=document.getElementById("results-tbody");i.innerHTML=s.map((r,c)=>{const m=r.merged_fields,d=`<span class="empty-cell">${t("empty-val")}</span>`,p="conf-tip-"+(r.confidence||"low"),l="conf-"+(r.confidence||"low"),u=t(p),f=t(l);return`
        ...
        `}).join(""),document.querySelectorAll("#results-table th").forEach(r=>{r.classList.remove("sort-asc","sort-desc"),r.dataset.sort===_sortKey&&r.classList.add("sort-"+_sortDir)}),i.querySelectorAll("tr").forEach(r=>{r.addEventListener("click",()=>{const c=parseInt(r.dataset.idx,10);_o(c)})})}document.querySelectorAll("#results-table th").forEach(e=>{e.classList.contains("no-sort")||e.addEventListener("click",()=>{const n=e.dataset.sort;_sortKey===n?_sortDir=_sortDir==="asc"?"desc":"asc":(_sortKey=n,_sortDir="asc"),vn()})});let Ia=null;document.getElementById("search-input").addEventListener("input",e=>{const n=e.target.value;document.getElementById("search-clear").style.display=n?"":"none",clearTimeout(Ia),Ia=setTimeout(()=>{_searchKeyword=n.trim(),vn(),xo()},200)});document.getElementById("search-clear").addEventListener("click",()=>{const e=document.getElementById("search-input");e.value="",_searchKeyword="",document.getElementById("search-clear").style.display="none",vn(),xo(),e.focus()});function xo(){const e=document.getElementById("search-matches");if(!e)return;if(!_searchKeyword){e.textContent="";return}const n=_searchKeyword.toLowerCase();let a=0;for(const o of _results)[o.filename,o.merged_fields?.invoice_number,o.merged_fields?.seller_name,o.merged_fields?.buyer_name].filter(Boolean).join(" ").toLowerCase().includes(n)&&a++;e.textContent=t("search-matches",{n:a})}function _o(e){_drawerIdx=e;const n=_results[e];if(!n)return;document.getElementById("drawer-title").textContent=n.filename;const a=n.engine==="cache"||n.from_cache,o=a?t("badge-cached-hint"):`${(n.elapsed_ms/1e3).toFixed(1)}s`;document.getElementById("drawer-sub").innerHTML=`
    ...
    `,d=i?"":`<span class="tax-badge unverified" data-tip="${escapeHtml(t("tax-tip-unverified"))}">${t("tax-unverified")}</span>`;if(c.innerHTML=`
        ...
        <div class="drawer-section">
            ...
            ${r.wht_amount||r.wht_rate?`
                ${me("wht_amount","drawer-lbl-wht-amount",r.wht_amount,"input",s,ui(r.wht_rate))}
            `:""}
        </div>
        ...
        <div class="drawer-section">
            ...
            ${me("seller_tax","drawer-lbl-tax",r.seller_tax,"input",s,d,La("seller"))}
        ...
        <div class="drawer-section">
            ...
            ${me("buyer_tax","drawer-lbl-tax",r.buyer_tax,"input",s,d,La("buyer"))}
        ...
        <div class="drawer-section">
            ...
            ${r.items&&r.items.length>0?fi(r.items):`<div class="drawer-items-empty">${t("drawer-items-empty")}</div>`}
        </div>
...
`))}</pre>
    ...
    `,s?c.querySelectorAll("[data-field]").forEach(p=>{p.addEventListener("input",onFieldEdit)}):c.querySelectorAll("[data-field]").forEach(p=>{p.setAttribute("readonly","readonly")}),document.getElementById("drawer-mask").classList.add("show"),document.getElementById("drawer").classList.add("show"),injectOcrPushButton(),typeof window.bindDrawerClient=="function"){const p=n._historyId||n.history_id||null;window.bindDrawerClient(p,n.client_id||null)}typeof window.fillCategoryDatalist=="function"&&window.fillCategoryDatalist(),setTimeout(()=>{const p=document.getElementById("drawer-cat-input");p&&!p.value&&!p.readOnly&&p.focus()},80)}function ui(e){return e?`<span class="wht-badge">${escapeHtml(e)}%</span>`:""}function me(e,n,a,o,s,i,r){const c=_results[_drawerIdx],m=c&&c.edits[e]!==void 0?c.edits[e]:a,d=c&&c.edits[e]!==void 0&&c.edits[e]!==a,p=escapeHtml(m??""),l=s?"":"readonly",u=o==="textarea"?`<textarea data-field="${e}" rows="2">${p}</textarea>`:`<input type="text" data-field="${e}" value="${p}">`;return`
    ...
    `;n.innerHTML=o+s,e.appendChild(n)}function Bn(){const e=document.getElementById("export-dropdown");e&&e.remove()}const In=document.getElementById("btn-export-arrow");In&&In.addEventListener("click",e=>{e.stopPropagation(),!In.disabled&&yi()});document.addEventListener("click",e=>{const n=e.target.closest(".export-dd-item");if(n){const a=n.getAttribute("data-tpl");if(a==="__custom"){Bn(),showToast(t("cs-coming-soon"),"info");return}bi(a),Bn(),Io(a);return}e.target.closest("#btn-export-arrow")||Bn()});function wi(){const e=document.getElementById("btn-export-arrow"),n=document.getElementById("btn-export");e&&n&&(e.disabled=n.disabled)}setInterval(wi,300);const ki=`
        <div class="page-head-clean">
            <div class="page-head-icon">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
...
`;(function(){const e=document.getElementById("page-history");if(!(!e||e.dataset.wbInjected==="1")){e.innerHTML=ki,e.dataset.wbInjected="1";try{const n=window._currentLang||localStorage.getItem("mrpilot_lang")||"th",a=window.I18N;a&&a[n]&&(e.querySelectorAll("[data-i18n]").forEach(o=>{const s=o.getAttribute("data-i18n");a[n][s]&&(o.textContent=a[n][s])}),e.querySelectorAll("[data-i18n-placeholder]").forEach(o=>{const s=o.getAttribute("data-i18n-placeholder");a[n][s]&&(o.placeholder=a[n][s])}))}catch{}}})();function Wn(){const e=document.getElementById("history-batch-bar"),n=document.getElementById("history-batch-count"),a=document.getElementById("history-check-all");if(!e||!n)return;const o=_historySelected.size;if(o>0?(e.style.display="",n.textContent=t("history-batch-count",{n:o})):e.style.display="none",a){const s=_historyState.items||[];if(s.length===0)a.checked=!1,a.indeterminate=!1;else{const i=s.filter(r=>_historySelected.has(r.id)).length;a.checked=i===s.length,a.indeterminate=i>0&&i<s.length}}}function xi(){_historySelected.clear(),Wn()}async function Yn(){if(!_userInfo){setTimeout(()=>Yn(),300);return}const e=document.getElementById("history-free-block"),n=document.getElementById("history-main"),a=document.getElementById("history-empty");if(!e||!n||!a){console.warn("[History] container missing");return}if(!_userInfo.can_view_history){e.style.display="",n.style.display="none",a.style.display="none";return}e.style.display="none",_historyState.loading=!0;try{const o=_historyState.page*_historyState.pageSize,s=new URLSearchParams({limit:_historyState.pageSize,offset:o});_historyState.keyword&&s.set("keyword",_historyState.keyword);const i=typeof window.getCurrentClientId=="function"?window.getCurrentClientId():null;i&&s.set("client_id",String(i));const r=await fetch(`/api/history?${s}`,{headers:{Authorization:"Bearer "+token}});if(r.status===401){localStorage.removeItem("mrpilot_token");const d=await r.json().catch(()=>({}));if((typeof d.detail=="string"?d.detail:d.detail&&d.detail.code||"")==="auth.session_revoked"){_showSessionRevokedModal();return}window.location.href="/";return}const c=await r.json();_historyState.items=c.items||[],_historyState.total=c.total||0;const m=new Set(_historyState.items.map(d=>d.id));for(const d of Array.from(_historySelected))m.has(d)||_historySelected.delete(d);Lo()}catch(o){console.error("load history failed",o)}finally{_historyState.loading=!1}}function Lo(){const e=document.getElementById("history-main"),n=document.getElementById("history-empty"),a=_historyState.items,o=document.getElementById("history-search-matches");if(o&&(o.textContent=_historyState.keyword?t("search-matches",{n:_historyState.total}):""),a.length===0&&_historyState.total===0&&!_historyState.keyword){e.style.display="none",n.style.display="";return}e.style.display="",n.style.display="none";let s=0;a.forEach(d=>{d.confidence==="high"&&s++});const i=a.length>0?Math.round(s/a.length*100):0;document.getElementById("history-stats").innerHTML=`
    ...
    `;const r=document.getElementById("history-tbody");a.length===0?r.innerHTML=`<div class="history-row-empty">${escapeHtml(t("history-empty-title"))}</div>`:r.innerHTML=a.map(d=>{const p=new Date(d.created_at),l=String(p.getMonth()+1).padStart(2,"0"),u=String(p.getDate()).padStart(2,"0"),f=String(p.getHours()).padStart(2,"0"),v=String(p.getMinutes()).padStart(2,"0"),w=`${l}-${u} ${f}:${v}`,g=escapeHtml(d.filename||""),b=g.length>50?g.substring(0,50)+"…":g,h=d.invoice_no?escapeHtml(d.invoice_no):b,_=[];d.seller_name&&_.push(escapeHtml(d.seller_name)),d.invoice_no&&d.filename&&_.push(b);const y=_.join(" · ")||"-",k=d.category_tag?`<span class="history-badge category">${escapeHtml(d.category_tag)}</span>`:"",x=d.source_total&&d.source_total>1?`<span class="history-badge multi">${escapeHtml(t("invoice-part-of",{i:d.source_index||1,n:d.source_total}))}</span>`:"",E=d.total_amount!==null&&d.total_amount!==void 0?Number(d.total_amount).toLocaleString(void 0,{minimumFractionDigits:2,maximumFractionDigits:2}):'<span class="history-cell-amount-empty">—</span>',B=[];(d.total_amount===null||d.total_amount===void 0)&&B.push(t("field-amount")),d.invoice_no||B.push(t("field-invoice-no")),d.invoice_date||B.push(t("field-invoice-date")),d.seller_name||B.push(t("field-seller-name")),B.length>0&&`${escapeHtml(d.id)}${escapeHtml(t("history-needs-review-tip")+" · "+B.join(" · "))}${escapeHtml(t("history-needs-review-tip"))}${svgIcon("alert",14)}`,d.edited&&`${escapeHtml(t("history-edited",{n:d.edit_count||1}))}`;const I=d.smart_assigned_flag?`<span class="history-badge smart-assigned" title="${escapeHtml(t("history-smart-assigned"))}">${svgIcon("sparkle",11)}</span>`:"",L=d.confidence==="high"?"high":d.confidence==="medium"?"mid":"low",C=d.confidence==="high"?t("conf-high"):d.confidence==="medium"?t("conf-medium"):t("conf-low"),S=`<span class="history-badge conf-${L}">${escapeHtml(C)}</span>`;let F="";const A=d.source||"manual";return A==="email"?F=`<span class="history-badge source source-email" title="${escapeHtml(t("history-source-email"))}">${svgIcon("mail",11)}<span>${escapeHtml(t("history-source-email"))}</span></span>`:A==="folder"?F=`<span class="history-badge source source-folder" title="${escapeHtml(t("history-source-folder"))}">${svgIcon("folder",11)}<span>${escapeHtml(t("history-source-folder"))}</span></span>`:A==="api"&&(F=`<span class="history-badge source source-api" title="${escapeHtml(t("history-source-api"))}">${svgIcon("api",11)}<span>${escapeHtml(t("history-source-api"))}</span></span>`),`
                <div class="history-row" data-hid="${escapeHtml(d.id)}">
                    ...
                    <div class="history-cell-file">
                        <div class="history-cell-filename">${h} ${k} ${x} ${F} ${I}</div>
    ...
    `,e.appendChild(n),document.getElementById("btn-save-history").addEventListener("click",Li),document.getElementById("btn-push-erp").addEventListener("click",Ii)}async function Bi(e){}async function Ii(){showToast(t("erp-push-coming-soon")||"ERP 推送即将开放，敬请期待","info")}async function Li(){const e=_results[_drawerIdx];if(!e||!e._historyId)return;const n=JSON.parse(JSON.stringify(e.pages||[]));if(n.length>0){const o=n.findIndex(c=>!c.is_duplicate&&!c.is_copy),s=o>=0?o:0,i=n[s].fields||(n[s].fields={}),r={...e.edits};r.category_tag!==void 0&&(r.category=r.category_tag,delete r.category_tag),Object.assign(i,r)}const a=document.getElementById("btn-save-history");a&&(a.disabled=!0);try{if(!(await fetch(`/api/history/${encodeURIComponent(e._historyId)}`,{method:"PUT",headers:{Authorization:"Bearer "+token,"Content-Type":"application/json"},body:JSON.stringify({pages:n})})).ok)throw new Error("save failed");showAlert("info",t("history-save-ok")),setTimeout(hideAlerts,1500),closeDrawer(),e._historyMode&&_results.pop(),loadHistoryPage()}catch{showAlert("error",t("history-save-fail")),a&&(a.disabled=!1)}}function Ci(e,n){document.querySelectorAll(".history-popover").forEach(d=>d.remove());const a=n.getBoundingClientRect(),o=(_historyState.items||[]).find(d=>d.id===e),s=o&&o.invoice_no?String(o.invoice_no):"",i=o&&o.has_pdf===!0,r=document.createElement("div");r.className="history-popover",r.innerHTML=`
...
`;fe("camera-tips-modal",$i);async function nn(e){return new Promise(n=>{const a=new FileReader;a.onerror=()=>n({warnings:[],width:0,height:0,brightness:128}),a.onload=()=>{const o=new Image;o.onerror=()=>n({warnings:[],width:0,height:0,brightness:128}),o.onload=()=>{const s=[],i=o.naturalWidth,r=o.naturalHeight;(i<1e3||r<1e3)&&s.push("low_res");try{const c=document.createElement("canvas");c.width=64,c.height=64;const m=c.getContext("2d");m.drawImage(o,0,0,64,64);const d=m.getImageData(0,0,64,64).data;let p=0,l=0;for(let f=0;f<d.length;f+=4)p+=.299*d[f]+.587*d[f+1]+.114*d[f+2],l++;const u=l?p/l:128;u<70?s.push("too_dark"):u>235&&s.push("too_bright"),n({warnings:s,width:i,height:r,brightness:u})}catch{n({warnings:s,width:i,height:r,brightness:128})}},o.src=a.result},a.readAsDataURL(e)})}async function So(e){if(!e||e.length===0)return null;const{jsPDF:n}=window.jspdf,a=210,o=297,s=new n({unit:"mm",format:"a4",orientation:"p"});for(let d=0;d<e.length;d++){const p=e[d],{dataUrl:l,naturalW:u,naturalH:f}=await Hi(p);d>0&&s.addPage("a4","p");const v=u/f;let w=a-10,g=w/v;g>o-10&&(g=o-10,w=g*v);const b=(a-w)/2,h=(o-g)/2,_=p.type==="image/png"?"PNG":"JPEG";s.addImage(l,_,b,h,w,g,void 0,"FAST")}const i=s.output("blob"),r=new Date,c=r.getFullYear().toString()+String(r.getMonth()+1).padStart(2,"0")+String(r.getDate()).padStart(2,"0")+String(r.getHours()).padStart(2,"0")+String(r.getMinutes()).padStart(2,"0")+String(r.getSeconds()).padStart(2,"0"),m=e.length>1?`_${e.length}p`:"";return new File([i],`photo_${c}${m}.pdf`,{type:"application/pdf"})}function Hi(e){return new Promise((n,a)=>{const o=new FileReader;o.onerror=a,o.onload=()=>{const s=new Image;s.onerror=a,s.onload=()=>n({dataUrl:o.result,naturalW:s.naturalWidth,naturalH:s.naturalHeight}),s.src=o.result},o.readAsDataURL(e)})}(function(){const n=document.getElementById("upload-alt-row"),a=document.getElementById("gallery-input"),o=document.getElementById("camera-input");if(!n)return;n.style.display="";const s=document.getElementById("btn-scan-doc");s&&o&&(s.addEventListener("click",async()=>{!(localStorage.getItem("mrpilot_camera_tips_skip")==="1")&&!await ji()||o.click()}),o.addEventListener("change",async c=>{const m=Array.from(c.target.files||[]);if(c.target.value="",m.length!==0)for(const d of m)await Dn([d],"camera")}));const i=document.getElementById("btn-upload-pic");i&&a&&i.addEventListener("click",()=>a.click());const r=c=>async m=>{const d=Array.from(m.target.files||[]);if(m.target.value="",d.length===0)return;const p=d.filter(u=>u.type==="application/pdf"||/\.pdf$/i.test(u.name)),l=d.filter(u=>!p.includes(u));p.length>0&&await Ai(p),l.length>0&&await Dn(l,c)};a&&a.addEventListener("change",r("gallery"))})();async function Ai(e){for(const a of e)_selectedFiles.push({file:a,name:a.name,size:a.size,status:"waiting",errorKey:null,errorParams:null});const n=getMaxFiles();_selectedFiles.length>n&&(showAlert("warn",t("alert-file-count",{n})),_selectedFiles=_selectedFiles.slice(0,n)),renderFileList(),updateStartButton()}function ji(){return new Promise(e=>{const n=document.getElementById("camera-tips-modal"),a=document.getElementById("camera-tips-ok"),o=document.getElementById("camera-tips-cancel"),s=document.getElementById("camera-tips-skip");if(!n||!a){e(!0);return}s&&(s.checked=!1),n.style.display="flex";const i=c=>{n.style.display="none",s&&s.checked&&localStorage.setItem("mrpilot_camera_tips_skip","1"),a.onclick=null,o&&(o.onclick=null),n.onclick=null,document.removeEventListener("keydown",r),e(c)},r=c=>{c.key==="Escape"&&i(!1)};a.onclick=()=>i(!0),o&&(o.onclick=()=>i(!1)),n.onclick=c=>{c.target===n&&i(!1)},document.addEventListener("keydown",r),setTimeout(()=>a.focus(),50)})}let Ee=[],We=null;async function Dn(e,n){if(hideAlerts(),!(!e||e.length===0)){var a=typeof window.getOcrDocumentMode=="function"?window.getOcrDocumentMode():"invoice";if(a==="thai_id_card"){for(const s of e)_selectedFiles.push({file:s,name:s.name,size:s.size,status:"waiting",errorKey:null,errorParams:null});const o=getMaxFiles();_selectedFiles.length>o&&(showAlert("warn",t("alert-file-count",{n:o})),_selectedFiles=_selectedFiles.slice(0,o)),renderFileList(),updateStartButton();return}if(typeof window.jspdf>"u"||!window.jspdf.jsPDF){showToast(t("camera-loading"),"info");for(let o=0;o<30&&(await new Promise(s=>setTimeout(s,100)),!(window.jspdf&&window.jspdf.jsPDF));o++);if(!window.jspdf||!window.jspdf.jsPDF){showToast(t("camera-lib-fail"),"error");return}}if(n==="camera"&&e.length===1){const o=e[0];let s={};try{s=await nn(o)}catch{}Ee.push({file:o,quality:s}),We="camera",ct();return}if(n==="gallery"&&(e.length>=2||Ee.length>0)){for(const o of e){let s={};try{s=await nn(o)}catch{}Ee.push({file:o,quality:s})}We="gallery",ct();return}await To(e)}}async function Pi(e){const n=new Set;for(const o of e)try{((await nn(o)).warnings||[]).forEach(i=>n.add(i))}catch{}try{const o=await So(e);o&&_selectedFiles.push({file:o,name:o.name,size:o.size,status:"waiting",errorKey:null,errorParams:null})}catch(o){console.error("[camera] convert failed",o),showToast(t("camera-convert-fail"),"error");return}const a=getMaxFiles();_selectedFiles.length>a&&(showAlert("warn",t("alert-file-count",{n:a})),_selectedFiles=_selectedFiles.slice(0,a)),renderFileList(),updateStartButton(),showToast(t("camera-added-merged",{n:e.length}),"success"),n.size>0&&setTimeout(()=>{n.has("too_dark")?showToast(t("camera-quality-dark"),"warn"):n.has("low_res")?showToast(t("camera-quality-lowres"),"warn"):n.has("too_bright")&&showToast(t("camera-quality-overexposed"),"warn")},1e3)}function ct(){let e=document.getElementById("camera-buffer-bar");if(Ee.length===0){e&&e.remove(),We=null;return}e||(e=document.createElement("div"),e.id="camera-buffer-bar",e.className="camera-buffer-bar",document.body.appendChild(e));const n=Ee.length,a=n>=2,o=We==="gallery",s=o?t("camera-buffer-more-gallery"):t("camera-buffer-more");let i;a?o?i=`
    ...
    `;fe("page-test-center",Ui);const Po="v118.28.5",aa="pearnly_tc_results_"+Po,Ae=[{id:"A1",group:"A · 异常栏 page-head(BUG1)",desc:"手机宽度进异常栏 · 标题「异常栏」横排正常 · 不再每字一行"},{id:"A2",group:"A · 异常栏 page-head(BUG1)",desc:"副标题「所有被规则拦截的单据集中复核…」也横排正常 · 不竖排"},{id:"A3",group:"A · 异常栏 page-head(BUG1)",desc:"客户筛选下拉 + 刷新按钮换到新一行 · 不抢标题宽度"},{id:"B1",group:"B · 客户管理 page-head(BUG2)",desc:"手机宽度进客户管理 · 标题「客户管理」横排正常"},{id:"B2",group:"B · 客户管理 page-head(BUG2)",desc:"副标题「为每家客户单独归档发票…」横排正常 · 不竖排"},{id:"B3",group:"B · 客户管理 page-head(BUG2)",desc:"「+ 新建客户」按钮换到新一行 · 不挤标题"},{id:"C1",group:"C · 客户卡片(BUG3)",desc:"客户卡片「编辑 / 导出本月」按钮文字清晰 · 不被截断"},{id:"D1",group:"D · 历史表头(BUG4)",desc:"手机宽度进单据记录 · 表头「文件·发票号·供应商」/「金额」单行 · 不竖排"},{id:"D2",group:"D · 历史表头(BUG4)",desc:"行内 INV-TH-202605-1006 这种长发票号正常单行展示 · 不一字一行"},{id:"E1",group:"E · 对账切换器(BUG6)",desc:"手机宽度进对账中心 · 顶栏点「全部客户」chip · 下拉从右上角向下展开 · 右对齐 · 不贴左屏边"},{id:"E2",group:"E · 对账切换器(BUG6)",desc:"下拉宽度自适应屏幕 · 不超出屏幕右边"},{id:"F1",group:"F · 通用设置回归",desc:"设置 → 个人资料 · 没有「界面语言」4 按钮卡"},{id:"F2",group:"F · 通用设置回归",desc:"左侧 nav 顺序:账户 / 公司 / 工作流 / 系统 / 关于"},{id:"F3",group:"F · 通用设置回归",desc:"系统 → 通用设置 · 4 行下拉(语言/时区/日期/数字)· 改语言立即切语言 · 改其他保存后 F5 仍保留"},{id:"G1",group:"G · 移动端 settings(回归)",desc:"手机宽度设置 tabs 不重叠 · 按分组分行 · chip 风格"},{id:"H1",group:"H · 回归",desc:"OCR 上传识别 / 客户管理 / 异常栏 / 对账中心 / 测试中心 全部仍工作"},{id:"H2",group:"H · 回归",desc:"4 语切换没新增异常(测试中心异常日志「API 失败」过滤无新条目)"},{id:"I1",group:"I · 三档移动 viewport",desc:"iPhone SE 375 · 上述 BUG 1-6 都修了"},{id:"I2",group:"I · 三档移动 viewport",desc:"Galaxy S 360 · 上述 BUG 1-6 都修了"},{id:"I3",group:"I · 三档移动 viewport",desc:"iPhone 12 Pro 414 · 上述 BUG 1-6 都修了"}],W={results:{},logFilter:"all",bound:!1,renderScheduled:!1,checkN:0};function be(e,n,a){let o=typeof t=="function"?t(e):null;return(!o||o===e)&&(o=n),a&&Object.keys(a).forEach(function(s){o=String(o).replace("{"+s+"}",String(a[s]))}),o}function Gi(){try{const e=localStorage.getItem(aa);W.results=e?JSON.parse(e):{},(typeof W.results!="object"||!W.results)&&(W.results={})}catch{W.results={}}}function Sa(){try{localStorage.setItem(aa,JSON.stringify(W.results))}catch{}}function oa(e){const n=new Date(e),a=function(o){return o<10?"0"+o:""+o};return a(n.getHours())+":"+a(n.getMinutes())+":"+a(n.getSeconds())}function _e(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function je(e,n){try{typeof showToast=="function"?showToast(e,n||"info"):alert(e)}catch{}}function Ta(e){try{navigator.clipboard&&navigator.clipboard.writeText?navigator.clipboard.writeText(e).then(function(){je(be("tc-toast-copied","已复制到剪贴板"),"success")}).catch(function(){Ln(e)}):Ln(e)}catch{Ln(e)}}function Ln(e){try{const n=document.createElement("textarea");n.value=e,n.style.position="fixed",n.style.opacity="0",document.body.appendChild(n),n.select();const a=document.execCommand("copy");document.body.removeChild(n),je(a?be("tc-toast-copied","已复制"):be("tc-toast-copy-fail","复制失败"),a?"success":"error")}catch{je(be("tc-toast-copy-fail","复制失败"),"error")}}function Ki(){const e=[],n=new Date,a=_userInfo&&(_userInfo.email||_userInfo.username)||"—";e.push("# Pearnly "+Po+" 测试结果"),e.push("- 账号:"+a),e.push("- 时间:"+n.toISOString().replace("T"," ").slice(0,19));const o=Ae.length,s=Ae.filter(function(p){return W.results[p.id]==="pass"}).length,i=Ae.filter(function(p){return W.results[p.id]==="fail"}).length,r=Ae.filter(function(p){return W.results[p.id]==="skip"}).length,c=o-s-i-r;e.push("- 进度:"+(s+i+r)+" / "+o+" · ✅ "+s+" · ❌ "+i+" · ⏭ "+r+" · 未测 "+c),e.push(""),e.push("| ID | 描述 | 状态 |"),e.push("|---|---|---|"),Ae.forEach(function(p){const l=W.results[p.id],u=l==="pass"?"✅":l==="fail"?"❌":l==="skip"?"⏭":"⬜";e.push("| "+p.id+" | "+p.desc.replace(/\|/g,"\\|")+" | "+u+" |")});const m=Ae.filter(function(p){return W.results[p.id]==="fail"});m.length>0&&(e.push(""),e.push("## ❌ 失败项"),m.forEach(function(p){e.push("- **"+p.id+"** · "+p.desc)}));const d=(window._pearnlyTcLogs||[]).slice(-30).reverse();return d.length>0&&(e.push(""),e.push("## 🔴 异常日志(最近 "+d.length+" 条)"),d.forEach(function(p){if(e.push("- `"+oa(p.ts)+"` · **"+p.type+"** · "+p.summary),p.detail){let l;try{l=JSON.stringify(p.detail)}catch{l=String(p.detail)}l&&l!=="{}"&&e.push("  - "+l.slice(0,600))}})),e.join(`
`)}function Ji(e){const n=(window._pearnlyTcLogs||[]).slice(-30).reverse();if(n.length===0)return"(暂无异常日志)";const a=["# Pearnly 异常日志(最近 "+n.length+" 条)"],o=_userInfo&&(_userInfo.email||_userInfo.username)||"—";return a.push("- 账号:"+o),a.push("- 当前页:"+(currentRoute||"?")),a.push("- UA:"+navigator.userAgent),a.push(""),n.forEach(function(s){if(a.push("## `"+oa(s.ts)+"` · "+s.type),a.push("- "+s.summary),s.detail){a.push("```");try{a.push(JSON.stringify(s.detail,null,2).slice(0,2e3))}catch{a.push(String(s.detail).slice(0,2e3))}a.push("```")}}),a.join(`
`)}(function(){function e(){const v=document.getElementById("tc-account-chip"),w=document.getElementById("tc-progress-chip");if(v&&(v.textContent=_userInfo&&(_userInfo.email||_userInfo.username)||"—"),w){const g=Ae.length,b=Ae.filter(function(h){return W.results[h.id]}).length;w.textContent=b+" / "+g}}function n(){const v=document.getElementById("tc-checklist-body");if(!v)return;const w={};Ae.forEach(function(b){w[b.group]||(w[b.group]=[]),w[b.group].push(b)});const g=[];Object.keys(w).forEach(function(b){g.push('<div class="tc-checklist-group">'),g.push('<div class="tc-checklist-group-title">'+_e(b)+"</div>"),w[b].forEach(function(h){const _=W.results[h.id]||"",y=_?"is-"+_:"";g.push('<div class="tc-check-item '+y+'" data-id="'+_e(h.id)+'"><div class="tc-check-id">'+_e(h.id)+'</div><div class="tc-check-desc">'+_e(h.desc)+'</div><div class="tc-check-actions">'+a(h.id,"pass",_)+a(h.id,"fail",_)+a(h.id,"skip",_)+"</div></div>")}),g.push("</div>")}),v.innerHTML=g.join("")}function a(v,w,g){const b=g===w,h={pass:'<svg viewBox="0 0 20 20" fill="none" stroke="currentColor" stroke-width="2.4" stroke-linecap="round" stroke-linejoin="round"><polyline points="4,11 8,15 16,5"/></svg>',fail:'<svg viewBox="0 0 20 20" fill="none" stroke="currentColor" stroke-width="2.4" stroke-linecap="round" stroke-linejoin="round"><line x1="5" y1="5" x2="15" y2="15"/><line x1="15" y1="5" x2="5" y2="15"/></svg>',skip:'<svg viewBox="0 0 20 20" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"><line x1="5" y1="10" x2="15" y2="10"/></svg>'},_={pass:be("tc-status-pass","通过"),fail:be("tc-status-fail","失败"),skip:be("tc-status-skip","跳过")};return'<button type="button" class="tc-status-btn '+(b?"is-active "+w:"")+'" data-id="'+_e(v)+'" data-kind="'+w+'" title="'+_e(_[w])+'">'+h[w]+"</button>"}function o(v){return W.logFilter==="all"?!0:W.logFilter==="js_error"?v.type==="js_error"||v.type==="promise_error":W.logFilter==="api"?v.type==="api_error"||v.type==="api_fail":W.logFilter==="api_slow"?v.type==="api_slow":W.logFilter==="console"?v.type==="console_error"||v.type==="console_warn":!0}function s(){const v=document.getElementById("tc-logs-body"),w=document.getElementById("tc-logs-count");if(!v)return;const g=(window._pearnlyTcLogs||[]).slice().reverse(),b=g.filter(o);if(w&&(w.textContent=String(g.length)),b.length===0){v.innerHTML='<div class="tc-logs-empty">'+_e(be("tc-logs-empty","暂无异常"))+"</div>";return}const h=b.slice(0,100).map(function(_){const y=typeof _.detail=="object"?JSON.stringify(_.detail,null,2):String(_.detail||"");return'<div class="tc-log-item t-'+_e(_.type)+'" data-ts="'+_.ts+'"><span class="tc-log-time">'+oa(_.ts)+'</span><span class="tc-log-type">'+_e(_.type)+'</span><div class="tc-log-summary">'+_e(_.summary)+'<div class="tc-log-detail">'+_e(y)+"</div></div></div>"}).join("");v.innerHTML=h,document.querySelectorAll("#tc-logs-filter .tc-filter-chip").forEach(function(_){_.classList.toggle("active",_.getAttribute("data-filter")===W.logFilter)})}function i(){W.renderScheduled||(W.renderScheduled=!0,setTimeout(function(){W.renderScheduled=!1,currentRoute==="test-center"&&document.getElementById("page-test-center")&&document.getElementById("page-test-center").classList.contains("active")&&s(),r()},200))}window._tcOnNewLog=i;function r(){const v=document.getElementById("nav-test-badge");if(!v)return;const w=(window._pearnlyTcLogs||[]).filter(function(g){return g.type==="js_error"||g.type==="promise_error"||g.type==="api_error"||g.type==="api_fail"||g.type==="console_error"}).length;w>0?(v.style.display="",v.textContent=w>99?"99+":String(w)):v.style.display="none"}function c(){e(),n(),s(),r()}function m(){const v=Date.now();fetch("/api/health").then(function(w){const g=Date.now()-v;w.ok?je(be("tc-toast-health-ok","后端健康 ✓ {ms}ms",{ms:g}),"success"):je(be("tc-toast-health-fail","后端无响应")+" ("+w.status+")","error")}).catch(function(){je(be("tc-toast-health-fail","后端无响应"),"error")})}function d(){try{localStorage.removeItem(aa),localStorage.removeItem("pearnly_current_client_id"),W.results={},(window._pearnlyTcLogs||[]).length=0,W.logFilter="all",window.setCurrentClientId}catch{}c(),je(be("tc-toast-cleared","session 状态已清空"),"success")}function p(){try{fetch("/api/clients",{headers:{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||"")}}).then(function(v){return v.json()}).then(function(v){window._clientsCache=v.clients||[],typeof window._refreshClientSwitcher=="function"&&window._refreshClientSwitcher(),typeof window._refreshExcClientFilter=="function"&&window._refreshExcClientFilter(),je("客户缓存已刷新 · "+(v.clients||[]).length+" 个客户","success")}).catch(function(){je("刷新失败","error")})}catch{}}function l(){if(W.bound||!document.getElementById("page-test-center"))return;W.bound=!0;const w=document.getElementById("tc-checklist-body");w&&w.addEventListener("click",function(I){const L=I.target.closest(".tc-status-btn");if(!L)return;const C=L.getAttribute("data-id"),S=L.getAttribute("data-kind");!C||!S||(W.results[C]===S?delete W.results[C]:W.results[C]=S,Sa(),n(),e())});const g=document.getElementById("tc-btn-reset-checklist");g&&g.addEventListener("click",function(){W.results={},Sa(),n(),e()});const b=document.getElementById("tc-btn-copy-all");b&&b.addEventListener("click",function(){Ta(Ki())});const h=document.getElementById("tc-btn-copy-logs");h&&h.addEventListener("click",function(){Ta(Ji())});const _=document.getElementById("tc-btn-clear-logs");_&&_.addEventListener("click",function(){(window._pearnlyTcLogs||[]).length=0,s(),r()});const y=document.getElementById("tc-logs-filter");y&&y.addEventListener("click",function(I){const L=I.target.closest(".tc-filter-chip");L&&(W.logFilter=L.getAttribute("data-filter")||"all",s())});const k=document.getElementById("tc-logs-body");k&&k.addEventListener("click",function(I){const L=I.target.closest(".tc-log-item");L&&L.classList.toggle("expanded")});const x=document.getElementById("tc-tool-health");x&&x.addEventListener("click",m);const E=document.getElementById("tc-tool-clear-session");E&&E.addEventListener("click",d);const B=document.getElementById("tc-tool-reload-clients");B&&B.addEventListener("click",p)}function u(){}window._tcApplyVisibility=u;const f=setInterval(function(){W.checkN++,_userInfo&&clearInterval(f),W.checkN>60&&clearInterval(f)},500);window.loadTestCenterPage=function(){Gi(),l(),c()},typeof window.subscribeI18n=="function"&&window.subscribeI18n("test-center",function(){r(),currentRoute==="test-center"&&document.getElementById("page-test-center")&&document.getElementById("page-test-center").classList.contains("active")&&c()})})();(function(){const e="pearnly_active_workspace_client_id",n="pearnly_work_mode";function a(h,_){if(typeof window.t=="function"){const y=window.t(h);if(y&&y!==h)return y}return _}function o(){const h=window._userInfo||{},_=String(h.role||"").toLowerCase(),y=String(h.tenant_role||"").toLowerCase();return h.is_super_admin===!0||h.is_owner===!0||_==="owner"||_==="admin"||y==="owner"||y==="admin"}function s(){return localStorage.getItem(n)==="client"?"client":"personal"}function i(){const h=localStorage.getItem(e);if(!h||h==="null"||h==="0"||h==="")return null;const _=parseInt(h,10);return isNaN(_)?null:_}function r(h){try{window.dispatchEvent(new CustomEvent("pearnly:workspace-changed",{detail:{id:h,mode:s()}}))}catch{}}function c(h){const _=i();h==null||h===0?localStorage.removeItem(e):(localStorage.setItem(e,String(h)),localStorage.setItem(n,"client")),String(_)!==String(h)&&r(h)}function m(){const h=i();localStorage.setItem(n,"personal"),localStorage.removeItem(e),h!=null&&r(null)}async function d(){try{const h=window.apiGet;if(typeof h!="function")return[];const _=await h("/api/workspace/clients");return _&&(_.clients||_.items)||[]}catch{return[]}}async function p(h){if(s()==="client"&&i()!=null)return typeof h=="function"&&h(),!0;const _=a("ws-need-client","这个功能需要先选择工作空间"),y=a("ws-btn-pick","选择工作空间"),k=a("ws-btn-cancel","取消");return typeof window.showConfirm=="function"?await window.showConfirm(_,{okText:y,cancelText:k})&&l(h):window.confirm(_+`

[`+y+" / "+k+"]")&&l(h),!1}async function l(h){const _=await d();if(typeof h=="function"&&s()!=="personal"&&_.length===1){c(Number(_[0].id)),h();return}if(typeof window.openWorkspaceChooserUI=="function"){window.openWorkspaceChooserUI({clients:_,canCreate:o(),active:i(),onPersonal:m,onPick:function(y){c(Number(y)),typeof h=="function"&&h()},emptyHint:_.length?null:o()?a("ws-empty-owner","还没有工作空间。创建一个公司后,上传、对账和 ERP 推送都会归属到该公司。"):a("ws-empty-employee","你还没有可用的工作空间,请联系管理员分配。")});return}if(!_.length){const y=o()?a("ws-empty-owner","还没有工作空间。创建一个公司后,上传、对账和 ERP 推送都会归属到该公司。"):a("ws-empty-employee","你还没有可用的工作空间,请联系管理员分配。");typeof window.showToast=="function"&&window.showToast(y,"info")}}function u(h){const _=h||document.getElementById("workspace-switcher-root");if(!_)return;const y=s(),k=i();let x,E;if(y==="client"&&k!=null){const L=(window._workspaceClientsCache||[]).find(C=>Number(C.id)===Number(k));x=v("building"),E=L?L.name:a("ws-current-label","当前工作空间")}else x=v("user"),E=a("ws-personal","个人事务");_.innerHTML='<button class="ws-ctrl-btn" id="ws-ctrl-btn" type="button">'+x+'<span class="ws-ctrl-label">'+f(E)+"</span></button>";const B=_.querySelector("#ws-ctrl-btn");B&&B.addEventListener("click",()=>l(null))}function f(h){return String(h??"").replace(/[&<>"']/g,function(_){return{"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"}[_]})}function v(h){const _='<svg class="ws-ic" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">';return h==="building"?_+'<rect x="2" y="7" width="20" height="14" rx="2"/><path d="M16 21V5a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v16"/></svg>':_+'<path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/></svg>'}function w(h){h=h||{};const _=h.clients||[],y=h.active,k=document.getElementById("ws-modal");k&&k.remove();const x=document.createElement("div");x.id="ws-modal",x.className="ws-modal";const B='<button type="button" class="ws-modal-item'+(s()==="personal"||y==null?" active":"")+'" data-ws-personal="1"><span class="ws-modal-item-ic">'+v("user")+'</span><span class="ws-modal-item-text" style="display:flex;flex-direction:column;align-items:flex-start;min-width:0;"><span class="ws-modal-item-name">'+f(a("ws-personal","个人事务"))+'</span><span class="ws-modal-item-desc" style="font-size:11px;color:#6b7280;font-weight:400;margin-top:2px;line-height:1.35;white-space:normal;">'+f(a("ws-personal-desc","用于临时识别、测试或处理不归属任何公司的文件。"))+"</span></span></button>";let I="";if(_.length){const A=['<option value="">'+f(a("ws-select-ph","— 选择账套主体 —"))+"</option>"].concat(_.map(function(z){const ee=y!=null&&Number(y)===Number(z.id);return'<option value="'+f(z.id)+'"'+(ee?" selected":"")+">"+f(z.name||"#"+z.id)+"</option>"}));I='<div class="ws-modal-select-row"><label class="ws-modal-select-label">'+f(a("ws-select-label","账套主体"))+'</label><select class="ws-modal-select" data-ws-select="1">'+A.join("")+"</select></div>"}const L=!_.length&&h.emptyHint?'<div class="ws-modal-empty">'+f(h.emptyHint)+"</div>":"",C=h.canCreate?'<div class="ws-modal-create"><button type="button" class="ws-modal-create-toggle" data-ws-create-toggle="1">+ '+f(a("ws-create-client","新建工作空间"))+'</button><div class="ws-modal-create-form" data-ws-create-form style="display:none;"><input type="text" class="ws-modal-create-input" data-ws-create-name placeholder="'+f(a("ws-create-ph","公司名称,例如 BAKELAB"))+'"><button type="button" class="ws-modal-create-submit" data-ws-create-submit="1">'+f(a("ws-create-submit","创建"))+"</button></div></div>":"";x.innerHTML='<div class="ws-modal-box" role="dialog" aria-modal="true"><div class="ws-modal-head"><span class="ws-modal-title">'+f(a("ws-chooser-title","选择工作空间"))+'</span><button type="button" class="ws-modal-close" data-ws-close="1" aria-label="close">✕</button></div><div class="ws-modal-subtitle" style="font-size:12px;color:#6b7280;padding:2px 4px 12px;line-height:1.45;white-space:normal;">'+f(a("ws-chooser-subtitle","账套主体 = 你的公司(发票卖方/开票方)。选择正在为哪家公司做账。"))+'</div><div class="ws-modal-list">'+B+I+"</div>"+L+C+"</div>",document.body.appendChild(x);const S=x.querySelector("[data-ws-select]");S&&S.addEventListener("change",function(){const A=S.value;A&&(typeof h.onPick=="function"&&h.onPick(A),F(),u())});function F(){x.remove()}x.addEventListener("click",function(A){if(A.target===x||A.target.closest("[data-ws-close]")){F();return}if(A.target.closest("[data-ws-personal]")){typeof h.onPersonal=="function"&&h.onPersonal(),F(),u();return}const ee=A.target.closest("[data-ws-pick]");if(ee){const te=ee.getAttribute("data-ws-pick");typeof h.onPick=="function"&&h.onPick(te),F(),u();return}if(A.target.closest("[data-ws-create-toggle]")){const te=x.querySelector("[data-ws-create-form]");if(te){te.style.display=te.style.display==="none"?"flex":"none";const N=te.querySelector("[data-ws-create-name]");N&&N.focus()}return}if(A.target.closest("[data-ws-create-submit]")){g(x,h,F);return}})}async function g(h,_,y){const k=h.querySelector("[data-ws-create-name]"),x=k?(k.value||"").trim():"";if(!x){k&&k.focus();return}let E=null;try{if(typeof window.apiPost=="function"){const I=await window.apiPost("/api/workspace/clients",{name:x});E=I&&typeof I.json=="function"?await I.json().catch(()=>null):I}}catch{E=null}const B=E&&(E.id||E.client&&E.client.id);if(!B){typeof window.showToast=="function"&&window.showToast(a("ws-create-fail","新建工作空间失败 · 请重试"),"error");return}window._workspaceClientsCache=await d(),c(Number(B)),_.onPick,y(),u()}window.openWorkspaceChooserUI=w,window.addEventListener("pearnly:workspace-changed",function(){u()}),window.getWorkMode=s,window.getActiveWorkspaceClientId=i,window.setActiveWorkspaceClientId=c,window.enterPersonalMode=m,window.requireWorkspace=p,window.openWorkspaceChooser=l,window.renderWorkspaceControl=u,window.fetchWorkspaceClients=d;function b(){try{if(sessionStorage.getItem("pearnly_ws_login_prompted")==="1"||i()!=null||localStorage.getItem(n)==="personal")return;sessionStorage.setItem("pearnly_ws_login_prompted","1"),setTimeout(function(){l(null)},800)}catch{}}d().then(h=>{window._workspaceClientsCache=h,u(),b()}),typeof window.subscribeI18n=="function"&&window.subscribeI18n("workspace-switcher",u)})();(function(){const e=y=>document.querySelector('[data-num-target="'+y+'"]');function n(y){if(!y)return t("reconcile-last-activity-none");try{const k=new Date(y),x=new Date,E=x-k;if(E/6e4<5)return t("reconcile-last-activity-just-now");if(k.toDateString()===x.toDateString())return t("reconcile-last-activity-today");const I=Math.max(1,Math.floor(E/(24*3600*1e3)));return t("reconcile-last-activity-days-ago").replace("{n}",I)}catch{return t("reconcile-last-activity-none")}}function a(y,k,x){const E=e(y);E&&(E.textContent=x?"-":String(k),E.classList.toggle("is-empty",!!x))}function o(y){const k=document.getElementById("reconcile-error");k&&(k.style.display=y?"flex":"none")}function s(y){const k=document.getElementById("reconcile-empty");k&&(k.style.display=y?"flex":"none")}function i(y,k){const x=document.getElementById("reconcile-last-activity");x&&(x.textContent=y,x.classList.toggle("has-data",!!k))}function r(y){const k=!y||(y.total_sessions||0)===0;a("pending",y.pending||0,k),a("matched",y.matched||0,k),a("unmatched",y.unmatched||0,k),i(n(y.last_activity_at),!!y.last_activity_at),o(!1),s(k)}function c(y){const k=y.toUpperCase();return k==="KBANK"?"bank-chip-kbank":k==="SCB"?"bank-chip-scb":k==="BBL"?"bank-chip-bbl":k==="KTB"?"bank-chip-ktb":k==="TTB"?"bank-chip-ttb":"bank-chip-other"}function m(y,k){const x=E=>E?String(E).slice(0,10):"?";return!y&&!k?"":x(y)+" ~ "+x(k)}function d(y){return y==null?"":String(y).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function p(y){const k=document.getElementById("reconcile-recent"),x=document.getElementById("reconcile-recent-list");if(!k||!x)return;const E=(y||[]).slice(0,20);if(E.length===0){k.style.display="none";return}k.style.display="",s(!1),x.innerHTML=E.map(B=>{const I=B.parse_status==="parse_failed",L=B.bank_code||"OTHER",C=B.account_last4?" ···"+d(B.account_last4):"",S=m(B.period_start,B.period_end),F=d(B.source_filename||""),A=Number(B.tx_count||0),z=I?'<span class="recon-card-fail" data-i18n="reconcile-card-parse-failed">'+t("reconcile-card-parse-failed")+"</span>":'<span class="recon-card-tx">'+t("reconcile-card-tx").replace("{n}",A)+"</span>";return'<div class="recon-card" data-session-id="'+d(B.id)+'" data-session-name="'+F+'"><span class="bank-chip '+c(L)+'">'+d(L)+'</span><div class="recon-card-main"><div class="recon-card-title">'+F+C+'</div><div class="recon-card-sub">'+d(S)+'</div></div><div class="recon-card-right">'+z+'</div><button class="recon-card-trash" data-trash="'+d(B.id)+'" title="'+d(t("bank-session-delete-tip")||"删除")+'"><svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"><path d="M3 5h10M6 5V3h4v2M5 5l1 9h4l1-9"/></svg></button><svg class="recon-card-arrow" viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M6 4l4 4-4 4"/></svg></div>'}).join(""),x.querySelectorAll(".recon-card").forEach(B=>{B.addEventListener("click",I=>{I.target.closest(".recon-card-trash")||(B.dataset.sessionId,l())})}),x.querySelectorAll(".recon-card-trash").forEach(B=>{B.addEventListener("click",I=>{I.stopPropagation();const L=B.dataset.trash,C=B.closest(".recon-card"),S=C&&C.dataset.sessionName||"";typeof window._deleteBankSession=="function"&&window._deleteBankSession(L,S)})})}function l(y){typeof window.routeTo=="function"&&window.routeTo("reconcile"),setTimeout(function(){const k=document.querySelector('[data-recon-tab="bank"]');k&&k.click()},150)}function u(){o(!0),s(!1)}function f(){typeof window.routeTo=="function"&&window.routeTo("reconcile"),setTimeout(function(){const y=document.querySelector('[data-recon-tab="bank"]');y&&y.click()},150)}async function v(){a("pending",0,!0),a("matched",0,!0),a("unmatched",0,!0),i("",!1),o(!1),s(!1);const y=document.getElementById("reconcile-recent");y&&(y.style.display="none");const k={Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||"")};try{const[x,E]=await Promise.all([fetch("/api/bank-recon/stats",{headers:k}),fetch("/api/bank-recon/sessions?limit=20",{headers:k})]);if(!x.ok)throw new Error("http "+x.status);const B=await x.json(),I=E.ok?await E.json():[];r(B||{}),p(I||[])}catch(x){console.warn("[reconcile] load failed",x),u()}}function w(y){if(!y||!y.length)return;const k="Bearer "+(localStorage.getItem("mrpilot_token")||"");let x=0;const E=y.length;Array.from(y).forEach(function(B){const I=new FormData;I.append("file",B,B.name);const L=new XMLHttpRequest;L.open("POST","/api/bank-recon/upload"),L.setRequestHeader("Authorization",k),L.onload=function(){x++;try{const C=JSON.parse(L.responseText);L.status===200&&C.tx_count!==void 0?showToast((t("bank-upload-ok")||"解析成功 · 共 {n} 条流水").replace("{n}",C.tx_count),"success"):showToast(B.name+" "+(t("upload-failed")||"上传失败"),"error")}catch{showToast(B.name+" "+(t("upload-failed")||"上传失败"),"error")}x===E&&setTimeout(v,600)},L.onerror=function(){x++,showToast(B.name+" "+(t("upload-failed")||"上传失败"),"error"),x===E&&setTimeout(v,600)},L.send(I)}),showToast((t("bank-queue-status-uploading")||"上传中")+"…","info")}function g(){if(window.__reconcileBound)return;window.__reconcileBound=!0;const y=document.getElementById("reconcile-bank-file-input");y&&y.addEventListener("change",function(){w(this.files),this.value=""}),document.addEventListener("click",k=>{if(k.target.closest("#btn-reconcile-upload-top")||k.target.closest("#btn-reconcile-upload-empty")){f();return}if(k.target.closest("#btn-reconcile-retry")){v();return}if(k.target.closest("#btn-reconcile-dev-seed")){_();return}})}const b=["468b50c1-5593-4fd6-990d-515ce8085563"];function h(){const y=document.getElementById("btn-reconcile-dev-seed");if(!y)return;const k=typeof _userInfo<"u"?_userInfo:null,x=k&&k.id&&b.indexOf(String(k.id))>=0;y.style.display=x?"":"none"}async function _(){try{const y=await fetch("/api/bank-recon/_dev/seed",{method:"POST",headers:{Authorization:"Bearer "+token}});if(!y.ok)throw new Error("seed:"+y.status);const k=await y.json(),x=(t("reconcile-dev-seed-ok")||"").replace("{n}",k.tx_count||0);showToast(x,"success"),typeof window.navigateTo=="function"?window.navigateTo("automation"):location.hash="#/automation",setTimeout(()=>{const E=document.querySelector('[data-auto-tab="bank"]');E&&E.click(),k.session_id&&typeof window._openBankSession=="function"&&window._openBankSession(k.session_id)},300)}catch(y){console.warn("[reconcile] dev seed failed",y),showToast(t("reconcile-dev-seed-fail")||"Seed failed","error")}}window.loadReconcilePage=async function(){g(),h(),typeof window._bankReconV2Init=="function"&&window._bankReconV2Init();try{await v()}catch{}},window._rerenderReconcile=function(){typeof currentRoute=="string"&&currentRoute==="reconcile"&&v().catch(()=>{})},typeof window.subscribeI18n=="function"&&window.subscribeI18n("reconcile",window._rerenderReconcile)})();(function(){const e=document.getElementById("assign-clients-modal");if(!(!e||e.dataset.wbInjected==="1")){e.innerHTML=`
    <div class="modal" style="max-width:480px">
        ...
        <div class="modal-foot">
            ...
            <div class="access-log-row access-log-head">
                ...
                </div>`}).join("");p.innerHTML=u+f}function s(){const p=document.getElementById("access-log-pager");if(!p)return;const l=e.total||0;if(!l){p.innerHTML="";return}const u=e.page||1,f=e.per_page,v=Math.max(1,Math.ceil(l/f)),w=(t("set-access-log-pager-total")||"Total {n}").replace("{n}",l),g=(t("set-access-log-pager-page")||"Page {p} / {t}").replace("{p}",u).replace("{t}",v);p.innerHTML=`
...
`,e.dataset.wbInjected="1";try{const n=window._currentLang||localStorage.getItem("mrpilot_lang")||"th",a=window.I18N;a&&a[n]&&(e.querySelectorAll("[data-i18n]").forEach(o=>{const s=o.getAttribute("data-i18n");s&&a[n][s]&&(o.textContent=a[n][s])}),e.querySelectorAll("[data-i18n-placeholder]").forEach(o=>{const s=o.getAttribute("data-i18n-placeholder");s&&a[n][s]&&(o.placeholder=a[n][s])}))}catch{}}})();(function(){const e=k=>document.getElementById(k);async function n(k,x){return await fetch(k,{method:"PATCH",headers:{Authorization:"Bearer "+token,"Content-Type":"application/json"},body:JSON.stringify(x||{})})}async function a(k){return await fetch(k,{method:"DELETE",headers:{Authorization:"Bearer "+token}})}let o=null;async function s(){try{o=await apiGet("/api/line/binding")}catch{o={bound:!1}}return o}function i(k,x){if(!k)return;k.style.display="",k.className="notif-line-check "+(x?"bound":"unbound");const E=x?'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M20 6 9 17l-5-5"/></svg>':'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><path d="M12 8v4M12 16h.01"/></svg>';k.innerHTML=E+"<span>"+escapeHtml(t(x?"notif-line-bound":"notif-line-not-bound"))+"</span>"}function r(k){if(!k)return"-";try{const x=new Date(k),E=(x.getMonth()+1).toString().padStart(2,"0"),B=x.getDate().toString().padStart(2,"0"),I=x.getHours().toString().padStart(2,"0"),L=x.getMinutes().toString().padStart(2,"0");return`${E}-${B} ${I}:${L}`}catch{return k}}function c(k){const x=e("notif-rules-list"),E=e("notif-rules-empty"),B=e("notif-rules-count");if(!(!x||!E)){if(B.textContent=String(k.length),B.className="auto-status-pill "+(k.length>0?"active":"none"),!k.length){E.style.display="",x.style.display="none",x.innerHTML="";return}E.style.display="none",x.style.display="",x.innerHTML=k.map(I=>{const L="notif-rule-exception-tag";let S=[];I.enabled||S.push('<span style="color:#9ca3af;">'+escapeHtml(t("notif-rule-disabled"))+"</span>");const F=S.length?S.join(' <span class="dot"></span> '):"";return`
                <div class="notif-rule-row${I.enabled?"":" disabled"}" data-rule-id="${I.id}">
                    ...
                    <div class="notif-rule-main">
                        ...
                        <div class="notif-rule-meta">${F}</div>
                    </div>
                ...
                </div>`}).join("")}}function m(k){const x=e("notif-logs-list");if(x){if(!k.length){x.innerHTML='<div class="notif-logs-empty">'+escapeHtml(t("notif-logs-empty"))+"</div>";return}x.innerHTML=k.map(E=>{const B=E.status==="sent",I=E.event_type==="exception_high"?"notif-event-exception-high":"notif-event-test-send",L=B?"":" · "+escapeHtml(E.error||"failed");return`
...
`,e.dataset.wbInjected="1";try{const n=window._currentLang||localStorage.getItem("mrpilot_lang")||"th",a=window.I18N;a&&a[n]&&(e.querySelectorAll("[data-i18n]").forEach(o=>{const s=o.getAttribute("data-i18n");s&&a[n][s]&&(o.textContent=a[n][s])}),e.querySelectorAll("[data-i18n-placeholder]").forEach(o=>{const s=o.getAttribute("data-i18n-placeholder");s&&a[n][s]&&(o.placeholder=a[n][s])}))}catch{}}})();(function(){const e=document.getElementById("archive-token-modal");if(!(!e||e.dataset.wbInjected==="1")){e.innerHTML=`
        ...
        `}async function n(){try{const o=await fetch("/api/settings/dup-check",{headers:{Authorization:"Bearer "+token}});if(!o.ok)return;const s=await o.json(),i=document.getElementById("pref-dup-check");i&&(i.checked=!!s.enabled)}catch(o){console.warn("load prefs failed",o)}}const a=document.getElementById("pref-dup-check");a&&!a.dataset.bound&&(a.dataset.bound="1",a.addEventListener("change",async o=>{const s=o.target.checked;try{(await fetch("/api/settings/dup-check",{method:"PUT",headers:{Authorization:"Bearer "+token,"Content-Type":"application/json"},body:JSON.stringify({enabled:s})})).ok?showToast(s?t("pref-dup-check-on-toast"):t("pref-dup-check-off-toast"),"success"):(o.target.checked=!s,showToast(t("pref-save-failed"),"error"))}catch{o.target.checked=!s,showToast(t("pref-save-failed"),"error")}}))})();(function(){const o="pearnly_big_batch_tip_shown";let s=null,i=null,r=0,c=0,m=!1;function d(h){const _=typeof t=="function"?t("big-batch-unload-warn"):"Batch OCR running · close anyway?";return h.preventDefault(),h.returnValue=_,_}function p(){m||(m=!0,window.addEventListener("beforeunload",d))}function l(){m&&(m=!1,window.removeEventListener("beforeunload",d))}function u(){if(document.getElementById("big-batch-progress"))return;const h=document.getElementById("file-list");if(!h||!h.parentNode)return;const _=document.createElement("div");_.id="big-batch-progress",_.className="big-batch-progress",_.innerHTML='<div class="bbp-row"><svg class="bbp-icon" viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><circle cx="8" cy="8" r="6.5"/><path d="M8 4.5v3.5l2.5 1.5"/></svg><span class="bbp-text" id="bbp-text"></span></div><div class="bbp-track"><div class="bbp-fill" id="bbp-fill" style="width:0%"></div></div>',h.parentNode.insertBefore(_,h);const y=document.getElementById("bbp-text");y&&(y.textContent=typeof t=="function"?t("big-batch-progress-init"):"Starting...")}function f(){const h=document.getElementById("big-batch-progress");h&&h.remove()}function v(){if(!i)return;let h=0;for(let L=0;L<i.length;L++){const C=i[L].status;(C==="success"||C==="error"||C==="cancelled")&&h++}const _=r,y=_>0?Math.min(100,Math.floor(100*h/_)):0,k=(Date.now()-c)/1e3;let x;if(h>=3&&k>1){const L=k/h;x=(_-h)*L}else x=(_-h)*6/6;const E=Math.max(1,Math.ceil(x/60)),B=document.getElementById("bbp-fill"),I=document.getElementById("bbp-text");B&&(B.style.width=y+"%"),I&&(h>=_?I.textContent=t("big-batch-progress-done").replace("{total}",_):I.textContent=t("big-batch-progress-running").replace("{done}",h).replace("{total}",_).replace("{min}",E))}function w(h){try{if(localStorage.getItem(o)==="1")return}catch{}const _=Math.max(1,Math.ceil(h*6/6/60)),y=t("big-batch-first-tip").replace("{n}",h).replace("{min}",_);typeof showToast=="function"&&showToast(y,"info",8e3);try{localStorage.setItem(o,"1")}catch{}}function g(h){!h||h.length<100||(i=h,r=h.length,c=Date.now(),u(),p(),w(r),s&&clearInterval(s),s=setInterval(v,250),v())}function b(){s&&(clearInterval(s),s=null),l(),i&&r>=100?(v(),setTimeout(f,1200)):f(),i=null,r=0}window._bigBatchStart=g,window._bigBatchStop=b,typeof window.subscribeI18n=="function"&&window.subscribeI18n("big-batch-progress",function(){i&&v()})})();const de={status:null,statusLoaded:!1,bound:!1};function re(e){return typeof escapeHtml=="function"?escapeHtml(e==null?"":String(e)):String(e??"")}function ue(e,n){try{typeof showToast=="function"&&showToast(e,n||"info")}catch{}}function Ma(){const e=typeof _userInfo<"u"?_userInfo:null;return!!(e&&(e.role==="owner"||e.is_super_admin))}function Do(){try{return(typeof _results<"u"?_results:[])[typeof _drawerIdx<"u"?_drawerIdx:-1]||null}catch{return null}}function Wi(e){if(!e)return!1;const n=String(e.status||"").toLowerCase();return n==="exception"||n==="exception_pending"||n==="rejected"}async function it(e){if(de.statusLoaded&&!e)return de.status;const n=localStorage.getItem("mrpilot_token");if(!n)return null;try{const a=await fetch("/api/erp/xero/status",{headers:{Authorization:"Bearer "+n}});if(!a.ok)throw new Error("http_"+a.status);de.status=await a.json(),de.statusLoaded=!0}catch{de.status={configured:!1,connected:!1,organisations:[]},de.statusLoaded=!1}return de.status}async function Yi(){const e=document.getElementById("drawer-history-save");if(!e||e.querySelector("#btn-xero-push")||e.querySelector("#pn-push-wrap")||(await it(!1),e.querySelector("#pn-push-wrap"))||e.querySelector("#btn-xero-push"))return;const n=Do();if(!(n&&(n._historyId||n.history_id)))return;let o=!1,s="xero-push-tip";!de.status||!de.status.configured?(o=!0,s="xero-err-not_configured"):de.status.connected?Wi(n)&&(o=!0,s="xero-push-disabled-exc"):(o=!0,s="xero-push-disabled-no-conn");const i=document.createElement("button");i.type="button",i.id="btn-xero-push",i.className="btn btn-ghost"+(o?" disabled":""),i.disabled=o,i.title=t(s)||"",i.innerHTML='<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"><circle cx="8" cy="8" r="6"/><path d="M5 8l2 2 4-4"/></svg><span style="margin-left:4px;">'+re(t("xero-push-btn"))+"</span>",i.addEventListener("click",Xi);const r=document.getElementById("btn-push-erp");r&&r.parentNode?r.parentNode.insertBefore(i,r.nextSibling):e.insertBefore(i,e.firstChild)}async function Xi(){const e=Do(),n=e&&(e._historyId||e.history_id);if(!n)return;const a=document.getElementById("btn-xero-push");a&&(a.disabled=!0,a.classList.add("loading"));const o=localStorage.getItem("mrpilot_token");try{const s=await fetch("/api/erp/xero/push/"+encodeURIComponent(n),{method:"POST",headers:{Authorization:"Bearer "+o}});if(!s.ok){let i="unknown";try{i=(await s.json()).detail||"unknown"}catch{}const r=String(i).replace(/^xero\./,"").toLowerCase(),c=t("xero-"+r),m=c&&c!=="xero-"+r?c:i;ue(t("xero-push-fail").replace("{err}",m),"error");return}ue(t("xero-push-ok"),"success")}catch(s){ue(t("xero-push-fail").replace("{err}",s.message||"network"),"error")}finally{a&&(a.disabled=!1,a.classList.remove("loading"))}}async function Zi(){const e=document.getElementById("erp-global-push-mode");if(!e)return;const n=localStorage.getItem("mrpilot_token");if(n)try{const a=await fetch("/api/settings/erp-push-mode",{headers:{Authorization:"Bearer "+n}});if(a.ok){const o=await a.json();o.mode&&(e.value=o.mode,e.dataset.prev=o.mode)}}catch{}}async function Qi(e){const n=e.value,a=localStorage.getItem("mrpilot_token");try{(await fetch("/api/settings/erp-push-mode",{method:"PUT",headers:{Authorization:"Bearer "+a,"Content-Type":"application/json"},body:JSON.stringify({mode:n})})).ok?(e.dataset.prev=n,ue(t("pref-erp-mode-saved"),"success")):(e.value=e.dataset.prev||"smart",ue(t("pref-save-failed"),"error"))}catch{e.value=e.dataset.prev||"smart",ue(t("pref-save-failed"),"error")}}(function(){function e(){const l=document.getElementById("erp-connect-cards");if(!l)return;const u=de.status;let f,v=!1;u?u.configured?u.connected?(v=!0,f='<span class="mrerp-card-pill mrerp-pill-ok">'+re(t("xero-card-connected"))+"</span>"):f='<span class="mrerp-card-pill mrerp-pill-neutral">'+re(t("xero-card-not-connected"))+"</span>":f='<span class="mrerp-card-pill mrerp-pill-neutral">'+re(t("xero-card-not-configured"))+"</span>":f='<span class="mrerp-card-pill mrerp-pill-neutral">'+re(t("xero-card-not-connected"))+"</span>";let w="";if(!u||!u.configured)w='<button type="button" class="int-btn-configure" id="btn-xero-connect">'+re(t("xero-connect-btn"))+"</button>";else if(!u.connected)Ma()&&(w='<button type="button" class="int-btn-configure" id="btn-xero-connect">'+re(t("xero-connect-btn"))+"</button>");else{const B=!!u.auto_push,I=B?t("card-btn-disable"):t("card-btn-enable");w='<button type="button" class="'+(B?"mrerp-card-toggle mrerp-card-toggle-disable":"mrerp-card-toggle mrerp-card-toggle-enable")+'" id="btn-xero-toggle-enabled" data-xero-enabled="'+(B?"1":"0")+'" title="'+re(B?t("erp-auto-push-on-tip"):t("erp-auto-push-off-tip"))+'">'+re(I)+'</button><button type="button" class="int-btn-configure" id="btn-xero-edit-toggle">'+re(t("card-btn-edit"))+"</button>"}const g=u&&u.connected?"xero-card-desc-connected":"xero-card-desc-default",b=u&&u.connected?t("xero-card-connected")||"Connected · default org will receive pushes":"Cloud accounting · push invoices to your default Xero org",h=(function(){const B=t(g);return B===g?b:B})();let _='<div class="integration-row erp-connect-xero'+(v?" connected":"")+'"><div class="int-icon ic-xero"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="9"/><circle cx="9" cy="10" r="1.3" fill="currentColor"/><circle cx="15" cy="14" r="1.3" fill="currentColor"/><path d="M9 14l6-4"/></svg></div><div class="int-info"><div class="int-name"><span>'+re(t("xero-card-title")||"Xero")+"</span>"+f+'</div><div class="int-desc">'+re(h)+'</div></div><div class="int-actions">'+w+"</div></div>";if(u&&u.configured&&u.connected&&Ma()){const B=u.organisations||[];let I="";if(B.length>0){I+='<div class="erp-cc-meta">'+re((t("xero-org-count")||"").replace("{n}",String(B.length)))+"</div>",I+='<div class="erp-cc-org-label">'+re(t("xero-default-org"))+":</div>",I+='<div class="erp-cc-orgs">',B.forEach(function(S){I+='<label class="erp-cc-org-row"><input type="radio" name="xero-default-org" value="'+re(S.id)+'"'+(S.is_default?" checked":"")+'><span class="erp-cc-org-name">'+re(S.organisation_name||S.organisation_id)+"</span></label>"}),I+="</div>";const L=!!u.auto_push,C=L?t("erp-auto-push-on-tip"):t("erp-auto-push-off-tip");I+='<div class="erp-cc-auto-push" title="'+re(C)+'"><label class="erp-cc-toggle"><input type="checkbox" id="xero-auto-push-toggle"'+(L?" checked":"")+'><span class="erp-cc-toggle-slider"></span><span class="erp-cc-toggle-label">'+re(t("erp-auto-push-label"))+"</span></label></div>",I+='<div class="erp-cc-actions"><button class="btn btn-ghost btn-tiny" type="button" id="btn-xero-disconnect">'+re(t("xero-disconnect-btn"))+"</button></div>"}_+='<div class="erp-xero-details" id="erp-xero-details" style="display:none; margin:8px 0 16px; padding:12px 14px; border:1px solid var(--line); border-radius:8px; background:var(--bg);">'+I+"</div>"}const y=l.querySelector(".erp-connect-xero"),k=l.querySelector("#erp-xero-details");k&&k.remove(),y?y.outerHTML=_:l.insertAdjacentHTML("afterbegin",_);const x=document.getElementById("btn-xero-edit-toggle");x&&x.addEventListener("click",function(B){B.preventDefault();const I=document.getElementById("erp-xero-details");I&&(I.style.display=I.style.display==="none"?"":"none")});const E=document.getElementById("btn-xero-toggle-enabled");E&&E.addEventListener("click",async function(B){if(B.preventDefault(),E.disabled)return;const L=!(E.getAttribute("data-xero-enabled")==="1");if(!L)try{if(!await window.pearnlyConfirm(t("card-toggle-disable-confirm")))return}catch{}E.disabled=!0,await s(L,null)})}async function n(){const l=localStorage.getItem("mrpilot_token");if(l)try{const u=await fetch("/api/erp/xero/auth/start",{method:"GET",headers:{Authorization:"Bearer "+l}});if(!u.ok){let v="unknown";try{v=(await u.json()).detail||"unknown"}catch{}const w=String(v).replace(/^xero\./,"").toLowerCase();ue(t("xero-push-fail").replace("{err}",t("xero-err-"+w)||v),"error");return}const f=await u.json();f.redirect_url&&(window.location.href=f.redirect_url)}catch(u){ue(t("xero-push-fail").replace("{err}",u.message||"network"),"error")}}async function a(){if(!await window.pearnlyConfirm(t("xero-disconnect-confirm")))return;const u=localStorage.getItem("mrpilot_token");try{const f=await fetch("/api/erp/xero/disconnect",{method:"POST",headers:{Authorization:"Bearer "+u}});if(!f.ok)throw new Error("http_"+f.status);await it(!0),e()}catch(f){ue(t("xero-push-fail").replace("{err}",f.message),"error")}}async function o(l){const u=localStorage.getItem("mrpilot_token");try{const f=await fetch("/api/erp/xero/select_org",{method:"POST",headers:{Authorization:"Bearer "+u,"Content-Type":"application/json"},body:JSON.stringify({token_id:l})});if(!f.ok)throw new Error("http_"+f.status);await it(!0),e()}catch(f){ue(t("xero-push-fail").replace("{err}",f.message),"error")}}async function s(l,u){const f=localStorage.getItem("mrpilot_token");u&&(u.disabled=!0);try{const v=await fetch("/api/erp/xero/auto-push",{method:"POST",headers:{Authorization:"Bearer "+f,"Content-Type":"application/json"},body:JSON.stringify({on:!!l})});if(!v.ok){let w="unknown";try{w=(await v.json()).detail||"unknown"}catch{}throw new Error(w)}ue(l?t("erp-auto-push-toggled-on"):t("erp-auto-push-toggled-off"),"success"),de.statusLoaded=!1,await it(!0),e()}catch(v){u&&(u.checked=!l),ue(t("erp-auto-push-toggle-fail").replace("{err}",v.message||"network"),"error")}finally{u&&(u.disabled=!1)}}async function i(){await it(!0),e(),Zi()}function r(){try{const l=String(window.location.hash||"");if(l.indexOf("xero=ok")>=0){const u=l.match(/n=(\d+)/),f=u?u[1]:"1";ue((t("xero-toast-redirected-ok")||"").replace("{n}",f),"success"),history.replaceState(null,"",window.location.pathname+"#automation"),it(!0).then(e)}else l.indexOf("xero=err")>=0&&(ue(t("xero-toast-redirected-err"),"error"),history.replaceState(null,"",window.location.pathname+"#automation"))}catch{}}function c(){if(de.bound)return;de.bound=!0,document.addEventListener("click",function(u){if(u.target.closest('.erp-subtab[data-erp-subtab="connect"]')){setTimeout(i,50);return}if(u.target.closest('.auto-nav-item[data-auto-tab="erp"]')){setTimeout(i,80);return}if(u.target.closest("#btn-xero-connect")){u.preventDefault(),n();return}if(u.target.closest("#btn-xero-disconnect")){u.preventDefault(),a();return}}),document.addEventListener("change",function(u){u.target&&u.target.matches('input[name="xero-default-org"]')&&o(u.target.value),u.target&&u.target.id==="xero-auto-push-toggle"&&s(u.target.checked,u.target),u.target&&u.target.id==="erp-global-push-mode"&&Qi(u.target)});const l=function(){return document.getElementById("drawer-body")};try{const u=new MutationObserver(function(){document.getElementById("drawer-history-save")&&!document.getElementById("btn-xero-push")&&Yi()}),f=l();if(f)u.observe(f,{childList:!0,subtree:!0});else{const v=new MutationObserver(function(){const w=l();w&&(u.observe(w,{childList:!0,subtree:!0}),v.disconnect())});v.observe(document.body,{childList:!0,subtree:!0})}}catch{}setTimeout(r,500)}function m(){de.status&&e();const l=document.getElementById("btn-xero-push");if(l){const u=l.querySelector("span");u&&(u.textContent=t("xero-push-btn"))}}c(),typeof window.subscribeI18n=="function"&&window.subscribeI18n("xero-adapter",m);async function d(l){const u=Date.now();for(;Date.now()-u<l;){if(typeof _userInfo<"u"&&_userInfo&&_userInfo.id)return _userInfo;await new Promise(f=>setTimeout(f,80))}return null}async function p(){await d(5e3);const l=document.querySelector('.auto-nav-item.active[data-auto-tab="erp"]'),u=document.querySelector('.erp-subtab.active[data-erp-subtab="connect"]');l&&u&&await i()}setTimeout(p,200)})();(function(){var e="https://www.mrerp4sme.com/dms/index.php",n=null,a=!1;function o(g){return typeof escapeHtml=="function"?escapeHtml(g==null?"":String(g)):String(g??"")}function s(g,b){try{typeof showToast=="function"&&showToast(g,b||"info")}catch{}}function i(){return localStorage.getItem("mrpilot_token")}async function r(g){var b=i();if(!b)return null;try{var h=await fetch("/api/erp/endpoints",{headers:{Authorization:"Bearer "+b}});if(!h.ok)throw new Error("http_"+h.status);var _=await h.json(),y=_&&_.items||[];n=y.find(function(k){return k&&(k.adapter||"").toLowerCase()==="mrerp_dms"})||null,a=!0}catch{n=null,a=!1}return n}function c(){var g=document.getElementById("erp-connect-cards");if(g){var b=g.querySelector("[data-mrerp-dms-zone]");b||(b=document.createElement("div"),b.setAttribute("data-mrerp-dms-zone","1"),g.appendChild(b));var h=n,_=!!(h&&h.enabled!==!1),y;h?_?y='<span class="mrerp-card-pill mrerp-pill-ok">'+o(t("dms-card-connected"))+"</span>":y='<span class="mrerp-card-pill mrerp-pill-neutral">'+o(t("dms-card-disabled-pill"))+"</span>":y='<span class="mrerp-card-pill mrerp-pill-neutral">'+o(t("dms-card-not-connected"))+"</span>";var k;if(!h)k='<button type="button" class="int-btn-configure" id="btn-dms-connect">'+o(t("dms-card-connect"))+"</button>";else{var x=_?t("dms-card-disable"):t("dms-card-enable");k='<button type="button" class="int-btn-configure" id="btn-dms-edit">'+o(t("dms-card-edit"))+'</button><button type="button" class="int-btn-configure" id="btn-dms-test">'+o(t("dms-card-test"))+'</button><button type="button" class="int-btn-configure" id="btn-dms-toggle">'+o(x)+"</button>"}b.innerHTML='<div class="integration-row erp-connect-mrerp-dms'+(_?" connected":"")+'"><div class="int-icon ic-mrerp-dms" style="background:#0a5c8a;color:#fff;"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M3 13l2-5a2 2 0 011.9-1.4h10.2A2 2 0 0119 8l2 5"/><path d="M3 13h18v4a1 1 0 01-1 1h-1a1 1 0 01-1-1v-1H6v1a1 1 0 01-1 1H4a1 1 0 01-1-1z"/><circle cx="7" cy="15.5" r="1"/><circle cx="17" cy="15.5" r="1"/></svg></div><div class="int-info"><div class="int-name"><span>'+o(t("dms-card-title"))+"</span>"+y+'</div><div class="int-desc">'+o(t("dms-card-desc"))+'</div></div><div class="int-actions">'+k+"</div></div>"}}function m(){var g=document.getElementById("dms-wizard-overlay");g&&g.remove(),document.removeEventListener("keydown",d)}function d(g){g.key==="Escape"&&m()}function p(){m();var g=n,b=g&&g.config&&g.config.booking_defaults&&g.config.booking_defaults.booking_prefix||"PN",h=function(k,x,E,B,I){return'<label style="display:block;margin-bottom:12px;"><span style="display:block;font-size:13px;color:var(--muted,#6b6b66);margin-bottom:5px;">'+o(t(k))+'</span><input id="'+x+'" type="'+E+'" value="'+o(B||"")+'" placeholder="'+o(I||"")+'" autocomplete="new-password" style="width:100%;box-sizing:border-box;padding:9px 11px;border:1px solid var(--line,#ddd);border-radius:8px;font-size:14px;"></label>'},_=document.createElement("div");_.id="dms-wizard-overlay",_.style.cssText="position:fixed;inset:0;z-index:13000;background:rgba(0,0,0,.42);display:flex;align-items:center;justify-content:center;padding:16px;",_.innerHTML='<div class="dms-wizard mrerp-wizard" role="dialog" aria-modal="true" style="background:var(--card,#fff);border-radius:14px;max-width:440px;width:100%;padding:24px;box-shadow:0 12px 40px rgba(0,0,0,.18);max-height:90vh;overflow:auto;"><div style="font-size:17px;font-weight:700;margin-bottom:4px;">'+o(t("dms-wizard-title"))+'</div><div style="font-size:13px;color:var(--muted,#6b6b66);margin-bottom:18px;">'+o(t("dms-card-desc"))+"</div>"+h("dms-wizard-username","dms-w-user","text","","")+h("dms-wizard-password","dms-w-pass","password","","")+h("dms-wizard-prefix","dms-w-prefix","text",b,"PN")+'<div id="dms-w-err" style="display:none;color:#b3261e;font-size:13px;margin:4px 0 12px;"></div><div style="display:flex;gap:10px;justify-content:flex-end;margin-top:8px;"><button type="button" class="btn btn-ghost" id="dms-w-cancel">'+o(t("dms-wizard-cancel"))+'</button><button type="button" class="btn btn-primary" id="dms-w-save">'+o(t("dms-wizard-save"))+"</button></div></div>",document.body.appendChild(_),document.addEventListener("keydown",d),_.addEventListener("click",function(k){k.target===_&&m()});var y=document.getElementById("dms-w-user");y&&y.focus()}function l(g){var b=document.getElementById("dms-w-err");b&&(b.textContent=g,b.style.display=g?"":"none")}async function u(){var g=n&&n.config&&n.config.system_url||e,b=(document.getElementById("dms-w-user")||{}).value||"",h=(document.getElementById("dms-w-pass")||{}).value||"",_=(document.getElementById("dms-w-prefix")||{}).value||"PN";if(g=g.trim(),b=b.trim(),!g||!b||!h){l(t("dms-wizard-required"));return}var y=document.getElementById("dms-w-save");y&&(y.disabled=!0,y.textContent=t("dms-wizard-saving")),l("");var k=i();try{var x=await fetch("/api/erp/test-connection",{method:"POST",headers:{Authorization:"Bearer "+k,"Content-Type":"application/json"},body:JSON.stringify({adapter:"mrerp_dms",config:{system_url:g,username:b,password:h}})}),E=await x.json().catch(function(){return{}});if(!x.ok||!E.ok){var B=E.error_friendly&&(E.error_friendly[window.currentLang]||E.error_friendly.en)||t("dms-connect-fail-generic");l(B),y&&(y.disabled=!1,y.textContent=t("dms-wizard-save"));return}var I={system_url:g,username_enc:b,password_enc:h,id_card_auto_push:!0,booking_defaults:{booking_prefix:_.trim()||"PN"}},L,C;n&&n.id?(L="PATCH",C="/api/erp/endpoints/"+encodeURIComponent(n.id)):(L="POST",C="/api/erp/endpoints");var S=L==="POST"?{name:"MR.ERP DMS",adapter:"mrerp_dms",config:I,is_default:!1,auto_push:!1}:{config:I,auto_push:!1},F=await fetch(C,{method:L,headers:{Authorization:"Bearer "+k,"Content-Type":"application/json"},body:JSON.stringify(S)});if(!F.ok){var A=await F.json().catch(function(){return{}}),z=A&&A.detail&&(A.detail.code||A.detail)||"save_failed";l(t("dms-save-fail")+" ("+o(String(z))+")"),y&&(y.disabled=!1,y.textContent=t("dms-wizard-save"));return}m(),s(t("dms-connect-ok"),"success"),await r(!0),c(),typeof window._refreshOcrDocMode=="function"&&window._refreshOcrDocMode()}catch{l(t("dms-connect-fail-generic")),y&&(y.disabled=!1,y.textContent=t("dms-wizard-save"))}}async function f(){if(!(!n||!n.id)){s(t("dms-test-running"),"info");var g=i();try{var b=await fetch("/api/erp/endpoints/"+encodeURIComponent(n.id)+"/test-connection?refresh=1",{method:"POST",headers:{Authorization:"Bearer "+g}}),h=await b.json().catch(function(){return{}});s(h&&h.ok?t("dms-test-ok"):t("dms-test-fail"),h&&h.ok?"success":"error")}catch{s(t("dms-test-fail"),"error")}}}async function v(){if(!(!n||!n.id)){var g=n.enabled===!1;if(!g)try{var b=await window.pearnlyConfirm(t("dms-confirm-disable"));if(!b)return}catch{}var h=i();try{var _=await fetch("/api/erp/endpoints/"+encodeURIComponent(n.id),{method:"PATCH",headers:{Authorization:"Bearer "+h,"Content-Type":"application/json"},body:JSON.stringify({enabled:g})});if(!_.ok)throw new Error("http_"+_.status);s(g?t("dms-enabled-toast"):t("dms-disabled-toast"),"success"),await r(!0),c(),typeof window._refreshOcrDocMode=="function"&&window._refreshOcrDocMode()}catch{s(t("dms-save-fail"),"error")}}}function w(){r().then(c)}document.addEventListener("click",function(g){if(g.target.closest('.erp-subtab[data-erp-subtab="connect"]')){setTimeout(w,60);return}if(g.target.closest('.auto-nav-item[data-auto-tab="erp"]')){setTimeout(w,90);return}if(g.target.closest("#btn-dms-connect")||g.target.closest("#btn-dms-edit")){g.preventDefault(),p();return}if(g.target.closest("#dms-w-cancel")){g.preventDefault(),m();return}if(g.target.closest("#dms-w-save")){g.preventDefault(),u();return}if(g.target.closest("#btn-dms-test")){g.preventDefault(),f();return}if(g.target.closest("#btn-dms-toggle")){g.preventDefault(),v();return}}),typeof window.subscribeI18n=="function"&&window.subscribeI18n("mrerp-dms-adapter",c),setTimeout(function(){var g=document.querySelector('.auto-nav-item.active[data-auto-tab="erp"]'),b=document.querySelector('.erp-subtab.active[data-erp-subtab="connect"]');g&&b&&w()},250)})();(function(){const e={};function n(){if(document.getElementById("report-modal"))return;const d=`
        ...
        `;p.innerHTML=l+u}function r(d){return d==null?"":String(d).replace(/[&<>"']/g,p=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[p])}function c(d){const p=new Date,l=p.getFullYear(),u=p.getMonth()+1;if(d==="all")return"all";if(d==="this-month")return`${l}-${String(u).padStart(2,"0")}`;if(d==="last-month"){const f=new Date(l,u-2,1);return`${f.getFullYear()}-${String(f.getMonth()+1).padStart(2,"0")}`}return d==="this-year"?`${l}`:d==="this-quarter"?`${l}-Q${Math.floor((u-1)/3)+1}`:"all"}window.openReportModal=async function(d){d=d||{},n(),typeof applyLang=="function"?applyLang(currentLang):document.querySelectorAll("#report-modal [data-i18n]").forEach(w=>{const g=w.getAttribute("data-i18n");I18N[currentLang]&&I18N[currentLang][g]&&(w.textContent=I18N[currentLang][g])});const p=document.getElementById("report-period-section");p&&(p.style.display=d.mode==="client"?"":"none");const l=document.getElementById("report-tpl-list");l.innerHTML=`<div class="report-tpl-loading">${r(t("report-modal-loading"))}</div>`,document.getElementById("report-modal").style.display="";const u=await s(currentLang,d&&d.mode);i(u),o=d;const f=document.getElementById("report-modal-download"),v=f.cloneNode(!0);f.parentNode.replaceChild(v,f),v.addEventListener("click",()=>m(o))};async function m(d){if(!d)return;const p=document.querySelector('input[name="report-tpl"]:checked');if(!p){showToast(t("report-toast-no-selection"),"info");return}const l=p.value,u=document.querySelector('input[name="report-period"]:checked'),f=u?u.value:"all",v=c(f),w=document.getElementById("report-modal-download"),g=w.innerHTML;w.disabled=!0,w.innerHTML=`<span>${r(t("report-modal-loading"))}</span>`;try{const b=localStorage.getItem("mrpilot_token");let h,_;if(d.mode==="records")h=await fetch("/api/reports/export",{method:"POST",headers:{Authorization:"Bearer "+b,"Content-Type":"application/json"},body:JSON.stringify({template:l,lang:currentLang,records:d.records||[],meta:d.meta||{}})}),_=`mrpilot-${l}-${Date.now()}.xlsx`;else if(d.mode==="client"){const L=`/api/reports/clients/${d.clientId}/export?template=${encodeURIComponent(l)}&lang=${encodeURIComponent(currentLang)}&month=${encodeURIComponent(v)}`;h=await fetch(L,{headers:{Authorization:"Bearer "+b}}),_=`${(d.clientName||"client").replace(/[^a-zA-Z0-9\u0e00-\u0e7f\u4e00-\u9fff]/g,"_").slice(0,40)}-${l}.xlsx`}else if(d.mode==="history-batch")l==="sales_detail_th"?(h=await fetch("/api/ocr/export-by-history-ids",{method:"POST",headers:{Authorization:"Bearer "+b,"Content-Type":"application/json"},body:JSON.stringify({template:"sales_detail_th",lang:currentLang,history_ids:d.historyIds||[],client_id:d.clientId||null})}),_=`Pearnly_SalesDetail_${Date.now()}.xlsx`):(h=await fetch("/api/reports/history/batch_export",{method:"POST",headers:{Authorization:"Bearer "+b,"Content-Type":"application/json"},body:JSON.stringify({template:l,lang:currentLang,history_ids:d.historyIds||[],client_id:d.clientId||null})}),_=`mrpilot-batch-${l}-${Date.now()}.xlsx`);else throw new Error("unknown mode: "+d.mode);if(!h.ok){let L="HTTP "+h.status;try{const C=await h.json();C&&C.detail&&(L=C.detail)}catch(C){console.warn("[batch-export] resp.json err.detail parse failed:",C)}h.status===404?showToast(t("report-toast-empty"),"info"):showToast(t("report-toast-fail")+" · "+L,"error");return}const y=await h.blob();let k=_;const E=(h.headers.get("Content-Disposition")||"").match(/filename\*=UTF-8''([^;]+)/i);if(E)try{k=decodeURIComponent(E[1])}catch{}const B=URL.createObjectURL(y),I=document.createElement("a");I.href=B,I.download=k,document.body.appendChild(I),I.click(),document.body.removeChild(I),URL.revokeObjectURL(B),showToast(t("report-toast-success"),"success"),a()}catch(b){console.error("doDownload fail",b),showToast(t("report-toast-fail")+" · "+(b.message||""),"error")}finally{w.disabled=!1,w.innerHTML=g}}document.addEventListener("DOMContentLoaded",()=>{const d=document.getElementById("btn-export");if(d){const l=d.cloneNode(!0);d.parentNode.replaceChild(l,d),l.addEventListener("click",()=>{if(typeof _results>"u"||!_results||_results.length===0){showToast(t("report-toast-no-selection"),"info");return}openReportModal({mode:"records",records:_results.map(u=>({filename:u.filename,merged_fields:u.merged_fields||{}}))})})}const p=document.getElementById("history-batch-export");p&&p.addEventListener("click",()=>{if(typeof _historySelected>"u"||_historySelected.size===0){showToast(t("report-toast-no-selection"),"info");return}openReportModal({mode:"history-batch",historyIds:Array.from(_historySelected)})})}),window.openClientExportModal=function(d,p){openReportModal({mode:"client",clientId:d,clientName:p||""})}})();const er=/\.(pdf|jpe?g|png|webp)$/i,tr="mrpilot_folder_watcher",nr=1;let Vt=null;function gn(){return Vt||(Vt=new Promise((e,n)=>{const a=indexedDB.open(tr,nr);a.onupgradeneeded=o=>{const s=o.target.result;s.objectStoreNames.contains("handles")||s.createObjectStore("handles"),s.objectStoreNames.contains("seen")||s.createObjectStore("seen"),s.objectStoreNames.contains("config")||s.createObjectStore("config")},a.onsuccess=o=>e(o.target.result),a.onerror=o=>n(o.target.error)}),Vt)}function Lt(e,n){return gn().then(a=>new Promise((o,s)=>{const r=a.transaction(e,"readonly").objectStore(e).get(n);r.onsuccess=()=>o(r.result),r.onerror=()=>s(r.error)}))}function Ge(e,n,a){return gn().then(o=>new Promise((s,i)=>{const r=o.transaction(e,"readwrite");r.objectStore(e).put(a,n),r.oncomplete=()=>s(),r.onerror=()=>i(r.error)}))}function Bt(e,n){return gn().then(a=>new Promise((o,s)=>{const i=a.transaction(e,"readwrite");i.objectStore(e).delete(n),i.oncomplete=()=>o(),i.onerror=()=>s(i.error)}))}function $a(e){return gn().then(n=>new Promise((a,o)=>{const s=n.transaction(e,"readwrite");s.objectStore(e).clear(),s.oncomplete=()=>a(),s.onerror=()=>o(s.error)}))}async function Ha(e){if(!e)return!1;try{const n={mode:"read"};let a=await e.queryPermission(n);return a==="granted"?!0:(a=await e.requestPermission(n),a==="granted")}catch(n){return console.warn("[folder] permission check failed:",n),!1}}async function ar(e){const n=new FormData;n.append("file",e,e.name),n.append("source","folder");const a=await fetch("/api/ocr/recognize?source=folder",{method:"POST",headers:{Authorization:"Bearer "+token,"X-Source":"folder"},body:n});if(!a.ok){let o="http_"+a.status;try{const s=await a.json();o=s&&s.detail?typeof s.detail=="string"?s.detail:s.detail.code||JSON.stringify(s.detail):o}catch{}throw new Error(o)}return await a.json()}async function or(e){try{const a=(await e.getFile()).size;return await new Promise(s=>setTimeout(s,3e3)),(await e.getFile()).size===a&&a>0}catch{return!1}}async function Fo(e,n,a,o){if(o>10)return;let s;try{s=await e.queryPermission({mode:"read"})}catch{s="denied"}if(s==="granted")for await(const i of e.values()){const r=n?`${n}/${i.name}`:i.name;if(i.kind==="file"){if(!er.test(i.name))continue;let c;try{c=await i.getFile()}catch{continue}const m=`${r}::${c.size}::${c.lastModified}`;if(await Lt("seen",m))continue;a.push({entry:i,file:c,seenKey:m,relPath:r})}else if(i.kind==="directory")try{await Fo(i,r,a,o+1)}catch{}}}(function(){const n=typeof window<"u"&&"showDirectoryPicker"in window;let a=null,o=null,s=60,i=!1,r=!1,c=0,m=0,d=0,p=[],l=null,u=!1;function f(N,q){const U=document.getElementById("folder-status-summary");U&&(U.setAttribute("data-i18n",N),U.textContent=t(N),U.className="auto-status-pill"+(q?" "+q:""))}function v(N){["folder-unsupported","folder-empty","folder-active"].forEach(q=>{const U=document.getElementById(q);U&&(U.style.display=q===N?"":"none")})}function w(N){if(!N)return"-";const q=N instanceof Date?N:new Date(N),U=String(q.getHours()).padStart(2,"0"),se=String(q.getMinutes()).padStart(2,"0"),ne=String(q.getSeconds()).padStart(2,"0");return`${U}:${se}:${ne}`}function g(){v("folder-active");const N=document.getElementById("folder-config-path");N&&a&&(N.textContent=a.name||"-");const q=document.getElementById("folder-interval-select");q&&(q.value=String(s)),document.getElementById("folder-stat-last").textContent=l?w(l):"-",document.getElementById("folder-stat-processed").textContent=String(c),document.getElementById("folder-stat-failed").textContent=String(m),document.getElementById("folder-stat-queue").textContent=String(d);const U=document.getElementById("btn-folder-pause"),se=document.getElementById("btn-folder-resume");U&&(U.style.display=i?"none":""),se&&(se.style.display=i?"":"none"),i?f("folder-status-paused","paused"):f("folder-status-running","running");const ne=document.getElementById("folder-status-text");ne&&(ne.setAttribute("data-i18n",i?"folder-status-paused":"folder-status-running"),ne.textContent=t(i?"folder-status-paused":"folder-status-running"));const xe=document.getElementById("folder-status-pulse");xe&&(xe.className="folder-status-pulse"+(i?" paused":"")),b()}function b(){const N=document.getElementById("folder-recent-list");if(N){if(p.length===0){N.innerHTML=`<div class="folder-recent-empty">${escapeHtml(t("folder-recent-empty"))}</div>`;return}N.innerHTML=p.slice(0,20).map(q=>{let U;q.status==="ok"?U=`<span class="folder-recent-icon ok">${svgIcon("check",12)}</span>`:q.status==="dup"?U=`<span class="folder-recent-icon dup" title="${escapeHtml(t("folder-recent-dup"))}">${svgIcon("copy",12)}</span>`:q.status==="skip"?U=`<span class="folder-recent-icon skip" title="${escapeHtml(t("folder-recent-skip"))}">${svgIcon("minus",12)}</span>`:U=`<span class="folder-recent-icon fail">${svgIcon("alert",12)}</span>`;const se=q.status==="fail"&&q.error?q.error:q.status==="dup"&&q.reason||q.status==="skip"&&q.reason?q.reason:"",ne=se?`<div class="folder-recent-err">${escapeHtml(se)}</div>`:"";return`
            ...
            `}).join("")}}function h(N){p.unshift(N),p.length>50&&(p.length=50),Ge("config","recent_list",p).catch(()=>{})}async function _(){if(!(r||i||!a)){r=!0;try{if(await a.queryPermission({mode:"read"})!=="granted"){console.warn("[folder] permission lost · stop"),S(),showToast("warn",t("folder-permission-lost"));return}l=new Date;const q=[];await Fo(a,"",q,0),d=q.length,g();for(const U of q){if(i)break;if(!await or(U.entry)){d=Math.max(0,d-1),g();continue}try{let ne;try{ne=await U.entry.getFile()}catch{ne=U.file}const xe=await ar(ne);await Ge("seen",U.seenKey,{name:ne.name,relPath:U.relPath,size:ne.size,lastModified:ne.lastModified,processed_at:Date.now()});const Ue=xe.history_ids||(xe.history_id?[xe.history_id]:[]),_n=xe.duplicate_warnings||[],En=U.relPath||ne.name;Ue.length>0?(c+=Ue.length,h({name:En,status:"ok",time:new Date,history_id:Ue[0],count:Ue.length}),await Ge("config","processed_count",c)):_n.length>0?h({name:En,status:"dup",time:new Date,reason:t("folder-recent-dup-reason")}):h({name:En,status:"skip",time:new Date,reason:t("folder-recent-skip-reason")})}catch(ne){m++,h({name:U.relPath||U.file.name,status:"fail",time:new Date,error:String(ne.message||ne)}),await Ge("config","failed_count",m)}d=Math.max(0,d-1),g()}}catch(N){console.warn("[folder] scan error:",N)}finally{r=!1,g()}}}function y(){o&&clearInterval(o),o=setInterval(_,s*1e3)}function k(){o&&(clearInterval(o),o=null)}function x(N){if(!a||i)return;const q=typeof t=="function"?t("folder-unload-warn"):"Folder watcher running · close anyway?";return N.preventDefault(),N.returnValue=q,q}function E(){window._pearnlyFolderUnloadAttached||(window._pearnlyFolderUnloadAttached=!0,window.addEventListener("beforeunload",x))}function B(){window._pearnlyFolderUnloadAttached&&(window._pearnlyFolderUnloadAttached=!1,window.removeEventListener("beforeunload",x))}function I(){i=!1,y(),E(),g(),_()}function L(){i=!0,k(),B(),g()}function C(){i=!1,y(),E(),g(),_()}function S(){i=!0,k(),B()}async function F(){try{const N=await window.showDirectoryPicker({mode:"read",startIn:"documents"});if(!await Ha(N)){showToast("warn",t("folder-permission-denied"));return}a=N,await Ge("handles","main",N),c=0,m=0,d=0,p=[],await Ge("config","processed_count",0),await Ge("config","failed_count",0),await $a("seen"),I()}catch(N){N&&N.name!=="AbortError"&&console.warn("[folder] pick failed:",N)}}async function A(){await showConfirm(t("folder-confirm-remove"),{danger:!0})&&(S(),a=null,c=0,m=0,d=0,p=[],await Bt("handles","main"),await Bt("config","processed_count"),await Bt("config","failed_count"),await $a("seen"),v("folder-empty"),f("folder-status-empty",""))}async function z(){p=[];try{await Bt("config","recent_list")}catch{}b()}async function ee(){if(u)return;if(u=!0,!n){v("folder-unsupported"),f("folder-status-unsupported",""),te();return}oe();let N=null;try{N=await Lt("handles","main")}catch{}if(!N){v("folder-empty"),f("folder-status-empty","");return}if(!await Ha(N)){v("folder-empty"),f("folder-status-empty",""),await Bt("handles","main"),showToast("warn",t("folder-permission-lost-restart"));return}a=N;try{c=await Lt("config","processed_count")||0}catch{}try{m=await Lt("config","failed_count")||0}catch{}try{const U=await Lt("config","recent_list");Array.isArray(U)&&(p=U.map(se=>({...se,time:se.time?new Date(se.time):new Date})))}catch{}I()}function oe(){const N=document.getElementById("btn-folder-pick"),q=document.getElementById("btn-folder-pause"),U=document.getElementById("btn-folder-resume"),se=document.getElementById("btn-folder-scan-now"),ne=document.getElementById("btn-folder-remove"),xe=document.getElementById("btn-folder-clear-recent"),Ue=document.getElementById("folder-interval-select");N&&N.addEventListener("click",F),q&&q.addEventListener("click",L),U&&U.addEventListener("click",C),se&&se.addEventListener("click",()=>{_()}),ne&&ne.addEventListener("click",A),xe&&xe.addEventListener("click",z),Ue&&Ue.addEventListener("change",_n=>{s=parseInt(_n.target.value,10)||60,i||y()}),ce()}function ce(){document.querySelectorAll('[data-auto-panel="folder"] [data-tab-jump]').forEach(N=>{N.dataset.tabJumpBound||(N.dataset.tabJumpBound="1",N.addEventListener("click",q=>{const U=q.currentTarget.dataset.tabJump;if(U==="email")typeof switchAutomationTab=="function"&&switchAutomationTab("email");else if(U==="upload"){const se=document.querySelector('[data-page="recognize"]')||document.querySelector('[data-page="upload"]');se&&se.click()}}))})}function te(){ce()}window._loadFolderWatcherPanel=ee})();function sr(){try{if(navigator.userAgentData&&Array.isArray(navigator.userAgentData.brands))return navigator.userAgentData.brands.some(n=>/chromium|google chrome|microsoft edge/i.test(n.brand||""))}catch{}const e=navigator.userAgent||"";return!!(/Edg\//.test(e)||/Chrome\//.test(e)&&!/OPR\/|YaBrowser|Opera/.test(e))}function Rn(){try{if(sr()||localStorage.getItem("pearnly_chrome_banner_dismissed")==="1")return;const e=document.getElementById("chrome-only-banner");if(!e)return;const n=e.querySelector('[data-i18n="chrome-banner-msg"]'),a=e.querySelector('[data-i18n="chrome-banner-dismiss"]');n&&typeof t=="function"&&(n.textContent=t("chrome-banner-msg")),a&&typeof t=="function"&&(a.textContent=t("chrome-banner-dismiss")),e.style.display="";const o=document.getElementById("chrome-only-banner-close");o&&!o.dataset.bound&&(o.dataset.bound="1",o.addEventListener("click",()=>{e.style.display="none";try{localStorage.setItem("pearnly_chrome_banner_dismissed","1")}catch{}}))}catch{}}typeof document<"u"&&(document.readyState==="loading"?document.addEventListener("DOMContentLoaded",Rn):setTimeout(Rn,0));window._refreshChromeBanner=Rn;const ir=`
        <div class="modal">
            <div class="modal-head">
    ...
    `;fe("email-modal",ir);const R={account:null,presets:null,modalMode:"new",loaded:!1,triggering:!1,autoRefreshTimer:null};function Aa(e){R.modalMode=e;const n=document.getElementById("email-modal");if(!n)return;const a=document.getElementById("email-preset");a.innerHTML="";const o=R.presets||{},s=["gmail","outlook","yahoo","icloud","qq","163","custom"],i={gmail:"Gmail",outlook:"Outlook / Office365",yahoo:"Yahoo Mail",icloud:"iCloud",qq:"QQ 邮箱",163:"网易 163"};s.forEach(b=>{if(!o[b])return;const h=document.createElement("option");h.value=b,h.textContent=b==="custom"?t("email-preset-custom"):i[b]||b,a.appendChild(h)});const r=document.getElementById("email-modal-title"),c=document.getElementById("email-address"),m=document.getElementById("email-password"),d=document.getElementById("email-imap-host"),p=document.getElementById("email-imap-port"),l=document.getElementById("email-imap-ssl"),u=document.getElementById("email-folder"),f=document.getElementById("email-mark-read"),v=document.getElementById("email-bind-enabled"),w=document.getElementById("email-test-result"),g=document.getElementById("email-adv-details");if(w&&(w.style.display="none",w.textContent=""),e==="edit"&&R.account){r.setAttribute("data-i18n","email-modal-title-edit"),r.textContent=t("email-modal-title-edit"),c.value=R.account.email_address||"",m.value="",m.setAttribute("data-i18n-placeholder","email-field-password-edit-ph"),m.placeholder=t("email-field-password-edit-ph"),d.value=R.account.imap_host||"",p.value=R.account.imap_port||993,l.checked=R.account.imap_use_ssl!==!1,u.value=R.account.folder||"INBOX",f.checked=R.account.mark_as_read!==!1,v.checked=R.account.enabled!==!1;const b=document.getElementById("email-filter-sender"),h=document.getElementById("email-filter-subject");b&&(b.value=R.account.filter_sender||""),h&&(h.value=R.account.filter_subject||""),Pa(R.account.interval_min||15),a.value=lr(R.account.imap_host)||"custom",g&&(g.open=!0)}else{r.setAttribute("data-i18n","email-modal-title-new"),r.textContent=t("email-modal-title-new"),c.value="",m.value="",m.setAttribute("data-i18n-placeholder","email-field-password-ph"),m.placeholder=t("email-field-password-ph"),a.value="gmail",sa("gmail"),u.value="INBOX",f.checked=!0,v.checked=!0;const b=document.getElementById("email-filter-sender"),h=document.getElementById("email-filter-subject");b&&(b.value=""),h&&(h.value=""),Pa(15),g&&(g.open=!1)}cr(),n.style.display="flex",setTimeout(()=>c.focus(),60)}function Cn(){const e=document.getElementById("email-modal");e&&(e.style.display="none")}function sa(e){const n=(R.presets||{})[e];if(!n||e==="custom")return;const a=document.getElementById("email-imap-host"),o=document.getElementById("email-imap-port"),s=document.getElementById("email-imap-ssl");a&&(a.value=n.host||""),o&&(o.value=n.port||993),s&&(s.checked=n.ssl!==!1)}const rr={"gmail.com":"gmail","googlemail.com":"gmail","outlook.com":"outlook","hotmail.com":"outlook","live.com":"outlook","office365.com":"outlook","msn.com":"outlook","yahoo.com":"yahoo","yahoo.co.jp":"yahoo","icloud.com":"icloud","me.com":"icloud","mac.com":"icloud","qq.com":"qq","foxmail.com":"qq","163.com":"163","126.com":"163","yeah.net":"163"};function ja(e){if(!e||!e.includes("@"))return;const n=e.split("@")[1].toLowerCase().trim(),a=rr[n];if(!a)return;const o=document.getElementById("email-preset");if(!o)return;const s=o.value;s&&s!=="custom"&&s!==""&&s===a||(o.value=a,sa(a))}function lr(e){if(!e)return null;const n=R.presets||{};for(const a in n)if(a!=="custom"&&n[a]&&n[a].host===e)return a;return null}function Ro(){const e=document.querySelector("#email-interval-options .email-interval-btn.active"),n=e?parseInt(e.dataset.interval,10):15;return{email_address:(document.getElementById("email-address").value||"").trim(),password:document.getElementById("email-password").value||"",imap_host:(document.getElementById("email-imap-host").value||"").trim(),imap_port:parseInt(document.getElementById("email-imap-port").value||"993",10)||993,imap_use_ssl:document.getElementById("email-imap-ssl").checked,folder:(document.getElementById("email-folder").value||"INBOX").trim()||"INBOX",mark_as_read:document.getElementById("email-mark-read").checked,enabled:document.getElementById("email-bind-enabled").checked,interval_min:[5,15,60].includes(n)?n:15,filter_sender:(document.getElementById("email-filter-sender").value||"").trim()||null,filter_subject:(document.getElementById("email-filter-subject").value||"").trim()||null}}function cr(){const e=document.getElementById("email-interval-options");!e||e._bound||(e._bound=!0,e.addEventListener("click",n=>{const a=n.target.closest(".email-interval-btn");a&&(e.querySelectorAll(".email-interval-btn").forEach(o=>o.classList.remove("active")),a.classList.add("active"))}))}function Pa(e){const n=[5,15,60].includes(e)?e:15,a=document.getElementById("email-interval-options");a&&a.querySelectorAll(".email-interval-btn").forEach(o=>{o.classList.toggle("active",parseInt(o.dataset.interval,10)===n)})}function ve(e,n){const a=document.getElementById("email-test-result");a&&(a.style.display="",a.textContent=n,a.className="form-test-result "+(e==="ok"?"ok":e==="running"?"running":"fail"))}async function dr(){const e=Ro();if(!e.email_address){ve("fail",t("email-addr-required"));return}if(!e.password){ve("fail",t("email-password-required"));return}if(!e.imap_host){ve("fail",t("email-host-required"));return}const n=document.getElementById("btn-email-modal-test");n&&(n.disabled=!0),ve("running",t("email-test-running"));try{const a=await fetch("/api/email-ingest/test",{method:"POST",headers:{Authorization:"Bearer "+token,"Content-Type":"application/json"},body:JSON.stringify({email_address:e.email_address,password:e.password,imap_host:e.imap_host,imap_port:e.imap_port,imap_use_ssl:e.imap_use_ssl,folder:e.folder})}),o=await a.json().catch(()=>({}));if(a.ok&&o.success)ve("ok",t("email-test-ok",{folder:e.folder,n:o.folder_count??"?"}));else{const s=o.error_msg||"";s==="auth_failed"||/auth/i.test(s)?ve("fail",t("email-test-auth-fail")):ve("fail",t("email-test-fail",{msg:s||a.status}))}}catch(a){ve("fail",t("email-test-fail",{msg:String(a).slice(0,120)}))}finally{n&&(n.disabled=!1)}}(function(){async function e(){const u=document.getElementById("email-empty"),f=document.getElementById("email-account-card");if(document.getElementById("email-logs-section"),!(!u||!f))try{const v=await fetch("/api/email-ingest/account",{headers:{Authorization:"Bearer "+token}});if(v.status===401){localStorage.removeItem("mrpilot_token");const g=await v.json().catch(()=>({}));if((typeof g.detail=="string"?g.detail:g.detail&&g.detail.code||"")==="auth.session_revoked"){_showSessionRevokedModal();return}window.location.href="/";return}if(!v.ok){a("none");return}const w=await v.json();R.account=w.account||null,R.presets=w.presets||{},R.loaded=!0,n(),R.account&&d()}catch(v){console.error("[email-ingest] load failed",v),a("none")}}function n(){const u=document.getElementById("email-empty"),f=document.getElementById("email-account-card"),v=document.getElementById("email-logs-section");if(!R.account){u.style.display="",f.style.display="none",v&&(v.style.display="none"),a("none");return}u.style.display="none",f.style.display="",v&&(v.style.display="");const w=document.getElementById("email-account-addr"),g=document.getElementById("email-account-host"),b=document.getElementById("email-account-last"),h=document.getElementById("email-last-error"),_=document.getElementById("email-enabled-toggle");if(w&&(w.textContent=R.account.email_address||"-"),g&&(g.textContent=`${R.account.imap_host||"-"}:${R.account.imap_port||993}`),b){const y=R.account.last_fetched_at;if(!y)b.textContent=t("email-last-never");else{const k=o(y),x=!R.account.last_error;b.textContent=x?t("email-last-ok",{time:k}):t("email-last-fail",{time:k})}}h&&(R.account.last_error?(h.style.display="",h.textContent=s(R.account.last_error)):h.style.display="none"),_&&(_.checked=!!R.account.enabled),R.account.enabled?R.account.last_error?a("error"):a("on"):a("off")}function a(u){const f=document.getElementById("email-status-summary");if(!f)return;f.classList.remove("none","ready","active","coming");let v="auto-status-loading";u==="none"?(v="email-status-none",f.classList.add("none")):u==="on"?(v="email-status-on",f.classList.add("active")):u==="off"?(v="email-status-off",f.classList.add("coming")):u==="error"&&(v="email-status-error",f.classList.add("none")),f.setAttribute("data-i18n",v),f.textContent=t(v)}function o(u){if(!u)return"";const f=new Date(u);if(isNaN(f.getTime()))return"";const v=w=>String(w).padStart(2,"0");return`${v(f.getMonth()+1)}-${v(f.getDate())} ${v(f.getHours())}:${v(f.getMinutes())}`}function s(u){if(!u)return"";const f=String(u);return/auth|AUTHENTICATIONFAILED|invalid credentials/i.test(f)?t("email-test-auth-fail"):/timeout|timed out/i.test(f)?t("email.timeout"):(/ENOTFOUND|getaddrinfo/i.test(f),f)}async function i(){const u=Ro();if(!u.email_address){ve("fail",t("email-addr-required"));return}if(R.modalMode==="new"&&!u.password){ve("fail",t("email-password-required"));return}if(!u.imap_host){ve("fail",t("email-host-required"));return}const f=document.getElementById("btn-email-modal-save");f&&(f.disabled=!0);const v={...u};R.modalMode==="edit"&&!v.password&&delete v.password;try{const w=await fetch("/api/email-ingest/account",{method:"PUT",headers:{Authorization:"Bearer "+token,"Content-Type":"application/json"},body:JSON.stringify(v)}),g=await w.json().catch(()=>({}));if(w.ok&&g.ok)R.account=g.account,showToast(t("email-save-ok"),"success"),Cn(),n(),d();else{const h="email."+(g.detail||"").split(".").slice(-1)[0];ve("fail",t(h)!==h?t(h):t("email-save-fail"))}}catch{ve("fail",t("email-save-fail"))}finally{f&&(f.disabled=!1)}}async function r(){if(!(!R.account||!await showConfirm(t("email-unbind-confirm",{email:R.account.email_address}),{danger:!0,okText:t("email-btn-unbind")})))try{if((await fetch("/api/email-ingest/account",{method:"DELETE",headers:{Authorization:"Bearer "+token}})).ok){R.account=null,showToast(t("email-unbind-ok"),"success"),n();const v=document.getElementById("email-logs-list");v&&(v.innerHTML="")}else showToast(t("email-unbind-fail"),"error")}catch{showToast(t("email-unbind-fail"),"error")}}async function c(){if(!R.account||R.triggering)return;if(!R.account.enabled){showToast(t("email.disabled"),"error");return}R.triggering=!0;const u=document.getElementById("btn-email-trigger"),f=u?u.innerHTML:"";u&&(u.disabled=!0,u.innerHTML=`<span>${escapeHtml(t("email-trigger-running"))}</span>`);try{const v=await fetch("/api/email-ingest/trigger",{method:"POST",headers:{Authorization:"Bearer "+token}}),w=await v.json().catch(()=>({}));if(v.ok){const g=w.emails_scanned||0,b=w.ocr_succeeded||0,h=w.ocr_failed||0;g===0&&b===0&&h===0?showToast(t("email-trigger-empty"),"success"):showToast(t("email-trigger-result",{scanned:g,ok:b,fail:h}),h>0?"warn":"success")}else{const b="email."+(w.detail||"").split(".").slice(-1)[0];showToast(t(b)!==b?t(b):t("email-trigger-fail"),"error")}await e()}catch{showToast(t("email-trigger-fail"),"error")}finally{R.triggering=!1,u&&(u.disabled=!1,u.innerHTML=f)}}async function m(){if(!R.account)return;const u=document.getElementById("email-enabled-toggle"),f=!!(u&&u.checked),v=R.account.enabled;try{const w=await fetch("/api/email-ingest/account",{method:"PUT",headers:{Authorization:"Bearer "+token,"Content-Type":"application/json"},body:JSON.stringify({email_address:R.account.email_address,imap_host:R.account.imap_host,imap_port:R.account.imap_port,imap_use_ssl:R.account.imap_use_ssl,folder:R.account.folder||"INBOX",filter_subject:R.account.filter_subject||null,filter_sender:R.account.filter_sender||null,mark_as_read:R.account.mark_as_read!==!1,enabled:f})}),g=await w.json().catch(()=>({}));w.ok&&g.ok?(R.account=g.account,n()):(u&&(u.checked=v),showToast(t("email-toggle-fail"),"error"))}catch{u&&(u.checked=v),showToast(t("email-toggle-fail"),"error")}}async function d(){const u=document.getElementById("email-logs-list");if(u){u.innerHTML=`<div class="erp-logs-empty">${escapeHtml(t("erp-logs-loading"))}</div>`;try{const f=await fetch("/api/email-ingest/logs?limit=20",{headers:{Authorization:"Bearer "+token}});if(!f.ok){u.innerHTML=`<div class="erp-logs-empty">${escapeHtml(t("erp-logs-error"))}</div>`;return}const v=await f.json();if(!Array.isArray(v)||v.length===0){u.innerHTML=`<div class="erp-logs-empty">${escapeHtml(t("email-logs-empty"))}</div>`;return}u.innerHTML=v.map(p).join("")}catch{u.innerHTML=`<div class="erp-logs-empty">${escapeHtml(t("erp-logs-error"))}</div>`}}}function p(u){const f=o(u.created_at),v=u.status||"failed",w=v==="success"?"ok":v==="partial"?"partial":"fail",g=v==="success"?"✓":v==="partial"?"◐":"✗",b=u.trigger==="manual"?`<span class="log-tag manual">${escapeHtml(t("email-log-tag-manual"))}</span>`:`<span class="log-tag auto">${escapeHtml(t("email-log-tag-auto"))}</span>`,h=t("email-log-counts",{scanned:u.emails_scanned||0,att:u.attachments_found||0,ok:u.ocr_succeeded||0,fail:u.ocr_failed||0}),_=(u.elapsed_ms||0)+"ms";return`
        ...
        `}function l(){const u=document.getElementById("btn-email-bind");u&&u.addEventListener("click",()=>Aa("new"));const f=document.getElementById("btn-email-edit");f&&f.addEventListener("click",()=>Aa("edit"));const v=document.getElementById("btn-email-unbind");v&&v.addEventListener("click",r);const w=document.getElementById("btn-email-trigger");w&&w.addEventListener("click",c);const g=document.getElementById("email-enabled-toggle");g&&g.addEventListener("change",m);const b=document.getElementById("email-modal-close");b&&b.addEventListener("click",Cn);const h=document.getElementById("btn-email-modal-cancel");h&&h.addEventListener("click",Cn);const _=document.getElementById("btn-email-modal-test");_&&_.addEventListener("click",dr);const y=document.getElementById("btn-email-modal-save");y&&y.addEventListener("click",i);const k=document.getElementById("email-preset");k&&k.addEventListener("change",B=>sa(B.target.value));const x=document.getElementById("email-address");x&&!x.dataset.autoBound&&(x.dataset.autoBound="1",x.addEventListener("blur",B=>ja((B.target.value||"").trim())),x.addEventListener("input",B=>{const I=(B.target.value||"").trim();I.includes("@")&&I.split("@")[1].includes(".")&&ja(I)}));const E=document.getElementById("btn-email-refresh-logs");E&&E.addEventListener("click",()=>{E.classList.add("spinning"),setTimeout(()=>E.classList.remove("spinning"),600),d()})}l(),window._loadEmailIngestPanel=e,window._rerenderEmailIngest=function(){if(!R.loaded)return;n();const u=document.getElementById("email-logs-section");R.account&&u&&u.open&&d()},window._startEmailLogAutoRefresh=function(){R.autoRefreshTimer||(R.autoRefreshTimer=setInterval(()=>{R.account&&R.loaded&&d()},3e4))},window._stopEmailLogAutoRefresh=function(){R.autoRefreshTimer&&(clearInterval(R.autoRefreshTimer),R.autoRefreshTimer=null)}})();const pr=`
...
`;fe("bank-cand-drawer",pr);const ur=`
    <div class="modal" style="max-width: 420px;">
        <div class="modal-head">
...
`;fe("bank-client-picker-modal",ur);const M={sessions:[],currentSession:null,currentTxs:[],currentFilter:"all",currentTxForDrawer:null,loaded:!1,queue:[],qSeq:0,sessionFilter:"all",pickerSelected:null};function fr(e){const n=Number(e||0);let a="score-low";return n>=85?a="score-high":n>=60&&(a="score-mid"),'<span class="bank-cand-score '+a+'">'+n.toFixed(0)+" "+t("bank-cand-score-unit")+"</span>"}function mr(e){const n=document.getElementById("bank-upload-progress");n&&(n.style.display="none")}function vr(){const e=document.getElementById("bank-upload-error");e&&(e.style.display="none")}function hr(e){return{"bank_recon.only_pdf":t("bank-err-only-pdf"),"bank_recon.empty_file":t("bank-err-empty"),"bank_recon.file_too_large":t("bank-err-too-large"),"bank_recon.save_failed":t("bank-err-server"),"bank_recon.scanned":t("bank-err-scanned"),"bank_recon.no_tx":t("bank-err-no-tx"),network:t("bank-err-network")}[e]||t("bank-err-unknown")+" ("+e+")"}function Ze(e){if(e==null)return"-";const n=Number(e);return isNaN(n)?"-":n.toLocaleString("en-US",{minimumFractionDigits:2,maximumFractionDigits:2})}function ht(e){if(!e)return"-";const n=String(e);return n.length>=10?n.slice(0,10):n}function qo(e,n){return!e&&!n?"":(ht(e)||"?")+" ~ "+(ht(n)||"?")}function K(e){return e==null?"":String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}async function gr(e){M.currentTxForDrawer=e;const n=document.getElementById("bank-detail-body");n&&n.classList.add("has-pane");const a=document.getElementById("bank-cand-pane-title"),o=document.getElementById("bank-cand-pane-sub"),s=document.getElementById("bank-cand-pane-foot");if(a&&(a.textContent=t("bank-cand-pane-current")),o){const r=e.direction==="OUT"?"-":"+",c=e.direction==="OUT"?"bank-out":"bank-in";o.innerHTML=`${K(ht(e.tx_date))}
    ...
    `}function Lr(e){if(e.parse_status==="parse_failed")return`<span class="bank-session-count cnt-failed">${t("bank-count-parse-failed")}</span>`;if(e.parse_status!=="parsed")return`<span class="bank-session-count">${t("bank-count-parsing")}</span>`;const n=e.tx_count||0,a=e.matched_count||0,o=e.unmatched_count||0,s=[`<span class="bank-session-count">${n} ${t("bank-count-tx")}</span>`];return a>0&&s.push(`<span class="bank-session-count cnt-matched">${a} ${t("bank-count-matched")}</span>`),o>0&&s.push(`<span class="bank-session-count cnt-unmatched">${o} ${t("bank-count-unmatched")}</span>`),s.join("")}function Cr(){document.getElementById("bank-detail").style.display="",document.querySelector(".bank-sessions-section").style.display="none",zo(),ia(),ra()}function la(){document.getElementById("bank-detail").style.display="none",document.querySelector(".bank-sessions-section").style.display="";const e=document.getElementById("bank-detail-body");e&&e.classList.remove("has-pane"),M.currentTxForDrawer=null}const Sr=3;function Tr(){return M.qSeq+=1,"q"+M.qSeq+"_"+Date.now()}async function Mr(e){const n=Array.from(e.target.files||[]);if(e.target.value="",n.length!==0){for(const a of n){const o={id:Tr(),file:a,name:a.name,size:a.size,status:"pending",progress:0,error_code:null,tx_count:0,session_id:null};a.name.toLowerCase().endsWith(".pdf")?a.size>20*1024*1024&&(o.status="failed",o.error_code="bank_recon.file_too_large"):(o.status="failed",o.error_code="bank_recon.only_pdf"),M.queue.push(o)}$r(),ye(),ca()}}function $r(){const e=document.getElementById("bank-upload-queue");e&&(e.style.display=""),mr(),vr()}function ye(){const e=document.getElementById("bank-upload-queue-list"),n=document.getElementById("bank-upload-queue-summary");if(!e)return;if(M.queue.length===0){e.innerHTML="",n&&(n.textContent="");const r=document.getElementById("bank-upload-queue");r&&(r.style.display="none");return}let a=0,o=0,s=0,i=0;for(const r of M.queue)r.status==="ok"?a++:r.status==="failed"?o++:r.status==="uploading"||r.status==="parsing"?s++:i++;n&&(n.textContent=t("bank-queue-summary").replace("{ok}",a).replace("{run}",s).replace("{wait}",i).replace("{fail}",o)),e.innerHTML=M.queue.map(Hr).join(""),e.querySelectorAll("[data-q-act]").forEach(r=>{const c=r.dataset.qAct,m=r.dataset.qId;r.addEventListener("click",()=>{c==="retry"&&Ar(m),c==="remove"&&jr(m)})})}function Hr(e){const n=(e.size/1024).toFixed(0)+" KB";let a="",o="";if(e.status==="pending")a='<span class="bq-stat bq-wait">'+t("bank-queue-status-wait")+"</span>",o='<button data-q-act="remove" data-q-id="'+K(e.id)+'" class="bq-act">×</button>';else if(e.status==="uploading")a='<span class="bq-stat bq-run">'+t("bank-queue-status-uploading")+'</span><div class="bq-bar"><div class="bq-bar-fill" style="width:'+(e.progress||0)+'%"></div></div>';else if(e.status==="parsing")a='<span class="bq-stat bq-run">'+t("bank-queue-status-parsing")+'</span><div class="bq-bar"><div class="bq-bar-fill bq-bar-indet"></div></div>';else if(e.status==="ok")a='<span class="bq-stat bq-ok">'+t("bank-queue-status-ok").replace("{n}",e.tx_count||0)+"</span>",o='<button data-q-act="remove" data-q-id="'+K(e.id)+'" class="bq-act">×</button>';else if(e.status==="failed"){const s=hr(e.error_code||"unknown");a='<span class="bq-stat bq-fail" title="'+K(s)+'">'+K(s)+"</span>",o='<button data-q-act="retry" data-q-id="'+K(e.id)+'" class="bq-act bq-act-retry">'+t("bank-queue-retry")+'</button><button data-q-act="remove" data-q-id="'+K(e.id)+'" class="bq-act">×</button>'}return'<div class="bq-row" data-q-row="'+K(e.id)+'"><div class="bq-name" title="'+K(e.name)+'">'+K(e.name)+'</div><div class="bq-size">'+n+'</div><div class="bq-status">'+a+'</div><div class="bq-actions">'+o+"</div></div>"}function Ar(e){const n=M.queue.find(a=>a.id===e);n&&(n.status="pending",n.error_code=null,n.progress=0,ye(),ca())}function jr(e){const n=M.queue.findIndex(o=>o.id===e);if(n<0)return;const a=M.queue[n];a.status==="uploading"||a.status==="parsing"||(M.queue.splice(n,1),ye())}function Pr(){M.queue=M.queue.filter(e=>e.status!=="ok"),ye()}async function ca(){for(;;){if(M.queue.filter(a=>a.status==="uploading"||a.status==="parsing").length>=Sr)return;const n=M.queue.find(a=>a.status==="pending");if(!n){M.queue.every(a=>a.status==="ok"||a.status==="failed")&&(await kt(),typeof window.loadReconcilePage=="function"&&window.loadReconcilePage());return}Dr(n).then(()=>ca())}}async function Dr(e){e.status="uploading",e.progress=0,ye();try{const n=new FormData;n.append("file",e.file,e.name);const a=await new Promise((s,i)=>{const r=new XMLHttpRequest;r.open("POST","/api/bank-recon/upload"),r.setRequestHeader("Authorization","Bearer "+token),r.upload.onprogress=c=>{c.lengthComputable&&(e.progress=Math.min(99,Math.round(c.loaded/c.total*100)),ye())},r.upload.onload=()=>{e.status="parsing",ye()},r.onload=()=>{r.status>=200&&r.status<300?s({status:r.status,text:r.responseText}):s({status:r.status,text:r.responseText})},r.onerror=()=>i(new Error("network")),r.send(n)});let o={};try{o=JSON.parse(a.text||"{}")}catch{o={}}if(a.status>=400){e.status="failed",e.error_code=o&&o.detail||"unknown",ye();return}if(o.parse_status==="parse_failed"){e.status="failed",e.error_code=o.error==="scanned_pdf_not_yet"?"bank_recon.scanned":"bank_recon.no_tx",ye();return}e.status="ok",e.tx_count=o.tx_count||0,e.session_id=o.session_id||null,ye()}catch(n){console.warn("[bank-recon] upload failed",n),e.status="failed",e.error_code="network",ye()}}async function Uo(){if(M.loaded){Fa();return}M.loaded=!0,Fr(),await kt(),Fa()}function Fr(){const e=document.getElementById("bank-file-input");e&&!e._bound&&(e._bound=!0,e.addEventListener("change",Mr));const n=document.getElementById("btn-bank-queue-clear-done");n&&!n._bound&&(n._bound=!0,n.addEventListener("click",Pr));const a=document.getElementById("btn-bank-back");a&&!a._bound&&(a._bound=!0,a.addEventListener("click",()=>{M.currentSession=null,M.currentTxs=[],la()}));const o=document.getElementById("btn-bank-delete");o&&!o._bound&&(o._bound=!0,o.addEventListener("click",kr));const s=document.getElementById("btn-bank-run-match");s&&!s._bound&&(s._bound=!0,s.addEventListener("click",wr)),document.querySelectorAll(".bank-filter-btn").forEach(p=>{p._bound||(p._bound=!0,p.addEventListener("click",()=>{M.currentFilter=p.dataset.bankFilter||"all",document.querySelectorAll(".bank-filter-btn").forEach(l=>{l.classList.toggle("active",l===p)}),ia()}))}),document.querySelectorAll("[data-bank-cand-close]").forEach(p=>{p._bound||(p._bound=!0,p.addEventListener("click",Rt))});const i=document.getElementById("btn-bank-cand-pane-close");i&&!i._bound&&(i._bound=!0,i.addEventListener("click",Rt));const r=document.getElementById("btn-bank-cand-ignore");r&&!r._bound&&(r._bound=!0,r.addEventListener("click",Da));const c=document.getElementById("btn-bank-cand-ignore-pane");c&&!c._bound&&(c._bound=!0,c.addEventListener("click",Da));const m=document.getElementById("bank-client-badge");m&&!m._bound&&(m._bound=!0,m.addEventListener("click",Er)),document.querySelectorAll("[data-bank-client-picker-close]").forEach(p=>{p._bound||(p._bound=!0,p.addEventListener("click",No))});const d=document.getElementById("btn-bank-client-picker-save");d&&!d._bound&&(d._bound=!0,d.addEventListener("click",Br)),document.querySelectorAll(".bank-sessions-chip").forEach(p=>{p._bound||(p._bound=!0,p.addEventListener("click",()=>{M.sessionFilter=p.dataset.sessFilter||"all",document.querySelectorAll(".bank-sessions-chip").forEach(l=>{l.classList.toggle("active",l===p)}),on()}))})}window._deleteBankSession=Vo;window._loadBankReconPanel=Uo;window._rerenderBankRecon=function(){if(currentRoute==="automation"){if(on(),M.currentSession&&(zo(),ia(),ra(),!M.currentTxForDrawer)){const e=document.getElementById("bank-cand-pane-title"),n=document.getElementById("bank-cand-pane-sub");e&&(e.textContent=t("bank-cand-pane-empty-title")),n&&(n.textContent=t("bank-cand-pane-empty-sub"))}ye()}};typeof window.subscribeI18n=="function"&&window.subscribeI18n("bank-recon",window._rerenderBankRecon);window._openBankSession=async function(e){e&&(M.loaded||await Uo(),await wt(e))};(function(){const e=document.getElementById("page-clients");if(!(!e||e.dataset.wbInjected==="1")){e.innerHTML=`
        <div class="page-head">
            <div class="page-head-icon">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
...
`,e.dataset.wbInjected="1";try{const n=window._currentLang||localStorage.getItem("mrpilot_lang")||"th",a=window.I18N;a&&a[n]&&(e.querySelectorAll("[data-i18n]").forEach(o=>{const s=o.getAttribute("data-i18n");a[n][s]&&(o.textContent=a[n][s])}),e.querySelectorAll("[data-i18n-placeholder]").forEach(o=>{const s=o.getAttribute("data-i18n-placeholder");a[n][s]&&(o.placeholder=a[n][s])}))}catch{}}})();const Rr=`
    ...
    `;fe("client-modal-mask",Rr);fe("wsclient-modal-mask",qr);const O={clients:[],editingClientId:null,historyClientFilter:"",custTab:"seller",sellerClients:[],editingWsClientId:null,catCache:{fetched:0,items:[],supplier_count:0}},pe={page:0,pageSize:12,keyword:""},Te=new Set,sn={keyword:""};function zr(){return{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||"")}}async function Be(e,n={}){const a=await fetch(e,{...n,headers:{"Content-Type":"application/json",...zr(),...n.headers||{}}});if(!a.ok){const o=await a.json().catch(()=>({}));throw new Error(o.detail||"HTTP "+a.status)}return a.json()}function Nr(){const e=document.querySelector("#client-color-picker .color-swatch.active");return e?e.dataset.color:"#111111"}function Ra(e){const n=document.getElementById("drawer-cat-learned-tag");n&&e>0&&(n.textContent=(t("drawer-suggest-learned-with-count")||"已学 {n}").replace("{n}",String(e)))}async function xt(){try{const e=await Be("/api/clients");O.clients=e.clients||[],window._clientsCache=O.clients}catch(e){console.error("loadClientsCache fail",e),O.clients=[]}try{typeof window._refreshExcClientFilter=="function"&&window._refreshExcClientFilter()}catch{}try{typeof window._refreshClientSwitcher=="function"&&window._refreshClientSwitcher()}catch{}return O.clients}function Or(){const e=pe.keyword.trim().toLowerCase();return e?O.clients.filter(n=>(n.name||"").toLowerCase().includes(e)||(n.short_name||"").toLowerCase().includes(e)||(n.tax_id||"").toLowerCase().includes(e)):O.clients}function da(){const e=Or(),n=pe.pageSize,a=Math.max(0,Math.ceil(e.length/n)-1);pe.page>a&&(pe.page=a);const o=pe.page*n;return{all:e,items:e.slice(o,o+n),start:o,ps:n,total:e.length,maxPage:a}}function Ce(){const e=document.getElementById("buyer-tbody");if(!e)return;const{items:n,start:a,ps:o,total:s,maxPage:i}=da();s?e.innerHTML=n.map(d=>{const p=Te.has(d.id);return`<div class="cust-row buyer-grid${p?" selected":""}" data-cid="${d.id}">
        ...
        </div>`}).join("")}function qa(e){O.editingWsClientId=e?e.id:null,document.getElementById("wsclient-modal-title").textContent=t(e?"wsclient-modal-edit":"wsclient-modal-new"),document.getElementById("wsclient-input-name").value=e&&e.name||"",document.getElementById("wsclient-input-tax").value=e&&e.tax_id||"",document.getElementById("wsclient-modal-archive").style.display=e?"":"none",document.getElementById("wsclient-modal-mask").style.display="flex",setTimeout(()=>document.getElementById("wsclient-input-name").focus(),50)}function At(){document.getElementById("wsclient-modal-mask").style.display="none",O.editingWsClientId=null}async function Zr(){const e=document.getElementById("wsclient-input-name").value.trim(),n=document.getElementById("wsclient-input-tax").value.trim();if(!e){showToast(t("client-msg-name-required"),"fail");return}try{O.editingWsClientId?(await Be("/api/workspace/clients/"+O.editingWsClientId,{method:"PATCH",body:JSON.stringify({name:e,tax_id:n})}),showToast(t("client-msg-updated"),"success")):(await Be("/api/workspace/clients",{method:"POST",body:JSON.stringify({name:e,tax_id:n||null})}),showToast(t("client-msg-created"),"success")),At(),await ua(),et(),Ko()}catch(a){const o=a&&a.message?a.message:t("client-msg-save-fail");showToast(t("client-msg-save-fail")+" · "+o,"fail")}}async function za(){if(!O.editingWsClientId)return;const e=O.sellerClients.find(a=>Number(a.id)===Number(O.editingWsClientId));if(await showConfirm(t("wsclient-archive-confirm").replace("{name}",e?e.name:""),{danger:!0}))try{const a=O.editingWsClientId;await Be("/api/workspace/clients/"+a,{method:"DELETE"}),showToast(t("wsclient-archived"),"success"),typeof window.getActiveWorkspaceClientId=="function"&&Number(window.getActiveWorkspaceClientId())===Number(a)&&typeof window.enterPersonalMode=="function"&&window.enterPersonalMode(),At(),await ua(),et(),Ko()}catch{showToast(t("client-msg-save-fail"),"fail")}}window.loadClientsPage=async function(){const e=document.getElementById("seller-tbody");e&&(e.innerHTML=`<div class="cust-loading">${escapeHtml(t("clients-loading"))}</div>`);const n=document.getElementById("buyer-tbody");n&&(n.innerHTML=`<div class="cust-loading">${escapeHtml(t("clients-loading"))}</div>`),await Promise.all([ua(),xt()]),et(),Ce()};window.addEventListener("pearnly:workspace-changed",function(){typeof currentRoute<"u"&&currentRoute==="clients"&&et()});window.bindDrawerClient=function(e,n){const a=document.getElementById("drawer-client-select");if(!a)return;if(bn(),a.value=n?String(n):"",!e){a.onchange=null;const s=document.getElementById("drawer-client-add");s&&(s.onclick=()=>$t(null));return}a.onchange=async()=>{const s=a.value?parseInt(a.value,10):null;try{await Be(`/api/history/${e}/assign_client`,{method:"POST",body:JSON.stringify({client_id:s})}),showToast(t("client-msg-updated"),"success");const i=_results[_drawerIdx];i&&(i.client_id=s),await xt()}catch(i){console.error(i),showToast(t("client-msg-save-fail"),"fail"),a.value=n?String(n):""}};const o=document.getElementById("drawer-client-add");o&&(o.onclick=()=>$t(null))};window.fillCategoryDatalist=async function(){try{const e=document.getElementById("drawer-cat-datalist"),n=Date.now();if(n-O.catCache.fetched<300*1e3){e&&(e.innerHTML=O.catCache.items.map(o=>`<option value="${escapeHtml(o)}">`).join("")),Ra(O.catCache.supplier_count);return}const a=await Be("/api/categories",{method:"GET"});O.catCache.fetched=n,O.catCache.items=a&&a.categories||[],O.catCache.supplier_count=a&&a.supplier_count||0,e&&(e.innerHTML=O.catCache.items.map(o=>`<option value="${escapeHtml(o)}">`).join("")),Ra(O.catCache.supplier_count)}catch(e){console.warn("fillCategoryDatalist failed",e)}};window.getHistoryClientFilter=function(){return O.historyClientFilter};document.addEventListener("DOMContentLoaded",()=>{const e=document.querySelector(".cust-tab-bar");e&&e.addEventListener("click",L=>{const C=L.target.closest("[data-cust-tab]");C&&Wr(C.dataset.custTab)});const n=document.getElementById("btn-buyer-new");n&&n.addEventListener("click",()=>$t(null));const a=document.getElementById("buyer-tbody");a&&a.addEventListener("click",L=>{const C=L.target.closest(".buyer-row-check");if(C){const A=parseInt(C.dataset.cid,10);C.checked?Te.add(A):Te.delete(A);const z=C.closest(".cust-row");z&&z.classList.toggle("selected",C.checked),Go();return}const S=L.target.closest(".cust-row-btn");if(S){L.stopPropagation();const A=parseInt(S.dataset.cid,10);if(S.dataset.action==="edit"){const z=O.clients.find(ee=>ee.id===A);z&&$t(z)}else S.dataset.action==="export"&&Jr(A);return}const F=L.target.closest(".cust-row");if(F&&!L.target.closest(".cust-cell-check")){const A=O.clients.find(z=>z.id===parseInt(F.dataset.cid,10));A&&$t(A)}});const o=document.getElementById("buyer-check-all");o&&o.addEventListener("change",()=>{const{items:L}=da();L.forEach(C=>{o.checked?Te.add(C.id):Te.delete(C.id)}),Ce()});const s=document.getElementById("buyer-batch-cancel");s&&s.addEventListener("click",Vr);const i=document.getElementById("buyer-batch-delete");i&&i.addEventListener("click",Ur);const r=document.getElementById("buyer-prev");r&&r.addEventListener("click",()=>{pe.page>0&&(pe.page--,Ce())});const c=document.getElementById("buyer-next");c&&c.addEventListener("click",()=>{pe.page++,Ce()});const m=document.getElementById("buyer-search");if(m){let L;m.addEventListener("input",()=>{clearTimeout(L),L=setTimeout(()=>{pe.keyword=m.value,pe.page=0;const C=document.getElementById("buyer-search-clear");C&&(C.style.display=m.value?"":"none"),Ce()},200)})}const d=document.getElementById("buyer-search-clear");d&&d.addEventListener("click",()=>{const L=document.getElementById("buyer-search");L&&(L.value=""),pe.keyword="",pe.page=0,d.style.display="none",Ce()});const p=document.getElementById("btn-seller-new");p&&p.addEventListener("click",()=>qa(null));const l=document.getElementById("seller-tbody");l&&l.addEventListener("click",L=>{const C=L.target.closest("[data-saction]");if(!C)return;L.stopPropagation();const S=parseInt(C.dataset.wid,10),F=C.dataset.saction,A=O.sellerClients.find(z=>Number(z.id)===S);F==="activate"?(typeof window.setActiveWorkspaceClientId=="function"&&window.setActiveWorkspaceClientId(S),et(),typeof window.renderWorkspaceControl=="function"&&window.renderWorkspaceControl(),showToast(t("seller-activated").replace("{name}",A?A.name:""),"success")):F==="edit"?A&&qa(A):F==="archive"&&(O.editingWsClientId=S,za())});const u=document.getElementById("seller-search");if(u){let L;u.addEventListener("input",()=>{clearTimeout(L),L=setTimeout(()=>{sn.keyword=u.value;const C=document.getElementById("seller-search-clear");C&&(C.style.display=u.value?"":"none"),et()},200)})}const f=document.getElementById("seller-search-clear");f&&f.addEventListener("click",()=>{const L=document.getElementById("seller-search");L&&(L.value=""),sn.keyword="",f.style.display="none",et()});const v=document.getElementById("wsclient-modal-close");v&&v.addEventListener("click",At);const w=document.getElementById("wsclient-modal-cancel");w&&w.addEventListener("click",At);const g=document.getElementById("wsclient-modal-save");g&&g.addEventListener("click",Zr);const b=document.getElementById("wsclient-modal-archive");b&&b.addEventListener("click",za);const h=document.getElementById("wsclient-modal-mask");h&&h.addEventListener("click",L=>{L.target===h&&At()});const _=document.getElementById("client-modal-close");_&&_.addEventListener("click",Ht);const y=document.getElementById("client-modal-cancel");y&&y.addEventListener("click",Ht);const k=document.getElementById("client-modal-save");k&&k.addEventListener("click",Gr);const x=document.getElementById("client-modal-delete");x&&x.addEventListener("click",Kr);const E=document.getElementById("client-modal-mask");E&&E.addEventListener("click",L=>{L.target===E&&Ht()});const B=document.getElementById("client-color-picker");B&&B.addEventListener("click",L=>{const C=L.target.closest(".color-swatch");C&&(B.querySelectorAll(".color-swatch").forEach(S=>S.classList.remove("active")),C.classList.add("active"))});const I=document.getElementById("history-client-filter");I&&I.addEventListener("change",()=>{O.historyClientFilter=I.value,typeof renderHistoryList=="function"&&renderHistoryList()})});setTimeout(()=>xt(),1e3);(function(){const e=document.getElementById("page-exceptions");if(!(!e||e.dataset.wbInjected==="1")){e.innerHTML=`
        <div class="page-head">
            <div class="page-head-icon">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round">
...
`,e.dataset.wbInjected="1";try{const n=window._currentLang||localStorage.getItem("mrpilot_lang")||"th",a=window.I18N;a&&a[n]&&(e.querySelectorAll("[data-i18n]").forEach(o=>{const s=o.getAttribute("data-i18n");a[n][s]&&(o.textContent=a[n][s])}),e.querySelectorAll("[data-i18n-placeholder]").forEach(o=>{const s=o.getAttribute("data-i18n-placeholder");a[n][s]&&(o.placeholder=a[n][s])}))}catch{}}})();const j={statsCache:null,listCache:[],currentRule:null,currentClient:"",currentStatus:"pending",loading:!1,selectedIds:new Set,offset:0,pageSize:50,total:0,loadFailed:!1,listScrollY:0},D={openExcId:null,excRow:null,history:null,loading:!1,pdfUrl:null,pdfStatus:"idle",editing:!1,editFields:null},dt={batchLoading:!1};function Ne(e,n){let a=t(e)||e;if(n)for(const o in n)a=a.replace(new RegExp("\\{"+o+"\\}","g"),String(n[o]));return a}function Qr(e){return e==="high"?`<svg viewBox="0 0 14 14" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
    ...
    </svg>`}function el(){return`<svg class="exc-empty-icon" viewBox="0 0 40 40" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
        <path d="M11 19l5 5 13-13"/>
        <circle cx="20" cy="20" r="17"/>
    </svg>`}function tl(e){if(e==null)return"—";const n=parseFloat(String(e));return isNaN(n)?"—":"฿ "+n.toLocaleString(void 0,{minimumFractionDigits:2,maximumFractionDigits:2})}function nl(e){return e?e.slice(0,10):"—"}function rt(e){if(e==null)return"—";const n=typeof e=="number"?e:parseFloat(String(e).replace(/,/g,""));return isNaN(n)?escapeHtml(String(e)):"฿ "+n.toLocaleString(void 0,{minimumFractionDigits:2,maximumFractionDigits:2})}function al(e){if(!e)return"—";try{const n=new Date(e),a=o=>String(o).padStart(2,"0");return`${n.getFullYear()}-${a(n.getMonth()+1)}-${a(n.getDate())} ${a(n.getHours())}:${a(n.getMinutes())}`}catch{return e.slice(0,16).replace("T"," ")}}function ol(e,n){if(n=n||{},e==="math_mismatch")return`
        ...
        `:e==="amount_missing"?`<div class="exc-why-detail-row" style="justify-content:center;color:var(--danger);"><span>${escapeHtml(t("exc-detail-missing"))}</span></div>`:`<div class="exc-why-detail-row"><span style="font-size:11px;">${escapeHtml(JSON.stringify(n))}</span></div>`}function De(){const e=D.excRow;if(!e)return;const n=e.seller_name&&e.seller_name.trim()?e.seller_name:t("exc-no-seller"),a=e.filename||"—";document.getElementById("exc-drawer-title").textContent=a;const o="exc-status-"+(e.status||"pending"),s=t(o)||e.status,i="s-"+(e.status||"pending"),r=(e.invoice_date||e.created_at||"").slice(0,10);document.getElementById("exc-drawer-sub").innerHTML=`
        <span>${escapeHtml(n)}</span>
        ${e.invoice_no?`<span>· ${escapeHtml(e.invoice_no)}</span>`:""}
        ${r?`<span>· ${escapeHtml(r)}</span>`:""}
        <span class="exc-status-chip ${i}">${escapeHtml(s)}</span>
    `;const c=e.severity||"medium",m=t("exc-rule-"+e.rule_code)||e.rule_code,d=ol(e.rule_code,e.detail||{}),p=Na(D.history),l=D.history===null,u=D.history&&D.history._err,f=new Set;e.rule_code==="math_mismatch"?(f.add("subtotal"),f.add("vat"),f.add("total_amount")):e.rule_code==="tax_id_format_invalid"?f.add("seller_tax"):e.rule_code==="amount_missing"&&(f.add("total_amount"),f.add("invoice_number"));const v=!!D.editing,w=D.editFields||{},g=(S,F,A)=>{if(l)return`<div class="exc-field-row"><label>${escapeHtml(t(F))}</label><span class="val empty">…</span></div>`;const z=v?w[S]!==void 0?w[S]:p[S]!==void 0&&p[S]!==null?p[S]:"":p[S],ee=f.has(S)?"flagged":"";if(v){const te=A?"number":"text",N=A?' step="0.01" inputmode="decimal"':"",q=z==null?"":String(z).replace(/"/g,"&quot;");return`<div class="exc-field-row ${ee} editing">
                <label>${escapeHtml(t(F))}</label>
                <input class="exc-field-input" type="${te}"${N} data-edit-key="${escapeHtml(S)}" value="${q}">
            </div>`}const oe=A?rt(z):z||"",ce=z==null||z===""?`<span class="val empty">${escapeHtml(t("exc-empty-val"))}</span>`:`<span class="val">${escapeHtml(oe)}</span>`;return`<div class="exc-field-row ${ee}"><label>${escapeHtml(t(F))}</label>${ce}</div>`};let b="";u?b=`<div class="exc-drawer-error">${escapeHtml(t("exc-drawer-error"))}</div>`:b=`
        ...
        `;const h=(()=>{if(D.pdfStatus==="loading"||D.pdfStatus==="idle")return`
    ...
    `;const _=document.getElementById("exc-fld-edit");_&&_.addEventListener("click",()=>{D.editing=!0,D.editFields={...Na(D.history)},De()});const y=document.getElementById("exc-fld-cancel");y&&y.addEventListener("click",()=>{D.editing=!1,D.editFields=null,De()});const k=document.getElementById("exc-fld-save");k&&k.addEventListener("click",()=>rl()),document.querySelectorAll(".exc-field-input").forEach(S=>{S.addEventListener("input",()=>{D.editFields||(D.editFields={}),D.editFields[S.dataset.editKey]=S.value})});const E=document.getElementById("exc-pdf-retry");E&&D.openExcId&&E.addEventListener("click",()=>{D.excRow&&Jo(D.excRow.history_id,D.openExcId)});const B=e.status==="pending",I=!!(e.seller_name&&e.seller_name.trim()),L=document.getElementById("exc-btn-resolve"),C=document.getElementById("exc-btn-ignore");L.disabled=!B,C.disabled=!B||!I,C.title=I?t("exc-ignore-hint"):t("exc-ignore-no-seller")}function fa(){if(D.pdfUrl){try{URL.revokeObjectURL(D.pdfUrl)}catch{}D.pdfUrl=null}D.pdfStatus="idle"}async function Jo(e,n){D.pdfStatus="loading",De();try{const a=await fetch("/api/history/"+encodeURIComponent(e)+"/pdf",{headers:{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||"")}});if(D.openExcId!==n)return;if(a.status===404){D.pdfStatus="empty",De();return}if(!a.ok)throw new Error("http "+a.status);const o=await a.blob();if(D.openExcId!==n)return;fa(),D.pdfUrl=URL.createObjectURL(o),D.pdfStatus="ready",De()}catch(a){if(D.openExcId!==n)return;console.warn("loadDrawerPdf fail",a),D.pdfStatus="error",De()}}function sl(e){const n=(j.listCache||[]).find(a=>a.id===e);if(!n){showToast(t("exc-drawer-error"),"error");return}j.listScrollY=window.scrollY||document.documentElement.scrollTop||0,fa(),D.editing=!1,D.editFields=null,D.openExcId=e,D.excRow=n,D.history=null,document.getElementById("exc-drawer-mask").classList.add("show"),document.getElementById("exc-drawer").classList.add("show"),De(),il(n.history_id),Jo(n.history_id,e)}function gt(){fa(),D.editing=!1,D.editFields=null,D.openExcId=null,D.excRow=null,D.history=null,document.getElementById("exc-drawer-mask").classList.remove("show"),document.getElementById("exc-drawer").classList.remove("show");const e=j.listScrollY||0;e>0&&requestAnimationFrame(()=>window.scrollTo(0,e))}async function il(e){try{const n=await fetch("/api/history/"+encodeURIComponent(e),{headers:{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||"")}});if(!n.ok)throw new Error("http "+n.status);D.history=await n.json()}catch(n){console.warn("loadHistoryDetail fail",n),D.history={_err:!0}}D.excRow&&De()}function Na(e){if(!e||!e.pages)return{};const n=e.pages,a=n.find(o=>!o.is_duplicate&&!o.is_copy)||n[0];return a&&a.fields||{}}async function rl(){if(!D.openExcId||!D.history||!D.history.pages||D.loading)return;D.loading=!0;const e=showToast(t("exc-fld-saving"),"loading",0);try{const n=JSON.parse(JSON.stringify(D.history.pages||[]));let a=n.findIndex(m=>!m.is_duplicate&&!m.is_copy);a<0&&(a=0),n[a]||(n[a]={fields:{}});const o=n[a].fields||{},s=D.editFields||{},i=new Set(["subtotal","vat","total_amount"]),r={...o};for(const m in s){let d=s[m];if((d===""||d===void 0)&&(d=null),i.has(m)&&d!==null){const p=parseFloat(d);d=isNaN(p)?null:p}r[m]=d}n[a].fields=r;const c=await fetch("/api/history/"+encodeURIComponent(D.history.id),{method:"PUT",headers:{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||""),"Content-Type":"application/json"},body:JSON.stringify({pages:n})});if(!c.ok)throw new Error("http "+c.status);e(),showToast(t("exc-fld-save-ok"),"success"),gt(),await _t(),await Ve(),$e()}catch(n){e(),console.warn("save fields fail",n),showToast(t("exc-fld-save-fail"),"error")}finally{D.loading=!1}}async function ll(){if(!(!D.openExcId||D.loading)){D.loading=!0;try{const e=await fetch("/api/exceptions/"+D.openExcId+"/resolve",{method:"POST",headers:{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||"")}});if(!e.ok)throw new Error("http "+e.status);showToast(t("exc-toast-resolved"),"success"),gt(),await _t(),await Ve(),$e()}catch(e){console.warn("resolve fail",e),showToast(t("exc-toast-action-fail"),"error")}finally{D.loading=!1}}}async function cl(){if(!(!D.openExcId||D.loading)){D.loading=!0;try{const e=await fetch("/api/exceptions/"+D.openExcId+"/ignore",{method:"POST",headers:{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||"")}});if(!e.ok)throw new Error("http "+e.status);showToast(t("exc-toast-ignored"),"success"),gt(),await _t(),await Ve(),$e()}catch(e){console.warn("ignore fail",e),showToast(t("exc-toast-action-fail"),"error")}finally{D.loading=!1}}}async function $e(){try{const e=j.currentClient||"",n="/api/exceptions/stats?status=pending"+(e?"&client_id="+encodeURIComponent(e):""),a=await fetch(n,{headers:{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||"")}});if(!a.ok)return;const o=await a.json(),s=document.getElementById("nav-exc-badge");if(!s)return;const i=parseInt(o.pending||0,10);i>0?(s.textContent=i>99?"99+":String(i),s.style.display=""):s.style.display="none"}catch{}}function Wo(e){document.getElementById("exc-kpi-pending").textContent=e.pending||0,document.getElementById("exc-kpi-high").textContent=e.high_severity||0,document.getElementById("exc-kpi-resolved").textContent=e.resolved||0,document.getElementById("exc-kpi-learned").textContent=e.learned_rules||0;const n=document.getElementById("exc-status-tab-count-pending"),a=document.getElementById("exc-status-tab-count-resolved"),o=document.getElementById("exc-status-tab-count-ignored");n&&(n.textContent=e.pending||0),a&&(a.textContent=e.resolved||0),o&&(o.textContent=e.ignored||0),document.querySelectorAll("#exc-status-tabs .exc-status-tab").forEach(i=>{i.classList.toggle("active",i.dataset.status===(j.currentStatus||"pending"))})}function ma(e){const n=document.getElementById("exc-chips");if(!n)return;const a=e.by_rule||{},o=["confidence_low","duplicate","amount_missing","math_mismatch","tax_id_format_invalid"];let i=`<button class="exc-chip ${!j.currentRule?"active":""}" data-rule="">
        ...
        <span class="exc-chip-count">${e.pending||0}</span>
        ...
        </div>`,Va();return}const a='<svg viewBox="0 0 14 14" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M3 7l3 3 5-5"/></svg>',o=(j.currentStatus||"pending")==="pending";n.innerHTML=e.map(s=>{const i=s.severity||"medium",r=t("exc-rule-"+s.rule_code)||s.rule_code,c=s.seller_name&&s.seller_name.trim()?s.seller_name:t("exc-no-seller"),m=s.filename||"—",d=nl(s.invoice_date||s.created_at),p=s.status==="pending",l=j.selectedIds.has(s.id),u=o&&p;return`
            <div class="exc-row sev-${escapeHtml(i)} ${l?"selected":""}" data-exc-id="${escapeHtml(String(s.id))}">
                ...
                <div class="exc-row-sev">${Qr(i)}</div>
        ...
        </div>`,document.body.appendChild(d),d.addEventListener("click",p=>{p.target===d&&ot()}),document.getElementById("erp-exc-m-close").addEventListener("click",ot),document.getElementById("erp-exc-m-cancel").addEventListener("click",ot),document.getElementById("erp-exc-m-retry").addEventListener("click",()=>{ot(),Xt(n.id,null)}),o){let p="";const l=document.getElementById("erp-exc-m-bind"),u=document.getElementById("erp-exc-m-custlist"),f=document.getElementById("erp-exc-m-search"),v=(g,b)=>{const h=(b||"").trim().toLowerCase(),_=h?g.filter(y=>(y.code||"").toLowerCase().includes(h)||(y.name||"").toLowerCase().includes(h)):g;if(_.length===0){u.innerHTML=`<div class="erp-exc-m-empty">${escapeHtml(t("erp-exc-edit-pick-empty"))}</div>`;return}u.innerHTML=_.slice(0,100).map(y=>`<div class="erp-exc-m-cust" data-cust-code="${escapeHtml(y.code||"")}">
                    <span class="erp-exc-m-cust-name">${escapeHtml(y.name||"")}</span>
                    <span class="erp-exc-m-cust-code">${escapeHtml(y.code||"")}</span>
                </div>`).join(""),u.querySelectorAll(".erp-exc-m-cust").forEach(y=>{y.addEventListener("click",()=>{p=y.dataset.custCode||"",u.querySelectorAll(".erp-exc-m-cust").forEach(k=>k.classList.remove("sel")),y.classList.add("sel"),l&&(l.disabled=!p)})})},w=async()=>{const g=n.endpoint_id;if(Ut[g]){v(Ut[g],"");return}try{const b=await fetch("/api/erp/endpoints/"+encodeURIComponent(g)+"/customers",{headers:{Authorization:"Bearer "+Se()}}),h=await b.json().catch(()=>({}));if(!b.ok||!h.ok){u.innerHTML=`<div class="erp-exc-m-empty">${escapeHtml(t("erp-exc-edit-pick-fail"))}</div>`;return}const _=h.customers||[];Ut[g]=_,v(_,"")}catch{u.innerHTML=`<div class="erp-exc-m-empty">${escapeHtml(t("erp-exc-edit-pick-fail"))}</div>`}};f&&f.addEventListener("input",()=>v(Ut[n.endpoint_id]||[],f.value)),w(),l&&l.addEventListener("click",async()=>{if(p){l.disabled=!0,l.textContent=t("erp-exc-retrying");try{if(!(await fetch("/api/erp/mappings/clients",{method:"POST",headers:{Authorization:"Bearer "+Se(),"Content-Type":"application/json"},body:JSON.stringify({client_id:n.history_client_id,erp_type:n.endpoint_adapter,erp_code:p})})).ok){showToast(t("erp-exc-retry-fail"),"error"),l.disabled=!1,l.textContent=t("erp-exc-edit-bind-retry");return}showToast(t("erp-exc-edit-bound-ok"),"success"),ot(),await Xt(n.id,null)}catch{showToast(t("erp-exc-retry-fail"),"error"),l.disabled=!1,l.textContent=t("erp-exc-edit-bind-retry")}}})}if(s){const p=document.getElementById("erp-exc-m-bind-prod"),l=document.getElementById("erp-exc-m-prodlist"),u={};let f=[];const v=()=>'<option value="">'+escapeHtml(t("erp-exc-edit-prod-choose"))+"</option>"+f.slice(0,500).map(b=>`<option value="${escapeHtml(b.code||"")}" data-pname="${escapeHtml(b.name||"")}">`+escapeHtml((b.name||"")+" · "+(b.code||""))+"</option>").join(""),w=b=>{if(!b.length){l.innerHTML=`<div class="erp-exc-m-empty">${escapeHtml(t("erp-exc-edit-prod-noitems"))}</div>`;return}l.innerHTML=b.map(h=>`<div class="erp-exc-m-cust" style="cursor:default">
...
`;let Ja=!1,yn=[],qn=null,Me="amount_limit",ba="global";const bl="/api/knowledge/rules";function yl(){return localStorage.getItem("mrpilot_token")||""}async function bt(e,n,a){return fetch(bl+n,{method:e,headers:{Authorization:"Bearer "+yl(),"Content-Type":"application/json"},body:a?JSON.stringify(a):void 0})}function wl(e){const n=Number(e);return Number.isFinite(n)?"฿ "+n.toLocaleString("en-US"):String(e)}function kl(e){const n=le(),a=o=>e===o?" selected":"";return`<option value="high"${a("high")}>${n.sevHigh}</option><option value="medium"${a("medium")}>${n.sevMid}</option><option value="low"${a("low")}>${n.sevLow}</option>`}function Wa(e,n){const a=n&&n.subject_key?escapeHtml(n.subject_key):"";return`<div class="rs-mlbl">${e}</div><input class="rs-field" id="rs-f-key" value="${a}"${n?" disabled":""}>`}function xl(e){const n=le(),a=e.subject_key?escapeHtml(e.subject_key):"";if(e.rule_type==="amount_limit"){const o=wl(e.rule_body.limit);let s=n.gAmount;e.subject_type==="global"?s=n.anyInvoice:e.subject_type==="supplier"?s=`${n.fSupplierTax} <b>${a}</b>`:s=`「${a}」`;const i=e.rule_body.notify_line?` <span class="rs-line">${qe("bell",12)} ${n.alsoLine}</span>`:"";return`${s} &gt; <b>${o}</b>${i}`}if(e.rule_type==="supplier_force_review")return`<b>${a}</b> · ${n.tForceDesc}`;if(e.rule_type==="no_auto_push_category")return`「${a}」 · ${n.tCategoryDesc}`;if(e.rule_type==="accounting_period"){const s=e.rule_body.mode==="prev_month"?n.pmPrev:n.pmCurrent;return`${n.gPeriodDesc} · <b>${s}</b>`}return e.rule_type}function _l(e){const n=le(),a=e.severity||"medium",o=a==="high"?n.sevHigh:a==="low"?n.sevLow:n.sevMid;return`<div class="rs-rule"><div class="rs-rm"><div class="rs-rt">${xl(e)}</div></div><span class="rs-sev ${a}">${o}</span><button class="rs-sw${e.is_active?"":" off"}" data-toggle="${e.id}" aria-label="toggle"></button><button class="rs-icobtn" data-edit="${e.id}" aria-label="edit">${qe("pencil",14)}</button><button class="rs-icobtn" data-del="${e.id}" aria-label="delete">${qe("trash",14)}</button></div>`}function Gt(e,n,a,o,s){const i=le(),c=yn.filter(m=>s.includes(m.rule_type)).map(_l).join("")||`<div class="rs-empty">${i.empty}</div>`;return`<div class="rs-group"><div class="rs-ghead"><div class="rs-gico">${qe(e,17)}</div><div><div class="rs-gt">${n}</div><div class="rs-gd">${a}</div></div><button class="rs-addbtn" data-add-type="${o}">${qe("plus",14)} ${i.add}</button></div><div class="rs-gbody">${c}</div></div>`}function Zo(){const e=le(),n=document.querySelector("#rules-settings-modal .rs-head h2");n&&(n.textContent=e.title);const a=document.getElementById("rs-body");a&&(a.innerHTML=`<p class="rs-lead">${e.lead}</p>`+Gt("building",e.gSupplier,e.gSupplierDesc,"supplier_force_review",["supplier_force_review"])+Gt("wallet",e.gAmount,e.gAmountDesc,"amount_limit",["amount_limit"])+Gt("calendar",e.gPeriod,e.gPeriodDesc,"accounting_period",["accounting_period"])+Gt("octagon",e.gCategory,e.gCategoryDesc,"no_auto_push_category",["no_auto_push_category"]))}async function wn(){try{const e=await bt("GET","");if(!e.ok)throw new Error("http "+e.status);yn=(await e.json()).rules||[],Zo()}catch{showToast(le().loadFail,"error")}}function zn(e){const n=le(),a=e?e.severity:Me==="supplier_force_review"?"high":"medium",o=`<div class="rs-mlbl">${n.fSeverity}</div><select class="rs-field" id="rs-f-sev">${kl(a)}</select>`;if(Me==="amount_limit"){const i=e?e.subject_type:ba,r=e&&e.subject_key?escapeHtml(e.subject_key):"",c=e?String(e.rule_body.limit??""):"",m=e?!!e.rule_body.notify_line:!0,d=i==="global"?"":`<div class="rs-mlbl">${i==="category"?n.fCategory:n.fSupplierTax}</div><input class="rs-field" id="rs-f-key" value="${r}">`;return`<div class="rs-mlbl">${n.gAmountDesc}</div><select class="rs-field" id="rs-f-scope"${e?" disabled":""}><option value="global"${i==="global"?" selected":""}>${n.anyInvoice}</option><option value="supplier"${i==="supplier"?" selected":""}>${n.tForce}</option><option value="category"${i==="category"?" selected":""}>${n.fCategory}</option></select><div id="rs-f-subj">${d}</div><div class="rs-two"><div><div class="rs-mlbl">${n.fAmountLimit}</div><input class="rs-field" id="rs-f-limit" type="number" min="1" value="${c}"></div><div>${o}</div></div><label class="rs-check"><input type="checkbox" id="rs-f-line"${m?" checked":""}>${qe("bell",14)} ${n.fAlsoLine}</label>`}if(Me==="supplier_force_review")return Wa(n.fSupplierTax,e)+o;if(Me==="no_auto_push_category")return Wa(n.fCategory,e)+o;const s=e?e.rule_body.mode:"current_month";return`<div class="rs-mlbl">${n.fPeriodMode}</div><select class="rs-field" id="rs-f-mode"><option value="current_month"${s==="current_month"?" selected":""}>${n.pmCurrent}</option><option value="prev_month"${s==="prev_month"?" selected":""}>${n.pmPrev}</option></select>`+o}function Kt(e,n,a){return`<button class="rs-type${Me===e?" on":""}" data-type-pick="${e}"><div class="tt">${n}</div><div class="td">${a}</div></button>`}function El(e){const n=le(),a=document.getElementById("rs-add-modal");if(!a)return;const o=e?"":`<div class="rs-mlbl">${n.rType}</div><div class="rs-types">`+Kt("supplier_force_review",n.tForce,n.tForceDesc)+Kt("amount_limit",n.tAmount,n.tAmountDesc)+Kt("accounting_period",n.tPeriod,n.tPeriodDesc)+Kt("no_auto_push_category",n.tCategory,n.tCategoryDesc)+"</div>";a.innerHTML=`<div class="rs-pop" style="max-width:460px;"><div class="rs-head"><h2>${e?n.editTitle:n.addTitle}</h2><button class="rs-close" id="rs-add-close">${qe("x",18)}</button></div><div class="rs-body">${o}<div id="rs-add-fields">${zn(e)}</div></div><div class="rs-foot" style="gap:10px;"><button class="rs-btn rs-btn-ghost" id="rs-add-cancel">${n.cancel}</button><button class="rs-btn rs-btn-primary" id="rs-add-save">${n.save}</button></div></div>`,a.classList.add("rs-open")}function Ke(e){const n=document.getElementById(e);return n?String(n.value).trim():""}function Bl(){const e=le(),n=Ke("rs-f-sev")||"medium";if(Me==="amount_limit"){const a=Ke("rs-f-scope")||"global",o=Number(Ke("rs-f-limit"));if(!Number.isFinite(o)||o<=0)return showToast(e.needAmount,"error"),{ok:!1};const s=a==="global"?null:Ke("rs-f-key");if(a!=="global"&&!s)return showToast(a==="category"?e.needCategory:e.needSupplier,"error"),{ok:!1};const i=document.getElementById("rs-f-line")?.checked;return{ok:!0,payload:{rule_type:"amount_limit",subject_type:a,subject_key:s,severity:n,rule_body:{limit:o,basis:"total",period:"per_invoice",notify_line:!!i}}}}if(Me==="supplier_force_review"){const a=Ke("rs-f-key");return a?{ok:!0,payload:{rule_type:"supplier_force_review",subject_type:"supplier",subject_key:a,severity:n,rule_body:{}}}:(showToast(e.needSupplier,"error"),{ok:!1})}if(Me==="no_auto_push_category"){const a=Ke("rs-f-key");return a?{ok:!0,payload:{rule_type:"no_auto_push_category",subject_type:"category",subject_key:a,severity:n,rule_body:{}}}:(showToast(e.needCategory,"error"),{ok:!1})}return{ok:!0,payload:{rule_type:"accounting_period",subject_type:"global",subject_key:null,severity:n,rule_body:{mode:Ke("rs-f-mode")||"current_month"}}}}async function Il(){const e=Bl();if(!(!e.ok||!e.payload))try{let n;if(qn!==null){const a=e.payload;n=await bt("PATCH","/"+qn,{rule_body:a.rule_body,severity:a.severity})}else n=await bt("POST","",e.payload);if(!n.ok)throw new Error("http "+n.status);showToast(le().saved,"success"),document.getElementById("rs-add-modal")?.classList.remove("rs-open"),await wn()}catch{showToast(le().saveFail,"error")}}async function Ll(e){const n=yn.find(a=>a.id===e);if(n)try{const a=await bt("PATCH","/"+e,{is_active:!n.is_active});if(!a.ok)throw new Error("http "+a.status);await wn()}catch{showToast(le().saveFail,"error")}}async function Cl(e){if(await showConfirm(le().delConfirm,{danger:!0}))try{const a=await bt("DELETE","/"+e);if(!a.ok)throw new Error("http "+a.status);showToast(le().deleted,"success"),await wn()}catch{showToast(le().saveFail,"error")}}function Ya(e,n){Me=e,ba="global",qn=n?n.id:null,El(n)}function Sl(){if(Ja)return;const e=document.createElement("style");e.textContent=gl,document.head.appendChild(e);const n=le(),a=document.createElement("div");a.id="rules-settings-modal",a.innerHTML=`<div class="rs-pop"><div class="rs-head"><h2>${n.title}</h2><span class="rs-tag">●</span><button class="rs-close" id="rs-main-close">${qe("x",18)}</button></div><div class="rs-body" id="rs-body"></div><div class="rs-foot"><button class="rs-btn rs-btn-primary" id="rs-done">${n.done}</button></div></div>`,document.body.appendChild(a);const o=document.createElement("div");o.id="rs-add-modal",document.body.appendChild(o),document.addEventListener("click",s=>{const i=s.target;(i.id==="rules-settings-modal"||i.closest("#rs-main-close")||i.closest("#rs-done"))&&a.classList.remove("rs-open"),(i.id==="rs-add-modal"||i.closest("#rs-add-close")||i.closest("#rs-add-cancel"))&&o.classList.remove("rs-open");const r=i.closest("[data-add-type]");r&&Ya(r.dataset.addType);const c=i.closest("[data-edit]");if(c){const l=yn.find(u=>u.id===Number(c.dataset.edit));l&&Ya(l.rule_type,l)}const m=i.closest("[data-del]");m&&Cl(Number(m.dataset.del));const d=i.closest("[data-toggle]");d&&Ll(Number(d.dataset.toggle));const p=i.closest("[data-type-pick]");if(p){Me=p.dataset.typePick;const l=document.getElementById("rs-add-fields");l&&(l.innerHTML=zn())}i.closest("#rs-add-save")&&Il()}),document.addEventListener("change",s=>{const i=s.target;if(i.id==="rs-f-scope"){ba=i.value;const r=document.getElementById("rs-add-fields");r&&(r.innerHTML=zn())}}),document.addEventListener("keydown",s=>{s.key==="Escape"&&(o.classList.contains("rs-open")?o.classList.remove("rs-open"):a.classList.contains("rs-open")&&a.classList.remove("rs-open"))}),Ja=!0}window.openRulesSettings=function(){Sl(),document.getElementById("rules-settings-modal").classList.add("rs-open"),wn()};function Tl(){const e=document.querySelector("#page-exceptions .page-head-actions");if(!e||document.getElementById("exc-rules-btn"))return;const n=document.createElement("button");n.id="exc-rules-btn",n.type="button",n.className="btn btn-ghost",n.innerHTML=qe("settings",16)+`<span class="rs-btn-label">${le().btn}</span>`,n.addEventListener("click",()=>window.openRulesSettings&&window.openRulesSettings()),e.insertBefore(n,e.firstChild)}let Xa=!1;async function Ml(){if(!Xa){Xa=!0;try{(await bt("GET","")).ok&&Tl()}catch{}}}const Za=window.loadExceptionsPage;window.loadExceptionsPage=function(){Ml(),Za&&Za()};Array.isArray(window.__i18nSubs)||(window.__i18nSubs=[]);window.__i18nSubs.push({name:"rules-settings",fn:()=>{const e=document.querySelector("#exc-rules-btn .rs-btn-label");e&&(e.textContent=le().btn),document.getElementById("rules-settings-modal")?.classList.contains("rs-open")&&Zo()}});const $l=`
    <div class="cmdk">
...
`;fe("cmdk-mask",$l);(function(){function e(l){try{if(location.search.indexOf("test_center=1")>=0||localStorage.getItem("pearnly_test_mode")==="1"||l&&l.id&&String(l.id)==="468b50c1-5593-4fd6-990d-515ce8085563")return!0}catch{}return!1}window.applyRoleVisibility=function(){var u=window._userInfo,f=!1,v=!0,w=!1,g=!1;u&&(f=typeof canManageTeam=="function"?canManageTeam(u):!!(u.role==="owner"||u.is_super_admin),v=typeof shouldHideMoney=="function"?shouldHideMoney(u):u.role==="member"&&!u.is_super_admin,w=typeof isSuperAdmin=="function"?isSuperAdmin(u):!!u.is_super_admin,g=e(u)),document.querySelectorAll("[data-show-if-team]").forEach(function(h){h.style.display=f?"":"none"}),document.querySelectorAll("[data-show-if-money]").forEach(function(h){h.style.display=v?"none":""}),document.querySelectorAll("[data-show-if-admin]").forEach(function(h){h.style.display=w?"":"none"}),document.querySelectorAll("[data-show-if-test]").forEach(function(h){h.style.display=g?"":"none"});var b=w||g;document.querySelectorAll("[data-show-if-special]").forEach(function(h){h.style.display=b?"":"none"})},window.renderAvatarMenu=function(u){if(u){var f=document.getElementById("avatar-btn"),v=document.getElementById("avatar-popup-name"),w=document.getElementById("avatar-popup-email");if(!(!f||!v||!w)){var g=(u.username||"").trim(),b=g.split("@")[0]||g||"—",h=(g.charAt(0)||"?").toUpperCase(),_=(u.avatar_url||"").trim();if(_){var y=_.replace(/"/g,"&quot;"),k=h.replace(/'/g,"\\'");f.innerHTML='<img src="'+y+'" alt="'+h+`" referrerpolicy="no-referrer" onerror="this.parentNode.textContent='`+k+`'">`}else f.textContent=h;v.textContent=b,w.textContent=g||"—",f.setAttribute("title",g||"")}}};function n(){var l=document.getElementById("avatar-wrap"),u=document.getElementById("avatar-btn"),f=document.getElementById("avatar-popup");if(!l||!u||!f)return;function v(){f.classList.remove("show"),u.setAttribute("aria-expanded","false")}function w(){f.classList.add("show"),u.setAttribute("aria-expanded","true")}u.addEventListener("click",function(g){g.stopPropagation(),f.classList.contains("show")?v():w()}),document.addEventListener("click",function(g){f.classList.contains("show")&&!l.contains(g.target)&&v()}),f.addEventListener("click",function(g){var b=g.target.closest(".avatar-popup-item");if(b){var h=b.dataset.action;switch(v(),h){case"settings":typeof openSettingsModal=="function"?openSettingsModal():typeof routeTo=="function"&&routeTo("settings");break;case"team":typeof openSettingsModal=="function"?openSettingsModal():typeof routeTo=="function"&&routeTo("settings"),setTimeout(function(){typeof switchSettingsTab=="function"&&switchSettingsTab("team")},50);break;case"billing":typeof openSettingsModal=="function"?openSettingsModal():typeof routeTo=="function"&&routeTo("settings"),setTimeout(function(){typeof switchSettingsTab=="function"&&switchSettingsTab("plan")},50);break;case"shortcuts":if(typeof showToast=="function"){var _=typeof t=="function"?t("feature-coming-soon"):"即将上线";showToast(_||"即将上线","info")}break;case"admin":window.location.href="/admin/cost";break;case"test-center":typeof routeTo=="function"&&routeTo("test-center");break;case"help":var y=document.getElementById("help-modal");y&&(y.style.display="flex");break;case"logout":try{localStorage.removeItem("mrpilot_token")}catch{}try{localStorage.removeItem("mrpilot_user")}catch{}window.location.href="/";break}}}),window._closeAvatarPopup=v}function a(){return[].slice.call(document.querySelectorAll(".cmdk-item")).filter(function(l){return l.style.display!=="none"})}function o(l){var u=a();u.forEach(function(f){f.classList.remove("focus")}),u[l]&&(u[l].classList.add("focus"),u[l].scrollIntoView({block:"nearest"}))}function s(l){var u=a();if(u.length){var f=u.findIndex(function(w){return w.classList.contains("focus")});f<0&&(f=0);var v=(f+l+u.length)%u.length;o(v)}}function i(l){l=(l||"").toLowerCase().trim();var u=0,f=window._userInfo,v=typeof isSuperAdmin=="function"?isSuperAdmin(f):!!(f&&f.is_super_admin),w=e(f);document.querySelectorAll(".cmdk-item").forEach(function(b){if(b.dataset.showIfAdmin==="1"&&!v){b.style.display="none";return}if(b.dataset.showIfTest==="1"&&!w){b.style.display="none";return}var h=(b.dataset.cmdkText||b.textContent||"").toLowerCase(),_=!l||h.indexOf(l)>=0;b.style.display=_?"":"none",b.classList.remove("focus"),_&&u++}),document.querySelectorAll("[data-cmdk-section]").forEach(function(b){for(var h=b.nextElementSibling,_=!1;h&&!h.hasAttribute("data-cmdk-section");){if(h.classList&&h.classList.contains("cmdk-item")&&h.style.display!=="none"){_=!0;break}h=h.nextElementSibling}b.style.display=_?"":"none"});var g=document.getElementById("cmdk-empty");g&&(g.style.display=u===0?"flex":"none"),o(0)}window.openCmdk=function(){var u=document.getElementById("cmdk-mask");u&&(typeof window._closeAvatarPopup=="function"&&window._closeAvatarPopup(),u.classList.add("show"),typeof window.applyRoleVisibility=="function"&&window.applyRoleVisibility(),setTimeout(function(){var f=document.getElementById("cmdk-input");f&&(f.value="",i(""),f.focus(),o(0))},50))},window.closeCmdk=function(){var u=document.getElementById("cmdk-mask");u&&u.classList.remove("show")};function r(l){if(l){if(l.classList.contains("cmdk-item-locked")){if(typeof showToast=="function"){var u=typeof t=="function"?t("feature-coming-soon"):"即将上线";showToast(u||"即将上线","info")}return}var f=l.dataset.cmdkRoute,v=l.dataset.cmdkAction;if(window.closeCmdk(),f){typeof routeTo=="function"&&routeTo(f);return}if(v){if(v==="open-admin"){window.location.href="/admin/cost";return}if(v.indexOf("lang-")===0){var w=v.slice(5);typeof applyLang=="function"&&applyLang(w)}}}}function c(){var l=document.getElementById("cmdk-mask"),u=document.getElementById("cmdk-input"),f=document.getElementById("cmdk-body");if(!(!l||!u||!f)){l.addEventListener("click",function(g){g.target===l&&window.closeCmdk()});var v=document.getElementById("cmdk-esc-btn");v&&v.addEventListener("click",function(){window.closeCmdk()}),u.addEventListener("input",function(g){i(g.target.value)}),u.addEventListener("keydown",function(g){g.key==="ArrowDown"?(g.preventDefault(),s(1)):g.key==="ArrowUp"?(g.preventDefault(),s(-1)):g.key==="Enter"?(g.preventDefault(),r(l.querySelector(".cmdk-item.focus"))):g.key==="Escape"&&(g.preventDefault(),window.closeCmdk())}),f.addEventListener("click",function(g){var b=g.target.closest(".cmdk-item");b&&r(b)}),f.addEventListener("mousemove",function(g){var b=g.target.closest(".cmdk-item");!b||b.style.display==="none"||b.classList.contains("cmdk-item-locked")||(a().forEach(function(h){h.classList.remove("focus")}),b.classList.add("focus"))});var w=document.getElementById("topbar-search");w&&(w.addEventListener("click",function(){window.openCmdk()}),w.addEventListener("keydown",function(g){(g.key==="Enter"||g.key===" ")&&(g.preventDefault(),window.openCmdk())}))}}document.addEventListener("keydown",function(l){if((l.metaKey||l.ctrlKey)&&(l.key==="k"||l.key==="K")){l.preventDefault(),window.openCmdk();return}if(l.key==="Escape"){var u=document.getElementById("cmdk-mask");if(u&&u.classList.contains("show")){window.closeCmdk();return}var f=document.getElementById("avatar-popup");f&&f.classList.contains("show")&&typeof window._closeAvatarPopup=="function"&&window._closeAvatarPopup()}});try{var m=(navigator.userAgent||"").toLowerCase(),d=m.indexOf("mac")>=0||m.indexOf("iphone")>=0||m.indexOf("ipad")>=0;d||document.body.classList.add("is-windows")}catch{}function p(){n(),c(),typeof window.subscribeI18n=="function"&&window.subscribeI18n("nav-ia-phase1-role",function(){try{typeof window.applyRoleVisibility=="function"&&window.applyRoleVisibility()}catch{}})}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",p):p()})();(function(){function n(v){return String(v??"").replace(/[&<>"']/g,function(w){return{"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"}[w]})}function a(v){if(!v||isNaN(v))return"";var w=Number(v);return w<1024?w+" B":w<1024*1024?(w/1024).toFixed(1)+" KB":(w/1024/1024).toFixed(1)+" MB"}document.addEventListener("click",function(v){var w=v.target.closest&&v.target.closest(".recon-collapse-head");if(w&&!(v.target.closest("button")||v.target.closest("a"))){var g=w.closest(".recon-collapse");if(g){var b=g.getAttribute("data-collapsed")==="true";g.setAttribute("data-collapsed",b?"false":"true"),b&&(g.id==="vex-summary-collapse"&&p(),g.id==="vex-detail-collapse"&&l())}}}),document.addEventListener("keydown",function(v){if(!(v.key!=="Enter"&&v.key!==" ")){var w=v.target.closest&&v.target.closest(".recon-collapse-head");w&&(v.preventDefault(),w.click())}});var o={vat:"",gl:""};window._glvClearPreviewSearch=function(){o.vat="",o.gl=""};var s='<svg class="vex-pp-fi-icon" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#111111" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/></svg>',i='<svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg>';function r(){m("vat"),m("gl")}function c(v){try{if(typeof window._glvPreviewFiles=="function")return window._glvPreviewFiles(v)||[]}catch{}var w=document.getElementById(v==="vat"?"glv-vat-input":"glv-gl-input");return w&&w.files?Array.from(w.files):[]}function m(v){var w=document.getElementById(v==="vat"?"glv-pp-vat-col":"glv-pp-gl-col");if(w){var g=c(v),b=v==="vat"?"glv-up-vat-title":"glv-up-gl-title",h=v==="vat"?"① 销项税报告":"② 总账 GL",_=window.t&&window.t(b)||h,y=n(window.t&&window.t("vex-preview-search")||"搜索文件名..."),k=n(window.t&&window.t("vex-preview-clear-all")||"全清"),x=o[v]||"",E=g.length;w.innerHTML='<div class="vex-pp-col-title"><span class="vex-pp-col-name">'+n(_)+' <span class="vex-pp-col-count">'+E+'</span></span></div><div class="vex-pp-search-row"><input class="vex-pp-search" id="glv-pp-search-'+v+'" type="text" placeholder="'+y+'" value="'+n(x)+'" autocomplete="off"><button class="vex-pp-clear-btn" id="glv-pp-clearall-'+v+'" type="button">'+k+'</button></div><div class="vex-pp-file-list" id="glv-pp-'+v+'-list"></div><div class="vex-pp-pagination" id="glv-pp-'+v+'-pg"></div>';var B=document.getElementById("glv-pp-search-"+v);B&&B.addEventListener("input",function(L){o[v]=L.target.value,d(v)});var I=document.getElementById("glv-pp-clearall-"+v);I&&I.addEventListener("click",function(){window._glvRemoveFile&&window._glvRemoveFile(v)}),d(v)}}function d(v){var w=document.getElementById("glv-pp-"+v+"-list"),g=document.getElementById("glv-pp-"+v+"-pg");if(w){var b=c(v),h=(o[v]||"").toLowerCase(),_=b.map(function(x,E){return{f:x,i:E}}),y=h?_.filter(function(x){return x.f.name.toLowerCase().indexOf(h)>=0}):_;if(w.innerHTML=y.map(function(x){var E=x.f;return'<div class="vex-pp-file-row">'+s+'<span class="vex-pp-fi-name" title="'+n(E.name)+'">'+n(E.name)+'</span><span class="vex-pp-fi-size">'+a(E.size)+'</span><button class="vex-pp-fi-del" type="button" data-kind="'+v+'" data-idx="'+x.i+'" aria-label="remove">'+i+"</button></div>"}).join(""),w.querySelectorAll(".vex-pp-fi-del").forEach(function(x){x.addEventListener("click",function(){var E=x.dataset.kind,B=parseInt(x.dataset.idx,10);window._glvRemoveFile&&window._glvRemoveFile(E,isNaN(B)?null:B)})}),g){var k=window.t&&window.t("vex-preview-count")||"显示前 {n} / 共 {m}";g.textContent=k.replace("{n}",y.length).replace("{m}",y.length)}}}function p(){var v=function(g,b){var h=document.getElementById(g);h&&(h.textContent=b==null?"—":String(b))},w=window._vexLastTask||{};v("vex-sum-total",w.total),v("vex-sum-matched",w.matched),v("vex-sum-diff",w.diff),v("vex-sum-incomplete",w.incomplete),v("vex-sum-cash",w.cash),document.getElementById("vex-summary-sub")}function l(){var v=window._vexLastTask&&window._vexLastTask.diff_rows||[],w=document.getElementById("vex-detail-tbody"),g=document.getElementById("vex-detail-table"),b=document.getElementById("vex-detail-empty");if(!(!w||!g||!b)){if(v.length===0){g.style.display="none",b.style.display="";return}b.style.display="none",g.style.display="";var h=v.map(function(y){return'<tr><td class="recon-detail-cell-mono">'+n(y.invoice_no||"")+"</td><td>"+n(y.field||"")+"</td><td>"+n(y.report_value||"")+"</td><td>"+n(y.invoice_value||"")+"</td><td>"+n(y.kind||"")+"</td></tr>"}).join("");w.innerHTML=h;var _=document.getElementById("vex-detail-sub");_&&(_.textContent=String(v.length))}}function u(){var v=document.getElementById("glv-toggle-preview");v&&!v._reconBound&&(v._reconBound=!0,v.addEventListener("click",function(){var w=document.getElementById("glv-preview-panel"),g=document.getElementById("glv-toggle-preview-label"),b=w&&w.style.display!=="none";w&&(w.style.display=b?"none":""),v.classList.toggle("open",!b),g&&(g.textContent=b?window.t&&window.t("vex-toggle-preview-open")||"查看清单":window.t&&window.t("vex-toggle-preview-close")||"收起清单"),b||r()})),["glv-vat-input","glv-gl-input"].forEach(function(w){var g=document.getElementById(w);!g||g._reconWatched||(g._reconWatched=!0,g.addEventListener("change",function(){var b=document.getElementById("glv-preview-panel");b&&b.style.display!=="none"&&r()}))})}function f(){var v=document.getElementById("vex-summary-collapse"),w=document.getElementById("vex-detail-collapse");v&&(v.style.display=""),w&&(w.style.display=""),p(),l()}window._fillVexSummary=p,window._fillVexDetail=l,window._onVexResultShown=f,document.addEventListener("DOMContentLoaded",function(){u()}),setTimeout(u,1500),typeof window.subscribeI18n=="function"&&window.subscribeI18n("recon-collapse",function(){var v=document.getElementById("glv-preview-panel");v&&v.style.display!=="none"&&r();var w=document.getElementById("glv-toggle-preview-label"),g=document.getElementById("glv-toggle-preview");w&&g&&(w.textContent=g.classList.contains("open")?window.t&&window.t("vex-toggle-preview-close")||"收起清单":window.t&&window.t("vex-toggle-preview-open")||"查看清单")}),window._reconCollapse={renderGlvPreview:r,fillVexSummary:p,fillVexDetail:l}})();(function(){function e(i){}function n(){const i=document.querySelectorAll("[data-recon-tab]");i.forEach(c=>{c.addEventListener("click",()=>{i.forEach(u=>u.classList.remove("active")),c.classList.add("active");const m=c.dataset.reconTab,d=document.getElementById("recon-pane-bank"),p=document.getElementById("recon-pane-sale-vat"),l=document.getElementById("recon-pane-gl-vat");d&&(d.style.display=m==="bank"?"":"none"),p&&(p.style.display=m==="sale-vat"?"":"none"),l&&(l.style.display=m==="gl-vat"?"":"none"),m==="gl-vat"&&window.GlVatRecon&&window.GlVatRecon.ensureInit(),m==="bank"&&typeof window._bankReconV2Init=="function"&&window._bankReconV2Init()})});const r=document.querySelector("[data-recon-tab].active");r&&(r.dataset.reconTab,void 0)}function a(){const i=document.getElementById("page-settings");if(!i)return null;let r=document.getElementById("settings-modal-overlay");if(r)return r;r=document.createElement("div"),r.id="settings-modal-overlay",r.className="settings-modal-overlay",r.style.display="none",i.parentElement.insertBefore(r,i),r.appendChild(i);const c=document.createElement("button");return c.id="settings-modal-close",c.className="settings-modal-close",c.setAttribute("aria-label","close"),c.innerHTML='<svg viewBox="0 0 20 20" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M5 5l10 10M15 5L5 15"/></svg>',i.insertBefore(c,i.firstChild),c.addEventListener("click",s),r.addEventListener("click",m=>{m.target===r&&s()}),r}function o(){const i=a();if(!i)return;i.style.display="flex",document.body.classList.add("settings-modal-open");const r=document.getElementById("page-settings");r&&(r.style.display="block"),setTimeout(()=>{try{typeof renderSettings=="function"&&renderSettings()}catch(m){console.warn("renderSettings:",m)}let c=document.querySelector(".settings-tab.active")||document.querySelector('.settings-tab[data-tab="profile"]');c&&c.click()},50)}function s(){const i=document.getElementById("settings-modal-overlay");i&&(i.style.display="none"),document.body.classList.remove("settings-modal-open")}window.openSettingsModal=o,window.closeSettingsModal=s,document.addEventListener("keydown",i=>{if(i.key==="Escape"){const r=document.getElementById("settings-modal-overlay");r&&r.style.display==="flex"&&s()}}),window.addEventListener("hashchange",()=>{location.hash==="#/settings"&&o()}),window.addEventListener("DOMContentLoaded",()=>{location.hash==="#/settings"&&o()}),document.readyState==="loading"?document.addEventListener("DOMContentLoaded",n):n()})();const Sn=1e3,Tn=30,ya=/\.(pdf|jpe?g|png|webp|tiff?|xlsx?|xlsm|csv|tsv|docx?)$/i,Y=e=>document.getElementById(e);function nt(){return{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||"")}}function he(e){const n={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"};return String(e??"").replace(/[&<>"']/g,a=>n[a])}function Qo(e){return e<1024?e+" B":e<1024*1024?(e/1024).toFixed(1)+" KB":(e/1024/1024).toFixed(1)+" MB"}const $={invoiceFiles:[],reportFiles:[],running:!1,vexAllRows:[],previewLimitInv:50,previewLimitRep:50,previewSearchInv:"",previewSearchRep:"",vexPage:1};async function Zt(){try{const e=await fetch("/api/vat_excel/tasks?page=1&page_size=1",{headers:nt()});if(!e.ok)return;const a=(await e.json()).kpi||{};[["vex-kpi-month-val",a.this_month],["vex-kpi-running-val",a.running],["vex-kpi-done-val",a.done],["vex-kpi-failed-val",a.failed]].forEach(([o,s])=>{const i=document.getElementById(o);i&&(i.textContent=s??0)})}catch{}}async function Qt(){try{const e=await fetch("/api/vat_excel/tasks?page=1&page_size=100",{headers:nt()});if(!e.ok)return;const n=await e.json();rn(n.rows||[])}catch{}}const pt=10;function es(){var e=((document.getElementById("vex-task-search")||{}).value||"").trim().toLowerCase();if($.vexPage=1,rn($.vexAllRows),!!e){var n=document.getElementById("vex-task-tbody");n&&n.querySelectorAll("tr").forEach(function(a){a.dataset.taskId&&(a.style.display=a.textContent.toLowerCase().indexOf(e)>=0?"":"none")})}}function rn(e){$.vexAllRows=e||$.vexAllRows;const n=document.getElementById("vex-task-tbody");if(!n)return;if(!$.vexAllRows.length){n.innerHTML='<tr><td colspan="9" class="vex-task-empty">'+(t("sv-empty-title")||"还没有对账任务")+"</td></tr>",Qa(0);return}const a=Math.ceil($.vexAllRows.length/pt);$.vexPage>a&&($.vexPage=a);const o=($.vexPage-1)*pt;Hl($.vexAllRows.slice(o,o+pt)),Qa($.vexAllRows.length)}function Qa(e){const n=document.getElementById("vex-task-pager"),a=document.getElementById("vex-task-pager-info"),o=document.getElementById("vex-task-prev"),s=document.getElementById("vex-task-next");if(!n)return;if(e<=pt){n.style.display="none";return}n.style.display="";const i=Math.ceil(e/pt);a&&(a.textContent=$.vexPage+" / "+i),o&&(o.disabled=$.vexPage<=1),s&&(s.disabled=$.vexPage>=i)}function Hl(e){const n=document.getElementById("vex-task-tbody");if(!n)return;const a={pending:t("vex-status-pending")||"待处理",running:t("vex-status-running")||"处理中",done:t("vex-status-done")||"已完成",failed:t("vex-status-failed")||"失败"},o={pending:"badge-gray",running:"badge-blue",done:"badge-green",failed:"badge-red"},s='<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M8 2v9M4 7l4 4 4-4M3 14h10"/></svg>',i='<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M3 4h10M6 4V3h4v1M5 4v8a1 1 0 001 1h4a1 1 0 001-1V4"/></svg>';n.innerHTML=e.map(r=>{const c=r.created_at?new Date(r.created_at).toLocaleString([],{year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",minute:"2-digit"}):"—",m=r.period||"—",d=r.matched_count!=null?r.matched_count+" ✓ · "+r.mismatched_count+" ⚠":"—",p=r.mismatch_amount!=null?"฿ "+Number(r.mismatch_amount).toLocaleString():"—",l=r.elapsed_seconds!=null?r.elapsed_seconds.toFixed(1)+" s":"—",u=r.status||"pending",f=r.client_name&&r.client_name!=="client"?r.client_name:t("vex-client-all")||"全部客户";return`<tr class="vex-task-row" data-task-id="${he(r.id)}" style="cursor:pointer">
        ...
        </tr>`}).join(""),n.querySelectorAll(".vex-task-dl-btn").forEach(r=>{r.addEventListener("click",async c=>{c.stopPropagation();const m=r.dataset.taskId;try{const d=await fetch("/api/vat_excel/tasks/"+encodeURIComponent(m)+"/download",{credentials:"include",headers:nt()});if(d.status===410){showToast(t("vex-toast-expired")||"数据已过期 · 请重新对账","warn");return}if(!d.ok){showToast(t("vex-toast-dl-fail")||"下载失败 · 请重试","error");return}const p=await d.blob(),u=(d.headers.get("Content-Disposition")||"").match(/filename\*?=(?:UTF-8''|")?([^";]+)/i),f=u?decodeURIComponent(u[1]):"vat_recon_"+m+".xlsx",v=URL.createObjectURL(p),w=document.createElement("a");w.href=v,w.download=f,w.click(),setTimeout(()=>URL.revokeObjectURL(v),1e3)}catch{showToast(t("vex-toast-dl-fail")||"下载失败 · 请重试","error")}})}),n.querySelectorAll(".vex-task-del-btn").forEach(r=>{r.addEventListener("click",c=>{c.stopPropagation(),jl(r.dataset.taskId)})}),es()}function Al(){var e=document.getElementById("vex-task-prev"),n=document.getElementById("vex-task-next");e&&!e._vexBound&&(e._vexBound=!0,e.addEventListener("click",function(){$.vexPage>1&&($.vexPage--,rn())})),n&&!n._vexBound&&(n._vexBound=!0,n.addEventListener("click",function(){var a=Math.ceil($.vexAllRows.length/pt);$.vexPage<a&&($.vexPage++,rn())}))}async function jl(e){const n=t("vex-task-delete-confirm-title")||"删除对账任务?",a=t("vex-task-delete-confirm-body")||"同时清掉对应的发票识别缓存 · 不可恢复";if(await showConfirm(a,{title:n,danger:!0,okText:t("vex-task-delete-confirm-title")||"确认删除"}))try{const s=await fetch("/api/vat_excel/tasks/"+encodeURIComponent(e),{method:"DELETE",credentials:"include",headers:nt()});if(!s.ok)throw new Error(s.status);showToast(t("vex-task-delete-ok")||"已删除","success"),Qt(),Zt()}catch{showToast(t("vex-task-delete-fail")||"删除失败","error")}}function ts(e){const n=window._currentLang||"th",a={zh:`已忽略 ${e} 个不支持的文件 · 仅支持 PDF / 图片 / Excel / CSV / Word`,th:`ข้ามไฟล์ที่ไม่รองรับ ${e} ไฟล์ · รองรับเฉพาะ PDF / รูปภาพ / Excel / CSV / Word`,en:`Ignored ${e} unsupported file(s) · only PDF / image / Excel / CSV / Word are supported`,ja:`非対応ファイル ${e} 件をスキップ · 対応形式は PDF / 画像 / Excel / CSV / Word のみ`};showToast(a[n]||a.th,"warn")}function Pl(e){const n=new Set($.invoiceFiles.map(o=>o.name+"|"+o.size));let a=0;for(const o of e){if(!ya.test(o.name)){a++;continue}const s=o.name+"|"+o.size;if(!n.has(s)&&(n.add(s),$.invoiceFiles.push(o),$.invoiceFiles.length>=Sn))break}a>0&&ts(a),$.invoiceFiles.length>Sn&&($.invoiceFiles=$.invoiceFiles.slice(0,Sn),showToast(t("vex-toast-cap-inv"),"warn")),Oe()}function Dl(e){const n=new Set($.reportFiles.map(o=>o.name+"|"+o.size));let a=0;for(const o of e){if(!ya.test(o.name)){a++;continue}const s=o.name+"|"+o.size;if(!n.has(s)&&(n.add(s),$.reportFiles.push(o),$.reportFiles.length>=Tn))break}a>0&&ts(a),$.reportFiles.length>Tn&&($.reportFiles=$.reportFiles.slice(0,Tn),showToast(t("vex-toast-cap-rep"),"warn")),Oe()}function ns(e){$.invoiceFiles.splice(e,1),Oe()}function as(e){$.reportFiles.splice(e,1),Oe()}function Oe(){const e=Y("vex-list-invoice"),n=Y("vex-list-report"),a=Y("vex-count-invoice"),o=Y("vex-count-report");a&&(a.textContent=$.invoiceFiles.length),o&&(o.textContent=$.reportFiles.length);const s=(c,m,d)=>`<div class="vex-fi">
        ...
        <span class="vex-fi-s">${Qo(c.size)}</span>
        <button class="vex-fi-x" type="button" data-vex-kind="${d}" data-vex-idx="${m}" aria-label="remove">×</button>
    </div>`;e&&(e.innerHTML=$.invoiceFiles.map((c,m)=>s(c,m,"inv")).join("")||'<div class="vex-fi-empty" data-i18n="vex-no-files">还没文件</div>'),n&&(n.innerHTML=$.reportFiles.map((c,m)=>s(c,m,"rep")).join("")||'<div class="vex-fi-empty" data-i18n="vex-no-files">还没文件</div>'),document.querySelectorAll(".vex-fi-x").forEach(c=>{c.addEventListener("click",m=>{const d=c.dataset.vexKind,p=parseInt(c.dataset.vexIdx,10);d==="inv"?ns(p):as(p)})});const i=$.invoiceFiles.length>0&&$.reportFiles.length>0;Y("vex-build").disabled=!i||$.running;const r=Y("vex-action-info");r&&(!$.invoiceFiles.length||!$.reportFiles.length?(r.textContent=t("vex-need-both")||"需要至少 1 张发票 + 1 份 VAT 报告",r.className="vex-action-info muted"):(r.textContent=(t("vex-ready")||"已就绪 · {a} 张发票 · {b} 份报告").replace("{a}",$.invoiceFiles.length).replace("{b}",$.reportFiles.length),r.className="vex-action-info ok")),Nn()}const Fl='<svg class="vex-pp-fi-icon" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#6B7280" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path><polyline points="14 2 14 8 20 8"></polyline></svg>',Rl='<svg class="vex-pp-fi-icon" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#111111" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="4" width="18" height="18" rx="2" ry="2"></rect><line x1="16" y1="2" x2="16" y2="6"></line><line x1="8" y1="2" x2="8" y2="6"></line><line x1="3" y1="10" x2="21" y2="10"></line></svg>',ql='<svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg>';function Nn(){const e=Y("vex-preview-panel");if(!e||e.style.display==="none")return;eo("inv"),eo("rep");const n=Y("vex-pp-guide");n&&(n.style.display=$.invoiceFiles.length>100?"flex":"none")}function eo(e){const n=Y(e==="inv"?"vex-pp-invoice-col":"vex-pp-report-col");if(!n)return;const a=e==="inv"?$.invoiceFiles:$.reportFiles,o=e==="inv"?$.previewSearchInv:$.previewSearchRep,s=t(e==="inv"?"vex-preview-invoice":"vex-preview-report")||(e==="inv"?"销售发票":"VAT 报告"),i=he(t("vex-preview-search")||"搜索文件名..."),r=he(t("vex-preview-clear-all")||"全清");n.innerHTML=`
        ...
        <div class="vex-pp-pagination" id="vex-pp-${e}-pg"></div>`;const c=Y("vex-pp-search-"+e);c&&c.addEventListener("input",d=>{e==="inv"?($.previewSearchInv=d.target.value,$.previewLimitInv=50):($.previewSearchRep=d.target.value,$.previewLimitRep=50),On(e)});const m=Y("vex-pp-clearall-"+e);m&&m.addEventListener("click",()=>{e==="inv"?($.invoiceFiles=[],$.previewSearchInv="",$.previewLimitInv=50):($.reportFiles=[],$.previewSearchRep="",$.previewLimitRep=50),Oe()}),On(e)}function On(e){const n=Y("vex-pp-"+e+"-list"),a=Y("vex-pp-"+e+"-pg");if(!n)return;const o=e==="inv"?$.invoiceFiles:$.reportFiles,s=e==="inv"?$.previewSearchInv:$.previewSearchRep,i=e==="inv"?$.previewLimitInv:$.previewLimitRep,r=e==="inv"?Fl:Rl,c=o.map((p,l)=>({f:p,i:l})),m=s?c.filter(({f:p})=>p.name.toLowerCase().includes(s.toLowerCase())):c,d=m.slice(0,i);if(n.innerHTML=d.map(({f:p,i:l})=>`
        <div class="vex-pp-file-row">
            ${r}
            <span class="vex-pp-fi-name" title="${he(p.name)}">${he(p.name)}</span>
            <span class="vex-pp-fi-size">${Qo(p.size)}</span>
            <button class="vex-pp-fi-del" type="button" data-kind="${e}" data-ridx="${l}" aria-label="remove">${ql}</button>
        </div>`).join("")+`<div id="vex-pp-sentinel-${e}" style="height:1px;flex-shrink:0"></div>`,n.querySelectorAll(".vex-pp-fi-del").forEach(p=>{p.addEventListener("click",()=>{const l=parseInt(p.dataset.ridx,10);p.dataset.kind==="inv"?ns(l):as(l)})}),a){const p=t("vex-preview-count")||"显示前 {n} / 共 {m}";a.textContent=p.replace("{n}",d.length).replace("{m}",m.length)}zl(e,m.length)}function zl(e,n){if((e==="inv"?$.previewLimitInv:$.previewLimitRep)>=n)return;const o=Y("vex-pp-sentinel-"+e),s=Y("vex-pp-"+e+"-list");if(!o||!s)return;const i=new IntersectionObserver(r=>{r[0].isIntersecting&&(i.disconnect(),e==="inv"?$.previewLimitInv+=50:$.previewLimitRep+=50,On(e))},{root:s,threshold:.8});i.observe(o)}function to(e,n,a,o){const s=Y(e),i=Y(n);!s||!i||(s.addEventListener("click",()=>i.click()),s.addEventListener("keydown",r=>{(r.key==="Enter"||r.key===" ")&&(r.preventDefault(),i.click())}),s.addEventListener("dragover",r=>{r.preventDefault(),s.classList.add("drag-over")}),s.addEventListener("dragleave",()=>s.classList.remove("drag-over")),s.addEventListener("drop",r=>{r.preventDefault(),s.classList.remove("drag-over");const m=Array.from(r.dataTransfer.files).filter(d=>ya.test(d.name));if(!m.length){showToast(t("vex-toast-bad-ext"),"error");return}a(m)}),i.addEventListener("change",()=>{const r=Array.from(i.files);a(r),i.value=""}))}(function(){async function e(){if($.running||!$.invoiceFiles.length||!$.reportFiles.length)return;$.running=!0,Y("vex-build").disabled=!0,Y("vex-progress").style.display="flex";var r=document.getElementById("vex-download");r&&(r.style.display="none"),["vex-summary-collapse","vex-detail-collapse"].forEach(function(p){var l=document.getElementById(p);l&&(l.style.display="none")});const c=Date.now();Y("vex-progress-title").textContent=t("vex-progress-running")||"AI 抽取中",Y("vex-progress-sub").textContent=(t("vex-progress-sub")||"{a} 张发票 + {b} 份报告 · 并行处理").replace("{a}",$.invoiceFiles.length).replace("{b}",$.reportFiles.length);const m=setInterval(()=>{const p=Math.floor((Date.now()-c)/1e3);Y("vex-progress-sub").textContent=(t("vex-progress-elapsed")||"已 {s} 秒 · {a} 张发票 + {b} 份报告").replace("{s}",p).replace("{a}",$.invoiceFiles.length).replace("{b}",$.reportFiles.length)},1e3);try{const p=new FormData;for(const L of $.invoiceFiles)p.append("invoices",L);for(const L of $.reportFiles)p.append("reports",L);const l=typeof currentLang=="string"&&currentLang||localStorage.getItem("mrpilot_lang")||"th";p.append("lang",l);const u=localStorage.getItem("mrpilot_token")||"",f=await fetch("/api/vat_excel/submit",{method:"POST",headers:nt(),body:p});let v=null;try{v=await f.json()}catch{v=null}if(!f.ok||!v||!v.ok||!v.job_id)throw clearInterval(m),new Error(v&&v.detail||"HTTP "+f.status);const w=Y("vex-progress-sub"),g=await window._reconPollJob(v.job_id,u,{onProgress:L=>{w&&(w.textContent=window._reconProgressText(L,l))}});if(clearInterval(m),!g||g.status!=="done"||!g.result_id)throw new Error(t("vex-toast-fail")||"生成失败");const b=g.result_id;let h=0;const _=await fetch("/api/vat_excel/tasks/"+encodeURIComponent(b)+"/download",{headers:nt()});if(!_.ok)throw new Error("HTTP "+_.status);const k=(_.headers.get("Content-Disposition")||"").match(/filename="([^"]+)"/),x=k&&k[1]||"vat_recon_"+Date.now()+".xlsx",E=await _.blob(),B=URL.createObjectURL(E),I=Y("vex-download");I.href=B,I.download=x;try{const L=document.createElement("a");L.href=B,L.download=x,document.body.appendChild(L),L.click(),setTimeout(()=>L.remove(),100)}catch{}Y("vex-progress").style.display="none";var d=document.getElementById("vex-download");d&&(d.style.display=""),b&&(h=await o(b)),window._onVexResultShown&&window._onVexResultShown(),h>0?showToast((t("vex-toast-some-fail")||"有 {n} 张发票 OCR 失败").replace("{n}",h),"warn"):showToast(t("vex-toast-done")||"Excel 已生成","success"),Zt(),setTimeout(Qt,800)}catch(p){clearInterval(m),Y("vex-progress").style.display="none";const l=(t("vex-toast-fail")||"生成失败")+": "+(p.message||p);showToast(l,"error")}finally{$.running=!1,Y("vex-build").disabled=!1}}function n(){$.invoiceFiles=[],$.reportFiles=[];var r=document.getElementById("vex-download");r&&(r.style.display="none"),Oe()}function a(r){if(r==null)return"—";var c=parseFloat(r);return isNaN(c)?"—":c.toLocaleString("th-TH",{minimumFractionDigits:2,maximumFractionDigits:2})}async function o(r){try{var c=await fetch("/api/vat_excel/tasks/"+encodeURIComponent(r),{headers:nt()});if(!c.ok)throw new Error(c.status);var m=await c.json(),d=m.raw_data_json;if(typeof d=="string")try{d=JSON.parse(d)}catch{d={}}d=d||{};var p=d.rows||[],l=[];p.forEach(function(v){v.kind==="invoice_orphan"?l.push({invoice_no:v.invoice_no||"",field:"仅发票有",report_value:"—",invoice_value:a(v.amount_inv),kind:v.kind}):v.kind==="report_orphan"?l.push({invoice_no:v.invoice_no||"",field:"仅报告有",report_value:a(v.amount_rep),invoice_value:"—",kind:v.kind}):v.dims&&Object.keys(v.dims).length>0&&Object.keys(v.dims).forEach(function(w){var g=String(v.dims[w]||""),b=g.split(" ≠ ");l.push({invoice_no:v.invoice_no||"",field:w,report_value:b[0]||g,invoice_value:b.length>1?b[1]:"—",kind:"diff"})})});var u=p.filter(function(v){return v.kind==="matched_cash"}).length,f=Math.max(0,parseInt(d.invoice_ocr_failed_count||0,10));return window._vexLastTask={total:d.n_total||0,matched:d.n_ok||0,diff:d.n_diff||0,incomplete:f,cash:u,diff_rows:l,task_id:r},window._fillVexSummary&&window._fillVexSummary(),window._fillVexDetail&&window._fillVexDetail(),f}catch{return 0}}function s(){const r=document.getElementById("vex-pane");r&&r.querySelectorAll("[data-i18n]").forEach(c=>{const m=t(c.dataset.i18n);m&&(c.textContent=m)}),Oe(),Qt()}function i(){to("vex-drop-invoice","vex-input-invoice",Pl),to("vex-drop-report","vex-input-report",Dl);const r=Y("vex-build"),c=Y("vex-reset");r&&r.addEventListener("click",e),c&&c.addEventListener("click",n),document.querySelectorAll('[data-recon-tab="sale-vat"]').forEach(p=>{p.addEventListener("click",()=>{Zt(),Qt()})}),Al();const m=document.getElementById("vex-task-search");m&&m.addEventListener("input",es);const d=document.getElementById("vex-toggle-preview");d&&d.addEventListener("click",()=>{const p=Y("vex-preview-panel"),l=Y("vex-toggle-preview-label"),u=p&&p.style.display!=="none";p&&(p.style.display=u?"none":""),d&&d.classList.toggle("open",!u),l&&(l.textContent=u?t("vex-toggle-preview-open")||"查看清单":t("vex-toggle-preview-close")||"收起清单"),u||Nn()}),Oe(),Zt()}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",i):i(),typeof window.subscribeI18n=="function"&&(window.subscribeI18n("vex-excel",s),window.subscribeI18n("vex-preview-panel",Nn))})();const G={inited:!1,glFile:[],vatFile:[],running:!1,currentTaskId:null,lastDetail:[],lastSummary:null},V=e=>document.getElementById(e),os=()=>localStorage.getItem("mrpilot_token")||"",yt=()=>typeof window.currentLang=="string"&&window.currentLang?window.currentLang:localStorage.getItem("mrpilot_lang")||"th",at=()=>({Authorization:"Bearer "+os()}),no={th:{not_found:"ไม่พบข้อมูล",running:"กำลังกระทบยอด…",error:"เกิดข้อผิดพลาด",need_files:"กรุณาเลือกไฟล์ทั้งสอง",done:"เสร็จสิ้น",hint_need_both:"อัปโหลด ① รายงานภาษีขาย + ② GL",hint_need_one_more:"อัปโหลดอีก 1 ไฟล์",hint_ready:"พร้อมแล้ว · กดเริ่มกระทบยอด",hist_load:"โหลด",hist_export:"ส่งออก",hist_delete:"ลบ",confirm_delete:"ยืนยันการลบงานนี้?",s_gl_total:"ยอดรวมตามบัญชีแยกประเภท",s_minus_gl_cr:"หัก : รายการเครดิตที่ไม่มีในรายงานภาษีขาย",s_plus_gl_dr:"บวก : รายการเดบิตที่ไม่มีในรายงานภาษีขาย",s_plus_vat_p:"บวก : รายการยอดขายที่ไม่มีในบัญชีแยกประเภท",s_minus_vat_n:"หัก : รายการลดหนี้ที่ไม่มีในบัญชีแยกประเภท",s_vat_total:"ยอดรวมตามรายงานภาษีขาย"},zh:{not_found:"未找到数据",running:"正在对账中...",error:"出错了",need_files:"请先选择两个文件",done:"完成",hint_need_both:"请上传① 销项税报告 + ② 总账 GL",hint_need_one_more:"还需上传 1 份文件",hint_ready:"已就绪 · 点击开始对账",hist_load:"加载",hist_export:"导出",hist_delete:"删除",confirm_delete:"确认删除此任务？",s_gl_total:"总账金额合计",s_minus_gl_cr:"减：销项税报告中未列的贷方记录",s_plus_gl_dr:"加：销项税报告中未列的借方记录",s_plus_vat_p:"加：总账中未列的销售记录",s_minus_vat_n:"减：总账中未列的贷项凭单(credit note)记录",s_vat_total:"销项税报告金额合计"},en:{not_found:"Not found",running:"Reconciling...",error:"Error",need_files:"Please select both files",done:"Done",hint_need_both:"Upload ① Output VAT report + ② GL file",hint_need_one_more:"1 more file required",hint_ready:"Ready · click Run to start",hist_load:"Load",hist_export:"Export",hist_delete:"Delete",confirm_delete:"Delete this task?",s_gl_total:"Total per General Ledger",s_minus_gl_cr:"Less: GL credits not in VAT Report",s_plus_gl_dr:"Add: GL debits not in VAT Report",s_plus_vat_p:"Add: Sales in VAT Report not in GL",s_minus_vat_n:"Less: Credit notes in VAT Report not in GL",s_vat_total:"Total per VAT Sales Report"},ja:{not_found:"データなし",running:"照合中…",error:"エラー",need_files:"両方のファイルを選択してください",done:"完了",hint_need_both:"① 売上税報告 + ② GL をアップロード",hint_need_one_more:"あと 1 ファイル必要",hint_ready:"準備完了 · 「開始」をクリック",hist_load:"読込",hist_export:"出力",hist_delete:"削除",confirm_delete:"このタスクを削除しますか?",s_gl_total:"総勘定元帳合計",s_minus_gl_cr:"減：売上税報告にないGL貸方記録",s_plus_gl_dr:"加：売上税報告にないGL借方記録",s_plus_vat_p:"加：GLにない売上記録",s_minus_vat_n:"減：GLにない赤伝記録",s_vat_total:"売上税報告合計"}},Q=e=>(no[yt()]||no.th)[e]||e;function Nl(e){const n=yt(),o={gl_no_revenue_rows:{zh:"GL 中未找到收入科目行。请确认「收入科目前缀」是否正确(收入科目通常以 4 开头),改对后重试。",th:"ไม่พบรายการบัญชีรายได้ใน GL · ตรวจสอบ «คำนำหน้าบัญชีรายได้» (รายได้มักขึ้นต้นด้วย 4) แล้วลองใหม่",en:"No revenue-account rows found in the GL. Check the “revenue account prefix” (revenue usually starts with 4) and retry.",ja:"GL に収益科目の行が見つかりません。「収益科目プレフィックス」(通常 4 で始まる)を確認して再試行してください。"},gl_parse_failed:{zh:"GL 文件解析失败。请确认文件含日期/科目/借贷列,或换清晰的 Excel/CSV 重传。",th:"อ่านไฟล์ GL ไม่สำเร็จ · ตรวจสอบว่ามีคอลัมน์ วันที่/บัญชี/เดบิต-เครดิต หรืออัปโหลด Excel/CSV ที่ชัดเจน",en:"Failed to parse the GL file. Ensure it has date/account/debit-credit columns, or re-upload a clean Excel/CSV.",ja:"GL ファイルの解析に失敗しました。日付/科目/借方貸方列を確認するか、Excel/CSV を再アップロードしてください。"},vat_no_rows:{zh:"销项税报告里没有可对账的数据行。请确认上传了正确的销项税报告。",th:"ไม่พบแถวข้อมูลในรายงานภาษีขาย · ตรวจสอบว่าอัปโหลดรายงานที่ถูกต้อง",en:"No rows found in the sales-VAT report. Please check you uploaded the correct report.",ja:"売上VATレポートに行が見つかりません。正しいレポートをアップロードしたか確認してください。"},vat_parse_failed:{zh:"销项税报告解析失败。请换更清晰的版本,或转成 Excel/PDF 重传。",th:"อ่านรายงานภาษีขายไม่สำเร็จ · ลองเวอร์ชันที่ชัดเจนกว่า หรือแปลงเป็น Excel/PDF",en:"Failed to parse the sales-VAT report. Try a clearer version, or convert to Excel/PDF.",ja:"売上VATレポートの解析に失敗しました。より鮮明な版か、Excel/PDF に変換してください。"}}[e];return o?o[n]||o.th||o.en:Q("error")||"Error"}const jt=e=>e==null||isNaN(e)?"":Number(e).toLocaleString("en-US",{minimumFractionDigits:2,maximumFractionDigits:2});function wa(e){V("glv-kpi-matched")&&(V("glv-kpi-matched").textContent=e&&e.matched!=null?e.matched:"—"),V("glv-kpi-diff")&&(V("glv-kpi-diff").textContent=e&&e.diff!=null?e.diff:"—"),V("glv-kpi-unmatched")&&(V("glv-kpi-unmatched").textContent=e&&e.unmatched!=null?e.unmatched:"—")}function Ol(e){if(!e)return"";try{const n=new Date(e);if(isNaN(n.getTime()))return e;const a=o=>String(o).padStart(2,"0");return n.getFullYear()+"-"+a(n.getMonth()+1)+"-"+a(n.getDate())+" "+a(n.getHours())+":"+a(n.getMinutes())}catch{return e}}function ao(e,n,a,o){const s=V(e),i=V(n),r=V(a);if(!s||!i||!r)return;const c=m=>{if(!m||!m.length)return;const d=Array.isArray(G[o])?G[o].slice():[],p=new Set(d.map(l=>l.name+"|"+l.size));for(const l of m){if(!l)continue;const u=l.name+"|"+l.size;p.has(u)||(d.push(l),p.add(u))}G[o]=d,ss(r,d),qt(),Nt(),window._reconCollapse&&window._reconCollapse.renderGlvPreview&&window._reconCollapse.renderGlvPreview()};s.addEventListener("click",()=>i.click()),s.addEventListener("keydown",m=>{(m.key==="Enter"||m.key===" ")&&(m.preventDefault(),i.click())}),i.addEventListener("change",()=>{c(Array.from(i.files||[])),i.value=""}),s.addEventListener("dragover",m=>{m.preventDefault(),s.classList.add("drag-over")}),s.addEventListener("dragleave",()=>s.classList.remove("drag-over")),s.addEventListener("drop",m=>{m.preventDefault(),s.classList.remove("drag-over");const d=m.dataTransfer&&m.dataTransfer.files?Array.from(m.dataTransfer.files):[];c(d)})}function ss(e,n){if(!e)return;if(!n||n.length===0){e.textContent="";return}const a=n.reduce((o,s)=>o+Math.round(s.size/1024),0);if(n.length===1)e.textContent=n[0].name+"  ("+a+" KB)";else{const o=window.t&&window.t("glv-files-count")||"{n} 个文件";e.textContent=o.replace("{n}",n.length)+"  ("+a+" KB)"}}function ze(e){const n=G[e];return Array.isArray(n)?n:n?[n]:[]}function qt(){const e=V("btn-glv-run");if(!e)return;const n=ze("glFile").length>0&&ze("vatFile").length>0;e.disabled=!n||G.running}function Nt(){const e=V("glv-status");if(!e||G.running)return;const n=ze("vatFile").length,a=ze("glFile").length;n===0&&a===0?(e.className="vex-action-info muted",e.innerHTML="<span>"+Q("hint_need_both")+"</span>"):n>0&&a>0?(e.className="vex-action-info ok",e.innerHTML="<span>"+Q("hint_ready")+"</span>"):(e.className="vex-action-info muted",e.innerHTML="<span>"+Q("hint_need_one_more")+"</span>")}function Vl(e,n){const a=e==="vat"?"vatFile":"glFile",o=e==="vat"?"glv-vat-input":"glv-gl-input",s=e==="vat"?"glv-vat-name":"glv-gl-name",i=ze(a);n==null?G[a]=[]:G[a]=i.filter((c,m)=>m!==n);const r=V(o);r&&(r.value=""),ss(V(s),ze(a)),qt(),Nt(),window._reconCollapse&&window._reconCollapse.renderGlvPreview&&window._reconCollapse.renderGlvPreview()}function Ul(){G.glFile=[],G.vatFile=[],G.currentTaskId=null,G.lastDetail=[],G.lastSummary=null;const e=V("glv-vat-input");e&&(e.value="");const n=V("glv-gl-input");n&&(n.value="");const a=V("glv-vat-name");a&&(a.textContent="");const o=V("glv-gl-name");o&&(o.textContent="");const s=V("glv-result");s&&(s.style.display="none");const i=V("glv-kpi-strip");i&&(i.style.display="none"),qt(),Nt(),window._glvClearPreviewSearch&&window._glvClearPreviewSearch(),window._reconCollapse&&window._reconCollapse.renderGlvPreview&&window._reconCollapse.renderGlvPreview()}function ka(e){const n=V("glv-tbody");if(!n)return;Jl(e.length),n.innerHTML="";const a=Q("not_found"),o=document.createDocumentFragment();e.forEach(s=>{const i=document.createElement("tr"),r=(l,u)=>{const f=document.createElement("td");return u&&(f.className=u),f.textContent=l,f},c=s.gl_amount===null||s.gl_amount===void 0,m=s.diff;let d="glv-num",p="glv-num";c?(p+=" glv-cell-missing",d+=" glv-cell-missing"):Math.abs(m||0)<.005?d+=" glv-cell-ok":d+=" glv-cell-diff",i.appendChild(r(s.doc_no||"","glv-doc")),i.appendChild(r(s.date||"","")),i.appendChild(r(s.customer_name||"","")),i.appendChild(r(jt(s.vat_amount),"glv-num")),i.appendChild(r(c?a:jt(s.gl_amount),p)),i.appendChild(r(c?a:jt(s.diff),d)),i.appendChild(r(s.account_codes||"","glv-doc")),o.appendChild(i)}),n.appendChild(o)}function xa(e){const n=V("glv-summary-table")&&V("glv-summary-table").querySelector("tbody");if(!n)return;n.innerHTML="",[{label:Q("s_gl_total"),amount:e.gl_total,emph:!0,items:[],negate:!1},{label:Q("s_minus_gl_cr"),amount:-(e.gl_only_credit||0),emph:!1,items:e.gl_only_credit_items||[],negate:!0},{label:Q("s_plus_gl_dr"),amount:e.gl_only_debit||0,emph:!1,items:e.gl_only_debit_items||[],negate:!1},{label:Q("s_plus_vat_p"),amount:e.vat_only_positive||0,emph:!1,items:e.vat_only_positive_items||[],negate:!1},{label:Q("s_minus_vat_n"),amount:e.vat_only_negative||0,emph:!1,items:e.vat_only_negative_items||[],negate:!1},{label:Q("s_vat_total"),amount:e.vat_total,emph:!0,items:[],negate:!1}].forEach(({label:o,amount:s,emph:i,items:r,negate:c})=>{const m=document.createElement("tr");m.className=i?"glv-summary-total":"glv-summary-sect";const d=document.createElement("td"),p=document.createElement("td");d.textContent=o,p.textContent=i?jt(s):"",m.appendChild(d),m.appendChild(p),n.appendChild(m),(r||[]).forEach(l=>{const u=document.createElement("tr");u.className="glv-summary-item";const f=document.createElement("td"),v=document.createElement("td"),w=[l.doc_no,l.date,l.name].filter(Boolean);f.textContent="· "+w.join("  ·  ");const g=c?-(l.amount||0):l.amount||0;v.textContent=jt(g),u.appendChild(f),u.appendChild(v),n.appendChild(u)})})}async function Gl(e){try{const a=await(await fetch("/api/recon/gl-vat/"+e,{headers:at()})).json();if(!a||!a.ok)throw new Error("load_failed");G.currentTaskId=e,G.lastDetail=a.detail||[],G.lastSummary=a.summary||{},wa(a.stats||{}),ka(G.lastDetail),xa(G.lastSummary);const o=V("glv-result");o&&(o.style.display=""),is(),window.scrollTo({top:o?o.offsetTop-80:0,behavior:"smooth"})}catch(n){console.error("[gl-vat] load task failed:",n),alert(Q("error")+": "+(n.message||n))}}function is(){var e=V("glv-kpi-strip");e&&(e.style.display="");var n=V("glv-section-summary");n&&n.setAttribute("data-collapsed","false");var a=V("glv-section-detail");a&&a.setAttribute("data-collapsed","false")}function Kl(){document.querySelectorAll(".glv-section-head[data-toggle]").forEach(e=>{const n=e.getAttribute("data-toggle"),a=document.getElementById(n);if(!a)return;const o=s=>{if(s.target&&s.target.closest("button")!==null&&!s.target.classList.contains("glv-section-head"))return;const i=a.getAttribute("data-collapsed")==="true";a.setAttribute("data-collapsed",i?"false":"true")};e.addEventListener("click",o),e.addEventListener("keydown",s=>{(s.key==="Enter"||s.key===" ")&&(s.preventDefault(),o(s))})})}function Jl(e){const n=V("glv-detail-count");n&&(n.textContent=e!=null?String(e):"")}const Ct=10;var lt=[],we=1;function Wl(){we=1,ln();var e=((V("glv-hist-search")||{}).value||"").trim().toLowerCase();if(e){var n=V("glv-history-tbody");n&&n.querySelectorAll("tr").forEach(function(a){a.dataset.taskId&&(a.style.display=a.textContent.toLowerCase().indexOf(e)>=0?"":"none")})}}function ln(){const e=V("glv-history-table-wrap"),n=V("glv-history-empty"),a=V("glv-history-tbody"),o=V("glv-history-pager"),s=V("glv-history-pager-info"),i=V("glv-history-prev"),r=V("glv-history-next");if(!a)return;if(a.innerHTML="",!lt.length){e&&(e.style.display="none"),n&&(n.style.display=""),o&&(o.style.display="none");return}e&&(e.style.display=""),n&&(n.style.display="none");const c=Math.ceil(lt.length/Ct);we>c&&(we=c);const m=(we-1)*Ct,d=lt.slice(m,m+Ct);o&&(o.style.display=lt.length>Ct?"":"none",s&&(s.textContent=we+" / "+c),i&&(i.disabled=we<=1),r&&(r.disabled=we>=c)),d.forEach(l=>{const u=document.createElement("tr");u.dataset.taskId=l.id;const f=document.createElement("td");f.textContent=Ol(l.created_at);const v=document.createElement("td");v.className="glv-history-file",v.title=(l.vat_filename||"")+" + "+(l.gl_filename||""),v.textContent=(l.vat_filename||"?")+" + "+(l.gl_filename||"?");const w=document.createElement("td");w.className="glv-num",w.textContent=(l.vat_row_count||0)+" / "+(l.gl_row_count||0);const g=document.createElement("td");g.className="glv-num",g.textContent=l.matched_count||0;const b=document.createElement("td");b.className="glv-num",b.textContent=l.diff_count||0;const h=document.createElement("td");h.className="glv-num",h.textContent=l.unmatched_count||0;const _=document.createElement("td");_.className="glv-history-actions";const y=(B,I,L,C)=>{const S=document.createElement("button");return S.type="button",L&&(S.className=L),S.title=I,S.setAttribute("aria-label",I),S.innerHTML=B,S.onclick=C,S},k='<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" width="14" height="14"><path d="M2 8a6 6 0 1 0 12 0A6 6 0 0 0 2 8z"/><polyline points="6 8 8 10 10 8"/><line x1="8" y1="4" x2="8" y2="10"/></svg>',x='<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" width="14" height="14"><path d="M8 2v9M4 7l4 4 4-4M3 14h10"/></svg>',E='<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" width="14" height="14"><polyline points="3 4 13 4"/><path d="M6 4V2.5a.5.5 0 0 1 .5-.5h3a.5.5 0 0 1 .5.5V4"/><path d="M5 4l1 9a1 1 0 0 0 1 1h2a1 1 0 0 0 1-1l1-9"/></svg>';_.appendChild(y(k,Q("hist_load"),"",()=>Gl(l.id))),_.appendChild(y(x,Q("hist_export"),"",()=>Xl(l.id))),_.appendChild(y(E,Q("hist_delete"),"glv-del",()=>Zl(l.id))),[f,v,w,g,b,h,_].forEach(B=>u.appendChild(B)),a.appendChild(u)})}function Yl(){var e=V("glv-history-prev"),n=V("glv-history-next");e&&!e._glvBound&&(e._glvBound=!0,e.addEventListener("click",function(){we>1&&(we--,ln())})),n&&!n._glvBound&&(n._glvBound=!0,n.addEventListener("click",function(){var a=Math.ceil(lt.length/Ct);we<a&&(we++,ln())}))}async function ut(){try{const n=await(await fetch("/api/recon/gl-vat/tasks",{headers:at()})).json();lt=n&&n.tasks||[],we=1,ln(),Yl()}catch(e){console.error("[gl-vat] history load failed:",e)}}async function Xl(e){try{const n="/api/recon/gl-vat/"+e+"/export?lang="+encodeURIComponent(yt()),a=await fetch(n,{headers:at()});if(!a.ok)throw new Error("HTTP "+a.status);const o=await a.blob(),s=document.createElement("a");s.href=URL.createObjectURL(o),s.download="GL_VAT_recon_"+e+".xlsx",document.body.appendChild(s),s.click(),setTimeout(()=>{URL.revokeObjectURL(s.href),s.remove()},200)}catch(n){console.error("[gl-vat] exportTask failed:",n),typeof showToast=="function"&&showToast(Q("error")+": "+(n.message||n),"error")}}async function Zl(e){let n;if(typeof window.showConfirm=="function"?n=await window.showConfirm(Q("confirm_delete"),{danger:!0}):n=confirm(Q("confirm_delete")),!!n)try{const a=await fetch("/api/recon/gl-vat/"+e,{method:"DELETE",headers:at()});if(!a.ok)throw new Error("HTTP "+a.status);ut()}catch(a){console.error("[gl-vat] delete failed:",a),typeof showToast=="function"&&showToast(Q("error")+": "+(a.message||a),"error")}}async function Ql(){if(!G.glFile||!G.vatFile){typeof showToast=="function"&&showToast(Q("need_files"),"warn");return}G.running=!0,qt();const e=V("glv-status"),n=V("glv-progress"),a=V("glv-progress-sub");e&&(e.className="vex-action-info muted",e.style.color="",e.innerHTML="<span>"+Q("running")+"</span>"),n&&(n.style.display=""),a&&(a.textContent=(G.vatFile.name||"VAT")+" + "+(G.glFile.name||"GL"));const o=new FormData,s=ze("vatFile"),i=ze("glFile");for(const c of s)o.append("vat_files",c,c.name);for(const c of i)o.append("gl_files",c,c.name);const r=(V("glv-prefix")&&V("glv-prefix").value||"4").trim()||"4";o.append("revenue_prefix",r),o.append("lang",yt());try{const c=await fetch("/api/recon/gl-vat/submit",{method:"POST",headers:at(),body:o});let m=null;try{m=await c.json()}catch{m=null}if(!c.ok||!m||!m.ok||!m.job_id)throw new Error(m&&m.detail||m&&m.error||"HTTP "+c.status);const d=V("glv-progress-sub"),p=await window._reconPollJob(m.job_id,os(),{onProgress:v=>{d&&(d.textContent=window._reconProgressText(v,yt()))}});if(!p||p.status!=="done"||!p.result_id)throw p&&p.status==="failed"&&p.error_code?new Error(Nl(p.error_code)):new Error(Q("error")||"Error");const l=await fetch("/api/recon/gl-vat/"+encodeURIComponent(p.result_id),{headers:at()});let u=null;try{u=await l.json()}catch{u=null}if(!l.ok||!u||!u.ok)throw new Error(u&&u.detail||u&&u.error||"HTTP "+l.status);G.currentTaskId=u.task_id,G.lastDetail=u.detail||[],G.lastSummary=u.summary||{},wa(u.stats||{}),ka(G.lastDetail),xa(G.lastSummary);const f=V("glv-result");f&&(f.style.display=""),is(),e&&(e.className="vex-action-info ok",e.style.color="",e.innerHTML="<span>"+Q("done")+" · GL "+(u.gl_row_count||0)+" · VAT "+(u.vat_row_count||0)+"</span>"),ut()}catch(c){console.error("[gl-vat] run failed:",c),e&&(e.className="vex-action-info",e.style.color="#ef4444",e.innerHTML="<span>"+Q("error")+": "+(c.message||c)+"</span>")}finally{G.running=!1,n&&(n.style.display="none"),qt()}}async function ec(){if(G.currentTaskId)try{const e="/api/recon/gl-vat/"+G.currentTaskId+"/export?lang="+encodeURIComponent(yt()),n=await fetch(e,{headers:at()});if(!n.ok)throw new Error("HTTP "+n.status);const a=await n.blob(),o=document.createElement("a");o.href=URL.createObjectURL(a),o.download="GL_VAT_recon_"+G.currentTaskId+".xlsx",document.body.appendChild(o),o.click(),setTimeout(()=>{URL.revokeObjectURL(o.href),o.remove()},200)}catch(e){console.error("[gl-vat] export failed:",e),typeof showToast=="function"&&showToast(Q("error")+": "+(e.message||e),"error")}}function tc(){G.running||Nt(),ut(),G.lastDetail&&G.lastDetail.length&&ka(G.lastDetail),G.lastSummary&&xa(G.lastSummary)}function nc(){if(G.inited){ut();return}G.inited=!0,ao("glv-drop-gl","glv-gl-input","glv-gl-name","glFile"),ao("glv-drop-vat","glv-vat-input","glv-vat-name","vatFile");const e=V("btn-glv-run");e&&e.addEventListener("click",Ql);const n=V("btn-glv-export");n&&n.addEventListener("click",ec);const a=V("btn-glv-reset");a&&a.addEventListener("click",Ul);const o=V("glv-hist-search");o&&o.addEventListener("input",Wl),Kl(),wa(null),Nt(),window._loadGlvHistory=ut,ut(),typeof window.subscribeI18n=="function"&&window.subscribeI18n("gl-vat-recon",tc)}window._glvRemoveFile=Vl;window.GlVatRecon={ensureInit:nc};window._glvPreviewFiles=function(e){return ze(e==="vat"?"vatFile":"glFile")};const ac=["flowaccount","peak","xero","quickbooks","express"],rs={flowaccount:"FlowAccount",peak:"PEAK",xero:"Xero",quickbooks:"QuickBooks",express:"Express"},oc=["expense_office","expense_travel","expense_utility","asset_inventory","asset_fixed","liability_ap","revenue_sales","revenue_service","other"],sc=["vat_7","vat_0","vat_exempt","wht_1","wht_3","wht_5","non_vat"],ic="468b50c1-5593-4fd6-990d-515ce8085563";let Z={sub:"clients",loaded:{clients:!1,accounts:!1,taxes:!1,products:!1},items:{clients:[],accounts:[],taxes:[],products:[]},clientList:[],clientLoaded:!1,addingNew:{clients:!1,accounts:!1,taxes:!1,products:!1},bound:!1};function Jt(){const e=typeof _userInfo<"u"?_userInfo:null;return!!(e&&(e.role==="owner"||e.is_super_admin))}function rc(){const e=typeof _userInfo<"u"?_userInfo:null;return!!(e&&e.id===ic)}function T(e){return typeof escapeHtml=="function"?escapeHtml(e==null?"":String(e)):String(e??"")}function Je(e,n){try{typeof showToast=="function"&&showToast(e,n||"info")}catch{}}function lc(e){return e==="clients"?'<div class="erp-map-row erp-map-head row-clients"><div>'+T(t("erp-map-col-client"))+"</div><div>"+T(t("erp-map-col-erp"))+"</div><div>"+T(t("erp-map-col-erp-code"))+"</div><div>"+T(t("erp-map-col-notes"))+"</div><div>"+T(t("erp-map-col-actions"))+"</div></div>":e==="accounts"?'<div class="erp-map-row erp-map-head row-accounts"><div>'+T(t("erp-map-col-erp"))+"</div><div>"+T(t("erp-map-col-category"))+"</div><div>"+T(t("erp-map-col-erp-code"))+"</div><div>"+T(t("erp-map-col-erp-name"))+"</div><div>"+T(t("erp-map-col-notes"))+"</div><div>"+T(t("erp-map-col-actions"))+"</div></div>":e==="products"?'<div class="erp-map-row erp-map-head row-products"><div>'+T(t("erp-map-col-item-name"))+"</div><div>"+T(t("erp-map-col-erp-product-code"))+"</div><div>"+T(t("erp-map-col-erp-name"))+"</div><div>"+T(t("erp-map-col-notes"))+"</div><div>"+T(t("erp-map-col-actions"))+"</div></div>":'<div class="erp-map-row erp-map-head row-taxes"><div>'+T(t("erp-map-col-erp"))+"</div><div>"+T(t("erp-map-col-tax"))+"</div><div>"+T(t("erp-map-col-erp-tax-code"))+"</div><div>"+T(t("erp-map-col-notes"))+"</div><div>"+T(t("erp-map-col-actions"))+"</div></div>"}function Mn(e,n){let a='<select class="form-input" data-erp-field="'+n+'">';return a+='<option value="">'+T(t("erp-map-pick-erp"))+"</option>",ac.forEach(function(o){const s=o===e?" selected":"";a+='<option value="'+o+'"'+s+">"+T(rs[o])+"</option>"}),a+="</select>",a}function cc(e){let n='<select class="form-input" data-erp-field="client_id">';return n+='<option value="">'+T(t("erp-map-pick-client"))+"</option>",(Z.clientList||[]).forEach(function(a){const o=String(a.id)===String(e)?" selected":"";n+='<option value="'+a.id+'"'+o+">"+T(a.name||"#"+a.id)+"</option>"}),n+="</select>",n}function dc(e){let n='<select class="form-input" data-erp-field="pearnly_category">';return n+='<option value="">'+T(t("erp-map-pick-cat"))+"</option>",oc.forEach(function(a){const o=a===e?" selected":"";n+='<option value="'+a+'"'+o+">"+T(t("erp-map-cat-"+a))+"</option>"}),n+="</select>",n}function pc(e){let n='<select class="form-input" data-erp-field="pearnly_tax_kind">';return n+='<option value="">'+T(t("erp-map-pick-tax"))+"</option>",sc.forEach(function(a){const o=a===e?" selected":"";n+='<option value="'+a+'"'+o+">"+T(t("erp-map-tax-"+a))+"</option>"}),n+="</select>",n}function uc(e){const n='<button class="btn btn-primary" type="button" data-erp-save="new" style="padding:6px 12px;height:32px;">'+T(t("erp-map-save"))+"</button>";return e==="clients"?'<div class="erp-map-row erp-map-row-add row-clients" data-erp-row="new"><div data-label="'+T(t("erp-map-col-client"))+'">'+cc("")+'</div><div data-label="'+T(t("erp-map-col-erp"))+'">'+Mn("","erp_type")+'</div><div data-label="'+T(t("erp-map-col-erp-code"))+'"><input type="text" class="form-input" data-erp-field="erp_code" placeholder="'+T(t("erp-map-ph-erp-code"))+'"></div><div data-label="'+T(t("erp-map-col-notes"))+'"><input type="text" class="form-input" data-erp-field="notes" placeholder="'+T(t("erp-map-ph-notes"))+'"></div><div>'+n+"</div></div>":e==="accounts"?'<div class="erp-map-row erp-map-row-add row-accounts" data-erp-row="new"><div data-label="'+T(t("erp-map-col-erp"))+'">'+Mn("","erp_type")+'</div><div data-label="'+T(t("erp-map-col-category"))+'">'+dc("")+'</div><div data-label="'+T(t("erp-map-col-erp-code"))+'"><input type="text" class="form-input" data-erp-field="erp_code" placeholder="'+T(t("erp-map-ph-acc-code"))+'"></div><div data-label="'+T(t("erp-map-col-erp-name"))+'"><input type="text" class="form-input" data-erp-field="erp_name" placeholder="'+T(t("erp-map-ph-acc-name"))+'"></div><div data-label="'+T(t("erp-map-col-notes"))+'"><input type="text" class="form-input" data-erp-field="notes" placeholder="'+T(t("erp-map-ph-notes"))+'"></div><div>'+n+"</div></div>":'<div class="erp-map-row erp-map-row-add row-taxes" data-erp-row="new"><div data-label="'+T(t("erp-map-col-erp"))+'">'+Mn("","erp_type")+'</div><div data-label="'+T(t("erp-map-col-tax"))+'">'+pc("")+'</div><div data-label="'+T(t("erp-map-col-erp-tax-code"))+'"><input type="text" class="form-input" data-erp-field="erp_code" placeholder="'+T(t("erp-map-ph-tax-code"))+'"></div><div data-label="'+T(t("erp-map-col-notes"))+'"><input type="text" class="form-input" data-erp-field="notes" placeholder="'+T(t("erp-map-ph-notes"))+'"></div><div>'+n+"</div></div>"}function fc(e,n,a){const o=a?"":'<button class="erp-map-del-btn" type="button" data-erp-del="'+T(n.id)+'" title="'+T(t("erp-map-delete"))+'"><svg width="14" height="14" viewBox="0 0 20 20" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"><path d="M4 6h12M8 6V4h4v2M6 6l1 11h6l1-11"/></svg></button>',s='<span class="erp-map-erp-badge">'+T(rs[n.erp_type]||n.erp_type)+"</span>";if(e==="clients")return'<div class="erp-map-row row-clients"><div data-label="'+T(t("erp-map-col-client"))+'" class="erp-map-cell-name">'+T(n.client_name||"#"+n.client_id)+'</div><div data-label="'+T(t("erp-map-col-erp"))+'">'+s+'</div><div data-label="'+T(t("erp-map-col-erp-code"))+'" class="erp-map-code">'+T(n.erp_code||"")+'</div><div data-label="'+T(t("erp-map-col-notes"))+'">'+T(n.notes||"")+"</div><div>"+o+"</div></div>";if(e==="accounts"){const r=t("erp-map-cat-"+(n.pearnly_category||"other"))||n.pearnly_category;return'<div class="erp-map-row row-accounts"><div data-label="'+T(t("erp-map-col-erp"))+'">'+s+'</div><div data-label="'+T(t("erp-map-col-category"))+'" class="erp-map-cell-name">'+T(r)+'</div><div data-label="'+T(t("erp-map-col-erp-code"))+'" class="erp-map-code">'+T(n.erp_code||"")+'</div><div data-label="'+T(t("erp-map-col-erp-name"))+'">'+T(n.erp_name||"")+'</div><div data-label="'+T(t("erp-map-col-notes"))+'">'+T(n.notes||"")+"</div><div>"+o+"</div></div>"}if(e==="products")return'<div class="erp-map-row row-products"><div data-label="'+T(t("erp-map-col-item-name"))+'" class="erp-map-cell-name">'+T(n.item_name||"")+'</div><div data-label="'+T(t("erp-map-col-erp-product-code"))+'" class="erp-map-code">'+T(n.erp_code||"")+'</div><div data-label="'+T(t("erp-map-col-erp-name"))+'">'+T(n.erp_name||"")+'</div><div data-label="'+T(t("erp-map-col-notes"))+'">'+T(n.notes||"")+"</div><div>"+o+"</div></div>";const i=t("erp-map-tax-"+(n.pearnly_tax_kind||""))||n.pearnly_tax_kind;return'<div class="erp-map-row row-taxes"><div data-label="'+T(t("erp-map-col-erp"))+'">'+s+'</div><div data-label="'+T(t("erp-map-col-tax"))+'" class="erp-map-cell-name"><span class="erp-map-tax-badge">'+T(i)+'</span></div><div data-label="'+T(t("erp-map-col-erp-tax-code"))+'" class="erp-map-code">'+T(n.erp_code||"")+'</div><div data-label="'+T(t("erp-map-col-notes"))+'">'+T(n.notes||"")+"</div><div>"+o+"</div></div>"}(function(){async function e(p,l){const u=localStorage.getItem("mrpilot_token");if(u&&!(Z.loaded[p]&&!l))try{const f=await fetch("/api/erp/mappings/"+p,{headers:{Authorization:"Bearer "+u}});if(!f.ok)throw new Error("http_"+f.status);const v=await f.json();Z.items[p]=v.items||[],Z.loaded[p]=!0}catch{Z.items[p]=[],Z.loaded[p]=!1}}async function n(p){if(Z.clientLoaded)return;const l=localStorage.getItem("mrpilot_token");if(l)try{const u=await fetch("/api/clients?include_inactive=false",{headers:{Authorization:"Bearer "+l}});if(!u.ok)throw new Error("http_"+u.status);const f=await u.json();Z.clientList=(f.clients||f.items||[]).filter(v=>v.is_active!==!1),Z.clientLoaded=!0}catch{Z.clientList=[]}}function a(){const p=document.getElementById("erp-map-pane-wrap");if(!p)return;const l=!Jt();let u="";l&&(u+='<div class="erp-map-readonly-banner"><svg width="16" height="16" viewBox="0 0 20 20" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"><circle cx="10" cy="10" r="8"/><path d="M10 6v4M10 13v0.01"/></svg>'+T(t("erp-map-readonly-tip"))+"</div>"),u+='<div class="erp-map-toolbar">',!l&&Z.sub!=="products"&&(u+='<button class="btn btn-primary" type="button" id="erp-map-add-btn" data-i18n="erp-map-add-row">'+T(t("erp-map-add-row"))+"</button>"),u+="</div>",u+='<div class="erp-map-table" id="erp-map-table-host"></div>',p.innerHTML=u,o();const f=document.getElementById("erp-map-dev-bar");f&&(f.style.display=Jt()&&rc()?"":"none")}function o(){const p=document.getElementById("erp-map-table-host");if(!p)return;const l=Z.sub,u=Z.items[l]||[],f=Z.addingNew[l],v=!Jt();if(!u.length&&!f){p.innerHTML='<div class="erp-map-empty"><strong>'+T(t("erp-map-empty-"+l))+"</strong>"+T(t("erp-map-empty-"+l+"-sub"))+"</div>";return}let w="";w+=lc(l),f&&!v&&(w+=uc(l)),u.forEach(function(g){w+=fc(l,g,v)}),p.innerHTML=w}async function s(p){const l=Z.sub,u={};p.querySelectorAll("[data-erp-field]").forEach(function(g){u[g.dataset.erpField]=(g.value||"").trim()});const f=localStorage.getItem("mrpilot_token");if(!f)return;let v={},w="/api/erp/mappings/"+l;if(l==="clients"){if(!u.client_id||!u.erp_type||!u.erp_code){Je(t("erp-map-save-fail"),"error");return}v={client_id:parseInt(u.client_id,10),erp_type:u.erp_type,erp_code:u.erp_code,notes:u.notes||""}}else if(l==="accounts"){if(!u.erp_type||!u.pearnly_category||!u.erp_code){Je(t("erp-map-save-fail"),"error");return}v={erp_type:u.erp_type,pearnly_category:u.pearnly_category,erp_code:u.erp_code,erp_name:u.erp_name||"",notes:u.notes||""}}else{if(!u.erp_type||!u.pearnly_tax_kind||!u.erp_code){Je(t("erp-map-save-fail"),"error");return}v={erp_type:u.erp_type,pearnly_tax_kind:u.pearnly_tax_kind,erp_code:u.erp_code,notes:u.notes||""}}try{const g=await fetch(w,{method:"POST",headers:{"Content-Type":"application/json",Authorization:"Bearer "+f},body:JSON.stringify(v)});if(!g.ok)throw new Error("http_"+g.status);Z.addingNew[l]=!1,await e(l,!0),o(),Je(t("erp-map-saved-toast"),"success")}catch{Je(t("erp-map-save-fail"),"error")}}async function i(p){if(!await window.pearnlyConfirm(t("erp-map-confirm-delete")))return;const u=Z.sub,f=localStorage.getItem("mrpilot_token");try{const v=await fetch("/api/erp/mappings/"+u+"/"+encodeURIComponent(p),{method:"DELETE",headers:{Authorization:"Bearer "+f}});if(!v.ok)throw new Error("http_"+v.status);await e(u,!0),o(),Je(t("erp-map-deleted-toast"),"success")}catch{Je(t("erp-map-delete-fail"),"error")}}async function r(){await n(),await e(Z.sub,!1),a()}function c(p){p!==Z.sub&&(Z.sub=p,Z.addingNew[p]=!1,["clients","accounts","taxes","products"].forEach(function(l){l!==p&&(Z.addingNew[l]=!1)}),document.querySelectorAll(".erp-map-subtab").forEach(function(l){l.classList.toggle("active",l.dataset.erpSubtab===p)}),e(p,!1).then(function(){a()}))}function m(){Z.bound||(Z.bound=!0,document.addEventListener("click",function(p){const l=p.target.closest(".erp-subtab[data-erp-subtab]");if(l){p.preventDefault();const g=l.dataset.erpSubtab;document.querySelectorAll(".erp-subtab").forEach(function(b){b.classList.toggle("active",b.dataset.erpSubtab===g)}),document.querySelectorAll(".erp-subpanel").forEach(function(b){b.classList.toggle("active",b.dataset.erpSubpanel===g)}),g==="mappings"&&setTimeout(r,50);return}const u=p.target.closest(".erp-map-subtab[data-erp-subtab]");if(u){p.preventDefault(),c(u.dataset.erpSubtab);return}if(p.target.closest("#erp-map-add-btn")){if(p.preventDefault(),!Jt())return;Z.addingNew[Z.sub]=!0,o();return}const v=p.target.closest('[data-erp-save="new"]');if(v){p.preventDefault();const g=v.closest('[data-erp-row="new"]');g&&s(g);return}const w=p.target.closest("[data-erp-del]");if(w){p.preventDefault(),i(w.dataset.erpDel);return}}))}function d(){const p=document.getElementById("erp-map-pane-wrap");p&&p.children.length>0&&a(),document.querySelectorAll(".erp-map-subtab").forEach(function(l){const u="erp-map-subtab-"+l.dataset.erpSubtab,f=t(u);f&&f!==u&&(l.textContent=f)})}m(),typeof window.subscribeI18n=="function"&&window.subscribeI18n("erp-mappings",d)})();(function(){let e=null,n=0,a=!1;function o(E){return typeof escapeHtml=="function"?escapeHtml(E==null?"":String(E)):String(E??"")}function s(E,B){try{typeof showToast=="function"&&showToast(E,B||"info")}catch{}}async function i(E){const B=Date.now();if(e&&B-n<3e4)return e;const I=localStorage.getItem("mrpilot_token");if(!I)return[];try{const L=await fetch("/api/erp/connectors/status",{headers:{Authorization:"Bearer "+I}});if(!L.ok)return[];const C=await L.json();return e=C&&C.connectors||[],n=B,e}catch{return[]}}function r(){try{return localStorage.getItem("pn_push_default_connector")||""}catch{return""}}function c(E){try{localStorage.setItem("pn_push_default_connector",E||"")}catch{}}function m(E){if(!E||!E.length)return null;const B=r();if(B){const L=E.find(C=>C.id===B);if(L)return L}const I=E.find(L=>L.is_default);return I||E[0]}function d(E){if(!E)return!1;const B=String(E.status||"").toLowerCase();return B==="exception"||B==="exception_pending"||B==="rejected"}function p(){try{return(typeof _results<"u"?_results:[])[typeof _drawerIdx<"u"?_drawerIdx:-1]||null}catch{return null}}function l(E){const B=E&&(E.type||E.id);return B==="xero"?'<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"><circle cx="8" cy="8" r="6"/><path d="M5.5 8l2 2 3-3.5"/></svg>':B==="webhook"?'<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"><circle cx="5" cy="11.5" r="1.8"/><circle cx="11" cy="4.5" r="1.8"/><path d="M6.4 10l3.2-4M5 9.6V5.5a3 3 0 016 0"/></svg>':'<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"><path d="M2 8h9M8 5l3 3-3 3"/><rect x="11" y="3" width="3" height="10" rx="1"/></svg>'}async function u(E,B){if(!E||!B)return!1;const I=document.getElementById("btn-push-default");I&&(I.disabled=!0,I.classList.add("loading"));const L=localStorage.getItem("mrpilot_token");try{let C,S={method:"POST",headers:{Authorization:"Bearer "+L}};E.type==="xero"?C="/api/erp/xero/push/"+encodeURIComponent(B):(C="/api/erp/push",S.headers["Content-Type"]="application/json",S.body=JSON.stringify({history_id:B,endpoint_id:E.endpoint_id||void 0}));const F=await fetch(C,S);let A={};try{A=await F.json()}catch{}if(!F.ok){let z=A&&A.detail||"unknown";typeof z=="object"&&(z=z.code||JSON.stringify(z));let ee=String(z||"unknown");if(E.type==="xero"){const oe=ee.replace(/^xero\./,"").toLowerCase(),ce=t("xero-"+oe);ce&&ce!=="xero-"+oe&&(ee=ce)}return s(t("unified-push-fail").replace("{name}",E.name).replace("{err}",ee),"error"),!1}if(A&&A.ok===!1){let z=A.error_msg||A.error_code||"unknown";return z=String(z).slice(0,200),s(t("unified-push-fail").replace("{name}",E.name).replace("{err}",z),"error"),!1}return s(t("unified-push-ok").replace("{name}",E.name),"success"),!0}catch(C){return s(t("unified-push-fail").replace("{name}",E.name).replace("{err}",C.message||"network"),"error"),!1}finally{I&&(I.disabled=!1,I.classList.remove("loading"))}}async function f(E,B){for(const I of E)await u(I,B)}function v(E,B){const I=document.createElement("div");I.className="pn-push-dropdown",I.id="pn-push-dropdown";const L=(E||[]).map(S=>{const F=!!(B&&S.id===B.id),A=S.method==="download"?t("unified-push-tag-download"):F?t("unified-push-tag-default"):"";return'<div class="pn-pd-item" data-cid="'+o(S.id)+'"><span class="pn-pd-icon">'+l(S)+'</span><span class="pn-pd-name">'+o(S.name)+"</span>"+(A?'<span class="pn-pd-tag">'+o(A)+"</span>":"")+(F?'<span class="pn-pd-check">✓</span>':"")+"</div>"}).join(""),C=E&&E.length>1?'<div class="pn-pd-divider"></div><div class="pn-pd-item pn-pd-all" data-cid="__all__"><span class="pn-pd-icon"><svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"><path d="M3 6h10M3 10h10M3 13.5h6"/></svg></span><span class="pn-pd-name">'+o(t("unified-push-all").replace("{n}",E.length))+"</span></div>":"";return I.innerHTML=L+C,I}function w(){const E=document.getElementById("pn-push-dropdown");E&&E.remove()}async function g(){if(document.getElementById("pn-push-dropdown")){w();return}const E=await i()||[],B=m(E),I=v(E,B),L=document.getElementById("pn-push-wrap");L&&L.appendChild(I)}async function b(){const E=await i()||[],B=m(E);if(!B)return;const I=p(),L=I&&(I._historyId||I.history_id);if(L){if(d(I)){s(t("unified-push-disabled-exc"),"warn");return}await u(B,L)}}async function h(E){w();const B=await i()||[],I=p(),L=I&&(I._historyId||I.history_id);if(!L)return;if(d(I)){s(t("unified-push-disabled-exc"),"warn");return}if(E==="__all__"){await f(B,L);return}const C=B.find(S=>S.id===E);C&&(c(E),await u(C,L),y())}async function _(){const E=document.getElementById("drawer-history-save");if(!E||E.querySelector("#pn-push-wrap"))return;const B=document.createElement("div");B.id="pn-push-wrap",B.className="pn-push-wrap",B.dataset.loading="1",E.insertBefore(B,E.firstChild),["btn-push-erp","btn-xero-push"].forEach(A=>{E.querySelectorAll("#"+A).forEach(z=>{z.style.display="none"})});const I=await i()||[],L=m(I),C=I.length>0;if(!C)B.innerHTML='<button type="button" class="btn btn-ghost pn-push-empty" id="btn-push-default" disabled title="'+o(t("unified-push-empty-tip"))+'"><svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"><path d="M2 8h9M8 5l3 3-3 3"/></svg><span style="margin-left:4px;">'+o(t("unified-push-empty"))+"</span></button>";else{const A=I.length>1;B.innerHTML='<div class="pn-push-split"><button type="button" class="pn-push-main" id="btn-push-default" title="'+o(t("unified-push-tip"))+'">'+l(L)+"<span>"+o(t("unified-push-to").replace("{name}",L?L.name:""))+"</span></button>"+(A?'<button type="button" class="pn-push-arrow" id="btn-push-arrow" title="'+o(t("unified-push-other"))+'"><svg viewBox="0 0 12 12" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M3 5l3 3 3-3"/></svg></button>':"")+"</div>"}delete B.dataset.loading;const S=B.querySelector("#btn-push-default");S&&C&&S.addEventListener("click",b);const F=B.querySelector("#btn-push-arrow");F&&F.addEventListener("click",function(A){A.stopPropagation(),g()}),a||(a=!0,document.addEventListener("click",function(A){const z=A.target.closest(".pn-pd-item");if(z){const ee=z.getAttribute("data-cid");h(ee);return}A.target.closest("#btn-push-arrow")||w()}),typeof window.subscribeI18n=="function"&&window.subscribeI18n("unified-push",y))}function y(){const E=document.getElementById("pn-push-wrap");E&&(E.remove(),e=null,n=0,_())}function k(){const E=document.getElementById("drawer-history-save");if(!E||!E.querySelector("#pn-push-wrap"))return;["btn-push-erp","btn-xero-push"].forEach(I=>{E.querySelectorAll("#"+I).forEach(L=>{L.style.display!=="none"&&(L.style.display="none")})});const B=E.querySelectorAll("#pn-push-wrap");if(B.length>1)for(let I=1;I<B.length;I++)B[I].remove()}function x(){try{const E=function(){return document.getElementById("drawer-body")},B=new MutationObserver(function(){document.getElementById("drawer-history-save")&&!document.getElementById("pn-push-wrap")&&_(),k()}),I=E();if(I)B.observe(I,{childList:!0,subtree:!0});else{const L=new MutationObserver(function(){const C=E();C&&(B.observe(C,{childList:!0,subtree:!0}),L.disconnect())});L.observe(document.body,{childList:!0,subtree:!0})}setTimeout(function(){document.getElementById("drawer-history-save")&&!document.getElementById("pn-push-wrap")&&_(),k()},200)}catch{}}x()})();(function(){function e(){const a=document.getElementById("erp-map-show-advanced-btn");if(!a)return;const o=document.getElementById("erp-map-subtabs");if(!o)return;const s=o.classList.contains("show-advanced"),i=a.querySelector(".erp-map-adv-btn-label");if(i&&typeof t=="function"){const r=s?"erp-map-hide-advanced":"erp-map-show-advanced",c=t(r);c&&c!==r&&(i.textContent=c)}a.setAttribute("aria-pressed",s?"true":"false")}document.addEventListener("click",function(a){if(!a.target.closest("#erp-map-show-advanced-btn"))return;a.preventDefault();const s=document.getElementById("erp-map-subtabs");if(s&&(s.classList.toggle("show-advanced"),e(),!s.classList.contains("show-advanced")&&s.querySelector(".erp-map-subtab.active.erp-map-subtab-advanced"))){const r=s.querySelector('.erp-map-subtab[data-erp-subtab="clients"]');r&&r.click()}});function n(){e()}typeof window.subscribeI18n=="function"&&window.subscribeI18n("erp-map-advanced-toggle",n)})();(function(){const e="pearnly_erp_onboard_shown";let n=!1;function a(){try{return Array.isArray(window._erpEndpoints)&&window._erpEndpoints.length>0}catch{return!1}}function o(){if(document.getElementById("erp-onboard-mask"))return;const i=document.createElement("div");i.id="erp-onboard-mask",i.className="erp-onboard-mask",i.innerHTML='<div class="erp-onboard-modal" role="dialog" aria-modal="true"><div class="erp-onboard-icon"><svg viewBox="0 0 32 32" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><rect x="4" y="6" width="24" height="20" rx="3"/><path d="M9 13h14M9 18h10"/><path d="M22 22l3 3 5-5"/></svg></div><div class="erp-onboard-title" id="erp-onboard-title"></div><div class="erp-onboard-body" id="erp-onboard-body"></div><div class="erp-onboard-btns"><button type="button" class="btn btn-secondary" id="erp-onboard-later"></button><button type="button" class="btn btn-primary" id="erp-onboard-ok"></button></div></div>',document.body.appendChild(i);function r(){const m=document.getElementById("erp-onboard-title"),d=document.getElementById("erp-onboard-body"),p=document.getElementById("erp-onboard-ok"),l=document.getElementById("erp-onboard-later");m&&(m.textContent=t("erp-onboard-title")),d&&(d.textContent=t("erp-onboard-body")),p&&(p.textContent=t("erp-onboard-ok")),l&&(l.textContent=t("erp-onboard-later"))}r();function c(){i.style.display="none"}document.getElementById("erp-onboard-ok").addEventListener("click",function(){try{localStorage.setItem(e,"1")}catch{}c();try{const m=document.querySelector('#btn-add-endpoint, [data-action="erp-add-endpoint"]');m&&m.scrollIntoView({behavior:"smooth",block:"center"})}catch{}}),document.getElementById("erp-onboard-later").addEventListener("click",function(){try{localStorage.setItem(e,"1")}catch{}c()}),i.addEventListener("click",function(m){m.target===i&&c()}),typeof window.subscribeI18n=="function"&&window.subscribeI18n("erp-onboard-modal",function(){i.style.display!=="none"&&r()})}function s(){if(!n){try{if(localStorage.getItem(e)==="1")return}catch{}a()||(n=!0,o(),requestAnimationFrame(function(){requestAnimationFrame(function(){if(a())return;const i=document.getElementById("erp-onboard-mask");i&&(i.style.display="flex")})}))}}document.addEventListener("click",function(i){const r=i.target.closest('.auto-nav-item[data-auto-tab="erp"]'),c=i.target.closest('.erp-subtab[data-erp-subtab="connect"]');(r||c)&&setTimeout(s,700)})})();(function(){const e={parse:{zh:"解析文件中",th:"กำลังอ่านไฟล์",en:"Parsing files",ja:"ファイル解析中"},report:{zh:"读取报告中",th:"กำลังอ่านรายงาน",en:"Reading report",ja:"レポート読込中"},reconcile:{zh:"对账中",th:"กำลังกระทบยอด",en:"Reconciling",ja:"照合中"},build:{zh:"生成中",th:"กำลังสร้างไฟล์",en:"Building",ja:"作成中"},persist:{zh:"保存中",th:"กำลังบันทึก",en:"Saving",ja:"保存中"},done:{zh:"完成",th:"เสร็จสิ้น",en:"Done",ja:"完了"}};window._reconProgressText=function(n,a){n=n||{},a=window._currentLang||a||localStorage.getItem("mrpilot_lang")||"th",e.parse[a]||(a="th");const o=n.stage||"parse",s=e[o]||e.parse,i=s[a]||s.th||s.en,r=n.stage_total,c=n.stage_done;if(o==="parse"&&typeof r=="number"&&r>0){const m={zh:"共 {d}/{t} 个文件",th:"{d}/{t} ไฟล์",en:"{d}/{t} files",ja:"{d}/{t} ファイル"}[a]||"{d}/{t} files";return i+" · "+m.replace("{d}",String(c||0)).replace("{t}",String(r))}return i},window._reconPollJob=async function(n,a,o){o=o||{};const s=o.intervalMs||1500,i=o.maxMs||1200*1e3,r=Date.now();let c=0;for(;;){let m=null;try{const d=await fetch("/api/recon/jobs/"+encodeURIComponent(n),{headers:{Authorization:"Bearer "+a}});try{m=await d.json()}catch{m=null}(!d.ok||!m||!m.ok)&&(m=null)}catch{m=null}if(m){if(c=0,o.onProgress)try{o.onProgress(m.progress||{},m)}catch{}if(m.status==="done"||m.status==="failed"||m.status==="needs_review"||m.status==="needs_mapping")return m}else if(++c>=10)return{ok:!1,status:"failed",error_code:"poll_unreachable"};if(Date.now()-r>i)return{ok:!1,status:"timeout",error_code:"timeout"};await new Promise(d=>setTimeout(d,s))}}})();const P={initialized:!1,stmtFiles:[],glFiles:[],currentTask:null,currentFilter:"all",allRows:[],brv2Search:{stmt:"",gl:""},cachedHistoryTasks:[],brv2Page:1},H=e=>document.getElementById(e);function Fe(e){if(e==null)return"—";const n=Number(e);return isNaN(n)?"—":n.toLocaleString("en-US",{minimumFractionDigits:2,maximumFractionDigits:2})}function oo(e){return e?String(e).slice(0,10).split("-").reverse().join("/"):"—"}function ie(e){return String(e||"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}function mc(e,n){n=window._currentLang||n||"th";const a={stmt_headers_not_found:{zh:"认不出银行账单表头 · 请确认文件含日期/金额/余额列,或转成清晰的 Excel/CSV 重传",th:"หาหัวตารางบัญชีธนาคารไม่เจอ · ตรวจสอบว่ามีคอลัมน์ วันที่/จำนวนเงิน/ยอดคงเหลือ หรือแปลงเป็น Excel/CSV แล้วอัปโหลดใหม่",en:"Cannot detect bank statement headers · ensure the file has date/amount/balance columns, or re-upload as a clean Excel/CSV",ja:"銀行明細のヘッダーを認識できません · 日付/金額/残高列を確認するか、Excel/CSVに変換して再アップロードしてください"},gl_headers_not_found:{zh:"认不出总账表头 · 请确认文件含日期/科目/借方/贷方列,或转成清晰的 Excel/CSV 重传",th:"หาหัวตาราง GL ไม่เจอ · ตรวจสอบว่ามีคอลัมน์ วันที่/บัญชี/เดบิต/เครดิต หรือแปลงเป็น Excel/CSV แล้วอัปโหลดใหม่",en:"Cannot detect GL headers · ensure the file has date/account/debit/credit columns, or re-upload as a clean Excel/CSV",ja:"GLのヘッダーを認識できません · 日付/科目/借方/貸方列を確認するか、Excel/CSVに変換して再アップロードしてください"},stmt_no_rows:{zh:"文件里没有交易数据 · 请确认上传了正确的银行流水,或换更清晰的版本重传",th:"ไม่พบรายการธุรกรรมในไฟล์ · ตรวจสอบว่าอัปโหลด statement ที่ถูกต้อง หรือใช้เวอร์ชันที่ชัดเจนกว่า",en:"No transaction rows found · please upload the correct statement, or try a clearer version",ja:"取引データが見つかりません · 正しい明細をアップロードするか、より鮮明なファイルでお試しください"},no_rows:{zh:"解析后没有可对账的数据行 · 请确认文件内容完整,或换清晰版本重传",th:"ไม่มีแถวข้อมูลให้กระทบยอดหลังการอ่าน · ตรวจสอบความสมบูรณ์ของไฟล์ หรืออัปโหลดใหม่",en:"No reconcilable rows after parsing · check the file is complete, or re-upload a clearer version",ja:"解析後に照合可能な行がありません · ファイルの完全性を確認するか再アップロードしてください"},file_unreadable:{zh:"文件无法读取 · 可能已损坏或被加密 · 请换文件或转 PDF/Excel 重传",th:"อ่านไฟล์ไม่ได้ · อาจเสียหายหรือถูกเข้ารหัส · ลองไฟล์อื่นหรือแปลงเป็น PDF/Excel",en:"File cannot be read · may be corrupted or encrypted · try another file or convert to PDF/Excel",ja:"ファイルを読み取れません · 破損または暗号化の可能性 · 別ファイルまたはPDF/Excelに変換してください"},file_not_supported:{zh:"不支持此文件类型 · 请上传 PDF / 图片 / Excel / CSV",th:"ไม่รองรับไฟล์ประเภทนี้ · กรุณาอัปโหลด PDF / รูปภาพ / Excel / CSV",en:"File type not supported · please upload PDF / image / Excel / CSV",ja:"このファイル形式は非対応 · PDF / 画像 / Excel / CSV をアップロードしてください"},ocr_failed:{zh:"文件识别失败 · 请尝试更清晰的版本,或转成 PDF / Excel / CSV 重传",th:"อ่านไฟล์ไม่ออก · ลองเวอร์ชันที่ชัดเจนกว่า หรือแปลงเป็น PDF / Excel / CSV",en:"Could not read the file · try a clearer version, or convert to PDF / Excel / CSV",ja:"読み取りに失敗 · より鮮明なファイルか、PDF / Excel / CSV に変換して再試行してください"}},o={zh:"解析失败 · 请换更清晰的文件,或转成 Excel / CSV 后重新上传",th:"อ่านไฟล์ไม่สำเร็จ · ลองไฟล์ที่ชัดเจนกว่า หรือแปลงเป็น Excel / CSV แล้วอัปโหลดใหม่",en:"Parsing failed · try a clearer file, or convert to Excel / CSV and re-upload",ja:"解析に失敗しました · より鮮明なファイルか、Excel / CSV に変換して再アップロードしてください"},s=a[e]||o;return s[n]||s.th||s.en}function vc(e){return e?e<1024?e+" B":e<1048576?(e/1024).toFixed(1)+" KB":(e/1048576).toFixed(1)+" MB":""}function st(e,n){return window.t&&window.t(e)||n}function He(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function $n(e){const n=Number(e);return Number.isFinite(n)?n.toLocaleString(void 0,{minimumFractionDigits:2,maximumFractionDigits:2}):"—"}var ls="pearnly.brv2.lastAnchorOcr";function hc(e){try{var n=e&&e._anchor_ocr;if(!n||typeof n!="object")return;var a={stmt_opening:Number.isFinite(+n.stmt_opening)?+n.stmt_opening:null,gl_opening:Number.isFinite(+n.gl_opening)?+n.gl_opening:null,gl_closing:Number.isFinite(+n.gl_closing)?+n.gl_closing:null,stmt_closing:Number.isFinite(+n.stmt_closing)?+n.stmt_closing:null,ts:Date.now()};localStorage.setItem(ls,JSON.stringify(a))}catch{}}function gc(){try{var e=localStorage.getItem(ls);if(!e)return null;var n=JSON.parse(e);return!n||typeof n!="object"?null:n}catch{return null}}function bc(){var e=gc();if(e){var n={"brv2-anchor-stmt-opening":e.stmt_opening,"brv2-anchor-gl-opening":e.gl_opening,"brv2-anchor-gl-closing":e.gl_closing,"brv2-anchor-stmt-closing":e.stmt_closing},a=0;Object.keys(n).forEach(function(c){var m=document.getElementById(c);if(m&&m.value===""){var d=n[c];if(Number.isFinite(d)){m.value=d.toFixed(2);var p=m.closest&&m.closest(".brv2-anchor-cell");p&&p.classList.add("is-prefilled"),a+=1}}});var o=document.getElementById("brv2-anchor-eq"),s=document.getElementById("brv2-anchor-eq-val");if(o&&s&&Number.isFinite(e.stmt_opening)&&Number.isFinite(e.gl_opening)){var i=e.stmt_opening-e.gl_opening;s.textContent=i.toLocaleString(void 0,{minimumFractionDigits:2,maximumFractionDigits:2}),o.style.display=""}if(a>0){var r=document.getElementById("brv2-anchor-prefill-banner");r&&r.classList.add("show")}}}function yc(){var e=document.getElementById("brv2-anchor-prefill-banner");if(e){var n=!1;["brv2-anchor-gl-closing","brv2-anchor-stmt-closing","brv2-anchor-stmt-opening","brv2-anchor-gl-opening"].forEach(function(a){var o=document.getElementById(a);if(o){var s=o.closest&&o.closest(".brv2-anchor-cell");s&&s.classList.contains("is-prefilled")&&(n=!0)}}),e.classList.toggle("show",n)}}var wc=[["stmt_opening","brv2-anchor-stmt-opening"],["gl_opening","brv2-anchor-gl-opening"],["gl_closing","brv2-anchor-gl-closing"],["stmt_closing","brv2-anchor-stmt-closing"]];function kc(e){var n=document.getElementById("brv2-summary-collapse");if(!(!n||!n.parentNode)){var a=document.getElementById("brv2-anchor-audit"),o=e&&e._anchor_overrides;if(!o||typeof o!="object"||Object.keys(o).length===0){a&&a.parentNode&&a.parentNode.removeChild(a);return}a||(a=document.createElement("div"),a.id="brv2-anchor-audit",a.style.cssText="margin-top:14px;background:#fff7ed;border:1px solid #fed7aa;border-radius:8px;padding:14px 16px;",n.parentNode.insertBefore(a,n.nextSibling));var s=wc.map(function(i){var r=o[i[0]];if(!r)return"";var c=+r.ocr||0,m=+r.user||0,d=m-c,p=d>0?"+":(d<0,""),l=Math.abs(d)<.005?"#6b7280":d>0?"#16a34a":"#dc2626";return'<tr><td style="padding:6px 10px;color:#111827;font-size:13px">'+He(st(i[1],i[0]))+'</td><td style="padding:6px 10px;color:#6b7280;font-size:13px;text-align:right;font-variant-numeric:tabular-nums">'+He($n(c))+'</td><td style="padding:6px 10px;background:#fef08a;color:#92400e;font-weight:600;font-size:13px;text-align:right;font-variant-numeric:tabular-nums">'+He($n(m))+'</td><td style="padding:6px 10px;color:'+l+';font-weight:500;font-size:13px;text-align:right;font-variant-numeric:tabular-nums">'+He(p+$n(d))+"</td></tr>"}).join("");a.innerHTML='<div style="font-weight:600;color:#92400e;font-size:13px;margin-bottom:10px">'+He(st("brv2-anchor-audit-title","⚠ This run contains manually entered anchors"))+'</div><table style="width:100%;border-collapse:collapse;font-family:inherit"><thead><tr><th style="padding:6px 10px;text-align:left;color:#6b7280;font-size:11px;font-weight:500;border-bottom:1px solid #fed7aa">'+He(st("brv2-anchor-audit-col-field","Field"))+'</th><th style="padding:6px 10px;text-align:right;color:#6b7280;font-size:11px;font-weight:500;border-bottom:1px solid #fed7aa">'+He(st("brv2-anchor-audit-col-ocr","OCR"))+'</th><th style="padding:6px 10px;text-align:right;color:#6b7280;font-size:11px;font-weight:500;border-bottom:1px solid #fed7aa">'+He(st("brv2-anchor-audit-col-user","User"))+'</th><th style="padding:6px 10px;text-align:right;color:#6b7280;font-size:11px;font-weight:500;border-bottom:1px solid #fed7aa">'+He(st("brv2-anchor-audit-col-diff","Diff"))+"</th></tr></thead><tbody>"+s+"</tbody></table>"}}function cn(e){const n=H("brv2-summary-collapse"),a=H("brv2-detail-collapse"),o=H("brv2-export-btn"),s=H("brv2-new-btn"),i=H("brv2-parse-info-wrap");n&&(n.style.display=e?"":"none"),a&&(a.style.display=e?"":"none"),o&&(o.style.display=e?"":"none"),s&&(s.style.display=e?"":"none"),!e&&i&&(i.style.display="none");const r=H("brv2-warnings");!e&&r&&(r.style.display="none",r.innerHTML="")}function xc(e){const n=H("brv2-parse-info-wrap"),a=H("brv2-parse-info-body");if(!n||!a)return;const o=e.parse_info;if(!o){n.style.display="none";return}const s=window._currentLang||"zh",i={title:{zh:"文件解析状态",th:"สถานะการอ่านไฟล์",en:"File Parse Status",ja:"ファイル解析状態"},type:{zh:"类型",th:"ประเภท",en:"Type",ja:"種別"},file:{zh:"文件名",th:"ชื่อไฟล์",en:"File",ja:"ファイル"},rows:{zh:"解析行数",th:"แถวที่พบ",en:"Rows Found",ja:"解析行数"},bank:{zh:"银行/科目",th:"ธนาคาร/บัญชี",en:"Bank/Account",ja:"銀行/科目"},status:{zh:"状态",th:"สถานะ",en:"Status",ja:"状態"},stmt:{zh:"账单",th:"บัญชีธนาคาร",en:"Stmt",ja:"明細"},gl:{zh:"总账GL",th:"GL",en:"GL",ja:"GL"},ok:{zh:"✓ 成功",th:"✓ สำเร็จ",en:"✓ OK",ja:"✓ 成功"},warn:{zh:"⚠ 0行",th:"⚠ 0 แถว",en:"⚠ 0 rows",ja:"⚠ 0行"},fail:{zh:"✗ 失败",th:"✗ ล้มเหลว",en:"✗ Failed",ja:"✗ 失敗"}},r=u=>(i[u]||{})[s]||(i[u]||{}).zh||u,c=[...(o.stmt_files||[]).map(u=>({...u,_type:"stmt",_extra:u.bank_code||""})),...(o.gl_files||[]).map(u=>({...u,_type:"gl",_extra:(u.accounts||[]).join(", ")}))],m={stmt_headers_not_found:{zh:"认不出表头列 · 请确认文件含日期/金额/余额列",th:"หาคอลัมน์หัวตารางไม่เจอ · ตรวจสอบไฟล์มีวันที่/จำนวนเงิน/ยอดคงเหลือ",en:"Cannot detect column headers · ensure file has date/amount/balance columns",ja:"列ヘッダーが認識できません · 日付/金額/残高列を確認してください"},stmt_no_rows:{zh:"文件里没有交易数据 · 请确认上传了正确的银行流水",th:"ไม่พบรายการธุรกรรมในไฟล์ · ตรวจสอบว่าอัปโหลด statement ที่ถูกต้อง",en:"No transaction rows found · please check the file",ja:"取引データが見つかりません · ファイルを確認してください"},file_not_supported:{zh:"不支持此文件类型 · 请上传 PDF / 图片 / Excel / CSV",th:"ไม่รองรับไฟล์ประเภทนี้ · กรุณาอัปโหลด PDF / รูปภาพ / Excel / CSV",en:"File type not supported · please upload PDF / image / Excel / CSV",ja:"このファイル形式は非対応 · PDF / 画像 / Excel / CSV をアップロード"},file_unreadable:{zh:"文件无法读取 · 可能已损坏或被加密",th:"อ่านไฟล์ไม่ได้ · อาจเสียหายหรือถูกเข้ารหัส",en:"File cannot be read · may be corrupted or encrypted",ja:"ファイルを読み取れません · 破損または暗号化の可能性"},ocr_failed:{zh:"文件识别失败 · 请尝试更清晰的版本或换 PDF 格式重传",th:"อ่านไฟล์ไม่ออก · ลองเวอร์ชันที่ชัดเจนกว่าหรือเปลี่ยนเป็น PDF",en:"Could not read file · try a clearer version or upload as PDF",ja:"読み取り失敗 · より鮮明なファイルまたは PDF 形式で再試行"},gl_headers_not_found:{zh:"认不出总账表头 · 请确认文件含科目/借方/贷方列",th:"หาหัวคอลัมน์ GL ไม่เจอ · ตรวจสอบมีคอลัมน์บัญชี/เดบิต/เครดิต",en:"Cannot detect GL column headers · ensure account/debit/credit columns exist",ja:"GL 列ヘッダー認識不可 · 科目/借方/貸方列を確認してください"}},d=u=>{const f=String(u||"");return/Cannot detect bank statement column headers/i.test(f)?"stmt_headers_not_found":/Cannot detect GL column headers/i.test(f)?"gl_headers_not_found":/No transaction rows found|no pages parsed/i.test(f)?"stmt_no_rows":/unsupported format/i.test(f)?"file_not_supported":/Cannot read Excel|file_unreadable/i.test(f)?"file_unreadable":/Gemini.*invalid JSON|Gemini.*parsed but failed|validation errors|BankStatementDocument schema|layer2:|layer1:/i.test(f)?"ocr_failed":null},p=u=>{const f=u.error_code||d(u.error);if(f&&m[f]){const v=window._currentLang||"zh";return m[f][v]||m[f].zh}return String(u.error||"").slice(0,80)},l=u=>!u.ok&&u.error?`<span style="color:#dc2626">${r("fail")} — ${ie(p(u))}</span>`:u.rows?`<span style="color:#059669">${r("ok")} (${u.rows})</span>`:`<span style="color:#d97706">${r("warn")}</span>`;a.innerHTML=`
        ...
        <table style="width:100%;border-collapse:collapse;font-size:12px;margin-bottom:4px">
          ...
          <td>${c?"L"+c:"—"}</td>
        </tr>`}).join("")}async function Pt(){const e=localStorage.getItem("mrpilot_token")||"";try{const a=await(await fetch("/api/recon/bank-v2/tasks",{headers:{Authorization:"Bearer "+e}})).json();dn(a.tasks||[])}catch{const a=H("brv2-history-empty"),o=window._currentLang||"zh",s={zh:"加载失败",th:"โหลดประวัติไม่ได้",en:"Load failed",ja:"読み込み失敗"}[o]||"加载失败";a&&(a.textContent=s,a.style.display="");const i=H("brv2-history-table-wrap");i&&(i.style.display="none")}}const ft=10;function so(){const e=H("brv2-history-pager"),n=H("brv2-history-pager-info"),a=H("brv2-history-prev"),o=H("brv2-history-next");if(!e)return;if(P.cachedHistoryTasks.length<=ft){e.style.display="none";return}e.style.display="";const s=Math.ceil(P.cachedHistoryTasks.length/ft);n&&(n.textContent=P.brv2Page+" / "+s),a&&(a.disabled=P.brv2Page<=1),o&&(o.disabled=P.brv2Page>=s)}function Ec(){const e=H("brv2-history-prev"),n=H("brv2-history-next");e&&!e._brv2Bound&&(e._brv2Bound=!0,e.addEventListener("click",()=>{P.brv2Page>1&&(P.brv2Page--,dn(P.cachedHistoryTasks))})),n&&!n._brv2Bound&&(n._brv2Bound=!0,n.addEventListener("click",()=>{const a=Math.ceil(P.cachedHistoryTasks.length/ft);P.brv2Page<a&&(P.brv2Page++,dn(P.cachedHistoryTasks))}))}function dn(e){e!==void 0&&(P.cachedHistoryTasks=e||[],P.brv2Page=1);const n=P.cachedHistoryTasks,a=H("brv2-history-empty"),o=H("brv2-history-table-wrap"),s=H("brv2-history-tbody");if(!s)return;const i=window._currentLang||"zh";if(!n.length){const f={zh:"暂无对账记录",th:"ยังไม่มีประวัติ",en:"No records yet",ja:"記録なし"}[i]||"暂无对账记录";a&&(a.textContent=f,a.style.display=""),o&&(o.style.display="none"),so();return}a&&(a.style.display="none"),o&&(o.style.display="");const r=Math.ceil(n.length/ft);P.brv2Page>r&&(P.brv2Page=r);const c=(P.brv2Page-1)*ft,m=n.slice(c,c+ft),d=localStorage.getItem("mrpilot_token")||"",p='<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" width="14" height="14"><circle cx="8" cy="8" r="6"/><polyline points="6 8 8 10 10 8"/><line x1="8" y1="4" x2="8" y2="10"/></svg>',l='<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" width="14" height="14"><path d="M8 2v9M4 7l4 4 4-4M3 14h10"/></svg>',u='<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" width="14" height="14"><polyline points="3 4 13 4"/><path d="M6 4V2.5a.5.5 0 0 1 .5-.5h3a.5.5 0 0 1 .5.5V4"/><path d="M5 4l1 9a1 1 0 0 0 1 1h2a1 1 0 0 0 1-1l1-9"/></svg>';s.innerHTML="",m.forEach(f=>{const v=Number(f.formula_diff||0),w=Math.abs(v)<.05,g=(f.stmt_files||"").split(";").map(oe=>oe.trim().split(/[/\\]/).pop()).filter(Boolean).join(", "),b=(f.gl_files||"").split(";").map(oe=>oe.trim().split(/[/\\]/).pop()).filter(Boolean).join(", "),h=f.created_at?String(f.created_at).slice(0,16).replace("T"," "):"",_=document.createElement("tr");_.dataset.taskId=f.id;const y=document.createElement("td");y.textContent=h;const k=document.createElement("td");k.className="glv-history-file",k.title=g+" + "+b,k.textContent=g+" + "+b;const x=document.createElement("td");x.className="glv-num",x.textContent=(f.stmt_row_count||0)+" / "+(f.gl_row_count||0);const E=document.createElement("td");E.className="glv-num",E.textContent=f.matched_count||0;const B=document.createElement("td");B.className="glv-num",B.textContent=f.unmatched_gl||0;const I=document.createElement("td");I.className="glv-num",I.textContent=f.unmatched_stmt||0;const L=document.createElement("td");L.className="glv-num",L.style.color=w?"#059669":"#dc2626",L.textContent=w?"✓":Fe(v);const C=document.createElement("td");C.className="glv-history-actions";const S=(oe,ce,te,N)=>{const q=document.createElement("button");return q.type="button",q.title=ce,q.setAttribute("aria-label",ce),te&&(q.className=te),q.innerHTML=oe,q.onclick=U=>{U.stopPropagation(),N()},q},F={zh:"删除这条记录?",th:"ลบรายการนี้?",en:"Delete this record?",ja:"この記録を削除しますか?"}[i]||"删除?",A={zh:"加载",th:"โหลด",en:"Load",ja:"読込"}[i]||"加载",z={zh:"导出",th:"ส่งออก",en:"Export",ja:"エクスポート"}[i]||"导出",ee={zh:"删除",th:"ลบ",en:"Delete",ja:"削除"}[i]||"删除";C.appendChild(S(p,A,"",()=>io(f.id,d))),C.appendChild(S(l,z,"",()=>cs(f.id))),C.appendChild(S(u,ee,"glv-del",async()=>{await showConfirm(F,{danger:!0})&&(await fetch("/api/recon/bank-v2/"+f.id,{method:"DELETE",headers:{Authorization:"Bearer "+d}}),Pt())})),[y,k,x,E,B,I,L,C].forEach(oe=>_.appendChild(oe)),_.style.cursor="pointer",_.addEventListener("click",async oe=>{oe.target.closest(".glv-del")||oe.target.closest("button")||await io(f.id,d)}),s.appendChild(_)}),so(),ps()}function ps(){const e=((H("brv2-hist-search")||{}).value||"").trim().toLowerCase(),n=H("brv2-history-tbody");n&&n.querySelectorAll("tr").forEach(a=>{a.dataset.taskId&&(a.style.display=!e||a.textContent.toLowerCase().includes(e)?"":"none")})}async function io(e,n){try{const o=await(await fetch("/api/recon/bank-v2/"+e,{headers:{Authorization:"Bearer "+n}})).json();if(!o.ok)return;P.currentTask={task_id:o.task_id,...o},P.allRows=o.detail||[],P.currentFilter="all",document.querySelectorAll(".brv2-filter-btn").forEach(s=>s.classList.toggle("active",s.dataset.filter==="all")),_a(P.currentTask)}catch{}}function Le(e){const n=e==="stmt"?P.stmtFiles:P.glFiles,a=H(`brv2-${e}-name`);if(a)if(n.length===0)a.textContent="";else{const s=window._currentLang||"zh",i={zh:"个文件",th:" ไฟล์",en:" file(s)",ja:" ファイル"};a.textContent=n.length+(i[s]||" 个文件")}const o=H("brv2-preview-panel");o&&o.style.display!=="none"&&Vn(e),Bc()}function Bc(){const e=H("brv2-toggle-preview"),n=H("brv2-preview-panel"),a=P.stmtFiles.length+P.glFiles.length>0;e&&(e.style.display=a?"":"none"),!a&&n&&(n.style.display="none",e&&e.classList.remove("open"))}function Ic(){Vn("stmt"),Vn("gl")}function Vn(e){const n=H(e==="stmt"?"brv2-pp-stmt-col":"brv2-pp-gl-col");if(!n)return;const a=e==="stmt"?P.stmtFiles:P.glFiles,o=window._currentLang||"zh",s={stmt:{zh:"① 银行账单",th:"① บัญชีธนาคาร",en:"① Bank Stmt",ja:"① 銀行明細"},gl:{zh:"② 总账 GL",th:"② GL รายงาน",en:"② GL Report",ja:"② GL帳簿"}},i=(s[e]||{})[o]||s[e].zh,r=ie(window.t&&window.t("vex-preview-search")||"搜索文件名..."),c=ie(window.t&&window.t("vex-preview-clear-all")||"全清"),m=P.brv2Search[e]||"";n.innerHTML='<div class="vex-pp-col-title"><span class="vex-pp-col-name">'+ie(i)+' <span class="vex-pp-col-count">'+a.length+'</span></span></div><div class="vex-pp-search-row"><input class="vex-pp-search" id="brv2-pp-search-'+e+'" type="text" placeholder="'+r+'" value="'+ie(m)+'" autocomplete="off"><button class="vex-pp-clear-btn" id="brv2-pp-clearall-'+e+'" type="button">'+c+'</button></div><div class="vex-pp-file-list" id="brv2-pp-'+e+'-list"></div><div class="vex-pp-pagination" id="brv2-pp-'+e+'-pg"></div>';const d=H("brv2-pp-search-"+e);d&&d.addEventListener("input",function(l){P.brv2Search[e]=l.target.value,ro(e)});const p=H("brv2-pp-clearall-"+e);p&&p.addEventListener("click",function(){e==="stmt"?P.stmtFiles.length=0:P.glFiles.length=0,Le(e),Re()}),ro(e)}function ro(e){const n=H("brv2-pp-"+e+"-list"),a=H("brv2-pp-"+e+"-pg");if(!n)return;const o=e==="stmt"?P.stmtFiles:P.glFiles,s=(P.brv2Search[e]||"").toLowerCase(),i=s?o.filter(m=>m.name.toLowerCase().includes(s)):o.slice(),r='<svg class="vex-pp-fi-ico" viewBox="0 0 14 16" fill="none" stroke="currentColor" stroke-width="1.4" width="12" height="14"><path d="M3 1h6l3 3v11H3V1z"/><path d="M9 1v3h3"/></svg>',c='<svg viewBox="0 0 14 14" fill="none" stroke="currentColor" stroke-width="1.6" width="11" height="11"><path d="M2 4h10M5 4V2h4v2M5.5 7v4M8.5 7v4M3 4l1 8h6l1-8"/></svg>';if(n.innerHTML=i.map((m,d)=>'<div class="vex-pp-file-row">'+r+'<span class="vex-pp-fi-name" title="'+ie(m.name)+'">'+ie(m.name)+'</span><span class="vex-pp-fi-size">'+vc(m.size)+'</span><button class="vex-pp-fi-del" type="button" data-zone="'+e+'" data-idx="'+o.indexOf(m)+'" aria-label="remove">'+c+"</button></div>").join(""),n.querySelectorAll(".vex-pp-fi-del").forEach(function(m){m.addEventListener("click",function(){const d=parseInt(m.dataset.idx,10);m.dataset.zone==="stmt"?P.stmtFiles.splice(d,1):P.glFiles.splice(d,1),Le(m.dataset.zone),Re()})}),a){const m=window.t&&window.t("vex-preview-count")||"显示 {n} / 共 {m}";a.textContent=m.replace("{n}",i.length).replace("{m}",o.length)}}function Lc(){const e=H("brv2-toggle-preview");e&&!e._reconBound&&(e._reconBound=!0,e.addEventListener("click",function(){const n=H("brv2-preview-panel"),a=H("brv2-toggle-preview-label"),o=n&&n.style.display!=="none";n&&(n.style.display=o?"none":""),e.classList.toggle("open",!o),a&&(a.textContent=o?window.t&&window.t("vex-toggle-preview-open")||"查看清单":window.t&&window.t("vex-toggle-preview-close")||"收起清单"),o||Ic()}))}function Re(){const e=H("brv2-run-btn"),n=H("brv2-status"),a=P.stmtFiles.length>0,o=P.glFiles.length>0;if(e&&(e.disabled=!(a&&o)),n){const s=window._currentLang||"zh";if(!a&&!o){const i={zh:"请上传银行账单和 GL 文件",th:"กรุณาอัปโหลดบัญชีธนาคารและ GL",en:"Upload bank statement and GL files",ja:"銀行明細と GL を両方アップロードしてください"};n.textContent=i[s]||i.zh}else if(a)if(o){const i={zh:"两份文件已就绪",th:"พร้อมสอบทาน",en:"Ready to reconcile",ja:"照合を開始できます"};n.textContent=i[s]||i.zh}else{const i={zh:"还缺 GL 文件",th:"ยังขาดไฟล์ GL",en:"Missing GL file",ja:"GL ファイルが未アップロード"};n.textContent=i[s]||i.zh}else{const i={zh:"还缺银行账单 PDF",th:"ยังขาดไฟล์บัญชีธนาคาร PDF",en:"Missing bank statement PDF",ja:"銀行明細 PDF が未アップロード"};n.textContent=i[s]||i.zh}}}function lo(e,n,a){const o=H(e),s=H(n);!o||!s||(o.addEventListener("click",()=>s.click()),o.addEventListener("keydown",i=>{(i.key==="Enter"||i.key===" ")&&(i.preventDefault(),s.click())}),o.addEventListener("dragover",i=>{i.preventDefault(),o.classList.add("drag-over")}),o.addEventListener("dragleave",()=>o.classList.remove("drag-over")),o.addEventListener("drop",i=>{i.preventDefault(),o.classList.remove("drag-over");const r=Array.from(i.dataTransfer.files||[]);a==="stmt"?P.stmtFiles.push(...r):P.glFiles.push(...r),Le(a),Re()}),s.addEventListener("change",()=>{const i=Array.from(s.files||[]);a==="stmt"?P.stmtFiles.push(...i):P.glFiles.push(...i),s.value="",Le(a),Re()}))}function ge(e){const n=H("brv2-progress"),a=H("brv2-run-btn"),o=H("brv2-error");n&&(n.style.display=e?"":"none"),a&&(a.disabled=e),o&&(o.style.display="none")}function Ie(e){const n=H("brv2-error");n&&(n.textContent=e,n.style.display="",n.scrollIntoView({behavior:"smooth",block:"nearest"})),ge(!1),Re(),window.showToast&&window.showToast(e,"error")}async function Un(){if(P.stmtFiles.length===0||P.glFiles.length===0)return;const e=localStorage.getItem("mrpilot_token")||"",n=window._currentLang||"zh",a=(H("brv2-acct-select")||{}).value||"";cn(!1),ge(!0);try{const o=new FormData;P.stmtFiles.forEach(f=>o.append("stmt_files",f)),P.glFiles.forEach(f=>o.append("gl_files",f)),o.append("gl_account",a),o.append("lang",n);const s=parseFloat((H("brv2-anchor-gl-closing")||{}).value),i=parseFloat((H("brv2-anchor-stmt-closing")||{}).value),r=parseFloat((H("brv2-anchor-stmt-opening")||{}).value),c=parseFloat((H("brv2-anchor-gl-opening")||{}).value);Number.isFinite(s)&&o.append("gl_closing_override",s),Number.isFinite(i)&&o.append("stmt_closing_override",i),Number.isFinite(r)&&o.append("stmt_opening_override",r),Number.isFinite(c)&&o.append("gl_opening_override",c);const m=await fetch("/api/recon/bank-v2/submit",{method:"POST",headers:{Authorization:"Bearer "+e},body:o});let d=null;try{d=await m.json()}catch{d=null}if(d&&d.needs_mapping){ge(!1),window.ReconMapping?window.ReconMapping.show(d,{token:e,lang:n,onConfirmed:function(){Un()}}):Ie(t("brv2-err-server")||"服务器繁忙,请稍后重试");return}if(!m.ok||!d||!d.ok||!d.job_id){ge(!1),d&&(d.detail||d.error)?Ie(_humanizeBackendError(d.detail||d.error,"Error "+m.status)):Ie(t("brv2-err-server")||"服务器繁忙,请稍后重试");return}const p=H("brv2-progress-sub"),l=await window._reconPollJob(d.job_id,e,{onProgress:f=>{p&&(p.textContent=window._reconProgressText(f,n))}});if(l&&l.status==="needs_mapping"&&l.mapping){ge(!1),window.ReconMapping?window.ReconMapping.show(l.mapping,{token:e,lang:n,onConfirmed:function(){Un()}}):Ie(t("brv2-err-server")||"服务器繁忙,请稍后重试");return}if(l&&l.status==="needs_review"&&l.review){ge(!1),window.ReconReview?window.ReconReview.show(l.review,{token:e,lang:n,jobId:d.job_id,onConfirmed:async function(f){ge(!0);const v=await window._reconPollJob(f,e,{onProgress:w=>{p&&(p.textContent=window._reconProgressText(w,n))}});await u(v)}}):Ie(t("brv2-err-server")||"服务器繁忙,请稍后重试");return}if(l&&l.status==="failed"){ge(!1),Ie(mc(l.error_code,n));return}await u(l);async function u(f){try{if(!f||f.status!=="done"||!f.result_id){ge(!1),Ie(t("brv2-err-server")||"服务器繁忙,请稍后重试");return}const v=await fetch("/api/recon/bank-v2/"+encodeURIComponent(f.result_id),{headers:{Authorization:"Bearer "+e}});let w=null;try{w=await v.json()}catch{w=null}if(!v.ok||w===null||!w.ok){ge(!1),Ie(t("brv2-err-server")||"服务器繁忙,请稍后重试");return}(w.gl_accounts||[]).length>1&&Cc(w.gl_accounts),P.currentTask=w,P.allRows=w.detail||[],P.currentFilter="all",document.querySelectorAll(".brv2-filter-btn").forEach(b=>b.classList.toggle("active",b.dataset.filter==="all")),hc(w&&w.summary),ge(!1),_a(w),Pt();const g=H("brv2-summary-collapse");g&&g.scrollIntoView({behavior:"smooth",block:"nearest"})}catch(v){ge(!1),Ie(v.message||"Network error")}}}catch(o){Ie(o.message||"Network error")}}function Cc(e){const n=H("brv2-acct-select");if(!n)return;const a=window._currentLang||"zh",o={zh:"全部账户",th:"ทุกบัญชี",en:"All Accounts",ja:"すべての口座"}[a]||"全部账户";n.innerHTML=`<option value="">${o}</option>`+e.map(s=>`<option value="${ie(s)}">${ie(s)}</option>`).join(""),n.style.display=""}function Ea(){if(P.initialized){Pt();return}P.initialized=!0,lo("brv2-stmt-zone","brv2-stmt-input","stmt"),lo("brv2-gl-zone","brv2-gl-input","gl");const e=["brv2-anchor-gl-closing","brv2-anchor-stmt-closing","brv2-anchor-stmt-opening","brv2-anchor-gl-opening"];function n(){const c=parseFloat((H("brv2-anchor-stmt-opening")||{}).value),m=parseFloat((H("brv2-anchor-gl-opening")||{}).value),d=H("brv2-anchor-eq"),p=H("brv2-anchor-eq-val");if(!(!d||!p))if(Number.isFinite(c)&&Number.isFinite(m)){const l=c-m;p.textContent=l.toLocaleString(void 0,{minimumFractionDigits:2,maximumFractionDigits:2}),d.style.display=""}else d.style.display="none"}e.forEach(c=>{const m=H(c);m&&(m.addEventListener("input",n),m.addEventListener("input",()=>{const d=m.closest(".brv2-anchor-cell");d&&d.classList.remove("is-prefilled"),yc()}))}),bc();const a=H("brv2-run-btn");a&&a.addEventListener("click",Un);const o=H("brv2-reset-btn");o&&o.addEventListener("click",()=>{P.currentTask=null,P.allRows=[],P.stmtFiles=[],P.glFiles=[],Le("stmt"),Le("gl"),Re(),cn(!1);const c=H("brv2-acct-select");c&&(c.style.display="none"),e.forEach(p=>{const l=H(p);if(l){l.value="";const u=l.closest&&l.closest(".brv2-anchor-cell");u&&u.classList.remove("is-prefilled")}});const m=H("brv2-anchor-eq");m&&(m.style.display="none");const d=H("brv2-anchor-prefill-banner");d&&d.classList.remove("show")});const s=H("brv2-new-btn");s&&s.addEventListener("click",()=>{P.currentTask=null,P.allRows=[],P.stmtFiles=[],P.glFiles=[],Le("stmt"),Le("gl"),Re(),cn(!1)});const i=H("brv2-filter-tabs");i&&i.addEventListener("click",c=>{c.stopPropagation();const m=c.target.closest(".brv2-filter-btn");m&&(P.currentFilter=m.dataset.filter,i.querySelectorAll(".brv2-filter-btn").forEach(d=>d.classList.toggle("active",d===m)),ds())}),Lc(),Ec();const r=H("brv2-hist-search");r&&r.addEventListener("input",ps),Pt(),Re(),window._brv2LoadHistory=Pt,Array.isArray(window.__i18nSubs)||(window.__i18nSubs=[]),window.__i18nSubs=window.__i18nSubs.filter(c=>c.name!=="brv2"),window.__i18nSubs.push({name:"brv2",fn:function(){Re(),Le("stmt"),Le("gl"),P.currentTask&&_a(P.currentTask),dn()}})}window._loadBankReconV2Panel=function(e){const n=e?document.getElementById(e):null;n&&n.id!=="recon-pane-bank"&&(n.innerHTML=`<div style="padding:16px;font-size:13px;color:var(--ink-3)">
            银行对账 v2 · 请前往对账中心使用</div>`),Ea()};document.addEventListener("DOMContentLoaded",()=>{H("brv2-run-btn")&&Ea()});window._bankReconV2Init=Ea;(function(){const e=document.getElementById("general-lang");if(!e)return;e.addEventListener("change",a=>{const o=a.target.value;o&&applyLang(o)});const n=typeof currentLang=="string"&&currentLang||localStorage.getItem("mrpilot_lang")||"th";e.value=n})();(function(){const n="pearnly_general_tz",a="pearnly_general_date_format",o="pearnly_general_number_format",s={tz:"Asia/Bangkok",date:"YYYY-MM-DD",number:"comma_dot"};function i(){const d=document.getElementById("general-tz"),p=document.getElementById("general-date"),l=document.getElementById("general-number");if(!(!d||!p||!l))try{d.value=localStorage.getItem(n)||s.tz,p.value=localStorage.getItem(a)||s.date,l.value=localStorage.getItem(o)||s.number}catch{d.value=s.tz,p.value=s.date,l.value=s.number}}async function r(){const d=document.getElementById("btn-save-general"),p=document.getElementById("general-save-msg");if(!d)return;const l=d.innerHTML;d.disabled=!0,d.innerHTML="<span>"+(t("msg-saving")||"保存中...")+"</span>",p&&(p.textContent="",p.classList.remove("error"));try{const u=(document.getElementById("general-tz")||{}).value||s.tz,f=(document.getElementById("general-date")||{}).value||s.date,v=(document.getElementById("general-number")||{}).value||s.number;try{localStorage.setItem(n,u),localStorage.setItem(a,f),localStorage.setItem(o,v)}catch{}window._pearnlyGeneral={tz:u,date_format:f,number_format:v},p&&(p.textContent=t("msg-saved")||"已保存")}catch{p&&(p.textContent=t("msg-save-failed")||"保存失败",p.classList.add("error"))}finally{d.disabled=!1,d.innerHTML=l,setTimeout(function(){p&&(p.textContent="")},3e3)}}function c(){const d=document.getElementById("btn-save-general");if(!d){setTimeout(c,200);return}d._pearnlyGenBound||(d._pearnlyGenBound=!0,d.addEventListener("click",r),i())}function m(){i();const d=document.getElementById("general-lang");if(d){const p=typeof currentLang=="string"&&currentLang||localStorage.getItem("mrpilot_lang")||"th";d.value=p}}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",c):c(),typeof window.subscribeI18n=="function"&&window.subscribeI18n("settings-general",m)})();(function(){const e="mrpilot_nav_collapsed",n={ocr:"sales",history:"sales",reconcile:"sales","sales-invoices":"sales",receivables:"sales",vouchers:"expense"};function a(){try{const r=localStorage.getItem(e);return r?JSON.parse(r):{}}catch{return{}}}function o(r){try{localStorage.setItem(e,JSON.stringify(r))}catch{}}function s(){const r=a();document.querySelectorAll(".nav-collapsible").forEach(function(c){const m=c.dataset.collapsible;r[m]?c.classList.add("collapsed"):c.classList.remove("collapsed")})}function i(r){const c=a();c[r]=!c[r],o(c),s()}(function(){const c=a();let m=!1;c.sales===void 0&&(c.sales=!1,m=!0),c.expense===void 0&&(c.expense=!0,m=!0),m&&o(c)})(),s(),document.querySelectorAll(".nav-group-toggle").forEach(function(r){r.addEventListener("click",function(){i(r.dataset.toggleGroup)})}),window.expandNavGroupForRoute=function(r){const c=n[r];if(!c)return;const m=a();m[c]&&(m[c]=!1,o(m),s())}})();const Sc=`
    <div class="modal" style="max-width:440px">
        ...
        `}).join(""),_userInfo&&_userInfo.endpoints_limit!==-1){const s=ke.length,i=_userInfo.endpoints_limit,r=_userInfo.plan,c=document.createElement("div");c.className="erp-limit-hint",r==="free"?c.innerHTML=`${escapeHtml(t("ep-free-limit-hint",{used:s,limit:i}))} <a data-upgrade="plus">${escapeHtml(t("upgrade-to-plus"))}</a>`:c.textContent=t("ep-plus-limit-hint",{used:s,limit:i}),e.appendChild(c)}}function Tc(e){zt=e||null;const n=document.getElementById("endpoint-modal"),a=document.getElementById("endpoint-modal-title");a.textContent=e?t("ep-modal-title-edit"):t("ep-modal-title-new");const o=document.getElementById("ep-name"),s=document.getElementById("ep-url"),i=document.getElementById("ep-token"),r=document.getElementById("ep-is-default"),c=document.getElementById("ep-auto-push"),m=document.getElementById("ep-test-result");m.style.display="none",m.textContent="";const d=document.getElementById("ep-save-error");if(d&&d.remove(),e){const l=ke.find(u=>u.id===e);if(!l)return;o.value=l.name||"",s.value=(l.config||{}).url||"",i.value=(l.config||{})._token_set&&l.config.token||"",i.placeholder=(l.config||{})._token_set?"（已保存 · 留空保持不变）":t("ep-token-ph"),r.checked=!!l.is_default,c.checked=!!l.auto_push}else o.value="",s.value="",i.value="",i.placeholder=t("ep-token-ph"),r.checked=ke.length===0,c.checked=!0;const p=c.closest(".form-switch-row");if(c.disabled=!1,p){p.classList.remove("disabled-plus"),p.title="",p.style.cursor="",p.onclick=null;const l=p.querySelector(".plus-badge");l&&l.remove()}n.style.display="",setTimeout(()=>o.focus(),50)}function ms(){document.getElementById("endpoint-modal").style.display="none",zt=null;const e=document.getElementById("ep-save-error");e&&e.remove()}function vs(e){if(!e)return"";let n=e.trim();const a=n.search(/\s/);return a>=0&&(n=n.slice(0,a)),n}function hs(){const e=document.getElementById("ep-name").value.trim(),n=vs(document.getElementById("ep-url").value),a=document.getElementById("ep-token").value,o=document.getElementById("ep-is-default").checked,s=document.getElementById("ep-auto-push").checked,i={url:n};return a&&(i.token=a),{name:e,url:n,tokenVal:a,isDefault:o,autoPush:s,config:i}}async function Mc(){const{url:e,config:n}=hs(),a=document.getElementById("ep-test-result");if(!e){a.style.display="",a.className="form-test-result fail",a.textContent=t("ep-required");return}a.style.display="",a.className="form-test-result running",a.textContent=t("ep-test-running");try{const s=await(await fetch("/api/erp/test-connection",{method:"POST",headers:{Authorization:"Bearer "+token,"Content-Type":"application/json"},body:JSON.stringify({adapter:"webhook",config:n})})).json();s.success?(a.className="form-test-result ok",a.textContent=t("ep-test-ok",{status:s.http_status,ms:s.elapsed_ms})):(a.className="form-test-result fail",a.textContent=t("ep-test-fail",{err:s.error_msg||"unknown"}))}catch(o){a.className="form-test-result fail",a.textContent=t("ep-test-fail",{err:o.message})}}async function $c(){const e=hs(),n=document.getElementById("ep-save-error");if(n&&(n.style.display="none"),!e.name||!e.url){po(t("ep-required"));return}const a={name:e.name,adapter:"webhook",config:e.config,is_default:e.isDefault,auto_push:e.autoPush},o=document.getElementById("btn-ep-save"),s=o.innerHTML;o.disabled=!0,o.classList.add("loading");try{let i;if(zt?i=await fetch(`/api/erp/endpoints/${encodeURIComponent(zt)}`,{method:"PATCH",headers:{Authorization:"Bearer "+token,"Content-Type":"application/json"},body:JSON.stringify(a)}):i=await fetch("/api/erp/endpoints",{method:"POST",headers:{Authorization:"Bearer "+token,"Content-Type":"application/json"},body:JSON.stringify(a)}),!i.ok){const c=(await i.json().catch(()=>({}))).detail||`HTTP ${i.status}`;throw new Error(typeof c=="string"?c:JSON.stringify(c))}ms(),showToast(t("ep-save-ok")),kn()}catch(i){po(`${t("ep-save-fail")} · ${i.message||"unknown"}`)}finally{o.disabled=!1,o.classList.remove("loading"),o.innerHTML=s}}function po(e){let n=document.getElementById("ep-save-error");if(!n){const a=document.querySelector("#endpoint-modal .modal-foot");if(!a)return;n=document.createElement("div"),n.id="ep-save-error",n.className="ep-inline-error",a.parentNode.insertBefore(n,a)}n.textContent=e,n.style.display=""}async function Hc(e){const n=ke.find(o=>o.id===e);if(!(!n||!await showConfirm(t("ep-delete-confirm",{name:n.name}),{danger:!0})))try{if(!(await fetch(`/api/erp/endpoints/${encodeURIComponent(e)}`,{method:"DELETE",headers:{Authorization:"Bearer "+token}})).ok)throw new Error;showToast(t("ep-delete-ok")),kn()}catch{showToast(t("ep-save-fail"),"fail")}}window.loadErpEndpoints=kn;window.loadErpTodayStats=us;window.renderErpEndpointsList=fs;window.openEndpointModal=Tc;window.closeEndpointModal=ms;window.saveEndpoint=$c;window.deleteEndpoint=Hc;window.testEndpointConnection=Mc;window._sanitizeUrl=vs;async function gs(e){if(e=(e||"").trim(),!!e)try{await navigator.clipboard.writeText(e),showToast(t("erp-doc-copy-ok",{no:e}),"success")}catch{try{const a=document.createElement("textarea");a.value=e,a.style.position="fixed",a.style.opacity="0",document.body.appendChild(a),a.select(),document.execCommand("copy"),a.remove(),showToast(t("erp-doc-copy-ok",{no:e}),"success")}catch{showToast(t("erp-doc-copy-fail"),"error")}}}async function Ac(e){const n=document.createElement("div");n.className="log-detail-modal",n.innerHTML=`
        <div class="log-detail-box">
            <div class="log-detail-loading">${escapeHtml(t("log-detail-loading"))}</div>
        </div>
    `,document.body.appendChild(n),n.addEventListener("click",async a=>{if(a.target===n||a.target.classList.contains("log-detail-close")){n.remove();return}const o=a.target.closest("[data-receipt-copy]");if(o){gs(o.dataset.receiptCopy);return}const s=a.target.closest("[data-receipt-action]");if(s){const i=s.dataset.receiptAction;i==="retry"?window.retryPushLog(s.dataset.logId):i==="exceptions"?typeof routeTo=="function"&&routeTo("exceptions"):i==="mappings"&&typeof routeTo=="function"&&routeTo("integrations"),n.remove();return}});try{const a=await fetch(`/api/erp/logs/${encodeURIComponent(e)}`,{headers:{Authorization:"Bearer "+token}});if(!a.ok){n.remove();return}const o=await a.json(),s=window._erpEndpoints.find(S=>S.id===o.endpoint_id),i=o.endpoint_name||(s?s.name:o.endpoint_id?t("erp-log-endpoint-deleted"):"-"),r=(o.endpoint_adapter||s&&s.adapter||"").toLowerCase(),c=new Date(o.created_at).toLocaleString(),m=o.trigger==="auto"?t("log-tag-auto"):o.trigger==="retry"?t("log-tag-retry"):t("log-tag-manual"),d=o.request_body?JSON.stringify(o.request_body,null,2):t("erp-receipt-no-tech"),p=o.response_body||t("erp-receipt-no-tech"),l=o.status==="success";let u=typeof p=="string"?p:JSON.stringify(p,null,2);if(l)try{const S=typeof o.response_body=="string"?JSON.parse(o.response_body):o.response_body||{},F=S.row_count||(Array.isArray(S.imported_rows)?S.imported_rows.length:0);F>0&&(u=t("log-push-rows").replace("{n}",String(F)))}catch{}const f=(o.external_doc_no||"").trim(),v=(o.external_url||"").trim(),w=(o.external_doc_hint||"").trim(),g=(o.ocr_buyer_name||"").trim()||o.client_name||"-",b=o.seller_name||"-",h=o.push_type==="id_card";let _="-";const y=Number(o.total_amount);o.total_amount!=null&&o.total_amount!==""&&!isNaN(y)&&(_=y.toLocaleString("en-US",{minimumFractionDigits:2,maximumFractionDigits:2}));const k=l?t("erp-receipt-title-ok"):t("erp-receipt-title-fail"),x=l?"✓":"✗",E=[],B=(S,F)=>{E.push(`
                <div class="erp-receipt-row">
                    <span class="erp-receipt-key">${escapeHtml(S)}</span>
                    <span class="erp-receipt-val">${F}</span>
                </div>`)};if(B(h?t("erp-log-col-booking"):t("erp-receipt-invoice-no"),`<strong>${escapeHtml(o.invoice_no||"-")}</strong>`),B(t("erp-receipt-erp-name"),escapeHtml(i)),l){let S;f?S=`<strong class="erp-receipt-docno">${escapeHtml(f)}</strong><button class="erp-receipt-copy-btn" type="button" data-receipt-copy="${escapeHtml(f)}" title="${escapeHtml(t("erp-doc-copy-tip"))}">${escapeHtml(t("erp-receipt-copy-btn"))}</button>`:S=`<span class="erp-receipt-docno-missing">${escapeHtml(t("erp-log-doc-missing"))}</span>`,B(t("erp-receipt-doc-no"),S)}h||B(t("erp-receipt-client"),escapeHtml(g)),B(h?t("erp-log-col-customer"):t("erp-receipt-seller"),escapeHtml(b)),l&&B(t("erp-receipt-amount"),escapeHtml(_)),B(t("erp-receipt-time"),escapeHtml(c)),B(t("erp-receipt-elapsed"),escapeHtml((o.elapsed_ms!=null?o.elapsed_ms:"-")+"ms"));let I="";l&&v?I=`<a class="erp-receipt-primary-btn" href="${escapeHtml(v)}" target="_blank" rel="noopener">${escapeHtml(t("erp-receipt-open-erp"))}</a>`:l&&f&&(I=`<button class="erp-receipt-primary-btn" type="button" data-receipt-copy="${escapeHtml(f)}">${escapeHtml(t("erp-receipt-copy-docno"))}</button>`);let L="";if(l&&f&&w){const S="erp-receipt-hint-"+w,F=t(S);F&&F!==S&&(L=`<div class="erp-receipt-hint"><svg class="erp-receipt-hint-ic" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><circle cx="12" cy="12" r="9"/><line x1="12" y1="11" x2="12" y2="16"/><line x1="12" y1="8" x2="12.01" y2="8"/></svg><span>${escapeHtml(F)}</span></div>`)}let C="";if(!l){const S=(o.error_msg||"").match(/ERR_[A-Z0-9_]+/),F=S?S[0]:"",A=typeof currentLang=="string"&&currentLang||window._currentLang||"th",ee=o.error_friendly&&o.error_friendly[A]||(o.error_msg?humanizeError(o.error_msg):t("erp-receipt-no-error")),oe=/ERR_NO_CUSTOMER_MAPPING|ERR_NO_CLIENT|ERR_NO_SEED_CUSTOMER|ERR_NO_SEED_PRODUCT/.test(o.error_msg||""),ce=!!(o.history_id&&o.endpoint_id),te=[];te.push(`<button class="erp-receipt-action-btn" type="button" data-receipt-action="exceptions">${escapeHtml(t("erp-receipt-act-exceptions"))}</button>`),oe&&te.push(`<button class="erp-receipt-action-btn" type="button" data-receipt-action="mappings">${escapeHtml(t("erp-receipt-act-mapping"))}</button>`),ce&&te.push(`<button class="erp-receipt-action-btn primary" type="button" data-receipt-action="retry" data-log-id="${escapeHtml(o.id)}">${escapeHtml(t("erp-receipt-act-retry"))}</button>`),C=`
                <div class="erp-receipt-fail-reason-label">${escapeHtml(t("erp-receipt-fail-reason"))}</div>
                <div class="erp-receipt-fail-box">
                    ${F?`<div class="erp-receipt-errcode">${escapeHtml(F)}</div>`:""}
        ...
        `}catch(a){console.error(a),n.remove()}}window.copyErpDocNo=gs;window.showLogDetail=Ac;const jc=`
        <div class="modal">
            <div class="modal-head">
    ...
    `;fe("endpoint-modal",jc);let St={key:"all",val:""},Dt="",Hn=!1,Pe=new Set;window._erpSelected=Pe;async function Pc(){const e=document.getElementById("erp-logs-erp-select");if(!(!e||Hn)){Hn=!0;try{let n=window._erpEndpoints;if(!Array.isArray(n)||n.length===0){const s=await fetch("/api/erp/endpoints",{headers:{Authorization:"Bearer "+token}});if(s.ok){const i=await s.json();n=i&&(i.items||i)||[]}}Array.isArray(n)||(n=[]);const a=new Set,o=[];n.forEach(s=>{const i=(s&&s.adapter||"").toLowerCase();!i||a.has(i)||(a.add(i),o.push({val:i,label:s&&s.name||i}))}),e.innerHTML=`<option value="">${escapeHtml(t("erp-logs-erp-all"))}</option>`+o.map(s=>`<option value="${escapeHtml(s.val)}"${s.val===Dt?" selected":""}>${escapeHtml(s.label)}</option>`).join("")}catch{Hn=!1}}}async function mt(e){const n=document.getElementById("erp-logs-list");if(n){e||(n.innerHTML=`<div class="erp-logs-empty">${escapeHtml(t("erp-logs-loading"))}</div>`),window.loadErpTodayStats(),Pc();try{const a=new URLSearchParams({limit:"30"});St.key==="status"&&a.set("status",St.val),St.key==="trigger"&&a.set("trigger",St.val),Dt&&a.set("adapter",Dt);const o=await fetch(`/api/erp/logs?${a}`,{headers:{Authorization:"Bearer "+token}});if(!o.ok){n.innerHTML=`<div class="erp-logs-empty">${escapeHtml(t("erp-logs-error"))}</div>`;return}const i=(await o.json()).items||[];if(window._erpLogPollTimer&&(clearTimeout(window._erpLogPollTimer),window._erpLogPollTimer=null),i.some(function(f){return f.status==="pending"})&&(window._erpLogPollTimer=setTimeout(function(){mt(!0)},4e3)),i.length===0){n.innerHTML=`<div class="erp-logs-empty">${escapeHtml(t("erp-logs-empty"))}</div>`;return}const r=i.filter(function(f){var v=f.status==="failed"&&f.next_retry_at&&new Date(f.next_retry_at).getTime()>Date.now()-6e4;return!v}).map(function(f){return f.id}),c=Dt==="mrerp_dms",m=c?t("erp-log-col-booking"):t("erp-log-col-invoice"),d=c?t("erp-log-col-customer"):t("erp-log-col-seller"),p=c?t("erp-log-col-idcard"):t("erp-log-col-client"),l='<div class="erp-log-row erp-log-row-header" data-log-header>'+(r.length>0?`<input type="checkbox" class="erp-log-cb erp-log-cb-all" data-log-select-all title="${escapeHtml(t("erp-log-select-all-tip"))}">`:'<span class="erp-log-cb-spacer"></span>')+`<span class="log-time">${escapeHtml(t("erp-log-col-time"))}</span><span class="log-status">${escapeHtml(t("erp-log-col-status"))}</span><span class="log-tag-header">${escapeHtml(t("erp-log-col-trigger"))}</span><span class="log-invoice">${escapeHtml(m)}</span><span class="log-workspace">${escapeHtml(t("erp-log-col-workspace"))}</span><span class="log-client">${escapeHtml(p)}</span><span class="log-seller">${escapeHtml(d)}</span><span class="log-erp">${escapeHtml(t("erp-log-col-erp"))}</span><span class="log-doc">${escapeHtml(t("erp-log-col-doc"))}</span><span class="log-http">${escapeHtml(t("erp-log-col-http"))}</span><span class="log-elapsed">${escapeHtml(t("erp-log-col-elapsed"))}</span><span class="log-actions"></span></div>`;n.innerHTML=l+i.map(f=>{const v=new Date(f.created_at),w=`${String(v.getMonth()+1).padStart(2,"0")}-${String(v.getDate()).padStart(2,"0")} ${String(v.getHours()).padStart(2,"0")}:${String(v.getMinutes()).padStart(2,"0")}`,g=f.status==="failed"&&f.next_retry_at&&new Date(f.next_retry_at).getTime()>Date.now()-6e4;let b,h,_;f.status==="pending"?(b="retrying",h="⟳",_=t("erp-status-pending")):f.status==="success"?(b="ok",h="✓",_=t("erp-status-success")):f.status==="skipped_dup"?(b="skipped",h="⏭",_=t("erp-status-skipped")):g?(b="retrying",h="↻",_=t("erp-status-retrying")):(b="fail",h="✗",_=t("erp-status-failed"));let y;f.trigger==="auto"?y=`<span class="log-tag auto">${escapeHtml(t("log-tag-auto"))}</span>`:f.trigger==="retry"?y=`<span class="log-tag retry">${escapeHtml(t("log-tag-retry"))}</span>`:y=`<span class="log-tag manual">${escapeHtml(t("log-tag-manual"))}</span>`;const k=f.push_type==="id_card",x=k?`<span class="log-tag log-type-idcard">${escapeHtml(t("erp-log-type-idcard"))}</span>`:"",E=f.error_friendly&&(f.error_friendly[currentLang]||f.error_friendly.en)||"";let B="";const I=f.retry_count||0,L=f.max_retries||3;if(g){const U=new Date(f.next_retry_at).getTime()-Date.now(),se=Math.max(0,Math.round(U/6e4)),ne=se<=0?t("erp-retry-next-soon"):t("erp-retry-next-min",{n:se});B=`${t("erp-retry-attempt",{n:I,max:L})} · ${ne}`}else f.status==="failed"&&I>=L&&!f.next_retry_at&&(B=t("erp-retry-exhausted",{n:I}));const C=f.status==="failed"&&!g?`<button class="log-retry-btn btn btn-icon" data-log-retry="${escapeHtml(f.id)}" title="${escapeHtml(t("log-retry-title"))}">↻</button>`:"",S=!g,F=Pe.has(f.id)?"checked":"",A=S?`<input type="checkbox" class="erp-log-cb" data-log-cb="${escapeHtml(f.id)}" ${F}>`:'<span class="erp-log-cb-spacer"></span>',z=(f.ocr_buyer_name||"").trim()||(f.client_name||"").trim(),ee=k?`<span class="log-client" title="${escapeHtml(t("erp-log-col-idcard"))}">${f.id_card_tail?"••••"+escapeHtml(f.id_card_tail):"—"}</span>`:z?`<span class="log-client" title="${escapeHtml(z)}">${escapeHtml(z.substring(0,18))}</span>`:`<span class="log-client log-client-empty" title="${escapeHtml(t("erp-log-client-unassigned-tip"))}">${escapeHtml(t("erp-log-client-unassigned"))}</span>`,oe=k?'<span class="log-workspace log-workspace-unresolved">—</span>':f.workspace_name?`<span class="log-workspace">${escapeHtml((f.workspace_name||"").substring(0,16))}</span>`:`<span class="log-workspace log-workspace-unresolved" title="${escapeHtml(t("erp-log-ws-unresolved-tip"))}">${escapeHtml(t("erp-log-ws-unresolved"))}</span>`,ce=f.endpoint_name?`<span class="log-erp">${escapeHtml((f.endpoint_name||"").substring(0,14))}</span>`:`<span class="log-erp log-erp-deleted">${escapeHtml(t("erp-log-endpoint-deleted"))}</span>`,te=(f.external_doc_no||"").trim(),N=(f.external_url||"").trim();let q;return N?q=`<span class="log-doc"><a href="${escapeHtml(N)}" target="_blank" rel="noopener" class="log-doc-open" title="${escapeHtml(te||"")}">${escapeHtml(t("erp-log-doc-open"))}</a></span>`:te?q=`<span class="log-doc log-doc-copy" data-copy-doc="${escapeHtml(te)}" title="${escapeHtml(t("erp-log-doc-copy-tip"))}">${escapeHtml(te.substring(0,18))}</span>`:f.status==="success"?q=`<span class="log-doc log-doc-missing" title="${escapeHtml(t("erp-log-doc-missing-tip"))}">${escapeHtml(t("erp-log-doc-missing"))}</span>`:q='<span class="log-doc log-doc-empty">-</span>',`
        ...
        `,document.body.appendChild(f);const v=()=>f.remove();f.querySelector("#cpw-forgot-close").addEventListener("click",v),f.querySelector("#cpw-forgot-cancel").addEventListener("click",v),f.addEventListener("click",w=>{w.target===f&&v()}),f.querySelector("#cpw-forgot-send").addEventListener("click",async()=>{const w=f.querySelector("#cpw-forgot-send"),g=f.querySelector("#cpw-forgot-msg");w.disabled=!0;const b=w.textContent;w.textContent=a("cpw-forgot-sending");try{const h=await fetch("/api/auth/forgot_password",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:l})}),_=await h.json().catch(()=>({}));h.ok?(g.textContent=a("cpw-forgot-success"),g.className="cpw-forgot-msg success",w.style.display="none",f.querySelector("#cpw-forgot-cancel").textContent=a("cpw-forgot-close-btn")):(g.textContent=_.detail||a("cpw-forgot-fail"),g.className="cpw-forgot-msg error",w.disabled=!1,w.textContent=b)}catch{g.textContent=a("cpw-forgot-fail"),g.className="cpw-forgot-msg error",w.disabled=!1,w.textContent=b}})}function m(p){if(!p||!p.includes("@"))return p||"";const[l,u]=p.split("@");return l.length<=2?l+"****@"+u:l.slice(0,2)+"****@"+u}function d(p){return p==null?"":String(p).replace(/[&<>"']/g,l=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[l])}document.readyState==="complete"||document.readyState==="interactive"?r():document.addEventListener("DOMContentLoaded",r)})();(function(){let e=null,n=!1;async function a(){if(n)return;const s=localStorage.getItem("mrpilot_token");if(s){n=!0;try{const i=await fetch("/api/me",{headers:{Authorization:"Bearer "+s},cache:"no-store"});if(i.status===401){const r=await i.json().catch(()=>({})),c=r&&r.detail;let m="";if(typeof c=="string"?m=c:c&&typeof c=="object"&&(m=c.code||""),console.warn("[heartbeat] session revoked",m),localStorage.removeItem("mrpilot_token"),e&&(clearInterval(e),e=null),m==="auth.session_revoked")try{_showSessionRevokedModal()}catch{window.location.href="/"}else{const d=m==="auth.password_changed_relogin"?"alert-password-changed-relogin":"alert-session";try{typeof showToast=="function"&&typeof t=="function"?showToast(t(d),"error"):alert("Session expired")}catch{}setTimeout(()=>{window.location.href="/"},1500)}}}catch{}finally{n=!1}}}function o(){e&&clearInterval(e),e=setInterval(a,15e3)}localStorage.getItem("mrpilot_token")&&o(),window.addEventListener("focus",a),document.addEventListener("visibilitychange",function(){document.hidden||a()}),window._sessionCheck=a})();async function xn(){const e=document.getElementById("team-loading"),n=document.getElementById("team-list"),a=document.getElementById("team-empty"),o=document.getElementById("team-count");if(n){e&&(e.style.display=""),n.style.display="none",a&&(a.style.display="none");try{const s=await apiGet("/api/team/employees"),i=s&&s.employees||[];if(e&&(e.style.display="none"),o&&(o.textContent=(t("team-count")||"共 {n} 名员工").replace("{n}",i.length)),i.length===0){a&&(a.style.display="");return}n.style.display="",n.innerHTML=i.map(r=>{const c=r.last_login_at?new Date(r.last_login_at).toLocaleDateString():t("team-never-login")||"从未登录",m=r.is_active===!1?"team-status-off":"team-status-on",d=r.is_active===!1?t("team-status-disabled")||"已禁用":t("team-status-active")||"正常",p=r.email?`<span class="team-meta-sep">·</span><span>${escapeHtml(r.email)}</span>`:"";return`
            ...
            </div>`}).join("")}catch(s){console.error("loadTeamList failed:",s),e&&(e.textContent=t("team-load-failed")||"加载失败")}}}async function Dc(){document.querySelectorAll(".add-emp-overlay").forEach(o=>o.remove());const e=document.createElement("div");e.className="add-emp-overlay",e.innerHTML=`
