...
import './home/permissions.js'; // REFACTOR-C1-home-batch8 · 用户角色原子判断(从 home.js 抽出 · window 桥 isSuperAdmin/isOwner/isEmployee/isTrial/isLifetime/shouldHideMoney/canManageApiKey · 全局唯一来源 · 被多模块裸调)
...
import './home/erp-express-dbf-risk.js'; // Express · DBF 直写风险弹窗(brief P7)
...
import './home/guide-links.js'; // 教程深链 · 失败原因码→章节映射 + 「这是怎么回事」委派(须在 guide-page 后)
...
import './home/erp-stock-documents.js';
