...
`,e.dataset.wbInjected="1";try{const n=window._currentLang||localStorage.getItem("mrpilot_lang")||"th",a=window.I18N;a&&a[n]&&(e.querySelectorAll("[data-i18n]").forEach(s=>{const o=s.getAttribute("data-i18n");a[n][o]&&(s.textContent=a[n][o])}),e.querySelectorAll("[data-i18n-placeholder]").forEach(s=>{const o=s.getAttribute("data-i18n-placeholder");a[n][o]&&(s.placeholder=a[n][o])}))}catch{}}})();(function(){const e=document.getElementById("page-settings");if(!(!e||e.dataset.wbInjected==="1")){e.innerHTML=`
        ...
        <!-- /settings-layout -->
`,e.dataset.wbInjected="1";try{const n=window._currentLang||localStorage.getItem("mrpilot_lang")||"th",a=window.I18N;a&&a[n]&&(e.querySelectorAll("[data-i18n]").forEach(s=>{const o=s.getAttribute("data-i18n");a[n][o]&&(s.textContent=a[n][o])}),e.querySelectorAll("[data-i18n-placeholder]").forEach(s=>{const o=s.getAttribute("data-i18n-placeholder");a[n][o]&&(s.placeholder=a[n][o])}))}catch{}}})();const fl=`
        <div class="page-head-clean">
            <div class="page-head-icon">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
...
`,hl=`                    <!-- Tab: 邮箱抓取 (v0.17 · M6 · v93 在 Vultr 复活) -->
...
`;(function(){const e=document.getElementById("page-automation");if(!(!e||e.dataset.wbInjected==="1")){e.innerHTML=fl+hl,e.dataset.wbInjected="1";try{const n=window._currentLang||localStorage.getItem("mrpilot_lang")||"th",a=window.I18N;a&&a[n]&&(e.querySelectorAll("[data-i18n]").forEach(s=>{const o=s.getAttribute("data-i18n");o&&a[n][o]&&(s.textContent=a[n][o])}),e.querySelectorAll("[data-i18n-placeholder]").forEach(s=>{const o=s.getAttribute("data-i18n-placeholder");o&&a[n][o]&&(s.placeholder=a[n][o])}))}catch{}}})();(function(){const e={"page-integration":`
        <div class="coming-soon">
            <svg class="cs-icon" viewBox="0 0 48 48" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
...
`,e.dataset.wbInjected="1";try{const n=window._currentLang||localStorage.getItem("mrpilot_lang")||"th",a=window.I18N;a&&a[n]&&e.querySelectorAll("[data-i18n]").forEach(s=>{const o=s.getAttribute("data-i18n");a[n][o]&&(s.textContent=a[n][o])})}catch{}}})();function gl(e,n){const a=document.getElementById("alert-"+e);a&&(document.getElementById("alert-"+e+"-text").textContent=n,a.classList.add("show"))}function bl(){["info","warn","error"].forEach(e=>{document.getElementById("alert-"+e).classList.remove("show")})}function yl(e,n){if(e==null)return n||"操作失败";if(typeof e=="string")return e;if(Array.isArray(e)){const a=e[0]||{};return a.msg?a.msg:n||"请求格式错误"}if(typeof e=="object"){if(e.code){const a="err."+e.code;try{const s=t(a,e);if(s&&s!==a)return s}catch(s){console.warn("[i18n] t() failed for key:",a,s)}return e.code}if(e.message)return e.message;if(e.error)return e.error;if(e.detail&&typeof e.detail=="string")return e.detail;try{return JSON.stringify(e).slice(0,160)}catch{}}return n||String(e)}function wl(e){if(!e)return"";const n=String(e);return/ECONNREFUSED|Connection refused/i.test(n)?"连接被拒绝 · ERP 地址可能错了,或服务没启动":/listing fetch failed|wait_for_selector/i.test(n)?"拉取 MR.ERP 客户/商品列表超时 · 已重试 3 次仍不通 · 可能 MR.ERP 响应慢 · 稍后再试":/ETIMEDOUT|timeout/i.test(n)?"连接超时 · MR.ERP 响应慢 · 稍后再试":/ENOTFOUND|getaddrinfo/i.test(n)?"域名解析失败 · ERP 地址拼错了":/certificate|SSL/i.test(n)?"SSL 证书问题 · ERP 站点证书异常":/401|Unauthorized/i.test(n)?"HTTP 401 · 认证失败,检查 Token 是否正确":/403|Forbidden/i.test(n)?"HTTP 403 · 权限不足,ERP 拒绝访问":/404|Not Found/i.test(n)?"HTTP 404 · URL 路径不存在":/^5\d\d/.test(n)||/500|502|503|504/.test(n)?"ERP 服务器错误 · 不是你的问题,等会儿再试":n}function kl(e,n,a){let s=document.getElementById("mp-toast-wrap");s||(s=document.createElement("div"),s.id="mp-toast-wrap",document.body.appendChild(s)),n=n||"success",n==="ok"&&(n="success"),n==="warning"&&(n="warn"),n==="danger"&&(n="error");const o={success:'<path d="M3 8l3 3 7-7"/>',error:'<circle cx="8" cy="8" r="6"/><path d="M5.5 5.5l5 5M10.5 5.5l-5 5"/>',warn:'<path d="M8 2L1.5 13h13L8 2z"/><path d="M8 7v3M8 12v.01"/>',info:'<circle cx="8" cy="8" r="6"/><path d="M8 5.5v.01M8 8v3"/>',loading:'<path d="M8 1a7 7 0 017 7" stroke-linecap="round" class="mp-toast-spin"/>'},i=document.createElement("div");i.className="mp-toast "+n,i.innerHTML=`
    ...
    `,s.appendChild(i),requestAnimationFrame(()=>i.classList.add("show"));const r=typeof a=="number"?a:2500;let l=null;const m=()=>{l&&(clearTimeout(l),l=null),i.classList.remove("show"),setTimeout(()=>{try{i.remove()}catch{}},300)};return r>0&&(l=setTimeout(m,r)),m}window.showAlert=gl;window.hideAlerts=bl;window._humanizeBackendError=yl;window.humanizeError=wl;window.showToast=kl;function xl(e,n){return n=n||{},new Promise(a=>{const s=document.getElementById("confirm-modal"),o=document.getElementById("confirm-modal-body"),i=document.getElementById("confirm-modal-ok"),r=document.getElementById("confirm-modal-cancel"),l=document.getElementById("confirm-modal-close"),m=document.getElementById("confirm-modal-title");if(!s||!o||!i||!r){a(!1);return}m.textContent=n.title||t("confirm-default-title");const d=n.promptInput?"cm_in_"+Date.now():null;if(n.promptInput){const v=(e||"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;"),f=(n.placeholder||"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;");o.innerHTML=`
        ...
        `;const s=document.getElementById("api-key-card");s&&(s.style.display="");return}Ll(n,e);const a=document.getElementById("api-key-card");if(a){const s=tt==="byo_api"||_userInfo&&_userInfo.is_super_admin;a.style.display=s?"":"none"}}function Ll(e,n){const a=escapeHtml(e.username||e.email||"");n.innerHTML=`
        <table style="width:100%; font-size:13px; border-collapse: collapse;">
            <tr>
    ...
    `}window.switchSettingsTab=_l;window.fillSettingsForms=El;window.saveProfile=Il;window.saveCompany=Bl;window.renderSettings=za;function pa(e){return e=e||_userInfo,!!(e&&e.is_super_admin)}function cs(e){return e=e||_userInfo,!!e&&(e.role==="owner"||pa(e))}function pi(e){return e=e||_userInfo,!!e&&e.role==="member"&&!pa(e)}function $l(e){return e=e||_userInfo,!!e&&(e.effective_plan==="trial"||e.plan==="trial")&&!pa(e)}function ui(e){return e=e||_userInfo,!!e&&e.tenant_type==="byo_api"}function mi(e){return pi(e)}function Sl(e){return cs(e)}function Cl(e){return cs(e)&&ui(e)}window.isMoneyHidden=mi;window.isSuperAdmin=pa;window.isOwner=cs;window.isEmployee=pi;window.isTrial=$l;window.isLifetime=ui;window.shouldHideMoney=mi;window.canManageTeam=Sl;window.canManageApiKey=Cl;function Tl(){const e=document.getElementById("quota-banner");if(!e)return;if(!_userInfo){e.style.display="none";return}if(_userInfo.is_super_admin||_userInfo.tenant_type==="admin"||_userInfo.tenant_type==="byo_api"){e.style.display="none";return}let n=0,a=0;if(_userInfo.plan==="free"&&_quota&&_quota.ip_daily_limit)n=_quota.ip_used_today||0,a=_quota.ip_daily_limit;else if(_userInfo.tenant_quota!=null&&_userInfo.tenant_quota>0)n=_userInfo.tenant_used||0,a=_userInfo.tenant_quota;else if(_userInfo.monthly_quota&&_userInfo.monthly_quota>0)n=_userInfo.used_this_month||0,a=_userInfo.monthly_quota;else{e.style.display="none";return}if(a<=0){e.style.display="none";return}const s=Math.max(0,a-n),o=n/a*100,i="quota_banner_dismiss_"+new Date().toISOString().slice(0,10);if(localStorage.getItem(i)){e.style.display="none";return}let r,l;if(s===0)r="danger",l=t("quota-banner-exhausted");else if(o>=90)r="danger",l=t("quota-banner-very-low",{n:s});else if(o>=70)r="warn",l=t("quota-banner-low",{n:s});else{e.style.display="none";return}e.className="quota-banner "+r,e.innerHTML=`
    ...
    `,e.style.display="flex";const m=e.querySelector(".quota-banner-close");m&&m.addEventListener("click",()=>{localStorage.setItem(i,"1"),e.style.display="none"})}function Ml(){const e=_userInfo;if(!e)return;const n=shouldHideMoney(e),a=canManageTeam(e),s=canManageApiKey(e),o=document.querySelector('.nav-item[data-route="templates"]');o&&(o.classList.remove("locked-for-plan"),o.removeAttribute("data-locked-target"));const i=document.querySelector('.nav-item[data-route="api-keys"]');i&&(i.classList.remove("locked-for-plan"),i.removeAttribute("data-locked-target"));const r=document.getElementById("btn-custom-template");r&&(r.style.display="",r.classList.remove("locked-for-plan"));const l=document.querySelector('.settings-tab[data-tab="team"]');l&&(l.style.display=a?"":"none");const m=document.querySelector('.settings-panel[data-settings-panel="team"]');m&&(m.dataset.permHidden=a?"0":"1");const d=document.querySelector('.settings-tab[data-tab="api"]');d&&(d.style.display=s||isSuperAdmin(e)?"":"none");const p=document.querySelector('.settings-tab[data-tab="plan"]');p&&(p.style.display=n?"none":"");const c=document.querySelector('.settings-tab[data-tab="company"]');c&&(c.style.display=n?"none":"");const u=document.getElementById("info-bar");u&&(u.style.display=n?"none":"");const v=document.getElementById("trial-banner");v&&n&&(v.style.display="none");const f=document.getElementById("plan-banner");f&&n&&(f.style.display="none",document.body.classList.remove("has-plan-banner")),document.querySelectorAll("[data-upgrade-cta], .btn-upgrade, .topbar-upgrade").forEach(y=>{y.style.display="none"}),document.body.classList.toggle("role-employee",isEmployee(e)),document.body.classList.toggle("role-owner",isOwner(e)),document.body.classList.toggle("role-super",isSuperAdmin(e));try{const y=document.querySelector(".settings-tab.active");y&&y.style.display==="none"&&(typeof window.switchSettingsTab=="function"?window.switchSettingsTab("profile"):typeof switchSettingsTab=="function"&&switchSettingsTab("profile"))}catch(y){console.warn("[v118.12.3] failed to fix active tab:",y)}if(window.PEARNLY_ADMIN_MODE){const y=document.getElementById("admin-mode-banner");y&&(y.style.display="flex"),document.querySelectorAll(".nav-item").forEach(g=>{g.classList.contains("nav-admin-only")||(g.style.display="none")}),document.querySelectorAll(".nav-group").forEach(g=>{g.classList.contains("nav-group-admin-only")||(g.style.display="none")});const b=document.getElementById("client-switcher");b&&(b.style.display="none"),document.body.classList.add("admin-mode");const h=["profile","security","notifications","about"];document.querySelectorAll(".settings-tab").forEach(g=>{const _=g.dataset.tab;_&&!h.includes(_)&&(g.style.display="none")}),document.querySelectorAll(".settings-pane").forEach(g=>{const _=g.dataset.pane;_&&!h.includes(_)&&(g.style.display="none")}),document.querySelectorAll(".settings-nav-group").forEach(g=>{const _=g.querySelectorAll(".settings-tab");Array.from(_).some(k=>k.style.display!=="none")||(g.style.display="none")})}}function Hl(){const e=_userInfo,n=document.getElementById("info-bar");if(!e||shouldHideMoney(e)){n&&(n.innerHTML="");return}let a="";const s=e.tenant_type;if(s==="byo_api")e.has_own_gemini_key?a=`
        ...
        `;else{const o=e.tenant_used!=null?e.tenant_used:e.used_this_month||0,i=e.tenant_quota!=null&&e.tenant_quota>0?e.tenant_quota:e.monthly_quota||0,r=i>0?Math.min(100,o/i*100):0;let l="";r>=95?l="danger":r>=80&&(l="warn"),i>0?a=`
            ...
            `:a=""}n&&(n.innerHTML=a)}window.renderQuotaBanner=Tl;window.applySidebarVisibility=Ml;window.renderInfoBar=Hl;async function vi(e,n){try{const a=await fetch(e,{method:"POST",headers:{Authorization:"Bearer "+token,"Content-Type":"application/json"},body:JSON.stringify(n)});if(a.status===401){localStorage.removeItem("mrpilot_token");const s=await a.json().catch(()=>({}));return(typeof s.detail=="string"?s.detail:s.detail&&s.detail.code||"")==="auth.session_revoked"?(_showSessionRevokedModal(),null):(window.location.href="/",null)}return await a.json()}catch{return{ok:!1,error:"network"}}}function fi(e){return{invalid_format:"rd-err-format",not_found:"rd-err-not-found",rd_unreachable:"rd-err-unreachable",parse_error:"rd-err-unknown",network:"rd-err-unreachable"}[e]||"rd-err-unknown"}function Gn(e){const n=document.querySelector(`[data-field="${e}"]`);return n?(n.value||"").trim():""}function $t(e,n,a){const s=document.querySelector(`[data-rd-status="${e}"]`);s&&(s.innerHTML=n,s.className="rd-status"+(a?" "+a:""))}async function Al(e){const a=Gn(e==="seller"?"seller_tax":"buyer_tax");$t(e,t("rd-verifying"),"loading");const s=await vi("/api/rd/verify",{tax_id:a});if(!s)return;if(!s.ok){$t(e,t(fi(s.error)),"error");return}s.data&&s.data.valid?$t(e,`<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="2"><path d="M3 8l3 3 7-7"/></svg> ${escapeHtml(t("rd-status-valid"))}`,"valid"):$t(e,t("rd-status-invalid"),"invalid")}async function Pl(e){const a=Gn(e==="seller"?"seller_tax":"buyer_tax");$t(e,t("rd-syncing"),"loading");const s=await vi("/api/rd/lookup",{tax_id:a,branch:0});if(s){if(!s.ok){$t(e,t(fi(s.error)),"error");return}$t(e,`<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="2"><path d="M3 8l3 3 7-7"/></svg> ${escapeHtml(t("rd-status-valid"))}`,"valid"),jl(e,s.data)}}function jl(e,n){const a=e==="seller"?"seller_name":"buyer_name",s=e==="seller"?"seller_addr":"buyer_addr",o=Gn(a),i=Gn(s),r=[];n.name&&n.name!==o&&r.push({field:a,label:t("rd-field-name"),current:o,official:n.name}),n.address&&n.address!==i&&r.push({field:s,label:t("rd-field-address"),current:i,official:n.address});const l=[];n.branch_label&&l.push(`<strong>${t("rd-field-branch")}:</strong> ${escapeHtml(n.branch_label)}`),n.post_code&&l.push(`<strong>${t("rd-field-postcode")}:</strong> ${escapeHtml(n.post_code)}`);let m=document.getElementById("rd-sync-modal");if(m||(m=document.createElement("div"),m.id="rd-sync-modal",m.className="rd-modal-mask",document.body.appendChild(m)),r.length===0)m.innerHTML=`
            <div class="rd-modal">
    ...
    `,d=i?"":`<span class="tax-badge unverified" data-tip="${escapeHtml(t("tax-tip-unverified"))}">${t("tax-unverified")}</span>`;if(l.innerHTML=`
        ...
        <div class="drawer-section">
            ...
            ${r.wht_amount||r.wht_rate?`
                ${Se("wht_amount","drawer-lbl-wht-amount",r.wht_amount,"input",o,Fl(r.wht_rate))}
            `:""}
        </div>
...
`))}</pre>
    ...
    `,o?l.querySelectorAll("[data-field]").forEach(p=>{p.addEventListener("input",onFieldEdit)}):l.querySelectorAll("[data-field]").forEach(p=>{p.setAttribute("readonly","readonly")}),document.getElementById("drawer-mask").classList.add("show"),document.getElementById("drawer").classList.add("show"),injectOcrPushButton(),typeof window.bindDrawerClient=="function"){const p=n._historyId||n.history_id||null;window.bindDrawerClient(p,n.client_id||null)}typeof window.fillCategoryDatalist=="function"&&window.fillCategoryDatalist(),setTimeout(()=>{const p=document.getElementById("drawer-cat-input");p&&!p.value&&!p.readOnly&&p.focus()},80)}function Fl(e){return e?`<span class="wht-badge">${escapeHtml(e)}%</span>`:""}function Se(e,n,a,s,o,i,r){const l=_results[_drawerIdx],m=l&&l.edits[e]!==void 0?l.edits[e]:a,d=l&&l.edits[e]!==void 0&&l.edits[e]!==a,p=escapeHtml(m??""),c=o?"":"readonly",u=s==="textarea"?`<textarea data-field="${e}" rows="2">${p}</textarea>`:`<input type="text" data-field="${e}" value="${p}">`;return`
    ...
    `;n.innerHTML=s+o,e.appendChild(n)}function Ia(){const e=document.getElementById("export-dropdown");e&&e.remove()}const Ba=document.getElementById("btn-export-arrow");Ba&&Ba.addEventListener("click",e=>{e.stopPropagation(),!Ba.disabled&&Wl()});document.addEventListener("click",e=>{const n=e.target.closest(".export-dd-item");if(n){const a=n.getAttribute("data-tpl");if(a==="__custom"){Ia(),showToast(t("cs-coming-soon"),"info");return}Gl(a),Ia(),ki(a);return}e.target.closest("#btn-export-arrow")||Ia()});function Kl(){const e=document.getElementById("btn-export-arrow"),n=document.getElementById("btn-export");e&&n&&(e.disabled=n.disabled)}setInterval(Kl,300);const Yl=`
        <div class="page-head-clean">
            <div class="page-head-icon">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
...
`;(function(){const e=document.getElementById("page-history");if(!(!e||e.dataset.wbInjected==="1")){e.innerHTML=Yl,e.dataset.wbInjected="1";try{const n=window._currentLang||localStorage.getItem("mrpilot_lang")||"th",a=window.I18N;a&&a[n]&&(e.querySelectorAll("[data-i18n]").forEach(s=>{const o=s.getAttribute("data-i18n");a[n][o]&&(s.textContent=a[n][o])}),e.querySelectorAll("[data-i18n-placeholder]").forEach(s=>{const o=s.getAttribute("data-i18n-placeholder");a[n][o]&&(s.placeholder=a[n][o])}))}catch{}}})();function ds(){const e=document.getElementById("history-batch-bar"),n=document.getElementById("history-batch-count"),a=document.getElementById("history-check-all");if(!e||!n)return;const s=_historySelected.size;if(s>0?(e.style.display="",n.textContent=t("history-batch-count",{n:s})):e.style.display="none",a){const o=_historyState.items||[];if(o.length===0)a.checked=!1,a.indeterminate=!1;else{const i=o.filter(r=>_historySelected.has(r.id)).length;a.checked=i===o.length,a.indeterminate=i>0&&i<o.length}}}function Jl(){_historySelected.clear(),ds()}async function ps(){if(!_userInfo){setTimeout(()=>ps(),300);return}const e=document.getElementById("history-free-block"),n=document.getElementById("history-main"),a=document.getElementById("history-empty");if(!e||!n||!a){console.warn("[History] container missing");return}if(!_userInfo.can_view_history){e.style.display="",n.style.display="none",a.style.display="none";return}e.style.display="none",_historyState.loading=!0;try{const s=_historyState.page*_historyState.pageSize,o=new URLSearchParams({limit:_historyState.pageSize,offset:s});_historyState.keyword&&o.set("keyword",_historyState.keyword);const i=typeof window.getCurrentClientId=="function"?window.getCurrentClientId():null;i&&o.set("client_id",String(i));const r=await fetch(`/api/history?${o}`,{headers:{Authorization:"Bearer "+token}});if(r.status===401){localStorage.removeItem("mrpilot_token");const d=await r.json().catch(()=>({}));if((typeof d.detail=="string"?d.detail:d.detail&&d.detail.code||"")==="auth.session_revoked"){_showSessionRevokedModal();return}window.location.href="/";return}const l=await r.json();_historyState.items=l.items||[],_historyState.total=l.total||0;const m=new Set(_historyState.items.map(d=>d.id));for(const d of Array.from(_historySelected))m.has(d)||_historySelected.delete(d);xi()}catch(s){console.error("load history failed",s)}finally{_historyState.loading=!1}}function xi(){const e=document.getElementById("history-main"),n=document.getElementById("history-empty"),a=_historyState.items,s=document.getElementById("history-search-matches");if(s&&(s.textContent=_historyState.keyword?t("search-matches",{n:_historyState.total}):""),a.length===0&&_historyState.total===0&&!_historyState.keyword){e.style.display="none",n.style.display="";return}e.style.display="",n.style.display="none";let o=0;a.forEach(d=>{d.confidence==="high"&&o++});const i=a.length>0?Math.round(o/a.length*100):0;document.getElementById("history-stats").innerHTML=`
    ...
    `;const r=document.getElementById("history-tbody");a.length===0?r.innerHTML=`<div class="history-row-empty">${escapeHtml(t("history-empty-title"))}</div>`:r.innerHTML=a.map(d=>{const p=new Date(d.created_at),c=String(p.getMonth()+1).padStart(2,"0"),u=String(p.getDate()).padStart(2,"0"),v=String(p.getHours()).padStart(2,"0"),f=String(p.getMinutes()).padStart(2,"0"),y=`${c}-${u} ${v}:${f}`,b=escapeHtml(d.filename||""),h=b.length>50?b.substring(0,50)+"…":b,g=d.invoice_no?escapeHtml(d.invoice_no):h,_=[];d.seller_name&&_.push(escapeHtml(d.seller_name)),d.invoice_no&&d.filename&&_.push(h);const w=_.join(" · ")||"-",k=d.category_tag?`<span class="history-badge category">${escapeHtml(d.category_tag)}</span>`:"",x=d.source_total&&d.source_total>1?`<span class="history-badge multi">${escapeHtml(t("invoice-part-of",{i:d.source_index||1,n:d.source_total}))}</span>`:"",E=d.total_amount!==null&&d.total_amount!==void 0?Number(d.total_amount).toLocaleString(void 0,{minimumFractionDigits:2,maximumFractionDigits:2}):'<span class="history-cell-amount-empty">—</span>',I=[];(d.total_amount===null||d.total_amount===void 0)&&I.push(t("field-amount")),d.invoice_no||I.push(t("field-invoice-no")),d.invoice_date||I.push(t("field-invoice-date")),d.seller_name||I.push(t("field-seller-name")),I.length>0&&`${escapeHtml(d.id)}${escapeHtml(t("history-needs-review-tip")+" · "+I.join(" · "))}${escapeHtml(t("history-needs-review-tip"))}${svgIcon("alert",14)}`,d.edited&&`${escapeHtml(t("history-edited",{n:d.edit_count||1}))}`;const B=d.smart_assigned_flag?`<span class="history-badge smart-assigned" title="${escapeHtml(t("history-smart-assigned"))}">${svgIcon("sparkle",11)}</span>`:"",L=d.confidence==="high"?"high":d.confidence==="medium"?"mid":"low",$=d.confidence==="high"?t("conf-high"):d.confidence==="medium"?t("conf-medium"):t("conf-low"),S=`<span class="history-badge conf-${L}">${escapeHtml($)}</span>`;let M="";const R=d.source||"manual";return R==="email"?M=`<span class="history-badge source source-email" title="${escapeHtml(t("history-source-email"))}">${svgIcon("mail",11)}<span>${escapeHtml(t("history-source-email"))}</span></span>`:R==="folder"?M=`<span class="history-badge source source-folder" title="${escapeHtml(t("history-source-folder"))}">${svgIcon("folder",11)}<span>${escapeHtml(t("history-source-folder"))}</span></span>`:R==="api"&&(M=`<span class="history-badge source source-api" title="${escapeHtml(t("history-source-api"))}">${svgIcon("api",11)}<span>${escapeHtml(t("history-source-api"))}</span></span>`),`
            ...
            `}).join(""),ds();const l=a.length>0?_historyState.page*_historyState.pageSize+1:0,m=_historyState.page*_historyState.pageSize+a.length;document.getElementById("history-pager-info").textContent=t("history-pager",{from:l,to:m,total:_historyState.total}),document.getElementById("history-prev").disabled=_historyState.page===0,document.getElementById("history-next").disabled=(_historyState.page+1)*_historyState.pageSize>=_historyState.total}window.loadHistoryPage=ps;window.renderHistoryList=xi;window.updateHistoryBatchBar=ds;window.clearHistorySelection=Jl;typeof currentRoute<"u"&&currentRoute==="history"&&ps();async function Wn(e){try{const n=await fetch(`/api/history/${encodeURIComponent(e)}`,{headers:{Authorization:"Bearer "+token}});if(!n.ok)return;const a=await n.json(),s=mergeFields(a.pages||[]),o={filename:a.filename,pages:a.pages,page_count:a.page_count,elapsed_ms:a.elapsed_ms,engine:"history",merged_fields:s,edits:{},confidence:a.confidence,archive_name:a.archive_name||null,category_tag:a.category_tag||null,_historyId:a.id,_historyMode:!0,client_id:a.client_id||null};_results.push(o),_drawerIdx=_results.length-1,openDrawer(_drawerIdx),Zl(),typeof window.bindDrawerClient=="function"&&window.bindDrawerClient(a.id,a.client_id||null),Ql(a.id)}catch(n){console.error("open history detail failed",n)}}async function Xl(e){await Wn(e),requestAnimationFrame(()=>{const n=document.querySelector('[data-field="total_amount"]');if(n){try{n.focus()}catch{}try{n.select()}catch{}try{n.scrollIntoView({block:"center",behavior:"smooth"})}catch{}}})}function Zl(){const e=document.getElementById("drawer-body");if(!e||document.getElementById("drawer-history-save"))return;const n=document.createElement("div");n.id="drawer-history-save",n.className="drawer-history-save-bar",n.innerHTML=`
    ...
    `,e.appendChild(n),document.getElementById("btn-save-history").addEventListener("click",tc),document.getElementById("btn-push-erp").addEventListener("click",ec)}async function Ql(e){}async function ec(){showToast(t("erp-push-coming-soon")||"ERP 推送即将开放，敬请期待","info")}async function tc(){const e=_results[_drawerIdx];if(!e||!e._historyId)return;const n=JSON.parse(JSON.stringify(e.pages||[]));if(n.length>0){const s=n.findIndex(l=>!l.is_duplicate&&!l.is_copy),o=s>=0?s:0,i=n[o].fields||(n[o].fields={}),r={...e.edits};r.category_tag!==void 0&&(r.category=r.category_tag,delete r.category_tag),Object.assign(i,r)}const a=document.getElementById("btn-save-history");a&&(a.disabled=!0);try{if(!(await fetch(`/api/history/${encodeURIComponent(e._historyId)}`,{method:"PUT",headers:{Authorization:"Bearer "+token,"Content-Type":"application/json"},body:JSON.stringify({pages:n})})).ok)throw new Error("save failed");showAlert("info",t("history-save-ok")),setTimeout(hideAlerts,1500),closeDrawer(),e._historyMode&&_results.pop(),loadHistoryPage()}catch{showAlert("error",t("history-save-fail")),a&&(a.disabled=!1)}}function nc(e,n){document.querySelectorAll(".history-popover").forEach(d=>d.remove());const a=n.getBoundingClientRect(),s=(_historyState.items||[]).find(d=>d.id===e),o=s&&s.invoice_no?String(s.invoice_no):"",i=s&&s.has_pdf===!0,r=document.createElement("div");r.className="history-popover",r.innerHTML=`
...
`,e.dataset.wbInjected="1";try{const n=window._currentLang||localStorage.getItem("mrpilot_lang")||"th",a=window.I18N;a&&a[n]&&(e.querySelectorAll("[data-i18n]").forEach(s=>{const o=s.getAttribute("data-i18n");o&&a[n][o]&&(s.textContent=a[n][o])}),e.querySelectorAll("[data-i18n-placeholder]").forEach(s=>{const o=s.getAttribute("data-i18n-placeholder");o&&a[n][o]&&(s.placeholder=a[n][o])}))}catch{}}})();(function(){const e=document.getElementById("archive-token-modal");if(!(!e||e.dataset.wbInjected==="1")){e.innerHTML=`
    ...
    `;$e("email-modal",Ac);const F={account:null,presets:null,modalMode:"new",loaded:!1,triggering:!1,autoRefreshTimer:null};function ro(e){F.modalMode=e;const n=document.getElementById("email-modal");if(!n)return;const a=document.getElementById("email-preset");a.innerHTML="";const s=F.presets||{},o=["gmail","outlook","yahoo","icloud","qq","163","custom"],i={gmail:"Gmail",outlook:"Outlook / Office365",yahoo:"Yahoo Mail",icloud:"iCloud",qq:"QQ 邮箱",163:"网易 163"};o.forEach(h=>{if(!s[h])return;const g=document.createElement("option");g.value=h,g.textContent=h==="custom"?t("email-preset-custom"):i[h]||h,a.appendChild(g)});const r=document.getElementById("email-modal-title"),l=document.getElementById("email-address"),m=document.getElementById("email-password"),d=document.getElementById("email-imap-host"),p=document.getElementById("email-imap-port"),c=document.getElementById("email-imap-ssl"),u=document.getElementById("email-folder"),v=document.getElementById("email-mark-read"),f=document.getElementById("email-bind-enabled"),y=document.getElementById("email-test-result"),b=document.getElementById("email-adv-details");if(y&&(y.style.display="none",y.textContent=""),e==="edit"&&F.account){r.setAttribute("data-i18n","email-modal-title-edit"),r.textContent=t("email-modal-title-edit"),l.value=F.account.email_address||"",m.value="",m.setAttribute("data-i18n-placeholder","email-field-password-edit-ph"),m.placeholder=t("email-field-password-edit-ph"),d.value=F.account.imap_host||"",p.value=F.account.imap_port||993,c.checked=F.account.imap_use_ssl!==!1,u.value=F.account.folder||"INBOX",v.checked=F.account.mark_as_read!==!1,f.checked=F.account.enabled!==!1;const h=document.getElementById("email-filter-sender"),g=document.getElementById("email-filter-subject");h&&(h.value=F.account.filter_sender||""),g&&(g.value=F.account.filter_subject||""),co(F.account.interval_min||15),a.value=jc(F.account.imap_host)||"custom",b&&(b.open=!0)}else{r.setAttribute("data-i18n","email-modal-title-new"),r.textContent=t("email-modal-title-new"),l.value="",m.value="",m.setAttribute("data-i18n-placeholder","email-field-password-ph"),m.placeholder=t("email-field-password-ph"),a.value="gmail",ws("gmail"),u.value="INBOX",v.checked=!0,f.checked=!0;const h=document.getElementById("email-filter-sender"),g=document.getElementById("email-filter-subject");h&&(h.value=""),g&&(g.value=""),co(15),b&&(b.open=!1)}Dc(),n.style.display="flex",setTimeout(()=>l.focus(),60)}function $a(){const e=document.getElementById("email-modal");e&&(e.style.display="none")}function ws(e){const n=(F.presets||{})[e];if(!n||e==="custom")return;const a=document.getElementById("email-imap-host"),s=document.getElementById("email-imap-port"),o=document.getElementById("email-imap-ssl");a&&(a.value=n.host||""),s&&(s.value=n.port||993),o&&(o.checked=n.ssl!==!1)}const Pc={"gmail.com":"gmail","googlemail.com":"gmail","outlook.com":"outlook","hotmail.com":"outlook","live.com":"outlook","office365.com":"outlook","msn.com":"outlook","yahoo.com":"yahoo","yahoo.co.jp":"yahoo","icloud.com":"icloud","me.com":"icloud","mac.com":"icloud","qq.com":"qq","foxmail.com":"qq","163.com":"163","126.com":"163","yeah.net":"163"};function lo(e){if(!e||!e.includes("@"))return;const n=e.split("@")[1].toLowerCase().trim(),a=Pc[n];if(!a)return;const s=document.getElementById("email-preset");if(!s)return;const o=s.value;o&&o!=="custom"&&o!==""&&o===a||(s.value=a,ws(a))}function jc(e){if(!e)return null;const n=F.presets||{};for(const a in n)if(a!=="custom"&&n[a]&&n[a].host===e)return a;return null}function Ai(){const e=document.querySelector("#email-interval-options .email-interval-btn.active"),n=e?parseInt(e.dataset.interval,10):15;return{email_address:(document.getElementById("email-address").value||"").trim(),password:document.getElementById("email-password").value||"",imap_host:(document.getElementById("email-imap-host").value||"").trim(),imap_port:parseInt(document.getElementById("email-imap-port").value||"993",10)||993,imap_use_ssl:document.getElementById("email-imap-ssl").checked,folder:(document.getElementById("email-folder").value||"INBOX").trim()||"INBOX",mark_as_read:document.getElementById("email-mark-read").checked,enabled:document.getElementById("email-bind-enabled").checked,interval_min:[5,15,60].includes(n)?n:15,filter_sender:(document.getElementById("email-filter-sender").value||"").trim()||null,filter_subject:(document.getElementById("email-filter-subject").value||"").trim()||null}}function Dc(){const e=document.getElementById("email-interval-options");!e||e._bound||(e._bound=!0,e.addEventListener("click",n=>{const a=n.target.closest(".email-interval-btn");a&&(e.querySelectorAll(".email-interval-btn").forEach(s=>s.classList.remove("active")),a.classList.add("active"))}))}function co(e){const n=[5,15,60].includes(e)?e:15,a=document.getElementById("email-interval-options");a&&a.querySelectorAll(".email-interval-btn").forEach(s=>{s.classList.toggle("active",parseInt(s.dataset.interval,10)===n)})}function Ce(e,n){const a=document.getElementById("email-test-result");a&&(a.style.display="",a.textContent=n,a.className="form-test-result "+(e==="ok"?"ok":e==="running"?"running":"fail"))}async function qc(){const e=Ai();if(!e.email_address){Ce("fail",t("email-addr-required"));return}if(!e.password){Ce("fail",t("email-password-required"));return}if(!e.imap_host){Ce("fail",t("email-host-required"));return}const n=document.getElementById("btn-email-modal-test");n&&(n.disabled=!0),Ce("running",t("email-test-running"));try{const a=await fetch("/api/email-ingest/test",{method:"POST",headers:{Authorization:"Bearer "+token,"Content-Type":"application/json"},body:JSON.stringify({email_address:e.email_address,password:e.password,imap_host:e.imap_host,imap_port:e.imap_port,imap_use_ssl:e.imap_use_ssl,folder:e.folder})}),s=await a.json().catch(()=>({}));if(a.ok&&s.success)Ce("ok",t("email-test-ok",{folder:e.folder,n:s.folder_count??"?"}));else{const o=s.error_msg||"";o==="auth_failed"||/auth/i.test(o)?Ce("fail",t("email-test-auth-fail")):Ce("fail",t("email-test-fail",{msg:o||a.status}))}}catch(a){Ce("fail",t("email-test-fail",{msg:String(a).slice(0,120)}))}finally{n&&(n.disabled=!1)}}(function(){async function e(){const u=document.getElementById("email-empty"),v=document.getElementById("email-account-card");if(document.getElementById("email-logs-section"),!(!u||!v))try{const f=await fetch("/api/email-ingest/account",{headers:{Authorization:"Bearer "+token}});if(f.status===401){localStorage.removeItem("mrpilot_token");const b=await f.json().catch(()=>({}));if((typeof b.detail=="string"?b.detail:b.detail&&b.detail.code||"")==="auth.session_revoked"){_showSessionRevokedModal();return}window.location.href="/";return}if(!f.ok){a("none");return}const y=await f.json();F.account=y.account||null,F.presets=y.presets||{},F.loaded=!0,n(),F.account&&d()}catch(f){console.error("[email-ingest] load failed",f),a("none")}}function n(){const u=document.getElementById("email-empty"),v=document.getElementById("email-account-card"),f=document.getElementById("email-logs-section");if(!F.account){u.style.display="",v.style.display="none",f&&(f.style.display="none"),a("none");return}u.style.display="none",v.style.display="",f&&(f.style.display="");const y=document.getElementById("email-account-addr"),b=document.getElementById("email-account-host"),h=document.getElementById("email-account-last"),g=document.getElementById("email-last-error"),_=document.getElementById("email-enabled-toggle");if(y&&(y.textContent=F.account.email_address||"-"),b&&(b.textContent=`${F.account.imap_host||"-"}:${F.account.imap_port||993}`),h){const w=F.account.last_fetched_at;if(!w)h.textContent=t("email-last-never");else{const k=s(w),x=!F.account.last_error;h.textContent=x?t("email-last-ok",{time:k}):t("email-last-fail",{time:k})}}g&&(F.account.last_error?(g.style.display="",g.textContent=o(F.account.last_error)):g.style.display="none"),_&&(_.checked=!!F.account.enabled),F.account.enabled?F.account.last_error?a("error"):a("on"):a("off")}function a(u){const v=document.getElementById("email-status-summary");if(!v)return;v.classList.remove("none","ready","active","coming");let f="auto-status-loading";u==="none"?(f="email-status-none",v.classList.add("none")):u==="on"?(f="email-status-on",v.classList.add("active")):u==="off"?(f="email-status-off",v.classList.add("coming")):u==="error"&&(f="email-status-error",v.classList.add("none")),v.setAttribute("data-i18n",f),v.textContent=t(f)}function s(u){if(!u)return"";const v=new Date(u);if(isNaN(v.getTime()))return"";const f=y=>String(y).padStart(2,"0");return`${f(v.getMonth()+1)}-${f(v.getDate())} ${f(v.getHours())}:${f(v.getMinutes())}`}function o(u){if(!u)return"";const v=String(u);return/auth|AUTHENTICATIONFAILED|invalid credentials/i.test(v)?t("email-test-auth-fail"):/timeout|timed out/i.test(v)?t("email.timeout"):(/ENOTFOUND|getaddrinfo/i.test(v),v)}async function i(){const u=Ai();if(!u.email_address){Ce("fail",t("email-addr-required"));return}if(F.modalMode==="new"&&!u.password){Ce("fail",t("email-password-required"));return}if(!u.imap_host){Ce("fail",t("email-host-required"));return}const v=document.getElementById("btn-email-modal-save");v&&(v.disabled=!0);const f={...u};F.modalMode==="edit"&&!f.password&&delete f.password;try{const y=await fetch("/api/email-ingest/account",{method:"PUT",headers:{Authorization:"Bearer "+token,"Content-Type":"application/json"},body:JSON.stringify(f)}),b=await y.json().catch(()=>({}));if(y.ok&&b.ok)F.account=b.account,showToast(t("email-save-ok"),"success"),$a(),n(),d();else{const g="email."+(b.detail||"").split(".").slice(-1)[0];Ce("fail",t(g)!==g?t(g):t("email-save-fail"))}}catch{Ce("fail",t("email-save-fail"))}finally{v&&(v.disabled=!1)}}async function r(){if(!(!F.account||!await showConfirm(t("email-unbind-confirm",{email:F.account.email_address}),{danger:!0,okText:t("email-btn-unbind")})))try{if((await fetch("/api/email-ingest/account",{method:"DELETE",headers:{Authorization:"Bearer "+token}})).ok){F.account=null,showToast(t("email-unbind-ok"),"success"),n();const f=document.getElementById("email-logs-list");f&&(f.innerHTML="")}else showToast(t("email-unbind-fail"),"error")}catch{showToast(t("email-unbind-fail"),"error")}}async function l(){if(!F.account||F.triggering)return;if(!F.account.enabled){showToast(t("email.disabled"),"error");return}F.triggering=!0;const u=document.getElementById("btn-email-trigger"),v=u?u.innerHTML:"";u&&(u.disabled=!0,u.innerHTML=`<span>${escapeHtml(t("email-trigger-running"))}</span>`);try{const f=await fetch("/api/email-ingest/trigger",{method:"POST",headers:{Authorization:"Bearer "+token}}),y=await f.json().catch(()=>({}));if(f.ok){const b=y.emails_scanned||0,h=y.ocr_succeeded||0,g=y.ocr_failed||0;b===0&&h===0&&g===0?showToast(t("email-trigger-empty"),"success"):showToast(t("email-trigger-result",{scanned:b,ok:h,fail:g}),g>0?"warn":"success")}else{const h="email."+(y.detail||"").split(".").slice(-1)[0];showToast(t(h)!==h?t(h):t("email-trigger-fail"),"error")}await e()}catch{showToast(t("email-trigger-fail"),"error")}finally{F.triggering=!1,u&&(u.disabled=!1,u.innerHTML=v)}}async function m(){if(!F.account)return;const u=document.getElementById("email-enabled-toggle"),v=!!(u&&u.checked),f=F.account.enabled;try{const y=await fetch("/api/email-ingest/account",{method:"PUT",headers:{Authorization:"Bearer "+token,"Content-Type":"application/json"},body:JSON.stringify({email_address:F.account.email_address,imap_host:F.account.imap_host,imap_port:F.account.imap_port,imap_use_ssl:F.account.imap_use_ssl,folder:F.account.folder||"INBOX",filter_subject:F.account.filter_subject||null,filter_sender:F.account.filter_sender||null,mark_as_read:F.account.mark_as_read!==!1,enabled:v})}),b=await y.json().catch(()=>({}));y.ok&&b.ok?(F.account=b.account,n()):(u&&(u.checked=f),showToast(t("email-toggle-fail"),"error"))}catch{u&&(u.checked=f),showToast(t("email-toggle-fail"),"error")}}async function d(){const u=document.getElementById("email-logs-list");if(u){u.innerHTML=`<div class="erp-logs-empty">${escapeHtml(t("erp-logs-loading"))}</div>`;try{const v=await fetch("/api/email-ingest/logs?limit=20",{headers:{Authorization:"Bearer "+token}});if(!v.ok){u.innerHTML=`<div class="erp-logs-empty">${escapeHtml(t("erp-logs-error"))}</div>`;return}const f=await v.json();if(!Array.isArray(f)||f.length===0){u.innerHTML=`<div class="erp-logs-empty">${escapeHtml(t("email-logs-empty"))}</div>`;return}u.innerHTML=f.map(p).join("")}catch{u.innerHTML=`<div class="erp-logs-empty">${escapeHtml(t("erp-logs-error"))}</div>`}}}function p(u){const v=s(u.created_at),f=u.status||"failed",y=f==="success"?"ok":f==="partial"?"partial":"fail",b=f==="success"?"✓":f==="partial"?"◐":"✗",h=u.trigger==="manual"?`<span class="log-tag manual">${escapeHtml(t("email-log-tag-manual"))}</span>`:`<span class="log-tag auto">${escapeHtml(t("email-log-tag-auto"))}</span>`,g=t("email-log-counts",{scanned:u.emails_scanned||0,att:u.attachments_found||0,ok:u.ocr_succeeded||0,fail:u.ocr_failed||0}),_=(u.elapsed_ms||0)+"ms";return`
        ...
        `}function c(){const u=document.getElementById("btn-email-bind");u&&u.addEventListener("click",()=>ro("new"));const v=document.getElementById("btn-email-edit");v&&v.addEventListener("click",()=>ro("edit"));const f=document.getElementById("btn-email-unbind");f&&f.addEventListener("click",r);const y=document.getElementById("btn-email-trigger");y&&y.addEventListener("click",l);const b=document.getElementById("email-enabled-toggle");b&&b.addEventListener("change",m);const h=document.getElementById("email-modal-close");h&&h.addEventListener("click",$a);const g=document.getElementById("btn-email-modal-cancel");g&&g.addEventListener("click",$a);const _=document.getElementById("btn-email-modal-test");_&&_.addEventListener("click",qc);const w=document.getElementById("btn-email-modal-save");w&&w.addEventListener("click",i);const k=document.getElementById("email-preset");k&&k.addEventListener("change",I=>ws(I.target.value));const x=document.getElementById("email-address");x&&!x.dataset.autoBound&&(x.dataset.autoBound="1",x.addEventListener("blur",I=>lo((I.target.value||"").trim())),x.addEventListener("input",I=>{const B=(I.target.value||"").trim();B.includes("@")&&B.split("@")[1].includes(".")&&lo(B)}));const E=document.getElementById("btn-email-refresh-logs");E&&E.addEventListener("click",()=>{E.classList.add("spinning"),setTimeout(()=>E.classList.remove("spinning"),600),d()})}c(),window._loadEmailIngestPanel=e,window._rerenderEmailIngest=function(){if(!F.loaded)return;n();const u=document.getElementById("email-logs-section");F.account&&u&&u.open&&d()},window._startEmailLogAutoRefresh=function(){F.autoRefreshTimer||(F.autoRefreshTimer=setInterval(()=>{F.account&&F.loaded&&d()},3e4))},window._stopEmailLogAutoRefresh=function(){F.autoRefreshTimer&&(clearInterval(F.autoRefreshTimer),F.autoRefreshTimer=null)}})();const Rc=`
...
`;$e("bank-cand-drawer",Rc);const Fc=`
    <div class="modal" style="max-width: 420px;">
        <div class="modal-head">
...
`;$e("bank-client-picker-modal",Fc);const H={sessions:[],currentSession:null,currentTxs:[],currentFilter:"all",currentTxForDrawer:null,loaded:!1,queue:[],qSeq:0,sessionFilter:"all",pickerSelected:null};function zc(e){const n=Number(e||0);let a="score-low";return n>=85?a="score-high":n>=60&&(a="score-mid"),'<span class="bank-cand-score '+a+'">'+n.toFixed(0)+" "+t("bank-cand-score-unit")+"</span>"}function Nc(e){const n=document.getElementById("bank-upload-progress");n&&(n.style.display="none")}function Oc(){const e=document.getElementById("bank-upload-error");e&&(e.style.display="none")}function Vc(e){return{"bank_recon.only_pdf":t("bank-err-only-pdf"),"bank_recon.empty_file":t("bank-err-empty"),"bank_recon.file_too_large":t("bank-err-too-large"),"bank_recon.save_failed":t("bank-err-server"),"bank_recon.scanned":t("bank-err-scanned"),"bank_recon.no_tx":t("bank-err-no-tx"),network:t("bank-err-network")}[e]||t("bank-err-unknown")+" ("+e+")"}function Ct(e){if(e==null)return"-";const n=Number(e);return isNaN(n)?"-":n.toLocaleString("en-US",{minimumFractionDigits:2,maximumFractionDigits:2})}function Kt(e){if(!e)return"-";const n=String(e);return n.length>=10?n.slice(0,10):n}function Pi(e,n){return!e&&!n?"":(Kt(e)||"?")+" ~ "+(Kt(n)||"?")}function X(e){return e==null?"":String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}async function Uc(e){H.currentTxForDrawer=e;const n=document.getElementById("bank-detail-body");n&&n.classList.add("has-pane");const a=document.getElementById("bank-cand-pane-title"),s=document.getElementById("bank-cand-pane-sub"),o=document.getElementById("bank-cand-pane-foot");if(a&&(a.textContent=t("bank-cand-pane-current")),s){const r=e.direction==="OUT"?"-":"+",l=e.direction==="OUT"?"bank-out":"bank-in";s.innerHTML=`${X(Kt(e.tx_date))}
    ...
    `}function td(e){if(e.parse_status==="parse_failed")return`<span class="bank-session-count cnt-failed">${t("bank-count-parse-failed")}</span>`;if(e.parse_status!=="parsed")return`<span class="bank-session-count">${t("bank-count-parsing")}</span>`;const n=e.tx_count||0,a=e.matched_count||0,s=e.unmatched_count||0,o=[`<span class="bank-session-count">${n} ${t("bank-count-tx")}</span>`];return a>0&&o.push(`<span class="bank-session-count cnt-matched">${a} ${t("bank-count-matched")}</span>`),s>0&&o.push(`<span class="bank-session-count cnt-unmatched">${s} ${t("bank-count-unmatched")}</span>`),o.join("")}function nd(){document.getElementById("bank-detail").style.display="",document.querySelector(".bank-sessions-section").style.display="none",ji(),ks(),xs()}function _s(){document.getElementById("bank-detail").style.display="none",document.querySelector(".bank-sessions-section").style.display="";const e=document.getElementById("bank-detail-body");e&&e.classList.remove("has-pane"),H.currentTxForDrawer=null}const ad=3;function sd(){return H.qSeq+=1,"q"+H.qSeq+"_"+Date.now()}async function od(e){const n=Array.from(e.target.files||[]);if(e.target.value="",n.length!==0){for(const a of n){const s={id:sd(),file:a,name:a.name,size:a.size,status:"pending",progress:0,error_code:null,tx_count:0,session_id:null};a.name.toLowerCase().endsWith(".pdf")?a.size>20*1024*1024&&(s.status="failed",s.error_code="bank_recon.file_too_large"):(s.status="failed",s.error_code="bank_recon.only_pdf"),H.queue.push(s)}id(),je(),Es()}}function id(){const e=document.getElementById("bank-upload-queue");e&&(e.style.display=""),Nc(),Oc()}function je(){const e=document.getElementById("bank-upload-queue-list"),n=document.getElementById("bank-upload-queue-summary");if(!e)return;if(H.queue.length===0){e.innerHTML="",n&&(n.textContent="");const r=document.getElementById("bank-upload-queue");r&&(r.style.display="none");return}let a=0,s=0,o=0,i=0;for(const r of H.queue)r.status==="ok"?a++:r.status==="failed"?s++:r.status==="uploading"||r.status==="parsing"?o++:i++;n&&(n.textContent=t("bank-queue-summary").replace("{ok}",a).replace("{run}",o).replace("{wait}",i).replace("{fail}",s)),e.innerHTML=H.queue.map(rd).join(""),e.querySelectorAll("[data-q-act]").forEach(r=>{const l=r.dataset.qAct,m=r.dataset.qId;r.addEventListener("click",()=>{l==="retry"&&ld(m),l==="remove"&&cd(m)})})}function rd(e){const n=(e.size/1024).toFixed(0)+" KB";let a="",s="";if(e.status==="pending")a='<span class="bq-stat bq-wait">'+t("bank-queue-status-wait")+"</span>",s='<button data-q-act="remove" data-q-id="'+X(e.id)+'" class="bq-act">×</button>';else if(e.status==="uploading")a='<span class="bq-stat bq-run">'+t("bank-queue-status-uploading")+'</span><div class="bq-bar"><div class="bq-bar-fill" style="width:'+(e.progress||0)+'%"></div></div>';else if(e.status==="parsing")a='<span class="bq-stat bq-run">'+t("bank-queue-status-parsing")+'</span><div class="bq-bar"><div class="bq-bar-fill bq-bar-indet"></div></div>';else if(e.status==="ok")a='<span class="bq-stat bq-ok">'+t("bank-queue-status-ok").replace("{n}",e.tx_count||0)+"</span>",s='<button data-q-act="remove" data-q-id="'+X(e.id)+'" class="bq-act">×</button>';else if(e.status==="failed"){const o=Vc(e.error_code||"unknown");a='<span class="bq-stat bq-fail" title="'+X(o)+'">'+X(o)+"</span>",s='<button data-q-act="retry" data-q-id="'+X(e.id)+'" class="bq-act bq-act-retry">'+t("bank-queue-retry")+'</button><button data-q-act="remove" data-q-id="'+X(e.id)+'" class="bq-act">×</button>'}return'<div class="bq-row" data-q-row="'+X(e.id)+'"><div class="bq-name" title="'+X(e.name)+'">'+X(e.name)+'</div><div class="bq-size">'+n+'</div><div class="bq-status">'+a+'</div><div class="bq-actions">'+s+"</div></div>"}function ld(e){const n=H.queue.find(a=>a.id===e);n&&(n.status="pending",n.error_code=null,n.progress=0,je(),Es())}function cd(e){const n=H.queue.findIndex(s=>s.id===e);if(n<0)return;const a=H.queue[n];a.status==="uploading"||a.status==="parsing"||(H.queue.splice(n,1),je())}function dd(){H.queue=H.queue.filter(e=>e.status!=="ok"),je()}async function Es(){for(;;){if(H.queue.filter(a=>a.status==="uploading"||a.status==="parsing").length>=ad)return;const n=H.queue.find(a=>a.status==="pending");if(!n){H.queue.every(a=>a.status==="ok"||a.status==="failed")&&(await Qt(),typeof window.loadReconcilePage=="function"&&window.loadReconcilePage());return}pd(n).then(()=>Es())}}async function pd(e){e.status="uploading",e.progress=0,je();try{const n=new FormData;n.append("file",e.file,e.name);const a=await new Promise((o,i)=>{const r=new XMLHttpRequest;r.open("POST","/api/bank-recon/upload"),r.setRequestHeader("Authorization","Bearer "+token),r.upload.onprogress=l=>{l.lengthComputable&&(e.progress=Math.min(99,Math.round(l.loaded/l.total*100)),je())},r.upload.onload=()=>{e.status="parsing",je()},r.onload=()=>{r.status>=200&&r.status<300?o({status:r.status,text:r.responseText}):o({status:r.status,text:r.responseText})},r.onerror=()=>i(new Error("network")),r.send(n)});let s={};try{s=JSON.parse(a.text||"{}")}catch{s={}}if(a.status>=400){e.status="failed",e.error_code=s&&s.detail||"unknown",je();return}if(s.parse_status==="parse_failed"){e.status="failed",e.error_code=s.error==="scanned_pdf_not_yet"?"bank_recon.scanned":"bank_recon.no_tx",je();return}e.status="ok",e.tx_count=s.tx_count||0,e.session_id=s.session_id||null,je()}catch(n){console.warn("[bank-recon] upload failed",n),e.status="failed",e.error_code="network",je()}}async function Fi(){if(H.loaded){uo();return}H.loaded=!0,ud(),await Qt(),uo()}function ud(){const e=document.getElementById("bank-file-input");e&&!e._bound&&(e._bound=!0,e.addEventListener("change",od));const n=document.getElementById("btn-bank-queue-clear-done");n&&!n._bound&&(n._bound=!0,n.addEventListener("click",dd));const a=document.getElementById("btn-bank-back");a&&!a._bound&&(a._bound=!0,a.addEventListener("click",()=>{H.currentSession=null,H.currentTxs=[],_s()}));const s=document.getElementById("btn-bank-delete");s&&!s._bound&&(s._bound=!0,s.addEventListener("click",Yc));const o=document.getElementById("btn-bank-run-match");o&&!o._bound&&(o._bound=!0,o.addEventListener("click",Kc)),document.querySelectorAll(".bank-filter-btn").forEach(p=>{p._bound||(p._bound=!0,p.addEventListener("click",()=>{H.currentFilter=p.dataset.bankFilter||"all",document.querySelectorAll(".bank-filter-btn").forEach(c=>{c.classList.toggle("active",c===p)}),ks()}))}),document.querySelectorAll("[data-bank-cand-close]").forEach(p=>{p._bound||(p._bound=!0,p.addEventListener("click",kn))});const i=document.getElementById("btn-bank-cand-pane-close");i&&!i._bound&&(i._bound=!0,i.addEventListener("click",kn));const r=document.getElementById("btn-bank-cand-ignore");r&&!r._bound&&(r._bound=!0,r.addEventListener("click",po));const l=document.getElementById("btn-bank-cand-ignore-pane");l&&!l._bound&&(l._bound=!0,l.addEventListener("click",po));const m=document.getElementById("bank-client-badge");m&&!m._bound&&(m._bound=!0,m.addEventListener("click",Zc)),document.querySelectorAll("[data-bank-client-picker-close]").forEach(p=>{p._bound||(p._bound=!0,p.addEventListener("click",Di))});const d=document.getElementById("btn-bank-client-picker-save");d&&!d._bound&&(d._bound=!0,d.addEventListener("click",Qc)),document.querySelectorAll(".bank-sessions-chip").forEach(p=>{p._bound||(p._bound=!0,p.addEventListener("click",()=>{H.sessionFilter=p.dataset.sessFilter||"all",document.querySelectorAll(".bank-sessions-chip").forEach(c=>{c.classList.toggle("active",c===p)}),Jn()}))})}window._deleteBankSession=Ri;window._loadBankReconPanel=Fi;window._rerenderBankRecon=function(){if(currentRoute==="automation"){if(Jn(),H.currentSession&&(ji(),ks(),xs(),!H.currentTxForDrawer)){const e=document.getElementById("bank-cand-pane-title"),n=document.getElementById("bank-cand-pane-sub");e&&(e.textContent=t("bank-cand-pane-empty-title")),n&&(n.textContent=t("bank-cand-pane-empty-sub"))}je()}};typeof window.subscribeI18n=="function"&&window.subscribeI18n("bank-recon",window._rerenderBankRecon);window._openBankSession=async function(e){e&&(H.loaded||await Fi(),await Zt(e))};(function(){const e=document.getElementById("page-clients");if(!(!e||e.dataset.wbInjected==="1")){e.innerHTML=`
        <div class="page-head">
            <div class="page-head-icon">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
...
`,e.dataset.wbInjected="1";try{const n=window._currentLang||localStorage.getItem("mrpilot_lang")||"th",a=window.I18N;a&&a[n]&&(e.querySelectorAll("[data-i18n]").forEach(s=>{const o=s.getAttribute("data-i18n");a[n][o]&&(s.textContent=a[n][o])}),e.querySelectorAll("[data-i18n-placeholder]").forEach(s=>{const o=s.getAttribute("data-i18n-placeholder");a[n][o]&&(s.placeholder=a[n][o])}))}catch{}}})();const md=`
    ...
    `;$e("client-modal-mask",md);$e("wsclient-modal-mask",vd);const U={clients:[],editingClientId:null,historyClientFilter:"",custTab:"seller",sellerClients:[],editingWsClientId:null,catCache:{fetched:0,items:[],supplier_count:0}},Be={page:0,pageSize:12,keyword:""},nt=new Set,Xn={keyword:""};function fd(){return{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||"")}}async function Ye(e,n={}){const a=await fetch(e,{...n,headers:{"Content-Type":"application/json",...fd(),...n.headers||{}}});if(!a.ok){const s=await a.json().catch(()=>({}));throw new Error(s.detail||"HTTP "+a.status)}return a.json()}function hd(){const e=document.querySelector("#client-color-picker .color-swatch.active");return e?e.dataset.color:"#111111"}function mo(e){const n=document.getElementById("drawer-cat-learned-tag");n&&e>0&&(n.textContent=(t("drawer-suggest-learned-with-count")||"已学 {n}").replace("{n}",String(e)))}async function en(){try{const e=await Ye("/api/clients");U.clients=e.clients||[],window._clientsCache=U.clients}catch(e){console.error("loadClientsCache fail",e),U.clients=[]}try{typeof window._refreshExcClientFilter=="function"&&window._refreshExcClientFilter()}catch{}try{typeof window._refreshClientSwitcher=="function"&&window._refreshClientSwitcher()}catch{}return U.clients}function gd(){const e=Be.keyword.trim().toLowerCase();return e?U.clients.filter(n=>(n.name||"").toLowerCase().includes(e)||(n.short_name||"").toLowerCase().includes(e)||(n.tax_id||"").toLowerCase().includes(e)):U.clients}function Is(){const e=gd(),n=Be.pageSize,a=Math.max(0,Math.ceil(e.length/n)-1);Be.page>a&&(Be.page=a);const s=Be.page*n;return{all:e,items:e.slice(s,s+n),start:s,ps:n,total:e.length,maxPage:a}}function Ze(){const e=document.getElementById("buyer-tbody");if(!e)return;const{items:n,start:a,ps:s,total:o,maxPage:i}=Is();o?e.innerHTML=n.map(d=>{const p=nt.has(d.id);return`<div class="cust-row buyer-grid${p?" selected":""}" data-cid="${d.id}">
...
`,e.dataset.wbInjected="1";try{const n=window._currentLang||localStorage.getItem("mrpilot_lang")||"th",a=window.I18N;a&&a[n]&&(e.querySelectorAll("[data-i18n]").forEach(s=>{const o=s.getAttribute("data-i18n");a[n][o]&&(s.textContent=a[n][o])}),e.querySelectorAll("[data-i18n-placeholder]").forEach(s=>{const o=s.getAttribute("data-i18n-placeholder");a[n][o]&&(s.placeholder=a[n][o])}))}catch{}}})();const q={statsCache:null,listCache:[],currentRule:null,currentClient:"",currentStatus:"pending",loading:!1,selectedIds:new Set,offset:0,pageSize:50,total:0,loadFailed:!1,listScrollY:0},D={openExcId:null,excRow:null,history:null,loading:!1,pdfUrl:null,pdfStatus:"idle",editing:!1,editFields:null},Nt={batchLoading:!1};function gt(e,n){let a=t(e)||e;if(n)for(const s in n)a=a.replace(new RegExp("\\{"+s+"\\}","g"),String(n[s]));return a}function Ld(e){return e==="high"?`<svg viewBox="0 0 14 14" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
    ...
    `;const w=document.getElementById("exc-fld-edit");w&&w.addEventListener("click",()=>{D.editing=!0,D.editFields={...ho(D.history)},ct()});const k=document.getElementById("exc-fld-cancel");k&&k.addEventListener("click",()=>{D.editing=!1,D.editFields=null,ct()});const x=document.getElementById("exc-fld-save");x&&x.addEventListener("click",()=>qd()),document.querySelectorAll(".exc-field-input").forEach(M=>{M.addEventListener("input",()=>{D.editFields||(D.editFields={}),D.editFields[M.dataset.editKey]=M.value})});const I=document.getElementById("exc-pdf-retry");I&&D.openExcId&&I.addEventListener("click",()=>{D.excRow&&Oi(D.excRow.history_id,D.openExcId)});const B=e.status==="pending",L=!!(e.seller_name&&e.seller_name.trim()),$=document.getElementById("exc-btn-resolve"),S=document.getElementById("exc-btn-ignore");$.disabled=!B,S.disabled=!B||!L,S.title=L?t("exc-ignore-hint"):t("exc-ignore-no-seller")}function Ss(){if(D.pdfUrl){try{URL.revokeObjectURL(D.pdfUrl)}catch{}D.pdfUrl=null}D.pdfStatus="idle"}async function Oi(e,n){D.pdfStatus="loading",ct();try{const a=await fetch("/api/history/"+encodeURIComponent(e)+"/pdf",{headers:{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||"")}});if(D.openExcId!==n)return;if(a.status===404){D.pdfStatus="empty",ct();return}if(!a.ok)throw new Error("http "+a.status);const s=await a.blob();if(D.openExcId!==n)return;Ss(),D.pdfUrl=URL.createObjectURL(s),D.pdfStatus="ready",ct()}catch(a){if(D.openExcId!==n)return;console.warn("loadDrawerPdf fail",a),D.pdfStatus="error",ct()}}function jd(e){const n=(q.listCache||[]).find(a=>a.id===e);if(!n){showToast(t("exc-drawer-error"),"error");return}q.listScrollY=window.scrollY||document.documentElement.scrollTop||0,Ss(),D.editing=!1,D.editFields=null,D.openExcId=e,D.excRow=n,D.history=null,document.getElementById("exc-drawer-mask").classList.add("show"),document.getElementById("exc-drawer").classList.add("show"),ct(),Dd(n.history_id),Oi(n.history_id,e)}function Yt(){Ss(),D.editing=!1,D.editFields=null,D.openExcId=null,D.excRow=null,D.history=null,document.getElementById("exc-drawer-mask").classList.remove("show"),document.getElementById("exc-drawer").classList.remove("show");const e=q.listScrollY||0;e>0&&requestAnimationFrame(()=>window.scrollTo(0,e))}async function Dd(e){try{const n=await fetch("/api/history/"+encodeURIComponent(e),{headers:{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||"")}});if(!n.ok)throw new Error("http "+n.status);D.history=await n.json()}catch(n){console.warn("loadHistoryDetail fail",n),D.history={_err:!0}}D.excRow&&ct()}function ho(e){if(!e||!e.pages)return{};const n=e.pages,a=n.find(s=>!s.is_duplicate&&!s.is_copy)||n[0];return a&&a.fields||{}}async function qd(){if(!D.openExcId||!D.history||!D.history.pages||D.loading)return;D.loading=!0;const e=showToast(t("exc-fld-saving"),"loading",0);try{const n=JSON.parse(JSON.stringify(D.history.pages||[]));let a=n.findIndex(m=>!m.is_duplicate&&!m.is_copy);a<0&&(a=0),n[a]||(n[a]={fields:{}});const s=n[a].fields||{},o=D.editFields||{},i=new Set(["subtotal","vat","total_amount"]),r={...s};for(const m in o){let d=o[m];if((d===""||d===void 0)&&(d=null),i.has(m)&&d!==null){const p=parseFloat(d);d=isNaN(p)?null:p}r[m]=d}n[a].fields=r;const l=await fetch("/api/history/"+encodeURIComponent(D.history.id),{method:"PUT",headers:{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||""),"Content-Type":"application/json"},body:JSON.stringify({pages:n})});if(!l.ok)throw new Error("http "+l.status);e(),showToast(t("exc-fld-save-ok"),"success"),Yt(),await tn(),await kt(),at()}catch(n){e(),console.warn("save fields fail",n),showToast(t("exc-fld-save-fail"),"error")}finally{D.loading=!1}}async function Rd(){if(!(!D.openExcId||D.loading)){D.loading=!0;try{const e=await fetch("/api/exceptions/"+D.openExcId+"/resolve",{method:"POST",headers:{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||"")}});if(!e.ok)throw new Error("http "+e.status);showToast(t("exc-toast-resolved"),"success"),Yt(),await tn(),await kt(),at()}catch(e){console.warn("resolve fail",e),showToast(t("exc-toast-action-fail"),"error")}finally{D.loading=!1}}}async function Fd(){if(!(!D.openExcId||D.loading)){D.loading=!0;try{const e=await fetch("/api/exceptions/"+D.openExcId+"/ignore",{method:"POST",headers:{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||"")}});if(!e.ok)throw new Error("http "+e.status);showToast(t("exc-toast-ignored"),"success"),Yt(),await tn(),await kt(),at()}catch(e){console.warn("ignore fail",e),showToast(t("exc-toast-action-fail"),"error")}finally{D.loading=!1}}}async function at(){try{const e=q.currentClient||"",n="/api/exceptions/stats?status=pending"+(e?"&client_id="+encodeURIComponent(e):""),a=await fetch(n,{headers:{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||"")}});if(!a.ok)return;const s=await a.json(),o=document.getElementById("nav-exc-badge");if(!o)return;const i=parseInt(s.pending||0,10);i>0?(o.textContent=i>99?"99+":String(i),o.style.display=""):o.style.display="none"}catch{}}function Vi(e){document.getElementById("exc-kpi-pending").textContent=e.pending||0,document.getElementById("exc-kpi-high").textContent=e.high_severity||0,document.getElementById("exc-kpi-resolved").textContent=e.resolved||0,document.getElementById("exc-kpi-learned").textContent=e.learned_rules||0;const n=document.getElementById("exc-status-tab-count-pending"),a=document.getElementById("exc-status-tab-count-resolved"),s=document.getElementById("exc-status-tab-count-ignored");n&&(n.textContent=e.pending||0),a&&(a.textContent=e.resolved||0),s&&(s.textContent=e.ignored||0),document.querySelectorAll("#exc-status-tabs .exc-status-tab").forEach(i=>{i.classList.toggle("active",i.dataset.status===(q.currentStatus||"pending"))})}function Ui(e,n){return n.split(",").reduce((a,s)=>a+(e[s]||0),0)}function Cs(e){const n=document.getElementById("exc-chips");if(!n)return;const a=e.by_rule||{};let o=`<button class="exc-chip ${!q.currentRule?"active":""}" data-rule="">
        <span>${escapeHtml(t("exc-chip-all"))}</span>
        <span class="exc-chip-count">${e.pending||0}</span>
    </button>`;for(const i of Md){const r=i.codes.join(","),l=Ui(a,r),m=q.currentRule===r;l===0&&!m||(o+=`<button class="exc-chip ${m?"active":""}" data-rule="${escapeHtml(r)}">
            ...
            <div class="exc-row sev-${escapeHtml(i)} ${c?"selected":""}" data-exc-id="${escapeHtml(String(o.id))}">
                ...
                <div class="exc-row-sev">${Ld(i)}</div>
...
`;let _o=!1,ha=[],Ga=null,We="amount_limit",As="global";const Yd="/api/knowledge/rules";function Jd(){return localStorage.getItem("mrpilot_token")||""}async function Jt(e,n,a){return fetch(Yd+n,{method:e,headers:{Authorization:"Bearer "+Jd(),"Content-Type":"application/json"},body:a?JSON.stringify(a):void 0})}function Xd(e){const n=Number(e);return Number.isFinite(n)?"฿ "+n.toLocaleString("en-US"):String(e)}function Zd(e){const n=he(),a=s=>e===s?" selected":"";return`<option value="high"${a("high")}>${n.sevHigh}</option><option value="medium"${a("medium")}>${n.sevMid}</option><option value="low"${a("low")}>${n.sevLow}</option>`}function Eo(e,n){const a=n&&n.subject_key?escapeHtml(n.subject_key):"";return`<div class="rs-mlbl">${e}</div><input class="rs-field" id="rs-f-key" value="${a}"${n?" disabled":""}>`}function Qd(e){const n=he(),a=e.subject_key?escapeHtml(e.subject_key):"";if(e.rule_type==="amount_limit"){const s=Xd(e.rule_body.limit);let o=n.gAmount;e.subject_type==="global"?o=n.anyInvoice:e.subject_type==="supplier"?o=`${n.fSupplierTax} <b>${a}</b>`:o=`「${a}」`;const i=e.rule_body.notify_line?` <span class="rs-line">${ft("bell",12)} ${n.alsoLine}</span>`:"";return`${o} &gt; <b>${s}</b>${i}`}if(e.rule_type==="supplier_force_review")return`<b>${a}</b> · ${n.tForceDesc}`;if(e.rule_type==="no_auto_push_category")return`「${a}」 · ${n.tCategoryDesc}`;if(e.rule_type==="accounting_period"){const o=e.rule_body.mode==="prev_month"?n.pmPrev:n.pmCurrent;return`${n.gPeriodDesc} · <b>${o}</b>`}return e.rule_type}function ep(e){const n=he(),a=e.severity||"medium",s=a==="high"?n.sevHigh:a==="low"?n.sevLow:n.sevMid;return`<div class="rs-rule"><div class="rs-rm"><div class="rs-rt">${Qd(e)}</div></div><span class="rs-sev ${a}">${s}</span><button class="rs-sw${e.is_active?"":" off"}" data-toggle="${e.id}" aria-label="toggle"></button><button class="rs-icobtn" data-edit="${e.id}" aria-label="edit">${ft("pencil",14)}</button><button class="rs-icobtn" data-del="${e.id}" aria-label="delete">${ft("trash",14)}</button></div>`}function Mn(e,n,a,s,o){const i=he(),l=ha.filter(m=>o.includes(m.rule_type)).map(ep).join("")||`<div class="rs-empty">${i.empty}</div>`;return`<div class="rs-group"><div class="rs-ghead"><div class="rs-gico">${ft(e,17)}</div><div><div class="rs-gt">${n}</div><div class="rs-gd">${a}</div></div><button class="rs-addbtn" data-add-type="${s}">${ft("plus",14)} ${i.add}</button></div><div class="rs-gbody">${l}</div></div>`}function Ki(){const e=he(),n=document.querySelector("#rules-settings-modal .rs-head h2");n&&(n.textContent=e.title);const a=document.getElementById("rs-body");a&&(a.innerHTML=`<p class="rs-lead">${e.lead}</p>`+Mn("building",e.gSupplier,e.gSupplierDesc,"supplier_force_review",["supplier_force_review"])+Mn("wallet",e.gAmount,e.gAmountDesc,"amount_limit",["amount_limit"])+Mn("calendar",e.gPeriod,e.gPeriodDesc,"accounting_period",["accounting_period"])+Mn("octagon",e.gCategory,e.gCategoryDesc,"no_auto_push_category",["no_auto_push_category"]))}async function Ps(){try{const e=await Jt("GET","?include_inactive=1");if(!e.ok)throw new Error("http "+e.status);ha=(await e.json()).rules||[],Ki()}catch{showToast(he().loadFail,"error")}}function Wa(e){const n=he(),a=e?e.severity:We==="supplier_force_review"?"high":"medium",s=`<div class="rs-mlbl">${n.fSeverity}</div><select class="rs-field" id="rs-f-sev">${Zd(a)}</select>`;if(We==="amount_limit"){const i=e?e.subject_type:As,r=e&&e.subject_key?escapeHtml(e.subject_key):"",l=e?String(e.rule_body.limit??""):"",m=e?!!e.rule_body.notify_line:!0,d=i==="global"?"":`<div class="rs-mlbl">${i==="category"?n.fCategory:n.fSupplierTax}</div><input class="rs-field" id="rs-f-key" value="${r}">`;return`<div class="rs-mlbl">${n.gAmountDesc}</div><select class="rs-field" id="rs-f-scope"${e?" disabled":""}><option value="global"${i==="global"?" selected":""}>${n.anyInvoice}</option><option value="supplier"${i==="supplier"?" selected":""}>${n.tForce}</option><option value="category"${i==="category"?" selected":""}>${n.fCategory}</option></select><div id="rs-f-subj">${d}</div><div class="rs-two"><div><div class="rs-mlbl">${n.fAmountLimit}</div><input class="rs-field" id="rs-f-limit" type="number" min="1" value="${l}"></div><div>${s}</div></div><label class="rs-check"><input type="checkbox" id="rs-f-line"${m?" checked":""}>${ft("bell",14)} ${n.fAlsoLine}</label>`}if(We==="supplier_force_review")return Eo(n.fSupplierTax,e)+s;if(We==="no_auto_push_category")return Eo(n.fCategory,e)+s;const o=e?e.rule_body.mode:"current_month";return`<div class="rs-mlbl">${n.fPeriodMode}</div><select class="rs-field" id="rs-f-mode"><option value="current_month"${o==="current_month"?" selected":""}>${n.pmCurrent}</option><option value="prev_month"${o==="prev_month"?" selected":""}>${n.pmPrev}</option></select>`+s}function Hn(e,n,a){return`<button class="rs-type${We===e?" on":""}" data-type-pick="${e}"><div class="tt">${n}</div><div class="td">${a}</div></button>`}function tp(e){const n=he(),a=document.getElementById("rs-add-modal");if(!a)return;const s=e?"":`<div class="rs-mlbl">${n.rType}</div><div class="rs-types">`+Hn("supplier_force_review",n.tForce,n.tForceDesc)+Hn("amount_limit",n.tAmount,n.tAmountDesc)+Hn("accounting_period",n.tPeriod,n.tPeriodDesc)+Hn("no_auto_push_category",n.tCategory,n.tCategoryDesc)+"</div>";a.innerHTML=`<div class="rs-pop" style="max-width:460px;"><div class="rs-head"><h2>${e?n.editTitle:n.addTitle}</h2><button class="rs-close" id="rs-add-close">${ft("x",18)}</button></div><div class="rs-body">${s}<div id="rs-add-fields">${Wa(e)}</div></div><div class="rs-foot" style="gap:10px;"><button class="rs-btn rs-btn-ghost" id="rs-add-cancel">${n.cancel}</button><button class="rs-btn rs-btn-primary" id="rs-add-save">${n.save}</button></div></div>`,a.classList.add("rs-open")}function It(e){const n=document.getElementById(e);return n?String(n.value).trim():""}function np(){const e=he(),n=It("rs-f-sev")||"medium";if(We==="amount_limit"){const a=It("rs-f-scope")||"global",s=Number(It("rs-f-limit"));if(!Number.isFinite(s)||s<=0)return showToast(e.needAmount,"error"),{ok:!1};const o=a==="global"?null:It("rs-f-key");if(a!=="global"&&!o)return showToast(a==="category"?e.needCategory:e.needSupplier,"error"),{ok:!1};const i=document.getElementById("rs-f-line")?.checked;return{ok:!0,payload:{rule_type:"amount_limit",subject_type:a,subject_key:o,severity:n,rule_body:{limit:s,basis:"total",period:"per_invoice",notify_line:!!i}}}}if(We==="supplier_force_review"){const a=It("rs-f-key");return a?{ok:!0,payload:{rule_type:"supplier_force_review",subject_type:"supplier",subject_key:a,severity:n,rule_body:{}}}:(showToast(e.needSupplier,"error"),{ok:!1})}if(We==="no_auto_push_category"){const a=It("rs-f-key");return a?{ok:!0,payload:{rule_type:"no_auto_push_category",subject_type:"category",subject_key:a,severity:n,rule_body:{}}}:(showToast(e.needCategory,"error"),{ok:!1})}return{ok:!0,payload:{rule_type:"accounting_period",subject_type:"global",subject_key:null,severity:n,rule_body:{mode:It("rs-f-mode")||"current_month"}}}}async function ap(){const e=np();if(!(!e.ok||!e.payload))try{let n;if(Ga!==null){const a=e.payload;n=await Jt("PATCH","/"+Ga,{rule_body:a.rule_body,severity:a.severity})}else n=await Jt("POST","",e.payload);if(!n.ok)throw new Error("http "+n.status);showToast(he().saved,"success"),document.getElementById("rs-add-modal")?.classList.remove("rs-open"),await Ps()}catch{showToast(he().saveFail,"error")}}async function sp(e){const n=ha.find(o=>o.id===e);if(!n)return;const a=!n.is_active;n.is_active=a;const s=document.querySelector(`#rules-settings-modal [data-toggle="${e}"]`);s&&s.classList.toggle("off",!a);try{const o=await Jt("PATCH","/"+e,{is_active:a});if(!o.ok)throw new Error("http "+o.status);showToast(a?he().enabled:he().disabled,"success")}catch{n.is_active=!a,s&&s.classList.toggle("off",a),showToast(he().saveFail,"error")}}async function op(e){if(await showConfirm(he().delConfirm,{danger:!0}))try{const a=await Jt("DELETE","/"+e);if(!a.ok)throw new Error("http "+a.status);showToast(he().deleted,"success"),await Ps()}catch{showToast(he().saveFail,"error")}}function Io(e,n){We=e,As="global",Ga=n?n.id:null,tp(n)}function ip(){if(_o)return;const e=document.createElement("style");e.textContent=Kd,document.head.appendChild(e);const n=he(),a=document.createElement("div");a.id="rules-settings-modal",a.innerHTML=`<div class="rs-pop"><div class="rs-head"><h2>${n.title}</h2><span class="rs-tag">●</span><button class="rs-close" id="rs-main-close">${ft("x",18)}</button></div><div class="rs-body" id="rs-body"></div><div class="rs-foot"><button class="rs-btn rs-btn-primary" id="rs-done">${n.done}</button></div></div>`,document.body.appendChild(a);const s=document.createElement("div");s.id="rs-add-modal",document.body.appendChild(s),document.addEventListener("click",o=>{const i=o.target;(i.id==="rules-settings-modal"||i.closest("#rs-main-close")||i.closest("#rs-done"))&&a.classList.remove("rs-open"),(i.id==="rs-add-modal"||i.closest("#rs-add-close")||i.closest("#rs-add-cancel"))&&s.classList.remove("rs-open");const r=i.closest("[data-add-type]");r&&Io(r.dataset.addType);const l=i.closest("[data-edit]");if(l){const c=ha.find(u=>u.id===Number(l.dataset.edit));c&&Io(c.rule_type,c)}const m=i.closest("[data-del]");m&&op(Number(m.dataset.del));const d=i.closest("[data-toggle]");d&&sp(Number(d.dataset.toggle));const p=i.closest("[data-type-pick]");if(p){We=p.dataset.typePick,document.querySelectorAll("#rs-add-modal .rs-type").forEach(u=>u.classList.toggle("on",u.dataset.typePick===We));const c=document.getElementById("rs-add-fields");c&&(c.innerHTML=Wa())}i.closest("#rs-add-save")&&ap()}),document.addEventListener("change",o=>{const i=o.target;if(i.id==="rs-f-scope"){As=i.value;const r=document.getElementById("rs-add-fields");r&&(r.innerHTML=Wa())}}),document.addEventListener("keydown",o=>{o.key==="Escape"&&(s.classList.contains("rs-open")?s.classList.remove("rs-open"):a.classList.contains("rs-open")&&a.classList.remove("rs-open"))}),_o=!0}window.openRulesSettings=function(){ip(),document.getElementById("rules-settings-modal").classList.add("rs-open"),Ps()};function rp(){const e=document.querySelector("#page-exceptions .page-head-actions");if(!e||document.getElementById("exc-rules-btn"))return;const n=document.createElement("button");n.id="exc-rules-btn",n.type="button",n.className="btn btn-ghost",n.innerHTML=ft("settings",16)+`<span class="rs-btn-label">${he().btn}</span>`,n.addEventListener("click",()=>window.openRulesSettings&&window.openRulesSettings()),e.insertBefore(n,e.firstChild)}let Bo=!1;async function lp(){if(!Bo){Bo=!0;try{(await Jt("GET","")).ok&&rp()}catch{}}}const Lo=window.loadExceptionsPage;window.loadExceptionsPage=function(){lp(),Lo&&Lo()};Array.isArray(window.__i18nSubs)||(window.__i18nSubs=[]);window.__i18nSubs.push({name:"rules-settings",fn:()=>{const e=document.querySelector("#exc-rules-btn .rs-btn-label");e&&(e.textContent=he().btn),document.getElementById("rules-settings-modal")?.classList.contains("rs-open")&&Ki()}});(function(){const e=document.getElementById("page-knowledge");if(!(!e||e.dataset.wbInjected==="1")){if(!document.getElementById("kb-center-style")){const n=document.createElement("style");n.id="kb-center-style",n.textContent=`
...
`,e.dataset.wbInjected="1";try{const n=window._currentLang||localStorage.getItem("mrpilot_lang")||"th",a=window.I18N;a&&a[n]&&e.querySelectorAll("[data-i18n]").forEach(s=>{const o=s.getAttribute("data-i18n");a[n][o]&&(s.textContent=a[n][o])})}catch{}}})();const cp="/api/knowledge",wt="/static/brand/kb-cat.png?v=2";function dp(){return localStorage.getItem("mrpilot_token")||""}function z(e,n){if(typeof window.t=="function"){const a=window.t(e);if(a&&a!==e)return a}return n}function K(e){return typeof escapeHtml=="function"?escapeHtml(String(e??"")):String(e??"")}const $o={file:'<path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><path d="M14 2v6h6"/>',"file-text":'<path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><path d="M14 2v6h6"/><path d="M16 13H8"/><path d="M16 17H8"/><path d="M10 9H8"/>',sheet:'<rect width="18" height="18" x="3" y="3" rx="2"/><path d="M3 9h18"/><path d="M3 15h18"/><path d="M9 3v18"/><path d="M15 3v18"/>',image:'<rect width="18" height="18" x="3" y="3" rx="2"/><circle cx="9" cy="9" r="2"/><path d="m21 15-3.1-3.1a2 2 0 0 0-2.8 0L6 21"/>',upload:'<path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><path d="M14 2v6h6"/><path d="M12 18v-6"/><path d="m9 15 3-3 3 3"/>',message:'<path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/>',"shield-check":'<path d="M20 13c0 5-3.5 7.5-7.7 9a1 1 0 0 1-.7 0C7.5 20.5 4 18 4 13V6a1 1 0 0 1 1-1c2 0 4.5-1.2 6.2-2.7a1.2 1.2 0 0 1 1.6 0C14.5 3.8 17 5 19 5a1 1 0 0 1 1 1z"/><path d="m9 12 2 2 4-4"/>',check:'<path d="M20 6 9 17l-5-5"/>',x:'<path d="M18 6 6 18"/><path d="M6 6l12 12"/>'};function Ke(e){return`<svg class="kb-ic" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round">${$o[e]||$o.file}</svg>`}function Yi(e){const n=`kb-${e}-mask`,a=`kb-${e}-modal`,s=()=>document.getElementById(n)?.classList.add("open"),o=()=>document.getElementById(n)?.classList.remove("open");let i=document.getElementById(n);if(!i){i=document.createElement("div"),i.id=n,i.className=`kb-${e}-mask`,i.innerHTML=`<div class="kb-${e}-modal" id="${a}" role="dialog" aria-modal="true"></div>`,document.body.appendChild(i);const r=i;r.addEventListener("click",l=>{(l.target===r||l.target.closest(`[data-kb-${e}-close]`))&&o()}),document.addEventListener("keydown",l=>{l.key==="Escape"&&r.classList.contains("open")&&o()})}return{modal:document.getElementById(a),open:s,close:o}}function ga(){const e=window.getActiveWorkspaceClientId;if(typeof e!="function")return null;const n=e(),a=Number(n);return Number.isFinite(a)&&a>0?a:null}function Ji(){const e=ga();if(!e)return"";const a=(window._workspaceClientsCache||[]).find(s=>Number(s.id)===e);return a&&a.name?String(a.name):"#"+e}async function nn(e,n,a,s={}){const o=new URL(cp+n,location.origin),i=ga();if(s.query)for(const[d,p]of Object.entries(s.query))p!=null&&o.searchParams.set(d,String(p));const r=s.withWorkspace!==!1&&i!=null;r&&(e==="GET"||e==="DELETE")&&o.searchParams.set("workspace_client_id",String(i));const l={Authorization:"Bearer "+dp()};let m=s.raw;if(!s.raw&&a!==void 0){const d=r?{workspace_client_id:i,...a}:a;l["Content-Type"]="application/json",m=JSON.stringify(d)}try{const d=await fetch(o.toString(),{method:e,headers:l,body:m});let p=null,c;const u=await d.text();if(u)try{const v=JSON.parse(u);d.ok?p=v:c=v?.detail?.error_code||v?.message_key||v?.detail||void 0}catch{}return{ok:d.ok,status:d.status,data:p,error:c}}catch{return{ok:!1,status:0,data:null,error:"network"}}}async function pp(e,n){const a=new FormData;a.append("file",e);const s=ga();return s!=null&&a.append("workspace_client_id",String(s)),nn("POST","/documents",void 0,{raw:a,withWorkspace:!1})}let An=null;async function Xi(){if(An!==null)return An;const e=await nn("GET","/bases",void 0,{withWorkspace:!1});return An=e.status===200||e.status===401||e.status===403,An}let So=!1;function Zi(){const e=document.getElementById("kb-ws-bar"),n=document.getElementById("kb-ws-label");if(!e||!n)return;ga()?(e.classList.remove("kb-ws-empty"),n.innerHTML=z("kb-ws-current","账套主体")+"：<b>"+K(Ji())+"</b>"):(e.classList.add("kb-ws-empty"),n.textContent=z("kb-ws-none","请先在右上角选择账套主体,再使用客户私有文档与问答。"))}function up(e){document.querySelectorAll(".kb-tab-bar .recon-tab-btn").forEach(n=>{n.classList.toggle("active",n.dataset.kbTab===e)}),document.querySelectorAll(".kb-pane").forEach(n=>{n.classList.toggle("active",n.id==="kb-pane-"+e)}),e==="docs"&&typeof window._kbRenderDocs=="function"&&window._kbRenderDocs(),e==="qa"&&typeof window._kbRenderAsk=="function"&&window._kbRenderAsk()}function mp(){if(So)return;const e=document.querySelector(".kb-tab-bar");if(!e)return;e.addEventListener("click",s=>{const o=s.target.closest(".recon-tab-btn");o&&o.dataset.kbTab&&up(o.dataset.kbTab)});const n=document.getElementById("kb-open-rules");n&&n.addEventListener("click",()=>{typeof window.openRulesSettings=="function"&&window.openRulesSettings()});const a=document.getElementById("kb-info-btn");a&&a.addEventListener("click",()=>{typeof window._kbOpenInfo=="function"&&window._kbOpenInfo()}),So=!0}window.loadKnowledgePage=function(){mp(),Zi(),document.querySelector('.kb-tab-bar .recon-tab-btn[data-kb-tab="docs"]')?.classList.contains("active")&&typeof window._kbRenderDocs=="function"&&window._kbRenderDocs()};async function Co(){if(!window._knowledgeProbed){window._knowledgeProbed=!0;try{if(await Xi()){const e=document.getElementById("nav-knowledge");e&&(e.style.display="")}}catch{}}}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",Co):Co();Array.isArray(window.__i18nSubs)||(window.__i18nSubs=[]);window.__i18nSubs.push({name:"knowledge-center",fn:Zi});let Ka=!1,dt=[];function vp(e){if(e.status==="ready")return`<span class="kb-badge ready"><span class="kb-bdot"></span>${K(z("kb-doc-ready","已就绪"))}</span>`;if(e.status==="failed")return`<span class="kb-badge failed"><span class="kb-bdot"></span>${K(z("kb-doc-failed","失败"))}</span>`;const n=e.status==="uploading"?z("kb-doc-uploading","上传中…"):z("kb-doc-parsing","解析中");return`<span class="kb-badge parsing"><span class="kb-bdot"></span>${K(n)}</span>`}function fp(e){return e==="unsupported_document"?z("kb-err-unsupported_document","不支持的文件类型"):e==="embedding_failed"?z("kb-err-embedding_failed","向量化失败，可重试"):e==="processing_failed"?z("kb-err-processing_failed","文件无法解析，可能已损坏或加密"):e?z("kb-doc-failed","失败"):""}function hp(e){return(e||"").slice(0,10)}function gp(e){let n;e.status==="failed"&&e.error_code?n=`<div class="kb-doc-sub err">${K(fp(e.error_code))}</div>`:e.status==="uploading"?n=`<div class="kb-doc-sub">${K(z("kb-doc-uploading","上传中…"))}</div>`:n=`<div class="kb-doc-sub">${K((e.source_type||"").toUpperCase())} · ${K(hp(e.created_at))}</div>`;const a=e.status==="uploading"?"":`<button class="btn btn-sm btn-ghost kb-doc-del" data-id="${e.id}">${K(z("kb-doc-delete","删除"))}</button>`;return`<div class="kb-doc-row" data-id="${e.id}">
        <div class="kb-doc-ic">${bp(e.source_type)}</div>
        <div class="kb-doc-meta"><div class="kb-doc-name">${K(e.filename)}</div>${n}</div>
        ${vp(e)}${a}
    </div>`}function bp(e){const n=(e||"").toLowerCase();return n==="doc"||n==="docx"?Ke("file-text"):n==="xls"||n==="xlsx"||n==="csv"?Ke("sheet"):["png","jpg","jpeg","webp"].includes(n)?Ke("image"):Ke("file")}function Qi(){return document.getElementById("kb-doc-list")}function xn(){const e=Qi();if(e){if(!dt.length){e.innerHTML=`<div class="kb-empty">
        ...
        </div>`;return}e.innerHTML=dt.map(gp).join("")}}function To(e){const n=Qi();n&&(n.innerHTML=e)}async function er(){To('<div class="kb-skel"><div class="kb-skrow"></div><div class="kb-skrow"></div><div class="kb-skrow"></div></div>');const e=await nn("GET","/documents");if(!e.ok){To(`<div class="kb-empty err">
            <div>${K(z("kb-doc-error","加载失败"))}</div>
            <button class="btn btn-sm kb-doc-reload" style="margin-top:12px">${K(z("kb-doc-retry","重试"))}</button>
        </div>`);return}dt=(e.data?.documents||[]).filter(n=>n.status!=="deleted"),xn()}async function Mo(e){const n=Array.from(e);if(n.length)for(const a of n){const s=-Date.now()-Math.floor(Math.random()*1e3);dt.unshift({id:s,filename:a.name,source_type:(a.name.split(".").pop()||"").toLowerCase(),status:"uploading",error_code:null,created_at:new Date().toISOString()}),xn();const o=await pp(a),i=dt.findIndex(r=>r.id===s);i<0||(o.ok&&o.data?.document?(dt[i]=o.data.document,o.data.document.status==="failed"&&showToast(z("kb-doc-failed","失败")+"："+a.name,"error")):(dt.splice(i,1),showToast(z("kb-upload-fail","上传失败")+"："+a.name,"error")),xn())}}async function yp(e){if(!(typeof showConfirm=="function"?await showConfirm(z("kb-doc-del-confirm","确定删除这份文档？删除后 AI 将不再引用它。")):!0))return;(await nn("DELETE","/documents/"+e)).ok?(dt=dt.filter(s=>s.id!==e),xn()):showToast(z("kb-doc-del-fail","删除失败"),"error")}function wp(){const e=document.getElementById("kb-pane-docs");if(!e||Ka&&e.querySelector("#kb-doc-list"))return;if(!document.getElementById("kb-docs-style")){const s=document.createElement("style");s.id="kb-docs-style",s.textContent=`
...
`,document.head.appendChild(s)}e.innerHTML=`
    ...
    `;try{const s=window._currentLang||localStorage.getItem("mrpilot_lang")||"th",o=window.I18N;o&&o[s]&&e.querySelectorAll("[data-i18n]").forEach(i=>{const r=i.getAttribute("data-i18n");o[s][r]&&(i.textContent=o[s][r])})}catch{}const n=e.querySelector("#kb-up"),a=e.querySelector("#kb-file");n.addEventListener("click",s=>{s.target.closest("input")||a.click()}),a.addEventListener("change",()=>{a.files&&Mo(a.files),a.value=""}),["dragenter","dragover"].forEach(s=>n.addEventListener(s,o=>{o.preventDefault(),n.classList.add("drag")})),["dragleave","drop"].forEach(s=>n.addEventListener(s,o=>{o.preventDefault(),n.classList.remove("drag")})),n.addEventListener("drop",s=>{const o=s.dataTransfer;o?.files?.length&&Mo(o.files)}),e.addEventListener("click",s=>{const o=s.target,i=o.closest(".kb-doc-del");if(i?.dataset.id){yp(Number(i.dataset.id));return}o.closest(".kb-doc-reload")&&er()}),Ka=!0}function kp(){wp(),er()}window._kbRenderDocs=kp;Array.isArray(window.__i18nSubs)||(window.__i18nSubs=[]);window.__i18nSubs.push({name:"knowledge-documents",fn:()=>{Ka&&xn()}});let Zn=null;function xp(){if(Zn)return;const e=document.createElement("style");e.id="kb-src-style",e.textContent=`
...
`,document.head.appendChild(e),Zn=Yi("src")}function _p(e){const n=K(e.text).replace(/\n/g,"<br>");return`<span class="seg${e.matched?" hit":""}">${n}</span>`}function Ep(e){return e.segments.map(_p).join("<br><br>")}async function Ip(e){xp();const n=Zn?.modal;if(!n)return;const a=e.filename||z("kb-src-unknown","未知来源"),s=typeof e.score=="number"?Math.round(Math.max(0,Math.min(1,e.score))*100):null,o=typeof e.chunk_id=="number";if(n.innerHTML=`
    ...
    `,Zn?.open(),!o)return;const i=await nn("GET","/chunks/"+e.chunk_id),r=n.querySelector("#kb-src-preview");r&&(i.ok&&i.data?.segments?.length?r.innerHTML=Ep(i.data):r.innerHTML=`<div class="kb-src-fail">${K(z("kb-src-load-fail","原文片段暂时取不到,可在文档库打开原件核对。"))}</div>`)}window._kbOpenSource=e=>{Ip(e)};function Bp(e){return`<div class="kb-msg user"><div class="kb-bub">${K(e)}</div></div>`}function Lp(e){const n=e.filename||z("kb-src-unknown","未知来源");return`<button class="kb-cite" data-cite='${K(JSON.stringify(e))}'>
        ...
        ${K(n)}<span class="ch">›</span></button>`}function $p(e){if(e.no_answer){const a=z(e.message_key||"ask.no_source","资料不足，无法判断。");return`<div class="kb-msg ai"><div class="kb-ava"><img src="${wt}" alt=""></div>
            <div class="kb-bub no-src">${K(a)}</div></div>`}const n=(e.citations||[]).map(a=>Lp(a)).join("");return`<div class="kb-msg ai"><div class="kb-ava"><img src="${wt}" alt=""></div>
        <div class="kb-bub">${K(e.answer)}${n?`<div class="kb-cites">${n}</div>`:""}</div></div>`}function Sp(e){return nn("POST","/ask",{question:e})}function Ho(e){return`<div class="kb-msg ai"><div class="kb-ava"><img src="${wt}" alt=""></div><div class="kb-bub no-src">${K(e)}</div></div>`}function tr(e,n,a){if(e.dataset.kbWired==="1")return;e.dataset.kbWired="1";let s=!1;function o(r){const l=document.createElement("div");l.innerHTML=r;const m=l.firstElementChild;return e.appendChild(m),e.scrollTop=e.scrollHeight,m}async function i(){const r=n.value.trim();if(!r||s)return;s=!0,n.value="",o(Bp(r));const l=o(`<div class="kb-msg ai"><div class="kb-ava"><img src="${wt}" alt=""></div><div class="kb-bub kb-thinking">${K(z("kb-ask-thinking","思考中…"))}</div></div>`),m=await Sp(r);if(l.remove(),m.status===402){const d=z("kb-ask-low-balance","余额不足，请先充值后再提问。");o(Ho(d)),typeof showToast=="function"&&showToast(d,"error")}else if(!m.ok||!m.data){const d=z("kb-ask-error","出错了，请稍后重试。");o(Ho(d)),typeof showToast=="function"&&showToast(d,"error")}else o($p(m.data));s=!1}a.addEventListener("click",i),n.addEventListener("keydown",r=>{r.key==="Enter"&&!r.shiftKey&&(r.preventDefault(),i())}),e.addEventListener("click",r=>{const l=r.target.closest(".kb-cite");if(!(!l||!l.dataset.cite))try{const m=JSON.parse(l.dataset.cite);typeof window._kbOpenSource=="function"&&window._kbOpenSource(m)}catch{}})}window._kbWireAsk=tr;function Cp(){if(document.getElementById("kb-ask-style"))return;const e=document.createElement("style");e.id="kb-ask-style",e.textContent=`
...
`,document.head.appendChild(e)}function Tp(){const e=document.getElementById("kb-pane-qa");if(!e||e.dataset.kbBuilt==="1")return;Cp();const n=K(z("kb-ask-ex1","这家客户有金额上限吗？")),a=K(z("kb-ask-ex2","合同约定的付款周期是多久？")),s=K(z("kb-ask-ex3","哪些供应商需要人工复核？")),o=typeof window._kbFabEnabled=="function"&&window._kbFabEnabled();e.innerHTML=`
        <div class="kb-ft">
    ...
    `,e.dataset.kbBuilt="1";const i=e.querySelector("#kb-qa-thread"),r=e.querySelector("#kb-qa-input"),l=e.querySelector("#kb-qa-send");tr(i,r,l),e.querySelectorAll(".kb-chip").forEach(d=>{d.addEventListener("click",()=>{r.value=d.dataset.q||"",l.click()})});const m=e.querySelector("#kb-fab-switch");m?.addEventListener("click",()=>{const d=!m.classList.contains("on");m.classList.toggle("on",d),m.setAttribute("aria-checked",String(d)),typeof window._kbFabSetEnabled=="function"&&window._kbFabSetEnabled(d)})}window._kbRenderAsk=Tp;const js="pearnly_kb_fab",Ya=wt,pt=14;let Ja=!1,Ao=!1;function Mp(){if(document.getElementById("kb-fab-style"))return;const e=document.createElement("style");e.id="kb-fab-style",e.textContent=`
...
`,document.head.appendChild(e)}let Z,vt,zn,Me;function Hp(){Ja||(Mp(),Z=document.createElement("div"),Z.className="kb-fab",Z.id="kb-fab",Z.innerHTML=`
        ...
        </div>`,document.body.appendChild(Me),vt=Z.querySelector("#kb-fab-btn"),zn=Z.querySelector("#kb-say"),document.getElementById("kb-card-x")?.addEventListener("click",Xa),document.addEventListener("keydown",e=>{e.key==="Escape"&&Xa()}),zp(),Rp(),Fp(),Ja=!0)}function Ap(){const e=document.getElementById("kb-card-thread"),n=document.getElementById("kb-card-input"),a=document.getElementById("kb-card-send");!Ao&&typeof window._kbWireAsk=="function"&&(e.innerHTML=`<div class="kb-msg ai"><div class="kb-ava"><img src="${Ya}" alt=""></div><div class="kb-bub">${z("kb-ask-empty","问点关于这家客户的事，答案都带出处；查不到时如实说「资料不足」。")}</div></div>`,window._kbWireAsk(e,n,a),Ao=!0);const s=document.getElementById("kb-card-ws");s&&(s.textContent=Ji()||z("kb-fab-no-ws","未选账套")),Pp(),Me.classList.add("open"),Dp(),nr(["💛","✨","💙","🐾"])}function Xa(){Me?.classList.remove("open")}function Pp(){const e=Z.getBoundingClientRect(),n=520,a=e.left+e.width/2<window.innerWidth/2,s=Math.min(Math.max(pt,e.top+e.height/2-n/2),window.innerHeight-n-pt);Me.style.top=s+"px",a?(Me.style.left=e.right+12+"px",Me.style.right="auto"):(Me.style.right=window.innerWidth-e.left+12+"px",Me.style.left="auto")}let Po;function jp(e,n=1500){zn.textContent=e,zn.classList.add("show"),clearTimeout(Po),Po=setTimeout(()=>zn.classList.remove("show"),n)}function Dp(){vt.classList.remove("jump"),vt.classList.add("cheer"),setTimeout(()=>vt.classList.remove("cheer"),650)}function qp(){Z.classList.contains("lifted")||(vt.classList.remove("cheer"),vt.classList.add("jump"),setTimeout(()=>vt.classList.remove("jump"),720))}function nr(e){for(let n=0;n<5;n++){const a=document.createElement("span");a.className="kb-spark",a.textContent=e[n%e.length],a.style.setProperty("--dx",n*14-28+"px"),a.style.left=30+n*10+"%",a.style.animationDelay=n*40+"ms",Z.appendChild(a),setTimeout(()=>a.remove(),1100)}}function Rp(){const e=[z("kb-fab-hi","喵?"),z("kb-fab-ask","问我呀!"),"🐾"];vt.addEventListener("mouseenter",()=>{Z.classList.contains("lifted")||jp(e[(Date.now()/1e3|0)%e.length],1400)}),setInterval(()=>{!Z.classList.contains("on")||Z.classList.contains("lifted")||Me.classList.contains("open")||(Date.now()/1e3|0)%2===0&&(qp(),nr(["✨","🐾"]))},5400)}function Ca(e){return Math.min(Math.max(pt,e),window.innerHeight-Z.offsetHeight-pt)}function Fp(){Z.classList.add("snapping"),Z.style.left=window.innerWidth-56-pt+"px",Z.style.top="62%"}function zp(){let e,n=!1,a=!1,s=0,o=0,i=0,r=0;function l(c){s=c.clientX,o=c.clientY,a=!1,n=!1;const u=Z.getBoundingClientRect();i=u.left,r=u.top,Z.classList.remove("snapping"),e=setTimeout(()=>{Z.classList.add("lifted")},180),window.addEventListener("pointermove",m),window.addEventListener("pointerup",d),c.preventDefault()}function m(c){const u=c.clientX-s,v=c.clientY-o;!n&&Math.hypot(u,v)>6&&(n=!0,Z.classList.add("lifted"),clearTimeout(e)),n&&(a=!0,Z.style.left=i+u+"px",Z.style.top=Ca(r+v)+"px")}function d(){if(clearTimeout(e),window.removeEventListener("pointermove",m),window.removeEventListener("pointerup",d),Z.classList.remove("lifted"),!a){Ap();return}p()}function p(){const c=Z.getBoundingClientRect();Z.classList.add("snapping"),Z.style.top=Ca(c.top)+"px",Z.style.left=(c.left+c.width/2<window.innerWidth/2?pt:window.innerWidth-Z.offsetWidth-pt)+"px"}vt.addEventListener("pointerdown",l),window.addEventListener("resize",()=>{if(!Ja)return;const c=Z.getBoundingClientRect();Z.style.top=Ca(c.top)+"px",Z.style.left=(c.left+c.width/2<window.innerWidth/2?pt:window.innerWidth-Z.offsetWidth-pt)+"px"})}function ar(e){Hp(),localStorage.setItem(js,e?"1":"0"),Z.classList.toggle("on",e),e||Xa()}window._kbFabSetEnabled=ar;window._kbFabEnabled=()=>localStorage.getItem(js)==="1";async function jo(){if(localStorage.getItem(js)==="1")try{await Xi()&&ar(!0)}catch{}}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",jo):jo();let Qn=null;function Np(){if(Qn)return;const e=document.createElement("style");e.id="kb-info-style",e.textContent=`
...
`,document.head.appendChild(e),Qn=Yi("info")}function Pn(e,n){return`<li><span class="ck">${Ke("check")}</span><span>${K(z(e,n))}</span></li>`}function Ta(e,n,a,s,o,i,r){return`<div class="row"><div class="pi">${e}</div>
        <div class="pm"><b>${K(z(n,a))}</b><div class="d">${K(z(s,o))}</div></div>
        <span class="amt">${K(z(i,r))}</span></div>`}function Op(){const e=Qn?.modal;e&&(e.innerHTML=`
    ...
    `)}function Vp(){Np(),Op(),Qn?.open()}window._kbOpenInfo=Vp;const sr={tax_invoice:"sx-dt-tax_invoice",tax_invoice_receipt:"sx-dt-tax_invoice_receipt",tax_invoice_simple:"sx-dt-tax_invoice_simple",receipt:"sx-dt-receipt",quotation:"sx-dt-quotation",credit_note:"sx-dt-credit_note",debit_note:"sx-dt-debit_note"};function Ds(e){const n=e?sr[e]:null;return n?t(n):e||"—"}function De(e){return Number(e||0).toLocaleString("en-US",{minimumFractionDigits:2,maximumFractionDigits:2})}function qs(e){return e?e.slice(0,10):"—"}function we(e){return escapeHtml(e==null?"":String(e))}function Up(){const e={Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||"")};try{const n=window._wsHeader&&window._wsHeader();n&&Object.assign(e,n)}catch{}return e}function xt(e,n={}){return fetch(e,{...n,headers:{...Up(),...n.headers||{}}})}const Gp=Object.freeze(Object.defineProperty({__proto__:null,DOC_TYPE_KEY:sr,docTypeLabel:Ds,fmtDate:qs,fmtMoney:De,htmlVal:we,salesFetch:xt},Symbol.toStringTag,{value:"Module"})),Te={x:'<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.9"><path d="M18 6 6 18M6 6l12 12"/></svg>',dl:'<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.9"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4M7 10l5 5 5-5M12 15V3"/></svg>',print:'<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.9"><path d="M6 9V2h12v7M6 18H4a2 2 0 0 1-2-2v-5a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2v5a2 2 0 0 1-2 2h-2M6 14h12v8H6z"/></svg>',send:'<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.9"><path d="m22 2-7 20-4-9-9-4Z"/></svg>',ban:'<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.9"><circle cx="12" cy="12" r="9"/><path d="m5 5 14 14"/></svg>',undo:'<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.9"><path d="M3 7v6h6M3 13a9 9 0 1 0 3-7.7L3 8"/></svg>',copy:'<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.9"><path d="M9 9h11v11H9zM5 15H4V4h11v1"/></svg>',qr:'<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.9"><rect x="3" y="3" width="7" height="7"/><rect x="14" y="3" width="7" height="7"/><rect x="3" y="14" width="7" height="7"/><path d="M14 14h3v3h-3zM21 14v7M17 21h4"/></svg>'};let Za={},Do=null;function ze(){return document.getElementById("sales-detail-mask")}function fe(){return document.getElementById("sales-action-mask")}function bt(){ze().style.display="none",ze().innerHTML=""}function _e(){fe().style.display="none",fe().innerHTML=""}async function Wp(){if(!Object.keys(Za).length)try{const e=await apiGet("/api/sales/sellers"),n=e&&(e.sellers||e.items||e)||[];if(Array.isArray(n))for(const a of n)Za[String(a.workspace_client_id??a.id)]=a}catch{}}function Kp(e){const n=Za[String(e.seller_workspace_client_id??"")]||{},a=(e.lines||[]).map((s,o)=>`<tr><td>${o+1}</td><td>${escapeHtml(String(s.description||"—"))}</td><td style="text-align:right">${De(s.amount??Number(s.qty||0)*Number(s.unit_price||0))}</td></tr>`).join("");return`<div class="sx-inv">
    ...
    </div>`}function Yp(e){const n=e.status==="void",a=e.doc_type==="quotation",s=e.status==="issued"&&(e.payment?.status||"unpaid")!=="paid",o=n?`<span style="color:var(--ink-3)">${escapeHtml(t("sx-voided-note"))}</span>`:`<button class="btn btn-ghost btn-sm" data-act="download">${Te.dl}<span>${escapeHtml(t("sx-download"))}</span></button>
        ...
        <div class="modal-footer" style="justify-content:space-between">
    ...
    </div>`,ze().style.display="flex",Jp(e)}function Jp(e){document.getElementById("sx-detail-close").onclick=bt,document.getElementById("sx-detail-close2").onclick=bt,ze().onclick=n=>{n.target===ze()&&bt()},ze().querySelectorAll("[data-soft]").forEach(n=>n.onclick=()=>showToast(t(n.dataset.soft),"info")),ze().querySelectorAll("[data-act]").forEach(n=>n.onclick=()=>au(n.dataset.act,e))}async function qo(e,n){try{const a=await xt(`/api/sales/documents/${e.id}/pdf?page=A4&copy=original`);if(!a.ok){showToast(t("sx-pdf-fail"),"error");return}const s=URL.createObjectURL(await a.blob()),o=window.open(s,"_blank");n&&o&&o.addEventListener("load",()=>o.print()),setTimeout(()=>URL.revokeObjectURL(s),6e4)}catch{showToast(t("sx-pdf-fail"),"error")}}async function Xp(e){try{const n=await xt(`/api/sales/documents/${e.id}/promptpay-qr`);if(!n.ok){const o=await n.json().catch(()=>({})),i=String(o.detail||"").replace("sales.","");showToast(t("sx-pp-"+i)||t("sx-pp-fail"),"error");return}const a=URL.createObjectURL(await n.blob()),s=Number(e.grand_total||0)-Number(e.payment?.paid_amount||0);fe().innerHTML=`<div class="modal" role="dialog" style="max-width:380px">
            ...
            </div></div>`,fe().style.display="flex",document.getElementById("sx-pp-close").onclick=_e,fe().onclick=o=>{o.target===fe()&&_e()},setTimeout(()=>URL.revokeObjectURL(a),12e4)}catch{showToast(t("sx-pp-fail"),"error")}}function Ro(e,n){const a=n==="credit_note"?t("sx-credit-title"):t("sx-debit-title");fe().innerHTML=`<div class="modal" role="dialog" style="max-width:460px">
        ...
        </div></div>`,fe().style.display="flex",document.getElementById("sx-note-close").onclick=_e,document.getElementById("sx-note-cancel").onclick=_e,fe().onclick=s=>{s.target===fe()&&_e()},document.getElementById("sx-note-ok").onclick=async()=>{const s=document.getElementById("sx-note-reason").value.trim(),o=Number(document.getElementById("sx-note-amount").value);if(!(o>0)){showToast(t("sx-note-amount-required"),"error");return}await ba(`/api/sales/documents/${e.id}/${n==="credit_note"?"credit-note":"debit-note"}`,{reason:s||a,vat_rate:Number(e.vat_rate||7),wht_rate:0,lines:[{description:s||a,qty:1,unit_price:o,vat_applicable:!0}]})&&(_e(),bt(),showToast(t("sx-done"),"success"),window.dispatchEvent(new CustomEvent("pearnly:sales-changed")))}}function Zp(e){fe().innerHTML=`<div class="modal" role="dialog" style="max-width:440px">
        ...
        <div class="modal-footer" style="justify-content:space-between;gap:8px">
            ...
            <button class="btn btn-primary" id="sx-link-copy">${escapeHtml(t("sx-send-copy"))}</button>
        </div></div>`,document.getElementById("sx-link-close").onclick=_e,document.getElementById("sx-link-done").onclick=_e,document.getElementById("sx-link-copy").onclick=()=>{document.getElementById("sx-link-url").select(),navigator.clipboard?.writeText(s).catch(()=>{}),showToast(t("sx-send-copied"),"success")}}async function nu(e){const n=e,a=(e.lines||[]).map(i=>{const r=i;return{description:(r.description||"").trim(),qty:Number(r.qty||0),unit_price:Number(r.unit_price||0),discount:Number(r.discount||0),vat_applicable:r.vat_applicable!==!1}}).filter(i=>i.description);if(!a.length)return showToast(t("sx-action-fail"),"error");const s={doc_type:e.doc_type,client_id:n.client_id,seller_workspace_client_id:n.seller_workspace_client_id,currency:n.currency||"THB",vat_rate:Number(e.vat_rate||0),wht_rate:Number(e.wht_rate||0),header_discount_amount:Number(n.header_discount_amount||0),header_discount_pct:Number(n.header_discount_pct||0),price_includes_vat:!!e.price_includes_vat,lines:a,buyer:e.buyer&&e.buyer.type?{...e.buyer}:null,payment:null};await ba("/api/sales/documents",s)&&(bt(),showToast(t("sx-copied"),"success"),window.dispatchEvent(new CustomEvent("pearnly:sales-changed")))}function au(e,n){if(e==="download")return void qo(n,!1);if(e==="print")return void qo(n,!0);if(e==="send")return or(n);if(e==="promptpay")return void Xp(n);if(e==="copy")return void nu(n);if(e==="credit")return Ro(n,"credit_note");if(e==="debit")return Ro(n,"debit_note");if(e==="void")return Zp(n);if(e==="convert")return void Qp(n)}window.openSalesDetail=async function(e){ze().innerHTML=`<div class="modal" role="dialog" style="max-width:640px"><div class="modal-body"><div class="sx-state">${escapeHtml(t("sx-loading"))}</div></div></div>`,ze().style.display="flex",await Wp();try{const n=await apiGet(`/api/sales/documents/${e}`);if(!n)return;Do=n.document,Yp(Do)}catch{ze().innerHTML=`<div class="modal" role="dialog" style="max-width:480px"><div class="modal-body"><div class="sx-state error">${escapeHtml(t("sx-error"))}</div></div></div>`;const a=ze();a.onclick=s=>{s.target===a&&bt()}}};const su='<svg width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.4"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8Z"/><path d="M14 2v6h6M8 13h8M8 17h5"/></svg>',ou='<svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.9"><circle cx="12" cy="12" r="3"/><path d="M19.4 13a7 7 0 0 0 0-2l2-1.5-2-3.5-2.3 1a7 7 0 0 0-1.7-1L15 3H9l-.4 2.5a7 7 0 0 0-1.7 1l-2.3-1-2 3.5L4.6 11a7 7 0 0 0 0 2l-2 1.5 2 3.5 2.3-1a7 7 0 0 0 1.7 1L9 21h6l.4-2.5a7 7 0 0 0 1.7-1l2.3 1 2-3.5-2-1.5Z"/></svg>',iu='<svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="#fff" stroke-width="2.2"><path d="M12 5v14M5 12h14"/></svg>',ru='<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.9"><path d="m9 18 6-6-6-6"/></svg>',lu=["paid","unpaid","partial"];let ea=[],ta="all",Rs="";function ir(e){const n=e.payment&&e.payment.status||"";return lu.indexOf(n)>=0?n:"unpaid"}function rr(e){return e.buyer&&e.buyer.name||"—"}function cu(e){if(!e)return!1;const n=new Date,a=n.getFullYear()+"-"+String(n.getMonth()+1).padStart(2,"0");return e.slice(0,7)===a}function du(){const e=ea.filter(i=>i.status==="issued"),n=e.filter(i=>cu(i.issue_date)),a=n.reduce((i,r)=>i+Number(r.grand_total||0),0),s=ea.filter(i=>i.status==="draft").length,o=e.filter(i=>ir(i)!=="paid").reduce((i,r)=>i+(Number(r.grand_total||0)-Number(r.payment.paid_amount||0)),0);return{count:n.length,amount:a,drafts:s,due:o}}function pu(){let e=ea;ta!=="all"&&(e=e.filter(a=>a.status===ta));const n=Rs.trim().toLowerCase();return n&&(e=e.filter(a=>(a.doc_number||"").toLowerCase().indexOf(n)>=0||rr(a).toLowerCase().indexOf(n)>=0)),e}function lr(){const e=pu();return e.length?e.map(n=>{const a=ir(n),s=n.doc_number||t("sx-draft-tag");return`<tr class="click" data-doc="${escapeHtml(n.id)}">
                <td><b>${escapeHtml(s)}</b></td>
                <td style="color:var(--ink-3)">${escapeHtml(qs(n.issue_date))}</td>
                <td>${escapeHtml(Ds(n.doc_type))}</td>
                <td>${escapeHtml(rr(n))}</td>
                ...
                <td class="r"><button class="sx-chev" data-doc="${escapeHtml(n.id)}" aria-label="${escapeHtml(t("sx-detail-title"))}">${ru}</button></td>
            </tr>`}).join(""):`<tr><td colspan="8"><div class="sx-state">${su}<div>${escapeHtml(t("sx-empty"))}</div></div></td></tr>`}function cr(){const e=du(),n=["all","draft","issued","void"].map(a=>`<button data-flt="${a}" class="${ta===a?"on":""}">${escapeHtml(t("sx-f-"+a))}</button>`).join("");return`<div class="sx-cards">
    ...
    <div class="sx-panel"><table class="sx-tbl">
        ...
        <tbody id="sx-wb-tbody">${lr()}</tbody>
    </table></div>`}function uu(){return`<div class="sx-page">
        <div class="sx-head">
            <h2 data-i18n="sx-wb-title">${escapeHtml(t("sx-wb-title"))}</h2>
            
            <div class="sx-actions">
                <button class="btn btn-ghost" id="sx-settings-btn">${ou}<span>${escapeHtml(t("sx-settings"))}</span></button>
                <button class="btn btn-primary" id="sx-new-btn">${iu}<span>${escapeHtml(t("sx-new"))}</span></button>
            </div>
        </div>
        <div id="sx-wb-body"></div>
    </div>`}function Nn(e){const n=document.getElementById("sx-wb-body");n&&(n.innerHTML=e)}function mu(){const e=document.getElementById("sx-wb-tbody");e&&(e.innerHTML=lr()),dr()}function dr(){document.querySelectorAll("#sx-wb-body [data-doc]").forEach(e=>{e.onclick=n=>{n.stopPropagation(),window.openSalesDetail&&window.openSalesDetail(e.dataset.doc)}})}function pr(){document.querySelectorAll("#sx-wb-body [data-flt]").forEach(n=>{n.onclick=()=>{ta=n.dataset.flt,Nn(cr()),pr()}});const e=document.getElementById("sx-wb-search");e&&(e.oninput=()=>{Rs=e.value,mu()}),dr()}function vu(){const e=document.getElementById("sx-new-btn");e&&(e.onclick=()=>window.openSalesWizard?.());const n=document.getElementById("sx-settings-btn");n&&(n.onclick=()=>window.openSalesSettings?.())}async function Fs(){Nn(`<div class="sx-state">${escapeHtml(t("sx-loading"))}</div>`);try{const e=await apiGet("/api/sales/documents");if(!e)return;ea=e.documents||[],Nn(cr()),pr()}catch{Nn(`<div class="sx-state error">${escapeHtml(t("sx-error"))}<br><button class="btn btn-ghost" id="sx-retry">${escapeHtml(t("sx-retry"))}</button></div>`);const n=document.getElementById("sx-retry");n&&(n.onclick=()=>Fs())}}window.loadSalesWorkbench=function(){const e=document.getElementById("page-sales-invoices");e&&(e.dataset.sxInit!=="1"&&(e.innerHTML=uu(),e.dataset.sxInit="1",vu()),Fs())};window.addEventListener("pearnly:sales-changed",()=>{typeof currentRoute<"u"&&currentRoute==="sales-invoices"&&Fs()});(function(){const n=document.querySelector(".nav-sales-head"),a=document.querySelector(".nav-sub2");if(!n||!a)return;const s=i=>{a.classList.toggle("show",i),n.classList.toggle("sx-open",i)},o=(location.hash||"").replace(/^#\//,"");(o==="sales-invoices"||o==="sales-account")&&s(!0),n.addEventListener("click",()=>s(!a.classList.contains("show")))})();const fu='<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6"><path d="M21 8 12 3 3 8l9 5 9-5ZM3 8v8l9 5 9-5V8"/></svg>',hu='<svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8"><path d="M11 4H4v16h16v-7M18.5 2.5a2.1 2.1 0 0 1 3 3L12 15l-4 1 1-4Z"/></svg>',gu='<svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8"><path d="M3 6h18M8 6V4h8v2M6 6l1 14h10l1-14"/></svg>',ur='<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.9"><path d="M18 6 6 18M6 6l12 12"/></svg>';let na=[],zs="";function mr(e){let n=document.getElementById(e);return n||(n=document.createElement("div"),n.id=e,n.className="modal-mask sx-modal-mask",n.style.display="none",document.body.appendChild(n)),n}function Ht(e){const n=document.getElementById(e);n&&(n.style.display="none",n.innerHTML="")}function bu(){const e=zs.trim().toLowerCase();return e?na.filter(n=>[n.code,n.name_th,n.name_en,n.name_zh,n.barcode].filter(Boolean).some(a=>a.toLowerCase().indexOf(e)>=0)):na}function vr(){const e=bu();return e.length?e.map(n=>{const a=n.name_th||n.name_en||n.name_zh||"—";return`<tr>
                <td>${n.image_url?`<img src="${escapeHtml(n.image_url)}" alt="" style="width:34px;height:34px;border-radius:7px;object-fit:cover">`:`<div class="sx-thumb">${fu}</div>`}</td>
                ...
                <td class="r"><button class="sx-chev" data-edit="${escapeHtml(n.id)}">${hu}</button><button class="sx-chev" data-del="${escapeHtml(n.id)}">${gu}</button></td>
            </tr>`}).join(""):`<tr><td colspan="7"><div class="sx-state">${escapeHtml(t("sx-empty"))}</div></td></tr>`}function yu(){return`<div class="sx-toolbar">
    ...
    <div class="sx-panel"><table class="sx-tbl">
        ...
        <tbody id="sx-p-tbody">${vr()}</tbody>
    </table></div>`}function Ma(e){const n=document.getElementById("sx-p-body");n&&(n.innerHTML=e)}function wu(){const e=document.getElementById("sx-p-search");e&&(e.oninput=()=>{zs=e.value;const n=document.getElementById("sx-p-tbody");n&&(n.innerHTML=vr()),Fo()}),document.getElementById("sx-p-add").onclick=()=>fr(null),document.getElementById("sx-p-import").onclick=Iu,Fo()}function Fo(){document.querySelectorAll("#sx-p-body [data-edit]").forEach(e=>{e.onclick=()=>fr(na.find(n=>n.id===e.dataset.edit)||null)}),document.querySelectorAll("#sx-p-body [data-del]").forEach(e=>{e.onclick=()=>Eu(e.dataset.del)})}function fr(e){const n=mr("sales-prod-mask");n.innerHTML=`<div class="modal" role="dialog" style="max-width:560px">
        <div class="modal-header"><div class="modal-title">${escapeHtml(t(e?"sx-p-edit":"sx-p-new"))}</div>
            <button class="modal-close" id="sx-p-close">${ur}</button></div>
        <div class="modal-body">
            <div class="form-row form-row-2col">
                <div><label>${escapeHtml(t("sx-p-f-code"))}</label><input type="text" id="sx-pf-code" value="${we(e?.code)}" maxlength="100"><div class="sx-field-err" id="sx-pf-code-err"></div></div>
                <div><label>${escapeHtml(t("sx-p-f-barcode"))}</label><input type="text" id="sx-pf-barcode" value="${we(e?.barcode)}" maxlength="100"></div>
            </div>
            <div class="form-row"><label>${escapeHtml(t("sx-p-f-name-th"))} *</label><input type="text" id="sx-pf-th" value="${we(e?.name_th)}" maxlength="300"></div>
            <div class="form-row form-row-2col">
                <div><label>${escapeHtml(t("sx-p-f-name-en"))}</label><input type="text" id="sx-pf-en" value="${we(e?.name_en)}" maxlength="300"></div>
                <div><label>${escapeHtml(t("sx-p-f-name-zh"))}</label><input type="text" id="sx-pf-zh" value="${we(e?.name_zh)}" maxlength="300"></div>
            </div>
            <div class="form-row form-row-2col">
                <div><label>${escapeHtml(t("sx-p-f-unit"))}</label><input type="text" id="sx-pf-unit" value="${we(e?.unit)}" maxlength="50"></div>
            ...
            <div class="form-row"><label>${escapeHtml(t("sx-p-f-image"))}</label><input type="text" id="sx-pf-image" value="${we(e?.image_url)}" maxlength="1000" placeholder="https://…"></div>
        </div>
        <div class="modal-footer" style="justify-content:space-between;gap:8px">
        ...
        </div></div>`,n.style.display="flex",document.getElementById("sx-p-close").onclick=()=>Ht("sales-prod-mask"),document.getElementById("sx-p-cancel").onclick=()=>Ht("sales-prod-mask"),n.onclick=a=>{a.target===n&&Ht("sales-prod-mask")},document.getElementById("sx-p-save").onclick=()=>_u(e)}function ku(){const e=n=>document.getElementById(n).value.trim();return{name_th:e("sx-pf-th"),code:e("sx-pf-code")||null,barcode:e("sx-pf-barcode")||null,name_en:e("sx-pf-en")||null,name_zh:e("sx-pf-zh")||null,unit:e("sx-pf-unit")||null,unit_price:Number(e("sx-pf-price"))||0,vat_applicable:document.getElementById("sx-pf-vat").checked,image_url:e("sx-pf-image")||null}}async function xu(e,n){const a=await e.json().catch(()=>({})),s=a&&a.detail?String(a.detail):"HTTP "+e.status;return t(n)+" · "+s}function zo(e){const n=document.getElementById("sx-pf-code-err");n&&(n.textContent=e)}async function _u(e){const n=ku();if(zo(""),!n.name_th)return showToast(t("sx-p-name-required"),"error");const a=e?`/api/sales/products/${e.id}`:"/api/sales/products";try{const s=await xt(a,{method:e?"PATCH":"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(n)});if(!s.ok){const o=await s.json().catch(()=>({})),i=o&&o.detail?String(o.detail):"HTTP "+s.status;if(i==="sales.product_code_exists"){zo(t("sales.product_code_exists")),document.getElementById("sx-pf-code")?.focus();return}showToast(t("sx-p-save-fail")+" · "+i,"error");return}Ht("sales-prod-mask"),showToast(t("sx-p-saved"),"success"),await In()}catch{showToast(t("sx-p-save-fail"),"error")}}async function Eu(e){if(window.pearnlyConfirm){if(!await window.pearnlyConfirm(t("sx-p-del-confirm")))return}else if(!confirm(t("sx-p-del-confirm")))return;try{const n=await xt(`/api/sales/products/${e}`,{method:"DELETE"});if(!n.ok){showToast(await xu(n,"sx-p-del-fail"),"error");return}showToast(t("sx-p-deleted"),"success"),await In()}catch{showToast(t("sx-p-del-fail"),"error")}}function Iu(){const e=mr("sales-prod-mask");e.innerHTML=`<div class="modal" role="dialog" style="max-width:480px">
        <div class="modal-header"><div class="modal-title">${escapeHtml(t("sx-p-import-title"))}</div>
            <button class="modal-close" id="sx-imp-close">${ur}</button></div>
        <div class="modal-body">
        ...
        </div></div>`,e.style.display="flex",document.getElementById("sx-imp-close").onclick=()=>Ht("sales-prod-mask"),document.getElementById("sx-imp-cancel").onclick=()=>Ht("sales-prod-mask"),document.getElementById("sx-imp-go").onclick=Bu}async function Bu(){const e=document.getElementById("sx-imp-file").files?.[0];if(!e)return showToast(t("sx-p-import-pick"),"error");const n=new FormData;n.append("file",e);try{const a=await xt("/api/sales/products/import",{method:"POST",body:n}),s=await a.json().catch(()=>({}));if(!a.ok)throw new Error;Ht("sales-prod-mask"),showToast(t("sx-p-import-done").replace("{n}",String(s.imported??0)),"success"),await In()}catch{showToast(t("sx-p-import-fail"),"error")}}async function In(){Ma(`<div class="sx-state">${escapeHtml(t("sx-loading"))}</div>`);try{const e=await apiGet("/api/sales/products");if(!e)return;na=e.products||[],Ma(yu()),wu()}catch{Ma(`<div class="sx-state error">${escapeHtml(t("sx-error"))}<br><button class="btn btn-ghost" id="sx-p-retry">${escapeHtml(t("sx-retry"))}</button></div>`);const n=document.getElementById("sx-p-retry");n&&(n.onclick=()=>In())}}window.loadSalesProducts=function(){const e=document.getElementById("page-sales-products");e&&(e.dataset.sxInit!=="1"&&(e.innerHTML=`<div class="sx-page"><div class="sx-head"><h2>${escapeHtml(t("nav-sales-products"))}</h2></div><div id="sx-p-body"></div></div>`,e.dataset.sxInit="1"),In())};const Lu=["classic","clean","brand","compact","official","mono"],$u=["#2563eb","#0f766e","#b45309","#7c3aed","#be123c","#111827"];let Ns=[],ya=0,Ge="classic",Pt="#2563eb";function Bn(){return Ns[ya]}function Su(){const e=Bn();if(!e)return`<div class="sx-state">${escapeHtml(t("sx-acc-none"))}</div>`;const n=Ns.map((o,i)=>`<option value="${i}" ${i===ya?"selected":""}>${escapeHtml(o.name||"—")}</option>`).join(""),a=Lu.map(o=>{const i=o==="brand"||o==="official"?Pt:"#111827",r=o==="brand"?`<div class="sx-tpl-bar" style="background:${i}"></div>`:"";return`<div class="sx-tpl ${Ge===o?"on":""}" data-tpl="${o}"><div class="sx-tpl-pv">${r}<div class="sx-tpl-co" style="color:${i};${o==="official"?"text-align:center;":""}">บริษัท ตัวอย่าง</div><div class="sx-tpl-ln">รายการ … 1,000</div><div class="sx-tpl-tt">รวม 1,070</div></div><div class="sx-tpl-nm">${escapeHtml(t("sx-acc-tpl-"+o))}</div></div>`}).join(""),s=$u.map(o=>`<span class="sx-sw ${Pt===o?"on":""}" data-color="${o}" style="background:${o}"></span>`).join("");return`<div class="sx-acc-2col">
      <div class="sx-acc-form">
        ...
        <div class="sx-acc-grid">
            <div class="sx-field"><label>${escapeHtml(t("sx-acc-name"))}</label><input type="text" id="sx-a-name" value="${we(e.name)}" maxlength="200"></div>
            <div class="sx-field"><label>${escapeHtml(t("sx-acc-tax"))}</label><input type="text" id="sx-a-tax" value="${we(e.tax_id)}" maxlength="20"></div>
        </div>
        <div class="sx-field"><label>${escapeHtml(t("sx-acc-address"))}</label><input type="text" id="sx-a-addr" value="${we(e.address)}" maxlength="500"></div>
        <div class="sx-acc-grid">
            <div class="sx-field"><label>${escapeHtml(t("sx-acc-branch"))}</label><input type="text" id="sx-a-branch" value="${we(e.branch)}" maxlength="120"></div>
            <div class="sx-field"><label>${escapeHtml(t("sx-acc-phone"))}</label><input type="text" id="sx-a-phone" value="${we(e.phone)}" maxlength="50"></div>
        </div>
        <div class="sx-field"><label>${escapeHtml(t("sx-acc-promptpay"))}</label><input type="text" id="sx-a-pp" value="${we(e.promptpay_id)}" maxlength="40" placeholder="08x-xxx-xxxx / ${escapeHtml(t("sx-acc-tax"))}"></div>

        <div class="sx-head" style="margin-top:18px"><h2 style="font-size:14px">${escapeHtml(t("sx-acc-sec-brand"))}</h2></div>
        <div class="sx-acc-grid">
            <div class="sx-field"><label>${escapeHtml(t("sx-acc-logo"))}</label><input type="text" id="sx-a-logo" value="${we(e.logo_url)}" maxlength="500" placeholder="https://…"></div>
            <div class="sx-field"><label>${escapeHtml(t("sx-acc-seal"))}</label><input type="text" id="sx-a-seal" value="${we(e.seal_url)}" maxlength="500" placeholder="https://…"></div>
        </div>
        <div class="sx-field"><label>${escapeHtml(t("sx-acc-sign"))}</label><input type="text" id="sx-a-sign" value="${we(e.signature_url)}" maxlength="500" placeholder="https://…"></div>
        <div class="sx-field"><label>${escapeHtml(t("sx-acc-footer"))}</label><textarea id="sx-a-footer" rows="2" maxlength="500">${we(e.footer_text)}</textarea></div>
      ...
      <div class="sx-acc-preview-col">
        ...
        <div id="sx-acc-prev">${hr()}</div>
      </div>
    </div>`}function hr(){const e=Bn();if(!e)return"";const n=Ge==="brand"||Ge==="official"?Pt:"#111827",a=Ge==="brand"?`<div style="height:7px;background:${n};margin:-18px -18px 12px;border-radius:8px 8px 0 0"></div>`:"";return`<div class="sx-prev-inv sx-prev-${Ge}" style="${Ge==="brand"?"border-color:"+n+"55":""}">
        ${a}
    ...
    </div>`}function Ha(){const e=document.getElementById("sx-acc-prev");e&&(e.innerHTML=hr())}function Cu(){const e=document.getElementById("sx-acc-body");e&&(e.innerHTML=Su(),Tu())}function gr(e){ya=e;const n=Bn();Ge=n&&n.template_id||"classic",Pt=n&&n.brand_color||"#2563eb",Cu()}function Tu(){const e=document.getElementById("sx-acc-sel");e&&(e.onchange=()=>gr(+e.value)),document.querySelectorAll("[data-tpl]").forEach(s=>{s.onclick=()=>{Ge=s.dataset.tpl,document.querySelectorAll("[data-tpl]").forEach(o=>o.classList.toggle("on",o.dataset.tpl===Ge)),Ha()}}),document.querySelectorAll("[data-color]").forEach(s=>{s.onclick=()=>{Pt=s.dataset.color,document.querySelectorAll("[data-color]").forEach(o=>o.classList.toggle("on",o.dataset.color===Pt)),Ha()}}),[["sx-a-name",s=>jn().name=s],["sx-a-tax",s=>jn().tax_id=s],["sx-a-branch",s=>jn().branch=s],["sx-a-footer",s=>jn().footer_text=s]].forEach(([s,o])=>{const i=document.getElementById(s);i&&(i.oninput=()=>{o(i.value),Ha()})});const a=document.getElementById("sx-a-save");a&&(a.onclick=Mu)}function jn(){return Bn()}async function Mu(){const e=Bn();if(!e)return;const n=s=>document.getElementById(s).value.trim(),a={name:n("sx-a-name"),tax_id:n("sx-a-tax")||null,address:n("sx-a-addr")||null,branch:n("sx-a-branch")||null,phone:n("sx-a-phone")||null,promptpay_id:n("sx-a-pp")||null,logo_url:n("sx-a-logo")||null,seal_url:n("sx-a-seal")||null,signature_url:n("sx-a-sign")||null,footer_text:document.getElementById("sx-a-footer").value.trim()||null,template_id:Ge,brand_color:Pt};try{if(!(await xt(`/api/sales/sellers/${e.id}`,{method:"PUT",headers:{"Content-Type":"application/json"},body:JSON.stringify(a)})).ok)throw new Error;Object.assign(e,a),showToast(t("sx-acc-saved"),"success")}catch{showToast(t("sx-acc-save-fail"),"error")}}async function br(){const e=document.getElementById("sx-acc-body");e&&(e.innerHTML=`<div class="sx-state">${escapeHtml(t("sx-loading"))}</div>`);try{const n=await apiGet("/api/sales/sellers");if(!n)return;Ns=n.sellers||[],ya=0,gr(0)}catch{e&&(e.innerHTML=`<div class="sx-state error">${escapeHtml(t("sx-error"))}<br><button class="btn btn-ghost" id="sx-acc-retry">${escapeHtml(t("sx-retry"))}</button></div>`);const a=document.getElementById("sx-acc-retry");a&&(a.onclick=()=>br())}}window.loadSalesAccount=function(){const e=document.getElementById("page-sales-account");e&&(e.dataset.sxInit!=="1"&&(e.innerHTML=`<div class="sx-page"><div class="sx-head"><h2>${escapeHtml(t("nav-sales-account"))}</h2></div><div id="sx-acc-body" style="max-width:1040px"></div></div>`,e.dataset.sxInit="1"),br())};const Hu='<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.9"><path d="M18 6 6 18M6 6l12 12"/></svg>',No=[["0","sx-wht-none"],["1","sx-wht-transport"],["2","sx-wht-ad"],["3","sx-wht-service"],["5","sx-wht-rent"]];let ve;function et(){let e=document.getElementById("sales-settings-mask");return e||(e=document.createElement("div"),e.id="sales-settings-mask",e.className="modal-mask sx-modal-mask",e.style.display="none",document.body.appendChild(e)),e}function aa(){const e=document.getElementById("sales-settings-mask");e&&(e.style.display="none",e.innerHTML="")}function on(e,n){return`<div class="sx-seg" data-seg="${String(e)}" style="width:100%">${n.map(a=>`<button type="button" data-seg-v="${a[0]}" class="${String(ve[e])===a[0]?"on":""}" style="flex:1">${escapeHtml(a[1])}</button>`).join("")}</div>`}function yr(){const e=ve.number_prefix||"INV",n=new Date().getFullYear();return`${escapeHtml(e)}${n}-00001`}function Au(){const e=String(Number(ve.default_wht_rate)||0),n=No.some(s=>s[0]===e),a=No.map(([s,o])=>`<option value="${s}" ${e===s?"selected":""}>${s}% ${escapeHtml(t(o))}</option>`).join("")+`<option value="custom" ${n?"":"selected"}>${escapeHtml(t("sx-wht-custom"))}</option>`;et().innerHTML=`<div class="modal" role="dialog" style="max-width:560px">
        <div class="modal-header"><div class="modal-title">${escapeHtml(t("sx-set-title"))}</div>
            <button class="modal-close" id="sx-set-close">${Hu}</button></div>
        <div class="modal-body">
            <div class="sx-set-card">
                ...
                <div class="sx-hint">${escapeHtml(t("sx-set-num-preview"))}: <b id="sx-set-preview">${yr()}</b> · ${escapeHtml(t("sx-set-num-preview-note"))}</div>
            </div>
            <div class="sx-set-card">
        ...
        <div class="sw-inv-tot">
            <div class="sw-tr"><span>${xe(e,"subtotal")}</span><span>${be(o.subAfter)}</span></div>
            <div class="sw-tr"><span>VAT ${e.vatRate}%</span><span>${be(o.vat)}</span></div>
            ${o.wht>0?`<div class="sw-tr"><span>${xe(e,"wht")}</span><span>-${be(o.wht)}</span></div>`:""}
            <div class="sw-tr g"><span>${xe(e,"grand")}</span><span>฿ ${be(o.grand)}</span></div>
        </div>
        ...
        <div class="sw-sectitle">${escapeHtml(C("orManual"))}</div><div class="sw-choices">${s}</div></div>`}function rm(e){const n=Ln(),a=xr(),s=a[e.sellerIdx],o=a.map((f,y)=>`<option value="${y}" ${y===e.sellerIdx?"selected":""}>${escapeHtml(f.name||"—")}</option>`).join(""),i=n.bt.map(f=>`<div class="sw-choice ${e.buyer.type===f[0]?"on":""}" data-bt="${f[0]}" style="padding:10px 12px"><div class="sw-ck">${ye.check}</div><div><div class="sw-t">${escapeHtml(f[1])}</div><div class="sw-d">${escapeHtml(f[2])}</div></div></div>`).join(""),r=e.buyer,l=r.type==="anonymous",m=r.type==="company",d=r.type==="individual"?C("natid"):r.type==="foreigner"?C("passport"):C("tin"),p=l?"":'<span class="sw-req">*</span>';let c="";l||(r.type==="foreigner"?r.tin&&!/^[A-Za-z0-9]{4,20}$/.test(r.tin)&&(c=`<div class="sw-hint err">${escapeHtml(C("passErr"))}</div>`):r.tin&&!/^\d{13}$/.test(r.tin)?c=`<div class="sw-hint err">${escapeHtml(C("tinErr"))}</div>`:r.type==="individual"&&(c=`<div class="sw-hint info">${ye.info} ${escapeHtml(C("tinHintInd"))}</div>`));const u=s?`${escapeHtml(s.name||"")} · ${escapeHtml(s.tax_id||"")} · ${escapeHtml(s.branch||"")}`:"—",v=l?`<div class="sw-banner warn">${ye.info}<span>${escapeHtml(C("anonNote"))}</span></div>
           ...
           ${m?lm(e):""}`;return`<div class="sw-card"><h2>${escapeHtml(C("s2h"))}</h2><div class="sw-sub">${escapeHtml(C("s2sub"))}</div>
        ...
        <div style="margin-top:16px">${v}</div></div>`}function lm(e){const n=e.buyer,a=n.branchNo&&!/^\d{5}$/.test(n.branchNo);return`<div class="sw-field"><label>${escapeHtml(C("branch"))} <span class="sw-req">*</span></label>
        ...
        ${n.branchType==="branch"?`<input type="text" id="sw-brno" value="${escapeHtml(n.branchNo)}" placeholder="${escapeHtml(C("brno"))} (5)">${a?`<div class="sw-hint err">${escapeHtml(C("brErr"))}</div>`:""}`:""}</div>`}function cm(e){const n=wa(e),a=_r(),s=a.map((l,m)=>`<div class="sw-pcard" data-add="${m}"><div class="sw-pimg" style="background:${Go[m%Go.length]}">${l.image_url?`<img src="${escapeHtml(l.image_url)}" alt="">`:ye.box}</div><div class="sw-pn">${escapeHtml(Ir(l))}</div><div class="sw-pp">฿${be(l.unit_price)}${l.vat_applicable?"":` <span class="sw-muted" style="font-size:10px">${escapeHtml(C("taxFree"))}</span>`}</div></div>`).join(""),o=a.length?"":'<div class="sw-muted" style="padding:20px;text-align:center">—</div>',r=e.lines.some(l=>l.desc||+l.price||l.custom)?e.lines.map((l,m)=>`<div class="sw-citem">
        ...
        </div></div>`}function dm(e){const n=Ln(),a=wa(e);if(!Os(e))return`<div class="sw-card"><h2>${escapeHtml(C("s4h"))}</h2><div class="sw-sub">${escapeHtml(C("s4sub"))}</div>
            <div class="sw-banner">${ye.info}<span>${escapeHtml(C("payNA"))}</span></div>${Wo(e)}</div>`;const s=e.pay,o=n.methods.map(i=>`<option value="${i[0]}" ${s.method===i[0]?"selected":""}>${escapeHtml(i[1])}</option>`).join("");return`<div class="sw-card"><h2>${escapeHtml(C("s4h"))}</h2><div class="sw-sub">${escapeHtml(C("s4sub"))}</div>
        ${On(e)?`<div class="sw-banner warn">${ye.info}<span>${escapeHtml(C("payReqWarn"))}</span></div>`:""}
        ...
        ${Wo(e)}</div>`}function Wo(e){return`<div class="sw-sectitle">${escapeHtml(C("issueDate"))}</div><div class="sw-row3">
    ...
    </div>`,ue().style.display="flex",um()}function Ve(e,n,a=!1){const s=document.getElementById(e);s&&(s.oninput=()=>n(s.value),a&&(s.onblur=me))}function um(){document.getElementById("sw-close").onclick=ns,document.getElementById("sw-back").onclick=()=>Ko(-1),document.getElementById("sw-next").onclick=()=>Ko(1),document.getElementById("sw-draft").onclick=wm,ue().querySelectorAll("[data-doc]").forEach(o=>o.onclick=()=>(V.docType=o.dataset.doc,me())),ue().querySelectorAll("[data-sc]").forEach(o=>o.onclick=()=>bm(+o.dataset.sc));const e=document.getElementById("sw-seller");e&&(e.onchange=()=>(V.sellerIdx=+e.value,me())),ue().querySelectorAll("[data-bt]").forEach(o=>o.onclick=()=>mm(o.dataset.bt)),ue().querySelectorAll("[data-brt]").forEach(o=>o.onclick=()=>(V.buyer.branchType=o.dataset.brt,o.dataset.brt==="hq"&&(V.buyer.branchNo=""),me())),Ve("sw-bname",o=>V.buyer.name=o),Ve("sw-baddr",o=>V.buyer.addr=o),Ve("sw-btin",o=>(V.buyer.tin=o,V.buyer.verified=!1),!0),Ve("sw-brno",o=>V.buyer.branchNo=o,!0);const n=document.getElementById("sw-rd");n&&(n.onclick=ym),ue().querySelectorAll("[data-add]").forEach(o=>o.onclick=()=>vm(+o.dataset.add)),ue().querySelectorAll("[data-q]").forEach(o=>o.onclick=()=>fm(+o.dataset.q,+o.dataset.d)),ue().querySelectorAll("[data-rm]").forEach(o=>o.onclick=()=>hm(+o.dataset.rm)),ue().querySelectorAll("[data-ln]").forEach(o=>{const i=+o.dataset.ln,r=o.dataset.f;o.oninput=()=>V.lines[i][r]=o.value,o.onblur=me});const a=document.getElementById("sw-addcustom");a&&(a.onclick=()=>(V.lines.push({desc:"",qty:1,price:0,disc:0,vat:!0,custom:!0}),me())),ue().querySelectorAll("[data-save]").forEach(o=>o.onchange=()=>V.lines[+o.dataset.save].save=o.checked),Ve("sw-hdisc",o=>V.hdisc=o,!0),Ve("sw-vat",o=>V.vatRate=o,!0),Ve("sw-wht",o=>V.whtRate=o,!0),ue().querySelectorAll("[data-ps]").forEach(o=>o.onclick=()=>(V.pay.status=o.dataset.ps,me()));const s=document.getElementById("sw-pm");s&&(s.onchange=()=>V.pay.method=s.value),Ve("sw-pdate",o=>V.pay.date=o),Ve("sw-paid",o=>V.pay.paidAmt=o),Ve("sw-idate",o=>V.issueDate=o),Ve("sw-ddate",o=>V.dueDate=o),ue().querySelectorAll("[data-cal]").forEach(o=>o.onclick=()=>(V.be=o.dataset.cal==="be",me())),ue().querySelectorAll("[data-paper]").forEach(o=>o.onclick=()=>(V.paper=o.dataset.paper,me())),ue().querySelectorAll("[data-dlang]").forEach(o=>o.onclick=()=>(V.docLang=o.dataset.dlang,me())),ue().querySelectorAll("[data-layout]").forEach(o=>o.onclick=()=>(V.layout=o.dataset.layout,me()))}function Ko(e){const n=qe+e;if(!(n<0||n>4)){if(e>0&&qe===4)return void km();qe=n,me()}}function mm(e){V.buyer.type!==e&&(V.buyer.type=e,V.buyer.tin="",V.buyer.verified=!1,V.buyer.branchType="hq",V.buyer.branchNo="",me())}function vm(e){const n=_r()[e];if(!n)return;const a=Ir(n),s=V.lines.find(o=>o.product_id===n.id);s?s.qty=(+s.qty||0)+1:V.lines.push({desc:a,qty:1,price:n.unit_price,disc:0,vat:n.vat_applicable,product_id:n.id}),me()}function fm(e,n){V.lines[e].qty=Math.max(0,(+V.lines[e].qty||0)+n),+V.lines[e].qty==0&&V.lines.splice(e,1),me()}function hm(e){V.lines.splice(e,1),me()}const gm=[["tax_invoice_receipt","individual","paid","cash"],["tax_invoice","company","unpaid","transfer"],["tax_invoice_receipt","individual","paid","transfer"],["tax_invoice_simple","anonymous","paid","cash"]];function bm(e){const n=gm[e];if(!n)return;const[a,s,o,i]=n;V.docType=a,V.buyer={type:s,name:"",addr:"",tin:"",branchType:"hq",branchNo:""},V.pay={status:o,method:i,date:ts(),paidAmt:null},qe=0,me()}async function ym(){const e=V.buyer;if(!e.tin)return showToast(C("rdNeedTin"),"error");if(e.type==="company"){if(!/^\d{13}$/.test(e.tin))return showToast(C("rdCo13"),"error");const n=await Wu(e.tin,0);if(!n.found)return showToast(C("lookupFail"),"error");n.name&&(e.name=n.name),n.address&&(e.addr=n.address),e.branchType="hq",e.branchNo="",e.verified=!0}else{if(!(await Gu(e.tin)).valid)return showToast(C("verifyFail"),"error");e.verified=!0}me()}async function wm(){if(!V.lines.some(n=>(n.desc||"").trim()))return showToast(C("needLines"),"error");const e=await Er(V);e.ok?(V.draftId=e.id||V.draftId,showToast(C("draftSaved"),"success"),window.dispatchEvent(new CustomEvent("pearnly:sales-changed"))):showToast(C("saveFail")+(e.error?" · "+e.error:""),"error")}async function km(){const e=wr(V).filter(a=>a.req&&!a.pass);if(e.length)return showToast(C("blockers")+" "+e.map(a=>C(a.key)).join(", "),"error");if(!V.lines.some(a=>(a.desc||"").trim()))return showToast(C("needLines"),"error");const n=await Yu(V);n.ok&&n.id?(xm(n.id),window.dispatchEvent(new CustomEvent("pearnly:sales-changed"))):showToast(C("issueFail")+(n.error?" · "+n.error:""),"error")}function xm(e){ue().innerHTML=`<div class="sw-okwrap"><div class="sw-okbox">
        ...
        </div></div></div>`,ue().style.display="flex",document.getElementById("sw-ok-done").onclick=ns,document.getElementById("sw-ok-new").onclick=()=>{V=Br(),qe=0,me()},document.getElementById("sw-ok-view").onclick=()=>{ns(),window.openSalesDetail&&window.openSalesDetail(e)}}window.openSalesWizard=async function(){V=Br(),qe=0;const e=typeof currentLang<"u"&&currentLang||localStorage.getItem("mrpilot_lang")||"th";em(e),ue().innerHTML=`<div class="sw-wrap"><div class="sw-card"><div class="sx-state">${escapeHtml(C("s1h"))}…</div></div></div>`,ue().style.display="flex",await Uu(),me()};const _m=`
    <div class="cmdk">
...
`;$e("cmdk-mask",_m);(function(){function e(c){try{if(location.search.indexOf("test_center=1")>=0||localStorage.getItem("pearnly_test_mode")==="1"||c&&c.id&&String(c.id)==="468b50c1-5593-4fd6-990d-515ce8085563")return!0}catch{}return!1}window.applyRoleVisibility=function(){var u=window._userInfo,v=!1,f=!0,y=!1,b=!1;u&&(v=typeof canManageTeam=="function"?canManageTeam(u):!!(u.role==="owner"||u.is_super_admin),f=typeof shouldHideMoney=="function"?shouldHideMoney(u):u.role==="member"&&!u.is_super_admin,y=typeof isSuperAdmin=="function"?isSuperAdmin(u):!!u.is_super_admin,b=e(u)),document.querySelectorAll("[data-show-if-team]").forEach(function(g){g.style.display=v?"":"none"}),document.querySelectorAll("[data-show-if-money]").forEach(function(g){g.style.display=f?"none":""}),document.querySelectorAll("[data-show-if-admin]").forEach(function(g){g.style.display=y?"":"none"}),document.querySelectorAll("[data-show-if-test]").forEach(function(g){g.style.display=b?"":"none"});var h=y||b;document.querySelectorAll("[data-show-if-special]").forEach(function(g){g.style.display=h?"":"none"})},window.renderAvatarMenu=function(u){if(u){var v=document.getElementById("avatar-btn"),f=document.getElementById("avatar-popup-name"),y=document.getElementById("avatar-popup-email");if(!(!v||!f||!y)){var b=(u.username||"").trim(),h=b.split("@")[0]||b||"—",g=(b.charAt(0)||"?").toUpperCase(),_=(u.avatar_url||"").trim();if(_){var w=_.replace(/"/g,"&quot;"),k=g.replace(/'/g,"\\'");v.innerHTML='<img src="'+w+'" alt="'+g+`" referrerpolicy="no-referrer" onerror="this.parentNode.textContent='`+k+`'">`}else v.textContent=g;f.textContent=h,y.textContent=b||"—",v.setAttribute("title",b||"")}}};function n(){var c=document.getElementById("avatar-wrap"),u=document.getElementById("avatar-btn"),v=document.getElementById("avatar-popup");if(!c||!u||!v)return;function f(){v.classList.remove("show"),u.setAttribute("aria-expanded","false")}function y(){v.classList.add("show"),u.setAttribute("aria-expanded","true")}u.addEventListener("click",function(b){b.stopPropagation(),v.classList.contains("show")?f():y()}),document.addEventListener("click",function(b){v.classList.contains("show")&&!c.contains(b.target)&&f()}),v.addEventListener("click",function(b){var h=b.target.closest(".avatar-popup-item");if(h){var g=h.dataset.action;switch(f(),g){case"settings":typeof openSettingsModal=="function"?openSettingsModal():typeof routeTo=="function"&&routeTo("settings");break;case"team":typeof openSettingsModal=="function"?openSettingsModal():typeof routeTo=="function"&&routeTo("settings"),setTimeout(function(){typeof switchSettingsTab=="function"&&switchSettingsTab("team")},50);break;case"billing":typeof openSettingsModal=="function"?openSettingsModal():typeof routeTo=="function"&&routeTo("settings"),setTimeout(function(){typeof switchSettingsTab=="function"&&switchSettingsTab("plan")},50);break;case"shortcuts":if(typeof showToast=="function"){var _=typeof t=="function"?t("feature-coming-soon"):"即将上线";showToast(_||"即将上线","info")}break;case"admin":window.location.href="/admin/cost";break;case"test-center":typeof routeTo=="function"&&routeTo("test-center");break;case"help":var w=document.getElementById("help-modal");w&&(w.style.display="flex");break;case"logout":try{localStorage.removeItem("mrpilot_token")}catch{}try{localStorage.removeItem("mrpilot_user")}catch{}window.location.href="/";break}}}),window._closeAvatarPopup=f}function a(){return[].slice.call(document.querySelectorAll(".cmdk-item")).filter(function(c){return c.style.display!=="none"})}function s(c){var u=a();u.forEach(function(v){v.classList.remove("focus")}),u[c]&&(u[c].classList.add("focus"),u[c].scrollIntoView({block:"nearest"}))}function o(c){var u=a();if(u.length){var v=u.findIndex(function(y){return y.classList.contains("focus")});v<0&&(v=0);var f=(v+c+u.length)%u.length;s(f)}}function i(c){c=(c||"").toLowerCase().trim();var u=0,v=window._userInfo,f=typeof isSuperAdmin=="function"?isSuperAdmin(v):!!(v&&v.is_super_admin),y=e(v);document.querySelectorAll(".cmdk-item").forEach(function(h){if(h.dataset.showIfAdmin==="1"&&!f){h.style.display="none";return}if(h.dataset.showIfTest==="1"&&!y){h.style.display="none";return}var g=(h.dataset.cmdkText||h.textContent||"").toLowerCase(),_=!c||g.indexOf(c)>=0;h.style.display=_?"":"none",h.classList.remove("focus"),_&&u++}),document.querySelectorAll("[data-cmdk-section]").forEach(function(h){for(var g=h.nextElementSibling,_=!1;g&&!g.hasAttribute("data-cmdk-section");){if(g.classList&&g.classList.contains("cmdk-item")&&g.style.display!=="none"){_=!0;break}g=g.nextElementSibling}h.style.display=_?"":"none"});var b=document.getElementById("cmdk-empty");b&&(b.style.display=u===0?"flex":"none"),s(0)}window.openCmdk=function(){var u=document.getElementById("cmdk-mask");u&&(typeof window._closeAvatarPopup=="function"&&window._closeAvatarPopup(),u.classList.add("show"),typeof window.applyRoleVisibility=="function"&&window.applyRoleVisibility(),setTimeout(function(){var v=document.getElementById("cmdk-input");v&&(v.value="",i(""),v.focus(),s(0))},50))},window.closeCmdk=function(){var u=document.getElementById("cmdk-mask");u&&u.classList.remove("show")};function r(c){if(c){if(c.classList.contains("cmdk-item-locked")){if(typeof showToast=="function"){var u=typeof t=="function"?t("feature-coming-soon"):"即将上线";showToast(u||"即将上线","info")}return}var v=c.dataset.cmdkRoute,f=c.dataset.cmdkAction;if(window.closeCmdk(),v){typeof routeTo=="function"&&routeTo(v);return}if(f){if(f==="open-admin"){window.location.href="/admin/cost";return}if(f.indexOf("lang-")===0){var y=f.slice(5);typeof applyLang=="function"&&applyLang(y)}}}}function l(){var c=document.getElementById("cmdk-mask"),u=document.getElementById("cmdk-input"),v=document.getElementById("cmdk-body");if(!(!c||!u||!v)){c.addEventListener("click",function(b){b.target===c&&window.closeCmdk()});var f=document.getElementById("cmdk-esc-btn");f&&f.addEventListener("click",function(){window.closeCmdk()}),u.addEventListener("input",function(b){i(b.target.value)}),u.addEventListener("keydown",function(b){b.key==="ArrowDown"?(b.preventDefault(),o(1)):b.key==="ArrowUp"?(b.preventDefault(),o(-1)):b.key==="Enter"?(b.preventDefault(),r(c.querySelector(".cmdk-item.focus"))):b.key==="Escape"&&(b.preventDefault(),window.closeCmdk())}),v.addEventListener("click",function(b){var h=b.target.closest(".cmdk-item");h&&r(h)}),v.addEventListener("mousemove",function(b){var h=b.target.closest(".cmdk-item");!h||h.style.display==="none"||h.classList.contains("cmdk-item-locked")||(a().forEach(function(g){g.classList.remove("focus")}),h.classList.add("focus"))});var y=document.getElementById("topbar-search");y&&(y.addEventListener("click",function(){window.openCmdk()}),y.addEventListener("keydown",function(b){(b.key==="Enter"||b.key===" ")&&(b.preventDefault(),window.openCmdk())}))}}document.addEventListener("keydown",function(c){if((c.metaKey||c.ctrlKey)&&(c.key==="k"||c.key==="K")){c.preventDefault(),window.openCmdk();return}if(c.key==="Escape"){var u=document.getElementById("cmdk-mask");if(u&&u.classList.contains("show")){window.closeCmdk();return}var v=document.getElementById("avatar-popup");v&&v.classList.contains("show")&&typeof window._closeAvatarPopup=="function"&&window._closeAvatarPopup()}});try{var m=(navigator.userAgent||"").toLowerCase(),d=m.indexOf("mac")>=0||m.indexOf("iphone")>=0||m.indexOf("ipad")>=0;d||document.body.classList.add("is-windows")}catch{}function p(){n(),l(),typeof window.subscribeI18n=="function"&&window.subscribeI18n("nav-ia-phase1-role",function(){try{typeof window.applyRoleVisibility=="function"&&window.applyRoleVisibility()}catch{}})}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",p):p()})();(function(){function n(f){return String(f??"").replace(/[&<>"']/g,function(y){return{"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"}[y]})}function a(f){if(!f||isNaN(f))return"";var y=Number(f);return y<1024?y+" B":y<1024*1024?(y/1024).toFixed(1)+" KB":(y/1024/1024).toFixed(1)+" MB"}document.addEventListener("click",function(f){var y=f.target.closest&&f.target.closest(".recon-collapse-head");if(y&&!(f.target.closest("button")||f.target.closest("a"))){var b=y.closest(".recon-collapse");if(b){var h=b.getAttribute("data-collapsed")==="true";b.setAttribute("data-collapsed",h?"false":"true"),h&&(b.id==="vex-summary-collapse"&&p(),b.id==="vex-detail-collapse"&&c())}}}),document.addEventListener("keydown",function(f){if(!(f.key!=="Enter"&&f.key!==" ")){var y=f.target.closest&&f.target.closest(".recon-collapse-head");y&&(f.preventDefault(),y.click())}});var s={vat:"",gl:""};window._glvClearPreviewSearch=function(){s.vat="",s.gl=""};var o='<svg class="vex-pp-fi-icon" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#111111" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/></svg>',i='<svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg>';function r(){m("vat"),m("gl")}function l(f){try{if(typeof window._glvPreviewFiles=="function")return window._glvPreviewFiles(f)||[]}catch{}var y=document.getElementById(f==="vat"?"glv-vat-input":"glv-gl-input");return y&&y.files?Array.from(y.files):[]}function m(f){var y=document.getElementById(f==="vat"?"glv-pp-vat-col":"glv-pp-gl-col");if(y){var b=l(f),h=f==="vat"?"glv-up-vat-title":"glv-up-gl-title",g=f==="vat"?"① 销项税报告":"② 总账 GL",_=window.t&&window.t(h)||g,w=n(window.t&&window.t("vex-preview-search")||"搜索文件名..."),k=n(window.t&&window.t("vex-preview-clear-all")||"全清"),x=s[f]||"",E=b.length;y.innerHTML='<div class="vex-pp-col-title"><span class="vex-pp-col-name">'+n(_)+' <span class="vex-pp-col-count">'+E+'</span></span></div><div class="vex-pp-search-row"><input class="vex-pp-search" id="glv-pp-search-'+f+'" type="text" placeholder="'+w+'" value="'+n(x)+'" autocomplete="off"><button class="vex-pp-clear-btn" id="glv-pp-clearall-'+f+'" type="button">'+k+'</button></div><div class="vex-pp-file-list" id="glv-pp-'+f+'-list"></div><div class="vex-pp-pagination" id="glv-pp-'+f+'-pg"></div>';var I=document.getElementById("glv-pp-search-"+f);I&&I.addEventListener("input",function(L){s[f]=L.target.value,d(f)});var B=document.getElementById("glv-pp-clearall-"+f);B&&B.addEventListener("click",function(){window._glvRemoveFile&&window._glvRemoveFile(f)}),d(f)}}function d(f){var y=document.getElementById("glv-pp-"+f+"-list"),b=document.getElementById("glv-pp-"+f+"-pg");if(y){var h=l(f),g=(s[f]||"").toLowerCase(),_=h.map(function(x,E){return{f:x,i:E}}),w=g?_.filter(function(x){return x.f.name.toLowerCase().indexOf(g)>=0}):_;if(y.innerHTML=w.map(function(x){var E=x.f;return'<div class="vex-pp-file-row">'+o+'<span class="vex-pp-fi-name" title="'+n(E.name)+'">'+n(E.name)+'</span><span class="vex-pp-fi-size">'+a(E.size)+'</span><button class="vex-pp-fi-del" type="button" data-kind="'+f+'" data-idx="'+x.i+'" aria-label="remove">'+i+"</button></div>"}).join(""),y.querySelectorAll(".vex-pp-fi-del").forEach(function(x){x.addEventListener("click",function(){var E=x.dataset.kind,I=parseInt(x.dataset.idx,10);window._glvRemoveFile&&window._glvRemoveFile(E,isNaN(I)?null:I)})}),b){var k=window.t&&window.t("vex-preview-count")||"显示前 {n} / 共 {m}";b.textContent=k.replace("{n}",w.length).replace("{m}",w.length)}}}function p(){var f=function(b,h){var g=document.getElementById(b);g&&(g.textContent=h==null?"—":String(h))},y=window._vexLastTask||{};f("vex-sum-total",y.total),f("vex-sum-matched",y.matched),f("vex-sum-diff",y.diff),f("vex-sum-incomplete",y.incomplete),f("vex-sum-cash",y.cash),document.getElementById("vex-summary-sub")}function c(){var f=window._vexLastTask&&window._vexLastTask.diff_rows||[],y=document.getElementById("vex-detail-tbody"),b=document.getElementById("vex-detail-table"),h=document.getElementById("vex-detail-empty");if(!(!y||!b||!h)){if(f.length===0){b.style.display="none",h.style.display="";return}h.style.display="none",b.style.display="";var g=f.map(function(w){return'<tr><td class="recon-detail-cell-mono">'+n(w.invoice_no||"")+"</td><td>"+n(w.field||"")+"</td><td>"+n(w.report_value||"")+"</td><td>"+n(w.invoice_value||"")+"</td><td>"+n(w.kind||"")+"</td></tr>"}).join("");y.innerHTML=g;var _=document.getElementById("vex-detail-sub");_&&(_.textContent=String(f.length))}}function u(){var f=document.getElementById("glv-toggle-preview");f&&!f._reconBound&&(f._reconBound=!0,f.addEventListener("click",function(){var y=document.getElementById("glv-preview-panel"),b=document.getElementById("glv-toggle-preview-label"),h=y&&y.style.display!=="none";y&&(y.style.display=h?"none":""),f.classList.toggle("open",!h),b&&(b.textContent=h?window.t&&window.t("vex-toggle-preview-open")||"查看清单":window.t&&window.t("vex-toggle-preview-close")||"收起清单"),h||r()})),["glv-vat-input","glv-gl-input"].forEach(function(y){var b=document.getElementById(y);!b||b._reconWatched||(b._reconWatched=!0,b.addEventListener("change",function(){var h=document.getElementById("glv-preview-panel");h&&h.style.display!=="none"&&r()}))})}function v(){var f=document.getElementById("vex-summary-collapse"),y=document.getElementById("vex-detail-collapse");f&&(f.style.display=""),y&&(y.style.display=""),p(),c()}window._fillVexSummary=p,window._fillVexDetail=c,window._onVexResultShown=v,document.addEventListener("DOMContentLoaded",function(){u()}),setTimeout(u,1500),typeof window.subscribeI18n=="function"&&window.subscribeI18n("recon-collapse",function(){var f=document.getElementById("glv-preview-panel");f&&f.style.display!=="none"&&r();var y=document.getElementById("glv-toggle-preview-label"),b=document.getElementById("glv-toggle-preview");y&&b&&(y.textContent=b.classList.contains("open")?window.t&&window.t("vex-toggle-preview-close")||"收起清单":window.t&&window.t("vex-toggle-preview-open")||"查看清单")}),window._reconCollapse={renderGlvPreview:r,fillVexSummary:p,fillVexDetail:c}})();(function(){function e(i){}function n(){const i=document.querySelectorAll("[data-recon-tab]");i.forEach(l=>{l.addEventListener("click",()=>{i.forEach(u=>u.classList.remove("active")),l.classList.add("active");const m=l.dataset.reconTab,d=document.getElementById("recon-pane-bank"),p=document.getElementById("recon-pane-sale-vat"),c=document.getElementById("recon-pane-gl-vat");d&&(d.style.display=m==="bank"?"":"none"),p&&(p.style.display=m==="sale-vat"?"":"none"),c&&(c.style.display=m==="gl-vat"?"":"none"),m==="gl-vat"&&window.GlVatRecon&&window.GlVatRecon.ensureInit(),m==="bank"&&typeof window._bankReconV2Init=="function"&&window._bankReconV2Init()})});const r=document.querySelector("[data-recon-tab].active");r&&(r.dataset.reconTab,void 0)}function a(){const i=document.getElementById("page-settings");if(!i)return null;let r=document.getElementById("settings-modal-overlay");if(r)return r;r=document.createElement("div"),r.id="settings-modal-overlay",r.className="settings-modal-overlay",r.style.display="none",i.parentElement.insertBefore(r,i),r.appendChild(i);const l=document.createElement("button");return l.id="settings-modal-close",l.className="settings-modal-close",l.setAttribute("aria-label","close"),l.innerHTML='<svg viewBox="0 0 20 20" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M5 5l10 10M15 5L5 15"/></svg>',i.insertBefore(l,i.firstChild),l.addEventListener("click",o),r.addEventListener("click",m=>{m.target===r&&o()}),r}function s(){const i=a();if(!i)return;i.style.display="flex",document.body.classList.add("settings-modal-open");const r=document.getElementById("page-settings");r&&(r.style.display="block"),setTimeout(()=>{try{typeof renderSettings=="function"&&renderSettings()}catch(m){console.warn("renderSettings:",m)}let l=document.querySelector(".settings-tab.active")||document.querySelector('.settings-tab[data-tab="profile"]');l&&l.click()},50)}function o(){const i=document.getElementById("settings-modal-overlay");i&&(i.style.display="none"),document.body.classList.remove("settings-modal-open")}window.openSettingsModal=s,window.closeSettingsModal=o,document.addEventListener("keydown",i=>{if(i.key==="Escape"){const r=document.getElementById("settings-modal-overlay");r&&r.style.display==="flex"&&o()}}),window.addEventListener("hashchange",()=>{location.hash==="#/settings"&&s()}),window.addEventListener("DOMContentLoaded",()=>{location.hash==="#/settings"&&s()}),document.readyState==="loading"?document.addEventListener("DOMContentLoaded",n):n()})();const Pa=1e3,ja=30,Gs=/\.(pdf|jpe?g|png|webp|tiff?|xlsx?|xlsm|csv|tsv|docx?)$/i,te=e=>document.getElementById(e);function At(){return{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||"")}}function He(e){const n={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"};return String(e??"").replace(/[&<>"']/g,a=>n[a])}function Lr(e){return e<1024?e+" B":e<1024*1024?(e/1024).toFixed(1)+" KB":(e/1024/1024).toFixed(1)+" MB"}const A={invoiceFiles:[],reportFiles:[],running:!1,vexAllRows:[],previewLimitInv:50,previewLimitRep:50,previewSearchInv:"",previewSearchRep:"",vexPage:1};async function Vn(){try{const e=await fetch("/api/vat_excel/tasks?page=1&page_size=1",{headers:At()});if(!e.ok)return;const a=(await e.json()).kpi||{};[["vex-kpi-month-val",a.this_month],["vex-kpi-running-val",a.running],["vex-kpi-done-val",a.done],["vex-kpi-failed-val",a.failed]].forEach(([s,o])=>{const i=document.getElementById(s);i&&(i.textContent=o??0)})}catch{}}async function Un(){try{const e=await fetch("/api/vat_excel/tasks?page=1&page_size=100",{headers:At()});if(!e.ok)return;const n=await e.json();sa(n.rows||[])}catch{}}const Ot=10;function $r(){var e=((document.getElementById("vex-task-search")||{}).value||"").trim().toLowerCase();if(A.vexPage=1,sa(A.vexAllRows),!!e){var n=document.getElementById("vex-task-tbody");n&&n.querySelectorAll("tr").forEach(function(a){a.dataset.taskId&&(a.style.display=a.textContent.toLowerCase().indexOf(e)>=0?"":"none")})}}function sa(e){A.vexAllRows=e||A.vexAllRows;const n=document.getElementById("vex-task-tbody");if(!n)return;if(!A.vexAllRows.length){n.innerHTML='<tr><td colspan="9" class="vex-task-empty">'+(t("sv-empty-title")||"还没有对账任务")+"</td></tr>",Yo(0);return}const a=Math.ceil(A.vexAllRows.length/Ot);A.vexPage>a&&(A.vexPage=a);const s=(A.vexPage-1)*Ot;Em(A.vexAllRows.slice(s,s+Ot)),Yo(A.vexAllRows.length)}function Yo(e){const n=document.getElementById("vex-task-pager"),a=document.getElementById("vex-task-pager-info"),s=document.getElementById("vex-task-prev"),o=document.getElementById("vex-task-next");if(!n)return;if(e<=Ot){n.style.display="none";return}n.style.display="";const i=Math.ceil(e/Ot);a&&(a.textContent=A.vexPage+" / "+i),s&&(s.disabled=A.vexPage<=1),o&&(o.disabled=A.vexPage>=i)}function Em(e){const n=document.getElementById("vex-task-tbody");if(!n)return;const a={pending:t("vex-status-pending")||"待处理",running:t("vex-status-running")||"处理中",done:t("vex-status-done")||"已完成",failed:t("vex-status-failed")||"失败"},s={pending:"badge-gray",running:"badge-blue",done:"badge-green",failed:"badge-red"},o='<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M8 2v9M4 7l4 4 4-4M3 14h10"/></svg>',i='<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M3 4h10M6 4V3h4v1M5 4v8a1 1 0 001 1h4a1 1 0 001-1V4"/></svg>';n.innerHTML=e.map(r=>{const l=r.created_at?new Date(r.created_at).toLocaleString([],{year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",minute:"2-digit"}):"—",m=r.period||"—",d=r.matched_count!=null?r.matched_count+" ✓ · "+r.mismatched_count+" ⚠":"—",p=r.mismatch_amount!=null?"฿ "+Number(r.mismatch_amount).toLocaleString():"—",c=r.elapsed_seconds!=null?r.elapsed_seconds.toFixed(1)+" s":"—",u=r.status||"pending",v=r.client_name&&r.client_name!=="client"?r.client_name:t("vex-client-all")||"全部客户";return`<tr class="vex-task-row" data-task-id="${He(r.id)}" style="cursor:pointer">
        ...
        </tr>`}).join(""),n.querySelectorAll(".vex-task-dl-btn").forEach(r=>{r.addEventListener("click",async l=>{l.stopPropagation();const m=r.dataset.taskId;try{const d=await fetch("/api/vat_excel/tasks/"+encodeURIComponent(m)+"/download",{credentials:"include",headers:At()});if(d.status===410){showToast(t("vex-toast-expired")||"数据已过期 · 请重新对账","warn");return}if(!d.ok){showToast(t("vex-toast-dl-fail")||"下载失败 · 请重试","error");return}const p=await d.blob(),u=(d.headers.get("Content-Disposition")||"").match(/filename\*?=(?:UTF-8''|")?([^";]+)/i),v=u?decodeURIComponent(u[1]):"vat_recon_"+m+".xlsx",f=URL.createObjectURL(p),y=document.createElement("a");y.href=f,y.download=v,y.click(),setTimeout(()=>URL.revokeObjectURL(f),1e3)}catch{showToast(t("vex-toast-dl-fail")||"下载失败 · 请重试","error")}})}),n.querySelectorAll(".vex-task-del-btn").forEach(r=>{r.addEventListener("click",l=>{l.stopPropagation(),Bm(r.dataset.taskId)})}),$r()}function Im(){var e=document.getElementById("vex-task-prev"),n=document.getElementById("vex-task-next");e&&!e._vexBound&&(e._vexBound=!0,e.addEventListener("click",function(){A.vexPage>1&&(A.vexPage--,sa())})),n&&!n._vexBound&&(n._vexBound=!0,n.addEventListener("click",function(){var a=Math.ceil(A.vexAllRows.length/Ot);A.vexPage<a&&(A.vexPage++,sa())}))}async function Bm(e){const n=t("vex-task-delete-confirm-title")||"删除对账任务?",a=t("vex-task-delete-confirm-body")||"同时清掉对应的发票识别缓存 · 不可恢复";if(await showConfirm(a,{title:n,danger:!0,okText:t("vex-task-delete-confirm-title")||"确认删除"}))try{const o=await fetch("/api/vat_excel/tasks/"+encodeURIComponent(e),{method:"DELETE",credentials:"include",headers:At()});if(!o.ok)throw new Error(o.status);showToast(t("vex-task-delete-ok")||"已删除","success"),Un(),Vn()}catch{showToast(t("vex-task-delete-fail")||"删除失败","error")}}function Sr(e){const n=window._currentLang||"th",a={zh:`已忽略 ${e} 个不支持的文件 · 仅支持 PDF / 图片 / Excel / CSV / Word`,th:`ข้ามไฟล์ที่ไม่รองรับ ${e} ไฟล์ · รองรับเฉพาะ PDF / รูปภาพ / Excel / CSV / Word`,en:`Ignored ${e} unsupported file(s) · only PDF / image / Excel / CSV / Word are supported`,ja:`非対応ファイル ${e} 件をスキップ · 対応形式は PDF / 画像 / Excel / CSV / Word のみ`};showToast(a[n]||a.th,"warn")}function Lm(e){const n=new Set(A.invoiceFiles.map(s=>s.name+"|"+s.size));let a=0;for(const s of e){if(!Gs.test(s.name)){a++;continue}const o=s.name+"|"+s.size;if(!n.has(o)&&(n.add(o),A.invoiceFiles.push(s),A.invoiceFiles.length>=Pa))break}a>0&&Sr(a),A.invoiceFiles.length>Pa&&(A.invoiceFiles=A.invoiceFiles.slice(0,Pa),showToast(t("vex-toast-cap-inv"),"warn")),yt()}function $m(e){const n=new Set(A.reportFiles.map(s=>s.name+"|"+s.size));let a=0;for(const s of e){if(!Gs.test(s.name)){a++;continue}const o=s.name+"|"+s.size;if(!n.has(o)&&(n.add(o),A.reportFiles.push(s),A.reportFiles.length>=ja))break}a>0&&Sr(a),A.reportFiles.length>ja&&(A.reportFiles=A.reportFiles.slice(0,ja),showToast(t("vex-toast-cap-rep"),"warn")),yt()}function Cr(e){A.invoiceFiles.splice(e,1),yt()}function Tr(e){A.reportFiles.splice(e,1),yt()}function yt(){const e=te("vex-list-invoice"),n=te("vex-list-report"),a=te("vex-count-invoice"),s=te("vex-count-report");a&&(a.textContent=A.invoiceFiles.length),s&&(s.textContent=A.reportFiles.length);const o=(l,m,d)=>`<div class="vex-fi">
        ...
        <span class="vex-fi-s">${Lr(l.size)}</span>
        <button class="vex-fi-x" type="button" data-vex-kind="${d}" data-vex-idx="${m}" aria-label="remove">×</button>
    </div>`;e&&(e.innerHTML=A.invoiceFiles.map((l,m)=>o(l,m,"inv")).join("")||'<div class="vex-fi-empty" data-i18n="vex-no-files">还没文件</div>'),n&&(n.innerHTML=A.reportFiles.map((l,m)=>o(l,m,"rep")).join("")||'<div class="vex-fi-empty" data-i18n="vex-no-files">还没文件</div>'),document.querySelectorAll(".vex-fi-x").forEach(l=>{l.addEventListener("click",m=>{const d=l.dataset.vexKind,p=parseInt(l.dataset.vexIdx,10);d==="inv"?Cr(p):Tr(p)})});const i=A.invoiceFiles.length>0&&A.reportFiles.length>0;te("vex-build").disabled=!i||A.running;const r=te("vex-action-info");r&&(!A.invoiceFiles.length||!A.reportFiles.length?(r.textContent=t("vex-need-both")||"需要至少 1 张发票 + 1 份 VAT 报告",r.className="vex-action-info muted"):(r.textContent=(t("vex-ready")||"已就绪 · {a} 张发票 · {b} 份报告").replace("{a}",A.invoiceFiles.length).replace("{b}",A.reportFiles.length),r.className="vex-action-info ok")),as()}const Sm='<svg class="vex-pp-fi-icon" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#6B7280" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path><polyline points="14 2 14 8 20 8"></polyline></svg>',Cm='<svg class="vex-pp-fi-icon" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#111111" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="4" width="18" height="18" rx="2" ry="2"></rect><line x1="16" y1="2" x2="16" y2="6"></line><line x1="8" y1="2" x2="8" y2="6"></line><line x1="3" y1="10" x2="21" y2="10"></line></svg>',Tm='<svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg>';function as(){const e=te("vex-preview-panel");if(!e||e.style.display==="none")return;Jo("inv"),Jo("rep");const n=te("vex-pp-guide");n&&(n.style.display=A.invoiceFiles.length>100?"flex":"none")}function Jo(e){const n=te(e==="inv"?"vex-pp-invoice-col":"vex-pp-report-col");if(!n)return;const a=e==="inv"?A.invoiceFiles:A.reportFiles,s=e==="inv"?A.previewSearchInv:A.previewSearchRep,o=t(e==="inv"?"vex-preview-invoice":"vex-preview-report")||(e==="inv"?"销售发票":"VAT 报告"),i=He(t("vex-preview-search")||"搜索文件名..."),r=He(t("vex-preview-clear-all")||"全清");n.innerHTML=`
    ...
    </div>`;function oi(){const e=document.getElementById("help-modal");if(!e||e.children.length)return;e.innerHTML=wv;const n=window._currentLang||"th",a=window.I18N&&window.I18N[n]||{};e.querySelectorAll("[data-i18n]").forEach(s=>{const o=s.getAttribute("data-i18n");o&&a[o]&&(s.textContent=a[o])})}document.readyState,oi();(function(){function e(){const n=document.getElementById("help-modal"),a=document.getElementById("help-modal-close");n&&(a&&!a.dataset.bound&&(a.addEventListener("click",function(){n.style.display="none"}),a.dataset.bound="1"),n.dataset.maskBound||(n.addEventListener("click",function(s){s.target===n&&(n.style.display="none")}),n.dataset.maskBound="1"),window._helpModalEscBound||(document.addEventListener("keydown",function(s){s.key==="Escape"&&n.style.display==="flex"&&(n.style.display="none")}),window._helpModalEscBound=!0))}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",e):e()})();(function(){const e={line:"line",folder:"folder",gmail:"email",erp:"erp",alert:"alert"};document.addEventListener("click",function(n){const a=n.target.closest(".int-btn-configure");if(!a)return;const s=a.closest(".integration-row"),o=s?s.dataset.intAnchor:null;if(o&&e[o]){const i=s.querySelector(".int-name"),r=i?(i.textContent||i.innerText||"").trim():"配置";typeof window.openIntegrationDrawer=="function"&&window.openIntegrationDrawer(e[o],r)}})})();let Fe=[];window._erpEndpoints=Fe;let En=null;async function ka(){try{const e=await fetch("/api/erp/endpoints",{headers:{Authorization:"Bearer "+token}});if(e.status===401){localStorage.removeItem("mrpilot_token");const a=await e.json().catch(()=>({}));if((typeof a.detail=="string"?a.detail:a.detail&&a.detail.code||"")==="auth.session_revoked"){_showSessionRevokedModal();return}window.location.href="/";return}Fe=(await e.json()).items||[],window._erpEndpoints=Fe,zr()}catch(e){console.error("load endpoints failed",e)}}window._refreshErpEndpointsCache=function(){return ka()};async function Fr(){const e=document.getElementById("erp-today-stats");if(e){e.innerHTML="";try{const n=await fetch("/api/erp/stats/today",{headers:{Authorization:"Bearer "+token}});if(!n.ok)return;const a=await n.json(),s=a.total||0,o=a.success||0,i=a.failed||0,r=a.auto_cnt||0;if(s===0){e.innerHTML=`<span class="erp-today-empty">${escapeHtml(t("erp-today-none"))}</span>`;return}const l=[];l.push(`<span class="erp-today-item"><strong>${s}</strong> ${escapeHtml(t("erp-today-total"))}</span>`),o>0&&l.push(`<span class="erp-today-item ok"><strong>${o}</strong> ${escapeHtml(t("erp-today-success"))}</span>`),i>0&&l.push(`<span class="erp-today-item fail"><strong>${i}</strong> ${escapeHtml(t("erp-today-failed"))}</span>`),r>0&&l.push(`<span class="erp-today-item auto"><strong>${r}</strong> ${escapeHtml(t("erp-today-auto"))}</span>`),e.innerHTML=l.join("")}catch(n){console.warn("loadErpTodayStats failed",n)}}}function zr(){const e=document.getElementById("erp-endpoints-list"),n=document.getElementById("erp-status-summary"),a=document.getElementById("btn-add-endpoint");if(!e){console.warn("erp-endpoints-list 容器不存在");return}if(a&&_userInfo){const o=_userInfo.endpoints_limit;o!==-1&&Fe.length>=o?(a.disabled=!0,a.title=t("ep-limit-reached",{limit:o}),a.classList.add("btn-disabled-plus")):(a.disabled=!1,a.title="",a.classList.remove("btn-disabled-plus"))}if(Fe.length===0){e.innerHTML=`<div class="erp-empty">${escapeHtml(t("ep-list-empty"))}</div>`,n&&(n.textContent=t("auto-status-none"),n.className="auto-status-pill none");return}const s=Fe.some(o=>o.auto_push&&o.enabled);if(n&&(n.textContent=t("auto-status-active",{n:Fe.length,mode:s?t("auto-status-on"):t("auto-status-off")}),n.className="auto-status-pill "+(s?"active":"ready")),Fr(),e.innerHTML=Fe.map(o=>{const i=o.config||{},r=escapeHtml(i.url||"");i._token_set;const l=o.enabled!==!1,m=[];o.is_default&&m.push(`<span class="ep-badge default">${escapeHtml(t("ep-default"))}</span>`),o.auto_push&&m.push(`<span class="ep-badge auto">${escapeHtml(t("ep-auto-push-on"))}</span>`),l||m.push(`<span class="ep-badge disabled">${escapeHtml(t("ep-disabled"))}</span>`);const d=[];return o.success_count>0&&d.push(`<span class="ep-stat ok">${escapeHtml(t("ep-success",{n:o.success_count}))}</span>`),o.failure_count>0&&d.push(`<span class="ep-stat fail">${escapeHtml(t("ep-failure",{n:o.failure_count}))}</span>`),`
    ...
    `,document.body.appendChild(n),n.addEventListener("click",async a=>{if(a.target===n||a.target.classList.contains("log-detail-close")){n.remove();return}const s=a.target.closest("[data-receipt-copy]");if(s){Ur(s.dataset.receiptCopy);return}const o=a.target.closest("[data-receipt-action]");if(o){const i=o.dataset.receiptAction;i==="retry"?window.retryPushLog(o.dataset.logId):i==="exceptions"?typeof routeTo=="function"&&routeTo("exceptions"):i==="mappings"&&typeof routeTo=="function"&&routeTo("integrations"),n.remove();return}});try{const a=await fetch(`/api/erp/logs/${encodeURIComponent(e)}`,{headers:{Authorization:"Bearer "+token}});if(!a.ok){n.remove();return}const s=await a.json(),o=window._erpEndpoints.find(S=>S.id===s.endpoint_id),i=s.endpoint_name||(o?o.name:s.endpoint_id?t("erp-log-endpoint-deleted"):"-"),r=(s.endpoint_adapter||o&&o.adapter||"").toLowerCase(),l=new Date(s.created_at).toLocaleString(),m=s.trigger==="auto"?t("log-tag-auto"):s.trigger==="retry"?t("log-tag-retry"):t("log-tag-manual"),d=s.request_body?JSON.stringify(s.request_body,null,2):t("erp-receipt-no-tech"),p=s.response_body||t("erp-receipt-no-tech"),c=s.status==="success";let u=typeof p=="string"?p:JSON.stringify(p,null,2);if(c)try{const S=typeof s.response_body=="string"?JSON.parse(s.response_body):s.response_body||{},M=S.row_count||(Array.isArray(S.imported_rows)?S.imported_rows.length:0);M>0&&(u=t("log-push-rows").replace("{n}",String(M)))}catch{}const v=(s.external_doc_no||"").trim(),f=(s.external_url||"").trim(),y=(s.external_doc_hint||"").trim(),b=(s.ocr_buyer_name||"").trim()||s.client_name||"-",h=s.seller_name||"-",g=s.push_type==="id_card";let _="-";const w=Number(s.total_amount);s.total_amount!=null&&s.total_amount!==""&&!isNaN(w)&&(_=w.toLocaleString("en-US",{minimumFractionDigits:2,maximumFractionDigits:2}));const k=c?t("erp-receipt-title-ok"):t("erp-receipt-title-fail"),x=c?"✓":"✗",E=[],I=(S,M)=>{E.push(`
        ...
        `}catch(a){console.error(a),n.remove()}}window.copyErpDocNo=Ur;window.showLogDetail=Iv;const Bv=`
        <div class="modal">
            <div class="modal-head">
    ...
    `;$e("endpoint-modal",Bv);let pn={key:"all",val:""},yn="",Ra=!1,lt=new Set;window._erpSelected=lt;async function Lv(){const e=document.getElementById("erp-logs-erp-select");if(!(!e||Ra)){Ra=!0;try{let n=window._erpEndpoints;if(!Array.isArray(n)||n.length===0){const o=await fetch("/api/erp/endpoints",{headers:{Authorization:"Bearer "+token}});if(o.ok){const i=await o.json();n=i&&(i.items||i)||[]}}Array.isArray(n)||(n=[]);const a=new Set,s=[];n.forEach(o=>{const i=(o&&o.adapter||"").toLowerCase();!i||a.has(i)||(a.add(i),s.push({val:i,label:o&&o.name||i}))}),e.innerHTML=`<option value="">${escapeHtml(t("erp-logs-erp-all"))}</option>`+s.map(o=>`<option value="${escapeHtml(o.val)}"${o.val===yn?" selected":""}>${escapeHtml(o.label)}</option>`).join("")}catch{Ra=!1}}}async function Gt(e){const n=document.getElementById("erp-logs-list");if(n){e||(n.innerHTML=`<div class="erp-logs-empty">${escapeHtml(t("erp-logs-loading"))}</div>`),window.loadErpTodayStats(),Lv();try{const a=new URLSearchParams({limit:"30"});pn.key==="status"&&a.set("status",pn.val),pn.key==="trigger"&&a.set("trigger",pn.val),yn&&a.set("adapter",yn);const s=await fetch(`/api/erp/logs?${a}`,{headers:{Authorization:"Bearer "+token}});if(!s.ok){n.innerHTML=`<div class="erp-logs-empty">${escapeHtml(t("erp-logs-error"))}</div>`;return}const i=(await s.json()).items||[];if(window._erpLogPollTimer&&(clearTimeout(window._erpLogPollTimer),window._erpLogPollTimer=null),i.some(function(v){return v.status==="pending"})&&(window._erpLogPollTimer=setTimeout(function(){Gt(!0)},4e3)),i.length===0){n.innerHTML=`<div class="erp-logs-empty">${escapeHtml(t("erp-logs-empty"))}</div>`;return}const r=i.filter(function(v){var f=v.status==="failed"&&v.next_retry_at&&new Date(v.next_retry_at).getTime()>Date.now()-6e4;return!f}).map(function(v){return v.id}),l=yn==="mrerp_dms",m=l?t("erp-log-col-booking"):t("erp-log-col-invoice"),d=l?t("erp-log-col-customer"):t("erp-log-col-seller"),p=l?t("erp-log-col-idcard"):t("erp-log-col-client"),c='<div class="erp-log-row erp-log-row-header" data-log-header>'+(r.length>0?`<input type="checkbox" class="erp-log-cb erp-log-cb-all" data-log-select-all title="${escapeHtml(t("erp-log-select-all-tip"))}">`:'<span class="erp-log-cb-spacer"></span>')+`<span class="log-time">${escapeHtml(t("erp-log-col-time"))}</span><span class="log-status">${escapeHtml(t("erp-log-col-status"))}</span><span class="log-tag-header">${escapeHtml(t("erp-log-col-trigger"))}</span><span class="log-invoice">${escapeHtml(m)}</span><span class="log-workspace">${escapeHtml(t("erp-log-col-workspace"))}</span><span class="log-client">${escapeHtml(p)}</span><span class="log-seller">${escapeHtml(d)}</span><span class="log-erp">${escapeHtml(t("erp-log-col-erp"))}</span><span class="log-doc">${escapeHtml(t("erp-log-col-doc"))}</span><span class="log-http">${escapeHtml(t("erp-log-col-http"))}</span><span class="log-elapsed">${escapeHtml(t("erp-log-col-elapsed"))}</span><span class="log-actions"></span></div>`;n.innerHTML=c+i.map(v=>{const f=new Date(v.created_at),y=`${String(f.getMonth()+1).padStart(2,"0")}-${String(f.getDate()).padStart(2,"0")} ${String(f.getHours()).padStart(2,"0")}:${String(f.getMinutes()).padStart(2,"0")}`,b=v.status==="failed"&&v.next_retry_at&&new Date(v.next_retry_at).getTime()>Date.now()-6e4;let h,g,_;v.status==="pending"?(h="retrying",g="⟳",_=t("erp-status-pending")):v.status==="success"?(h="ok",g="✓",_=t("erp-status-success")):v.status==="skipped_dup"?(h="skipped",g="⏭",_=t("erp-status-skipped")):b?(h="retrying",g="↻",_=t("erp-status-retrying")):(h="fail",g="✗",_=t("erp-status-failed"));let w;v.trigger==="auto"?w=`<span class="log-tag auto">${escapeHtml(t("log-tag-auto"))}</span>`:v.trigger==="retry"?w=`<span class="log-tag retry">${escapeHtml(t("log-tag-retry"))}</span>`:w=`<span class="log-tag manual">${escapeHtml(t("log-tag-manual"))}</span>`;const k=v.push_type==="id_card",x=k?`<span class="log-tag log-type-idcard">${escapeHtml(t("erp-log-type-idcard"))}</span>`:"",E=v.error_friendly&&(v.error_friendly[currentLang]||v.error_friendly.en)||"";let I="";const B=v.retry_count||0,L=v.max_retries||3;if(b){const Y=new Date(v.next_retry_at).getTime()-Date.now(),de=Math.max(0,Math.round(Y/6e4)),re=de<=0?t("erp-retry-next-soon"):t("erp-retry-next-min",{n:de});I=`${t("erp-retry-attempt",{n:B,max:L})} · ${re}`}else v.status==="failed"&&B>=L&&!v.next_retry_at&&(I=t("erp-retry-exhausted",{n:B}));const $=v.status==="failed"&&!b?`<button class="log-retry-btn btn btn-icon" data-log-retry="${escapeHtml(v.id)}" title="${escapeHtml(t("log-retry-title"))}">↻</button>`:"",S=!b,M=lt.has(v.id)?"checked":"",R=S?`<input type="checkbox" class="erp-log-cb" data-log-cb="${escapeHtml(v.id)}" ${M}>`:'<span class="erp-log-cb-spacer"></span>',G=(v.ocr_buyer_name||"").trim()||(v.client_name||"").trim(),se=k?`<span class="log-client" title="${escapeHtml(t("erp-log-col-idcard"))}">${v.id_card_tail?"••••"+escapeHtml(v.id_card_tail):"—"}</span>`:G?`<span class="log-client" title="${escapeHtml(G)}">${escapeHtml(G.substring(0,18))}</span>`:`<span class="log-client log-client-empty" title="${escapeHtml(t("erp-log-client-unassigned-tip"))}">${escapeHtml(t("erp-log-client-unassigned"))}</span>`,ce=k?'<span class="log-workspace log-workspace-unresolved">—</span>':v.workspace_name?`<span class="log-workspace">${escapeHtml((v.workspace_name||"").substring(0,16))}</span>`:`<span class="log-workspace log-workspace-unresolved" title="${escapeHtml(t("erp-log-ws-unresolved-tip"))}">${escapeHtml(t("erp-log-ws-unresolved"))}</span>`,Ee=v.endpoint_name?`<span class="log-erp">${escapeHtml((v.endpoint_name||"").substring(0,14))}</span>`:`<span class="log-erp log-erp-deleted">${escapeHtml(t("erp-log-endpoint-deleted"))}</span>`,ke=(v.external_doc_no||"").trim(),O=(v.external_url||"").trim();let N;return O?N=`<span class="log-doc"><a href="${escapeHtml(O)}" target="_blank" rel="noopener" class="log-doc-open" title="${escapeHtml(ke||"")}">${escapeHtml(t("erp-log-doc-open"))}</a></span>`:ke?N=`<span class="log-doc log-doc-copy" data-copy-doc="${escapeHtml(ke)}" title="${escapeHtml(t("erp-log-doc-copy-tip"))}">${escapeHtml(ke.substring(0,18))}</span>`:v.status==="success"?N=`<span class="log-doc log-doc-missing" title="${escapeHtml(t("erp-log-doc-missing-tip"))}">${escapeHtml(t("erp-log-doc-missing"))}</span>`:N='<span class="log-doc log-doc-empty">-</span>',`
        ...
        `,document.body.appendChild(v);const f=()=>v.remove();v.querySelector("#cpw-forgot-close").addEventListener("click",f),v.querySelector("#cpw-forgot-cancel").addEventListener("click",f),v.addEventListener("click",y=>{y.target===v&&f()}),v.querySelector("#cpw-forgot-send").addEventListener("click",async()=>{const y=v.querySelector("#cpw-forgot-send"),b=v.querySelector("#cpw-forgot-msg");y.disabled=!0;const h=y.textContent;y.textContent=a("cpw-forgot-sending");try{const g=await fetch("/api/auth/forgot_password",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:c})}),_=await g.json().catch(()=>({}));g.ok?(b.textContent=a("cpw-forgot-success"),b.className="cpw-forgot-msg success",y.style.display="none",v.querySelector("#cpw-forgot-cancel").textContent=a("cpw-forgot-close-btn")):(b.textContent=_.detail||a("cpw-forgot-fail"),b.className="cpw-forgot-msg error",y.disabled=!1,y.textContent=h)}catch{b.textContent=a("cpw-forgot-fail"),b.className="cpw-forgot-msg error",y.disabled=!1,y.textContent=h}})}function m(p){if(!p||!p.includes("@"))return p||"";const[c,u]=p.split("@");return c.length<=2?c+"****@"+u:c.slice(0,2)+"****@"+u}function d(p){return p==null?"":String(p).replace(/[&<>"']/g,c=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[c])}document.readyState==="complete"||document.readyState==="interactive"?r():document.addEventListener("DOMContentLoaded",r)})();(function(){let e=null,n=!1;async function a(){if(n)return;const o=localStorage.getItem("mrpilot_token");if(o){n=!0;try{const i=await fetch("/api/me",{headers:{Authorization:"Bearer "+o},cache:"no-store"});if(i.status===401){const r=await i.json().catch(()=>({})),l=r&&r.detail;let m="";if(typeof l=="string"?m=l:l&&typeof l=="object"&&(m=l.code||""),console.warn("[heartbeat] session revoked",m),localStorage.removeItem("mrpilot_token"),e&&(clearInterval(e),e=null),m==="auth.session_revoked")try{_showSessionRevokedModal()}catch{window.location.href="/"}else{const d=m==="auth.password_changed_relogin"?"alert-password-changed-relogin":"alert-session";try{typeof showToast=="function"&&typeof t=="function"?showToast(t(d),"error"):alert("Session expired")}catch{}setTimeout(()=>{window.location.href="/"},1500)}}}catch{}finally{n=!1}}}function s(){e&&clearInterval(e),e=setInterval(a,15e3)}localStorage.getItem("mrpilot_token")&&s(),window.addEventListener("focus",a),document.addEventListener("visibilitychange",function(){document.hidden||a()}),window._sessionCheck=a})();async function xa(){const e=document.getElementById("team-loading"),n=document.getElementById("team-list"),a=document.getElementById("team-empty"),s=document.getElementById("team-count");if(n){e&&(e.style.display=""),n.style.display="none",a&&(a.style.display="none");try{const o=await apiGet("/api/team/employees"),i=o&&o.employees||[];if(e&&(e.style.display="none"),s&&(s.textContent=(t("team-count")||"共 {n} 名员工").replace("{n}",i.length)),i.length===0){a&&(a.style.display="");return}n.style.display="",n.innerHTML=i.map(r=>{const l=r.last_login_at?new Date(r.last_login_at).toLocaleDateString():t("team-never-login")||"从未登录",m=r.is_active===!1?"team-status-off":"team-status-on",d=r.is_active===!1?t("team-status-disabled")||"已禁用":t("team-status-active")||"正常",p=r.email?`<span class="team-meta-sep">·</span><span>${escapeHtml(r.email)}</span>`:"";return`
            ...
            </div>`}).join("")}catch(o){console.error("loadTeamList failed:",o),e&&(e.textContent=t("team-load-failed")||"加载失败")}}}async function $v(){document.querySelectorAll(".add-emp-overlay").forEach(s=>s.remove());const e=document.createElement("div");e.className="add-emp-overlay",e.innerHTML=`
