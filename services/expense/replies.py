...
_POOLS = {
    ...
    "amount_missing": {
        "th": ["รายการนี้ราคาเท่าไหร่คะ พิมพ์ตัวเลขต่อได้เลย เช่น 65"],
        "zh": ["这笔多少钱？直接回复数字就行，比如 65"],
        "en": ["How much was it? Reply with just the amount, e.g. 65"],
        "ja": ["金額はいくらですか？数字だけ返信してください。例: 65"],
    },
    "out_of_scope": {
        "th": [
