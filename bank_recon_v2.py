...
_I18N_EXPORT: Dict[str, Dict[str, str]] = {
    ...
    "lbl_gl_debit_only": {"th": "GL เดบิตเท่านั้น (ไม่มีในบัญชีธนาคาร)", "en": "GL Debit Only (not in Statement)", "zh": "仅 GL 有借方（对账单中缺失）", "ja": "GLのみ借方"},
    "lbl_gl_credit_only": {"th": "GL เครดิตเท่านั้น (ไม่มีในบัญชีธนาคาร)", "en": "GL Credit Only (not in Statement)", "zh": "仅 GL 有贷方（对账单中缺失）", "ja": "GLのみ貸方"},
