...
def send_reset_link_for_employee(
    ...
    """
    import db as _db
    from auth_signup import _now  # noqa: E402 · lazy 破循环
...
def forgot_password(req: ForgotPasswordRequest, request: Request):
    ...
    from auth_signup import normalize_email, get_client_ip_safe, _now  # noqa: E402 · lazy 破循环
...
def reset_password(req: ResetPasswordRequest, request: Request):
    """凭 token 重置密码"""
    from auth_signup import _hash_password, _now  # noqa: E402 · lazy 破循环
...
def change_password(req: ChangePasswordRequest, request: Request):
    ...
    try:
        ...
        from auth_signup import _hash_password  # noqa: E402 · lazy 破循环
