...
COPY = {
    ...
    "forbidden": (
        "当前账号没有此任务的操作权限，请重新打开工作菜单。",
        "This account cannot perform this task action. Please reopen the work menu.",
        "บัญชีนี้ไม่มีสิทธิ์ดำเนินการกับงานนี้ กรุณาเปิดเมนูงานอีกครั้งครับ",
        "この操作を行う権限がありません。作業メニューを開き直してください。",
    ),
    "expired": (
        "这个按钮已过期，请使用最新卡片。",
