...
`,e.dataset.wbInjected="1";try{const a=window._currentLang||localStorage.getItem("mrpilot_lang")||"th",n=window.I18N;n&&n[a]&&(e.querySelectorAll("[data-i18n]").forEach(o=>{const l=o.getAttribute("data-i18n");n[a][l]&&(o.textContent=n[a][l])}),e.querySelectorAll("[data-i18n-placeholder]").forEach(o=>{const l=o.getAttribute("data-i18n-placeholder");n[a][l]&&(o.placeholder=n[a][l])}))}catch{}}})();(function(){const e=document.getElementById("page-integrations");if(!(!e||e.dataset.wbInjected==="1")){e.innerHTML=`
        ...
        <!-- /Tab 2 -->
`,e.dataset.wbInjected="1";try{const a=window._currentLang||localStorage.getItem("mrpilot_lang")||"th",n=window.I18N;n&&n[a]&&(e.querySelectorAll("[data-i18n]").forEach(o=>{const l=o.getAttribute("data-i18n");n[a][l]&&(o.textContent=n[a][l])}),e.querySelectorAll("[data-i18n-placeholder]").forEach(o=>{const l=o.getAttribute("data-i18n-placeholder");n[a][l]&&(o.placeholder=n[a][l])}))}catch{}}})();(function(){const e=document.getElementById("page-settings");if(!(!e||e.dataset.wbInjected==="1")){e.innerHTML=`
        ...
        <!-- /settings-layout -->
`,e.dataset.wbInjected="1";try{const a=window._currentLang||localStorage.getItem("mrpilot_lang")||"th",n=window.I18N;n&&n[a]&&(e.querySelectorAll("[data-i18n]").forEach(o=>{const l=o.getAttribute("data-i18n");n[a][l]&&(o.textContent=n[a][l])}),e.querySelectorAll("[data-i18n-placeholder]").forEach(o=>{const l=o.getAttribute("data-i18n-placeholder");n[a][l]&&(o.placeholder=n[a][l])}))}catch{}}})();(function(){const e=document.getElementById("page-automation");if(!(!e||e.dataset.wbInjected==="1")){e.innerHTML=`
        <div class="page-head-clean">
            <div class="page-head-icon">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
...
`,e.dataset.wbInjected="1";try{const a=window._currentLang||localStorage.getItem("mrpilot_lang")||"th",n=window.I18N;n&&n[a]&&(e.querySelectorAll("[data-i18n]").forEach(o=>{const l=o.getAttribute("data-i18n");n[a][l]&&(o.textContent=n[a][l])}),e.querySelectorAll("[data-i18n-placeholder]").forEach(o=>{const l=o.getAttribute("data-i18n-placeholder");n[a][l]&&(o.placeholder=n[a][l])}))}catch{}}})();(function(){const e={"page-integration":`
        <div class="coming-soon">
            <svg class="cs-icon" viewBox="0 0 48 48" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
...
`},a=window._currentLang||localStorage.getItem("mrpilot_lang")||"th",n=window.I18N;Object.keys(e).forEach(o=>{const l=document.getElementById(o);!l||l.dataset.wbInjected==="1"||(l.innerHTML=e[o],l.dataset.wbInjected="1",n&&n[a]&&l.querySelectorAll("[data-i18n]").forEach(f=>{const g=f.getAttribute("data-i18n");n[a][g]&&(f.textContent=n[a][g])}))})})();function $e(e,a){try{return typeof window.t=="function"?window.t(e):a}catch{return a}}function Pe(e){if(e==null||isNaN(e))return"—";try{return String(e).replace(/\B(?=(\d{3})+(?!\d))/g,",")}catch{return String(e)}}function Et(e){if(!e)return"";try{const a=new Date(e).getTime();if(!a)return"";const n=Math.floor((Date.now()-a)/1e3);return n<60?$e("time-just-now","刚刚"):n<3600?Math.floor(n/60)+$e("time-min-ago-suffix"," 分钟前"):n<86400?Math.floor(n/3600)+$e("time-hour-ago-suffix"," 小时前"):Math.floor(n/86400)+$e("time-day-ago-suffix"," 天前")}catch{return""}}async function et(){pt();const e=document.getElementById("dash-kpi-invoices"),a=document.getElementById("dash-kpi-pending"),n=document.getElementById("dash-kpi-exceptions"),o=document.getElementById("dash-kpi-plan"),l=document.getElementById("dash-kpi-plan-sub"),f=document.getElementById("dash-recent-list"),g=document.getElementById("dash-quick-exc-badge");try{const x={Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||"")},[s,p,w]=await Promise.all([fetch("/api/me/tenant-usage",{headers:x}).then(N=>N.ok?N.json():null).catch(()=>null),fetch("/api/history?limit=20",{headers:x}).then(N=>N.ok?N.json():null).catch(()=>null),fetch("/api/exceptions/stats?status=pending",{headers:x}).then(N=>N.ok?N.json():null).catch(()=>null)]),h=s&&s.ocr_this_month||0;let B=0;const S=p&&(p.items||p.history||p)||[],I=Array.isArray(S)?S:[];I.forEach(N=>{(N.status==="pending"||N.status==="reviewing")&&B++});const U=w&&(w.total||w.count||w.pending||0)||0;if(e&&(e.textContent=Pe(h)),a&&(a.textContent=Pe(B)),n&&(n.textContent=Pe(U)),g&&(U>0?(g.style.display="",g.textContent=U):g.style.display="none"),o&&s){const N=s.ocr_this_month||0,M=s.quota||0;o.textContent=Pe(N),l&&(l.textContent=M?N+" / "+Pe(M)+" 张":$e("dash-kpi-plan-sub","本月用量"))}if(f)if(I.length===0)f.innerHTML='<div class="dash-recent-empty">'+$e("dash-recent-empty","还没有识别记录 · 去上传第一张吧")+"</div>";else{const N=I.slice(0,5).map(M=>{const L=(M.invoice_no||M.filename||M.id||"").toString(),z=(M.supplier_name||M.buyer_name||M.client_name||M.notes||"").toString(),V=Et(M.created_at||M.upload_time||M.date),W=P=>String(P).replace(/[&<>"']/g,u=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[u]);return'<div class="dash-recent-row"><span class="dash-recent-key" title="'+W(L)+'">'+W(L)+'</span><span class="dash-recent-mid" title="'+W(z)+'">'+W(z)+'</span><span class="dash-recent-time">'+W(V)+"</span></div>"}).join("");f.innerHTML=N}}catch{f&&(f.innerHTML='<div class="dash-recent-empty">'+$e("dash-recent-empty","还没有识别记录 · 去上传第一张吧")+"</div>")}}window.loadDashboard=et;async function pt(){const e=document.getElementById("dash-kpi-balance-card"),a=document.getElementById("dash-kpi-usage-card"),n=document.getElementById("dash-kpi-balance"),o=document.getElementById("dash-kpi-balance-sub"),l=document.getElementById("dash-kpi-usage"),f=document.getElementById("dash-kpi-usage-sub");if(!(!e||!a))try{const g={Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||"")},x=await fetch("/api/me/credits",{headers:g,cache:"no-store"});if(!x.ok){e.style.display="none",l&&(l.textContent="—"),f&&(f.textContent="");return}const s=await x.json(),p=!!s.is_owner,w=!!s.is_billing_exempt;if(!p)e.style.display="none";else if(e.style.display="",w)n&&(n.textContent="∞",n.className="dash-kpi-val dash-green"),o&&(o.textContent=typeof window.t=="function"?window.t("dash-kpi-balance-exempt"):"Billing exempt");else{const B=typeof s.balance_thb=="number"?s.balance_thb:0;if(n&&(n.textContent="฿"+B.toFixed(2),n.className=B<50?"dash-kpi-val dash-red":"dash-kpi-val"),o){const S=typeof window.t=="function"?window.t("dash-kpi-balance-topup"):"Top up →",I=B<50?"#dc2626":"#6b7280",U=N=>typeof window.escapeHtml=="function"?window.escapeHtml(N):String(N).replace(/[&<>"']/g,M=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[M]);o.innerHTML='<a href="#" id="kpi-balance-topup-link" style="color:'+I+';text-decoration:underline;cursor:pointer;" onclick="event.preventDefault();window._openTopupModal&&window._openTopupModal();return false;">'+U(S)+"</a>"}}const h=typeof s.pages_this_month=="number"?s.pages_this_month:typeof s.my_invoice_count=="number"?s.my_invoice_count:0;if(a.style.display="",l&&(l.textContent=String(h)),f){const B=h>=200?"dash-kpi-usage-sub-high":"dash-kpi-usage-sub-low",S=typeof window.t=="function"?window.t(B,{used:h}):h+" pages";f.textContent=S}}catch(g){console.warn("[credits] loadCreditsCard failed:",g),e.style.display="none",l&&(l.textContent="—")}}window.loadCreditsCard=pt;document.addEventListener("DOMContentLoaded",function(){(location.hash||"").replace(/^#\//,"")==="dashboard"&&setTimeout(et,500)});typeof window.subscribeI18n=="function"&&window.subscribeI18n("dashboard",function(){(location.hash||"").replace(/^#\//,"")==="dashboard"&&et()});function ge(e){return(typeof window.t=="function"?window.t(e):null)||e}function tt(){return localStorage.getItem("mrpilot_token")||""}function me(e){return document.getElementById(e)}var Ve=null,Re=null;function ut(){Re||(Re=setInterval(function(){if(!document.hidden){var e=tt();e&&(window._userInfo&&window._userInfo.is_billing_exempt||fetch("/api/me/credits",{headers:{Authorization:"Bearer "+e},cache:"no-store"}).then(function(a){return a.ok?a.json():null}).then(function(a){if(a){var n=a.balance_thb!=null?Number(a.balance_thb):0;Ve!==null&&n>Ve&&(window.showToast&&window.showToast(ge("credits-updated"),"success"),typeof window.loadDashboard=="function"&&window.loadDashboard(),typeof window._refreshBalanceAlerts=="function"&&window._refreshBalanceAlerts()),Ve=n}}).catch(function(){}))}},3e4))}function Bt(){Re&&(clearInterval(Re),Re=null),Ve=null}window._startCreditsPoll=ut;window._stopCreditsPoll=Bt;ut();var nt=null,at=0;function It(){if(!me("topup-v2-ov")){var e=document.createElement("div");e.id="topup-v2-ov",e.className="topup-v2-ov",e.style.cssText="display:none;position:fixed;inset:0;background:rgba(15,23,42,.5);z-index:9500;align-items:center;justify-content:center;padding:16px",e.innerHTML=['<div class="topup-v2-box">','  <div class="topup-v2-head">','    <div class="topup-v2-title" id="tv2-title"></div>','    <button class="topup-v2-close" id="tv2-close" aria-label="close">','      <svg viewBox="0 0 20 20" width="16" height="16" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"><line x1="4" y1="4" x2="16" y2="16"/><line x1="16" y1="4" x2="4" y2="16"/></svg>',"    </button>","  </div>",'  <div class="topup-v2-steps">','    <div class="topup-v2-step" id="tv2-d1"><span class="topup-v2-dot">1</span><span class="topup-v2-slabel" id="tv2-sl1"></span></div>','    <div class="topup-v2-line"></div>','    <div class="topup-v2-step" id="tv2-d2"><span class="topup-v2-dot">2</span><span class="topup-v2-slabel" id="tv2-sl2"></span></div>','    <div class="topup-v2-line"></div>','    <div class="topup-v2-step" id="tv2-d3"><span class="topup-v2-dot">3</span><span class="topup-v2-slabel" id="tv2-sl3"></span></div>',"  </div>",'  <div class="topup-v2-body">','    <div id="tv2-s1">','      <label class="topup-v2-label" id="tv2-al"></label>','      <div class="topup-v2-qamts">','        <button class="topup-v2-qamt" data-val="100">฿100</button>','        <button class="topup-v2-qamt" data-val="500">฿500</button>','        <button class="topup-v2-qamt" data-val="1000">฿1,000</button>','        <button class="topup-v2-qamt" data-val="2000">฿2,000</button>',"      </div>",'      <input id="tv2-amt" type="number" min="10" step="1" class="topup-v2-input" placeholder="฿ ...">','      <div id="tv2-ae" class="topup-v2-err" style="display:none"></div>',"    </div>",'    <div id="tv2-s2" style="display:none">','      <p class="topup-v2-bank-label" id="tv2-bl"></p>','      <div class="topup-v2-bank-card">','        <div class="topup-v2-bank-name">ธนาคาร กรุงเทพ</div>','        <div class="topup-v2-bank-branch">สาขาโชคชัย 4 ลาดพร้าว</div>','        <div class="topup-v2-bank-acct">230-0-91368-4</div>','        <div class="topup-v2-bank-holder">บจ. มิสเตอร์ อี อาร์ พี</div>','        <button class="topup-v2-copy" id="tv2-copy"></button>',"      </div>",'      <div class="topup-v2-warn" id="tv2-bn"></div>',"    </div>",'    <div id="tv2-s3" style="display:none">','      <div class="topup-v2-drop" id="tv2-drop">','        <input type="file" id="tv2-file" accept="image/*,.pdf" style="display:none">','        <svg viewBox="0 0 24 24" width="28" height="28" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M21 15v4a2 2 0 01-2 2H5a2 2 0 01-2-2v-4"/><polyline points="17 8 12 3 7 8"/><line x1="12" y1="3" x2="12" y2="15"/></svg>','        <span class="topup-v2-drop-text" id="tv2-dt"></span>',"      </div>",'      <div id="tv2-se" class="topup-v2-err" style="display:none"></div>','      <label class="topup-v2-label" id="tv2-pl"></label>','      <input id="tv2-payer" type="text" maxlength="200" class="topup-v2-input">','      <label class="topup-v2-label" id="tv2-nl"></label>','      <input id="tv2-note" type="text" maxlength="500" class="topup-v2-input">','      <div id="tv2-ue" class="topup-v2-err" style="display:none"></div>',"    </div>","  </div>",'  <div class="topup-v2-foot">','    <button class="btn btn-ghost" id="tv2-back" style="display:none"></button>','    <button class="btn btn-primary" id="tv2-next"></button>',"  </div>","</div>"].join(""),document.body.appendChild(e),Lt()}}function ft(){var e=function(a,n){var o=me(a);o&&(o.textContent=n)};e("tv2-title",ge("topup-title")),e("tv2-sl1",ge("topup-step1")),e("tv2-sl2",ge("topup-step2")),e("tv2-sl3",ge("topup-step3")),e("tv2-al",ge("topup-amount-label")),e("tv2-bl",ge("topup-bank-label")),e("tv2-copy",ge("topup-copy-account")),e("tv2-dt",ge("topup-slip-drop")),e("tv2-pl",ge("topup-payer-label")),e("tv2-nl",ge("topup-note-label"))}function ze(e){[1,2,3].forEach(function(l){var f=me("tv2-s"+l);f&&(f.style.display=l===e?"":"none");var g=me("tv2-d"+l);g&&g.classList.toggle("active",l<=e)});var a=me("tv2-back"),n=me("tv2-next");if(e===1?a&&(a.style.display="",a.textContent=ge("topup-btn-cancel")):a&&(a.style.display="",a.textContent=ge("topup-btn-back")),n&&(n.textContent=ge(e===3?"topup-btn-submit":"topup-btn-next")),e===2){var o=me("tv2-bn");o&&(o.innerHTML=ge("topup-bank-note").replace("{amount}","<strong>฿"+Number(at).toLocaleString()+"</strong>"))}}function Ze(){for(var e=1;e<=3;e++){var a=me("tv2-s"+e);if(a&&a.style.display!=="none")return e}return 1}function Ue(e){var a=me(e);a&&(a.textContent="",a.style.display="none")}function qe(e,a){var n=me(e);n&&(n.textContent=a,n.style.display="")}function ct(e){var a=me("tv2-dt");a&&(a.textContent=e.name);var n=me("tv2-drop");n&&n.classList.add("has-file"),Ue("tv2-se")}function Lt(){var e=me("topup-v2-ov");me("tv2-close").addEventListener("click",De),e.addEventListener("click",function(f){f.target===e&&De()}),document.addEventListener("keydown",function(f){f.key==="Escape"&&e&&e.style.display!=="none"&&De()}),e.addEventListener("click",function(f){var g=f.target.closest(".topup-v2-qamt");if(g){e.querySelectorAll(".topup-v2-qamt").forEach(function(s){s.classList.remove("active")}),g.classList.add("active");var x=me("tv2-amt");x&&(x.value=g.dataset.val,Ue("tv2-ae"))}});var a=me("tv2-amt");a&&a.addEventListener("input",function(){e.querySelectorAll(".topup-v2-qamt").forEach(function(f){f.classList.remove("active")}),Ue("tv2-ae")});var n=me("tv2-copy");n&&n.addEventListener("click",function(){navigator.clipboard&&navigator.clipboard.writeText("2300913684").then(function(){var f=n.textContent;n.textContent=ge("topup-copied"),setTimeout(function(){n.textContent=f},1500)})});var o=me("tv2-drop"),l=me("tv2-file");o&&(o.addEventListener("click",function(){l&&l.click()}),o.addEventListener("dragover",function(f){f.preventDefault(),o.classList.add("drag-over")}),o.addEventListener("dragleave",function(){o.classList.remove("drag-over")}),o.addEventListener("drop",function(f){f.preventDefault(),o.classList.remove("drag-over");var g=f.dataTransfer&&f.dataTransfer.files[0];g&&ct(g)})),l&&l.addEventListener("change",function(){l.files[0]&&ct(l.files[0])}),me("tv2-back").addEventListener("click",function(){var f=Ze();if(f<=1){De();return}ze(f-1)}),me("tv2-next").addEventListener("click",function(){var f=Ze();f===1?Ct():f===2?ze(3):St()})}async function Ct(){var e=me("tv2-amt"),a=e?parseFloat(e.value):0;if(!a||a<10){qe("tv2-ae",ge("topup-amount-invalid"));return}if(a>5e5){qe("tv2-ae",ge("topup-amount-too-large"));return}at=a;var n=me("tv2-next");n&&(n.disabled=!0,n.textContent="…");try{var o=await fetch("/api/credits/topup/request",{method:"POST",headers:{"Content-Type":"application/json",Authorization:"Bearer "+tt()},body:JSON.stringify({amount_thb:a})});if(!o.ok){var l=await o.text(),f=ge("topup-submit-fail");try{var g=JSON.parse(l),x=g.detail;if(Array.isArray(x)&&x.length){var s=x[0]&&x[0].type||"";s.indexOf("less_than")>=0?f=ge("topup-amount-too-large"):(s.indexOf("greater_than")>=0||s.indexOf("parsing")>=0)&&(f=ge("topup-amount-invalid"))}else typeof x=="string"&&(f=x)}catch{}throw new Error(f)}var p=await o.json();nt=p.request_id,ze(2)}catch(w){qe("tv2-ae",w.message||ge("topup-submit-fail"))}finally{n&&(n.disabled=!1,n.textContent=ge("topup-btn-next"))}}async function St(){var e=me("tv2-file");if(!e||!e.files||!e.files[0]){qe("tv2-se",ge("topup-slip-required"));return}var a=me("tv2-next");a&&(a.disabled=!0,a.textContent="…");try{var n=new FormData;n.append("file",e.files[0]);var o=me("tv2-payer"),l=me("tv2-note");o&&o.value.trim()&&n.append("payer_name",o.value.trim()),l&&l.value.trim()&&n.append("note",l.value.trim());var f=await fetch("/api/credits/topup/upload-slip/"+nt,{method:"POST",headers:{Authorization:"Bearer "+tt()},body:n});if(!f.ok)throw new Error(await f.text());var g=await f.json();g.auto_approved?(window.showToast&&window.showToast(ge("topup-auto-approved"),"success"),typeof window.loadDashboard=="function"&&window.loadDashboard()):window.showToast&&window.showToast(ge("topup-pending"),"info"),De()}catch(x){qe("tv2-ue",ge("topup-upload-fail")+" · "+x.message),a&&(a.disabled=!1,a.textContent=ge("topup-btn-submit"))}}function De(){var e=me("topup-v2-ov");e&&(e.style.display="none"),typeof window.loadDashboard=="function"&&window.loadDashboard()}window._openTopupModal=function(){It(),nt=null,at=0,["tv2-amt","tv2-payer","tv2-note"].forEach(function(n){var o=me(n);o&&(o.value="")});var e=me("tv2-file");e&&(e.value="");var a=me("tv2-drop");a&&a.classList.remove("has-file","drag-over"),me("topup-v2-ov").querySelectorAll(".topup-v2-qamt").forEach(function(n){n.classList.remove("active")}),["tv2-ae","tv2-se","tv2-ue"].forEach(function(n){Ue(n)}),ft(),ze(1),me("topup-v2-ov").style.display="flex"};typeof window.subscribeI18n=="function"&&window.subscribeI18n("topup-v2",function(){var e=me("topup-v2-ov");e&&e.style.display!=="none"&&e.style.display!==""&&(ft(),ze(Ze()))});(function(){const e="v118.28.5",a="pearnly_tc_results_"+e,n=[{id:"A1",group:"A · 异常栏 page-head(BUG1)",desc:"手机宽度进异常栏 · 标题「异常栏」横排正常 · 不再每字一行"},{id:"A2",group:"A · 异常栏 page-head(BUG1)",desc:"副标题「所有被规则拦截的单据集中复核…」也横排正常 · 不竖排"},{id:"A3",group:"A · 异常栏 page-head(BUG1)",desc:"客户筛选下拉 + 刷新按钮换到新一行 · 不抢标题宽度"},{id:"B1",group:"B · 客户管理 page-head(BUG2)",desc:"手机宽度进客户管理 · 标题「客户管理」横排正常"},{id:"B2",group:"B · 客户管理 page-head(BUG2)",desc:"副标题「为每家客户单独归档发票…」横排正常 · 不竖排"},{id:"B3",group:"B · 客户管理 page-head(BUG2)",desc:"「+ 新建客户」按钮换到新一行 · 不挤标题"},{id:"C1",group:"C · 客户卡片(BUG3)",desc:"客户卡片「编辑 / 导出本月」按钮文字清晰 · 不被截断"},{id:"D1",group:"D · 历史表头(BUG4)",desc:"手机宽度进单据记录 · 表头「文件·发票号·供应商」/「金额」单行 · 不竖排"},{id:"D2",group:"D · 历史表头(BUG4)",desc:"行内 INV-TH-202605-1006 这种长发票号正常单行展示 · 不一字一行"},{id:"E1",group:"E · 对账切换器(BUG6)",desc:"手机宽度进对账中心 · 顶栏点「全部客户」chip · 下拉从右上角向下展开 · 右对齐 · 不贴左屏边"},{id:"E2",group:"E · 对账切换器(BUG6)",desc:"下拉宽度自适应屏幕 · 不超出屏幕右边"},{id:"F1",group:"F · 通用设置回归",desc:"设置 → 个人资料 · 没有「界面语言」4 按钮卡"},{id:"F2",group:"F · 通用设置回归",desc:"左侧 nav 顺序:账户 / 公司 / 工作流 / 系统 / 关于"},{id:"F3",group:"F · 通用设置回归",desc:"系统 → 通用设置 · 4 行下拉(语言/时区/日期/数字)· 改语言立即切语言 · 改其他保存后 F5 仍保留"},{id:"G1",group:"G · 移动端 settings(回归)",desc:"手机宽度设置 tabs 不重叠 · 按分组分行 · chip 风格"},{id:"H1",group:"H · 回归",desc:"OCR 上传识别 / 客户管理 / 异常栏 / 对账中心 / 测试中心 全部仍工作"},{id:"H2",group:"H · 回归",desc:"4 语切换没新增异常(测试中心异常日志「API 失败」过滤无新条目)"},{id:"I1",group:"I · 三档移动 viewport",desc:"iPhone SE 375 · 上述 BUG 1-6 都修了"},{id:"I2",group:"I · 三档移动 viewport",desc:"Galaxy S 360 · 上述 BUG 1-6 都修了"},{id:"I3",group:"I · 三档移动 viewport",desc:"iPhone 12 Pro 414 · 上述 BUG 1-6 都修了"}];let o={},l="all",f=!1,g=!1;function x(F,Q,ie){let le=typeof t=="function"?t(F):null;return(!le||le===F)&&(le=Q),ie&&Object.keys(ie).forEach(function(ue){le=String(le).replace("{"+ue+"}",String(ie[ue]))}),le}function s(){try{const F=localStorage.getItem(a);o=F?JSON.parse(F):{},(typeof o!="object"||!o)&&(o={})}catch{o={}}}function p(){try{localStorage.setItem(a,JSON.stringify(o))}catch{}}function w(F){const Q=new Date(F),ie=function(le){return le<10?"0"+le:""+le};return ie(Q.getHours())+":"+ie(Q.getMinutes())+":"+ie(Q.getSeconds())}function h(F){return String(F??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function B(F,Q){try{typeof showToast=="function"?showToast(F,Q||"info"):alert(F)}catch{}}function S(F){try{navigator.clipboard&&navigator.clipboard.writeText?navigator.clipboard.writeText(F).then(function(){B(x("tc-toast-copied","已复制到剪贴板"),"success")}).catch(function(){I(F)}):I(F)}catch{I(F)}}function I(F){try{const Q=document.createElement("textarea");Q.value=F,Q.style.position="fixed",Q.style.opacity="0",document.body.appendChild(Q),Q.select();const ie=document.execCommand("copy");document.body.removeChild(Q),B(ie?x("tc-toast-copied","已复制"):x("tc-toast-copy-fail","复制失败"),ie?"success":"error")}catch{B(x("tc-toast-copy-fail","复制失败"),"error")}}function U(){const F=document.getElementById("tc-account-chip"),Q=document.getElementById("tc-progress-chip");if(F&&(F.textContent=_userInfo&&(_userInfo.email||_userInfo.username)||"—"),Q){const ie=n.length,le=n.filter(function(ue){return o[ue.id]}).length;Q.textContent=le+" / "+ie}}function N(){const F=document.getElementById("tc-checklist-body");if(!F)return;const Q={};n.forEach(function(le){Q[le.group]||(Q[le.group]=[]),Q[le.group].push(le)});const ie=[];Object.keys(Q).forEach(function(le){ie.push('<div class="tc-checklist-group">'),ie.push('<div class="tc-checklist-group-title">'+h(le)+"</div>"),Q[le].forEach(function(ue){const R=o[ue.id]||"",k=R?"is-"+R:"";ie.push('<div class="tc-check-item '+k+'" data-id="'+h(ue.id)+'"><div class="tc-check-id">'+h(ue.id)+'</div><div class="tc-check-desc">'+h(ue.desc)+'</div><div class="tc-check-actions">'+M(ue.id,"pass",R)+M(ue.id,"fail",R)+M(ue.id,"skip",R)+"</div></div>")}),ie.push("</div>")}),F.innerHTML=ie.join("")}function M(F,Q,ie){const le=ie===Q,ue={pass:'<svg viewBox="0 0 20 20" fill="none" stroke="currentColor" stroke-width="2.4" stroke-linecap="round" stroke-linejoin="round"><polyline points="4,11 8,15 16,5"/></svg>',fail:'<svg viewBox="0 0 20 20" fill="none" stroke="currentColor" stroke-width="2.4" stroke-linecap="round" stroke-linejoin="round"><line x1="5" y1="5" x2="15" y2="15"/><line x1="15" y1="5" x2="5" y2="15"/></svg>',skip:'<svg viewBox="0 0 20 20" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"><line x1="5" y1="10" x2="15" y2="10"/></svg>'},R={pass:x("tc-status-pass","通过"),fail:x("tc-status-fail","失败"),skip:x("tc-status-skip","跳过")};return'<button type="button" class="tc-status-btn '+(le?"is-active "+Q:"")+'" data-id="'+h(F)+'" data-kind="'+Q+'" title="'+h(R[Q])+'">'+ue[Q]+"</button>"}function L(F){return l==="all"?!0:l==="js_error"?F.type==="js_error"||F.type==="promise_error":l==="api"?F.type==="api_error"||F.type==="api_fail":l==="api_slow"?F.type==="api_slow":l==="console"?F.type==="console_error"||F.type==="console_warn":!0}function z(){const F=document.getElementById("tc-logs-body"),Q=document.getElementById("tc-logs-count");if(!F)return;const ie=(window._pearnlyTcLogs||[]).slice().reverse(),le=ie.filter(L);if(Q&&(Q.textContent=String(ie.length)),le.length===0){F.innerHTML='<div class="tc-logs-empty">'+h(x("tc-logs-empty","暂无异常"))+"</div>";return}const ue=le.slice(0,100).map(function(R){const k=typeof R.detail=="object"?JSON.stringify(R.detail,null,2):String(R.detail||"");return'<div class="tc-log-item t-'+h(R.type)+'" data-ts="'+R.ts+'"><span class="tc-log-time">'+w(R.ts)+'</span><span class="tc-log-type">'+h(R.type)+'</span><div class="tc-log-summary">'+h(R.summary)+'<div class="tc-log-detail">'+h(k)+"</div></div></div>"}).join("");F.innerHTML=ue,document.querySelectorAll("#tc-logs-filter .tc-filter-chip").forEach(function(R){R.classList.toggle("active",R.getAttribute("data-filter")===l)})}function V(){g||(g=!0,setTimeout(function(){g=!1,currentRoute==="test-center"&&document.getElementById("page-test-center")&&document.getElementById("page-test-center").classList.contains("active")&&z(),W()},200))}window._tcOnNewLog=V;function W(){const F=document.getElementById("nav-test-badge");if(!F)return;const Q=(window._pearnlyTcLogs||[]).filter(function(ie){return ie.type==="js_error"||ie.type==="promise_error"||ie.type==="api_error"||ie.type==="api_fail"||ie.type==="console_error"}).length;Q>0?(F.style.display="",F.textContent=Q>99?"99+":String(Q)):F.style.display="none"}function P(){U(),N(),z(),W()}function u(){const F=[],Q=new Date,ie=_userInfo&&(_userInfo.email||_userInfo.username)||"—";F.push("# Pearnly "+e+" 测试结果"),F.push("- 账号:"+ie),F.push("- 时间:"+Q.toISOString().replace("T"," ").slice(0,19));const le=n.length,ue=n.filter(function(re){return o[re.id]==="pass"}).length,R=n.filter(function(re){return o[re.id]==="fail"}).length,k=n.filter(function(re){return o[re.id]==="skip"}).length,Y=le-ue-R-k;F.push("- 进度:"+(ue+R+k)+" / "+le+" · ✅ "+ue+" · ❌ "+R+" · ⏭ "+k+" · 未测 "+Y),F.push(""),F.push("| ID | 描述 | 状态 |"),F.push("|---|---|---|"),n.forEach(function(re){const de=o[re.id],pe=de==="pass"?"✅":de==="fail"?"❌":de==="skip"?"⏭":"⬜";F.push("| "+re.id+" | "+re.desc.replace(/\|/g,"\\|")+" | "+pe+" |")});const X=n.filter(function(re){return o[re.id]==="fail"});X.length>0&&(F.push(""),F.push("## ❌ 失败项"),X.forEach(function(re){F.push("- **"+re.id+"** · "+re.desc)}));const ee=(window._pearnlyTcLogs||[]).slice(-30).reverse();return ee.length>0&&(F.push(""),F.push("## 🔴 异常日志(最近 "+ee.length+" 条)"),ee.forEach(function(re){if(F.push("- `"+w(re.ts)+"` · **"+re.type+"** · "+re.summary),re.detail){let de;try{de=JSON.stringify(re.detail)}catch{de=String(re.detail)}de&&de!=="{}"&&F.push("  - "+de.slice(0,600))}})),F.join(`
...
[`+V+" / "+W+"]")&&h(L),!1}async function h(L){const z=await p();if(typeof L=="function"&&l()!=="personal"&&z.length===1){x(Number(z[0].id)),L();return}if(typeof window.openWorkspaceChooserUI=="function"){window.openWorkspaceChooserUI({clients:z,canCreate:o(),active:f(),onPersonal:s,onPick:function(V){x(Number(V)),typeof L=="function"&&L()},emptyHint:z.length?null:o()?n("ws-empty-owner","还没有工作空间。创建一个公司后,上传、对账和 ERP 推送都会归属到该公司。"):n("ws-empty-employee","你还没有可用的工作空间,请联系管理员分配。")});return}if(!z.length){const V=o()?n("ws-empty-owner","还没有工作空间。创建一个公司后,上传、对账和 ERP 推送都会归属到该公司。"):n("ws-empty-employee","你还没有可用的工作空间,请联系管理员分配。");typeof window.showToast=="function"&&window.showToast(V,"info")}}function B(L){const z=L||document.getElementById("workspace-switcher-root");if(!z)return;const V=l(),W=f();let P,u;if(V==="client"&&W!=null){const $=(window._workspaceClientsCache||[]).find(T=>Number(T.id)===Number(W));P=I("building"),u=$?$.name:n("ws-current-label","当前工作空间")}else P=I("user"),u=n("ws-personal","个人事务");z.innerHTML='<button class="ws-ctrl-btn" id="ws-ctrl-btn" type="button">'+P+'<span class="ws-ctrl-label">'+S(u)+"</span></button>";const c=z.querySelector("#ws-ctrl-btn");c&&c.addEventListener("click",()=>h(null))}function S(L){return String(L??"").replace(/[&<>"']/g,function(z){return{"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"}[z]})}function I(L){const z='<svg class="ws-ic" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">';return L==="building"?z+'<rect x="2" y="7" width="20" height="14" rx="2"/><path d="M16 21V5a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v16"/></svg>':z+'<path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/></svg>'}function U(L){L=L||{};const z=L.clients||[],V=L.active,W=document.getElementById("ws-modal");W&&W.remove();const P=document.createElement("div");P.id="ws-modal",P.className="ws-modal";const c='<button type="button" class="ws-modal-item'+(l()==="personal"||V==null?" active":"")+'" data-ws-personal="1"><span class="ws-modal-item-ic">'+I("user")+'</span><span class="ws-modal-item-text" style="display:flex;flex-direction:column;align-items:flex-start;min-width:0;"><span class="ws-modal-item-name">'+S(n("ws-personal","个人事务"))+'</span><span class="ws-modal-item-desc" style="font-size:11px;color:#6b7280;font-weight:400;margin-top:2px;line-height:1.35;white-space:normal;">'+S(n("ws-personal-desc","用于临时识别、测试或处理不归属任何公司的文件。"))+"</span></span></button>";let y="";if(z.length){const D=['<option value="">'+S(n("ws-select-ph","— 选择账套主体 —"))+"</option>"].concat(z.map(function(J){const F=V!=null&&Number(V)===Number(J.id);return'<option value="'+S(J.id)+'"'+(F?" selected":"")+">"+S(J.name||"#"+J.id)+"</option>"}));y='<div class="ws-modal-select-row"><label class="ws-modal-select-label">'+S(n("ws-select-label","账套主体"))+'</label><select class="ws-modal-select" data-ws-select="1">'+D.join("")+"</select></div>"}const $=!z.length&&L.emptyHint?'<div class="ws-modal-empty">'+S(L.emptyHint)+"</div>":"",T=L.canCreate?'<div class="ws-modal-create"><button type="button" class="ws-modal-create-toggle" data-ws-create-toggle="1">+ '+S(n("ws-create-client","新建工作空间"))+'</button><div class="ws-modal-create-form" data-ws-create-form style="display:none;"><input type="text" class="ws-modal-create-input" data-ws-create-name placeholder="'+S(n("ws-create-ph","公司名称,例如 BAKELAB"))+'"><button type="button" class="ws-modal-create-submit" data-ws-create-submit="1">'+S(n("ws-create-submit","创建"))+"</button></div></div>":"";P.innerHTML='<div class="ws-modal-box" role="dialog" aria-modal="true"><div class="ws-modal-head"><span class="ws-modal-title">'+S(n("ws-chooser-title","选择工作空间"))+'</span><button type="button" class="ws-modal-close" data-ws-close="1" aria-label="close">✕</button></div><div class="ws-modal-subtitle" style="font-size:12px;color:#6b7280;padding:2px 4px 12px;line-height:1.45;white-space:normal;">'+S(n("ws-chooser-subtitle","账套主体 = 你的公司(发票卖方/开票方)。选择正在为哪家公司做账。"))+'</div><div class="ws-modal-list">'+c+y+"</div>"+$+T+"</div>",document.body.appendChild(P);const _=P.querySelector("[data-ws-select]");_&&_.addEventListener("change",function(){const D=_.value;D&&(typeof L.onPick=="function"&&L.onPick(D),E(),B())});function E(){P.remove()}P.addEventListener("click",function(D){if(D.target===P||D.target.closest("[data-ws-close]")){E();return}if(D.target.closest("[data-ws-personal]")){typeof L.onPersonal=="function"&&L.onPersonal(),E(),B();return}const F=D.target.closest("[data-ws-pick]");if(F){const le=F.getAttribute("data-ws-pick");typeof L.onPick=="function"&&L.onPick(le),E(),B();return}if(D.target.closest("[data-ws-create-toggle]")){const le=P.querySelector("[data-ws-create-form]");if(le){le.style.display=le.style.display==="none"?"flex":"none";const ue=le.querySelector("[data-ws-create-name]");ue&&ue.focus()}return}if(D.target.closest("[data-ws-create-submit]")){N(P,L,E);return}})}async function N(L,z,V){const W=L.querySelector("[data-ws-create-name]"),P=W?(W.value||"").trim():"";if(!P){W&&W.focus();return}let u=null;try{if(typeof window.apiPost=="function"){const y=await window.apiPost("/api/workspace/clients",{name:P});u=y&&typeof y.json=="function"?await y.json().catch(()=>null):y}}catch{u=null}const c=u&&(u.id||u.client&&u.client.id);if(!c){typeof window.showToast=="function"&&window.showToast(n("ws-create-fail","新建工作空间失败 · 请重试"),"error");return}window._workspaceClientsCache=await p(),x(Number(c)),z.onPick,V(),B()}window.openWorkspaceChooserUI=U,window.addEventListener("pearnly:workspace-changed",function(){B()}),window.getWorkMode=l,window.getActiveWorkspaceClientId=f,window.setActiveWorkspaceClientId=x,window.enterPersonalMode=s,window.requireWorkspace=w,window.openWorkspaceChooser=h,window.renderWorkspaceControl=B,window.fetchWorkspaceClients=p;function M(){try{if(sessionStorage.getItem("pearnly_ws_login_prompted")==="1"||f()!=null||localStorage.getItem(a)==="personal")return;sessionStorage.setItem("pearnly_ws_login_prompted","1"),setTimeout(function(){h(null)},800)}catch{}}p().then(L=>{window._workspaceClientsCache=L,B(),M()}),typeof window.subscribeI18n=="function"&&window.subscribeI18n("workspace-switcher",B)})();(function(){const e=V=>document.querySelector('[data-num-target="'+V+'"]');function a(V){if(!V)return t("reconcile-last-activity-none");try{const W=new Date(V),P=new Date,u=P-W;if(u/6e4<5)return t("reconcile-last-activity-just-now");if(W.toDateString()===P.toDateString())return t("reconcile-last-activity-today");const y=Math.max(1,Math.floor(u/(24*3600*1e3)));return t("reconcile-last-activity-days-ago").replace("{n}",y)}catch{return t("reconcile-last-activity-none")}}function n(V,W,P){const u=e(V);u&&(u.textContent=P?"-":String(W),u.classList.toggle("is-empty",!!P))}function o(V){const W=document.getElementById("reconcile-error");W&&(W.style.display=V?"flex":"none")}function l(V){const W=document.getElementById("reconcile-empty");W&&(W.style.display=V?"flex":"none")}function f(V,W){const P=document.getElementById("reconcile-last-activity");P&&(P.textContent=V,P.classList.toggle("has-data",!!W))}function g(V){const W=!V||(V.total_sessions||0)===0;n("pending",V.pending||0,W),n("matched",V.matched||0,W),n("unmatched",V.unmatched||0,W),f(a(V.last_activity_at),!!V.last_activity_at),o(!1),l(W)}function x(V){const W=V.toUpperCase();return W==="KBANK"?"bank-chip-kbank":W==="SCB"?"bank-chip-scb":W==="BBL"?"bank-chip-bbl":W==="KTB"?"bank-chip-ktb":W==="TTB"?"bank-chip-ttb":"bank-chip-other"}function s(V,W){const P=u=>u?String(u).slice(0,10):"?";return!V&&!W?"":P(V)+" ~ "+P(W)}function p(V){return V==null?"":String(V).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function w(V){const W=document.getElementById("reconcile-recent"),P=document.getElementById("reconcile-recent-list");if(!W||!P)return;const u=(V||[]).slice(0,20);if(u.length===0){W.style.display="none";return}W.style.display="",l(!1),P.innerHTML=u.map(c=>{const y=c.parse_status==="parse_failed",$=c.bank_code||"OTHER",T=c.account_last4?" ···"+p(c.account_last4):"",_=s(c.period_start,c.period_end),E=p(c.source_filename||""),D=Number(c.tx_count||0),J=y?'<span class="recon-card-fail" data-i18n="reconcile-card-parse-failed">'+t("reconcile-card-parse-failed")+"</span>":'<span class="recon-card-tx">'+t("reconcile-card-tx").replace("{n}",D)+"</span>";return'<div class="recon-card" data-session-id="'+p(c.id)+'" data-session-name="'+E+'"><span class="bank-chip '+x($)+'">'+p($)+'</span><div class="recon-card-main"><div class="recon-card-title">'+E+T+'</div><div class="recon-card-sub">'+p(_)+'</div></div><div class="recon-card-right">'+J+'</div><button class="recon-card-trash" data-trash="'+p(c.id)+'" title="'+p(t("bank-session-delete-tip")||"删除")+'"><svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"><path d="M3 5h10M6 5V3h4v2M5 5l1 9h4l1-9"/></svg></button><svg class="recon-card-arrow" viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M6 4l4 4-4 4"/></svg></div>'}).join(""),P.querySelectorAll(".recon-card").forEach(c=>{c.addEventListener("click",y=>{y.target.closest(".recon-card-trash")||(c.dataset.sessionId,h())})}),P.querySelectorAll(".recon-card-trash").forEach(c=>{c.addEventListener("click",y=>{y.stopPropagation();const $=c.dataset.trash,T=c.closest(".recon-card"),_=T&&T.dataset.sessionName||"";typeof window._deleteBankSession=="function"&&window._deleteBankSession($,_)})})}function h(V){typeof window.routeTo=="function"&&window.routeTo("reconcile"),setTimeout(function(){const W=document.querySelector('[data-recon-tab="bank"]');W&&W.click()},150)}function B(){o(!0),l(!1)}function S(){typeof window.routeTo=="function"&&window.routeTo("reconcile"),setTimeout(function(){const V=document.querySelector('[data-recon-tab="bank"]');V&&V.click()},150)}async function I(){n("pending",0,!0),n("matched",0,!0),n("unmatched",0,!0),f("",!1),o(!1),l(!1);const V=document.getElementById("reconcile-recent");V&&(V.style.display="none");const W={Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||"")};try{const[P,u]=await Promise.all([fetch("/api/bank-recon/stats",{headers:W}),fetch("/api/bank-recon/sessions?limit=20",{headers:W})]);if(!P.ok)throw new Error("http "+P.status);const c=await P.json(),y=u.ok?await u.json():[];g(c||{}),w(y||[])}catch(P){console.warn("[reconcile] load failed",P),B()}}function U(V){if(!V||!V.length)return;const W="Bearer "+(localStorage.getItem("mrpilot_token")||"");let P=0;const u=V.length;Array.from(V).forEach(function(c){const y=new FormData;y.append("file",c,c.name);const $=new XMLHttpRequest;$.open("POST","/api/bank-recon/upload"),$.setRequestHeader("Authorization",W),$.onload=function(){P++;try{const T=JSON.parse($.responseText);$.status===200&&T.tx_count!==void 0?showToast((t("bank-upload-ok")||"解析成功 · 共 {n} 条流水").replace("{n}",T.tx_count),"success"):showToast(c.name+" "+(t("upload-failed")||"上传失败"),"error")}catch{showToast(c.name+" "+(t("upload-failed")||"上传失败"),"error")}P===u&&setTimeout(I,600)},$.onerror=function(){P++,showToast(c.name+" "+(t("upload-failed")||"上传失败"),"error"),P===u&&setTimeout(I,600)},$.send(y)}),showToast((t("bank-queue-status-uploading")||"上传中")+"…","info")}function N(){if(window.__reconcileBound)return;window.__reconcileBound=!0;const V=document.getElementById("reconcile-bank-file-input");V&&V.addEventListener("change",function(){U(this.files),this.value=""}),document.addEventListener("click",W=>{if(W.target.closest("#btn-reconcile-upload-top")||W.target.closest("#btn-reconcile-upload-empty")){S();return}if(W.target.closest("#btn-reconcile-retry")){I();return}if(W.target.closest("#btn-reconcile-dev-seed")){z();return}})}const M=["468b50c1-5593-4fd6-990d-515ce8085563"];function L(){const V=document.getElementById("btn-reconcile-dev-seed");if(!V)return;const W=typeof _userInfo<"u"?_userInfo:null,P=W&&W.id&&M.indexOf(String(W.id))>=0;V.style.display=P?"":"none"}async function z(){try{const V=await fetch("/api/bank-recon/_dev/seed",{method:"POST",headers:{Authorization:"Bearer "+token}});if(!V.ok)throw new Error("seed:"+V.status);const W=await V.json(),P=(t("reconcile-dev-seed-ok")||"").replace("{n}",W.tx_count||0);showToast(P,"success"),typeof window.navigateTo=="function"?window.navigateTo("automation"):location.hash="#/automation",setTimeout(()=>{const u=document.querySelector('[data-auto-tab="bank"]');u&&u.click(),W.session_id&&typeof window._openBankSession=="function"&&window._openBankSession(W.session_id)},300)}catch(V){console.warn("[reconcile] dev seed failed",V),showToast(t("reconcile-dev-seed-fail")||"Seed failed","error")}}window.loadReconcilePage=async function(){N(),L(),typeof window._bankReconV2Init=="function"&&window._bankReconV2Init();try{await I()}catch{}},window._rerenderReconcile=function(){typeof currentRoute=="string"&&currentRoute==="reconcile"&&I().catch(()=>{})},typeof window.subscribeI18n=="function"&&window.subscribeI18n("reconcile",window._rerenderReconcile)})();(function(){let e={employeeId:null,employeeName:"",clients:[],selected:new Set,opened:!1};function a(){return document.getElementById("assign-clients-modal")}function n(){return document.getElementById("assign-clients-list")}function o(){return document.getElementById("assign-select-all")}function l(){return document.getElementById("assign-selected-count")}function f(){return document.getElementById("assign-modal-target")}function g(){const I=n();if(I){if(!e.clients.length){I.innerHTML='<div class="assign-empty">'+escapeHtml(t("assign-no-clients")||"暂无客户 · 请先到「客户管理」添加")+"</div>";return}I.innerHTML=e.clients.map(U=>{const N=String(U.id),M=e.selected.has(N)?"checked":"",L=escapeHtml(U.name||U.label||"#"+N),z=U.code?'<span class="assign-row-code">'+escapeHtml(U.code)+"</span>":"";return'<label class="assign-row"><input type="checkbox" data-cid="'+escapeHtml(N)+'" '+M+'><span class="assign-row-name">'+L+"</span>"+z+"</label>"}).join(""),x()}}function x(){const I=l();if(I){const N=t("assign-selected-count")||"已选 {n} / {total}";I.textContent=N.replace("{n}",e.selected.size).replace("{total}",e.clients.length)}const U=o();U&&(U.checked=e.clients.length>0&&e.selected.size===e.clients.length)}function s(){const I=f();I&&(I.textContent=e.employeeName?" · "+e.employeeName:"")}async function p(I,U){e.employeeId=I,e.employeeName=U||"",e.opened=!0,e.selected=new Set,e.clients=[],s();const N=n();N&&(N.innerHTML='<div class="assign-empty">'+escapeHtml(t("assign-loading")||"加载中...")+"</div>");const M=a();M&&(M.style.display="flex");try{const[L,z]=await Promise.all([apiGet("/api/clients?include_inactive=false"),apiGet("/api/team/employees/"+encodeURIComponent(I)+"/assignments")]);e.clients=L&&L.clients||[];const V=z&&z.client_ids||[];e.selected=new Set(V.map(String)),g()}catch(L){console.error("[assign-clients] load failed",L);const z=n();z&&(z.innerHTML='<div class="assign-empty">'+escapeHtml(t("assign-load-failed")||"加载失败 · 请重试")+"</div>")}}function w(){e.opened=!1;const I=a();I&&(I.style.display="none")}async function h(){if(!e.employeeId)return;const I=Array.from(e.selected).map(N=>parseInt(N,10)).filter(N=>!isNaN(N)),U=document.getElementById("assign-modal-save");U&&(U.disabled=!0);try{const N=await apiPost("/api/team/employees/"+encodeURIComponent(e.employeeId)+"/assignments",{client_ids:I});N&&N.ok!==!1?(showToast((t("assign-saved")||"已保存 {n} 个客户分配").replace("{n}",I.length),"success"),w(),typeof loadTeamList=="function"&&loadTeamList()):showToast(t("assign-save-failed")||"保存失败","error")}catch(N){console.error("[assign-clients] save failed",N),showToast(t("assign-save-failed")||"保存失败","error")}finally{U&&(U.disabled=!1)}}function B(){const I=a();if(!I||I.dataset.bound==="1")return;I.dataset.bound="1";const U=document.getElementById("assign-modal-close");U&&U.addEventListener("click",w);const N=document.getElementById("assign-modal-cancel");N&&N.addEventListener("click",w);const M=document.getElementById("assign-modal-save");M&&M.addEventListener("click",h),I.addEventListener("click",function(V){V.target===I&&w()});const L=o();L&&L.addEventListener("change",function(){L.checked?e.selected=new Set(e.clients.map(V=>String(V.id))):e.selected=new Set,g()});const z=n();z&&z.addEventListener("change",function(V){const W=V.target.closest('input[type="checkbox"][data-cid]');if(!W)return;const P=W.dataset.cid;W.checked?e.selected.add(P):e.selected.delete(P),x()})}function S(){e.opened&&(s(),g())}typeof window.subscribeI18n=="function"&&window.subscribeI18n("assign-clients-modal",S),window.openAssignClientsModal=function(I,U){B(),p(I,U)}})();(function(){const e={page:1,per_page:50,q:"",total:0,rows:[],loaded:!1};function a(w){if(!w)return"";try{return new Date(w).toLocaleString()}catch{return w}}function n(w){const h=document.getElementById("access-log-table");h&&(h.innerHTML='<div class="access-log-empty">'+escapeHtml(w)+"</div>");const B=document.getElementById("access-log-pager");B&&(B.innerHTML="")}function o(){const w=document.getElementById("access-log-table");if(!w)return;const h=e.rows||[];if(!h.length){n(t("set-access-log-empty"));return}const B=`
            <div class="access-log-row access-log-head">
                ...
                </div>`}).join("");w.innerHTML=B+S}function l(){const w=document.getElementById("access-log-pager");if(!w)return;const h=e.total||0;if(!h){w.innerHTML="";return}const B=e.page||1,S=e.per_page,I=Math.max(1,Math.ceil(h/S)),U=(t("set-access-log-pager-total")||"Total {n}").replace("{n}",h),N=(t("set-access-log-pager-page")||"Page {p} / {t}").replace("{p}",B).replace("{t}",I);w.innerHTML=`
            ...
            </div>`}async function f(w){const h=localStorage.getItem("mrpilot_token");if(h){e.page=w||1,n(t("set-access-log-loading"));try{const B="/api/me/access_log?page="+e.page+"&per_page="+e.per_page+"&q="+encodeURIComponent(e.q||""),S=await fetch(B,{headers:{Authorization:"Bearer "+h}});if(S.status===403){n(t("set-access-log-empty"));return}if(!S.ok)throw new Error("http_"+S.status);const I=await S.json();e.rows=I.logs||[],e.total=I.total||0,e.loaded=!0,o(),l()}catch{n(t("set-access-log-fail"))}}}async function g(){const w=localStorage.getItem("mrpilot_token");if(w)try{const h="/api/me/access_log.csv?q="+encodeURIComponent(e.q||""),B=await fetch(h,{headers:{Authorization:"Bearer "+w}});if(!B.ok){showToast(t("set-access-log-csv-fail")||"Export failed","error");return}const S=await B.blob(),I=document.createElement("a"),U=URL.createObjectURL(S);I.href=U,I.download="pearnly_access_log.csv",document.body.appendChild(I),I.click(),setTimeout(function(){URL.revokeObjectURL(U),I.remove()},100),showToast(t("set-access-log-csv-ok")||"Exported","success")}catch{showToast(t("set-access-log-csv-fail")||"Export failed","error")}}function x(){const w=document.querySelectorAll(".set-tab-owner-only"),h=!!(_userInfo&&(_userInfo.role==="owner"||_userInfo.is_super_admin));w.forEach(function(B){B.style.display=h?"":"none"})}document.addEventListener("click",function(w){if(w.target.closest('.settings-tab[data-tab="access-log"]')){setTimeout(function(){(!e.loaded||e.page!==1)&&f(1)},50);return}if(w.target.closest("#access-log-csv-btn")){w.preventDefault(),g();return}const S=w.target.closest(".access-log-pager-btn[data-access-log-page]");if(S&&!S.disabled){const I=parseInt(S.dataset.accessLogPage,10);f(I)}}),document.addEventListener("input",function(w){w.target&&w.target.id==="access-log-search"&&(clearTimeout(window.__accessLogSearchTimer),window.__accessLogSearchTimer=setTimeout(function(){e.q=(w.target.value||"").trim(),f(1)},350))});let s=0;const p=setInterval(function(){s++,_userInfo&&(x(),clearInterval(p)),s>60&&clearInterval(p)},500);typeof window.subscribeI18n=="function"&&window.subscribeI18n("me-access-log",function(){x(),e.loaded&&(o(),l())})})();(function(){const e=P=>document.getElementById(P);async function a(P,u){return await fetch(P,{method:"PATCH",headers:{Authorization:"Bearer "+token,"Content-Type":"application/json"},body:JSON.stringify(u||{})})}async function n(P){return await fetch(P,{method:"DELETE",headers:{Authorization:"Bearer "+token}})}let o=null;async function l(){try{o=await apiGet("/api/line/binding")}catch{o={bound:!1}}return o}function f(P,u){if(!P)return;P.style.display="",P.className="notif-line-check "+(u?"bound":"unbound");const c=u?'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M20 6 9 17l-5-5"/></svg>':'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><path d="M12 8v4M12 16h.01"/></svg>';P.innerHTML=c+"<span>"+escapeHtml(t(u?"notif-line-bound":"notif-line-not-bound"))+"</span>"}function g(P){if(P==null)return"-";const u=Number(P);return isNaN(u)?String(P):"฿ "+u.toLocaleString("en-US",{minimumFractionDigits:2,maximumFractionDigits:2})}function x(P){if(!P)return"-";try{const u=new Date(P),c=(u.getMonth()+1).toString().padStart(2,"0"),y=u.getDate().toString().padStart(2,"0"),$=u.getHours().toString().padStart(2,"0"),T=u.getMinutes().toString().padStart(2,"0");return`${c}-${y} ${$}:${T}`}catch{return P}}function s(P){const u=e("notif-rules-list"),c=e("notif-rules-empty"),y=e("notif-rules-count");if(!(!u||!c)){if(y.textContent=String(P.length),y.className="auto-status-pill "+(P.length>0?"active":"none"),!P.length){c.style.display="",u.style.display="none",u.innerHTML="";return}c.style.display="none",u.style.display="",u.innerHTML=P.map($=>{const T=$.template_code==="large_invoice",_=T?"notif-rule-large-tag":"notif-rule-exception-tag",E=T?"large":"";let D=[];if(T){const F=$.params&&$.params.threshold?g($.params.threshold):"-";D.push(escapeHtml(t("notif-rule-threshold-prefix"))+" "+F)}$.enabled||D.push('<span style="color:#9ca3af;">'+escapeHtml(t("notif-rule-disabled"))+"</span>");const J=D.length?D.join(' <span class="dot"></span> '):"";return`
        ...
        `}async function w(){try{const u=await fetch("/api/settings/dup-check",{headers:{Authorization:"Bearer "+token}});if(!u.ok)return;const c=await u.json(),y=document.getElementById("pref-dup-check");y&&(y.checked=!!c.enabled)}catch(u){console.warn("load prefs failed",u)}}const h=document.getElementById("pref-dup-check");h&&!h.dataset.bound&&(h.dataset.bound="1",h.addEventListener("change",async u=>{const c=u.target.checked;try{(await fetch("/api/settings/dup-check",{method:"PUT",headers:{Authorization:"Bearer "+token,"Content-Type":"application/json"},body:JSON.stringify({enabled:c})})).ok?showToast(c?t("pref-dup-check-on-toast"):t("pref-dup-check-off-toast"),"success"):(u.target.checked=!c,showToast(t("pref-save-failed"),"error"))}catch{u.target.checked=!c,showToast(t("pref-save-failed"),"error")}}));async function B(){const u=!!(_userInfo&&_userInfo.can_customize_archive);o=!u;const c=document.getElementById("archive-upgrade-banner");c&&(c.style.display=u?"none":"");const y=document.getElementById("archive-plus-badge");y&&(y.style.display=u?"none":"");try{const $=await fetch("/api/archive/settings",{headers:{Authorization:"Bearer "+token}});if(!$.ok)throw new Error("load failed");const T=await $.json();e=Array.isArray(T.name_template)?T.name_template:[],a=T.folder_strategy||"by_month_seller"}catch($){console.error("load archive settings failed",$),showToast(t("archive-load-failed"),"error");return}S(),I(),U(),N()}function S(){const u=document.getElementById("archive-rule-canvas");if(u){if(e.length===0){u.innerHTML=`<div class="archive-empty">${escapeHtml(t("archive-rule-empty"))}</div>`;return}u.innerHTML=e.map((c,y)=>{const $=f[c.type]||{label:c.type},T=l[c.type]||"",_=c.type==="sep"?`"${escapeHtml(c.val||"_")}"`:escapeHtml(t($.label));return`
            ...
            `}).join("")}function U(){document.querySelectorAll('input[name="folder-strategy"]').forEach(u=>{u.checked=u.value===a,u.disabled=o})}async function N(){const u=document.getElementById("archive-preview-name"),c=document.getElementById("archive-preview-hint");if(c&&(c.textContent=t("archive-preview-hint",{category:g()})),!!u){if(e.length===0){u.textContent="-";return}try{const $=await(await fetch("/api/archive/rename-preview",{method:"POST",headers:{Authorization:"Bearer "+token,"Content-Type":"application/json"},body:JSON.stringify({merged_fields:s().merged_fields,name_template:e})})).json();u.textContent=($.name||"-")+".pdf"}catch{u.textContent="("+t("archive-preview-error")+")"}}}window._rerenderArchiveAll=function(){const u=document.getElementById("archive-rule-modal");!u||u.style.display==="none"||(S(),I(),N())};let M=-1;document.addEventListener("dragstart",u=>{const c=u.target.closest(".archive-token");!c||o||(M=parseInt(c.dataset.tokenIdx,10),c.classList.add("dragging"),u.dataTransfer.effectAllowed="move")}),document.addEventListener("dragend",u=>{document.querySelectorAll(".archive-token").forEach(c=>c.classList.remove("dragging","drop-target")),M=-1}),document.addEventListener("dragover",u=>{const c=u.target.closest(".archive-token");c&&(u.preventDefault(),u.dataTransfer.dropEffect="move",document.querySelectorAll(".archive-token").forEach(y=>y.classList.remove("drop-target")),c.classList.add("drop-target"))}),document.addEventListener("drop",u=>{const c=u.target.closest(".archive-token");if(!c||M<0||o)return;u.preventDefault();const y=parseInt(c.dataset.tokenIdx,10);if(y===M)return;const $=e.splice(M,1)[0];e.splice(y,0,$),M=-1,S(),N()}),document.addEventListener("click",u=>{if(u.target.closest("#btn-open-archive-rule")||u.target.closest("#btn-open-archive-rule-from-settings")){const T=document.getElementById("archive-rule-modal");T&&(T.style.display="",B());return}if(u.target.closest("#archive-rule-modal-close")||u.target.id==="archive-rule-modal"){const T=document.getElementById("archive-rule-modal");T&&(T.style.display="none");return}const c=u.target.closest(".settings-nav-item");if(c){switchSettingsTab(c.dataset.settingsTab);return}if(o&&u.target.closest(".archive-token, [data-add-field], #btn-archive-save, #btn-archive-reset")){showToast(t("feature-contact-us"),"info");return}const y=u.target.closest("[data-add-field]");if(y){const T=y.dataset.addField,_=f[T],E={type:T,..._.defaultCfg};e.push(E),S(),N();return}const $=u.target.closest(".archive-token");if($&&!o){L(parseInt($.dataset.tokenIdx,10));return}if(u.target.closest("#btn-archive-save"))return W();if(u.target.closest("#btn-archive-reset"))return P();(u.target.closest("#archive-token-close")||u.target.id==="archive-token-modal")&&(document.getElementById("archive-token-modal").style.display="none"),u.target.closest("#btn-archive-token-ok")&&z(),u.target.closest("#btn-archive-token-delete")&&V()}),document.addEventListener("change",u=>{u.target.name==="folder-strategy"&&(a=u.target.value)});function L(u){n=u;const c=e[u];if(!c)return;const y=document.getElementById("archive-token-body");let $="";c.type==="date"?$=`
        ...
        </div>`,w=document.createElement("div");w.innerHTML=p,document.body.appendChild(w.firstElementChild),document.getElementById("report-modal-close-x").addEventListener("click",n),document.getElementById("report-modal-cancel").addEventListener("click",n),document.getElementById("report-modal").addEventListener("click",h=>{h.target.id==="report-modal"&&n()})}function n(){const p=document.getElementById("report-modal");p&&(p.style.display="none"),o=null}let o=null;async function l(p,w){const h=p+":"+(w||"");if(e[h])return e[h];let B;try{const S=localStorage.getItem("mrpilot_token"),I=await fetch(`/api/reports/templates?lang=${encodeURIComponent(p)}`,{headers:{Authorization:"Bearer "+S}});if(!I.ok)throw new Error("templates fetch failed");B=(await I.json()).templates||[]}catch(S){console.error("fetchTemplates fail",S),B=[{code:"input_vat",name:t("tpl-input-vat"),desc:t("tpl-input-vat-desc"),recommended:!0},{code:"standard",name:t("tpl-standard"),desc:t("tpl-standard-desc"),recommended:!1},{code:"print",name:t("tpl-print"),desc:t("tpl-print-desc"),recommended:!1}]}if(B=B.filter(S=>S.code!=="erp"),w==="history-batch"){const S=B.findIndex(U=>U.code==="standard"),I=S>=0?S+1:B.length;B.splice(I,0,{code:"sales_detail_th",name:t("export-tpl-sales-detail"),desc:t("export-tpl-sales-detail-desc"),recommended:!1,is_new:!0})}return e[h]=B,B}function f(p){const w=document.getElementById("report-tpl-list"),h=p.map((S,I)=>`
...
`,e.dataset.wbInjected="1";try{const a=window._currentLang||localStorage.getItem("mrpilot_lang")||"th",n=window.I18N;n&&n[a]&&(e.querySelectorAll("[data-i18n]").forEach(o=>{const l=o.getAttribute("data-i18n");n[a][l]&&(o.textContent=n[a][l])}),e.querySelectorAll("[data-i18n-placeholder]").forEach(o=>{const l=o.getAttribute("data-i18n-placeholder");n[a][l]&&(o.placeholder=n[a][l])}))}catch{}}})();(function(){let e=[],a=null,n="",o="seller";const l={page:0,pageSize:12,keyword:""},f=new Set;let g=[];const x={keyword:""};let s=null;function p(){return{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||"")}}async function w(k,Y={}){const X=await fetch(k,{...Y,headers:{"Content-Type":"application/json",...p(),...Y.headers||{}}});if(!X.ok){const ee=await X.json().catch(()=>({}));throw new Error(ee.detail||"HTTP "+X.status)}return X.json()}async function h(){try{e=(await w("/api/clients")).clients||[],window._clientsCache=e}catch(k){console.error("loadClientsCache fail",k),e=[]}try{typeof window._refreshExcClientFilter=="function"&&window._refreshExcClientFilter()}catch{}try{typeof window._refreshClientSwitcher=="function"&&window._refreshClientSwitcher()}catch{}return e}function B(k){o=k==="buyer"?"buyer":"seller",document.querySelectorAll("[data-cust-tab]").forEach(ee=>ee.classList.toggle("active",ee.dataset.custTab===o));const Y=document.getElementById("cust-pane-seller"),X=document.getElementById("cust-pane-buyer");Y&&Y.classList.toggle("active",o==="seller"),X&&X.classList.toggle("active",o==="buyer")}function S(){const k=window._userInfo||{},Y=String(k.role||"").toLowerCase(),X=String(k.tenant_role||"").toLowerCase();return k.is_super_admin===!0||k.is_owner===!0||Y==="owner"||Y==="admin"||X==="owner"||X==="admin"}function I(){window._workspaceClientsCache=g,typeof window.renderWorkspaceControl=="function"&&window.renderWorkspaceControl()}async function U(){try{const k=await w("/api/workspace/clients");g=k&&(k.clients||k.items)||[],window._workspaceClientsCache=g}catch(k){console.error("loadSellerCache fail",k),g=[]}return g}function N(){const k=x.keyword.trim().toLowerCase();return k?g.filter(Y=>(Y.name||"").toLowerCase().includes(k)||(Y.tax_id||"").toLowerCase().includes(k)):g}function M(){const k=document.getElementById("seller-tbody");if(!k)return;const Y=S(),X=document.getElementById("btn-seller-new");X&&(X.style.display=Y?"":"none");const ee=N(),re=typeof window.getActiveWorkspaceClientId=="function"?window.getActiveWorkspaceClientId():null;if(!ee.length){k.innerHTML=`<div class="cust-empty">${escapeHtml(t(x.keyword?"cust-no-match":"seller-empty"))}</div>`;return}k.innerHTML=ee.map(de=>{const G=re!=null&&Number(re)===Number(de.id)?`<span class="cust-badge-current"><svg viewBox="0 0 14 14" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M2 7.5l3.2 3.2L12 4"/></svg>${escapeHtml(t("seller-current"))}</span>`:`<button class="cust-row-btn primary" data-saction="activate" data-wid="${de.id}">${escapeHtml(t("seller-set-current"))}</button>`,ae=Y?`
            ...
            </div>`}).join("")}function L(k){s=k?k.id:null,document.getElementById("wsclient-modal-title").textContent=t(k?"wsclient-modal-edit":"wsclient-modal-new"),document.getElementById("wsclient-input-name").value=k&&k.name||"",document.getElementById("wsclient-input-tax").value=k&&k.tax_id||"",document.getElementById("wsclient-modal-archive").style.display=k?"":"none",document.getElementById("wsclient-modal-mask").style.display="flex",setTimeout(()=>document.getElementById("wsclient-input-name").focus(),50)}function z(){document.getElementById("wsclient-modal-mask").style.display="none",s=null}async function V(){const k=document.getElementById("wsclient-input-name").value.trim(),Y=document.getElementById("wsclient-input-tax").value.trim();if(!k){showToast(t("client-msg-name-required"),"fail");return}try{s?(await w("/api/workspace/clients/"+s,{method:"PATCH",body:JSON.stringify({name:k,tax_id:Y})}),showToast(t("client-msg-updated"),"success")):(await w("/api/workspace/clients",{method:"POST",body:JSON.stringify({name:k,tax_id:Y||null})}),showToast(t("client-msg-created"),"success")),z(),await U(),M(),I()}catch(X){const ee=X&&X.message?X.message:t("client-msg-save-fail");showToast(t("client-msg-save-fail")+" · "+ee,"fail")}}async function W(){if(!s)return;const k=g.find(X=>Number(X.id)===Number(s));if(await showConfirm(t("wsclient-archive-confirm").replace("{name}",k?k.name:""),{danger:!0}))try{const X=s;await w("/api/workspace/clients/"+X,{method:"DELETE"}),showToast(t("wsclient-archived"),"success"),typeof window.getActiveWorkspaceClientId=="function"&&Number(window.getActiveWorkspaceClientId())===Number(X)&&typeof window.enterPersonalMode=="function"&&window.enterPersonalMode(),z(),await U(),M(),I()}catch{showToast(t("client-msg-save-fail"),"fail")}}function P(){const k=l.keyword.trim().toLowerCase();return k?e.filter(Y=>(Y.name||"").toLowerCase().includes(k)||(Y.short_name||"").toLowerCase().includes(k)||(Y.tax_id||"").toLowerCase().includes(k)):e}function u(){const k=P(),Y=l.pageSize,X=Math.max(0,Math.ceil(k.length/Y)-1);l.page>X&&(l.page=X);const ee=l.page*Y;return{all:k,items:k.slice(ee,ee+Y),start:ee,ps:Y,total:k.length,maxPage:X}}function c(){const k=document.getElementById("buyer-tbody");if(!k)return;const{items:Y,start:X,ps:ee,total:re,maxPage:de}=u();re?k.innerHTML=Y.map(d=>{const m=f.has(d.id);return`<div class="cust-row buyer-grid${m?" selected":""}" data-cid="${d.id}">
...
`,e.dataset.wbInjected="1";try{const a=window._currentLang||localStorage.getItem("mrpilot_lang")||"th",n=window.I18N;n&&n[a]&&(e.querySelectorAll("[data-i18n]").forEach(o=>{const l=o.getAttribute("data-i18n");n[a][l]&&(o.textContent=n[a][l])}),e.querySelectorAll("[data-i18n-placeholder]").forEach(o=>{const l=o.getAttribute("data-i18n-placeholder");n[a][l]&&(o.placeholder=n[a][l])}))}catch{}}})();(function(){let e={statsCache:null,listCache:[],currentRule:null,currentClient:"",currentStatus:"pending",loading:!1,selectedIds:new Set,offset:0,pageSize:50,total:0,loadFailed:!1,listScrollY:0};function a(d,m){let q=t(d)||d;if(m)for(const Z in m)q=q.replace(new RegExp("\\{"+Z+"\\}","g"),String(m[Z]));return q}async function n(){try{const d=e.currentClient||"",m="/api/exceptions/stats?status=pending"+(d?"&client_id="+encodeURIComponent(d):""),q=await fetch(m,{headers:{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||"")}});if(!q.ok)return;const Z=await q.json(),i=document.getElementById("nav-exc-badge");if(!i)return;const v=parseInt(Z.pending||0,10);v>0?(i.textContent=v>99?"99+":String(v),i.style.display=""):i.style.display="none"}catch{}}function o(d){return d==="high"?`<svg viewBox="0 0 14 14" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
        ...
        `;const fe=document.getElementById("exc-fld-edit");fe&&fe.addEventListener("click",()=>{_.editing=!0,_.editFields={...ie(_.history)},R()});const ve=document.getElementById("exc-fld-cancel");ve&&ve.addEventListener("click",()=>{_.editing=!1,_.editFields=null,R()});const he=document.getElementById("exc-fld-save");he&&he.addEventListener("click",()=>k()),document.querySelectorAll(".exc-field-input").forEach(be=>{be.addEventListener("input",()=>{_.editFields||(_.editFields={}),_.editFields[be.dataset.editKey]=be.value})});const ke=document.getElementById("exc-pdf-retry");ke&&_.openExcId&&ke.addEventListener("click",()=>{_.excRow&&D(_.excRow.history_id,_.openExcId)});const Le=d.status==="pending",Be=!!(d.seller_name&&d.seller_name.trim()),Ie=document.getElementById("exc-btn-resolve"),Ae=document.getElementById("exc-btn-ignore");Ie.disabled=!Le,Ae.disabled=!Le||!Be,Ae.title=Be?t("exc-ignore-hint"):t("exc-ignore-no-seller")}async function k(){if(!_.openExcId||!_.history||!_.history.pages||_.loading)return;_.loading=!0;const d=showToast(t("exc-fld-saving"),"loading",0);try{const m=JSON.parse(JSON.stringify(_.history.pages||[]));let q=m.findIndex(H=>!H.is_duplicate&&!H.is_copy);q<0&&(q=0),m[q]||(m[q]={fields:{}});const Z=m[q].fields||{},i=_.editFields||{},v=new Set(["subtotal","vat","total_amount"]),b={...Z};for(const H in i){let r=i[H];if((r===""||r===void 0)&&(r=null),v.has(H)&&r!==null){const C=parseFloat(r);r=isNaN(C)?null:C}b[H]=r}m[q].fields=b;const j=await fetch("/api/history/"+encodeURIComponent(_.history.id),{method:"PUT",headers:{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||""),"Content-Type":"application/json"},body:JSON.stringify({pages:m})});if(!j.ok)throw new Error("http "+j.status);d(),showToast(t("exc-fld-save-ok"),"success"),F(),await B(),await I(),n()}catch(m){d(),console.warn("save fields fail",m),showToast(t("exc-fld-save-fail"),"error")}finally{_.loading=!1}}async function Y(){if(!(!_.openExcId||_.loading)){_.loading=!0;try{const d=await fetch("/api/exceptions/"+_.openExcId+"/resolve",{method:"POST",headers:{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||"")}});if(!d.ok)throw new Error("http "+d.status);showToast(t("exc-toast-resolved"),"success"),F(),await B(),await I(),n()}catch(d){console.warn("resolve fail",d),showToast(t("exc-toast-action-fail"),"error")}finally{_.loading=!1}}}async function X(){if(!(!_.openExcId||_.loading)){_.loading=!0;try{const d=await fetch("/api/exceptions/"+_.openExcId+"/ignore",{method:"POST",headers:{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||"")}});if(!d.ok)throw new Error("http "+d.status);showToast(t("exc-toast-ignored"),"success"),F(),await B(),await I(),n()}catch(d){console.warn("ignore fail",d),showToast(t("exc-toast-action-fail"),"error")}finally{_.loading=!1}}}let ee=!1;async function re(){if(ee)return;const d=Array.from(e.selectedIds);if(d.length===0||!await showConfirm(a("exc-batch-confirm-resolve",{n:d.length})))return;ee=!0;const q=showToast(a("exc-batch-count",{n:d.length})+" …","loading",0);try{const Z=await fetch("/api/exceptions/batch",{method:"POST",headers:{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||""),"Content-Type":"application/json"},body:JSON.stringify({ids:d,action:"resolve"})});if(!Z.ok)throw new Error("http "+Z.status);const i=await Z.json();q(),showToast(a("exc-toast-batch-resolved",{n:i.processed||0}),"success"),e.selectedIds.clear(),await B(),await I(),n()}catch(Z){q(),console.warn("batch resolve fail",Z),showToast(t("exc-toast-batch-fail"),"error")}finally{ee=!1}}async function de(){if(ee)return;const d=Array.from(e.selectedIds);if(d.length===0||!await showConfirm(a("exc-batch-confirm-ignore",{n:d.length}),{danger:!1}))return;ee=!0;const q=showToast(a("exc-batch-count",{n:d.length})+" …","loading",0);try{const Z=await fetch("/api/exceptions/batch",{method:"POST",headers:{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||""),"Content-Type":"application/json"},body:JSON.stringify({ids:d,action:"ignore"})});if(!Z.ok)throw new Error("http "+Z.status);const i=await Z.json();q(),showToast(a("exc-toast-batch-ignored",{n:i.processed||0,wl:i.whitelist_added||0}),"success"),e.selectedIds.clear(),await B(),await I(),n()}catch(Z){q(),console.warn("batch ignore fail",Z),showToast(t("exc-toast-batch-fail"),"error")}finally{ee=!1}}function pe(){e.selectedIds.clear(),p(e.listCache)}document.addEventListener("click",d=>{d.target.closest("#exc-drawer-close")&&F(),d.target.closest("#exc-drawer-mask")&&F(),d.target.closest("#exc-btn-resolve")&&Y(),d.target.closest("#exc-btn-ignore")&&X(),d.target.closest("#exc-batch-resolve")&&re(),d.target.closest("#exc-batch-ignore")&&de(),d.target.closest("#exc-batch-clear")&&pe(),d.target.closest("#exc-loadmore")&&U()}),document.addEventListener("keydown",d=>{d.key==="Escape"&&_.openExcId&&F()}),document.addEventListener("click",d=>{d.target.closest("#btn-exc-refresh")&&(typeof window.loadExceptionsPage=="function"&&window.loadExceptionsPage(),n())}),document.addEventListener("change",d=>{if(!d.target.closest("#exc-client-filter"))return;const m=d.target;e.currentClient=m.value||"",e.currentRule=null,e.selectedIds.clear(),e.listCache=[],typeof window.loadExceptionsPage=="function"&&window.loadExceptionsPage(),n()}),document.addEventListener("click",d=>{const m=d.target.closest("#exc-status-tabs .exc-status-tab");if(!m)return;const q=m.dataset.status||"pending";q!==e.currentStatus&&(e.currentStatus=q,e.currentRule=null,e.selectedIds.clear(),e.listCache=[],typeof window.loadExceptionsPage=="function"&&window.loadExceptionsPage())}),window.addEventListener("online",()=>{e.loadFailed&&document.getElementById("page-exceptions")?.classList.contains("show")&&window.loadExceptionsPage&&window.loadExceptionsPage()}),setTimeout(n,1500),setInterval(n,6e4);function G(d){if(!d)return"—";try{const m=new Date(d),q=Z=>String(Z).padStart(2,"0");return`${m.getFullYear()}-${q(m.getMonth()+1)}-${q(m.getDate())} ${q(m.getHours())}:${q(m.getMinutes())}`}catch{return d.slice(0,16).replace("T"," ")}}async function ae(){const d=document.getElementById("learned-list");if(d){d.innerHTML=`<div class="learned-empty">${escapeHtml(t("set-learned-loading"))}</div>`;try{const m=await fetch("/api/exception-whitelist",{headers:{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||"")}});if(!m.ok)throw new Error("http "+m.status);const Z=(await m.json()).items||[];if(Z.length===0){d.innerHTML=`<div class="learned-empty">${escapeHtml(t("set-learned-empty"))}</div>`;return}const i=`<svg viewBox="0 0 14 14" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round">
                ...
                `}).join("")}catch(m){console.warn("loadLearnedRules fail",m),d.innerHTML=`<div class="learned-empty">${escapeHtml(t("exc-toast-load-fail"))}</div>`}}}window.loadLearnedRules=ae,document.addEventListener("click",async d=>{const m=d.target.closest("[data-del-wl]");if(!m)return;const q=parseInt(m.dataset.delWl,10);if(!q)return;const Z=m.closest(".learned-row"),i=Z&&Z.querySelector(".learned-seller"),v=i?i.textContent.trim():"",b=t("set-learned-del-confirm").replace("{seller}",v);if(await showConfirm(b,{danger:!0}))try{const H=await fetch("/api/exception-whitelist/"+q,{method:"DELETE",headers:{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||"")}});if(!H.ok)throw new Error("http "+H.status);showToast(t("set-learned-del-ok"),"success"),ae(),typeof window.loadExceptionsPage=="function"&&document.getElementById("page-exceptions")?.classList.contains("show")&&window.loadExceptionsPage()}catch(H){console.warn("delete whitelist fail",H),showToast(t("set-learned-del-fail"),"error")}})})();(function(){function e(h){try{if(location.search.indexOf("test_center=1")>=0||localStorage.getItem("pearnly_test_mode")==="1"||h&&h.id&&String(h.id)==="468b50c1-5593-4fd6-990d-515ce8085563")return!0}catch{}return!1}window.applyRoleVisibility=function(){var B=window._userInfo,S=!1,I=!0,U=!1,N=!1;B&&(S=typeof canManageTeam=="function"?canManageTeam(B):!!(B.role==="owner"||B.is_super_admin),I=typeof shouldHideMoney=="function"?shouldHideMoney(B):B.role==="member"&&!B.is_super_admin,U=typeof isSuperAdmin=="function"?isSuperAdmin(B):!!B.is_super_admin,N=e(B)),document.querySelectorAll("[data-show-if-team]").forEach(function(L){L.style.display=S?"":"none"}),document.querySelectorAll("[data-show-if-money]").forEach(function(L){L.style.display=I?"none":""}),document.querySelectorAll("[data-show-if-admin]").forEach(function(L){L.style.display=U?"":"none"}),document.querySelectorAll("[data-show-if-test]").forEach(function(L){L.style.display=N?"":"none"});var M=U||N;document.querySelectorAll("[data-show-if-special]").forEach(function(L){L.style.display=M?"":"none"})},window.renderAvatarMenu=function(B){if(B){var S=document.getElementById("avatar-btn"),I=document.getElementById("avatar-popup-name"),U=document.getElementById("avatar-popup-email");if(!(!S||!I||!U)){var N=(B.username||"").trim(),M=N.split("@")[0]||N||"—",L=(N.charAt(0)||"?").toUpperCase(),z=(B.avatar_url||"").trim();if(z){var V=z.replace(/"/g,"&quot;"),W=L.replace(/'/g,"\\'");S.innerHTML='<img src="'+V+'" alt="'+L+`" referrerpolicy="no-referrer" onerror="this.parentNode.textContent='`+W+`'">`}else S.textContent=L;I.textContent=M,U.textContent=N||"—",S.setAttribute("title",N||"")}}};function a(){var h=document.getElementById("avatar-wrap"),B=document.getElementById("avatar-btn"),S=document.getElementById("avatar-popup");if(!h||!B||!S)return;function I(){S.classList.remove("show"),B.setAttribute("aria-expanded","false")}function U(){S.classList.add("show"),B.setAttribute("aria-expanded","true")}B.addEventListener("click",function(N){N.stopPropagation(),S.classList.contains("show")?I():U()}),document.addEventListener("click",function(N){S.classList.contains("show")&&!h.contains(N.target)&&I()}),S.addEventListener("click",function(N){var M=N.target.closest(".avatar-popup-item");if(M){var L=M.dataset.action;switch(I(),L){case"settings":typeof openSettingsModal=="function"?openSettingsModal():typeof routeTo=="function"&&routeTo("settings");break;case"team":typeof openSettingsModal=="function"?openSettingsModal():typeof routeTo=="function"&&routeTo("settings"),setTimeout(function(){typeof switchSettingsTab=="function"&&switchSettingsTab("team")},50);break;case"billing":typeof openSettingsModal=="function"?openSettingsModal():typeof routeTo=="function"&&routeTo("settings"),setTimeout(function(){typeof switchSettingsTab=="function"&&switchSettingsTab("plan")},50);break;case"shortcuts":if(typeof showToast=="function"){var z=typeof t=="function"?t("feature-coming-soon"):"即将上线";showToast(z||"即将上线","info")}break;case"admin":window.location.href="/admin/cost";break;case"test-center":typeof routeTo=="function"&&routeTo("test-center");break;case"help":var V=document.getElementById("help-modal");V&&(V.style.display="flex");break;case"logout":try{localStorage.removeItem("mrpilot_token")}catch{}try{localStorage.removeItem("mrpilot_user")}catch{}window.location.href="/";break}}}),window._closeAvatarPopup=I}function n(){return[].slice.call(document.querySelectorAll(".cmdk-item")).filter(function(h){return h.style.display!=="none"})}function o(h){var B=n();B.forEach(function(S){S.classList.remove("focus")}),B[h]&&(B[h].classList.add("focus"),B[h].scrollIntoView({block:"nearest"}))}function l(h){var B=n();if(B.length){var S=B.findIndex(function(U){return U.classList.contains("focus")});S<0&&(S=0);var I=(S+h+B.length)%B.length;o(I)}}function f(h){h=(h||"").toLowerCase().trim();var B=0,S=window._userInfo,I=typeof isSuperAdmin=="function"?isSuperAdmin(S):!!(S&&S.is_super_admin),U=e(S);document.querySelectorAll(".cmdk-item").forEach(function(M){if(M.dataset.showIfAdmin==="1"&&!I){M.style.display="none";return}if(M.dataset.showIfTest==="1"&&!U){M.style.display="none";return}var L=(M.dataset.cmdkText||M.textContent||"").toLowerCase(),z=!h||L.indexOf(h)>=0;M.style.display=z?"":"none",M.classList.remove("focus"),z&&B++}),document.querySelectorAll("[data-cmdk-section]").forEach(function(M){for(var L=M.nextElementSibling,z=!1;L&&!L.hasAttribute("data-cmdk-section");){if(L.classList&&L.classList.contains("cmdk-item")&&L.style.display!=="none"){z=!0;break}L=L.nextElementSibling}M.style.display=z?"":"none"});var N=document.getElementById("cmdk-empty");N&&(N.style.display=B===0?"flex":"none"),o(0)}window.openCmdk=function(){var B=document.getElementById("cmdk-mask");B&&(typeof window._closeAvatarPopup=="function"&&window._closeAvatarPopup(),B.classList.add("show"),typeof window.applyRoleVisibility=="function"&&window.applyRoleVisibility(),setTimeout(function(){var S=document.getElementById("cmdk-input");S&&(S.value="",f(""),S.focus(),o(0))},50))},window.closeCmdk=function(){var B=document.getElementById("cmdk-mask");B&&B.classList.remove("show")};function g(h){if(h){if(h.classList.contains("cmdk-item-locked")){if(typeof showToast=="function"){var B=typeof t=="function"?t("feature-coming-soon"):"即将上线";showToast(B||"即将上线","info")}return}var S=h.dataset.cmdkRoute,I=h.dataset.cmdkAction;if(window.closeCmdk(),S){typeof routeTo=="function"&&routeTo(S);return}if(I){if(I==="open-admin"){window.location.href="/admin/cost";return}if(I.indexOf("lang-")===0){var U=I.slice(5);typeof applyLang=="function"&&applyLang(U)}}}}function x(){var h=document.getElementById("cmdk-mask"),B=document.getElementById("cmdk-input"),S=document.getElementById("cmdk-body");if(!(!h||!B||!S)){h.addEventListener("click",function(N){N.target===h&&window.closeCmdk()});var I=document.getElementById("cmdk-esc-btn");I&&I.addEventListener("click",function(){window.closeCmdk()}),B.addEventListener("input",function(N){f(N.target.value)}),B.addEventListener("keydown",function(N){N.key==="ArrowDown"?(N.preventDefault(),l(1)):N.key==="ArrowUp"?(N.preventDefault(),l(-1)):N.key==="Enter"?(N.preventDefault(),g(h.querySelector(".cmdk-item.focus"))):N.key==="Escape"&&(N.preventDefault(),window.closeCmdk())}),S.addEventListener("click",function(N){var M=N.target.closest(".cmdk-item");M&&g(M)}),S.addEventListener("mousemove",function(N){var M=N.target.closest(".cmdk-item");!M||M.style.display==="none"||M.classList.contains("cmdk-item-locked")||(n().forEach(function(L){L.classList.remove("focus")}),M.classList.add("focus"))});var U=document.getElementById("topbar-search");U&&(U.addEventListener("click",function(){window.openCmdk()}),U.addEventListener("keydown",function(N){(N.key==="Enter"||N.key===" ")&&(N.preventDefault(),window.openCmdk())}))}}document.addEventListener("keydown",function(h){if((h.metaKey||h.ctrlKey)&&(h.key==="k"||h.key==="K")){h.preventDefault(),window.openCmdk();return}if(h.key==="Escape"){var B=document.getElementById("cmdk-mask");if(B&&B.classList.contains("show")){window.closeCmdk();return}var S=document.getElementById("avatar-popup");S&&S.classList.contains("show")&&typeof window._closeAvatarPopup=="function"&&window._closeAvatarPopup()}});try{var s=(navigator.userAgent||"").toLowerCase(),p=s.indexOf("mac")>=0||s.indexOf("iphone")>=0||s.indexOf("ipad")>=0;p||document.body.classList.add("is-windows")}catch{}function w(){a(),x(),typeof window.subscribeI18n=="function"&&window.subscribeI18n("nav-ia-phase1-role",function(){try{typeof window.applyRoleVisibility=="function"&&window.applyRoleVisibility()}catch{}})}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",w):w()})();(function(){function a(I){return String(I??"").replace(/[&<>"']/g,function(U){return{"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"}[U]})}function n(I){if(!I||isNaN(I))return"";var U=Number(I);return U<1024?U+" B":U<1024*1024?(U/1024).toFixed(1)+" KB":(U/1024/1024).toFixed(1)+" MB"}document.addEventListener("click",function(I){var U=I.target.closest&&I.target.closest(".recon-collapse-head");if(U&&!(I.target.closest("button")||I.target.closest("a"))){var N=U.closest(".recon-collapse");if(N){var M=N.getAttribute("data-collapsed")==="true";N.setAttribute("data-collapsed",M?"false":"true"),M&&(N.id==="vex-summary-collapse"&&w(),N.id==="vex-detail-collapse"&&h())}}}),document.addEventListener("keydown",function(I){if(!(I.key!=="Enter"&&I.key!==" ")){var U=I.target.closest&&I.target.closest(".recon-collapse-head");U&&(I.preventDefault(),U.click())}});var o={vat:"",gl:""};window._glvClearPreviewSearch=function(){o.vat="",o.gl=""};var l='<svg class="vex-pp-fi-icon" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#111111" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/></svg>',f='<svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg>';function g(){s("vat"),s("gl")}function x(I){try{if(typeof window._glvPreviewFiles=="function")return window._glvPreviewFiles(I)||[]}catch{}var U=document.getElementById(I==="vat"?"glv-vat-input":"glv-gl-input");return U&&U.files?Array.from(U.files):[]}function s(I){var U=document.getElementById(I==="vat"?"glv-pp-vat-col":"glv-pp-gl-col");if(U){var N=x(I),M=I==="vat"?"glv-up-vat-title":"glv-up-gl-title",L=I==="vat"?"① 销项税报告":"② 总账 GL",z=window.t&&window.t(M)||L,V=a(window.t&&window.t("vex-preview-search")||"搜索文件名..."),W=a(window.t&&window.t("vex-preview-clear-all")||"全清"),P=o[I]||"",u=N.length;U.innerHTML='<div class="vex-pp-col-title"><span class="vex-pp-col-name">'+a(z)+' <span class="vex-pp-col-count">'+u+'</span></span></div><div class="vex-pp-search-row"><input class="vex-pp-search" id="glv-pp-search-'+I+'" type="text" placeholder="'+V+'" value="'+a(P)+'" autocomplete="off"><button class="vex-pp-clear-btn" id="glv-pp-clearall-'+I+'" type="button">'+W+'</button></div><div class="vex-pp-file-list" id="glv-pp-'+I+'-list"></div><div class="vex-pp-pagination" id="glv-pp-'+I+'-pg"></div>';var c=document.getElementById("glv-pp-search-"+I);c&&c.addEventListener("input",function($){o[I]=$.target.value,p(I)});var y=document.getElementById("glv-pp-clearall-"+I);y&&y.addEventListener("click",function(){window._glvRemoveFile&&window._glvRemoveFile(I)}),p(I)}}function p(I){var U=document.getElementById("glv-pp-"+I+"-list"),N=document.getElementById("glv-pp-"+I+"-pg");if(U){var M=x(I),L=(o[I]||"").toLowerCase(),z=M.map(function(P,u){return{f:P,i:u}}),V=L?z.filter(function(P){return P.f.name.toLowerCase().indexOf(L)>=0}):z;if(U.innerHTML=V.map(function(P){var u=P.f;return'<div class="vex-pp-file-row">'+l+'<span class="vex-pp-fi-name" title="'+a(u.name)+'">'+a(u.name)+'</span><span class="vex-pp-fi-size">'+n(u.size)+'</span><button class="vex-pp-fi-del" type="button" data-kind="'+I+'" data-idx="'+P.i+'" aria-label="remove">'+f+"</button></div>"}).join(""),U.querySelectorAll(".vex-pp-fi-del").forEach(function(P){P.addEventListener("click",function(){var u=P.dataset.kind,c=parseInt(P.dataset.idx,10);window._glvRemoveFile&&window._glvRemoveFile(u,isNaN(c)?null:c)})}),N){var W=window.t&&window.t("vex-preview-count")||"显示前 {n} / 共 {m}";N.textContent=W.replace("{n}",V.length).replace("{m}",V.length)}}}function w(){var I=function(N,M){var L=document.getElementById(N);L&&(L.textContent=M==null?"—":String(M))},U=window._vexLastTask||{};I("vex-sum-total",U.total),I("vex-sum-matched",U.matched),I("vex-sum-diff",U.diff),I("vex-sum-incomplete",U.incomplete),I("vex-sum-cash",U.cash),document.getElementById("vex-summary-sub")}function h(){var I=window._vexLastTask&&window._vexLastTask.diff_rows||[],U=document.getElementById("vex-detail-tbody"),N=document.getElementById("vex-detail-table"),M=document.getElementById("vex-detail-empty");if(!(!U||!N||!M)){if(I.length===0){N.style.display="none",M.style.display="";return}M.style.display="none",N.style.display="";var L=I.map(function(V){return'<tr><td class="recon-detail-cell-mono">'+a(V.invoice_no||"")+"</td><td>"+a(V.field||"")+"</td><td>"+a(V.report_value||"")+"</td><td>"+a(V.invoice_value||"")+"</td><td>"+a(V.kind||"")+"</td></tr>"}).join("");U.innerHTML=L;var z=document.getElementById("vex-detail-sub");z&&(z.textContent=String(I.length))}}function B(){var I=document.getElementById("glv-toggle-preview");I&&!I._reconBound&&(I._reconBound=!0,I.addEventListener("click",function(){var U=document.getElementById("glv-preview-panel"),N=document.getElementById("glv-toggle-preview-label"),M=U&&U.style.display!=="none";U&&(U.style.display=M?"none":""),I.classList.toggle("open",!M),N&&(N.textContent=M?window.t&&window.t("vex-toggle-preview-open")||"查看清单":window.t&&window.t("vex-toggle-preview-close")||"收起清单"),M||g()})),["glv-vat-input","glv-gl-input"].forEach(function(U){var N=document.getElementById(U);!N||N._reconWatched||(N._reconWatched=!0,N.addEventListener("change",function(){var M=document.getElementById("glv-preview-panel");M&&M.style.display!=="none"&&g()}))})}function S(){var I=document.getElementById("vex-summary-collapse"),U=document.getElementById("vex-detail-collapse");I&&(I.style.display=""),U&&(U.style.display=""),w(),h()}window._fillVexSummary=w,window._fillVexDetail=h,window._onVexResultShown=S,document.addEventListener("DOMContentLoaded",function(){B()}),setTimeout(B,1500),typeof window.subscribeI18n=="function"&&window.subscribeI18n("recon-collapse",function(){var I=document.getElementById("glv-preview-panel");I&&I.style.display!=="none"&&g();var U=document.getElementById("glv-toggle-preview-label"),N=document.getElementById("glv-toggle-preview");U&&N&&(U.textContent=N.classList.contains("open")?window.t&&window.t("vex-toggle-preview-close")||"收起清单":window.t&&window.t("vex-toggle-preview-open")||"查看清单")}),window._reconCollapse={renderGlvPreview:g,fillVexSummary:w,fillVexDetail:h}})();(function(){function e(f){}function a(){const f=document.querySelectorAll("[data-recon-tab]");f.forEach(x=>{x.addEventListener("click",()=>{f.forEach(B=>B.classList.remove("active")),x.classList.add("active");const s=x.dataset.reconTab,p=document.getElementById("recon-pane-bank"),w=document.getElementById("recon-pane-sale-vat"),h=document.getElementById("recon-pane-gl-vat");p&&(p.style.display=s==="bank"?"":"none"),w&&(w.style.display=s==="sale-vat"?"":"none"),h&&(h.style.display=s==="gl-vat"?"":"none"),s==="gl-vat"&&window.GlVatRecon&&window.GlVatRecon.ensureInit(),s==="bank"&&typeof window._bankReconV2Init=="function"&&window._bankReconV2Init()})});const g=document.querySelector("[data-recon-tab].active");g&&(g.dataset.reconTab,void 0)}function n(){const f=document.getElementById("page-settings");if(!f)return null;let g=document.getElementById("settings-modal-overlay");if(g)return g;g=document.createElement("div"),g.id="settings-modal-overlay",g.className="settings-modal-overlay",g.style.display="none",f.parentElement.insertBefore(g,f),g.appendChild(f);const x=document.createElement("button");return x.id="settings-modal-close",x.className="settings-modal-close",x.setAttribute("aria-label","close"),x.innerHTML='<svg viewBox="0 0 20 20" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M5 5l10 10M15 5L5 15"/></svg>',f.insertBefore(x,f.firstChild),x.addEventListener("click",l),g.addEventListener("click",s=>{s.target===g&&l()}),g}function o(){const f=n();if(!f)return;f.style.display="flex",document.body.classList.add("settings-modal-open");const g=document.getElementById("page-settings");g&&(g.style.display="block"),setTimeout(()=>{try{typeof renderSettings=="function"&&renderSettings()}catch(s){console.warn("renderSettings:",s)}let x=document.querySelector(".settings-tab.active")||document.querySelector('.settings-tab[data-tab="profile"]');x&&x.click()},50)}function l(){const f=document.getElementById("settings-modal-overlay");f&&(f.style.display="none"),document.body.classList.remove("settings-modal-open")}window.openSettingsModal=o,window.closeSettingsModal=l,document.addEventListener("keydown",f=>{if(f.key==="Escape"){const g=document.getElementById("settings-modal-overlay");g&&g.style.display==="flex"&&l()}}),window.addEventListener("hashchange",()=>{location.hash==="#/settings"&&o()}),window.addEventListener("DOMContentLoaded",()=>{location.hash==="#/settings"&&o()}),document.readyState==="loading"?document.addEventListener("DOMContentLoaded",a):a()})();(function(){const n=/\.(pdf|jpe?g|png|webp|tiff?|xlsx?|xlsm|csv|tsv|docx?)$/i,o=G=>document.getElementById(G);function l(){return{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||"")}}function f(G){return String(G??"").replace(/[&<>"']/g,ae=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[ae])}function g(G){return G<1024?G+" B":G<1024*1024?(G/1024).toFixed(1)+" KB":(G/1024/1024).toFixed(1)+" MB"}let x=[],s=[],p=!1,w=[],h=50,B=50,S="",I="";async function U(){try{const G=await fetch("/api/vat_excel/tasks?page=1&page_size=1",{headers:l()});if(!G.ok)return;const d=(await G.json()).kpi||{};[["vex-kpi-month-val",d.this_month],["vex-kpi-running-val",d.running],["vex-kpi-done-val",d.done],["vex-kpi-failed-val",d.failed]].forEach(([m,q])=>{const Z=document.getElementById(m);Z&&(Z.textContent=q??0)})}catch{}}async function N(){try{const G=await fetch("/api/vat_excel/tasks?page=1&page_size=100",{headers:l()});if(!G.ok)return;const ae=await G.json();V(ae.rows||[])}catch{}}const M=10;var L=1;function z(){var G=((document.getElementById("vex-task-search")||{}).value||"").trim().toLowerCase();if(L=1,V(w),!!G){var ae=document.getElementById("vex-task-tbody");ae&&ae.querySelectorAll("tr").forEach(function(d){d.dataset.taskId&&(d.style.display=d.textContent.toLowerCase().indexOf(G)>=0?"":"none")})}}function V(G){w=G||w;const ae=document.getElementById("vex-task-tbody");if(!ae)return;if(!w.length){ae.innerHTML='<tr><td colspan="9" class="vex-task-empty">'+(t("sv-empty-title")||"还没有对账任务")+"</td></tr>",W(0);return}const d=Math.ceil(w.length/M);L>d&&(L=d);const m=(L-1)*M;P(w.slice(m,m+M)),W(w.length)}function W(G){const ae=document.getElementById("vex-task-pager"),d=document.getElementById("vex-task-pager-info"),m=document.getElementById("vex-task-prev"),q=document.getElementById("vex-task-next");if(!ae)return;if(G<=M){ae.style.display="none";return}ae.style.display="";const Z=Math.ceil(G/M);d&&(d.textContent=L+" / "+Z),m&&(m.disabled=L<=1),q&&(q.disabled=L>=Z)}function P(G){const ae=document.getElementById("vex-task-tbody");if(!ae)return;const d={pending:t("vex-status-pending")||"待处理",running:t("vex-status-running")||"处理中",done:t("vex-status-done")||"已完成",failed:t("vex-status-failed")||"失败"},m={pending:"badge-gray",running:"badge-blue",done:"badge-green",failed:"badge-red"},q='<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M8 2v9M4 7l4 4 4-4M3 14h10"/></svg>',Z='<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M3 4h10M6 4V3h4v1M5 4v8a1 1 0 001 1h4a1 1 0 001-1V4"/></svg>';ae.innerHTML=G.map(i=>{const v=i.created_at?new Date(i.created_at).toLocaleString([],{year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",minute:"2-digit"}):"—",b=i.period||"—",j=i.matched_count!=null?i.matched_count+" ✓ · "+i.mismatched_count+" ⚠":"—",H=i.mismatch_amount!=null?"฿ "+Number(i.mismatch_amount).toLocaleString():"—",r=i.elapsed_seconds!=null?i.elapsed_seconds.toFixed(1)+" s":"—",C=i.status||"pending",A=i.client_name&&i.client_name!=="client"?i.client_name:t("vex-client-all")||"全部客户";return`<tr class="vex-task-row" data-task-id="${f(i.id)}" style="cursor:pointer">
                <td>${v}</td>
                <td>${f(A)}</td>
                <td>${f(b)}</td>
            ...
            <span class="vex-fi-s">${g(v.size)}</span>
            <button class="vex-fi-x" type="button" data-vex-kind="${j}" data-vex-idx="${b}" aria-label="remove">×</button>
        </div>`;G&&(G.innerHTML=x.map((v,b)=>q(v,b,"inv")).join("")||'<div class="vex-fi-empty" data-i18n="vex-no-files">还没文件</div>'),ae&&(ae.innerHTML=s.map((v,b)=>q(v,b,"rep")).join("")||'<div class="vex-fi-empty" data-i18n="vex-no-files">还没文件</div>'),document.querySelectorAll(".vex-fi-x").forEach(v=>{v.addEventListener("click",b=>{const j=v.dataset.vexKind,H=parseInt(v.dataset.vexIdx,10);j==="inv"?_(H):E(H)})});const Z=x.length>0&&s.length>0;o("vex-build").disabled=!Z||p;const i=o("vex-action-info");i&&(!x.length||!s.length?(i.textContent=t("vex-need-both")||"需要至少 1 张发票 + 1 份 VAT 报告",i.className="vex-action-info muted"):(i.textContent=(t("vex-ready")||"已就绪 · {a} 张发票 · {b} 份报告").replace("{a}",x.length).replace("{b}",s.length),i.className="vex-action-info ok")),ie()}const J='<svg class="vex-pp-fi-icon" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#6B7280" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path><polyline points="14 2 14 8 20 8"></polyline></svg>',F='<svg class="vex-pp-fi-icon" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#111111" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="4" width="18" height="18" rx="2" ry="2"></rect><line x1="16" y1="2" x2="16" y2="6"></line><line x1="8" y1="2" x2="8" y2="6"></line><line x1="3" y1="10" x2="21" y2="10"></line></svg>',Q='<svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg>';function ie(){const G=o("vex-preview-panel");if(!G||G.style.display==="none")return;le("inv"),le("rep");const ae=o("vex-pp-guide");ae&&(ae.style.display=x.length>100?"flex":"none")}function le(G){const ae=o(G==="inv"?"vex-pp-invoice-col":"vex-pp-report-col");if(!ae)return;const d=G==="inv"?x:s,m=G==="inv"?S:I,q=t(G==="inv"?"vex-preview-invoice":"vex-preview-report")||(G==="inv"?"销售发票":"VAT 报告"),Z=f(t("vex-preview-search")||"搜索文件名..."),i=f(t("vex-preview-clear-all")||"全清");ae.innerHTML=`
            ...
            <div class="vex-pp-pagination" id="vex-pp-${G}-pg"></div>`;const v=o("vex-pp-search-"+G);v&&v.addEventListener("input",j=>{G==="inv"?(S=j.target.value,h=50):(I=j.target.value,B=50),ue(G)});const b=o("vex-pp-clearall-"+G);b&&b.addEventListener("click",()=>{G==="inv"?(x=[],S="",h=50):(s=[],I="",B=50),D()}),ue(G)}function ue(G){const ae=o("vex-pp-"+G+"-list"),d=o("vex-pp-"+G+"-pg");if(!ae)return;const m=G==="inv"?x:s,q=G==="inv"?S:I,Z=G==="inv"?h:B,i=G==="inv"?J:F,v=m.map((H,r)=>({f:H,i:r})),b=q?v.filter(({f:H})=>H.name.toLowerCase().includes(q.toLowerCase())):v,j=b.slice(0,Z);if(ae.innerHTML=j.map(({f:H,i:r})=>`
            <div class="vex-pp-file-row">
                ${i}
                <span class="vex-pp-fi-name" title="${f(H.name)}">${f(H.name)}</span>
                <span class="vex-pp-fi-size">${g(H.size)}</span>
                <button class="vex-pp-fi-del" type="button" data-kind="${G}" data-ridx="${r}" aria-label="remove">${Q}</button>
            </div>`).join("")+`<div id="vex-pp-sentinel-${G}" style="height:1px;flex-shrink:0"></div>`,ae.querySelectorAll(".vex-pp-fi-del").forEach(H=>{H.addEventListener("click",()=>{const r=parseInt(H.dataset.ridx,10);H.dataset.kind==="inv"?_(r):E(r)})}),d){const H=t("vex-preview-count")||"显示前 {n} / 共 {m}";d.textContent=H.replace("{n}",j.length).replace("{m}",b.length)}R(G,b.length)}function R(G,ae){if((G==="inv"?h:B)>=ae)return;const m=o("vex-pp-sentinel-"+G),q=o("vex-pp-"+G+"-list");if(!m||!q)return;const Z=new IntersectionObserver(i=>{i[0].isIntersecting&&(Z.disconnect(),G==="inv"?h+=50:B+=50,ue(G))},{root:q,threshold:.8});Z.observe(m)}function k(G,ae,d,m){const q=o(G),Z=o(ae);!q||!Z||(q.addEventListener("click",()=>Z.click()),q.addEventListener("keydown",i=>{(i.key==="Enter"||i.key===" ")&&(i.preventDefault(),Z.click())}),q.addEventListener("dragover",i=>{i.preventDefault(),q.classList.add("drag-over")}),q.addEventListener("dragleave",()=>q.classList.remove("drag-over")),q.addEventListener("drop",i=>{i.preventDefault(),q.classList.remove("drag-over");const b=Array.from(i.dataTransfer.files).filter(j=>n.test(j.name));if(!b.length){showToast(t("vex-toast-bad-ext"),"error");return}d(b)}),Z.addEventListener("change",()=>{const i=Array.from(Z.files);d(i),Z.value=""}))}async function Y(){if(p||!x.length||!s.length)return;p=!0,o("vex-build").disabled=!0,o("vex-progress").style.display="flex";var G=document.getElementById("vex-download");G&&(G.style.display="none"),["vex-summary-collapse","vex-detail-collapse"].forEach(function(q){var Z=document.getElementById(q);Z&&(Z.style.display="none")});const ae=Date.now();o("vex-progress-title").textContent=t("vex-progress-running")||"AI 抽取中",o("vex-progress-sub").textContent=(t("vex-progress-sub")||"{a} 张发票 + {b} 份报告 · 并行处理").replace("{a}",x.length).replace("{b}",s.length);const d=setInterval(()=>{const q=Math.floor((Date.now()-ae)/1e3);o("vex-progress-sub").textContent=(t("vex-progress-elapsed")||"已 {s} 秒 · {a} 张发票 + {b} 份报告").replace("{s}",q).replace("{a}",x.length).replace("{b}",s.length)},1e3);try{const q=new FormData;for(const ce of x)q.append("invoices",ce);for(const ce of s)q.append("reports",ce);const Z=typeof currentLang=="string"&&currentLang||localStorage.getItem("mrpilot_lang")||"th";q.append("lang",Z);const i=localStorage.getItem("mrpilot_token")||"",v=await fetch("/api/vat_excel/submit",{method:"POST",headers:l(),body:q});let b=null;try{b=await v.json()}catch{b=null}if(!v.ok||!b||!b.ok||!b.job_id)throw clearInterval(d),new Error(b&&b.detail||"HTTP "+v.status);const j=o("vex-progress-sub"),H=await window._reconPollJob(b.job_id,i,{onProgress:ce=>{j&&(j.textContent=window._reconProgressText(ce,Z))}});if(clearInterval(d),!H||H.status!=="done"||!H.result_id)throw new Error(t("vex-toast-fail")||"生成失败");const r=H.result_id;let C=0;const A=await fetch("/api/vat_excel/tasks/"+encodeURIComponent(r)+"/download",{headers:l()});if(!A.ok)throw new Error("HTTP "+A.status);const K=(A.headers.get("Content-Disposition")||"").match(/filename="([^"]+)"/),te=K&&K[1]||"vat_recon_"+Date.now()+".xlsx",oe=await A.blob(),se=URL.createObjectURL(oe),ne=o("vex-download");ne.href=se,ne.download=te;try{const ce=document.createElement("a");ce.href=se,ce.download=te,document.body.appendChild(ce),ce.click(),setTimeout(()=>ce.remove(),100)}catch{}o("vex-progress").style.display="none";var m=document.getElementById("vex-download");m&&(m.style.display=""),r&&(C=await re(r)),window._onVexResultShown&&window._onVexResultShown(),C>0?showToast((t("vex-toast-some-fail")||"有 {n} 张发票 OCR 失败").replace("{n}",C),"warn"):showToast(t("vex-toast-done")||"Excel 已生成","success"),U(),setTimeout(N,800)}catch(q){clearInterval(d),o("vex-progress").style.display="none";const Z=(t("vex-toast-fail")||"生成失败")+": "+(q.message||q);showToast(Z,"error")}finally{p=!1,o("vex-build").disabled=!1}}function X(){x=[],s=[];var G=document.getElementById("vex-download");G&&(G.style.display="none"),D()}function ee(G){if(G==null)return"—";var ae=parseFloat(G);return isNaN(ae)?"—":ae.toLocaleString("th-TH",{minimumFractionDigits:2,maximumFractionDigits:2})}async function re(G){try{var ae=await fetch("/api/vat_excel/tasks/"+encodeURIComponent(G),{headers:l()});if(!ae.ok)throw new Error(ae.status);var d=await ae.json(),m=d.raw_data_json;if(typeof m=="string")try{m=JSON.parse(m)}catch{m={}}m=m||{};var q=m.rows||[],Z=[];q.forEach(function(b){b.kind==="invoice_orphan"?Z.push({invoice_no:b.invoice_no||"",field:"仅发票有",report_value:"—",invoice_value:ee(b.amount_inv),kind:b.kind}):b.kind==="report_orphan"?Z.push({invoice_no:b.invoice_no||"",field:"仅报告有",report_value:ee(b.amount_rep),invoice_value:"—",kind:b.kind}):b.dims&&Object.keys(b.dims).length>0&&Object.keys(b.dims).forEach(function(j){var H=String(b.dims[j]||""),r=H.split(" ≠ ");Z.push({invoice_no:b.invoice_no||"",field:j,report_value:r[0]||H,invoice_value:r.length>1?r[1]:"—",kind:"diff"})})});var i=q.filter(function(b){return b.kind==="matched_cash"}).length,v=Math.max(0,parseInt(m.invoice_ocr_failed_count||0,10));return window._vexLastTask={total:m.n_total||0,matched:m.n_ok||0,diff:m.n_diff||0,incomplete:v,cash:i,diff_rows:Z,task_id:G},window._fillVexSummary&&window._fillVexSummary(),window._fillVexDetail&&window._fillVexDetail(),v}catch{return 0}}function de(){const G=document.getElementById("vex-pane");G&&G.querySelectorAll("[data-i18n]").forEach(ae=>{const d=t(ae.dataset.i18n);d&&(ae.textContent=d)}),D(),N()}function pe(){k("vex-drop-invoice","vex-input-invoice",$),k("vex-drop-report","vex-input-report",T);const G=o("vex-build"),ae=o("vex-reset");G&&G.addEventListener("click",Y),ae&&ae.addEventListener("click",X),document.querySelectorAll('[data-recon-tab="sale-vat"]').forEach(q=>{q.addEventListener("click",()=>{U(),N()})}),u();const d=document.getElementById("vex-task-search");d&&d.addEventListener("input",z);const m=document.getElementById("vex-toggle-preview");m&&m.addEventListener("click",()=>{const q=o("vex-preview-panel"),Z=o("vex-toggle-preview-label"),i=q&&q.style.display!=="none";q&&(q.style.display=i?"none":""),m&&m.classList.toggle("open",!i),Z&&(Z.textContent=i?t("vex-toggle-preview-open")||"查看清单":t("vex-toggle-preview-close")||"收起清单"),i||ie()}),D(),U()}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",pe):pe(),typeof window.subscribeI18n=="function"&&(window.subscribeI18n("vex-excel",de),window.subscribeI18n("vex-preview-panel",ie))})();(function(){const e=R=>document.getElementById(R),a=()=>localStorage.getItem("mrpilot_token")||"",n=()=>typeof window.currentLang=="string"&&window.currentLang?window.currentLang:localStorage.getItem("mrpilot_lang")||"th",o=()=>({Authorization:"Bearer "+a()}),l={inited:!1,glFile:[],vatFile:[],running:!1,currentTaskId:null,lastDetail:[],lastSummary:null},f={th:{not_found:"ไม่พบข้อมูล",running:"กำลังกระทบยอด…",error:"เกิดข้อผิดพลาด",need_files:"กรุณาเลือกไฟล์ทั้งสอง",done:"เสร็จสิ้น",hint_need_both:"อัปโหลด ① รายงานภาษีขาย + ② GL",hint_need_one_more:"อัปโหลดอีก 1 ไฟล์",hint_ready:"พร้อมแล้ว · กดเริ่มกระทบยอด",hist_load:"โหลด",hist_export:"ส่งออก",hist_delete:"ลบ",confirm_delete:"ยืนยันการลบงานนี้?",s_gl_total:"ยอดรวมตามบัญชีแยกประเภท",s_minus_gl_cr:"หัก : รายการเครดิตที่ไม่มีในรายงานภาษีขาย",s_plus_gl_dr:"บวก : รายการเดบิตที่ไม่มีในรายงานภาษีขาย",s_plus_vat_p:"บวก : รายการยอดขายที่ไม่มีในบัญชีแยกประเภท",s_minus_vat_n:"หัก : รายการลดหนี้ที่ไม่มีในบัญชีแยกประเภท",s_vat_total:"ยอดรวมตามรายงานภาษีขาย"},zh:{not_found:"未找到数据",running:"正在对账中...",error:"出错了",need_files:"请先选择两个文件",done:"完成",hint_need_both:"请上传① 销项税报告 + ② 总账 GL",hint_need_one_more:"还需上传 1 份文件",hint_ready:"已就绪 · 点击开始对账",hist_load:"加载",hist_export:"导出",hist_delete:"删除",confirm_delete:"确认删除此任务？",s_gl_total:"总账金额合计",s_minus_gl_cr:"减：销项税报告中未列的贷方记录",s_plus_gl_dr:"加：销项税报告中未列的借方记录",s_plus_vat_p:"加：总账中未列的销售记录",s_minus_vat_n:"减：总账中未列的贷项凭单(credit note)记录",s_vat_total:"销项税报告金额合计"},en:{not_found:"Not found",running:"Reconciling...",error:"Error",need_files:"Please select both files",done:"Done",hint_need_both:"Upload ① Output VAT report + ② GL file",hint_need_one_more:"1 more file required",hint_ready:"Ready · click Run to start",hist_load:"Load",hist_export:"Export",hist_delete:"Delete",confirm_delete:"Delete this task?",s_gl_total:"Total per General Ledger",s_minus_gl_cr:"Less: GL credits not in VAT Report",s_plus_gl_dr:"Add: GL debits not in VAT Report",s_plus_vat_p:"Add: Sales in VAT Report not in GL",s_minus_vat_n:"Less: Credit notes in VAT Report not in GL",s_vat_total:"Total per VAT Sales Report"},ja:{not_found:"データなし",running:"照合中…",error:"エラー",need_files:"両方のファイルを選択してください",done:"完了",hint_need_both:"① 売上税報告 + ② GL をアップロード",hint_need_one_more:"あと 1 ファイル必要",hint_ready:"準備完了 · 「開始」をクリック",hist_load:"読込",hist_export:"出力",hist_delete:"削除",confirm_delete:"このタスクを削除しますか?",s_gl_total:"総勘定元帳合計",s_minus_gl_cr:"減：売上税報告にないGL貸方記録",s_plus_gl_dr:"加：売上税報告にないGL借方記録",s_plus_vat_p:"加：GLにない売上記録",s_minus_vat_n:"減：GLにない赤伝記録",s_vat_total:"売上税報告合計"}},g=R=>(f[n()]||f.th)[R]||R;function x(R){const k=n(),X={gl_no_revenue_rows:{zh:"GL 中未找到收入科目行。请确认「收入科目前缀」是否正确(收入科目通常以 4 开头),改对后重试。",th:"ไม่พบรายการบัญชีรายได้ใน GL · ตรวจสอบ «คำนำหน้าบัญชีรายได้» (รายได้มักขึ้นต้นด้วย 4) แล้วลองใหม่",en:"No revenue-account rows found in the GL. Check the “revenue account prefix” (revenue usually starts with 4) and retry.",ja:"GL に収益科目の行が見つかりません。「収益科目プレフィックス」(通常 4 で始まる)を確認して再試行してください。"},gl_parse_failed:{zh:"GL 文件解析失败。请确认文件含日期/科目/借贷列,或换清晰的 Excel/CSV 重传。",th:"อ่านไฟล์ GL ไม่สำเร็จ · ตรวจสอบว่ามีคอลัมน์ วันที่/บัญชี/เดบิต-เครดิต หรืออัปโหลด Excel/CSV ที่ชัดเจน",en:"Failed to parse the GL file. Ensure it has date/account/debit-credit columns, or re-upload a clean Excel/CSV.",ja:"GL ファイルの解析に失敗しました。日付/科目/借方貸方列を確認するか、Excel/CSV を再アップロードしてください。"},vat_no_rows:{zh:"销项税报告里没有可对账的数据行。请确认上传了正确的销项税报告。",th:"ไม่พบแถวข้อมูลในรายงานภาษีขาย · ตรวจสอบว่าอัปโหลดรายงานที่ถูกต้อง",en:"No rows found in the sales-VAT report. Please check you uploaded the correct report.",ja:"売上VATレポートに行が見つかりません。正しいレポートをアップロードしたか確認してください。"},vat_parse_failed:{zh:"销项税报告解析失败。请换更清晰的版本,或转成 Excel/PDF 重传。",th:"อ่านรายงานภาษีขายไม่สำเร็จ · ลองเวอร์ชันที่ชัดเจนกว่า หรือแปลงเป็น Excel/PDF",en:"Failed to parse the sales-VAT report. Try a clearer version, or convert to Excel/PDF.",ja:"売上VATレポートの解析に失敗しました。より鮮明な版か、Excel/PDF に変換してください。"}}[R];return X?X[k]||X.th||X.en:g("error")||"Error"}const s=R=>R==null||isNaN(R)?"":Number(R).toLocaleString("en-US",{minimumFractionDigits:2,maximumFractionDigits:2});function p(R,k,Y,X){const ee=e(R),re=e(k),de=e(Y);if(!ee||!re||!de)return;const pe=G=>{if(!G||!G.length)return;const ae=Array.isArray(l[X])?l[X].slice():[],d=new Set(ae.map(m=>m.name+"|"+m.size));for(const m of G){if(!m)continue;const q=m.name+"|"+m.size;d.has(q)||(ae.push(m),d.add(q))}l[X]=ae,w(de,ae),B(),S(),window._reconCollapse&&window._reconCollapse.renderGlvPreview&&window._reconCollapse.renderGlvPreview()};ee.addEventListener("click",()=>re.click()),ee.addEventListener("keydown",G=>{(G.key==="Enter"||G.key===" ")&&(G.preventDefault(),re.click())}),re.addEventListener("change",()=>{pe(Array.from(re.files||[])),re.value=""}),ee.addEventListener("dragover",G=>{G.preventDefault(),ee.classList.add("drag-over")}),ee.addEventListener("dragleave",()=>ee.classList.remove("drag-over")),ee.addEventListener("drop",G=>{G.preventDefault(),ee.classList.remove("drag-over");const ae=G.dataTransfer&&G.dataTransfer.files?Array.from(G.dataTransfer.files):[];pe(ae)})}function w(R,k){if(!R)return;if(!k||k.length===0){R.textContent="";return}const Y=k.reduce((X,ee)=>X+Math.round(ee.size/1024),0);if(k.length===1)R.textContent=k[0].name+"  ("+Y+" KB)";else{const X=window.t&&window.t("glv-files-count")||"{n} 个文件";R.textContent=X.replace("{n}",k.length)+"  ("+Y+" KB)"}}function h(R){const k=l[R];return Array.isArray(k)?k:k?[k]:[]}function B(){const R=e("btn-glv-run");if(!R)return;const k=h("glFile").length>0&&h("vatFile").length>0;R.disabled=!k||l.running}function S(){const R=e("glv-status");if(!R||l.running)return;const k=h("vatFile").length,Y=h("glFile").length;k===0&&Y===0?(R.className="vex-action-info muted",R.innerHTML="<span>"+g("hint_need_both")+"</span>"):k>0&&Y>0?(R.className="vex-action-info ok",R.innerHTML="<span>"+g("hint_ready")+"</span>"):(R.className="vex-action-info muted",R.innerHTML="<span>"+g("hint_need_one_more")+"</span>")}function I(R,k){const Y=R==="vat"?"vatFile":"glFile",X=R==="vat"?"glv-vat-input":"glv-gl-input",ee=R==="vat"?"glv-vat-name":"glv-gl-name",re=h(Y);k==null?l[Y]=[]:l[Y]=re.filter((pe,G)=>G!==k);const de=e(X);de&&(de.value=""),w(e(ee),h(Y)),B(),S(),window._reconCollapse&&window._reconCollapse.renderGlvPreview&&window._reconCollapse.renderGlvPreview()}window._glvRemoveFile=I;function U(){l.glFile=[],l.vatFile=[],l.currentTaskId=null,l.lastDetail=[],l.lastSummary=null;const R=e("glv-vat-input");R&&(R.value="");const k=e("glv-gl-input");k&&(k.value="");const Y=e("glv-vat-name");Y&&(Y.textContent="");const X=e("glv-gl-name");X&&(X.textContent="");const ee=e("glv-result");ee&&(ee.style.display="none");const re=e("glv-kpi-strip");re&&(re.style.display="none"),B(),S(),window._glvClearPreviewSearch&&window._glvClearPreviewSearch(),window._reconCollapse&&window._reconCollapse.renderGlvPreview&&window._reconCollapse.renderGlvPreview()}function N(R){const k=e("glv-tbody");if(!k)return;le(R.length),k.innerHTML="";const Y=g("not_found"),X=document.createDocumentFragment();R.forEach(ee=>{const re=document.createElement("tr"),de=(m,q)=>{const Z=document.createElement("td");return q&&(Z.className=q),Z.textContent=m,Z},pe=ee.gl_amount===null||ee.gl_amount===void 0,G=ee.diff;let ae="glv-num",d="glv-num";pe?(d+=" glv-cell-missing",ae+=" glv-cell-missing"):Math.abs(G||0)<.005?ae+=" glv-cell-ok":ae+=" glv-cell-diff",re.appendChild(de(ee.doc_no||"","glv-doc")),re.appendChild(de(ee.date||"","")),re.appendChild(de(ee.customer_name||"","")),re.appendChild(de(s(ee.vat_amount),"glv-num")),re.appendChild(de(pe?Y:s(ee.gl_amount),d)),re.appendChild(de(pe?Y:s(ee.diff),ae)),re.appendChild(de(ee.account_codes||"","glv-doc")),X.appendChild(re)}),k.appendChild(X)}function M(R){const k=e("glv-summary-table")&&e("glv-summary-table").querySelector("tbody");if(!k)return;k.innerHTML="",[{label:g("s_gl_total"),amount:R.gl_total,emph:!0,items:[],negate:!1},{label:g("s_minus_gl_cr"),amount:-(R.gl_only_credit||0),emph:!1,items:R.gl_only_credit_items||[],negate:!0},{label:g("s_plus_gl_dr"),amount:R.gl_only_debit||0,emph:!1,items:R.gl_only_debit_items||[],negate:!1},{label:g("s_plus_vat_p"),amount:R.vat_only_positive||0,emph:!1,items:R.vat_only_positive_items||[],negate:!1},{label:g("s_minus_vat_n"),amount:R.vat_only_negative||0,emph:!1,items:R.vat_only_negative_items||[],negate:!1},{label:g("s_vat_total"),amount:R.vat_total,emph:!0,items:[],negate:!1}].forEach(({label:X,amount:ee,emph:re,items:de,negate:pe})=>{const G=document.createElement("tr");G.className=re?"glv-summary-total":"glv-summary-sect";const ae=document.createElement("td"),d=document.createElement("td");ae.textContent=X,d.textContent=re?s(ee):"",G.appendChild(ae),G.appendChild(d),k.appendChild(G),(de||[]).forEach(m=>{const q=document.createElement("tr");q.className="glv-summary-item";const Z=document.createElement("td"),i=document.createElement("td"),v=[m.doc_no,m.date,m.name].filter(Boolean);Z.textContent="· "+v.join("  ·  ");const b=pe?-(m.amount||0):m.amount||0;i.textContent=s(b),q.appendChild(Z),q.appendChild(i),k.appendChild(q)})})}function L(R){e("glv-kpi-matched")&&(e("glv-kpi-matched").textContent=R&&R.matched!=null?R.matched:"—"),e("glv-kpi-diff")&&(e("glv-kpi-diff").textContent=R&&R.diff!=null?R.diff:"—"),e("glv-kpi-unmatched")&&(e("glv-kpi-unmatched").textContent=R&&R.unmatched!=null?R.unmatched:"—")}function z(R){if(!R)return"";try{const k=new Date(R);if(isNaN(k.getTime()))return R;const Y=X=>String(X).padStart(2,"0");return k.getFullYear()+"-"+Y(k.getMonth()+1)+"-"+Y(k.getDate())+" "+Y(k.getHours())+":"+Y(k.getMinutes())}catch{return R}}const V=10;var W=[],P=1;function u(){P=1,c();var R=((e("glv-hist-search")||{}).value||"").trim().toLowerCase();if(R){var k=e("glv-history-tbody");k&&k.querySelectorAll("tr").forEach(function(Y){Y.dataset.taskId&&(Y.style.display=Y.textContent.toLowerCase().indexOf(R)>=0?"":"none")})}}function c(){const R=e("glv-history-table-wrap"),k=e("glv-history-empty"),Y=e("glv-history-tbody"),X=e("glv-history-pager"),ee=e("glv-history-pager-info"),re=e("glv-history-prev"),de=e("glv-history-next");if(!Y)return;if(Y.innerHTML="",!W.length){R&&(R.style.display="none"),k&&(k.style.display=""),X&&(X.style.display="none");return}R&&(R.style.display=""),k&&(k.style.display="none");const pe=Math.ceil(W.length/V);P>pe&&(P=pe);const G=(P-1)*V,ae=W.slice(G,G+V);X&&(X.style.display=W.length>V?"":"none",ee&&(ee.textContent=P+" / "+pe),re&&(re.disabled=P<=1),de&&(de.disabled=P>=pe)),ae.forEach(m=>{const q=document.createElement("tr");q.dataset.taskId=m.id;const Z=document.createElement("td");Z.textContent=z(m.created_at);const i=document.createElement("td");i.className="glv-history-file",i.title=(m.vat_filename||"")+" + "+(m.gl_filename||""),i.textContent=(m.vat_filename||"?")+" + "+(m.gl_filename||"?");const v=document.createElement("td");v.className="glv-num",v.textContent=(m.vat_row_count||0)+" / "+(m.gl_row_count||0);const b=document.createElement("td");b.className="glv-num",b.textContent=m.matched_count||0;const j=document.createElement("td");j.className="glv-num",j.textContent=m.diff_count||0;const H=document.createElement("td");H.className="glv-num",H.textContent=m.unmatched_count||0;const r=document.createElement("td");r.className="glv-history-actions";const C=(te,oe,se,ne)=>{const ce=document.createElement("button");return ce.type="button",se&&(ce.className=se),ce.title=oe,ce.setAttribute("aria-label",oe),ce.innerHTML=te,ce.onclick=ne,ce},A='<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" width="14" height="14"><path d="M2 8a6 6 0 1 0 12 0A6 6 0 0 0 2 8z"/><polyline points="6 8 8 10 10 8"/><line x1="8" y1="4" x2="8" y2="10"/></svg>',O='<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" width="14" height="14"><path d="M8 2v9M4 7l4 4 4-4M3 14h10"/></svg>',K='<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" width="14" height="14"><polyline points="3 4 13 4"/><path d="M6 4V2.5a.5.5 0 0 1 .5-.5h3a.5.5 0 0 1 .5.5V4"/><path d="M5 4l1 9a1 1 0 0 0 1 1h2a1 1 0 0 0 1-1l1-9"/></svg>';r.appendChild(C(A,g("hist_load"),"",()=>T(m.id))),r.appendChild(C(O,g("hist_export"),"",()=>_(m.id))),r.appendChild(C(K,g("hist_delete"),"glv-del",()=>E(m.id))),[Z,i,v,b,j,H,r].forEach(te=>q.appendChild(te)),Y.appendChild(q)})}function y(){var R=e("glv-history-prev"),k=e("glv-history-next");R&&!R._glvBound&&(R._glvBound=!0,R.addEventListener("click",function(){P>1&&(P--,c())})),k&&!k._glvBound&&(k._glvBound=!0,k.addEventListener("click",function(){var Y=Math.ceil(W.length/V);P<Y&&(P++,c())}))}async function $(){try{const k=await(await fetch("/api/recon/gl-vat/tasks",{headers:o()})).json();W=k&&k.tasks||[],P=1,c(),y()}catch(R){console.error("[gl-vat] history load failed:",R)}}async function T(R){try{const Y=await(await fetch("/api/recon/gl-vat/"+R,{headers:o()})).json();if(!Y||!Y.ok)throw new Error("load_failed");l.currentTaskId=R,l.lastDetail=Y.detail||[],l.lastSummary=Y.summary||{},L(Y.stats||{}),N(l.lastDetail),M(l.lastSummary);const X=e("glv-result");X&&(X.style.display=""),Q(),window.scrollTo({top:X?X.offsetTop-80:0,behavior:"smooth"})}catch(k){console.error("[gl-vat] load task failed:",k),alert(g("error")+": "+(k.message||k))}}async function _(R){try{const k="/api/recon/gl-vat/"+R+"/export?lang="+encodeURIComponent(n()),Y=await fetch(k,{headers:o()});if(!Y.ok)throw new Error("HTTP "+Y.status);const X=await Y.blob(),ee=document.createElement("a");ee.href=URL.createObjectURL(X),ee.download="GL_VAT_recon_"+R+".xlsx",document.body.appendChild(ee),ee.click(),setTimeout(()=>{URL.revokeObjectURL(ee.href),ee.remove()},200)}catch(k){console.error("[gl-vat] exportTask failed:",k),typeof showToast=="function"&&showToast(g("error")+": "+(k.message||k),"error")}}async function E(R){let k;if(typeof window.showConfirm=="function"?k=await window.showConfirm(g("confirm_delete"),{danger:!0}):k=confirm(g("confirm_delete")),!!k)try{const Y=await fetch("/api/recon/gl-vat/"+R,{method:"DELETE",headers:o()});if(!Y.ok)throw new Error("HTTP "+Y.status);$()}catch(Y){console.error("[gl-vat] delete failed:",Y),typeof showToast=="function"&&showToast(g("error")+": "+(Y.message||Y),"error")}}async function D(){if(!l.glFile||!l.vatFile){typeof showToast=="function"&&showToast(g("need_files"),"warn");return}l.running=!0,B();const R=e("glv-status"),k=e("glv-progress"),Y=e("glv-progress-sub");R&&(R.className="vex-action-info muted",R.style.color="",R.innerHTML="<span>"+g("running")+"</span>"),k&&(k.style.display=""),Y&&(Y.textContent=(l.vatFile.name||"VAT")+" + "+(l.glFile.name||"GL"));const X=new FormData,ee=h("vatFile"),re=h("glFile");for(const pe of ee)X.append("vat_files",pe,pe.name);for(const pe of re)X.append("gl_files",pe,pe.name);const de=(e("glv-prefix")&&e("glv-prefix").value||"4").trim()||"4";X.append("revenue_prefix",de),X.append("lang",n());try{const pe=await fetch("/api/recon/gl-vat/submit",{method:"POST",headers:o(),body:X});let G=null;try{G=await pe.json()}catch{G=null}if(!pe.ok||!G||!G.ok||!G.job_id)throw new Error(G&&G.detail||G&&G.error||"HTTP "+pe.status);const ae=e("glv-progress-sub"),d=await window._reconPollJob(G.job_id,a(),{onProgress:i=>{ae&&(ae.textContent=window._reconProgressText(i,n()))}});if(!d||d.status!=="done"||!d.result_id)throw d&&d.status==="failed"&&d.error_code?new Error(x(d.error_code)):new Error(g("error")||"Error");const m=await fetch("/api/recon/gl-vat/"+encodeURIComponent(d.result_id),{headers:o()});let q=null;try{q=await m.json()}catch{q=null}if(!m.ok||!q||!q.ok)throw new Error(q&&q.detail||q&&q.error||"HTTP "+m.status);l.currentTaskId=q.task_id,l.lastDetail=q.detail||[],l.lastSummary=q.summary||{},L(q.stats||{}),N(l.lastDetail),M(l.lastSummary);const Z=e("glv-result");Z&&(Z.style.display=""),Q(),R&&(R.className="vex-action-info ok",R.style.color="",R.innerHTML="<span>"+g("done")+" · GL "+(q.gl_row_count||0)+" · VAT "+(q.vat_row_count||0)+"</span>"),$()}catch(pe){console.error("[gl-vat] run failed:",pe),R&&(R.className="vex-action-info",R.style.color="#ef4444",R.innerHTML="<span>"+g("error")+": "+(pe.message||pe)+"</span>")}finally{l.running=!1,k&&(k.style.display="none"),B()}}async function J(){if(l.currentTaskId)try{const R="/api/recon/gl-vat/"+l.currentTaskId+"/export?lang="+encodeURIComponent(n()),k=await fetch(R,{headers:o()});if(!k.ok)throw new Error("HTTP "+k.status);const Y=await k.blob(),X=document.createElement("a");X.href=URL.createObjectURL(Y),X.download="GL_VAT_recon_"+l.currentTaskId+".xlsx",document.body.appendChild(X),X.click(),setTimeout(()=>{URL.revokeObjectURL(X.href),X.remove()},200)}catch(R){console.error("[gl-vat] export failed:",R),typeof showToast=="function"&&showToast(g("error")+": "+(R.message||R),"error")}}function F(){l.running||S(),$(),l.lastDetail&&l.lastDetail.length&&N(l.lastDetail),l.lastSummary&&M(l.lastSummary)}function Q(){var R=e("glv-kpi-strip");R&&(R.style.display="");var k=e("glv-section-summary");k&&k.setAttribute("data-collapsed","false");var Y=e("glv-section-detail");Y&&Y.setAttribute("data-collapsed","false")}function ie(){document.querySelectorAll(".glv-section-head[data-toggle]").forEach(R=>{const k=R.getAttribute("data-toggle"),Y=document.getElementById(k);if(!Y)return;const X=ee=>{if(ee.target&&ee.target.closest("button")!==null&&!ee.target.classList.contains("glv-section-head"))return;const re=Y.getAttribute("data-collapsed")==="true";Y.setAttribute("data-collapsed",re?"false":"true")};R.addEventListener("click",X),R.addEventListener("keydown",ee=>{(ee.key==="Enter"||ee.key===" ")&&(ee.preventDefault(),X(ee))})})}function le(R){const k=e("glv-detail-count");k&&(k.textContent=R!=null?String(R):"")}function ue(){if(l.inited){$();return}l.inited=!0,p("glv-drop-gl","glv-gl-input","glv-gl-name","glFile"),p("glv-drop-vat","glv-vat-input","glv-vat-name","vatFile");const R=e("btn-glv-run");R&&R.addEventListener("click",D);const k=e("btn-glv-export");k&&k.addEventListener("click",J);const Y=e("btn-glv-reset");Y&&Y.addEventListener("click",U);const X=e("glv-hist-search");X&&X.addEventListener("input",u),ie(),L(null),S(),window._loadGlvHistory=$,$(),typeof window.subscribeI18n=="function"&&window.subscribeI18n("gl-vat-recon",F)}window.GlVatRecon={ensureInit:ue},window._glvPreviewFiles=function(R){return h(R==="vat"?"vatFile":"glFile")}})();(function(){const e=["flowaccount","peak","xero","quickbooks","express"],a={flowaccount:"FlowAccount",peak:"PEAK",xero:"Xero",quickbooks:"QuickBooks",express:"Express"},n=["expense_office","expense_travel","expense_utility","asset_inventory","asset_fixed","liability_ap","revenue_sales","revenue_service","other"],o=["vat_7","vat_0","vat_exempt","wht_1","wht_3","wht_5","non_vat"],l="468b50c1-5593-4fd6-990d-515ce8085563";let f={sub:"clients",loaded:{clients:!1,accounts:!1,taxes:!1,products:!1},items:{clients:[],accounts:[],taxes:[],products:[]},clientList:[],clientLoaded:!1,addingNew:{clients:!1,accounts:!1,taxes:!1,products:!1},bound:!1};function g(){const T=typeof _userInfo<"u"?_userInfo:null;return!!(T&&(T.role==="owner"||T.is_super_admin))}function x(){const T=typeof _userInfo<"u"?_userInfo:null;return!!(T&&T.id===l)}function s(T){return typeof escapeHtml=="function"?escapeHtml(T==null?"":String(T)):String(T??"")}function p(T,_){try{typeof showToast=="function"&&showToast(T,_||"info")}catch{}}async function w(T,_){const E=localStorage.getItem("mrpilot_token");if(E&&!(f.loaded[T]&&!_))try{const D=await fetch("/api/erp/mappings/"+T,{headers:{Authorization:"Bearer "+E}});if(!D.ok)throw new Error("http_"+D.status);const J=await D.json();f.items[T]=J.items||[],f.loaded[T]=!0}catch{f.items[T]=[],f.loaded[T]=!1}}async function h(T){if(f.clientLoaded)return;const _=localStorage.getItem("mrpilot_token");if(_)try{const E=await fetch("/api/clients?include_inactive=false",{headers:{Authorization:"Bearer "+_}});if(!E.ok)throw new Error("http_"+E.status);const D=await E.json();f.clientList=(D.clients||D.items||[]).filter(J=>J.is_active!==!1),f.clientLoaded=!0}catch{f.clientList=[]}}function B(){const T=document.getElementById("erp-map-pane-wrap");if(!T)return;const _=!g();let E="";_&&(E+='<div class="erp-map-readonly-banner"><svg width="16" height="16" viewBox="0 0 20 20" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"><circle cx="10" cy="10" r="8"/><path d="M10 6v4M10 13v0.01"/></svg>'+s(t("erp-map-readonly-tip"))+"</div>"),E+='<div class="erp-map-toolbar">',!_&&f.sub!=="products"&&(E+='<button class="btn btn-primary" type="button" id="erp-map-add-btn" data-i18n="erp-map-add-row">'+s(t("erp-map-add-row"))+"</button>"),E+="</div>",E+='<div class="erp-map-table" id="erp-map-table-host"></div>',T.innerHTML=E,S();const D=document.getElementById("erp-map-dev-bar");D&&(D.style.display=g()&&x()?"":"none")}function S(){const T=document.getElementById("erp-map-table-host");if(!T)return;const _=f.sub,E=f.items[_]||[],D=f.addingNew[_],J=!g();if(!E.length&&!D){T.innerHTML='<div class="erp-map-empty"><strong>'+s(t("erp-map-empty-"+_))+"</strong>"+s(t("erp-map-empty-"+_+"-sub"))+"</div>";return}let F="";F+=I(_),D&&!J&&(F+=z(_)),E.forEach(function(Q){F+=V(_,Q,J)}),T.innerHTML=F}function I(T){return T==="clients"?'<div class="erp-map-row erp-map-head row-clients"><div>'+s(t("erp-map-col-client"))+"</div><div>"+s(t("erp-map-col-erp"))+"</div><div>"+s(t("erp-map-col-erp-code"))+"</div><div>"+s(t("erp-map-col-notes"))+"</div><div>"+s(t("erp-map-col-actions"))+"</div></div>":T==="accounts"?'<div class="erp-map-row erp-map-head row-accounts"><div>'+s(t("erp-map-col-erp"))+"</div><div>"+s(t("erp-map-col-category"))+"</div><div>"+s(t("erp-map-col-erp-code"))+"</div><div>"+s(t("erp-map-col-erp-name"))+"</div><div>"+s(t("erp-map-col-notes"))+"</div><div>"+s(t("erp-map-col-actions"))+"</div></div>":T==="products"?'<div class="erp-map-row erp-map-head row-products"><div>'+s(t("erp-map-col-item-name"))+"</div><div>"+s(t("erp-map-col-erp-product-code"))+"</div><div>"+s(t("erp-map-col-erp-name"))+"</div><div>"+s(t("erp-map-col-notes"))+"</div><div>"+s(t("erp-map-col-actions"))+"</div></div>":'<div class="erp-map-row erp-map-head row-taxes"><div>'+s(t("erp-map-col-erp"))+"</div><div>"+s(t("erp-map-col-tax"))+"</div><div>"+s(t("erp-map-col-erp-tax-code"))+"</div><div>"+s(t("erp-map-col-notes"))+"</div><div>"+s(t("erp-map-col-actions"))+"</div></div>"}function U(T,_){let E='<select class="form-input" data-erp-field="'+_+'">';return E+='<option value="">'+s(t("erp-map-pick-erp"))+"</option>",e.forEach(function(D){const J=D===T?" selected":"";E+='<option value="'+D+'"'+J+">"+s(a[D])+"</option>"}),E+="</select>",E}function N(T){let _='<select class="form-input" data-erp-field="client_id">';return _+='<option value="">'+s(t("erp-map-pick-client"))+"</option>",(f.clientList||[]).forEach(function(E){const D=String(E.id)===String(T)?" selected":"";_+='<option value="'+E.id+'"'+D+">"+s(E.name||"#"+E.id)+"</option>"}),_+="</select>",_}function M(T){let _='<select class="form-input" data-erp-field="pearnly_category">';return _+='<option value="">'+s(t("erp-map-pick-cat"))+"</option>",n.forEach(function(E){const D=E===T?" selected":"";_+='<option value="'+E+'"'+D+">"+s(t("erp-map-cat-"+E))+"</option>"}),_+="</select>",_}function L(T){let _='<select class="form-input" data-erp-field="pearnly_tax_kind">';return _+='<option value="">'+s(t("erp-map-pick-tax"))+"</option>",o.forEach(function(E){const D=E===T?" selected":"";_+='<option value="'+E+'"'+D+">"+s(t("erp-map-tax-"+E))+"</option>"}),_+="</select>",_}function z(T){const _='<button class="btn btn-primary" type="button" data-erp-save="new" style="padding:6px 12px;height:32px;">'+s(t("erp-map-save"))+"</button>";return T==="clients"?'<div class="erp-map-row erp-map-row-add row-clients" data-erp-row="new"><div data-label="'+s(t("erp-map-col-client"))+'">'+N("")+'</div><div data-label="'+s(t("erp-map-col-erp"))+'">'+U("","erp_type")+'</div><div data-label="'+s(t("erp-map-col-erp-code"))+'"><input type="text" class="form-input" data-erp-field="erp_code" placeholder="'+s(t("erp-map-ph-erp-code"))+'"></div><div data-label="'+s(t("erp-map-col-notes"))+'"><input type="text" class="form-input" data-erp-field="notes" placeholder="'+s(t("erp-map-ph-notes"))+'"></div><div>'+_+"</div></div>":T==="accounts"?'<div class="erp-map-row erp-map-row-add row-accounts" data-erp-row="new"><div data-label="'+s(t("erp-map-col-erp"))+'">'+U("","erp_type")+'</div><div data-label="'+s(t("erp-map-col-category"))+'">'+M("")+'</div><div data-label="'+s(t("erp-map-col-erp-code"))+'"><input type="text" class="form-input" data-erp-field="erp_code" placeholder="'+s(t("erp-map-ph-acc-code"))+'"></div><div data-label="'+s(t("erp-map-col-erp-name"))+'"><input type="text" class="form-input" data-erp-field="erp_name" placeholder="'+s(t("erp-map-ph-acc-name"))+'"></div><div data-label="'+s(t("erp-map-col-notes"))+'"><input type="text" class="form-input" data-erp-field="notes" placeholder="'+s(t("erp-map-ph-notes"))+'"></div><div>'+_+"</div></div>":'<div class="erp-map-row erp-map-row-add row-taxes" data-erp-row="new"><div data-label="'+s(t("erp-map-col-erp"))+'">'+U("","erp_type")+'</div><div data-label="'+s(t("erp-map-col-tax"))+'">'+L("")+'</div><div data-label="'+s(t("erp-map-col-erp-tax-code"))+'"><input type="text" class="form-input" data-erp-field="erp_code" placeholder="'+s(t("erp-map-ph-tax-code"))+'"></div><div data-label="'+s(t("erp-map-col-notes"))+'"><input type="text" class="form-input" data-erp-field="notes" placeholder="'+s(t("erp-map-ph-notes"))+'"></div><div>'+_+"</div></div>"}function V(T,_,E){const D=E?"":'<button class="erp-map-del-btn" type="button" data-erp-del="'+s(_.id)+'" title="'+s(t("erp-map-delete"))+'"><svg width="14" height="14" viewBox="0 0 20 20" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"><path d="M4 6h12M8 6V4h4v2M6 6l1 11h6l1-11"/></svg></button>',J='<span class="erp-map-erp-badge">'+s(a[_.erp_type]||_.erp_type)+"</span>";if(T==="clients")return'<div class="erp-map-row row-clients"><div data-label="'+s(t("erp-map-col-client"))+'" class="erp-map-cell-name">'+s(_.client_name||"#"+_.client_id)+'</div><div data-label="'+s(t("erp-map-col-erp"))+'">'+J+'</div><div data-label="'+s(t("erp-map-col-erp-code"))+'" class="erp-map-code">'+s(_.erp_code||"")+'</div><div data-label="'+s(t("erp-map-col-notes"))+'">'+s(_.notes||"")+"</div><div>"+D+"</div></div>";if(T==="accounts"){const Q=t("erp-map-cat-"+(_.pearnly_category||"other"))||_.pearnly_category;return'<div class="erp-map-row row-accounts"><div data-label="'+s(t("erp-map-col-erp"))+'">'+J+'</div><div data-label="'+s(t("erp-map-col-category"))+'" class="erp-map-cell-name">'+s(Q)+'</div><div data-label="'+s(t("erp-map-col-erp-code"))+'" class="erp-map-code">'+s(_.erp_code||"")+'</div><div data-label="'+s(t("erp-map-col-erp-name"))+'">'+s(_.erp_name||"")+'</div><div data-label="'+s(t("erp-map-col-notes"))+'">'+s(_.notes||"")+"</div><div>"+D+"</div></div>"}if(T==="products")return'<div class="erp-map-row row-products"><div data-label="'+s(t("erp-map-col-item-name"))+'" class="erp-map-cell-name">'+s(_.item_name||"")+'</div><div data-label="'+s(t("erp-map-col-erp-product-code"))+'" class="erp-map-code">'+s(_.erp_code||"")+'</div><div data-label="'+s(t("erp-map-col-erp-name"))+'">'+s(_.erp_name||"")+'</div><div data-label="'+s(t("erp-map-col-notes"))+'">'+s(_.notes||"")+"</div><div>"+D+"</div></div>";const F=t("erp-map-tax-"+(_.pearnly_tax_kind||""))||_.pearnly_tax_kind;return'<div class="erp-map-row row-taxes"><div data-label="'+s(t("erp-map-col-erp"))+'">'+J+'</div><div data-label="'+s(t("erp-map-col-tax"))+'" class="erp-map-cell-name"><span class="erp-map-tax-badge">'+s(F)+'</span></div><div data-label="'+s(t("erp-map-col-erp-tax-code"))+'" class="erp-map-code">'+s(_.erp_code||"")+'</div><div data-label="'+s(t("erp-map-col-notes"))+'">'+s(_.notes||"")+"</div><div>"+D+"</div></div>"}async function W(T){const _=f.sub,E={};T.querySelectorAll("[data-erp-field]").forEach(function(Q){E[Q.dataset.erpField]=(Q.value||"").trim()});const D=localStorage.getItem("mrpilot_token");if(!D)return;let J={},F="/api/erp/mappings/"+_;if(_==="clients"){if(!E.client_id||!E.erp_type||!E.erp_code){p(t("erp-map-save-fail"),"error");return}J={client_id:parseInt(E.client_id,10),erp_type:E.erp_type,erp_code:E.erp_code,notes:E.notes||""}}else if(_==="accounts"){if(!E.erp_type||!E.pearnly_category||!E.erp_code){p(t("erp-map-save-fail"),"error");return}J={erp_type:E.erp_type,pearnly_category:E.pearnly_category,erp_code:E.erp_code,erp_name:E.erp_name||"",notes:E.notes||""}}else{if(!E.erp_type||!E.pearnly_tax_kind||!E.erp_code){p(t("erp-map-save-fail"),"error");return}J={erp_type:E.erp_type,pearnly_tax_kind:E.pearnly_tax_kind,erp_code:E.erp_code,notes:E.notes||""}}try{const Q=await fetch(F,{method:"POST",headers:{"Content-Type":"application/json",Authorization:"Bearer "+D},body:JSON.stringify(J)});if(!Q.ok)throw new Error("http_"+Q.status);f.addingNew[_]=!1,await w(_,!0),S(),p(t("erp-map-saved-toast"),"success")}catch{p(t("erp-map-save-fail"),"error")}}async function P(T){if(!await window.pearnlyConfirm(t("erp-map-confirm-delete")))return;const E=f.sub,D=localStorage.getItem("mrpilot_token");try{const J=await fetch("/api/erp/mappings/"+E+"/"+encodeURIComponent(T),{method:"DELETE",headers:{Authorization:"Bearer "+D}});if(!J.ok)throw new Error("http_"+J.status);await w(E,!0),S(),p(t("erp-map-deleted-toast"),"success")}catch{p(t("erp-map-delete-fail"),"error")}}async function u(){await h(),await w(f.sub,!1),B()}function c(T){T!==f.sub&&(f.sub=T,f.addingNew[T]=!1,["clients","accounts","taxes","products"].forEach(function(_){_!==T&&(f.addingNew[_]=!1)}),document.querySelectorAll(".erp-map-subtab").forEach(function(_){_.classList.toggle("active",_.dataset.erpSubtab===T)}),w(T,!1).then(function(){B()}))}function y(){f.bound||(f.bound=!0,document.addEventListener("click",function(T){const _=T.target.closest(".erp-subtab[data-erp-subtab]");if(_){T.preventDefault();const Q=_.dataset.erpSubtab;document.querySelectorAll(".erp-subtab").forEach(function(ie){ie.classList.toggle("active",ie.dataset.erpSubtab===Q)}),document.querySelectorAll(".erp-subpanel").forEach(function(ie){ie.classList.toggle("active",ie.dataset.erpSubpanel===Q)}),Q==="mappings"&&setTimeout(u,50);return}const E=T.target.closest(".erp-map-subtab[data-erp-subtab]");if(E){T.preventDefault(),c(E.dataset.erpSubtab);return}if(T.target.closest("#erp-map-add-btn")){if(T.preventDefault(),!g())return;f.addingNew[f.sub]=!0,S();return}const J=T.target.closest('[data-erp-save="new"]');if(J){T.preventDefault();const Q=J.closest('[data-erp-row="new"]');Q&&W(Q);return}const F=T.target.closest("[data-erp-del]");if(F){T.preventDefault(),P(F.dataset.erpDel);return}}))}function $(){const T=document.getElementById("erp-map-pane-wrap");T&&T.children.length>0&&B(),document.querySelectorAll(".erp-map-subtab").forEach(function(_){const E="erp-map-subtab-"+_.dataset.erpSubtab,D=t(E);D&&D!==E&&(_.textContent=D)})}y(),typeof window.subscribeI18n=="function"&&window.subscribeI18n("erp-mappings",$)})();(function(){let e=null,a=0,n=!1;function o(u){return typeof escapeHtml=="function"?escapeHtml(u==null?"":String(u)):String(u??"")}function l(u,c){try{typeof showToast=="function"&&showToast(u,c||"info")}catch{}}async function f(u){const c=Date.now();if(e&&c-a<3e4)return e;const y=localStorage.getItem("mrpilot_token");if(!y)return[];try{const $=await fetch("/api/erp/connectors/status",{headers:{Authorization:"Bearer "+y}});if(!$.ok)return[];const T=await $.json();return e=T&&T.connectors||[],a=c,e}catch{return[]}}function g(){try{return localStorage.getItem("pn_push_default_connector")||""}catch{return""}}function x(u){try{localStorage.setItem("pn_push_default_connector",u||"")}catch{}}function s(u){if(!u||!u.length)return null;const c=g();if(c){const $=u.find(T=>T.id===c);if($)return $}const y=u.find($=>$.is_default);return y||u[0]}function p(u){if(!u)return!1;const c=String(u.status||"").toLowerCase();return c==="exception"||c==="exception_pending"||c==="rejected"}function w(){try{return(typeof _results<"u"?_results:[])[typeof _drawerIdx<"u"?_drawerIdx:-1]||null}catch{return null}}function h(u){const c=u&&(u.type||u.id);return c==="xero"?'<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"><circle cx="8" cy="8" r="6"/><path d="M5.5 8l2 2 3-3.5"/></svg>':c==="webhook"?'<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"><circle cx="5" cy="11.5" r="1.8"/><circle cx="11" cy="4.5" r="1.8"/><path d="M6.4 10l3.2-4M5 9.6V5.5a3 3 0 016 0"/></svg>':'<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"><path d="M2 8h9M8 5l3 3-3 3"/><rect x="11" y="3" width="3" height="10" rx="1"/></svg>'}async function B(u,c){if(!u||!c)return!1;const y=document.getElementById("btn-push-default");y&&(y.disabled=!0,y.classList.add("loading"));const $=localStorage.getItem("mrpilot_token");try{let T,_={method:"POST",headers:{Authorization:"Bearer "+$}};u.type==="xero"?T="/api/erp/xero/push/"+encodeURIComponent(c):(T="/api/erp/push",_.headers["Content-Type"]="application/json",_.body=JSON.stringify({history_id:c,endpoint_id:u.endpoint_id||void 0}));const E=await fetch(T,_);let D={};try{D=await E.json()}catch{}if(!E.ok){let J=D&&D.detail||"unknown";typeof J=="object"&&(J=J.code||JSON.stringify(J));let F=String(J||"unknown");if(u.type==="xero"){const Q=F.replace(/^xero\./,"").toLowerCase(),ie=t("xero-"+Q);ie&&ie!=="xero-"+Q&&(F=ie)}return l(t("unified-push-fail").replace("{name}",u.name).replace("{err}",F),"error"),!1}if(D&&D.ok===!1){let J=D.error_msg||D.error_code||"unknown";return J=String(J).slice(0,200),l(t("unified-push-fail").replace("{name}",u.name).replace("{err}",J),"error"),!1}return l(t("unified-push-ok").replace("{name}",u.name),"success"),!0}catch(T){return l(t("unified-push-fail").replace("{name}",u.name).replace("{err}",T.message||"network"),"error"),!1}finally{y&&(y.disabled=!1,y.classList.remove("loading"))}}async function S(u,c){for(const y of u)await B(y,c)}function I(u,c){const y=document.createElement("div");y.className="pn-push-dropdown",y.id="pn-push-dropdown";const $=(u||[]).map(_=>{const E=!!(c&&_.id===c.id),D=_.method==="download"?t("unified-push-tag-download"):E?t("unified-push-tag-default"):"";return'<div class="pn-pd-item" data-cid="'+o(_.id)+'"><span class="pn-pd-icon">'+h(_)+'</span><span class="pn-pd-name">'+o(_.name)+"</span>"+(D?'<span class="pn-pd-tag">'+o(D)+"</span>":"")+(E?'<span class="pn-pd-check">✓</span>':"")+"</div>"}).join(""),T=u&&u.length>1?'<div class="pn-pd-divider"></div><div class="pn-pd-item pn-pd-all" data-cid="__all__"><span class="pn-pd-icon"><svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"><path d="M3 6h10M3 10h10M3 13.5h6"/></svg></span><span class="pn-pd-name">'+o(t("unified-push-all").replace("{n}",u.length))+"</span></div>":"";return y.innerHTML=$+T,y}function U(){const u=document.getElementById("pn-push-dropdown");u&&u.remove()}async function N(){if(document.getElementById("pn-push-dropdown")){U();return}const u=await f()||[],c=s(u),y=I(u,c),$=document.getElementById("pn-push-wrap");$&&$.appendChild(y)}async function M(){const u=await f()||[],c=s(u);if(!c)return;const y=w(),$=y&&(y._historyId||y.history_id);if($){if(p(y)){l(t("unified-push-disabled-exc"),"warn");return}await B(c,$)}}async function L(u){U();const c=await f()||[],y=w(),$=y&&(y._historyId||y.history_id);if(!$)return;if(p(y)){l(t("unified-push-disabled-exc"),"warn");return}if(u==="__all__"){await S(c,$);return}const T=c.find(_=>_.id===u);T&&(x(u),await B(T,$),V())}async function z(){const u=document.getElementById("drawer-history-save");if(!u||u.querySelector("#pn-push-wrap"))return;const c=document.createElement("div");c.id="pn-push-wrap",c.className="pn-push-wrap",c.dataset.loading="1",u.insertBefore(c,u.firstChild),["btn-push-erp","btn-xero-push"].forEach(D=>{u.querySelectorAll("#"+D).forEach(J=>{J.style.display="none"})});const y=await f()||[],$=s(y),T=y.length>0;if(!T)c.innerHTML='<button type="button" class="btn btn-ghost pn-push-empty" id="btn-push-default" disabled title="'+o(t("unified-push-empty-tip"))+'"><svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"><path d="M2 8h9M8 5l3 3-3 3"/></svg><span style="margin-left:4px;">'+o(t("unified-push-empty"))+"</span></button>";else{const D=y.length>1;c.innerHTML='<div class="pn-push-split"><button type="button" class="pn-push-main" id="btn-push-default" title="'+o(t("unified-push-tip"))+'">'+h($)+"<span>"+o(t("unified-push-to").replace("{name}",$?$.name:""))+"</span></button>"+(D?'<button type="button" class="pn-push-arrow" id="btn-push-arrow" title="'+o(t("unified-push-other"))+'"><svg viewBox="0 0 12 12" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M3 5l3 3 3-3"/></svg></button>':"")+"</div>"}delete c.dataset.loading;const _=c.querySelector("#btn-push-default");_&&T&&_.addEventListener("click",M);const E=c.querySelector("#btn-push-arrow");E&&E.addEventListener("click",function(D){D.stopPropagation(),N()}),n||(n=!0,document.addEventListener("click",function(D){const J=D.target.closest(".pn-pd-item");if(J){const F=J.getAttribute("data-cid");L(F);return}D.target.closest("#btn-push-arrow")||U()}),typeof window.subscribeI18n=="function"&&window.subscribeI18n("unified-push",V))}function V(){const u=document.getElementById("pn-push-wrap");u&&(u.remove(),e=null,a=0,z())}function W(){const u=document.getElementById("drawer-history-save");if(!u||!u.querySelector("#pn-push-wrap"))return;["btn-push-erp","btn-xero-push"].forEach(y=>{u.querySelectorAll("#"+y).forEach($=>{$.style.display!=="none"&&($.style.display="none")})});const c=u.querySelectorAll("#pn-push-wrap");if(c.length>1)for(let y=1;y<c.length;y++)c[y].remove()}function P(){try{const u=function(){return document.getElementById("drawer-body")},c=new MutationObserver(function(){document.getElementById("drawer-history-save")&&!document.getElementById("pn-push-wrap")&&z(),W()}),y=u();if(y)c.observe(y,{childList:!0,subtree:!0});else{const $=new MutationObserver(function(){const T=u();T&&(c.observe(T,{childList:!0,subtree:!0}),$.disconnect())});$.observe(document.body,{childList:!0,subtree:!0})}setTimeout(function(){document.getElementById("drawer-history-save")&&!document.getElementById("pn-push-wrap")&&z(),W()},200)}catch{}}P()})();(function(){function e(){const n=document.getElementById("erp-map-show-advanced-btn");if(!n)return;const o=document.getElementById("erp-map-subtabs");if(!o)return;const l=o.classList.contains("show-advanced"),f=n.querySelector(".erp-map-adv-btn-label");if(f&&typeof t=="function"){const g=l?"erp-map-hide-advanced":"erp-map-show-advanced",x=t(g);x&&x!==g&&(f.textContent=x)}n.setAttribute("aria-pressed",l?"true":"false")}document.addEventListener("click",function(n){if(!n.target.closest("#erp-map-show-advanced-btn"))return;n.preventDefault();const l=document.getElementById("erp-map-subtabs");if(l&&(l.classList.toggle("show-advanced"),e(),!l.classList.contains("show-advanced")&&l.querySelector(".erp-map-subtab.active.erp-map-subtab-advanced"))){const g=l.querySelector('.erp-map-subtab[data-erp-subtab="clients"]');g&&g.click()}});function a(){e()}typeof window.subscribeI18n=="function"&&window.subscribeI18n("erp-map-advanced-toggle",a)})();(function(){const e="pearnly_erp_onboard_shown";let a=!1;function n(){try{return Array.isArray(window._erpEndpoints)&&window._erpEndpoints.length>0}catch{return!1}}function o(){if(document.getElementById("erp-onboard-mask"))return;const f=document.createElement("div");f.id="erp-onboard-mask",f.className="erp-onboard-mask",f.innerHTML='<div class="erp-onboard-modal" role="dialog" aria-modal="true"><div class="erp-onboard-icon"><svg viewBox="0 0 32 32" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><rect x="4" y="6" width="24" height="20" rx="3"/><path d="M9 13h14M9 18h10"/><path d="M22 22l3 3 5-5"/></svg></div><div class="erp-onboard-title" id="erp-onboard-title"></div><div class="erp-onboard-body" id="erp-onboard-body"></div><div class="erp-onboard-btns"><button type="button" class="btn btn-secondary" id="erp-onboard-later"></button><button type="button" class="btn btn-primary" id="erp-onboard-ok"></button></div></div>',document.body.appendChild(f);function g(){const s=document.getElementById("erp-onboard-title"),p=document.getElementById("erp-onboard-body"),w=document.getElementById("erp-onboard-ok"),h=document.getElementById("erp-onboard-later");s&&(s.textContent=t("erp-onboard-title")),p&&(p.textContent=t("erp-onboard-body")),w&&(w.textContent=t("erp-onboard-ok")),h&&(h.textContent=t("erp-onboard-later"))}g();function x(){f.style.display="none"}document.getElementById("erp-onboard-ok").addEventListener("click",function(){try{localStorage.setItem(e,"1")}catch{}x();try{const s=document.querySelector('#btn-add-endpoint, [data-action="erp-add-endpoint"]');s&&s.scrollIntoView({behavior:"smooth",block:"center"})}catch{}}),document.getElementById("erp-onboard-later").addEventListener("click",function(){try{localStorage.setItem(e,"1")}catch{}x()}),f.addEventListener("click",function(s){s.target===f&&x()}),typeof window.subscribeI18n=="function"&&window.subscribeI18n("erp-onboard-modal",function(){f.style.display!=="none"&&g()})}function l(){if(!a){try{if(localStorage.getItem(e)==="1")return}catch{}n()||(a=!0,o(),requestAnimationFrame(function(){requestAnimationFrame(function(){if(n())return;const f=document.getElementById("erp-onboard-mask");f&&(f.style.display="flex")})}))}}document.addEventListener("click",function(f){const g=f.target.closest('.auto-nav-item[data-auto-tab="erp"]'),x=f.target.closest('.erp-subtab[data-erp-subtab="connect"]');(g||x)&&setTimeout(l,700)})})();(function(){const e={parse:{zh:"解析文件中",th:"กำลังอ่านไฟล์",en:"Parsing files",ja:"ファイル解析中"},report:{zh:"读取报告中",th:"กำลังอ่านรายงาน",en:"Reading report",ja:"レポート読込中"},reconcile:{zh:"对账中",th:"กำลังกระทบยอด",en:"Reconciling",ja:"照合中"},build:{zh:"生成中",th:"กำลังสร้างไฟล์",en:"Building",ja:"作成中"},persist:{zh:"保存中",th:"กำลังบันทึก",en:"Saving",ja:"保存中"},done:{zh:"完成",th:"เสร็จสิ้น",en:"Done",ja:"完了"}};window._reconProgressText=function(a,n){a=a||{},n=window._currentLang||n||localStorage.getItem("mrpilot_lang")||"th",e.parse[n]||(n="th");const o=a.stage||"parse",l=e[o]||e.parse,f=l[n]||l.th||l.en,g=a.stage_total,x=a.stage_done;if(o==="parse"&&Number.isFinite(g)&&g>0){const s={zh:"共 {d}/{t} 个文件",th:"{d}/{t} ไฟล์",en:"{d}/{t} files",ja:"{d}/{t} ファイル"}[n]||"{d}/{t} files";return f+" · "+s.replace("{d}",x||0).replace("{t}",g)}return f},window._reconPollJob=async function(a,n,o){o=o||{};const l=o.intervalMs||1500,f=o.maxMs||1200*1e3,g=Date.now();let x=0;for(;;){let s=null;try{const p=await fetch("/api/recon/jobs/"+encodeURIComponent(a),{headers:{Authorization:"Bearer "+n}});try{s=await p.json()}catch{s=null}(!p.ok||!s||!s.ok)&&(s=null)}catch{s=null}if(s){if(x=0,o.onProgress)try{o.onProgress(s.progress||{},s)}catch{}if(s.status==="done"||s.status==="failed"||s.status==="needs_review"||s.status==="needs_mapping")return s}else if(++x>=10)return{ok:!1,status:"failed",error_code:"poll_unreachable"};if(Date.now()-g>f)return{ok:!1,status:"timeout",error_code:"timeout"};await new Promise(p=>setTimeout(p,l))}}})();(function(){let e=!1,a=[],n=[],o=null,l="all",f=[],g={stmt:"",gl:""},x=[];const s=i=>document.getElementById(i);function p(i){if(i==null)return"—";const v=Number(i);return isNaN(v)?"—":v.toLocaleString("en-US",{minimumFractionDigits:2,maximumFractionDigits:2})}function w(i){return i?String(i).slice(0,10).split("-").reverse().join("/"):"—"}function h(i){return String(i||"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}function B(i,v){v=window._currentLang||v||"th";const b={stmt_headers_not_found:{zh:"认不出银行账单表头 · 请确认文件含日期/金额/余额列,或转成清晰的 Excel/CSV 重传",th:"หาหัวตารางบัญชีธนาคารไม่เจอ · ตรวจสอบว่ามีคอลัมน์ วันที่/จำนวนเงิน/ยอดคงเหลือ หรือแปลงเป็น Excel/CSV แล้วอัปโหลดใหม่",en:"Cannot detect bank statement headers · ensure the file has date/amount/balance columns, or re-upload as a clean Excel/CSV",ja:"銀行明細のヘッダーを認識できません · 日付/金額/残高列を確認するか、Excel/CSVに変換して再アップロードしてください"},gl_headers_not_found:{zh:"认不出总账表头 · 请确认文件含日期/科目/借方/贷方列,或转成清晰的 Excel/CSV 重传",th:"หาหัวตาราง GL ไม่เจอ · ตรวจสอบว่ามีคอลัมน์ วันที่/บัญชี/เดบิต/เครดิต หรือแปลงเป็น Excel/CSV แล้วอัปโหลดใหม่",en:"Cannot detect GL headers · ensure the file has date/account/debit/credit columns, or re-upload as a clean Excel/CSV",ja:"GLのヘッダーを認識できません · 日付/科目/借方/貸方列を確認するか、Excel/CSVに変換して再アップロードしてください"},stmt_no_rows:{zh:"文件里没有交易数据 · 请确认上传了正确的银行流水,或换更清晰的版本重传",th:"ไม่พบรายการธุรกรรมในไฟล์ · ตรวจสอบว่าอัปโหลด statement ที่ถูกต้อง หรือใช้เวอร์ชันที่ชัดเจนกว่า",en:"No transaction rows found · please upload the correct statement, or try a clearer version",ja:"取引データが見つかりません · 正しい明細をアップロードするか、より鮮明なファイルでお試しください"},no_rows:{zh:"解析后没有可对账的数据行 · 请确认文件内容完整,或换清晰版本重传",th:"ไม่มีแถวข้อมูลให้กระทบยอดหลังการอ่าน · ตรวจสอบความสมบูรณ์ของไฟล์ หรืออัปโหลดใหม่",en:"No reconcilable rows after parsing · check the file is complete, or re-upload a clearer version",ja:"解析後に照合可能な行がありません · ファイルの完全性を確認するか再アップロードしてください"},file_unreadable:{zh:"文件无法读取 · 可能已损坏或被加密 · 请换文件或转 PDF/Excel 重传",th:"อ่านไฟล์ไม่ได้ · อาจเสียหายหรือถูกเข้ารหัส · ลองไฟล์อื่นหรือแปลงเป็น PDF/Excel",en:"File cannot be read · may be corrupted or encrypted · try another file or convert to PDF/Excel",ja:"ファイルを読み取れません · 破損または暗号化の可能性 · 別ファイルまたはPDF/Excelに変換してください"},file_not_supported:{zh:"不支持此文件类型 · 请上传 PDF / 图片 / Excel / CSV",th:"ไม่รองรับไฟล์ประเภทนี้ · กรุณาอัปโหลด PDF / รูปภาพ / Excel / CSV",en:"File type not supported · please upload PDF / image / Excel / CSV",ja:"このファイル形式は非対応 · PDF / 画像 / Excel / CSV をアップロードしてください"},ocr_failed:{zh:"文件识别失败 · 请尝试更清晰的版本,或转成 PDF / Excel / CSV 重传",th:"อ่านไฟล์ไม่ออก · ลองเวอร์ชันที่ชัดเจนกว่า หรือแปลงเป็น PDF / Excel / CSV",en:"Could not read the file · try a clearer version, or convert to PDF / Excel / CSV",ja:"読み取りに失敗 · より鮮明なファイルか、PDF / Excel / CSV に変換して再試行してください"}},j={zh:"解析失败 · 请换更清晰的文件,或转成 Excel / CSV 后重新上传",th:"อ่านไฟล์ไม่สำเร็จ · ลองไฟล์ที่ชัดเจนกว่า หรือแปลงเป็น Excel / CSV แล้วอัปโหลดใหม่",en:"Parsing failed · try a clearer file, or convert to Excel / CSV and re-upload",ja:"解析に失敗しました · より鮮明なファイルか、Excel / CSV に変換して再アップロードしてください"},H=b[i]||j;return H[v]||H.th||H.en}function S(i){const v=i==="stmt"?a:n,b=s(`brv2-${i}-name`);if(b)if(v.length===0)b.textContent="";else{const H=window._currentLang||"zh",r={zh:"个文件",th:" ไฟล์",en:" file(s)",ja:" ファイル"};b.textContent=v.length+(r[H]||" 个文件")}const j=s("brv2-preview-panel");j&&j.style.display!=="none"&&N(i),I()}function I(){const i=s("brv2-toggle-preview"),v=s("brv2-preview-panel"),b=a.length+n.length>0;i&&(i.style.display=b?"":"none"),!b&&v&&(v.style.display="none",i&&i.classList.remove("open"))}function U(){N("stmt"),N("gl")}function N(i){const v=s(i==="stmt"?"brv2-pp-stmt-col":"brv2-pp-gl-col");if(!v)return;const b=i==="stmt"?a:n,j=window._currentLang||"zh",H={stmt:{zh:"① 银行账单",th:"① บัญชีธนาคาร",en:"① Bank Stmt",ja:"① 銀行明細"},gl:{zh:"② 总账 GL",th:"② GL รายงาน",en:"② GL Report",ja:"② GL帳簿"}},r=(H[i]||{})[j]||H[i].zh,C=h(window.t&&window.t("vex-preview-search")||"搜索文件名..."),A=h(window.t&&window.t("vex-preview-clear-all")||"全清"),O=g[i]||"";v.innerHTML='<div class="vex-pp-col-title"><span class="vex-pp-col-name">'+h(r)+' <span class="vex-pp-col-count">'+b.length+'</span></span></div><div class="vex-pp-search-row"><input class="vex-pp-search" id="brv2-pp-search-'+i+'" type="text" placeholder="'+C+'" value="'+h(O)+'" autocomplete="off"><button class="vex-pp-clear-btn" id="brv2-pp-clearall-'+i+'" type="button">'+A+'</button></div><div class="vex-pp-file-list" id="brv2-pp-'+i+'-list"></div><div class="vex-pp-pagination" id="brv2-pp-'+i+'-pg"></div>';const K=s("brv2-pp-search-"+i);K&&K.addEventListener("input",function(oe){g[i]=oe.target.value,M(i)});const te=s("brv2-pp-clearall-"+i);te&&te.addEventListener("click",function(){i==="stmt"?a.length=0:n.length=0,S(i),D()}),M(i)}function M(i){const v=s("brv2-pp-"+i+"-list"),b=s("brv2-pp-"+i+"-pg");if(!v)return;const j=i==="stmt"?a:n,H=(g[i]||"").toLowerCase(),r=H?j.filter(O=>O.name.toLowerCase().includes(H)):j.slice(),C='<svg class="vex-pp-fi-ico" viewBox="0 0 14 16" fill="none" stroke="currentColor" stroke-width="1.4" width="12" height="14"><path d="M3 1h6l3 3v11H3V1z"/><path d="M9 1v3h3"/></svg>',A='<svg viewBox="0 0 14 14" fill="none" stroke="currentColor" stroke-width="1.6" width="11" height="11"><path d="M2 4h10M5 4V2h4v2M5.5 7v4M8.5 7v4M3 4l1 8h6l1-8"/></svg>';if(v.innerHTML=r.map((O,K)=>'<div class="vex-pp-file-row">'+C+'<span class="vex-pp-fi-name" title="'+h(O.name)+'">'+h(O.name)+'</span><span class="vex-pp-fi-size">'+L(O.size)+'</span><button class="vex-pp-fi-del" type="button" data-zone="'+i+'" data-idx="'+j.indexOf(O)+'" aria-label="remove">'+A+"</button></div>").join(""),v.querySelectorAll(".vex-pp-fi-del").forEach(function(O){O.addEventListener("click",function(){const K=parseInt(O.dataset.idx,10);O.dataset.zone==="stmt"?a.splice(K,1):n.splice(K,1),S(O.dataset.zone),D()})}),b){const O=window.t&&window.t("vex-preview-count")||"显示 {n} / 共 {m}";b.textContent=O.replace("{n}",r.length).replace("{m}",j.length)}}function L(i){return i?i<1024?i+" B":i<1048576?(i/1024).toFixed(1)+" KB":(i/1048576).toFixed(1)+" MB":""}var z="pearnly.brv2.lastAnchorOcr";function V(i){try{var v=i&&i._anchor_ocr;if(!v||typeof v!="object")return;var b={stmt_opening:Number.isFinite(+v.stmt_opening)?+v.stmt_opening:null,gl_opening:Number.isFinite(+v.gl_opening)?+v.gl_opening:null,gl_closing:Number.isFinite(+v.gl_closing)?+v.gl_closing:null,stmt_closing:Number.isFinite(+v.stmt_closing)?+v.stmt_closing:null,ts:Date.now()};localStorage.setItem(z,JSON.stringify(b))}catch{}}function W(){try{var i=localStorage.getItem(z);if(!i)return null;var v=JSON.parse(i);return!v||typeof v!="object"?null:v}catch{return null}}function P(){var i=W();if(i){var v={"brv2-anchor-stmt-opening":i.stmt_opening,"brv2-anchor-gl-opening":i.gl_opening,"brv2-anchor-gl-closing":i.gl_closing,"brv2-anchor-stmt-closing":i.stmt_closing},b=0;Object.keys(v).forEach(function(A){var O=document.getElementById(A);if(O&&O.value===""){var K=v[A];if(Number.isFinite(K)){O.value=K.toFixed(2);var te=O.closest&&O.closest(".brv2-anchor-cell");te&&te.classList.add("is-prefilled"),b+=1}}});var j=document.getElementById("brv2-anchor-eq"),H=document.getElementById("brv2-anchor-eq-val");if(j&&H&&Number.isFinite(i.stmt_opening)&&Number.isFinite(i.gl_opening)){var r=i.stmt_opening-i.gl_opening;H.textContent=r.toLocaleString(void 0,{minimumFractionDigits:2,maximumFractionDigits:2}),j.style.display=""}if(b>0){var C=document.getElementById("brv2-anchor-prefill-banner");C&&C.classList.add("show")}}}function u(){var i=document.getElementById("brv2-anchor-prefill-banner");if(i){var v=!1;["brv2-anchor-gl-closing","brv2-anchor-stmt-closing","brv2-anchor-stmt-opening","brv2-anchor-gl-opening"].forEach(function(b){var j=document.getElementById(b);if(j){var H=j.closest&&j.closest(".brv2-anchor-cell");H&&H.classList.contains("is-prefilled")&&(v=!0)}}),i.classList.toggle("show",v)}}var c=[["stmt_opening","brv2-anchor-stmt-opening"],["gl_opening","brv2-anchor-gl-opening"],["gl_closing","brv2-anchor-gl-closing"],["stmt_closing","brv2-anchor-stmt-closing"]];function y(i,v){return window.t&&window.t(i)||v}function $(i){return String(i??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function T(i){return Number.isFinite(+i)?(+i).toLocaleString(void 0,{minimumFractionDigits:2,maximumFractionDigits:2}):"—"}function _(i){var v=document.getElementById("brv2-summary-collapse");if(!(!v||!v.parentNode)){var b=document.getElementById("brv2-anchor-audit"),j=i&&i._anchor_overrides;if(!j||typeof j!="object"||Object.keys(j).length===0){b&&b.parentNode&&b.parentNode.removeChild(b);return}b||(b=document.createElement("div"),b.id="brv2-anchor-audit",b.style.cssText="margin-top:14px;background:#fff7ed;border:1px solid #fed7aa;border-radius:8px;padding:14px 16px;",v.parentNode.insertBefore(b,v.nextSibling));var H=c.map(function(r){var C=j[r[0]];if(!C)return"";var A=+C.ocr||0,O=+C.user||0,K=O-A,te=K>0?"+":(K<0,""),oe=Math.abs(K)<.005?"#6b7280":K>0?"#16a34a":"#dc2626";return'<tr><td style="padding:6px 10px;color:#111827;font-size:13px">'+$(y(r[1],r[0]))+'</td><td style="padding:6px 10px;color:#6b7280;font-size:13px;text-align:right;font-variant-numeric:tabular-nums">'+$(T(A))+'</td><td style="padding:6px 10px;background:#fef08a;color:#92400e;font-weight:600;font-size:13px;text-align:right;font-variant-numeric:tabular-nums">'+$(T(O))+'</td><td style="padding:6px 10px;color:'+oe+';font-weight:500;font-size:13px;text-align:right;font-variant-numeric:tabular-nums">'+$(te+T(K))+"</td></tr>"}).join("");b.innerHTML='<div style="font-weight:600;color:#92400e;font-size:13px;margin-bottom:10px">'+$(y("brv2-anchor-audit-title","⚠ This run contains manually entered anchors"))+'</div><table style="width:100%;border-collapse:collapse;font-family:inherit"><thead><tr><th style="padding:6px 10px;text-align:left;color:#6b7280;font-size:11px;font-weight:500;border-bottom:1px solid #fed7aa">'+$(y("brv2-anchor-audit-col-field","Field"))+'</th><th style="padding:6px 10px;text-align:right;color:#6b7280;font-size:11px;font-weight:500;border-bottom:1px solid #fed7aa">'+$(y("brv2-anchor-audit-col-ocr","OCR"))+'</th><th style="padding:6px 10px;text-align:right;color:#6b7280;font-size:11px;font-weight:500;border-bottom:1px solid #fed7aa">'+$(y("brv2-anchor-audit-col-user","User"))+'</th><th style="padding:6px 10px;text-align:right;color:#6b7280;font-size:11px;font-weight:500;border-bottom:1px solid #fed7aa">'+$(y("brv2-anchor-audit-col-diff","Diff"))+"</th></tr></thead><tbody>"+H+"</tbody></table>"}}function E(){const i=s("brv2-toggle-preview");i&&!i._reconBound&&(i._reconBound=!0,i.addEventListener("click",function(){const v=s("brv2-preview-panel"),b=s("brv2-toggle-preview-label"),j=v&&v.style.display!=="none";v&&(v.style.display=j?"none":""),i.classList.toggle("open",!j),b&&(b.textContent=j?window.t&&window.t("vex-toggle-preview-open")||"查看清单":window.t&&window.t("vex-toggle-preview-close")||"收起清单"),j||U()}))}function D(){const i=s("brv2-run-btn"),v=s("brv2-status"),b=a.length>0,j=n.length>0;if(i&&(i.disabled=!(b&&j)),v){const H=window._currentLang||"zh";if(!b&&!j){const r={zh:"请上传银行账单和 GL 文件",th:"กรุณาอัปโหลดบัญชีธนาคารและ GL",en:"Upload bank statement and GL files",ja:"銀行明細と GL を両方アップロードしてください"};v.textContent=r[H]||r.zh}else if(b)if(j){const r={zh:"两份文件已就绪",th:"พร้อมสอบทาน",en:"Ready to reconcile",ja:"照合を開始できます"};v.textContent=r[H]||r.zh}else{const r={zh:"还缺 GL 文件",th:"ยังขาดไฟล์ GL",en:"Missing GL file",ja:"GL ファイルが未アップロード"};v.textContent=r[H]||r.zh}else{const r={zh:"还缺银行账单 PDF",th:"ยังขาดไฟล์บัญชีธนาคาร PDF",en:"Missing bank statement PDF",ja:"銀行明細 PDF が未アップロード"};v.textContent=r[H]||r.zh}}}function J(i,v,b){const j=s(i),H=s(v);!j||!H||(j.addEventListener("click",()=>H.click()),j.addEventListener("keydown",r=>{(r.key==="Enter"||r.key===" ")&&(r.preventDefault(),H.click())}),j.addEventListener("dragover",r=>{r.preventDefault(),j.classList.add("drag-over")}),j.addEventListener("dragleave",()=>j.classList.remove("drag-over")),j.addEventListener("drop",r=>{r.preventDefault(),j.classList.remove("drag-over");const C=Array.from(r.dataTransfer.files||[]);b==="stmt"?a.push(...C):n.push(...C),S(b),D()}),H.addEventListener("change",()=>{const r=Array.from(H.files||[]);b==="stmt"?a.push(...r):n.push(...r),H.value="",S(b),D()}))}function F(i){const v=s("brv2-progress"),b=s("brv2-run-btn"),j=s("brv2-error");v&&(v.style.display=i?"":"none"),b&&(b.disabled=i),j&&(j.style.display="none")}function Q(i){const v=s("brv2-error");v&&(v.textContent=i,v.style.display="",v.scrollIntoView({behavior:"smooth",block:"nearest"})),F(!1),D(),window.showToast&&window.showToast(i,"error")}async function ie(){if(a.length===0||n.length===0)return;const i=localStorage.getItem("mrpilot_token")||"",v=window._currentLang||"zh",b=(s("brv2-acct-select")||{}).value||"";ue(!1),F(!0);try{const j=new FormData;a.forEach(ne=>j.append("stmt_files",ne)),n.forEach(ne=>j.append("gl_files",ne)),j.append("gl_account",b),j.append("lang",v);const H=parseFloat((s("brv2-anchor-gl-closing")||{}).value),r=parseFloat((s("brv2-anchor-stmt-closing")||{}).value),C=parseFloat((s("brv2-anchor-stmt-opening")||{}).value),A=parseFloat((s("brv2-anchor-gl-opening")||{}).value);Number.isFinite(H)&&j.append("gl_closing_override",H),Number.isFinite(r)&&j.append("stmt_closing_override",r),Number.isFinite(C)&&j.append("stmt_opening_override",C),Number.isFinite(A)&&j.append("gl_opening_override",A);const O=await fetch("/api/recon/bank-v2/submit",{method:"POST",headers:{Authorization:"Bearer "+i},body:j});let K=null;try{K=await O.json()}catch{K=null}if(K&&K.needs_mapping){F(!1),window.ReconMapping?window.ReconMapping.show(K,{token:i,lang:v,onConfirmed:function(){ie()}}):Q(t("brv2-err-server")||"服务器繁忙,请稍后重试");return}if(!O.ok||!K||!K.ok||!K.job_id){F(!1),K&&(K.detail||K.error)?Q(_humanizeBackendError(K.detail||K.error,"Error "+O.status)):Q(t("brv2-err-server")||"服务器繁忙,请稍后重试");return}const te=s("brv2-progress-sub"),oe=await window._reconPollJob(K.job_id,i,{onProgress:ne=>{te&&(te.textContent=window._reconProgressText(ne,v))}});if(oe&&oe.status==="needs_mapping"&&oe.mapping){F(!1),window.ReconMapping?window.ReconMapping.show(oe.mapping,{token:i,lang:v,onConfirmed:function(){ie()}}):Q(t("brv2-err-server")||"服务器繁忙,请稍后重试");return}if(oe&&oe.status==="needs_review"&&oe.review){F(!1),window.ReconReview?window.ReconReview.show(oe.review,{token:i,lang:v,jobId:K.job_id,onConfirmed:async function(ne){F(!0);const ce=await window._reconPollJob(ne,i,{onProgress:fe=>{te&&(te.textContent=window._reconProgressText(fe,v))}});await se(ce)}}):Q(t("brv2-err-server")||"服务器繁忙,请稍后重试");return}if(oe&&oe.status==="failed"){F(!1),Q(B(oe.error_code,v));return}await se(oe);async function se(ne){try{if(!ne||ne.status!=="done"||!ne.result_id){F(!1),Q(t("brv2-err-server")||"服务器繁忙,请稍后重试");return}const ce=await fetch("/api/recon/bank-v2/"+encodeURIComponent(ne.result_id),{headers:{Authorization:"Bearer "+i}});let fe=null;try{fe=await ce.json()}catch{fe=null}if(!ce.ok||fe===null||!fe.ok){F(!1),Q(t("brv2-err-server")||"服务器繁忙,请稍后重试");return}(fe.gl_accounts||[]).length>1&&le(fe.gl_accounts),o=fe,f=fe.detail||[],l="all",document.querySelectorAll(".brv2-filter-btn").forEach(he=>he.classList.toggle("active",he.dataset.filter==="all")),V(fe&&fe.summary),F(!1),X(fe),re();const ve=s("brv2-summary-collapse");ve&&ve.scrollIntoView({behavior:"smooth",block:"nearest"})}catch(ce){F(!1),Q(ce.message||"Network error")}}}catch(j){Q(j.message||"Network error")}}function le(i){const v=s("brv2-acct-select");if(!v)return;const b=window._currentLang||"zh",j={zh:"全部账户",th:"ทุกบัญชี",en:"All Accounts",ja:"すべての口座"}[b]||"全部账户";v.innerHTML=`<option value="">${j}</option>`+i.map(H=>`<option value="${h(H)}">${h(H)}</option>`).join(""),v.style.display=""}function ue(i){const v=s("brv2-summary-collapse"),b=s("brv2-detail-collapse"),j=s("brv2-export-btn"),H=s("brv2-new-btn"),r=s("brv2-parse-info-wrap");v&&(v.style.display=i?"":"none"),b&&(b.style.display=i?"":"none"),j&&(j.style.display=i?"":"none"),H&&(H.style.display=i?"":"none"),!i&&r&&(r.style.display="none");const C=s("brv2-warnings");!i&&C&&(C.style.display="none",C.innerHTML="")}function R(i){const v=s("brv2-parse-info-wrap"),b=s("brv2-parse-info-body");if(!v||!b)return;const j=i.parse_info;if(!j){v.style.display="none";return}const H=window._currentLang||"zh",r={title:{zh:"文件解析状态",th:"สถานะการอ่านไฟล์",en:"File Parse Status",ja:"ファイル解析状態"},type:{zh:"类型",th:"ประเภท",en:"Type",ja:"種別"},file:{zh:"文件名",th:"ชื่อไฟล์",en:"File",ja:"ファイル"},rows:{zh:"解析行数",th:"แถวที่พบ",en:"Rows Found",ja:"解析行数"},bank:{zh:"银行/科目",th:"ธนาคาร/บัญชี",en:"Bank/Account",ja:"銀行/科目"},status:{zh:"状态",th:"สถานะ",en:"Status",ja:"状態"},stmt:{zh:"账单",th:"บัญชีธนาคาร",en:"Stmt",ja:"明細"},gl:{zh:"总账GL",th:"GL",en:"GL",ja:"GL"},ok:{zh:"✓ 成功",th:"✓ สำเร็จ",en:"✓ OK",ja:"✓ 成功"},warn:{zh:"⚠ 0行",th:"⚠ 0 แถว",en:"⚠ 0 rows",ja:"⚠ 0行"},fail:{zh:"✗ 失败",th:"✗ ล้มเหลว",en:"✗ Failed",ja:"✗ 失敗"}},C=se=>(r[se]||{})[H]||(r[se]||{}).zh||se,A=[...(j.stmt_files||[]).map(se=>({...se,_type:"stmt",_extra:se.bank_code||""})),...(j.gl_files||[]).map(se=>({...se,_type:"gl",_extra:(se.accounts||[]).join(", ")}))],O={stmt_headers_not_found:{zh:"认不出表头列 · 请确认文件含日期/金额/余额列",th:"หาคอลัมน์หัวตารางไม่เจอ · ตรวจสอบไฟล์มีวันที่/จำนวนเงิน/ยอดคงเหลือ",en:"Cannot detect column headers · ensure file has date/amount/balance columns",ja:"列ヘッダーが認識できません · 日付/金額/残高列を確認してください"},stmt_no_rows:{zh:"文件里没有交易数据 · 请确认上传了正确的银行流水",th:"ไม่พบรายการธุรกรรมในไฟล์ · ตรวจสอบว่าอัปโหลด statement ที่ถูกต้อง",en:"No transaction rows found · please check the file",ja:"取引データが見つかりません · ファイルを確認してください"},file_not_supported:{zh:"不支持此文件类型 · 请上传 PDF / 图片 / Excel / CSV",th:"ไม่รองรับไฟล์ประเภทนี้ · กรุณาอัปโหลด PDF / รูปภาพ / Excel / CSV",en:"File type not supported · please upload PDF / image / Excel / CSV",ja:"このファイル形式は非対応 · PDF / 画像 / Excel / CSV をアップロード"},file_unreadable:{zh:"文件无法读取 · 可能已损坏或被加密",th:"อ่านไฟล์ไม่ได้ · อาจเสียหายหรือถูกเข้ารหัส",en:"File cannot be read · may be corrupted or encrypted",ja:"ファイルを読み取れません · 破損または暗号化の可能性"},ocr_failed:{zh:"文件识别失败 · 请尝试更清晰的版本或换 PDF 格式重传",th:"อ่านไฟล์ไม่ออก · ลองเวอร์ชันที่ชัดเจนกว่าหรือเปลี่ยนเป็น PDF",en:"Could not read file · try a clearer version or upload as PDF",ja:"読み取り失敗 · より鮮明なファイルまたは PDF 形式で再試行"},gl_headers_not_found:{zh:"认不出总账表头 · 请确认文件含科目/借方/贷方列",th:"หาหัวคอลัมน์ GL ไม่เจอ · ตรวจสอบมีคอลัมน์บัญชี/เดบิต/เครดิต",en:"Cannot detect GL column headers · ensure account/debit/credit columns exist",ja:"GL 列ヘッダー認識不可 · 科目/借方/貸方列を確認してください"}},K=se=>{const ne=String(se||"");return/Cannot detect bank statement column headers/i.test(ne)?"stmt_headers_not_found":/Cannot detect GL column headers/i.test(ne)?"gl_headers_not_found":/No transaction rows found|no pages parsed/i.test(ne)?"stmt_no_rows":/unsupported format/i.test(ne)?"file_not_supported":/Cannot read Excel|file_unreadable/i.test(ne)?"file_unreadable":/Gemini.*invalid JSON|Gemini.*parsed but failed|validation errors|BankStatementDocument schema|layer2:|layer1:/i.test(ne)?"ocr_failed":null},te=se=>{const ne=se.error_code||K(se.error);if(ne&&O[ne]){const ce=window._currentLang||"zh";return O[ne][ce]||O[ne].zh}return String(se.error||"").slice(0,80)},oe=se=>!se.ok&&se.error?`<span style="color:#dc2626">${C("fail")} — ${h(te(se))}</span>`:se.rows?`<span style="color:#059669">${C("ok")} (${se.rows})</span>`:`<span style="color:#d97706">${C("warn")}</span>`;b.innerHTML=`
            ...
            <table style="width:100%;border-collapse:collapse;font-size:12px;margin-bottom:4px">
                ...
                <tbody>
                    ${A.map(se=>`<tr>
                        ...
                        <td style="padding:5px 8px;border:1px solid #e5e7eb;max-width:220px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap" title="${h(se.file||"")}">${h(se.file||"")}</td>
                        <td style="padding:5px 8px;border:1px solid #e5e7eb;text-align:center">${se.rows||0}</td>
                        <td style="padding:5px 8px;border:1px solid #e5e7eb;color:var(--ink-2)">${h(se._extra||"")}</td>
                        <td style="padding:5px 8px;border:1px solid #e5e7eb">${oe(se)}</td>
                    </tr>`).join("")}
                </tbody>
            </table>`,v.style.display=""}async function k(i){const v=localStorage.getItem("mrpilot_token")||"",b=window._currentLang||"zh";try{const j=await fetch("/api/recon/bank-v2/"+i+"/export?lang="+b,{headers:{Authorization:"Bearer "+v}});if(!j.ok){const te=await j.json().catch(()=>({}));window.showToast&&window.showToast(te.detail||"Export failed","error");return}const H=await j.blob(),C=(j.headers.get("content-disposition")||"").match(/filename[^;=\n]*=((['"]).*?\2|[^;\n]*)/),A=C?C[1].replace(/['"]/g,""):"reconciliation.xlsx",O=URL.createObjectURL(H),K=document.createElement("a");K.href=O,K.download=A,document.body.appendChild(K),K.click(),document.body.removeChild(K),URL.revokeObjectURL(O)}catch(j){window.showToast&&window.showToast("Export error: "+j.message,"error")}}function Y(i,v){const b=s("brv2-summary-collapse");let j=s("brv2-warnings");const H=window._currentLang||"zh",r={zh:"⏭ 已跳过无法识别的文件:",th:"⏭ ข้ามไฟล์ที่อ่านไม่ได้:",en:"⏭ Skipped unreadable file:",ja:"⏭ 読み取れないファイルをスキップ:"}[H]||"⏭ ",C=[];if((v||[]).forEach(A=>C.push(r+" "+A)),(i||[]).forEach(A=>C.push(A)),!C.length){j&&(j.style.display="none");return}if(!j)if(j=document.createElement("div"),j.id="brv2-warnings",b&&b.parentNode)b.parentNode.insertBefore(j,b);else return;j.style.cssText="display:block;margin:10px 0;padding:10px 14px;background:#FEF3C7;border:1px solid #FCD34D;border-radius:8px;color:#92400E;font-size:13px;line-height:1.6",j.innerHTML=C.map(A=>"<div>"+h(A)+"</div>").join("")}function X(i){R(i),Y(i.warnings||[],i.skipped_files||[]),!i.ok&&i.error&&window.showToast&&window.showToast(i.error,"error");const v=i.stats||{},b=i.summary||{},j=v.matched||0,H=(v.gl_debit_only||0)+(v.gl_credit_only||0),r=(v.stmt_withdrawal_only||0)+(v.stmt_deposit_only||0),C=Number(b.formula_diff||0),A=Math.abs(C)<.05;s("brv2-kpi-matched")&&(s("brv2-kpi-matched").textContent=j),s("brv2-kpi-diff")&&(s("brv2-kpi-diff").textContent=p(C)),s("brv2-kpi-unmatched")&&(s("brv2-kpi-unmatched").textContent=H+r);const O=s("brv2-kpi-diff-icon");O&&(O.style.background=A?"#d1fae5":"#fee2e2",O.style.color=A?"#065f46":"#b91c1c");const K=s("brv2-formula-sub");if(K){const ce=window._currentLang||"zh";K.textContent=A?{zh:"✓ 平衡",th:"✓ สมดุล",en:"✓ Balanced",ja:"✓ 一致"}[ce]||"✓ 平衡":({zh:"差 ",th:"ต่าง ",en:"Diff ",ja:"差 "}[ce]||"差 ")+p(C)}const te=s("brv2-detail-sub");if(te){const ce=window._currentLang||"zh",fe={zh:"共 {n} 行",th:"ทั้งหมด {n} แถว",en:"{n} rows",ja:"計 {n} 行"}[ce]||"共 {n} 行";te.textContent=fe.replace("{n}",f.length)}function oe(ce,fe,ve){const he=s(ce);he&&(he.textContent=(ve&&fe>0?"(":"")+p(ve?-fe:fe)+(ve&&fe>0?")":""))}oe("brf-gl-close",b.gl_closing||0),oe("brf-open-diff",b.opening_diff||0),oe("brf-gl-debit-only",b.gl_debit_only_amount||0,!0),oe("brf-gl-credit-only",b.gl_credit_only_amount||0),oe("brf-stmt-wd-only",b.stmt_withdrawal_only_amount||0,!0),oe("brf-stmt-dep-only",b.stmt_deposit_only_amount||0),oe("brf-calc-close",b.formula_stmt_closing||0),oe("brf-stmt-close",b.stmt_closing||0),s("brf-diff")&&(s("brf-diff").textContent=p(C));const se=s("brv2-fcell-diff");se&&se.classList.toggle("brv2-fcell-diff-ok",A);const ne=s("brv2-export-btn");ne&&(ne.onclick=()=>{o&&k(o.task_id)}),_(b),ue(!0),ee()}function ee(){const i=s("brv2-tbody");if(!i)return;const v=f.filter(r=>l==="all"?!0:l==="matched"?r.match_status==="matched":l==="gl_only"?r.match_status.startsWith("gl_"):l==="stmt_only"?r.match_status.startsWith("stmt_"):!0);if(v.length===0){const r={zh:"无记录",th:"ไม่มีรายการ",en:"No rows",ja:"行なし"}[window._currentLang||"zh"]||"无记录";i.innerHTML=`<tr><td colspan="10" style="text-align:center;padding:20px;color:var(--ink-3)">${r}</td></tr>`;return}const b=window._currentLang||"zh",j={zh:"OCR 余额验证未通过 · 上一行余额 ± 金额 ≠ 本行余额，请核对原 PDF",th:"การตรวจสอบยอดคงเหลือไม่ผ่าน · ยอดก่อนหน้า ± จำนวน ≠ ยอดบรรทัดนี้ โปรดตรวจสอบ PDF ต้นฉบับ",en:"Balance check FAILED · prev_balance ± amount ≠ this row balance — verify against the original PDF",ja:"残高検証エラー · 前残高 ± 金額 ≠ この行残高 — 元のPDFと照合してください"}[b],H={zh:"OCR 低置信度 · 数字模糊或难以辨认，请核对原 PDF",th:"OCR ความมั่นใจต่ำ · ตัวเลขเบลอหรืออ่านยาก โปรดตรวจสอบ PDF ต้นฉบับ",en:"OCR low confidence · digit was blurry or hard to read — verify against the original PDF",ja:"OCR信頼度低 · 数字がぼやけている — 元のPDFと照合してください"}[b];i.innerHTML=v.map(r=>{const C=r.match_status,A=r.match_layer;let O="",K="";C==="matched"?(A===1&&(O="matched",K='<span class="brv2-status-badge brv2-badge-matched">L1 ✓</span>'),A===2&&(O="matched-l2",K='<span class="brv2-status-badge brv2-badge-matched-l2">L2 ~</span>'),A===3&&(O="matched-l3",K='<span class="brv2-status-badge brv2-badge-matched-l3">L3 ?</span>')):C==="gl_debit_only"||C==="gl_credit_only"?(O="gl-only",K='<span class="brv2-status-badge brv2-badge-gl-only">GL</span>'):(O="stmt-only",K=`<span class="brv2-status-badge brv2-badge-stmt-only">${{zh:"账单",th:"บัญชี",en:"Stmt",ja:"明細"}[b]||"账单"}</span>`);let te="";return r.stmt_balance_ok===!1&&(te+=`<span class="brv2-ocr-warn brv2-ocr-warn-bal" title="${h(j)}">⚠</span>`,O+=" brv2-row-warn"),r.stmt_confidence==="low"&&(te+=`<span class="brv2-ocr-warn brv2-ocr-warn-conf" title="${h(H)}">◌</span>`,O.includes("brv2-row-warn")||(O+=" brv2-row-warn-soft")),`<tr class="${O.trim()}">
              <td>${K}${te}</td>
              <td>${h(w(r.stmt_date))}</td>
              <td title="${h(r.stmt_desc)}" style="max-width:180px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap">${h(r.stmt_desc)}</td>
              <td class="num">${r.stmt_withdrawal?p(r.stmt_withdrawal):""}</td>
              <td class="num">${r.stmt_deposit?p(r.stmt_deposit):""}</td>
              <td>${h(w(r.gl_date))}</td>
              <td title="${h(r.gl_doc_no)}" style="max-width:120px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap">${h(r.gl_doc_no)}</td>
              <td class="num">${r.gl_debit?p(r.gl_debit):""}</td>
              <td class="num">${r.gl_credit?p(r.gl_credit):""}</td>
              <td>${A?"L"+A:"—"}</td>
            </tr>`}).join("")}async function re(){const i=localStorage.getItem("mrpilot_token")||"";try{const b=await(await fetch("/api/recon/bank-v2/tasks",{headers:{Authorization:"Bearer "+i}})).json();d(b.tasks||[])}catch{const b=s("brv2-history-empty"),j=window._currentLang||"zh",H={zh:"加载失败",th:"โหลดประวัติไม่ได้",en:"Load failed",ja:"読み込み失敗"}[j]||"加载失败";b&&(b.textContent=H,b.style.display="");const r=s("brv2-history-table-wrap");r&&(r.style.display="none")}}const de=10;let pe=1;function G(){const i=s("brv2-history-pager"),v=s("brv2-history-pager-info"),b=s("brv2-history-prev"),j=s("brv2-history-next");if(!i)return;if(x.length<=de){i.style.display="none";return}i.style.display="";const H=Math.ceil(x.length/de);v&&(v.textContent=pe+" / "+H),b&&(b.disabled=pe<=1),j&&(j.disabled=pe>=H)}function ae(){const i=s("brv2-history-prev"),v=s("brv2-history-next");i&&!i._brv2Bound&&(i._brv2Bound=!0,i.addEventListener("click",()=>{pe>1&&(pe--,d(x))})),v&&!v._brv2Bound&&(v._brv2Bound=!0,v.addEventListener("click",()=>{const b=Math.ceil(x.length/de);pe<b&&(pe++,d(x))}))}function d(i){i!==void 0&&(x=i||[],pe=1);const v=x,b=s("brv2-history-empty"),j=s("brv2-history-table-wrap"),H=s("brv2-history-tbody");if(!H)return;const r=window._currentLang||"zh";if(!v.length){const ne={zh:"暂无对账记录",th:"ยังไม่มีประวัติ",en:"No records yet",ja:"記録なし"}[r]||"暂无对账记录";b&&(b.textContent=ne,b.style.display=""),j&&(j.style.display="none"),G();return}b&&(b.style.display="none"),j&&(j.style.display="");const C=Math.ceil(v.length/de);pe>C&&(pe=C);const A=(pe-1)*de,O=v.slice(A,A+de),K=localStorage.getItem("mrpilot_token")||"",te='<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" width="14" height="14"><circle cx="8" cy="8" r="6"/><polyline points="6 8 8 10 10 8"/><line x1="8" y1="4" x2="8" y2="10"/></svg>',oe='<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" width="14" height="14"><path d="M8 2v9M4 7l4 4 4-4M3 14h10"/></svg>',se='<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" width="14" height="14"><polyline points="3 4 13 4"/><path d="M6 4V2.5a.5.5 0 0 1 .5-.5h3a.5.5 0 0 1 .5.5V4"/><path d="M5 4l1 9a1 1 0 0 0 1 1h2a1 1 0 0 0 1-1l1-9"/></svg>';H.innerHTML="",O.forEach(ne=>{const ce=Number(ne.formula_diff||0),fe=Math.abs(ce)<.05,ve=(ne.stmt_files||"").split(";").map(Ee=>Ee.trim().split(/[/\\]/).pop()).filter(Boolean).join(", "),he=(ne.gl_files||"").split(";").map(Ee=>Ee.trim().split(/[/\\]/).pop()).filter(Boolean).join(", "),we=ne.created_at?String(ne.created_at).slice(0,16).replace("T"," "):"",ke=document.createElement("tr");ke.dataset.taskId=ne.id;const Le=document.createElement("td");Le.textContent=we;const Be=document.createElement("td");Be.className="glv-history-file",Be.title=ve+" + "+he,Be.textContent=ve+" + "+he;const Ie=document.createElement("td");Ie.className="glv-num",Ie.textContent=(ne.stmt_row_count||0)+" / "+(ne.gl_row_count||0);const Ae=document.createElement("td");Ae.className="glv-num",Ae.textContent=ne.matched_count||0;const be=document.createElement("td");be.className="glv-num",be.textContent=ne.unmatched_gl||0;const Se=document.createElement("td");Se.className="glv-num",Se.textContent=ne.unmatched_stmt||0;const Ce=document.createElement("td");Ce.className="glv-num",Ce.style.color=fe?"#059669":"#dc2626",Ce.textContent=fe?"✓":p(ce);const xe=document.createElement("td");xe.className="glv-history-actions";const je=(Ee,rt,lt,xt)=>{const Te=document.createElement("button");return Te.type="button",Te.title=rt,Te.setAttribute("aria-label",rt),lt&&(Te.className=lt),Te.innerHTML=Ee,Te.onclick=_t=>{_t.stopPropagation(),xt()},Te},Je={zh:"删除这条记录?",th:"ลบรายการนี้?",en:"Delete this record?",ja:"この記録を削除しますか?"}[r]||"删除?",We={zh:"加载",th:"โหลด",en:"Load",ja:"読込"}[r]||"加载",Ke={zh:"导出",th:"ส่งออก",en:"Export",ja:"エクスポート"}[r]||"导出",Xe={zh:"删除",th:"ลบ",en:"Delete",ja:"削除"}[r]||"删除";xe.appendChild(je(te,We,"",()=>q(ne.id,K))),xe.appendChild(je(oe,Ke,"",()=>k(ne.id))),xe.appendChild(je(se,Xe,"glv-del",async()=>{await showConfirm(Je,{danger:!0})&&(await fetch("/api/recon/bank-v2/"+ne.id,{method:"DELETE",headers:{Authorization:"Bearer "+K}}),re())})),[Le,Be,Ie,Ae,be,Se,Ce,xe].forEach(Ee=>ke.appendChild(Ee)),ke.style.cursor="pointer",ke.addEventListener("click",async Ee=>{Ee.target.closest(".glv-del")||Ee.target.closest("button")||await q(ne.id,K)}),H.appendChild(ke)}),G(),m()}function m(){const i=((s("brv2-hist-search")||{}).value||"").trim().toLowerCase(),v=s("brv2-history-tbody");v&&v.querySelectorAll("tr").forEach(b=>{b.dataset.taskId&&(b.style.display=!i||b.textContent.toLowerCase().includes(i)?"":"none")})}async function q(i,v){try{const j=await(await fetch("/api/recon/bank-v2/"+i,{headers:{Authorization:"Bearer "+v}})).json();if(!j.ok)return;o={task_id:j.task_id,...j},f=j.detail||[],l="all",document.querySelectorAll(".brv2-filter-btn").forEach(H=>H.classList.toggle("active",H.dataset.filter==="all")),X(o)}catch{}}function Z(){if(e){re();return}e=!0,J("brv2-stmt-zone","brv2-stmt-input","stmt"),J("brv2-gl-zone","brv2-gl-input","gl");const i=["brv2-anchor-gl-closing","brv2-anchor-stmt-closing","brv2-anchor-stmt-opening","brv2-anchor-gl-opening"];function v(){const A=parseFloat((s("brv2-anchor-stmt-opening")||{}).value),O=parseFloat((s("brv2-anchor-gl-opening")||{}).value),K=s("brv2-anchor-eq"),te=s("brv2-anchor-eq-val");if(!(!K||!te))if(Number.isFinite(A)&&Number.isFinite(O)){const oe=A-O;te.textContent=oe.toLocaleString(void 0,{minimumFractionDigits:2,maximumFractionDigits:2}),K.style.display=""}else K.style.display="none"}i.forEach(A=>{const O=s(A);O&&(O.addEventListener("input",v),O.addEventListener("input",()=>{const K=O.closest(".brv2-anchor-cell");K&&K.classList.remove("is-prefilled"),u()}))}),P();const b=s("brv2-run-btn");b&&b.addEventListener("click",ie);const j=s("brv2-reset-btn");j&&j.addEventListener("click",()=>{o=null,f=[],a=[],n=[],S("stmt"),S("gl"),D(),ue(!1);const A=s("brv2-acct-select");A&&(A.style.display="none"),i.forEach(te=>{const oe=s(te);if(oe){oe.value="";const se=oe.closest&&oe.closest(".brv2-anchor-cell");se&&se.classList.remove("is-prefilled")}});const O=s("brv2-anchor-eq");O&&(O.style.display="none");const K=s("brv2-anchor-prefill-banner");K&&K.classList.remove("show")});const H=s("brv2-new-btn");H&&H.addEventListener("click",()=>{o=null,f=[],a=[],n=[],S("stmt"),S("gl"),D(),ue(!1)});const r=s("brv2-filter-tabs");r&&r.addEventListener("click",A=>{A.stopPropagation();const O=A.target.closest(".brv2-filter-btn");O&&(l=O.dataset.filter,r.querySelectorAll(".brv2-filter-btn").forEach(K=>K.classList.toggle("active",K===O)),ee())}),E(),ae();const C=s("brv2-hist-search");C&&C.addEventListener("input",m),re(),D(),window._brv2LoadHistory=re,Array.isArray(window.__i18nSubs)||(window.__i18nSubs=[]),window.__i18nSubs=window.__i18nSubs.filter(A=>A.name!=="brv2"),window.__i18nSubs.push({name:"brv2",fn:function(){D(),S("stmt"),S("gl"),o&&X(o),d()}})}window._loadBankReconV2Panel=function(i){const v=i?document.getElementById(i):null;v&&v.id!=="recon-pane-bank"&&(v.innerHTML=`<div style="padding:16px;font-size:13px;color:var(--ink-3)">
                银行对账 v2 · 请前往对账中心使用</div>`),Z()},document.addEventListener("DOMContentLoaded",()=>{s("brv2-run-btn")&&Z()}),window._bankReconV2Init=Z})();(function(){const e=document.getElementById("general-lang");if(!e)return;e.addEventListener("change",n=>{const o=n.target.value;o&&applyLang(o)});const a=typeof currentLang=="string"&&currentLang||localStorage.getItem("mrpilot_lang")||"th";e.value=a})();(function(){const a="pearnly_general_tz",n="pearnly_general_date_format",o="pearnly_general_number_format",l={tz:"Asia/Bangkok",date:"YYYY-MM-DD",number:"comma_dot"};function f(){const p=document.getElementById("general-tz"),w=document.getElementById("general-date"),h=document.getElementById("general-number");if(!(!p||!w||!h))try{p.value=localStorage.getItem(a)||l.tz,w.value=localStorage.getItem(n)||l.date,h.value=localStorage.getItem(o)||l.number}catch{p.value=l.tz,w.value=l.date,h.value=l.number}}async function g(){const p=document.getElementById("btn-save-general"),w=document.getElementById("general-save-msg");if(!p)return;const h=p.innerHTML;p.disabled=!0,p.innerHTML="<span>"+(t("msg-saving")||"保存中...")+"</span>",w&&(w.textContent="",w.classList.remove("error"));try{const B=(document.getElementById("general-tz")||{}).value||l.tz,S=(document.getElementById("general-date")||{}).value||l.date,I=(document.getElementById("general-number")||{}).value||l.number;try{localStorage.setItem(a,B),localStorage.setItem(n,S),localStorage.setItem(o,I)}catch{}window._pearnlyGeneral={tz:B,date_format:S,number_format:I},w&&(w.textContent=t("msg-saved")||"已保存")}catch{w&&(w.textContent=t("msg-save-failed")||"保存失败",w.classList.add("error"))}finally{p.disabled=!1,p.innerHTML=h,setTimeout(function(){w&&(w.textContent="")},3e3)}}function x(){const p=document.getElementById("btn-save-general");if(!p){setTimeout(x,200);return}p._pearnlyGenBound||(p._pearnlyGenBound=!0,p.addEventListener("click",g),f())}function s(){f();const p=document.getElementById("general-lang");if(p){const w=typeof currentLang=="string"&&currentLang||localStorage.getItem("mrpilot_lang")||"th";p.value=w}}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",x):x(),typeof window.subscribeI18n=="function"&&window.subscribeI18n("settings-general",s)})();(function(){const e="mrpilot_nav_collapsed",a={ocr:"sales",history:"sales",reconcile:"sales","sales-invoices":"sales",receivables:"sales",vouchers:"expense"};function n(){try{const g=localStorage.getItem(e);return g?JSON.parse(g):{}}catch{return{}}}function o(g){try{localStorage.setItem(e,JSON.stringify(g))}catch{}}function l(){const g=n();document.querySelectorAll(".nav-collapsible").forEach(function(x){const s=x.dataset.collapsible;g[s]?x.classList.add("collapsed"):x.classList.remove("collapsed")})}function f(g){const x=n();x[g]=!x[g],o(x),l()}(function(){const x=n();let s=!1;x.sales===void 0&&(x.sales=!1,s=!0),x.expense===void 0&&(x.expense=!0,s=!0),s&&o(x)})(),l(),document.querySelectorAll(".nav-group-toggle").forEach(function(g){g.addEventListener("click",function(){f(g.dataset.toggleGroup)})}),window.expandNavGroupForRoute=function(g){const x=a[g];if(!x)return;const s=n();s[x]&&(s[x]=!1,o(s),l())}})();(function(){function e(){const a=document.getElementById("help-modal"),n=document.getElementById("help-modal-close");a&&(n&&!n.dataset.bound&&(n.addEventListener("click",function(){a.style.display="none"}),n.dataset.bound="1"),a.dataset.maskBound||(a.addEventListener("click",function(o){o.target===a&&(a.style.display="none")}),a.dataset.maskBound="1"),window._helpModalEscBound||(document.addEventListener("keydown",function(o){o.key==="Escape"&&a.style.display==="flex"&&(a.style.display="none")}),window._helpModalEscBound=!0))}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",e):e()})();(function(){const e={line:"line",folder:"folder",gmail:"email",erp:"erp",alert:"alert"};document.addEventListener("click",function(a){const n=a.target.closest(".int-btn-configure");if(!n)return;const o=n.closest(".integration-row"),l=o?o.dataset.intAnchor:null;if(l&&e[l]){const f=o.querySelector(".int-name"),g=f?(f.textContent||f.innerText||"").trim():"配置";typeof window.openIntegrationDrawer=="function"&&window.openIntegrationDrawer(e[l],g)}})})();let _e=[];window._erpEndpoints=_e;let Oe=null,Me={key:"all",val:""},ye=new Set;async function He(e){const a=document.getElementById("erp-logs-list");if(a){e||(a.innerHTML=`<div class="erp-logs-empty">${escapeHtml(t("erp-logs-loading"))}</div>`),it();try{const n=new URLSearchParams({limit:"30"});Me.key==="status"&&n.set("status",Me.val),Me.key==="trigger"&&n.set("trigger",Me.val),Me.key==="adapter"&&n.set("adapter",Me.val);const o=await fetch(`/api/erp/logs?${n}`,{headers:{Authorization:"Bearer "+token}});if(!o.ok){a.innerHTML=`<div class="erp-logs-empty">${escapeHtml(t("erp-logs-error"))}</div>`;return}const f=(await o.json()).items||[];if(window._erpLogPollTimer&&(clearTimeout(window._erpLogPollTimer),window._erpLogPollTimer=null),f.some(function(p){return p.status==="pending"})&&(window._erpLogPollTimer=setTimeout(function(){He(!0)},4e3)),f.length===0){a.innerHTML=`<div class="erp-logs-empty">${escapeHtml(t("erp-logs-empty"))}</div>`;return}const x='<div class="erp-log-row erp-log-row-header" data-log-header>'+(f.filter(function(p){var w=p.status==="failed"&&p.next_retry_at&&new Date(p.next_retry_at).getTime()>Date.now()-6e4;return!w}).map(function(p){return p.id}).length>0?`<input type="checkbox" class="erp-log-cb erp-log-cb-all" data-log-select-all title="${escapeHtml(t("erp-log-select-all-tip"))}">`:'<span class="erp-log-cb-spacer"></span>')+`<span class="log-time">${escapeHtml(t("erp-log-col-time"))}</span><span class="log-status">${escapeHtml(t("erp-log-col-status"))}</span><span class="log-tag-header">${escapeHtml(t("erp-log-col-trigger"))}</span><span class="log-invoice">${escapeHtml(t("erp-log-col-invoice"))}</span><span class="log-workspace">${escapeHtml(t("erp-log-col-workspace"))}</span><span class="log-client">${escapeHtml(t("erp-log-col-client"))}</span><span class="log-seller">${escapeHtml(t("erp-log-col-seller"))}</span><span class="log-erp">${escapeHtml(t("erp-log-col-erp"))}</span><span class="log-doc">${escapeHtml(t("erp-log-col-doc"))}</span><span class="log-http">${escapeHtml(t("erp-log-col-http"))}</span><span class="log-elapsed">${escapeHtml(t("erp-log-col-elapsed"))}</span><span class="log-actions"></span></div>`;a.innerHTML=x+f.map(p=>{const w=new Date(p.created_at),h=`${String(w.getMonth()+1).padStart(2,"0")}-${String(w.getDate()).padStart(2,"0")} ${String(w.getHours()).padStart(2,"0")}:${String(w.getMinutes()).padStart(2,"0")}`,B=p.status==="failed"&&p.next_retry_at&&new Date(p.next_retry_at).getTime()>Date.now()-6e4;let S,I,U;p.status==="pending"?(S="retrying",I="⟳",U=t("erp-status-pending")):p.status==="success"?(S="ok",I="✓",U=t("erp-status-success")):p.status==="skipped_dup"?(S="skipped",I="⏭",U=t("erp-status-skipped")):B?(S="retrying",I="↻",U=t("erp-status-retrying")):(S="fail",I="✗",U=t("erp-status-failed"));let N;p.trigger==="auto"?N=`<span class="log-tag auto">${escapeHtml(t("log-tag-auto"))}</span>`:p.trigger==="retry"?N=`<span class="log-tag retry">${escapeHtml(t("log-tag-retry"))}</span>`:N=`<span class="log-tag manual">${escapeHtml(t("log-tag-manual"))}</span>`;let M="";const L=p.retry_count||0,z=p.max_retries||3;if(B){const J=new Date(p.next_retry_at).getTime()-Date.now(),F=Math.max(0,Math.round(J/6e4)),Q=F<=0?t("erp-retry-next-soon"):t("erp-retry-next-min",{n:F});M=`${t("erp-retry-attempt",{n:L,max:z})} · ${Q}`}else p.status==="failed"&&L>=z&&!p.next_retry_at&&(M=t("erp-retry-exhausted",{n:L}));const V=p.status==="failed"&&!B?`<button class="log-retry-btn" data-log-retry="${escapeHtml(p.id)}" title="${escapeHtml(t("log-retry-title"))}">↻</button>`:"",W=!B,P=ye.has(p.id)?"checked":"",u=W?`<input type="checkbox" class="erp-log-cb" data-log-cb="${escapeHtml(p.id)}" ${P}>`:'<span class="erp-log-cb-spacer"></span>',c=(p.ocr_buyer_name||"").trim()||(p.client_name||"").trim(),y=c?`<span class="log-client" title="${escapeHtml(c)}">${escapeHtml(c.substring(0,18))}</span>`:`<span class="log-client log-client-empty" title="${escapeHtml(t("erp-log-client-unassigned-tip"))}">${escapeHtml(t("erp-log-client-unassigned"))}</span>`,$=p.workspace_name?`<span class="log-workspace">${escapeHtml((p.workspace_name||"").substring(0,16))}</span>`:`<span class="log-workspace log-workspace-unresolved" title="${escapeHtml(t("erp-log-ws-unresolved-tip"))}">${escapeHtml(t("erp-log-ws-unresolved"))}</span>`,T=p.endpoint_name?`<span class="log-erp">${escapeHtml((p.endpoint_name||"").substring(0,14))}</span>`:`<span class="log-erp log-erp-deleted">${escapeHtml(t("erp-log-endpoint-deleted"))}</span>`,_=(p.external_doc_no||"").trim(),E=(p.external_url||"").trim();let D;return E?D=`<span class="log-doc"><a href="${escapeHtml(E)}" target="_blank" rel="noopener" class="log-doc-open" title="${escapeHtml(_||"")}">${escapeHtml(t("erp-log-doc-open"))}</a></span>`:_?D=`<span class="log-doc log-doc-copy" data-copy-doc="${escapeHtml(_)}" title="${escapeHtml(t("erp-log-doc-copy-tip"))}">${escapeHtml(_.substring(0,18))}</span>`:p.status==="success"?D=`<span class="log-doc log-doc-missing" title="${escapeHtml(t("erp-log-doc-missing-tip"))}">${escapeHtml(t("erp-log-doc-missing"))}</span>`:D='<span class="log-doc log-doc-empty">-</span>',`
            ...
            `}).join("");const s=new Set(f.map(p=>p.id));for(const p of Array.from(ye))s.has(p)||ye.delete(p);Ne()}catch(n){console.error("load erp logs failed",n),a.innerHTML=`<div class="erp-logs-empty">${escapeHtml(t("erp-logs-error"))}</div>`}}}function Ne(){const e=document.getElementById("erp-logs-batch-bar"),a=document.getElementById("erp-logs-batch-count"),n=document.querySelector("[data-log-select-all]");if(n){const f=document.querySelectorAll("[data-log-cb]").length,g=ye.size;g===0?(n.checked=!1,n.indeterminate=!1):g>=f?(n.checked=!0,n.indeterminate=!1):(n.checked=!1,n.indeterminate=!0)}if(!e||!a)return;const o=ye.size;if(o===0){e.style.display="none";return}e.style.display="",a.textContent=t("erp-batch-selected",{n:o})}async function vt(){console.info("[ErpBatch] retry triggered · selected=",ye.size);const e=Array.from(ye);if(e.length===0){showToast(t("erp-batch-empty-warn"),"warn");return}if(await showConfirm(t("erp-batch-confirm",{n:e.length})))try{const n=await fetch("/api/erp/logs/batch-retry",{method:"POST",headers:{Authorization:"Bearer "+token,"Content-Type":"application/json"},body:JSON.stringify({log_ids:e})});if(!n.ok){showToast(t("erp-logs-error"),"error");return}const o=await n.json(),l=t("erp-batch-result",{ok:o.succeeded||0,fail:o.failed||0,skip:o.skipped||0}),f=o.failed&&o.failed>0?"warn":"success";showToast(l,f),ye.clear(),He()}catch(n){console.error("batch retry failed",n),showToast(t("erp-logs-error"),"error")}}async function Tt(){console.info("[ErpBatch] delete triggered · selected=",ye.size);const e=Array.from(ye);if(e.length===0){showToast(t("erp-batch-empty-warn"),"warn");return}if(await showConfirm(t("erp-batch-delete-confirm",{n:e.length}),{danger:!0}))try{const o=await fetch("/api/erp/logs/batch-delete",{method:"POST",headers:{Authorization:"Bearer "+token,"Content-Type":"application/json"},body:JSON.stringify({log_ids:e})});if(!o.ok){showToast(t("erp-logs-error"),"error");return}const l=await o.json();e.forEach(function(f){var g=document.querySelector('[data-log-detail="'+f+'"]');g&&g.remove()});var n=document.getElementById("erp-logs-batch-bar");n&&(n.style.display="none"),showToast(t("erp-batch-delete-result",{n:l.deleted||0,skip:l.skipped||0}),l.deleted>0?"success":"warn"),ye.clear(),setTimeout(He,500)}catch(o){console.error("batch delete failed",o),showToast(t("erp-logs-error"),"error")}}(function(){function a(){var n=document.getElementById("btn-erp-batch-retry"),o=document.getElementById("btn-erp-batch-delete"),l=document.getElementById("btn-erp-batch-clear");n&&!n.dataset.boundDirect&&(n.addEventListener("click",function(f){f.preventDefault(),f.stopPropagation(),vt()}),n.dataset.boundDirect="1"),o&&!o.dataset.boundDirect&&(o.addEventListener("click",function(f){f.preventDefault(),f.stopPropagation(),Tt()}),o.dataset.boundDirect="1"),l&&!l.dataset.boundDirect&&(l.addEventListener("click",function(f){f.preventDefault(),f.stopPropagation(),ye.clear(),document.querySelectorAll(".erp-log-cb").forEach(function(g){g.checked=!1}),Ne()}),l.dataset.boundDirect="1")}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",a):a(),setTimeout(a,2e3),setTimeout(a,5e3),window._bindErpBatchButtons=a})();async function ot(e){if(e=(e||"").trim(),!!e)try{await navigator.clipboard.writeText(e),showToast(t("erp-doc-copy-ok",{no:e}),"success")}catch{try{const n=document.createElement("textarea");n.value=e,n.style.position="fixed",n.style.opacity="0",document.body.appendChild(n),n.select(),document.execCommand("copy"),n.remove(),showToast(t("erp-doc-copy-ok",{no:e}),"success")}catch{showToast(t("erp-doc-copy-fail"),"error")}}}async function mt(e){const a=document.createElement("div");a.className="log-detail-modal",a.innerHTML=`
        <div class="log-detail-box">
            <div class="log-detail-loading">${escapeHtml(t("log-detail-loading"))}</div>
        </div>
    `,document.body.appendChild(a),a.addEventListener("click",async n=>{if(n.target===a||n.target.classList.contains("log-detail-close")){a.remove();return}const o=n.target.closest("[data-receipt-copy]");if(o){ot(o.dataset.receiptCopy);return}const l=n.target.closest("[data-receipt-action]");if(l){const f=l.dataset.receiptAction;f==="retry"?st(l.dataset.logId):f==="exceptions"?typeof routeTo=="function"&&routeTo("exceptions"):f==="mappings"&&typeof routeTo=="function"&&routeTo("integrations"),a.remove();return}});try{const n=await fetch(`/api/erp/logs/${encodeURIComponent(e)}`,{headers:{Authorization:"Bearer "+token}});if(!n.ok){a.remove();return}const o=await n.json(),l=_e.find(T=>T.id===o.endpoint_id),f=o.endpoint_name||(l?l.name:o.endpoint_id?t("erp-log-endpoint-deleted"):"-"),g=(o.endpoint_adapter||l&&l.adapter||"").toLowerCase(),x=new Date(o.created_at).toLocaleString(),s=o.trigger==="auto"?t("log-tag-auto"):o.trigger==="retry"?t("log-tag-retry"):t("log-tag-manual"),p=o.request_body?JSON.stringify(o.request_body,null,2):t("erp-receipt-no-tech"),w=o.response_body||t("erp-receipt-no-tech"),h=o.status==="success";let B=typeof w=="string"?w:JSON.stringify(w,null,2);if(h)try{const T=typeof o.response_body=="string"?JSON.parse(o.response_body):o.response_body||{},_=T.row_count||(Array.isArray(T.imported_rows)?T.imported_rows.length:0);_>0&&(B=t("log-push-rows").replace("{n}",String(_)))}catch{}const S=(o.external_doc_no||"").trim(),I=(o.external_url||"").trim(),U=(o.external_doc_hint||"").trim(),N=(o.ocr_buyer_name||"").trim()||o.client_name||"-",M=o.seller_name||"-";let L="-";const z=Number(o.total_amount);o.total_amount!=null&&o.total_amount!==""&&!isNaN(z)&&(L=z.toLocaleString("en-US",{minimumFractionDigits:2,maximumFractionDigits:2}));const V=h?t("erp-receipt-title-ok"):t("erp-receipt-title-fail"),W=h?"✓":"✗",P=[],u=(T,_)=>{P.push(`
                <div class="erp-receipt-row">
                    <span class="erp-receipt-key">${escapeHtml(T)}</span>
                    <span class="erp-receipt-val">${_}</span>
                </div>`)};if(u(t("erp-receipt-invoice-no"),`<strong>${escapeHtml(o.invoice_no||"-")}</strong>`),u(t("erp-receipt-erp-name"),escapeHtml(f)),h){let T;S?T=`<strong class="erp-receipt-docno">${escapeHtml(S)}</strong><button class="erp-receipt-copy-btn" type="button" data-receipt-copy="${escapeHtml(S)}" title="${escapeHtml(t("erp-doc-copy-tip"))}">${escapeHtml(t("erp-receipt-copy-btn"))}</button>`:T=`<span class="erp-receipt-docno-missing">${escapeHtml(t("erp-log-doc-missing"))}</span>`,u(t("erp-receipt-doc-no"),T)}u(t("erp-receipt-client"),escapeHtml(N)),u(t("erp-receipt-seller"),escapeHtml(M)),h&&u(t("erp-receipt-amount"),escapeHtml(L)),u(t("erp-receipt-time"),escapeHtml(x)),u(t("erp-receipt-elapsed"),escapeHtml((o.elapsed_ms!=null?o.elapsed_ms:"-")+"ms"));let c="";h&&I?c=`<a class="erp-receipt-primary-btn" href="${escapeHtml(I)}" target="_blank" rel="noopener">${escapeHtml(t("erp-receipt-open-erp"))}</a>`:h&&S&&(c=`<button class="erp-receipt-primary-btn" type="button" data-receipt-copy="${escapeHtml(S)}">${escapeHtml(t("erp-receipt-copy-docno"))}</button>`);let y="";if(h&&S&&U){const T="erp-receipt-hint-"+U,_=t(T);_&&_!==T&&(y=`<div class="erp-receipt-hint"><svg class="erp-receipt-hint-ic" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><circle cx="12" cy="12" r="9"/><line x1="12" y1="11" x2="12" y2="16"/><line x1="12" y1="8" x2="12.01" y2="8"/></svg><span>${escapeHtml(_)}</span></div>`)}let $="";if(!h){const T=(o.error_msg||"").match(/ERR_[A-Z0-9_]+/),_=T?T[0]:"",E=typeof currentLang=="string"&&currentLang||window._currentLang||"th",J=o.error_friendly&&o.error_friendly[E]||(o.error_msg?humanizeError(o.error_msg):t("erp-receipt-no-error")),F=/ERR_NO_CUSTOMER_MAPPING|ERR_NO_CLIENT|ERR_NO_SEED_CUSTOMER|ERR_NO_SEED_PRODUCT/.test(o.error_msg||""),Q=!!(o.history_id&&o.endpoint_id),ie=[];ie.push(`<button class="erp-receipt-action-btn" type="button" data-receipt-action="exceptions">${escapeHtml(t("erp-receipt-act-exceptions"))}</button>`),F&&ie.push(`<button class="erp-receipt-action-btn" type="button" data-receipt-action="mappings">${escapeHtml(t("erp-receipt-act-mapping"))}</button>`),Q&&ie.push(`<button class="erp-receipt-action-btn primary" type="button" data-receipt-action="retry" data-log-id="${escapeHtml(o.id)}">${escapeHtml(t("erp-receipt-act-retry"))}</button>`),$=`
            ...
            <div class="log-detail-head">
                <div class="log-detail-title">
                    <span class="log-detail-status-icon ${h?"ok":"fail"}">${W}</span>
                    ${escapeHtml(V)}
        ...
        `}catch(n){console.error(n),a.remove()}}async function st(e){try{const a=await fetch(`/api/erp/logs/${encodeURIComponent(e)}/retry`,{method:"POST",headers:{Authorization:"Bearer "+token}}),n=await a.json().catch(()=>({}));a.ok&&n.ok?showToast(t("log-retry-ok"),"success"):showToast(t("log-retry-fail")+" · HTTP "+(n.http_status||a.status),"error"),He(),Fe()}catch{showToast(t("log-retry-fail"),"error")}}async function Fe(){try{const e=await fetch("/api/erp/endpoints",{headers:{Authorization:"Bearer "+token}});if(e.status===401){localStorage.removeItem("mrpilot_token");const n=await e.json().catch(()=>({}));if((typeof n.detail=="string"?n.detail:n.detail&&n.detail.code||"")==="auth.session_revoked"){_showSessionRevokedModal();return}window.location.href="/";return}_e=(await e.json()).items||[],window._erpEndpoints=_e,gt()}catch(e){console.error("load endpoints failed",e)}}window._refreshErpEndpointsCache=function(){return Fe()};async function it(){const e=document.getElementById("erp-today-stats");if(e){e.innerHTML="";try{const a=await fetch("/api/erp/stats/today",{headers:{Authorization:"Bearer "+token}});if(!a.ok)return;const n=await a.json(),o=n.total||0,l=n.success||0,f=n.failed||0,g=n.auto_cnt||0;if(o===0){e.innerHTML=`<span class="erp-today-empty">${escapeHtml(t("erp-today-none"))}</span>`;return}const x=[];x.push(`<span class="erp-today-item"><strong>${o}</strong> ${escapeHtml(t("erp-today-total"))}</span>`),l>0&&x.push(`<span class="erp-today-item ok"><strong>${l}</strong> ${escapeHtml(t("erp-today-success"))}</span>`),f>0&&x.push(`<span class="erp-today-item fail"><strong>${f}</strong> ${escapeHtml(t("erp-today-failed"))}</span>`),g>0&&x.push(`<span class="erp-today-item auto"><strong>${g}</strong> ${escapeHtml(t("erp-today-auto"))}</span>`),e.innerHTML=x.join("")}catch(a){console.warn("loadErpTodayStats failed",a)}}}function gt(){const e=document.getElementById("erp-endpoints-list"),a=document.getElementById("erp-status-summary"),n=document.getElementById("btn-add-endpoint");if(!e){console.warn("erp-endpoints-list 容器不存在");return}if(n&&_userInfo){const l=_userInfo.endpoints_limit;l!==-1&&_e.length>=l?(n.disabled=!0,n.title=t("ep-limit-reached",{limit:l}),n.classList.add("btn-disabled-plus")):(n.disabled=!1,n.title="",n.classList.remove("btn-disabled-plus"))}if(_e.length===0){e.innerHTML=`<div class="erp-empty">${escapeHtml(t("ep-list-empty"))}</div>`,a&&(a.textContent=t("auto-status-none"),a.className="auto-status-pill none");return}const o=_e.some(l=>l.auto_push&&l.enabled);if(a&&(a.textContent=t("auto-status-active",{n:_e.length,mode:o?t("auto-status-on"):t("auto-status-off")}),a.className="auto-status-pill "+(o?"active":"ready")),it(),e.innerHTML=_e.map(l=>{const f=l.config||{},g=escapeHtml(f.url||"");f._token_set;const x=l.enabled!==!1,s=[];l.is_default&&s.push(`<span class="ep-badge default">${escapeHtml(t("ep-default"))}</span>`),l.auto_push&&s.push(`<span class="ep-badge auto">${escapeHtml(t("ep-auto-push-on"))}</span>`),x||s.push(`<span class="ep-badge disabled">${escapeHtml(t("ep-disabled"))}</span>`);const p=[];return l.success_count>0&&p.push(`<span class="ep-stat ok">${escapeHtml(t("ep-success",{n:l.success_count}))}</span>`),l.failure_count>0&&p.push(`<span class="ep-stat fail">${escapeHtml(t("ep-failure",{n:l.failure_count}))}</span>`),`
        ...
        `}).join(""),_userInfo&&_userInfo.endpoints_limit!==-1){const l=_e.length,f=_userInfo.endpoints_limit,g=_userInfo.plan,x=document.createElement("div");x.className="erp-limit-hint",g==="free"?x.innerHTML=`${escapeHtml(t("ep-free-limit-hint",{used:l,limit:f}))} <a data-upgrade="plus">${escapeHtml(t("upgrade-to-plus"))}</a>`:x.textContent=t("ep-plus-limit-hint",{used:l,limit:f}),e.appendChild(x)}}function Qe(e){Oe=e||null;const a=document.getElementById("endpoint-modal"),n=document.getElementById("endpoint-modal-title");n.textContent=e?t("ep-modal-title-edit"):t("ep-modal-title-new");const o=document.getElementById("ep-name"),l=document.getElementById("ep-url"),f=document.getElementById("ep-token"),g=document.getElementById("ep-is-default"),x=document.getElementById("ep-auto-push"),s=document.getElementById("ep-test-result");s.style.display="none",s.textContent="";const p=document.getElementById("ep-save-error");if(p&&p.remove(),e){const h=_e.find(B=>B.id===e);if(!h)return;o.value=h.name||"",l.value=(h.config||{}).url||"",f.value=(h.config||{})._token_set&&h.config.token||"",f.placeholder=(h.config||{})._token_set?"（已保存 · 留空保持不变）":t("ep-token-ph"),g.checked=!!h.is_default,x.checked=!!h.auto_push}else o.value="",l.value="",f.value="",f.placeholder=t("ep-token-ph"),g.checked=_e.length===0,x.checked=!0;const w=x.closest(".form-switch-row");if(x.disabled=!1,w){w.classList.remove("disabled-plus"),w.title="",w.style.cursor="",w.onclick=null;const h=w.querySelector(".plus-badge");h&&h.remove()}a.style.display="",setTimeout(()=>o.focus(),50)}function Ge(){document.getElementById("endpoint-modal").style.display="none",Oe=null;const e=document.getElementById("ep-save-error");e&&e.remove()}function ht(e){if(!e)return"";let a=e.trim();const n=a.search(/\s/);return n>=0&&(a=a.slice(0,n)),a}function bt(){const e=document.getElementById("ep-name").value.trim(),a=ht(document.getElementById("ep-url").value),n=document.getElementById("ep-token").value,o=document.getElementById("ep-is-default").checked,l=document.getElementById("ep-auto-push").checked,f={url:a};return n&&(f.token=n),{name:e,url:a,tokenVal:n,isDefault:o,autoPush:l,config:f}}async function yt(){const{url:e,config:a}=bt(),n=document.getElementById("ep-test-result");if(!e){n.style.display="",n.className="form-test-result fail",n.textContent=t("ep-required");return}n.style.display="",n.className="form-test-result running",n.textContent=t("ep-test-running");try{const l=await(await fetch("/api/erp/test-connection",{method:"POST",headers:{Authorization:"Bearer "+token,"Content-Type":"application/json"},body:JSON.stringify({adapter:"webhook",config:a})})).json();l.success?(n.className="form-test-result ok",n.textContent=t("ep-test-ok",{status:l.http_status,ms:l.elapsed_ms})):(n.className="form-test-result fail",n.textContent=t("ep-test-fail",{err:l.error_msg||"unknown"}))}catch(o){n.className="form-test-result fail",n.textContent=t("ep-test-fail",{err:o.message})}}async function wt(){const e=bt(),a=document.getElementById("ep-save-error");if(a&&(a.style.display="none"),!e.name||!e.url){dt(t("ep-required"));return}const n={name:e.name,adapter:"webhook",config:e.config,is_default:e.isDefault,auto_push:e.autoPush},o=document.getElementById("btn-ep-save"),l=o.innerHTML;o.disabled=!0,o.classList.add("loading");try{let f;if(Oe?f=await fetch(`/api/erp/endpoints/${encodeURIComponent(Oe)}`,{method:"PATCH",headers:{Authorization:"Bearer "+token,"Content-Type":"application/json"},body:JSON.stringify(n)}):f=await fetch("/api/erp/endpoints",{method:"POST",headers:{Authorization:"Bearer "+token,"Content-Type":"application/json"},body:JSON.stringify(n)}),!f.ok){const x=(await f.json().catch(()=>({}))).detail||`HTTP ${f.status}`;throw new Error(typeof x=="string"?x:JSON.stringify(x))}Ge(),showToast(t("ep-save-ok")),Fe()}catch(f){dt(`${t("ep-save-fail")} · ${f.message||"unknown"}`)}finally{o.disabled=!1,o.classList.remove("loading"),o.innerHTML=l}}function dt(e){let a=document.getElementById("ep-save-error");if(!a){const n=document.querySelector("#endpoint-modal .modal-foot");if(!n)return;a=document.createElement("div"),a.id="ep-save-error",a.className="ep-inline-error",n.parentNode.insertBefore(a,n)}a.textContent=e,a.style.display=""}async function kt(e){const a=_e.find(o=>o.id===e);if(!(!a||!await showConfirm(t("ep-delete-confirm",{name:a.name}),{danger:!0})))try{if(!(await fetch(`/api/erp/endpoints/${encodeURIComponent(e)}`,{method:"DELETE",headers:{Authorization:"Bearer "+token}})).ok)throw new Error;showToast(t("ep-delete-ok")),Fe()}catch{showToast(t("ep-save-fail"),"fail")}}(function(){document.getElementById("btn-add-endpoint").addEventListener("click",()=>Qe(null)),document.getElementById("endpoint-modal-close").addEventListener("click",Ge),document.getElementById("btn-ep-cancel").addEventListener("click",Ge),document.getElementById("btn-ep-test").addEventListener("click",yt),document.getElementById("btn-ep-save").addEventListener("click",wt),document.getElementById("ep-url").addEventListener("blur",a=>{const n=ht(a.target.value);n!==a.target.value.trim()&&(a.target.value=n)}),document.addEventListener("click",a=>{const n=a.target.closest("[data-ep-edit]"),o=a.target.closest("[data-ep-del]");n&&Qe(n.dataset.epEdit),o&&kt(o.dataset.epDel);const l=a.target.closest("[data-log-retry]");if(l){a.stopPropagation(),st(l.dataset.logRetry);return}const f=a.target.closest("[data-log-cb]");if(f){a.stopPropagation();const w=f.dataset.logCb;f.checked?ye.add(w):ye.delete(w),Ne();return}const g=a.target.closest("[data-log-select-all]");if(g){a.stopPropagation();const w=g.checked;document.querySelectorAll("[data-log-cb]").forEach(function(B){B.checked=w;const S=B.dataset.logCb;w?ye.add(S):ye.delete(S)}),Ne();return}if(a.target.closest("#btn-erp-batch-retry")){a.stopPropagation(),vt();return}if(a.target.closest("#btn-erp-batch-clear")){a.stopPropagation(),ye.clear(),document.querySelectorAll(".erp-log-cb").forEach(w=>{w.checked=!1}),Ne();return}const x=a.target.closest("[data-log-detail]");if(x){if(a.target.closest("[data-log-cb]"))return;const w=a.target.closest("[data-copy-doc]");if(w){a.stopPropagation(),ot(w.dataset.copyDoc);return}if(a.target.closest(".log-doc-open"))return;mt(x.dataset.logDetail);return}const s=a.target.closest(".chip-filter");if(s){document.querySelectorAll("#erp-logs-filters .chip-filter").forEach(w=>w.classList.remove("active")),s.classList.add("active"),Me={key:s.dataset.filterKey,val:s.dataset.filterVal},He();return}if(a.target.closest("#btn-refresh-logs")){const w=a.target.closest("#btn-refresh-logs");w.classList.add("spinning"),setTimeout(()=>w.classList.remove("spinning"),600),He();return}const p=a.target.closest(".auto-nav-item");if(p&&p.dataset.autoTab){switchAutomationTab(p.dataset.autoTab);return}})})();window.loadErpLogs=He;window.loadErpEndpoints=Fe;window.loadErpTodayStats=it;window.renderErpEndpointsList=gt;window.showLogDetail=mt;window.retryPushLog=st;window.copyErpDocNo=ot;window.openEndpointModal=Qe;window.closeEndpointModal=Ge;window.saveEndpoint=wt;window.deleteEndpoint=kt;window.testEndpointConnection=yt;(function(){let e=null,a=!1;function n(){if(e)return e;const x=document.createElement("div");x.id="line-email-modal",x.style.cssText="position:fixed;inset:0;background:rgba(10,14,39,0.85);z-index:99999;display:flex;align-items:center;justify-content:center;padding:20px;",x.innerHTML=`
        ...
        `,document.body.appendChild(x),e=x;const s=x.querySelector("#line-email-input"),p=x.querySelector("#line-email-submit-btn"),w=x.querySelector("#line-email-err");async function h(){w.textContent="";const B=(s.value||"").trim().toLowerCase();if(!B||B.indexOf("@")<0||B.split("@")[1].indexOf(".")<0){w.textContent=t("line-email-err-invalid");return}p.disabled=!0,p.style.opacity="0.6";try{const S=await fetch("/api/me/line_complete_email",{method:"POST",headers:{"Content-Type":"application/json",Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||"")},body:JSON.stringify({email:B})});if(!S.ok)throw new Error("http_"+S.status);const I=await S.json();I.token&&localStorage.setItem("mrpilot_token",I.token),typeof showToast=="function"&&showToast(I.merged?t("line-email-merged-toast"):t("line-email-saved-toast"),"success"),setTimeout(function(){window.location.reload()},600)}catch{w.textContent=t("line-email-err-failed"),p.disabled=!1,p.style.opacity="1"}}return p.addEventListener("click",h),s.addEventListener("keydown",function(B){B.key==="Enter"&&h()}),x}function o(){if(!e)return;const x=e.querySelector("#line-email-title-h"),s=e.querySelector("#line-email-sub-p"),p=e.querySelector("#line-email-input"),w=e.querySelector("#line-email-submit-btn");x&&(x.textContent=t("line-email-title")),s&&(s.textContent=t("line-email-sub")),p&&(p.placeholder=t("line-email-placeholder")),w&&(w.textContent=t("line-email-submit"))}function l(){n(),o(),e.style.display="flex",a=!0;const x=e.querySelector("#line-email-input");x&&setTimeout(function(){x.focus()},100)}async function f(){const x=localStorage.getItem("mrpilot_token");if(x)try{const s=await fetch("/api/me/needs_email",{headers:{Authorization:"Bearer "+x}});if(!s.ok)return;const p=await s.json();p&&p.needs_email&&l()}catch{}}function g(){setTimeout(f,800)}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",g):g(),typeof window.subscribeI18n=="function"&&window.subscribeI18n("line-email-modal",function(){a&&o()})})();(function(){function e(x){let s=0;return x.length>=8&&s++,x.length>=12&&s++,/[a-zA-Z]/.test(x)&&/\d/.test(x)&&s++,/[^a-zA-Z0-9]/.test(x)&&s++,Math.min(3,s)}function a(x,s){const p=document.getElementById("cpw-msg");p&&(p.textContent=x,p.className="cpw-msg "+(s||""))}function n(x){return typeof t=="function"?t(x):x}function o(){const x=["cpw-old","cpw-new","cpw-confirm"];x.forEach(B=>{const S=document.getElementById(B);S&&(S.value="",S.setAttribute("readonly","readonly"),S.addEventListener("focus",function(){this.removeAttribute("readonly")}))}),document.querySelectorAll('.settings-nav-item[data-settings-tab="account"]').forEach(B=>{B.addEventListener("click",()=>{setTimeout(()=>{x.forEach(I=>{const U=document.getElementById(I);U&&(U.value="",U.setAttribute("readonly","readonly"))});const S=document.getElementById("cpw-strength-bar");S&&(S.style.width="0%",S.className="cpw-strength-bar"),a("","")},100)})}),document.querySelectorAll(".cpw-eye").forEach(B=>{B.addEventListener("click",()=>{const S=B.dataset.target,I=document.getElementById(S);I&&(I.type=I.type==="password"?"text":"password")})});const s=document.getElementById("cpw-new"),p=document.getElementById("cpw-strength-bar");s&&p&&s.addEventListener("input",()=>{const B=e(s.value),S=["0%","33%","66%","100%"],I=["","weak","medium","strong"];p.style.width=S[B],p.className="cpw-strength-bar "+I[B]});const w=document.getElementById("cpw-forgot-link");w&&w.addEventListener("click",()=>l());const h=document.getElementById("btn-change-pw");h&&h.addEventListener("click",async()=>{const B=document.getElementById("cpw-old"),S=document.getElementById("cpw-new"),I=document.getElementById("cpw-confirm");if(!B||!S||!I)return;const U=B.value,N=S.value,M=I.value;if(!U||!N||!M){a(n("settings-change-pw-empty"),"error");return}if(N.length<8){a(n("settings-change-pw-too-short"),"error");return}if(!(/[a-zA-Z]/.test(N)&&/\d/.test(N))){a(n("settings-change-pw-too-weak"),"error");return}if(N!==M){a(n("settings-change-pw-mismatch"),"error");return}h.disabled=!0;const L=h.textContent;h.textContent=n("settings-change-pw-submitting"),a("","");try{const z=localStorage.getItem("mrpilot_token"),V=await fetch("/api/me/change_password",{method:"POST",headers:{"Content-Type":"application/json",Authorization:"Bearer "+z},body:JSON.stringify({old_password:U,new_password:N})}),W=await V.json().catch(()=>({}));if(V.ok&&W.ok)a(n("settings-change-pw-success"),"success"),typeof showToast=="function"&&showToast(n("settings-change-pw-success"),"success"),B.value="",S.value="",I.value="",p&&(p.style.width="0%",p.className="cpw-strength-bar");else{const P=W.detail||"";let u=n("settings-change-pw-success");P==="wrong_old_password"?u=n("settings-change-pw-wrong-old"):P==="password_too_short"?u=n("settings-change-pw-too-short"):P==="password_too_weak"?u=n("settings-change-pw-too-weak"):u=P||"Error",a(u,"error")}}catch(z){console.error("change_password",z),a("Network error","error")}finally{h.disabled=!1,h.textContent=L}})}function l(){const x=window._userInfo||(typeof _userInfo<"u"?_userInfo:null),s=x&&x.username?x.username:"",p=f(s);let w=document.getElementById("cpw-forgot-overlay");w&&w.remove(),w=document.createElement("div"),w.id="cpw-forgot-overlay",w.className="cpw-forgot-overlay",w.innerHTML=`
            <div class="cpw-forgot-modal">
                <div class="cpw-forgot-head">
                    <div class="cpw-forgot-title">${g(n("cpw-forgot-title"))}</div>
                ...
                <div class="cpw-forgot-body">
                    <p class="cpw-forgot-desc">${g(n("cpw-forgot-desc"))}</p>
                    <div class="cpw-forgot-email">${g(p)}</div>
                    <p class="cpw-forgot-tip">${g(n("cpw-forgot-tip"))}</p>
                    <div class="cpw-forgot-msg" id="cpw-forgot-msg"></div>
                </div>
                <div class="cpw-forgot-foot">
                    <button class="btn btn-ghost" id="cpw-forgot-cancel">${g(n("cpw-forgot-cancel"))}</button>
                    <button class="btn btn-primary" id="cpw-forgot-send">${g(n("cpw-forgot-send"))}</button>
                </div>
            </div>
        `,document.body.appendChild(w);const h=()=>w.remove();w.querySelector("#cpw-forgot-close").addEventListener("click",h),w.querySelector("#cpw-forgot-cancel").addEventListener("click",h),w.addEventListener("click",B=>{B.target===w&&h()}),w.querySelector("#cpw-forgot-send").addEventListener("click",async()=>{const B=w.querySelector("#cpw-forgot-send"),S=w.querySelector("#cpw-forgot-msg");B.disabled=!0;const I=B.textContent;B.textContent=n("cpw-forgot-sending");try{const U=await fetch("/api/auth/forgot_password",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:s})}),N=await U.json().catch(()=>({}));U.ok?(S.textContent=n("cpw-forgot-success"),S.className="cpw-forgot-msg success",B.style.display="none",w.querySelector("#cpw-forgot-cancel").textContent=n("cpw-forgot-close-btn")):(S.textContent=N.detail||n("cpw-forgot-fail"),S.className="cpw-forgot-msg error",B.disabled=!1,B.textContent=I)}catch{S.textContent=n("cpw-forgot-fail"),S.className="cpw-forgot-msg error",B.disabled=!1,B.textContent=I}})}function f(x){if(!x||!x.includes("@"))return x||"";const[s,p]=x.split("@");return s.length<=2?s+"****@"+p:s.slice(0,2)+"****@"+p}function g(x){return x==null?"":String(x).replace(/[&<>"']/g,s=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[s])}document.readyState==="complete"||document.readyState==="interactive"?o():document.addEventListener("DOMContentLoaded",o)})();(function(){let e=null,a=!1;async function n(){if(a)return;const l=localStorage.getItem("mrpilot_token");if(l){a=!0;try{const f=await fetch("/api/me",{headers:{Authorization:"Bearer "+l},cache:"no-store"});if(f.status===401){const g=await f.json().catch(()=>({})),x=g&&g.detail;let s="";if(typeof x=="string"?s=x:x&&typeof x=="object"&&(s=x.code||""),console.warn("[heartbeat] session revoked",s),localStorage.removeItem("mrpilot_token"),e&&(clearInterval(e),e=null),s==="auth.session_revoked")try{_showSessionRevokedModal()}catch{window.location.href="/"}else{const p=s==="auth.password_changed_relogin"?"alert-password-changed-relogin":"alert-session";try{typeof showToast=="function"&&typeof t=="function"?showToast(t(p),"error"):alert("Session expired")}catch{}setTimeout(()=>{window.location.href="/"},1500)}}}catch{}finally{a=!1}}}function o(){e&&clearInterval(e),e=setInterval(n,15e3)}localStorage.getItem("mrpilot_token")&&o(),window.addEventListener("focus",n),document.addEventListener("visibilitychange",function(){document.hidden||n()}),window._sessionCheck=n})();async function Ye(){const e=document.getElementById("team-loading"),a=document.getElementById("team-list"),n=document.getElementById("team-empty"),o=document.getElementById("team-count");if(a){e&&(e.style.display=""),a.style.display="none",n&&(n.style.display="none");try{const l=await apiGet("/api/team/employees"),f=l&&l.employees||[];if(e&&(e.style.display="none"),o&&(o.textContent=(t("team-count")||"共 {n} 名员工").replace("{n}",f.length)),f.length===0){n&&(n.style.display="");return}a.style.display="",a.innerHTML=f.map(g=>{const x=g.last_login_at?new Date(g.last_login_at).toLocaleDateString():t("team-never-login")||"从未登录",s=g.is_active===!1?"team-status-off":"team-status-on",p=g.is_active===!1?t("team-status-disabled")||"已禁用":t("team-status-active")||"正常",w=g.email?`<span class="team-meta-sep">·</span><span>${escapeHtml(g.email)}</span>`:"";return`
            <div class="team-card" data-employee-id="${escapeHtml(g.id)}">
                <div class="team-card-main">
                    <div class="team-avatar">${escapeHtml((g.username||"?")[0].toUpperCase())}</div>
                    <div class="team-info">
                        <div class="team-name">${escapeHtml(g.username||"")}</div>
                        <div class="team-meta">
                            ...
                            ${w}
                            <span class="team-meta-sep">·</span>
                            <span>${escapeHtml((t("team-assigned-clients")||"已分配 {n} 客户").replace("{n}",g.assigned_client_count||0))}</span>
                        </div>
                    </div>
                </div>
                <div class="team-card-actions">
                    <button class="btn btn-ghost btn-small" data-assign-clients="${escapeHtml(g.id)}" data-name="${escapeHtml(g.username||"")}">
                        ${escapeHtml(t("team-assign-clients")||"分配客户")}
                    </button>
                    <button class="btn btn-ghost btn-small" data-reset-pwd-employee="${escapeHtml(g.id)}" data-name="${escapeHtml(g.username||"")}" title="${escapeHtml(t("team-reset-pwd")||"重置密码")}">
                        ${escapeHtml(t("team-reset-pwd")||"重置密码")}
                    </button>
                    <button class="btn btn-ghost btn-small" data-toggle-employee="${escapeHtml(g.id)}" data-active="${g.is_active===!1?"false":"true"}">
                        ${escapeHtml(g.is_active===!1?t("team-enable")||"启用":t("team-disable")||"禁用")}
                    </button>
                    <button class="btn btn-ghost btn-small btn-danger-text" data-remove-employee="${escapeHtml(g.id)}" data-name="${escapeHtml(g.username||"")}">
                        ${escapeHtml(t("team-remove")||"移除")}
                    </button>
                </div>
            </div>`}).join("")}catch(l){console.error("loadTeamList failed:",l),e&&(e.textContent=t("team-load-failed")||"加载失败")}}}async function Mt(){document.querySelectorAll(".add-emp-overlay").forEach(o=>o.remove());const e=document.createElement("div");e.className="add-emp-overlay",e.innerHTML=`
    ...
    `,document.body.appendChild(e),requestAnimationFrame(()=>e.classList.add("show")),setTimeout(()=>{const o=document.getElementById("add-emp-username");o&&o.focus()},200);function a(){e.classList.remove("show"),setTimeout(()=>e.remove(),220)}e.querySelector(".add-emp-close").addEventListener("click",a),e.querySelector("#add-emp-cancel").addEventListener("click",a),e.addEventListener("click",o=>{o.target===e&&a()}),e.querySelector("#add-emp-submit").addEventListener("click",async()=>{const o=document.getElementById("add-emp-username"),l=document.getElementById("add-emp-email"),f=document.getElementById("add-emp-password"),g=document.getElementById("add-emp-msg"),x=document.getElementById("add-emp-submit"),s=(o.value||"").trim(),p=(l.value||"").trim(),w=f.value||"";if(g.textContent="",g.classList.remove("error"),!s||s.length<3){g.textContent=t("team-modal-err-username")||"用户名至少 3 位",g.classList.add("error");return}if(!/^[a-zA-Z0-9_.\-]+$/.test(s)){g.textContent=t("team-modal-err-username-fmt")||"只能用字母 / 数字 / 下划线 / 点 / 横线",g.classList.add("error");return}if(p&&!/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(p)){g.textContent=t("msg-email-invalid")||"邮箱格式不对",g.classList.add("error");return}if(w.length<8){g.textContent=t("pwd-too-short")||"密码至少 8 位",g.classList.add("error");return}if(/^\d+$/.test(w)){g.textContent=t("pwd-too-weak-numeric")||"不能是纯数字 · 请加入字母",g.classList.add("error");return}if(!(/[a-zA-Z]/.test(w)&&/\d/.test(w))){g.textContent=t("pwd-too-weak")||"密码至少 8 位 · 字母 + 数字",g.classList.add("error");return}x.disabled=!0,x.textContent=t("msg-saving")||"保存中...";try{const h={username:s,password:w};p&&(h.email=p);const B=await apiPost("/api/team/employees",h),S=B?await B.json().catch(()=>({})):{};if(B&&B.ok&&S&&S.ok){showToast(t("team-added")||"员工已添加","success"),a(),Ye();return}const I=S&&S.detail||"unknown",U={"team.username_exists":t("team-username-exists")||"用户名已被占用","team.email_exists":t("team-email-exists")||"邮箱已被占用","team.create_failed":t("team-create-failed")||"创建失败","team.only_owner_or_super":t("team-no-permission")||"无权限","team.no_tenant":t("team-no-tenant")||"请先升级账号","pwd.too_short":t("pwd-too-short")||"密码至少 8 位","pwd.too_weak_numeric":t("pwd-too-weak-numeric")||"不能是纯数字","pwd.too_weak_common":t("pwd-too-weak-common")||"这个密码太常见 · 请换一个","pwd.too_weak":t("pwd-too-weak")||"密码至少 8 位 · 字母 + 数字"};g.textContent=U[I]||(t("team-create-failed")||"创建失败")+" ("+I+")",g.classList.add("error")}catch{g.textContent=t("team-create-failed")||"创建失败",g.classList.add("error")}finally{x.disabled=!1,x.textContent=t("team-add")||"添加员工"}});function n(o){o.key==="Escape"&&(a(),document.removeEventListener("keydown",n))}document.addEventListener("keydown",n)}async function $t(e,a){try{if((await fetch(`/api/team/employees/${encodeURIComponent(e)}/active`,{method:"PATCH",headers:{Authorization:"Bearer "+token,"Content-Type":"application/json"},body:JSON.stringify({is_active:!!a})})).ok){Ye();return}showToast(t("team-toggle-failed")||"操作失败","error")}catch{showToast(t("team-toggle-failed")||"操作失败","error")}}async function Ht(e,a){const o=(t("team-confirm-remove")||"确认移除员工「{name}」?他的所有识别记录会保留 · 但他将无法登录").replace("{name}",a).replace("{n}",a);if(await showConfirm(o,{danger:!0,okText:t("team-remove")}))try{if((await fetch(`/api/team/employees/${encodeURIComponent(e)}`,{method:"DELETE",headers:{Authorization:"Bearer "+token}})).ok){showToast(t("team-removed")||"已移除","success"),Ye();return}showToast(t("team-remove-failed")||"移除失败","error")}catch{showToast(t("team-remove-failed")||"移除失败","error")}}async function At(e,a){const o=(t("team-reset-pwd-confirm")||"给员工「{name}」发送改密链接?系统将通过员工的邮箱或 LINE 发送一个 15 分钟内有效的链接 · 员工自己点链接改密码 · 您看不到密码").replace("{name}",a).replace("{n}",a);if(await showConfirm(o,{okText:t("team-reset-link-send-btn")||"发送链接"}))try{const f=await fetch(`/api/team/employees/${encodeURIComponent(e)}/reset-password`,{method:"POST",headers:{Authorization:"Bearer "+token}}),g=await f.json().catch(()=>({}));if(f.status===400&&g.detail==="team.reset_no_channel"){showToast(t("team-reset-no-channel")||"员工尚未绑定邮箱或 LINE · 请先帮员工补充邮箱再重置","error");return}if(!f.ok){showToast(t("team-reset-pwd-fail")||"发送失败","error");return}if(g.channel==="line"||g.channel==="email"){const x=t("team-reset-link-sent")||"改密链接已通过 {ch} 发送给员工 · 链接 15 分钟内有效",s=g.channel==="line"?"LINE":t("team-reset-via-email")||"邮箱";showToast(x.replace("{ch}",s),"success");return}showToast(t("team-reset-pwd-fail")||"发送失败","error")}catch{showToast(t("team-reset-pwd-fail")||"发送失败","error")}}document.addEventListener("click",e=>{if(e.target.closest("#btn-add-employee")){e.preventDefault(),Mt();return}const a=e.target.closest("[data-toggle-employee]");if(a){e.preventDefault(),$t(a.dataset.toggleEmployee,a.dataset.active==="false");return}const n=e.target.closest("[data-remove-employee]");if(n){e.preventDefault(),Ht(n.dataset.removeEmployee,n.dataset.name||"");return}const o=e.target.closest("[data-reset-pwd-employee]");if(o){e.preventDefault(),At(o.dataset.resetPwdEmployee,o.dataset.name||"");return}const l=e.target.closest("[data-assign-clients]");if(l){e.preventDefault(),typeof window.openAssignClientsModal=="function"&&window.openAssignClientsModal(l.dataset.assignClients,l.dataset.name||"");return}});window.loadTeamList=Ye;function jt(e){document.querySelectorAll(".auto-nav-item").forEach(a=>{a.classList.toggle("active",a.dataset.autoTab===e)}),document.querySelectorAll(".auto-panel").forEach(a=>{a.classList.toggle("active",a.dataset.autoPanel===e)}),e==="email"&&typeof window._loadEmailIngestPanel=="function"?(window._loadEmailIngestPanel(),typeof window._startEmailLogAutoRefresh=="function"&&window._startEmailLogAutoRefresh()):typeof window._stopEmailLogAutoRefresh=="function"&&window._stopEmailLogAutoRefresh(),e==="bank"&&typeof window._loadBankReconPanel=="function"&&window._loadBankReconPanel(),e==="linebot"&&typeof window._loadLineBotPanel=="function"&&window._loadLineBotPanel(),e==="alert"&&typeof window._loadNotificationsPanel=="function"&&window._loadNotificationsPanel(),e==="folder"&&typeof window._loadFolderWatcherPanel=="function"&&window._loadFolderWatcherPanel()}window.switchAutomationTab=jt;typeof console<"u"&&typeof console.info=="function"&&console.info("[pearnly] vite bundle loaded · dashboard + billing + test-center + workspace-switcher + recon-center + assign-clients + access-log + notifications + recon-batch + welcome-wizard + archive-settings");
