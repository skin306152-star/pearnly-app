...
`,e.dataset.wbInjected="1";try{const n=window._currentLang||localStorage.getItem("mrpilot_lang")||"th",a=window.I18N;a&&a[n]&&e.querySelectorAll("[data-i18n]").forEach(o=>{const s=o.getAttribute("data-i18n");a[n][s]&&(o.textContent=a[n][s])})}catch{}}})();function zn(e,n){const a=document.getElementById("alert-"+e);a&&(document.getElementById("alert-"+e+"-text").textContent=n,a.classList.add("show"))}function Fn(){["info","warn","error"].forEach(e=>{document.getElementById("alert-"+e).classList.remove("show")})}function On(e,n){if(e==null)return n||"操作失败";if(typeof e=="string")return e;if(Array.isArray(e)){const a=e[0]||{};return a.msg?a.msg:n||"请求格式错误"}if(typeof e=="object"){if(e.code){const a="err."+e.code;try{const o=t(a,e);if(o&&o!==a)return o}catch(o){console.warn("[i18n] t() failed for key:",a,o)}return e.code}if(e.message)return e.message;if(e.error)return e.error;if(e.detail&&typeof e.detail=="string")return e.detail;try{return JSON.stringify(e).slice(0,160)}catch{}}return n||String(e)}function Vn(e){if(!e)return"";const n=String(e);return/ECONNREFUSED|Connection refused/i.test(n)?"连接被拒绝 · ERP 地址可能错了,或服务没启动":/listing fetch failed|wait_for_selector/i.test(n)?"拉取 MR.ERP 客户/商品列表超时 · 已重试 3 次仍不通 · 可能 MR.ERP 响应慢 · 稍后再试":/ETIMEDOUT|timeout/i.test(n)?"连接超时 · MR.ERP 响应慢 · 稍后再试":/ENOTFOUND|getaddrinfo/i.test(n)?"域名解析失败 · ERP 地址拼错了":/certificate|SSL/i.test(n)?"SSL 证书问题 · ERP 站点证书异常":/401|Unauthorized/i.test(n)?"HTTP 401 · 认证失败,检查 Token 是否正确":/403|Forbidden/i.test(n)?"HTTP 403 · 权限不足,ERP 拒绝访问":/404|Not Found/i.test(n)?"HTTP 404 · URL 路径不存在":/^5\d\d/.test(n)||/500|502|503|504/.test(n)?"ERP 服务器错误 · 不是你的问题,等会儿再试":n}function Un(e,n,a){let o=document.getElementById("mp-toast-wrap");o||(o=document.createElement("div"),o.id="mp-toast-wrap",document.body.appendChild(o)),n=n||"success",n==="ok"&&(n="success"),n==="warning"&&(n="warn"),n==="danger"&&(n="error");const s={success:'<path d="M3 8l3 3 7-7"/>',error:'<circle cx="8" cy="8" r="6"/><path d="M5.5 5.5l5 5M10.5 5.5l-5 5"/>',warn:'<path d="M8 2L1.5 13h13L8 2z"/><path d="M8 7v3M8 12v.01"/>',info:'<circle cx="8" cy="8" r="6"/><path d="M8 5.5v.01M8 8v3"/>',loading:'<path d="M8 1a7 7 0 017 7" stroke-linecap="round" class="mp-toast-spin"/>'},i=document.createElement("div");i.className="mp-toast "+n,i.innerHTML=`
    ...
    `}window.switchSettingsTab=Kn;window.fillSettingsForms=Jn;window.saveProfile=Yn;window.saveCompany=Wn;window.renderSettings=vt;function nt(e){return e=e||_userInfo,!!(e&&e.is_super_admin)}function kt(e){return e=e||_userInfo,!!e&&(e.role==="owner"||nt(e))}function Ot(e){return e=e||_userInfo,!!e&&e.role==="member"&&!nt(e)}function Zn(e){return e=e||_userInfo,!!e&&(e.effective_plan==="trial"||e.plan==="trial")&&!nt(e)}function Vt(e){return e=e||_userInfo,!!e&&e.tenant_type==="byo_api"}function Ut(e){return Ot(e)}function Qn(e){return kt(e)}function ea(e){return kt(e)&&Vt(e)}window.isMoneyHidden=Ut;window.isSuperAdmin=nt;window.isOwner=kt;window.isEmployee=Ot;window.isTrial=Zn;window.isLifetime=Vt;window.shouldHideMoney=Ut;window.canManageTeam=Qn;window.canManageApiKey=ea;function ta(){const e=document.getElementById("quota-banner");if(!e)return;if(!_userInfo){e.style.display="none";return}if(_userInfo.is_super_admin||_userInfo.tenant_type==="admin"||_userInfo.tenant_type==="byo_api"){e.style.display="none";return}let n=0,a=0;if(_userInfo.plan==="free"&&_quota&&_quota.ip_daily_limit)n=_quota.ip_used_today||0,a=_quota.ip_daily_limit;else if(_userInfo.tenant_quota!=null&&_userInfo.tenant_quota>0)n=_userInfo.tenant_used||0,a=_userInfo.tenant_quota;else if(_userInfo.monthly_quota&&_userInfo.monthly_quota>0)n=_userInfo.used_this_month||0,a=_userInfo.monthly_quota;else{e.style.display="none";return}if(a<=0){e.style.display="none";return}const o=Math.max(0,a-n),s=n/a*100,i="quota_banner_dismiss_"+new Date().toISOString().slice(0,10);if(localStorage.getItem(i)){e.style.display="none";return}let r,p;if(o===0)r="danger",p=t("quota-banner-exhausted");else if(s>=90)r="danger",p=t("quota-banner-very-low",{n:o});else if(s>=70)r="warn",p=t("quota-banner-low",{n:o});else{e.style.display="none";return}e.className="quota-banner "+r,e.innerHTML=`
    ...
    `,d=i?"":`<span class="tax-badge unverified" data-tip="${escapeHtml(t("tax-tip-unverified"))}">${t("tax-unverified")}</span>`;if(p.innerHTML=`
        ...
        <div class="drawer-section">
            ...
            ${r.wht_amount||r.wht_rate?`
                ${ye("wht_amount","drawer-lbl-wht-amount",r.wht_amount,"input",s,da(r.wht_rate))}
            `:""}
        </div>
        ...
        <div class="drawer-section">
            ...
            ${ye("seller_tax","drawer-lbl-tax",r.seller_tax,"input",s,d,At("seller"))}
        ...
        <div class="drawer-section">
            ...
            ${ye("buyer_tax","drawer-lbl-tax",r.buyer_tax,"input",s,d,At("buyer"))}
...
`))}</pre>
    ...
    `;n.innerHTML=o+s,e.appendChild(n)}function pt(){const e=document.getElementById("export-dropdown");e&&e.remove()}const ut=document.getElementById("btn-export-arrow");ut&&ut.addEventListener("click",e=>{e.stopPropagation(),!ut.disabled&&ga()});document.addEventListener("click",e=>{const n=e.target.closest(".export-dd-item");if(n){const a=n.getAttribute("data-tpl");if(a==="__custom"){pt(),showToast(t("cs-coming-soon"),"info");return}ha(a),pt(),Qt(a);return}e.target.closest("#btn-export-arrow")||pt()});function ba(){const e=document.getElementById("btn-export-arrow"),n=document.getElementById("btn-export");e&&n&&(e.disabled=n.disabled)}setInterval(ba,300);const ya=`
        <div class="page-head-clean">
            <div class="page-head-icon">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
...
`;(function(){const e=document.getElementById("page-history");if(!(!e||e.dataset.wbInjected==="1")){e.innerHTML=ya,e.dataset.wbInjected="1";try{const n=window._currentLang||localStorage.getItem("mrpilot_lang")||"th",a=window.I18N;a&&a[n]&&(e.querySelectorAll("[data-i18n]").forEach(o=>{const s=o.getAttribute("data-i18n");a[n][s]&&(o.textContent=a[n][s])}),e.querySelectorAll("[data-i18n-placeholder]").forEach(o=>{const s=o.getAttribute("data-i18n-placeholder");a[n][s]&&(o.placeholder=a[n][s])}))}catch{}}})();function _t(){const e=document.getElementById("history-batch-bar"),n=document.getElementById("history-batch-count"),a=document.getElementById("history-check-all");if(!e||!n)return;const o=_historySelected.size;if(o>0?(e.style.display="",n.textContent=t("history-batch-count",{n:o})):e.style.display="none",a){const s=_historyState.items||[];if(s.length===0)a.checked=!1,a.indeterminate=!1;else{const i=s.filter(r=>_historySelected.has(r.id)).length;a.checked=i===s.length,a.indeterminate=i>0&&i<s.length}}}function wa(){_historySelected.clear(),_t()}async function xt(){if(!_userInfo){setTimeout(()=>xt(),300);return}const e=document.getElementById("history-free-block"),n=document.getElementById("history-main"),a=document.getElementById("history-empty");if(!e||!n||!a){console.warn("[History] container missing");return}if(!_userInfo.can_view_history){e.style.display="",n.style.display="none",a.style.display="none";return}e.style.display="none",_historyState.loading=!0;try{const o=_historyState.page*_historyState.pageSize,s=new URLSearchParams({limit:_historyState.pageSize,offset:o});_historyState.keyword&&s.set("keyword",_historyState.keyword);const i=typeof window.getCurrentClientId=="function"?window.getCurrentClientId():null;i&&s.set("client_id",String(i));const r=await fetch(`/api/history?${s}`,{headers:{Authorization:"Bearer "+token}});if(r.status===401){localStorage.removeItem("mrpilot_token");const d=await r.json().catch(()=>({}));if((typeof d.detail=="string"?d.detail:d.detail&&d.detail.code||"")==="auth.session_revoked"){_showSessionRevokedModal();return}window.location.href="/";return}const p=await r.json();_historyState.items=p.items||[],_historyState.total=p.total||0;const l=new Set(_historyState.items.map(d=>d.id));for(const d of Array.from(_historySelected))l.has(d)||_historySelected.delete(d);en()}catch(o){console.error("load history failed",o)}finally{_historyState.loading=!1}}function en(){const e=document.getElementById("history-main"),n=document.getElementById("history-empty"),a=_historyState.items,o=document.getElementById("history-search-matches");if(o&&(o.textContent=_historyState.keyword?t("search-matches",{n:_historyState.total}):""),a.length===0&&_historyState.total===0&&!_historyState.keyword){e.style.display="none",n.style.display="";return}e.style.display="",n.style.display="none";let s=0;a.forEach(d=>{d.confidence==="high"&&s++});const i=a.length>0?Math.round(s/a.length*100):0;document.getElementById("history-stats").innerHTML=`
    ...
    `;const r=document.getElementById("history-tbody");a.length===0?r.innerHTML=`<div class="history-row-empty">${escapeHtml(t("history-empty-title"))}</div>`:r.innerHTML=a.map(d=>{const m=new Date(d.created_at),c=String(m.getMonth()+1).padStart(2,"0"),u=String(m.getDate()).padStart(2,"0"),f=String(m.getHours()).padStart(2,"0"),w=String(m.getMinutes()).padStart(2,"0"),C=`${c}-${u} ${f}:${w}`,E=escapeHtml(d.filename||""),v=E.length>50?E.substring(0,50)+"…":E,h=d.invoice_no?escapeHtml(d.invoice_no):v,S=[];d.seller_name&&S.push(escapeHtml(d.seller_name)),d.invoice_no&&d.filename&&S.push(v);const L=S.join(" · ")||"-",A=d.category_tag?`<span class="history-badge category">${escapeHtml(d.category_tag)}</span>`:"",T=d.source_total&&d.source_total>1?`<span class="history-badge multi">${escapeHtml(t("invoice-part-of",{i:d.source_index||1,n:d.source_total}))}</span>`:"",k=d.total_amount!==null&&d.total_amount!==void 0?Number(d.total_amount).toLocaleString(void 0,{minimumFractionDigits:2,maximumFractionDigits:2}):'<span class="history-cell-amount-empty">—</span>',g=[];(d.total_amount===null||d.total_amount===void 0)&&g.push(t("field-amount")),d.invoice_no||g.push(t("field-invoice-no")),d.invoice_date||g.push(t("field-invoice-date")),d.seller_name||g.push(t("field-seller-name")),g.length>0&&`${escapeHtml(d.id)}${escapeHtml(t("history-needs-review-tip")+" · "+g.join(" · "))}${escapeHtml(t("history-needs-review-tip"))}${svgIcon("alert",14)}`,d.edited&&`${escapeHtml(t("history-edited",{n:d.edit_count||1}))}`;const B=d.smart_assigned_flag?`<span class="history-badge smart-assigned" title="${escapeHtml(t("history-smart-assigned"))}">${svgIcon("sparkle",11)}</span>`:"",H=d.confidence==="high"?"high":d.confidence==="medium"?"mid":"low",D=d.confidence==="high"?t("conf-high"):d.confidence==="medium"?t("conf-medium"):t("conf-low"),R=`<span class="history-badge conf-${H}">${escapeHtml(D)}</span>`;let I="";const P=d.source||"manual";return P==="email"?I=`<span class="history-badge source source-email" title="${escapeHtml(t("history-source-email"))}">${svgIcon("mail",11)}<span>${escapeHtml(t("history-source-email"))}</span></span>`:P==="folder"?I=`<span class="history-badge source source-folder" title="${escapeHtml(t("history-source-folder"))}">${svgIcon("folder",11)}<span>${escapeHtml(t("history-source-folder"))}</span></span>`:P==="api"&&(I=`<span class="history-badge source source-api" title="${escapeHtml(t("history-source-api"))}">${svgIcon("api",11)}<span>${escapeHtml(t("history-source-api"))}</span></span>`),`
            ...
            `}).join(""),_t();const p=a.length>0?_historyState.page*_historyState.pageSize+1:0,l=_historyState.page*_historyState.pageSize+a.length;document.getElementById("history-pager-info").textContent=t("history-pager",{from:p,to:l,total:_historyState.total}),document.getElementById("history-prev").disabled=_historyState.page===0,document.getElementById("history-next").disabled=(_historyState.page+1)*_historyState.pageSize>=_historyState.total}window.loadHistoryPage=xt;window.renderHistoryList=en;window.updateHistoryBatchBar=_t;window.clearHistorySelection=wa;typeof currentRoute<"u"&&currentRoute==="history"&&xt();async function Ye(e){try{const n=await fetch(`/api/history/${encodeURIComponent(e)}`,{headers:{Authorization:"Bearer "+token}});if(!n.ok)return;const a=await n.json(),o=mergeFields(a.pages||[]),s={filename:a.filename,pages:a.pages,page_count:a.page_count,elapsed_ms:a.elapsed_ms,engine:"history",merged_fields:o,edits:{},confidence:a.confidence,archive_name:a.archive_name||null,category_tag:a.category_tag||null,_historyId:a.id,_historyMode:!0,client_id:a.client_id||null};_results.push(s),_drawerIdx=_results.length-1,openDrawer(_drawerIdx),_a(),typeof window.bindDrawerClient=="function"&&window.bindDrawerClient(a.id,a.client_id||null),xa(a.id)}catch(n){console.error("open history detail failed",n)}}async function ka(e){await Ye(e),requestAnimationFrame(()=>{const n=document.querySelector('[data-field="total_amount"]');if(n){try{n.focus()}catch{}try{n.select()}catch{}try{n.scrollIntoView({block:"center",behavior:"smooth"})}catch{}}})}function _a(){const e=document.getElementById("drawer-body");if(!e||document.getElementById("drawer-history-save"))return;const n=document.createElement("div");n.id="drawer-history-save",n.className="drawer-history-save-bar",n.innerHTML=`
...
`,e.dataset.wbInjected="1";try{const n=window._currentLang||localStorage.getItem("mrpilot_lang")||"th",a=window.I18N;a&&a[n]&&(e.querySelectorAll("[data-i18n]").forEach(o=>{const s=o.getAttribute("data-i18n");a[n][s]&&(o.textContent=a[n][s])}),e.querySelectorAll("[data-i18n-placeholder]").forEach(o=>{const s=o.getAttribute("data-i18n-placeholder");a[n][s]&&(o.placeholder=a[n][s])}))}catch{}}})();(function(){const e=document.getElementById("archive-token-modal");if(!(!e||e.dataset.wbInjected==="1")){e.innerHTML=`
        ...
        `}async function m(){try{const k=await fetch("/api/settings/dup-check",{headers:{Authorization:"Bearer "+token}});if(!k.ok)return;const g=await k.json(),B=document.getElementById("pref-dup-check");B&&(B.checked=!!g.enabled)}catch(k){console.warn("load prefs failed",k)}}const c=document.getElementById("pref-dup-check");c&&!c.dataset.bound&&(c.dataset.bound="1",c.addEventListener("change",async k=>{const g=k.target.checked;try{(await fetch("/api/settings/dup-check",{method:"PUT",headers:{Authorization:"Bearer "+token,"Content-Type":"application/json"},body:JSON.stringify({enabled:g})})).ok?showToast(g?t("pref-dup-check-on-toast"):t("pref-dup-check-off-toast"),"success"):(k.target.checked=!g,showToast(t("pref-save-failed"),"error"))}catch{k.target.checked=!g,showToast(t("pref-save-failed"),"error")}}));async function u(){const k=!!(_userInfo&&_userInfo.can_customize_archive);o=!k;const g=document.getElementById("archive-upgrade-banner");g&&(g.style.display=k?"none":"");const B=document.getElementById("archive-plus-badge");B&&(B.style.display=k?"none":"");try{const H=await fetch("/api/archive/settings",{headers:{Authorization:"Bearer "+token}});if(!H.ok)throw new Error("load failed");const D=await H.json();e=Array.isArray(D.name_template)?D.name_template:[],n=D.folder_strategy||"by_month_seller"}catch(H){console.error("load archive settings failed",H),showToast(t("archive-load-failed"),"error");return}f(),w(),C(),E()}function f(){const k=document.getElementById("archive-rule-canvas");if(k){if(e.length===0){k.innerHTML=`<div class="archive-empty">${escapeHtml(t("archive-rule-empty"))}</div>`;return}k.innerHTML=e.map((g,B)=>{const H=i[g.type]||{label:g.type},D=s[g.type]||"",R=g.type==="sep"?`"${escapeHtml(g.val||"_")}"`:escapeHtml(t(H.label));return`
            ...
            `}).join("")}}function w(){const k=document.getElementById("archive-field-palette");if(!k)return;const g=["date","seller","category","amount","invoice","buyer","sep"];k.innerHTML=g.map(B=>{const H=i[B],D=s[B]||"";return`
                <button class="archive-palette-btn ${B}" data-add-field="${B}" ${o?"disabled":""}>
                    <span class="token-icon">${D}</span>
                    <span>${escapeHtml(t(H.label))}</span>
                </button>
            `}).join("")}function C(){document.querySelectorAll('input[name="folder-strategy"]').forEach(k=>{k.checked=k.value===n,k.disabled=o})}async function E(){const k=document.getElementById("archive-preview-name"),g=document.getElementById("archive-preview-hint");if(g&&(g.textContent=t("archive-preview-hint",{category:r()})),!!k){if(e.length===0){k.textContent="-";return}try{const H=await(await fetch("/api/archive/rename-preview",{method:"POST",headers:{Authorization:"Bearer "+token,"Content-Type":"application/json"},body:JSON.stringify({merged_fields:l().merged_fields,name_template:e})})).json();k.textContent=(H.name||"-")+".pdf"}catch{k.textContent="("+t("archive-preview-error")+")"}}}window._rerenderArchiveAll=function(){const k=document.getElementById("archive-rule-modal");!k||k.style.display==="none"||(f(),w(),E())};let v=-1;document.addEventListener("dragstart",k=>{const g=k.target.closest(".archive-token");!g||o||(v=parseInt(g.dataset.tokenIdx,10),g.classList.add("dragging"),k.dataTransfer.effectAllowed="move")}),document.addEventListener("dragend",k=>{document.querySelectorAll(".archive-token").forEach(g=>g.classList.remove("dragging","drop-target")),v=-1}),document.addEventListener("dragover",k=>{const g=k.target.closest(".archive-token");g&&(k.preventDefault(),k.dataTransfer.dropEffect="move",document.querySelectorAll(".archive-token").forEach(B=>B.classList.remove("drop-target")),g.classList.add("drop-target"))}),document.addEventListener("drop",k=>{const g=k.target.closest(".archive-token");if(!g||v<0||o)return;k.preventDefault();const B=parseInt(g.dataset.tokenIdx,10);if(B===v)return;const H=e.splice(v,1)[0];e.splice(B,0,H),v=-1,f(),E()}),document.addEventListener("click",k=>{if(k.target.closest("#btn-open-archive-rule")||k.target.closest("#btn-open-archive-rule-from-settings")){const D=document.getElementById("archive-rule-modal");D&&(D.style.display="",u());return}if(k.target.closest("#archive-rule-modal-close")||k.target.id==="archive-rule-modal"){const D=document.getElementById("archive-rule-modal");D&&(D.style.display="none");return}const g=k.target.closest(".settings-nav-item");if(g){switchSettingsTab(g.dataset.settingsTab);return}if(o&&k.target.closest(".archive-token, [data-add-field], #btn-archive-save, #btn-archive-reset")){showToast(t("feature-contact-us"),"info");return}const B=k.target.closest("[data-add-field]");if(B){const D=B.dataset.addField,R=i[D],I={type:D,...R.defaultCfg};e.push(I),f(),E();return}const H=k.target.closest(".archive-token");if(H&&!o){h(parseInt(H.dataset.tokenIdx,10));return}if(k.target.closest("#btn-archive-save"))return A();if(k.target.closest("#btn-archive-reset"))return T();(k.target.closest("#archive-token-close")||k.target.id==="archive-token-modal")&&(document.getElementById("archive-token-modal").style.display="none"),k.target.closest("#btn-archive-token-ok")&&S(),k.target.closest("#btn-archive-token-delete")&&L()}),document.addEventListener("change",k=>{k.target.name==="folder-strategy"&&(n=k.target.value)});function h(k){a=k;const g=e[k];if(!g)return;const B=document.getElementById("archive-token-body");let H="";g.type==="date"?H=`
                <div class="form-group">
...
`,e.dataset.wbInjected="1";try{const n=window._currentLang||localStorage.getItem("mrpilot_lang")||"th",a=window.I18N;a&&a[n]&&(e.querySelectorAll("[data-i18n]").forEach(o=>{const s=o.getAttribute("data-i18n");a[n][s]&&(o.textContent=a[n][s])}),e.querySelectorAll("[data-i18n-placeholder]").forEach(o=>{const s=o.getAttribute("data-i18n-placeholder");a[n][s]&&(o.placeholder=a[n][s])}))}catch{}}})();(function(){const e=document.getElementById("bank-client-picker-modal");if(!(!e||e.dataset.wbInjected==="1")){e.innerHTML=`
    <div class="modal" style="max-width: 420px;">
        <div class="modal-head">
...
`,e.dataset.wbInjected="1";try{const n=window._currentLang||localStorage.getItem("mrpilot_lang")||"th",a=window.I18N;a&&a[n]&&(e.querySelectorAll("[data-i18n]").forEach(o=>{const s=o.getAttribute("data-i18n");a[n][s]&&(o.textContent=a[n][s])}),e.querySelectorAll("[data-i18n-placeholder]").forEach(o=>{const s=o.getAttribute("data-i18n-placeholder");a[n][s]&&(o.placeholder=a[n][s])}))}catch{}}})();(function(){let e=[],n=null,a=[],o="all",s=null,i=!1;async function r(){if(i){D();return}i=!0,p(),await l(),D()}function p(){const b=document.getElementById("bank-file-input");b&&!b._bound&&(b._bound=!0,b.addEventListener("change",w));const z=document.getElementById("btn-bank-queue-clear-done");z&&!z._bound&&(z._bound=!0,z.addEventListener("click",L));const V=document.getElementById("btn-bank-back");V&&!V._bound&&(V._bound=!0,V.addEventListener("click",()=>{n=null,a=[],Q()}));const W=document.getElementById("btn-bank-delete");W&&!W._bound&&(W._bound=!0,W.addEventListener("click",g));const X=document.getElementById("btn-bank-run-match");X&&!X._bound&&(X._bound=!0,X.addEventListener("click",k)),document.querySelectorAll(".bank-filter-btn").forEach(fe=>{fe._bound||(fe._bound=!0,fe.addEventListener("click",()=>{o=fe.dataset.bankFilter||"all",document.querySelectorAll(".bank-filter-btn").forEach(me=>{me.classList.toggle("active",me===fe)}),Z()}))}),document.querySelectorAll("[data-bank-cand-close]").forEach(fe=>{fe._bound||(fe._bound=!0,fe.addEventListener("click",ne))});const de=document.getElementById("btn-bank-cand-pane-close");de&&!de._bound&&(de._bound=!0,de.addEventListener("click",ne));const ie=document.getElementById("btn-bank-cand-ignore");ie&&!ie._bound&&(ie._bound=!0,ie.addEventListener("click",B));const ce=document.getElementById("btn-bank-cand-ignore-pane");ce&&!ce._bound&&(ce._bound=!0,ce.addEventListener("click",B));const ae=document.getElementById("bank-client-badge");ae&&!ae._bound&&(ae._bound=!0,ae.addEventListener("click",x)),document.querySelectorAll("[data-bank-client-picker-close]").forEach(fe=>{fe._bound||(fe._bound=!0,fe.addEventListener("click",y))});const pe=document.getElementById("btn-bank-client-picker-save");pe&&!pe._bound&&(pe._bound=!0,pe.addEventListener("click",N)),document.querySelectorAll(".bank-sessions-chip").forEach(fe=>{fe._bound||(fe._bound=!0,fe.addEventListener("click",()=>{R=fe.dataset.sessFilter||"all",document.querySelectorAll(".bank-sessions-chip").forEach(me=>{me.classList.toggle("active",me===fe)}),I()}))})}async function l(){try{const b=await fetch("/api/bank-recon/sessions?limit=30",{headers:{Authorization:"Bearer "+token}});if(!b.ok)throw new Error("sessions:"+b.status);e=await b.json(),I()}catch(b){console.warn("[bank-recon] loadSessions failed",b),e=[],I()}}async function d(b){try{const z="/api/bank-recon/sessions/"+encodeURIComponent(b)+(o!=="all"?"?filter="+o:""),V=await fetch(z,{headers:{Authorization:"Bearer "+token}});if(!V.ok)throw new Error("detail:"+V.status);const W=await V.json();n=W.session,a=W.transactions||[],F()}catch(z){console.warn("[bank-recon] loadSessionDetail failed",z),showToast(t("bank-load-failed"),"error")}}let m=[],c=0;const u=3;function f(){return c+=1,"q"+c+"_"+Date.now()}async function w(b){const z=Array.from(b.target.files||[]);if(b.target.value="",z.length!==0){for(const V of z){const W={id:f(),file:V,name:V.name,size:V.size,status:"pending",progress:0,error_code:null,tx_count:0,session_id:null};V.name.toLowerCase().endsWith(".pdf")?V.size>20*1024*1024&&(W.status="failed",W.error_code="bank_recon.file_too_large"):(W.status="failed",W.error_code="bank_recon.only_pdf"),m.push(W)}C(),E(),A()}}function C(){const b=document.getElementById("bank-upload-queue");b&&(b.style.display=""),se(),ue()}function E(){const b=document.getElementById("bank-upload-queue-list"),z=document.getElementById("bank-upload-queue-summary");if(!b)return;if(m.length===0){b.innerHTML="",z&&(z.textContent="");const ie=document.getElementById("bank-upload-queue");ie&&(ie.style.display="none");return}let V=0,W=0,X=0,de=0;for(const ie of m)ie.status==="ok"?V++:ie.status==="failed"?W++:ie.status==="uploading"||ie.status==="parsing"?X++:de++;z&&(z.textContent=t("bank-queue-summary").replace("{ok}",V).replace("{run}",X).replace("{wait}",de).replace("{fail}",W)),b.innerHTML=m.map(v).join(""),b.querySelectorAll("[data-q-act]").forEach(ie=>{const ce=ie.dataset.qAct,ae=ie.dataset.qId;ie.addEventListener("click",()=>{ce==="retry"&&h(ae),ce==="remove"&&S(ae)})})}function v(b){const z=(b.size/1024).toFixed(0)+" KB";let V="",W="";if(b.status==="pending")V='<span class="bq-stat bq-wait">'+t("bank-queue-status-wait")+"</span>",W='<button data-q-act="remove" data-q-id="'+O(b.id)+'" class="bq-act">×</button>';else if(b.status==="uploading")V='<span class="bq-stat bq-run">'+t("bank-queue-status-uploading")+'</span><div class="bq-bar"><div class="bq-bar-fill" style="width:'+(b.progress||0)+'%"></div></div>';else if(b.status==="parsing")V='<span class="bq-stat bq-run">'+t("bank-queue-status-parsing")+'</span><div class="bq-bar"><div class="bq-bar-fill bq-bar-indet"></div></div>';else if(b.status==="ok")V='<span class="bq-stat bq-ok">'+t("bank-queue-status-ok").replace("{n}",b.tx_count||0)+"</span>",W='<button data-q-act="remove" data-q-id="'+O(b.id)+'" class="bq-act">×</button>';else if(b.status==="failed"){const X=_(b.error_code||"unknown");V='<span class="bq-stat bq-fail" title="'+O(X)+'">'+O(X)+"</span>",W='<button data-q-act="retry" data-q-id="'+O(b.id)+'" class="bq-act bq-act-retry">'+t("bank-queue-retry")+'</button><button data-q-act="remove" data-q-id="'+O(b.id)+'" class="bq-act">×</button>'}return'<div class="bq-row" data-q-row="'+O(b.id)+'"><div class="bq-name" title="'+O(b.name)+'">'+O(b.name)+'</div><div class="bq-size">'+z+'</div><div class="bq-status">'+V+'</div><div class="bq-actions">'+W+"</div></div>"}function h(b){const z=m.find(V=>V.id===b);z&&(z.status="pending",z.error_code=null,z.progress=0,E(),A())}function S(b){const z=m.findIndex(W=>W.id===b);if(z<0)return;const V=m[z];V.status==="uploading"||V.status==="parsing"||(m.splice(z,1),E())}function L(){m=m.filter(b=>b.status!=="ok"),E()}async function A(){for(;;){if(m.filter(V=>V.status==="uploading"||V.status==="parsing").length>=u)return;const z=m.find(V=>V.status==="pending");if(!z){m.every(V=>V.status==="ok"||V.status==="failed")&&(await l(),typeof window.loadReconcilePage=="function"&&window.loadReconcilePage());return}T(z).then(()=>A())}}async function T(b){b.status="uploading",b.progress=0,E();try{const z=new FormData;z.append("file",b.file,b.name);const V=await new Promise((X,de)=>{const ie=new XMLHttpRequest;ie.open("POST","/api/bank-recon/upload"),ie.setRequestHeader("Authorization","Bearer "+token),ie.upload.onprogress=ce=>{ce.lengthComputable&&(b.progress=Math.min(99,Math.round(ce.loaded/ce.total*100)),E())},ie.upload.onload=()=>{b.status="parsing",E()},ie.onload=()=>{ie.status>=200&&ie.status<300?X({status:ie.status,text:ie.responseText}):X({status:ie.status,text:ie.responseText})},ie.onerror=()=>de(new Error("network")),ie.send(z)});let W={};try{W=JSON.parse(V.text||"{}")}catch{W={}}if(V.status>=400){b.status="failed",b.error_code=W&&W.detail||"unknown",E();return}if(W.parse_status==="parse_failed"){b.status="failed",b.error_code=W.error==="scanned_pdf_not_yet"?"bank_recon.scanned":"bank_recon.no_tx",E();return}b.status="ok",b.tx_count=W.tx_count||0,b.session_id=W.session_id||null,E()}catch(z){console.warn("[bank-recon] upload failed",z),b.status="failed",b.error_code="network",E()}}async function k(){if(!n)return;const b=document.getElementById("btn-bank-run-match"),z=b.innerHTML;b.disabled=!0,b.innerHTML="<span>"+t("bank-matching")+"</span>";try{const V=await fetch("/api/bank-recon/sessions/"+encodeURIComponent(n.id)+"/match",{method:"POST",headers:{Authorization:"Bearer "+token}});if(!V.ok)throw new Error("match:"+V.status);const W=await V.json();showToast(t("bank-match-done").replace("{matched}",W.matched).replace("{suggested}",W.suggested).replace("{unmatched}",W.unmatched),"success"),await d(n.id),await l()}catch(V){console.warn("[bank-recon] match failed",V),showToast(t("bank-match-failed"),"error")}finally{b.disabled=!1,b.innerHTML=z}}async function g(){if(!(!n||!await showConfirm(t("bank-delete-confirm"),{danger:!0})))try{const z=await fetch("/api/bank-recon/sessions/"+encodeURIComponent(n.id),{method:"DELETE",headers:{Authorization:"Bearer "+token}});if(!z.ok)throw new Error("delete:"+z.status);showToast(t("bank-deleted"),"success"),n=null,a=[],Q(),await l()}catch(z){console.warn("[bank-recon] delete failed",z),showToast(t("bank-delete-failed"),"error")}}async function B(){if(s)try{const b=await fetch("/api/bank-recon/tx/"+encodeURIComponent(s.id)+"/override",{method:"POST",headers:{Authorization:"Bearer "+token,"Content-Type":"application/json"},body:JSON.stringify({status:"ignored"})});if(!b.ok)throw new Error("ignore:"+b.status);ne(),await d(n.id)}catch{showToast(t("bank-action-failed"),"error")}}async function H(b){if(s)try{const z=await fetch("/api/bank-recon/tx/"+encodeURIComponent(s.id)+"/override",{method:"POST",headers:{Authorization:"Bearer "+token,"Content-Type":"application/json"},body:JSON.stringify({status:"matched",history_id:b})});if(!z.ok)throw new Error("pick:"+z.status);showToast(t("bank-matched-ok"),"success"),ne(),await d(n.id)}catch{showToast(t("bank-action-failed"),"error")}}function D(){const b=document.getElementById("bank-status-summary");if(!b)return;if(e.length===0){b.textContent=t("bank-pill-none");return}let V=0;for(const W of e)W.parse_status==="parsed"&&(W.unmatched_count||0)>0&&V++;b.textContent=V>0?t("bank-pill-pending").replace("{n}",V):t("bank-pill-ok")}let R="all";function I(){const b=document.getElementById("bank-sessions-list");if(!b)return;let z=e||[];if(R==="parsed"?z=z.filter(V=>V.parse_status==="parsed"):R==="failed"&&(z=z.filter(V=>V.parse_status==="parse_failed")),!e||e.length===0){b.innerHTML='<div class="bank-empty" data-i18n="bank-sessions-empty">'+t("bank-sessions-empty")+"</div>";return}if(z.length===0){b.innerHTML='<div class="bank-empty">'+t("bank-sess-filter-empty")+"</div>";return}b.innerHTML=z.map(V=>U(V)).join(""),b.querySelectorAll(".bank-session-row").forEach(V=>{V.addEventListener("click",W=>{W.target.closest(".bank-session-trash")||d(V.dataset.sessionId)})}),b.querySelectorAll(".bank-session-trash").forEach(V=>{V.addEventListener("click",W=>{W.stopPropagation();const X=V.dataset.sessionId,de=V.dataset.sessionName||"";P(X,de)})})}async function P(b,z){if(!b)return;const V=(t("bank-session-delete-confirm")||"确定删除这条对账记录吗?").replace("{name}",z||"");if(await showConfirm(V,{danger:!0}))try{const X=await fetch("/api/bank-recon/sessions/"+encodeURIComponent(b),{method:"DELETE",headers:{Authorization:"Bearer "+token}});if(!X.ok)throw new Error("delete:"+X.status);showToast(t("bank-deleted"),"success"),n&&n.id===b&&(n=null,a=[],Q()),await l(),typeof window.loadReconcilePage=="function"&&window.loadReconcilePage()}catch(X){console.warn("[bank-recon] delete failed",X),showToast(t("bank-delete-failed"),"error")}}window._deleteBankSession=P;function U(b){const z=(b.bank_code||"OTHER").toUpperCase(),V=J(b.period_start,b.period_end),W=b.account_last4?"···"+b.account_last4:"",X=G(b),de=j(b.created_at);return`
        ...
        `}function G(b){if(b.parse_status==="parse_failed")return`<span class="bank-session-count cnt-failed">${t("bank-count-parse-failed")}</span>`;if(b.parse_status!=="parsed")return`<span class="bank-session-count">${t("bank-count-parsing")}</span>`;const z=b.tx_count||0,V=b.matched_count||0,W=b.unmatched_count||0,X=[`<span class="bank-session-count">${z} ${t("bank-count-tx")}</span>`];return V>0&&X.push(`<span class="bank-session-count cnt-matched">${V} ${t("bank-count-matched")}</span>`),W>0&&X.push(`<span class="bank-session-count cnt-unmatched">${W} ${t("bank-count-unmatched")}</span>`),X.join("")}function F(){document.getElementById("bank-detail").style.display="",document.querySelector(".bank-sessions-section").style.display="none",Y(),Z(),oe()}function Q(){document.getElementById("bank-detail").style.display="none",document.querySelector(".bank-sessions-section").style.display="";const b=document.getElementById("bank-detail-body");b&&b.classList.remove("has-pane"),s=null}function oe(){const b=document.getElementById("bank-client-badge");if(!b||!n)return;const z=n.client_id,V=document.getElementById("bank-client-badge-dot"),W=document.getElementById("bank-client-badge-name"),X=document.getElementById("bank-client-badge-caret"),de=typeof _userInfo<"u"?_userInfo:null,ie=!(de&&de.role==="member");if(z!=null){const ce=(window._clientsCache||[]).find(ae=>Number(ae.id)===Number(z));b.classList.remove("is-empty"),V&&(V.style.background=ce&&ce.color||"#111111"),W&&(W.textContent=ce&&(ce.short_name||ce.name)||"#"+z)}else b.classList.add("is-empty"),V&&(V.style.background=""),W&&(W.textContent=t("bank-client-none"));ie?(b.classList.remove("is-readonly"),b.disabled=!1,X&&(X.style.display="")):(b.classList.add("is-readonly"),b.disabled=!0,X&&(X.style.display="none")),b.style.display=""}let $=null;function x(){if(!n)return;const b=typeof _userInfo<"u"?_userInfo:null;if(!!(b&&b.role==="member"))return;$=n.client_id!=null?Number(n.client_id):null,q();const V=document.getElementById("bank-client-picker-modal");V&&(V.style.display="")}function y(){const b=document.getElementById("bank-client-picker-modal");b&&(b.style.display="none"),$=null}function q(){const b=document.getElementById("bank-client-picker-list");if(!b)return;const z=(window._clientsCache||[]).filter(W=>W&&(W.is_active===!0||W.is_active===void 0)),V=[];V.push('<div class="bank-client-picker-row is-none'+($==null?" is-selected":"")+'" data-cid=""><span class="bank-cp-dot"></span><span>'+O(t("bank-client-picker-none"))+"</span></div>"),z.forEach(W=>{const X=Number(W.id)===Number($)?" is-selected":"";V.push('<div class="bank-client-picker-row'+X+'" data-cid="'+O(W.id)+'"><span class="bank-cp-dot" style="background:'+O(W.color||"#111111")+'"></span><span>'+O(W.short_name||W.name||"#"+W.id)+"</span></div>")}),b.innerHTML=V.join(""),b.querySelectorAll(".bank-client-picker-row").forEach(W=>{W.addEventListener("click",()=>{const X=W.dataset.cid;$=X?Number(X):null,q()})})}async function N(){if(n)try{const b=await fetch("/api/bank-recon/sessions/"+encodeURIComponent(n.id)+"/client",{method:"PATCH",headers:{Authorization:"Bearer "+token,"Content-Type":"application/json"},body:JSON.stringify({client_id:$})});if(!b.ok)throw new Error("client:"+b.status);n.client_id=$,oe(),showToast(t("bank-client-changed"),"success"),y();try{await l()}catch{}}catch(b){console.warn("[bank-recon] save client failed",b),showToast(t("bank-client-change-failed"),"error")}}function Y(){if(!n)return;const b=n;document.getElementById("bank-detail-title").textContent=(b.bank_code||"-")+(b.account_last4?" ···"+b.account_last4:"")+" · "+(b.source_filename||""),document.getElementById("bank-meta-period").textContent=J(b.period_start,b.period_end)||"-",document.getElementById("bank-meta-opening").textContent=M(b.opening_balance),document.getElementById("bank-meta-inflow").textContent="+"+M(b.total_inflow),document.getElementById("bank-meta-outflow").textContent="-"+M(b.total_outflow),document.getElementById("bank-meta-closing").textContent=M(b.closing_balance);const z=a||[],V=z.length;let W=0,X=0,de=0;for(const ie of z){const ce=ie.match_status||"unmatched";ce==="matched"?W++:ce==="suggested"?X++:de++}document.getElementById("bank-stat-total").textContent=V,document.getElementById("bank-stat-matched").textContent=W,document.getElementById("bank-stat-suggested").textContent=X,document.getElementById("bank-stat-unmatched").textContent=de}function Z(){const b=document.getElementById("bank-tx-tbody");if(!b)return;let z=a||[];if(o!=="all"&&(z=z.filter(V=>o==="matched"?V.match_status==="matched":o==="suggested"?V.match_status==="suggested":o==="unmatched"?V.match_status==="unmatched"||V.match_status==="ignored":!0)),z.length===0){b.innerHTML=`<tr><td colspan="4" class="bank-empty">${t("bank-tx-empty")}</td></tr>`;return}if(b.innerHTML=z.map(V=>le(V)).join(""),b.querySelectorAll("tr[data-tx-id]").forEach(V=>{V.addEventListener("click",()=>{const W=V.dataset.txId,X=a.find(de=>de.id===W);X&&(b.querySelectorAll("tr.is-selected").forEach(de=>de.classList.remove("is-selected")),V.classList.add("is-selected"),re(X))})}),s){const V=b.querySelector('tr[data-tx-id="'+s.id+'"]');V&&V.classList.add("is-selected")}}function le(b){const z=b.direction==="OUT",V=z?"-":"+",W=z?"bank-out":"bank-in",X=b.match_status||"unmatched",de=t("bank-match-"+X)||X,ie=j(b.tx_date),ce=b.channel?`<span class="bank-tx-channel">${O(b.channel)}</span>`:"";return`
...
`,e.dataset.wbInjected="1";try{const n=window._currentLang||localStorage.getItem("mrpilot_lang")||"th",a=window.I18N;a&&a[n]&&(e.querySelectorAll("[data-i18n]").forEach(o=>{const s=o.getAttribute("data-i18n");a[n][s]&&(o.textContent=a[n][s])}),e.querySelectorAll("[data-i18n-placeholder]").forEach(o=>{const s=o.getAttribute("data-i18n-placeholder");a[n][s]&&(o.placeholder=a[n][s])}))}catch{}}})();(function(){const e=`
    ...
    `;function a(o,s){const i=document.getElementById(o);if(!(!i||i.dataset.wbInjected==="1")){i.innerHTML=s,i.dataset.wbInjected="1";try{const r=window._currentLang||localStorage.getItem("mrpilot_lang")||"th",p=window.I18N;p&&p[r]&&(i.querySelectorAll("[data-i18n]").forEach(l=>{const d=l.getAttribute("data-i18n");p[r][d]&&(l.textContent=p[r][d])}),i.querySelectorAll("[data-i18n-placeholder]").forEach(l=>{const d=l.getAttribute("data-i18n-placeholder");p[r][d]&&(l.placeholder=p[r][d])}))}catch{}}}a("client-modal-mask",e),a("wsclient-modal-mask",n)})();(function(){let e=[],n=null,a="",o="seller";const s={page:0,pageSize:12,keyword:""},i=new Set;let r=[];const p={keyword:""};let l=null;function d(){return{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||"")}}async function m(y,q={}){const N=await fetch(y,{...q,headers:{"Content-Type":"application/json",...d(),...q.headers||{}}});if(!N.ok){const Y=await N.json().catch(()=>({}));throw new Error(Y.detail||"HTTP "+N.status)}return N.json()}async function c(){try{e=(await m("/api/clients")).clients||[],window._clientsCache=e}catch(y){console.error("loadClientsCache fail",y),e=[]}try{typeof window._refreshExcClientFilter=="function"&&window._refreshExcClientFilter()}catch{}try{typeof window._refreshClientSwitcher=="function"&&window._refreshClientSwitcher()}catch{}return e}function u(y){o=y==="buyer"?"buyer":"seller",document.querySelectorAll("[data-cust-tab]").forEach(Y=>Y.classList.toggle("active",Y.dataset.custTab===o));const q=document.getElementById("cust-pane-seller"),N=document.getElementById("cust-pane-buyer");q&&q.classList.toggle("active",o==="seller"),N&&N.classList.toggle("active",o==="buyer")}function f(){const y=window._userInfo||{},q=String(y.role||"").toLowerCase(),N=String(y.tenant_role||"").toLowerCase();return y.is_super_admin===!0||y.is_owner===!0||q==="owner"||q==="admin"||N==="owner"||N==="admin"}function w(){window._workspaceClientsCache=r,typeof window.renderWorkspaceControl=="function"&&window.renderWorkspaceControl()}async function C(){try{const y=await m("/api/workspace/clients");r=y&&(y.clients||y.items)||[],window._workspaceClientsCache=r}catch(y){console.error("loadSellerCache fail",y),r=[]}return r}function E(){const y=p.keyword.trim().toLowerCase();return y?r.filter(q=>(q.name||"").toLowerCase().includes(y)||(q.tax_id||"").toLowerCase().includes(y)):r}function v(){const y=document.getElementById("seller-tbody");if(!y)return;const q=f(),N=document.getElementById("btn-seller-new");N&&(N.style.display=q?"":"none");const Y=E(),Z=typeof window.getActiveWorkspaceClientId=="function"?window.getActiveWorkspaceClientId():null;if(!Y.length){y.innerHTML=`<div class="cust-empty">${escapeHtml(t(p.keyword?"cust-no-match":"seller-empty"))}</div>`;return}y.innerHTML=Y.map(le=>{const K=Z!=null&&Number(Z)===Number(le.id)?`<span class="cust-badge-current"><svg viewBox="0 0 14 14" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M2 7.5l3.2 3.2L12 4"/></svg>${escapeHtml(t("seller-current"))}</span>`:`<button class="cust-row-btn primary" data-saction="activate" data-wid="${le.id}">${escapeHtml(t("seller-set-current"))}</button>`,ee=q?`
            ...
            </div>`}).join("")}function h(y){l=y?y.id:null,document.getElementById("wsclient-modal-title").textContent=t(y?"wsclient-modal-edit":"wsclient-modal-new"),document.getElementById("wsclient-input-name").value=y&&y.name||"",document.getElementById("wsclient-input-tax").value=y&&y.tax_id||"",document.getElementById("wsclient-modal-archive").style.display=y?"":"none",document.getElementById("wsclient-modal-mask").style.display="flex",setTimeout(()=>document.getElementById("wsclient-input-name").focus(),50)}function S(){document.getElementById("wsclient-modal-mask").style.display="none",l=null}async function L(){const y=document.getElementById("wsclient-input-name").value.trim(),q=document.getElementById("wsclient-input-tax").value.trim();if(!y){showToast(t("client-msg-name-required"),"fail");return}try{l?(await m("/api/workspace/clients/"+l,{method:"PATCH",body:JSON.stringify({name:y,tax_id:q})}),showToast(t("client-msg-updated"),"success")):(await m("/api/workspace/clients",{method:"POST",body:JSON.stringify({name:y,tax_id:q||null})}),showToast(t("client-msg-created"),"success")),S(),await C(),v(),w()}catch(N){const Y=N&&N.message?N.message:t("client-msg-save-fail");showToast(t("client-msg-save-fail")+" · "+Y,"fail")}}async function A(){if(!l)return;const y=r.find(N=>Number(N.id)===Number(l));if(await showConfirm(t("wsclient-archive-confirm").replace("{name}",y?y.name:""),{danger:!0}))try{const N=l;await m("/api/workspace/clients/"+N,{method:"DELETE"}),showToast(t("wsclient-archived"),"success"),typeof window.getActiveWorkspaceClientId=="function"&&Number(window.getActiveWorkspaceClientId())===Number(N)&&typeof window.enterPersonalMode=="function"&&window.enterPersonalMode(),S(),await C(),v(),w()}catch{showToast(t("client-msg-save-fail"),"fail")}}function T(){const y=s.keyword.trim().toLowerCase();return y?e.filter(q=>(q.name||"").toLowerCase().includes(y)||(q.short_name||"").toLowerCase().includes(y)||(q.tax_id||"").toLowerCase().includes(y)):e}function k(){const y=T(),q=s.pageSize,N=Math.max(0,Math.ceil(y.length/q)-1);s.page>N&&(s.page=N);const Y=s.page*q;return{all:y,items:y.slice(Y,Y+q),start:Y,ps:q,total:y.length,maxPage:N}}function g(){const y=document.getElementById("buyer-tbody");if(!y)return;const{items:q,start:N,ps:Y,total:Z,maxPage:le}=k();Z?y.innerHTML=q.map(te=>{const ne=i.has(te.id);return`<div class="cust-row buyer-grid${ne?" selected":""}" data-cid="${te.id}">
...
`,e.dataset.wbInjected="1";try{const n=window._currentLang||localStorage.getItem("mrpilot_lang")||"th",a=window.I18N;a&&a[n]&&(e.querySelectorAll("[data-i18n]").forEach(o=>{const s=o.getAttribute("data-i18n");a[n][s]&&(o.textContent=a[n][s])}),e.querySelectorAll("[data-i18n-placeholder]").forEach(o=>{const s=o.getAttribute("data-i18n-placeholder");a[n][s]&&(o.placeholder=a[n][s])}))}catch{}}})();(function(){let e={statsCache:null,listCache:[],currentRule:null,currentClient:"",currentStatus:"pending",loading:!1,selectedIds:new Set,offset:0,pageSize:50,total:0,loadFailed:!1,listScrollY:0};function n($,x){let y=t($)||$;if(x)for(const q in x)y=y.replace(new RegExp("\\{"+q+"\\}","g"),String(x[q]));return y}async function a(){try{const $=e.currentClient||"",x="/api/exceptions/stats?status=pending"+($?"&client_id="+encodeURIComponent($):""),y=await fetch(x,{headers:{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||"")}});if(!y.ok)return;const q=await y.json(),N=document.getElementById("nav-exc-badge");if(!N)return;const Y=parseInt(q.pending||0,10);Y>0?(N.textContent=Y>99?"99+":String(Y),N.style.display=""):N.style.display="none"}catch{}}function o($){return $==="high"?`<svg viewBox="0 0 14 14" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
            ...
            <span class="exc-chip-count">${$.pending||0}</span>
                ...
                <div class="exc-row sev-${escapeHtml(Y)} ${te?"selected":""}" data-exc-id="${escapeHtml(String(N.id))}">
                    <div class="exc-row-check ${te?"checked":""}" data-check-id="${escapeHtml(String(N.id))}" ${ne?"":'style="visibility:hidden;"'}>${y}</div>
        ...
        `;const le=$.severity||"medium",re=t("exc-rule-"+$.rule_code)||$.rule_code,K=B($.rule_code,$.detail||{}),ee=k(v.history),te=v.history===null,ne=v.history&&v.history._err,se=new Set;$.rule_code==="math_mismatch"?(se.add("subtotal"),se.add("vat"),se.add("total_amount")):$.rule_code==="tax_id_format_invalid"?se.add("seller_tax"):$.rule_code==="amount_missing"&&(se.add("total_amount"),se.add("invoice_number"));const ue=!!v.editing,_=v.editFields||{},M=(ae,pe,fe)=>{if(te)return`<div class="exc-field-row"><label>${escapeHtml(t(pe))}</label><span class="val empty">…</span></div>`;const me=ue?_[ae]!==void 0?_[ae]:ee[ae]!==void 0&&ee[ae]!==null?ee[ae]:"":ee[ae],ge=se.has(ae)?"flagged":"";if(ue){const Oe=fe?"number":"text",Ce=fe?' step="0.01" inputmode="decimal"':"",He=me==null?"":String(me).replace(/"/g,"&quot;");return`<div class="exc-field-row ${ge} editing">
                    <label>${escapeHtml(t(pe))}</label>
                    <input class="exc-field-input" type="${Oe}"${Ce} data-edit-key="${escapeHtml(ae)}" value="${He}">
                </div>`}const be=fe?g(me):me||"",xe=me==null||me===""?`<span class="val empty">${escapeHtml(t("exc-empty-val"))}</span>`:`<span class="val">${escapeHtml(be)}</span>`;return`<div class="exc-field-row ${ge}"><label>${escapeHtml(t(pe))}</label>${xe}</div>`};let j="";ne?j=`<div class="exc-drawer-error">${escapeHtml(t("exc-drawer-error"))}</div>`:j=`
        ...
        `;const O=document.getElementById("exc-fld-edit");O&&O.addEventListener("click",()=>{v.editing=!0,v.editFields={...k(v.history)},H()});const b=document.getElementById("exc-fld-cancel");b&&b.addEventListener("click",()=>{v.editing=!1,v.editFields=null,H()});const z=document.getElementById("exc-fld-save");z&&z.addEventListener("click",()=>D()),document.querySelectorAll(".exc-field-input").forEach(ae=>{ae.addEventListener("input",()=>{v.editFields||(v.editFields={}),v.editFields[ae.dataset.editKey]=ae.value})});const W=document.getElementById("exc-pdf-retry");W&&v.openExcId&&W.addEventListener("click",()=>{v.excRow&&S(v.excRow.history_id,v.openExcId)});const X=$.status==="pending",de=!!($.seller_name&&$.seller_name.trim()),ie=document.getElementById("exc-btn-resolve"),ce=document.getElementById("exc-btn-ignore");ie.disabled=!X,ce.disabled=!X||!de,ce.title=de?t("exc-ignore-hint"):t("exc-ignore-no-seller")}async function D(){if(!v.openExcId||!v.history||!v.history.pages||v.loading)return;v.loading=!0;const $=showToast(t("exc-fld-saving"),"loading",0);try{const x=JSON.parse(JSON.stringify(v.history.pages||[]));let y=x.findIndex(re=>!re.is_duplicate&&!re.is_copy);y<0&&(y=0),x[y]||(x[y]={fields:{}});const q=x[y].fields||{},N=v.editFields||{},Y=new Set(["subtotal","vat","total_amount"]),Z={...q};for(const re in N){let K=N[re];if((K===""||K===void 0)&&(K=null),Y.has(re)&&K!==null){const ee=parseFloat(K);K=isNaN(ee)?null:ee}Z[re]=K}x[y].fields=Z;const le=await fetch("/api/history/"+encodeURIComponent(v.history.id),{method:"PUT",headers:{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||""),"Content-Type":"application/json"},body:JSON.stringify({pages:x})});if(!le.ok)throw new Error("http "+le.status);$(),showToast(t("exc-fld-save-ok"),"success"),A(),await u(),await w(),a()}catch(x){$(),console.warn("save fields fail",x),showToast(t("exc-fld-save-fail"),"error")}finally{v.loading=!1}}async function R(){if(!(!v.openExcId||v.loading)){v.loading=!0;try{const $=await fetch("/api/exceptions/"+v.openExcId+"/resolve",{method:"POST",headers:{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||"")}});if(!$.ok)throw new Error("http "+$.status);showToast(t("exc-toast-resolved"),"success"),A(),await u(),await w(),a()}catch($){console.warn("resolve fail",$),showToast(t("exc-toast-action-fail"),"error")}finally{v.loading=!1}}}async function I(){if(!(!v.openExcId||v.loading)){v.loading=!0;try{const $=await fetch("/api/exceptions/"+v.openExcId+"/ignore",{method:"POST",headers:{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||"")}});if(!$.ok)throw new Error("http "+$.status);showToast(t("exc-toast-ignored"),"success"),A(),await u(),await w(),a()}catch($){console.warn("ignore fail",$),showToast(t("exc-toast-action-fail"),"error")}finally{v.loading=!1}}}let P=!1;async function U(){if(P)return;const $=Array.from(e.selectedIds);if($.length===0||!await showConfirm(n("exc-batch-confirm-resolve",{n:$.length})))return;P=!0;const y=showToast(n("exc-batch-count",{n:$.length})+" …","loading",0);try{const q=await fetch("/api/exceptions/batch",{method:"POST",headers:{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||""),"Content-Type":"application/json"},body:JSON.stringify({ids:$,action:"resolve"})});if(!q.ok)throw new Error("http "+q.status);const N=await q.json();y(),showToast(n("exc-toast-batch-resolved",{n:N.processed||0}),"success"),e.selectedIds.clear(),await u(),await w(),a()}catch(q){y(),console.warn("batch resolve fail",q),showToast(t("exc-toast-batch-fail"),"error")}finally{P=!1}}async function G(){if(P)return;const $=Array.from(e.selectedIds);if($.length===0||!await showConfirm(n("exc-batch-confirm-ignore",{n:$.length}),{danger:!1}))return;P=!0;const y=showToast(n("exc-batch-count",{n:$.length})+" …","loading",0);try{const q=await fetch("/api/exceptions/batch",{method:"POST",headers:{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||""),"Content-Type":"application/json"},body:JSON.stringify({ids:$,action:"ignore"})});if(!q.ok)throw new Error("http "+q.status);const N=await q.json();y(),showToast(n("exc-toast-batch-ignored",{n:N.processed||0,wl:N.whitelist_added||0}),"success"),e.selectedIds.clear(),await u(),await w(),a()}catch(q){y(),console.warn("batch ignore fail",q),showToast(t("exc-toast-batch-fail"),"error")}finally{P=!1}}function F(){e.selectedIds.clear(),d(e.listCache)}document.addEventListener("click",$=>{$.target.closest("#exc-drawer-close")&&A(),$.target.closest("#exc-drawer-mask")&&A(),$.target.closest("#exc-btn-resolve")&&R(),$.target.closest("#exc-btn-ignore")&&I(),$.target.closest("#exc-batch-resolve")&&U(),$.target.closest("#exc-batch-ignore")&&G(),$.target.closest("#exc-batch-clear")&&F(),$.target.closest("#exc-loadmore")&&C()}),document.addEventListener("keydown",$=>{$.key==="Escape"&&v.openExcId&&A()}),document.addEventListener("click",$=>{$.target.closest("#btn-exc-refresh")&&(typeof window.loadExceptionsPage=="function"&&window.loadExceptionsPage(),a())}),document.addEventListener("change",$=>{if(!$.target.closest("#exc-client-filter"))return;const x=$.target;e.currentClient=x.value||"",e.currentRule=null,e.selectedIds.clear(),e.listCache=[],typeof window.loadExceptionsPage=="function"&&window.loadExceptionsPage(),a()}),document.addEventListener("click",$=>{const x=$.target.closest("#exc-status-tabs .exc-status-tab");if(!x)return;const y=x.dataset.status||"pending";y!==e.currentStatus&&(e.currentStatus=y,e.currentRule=null,e.selectedIds.clear(),e.listCache=[],typeof window.loadExceptionsPage=="function"&&window.loadExceptionsPage())}),window.addEventListener("online",()=>{e.loadFailed&&document.getElementById("page-exceptions")?.classList.contains("show")&&window.loadExceptionsPage&&window.loadExceptionsPage()}),setTimeout(a,1500),setInterval(a,6e4);function Q($){if(!$)return"—";try{const x=new Date($),y=q=>String(q).padStart(2,"0");return`${x.getFullYear()}-${y(x.getMonth()+1)}-${y(x.getDate())} ${y(x.getHours())}:${y(x.getMinutes())}`}catch{return $.slice(0,16).replace("T"," ")}}async function oe(){const $=document.getElementById("learned-list");if($){$.innerHTML=`<div class="learned-empty">${escapeHtml(t("set-learned-loading"))}</div>`;try{const x=await fetch("/api/exception-whitelist",{headers:{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||"")}});if(!x.ok)throw new Error("http "+x.status);const q=(await x.json()).items||[];if(q.length===0){$.innerHTML=`<div class="learned-empty">${escapeHtml(t("set-learned-empty"))}</div>`;return}const N=`<svg viewBox="0 0 14 14" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round">
            ...
            <table style="width:100%;border-collapse:collapse;font-size:12px;margin-bottom:4px">
              ...
              <td>${V?"L"+V:"—"}</td>
            </tr>`}).join("")}async function Z(){const _=localStorage.getItem("mrpilot_token")||"";try{const j=await(await fetch("/api/recon/bank-v2/tasks",{headers:{Authorization:"Bearer "+_}})).json();te(j.tasks||[])}catch{const j=l("brv2-history-empty"),J=window._currentLang||"zh",O={zh:"加载失败",th:"โหลดประวัติไม่ได้",en:"Load failed",ja:"読み込み失敗"}[J]||"加载失败";j&&(j.textContent=O,j.style.display="");const b=l("brv2-history-table-wrap");b&&(b.style.display="none")}}const le=10;let re=1;function K(){const _=l("brv2-history-pager"),M=l("brv2-history-pager-info"),j=l("brv2-history-prev"),J=l("brv2-history-next");if(!_)return;if(p.length<=le){_.style.display="none";return}_.style.display="";const O=Math.ceil(p.length/le);M&&(M.textContent=re+" / "+O),j&&(j.disabled=re<=1),J&&(J.disabled=re>=O)}function ee(){const _=l("brv2-history-prev"),M=l("brv2-history-next");_&&!_._brv2Bound&&(_._brv2Bound=!0,_.addEventListener("click",()=>{re>1&&(re--,te(p))})),M&&!M._brv2Bound&&(M._brv2Bound=!0,M.addEventListener("click",()=>{const j=Math.ceil(p.length/le);re<j&&(re++,te(p))}))}function te(_){_!==void 0&&(p=_||[],re=1);const M=p,j=l("brv2-history-empty"),J=l("brv2-history-table-wrap"),O=l("brv2-history-tbody");if(!O)return;const b=window._currentLang||"zh";if(!M.length){const ae={zh:"暂无对账记录",th:"ยังไม่มีประวัติ",en:"No records yet",ja:"記録なし"}[b]||"暂无对账记录";j&&(j.textContent=ae,j.style.display=""),J&&(J.style.display="none"),K();return}j&&(j.style.display="none"),J&&(J.style.display="");const z=Math.ceil(M.length/le);re>z&&(re=z);const V=(re-1)*le,W=M.slice(V,V+le),X=localStorage.getItem("mrpilot_token")||"",de='<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" width="14" height="14"><circle cx="8" cy="8" r="6"/><polyline points="6 8 8 10 10 8"/><line x1="8" y1="4" x2="8" y2="10"/></svg>',ie='<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" width="14" height="14"><path d="M8 2v9M4 7l4 4 4-4M3 14h10"/></svg>',ce='<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" width="14" height="14"><polyline points="3 4 13 4"/><path d="M6 4V2.5a.5.5 0 0 1 .5-.5h3a.5.5 0 0 1 .5.5V4"/><path d="M5 4l1 9a1 1 0 0 0 1 1h2a1 1 0 0 0 1-1l1-9"/></svg>';O.innerHTML="",W.forEach(ae=>{const pe=Number(ae.formula_diff||0),fe=Math.abs(pe)<.05,me=(ae.stmt_files||"").split(";").map(_e=>_e.trim().split(/[/\\]/).pop()).filter(Boolean).join(", "),ge=(ae.gl_files||"").split(";").map(_e=>_e.trim().split(/[/\\]/).pop()).filter(Boolean).join(", "),be=ae.created_at?String(ae.created_at).slice(0,16).replace("T"," "):"",xe=document.createElement("tr");xe.dataset.taskId=ae.id;const Oe=document.createElement("td");Oe.textContent=be;const Ce=document.createElement("td");Ce.className="glv-history-file",Ce.title=me+" + "+ge,Ce.textContent=me+" + "+ge;const He=document.createElement("td");He.className="glv-num",He.textContent=(ae.stmt_row_count||0)+" / "+(ae.gl_row_count||0);const rt=document.createElement("td");rt.className="glv-num",rt.textContent=ae.matched_count||0;const lt=document.createElement("td");lt.className="glv-num",lt.textContent=ae.unmatched_gl||0;const ct=document.createElement("td");ct.className="glv-num",ct.textContent=ae.unmatched_stmt||0;const Ve=document.createElement("td");Ve.className="glv-num",Ve.style.color=fe?"#059669":"#dc2626",Ve.textContent=fe?"✓":d(pe);const Ae=document.createElement("td");Ae.className="glv-history-actions";const dt=(_e,Tt,Mt,En)=>{const Ie=document.createElement("button");return Ie.type="button",Ie.title=Tt,Ie.setAttribute("aria-label",Tt),Mt&&(Ie.className=Mt),Ie.innerHTML=_e,Ie.onclick=In=>{In.stopPropagation(),En()},Ie},wn={zh:"删除这条记录?",th:"ลบรายการนี้?",en:"Delete this record?",ja:"この記録を削除しますか?"}[b]||"删除?",kn={zh:"加载",th:"โหลด",en:"Load",ja:"読込"}[b]||"加载",_n={zh:"导出",th:"ส่งออก",en:"Export",ja:"エクスポート"}[b]||"导出",xn={zh:"删除",th:"ลบ",en:"Delete",ja:"削除"}[b]||"删除";Ae.appendChild(dt(de,kn,"",()=>se(ae.id,X))),Ae.appendChild(dt(ie,_n,"",()=>y(ae.id))),Ae.appendChild(dt(ce,xn,"glv-del",async()=>{await showConfirm(wn,{danger:!0})&&(await fetch("/api/recon/bank-v2/"+ae.id,{method:"DELETE",headers:{Authorization:"Bearer "+X}}),Z())})),[Oe,Ce,He,rt,lt,ct,Ve,Ae].forEach(_e=>xe.appendChild(_e)),xe.style.cursor="pointer",xe.addEventListener("click",async _e=>{_e.target.closest(".glv-del")||_e.target.closest("button")||await se(ae.id,X)}),O.appendChild(xe)}),K(),ne()}function ne(){const _=((l("brv2-hist-search")||{}).value||"").trim().toLowerCase(),M=l("brv2-history-tbody");M&&M.querySelectorAll("tr").forEach(j=>{j.dataset.taskId&&(j.style.display=!_||j.textContent.toLowerCase().includes(_)?"":"none")})}async function se(_,M){try{const J=await(await fetch("/api/recon/bank-v2/"+_,{headers:{Authorization:"Bearer "+M}})).json();if(!J.ok)return;o={task_id:J.task_id,...J},i=J.detail||[],s="all",document.querySelectorAll(".brv2-filter-btn").forEach(O=>O.classList.toggle("active",O.dataset.filter==="all")),N(o)}catch{}}function ue(){if(e){Z();return}e=!0,U("brv2-stmt-zone","brv2-stmt-input","stmt"),U("brv2-gl-zone","brv2-gl-input","gl");const _=["brv2-anchor-gl-closing","brv2-anchor-stmt-closing","brv2-anchor-stmt-opening","brv2-anchor-gl-opening"];function M(){const V=parseFloat((l("brv2-anchor-stmt-opening")||{}).value),W=parseFloat((l("brv2-anchor-gl-opening")||{}).value),X=l("brv2-anchor-eq"),de=l("brv2-anchor-eq-val");if(!(!X||!de))if(Number.isFinite(V)&&Number.isFinite(W)){const ie=V-W;de.textContent=ie.toLocaleString(void 0,{minimumFractionDigits:2,maximumFractionDigits:2}),X.style.display=""}else X.style.display="none"}_.forEach(V=>{const W=l(V);W&&(W.addEventListener("input",M),W.addEventListener("input",()=>{const X=W.closest(".brv2-anchor-cell");X&&X.classList.remove("is-prefilled"),k()}))}),T();const j=l("brv2-run-btn");j&&j.addEventListener("click",Q);const J=l("brv2-reset-btn");J&&J.addEventListener("click",()=>{o=null,i=[],n=[],a=[],f("stmt"),f("gl"),P(),$(!1);const V=l("brv2-acct-select");V&&(V.style.display="none"),_.forEach(de=>{const ie=l(de);if(ie){ie.value="";const ce=ie.closest&&ie.closest(".brv2-anchor-cell");ce&&ce.classList.remove("is-prefilled")}});const W=l("brv2-anchor-eq");W&&(W.style.display="none");const X=l("brv2-anchor-prefill-banner");X&&X.classList.remove("show")});const O=l("brv2-new-btn");O&&O.addEventListener("click",()=>{o=null,i=[],n=[],a=[],f("stmt"),f("gl"),P(),$(!1)});const b=l("brv2-filter-tabs");b&&b.addEventListener("click",V=>{V.stopPropagation();const W=V.target.closest(".brv2-filter-btn");W&&(s=W.dataset.filter,b.querySelectorAll(".brv2-filter-btn").forEach(X=>X.classList.toggle("active",X===W)),Y())}),I(),ee();const z=l("brv2-hist-search");z&&z.addEventListener("input",ne),Z(),P(),window._brv2LoadHistory=Z,Array.isArray(window.__i18nSubs)||(window.__i18nSubs=[]),window.__i18nSubs=window.__i18nSubs.filter(V=>V.name!=="brv2"),window.__i18nSubs.push({name:"brv2",fn:function(){P(),f("stmt"),f("gl"),o&&N(o),te()}})}window._loadBankReconV2Panel=function(_){const M=_?document.getElementById(_):null;M&&M.id!=="recon-pane-bank"&&(M.innerHTML=`<div style="padding:16px;font-size:13px;color:var(--ink-3)">
    ...
    `,document.body.appendChild(n),n.addEventListener("click",async a=>{if(a.target===n||a.target.classList.contains("log-detail-close")){n.remove();return}const o=a.target.closest("[data-receipt-copy]");if(o){vn(o.dataset.receiptCopy);return}const s=a.target.closest("[data-receipt-action]");if(s){const i=s.dataset.receiptAction;i==="retry"?window.retryPushLog(s.dataset.logId):i==="exceptions"?typeof routeTo=="function"&&routeTo("exceptions"):i==="mappings"&&typeof routeTo=="function"&&routeTo("integrations"),n.remove();return}});try{const a=await fetch(`/api/erp/logs/${encodeURIComponent(e)}`,{headers:{Authorization:"Bearer "+token}});if(!a.ok){n.remove();return}const o=await a.json(),s=window._erpEndpoints.find(R=>R.id===o.endpoint_id),i=o.endpoint_name||(s?s.name:o.endpoint_id?t("erp-log-endpoint-deleted"):"-"),r=(o.endpoint_adapter||s&&s.adapter||"").toLowerCase(),p=new Date(o.created_at).toLocaleString(),l=o.trigger==="auto"?t("log-tag-auto"):o.trigger==="retry"?t("log-tag-retry"):t("log-tag-manual"),d=o.request_body?JSON.stringify(o.request_body,null,2):t("erp-receipt-no-tech"),m=o.response_body||t("erp-receipt-no-tech"),c=o.status==="success";let u=typeof m=="string"?m:JSON.stringify(m,null,2);if(c)try{const R=typeof o.response_body=="string"?JSON.parse(o.response_body):o.response_body||{},I=R.row_count||(Array.isArray(R.imported_rows)?R.imported_rows.length:0);I>0&&(u=t("log-push-rows").replace("{n}",String(I)))}catch{}const f=(o.external_doc_no||"").trim(),w=(o.external_url||"").trim(),C=(o.external_doc_hint||"").trim(),E=(o.ocr_buyer_name||"").trim()||o.client_name||"-",v=o.seller_name||"-",h=o.push_type==="id_card";let S="-";const L=Number(o.total_amount);o.total_amount!=null&&o.total_amount!==""&&!isNaN(L)&&(S=L.toLocaleString("en-US",{minimumFractionDigits:2,maximumFractionDigits:2}));const A=c?t("erp-receipt-title-ok"):t("erp-receipt-title-fail"),T=c?"✓":"✗",k=[],g=(R,I)=>{k.push(`
        ...
        `}catch(a){console.error(a),n.remove()}}window.copyErpDocNo=vn;window.showLogDetail=Ka;(function(){const e=document.getElementById("endpoint-modal");if(!(!e||e.dataset.wbInjected==="1")){e.innerHTML=`
        <div class="modal">
            <div class="modal-head">
