...
# v118.35 · CLEANUP-01 · PaymentSubmitRequest / AdminUpgradeRequest 已删除 · 旧路由下线
...
# ============================================================
# v118.35 · CLEANUP-01 · check_ocr_quota 已下线
# credits 系统接管 OCR 配额拦截 · 旧函数无调用者(app.py:1592 已注释)
# ============================================================
