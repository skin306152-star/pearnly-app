...
from services.playwright_bootstrap import ensure_playwright_installed  # REFACTOR-WA-B1 · 2026-05-29
from services.background_loops import (  # REFACTOR-WA-B1 · 2026-05-29 · 后台常驻 loop
    erp_retry_loop,
    email_ingest_loop,
)
from services.static_assets import read_frontend_version, purge_stale_static_gz  # REFACTOR-WA-B1
from services.users.columns import ensure_user_profile_columns  # REFACTOR-WA-B1
...
"""
    ...
    try:
        ...
        await _asyncio.to_thread(ensure_playwright_installed)
    except Exception as e:
        logger.warning(
