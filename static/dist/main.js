...
`,e.dataset.wbInjected="1";try{const n=window._currentLang||localStorage.getItem("mrpilot_lang")||"th",a=window.I18N;a&&a[n]&&e.querySelectorAll("[data-i18n]").forEach(o=>{const s=o.getAttribute("data-i18n");a[n][s]&&(o.textContent=a[n][s])})}catch{}}})();const Cc="/api/knowledge",et="/static/brand/kb-cat.png?v=2";function Sc(){return localStorage.getItem("mrpilot_token")||""}function F(e,n){if(typeof window.t=="function"){const a=window.t(e);if(a&&a!==e)return a}return n}function G(e){return typeof escapeHtml=="function"?escapeHtml(String(e??"")):String(e??"")}const Co={file:'<path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><path d="M14 2v6h6"/>',"file-text":'<path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><path d="M14 2v6h6"/><path d="M16 13H8"/><path d="M16 17H8"/><path d="M10 9H8"/>',sheet:'<rect width="18" height="18" x="3" y="3" rx="2"/><path d="M3 9h18"/><path d="M3 15h18"/><path d="M9 3v18"/><path d="M15 3v18"/>',image:'<rect width="18" height="18" x="3" y="3" rx="2"/><circle cx="9" cy="9" r="2"/><path d="m21 15-3.1-3.1a2 2 0 0 0-2.8 0L6 21"/>',upload:'<path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><path d="M14 2v6h6"/><path d="M12 18v-6"/><path d="m9 15 3-3 3 3"/>',message:'<path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/>',"shield-check":'<path d="M20 13c0 5-3.5 7.5-7.7 9a1 1 0 0 1-.7 0C7.5 20.5 4 18 4 13V6a1 1 0 0 1 1-1c2 0 4.5-1.2 6.2-2.7a1.2 1.2 0 0 1 1.6 0C14.5 3.8 17 5 19 5a1 1 0 0 1 1 1z"/><path d="m9 12 2 2 4-4"/>',check:'<path d="M20 6 9 17l-5-5"/>',x:'<path d="M18 6 6 18"/><path d="M6 6l12 12"/>'};function Me(e){return`<svg class="kb-ic" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round">${Co[e]||Co.file}</svg>`}function Ds(e){const n=`kb-${e}-mask`,a=`kb-${e}-modal`,o=()=>document.getElementById(n)?.classList.add("open"),s=()=>document.getElementById(n)?.classList.remove("open");let i=document.getElementById(n);if(!i){i=document.createElement("div"),i.id=n,i.className=`kb-${e}-mask`,i.innerHTML=`<div class="kb-${e}-modal" id="${a}" role="dialog" aria-modal="true"></div>`,document.body.appendChild(i);const r=i;r.addEventListener("click",c=>{(c.target===r||c.target.closest(`[data-kb-${e}-close]`))&&s()}),document.addEventListener("keydown",c=>{c.key==="Escape"&&r.classList.contains("open")&&s()})}return{modal:document.getElementById(a),open:o,close:s}}function Dn(){const e=window.getActiveWorkspaceClientId;if(typeof e!="function")return null;const n=e(),a=Number(n);return Number.isFinite(a)&&a>0?a:null}function Rs(){const e=Dn();if(!e)return"";const a=(window._workspaceClientsCache||[]).find(o=>Number(o.id)===e);return a&&a.name?String(a.name):"#"+e}async function At(e,n,a,o={}){const s=new URL(Cc+n,location.origin),i=Dn();if(o.query)for(const[d,u]of Object.entries(o.query))u!=null&&s.searchParams.set(d,String(u));const r=o.withWorkspace!==!1&&i!=null;r&&(e==="GET"||e==="DELETE")&&s.searchParams.set("workspace_client_id",String(i));const c={Authorization:"Bearer "+Sc()};let m=o.raw;if(!o.raw&&a!==void 0){const d=r?{workspace_client_id:i,...a}:a;c["Content-Type"]="application/json",m=JSON.stringify(d)}try{const d=await fetch(s.toString(),{method:e,headers:c,body:m});let u=null,l;const p=await d.text();if(p)try{const f=JSON.parse(p);d.ok?u=f:l=f?.detail?.error_code||f?.message_key||f?.detail||void 0}catch{}return{ok:d.ok,status:d.status,data:u,error:l}}catch{return{ok:!1,status:0,data:null,error:"network"}}}async function Tc(e,n){const a=new FormData;a.append("file",e);const o=Dn();return o!=null&&a.append("workspace_client_id",String(o)),At("POST","/documents",void 0,{raw:a,withWorkspace:!1})}let rn=null;async function qs(){if(rn!==null)return rn;const e=await At("GET","/bases",void 0,{withWorkspace:!1});return rn=e.status===200||e.status===401||e.status===403,rn}let So=!1;function Fs(){const e=document.getElementById("kb-ws-bar"),n=document.getElementById("kb-ws-label");if(!e||!n)return;Dn()?(e.classList.remove("kb-ws-empty"),n.innerHTML=F("kb-ws-current","账套主体")+"：<b>"+G(Rs())+"</b>"):(e.classList.add("kb-ws-empty"),n.textContent=F("kb-ws-none","请先在右上角选择账套主体,再使用客户私有文档与问答。"))}function Mc(e){document.querySelectorAll(".kb-tab-bar .recon-tab-btn").forEach(n=>{n.classList.toggle("active",n.dataset.kbTab===e)}),document.querySelectorAll(".kb-pane").forEach(n=>{n.classList.toggle("active",n.id==="kb-pane-"+e)}),e==="docs"&&typeof window._kbRenderDocs=="function"&&window._kbRenderDocs(),e==="qa"&&typeof window._kbRenderAsk=="function"&&window._kbRenderAsk()}function $c(){if(So)return;const e=document.querySelector(".kb-tab-bar");if(!e)return;e.addEventListener("click",o=>{const s=o.target.closest(".recon-tab-btn");s&&s.dataset.kbTab&&Mc(s.dataset.kbTab)});const n=document.getElementById("kb-open-rules");n&&n.addEventListener("click",()=>{typeof window.openRulesSettings=="function"&&window.openRulesSettings()});const a=document.getElementById("kb-info-btn");a&&a.addEventListener("click",()=>{typeof window._kbOpenInfo=="function"&&window._kbOpenInfo()}),So=!0}window.loadKnowledgePage=function(){$c(),Fs(),document.querySelector('.kb-tab-bar .recon-tab-btn[data-kb-tab="docs"]')?.classList.contains("active")&&typeof window._kbRenderDocs=="function"&&window._kbRenderDocs()};async function To(){if(!window._knowledgeProbed){window._knowledgeProbed=!0;try{if(await qs()){const e=document.getElementById("nav-knowledge");e&&(e.style.display="")}}catch{}}}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",To):To();Array.isArray(window.__i18nSubs)||(window.__i18nSubs=[]);window.__i18nSubs.push({name:"knowledge-center",fn:Fs});let la=!1,Ue=[];function Hc(e){if(e.status==="ready")return`<span class="kb-badge ready"><span class="kb-bdot"></span>${G(F("kb-doc-ready","已就绪"))}</span>`;if(e.status==="failed")return`<span class="kb-badge failed"><span class="kb-bdot"></span>${G(F("kb-doc-failed","失败"))}</span>`;const n=e.status==="uploading"?F("kb-doc-uploading","上传中…"):F("kb-doc-parsing","解析中");return`<span class="kb-badge parsing"><span class="kb-bdot"></span>${G(n)}</span>`}function Ac(e){return e==="unsupported_document"?F("kb-err-unsupported_document","不支持的文件类型"):e==="embedding_failed"?F("kb-err-embedding_failed","向量化失败，可重试"):e==="processing_failed"?F("kb-err-processing_failed","文件无法解析，可能已损坏或加密"):e?F("kb-doc-failed","失败"):""}function jc(e){return(e||"").slice(0,10)}function Pc(e){let n;e.status==="failed"&&e.error_code?n=`<div class="kb-doc-sub err">${G(Ac(e.error_code))}</div>`:e.status==="uploading"?n=`<div class="kb-doc-sub">${G(F("kb-doc-uploading","上传中…"))}</div>`:n=`<div class="kb-doc-sub">${G((e.source_type||"").toUpperCase())} · ${G(jc(e.created_at))}</div>`;const a=e.status==="uploading"?"":`<button class="btn btn-sm btn-ghost kb-doc-del" data-id="${e.id}">${G(F("kb-doc-delete","删除"))}</button>`;return`<div class="kb-doc-row" data-id="${e.id}">
        ...
        </div>`);return}Ue=(e.data?.documents||[]).filter(n=>n.status!=="deleted"),Xt()}async function $o(e){const n=Array.from(e);if(n.length)for(const a of n){const o=-Date.now()-Math.floor(Math.random()*1e3);Ue.unshift({id:o,filename:a.name,source_type:(a.name.split(".").pop()||"").toLowerCase(),status:"uploading",error_code:null,created_at:new Date().toISOString()}),Xt();const s=await Tc(a),i=Ue.findIndex(r=>r.id===o);i<0||(s.ok&&s.data?.document?(Ue[i]=s.data.document,s.data.document.status==="failed"&&showToast(F("kb-doc-failed","失败")+"："+a.name,"error")):(Ue.splice(i,1),showToast(F("kb-upload-fail","上传失败")+"："+a.name,"error")),Xt())}}async function Rc(e){if(!(typeof showConfirm=="function"?await showConfirm(F("kb-doc-del-confirm","确定删除这份文档？删除后 AI 将不再引用它。")):!0))return;(await At("DELETE","/documents/"+e)).ok?(Ue=Ue.filter(o=>o.id!==e),Xt()):showToast(F("kb-doc-del-fail","删除失败"),"error")}function qc(){const e=document.getElementById("kb-pane-docs");if(!e||la&&e.querySelector("#kb-doc-list"))return;if(!document.getElementById("kb-docs-style")){const o=document.createElement("style");o.id="kb-docs-style",o.textContent=`
...
`,document.head.appendChild(o)}e.innerHTML=`
    ...
    `;try{const o=window._currentLang||localStorage.getItem("mrpilot_lang")||"th",s=window.I18N;s&&s[o]&&e.querySelectorAll("[data-i18n]").forEach(i=>{const r=i.getAttribute("data-i18n");s[o][r]&&(i.textContent=s[o][r])})}catch{}const n=e.querySelector("#kb-up"),a=e.querySelector("#kb-file");n.addEventListener("click",o=>{o.target.closest("input")||a.click()}),a.addEventListener("change",()=>{a.files&&$o(a.files),a.value=""}),["dragenter","dragover"].forEach(o=>n.addEventListener(o,s=>{s.preventDefault(),n.classList.add("drag")})),["dragleave","drop"].forEach(o=>n.addEventListener(o,s=>{s.preventDefault(),n.classList.remove("drag")})),n.addEventListener("drop",o=>{const s=o.dataTransfer;s?.files?.length&&$o(s.files)}),e.addEventListener("click",o=>{const s=o.target,i=s.closest(".kb-doc-del");if(i?.dataset.id){Rc(Number(i.dataset.id));return}s.closest(".kb-doc-reload")&&Ns()}),la=!0}function Fc(){qc(),Ns()}window._kbRenderDocs=Fc;Array.isArray(window.__i18nSubs)||(window.__i18nSubs=[]);window.__i18nSubs.push({name:"knowledge-documents",fn:()=>{la&&Xt()}});let xn=null;function zc(){if(xn)return;const e=document.createElement("style");e.id="kb-src-style",e.textContent=`
...
`,document.head.appendChild(e),xn=Ds("src")}function Nc(e){const n=G(e.text).replace(/\n/g,"<br>");return`<span class="seg${e.matched?" hit":""}">${n}</span>`}function Oc(e){return e.segments.map(Nc).join("<br><br>")}async function Vc(e){zc();const n=xn?.modal;if(!n)return;const a=e.filename||F("kb-src-unknown","未知来源"),o=typeof e.score=="number"?Math.round(Math.max(0,Math.min(1,e.score))*100):null,s=typeof e.chunk_id=="number";if(n.innerHTML=`
        ...
        <div class="kb-src-body">
            ...
            <div class="kb-src-preview" id="kb-src-preview">${s?`<div class="kb-src-loading">${G(F("kb-src-loading","正在取原文…"))}</div>`:`<div class="kb-src-fail">${G(F("kb-src-no-chunk","可在文档库打开原件核对。"))}</div>`}</div>
            <p class="kb-src-foot">${G(F("kb-src-verifiable","这就是「可核对」:AI 说的每句话都能点回原文这一句,会计自己一眼能确认,不用盲信。"))}</p>
        </div>
    `,xn?.open(),!s)return;const i=await At("GET","/chunks/"+e.chunk_id),r=n.querySelector("#kb-src-preview");r&&(i.ok&&i.data?.segments?.length?r.innerHTML=Oc(i.data):r.innerHTML=`<div class="kb-src-fail">${G(F("kb-src-load-fail","原文片段暂时取不到,可在文档库打开原件核对。"))}</div>`)}window._kbOpenSource=e=>{Vc(e)};function Uc(e){return`<div class="kb-msg user"><div class="kb-bub">${G(e)}</div></div>`}function Gc(e){const n=e.filename||F("kb-src-unknown","未知来源");return`<button class="kb-cite" data-cite='${G(JSON.stringify(e))}'>
        ...
        ${G(n)}<span class="ch">›</span></button>`}function Kc(e){if(e.no_answer){const a=F(e.message_key||"ask.no_source","资料不足，无法判断。");return`<div class="kb-msg ai"><div class="kb-ava"><img src="${et}" alt=""></div>
...
`,document.head.appendChild(e)}function Jc(){const e=document.getElementById("kb-pane-qa");if(!e||e.dataset.kbBuilt==="1")return;Yc();const n=G(F("kb-ask-ex1","这家客户有金额上限吗？")),a=G(F("kb-ask-ex2","合同约定的付款周期是多久？")),o=G(F("kb-ask-ex3","哪些供应商需要人工复核？")),s=typeof window._kbFabEnabled=="function"&&window._kbFabEnabled();e.innerHTML=`
        <div class="kb-ft">
...
`,document.head.appendChild(e),_n=Ds("info")}function ln(e,n){return`<li><span class="ck">${Me("check")}</span><span>${G(F(e,n))}</span></li>`}function Wn(e,n,a,o,s,i,r){return`<div class="row"><div class="pi">${e}</div>
        <div class="pm"><b>${G(F(n,a))}</b><div class="d">${G(F(o,s))}</div></div>
        <span class="amt">${G(F(i,r))}</span></div>`}function ld(){const e=_n?.modal;e&&(e.innerHTML=`
