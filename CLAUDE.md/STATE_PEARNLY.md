...
> **最近更新**:2026-05-13 · v4.10.0 DB+API 完成(vat_recon_tasks 表 + 6 CRUD + 5 API 路由全过) · 铁律立 · v4.10.1 execute 中
> **当前线上(已 ssh 核实)**:**v118.32.4.10.0**(vat_excel_routes 全网开放 · 任务持久化)
> **🔥 v4.10 微版本排期(2026-05-13 Zihao 拍板)**:
>   - ✅ **v4.10.0** · DB + API 纯后端 · 5 API 全过
>   - 🔥 **v4.10.1** · 主体 UI：撤 toggle/BETA/email gate + 标题 bug + KPI 4卡 + 任务列表 + 2 处 i18n 残留 · **本窗口正在做**
>   - 📅 **v4.10.2** · 详情抽屉(5 节)
