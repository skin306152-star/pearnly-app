...
`,e.dataset.wbInjected="1";try{const n=window._currentLang||localStorage.getItem("mrpilot_lang")||"th",a=window.I18N;a&&a[n]&&(e.querySelectorAll("[data-i18n]").forEach(o=>{const s=o.getAttribute("data-i18n");a[n][s]&&(o.textContent=a[n][s])}),e.querySelectorAll("[data-i18n-placeholder]").forEach(o=>{const s=o.getAttribute("data-i18n-placeholder");a[n][s]&&(o.placeholder=a[n][s])}))}catch{}}})();(function(){const e=document.getElementById("page-settings");if(!(!e||e.dataset.wbInjected==="1")){e.innerHTML=`
        ...
        <!-- /settings-layout -->
`,e.dataset.wbInjected="1";try{const n=window._currentLang||localStorage.getItem("mrpilot_lang")||"th",a=window.I18N;a&&a[n]&&(e.querySelectorAll("[data-i18n]").forEach(o=>{const s=o.getAttribute("data-i18n");a[n][s]&&(o.textContent=a[n][s])}),e.querySelectorAll("[data-i18n-placeholder]").forEach(o=>{const s=o.getAttribute("data-i18n-placeholder");a[n][s]&&(o.placeholder=a[n][s])}))}catch{}}})();const tn=`
        <div class="page-head-clean">
            <div class="page-head-icon">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
...
`;(function(){const e=document.getElementById("page-automation");if(!(!e||e.dataset.wbInjected==="1")){e.innerHTML=tn+nn,e.dataset.wbInjected="1";try{const n=window._currentLang||localStorage.getItem("mrpilot_lang")||"th",a=window.I18N;a&&a[n]&&(e.querySelectorAll("[data-i18n]").forEach(o=>{const s=o.getAttribute("data-i18n");a[n][s]&&(o.textContent=a[n][s])}),e.querySelectorAll("[data-i18n-placeholder]").forEach(o=>{const s=o.getAttribute("data-i18n-placeholder");a[n][s]&&(o.placeholder=a[n][s])}))}catch{}}})();(function(){const e={"page-integration":`
        <div class="coming-soon">
            <svg class="cs-icon" viewBox="0 0 48 48" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
...
`,e.dataset.wbInjected="1";try{const n=window._currentLang||localStorage.getItem("mrpilot_lang")||"th",a=window.I18N;a&&a[n]&&e.querySelectorAll("[data-i18n]").forEach(o=>{const s=o.getAttribute("data-i18n");a[n][s]&&(o.textContent=a[n][s])})}catch{}}})();function an(e,n){const a=document.getElementById("alert-"+e);a&&(document.getElementById("alert-"+e+"-text").textContent=n,a.classList.add("show"))}function on(){["info","warn","error"].forEach(e=>{document.getElementById("alert-"+e).classList.remove("show")})}function sn(e,n){if(e==null)return n||"操作失败";if(typeof e=="string")return e;if(Array.isArray(e)){const a=e[0]||{};return a.msg?a.msg:n||"请求格式错误"}if(typeof e=="object"){if(e.code){const a="err."+e.code;try{const o=t(a,e);if(o&&o!==a)return o}catch(o){console.warn("[i18n] t() failed for key:",a,o)}return e.code}if(e.message)return e.message;if(e.error)return e.error;if(e.detail&&typeof e.detail=="string")return e.detail;try{return JSON.stringify(e).slice(0,160)}catch{}}return n||String(e)}function rn(e){if(!e)return"";const n=String(e);return/ECONNREFUSED|Connection refused/i.test(n)?"连接被拒绝 · ERP 地址可能错了,或服务没启动":/listing fetch failed|wait_for_selector/i.test(n)?"拉取 MR.ERP 客户/商品列表超时 · 已重试 3 次仍不通 · 可能 MR.ERP 响应慢 · 稍后再试":/ETIMEDOUT|timeout/i.test(n)?"连接超时 · MR.ERP 响应慢 · 稍后再试":/ENOTFOUND|getaddrinfo/i.test(n)?"域名解析失败 · ERP 地址拼错了":/certificate|SSL/i.test(n)?"SSL 证书问题 · ERP 站点证书异常":/401|Unauthorized/i.test(n)?"HTTP 401 · 认证失败,检查 Token 是否正确":/403|Forbidden/i.test(n)?"HTTP 403 · 权限不足,ERP 拒绝访问":/404|Not Found/i.test(n)?"HTTP 404 · URL 路径不存在":/^5\d\d/.test(n)||/500|502|503|504/.test(n)?"ERP 服务器错误 · 不是你的问题,等会儿再试":n}function ln(e,n,a){let o=document.getElementById("mp-toast-wrap");o||(o=document.createElement("div"),o.id="mp-toast-wrap",document.body.appendChild(o)),n=n||"success",n==="ok"&&(n="success"),n==="warning"&&(n="warn"),n==="danger"&&(n="error");const s={success:'<path d="M3 8l3 3 7-7"/>',error:'<circle cx="8" cy="8" r="6"/><path d="M5.5 5.5l5 5M10.5 5.5l-5 5"/>',warn:'<path d="M8 2L1.5 13h13L8 2z"/><path d="M8 7v3M8 12v.01"/>',info:'<circle cx="8" cy="8" r="6"/><path d="M8 5.5v.01M8 8v3"/>',loading:'<path d="M8 1a7 7 0 017 7" stroke-linecap="round" class="mp-toast-spin"/>'},p=document.createElement("div");p.className="mp-toast "+n,p.innerHTML=`
    ...
    `,o.appendChild(p),requestAnimationFrame(()=>p.classList.add("show"));const r=typeof a=="number"?a:2500;let f=null;const i=()=>{f&&(clearTimeout(f),f=null),p.classList.remove("show"),setTimeout(()=>{try{p.remove()}catch{}},300)};return r>0&&(f=setTimeout(i,r)),i}window.showAlert=an;window.hideAlerts=on;window._humanizeBackendError=sn;window.humanizeError=rn;window.showToast=ln;function cn(e){if(e){try{if(typeof shouldHideMoney=="function"&&shouldHideMoney(_userInfo)&&["team","api","plan","company"].indexOf(e)>=0){e="profile";try{localStorage.setItem("mrpilot_settings_tab","profile")}catch{}}}catch{}document.querySelectorAll(".settings-tab").forEach(n=>{n.classList.toggle("active",n.dataset.tab===e)}),document.querySelectorAll(".settings-pane").forEach(n=>{n.classList.toggle("active",n.dataset.pane===e)});try{localStorage.setItem("mrpilot_settings_tab",e)}catch{}try{e==="about"&&typeof window.loadAboutPanel=="function"&&window.loadAboutPanel(),e==="notifications"&&typeof window.loadPrefsSettings=="function"&&window.loadPrefsSettings(),e==="team"&&loadTeamList(),e==="learned"&&typeof window.loadLearnedRules=="function"&&window.loadLearnedRules(),e==="plan"&&typeof st=="function"&&st()}catch(n){console.warn("settings tab side effect failed:",n)}}}function dn(e){if(!e)return;const n=(a,o)=>{const s=document.getElementById(a);s&&(s.value=o||"")};n("profile-username",e.username||""),n("profile-email",e.username||""),n("profile-fullname",e.full_name||""),n("profile-phone",e.phone||""),n("profile-country",e.country||"TH"),n("profile-line",e.line_id||""),n("company-name",e.company_name||""),n("company-volume",e.monthly_volume||""),n("company-role",e.user_role||e.role_self||"")}async function pn(){const e=document.getElementById("btn-save-profile"),n=document.getElementById("profile-save-msg");if(!e)return;const a=e.innerHTML;e.disabled=!0,e.innerHTML=`<span>${t("msg-saving")||"保存中..."}</span>`,n&&(n.textContent="",n.classList.remove("error"));try{const o={full_name:(document.getElementById("profile-fullname")||{}).value||"",phone:(document.getElementById("profile-phone")||{}).value||"",country:(document.getElementById("profile-country")||{}).value||"TH",line_id:(document.getElementById("profile-line")||{}).value||""},s=await apiPut("/api/me/profile",o);if(s&&s.ok){n&&(n.textContent=t("msg-saved")||"已保存");try{const p=await apiGet("/api/me");_userInfo=p;try{window._userInfo=p}catch{}renderBrandWorkspace()}catch{}}else throw new Error("save failed")}catch{n&&(n.textContent=t("msg-save-failed")||"保存失败",n.classList.add("error"))}finally{e.disabled=!1,e.innerHTML=a,setTimeout(()=>{n&&(n.textContent="")},3e3)}}async function un(){const e=document.getElementById("btn-save-company"),n=document.getElementById("company-save-msg");if(!e)return;const a=e.innerHTML;e.disabled=!0,e.innerHTML=`<span>${t("msg-saving")||"保存中..."}</span>`,n&&(n.textContent="",n.classList.remove("error"));try{const o={company_name:(document.getElementById("company-name")||{}).value||"",monthly_volume:(document.getElementById("company-volume")||{}).value||"",role:(document.getElementById("company-role")||{}).value||""},s=await apiPut("/api/me/profile",o);if(s&&s.ok){n&&(n.textContent=t("msg-saved")||"已保存");try{const p=await apiGet("/api/me");_userInfo=p;try{window._userInfo=p}catch{}renderBrandWorkspace()}catch{}}else throw new Error("save failed")}catch{n&&(n.textContent=t("msg-save-failed")||"保存失败",n.classList.add("error"))}finally{e.disabled=!1,e.innerHTML=a,setTimeout(()=>{n&&(n.textContent="")},3e3)}}function st(){if(!_userInfo)return;typeof window.loadAboutPanel=="function"&&window.loadAboutPanel(),typeof window.loadPrefsSettings=="function"&&window.loadPrefsSettings();const e=document.getElementById("settings-info");if(!e)return;const n=_userInfo;if(n.is_super_admin){e.innerHTML=`
        ...
        `;const o=document.getElementById("api-key-card");o&&(o.style.display="");return}fn(n,e);const a=document.getElementById("api-key-card");if(a){const o=tt==="byo_api"||_userInfo&&_userInfo.is_super_admin;a.style.display=o?"":"none"}}function fn(e,n){const a=escapeHtml(e.username||e.email||"");n.innerHTML=`
        <table style="width:100%; font-size:13px; border-collapse: collapse;">
            <tr>
    ...
    `;let s=_results.map((r,f)=>({...r,_idx:f}));if(_searchKeyword){const r=_searchKeyword.toLowerCase();s=s.filter(f=>(f.filename||"").toLowerCase().includes(r)||(f.merged_fields.invoice_number||"").toLowerCase().includes(r))}_sortKey&&s.sort((r,f)=>{let i,c;return _sortKey==="filename"?(i=r.filename,c=f.filename):_sortKey==="invoice_no"?(i=r.merged_fields.invoice_number,c=f.merged_fields.invoice_number):_sortKey==="invoice_date"?(i=r.merged_fields.date,c=f.merged_fields.date):_sortKey==="total"?(i=parseFloat(r.merged_fields.total_amount)||0,c=parseFloat(f.merged_fields.total_amount)||0):_sortKey==="confidence"?(i=r.confidence,c=f.confidence):(i="",c=""),i<c?_sortDir==="asc"?-1:1:i>c?_sortDir==="asc"?1:-1:0});const p=document.getElementById("results-tbody");p.innerHTML=s.map((r,f)=>{const i=r.merged_fields,c=`<span class="empty-cell">${t("empty-val")}</span>`,l="conf-tip-"+(r.confidence||"low"),d="conf-"+(r.confidence||"low"),u=t(l),b=t(d);return`
            <tr data-idx="${r._idx}">
                <td class="num">${f+1}</td>
                ...
                <td><span class="conf-badge ${r.confidence}" data-tip="${escapeHtml(u)}">${b}</span></td>
            </tr>
        `}).join(""),document.querySelectorAll("#results-table th").forEach(r=>{r.classList.remove("sort-asc","sort-desc"),r.dataset.sort===_sortKey&&r.classList.add("sort-"+_sortDir)}),p.querySelectorAll("tr").forEach(r=>{r.addEventListener("click",()=>{const f=parseInt(r.dataset.idx,10);Bt(f)})})}document.querySelectorAll("#results-table th").forEach(e=>{e.classList.contains("no-sort")||e.addEventListener("click",()=>{const n=e.dataset.sort;_sortKey===n?_sortDir=_sortDir==="asc"?"desc":"asc":(_sortKey=n,_sortDir="asc"),Je()})});let yt=null;document.getElementById("search-input").addEventListener("input",e=>{const n=e.target.value;document.getElementById("search-clear").style.display=n?"":"none",clearTimeout(yt),yt=setTimeout(()=>{_searchKeyword=n.trim(),Je(),Et()},200)});document.getElementById("search-clear").addEventListener("click",()=>{const e=document.getElementById("search-input");e.value="",_searchKeyword="",document.getElementById("search-clear").style.display="none",Je(),Et(),e.focus()});function Et(){const e=document.getElementById("search-matches");if(!e)return;if(!_searchKeyword){e.textContent="";return}const n=_searchKeyword.toLowerCase();let a=0;for(const o of _results)[o.filename,o.merged_fields?.invoice_number,o.merged_fields?.seller_name,o.merged_fields?.buyer_name].filter(Boolean).join(" ").toLowerCase().includes(n)&&a++;e.textContent=t("search-matches",{n:a})}function Bt(e){_drawerIdx=e;const n=_results[e];if(!n)return;document.getElementById("drawer-title").textContent=n.filename;const a=n.engine==="cache"||n.from_cache,o=a?t("badge-cached-hint"):`${(n.elapsed_ms/1e3).toFixed(1)}s`;document.getElementById("drawer-sub").innerHTML=`
    ...
    `,c=p?"":`<span class="tax-badge unverified" data-tip="${escapeHtml(t("tax-tip-unverified"))}">${t("tax-unverified")}</span>`;if(f.innerHTML=`
        ...
        <div class="drawer-section">
            ...
            ${ye("seller_tax","drawer-lbl-tax",r.seller_tax,"input",s,c,wt("seller"))}
        ...
        <div class="drawer-section">
            ...
            ${ye("buyer_tax","drawer-lbl-tax",r.buyer_tax,"input",s,c,wt("buyer"))}
        ...
        <div class="drawer-section">
            ...
            ${r.items&&r.items.length>0?vn(r.items):`<div class="drawer-items-empty">${t("drawer-items-empty")}</div>`}
        </div>
...
`))}</pre>
    ...
    `}function wt(e){return _userInfo&&_userInfo.can_verify_tax?`
    ...
    `;n.innerHTML=o+s,e.appendChild(n)}function at(){const e=document.getElementById("export-dropdown");e&&e.remove()}const ot=document.getElementById("btn-export-arrow");ot&&ot.addEventListener("click",e=>{e.stopPropagation(),!ot.disabled&&kn()});document.addEventListener("click",e=>{const n=e.target.closest(".export-dd-item");if(n){const a=n.getAttribute("data-tpl");if(a==="__custom"){at(),showToast(t("cs-coming-soon"),"info");return}wn(a),at(),Ct(a);return}e.target.closest("#btn-export-arrow")||at()});function _n(){const e=document.getElementById("btn-export-arrow"),n=document.getElementById("btn-export");e&&n&&(e.disabled=n.disabled)}setInterval(_n,300);function ct(){const e=document.getElementById("history-batch-bar"),n=document.getElementById("history-batch-count"),a=document.getElementById("history-check-all");if(!e||!n)return;const o=_historySelected.size;if(o>0?(e.style.display="",n.textContent=t("history-batch-count",{n:o})):e.style.display="none",a){const s=_historyState.items||[];if(s.length===0)a.checked=!1,a.indeterminate=!1;else{const p=s.filter(r=>_historySelected.has(r.id)).length;a.checked=p===s.length,a.indeterminate=p>0&&p<s.length}}}function xn(){_historySelected.clear(),ct()}async function dt(){if(!_userInfo){setTimeout(()=>dt(),300);return}const e=document.getElementById("history-free-block"),n=document.getElementById("history-main"),a=document.getElementById("history-empty");if(!e||!n||!a){console.warn("[History] container missing");return}if(!_userInfo.can_view_history){e.style.display="",n.style.display="none",a.style.display="none";return}e.style.display="none",_historyState.loading=!0;try{const o=_historyState.page*_historyState.pageSize,s=new URLSearchParams({limit:_historyState.pageSize,offset:o});_historyState.keyword&&s.set("keyword",_historyState.keyword);const p=typeof window.getCurrentClientId=="function"?window.getCurrentClientId():null;p&&s.set("client_id",String(p));const r=await fetch(`/api/history?${s}`,{headers:{Authorization:"Bearer "+token}});if(r.status===401){localStorage.removeItem("mrpilot_token");const c=await r.json().catch(()=>({}));if((typeof c.detail=="string"?c.detail:c.detail&&c.detail.code||"")==="auth.session_revoked"){_showSessionRevokedModal();return}window.location.href="/";return}const f=await r.json();_historyState.items=f.items||[],_historyState.total=f.total||0;const i=new Set(_historyState.items.map(c=>c.id));for(const c of Array.from(_historySelected))i.has(c)||_historySelected.delete(c);St()}catch(o){console.error("load history failed",o)}finally{_historyState.loading=!1}}function St(){const e=document.getElementById("history-main"),n=document.getElementById("history-empty"),a=_historyState.items,o=document.getElementById("history-search-matches");if(o&&(o.textContent=_historyState.keyword?t("search-matches",{n:_historyState.total}):""),a.length===0&&_historyState.total===0&&!_historyState.keyword){e.style.display="none",n.style.display="";return}e.style.display="",n.style.display="none";let s=0;a.forEach(c=>{c.confidence==="high"&&s++});const p=a.length>0?Math.round(s/a.length*100):0;document.getElementById("history-stats").innerHTML=`
        <div class="rh-stat">
    ...
    `;const r=document.getElementById("history-tbody");a.length===0?r.innerHTML=`<div class="history-row-empty">${escapeHtml(t("history-empty-title"))}</div>`:r.innerHTML=a.map(c=>{const l=new Date(c.created_at),d=String(l.getMonth()+1).padStart(2,"0"),u=String(l.getDate()).padStart(2,"0"),b=String(l.getHours()).padStart(2,"0"),k=String(l.getMinutes()).padStart(2,"0"),D=`${d}-${u} ${b}:${k}`,E=escapeHtml(c.filename||""),x=E.length>50?E.substring(0,50)+"…":E,I=c.invoice_no?escapeHtml(c.invoice_no):x,N=[];c.seller_name&&N.push(escapeHtml(c.seller_name)),c.invoice_no&&c.filename&&N.push(x);const M=N.join(" · ")||"-",F=c.category_tag?`<span class="history-badge category">${escapeHtml(c.category_tag)}</span>`:"",H=c.source_total&&c.source_total>1?`<span class="history-badge multi">${escapeHtml(t("invoice-part-of",{i:c.source_index||1,n:c.source_total}))}</span>`:"",y=c.total_amount!==null&&c.total_amount!==void 0?Number(c.total_amount).toLocaleString(void 0,{minimumFractionDigits:2,maximumFractionDigits:2}):'<span class="history-cell-amount-empty">—</span>',v=[];(c.total_amount===null||c.total_amount===void 0)&&v.push(t("field-amount")),c.invoice_no||v.push(t("field-invoice-no")),c.invoice_date||v.push(t("field-invoice-date")),c.seller_name||v.push(t("field-seller-name")),v.length>0&&`${escapeHtml(c.id)}${escapeHtml(t("history-needs-review-tip")+" · "+v.join(" · "))}${escapeHtml(t("history-needs-review-tip"))}${svgIcon("alert",14)}`,c.edited&&`${escapeHtml(t("history-edited",{n:c.edit_count||1}))}`;const g=c.smart_assigned_flag?`<span class="history-badge smart-assigned" title="${escapeHtml(t("history-smart-assigned"))}">${svgIcon("sparkle",11)}</span>`:"",L=c.confidence==="high"?"high":c.confidence==="medium"?"mid":"low",C=c.confidence==="high"?t("conf-high"):c.confidence==="medium"?t("conf-medium"):t("conf-low"),j=`<span class="history-badge conf-${L}">${escapeHtml(C)}</span>`;let B="";const A=c.source||"manual";return A==="email"?B=`<span class="history-badge source source-email" title="${escapeHtml(t("history-source-email"))}">${svgIcon("mail",11)}<span>${escapeHtml(t("history-source-email"))}</span></span>`:A==="folder"?B=`<span class="history-badge source source-folder" title="${escapeHtml(t("history-source-folder"))}">${svgIcon("folder",11)}<span>${escapeHtml(t("history-source-folder"))}</span></span>`:A==="api"&&(B=`<span class="history-badge source source-api" title="${escapeHtml(t("history-source-api"))}">${svgIcon("api",11)}<span>${escapeHtml(t("history-source-api"))}</span></span>`),`
            ...
            `}).join(""),ct();const f=a.length>0?_historyState.page*_historyState.pageSize+1:0,i=_historyState.page*_historyState.pageSize+a.length;document.getElementById("history-pager-info").textContent=t("history-pager",{from:f,to:i,total:_historyState.total}),document.getElementById("history-prev").disabled=_historyState.page===0,document.getElementById("history-next").disabled=(_historyState.page+1)*_historyState.pageSize>=_historyState.total}window.loadHistoryPage=dt;window.renderHistoryList=St;window.updateHistoryBatchBar=ct;window.clearHistorySelection=xn;typeof currentRoute<"u"&&currentRoute==="history"&&dt();async function Ue(e){try{const n=await fetch(`/api/history/${encodeURIComponent(e)}`,{headers:{Authorization:"Bearer "+token}});if(!n.ok)return;const a=await n.json(),o=mergeFields(a.pages||[]),s={filename:a.filename,pages:a.pages,page_count:a.page_count,elapsed_ms:a.elapsed_ms,engine:"history",merged_fields:o,edits:{},confidence:a.confidence,archive_name:a.archive_name||null,category_tag:a.category_tag||null,_historyId:a.id,_historyMode:!0,client_id:a.client_id||null};_results.push(s),_drawerIdx=_results.length-1,openDrawer(_drawerIdx),Bn(),typeof window.bindDrawerClient=="function"&&window.bindDrawerClient(a.id,a.client_id||null),In(a.id)}catch(n){console.error("open history detail failed",n)}}async function En(e){await Ue(e),requestAnimationFrame(()=>{const n=document.querySelector('[data-field="total_amount"]');if(n){try{n.focus()}catch{}try{n.select()}catch{}try{n.scrollIntoView({block:"center",behavior:"smooth"})}catch{}}})}function Bn(){const e=document.getElementById("drawer-body");if(!e||document.getElementById("drawer-history-save"))return;const n=document.createElement("div");n.id="drawer-history-save",n.className="drawer-history-save-bar",n.innerHTML=`
    ...
    `,e.appendChild(n),document.getElementById("btn-save-history").addEventListener("click",Cn),document.getElementById("btn-push-erp").addEventListener("click",Ln)}async function In(e){}async function Ln(){showToast(t("erp-push-coming-soon")||"ERP 推送即将开放，敬请期待","info")}async function Cn(){const e=_results[_drawerIdx];if(!e||!e._historyId)return;const n=JSON.parse(JSON.stringify(e.pages||[]));if(n.length>0){const o=n.findIndex(f=>!f.is_duplicate&&!f.is_copy),s=o>=0?o:0,p=n[s].fields||(n[s].fields={}),r={...e.edits};r.category_tag!==void 0&&(r.category=r.category_tag,delete r.category_tag),Object.assign(p,r)}const a=document.getElementById("btn-save-history");a&&(a.disabled=!0);try{if(!(await fetch(`/api/history/${encodeURIComponent(e._historyId)}`,{method:"PUT",headers:{Authorization:"Bearer "+token,"Content-Type":"application/json"},body:JSON.stringify({pages:n})})).ok)throw new Error("save failed");showAlert("info",t("history-save-ok")),setTimeout(hideAlerts,1500),closeDrawer(),e._historyMode&&_results.pop(),loadHistoryPage()}catch{showAlert("error",t("history-save-fail")),a&&(a.disabled=!1)}}function Sn(e,n){document.querySelectorAll(".history-popover").forEach(c=>c.remove());const a=n.getBoundingClientRect(),o=(_historyState.items||[]).find(c=>c.id===e),s=o&&o.invoice_no?String(o.invoice_no):"",p=o&&o.has_pdf===!0,r=document.createElement("div");r.className="history-popover",r.innerHTML=`
    ...
    `;const c=document.getElementById("file-list-toggle");c&&c.addEventListener("click",()=>{Oe=!Oe,Ye()});const l=document.getElementById("file-list-body");l&&!l.dataset.retryBound&&(l.dataset.retryBound="1",l.addEventListener("click",async d=>{const u=d.target.closest(".file-retry-btn");if(!u)return;const b=parseInt(u.dataset.retryIdx||"-1",10);if(b<0||b>=_selectedFiles.length)return;const k=_selectedFiles[b];!k||k.status!=="error"||typeof window._reprocessFile=="function"&&await window._reprocessFile(k,!0)}))}function ut(){const e=document.getElementById("btn-start"),n=document.getElementById("btn-clear"),a=document.getElementById("btn-export"),o=_selectedFiles.some(s=>s.status==="waiting");e.disabled=_selectedFiles.length===0||!o,n.disabled=_selectedFiles.length===0&&_results.length===0,a.disabled=_results.length===0}document.getElementById("btn-clear").addEventListener("click",()=>{_selectedFiles=[],_results=[],Ye(),renderResults(),ut(),hideAlerts()});window.renderFileList=Ye;window.updateStartButton=ut;(function(){const n=document.getElementById("upload-alt-row"),a=document.getElementById("gallery-input"),o=document.getElementById("camera-input");if(!n)return;n.style.display="";const s=document.getElementById("btn-scan-doc");s&&o&&(s.addEventListener("click",async()=>{!(localStorage.getItem("mrpilot_camera_tips_skip")==="1")&&!await An()||o.click()}),o.addEventListener("change",async f=>{const i=Array.from(f.target.files||[]);if(f.target.value="",i.length!==0)for(const c of i)await rt([c],"camera")}));const p=document.getElementById("btn-upload-pic");p&&a&&p.addEventListener("click",()=>a.click());const r=f=>async i=>{const c=Array.from(i.target.files||[]);if(i.target.value="",c.length===0)return;const l=c.filter(u=>u.type==="application/pdf"||/\.pdf$/i.test(u.name)),d=c.filter(u=>!l.includes(u));l.length>0&&await Hn(l),d.length>0&&await rt(d,f)};a&&a.addEventListener("change",r("gallery"))})();async function Hn(e){for(const a of e)_selectedFiles.push({file:a,name:a.name,size:a.size,status:"waiting",errorKey:null,errorParams:null});const n=getMaxFiles();_selectedFiles.length>n&&(showAlert("warn",t("alert-file-count",{n})),_selectedFiles=_selectedFiles.slice(0,n)),renderFileList(),updateStartButton()}function An(){return new Promise(e=>{const n=document.getElementById("camera-tips-modal"),a=document.getElementById("camera-tips-ok"),o=document.getElementById("camera-tips-cancel"),s=document.getElementById("camera-tips-skip");if(!n||!a){e(!0);return}s&&(s.checked=!1),n.style.display="flex";const p=f=>{n.style.display="none",s&&s.checked&&localStorage.setItem("mrpilot_camera_tips_skip","1"),a.onclick=null,o&&(o.onclick=null),n.onclick=null,document.removeEventListener("keydown",r),e(f)},r=f=>{f.key==="Escape"&&p(!1)};a.onclick=()=>p(!0),o&&(o.onclick=()=>p(!1)),n.onclick=f=>{f.target===n&&p(!1)},document.addEventListener("keydown",r),setTimeout(()=>a.focus(),50)})}async function Ge(e){return new Promise(n=>{const a=new FileReader;a.onerror=()=>n({warnings:[],width:0,height:0,brightness:128}),a.onload=()=>{const o=new Image;o.onerror=()=>n({warnings:[],width:0,height:0,brightness:128}),o.onload=()=>{const s=[],p=o.naturalWidth,r=o.naturalHeight;(p<1e3||r<1e3)&&s.push("low_res");try{const f=document.createElement("canvas");f.width=64,f.height=64;const i=f.getContext("2d");i.drawImage(o,0,0,64,64);const c=i.getImageData(0,0,64,64).data;let l=0,d=0;for(let b=0;b<c.length;b+=4)l+=.299*c[b]+.587*c[b+1]+.114*c[b+2],d++;const u=d?l/d:128;u<70?s.push("too_dark"):u>235&&s.push("too_bright"),n({warnings:s,width:p,height:r,brightness:u})}catch{n({warnings:s,width:p,height:r,brightness:128})}},o.src=a.result},a.readAsDataURL(e)})}let ke=[],Le=null;async function rt(e,n){if(hideAlerts(),!(!e||e.length===0)){if(typeof window.jspdf>"u"||!window.jspdf.jsPDF){showToast(t("camera-loading"),"info");for(let a=0;a<30&&(await new Promise(o=>setTimeout(o,100)),!(window.jspdf&&window.jspdf.jsPDF));a++);if(!window.jspdf||!window.jspdf.jsPDF){showToast(t("camera-lib-fail"),"error");return}}if(n==="camera"&&e.length===1){const a=e[0];let o={};try{o=await Ge(a)}catch{}ke.push({file:a,quality:o}),Le="camera",Te();return}if(n==="gallery"&&(e.length>=2||ke.length>0)){for(const a of e){let o={};try{o=await Ge(a)}catch{}ke.push({file:a,quality:o})}Le="gallery",Te();return}await $t(e)}}async function jn(e){const n=new Set;for(const o of e)try{((await Ge(o)).warnings||[]).forEach(p=>n.add(p))}catch{}try{const o=await Mt(e);o&&_selectedFiles.push({file:o,name:o.name,size:o.size,status:"waiting",errorKey:null,errorParams:null})}catch(o){console.error("[camera] convert failed",o),showToast(t("camera-convert-fail"),"error");return}const a=getMaxFiles();_selectedFiles.length>a&&(showAlert("warn",t("alert-file-count",{n:a})),_selectedFiles=_selectedFiles.slice(0,a)),renderFileList(),updateStartButton(),showToast(t("camera-added-merged",{n:e.length}),"success"),n.size>0&&setTimeout(()=>{n.has("too_dark")?showToast(t("camera-quality-dark"),"warn"):n.has("low_res")?showToast(t("camera-quality-lowres"),"warn"):n.has("too_bright")&&showToast(t("camera-quality-overexposed"),"warn")},1e3)}function Te(){let e=document.getElementById("camera-buffer-bar");if(ke.length===0){e&&e.remove(),Le=null;return}e||(e=document.createElement("div"),e.id="camera-buffer-bar",e.className="camera-buffer-bar",document.body.appendChild(e));const n=ke.length,a=n>=2,o=Le==="gallery",s=o?t("camera-buffer-more-gallery"):t("camera-buffer-more");let p;a?o?p=`
    ...
    `,e.querySelector('[data-cbb-action="discard"]').onclick=()=>{ke=[],Le=null,Te()},e.querySelector('[data-cbb-action="more"]').onclick=()=>{const i=o?"gallery-input":"camera-input",c=document.getElementById(i);c&&c.click()};const r=e.querySelector('[data-cbb-action="merge"]');r&&(r.onclick=async()=>{const i=ke.map(c=>c.file);ke=[],Le=null,Te(),await jn(i)});const f=e.querySelector('[data-cbb-action="separate"]');f&&(f.onclick=async()=>{const i=ke.map(c=>c.file);ke=[],Le=null,Te(),await $t(i)})}typeof window.subscribeI18n=="function"&&window.subscribeI18n("camera-buffer-bar",()=>{ke.length>0&&Te()});async function $t(e){const n=new Set;let a=0;for(const s of e)try{((await Ge(s)).warnings||[]).forEach(f=>n.add(f));const r=await Mt([s]);r&&(_selectedFiles.push({file:r,name:r.name,size:r.size,status:"waiting",errorKey:null,errorParams:null}),a++)}catch(p){console.error("[camera] separate convert failed",p)}if(a===0){showToast(t("camera-convert-fail"),"error");return}const o=getMaxFiles();_selectedFiles.length>o&&(showAlert("warn",t("alert-file-count",{n:o})),_selectedFiles=_selectedFiles.slice(0,o)),renderFileList(),updateStartButton(),showToast(t("camera-added-separate",{n:a}),"success"),n.size>0&&setTimeout(()=>{n.has("too_dark")?showToast(t("camera-quality-dark"),"warn"):n.has("low_res")?showToast(t("camera-quality-lowres"),"warn"):n.has("too_bright")&&showToast(t("camera-quality-overexposed"),"warn")},1e3)}async function Mt(e){if(!e||e.length===0)return null;const{jsPDF:n}=window.jspdf,a=210,o=297,s=new n({unit:"mm",format:"a4",orientation:"p"});for(let c=0;c<e.length;c++){const l=e[c],{dataUrl:d,naturalW:u,naturalH:b}=await Pn(l);c>0&&s.addPage("a4","p");const k=u/b;let D=a-10,E=D/k;E>o-10&&(E=o-10,D=E*k);const x=(a-D)/2,I=(o-E)/2,N=l.type==="image/png"?"PNG":"JPEG";s.addImage(d,N,x,I,D,E,void 0,"FAST")}const p=s.output("blob"),r=new Date,f=r.getFullYear().toString()+String(r.getMonth()+1).padStart(2,"0")+String(r.getDate()).padStart(2,"0")+String(r.getHours()).padStart(2,"0")+String(r.getMinutes()).padStart(2,"0")+String(r.getSeconds()).padStart(2,"0"),i=e.length>1?`_${e.length}p`:"";return new File([p],`photo_${f}${i}.pdf`,{type:"application/pdf"})}function Pn(e){return new Promise((n,a)=>{const o=new FileReader;o.onerror=a,o.onload=()=>{const s=new Image;s.onerror=a,s.onload=()=>n({dataUrl:o.result,naturalW:s.naturalWidth,naturalH:s.naturalHeight}),s.src=o.result},o.readAsDataURL(e)})}window.handleCameraImages=rt;document.getElementById("btn-start").addEventListener("click",async()=>{if(hideAlerts(),document.getElementById("btn-start").disabled=!0,_userInfo&&_userInfo.plan==="free"){const l=await fetch("/api/health").then(d=>d.json()).catch(()=>null);l&&!l.ocr_ready&&(showAlert("info",t("alert-loading-engine")),startEnginePolling())}const e=_selectedFiles.filter(l=>l.status==="waiting"),n=6;async function a(l,d){if(window._ocrAborted)return l.status="cancelled",l.errorKey=null,renderFileList(),{};l.status=d?"retrying":"processing",l.canRetry=!1,renderFileList();const u=new AbortController,b=setTimeout(()=>u.abort("timeout"),9e4);window._ocrCtrls=window._ocrCtrls||new Set,window._ocrCtrls.add(u);try{const k=new FormData;k.append("file",l.file,l.name);try{if(typeof window.getCurrentClientId=="function"){const N=window.getCurrentClientId();N!=null&&k.append("client_id",String(N))}}catch{}const D=await fetch("/api/ocr/recognize",{method:"POST",headers:{Authorization:"Bearer "+token},body:k,signal:u.signal});if(clearTimeout(b),window._ocrCtrls.delete(u),D.status===401||D.status===403){const M=await D.clone().json().catch(()=>({})),F=M&&M.detail,H=typeof F=="string"?F:F&&F.code||"";if(!H||H.startsWith("auth.")){if(localStorage.removeItem("mrpilot_token"),H==="auth.session_revoked")_showSessionRevokedModal();else{const y=H==="auth.password_changed_relogin"?"alert-password-changed-relogin":"alert-session";showToast(t(y),"error"),setTimeout(()=>{window.location.href="/"},1200)}return{abort:!0}}H==="quota.need_api_key"&&showToast(t("err.quota.need_api_key"),"error")}if(!D.ok){const M=(await D.json().catch(()=>({}))).detail;return typeof M=="string"?(l.errorKey="err."+M,l.errorParams=null):M&&M.code?(l.errorKey="err."+M.code,l.errorParams={...M,mb:_quota.max_file_size_mb}):(l.errorKey="err.unknown",l.errorParams=null),(l.errorKey==="err.unknown"||l.errorKey==="err.ocr.engine_error")&&(D.status===429?l.errorKey="err.rate_limit":D.status===502||D.status===503||D.status===504?l.errorKey="err.gemini_overloaded":D.status>=500&&(l.errorKey="err.server")),l.status="error",l.canRetry=!/not_pdf|invalid_pdf|file_too_large|too_many_pages|monthly_limit_exceeded|ip_limit_exceeded|plan_not_supported|need_api_key|not_invoice/.test(l.errorKey||""),renderFileList(),{}}const E=await D.json();l.status="success",l.fromCache=!!E.from_cache;const x=mergeFields(E.pages),I=E.confidence||(x.items&&x.items.length>0?"high":"low");if(_results.push({filename:E.filename,pages:E.pages,page_count:E.page_count,elapsed_ms:E.elapsed_ms,engine:E.engine,merged_fields:x,edits:{},confidence:I,history_id:E.history_id,history_ids:E.history_ids||[],invoice_count:E.invoice_count||1,invoices:E.invoices||[],archive_name:E.archive_name||null,category_tag:E.category_tag||null,auto_pushed:!!E.auto_pushed,typhoon_enhanced:!!E.typhoon_enhanced,typhoon_pages:E.typhoon_pages||[],from_cache:!!E.from_cache}),E.invoice_count&&E.invoice_count>1&&showToast(t("multi-invoice-toast",{file:E.filename,n:E.invoice_count}),"success"),E.missed_invoice_warnings&&E.missed_invoice_warnings.length){const N=E.missed_invoice_warnings.map(function(M){return M.page}).filter(function(M){return M!=null});showToast(t("missed-invoice-warn",{file:E.filename,pages:N.join(", ")}),"warn",8e3),console.warn("[OCR] possible missed invoice(s)",E.missed_invoice_warnings)}if(E.typhoon_enhanced&&E.typhoon_pages&&E.typhoon_pages.length&&showToast(t("typhoon-enhanced-toast",{file:E.filename,n:E.typhoon_pages.length}),"success"),E.fallback_used){const N=E.engine_chain||[],M=E.engine||"";let F;M==="typhoon_nvidia"?F="fallback-typhoon-nvidia-toast":M==="easyocr"?F="fallback-easyocr-toast":F="fallback-generic-toast",showToast(t(F,{file:E.filename}),"warn"),console.info("[OCR Chain]",N)}if(E.from_cache&&showToast(t("cache-hit-toast",{file:E.filename}),"info"),E.duplicate_warnings&&E.duplicate_warnings.length){window._dupQueue||(window._dupQueue=[]);for(const N of E.duplicate_warnings)window._dupQueue.push({filename:E.filename,...N})}return E.auto_pushed&&showToast(t("auto-push-fired",{file:E.filename}),"info"),E.quota&&E.quota.used_this_month!=null&&_userInfo&&(_userInfo.used_this_month=E.quota.used_this_month,_userInfo.tenant_used=E.quota.used_this_month,renderInfoBar(),renderQuotaBanner()),renderFileList(),renderResults(),updateStartButton(),{}}catch(k){clearTimeout(b);try{window._ocrCtrls&&window._ocrCtrls.delete(u)}catch{}console.error("[Upload] failed for",l.file.name,k);const D=k&&(k.name==="AbortError"||k==="timeout"),E=D&&(u.signal.reason==="timeout"||k==="timeout"),x=k&&k.message&&/NetworkError|Failed to fetch/i.test(k.message);return D&&(u.signal.reason==="user_stop"||window._ocrAborted)?(l.status="cancelled",l.errorKey=null,l.canRetry=!1,renderFileList(),{}):(E?l.errorKey="err.timeout":D?l.errorKey="err.aborted":x?l.errorKey="err.network":(l.errorKey="err.unknown",l.errorParams={msg:k&&k.message?k.message:String(k)}),l.status="error",!d&&!window._ocrAborted&&(x||E)&&navigator.onLine!==!1&&(l.canRetry=!0,renderFileList(),await new Promise(N=>setTimeout(N,2e3)),l.status==="error"&&navigator.onLine!==!1&&!window._ocrAborted)?a(l,!0):(l.canRetry=!0,renderFileList(),{}))}}window._reprocessFile=a;let o=0,s=!1;async function p(){for(;o<e.length&&!s&&!window._ocrAborted;){const l=o++,d=await a(e[l]);if(d&&d.abort){s=!0;return}}}window._ocrAborted=!1,window._ocrCtrls=window._ocrCtrls||new Set;const r=document.getElementById("btn-start"),f=document.getElementById("btn-stop");r&&(r.style.display="none"),f&&(f.style.display="");try{typeof window._bigBatchStart=="function"&&window._bigBatchStart(e)}catch{}const i=[];for(let l=0;l<Math.min(n,e.length);l++)i.push(p());await Promise.all(i);try{typeof window._bigBatchStop=="function"&&window._bigBatchStop()}catch{}r&&(r.style.display=""),f&&(f.style.display="none");const c=!!window._ocrAborted;window._ocrAborted=!1,window._ocrCtrls.clear(),updateStartButton(),stopEnginePolling(),document.getElementById("alert-info").classList.contains("show")&&(showAlert("info",t("alert-engine-ready")),setTimeout(hideAlerts,2e3));try{const l={success:0,cancelled:0,network:0,timeout:0,quota:0,overloaded:0,rate:0,other:0};for(const u of e)if(u.status==="success")l.success++;else if(u.status==="cancelled")l.cancelled++;else if(u.status==="error"){const b=u.errorKey||"";b==="err.network"?l.network++:b==="err.timeout"||b==="err.aborted"?l.timeout++:b.indexOf("quota")>=0||b==="err.monthly_limit_exceeded"?l.quota++:b==="err.gemini_overloaded"||b==="err.server"?l.overloaded++:b==="err.rate_limit"?l.rate++:l.other++}const d=e.length;c?showToast(Dn(l,d),"warn",4e3):d>1&&l.network+l.timeout+l.quota+l.overloaded+l.rate+l.other>0&&showToast(qn(l),"error",4500)}catch{}window._dupQueue&&window._dupQueue.length&&showDuplicateDialog()});function Dn(e,n){return t("ocr-summary-aborted").replace("{success}",e.success).replace("{cancelled}",e.cancelled).replace("{total}",n)}function qn(e){const n=[];return e.success&&n.push(t("ocr-summary-success").replace("{n}",e.success)),e.network&&n.push(t("ocr-summary-network").replace("{n}",e.network)),e.timeout&&n.push(t("ocr-summary-timeout").replace("{n}",e.timeout)),e.quota&&n.push(t("ocr-summary-quota").replace("{n}",e.quota)),e.overloaded&&n.push(t("ocr-summary-overloaded").replace("{n}",e.overloaded)),e.rate&&n.push(t("ocr-summary-rate").replace("{n}",e.rate)),e.other&&n.push(t("ocr-summary-other").replace("{n}",e.other)),n.join(" · ")}document.addEventListener("click",e=>{if(!e.target.closest("#btn-stop")||window._ocrAborted)return;window._ocrAborted=!0,window._ocrCtrls&&window._ocrCtrls.size&&window._ocrCtrls.forEach(a=>{try{a.abort("user_stop")}catch{}});const n=document.getElementById("btn-stop");n&&(n.disabled=!0),typeof showToast=="function"&&showToast(t("ocr-stop-toast"),"warn",2e3),setTimeout(()=>{n&&(n.disabled=!1)},800)});function Ht(){if(!window._dupQueue||!window._dupQueue.length)return;const e=window._dupQueue.shift(),n=e.level==="exact",a=n?"dup-title-exact":"dup-title-likely",o=n?"dup-desc-exact":"dup-desc-likely",s=n?"#DC2626":"#D97706",p=n?"#FEE2E2":"#FEF3C7",r=b=>b!=null?Number(b).toLocaleString(void 0,{minimumFractionDigits:2,maximumFractionDigits:2}):"—",f=b=>b||"—",i=b=>{try{const k=new Date(b);return`${k.getFullYear()}-${String(k.getMonth()+1).padStart(2,"0")}-${String(k.getDate()).padStart(2,"0")}`}catch{return b}},c=e.invoice_total>1?` · ${t("invoice-part-of",{i:e.invoice_index,n:e.invoice_total})}`:"",l=(e.matched_fields||[]).map(b=>{const k=t("dup-field-"+b.replace("_","-"))||b;return`<span class="dup-field-chip">${escapeHtml(k)}</span>`}).join(" "),d=document.createElement("div");d.className="log-detail-modal",d.innerHTML=`
    ...
    <div class="modal" style="max-width:480px">
        ...
        <div class="modal-foot">
            ...
            <div class="access-log-row access-log-head">
                ...
                </div>`}).join("");l.innerHTML=u+b}function s(){const l=document.getElementById("access-log-pager");if(!l)return;const d=e.total||0;if(!d){l.innerHTML="";return}const u=e.page||1,b=e.per_page,k=Math.max(1,Math.ceil(d/b)),D=(t("set-access-log-pager-total")||"Total {n}").replace("{n}",d),E=(t("set-access-log-pager-page")||"Page {p} / {t}").replace("{p}",u).replace("{t}",k);l.innerHTML=`
            ...
            </div>`}async function p(l){const d=localStorage.getItem("mrpilot_token");if(d){e.page=l||1,a(t("set-access-log-loading"));try{const u="/api/me/access_log?page="+e.page+"&per_page="+e.per_page+"&q="+encodeURIComponent(e.q||""),b=await fetch(u,{headers:{Authorization:"Bearer "+d}});if(b.status===403){a(t("set-access-log-empty"));return}if(!b.ok)throw new Error("http_"+b.status);const k=await b.json();e.rows=k.logs||[],e.total=k.total||0,e.loaded=!0,o(),s()}catch{a(t("set-access-log-fail"))}}}async function r(){const l=localStorage.getItem("mrpilot_token");if(l)try{const d="/api/me/access_log.csv?q="+encodeURIComponent(e.q||""),u=await fetch(d,{headers:{Authorization:"Bearer "+l}});if(!u.ok){showToast(t("set-access-log-csv-fail")||"Export failed","error");return}const b=await u.blob(),k=document.createElement("a"),D=URL.createObjectURL(b);k.href=D,k.download="pearnly_access_log.csv",document.body.appendChild(k),k.click(),setTimeout(function(){URL.revokeObjectURL(D),k.remove()},100),showToast(t("set-access-log-csv-ok")||"Exported","success")}catch{showToast(t("set-access-log-csv-fail")||"Export failed","error")}}function f(){const l=document.querySelectorAll(".set-tab-owner-only"),d=!!(_userInfo&&(_userInfo.role==="owner"||_userInfo.is_super_admin));l.forEach(function(u){u.style.display=d?"":"none"})}document.addEventListener("click",function(l){if(l.target.closest('.settings-tab[data-tab="access-log"]')){setTimeout(function(){(!e.loaded||e.page!==1)&&p(1)},50);return}if(l.target.closest("#access-log-csv-btn")){l.preventDefault(),r();return}const b=l.target.closest(".access-log-pager-btn[data-access-log-page]");if(b&&!b.disabled){const k=parseInt(b.dataset.accessLogPage,10);p(k)}}),document.addEventListener("input",function(l){l.target&&l.target.id==="access-log-search"&&(clearTimeout(window.__accessLogSearchTimer),window.__accessLogSearchTimer=setTimeout(function(){e.q=(l.target.value||"").trim(),p(1)},350))});let i=0;const c=setInterval(function(){i++,_userInfo&&(f(),clearInterval(c)),i>60&&clearInterval(c)},500);typeof window.subscribeI18n=="function"&&window.subscribeI18n("me-access-log",function(){f(),e.loaded&&(o(),s())})})();(function(){const e=document.getElementById("notif-new-modal");if(!(!e||e.dataset.wbInjected==="1")){e.innerHTML=`
...
`,e.dataset.wbInjected="1";try{const n=window._currentLang||localStorage.getItem("mrpilot_lang")||"th",a=window.I18N;a&&a[n]&&(e.querySelectorAll("[data-i18n]").forEach(o=>{const s=o.getAttribute("data-i18n");a[n][s]&&(o.textContent=a[n][s])}),e.querySelectorAll("[data-i18n-placeholder]").forEach(o=>{const s=o.getAttribute("data-i18n-placeholder");a[n][s]&&(o.placeholder=a[n][s])}))}catch{}}})();(function(){const e=H=>document.getElementById(H);async function n(H,y){return await fetch(H,{method:"PATCH",headers:{Authorization:"Bearer "+token,"Content-Type":"application/json"},body:JSON.stringify(y||{})})}async function a(H){return await fetch(H,{method:"DELETE",headers:{Authorization:"Bearer "+token}})}let o=null;async function s(){try{o=await apiGet("/api/line/binding")}catch{o={bound:!1}}return o}function p(H,y){if(!H)return;H.style.display="",H.className="notif-line-check "+(y?"bound":"unbound");const v=y?'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M20 6 9 17l-5-5"/></svg>':'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><path d="M12 8v4M12 16h.01"/></svg>';H.innerHTML=v+"<span>"+escapeHtml(t(y?"notif-line-bound":"notif-line-not-bound"))+"</span>"}function r(H){if(H==null)return"-";const y=Number(H);return isNaN(y)?String(H):"฿ "+y.toLocaleString("en-US",{minimumFractionDigits:2,maximumFractionDigits:2})}function f(H){if(!H)return"-";try{const y=new Date(H),v=(y.getMonth()+1).toString().padStart(2,"0"),g=y.getDate().toString().padStart(2,"0"),L=y.getHours().toString().padStart(2,"0"),C=y.getMinutes().toString().padStart(2,"0");return`${v}-${g} ${L}:${C}`}catch{return H}}function i(H){const y=e("notif-rules-list"),v=e("notif-rules-empty"),g=e("notif-rules-count");if(!(!y||!v)){if(g.textContent=String(H.length),g.className="auto-status-pill "+(H.length>0?"active":"none"),!H.length){v.style.display="",y.style.display="none",y.innerHTML="";return}v.style.display="none",y.style.display="",y.innerHTML=H.map(L=>{const C=L.template_code==="large_invoice",j=C?"notif-rule-large-tag":"notif-rule-exception-tag",B=C?"large":"";let A=[];if(C){const G=L.params&&L.params.threshold?r(L.params.threshold):"-";A.push(escapeHtml(t("notif-rule-threshold-prefix"))+" "+G)}L.enabled||A.push('<span style="color:#9ca3af;">'+escapeHtml(t("notif-rule-disabled"))+"</span>");const Y=A.length?A.join(' <span class="dot"></span> '):"";return`
...
`,e.dataset.wbInjected="1";try{const n=window._currentLang||localStorage.getItem("mrpilot_lang")||"th",a=window.I18N;a&&a[n]&&(e.querySelectorAll("[data-i18n]").forEach(o=>{const s=o.getAttribute("data-i18n");a[n][s]&&(o.textContent=a[n][s])}),e.querySelectorAll("[data-i18n-placeholder]").forEach(o=>{const s=o.getAttribute("data-i18n-placeholder");a[n][s]&&(o.placeholder=a[n][s])}))}catch{}}})();(function(){const e=document.getElementById("archive-token-modal");if(!(!e||e.dataset.wbInjected==="1")){e.innerHTML=`
        ...
        </div>`,l=document.createElement("div");l.innerHTML=c,document.body.appendChild(l.firstElementChild),document.getElementById("report-modal-close-x").addEventListener("click",a),document.getElementById("report-modal-cancel").addEventListener("click",a),document.getElementById("report-modal").addEventListener("click",d=>{d.target.id==="report-modal"&&a()})}function a(){const c=document.getElementById("report-modal");c&&(c.style.display="none"),o=null}let o=null;async function s(c,l){const d=c+":"+(l||"");if(e[d])return e[d];let u;try{const b=localStorage.getItem("mrpilot_token"),k=await fetch(`/api/reports/templates?lang=${encodeURIComponent(c)}`,{headers:{Authorization:"Bearer "+b}});if(!k.ok)throw new Error("templates fetch failed");u=(await k.json()).templates||[]}catch(b){console.error("fetchTemplates fail",b),u=[{code:"input_vat",name:t("tpl-input-vat"),desc:t("tpl-input-vat-desc"),recommended:!0},{code:"standard",name:t("tpl-standard"),desc:t("tpl-standard-desc"),recommended:!1},{code:"print",name:t("tpl-print"),desc:t("tpl-print-desc"),recommended:!1}]}if(u=u.filter(b=>b.code!=="erp"),l==="history-batch"){const b=u.findIndex(D=>D.code==="standard"),k=b>=0?b+1:u.length;u.splice(k,0,{code:"sales_detail_th",name:t("export-tpl-sales-detail"),desc:t("export-tpl-sales-detail-desc"),recommended:!1,is_new:!0})}return e[d]=u,u}function p(c){const l=document.getElementById("report-tpl-list"),d=c.map((b,k)=>`
            <label class="report-tpl-item${b.recommended?" is-recommended":""}">
                ...
                <div class="report-tpl-content">
                    <div class="report-tpl-name">
                        ${r(b.name)}
                        ${b.recommended?`<span class="report-tpl-badge">${r(t("report-recommended"))}</span>`:""}
                    </div>
                    <div class="report-tpl-desc">${r(b.desc||"")}</div>
                </div>
            </label>
        `).join(""),u=`
...
`,e.dataset.wbInjected="1";try{const n=window._currentLang||localStorage.getItem("mrpilot_lang")||"th",a=window.I18N;a&&a[n]&&(e.querySelectorAll("[data-i18n]").forEach(o=>{const s=o.getAttribute("data-i18n");a[n][s]&&(o.textContent=a[n][s])}),e.querySelectorAll("[data-i18n-placeholder]").forEach(o=>{const s=o.getAttribute("data-i18n-placeholder");a[n][s]&&(o.placeholder=a[n][s])}))}catch{}}})();(function(){let e=[],n=null,a="",o="seller";const s={page:0,pageSize:12,keyword:""},p=new Set;let r=[];const f={keyword:""};let i=null;function c(){return{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||"")}}async function l(h,P={}){const R=await fetch(h,{...P,headers:{"Content-Type":"application/json",...c(),...P.headers||{}}});if(!R.ok){const K=await R.json().catch(()=>({}));throw new Error(K.detail||"HTTP "+R.status)}return R.json()}async function d(){try{e=(await l("/api/clients")).clients||[],window._clientsCache=e}catch(h){console.error("loadClientsCache fail",h),e=[]}try{typeof window._refreshExcClientFilter=="function"&&window._refreshExcClientFilter()}catch{}try{typeof window._refreshClientSwitcher=="function"&&window._refreshClientSwitcher()}catch{}return e}function u(h){o=h==="buyer"?"buyer":"seller",document.querySelectorAll("[data-cust-tab]").forEach(K=>K.classList.toggle("active",K.dataset.custTab===o));const P=document.getElementById("cust-pane-seller"),R=document.getElementById("cust-pane-buyer");P&&P.classList.toggle("active",o==="seller"),R&&R.classList.toggle("active",o==="buyer")}function b(){const h=window._userInfo||{},P=String(h.role||"").toLowerCase(),R=String(h.tenant_role||"").toLowerCase();return h.is_super_admin===!0||h.is_owner===!0||P==="owner"||P==="admin"||R==="owner"||R==="admin"}function k(){window._workspaceClientsCache=r,typeof window.renderWorkspaceControl=="function"&&window.renderWorkspaceControl()}async function D(){try{const h=await l("/api/workspace/clients");r=h&&(h.clients||h.items)||[],window._workspaceClientsCache=r}catch(h){console.error("loadSellerCache fail",h),r=[]}return r}function E(){const h=f.keyword.trim().toLowerCase();return h?r.filter(P=>(P.name||"").toLowerCase().includes(h)||(P.tax_id||"").toLowerCase().includes(h)):r}function x(){const h=document.getElementById("seller-tbody");if(!h)return;const P=b(),R=document.getElementById("btn-seller-new");R&&(R.style.display=P?"":"none");const K=E(),Q=typeof window.getActiveWorkspaceClientId=="function"?window.getActiveWorkspaceClientId():null;if(!K.length){h.innerHTML=`<div class="cust-empty">${escapeHtml(t(f.keyword?"cust-no-match":"seller-empty"))}</div>`;return}h.innerHTML=K.map(le=>{const V=Q!=null&&Number(Q)===Number(le.id)?`<span class="cust-badge-current"><svg viewBox="0 0 14 14" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M2 7.5l3.2 3.2L12 4"/></svg>${escapeHtml(t("seller-current"))}</span>`:`<button class="cust-row-btn primary" data-saction="activate" data-wid="${le.id}">${escapeHtml(t("seller-set-current"))}</button>`,Z=P?`
            ...
            </div>`}).join("")}function I(h){i=h?h.id:null,document.getElementById("wsclient-modal-title").textContent=t(h?"wsclient-modal-edit":"wsclient-modal-new"),document.getElementById("wsclient-input-name").value=h&&h.name||"",document.getElementById("wsclient-input-tax").value=h&&h.tax_id||"",document.getElementById("wsclient-modal-archive").style.display=h?"":"none",document.getElementById("wsclient-modal-mask").style.display="flex",setTimeout(()=>document.getElementById("wsclient-input-name").focus(),50)}function N(){document.getElementById("wsclient-modal-mask").style.display="none",i=null}async function M(){const h=document.getElementById("wsclient-input-name").value.trim(),P=document.getElementById("wsclient-input-tax").value.trim();if(!h){showToast(t("client-msg-name-required"),"fail");return}try{i?(await l("/api/workspace/clients/"+i,{method:"PATCH",body:JSON.stringify({name:h,tax_id:P})}),showToast(t("client-msg-updated"),"success")):(await l("/api/workspace/clients",{method:"POST",body:JSON.stringify({name:h,tax_id:P||null})}),showToast(t("client-msg-created"),"success")),N(),await D(),x(),k()}catch(R){const K=R&&R.message?R.message:t("client-msg-save-fail");showToast(t("client-msg-save-fail")+" · "+K,"fail")}}async function F(){if(!i)return;const h=r.find(R=>Number(R.id)===Number(i));if(await showConfirm(t("wsclient-archive-confirm").replace("{name}",h?h.name:""),{danger:!0}))try{const R=i;await l("/api/workspace/clients/"+R,{method:"DELETE"}),showToast(t("wsclient-archived"),"success"),typeof window.getActiveWorkspaceClientId=="function"&&Number(window.getActiveWorkspaceClientId())===Number(R)&&typeof window.enterPersonalMode=="function"&&window.enterPersonalMode(),N(),await D(),x(),k()}catch{showToast(t("client-msg-save-fail"),"fail")}}function H(){const h=s.keyword.trim().toLowerCase();return h?e.filter(P=>(P.name||"").toLowerCase().includes(h)||(P.short_name||"").toLowerCase().includes(h)||(P.tax_id||"").toLowerCase().includes(h)):e}function y(){const h=H(),P=s.pageSize,R=Math.max(0,Math.ceil(h.length/P)-1);s.page>R&&(s.page=R);const K=s.page*P;return{all:h,items:h.slice(K,K+P),start:K,ps:P,total:h.length,maxPage:R}}function v(){const h=document.getElementById("buyer-tbody");if(!h)return;const{items:P,start:R,ps:K,total:Q,maxPage:le}=y();Q?h.innerHTML=P.map(ee=>{const ne=p.has(ee.id);return`<div class="cust-row buyer-grid${ne?" selected":""}" data-cid="${ee.id}">
...
`,e.dataset.wbInjected="1";try{const n=window._currentLang||localStorage.getItem("mrpilot_lang")||"th",a=window.I18N;a&&a[n]&&(e.querySelectorAll("[data-i18n]").forEach(o=>{const s=o.getAttribute("data-i18n");a[n][s]&&(o.textContent=a[n][s])}),e.querySelectorAll("[data-i18n-placeholder]").forEach(o=>{const s=o.getAttribute("data-i18n-placeholder");a[n][s]&&(o.placeholder=a[n][s])}))}catch{}}})();(function(){let e={statsCache:null,listCache:[],currentRule:null,currentClient:"",currentStatus:"pending",loading:!1,selectedIds:new Set,offset:0,pageSize:50,total:0,loadFailed:!1,listScrollY:0};function n(T,_){let h=t(T)||T;if(_)for(const P in _)h=h.replace(new RegExp("\\{"+P+"\\}","g"),String(_[P]));return h}async function a(){try{const T=e.currentClient||"",_="/api/exceptions/stats?status=pending"+(T?"&client_id="+encodeURIComponent(T):""),h=await fetch(_,{headers:{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||"")}});if(!h.ok)return;const P=await h.json(),R=document.getElementById("nav-exc-badge");if(!R)return;const K=parseInt(P.pending||0,10);K>0?(R.textContent=K>99?"99+":String(K),R.style.display=""):R.style.display="none"}catch{}}function o(T){return T==="high"?`<svg viewBox="0 0 14 14" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
        ...
        `;const z=document.getElementById("exc-fld-edit");z&&z.addEventListener("click",()=>{x.editing=!0,x.editFields={...y(x.history)},L()});const m=document.getElementById("exc-fld-cancel");m&&m.addEventListener("click",()=>{x.editing=!1,x.editFields=null,L()});const q=document.getElementById("exc-fld-save");q&&q.addEventListener("click",()=>C()),document.querySelectorAll(".exc-field-input").forEach(ae=>{ae.addEventListener("input",()=>{x.editFields||(x.editFields={}),x.editFields[ae.dataset.editKey]=ae.value})});const J=document.getElementById("exc-pdf-retry");J&&x.openExcId&&J.addEventListener("click",()=>{x.excRow&&N(x.excRow.history_id,x.openExcId)});const X=T.status==="pending",de=!!(T.seller_name&&T.seller_name.trim()),se=document.getElementById("exc-btn-resolve"),ce=document.getElementById("exc-btn-ignore");se.disabled=!X,ce.disabled=!X||!de,ce.title=de?t("exc-ignore-hint"):t("exc-ignore-no-seller")}async function C(){if(!x.openExcId||!x.history||!x.history.pages||x.loading)return;x.loading=!0;const T=showToast(t("exc-fld-saving"),"loading",0);try{const _=JSON.parse(JSON.stringify(x.history.pages||[]));let h=_.findIndex(ie=>!ie.is_duplicate&&!ie.is_copy);h<0&&(h=0),_[h]||(_[h]={fields:{}});const P=_[h].fields||{},R=x.editFields||{},K=new Set(["subtotal","vat","total_amount"]),Q={...P};for(const ie in R){let V=R[ie];if((V===""||V===void 0)&&(V=null),K.has(ie)&&V!==null){const Z=parseFloat(V);V=isNaN(Z)?null:Z}Q[ie]=V}_[h].fields=Q;const le=await fetch("/api/history/"+encodeURIComponent(x.history.id),{method:"PUT",headers:{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||""),"Content-Type":"application/json"},body:JSON.stringify({pages:_})});if(!le.ok)throw new Error("http "+le.status);T(),showToast(t("exc-fld-save-ok"),"success"),F(),await u(),await k(),a()}catch(_){T(),console.warn("save fields fail",_),showToast(t("exc-fld-save-fail"),"error")}finally{x.loading=!1}}async function j(){if(!(!x.openExcId||x.loading)){x.loading=!0;try{const T=await fetch("/api/exceptions/"+x.openExcId+"/resolve",{method:"POST",headers:{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||"")}});if(!T.ok)throw new Error("http "+T.status);showToast(t("exc-toast-resolved"),"success"),F(),await u(),await k(),a()}catch(T){console.warn("resolve fail",T),showToast(t("exc-toast-action-fail"),"error")}finally{x.loading=!1}}}async function B(){if(!(!x.openExcId||x.loading)){x.loading=!0;try{const T=await fetch("/api/exceptions/"+x.openExcId+"/ignore",{method:"POST",headers:{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||"")}});if(!T.ok)throw new Error("http "+T.status);showToast(t("exc-toast-ignored"),"success"),F(),await u(),await k(),a()}catch(T){console.warn("ignore fail",T),showToast(t("exc-toast-action-fail"),"error")}finally{x.loading=!1}}}let A=!1;async function Y(){if(A)return;const T=Array.from(e.selectedIds);if(T.length===0||!await showConfirm(n("exc-batch-confirm-resolve",{n:T.length})))return;A=!0;const h=showToast(n("exc-batch-count",{n:T.length})+" …","loading",0);try{const P=await fetch("/api/exceptions/batch",{method:"POST",headers:{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||""),"Content-Type":"application/json"},body:JSON.stringify({ids:T,action:"resolve"})});if(!P.ok)throw new Error("http "+P.status);const R=await P.json();h(),showToast(n("exc-toast-batch-resolved",{n:R.processed||0}),"success"),e.selectedIds.clear(),await u(),await k(),a()}catch(P){h(),console.warn("batch resolve fail",P),showToast(t("exc-toast-batch-fail"),"error")}finally{A=!1}}async function G(){if(A)return;const T=Array.from(e.selectedIds);if(T.length===0||!await showConfirm(n("exc-batch-confirm-ignore",{n:T.length}),{danger:!1}))return;A=!0;const h=showToast(n("exc-batch-count",{n:T.length})+" …","loading",0);try{const P=await fetch("/api/exceptions/batch",{method:"POST",headers:{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||""),"Content-Type":"application/json"},body:JSON.stringify({ids:T,action:"ignore"})});if(!P.ok)throw new Error("http "+P.status);const R=await P.json();h(),showToast(n("exc-toast-batch-ignored",{n:R.processed||0,wl:R.whitelist_added||0}),"success"),e.selectedIds.clear(),await u(),await k(),a()}catch(P){h(),console.warn("batch ignore fail",P),showToast(t("exc-toast-batch-fail"),"error")}finally{A=!1}}function W(){e.selectedIds.clear(),c(e.listCache)}document.addEventListener("click",T=>{T.target.closest("#exc-drawer-close")&&F(),T.target.closest("#exc-drawer-mask")&&F(),T.target.closest("#exc-btn-resolve")&&j(),T.target.closest("#exc-btn-ignore")&&B(),T.target.closest("#exc-batch-resolve")&&Y(),T.target.closest("#exc-batch-ignore")&&G(),T.target.closest("#exc-batch-clear")&&W(),T.target.closest("#exc-loadmore")&&D()}),document.addEventListener("keydown",T=>{T.key==="Escape"&&x.openExcId&&F()}),document.addEventListener("click",T=>{T.target.closest("#btn-exc-refresh")&&(typeof window.loadExceptionsPage=="function"&&window.loadExceptionsPage(),a())}),document.addEventListener("change",T=>{if(!T.target.closest("#exc-client-filter"))return;const _=T.target;e.currentClient=_.value||"",e.currentRule=null,e.selectedIds.clear(),e.listCache=[],typeof window.loadExceptionsPage=="function"&&window.loadExceptionsPage(),a()}),document.addEventListener("click",T=>{const _=T.target.closest("#exc-status-tabs .exc-status-tab");if(!_)return;const h=_.dataset.status||"pending";h!==e.currentStatus&&(e.currentStatus=h,e.currentRule=null,e.selectedIds.clear(),e.listCache=[],typeof window.loadExceptionsPage=="function"&&window.loadExceptionsPage())}),window.addEventListener("online",()=>{e.loadFailed&&document.getElementById("page-exceptions")?.classList.contains("show")&&window.loadExceptionsPage&&window.loadExceptionsPage()}),setTimeout(a,1500),setInterval(a,6e4);function te(T){if(!T)return"—";try{const _=new Date(T),h=P=>String(P).padStart(2,"0");return`${_.getFullYear()}-${h(_.getMonth()+1)}-${h(_.getDate())} ${h(_.getHours())}:${h(_.getMinutes())}`}catch{return T.slice(0,16).replace("T"," ")}}async function re(){const T=document.getElementById("learned-list");if(T){T.innerHTML=`<div class="learned-empty">${escapeHtml(t("set-learned-loading"))}</div>`;try{const _=await fetch("/api/exception-whitelist",{headers:{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||"")}});if(!_.ok)throw new Error("http "+_.status);const P=(await _.json()).items||[];if(P.length===0){T.innerHTML=`<div class="learned-empty">${escapeHtml(t("set-learned-empty"))}</div>`;return}const R=`<svg viewBox="0 0 14 14" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round">
            ...
            </div>`,document.body.appendChild(N),N.addEventListener("click",M=>{M.target===N&&l()}),document.getElementById("erp-exc-m-close").addEventListener("click",l),document.getElementById("erp-exc-m-cancel").addEventListener("click",l),document.getElementById("erp-exc-m-retry").addEventListener("click",()=>{l(),r(u.id,null)}),b){let M="";const F=document.getElementById("erp-exc-m-bind"),H=document.getElementById("erp-exc-m-custlist"),y=document.getElementById("erp-exc-m-search"),v=(L,C)=>{const j=(C||"").trim().toLowerCase(),B=j?L.filter(A=>(A.code||"").toLowerCase().includes(j)||(A.name||"").toLowerCase().includes(j)):L;if(B.length===0){H.innerHTML=`<div class="erp-exc-m-empty">${escapeHtml(t("erp-exc-edit-pick-empty"))}</div>`;return}H.innerHTML=B.slice(0,100).map(A=>`<div class="erp-exc-m-cust" data-cust-code="${escapeHtml(A.code||"")}">
    ...
    </div>`;function _t(){const e=document.getElementById("help-modal");if(!e||e.children.length)return;e.innerHTML=Un;const n=window._currentLang||"th",a=window.I18N&&window.I18N[n]||{};e.querySelectorAll("[data-i18n]").forEach(o=>{const s=o.getAttribute("data-i18n");a[s]&&(o.textContent=a[s])})}document.readyState,_t();(function(){function e(){const n=document.getElementById("help-modal"),a=document.getElementById("help-modal-close");n&&(a&&!a.dataset.bound&&(a.addEventListener("click",function(){n.style.display="none"}),a.dataset.bound="1"),n.dataset.maskBound||(n.addEventListener("click",function(o){o.target===n&&(n.style.display="none")}),n.dataset.maskBound="1"),window._helpModalEscBound||(document.addEventListener("keydown",function(o){o.key==="Escape"&&n.style.display==="flex"&&(n.style.display="none")}),window._helpModalEscBound=!0))}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",e):e()})();(function(){const e={line:"line",folder:"folder",gmail:"email",erp:"erp",alert:"alert"};document.addEventListener("click",function(n){const a=n.target.closest(".int-btn-configure");if(!a)return;const o=a.closest(".integration-row"),s=o?o.dataset.intAnchor:null;if(s&&e[s]){const p=o.querySelector(".int-name"),r=p?(p.textContent||p.innerText||"").trim():"配置";typeof window.openIntegrationDrawer=="function"&&window.openIntegrationDrawer(e[s],r)}})})();let we=[];window._erpEndpoints=we;let Re=null;async function We(){try{const e=await fetch("/api/erp/endpoints",{headers:{Authorization:"Bearer "+token}});if(e.status===401){localStorage.removeItem("mrpilot_token");const a=await e.json().catch(()=>({}));if((typeof a.detail=="string"?a.detail:a.detail&&a.detail.code||"")==="auth.session_revoked"){_showSessionRevokedModal();return}window.location.href="/";return}we=(await e.json()).items||[],window._erpEndpoints=we,qt()}catch(e){console.error("load endpoints failed",e)}}window._refreshErpEndpointsCache=function(){return We()};async function Dt(){const e=document.getElementById("erp-today-stats");if(e){e.innerHTML="";try{const n=await fetch("/api/erp/stats/today",{headers:{Authorization:"Bearer "+token}});if(!n.ok)return;const a=await n.json(),o=a.total||0,s=a.success||0,p=a.failed||0,r=a.auto_cnt||0;if(o===0){e.innerHTML=`<span class="erp-today-empty">${escapeHtml(t("erp-today-none"))}</span>`;return}const f=[];f.push(`<span class="erp-today-item"><strong>${o}</strong> ${escapeHtml(t("erp-today-total"))}</span>`),s>0&&f.push(`<span class="erp-today-item ok"><strong>${s}</strong> ${escapeHtml(t("erp-today-success"))}</span>`),p>0&&f.push(`<span class="erp-today-item fail"><strong>${p}</strong> ${escapeHtml(t("erp-today-failed"))}</span>`),r>0&&f.push(`<span class="erp-today-item auto"><strong>${r}</strong> ${escapeHtml(t("erp-today-auto"))}</span>`),e.innerHTML=f.join("")}catch(n){console.warn("loadErpTodayStats failed",n)}}}function qt(){const e=document.getElementById("erp-endpoints-list"),n=document.getElementById("erp-status-summary"),a=document.getElementById("btn-add-endpoint");if(!e){console.warn("erp-endpoints-list 容器不存在");return}if(a&&_userInfo){const s=_userInfo.endpoints_limit;s!==-1&&we.length>=s?(a.disabled=!0,a.title=t("ep-limit-reached",{limit:s}),a.classList.add("btn-disabled-plus")):(a.disabled=!1,a.title="",a.classList.remove("btn-disabled-plus"))}if(we.length===0){e.innerHTML=`<div class="erp-empty">${escapeHtml(t("ep-list-empty"))}</div>`,n&&(n.textContent=t("auto-status-none"),n.className="auto-status-pill none");return}const o=we.some(s=>s.auto_push&&s.enabled);if(n&&(n.textContent=t("auto-status-active",{n:we.length,mode:o?t("auto-status-on"):t("auto-status-off")}),n.className="auto-status-pill "+(o?"active":"ready")),Dt(),e.innerHTML=we.map(s=>{const p=s.config||{},r=escapeHtml(p.url||"");p._token_set;const f=s.enabled!==!1,i=[];s.is_default&&i.push(`<span class="ep-badge default">${escapeHtml(t("ep-default"))}</span>`),s.auto_push&&i.push(`<span class="ep-badge auto">${escapeHtml(t("ep-auto-push-on"))}</span>`),f||i.push(`<span class="ep-badge disabled">${escapeHtml(t("ep-disabled"))}</span>`);const c=[];return s.success_count>0&&c.push(`<span class="ep-stat ok">${escapeHtml(t("ep-success",{n:s.success_count}))}</span>`),s.failure_count>0&&c.push(`<span class="ep-stat fail">${escapeHtml(t("ep-failure",{n:s.failure_count}))}</span>`),`
    ...
    `,document.body.appendChild(n),n.addEventListener("click",async a=>{if(a.target===n||a.target.classList.contains("log-detail-close")){n.remove();return}const o=a.target.closest("[data-receipt-copy]");if(o){zt(o.dataset.receiptCopy);return}const s=a.target.closest("[data-receipt-action]");if(s){const p=s.dataset.receiptAction;p==="retry"?window.retryPushLog(s.dataset.logId):p==="exceptions"?typeof routeTo=="function"&&routeTo("exceptions"):p==="mappings"&&typeof routeTo=="function"&&routeTo("integrations"),n.remove();return}});try{const a=await fetch(`/api/erp/logs/${encodeURIComponent(e)}`,{headers:{Authorization:"Bearer "+token}});if(!a.ok){n.remove();return}const o=await a.json(),s=window._erpEndpoints.find(C=>C.id===o.endpoint_id),p=o.endpoint_name||(s?s.name:o.endpoint_id?t("erp-log-endpoint-deleted"):"-"),r=(o.endpoint_adapter||s&&s.adapter||"").toLowerCase(),f=new Date(o.created_at).toLocaleString(),i=o.trigger==="auto"?t("log-tag-auto"):o.trigger==="retry"?t("log-tag-retry"):t("log-tag-manual"),c=o.request_body?JSON.stringify(o.request_body,null,2):t("erp-receipt-no-tech"),l=o.response_body||t("erp-receipt-no-tech"),d=o.status==="success";let u=typeof l=="string"?l:JSON.stringify(l,null,2);if(d)try{const C=typeof o.response_body=="string"?JSON.parse(o.response_body):o.response_body||{},j=C.row_count||(Array.isArray(C.imported_rows)?C.imported_rows.length:0);j>0&&(u=t("log-push-rows").replace("{n}",String(j)))}catch{}const b=(o.external_doc_no||"").trim(),k=(o.external_url||"").trim(),D=(o.external_doc_hint||"").trim(),E=(o.ocr_buyer_name||"").trim()||o.client_name||"-",x=o.seller_name||"-";let I="-";const N=Number(o.total_amount);o.total_amount!=null&&o.total_amount!==""&&!isNaN(N)&&(I=N.toLocaleString("en-US",{minimumFractionDigits:2,maximumFractionDigits:2}));const M=d?t("erp-receipt-title-ok"):t("erp-receipt-title-fail"),F=d?"✓":"✗",H=[],y=(C,j)=>{H.push(`
        ...
        `,document.body.appendChild(b);const k=()=>b.remove();b.querySelector("#cpw-forgot-close").addEventListener("click",k),b.querySelector("#cpw-forgot-cancel").addEventListener("click",k),b.addEventListener("click",D=>{D.target===b&&k()}),b.querySelector("#cpw-forgot-send").addEventListener("click",async()=>{const D=b.querySelector("#cpw-forgot-send"),E=b.querySelector("#cpw-forgot-msg");D.disabled=!0;const x=D.textContent;D.textContent=a("cpw-forgot-sending");try{const I=await fetch("/api/auth/forgot_password",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:d})}),N=await I.json().catch(()=>({}));I.ok?(E.textContent=a("cpw-forgot-success"),E.className="cpw-forgot-msg success",D.style.display="none",b.querySelector("#cpw-forgot-cancel").textContent=a("cpw-forgot-close-btn")):(E.textContent=N.detail||a("cpw-forgot-fail"),E.className="cpw-forgot-msg error",D.disabled=!1,D.textContent=x)}catch{E.textContent=a("cpw-forgot-fail"),E.className="cpw-forgot-msg error",D.disabled=!1,D.textContent=x}})}function i(l){if(!l||!l.includes("@"))return l||"";const[d,u]=l.split("@");return d.length<=2?d+"****@"+u:d.slice(0,2)+"****@"+u}function c(l){return l==null?"":String(l).replace(/[&<>"']/g,d=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[d])}document.readyState==="complete"||document.readyState==="interactive"?r():document.addEventListener("DOMContentLoaded",r)})();(function(){let e=null,n=!1;async function a(){if(n)return;const s=localStorage.getItem("mrpilot_token");if(s){n=!0;try{const p=await fetch("/api/me",{headers:{Authorization:"Bearer "+s},cache:"no-store"});if(p.status===401){const r=await p.json().catch(()=>({})),f=r&&r.detail;let i="";if(typeof f=="string"?i=f:f&&typeof f=="object"&&(i=f.code||""),console.warn("[heartbeat] session revoked",i),localStorage.removeItem("mrpilot_token"),e&&(clearInterval(e),e=null),i==="auth.session_revoked")try{_showSessionRevokedModal()}catch{window.location.href="/"}else{const c=i==="auth.password_changed_relogin"?"alert-password-changed-relogin":"alert-session";try{typeof showToast=="function"&&typeof t=="function"?showToast(t(c),"error"):alert("Session expired")}catch{}setTimeout(()=>{window.location.href="/"},1500)}}}catch{}finally{n=!1}}}function o(){e&&clearInterval(e),e=setInterval(a,15e3)}localStorage.getItem("mrpilot_token")&&o(),window.addEventListener("focus",a),document.addEventListener("visibilitychange",function(){document.hidden||a()}),window._sessionCheck=a})();async function Xe(){const e=document.getElementById("team-loading"),n=document.getElementById("team-list"),a=document.getElementById("team-empty"),o=document.getElementById("team-count");if(n){e&&(e.style.display=""),n.style.display="none",a&&(a.style.display="none");try{const s=await apiGet("/api/team/employees"),p=s&&s.employees||[];if(e&&(e.style.display="none"),o&&(o.textContent=(t("team-count")||"共 {n} 名员工").replace("{n}",p.length)),p.length===0){a&&(a.style.display="");return}n.style.display="",n.innerHTML=p.map(r=>{const f=r.last_login_at?new Date(r.last_login_at).toLocaleDateString():t("team-never-login")||"从未登录",i=r.is_active===!1?"team-status-off":"team-status-on",c=r.is_active===!1?t("team-status-disabled")||"已禁用":t("team-status-active")||"正常",l=r.email?`<span class="team-meta-sep">·</span><span>${escapeHtml(r.email)}</span>`:"";return`
            ...
            </div>`}).join("")}catch(s){console.error("loadTeamList failed:",s),e&&(e.textContent=t("team-load-failed")||"加载失败")}}}async function Xn(){document.querySelectorAll(".add-emp-overlay").forEach(o=>o.remove());const e=document.createElement("div");e.className="add-emp-overlay",e.innerHTML=`
