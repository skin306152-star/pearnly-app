// ============================================================
// REFACTOR-WB-C1 (2026-05-30) · 自动化页壳 HTML(上半)· 从 page-automation.js 抽出为数据模块
// 纯静态 HTML 模板数据(0 逻辑 / 0 状态)· head + 左侧 nav + ERP panel + 银行对账 panel。
// page-automation.js 注入时 AUTO_HTML_1 + AUTO_HTML_2 拼接 = 原 innerHTML 逐字节一致。
// ============================================================
export const AUTO_HTML_1 = `
