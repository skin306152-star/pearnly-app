...
LINE_I18N = {
    "zh": {
        ...
        "exp_reply_to_record": "请长按要操作的那条记录、点「回复」,再输入「删除」或「改成多少钱」。这样我不会改错单。",
    ...
    "en": {
        ...
        "exp_reply_to_record": 'Long-press the entry you want, tap Reply, then type "delete" or "change the amount" — so I don\'t edit the wrong one.',
    ...
    "th": {
        ...
        "exp_reply_to_record": "กรุณากดค้างที่ข้อความรายการที่ต้องการแล้วกด “ตอบกลับ” จากนั้นพิมพ์ “ลบ” หรือ “แก้ยอดเป็น…” เพื่อไม่ให้แก้ผิดรายการ",
    ...
    "ja": {
        ...
        "exp_reply_to_record": "変更したい記録を長押しして「返信」し、「削除」または「金額を変更」と入力してください。誤った記録を変更しないためです。",
