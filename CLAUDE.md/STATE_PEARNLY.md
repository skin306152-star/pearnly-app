...
- **代码规模快照**(实时跑 `scripts/refactor_progress.py`):home.js **5359**→<200 · app.py **1701**→<500 · db.py **332**→<500 **✅达标** · home.css **0** ✅ · home.html **4410**→<1000 · 综合 **~80%**。
