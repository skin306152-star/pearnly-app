...
`,e.dataset.wbInjected="1";try{const n=window._currentLang||localStorage.getItem("mrpilot_lang")||"th",a=window.I18N;a&&a[n]&&e.querySelectorAll("[data-i18n]").forEach(o=>{const s=o.getAttribute("data-i18n");a[n][s]&&(o.textContent=a[n][s])})}catch{}}})();function Rn(e,n){const a=document.getElementById("alert-"+e);a&&(document.getElementById("alert-"+e+"-text").textContent=n,a.classList.add("show"))}function zn(){["info","warn","error"].forEach(e=>{document.getElementById("alert-"+e).classList.remove("show")})}function Nn(e,n){if(e==null)return n||"操作失败";if(typeof e=="string")return e;if(Array.isArray(e)){const a=e[0]||{};return a.msg?a.msg:n||"请求格式错误"}if(typeof e=="object"){if(e.code){const a="err."+e.code;try{const o=t(a,e);if(o&&o!==a)return o}catch(o){console.warn("[i18n] t() failed for key:",a,o)}return e.code}if(e.message)return e.message;if(e.error)return e.error;if(e.detail&&typeof e.detail=="string")return e.detail;try{return JSON.stringify(e).slice(0,160)}catch{}}return n||String(e)}function Fn(e){if(!e)return"";const n=String(e);return/ECONNREFUSED|Connection refused/i.test(n)?"连接被拒绝 · ERP 地址可能错了,或服务没启动":/listing fetch failed|wait_for_selector/i.test(n)?"拉取 MR.ERP 客户/商品列表超时 · 已重试 3 次仍不通 · 可能 MR.ERP 响应慢 · 稍后再试":/ETIMEDOUT|timeout/i.test(n)?"连接超时 · MR.ERP 响应慢 · 稍后再试":/ENOTFOUND|getaddrinfo/i.test(n)?"域名解析失败 · ERP 地址拼错了":/certificate|SSL/i.test(n)?"SSL 证书问题 · ERP 站点证书异常":/401|Unauthorized/i.test(n)?"HTTP 401 · 认证失败,检查 Token 是否正确":/403|Forbidden/i.test(n)?"HTTP 403 · 权限不足,ERP 拒绝访问":/404|Not Found/i.test(n)?"HTTP 404 · URL 路径不存在":/^5\d\d/.test(n)||/500|502|503|504/.test(n)?"ERP 服务器错误 · 不是你的问题,等会儿再试":n}function On(e,n,a){let o=document.getElementById("mp-toast-wrap");o||(o=document.createElement("div"),o.id="mp-toast-wrap",document.body.appendChild(o)),n=n||"success",n==="ok"&&(n="success"),n==="warning"&&(n="warn"),n==="danger"&&(n="error");const s={success:'<path d="M3 8l3 3 7-7"/>',error:'<circle cx="8" cy="8" r="6"/><path d="M5.5 5.5l5 5M10.5 5.5l-5 5"/>',warn:'<path d="M8 2L1.5 13h13L8 2z"/><path d="M8 7v3M8 12v.01"/>',info:'<circle cx="8" cy="8" r="6"/><path d="M8 5.5v.01M8 8v3"/>',loading:'<path d="M8 1a7 7 0 017 7" stroke-linecap="round" class="mp-toast-spin"/>'},i=document.createElement("div");i.className="mp-toast "+n,i.innerHTML=`
    ...
    `}window.switchSettingsTab=Un;window.fillSettingsForms=Gn;window.saveProfile=Kn;window.saveCompany=Jn;window.renderSettings=ft;function et(e){return e=e||_userInfo,!!(e&&e.is_super_admin)}function bt(e){return e=e||_userInfo,!!e&&(e.role==="owner"||et(e))}function Nt(e){return e=e||_userInfo,!!e&&e.role==="member"&&!et(e)}function Wn(e){return e=e||_userInfo,!!e&&(e.effective_plan==="trial"||e.plan==="trial")&&!et(e)}function Ft(e){return e=e||_userInfo,!!e&&e.tenant_type==="byo_api"}function Ot(e){return Nt(e)}function Xn(e){return bt(e)}function Zn(e){return bt(e)&&Ft(e)}window.isMoneyHidden=Ot;window.isSuperAdmin=et;window.isOwner=bt;window.isEmployee=Nt;window.isTrial=Wn;window.isLifetime=Ft;window.shouldHideMoney=Ot;window.canManageTeam=Xn;window.canManageApiKey=Zn;function Qn(){const e=document.getElementById("quota-banner");if(!e)return;if(!_userInfo){e.style.display="none";return}if(_userInfo.is_super_admin||_userInfo.tenant_type==="admin"||_userInfo.tenant_type==="byo_api"){e.style.display="none";return}let n=0,a=0;if(_userInfo.plan==="free"&&_quota&&_quota.ip_daily_limit)n=_quota.ip_used_today||0,a=_quota.ip_daily_limit;else if(_userInfo.tenant_quota!=null&&_userInfo.tenant_quota>0)n=_userInfo.tenant_used||0,a=_userInfo.tenant_quota;else if(_userInfo.monthly_quota&&_userInfo.monthly_quota>0)n=_userInfo.used_this_month||0,a=_userInfo.monthly_quota;else{e.style.display="none";return}if(a<=0){e.style.display="none";return}const o=Math.max(0,a-n),s=n/a*100,i="quota_banner_dismiss_"+new Date().toISOString().slice(0,10);if(localStorage.getItem(i)){e.style.display="none";return}let r,p;if(o===0)r="danger",p=t("quota-banner-exhausted");else if(s>=90)r="danger",p=t("quota-banner-very-low",{n:o});else if(s>=70)r="warn",p=t("quota-banner-low",{n:o});else{e.style.display="none";return}e.className="quota-banner "+r,e.innerHTML=`
...
[`+B+" / "+P+"]")&&c(h),!1}async function c(h){const T=await d();if(typeof h=="function"&&s()!=="personal"&&T.length===1){p(Number(T[0].id)),h();return}if(typeof window.openWorkspaceChooserUI=="function"){window.openWorkspaceChooserUI({clients:T,canCreate:o(),active:i(),onPersonal:l,onPick:function(B){p(Number(B)),typeof h=="function"&&h()},emptyHint:T.length?null:o()?a("ws-empty-owner","还没有工作空间。创建一个公司后,上传、对账和 ERP 推送都会归属到该公司。"):a("ws-empty-employee","你还没有可用的工作空间,请联系管理员分配。")});return}if(!T.length){const B=o()?a("ws-empty-owner","还没有工作空间。创建一个公司后,上传、对账和 ERP 推送都会归属到该公司。"):a("ws-empty-employee","你还没有可用的工作空间,请联系管理员分配。");typeof window.showToast=="function"&&window.showToast(B,"info")}}function u(h){const T=h||document.getElementById("workspace-switcher-root");if(!T)return;const B=s(),P=i();let H,_;if(B==="client"&&P!=null){const S=(window._workspaceClientsCache||[]).find(C=>Number(C.id)===Number(P));H=b("building"),_=S?S.name:a("ws-current-label","当前工作空间")}else H=b("user"),_=a("ws-personal","个人事务");T.innerHTML='<button class="ws-ctrl-btn" id="ws-ctrl-btn" type="button">'+H+'<span class="ws-ctrl-label">'+v(_)+"</span></button>";const g=T.querySelector("#ws-ctrl-btn");g&&g.addEventListener("click",()=>c(null))}function v(h){return String(h??"").replace(/[&<>"']/g,function(T){return{"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"}[T]})}function b(h){const T='<svg class="ws-ic" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">';return h==="building"?T+'<rect x="2" y="7" width="20" height="14" rx="2"/><path d="M16 21V5a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v16"/></svg>':T+'<path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/></svg>'}function M(h){h=h||{};const T=h.clients||[],B=h.active,P=document.getElementById("ws-modal");P&&P.remove();const H=document.createElement("div");H.id="ws-modal",H.className="ws-modal";const g='<button type="button" class="ws-modal-item'+(s()==="personal"||B==null?" active":"")+'" data-ws-personal="1"><span class="ws-modal-item-ic">'+b("user")+'</span><span class="ws-modal-item-text" style="display:flex;flex-direction:column;align-items:flex-start;min-width:0;"><span class="ws-modal-item-name">'+v(a("ws-personal","个人事务"))+'</span><span class="ws-modal-item-desc" style="font-size:11px;color:#6b7280;font-weight:400;margin-top:2px;line-height:1.35;white-space:normal;">'+v(a("ws-personal-desc","用于临时识别、测试或处理不归属任何公司的文件。"))+"</span></span></button>";let k="";if(T.length){const D=['<option value="">'+v(a("ws-select-ph","— 选择账套主体 —"))+"</option>"].concat(T.map(function(Y){const V=B!=null&&Number(B)===Number(Y.id);return'<option value="'+v(Y.id)+'"'+(V?" selected":"")+">"+v(Y.name||"#"+Y.id)+"</option>"}));k='<div class="ws-modal-select-row"><label class="ws-modal-select-label">'+v(a("ws-select-label","账套主体"))+'</label><select class="ws-modal-select" data-ws-select="1">'+D.join("")+"</select></div>"}const S=!T.length&&h.emptyHint?'<div class="ws-modal-empty">'+v(h.emptyHint)+"</div>":"",C=h.canCreate?'<div class="ws-modal-create"><button type="button" class="ws-modal-create-toggle" data-ws-create-toggle="1">+ '+v(a("ws-create-client","新建工作空间"))+'</button><div class="ws-modal-create-form" data-ws-create-form style="display:none;"><input type="text" class="ws-modal-create-input" data-ws-create-name placeholder="'+v(a("ws-create-ph","公司名称,例如 BAKELAB"))+'"><button type="button" class="ws-modal-create-submit" data-ws-create-submit="1">'+v(a("ws-create-submit","创建"))+"</button></div></div>":"";H.innerHTML='<div class="ws-modal-box" role="dialog" aria-modal="true"><div class="ws-modal-head"><span class="ws-modal-title">'+v(a("ws-chooser-title","选择工作空间"))+'</span><button type="button" class="ws-modal-close" data-ws-close="1" aria-label="close">✕</button></div><div class="ws-modal-subtitle" style="font-size:12px;color:#6b7280;padding:2px 4px 12px;line-height:1.45;white-space:normal;">'+v(a("ws-chooser-subtitle","账套主体 = 你的公司(发票卖方/开票方)。选择正在为哪家公司做账。"))+'</div><div class="ws-modal-list">'+g+k+"</div>"+S+C+"</div>",document.body.appendChild(H);const q=H.querySelector("[data-ws-select]");q&&q.addEventListener("change",function(){const D=q.value;D&&(typeof h.onPick=="function"&&h.onPick(D),L(),u())});function L(){H.remove()}H.addEventListener("click",function(D){if(D.target===H||D.target.closest("[data-ws-close]")){L();return}if(D.target.closest("[data-ws-personal]")){typeof h.onPersonal=="function"&&h.onPersonal(),L(),u();return}const V=D.target.closest("[data-ws-pick]");if(V){const re=V.getAttribute("data-ws-pick");typeof h.onPick=="function"&&h.onPick(re),L(),u();return}if(D.target.closest("[data-ws-create-toggle]")){const re=H.querySelector("[data-ws-create-form]");if(re){re.style.display=re.style.display==="none"?"flex":"none";const A=re.querySelector("[data-ws-create-name]");A&&A.focus()}return}if(D.target.closest("[data-ws-create-submit]")){E(H,h,L);return}})}async function E(h,T,B){const P=h.querySelector("[data-ws-create-name]"),H=P?(P.value||"").trim():"";if(!H){P&&P.focus();return}let _=null;try{if(typeof window.apiPost=="function"){const k=await window.apiPost("/api/workspace/clients",{name:H});_=k&&typeof k.json=="function"?await k.json().catch(()=>null):k}}catch{_=null}const g=_&&(_.id||_.client&&_.client.id);if(!g){typeof window.showToast=="function"&&window.showToast(a("ws-create-fail","新建工作空间失败 · 请重试"),"error");return}window._workspaceClientsCache=await d(),p(Number(g)),T.onPick,B(),u()}window.openWorkspaceChooserUI=M,window.addEventListener("pearnly:workspace-changed",function(){u()}),window.getWorkMode=s,window.getActiveWorkspaceClientId=i,window.setActiveWorkspaceClientId=p,window.enterPersonalMode=l,window.requireWorkspace=f,window.openWorkspaceChooser=c,window.renderWorkspaceControl=u,window.fetchWorkspaceClients=d;function m(){try{if(sessionStorage.getItem("pearnly_ws_login_prompted")==="1"||i()!=null||localStorage.getItem(n)==="personal")return;sessionStorage.setItem("pearnly_ws_login_prompted","1"),setTimeout(function(){c(null)},800)}catch{}}d().then(h=>{window._workspaceClientsCache=h,u(),m()}),typeof window.subscribeI18n=="function"&&window.subscribeI18n("workspace-switcher",u)})();(function(){const e=B=>document.querySelector('[data-num-target="'+B+'"]');function n(B){if(!B)return t("reconcile-last-activity-none");try{const P=new Date(B),H=new Date,_=H-P;if(_/6e4<5)return t("reconcile-last-activity-just-now");if(P.toDateString()===H.toDateString())return t("reconcile-last-activity-today");const k=Math.max(1,Math.floor(_/(24*3600*1e3)));return t("reconcile-last-activity-days-ago").replace("{n}",k)}catch{return t("reconcile-last-activity-none")}}function a(B,P,H){const _=e(B);_&&(_.textContent=H?"-":String(P),_.classList.toggle("is-empty",!!H))}function o(B){const P=document.getElementById("reconcile-error");P&&(P.style.display=B?"flex":"none")}function s(B){const P=document.getElementById("reconcile-empty");P&&(P.style.display=B?"flex":"none")}function i(B,P){const H=document.getElementById("reconcile-last-activity");H&&(H.textContent=B,H.classList.toggle("has-data",!!P))}function r(B){const P=!B||(B.total_sessions||0)===0;a("pending",B.pending||0,P),a("matched",B.matched||0,P),a("unmatched",B.unmatched||0,P),i(n(B.last_activity_at),!!B.last_activity_at),o(!1),s(P)}function p(B){const P=B.toUpperCase();return P==="KBANK"?"bank-chip-kbank":P==="SCB"?"bank-chip-scb":P==="BBL"?"bank-chip-bbl":P==="KTB"?"bank-chip-ktb":P==="TTB"?"bank-chip-ttb":"bank-chip-other"}function l(B,P){const H=_=>_?String(_).slice(0,10):"?";return!B&&!P?"":H(B)+" ~ "+H(P)}function d(B){return B==null?"":String(B).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function f(B){const P=document.getElementById("reconcile-recent"),H=document.getElementById("reconcile-recent-list");if(!P||!H)return;const _=(B||[]).slice(0,20);if(_.length===0){P.style.display="none";return}P.style.display="",s(!1),H.innerHTML=_.map(g=>{const k=g.parse_status==="parse_failed",S=g.bank_code||"OTHER",C=g.account_last4?" ···"+d(g.account_last4):"",q=l(g.period_start,g.period_end),L=d(g.source_filename||""),D=Number(g.tx_count||0),Y=k?'<span class="recon-card-fail" data-i18n="reconcile-card-parse-failed">'+t("reconcile-card-parse-failed")+"</span>":'<span class="recon-card-tx">'+t("reconcile-card-tx").replace("{n}",D)+"</span>";return'<div class="recon-card" data-session-id="'+d(g.id)+'" data-session-name="'+L+'"><span class="bank-chip '+p(S)+'">'+d(S)+'</span><div class="recon-card-main"><div class="recon-card-title">'+L+C+'</div><div class="recon-card-sub">'+d(q)+'</div></div><div class="recon-card-right">'+Y+'</div><button class="recon-card-trash" data-trash="'+d(g.id)+'" title="'+d(t("bank-session-delete-tip")||"删除")+'"><svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"><path d="M3 5h10M6 5V3h4v2M5 5l1 9h4l1-9"/></svg></button><svg class="recon-card-arrow" viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M6 4l4 4-4 4"/></svg></div>'}).join(""),H.querySelectorAll(".recon-card").forEach(g=>{g.addEventListener("click",k=>{k.target.closest(".recon-card-trash")||(g.dataset.sessionId,c())})}),H.querySelectorAll(".recon-card-trash").forEach(g=>{g.addEventListener("click",k=>{k.stopPropagation();const S=g.dataset.trash,C=g.closest(".recon-card"),q=C&&C.dataset.sessionName||"";typeof window._deleteBankSession=="function"&&window._deleteBankSession(S,q)})})}function c(B){typeof window.routeTo=="function"&&window.routeTo("reconcile"),setTimeout(function(){const P=document.querySelector('[data-recon-tab="bank"]');P&&P.click()},150)}function u(){o(!0),s(!1)}function v(){typeof window.routeTo=="function"&&window.routeTo("reconcile"),setTimeout(function(){const B=document.querySelector('[data-recon-tab="bank"]');B&&B.click()},150)}async function b(){a("pending",0,!0),a("matched",0,!0),a("unmatched",0,!0),i("",!1),o(!1),s(!1);const B=document.getElementById("reconcile-recent");B&&(B.style.display="none");const P={Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||"")};try{const[H,_]=await Promise.all([fetch("/api/bank-recon/stats",{headers:P}),fetch("/api/bank-recon/sessions?limit=20",{headers:P})]);if(!H.ok)throw new Error("http "+H.status);const g=await H.json(),k=_.ok?await _.json():[];r(g||{}),f(k||[])}catch(H){console.warn("[reconcile] load failed",H),u()}}function M(B){if(!B||!B.length)return;const P="Bearer "+(localStorage.getItem("mrpilot_token")||"");let H=0;const _=B.length;Array.from(B).forEach(function(g){const k=new FormData;k.append("file",g,g.name);const S=new XMLHttpRequest;S.open("POST","/api/bank-recon/upload"),S.setRequestHeader("Authorization",P),S.onload=function(){H++;try{const C=JSON.parse(S.responseText);S.status===200&&C.tx_count!==void 0?showToast((t("bank-upload-ok")||"解析成功 · 共 {n} 条流水").replace("{n}",C.tx_count),"success"):showToast(g.name+" "+(t("upload-failed")||"上传失败"),"error")}catch{showToast(g.name+" "+(t("upload-failed")||"上传失败"),"error")}H===_&&setTimeout(b,600)},S.onerror=function(){H++,showToast(g.name+" "+(t("upload-failed")||"上传失败"),"error"),H===_&&setTimeout(b,600)},S.send(k)}),showToast((t("bank-queue-status-uploading")||"上传中")+"…","info")}function E(){if(window.__reconcileBound)return;window.__reconcileBound=!0;const B=document.getElementById("reconcile-bank-file-input");B&&B.addEventListener("change",function(){M(this.files),this.value=""}),document.addEventListener("click",P=>{if(P.target.closest("#btn-reconcile-upload-top")||P.target.closest("#btn-reconcile-upload-empty")){v();return}if(P.target.closest("#btn-reconcile-retry")){b();return}if(P.target.closest("#btn-reconcile-dev-seed")){T();return}})}const m=["468b50c1-5593-4fd6-990d-515ce8085563"];function h(){const B=document.getElementById("btn-reconcile-dev-seed");if(!B)return;const P=typeof _userInfo<"u"?_userInfo:null,H=P&&P.id&&m.indexOf(String(P.id))>=0;B.style.display=H?"":"none"}async function T(){try{const B=await fetch("/api/bank-recon/_dev/seed",{method:"POST",headers:{Authorization:"Bearer "+token}});if(!B.ok)throw new Error("seed:"+B.status);const P=await B.json(),H=(t("reconcile-dev-seed-ok")||"").replace("{n}",P.tx_count||0);showToast(H,"success"),typeof window.navigateTo=="function"?window.navigateTo("automation"):location.hash="#/automation",setTimeout(()=>{const _=document.querySelector('[data-auto-tab="bank"]');_&&_.click(),P.session_id&&typeof window._openBankSession=="function"&&window._openBankSession(P.session_id)},300)}catch(B){console.warn("[reconcile] dev seed failed",B),showToast(t("reconcile-dev-seed-fail")||"Seed failed","error")}}window.loadReconcilePage=async function(){E(),h(),typeof window._bankReconV2Init=="function"&&window._bankReconV2Init();try{await b()}catch{}},window._rerenderReconcile=function(){typeof currentRoute=="string"&&currentRoute==="reconcile"&&b().catch(()=>{})},typeof window.subscribeI18n=="function"&&window.subscribeI18n("reconcile",window._rerenderReconcile)})();(function(){const e=document.getElementById("assign-clients-modal");if(!(!e||e.dataset.wbInjected==="1")){e.innerHTML=`
    ...
    </div>`,e.dataset.wbInjected="1";try{const n=window._currentLang||localStorage.getItem("mrpilot_lang")||"th",a=window.I18N;a&&a[n]&&e.querySelectorAll("[data-i18n]").forEach(o=>{const s=o.getAttribute("data-i18n");a[n][s]&&(o.textContent=a[n][s])})}catch{}}})();(function(){let e={employeeId:null,employeeName:"",clients:[],selected:new Set,opened:!1};function n(){return document.getElementById("assign-clients-modal")}function a(){return document.getElementById("assign-clients-list")}function o(){return document.getElementById("assign-select-all")}function s(){return document.getElementById("assign-selected-count")}function i(){return document.getElementById("assign-modal-target")}function r(){const b=a();if(b){if(!e.clients.length){b.innerHTML='<div class="assign-empty">'+escapeHtml(t("assign-no-clients")||"暂无客户 · 请先到「客户管理」添加")+"</div>";return}b.innerHTML=e.clients.map(M=>{const E=String(M.id),m=e.selected.has(E)?"checked":"",h=escapeHtml(M.name||M.label||"#"+E),T=M.code?'<span class="assign-row-code">'+escapeHtml(M.code)+"</span>":"";return'<label class="assign-row"><input type="checkbox" data-cid="'+escapeHtml(E)+'" '+m+'><span class="assign-row-name">'+h+"</span>"+T+"</label>"}).join(""),p()}}function p(){const b=s();if(b){const E=t("assign-selected-count")||"已选 {n} / {total}";b.textContent=E.replace("{n}",e.selected.size).replace("{total}",e.clients.length)}const M=o();M&&(M.checked=e.clients.length>0&&e.selected.size===e.clients.length)}function l(){const b=i();b&&(b.textContent=e.employeeName?" · "+e.employeeName:"")}async function d(b,M){e.employeeId=b,e.employeeName=M||"",e.opened=!0,e.selected=new Set,e.clients=[],l();const E=a();E&&(E.innerHTML='<div class="assign-empty">'+escapeHtml(t("assign-loading")||"加载中...")+"</div>");const m=n();m&&(m.style.display="flex");try{const[h,T]=await Promise.all([apiGet("/api/clients?include_inactive=false"),apiGet("/api/team/employees/"+encodeURIComponent(b)+"/assignments")]);e.clients=h&&h.clients||[];const B=T&&T.client_ids||[];e.selected=new Set(B.map(String)),r()}catch(h){console.error("[assign-clients] load failed",h);const T=a();T&&(T.innerHTML='<div class="assign-empty">'+escapeHtml(t("assign-load-failed")||"加载失败 · 请重试")+"</div>")}}function f(){e.opened=!1;const b=n();b&&(b.style.display="none")}async function c(){if(!e.employeeId)return;const b=Array.from(e.selected).map(E=>parseInt(E,10)).filter(E=>!isNaN(E)),M=document.getElementById("assign-modal-save");M&&(M.disabled=!0);try{const E=await apiPost("/api/team/employees/"+encodeURIComponent(e.employeeId)+"/assignments",{client_ids:b});E&&E.ok!==!1?(showToast((t("assign-saved")||"已保存 {n} 个客户分配").replace("{n}",b.length),"success"),f(),typeof loadTeamList=="function"&&loadTeamList()):showToast(t("assign-save-failed")||"保存失败","error")}catch(E){console.error("[assign-clients] save failed",E),showToast(t("assign-save-failed")||"保存失败","error")}finally{M&&(M.disabled=!1)}}function u(){const b=n();if(!b||b.dataset.bound==="1")return;b.dataset.bound="1";const M=document.getElementById("assign-modal-close");M&&M.addEventListener("click",f);const E=document.getElementById("assign-modal-cancel");E&&E.addEventListener("click",f);const m=document.getElementById("assign-modal-save");m&&m.addEventListener("click",c),b.addEventListener("click",function(B){B.target===b&&f()});const h=o();h&&h.addEventListener("change",function(){h.checked?e.selected=new Set(e.clients.map(B=>String(B.id))):e.selected=new Set,r()});const T=a();T&&T.addEventListener("change",function(B){const P=B.target.closest('input[type="checkbox"][data-cid]');if(!P)return;const H=P.dataset.cid;P.checked?e.selected.add(H):e.selected.delete(H),p()})}function v(){e.opened&&(l(),r())}typeof window.subscribeI18n=="function"&&window.subscribeI18n("assign-clients-modal",v),window.openAssignClientsModal=function(b,M){u(),d(b,M)}})();(function(){const e={page:1,per_page:50,q:"",total:0,rows:[],loaded:!1};function n(f){if(!f)return"";try{return new Date(f).toLocaleString()}catch{return f}}function a(f){const c=document.getElementById("access-log-table");c&&(c.innerHTML='<div class="access-log-empty">'+escapeHtml(f)+"</div>");const u=document.getElementById("access-log-pager");u&&(u.innerHTML="")}function o(){const f=document.getElementById("access-log-table");if(!f)return;const c=e.rows||[];if(!c.length){a(t("set-access-log-empty"));return}const u=`
...
`,e.dataset.wbInjected="1";try{const n=window._currentLang||localStorage.getItem("mrpilot_lang")||"th",a=window.I18N;a&&a[n]&&(e.querySelectorAll("[data-i18n]").forEach(o=>{const s=o.getAttribute("data-i18n");a[n][s]&&(o.textContent=a[n][s])}),e.querySelectorAll("[data-i18n-placeholder]").forEach(o=>{const s=o.getAttribute("data-i18n-placeholder");a[n][s]&&(o.placeholder=a[n][s])}))}catch{}}})();(function(){const e=H=>document.getElementById(H);async function n(H,_){return await fetch(H,{method:"PATCH",headers:{Authorization:"Bearer "+token,"Content-Type":"application/json"},body:JSON.stringify(_||{})})}async function a(H){return await fetch(H,{method:"DELETE",headers:{Authorization:"Bearer "+token}})}let o=null;async function s(){try{o=await apiGet("/api/line/binding")}catch{o={bound:!1}}return o}function i(H,_){if(!H)return;H.style.display="",H.className="notif-line-check "+(_?"bound":"unbound");const g=_?'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M20 6 9 17l-5-5"/></svg>':'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><path d="M12 8v4M12 16h.01"/></svg>';H.innerHTML=g+"<span>"+escapeHtml(t(_?"notif-line-bound":"notif-line-not-bound"))+"</span>"}function r(H){if(H==null)return"-";const _=Number(H);return isNaN(_)?String(H):"฿ "+_.toLocaleString("en-US",{minimumFractionDigits:2,maximumFractionDigits:2})}function p(H){if(!H)return"-";try{const _=new Date(H),g=(_.getMonth()+1).toString().padStart(2,"0"),k=_.getDate().toString().padStart(2,"0"),S=_.getHours().toString().padStart(2,"0"),C=_.getMinutes().toString().padStart(2,"0");return`${g}-${k} ${S}:${C}`}catch{return H}}function l(H){const _=e("notif-rules-list"),g=e("notif-rules-empty"),k=e("notif-rules-count");if(!(!_||!g)){if(k.textContent=String(H.length),k.className="auto-status-pill "+(H.length>0?"active":"none"),!H.length){g.style.display="",_.style.display="none",_.innerHTML="";return}g.style.display="none",_.style.display="",_.innerHTML=H.map(S=>{const C=S.template_code==="large_invoice",q=C?"notif-rule-large-tag":"notif-rule-exception-tag",L=C?"large":"";let D=[];if(C){const V=S.params&&S.params.threshold?r(S.params.threshold):"-";D.push(escapeHtml(t("notif-rule-threshold-prefix"))+" "+V)}S.enabled||D.push('<span style="color:#9ca3af;">'+escapeHtml(t("notif-rule-disabled"))+"</span>");const Y=D.length?D.join(' <span class="dot"></span> '):"";return`
...
`,e.dataset.wbInjected="1";try{const n=window._currentLang||localStorage.getItem("mrpilot_lang")||"th",a=window.I18N;a&&a[n]&&(e.querySelectorAll("[data-i18n]").forEach(o=>{const s=o.getAttribute("data-i18n");a[n][s]&&(o.textContent=a[n][s])}),e.querySelectorAll("[data-i18n-placeholder]").forEach(o=>{const s=o.getAttribute("data-i18n-placeholder");a[n][s]&&(o.placeholder=a[n][s])}))}catch{}}})();(function(){const e=document.getElementById("archive-token-modal");if(!(!e||e.dataset.wbInjected==="1")){e.innerHTML=`
        ...
        `;f.innerHTML=c+u}function r(d){return d==null?"":String(d).replace(/[&<>"']/g,f=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[f])}function p(d){const f=new Date,c=f.getFullYear(),u=f.getMonth()+1;if(d==="all")return"all";if(d==="this-month")return`${c}-${String(u).padStart(2,"0")}`;if(d==="last-month"){const v=new Date(c,u-2,1);return`${v.getFullYear()}-${String(v.getMonth()+1).padStart(2,"0")}`}return d==="this-year"?`${c}`:d==="this-quarter"?`${c}-Q${Math.floor((u-1)/3)+1}`:"all"}window.openReportModal=async function(d){d=d||{},n(),typeof applyLang=="function"?applyLang(currentLang):document.querySelectorAll("#report-modal [data-i18n]").forEach(M=>{const E=M.getAttribute("data-i18n");I18N[currentLang]&&I18N[currentLang][E]&&(M.textContent=I18N[currentLang][E])});const f=document.getElementById("report-period-section");f&&(f.style.display=d.mode==="client"?"":"none");const c=document.getElementById("report-tpl-list");c.innerHTML=`<div class="report-tpl-loading">${r(t("report-modal-loading"))}</div>`,document.getElementById("report-modal").style.display="";const u=await s(currentLang,d&&d.mode);i(u),o=d;const v=document.getElementById("report-modal-download"),b=v.cloneNode(!0);v.parentNode.replaceChild(b,v),b.addEventListener("click",()=>l(o))};async function l(d){if(!d)return;const f=document.querySelector('input[name="report-tpl"]:checked');if(!f){showToast(t("report-toast-no-selection"),"info");return}const c=f.value,u=document.querySelector('input[name="report-period"]:checked'),v=u?u.value:"all",b=p(v),M=document.getElementById("report-modal-download"),E=M.innerHTML;M.disabled=!0,M.innerHTML=`<span>${r(t("report-modal-loading"))}</span>`;try{const m=localStorage.getItem("mrpilot_token");let h,T;if(d.mode==="records")h=await fetch("/api/reports/export",{method:"POST",headers:{Authorization:"Bearer "+m,"Content-Type":"application/json"},body:JSON.stringify({template:c,lang:currentLang,records:d.records||[],meta:d.meta||{}})}),T=`mrpilot-${c}-${Date.now()}.xlsx`;else if(d.mode==="client"){const S=`/api/reports/clients/${d.clientId}/export?template=${encodeURIComponent(c)}&lang=${encodeURIComponent(currentLang)}&month=${encodeURIComponent(b)}`;h=await fetch(S,{headers:{Authorization:"Bearer "+m}}),T=`${(d.clientName||"client").replace(/[^a-zA-Z0-9\u0e00-\u0e7f\u4e00-\u9fff]/g,"_").slice(0,40)}-${c}.xlsx`}else if(d.mode==="history-batch")c==="sales_detail_th"?(h=await fetch("/api/ocr/export-by-history-ids",{method:"POST",headers:{Authorization:"Bearer "+m,"Content-Type":"application/json"},body:JSON.stringify({template:"sales_detail_th",lang:currentLang,history_ids:d.historyIds||[],client_id:d.clientId||null})}),T=`Pearnly_SalesDetail_${Date.now()}.xlsx`):(h=await fetch("/api/reports/history/batch_export",{method:"POST",headers:{Authorization:"Bearer "+m,"Content-Type":"application/json"},body:JSON.stringify({template:c,lang:currentLang,history_ids:d.historyIds||[],client_id:d.clientId||null})}),T=`mrpilot-batch-${c}-${Date.now()}.xlsx`);else throw new Error("unknown mode: "+d.mode);if(!h.ok){let S="HTTP "+h.status;try{const C=await h.json();C&&C.detail&&(S=C.detail)}catch(C){console.warn("[batch-export] resp.json err.detail parse failed:",C)}h.status===404?showToast(t("report-toast-empty"),"info"):showToast(t("report-toast-fail")+" · "+S,"error");return}const B=await h.blob();let P=T;const _=(h.headers.get("Content-Disposition")||"").match(/filename\*=UTF-8''([^;]+)/i);if(_)try{P=decodeURIComponent(_[1])}catch{}const g=URL.createObjectURL(B),k=document.createElement("a");k.href=g,k.download=P,document.body.appendChild(k),k.click(),document.body.removeChild(k),URL.revokeObjectURL(g),showToast(t("report-toast-success"),"success"),a()}catch(m){console.error("doDownload fail",m),showToast(t("report-toast-fail")+" · "+(m.message||""),"error")}finally{M.disabled=!1,M.innerHTML=E}}document.addEventListener("DOMContentLoaded",()=>{const d=document.getElementById("btn-export");if(d){const c=d.cloneNode(!0);d.parentNode.replaceChild(c,d),c.addEventListener("click",()=>{if(typeof _results>"u"||!_results||_results.length===0){showToast(t("report-toast-no-selection"),"info");return}openReportModal({mode:"records",records:_results.map(u=>({filename:u.filename,merged_fields:u.merged_fields||{}}))})})}const f=document.getElementById("history-batch-export");f&&f.addEventListener("click",()=>{if(typeof _historySelected>"u"||_historySelected.size===0){showToast(t("report-toast-no-selection"),"info");return}openReportModal({mode:"history-batch",historyIds:Array.from(_historySelected)})})}),window.openClientExportModal=function(d,f){openReportModal({mode:"client",clientId:d,clientName:f||""})}})();(function(){const n=typeof window<"u"&&"showDirectoryPicker"in window,a=/\.(pdf|jpe?g|png|webp)$/i,o="mrpilot_folder_watcher",s=1;let i=null,r=null,p=null,l=60,d=!1,f=!1,c=0,u=0,v=0,b=[],M=null,E=!1;function m(){return i||(i=new Promise((x,$)=>{const j=indexedDB.open(o,s);j.onupgradeneeded=G=>{const F=G.target.result;F.objectStoreNames.contains("handles")||F.createObjectStore("handles"),F.objectStoreNames.contains("seen")||F.createObjectStore("seen"),F.objectStoreNames.contains("config")||F.createObjectStore("config")},j.onsuccess=G=>x(G.target.result),j.onerror=G=>$(G.target.error)}),i)}function h(x,$){return m().then(j=>new Promise((G,F)=>{const z=j.transaction(x,"readonly").objectStore(x).get($);z.onsuccess=()=>G(z.result),z.onerror=()=>F(z.error)}))}function T(x,$,j){return m().then(G=>new Promise((F,y)=>{const z=G.transaction(x,"readwrite");z.objectStore(x).put(j,$),z.oncomplete=()=>F(),z.onerror=()=>y(z.error)}))}function B(x,$){return m().then(j=>new Promise((G,F)=>{const y=j.transaction(x,"readwrite");y.objectStore(x).delete($),y.oncomplete=()=>G(),y.onerror=()=>F(y.error)}))}function P(x){return m().then($=>new Promise((j,G)=>{const F=$.transaction(x,"readwrite");F.objectStore(x).clear(),F.oncomplete=()=>j(),F.onerror=()=>G(F.error)}))}async function H(x){if(!x)return!1;try{const $={mode:"read"};let j=await x.queryPermission($);return j==="granted"?!0:(j=await x.requestPermission($),j==="granted")}catch($){return console.warn("[folder] permission check failed:",$),!1}}function _(x,$){const j=document.getElementById("folder-status-summary");j&&(j.setAttribute("data-i18n",x),j.textContent=t(x),j.className="auto-status-pill"+($?" "+$:""))}function g(x){["folder-unsupported","folder-empty","folder-active"].forEach($=>{const j=document.getElementById($);j&&(j.style.display=$===x?"":"none")})}function k(x){if(!x)return"-";const $=x instanceof Date?x:new Date(x),j=String($.getHours()).padStart(2,"0"),G=String($.getMinutes()).padStart(2,"0"),F=String($.getSeconds()).padStart(2,"0");return`${j}:${G}:${F}`}function S(){g("folder-active");const x=document.getElementById("folder-config-path");x&&r&&(x.textContent=r.name||"-");const $=document.getElementById("folder-interval-select");$&&($.value=String(l)),document.getElementById("folder-stat-last").textContent=M?k(M):"-",document.getElementById("folder-stat-processed").textContent=String(c),document.getElementById("folder-stat-failed").textContent=String(u),document.getElementById("folder-stat-queue").textContent=String(v);const j=document.getElementById("btn-folder-pause"),G=document.getElementById("btn-folder-resume");j&&(j.style.display=d?"none":""),G&&(G.style.display=d?"":"none"),d?_("folder-status-paused","paused"):_("folder-status-running","running");const F=document.getElementById("folder-status-text");F&&(F.setAttribute("data-i18n",d?"folder-status-paused":"folder-status-running"),F.textContent=t(d?"folder-status-paused":"folder-status-running"));const y=document.getElementById("folder-status-pulse");y&&(y.className="folder-status-pulse"+(d?" paused":"")),C()}function C(){const x=document.getElementById("folder-recent-list");if(x){if(b.length===0){x.innerHTML=`<div class="folder-recent-empty">${escapeHtml(t("folder-recent-empty"))}</div>`;return}x.innerHTML=b.slice(0,20).map($=>{let j;$.status==="ok"?j=`<span class="folder-recent-icon ok">${svgIcon("check",12)}</span>`:$.status==="dup"?j=`<span class="folder-recent-icon dup" title="${escapeHtml(t("folder-recent-dup"))}">${svgIcon("copy",12)}</span>`:$.status==="skip"?j=`<span class="folder-recent-icon skip" title="${escapeHtml(t("folder-recent-skip"))}">${svgIcon("minus",12)}</span>`:j=`<span class="folder-recent-icon fail">${svgIcon("alert",12)}</span>`;const G=$.status==="fail"&&$.error?$.error:$.status==="dup"&&$.reason||$.status==="skip"&&$.reason?$.reason:"",F=G?`<div class="folder-recent-err">${escapeHtml(G)}</div>`:"";return`
        ...
        `}function C(){const L=document.getElementById("btn-email-bind");L&&L.addEventListener("click",()=>f("new"));const D=document.getElementById("btn-email-edit");D&&D.addEventListener("click",()=>f("edit"));const Y=document.getElementById("btn-email-unbind");Y&&Y.addEventListener("click",H);const V=document.getElementById("btn-email-trigger");V&&V.addEventListener("click",_);const W=document.getElementById("email-enabled-toggle");W&&W.addEventListener("change",g);const te=document.getElementById("email-modal-close");te&&te.addEventListener("click",c);const re=document.getElementById("btn-email-modal-cancel");re&&re.addEventListener("click",c);const A=document.getElementById("btn-email-modal-test");A&&A.addEventListener("click",B);const I=document.getElementById("btn-email-modal-save");I&&I.addEventListener("click",P);const w=document.getElementById("email-preset");w&&w.addEventListener("change",K=>u(K.target.value));const R=document.getElementById("email-address");R&&!R.dataset.autoBound&&(R.dataset.autoBound="1",R.addEventListener("blur",K=>b((K.target.value||"").trim())),R.addEventListener("input",K=>{const Z=(K.target.value||"").trim();Z.includes("@")&&Z.split("@")[1].includes(".")&&b(Z)}));const N=document.getElementById("btn-email-refresh-logs");N&&N.addEventListener("click",()=>{N.classList.add("spinning"),setTimeout(()=>N.classList.remove("spinning"),600),k()})}C(),window._loadEmailIngestPanel=i,window._rerenderEmailIngest=function(){if(!o)return;r();const L=document.getElementById("email-logs-section");e&&L&&L.open&&k()};let q=null;window._startEmailLogAutoRefresh=function(){q||(q=setInterval(()=>{e&&o&&k()},3e4))},window._stopEmailLogAutoRefresh=function(){q&&(clearInterval(q),q=null)}})();(function(){let e=[],n=null,a=[],o="all",s=null,i=!1;async function r(){if(i){C();return}i=!0,p(),await l(),C()}function p(){const y=document.getElementById("bank-file-input");y&&!y._bound&&(y._bound=!0,y.addEventListener("change",b));const z=document.getElementById("btn-bank-queue-clear-done");z&&!z._bound&&(z._bound=!0,z.addEventListener("click",B));const O=document.getElementById("btn-bank-back");O&&!O._bound&&(O._bound=!0,O.addEventListener("click",()=>{n=null,a=[],te()}));const J=document.getElementById("btn-bank-delete");J&&!J._bound&&(J._bound=!0,J.addEventListener("click",g));const X=document.getElementById("btn-bank-run-match");X&&!X._bound&&(X._bound=!0,X.addEventListener("click",_)),document.querySelectorAll(".bank-filter-btn").forEach(fe=>{fe._bound||(fe._bound=!0,fe.addEventListener("click",()=>{o=fe.dataset.bankFilter||"all",document.querySelectorAll(".bank-filter-btn").forEach(me=>{me.classList.toggle("active",me===fe)}),Z()}))}),document.querySelectorAll("[data-bank-cand-close]").forEach(fe=>{fe._bound||(fe._bound=!0,fe.addEventListener("click",ne))});const de=document.getElementById("btn-bank-cand-pane-close");de&&!de._bound&&(de._bound=!0,de.addEventListener("click",ne));const se=document.getElementById("btn-bank-cand-ignore");se&&!se._bound&&(se._bound=!0,se.addEventListener("click",k));const ce=document.getElementById("btn-bank-cand-ignore-pane");ce&&!ce._bound&&(ce._bound=!0,ce.addEventListener("click",k));const ae=document.getElementById("bank-client-badge");ae&&!ae._bound&&(ae._bound=!0,ae.addEventListener("click",I)),document.querySelectorAll("[data-bank-client-picker-close]").forEach(fe=>{fe._bound||(fe._bound=!0,fe.addEventListener("click",w))});const pe=document.getElementById("btn-bank-client-picker-save");pe&&!pe._bound&&(pe._bound=!0,pe.addEventListener("click",N)),document.querySelectorAll(".bank-sessions-chip").forEach(fe=>{fe._bound||(fe._bound=!0,fe.addEventListener("click",()=>{q=fe.dataset.sessFilter||"all",document.querySelectorAll(".bank-sessions-chip").forEach(me=>{me.classList.toggle("active",me===fe)}),L()}))})}async function l(){try{const y=await fetch("/api/bank-recon/sessions?limit=30",{headers:{Authorization:"Bearer "+token}});if(!y.ok)throw new Error("sessions:"+y.status);e=await y.json(),L()}catch(y){console.warn("[bank-recon] loadSessions failed",y),e=[],L()}}async function d(y){try{const z="/api/bank-recon/sessions/"+encodeURIComponent(y)+(o!=="all"?"?filter="+o:""),O=await fetch(z,{headers:{Authorization:"Bearer "+token}});if(!O.ok)throw new Error("detail:"+O.status);const J=await O.json();n=J.session,a=J.transactions||[],W()}catch(z){console.warn("[bank-recon] loadSessionDetail failed",z),showToast(t("bank-load-failed"),"error")}}let f=[],c=0;const u=3;function v(){return c+=1,"q"+c+"_"+Date.now()}async function b(y){const z=Array.from(y.target.files||[]);if(y.target.value="",z.length!==0){for(const O of z){const J={id:v(),file:O,name:O.name,size:O.size,status:"pending",progress:0,error_code:null,tx_count:0,session_id:null};O.name.toLowerCase().endsWith(".pdf")?O.size>20*1024*1024&&(J.status="failed",J.error_code="bank_recon.file_too_large"):(J.status="failed",J.error_code="bank_recon.only_pdf"),f.push(J)}M(),E(),P()}}function M(){const y=document.getElementById("bank-upload-queue");y&&(y.style.display=""),oe(),ue()}function E(){const y=document.getElementById("bank-upload-queue-list"),z=document.getElementById("bank-upload-queue-summary");if(!y)return;if(f.length===0){y.innerHTML="",z&&(z.textContent="");const se=document.getElementById("bank-upload-queue");se&&(se.style.display="none");return}let O=0,J=0,X=0,de=0;for(const se of f)se.status==="ok"?O++:se.status==="failed"?J++:se.status==="uploading"||se.status==="parsing"?X++:de++;z&&(z.textContent=t("bank-queue-summary").replace("{ok}",O).replace("{run}",X).replace("{wait}",de).replace("{fail}",J)),y.innerHTML=f.map(m).join(""),y.querySelectorAll("[data-q-act]").forEach(se=>{const ce=se.dataset.qAct,ae=se.dataset.qId;se.addEventListener("click",()=>{ce==="retry"&&h(ae),ce==="remove"&&T(ae)})})}function m(y){const z=(y.size/1024).toFixed(0)+" KB";let O="",J="";if(y.status==="pending")O='<span class="bq-stat bq-wait">'+t("bank-queue-status-wait")+"</span>",J='<button data-q-act="remove" data-q-id="'+F(y.id)+'" class="bq-act">×</button>';else if(y.status==="uploading")O='<span class="bq-stat bq-run">'+t("bank-queue-status-uploading")+'</span><div class="bq-bar"><div class="bq-bar-fill" style="width:'+(y.progress||0)+'%"></div></div>';else if(y.status==="parsing")O='<span class="bq-stat bq-run">'+t("bank-queue-status-parsing")+'</span><div class="bq-bar"><div class="bq-bar-fill bq-bar-indet"></div></div>';else if(y.status==="ok")O='<span class="bq-stat bq-ok">'+t("bank-queue-status-ok").replace("{n}",y.tx_count||0)+"</span>",J='<button data-q-act="remove" data-q-id="'+F(y.id)+'" class="bq-act">×</button>';else if(y.status==="failed"){const X=x(y.error_code||"unknown");O='<span class="bq-stat bq-fail" title="'+F(X)+'">'+F(X)+"</span>",J='<button data-q-act="retry" data-q-id="'+F(y.id)+'" class="bq-act bq-act-retry">'+t("bank-queue-retry")+'</button><button data-q-act="remove" data-q-id="'+F(y.id)+'" class="bq-act">×</button>'}return'<div class="bq-row" data-q-row="'+F(y.id)+'"><div class="bq-name" title="'+F(y.name)+'">'+F(y.name)+'</div><div class="bq-size">'+z+'</div><div class="bq-status">'+O+'</div><div class="bq-actions">'+J+"</div></div>"}function h(y){const z=f.find(O=>O.id===y);z&&(z.status="pending",z.error_code=null,z.progress=0,E(),P())}function T(y){const z=f.findIndex(J=>J.id===y);if(z<0)return;const O=f[z];O.status==="uploading"||O.status==="parsing"||(f.splice(z,1),E())}function B(){f=f.filter(y=>y.status!=="ok"),E()}async function P(){for(;;){if(f.filter(O=>O.status==="uploading"||O.status==="parsing").length>=u)return;const z=f.find(O=>O.status==="pending");if(!z){f.every(O=>O.status==="ok"||O.status==="failed")&&(await l(),typeof window.loadReconcilePage=="function"&&window.loadReconcilePage());return}H(z).then(()=>P())}}async function H(y){y.status="uploading",y.progress=0,E();try{const z=new FormData;z.append("file",y.file,y.name);const O=await new Promise((X,de)=>{const se=new XMLHttpRequest;se.open("POST","/api/bank-recon/upload"),se.setRequestHeader("Authorization","Bearer "+token),se.upload.onprogress=ce=>{ce.lengthComputable&&(y.progress=Math.min(99,Math.round(ce.loaded/ce.total*100)),E())},se.upload.onload=()=>{y.status="parsing",E()},se.onload=()=>{se.status>=200&&se.status<300?X({status:se.status,text:se.responseText}):X({status:se.status,text:se.responseText})},se.onerror=()=>de(new Error("network")),se.send(z)});let J={};try{J=JSON.parse(O.text||"{}")}catch{J={}}if(O.status>=400){y.status="failed",y.error_code=J&&J.detail||"unknown",E();return}if(J.parse_status==="parse_failed"){y.status="failed",y.error_code=J.error==="scanned_pdf_not_yet"?"bank_recon.scanned":"bank_recon.no_tx",E();return}y.status="ok",y.tx_count=J.tx_count||0,y.session_id=J.session_id||null,E()}catch(z){console.warn("[bank-recon] upload failed",z),y.status="failed",y.error_code="network",E()}}async function _(){if(!n)return;const y=document.getElementById("btn-bank-run-match"),z=y.innerHTML;y.disabled=!0,y.innerHTML="<span>"+t("bank-matching")+"</span>";try{const O=await fetch("/api/bank-recon/sessions/"+encodeURIComponent(n.id)+"/match",{method:"POST",headers:{Authorization:"Bearer "+token}});if(!O.ok)throw new Error("match:"+O.status);const J=await O.json();showToast(t("bank-match-done").replace("{matched}",J.matched).replace("{suggested}",J.suggested).replace("{unmatched}",J.unmatched),"success"),await d(n.id),await l()}catch(O){console.warn("[bank-recon] match failed",O),showToast(t("bank-match-failed"),"error")}finally{y.disabled=!1,y.innerHTML=z}}async function g(){if(!(!n||!await showConfirm(t("bank-delete-confirm"),{danger:!0})))try{const z=await fetch("/api/bank-recon/sessions/"+encodeURIComponent(n.id),{method:"DELETE",headers:{Authorization:"Bearer "+token}});if(!z.ok)throw new Error("delete:"+z.status);showToast(t("bank-deleted"),"success"),n=null,a=[],te(),await l()}catch(z){console.warn("[bank-recon] delete failed",z),showToast(t("bank-delete-failed"),"error")}}async function k(){if(s)try{const y=await fetch("/api/bank-recon/tx/"+encodeURIComponent(s.id)+"/override",{method:"POST",headers:{Authorization:"Bearer "+token,"Content-Type":"application/json"},body:JSON.stringify({status:"ignored"})});if(!y.ok)throw new Error("ignore:"+y.status);ne(),await d(n.id)}catch{showToast(t("bank-action-failed"),"error")}}async function S(y){if(s)try{const z=await fetch("/api/bank-recon/tx/"+encodeURIComponent(s.id)+"/override",{method:"POST",headers:{Authorization:"Bearer "+token,"Content-Type":"application/json"},body:JSON.stringify({status:"matched",history_id:y})});if(!z.ok)throw new Error("pick:"+z.status);showToast(t("bank-matched-ok"),"success"),ne(),await d(n.id)}catch{showToast(t("bank-action-failed"),"error")}}function C(){const y=document.getElementById("bank-status-summary");if(!y)return;if(e.length===0){y.textContent=t("bank-pill-none");return}let O=0;for(const J of e)J.parse_status==="parsed"&&(J.unmatched_count||0)>0&&O++;y.textContent=O>0?t("bank-pill-pending").replace("{n}",O):t("bank-pill-ok")}let q="all";function L(){const y=document.getElementById("bank-sessions-list");if(!y)return;let z=e||[];if(q==="parsed"?z=z.filter(O=>O.parse_status==="parsed"):q==="failed"&&(z=z.filter(O=>O.parse_status==="parse_failed")),!e||e.length===0){y.innerHTML='<div class="bank-empty" data-i18n="bank-sessions-empty">'+t("bank-sessions-empty")+"</div>";return}if(z.length===0){y.innerHTML='<div class="bank-empty">'+t("bank-sess-filter-empty")+"</div>";return}y.innerHTML=z.map(O=>Y(O)).join(""),y.querySelectorAll(".bank-session-row").forEach(O=>{O.addEventListener("click",J=>{J.target.closest(".bank-session-trash")||d(O.dataset.sessionId)})}),y.querySelectorAll(".bank-session-trash").forEach(O=>{O.addEventListener("click",J=>{J.stopPropagation();const X=O.dataset.sessionId,de=O.dataset.sessionName||"";D(X,de)})})}async function D(y,z){if(!y)return;const O=(t("bank-session-delete-confirm")||"确定删除这条对账记录吗?").replace("{name}",z||"");if(await showConfirm(O,{danger:!0}))try{const X=await fetch("/api/bank-recon/sessions/"+encodeURIComponent(y),{method:"DELETE",headers:{Authorization:"Bearer "+token}});if(!X.ok)throw new Error("delete:"+X.status);showToast(t("bank-deleted"),"success"),n&&n.id===y&&(n=null,a=[],te()),await l(),typeof window.loadReconcilePage=="function"&&window.loadReconcilePage()}catch(X){console.warn("[bank-recon] delete failed",X),showToast(t("bank-delete-failed"),"error")}}window._deleteBankSession=D;function Y(y){const z=(y.bank_code||"OTHER").toUpperCase(),O=G(y.period_start,y.period_end),J=y.account_last4?"···"+y.account_last4:"",X=V(y),de=j(y.created_at);return`
            <div class="bank-session-row" data-session-id="${F(y.id)}">
                <div class="bank-session-bank bk-${F(z)}">${F(z)}</div>
                <div class="bank-session-info">
                    <div class="bank-session-title">${F(y.source_filename||O||"-")}</div>
                    <div class="bank-session-meta">${F(O)} · ${F(J)} · ${F(de)}</div>
                </div>
                <div class="bank-session-counts">${X}</div>
                <button class="bank-session-trash" data-session-id="${F(y.id)}" data-session-name="${F(y.source_filename||"")}" title="${F(t("bank-session-delete-tip")||"删除")}">
...
`,e.dataset.wbInjected="1";try{const n=window._currentLang||localStorage.getItem("mrpilot_lang")||"th",a=window.I18N;a&&a[n]&&(e.querySelectorAll("[data-i18n]").forEach(o=>{const s=o.getAttribute("data-i18n");a[n][s]&&(o.textContent=a[n][s])}),e.querySelectorAll("[data-i18n-placeholder]").forEach(o=>{const s=o.getAttribute("data-i18n-placeholder");a[n][s]&&(o.placeholder=a[n][s])}))}catch{}}})();(function(){let e=[],n=null,a="",o="seller";const s={page:0,pageSize:12,keyword:""},i=new Set;let r=[];const p={keyword:""};let l=null;function d(){return{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||"")}}async function f(w,R={}){const N=await fetch(w,{...R,headers:{"Content-Type":"application/json",...d(),...R.headers||{}}});if(!N.ok){const K=await N.json().catch(()=>({}));throw new Error(K.detail||"HTTP "+N.status)}return N.json()}async function c(){try{e=(await f("/api/clients")).clients||[],window._clientsCache=e}catch(w){console.error("loadClientsCache fail",w),e=[]}try{typeof window._refreshExcClientFilter=="function"&&window._refreshExcClientFilter()}catch{}try{typeof window._refreshClientSwitcher=="function"&&window._refreshClientSwitcher()}catch{}return e}function u(w){o=w==="buyer"?"buyer":"seller",document.querySelectorAll("[data-cust-tab]").forEach(K=>K.classList.toggle("active",K.dataset.custTab===o));const R=document.getElementById("cust-pane-seller"),N=document.getElementById("cust-pane-buyer");R&&R.classList.toggle("active",o==="seller"),N&&N.classList.toggle("active",o==="buyer")}function v(){const w=window._userInfo||{},R=String(w.role||"").toLowerCase(),N=String(w.tenant_role||"").toLowerCase();return w.is_super_admin===!0||w.is_owner===!0||R==="owner"||R==="admin"||N==="owner"||N==="admin"}function b(){window._workspaceClientsCache=r,typeof window.renderWorkspaceControl=="function"&&window.renderWorkspaceControl()}async function M(){try{const w=await f("/api/workspace/clients");r=w&&(w.clients||w.items)||[],window._workspaceClientsCache=r}catch(w){console.error("loadSellerCache fail",w),r=[]}return r}function E(){const w=p.keyword.trim().toLowerCase();return w?r.filter(R=>(R.name||"").toLowerCase().includes(w)||(R.tax_id||"").toLowerCase().includes(w)):r}function m(){const w=document.getElementById("seller-tbody");if(!w)return;const R=v(),N=document.getElementById("btn-seller-new");N&&(N.style.display=R?"":"none");const K=E(),Z=typeof window.getActiveWorkspaceClientId=="function"?window.getActiveWorkspaceClientId():null;if(!K.length){w.innerHTML=`<div class="cust-empty">${escapeHtml(t(p.keyword?"cust-no-match":"seller-empty"))}</div>`;return}w.innerHTML=K.map(le=>{const U=Z!=null&&Number(Z)===Number(le.id)?`<span class="cust-badge-current"><svg viewBox="0 0 14 14" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M2 7.5l3.2 3.2L12 4"/></svg>${escapeHtml(t("seller-current"))}</span>`:`<button class="cust-row-btn primary" data-saction="activate" data-wid="${le.id}">${escapeHtml(t("seller-set-current"))}</button>`,Q=R?`
            ...
            </div>`}).join("")}function h(w){l=w?w.id:null,document.getElementById("wsclient-modal-title").textContent=t(w?"wsclient-modal-edit":"wsclient-modal-new"),document.getElementById("wsclient-input-name").value=w&&w.name||"",document.getElementById("wsclient-input-tax").value=w&&w.tax_id||"",document.getElementById("wsclient-modal-archive").style.display=w?"":"none",document.getElementById("wsclient-modal-mask").style.display="flex",setTimeout(()=>document.getElementById("wsclient-input-name").focus(),50)}function T(){document.getElementById("wsclient-modal-mask").style.display="none",l=null}async function B(){const w=document.getElementById("wsclient-input-name").value.trim(),R=document.getElementById("wsclient-input-tax").value.trim();if(!w){showToast(t("client-msg-name-required"),"fail");return}try{l?(await f("/api/workspace/clients/"+l,{method:"PATCH",body:JSON.stringify({name:w,tax_id:R})}),showToast(t("client-msg-updated"),"success")):(await f("/api/workspace/clients",{method:"POST",body:JSON.stringify({name:w,tax_id:R||null})}),showToast(t("client-msg-created"),"success")),T(),await M(),m(),b()}catch(N){const K=N&&N.message?N.message:t("client-msg-save-fail");showToast(t("client-msg-save-fail")+" · "+K,"fail")}}async function P(){if(!l)return;const w=r.find(N=>Number(N.id)===Number(l));if(await showConfirm(t("wsclient-archive-confirm").replace("{name}",w?w.name:""),{danger:!0}))try{const N=l;await f("/api/workspace/clients/"+N,{method:"DELETE"}),showToast(t("wsclient-archived"),"success"),typeof window.getActiveWorkspaceClientId=="function"&&Number(window.getActiveWorkspaceClientId())===Number(N)&&typeof window.enterPersonalMode=="function"&&window.enterPersonalMode(),T(),await M(),m(),b()}catch{showToast(t("client-msg-save-fail"),"fail")}}function H(){const w=s.keyword.trim().toLowerCase();return w?e.filter(R=>(R.name||"").toLowerCase().includes(w)||(R.short_name||"").toLowerCase().includes(w)||(R.tax_id||"").toLowerCase().includes(w)):e}function _(){const w=H(),R=s.pageSize,N=Math.max(0,Math.ceil(w.length/R)-1);s.page>N&&(s.page=N);const K=s.page*R;return{all:w,items:w.slice(K,K+R),start:K,ps:R,total:w.length,maxPage:N}}function g(){const w=document.getElementById("buyer-tbody");if(!w)return;const{items:R,start:N,ps:K,total:Z,maxPage:le}=_();Z?w.innerHTML=R.map(ee=>{const ne=i.has(ee.id);return`<div class="cust-row buyer-grid${ne?" selected":""}" data-cid="${ee.id}">
...
`,e.dataset.wbInjected="1";try{const n=window._currentLang||localStorage.getItem("mrpilot_lang")||"th",a=window.I18N;a&&a[n]&&(e.querySelectorAll("[data-i18n]").forEach(o=>{const s=o.getAttribute("data-i18n");a[n][s]&&(o.textContent=a[n][s])}),e.querySelectorAll("[data-i18n-placeholder]").forEach(o=>{const s=o.getAttribute("data-i18n-placeholder");a[n][s]&&(o.placeholder=a[n][s])}))}catch{}}})();(function(){let e={statsCache:null,listCache:[],currentRule:null,currentClient:"",currentStatus:"pending",loading:!1,selectedIds:new Set,offset:0,pageSize:50,total:0,loadFailed:!1,listScrollY:0};function n(A,I){let w=t(A)||A;if(I)for(const R in I)w=w.replace(new RegExp("\\{"+R+"\\}","g"),String(I[R]));return w}async function a(){try{const A=e.currentClient||"",I="/api/exceptions/stats?status=pending"+(A?"&client_id="+encodeURIComponent(A):""),w=await fetch(I,{headers:{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||"")}});if(!w.ok)return;const R=await w.json(),N=document.getElementById("nav-exc-badge");if(!N)return;const K=parseInt(R.pending||0,10);K>0?(N.textContent=K>99?"99+":String(K),N.style.display=""):N.style.display="none"}catch{}}function o(A){return A==="high"?`<svg viewBox="0 0 14 14" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
            ...
            </div>`,c();return}const w='<svg viewBox="0 0 14 14" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M3 7l3 3 5-5"/></svg>',R=(e.currentStatus||"pending")==="pending";I.innerHTML=A.map(N=>{const K=N.severity||"medium",Z=t("exc-rule-"+N.rule_code)||N.rule_code,le=N.seller_name&&N.seller_name.trim()?N.seller_name:t("exc-no-seller"),ie=N.filename||"—",U=r(N.invoice_date||N.created_at),Q=N.status==="pending",ee=e.selectedIds.has(N.id),ne=R&&Q;return`
                <div class="exc-row sev-${escapeHtml(K)} ${ee?"selected":""}" data-exc-id="${escapeHtml(String(N.id))}">
                    <div class="exc-row-check ${ee?"checked":""}" data-check-id="${escapeHtml(String(N.id))}" ${ne?"":'style="visibility:hidden;"'}>${w}</div>
        ...
        `;const F=document.getElementById("exc-fld-edit");F&&F.addEventListener("click",()=>{m.editing=!0,m.editFields={..._(m.history)},S()});const y=document.getElementById("exc-fld-cancel");y&&y.addEventListener("click",()=>{m.editing=!1,m.editFields=null,S()});const z=document.getElementById("exc-fld-save");z&&z.addEventListener("click",()=>C()),document.querySelectorAll(".exc-field-input").forEach(ae=>{ae.addEventListener("input",()=>{m.editFields||(m.editFields={}),m.editFields[ae.dataset.editKey]=ae.value})});const J=document.getElementById("exc-pdf-retry");J&&m.openExcId&&J.addEventListener("click",()=>{m.excRow&&T(m.excRow.history_id,m.openExcId)});const X=A.status==="pending",de=!!(A.seller_name&&A.seller_name.trim()),se=document.getElementById("exc-btn-resolve"),ce=document.getElementById("exc-btn-ignore");se.disabled=!X,ce.disabled=!X||!de,ce.title=de?t("exc-ignore-hint"):t("exc-ignore-no-seller")}async function C(){if(!m.openExcId||!m.history||!m.history.pages||m.loading)return;m.loading=!0;const A=showToast(t("exc-fld-saving"),"loading",0);try{const I=JSON.parse(JSON.stringify(m.history.pages||[]));let w=I.findIndex(ie=>!ie.is_duplicate&&!ie.is_copy);w<0&&(w=0),I[w]||(I[w]={fields:{}});const R=I[w].fields||{},N=m.editFields||{},K=new Set(["subtotal","vat","total_amount"]),Z={...R};for(const ie in N){let U=N[ie];if((U===""||U===void 0)&&(U=null),K.has(ie)&&U!==null){const Q=parseFloat(U);U=isNaN(Q)?null:Q}Z[ie]=U}I[w].fields=Z;const le=await fetch("/api/history/"+encodeURIComponent(m.history.id),{method:"PUT",headers:{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||""),"Content-Type":"application/json"},body:JSON.stringify({pages:I})});if(!le.ok)throw new Error("http "+le.status);A(),showToast(t("exc-fld-save-ok"),"success"),P(),await u(),await b(),a()}catch(I){A(),console.warn("save fields fail",I),showToast(t("exc-fld-save-fail"),"error")}finally{m.loading=!1}}async function q(){if(!(!m.openExcId||m.loading)){m.loading=!0;try{const A=await fetch("/api/exceptions/"+m.openExcId+"/resolve",{method:"POST",headers:{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||"")}});if(!A.ok)throw new Error("http "+A.status);showToast(t("exc-toast-resolved"),"success"),P(),await u(),await b(),a()}catch(A){console.warn("resolve fail",A),showToast(t("exc-toast-action-fail"),"error")}finally{m.loading=!1}}}async function L(){if(!(!m.openExcId||m.loading)){m.loading=!0;try{const A=await fetch("/api/exceptions/"+m.openExcId+"/ignore",{method:"POST",headers:{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||"")}});if(!A.ok)throw new Error("http "+A.status);showToast(t("exc-toast-ignored"),"success"),P(),await u(),await b(),a()}catch(A){console.warn("ignore fail",A),showToast(t("exc-toast-action-fail"),"error")}finally{m.loading=!1}}}let D=!1;async function Y(){if(D)return;const A=Array.from(e.selectedIds);if(A.length===0||!await showConfirm(n("exc-batch-confirm-resolve",{n:A.length})))return;D=!0;const w=showToast(n("exc-batch-count",{n:A.length})+" …","loading",0);try{const R=await fetch("/api/exceptions/batch",{method:"POST",headers:{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||""),"Content-Type":"application/json"},body:JSON.stringify({ids:A,action:"resolve"})});if(!R.ok)throw new Error("http "+R.status);const N=await R.json();w(),showToast(n("exc-toast-batch-resolved",{n:N.processed||0}),"success"),e.selectedIds.clear(),await u(),await b(),a()}catch(R){w(),console.warn("batch resolve fail",R),showToast(t("exc-toast-batch-fail"),"error")}finally{D=!1}}async function V(){if(D)return;const A=Array.from(e.selectedIds);if(A.length===0||!await showConfirm(n("exc-batch-confirm-ignore",{n:A.length}),{danger:!1}))return;D=!0;const w=showToast(n("exc-batch-count",{n:A.length})+" …","loading",0);try{const R=await fetch("/api/exceptions/batch",{method:"POST",headers:{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||""),"Content-Type":"application/json"},body:JSON.stringify({ids:A,action:"ignore"})});if(!R.ok)throw new Error("http "+R.status);const N=await R.json();w(),showToast(n("exc-toast-batch-ignored",{n:N.processed||0,wl:N.whitelist_added||0}),"success"),e.selectedIds.clear(),await u(),await b(),a()}catch(R){w(),console.warn("batch ignore fail",R),showToast(t("exc-toast-batch-fail"),"error")}finally{D=!1}}function W(){e.selectedIds.clear(),d(e.listCache)}document.addEventListener("click",A=>{A.target.closest("#exc-drawer-close")&&P(),A.target.closest("#exc-drawer-mask")&&P(),A.target.closest("#exc-btn-resolve")&&q(),A.target.closest("#exc-btn-ignore")&&L(),A.target.closest("#exc-batch-resolve")&&Y(),A.target.closest("#exc-batch-ignore")&&V(),A.target.closest("#exc-batch-clear")&&W(),A.target.closest("#exc-loadmore")&&M()}),document.addEventListener("keydown",A=>{A.key==="Escape"&&m.openExcId&&P()}),document.addEventListener("click",A=>{A.target.closest("#btn-exc-refresh")&&(typeof window.loadExceptionsPage=="function"&&window.loadExceptionsPage(),a())}),document.addEventListener("change",A=>{if(!A.target.closest("#exc-client-filter"))return;const I=A.target;e.currentClient=I.value||"",e.currentRule=null,e.selectedIds.clear(),e.listCache=[],typeof window.loadExceptionsPage=="function"&&window.loadExceptionsPage(),a()}),document.addEventListener("click",A=>{const I=A.target.closest("#exc-status-tabs .exc-status-tab");if(!I)return;const w=I.dataset.status||"pending";w!==e.currentStatus&&(e.currentStatus=w,e.currentRule=null,e.selectedIds.clear(),e.listCache=[],typeof window.loadExceptionsPage=="function"&&window.loadExceptionsPage())}),window.addEventListener("online",()=>{e.loadFailed&&document.getElementById("page-exceptions")?.classList.contains("show")&&window.loadExceptionsPage&&window.loadExceptionsPage()}),setTimeout(a,1500),setInterval(a,6e4);function te(A){if(!A)return"—";try{const I=new Date(A),w=R=>String(R).padStart(2,"0");return`${I.getFullYear()}-${w(I.getMonth()+1)}-${w(I.getDate())} ${w(I.getHours())}:${w(I.getMinutes())}`}catch{return A.slice(0,16).replace("T"," ")}}async function re(){const A=document.getElementById("learned-list");if(A){A.innerHTML=`<div class="learned-empty">${escapeHtml(t("set-learned-loading"))}</div>`;try{const I=await fetch("/api/exception-whitelist",{headers:{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||"")}});if(!I.ok)throw new Error("http "+I.status);const R=(await I.json()).items||[];if(R.length===0){A.innerHTML=`<div class="learned-empty">${escapeHtml(t("set-learned-empty"))}</div>`;return}const N=`<svg viewBox="0 0 14 14" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round">
                ...
                `}).join("")}catch(I){console.warn("loadLearnedRules fail",I),A.innerHTML=`<div class="learned-empty">${escapeHtml(t("exc-toast-load-fail"))}</div>`}}}window.loadLearnedRules=re,document.addEventListener("click",async A=>{const I=A.target.closest("[data-del-wl]");if(!I)return;const w=parseInt(I.dataset.delWl,10);if(!w)return;const R=I.closest(".learned-row"),N=R&&R.querySelector(".learned-seller"),K=N?N.textContent.trim():"",Z=t("set-learned-del-confirm").replace("{seller}",K);if(await showConfirm(Z,{danger:!0}))try{const ie=await fetch("/api/exception-whitelist/"+w,{method:"DELETE",headers:{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||"")}});if(!ie.ok)throw new Error("http "+ie.status);showToast(t("set-learned-del-ok"),"success"),re(),typeof window.loadExceptionsPage=="function"&&document.getElementById("page-exceptions")?.classList.contains("show")&&window.loadExceptionsPage()}catch(ie){console.warn("delete whitelist fail",ie),showToast(t("set-learned-del-fail"),"error")}})})();(function(){let e={items:[],q:"",cat:"",selected:new Set,total:0,categories:{},pageSize:30,loading:!1,focusSearch:!1,searchCaret:0},n=null;function a(){return localStorage.getItem("mrpilot_token")||""}function o(c){const u=typeof currentLang=="string"&&currentLang||window._currentLang||"th",v=c.error_friendly&&c.error_friendly[u];if(v)return v;if(typeof humanizeError=="function"&&c.error_msg)try{return humanizeError(c.error_msg)}catch{}return t("erp-exc-reason-"+(c.category||"other"))}function s(){const c=document.getElementById("erp-exc-batch");if(!c)return;const u=e.selected.size;c.hidden=u===0;const v=c.querySelector(".erp-exc-batch-count");v&&(v.textContent=String(u))}function i(){const c=document.getElementById("erp-exc-block");if(!c)return;const u=e;if(!(u.total>0||!!u.q||!!u.cat)){c.hidden=!0,c.innerHTML="";return}c.hidden=!1;const b=u.categories||{},M=Object.keys(b).reduce((k,S)=>k+b[S],0);let E=`<button class="erp-exc-chip ${u.cat===""?"active":""}" data-erpexc-cat=""><span>${escapeHtml(t("erp-exc-cat-all"))}</span><span class="erp-exc-chip-count">${M}</span></button>`;Object.keys(b).forEach(k=>{E+=`<button class="erp-exc-chip ${u.cat===k?"active":""}" data-erpexc-cat="${escapeHtml(k)}"><span>${escapeHtml(t("erp-exc-cat-"+k))}</span><span class="erp-exc-chip-count">${b[k]}</span></button>`});const m=u.items||[],h=m.length>0&&m.every(k=>u.selected.has(k.id)),T=m.map(k=>{const S=k.state==="needs_action"?"needs":k.state==="retrying"?"retry":"fail",C=t("erp-exc-state-"+(k.state||"failed")),q=o(k),L=u.selected.has(k.id)?"checked":"";return`<div class="erp-exc-row" data-erpexc-id="${escapeHtml(k.id)}">
                ...
                <span class="ex-state"><span class="erp-exc-state ${S}">${escapeHtml(C)}</span></span>
            ...
            <div class="erp-exc-foot">${P}</div>`;const H=document.getElementById("erp-exc-search");if(H){if(u.focusSearch){H.focus();try{H.setSelectionRange(u.searchCaret,u.searchCaret)}catch{}}H.addEventListener("input",()=>{u.q=H.value,u.focusSearch=!0,u.searchCaret=H.selectionStart||H.value.length,clearTimeout(n),n=setTimeout(()=>l(!1),350)}),H.addEventListener("blur",()=>{u.focusSearch=!1})}c.querySelectorAll(".erp-exc-chip").forEach(k=>{k.addEventListener("click",()=>{u.cat=k.dataset.erpexcCat||"",l(!1)})}),c.querySelectorAll("[data-erpexc-retry]").forEach(k=>{k.addEventListener("click",S=>{S.stopPropagation(),r(k.dataset.erpexcRetry,k)})}),c.querySelectorAll(".erp-exc-cb").forEach(k=>{k.addEventListener("change",()=>{const S=k.dataset.erpexcCb;k.checked?u.selected.add(S):u.selected.delete(S);const C=document.getElementById("erp-exc-cb-all");C&&(C.checked=m.length>0&&m.every(q=>u.selected.has(q.id))),s()})});const _=document.getElementById("erp-exc-cb-all");_&&_.addEventListener("change",()=>{m.forEach(k=>{_.checked?u.selected.add(k.id):u.selected.delete(k.id)}),c.querySelectorAll(".erp-exc-cb").forEach(k=>{k.checked=_.checked}),s()}),c.querySelectorAll("[data-erpexc-batch]").forEach(k=>{k.addEventListener("click",()=>p(k.dataset.erpexcBatch))});const g=document.getElementById("erp-exc-more");g&&g.addEventListener("click",()=>l(!0)),c.querySelectorAll(".erp-exc-row:not(.erp-exc-row-head)").forEach(k=>{k.addEventListener("click",S=>{S.target.closest("input,button")||typeof window._erpExcOpenEdit=="function"&&window._erpExcOpenEdit(k.dataset.erpexcId)})})}async function r(c,u){if(c){u&&(u.disabled=!0,u.textContent=t("erp-exc-retrying"));try{const v=await fetch("/api/erp/logs/"+encodeURIComponent(c)+"/retry",{method:"POST",headers:{Authorization:"Bearer "+a()}}),b=await v.json().catch(()=>({}));showToast(v.ok&&b.ok?t("erp-exc-retry-ok"):t("erp-exc-retry-fail"),v.ok&&b.ok?"success":"error")}catch{showToast(t("erp-exc-retry-fail"),"error")}if(e.selected.delete(c),l(!1),typeof window.refreshExcBadge=="function")try{window.refreshExcBadge()}catch{}}}async function p(c){const u=Array.from(e.selected);if(c==="clear"){e.selected.clear(),i();return}if(u.length!==0){if(c==="delete"){if(!await showConfirm(t("erp-exc-batch-delete-confirm",{n:u.length}),{danger:!0}))return;try{const b=await fetch("/api/erp/logs/batch-delete",{method:"POST",headers:{Authorization:"Bearer "+a(),"Content-Type":"application/json"},body:JSON.stringify({log_ids:u.slice(0,200)})}),M=await b.json().catch(()=>({}));showToast(b.ok?t("erp-exc-batch-delete-ok",{n:M.deleted||0}):t("erp-exc-retry-fail"),b.ok?"success":"error")}catch{showToast(t("erp-exc-retry-fail"),"error")}}else if(c==="retry")try{const v=await fetch("/api/erp/logs/batch-retry",{method:"POST",headers:{Authorization:"Bearer "+a(),"Content-Type":"application/json"},body:JSON.stringify({log_ids:u.slice(0,50)})}),b=await v.json().catch(()=>({}));showToast(v.ok?t("erp-exc-batch-retry-ok",{ok:b.succeeded||0,fail:(b.failed||0)+(b.skipped||0)}):t("erp-exc-retry-fail"),v.ok?"success":"error")}catch{showToast(t("erp-exc-retry-fail"),"error")}if(e.selected.clear(),l(!1),typeof window.refreshExcBadge=="function")try{window.refreshExcBadge()}catch{}}}async function l(c){const u=document.getElementById("erp-exc-block");if(!(!u||e.loading)){e.loading=!0;try{const v=new URLSearchParams;e.q&&v.set("q",e.q),e.cat&&v.set("category",e.cat),v.set("limit",String(e.pageSize)),v.set("offset",String(c?e.items.length:0));const b=await fetch("/api/erp/exceptions?"+v.toString(),{headers:{Authorization:"Bearer "+a()}});if(!b.ok){c||(u.hidden=!0);return}const M=await b.json(),E=M.items||[];e.items=c?e.items.concat(E):E,e.total=M.total||0,e.categories=M.categories||{},i()}catch{c||(u.hidden=!0)}finally{e.loading=!1}}}let d={};function f(){const c=document.getElementById("erp-exc-modal");c&&c.remove()}window._erpExcOpenEdit=function(c){const u=(e.items||[]).find(B=>String(B.id)===String(c));if(!u)return;const v=!!u.history_client_id&&u.category==="customer_mismatch",b=u.category==="product_mismatch"&&!!u.history_id&&!!u.endpoint_id,M=o(u),E=u.state==="needs_action"?"needs":u.state==="retrying"?"retry":"fail",m=(B,P)=>`<div class="erp-exc-m-row"><span class="erp-exc-m-k">${escapeHtml(B)}</span><span class="erp-exc-m-v">${escapeHtml(P||"—")}</span></div>`;let h="";if(v)h=`
                ...
                </div>`;else{const B="erp-exc-edit-hint-"+(u.category||"other");let P=t(B);(!P||P===B)&&(P=M),h=`<div class="erp-exc-m-hint">${escapeHtml(P)}</div>`}const T=document.createElement("div");if(T.id="erp-exc-modal",T.className="erp-exc-modal-overlay",T.innerHTML=`
            <div class="erp-exc-modal" role="dialog" aria-modal="true">
                ...
                <div class="erp-exc-m-body">
                    <div class="erp-exc-m-reason"><span class="erp-exc-state ${E}">${escapeHtml(t("erp-exc-state-"+(u.state||"failed")))}</span> ${escapeHtml(M)}${u.error_code?` <span class="erp-exc-code">${escapeHtml(u.error_code)}</span>`:""}</div>
                ...
                <div class="erp-exc-m-foot">
            ...
            </div>`,document.body.appendChild(T),T.addEventListener("click",B=>{B.target===T&&f()}),document.getElementById("erp-exc-m-close").addEventListener("click",f),document.getElementById("erp-exc-m-cancel").addEventListener("click",f),document.getElementById("erp-exc-m-retry").addEventListener("click",()=>{f(),r(u.id,null)}),v){let B="";const P=document.getElementById("erp-exc-m-bind"),H=document.getElementById("erp-exc-m-custlist"),_=document.getElementById("erp-exc-m-search"),g=(S,C)=>{const q=(C||"").trim().toLowerCase(),L=q?S.filter(D=>(D.code||"").toLowerCase().includes(q)||(D.name||"").toLowerCase().includes(q)):S;if(L.length===0){H.innerHTML=`<div class="erp-exc-m-empty">${escapeHtml(t("erp-exc-edit-pick-empty"))}</div>`;return}H.innerHTML=L.slice(0,100).map(D=>`<div class="erp-exc-m-cust" data-cust-code="${escapeHtml(D.code||"")}">
                        <span class="erp-exc-m-cust-name">${escapeHtml(D.name||"")}</span>
                        <span class="erp-exc-m-cust-code">${escapeHtml(D.code||"")}</span>
                    </div>`).join(""),H.querySelectorAll(".erp-exc-m-cust").forEach(D=>{D.addEventListener("click",()=>{B=D.dataset.custCode||"",H.querySelectorAll(".erp-exc-m-cust").forEach(Y=>Y.classList.remove("sel")),D.classList.add("sel"),P&&(P.disabled=!B)})})},k=async()=>{const S=u.endpoint_id;if(d[S]){g(d[S],"");return}try{const C=await fetch("/api/erp/endpoints/"+encodeURIComponent(S)+"/customers",{headers:{Authorization:"Bearer "+a()}}),q=await C.json().catch(()=>({}));if(!C.ok||!q.ok){H.innerHTML=`<div class="erp-exc-m-empty">${escapeHtml(t("erp-exc-edit-pick-fail"))}</div>`;return}const L=q.customers||[];d[S]=L,g(L,"")}catch{H.innerHTML=`<div class="erp-exc-m-empty">${escapeHtml(t("erp-exc-edit-pick-fail"))}</div>`}};_&&_.addEventListener("input",()=>g(d[u.endpoint_id]||[],_.value)),k(),P&&P.addEventListener("click",async()=>{if(B){P.disabled=!0,P.textContent=t("erp-exc-retrying");try{if(!(await fetch("/api/erp/mappings/clients",{method:"POST",headers:{Authorization:"Bearer "+a(),"Content-Type":"application/json"},body:JSON.stringify({client_id:u.history_client_id,erp_type:u.endpoint_adapter,erp_code:B})})).ok){showToast(t("erp-exc-retry-fail"),"error"),P.disabled=!1,P.textContent=t("erp-exc-edit-bind-retry");return}showToast(t("erp-exc-edit-bound-ok"),"success"),f(),await r(u.id,null)}catch{showToast(t("erp-exc-retry-fail"),"error"),P.disabled=!1,P.textContent=t("erp-exc-edit-bind-retry")}}})}if(b){const B=document.getElementById("erp-exc-m-bind-prod"),P=document.getElementById("erp-exc-m-prodlist"),H={};let _=[];const g=()=>'<option value="">'+escapeHtml(t("erp-exc-edit-prod-choose"))+"</option>"+_.slice(0,500).map(C=>`<option value="${escapeHtml(C.code||"")}" data-pname="${escapeHtml(C.name||"")}">`+escapeHtml((C.name||"")+" · "+(C.code||""))+"</option>").join(""),k=C=>{if(!C.length){P.innerHTML=`<div class="erp-exc-m-empty">${escapeHtml(t("erp-exc-edit-prod-noitems"))}</div>`;return}P.innerHTML=C.map(q=>`<div class="erp-exc-m-cust" style="cursor:default">
                    ...
                    </div>`).join(""),P.querySelectorAll(".erp-exc-m-prod-sel").forEach(q=>{q.addEventListener("change",()=>{const L=q.dataset.item,D=q.options[q.selectedIndex];q.value?H[L]={code:q.value,name:D&&D.dataset.pname||""}:delete H[L],B&&(B.disabled=Object.keys(H).length===0)})})};(async()=>{try{const q=await(await fetch("/api/history/"+encodeURIComponent(u.history_id),{headers:{Authorization:"Bearer "+a()}})).json().catch(()=>({})),L=q&&q.pages||[],D=[],Y={};(Array.isArray(L)?L:[]).forEach(te=>{const re=te&&te.fields&&te.fields.items||[];(Array.isArray(re)?re:[]).forEach(A=>{const I=(A&&(A.name||A.description)||"").trim();I&&!Y[I]&&(Y[I]=1,D.push(I))})});const V=await fetch("/api/erp/endpoints/"+encodeURIComponent(u.endpoint_id)+"/products",{headers:{Authorization:"Bearer "+a()}}),W=await V.json().catch(()=>({}));if(!V.ok||!W.ok){P.innerHTML=`<div class="erp-exc-m-empty">${escapeHtml(t("erp-exc-edit-prod-fail"))}</div>`;return}_=W.products||[],k(D)}catch{P.innerHTML=`<div class="erp-exc-m-empty">${escapeHtml(t("erp-exc-edit-prod-fail"))}</div>`}})(),B&&B.addEventListener("click",async()=>{const C=Object.entries(H);if(C.length){B.disabled=!0,B.textContent=t("erp-exc-retrying");try{for(const[q,L]of C)if(!(await fetch("/api/erp/mappings/products",{method:"POST",headers:{Authorization:"Bearer "+a(),"Content-Type":"application/json"},body:JSON.stringify({erp_type:u.endpoint_adapter,item_name:q,erp_code:L.code,erp_name:L.name})})).ok){showToast(t("erp-exc-retry-fail"),"error"),B.disabled=!1,B.textContent=t("erp-exc-edit-bind-prod-retry");return}showToast(t("erp-exc-edit-prod-bound-ok"),"success"),f(),await r(u.id,null)}catch{showToast(t("erp-exc-retry-fail"),"error"),B.disabled=!1,B.textContent=t("erp-exc-edit-bind-prod-retry")}}})}},window._rerenderErpExceptions=i,window.loadErpExceptions=l,window._erpExcState=e})();(function(){function e(c){try{if(location.search.indexOf("test_center=1")>=0||localStorage.getItem("pearnly_test_mode")==="1"||c&&c.id&&String(c.id)==="468b50c1-5593-4fd6-990d-515ce8085563")return!0}catch{}return!1}window.applyRoleVisibility=function(){var u=window._userInfo,v=!1,b=!0,M=!1,E=!1;u&&(v=typeof canManageTeam=="function"?canManageTeam(u):!!(u.role==="owner"||u.is_super_admin),b=typeof shouldHideMoney=="function"?shouldHideMoney(u):u.role==="member"&&!u.is_super_admin,M=typeof isSuperAdmin=="function"?isSuperAdmin(u):!!u.is_super_admin,E=e(u)),document.querySelectorAll("[data-show-if-team]").forEach(function(h){h.style.display=v?"":"none"}),document.querySelectorAll("[data-show-if-money]").forEach(function(h){h.style.display=b?"none":""}),document.querySelectorAll("[data-show-if-admin]").forEach(function(h){h.style.display=M?"":"none"}),document.querySelectorAll("[data-show-if-test]").forEach(function(h){h.style.display=E?"":"none"});var m=M||E;document.querySelectorAll("[data-show-if-special]").forEach(function(h){h.style.display=m?"":"none"})},window.renderAvatarMenu=function(u){if(u){var v=document.getElementById("avatar-btn"),b=document.getElementById("avatar-popup-name"),M=document.getElementById("avatar-popup-email");if(!(!v||!b||!M)){var E=(u.username||"").trim(),m=E.split("@")[0]||E||"—",h=(E.charAt(0)||"?").toUpperCase(),T=(u.avatar_url||"").trim();if(T){var B=T.replace(/"/g,"&quot;"),P=h.replace(/'/g,"\\'");v.innerHTML='<img src="'+B+'" alt="'+h+`" referrerpolicy="no-referrer" onerror="this.parentNode.textContent='`+P+`'">`}else v.textContent=h;b.textContent=m,M.textContent=E||"—",v.setAttribute("title",E||"")}}};function n(){var c=document.getElementById("avatar-wrap"),u=document.getElementById("avatar-btn"),v=document.getElementById("avatar-popup");if(!c||!u||!v)return;function b(){v.classList.remove("show"),u.setAttribute("aria-expanded","false")}function M(){v.classList.add("show"),u.setAttribute("aria-expanded","true")}u.addEventListener("click",function(E){E.stopPropagation(),v.classList.contains("show")?b():M()}),document.addEventListener("click",function(E){v.classList.contains("show")&&!c.contains(E.target)&&b()}),v.addEventListener("click",function(E){var m=E.target.closest(".avatar-popup-item");if(m){var h=m.dataset.action;switch(b(),h){case"settings":typeof openSettingsModal=="function"?openSettingsModal():typeof routeTo=="function"&&routeTo("settings");break;case"team":typeof openSettingsModal=="function"?openSettingsModal():typeof routeTo=="function"&&routeTo("settings"),setTimeout(function(){typeof switchSettingsTab=="function"&&switchSettingsTab("team")},50);break;case"billing":typeof openSettingsModal=="function"?openSettingsModal():typeof routeTo=="function"&&routeTo("settings"),setTimeout(function(){typeof switchSettingsTab=="function"&&switchSettingsTab("plan")},50);break;case"shortcuts":if(typeof showToast=="function"){var T=typeof t=="function"?t("feature-coming-soon"):"即将上线";showToast(T||"即将上线","info")}break;case"admin":window.location.href="/admin/cost";break;case"test-center":typeof routeTo=="function"&&routeTo("test-center");break;case"help":var B=document.getElementById("help-modal");B&&(B.style.display="flex");break;case"logout":try{localStorage.removeItem("mrpilot_token")}catch{}try{localStorage.removeItem("mrpilot_user")}catch{}window.location.href="/";break}}}),window._closeAvatarPopup=b}function a(){return[].slice.call(document.querySelectorAll(".cmdk-item")).filter(function(c){return c.style.display!=="none"})}function o(c){var u=a();u.forEach(function(v){v.classList.remove("focus")}),u[c]&&(u[c].classList.add("focus"),u[c].scrollIntoView({block:"nearest"}))}function s(c){var u=a();if(u.length){var v=u.findIndex(function(M){return M.classList.contains("focus")});v<0&&(v=0);var b=(v+c+u.length)%u.length;o(b)}}function i(c){c=(c||"").toLowerCase().trim();var u=0,v=window._userInfo,b=typeof isSuperAdmin=="function"?isSuperAdmin(v):!!(v&&v.is_super_admin),M=e(v);document.querySelectorAll(".cmdk-item").forEach(function(m){if(m.dataset.showIfAdmin==="1"&&!b){m.style.display="none";return}if(m.dataset.showIfTest==="1"&&!M){m.style.display="none";return}var h=(m.dataset.cmdkText||m.textContent||"").toLowerCase(),T=!c||h.indexOf(c)>=0;m.style.display=T?"":"none",m.classList.remove("focus"),T&&u++}),document.querySelectorAll("[data-cmdk-section]").forEach(function(m){for(var h=m.nextElementSibling,T=!1;h&&!h.hasAttribute("data-cmdk-section");){if(h.classList&&h.classList.contains("cmdk-item")&&h.style.display!=="none"){T=!0;break}h=h.nextElementSibling}m.style.display=T?"":"none"});var E=document.getElementById("cmdk-empty");E&&(E.style.display=u===0?"flex":"none"),o(0)}window.openCmdk=function(){var u=document.getElementById("cmdk-mask");u&&(typeof window._closeAvatarPopup=="function"&&window._closeAvatarPopup(),u.classList.add("show"),typeof window.applyRoleVisibility=="function"&&window.applyRoleVisibility(),setTimeout(function(){var v=document.getElementById("cmdk-input");v&&(v.value="",i(""),v.focus(),o(0))},50))},window.closeCmdk=function(){var u=document.getElementById("cmdk-mask");u&&u.classList.remove("show")};function r(c){if(c){if(c.classList.contains("cmdk-item-locked")){if(typeof showToast=="function"){var u=typeof t=="function"?t("feature-coming-soon"):"即将上线";showToast(u||"即将上线","info")}return}var v=c.dataset.cmdkRoute,b=c.dataset.cmdkAction;if(window.closeCmdk(),v){typeof routeTo=="function"&&routeTo(v);return}if(b){if(b==="open-admin"){window.location.href="/admin/cost";return}if(b.indexOf("lang-")===0){var M=b.slice(5);typeof applyLang=="function"&&applyLang(M)}}}}function p(){var c=document.getElementById("cmdk-mask"),u=document.getElementById("cmdk-input"),v=document.getElementById("cmdk-body");if(!(!c||!u||!v)){c.addEventListener("click",function(E){E.target===c&&window.closeCmdk()});var b=document.getElementById("cmdk-esc-btn");b&&b.addEventListener("click",function(){window.closeCmdk()}),u.addEventListener("input",function(E){i(E.target.value)}),u.addEventListener("keydown",function(E){E.key==="ArrowDown"?(E.preventDefault(),s(1)):E.key==="ArrowUp"?(E.preventDefault(),s(-1)):E.key==="Enter"?(E.preventDefault(),r(c.querySelector(".cmdk-item.focus"))):E.key==="Escape"&&(E.preventDefault(),window.closeCmdk())}),v.addEventListener("click",function(E){var m=E.target.closest(".cmdk-item");m&&r(m)}),v.addEventListener("mousemove",function(E){var m=E.target.closest(".cmdk-item");!m||m.style.display==="none"||m.classList.contains("cmdk-item-locked")||(a().forEach(function(h){h.classList.remove("focus")}),m.classList.add("focus"))});var M=document.getElementById("topbar-search");M&&(M.addEventListener("click",function(){window.openCmdk()}),M.addEventListener("keydown",function(E){(E.key==="Enter"||E.key===" ")&&(E.preventDefault(),window.openCmdk())}))}}document.addEventListener("keydown",function(c){if((c.metaKey||c.ctrlKey)&&(c.key==="k"||c.key==="K")){c.preventDefault(),window.openCmdk();return}if(c.key==="Escape"){var u=document.getElementById("cmdk-mask");if(u&&u.classList.contains("show")){window.closeCmdk();return}var v=document.getElementById("avatar-popup");v&&v.classList.contains("show")&&typeof window._closeAvatarPopup=="function"&&window._closeAvatarPopup()}});try{var l=(navigator.userAgent||"").toLowerCase(),d=l.indexOf("mac")>=0||l.indexOf("iphone")>=0||l.indexOf("ipad")>=0;d||document.body.classList.add("is-windows")}catch{}function f(){n(),p(),typeof window.subscribeI18n=="function"&&window.subscribeI18n("nav-ia-phase1-role",function(){try{typeof window.applyRoleVisibility=="function"&&window.applyRoleVisibility()}catch{}})}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",f):f()})();(function(){function n(b){return String(b??"").replace(/[&<>"']/g,function(M){return{"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"}[M]})}function a(b){if(!b||isNaN(b))return"";var M=Number(b);return M<1024?M+" B":M<1024*1024?(M/1024).toFixed(1)+" KB":(M/1024/1024).toFixed(1)+" MB"}document.addEventListener("click",function(b){var M=b.target.closest&&b.target.closest(".recon-collapse-head");if(M&&!(b.target.closest("button")||b.target.closest("a"))){var E=M.closest(".recon-collapse");if(E){var m=E.getAttribute("data-collapsed")==="true";E.setAttribute("data-collapsed",m?"false":"true"),m&&(E.id==="vex-summary-collapse"&&f(),E.id==="vex-detail-collapse"&&c())}}}),document.addEventListener("keydown",function(b){if(!(b.key!=="Enter"&&b.key!==" ")){var M=b.target.closest&&b.target.closest(".recon-collapse-head");M&&(b.preventDefault(),M.click())}});var o={vat:"",gl:""};window._glvClearPreviewSearch=function(){o.vat="",o.gl=""};var s='<svg class="vex-pp-fi-icon" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#111111" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/></svg>',i='<svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg>';function r(){l("vat"),l("gl")}function p(b){try{if(typeof window._glvPreviewFiles=="function")return window._glvPreviewFiles(b)||[]}catch{}var M=document.getElementById(b==="vat"?"glv-vat-input":"glv-gl-input");return M&&M.files?Array.from(M.files):[]}function l(b){var M=document.getElementById(b==="vat"?"glv-pp-vat-col":"glv-pp-gl-col");if(M){var E=p(b),m=b==="vat"?"glv-up-vat-title":"glv-up-gl-title",h=b==="vat"?"① 销项税报告":"② 总账 GL",T=window.t&&window.t(m)||h,B=n(window.t&&window.t("vex-preview-search")||"搜索文件名..."),P=n(window.t&&window.t("vex-preview-clear-all")||"全清"),H=o[b]||"",_=E.length;M.innerHTML='<div class="vex-pp-col-title"><span class="vex-pp-col-name">'+n(T)+' <span class="vex-pp-col-count">'+_+'</span></span></div><div class="vex-pp-search-row"><input class="vex-pp-search" id="glv-pp-search-'+b+'" type="text" placeholder="'+B+'" value="'+n(H)+'" autocomplete="off"><button class="vex-pp-clear-btn" id="glv-pp-clearall-'+b+'" type="button">'+P+'</button></div><div class="vex-pp-file-list" id="glv-pp-'+b+'-list"></div><div class="vex-pp-pagination" id="glv-pp-'+b+'-pg"></div>';var g=document.getElementById("glv-pp-search-"+b);g&&g.addEventListener("input",function(S){o[b]=S.target.value,d(b)});var k=document.getElementById("glv-pp-clearall-"+b);k&&k.addEventListener("click",function(){window._glvRemoveFile&&window._glvRemoveFile(b)}),d(b)}}function d(b){var M=document.getElementById("glv-pp-"+b+"-list"),E=document.getElementById("glv-pp-"+b+"-pg");if(M){var m=p(b),h=(o[b]||"").toLowerCase(),T=m.map(function(H,_){return{f:H,i:_}}),B=h?T.filter(function(H){return H.f.name.toLowerCase().indexOf(h)>=0}):T;if(M.innerHTML=B.map(function(H){var _=H.f;return'<div class="vex-pp-file-row">'+s+'<span class="vex-pp-fi-name" title="'+n(_.name)+'">'+n(_.name)+'</span><span class="vex-pp-fi-size">'+a(_.size)+'</span><button class="vex-pp-fi-del" type="button" data-kind="'+b+'" data-idx="'+H.i+'" aria-label="remove">'+i+"</button></div>"}).join(""),M.querySelectorAll(".vex-pp-fi-del").forEach(function(H){H.addEventListener("click",function(){var _=H.dataset.kind,g=parseInt(H.dataset.idx,10);window._glvRemoveFile&&window._glvRemoveFile(_,isNaN(g)?null:g)})}),E){var P=window.t&&window.t("vex-preview-count")||"显示前 {n} / 共 {m}";E.textContent=P.replace("{n}",B.length).replace("{m}",B.length)}}}function f(){var b=function(E,m){var h=document.getElementById(E);h&&(h.textContent=m==null?"—":String(m))},M=window._vexLastTask||{};b("vex-sum-total",M.total),b("vex-sum-matched",M.matched),b("vex-sum-diff",M.diff),b("vex-sum-incomplete",M.incomplete),b("vex-sum-cash",M.cash),document.getElementById("vex-summary-sub")}function c(){var b=window._vexLastTask&&window._vexLastTask.diff_rows||[],M=document.getElementById("vex-detail-tbody"),E=document.getElementById("vex-detail-table"),m=document.getElementById("vex-detail-empty");if(!(!M||!E||!m)){if(b.length===0){E.style.display="none",m.style.display="";return}m.style.display="none",E.style.display="";var h=b.map(function(B){return'<tr><td class="recon-detail-cell-mono">'+n(B.invoice_no||"")+"</td><td>"+n(B.field||"")+"</td><td>"+n(B.report_value||"")+"</td><td>"+n(B.invoice_value||"")+"</td><td>"+n(B.kind||"")+"</td></tr>"}).join("");M.innerHTML=h;var T=document.getElementById("vex-detail-sub");T&&(T.textContent=String(b.length))}}function u(){var b=document.getElementById("glv-toggle-preview");b&&!b._reconBound&&(b._reconBound=!0,b.addEventListener("click",function(){var M=document.getElementById("glv-preview-panel"),E=document.getElementById("glv-toggle-preview-label"),m=M&&M.style.display!=="none";M&&(M.style.display=m?"none":""),b.classList.toggle("open",!m),E&&(E.textContent=m?window.t&&window.t("vex-toggle-preview-open")||"查看清单":window.t&&window.t("vex-toggle-preview-close")||"收起清单"),m||r()})),["glv-vat-input","glv-gl-input"].forEach(function(M){var E=document.getElementById(M);!E||E._reconWatched||(E._reconWatched=!0,E.addEventListener("change",function(){var m=document.getElementById("glv-preview-panel");m&&m.style.display!=="none"&&r()}))})}function v(){var b=document.getElementById("vex-summary-collapse"),M=document.getElementById("vex-detail-collapse");b&&(b.style.display=""),M&&(M.style.display=""),f(),c()}window._fillVexSummary=f,window._fillVexDetail=c,window._onVexResultShown=v,document.addEventListener("DOMContentLoaded",function(){u()}),setTimeout(u,1500),typeof window.subscribeI18n=="function"&&window.subscribeI18n("recon-collapse",function(){var b=document.getElementById("glv-preview-panel");b&&b.style.display!=="none"&&r();var M=document.getElementById("glv-toggle-preview-label"),E=document.getElementById("glv-toggle-preview");M&&E&&(M.textContent=E.classList.contains("open")?window.t&&window.t("vex-toggle-preview-close")||"收起清单":window.t&&window.t("vex-toggle-preview-open")||"查看清单")}),window._reconCollapse={renderGlvPreview:r,fillVexSummary:f,fillVexDetail:c}})();(function(){function e(i){}function n(){const i=document.querySelectorAll("[data-recon-tab]");i.forEach(p=>{p.addEventListener("click",()=>{i.forEach(u=>u.classList.remove("active")),p.classList.add("active");const l=p.dataset.reconTab,d=document.getElementById("recon-pane-bank"),f=document.getElementById("recon-pane-sale-vat"),c=document.getElementById("recon-pane-gl-vat");d&&(d.style.display=l==="bank"?"":"none"),f&&(f.style.display=l==="sale-vat"?"":"none"),c&&(c.style.display=l==="gl-vat"?"":"none"),l==="gl-vat"&&window.GlVatRecon&&window.GlVatRecon.ensureInit(),l==="bank"&&typeof window._bankReconV2Init=="function"&&window._bankReconV2Init()})});const r=document.querySelector("[data-recon-tab].active");r&&(r.dataset.reconTab,void 0)}function a(){const i=document.getElementById("page-settings");if(!i)return null;let r=document.getElementById("settings-modal-overlay");if(r)return r;r=document.createElement("div"),r.id="settings-modal-overlay",r.className="settings-modal-overlay",r.style.display="none",i.parentElement.insertBefore(r,i),r.appendChild(i);const p=document.createElement("button");return p.id="settings-modal-close",p.className="settings-modal-close",p.setAttribute("aria-label","close"),p.innerHTML='<svg viewBox="0 0 20 20" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M5 5l10 10M15 5L5 15"/></svg>',i.insertBefore(p,i.firstChild),p.addEventListener("click",s),r.addEventListener("click",l=>{l.target===r&&s()}),r}function o(){const i=a();if(!i)return;i.style.display="flex",document.body.classList.add("settings-modal-open");const r=document.getElementById("page-settings");r&&(r.style.display="block"),setTimeout(()=>{try{typeof renderSettings=="function"&&renderSettings()}catch(l){console.warn("renderSettings:",l)}let p=document.querySelector(".settings-tab.active")||document.querySelector('.settings-tab[data-tab="profile"]');p&&p.click()},50)}function s(){const i=document.getElementById("settings-modal-overlay");i&&(i.style.display="none"),document.body.classList.remove("settings-modal-open")}window.openSettingsModal=o,window.closeSettingsModal=s,document.addEventListener("keydown",i=>{if(i.key==="Escape"){const r=document.getElementById("settings-modal-overlay");r&&r.style.display==="flex"&&s()}}),window.addEventListener("hashchange",()=>{location.hash==="#/settings"&&o()}),window.addEventListener("DOMContentLoaded",()=>{location.hash==="#/settings"&&o()}),document.readyState==="loading"?document.addEventListener("DOMContentLoaded",n):n()})();(function(){const a=/\.(pdf|jpe?g|png|webp|tiff?|xlsx?|xlsm|csv|tsv|docx?)$/i,o=U=>document.getElementById(U);function s(){return{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||"")}}function i(U){return String(U??"").replace(/[&<>"']/g,Q=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[Q])}function r(U){return U<1024?U+" B":U<1024*1024?(U/1024).toFixed(1)+" KB":(U/1024/1024).toFixed(1)+" MB"}let p=[],l=[],d=!1,f=[],c=50,u=50,v="",b="";async function M(){try{const U=await fetch("/api/vat_excel/tasks?page=1&page_size=1",{headers:s()});if(!U.ok)return;const ee=(await U.json()).kpi||{};[["vex-kpi-month-val",ee.this_month],["vex-kpi-running-val",ee.running],["vex-kpi-done-val",ee.done],["vex-kpi-failed-val",ee.failed]].forEach(([ne,oe])=>{const ue=document.getElementById(ne);ue&&(ue.textContent=oe??0)})}catch{}}async function E(){try{const U=await fetch("/api/vat_excel/tasks?page=1&page_size=100",{headers:s()});if(!U.ok)return;const Q=await U.json();B(Q.rows||[])}catch{}}const m=10;var h=1;function T(){var U=((document.getElementById("vex-task-search")||{}).value||"").trim().toLowerCase();if(h=1,B(f),!!U){var Q=document.getElementById("vex-task-tbody");Q&&Q.querySelectorAll("tr").forEach(function(ee){ee.dataset.taskId&&(ee.style.display=ee.textContent.toLowerCase().indexOf(U)>=0?"":"none")})}}function B(U){f=U||f;const Q=document.getElementById("vex-task-tbody");if(!Q)return;if(!f.length){Q.innerHTML='<tr><td colspan="9" class="vex-task-empty">'+(t("sv-empty-title")||"还没有对账任务")+"</td></tr>",P(0);return}const ee=Math.ceil(f.length/m);h>ee&&(h=ee);const ne=(h-1)*m;H(f.slice(ne,ne+m)),P(f.length)}function P(U){const Q=document.getElementById("vex-task-pager"),ee=document.getElementById("vex-task-pager-info"),ne=document.getElementById("vex-task-prev"),oe=document.getElementById("vex-task-next");if(!Q)return;if(U<=m){Q.style.display="none";return}Q.style.display="";const ue=Math.ceil(U/m);ee&&(ee.textContent=h+" / "+ue),ne&&(ne.disabled=h<=1),oe&&(oe.disabled=h>=ue)}function H(U){const Q=document.getElementById("vex-task-tbody");if(!Q)return;const ee={pending:t("vex-status-pending")||"待处理",running:t("vex-status-running")||"处理中",done:t("vex-status-done")||"已完成",failed:t("vex-status-failed")||"失败"},ne={pending:"badge-gray",running:"badge-blue",done:"badge-green",failed:"badge-red"},oe='<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M8 2v9M4 7l4 4 4-4M3 14h10"/></svg>',ue='<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M3 4h10M6 4V3h4v1M5 4v8a1 1 0 001 1h4a1 1 0 001-1V4"/></svg>';Q.innerHTML=U.map(x=>{const $=x.created_at?new Date(x.created_at).toLocaleString([],{year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",minute:"2-digit"}):"—",j=x.period||"—",G=x.matched_count!=null?x.matched_count+" ✓ · "+x.mismatched_count+" ⚠":"—",F=x.mismatch_amount!=null?"฿ "+Number(x.mismatch_amount).toLocaleString():"—",y=x.elapsed_seconds!=null?x.elapsed_seconds.toFixed(1)+" s":"—",z=x.status||"pending",O=x.client_name&&x.client_name!=="client"?x.client_name:t("vex-client-all")||"全部客户";return`<tr class="vex-task-row" data-task-id="${i(x.id)}" style="cursor:pointer">
                <td>${$}</td>
                <td>${i(O)}</td>
                <td>${i(j)}</td>
                ...
                <td>${G}</td>
                <td>${F}</td>
                <td><span class="badge ${ne[z]||"badge-gray"}">${ee[z]||z}</span></td>
                <td>${y}</td>
            ...
            </table>`,$.style.display=""}async function w(x){const $=localStorage.getItem("mrpilot_token")||"",j=window._currentLang||"zh";try{const G=await fetch("/api/recon/bank-v2/"+x+"/export?lang="+j,{headers:{Authorization:"Bearer "+$}});if(!G.ok){const de=await G.json().catch(()=>({}));window.showToast&&window.showToast(de.detail||"Export failed","error");return}const F=await G.blob(),z=(G.headers.get("content-disposition")||"").match(/filename[^;=\n]*=((['"]).*?\2|[^;\n]*)/),O=z?z[1].replace(/['"]/g,""):"reconciliation.xlsx",J=URL.createObjectURL(F),X=document.createElement("a");X.href=J,X.download=O,document.body.appendChild(X),X.click(),document.body.removeChild(X),URL.revokeObjectURL(J)}catch(G){window.showToast&&window.showToast("Export error: "+G.message,"error")}}function R(x,$){const j=l("brv2-summary-collapse");let G=l("brv2-warnings");const F=window._currentLang||"zh",y={zh:"⏭ 已跳过无法识别的文件:",th:"⏭ ข้ามไฟล์ที่อ่านไม่ได้:",en:"⏭ Skipped unreadable file:",ja:"⏭ 読み取れないファイルをスキップ:"}[F]||"⏭ ",z=[];if(($||[]).forEach(O=>z.push(y+" "+O)),(x||[]).forEach(O=>z.push(O)),!z.length){G&&(G.style.display="none");return}if(!G)if(G=document.createElement("div"),G.id="brv2-warnings",j&&j.parentNode)j.parentNode.insertBefore(G,j);else return;G.style.cssText="display:block;margin:10px 0;padding:10px 14px;background:#FEF3C7;border:1px solid #FCD34D;border-radius:8px;color:#92400E;font-size:13px;line-height:1.6",G.innerHTML=z.map(O=>"<div>"+c(O)+"</div>").join("")}function N(x){I(x),R(x.warnings||[],x.skipped_files||[]),!x.ok&&x.error&&window.showToast&&window.showToast(x.error,"error");const $=x.stats||{},j=x.summary||{},G=$.matched||0,F=($.gl_debit_only||0)+($.gl_credit_only||0),y=($.stmt_withdrawal_only||0)+($.stmt_deposit_only||0),z=Number(j.formula_diff||0),O=Math.abs(z)<.05;l("brv2-kpi-matched")&&(l("brv2-kpi-matched").textContent=G),l("brv2-kpi-diff")&&(l("brv2-kpi-diff").textContent=d(z)),l("brv2-kpi-unmatched")&&(l("brv2-kpi-unmatched").textContent=F+y);const J=l("brv2-kpi-diff-icon");J&&(J.style.background=O?"#d1fae5":"#fee2e2",J.style.color=O?"#065f46":"#b91c1c");const X=l("brv2-formula-sub");if(X){const pe=window._currentLang||"zh";X.textContent=O?{zh:"✓ 平衡",th:"✓ สมดุล",en:"✓ Balanced",ja:"✓ 一致"}[pe]||"✓ 平衡":({zh:"差 ",th:"ต่าง ",en:"Diff ",ja:"差 "}[pe]||"差 ")+d(z)}const de=l("brv2-detail-sub");if(de){const pe=window._currentLang||"zh",fe={zh:"共 {n} 行",th:"ทั้งหมด {n} แถว",en:"{n} rows",ja:"計 {n} 行"}[pe]||"共 {n} 行";de.textContent=fe.replace("{n}",i.length)}function se(pe,fe,me){const ge=l(pe);ge&&(ge.textContent=(me&&fe>0?"(":"")+d(me?-fe:fe)+(me&&fe>0?")":""))}se("brf-gl-close",j.gl_closing||0),se("brf-open-diff",j.opening_diff||0),se("brf-gl-debit-only",j.gl_debit_only_amount||0,!0),se("brf-gl-credit-only",j.gl_credit_only_amount||0),se("brf-stmt-wd-only",j.stmt_withdrawal_only_amount||0,!0),se("brf-stmt-dep-only",j.stmt_deposit_only_amount||0),se("brf-calc-close",j.formula_stmt_closing||0),se("brf-stmt-close",j.stmt_closing||0),l("brf-diff")&&(l("brf-diff").textContent=d(z));const ce=l("brv2-fcell-diff");ce&&ce.classList.toggle("brv2-fcell-diff-ok",O);const ae=l("brv2-export-btn");ae&&(ae.onclick=()=>{o&&w(o.task_id)}),q(j),A(!0),K()}function K(){const x=l("brv2-tbody");if(!x)return;const $=i.filter(y=>s==="all"?!0:s==="matched"?y.match_status==="matched":s==="gl_only"?y.match_status.startsWith("gl_"):s==="stmt_only"?y.match_status.startsWith("stmt_"):!0);if($.length===0){const y={zh:"无记录",th:"ไม่มีรายการ",en:"No rows",ja:"行なし"}[window._currentLang||"zh"]||"无记录";x.innerHTML=`<tr><td colspan="10" style="text-align:center;padding:20px;color:var(--ink-3)">${y}</td></tr>`;return}const j=window._currentLang||"zh",G={zh:"OCR 余额验证未通过 · 上一行余额 ± 金额 ≠ 本行余额，请核对原 PDF",th:"การตรวจสอบยอดคงเหลือไม่ผ่าน · ยอดก่อนหน้า ± จำนวน ≠ ยอดบรรทัดนี้ โปรดตรวจสอบ PDF ต้นฉบับ",en:"Balance check FAILED · prev_balance ± amount ≠ this row balance — verify against the original PDF",ja:"残高検証エラー · 前残高 ± 金額 ≠ この行残高 — 元のPDFと照合してください"}[j],F={zh:"OCR 低置信度 · 数字模糊或难以辨认，请核对原 PDF",th:"OCR ความมั่นใจต่ำ · ตัวเลขเบลอหรืออ่านยาก โปรดตรวจสอบ PDF ต้นฉบับ",en:"OCR low confidence · digit was blurry or hard to read — verify against the original PDF",ja:"OCR信頼度低 · 数字がぼやけている — 元のPDFと照合してください"}[j];x.innerHTML=$.map(y=>{const z=y.match_status,O=y.match_layer;let J="",X="";z==="matched"?(O===1&&(J="matched",X='<span class="brv2-status-badge brv2-badge-matched">L1 ✓</span>'),O===2&&(J="matched-l2",X='<span class="brv2-status-badge brv2-badge-matched-l2">L2 ~</span>'),O===3&&(J="matched-l3",X='<span class="brv2-status-badge brv2-badge-matched-l3">L3 ?</span>')):z==="gl_debit_only"||z==="gl_credit_only"?(J="gl-only",X='<span class="brv2-status-badge brv2-badge-gl-only">GL</span>'):(J="stmt-only",X=`<span class="brv2-status-badge brv2-badge-stmt-only">${{zh:"账单",th:"บัญชี",en:"Stmt",ja:"明細"}[j]||"账单"}</span>`);let de="";return y.stmt_balance_ok===!1&&(de+=`<span class="brv2-ocr-warn brv2-ocr-warn-bal" title="${c(G)}">⚠</span>`,J+=" brv2-row-warn"),y.stmt_confidence==="low"&&(de+=`<span class="brv2-ocr-warn brv2-ocr-warn-conf" title="${c(F)}">◌</span>`,J.includes("brv2-row-warn")||(J+=" brv2-row-warn-soft")),`<tr class="${J.trim()}">
              <td>${X}${de}</td>
