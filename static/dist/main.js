...
`,ln=`                    <!-- Tab: 邮箱抓取 (v0.17 · M6 · v93 在 Vultr 复活) -->
...
`;(function(){const e=document.getElementById("page-automation");if(!(!e||e.dataset.wbInjected==="1")){e.innerHTML=rn+ln,e.dataset.wbInjected="1";try{const n=window._currentLang||localStorage.getItem("mrpilot_lang")||"th",a=window.I18N;a&&a[n]&&(e.querySelectorAll("[data-i18n]").forEach(o=>{const s=o.getAttribute("data-i18n");a[n][s]&&(o.textContent=a[n][s])}),e.querySelectorAll("[data-i18n-placeholder]").forEach(o=>{const s=o.getAttribute("data-i18n-placeholder");a[n][s]&&(o.placeholder=a[n][s])}))}catch{}}})();(function(){const e={"page-integration":`
        <div class="coming-soon">
            <svg class="cs-icon" viewBox="0 0 48 48" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
...
`,e.dataset.wbInjected="1";try{const n=window._currentLang||localStorage.getItem("mrpilot_lang")||"th",a=window.I18N;a&&a[n]&&e.querySelectorAll("[data-i18n]").forEach(o=>{const s=o.getAttribute("data-i18n");a[n][s]&&(o.textContent=a[n][s])})}catch{}}})();function cn(e,n){const a=document.getElementById("alert-"+e);a&&(document.getElementById("alert-"+e+"-text").textContent=n,a.classList.add("show"))}function dn(){["info","warn","error"].forEach(e=>{document.getElementById("alert-"+e).classList.remove("show")})}function pn(e,n){if(e==null)return n||"操作失败";if(typeof e=="string")return e;if(Array.isArray(e)){const a=e[0]||{};return a.msg?a.msg:n||"请求格式错误"}if(typeof e=="object"){if(e.code){const a="err."+e.code;try{const o=t(a,e);if(o&&o!==a)return o}catch(o){console.warn("[i18n] t() failed for key:",a,o)}return e.code}if(e.message)return e.message;if(e.error)return e.error;if(e.detail&&typeof e.detail=="string")return e.detail;try{return JSON.stringify(e).slice(0,160)}catch{}}return n||String(e)}function un(e){if(!e)return"";const n=String(e);return/ECONNREFUSED|Connection refused/i.test(n)?"连接被拒绝 · ERP 地址可能错了,或服务没启动":/listing fetch failed|wait_for_selector/i.test(n)?"拉取 MR.ERP 客户/商品列表超时 · 已重试 3 次仍不通 · 可能 MR.ERP 响应慢 · 稍后再试":/ETIMEDOUT|timeout/i.test(n)?"连接超时 · MR.ERP 响应慢 · 稍后再试":/ENOTFOUND|getaddrinfo/i.test(n)?"域名解析失败 · ERP 地址拼错了":/certificate|SSL/i.test(n)?"SSL 证书问题 · ERP 站点证书异常":/401|Unauthorized/i.test(n)?"HTTP 401 · 认证失败,检查 Token 是否正确":/403|Forbidden/i.test(n)?"HTTP 403 · 权限不足,ERP 拒绝访问":/404|Not Found/i.test(n)?"HTTP 404 · URL 路径不存在":/^5\d\d/.test(n)||/500|502|503|504/.test(n)?"ERP 服务器错误 · 不是你的问题,等会儿再试":n}function fn(e,n,a){let o=document.getElementById("mp-toast-wrap");o||(o=document.createElement("div"),o.id="mp-toast-wrap",document.body.appendChild(o)),n=n||"success",n==="ok"&&(n="success"),n==="warning"&&(n="warn"),n==="danger"&&(n="error");const s={success:'<path d="M3 8l3 3 7-7"/>',error:'<circle cx="8" cy="8" r="6"/><path d="M5.5 5.5l5 5M10.5 5.5l-5 5"/>',warn:'<path d="M8 2L1.5 13h13L8 2z"/><path d="M8 7v3M8 12v.01"/>',info:'<circle cx="8" cy="8" r="6"/><path d="M8 5.5v.01M8 8v3"/>',loading:'<path d="M8 1a7 7 0 017 7" stroke-linecap="round" class="mp-toast-spin"/>'},p=document.createElement("div");p.className="mp-toast "+n,p.innerHTML=`
    ...
    `,o.appendChild(p),requestAnimationFrame(()=>p.classList.add("show"));const r=typeof a=="number"?a:2500;let f=null;const i=()=>{f&&(clearTimeout(f),f=null),p.classList.remove("show"),setTimeout(()=>{try{p.remove()}catch{}},300)};return r>0&&(f=setTimeout(i,r)),i}window.showAlert=cn;window.hideAlerts=dn;window._humanizeBackendError=pn;window.humanizeError=un;window.showToast=fn;function mn(e){if(e){try{if(typeof shouldHideMoney=="function"&&shouldHideMoney(_userInfo)&&["team","api","plan","company"].indexOf(e)>=0){e="profile";try{localStorage.setItem("mrpilot_settings_tab","profile")}catch{}}}catch{}document.querySelectorAll(".settings-tab").forEach(n=>{n.classList.toggle("active",n.dataset.tab===e)}),document.querySelectorAll(".settings-pane").forEach(n=>{n.classList.toggle("active",n.dataset.pane===e)});try{localStorage.setItem("mrpilot_settings_tab",e)}catch{}try{e==="about"&&typeof window.loadAboutPanel=="function"&&window.loadAboutPanel(),e==="notifications"&&typeof window.loadPrefsSettings=="function"&&window.loadPrefsSettings(),e==="team"&&loadTeamList(),e==="learned"&&typeof window.loadLearnedRules=="function"&&window.loadLearnedRules(),e==="plan"&&typeof it=="function"&&it()}catch(n){console.warn("settings tab side effect failed:",n)}}}function vn(e){if(!e)return;const n=(a,o)=>{const s=document.getElementById(a);s&&(s.value=o||"")};n("profile-username",e.username||""),n("profile-email",e.username||""),n("profile-fullname",e.full_name||""),n("profile-phone",e.phone||""),n("profile-country",e.country||"TH"),n("profile-line",e.line_id||""),n("company-name",e.company_name||""),n("company-volume",e.monthly_volume||""),n("company-role",e.user_role||e.role_self||"")}async function hn(){const e=document.getElementById("btn-save-profile"),n=document.getElementById("profile-save-msg");if(!e)return;const a=e.innerHTML;e.disabled=!0,e.innerHTML=`<span>${t("msg-saving")||"保存中..."}</span>`,n&&(n.textContent="",n.classList.remove("error"));try{const o={full_name:(document.getElementById("profile-fullname")||{}).value||"",phone:(document.getElementById("profile-phone")||{}).value||"",country:(document.getElementById("profile-country")||{}).value||"TH",line_id:(document.getElementById("profile-line")||{}).value||""},s=await apiPut("/api/me/profile",o);if(s&&s.ok){n&&(n.textContent=t("msg-saved")||"已保存");try{const p=await apiGet("/api/me");_userInfo=p;try{window._userInfo=p}catch{}renderBrandWorkspace()}catch{}}else throw new Error("save failed")}catch{n&&(n.textContent=t("msg-save-failed")||"保存失败",n.classList.add("error"))}finally{e.disabled=!1,e.innerHTML=a,setTimeout(()=>{n&&(n.textContent="")},3e3)}}async function gn(){const e=document.getElementById("btn-save-company"),n=document.getElementById("company-save-msg");if(!e)return;const a=e.innerHTML;e.disabled=!0,e.innerHTML=`<span>${t("msg-saving")||"保存中..."}</span>`,n&&(n.textContent="",n.classList.remove("error"));try{const o={company_name:(document.getElementById("company-name")||{}).value||"",monthly_volume:(document.getElementById("company-volume")||{}).value||"",role:(document.getElementById("company-role")||{}).value||""},s=await apiPut("/api/me/profile",o);if(s&&s.ok){n&&(n.textContent=t("msg-saved")||"已保存");try{const p=await apiGet("/api/me");_userInfo=p;try{window._userInfo=p}catch{}renderBrandWorkspace()}catch{}}else throw new Error("save failed")}catch{n&&(n.textContent=t("msg-save-failed")||"保存失败",n.classList.add("error"))}finally{e.disabled=!1,e.innerHTML=a,setTimeout(()=>{n&&(n.textContent="")},3e3)}}function it(){if(!_userInfo)return;typeof window.loadAboutPanel=="function"&&window.loadAboutPanel(),typeof window.loadPrefsSettings=="function"&&window.loadPrefsSettings();const e=document.getElementById("settings-info");if(!e)return;const n=_userInfo;if(n.is_super_admin){e.innerHTML=`
        ...
        `;const o=document.getElementById("api-key-card");o&&(o.style.display="");return}bn(n,e);const a=document.getElementById("api-key-card");if(a){const o=tt==="byo_api"||_userInfo&&_userInfo.is_super_admin;a.style.display=o?"":"none"}}function bn(e,n){const a=escapeHtml(e.username||e.email||"");n.innerHTML=`
        <table style="width:100%; font-size:13px; border-collapse: collapse;">
            <tr>
    ...
    `}window.switchSettingsTab=mn;window.fillSettingsForms=vn;window.saveProfile=hn;window.saveCompany=gn;window.renderSettings=it;function Je(e){return e=e||_userInfo,!!(e&&e.is_super_admin)}function dt(e){return e=e||_userInfo,!!e&&(e.role==="owner"||Je(e))}function It(e){return e=e||_userInfo,!!e&&e.role==="member"&&!Je(e)}function yn(e){return e=e||_userInfo,!!e&&(e.effective_plan==="trial"||e.plan==="trial")&&!Je(e)}function Lt(e){return e=e||_userInfo,!!e&&e.tenant_type==="byo_api"}function Ct(e){return It(e)}function wn(e){return dt(e)}function kn(e){return dt(e)&&Lt(e)}window.isMoneyHidden=Ct;window.isSuperAdmin=Je;window.isOwner=dt;window.isEmployee=It;window.isTrial=yn;window.isLifetime=Lt;window.shouldHideMoney=Ct;window.canManageTeam=wn;window.canManageApiKey=kn;function _n(){const e=document.getElementById("quota-banner");if(!e)return;if(!_userInfo){e.style.display="none";return}if(_userInfo.is_super_admin||_userInfo.tenant_type==="admin"||_userInfo.tenant_type==="byo_api"){e.style.display="none";return}let n=0,a=0;if(_userInfo.plan==="free"&&_quota&&_quota.ip_daily_limit)n=_quota.ip_used_today||0,a=_quota.ip_daily_limit;else if(_userInfo.tenant_quota!=null&&_userInfo.tenant_quota>0)n=_userInfo.tenant_used||0,a=_userInfo.tenant_quota;else if(_userInfo.monthly_quota&&_userInfo.monthly_quota>0)n=_userInfo.used_this_month||0,a=_userInfo.monthly_quota;else{e.style.display="none";return}if(a<=0){e.style.display="none";return}const o=Math.max(0,a-n),s=n/a*100,p="quota_banner_dismiss_"+new Date().toISOString().slice(0,10);if(localStorage.getItem(p)){e.style.display="none";return}let r,f;if(o===0)r="danger",f=t("quota-banner-exhausted");else if(s>=90)r="danger",f=t("quota-banner-very-low",{n:o});else if(s>=70)r="warn",f=t("quota-banner-low",{n:o});else{e.style.display="none";return}e.className="quota-banner "+r,e.innerHTML=`
    ...
    `,e.style.display="flex";const i=e.querySelector(".quota-banner-close");i&&i.addEventListener("click",()=>{localStorage.setItem(p,"1"),e.style.display="none"})}function xn(){const e=_userInfo;if(!e)return;const n=shouldHideMoney(e),a=canManageTeam(e),o=canManageApiKey(e),s=document.querySelector('.nav-item[data-route="templates"]');s&&(s.classList.remove("locked-for-plan"),s.removeAttribute("data-locked-target"));const p=document.querySelector('.nav-item[data-route="api-keys"]');p&&(p.classList.remove("locked-for-plan"),p.removeAttribute("data-locked-target"));const r=document.getElementById("btn-custom-template");r&&(r.style.display="",r.classList.remove("locked-for-plan"));const f=document.querySelector('.settings-tab[data-tab="team"]');f&&(f.style.display=a?"":"none");const i=document.querySelector('.settings-panel[data-settings-panel="team"]');i&&(i.dataset.permHidden=a?"0":"1");const c=document.querySelector('.settings-tab[data-tab="api"]');c&&(c.style.display=o||isSuperAdmin(e)?"":"none");const l=document.querySelector('.settings-tab[data-tab="plan"]');l&&(l.style.display=n?"none":"");const d=document.querySelector('.settings-tab[data-tab="company"]');d&&(d.style.display=n?"none":"");const u=document.getElementById("info-bar");u&&(u.style.display=n?"none":"");const g=document.getElementById("trial-banner");g&&n&&(g.style.display="none");const k=document.getElementById("plan-banner");k&&n&&(k.style.display="none",document.body.classList.remove("has-plan-banner")),document.querySelectorAll("[data-upgrade-cta], .btn-upgrade, .topbar-upgrade").forEach(M=>{M.style.display="none"}),document.body.classList.toggle("role-employee",isEmployee(e)),document.body.classList.toggle("role-owner",isOwner(e)),document.body.classList.toggle("role-super",isSuperAdmin(e));try{const M=document.querySelector(".settings-tab.active");M&&M.style.display==="none"&&(typeof window.switchSettingsTab=="function"?window.switchSettingsTab("profile"):typeof switchSettingsTab=="function"&&switchSettingsTab("profile"))}catch(M){console.warn("[v118.12.3] failed to fix active tab:",M)}if(window.PEARNLY_ADMIN_MODE){const M=document.getElementById("admin-mode-banner");M&&(M.style.display="flex"),document.querySelectorAll(".nav-item").forEach(E=>{E.classList.contains("nav-admin-only")||(E.style.display="none")}),document.querySelectorAll(".nav-group").forEach(E=>{E.classList.contains("nav-group-admin-only")||(E.style.display="none")});const B=document.getElementById("client-switcher");B&&(B.style.display="none"),document.body.classList.add("admin-mode");const _=["profile","security","notifications","about"];document.querySelectorAll(".settings-tab").forEach(E=>{const q=E.dataset.tab;q&&!_.includes(q)&&(E.style.display="none")}),document.querySelectorAll(".settings-pane").forEach(E=>{const q=E.dataset.pane;q&&!_.includes(q)&&(E.style.display="none")}),document.querySelectorAll(".settings-nav-group").forEach(E=>{const q=E.querySelectorAll(".settings-tab");Array.from(q).some(F=>F.style.display!=="none")||(E.style.display="none")})}}function En(){const e=_userInfo,n=document.getElementById("info-bar");if(!e||shouldHideMoney(e)){n&&(n.innerHTML="");return}let a="";const o=e.tenant_type;if(o==="byo_api")e.has_own_gemini_key?a=`
                <div class="info-chip">
    ...
    `;let s=_results.map((r,f)=>({...r,_idx:f}));if(_searchKeyword){const r=_searchKeyword.toLowerCase();s=s.filter(f=>(f.filename||"").toLowerCase().includes(r)||(f.merged_fields.invoice_number||"").toLowerCase().includes(r))}_sortKey&&s.sort((r,f)=>{let i,c;return _sortKey==="filename"?(i=r.filename,c=f.filename):_sortKey==="invoice_no"?(i=r.merged_fields.invoice_number,c=f.merged_fields.invoice_number):_sortKey==="invoice_date"?(i=r.merged_fields.date,c=f.merged_fields.date):_sortKey==="total"?(i=parseFloat(r.merged_fields.total_amount)||0,c=parseFloat(f.merged_fields.total_amount)||0):_sortKey==="confidence"?(i=r.confidence,c=f.confidence):(i="",c=""),i<c?_sortDir==="asc"?-1:1:i>c?_sortDir==="asc"?1:-1:0});const p=document.getElementById("results-tbody");p.innerHTML=s.map((r,f)=>{const i=r.merged_fields,c=`<span class="empty-cell">${t("empty-val")}</span>`,l="conf-tip-"+(r.confidence||"low"),d="conf-"+(r.confidence||"low"),u=t(l),g=t(d);return`
        ...
        `}).join(""),document.querySelectorAll("#results-table th").forEach(r=>{r.classList.remove("sort-asc","sort-desc"),r.dataset.sort===_sortKey&&r.classList.add("sort-"+_sortDir)}),p.querySelectorAll("tr").forEach(r=>{r.addEventListener("click",()=>{const f=parseInt(r.dataset.idx,10);Tt(f)})})}document.querySelectorAll("#results-table th").forEach(e=>{e.classList.contains("no-sort")||e.addEventListener("click",()=>{const n=e.dataset.sort;_sortKey===n?_sortDir=_sortDir==="asc"?"desc":"asc":(_sortKey=n,_sortDir="asc"),Ye()})});let kt=null;document.getElementById("search-input").addEventListener("input",e=>{const n=e.target.value;document.getElementById("search-clear").style.display=n?"":"none",clearTimeout(kt),kt=setTimeout(()=>{_searchKeyword=n.trim(),Ye(),St()},200)});document.getElementById("search-clear").addEventListener("click",()=>{const e=document.getElementById("search-input");e.value="",_searchKeyword="",document.getElementById("search-clear").style.display="none",Ye(),St(),e.focus()});function St(){const e=document.getElementById("search-matches");if(!e)return;if(!_searchKeyword){e.textContent="";return}const n=_searchKeyword.toLowerCase();let a=0;for(const o of _results)[o.filename,o.merged_fields?.invoice_number,o.merged_fields?.seller_name,o.merged_fields?.buyer_name].filter(Boolean).join(" ").toLowerCase().includes(n)&&a++;e.textContent=t("search-matches",{n:a})}function Tt(e){_drawerIdx=e;const n=_results[e];if(!n)return;document.getElementById("drawer-title").textContent=n.filename;const a=n.engine==="cache"||n.from_cache,o=a?t("badge-cached-hint"):`${(n.elapsed_ms/1e3).toFixed(1)}s`;document.getElementById("drawer-sub").innerHTML=`
    ...
    `,c=p?"":`<span class="tax-badge unverified" data-tip="${escapeHtml(t("tax-tip-unverified"))}">${t("tax-unverified")}</span>`;if(f.innerHTML=`
        ...
        <div class="drawer-section">
            ...
            ${r.wht_amount||r.wht_rate?`
                ${ye("wht_amount","drawer-lbl-wht-amount",r.wht_amount,"input",s,Bn(r.wht_rate))}
            `:""}
        </div>
        ...
        <div class="drawer-section">
            ...
            ${ye("seller_tax","drawer-lbl-tax",r.seller_tax,"input",s,c,_t("seller"))}
        ...
        <div class="drawer-section">
            ...
            ${ye("buyer_tax","drawer-lbl-tax",r.buyer_tax,"input",s,c,_t("buyer"))}
        ...
        <div class="drawer-section">
            ...
            ${r.items&&r.items.length>0?In(r.items):`<div class="drawer-items-empty">${t("drawer-items-empty")}</div>`}
        </div>
...
`))}</pre>
    ...
    `,s?f.querySelectorAll("[data-field]").forEach(l=>{l.addEventListener("input",onFieldEdit)}):f.querySelectorAll("[data-field]").forEach(l=>{l.setAttribute("readonly","readonly")}),document.getElementById("drawer-mask").classList.add("show"),document.getElementById("drawer").classList.add("show"),injectOcrPushButton(),typeof window.bindDrawerClient=="function"){const l=n._historyId||n.history_id||null;window.bindDrawerClient(l,n.client_id||null)}typeof window.fillCategoryDatalist=="function"&&window.fillCategoryDatalist(),setTimeout(()=>{const l=document.getElementById("drawer-cat-input");l&&!l.value&&!l.readOnly&&l.focus()},80)}function Bn(e){return e?`<span class="wht-badge">${escapeHtml(e)}%</span>`:""}function ye(e,n,a,o,s,p,r){const f=_results[_drawerIdx],i=f&&f.edits[e]!==void 0?f.edits[e]:a,c=f&&f.edits[e]!==void 0&&f.edits[e]!==a,l=escapeHtml(i??""),d=s?"":"readonly",u=o==="textarea"?`<textarea data-field="${e}" rows="2">${l}</textarea>`:`<input type="text" data-field="${e}" value="${l}">`;return`
    ...
    `}function _t(e){return _userInfo&&_userInfo.can_verify_tax?`
    ...
    `;n.innerHTML=o+s,e.appendChild(n)}function ot(){const e=document.getElementById("export-dropdown");e&&e.remove()}const st=document.getElementById("btn-export-arrow");st&&st.addEventListener("click",e=>{e.stopPropagation(),!st.disabled&&Mn()});document.addEventListener("click",e=>{const n=e.target.closest(".export-dd-item");if(n){const a=n.getAttribute("data-tpl");if(a==="__custom"){ot(),showToast(t("cs-coming-soon"),"info");return}$n(a),ot(),Ht(a);return}e.target.closest("#btn-export-arrow")||ot()});function Hn(){const e=document.getElementById("btn-export-arrow"),n=document.getElementById("btn-export");e&&n&&(e.disabled=n.disabled)}setInterval(Hn,300);function pt(){const e=document.getElementById("history-batch-bar"),n=document.getElementById("history-batch-count"),a=document.getElementById("history-check-all");if(!e||!n)return;const o=_historySelected.size;if(o>0?(e.style.display="",n.textContent=t("history-batch-count",{n:o})):e.style.display="none",a){const s=_historyState.items||[];if(s.length===0)a.checked=!1,a.indeterminate=!1;else{const p=s.filter(r=>_historySelected.has(r.id)).length;a.checked=p===s.length,a.indeterminate=p>0&&p<s.length}}}function An(){_historySelected.clear(),pt()}async function ut(){if(!_userInfo){setTimeout(()=>ut(),300);return}const e=document.getElementById("history-free-block"),n=document.getElementById("history-main"),a=document.getElementById("history-empty");if(!e||!n||!a){console.warn("[History] container missing");return}if(!_userInfo.can_view_history){e.style.display="",n.style.display="none",a.style.display="none";return}e.style.display="none",_historyState.loading=!0;try{const o=_historyState.page*_historyState.pageSize,s=new URLSearchParams({limit:_historyState.pageSize,offset:o});_historyState.keyword&&s.set("keyword",_historyState.keyword);const p=typeof window.getCurrentClientId=="function"?window.getCurrentClientId():null;p&&s.set("client_id",String(p));const r=await fetch(`/api/history?${s}`,{headers:{Authorization:"Bearer "+token}});if(r.status===401){localStorage.removeItem("mrpilot_token");const c=await r.json().catch(()=>({}));if((typeof c.detail=="string"?c.detail:c.detail&&c.detail.code||"")==="auth.session_revoked"){_showSessionRevokedModal();return}window.location.href="/";return}const f=await r.json();_historyState.items=f.items||[],_historyState.total=f.total||0;const i=new Set(_historyState.items.map(c=>c.id));for(const c of Array.from(_historySelected))i.has(c)||_historySelected.delete(c);At()}catch(o){console.error("load history failed",o)}finally{_historyState.loading=!1}}function At(){const e=document.getElementById("history-main"),n=document.getElementById("history-empty"),a=_historyState.items,o=document.getElementById("history-search-matches");if(o&&(o.textContent=_historyState.keyword?t("search-matches",{n:_historyState.total}):""),a.length===0&&_historyState.total===0&&!_historyState.keyword){e.style.display="none",n.style.display="";return}e.style.display="",n.style.display="none";let s=0;a.forEach(c=>{c.confidence==="high"&&s++});const p=a.length>0?Math.round(s/a.length*100):0;document.getElementById("history-stats").innerHTML=`
        <div class="rh-stat">
    ...
    `;const r=document.getElementById("history-tbody");a.length===0?r.innerHTML=`<div class="history-row-empty">${escapeHtml(t("history-empty-title"))}</div>`:r.innerHTML=a.map(c=>{const l=new Date(c.created_at),d=String(l.getMonth()+1).padStart(2,"0"),u=String(l.getDate()).padStart(2,"0"),g=String(l.getHours()).padStart(2,"0"),k=String(l.getMinutes()).padStart(2,"0"),M=`${d}-${u} ${g}:${k}`,B=escapeHtml(c.filename||""),_=B.length>50?B.substring(0,50)+"…":B,E=c.invoice_no?escapeHtml(c.invoice_no):_,q=[];c.seller_name&&q.push(escapeHtml(c.seller_name)),c.invoice_no&&c.filename&&q.push(_);const H=q.join(" · ")||"-",F=c.category_tag?`<span class="history-badge category">${escapeHtml(c.category_tag)}</span>`:"",A=c.source_total&&c.source_total>1?`<span class="history-badge multi">${escapeHtml(t("invoice-part-of",{i:c.source_index||1,n:c.source_total}))}</span>`:"",y=c.total_amount!==null&&c.total_amount!==void 0?Number(c.total_amount).toLocaleString(void 0,{minimumFractionDigits:2,maximumFractionDigits:2}):'<span class="history-cell-amount-empty">—</span>',v=[];(c.total_amount===null||c.total_amount===void 0)&&v.push(t("field-amount")),c.invoice_no||v.push(t("field-invoice-no")),c.invoice_date||v.push(t("field-invoice-date")),c.seller_name||v.push(t("field-seller-name")),v.length>0&&`${escapeHtml(c.id)}${escapeHtml(t("history-needs-review-tip")+" · "+v.join(" · "))}${escapeHtml(t("history-needs-review-tip"))}${svgIcon("alert",14)}`,c.edited&&`${escapeHtml(t("history-edited",{n:c.edit_count||1}))}`;const b=c.smart_assigned_flag?`<span class="history-badge smart-assigned" title="${escapeHtml(t("history-smart-assigned"))}">${svgIcon("sparkle",11)}</span>`:"",L=c.confidence==="high"?"high":c.confidence==="medium"?"mid":"low",C=c.confidence==="high"?t("conf-high"):c.confidence==="medium"?t("conf-medium"):t("conf-low"),P=`<span class="history-badge conf-${L}">${escapeHtml(C)}</span>`;let I="";const j=c.source||"manual";return j==="email"?I=`<span class="history-badge source source-email" title="${escapeHtml(t("history-source-email"))}">${svgIcon("mail",11)}<span>${escapeHtml(t("history-source-email"))}</span></span>`:j==="folder"?I=`<span class="history-badge source source-folder" title="${escapeHtml(t("history-source-folder"))}">${svgIcon("folder",11)}<span>${escapeHtml(t("history-source-folder"))}</span></span>`:j==="api"&&(I=`<span class="history-badge source source-api" title="${escapeHtml(t("history-source-api"))}">${svgIcon("api",11)}<span>${escapeHtml(t("history-source-api"))}</span></span>`),`
                <div class="history-row" data-hid="${escapeHtml(c.id)}">
                    ...
                    <div class="history-cell-file">
                        <div class="history-cell-filename">${E} ${F} ${A} ${I} ${b}</div>
            ...
            `}).join(""),pt();const f=a.length>0?_historyState.page*_historyState.pageSize+1:0,i=_historyState.page*_historyState.pageSize+a.length;document.getElementById("history-pager-info").textContent=t("history-pager",{from:f,to:i,total:_historyState.total}),document.getElementById("history-prev").disabled=_historyState.page===0,document.getElementById("history-next").disabled=(_historyState.page+1)*_historyState.pageSize>=_historyState.total}window.loadHistoryPage=ut;window.renderHistoryList=At;window.updateHistoryBatchBar=pt;window.clearHistorySelection=An;typeof currentRoute<"u"&&currentRoute==="history"&&ut();async function Ue(e){try{const n=await fetch(`/api/history/${encodeURIComponent(e)}`,{headers:{Authorization:"Bearer "+token}});if(!n.ok)return;const a=await n.json(),o=mergeFields(a.pages||[]),s={filename:a.filename,pages:a.pages,page_count:a.page_count,elapsed_ms:a.elapsed_ms,engine:"history",merged_fields:o,edits:{},confidence:a.confidence,archive_name:a.archive_name||null,category_tag:a.category_tag||null,_historyId:a.id,_historyMode:!0,client_id:a.client_id||null};_results.push(s),_drawerIdx=_results.length-1,openDrawer(_drawerIdx),Pn(),typeof window.bindDrawerClient=="function"&&window.bindDrawerClient(a.id,a.client_id||null),Dn(a.id)}catch(n){console.error("open history detail failed",n)}}async function jn(e){await Ue(e),requestAnimationFrame(()=>{const n=document.querySelector('[data-field="total_amount"]');if(n){try{n.focus()}catch{}try{n.select()}catch{}try{n.scrollIntoView({block:"center",behavior:"smooth"})}catch{}}})}function Pn(){const e=document.getElementById("drawer-body");if(!e||document.getElementById("drawer-history-save"))return;const n=document.createElement("div");n.id="drawer-history-save",n.className="drawer-history-save-bar",n.innerHTML=`
    ...
    `,e.appendChild(n),document.getElementById("btn-save-history").addEventListener("click",Rn),document.getElementById("btn-push-erp").addEventListener("click",qn)}async function Dn(e){}async function qn(){showToast(t("erp-push-coming-soon")||"ERP 推送即将开放，敬请期待","info")}async function Rn(){const e=_results[_drawerIdx];if(!e||!e._historyId)return;const n=JSON.parse(JSON.stringify(e.pages||[]));if(n.length>0){const o=n.findIndex(f=>!f.is_duplicate&&!f.is_copy),s=o>=0?o:0,p=n[s].fields||(n[s].fields={}),r={...e.edits};r.category_tag!==void 0&&(r.category=r.category_tag,delete r.category_tag),Object.assign(p,r)}const a=document.getElementById("btn-save-history");a&&(a.disabled=!0);try{if(!(await fetch(`/api/history/${encodeURIComponent(e._historyId)}`,{method:"PUT",headers:{Authorization:"Bearer "+token,"Content-Type":"application/json"},body:JSON.stringify({pages:n})})).ok)throw new Error("save failed");showAlert("info",t("history-save-ok")),setTimeout(hideAlerts,1500),closeDrawer(),e._historyMode&&_results.pop(),loadHistoryPage()}catch{showAlert("error",t("history-save-fail")),a&&(a.disabled=!1)}}function Nn(e,n){document.querySelectorAll(".history-popover").forEach(c=>c.remove());const a=n.getBoundingClientRect(),o=(_historyState.items||[]).find(c=>c.id===e),s=o&&o.invoice_no?String(o.invoice_no):"",p=o&&o.has_pdf===!0,r=document.createElement("div");r.className="history-popover",r.innerHTML=`
    ...
    `,r.style.top=a.bottom+4+"px",r.style.left=a.right-160+"px",document.body.appendChild(r);const f=()=>{r.remove(),document.removeEventListener("click",i,!0)},i=c=>{!r.contains(c.target)&&c.target!==n&&f()};setTimeout(()=>document.addEventListener("click",i,!0),0),r.addEventListener("click",async c=>{const l=c.target.closest("[data-act]");if(!l||l.disabled)return;const d=l.dataset.act;if(f(),d==="copy-invno"){if(!s)return;try{await navigator.clipboard.writeText(s),showToast(t("history-copy-invno-ok",{no:s}),"success")}catch{try{const g=document.createElement("textarea");g.value=s,g.style.position="fixed",g.style.opacity="0",document.body.appendChild(g),g.select(),document.execCommand("copy"),document.body.removeChild(g),showToast(t("history-copy-invno-ok",{no:s}),"success")}catch{showToast(t("history-copy-invno-fail"),"error")}}}else if(d==="download-pdf"){const u=showToast(t("history-download-pdf-loading"),"loading",0);try{const g=await fetch(`/api/history/${encodeURIComponent(e)}/pdf`,{headers:{Authorization:"Bearer "+token}});if(!g.ok)throw new Error("download failed");const k=await g.blob(),M=URL.createObjectURL(k),B=document.createElement("a");B.href=M,B.download=o&&o.filename?o.filename.endsWith(".pdf")?o.filename:o.filename+".pdf":"invoice.pdf",document.body.appendChild(B),B.click(),document.body.removeChild(B),setTimeout(()=>URL.revokeObjectURL(M),5e3),u(),showToast(t("history-download-pdf-ok"),"success")}catch{u(),showToast(t("history-download-pdf-fail"),"error")}}else if(d==="delete"){if(!await showConfirm(t("history-confirm-delete"),{danger:!0}))return;try{if(!(await fetch(`/api/history/${encodeURIComponent(e)}`,{method:"DELETE",headers:{Authorization:"Bearer "+token}})).ok)throw new Error;showAlert("info",t("history-delete-ok")),setTimeout(hideAlerts,1500),loadHistoryPage()}catch{showAlert("error",t("history-delete-fail"))}}})}(function(){document.addEventListener("click",r=>{const f=r.target.closest(".history-row"),i=r.target.closest("[data-hmenu]");if(i){r.stopPropagation(),Nn(i.dataset.hmenu,i);return}const c=r.target.closest("[data-review]");if(c){r.stopPropagation(),Ue(c.dataset.review);return}const l=r.target.closest("[data-fill-amount]");if(l){r.stopPropagation(),jn(l.dataset.fillAmount);return}r.target.closest(".history-row-check")||r.target.closest(".history-cell-check")||f&&!r.target.closest("[data-hmenu]")&&Ue(f.dataset.hid)});const n=document.getElementById("history-tbody");n&&n.addEventListener("change",r=>{const f=r.target.closest(".history-row-check");if(!f)return;const i=f.dataset.hid;f.checked?_historySelected.add(i):_historySelected.delete(i),updateHistoryBatchBar()});const a=document.getElementById("history-check-all");a&&a.addEventListener("change",r=>{const f=r.target.checked;for(const i of _historyState.items)f?_historySelected.add(i.id):_historySelected.delete(i.id);document.querySelectorAll(".history-row-check").forEach(i=>{i.checked=f}),updateHistoryBatchBar()});const o=document.getElementById("history-batch-cancel");o&&o.addEventListener("click",()=>{clearHistorySelection(),document.querySelectorAll(".history-row-check").forEach(r=>{r.checked=!1})});const s=document.getElementById("history-batch-delete");s&&s.addEventListener("click",async()=>{const r=_historySelected.size;if(r===0||!await showConfirm(t("history-batch-confirm",{n:r}),{danger:!0}))return;const i=Array.from(_historySelected);try{const c=await fetch("/api/history/batch-delete",{method:"POST",headers:{Authorization:"Bearer "+token,"Content-Type":"application/json"},body:JSON.stringify({ids:i})});if(!c.ok)throw new Error("batch delete failed");const l=await c.json();showToast(t("history-batch-done",{n:l.deleted||0}),"success"),clearHistorySelection(),loadHistoryPage()}catch(c){console.error("batch delete",c),showToast(t("history-batch-fail"),"error")}});let p=null;document.getElementById("history-search").addEventListener("input",r=>{const f=r.target.value;document.getElementById("history-search-clear").style.display=f?"":"none",clearTimeout(p),p=setTimeout(()=>{_historyState.keyword=f.trim(),_historyState.page=0,clearHistorySelection(),loadHistoryPage()},300)}),document.getElementById("history-search-clear").addEventListener("click",()=>{const r=document.getElementById("history-search");r.value="",_historyState.keyword="",_historyState.page=0,clearHistorySelection(),document.getElementById("history-search-clear").style.display="none",loadHistoryPage(),r.focus()}),document.getElementById("history-range").addEventListener("change",r=>{_historyState.range=parseInt(r.target.value,10),_historyState.page=0,clearHistorySelection(),loadHistoryPage()}),document.getElementById("history-prev").addEventListener("click",()=>{_historyState.page>0&&(_historyState.page--,clearHistorySelection(),loadHistoryPage())}),document.getElementById("history-next").addEventListener("click",()=>{(_historyState.page+1)*_historyState.pageSize<_historyState.total&&(_historyState.page++,clearHistorySelection(),loadHistoryPage())})})();window.openHistoryDrawer=Ue;const $e=document.getElementById("drop-zone"),ft=document.getElementById("file-input");$e.addEventListener("click",()=>ft.click());ft.addEventListener("change",e=>jt(e.target.files));["dragover","dragenter"].forEach(e=>{$e.addEventListener(e,n=>{n.preventDefault(),$e.classList.add("drag-over")})});["dragleave","drop"].forEach(e=>{$e.addEventListener(e,n=>{n.preventDefault(),$e.classList.remove("drag-over")})});$e.addEventListener("drop",e=>{e.preventDefault(),jt(e.dataTransfer.files)});const Fn=/\.(pdf|png|jpe?g|webp|tiff?|bmp|gif|xlsx?|xlsm|csv|tsv|docx?|txt)$/i;function rt(e){return e.type&&e.type.startsWith("image/")||/\.(png|jpe?g|webp|tiff?|bmp|gif)$/i.test(e.name)}function zn(e){return e.type==="application/pdf"||/\.pdf$/i.test(e.name)}function On(e){return zn(e)||rt(e)||Fn.test(e.name)}function jt(e){hideAlerts();const n=Array.from(e),a=n.filter(On);a.length!==n.length&&showAlert("warn",t("alert-unsupported-format"));const o=a.filter(f=>!rt(f)),s=a.filter(rt),p=new Set(_selectedFiles.map(f=>f.name+"_"+f.size));for(const f of o){const i=f.name+"_"+f.size;p.has(i)||(_selectedFiles.push({file:f,name:f.name,size:f.size,status:"waiting",errorKey:null,errorParams:null}),p.add(i))}if(s.length>0)try{handleCameraImages(s,"gallery")}catch(f){console.error("[upload] image route failed",f)}const r=getMaxFiles();_selectedFiles.length>r&&(showAlert("warn",t("alert-file-count",{n:r})),_selectedFiles=_selectedFiles.slice(0,r)),We(),mt(),ft.value=""}let Oe=!1;function We(){const e=document.getElementById("file-list");if(!e)return;if(_selectedFiles.length===0){e.classList.remove("has-files"),e.innerHTML="";return}e.classList.add("has-files");const n=_selectedFiles.length,a=_selectedFiles.filter(d=>d.status==="processing"||d.status==="retrying").length,o=_selectedFiles.filter(d=>d.status==="success").length,s=_selectedFiles.filter(d=>d.status==="error").length;let p=`<span class="count">${escapeHtml(t("file-list-total",{n}))}</span>`;const r=[];a&&r.push(`<span style="color: var(--accent, #111111);">${a} ${escapeHtml(t("status-processing"))}</span>`),o&&r.push(`<span style="color: var(--success, #059669);">${o} ${escapeHtml(t("status-success"))}</span>`),s&&r.push(`<span style="color: var(--danger, #dc2626);">${s} ${escapeHtml(t("status-error"))}</span>`),r.length&&(p+=" · "+r.join(" · "));const f=Oe?t("file-list-collapse"):t("file-list-expand"),i=_selectedFiles.map((d,u)=>{let g=t("status-"+d.status);d.status==="retrying"&&(g=t("status-retrying")),d.status==="error"&&d.errorKey&&(g=t(d.errorKey,d.errorParams||{}));const k=d.status==="processing"||d.status==="retrying"?'<span class="spinner"></span>':"",M=d.status==="error"&&d.canRetry?`<button class="file-retry-btn" data-retry-idx="${u}" title="${escapeHtml(t("upload-retry-btn"))}">${svgIcon("refresh",12)}<span>${escapeHtml(t("upload-retry-btn"))}</span></button>`:"",B=d.status==="success"&&d.fromCache?`<span class="file-cache-badge">${svgIcon("cache",11)}<span>${escapeHtml(t("cache-hit-badge"))}</span></span>`:"";return`
            <li class="file-item">
                ...
                ${B}
                <span class="file-status ${d.status}">${k}${g}</span>
                ${M}
            </li>
        `}).join("");e.innerHTML=`
    ...
    `;const c=document.getElementById("file-list-toggle");c&&c.addEventListener("click",()=>{Oe=!Oe,We()});const l=document.getElementById("file-list-body");l&&!l.dataset.retryBound&&(l.dataset.retryBound="1",l.addEventListener("click",async d=>{const u=d.target.closest(".file-retry-btn");if(!u)return;const g=parseInt(u.dataset.retryIdx||"-1",10);if(g<0||g>=_selectedFiles.length)return;const k=_selectedFiles[g];!k||k.status!=="error"||typeof window._reprocessFile=="function"&&await window._reprocessFile(k,!0)}))}function mt(){const e=document.getElementById("btn-start"),n=document.getElementById("btn-clear"),a=document.getElementById("btn-export"),o=_selectedFiles.some(s=>s.status==="waiting");e.disabled=_selectedFiles.length===0||!o,n.disabled=_selectedFiles.length===0&&_results.length===0,a.disabled=_results.length===0}document.getElementById("btn-clear").addEventListener("click",()=>{_selectedFiles=[],_results=[],We(),renderResults(),mt(),hideAlerts()});window.renderFileList=We;window.updateStartButton=mt;(function(){const n=document.getElementById("upload-alt-row"),a=document.getElementById("gallery-input"),o=document.getElementById("camera-input");if(!n)return;n.style.display="";const s=document.getElementById("btn-scan-doc");s&&o&&(s.addEventListener("click",async()=>{!(localStorage.getItem("mrpilot_camera_tips_skip")==="1")&&!await Un()||o.click()}),o.addEventListener("change",async f=>{const i=Array.from(f.target.files||[]);if(f.target.value="",i.length!==0)for(const c of i)await lt([c],"camera")}));const p=document.getElementById("btn-upload-pic");p&&a&&p.addEventListener("click",()=>a.click());const r=f=>async i=>{const c=Array.from(i.target.files||[]);if(i.target.value="",c.length===0)return;const l=c.filter(u=>u.type==="application/pdf"||/\.pdf$/i.test(u.name)),d=c.filter(u=>!l.includes(u));l.length>0&&await Vn(l),d.length>0&&await lt(d,f)};a&&a.addEventListener("change",r("gallery"))})();async function Vn(e){for(const a of e)_selectedFiles.push({file:a,name:a.name,size:a.size,status:"waiting",errorKey:null,errorParams:null});const n=getMaxFiles();_selectedFiles.length>n&&(showAlert("warn",t("alert-file-count",{n})),_selectedFiles=_selectedFiles.slice(0,n)),renderFileList(),updateStartButton()}function Un(){return new Promise(e=>{const n=document.getElementById("camera-tips-modal"),a=document.getElementById("camera-tips-ok"),o=document.getElementById("camera-tips-cancel"),s=document.getElementById("camera-tips-skip");if(!n||!a){e(!0);return}s&&(s.checked=!1),n.style.display="flex";const p=f=>{n.style.display="none",s&&s.checked&&localStorage.setItem("mrpilot_camera_tips_skip","1"),a.onclick=null,o&&(o.onclick=null),n.onclick=null,document.removeEventListener("keydown",r),e(f)},r=f=>{f.key==="Escape"&&p(!1)};a.onclick=()=>p(!0),o&&(o.onclick=()=>p(!1)),n.onclick=f=>{f.target===n&&p(!1)},document.addEventListener("keydown",r),setTimeout(()=>a.focus(),50)})}async function Ge(e){return new Promise(n=>{const a=new FileReader;a.onerror=()=>n({warnings:[],width:0,height:0,brightness:128}),a.onload=()=>{const o=new Image;o.onerror=()=>n({warnings:[],width:0,height:0,brightness:128}),o.onload=()=>{const s=[],p=o.naturalWidth,r=o.naturalHeight;(p<1e3||r<1e3)&&s.push("low_res");try{const f=document.createElement("canvas");f.width=64,f.height=64;const i=f.getContext("2d");i.drawImage(o,0,0,64,64);const c=i.getImageData(0,0,64,64).data;let l=0,d=0;for(let g=0;g<c.length;g+=4)l+=.299*c[g]+.587*c[g+1]+.114*c[g+2],d++;const u=d?l/d:128;u<70?s.push("too_dark"):u>235&&s.push("too_bright"),n({warnings:s,width:p,height:r,brightness:u})}catch{n({warnings:s,width:p,height:r,brightness:128})}},o.src=a.result},a.readAsDataURL(e)})}let ke=[],Le=null;async function lt(e,n){if(hideAlerts(),!(!e||e.length===0)){if(typeof window.jspdf>"u"||!window.jspdf.jsPDF){showToast(t("camera-loading"),"info");for(let a=0;a<30&&(await new Promise(o=>setTimeout(o,100)),!(window.jspdf&&window.jspdf.jsPDF));a++);if(!window.jspdf||!window.jspdf.jsPDF){showToast(t("camera-lib-fail"),"error");return}}if(n==="camera"&&e.length===1){const a=e[0];let o={};try{o=await Ge(a)}catch{}ke.push({file:a,quality:o}),Le="camera",Te();return}if(n==="gallery"&&(e.length>=2||ke.length>0)){for(const a of e){let o={};try{o=await Ge(a)}catch{}ke.push({file:a,quality:o})}Le="gallery",Te();return}await Pt(e)}}async function Gn(e){const n=new Set;for(const o of e)try{((await Ge(o)).warnings||[]).forEach(p=>n.add(p))}catch{}try{const o=await Dt(e);o&&_selectedFiles.push({file:o,name:o.name,size:o.size,status:"waiting",errorKey:null,errorParams:null})}catch(o){console.error("[camera] convert failed",o),showToast(t("camera-convert-fail"),"error");return}const a=getMaxFiles();_selectedFiles.length>a&&(showAlert("warn",t("alert-file-count",{n:a})),_selectedFiles=_selectedFiles.slice(0,a)),renderFileList(),updateStartButton(),showToast(t("camera-added-merged",{n:e.length}),"success"),n.size>0&&setTimeout(()=>{n.has("too_dark")?showToast(t("camera-quality-dark"),"warn"):n.has("low_res")?showToast(t("camera-quality-lowres"),"warn"):n.has("too_bright")&&showToast(t("camera-quality-overexposed"),"warn")},1e3)}function Te(){let e=document.getElementById("camera-buffer-bar");if(ke.length===0){e&&e.remove(),Le=null;return}e||(e=document.createElement("div"),e.id="camera-buffer-bar",e.className="camera-buffer-bar",document.body.appendChild(e));const n=ke.length,a=n>=2,o=Le==="gallery",s=o?t("camera-buffer-more-gallery"):t("camera-buffer-more");let p;a?o?p=`
    ...
    `,e.querySelector('[data-cbb-action="discard"]').onclick=()=>{ke=[],Le=null,Te()},e.querySelector('[data-cbb-action="more"]').onclick=()=>{const i=o?"gallery-input":"camera-input",c=document.getElementById(i);c&&c.click()};const r=e.querySelector('[data-cbb-action="merge"]');r&&(r.onclick=async()=>{const i=ke.map(c=>c.file);ke=[],Le=null,Te(),await Gn(i)});const f=e.querySelector('[data-cbb-action="separate"]');f&&(f.onclick=async()=>{const i=ke.map(c=>c.file);ke=[],Le=null,Te(),await Pt(i)})}typeof window.subscribeI18n=="function"&&window.subscribeI18n("camera-buffer-bar",()=>{ke.length>0&&Te()});async function Pt(e){const n=new Set;let a=0;for(const s of e)try{((await Ge(s)).warnings||[]).forEach(f=>n.add(f));const r=await Dt([s]);r&&(_selectedFiles.push({file:r,name:r.name,size:r.size,status:"waiting",errorKey:null,errorParams:null}),a++)}catch(p){console.error("[camera] separate convert failed",p)}if(a===0){showToast(t("camera-convert-fail"),"error");return}const o=getMaxFiles();_selectedFiles.length>o&&(showAlert("warn",t("alert-file-count",{n:o})),_selectedFiles=_selectedFiles.slice(0,o)),renderFileList(),updateStartButton(),showToast(t("camera-added-separate",{n:a}),"success"),n.size>0&&setTimeout(()=>{n.has("too_dark")?showToast(t("camera-quality-dark"),"warn"):n.has("low_res")?showToast(t("camera-quality-lowres"),"warn"):n.has("too_bright")&&showToast(t("camera-quality-overexposed"),"warn")},1e3)}async function Dt(e){if(!e||e.length===0)return null;const{jsPDF:n}=window.jspdf,a=210,o=297,s=new n({unit:"mm",format:"a4",orientation:"p"});for(let c=0;c<e.length;c++){const l=e[c],{dataUrl:d,naturalW:u,naturalH:g}=await Kn(l);c>0&&s.addPage("a4","p");const k=u/g;let M=a-10,B=M/k;B>o-10&&(B=o-10,M=B*k);const _=(a-M)/2,E=(o-B)/2,q=l.type==="image/png"?"PNG":"JPEG";s.addImage(d,q,_,E,M,B,void 0,"FAST")}const p=s.output("blob"),r=new Date,f=r.getFullYear().toString()+String(r.getMonth()+1).padStart(2,"0")+String(r.getDate()).padStart(2,"0")+String(r.getHours()).padStart(2,"0")+String(r.getMinutes()).padStart(2,"0")+String(r.getSeconds()).padStart(2,"0"),i=e.length>1?`_${e.length}p`:"";return new File([p],`photo_${f}${i}.pdf`,{type:"application/pdf"})}function Kn(e){return new Promise((n,a)=>{const o=new FileReader;o.onerror=a,o.onload=()=>{const s=new Image;s.onerror=a,s.onload=()=>n({dataUrl:o.result,naturalW:s.naturalWidth,naturalH:s.naturalHeight}),s.src=o.result},o.readAsDataURL(e)})}window.handleCameraImages=lt;document.getElementById("btn-start").addEventListener("click",async()=>{if(hideAlerts(),document.getElementById("btn-start").disabled=!0,_userInfo&&_userInfo.plan==="free"){const l=await fetch("/api/health").then(d=>d.json()).catch(()=>null);l&&!l.ocr_ready&&(showAlert("info",t("alert-loading-engine")),startEnginePolling())}const e=_selectedFiles.filter(l=>l.status==="waiting"),n=6;async function a(l,d){if(window._ocrAborted)return l.status="cancelled",l.errorKey=null,renderFileList(),{};l.status=d?"retrying":"processing",l.canRetry=!1,renderFileList();const u=new AbortController,g=setTimeout(()=>u.abort("timeout"),9e4);window._ocrCtrls=window._ocrCtrls||new Set,window._ocrCtrls.add(u);try{const k=new FormData;k.append("file",l.file,l.name);try{if(typeof window.getCurrentClientId=="function"){const q=window.getCurrentClientId();q!=null&&k.append("client_id",String(q))}}catch{}const M=await fetch("/api/ocr/recognize",{method:"POST",headers:{Authorization:"Bearer "+token},body:k,signal:u.signal});if(clearTimeout(g),window._ocrCtrls.delete(u),M.status===401||M.status===403){const H=await M.clone().json().catch(()=>({})),F=H&&H.detail,A=typeof F=="string"?F:F&&F.code||"";if(!A||A.startsWith("auth.")){if(localStorage.removeItem("mrpilot_token"),A==="auth.session_revoked")_showSessionRevokedModal();else{const y=A==="auth.password_changed_relogin"?"alert-password-changed-relogin":"alert-session";showToast(t(y),"error"),setTimeout(()=>{window.location.href="/"},1200)}return{abort:!0}}A==="quota.need_api_key"&&showToast(t("err.quota.need_api_key"),"error")}if(!M.ok){const H=(await M.json().catch(()=>({}))).detail;return typeof H=="string"?(l.errorKey="err."+H,l.errorParams=null):H&&H.code?(l.errorKey="err."+H.code,l.errorParams={...H,mb:_quota.max_file_size_mb}):(l.errorKey="err.unknown",l.errorParams=null),(l.errorKey==="err.unknown"||l.errorKey==="err.ocr.engine_error")&&(M.status===429?l.errorKey="err.rate_limit":M.status===502||M.status===503||M.status===504?l.errorKey="err.gemini_overloaded":M.status>=500&&(l.errorKey="err.server")),l.status="error",l.canRetry=!/not_pdf|invalid_pdf|file_too_large|too_many_pages|monthly_limit_exceeded|ip_limit_exceeded|plan_not_supported|need_api_key|not_invoice/.test(l.errorKey||""),renderFileList(),{}}const B=await M.json();l.status="success",l.fromCache=!!B.from_cache;const _=mergeFields(B.pages),E=B.confidence||(_.items&&_.items.length>0?"high":"low");if(_results.push({filename:B.filename,pages:B.pages,page_count:B.page_count,elapsed_ms:B.elapsed_ms,engine:B.engine,merged_fields:_,edits:{},confidence:E,history_id:B.history_id,history_ids:B.history_ids||[],invoice_count:B.invoice_count||1,invoices:B.invoices||[],archive_name:B.archive_name||null,category_tag:B.category_tag||null,auto_pushed:!!B.auto_pushed,typhoon_enhanced:!!B.typhoon_enhanced,typhoon_pages:B.typhoon_pages||[],from_cache:!!B.from_cache}),B.invoice_count&&B.invoice_count>1&&showToast(t("multi-invoice-toast",{file:B.filename,n:B.invoice_count}),"success"),B.missed_invoice_warnings&&B.missed_invoice_warnings.length){const q=B.missed_invoice_warnings.map(function(H){return H.page}).filter(function(H){return H!=null});showToast(t("missed-invoice-warn",{file:B.filename,pages:q.join(", ")}),"warn",8e3),console.warn("[OCR] possible missed invoice(s)",B.missed_invoice_warnings)}if(B.typhoon_enhanced&&B.typhoon_pages&&B.typhoon_pages.length&&showToast(t("typhoon-enhanced-toast",{file:B.filename,n:B.typhoon_pages.length}),"success"),B.fallback_used){const q=B.engine_chain||[],H=B.engine||"";let F;H==="typhoon_nvidia"?F="fallback-typhoon-nvidia-toast":H==="easyocr"?F="fallback-easyocr-toast":F="fallback-generic-toast",showToast(t(F,{file:B.filename}),"warn"),console.info("[OCR Chain]",q)}if(B.from_cache&&showToast(t("cache-hit-toast",{file:B.filename}),"info"),B.duplicate_warnings&&B.duplicate_warnings.length){window._dupQueue||(window._dupQueue=[]);for(const q of B.duplicate_warnings)window._dupQueue.push({filename:B.filename,...q})}return B.auto_pushed&&showToast(t("auto-push-fired",{file:B.filename}),"info"),B.quota&&B.quota.used_this_month!=null&&_userInfo&&(_userInfo.used_this_month=B.quota.used_this_month,_userInfo.tenant_used=B.quota.used_this_month,renderInfoBar(),renderQuotaBanner()),renderFileList(),renderResults(),updateStartButton(),{}}catch(k){clearTimeout(g);try{window._ocrCtrls&&window._ocrCtrls.delete(u)}catch{}console.error("[Upload] failed for",l.file.name,k);const M=k&&(k.name==="AbortError"||k==="timeout"),B=M&&(u.signal.reason==="timeout"||k==="timeout"),_=k&&k.message&&/NetworkError|Failed to fetch/i.test(k.message);return M&&(u.signal.reason==="user_stop"||window._ocrAborted)?(l.status="cancelled",l.errorKey=null,l.canRetry=!1,renderFileList(),{}):(B?l.errorKey="err.timeout":M?l.errorKey="err.aborted":_?l.errorKey="err.network":(l.errorKey="err.unknown",l.errorParams={msg:k&&k.message?k.message:String(k)}),l.status="error",!d&&!window._ocrAborted&&(_||B)&&navigator.onLine!==!1&&(l.canRetry=!0,renderFileList(),await new Promise(q=>setTimeout(q,2e3)),l.status==="error"&&navigator.onLine!==!1&&!window._ocrAborted)?a(l,!0):(l.canRetry=!0,renderFileList(),{}))}}window._reprocessFile=a;let o=0,s=!1;async function p(){for(;o<e.length&&!s&&!window._ocrAborted;){const l=o++,d=await a(e[l]);if(d&&d.abort){s=!0;return}}}window._ocrAborted=!1,window._ocrCtrls=window._ocrCtrls||new Set;const r=document.getElementById("btn-start"),f=document.getElementById("btn-stop");r&&(r.style.display="none"),f&&(f.style.display="");try{typeof window._bigBatchStart=="function"&&window._bigBatchStart(e)}catch{}const i=[];for(let l=0;l<Math.min(n,e.length);l++)i.push(p());await Promise.all(i);try{typeof window._bigBatchStop=="function"&&window._bigBatchStop()}catch{}r&&(r.style.display=""),f&&(f.style.display="none");const c=!!window._ocrAborted;window._ocrAborted=!1,window._ocrCtrls.clear(),updateStartButton(),stopEnginePolling(),document.getElementById("alert-info").classList.contains("show")&&(showAlert("info",t("alert-engine-ready")),setTimeout(hideAlerts,2e3));try{const l={success:0,cancelled:0,network:0,timeout:0,quota:0,overloaded:0,rate:0,other:0};for(const u of e)if(u.status==="success")l.success++;else if(u.status==="cancelled")l.cancelled++;else if(u.status==="error"){const g=u.errorKey||"";g==="err.network"?l.network++:g==="err.timeout"||g==="err.aborted"?l.timeout++:g.indexOf("quota")>=0||g==="err.monthly_limit_exceeded"?l.quota++:g==="err.gemini_overloaded"||g==="err.server"?l.overloaded++:g==="err.rate_limit"?l.rate++:l.other++}const d=e.length;c?showToast(Jn(l,d),"warn",4e3):d>1&&l.network+l.timeout+l.quota+l.overloaded+l.rate+l.other>0&&showToast(Yn(l),"error",4500)}catch{}window._dupQueue&&window._dupQueue.length&&showDuplicateDialog()});function Jn(e,n){return t("ocr-summary-aborted").replace("{success}",e.success).replace("{cancelled}",e.cancelled).replace("{total}",n)}function Yn(e){const n=[];return e.success&&n.push(t("ocr-summary-success").replace("{n}",e.success)),e.network&&n.push(t("ocr-summary-network").replace("{n}",e.network)),e.timeout&&n.push(t("ocr-summary-timeout").replace("{n}",e.timeout)),e.quota&&n.push(t("ocr-summary-quota").replace("{n}",e.quota)),e.overloaded&&n.push(t("ocr-summary-overloaded").replace("{n}",e.overloaded)),e.rate&&n.push(t("ocr-summary-rate").replace("{n}",e.rate)),e.other&&n.push(t("ocr-summary-other").replace("{n}",e.other)),n.join(" · ")}document.addEventListener("click",e=>{if(!e.target.closest("#btn-stop")||window._ocrAborted)return;window._ocrAborted=!0,window._ocrCtrls&&window._ocrCtrls.size&&window._ocrCtrls.forEach(a=>{try{a.abort("user_stop")}catch{}});const n=document.getElementById("btn-stop");n&&(n.disabled=!0),typeof showToast=="function"&&showToast(t("ocr-stop-toast"),"warn",2e3),setTimeout(()=>{n&&(n.disabled=!1)},800)});function qt(){if(!window._dupQueue||!window._dupQueue.length)return;const e=window._dupQueue.shift(),n=e.level==="exact",a=n?"dup-title-exact":"dup-title-likely",o=n?"dup-desc-exact":"dup-desc-likely",s=n?"#DC2626":"#D97706",p=n?"#FEE2E2":"#FEF3C7",r=g=>g!=null?Number(g).toLocaleString(void 0,{minimumFractionDigits:2,maximumFractionDigits:2}):"—",f=g=>g||"—",i=g=>{try{const k=new Date(g);return`${k.getFullYear()}-${String(k.getMonth()+1).padStart(2,"0")}-${String(k.getDate()).padStart(2,"0")}`}catch{return g}},c=e.invoice_total>1?` · ${t("invoice-part-of",{i:e.invoice_index,n:e.invoice_total})}`:"",l=(e.matched_fields||[]).map(g=>{const k=t("dup-field-"+g.replace("_","-"))||g;return`<span class="dup-field-chip">${escapeHtml(k)}</span>`}).join(" "),d=document.createElement("div");d.className="log-detail-modal",d.innerHTML=`
...
[`+H+" / "+F+"]")&&d(E),!1}async function d(E){const q=await c();if(typeof E=="function"&&s()!=="personal"&&q.length===1){f(Number(q[0].id)),E();return}if(typeof window.openWorkspaceChooserUI=="function"){window.openWorkspaceChooserUI({clients:q,canCreate:o(),active:p(),onPersonal:i,onPick:function(H){f(Number(H)),typeof E=="function"&&E()},emptyHint:q.length?null:o()?a("ws-empty-owner","还没有工作空间。创建一个公司后,上传、对账和 ERP 推送都会归属到该公司。"):a("ws-empty-employee","你还没有可用的工作空间,请联系管理员分配。")});return}if(!q.length){const H=o()?a("ws-empty-owner","还没有工作空间。创建一个公司后,上传、对账和 ERP 推送都会归属到该公司。"):a("ws-empty-employee","你还没有可用的工作空间,请联系管理员分配。");typeof window.showToast=="function"&&window.showToast(H,"info")}}function u(E){const q=E||document.getElementById("workspace-switcher-root");if(!q)return;const H=s(),F=p();let A,y;if(H==="client"&&F!=null){const L=(window._workspaceClientsCache||[]).find(C=>Number(C.id)===Number(F));A=k("building"),y=L?L.name:a("ws-current-label","当前工作空间")}else A=k("user"),y=a("ws-personal","个人事务");q.innerHTML='<button class="ws-ctrl-btn" id="ws-ctrl-btn" type="button">'+A+'<span class="ws-ctrl-label">'+g(y)+"</span></button>";const v=q.querySelector("#ws-ctrl-btn");v&&v.addEventListener("click",()=>d(null))}function g(E){return String(E??"").replace(/[&<>"']/g,function(q){return{"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"}[q]})}function k(E){const q='<svg class="ws-ic" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">';return E==="building"?q+'<rect x="2" y="7" width="20" height="14" rx="2"/><path d="M16 21V5a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v16"/></svg>':q+'<path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/></svg>'}function M(E){E=E||{};const q=E.clients||[],H=E.active,F=document.getElementById("ws-modal");F&&F.remove();const A=document.createElement("div");A.id="ws-modal",A.className="ws-modal";const v='<button type="button" class="ws-modal-item'+(s()==="personal"||H==null?" active":"")+'" data-ws-personal="1"><span class="ws-modal-item-ic">'+k("user")+'</span><span class="ws-modal-item-text" style="display:flex;flex-direction:column;align-items:flex-start;min-width:0;"><span class="ws-modal-item-name">'+g(a("ws-personal","个人事务"))+'</span><span class="ws-modal-item-desc" style="font-size:11px;color:#6b7280;font-weight:400;margin-top:2px;line-height:1.35;white-space:normal;">'+g(a("ws-personal-desc","用于临时识别、测试或处理不归属任何公司的文件。"))+"</span></span></button>";let b="";if(q.length){const j=['<option value="">'+g(a("ws-select-ph","— 选择账套主体 —"))+"</option>"].concat(q.map(function(Y){const G=H!=null&&Number(H)===Number(Y.id);return'<option value="'+g(Y.id)+'"'+(G?" selected":"")+">"+g(Y.name||"#"+Y.id)+"</option>"}));b='<div class="ws-modal-select-row"><label class="ws-modal-select-label">'+g(a("ws-select-label","账套主体"))+'</label><select class="ws-modal-select" data-ws-select="1">'+j.join("")+"</select></div>"}const L=!q.length&&E.emptyHint?'<div class="ws-modal-empty">'+g(E.emptyHint)+"</div>":"",C=E.canCreate?'<div class="ws-modal-create"><button type="button" class="ws-modal-create-toggle" data-ws-create-toggle="1">+ '+g(a("ws-create-client","新建工作空间"))+'</button><div class="ws-modal-create-form" data-ws-create-form style="display:none;"><input type="text" class="ws-modal-create-input" data-ws-create-name placeholder="'+g(a("ws-create-ph","公司名称,例如 BAKELAB"))+'"><button type="button" class="ws-modal-create-submit" data-ws-create-submit="1">'+g(a("ws-create-submit","创建"))+"</button></div></div>":"";A.innerHTML='<div class="ws-modal-box" role="dialog" aria-modal="true"><div class="ws-modal-head"><span class="ws-modal-title">'+g(a("ws-chooser-title","选择工作空间"))+'</span><button type="button" class="ws-modal-close" data-ws-close="1" aria-label="close">✕</button></div><div class="ws-modal-subtitle" style="font-size:12px;color:#6b7280;padding:2px 4px 12px;line-height:1.45;white-space:normal;">'+g(a("ws-chooser-subtitle","账套主体 = 你的公司(发票卖方/开票方)。选择正在为哪家公司做账。"))+'</div><div class="ws-modal-list">'+v+b+"</div>"+L+C+"</div>",document.body.appendChild(A);const P=A.querySelector("[data-ws-select]");P&&P.addEventListener("change",function(){const j=P.value;j&&(typeof E.onPick=="function"&&E.onPick(j),I(),u())});function I(){A.remove()}A.addEventListener("click",function(j){if(j.target===A||j.target.closest("[data-ws-close]")){I();return}if(j.target.closest("[data-ws-personal]")){typeof E.onPersonal=="function"&&E.onPersonal(),I(),u();return}const G=j.target.closest("[data-ws-pick]");if(G){const re=G.getAttribute("data-ws-pick");typeof E.onPick=="function"&&E.onPick(re),I(),u();return}if(j.target.closest("[data-ws-create-toggle]")){const re=A.querySelector("[data-ws-create-form]");if(re){re.style.display=re.style.display==="none"?"flex":"none";const T=re.querySelector("[data-ws-create-name]");T&&T.focus()}return}if(j.target.closest("[data-ws-create-submit]")){B(A,E,I);return}})}async function B(E,q,H){const F=E.querySelector("[data-ws-create-name]"),A=F?(F.value||"").trim():"";if(!A){F&&F.focus();return}let y=null;try{if(typeof window.apiPost=="function"){const b=await window.apiPost("/api/workspace/clients",{name:A});y=b&&typeof b.json=="function"?await b.json().catch(()=>null):b}}catch{y=null}const v=y&&(y.id||y.client&&y.client.id);if(!v){typeof window.showToast=="function"&&window.showToast(a("ws-create-fail","新建工作空间失败 · 请重试"),"error");return}window._workspaceClientsCache=await c(),f(Number(v)),q.onPick,H(),u()}window.openWorkspaceChooserUI=M,window.addEventListener("pearnly:workspace-changed",function(){u()}),window.getWorkMode=s,window.getActiveWorkspaceClientId=p,window.setActiveWorkspaceClientId=f,window.enterPersonalMode=i,window.requireWorkspace=l,window.openWorkspaceChooser=d,window.renderWorkspaceControl=u,window.fetchWorkspaceClients=c;function _(){try{if(sessionStorage.getItem("pearnly_ws_login_prompted")==="1"||p()!=null||localStorage.getItem(n)==="personal")return;sessionStorage.setItem("pearnly_ws_login_prompted","1"),setTimeout(function(){d(null)},800)}catch{}}c().then(E=>{window._workspaceClientsCache=E,u(),_()}),typeof window.subscribeI18n=="function"&&window.subscribeI18n("workspace-switcher",u)})();(function(){const e=H=>document.querySelector('[data-num-target="'+H+'"]');function n(H){if(!H)return t("reconcile-last-activity-none");try{const F=new Date(H),A=new Date,y=A-F;if(y/6e4<5)return t("reconcile-last-activity-just-now");if(F.toDateString()===A.toDateString())return t("reconcile-last-activity-today");const b=Math.max(1,Math.floor(y/(24*3600*1e3)));return t("reconcile-last-activity-days-ago").replace("{n}",b)}catch{return t("reconcile-last-activity-none")}}function a(H,F,A){const y=e(H);y&&(y.textContent=A?"-":String(F),y.classList.toggle("is-empty",!!A))}function o(H){const F=document.getElementById("reconcile-error");F&&(F.style.display=H?"flex":"none")}function s(H){const F=document.getElementById("reconcile-empty");F&&(F.style.display=H?"flex":"none")}function p(H,F){const A=document.getElementById("reconcile-last-activity");A&&(A.textContent=H,A.classList.toggle("has-data",!!F))}function r(H){const F=!H||(H.total_sessions||0)===0;a("pending",H.pending||0,F),a("matched",H.matched||0,F),a("unmatched",H.unmatched||0,F),p(n(H.last_activity_at),!!H.last_activity_at),o(!1),s(F)}function f(H){const F=H.toUpperCase();return F==="KBANK"?"bank-chip-kbank":F==="SCB"?"bank-chip-scb":F==="BBL"?"bank-chip-bbl":F==="KTB"?"bank-chip-ktb":F==="TTB"?"bank-chip-ttb":"bank-chip-other"}function i(H,F){const A=y=>y?String(y).slice(0,10):"?";return!H&&!F?"":A(H)+" ~ "+A(F)}function c(H){return H==null?"":String(H).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function l(H){const F=document.getElementById("reconcile-recent"),A=document.getElementById("reconcile-recent-list");if(!F||!A)return;const y=(H||[]).slice(0,20);if(y.length===0){F.style.display="none";return}F.style.display="",s(!1),A.innerHTML=y.map(v=>{const b=v.parse_status==="parse_failed",L=v.bank_code||"OTHER",C=v.account_last4?" ···"+c(v.account_last4):"",P=i(v.period_start,v.period_end),I=c(v.source_filename||""),j=Number(v.tx_count||0),Y=b?'<span class="recon-card-fail" data-i18n="reconcile-card-parse-failed">'+t("reconcile-card-parse-failed")+"</span>":'<span class="recon-card-tx">'+t("reconcile-card-tx").replace("{n}",j)+"</span>";return'<div class="recon-card" data-session-id="'+c(v.id)+'" data-session-name="'+I+'"><span class="bank-chip '+f(L)+'">'+c(L)+'</span><div class="recon-card-main"><div class="recon-card-title">'+I+C+'</div><div class="recon-card-sub">'+c(P)+'</div></div><div class="recon-card-right">'+Y+'</div><button class="recon-card-trash" data-trash="'+c(v.id)+'" title="'+c(t("bank-session-delete-tip")||"删除")+'"><svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"><path d="M3 5h10M6 5V3h4v2M5 5l1 9h4l1-9"/></svg></button><svg class="recon-card-arrow" viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M6 4l4 4-4 4"/></svg></div>'}).join(""),A.querySelectorAll(".recon-card").forEach(v=>{v.addEventListener("click",b=>{b.target.closest(".recon-card-trash")||(v.dataset.sessionId,d())})}),A.querySelectorAll(".recon-card-trash").forEach(v=>{v.addEventListener("click",b=>{b.stopPropagation();const L=v.dataset.trash,C=v.closest(".recon-card"),P=C&&C.dataset.sessionName||"";typeof window._deleteBankSession=="function"&&window._deleteBankSession(L,P)})})}function d(H){typeof window.routeTo=="function"&&window.routeTo("reconcile"),setTimeout(function(){const F=document.querySelector('[data-recon-tab="bank"]');F&&F.click()},150)}function u(){o(!0),s(!1)}function g(){typeof window.routeTo=="function"&&window.routeTo("reconcile"),setTimeout(function(){const H=document.querySelector('[data-recon-tab="bank"]');H&&H.click()},150)}async function k(){a("pending",0,!0),a("matched",0,!0),a("unmatched",0,!0),p("",!1),o(!1),s(!1);const H=document.getElementById("reconcile-recent");H&&(H.style.display="none");const F={Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||"")};try{const[A,y]=await Promise.all([fetch("/api/bank-recon/stats",{headers:F}),fetch("/api/bank-recon/sessions?limit=20",{headers:F})]);if(!A.ok)throw new Error("http "+A.status);const v=await A.json(),b=y.ok?await y.json():[];r(v||{}),l(b||[])}catch(A){console.warn("[reconcile] load failed",A),u()}}function M(H){if(!H||!H.length)return;const F="Bearer "+(localStorage.getItem("mrpilot_token")||"");let A=0;const y=H.length;Array.from(H).forEach(function(v){const b=new FormData;b.append("file",v,v.name);const L=new XMLHttpRequest;L.open("POST","/api/bank-recon/upload"),L.setRequestHeader("Authorization",F),L.onload=function(){A++;try{const C=JSON.parse(L.responseText);L.status===200&&C.tx_count!==void 0?showToast((t("bank-upload-ok")||"解析成功 · 共 {n} 条流水").replace("{n}",C.tx_count),"success"):showToast(v.name+" "+(t("upload-failed")||"上传失败"),"error")}catch{showToast(v.name+" "+(t("upload-failed")||"上传失败"),"error")}A===y&&setTimeout(k,600)},L.onerror=function(){A++,showToast(v.name+" "+(t("upload-failed")||"上传失败"),"error"),A===y&&setTimeout(k,600)},L.send(b)}),showToast((t("bank-queue-status-uploading")||"上传中")+"…","info")}function B(){if(window.__reconcileBound)return;window.__reconcileBound=!0;const H=document.getElementById("reconcile-bank-file-input");H&&H.addEventListener("change",function(){M(this.files),this.value=""}),document.addEventListener("click",F=>{if(F.target.closest("#btn-reconcile-upload-top")||F.target.closest("#btn-reconcile-upload-empty")){g();return}if(F.target.closest("#btn-reconcile-retry")){k();return}if(F.target.closest("#btn-reconcile-dev-seed")){q();return}})}const _=["468b50c1-5593-4fd6-990d-515ce8085563"];function E(){const H=document.getElementById("btn-reconcile-dev-seed");if(!H)return;const F=typeof _userInfo<"u"?_userInfo:null,A=F&&F.id&&_.indexOf(String(F.id))>=0;H.style.display=A?"":"none"}async function q(){try{const H=await fetch("/api/bank-recon/_dev/seed",{method:"POST",headers:{Authorization:"Bearer "+token}});if(!H.ok)throw new Error("seed:"+H.status);const F=await H.json(),A=(t("reconcile-dev-seed-ok")||"").replace("{n}",F.tx_count||0);showToast(A,"success"),typeof window.navigateTo=="function"?window.navigateTo("automation"):location.hash="#/automation",setTimeout(()=>{const y=document.querySelector('[data-auto-tab="bank"]');y&&y.click(),F.session_id&&typeof window._openBankSession=="function"&&window._openBankSession(F.session_id)},300)}catch(H){console.warn("[reconcile] dev seed failed",H),showToast(t("reconcile-dev-seed-fail")||"Seed failed","error")}}window.loadReconcilePage=async function(){B(),E(),typeof window._bankReconV2Init=="function"&&window._bankReconV2Init();try{await k()}catch{}},window._rerenderReconcile=function(){typeof currentRoute=="string"&&currentRoute==="reconcile"&&k().catch(()=>{})},typeof window.subscribeI18n=="function"&&window.subscribeI18n("reconcile",window._rerenderReconcile)})();(function(){const e=document.getElementById("assign-clients-modal");if(!(!e||e.dataset.wbInjected==="1")){e.innerHTML=`
    <div class="modal" style="max-width:480px">
        ...
        <div class="modal-foot">
    ...
    </div>`,e.dataset.wbInjected="1";try{const n=window._currentLang||localStorage.getItem("mrpilot_lang")||"th",a=window.I18N;a&&a[n]&&e.querySelectorAll("[data-i18n]").forEach(o=>{const s=o.getAttribute("data-i18n");a[n][s]&&(o.textContent=a[n][s])})}catch{}}})();(function(){let e={employeeId:null,employeeName:"",clients:[],selected:new Set,opened:!1};function n(){return document.getElementById("assign-clients-modal")}function a(){return document.getElementById("assign-clients-list")}function o(){return document.getElementById("assign-select-all")}function s(){return document.getElementById("assign-selected-count")}function p(){return document.getElementById("assign-modal-target")}function r(){const k=a();if(k){if(!e.clients.length){k.innerHTML='<div class="assign-empty">'+escapeHtml(t("assign-no-clients")||"暂无客户 · 请先到「客户管理」添加")+"</div>";return}k.innerHTML=e.clients.map(M=>{const B=String(M.id),_=e.selected.has(B)?"checked":"",E=escapeHtml(M.name||M.label||"#"+B),q=M.code?'<span class="assign-row-code">'+escapeHtml(M.code)+"</span>":"";return'<label class="assign-row"><input type="checkbox" data-cid="'+escapeHtml(B)+'" '+_+'><span class="assign-row-name">'+E+"</span>"+q+"</label>"}).join(""),f()}}function f(){const k=s();if(k){const B=t("assign-selected-count")||"已选 {n} / {total}";k.textContent=B.replace("{n}",e.selected.size).replace("{total}",e.clients.length)}const M=o();M&&(M.checked=e.clients.length>0&&e.selected.size===e.clients.length)}function i(){const k=p();k&&(k.textContent=e.employeeName?" · "+e.employeeName:"")}async function c(k,M){e.employeeId=k,e.employeeName=M||"",e.opened=!0,e.selected=new Set,e.clients=[],i();const B=a();B&&(B.innerHTML='<div class="assign-empty">'+escapeHtml(t("assign-loading")||"加载中...")+"</div>");const _=n();_&&(_.style.display="flex");try{const[E,q]=await Promise.all([apiGet("/api/clients?include_inactive=false"),apiGet("/api/team/employees/"+encodeURIComponent(k)+"/assignments")]);e.clients=E&&E.clients||[];const H=q&&q.client_ids||[];e.selected=new Set(H.map(String)),r()}catch(E){console.error("[assign-clients] load failed",E);const q=a();q&&(q.innerHTML='<div class="assign-empty">'+escapeHtml(t("assign-load-failed")||"加载失败 · 请重试")+"</div>")}}function l(){e.opened=!1;const k=n();k&&(k.style.display="none")}async function d(){if(!e.employeeId)return;const k=Array.from(e.selected).map(B=>parseInt(B,10)).filter(B=>!isNaN(B)),M=document.getElementById("assign-modal-save");M&&(M.disabled=!0);try{const B=await apiPost("/api/team/employees/"+encodeURIComponent(e.employeeId)+"/assignments",{client_ids:k});B&&B.ok!==!1?(showToast((t("assign-saved")||"已保存 {n} 个客户分配").replace("{n}",k.length),"success"),l(),typeof loadTeamList=="function"&&loadTeamList()):showToast(t("assign-save-failed")||"保存失败","error")}catch(B){console.error("[assign-clients] save failed",B),showToast(t("assign-save-failed")||"保存失败","error")}finally{M&&(M.disabled=!1)}}function u(){const k=n();if(!k||k.dataset.bound==="1")return;k.dataset.bound="1";const M=document.getElementById("assign-modal-close");M&&M.addEventListener("click",l);const B=document.getElementById("assign-modal-cancel");B&&B.addEventListener("click",l);const _=document.getElementById("assign-modal-save");_&&_.addEventListener("click",d),k.addEventListener("click",function(H){H.target===k&&l()});const E=o();E&&E.addEventListener("change",function(){E.checked?e.selected=new Set(e.clients.map(H=>String(H.id))):e.selected=new Set,r()});const q=a();q&&q.addEventListener("change",function(H){const F=H.target.closest('input[type="checkbox"][data-cid]');if(!F)return;const A=F.dataset.cid;F.checked?e.selected.add(A):e.selected.delete(A),f()})}function g(){e.opened&&(i(),r())}typeof window.subscribeI18n=="function"&&window.subscribeI18n("assign-clients-modal",g),window.openAssignClientsModal=function(k,M){u(),c(k,M)}})();(function(){const e={page:1,per_page:50,q:"",total:0,rows:[],loaded:!1};function n(l){if(!l)return"";try{return new Date(l).toLocaleString()}catch{return l}}function a(l){const d=document.getElementById("access-log-table");d&&(d.innerHTML='<div class="access-log-empty">'+escapeHtml(l)+"</div>");const u=document.getElementById("access-log-pager");u&&(u.innerHTML="")}function o(){const l=document.getElementById("access-log-table");if(!l)return;const d=e.rows||[];if(!d.length){a(t("set-access-log-empty"));return}const u=`
            <div class="access-log-row access-log-head">
                ...
                </div>`}).join("");l.innerHTML=u+g}function s(){const l=document.getElementById("access-log-pager");if(!l)return;const d=e.total||0;if(!d){l.innerHTML="";return}const u=e.page||1,g=e.per_page,k=Math.max(1,Math.ceil(d/g)),M=(t("set-access-log-pager-total")||"Total {n}").replace("{n}",d),B=(t("set-access-log-pager-page")||"Page {p} / {t}").replace("{p}",u).replace("{t}",k);l.innerHTML=`
            ...
            </div>`}async function p(l){const d=localStorage.getItem("mrpilot_token");if(d){e.page=l||1,a(t("set-access-log-loading"));try{const u="/api/me/access_log?page="+e.page+"&per_page="+e.per_page+"&q="+encodeURIComponent(e.q||""),g=await fetch(u,{headers:{Authorization:"Bearer "+d}});if(g.status===403){a(t("set-access-log-empty"));return}if(!g.ok)throw new Error("http_"+g.status);const k=await g.json();e.rows=k.logs||[],e.total=k.total||0,e.loaded=!0,o(),s()}catch{a(t("set-access-log-fail"))}}}async function r(){const l=localStorage.getItem("mrpilot_token");if(l)try{const d="/api/me/access_log.csv?q="+encodeURIComponent(e.q||""),u=await fetch(d,{headers:{Authorization:"Bearer "+l}});if(!u.ok){showToast(t("set-access-log-csv-fail")||"Export failed","error");return}const g=await u.blob(),k=document.createElement("a"),M=URL.createObjectURL(g);k.href=M,k.download="pearnly_access_log.csv",document.body.appendChild(k),k.click(),setTimeout(function(){URL.revokeObjectURL(M),k.remove()},100),showToast(t("set-access-log-csv-ok")||"Exported","success")}catch{showToast(t("set-access-log-csv-fail")||"Export failed","error")}}function f(){const l=document.querySelectorAll(".set-tab-owner-only"),d=!!(_userInfo&&(_userInfo.role==="owner"||_userInfo.is_super_admin));l.forEach(function(u){u.style.display=d?"":"none"})}document.addEventListener("click",function(l){if(l.target.closest('.settings-tab[data-tab="access-log"]')){setTimeout(function(){(!e.loaded||e.page!==1)&&p(1)},50);return}if(l.target.closest("#access-log-csv-btn")){l.preventDefault(),r();return}const g=l.target.closest(".access-log-pager-btn[data-access-log-page]");if(g&&!g.disabled){const k=parseInt(g.dataset.accessLogPage,10);p(k)}}),document.addEventListener("input",function(l){l.target&&l.target.id==="access-log-search"&&(clearTimeout(window.__accessLogSearchTimer),window.__accessLogSearchTimer=setTimeout(function(){e.q=(l.target.value||"").trim(),p(1)},350))});let i=0;const c=setInterval(function(){i++,_userInfo&&(f(),clearInterval(c)),i>60&&clearInterval(c)},500);typeof window.subscribeI18n=="function"&&window.subscribeI18n("me-access-log",function(){f(),e.loaded&&(o(),s())})})();(function(){const e=document.getElementById("notif-new-modal");if(!(!e||e.dataset.wbInjected==="1")){e.innerHTML=`
...
`,e.dataset.wbInjected="1";try{const n=window._currentLang||localStorage.getItem("mrpilot_lang")||"th",a=window.I18N;a&&a[n]&&(e.querySelectorAll("[data-i18n]").forEach(o=>{const s=o.getAttribute("data-i18n");a[n][s]&&(o.textContent=a[n][s])}),e.querySelectorAll("[data-i18n-placeholder]").forEach(o=>{const s=o.getAttribute("data-i18n-placeholder");a[n][s]&&(o.placeholder=a[n][s])}))}catch{}}})();(function(){const e=document.getElementById("archive-token-modal");if(!(!e||e.dataset.wbInjected==="1")){e.innerHTML=`
        ...
        `}async function l(){try{const y=await fetch("/api/settings/dup-check",{headers:{Authorization:"Bearer "+token}});if(!y.ok)return;const v=await y.json(),b=document.getElementById("pref-dup-check");b&&(b.checked=!!v.enabled)}catch(y){console.warn("load prefs failed",y)}}const d=document.getElementById("pref-dup-check");d&&!d.dataset.bound&&(d.dataset.bound="1",d.addEventListener("change",async y=>{const v=y.target.checked;try{(await fetch("/api/settings/dup-check",{method:"PUT",headers:{Authorization:"Bearer "+token,"Content-Type":"application/json"},body:JSON.stringify({enabled:v})})).ok?showToast(v?t("pref-dup-check-on-toast"):t("pref-dup-check-off-toast"),"success"):(y.target.checked=!v,showToast(t("pref-save-failed"),"error"))}catch{y.target.checked=!v,showToast(t("pref-save-failed"),"error")}}));async function u(){const y=!!(_userInfo&&_userInfo.can_customize_archive);o=!y;const v=document.getElementById("archive-upgrade-banner");v&&(v.style.display=y?"none":"");const b=document.getElementById("archive-plus-badge");b&&(b.style.display=y?"none":"");try{const L=await fetch("/api/archive/settings",{headers:{Authorization:"Bearer "+token}});if(!L.ok)throw new Error("load failed");const C=await L.json();e=Array.isArray(C.name_template)?C.name_template:[],n=C.folder_strategy||"by_month_seller"}catch(L){console.error("load archive settings failed",L),showToast(t("archive-load-failed"),"error");return}g(),k(),M(),B()}function g(){const y=document.getElementById("archive-rule-canvas");if(y){if(e.length===0){y.innerHTML=`<div class="archive-empty">${escapeHtml(t("archive-rule-empty"))}</div>`;return}y.innerHTML=e.map((v,b)=>{const L=p[v.type]||{label:v.type},C=s[v.type]||"",P=v.type==="sep"?`"${escapeHtml(v.val||"_")}"`:escapeHtml(t(L.label));return`
            ...
            `}).join("")}}function k(){const y=document.getElementById("archive-field-palette");if(!y)return;const v=["date","seller","category","amount","invoice","buyer","sep"];y.innerHTML=v.map(b=>{const L=p[b],C=s[b]||"";return`
                <button class="archive-palette-btn ${b}" data-add-field="${b}" ${o?"disabled":""}>
                    <span class="token-icon">${C}</span>
                    <span>${escapeHtml(t(L.label))}</span>
                </button>
            `}).join("")}function M(){document.querySelectorAll('input[name="folder-strategy"]').forEach(y=>{y.checked=y.value===n,y.disabled=o})}async function B(){const y=document.getElementById("archive-preview-name"),v=document.getElementById("archive-preview-hint");if(v&&(v.textContent=t("archive-preview-hint",{category:r()})),!!y){if(e.length===0){y.textContent="-";return}try{const L=await(await fetch("/api/archive/rename-preview",{method:"POST",headers:{Authorization:"Bearer "+token,"Content-Type":"application/json"},body:JSON.stringify({merged_fields:i().merged_fields,name_template:e})})).json();y.textContent=(L.name||"-")+".pdf"}catch{y.textContent="("+t("archive-preview-error")+")"}}}window._rerenderArchiveAll=function(){const y=document.getElementById("archive-rule-modal");!y||y.style.display==="none"||(g(),k(),B())};let _=-1;document.addEventListener("dragstart",y=>{const v=y.target.closest(".archive-token");!v||o||(_=parseInt(v.dataset.tokenIdx,10),v.classList.add("dragging"),y.dataTransfer.effectAllowed="move")}),document.addEventListener("dragend",y=>{document.querySelectorAll(".archive-token").forEach(v=>v.classList.remove("dragging","drop-target")),_=-1}),document.addEventListener("dragover",y=>{const v=y.target.closest(".archive-token");v&&(y.preventDefault(),y.dataTransfer.dropEffect="move",document.querySelectorAll(".archive-token").forEach(b=>b.classList.remove("drop-target")),v.classList.add("drop-target"))}),document.addEventListener("drop",y=>{const v=y.target.closest(".archive-token");if(!v||_<0||o)return;y.preventDefault();const b=parseInt(v.dataset.tokenIdx,10);if(b===_)return;const L=e.splice(_,1)[0];e.splice(b,0,L),_=-1,g(),B()}),document.addEventListener("click",y=>{if(y.target.closest("#btn-open-archive-rule")||y.target.closest("#btn-open-archive-rule-from-settings")){const C=document.getElementById("archive-rule-modal");C&&(C.style.display="",u());return}if(y.target.closest("#archive-rule-modal-close")||y.target.id==="archive-rule-modal"){const C=document.getElementById("archive-rule-modal");C&&(C.style.display="none");return}const v=y.target.closest(".settings-nav-item");if(v){switchSettingsTab(v.dataset.settingsTab);return}if(o&&y.target.closest(".archive-token, [data-add-field], #btn-archive-save, #btn-archive-reset")){showToast(t("feature-contact-us"),"info");return}const b=y.target.closest("[data-add-field]");if(b){const C=b.dataset.addField,P=p[C],I={type:C,...P.defaultCfg};e.push(I),g(),B();return}const L=y.target.closest(".archive-token");if(L&&!o){E(parseInt(L.dataset.tokenIdx,10));return}if(y.target.closest("#btn-archive-save"))return F();if(y.target.closest("#btn-archive-reset"))return A();(y.target.closest("#archive-token-close")||y.target.id==="archive-token-modal")&&(document.getElementById("archive-token-modal").style.display="none"),y.target.closest("#btn-archive-token-ok")&&q(),y.target.closest("#btn-archive-token-delete")&&H()}),document.addEventListener("change",y=>{y.target.name==="folder-strategy"&&(n=y.target.value)});function E(y){a=y;const v=e[y];if(!v)return;const b=document.getElementById("archive-token-body");let L="";v.type==="date"?L=`
                <div class="form-group">
        ...
        </div>`,l=document.createElement("div");l.innerHTML=c,document.body.appendChild(l.firstElementChild),document.getElementById("report-modal-close-x").addEventListener("click",a),document.getElementById("report-modal-cancel").addEventListener("click",a),document.getElementById("report-modal").addEventListener("click",d=>{d.target.id==="report-modal"&&a()})}function a(){const c=document.getElementById("report-modal");c&&(c.style.display="none"),o=null}let o=null;async function s(c,l){const d=c+":"+(l||"");if(e[d])return e[d];let u;try{const g=localStorage.getItem("mrpilot_token"),k=await fetch(`/api/reports/templates?lang=${encodeURIComponent(c)}`,{headers:{Authorization:"Bearer "+g}});if(!k.ok)throw new Error("templates fetch failed");u=(await k.json()).templates||[]}catch(g){console.error("fetchTemplates fail",g),u=[{code:"input_vat",name:t("tpl-input-vat"),desc:t("tpl-input-vat-desc"),recommended:!0},{code:"standard",name:t("tpl-standard"),desc:t("tpl-standard-desc"),recommended:!1},{code:"print",name:t("tpl-print"),desc:t("tpl-print-desc"),recommended:!1}]}if(u=u.filter(g=>g.code!=="erp"),l==="history-batch"){const g=u.findIndex(M=>M.code==="standard"),k=g>=0?g+1:u.length;u.splice(k,0,{code:"sales_detail_th",name:t("export-tpl-sales-detail"),desc:t("export-tpl-sales-detail-desc"),recommended:!1,is_new:!0})}return e[d]=u,u}function p(c){const l=document.getElementById("report-tpl-list"),d=c.map((g,k)=>`
...
`,e.dataset.wbInjected="1";try{const n=window._currentLang||localStorage.getItem("mrpilot_lang")||"th",a=window.I18N;a&&a[n]&&(e.querySelectorAll("[data-i18n]").forEach(o=>{const s=o.getAttribute("data-i18n");a[n][s]&&(o.textContent=a[n][s])}),e.querySelectorAll("[data-i18n-placeholder]").forEach(o=>{const s=o.getAttribute("data-i18n-placeholder");a[n][s]&&(o.placeholder=a[n][s])}))}catch{}}})();(function(){let e=[],n=null,a="",o="seller";const s={page:0,pageSize:12,keyword:""},p=new Set;let r=[];const f={keyword:""};let i=null;function c(){return{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||"")}}async function l(h,D={}){const N=await fetch(h,{...D,headers:{"Content-Type":"application/json",...c(),...D.headers||{}}});if(!N.ok){const K=await N.json().catch(()=>({}));throw new Error(K.detail||"HTTP "+N.status)}return N.json()}async function d(){try{e=(await l("/api/clients")).clients||[],window._clientsCache=e}catch(h){console.error("loadClientsCache fail",h),e=[]}try{typeof window._refreshExcClientFilter=="function"&&window._refreshExcClientFilter()}catch{}try{typeof window._refreshClientSwitcher=="function"&&window._refreshClientSwitcher()}catch{}return e}function u(h){o=h==="buyer"?"buyer":"seller",document.querySelectorAll("[data-cust-tab]").forEach(K=>K.classList.toggle("active",K.dataset.custTab===o));const D=document.getElementById("cust-pane-seller"),N=document.getElementById("cust-pane-buyer");D&&D.classList.toggle("active",o==="seller"),N&&N.classList.toggle("active",o==="buyer")}function g(){const h=window._userInfo||{},D=String(h.role||"").toLowerCase(),N=String(h.tenant_role||"").toLowerCase();return h.is_super_admin===!0||h.is_owner===!0||D==="owner"||D==="admin"||N==="owner"||N==="admin"}function k(){window._workspaceClientsCache=r,typeof window.renderWorkspaceControl=="function"&&window.renderWorkspaceControl()}async function M(){try{const h=await l("/api/workspace/clients");r=h&&(h.clients||h.items)||[],window._workspaceClientsCache=r}catch(h){console.error("loadSellerCache fail",h),r=[]}return r}function B(){const h=f.keyword.trim().toLowerCase();return h?r.filter(D=>(D.name||"").toLowerCase().includes(h)||(D.tax_id||"").toLowerCase().includes(h)):r}function _(){const h=document.getElementById("seller-tbody");if(!h)return;const D=g(),N=document.getElementById("btn-seller-new");N&&(N.style.display=D?"":"none");const K=B(),Q=typeof window.getActiveWorkspaceClientId=="function"?window.getActiveWorkspaceClientId():null;if(!K.length){h.innerHTML=`<div class="cust-empty">${escapeHtml(t(f.keyword?"cust-no-match":"seller-empty"))}</div>`;return}h.innerHTML=K.map(le=>{const V=Q!=null&&Number(Q)===Number(le.id)?`<span class="cust-badge-current"><svg viewBox="0 0 14 14" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M2 7.5l3.2 3.2L12 4"/></svg>${escapeHtml(t("seller-current"))}</span>`:`<button class="cust-row-btn primary" data-saction="activate" data-wid="${le.id}">${escapeHtml(t("seller-set-current"))}</button>`,Z=D?`
            ...
            </div>`}).join("")}function E(h){i=h?h.id:null,document.getElementById("wsclient-modal-title").textContent=t(h?"wsclient-modal-edit":"wsclient-modal-new"),document.getElementById("wsclient-input-name").value=h&&h.name||"",document.getElementById("wsclient-input-tax").value=h&&h.tax_id||"",document.getElementById("wsclient-modal-archive").style.display=h?"":"none",document.getElementById("wsclient-modal-mask").style.display="flex",setTimeout(()=>document.getElementById("wsclient-input-name").focus(),50)}function q(){document.getElementById("wsclient-modal-mask").style.display="none",i=null}async function H(){const h=document.getElementById("wsclient-input-name").value.trim(),D=document.getElementById("wsclient-input-tax").value.trim();if(!h){showToast(t("client-msg-name-required"),"fail");return}try{i?(await l("/api/workspace/clients/"+i,{method:"PATCH",body:JSON.stringify({name:h,tax_id:D})}),showToast(t("client-msg-updated"),"success")):(await l("/api/workspace/clients",{method:"POST",body:JSON.stringify({name:h,tax_id:D||null})}),showToast(t("client-msg-created"),"success")),q(),await M(),_(),k()}catch(N){const K=N&&N.message?N.message:t("client-msg-save-fail");showToast(t("client-msg-save-fail")+" · "+K,"fail")}}async function F(){if(!i)return;const h=r.find(N=>Number(N.id)===Number(i));if(await showConfirm(t("wsclient-archive-confirm").replace("{name}",h?h.name:""),{danger:!0}))try{const N=i;await l("/api/workspace/clients/"+N,{method:"DELETE"}),showToast(t("wsclient-archived"),"success"),typeof window.getActiveWorkspaceClientId=="function"&&Number(window.getActiveWorkspaceClientId())===Number(N)&&typeof window.enterPersonalMode=="function"&&window.enterPersonalMode(),q(),await M(),_(),k()}catch{showToast(t("client-msg-save-fail"),"fail")}}function A(){const h=s.keyword.trim().toLowerCase();return h?e.filter(D=>(D.name||"").toLowerCase().includes(h)||(D.short_name||"").toLowerCase().includes(h)||(D.tax_id||"").toLowerCase().includes(h)):e}function y(){const h=A(),D=s.pageSize,N=Math.max(0,Math.ceil(h.length/D)-1);s.page>N&&(s.page=N);const K=s.page*D;return{all:h,items:h.slice(K,K+D),start:K,ps:D,total:h.length,maxPage:N}}function v(){const h=document.getElementById("buyer-tbody");if(!h)return;const{items:D,start:N,ps:K,total:Q,maxPage:le}=y();Q?h.innerHTML=D.map(ee=>{const ne=p.has(ee.id);return`<div class="cust-row buyer-grid${ne?" selected":""}" data-cid="${ee.id}">
...
`,e.dataset.wbInjected="1";try{const n=window._currentLang||localStorage.getItem("mrpilot_lang")||"th",a=window.I18N;a&&a[n]&&(e.querySelectorAll("[data-i18n]").forEach(o=>{const s=o.getAttribute("data-i18n");a[n][s]&&(o.textContent=a[n][s])}),e.querySelectorAll("[data-i18n-placeholder]").forEach(o=>{const s=o.getAttribute("data-i18n-placeholder");a[n][s]&&(o.placeholder=a[n][s])}))}catch{}}})();(function(){let e={statsCache:null,listCache:[],currentRule:null,currentClient:"",currentStatus:"pending",loading:!1,selectedIds:new Set,offset:0,pageSize:50,total:0,loadFailed:!1,listScrollY:0};function n(T,x){let h=t(T)||T;if(x)for(const D in x)h=h.replace(new RegExp("\\{"+D+"\\}","g"),String(x[D]));return h}async function a(){try{const T=e.currentClient||"",x="/api/exceptions/stats?status=pending"+(T?"&client_id="+encodeURIComponent(T):""),h=await fetch(x,{headers:{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||"")}});if(!h.ok)return;const D=await h.json(),N=document.getElementById("nav-exc-badge");if(!N)return;const K=parseInt(D.pending||0,10);K>0?(N.textContent=K>99?"99+":String(K),N.style.display=""):N.style.display="none"}catch{}}function o(T){return T==="high"?`<svg viewBox="0 0 14 14" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
            ...
            </button>`}x.innerHTML=K,x.querySelectorAll(".exc-chip").forEach(Q=>{Q.addEventListener("click",()=>{const le=Q.dataset.rule||null;e.currentRule=le,k()})})}function c(T){const x=document.getElementById("exc-list");if(!x)return;if(!T||T.length===0){x.innerHTML=`<div class="exc-empty">
                ${s()}
        ...
        `;const le=T.severity||"medium",ie=t("exc-rule-"+T.rule_code)||T.rule_code,V=b(T.rule_code,T.detail||{}),Z=y(_.history),ee=_.history===null,ne=_.history&&_.history._err,oe=new Set;T.rule_code==="math_mismatch"?(oe.add("subtotal"),oe.add("vat"),oe.add("total_amount")):T.rule_code==="tax_id_format_invalid"?oe.add("seller_tax"):T.rule_code==="amount_missing"&&(oe.add("total_amount"),oe.add("invoice_number"));const ue=!!_.editing,w=_.editFields||{},S=(ae,pe,fe)=>{if(ee)return`<div class="exc-field-row"><label>${escapeHtml(t(pe))}</label><span class="val empty">…</span></div>`;const me=ue?w[ae]!==void 0?w[ae]:Z[ae]!==void 0&&Z[ae]!==null?Z[ae]:"":Z[ae],ge=oe.has(ae)?"flagged":"";if(ue){const Fe=fe?"number":"text",Se=fe?' step="0.01" inputmode="decimal"':"",Me=me==null?"":String(me).replace(/"/g,"&quot;");return`<div class="exc-field-row ${ge} editing">
        ...
        `;const z=document.getElementById("exc-fld-edit");z&&z.addEventListener("click",()=>{_.editing=!0,_.editFields={...y(_.history)},L()});const m=document.getElementById("exc-fld-cancel");m&&m.addEventListener("click",()=>{_.editing=!1,_.editFields=null,L()});const R=document.getElementById("exc-fld-save");R&&R.addEventListener("click",()=>C()),document.querySelectorAll(".exc-field-input").forEach(ae=>{ae.addEventListener("input",()=>{_.editFields||(_.editFields={}),_.editFields[ae.dataset.editKey]=ae.value})});const J=document.getElementById("exc-pdf-retry");J&&_.openExcId&&J.addEventListener("click",()=>{_.excRow&&q(_.excRow.history_id,_.openExcId)});const X=T.status==="pending",de=!!(T.seller_name&&T.seller_name.trim()),se=document.getElementById("exc-btn-resolve"),ce=document.getElementById("exc-btn-ignore");se.disabled=!X,ce.disabled=!X||!de,ce.title=de?t("exc-ignore-hint"):t("exc-ignore-no-seller")}async function C(){if(!_.openExcId||!_.history||!_.history.pages||_.loading)return;_.loading=!0;const T=showToast(t("exc-fld-saving"),"loading",0);try{const x=JSON.parse(JSON.stringify(_.history.pages||[]));let h=x.findIndex(ie=>!ie.is_duplicate&&!ie.is_copy);h<0&&(h=0),x[h]||(x[h]={fields:{}});const D=x[h].fields||{},N=_.editFields||{},K=new Set(["subtotal","vat","total_amount"]),Q={...D};for(const ie in N){let V=N[ie];if((V===""||V===void 0)&&(V=null),K.has(ie)&&V!==null){const Z=parseFloat(V);V=isNaN(Z)?null:Z}Q[ie]=V}x[h].fields=Q;const le=await fetch("/api/history/"+encodeURIComponent(_.history.id),{method:"PUT",headers:{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||""),"Content-Type":"application/json"},body:JSON.stringify({pages:x})});if(!le.ok)throw new Error("http "+le.status);T(),showToast(t("exc-fld-save-ok"),"success"),F(),await u(),await k(),a()}catch(x){T(),console.warn("save fields fail",x),showToast(t("exc-fld-save-fail"),"error")}finally{_.loading=!1}}async function P(){if(!(!_.openExcId||_.loading)){_.loading=!0;try{const T=await fetch("/api/exceptions/"+_.openExcId+"/resolve",{method:"POST",headers:{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||"")}});if(!T.ok)throw new Error("http "+T.status);showToast(t("exc-toast-resolved"),"success"),F(),await u(),await k(),a()}catch(T){console.warn("resolve fail",T),showToast(t("exc-toast-action-fail"),"error")}finally{_.loading=!1}}}async function I(){if(!(!_.openExcId||_.loading)){_.loading=!0;try{const T=await fetch("/api/exceptions/"+_.openExcId+"/ignore",{method:"POST",headers:{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||"")}});if(!T.ok)throw new Error("http "+T.status);showToast(t("exc-toast-ignored"),"success"),F(),await u(),await k(),a()}catch(T){console.warn("ignore fail",T),showToast(t("exc-toast-action-fail"),"error")}finally{_.loading=!1}}}let j=!1;async function Y(){if(j)return;const T=Array.from(e.selectedIds);if(T.length===0||!await showConfirm(n("exc-batch-confirm-resolve",{n:T.length})))return;j=!0;const h=showToast(n("exc-batch-count",{n:T.length})+" …","loading",0);try{const D=await fetch("/api/exceptions/batch",{method:"POST",headers:{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||""),"Content-Type":"application/json"},body:JSON.stringify({ids:T,action:"resolve"})});if(!D.ok)throw new Error("http "+D.status);const N=await D.json();h(),showToast(n("exc-toast-batch-resolved",{n:N.processed||0}),"success"),e.selectedIds.clear(),await u(),await k(),a()}catch(D){h(),console.warn("batch resolve fail",D),showToast(t("exc-toast-batch-fail"),"error")}finally{j=!1}}async function G(){if(j)return;const T=Array.from(e.selectedIds);if(T.length===0||!await showConfirm(n("exc-batch-confirm-ignore",{n:T.length}),{danger:!1}))return;j=!0;const h=showToast(n("exc-batch-count",{n:T.length})+" …","loading",0);try{const D=await fetch("/api/exceptions/batch",{method:"POST",headers:{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||""),"Content-Type":"application/json"},body:JSON.stringify({ids:T,action:"ignore"})});if(!D.ok)throw new Error("http "+D.status);const N=await D.json();h(),showToast(n("exc-toast-batch-ignored",{n:N.processed||0,wl:N.whitelist_added||0}),"success"),e.selectedIds.clear(),await u(),await k(),a()}catch(D){h(),console.warn("batch ignore fail",D),showToast(t("exc-toast-batch-fail"),"error")}finally{j=!1}}function W(){e.selectedIds.clear(),c(e.listCache)}document.addEventListener("click",T=>{T.target.closest("#exc-drawer-close")&&F(),T.target.closest("#exc-drawer-mask")&&F(),T.target.closest("#exc-btn-resolve")&&P(),T.target.closest("#exc-btn-ignore")&&I(),T.target.closest("#exc-batch-resolve")&&Y(),T.target.closest("#exc-batch-ignore")&&G(),T.target.closest("#exc-batch-clear")&&W(),T.target.closest("#exc-loadmore")&&M()}),document.addEventListener("keydown",T=>{T.key==="Escape"&&_.openExcId&&F()}),document.addEventListener("click",T=>{T.target.closest("#btn-exc-refresh")&&(typeof window.loadExceptionsPage=="function"&&window.loadExceptionsPage(),a())}),document.addEventListener("change",T=>{if(!T.target.closest("#exc-client-filter"))return;const x=T.target;e.currentClient=x.value||"",e.currentRule=null,e.selectedIds.clear(),e.listCache=[],typeof window.loadExceptionsPage=="function"&&window.loadExceptionsPage(),a()}),document.addEventListener("click",T=>{const x=T.target.closest("#exc-status-tabs .exc-status-tab");if(!x)return;const h=x.dataset.status||"pending";h!==e.currentStatus&&(e.currentStatus=h,e.currentRule=null,e.selectedIds.clear(),e.listCache=[],typeof window.loadExceptionsPage=="function"&&window.loadExceptionsPage())}),window.addEventListener("online",()=>{e.loadFailed&&document.getElementById("page-exceptions")?.classList.contains("show")&&window.loadExceptionsPage&&window.loadExceptionsPage()}),setTimeout(a,1500),setInterval(a,6e4);function te(T){if(!T)return"—";try{const x=new Date(T),h=D=>String(D).padStart(2,"0");return`${x.getFullYear()}-${h(x.getMonth()+1)}-${h(x.getDate())} ${h(x.getHours())}:${h(x.getMinutes())}`}catch{return T.slice(0,16).replace("T"," ")}}async function re(){const T=document.getElementById("learned-list");if(T){T.innerHTML=`<div class="learned-empty">${escapeHtml(t("set-learned-loading"))}</div>`;try{const x=await fetch("/api/exception-whitelist",{headers:{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||"")}});if(!x.ok)throw new Error("http "+x.status);const D=(await x.json()).items||[];if(D.length===0){T.innerHTML=`<div class="learned-empty">${escapeHtml(t("set-learned-empty"))}</div>`;return}const N=`<svg viewBox="0 0 14 14" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round">
            ...
            <div class="erp-exc-rows">
                <div class="erp-exc-row erp-exc-row-head">
                    <span class="ex-cb"><input type="checkbox" class="erp-exc-cb-all" id="erp-exc-cb-all" ${E?"checked":""}></span>
            ...
            <div class="erp-exc-foot">${F}</div>`;const A=document.getElementById("erp-exc-search");if(A){if(u.focusSearch){A.focus();try{A.setSelectionRange(u.searchCaret,u.searchCaret)}catch{}}A.addEventListener("input",()=>{u.q=A.value,u.focusSearch=!0,u.searchCaret=A.selectionStart||A.value.length,clearTimeout(n),n=setTimeout(()=>i(!1),350)}),A.addEventListener("blur",()=>{u.focusSearch=!1})}d.querySelectorAll(".erp-exc-chip").forEach(b=>{b.addEventListener("click",()=>{u.cat=b.dataset.erpexcCat||"",i(!1)})}),d.querySelectorAll("[data-erpexc-retry]").forEach(b=>{b.addEventListener("click",L=>{L.stopPropagation(),r(b.dataset.erpexcRetry,b)})}),d.querySelectorAll(".erp-exc-cb").forEach(b=>{b.addEventListener("change",()=>{const L=b.dataset.erpexcCb;b.checked?u.selected.add(L):u.selected.delete(L);const C=document.getElementById("erp-exc-cb-all");C&&(C.checked=_.length>0&&_.every(P=>u.selected.has(P.id))),s()})});const y=document.getElementById("erp-exc-cb-all");y&&y.addEventListener("change",()=>{_.forEach(b=>{y.checked?u.selected.add(b.id):u.selected.delete(b.id)}),d.querySelectorAll(".erp-exc-cb").forEach(b=>{b.checked=y.checked}),s()}),d.querySelectorAll("[data-erpexc-batch]").forEach(b=>{b.addEventListener("click",()=>f(b.dataset.erpexcBatch))});const v=document.getElementById("erp-exc-more");v&&v.addEventListener("click",()=>i(!0)),d.querySelectorAll(".erp-exc-row:not(.erp-exc-row-head)").forEach(b=>{b.addEventListener("click",L=>{L.target.closest("input,button")||typeof window._erpExcOpenEdit=="function"&&window._erpExcOpenEdit(b.dataset.erpexcId)})})}async function r(d,u){if(d){u&&(u.disabled=!0,u.textContent=t("erp-exc-retrying"));try{const g=await fetch("/api/erp/logs/"+encodeURIComponent(d)+"/retry",{method:"POST",headers:{Authorization:"Bearer "+a()}}),k=await g.json().catch(()=>({}));showToast(g.ok&&k.ok?t("erp-exc-retry-ok"):t("erp-exc-retry-fail"),g.ok&&k.ok?"success":"error")}catch{showToast(t("erp-exc-retry-fail"),"error")}if(e.selected.delete(d),i(!1),typeof window.refreshExcBadge=="function")try{window.refreshExcBadge()}catch{}}}async function f(d){const u=Array.from(e.selected);if(d==="clear"){e.selected.clear(),p();return}if(u.length!==0){if(d==="delete"){if(!await showConfirm(t("erp-exc-batch-delete-confirm",{n:u.length}),{danger:!0}))return;try{const k=await fetch("/api/erp/logs/batch-delete",{method:"POST",headers:{Authorization:"Bearer "+a(),"Content-Type":"application/json"},body:JSON.stringify({log_ids:u.slice(0,200)})}),M=await k.json().catch(()=>({}));showToast(k.ok?t("erp-exc-batch-delete-ok",{n:M.deleted||0}):t("erp-exc-retry-fail"),k.ok?"success":"error")}catch{showToast(t("erp-exc-retry-fail"),"error")}}else if(d==="retry")try{const g=await fetch("/api/erp/logs/batch-retry",{method:"POST",headers:{Authorization:"Bearer "+a(),"Content-Type":"application/json"},body:JSON.stringify({log_ids:u.slice(0,50)})}),k=await g.json().catch(()=>({}));showToast(g.ok?t("erp-exc-batch-retry-ok",{ok:k.succeeded||0,fail:(k.failed||0)+(k.skipped||0)}):t("erp-exc-retry-fail"),g.ok?"success":"error")}catch{showToast(t("erp-exc-retry-fail"),"error")}if(e.selected.clear(),i(!1),typeof window.refreshExcBadge=="function")try{window.refreshExcBadge()}catch{}}}async function i(d){const u=document.getElementById("erp-exc-block");if(!(!u||e.loading)){e.loading=!0;try{const g=new URLSearchParams;e.q&&g.set("q",e.q),e.cat&&g.set("category",e.cat),g.set("limit",String(e.pageSize)),g.set("offset",String(d?e.items.length:0));const k=await fetch("/api/erp/exceptions?"+g.toString(),{headers:{Authorization:"Bearer "+a()}});if(!k.ok){d||(u.hidden=!0);return}const M=await k.json(),B=M.items||[];e.items=d?e.items.concat(B):B,e.total=M.total||0,e.categories=M.categories||{},p()}catch{d||(u.hidden=!0)}finally{e.loading=!1}}}let c={};function l(){const d=document.getElementById("erp-exc-modal");d&&d.remove()}window._erpExcOpenEdit=function(d){const u=(e.items||[]).find(H=>String(H.id)===String(d));if(!u)return;const g=!!u.history_client_id&&u.category==="customer_mismatch",k=u.category==="product_mismatch"&&!!u.history_id&&!!u.endpoint_id,M=o(u),B=u.state==="needs_action"?"needs":u.state==="retrying"?"retry":"fail",_=(H,F)=>`<div class="erp-exc-m-row"><span class="erp-exc-m-k">${escapeHtml(H)}</span><span class="erp-exc-m-v">${escapeHtml(F||"—")}</span></div>`;let E="";if(g)E=`
                ...
                </div>`;else{const H="erp-exc-edit-hint-"+(u.category||"other");let F=t(H);(!F||F===H)&&(F=M),E=`<div class="erp-exc-m-hint">${escapeHtml(F)}</div>`}const q=document.createElement("div");if(q.id="erp-exc-modal",q.className="erp-exc-modal-overlay",q.innerHTML=`
            <div class="erp-exc-modal" role="dialog" aria-modal="true">
                ...
                <div class="erp-exc-m-foot">
                    ...
                    </div>`).join(""),F.querySelectorAll(".erp-exc-m-prod-sel").forEach(P=>{P.addEventListener("change",()=>{const I=P.dataset.item,j=P.options[P.selectedIndex];P.value?A[I]={code:P.value,name:j&&j.dataset.pname||""}:delete A[I],H&&(H.disabled=Object.keys(A).length===0)})})};(async()=>{try{const P=await(await fetch("/api/history/"+encodeURIComponent(u.history_id),{headers:{Authorization:"Bearer "+a()}})).json().catch(()=>({})),I=P&&P.pages||[],j=[],Y={};(Array.isArray(I)?I:[]).forEach(te=>{const re=te&&te.fields&&te.fields.items||[];(Array.isArray(re)?re:[]).forEach(T=>{const x=(T&&(T.name||T.description)||"").trim();x&&!Y[x]&&(Y[x]=1,j.push(x))})});const G=await fetch("/api/erp/endpoints/"+encodeURIComponent(u.endpoint_id)+"/products",{headers:{Authorization:"Bearer "+a()}}),W=await G.json().catch(()=>({}));if(!G.ok||!W.ok){F.innerHTML=`<div class="erp-exc-m-empty">${escapeHtml(t("erp-exc-edit-prod-fail"))}</div>`;return}y=W.products||[],b(j)}catch{F.innerHTML=`<div class="erp-exc-m-empty">${escapeHtml(t("erp-exc-edit-prod-fail"))}</div>`}})(),H&&H.addEventListener("click",async()=>{const C=Object.entries(A);if(C.length){H.disabled=!0,H.textContent=t("erp-exc-retrying");try{for(const[P,I]of C)if(!(await fetch("/api/erp/mappings/products",{method:"POST",headers:{Authorization:"Bearer "+a(),"Content-Type":"application/json"},body:JSON.stringify({erp_type:u.endpoint_adapter,item_name:P,erp_code:I.code,erp_name:I.name})})).ok){showToast(t("erp-exc-retry-fail"),"error"),H.disabled=!1,H.textContent=t("erp-exc-edit-bind-prod-retry");return}showToast(t("erp-exc-edit-prod-bound-ok"),"success"),l(),await r(u.id,null)}catch{showToast(t("erp-exc-retry-fail"),"error"),H.disabled=!1,H.textContent=t("erp-exc-edit-bind-prod-retry")}}})}},window._rerenderErpExceptions=p,window.loadErpExceptions=i,window._erpExcState=e})();(function(){function e(d){try{if(location.search.indexOf("test_center=1")>=0||localStorage.getItem("pearnly_test_mode")==="1"||d&&d.id&&String(d.id)==="468b50c1-5593-4fd6-990d-515ce8085563")return!0}catch{}return!1}window.applyRoleVisibility=function(){var u=window._userInfo,g=!1,k=!0,M=!1,B=!1;u&&(g=typeof canManageTeam=="function"?canManageTeam(u):!!(u.role==="owner"||u.is_super_admin),k=typeof shouldHideMoney=="function"?shouldHideMoney(u):u.role==="member"&&!u.is_super_admin,M=typeof isSuperAdmin=="function"?isSuperAdmin(u):!!u.is_super_admin,B=e(u)),document.querySelectorAll("[data-show-if-team]").forEach(function(E){E.style.display=g?"":"none"}),document.querySelectorAll("[data-show-if-money]").forEach(function(E){E.style.display=k?"none":""}),document.querySelectorAll("[data-show-if-admin]").forEach(function(E){E.style.display=M?"":"none"}),document.querySelectorAll("[data-show-if-test]").forEach(function(E){E.style.display=B?"":"none"});var _=M||B;document.querySelectorAll("[data-show-if-special]").forEach(function(E){E.style.display=_?"":"none"})},window.renderAvatarMenu=function(u){if(u){var g=document.getElementById("avatar-btn"),k=document.getElementById("avatar-popup-name"),M=document.getElementById("avatar-popup-email");if(!(!g||!k||!M)){var B=(u.username||"").trim(),_=B.split("@")[0]||B||"—",E=(B.charAt(0)||"?").toUpperCase(),q=(u.avatar_url||"").trim();if(q){var H=q.replace(/"/g,"&quot;"),F=E.replace(/'/g,"\\'");g.innerHTML='<img src="'+H+'" alt="'+E+`" referrerpolicy="no-referrer" onerror="this.parentNode.textContent='`+F+`'">`}else g.textContent=E;k.textContent=_,M.textContent=B||"—",g.setAttribute("title",B||"")}}};function n(){var d=document.getElementById("avatar-wrap"),u=document.getElementById("avatar-btn"),g=document.getElementById("avatar-popup");if(!d||!u||!g)return;function k(){g.classList.remove("show"),u.setAttribute("aria-expanded","false")}function M(){g.classList.add("show"),u.setAttribute("aria-expanded","true")}u.addEventListener("click",function(B){B.stopPropagation(),g.classList.contains("show")?k():M()}),document.addEventListener("click",function(B){g.classList.contains("show")&&!d.contains(B.target)&&k()}),g.addEventListener("click",function(B){var _=B.target.closest(".avatar-popup-item");if(_){var E=_.dataset.action;switch(k(),E){case"settings":typeof openSettingsModal=="function"?openSettingsModal():typeof routeTo=="function"&&routeTo("settings");break;case"team":typeof openSettingsModal=="function"?openSettingsModal():typeof routeTo=="function"&&routeTo("settings"),setTimeout(function(){typeof switchSettingsTab=="function"&&switchSettingsTab("team")},50);break;case"billing":typeof openSettingsModal=="function"?openSettingsModal():typeof routeTo=="function"&&routeTo("settings"),setTimeout(function(){typeof switchSettingsTab=="function"&&switchSettingsTab("plan")},50);break;case"shortcuts":if(typeof showToast=="function"){var q=typeof t=="function"?t("feature-coming-soon"):"即将上线";showToast(q||"即将上线","info")}break;case"admin":window.location.href="/admin/cost";break;case"test-center":typeof routeTo=="function"&&routeTo("test-center");break;case"help":var H=document.getElementById("help-modal");H&&(H.style.display="flex");break;case"logout":try{localStorage.removeItem("mrpilot_token")}catch{}try{localStorage.removeItem("mrpilot_user")}catch{}window.location.href="/";break}}}),window._closeAvatarPopup=k}function a(){return[].slice.call(document.querySelectorAll(".cmdk-item")).filter(function(d){return d.style.display!=="none"})}function o(d){var u=a();u.forEach(function(g){g.classList.remove("focus")}),u[d]&&(u[d].classList.add("focus"),u[d].scrollIntoView({block:"nearest"}))}function s(d){var u=a();if(u.length){var g=u.findIndex(function(M){return M.classList.contains("focus")});g<0&&(g=0);var k=(g+d+u.length)%u.length;o(k)}}function p(d){d=(d||"").toLowerCase().trim();var u=0,g=window._userInfo,k=typeof isSuperAdmin=="function"?isSuperAdmin(g):!!(g&&g.is_super_admin),M=e(g);document.querySelectorAll(".cmdk-item").forEach(function(_){if(_.dataset.showIfAdmin==="1"&&!k){_.style.display="none";return}if(_.dataset.showIfTest==="1"&&!M){_.style.display="none";return}var E=(_.dataset.cmdkText||_.textContent||"").toLowerCase(),q=!d||E.indexOf(d)>=0;_.style.display=q?"":"none",_.classList.remove("focus"),q&&u++}),document.querySelectorAll("[data-cmdk-section]").forEach(function(_){for(var E=_.nextElementSibling,q=!1;E&&!E.hasAttribute("data-cmdk-section");){if(E.classList&&E.classList.contains("cmdk-item")&&E.style.display!=="none"){q=!0;break}E=E.nextElementSibling}_.style.display=q?"":"none"});var B=document.getElementById("cmdk-empty");B&&(B.style.display=u===0?"flex":"none"),o(0)}window.openCmdk=function(){var u=document.getElementById("cmdk-mask");u&&(typeof window._closeAvatarPopup=="function"&&window._closeAvatarPopup(),u.classList.add("show"),typeof window.applyRoleVisibility=="function"&&window.applyRoleVisibility(),setTimeout(function(){var g=document.getElementById("cmdk-input");g&&(g.value="",p(""),g.focus(),o(0))},50))},window.closeCmdk=function(){var u=document.getElementById("cmdk-mask");u&&u.classList.remove("show")};function r(d){if(d){if(d.classList.contains("cmdk-item-locked")){if(typeof showToast=="function"){var u=typeof t=="function"?t("feature-coming-soon"):"即将上线";showToast(u||"即将上线","info")}return}var g=d.dataset.cmdkRoute,k=d.dataset.cmdkAction;if(window.closeCmdk(),g){typeof routeTo=="function"&&routeTo(g);return}if(k){if(k==="open-admin"){window.location.href="/admin/cost";return}if(k.indexOf("lang-")===0){var M=k.slice(5);typeof applyLang=="function"&&applyLang(M)}}}}function f(){var d=document.getElementById("cmdk-mask"),u=document.getElementById("cmdk-input"),g=document.getElementById("cmdk-body");if(!(!d||!u||!g)){d.addEventListener("click",function(B){B.target===d&&window.closeCmdk()});var k=document.getElementById("cmdk-esc-btn");k&&k.addEventListener("click",function(){window.closeCmdk()}),u.addEventListener("input",function(B){p(B.target.value)}),u.addEventListener("keydown",function(B){B.key==="ArrowDown"?(B.preventDefault(),s(1)):B.key==="ArrowUp"?(B.preventDefault(),s(-1)):B.key==="Enter"?(B.preventDefault(),r(d.querySelector(".cmdk-item.focus"))):B.key==="Escape"&&(B.preventDefault(),window.closeCmdk())}),g.addEventListener("click",function(B){var _=B.target.closest(".cmdk-item");_&&r(_)}),g.addEventListener("mousemove",function(B){var _=B.target.closest(".cmdk-item");!_||_.style.display==="none"||_.classList.contains("cmdk-item-locked")||(a().forEach(function(E){E.classList.remove("focus")}),_.classList.add("focus"))});var M=document.getElementById("topbar-search");M&&(M.addEventListener("click",function(){window.openCmdk()}),M.addEventListener("keydown",function(B){(B.key==="Enter"||B.key===" ")&&(B.preventDefault(),window.openCmdk())}))}}document.addEventListener("keydown",function(d){if((d.metaKey||d.ctrlKey)&&(d.key==="k"||d.key==="K")){d.preventDefault(),window.openCmdk();return}if(d.key==="Escape"){var u=document.getElementById("cmdk-mask");if(u&&u.classList.contains("show")){window.closeCmdk();return}var g=document.getElementById("avatar-popup");g&&g.classList.contains("show")&&typeof window._closeAvatarPopup=="function"&&window._closeAvatarPopup()}});try{var i=(navigator.userAgent||"").toLowerCase(),c=i.indexOf("mac")>=0||i.indexOf("iphone")>=0||i.indexOf("ipad")>=0;c||document.body.classList.add("is-windows")}catch{}function l(){n(),f(),typeof window.subscribeI18n=="function"&&window.subscribeI18n("nav-ia-phase1-role",function(){try{typeof window.applyRoleVisibility=="function"&&window.applyRoleVisibility()}catch{}})}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",l):l()})();(function(){function n(k){return String(k??"").replace(/[&<>"']/g,function(M){return{"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"}[M]})}function a(k){if(!k||isNaN(k))return"";var M=Number(k);return M<1024?M+" B":M<1024*1024?(M/1024).toFixed(1)+" KB":(M/1024/1024).toFixed(1)+" MB"}document.addEventListener("click",function(k){var M=k.target.closest&&k.target.closest(".recon-collapse-head");if(M&&!(k.target.closest("button")||k.target.closest("a"))){var B=M.closest(".recon-collapse");if(B){var _=B.getAttribute("data-collapsed")==="true";B.setAttribute("data-collapsed",_?"false":"true"),_&&(B.id==="vex-summary-collapse"&&l(),B.id==="vex-detail-collapse"&&d())}}}),document.addEventListener("keydown",function(k){if(!(k.key!=="Enter"&&k.key!==" ")){var M=k.target.closest&&k.target.closest(".recon-collapse-head");M&&(k.preventDefault(),M.click())}});var o={vat:"",gl:""};window._glvClearPreviewSearch=function(){o.vat="",o.gl=""};var s='<svg class="vex-pp-fi-icon" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#111111" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/></svg>',p='<svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg>';function r(){i("vat"),i("gl")}function f(k){try{if(typeof window._glvPreviewFiles=="function")return window._glvPreviewFiles(k)||[]}catch{}var M=document.getElementById(k==="vat"?"glv-vat-input":"glv-gl-input");return M&&M.files?Array.from(M.files):[]}function i(k){var M=document.getElementById(k==="vat"?"glv-pp-vat-col":"glv-pp-gl-col");if(M){var B=f(k),_=k==="vat"?"glv-up-vat-title":"glv-up-gl-title",E=k==="vat"?"① 销项税报告":"② 总账 GL",q=window.t&&window.t(_)||E,H=n(window.t&&window.t("vex-preview-search")||"搜索文件名..."),F=n(window.t&&window.t("vex-preview-clear-all")||"全清"),A=o[k]||"",y=B.length;M.innerHTML='<div class="vex-pp-col-title"><span class="vex-pp-col-name">'+n(q)+' <span class="vex-pp-col-count">'+y+'</span></span></div><div class="vex-pp-search-row"><input class="vex-pp-search" id="glv-pp-search-'+k+'" type="text" placeholder="'+H+'" value="'+n(A)+'" autocomplete="off"><button class="vex-pp-clear-btn" id="glv-pp-clearall-'+k+'" type="button">'+F+'</button></div><div class="vex-pp-file-list" id="glv-pp-'+k+'-list"></div><div class="vex-pp-pagination" id="glv-pp-'+k+'-pg"></div>';var v=document.getElementById("glv-pp-search-"+k);v&&v.addEventListener("input",function(L){o[k]=L.target.value,c(k)});var b=document.getElementById("glv-pp-clearall-"+k);b&&b.addEventListener("click",function(){window._glvRemoveFile&&window._glvRemoveFile(k)}),c(k)}}function c(k){var M=document.getElementById("glv-pp-"+k+"-list"),B=document.getElementById("glv-pp-"+k+"-pg");if(M){var _=f(k),E=(o[k]||"").toLowerCase(),q=_.map(function(A,y){return{f:A,i:y}}),H=E?q.filter(function(A){return A.f.name.toLowerCase().indexOf(E)>=0}):q;if(M.innerHTML=H.map(function(A){var y=A.f;return'<div class="vex-pp-file-row">'+s+'<span class="vex-pp-fi-name" title="'+n(y.name)+'">'+n(y.name)+'</span><span class="vex-pp-fi-size">'+a(y.size)+'</span><button class="vex-pp-fi-del" type="button" data-kind="'+k+'" data-idx="'+A.i+'" aria-label="remove">'+p+"</button></div>"}).join(""),M.querySelectorAll(".vex-pp-fi-del").forEach(function(A){A.addEventListener("click",function(){var y=A.dataset.kind,v=parseInt(A.dataset.idx,10);window._glvRemoveFile&&window._glvRemoveFile(y,isNaN(v)?null:v)})}),B){var F=window.t&&window.t("vex-preview-count")||"显示前 {n} / 共 {m}";B.textContent=F.replace("{n}",H.length).replace("{m}",H.length)}}}function l(){var k=function(B,_){var E=document.getElementById(B);E&&(E.textContent=_==null?"—":String(_))},M=window._vexLastTask||{};k("vex-sum-total",M.total),k("vex-sum-matched",M.matched),k("vex-sum-diff",M.diff),k("vex-sum-incomplete",M.incomplete),k("vex-sum-cash",M.cash),document.getElementById("vex-summary-sub")}function d(){var k=window._vexLastTask&&window._vexLastTask.diff_rows||[],M=document.getElementById("vex-detail-tbody"),B=document.getElementById("vex-detail-table"),_=document.getElementById("vex-detail-empty");if(!(!M||!B||!_)){if(k.length===0){B.style.display="none",_.style.display="";return}_.style.display="none",B.style.display="";var E=k.map(function(H){return'<tr><td class="recon-detail-cell-mono">'+n(H.invoice_no||"")+"</td><td>"+n(H.field||"")+"</td><td>"+n(H.report_value||"")+"</td><td>"+n(H.invoice_value||"")+"</td><td>"+n(H.kind||"")+"</td></tr>"}).join("");M.innerHTML=E;var q=document.getElementById("vex-detail-sub");q&&(q.textContent=String(k.length))}}function u(){var k=document.getElementById("glv-toggle-preview");k&&!k._reconBound&&(k._reconBound=!0,k.addEventListener("click",function(){var M=document.getElementById("glv-preview-panel"),B=document.getElementById("glv-toggle-preview-label"),_=M&&M.style.display!=="none";M&&(M.style.display=_?"none":""),k.classList.toggle("open",!_),B&&(B.textContent=_?window.t&&window.t("vex-toggle-preview-open")||"查看清单":window.t&&window.t("vex-toggle-preview-close")||"收起清单"),_||r()})),["glv-vat-input","glv-gl-input"].forEach(function(M){var B=document.getElementById(M);!B||B._reconWatched||(B._reconWatched=!0,B.addEventListener("change",function(){var _=document.getElementById("glv-preview-panel");_&&_.style.display!=="none"&&r()}))})}function g(){var k=document.getElementById("vex-summary-collapse"),M=document.getElementById("vex-detail-collapse");k&&(k.style.display=""),M&&(M.style.display=""),l(),d()}window._fillVexSummary=l,window._fillVexDetail=d,window._onVexResultShown=g,document.addEventListener("DOMContentLoaded",function(){u()}),setTimeout(u,1500),typeof window.subscribeI18n=="function"&&window.subscribeI18n("recon-collapse",function(){var k=document.getElementById("glv-preview-panel");k&&k.style.display!=="none"&&r();var M=document.getElementById("glv-toggle-preview-label"),B=document.getElementById("glv-toggle-preview");M&&B&&(M.textContent=B.classList.contains("open")?window.t&&window.t("vex-toggle-preview-close")||"收起清单":window.t&&window.t("vex-toggle-preview-open")||"查看清单")}),window._reconCollapse={renderGlvPreview:r,fillVexSummary:l,fillVexDetail:d}})();(function(){function e(p){}function n(){const p=document.querySelectorAll("[data-recon-tab]");p.forEach(f=>{f.addEventListener("click",()=>{p.forEach(u=>u.classList.remove("active")),f.classList.add("active");const i=f.dataset.reconTab,c=document.getElementById("recon-pane-bank"),l=document.getElementById("recon-pane-sale-vat"),d=document.getElementById("recon-pane-gl-vat");c&&(c.style.display=i==="bank"?"":"none"),l&&(l.style.display=i==="sale-vat"?"":"none"),d&&(d.style.display=i==="gl-vat"?"":"none"),i==="gl-vat"&&window.GlVatRecon&&window.GlVatRecon.ensureInit(),i==="bank"&&typeof window._bankReconV2Init=="function"&&window._bankReconV2Init()})});const r=document.querySelector("[data-recon-tab].active");r&&(r.dataset.reconTab,void 0)}function a(){const p=document.getElementById("page-settings");if(!p)return null;let r=document.getElementById("settings-modal-overlay");if(r)return r;r=document.createElement("div"),r.id="settings-modal-overlay",r.className="settings-modal-overlay",r.style.display="none",p.parentElement.insertBefore(r,p),r.appendChild(p);const f=document.createElement("button");return f.id="settings-modal-close",f.className="settings-modal-close",f.setAttribute("aria-label","close"),f.innerHTML='<svg viewBox="0 0 20 20" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M5 5l10 10M15 5L5 15"/></svg>',p.insertBefore(f,p.firstChild),f.addEventListener("click",s),r.addEventListener("click",i=>{i.target===r&&s()}),r}function o(){const p=a();if(!p)return;p.style.display="flex",document.body.classList.add("settings-modal-open");const r=document.getElementById("page-settings");r&&(r.style.display="block"),setTimeout(()=>{try{typeof renderSettings=="function"&&renderSettings()}catch(i){console.warn("renderSettings:",i)}let f=document.querySelector(".settings-tab.active")||document.querySelector('.settings-tab[data-tab="profile"]');f&&f.click()},50)}function s(){const p=document.getElementById("settings-modal-overlay");p&&(p.style.display="none"),document.body.classList.remove("settings-modal-open")}window.openSettingsModal=o,window.closeSettingsModal=s,document.addEventListener("keydown",p=>{if(p.key==="Escape"){const r=document.getElementById("settings-modal-overlay");r&&r.style.display==="flex"&&s()}}),window.addEventListener("hashchange",()=>{location.hash==="#/settings"&&o()}),window.addEventListener("DOMContentLoaded",()=>{location.hash==="#/settings"&&o()}),document.readyState==="loading"?document.addEventListener("DOMContentLoaded",n):n()})();(function(){const a=/\.(pdf|jpe?g|png|webp|tiff?|xlsx?|xlsm|csv|tsv|docx?)$/i,o=V=>document.getElementById(V);function s(){return{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||"")}}function p(V){return String(V??"").replace(/[&<>"']/g,Z=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[Z])}function r(V){return V<1024?V+" B":V<1024*1024?(V/1024).toFixed(1)+" KB":(V/1024/1024).toFixed(1)+" MB"}let f=[],i=[],c=!1,l=[],d=50,u=50,g="",k="";async function M(){try{const V=await fetch("/api/vat_excel/tasks?page=1&page_size=1",{headers:s()});if(!V.ok)return;const ee=(await V.json()).kpi||{};[["vex-kpi-month-val",ee.this_month],["vex-kpi-running-val",ee.running],["vex-kpi-done-val",ee.done],["vex-kpi-failed-val",ee.failed]].forEach(([ne,oe])=>{const ue=document.getElementById(ne);ue&&(ue.textContent=oe??0)})}catch{}}async function B(){try{const V=await fetch("/api/vat_excel/tasks?page=1&page_size=100",{headers:s()});if(!V.ok)return;const Z=await V.json();H(Z.rows||[])}catch{}}const _=10;var E=1;function q(){var V=((document.getElementById("vex-task-search")||{}).value||"").trim().toLowerCase();if(E=1,H(l),!!V){var Z=document.getElementById("vex-task-tbody");Z&&Z.querySelectorAll("tr").forEach(function(ee){ee.dataset.taskId&&(ee.style.display=ee.textContent.toLowerCase().indexOf(V)>=0?"":"none")})}}function H(V){l=V||l;const Z=document.getElementById("vex-task-tbody");if(!Z)return;if(!l.length){Z.innerHTML='<tr><td colspan="9" class="vex-task-empty">'+(t("sv-empty-title")||"还没有对账任务")+"</td></tr>",F(0);return}const ee=Math.ceil(l.length/_);E>ee&&(E=ee);const ne=(E-1)*_;A(l.slice(ne,ne+_)),F(l.length)}function F(V){const Z=document.getElementById("vex-task-pager"),ee=document.getElementById("vex-task-pager-info"),ne=document.getElementById("vex-task-prev"),oe=document.getElementById("vex-task-next");if(!Z)return;if(V<=_){Z.style.display="none";return}Z.style.display="";const ue=Math.ceil(V/_);ee&&(ee.textContent=E+" / "+ue),ne&&(ne.disabled=E<=1),oe&&(oe.disabled=E>=ue)}function A(V){const Z=document.getElementById("vex-task-tbody");if(!Z)return;const ee={pending:t("vex-status-pending")||"待处理",running:t("vex-status-running")||"处理中",done:t("vex-status-done")||"已完成",failed:t("vex-status-failed")||"失败"},ne={pending:"badge-gray",running:"badge-blue",done:"badge-green",failed:"badge-red"},oe='<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M8 2v9M4 7l4 4 4-4M3 14h10"/></svg>',ue='<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M3 4h10M6 4V3h4v1M5 4v8a1 1 0 001 1h4a1 1 0 001-1V4"/></svg>';Z.innerHTML=V.map(w=>{const S=w.created_at?new Date(w.created_at).toLocaleString([],{year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",minute:"2-digit"}):"—",$=w.period||"—",U=w.matched_count!=null?w.matched_count+" ✓ · "+w.mismatched_count+" ⚠":"—",z=w.mismatch_amount!=null?"฿ "+Number(w.mismatch_amount).toLocaleString():"—",m=w.elapsed_seconds!=null?w.elapsed_seconds.toFixed(1)+" s":"—",R=w.status||"pending",O=w.client_name&&w.client_name!=="client"?w.client_name:t("vex-client-all")||"全部客户";return`<tr class="vex-task-row" data-task-id="${p(w.id)}" style="cursor:pointer">
                <td>${S}</td>
                <td>${p(O)}</td>
                <td>${p($)}</td>
            ...
            <div class="vex-pp-pagination" id="vex-pp-${V}-pg"></div>`;const S=o("vex-pp-search-"+V);S&&S.addEventListener("input",U=>{V==="inv"?(g=U.target.value,d=50):(k=U.target.value,u=50),T(V)});const $=o("vex-pp-clearall-"+V);$&&$.addEventListener("click",()=>{V==="inv"?(f=[],g="",d=50):(i=[],k="",u=50),j()}),T(V)}function T(V){const Z=o("vex-pp-"+V+"-list"),ee=o("vex-pp-"+V+"-pg");if(!Z)return;const ne=V==="inv"?f:i,oe=V==="inv"?g:k,ue=V==="inv"?d:u,w=V==="inv"?Y:G,S=ne.map((z,m)=>({f:z,i:m})),$=oe?S.filter(({f:z})=>z.name.toLowerCase().includes(oe.toLowerCase())):S,U=$.slice(0,ue);if(Z.innerHTML=U.map(({f:z,i:m})=>`
    ...
    </div>`;function Et(){const e=document.getElementById("help-modal");if(!e||e.children.length)return;e.innerHTML=na;const n=window._currentLang||"th",a=window.I18N&&window.I18N[n]||{};e.querySelectorAll("[data-i18n]").forEach(o=>{const s=o.getAttribute("data-i18n");a[s]&&(o.textContent=a[s])})}document.readyState,Et();(function(){function e(){const n=document.getElementById("help-modal"),a=document.getElementById("help-modal-close");n&&(a&&!a.dataset.bound&&(a.addEventListener("click",function(){n.style.display="none"}),a.dataset.bound="1"),n.dataset.maskBound||(n.addEventListener("click",function(o){o.target===n&&(n.style.display="none")}),n.dataset.maskBound="1"),window._helpModalEscBound||(document.addEventListener("keydown",function(o){o.key==="Escape"&&n.style.display==="flex"&&(n.style.display="none")}),window._helpModalEscBound=!0))}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",e):e()})();(function(){const e={line:"line",folder:"folder",gmail:"email",erp:"erp",alert:"alert"};document.addEventListener("click",function(n){const a=n.target.closest(".int-btn-configure");if(!a)return;const o=a.closest(".integration-row"),s=o?o.dataset.intAnchor:null;if(s&&e[s]){const p=o.querySelector(".int-name"),r=p?(p.textContent||p.innerText||"").trim():"配置";typeof window.openIntegrationDrawer=="function"&&window.openIntegrationDrawer(e[s],r)}})})();let we=[];window._erpEndpoints=we;let Re=null;async function Xe(){try{const e=await fetch("/api/erp/endpoints",{headers:{Authorization:"Bearer "+token}});if(e.status===401){localStorage.removeItem("mrpilot_token");const a=await e.json().catch(()=>({}));if((typeof a.detail=="string"?a.detail:a.detail&&a.detail.code||"")==="auth.session_revoked"){_showSessionRevokedModal();return}window.location.href="/";return}we=(await e.json()).items||[],window._erpEndpoints=we,Ot()}catch(e){console.error("load endpoints failed",e)}}window._refreshErpEndpointsCache=function(){return Xe()};async function zt(){const e=document.getElementById("erp-today-stats");if(e){e.innerHTML="";try{const n=await fetch("/api/erp/stats/today",{headers:{Authorization:"Bearer "+token}});if(!n.ok)return;const a=await n.json(),o=a.total||0,s=a.success||0,p=a.failed||0,r=a.auto_cnt||0;if(o===0){e.innerHTML=`<span class="erp-today-empty">${escapeHtml(t("erp-today-none"))}</span>`;return}const f=[];f.push(`<span class="erp-today-item"><strong>${o}</strong> ${escapeHtml(t("erp-today-total"))}</span>`),s>0&&f.push(`<span class="erp-today-item ok"><strong>${s}</strong> ${escapeHtml(t("erp-today-success"))}</span>`),p>0&&f.push(`<span class="erp-today-item fail"><strong>${p}</strong> ${escapeHtml(t("erp-today-failed"))}</span>`),r>0&&f.push(`<span class="erp-today-item auto"><strong>${r}</strong> ${escapeHtml(t("erp-today-auto"))}</span>`),e.innerHTML=f.join("")}catch(n){console.warn("loadErpTodayStats failed",n)}}}function Ot(){const e=document.getElementById("erp-endpoints-list"),n=document.getElementById("erp-status-summary"),a=document.getElementById("btn-add-endpoint");if(!e){console.warn("erp-endpoints-list 容器不存在");return}if(a&&_userInfo){const s=_userInfo.endpoints_limit;s!==-1&&we.length>=s?(a.disabled=!0,a.title=t("ep-limit-reached",{limit:s}),a.classList.add("btn-disabled-plus")):(a.disabled=!1,a.title="",a.classList.remove("btn-disabled-plus"))}if(we.length===0){e.innerHTML=`<div class="erp-empty">${escapeHtml(t("ep-list-empty"))}</div>`,n&&(n.textContent=t("auto-status-none"),n.className="auto-status-pill none");return}const o=we.some(s=>s.auto_push&&s.enabled);if(n&&(n.textContent=t("auto-status-active",{n:we.length,mode:o?t("auto-status-on"):t("auto-status-off")}),n.className="auto-status-pill "+(o?"active":"ready")),zt(),e.innerHTML=we.map(s=>{const p=s.config||{},r=escapeHtml(p.url||"");p._token_set;const f=s.enabled!==!1,i=[];s.is_default&&i.push(`<span class="ep-badge default">${escapeHtml(t("ep-default"))}</span>`),s.auto_push&&i.push(`<span class="ep-badge auto">${escapeHtml(t("ep-auto-push-on"))}</span>`),f||i.push(`<span class="ep-badge disabled">${escapeHtml(t("ep-disabled"))}</span>`);const c=[];return s.success_count>0&&c.push(`<span class="ep-stat ok">${escapeHtml(t("ep-success",{n:s.success_count}))}</span>`),s.failure_count>0&&c.push(`<span class="ep-stat fail">${escapeHtml(t("ep-failure",{n:s.failure_count}))}</span>`),`
    ...
    `,document.body.appendChild(n),n.addEventListener("click",async a=>{if(a.target===n||a.target.classList.contains("log-detail-close")){n.remove();return}const o=a.target.closest("[data-receipt-copy]");if(o){Kt(o.dataset.receiptCopy);return}const s=a.target.closest("[data-receipt-action]");if(s){const p=s.dataset.receiptAction;p==="retry"?window.retryPushLog(s.dataset.logId):p==="exceptions"?typeof routeTo=="function"&&routeTo("exceptions"):p==="mappings"&&typeof routeTo=="function"&&routeTo("integrations"),n.remove();return}});try{const a=await fetch(`/api/erp/logs/${encodeURIComponent(e)}`,{headers:{Authorization:"Bearer "+token}});if(!a.ok){n.remove();return}const o=await a.json(),s=window._erpEndpoints.find(C=>C.id===o.endpoint_id),p=o.endpoint_name||(s?s.name:o.endpoint_id?t("erp-log-endpoint-deleted"):"-"),r=(o.endpoint_adapter||s&&s.adapter||"").toLowerCase(),f=new Date(o.created_at).toLocaleString(),i=o.trigger==="auto"?t("log-tag-auto"):o.trigger==="retry"?t("log-tag-retry"):t("log-tag-manual"),c=o.request_body?JSON.stringify(o.request_body,null,2):t("erp-receipt-no-tech"),l=o.response_body||t("erp-receipt-no-tech"),d=o.status==="success";let u=typeof l=="string"?l:JSON.stringify(l,null,2);if(d)try{const C=typeof o.response_body=="string"?JSON.parse(o.response_body):o.response_body||{},P=C.row_count||(Array.isArray(C.imported_rows)?C.imported_rows.length:0);P>0&&(u=t("log-push-rows").replace("{n}",String(P)))}catch{}const g=(o.external_doc_no||"").trim(),k=(o.external_url||"").trim(),M=(o.external_doc_hint||"").trim(),B=(o.ocr_buyer_name||"").trim()||o.client_name||"-",_=o.seller_name||"-";let E="-";const q=Number(o.total_amount);o.total_amount!=null&&o.total_amount!==""&&!isNaN(q)&&(E=q.toLocaleString("en-US",{minimumFractionDigits:2,maximumFractionDigits:2}));const H=d?t("erp-receipt-title-ok"):t("erp-receipt-title-fail"),F=d?"✓":"✗",A=[],y=(C,P)=>{A.push(`
        ...
        `,document.body.appendChild(g);const k=()=>g.remove();g.querySelector("#cpw-forgot-close").addEventListener("click",k),g.querySelector("#cpw-forgot-cancel").addEventListener("click",k),g.addEventListener("click",M=>{M.target===g&&k()}),g.querySelector("#cpw-forgot-send").addEventListener("click",async()=>{const M=g.querySelector("#cpw-forgot-send"),B=g.querySelector("#cpw-forgot-msg");M.disabled=!0;const _=M.textContent;M.textContent=a("cpw-forgot-sending");try{const E=await fetch("/api/auth/forgot_password",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:d})}),q=await E.json().catch(()=>({}));E.ok?(B.textContent=a("cpw-forgot-success"),B.className="cpw-forgot-msg success",M.style.display="none",g.querySelector("#cpw-forgot-cancel").textContent=a("cpw-forgot-close-btn")):(B.textContent=q.detail||a("cpw-forgot-fail"),B.className="cpw-forgot-msg error",M.disabled=!1,M.textContent=_)}catch{B.textContent=a("cpw-forgot-fail"),B.className="cpw-forgot-msg error",M.disabled=!1,M.textContent=_}})}function i(l){if(!l||!l.includes("@"))return l||"";const[d,u]=l.split("@");return d.length<=2?d+"****@"+u:d.slice(0,2)+"****@"+u}function c(l){return l==null?"":String(l).replace(/[&<>"']/g,d=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[d])}document.readyState==="complete"||document.readyState==="interactive"?r():document.addEventListener("DOMContentLoaded",r)})();(function(){let e=null,n=!1;async function a(){if(n)return;const s=localStorage.getItem("mrpilot_token");if(s){n=!0;try{const p=await fetch("/api/me",{headers:{Authorization:"Bearer "+s},cache:"no-store"});if(p.status===401){const r=await p.json().catch(()=>({})),f=r&&r.detail;let i="";if(typeof f=="string"?i=f:f&&typeof f=="object"&&(i=f.code||""),console.warn("[heartbeat] session revoked",i),localStorage.removeItem("mrpilot_token"),e&&(clearInterval(e),e=null),i==="auth.session_revoked")try{_showSessionRevokedModal()}catch{window.location.href="/"}else{const c=i==="auth.password_changed_relogin"?"alert-password-changed-relogin":"alert-session";try{typeof showToast=="function"&&typeof t=="function"?showToast(t(c),"error"):alert("Session expired")}catch{}setTimeout(()=>{window.location.href="/"},1500)}}}catch{}finally{n=!1}}}function o(){e&&clearInterval(e),e=setInterval(a,15e3)}localStorage.getItem("mrpilot_token")&&o(),window.addEventListener("focus",a),document.addEventListener("visibilitychange",function(){document.hidden||a()}),window._sessionCheck=a})();async function Qe(){const e=document.getElementById("team-loading"),n=document.getElementById("team-list"),a=document.getElementById("team-empty"),o=document.getElementById("team-count");if(n){e&&(e.style.display=""),n.style.display="none",a&&(a.style.display="none");try{const s=await apiGet("/api/team/employees"),p=s&&s.employees||[];if(e&&(e.style.display="none"),o&&(o.textContent=(t("team-count")||"共 {n} 名员工").replace("{n}",p.length)),p.length===0){a&&(a.style.display="");return}n.style.display="",n.innerHTML=p.map(r=>{const f=r.last_login_at?new Date(r.last_login_at).toLocaleDateString():t("team-never-login")||"从未登录",i=r.is_active===!1?"team-status-off":"team-status-on",c=r.is_active===!1?t("team-status-disabled")||"已禁用":t("team-status-active")||"正常",l=r.email?`<span class="team-meta-sep">·</span><span>${escapeHtml(r.email)}</span>`:"";return`
            ...
            </div>`}).join("")}catch(s){console.error("loadTeamList failed:",s),e&&(e.textContent=t("team-load-failed")||"加载失败")}}}async function la(){document.querySelectorAll(".add-emp-overlay").forEach(o=>o.remove());const e=document.createElement("div");e.className="add-emp-overlay",e.innerHTML=`
