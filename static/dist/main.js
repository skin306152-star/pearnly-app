...
このデバイスは自動的にログアウトされました。`},s={zh:"确定，去登录",en:"OK, Sign in",th:"ตกลง เข้าสู่ระบบ",ja:"OK、ログイン"},o=n[e]?e:"th",i=document.createElement("div");i.id="pn-session-revoked-modal",i.style.cssText="position:fixed;inset:0;z-index:99999;background:rgba(0,0,0,.5);display:flex;align-items:center;justify-content:center;padding:16px;",i.innerHTML='<div style="background:#fff;border-radius:14px;padding:32px 24px 24px;max-width:360px;width:100%;box-shadow:0 12px 40px rgba(0,0,0,.2);text-align:center;"><div style="width:52px;height:52px;border-radius:50%;background:#FEF2F2;display:flex;align-items:center;justify-content:center;margin:0 auto 18px;flex-shrink:0;"><svg width="26" height="26" fill="none" stroke="#DC2626" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" viewBox="0 0 24 24"><circle cx="12" cy="12" r="10"/><line x1="12" y1="8" x2="12" y2="12"/><circle cx="12" cy="16" r=".5" fill="#DC2626"/></svg></div><div style="font-size:16px;font-weight:700;color:#111827;margin-bottom:10px;line-height:1.4;">'+n[o]+'</div><div style="font-size:13px;color:#6B7280;line-height:1.7;margin-bottom:24px;white-space:pre-line;">'+a[o]+'</div><button id="pn-srm-ok" style="width:100%;padding:11px 0;background:#111111;color:#fff;border:none;border-radius:8px;font-size:14px;font-weight:600;cursor:pointer;">'+s[o]+"</button></div>",document.body.appendChild(i),document.getElementById("pn-srm-ok").addEventListener("click",function(){window.location.href="/"})}}function fa(){try{if(typeof window.getActiveWorkspaceClientId=="function"){const e=window.getActiveWorkspaceClientId();if(e!=null)return{"X-Workspace-Client-Id":String(e)}}}catch{}return{}}async function vl(e){const n=await fetch(e,{headers:{Authorization:"Bearer "+token,...fa()}});if(n.status===401||n.status===403){const a=await n.json().catch(()=>({})),s=a&&a.detail;let o="";if(typeof s=="string"?o=s:s&&typeof s=="object"&&(o=s.code||""),n.status===401||typeof o=="string"&&o.indexOf("auth.")>=0){if(console.warn("[auth-fail-redirect]",e,n.status,s),localStorage.removeItem("mrpilot_token"),o==="auth.session_revoked")va();else{const l=o==="auth.password_changed_relogin"?"alert-password-changed-relogin":"alert-session";showToast(ma(l),"error"),setTimeout(()=>{window.location.href="/"},1500)}return null}const r=new Error("biz_403");throw r.detail=s,r}if(!n.ok)throw new Error("fetch failed");return await n.json()}async function fl(e,n){const a=await fetch(e,{method:"POST",headers:{Authorization:"Bearer "+token,"Content-Type":"application/json",...fa()},body:JSON.stringify(n)});if(a.status===401||a.status===403){const o=await a.clone().json().catch(()=>({})),i=o&&o.detail;let r="";if(typeof i=="string"?r=i:i&&typeof i=="object"&&(r=i.code||""),a.status===401||typeof r=="string"&&r.indexOf("auth.")>=0){if(console.warn("[auth-fail-redirect]",e,a.status,i),localStorage.removeItem("mrpilot_token"),r==="auth.session_revoked")va();else{const m=r==="auth.password_changed_relogin"?"alert-password-changed-relogin":"alert-session";showToast(ma(m),"error"),setTimeout(()=>{window.location.href="/"},1500)}return null}return a}return a}async function hl(e,n){try{const a=await fetch(e,{method:"PUT",headers:{Authorization:"Bearer "+token,"Content-Type":"application/json",...fa()},body:JSON.stringify(n)});if(a.status===401||a.status===403){const o=await a.json().catch(()=>({})),i=o&&o.detail;let r="";if(typeof i=="string"?r=i:i&&typeof i=="object"&&(r=i.code||""),a.status===401||typeof r=="string"&&r.indexOf("auth.")>=0){if(console.warn("[auth-fail-redirect]",e,a.status,i),localStorage.removeItem("mrpilot_token"),r==="auth.session_revoked")va();else{const m=r==="auth.password_changed_relogin"?"alert-password-changed-relogin":"alert-session";showToast(ma(m),"error"),setTimeout(()=>{window.location.href="/"},1500)}return{ok:!1}}return{ok:!1,status:a.status,detail:i}}const s=await a.json().catch(()=>({}));return{ok:a.ok&&s.ok!==!1,...s}}catch(a){return{ok:!1,error:String(a)}}}window.apiGet=vl;window.apiPost=fl;window.t=ma;window.escapeHtml=ul;window.svgIcon=ml;window._showSessionRevokedModal=va;window._wsHeader=fa;window.apiPut=hl;window.getMaxFiles=cl;window.getMaxPagesPerFile=dl;window.getMaxMbPerFile=pl;function Ce(e,n){const a=document.getElementById(e);if(!(!a||a.dataset.wbInjected==="1")){a.innerHTML=n,a.dataset.wbInjected="1";try{const s=window._currentLang||localStorage.getItem("mrpilot_lang")||"th",o=window.I18N;if(!o||!o[s])return;a.querySelectorAll("[data-i18n]").forEach(i=>{const r=i.getAttribute("data-i18n");r&&o[s][r]&&(i.textContent=o[s][r])}),a.querySelectorAll("[data-i18n-placeholder]").forEach(i=>{const r=i.getAttribute("data-i18n-placeholder");r&&o[s][r]&&(i.placeholder=o[s][r])})}catch{}}}const gl=`
        <!-- v85 · 模块头 · 视觉对齐其他页 -->
...
`,e.dataset.wbInjected="1";try{const n=window._currentLang||localStorage.getItem("mrpilot_lang")||"th",a=window.I18N;a&&a[n]&&(e.querySelectorAll("[data-i18n]").forEach(s=>{const o=s.getAttribute("data-i18n");a[n][o]&&(s.textContent=a[n][o])}),e.querySelectorAll("[data-i18n-placeholder]").forEach(s=>{const o=s.getAttribute("data-i18n-placeholder");a[n][o]&&(s.placeholder=a[n][o])}))}catch{}}})();(function(){const e=document.getElementById("page-settings");if(!(!e||e.dataset.wbInjected==="1")){e.innerHTML=`
        ...
        <!-- /settings-layout -->
`,e.dataset.wbInjected="1";try{const n=window._currentLang||localStorage.getItem("mrpilot_lang")||"th",a=window.I18N;a&&a[n]&&(e.querySelectorAll("[data-i18n]").forEach(s=>{const o=s.getAttribute("data-i18n");a[n][o]&&(s.textContent=a[n][o])}),e.querySelectorAll("[data-i18n-placeholder]").forEach(s=>{const o=s.getAttribute("data-i18n-placeholder");a[n][o]&&(s.placeholder=a[n][o])}))}catch{}}})();const $l=`
        <div class="page-head-clean">
            <div class="page-head-icon">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
...
`,Sl=`                    <!-- Tab: 邮箱抓取 (v0.17 · M6 · v93 在 Vultr 复活) -->
...
`;(function(){const e=document.getElementById("page-automation");if(!(!e||e.dataset.wbInjected==="1")){e.innerHTML=$l+Sl,e.dataset.wbInjected="1";try{const n=window._currentLang||localStorage.getItem("mrpilot_lang")||"th",a=window.I18N;a&&a[n]&&(e.querySelectorAll("[data-i18n]").forEach(s=>{const o=s.getAttribute("data-i18n");o&&a[n][o]&&(s.textContent=a[n][o])}),e.querySelectorAll("[data-i18n-placeholder]").forEach(s=>{const o=s.getAttribute("data-i18n-placeholder");o&&a[n][o]&&(s.placeholder=a[n][o])}))}catch{}}})();(function(){const e={"page-integration":`
        <div class="coming-soon">
            <svg class="cs-icon" viewBox="0 0 48 48" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
...
`,e.dataset.wbInjected="1";try{const n=window._currentLang||localStorage.getItem("mrpilot_lang")||"th",a=window.I18N;a&&a[n]&&e.querySelectorAll("[data-i18n]").forEach(s=>{const o=s.getAttribute("data-i18n");a[n][o]&&(s.textContent=a[n][o])})}catch{}}})();function Cl(e,n){const a=document.getElementById("alert-"+e);a&&(document.getElementById("alert-"+e+"-text").textContent=n,a.classList.add("show"))}function Tl(){["info","warn","error"].forEach(e=>{document.getElementById("alert-"+e).classList.remove("show")})}function Hl(e,n){if(e==null)return n||"操作失败";if(typeof e=="string")return e;if(Array.isArray(e)){const a=e[0]||{};return a.msg?a.msg:n||"请求格式错误"}if(typeof e=="object"){if(e.code){const a="err."+e.code;try{const s=t(a,e);if(s&&s!==a)return s}catch(s){console.warn("[i18n] t() failed for key:",a,s)}return e.code}if(e.message)return e.message;if(e.error)return e.error;if(e.detail&&typeof e.detail=="string")return e.detail;try{return JSON.stringify(e).slice(0,160)}catch{}}return n||String(e)}function Ml(e){if(!e)return"";const n=String(e);return/ECONNREFUSED|Connection refused/i.test(n)?"连接被拒绝 · ERP 地址可能错了,或服务没启动":/listing fetch failed|wait_for_selector/i.test(n)?"拉取 MR.ERP 客户/商品列表超时 · 已重试 3 次仍不通 · 可能 MR.ERP 响应慢 · 稍后再试":/ETIMEDOUT|timeout/i.test(n)?"连接超时 · MR.ERP 响应慢 · 稍后再试":/ENOTFOUND|getaddrinfo/i.test(n)?"域名解析失败 · ERP 地址拼错了":/certificate|SSL/i.test(n)?"SSL 证书问题 · ERP 站点证书异常":/401|Unauthorized/i.test(n)?"HTTP 401 · 认证失败,检查 Token 是否正确":/403|Forbidden/i.test(n)?"HTTP 403 · 权限不足,ERP 拒绝访问":/404|Not Found/i.test(n)?"HTTP 404 · URL 路径不存在":/^5\d\d/.test(n)||/500|502|503|504/.test(n)?"ERP 服务器错误 · 不是你的问题,等会儿再试":n}function Al(e,n,a){let s=document.getElementById("mp-toast-wrap");s||(s=document.createElement("div"),s.id="mp-toast-wrap",document.body.appendChild(s)),n=n||"success",n==="ok"&&(n="success"),n==="warning"&&(n="warn"),n==="danger"&&(n="error");const o={success:'<path d="M3 8l3 3 7-7"/>',error:'<circle cx="8" cy="8" r="6"/><path d="M5.5 5.5l5 5M10.5 5.5l-5 5"/>',warn:'<path d="M8 2L1.5 13h13L8 2z"/><path d="M8 7v3M8 12v.01"/>',info:'<circle cx="8" cy="8" r="6"/><path d="M8 5.5v.01M8 8v3"/>',loading:'<path d="M8 1a7 7 0 017 7" stroke-linecap="round" class="mp-toast-spin"/>'},i=document.createElement("div");i.className="mp-toast "+n,i.innerHTML=`
    ...
    `,s.appendChild(i),requestAnimationFrame(()=>i.classList.add("show"));const r=typeof a=="number"?a:2500;let l=null;const m=()=>{l&&(clearTimeout(l),l=null),i.classList.remove("show"),setTimeout(()=>{try{i.remove()}catch{}},300)};return r>0&&(l=setTimeout(m,r)),m}window.showAlert=Cl;window.hideAlerts=Tl;window._humanizeBackendError=Hl;window.humanizeError=Ml;window.showToast=Al;function Pl(e,n){return n=n||{},new Promise(a=>{const s=document.getElementById("confirm-modal"),o=document.getElementById("confirm-modal-body"),i=document.getElementById("confirm-modal-ok"),r=document.getElementById("confirm-modal-cancel"),l=document.getElementById("confirm-modal-close"),m=document.getElementById("confirm-modal-title");if(!s||!o||!i||!r){a(!1);return}m.textContent=n.title||t("confirm-default-title");const d=n.promptInput?"cm_in_"+Date.now():null;if(n.promptInput){const v=(e||"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;"),f=(n.placeholder||"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;");o.innerHTML=`
        ...
        `;const s=document.getElementById("api-key-card");s&&(s.style.display="");return}Fl(n,e);const a=document.getElementById("api-key-card");if(a){const s=tt==="byo_api"||_userInfo&&_userInfo.is_super_admin;a.style.display=s?"":"none"}}function Fl(e,n){const a=escapeHtml(e.username||e.email||"");n.innerHTML=`
        <table style="width:100%; font-size:13px; border-collapse: collapse;">
            <tr>
    ...
    `}window.switchSettingsTab=jl;window.fillSettingsForms=Dl;window.saveProfile=ql;window.saveCompany=Rl;window.renderSettings=Za;function ha(e){return e=e||_userInfo,!!(e&&e.is_super_admin)}function ws(e){return e=e||_userInfo,!!e&&(e.role==="owner"||ha(e))}function _i(e){return e=e||_userInfo,!!e&&e.role==="member"&&!ha(e)}function zl(e){return e=e||_userInfo,!!e&&(e.effective_plan==="trial"||e.plan==="trial")&&!ha(e)}function Ei(e){return e=e||_userInfo,!!e&&e.tenant_type==="byo_api"}function Ii(e){return _i(e)}function Nl(e){return ws(e)}function Ol(e){return ws(e)&&Ei(e)}window.isMoneyHidden=Ii;window.isSuperAdmin=ha;window.isOwner=ws;window.isEmployee=_i;window.isTrial=zl;window.isLifetime=Ei;window.shouldHideMoney=Ii;window.canManageTeam=Nl;window.canManageApiKey=Ol;function Vl(){const e=document.getElementById("quota-banner");if(!e)return;if(!_userInfo){e.style.display="none";return}if(_userInfo.is_super_admin||_userInfo.tenant_type==="admin"||_userInfo.tenant_type==="byo_api"){e.style.display="none";return}let n=0,a=0;if(_userInfo.plan==="free"&&_quota&&_quota.ip_daily_limit)n=_quota.ip_used_today||0,a=_quota.ip_daily_limit;else if(_userInfo.tenant_quota!=null&&_userInfo.tenant_quota>0)n=_userInfo.tenant_used||0,a=_userInfo.tenant_quota;else if(_userInfo.monthly_quota&&_userInfo.monthly_quota>0)n=_userInfo.used_this_month||0,a=_userInfo.monthly_quota;else{e.style.display="none";return}if(a<=0){e.style.display="none";return}const s=Math.max(0,a-n),o=n/a*100,i="quota_banner_dismiss_"+new Date().toISOString().slice(0,10);if(localStorage.getItem(i)){e.style.display="none";return}let r,l;if(s===0)r="danger",l=t("quota-banner-exhausted");else if(o>=90)r="danger",l=t("quota-banner-very-low",{n:s});else if(o>=70)r="warn",l=t("quota-banner-low",{n:s});else{e.style.display="none";return}e.className="quota-banner "+r,e.innerHTML=`
    ...
    `,e.style.display="flex";const m=e.querySelector(".quota-banner-close");m&&m.addEventListener("click",()=>{localStorage.setItem(i,"1"),e.style.display="none"})}function Ul(){const e=_userInfo;if(!e)return;const n=shouldHideMoney(e),a=canManageTeam(e),s=canManageApiKey(e),o=document.querySelector('.nav-item[data-route="templates"]');o&&(o.classList.remove("locked-for-plan"),o.removeAttribute("data-locked-target"));const i=document.querySelector('.nav-item[data-route="api-keys"]');i&&(i.classList.remove("locked-for-plan"),i.removeAttribute("data-locked-target"));const r=document.getElementById("btn-custom-template");r&&(r.style.display="",r.classList.remove("locked-for-plan"));const l=document.querySelector('.settings-tab[data-tab="team"]');l&&(l.style.display=a?"":"none");const m=document.querySelector('.settings-panel[data-settings-panel="team"]');m&&(m.dataset.permHidden=a?"0":"1");const d=document.querySelector('.settings-tab[data-tab="api"]');d&&(d.style.display=s||isSuperAdmin(e)?"":"none");const p=document.querySelector('.settings-tab[data-tab="plan"]');p&&(p.style.display=n?"none":"");const c=document.querySelector('.settings-tab[data-tab="company"]');c&&(c.style.display=n?"none":"");const u=document.getElementById("info-bar");u&&(u.style.display=n?"none":"");const v=document.getElementById("trial-banner");v&&n&&(v.style.display="none");const f=document.getElementById("plan-banner");f&&n&&(f.style.display="none",document.body.classList.remove("has-plan-banner")),document.querySelectorAll("[data-upgrade-cta], .btn-upgrade, .topbar-upgrade").forEach(y=>{y.style.display="none"}),document.body.classList.toggle("role-employee",isEmployee(e)),document.body.classList.toggle("role-owner",isOwner(e)),document.body.classList.toggle("role-super",isSuperAdmin(e));try{const y=document.querySelector(".settings-tab.active");y&&y.style.display==="none"&&(typeof window.switchSettingsTab=="function"?window.switchSettingsTab("profile"):typeof switchSettingsTab=="function"&&switchSettingsTab("profile"))}catch(y){console.warn("[v118.12.3] failed to fix active tab:",y)}if(window.PEARNLY_ADMIN_MODE){const y=document.getElementById("admin-mode-banner");y&&(y.style.display="flex"),document.querySelectorAll(".nav-item").forEach(g=>{g.classList.contains("nav-admin-only")||(g.style.display="none")}),document.querySelectorAll(".nav-group").forEach(g=>{g.classList.contains("nav-group-admin-only")||(g.style.display="none")});const b=document.getElementById("client-switcher");b&&(b.style.display="none"),document.body.classList.add("admin-mode");const h=["profile","security","notifications","about"];document.querySelectorAll(".settings-tab").forEach(g=>{const _=g.dataset.tab;_&&!h.includes(_)&&(g.style.display="none")}),document.querySelectorAll(".settings-pane").forEach(g=>{const _=g.dataset.pane;_&&!h.includes(_)&&(g.style.display="none")}),document.querySelectorAll(".settings-nav-group").forEach(g=>{const _=g.querySelectorAll(".settings-tab");Array.from(_).some(k=>k.style.display!=="none")||(g.style.display="none")})}}function Gl(){const e=_userInfo,n=document.getElementById("info-bar");if(!e||shouldHideMoney(e)){n&&(n.innerHTML="");return}let a="";const s=e.tenant_type;if(s==="byo_api")e.has_own_gemini_key?a=`
        ...
        `;else{const o=e.tenant_used!=null?e.tenant_used:e.used_this_month||0,i=e.tenant_quota!=null&&e.tenant_quota>0?e.tenant_quota:e.monthly_quota||0,r=i>0?Math.min(100,o/i*100):0;let l="";r>=95?l="danger":r>=80&&(l="warn"),i>0?a=`
            ...
            `:a=""}n&&(n.innerHTML=a)}window.renderQuotaBanner=Vl;window.applySidebarVisibility=Ul;window.renderInfoBar=Gl;async function Bi(e,n){try{const a=await fetch(e,{method:"POST",headers:{Authorization:"Bearer "+token,"Content-Type":"application/json"},body:JSON.stringify(n)});if(a.status===401){localStorage.removeItem("mrpilot_token");const s=await a.json().catch(()=>({}));return(typeof s.detail=="string"?s.detail:s.detail&&s.detail.code||"")==="auth.session_revoked"?(_showSessionRevokedModal(),null):(window.location.href="/",null)}return await a.json()}catch{return{ok:!1,error:"network"}}}function Li(e){return{invalid_format:"rd-err-format",not_found:"rd-err-not-found",rd_unreachable:"rd-err-unreachable",parse_error:"rd-err-unknown",network:"rd-err-unreachable"}[e]||"rd-err-unknown"}function Zn(e){const n=document.querySelector(`[data-field="${e}"]`);return n?(n.value||"").trim():""}function $t(e,n,a){const s=document.querySelector(`[data-rd-status="${e}"]`);s&&(s.innerHTML=n,s.className="rd-status"+(a?" "+a:""))}async function Wl(e){const a=Zn(e==="seller"?"seller_tax":"buyer_tax");$t(e,t("rd-verifying"),"loading");const s=await Bi("/api/rd/verify",{tax_id:a});if(!s)return;if(!s.ok){$t(e,t(Li(s.error)),"error");return}s.data&&s.data.valid?$t(e,`<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="2"><path d="M3 8l3 3 7-7"/></svg> ${escapeHtml(t("rd-status-valid"))}`,"valid"):$t(e,t("rd-status-invalid"),"invalid")}async function Kl(e){const a=Zn(e==="seller"?"seller_tax":"buyer_tax");$t(e,t("rd-syncing"),"loading");const s=await Bi("/api/rd/lookup",{tax_id:a,branch:0});if(s){if(!s.ok){$t(e,t(Li(s.error)),"error");return}$t(e,`<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="2"><path d="M3 8l3 3 7-7"/></svg> ${escapeHtml(t("rd-status-valid"))}`,"valid"),Yl(e,s.data)}}function Yl(e,n){const a=e==="seller"?"seller_name":"buyer_name",s=e==="seller"?"seller_addr":"buyer_addr",o=Zn(a),i=Zn(s),r=[];n.name&&n.name!==o&&r.push({field:a,label:t("rd-field-name"),current:o,official:n.name}),n.address&&n.address!==i&&r.push({field:s,label:t("rd-field-address"),current:i,official:n.address});const l=[];n.branch_label&&l.push(`<strong>${t("rd-field-branch")}:</strong> ${escapeHtml(n.branch_label)}`),n.post_code&&l.push(`<strong>${t("rd-field-postcode")}:</strong> ${escapeHtml(n.post_code)}`);let m=document.getElementById("rd-sync-modal");if(m||(m=document.createElement("div"),m.id="rd-sync-modal",m.className="rd-modal-mask",document.body.appendChild(m)),r.length===0)m.innerHTML=`
            <div class="rd-modal">
    ...
    `;let o=_results.map((r,l)=>({...r,_idx:l}));if(_searchKeyword){const r=_searchKeyword.toLowerCase();o=o.filter(l=>(l.filename||"").toLowerCase().includes(r)||(l.merged_fields.invoice_number||"").toLowerCase().includes(r))}_sortKey&&o.sort((r,l)=>{let m,d;return _sortKey==="filename"?(m=r.filename,d=l.filename):_sortKey==="invoice_no"?(m=r.merged_fields.invoice_number,d=l.merged_fields.invoice_number):_sortKey==="invoice_date"?(m=r.merged_fields.date,d=l.merged_fields.date):_sortKey==="total"?(m=parseFloat(r.merged_fields.total_amount)||0,d=parseFloat(l.merged_fields.total_amount)||0):_sortKey==="confidence"?(m=r.confidence,d=l.confidence):(m="",d=""),m<d?_sortDir==="asc"?-1:1:m>d?_sortDir==="asc"?1:-1:0});const i=document.getElementById("results-tbody");i.innerHTML=o.map((r,l)=>{const m=r.merged_fields,d=`<span class="empty-cell">${t("empty-val")}</span>`,p="conf-tip-"+(r.confidence||"low"),c="conf-"+(r.confidence||"low"),u=t(p),v=t(c);return`
        ...
        `}).join(""),document.querySelectorAll("#results-table th").forEach(r=>{r.classList.remove("sort-asc","sort-desc"),r.dataset.sort===_sortKey&&r.classList.add("sort-"+_sortDir)}),i.querySelectorAll("tr").forEach(r=>{r.addEventListener("click",()=>{const l=parseInt(r.dataset.idx,10);Ci(l)})})}document.querySelectorAll("#results-table th").forEach(e=>{e.classList.contains("no-sort")||e.addEventListener("click",()=>{const n=e.dataset.sort;_sortKey===n?_sortDir=_sortDir==="asc"?"desc":"asc":(_sortKey=n,_sortDir="asc"),ga()})});let po=null;document.getElementById("search-input").addEventListener("input",e=>{const n=e.target.value;document.getElementById("search-clear").style.display=n?"":"none",clearTimeout(po),po=setTimeout(()=>{_searchKeyword=n.trim(),ga(),Si()},200)});document.getElementById("search-clear").addEventListener("click",()=>{const e=document.getElementById("search-input");e.value="",_searchKeyword="",document.getElementById("search-clear").style.display="none",ga(),Si(),e.focus()});function Si(){const e=document.getElementById("search-matches");if(!e)return;if(!_searchKeyword){e.textContent="";return}const n=_searchKeyword.toLowerCase();let a=0;for(const s of _results)[s.filename,s.merged_fields?.invoice_number,s.merged_fields?.seller_name,s.merged_fields?.buyer_name].filter(Boolean).join(" ").toLowerCase().includes(n)&&a++;e.textContent=t("search-matches",{n:a})}function Ci(e){_drawerIdx=e;const n=_results[e];if(!n)return;document.getElementById("drawer-title").textContent=n.filename;const a=n.engine==="cache"||n.from_cache,s=a?t("badge-cached-hint"):`${(n.elapsed_ms/1e3).toFixed(1)}s`;document.getElementById("drawer-sub").innerHTML=`
    ...
    `,d=i?"":`<span class="tax-badge unverified" data-tip="${escapeHtml(t("tax-tip-unverified"))}">${t("tax-unverified")}</span>`;if(l.innerHTML=`
        ...
        <div class="drawer-section">
            ...
            ${Te("invoice_number","drawer-lbl-invoice",r.invoice_number,"input",o)}
            ${Te("date","drawer-lbl-date",r.date,"input",o)}
            ...
            ${Te("subtotal","drawer-lbl-subtotal",r.subtotal,"input",o)}
            ${Te("vat","drawer-lbl-vat",r.vat,"input",o)}
            ${Te("total_amount","drawer-lbl-total",r.total_amount,"input",o)}
            ${r.wht_amount||r.wht_rate?`
                ${Te("wht_amount","drawer-lbl-wht-amount",r.wht_amount,"input",o,Ql(r.wht_rate))}
            `:""}
        </div>
        ...
        <div class="drawer-section">
            ...
            ${Te("seller_name","drawer-lbl-name",r.seller_name,"input",o)}
            ${Te("seller_tax","drawer-lbl-tax",r.seller_tax,"input",o,d,uo("seller"))}
            ${Te("seller_addr","drawer-lbl-addr",r.seller_addr,"textarea",o)}
        </div>
        ...
        <div class="drawer-section">
            ...
            ${Te("buyer_name","drawer-lbl-name",r.buyer_name,"input",o)}
            ${Te("buyer_tax","drawer-lbl-tax",r.buyer_tax,"input",o,d,uo("buyer"))}
            ${Te("buyer_addr","drawer-lbl-addr",r.buyer_addr,"textarea",o)}
        </div>
        ...
        <div class="drawer-section">
            ...
            ${r.items&&r.items.length>0?ec(r.items):`<div class="drawer-items-empty">${t("drawer-items-empty")}</div>`}
        </div>

        <div class="drawer-section">
            ${Te("notes","drawer-lbl-notes",r.notes,"textarea",o)}
        </div>
...
`))}</pre>
    ...
    `}function uo(e){return _userInfo&&_userInfo.can_verify_tax?`
    ...
    `;n.innerHTML=s+o,e.appendChild(n)}function Pa(){const e=document.getElementById("export-dropdown");e&&e.remove()}const ja=document.getElementById("btn-export-arrow");ja&&ja.addEventListener("click",e=>{e.stopPropagation(),!ja.disabled&&ic()});document.addEventListener("click",e=>{const n=e.target.closest(".export-dd-item");if(n){const a=n.getAttribute("data-tpl");if(a==="__custom"){Pa(),showToast(t("cs-coming-soon"),"info");return}oc(a),Pa(),Mi(a);return}e.target.closest("#btn-export-arrow")||Pa()});function rc(){const e=document.getElementById("btn-export-arrow"),n=document.getElementById("btn-export");e&&n&&(e.disabled=n.disabled)}setInterval(rc,300);const lc=`
        <div class="page-head-clean">
            <div class="page-head-icon">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
...
`;(function(){const e=document.getElementById("page-history");if(!(!e||e.dataset.wbInjected==="1")){e.innerHTML=lc,e.dataset.wbInjected="1";try{const n=window._currentLang||localStorage.getItem("mrpilot_lang")||"th",a=window.I18N;a&&a[n]&&(e.querySelectorAll("[data-i18n]").forEach(s=>{const o=s.getAttribute("data-i18n");a[n][o]&&(s.textContent=a[n][o])}),e.querySelectorAll("[data-i18n-placeholder]").forEach(s=>{const o=s.getAttribute("data-i18n-placeholder");a[n][o]&&(s.placeholder=a[n][o])}))}catch{}}})();function ks(){const e=document.getElementById("history-batch-bar"),n=document.getElementById("history-batch-count"),a=document.getElementById("history-check-all");if(!e||!n)return;const s=_historySelected.size;if(s>0?(e.style.display="",n.textContent=t("history-batch-count",{n:s})):e.style.display="none",a){const o=_historyState.items||[];if(o.length===0)a.checked=!1,a.indeterminate=!1;else{const i=o.filter(r=>_historySelected.has(r.id)).length;a.checked=i===o.length,a.indeterminate=i>0&&i<o.length}}}function cc(){_historySelected.clear(),ks()}async function xs(){if(!_userInfo){setTimeout(()=>xs(),300);return}const e=document.getElementById("history-free-block"),n=document.getElementById("history-main"),a=document.getElementById("history-empty");if(!e||!n||!a){console.warn("[History] container missing");return}if(!_userInfo.can_view_history){e.style.display="",n.style.display="none",a.style.display="none";return}e.style.display="none",_historyState.loading=!0;try{const s=_historyState.page*_historyState.pageSize,o=new URLSearchParams({limit:_historyState.pageSize,offset:s});_historyState.keyword&&o.set("keyword",_historyState.keyword);const i=typeof window.getCurrentClientId=="function"?window.getCurrentClientId():null;i&&o.set("client_id",String(i));const r=await fetch(`/api/history?${o}`,{headers:{Authorization:"Bearer "+token}});if(r.status===401){localStorage.removeItem("mrpilot_token");const d=await r.json().catch(()=>({}));if((typeof d.detail=="string"?d.detail:d.detail&&d.detail.code||"")==="auth.session_revoked"){_showSessionRevokedModal();return}window.location.href="/";return}const l=await r.json();_historyState.items=l.items||[],_historyState.total=l.total||0;const m=new Set(_historyState.items.map(d=>d.id));for(const d of Array.from(_historySelected))m.has(d)||_historySelected.delete(d);Ai()}catch(s){console.error("load history failed",s)}finally{_historyState.loading=!1}}function Ai(){const e=document.getElementById("history-main"),n=document.getElementById("history-empty"),a=_historyState.items,s=document.getElementById("history-search-matches");if(s&&(s.textContent=_historyState.keyword?t("search-matches",{n:_historyState.total}):""),a.length===0&&_historyState.total===0&&!_historyState.keyword){e.style.display="none",n.style.display="";return}e.style.display="",n.style.display="none";let o=0;a.forEach(d=>{d.confidence==="high"&&o++});const i=a.length>0?Math.round(o/a.length*100):0;document.getElementById("history-stats").innerHTML=`
    ...
    `;const r=document.getElementById("history-tbody");a.length===0?r.innerHTML=`<div class="history-row-empty">${escapeHtml(t("history-empty-title"))}</div>`:r.innerHTML=a.map(d=>{const p=new Date(d.created_at),c=String(p.getMonth()+1).padStart(2,"0"),u=String(p.getDate()).padStart(2,"0"),v=String(p.getHours()).padStart(2,"0"),f=String(p.getMinutes()).padStart(2,"0"),y=`${c}-${u} ${v}:${f}`,b=escapeHtml(d.filename||""),h=b.length>50?b.substring(0,50)+"…":b,g=d.invoice_no?escapeHtml(d.invoice_no):h,_=[];d.seller_name&&_.push(escapeHtml(d.seller_name)),d.invoice_no&&d.filename&&_.push(h);const w=_.join(" · ")||"-",k=d.category_tag?`<span class="history-badge category">${escapeHtml(d.category_tag)}</span>`:"",x=d.source_total&&d.source_total>1?`<span class="history-badge multi">${escapeHtml(t("invoice-part-of",{i:d.source_index||1,n:d.source_total}))}</span>`:"",E=d.total_amount!==null&&d.total_amount!==void 0?Number(d.total_amount).toLocaleString(void 0,{minimumFractionDigits:2,maximumFractionDigits:2}):'<span class="history-cell-amount-empty">—</span>',I=[];(d.total_amount===null||d.total_amount===void 0)&&I.push(t("field-amount")),d.invoice_no||I.push(t("field-invoice-no")),d.invoice_date||I.push(t("field-invoice-date")),d.seller_name||I.push(t("field-seller-name")),I.length>0&&`${escapeHtml(d.id)}${escapeHtml(t("history-needs-review-tip")+" · "+I.join(" · "))}${escapeHtml(t("history-needs-review-tip"))}${svgIcon("alert",14)}`,d.edited&&`${escapeHtml(t("history-edited",{n:d.edit_count||1}))}`;const B=d.smart_assigned_flag?`<span class="history-badge smart-assigned" title="${escapeHtml(t("history-smart-assigned"))}">${svgIcon("sparkle",11)}</span>`:"",L=d.confidence==="high"?"high":d.confidence==="medium"?"mid":"low",$=d.confidence==="high"?t("conf-high"):d.confidence==="medium"?t("conf-medium"):t("conf-low"),C=`<span class="history-badge conf-${L}">${escapeHtml($)}</span>`;let H="";const R=d.source||"manual";return R==="email"?H=`<span class="history-badge source source-email" title="${escapeHtml(t("history-source-email"))}">${svgIcon("mail",11)}<span>${escapeHtml(t("history-source-email"))}</span></span>`:R==="folder"?H=`<span class="history-badge source source-folder" title="${escapeHtml(t("history-source-folder"))}">${svgIcon("folder",11)}<span>${escapeHtml(t("history-source-folder"))}</span></span>`:R==="api"&&(H=`<span class="history-badge source source-api" title="${escapeHtml(t("history-source-api"))}">${svgIcon("api",11)}<span>${escapeHtml(t("history-source-api"))}</span></span>`),`
            ...
            `}).join(""),ks();const l=a.length>0?_historyState.page*_historyState.pageSize+1:0,m=_historyState.page*_historyState.pageSize+a.length;document.getElementById("history-pager-info").textContent=t("history-pager",{from:l,to:m,total:_historyState.total}),document.getElementById("history-prev").disabled=_historyState.page===0,document.getElementById("history-next").disabled=(_historyState.page+1)*_historyState.pageSize>=_historyState.total}window.loadHistoryPage=xs;window.renderHistoryList=Ai;window.updateHistoryBatchBar=ks;window.clearHistorySelection=cc;typeof currentRoute<"u"&&currentRoute==="history"&&xs();async function Qn(e){try{const n=await fetch(`/api/history/${encodeURIComponent(e)}`,{headers:{Authorization:"Bearer "+token}});if(!n.ok)return;const a=await n.json(),s=mergeFields(a.pages||[]),o={filename:a.filename,pages:a.pages,page_count:a.page_count,elapsed_ms:a.elapsed_ms,engine:"history",merged_fields:s,edits:{},confidence:a.confidence,archive_name:a.archive_name||null,category_tag:a.category_tag||null,_historyId:a.id,_historyMode:!0,client_id:a.client_id||null};_results.push(o),_drawerIdx=_results.length-1,openDrawer(_drawerIdx),pc(),typeof window.bindDrawerClient=="function"&&window.bindDrawerClient(a.id,a.client_id||null),uc(a.id)}catch(n){console.error("open history detail failed",n)}}async function dc(e){await Qn(e),requestAnimationFrame(()=>{const n=document.querySelector('[data-field="total_amount"]');if(n){try{n.focus()}catch{}try{n.select()}catch{}try{n.scrollIntoView({block:"center",behavior:"smooth"})}catch{}}})}function pc(){const e=document.getElementById("drawer-body");if(!e||document.getElementById("drawer-history-save"))return;const n=document.createElement("div");n.id="drawer-history-save",n.className="drawer-history-save-bar",n.innerHTML=`
    ...
    `,e.appendChild(n),document.getElementById("btn-save-history").addEventListener("click",vc),document.getElementById("btn-push-erp").addEventListener("click",mc)}async function uc(e){}async function mc(){showToast(t("erp-push-coming-soon")||"ERP 推送即将开放，敬请期待","info")}async function vc(){const e=_results[_drawerIdx];if(!e||!e._historyId)return;const n=JSON.parse(JSON.stringify(e.pages||[]));if(n.length>0){const s=n.findIndex(l=>!l.is_duplicate&&!l.is_copy),o=s>=0?s:0,i=n[o].fields||(n[o].fields={}),r={...e.edits};r.category_tag!==void 0&&(r.category=r.category_tag,delete r.category_tag),Object.assign(i,r)}const a=document.getElementById("btn-save-history");a&&(a.disabled=!0);try{if(!(await fetch(`/api/history/${encodeURIComponent(e._historyId)}`,{method:"PUT",headers:{Authorization:"Bearer "+token,"Content-Type":"application/json"},body:JSON.stringify({pages:n})})).ok)throw new Error("save failed");showAlert("info",t("history-save-ok")),setTimeout(hideAlerts,1500),closeDrawer(),e._historyMode&&_results.pop(),loadHistoryPage()}catch{showAlert("error",t("history-save-fail")),a&&(a.disabled=!1)}}function fc(e,n){document.querySelectorAll(".history-popover").forEach(d=>d.remove());const a=n.getBoundingClientRect(),s=(_historyState.items||[]).find(d=>d.id===e),o=s&&s.invoice_no?String(s.invoice_no):"",i=s&&s.has_pdf===!0,r=document.createElement("div");r.className="history-popover",r.innerHTML=`
...
`;Ce("camera-tips-modal",yc);async function ea(e){return new Promise(n=>{const a=new FileReader;a.onerror=()=>n({warnings:[],width:0,height:0,brightness:128}),a.onload=()=>{const s=new Image;s.onerror=()=>n({warnings:[],width:0,height:0,brightness:128}),s.onload=()=>{const o=[],i=s.naturalWidth,r=s.naturalHeight;(i<1e3||r<1e3)&&o.push("low_res");try{const l=document.createElement("canvas");l.width=64,l.height=64;const m=l.getContext("2d");m.drawImage(s,0,0,64,64);const d=m.getImageData(0,0,64,64).data;let p=0,c=0;for(let v=0;v<d.length;v+=4)p+=.299*d[v]+.587*d[v+1]+.114*d[v+2],c++;const u=c?p/c:128;u<70?o.push("too_dark"):u>235&&o.push("too_bright"),n({warnings:o,width:i,height:r,brightness:u})}catch{n({warnings:o,width:i,height:r,brightness:128})}},s.src=a.result},a.readAsDataURL(e)})}async function ji(e){if(!e||e.length===0)return null;const{jsPDF:n}=window.jspdf,a=210,s=297,o=new n({unit:"mm",format:"a4",orientation:"p"});for(let d=0;d<e.length;d++){const p=e[d],{dataUrl:c,naturalW:u,naturalH:v}=await wc(p);d>0&&o.addPage("a4","p");const f=u/v;let y=a-10,b=y/f;b>s-10&&(b=s-10,y=b*f);const h=(a-y)/2,g=(s-b)/2,_=p.type==="image/png"?"PNG":"JPEG";o.addImage(c,_,h,g,y,b,void 0,"FAST")}const i=o.output("blob"),r=new Date,l=r.getFullYear().toString()+String(r.getMonth()+1).padStart(2,"0")+String(r.getDate()).padStart(2,"0")+String(r.getHours()).padStart(2,"0")+String(r.getMinutes()).padStart(2,"0")+String(r.getSeconds()).padStart(2,"0"),m=e.length>1?`_${e.length}p`:"";return new File([i],`photo_${l}${m}.pdf`,{type:"application/pdf"})}function wc(e){return new Promise((n,a)=>{const s=new FileReader;s.onerror=a,s.onload=()=>{const o=new Image;o.onerror=a,o.onload=()=>n({dataUrl:s.result,naturalW:o.naturalWidth,naturalH:o.naturalHeight}),o.src=s.result},s.readAsDataURL(e)})}(function(){const n=document.getElementById("upload-alt-row"),a=document.getElementById("gallery-input"),s=document.getElementById("camera-input");if(!n)return;n.style.display="";const o=document.getElementById("btn-scan-doc");o&&s&&(o.addEventListener("click",async()=>{!(localStorage.getItem("mrpilot_camera_tips_skip")==="1")&&!await xc()||s.click()}),s.addEventListener("change",async l=>{const m=Array.from(l.target.files||[]);if(l.target.value="",m.length!==0)for(const d of m)await es([d],"camera")}));const i=document.getElementById("btn-upload-pic");i&&a&&i.addEventListener("click",()=>a.click());const r=l=>async m=>{const d=Array.from(m.target.files||[]);if(m.target.value="",d.length===0)return;const p=d.filter(u=>u.type==="application/pdf"||/\.pdf$/i.test(u.name)),c=d.filter(u=>!p.includes(u));p.length>0&&await kc(p),c.length>0&&await es(c,l)};a&&a.addEventListener("change",r("gallery"))})();async function kc(e){for(const a of e)_selectedFiles.push({file:a,name:a.name,size:a.size,status:"waiting",errorKey:null,errorParams:null});const n=getMaxFiles();_selectedFiles.length>n&&(showAlert("warn",t("alert-file-count",{n})),_selectedFiles=_selectedFiles.slice(0,n)),renderFileList(),updateStartButton()}function xc(){return new Promise(e=>{const n=document.getElementById("camera-tips-modal"),a=document.getElementById("camera-tips-ok"),s=document.getElementById("camera-tips-cancel"),o=document.getElementById("camera-tips-skip");if(!n||!a){e(!0);return}o&&(o.checked=!1),n.style.display="flex";const i=l=>{n.style.display="none",o&&o.checked&&localStorage.setItem("mrpilot_camera_tips_skip","1"),a.onclick=null,s&&(s.onclick=null),n.onclick=null,document.removeEventListener("keydown",r),e(l)},r=l=>{l.key==="Escape"&&i(!1)};a.onclick=()=>i(!0),s&&(s.onclick=()=>i(!1)),n.onclick=l=>{l.target===n&&i(!1)},document.addEventListener("keydown",r),setTimeout(()=>a.focus(),50)})}let Ue=[],Lt=null;async function es(e,n){if(hideAlerts(),!(!e||e.length===0)){var a=typeof window.getOcrDocumentMode=="function"?window.getOcrDocumentMode():"invoice";if(a==="thai_id_card"){for(const o of e)_selectedFiles.push({file:o,name:o.name,size:o.size,status:"waiting",errorKey:null,errorParams:null});const s=getMaxFiles();_selectedFiles.length>s&&(showAlert("warn",t("alert-file-count",{n:s})),_selectedFiles=_selectedFiles.slice(0,s)),renderFileList(),updateStartButton();return}if(typeof window.jspdf>"u"||!window.jspdf.jsPDF){showToast(t("camera-loading"),"info");for(let s=0;s<30&&(await new Promise(o=>setTimeout(o,100)),!(window.jspdf&&window.jspdf.jsPDF));s++);if(!window.jspdf||!window.jspdf.jsPDF){showToast(t("camera-lib-fail"),"error");return}}if(n==="camera"&&e.length===1){const s=e[0];let o={};try{o=await ea(s)}catch{}Ue.push({file:s,quality:o}),Lt="camera",zt();return}if(n==="gallery"&&(e.length>=2||Ue.length>0)){for(const s of e){let o={};try{o=await ea(s)}catch{}Ue.push({file:s,quality:o})}Lt="gallery",zt();return}await Di(e)}}async function _c(e){const n=new Set;for(const s of e)try{((await ea(s)).warnings||[]).forEach(i=>n.add(i))}catch{}try{const s=await ji(e);s&&_selectedFiles.push({file:s,name:s.name,size:s.size,status:"waiting",errorKey:null,errorParams:null})}catch(s){console.error("[camera] convert failed",s),showToast(t("camera-convert-fail"),"error");return}const a=getMaxFiles();_selectedFiles.length>a&&(showAlert("warn",t("alert-file-count",{n:a})),_selectedFiles=_selectedFiles.slice(0,a)),renderFileList(),updateStartButton(),showToast(t("camera-added-merged",{n:e.length}),"success"),n.size>0&&setTimeout(()=>{n.has("too_dark")?showToast(t("camera-quality-dark"),"warn"):n.has("low_res")?showToast(t("camera-quality-lowres"),"warn"):n.has("too_bright")&&showToast(t("camera-quality-overexposed"),"warn")},1e3)}function zt(){let e=document.getElementById("camera-buffer-bar");if(Ue.length===0){e&&e.remove(),Lt=null;return}e||(e=document.createElement("div"),e.id="camera-buffer-bar",e.className="camera-buffer-bar",document.body.appendChild(e));const n=Ue.length,a=n>=2,s=Lt==="gallery",o=s?t("camera-buffer-more-gallery"):t("camera-buffer-more");let i;a?s?i=`
...
`,e.dataset.wbInjected="1";try{const n=window._currentLang||localStorage.getItem("mrpilot_lang")||"th",a=window.I18N;a&&a[n]&&(e.querySelectorAll("[data-i18n]").forEach(s=>{const o=s.getAttribute("data-i18n");o&&a[n][o]&&(s.textContent=a[n][o])}),e.querySelectorAll("[data-i18n-placeholder]").forEach(s=>{const o=s.getAttribute("data-i18n-placeholder");o&&a[n][o]&&(s.placeholder=a[n][o])}))}catch{}}})();(function(){const e=document.getElementById("archive-token-modal");if(!(!e||e.dataset.wbInjected==="1")){e.innerHTML=`
        ...
        `;p.innerHTML=c+u}function r(d){return d==null?"":String(d).replace(/[&<>"']/g,p=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[p])}function l(d){const p=new Date,c=p.getFullYear(),u=p.getMonth()+1;if(d==="all")return"all";if(d==="this-month")return`${c}-${String(u).padStart(2,"0")}`;if(d==="last-month"){const v=new Date(c,u-2,1);return`${v.getFullYear()}-${String(v.getMonth()+1).padStart(2,"0")}`}return d==="this-year"?`${c}`:d==="this-quarter"?`${c}-Q${Math.floor((u-1)/3)+1}`:"all"}window.openReportModal=async function(d){d=d||{},n(),typeof applyLang=="function"?applyLang(currentLang):document.querySelectorAll("#report-modal [data-i18n]").forEach(y=>{const b=y.getAttribute("data-i18n");I18N[currentLang]&&I18N[currentLang][b]&&(y.textContent=I18N[currentLang][b])});const p=document.getElementById("report-period-section");p&&(p.style.display=d.mode==="client"?"":"none");const c=document.getElementById("report-tpl-list");c.innerHTML=`<div class="report-tpl-loading">${r(t("report-modal-loading"))}</div>`,document.getElementById("report-modal").style.display="";const u=await o(currentLang,d&&d.mode);i(u),s=d;const v=document.getElementById("report-modal-download"),f=v.cloneNode(!0);v.parentNode.replaceChild(f,v),f.addEventListener("click",()=>m(s))};async function m(d){if(!d)return;const p=document.querySelector('input[name="report-tpl"]:checked');if(!p){showToast(t("report-toast-no-selection"),"info");return}const c=p.value,u=document.querySelector('input[name="report-period"]:checked'),v=u?u.value:"all",f=l(v),y=document.getElementById("report-modal-download"),b=y.innerHTML;y.disabled=!0,y.innerHTML=`<span>${r(t("report-modal-loading"))}</span>`;try{const h=localStorage.getItem("mrpilot_token");let g,_;if(d.mode==="records")g=await fetch("/api/reports/export",{method:"POST",headers:{Authorization:"Bearer "+h,"Content-Type":"application/json"},body:JSON.stringify({template:c,lang:currentLang,records:d.records||[],meta:d.meta||{}})}),_=`mrpilot-${c}-${Date.now()}.xlsx`;else if(d.mode==="client"){const L=`/api/reports/clients/${d.clientId}/export?template=${encodeURIComponent(c)}&lang=${encodeURIComponent(currentLang)}&month=${encodeURIComponent(f)}`;g=await fetch(L,{headers:{Authorization:"Bearer "+h}}),_=`${(d.clientName||"client").replace(/[^a-zA-Z0-9\u0e00-\u0e7f\u4e00-\u9fff]/g,"_").slice(0,40)}-${c}.xlsx`}else if(d.mode==="history-batch")c==="sales_detail_th"?(g=await fetch("/api/ocr/export-by-history-ids",{method:"POST",headers:{Authorization:"Bearer "+h,"Content-Type":"application/json"},body:JSON.stringify({template:"sales_detail_th",lang:currentLang,history_ids:d.historyIds||[],client_id:d.clientId||null})}),_=`Pearnly_SalesDetail_${Date.now()}.xlsx`):(g=await fetch("/api/reports/history/batch_export",{method:"POST",headers:{Authorization:"Bearer "+h,"Content-Type":"application/json"},body:JSON.stringify({template:c,lang:currentLang,history_ids:d.historyIds||[],client_id:d.clientId||null})}),_=`mrpilot-batch-${c}-${Date.now()}.xlsx`);else throw new Error("unknown mode: "+d.mode);if(!g.ok){let L="HTTP "+g.status;try{const $=await g.json();$&&$.detail&&(L=$.detail)}catch($){console.warn("[batch-export] resp.json err.detail parse failed:",$)}g.status===404?showToast(t("report-toast-empty"),"info"):showToast(t("report-toast-fail")+" · "+L,"error");return}const w=await g.blob();let k=_;const E=(g.headers.get("Content-Disposition")||"").match(/filename\*=UTF-8''([^;]+)/i);if(E)try{k=decodeURIComponent(E[1])}catch{}const I=URL.createObjectURL(w),B=document.createElement("a");B.href=I,B.download=k,document.body.appendChild(B),B.click(),document.body.removeChild(B),URL.revokeObjectURL(I),showToast(t("report-toast-success"),"success"),a()}catch(h){console.error("doDownload fail",h),showToast(t("report-toast-fail")+" · "+(h.message||""),"error")}finally{y.disabled=!1,y.innerHTML=b}}document.addEventListener("DOMContentLoaded",()=>{const d=document.getElementById("btn-export");if(d){const c=d.cloneNode(!0);d.parentNode.replaceChild(c,d),c.addEventListener("click",()=>{if(typeof _results>"u"||!_results||_results.length===0){showToast(t("report-toast-no-selection"),"info");return}openReportModal({mode:"records",records:_results.map(u=>({filename:u.filename,merged_fields:u.merged_fields||{}}))})})}const p=document.getElementById("history-batch-export");p&&p.addEventListener("click",()=>{if(typeof _historySelected>"u"||_historySelected.size===0){showToast(t("report-toast-no-selection"),"info");return}openReportModal({mode:"history-batch",historyIds:Array.from(_historySelected)})})}),window.openClientExportModal=function(d,p){openReportModal({mode:"client",clientId:d,clientName:p||""})}})();const zc=/\.(pdf|jpe?g|png|webp)$/i,Nc="mrpilot_folder_watcher",Oc=1;let jn=null;function ya(){return jn||(jn=new Promise((e,n)=>{const a=indexedDB.open(Nc,Oc);a.onupgradeneeded=s=>{const o=s.target.result;o.objectStoreNames.contains("handles")||o.createObjectStore("handles"),o.objectStoreNames.contains("seen")||o.createObjectStore("seen"),o.objectStoreNames.contains("config")||o.createObjectStore("config")},a.onsuccess=s=>e(s.target.result),a.onerror=s=>n(s.target.error)}),jn)}function ln(e,n){return ya().then(a=>new Promise((s,o)=>{const r=a.transaction(e,"readonly").objectStore(e).get(n);r.onsuccess=()=>s(r.result),r.onerror=()=>o(r.error)}))}function Et(e,n,a){return ya().then(s=>new Promise((o,i)=>{const r=s.transaction(e,"readwrite");r.objectStore(e).put(a,n),r.oncomplete=()=>o(),r.onerror=()=>i(r.error)}))}function sn(e,n){return ya().then(a=>new Promise((s,o)=>{const i=a.transaction(e,"readwrite");i.objectStore(e).delete(n),i.oncomplete=()=>s(),i.onerror=()=>o(i.error)}))}function go(e){return ya().then(n=>new Promise((a,s)=>{const o=n.transaction(e,"readwrite");o.objectStore(e).clear(),o.oncomplete=()=>a(),o.onerror=()=>s(o.error)}))}async function bo(e){if(!e)return!1;try{const n={mode:"read"};let a=await e.queryPermission(n);return a==="granted"?!0:(a=await e.requestPermission(n),a==="granted")}catch(n){return console.warn("[folder] permission check failed:",n),!1}}async function Vc(e){const n=new FormData;n.append("file",e,e.name),n.append("source","folder");const a=await fetch("/api/ocr/recognize?source=folder",{method:"POST",headers:{Authorization:"Bearer "+token,"X-Source":"folder"},body:n});if(!a.ok){let s="http_"+a.status;try{const o=await a.json();s=o&&o.detail?typeof o.detail=="string"?o.detail:o.detail.code||JSON.stringify(o.detail):s}catch{}throw new Error(s)}return await a.json()}async function Uc(e){try{const a=(await e.getFile()).size;return await new Promise(o=>setTimeout(o,3e3)),(await e.getFile()).size===a&&a>0}catch{return!1}}async function Ui(e,n,a,s){if(s>10)return;let o;try{o=await e.queryPermission({mode:"read"})}catch{o="denied"}if(o==="granted")for await(const i of e.values()){const r=n?`${n}/${i.name}`:i.name;if(i.kind==="file"){if(!zc.test(i.name))continue;let l;try{l=await i.getFile()}catch{continue}const m=`${r}::${l.size}::${l.lastModified}`;if(await ln("seen",m))continue;a.push({entry:i,file:l,seenKey:m,relPath:r})}else if(i.kind==="directory")try{await Ui(i,r,a,s+1)}catch{}}}(function(){const n=typeof window<"u"&&"showDirectoryPicker"in window;let a=null,s=null,o=60,i=!1,r=!1,l=0,m=0,d=0,p=[],c=null,u=!1;function v(V,N){const Y=document.getElementById("folder-status-summary");Y&&(Y.setAttribute("data-i18n",V),Y.textContent=t(V),Y.className="auto-status-pill"+(N?" "+N:""))}function f(V){["folder-unsupported","folder-empty","folder-active"].forEach(N=>{const Y=document.getElementById(N);Y&&(Y.style.display=N===V?"":"none")})}function y(V){if(!V)return"-";const N=V instanceof Date?V:new Date(V),Y=String(N.getHours()).padStart(2,"0"),pe=String(N.getMinutes()).padStart(2,"0"),le=String(N.getSeconds()).padStart(2,"0");return`${Y}:${pe}:${le}`}function b(){f("folder-active");const V=document.getElementById("folder-config-path");V&&a&&(V.textContent=a.name||"-");const N=document.getElementById("folder-interval-select");N&&(N.value=String(o)),document.getElementById("folder-stat-last").textContent=c?y(c):"-",document.getElementById("folder-stat-processed").textContent=String(l),document.getElementById("folder-stat-failed").textContent=String(m),document.getElementById("folder-stat-queue").textContent=String(d);const Y=document.getElementById("btn-folder-pause"),pe=document.getElementById("btn-folder-resume");Y&&(Y.style.display=i?"none":""),pe&&(pe.style.display=i?"":"none"),i?v("folder-status-paused","paused"):v("folder-status-running","running");const le=document.getElementById("folder-status-text");le&&(le.setAttribute("data-i18n",i?"folder-status-paused":"folder-status-running"),le.textContent=t(i?"folder-status-paused":"folder-status-running"));const Ne=document.getElementById("folder-status-pulse");Ne&&(Ne.className="folder-status-pulse"+(i?" paused":"")),h()}function h(){const V=document.getElementById("folder-recent-list");if(V){if(p.length===0){V.innerHTML=`<div class="folder-recent-empty">${escapeHtml(t("folder-recent-empty"))}</div>`;return}V.innerHTML=p.slice(0,20).map(N=>{let Y;N.status==="ok"?Y=`<span class="folder-recent-icon ok">${svgIcon("check",12)}</span>`:N.status==="dup"?Y=`<span class="folder-recent-icon dup" title="${escapeHtml(t("folder-recent-dup"))}">${svgIcon("copy",12)}</span>`:N.status==="skip"?Y=`<span class="folder-recent-icon skip" title="${escapeHtml(t("folder-recent-skip"))}">${svgIcon("minus",12)}</span>`:Y=`<span class="folder-recent-icon fail">${svgIcon("alert",12)}</span>`;const pe=N.status==="fail"&&N.error?N.error:N.status==="dup"&&N.reason||N.status==="skip"&&N.reason?N.reason:"",le=pe?`<div class="folder-recent-err">${escapeHtml(pe)}</div>`:"";return`
            ...
            `}).join("")}}function g(V){p.unshift(V),p.length>50&&(p.length=50),Et("config","recent_list",p).catch(()=>{})}async function _(){if(!(r||i||!a)){r=!0;try{if(await a.queryPermission({mode:"read"})!=="granted"){console.warn("[folder] permission lost · stop"),C(),showToast("warn",t("folder-permission-lost"));return}c=new Date;const N=[];await Ui(a,"",N,0),d=N.length,b();for(const Y of N){if(i)break;if(!await Uc(Y.entry)){d=Math.max(0,d-1),b();continue}try{let le;try{le=await Y.entry.getFile()}catch{le=Y.file}const Ne=await Vc(le);await Et("seen",Y.seenKey,{name:le.name,relPath:Y.relPath,size:le.size,lastModified:le.lastModified,processed_at:Date.now()});const _t=Ne.history_ids||(Ne.history_id?[Ne.history_id]:[]),Ma=Ne.duplicate_warnings||[],Aa=Y.relPath||le.name;_t.length>0?(l+=_t.length,g({name:Aa,status:"ok",time:new Date,history_id:_t[0],count:_t.length}),await Et("config","processed_count",l)):Ma.length>0?g({name:Aa,status:"dup",time:new Date,reason:t("folder-recent-dup-reason")}):g({name:Aa,status:"skip",time:new Date,reason:t("folder-recent-skip-reason")})}catch(le){m++,g({name:Y.relPath||Y.file.name,status:"fail",time:new Date,error:String(le.message||le)}),await Et("config","failed_count",m)}d=Math.max(0,d-1),b()}}catch(V){console.warn("[folder] scan error:",V)}finally{r=!1,b()}}}function w(){s&&clearInterval(s),s=setInterval(_,o*1e3)}function k(){s&&(clearInterval(s),s=null)}function x(V){if(!a||i)return;const N=typeof t=="function"?t("folder-unload-warn"):"Folder watcher running · close anyway?";return V.preventDefault(),V.returnValue=N,N}function E(){window._pearnlyFolderUnloadAttached||(window._pearnlyFolderUnloadAttached=!0,window.addEventListener("beforeunload",x))}function I(){window._pearnlyFolderUnloadAttached&&(window._pearnlyFolderUnloadAttached=!1,window.removeEventListener("beforeunload",x))}function B(){i=!1,w(),E(),b(),_()}function L(){i=!0,k(),I(),b()}function $(){i=!1,w(),E(),b(),_()}function C(){i=!0,k(),I()}async function H(){try{const V=await window.showDirectoryPicker({mode:"read",startIn:"documents"});if(!await bo(V)){showToast("warn",t("folder-permission-denied"));return}a=V,await Et("handles","main",V),l=0,m=0,d=0,p=[],await Et("config","processed_count",0),await Et("config","failed_count",0),await go("seen"),B()}catch(V){V&&V.name!=="AbortError"&&console.warn("[folder] pick failed:",V)}}async function R(){await showConfirm(t("folder-confirm-remove"),{danger:!0})&&(C(),a=null,l=0,m=0,d=0,p=[],await sn("handles","main"),await sn("config","processed_count"),await sn("config","failed_count"),await go("seen"),f("folder-empty"),v("folder-status-empty",""))}async function G(){p=[];try{await sn("config","recent_list")}catch{}h()}async function se(){if(u)return;if(u=!0,!n){f("folder-unsupported"),v("folder-status-unsupported",""),we();return}de();let V=null;try{V=await ln("handles","main")}catch{}if(!V){f("folder-empty"),v("folder-status-empty","");return}if(!await bo(V)){f("folder-empty"),v("folder-status-empty",""),await sn("handles","main"),showToast("warn",t("folder-permission-lost-restart"));return}a=V;try{l=await ln("config","processed_count")||0}catch{}try{m=await ln("config","failed_count")||0}catch{}try{const Y=await ln("config","recent_list");Array.isArray(Y)&&(p=Y.map(pe=>({...pe,time:pe.time?new Date(pe.time):new Date})))}catch{}B()}function de(){const V=document.getElementById("btn-folder-pick"),N=document.getElementById("btn-folder-pause"),Y=document.getElementById("btn-folder-resume"),pe=document.getElementById("btn-folder-scan-now"),le=document.getElementById("btn-folder-remove"),Ne=document.getElementById("btn-folder-clear-recent"),_t=document.getElementById("folder-interval-select");V&&V.addEventListener("click",H),N&&N.addEventListener("click",L),Y&&Y.addEventListener("click",$),pe&&pe.addEventListener("click",()=>{_()}),le&&le.addEventListener("click",R),Ne&&Ne.addEventListener("click",G),_t&&_t.addEventListener("change",Ma=>{o=parseInt(Ma.target.value,10)||60,i||w()}),Ie()}function Ie(){document.querySelectorAll('[data-auto-panel="folder"] [data-tab-jump]').forEach(V=>{V.dataset.tabJumpBound||(V.dataset.tabJumpBound="1",V.addEventListener("click",N=>{const Y=N.currentTarget.dataset.tabJump;if(Y==="email")typeof switchAutomationTab=="function"&&switchAutomationTab("email");else if(Y==="upload"){const pe=document.querySelector('[data-page="recognize"]')||document.querySelector('[data-page="upload"]');pe&&pe.click()}}))})}function we(){Ie()}window._loadFolderWatcherPanel=se})();function Gc(){try{if(navigator.userAgentData&&Array.isArray(navigator.userAgentData.brands))return navigator.userAgentData.brands.some(n=>/chromium|google chrome|microsoft edge/i.test(n.brand||""))}catch{}const e=navigator.userAgent||"";return!!(/Edg\//.test(e)||/Chrome\//.test(e)&&!/OPR\/|YaBrowser|Opera/.test(e))}function ns(){try{if(Gc()||localStorage.getItem("pearnly_chrome_banner_dismissed")==="1")return;const e=document.getElementById("chrome-only-banner");if(!e)return;const n=e.querySelector('[data-i18n="chrome-banner-msg"]'),a=e.querySelector('[data-i18n="chrome-banner-dismiss"]');n&&typeof t=="function"&&(n.textContent=t("chrome-banner-msg")),a&&typeof t=="function"&&(a.textContent=t("chrome-banner-dismiss")),e.style.display="";const s=document.getElementById("chrome-only-banner-close");s&&!s.dataset.bound&&(s.dataset.bound="1",s.addEventListener("click",()=>{e.style.display="none";try{localStorage.setItem("pearnly_chrome_banner_dismissed","1")}catch{}}))}catch{}}typeof document<"u"&&(document.readyState==="loading"?document.addEventListener("DOMContentLoaded",ns):setTimeout(ns,0));window._refreshChromeBanner=ns;const Wc=`
        <div class="modal">
            <div class="modal-head">
    ...
    `;Ce("email-modal",Wc);const F={account:null,presets:null,modalMode:"new",loaded:!1,triggering:!1,autoRefreshTimer:null};function yo(e){F.modalMode=e;const n=document.getElementById("email-modal");if(!n)return;const a=document.getElementById("email-preset");a.innerHTML="";const s=F.presets||{},o=["gmail","outlook","yahoo","icloud","qq","163","custom"],i={gmail:"Gmail",outlook:"Outlook / Office365",yahoo:"Yahoo Mail",icloud:"iCloud",qq:"QQ 邮箱",163:"网易 163"};o.forEach(h=>{if(!s[h])return;const g=document.createElement("option");g.value=h,g.textContent=h==="custom"?t("email-preset-custom"):i[h]||h,a.appendChild(g)});const r=document.getElementById("email-modal-title"),l=document.getElementById("email-address"),m=document.getElementById("email-password"),d=document.getElementById("email-imap-host"),p=document.getElementById("email-imap-port"),c=document.getElementById("email-imap-ssl"),u=document.getElementById("email-folder"),v=document.getElementById("email-mark-read"),f=document.getElementById("email-bind-enabled"),y=document.getElementById("email-test-result"),b=document.getElementById("email-adv-details");if(y&&(y.style.display="none",y.textContent=""),e==="edit"&&F.account){r.setAttribute("data-i18n","email-modal-title-edit"),r.textContent=t("email-modal-title-edit"),l.value=F.account.email_address||"",m.value="",m.setAttribute("data-i18n-placeholder","email-field-password-edit-ph"),m.placeholder=t("email-field-password-edit-ph"),d.value=F.account.imap_host||"",p.value=F.account.imap_port||993,c.checked=F.account.imap_use_ssl!==!1,u.value=F.account.folder||"INBOX",v.checked=F.account.mark_as_read!==!1,f.checked=F.account.enabled!==!1;const h=document.getElementById("email-filter-sender"),g=document.getElementById("email-filter-subject");h&&(h.value=F.account.filter_sender||""),g&&(g.value=F.account.filter_subject||""),ko(F.account.interval_min||15),a.value=Yc(F.account.imap_host)||"custom",b&&(b.open=!0)}else{r.setAttribute("data-i18n","email-modal-title-new"),r.textContent=t("email-modal-title-new"),l.value="",m.value="",m.setAttribute("data-i18n-placeholder","email-field-password-ph"),m.placeholder=t("email-field-password-ph"),a.value="gmail",Ts("gmail"),u.value="INBOX",v.checked=!0,f.checked=!0;const h=document.getElementById("email-filter-sender"),g=document.getElementById("email-filter-subject");h&&(h.value=""),g&&(g.value=""),ko(15),b&&(b.open=!1)}Jc(),n.style.display="flex",setTimeout(()=>l.focus(),60)}function qa(){const e=document.getElementById("email-modal");e&&(e.style.display="none")}function Ts(e){const n=(F.presets||{})[e];if(!n||e==="custom")return;const a=document.getElementById("email-imap-host"),s=document.getElementById("email-imap-port"),o=document.getElementById("email-imap-ssl");a&&(a.value=n.host||""),s&&(s.value=n.port||993),o&&(o.checked=n.ssl!==!1)}const Kc={"gmail.com":"gmail","googlemail.com":"gmail","outlook.com":"outlook","hotmail.com":"outlook","live.com":"outlook","office365.com":"outlook","msn.com":"outlook","yahoo.com":"yahoo","yahoo.co.jp":"yahoo","icloud.com":"icloud","me.com":"icloud","mac.com":"icloud","qq.com":"qq","foxmail.com":"qq","163.com":"163","126.com":"163","yeah.net":"163"};function wo(e){if(!e||!e.includes("@"))return;const n=e.split("@")[1].toLowerCase().trim(),a=Kc[n];if(!a)return;const s=document.getElementById("email-preset");if(!s)return;const o=s.value;o&&o!=="custom"&&o!==""&&o===a||(s.value=a,Ts(a))}function Yc(e){if(!e)return null;const n=F.presets||{};for(const a in n)if(a!=="custom"&&n[a]&&n[a].host===e)return a;return null}function Gi(){const e=document.querySelector("#email-interval-options .email-interval-btn.active"),n=e?parseInt(e.dataset.interval,10):15;return{email_address:(document.getElementById("email-address").value||"").trim(),password:document.getElementById("email-password").value||"",imap_host:(document.getElementById("email-imap-host").value||"").trim(),imap_port:parseInt(document.getElementById("email-imap-port").value||"993",10)||993,imap_use_ssl:document.getElementById("email-imap-ssl").checked,folder:(document.getElementById("email-folder").value||"INBOX").trim()||"INBOX",mark_as_read:document.getElementById("email-mark-read").checked,enabled:document.getElementById("email-bind-enabled").checked,interval_min:[5,15,60].includes(n)?n:15,filter_sender:(document.getElementById("email-filter-sender").value||"").trim()||null,filter_subject:(document.getElementById("email-filter-subject").value||"").trim()||null}}function Jc(){const e=document.getElementById("email-interval-options");!e||e._bound||(e._bound=!0,e.addEventListener("click",n=>{const a=n.target.closest(".email-interval-btn");a&&(e.querySelectorAll(".email-interval-btn").forEach(s=>s.classList.remove("active")),a.classList.add("active"))}))}function ko(e){const n=[5,15,60].includes(e)?e:15,a=document.getElementById("email-interval-options");a&&a.querySelectorAll(".email-interval-btn").forEach(s=>{s.classList.toggle("active",parseInt(s.dataset.interval,10)===n)})}function He(e,n){const a=document.getElementById("email-test-result");a&&(a.style.display="",a.textContent=n,a.className="form-test-result "+(e==="ok"?"ok":e==="running"?"running":"fail"))}async function Xc(){const e=Gi();if(!e.email_address){He("fail",t("email-addr-required"));return}if(!e.password){He("fail",t("email-password-required"));return}if(!e.imap_host){He("fail",t("email-host-required"));return}const n=document.getElementById("btn-email-modal-test");n&&(n.disabled=!0),He("running",t("email-test-running"));try{const a=await fetch("/api/email-ingest/test",{method:"POST",headers:{Authorization:"Bearer "+token,"Content-Type":"application/json"},body:JSON.stringify({email_address:e.email_address,password:e.password,imap_host:e.imap_host,imap_port:e.imap_port,imap_use_ssl:e.imap_use_ssl,folder:e.folder})}),s=await a.json().catch(()=>({}));if(a.ok&&s.success)He("ok",t("email-test-ok",{folder:e.folder,n:s.folder_count??"?"}));else{const o=s.error_msg||"";o==="auth_failed"||/auth/i.test(o)?He("fail",t("email-test-auth-fail")):He("fail",t("email-test-fail",{msg:o||a.status}))}}catch(a){He("fail",t("email-test-fail",{msg:String(a).slice(0,120)}))}finally{n&&(n.disabled=!1)}}(function(){async function e(){const u=document.getElementById("email-empty"),v=document.getElementById("email-account-card");if(document.getElementById("email-logs-section"),!(!u||!v))try{const f=await fetch("/api/email-ingest/account",{headers:{Authorization:"Bearer "+token}});if(f.status===401){localStorage.removeItem("mrpilot_token");const b=await f.json().catch(()=>({}));if((typeof b.detail=="string"?b.detail:b.detail&&b.detail.code||"")==="auth.session_revoked"){_showSessionRevokedModal();return}window.location.href="/";return}if(!f.ok){a("none");return}const y=await f.json();F.account=y.account||null,F.presets=y.presets||{},F.loaded=!0,n(),F.account&&d()}catch(f){console.error("[email-ingest] load failed",f),a("none")}}function n(){const u=document.getElementById("email-empty"),v=document.getElementById("email-account-card"),f=document.getElementById("email-logs-section");if(!F.account){u.style.display="",v.style.display="none",f&&(f.style.display="none"),a("none");return}u.style.display="none",v.style.display="",f&&(f.style.display="");const y=document.getElementById("email-account-addr"),b=document.getElementById("email-account-host"),h=document.getElementById("email-account-last"),g=document.getElementById("email-last-error"),_=document.getElementById("email-enabled-toggle");if(y&&(y.textContent=F.account.email_address||"-"),b&&(b.textContent=`${F.account.imap_host||"-"}:${F.account.imap_port||993}`),h){const w=F.account.last_fetched_at;if(!w)h.textContent=t("email-last-never");else{const k=s(w),x=!F.account.last_error;h.textContent=x?t("email-last-ok",{time:k}):t("email-last-fail",{time:k})}}g&&(F.account.last_error?(g.style.display="",g.textContent=o(F.account.last_error)):g.style.display="none"),_&&(_.checked=!!F.account.enabled),F.account.enabled?F.account.last_error?a("error"):a("on"):a("off")}function a(u){const v=document.getElementById("email-status-summary");if(!v)return;v.classList.remove("none","ready","active","coming");let f="auto-status-loading";u==="none"?(f="email-status-none",v.classList.add("none")):u==="on"?(f="email-status-on",v.classList.add("active")):u==="off"?(f="email-status-off",v.classList.add("coming")):u==="error"&&(f="email-status-error",v.classList.add("none")),v.setAttribute("data-i18n",f),v.textContent=t(f)}function s(u){if(!u)return"";const v=new Date(u);if(isNaN(v.getTime()))return"";const f=y=>String(y).padStart(2,"0");return`${f(v.getMonth()+1)}-${f(v.getDate())} ${f(v.getHours())}:${f(v.getMinutes())}`}function o(u){if(!u)return"";const v=String(u);return/auth|AUTHENTICATIONFAILED|invalid credentials/i.test(v)?t("email-test-auth-fail"):/timeout|timed out/i.test(v)?t("email.timeout"):(/ENOTFOUND|getaddrinfo/i.test(v),v)}async function i(){const u=Gi();if(!u.email_address){He("fail",t("email-addr-required"));return}if(F.modalMode==="new"&&!u.password){He("fail",t("email-password-required"));return}if(!u.imap_host){He("fail",t("email-host-required"));return}const v=document.getElementById("btn-email-modal-save");v&&(v.disabled=!0);const f={...u};F.modalMode==="edit"&&!f.password&&delete f.password;try{const y=await fetch("/api/email-ingest/account",{method:"PUT",headers:{Authorization:"Bearer "+token,"Content-Type":"application/json"},body:JSON.stringify(f)}),b=await y.json().catch(()=>({}));if(y.ok&&b.ok)F.account=b.account,showToast(t("email-save-ok"),"success"),qa(),n(),d();else{const g="email."+(b.detail||"").split(".").slice(-1)[0];He("fail",t(g)!==g?t(g):t("email-save-fail"))}}catch{He("fail",t("email-save-fail"))}finally{v&&(v.disabled=!1)}}async function r(){if(!(!F.account||!await showConfirm(t("email-unbind-confirm",{email:F.account.email_address}),{danger:!0,okText:t("email-btn-unbind")})))try{if((await fetch("/api/email-ingest/account",{method:"DELETE",headers:{Authorization:"Bearer "+token}})).ok){F.account=null,showToast(t("email-unbind-ok"),"success"),n();const f=document.getElementById("email-logs-list");f&&(f.innerHTML="")}else showToast(t("email-unbind-fail"),"error")}catch{showToast(t("email-unbind-fail"),"error")}}async function l(){if(!F.account||F.triggering)return;if(!F.account.enabled){showToast(t("email.disabled"),"error");return}F.triggering=!0;const u=document.getElementById("btn-email-trigger"),v=u?u.innerHTML:"";u&&(u.disabled=!0,u.innerHTML=`<span>${escapeHtml(t("email-trigger-running"))}</span>`);try{const f=await fetch("/api/email-ingest/trigger",{method:"POST",headers:{Authorization:"Bearer "+token}}),y=await f.json().catch(()=>({}));if(f.ok){const b=y.emails_scanned||0,h=y.ocr_succeeded||0,g=y.ocr_failed||0;b===0&&h===0&&g===0?showToast(t("email-trigger-empty"),"success"):showToast(t("email-trigger-result",{scanned:b,ok:h,fail:g}),g>0?"warn":"success")}else{const h="email."+(y.detail||"").split(".").slice(-1)[0];showToast(t(h)!==h?t(h):t("email-trigger-fail"),"error")}await e()}catch{showToast(t("email-trigger-fail"),"error")}finally{F.triggering=!1,u&&(u.disabled=!1,u.innerHTML=v)}}async function m(){if(!F.account)return;const u=document.getElementById("email-enabled-toggle"),v=!!(u&&u.checked),f=F.account.enabled;try{const y=await fetch("/api/email-ingest/account",{method:"PUT",headers:{Authorization:"Bearer "+token,"Content-Type":"application/json"},body:JSON.stringify({email_address:F.account.email_address,imap_host:F.account.imap_host,imap_port:F.account.imap_port,imap_use_ssl:F.account.imap_use_ssl,folder:F.account.folder||"INBOX",filter_subject:F.account.filter_subject||null,filter_sender:F.account.filter_sender||null,mark_as_read:F.account.mark_as_read!==!1,enabled:v})}),b=await y.json().catch(()=>({}));y.ok&&b.ok?(F.account=b.account,n()):(u&&(u.checked=f),showToast(t("email-toggle-fail"),"error"))}catch{u&&(u.checked=f),showToast(t("email-toggle-fail"),"error")}}async function d(){const u=document.getElementById("email-logs-list");if(u){u.innerHTML=`<div class="erp-logs-empty">${escapeHtml(t("erp-logs-loading"))}</div>`;try{const v=await fetch("/api/email-ingest/logs?limit=20",{headers:{Authorization:"Bearer "+token}});if(!v.ok){u.innerHTML=`<div class="erp-logs-empty">${escapeHtml(t("erp-logs-error"))}</div>`;return}const f=await v.json();if(!Array.isArray(f)||f.length===0){u.innerHTML=`<div class="erp-logs-empty">${escapeHtml(t("email-logs-empty"))}</div>`;return}u.innerHTML=f.map(p).join("")}catch{u.innerHTML=`<div class="erp-logs-empty">${escapeHtml(t("erp-logs-error"))}</div>`}}}function p(u){const v=s(u.created_at),f=u.status||"failed",y=f==="success"?"ok":f==="partial"?"partial":"fail",b=f==="success"?"✓":f==="partial"?"◐":"✗",h=u.trigger==="manual"?`<span class="log-tag manual">${escapeHtml(t("email-log-tag-manual"))}</span>`:`<span class="log-tag auto">${escapeHtml(t("email-log-tag-auto"))}</span>`,g=t("email-log-counts",{scanned:u.emails_scanned||0,att:u.attachments_found||0,ok:u.ocr_succeeded||0,fail:u.ocr_failed||0}),_=(u.elapsed_ms||0)+"ms";return`
        ...
        `}function c(){const u=document.getElementById("btn-email-bind");u&&u.addEventListener("click",()=>yo("new"));const v=document.getElementById("btn-email-edit");v&&v.addEventListener("click",()=>yo("edit"));const f=document.getElementById("btn-email-unbind");f&&f.addEventListener("click",r);const y=document.getElementById("btn-email-trigger");y&&y.addEventListener("click",l);const b=document.getElementById("email-enabled-toggle");b&&b.addEventListener("change",m);const h=document.getElementById("email-modal-close");h&&h.addEventListener("click",qa);const g=document.getElementById("btn-email-modal-cancel");g&&g.addEventListener("click",qa);const _=document.getElementById("btn-email-modal-test");_&&_.addEventListener("click",Xc);const w=document.getElementById("btn-email-modal-save");w&&w.addEventListener("click",i);const k=document.getElementById("email-preset");k&&k.addEventListener("change",I=>Ts(I.target.value));const x=document.getElementById("email-address");x&&!x.dataset.autoBound&&(x.dataset.autoBound="1",x.addEventListener("blur",I=>wo((I.target.value||"").trim())),x.addEventListener("input",I=>{const B=(I.target.value||"").trim();B.includes("@")&&B.split("@")[1].includes(".")&&wo(B)}));const E=document.getElementById("btn-email-refresh-logs");E&&E.addEventListener("click",()=>{E.classList.add("spinning"),setTimeout(()=>E.classList.remove("spinning"),600),d()})}c(),window._loadEmailIngestPanel=e,window._rerenderEmailIngest=function(){if(!F.loaded)return;n();const u=document.getElementById("email-logs-section");F.account&&u&&u.open&&d()},window._startEmailLogAutoRefresh=function(){F.autoRefreshTimer||(F.autoRefreshTimer=setInterval(()=>{F.account&&F.loaded&&d()},3e4))},window._stopEmailLogAutoRefresh=function(){F.autoRefreshTimer&&(clearInterval(F.autoRefreshTimer),F.autoRefreshTimer=null)}})();const Zc=`
...
`;Ce("bank-cand-drawer",Zc);const Qc=`
    <div class="modal" style="max-width: 420px;">
        <div class="modal-head">
...
`;Ce("bank-client-picker-modal",Qc);const M={sessions:[],currentSession:null,currentTxs:[],currentFilter:"all",currentTxForDrawer:null,loaded:!1,queue:[],qSeq:0,sessionFilter:"all",pickerSelected:null};function ed(e){const n=Number(e||0);let a="score-low";return n>=85?a="score-high":n>=60&&(a="score-mid"),'<span class="bank-cand-score '+a+'">'+n.toFixed(0)+" "+t("bank-cand-score-unit")+"</span>"}function td(e){const n=document.getElementById("bank-upload-progress");n&&(n.style.display="none")}function nd(){const e=document.getElementById("bank-upload-error");e&&(e.style.display="none")}function ad(e){return{"bank_recon.only_pdf":t("bank-err-only-pdf"),"bank_recon.empty_file":t("bank-err-empty"),"bank_recon.file_too_large":t("bank-err-too-large"),"bank_recon.save_failed":t("bank-err-server"),"bank_recon.scanned":t("bank-err-scanned"),"bank_recon.no_tx":t("bank-err-no-tx"),network:t("bank-err-network")}[e]||t("bank-err-unknown")+" ("+e+")"}function Ct(e){if(e==null)return"-";const n=Number(e);return isNaN(n)?"-":n.toLocaleString("en-US",{minimumFractionDigits:2,maximumFractionDigits:2})}function Kt(e){if(!e)return"-";const n=String(e);return n.length>=10?n.slice(0,10):n}function Wi(e,n){return!e&&!n?"":(Kt(e)||"?")+" ~ "+(Kt(n)||"?")}function X(e){return e==null?"":String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}async function sd(e){M.currentTxForDrawer=e;const n=document.getElementById("bank-detail-body");n&&n.classList.add("has-pane");const a=document.getElementById("bank-cand-pane-title"),s=document.getElementById("bank-cand-pane-sub"),o=document.getElementById("bank-cand-pane-foot");if(a&&(a.textContent=t("bank-cand-pane-current")),s){const r=e.direction==="OUT"?"-":"+",l=e.direction==="OUT"?"bank-out":"bank-in";s.innerHTML=`${X(Kt(e.tx_date))}
            <span style="margin:0 6px;color:#D1D5DB">·</span>
            <span>${X(e.description||"-")}</span>
            <span style="margin:0 6px;color:#D1D5DB">·</span>
            <strong class="${l}">${r}${Ct(e.amount)}</strong>`}o&&(o.style.display="");const i=document.getElementById("bank-cand-pane-body");if(i){i.innerHTML=`<div class="bank-empty">${t("bank-cand-loading")}</div>`;try{const r=await fetch("/api/bank-recon/tx/"+encodeURIComponent(e.id)+"/candidates",{headers:{Authorization:"Bearer "+token}});if(!r.ok)throw new Error("cands:"+r.status);const l=await r.json();id(e,l.candidates||[])}catch{i.innerHTML=`<div class="bank-empty">${t("bank-cand-load-failed")}</div>`}}}function od(e,n,a){const s=n.history_id,o=n.invoice_no||"-",i=n.vendor||"-",r=n.amount_total!==null&&n.amount_total!==void 0?Ct(n.amount_total):"-",l=n.invoice_date?Kt(n.invoice_date):"-",m=n.filename||"",d=!!a&&e.matched_history_id===s,p="bank-cand-card"+(n.is_auto_picked?" is-auto":"")+(d?" is-picked":"");let c="";return d?c='<button class="btn btn-ghost btn-small" data-act="unmatch"><span>'+t("bank-cand-unmatch")+"</span></button>":c='<button class="btn btn-primary btn-small" data-act="pick" data-hid="'+X(s)+'"><span>'+t(n.is_auto_picked?"bank-cand-confirm":"bank-cand-pick-this")+"</span></button>",'<div class="'+p+'" data-hid="'+X(s)+'"><div class="bank-cand-card-head"><div class="bank-cand-card-vendor">'+X(i)+"</div>"+ed(n.score)+'</div><div class="bank-cand-card-fields"><span class="bank-cand-field"><span class="bank-cand-flabel">'+t("bank-cand-fld-invoice-no")+"</span> "+X(o)+'</span><span class="bank-cand-field"><span class="bank-cand-flabel">'+t("bank-cand-fld-amount")+"</span> "+r+'</span><span class="bank-cand-field"><span class="bank-cand-flabel">'+t("bank-cand-fld-date")+"</span> "+X(l)+"</span></div>"+(m?'<div class="bank-cand-card-file" title="'+X(m)+'">'+X(m)+"</div>":"")+(n.reason?'<div class="bank-cand-card-reason">'+X(n.reason)+"</div>":"")+'<div class="bank-cand-card-actions">'+c+"</div></div>"}function id(e,n){const a=document.getElementById("bank-cand-pane-body");if(!a)return;const s=n||[];let o="";if(e.match_status==="matched")o='<div class="bank-cand-hint hint-matched">'+t("bank-cand-hint-matched").replace("{n}",s.length)+"</div>";else if(e.match_status==="suggested")o='<div class="bank-cand-hint hint-suggested">'+t("bank-cand-hint-suggested").replace("{n}",s.length)+"</div>";else if(s.length>0)o='<div class="bank-cand-hint hint-low">'+t("bank-cand-hint-low").replace("{n}",s.length)+"</div>";else{a.innerHTML='<div class="bank-empty">'+t("bank-cand-no-match-detail")+"</div>";return}const i=e.match_status==="matched",r=s.map(l=>od(e,l,i)).join("");a.innerHTML=o+'<div class="bank-cand-list">'+r+"</div>",a.querySelectorAll('[data-act="pick"]').forEach(l=>{l.addEventListener("click",()=>{cd(l.dataset.hid)})}),a.querySelectorAll('[data-act="unmatch"]').forEach(l=>{l.addEventListener("click",async()=>{try{await fetch("/api/bank-recon/tx/"+encodeURIComponent(e.id)+"/override",{method:"POST",headers:{Authorization:"Bearer "+token,"Content-Type":"application/json"},body:JSON.stringify({status:"unmatched"})}),_n(),await Zt(M.currentSession.id)}catch{showToast(t("bank-action-failed"),"error")}})})}function _n(){const e=document.getElementById("bank-detail-body");e&&e.classList.remove("has-pane");const n=document.getElementById("bank-cand-pane-title"),a=document.getElementById("bank-cand-pane-sub"),s=document.getElementById("bank-cand-pane-body"),o=document.getElementById("bank-cand-pane-foot");n&&(n.textContent=t("bank-cand-pane-empty-title")),a&&(a.textContent=t("bank-cand-pane-empty-sub")),o&&(o.style.display="none"),s&&(s.innerHTML='<div class="bank-cand-pane-empty"><svg viewBox="0 0 64 64" fill="none" stroke="currentColor" stroke-width="1.4" stroke-linecap="round" stroke-linejoin="round"><rect x="14" y="10" width="36" height="44" rx="3"/><path d="M22 22h20M22 30h20M22 38h12"/></svg><div>'+t("bank-cand-pane-empty-hint")+"</div></div>");const i=document.getElementById("bank-tx-tbody");i&&i.querySelectorAll("tr.is-selected").forEach(r=>r.classList.remove("is-selected")),M.currentTxForDrawer=null}async function Zt(e){try{const n="/api/bank-recon/sessions/"+encodeURIComponent(e)+(M.currentFilter!=="all"?"?filter="+M.currentFilter:""),a=await fetch(n,{headers:{Authorization:"Bearer "+token}});if(!a.ok)throw new Error("detail:"+a.status);const s=await a.json();M.currentSession=s.session,M.currentTxs=s.transactions||[],fd()}catch(n){console.warn("[bank-recon] loadSessionDetail failed",n),showToast(t("bank-load-failed"),"error")}}async function rd(){if(!M.currentSession)return;const e=document.getElementById("btn-bank-run-match"),n=e.innerHTML;e.disabled=!0,e.innerHTML="<span>"+t("bank-matching")+"</span>";try{const a=await fetch("/api/bank-recon/sessions/"+encodeURIComponent(M.currentSession.id)+"/match",{method:"POST",headers:{Authorization:"Bearer "+token}});if(!a.ok)throw new Error("match:"+a.status);const s=await a.json();showToast(t("bank-match-done").replace("{matched}",s.matched).replace("{suggested}",s.suggested).replace("{unmatched}",s.unmatched),"success"),await Zt(M.currentSession.id),await Qt()}catch(a){console.warn("[bank-recon] match failed",a),showToast(t("bank-match-failed"),"error")}finally{e.disabled=!1,e.innerHTML=n}}async function ld(){if(!(!M.currentSession||!await showConfirm(t("bank-delete-confirm"),{danger:!0})))try{const n=await fetch("/api/bank-recon/sessions/"+encodeURIComponent(M.currentSession.id),{method:"DELETE",headers:{Authorization:"Bearer "+token}});if(!n.ok)throw new Error("delete:"+n.status);showToast(t("bank-deleted"),"success"),M.currentSession=null,M.currentTxs=[],As(),await Qt()}catch(n){console.warn("[bank-recon] delete failed",n),showToast(t("bank-delete-failed"),"error")}}async function xo(){if(M.currentTxForDrawer)try{const e=await fetch("/api/bank-recon/tx/"+encodeURIComponent(M.currentTxForDrawer.id)+"/override",{method:"POST",headers:{Authorization:"Bearer "+token,"Content-Type":"application/json"},body:JSON.stringify({status:"ignored"})});if(!e.ok)throw new Error("ignore:"+e.status);_n(),await Zt(M.currentSession.id)}catch{showToast(t("bank-action-failed"),"error")}}async function cd(e){if(M.currentTxForDrawer)try{const n=await fetch("/api/bank-recon/tx/"+encodeURIComponent(M.currentTxForDrawer.id)+"/override",{method:"POST",headers:{Authorization:"Bearer "+token,"Content-Type":"application/json"},body:JSON.stringify({status:"matched",history_id:e})});if(!n.ok)throw new Error("pick:"+n.status);showToast(t("bank-matched-ok"),"success"),_n(),await Zt(M.currentSession.id)}catch{showToast(t("bank-action-failed"),"error")}}function Ki(){if(!M.currentSession)return;const e=M.currentSession;document.getElementById("bank-detail-title").textContent=(e.bank_code||"-")+(e.account_last4?" ···"+e.account_last4:"")+" · "+(e.source_filename||""),document.getElementById("bank-meta-period").textContent=Wi(e.period_start,e.period_end)||"-",document.getElementById("bank-meta-opening").textContent=Ct(e.opening_balance),document.getElementById("bank-meta-inflow").textContent="+"+Ct(e.total_inflow),document.getElementById("bank-meta-outflow").textContent="-"+Ct(e.total_outflow),document.getElementById("bank-meta-closing").textContent=Ct(e.closing_balance);const n=M.currentTxs||[],a=n.length;let s=0,o=0,i=0;for(const r of n){const l=r.match_status||"unmatched";l==="matched"?s++:l==="suggested"?o++:i++}document.getElementById("bank-stat-total").textContent=a,document.getElementById("bank-stat-matched").textContent=s,document.getElementById("bank-stat-suggested").textContent=o,document.getElementById("bank-stat-unmatched").textContent=i}function Hs(){const e=document.getElementById("bank-tx-tbody");if(!e)return;let n=M.currentTxs||[];if(M.currentFilter!=="all"&&(n=n.filter(a=>M.currentFilter==="matched"?a.match_status==="matched":M.currentFilter==="suggested"?a.match_status==="suggested":M.currentFilter==="unmatched"?a.match_status==="unmatched"||a.match_status==="ignored":!0)),n.length===0){e.innerHTML=`<tr><td colspan="4" class="bank-empty">${t("bank-tx-empty")}</td></tr>`;return}if(e.innerHTML=n.map(a=>dd(a)).join(""),e.querySelectorAll("tr[data-tx-id]").forEach(a=>{a.addEventListener("click",()=>{const s=a.dataset.txId,o=M.currentTxs.find(i=>i.id===s);o&&(e.querySelectorAll("tr.is-selected").forEach(i=>i.classList.remove("is-selected")),a.classList.add("is-selected"),sd(o))})}),M.currentTxForDrawer){const a=e.querySelector('tr[data-tx-id="'+M.currentTxForDrawer.id+'"]');a&&a.classList.add("is-selected")}}function dd(e){const n=e.direction==="OUT",a=n?"-":"+",s=n?"bank-out":"bank-in",o=e.match_status||"unmatched",i=t("bank-match-"+o)||o,r=Kt(e.tx_date),l=e.channel?`<span class="bank-tx-channel">${X(e.channel)}</span>`:"";return`
    ...
    `}function Ms(){const e=document.getElementById("bank-client-badge");if(!e||!M.currentSession)return;const n=M.currentSession.client_id,a=document.getElementById("bank-client-badge-dot"),s=document.getElementById("bank-client-badge-name"),o=document.getElementById("bank-client-badge-caret"),i=typeof _userInfo<"u"?_userInfo:null,r=!(i&&i.role==="member");if(n!=null){const l=(window._clientsCache||[]).find(m=>Number(m.id)===Number(n));e.classList.remove("is-empty"),a&&(a.style.background=l&&l.color||"#111111"),s&&(s.textContent=l&&(l.short_name||l.name)||"#"+n)}else e.classList.add("is-empty"),a&&(a.style.background=""),s&&(s.textContent=t("bank-client-none"));r?(e.classList.remove("is-readonly"),e.disabled=!1,o&&(o.style.display="")):(e.classList.add("is-readonly"),e.disabled=!0,o&&(o.style.display="none")),e.style.display=""}function pd(){if(!M.currentSession)return;const e=typeof _userInfo<"u"?_userInfo:null;if(!!(e&&e.role==="member"))return;M.pickerSelected=M.currentSession.client_id!=null?Number(M.currentSession.client_id):null,Ji();const a=document.getElementById("bank-client-picker-modal");a&&(a.style.display="")}function Yi(){const e=document.getElementById("bank-client-picker-modal");e&&(e.style.display="none"),M.pickerSelected=null}function Ji(){const e=document.getElementById("bank-client-picker-list");if(!e)return;const n=(window._clientsCache||[]).filter(s=>s&&(s.is_active===!0||s.is_active===void 0)),a=[];a.push('<div class="bank-client-picker-row is-none'+(M.pickerSelected==null?" is-selected":"")+'" data-cid=""><span class="bank-cp-dot"></span><span>'+X(t("bank-client-picker-none"))+"</span></div>"),n.forEach(s=>{const o=Number(s.id)===Number(M.pickerSelected)?" is-selected":"";a.push('<div class="bank-client-picker-row'+o+'" data-cid="'+X(s.id)+'"><span class="bank-cp-dot" style="background:'+X(s.color||"#111111")+'"></span><span>'+X(s.short_name||s.name||"#"+s.id)+"</span></div>")}),e.innerHTML=a.join(""),e.querySelectorAll(".bank-client-picker-row").forEach(s=>{s.addEventListener("click",()=>{const o=s.dataset.cid;M.pickerSelected=o?Number(o):null,Ji()})})}async function ud(){if(M.currentSession)try{const e=await fetch("/api/bank-recon/sessions/"+encodeURIComponent(M.currentSession.id)+"/client",{method:"PATCH",headers:{Authorization:"Bearer "+token,"Content-Type":"application/json"},body:JSON.stringify({client_id:M.pickerSelected})});if(!e.ok)throw new Error("client:"+e.status);M.currentSession.client_id=M.pickerSelected,Ms(),showToast(t("bank-client-changed"),"success"),Yi();try{await Qt()}catch{}}catch(e){console.warn("[bank-recon] save client failed",e),showToast(t("bank-client-change-failed"),"error")}}async function Qt(){try{const e=await fetch("/api/bank-recon/sessions?limit=30",{headers:{Authorization:"Bearer "+token}});if(!e.ok)throw new Error("sessions:"+e.status);M.sessions=await e.json(),na()}catch(e){console.warn("[bank-recon] loadSessions failed",e),M.sessions=[],na()}}function _o(){const e=document.getElementById("bank-status-summary");if(!e)return;if(M.sessions.length===0){e.textContent=t("bank-pill-none");return}let a=0;for(const s of M.sessions)s.parse_status==="parsed"&&(s.unmatched_count||0)>0&&a++;e.textContent=a>0?t("bank-pill-pending").replace("{n}",a):t("bank-pill-ok")}function na(){const e=document.getElementById("bank-sessions-list");if(!e)return;let n=M.sessions||[];if(M.sessionFilter==="parsed"?n=n.filter(a=>a.parse_status==="parsed"):M.sessionFilter==="failed"&&(n=n.filter(a=>a.parse_status==="parse_failed")),!M.sessions||M.sessions.length===0){e.innerHTML='<div class="bank-empty" data-i18n="bank-sessions-empty">'+t("bank-sessions-empty")+"</div>";return}if(n.length===0){e.innerHTML='<div class="bank-empty">'+t("bank-sess-filter-empty")+"</div>";return}e.innerHTML=n.map(a=>md(a)).join(""),e.querySelectorAll(".bank-session-row").forEach(a=>{a.addEventListener("click",s=>{s.target.closest(".bank-session-trash")||Zt(a.dataset.sessionId)})}),e.querySelectorAll(".bank-session-trash").forEach(a=>{a.addEventListener("click",s=>{s.stopPropagation();const o=a.dataset.sessionId,i=a.dataset.sessionName||"";Xi(o,i)})})}async function Xi(e,n){if(!e)return;const a=(t("bank-session-delete-confirm")||"确定删除这条对账记录吗?").replace("{name}",n||"");if(await showConfirm(a,{danger:!0}))try{const o=await fetch("/api/bank-recon/sessions/"+encodeURIComponent(e),{method:"DELETE",headers:{Authorization:"Bearer "+token}});if(!o.ok)throw new Error("delete:"+o.status);showToast(t("bank-deleted"),"success"),M.currentSession&&M.currentSession.id===e&&(M.currentSession=null,M.currentTxs=[],As()),await Qt(),typeof window.loadReconcilePage=="function"&&window.loadReconcilePage()}catch(o){console.warn("[bank-recon] delete failed",o),showToast(t("bank-delete-failed"),"error")}}function md(e){const n=(e.bank_code||"OTHER").toUpperCase(),a=Wi(e.period_start,e.period_end),s=e.account_last4?"···"+e.account_last4:"",o=vd(e),i=Kt(e.created_at);return`
    ...
    `}function vd(e){if(e.parse_status==="parse_failed")return`<span class="bank-session-count cnt-failed">${t("bank-count-parse-failed")}</span>`;if(e.parse_status!=="parsed")return`<span class="bank-session-count">${t("bank-count-parsing")}</span>`;const n=e.tx_count||0,a=e.matched_count||0,s=e.unmatched_count||0,o=[`<span class="bank-session-count">${n} ${t("bank-count-tx")}</span>`];return a>0&&o.push(`<span class="bank-session-count cnt-matched">${a} ${t("bank-count-matched")}</span>`),s>0&&o.push(`<span class="bank-session-count cnt-unmatched">${s} ${t("bank-count-unmatched")}</span>`),o.join("")}function fd(){document.getElementById("bank-detail").style.display="",document.querySelector(".bank-sessions-section").style.display="none",Ki(),Hs(),Ms()}function As(){document.getElementById("bank-detail").style.display="none",document.querySelector(".bank-sessions-section").style.display="";const e=document.getElementById("bank-detail-body");e&&e.classList.remove("has-pane"),M.currentTxForDrawer=null}const hd=3;function gd(){return M.qSeq+=1,"q"+M.qSeq+"_"+Date.now()}async function bd(e){const n=Array.from(e.target.files||[]);if(e.target.value="",n.length!==0){for(const a of n){const s={id:gd(),file:a,name:a.name,size:a.size,status:"pending",progress:0,error_code:null,tx_count:0,session_id:null};a.name.toLowerCase().endsWith(".pdf")?a.size>20*1024*1024&&(s.status="failed",s.error_code="bank_recon.file_too_large"):(s.status="failed",s.error_code="bank_recon.only_pdf"),M.queue.push(s)}yd(),De(),Ps()}}function yd(){const e=document.getElementById("bank-upload-queue");e&&(e.style.display=""),td(),nd()}function De(){const e=document.getElementById("bank-upload-queue-list"),n=document.getElementById("bank-upload-queue-summary");if(!e)return;if(M.queue.length===0){e.innerHTML="",n&&(n.textContent="");const r=document.getElementById("bank-upload-queue");r&&(r.style.display="none");return}let a=0,s=0,o=0,i=0;for(const r of M.queue)r.status==="ok"?a++:r.status==="failed"?s++:r.status==="uploading"||r.status==="parsing"?o++:i++;n&&(n.textContent=t("bank-queue-summary").replace("{ok}",a).replace("{run}",o).replace("{wait}",i).replace("{fail}",s)),e.innerHTML=M.queue.map(wd).join(""),e.querySelectorAll("[data-q-act]").forEach(r=>{const l=r.dataset.qAct,m=r.dataset.qId;r.addEventListener("click",()=>{l==="retry"&&kd(m),l==="remove"&&xd(m)})})}function wd(e){const n=(e.size/1024).toFixed(0)+" KB";let a="",s="";if(e.status==="pending")a='<span class="bq-stat bq-wait">'+t("bank-queue-status-wait")+"</span>",s='<button data-q-act="remove" data-q-id="'+X(e.id)+'" class="bq-act">×</button>';else if(e.status==="uploading")a='<span class="bq-stat bq-run">'+t("bank-queue-status-uploading")+'</span><div class="bq-bar"><div class="bq-bar-fill" style="width:'+(e.progress||0)+'%"></div></div>';else if(e.status==="parsing")a='<span class="bq-stat bq-run">'+t("bank-queue-status-parsing")+'</span><div class="bq-bar"><div class="bq-bar-fill bq-bar-indet"></div></div>';else if(e.status==="ok")a='<span class="bq-stat bq-ok">'+t("bank-queue-status-ok").replace("{n}",e.tx_count||0)+"</span>",s='<button data-q-act="remove" data-q-id="'+X(e.id)+'" class="bq-act">×</button>';else if(e.status==="failed"){const o=ad(e.error_code||"unknown");a='<span class="bq-stat bq-fail" title="'+X(o)+'">'+X(o)+"</span>",s='<button data-q-act="retry" data-q-id="'+X(e.id)+'" class="bq-act bq-act-retry">'+t("bank-queue-retry")+'</button><button data-q-act="remove" data-q-id="'+X(e.id)+'" class="bq-act">×</button>'}return'<div class="bq-row" data-q-row="'+X(e.id)+'"><div class="bq-name" title="'+X(e.name)+'">'+X(e.name)+'</div><div class="bq-size">'+n+'</div><div class="bq-status">'+a+'</div><div class="bq-actions">'+s+"</div></div>"}function kd(e){const n=M.queue.find(a=>a.id===e);n&&(n.status="pending",n.error_code=null,n.progress=0,De(),Ps())}function xd(e){const n=M.queue.findIndex(s=>s.id===e);if(n<0)return;const a=M.queue[n];a.status==="uploading"||a.status==="parsing"||(M.queue.splice(n,1),De())}function _d(){M.queue=M.queue.filter(e=>e.status!=="ok"),De()}async function Ps(){for(;;){if(M.queue.filter(a=>a.status==="uploading"||a.status==="parsing").length>=hd)return;const n=M.queue.find(a=>a.status==="pending");if(!n){M.queue.every(a=>a.status==="ok"||a.status==="failed")&&(await Qt(),typeof window.loadReconcilePage=="function"&&window.loadReconcilePage());return}Ed(n).then(()=>Ps())}}async function Ed(e){e.status="uploading",e.progress=0,De();try{const n=new FormData;n.append("file",e.file,e.name);const a=await new Promise((o,i)=>{const r=new XMLHttpRequest;r.open("POST","/api/bank-recon/upload"),r.setRequestHeader("Authorization","Bearer "+token),r.upload.onprogress=l=>{l.lengthComputable&&(e.progress=Math.min(99,Math.round(l.loaded/l.total*100)),De())},r.upload.onload=()=>{e.status="parsing",De()},r.onload=()=>{r.status>=200&&r.status<300?o({status:r.status,text:r.responseText}):o({status:r.status,text:r.responseText})},r.onerror=()=>i(new Error("network")),r.send(n)});let s={};try{s=JSON.parse(a.text||"{}")}catch{s={}}if(a.status>=400){e.status="failed",e.error_code=s&&s.detail||"unknown",De();return}if(s.parse_status==="parse_failed"){e.status="failed",e.error_code=s.error==="scanned_pdf_not_yet"?"bank_recon.scanned":"bank_recon.no_tx",De();return}e.status="ok",e.tx_count=s.tx_count||0,e.session_id=s.session_id||null,De()}catch(n){console.warn("[bank-recon] upload failed",n),e.status="failed",e.error_code="network",De()}}async function Zi(){if(M.loaded){_o();return}M.loaded=!0,Id(),await Qt(),_o()}function Id(){const e=document.getElementById("bank-file-input");e&&!e._bound&&(e._bound=!0,e.addEventListener("change",bd));const n=document.getElementById("btn-bank-queue-clear-done");n&&!n._bound&&(n._bound=!0,n.addEventListener("click",_d));const a=document.getElementById("btn-bank-back");a&&!a._bound&&(a._bound=!0,a.addEventListener("click",()=>{M.currentSession=null,M.currentTxs=[],As()}));const s=document.getElementById("btn-bank-delete");s&&!s._bound&&(s._bound=!0,s.addEventListener("click",ld));const o=document.getElementById("btn-bank-run-match");o&&!o._bound&&(o._bound=!0,o.addEventListener("click",rd)),document.querySelectorAll(".bank-filter-btn").forEach(p=>{p._bound||(p._bound=!0,p.addEventListener("click",()=>{M.currentFilter=p.dataset.bankFilter||"all",document.querySelectorAll(".bank-filter-btn").forEach(c=>{c.classList.toggle("active",c===p)}),Hs()}))}),document.querySelectorAll("[data-bank-cand-close]").forEach(p=>{p._bound||(p._bound=!0,p.addEventListener("click",_n))});const i=document.getElementById("btn-bank-cand-pane-close");i&&!i._bound&&(i._bound=!0,i.addEventListener("click",_n));const r=document.getElementById("btn-bank-cand-ignore");r&&!r._bound&&(r._bound=!0,r.addEventListener("click",xo));const l=document.getElementById("btn-bank-cand-ignore-pane");l&&!l._bound&&(l._bound=!0,l.addEventListener("click",xo));const m=document.getElementById("bank-client-badge");m&&!m._bound&&(m._bound=!0,m.addEventListener("click",pd)),document.querySelectorAll("[data-bank-client-picker-close]").forEach(p=>{p._bound||(p._bound=!0,p.addEventListener("click",Yi))});const d=document.getElementById("btn-bank-client-picker-save");d&&!d._bound&&(d._bound=!0,d.addEventListener("click",ud)),document.querySelectorAll(".bank-sessions-chip").forEach(p=>{p._bound||(p._bound=!0,p.addEventListener("click",()=>{M.sessionFilter=p.dataset.sessFilter||"all",document.querySelectorAll(".bank-sessions-chip").forEach(c=>{c.classList.toggle("active",c===p)}),na()}))})}window._deleteBankSession=Xi;window._loadBankReconPanel=Zi;window._rerenderBankRecon=function(){if(currentRoute==="automation"){if(na(),M.currentSession&&(Ki(),Hs(),Ms(),!M.currentTxForDrawer)){const e=document.getElementById("bank-cand-pane-title"),n=document.getElementById("bank-cand-pane-sub");e&&(e.textContent=t("bank-cand-pane-empty-title")),n&&(n.textContent=t("bank-cand-pane-empty-sub"))}De()}};typeof window.subscribeI18n=="function"&&window.subscribeI18n("bank-recon",window._rerenderBankRecon);window._openBankSession=async function(e){e&&(M.loaded||await Zi(),await Zt(e))};(function(){const e=document.getElementById("page-clients");if(!(!e||e.dataset.wbInjected==="1")){e.innerHTML=`
        <div class="page-head">
            <div class="page-head-icon">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
...
`,e.dataset.wbInjected="1";try{const n=window._currentLang||localStorage.getItem("mrpilot_lang")||"th",a=window.I18N;a&&a[n]&&(e.querySelectorAll("[data-i18n]").forEach(s=>{const o=s.getAttribute("data-i18n");a[n][o]&&(s.textContent=a[n][o])}),e.querySelectorAll("[data-i18n-placeholder]").forEach(s=>{const o=s.getAttribute("data-i18n-placeholder");a[n][o]&&(s.placeholder=a[n][o])}))}catch{}}})();const Bd=`
    ...
    `;Ce("client-modal-mask",Bd);Ce("wsclient-modal-mask",Ld);const U={clients:[],editingClientId:null,historyClientFilter:"",custTab:"seller",sellerClients:[],editingWsClientId:null,catCache:{fetched:0,items:[],supplier_count:0}},Le={page:0,pageSize:12,keyword:""},at=new Set,aa={keyword:""};function $d(){return{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||"")}}async function Ye(e,n={}){const a=await fetch(e,{...n,headers:{"Content-Type":"application/json",...$d(),...n.headers||{}}});if(!a.ok){const s=await a.json().catch(()=>({}));throw new Error(s.detail||"HTTP "+a.status)}return a.json()}function Sd(){const e=document.querySelector("#client-color-picker .color-swatch.active");return e?e.dataset.color:"#111111"}function Eo(e){const n=document.getElementById("drawer-cat-learned-tag");n&&e>0&&(n.textContent=(t("drawer-suggest-learned-with-count")||"已学 {n}").replace("{n}",String(e)))}async function en(){try{const e=await Ye("/api/clients");U.clients=e.clients||[],window._clientsCache=U.clients}catch(e){console.error("loadClientsCache fail",e),U.clients=[]}try{typeof window._refreshExcClientFilter=="function"&&window._refreshExcClientFilter()}catch{}try{typeof window._refreshClientSwitcher=="function"&&window._refreshClientSwitcher()}catch{}return U.clients}function Cd(){const e=Le.keyword.trim().toLowerCase();return e?U.clients.filter(n=>(n.name||"").toLowerCase().includes(e)||(n.short_name||"").toLowerCase().includes(e)||(n.tax_id||"").toLowerCase().includes(e)):U.clients}function js(){const e=Cd(),n=Le.pageSize,a=Math.max(0,Math.ceil(e.length/n)-1);Le.page>a&&(Le.page=a);const s=Le.page*n;return{all:e,items:e.slice(s,s+n),start:s,ps:n,total:e.length,maxPage:a}}function Qe(){const e=document.getElementById("buyer-tbody");if(!e)return;const{items:n,start:a,ps:s,total:o,maxPage:i}=js();o?e.innerHTML=n.map(d=>{const p=at.has(d.id);return`<div class="cust-row buyer-grid${p?" selected":""}" data-cid="${d.id}">
            ...
            </div>`}).join(""):e.innerHTML=`<div class="cust-empty">${escapeHtml(t(Le.keyword?"cust-no-match":"clients-empty"))}</div>`;const r=document.getElementById("buyer-pager-info");r&&(r.textContent=o?`${a+1}–${Math.min(a+s,o)} / ${o}`:"0");const l=document.getElementById("buyer-prev");l&&(l.disabled=Le.page<=0);const m=document.getElementById("buyer-next");m&&(m.disabled=Le.page>=i),Qi()}function Qi(){const e=at.size,n=document.getElementById("buyer-batch-bar");n&&(n.style.display=e?"flex":"none");const a=document.getElementById("buyer-batch-count");a&&(a.textContent=t("cust-selected-n").replace("{n}",e));const s=document.getElementById("buyer-check-all");if(s){const{items:o}=js(),i=o.map(l=>l.id),r=i.filter(l=>at.has(l)).length;s.checked=i.length>0&&r===i.length,s.indeterminate=r>0&&r<i.length}}function Td(){at.clear(),Qe()}async function Hd(){const e=Array.from(at);if(!(!e.length||!await showConfirm(t("cust-batch-del-confirm").replace("{n}",e.length),{danger:!0})))try{await Ye("/api/clients/batch-delete",{method:"POST",body:JSON.stringify({ids:e})}),showToast(t("client-msg-deleted"),"success"),at.clear(),await en(),Qe(),wa(),Ds()}catch{showToast(t("client-msg-save-fail"),"fail")}}function vn(e){U.editingClientId=e?e.id:null;const n=!!e;document.getElementById("client-modal-title").textContent=t(n?"client-modal-edit":"client-modal-new"),document.getElementById("client-input-name").value=e&&e.name||"",document.getElementById("client-input-short").value=e&&e.short_name||"",document.getElementById("client-input-tax").value=e&&e.tax_id||"",document.getElementById("client-input-address").value=e&&e.address||"",document.getElementById("client-input-contact").value=e&&e.contact_person||"",document.getElementById("client-input-phone").value=e&&e.contact_phone||"",document.getElementById("client-input-email").value=e&&e.contact_email||"",document.getElementById("client-input-notes").value=e&&e.notes||"",document.getElementById("client-input-party-type").value=e&&e.party_type||"",document.getElementById("client-input-branch").value=e&&e.branch||"",document.getElementById("client-input-promptpay").value=e&&e.promptpay_id||"";const a=e&&e.color||"#111111";document.querySelectorAll("#client-color-picker .color-swatch").forEach(s=>{s.classList.toggle("active",s.dataset.color===a)}),document.getElementById("client-modal-delete").style.display=n?"":"none",document.getElementById("client-modal-mask").style.display="flex",setTimeout(()=>document.getElementById("client-input-name").focus(),50)}function fn(){document.getElementById("client-modal-mask").style.display="none",U.editingClientId=null}async function Md(){const e=document.getElementById("client-input-name").value.trim();if(!e){showToast(t("client-msg-name-required"),"fail");return}const n={name:e,short_name:document.getElementById("client-input-short").value.trim()||null,tax_id:document.getElementById("client-input-tax").value.trim()||null,address:document.getElementById("client-input-address").value.trim()||null,contact_person:document.getElementById("client-input-contact").value.trim()||null,contact_phone:document.getElementById("client-input-phone").value.trim()||null,contact_email:document.getElementById("client-input-email").value.trim()||null,notes:document.getElementById("client-input-notes").value.trim()||null,color:Sd(),party_type:document.getElementById("client-input-party-type").value||null,branch:document.getElementById("client-input-branch").value.trim()||null,promptpay_id:document.getElementById("client-input-promptpay").value.trim()||null};try{U.editingClientId?(await Ye(`/api/clients/${U.editingClientId}`,{method:"PATCH",body:JSON.stringify(n)}),showToast(t("client-msg-updated"),"success")):(await Ye("/api/clients",{method:"POST",body:JSON.stringify(n)}),showToast(t("client-msg-created"),"success")),fn(),await en(),currentRoute==="clients"&&Qe(),wa(),Ds()}catch(a){console.error("saveClient fail",a);const s=a&&a.message?a.message:t("client-msg-save-fail");showToast(t("client-msg-save-fail")+" · "+s,"fail")}}async function Ad(){if(!U.editingClientId)return;const e=U.clients.find(s=>s.id===U.editingClientId);if(!e)return;const n=t("client-delete-confirm").replace("{name}",e.name);if(await showConfirm(n,{danger:!0}))try{await Ye(`/api/clients/${U.editingClientId}`,{method:"DELETE"}),showToast(t("client-msg-deleted"),"success"),fn(),await en(),currentRoute==="clients"&&Qe(),wa(),Ds()}catch(s){console.error(s),showToast(t("client-msg-save-fail"),"fail")}}async function Pd(e){const n=U.clients.find(a=>a.id===e);if(typeof window.openClientExportModal=="function"){window.openClientExportModal(e,n?n.name:"");return}try{const a=localStorage.getItem("mrpilot_token"),s=await fetch(`/api/clients/${e}/export?month=all`,{headers:{Authorization:"Bearer "+a}});if(!s.ok){let m="HTTP "+s.status;try{const d=await s.json();d&&d.detail&&(m=d.detail)}catch{}throw new Error(m)}const o=await s.blob();if(o.size<200){showToast(t("client-export-month-empty"),"info");return}const i=n&&n.name?n.name.replace(/[^a-zA-Z0-9\u0e00-\u0e7f\u4e00-\u9fff]/g,"_").slice(0,40):"client",r=URL.createObjectURL(o),l=document.createElement("a");l.href=r,l.download=`${i}_export.csv`,l.click(),URL.revokeObjectURL(r)}catch(a){console.error("exportClient fail",a),showToast(t("client-msg-save-fail")+" · "+(a.message||""),"fail")}}function wa(){const e=document.getElementById("drawer-client-select");if(!e)return;const n=e.value;e.innerHTML=`<option value="">${escapeHtml(t("drawer-client-none"))}</option>`+U.clients.map(a=>`<option value="${a.id}">${escapeHtml(a.name)}</option>`).join(""),e.value=n||""}function Ds(){const e=document.getElementById("history-client-filter");if(!e)return;const n=e.value;e.innerHTML=`<option value="">${escapeHtml(t("history-client-all"))}</option>`+U.clients.map(a=>`<option value="${a.id}">${escapeHtml(a.name)}</option>`).join(""),e.value=n||""}function jd(e){U.custTab=e==="buyer"?"buyer":"seller",document.querySelectorAll("[data-cust-tab]").forEach(s=>s.classList.toggle("active",s.dataset.custTab===U.custTab));const n=document.getElementById("cust-pane-seller"),a=document.getElementById("cust-pane-buyer");n&&n.classList.toggle("active",U.custTab==="seller"),a&&a.classList.toggle("active",U.custTab==="buyer")}function Dd(){const e=window._userInfo||{},n=String(e.role||"").toLowerCase(),a=String(e.tenant_role||"").toLowerCase();return e.is_super_admin===!0||e.is_owner===!0||n==="owner"||n==="admin"||a==="owner"||a==="admin"}function er(){window._workspaceClientsCache=U.sellerClients,typeof window.renderWorkspaceControl=="function"&&window.renderWorkspaceControl()}async function qs(){try{const e=await Ye("/api/workspace/clients");U.sellerClients=e&&(e.clients||e.items)||[],window._workspaceClientsCache=U.sellerClients}catch(e){console.error("loadSellerCache fail",e),U.sellerClients=[]}return U.sellerClients}function qd(){const e=aa.keyword.trim().toLowerCase();return e?U.sellerClients.filter(n=>(n.name||"").toLowerCase().includes(e)||(n.tax_id||"").toLowerCase().includes(e)):U.sellerClients}function Ht(){const e=document.getElementById("seller-tbody");if(!e)return;const n=Dd(),a=document.getElementById("btn-seller-new");a&&(a.style.display=n?"":"none");const s=qd(),o=typeof window.getActiveWorkspaceClientId=="function"?window.getActiveWorkspaceClientId():null;if(!s.length){e.innerHTML=`<div class="cust-empty">${escapeHtml(t(aa.keyword?"cust-no-match":"seller-empty"))}</div>`;return}e.innerHTML=s.map(i=>{const l=o!=null&&Number(o)===Number(i.id)?`<span class="cust-badge-current"><svg viewBox="0 0 14 14" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M2 7.5l3.2 3.2L12 4"/></svg>${escapeHtml(t("seller-current"))}</span>`:`<button class="cust-row-btn primary" data-saction="activate" data-wid="${i.id}">${escapeHtml(t("seller-set-current"))}</button>`,m=n?`
        ...
        </div>`}).join("")}function Io(e){U.editingWsClientId=e?e.id:null,document.getElementById("wsclient-modal-title").textContent=t(e?"wsclient-modal-edit":"wsclient-modal-new"),document.getElementById("wsclient-input-name").value=e&&e.name||"",document.getElementById("wsclient-input-tax").value=e&&e.tax_id||"",document.getElementById("wsclient-input-address").value=e&&e.address||"",document.getElementById("wsclient-input-branch").value=e&&e.branch||"",document.getElementById("wsclient-input-phone").value=e&&e.phone||"",document.getElementById("wsclient-input-vat").checked=e?e.vat_registered!==!1:!0,document.getElementById("wsclient-modal-archive").style.display=e?"":"none",document.getElementById("wsclient-modal-mask").style.display="flex",setTimeout(()=>document.getElementById("wsclient-input-name").focus(),50)}function hn(){document.getElementById("wsclient-modal-mask").style.display="none",U.editingWsClientId=null}async function Rd(){const e=document.getElementById("wsclient-input-name").value.trim(),n=document.getElementById("wsclient-input-tax").value.trim(),a=document.getElementById("wsclient-input-address").value.trim(),s=document.getElementById("wsclient-input-branch").value.trim(),o=document.getElementById("wsclient-input-phone").value.trim(),i=document.getElementById("wsclient-input-vat").checked;if(!e){showToast(t("client-msg-name-required"),"fail");return}const r={address:a||null,branch:s||null,phone:o||null,vat_registered:i};try{U.editingWsClientId?(await Ye("/api/workspace/clients/"+U.editingWsClientId,{method:"PATCH",body:JSON.stringify({name:e,tax_id:n,...r})}),showToast(t("client-msg-updated"),"success")):(await Ye("/api/workspace/clients",{method:"POST",body:JSON.stringify({name:e,tax_id:n||null,...r})}),showToast(t("client-msg-created"),"success")),hn(),await qs(),Ht(),er()}catch(l){const m=l&&l.message?l.message:t("client-msg-save-fail");showToast(t("client-msg-save-fail")+" · "+m,"fail")}}async function Bo(){if(!U.editingWsClientId)return;const e=U.sellerClients.find(a=>Number(a.id)===Number(U.editingWsClientId));if(await showConfirm(t("wsclient-archive-confirm").replace("{name}",e?e.name:""),{danger:!0}))try{const a=U.editingWsClientId;await Ye("/api/workspace/clients/"+a,{method:"DELETE"}),showToast(t("wsclient-archived"),"success"),typeof window.getActiveWorkspaceClientId=="function"&&Number(window.getActiveWorkspaceClientId())===Number(a)&&typeof window.enterPersonalMode=="function"&&window.enterPersonalMode(),hn(),await qs(),Ht(),er()}catch{showToast(t("client-msg-save-fail"),"fail")}}window.loadClientsPage=async function(){const e=document.getElementById("seller-tbody");e&&(e.innerHTML=`<div class="cust-loading">${escapeHtml(t("clients-loading"))}</div>`);const n=document.getElementById("buyer-tbody");n&&(n.innerHTML=`<div class="cust-loading">${escapeHtml(t("clients-loading"))}</div>`),await Promise.all([qs(),en()]),Ht(),Qe()};window.addEventListener("pearnly:workspace-changed",function(){typeof currentRoute<"u"&&currentRoute==="clients"&&Ht()});window.bindDrawerClient=function(e,n){const a=document.getElementById("drawer-client-select");if(!a)return;if(wa(),a.value=n?String(n):"",!e){a.onchange=null;const o=document.getElementById("drawer-client-add");o&&(o.onclick=()=>vn(null));return}a.onchange=async()=>{const o=a.value?parseInt(a.value,10):null;try{await Ye(`/api/history/${e}/assign_client`,{method:"POST",body:JSON.stringify({client_id:o})}),showToast(t("client-msg-updated"),"success");const i=_results[_drawerIdx];i&&(i.client_id=o),await en()}catch(i){console.error(i),showToast(t("client-msg-save-fail"),"fail"),a.value=n?String(n):""}};const s=document.getElementById("drawer-client-add");s&&(s.onclick=()=>vn(null))};window.fillCategoryDatalist=async function(){try{const e=document.getElementById("drawer-cat-datalist"),n=Date.now();if(n-U.catCache.fetched<300*1e3){e&&(e.innerHTML=U.catCache.items.map(s=>`<option value="${escapeHtml(s)}">`).join("")),Eo(U.catCache.supplier_count);return}const a=await Ye("/api/categories",{method:"GET"});U.catCache.fetched=n,U.catCache.items=a&&a.categories||[],U.catCache.supplier_count=a&&a.supplier_count||0,e&&(e.innerHTML=U.catCache.items.map(s=>`<option value="${escapeHtml(s)}">`).join("")),Eo(U.catCache.supplier_count)}catch(e){console.warn("fillCategoryDatalist failed",e)}};window.getHistoryClientFilter=function(){return U.historyClientFilter};document.addEventListener("DOMContentLoaded",()=>{const e=document.querySelector(".cust-tab-bar");e&&e.addEventListener("click",L=>{const $=L.target.closest("[data-cust-tab]");$&&jd($.dataset.custTab)});const n=document.getElementById("btn-buyer-new");n&&n.addEventListener("click",()=>vn(null));const a=document.getElementById("buyer-tbody");a&&a.addEventListener("click",L=>{const $=L.target.closest(".buyer-row-check");if($){const R=parseInt($.dataset.cid,10);$.checked?at.add(R):at.delete(R);const G=$.closest(".cust-row");G&&G.classList.toggle("selected",$.checked),Qi();return}const C=L.target.closest(".cust-row-btn");if(C){L.stopPropagation();const R=parseInt(C.dataset.cid,10);if(C.dataset.action==="edit"){const G=U.clients.find(se=>se.id===R);G&&vn(G)}else C.dataset.action==="export"&&Pd(R);return}const H=L.target.closest(".cust-row");if(H&&!L.target.closest(".cust-cell-check")){const R=U.clients.find(G=>G.id===parseInt(H.dataset.cid,10));R&&vn(R)}});const s=document.getElementById("buyer-check-all");s&&s.addEventListener("change",()=>{const{items:L}=js();L.forEach($=>{s.checked?at.add($.id):at.delete($.id)}),Qe()});const o=document.getElementById("buyer-batch-cancel");o&&o.addEventListener("click",Td);const i=document.getElementById("buyer-batch-delete");i&&i.addEventListener("click",Hd);const r=document.getElementById("buyer-prev");r&&r.addEventListener("click",()=>{Le.page>0&&(Le.page--,Qe())});const l=document.getElementById("buyer-next");l&&l.addEventListener("click",()=>{Le.page++,Qe()});const m=document.getElementById("buyer-search");if(m){let L;m.addEventListener("input",()=>{clearTimeout(L),L=setTimeout(()=>{Le.keyword=m.value,Le.page=0;const $=document.getElementById("buyer-search-clear");$&&($.style.display=m.value?"":"none"),Qe()},200)})}const d=document.getElementById("buyer-search-clear");d&&d.addEventListener("click",()=>{const L=document.getElementById("buyer-search");L&&(L.value=""),Le.keyword="",Le.page=0,d.style.display="none",Qe()});const p=document.getElementById("btn-seller-new");p&&p.addEventListener("click",()=>Io(null));const c=document.getElementById("seller-tbody");c&&c.addEventListener("click",L=>{const $=L.target.closest("[data-saction]");if(!$)return;L.stopPropagation();const C=parseInt($.dataset.wid,10),H=$.dataset.saction,R=U.sellerClients.find(G=>Number(G.id)===C);H==="activate"?(typeof window.setActiveWorkspaceClientId=="function"&&window.setActiveWorkspaceClientId(C),Ht(),typeof window.renderWorkspaceControl=="function"&&window.renderWorkspaceControl(),showToast(t("seller-activated").replace("{name}",R?R.name:""),"success")):H==="edit"?R&&Io(R):H==="archive"&&(U.editingWsClientId=C,Bo())});const u=document.getElementById("seller-search");if(u){let L;u.addEventListener("input",()=>{clearTimeout(L),L=setTimeout(()=>{aa.keyword=u.value;const $=document.getElementById("seller-search-clear");$&&($.style.display=u.value?"":"none"),Ht()},200)})}const v=document.getElementById("seller-search-clear");v&&v.addEventListener("click",()=>{const L=document.getElementById("seller-search");L&&(L.value=""),aa.keyword="",v.style.display="none",Ht()});const f=document.getElementById("wsclient-modal-close");f&&f.addEventListener("click",hn);const y=document.getElementById("wsclient-modal-cancel");y&&y.addEventListener("click",hn);const b=document.getElementById("wsclient-modal-save");b&&b.addEventListener("click",Rd);const h=document.getElementById("wsclient-modal-archive");h&&h.addEventListener("click",Bo);const g=document.getElementById("wsclient-modal-mask");g&&g.addEventListener("click",L=>{L.target===g&&hn()});const _=document.getElementById("client-modal-close");_&&_.addEventListener("click",fn);const w=document.getElementById("client-modal-cancel");w&&w.addEventListener("click",fn);const k=document.getElementById("client-modal-save");k&&k.addEventListener("click",Md);const x=document.getElementById("client-modal-delete");x&&x.addEventListener("click",Ad);const E=document.getElementById("client-modal-mask");E&&E.addEventListener("click",L=>{L.target===E&&fn()});const I=document.getElementById("client-color-picker");I&&I.addEventListener("click",L=>{const $=L.target.closest(".color-swatch");$&&(I.querySelectorAll(".color-swatch").forEach(C=>C.classList.remove("active")),$.classList.add("active"))});const B=document.getElementById("history-client-filter");B&&B.addEventListener("change",()=>{U.historyClientFilter=B.value,typeof renderHistoryList=="function"&&renderHistoryList()})});setTimeout(()=>en(),1e3);(function(){const e=document.getElementById("page-exceptions");if(!(!e||e.dataset.wbInjected==="1")){e.innerHTML=`
        <div class="page-head">
            <div class="page-head-icon">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round">
...
`,e.dataset.wbInjected="1";try{const n=window._currentLang||localStorage.getItem("mrpilot_lang")||"th",a=window.I18N;a&&a[n]&&(e.querySelectorAll("[data-i18n]").forEach(s=>{const o=s.getAttribute("data-i18n");a[n][o]&&(s.textContent=a[n][o])}),e.querySelectorAll("[data-i18n-placeholder]").forEach(s=>{const o=s.getAttribute("data-i18n-placeholder");a[n][o]&&(s.placeholder=a[n][o])}))}catch{}}})();const q={statsCache:null,listCache:[],currentRule:null,currentClient:"",currentStatus:"pending",loading:!1,selectedIds:new Set,offset:0,pageSize:50,total:0,loadFailed:!1,listScrollY:0},D={openExcId:null,excRow:null,history:null,loading:!1,pdfUrl:null,pdfStatus:"idle",editing:!1,editFields:null},Nt={batchLoading:!1};function yt(e,n){let a=t(e)||e;if(n)for(const s in n)a=a.replace(new RegExp("\\{"+s+"\\}","g"),String(n[s]));return a}function Fd(e){return e==="high"?`<svg viewBox="0 0 14 14" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
    ...
    </svg>`}function zd(){return`<svg class="exc-empty-icon" viewBox="0 0 40 40" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
        <path d="M11 19l5 5 13-13"/>
        <circle cx="20" cy="20" r="17"/>
    </svg>`}function Nd(e){if(e==null)return"—";const n=parseFloat(String(e));return isNaN(n)?"—":"฿ "+n.toLocaleString(void 0,{minimumFractionDigits:2,maximumFractionDigits:2})}function Od(e){return e?e.slice(0,10):"—"}function ct(e){if(e==null)return"—";const n=typeof e=="number"?e:parseFloat(String(e).replace(/,/g,""));return isNaN(n)?escapeHtml(String(e)):"฿ "+n.toLocaleString(void 0,{minimumFractionDigits:2,maximumFractionDigits:2})}const Vd={"R-VAT-01":"risk.vat_mismatch","R-VAT-02":"risk.total_mismatch","R-SUM-01":"risk.line_sum_mismatch","R-LINE-01":"risk.line_amount_mismatch","R-MULTIPAGE-01":"risk.multipage_mismatch","R-TAXID-01":"risk.seller_tax_id_invalid","R-TAXID-02":"risk.buyer_tax_id_invalid","R-TAXID-03":"risk.tax_id_placeholder","R-DUP-01":"risk.duplicate_exact","R-DUP-02":"risk.duplicate_suspected","R-DATE-01":"risk.invoice_date_unparseable","R-DATE-02":"risk.invoice_date_out_of_period","R-SUP-01":"risk.supplier_not_allowlisted","R-SUP-02":"risk.supplier_force_review","R-LIMIT-01":"risk.amount_over_limit","R-CAT-01":"risk.category_no_auto_push"};function Ra(e,n){const a=t(e);return a&&a!==e?a:n}function Rs(e){const n=e.rule_code||"",a=e.detail&&e.detail.message_key;if(a){const i=Ra(a,"");if(i)return i}const s=Ra("exc-rule-"+n,"");if(s)return s;const o=Vd[n];if(o){const i=Ra(o,"");if(i)return i}return n}const Ud=[{labelKey:"exc-grp-arithmetic",codes:["R-VAT-01","R-VAT-02","R-SUM-01","R-LINE-01","R-MULTIPAGE-01","math_mismatch"]},{labelKey:"exc-grp-taxid",codes:["R-TAXID-01","R-TAXID-02","R-TAXID-03","tax_id_format_invalid"]},{labelKey:"exc-grp-dup",codes:["R-DUP-01","R-DUP-02","duplicate"]},{labelKey:"exc-grp-date",codes:["R-DATE-01","R-DATE-02"]},{labelKey:"exc-grp-customer",codes:["R-SUP-01","R-SUP-02","R-LIMIT-01","R-CAT-01"]},{labelKey:"exc-grp-fields",codes:["amount_missing"]},{labelKey:"exc-chip-confidence_low",codes:["confidence_low"]}];function Gd(e){if(!e)return"—";try{const n=new Date(e),a=s=>String(s).padStart(2,"0");return`${n.getFullYear()}-${a(n.getMonth()+1)}-${a(n.getDate())} ${a(n.getHours())}:${a(n.getMinutes())}`}catch{return e.slice(0,16).replace("T"," ")}}function ae(e,n,a){return`<div class="exc-why-detail-row"><b>${escapeHtml(t(e))}</b><span class="${a||""}">${escapeHtml(n)}</span></div>`}function Wd(e,n){const a=o=>ct(n[o]),s=o=>n[o]===null||n[o]===void 0?"—":String(n[o]);switch(e){case"risk.vat_mismatch":return ae("exc-fld-subtotal",a("net_amount"))+ae("exc-fld-vat",a("vat_amount"),"v-bad")+ae("exc-detail-expected",a("expected_vat"),"v-good");case"risk.total_mismatch":{const o=Number(n.net_amount)||0,i=Number(n.vat_amount)||0;return ae("exc-fld-subtotal",a("net_amount"))+ae("exc-fld-vat",a("vat_amount"))+ae("exc-fld-total",a("total_amount"),"v-bad")+ae("exc-detail-expected",ct(o+i),"v-good")}case"risk.line_sum_mismatch":return ae("exc-ev-lines-sum",a("lines_sum"),"v-bad")+ae("exc-fld-subtotal",a("net_amount"),"v-good");case"risk.line_amount_mismatch":{const o=Number(n.qty)||0,i=Number(n.unit_price)||0;return ae("exc-ev-amount",a("amount"),"v-bad")+ae("exc-detail-expected",ct(o*i),"v-good")}case"risk.multipage_mismatch":return ae("exc-ev-pages",s("pages"));case"risk.seller_tax_id_invalid":return ae("exc-fld-seller-tax",s("seller_tax_id"),"v-bad");case"risk.buyer_tax_id_invalid":return ae("exc-fld-buyer-tax",s("buyer_tax_id"),"v-bad");case"risk.tax_id_placeholder":return ae("exc-ev-value",s("value"),"v-bad");case"risk.invoice_date_unparseable":case"risk.invoice_date_future":return ae("exc-fld-date",s("invoice_date"),"v-bad");case"risk.invoice_date_out_of_period":return ae("exc-fld-date",s("invoice_date"),"v-bad")+ae("exc-ev-period-start",s("period_start"))+ae("exc-ev-period-end",s("period_end"));case"risk.duplicate_exact":return(n.invoice_no?ae("exc-fld-invoice-no",s("invoice_no")):"")+ae("exc-fld-seller-tax",s("seller_tax_id"));case"risk.duplicate_suspected":{const o=Array.isArray(n.candidate_history_ids)?n.candidate_history_ids.length:0;return ae("exc-ev-dup-count",String(o))}case"risk.supplier_not_allowlisted":return ae("exc-fld-seller",s("seller_name"))+ae("exc-fld-seller-tax",s("seller_tax_id"));case"risk.supplier_force_review":return ae("exc-ev-reason",s("reason"),"v-bad")+ae("exc-fld-seller-tax",s("seller_tax_id"));case"risk.amount_over_limit":return ae("exc-ev-amount",a("value"),"v-bad")+ae("exc-ev-limit",a("limit"),"v-good");case"risk.category_no_auto_push":return ae("exc-ev-category",s("category"));default:return`<div class="exc-why-detail-row"><span style="font-size:11px;">${escapeHtml(JSON.stringify(n))}</span></div>`}}function Kd(e,n){if(n=n||{},n.message_key)return Wd(n.message_key,n.evidence||{});if(e==="math_mismatch")return`
            <div class="exc-why-detail-row"><b>${escapeHtml(t("exc-fld-subtotal"))}</b><span>${escapeHtml(ct(n.subtotal))}</span></div>
            <div class="exc-why-detail-row"><b>${escapeHtml(t("exc-fld-vat"))}</b><span>${escapeHtml(ct(n.vat))}</span></div>
            <div class="exc-why-detail-row"><b>${escapeHtml(t("exc-detail-expected"))}</b><span class="v-good">${escapeHtml(ct(n.total_expected))}</span></div>
            <div class="exc-why-detail-row"><b>${escapeHtml(t("exc-detail-actual"))}</b><span class="v-bad">${escapeHtml(ct(n.total_actual))}</span></div>
            <div class="exc-why-detail-row"><b>${escapeHtml(t("exc-detail-diff"))}</b><span class="v-bad">${escapeHtml(ct(n.diff))}</span></div>
        ...
        `:e==="amount_missing"?`<div class="exc-why-detail-row" style="justify-content:center;color:var(--danger);"><span>${escapeHtml(t("exc-detail-missing"))}</span></div>`:`<div class="exc-why-detail-row"><span style="font-size:11px;">${escapeHtml(JSON.stringify(n))}</span></div>`}function pt(){const e=D.excRow;if(!e)return;const n=e.seller_name&&e.seller_name.trim()?e.seller_name:t("exc-no-seller"),a=e.filename||"—";document.getElementById("exc-drawer-title").textContent=a;const s="exc-status-"+(e.status||"pending"),o=t(s)||e.status,i="s-"+(e.status||"pending"),r=(e.invoice_date||e.created_at||"").slice(0,10);document.getElementById("exc-drawer-sub").innerHTML=`
        <span>${escapeHtml(n)}</span>
        ${e.invoice_no?`<span>· ${escapeHtml(e.invoice_no)}</span>`:""}
        ${r?`<span>· ${escapeHtml(r)}</span>`:""}
        <span class="exc-status-chip ${i}">${escapeHtml(o)}</span>
    `;const l=e.severity||"medium",m=Rs(e),d=Kd(e.rule_code,e.detail||{}),p=Lo(D.history),c=D.history===null,u=D.history&&D.history._err,v=new Set,f=e.rule_code||"";["math_mismatch","R-VAT-01","R-VAT-02","R-SUM-01","R-LINE-01"].includes(f)?(v.add("subtotal"),v.add("vat"),v.add("total_amount")):f==="R-MULTIPAGE-01"||f==="R-LIMIT-01"?v.add("total_amount"):f==="tax_id_format_invalid"||f==="R-TAXID-01"?v.add("seller_tax"):f==="R-TAXID-02"?v.add("buyer_tax"):f==="R-TAXID-03"?(v.add("seller_tax"),v.add("buyer_tax")):f==="R-DATE-01"||f==="R-DATE-02"?v.add("date"):f==="R-DUP-01"||f==="R-DUP-02"?v.add("invoice_number"):f==="R-SUP-01"||f==="R-SUP-02"?(v.add("seller_name"),v.add("seller_tax")):f==="amount_missing"&&(v.add("total_amount"),v.add("invoice_number"));const y=!!D.editing,b=D.editFields||{},h=(H,R,G)=>{if(c)return`<div class="exc-field-row"><label>${escapeHtml(t(R))}</label><span class="val empty">…</span></div>`;const se=y?b[H]!==void 0?b[H]:p[H]!==void 0&&p[H]!==null?p[H]:"":p[H],de=v.has(H)?"flagged":"";if(y){const V=G?"number":"text",N=G?' step="0.01" inputmode="decimal"':"",Y=se==null?"":String(se).replace(/"/g,"&quot;");return`<div class="exc-field-row ${de} editing">
                <label>${escapeHtml(t(R))}</label>
                <input class="exc-field-input" type="${V}"${N} data-edit-key="${escapeHtml(H)}" value="${Y}">
            </div>`}const Ie=G?ct(se):se||"",we=se==null||se===""?`<span class="val empty">${escapeHtml(t("exc-empty-val"))}</span>`:`<span class="val">${escapeHtml(Ie)}</span>`;return`<div class="exc-field-row ${de}"><label>${escapeHtml(t(R))}</label>${we}</div>`};let g="";u?g=`<div class="exc-drawer-error">${escapeHtml(t("exc-drawer-error"))}</div>`:g=`
    ...
    `;const w=document.getElementById("exc-fld-edit");w&&w.addEventListener("click",()=>{D.editing=!0,D.editFields={...Lo(D.history)},pt()});const k=document.getElementById("exc-fld-cancel");k&&k.addEventListener("click",()=>{D.editing=!1,D.editFields=null,pt()});const x=document.getElementById("exc-fld-save");x&&x.addEventListener("click",()=>Xd()),document.querySelectorAll(".exc-field-input").forEach(H=>{H.addEventListener("input",()=>{D.editFields||(D.editFields={}),D.editFields[H.dataset.editKey]=H.value})});const I=document.getElementById("exc-pdf-retry");I&&D.openExcId&&I.addEventListener("click",()=>{D.excRow&&tr(D.excRow.history_id,D.openExcId)});const B=e.status==="pending",L=!!(e.seller_name&&e.seller_name.trim()),$=document.getElementById("exc-btn-resolve"),C=document.getElementById("exc-btn-ignore");$.disabled=!B,C.disabled=!B||!L,C.title=L?t("exc-ignore-hint"):t("exc-ignore-no-seller")}function Fs(){if(D.pdfUrl){try{URL.revokeObjectURL(D.pdfUrl)}catch{}D.pdfUrl=null}D.pdfStatus="idle"}async function tr(e,n){D.pdfStatus="loading",pt();try{const a=await fetch("/api/history/"+encodeURIComponent(e)+"/pdf",{headers:{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||"")}});if(D.openExcId!==n)return;if(a.status===404){D.pdfStatus="empty",pt();return}if(!a.ok)throw new Error("http "+a.status);const s=await a.blob();if(D.openExcId!==n)return;Fs(),D.pdfUrl=URL.createObjectURL(s),D.pdfStatus="ready",pt()}catch(a){if(D.openExcId!==n)return;console.warn("loadDrawerPdf fail",a),D.pdfStatus="error",pt()}}function Yd(e){const n=(q.listCache||[]).find(a=>a.id===e);if(!n){showToast(t("exc-drawer-error"),"error");return}q.listScrollY=window.scrollY||document.documentElement.scrollTop||0,Fs(),D.editing=!1,D.editFields=null,D.openExcId=e,D.excRow=n,D.history=null,document.getElementById("exc-drawer-mask").classList.add("show"),document.getElementById("exc-drawer").classList.add("show"),pt(),Jd(n.history_id),tr(n.history_id,e)}function Yt(){Fs(),D.editing=!1,D.editFields=null,D.openExcId=null,D.excRow=null,D.history=null,document.getElementById("exc-drawer-mask").classList.remove("show"),document.getElementById("exc-drawer").classList.remove("show");const e=q.listScrollY||0;e>0&&requestAnimationFrame(()=>window.scrollTo(0,e))}async function Jd(e){try{const n=await fetch("/api/history/"+encodeURIComponent(e),{headers:{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||"")}});if(!n.ok)throw new Error("http "+n.status);D.history=await n.json()}catch(n){console.warn("loadHistoryDetail fail",n),D.history={_err:!0}}D.excRow&&pt()}function Lo(e){if(!e||!e.pages)return{};const n=e.pages,a=n.find(s=>!s.is_duplicate&&!s.is_copy)||n[0];return a&&a.fields||{}}async function Xd(){if(!D.openExcId||!D.history||!D.history.pages||D.loading)return;D.loading=!0;const e=showToast(t("exc-fld-saving"),"loading",0);try{const n=JSON.parse(JSON.stringify(D.history.pages||[]));let a=n.findIndex(m=>!m.is_duplicate&&!m.is_copy);a<0&&(a=0),n[a]||(n[a]={fields:{}});const s=n[a].fields||{},o=D.editFields||{},i=new Set(["subtotal","vat","total_amount"]),r={...s};for(const m in o){let d=o[m];if((d===""||d===void 0)&&(d=null),i.has(m)&&d!==null){const p=parseFloat(d);d=isNaN(p)?null:p}r[m]=d}n[a].fields=r;const l=await fetch("/api/history/"+encodeURIComponent(D.history.id),{method:"PUT",headers:{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||""),"Content-Type":"application/json"},body:JSON.stringify({pages:n})});if(!l.ok)throw new Error("http "+l.status);e(),showToast(t("exc-fld-save-ok"),"success"),Yt(),await tn(),await xt(),ot()}catch(n){e(),console.warn("save fields fail",n),showToast(t("exc-fld-save-fail"),"error")}finally{D.loading=!1}}async function Zd(){if(!(!D.openExcId||D.loading)){D.loading=!0;try{const e=await fetch("/api/exceptions/"+D.openExcId+"/resolve",{method:"POST",headers:{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||"")}});if(!e.ok)throw new Error("http "+e.status);showToast(t("exc-toast-resolved"),"success"),Yt(),await tn(),await xt(),ot()}catch(e){console.warn("resolve fail",e),showToast(t("exc-toast-action-fail"),"error")}finally{D.loading=!1}}}async function Qd(){if(!(!D.openExcId||D.loading)){D.loading=!0;try{const e=await fetch("/api/exceptions/"+D.openExcId+"/ignore",{method:"POST",headers:{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||"")}});if(!e.ok)throw new Error("http "+e.status);showToast(t("exc-toast-ignored"),"success"),Yt(),await tn(),await xt(),ot()}catch(e){console.warn("ignore fail",e),showToast(t("exc-toast-action-fail"),"error")}finally{D.loading=!1}}}async function ot(){try{const e=q.currentClient||"",n="/api/exceptions/stats?status=pending"+(e?"&client_id="+encodeURIComponent(e):""),a=await fetch(n,{headers:{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||"")}});if(!a.ok)return;const s=await a.json(),o=document.getElementById("nav-exc-badge");if(!o)return;const i=parseInt(s.pending||0,10);i>0?(o.textContent=i>99?"99+":String(i),o.style.display=""):o.style.display="none"}catch{}}function nr(e){document.getElementById("exc-kpi-pending").textContent=e.pending||0,document.getElementById("exc-kpi-high").textContent=e.high_severity||0,document.getElementById("exc-kpi-resolved").textContent=e.resolved||0,document.getElementById("exc-kpi-learned").textContent=e.learned_rules||0;const n=document.getElementById("exc-status-tab-count-pending"),a=document.getElementById("exc-status-tab-count-resolved"),s=document.getElementById("exc-status-tab-count-ignored");n&&(n.textContent=e.pending||0),a&&(a.textContent=e.resolved||0),s&&(s.textContent=e.ignored||0),document.querySelectorAll("#exc-status-tabs .exc-status-tab").forEach(i=>{i.classList.toggle("active",i.dataset.status===(q.currentStatus||"pending"))})}function ar(e,n){return n.split(",").reduce((a,s)=>a+(e[s]||0),0)}function zs(e){const n=document.getElementById("exc-chips");if(!n)return;const a=e.by_rule||{};let o=`<button class="exc-chip ${!q.currentRule?"active":""}" data-rule="">
        <span>${escapeHtml(t("exc-chip-all"))}</span>
        <span class="exc-chip-count">${e.pending||0}</span>
    </button>`;for(const i of Ud){const r=i.codes.join(","),l=ar(a,r),m=q.currentRule===r;l===0&&!m||(o+=`<button class="exc-chip ${m?"active":""}" data-rule="${escapeHtml(r)}">
            <span>${escapeHtml(t(i.labelKey))}</span>
            <span class="exc-chip-count">${l}</span>
        </button>`)}n.innerHTML=o,n.querySelectorAll(".exc-chip").forEach(i=>{i.addEventListener("click",()=>{const r=i.dataset.rule||null;q.currentRule=r,xt()})})}function Ns(e){const n=document.getElementById("exc-list");if(!n)return;if(!e||e.length===0){n.innerHTML=`<div class="exc-empty">
            ${zd()}
            <div class="exc-empty-title">${escapeHtml(t("exc-empty-title"))}</div>
            <div>${escapeHtml(t("exc-empty-desc"))}</div>
        </div>`,So();return}const a='<svg viewBox="0 0 14 14" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M3 7l3 3 5-5"/></svg>',s=(q.currentStatus||"pending")==="pending";n.innerHTML=e.map(o=>{const i=o.severity||"medium",r=Rs(o),l=o.seller_name&&o.seller_name.trim()?o.seller_name:t("exc-no-seller"),m=o.filename||"—",d=Od(o.invoice_date||o.created_at),p=o.status==="pending",c=q.selectedIds.has(o.id),u=s&&p;return`
            <div class="exc-row sev-${escapeHtml(i)} ${c?"selected":""}" data-exc-id="${escapeHtml(String(o.id))}">
                ...
                <div class="exc-row-sev">${Fd(i)}</div>
                ...
                <div class="exc-row-amount">${escapeHtml(Nd(o.total_amount))}</div>
            </div>
        `}).join(""),n.querySelectorAll(".exc-row").forEach(o=>{o.addEventListener("click",i=>{if(i.target.closest(".exc-row-check"))return;const r=o.dataset.excId;r&&Yd(parseInt(r,10))})}),n.querySelectorAll(".exc-row-check").forEach(o=>{o.addEventListener("click",i=>{i.stopPropagation();const r=parseInt(o.dataset.checkId,10);r&&(q.selectedIds.has(r)?(q.selectedIds.delete(r),o.classList.remove("checked"),o.closest(".exc-row").classList.remove("selected")):(q.selectedIds.add(r),o.classList.add("checked"),o.closest(".exc-row").classList.add("selected")),$o())})}),$o(),So()}function $o(){const e=document.getElementById("exc-batch-bar"),n=document.getElementById("exc-batch-count");if(!e||!n)return;const a=q.selectedIds.size;a===0?e.style.display="none":(e.style.display="",n.textContent=yt("exc-batch-count",{n:a}))}function So(){const e=document.getElementById("exc-list-foot"),n=document.getElementById("exc-list-count"),a=document.getElementById("exc-loadmore");if(!e||!n||!a)return;const s=q.listCache.length;if(s===0){e.style.display="none";return}e.style.display="";let o=s;const i=q.statsCache;i&&(q.currentRule?o=ar(i.by_rule||{},q.currentRule)||s:o=i.pending||s),q.total=o,n.textContent=yt("exc-list-count",{shown:s,total:o});const r=s<o&&s<500;a.style.display=r?"":"none"}async function tn(){try{if(navigator.onLine===!1)throw new Error("offline");const e=q.currentClient||"",n=q.currentStatus||"pending",a=new URLSearchParams;a.set("status",n),e&&a.set("client_id",e);const s="/api/exceptions/stats?"+a.toString(),o=await fetch(s,{headers:{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||"")}});if(!o.ok)throw new Error("http "+o.status);const i=await o.json();return q.statsCache=i,nr(i),zs(i),i}catch(e){return console.warn("loadExceptionsStats fail",e),null}}function ep(e){const n=document.getElementById("exc-list");if(!n)return;const a=`<svg class="exc-error-icon" viewBox="0 0 36 36" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round">
        <circle cx="18" cy="18" r="14"/>
        ...
        </div>`;const i=document.getElementById("exc-retry-btn");i&&i.addEventListener("click",()=>window.loadExceptionsPage&&window.loadExceptionsPage())}async function xt(e){e=e||{};const n=!!e.append,a=document.getElementById("exc-list");!n&&a&&q.listCache.length===0&&(a.innerHTML=`<div class="exc-loading">${escapeHtml(t("exc-loading"))}</div>`);const s=new URLSearchParams;s.set("status",q.currentStatus||"pending"),q.currentRule&&s.set("rule_code",q.currentRule),q.currentClient&&s.set("client_id",q.currentClient);const o=n?q.listCache.length:0;s.set("limit",String(q.pageSize)),s.set("offset",String(o));try{if(navigator.onLine===!1)throw new Error("offline");const i=await fetch("/api/exceptions/list?"+s.toString(),{headers:{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||"")}});if(!i.ok)throw new Error("http "+i.status);const l=(await i.json()).items||[];n?q.listCache=q.listCache.concat(l):(q.listCache=l,q.selectedIds.clear()),q.loadFailed=!1,Ns(q.listCache),q.statsCache&&zs(q.statsCache)}catch(i){console.warn("loadExceptionsList fail",i),q.loadFailed=!0;const r=navigator.onLine===!1||String(i.message||"").includes("offline");n?showToast(t("exc-toast-load-fail"),"error"):(ep(r),showToast(r?t("exc-offline"):t("exc-toast-load-fail"),"error"))}}async function tp(){if(!q.loading&&!(q.listCache.length>=500)){q.loading=!0;try{await xt({append:!0})}finally{q.loading=!1}}}function Os(){const e=document.getElementById("exc-client-filter");if(!e)return;const n=window._clientsCache||[],a=q.currentClient||"",s=typeof t=="function"?t("history-client-all"):"全部客户";e.innerHTML=`<option value="">${escapeHtml(s)}</option>`+n.map(o=>`<option value="${o.id}">${escapeHtml(o.name)}</option>`).join(""),e.value=a}async function np(){if(Nt.batchLoading)return;const e=Array.from(q.selectedIds);if(e.length===0||!await showConfirm(yt("exc-batch-confirm-resolve",{n:e.length})))return;Nt.batchLoading=!0;const a=showToast(yt("exc-batch-count",{n:e.length})+" …","loading",0);try{const s=await fetch("/api/exceptions/batch",{method:"POST",headers:{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||""),"Content-Type":"application/json"},body:JSON.stringify({ids:e,action:"resolve"})});if(!s.ok)throw new Error("http "+s.status);const o=await s.json();a(),showToast(yt("exc-toast-batch-resolved",{n:o.processed||0}),"success"),q.selectedIds.clear(),await tn(),await xt(),ot()}catch(s){a(),console.warn("batch resolve fail",s),showToast(t("exc-toast-batch-fail"),"error")}finally{Nt.batchLoading=!1}}async function ap(){if(Nt.batchLoading)return;const e=Array.from(q.selectedIds);if(e.length===0||!await showConfirm(yt("exc-batch-confirm-ignore",{n:e.length}),{danger:!1}))return;Nt.batchLoading=!0;const a=showToast(yt("exc-batch-count",{n:e.length})+" …","loading",0);try{const s=await fetch("/api/exceptions/batch",{method:"POST",headers:{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||""),"Content-Type":"application/json"},body:JSON.stringify({ids:e,action:"ignore"})});if(!s.ok)throw new Error("http "+s.status);const o=await s.json();a(),showToast(yt("exc-toast-batch-ignored",{n:o.processed||0,wl:o.whitelist_added||0}),"success"),q.selectedIds.clear(),await tn(),await xt(),ot()}catch(s){a(),console.warn("batch ignore fail",s),showToast(t("exc-toast-batch-fail"),"error")}finally{Nt.batchLoading=!1}}function sp(){q.selectedIds.clear(),Ns(q.listCache)}async function sr(){const e=document.getElementById("learned-list");if(e){e.innerHTML=`<div class="learned-empty">${escapeHtml(t("set-learned-loading"))}</div>`;try{const n=await fetch("/api/exception-whitelist",{headers:{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||"")}});if(!n.ok)throw new Error("http "+n.status);const s=(await n.json()).items||[];if(s.length===0){e.innerHTML=`<div class="learned-empty">${escapeHtml(t("set-learned-empty"))}</div>`;return}const o=`<svg viewBox="0 0 14 14" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round">
            <path d="M3 4h8M5.5 4V2.5h3V4M4 4l0.6 8.5h4.8L10 4"/>
        </svg>`;e.innerHTML=s.map(i=>{const r=Rs(i);return`
                <div class="learned-row" data-wl-id="${escapeHtml(String(i.id))}">
                    ...
                    <div class="learned-date">${escapeHtml(Gd(i.created_at))}</div>
                    <button class="learned-del-btn" data-del-wl="${escapeHtml(String(i.id))}" title="${escapeHtml(t("set-learned-del"))}" type="button">${o}</button>
                </div>
            `}).join("")}catch(n){console.warn("loadLearnedRules fail",n),e.innerHTML=`<div class="learned-empty">${escapeHtml(t("exc-toast-load-fail"))}</div>`}}}window.loadExceptionsPage=async function(){if(!q.loading){q.loading=!0;try{Os(),await tn(),await xt()}finally{q.loading=!1}}};window.refreshExcBadge=ot;window._refreshExcClientFilter=Os;window._excState=q;window._rerenderExceptions=function(){try{Os()}catch{}q.statsCache&&(nr(q.statsCache),zs(q.statsCache)),q.listCache&&q.listCache.length&&Ns(q.listCache);try{window._erpExcState&&window._erpExcState.items&&window._erpExcState.items.length&&typeof window._rerenderErpExceptions=="function"&&window._rerenderErpExceptions()}catch{}D.openExcId&&pt()};document.addEventListener("click",e=>{e.target.closest("#exc-drawer-close")&&Yt(),e.target.closest("#exc-drawer-mask")&&Yt(),e.target.closest("#exc-btn-resolve")&&Zd(),e.target.closest("#exc-btn-ignore")&&Qd(),e.target.closest("#exc-batch-resolve")&&np(),e.target.closest("#exc-batch-ignore")&&ap(),e.target.closest("#exc-batch-clear")&&sp(),e.target.closest("#exc-loadmore")&&tp()});document.addEventListener("keydown",e=>{e.key==="Escape"&&D.openExcId&&Yt()});document.addEventListener("click",e=>{e.target.closest("#btn-exc-refresh")&&(typeof window.loadExceptionsPage=="function"&&window.loadExceptionsPage(),ot())});document.addEventListener("change",e=>{if(!e.target.closest("#exc-client-filter"))return;const n=e.target;q.currentClient=n.value||"",q.currentRule=null,q.selectedIds.clear(),q.listCache=[],typeof window.loadExceptionsPage=="function"&&window.loadExceptionsPage(),ot()});document.addEventListener("click",e=>{const n=e.target.closest("#exc-status-tabs .exc-status-tab");if(!n)return;const a=n.dataset.status||"pending";a!==q.currentStatus&&(q.currentStatus=a,q.currentRule=null,q.selectedIds.clear(),q.listCache=[],typeof window.loadExceptionsPage=="function"&&window.loadExceptionsPage())});window.addEventListener("online",()=>{q.loadFailed&&document.getElementById("page-exceptions")?.classList.contains("show")&&window.loadExceptionsPage&&window.loadExceptionsPage()});setTimeout(ot,1500);setInterval(ot,6e4);window.loadLearnedRules=sr;document.addEventListener("click",async e=>{const n=e.target.closest("[data-del-wl]");if(!n)return;const a=parseInt(n.dataset.delWl,10);if(!a)return;const s=n.closest(".learned-row"),o=s&&s.querySelector(".learned-seller"),i=o?o.textContent.trim():"",r=t("set-learned-del-confirm").replace("{seller}",i);if(await showConfirm(r,{danger:!0}))try{const m=await fetch("/api/exception-whitelist/"+a,{method:"DELETE",headers:{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||"")}});if(!m.ok)throw new Error("http "+m.status);showToast(t("set-learned-del-ok"),"success"),sr(),typeof window.loadExceptionsPage=="function"&&document.getElementById("page-exceptions")?.classList.contains("show")&&window.loadExceptionsPage()}catch(m){console.warn("delete whitelist fail",m),showToast(t("set-learned-del-fail"),"error")}});let ce={items:[],q:"",cat:"",adapter:"",selected:new Set,total:0,categories:{},pageSize:30,loading:!1,focusSearch:!1,searchCaret:0},Co=null;function et(){return localStorage.getItem("mrpilot_token")||""}function To(e){return/<!?\s*doctype|<html|<\/?[a-z]+>|\bTraceback\b|^\s*ERR_[A-Z]/i.test(e)||e.length>200}function or(e){const n=typeof currentLang=="string"&&currentLang||window._currentLang||"th",a=e.error_friendly&&e.error_friendly[n];if(a)return a;if(typeof humanizeError=="function"&&e.error_msg&&!To(e.error_msg))try{const s=humanizeError(e.error_msg);if(s&&!To(s))return s}catch{}return t("erp-exc-reason-"+(e.category||"other"))}function Ho(){const e=document.getElementById("erp-exc-batch");if(!e)return;const n=ce.selected.size;e.hidden=n===0;const a=e.querySelector(".erp-exc-batch-count");a&&(a.textContent=String(n))}function Vs(){const e=document.getElementById("erp-exc-block");if(!e)return;const n=ce;if(!(n.total>0||!!n.q||!!n.cat)){e.hidden=!0,e.innerHTML="";return}e.hidden=!1;const s=n.categories||{},o=Object.keys(s).reduce((x,E)=>x+s[E],0);let i=`<button class="erp-exc-chip ${n.cat===""?"active":""}" data-erpexc-cat=""><span>${escapeHtml(t("erp-exc-cat-all"))}</span><span class="erp-exc-chip-count">${o}</span></button>`;Object.keys(s).forEach(x=>{i+=`<button class="erp-exc-chip ${n.cat===x?"active":""}" data-erpexc-cat="${escapeHtml(x)}"><span>${escapeHtml(t("erp-exc-cat-"+x))}</span><span class="erp-exc-chip-count">${s[x]}</span></button>`});const r=n.items||[],l=r.length>0&&r.every(x=>n.selected.has(x.id)),m=r.map(x=>{const E=x.state==="needs_action"?"needs":x.state==="retrying"?"retry":"fail",I=t("erp-exc-state-"+(x.state||"failed")),B=or(x),L=n.selected.has(x.id)?"checked":"",$=x.push_type==="id_card",C=$?`<span class="erp-exc-type-idcard">${escapeHtml(t("erp-log-type-idcard"))}</span> `:"",H=$?`<span class="ex-inv" title="${escapeHtml(t("erp-log-col-booking"))}">${C}${escapeHtml(x.invoice_no||"—")}</span>`:`<span class="ex-inv" title="${escapeHtml(x.invoice_no||"")}">${escapeHtml(x.invoice_no||"—")}</span>`,R=$?`<span class="ex-seller" title="${escapeHtml(t("erp-log-col-customer"))}">${escapeHtml(x.seller_name||"—")}</span>`:`<span class="ex-seller" title="${escapeHtml(x.seller_name||"")}">${escapeHtml(x.seller_name||"—")}</span>`,G=$?`<span class="ex-buyer" title="${escapeHtml(t("erp-log-col-idcard"))}">${x.id_card_tail?"••••"+escapeHtml(x.id_card_tail):"—"}</span>`:`<span class="ex-buyer" title="${escapeHtml(x.ocr_buyer_name||"")}">${escapeHtml(x.ocr_buyer_name||"—")}</span>`;return`<div class="erp-exc-row" data-erpexc-id="${escapeHtml(x.id)}">
        ...
        <div class="erp-exc-foot">${p}</div>`;const g=document.getElementById("erp-exc-search");if(g){if(n.focusSearch){g.focus();try{g.setSelectionRange(n.searchCaret,n.searchCaret)}catch{}}g.addEventListener("input",()=>{n.q=g.value,n.focusSearch=!0,n.searchCaret=g.selectionStart||g.value.length,clearTimeout(Co),Co=setTimeout(()=>Tt(!1),350)}),g.addEventListener("blur",()=>{n.focusSearch=!1})}e.querySelectorAll(".erp-exc-chip").forEach(x=>{x.addEventListener("click",()=>{n.cat=x.dataset.erpexcCat||"",Tt(!1)})});const _=document.getElementById("erp-exc-erp-select");_&&_.addEventListener("change",()=>{n.adapter=_.value||"",Tt(!1)}),e.querySelectorAll("[data-erpexc-retry]").forEach(x=>{x.addEventListener("click",E=>{E.stopPropagation(),Gn(x.dataset.erpexcRetry,x)})}),e.querySelectorAll(".erp-exc-cb").forEach(x=>{x.addEventListener("change",()=>{const E=x.dataset.erpexcCb;x.checked?n.selected.add(E):n.selected.delete(E);const I=document.getElementById("erp-exc-cb-all");I&&(I.checked=r.length>0&&r.every(B=>n.selected.has(B.id))),Ho()})});const w=document.getElementById("erp-exc-cb-all");w&&w.addEventListener("change",()=>{r.forEach(x=>{w.checked?n.selected.add(x.id):n.selected.delete(x.id)}),e.querySelectorAll(".erp-exc-cb").forEach(x=>{x.checked=w.checked}),Ho()}),e.querySelectorAll("[data-erpexc-batch]").forEach(x=>{x.addEventListener("click",()=>op(x.dataset.erpexcBatch))});const k=document.getElementById("erp-exc-more");k&&k.addEventListener("click",()=>Tt(!0)),e.querySelectorAll(".erp-exc-row:not(.erp-exc-row-head)").forEach(x=>{x.addEventListener("click",E=>{E.target.closest("input,button")||typeof window._erpExcOpenEdit=="function"&&window._erpExcOpenEdit(x.dataset.erpexcId)})})}async function Gn(e,n){if(e){n&&(n.disabled=!0,n.textContent=t("erp-exc-retrying"));try{const a=await fetch("/api/erp/logs/"+encodeURIComponent(e)+"/retry",{method:"POST",headers:{Authorization:"Bearer "+et()}}),s=await a.json().catch(()=>({}));showToast(a.ok&&s.ok?t("erp-exc-retry-ok"):t("erp-exc-retry-fail"),a.ok&&s.ok?"success":"error")}catch{showToast(t("erp-exc-retry-fail"),"error")}if(ce.selected.delete(e),Tt(!1),typeof window.refreshExcBadge=="function")try{window.refreshExcBadge()}catch{}}}async function op(e){const n=Array.from(ce.selected);if(e==="clear"){ce.selected.clear(),Vs();return}if(n.length!==0){if(e==="delete"){if(!await showConfirm(t("erp-exc-batch-delete-confirm",{n:n.length}),{danger:!0}))return;try{const s=await fetch("/api/erp/logs/batch-delete",{method:"POST",headers:{Authorization:"Bearer "+et(),"Content-Type":"application/json"},body:JSON.stringify({log_ids:n.slice(0,200)})}),o=await s.json().catch(()=>({}));showToast(s.ok?t("erp-exc-batch-delete-ok",{n:o.deleted||0}):t("erp-exc-retry-fail"),s.ok?"success":"error")}catch{showToast(t("erp-exc-retry-fail"),"error")}}else if(e==="retry")try{const a=await fetch("/api/erp/logs/batch-retry",{method:"POST",headers:{Authorization:"Bearer "+et(),"Content-Type":"application/json"},body:JSON.stringify({log_ids:n.slice(0,50)})}),s=await a.json().catch(()=>({}));showToast(a.ok?t("erp-exc-batch-retry-ok",{ok:s.succeeded||0,fail:(s.failed||0)+(s.skipped||0)}):t("erp-exc-retry-fail"),a.ok?"success":"error")}catch{showToast(t("erp-exc-retry-fail"),"error")}if(ce.selected.clear(),Tt(!1),typeof window.refreshExcBadge=="function")try{window.refreshExcBadge()}catch{}}}async function Tt(e){const n=document.getElementById("erp-exc-block");if(!(!n||ce.loading)){ce.loading=!0;try{if(!Array.isArray(window._erpEndpoints)||!window._erpEndpoints.length)try{const r=await fetch("/api/erp/endpoints",{headers:{Authorization:"Bearer "+et()}});if(r.ok){const l=await r.json();window._erpEndpoints=l&&(l.items||l)||[]}}catch{}const a=new URLSearchParams;ce.q&&a.set("q",ce.q),ce.cat&&a.set("category",ce.cat),ce.adapter&&a.set("adapter",ce.adapter),a.set("limit",String(ce.pageSize)),a.set("offset",String(e?ce.items.length:0));const s=await fetch("/api/erp/exceptions?"+a.toString(),{headers:{Authorization:"Bearer "+et()}});if(!s.ok){e||(n.hidden=!0);return}const o=await s.json(),i=o.items||[];ce.items=e?ce.items.concat(i):i,ce.total=o.total||0,ce.categories=o.categories||{},Vs()}catch{e||(n.hidden=!0)}finally{ce.loading=!1}}}window._rerenderErpExceptions=Vs;window.loadErpExceptions=Tt;window._erpExcState=ce;let Dn={};function Dt(){const e=document.getElementById("erp-exc-modal");e&&e.remove()}window._erpExcOpenEdit=function(e){const n=(ce.items||[]).find(p=>String(p.id)===String(e));if(!n)return;const a=n.push_type==="id_card",s=!!n.history_client_id&&n.category==="customer_mismatch",o=n.category==="product_mismatch"&&!!n.history_id&&!!n.endpoint_id,i=or(n),r=n.state==="needs_action"?"needs":n.state==="retrying"?"retry":"fail",l=(p,c)=>`<div class="erp-exc-m-row"><span class="erp-exc-m-k">${escapeHtml(p)}</span><span class="erp-exc-m-v">${escapeHtml(c||"—")}</span></div>`;let m="";if(s)m=`
        ...
        </div>`,document.body.appendChild(d),d.addEventListener("click",p=>{p.target===d&&Dt()}),document.getElementById("erp-exc-m-close").addEventListener("click",Dt),document.getElementById("erp-exc-m-cancel").addEventListener("click",Dt),document.getElementById("erp-exc-m-retry").addEventListener("click",()=>{Dt(),Gn(n.id,null)}),s){let p="";const c=document.getElementById("erp-exc-m-bind"),u=document.getElementById("erp-exc-m-custlist"),v=document.getElementById("erp-exc-m-search"),f=(b,h)=>{const g=(h||"").trim().toLowerCase(),_=g?b.filter(w=>(w.code||"").toLowerCase().includes(g)||(w.name||"").toLowerCase().includes(g)):b;if(_.length===0){u.innerHTML=`<div class="erp-exc-m-empty">${escapeHtml(t("erp-exc-edit-pick-empty"))}</div>`;return}u.innerHTML=_.slice(0,100).map(w=>`<div class="erp-exc-m-cust" data-cust-code="${escapeHtml(w.code||"")}">
                    <span class="erp-exc-m-cust-name">${escapeHtml(w.name||"")}</span>
                    <span class="erp-exc-m-cust-code">${escapeHtml(w.code||"")}</span>
                </div>`).join(""),u.querySelectorAll(".erp-exc-m-cust").forEach(w=>{w.addEventListener("click",()=>{p=w.dataset.custCode||"",u.querySelectorAll(".erp-exc-m-cust").forEach(k=>k.classList.remove("sel")),w.classList.add("sel"),c&&(c.disabled=!p)})})},y=async()=>{const b=n.endpoint_id;if(Dn[b]){f(Dn[b],"");return}try{const h=await fetch("/api/erp/endpoints/"+encodeURIComponent(b)+"/customers",{headers:{Authorization:"Bearer "+et()}}),g=await h.json().catch(()=>({}));if(!h.ok||!g.ok){u.innerHTML=`<div class="erp-exc-m-empty">${escapeHtml(t("erp-exc-edit-pick-fail"))}</div>`;return}const _=g.customers||[];Dn[b]=_,f(_,"")}catch{u.innerHTML=`<div class="erp-exc-m-empty">${escapeHtml(t("erp-exc-edit-pick-fail"))}</div>`}};v&&v.addEventListener("input",()=>f(Dn[n.endpoint_id]||[],v.value)),y(),c&&c.addEventListener("click",async()=>{if(p){c.disabled=!0,c.textContent=t("erp-exc-retrying");try{if(!(await fetch("/api/erp/mappings/clients",{method:"POST",headers:{Authorization:"Bearer "+et(),"Content-Type":"application/json"},body:JSON.stringify({client_id:n.history_client_id,erp_type:n.endpoint_adapter,erp_code:p})})).ok){showToast(t("erp-exc-retry-fail"),"error"),c.disabled=!1,c.textContent=t("erp-exc-edit-bind-retry");return}showToast(t("erp-exc-edit-bound-ok"),"success"),Dt(),await Gn(n.id,null)}catch{showToast(t("erp-exc-retry-fail"),"error"),c.disabled=!1,c.textContent=t("erp-exc-edit-bind-retry")}}})}if(o){const p=document.getElementById("erp-exc-m-bind-prod"),c=document.getElementById("erp-exc-m-prodlist"),u={};let v=[];const f=()=>'<option value="">'+escapeHtml(t("erp-exc-edit-prod-choose"))+"</option>"+v.slice(0,500).map(h=>`<option value="${escapeHtml(h.code||"")}" data-pname="${escapeHtml(h.name||"")}">`+escapeHtml((h.name||"")+" · "+(h.code||""))+"</option>").join(""),y=h=>{if(!h.length){c.innerHTML=`<div class="erp-exc-m-empty">${escapeHtml(t("erp-exc-edit-prod-noitems"))}</div>`;return}c.innerHTML=h.map(g=>`<div class="erp-exc-m-cust" style="cursor:default">
...
`;let Ao=!1,ka=[],as=null,We="amount_limit",Us="global";const lp="/api/knowledge/rules";function cp(){return localStorage.getItem("mrpilot_token")||""}async function Jt(e,n,a){return fetch(lp+n,{method:e,headers:{Authorization:"Bearer "+cp(),"Content-Type":"application/json"},body:a?JSON.stringify(a):void 0})}function dp(e){const n=Number(e);return Number.isFinite(n)?"฿ "+n.toLocaleString("en-US"):String(e)}function pp(e){const n=he(),a=s=>e===s?" selected":"";return`<option value="high"${a("high")}>${n.sevHigh}</option><option value="medium"${a("medium")}>${n.sevMid}</option><option value="low"${a("low")}>${n.sevLow}</option>`}function Po(e,n){const a=n&&n.subject_key?escapeHtml(n.subject_key):"";return`<div class="rs-mlbl">${e}</div><input class="rs-field" id="rs-f-key" value="${a}"${n?" disabled":""}>`}function up(e){const n=he(),a=e.subject_key?escapeHtml(e.subject_key):"";if(e.rule_type==="amount_limit"){const s=dp(e.rule_body.limit);let o=n.gAmount;e.subject_type==="global"?o=n.anyInvoice:e.subject_type==="supplier"?o=`${n.fSupplierTax} <b>${a}</b>`:o=`「${a}」`;const i=e.rule_body.notify_line?` <span class="rs-line">${gt("bell",12)} ${n.alsoLine}</span>`:"";return`${o} &gt; <b>${s}</b>${i}`}if(e.rule_type==="supplier_force_review")return`<b>${a}</b> · ${n.tForceDesc}`;if(e.rule_type==="no_auto_push_category")return`「${a}」 · ${n.tCategoryDesc}`;if(e.rule_type==="accounting_period"){const o=e.rule_body.mode==="prev_month"?n.pmPrev:n.pmCurrent;return`${n.gPeriodDesc} · <b>${o}</b>`}return e.rule_type}function mp(e){const n=he(),a=e.severity||"medium",s=a==="high"?n.sevHigh:a==="low"?n.sevLow:n.sevMid;return`<div class="rs-rule"><div class="rs-rm"><div class="rs-rt">${up(e)}</div></div><span class="rs-sev ${a}">${s}</span><button class="rs-sw${e.is_active?"":" off"}" data-toggle="${e.id}" aria-label="toggle"></button><button class="rs-icobtn" data-edit="${e.id}" aria-label="edit">${gt("pencil",14)}</button><button class="rs-icobtn" data-del="${e.id}" aria-label="delete">${gt("trash",14)}</button></div>`}function qn(e,n,a,s,o){const i=he(),l=ka.filter(m=>o.includes(m.rule_type)).map(mp).join("")||`<div class="rs-empty">${i.empty}</div>`;return`<div class="rs-group"><div class="rs-ghead"><div class="rs-gico">${gt(e,17)}</div><div><div class="rs-gt">${n}</div><div class="rs-gd">${a}</div></div><button class="rs-addbtn" data-add-type="${s}">${gt("plus",14)} ${i.add}</button></div><div class="rs-gbody">${l}</div></div>`}function ir(){const e=he(),n=document.querySelector("#rules-settings-modal .rs-head h2");n&&(n.textContent=e.title);const a=document.getElementById("rs-body");a&&(a.innerHTML=`<p class="rs-lead">${e.lead}</p>`+qn("building",e.gSupplier,e.gSupplierDesc,"supplier_force_review",["supplier_force_review"])+qn("wallet",e.gAmount,e.gAmountDesc,"amount_limit",["amount_limit"])+qn("calendar",e.gPeriod,e.gPeriodDesc,"accounting_period",["accounting_period"])+qn("octagon",e.gCategory,e.gCategoryDesc,"no_auto_push_category",["no_auto_push_category"]))}async function Gs(){try{const e=await Jt("GET","?include_inactive=1");if(!e.ok)throw new Error("http "+e.status);ka=(await e.json()).rules||[],ir()}catch{showToast(he().loadFail,"error")}}function ss(e){const n=he(),a=e?e.severity:We==="supplier_force_review"?"high":"medium",s=`<div class="rs-mlbl">${n.fSeverity}</div><select class="rs-field" id="rs-f-sev">${pp(a)}</select>`;if(We==="amount_limit"){const i=e?e.subject_type:Us,r=e&&e.subject_key?escapeHtml(e.subject_key):"",l=e?String(e.rule_body.limit??""):"",m=e?!!e.rule_body.notify_line:!0,d=i==="global"?"":`<div class="rs-mlbl">${i==="category"?n.fCategory:n.fSupplierTax}</div><input class="rs-field" id="rs-f-key" value="${r}">`;return`<div class="rs-mlbl">${n.gAmountDesc}</div><select class="rs-field" id="rs-f-scope"${e?" disabled":""}><option value="global"${i==="global"?" selected":""}>${n.anyInvoice}</option><option value="supplier"${i==="supplier"?" selected":""}>${n.tForce}</option><option value="category"${i==="category"?" selected":""}>${n.fCategory}</option></select><div id="rs-f-subj">${d}</div><div class="rs-two"><div><div class="rs-mlbl">${n.fAmountLimit}</div><input class="rs-field" id="rs-f-limit" type="number" min="1" value="${l}"></div><div>${s}</div></div><label class="rs-check"><input type="checkbox" id="rs-f-line"${m?" checked":""}>${gt("bell",14)} ${n.fAlsoLine}</label>`}if(We==="supplier_force_review")return Po(n.fSupplierTax,e)+s;if(We==="no_auto_push_category")return Po(n.fCategory,e)+s;const o=e?e.rule_body.mode:"current_month";return`<div class="rs-mlbl">${n.fPeriodMode}</div><select class="rs-field" id="rs-f-mode"><option value="current_month"${o==="current_month"?" selected":""}>${n.pmCurrent}</option><option value="prev_month"${o==="prev_month"?" selected":""}>${n.pmPrev}</option></select>`+s}function Rn(e,n,a){return`<button class="rs-type${We===e?" on":""}" data-type-pick="${e}"><div class="tt">${n}</div><div class="td">${a}</div></button>`}function vp(e){const n=he(),a=document.getElementById("rs-add-modal");if(!a)return;const s=e?"":`<div class="rs-mlbl">${n.rType}</div><div class="rs-types">`+Rn("supplier_force_review",n.tForce,n.tForceDesc)+Rn("amount_limit",n.tAmount,n.tAmountDesc)+Rn("accounting_period",n.tPeriod,n.tPeriodDesc)+Rn("no_auto_push_category",n.tCategory,n.tCategoryDesc)+"</div>";a.innerHTML=`<div class="rs-pop" style="max-width:460px;"><div class="rs-head"><h2>${e?n.editTitle:n.addTitle}</h2><button class="rs-close" id="rs-add-close">${gt("x",18)}</button></div><div class="rs-body">${s}<div id="rs-add-fields">${ss(e)}</div></div><div class="rs-foot" style="gap:10px;"><button class="rs-btn rs-btn-ghost" id="rs-add-cancel">${n.cancel}</button><button class="rs-btn rs-btn-primary" id="rs-add-save">${n.save}</button></div></div>`,a.classList.add("rs-open")}function It(e){const n=document.getElementById(e);return n?String(n.value).trim():""}function fp(){const e=he(),n=It("rs-f-sev")||"medium";if(We==="amount_limit"){const a=It("rs-f-scope")||"global",s=Number(It("rs-f-limit"));if(!Number.isFinite(s)||s<=0)return showToast(e.needAmount,"error"),{ok:!1};const o=a==="global"?null:It("rs-f-key");if(a!=="global"&&!o)return showToast(a==="category"?e.needCategory:e.needSupplier,"error"),{ok:!1};const i=document.getElementById("rs-f-line")?.checked;return{ok:!0,payload:{rule_type:"amount_limit",subject_type:a,subject_key:o,severity:n,rule_body:{limit:s,basis:"total",period:"per_invoice",notify_line:!!i}}}}if(We==="supplier_force_review"){const a=It("rs-f-key");return a?{ok:!0,payload:{rule_type:"supplier_force_review",subject_type:"supplier",subject_key:a,severity:n,rule_body:{}}}:(showToast(e.needSupplier,"error"),{ok:!1})}if(We==="no_auto_push_category"){const a=It("rs-f-key");return a?{ok:!0,payload:{rule_type:"no_auto_push_category",subject_type:"category",subject_key:a,severity:n,rule_body:{}}}:(showToast(e.needCategory,"error"),{ok:!1})}return{ok:!0,payload:{rule_type:"accounting_period",subject_type:"global",subject_key:null,severity:n,rule_body:{mode:It("rs-f-mode")||"current_month"}}}}async function hp(){const e=fp();if(!(!e.ok||!e.payload))try{let n;if(as!==null){const a=e.payload;n=await Jt("PATCH","/"+as,{rule_body:a.rule_body,severity:a.severity})}else n=await Jt("POST","",e.payload);if(!n.ok)throw new Error("http "+n.status);showToast(he().saved,"success"),document.getElementById("rs-add-modal")?.classList.remove("rs-open"),await Gs()}catch{showToast(he().saveFail,"error")}}async function gp(e){const n=ka.find(o=>o.id===e);if(!n)return;const a=!n.is_active;n.is_active=a;const s=document.querySelector(`#rules-settings-modal [data-toggle="${e}"]`);s&&s.classList.toggle("off",!a);try{const o=await Jt("PATCH","/"+e,{is_active:a});if(!o.ok)throw new Error("http "+o.status);showToast(a?he().enabled:he().disabled,"success")}catch{n.is_active=!a,s&&s.classList.toggle("off",a),showToast(he().saveFail,"error")}}async function bp(e){if(await showConfirm(he().delConfirm,{danger:!0}))try{const a=await Jt("DELETE","/"+e);if(!a.ok)throw new Error("http "+a.status);showToast(he().deleted,"success"),await Gs()}catch{showToast(he().saveFail,"error")}}function jo(e,n){We=e,Us="global",as=n?n.id:null,vp(n)}function yp(){if(Ao)return;const e=document.createElement("style");e.textContent=rp,document.head.appendChild(e);const n=he(),a=document.createElement("div");a.id="rules-settings-modal",a.innerHTML=`<div class="rs-pop"><div class="rs-head"><h2>${n.title}</h2><span class="rs-tag">●</span><button class="rs-close" id="rs-main-close">${gt("x",18)}</button></div><div class="rs-body" id="rs-body"></div><div class="rs-foot"><button class="rs-btn rs-btn-primary" id="rs-done">${n.done}</button></div></div>`,document.body.appendChild(a);const s=document.createElement("div");s.id="rs-add-modal",document.body.appendChild(s),document.addEventListener("click",o=>{const i=o.target;(i.id==="rules-settings-modal"||i.closest("#rs-main-close")||i.closest("#rs-done"))&&a.classList.remove("rs-open"),(i.id==="rs-add-modal"||i.closest("#rs-add-close")||i.closest("#rs-add-cancel"))&&s.classList.remove("rs-open");const r=i.closest("[data-add-type]");r&&jo(r.dataset.addType);const l=i.closest("[data-edit]");if(l){const c=ka.find(u=>u.id===Number(l.dataset.edit));c&&jo(c.rule_type,c)}const m=i.closest("[data-del]");m&&bp(Number(m.dataset.del));const d=i.closest("[data-toggle]");d&&gp(Number(d.dataset.toggle));const p=i.closest("[data-type-pick]");if(p){We=p.dataset.typePick,document.querySelectorAll("#rs-add-modal .rs-type").forEach(u=>u.classList.toggle("on",u.dataset.typePick===We));const c=document.getElementById("rs-add-fields");c&&(c.innerHTML=ss())}i.closest("#rs-add-save")&&hp()}),document.addEventListener("change",o=>{const i=o.target;if(i.id==="rs-f-scope"){Us=i.value;const r=document.getElementById("rs-add-fields");r&&(r.innerHTML=ss())}}),document.addEventListener("keydown",o=>{o.key==="Escape"&&(s.classList.contains("rs-open")?s.classList.remove("rs-open"):a.classList.contains("rs-open")&&a.classList.remove("rs-open"))}),Ao=!0}window.openRulesSettings=function(){yp(),document.getElementById("rules-settings-modal").classList.add("rs-open"),Gs()};function wp(){const e=document.querySelector("#page-exceptions .page-head-actions");if(!e||document.getElementById("exc-rules-btn"))return;const n=document.createElement("button");n.id="exc-rules-btn",n.type="button",n.className="btn btn-ghost",n.innerHTML=gt("settings",16)+`<span class="rs-btn-label">${he().btn}</span>`,n.addEventListener("click",()=>window.openRulesSettings&&window.openRulesSettings()),e.insertBefore(n,e.firstChild)}let Do=!1;async function kp(){if(!Do){Do=!0;try{(await Jt("GET","")).ok&&wp()}catch{}}}const qo=window.loadExceptionsPage;window.loadExceptionsPage=function(){kp(),qo&&qo()};Array.isArray(window.__i18nSubs)||(window.__i18nSubs=[]);window.__i18nSubs.push({name:"rules-settings",fn:()=>{const e=document.querySelector("#exc-rules-btn .rs-btn-label");e&&(e.textContent=he().btn),document.getElementById("rules-settings-modal")?.classList.contains("rs-open")&&ir()}});(function(){const e=document.getElementById("page-knowledge");if(!(!e||e.dataset.wbInjected==="1")){if(!document.getElementById("kb-center-style")){const n=document.createElement("style");n.id="kb-center-style",n.textContent=`
...
`,e.dataset.wbInjected="1";try{const n=window._currentLang||localStorage.getItem("mrpilot_lang")||"th",a=window.I18N;a&&a[n]&&e.querySelectorAll("[data-i18n]").forEach(s=>{const o=s.getAttribute("data-i18n");a[n][o]&&(s.textContent=a[n][o])})}catch{}}})();const xp="/api/knowledge",kt="/static/brand/kb-cat.png?v=2";function _p(){return localStorage.getItem("mrpilot_token")||""}function z(e,n){if(typeof window.t=="function"){const a=window.t(e);if(a&&a!==e)return a}return n}function K(e){return typeof escapeHtml=="function"?escapeHtml(String(e??"")):String(e??"")}const Ro={file:'<path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><path d="M14 2v6h6"/>',"file-text":'<path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><path d="M14 2v6h6"/><path d="M16 13H8"/><path d="M16 17H8"/><path d="M10 9H8"/>',sheet:'<rect width="18" height="18" x="3" y="3" rx="2"/><path d="M3 9h18"/><path d="M3 15h18"/><path d="M9 3v18"/><path d="M15 3v18"/>',image:'<rect width="18" height="18" x="3" y="3" rx="2"/><circle cx="9" cy="9" r="2"/><path d="m21 15-3.1-3.1a2 2 0 0 0-2.8 0L6 21"/>',upload:'<path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><path d="M14 2v6h6"/><path d="M12 18v-6"/><path d="m9 15 3-3 3 3"/>',message:'<path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/>',"shield-check":'<path d="M20 13c0 5-3.5 7.5-7.7 9a1 1 0 0 1-.7 0C7.5 20.5 4 18 4 13V6a1 1 0 0 1 1-1c2 0 4.5-1.2 6.2-2.7a1.2 1.2 0 0 1 1.6 0C14.5 3.8 17 5 19 5a1 1 0 0 1 1 1z"/><path d="m9 12 2 2 4-4"/>',check:'<path d="M20 6 9 17l-5-5"/>',x:'<path d="M18 6 6 18"/><path d="M6 6l12 12"/>'};function Ke(e){return`<svg class="kb-ic" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round">${Ro[e]||Ro.file}</svg>`}function rr(e){const n=`kb-${e}-mask`,a=`kb-${e}-modal`,s=()=>document.getElementById(n)?.classList.add("open"),o=()=>document.getElementById(n)?.classList.remove("open");let i=document.getElementById(n);if(!i){i=document.createElement("div"),i.id=n,i.className=`kb-${e}-mask`,i.innerHTML=`<div class="kb-${e}-modal" id="${a}" role="dialog" aria-modal="true"></div>`,document.body.appendChild(i);const r=i;r.addEventListener("click",l=>{(l.target===r||l.target.closest(`[data-kb-${e}-close]`))&&o()}),document.addEventListener("keydown",l=>{l.key==="Escape"&&r.classList.contains("open")&&o()})}return{modal:document.getElementById(a),open:s,close:o}}function xa(){const e=window.getActiveWorkspaceClientId;if(typeof e!="function")return null;const n=e(),a=Number(n);return Number.isFinite(a)&&a>0?a:null}function lr(){const e=xa();if(!e)return"";const a=(window._workspaceClientsCache||[]).find(s=>Number(s.id)===e);return a&&a.name?String(a.name):"#"+e}async function nn(e,n,a,s={}){const o=new URL(xp+n,location.origin),i=xa();if(s.query)for(const[d,p]of Object.entries(s.query))p!=null&&o.searchParams.set(d,String(p));const r=s.withWorkspace!==!1&&i!=null;r&&(e==="GET"||e==="DELETE")&&o.searchParams.set("workspace_client_id",String(i));const l={Authorization:"Bearer "+_p()};let m=s.raw;if(!s.raw&&a!==void 0){const d=r?{workspace_client_id:i,...a}:a;l["Content-Type"]="application/json",m=JSON.stringify(d)}try{const d=await fetch(o.toString(),{method:e,headers:l,body:m});let p=null,c;const u=await d.text();if(u)try{const v=JSON.parse(u);d.ok?p=v:c=v?.detail?.error_code||v?.message_key||v?.detail||void 0}catch{}return{ok:d.ok,status:d.status,data:p,error:c}}catch{return{ok:!1,status:0,data:null,error:"network"}}}async function Ep(e,n){const a=new FormData;a.append("file",e);const s=xa();return s!=null&&a.append("workspace_client_id",String(s)),nn("POST","/documents",void 0,{raw:a,withWorkspace:!1})}let Fn=null;async function cr(){if(Fn!==null)return Fn;const e=await nn("GET","/bases",void 0,{withWorkspace:!1});return Fn=e.status===200||e.status===401||e.status===403,Fn}let Fo=!1;function dr(){const e=document.getElementById("kb-ws-bar"),n=document.getElementById("kb-ws-label");if(!e||!n)return;xa()?(e.classList.remove("kb-ws-empty"),n.innerHTML=z("kb-ws-current","账套主体")+"：<b>"+K(lr())+"</b>"):(e.classList.add("kb-ws-empty"),n.textContent=z("kb-ws-none","请先在右上角选择账套主体,再使用客户私有文档与问答。"))}function Ip(e){document.querySelectorAll(".kb-tab-bar .recon-tab-btn").forEach(n=>{n.classList.toggle("active",n.dataset.kbTab===e)}),document.querySelectorAll(".kb-pane").forEach(n=>{n.classList.toggle("active",n.id==="kb-pane-"+e)}),e==="docs"&&typeof window._kbRenderDocs=="function"&&window._kbRenderDocs(),e==="qa"&&typeof window._kbRenderAsk=="function"&&window._kbRenderAsk()}function Bp(){if(Fo)return;const e=document.querySelector(".kb-tab-bar");if(!e)return;e.addEventListener("click",s=>{const o=s.target.closest(".recon-tab-btn");o&&o.dataset.kbTab&&Ip(o.dataset.kbTab)});const n=document.getElementById("kb-open-rules");n&&n.addEventListener("click",()=>{typeof window.openRulesSettings=="function"&&window.openRulesSettings()});const a=document.getElementById("kb-info-btn");a&&a.addEventListener("click",()=>{typeof window._kbOpenInfo=="function"&&window._kbOpenInfo()}),Fo=!0}window.loadKnowledgePage=function(){Bp(),dr(),document.querySelector('.kb-tab-bar .recon-tab-btn[data-kb-tab="docs"]')?.classList.contains("active")&&typeof window._kbRenderDocs=="function"&&window._kbRenderDocs()};async function zo(){if(!window._knowledgeProbed){window._knowledgeProbed=!0;try{if(await cr()){const e=document.getElementById("nav-knowledge");e&&(e.style.display="")}}catch{}}}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",zo):zo();Array.isArray(window.__i18nSubs)||(window.__i18nSubs=[]);window.__i18nSubs.push({name:"knowledge-center",fn:dr});let os=!1,ut=[];function Lp(e){if(e.status==="ready")return`<span class="kb-badge ready"><span class="kb-bdot"></span>${K(z("kb-doc-ready","已就绪"))}</span>`;if(e.status==="failed")return`<span class="kb-badge failed"><span class="kb-bdot"></span>${K(z("kb-doc-failed","失败"))}</span>`;const n=e.status==="uploading"?z("kb-doc-uploading","上传中…"):z("kb-doc-parsing","解析中");return`<span class="kb-badge parsing"><span class="kb-bdot"></span>${K(n)}</span>`}function $p(e){return e==="unsupported_document"?z("kb-err-unsupported_document","不支持的文件类型"):e==="embedding_failed"?z("kb-err-embedding_failed","向量化失败，可重试"):e==="processing_failed"?z("kb-err-processing_failed","文件无法解析，可能已损坏或加密"):e?z("kb-doc-failed","失败"):""}function Sp(e){return(e||"").slice(0,10)}function Cp(e){let n;e.status==="failed"&&e.error_code?n=`<div class="kb-doc-sub err">${K($p(e.error_code))}</div>`:e.status==="uploading"?n=`<div class="kb-doc-sub">${K(z("kb-doc-uploading","上传中…"))}</div>`:n=`<div class="kb-doc-sub">${K((e.source_type||"").toUpperCase())} · ${K(Sp(e.created_at))}</div>`;const a=e.status==="uploading"?"":`<button class="btn btn-sm btn-ghost kb-doc-del" data-id="${e.id}">${K(z("kb-doc-delete","删除"))}</button>`;return`<div class="kb-doc-row" data-id="${e.id}">
        <div class="kb-doc-ic">${Tp(e.source_type)}</div>
        <div class="kb-doc-meta"><div class="kb-doc-name">${K(e.filename)}</div>${n}</div>
        ${Lp(e)}${a}
    </div>`}function Tp(e){const n=(e||"").toLowerCase();return n==="doc"||n==="docx"?Ke("file-text"):n==="xls"||n==="xlsx"||n==="csv"?Ke("sheet"):["png","jpg","jpeg","webp"].includes(n)?Ke("image"):Ke("file")}function pr(){return document.getElementById("kb-doc-list")}function En(){const e=pr();if(e){if(!ut.length){e.innerHTML=`<div class="kb-empty">
        ...
        </div>`;return}e.innerHTML=ut.map(Cp).join("")}}function No(e){const n=pr();n&&(n.innerHTML=e)}async function ur(){No('<div class="kb-skel"><div class="kb-skrow"></div><div class="kb-skrow"></div><div class="kb-skrow"></div></div>');const e=await nn("GET","/documents");if(!e.ok){No(`<div class="kb-empty err">
            <div>${K(z("kb-doc-error","加载失败"))}</div>
            <button class="btn btn-sm kb-doc-reload" style="margin-top:12px">${K(z("kb-doc-retry","重试"))}</button>
        </div>`);return}ut=(e.data?.documents||[]).filter(n=>n.status!=="deleted"),En()}async function Oo(e){const n=Array.from(e);if(n.length)for(const a of n){const s=-Date.now()-Math.floor(Math.random()*1e3);ut.unshift({id:s,filename:a.name,source_type:(a.name.split(".").pop()||"").toLowerCase(),status:"uploading",error_code:null,created_at:new Date().toISOString()}),En();const o=await Ep(a),i=ut.findIndex(r=>r.id===s);i<0||(o.ok&&o.data?.document?(ut[i]=o.data.document,o.data.document.status==="failed"&&showToast(z("kb-doc-failed","失败")+"："+a.name,"error")):(ut.splice(i,1),showToast(z("kb-upload-fail","上传失败")+"："+a.name,"error")),En())}}async function Hp(e){if(!(typeof showConfirm=="function"?await showConfirm(z("kb-doc-del-confirm","确定删除这份文档？删除后 AI 将不再引用它。")):!0))return;(await nn("DELETE","/documents/"+e)).ok?(ut=ut.filter(s=>s.id!==e),En()):showToast(z("kb-doc-del-fail","删除失败"),"error")}function Mp(){const e=document.getElementById("kb-pane-docs");if(!e||os&&e.querySelector("#kb-doc-list"))return;if(!document.getElementById("kb-docs-style")){const s=document.createElement("style");s.id="kb-docs-style",s.textContent=`
...
`,document.head.appendChild(s)}e.innerHTML=`
    ...
    `;try{const s=window._currentLang||localStorage.getItem("mrpilot_lang")||"th",o=window.I18N;o&&o[s]&&e.querySelectorAll("[data-i18n]").forEach(i=>{const r=i.getAttribute("data-i18n");o[s][r]&&(i.textContent=o[s][r])})}catch{}const n=e.querySelector("#kb-up"),a=e.querySelector("#kb-file");n.addEventListener("click",s=>{s.target.closest("input")||a.click()}),a.addEventListener("change",()=>{a.files&&Oo(a.files),a.value=""}),["dragenter","dragover"].forEach(s=>n.addEventListener(s,o=>{o.preventDefault(),n.classList.add("drag")})),["dragleave","drop"].forEach(s=>n.addEventListener(s,o=>{o.preventDefault(),n.classList.remove("drag")})),n.addEventListener("drop",s=>{const o=s.dataTransfer;o?.files?.length&&Oo(o.files)}),e.addEventListener("click",s=>{const o=s.target,i=o.closest(".kb-doc-del");if(i?.dataset.id){Hp(Number(i.dataset.id));return}o.closest(".kb-doc-reload")&&ur()}),os=!0}function Ap(){Mp(),ur()}window._kbRenderDocs=Ap;Array.isArray(window.__i18nSubs)||(window.__i18nSubs=[]);window.__i18nSubs.push({name:"knowledge-documents",fn:()=>{os&&En()}});let sa=null;function Pp(){if(sa)return;const e=document.createElement("style");e.id="kb-src-style",e.textContent=`
...
`,document.head.appendChild(e),sa=rr("src")}function jp(e){const n=K(e.text).replace(/\n/g,"<br>");return`<span class="seg${e.matched?" hit":""}">${n}</span>`}function Dp(e){return e.segments.map(jp).join("<br><br>")}async function qp(e){Pp();const n=sa?.modal;if(!n)return;const a=e.filename||z("kb-src-unknown","未知来源"),s=typeof e.score=="number"?Math.round(Math.max(0,Math.min(1,e.score))*100):null,o=typeof e.chunk_id=="number";if(n.innerHTML=`
    ...
    `,sa?.open(),!o)return;const i=await nn("GET","/chunks/"+e.chunk_id),r=n.querySelector("#kb-src-preview");r&&(i.ok&&i.data?.segments?.length?r.innerHTML=Dp(i.data):r.innerHTML=`<div class="kb-src-fail">${K(z("kb-src-load-fail","原文片段暂时取不到,可在文档库打开原件核对。"))}</div>`)}window._kbOpenSource=e=>{qp(e)};function Rp(e){return`<div class="kb-msg user"><div class="kb-bub">${K(e)}</div></div>`}function Fp(e){const n=e.filename||z("kb-src-unknown","未知来源");return`<button class="kb-cite" data-cite='${K(JSON.stringify(e))}'>
        ...
        ${K(n)}<span class="ch">›</span></button>`}function zp(e){if(e.no_answer){const a=z(e.message_key||"ask.no_source","资料不足，无法判断。");return`<div class="kb-msg ai"><div class="kb-ava"><img src="${kt}" alt=""></div>
            <div class="kb-bub no-src">${K(a)}</div></div>`}const n=(e.citations||[]).map(a=>Fp(a)).join("");return`<div class="kb-msg ai"><div class="kb-ava"><img src="${kt}" alt=""></div>
        <div class="kb-bub">${K(e.answer)}${n?`<div class="kb-cites">${n}</div>`:""}</div></div>`}function Np(e){return nn("POST","/ask",{question:e})}function Vo(e){return`<div class="kb-msg ai"><div class="kb-ava"><img src="${kt}" alt=""></div><div class="kb-bub no-src">${K(e)}</div></div>`}function mr(e,n,a){if(e.dataset.kbWired==="1")return;e.dataset.kbWired="1";let s=!1;function o(r){const l=document.createElement("div");l.innerHTML=r;const m=l.firstElementChild;return e.appendChild(m),e.scrollTop=e.scrollHeight,m}async function i(){const r=n.value.trim();if(!r||s)return;s=!0,n.value="",o(Rp(r));const l=o(`<div class="kb-msg ai"><div class="kb-ava"><img src="${kt}" alt=""></div><div class="kb-bub kb-thinking">${K(z("kb-ask-thinking","思考中…"))}</div></div>`),m=await Np(r);if(l.remove(),m.status===402){const d=z("kb-ask-low-balance","余额不足，请先充值后再提问。");o(Vo(d)),typeof showToast=="function"&&showToast(d,"error")}else if(!m.ok||!m.data){const d=z("kb-ask-error","出错了，请稍后重试。");o(Vo(d)),typeof showToast=="function"&&showToast(d,"error")}else o(zp(m.data));s=!1}a.addEventListener("click",i),n.addEventListener("keydown",r=>{r.key==="Enter"&&!r.shiftKey&&(r.preventDefault(),i())}),e.addEventListener("click",r=>{const l=r.target.closest(".kb-cite");if(!(!l||!l.dataset.cite))try{const m=JSON.parse(l.dataset.cite);typeof window._kbOpenSource=="function"&&window._kbOpenSource(m)}catch{}})}window._kbWireAsk=mr;function Op(){if(document.getElementById("kb-ask-style"))return;const e=document.createElement("style");e.id="kb-ask-style",e.textContent=`
...
`,document.head.appendChild(e)}function Vp(){const e=document.getElementById("kb-pane-qa");if(!e||e.dataset.kbBuilt==="1")return;Op();const n=K(z("kb-ask-ex1","这家客户有金额上限吗？")),a=K(z("kb-ask-ex2","合同约定的付款周期是多久？")),s=K(z("kb-ask-ex3","哪些供应商需要人工复核？")),o=typeof window._kbFabEnabled=="function"&&window._kbFabEnabled();e.innerHTML=`
        <div class="kb-ft">
    ...
    `,e.dataset.kbBuilt="1";const i=e.querySelector("#kb-qa-thread"),r=e.querySelector("#kb-qa-input"),l=e.querySelector("#kb-qa-send");mr(i,r,l),e.querySelectorAll(".kb-chip").forEach(d=>{d.addEventListener("click",()=>{r.value=d.dataset.q||"",l.click()})});const m=e.querySelector("#kb-fab-switch");m?.addEventListener("click",()=>{const d=!m.classList.contains("on");m.classList.toggle("on",d),m.setAttribute("aria-checked",String(d)),typeof window._kbFabSetEnabled=="function"&&window._kbFabSetEnabled(d)})}window._kbRenderAsk=Vp;const Ws="pearnly_kb_fab",is=kt,mt=14;let rs=!1,Uo=!1;function Up(){if(document.getElementById("kb-fab-style"))return;const e=document.createElement("style");e.id="kb-fab-style",e.textContent=`
...
`,document.head.appendChild(e)}let Z,ht,Wn,Me;function Gp(){rs||(Up(),Z=document.createElement("div"),Z.className="kb-fab",Z.id="kb-fab",Z.innerHTML=`
        <span class="kb-say" id="kb-say">${z("kb-fab-hi","喵~")}</span>
        <button class="kb-fab-btn" id="kb-fab-btn" aria-label="${z("kb-fab-aria","问 AI")}"><img src="${is}" alt=""></button>`,document.body.appendChild(Z),Me=document.createElement("div"),Me.className="kb-card",Me.id="kb-card",Me.innerHTML=`
        <div class="kb-card-top">
            <div class="tt"><span class="mini"><img src="${is}" alt=""></span> ${z("kb-fab-title","客户知识助手")}</div>
        ...
        </div>`,document.body.appendChild(Me),ht=Z.querySelector("#kb-fab-btn"),Wn=Z.querySelector("#kb-say"),document.getElementById("kb-card-x")?.addEventListener("click",ls),document.addEventListener("keydown",e=>{e.key==="Escape"&&ls()}),eu(),Zp(),Qp(),rs=!0)}function Wp(){const e=document.getElementById("kb-card-thread"),n=document.getElementById("kb-card-input"),a=document.getElementById("kb-card-send");!Uo&&typeof window._kbWireAsk=="function"&&(e.innerHTML=`<div class="kb-msg ai"><div class="kb-ava"><img src="${is}" alt=""></div><div class="kb-bub">${z("kb-ask-empty","问点关于这家客户的事，答案都带出处；查不到时如实说「资料不足」。")}</div></div>`,window._kbWireAsk(e,n,a),Uo=!0);const s=document.getElementById("kb-card-ws");s&&(s.textContent=lr()||z("kb-fab-no-ws","未选账套")),Kp(),Me.classList.add("open"),Jp(),vr(["💛","✨","💙","🐾"])}function ls(){Me?.classList.remove("open")}function Kp(){const e=Z.getBoundingClientRect(),n=520,a=e.left+e.width/2<window.innerWidth/2,s=Math.min(Math.max(mt,e.top+e.height/2-n/2),window.innerHeight-n-mt);Me.style.top=s+"px",a?(Me.style.left=e.right+12+"px",Me.style.right="auto"):(Me.style.right=window.innerWidth-e.left+12+"px",Me.style.left="auto")}let Go;function Yp(e,n=1500){Wn.textContent=e,Wn.classList.add("show"),clearTimeout(Go),Go=setTimeout(()=>Wn.classList.remove("show"),n)}function Jp(){ht.classList.remove("jump"),ht.classList.add("cheer"),setTimeout(()=>ht.classList.remove("cheer"),650)}function Xp(){Z.classList.contains("lifted")||(ht.classList.remove("cheer"),ht.classList.add("jump"),setTimeout(()=>ht.classList.remove("jump"),720))}function vr(e){for(let n=0;n<5;n++){const a=document.createElement("span");a.className="kb-spark",a.textContent=e[n%e.length],a.style.setProperty("--dx",n*14-28+"px"),a.style.left=30+n*10+"%",a.style.animationDelay=n*40+"ms",Z.appendChild(a),setTimeout(()=>a.remove(),1100)}}function Zp(){const e=[z("kb-fab-hi","喵?"),z("kb-fab-ask","问我呀!"),"🐾"];ht.addEventListener("mouseenter",()=>{Z.classList.contains("lifted")||Yp(e[(Date.now()/1e3|0)%e.length],1400)}),setInterval(()=>{!Z.classList.contains("on")||Z.classList.contains("lifted")||Me.classList.contains("open")||(Date.now()/1e3|0)%2===0&&(Xp(),vr(["✨","🐾"]))},5400)}function Fa(e){return Math.min(Math.max(mt,e),window.innerHeight-Z.offsetHeight-mt)}function Qp(){Z.classList.add("snapping"),Z.style.left=window.innerWidth-56-mt+"px",Z.style.top="62%"}function eu(){let e,n=!1,a=!1,s=0,o=0,i=0,r=0;function l(c){s=c.clientX,o=c.clientY,a=!1,n=!1;const u=Z.getBoundingClientRect();i=u.left,r=u.top,Z.classList.remove("snapping"),e=setTimeout(()=>{Z.classList.add("lifted")},180),window.addEventListener("pointermove",m),window.addEventListener("pointerup",d),c.preventDefault()}function m(c){const u=c.clientX-s,v=c.clientY-o;!n&&Math.hypot(u,v)>6&&(n=!0,Z.classList.add("lifted"),clearTimeout(e)),n&&(a=!0,Z.style.left=i+u+"px",Z.style.top=Fa(r+v)+"px")}function d(){if(clearTimeout(e),window.removeEventListener("pointermove",m),window.removeEventListener("pointerup",d),Z.classList.remove("lifted"),!a){Wp();return}p()}function p(){const c=Z.getBoundingClientRect();Z.classList.add("snapping"),Z.style.top=Fa(c.top)+"px",Z.style.left=(c.left+c.width/2<window.innerWidth/2?mt:window.innerWidth-Z.offsetWidth-mt)+"px"}ht.addEventListener("pointerdown",l),window.addEventListener("resize",()=>{if(!rs)return;const c=Z.getBoundingClientRect();Z.style.top=Fa(c.top)+"px",Z.style.left=(c.left+c.width/2<window.innerWidth/2?mt:window.innerWidth-Z.offsetWidth-mt)+"px"})}function fr(e){Gp(),localStorage.setItem(Ws,e?"1":"0"),Z.classList.toggle("on",e),e||ls()}window._kbFabSetEnabled=fr;window._kbFabEnabled=()=>localStorage.getItem(Ws)==="1";async function Wo(){if(localStorage.getItem(Ws)==="1")try{await cr()&&fr(!0)}catch{}}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",Wo):Wo();let oa=null;function tu(){if(oa)return;const e=document.createElement("style");e.id="kb-info-style",e.textContent=`
...
`,document.head.appendChild(e),oa=rr("info")}function zn(e,n){return`<li><span class="ck">${Ke("check")}</span><span>${K(z(e,n))}</span></li>`}function za(e,n,a,s,o,i,r){return`<div class="row"><div class="pi">${e}</div>
        <div class="pm"><b>${K(z(n,a))}</b><div class="d">${K(z(s,o))}</div></div>
        <span class="amt">${K(z(i,r))}</span></div>`}function nu(){const e=oa?.modal;e&&(e.innerHTML=`
        ...
        <div class="kb-info-body">
            ...
            <ul class="kb-info-use">
                ${zn("kb-info-use1","把客户的合同、采购政策、内部规矩上传一次，AI 读懂后建成可检索的资料库 —— 不用再翻文件夹找合同。")}
                ${zn("kb-info-use2","做账时 AI 自动按这家客户的规矩检查发票：金额超上限、供应商要不要人工复核、差旅超标…… 异常当场标出来。")}
                ${zn("kb-info-use3","任意页面右下角随手问「这家客户能不能这样报」，答案都带合同原文出处，点一下就能核对，AI 不瞎编。")}
                ${zn("kb-info-use4","把老会计脑子里记的客户规矩，变成系统记住、新人也能直接上手 —— 给多家公司做账的事务所尤其值。")}
            </ul>
            ...
            <div class="kb-info-price">
                ${za(Ke("upload"),"kb-info-c1-n","上传建库","kb-info-c1-d","PDF / 图片按页、文档按字符 —— 跟现在 OCR 同价","kb-info-c1-amt","฿1.50/页起")}
                ${za(Ke("message"),"kb-info-c2-n","AI 问答","kb-info-c2-d","每次带合同原文出处的回答","kb-info-c2-amt","฿0.50/次")}
                ${za(Ke("shield-check"),"kb-info-c3-n","自动发票检查","kb-info-c3-d","死规则:算术 / 税号 / 查重 / 客户规矩","kb-info-c3-amt","免费")}
            </div>
    ...
    `)}function au(){tu(),nu(),oa?.open()}window._kbOpenInfo=au;const hr={tax_invoice:"sx-dt-tax_invoice",tax_invoice_receipt:"sx-dt-tax_invoice_receipt",tax_invoice_simple:"sx-dt-tax_invoice_simple",receipt:"sx-dt-receipt",quotation:"sx-dt-quotation",credit_note:"sx-dt-credit_note",debit_note:"sx-dt-debit_note"};function Ks(e){const n=e?hr[e]:null;return n?t(n):e||"—"}function qe(e){return Number(e||0).toLocaleString("en-US",{minimumFractionDigits:2,maximumFractionDigits:2})}function Ys(e){return e?e.slice(0,10):"—"}function Se(e){return escapeHtml(e==null?"":String(e))}function su(){const e={Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||"")};try{const n=window._wsHeader&&window._wsHeader();n&&Object.assign(e,n)}catch{}return e}function Je(e,n={}){return fetch(e,{...n,headers:{...su(),...n.headers||{}}})}async function In(e,n){try{const a=await Je(`/api/sales/documents/${e}/pdf?copy=original`);if(!a.ok){showToast(t("sx-pdf-fail"),"error");return}const s=URL.createObjectURL(await a.blob()),o=window.open(s,"_blank");n&&o&&o.addEventListener("load",()=>o.print()),setTimeout(()=>URL.revokeObjectURL(s),6e4)}catch{showToast(t("sx-pdf-fail"),"error")}}async function ia(e,n){if(n){if(!n.startsWith("/api/uploads/image/")){e.src=n;return}try{const a=await Je(n);if(!a.ok)return;const s=URL.createObjectURL(await a.blob());e.addEventListener("load",()=>URL.revokeObjectURL(s),{once:!0}),e.src=s}catch{}}}function _a(e){const n=String(e||"").trim();if(!n)return null;const a=n.startsWith("sales.")?n:"sales."+n,s=t(a);return s&&s!==a?s:null}function Sn(e,n){return _a(e)||t(n)}async function gr(e){const n=new FormData;n.append("file",e);try{const a=await Je("/api/uploads/image",{method:"POST",body:n}),s=await a.json().catch(()=>({}));return a.ok&&s.url?{url:String(s.url)}:{error:String(s.detail||"HTTP "+a.status)}}catch{return{error:"network"}}}const Cn='<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.9"><path d="M18 6 6 18M6 6l12 12"/></svg>',ou='<svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4M7 9l5-5 5 5M12 4v12"/></svg>';function gn(e,n,a){const s=a||"";return`<div class="sx-dropwrap">
        <div class="sx-drop${s?" has":""}" id="${e}-drop">
            ...
            <img id="${e}-prev" alt="" style="${s?"":"display:none"}">
            <span class="sx-drop-lbl" id="${e}-lbl" style="${s?"display:none":""}">${ou} ${escapeHtml(n)}</span>
    ...
    </div>`}function bn(e){const n=document.getElementById(e+"-file"),a=document.getElementById(e+"-drop"),s=document.getElementById(e+"-clr"),o=document.getElementById(e),i=document.getElementById(e+"-prev"),r=document.getElementById(e+"-lbl"),l=document.getElementById(e+"-err");if(!n||!a||!o)return;const m=d=>{o.value=d,i&&(i.style.display=d?"":"none",d?ia(i,d):i.removeAttribute("src")),r&&(r.style.display=d?"none":""),s&&(s.style.display=d?"":"none"),a.classList.toggle("has",!!d)};i&&o.value&&ia(i,o.value),a.onclick=d=>{d.target.closest(".sx-drop-clr")||n.click()},n.onchange=async()=>{const d=n.files&&n.files[0];if(!d)return;l&&(l.textContent="");const p=await gr(d);p.url?m(p.url):l&&(l.textContent=t(p.error||"")!==p.error?t(p.error||""):t("sx-upload-fail")),n.value=""},s&&(s.onclick=d=>{d.stopPropagation(),m("")})}const iu=Object.freeze(Object.defineProperty({__proto__:null,DOC_TYPE_KEY:hr,IC_X:Cn,bindImageField:bn,docTypeLabel:Ks,fmtDate:Ys,fmtMoney:qe,htmlVal:Se,imageFieldHtml:gn,loadAuthedImg:ia,openDocPdf:In,salesErrMsg:Sn,salesErrText:_a,salesFetch:Je,uploadImage:gr},Symbol.toStringTag,{value:"Module"})),xe={x:Cn,dl:'<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.9"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4M7 10l5 5 5-5M12 15V3"/></svg>',print:'<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.9"><path d="M6 9V2h12v7M6 18H4a2 2 0 0 1-2-2v-5a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2v5a2 2 0 0 1-2 2h-2M6 14h12v8H6z"/></svg>',send:'<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.9"><path d="m22 2-7 20-4-9-9-4Z"/></svg>',ban:'<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.9"><circle cx="12" cy="12" r="9"/><path d="m5 5 14 14"/></svg>',undo:'<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.9"><path d="M3 7v6h6M3 13a9 9 0 1 0 3-7.7L3 8"/></svg>',copy:'<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.9"><path d="M9 9h11v11H9zM5 15H4V4h11v1"/></svg>',edit:'<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.9"><path d="M11 4H4v16h16v-7M18.5 2.5a2.1 2.1 0 0 1 3 3L12 15l-4 1 1-4Z"/></svg>',qr:'<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.9"><rect x="3" y="3" width="7" height="7"/><rect x="14" y="3" width="7" height="7"/><rect x="3" y="14" width="7" height="7"/><path d="M14 14h3v3h-3zM21 14v7M17 21h4"/></svg>'};let cs={},Ko=null;function ze(){return document.getElementById("sales-detail-mask")}function fe(){return document.getElementById("sales-action-mask")}function st(){ze().style.display="none",ze().innerHTML=""}function Ee(){fe().style.display="none",fe().innerHTML=""}async function ru(){if(!Object.keys(cs).length)try{const e=await apiGet("/api/sales/sellers"),n=e&&(e.sellers||e.items||e)||[];if(Array.isArray(n))for(const a of n)cs[String(a.workspace_client_id??a.id)]=a}catch{}}function lu(e){const n=cs[String(e.seller_workspace_client_id??"")]||{},a=(e.lines||[]).map((s,o)=>`<tr><td>${o+1}</td><td>${escapeHtml(String(s.description||"—"))}</td><td style="text-align:right">${qe(s.amount??Number(s.qty||0)*Number(s.unit_price||0))}</td></tr>`).join("");return`<div class="sx-inv">
        <div class="sx-cb">ต้นฉบับ</div>
        <h4>${escapeHtml(n.name||t("sx-seller"))}</h4>
        <div class="sx-no">${escapeHtml(Ks(e.doc_type))} · ${escapeHtml(e.doc_number||t("sx-draft-tag"))} · ${escapeHtml(Ys(e.issue_date))}</div>
        <div class="sx-pp">
        ...
        <div class="sx-tot">
            <div class="sx-tr"><span>${escapeHtml(t("sx-subtotal"))}</span><span>${qe(e.subtotal)}</span></div>
            <div class="sx-tr"><span>VAT ${qe(e.vat_rate)}%</span><span>${qe(e.vat_amount)}</span></div>
            ${Number(e.wht_amount||0)?`<div class="sx-tr"><span>WHT</span><span>-${qe(e.wht_amount)}</span></div>`:""}
            <div class="sx-tr g"><span>${escapeHtml(t("sx-grand"))}</span><span>฿ ${qe(e.grand_total)}</span></div>
        </div>
    </div>`}function cu(e){const n=e.doc_type==="quotation",a=e.status==="issued"&&(e.payment?.status||"unpaid")!=="paid";let s,o;e.status==="void"?(s=`<span style="color:var(--ink-3)">${escapeHtml(t("sx-voided-note"))}</span>`,o=""):e.status==="draft"?(s=`<button class="btn btn-primary btn-sm" data-act="edit">${xe.edit}<span>${escapeHtml(t("sx-edit-draft"))}</span></button>
           <button class="btn btn-ghost btn-sm" data-act="download">${xe.dl}<span>${escapeHtml(t("sx-download"))}</span></button>`,o=`<button class="btn btn-danger btn-sm" data-act="delete">${xe.ban}<span>${escapeHtml(t("sx-del-draft"))}</span></button>`):(s=`<button class="btn btn-ghost btn-sm" data-act="download">${xe.dl}<span>${escapeHtml(t("sx-download"))}</span></button>
           <button class="btn btn-ghost btn-sm" data-act="print">${xe.print}<span>${escapeHtml(t("sx-print"))}</span></button>
           <button class="btn btn-ghost btn-sm" data-act="send">${xe.send}<span>${escapeHtml(t("sx-send-to"))}</span></button>
           ${a?`<button class="btn btn-accent btn-sm" data-act="promptpay">${xe.qr}<span>${escapeHtml(t("sx-promptpay"))}</span></button>`:""}
           <button class="btn btn-ghost btn-sm" data-act="copy">${xe.copy}<span>${escapeHtml(t("sx-copy"))}</span></button>`,o=`${n?`<button class="btn btn-ghost btn-sm" data-act="convert">${escapeHtml(t("sx-convert"))}</button>`:""}
           <button class="btn btn-ghost btn-sm" data-act="credit">${xe.undo}<span>${escapeHtml(t("sx-credit"))}</span></button>
           <button class="btn btn-ghost btn-sm" data-act="debit"><span>${escapeHtml(t("sx-debit"))}</span></button>
           <button class="btn btn-danger btn-sm" data-act="void">${xe.ban}<span>${escapeHtml(t("sx-void"))}</span></button>`),ze().innerHTML=`<div class="modal" role="dialog" style="max-width:640px">
        <div class="modal-header">
            ...
            <button class="modal-close" id="sx-detail-close">${xe.x}</button>
        </div>
        <div class="modal-body">
            <div class="sx-detail-acts">${s}</div>
            ${lu(e)}
            <div class="sx-banner">${escapeHtml(t("sx-archived"))}${e.pdf_sha256?" · sha256 ✓":""}</div>
        </div>
        <div class="modal-footer" style="justify-content:space-between">
            <div style="display:flex;gap:7px;flex-wrap:wrap">${o}</div>
            <button class="btn btn-ghost" id="sx-detail-close2">${escapeHtml(t("sx-close"))}</button>
        </div>
    </div>`,ze().style.display="flex",du(e)}function du(e){document.getElementById("sx-detail-close").onclick=st,document.getElementById("sx-detail-close2").onclick=st,ze().onclick=n=>{n.target===ze()&&st()},ze().querySelectorAll("[data-soft]").forEach(n=>n.onclick=()=>showToast(t(n.dataset.soft),"info")),ze().querySelectorAll("[data-act]").forEach(n=>n.onclick=()=>yu(n.dataset.act,e))}async function pu(e){try{const n=await Je(`/api/sales/documents/${e.id}/promptpay-qr`);if(!n.ok){const o=await n.json().catch(()=>({})),i=String(o.detail||"").replace("sales.","");showToast(t("sx-pp-"+i)||t("sx-pp-fail"),"error");return}const a=URL.createObjectURL(await n.blob()),s=Number(e.grand_total||0)-Number(e.payment?.paid_amount||0);fe().innerHTML=`<div class="modal" role="dialog" style="max-width:380px">
            <div class="modal-header"><div class="modal-title">${escapeHtml(t("sx-promptpay"))} · PromptPay</div>
                <button class="modal-close" id="sx-pp-close">${xe.x}</button></div>
            <div class="modal-body" style="text-align:center">
                <div class="sx-qr"><img src="${a}" alt="PromptPay QR"></div>
                <div style="font-weight:700;font-size:16px">฿ ${qe(s)}</div>
                <div style="color:var(--ink-3);font-size:12px;margin-top:4px">${escapeHtml(t("sx-pp-scan"))}</div>
            </div></div>`,fe().style.display="flex",document.getElementById("sx-pp-close").onclick=Ee,fe().onclick=o=>{o.target===fe()&&Ee()},setTimeout(()=>URL.revokeObjectURL(a),12e4)}catch{showToast(t("sx-pp-fail"),"error")}}function Yo(e,n){const a=n==="credit_note"?t("sx-credit-title"):t("sx-debit-title");fe().innerHTML=`<div class="modal" role="dialog" style="max-width:460px">
        <div class="modal-header"><div class="modal-title">${escapeHtml(a)}</div>
            <button class="modal-close" id="sx-note-close">${xe.x}</button></div>
        <div class="modal-body">
        ...
        </div></div>`,fe().style.display="flex",document.getElementById("sx-note-close").onclick=Ee,document.getElementById("sx-note-cancel").onclick=Ee,fe().onclick=s=>{s.target===fe()&&Ee()},document.getElementById("sx-note-ok").onclick=async()=>{const s=document.getElementById("sx-note-reason").value.trim(),o=Number(document.getElementById("sx-note-amount").value);if(!(o>0)){showToast(t("sx-note-amount-required"),"error");return}await Ea(`/api/sales/documents/${e.id}/${n==="credit_note"?"credit-note":"debit-note"}`,{reason:s||a,vat_rate:Number(e.vat_rate||7),wht_rate:0,lines:[{description:s||a,qty:1,unit_price:o,vat_applicable:!0}]})&&(Ee(),st(),showToast(t("sx-done"),"success"),window.dispatchEvent(new CustomEvent("pearnly:sales-changed")))}}function uu(e){fe().innerHTML=`<div class="modal" role="dialog" style="max-width:440px">
        <div class="modal-header"><div class="modal-title">${escapeHtml(t("sx-void-title"))}</div>
            <button class="modal-close" id="sx-void-close">${xe.x}</button></div>
        ...
        </div></div>`,fe().style.display="flex",document.getElementById("sx-void-close").onclick=Ee,document.getElementById("sx-void-cancel").onclick=Ee,fe().onclick=n=>{n.target===fe()&&Ee()},document.getElementById("sx-void-ok").onclick=async()=>{await Ea(`/api/sales/documents/${e.id}/void`,{})&&(Ee(),st(),showToast(t("sx-done"),"success"),window.dispatchEvent(new CustomEvent("pearnly:sales-changed")))}}async function mu(e){await Ea(`/api/sales/documents/${e.id}/convert`,{target_doc_type:"tax_invoice"})&&(st(),showToast(t("sx-converted"),"success"),window.dispatchEvent(new CustomEvent("pearnly:sales-changed")))}async function Ea(e,n){try{const a=await apiPost(e,n);if(a&&a.ok)return!0;const s=a?await a.json().catch(()=>({})):{};return showToast(Sn(s.detail,"sx-action-fail"),"error"),!1}catch{return showToast(t("sx-action-fail"),"error"),!1}}let cn="email";function vu(e,n,a){return`<div class="sx-seg" style="width:100%">${e.map(s=>`<button type="button" data-${a}="${s[0]}" class="${n===s[0]?"on":""}" style="flex:1">${escapeHtml(s[1])}</button>`).join("")}</div>`}function br(e){const n=cn==="email"?`<div class="sx-banner" style="margin-top:4px">${escapeHtml(t("sx-send-email-hint"))}</div>
        ...
        <div class="modal-header"><div class="modal-title">${escapeHtml(t("sx-send-to-title"))}</div>
            <button class="modal-close" id="sx-send-close">${xe.x}</button></div>
        <div class="modal-body">
            <div class="form-row"><label>${escapeHtml(t("sx-send-how"))}</label>
                ${vu([["email",t("sx-send-opt-email")],["line",t("sx-send-opt-line")]],cn,"ch")}</div>
            ${n}
        </div>
        <div class="modal-footer" style="justify-content:space-between;gap:8px">
        ...
        </div></div>`,fe().style.display="flex",document.getElementById("sx-send-close").onclick=Ee,document.getElementById("sx-send-cancel").onclick=Ee,fe().onclick=a=>{a.target===fe()&&Ee()},fe().querySelectorAll("[data-ch]").forEach(a=>a.onclick=()=>(cn=a.dataset.ch,br(e))),document.getElementById("sx-send-do").onclick=()=>fu(e)}async function fu(e){if(cn==="email"){const o=document.getElementById("sx-send-email").value.trim();if(!o)return showToast(t("sx-send-email-required"),"error");const i=await apiPost(`/api/sales/documents/${e.id}/send`,{channel:"email",to:o});i&&i.ok?(Ee(),showToast(t("sx-send-email-ok"),"success")):showToast(t("sx-send-fail"),"error");return}const n=await apiPost(`/api/sales/documents/${e.id}/send`,{channel:"line"}),a=n?await n.json().catch(()=>({})):{};if(!n||!n.ok||!a.share_url)return showToast(t("sx-send-fail"),"error");const s=String(a.share_url);fe().innerHTML=`<div class="modal" role="dialog" style="max-width:480px">
        <div class="modal-header"><div class="modal-title">${escapeHtml(t("sx-send-line-title"))}</div>
            <button class="modal-close" id="sx-link-close">${xe.x}</button></div>
        <div class="modal-body">
        ...
        <div class="modal-footer" style="justify-content:space-between;gap:8px">
            ...
            <button class="btn btn-primary" id="sx-link-copy">${escapeHtml(t("sx-send-copy"))}</button>
        </div></div>`,document.getElementById("sx-link-close").onclick=Ee,document.getElementById("sx-link-done").onclick=Ee,document.getElementById("sx-link-copy").onclick=()=>{document.getElementById("sx-link-url").select(),navigator.clipboard?.writeText(s).catch(()=>{}),showToast(t("sx-send-copied"),"success")}}async function hu(e){const n=e,a=(e.lines||[]).map(i=>{const r=i;return{description:(r.description||"").trim(),qty:Number(r.qty||0),unit_price:Number(r.unit_price||0),discount:Number(r.discount||0),vat_applicable:r.vat_applicable!==!1}}).filter(i=>i.description);if(!a.length)return showToast(t("sx-action-fail"),"error");const s={doc_type:e.doc_type,client_id:n.client_id,seller_workspace_client_id:n.seller_workspace_client_id,currency:n.currency||"THB",vat_rate:Number(e.vat_rate||0),wht_rate:Number(e.wht_rate||0),header_discount_amount:Number(n.header_discount_amount||0),header_discount_pct:Number(n.header_discount_pct||0),price_includes_vat:!!e.price_includes_vat,lines:a,buyer:e.buyer&&e.buyer.type?{...e.buyer}:null,payment:null};await Ea("/api/sales/documents",s)&&(st(),showToast(t("sx-copied"),"success"),window.dispatchEvent(new CustomEvent("pearnly:sales-changed")))}function gu(e){st(),window.editSalesDraft&&window.editSalesDraft(e)}async function bu(e){if(window.pearnlyConfirm?await window.pearnlyConfirm(t("sx-del-draft-confirm")):confirm(t("sx-del-draft-confirm")))try{const a=await Je(`/api/sales/documents/${e.id}`,{method:"DELETE"});if(!a.ok){const s=await a.json().catch(()=>({}));showToast(Sn(s.detail,"sx-action-fail"),"error");return}st(),showToast(t("sx-draft-deleted"),"success"),window.dispatchEvent(new CustomEvent("pearnly:sales-changed"))}catch{showToast(t("sx-action-fail"),"error")}}function yu(e,n){if(e==="edit")return gu(n);if(e==="delete")return void bu(n);if(e==="download")return void In(n.id,!1);if(e==="print")return void In(n.id,!0);if(e==="send")return br(n);if(e==="promptpay")return void pu(n);if(e==="copy")return void hu(n);if(e==="credit")return Yo(n,"credit_note");if(e==="debit")return Yo(n,"debit_note");if(e==="void")return uu(n);if(e==="convert")return void mu(n)}window.openSalesDetail=async function(e){ze().innerHTML=`<div class="modal" role="dialog" style="max-width:640px"><div class="modal-body"><div class="sx-state">${escapeHtml(t("sx-loading"))}</div></div></div>`,ze().style.display="flex",await ru();try{const n=await apiGet(`/api/sales/documents/${e}`);if(!n)return;Ko=n.document,cu(Ko)}catch{ze().innerHTML=`<div class="modal" role="dialog" style="max-width:480px"><div class="modal-body"><div class="sx-state error">${escapeHtml(t("sx-error"))}</div></div></div>`;const a=ze();a.onclick=s=>{s.target===a&&st()}}};const wu='<svg width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.4"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8Z"/><path d="M14 2v6h6M8 13h8M8 17h5"/></svg>',ku='<svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.9"><circle cx="12" cy="12" r="3"/><path d="M19.4 13a7 7 0 0 0 0-2l2-1.5-2-3.5-2.3 1a7 7 0 0 0-1.7-1L15 3H9l-.4 2.5a7 7 0 0 0-1.7 1l-2.3-1-2 3.5L4.6 11a7 7 0 0 0 0 2l-2 1.5 2 3.5 2.3-1a7 7 0 0 0 1.7 1L9 21h6l.4-2.5a7 7 0 0 0 1.7-1l2.3 1 2-3.5-2-1.5Z"/></svg>',xu='<svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="#fff" stroke-width="2.2"><path d="M12 5v14M5 12h14"/></svg>',_u='<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.9"><path d="m9 18 6-6-6-6"/></svg>',Eu=["paid","unpaid","partial"];let ra=[],Ia=[],Bn="all",Ba="",Jo;function yr(e){const n=e.payment&&e.payment.status||"";return Eu.indexOf(n)>=0?n:"unpaid"}function Iu(e){return e.buyer&&e.buyer.name||"—"}function Bu(e){if(!e)return!1;const n=new Date,a=n.getFullYear()+"-"+String(n.getMonth()+1).padStart(2,"0");return e.slice(0,7)===a}function Lu(){const e=ra.filter(i=>i.status==="issued"),n=e.filter(i=>Bu(i.issue_date)),a=n.reduce((i,r)=>i+Number(r.grand_total||0),0),s=ra.filter(i=>i.status==="draft").length,o=e.filter(i=>yr(i)!=="paid").reduce((i,r)=>i+(Number(r.grand_total||0)-Number(r.payment.paid_amount||0)),0);return{count:n.length,amount:a,drafts:s,due:o}}function wr(){const e=Ia;return e.length?e.map(n=>{const a=yr(n),s=n.doc_number||t("sx-draft-tag");return`<tr class="click" data-doc="${escapeHtml(n.id)}">
                <td><b>${escapeHtml(s)}</b></td>
                <td style="color:var(--ink-3)">${escapeHtml(Ys(n.issue_date))}</td>
                <td>${escapeHtml(Ks(n.doc_type))}</td>
                <td>${escapeHtml(Iu(n))}</td>
                <td class="r">${qe(n.grand_total)}</td>
                ...
                <td class="r"><button class="sx-chev" data-doc="${escapeHtml(n.id)}" aria-label="${escapeHtml(t("sx-detail-title"))}">${_u}</button></td>
            </tr>`}).join(""):`<tr><td colspan="8"><div class="sx-state">${wu}<div>${escapeHtml(t("sx-empty"))}</div></div></td></tr>`}function kr(){const e=Lu(),n=["all","draft","issued","void"].map(a=>`<button data-flt="${a}" class="${Bn===a?"on":""}">${escapeHtml(t("sx-f-"+a))}</button>`).join("");return`<div class="sx-cards">
        ...
        <div class="sx-stat"><div class="sx-l">${escapeHtml(t("sx-card-amount"))}</div><div class="sx-v">฿ ${qe(e.amount)}</div></div>
        <div class="sx-stat"><div class="sx-l">${escapeHtml(t("sx-card-draft"))}</div><div class="sx-v">${e.drafts}</div></div>
        <div class="sx-stat"><div class="sx-l">${escapeHtml(t("sx-card-due"))}</div><div class="sx-v warn">฿ ${qe(e.due)}</div></div>
    </div>
    <div class="sx-toolbar">
        <div class="sx-seg">${n}</div>
        <div class="sx-search"><input type="text" id="sx-wb-search" value="${escapeHtml(Ba)}" placeholder="${escapeHtml(t("sx-search-ph"))}"></div>
    </div>
    <div class="sx-panel"><table class="sx-tbl">
        ...
        <tbody id="sx-wb-tbody">${wr()}</tbody>
    </table></div>`}function $u(){return`<div class="sx-page">
        <div class="sx-head">
            <h2 data-i18n="sx-wb-title">${escapeHtml(t("sx-wb-title"))}</h2>
            
            <div class="sx-actions">
                <button class="btn btn-ghost" id="sx-settings-btn">${ku}<span>${escapeHtml(t("sx-settings"))}</span></button>
                <button class="btn btn-primary" id="sx-new-btn">${xu}<span>${escapeHtml(t("sx-new"))}</span></button>
            </div>
        </div>
        <div id="sx-wb-body"></div>
    </div>`}function Kn(e){const n=document.getElementById("sx-wb-body");n&&(n.innerHTML=e)}function Su(){const e=document.getElementById("sx-wb-tbody");e&&(e.innerHTML=wr()),xr()}function xr(){document.querySelectorAll("#sx-wb-body [data-doc]").forEach(e=>{e.onclick=n=>{n.stopPropagation(),window.openSalesDetail&&window.openSalesDetail(e.dataset.doc)}})}function _r(){document.querySelectorAll("#sx-wb-body [data-flt]").forEach(n=>{n.onclick=async()=>{Bn=n.dataset.flt;try{Ia=await Js()}catch{return}Kn(kr()),_r()}});const e=document.getElementById("sx-wb-search");e&&(e.oninput=()=>{Ba=e.value,clearTimeout(Jo),Jo=window.setTimeout(Cu,250)}),xr()}async function Js(){const e=new URLSearchParams;Bn!=="all"&&e.set("status",Bn);const n=Ba.trim();n&&e.set("q",n);const a=e.toString(),s=await apiGet("/api/sales/documents"+(a?"?"+a:""));return s&&s.documents||[]}async function Cu(){try{Ia=await Js()}catch{return}Su()}function Tu(){const e=document.getElementById("sx-new-btn");e&&(e.onclick=()=>window.openSalesWizard?.());const n=document.getElementById("sx-settings-btn");n&&(n.onclick=()=>window.openSalesSettings?.())}async function Xs(){Kn(`<div class="sx-state">${escapeHtml(t("sx-loading"))}</div>`);try{const e=await apiGet("/api/sales/documents");if(!e)return;ra=e.documents||[],Ia=Bn!=="all"||Ba.trim()?await Js():ra,Kn(kr()),_r()}catch{Kn(`<div class="sx-state error">${escapeHtml(t("sx-error"))}<br><button class="btn btn-ghost" id="sx-retry">${escapeHtml(t("sx-retry"))}</button></div>`);const n=document.getElementById("sx-retry");n&&(n.onclick=()=>Xs())}}window.loadSalesWorkbench=function(){const e=document.getElementById("page-sales-invoices");e&&(e.dataset.sxInit!=="1"&&(e.innerHTML=$u(),e.dataset.sxInit="1",Tu()),Xs())};window.addEventListener("pearnly:sales-changed",()=>{typeof currentRoute<"u"&&currentRoute==="sales-invoices"&&Xs()});(function(){const n=document.querySelector(".nav-sales-head"),a=document.querySelector(".nav-sub2");if(!n||!a)return;const s=i=>{a.classList.toggle("show",i),n.classList.toggle("sx-open",i)},o=(location.hash||"").replace(/^#\//,"");(o==="sales-invoices"||o==="sales-account")&&s(!0),n.addEventListener("click",()=>s(!a.classList.contains("show")))})();const Hu='<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6"><path d="M21 8 12 3 3 8l9 5 9-5ZM3 8v8l9 5 9-5V8"/></svg>',Mu='<svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8"><path d="M11 4H4v16h16v-7M18.5 2.5a2.1 2.1 0 0 1 3 3L12 15l-4 1 1-4Z"/></svg>',Au='<svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8"><path d="M3 6h18M8 6V4h8v2M6 6l1 14h10l1-14"/></svg>';let La=[],Zs="",Xo;function Er(e){let n=document.getElementById(e);return n||(n=document.createElement("div"),n.id=e,n.className="modal-mask sx-modal-mask",n.style.display="none",document.body.appendChild(n)),n}function Mt(e){const n=document.getElementById(e);n&&(n.style.display="none",n.innerHTML="")}function Ir(){const e=La;return e.length?e.map(n=>{const a=n.name_th||n.name_en||n.name_zh||"—";return`<tr>
                <td>${n.image_url?`<img data-aimg="${escapeHtml(n.image_url)}" alt="" style="width:34px;height:34px;border-radius:7px;object-fit:cover">`:`<div class="sx-thumb">${Hu}</div>`}</td>
                <td style="color:var(--ink-3)">${escapeHtml(n.code||"—")}</td>
                <td><b>${escapeHtml(a)}</b></td>
                <td>${escapeHtml(n.unit||"—")}</td>
                <td class="r">${qe(n.unit_price)}</td>
                <td>${n.vat_applicable?'<span class="sx-badge issued">7%</span>':'<span class="sx-badge draft">—</span>'}</td>
                <td class="r"><button class="sx-chev" data-edit="${escapeHtml(n.id)}">${Mu}</button><button class="sx-chev" data-del="${escapeHtml(n.id)}">${Au}</button></td>
            </tr>`}).join(""):`<tr><td colspan="7"><div class="sx-state">${escapeHtml(t("sx-empty"))}</div></td></tr>`}function Pu(){return`<div class="sx-toolbar">
        <div class="sx-search"><input type="text" id="sx-p-search" value="${escapeHtml(Zs)}" placeholder="${escapeHtml(t("sx-p-search-ph"))}"></div>
    ...
    <div class="sx-panel"><table class="sx-tbl">
        ...
        <tbody id="sx-p-tbody">${Ir()}</tbody>
    </table></div>`}function Na(e){const n=document.getElementById("sx-p-body");n&&(n.innerHTML=e)}function ju(){const e=document.getElementById("sx-p-search");e&&(e.oninput=()=>{Zs=e.value,clearTimeout(Xo),Xo=window.setTimeout(Ou,250)}),document.getElementById("sx-p-add").onclick=()=>Lr(null),document.getElementById("sx-p-import").onclick=zu,Br()}function Br(){document.querySelectorAll("#sx-p-body [data-aimg]").forEach(e=>{ia(e,e.dataset.aimg||"")}),document.querySelectorAll("#sx-p-body [data-edit]").forEach(e=>{e.onclick=()=>Lr(La.find(n=>n.id===e.dataset.edit)||null)}),document.querySelectorAll("#sx-p-body [data-del]").forEach(e=>{e.onclick=()=>Fu(e.dataset.del)})}function Lr(e){const n=Er("sales-prod-mask");n.innerHTML=`<div class="modal" role="dialog" style="max-width:560px">
        <div class="modal-header"><div class="modal-title">${escapeHtml(t(e?"sx-p-edit":"sx-p-new"))}</div>
            <button class="modal-close" id="sx-p-close">${Cn}</button></div>
        <div class="modal-body">
            <div class="form-row form-row-2col">
                <div><label>${escapeHtml(t("sx-p-f-code"))}</label><input type="text" id="sx-pf-code" value="${Se(e?.code)}" maxlength="100"><div class="sx-field-err" id="sx-pf-code-err"></div></div>
                <div><label>${escapeHtml(t("sx-p-f-barcode"))}</label><input type="text" id="sx-pf-barcode" value="${Se(e?.barcode)}" maxlength="100"></div>
            </div>
            <div class="form-row"><label>${escapeHtml(t("sx-p-f-name-th"))} *</label><input type="text" id="sx-pf-th" value="${Se(e?.name_th)}" maxlength="300"></div>
            <div class="form-row form-row-2col">
                <div><label>${escapeHtml(t("sx-p-f-name-en"))}</label><input type="text" id="sx-pf-en" value="${Se(e?.name_en)}" maxlength="300"></div>
                <div><label>${escapeHtml(t("sx-p-f-name-zh"))}</label><input type="text" id="sx-pf-zh" value="${Se(e?.name_zh)}" maxlength="300"></div>
            </div>
            <div class="form-row form-row-2col">
                <div><label>${escapeHtml(t("sx-p-f-unit"))}</label><input type="text" id="sx-pf-unit" value="${Se(e?.unit)}" maxlength="50"></div>
        ...
        </div></div>`,n.style.display="flex",document.getElementById("sx-p-close").onclick=()=>Mt("sales-prod-mask"),document.getElementById("sx-p-cancel").onclick=()=>Mt("sales-prod-mask"),n.onclick=a=>{a.target===n&&Mt("sales-prod-mask")},document.getElementById("sx-p-save").onclick=()=>Ru(e),bn("sx-pf-image")}function Du(){const e=n=>document.getElementById(n).value.trim();return{name_th:e("sx-pf-th"),code:e("sx-pf-code")||null,barcode:e("sx-pf-barcode")||null,name_en:e("sx-pf-en")||null,name_zh:e("sx-pf-zh")||null,unit:e("sx-pf-unit")||null,unit_price:Number(e("sx-pf-price"))||0,vat_applicable:document.getElementById("sx-pf-vat").checked,image_url:e("sx-pf-image")||null}}async function qu(e,n){const a=await e.json().catch(()=>({}));return Sn(a&&a.detail,n)}function Zo(e){const n=document.getElementById("sx-pf-code-err");n&&(n.textContent=e)}async function Ru(e){const n=Du();if(Zo(""),!n.name_th)return showToast(t("sx-p-name-required"),"error");const a=e?`/api/sales/products/${e.id}`:"/api/sales/products";try{const s=await Je(a,{method:e?"PATCH":"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(n)});if(!s.ok){const o=await s.json().catch(()=>({})),i=o&&o.detail?String(o.detail):"HTTP "+s.status;if(i==="sales.product_code_exists"){Zo(t("sales.product_code_exists")),document.getElementById("sx-pf-code")?.focus();return}showToast(Sn(i,"sx-p-save-fail"),"error");return}Mt("sales-prod-mask"),showToast(t("sx-p-saved"),"success"),await Tn()}catch{showToast(t("sx-p-save-fail"),"error")}}async function Fu(e){if(window.pearnlyConfirm){if(!await window.pearnlyConfirm(t("sx-p-del-confirm")))return}else if(!confirm(t("sx-p-del-confirm")))return;try{const n=await Je(`/api/sales/products/${e}`,{method:"DELETE"});if(!n.ok){showToast(await qu(n,"sx-p-del-fail"),"error");return}showToast(t("sx-p-deleted"),"success"),await Tn()}catch{showToast(t("sx-p-del-fail"),"error")}}function zu(){const e=Er("sales-prod-mask");e.innerHTML=`<div class="modal" role="dialog" style="max-width:480px">
        <div class="modal-header"><div class="modal-title">${escapeHtml(t("sx-p-import-title"))}</div>
            <button class="modal-close" id="sx-imp-close">${Cn}</button></div>
        <div class="modal-body">
        ...
        </div></div>`,e.style.display="flex",document.getElementById("sx-imp-close").onclick=()=>Mt("sales-prod-mask"),document.getElementById("sx-imp-cancel").onclick=()=>Mt("sales-prod-mask"),document.getElementById("sx-imp-go").onclick=Nu}async function Nu(){const e=document.getElementById("sx-imp-file").files?.[0];if(!e)return showToast(t("sx-p-import-pick"),"error");const n=new FormData;n.append("file",e);try{const a=await Je("/api/sales/products/import",{method:"POST",body:n}),s=await a.json().catch(()=>({}));if(!a.ok)throw new Error;Mt("sales-prod-mask"),showToast(t("sx-p-import-done").replace("{n}",String(s.created??s.imported??0)),"success"),await Tn()}catch{showToast(t("sx-p-import-fail"),"error")}}async function $r(){const e=Zs.trim(),n="/api/sales/products"+(e?"?q="+encodeURIComponent(e):""),a=await apiGet(n);return a&&a.products||[]}async function Ou(){try{La=await $r()}catch{return}const e=document.getElementById("sx-p-tbody");e&&(e.innerHTML=Ir()),Br()}async function Tn(){Na(`<div class="sx-state">${escapeHtml(t("sx-loading"))}</div>`);try{La=await $r(),Na(Pu()),ju()}catch{Na(`<div class="sx-state error">${escapeHtml(t("sx-error"))}<br><button class="btn btn-ghost" id="sx-p-retry">${escapeHtml(t("sx-retry"))}</button></div>`);const n=document.getElementById("sx-p-retry");n&&(n.onclick=()=>Tn())}}window.loadSalesProducts=function(){const e=document.getElementById("page-sales-products");e&&(e.dataset.sxInit!=="1"&&(e.innerHTML=`<div class="sx-page"><div class="sx-head"><h2>${escapeHtml(t("nav-sales-products"))}</h2></div><div id="sx-p-body"></div></div>`,e.dataset.sxInit="1"),Tn())};const Vu=["classic","clean","brand","compact","official","mono"],Uu=["#2563eb","#0f766e","#b45309","#7c3aed","#be123c","#111827"];let Qs=[],$a=0,Ge="classic",Pt="#2563eb";function Hn(){return Qs[$a]}function Gu(){const e=Hn();if(!e)return`<div class="sx-state">${escapeHtml(t("sx-acc-none"))}</div>`;const n=Qs.map((o,i)=>`<option value="${i}" ${i===$a?"selected":""}>${escapeHtml(o.name||"—")}</option>`).join(""),a=Vu.map(o=>{const i=o==="brand"||o==="official"?Pt:"#111827",r=o==="brand"?`<div class="sx-tpl-bar" style="background:${i}"></div>`:"";return`<div class="sx-tpl ${Ge===o?"on":""}" data-tpl="${o}"><div class="sx-tpl-pv">${r}<div class="sx-tpl-co" style="color:${i};${o==="official"?"text-align:center;":""}">บริษัท ตัวอย่าง</div><div class="sx-tpl-ln">รายการ … 1,000</div><div class="sx-tpl-tt">รวม 1,070</div></div><div class="sx-tpl-nm">${escapeHtml(t("sx-acc-tpl-"+o))}</div></div>`}).join(""),s=Uu.map(o=>`<span class="sx-sw ${Pt===o?"on":""}" data-color="${o}" style="background:${o}"></span>`).join("");return`<div class="sx-acc-2col">
      <div class="sx-acc-form">
        ...
        <div class="sx-acc-grid">
            <div class="sx-field"><label>${escapeHtml(t("sx-acc-name"))}</label><input type="text" id="sx-a-name" value="${Se(e.name)}" maxlength="200"></div>
            <div class="sx-field"><label>${escapeHtml(t("sx-acc-tax"))}</label><input type="text" id="sx-a-tax" value="${Se(e.tax_id)}" maxlength="20"></div>
        </div>
        <div class="sx-field"><label>${escapeHtml(t("sx-acc-address"))}</label><input type="text" id="sx-a-addr" value="${Se(e.address)}" maxlength="500"></div>
        <div class="sx-acc-grid">
            <div class="sx-field"><label>${escapeHtml(t("sx-acc-branch"))}</label><input type="text" id="sx-a-branch" value="${Se(e.branch)}" maxlength="120"></div>
            <div class="sx-field"><label>${escapeHtml(t("sx-acc-phone"))}</label><input type="text" id="sx-a-phone" value="${Se(e.phone)}" maxlength="50"></div>
        </div>
        <div class="sx-field"><label>${escapeHtml(t("sx-acc-promptpay"))}</label><input type="text" id="sx-a-pp" value="${Se(e.promptpay_id)}" maxlength="40" placeholder="08x-xxx-xxxx / ${escapeHtml(t("sx-acc-tax"))}"></div>
        ...
        <div class="sx-field"><label>${escapeHtml(t("sx-acc-footer"))}</label><textarea id="sx-a-footer" rows="2" maxlength="500">${Se(e.footer_text)}</textarea></div>
      ...
      <div class="sx-acc-preview-col">
        ...
        <div id="sx-acc-prev">${Sr()}</div>
      </div>
    </div>`}function Sr(){const e=Hn();if(!e)return"";const n=Ge==="brand"||Ge==="official"?Pt:"#111827",a=Ge==="brand"?`<div style="height:7px;background:${n};margin:-18px -18px 12px;border-radius:8px 8px 0 0"></div>`:"";return`<div class="sx-prev-inv sx-prev-${Ge}" style="${Ge==="brand"?"border-color:"+n+"55":""}">
        ${a}
    ...
    </div>`}function Oa(){const e=document.getElementById("sx-acc-prev");e&&(e.innerHTML=Sr())}function Wu(){const e=document.getElementById("sx-acc-body");e&&(e.innerHTML=Gu(),Ku())}function Cr(e){$a=e;const n=Hn();Ge=n&&n.template_id||"classic",Pt=n&&n.brand_color||"#2563eb",Wu()}function Ku(){const e=document.getElementById("sx-acc-sel");e&&(e.onchange=()=>Cr(+e.value)),document.querySelectorAll("[data-tpl]").forEach(s=>{s.onclick=()=>{Ge=s.dataset.tpl,document.querySelectorAll("[data-tpl]").forEach(o=>o.classList.toggle("on",o.dataset.tpl===Ge)),Oa()}}),document.querySelectorAll("[data-color]").forEach(s=>{s.onclick=()=>{Pt=s.dataset.color,document.querySelectorAll("[data-color]").forEach(o=>o.classList.toggle("on",o.dataset.color===Pt)),Oa()}}),[["sx-a-name",s=>Nn().name=s],["sx-a-tax",s=>Nn().tax_id=s],["sx-a-branch",s=>Nn().branch=s],["sx-a-footer",s=>Nn().footer_text=s]].forEach(([s,o])=>{const i=document.getElementById(s);i&&(i.oninput=()=>{o(i.value),Oa()})}),bn("sx-a-logo"),bn("sx-a-seal"),bn("sx-a-sign");const a=document.getElementById("sx-a-save");a&&(a.onclick=Yu)}function Nn(){return Hn()}async function Yu(){const e=Hn();if(!e)return;const n=s=>document.getElementById(s).value.trim(),a={name:n("sx-a-name"),tax_id:n("sx-a-tax")||null,address:n("sx-a-addr")||null,branch:n("sx-a-branch")||null,phone:n("sx-a-phone")||null,promptpay_id:n("sx-a-pp")||null,logo_url:n("sx-a-logo")||null,seal_url:n("sx-a-seal")||null,signature_url:n("sx-a-sign")||null,footer_text:document.getElementById("sx-a-footer").value.trim()||null,template_id:Ge,brand_color:Pt};try{if(!(await Je(`/api/sales/sellers/${e.id}`,{method:"PUT",headers:{"Content-Type":"application/json"},body:JSON.stringify(a)})).ok)throw new Error;Object.assign(e,a),showToast(t("sx-acc-saved"),"success")}catch{showToast(t("sx-acc-save-fail"),"error")}}async function Tr(){const e=document.getElementById("sx-acc-body");e&&(e.innerHTML=`<div class="sx-state">${escapeHtml(t("sx-loading"))}</div>`);try{const n=await apiGet("/api/sales/sellers");if(!n)return;Qs=n.sellers||[],$a=0,Cr(0)}catch{e&&(e.innerHTML=`<div class="sx-state error">${escapeHtml(t("sx-error"))}<br><button class="btn btn-ghost" id="sx-acc-retry">${escapeHtml(t("sx-retry"))}</button></div>`);const a=document.getElementById("sx-acc-retry");a&&(a.onclick=()=>Tr())}}window.loadSalesAccount=function(){const e=document.getElementById("page-sales-account");e&&(e.dataset.sxInit!=="1"&&(e.innerHTML=`<div class="sx-page"><div class="sx-head"><h2>${escapeHtml(t("nav-sales-account"))}</h2></div><div id="sx-acc-body" style="max-width:1040px"></div></div>`,e.dataset.sxInit="1"),Tr())};const Qo=[["0","sx-wht-none"],["1","sx-wht-transport"],["2","sx-wht-ad"],["3","sx-wht-service"],["5","sx-wht-rent"]];let ve;function nt(){let e=document.getElementById("sales-settings-mask");return e||(e=document.createElement("div"),e.id="sales-settings-mask",e.className="modal-mask sx-modal-mask",e.style.display="none",document.body.appendChild(e)),e}function la(){const e=document.getElementById("sales-settings-mask");e&&(e.style.display="none",e.innerHTML="")}function on(e,n,a=!1){return`<div class="sx-seg" data-seg="${String(e)}"${a?' style="width:100%"':""}>${n.map(s=>`<button type="button" data-seg-v="${s[0]}" class="${String(ve[e])===s[0]?"on":""}"${a?' style="flex:1"':""}>${escapeHtml(s[1])}</button>`).join("")}</div>`}function Hr(){const e=ve.number_prefix||"INV",n=new Date().getFullYear();return`${escapeHtml(e)}${n}-00001`}function Ju(){const e=String(Number(ve.default_wht_rate)||0),n=Qo.some(s=>s[0]===e),a=Qo.map(([s,o])=>`<option value="${s}" ${e===s?"selected":""}>${s}% ${escapeHtml(t(o))}</option>`).join("")+`<option value="custom" ${n?"":"selected"}>${escapeHtml(t("sx-wht-custom"))}</option>`;nt().innerHTML=`<div class="modal" role="dialog" style="max-width:720px">
        <div class="modal-header"><div class="modal-title">${escapeHtml(t("sx-set-title"))}</div>
            <button class="modal-close" id="sx-set-close">${Cn}</button></div>
        <div class="modal-body">
            <div class="sx-set-card">
                ...
                <div class="sx-hint">${escapeHtml(t("sx-set-num-preview"))}: <b id="sx-set-preview">${Hr()}</b> · ${escapeHtml(t("sx-set-num-preview-note"))}</div>
            </div>
            <div class="sx-set-card">
        ...
        </div></div>`,nt().style.display="flex",Xu()}function Xu(){document.getElementById("sx-set-close").onclick=la,nt().onclick=o=>{o.target===nt()&&la()},nt().querySelectorAll("[data-seg]").forEach(o=>{const i=o.dataset.seg;o.querySelectorAll("[data-seg-v]").forEach(r=>{r.onclick=()=>{const l=r.dataset.segV;ve[i]=i==="price_includes_vat_default"?l==="true":l,o.querySelectorAll("[data-seg-v]").forEach(m=>m.classList.toggle("on",m.dataset.segV===l))}})});const e=document.getElementById("sx-set-prefix");e&&(e.oninput=()=>{ve.number_prefix=e.value;const o=document.getElementById("sx-set-preview");o&&(o.textContent=Hr())});const n=document.getElementById("sx-set-wht"),a=document.getElementById("sx-set-wht-custom");n&&(n.onchange=()=>{const o=n.value==="custom";a&&(a.style.display=o?"":"none"),ve.default_wht_rate=o?Number(a?.value)||0:n.value}),a&&(a.oninput=()=>ve.default_wht_rate=Number(a.value)||0);const s=document.getElementById("sx-set-2up");s&&(s.onchange=()=>ve.default_copies_layout=s.checked?"two_up":"separate"),document.getElementById("sx-set-save").onclick=Zu}async function Zu(){const e={number_prefix:document.getElementById("sx-set-prefix").value.trim()||null,number_reset:ve.number_reset,number_start:Number(document.getElementById("sx-set-start").value)||1,approval_mode:ve.approval_mode,price_includes_vat_default:ve.price_includes_vat_default,default_wht_rate:Number(ve.default_wht_rate)||0,default_doc_lang:ve.default_doc_lang,default_paper:ve.default_paper,default_copies_layout:ve.default_copies_layout};try{if(!(await Je("/api/sales/settings",{method:"PUT",headers:{"Content-Type":"application/json"},body:JSON.stringify(e)})).ok)throw new Error;la(),showToast(t("sx-set-saved"),"success")}catch{showToast(t("sx-set-save-fail"),"error")}}window.openSalesSettings=async function(){nt().innerHTML=`<div class="modal" role="dialog" style="max-width:560px"><div class="modal-body"><div class="sx-state">${escapeHtml(t("sx-loading"))}</div></div></div>`,nt().style.display="flex";try{const e=await apiGet("/api/sales/settings");if(!e)return;ve=e.settings,Ju()}catch{nt().innerHTML=`<div class="modal" role="dialog" style="max-width:480px"><div class="modal-body"><div class="sx-state error">${escapeHtml(t("sx-error"))}</div></div></div>`,nt().onclick=n=>{n.target===nt()&&la()}}};const Qu=["tax_invoice","tax_invoice_receipt"],em=["receipt","tax_invoice_receipt"];function Yn(e){return em.includes(e.docType)}function eo(e){return e.docType!=="quotation"}function be(e){return(Math.round(e*100)/100).toLocaleString("en-US",{minimumFractionDigits:2,maximumFractionDigits:2})}function Sa(e){let n=0,a=0;e.lines.forEach(d=>{const p=Math.max(0,(+d.qty||0)*(+d.price||0)-(+d.disc||0));n+=p,d.vat&&(a+=p)});const s=Math.min(+e.hdisc||0,n),o=n>0?(n-s)/n:1;a*=o;const i=n-s,r=a*(+e.vatRate||0)/100,l=i*(+e.whtRate||0)/100,m=i+r-l;return{sub:n,hd:s,subAfter:i,vat:r,wht:l,grand:m}}function tm(e){const n=["","หนึ่ง","สอง","สาม","สี่","ห้า","หก","เจ็ด","แปด","เก้า"],a=["","สิบ","ร้อย","พัน","หมื่น","แสน"];let s="";const o=e.length;for(let i=0;i<o;i++){const r=+e[i],l=o-1-i;r!==0&&(l===1&&r===1?s+="สิบ":l===1&&r===2?s+="ยี่สิบ":l===0&&r===1&&o>1?s+="เอ็ด":s+=n[r]+a[l])}return s}function ei(e){if(e===0)return"ศูนย์";const n=[];let a=String(e);for(;a.length>6;)n.unshift(a.slice(-6)),a=a.slice(0,-6);n.unshift(a);let s="";return n.forEach((o,i)=>{const r=+o;if(r===0)return;s+=tm(String(r));const l=n.length-1-i;for(let m=0;m<l;m++)s+="ล้าน"}),s}function nm(e){e=Math.round(e*100)/100;const n=Math.floor(e),a=Math.round((e-n)*100);let s=ei(n)+"บาท";return s+=a===0?"ถ้วน":ei(a)+"สตางค์",s}function am(e){e=Math.round(e*100)/100;const n=Math.floor(e),a=Math.round((e-n)*100),s=["零","壹","贰","叁","肆","伍","陆","柒","捌","玖"],o=["","拾","佰","仟"],i=["","万","亿"],r=d=>{let p="";const c=String(d);for(let u=0;u<c.length;u++){const v=+c[u],f=c.length-1-u;v===0?!p.endsWith("零")&&p&&(p+="零"):p+=s[v]+o[f]}return p.replace(/零+$/,"")};let m=(d=>{if(d===0)return"零";const p=[];let c=String(d);for(;c.length>4;)p.unshift(c.slice(-4)),c=c.slice(0,-4);p.unshift(c);let u="";return p.forEach((v,f)=>{const y=+v,b=p.length-1-f;y!==0?u+=r(y)+i[b]:u&&!u.endsWith("零")&&(u+="零")}),u.replace(/零+$/,"")})(n)+"泰铢";return m+=a===0?"整":s[Math.floor(a/10)]+"角"+(a%10?s[a%10]+"分":""),m}function Mr(e){const n=e.buyer,a=Qu.includes(e.docType),s=n.type==="anonymous",o=a?!s&&!!(n.name&&n.addr&&n.tin&&(n.type!=="company"||n.branchType==="hq"||/^\d{5}$/.test(n.branchNo))):!0;let i=!0;["company","individual"].includes(n.type)&&n.tin&&(i=/^\d{13}$/.test(n.tin)),n.type==="foreigner"&&n.tin&&(i=/^[A-Za-z0-9]{4,20}$/.test(n.tin));const r=!Yn(e)||e.pay.status!=="unpaid",l=a||e.docType==="tax_invoice_simple";return[{key:"ckBuyer",descKey:"ckBuyerD",pass:o,req:a,na:!a},{key:"ckTin",descKey:"ckTinD",pass:i,req:a,na:e.docType==="quotation"},{key:"ckVat",descKey:"ckVatD",pass:!0,req:l,na:!l},{key:"ckPay",descKey:"ckPayD",pass:r,req:Yn(e),na:!Yn(e)},{key:"ckSeq",descKey:"ckSeqD",pass:!0,req:!0,na:!1},{key:"ckWords",descKey:"ckWordsD",pass:!0,req:l,na:!l}]}const sm="modulepreload",om=function(e){return"/"+e},ti={},im=function(n,a,s){let o=Promise.resolve();if(a&&a.length>0){let r=function(d){return Promise.all(d.map(p=>Promise.resolve(p).then(c=>({status:"fulfilled",value:c}),c=>({status:"rejected",reason:c}))))};document.getElementsByTagName("link");const l=document.querySelector("meta[property=csp-nonce]"),m=l?.nonce||l?.getAttribute("nonce");o=r(a.map(d=>{if(d=om(d),d in ti)return;ti[d]=!0;const p=d.endsWith(".css"),c=p?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${d}"]${c}`))return;const u=document.createElement("link");if(u.rel=p?"stylesheet":sm,p||(u.as="script"),u.crossOrigin="",u.href=d,m&&u.setAttribute("nonce",m),document.head.appendChild(u),p)return new Promise((v,f)=>{u.addEventListener("load",v),u.addEventListener("error",()=>f(new Error(`Unable to preload CSS for ${d}`)))})}))}function i(r){const l=new Event("vite:preloadError",{cancelable:!0});if(l.payload=r,window.dispatchEvent(l),!l.defaultPrevented)throw r}return o.then(r=>{for(const l of r||[])l.status==="rejected"&&i(l.reason);return n().catch(i)})};let Ca=[],Ar=[];const rm={a4:"A4",a5:"A5",pos:"thermal_80"},ni={A4:"a4",A5:"a5",thermal_80:"pos",thermal_58:"pos"};function Pr(){return Ca}function jr(){return Ar}async function lm(){const[e,n]=await Promise.all([apiGet("/api/sales/sellers").catch(()=>null),apiGet("/api/sales/products").catch(()=>null)]);Ca=e&&e.sellers||[],Ar=n&&n.products||[]}function cm(e,n){const a=n||{},s=e;s.docType=a.doc_type||s.docType;const o=Ca.findIndex(l=>String(l.id)===String(a.seller_workspace_client_id));o>=0&&(s.sellerIdx=o);const i=a.buyer||{};s.buyer={type:i.type||"company",name:i.name||"",addr:i.address||"",tin:i.tax_id||"",branchType:i.branch_type||(i.branch_no?"branch":"hq"),branchNo:i.branch_no||"",verified:!1},s.lines=(a.lines||[]).map(l=>({desc:l.description||"",qty:Number(l.qty||0),price:Number(l.unit_price||0),disc:Number(l.discount||0),vat:l.vat_applicable!==!1,product_id:l.product_id||void 0})),s.hdisc=Number(a.header_discount_amount||0),s.vatRate=Number(a.vat_rate||0),s.whtRate=Number(a.wht_rate||0);const r=a.payment||{};return s.pay={status:r.status||s.pay.status,method:r.method||s.pay.method,date:r.date||s.pay.date,paidAmt:r.paid_amount!=null?Number(r.paid_amount):null},s.layout=a.copies_layout==="two_up"?"pair":"single",a.paper_size&&ni[a.paper_size]&&(s.paper=ni[a.paper_size]),a.doc_language&&(s.docLang=a.doc_language),s.issueDate=a.issue_date||s.issueDate,s.dueDate=a.due_date||"",s.draftId=String(a.id),s}async function dm(e){const n=await apiPost("/api/rd/verify",{tax_id:e});if(!n||!n.ok)return{valid:!1};const a=await n.json().catch(()=>({})),s=a&&a.data||{};return{valid:!!(a&&a.ok&&s.valid)}}async function pm(e,n=0){const a=await apiPost("/api/rd/lookup",{tax_id:e,branch:n});if(!a||!a.ok)return{found:!1};const s=await a.json().catch(()=>({})),o=s&&s.data||{};return{found:!!(s&&s.ok&&(o.name||o.address)),name:o.name,address:o.address,branch_no:o.branch_no}}function um(e){const n=Ca[e.sellerIdx],a=Sa(e),s=e.lines.filter(i=>(i.desc||"").trim()).map(i=>({description:i.desc.trim(),product_id:i.product_id||null,qty:+i.qty||0,unit_price:+i.price||0,discount:+i.disc||0,vat_applicable:!!i.vat}));let o=null;if(eo(e)){const i=e.pay.status==="paid"?a.grand:e.pay.status==="partial"?+(e.pay.paidAmt||0):0;o={status:e.pay.status,paid_amount:i,method:e.pay.method,date:e.pay.date}}return{doc_type:e.docType,seller_workspace_client_id:n?n.id:null,currency:"THB",vat_rate:+e.vatRate||0,wht_rate:+e.whtRate||0,header_discount_amount:+e.hdisc||0,header_discount_pct:0,price_includes_vat:!1,copies_layout:e.layout==="pair"?"two_up":"separate",paper_size:rm[e.paper]||"A4",doc_language:e.docLang||"th_en",due_date:e.docType==="tax_invoice"&&e.dueDate?e.dueDate:null,lines:s,buyer:{type:e.buyer.type,name:e.buyer.name||null,address:e.buyer.addr||null,tax_id:e.buyer.tin||null,branch_type:e.buyer.type==="company"?e.buyer.branchType:null,branch_no:e.buyer.branchType==="branch"?e.buyer.branchNo:null},payment:o}}async function ds(e){if(!e)return{ok:!1,error:"network"};const n=await e.json().catch(()=>({}));return e.ok?{ok:!0,id:n.document&&String(n.document.id)}:{ok:!1,error:n.detail||"http_"+e.status}}async function mm(e){const n=e.lines.filter(a=>a.save&&a.custom&&!a.product_id&&(a.desc||"").trim());for(const a of n)try{const s=await apiPost("/api/sales/products",{name_th:a.desc.trim(),unit_price:+a.price||0,vat_applicable:!!a.vat});if(!s||!s.ok)continue;const o=await s.json().catch(()=>({}));o&&o.product&&o.product.id&&(a.product_id=String(o.product.id)),a.save=!1}catch{}}async function Dr(e){const n=um(e);let a;if(e.draftId){const{salesFetch:s}=await im(async()=>{const{salesFetch:i}=await Promise.resolve().then(()=>iu);return{salesFetch:i}},void 0),o=await s(`/api/sales/documents/${e.draftId}`,{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify(n)});a=await ds(o)}else a=await ds(await apiPost("/api/sales/documents",n));return a.ok&&await mm(e),a}async function vm(e){const n=await Dr(e);if(!n.ok||!n.id)return n;const a=await apiPost(`/api/sales/documents/${n.id}/issue`,{issue_date:e.issueDate||null}),s=await ds(a);return s.ok?{ok:!0,id:n.id}:s}const fm={steps:["ประเภทเอกสาร","ผู้ขาย/ผู้ซื้อ","รายการสินค้า","รับชำระ / วันที่","ตรวจ & ออก"],sc:[["ขายปลีกรับเงินสด","รวม · ลูกค้าบุคคลจ่ายสด"],["ขายเชื่อ B2B","ใบกำกับ · นิติบุคคล · เครดิต"],["บุคคลขอลดหย่อน","รวม · บุคคล+เลขบัตร"],["POS แบบย่อ","อย่างย่อ · ไม่ระบุชื่อ"]],docTypes:[["tax_invoice_receipt","ใบกำกับภาษี/ใบเสร็จรับเงิน","พบบ่อยสุด รับเงินแล้วออกทันที"],["tax_invoice","ใบกำกับภาษี (ขายเชื่อ)","ออกก่อน รับเงินทีหลัง"],["tax_invoice_simple","ใบกำกับภาษีอย่างย่อ","ขายปลีก ผู้ซื้อขอคืนภาษีไม่ได้"],["receipt","ใบเสร็จรับเงิน","หลักฐานรับเงิน"],["quotation","ใบเสนอราคา","ไม่ใช่เอกสารภาษี"]],bt:[["company","นิติบุคคล","ขอคืนภาษีซื้อได้"],["individual","บุคคลธรรมดา","คนไทย"],["foreigner","ชาวต่างชาติ","ใช้พาสปอร์ต"],["anonymous","ลูกค้าทั่วไป","ไม่ระบุ"]],methods:[["cash","เงินสด"],["transfer","โอน"],["promptpay","พร้อมเพย์"],["card","บัตร"],["cheque","เช็ค"]],s:{title:"ออกใบกำกับภาษี",sub:"· ใบกำกับขาย",back:"ย้อนกลับ",next:"ถัดไป",draft:"บันทึกร่าง",issue:"ออกใบกำกับภาษี",s1h:"เลือกประเภทเอกสาร",s1sub:"แต่ละประเภทจะให้กรอกข้อมูลต่างกัน เลือกสถานการณ์เพื่อตั้งค่าอัตโนมัติได้",scenarios:"สถานการณ์ที่พบบ่อย (กดเพื่อตั้งค่า)",orManual:"หรือเลือกประเภทเอง",s2h:"ผู้ขาย / ผู้ซื้อ",s2sub:"ผู้ขายดึงจากกิจการที่เลือก ผู้ซื้อปรับช่องตามประเภทอัตโนมัติ",seller:"ผู้ขาย (กิจการ)",sellerPick:"เลือกกิจการที่ออกบิล",buyer:"ผู้ซื้อ",buyerType:"ประเภทผู้ซื้อ",name:"ชื่อ",addr:"ที่อยู่",tin:"เลขผู้เสียภาษี",natid:"เลขบัตรประชาชน",passport:"เลขพาสปอร์ต",branch:"สำนักงานใหญ่ / สาขา",hq:"สำนักงานใหญ่",br:"สาขา",brno:"เลขสาขา",tinHintInd:"บุคคลใช้เลขบัตรประชาชนเป็นเลขผู้เสียภาษีได้",tinErr:"ต้องเป็นตัวเลข 13 หลัก",passErr:"พาสปอร์ต 4–20 ตัวอักษร/ตัวเลข",brErr:"เลขสาขาต้อง 5 หลัก",anonNote:"ลูกค้าทั่วไป: เว้นว่างได้ แต่ผู้ซื้อจะใช้ขอคืนภาษีไม่ได้",verify:"ตรวจสอบเลขภาษี",verifyLookup:"ตรวจสอบและดึงข้อมูล",rdModalTitle:"ข้อมูลจดทะเบียนสรรพากร",rdModalSub:"ดึงข้อมูลจดทะเบียนจากสรรพากรแล้ว ตรวจ/แก้ไขแล้วยืนยันเพื่อเติมข้อมูลผู้ซื้อ",rdFill:"ยืนยันเติมข้อมูล",rdCancel:"ยกเลิก",verifiedCo:"ตรวจผ่าน · ดึงข้อมูลจากสรรพากร (แก้ได้)",verified:"ตรวจผ่าน",rdNeedTin:"กรอกเลขภาษีก่อน",rdCo13:"เลขภาษี 13 หลัก",lookupFail:"ไม่พบ · กรอกเอง",verifyFail:"ตรวจไม่ผ่าน / ไม่พบ",s3h:"รายการสินค้า",s3subMenu:"แตะเลือกสินค้าเหมือนสั่งอาหาร → ออกบิลอัตโนมัติ",searchPh:"ค้นหา / สแกน…",addCustom:"เพิ่มรายการเอง",cartEmpty:"แตะสินค้าทางซ้ายเพื่อเพิ่ม",saveCatalog:"บันทึกเข้าคลังสินค้า",lineNamePh:"ชื่อสินค้า/บริการ",linePrice:"ราคา",lineDisc:"ส่วนลด",hdisc:"ส่วนลดท้ายบิล",subtotal:"รวมเงิน",vat:"ภาษีมูลค่าเพิ่ม",whtL:"หัก ณ ที่จ่าย",grand:"ยอดสุทธิ",taxFree:"ยกเว้นภาษี",s4h:"รับชำระ & วันที่",s4sub:"ใบเสร็จ/ใบรวมต้องบันทึกการรับเงินก่อน",payStatus:"สถานะชำระ",paid:"รับเงินแล้ว",partial:"รับบางส่วน",unpaid:"ยังไม่รับ",payMethod:"วิธีรับเงิน",payDate:"วันที่รับ",paidAmt:"จำนวนที่รับ",issueDate:"วันที่ออก",dueDate:"ครบกำหนดชำระ",calendar:"ปฏิทิน",ce:"ค.ศ.",be:"พ.ศ.",payReqWarn:"เอกสารนี้เป็นใบเสร็จ/ใบรวม ต้องบันทึกรับเงินก่อนออก",payNA:"เอกสารประเภทนี้ไม่ต้องระบุการรับเงิน",s5h:"ตรวจสอบ & ออก",s5sub:"ออกแล้วเลขที่ล็อก แก้ไม่ได้ (ต้องใช้ใบลด/เพิ่มหนี้)",compliance:"ตรวจความถูกต้อง (มาตรา 86/4)",preview:"ตัวอย่างเอกสาร",ckBuyer:"ข้อมูลผู้ซื้อครบ",ckBuyerD:"ใบเต็มต้องมีชื่อ/ที่อยู่/เลขภาษี",ckTin:"รูปแบบเลขภาษีถูก",ckTinD:"13 หลัก / พาสปอร์ต",ckVat:"แยกบรรทัด VAT",ckVatD:"แยกภาษีออกจากราคาสินค้า",ckPay:"บันทึกรับเงินแล้ว",ckPayD:"ใบเสร็จ/ใบรวมต้องรับเงิน",ckSeq:"เลขที่ต่อเนื่อง",ckSeqD:"ออกเลขในทรานแซกชัน",ckWords:"จำนวนเงินตัวอักษร",ckWordsD:"สร้างคำอ่านบาทแล้ว",ckNa:"ไม่เกี่ยวข้อง",output:"ตั้งค่าการออก",paper:"กระดาษ",paperA4:"A4",paperA5:"A5",paperPos:"80mm ความร้อน",docLangL:"ภาษาเอกสาร",dlTh:"ไทย",dlThEn:"ไทย+อังกฤษ",dlThZh:"ไทย+จีน",layoutL:"รูปแบบ",laySingle:"ต้นฉบับหน้าเดียว",layPair:"ต้นฉบับ+สำเนาในแผ่นเดียว",tear:"ตัดตามเส้นประ · ส่วนบนให้ลูกค้า · ส่วนล่างเก็บไว้",okTitle:"ออกเอกสารแล้ว",okSeq:"ล็อกเลขที่แล้ว",okArchived:"จัดเก็บสำเนาอัตโนมัติ (5 ปี)",dl:"ดาวน์โหลด PDF",prnt:"พิมพ์",viewSend:"ดู / ส่ง",done:"เสร็จสิ้น",newOne:"ออกใบใหม่",blockers:"ยังออกไม่ได้:",draftSaved:"บันทึกร่างแล้ว (ยังไม่กินเลขที่)",saveFail:"บันทึกไม่สำเร็จ",issueFail:"ออกไม่สำเร็จ",needLines:"เพิ่มอย่างน้อยหนึ่งรายการ"}},hm={steps:["書類の種類","売手/買手","明細","入金 / 日付","確認 & 発行"],sc:[["小売現金","合算 · 個人が現金払い"],["B2B 掛売","税額票 · 法人 · 掛け"],["個人の控除","合算 · 個人+身分証"],["POS 簡易","簡易票 · 匿名"]],docTypes:[["tax_invoice_receipt","税額票 + 領収書","一枚で両方を兼ねる(タイで最も一般的)"],["tax_invoice","税額票(掛売)","先に発行・後で入金"],["tax_invoice_simple","簡易税額票 ABB","小売・買手は仕入税額控除不可"],["receipt","領収書","入金証憑のみ・税額票ではない"],["quotation","見積書","見積用・税務証憑ではない"]],bt:[["company","法人","仕入税額控除可"],["individual","個人","タイ国籍の個人"],["foreigner","外国人","パスポート番号"],["anonymous","匿名客","記名なし"]],methods:[["cash","現金"],["transfer","振込"],["promptpay","PromptPay"],["card","カード"],["cheque","小切手"]],s:{title:"発行",sub:"· 売上請求書",back:"戻る",next:"次へ",draft:"下書き保存",issue:"請求書を発行",s1h:"書類の種類を選択",s1sub:"種類で後の入力項目が変わります。よくある場面から自動設定も可能。",scenarios:"よくある場面(タップで設定)",orManual:"または手動で選択",s2h:"売手 / 買手",s2sub:"売手は帳簿主体から自動入力、買手は種類で項目が変化。",seller:"売手(帳簿主体)",sellerPick:"どの会社で発行するか",buyer:"買手",buyerType:"買手の種類",name:"名称 / 氏名",addr:"住所",tin:"納税番号",natid:"身分証番号",passport:"パスポート番号",branch:"本店 / 支店",hq:"本店",br:"支店",brno:"支店番号",tinHintInd:"個人は身分証番号を納税番号に使えます",tinErr:"13 桁の数字",passErr:"パスポート 4–20 桁英数",brErr:"支店番号は 5 桁",anonNote:"匿名客:買手情報は空でも可。ただし買手は仕入控除に使えません。",verify:"番号照合",verifyLookup:"照合して取得",rdModalTitle:"税務署の登録情報",rdModalSub:"税務署から登録情報を取得しました。確認・編集のうえ、買手に反映してください。",rdFill:"反映する",rdCancel:"キャンセル",verifiedCo:"照合成功 · 税務署の登録情報を取得(編集可)",verified:"納税番号 照合成功",rdNeedTin:"先に納税番号を入力",rdCo13:"法人番号は 13 桁",lookupFail:"見つかりません · 手入力",verifyFail:"照合失敗 / 見つからない",s3h:"明細",s3subMenu:"注文のように左の商品をタップ → 右に自動で明細(自由行も追加可)",searchPh:"検索 / スキャン…",addCustom:"自由行を追加(サービス/在庫外)",cartEmpty:"左の商品をタップして追加",saveCatalog:"商品マスタに保存",lineNamePh:"商品/サービス名",linePrice:"単価",lineDisc:"割引",hdisc:"伝票全体の割引",subtotal:"小計",vat:"付加価値税 VAT",whtL:"源泉税 WHT",grand:"請求合計",taxFree:"非課税",s4h:"入金 & 日付",s4sub:"領収書/合算は先に入金記録が必要。掛売は未入金でも可。",payStatus:"入金状態",paid:"入金済",partial:"一部入金",unpaid:"未入金",payMethod:"入金方法",payDate:"入金日",paidAmt:"入金額",issueDate:"発行日",dueDate:"支払期日",calendar:"暦",ce:"西暦",be:"仏暦 (พ.ศ.)",payReqWarn:"これは領収書/合算です:発行前に入金(または一部)を記録してください。",payNA:"この種類は入金情報が不要です。",s5h:"確認して発行",s5sub:"発行後は番号がロックされ内容は変更不可(貸方/借方票で調整)。",compliance:"コンプライアンス確認(歳入法第86/4条)",preview:"請求書プレビュー",ckBuyer:"買手情報が完全",ckBuyerD:"完全な税額票は名称/住所/納税番号が必要(法人は支店も)",ckTin:"納税番号の形式が正しい",ckTinD:"13 桁 / パスポート",ckVat:"VAT を分離表示",ckVatD:"税額と本体価格を分離",ckPay:"入金記録済",ckPayD:"領収書/合算は入金必須",ckSeq:"連番(欠番なし)",ckSeqD:"発行時にトランザクションで採番",ckWords:"金額の文字表記",ckWordsD:"バーツ表記を生成済",ckNa:"対象外",output:"出力設定",paper:"用紙",paperA4:"A4",paperA5:"A5",paperPos:"80mm 感熱",docLangL:"書類の言語",dlTh:"タイ語",dlThEn:"タイ+英",dlThZh:"タイ+中",layoutL:"レイアウト",laySingle:"正本のみ1ページ",layPair:"正本+副本を1ページ",tear:"破線で切離 · 上を客へ · 下を控え",okTitle:"発行完了",okSeq:"番号をロック",okArchived:"副本を自動保管(5年)",dl:"PDF をダウンロード",prnt:"印刷",viewSend:"表示 / 送信",done:"完了",newOne:"もう一枚",blockers:"発行にはあと:",draftSaved:"下書き保存(番号は未使用)",saveFail:"保存失敗",issueFail:"発行失敗",needLines:"明細を1行以上追加"}},gm={steps:["单据类型","买卖双方","商品明细","收款 / 日期","核对开出"],sc:[["零售收现金","合并单 · 个人散客付现"],["B2B 赊销","税票 · 公司 · 月结"],["个人要抵税","合并单 · 个人带身份证"],["POS 简易票","简易票 · 不记名"]],docTypes:[["tax_invoice_receipt","税票 + 收据合并单","一张纸既是税票又是收据(泰国最常见,收钱当场开)"],["tax_invoice","税票(赊销)","先开票后收款,月结/账期常用"],["tax_invoice_simple","简易税票 ABB","零售小票,不记买方,买方不能抵扣"],["receipt","收据","纯收款凭证,非税票"],["quotation","报价单","报价用,不是税务凭证"]],bt:[["company","公司","法人,可抵进项"],["individual","个人","本国自然人"],["foreigner","外国个人","用护照号"],["anonymous","匿名散客","不记名"]],methods:[["cash","现金"],["transfer","转账"],["promptpay","PromptPay"],["card","刷卡"],["cheque","支票"]],s:{title:"开票",sub:"· 销项发票",back:"上一步",next:"下一步",draft:"存草稿",issue:"开出发票",s1h:"选择单据类型",s1sub:"不同单据,后面要填的内容会自动变。也可以点常见场景一键带出。",scenarios:"常见场景(点一下自动设置)",orManual:"或手动选类型",s2h:"买卖双方",s2sub:"卖方按账套主体自动带出;买方按类型动态显示该填什么。",seller:"卖方(账套主体)",sellerPick:"选择以哪家公司开票",buyer:"买方",buyerType:"买方类型",name:"名称 / 姓名",addr:"地址",tin:"税号",natid:"身份证号",passport:"护照号",branch:"总公司 / 分店",hq:"总公司",br:"分店",brno:"分店号",tinHintInd:"个人可用身份证号作为税号",tinErr:"需为 13 位数字",passErr:"护照号 4–20 位字母数字",brErr:"分店号需 5 位数字",anonNote:"匿名散客:买方信息留空也可,但买方将无法用于抵扣进项 / 个税。",verify:"核验税号",verifyLookup:"核验并带出登记",rdModalTitle:"税局登记信息",rdModalSub:"已从税务局查到以下登记信息,核对(可编辑)后确认填入买方。",rdFill:"确认填入",rdCancel:"取消",verifiedCo:"税号验真通过 · 已从税局带出登记信息(可改)",verified:"税号验真通过",rdNeedTin:"先填税号",rdCo13:"公司税号需 13 位",lookupFail:"查不到 · 请手填",verifyFail:"验真不通过 / 查不到",s3h:"商品明细",s3subMenu:"像餐厅点单:左边点商品 → 右边自动成单(没有的可加自定义行)",searchPh:"搜商品 / 扫码…",addCustom:"加自定义行(服务/不在库)",cartEmpty:"点左边商品加入 · 像点菜单",saveCatalog:"存入商品库(以后也能点)",lineNamePh:"商品/服务名",linePrice:"单价",lineDisc:"折扣",hdisc:"整单折扣",subtotal:"小计",vat:"增值税 VAT",whtL:"预扣税 WHT",grand:"合计应付",taxFree:"免税",s4h:"收款与日期",s4sub:"收据/合并单必须先记收款;赊销税票可暂不收。",payStatus:"收款状态",paid:"已收款",partial:"部分收款",unpaid:"未收款",payMethod:"收款方式",payDate:"收款日",paidAmt:"已收金额",issueDate:"开票日期",dueDate:"付款到期日",calendar:"日期历法",ce:"公历",be:"佛历 พ.ศ.",payReqWarn:"当前单据是收据/合并单:开出前必须记为已收款(或部分收款)。",payNA:"此单据类型无需收款信息。",s5h:"核对并开出",s5sub:"确认无误后开出。开出后连号锁定、内容不可改(红冲/补开才能调整)。",compliance:"合规检查(泰国税法第 86/4 条)",preview:"发票预览",ckBuyer:"买方信息齐全",ckBuyerD:"完整税票需买方名称/地址/税号(公司还要分店)",ckTin:"税号格式正确",ckTinD:"13 位数字 / 护照号",ckVat:"VAT 单独列示",ckVatD:"税额与货值分开",ckPay:"收款已记录",ckPayD:"收据/合并单须已收款",ckSeq:"连号不跳号",ckSeqD:"开出时事务取号",ckWords:"金额大写",ckWordsD:"泰铢大写已生成",ckNa:"不适用",output:"输出设置",paper:"纸张",paperA4:"A4",paperA5:"A5",paperPos:"80mm 热敏",docLangL:"文档语言",dlTh:"泰文",dlThEn:"泰+英",dlThZh:"泰+中",layoutL:"版式 / 联数",laySingle:"正本单页",layPair:"正本+副本同页",tear:"沿虚线裁开 · 上联给顾客 · 下联自留",okTitle:"已开出",okSeq:"连号已锁定",okArchived:"副本已自动归档(留底 5 年)",dl:"下载 PDF 正本",prnt:"打印",viewSend:"查看 / 发送",done:"完成",newOne:"再开一张",blockers:"还差这些才能开出:",draftSaved:"草稿已保存(未占连号)",saveFail:"保存失败",issueFail:"开出失败",needLines:"请至少加一行商品"}},bm={steps:["Document type","Parties","Line items","Payment / Date","Review & issue"],sc:[["Retail cash","Combined · individual pays cash"],["B2B credit","Tax invoice · company · terms"],["Individual tax","Combined · individual w/ ID"],["POS simplified","Simplified · anonymous"]],docTypes:[["tax_invoice_receipt","Tax Invoice + Receipt","One paper that is both (most common in Thailand)"],["tax_invoice","Tax Invoice (credit)","Issued first, paid later"],["tax_invoice_simple","Simplified ABB","Retail; buyer cannot claim input VAT"],["receipt","Receipt","Payment proof only, not a tax invoice"],["quotation","Quotation","For quoting, not a tax document"]],bt:[["company","Company","Legal entity, can claim VAT"],["individual","Individual","Thai natural person"],["foreigner","Foreigner","Uses passport no."],["anonymous","Walk-in","Anonymous"]],methods:[["cash","Cash"],["transfer","Transfer"],["promptpay","PromptPay"],["card","Card"],["cheque","Cheque"]],s:{title:"New Invoice",sub:"· Sales invoice",back:"Back",next:"Next",draft:"Save draft",issue:"Issue invoice",s1h:"Choose document type",s1sub:"Each type changes later fields. Or pick a common scenario.",scenarios:"Common scenarios (tap to set)",orManual:"Or pick a type manually",s2h:"Parties",s2sub:"Seller auto-fills from your company; buyer fields adapt to type.",seller:"Seller (company)",sellerPick:"Choose which company issues",buyer:"Buyer",buyerType:"Buyer type",name:"Name",addr:"Address",tin:"Tax ID",natid:"National ID",passport:"Passport no.",branch:"HQ / Branch",hq:"HQ",br:"Branch",brno:"Branch no.",tinHintInd:"Individuals may use national ID as tax ID",tinErr:"Must be 13 digits",passErr:"Passport 4–20 alphanumeric",brErr:"Branch no. must be 5 digits",anonNote:"Walk-in: buyer info may be blank, but the buyer cannot claim input VAT / tax.",verify:"Verify Tax ID",verifyLookup:"Verify & fetch",rdModalTitle:"RD registered info",rdModalSub:"Fetched from the Revenue Dept. Review/edit, then confirm to fill the buyer.",rdFill:"Fill in",rdCancel:"Cancel",verifiedCo:"Verified · pulled registration from RD (editable)",verified:"Tax ID verified",rdNeedTin:"Enter the tax ID first",rdCo13:"Company tax ID must be 13 digits",lookupFail:"Not found · enter manually",verifyFail:"Verification failed / not found",s3h:"Line items",s3subMenu:"Like ordering food: tap products on the left → cart on the right (add custom rows too)",searchPh:"Search / scan…",addCustom:"Add custom row (service / off-catalog)",cartEmpty:"Tap a product to add · like a menu",saveCatalog:"Save to product catalog",lineNamePh:"Item / service name",linePrice:"Price",lineDisc:"Discount",hdisc:"Whole-bill discount",subtotal:"Subtotal",vat:"VAT",whtL:"WHT",grand:"Total due",taxFree:"tax-free",s4h:"Payment & date",s4sub:"Receipts/combined must record payment first; credit invoices may stay unpaid.",payStatus:"Payment status",paid:"Paid",partial:"Partial",unpaid:"Unpaid",payMethod:"Method",payDate:"Paid date",paidAmt:"Paid amount",issueDate:"Issue date",dueDate:"Due date",calendar:"Calendar",ce:"CE",be:"BE (พ.ศ.)",payReqWarn:"This is a receipt/combined: must be marked paid (or partial) before issuing.",payNA:"This document type needs no payment info.",s5h:"Review & issue",s5sub:"Once issued, the number is locked and content cannot change (use credit/debit notes).",compliance:"Compliance check (Revenue Code §86/4)",preview:"Invoice preview",ckBuyer:"Buyer info complete",ckBuyerD:"Full tax invoice needs name/address/tax ID (company also branch)",ckTin:"Tax ID format valid",ckTinD:"13 digits / passport",ckVat:"VAT shown separately",ckVatD:"Tax split from goods value",ckPay:"Payment recorded",ckPayD:"Receipt/combined must be paid",ckSeq:"Sequential numbering",ckSeqD:"Number drawn in a transaction",ckWords:"Amount in words",ckWordsD:"Baht text generated",ckNa:"N/A",output:"Output settings",paper:"Paper",paperA4:"A4",paperA5:"A5",paperPos:"80mm thermal",docLangL:"Document language",dlTh:"Thai",dlThEn:"Thai+Eng",dlThZh:"Thai+Chi",layoutL:"Layout",laySingle:"Original single page",layPair:"Original + copy on one page",tear:"Cut along the dashed line · top to customer · bottom kept",okTitle:"Issued",okSeq:"Number locked",okArchived:"Copy auto-archived (kept 5 yrs)",dl:"Download PDF",prnt:"Print",viewSend:"View / Send",done:"Done",newOne:"New invoice",blockers:"Still needed before issuing:",draftSaved:"Draft saved (no number used)",saveFail:"Save failed",issueFail:"Issue failed",needLines:"Add at least one line item"}},ps={zh:gm,en:bm,th:fm,ja:hm};let to="th";function ym(e){ps[e]&&(to=e)}function wm(){return to}function Mn(){return ps[to]||ps.th}function S(e){return Mn().s[e]||e}const km={no:{th:"เลขที่",en:"No.",zh:"号码"},date:{th:"วันที่",en:"Date",zh:"日期"},seller:{th:"ผู้ขาย",en:"Seller",zh:"卖方"},buyer:{th:"ผู้ซื้อ",en:"Buyer",zh:"买方"},desc:{th:"รายการ",en:"Description",zh:"商品"},qty:{th:"จำนวน",en:"Qty",zh:"数量"},price:{th:"ราคา",en:"Price",zh:"单价"},disc:{th:"ส่วนลด",en:"Discount",zh:"折扣"},amount:{th:"จำนวนเงิน",en:"Amount",zh:"金额"},subtotal:{th:"มูลค่า",en:"Subtotal",zh:"小计"},grand:{th:"รวมทั้งสิ้น",en:"Grand Total",zh:"合计"},words:{th:"ตัวอักษร",en:"In words",zh:"大写"},paid:{th:"การรับเงิน",en:"Payment",zh:"收款"},wht:{th:"หัก ณ ที่จ่าย",en:"WHT",zh:"预扣税"},signSeller:{th:"ผู้รับเงิน / ผู้มีอำนาจ",en:"Authorized",zh:"收款人/授权"},signBuyer:{th:"ผู้ซื้อ",en:"Buyer",zh:"买方签收"}};function ke(e,n){const a=km[n];return e.docLang==="th"?a.th:a.th+" / "+(e.docLang==="th_zh"?a.zh:a.en)}const xm={tax_invoice_receipt:"ใบกำกับภาษี/ใบเสร็จรับเงิน · Tax Invoice / Receipt",tax_invoice:"ใบกำกับภาษี · Tax Invoice",tax_invoice_simple:"ใบกำกับภาษีอย่างย่อ · Simplified",receipt:"ใบเสร็จรับเงิน · Receipt",quotation:"ใบเสนอราคา · Quotation"},_m={cash:"เงินสด",transfer:"โอน",promptpay:"พร้อมเพย์",card:"บัตร",cheque:"เช็ค"};function ai(e,n){if(!n)return"-";if(e.be){const a=n.split("-");return+a[0]+543+"-"+a[1]+"-"+a[2]}return n}function Va(e,n){const a=Pr()[e.sellerIdx]||{name:"",tax_id:"",address:"",branch:""},s=e.buyer,o=Sa(e),i=s.type==="individual"?"เลขบัตรประชาชน":s.type==="foreigner"?"Passport":"Tax ID",r=s.name||(s.type==="anonymous"?"ลูกค้าทั่วไป":"-"),l=s.type==="anonymous"&&!s.name?"":`<div class="sw-pl">${escapeHtml(s.addr)||""}</div><div class="sw-pl">${i}: ${escapeHtml(s.tin)||"-"}</div>
               ${s.type==="company"?`<div class="sw-pl">${s.branchType==="hq"?"สำนักงานใหญ่":"สาขาที่ "+(escapeHtml(s.branchNo)||"-")}</div>`:""}`,m=e.lines.map((v,f)=>`<tr><td>${f+1}</td><td>${escapeHtml(v.desc)||"-"}</td><td class="r">${be(+v.qty||0)}</td><td class="r">${be(+v.price||0)}</td><td class="r">${+v.disc>0?"-"+be(+v.disc):"-"}</td><td class="r">${be(Math.max(0,(+v.qty||0)*(+v.price||0)-(+v.disc||0)))}</td></tr>`).join(""),d=eo(e)&&e.pay.status!=="unpaid"?`<div class="sw-inv-pay"><b>${ke(e,"paid")}:</b> ${_m[e.pay.method]||e.pay.method} · ${ai(e,e.pay.date)} · ${e.pay.status==="partial"?"฿ "+be(+(e.pay.paidAmt||0)):"฿ "+be(o.grand)}</div>`:"",p=e.docLang==="th_zh"?am(o.grand):nm(o.grand),c=n==="copy",u=c?e.docLang==="th"?"สำเนา":"สำเนา / Copy":e.docLang==="th"?"ต้นฉบับ":"ต้นฉบับ / Original";return`<div class="sw-invoice ${e.paper==="pos"?"pos":""} ${e.layout==="pair"?"half":""}">
        <div class="sw-copybadge ${c?"copy":""}">${u}</div>
        <h3>${xm[e.docType]}</h3>
        <div class="sw-docno">${ke(e,"no")}: — &nbsp;·&nbsp; ${ke(e,"date")}: ${ai(e,e.issueDate)}${e.be?" (พ.ศ.)":""}</div>
    ...
    </div>`}function Em(e,n,a){return e.layout==="pair"&&e.paper!=="pos"?`<div class="sw-pairwrap">${Va(e,"original")}
            <div class="sw-tear"><span>${a} ${escapeHtml(n)}</span></div>
            ${Va(e,"copy")}</div>`:Va(e,"original")}const ye={check:'<svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="#fff" stroke-width="3"><path d="M20 6 9 17l-5-5"/></svg>',checkG:'<svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3"><path d="M20 6 9 17l-5-5"/></svg>',x:'<svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3"><path d="M18 6 6 18M6 6l12 12"/></svg>',plus:'<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2"><path d="M12 5v14M5 12h14"/></svg>',trash:'<svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.9"><path d="M3 6h18M8 6V4h8v2M6 6l1 14h10l1-14"/></svg>',info:'<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="9"/><path d="M12 11v5M12 7.5v.5"/></svg>',close:'<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.9"><path d="M18 6 6 18M6 6l12 12"/></svg>',box:'<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#fff" stroke-width="1.7"><path d="M21 8 12 3 3 8l9 5 9-5ZM3 8v8l9 5 9-5V8"/></svg>'},si=["#2563eb","#db2777","#16a34a","#d97706","#0891b2","#7c3aed","#92400e","#e11d48","#059669"];function qr(e){const n=wm();return n==="zh"&&(e.name_zh||e.name_th)||n==="en"&&(e.name_en||e.name_th)||e.name_th||e.name_en||e.name_zh||"—"}function Im(e){const n=Mn(),a=n.sc.map((o,i)=>`<span class="sw-chip" data-sc="${i}"><b>${escapeHtml(o[0])}</b> · <span class="sw-muted">${escapeHtml(o[1])}</span></span>`).join(""),s=n.docTypes.map(o=>`<div class="sw-choice ${e.docType===o[0]?"on":""}" data-doc="${o[0]}"><div class="sw-ck">${ye.check}</div><div><div class="sw-t">${escapeHtml(o[1])}</div><div class="sw-d">${escapeHtml(o[2])}</div></div></div>`).join("");return`<div class="sw-card"><h2>${escapeHtml(S("s1h"))}</h2><div class="sw-sub">${escapeHtml(S("s1sub"))}</div>
        <div class="sw-sectitle">${escapeHtml(S("scenarios"))}</div><div class="sw-chips">${a}</div>
        <div class="sw-sectitle">${escapeHtml(S("orManual"))}</div><div class="sw-choices">${s}</div></div>`}function Bm(e){const n=Mn(),a=Pr(),s=a[e.sellerIdx],o=a.map((f,y)=>`<option value="${y}" ${y===e.sellerIdx?"selected":""}>${escapeHtml(f.name||"—")}</option>`).join(""),i=n.bt.map(f=>`<div class="sw-choice ${e.buyer.type===f[0]?"on":""}" data-bt="${f[0]}" style="padding:10px 12px"><div class="sw-ck">${ye.check}</div><div><div class="sw-t">${escapeHtml(f[1])}</div><div class="sw-d">${escapeHtml(f[2])}</div></div></div>`).join(""),r=e.buyer,l=r.type==="anonymous",m=r.type==="company",d=r.type==="individual"?S("natid"):r.type==="foreigner"?S("passport"):S("tin"),p=l?"":'<span class="sw-req">*</span>';let c="";l||(r.type==="foreigner"?r.tin&&!/^[A-Za-z0-9]{4,20}$/.test(r.tin)&&(c=`<div class="sw-hint err">${escapeHtml(S("passErr"))}</div>`):r.tin&&!/^\d{13}$/.test(r.tin)?c=`<div class="sw-hint err">${escapeHtml(S("tinErr"))}</div>`:r.type==="individual"&&(c=`<div class="sw-hint info">${ye.info} ${escapeHtml(S("tinHintInd"))}</div>`));const u=s?`${escapeHtml(s.name||"")} · ${escapeHtml(s.tax_id||"")} · ${escapeHtml(s.branch||"")}`:"—",v=l?`<div class="sw-banner warn">${ye.info}<span>${escapeHtml(S("anonNote"))}</span></div>
           <div class="sw-field"><label>${escapeHtml(S("name"))}</label><input type="text" id="sw-bname" value="${escapeHtml(r.name)}"></div>`:`<div class="sw-field"><label>${escapeHtml(S("name"))} ${p}</label><input type="text" id="sw-bname" value="${escapeHtml(r.name)}"></div>
           <div class="sw-field"><label>${escapeHtml(S("addr"))} ${p}</label><input type="text" id="sw-baddr" value="${escapeHtml(r.addr)}"></div>
           <div class="sw-field"><label>${escapeHtml(d)} ${p}</label>
             <div style="display:flex;gap:8px"><input type="text" id="sw-btin" value="${escapeHtml(r.tin)}" style="flex:1">
               <button type="button" id="sw-rd" class="btn btn-primary" style="white-space:nowrap">${r.type==="company"?escapeHtml(S("verifyLookup")):escapeHtml(S("verify"))}</button></div>
             ${r.verified?`<div class="sw-hint ok">${ye.checkG} ${escapeHtml(r.type==="company"?S("verifiedCo"):S("verified"))}</div>`:c}</div>
           ${m?Lm(e):""}`;return`<div class="sw-card"><h2>${escapeHtml(S("s2h"))}</h2><div class="sw-sub">${escapeHtml(S("s2sub"))}</div>
        <div class="sw-sectitle">${escapeHtml(S("seller"))}</div>
        <div class="sw-field"><label>${escapeHtml(S("sellerPick"))}</label><select id="sw-seller">${o}</select></div>
        <div class="sw-banner">${ye.info}<span>${u}</span></div>
        <div class="sw-sectitle">${escapeHtml(S("buyer"))} — ${escapeHtml(S("buyerType"))}</div>
        <div class="sw-choices">${i}</div>
        <div style="margin-top:16px">${v}</div></div>`}function Lm(e){const n=e.buyer,a=n.branchNo&&!/^\d{5}$/.test(n.branchNo);return`<div class="sw-field"><label>${escapeHtml(S("branch"))} <span class="sw-req">*</span></label>
        <div class="sw-seg" style="margin-bottom:8px">
            <button type="button" data-brt="hq" class="${n.branchType==="hq"?"on":""}">${escapeHtml(S("hq"))}</button>
            <button type="button" data-brt="branch" class="${n.branchType==="branch"?"on":""}">${escapeHtml(S("br"))}</button></div>
        ${n.branchType==="branch"?`<input type="text" id="sw-brno" value="${escapeHtml(n.branchNo)}" placeholder="${escapeHtml(S("brno"))} (5)">${a?`<div class="sw-hint err">${escapeHtml(S("brErr"))}</div>`:""}`:""}</div>`}function $m(e){const n=Sa(e),a=jr(),s=a.map((l,m)=>`<div class="sw-pcard" data-add="${m}"><div class="sw-pimg" style="background:${si[m%si.length]}">${l.image_url?`<img src="${escapeHtml(l.image_url)}" alt="">`:ye.box}</div><div class="sw-pn">${escapeHtml(qr(l))}</div><div class="sw-pp">฿${be(l.unit_price)}${l.vat_applicable?"":` <span class="sw-muted" style="font-size:10px">${escapeHtml(S("taxFree"))}</span>`}</div></div>`).join(""),o=a.length?"":'<div class="sw-muted" style="padding:20px;text-align:center">—</div>',r=e.lines.some(l=>l.desc||+l.price||l.custom)?e.lines.map((l,m)=>`<div class="sw-citem">
            <div class="sw-crow1"><input type="text" data-ln="${m}" data-f="desc" value="${escapeHtml(l.desc)}" placeholder="${escapeHtml(S("lineNamePh"))}" style="border:0;font-weight:600;padding:2px;flex:1;background:transparent"><button class="sw-iconbtn" data-rm="${m}">${ye.trash}</button></div>
            <div class="sw-crow2"><div class="sw-cqty"><button data-q="${m}" data-d="-1">−</button><span>${l.qty}</span><button data-q="${m}" data-d="1">+</button></div>
              <div class="sw-cfield"><label>${escapeHtml(S("linePrice"))}</label><input type="number" data-ln="${m}" data-f="price" value="${l.price}" min="0" step="0.01"></div>
              <div class="sw-cfield"><label>${escapeHtml(S("lineDisc"))}</label><input type="number" data-ln="${m}" data-f="disc" value="${l.disc}" min="0" step="0.01"></div>
              <span class="sw-amt">฿${be(Math.max(0,(+l.qty||0)*(+l.price||0)-(+l.disc||0)))}</span></div>
            ${l.custom?`<label style="display:flex;align-items:center;gap:6px;margin-top:7px;font-size:11px;color:var(--ink-3);cursor:pointer"><input type="checkbox" style="width:auto" data-save="${m}" ${l.save?"checked":""}> ${escapeHtml(S("saveCatalog"))}</label>`:""}</div>`).join(""):`<div class="sw-cart-empty">${escapeHtml(S("cartEmpty"))}</div>`;return`<div class="sw-card"><h2>${escapeHtml(S("s3h"))}</h2><div class="sw-sub">${escapeHtml(S("s3subMenu"))}</div>
        <div class="sw-menu">
            <div><input type="text" placeholder="${escapeHtml(S("searchPh"))}" style="margin-bottom:10px" id="sw-psearch"><div class="sw-pgrid">${s}${o}</div>
              <button class="sw-addline" id="sw-addcustom">${ye.plus} ${escapeHtml(S("addCustom"))}</button></div>
            <div><div class="sw-cart">${r}</div>
              <div class="sw-row" style="margin-top:12px">
                <div class="sw-field" style="margin:0"><label>${escapeHtml(S("hdisc"))}</label><input type="number" id="sw-hdisc" value="${e.hdisc}" min="0" step="0.01"></div>
              ...
              <div class="sw-totals">
                <div class="sw-tr"><span>${escapeHtml(S("subtotal"))}</span><span class="v">${be(n.sub)}</span></div>
                ${n.hd>0?`<div class="sw-tr disc"><span>${escapeHtml(S("hdisc"))}</span><span class="v">-${be(n.hd)}</span></div>`:""}
                <div class="sw-tr"><span>${escapeHtml(S("vat"))} ${e.vatRate}%</span><span class="v">${be(n.vat)}</span></div>
                ${n.wht>0?`<div class="sw-tr disc"><span>${escapeHtml(S("whtL"))} ${e.whtRate}%</span><span class="v">-${be(n.wht)}</span></div>`:""}
                <div class="sw-tr grand"><span>${escapeHtml(S("grand"))}</span><span class="v">฿ ${be(n.grand)}</span></div></div></div>
        </div></div>`}function Sm(e){const n=Mn(),a=Sa(e);if(!eo(e))return`<div class="sw-card"><h2>${escapeHtml(S("s4h"))}</h2><div class="sw-sub">${escapeHtml(S("s4sub"))}</div>
            <div class="sw-banner">${ye.info}<span>${escapeHtml(S("payNA"))}</span></div>${oi(e)}</div>`;const s=e.pay,o=n.methods.map(i=>`<option value="${i[0]}" ${s.method===i[0]?"selected":""}>${escapeHtml(i[1])}</option>`).join("");return`<div class="sw-card"><h2>${escapeHtml(S("s4h"))}</h2><div class="sw-sub">${escapeHtml(S("s4sub"))}</div>
        ${Yn(e)?`<div class="sw-banner warn">${ye.info}<span>${escapeHtml(S("payReqWarn"))}</span></div>`:""}
        <div class="sw-field"><label>${escapeHtml(S("payStatus"))}</label><div class="sw-seg">
            <button type="button" data-ps="paid" class="${s.status==="paid"?"on":""}">${escapeHtml(S("paid"))}</button>
            <button type="button" data-ps="partial" class="${s.status==="partial"?"on":""}">${escapeHtml(S("partial"))}</button>
            <button type="button" data-ps="unpaid" class="${s.status==="unpaid"?"on":""}">${escapeHtml(S("unpaid"))}</button></div></div>
        ${s.status!=="unpaid"?`<div class="sw-row3">
            <div class="sw-field"><label>${escapeHtml(S("payMethod"))}</label><select id="sw-pm">${o}</select></div>
            <div class="sw-field"><label>${escapeHtml(S("payDate"))}</label><input type="date" id="sw-pdate" value="${s.date}"></div>
            ${s.status==="partial"?`<div class="sw-field"><label>${escapeHtml(S("paidAmt"))}</label><input type="number" id="sw-paid" value="${s.paidAmt!=null?s.paidAmt:""}" placeholder="${be(a.grand)}"></div>`:`<div class="sw-field"><label>${escapeHtml(S("paidAmt"))}</label><input type="text" value="฿ ${be(a.grand)}" disabled></div>`}</div>`:""}
        ${oi(e)}</div>`}function oi(e){return`<div class="sw-sectitle">${escapeHtml(S("issueDate"))}</div><div class="sw-row3">
        <div class="sw-field"><label>${escapeHtml(S("issueDate"))}</label><input type="date" id="sw-idate" value="${e.issueDate}"></div>
        ${e.docType==="tax_invoice"?`<div class="sw-field"><label>${escapeHtml(S("dueDate"))}</label><input type="date" id="sw-ddate" value="${e.dueDate}"></div>`:"<div></div>"}
        <div class="sw-field"><label>${escapeHtml(S("calendar"))}</label><div class="sw-seg">
            <button type="button" data-cal="ce" class="${e.be?"":"on"}">${escapeHtml(S("ce"))}</button>
            <button type="button" data-cal="be" class="${e.be?"on":""}">${escapeHtml(S("be"))}</button></div></div></div>`}function Cm(e){const n=Mr(e).map(i=>i.na?`<div class="sw-check"><div class="sw-ci" style="background:#eee;color:#999">${ye.checkG}</div><div><div class="sw-ct">${escapeHtml(S(i.key))} <span class="sw-pill">${escapeHtml(S("ckNa"))}</span></div></div></div>`:`<div class="sw-check ${i.pass?"pass":"fail"}"><div class="sw-ci">${i.pass?ye.checkG:ye.x}</div><div><div class="sw-ct">${escapeHtml(S(i.key))}${i.req&&!i.pass?' <span class="sw-req">*</span>':""}</div><div class="sw-cd">${escapeHtml(S(i.descKey))}</div></div></div>`).join(""),a={a4:"paperA4",a5:"paperA5",pos:"paperPos"},s=["a4","a5","pos"].map(i=>`<button type="button" data-paper="${i}" class="${e.paper===i?"on":""}">${escapeHtml(S(a[i]))}</button>`).join(""),o=["th","th_en","th_zh"].map(i=>`<button type="button" data-dlang="${i}" class="${e.docLang===i?"on":""}">${escapeHtml(S(i==="th"?"dlTh":i==="th_en"?"dlThEn":"dlThZh"))}</button>`).join("");return`<div class="sw-card"><h2>${escapeHtml(S("s5h"))}</h2><div class="sw-sub">${escapeHtml(S("s5sub"))}</div>
        <div class="sw-sectitle">${escapeHtml(S("compliance"))}</div><div class="sw-checks">${n}</div>
        <div class="sw-sectitle" style="margin-top:22px">${escapeHtml(S("output"))}</div>
        <div class="sw-row" style="max-width:580px">
            <div class="sw-field"><label>${escapeHtml(S("paper"))}</label><div class="sw-seg">${s}</div></div>
            <div class="sw-field"><label>${escapeHtml(S("docLangL"))}</label><div class="sw-seg">${o}</div></div></div>
        ${e.paper!=="pos"?`<div class="sw-field" style="max-width:580px;margin-top:4px"><label>${escapeHtml(S("layoutL"))}</label><div class="sw-seg"><button type="button" data-layout="single" class="${e.layout==="single"?"on":""}">${escapeHtml(S("laySingle"))}</button><button type="button" data-layout="pair" class="${e.layout==="pair"?"on":""}">${escapeHtml(S("layPair"))}</button></div></div>`:""}
        <div class="sw-sectitle" style="margin-top:18px">${escapeHtml(S("preview"))}</div>
        <div id="sw-print">${Em(e,S("tear"),ye.info)}</div></div>`}function us(){const e=new Date;return e.getFullYear()+"-"+String(e.getMonth()+1).padStart(2,"0")+"-"+String(e.getDate()).padStart(2,"0")}let _e=0,O;function no(){return{docType:"tax_invoice_receipt",sellerIdx:0,buyer:{type:"company",name:"",addr:"",tin:"",branchType:"hq",branchNo:""},lines:[],hdisc:0,vatRate:7,whtRate:0,pay:{status:"paid",method:"transfer",date:us(),paidAmt:null},issueDate:us(),dueDate:"",be:!1,paper:"a4",docLang:"th_en",layout:"single",draftId:null}}function me(){let e=document.getElementById("sales-wizard-mask");return e||(e=document.createElement("div"),e.id="sales-wizard-mask",e.className="sw-mask",document.body.appendChild(e)),e}function ms(){const e=document.getElementById("sales-wizard-mask");e&&(e.style.display="none",e.innerHTML="")}function re(){const n=Mn().steps.map((s,o)=>{const i=o===_e?"active":o<_e?"done":"",r=o<_e?ye.check:o+1;return`<div class="sw-step ${i}"><div class="sw-num">${r}</div><div class="sw-lbl">${escapeHtml(s)}</div>${o<4?'<div class="sw-bar"></div>':""}</div>`}).join(""),a=[Im,Bm,$m,Sm,Cm][_e](O);me().innerHTML=`<div class="sw-wrap">
        <div class="sw-topbar">
            <div class="sw-brand">${escapeHtml(S("title"))}<small>${escapeHtml(S("sub"))}</small></div>
        ...
        <div class="sw-nav">
            <div class="sw-left">
                <button class="btn btn-ghost" id="sw-back" ${_e===0?"disabled":""}>${escapeHtml(S("back"))}</button>
                <button class="btn btn-ghost" id="sw-draft">${escapeHtml(S("draft"))}</button>
            </div>
            <button class="btn btn-primary" id="sw-next">${escapeHtml(S(_e===4?"issue":"next"))}</button>
        </div>
    </div>`,me().style.display="flex",Tm()}function Ve(e,n,a=!1){const s=document.getElementById(e);s&&(s.oninput=()=>n(s.value),a&&(s.onblur=re))}function Tm(){document.getElementById("sw-close").onclick=ms,document.getElementById("sw-back").onclick=()=>ii(-1),document.getElementById("sw-next").onclick=()=>ii(1),document.getElementById("sw-draft").onclick=Fm,me().querySelectorAll("[data-doc]").forEach(o=>o.onclick=()=>(O.docType=o.dataset.doc,re())),me().querySelectorAll("[data-sc]").forEach(o=>o.onclick=()=>Dm(+o.dataset.sc));const e=document.getElementById("sw-seller");e&&(e.onchange=()=>(O.sellerIdx=+e.value,re())),me().querySelectorAll("[data-bt]").forEach(o=>o.onclick=()=>Hm(o.dataset.bt)),me().querySelectorAll("[data-brt]").forEach(o=>o.onclick=()=>(O.buyer.branchType=o.dataset.brt,o.dataset.brt==="hq"&&(O.buyer.branchNo=""),re())),Ve("sw-bname",o=>O.buyer.name=o),Ve("sw-baddr",o=>O.buyer.addr=o),Ve("sw-btin",o=>(O.buyer.tin=o,O.buyer.verified=!1),!0),Ve("sw-brno",o=>O.buyer.branchNo=o,!0);const n=document.getElementById("sw-rd");n&&(n.onclick=qm),me().querySelectorAll("[data-add]").forEach(o=>o.onclick=()=>Mm(+o.dataset.add)),me().querySelectorAll("[data-q]").forEach(o=>o.onclick=()=>Am(+o.dataset.q,+o.dataset.d)),me().querySelectorAll("[data-rm]").forEach(o=>o.onclick=()=>Pm(+o.dataset.rm)),me().querySelectorAll("[data-ln]").forEach(o=>{const i=+o.dataset.ln,r=o.dataset.f;o.oninput=()=>O.lines[i][r]=o.value,o.onblur=re});const a=document.getElementById("sw-addcustom");a&&(a.onclick=()=>(O.lines.push({desc:"",qty:1,price:0,disc:0,vat:!0,custom:!0}),re())),me().querySelectorAll("[data-save]").forEach(o=>o.onchange=()=>O.lines[+o.dataset.save].save=o.checked),Ve("sw-hdisc",o=>O.hdisc=o,!0),Ve("sw-vat",o=>O.vatRate=o,!0),Ve("sw-wht",o=>O.whtRate=o,!0),me().querySelectorAll("[data-ps]").forEach(o=>o.onclick=()=>(O.pay.status=o.dataset.ps,re()));const s=document.getElementById("sw-pm");s&&(s.onchange=()=>O.pay.method=s.value),Ve("sw-pdate",o=>O.pay.date=o),Ve("sw-paid",o=>O.pay.paidAmt=o),Ve("sw-idate",o=>O.issueDate=o),Ve("sw-ddate",o=>O.dueDate=o),me().querySelectorAll("[data-cal]").forEach(o=>o.onclick=()=>(O.be=o.dataset.cal==="be",re())),me().querySelectorAll("[data-paper]").forEach(o=>o.onclick=()=>(O.paper=o.dataset.paper,re())),me().querySelectorAll("[data-dlang]").forEach(o=>o.onclick=()=>(O.docLang=o.dataset.dlang,re())),me().querySelectorAll("[data-layout]").forEach(o=>o.onclick=()=>(O.layout=o.dataset.layout,re()))}function ii(e){if(e>0&&_e===4)return void Om();const n=_e+e;n<0||n>4||(_e=n,re())}function Hm(e){O.buyer.type!==e&&(O.buyer.type=e,O.buyer.tin="",O.buyer.verified=!1,O.buyer.branchType="hq",O.buyer.branchNo="",re())}function Mm(e){const n=jr()[e];if(!n)return;const a=qr(n),s=O.lines.find(o=>o.product_id===n.id);s?s.qty=(+s.qty||0)+1:O.lines.push({desc:a,qty:1,price:n.unit_price,disc:0,vat:n.vat_applicable,product_id:n.id}),re()}function Am(e,n){O.lines[e].qty=Math.max(0,(+O.lines[e].qty||0)+n),+O.lines[e].qty==0&&O.lines.splice(e,1),re()}function Pm(e){O.lines.splice(e,1),re()}const jm=[["tax_invoice_receipt","individual","paid","cash"],["tax_invoice","company","unpaid","transfer"],["tax_invoice_receipt","individual","paid","transfer"],["tax_invoice_simple","anonymous","paid","cash"]];function Dm(e){const n=jm[e];if(!n)return;const[a,s,o,i]=n;O.docType=a,O.buyer={type:s,name:"",addr:"",tin:"",branchType:"hq",branchNo:""},O.pay={status:o,method:i,date:us(),paidAmt:null},_e=0,re()}async function qm(){const e=O.buyer;if(!e.tin)return showToast(S("rdNeedTin"),"error");if(e.type==="company"){if(!/^\d{13}$/.test(e.tin))return showToast(S("rdCo13"),"error");const n=await pm(e.tin,0);if(!n.found)return showToast(S("lookupFail"),"error");Rm(n)}else{if(!(await dm(e.tin)).valid)return e.verified=!1,re(),showToast(S("verifyFail"),"error");e.verified=!0,re(),showToast(S("verified"),"success")}}function Rm(e){const n=O.buyer;let a=document.getElementById("sw-rd-modal");a||(a=document.createElement("div"),a.id="sw-rd-modal",a.className="modal-mask sx-modal-mask",document.body.appendChild(a));const s=(i,r,l)=>`<div class="form-row"><label>${escapeHtml(i)}</label><input type="text" id="${r}" value="${escapeHtml(l)}"></div>`;a.innerHTML=`<div class="modal" role="dialog" style="max-width:480px">
        <div class="modal-header"><div class="modal-title">${escapeHtml(S("rdModalTitle"))}</div>
            <button class="modal-close" id="sw-rd-x" aria-label="close">✕</button></div>
        <div class="modal-body">
            <div class="sw-sub">${escapeHtml(S("rdModalSub"))}</div>
            ${s(S("name"),"sw-rd-name",e.name||n.name)}
            ${s(S("addr"),"sw-rd-addr",e.address||n.addr)}
        </div>
        <div class="modal-footer" style="justify-content:space-between;gap:8px">
            <button class="btn btn-ghost" id="sw-rd-cancel">${escapeHtml(S("rdCancel"))}</button>
            <button class="btn btn-primary" id="sw-rd-fill">${escapeHtml(S("rdFill"))}</button>
        </div></div>`,a.style.display="flex";const o=()=>{a.style.display="none",a.innerHTML=""};document.getElementById("sw-rd-x").onclick=o,document.getElementById("sw-rd-cancel").onclick=o,a.onclick=i=>{i.target===a&&o()},document.getElementById("sw-rd-fill").onclick=()=>{n.name=document.getElementById("sw-rd-name").value.trim(),n.addr=document.getElementById("sw-rd-addr").value.trim(),n.branchType="hq",n.branchNo="",n.verified=!0,o(),re()}}async function Fm(){if(!O.lines.some(n=>(n.desc||"").trim()))return showToast(S("needLines"),"error");const e=await Dr(O);e.ok?(O.draftId=e.id||O.draftId,showToast(S("draftSaved"),"success"),window.dispatchEvent(new CustomEvent("pearnly:sales-changed"))):showToast(_a(e.error)||S("saveFail"),"error")}const zm={ckBuyer:1,ckTin:1,ckPay:3},Nm={buyer_incomplete:{descKey:"ckBuyerD",step:1},buyer_branch_required:{descKey:"ckBuyerD",step:1},buyer_branch_no_invalid:{descKey:"ckBuyerD",step:1},buyer_tax_id_invalid:{descKey:"ckTinD",step:1},payment_required:{descKey:"ckPayD",step:3}};function Ua(e){e!==_e&&(_e=e,re())}async function Om(){if(!O.lines.some(o=>(o.desc||"").trim()))return Ua(2),showToast(S("needLines"),"error");const e=Mr(O).filter(o=>o.req&&!o.pass);if(e.length){Ua(zm[e[0].key]??_e);const o=e.map(i=>S(i.descKey)).join(" · ");return showToast(S("blockers")+" "+o,"error")}const n=await vm(O);if(n.ok&&n.id){Vm(n.id),window.dispatchEvent(new CustomEvent("pearnly:sales-changed"));return}const a=(n.error||"").replace(/^sales\./,""),s=Nm[a];s?(Ua(s.step),showToast(S("blockers")+" "+S(s.descKey),"error")):showToast(_a(n.error)||S("issueFail"),"error")}function Vm(e){me().innerHTML=`<div class="sw-okwrap"><div class="sw-okbox">
        ...
        </div></div></div>`,me().style.display="flex",document.getElementById("sw-ok-done").onclick=ms,document.getElementById("sw-ok-new").onclick=()=>{O=no(),_e=0,re()},document.getElementById("sw-ok-view").onclick=()=>{ms(),window.openSalesDetail&&window.openSalesDetail(e)},document.getElementById("sw-ok-dl").onclick=()=>void In(e,!1),document.getElementById("sw-ok-print").onclick=()=>void In(e,!0)}function Um(){return typeof currentLang<"u"&&currentLang||localStorage.getItem("mrpilot_lang")||"th"}async function Rr(){ym(Um()),me().innerHTML=`<div class="sw-wrap"><div class="sw-card"><div class="sx-state">${escapeHtml(S("s1h"))}…</div></div></div>`,me().style.display="flex",await lm()}window.openSalesWizard=async function(){O=no(),_e=0,await Rr(),re()};window.editSalesDraft=async function(e){await Rr(),O=cm(no(),e),_e=0,re()};const Gm=`
    <div class="cmdk">
...
`;Ce("cmdk-mask",Gm);(function(){function e(c){try{if(location.search.indexOf("test_center=1")>=0||localStorage.getItem("pearnly_test_mode")==="1"||c&&c.id&&String(c.id)==="468b50c1-5593-4fd6-990d-515ce8085563")return!0}catch{}return!1}window.applyRoleVisibility=function(){var u=window._userInfo,v=!1,f=!0,y=!1,b=!1;u&&(v=typeof canManageTeam=="function"?canManageTeam(u):!!(u.role==="owner"||u.is_super_admin),f=typeof shouldHideMoney=="function"?shouldHideMoney(u):u.role==="member"&&!u.is_super_admin,y=typeof isSuperAdmin=="function"?isSuperAdmin(u):!!u.is_super_admin,b=e(u)),document.querySelectorAll("[data-show-if-team]").forEach(function(g){g.style.display=v?"":"none"}),document.querySelectorAll("[data-show-if-money]").forEach(function(g){g.style.display=f?"none":""}),document.querySelectorAll("[data-show-if-admin]").forEach(function(g){g.style.display=y?"":"none"}),document.querySelectorAll("[data-show-if-test]").forEach(function(g){g.style.display=b?"":"none"});var h=y||b;document.querySelectorAll("[data-show-if-special]").forEach(function(g){g.style.display=h?"":"none"})},window.renderAvatarMenu=function(u){if(u){var v=document.getElementById("avatar-btn"),f=document.getElementById("avatar-popup-name"),y=document.getElementById("avatar-popup-email");if(!(!v||!f||!y)){var b=(u.username||"").trim(),h=b.split("@")[0]||b||"—",g=(b.charAt(0)||"?").toUpperCase(),_=(u.avatar_url||"").trim();if(_){var w=_.replace(/"/g,"&quot;"),k=g.replace(/'/g,"\\'");v.innerHTML='<img src="'+w+'" alt="'+g+`" referrerpolicy="no-referrer" onerror="this.parentNode.textContent='`+k+`'">`}else v.textContent=g;f.textContent=h,y.textContent=b||"—",v.setAttribute("title",b||"")}}};function n(){var c=document.getElementById("avatar-wrap"),u=document.getElementById("avatar-btn"),v=document.getElementById("avatar-popup");if(!c||!u||!v)return;function f(){v.classList.remove("show"),u.setAttribute("aria-expanded","false")}function y(){v.classList.add("show"),u.setAttribute("aria-expanded","true")}u.addEventListener("click",function(b){b.stopPropagation(),v.classList.contains("show")?f():y()}),document.addEventListener("click",function(b){v.classList.contains("show")&&!c.contains(b.target)&&f()}),v.addEventListener("click",function(b){var h=b.target.closest(".avatar-popup-item");if(h){var g=h.dataset.action;switch(f(),g){case"settings":typeof openSettingsModal=="function"?openSettingsModal():typeof routeTo=="function"&&routeTo("settings");break;case"team":typeof openSettingsModal=="function"?openSettingsModal():typeof routeTo=="function"&&routeTo("settings"),setTimeout(function(){typeof switchSettingsTab=="function"&&switchSettingsTab("team")},50);break;case"billing":typeof openSettingsModal=="function"?openSettingsModal():typeof routeTo=="function"&&routeTo("settings"),setTimeout(function(){typeof switchSettingsTab=="function"&&switchSettingsTab("plan")},50);break;case"shortcuts":if(typeof showToast=="function"){var _=typeof t=="function"?t("feature-coming-soon"):"即将上线";showToast(_||"即将上线","info")}break;case"admin":window.location.href="/admin/cost";break;case"test-center":typeof routeTo=="function"&&routeTo("test-center");break;case"help":var w=document.getElementById("help-modal");w&&(w.style.display="flex");break;case"logout":try{localStorage.removeItem("mrpilot_token")}catch{}try{localStorage.removeItem("mrpilot_user")}catch{}window.location.href="/";break}}}),window._closeAvatarPopup=f}function a(){return[].slice.call(document.querySelectorAll(".cmdk-item")).filter(function(c){return c.style.display!=="none"})}function s(c){var u=a();u.forEach(function(v){v.classList.remove("focus")}),u[c]&&(u[c].classList.add("focus"),u[c].scrollIntoView({block:"nearest"}))}function o(c){var u=a();if(u.length){var v=u.findIndex(function(y){return y.classList.contains("focus")});v<0&&(v=0);var f=(v+c+u.length)%u.length;s(f)}}function i(c){c=(c||"").toLowerCase().trim();var u=0,v=window._userInfo,f=typeof isSuperAdmin=="function"?isSuperAdmin(v):!!(v&&v.is_super_admin),y=e(v);document.querySelectorAll(".cmdk-item").forEach(function(h){if(h.dataset.showIfAdmin==="1"&&!f){h.style.display="none";return}if(h.dataset.showIfTest==="1"&&!y){h.style.display="none";return}var g=(h.dataset.cmdkText||h.textContent||"").toLowerCase(),_=!c||g.indexOf(c)>=0;h.style.display=_?"":"none",h.classList.remove("focus"),_&&u++}),document.querySelectorAll("[data-cmdk-section]").forEach(function(h){for(var g=h.nextElementSibling,_=!1;g&&!g.hasAttribute("data-cmdk-section");){if(g.classList&&g.classList.contains("cmdk-item")&&g.style.display!=="none"){_=!0;break}g=g.nextElementSibling}h.style.display=_?"":"none"});var b=document.getElementById("cmdk-empty");b&&(b.style.display=u===0?"flex":"none"),s(0)}window.openCmdk=function(){var u=document.getElementById("cmdk-mask");u&&(typeof window._closeAvatarPopup=="function"&&window._closeAvatarPopup(),u.classList.add("show"),typeof window.applyRoleVisibility=="function"&&window.applyRoleVisibility(),setTimeout(function(){var v=document.getElementById("cmdk-input");v&&(v.value="",i(""),v.focus(),s(0))},50))},window.closeCmdk=function(){var u=document.getElementById("cmdk-mask");u&&u.classList.remove("show")};function r(c){if(c){if(c.classList.contains("cmdk-item-locked")){if(typeof showToast=="function"){var u=typeof t=="function"?t("feature-coming-soon"):"即将上线";showToast(u||"即将上线","info")}return}var v=c.dataset.cmdkRoute,f=c.dataset.cmdkAction;if(window.closeCmdk(),v){typeof routeTo=="function"&&routeTo(v);return}if(f){if(f==="open-admin"){window.location.href="/admin/cost";return}if(f.indexOf("lang-")===0){var y=f.slice(5);typeof applyLang=="function"&&applyLang(y)}}}}function l(){var c=document.getElementById("cmdk-mask"),u=document.getElementById("cmdk-input"),v=document.getElementById("cmdk-body");if(!(!c||!u||!v)){c.addEventListener("click",function(b){b.target===c&&window.closeCmdk()});var f=document.getElementById("cmdk-esc-btn");f&&f.addEventListener("click",function(){window.closeCmdk()}),u.addEventListener("input",function(b){i(b.target.value)}),u.addEventListener("keydown",function(b){b.key==="ArrowDown"?(b.preventDefault(),o(1)):b.key==="ArrowUp"?(b.preventDefault(),o(-1)):b.key==="Enter"?(b.preventDefault(),r(c.querySelector(".cmdk-item.focus"))):b.key==="Escape"&&(b.preventDefault(),window.closeCmdk())}),v.addEventListener("click",function(b){var h=b.target.closest(".cmdk-item");h&&r(h)}),v.addEventListener("mousemove",function(b){var h=b.target.closest(".cmdk-item");!h||h.style.display==="none"||h.classList.contains("cmdk-item-locked")||(a().forEach(function(g){g.classList.remove("focus")}),h.classList.add("focus"))});var y=document.getElementById("topbar-search");y&&(y.addEventListener("click",function(){window.openCmdk()}),y.addEventListener("keydown",function(b){(b.key==="Enter"||b.key===" ")&&(b.preventDefault(),window.openCmdk())}))}}document.addEventListener("keydown",function(c){if((c.metaKey||c.ctrlKey)&&(c.key==="k"||c.key==="K")){c.preventDefault(),window.openCmdk();return}if(c.key==="Escape"){var u=document.getElementById("cmdk-mask");if(u&&u.classList.contains("show")){window.closeCmdk();return}var v=document.getElementById("avatar-popup");v&&v.classList.contains("show")&&typeof window._closeAvatarPopup=="function"&&window._closeAvatarPopup()}});try{var m=(navigator.userAgent||"").toLowerCase(),d=m.indexOf("mac")>=0||m.indexOf("iphone")>=0||m.indexOf("ipad")>=0;d||document.body.classList.add("is-windows")}catch{}function p(){n(),l(),typeof window.subscribeI18n=="function"&&window.subscribeI18n("nav-ia-phase1-role",function(){try{typeof window.applyRoleVisibility=="function"&&window.applyRoleVisibility()}catch{}})}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",p):p()})();(function(){function n(f){return String(f??"").replace(/[&<>"']/g,function(y){return{"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"}[y]})}function a(f){if(!f||isNaN(f))return"";var y=Number(f);return y<1024?y+" B":y<1024*1024?(y/1024).toFixed(1)+" KB":(y/1024/1024).toFixed(1)+" MB"}document.addEventListener("click",function(f){var y=f.target.closest&&f.target.closest(".recon-collapse-head");if(y&&!(f.target.closest("button")||f.target.closest("a"))){var b=y.closest(".recon-collapse");if(b){var h=b.getAttribute("data-collapsed")==="true";b.setAttribute("data-collapsed",h?"false":"true"),h&&(b.id==="vex-summary-collapse"&&p(),b.id==="vex-detail-collapse"&&c())}}}),document.addEventListener("keydown",function(f){if(!(f.key!=="Enter"&&f.key!==" ")){var y=f.target.closest&&f.target.closest(".recon-collapse-head");y&&(f.preventDefault(),y.click())}});var s={vat:"",gl:""};window._glvClearPreviewSearch=function(){s.vat="",s.gl=""};var o='<svg class="vex-pp-fi-icon" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#111111" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/></svg>',i='<svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg>';function r(){m("vat"),m("gl")}function l(f){try{if(typeof window._glvPreviewFiles=="function")return window._glvPreviewFiles(f)||[]}catch{}var y=document.getElementById(f==="vat"?"glv-vat-input":"glv-gl-input");return y&&y.files?Array.from(y.files):[]}function m(f){var y=document.getElementById(f==="vat"?"glv-pp-vat-col":"glv-pp-gl-col");if(y){var b=l(f),h=f==="vat"?"glv-up-vat-title":"glv-up-gl-title",g=f==="vat"?"① 销项税报告":"② 总账 GL",_=window.t&&window.t(h)||g,w=n(window.t&&window.t("vex-preview-search")||"搜索文件名..."),k=n(window.t&&window.t("vex-preview-clear-all")||"全清"),x=s[f]||"",E=b.length;y.innerHTML='<div class="vex-pp-col-title"><span class="vex-pp-col-name">'+n(_)+' <span class="vex-pp-col-count">'+E+'</span></span></div><div class="vex-pp-search-row"><input class="vex-pp-search" id="glv-pp-search-'+f+'" type="text" placeholder="'+w+'" value="'+n(x)+'" autocomplete="off"><button class="vex-pp-clear-btn" id="glv-pp-clearall-'+f+'" type="button">'+k+'</button></div><div class="vex-pp-file-list" id="glv-pp-'+f+'-list"></div><div class="vex-pp-pagination" id="glv-pp-'+f+'-pg"></div>';var I=document.getElementById("glv-pp-search-"+f);I&&I.addEventListener("input",function(L){s[f]=L.target.value,d(f)});var B=document.getElementById("glv-pp-clearall-"+f);B&&B.addEventListener("click",function(){window._glvRemoveFile&&window._glvRemoveFile(f)}),d(f)}}function d(f){var y=document.getElementById("glv-pp-"+f+"-list"),b=document.getElementById("glv-pp-"+f+"-pg");if(y){var h=l(f),g=(s[f]||"").toLowerCase(),_=h.map(function(x,E){return{f:x,i:E}}),w=g?_.filter(function(x){return x.f.name.toLowerCase().indexOf(g)>=0}):_;if(y.innerHTML=w.map(function(x){var E=x.f;return'<div class="vex-pp-file-row">'+o+'<span class="vex-pp-fi-name" title="'+n(E.name)+'">'+n(E.name)+'</span><span class="vex-pp-fi-size">'+a(E.size)+'</span><button class="vex-pp-fi-del" type="button" data-kind="'+f+'" data-idx="'+x.i+'" aria-label="remove">'+i+"</button></div>"}).join(""),y.querySelectorAll(".vex-pp-fi-del").forEach(function(x){x.addEventListener("click",function(){var E=x.dataset.kind,I=parseInt(x.dataset.idx,10);window._glvRemoveFile&&window._glvRemoveFile(E,isNaN(I)?null:I)})}),b){var k=window.t&&window.t("vex-preview-count")||"显示前 {n} / 共 {m}";b.textContent=k.replace("{n}",w.length).replace("{m}",w.length)}}}function p(){var f=function(b,h){var g=document.getElementById(b);g&&(g.textContent=h==null?"—":String(h))},y=window._vexLastTask||{};f("vex-sum-total",y.total),f("vex-sum-matched",y.matched),f("vex-sum-diff",y.diff),f("vex-sum-incomplete",y.incomplete),f("vex-sum-cash",y.cash),document.getElementById("vex-summary-sub")}function c(){var f=window._vexLastTask&&window._vexLastTask.diff_rows||[],y=document.getElementById("vex-detail-tbody"),b=document.getElementById("vex-detail-table"),h=document.getElementById("vex-detail-empty");if(!(!y||!b||!h)){if(f.length===0){b.style.display="none",h.style.display="";return}h.style.display="none",b.style.display="";var g=f.map(function(w){return'<tr><td class="recon-detail-cell-mono">'+n(w.invoice_no||"")+"</td><td>"+n(w.field||"")+"</td><td>"+n(w.report_value||"")+"</td><td>"+n(w.invoice_value||"")+"</td><td>"+n(w.kind||"")+"</td></tr>"}).join("");y.innerHTML=g;var _=document.getElementById("vex-detail-sub");_&&(_.textContent=String(f.length))}}function u(){var f=document.getElementById("glv-toggle-preview");f&&!f._reconBound&&(f._reconBound=!0,f.addEventListener("click",function(){var y=document.getElementById("glv-preview-panel"),b=document.getElementById("glv-toggle-preview-label"),h=y&&y.style.display!=="none";y&&(y.style.display=h?"none":""),f.classList.toggle("open",!h),b&&(b.textContent=h?window.t&&window.t("vex-toggle-preview-open")||"查看清单":window.t&&window.t("vex-toggle-preview-close")||"收起清单"),h||r()})),["glv-vat-input","glv-gl-input"].forEach(function(y){var b=document.getElementById(y);!b||b._reconWatched||(b._reconWatched=!0,b.addEventListener("change",function(){var h=document.getElementById("glv-preview-panel");h&&h.style.display!=="none"&&r()}))})}function v(){var f=document.getElementById("vex-summary-collapse"),y=document.getElementById("vex-detail-collapse");f&&(f.style.display=""),y&&(y.style.display=""),p(),c()}window._fillVexSummary=p,window._fillVexDetail=c,window._onVexResultShown=v,document.addEventListener("DOMContentLoaded",function(){u()}),setTimeout(u,1500),typeof window.subscribeI18n=="function"&&window.subscribeI18n("recon-collapse",function(){var f=document.getElementById("glv-preview-panel");f&&f.style.display!=="none"&&r();var y=document.getElementById("glv-toggle-preview-label"),b=document.getElementById("glv-toggle-preview");y&&b&&(y.textContent=b.classList.contains("open")?window.t&&window.t("vex-toggle-preview-close")||"收起清单":window.t&&window.t("vex-toggle-preview-open")||"查看清单")}),window._reconCollapse={renderGlvPreview:r,fillVexSummary:p,fillVexDetail:c}})();(function(){function e(i){}function n(){const i=document.querySelectorAll("[data-recon-tab]");i.forEach(l=>{l.addEventListener("click",()=>{i.forEach(u=>u.classList.remove("active")),l.classList.add("active");const m=l.dataset.reconTab,d=document.getElementById("recon-pane-bank"),p=document.getElementById("recon-pane-sale-vat"),c=document.getElementById("recon-pane-gl-vat");d&&(d.style.display=m==="bank"?"":"none"),p&&(p.style.display=m==="sale-vat"?"":"none"),c&&(c.style.display=m==="gl-vat"?"":"none"),m==="gl-vat"&&window.GlVatRecon&&window.GlVatRecon.ensureInit(),m==="bank"&&typeof window._bankReconV2Init=="function"&&window._bankReconV2Init()})});const r=document.querySelector("[data-recon-tab].active");r&&(r.dataset.reconTab,void 0)}function a(){const i=document.getElementById("page-settings");if(!i)return null;let r=document.getElementById("settings-modal-overlay");if(r)return r;r=document.createElement("div"),r.id="settings-modal-overlay",r.className="settings-modal-overlay",r.style.display="none",i.parentElement.insertBefore(r,i),r.appendChild(i);const l=document.createElement("button");return l.id="settings-modal-close",l.className="settings-modal-close",l.setAttribute("aria-label","close"),l.innerHTML='<svg viewBox="0 0 20 20" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M5 5l10 10M15 5L5 15"/></svg>',i.insertBefore(l,i.firstChild),l.addEventListener("click",o),r.addEventListener("click",m=>{m.target===r&&o()}),r}function s(){const i=a();if(!i)return;i.style.display="flex",document.body.classList.add("settings-modal-open");const r=document.getElementById("page-settings");r&&(r.style.display="block"),setTimeout(()=>{try{typeof renderSettings=="function"&&renderSettings()}catch(m){console.warn("renderSettings:",m)}let l=document.querySelector(".settings-tab.active")||document.querySelector('.settings-tab[data-tab="profile"]');l&&l.click()},50)}function o(){const i=document.getElementById("settings-modal-overlay");i&&(i.style.display="none"),document.body.classList.remove("settings-modal-open")}window.openSettingsModal=s,window.closeSettingsModal=o,document.addEventListener("keydown",i=>{if(i.key==="Escape"){const r=document.getElementById("settings-modal-overlay");r&&r.style.display==="flex"&&o()}}),window.addEventListener("hashchange",()=>{location.hash==="#/settings"&&s()}),window.addEventListener("DOMContentLoaded",()=>{location.hash==="#/settings"&&s()}),document.readyState==="loading"?document.addEventListener("DOMContentLoaded",n):n()})();const Ga=1e3,Wa=30,ao=/\.(pdf|jpe?g|png|webp|tiff?|xlsx?|xlsm|csv|tsv|docx?)$/i,te=e=>document.getElementById(e);function At(){return{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||"")}}function Ae(e){const n={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"};return String(e??"").replace(/[&<>"']/g,a=>n[a])}function Fr(e){return e<1024?e+" B":e<1024*1024?(e/1024).toFixed(1)+" KB":(e/1024/1024).toFixed(1)+" MB"}const A={invoiceFiles:[],reportFiles:[],running:!1,vexAllRows:[],previewLimitInv:50,previewLimitRep:50,previewSearchInv:"",previewSearchRep:"",vexPage:1};async function Jn(){try{const e=await fetch("/api/vat_excel/tasks?page=1&page_size=1",{headers:At()});if(!e.ok)return;const a=(await e.json()).kpi||{};[["vex-kpi-month-val",a.this_month],["vex-kpi-running-val",a.running],["vex-kpi-done-val",a.done],["vex-kpi-failed-val",a.failed]].forEach(([s,o])=>{const i=document.getElementById(s);i&&(i.textContent=o??0)})}catch{}}async function Xn(){try{const e=await fetch("/api/vat_excel/tasks?page=1&page_size=100",{headers:At()});if(!e.ok)return;const n=await e.json();ca(n.rows||[])}catch{}}const Ot=10;function zr(){var e=((document.getElementById("vex-task-search")||{}).value||"").trim().toLowerCase();if(A.vexPage=1,ca(A.vexAllRows),!!e){var n=document.getElementById("vex-task-tbody");n&&n.querySelectorAll("tr").forEach(function(a){a.dataset.taskId&&(a.style.display=a.textContent.toLowerCase().indexOf(e)>=0?"":"none")})}}function ca(e){A.vexAllRows=e||A.vexAllRows;const n=document.getElementById("vex-task-tbody");if(!n)return;if(!A.vexAllRows.length){n.innerHTML='<tr><td colspan="9" class="vex-task-empty">'+(t("sv-empty-title")||"还没有对账任务")+"</td></tr>",ri(0);return}const a=Math.ceil(A.vexAllRows.length/Ot);A.vexPage>a&&(A.vexPage=a);const s=(A.vexPage-1)*Ot;Wm(A.vexAllRows.slice(s,s+Ot)),ri(A.vexAllRows.length)}function ri(e){const n=document.getElementById("vex-task-pager"),a=document.getElementById("vex-task-pager-info"),s=document.getElementById("vex-task-prev"),o=document.getElementById("vex-task-next");if(!n)return;if(e<=Ot){n.style.display="none";return}n.style.display="";const i=Math.ceil(e/Ot);a&&(a.textContent=A.vexPage+" / "+i),s&&(s.disabled=A.vexPage<=1),o&&(o.disabled=A.vexPage>=i)}function Wm(e){const n=document.getElementById("vex-task-tbody");if(!n)return;const a={pending:t("vex-status-pending")||"待处理",running:t("vex-status-running")||"处理中",done:t("vex-status-done")||"已完成",failed:t("vex-status-failed")||"失败"},s={pending:"badge-gray",running:"badge-blue",done:"badge-green",failed:"badge-red"},o='<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M8 2v9M4 7l4 4 4-4M3 14h10"/></svg>',i='<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M3 4h10M6 4V3h4v1M5 4v8a1 1 0 001 1h4a1 1 0 001-1V4"/></svg>';n.innerHTML=e.map(r=>{const l=r.created_at?new Date(r.created_at).toLocaleString([],{year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",minute:"2-digit"}):"—",m=r.period||"—",d=r.matched_count!=null?r.matched_count+" ✓ · "+r.mismatched_count+" ⚠":"—",p=r.mismatch_amount!=null?"฿ "+Number(r.mismatch_amount).toLocaleString():"—",c=r.elapsed_seconds!=null?r.elapsed_seconds.toFixed(1)+" s":"—",u=r.status||"pending",v=r.client_name&&r.client_name!=="client"?r.client_name:t("vex-client-all")||"全部客户";return`<tr class="vex-task-row" data-task-id="${Ae(r.id)}" style="cursor:pointer">
            ...
            <td><div class="vex-task-actions">
                <button class="vex-task-dl-btn" data-task-id="${Ae(r.id)}" title="${t("hist_export")||"导出"}">${o}</button>
                <button class="vex-task-del-btn" data-task-id="${Ae(r.id)}" title="${t("vex-task-delete-confirm-title")||"删除"}">${i}</button>
            </div></td>
        </tr>`}).join(""),n.querySelectorAll(".vex-task-dl-btn").forEach(r=>{r.addEventListener("click",async l=>{l.stopPropagation();const m=r.dataset.taskId;try{const d=await fetch("/api/vat_excel/tasks/"+encodeURIComponent(m)+"/download",{credentials:"include",headers:At()});if(d.status===410){showToast(t("vex-toast-expired")||"数据已过期 · 请重新对账","warn");return}if(!d.ok){showToast(t("vex-toast-dl-fail")||"下载失败 · 请重试","error");return}const p=await d.blob(),u=(d.headers.get("Content-Disposition")||"").match(/filename\*?=(?:UTF-8''|")?([^";]+)/i),v=u?decodeURIComponent(u[1]):"vat_recon_"+m+".xlsx",f=URL.createObjectURL(p),y=document.createElement("a");y.href=f,y.download=v,y.click(),setTimeout(()=>URL.revokeObjectURL(f),1e3)}catch{showToast(t("vex-toast-dl-fail")||"下载失败 · 请重试","error")}})}),n.querySelectorAll(".vex-task-del-btn").forEach(r=>{r.addEventListener("click",l=>{l.stopPropagation(),Ym(r.dataset.taskId)})}),zr()}function Km(){var e=document.getElementById("vex-task-prev"),n=document.getElementById("vex-task-next");e&&!e._vexBound&&(e._vexBound=!0,e.addEventListener("click",function(){A.vexPage>1&&(A.vexPage--,ca())})),n&&!n._vexBound&&(n._vexBound=!0,n.addEventListener("click",function(){var a=Math.ceil(A.vexAllRows.length/Ot);A.vexPage<a&&(A.vexPage++,ca())}))}async function Ym(e){const n=t("vex-task-delete-confirm-title")||"删除对账任务?",a=t("vex-task-delete-confirm-body")||"同时清掉对应的发票识别缓存 · 不可恢复";if(await showConfirm(a,{title:n,danger:!0,okText:t("vex-task-delete-confirm-title")||"确认删除"}))try{const o=await fetch("/api/vat_excel/tasks/"+encodeURIComponent(e),{method:"DELETE",credentials:"include",headers:At()});if(!o.ok)throw new Error(o.status);showToast(t("vex-task-delete-ok")||"已删除","success"),Xn(),Jn()}catch{showToast(t("vex-task-delete-fail")||"删除失败","error")}}function Nr(e){const n=window._currentLang||"th",a={zh:`已忽略 ${e} 个不支持的文件 · 仅支持 PDF / 图片 / Excel / CSV / Word`,th:`ข้ามไฟล์ที่ไม่รองรับ ${e} ไฟล์ · รองรับเฉพาะ PDF / รูปภาพ / Excel / CSV / Word`,en:`Ignored ${e} unsupported file(s) · only PDF / image / Excel / CSV / Word are supported`,ja:`非対応ファイル ${e} 件をスキップ · 対応形式は PDF / 画像 / Excel / CSV / Word のみ`};showToast(a[n]||a.th,"warn")}function Jm(e){const n=new Set(A.invoiceFiles.map(s=>s.name+"|"+s.size));let a=0;for(const s of e){if(!ao.test(s.name)){a++;continue}const o=s.name+"|"+s.size;if(!n.has(o)&&(n.add(o),A.invoiceFiles.push(s),A.invoiceFiles.length>=Ga))break}a>0&&Nr(a),A.invoiceFiles.length>Ga&&(A.invoiceFiles=A.invoiceFiles.slice(0,Ga),showToast(t("vex-toast-cap-inv"),"warn")),wt()}function Xm(e){const n=new Set(A.reportFiles.map(s=>s.name+"|"+s.size));let a=0;for(const s of e){if(!ao.test(s.name)){a++;continue}const o=s.name+"|"+s.size;if(!n.has(o)&&(n.add(o),A.reportFiles.push(s),A.reportFiles.length>=Wa))break}a>0&&Nr(a),A.reportFiles.length>Wa&&(A.reportFiles=A.reportFiles.slice(0,Wa),showToast(t("vex-toast-cap-rep"),"warn")),wt()}function Or(e){A.invoiceFiles.splice(e,1),wt()}function Vr(e){A.reportFiles.splice(e,1),wt()}function wt(){const e=te("vex-list-invoice"),n=te("vex-list-report"),a=te("vex-count-invoice"),s=te("vex-count-report");a&&(a.textContent=A.invoiceFiles.length),s&&(s.textContent=A.reportFiles.length);const o=(l,m,d)=>`<div class="vex-fi">
        ...
        <table style="width:100%;border-collapse:collapse;font-size:12px;margin-bottom:4px">
            ...
            <tbody>
                ${l.map(u=>`<tr>
                    ...
                    <td style="padding:5px 8px;border:1px solid #e5e7eb;max-width:220px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap" title="${ue(u.file||"")}">${ue(u.file||"")}</td>
                    <td style="padding:5px 8px;border:1px solid #e5e7eb;text-align:center">${u.rows||0}</td>
                    <td style="padding:5px 8px;border:1px solid #e5e7eb;color:var(--ink-2)">${ue(u._extra||"")}</td>
                    <td style="padding:5px 8px;border:1px solid #e5e7eb">${c(u)}</td>
                </tr>`).join("")}
            </tbody>
        </table>`,n.style.display=""}async function Jr(e){const n=localStorage.getItem("mrpilot_token")||"",a=window._currentLang||"zh";try{const s=await fetch("/api/recon/bank-v2/"+e+"/export?lang="+a,{headers:{Authorization:"Bearer "+n}});if(!s.ok){const p=await s.json().catch(()=>({}));window.showToast&&window.showToast(p.detail||"Export failed","error");return}const o=await s.blob(),r=(s.headers.get("content-disposition")||"").match(/filename[^;=\n]*=((['"]).*?\2|[^;\n]*)/),l=r?r[1].replace(/['"]/g,""):"reconciliation.xlsx",m=URL.createObjectURL(o),d=document.createElement("a");d.href=m,d.download=l,document.body.appendChild(d),d.click(),document.body.removeChild(d),URL.revokeObjectURL(m)}catch(s){window.showToast&&window.showToast("Export error: "+s.message,"error")}}function Dv(e,n){const a=P("brv2-summary-collapse");let s=P("brv2-warnings");const o=window._currentLang||"zh",i={zh:"⏭ 已跳过无法识别的文件:",th:"⏭ ข้ามไฟล์ที่อ่านไม่ได้:",en:"⏭ Skipped unreadable file:",ja:"⏭ 読み取れないファイルをスキップ:"}[o]||"⏭ ",r=[];if((n||[]).forEach(l=>r.push(i+" "+l)),(e||[]).forEach(l=>r.push(l)),!r.length){s&&(s.style.display="none");return}if(!s)if(s=document.createElement("div"),s.id="brv2-warnings",a&&a.parentNode)a.parentNode.insertBefore(s,a);else return;s.style.cssText="display:block;margin:10px 0;padding:10px 14px;background:#FEF3C7;border:1px solid #FCD34D;border-radius:8px;color:#92400E;font-size:13px;line-height:1.6",s.innerHTML=r.map(l=>"<div>"+ue(l)+"</div>").join("")}function ro(e){jv(e),Dv(e.warnings||[],e.skipped_files||[]),!e.ok&&e.error&&window.showToast&&window.showToast(e.error,"error");const n=e.stats||{},a=e.summary||{},s=n.matched||0,o=(n.gl_debit_only||0)+(n.gl_credit_only||0),i=(n.stmt_withdrawal_only||0)+(n.stmt_deposit_only||0),r=Number(a.formula_diff||0),l=Math.abs(r)<.05;P("brv2-kpi-matched")&&(P("brv2-kpi-matched").textContent=s),P("brv2-kpi-diff")&&(P("brv2-kpi-diff").textContent=vt(r)),P("brv2-kpi-unmatched")&&(P("brv2-kpi-unmatched").textContent=o+i);const m=P("brv2-kpi-diff-icon");m&&(m.style.background=l?"#d1fae5":"#fee2e2",m.style.color=l?"#065f46":"#b91c1c");const d=P("brv2-formula-sub");if(d){const f=window._currentLang||"zh";d.textContent=l?{zh:"✓ 平衡",th:"✓ สมดุล",en:"✓ Balanced",ja:"✓ 一致"}[f]||"✓ 平衡":({zh:"差 ",th:"ต่าง ",en:"Diff ",ja:"差 "}[f]||"差 ")+vt(r)}const p=P("brv2-detail-sub");if(p){const f=window._currentLang||"zh",y={zh:"共 {n} 行",th:"ทั้งหมด {n} แถว",en:"{n} rows",ja:"計 {n} 行"}[f]||"共 {n} 行";p.textContent=y.replace("{n}",j.allRows.length)}function c(f,y,b){const h=P(f);h&&(h.textContent=(b&&y>0?"(":"")+vt(b?-y:y)+(b&&y>0?")":""))}c("brf-gl-close",a.gl_closing||0),c("brf-open-diff",a.opening_diff||0),c("brf-gl-debit-only",a.gl_debit_only_amount||0,!0),c("brf-gl-credit-only",a.gl_credit_only_amount||0),c("brf-stmt-wd-only",a.stmt_withdrawal_only_amount||0,!0),c("brf-stmt-dep-only",a.stmt_deposit_only_amount||0),c("brf-calc-close",a.formula_stmt_closing||0),c("brf-stmt-close",a.stmt_closing||0),P("brf-diff")&&(P("brf-diff").textContent=vt(r));const u=P("brv2-fcell-diff");u&&u.classList.toggle("brv2-fcell-diff-ok",l);const v=P("brv2-export-btn");v&&(v.onclick=()=>{j.currentTask&&Jr(j.currentTask.task_id)}),Pv(a),pa(!0),Xr()}function Xr(){const e=P("brv2-tbody");if(!e)return;const n=j.allRows.filter(i=>j.currentFilter==="all"?!0:j.currentFilter==="matched"?i.match_status==="matched":j.currentFilter==="gl_only"?i.match_status.startsWith("gl_"):j.currentFilter==="stmt_only"?i.match_status.startsWith("stmt_"):!0);if(n.length===0){const i={zh:"无记录",th:"ไม่มีรายการ",en:"No rows",ja:"行なし"}[window._currentLang||"zh"]||"无记录";e.innerHTML=`<tr><td colspan="10" style="text-align:center;padding:20px;color:var(--ink-3)">${i}</td></tr>`;return}const a=window._currentLang||"zh",s={zh:"OCR 余额验证未通过 · 上一行余额 ± 金额 ≠ 本行余额，请核对原 PDF",th:"การตรวจสอบยอดคงเหลือไม่ผ่าน · ยอดก่อนหน้า ± จำนวน ≠ ยอดบรรทัดนี้ โปรดตรวจสอบ PDF ต้นฉบับ",en:"Balance check FAILED · prev_balance ± amount ≠ this row balance — verify against the original PDF",ja:"残高検証エラー · 前残高 ± 金額 ≠ この行残高 — 元のPDFと照合してください"}[a],o={zh:"OCR 低置信度 · 数字模糊或难以辨认，请核对原 PDF",th:"OCR ความมั่นใจต่ำ · ตัวเลขเบลอหรืออ่านยาก โปรดตรวจสอบ PDF ต้นฉบับ",en:"OCR low confidence · digit was blurry or hard to read — verify against the original PDF",ja:"OCR信頼度低 · 数字がぼやけている — 元のPDFと照合してください"}[a];e.innerHTML=n.map(i=>{const r=i.match_status,l=i.match_layer;let m="",d="";r==="matched"?(l===1&&(m="matched",d='<span class="brv2-status-badge brv2-badge-matched">L1 ✓</span>'),l===2&&(m="matched-l2",d='<span class="brv2-status-badge brv2-badge-matched-l2">L2 ~</span>'),l===3&&(m="matched-l3",d='<span class="brv2-status-badge brv2-badge-matched-l3">L3 ?</span>')):r==="gl_debit_only"||r==="gl_credit_only"?(m="gl-only",d='<span class="brv2-status-badge brv2-badge-gl-only">GL</span>'):(m="stmt-only",d=`<span class="brv2-status-badge brv2-badge-stmt-only">${{zh:"账单",th:"บัญชี",en:"Stmt",ja:"明細"}[a]||"账单"}</span>`);let p="";return i.stmt_balance_ok===!1&&(p+=`<span class="brv2-ocr-warn brv2-ocr-warn-bal" title="${ue(s)}">⚠</span>`,m+=" brv2-row-warn"),i.stmt_confidence==="low"&&(p+=`<span class="brv2-ocr-warn brv2-ocr-warn-conf" title="${ue(o)}">◌</span>`,m.includes("brv2-row-warn")||(m+=" brv2-row-warn-soft")),`<tr class="${m.trim()}">
          <td>${d}${p}</td>
          <td>${ue(ui(i.stmt_date))}</td>
          <td title="${ue(i.stmt_desc)}" style="max-width:180px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap">${ue(i.stmt_desc)}</td>
          <td class="num">${i.stmt_withdrawal?vt(i.stmt_withdrawal):""}</td>
          <td class="num">${i.stmt_deposit?vt(i.stmt_deposit):""}</td>
          <td>${ue(ui(i.gl_date))}</td>
          <td title="${ue(i.gl_doc_no)}" style="max-width:120px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap">${ue(i.gl_doc_no)}</td>
          <td class="num">${i.gl_debit?vt(i.gl_debit):""}</td>
          <td class="num">${i.gl_credit?vt(i.gl_credit):""}</td>
          <td>${l?"L"+l:"—"}</td>
        </tr>`}).join("")}async function wn(){const e=localStorage.getItem("mrpilot_token")||"";try{const a=await(await fetch("/api/recon/bank-v2/tasks",{headers:{Authorization:"Bearer "+e}})).json();ua(a.tasks||[])}catch{const a=P("brv2-history-empty"),s=window._currentLang||"zh",o={zh:"加载失败",th:"โหลดประวัติไม่ได้",en:"Load failed",ja:"読み込み失敗"}[s]||"加载失败";a&&(a.textContent=o,a.style.display="");const i=P("brv2-history-table-wrap");i&&(i.style.display="none")}}const Ut=10;function mi(){const e=P("brv2-history-pager"),n=P("brv2-history-pager-info"),a=P("brv2-history-prev"),s=P("brv2-history-next");if(!e)return;if(j.cachedHistoryTasks.length<=Ut){e.style.display="none";return}e.style.display="";const o=Math.ceil(j.cachedHistoryTasks.length/Ut);n&&(n.textContent=j.brv2Page+" / "+o),a&&(a.disabled=j.brv2Page<=1),s&&(s.disabled=j.brv2Page>=o)}function qv(){const e=P("brv2-history-prev"),n=P("brv2-history-next");e&&!e._brv2Bound&&(e._brv2Bound=!0,e.addEventListener("click",()=>{j.brv2Page>1&&(j.brv2Page--,ua(j.cachedHistoryTasks))})),n&&!n._brv2Bound&&(n._brv2Bound=!0,n.addEventListener("click",()=>{const a=Math.ceil(j.cachedHistoryTasks.length/Ut);j.brv2Page<a&&(j.brv2Page++,ua(j.cachedHistoryTasks))}))}function ua(e){e!==void 0&&(j.cachedHistoryTasks=e||[],j.brv2Page=1);const n=j.cachedHistoryTasks,a=P("brv2-history-empty"),s=P("brv2-history-table-wrap"),o=P("brv2-history-tbody");if(!o)return;const i=window._currentLang||"zh";if(!n.length){const v={zh:"暂无对账记录",th:"ยังไม่มีประวัติ",en:"No records yet",ja:"記録なし"}[i]||"暂无对账记录";a&&(a.textContent=v,a.style.display=""),s&&(s.style.display="none"),mi();return}a&&(a.style.display="none"),s&&(s.style.display="");const r=Math.ceil(n.length/Ut);j.brv2Page>r&&(j.brv2Page=r);const l=(j.brv2Page-1)*Ut,m=n.slice(l,l+Ut),d=localStorage.getItem("mrpilot_token")||"",p='<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" width="14" height="14"><circle cx="8" cy="8" r="6"/><polyline points="6 8 8 10 10 8"/><line x1="8" y1="4" x2="8" y2="10"/></svg>',c='<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" width="14" height="14"><path d="M8 2v9M4 7l4 4 4-4M3 14h10"/></svg>',u='<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" width="14" height="14"><polyline points="3 4 13 4"/><path d="M6 4V2.5a.5.5 0 0 1 .5-.5h3a.5.5 0 0 1 .5.5V4"/><path d="M5 4l1 9a1 1 0 0 0 1 1h2a1 1 0 0 0 1-1l1-9"/></svg>';o.innerHTML="",m.forEach(v=>{const f=Number(v.formula_diff||0),y=Math.abs(f)<.05,b=(v.stmt_files||"").split(";").map(de=>de.trim().split(/[/\\]/).pop()).filter(Boolean).join(", "),h=(v.gl_files||"").split(";").map(de=>de.trim().split(/[/\\]/).pop()).filter(Boolean).join(", "),g=v.created_at?String(v.created_at).slice(0,16).replace("T"," "):"",_=document.createElement("tr");_.dataset.taskId=v.id;const w=document.createElement("td");w.textContent=g;const k=document.createElement("td");k.className="glv-history-file",k.title=b+" + "+h,k.textContent=b+" + "+h;const x=document.createElement("td");x.className="glv-num",x.textContent=(v.stmt_row_count||0)+" / "+(v.gl_row_count||0);const E=document.createElement("td");E.className="glv-num",E.textContent=v.matched_count||0;const I=document.createElement("td");I.className="glv-num",I.textContent=v.unmatched_gl||0;const B=document.createElement("td");B.className="glv-num",B.textContent=v.unmatched_stmt||0;const L=document.createElement("td");L.className="glv-num",L.style.color=y?"#059669":"#dc2626",L.textContent=y?"✓":vt(f);const $=document.createElement("td");$.className="glv-history-actions";const C=(de,Ie,we,V)=>{const N=document.createElement("button");return N.type="button",N.title=Ie,N.setAttribute("aria-label",Ie),we&&(N.className=we),N.innerHTML=de,N.onclick=Y=>{Y.stopPropagation(),V()},N},H={zh:"删除这条记录?",th:"ลบรายการนี้?",en:"Delete this record?",ja:"この記録を削除しますか?"}[i]||"删除?",R={zh:"加载",th:"โหลด",en:"Load",ja:"読込"}[i]||"加载",G={zh:"导出",th:"ส่งออก",en:"Export",ja:"エクスポート"}[i]||"导出",se={zh:"删除",th:"ลบ",en:"Delete",ja:"削除"}[i]||"删除";$.appendChild(C(p,R,"",()=>vi(v.id,d))),$.appendChild(C(c,G,"",()=>Jr(v.id))),$.appendChild(C(u,se,"glv-del",async()=>{await showConfirm(H,{danger:!0})&&(await fetch("/api/recon/bank-v2/"+v.id,{method:"DELETE",headers:{Authorization:"Bearer "+d}}),wn())})),[w,k,x,E,I,B,L,$].forEach(de=>_.appendChild(de)),_.style.cursor="pointer",_.addEventListener("click",async de=>{de.target.closest(".glv-del")||de.target.closest("button")||await vi(v.id,d)}),o.appendChild(_)}),mi(),Zr()}function Zr(){const e=((P("brv2-hist-search")||{}).value||"").trim().toLowerCase(),n=P("brv2-history-tbody");n&&n.querySelectorAll("tr").forEach(a=>{a.dataset.taskId&&(a.style.display=!e||a.textContent.toLowerCase().includes(e)?"":"none")})}async function vi(e,n){try{const s=await(await fetch("/api/recon/bank-v2/"+e,{headers:{Authorization:"Bearer "+n}})).json();if(!s.ok)return;j.currentTask={task_id:s.task_id,...s},j.allRows=s.detail||[],j.currentFilter="all",document.querySelectorAll(".brv2-filter-btn").forEach(o=>o.classList.toggle("active",o.dataset.filter==="all")),ro(j.currentTask)}catch{}}function Ze(e){const n=e==="stmt"?j.stmtFiles:j.glFiles,a=P(`brv2-${e}-name`);if(a)if(n.length===0)a.textContent="";else{const o=window._currentLang||"zh",i={zh:"个文件",th:" ไฟล์",en:" file(s)",ja:" ファイル"};a.textContent=n.length+(i[o]||" 个文件")}const s=P("brv2-preview-panel");s&&s.style.display!=="none"&&hs(e),Rv()}function Rv(){const e=P("brv2-toggle-preview"),n=P("brv2-preview-panel"),a=j.stmtFiles.length+j.glFiles.length>0;e&&(e.style.display=a?"":"none"),!a&&n&&(n.style.display="none",e&&e.classList.remove("open"))}function Fv(){hs("stmt"),hs("gl")}function hs(e){const n=P(e==="stmt"?"brv2-pp-stmt-col":"brv2-pp-gl-col");if(!n)return;const a=e==="stmt"?j.stmtFiles:j.glFiles,s=window._currentLang||"zh",o={stmt:{zh:"① 银行账单",th:"① บัญชีธนาคาร",en:"① Bank Stmt",ja:"① 銀行明細"},gl:{zh:"② 总账 GL",th:"② GL รายงาน",en:"② GL Report",ja:"② GL帳簿"}},i=(o[e]||{})[s]||o[e].zh,r=ue(window.t&&window.t("vex-preview-search")||"搜索文件名..."),l=ue(window.t&&window.t("vex-preview-clear-all")||"全清"),m=j.brv2Search[e]||"";n.innerHTML='<div class="vex-pp-col-title"><span class="vex-pp-col-name">'+ue(i)+' <span class="vex-pp-col-count">'+a.length+'</span></span></div><div class="vex-pp-search-row"><input class="vex-pp-search" id="brv2-pp-search-'+e+'" type="text" placeholder="'+r+'" value="'+ue(m)+'" autocomplete="off"><button class="vex-pp-clear-btn" id="brv2-pp-clearall-'+e+'" type="button">'+l+'</button></div><div class="vex-pp-file-list" id="brv2-pp-'+e+'-list"></div><div class="vex-pp-pagination" id="brv2-pp-'+e+'-pg"></div>';const d=P("brv2-pp-search-"+e);d&&d.addEventListener("input",function(c){j.brv2Search[e]=c.target.value,fi(e)});const p=P("brv2-pp-clearall-"+e);p&&p.addEventListener("click",function(){e==="stmt"?j.stmtFiles.length=0:j.glFiles.length=0,Ze(e),ft()}),fi(e)}function fi(e){const n=P("brv2-pp-"+e+"-list"),a=P("brv2-pp-"+e+"-pg");if(!n)return;const s=e==="stmt"?j.stmtFiles:j.glFiles,o=(j.brv2Search[e]||"").toLowerCase(),i=o?s.filter(m=>m.name.toLowerCase().includes(o)):s.slice(),r='<svg class="vex-pp-fi-ico" viewBox="0 0 14 16" fill="none" stroke="currentColor" stroke-width="1.4" width="12" height="14"><path d="M3 1h6l3 3v11H3V1z"/><path d="M9 1v3h3"/></svg>',l='<svg viewBox="0 0 14 14" fill="none" stroke="currentColor" stroke-width="1.6" width="11" height="11"><path d="M2 4h10M5 4V2h4v2M5.5 7v4M8.5 7v4M3 4l1 8h6l1-8"/></svg>';if(n.innerHTML=i.map((m,d)=>'<div class="vex-pp-file-row">'+r+'<span class="vex-pp-fi-name" title="'+ue(m.name)+'">'+ue(m.name)+'</span><span class="vex-pp-fi-size">'+Sv(m.size)+'</span><button class="vex-pp-fi-del" type="button" data-zone="'+e+'" data-idx="'+s.indexOf(m)+'" aria-label="remove">'+l+"</button></div>").join(""),n.querySelectorAll(".vex-pp-fi-del").forEach(function(m){m.addEventListener("click",function(){const d=parseInt(m.dataset.idx,10);m.dataset.zone==="stmt"?j.stmtFiles.splice(d,1):j.glFiles.splice(d,1),Ze(m.dataset.zone),ft()})}),a){const m=window.t&&window.t("vex-preview-count")||"显示 {n} / 共 {m}";a.textContent=m.replace("{n}",i.length).replace("{m}",s.length)}}function zv(){const e=P("brv2-toggle-preview");e&&!e._reconBound&&(e._reconBound=!0,e.addEventListener("click",function(){const n=P("brv2-preview-panel"),a=P("brv2-toggle-preview-label"),s=n&&n.style.display!=="none";n&&(n.style.display=s?"none":""),e.classList.toggle("open",!s),a&&(a.textContent=s?window.t&&window.t("vex-toggle-preview-open")||"查看清单":window.t&&window.t("vex-toggle-preview-close")||"收起清单"),s||Fv()}))}function ft(){const e=P("brv2-run-btn"),n=P("brv2-status"),a=j.stmtFiles.length>0,s=j.glFiles.length>0;if(e&&(e.disabled=!(a&&s)),n){const o=window._currentLang||"zh";if(!a&&!s){const i={zh:"请上传银行账单和 GL 文件",th:"กรุณาอัปโหลดบัญชีธนาคารและ GL",en:"Upload bank statement and GL files",ja:"銀行明細と GL を両方アップロードしてください"};n.textContent=i[o]||i.zh}else if(a)if(s){const i={zh:"两份文件已就绪",th:"พร้อมสอบทาน",en:"Ready to reconcile",ja:"照合を開始できます"};n.textContent=i[o]||i.zh}else{const i={zh:"还缺 GL 文件",th:"ยังขาดไฟล์ GL",en:"Missing GL file",ja:"GL ファイルが未アップロード"};n.textContent=i[o]||i.zh}else{const i={zh:"还缺银行账单 PDF",th:"ยังขาดไฟล์บัญชีธนาคาร PDF",en:"Missing bank statement PDF",ja:"銀行明細 PDF が未アップロード"};n.textContent=i[o]||i.zh}}}function hi(e,n,a){const s=P(e),o=P(n);!s||!o||(s.addEventListener("click",()=>o.click()),s.addEventListener("keydown",i=>{(i.key==="Enter"||i.key===" ")&&(i.preventDefault(),o.click())}),s.addEventListener("dragover",i=>{i.preventDefault(),s.classList.add("drag-over")}),s.addEventListener("dragleave",()=>s.classList.remove("drag-over")),s.addEventListener("drop",i=>{i.preventDefault(),s.classList.remove("drag-over");const r=Array.from(i.dataTransfer.files||[]);a==="stmt"?j.stmtFiles.push(...r):j.glFiles.push(...r),Ze(a),ft()}),o.addEventListener("change",()=>{const i=Array.from(o.files||[]);a==="stmt"?j.stmtFiles.push(...i):j.glFiles.push(...i),o.value="",Ze(a),ft()}))}function Pe(e){const n=P("brv2-progress"),a=P("brv2-run-btn"),s=P("brv2-error");n&&(n.style.display=e?"":"none"),a&&(a.disabled=e),s&&(s.style.display="none")}function Xe(e){const n=P("brv2-error");n&&(n.textContent=e,n.style.display="",n.scrollIntoView({behavior:"smooth",block:"nearest"})),Pe(!1),ft(),window.showToast&&window.showToast(e,"error")}async function gs(){if(j.stmtFiles.length===0||j.glFiles.length===0)return;const e=localStorage.getItem("mrpilot_token")||"",n=window._currentLang||"zh",a=(P("brv2-acct-select")||{}).value||"";pa(!1),Pe(!0);try{const s=new FormData;j.stmtFiles.forEach(v=>s.append("stmt_files",v)),j.glFiles.forEach(v=>s.append("gl_files",v)),s.append("gl_account",a),s.append("lang",n);const o=parseFloat((P("brv2-anchor-gl-closing")||{}).value),i=parseFloat((P("brv2-anchor-stmt-closing")||{}).value),r=parseFloat((P("brv2-anchor-stmt-opening")||{}).value),l=parseFloat((P("brv2-anchor-gl-opening")||{}).value);Number.isFinite(o)&&s.append("gl_closing_override",o),Number.isFinite(i)&&s.append("stmt_closing_override",i),Number.isFinite(r)&&s.append("stmt_opening_override",r),Number.isFinite(l)&&s.append("gl_opening_override",l);const m=await fetch("/api/recon/bank-v2/submit",{method:"POST",headers:{Authorization:"Bearer "+e},body:s});let d=null;try{d=await m.json()}catch{d=null}if(d&&d.needs_mapping){Pe(!1),window.ReconMapping?window.ReconMapping.show(d,{token:e,lang:n,onConfirmed:function(){gs()}}):Xe(t("brv2-err-server")||"服务器繁忙,请稍后重试");return}if(!m.ok||!d||!d.ok||!d.job_id){Pe(!1),d&&(d.detail||d.error)?Xe(_humanizeBackendError(d.detail||d.error,"Error "+m.status)):Xe(t("brv2-err-server")||"服务器繁忙,请稍后重试");return}const p=P("brv2-progress-sub"),c=await window._reconPollJob(d.job_id,e,{onProgress:v=>{p&&(p.textContent=window._reconProgressText(v,n))}});if(c&&c.status==="needs_mapping"&&c.mapping){Pe(!1),window.ReconMapping?window.ReconMapping.show(c.mapping,{token:e,lang:n,onConfirmed:function(){gs()}}):Xe(t("brv2-err-server")||"服务器繁忙,请稍后重试");return}if(c&&c.status==="needs_review"&&c.review){Pe(!1),window.ReconReview?window.ReconReview.show(c.review,{token:e,lang:n,jobId:d.job_id,onConfirmed:async function(v){Pe(!0);const f=await window._reconPollJob(v,e,{onProgress:y=>{p&&(p.textContent=window._reconProgressText(y,n))}});await u(f)}}):Xe(t("brv2-err-server")||"服务器繁忙,请稍后重试");return}if(c&&c.status==="failed"){Pe(!1),Xe($v(c.error_code,n));return}await u(c);async function u(v){try{if(!v||v.status!=="done"||!v.result_id){Pe(!1),Xe(t("brv2-err-server")||"服务器繁忙,请稍后重试");return}const f=await fetch("/api/recon/bank-v2/"+encodeURIComponent(v.result_id),{headers:{Authorization:"Bearer "+e}});let y=null;try{y=await f.json()}catch{y=null}if(!f.ok||y===null||!y.ok){Pe(!1),Xe(t("brv2-err-server")||"服务器繁忙,请稍后重试");return}(y.gl_accounts||[]).length>1&&Nv(y.gl_accounts),j.currentTask=y,j.allRows=y.detail||[],j.currentFilter="all",document.querySelectorAll(".brv2-filter-btn").forEach(h=>h.classList.toggle("active",h.dataset.filter==="all")),Cv(y&&y.summary),Pe(!1),ro(y),wn();const b=P("brv2-summary-collapse");b&&b.scrollIntoView({behavior:"smooth",block:"nearest"})}catch(f){Pe(!1),Xe(f.message||"Network error")}}}catch(s){Xe(s.message||"Network error")}}function Nv(e){const n=P("brv2-acct-select");if(!n)return;const a=window._currentLang||"zh",s={zh:"全部账户",th:"ทุกบัญชี",en:"All Accounts",ja:"すべての口座"}[a]||"全部账户";n.innerHTML=`<option value="">${s}</option>`+e.map(o=>`<option value="${ue(o)}">${ue(o)}</option>`).join(""),n.style.display=""}function lo(){if(j.initialized){wn();return}j.initialized=!0,hi("brv2-stmt-zone","brv2-stmt-input","stmt"),hi("brv2-gl-zone","brv2-gl-input","gl");const e=["brv2-anchor-gl-closing","brv2-anchor-stmt-closing","brv2-anchor-stmt-opening","brv2-anchor-gl-opening"];function n(){const l=parseFloat((P("brv2-anchor-stmt-opening")||{}).value),m=parseFloat((P("brv2-anchor-gl-opening")||{}).value),d=P("brv2-anchor-eq"),p=P("brv2-anchor-eq-val");if(!(!d||!p))if(Number.isFinite(l)&&Number.isFinite(m)){const c=l-m;p.textContent=c.toLocaleString(void 0,{minimumFractionDigits:2,maximumFractionDigits:2}),d.style.display=""}else d.style.display="none"}e.forEach(l=>{const m=P(l);m&&(m.addEventListener("input",n),m.addEventListener("input",()=>{const d=m.closest(".brv2-anchor-cell");d&&d.classList.remove("is-prefilled"),Mv()}))}),Hv();const a=P("brv2-run-btn");a&&a.addEventListener("click",gs);const s=P("brv2-reset-btn");s&&s.addEventListener("click",()=>{j.currentTask=null,j.allRows=[],j.stmtFiles=[],j.glFiles=[],Ze("stmt"),Ze("gl"),ft(),pa(!1);const l=P("brv2-acct-select");l&&(l.style.display="none"),e.forEach(p=>{const c=P(p);if(c){c.value="";const u=c.closest&&c.closest(".brv2-anchor-cell");u&&u.classList.remove("is-prefilled")}});const m=P("brv2-anchor-eq");m&&(m.style.display="none");const d=P("brv2-anchor-prefill-banner");d&&d.classList.remove("show")});const o=P("brv2-new-btn");o&&o.addEventListener("click",()=>{j.currentTask=null,j.allRows=[],j.stmtFiles=[],j.glFiles=[],Ze("stmt"),Ze("gl"),ft(),pa(!1)});const i=P("brv2-filter-tabs");i&&i.addEventListener("click",l=>{l.stopPropagation();const m=l.target.closest(".brv2-filter-btn");m&&(j.currentFilter=m.dataset.filter,i.querySelectorAll(".brv2-filter-btn").forEach(d=>d.classList.toggle("active",d===m)),Xr())}),zv(),qv();const r=P("brv2-hist-search");r&&r.addEventListener("input",Zr),wn(),ft(),window._brv2LoadHistory=wn,Array.isArray(window.__i18nSubs)||(window.__i18nSubs=[]),window.__i18nSubs=window.__i18nSubs.filter(l=>l.name!=="brv2"),window.__i18nSubs.push({name:"brv2",fn:function(){ft(),Ze("stmt"),Ze("gl"),j.currentTask&&ro(j.currentTask),ua()}})}window._loadBankReconV2Panel=function(e){const n=e?document.getElementById(e):null;n&&n.id!=="recon-pane-bank"&&(n.innerHTML=`<div style="padding:16px;font-size:13px;color:var(--ink-3)">
            银行对账 v2 · 请前往对账中心使用</div>`),lo()};document.addEventListener("DOMContentLoaded",()=>{P("brv2-run-btn")&&lo()});window._bankReconV2Init=lo;(function(){const e=document.getElementById("general-lang");if(!e)return;e.addEventListener("change",a=>{const s=a.target.value;s&&applyLang(s)});const n=typeof currentLang=="string"&&currentLang||localStorage.getItem("mrpilot_lang")||"th";e.value=n})();(function(){const n="pearnly_general_tz",a="pearnly_general_date_format",s="pearnly_general_number_format",o={tz:"Asia/Bangkok",date:"YYYY-MM-DD",number:"comma_dot"};function i(){const d=document.getElementById("general-tz"),p=document.getElementById("general-date"),c=document.getElementById("general-number");if(!(!d||!p||!c))try{d.value=localStorage.getItem(n)||o.tz,p.value=localStorage.getItem(a)||o.date,c.value=localStorage.getItem(s)||o.number}catch{d.value=o.tz,p.value=o.date,c.value=o.number}}async function r(){const d=document.getElementById("btn-save-general"),p=document.getElementById("general-save-msg");if(!d)return;const c=d.innerHTML;d.disabled=!0,d.innerHTML="<span>"+(t("msg-saving")||"保存中...")+"</span>",p&&(p.textContent="",p.classList.remove("error"));try{const u=(document.getElementById("general-tz")||{}).value||o.tz,v=(document.getElementById("general-date")||{}).value||o.date,f=(document.getElementById("general-number")||{}).value||o.number;try{localStorage.setItem(n,u),localStorage.setItem(a,v),localStorage.setItem(s,f)}catch{}window._pearnlyGeneral={tz:u,date_format:v,number_format:f},p&&(p.textContent=t("msg-saved")||"已保存")}catch{p&&(p.textContent=t("msg-save-failed")||"保存失败",p.classList.add("error"))}finally{d.disabled=!1,d.innerHTML=c,setTimeout(function(){p&&(p.textContent="")},3e3)}}function l(){const d=document.getElementById("btn-save-general");if(!d){setTimeout(l,200);return}d._pearnlyGenBound||(d._pearnlyGenBound=!0,d.addEventListener("click",r),i())}function m(){i();const d=document.getElementById("general-lang");if(d){const p=typeof currentLang=="string"&&currentLang||localStorage.getItem("mrpilot_lang")||"th";d.value=p}}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",l):l(),typeof window.subscribeI18n=="function"&&window.subscribeI18n("settings-general",m)})();(function(){const e="mrpilot_nav_collapsed",n={ocr:"sales",history:"sales",reconcile:"sales","sales-invoices":"sales","sales-account":"sales",receivables:"sales",vouchers:"expense"};function a(){try{const r=localStorage.getItem(e);return r?JSON.parse(r):{}}catch{return{}}}function s(r){try{localStorage.setItem(e,JSON.stringify(r))}catch{}}function o(){const r=a();document.querySelectorAll(".nav-collapsible").forEach(function(l){const m=l.dataset.collapsible;r[m]?l.classList.add("collapsed"):l.classList.remove("collapsed")})}function i(r){const l=a();l[r]=!l[r],s(l),o()}(function(){const l=a();let m=!1;l.sales===void 0&&(l.sales=!1,m=!0),l.expense===void 0&&(l.expense=!0,m=!0),m&&s(l)})(),o(),document.querySelectorAll(".nav-group-toggle").forEach(function(r){r.addEventListener("click",function(){i(r.dataset.toggleGroup)})}),window.expandNavGroupForRoute=function(r){const l=n[r];if(!l)return;const m=a();m[l]&&(m[l]=!1,s(m),o())}})();const Ov=`
    <div class="modal" style="max-width:440px">
        ...
        `}).join(""),_userInfo&&_userInfo.endpoints_limit!==-1){const o=Fe.length,i=_userInfo.endpoints_limit,r=_userInfo.plan,l=document.createElement("div");l.className="erp-limit-hint",r==="free"?l.innerHTML=`${escapeHtml(t("ep-free-limit-hint",{used:o,limit:i}))} <a data-upgrade="plus">${escapeHtml(t("upgrade-to-plus"))}</a>`:l.textContent=t("ep-plus-limit-hint",{used:o,limit:i}),e.appendChild(l)}}function Vv(e){$n=e||null;const n=document.getElementById("endpoint-modal"),a=document.getElementById("endpoint-modal-title");a.textContent=e?t("ep-modal-title-edit"):t("ep-modal-title-new");const s=document.getElementById("ep-name"),o=document.getElementById("ep-url"),i=document.getElementById("ep-token"),r=document.getElementById("ep-is-default"),l=document.getElementById("ep-auto-push"),m=document.getElementById("ep-test-result");m.style.display="none",m.textContent="";const d=document.getElementById("ep-save-error");if(d&&d.remove(),e){const c=Fe.find(u=>u.id===e);if(!c)return;s.value=c.name||"",o.value=(c.config||{}).url||"",i.value=(c.config||{})._token_set&&c.config.token||"",i.placeholder=(c.config||{})._token_set?"（已保存 · 留空保持不变）":t("ep-token-ph"),r.checked=!!c.is_default,l.checked=!!c.auto_push}else s.value="",o.value="",i.value="",i.placeholder=t("ep-token-ph"),r.checked=Fe.length===0,l.checked=!0;const p=l.closest(".form-switch-row");if(l.disabled=!1,p){p.classList.remove("disabled-plus"),p.title="",p.style.cursor="",p.onclick=null;const c=p.querySelector(".plus-badge");c&&c.remove()}n.style.display="",setTimeout(()=>s.focus(),50)}function tl(){document.getElementById("endpoint-modal").style.display="none",$n=null;const e=document.getElementById("ep-save-error");e&&e.remove()}function nl(e){if(!e)return"";let n=e.trim();const a=n.search(/\s/);return a>=0&&(n=n.slice(0,a)),n}function al(){const e=document.getElementById("ep-name").value.trim(),n=nl(document.getElementById("ep-url").value),a=document.getElementById("ep-token").value,s=document.getElementById("ep-is-default").checked,o=document.getElementById("ep-auto-push").checked,i={url:n};return a&&(i.token=a),{name:e,url:n,tokenVal:a,isDefault:s,autoPush:o,config:i}}async function Uv(){const{url:e,config:n}=al(),a=document.getElementById("ep-test-result");if(!e){a.style.display="",a.className="form-test-result fail",a.textContent=t("ep-required");return}a.style.display="",a.className="form-test-result running",a.textContent=t("ep-test-running");try{const o=await(await fetch("/api/erp/test-connection",{method:"POST",headers:{Authorization:"Bearer "+token,"Content-Type":"application/json"},body:JSON.stringify({adapter:"webhook",config:n})})).json();o.success?(a.className="form-test-result ok",a.textContent=t("ep-test-ok",{status:o.http_status,ms:o.elapsed_ms})):(a.className="form-test-result fail",a.textContent=t("ep-test-fail",{err:o.error_msg||"unknown"}))}catch(s){a.className="form-test-result fail",a.textContent=t("ep-test-fail",{err:s.message})}}async function Gv(){const e=al(),n=document.getElementById("ep-save-error");if(n&&(n.style.display="none"),!e.name||!e.url){bi(t("ep-required"));return}const a={name:e.name,adapter:"webhook",config:e.config,is_default:e.isDefault,auto_push:e.autoPush},s=document.getElementById("btn-ep-save"),o=s.innerHTML;s.disabled=!0,s.classList.add("loading");try{let i;if($n?i=await fetch(`/api/erp/endpoints/${encodeURIComponent($n)}`,{method:"PATCH",headers:{Authorization:"Bearer "+token,"Content-Type":"application/json"},body:JSON.stringify(a)}):i=await fetch("/api/erp/endpoints",{method:"POST",headers:{Authorization:"Bearer "+token,"Content-Type":"application/json"},body:JSON.stringify(a)}),!i.ok){const l=(await i.json().catch(()=>({}))).detail||`HTTP ${i.status}`;throw new Error(typeof l=="string"?l:JSON.stringify(l))}tl(),showToast(t("ep-save-ok")),Ta()}catch(i){bi(`${t("ep-save-fail")} · ${i.message||"unknown"}`)}finally{s.disabled=!1,s.classList.remove("loading"),s.innerHTML=o}}function bi(e){let n=document.getElementById("ep-save-error");if(!n){const a=document.querySelector("#endpoint-modal .modal-foot");if(!a)return;n=document.createElement("div"),n.id="ep-save-error",n.className="ep-inline-error",a.parentNode.insertBefore(n,a)}n.textContent=e,n.style.display=""}async function Wv(e){const n=Fe.find(s=>s.id===e);if(!(!n||!await showConfirm(t("ep-delete-confirm",{name:n.name}),{danger:!0})))try{if(!(await fetch(`/api/erp/endpoints/${encodeURIComponent(e)}`,{method:"DELETE",headers:{Authorization:"Bearer "+token}})).ok)throw new Error;showToast(t("ep-delete-ok")),Ta()}catch{showToast(t("ep-save-fail"),"fail")}}window.loadErpEndpoints=Ta;window.loadErpTodayStats=Qr;window.renderErpEndpointsList=el;window.openEndpointModal=Vv;window.closeEndpointModal=tl;window.saveEndpoint=Gv;window.deleteEndpoint=Wv;window.testEndpointConnection=Uv;window._sanitizeUrl=nl;async function sl(e){if(e=(e||"").trim(),!!e)try{await navigator.clipboard.writeText(e),showToast(t("erp-doc-copy-ok",{no:e}),"success")}catch{try{const a=document.createElement("textarea");a.value=e,a.style.position="fixed",a.style.opacity="0",document.body.appendChild(a),a.select(),document.execCommand("copy"),a.remove(),showToast(t("erp-doc-copy-ok",{no:e}),"success")}catch{showToast(t("erp-doc-copy-fail"),"error")}}}async function Kv(e){const n=document.createElement("div");n.className="log-detail-modal",n.innerHTML=`
        <div class="log-detail-box">
            <div class="log-detail-loading">${escapeHtml(t("log-detail-loading"))}</div>
        </div>
    `,document.body.appendChild(n),n.addEventListener("click",async a=>{if(a.target===n||a.target.classList.contains("log-detail-close")){n.remove();return}const s=a.target.closest("[data-receipt-copy]");if(s){sl(s.dataset.receiptCopy);return}const o=a.target.closest("[data-receipt-action]");if(o){const i=o.dataset.receiptAction;i==="retry"?window.retryPushLog(o.dataset.logId):i==="exceptions"?typeof routeTo=="function"&&routeTo("exceptions"):i==="mappings"&&typeof routeTo=="function"&&routeTo("integrations"),n.remove();return}});try{const a=await fetch(`/api/erp/logs/${encodeURIComponent(e)}`,{headers:{Authorization:"Bearer "+token}});if(!a.ok){n.remove();return}const s=await a.json(),o=window._erpEndpoints.find(C=>C.id===s.endpoint_id),i=s.endpoint_name||(o?o.name:s.endpoint_id?t("erp-log-endpoint-deleted"):"-"),r=(s.endpoint_adapter||o&&o.adapter||"").toLowerCase(),l=new Date(s.created_at).toLocaleString(),m=s.trigger==="auto"?t("log-tag-auto"):s.trigger==="retry"?t("log-tag-retry"):t("log-tag-manual"),d=s.request_body?JSON.stringify(s.request_body,null,2):t("erp-receipt-no-tech"),p=s.response_body||t("erp-receipt-no-tech"),c=s.status==="success";let u=typeof p=="string"?p:JSON.stringify(p,null,2);if(c)try{const C=typeof s.response_body=="string"?JSON.parse(s.response_body):s.response_body||{},H=C.row_count||(Array.isArray(C.imported_rows)?C.imported_rows.length:0);H>0&&(u=t("log-push-rows").replace("{n}",String(H)))}catch{}const v=(s.external_doc_no||"").trim(),f=(s.external_url||"").trim(),y=(s.external_doc_hint||"").trim(),b=(s.ocr_buyer_name||"").trim()||s.client_name||"-",h=s.seller_name||"-",g=s.push_type==="id_card";let _="-";const w=Number(s.total_amount);s.total_amount!=null&&s.total_amount!==""&&!isNaN(w)&&(_=w.toLocaleString("en-US",{minimumFractionDigits:2,maximumFractionDigits:2}));const k=c?t("erp-receipt-title-ok"):t("erp-receipt-title-fail"),x=c?"✓":"✗",E=[],I=(C,H)=>{E.push(`
                <div class="erp-receipt-row">
                    <span class="erp-receipt-key">${escapeHtml(C)}</span>
                    <span class="erp-receipt-val">${H}</span>
                </div>`)};if(I(g?t("erp-log-col-booking"):t("erp-receipt-invoice-no"),`<strong>${escapeHtml(s.invoice_no||"-")}</strong>`),I(t("erp-receipt-erp-name"),escapeHtml(i)),c){let C;v?C=`<strong class="erp-receipt-docno">${escapeHtml(v)}</strong><button class="erp-receipt-copy-btn" type="button" data-receipt-copy="${escapeHtml(v)}" title="${escapeHtml(t("erp-doc-copy-tip"))}">${escapeHtml(t("erp-receipt-copy-btn"))}</button>`:C=`<span class="erp-receipt-docno-missing">${escapeHtml(t("erp-log-doc-missing"))}</span>`,I(t("erp-receipt-doc-no"),C)}g||I(t("erp-receipt-client"),escapeHtml(b)),I(g?t("erp-log-col-customer"):t("erp-receipt-seller"),escapeHtml(h)),c&&I(t("erp-receipt-amount"),escapeHtml(_)),I(t("erp-receipt-time"),escapeHtml(l)),I(t("erp-receipt-elapsed"),escapeHtml((s.elapsed_ms!=null?s.elapsed_ms:"-")+"ms"));let B="";c&&f?B=`<a class="erp-receipt-primary-btn" href="${escapeHtml(f)}" target="_blank" rel="noopener">${escapeHtml(t("erp-receipt-open-erp"))}</a>`:c&&v&&(B=`<button class="erp-receipt-primary-btn" type="button" data-receipt-copy="${escapeHtml(v)}">${escapeHtml(t("erp-receipt-copy-docno"))}</button>`);let L="";if(c&&v&&y){const C="erp-receipt-hint-"+y,H=t(C);H&&H!==C&&(L=`<div class="erp-receipt-hint"><svg class="erp-receipt-hint-ic" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><circle cx="12" cy="12" r="9"/><line x1="12" y1="11" x2="12" y2="16"/><line x1="12" y1="8" x2="12.01" y2="8"/></svg><span>${escapeHtml(H)}</span></div>`)}let $="";if(!c){const C=(s.error_msg||"").match(/ERR_[A-Z0-9_]+/),H=C?C[0]:"",R=typeof currentLang=="string"&&currentLang||window._currentLang||"th",se=s.error_friendly&&s.error_friendly[R]||(s.error_msg?humanizeError(s.error_msg):t("erp-receipt-no-error")),de=/ERR_NO_CUSTOMER_MAPPING|ERR_NO_CLIENT|ERR_NO_SEED_CUSTOMER|ERR_NO_SEED_PRODUCT/.test(s.error_msg||""),Ie=!!(s.history_id&&s.endpoint_id),we=[];we.push(`<button class="erp-receipt-action-btn" type="button" data-receipt-action="exceptions">${escapeHtml(t("erp-receipt-act-exceptions"))}</button>`),de&&we.push(`<button class="erp-receipt-action-btn" type="button" data-receipt-action="mappings">${escapeHtml(t("erp-receipt-act-mapping"))}</button>`),Ie&&we.push(`<button class="erp-receipt-action-btn primary" type="button" data-receipt-action="retry" data-log-id="${escapeHtml(s.id)}">${escapeHtml(t("erp-receipt-act-retry"))}</button>`),$=`
        ...
        `}catch(a){console.error(a),n.remove()}}window.copyErpDocNo=sl;window.showLogDetail=Kv;const Yv=`
        <div class="modal">
            <div class="modal-head">
    ...
    `;Ce("endpoint-modal",Yv);let pn={key:"all",val:""},kn="",Ja=!1,dt=new Set;window._erpSelected=dt;async function Jv(){const e=document.getElementById("erp-logs-erp-select");if(!(!e||Ja)){Ja=!0;try{let n=window._erpEndpoints;if(!Array.isArray(n)||n.length===0){const o=await fetch("/api/erp/endpoints",{headers:{Authorization:"Bearer "+token}});if(o.ok){const i=await o.json();n=i&&(i.items||i)||[]}}Array.isArray(n)||(n=[]);const a=new Set,s=[];n.forEach(o=>{const i=(o&&o.adapter||"").toLowerCase();!i||a.has(i)||(a.add(i),s.push({val:i,label:o&&o.name||i}))}),e.innerHTML=`<option value="">${escapeHtml(t("erp-logs-erp-all"))}</option>`+s.map(o=>`<option value="${escapeHtml(o.val)}"${o.val===kn?" selected":""}>${escapeHtml(o.label)}</option>`).join("")}catch{Ja=!1}}}async function Gt(e){const n=document.getElementById("erp-logs-list");if(n){e||(n.innerHTML=`<div class="erp-logs-empty">${escapeHtml(t("erp-logs-loading"))}</div>`),window.loadErpTodayStats(),Jv();try{const a=new URLSearchParams({limit:"30"});pn.key==="status"&&a.set("status",pn.val),pn.key==="trigger"&&a.set("trigger",pn.val),kn&&a.set("adapter",kn);const s=await fetch(`/api/erp/logs?${a}`,{headers:{Authorization:"Bearer "+token}});if(!s.ok){n.innerHTML=`<div class="erp-logs-empty">${escapeHtml(t("erp-logs-error"))}</div>`;return}const i=(await s.json()).items||[];if(window._erpLogPollTimer&&(clearTimeout(window._erpLogPollTimer),window._erpLogPollTimer=null),i.some(function(v){return v.status==="pending"})&&(window._erpLogPollTimer=setTimeout(function(){Gt(!0)},4e3)),i.length===0){n.innerHTML=`<div class="erp-logs-empty">${escapeHtml(t("erp-logs-empty"))}</div>`;return}const r=i.filter(function(v){var f=v.status==="failed"&&v.next_retry_at&&new Date(v.next_retry_at).getTime()>Date.now()-6e4;return!f}).map(function(v){return v.id}),l=kn==="mrerp_dms",m=l?t("erp-log-col-booking"):t("erp-log-col-invoice"),d=l?t("erp-log-col-customer"):t("erp-log-col-seller"),p=l?t("erp-log-col-idcard"):t("erp-log-col-client"),c='<div class="erp-log-row erp-log-row-header" data-log-header>'+(r.length>0?`<input type="checkbox" class="erp-log-cb erp-log-cb-all" data-log-select-all title="${escapeHtml(t("erp-log-select-all-tip"))}">`:'<span class="erp-log-cb-spacer"></span>')+`<span class="log-time">${escapeHtml(t("erp-log-col-time"))}</span><span class="log-status">${escapeHtml(t("erp-log-col-status"))}</span><span class="log-tag-header">${escapeHtml(t("erp-log-col-trigger"))}</span><span class="log-invoice">${escapeHtml(m)}</span><span class="log-workspace">${escapeHtml(t("erp-log-col-workspace"))}</span><span class="log-client">${escapeHtml(p)}</span><span class="log-seller">${escapeHtml(d)}</span><span class="log-erp">${escapeHtml(t("erp-log-col-erp"))}</span><span class="log-doc">${escapeHtml(t("erp-log-col-doc"))}</span><span class="log-http">${escapeHtml(t("erp-log-col-http"))}</span><span class="log-elapsed">${escapeHtml(t("erp-log-col-elapsed"))}</span><span class="log-actions"></span></div>`;n.innerHTML=c+i.map(v=>{const f=new Date(v.created_at),y=`${String(f.getMonth()+1).padStart(2,"0")}-${String(f.getDate()).padStart(2,"0")} ${String(f.getHours()).padStart(2,"0")}:${String(f.getMinutes()).padStart(2,"0")}`,b=v.status==="failed"&&v.next_retry_at&&new Date(v.next_retry_at).getTime()>Date.now()-6e4;let h,g,_;v.status==="pending"?(h="retrying",g="⟳",_=t("erp-status-pending")):v.status==="success"?(h="ok",g="✓",_=t("erp-status-success")):v.status==="skipped_dup"?(h="skipped",g="⏭",_=t("erp-status-skipped")):b?(h="retrying",g="↻",_=t("erp-status-retrying")):(h="fail",g="✗",_=t("erp-status-failed"));let w;v.trigger==="auto"?w=`<span class="log-tag auto">${escapeHtml(t("log-tag-auto"))}</span>`:v.trigger==="retry"?w=`<span class="log-tag retry">${escapeHtml(t("log-tag-retry"))}</span>`:w=`<span class="log-tag manual">${escapeHtml(t("log-tag-manual"))}</span>`;const k=v.push_type==="id_card",x=k?`<span class="log-tag log-type-idcard">${escapeHtml(t("erp-log-type-idcard"))}</span>`:"",E=v.error_friendly&&(v.error_friendly[currentLang]||v.error_friendly.en)||"";let I="";const B=v.retry_count||0,L=v.max_retries||3;if(b){const Y=new Date(v.next_retry_at).getTime()-Date.now(),pe=Math.max(0,Math.round(Y/6e4)),le=pe<=0?t("erp-retry-next-soon"):t("erp-retry-next-min",{n:pe});I=`${t("erp-retry-attempt",{n:B,max:L})} · ${le}`}else v.status==="failed"&&B>=L&&!v.next_retry_at&&(I=t("erp-retry-exhausted",{n:B}));const $=v.status==="failed"&&!b?`<button class="log-retry-btn btn btn-icon" data-log-retry="${escapeHtml(v.id)}" title="${escapeHtml(t("log-retry-title"))}">↻</button>`:"",C=!b,H=dt.has(v.id)?"checked":"",R=C?`<input type="checkbox" class="erp-log-cb" data-log-cb="${escapeHtml(v.id)}" ${H}>`:'<span class="erp-log-cb-spacer"></span>',G=(v.ocr_buyer_name||"").trim()||(v.client_name||"").trim(),se=k?`<span class="log-client" title="${escapeHtml(t("erp-log-col-idcard"))}">${v.id_card_tail?"••••"+escapeHtml(v.id_card_tail):"—"}</span>`:G?`<span class="log-client" title="${escapeHtml(G)}">${escapeHtml(G.substring(0,18))}</span>`:`<span class="log-client log-client-empty" title="${escapeHtml(t("erp-log-client-unassigned-tip"))}">${escapeHtml(t("erp-log-client-unassigned"))}</span>`,de=k?'<span class="log-workspace log-workspace-unresolved">—</span>':v.workspace_name?`<span class="log-workspace">${escapeHtml((v.workspace_name||"").substring(0,16))}</span>`:`<span class="log-workspace log-workspace-unresolved" title="${escapeHtml(t("erp-log-ws-unresolved-tip"))}">${escapeHtml(t("erp-log-ws-unresolved"))}</span>`,Ie=v.endpoint_name?`<span class="log-erp">${escapeHtml((v.endpoint_name||"").substring(0,14))}</span>`:`<span class="log-erp log-erp-deleted">${escapeHtml(t("erp-log-endpoint-deleted"))}</span>`,we=(v.external_doc_no||"").trim(),V=(v.external_url||"").trim();let N;return V?N=`<span class="log-doc"><a href="${escapeHtml(V)}" target="_blank" rel="noopener" class="log-doc-open" title="${escapeHtml(we||"")}">${escapeHtml(t("erp-log-doc-open"))}</a></span>`:we?N=`<span class="log-doc log-doc-copy" data-copy-doc="${escapeHtml(we)}" title="${escapeHtml(t("erp-log-doc-copy-tip"))}">${escapeHtml(we.substring(0,18))}</span>`:v.status==="success"?N=`<span class="log-doc log-doc-missing" title="${escapeHtml(t("erp-log-doc-missing-tip"))}">${escapeHtml(t("erp-log-doc-missing"))}</span>`:N='<span class="log-doc log-doc-empty">-</span>',`
        ...
        `,document.body.appendChild(v);const f=()=>v.remove();v.querySelector("#cpw-forgot-close").addEventListener("click",f),v.querySelector("#cpw-forgot-cancel").addEventListener("click",f),v.addEventListener("click",y=>{y.target===v&&f()}),v.querySelector("#cpw-forgot-send").addEventListener("click",async()=>{const y=v.querySelector("#cpw-forgot-send"),b=v.querySelector("#cpw-forgot-msg");y.disabled=!0;const h=y.textContent;y.textContent=a("cpw-forgot-sending");try{const g=await fetch("/api/auth/forgot_password",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:c})}),_=await g.json().catch(()=>({}));g.ok?(b.textContent=a("cpw-forgot-success"),b.className="cpw-forgot-msg success",y.style.display="none",v.querySelector("#cpw-forgot-cancel").textContent=a("cpw-forgot-close-btn")):(b.textContent=_.detail||a("cpw-forgot-fail"),b.className="cpw-forgot-msg error",y.disabled=!1,y.textContent=h)}catch{b.textContent=a("cpw-forgot-fail"),b.className="cpw-forgot-msg error",y.disabled=!1,y.textContent=h}})}function m(p){if(!p||!p.includes("@"))return p||"";const[c,u]=p.split("@");return c.length<=2?c+"****@"+u:c.slice(0,2)+"****@"+u}function d(p){return p==null?"":String(p).replace(/[&<>"']/g,c=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[c])}document.readyState==="complete"||document.readyState==="interactive"?r():document.addEventListener("DOMContentLoaded",r)})();(function(){let e=null,n=!1;async function a(){if(n)return;const o=localStorage.getItem("mrpilot_token");if(o){n=!0;try{const i=await fetch("/api/me",{headers:{Authorization:"Bearer "+o},cache:"no-store"});if(i.status===401){const r=await i.json().catch(()=>({})),l=r&&r.detail;let m="";if(typeof l=="string"?m=l:l&&typeof l=="object"&&(m=l.code||""),console.warn("[heartbeat] session revoked",m),localStorage.removeItem("mrpilot_token"),e&&(clearInterval(e),e=null),m==="auth.session_revoked")try{_showSessionRevokedModal()}catch{window.location.href="/"}else{const d=m==="auth.password_changed_relogin"?"alert-password-changed-relogin":"alert-session";try{typeof showToast=="function"&&typeof t=="function"?showToast(t(d),"error"):alert("Session expired")}catch{}setTimeout(()=>{window.location.href="/"},1500)}}}catch{}finally{n=!1}}}function s(){e&&clearInterval(e),e=setInterval(a,15e3)}localStorage.getItem("mrpilot_token")&&s(),window.addEventListener("focus",a),document.addEventListener("visibilitychange",function(){document.hidden||a()}),window._sessionCheck=a})();async function Ha(){const e=document.getElementById("team-loading"),n=document.getElementById("team-list"),a=document.getElementById("team-empty"),s=document.getElementById("team-count");if(n){e&&(e.style.display=""),n.style.display="none",a&&(a.style.display="none");try{const o=await apiGet("/api/team/employees"),i=o&&o.employees||[];if(e&&(e.style.display="none"),s&&(s.textContent=(t("team-count")||"共 {n} 名员工").replace("{n}",i.length)),i.length===0){a&&(a.style.display="");return}n.style.display="",n.innerHTML=i.map(r=>{const l=r.last_login_at?new Date(r.last_login_at).toLocaleDateString():t("team-never-login")||"从未登录",m=r.is_active===!1?"team-status-off":"team-status-on",d=r.is_active===!1?t("team-status-disabled")||"已禁用":t("team-status-active")||"正常",p=r.email?`<span class="team-meta-sep">·</span><span>${escapeHtml(r.email)}</span>`:"";return`
            ...
            </div>`}).join("")}catch(o){console.error("loadTeamList failed:",o),e&&(e.textContent=t("team-load-failed")||"加载失败")}}}async function Xv(){document.querySelectorAll(".add-emp-overlay").forEach(s=>s.remove());const e=document.createElement("div");e.className="add-emp-overlay",e.innerHTML=`
