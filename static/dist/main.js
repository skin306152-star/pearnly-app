...
`,e.dataset.wbInjected="1";try{const n=window._currentLang||localStorage.getItem("mrpilot_lang")||"th",a=window.I18N;a&&a[n]&&(e.querySelectorAll("[data-i18n]").forEach(o=>{const s=o.getAttribute("data-i18n");a[n][s]&&(o.textContent=a[n][s])}),e.querySelectorAll("[data-i18n-placeholder]").forEach(o=>{const s=o.getAttribute("data-i18n-placeholder");a[n][s]&&(o.placeholder=a[n][s])}))}catch{}}})();(function(){const e=document.getElementById("page-settings");if(!(!e||e.dataset.wbInjected==="1")){e.innerHTML=`
        ...
        <!-- /settings-layout -->
`,e.dataset.wbInjected="1";try{const n=window._currentLang||localStorage.getItem("mrpilot_lang")||"th",a=window.I18N;a&&a[n]&&(e.querySelectorAll("[data-i18n]").forEach(o=>{const s=o.getAttribute("data-i18n");a[n][s]&&(o.textContent=a[n][s])}),e.querySelectorAll("[data-i18n-placeholder]").forEach(o=>{const s=o.getAttribute("data-i18n-placeholder");a[n][s]&&(o.placeholder=a[n][s])}))}catch{}}})();const $n=`
        <div class="page-head-clean">
            <div class="page-head-icon">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
...
`,Mn=`                    <!-- Tab: 邮箱抓取 (v0.17 · M6 · v93 在 Vultr 复活) -->
...
`;(function(){const e=document.getElementById("page-automation");if(!(!e||e.dataset.wbInjected==="1")){e.innerHTML=$n+Mn,e.dataset.wbInjected="1";try{const n=window._currentLang||localStorage.getItem("mrpilot_lang")||"th",a=window.I18N;a&&a[n]&&(e.querySelectorAll("[data-i18n]").forEach(o=>{const s=o.getAttribute("data-i18n");a[n][s]&&(o.textContent=a[n][s])}),e.querySelectorAll("[data-i18n-placeholder]").forEach(o=>{const s=o.getAttribute("data-i18n-placeholder");a[n][s]&&(o.placeholder=a[n][s])}))}catch{}}})();(function(){const e={"page-integration":`
        <div class="coming-soon">
            <svg class="cs-icon" viewBox="0 0 48 48" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
...
`,e.dataset.wbInjected="1";try{const n=window._currentLang||localStorage.getItem("mrpilot_lang")||"th",a=window.I18N;a&&a[n]&&e.querySelectorAll("[data-i18n]").forEach(o=>{const s=o.getAttribute("data-i18n");a[n][s]&&(o.textContent=a[n][s])})}catch{}}})();function Hn(e,n){const a=document.getElementById("alert-"+e);a&&(document.getElementById("alert-"+e+"-text").textContent=n,a.classList.add("show"))}function An(){["info","warn","error"].forEach(e=>{document.getElementById("alert-"+e).classList.remove("show")})}function jn(e,n){if(e==null)return n||"操作失败";if(typeof e=="string")return e;if(Array.isArray(e)){const a=e[0]||{};return a.msg?a.msg:n||"请求格式错误"}if(typeof e=="object"){if(e.code){const a="err."+e.code;try{const o=t(a,e);if(o&&o!==a)return o}catch(o){console.warn("[i18n] t() failed for key:",a,o)}return e.code}if(e.message)return e.message;if(e.error)return e.error;if(e.detail&&typeof e.detail=="string")return e.detail;try{return JSON.stringify(e).slice(0,160)}catch{}}return n||String(e)}function Pn(e){if(!e)return"";const n=String(e);return/ECONNREFUSED|Connection refused/i.test(n)?"连接被拒绝 · ERP 地址可能错了,或服务没启动":/listing fetch failed|wait_for_selector/i.test(n)?"拉取 MR.ERP 客户/商品列表超时 · 已重试 3 次仍不通 · 可能 MR.ERP 响应慢 · 稍后再试":/ETIMEDOUT|timeout/i.test(n)?"连接超时 · MR.ERP 响应慢 · 稍后再试":/ENOTFOUND|getaddrinfo/i.test(n)?"域名解析失败 · ERP 地址拼错了":/certificate|SSL/i.test(n)?"SSL 证书问题 · ERP 站点证书异常":/401|Unauthorized/i.test(n)?"HTTP 401 · 认证失败,检查 Token 是否正确":/403|Forbidden/i.test(n)?"HTTP 403 · 权限不足,ERP 拒绝访问":/404|Not Found/i.test(n)?"HTTP 404 · URL 路径不存在":/^5\d\d/.test(n)||/500|502|503|504/.test(n)?"ERP 服务器错误 · 不是你的问题,等会儿再试":n}function Dn(e,n,a){let o=document.getElementById("mp-toast-wrap");o||(o=document.createElement("div"),o.id="mp-toast-wrap",document.body.appendChild(o)),n=n||"success",n==="ok"&&(n="success"),n==="warning"&&(n="warn"),n==="danger"&&(n="error");const s={success:'<path d="M3 8l3 3 7-7"/>',error:'<circle cx="8" cy="8" r="6"/><path d="M5.5 5.5l5 5M10.5 5.5l-5 5"/>',warn:'<path d="M8 2L1.5 13h13L8 2z"/><path d="M8 7v3M8 12v.01"/>',info:'<circle cx="8" cy="8" r="6"/><path d="M8 5.5v.01M8 8v3"/>',loading:'<path d="M8 1a7 7 0 017 7" stroke-linecap="round" class="mp-toast-spin"/>'},i=document.createElement("div");i.className="mp-toast "+n,i.innerHTML=`
        <svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
            ${s[n]||s.success}
        </svg>
        <span>${escapeHtml(e)}</span>
    `,o.appendChild(i),requestAnimationFrame(()=>i.classList.add("show"));const r=typeof a=="number"?a:2500;let f=null;const l=()=>{f&&(clearTimeout(f),f=null),i.classList.remove("show"),setTimeout(()=>{try{i.remove()}catch{}},300)};return r>0&&(f=setTimeout(l,r)),l}window.showAlert=Hn;window.hideAlerts=An;window._humanizeBackendError=jn;window.humanizeError=Pn;window.showToast=Dn;function qn(e,n){return n=n||{},new Promise(a=>{const o=document.getElementById("confirm-modal"),s=document.getElementById("confirm-modal-body"),i=document.getElementById("confirm-modal-ok"),r=document.getElementById("confirm-modal-cancel"),f=document.getElementById("confirm-modal-close"),l=document.getElementById("confirm-modal-title");if(!o||!s||!i||!r){a(!1);return}l.textContent=n.title||t("confirm-default-title");const d=n.promptInput?"cm_in_"+Date.now():null;if(n.promptInput){const v=(e||"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;"),_=(n.placeholder||"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;");s.innerHTML=`
                <div style="margin-bottom:12px;line-height:1.55;white-space:pre-wrap;">${v}</div>
                <input type="text" id="${d}" placeholder="${_}" autocomplete="off"
                    style="width:100%;padding:10px 12px;border:1px solid #cbd5e1;border-radius:8px;font-size:14px;box-sizing:border-box;">
            `}else s.textContent=e||"";i.className=n.danger?"btn btn-danger":"btn btn-primary",i.textContent=n.okText||t("confirm-ok"),r.textContent=n.cancelText||t("confirm-cancel"),r.style.display=n.hideCancel?"none":"",o.style.display="flex";const c=v=>{o.style.display="none",i.onclick=null,r.onclick=null,f.onclick=null,o.onclick=null,document.removeEventListener("keydown",u),n.promptInput&&(s.innerHTML=""),r.style.display="",a(v)},p=()=>{const v=d?document.getElementById(d):null;return v?v.value:""},u=v=>{v.key==="Escape"?c(n.promptInput?null:!1):v.key==="Enter"&&c(n.promptInput?p():!0)};i.onclick=()=>c(n.promptInput?p():!0),r.onclick=()=>c(n.promptInput?null:!1),f.onclick=()=>c(n.promptInput?null:!1),o.onclick=v=>{v.target===o&&c(n.promptInput?null:!1)},document.addEventListener("keydown",u),setTimeout(()=>{if(n.promptInput){const v=document.getElementById(d);v&&v.focus()}else i.focus()},50)})}window.showConfirm=qn;function Rn(e){if(e){try{if(typeof shouldHideMoney=="function"&&shouldHideMoney(_userInfo)&&["team","api","plan","company"].indexOf(e)>=0){e="profile";try{localStorage.setItem("mrpilot_settings_tab","profile")}catch{}}}catch{}document.querySelectorAll(".settings-tab").forEach(n=>{n.classList.toggle("active",n.dataset.tab===e)}),document.querySelectorAll(".settings-pane").forEach(n=>{n.classList.toggle("active",n.dataset.pane===e)});try{localStorage.setItem("mrpilot_settings_tab",e)}catch{}try{e==="about"&&typeof window.loadAboutPanel=="function"&&window.loadAboutPanel(),e==="notifications"&&typeof window.loadPrefsSettings=="function"&&window.loadPrefsSettings(),e==="team"&&loadTeamList(),e==="learned"&&typeof window.loadLearnedRules=="function"&&window.loadLearnedRules(),e==="plan"&&typeof pt=="function"&&pt()}catch(n){console.warn("settings tab side effect failed:",n)}}}function Nn(e){if(!e)return;const n=(a,o)=>{const s=document.getElementById(a);s&&(s.value=o||"")};n("profile-username",e.username||""),n("profile-email",e.username||""),n("profile-fullname",e.full_name||""),n("profile-phone",e.phone||""),n("profile-country",e.country||"TH"),n("profile-line",e.line_id||""),n("company-name",e.company_name||""),n("company-volume",e.monthly_volume||""),n("company-role",e.user_role||e.role_self||"")}async function Fn(){const e=document.getElementById("btn-save-profile"),n=document.getElementById("profile-save-msg");if(!e)return;const a=e.innerHTML;e.disabled=!0,e.innerHTML=`<span>${t("msg-saving")||"保存中..."}</span>`,n&&(n.textContent="",n.classList.remove("error"));try{const o={full_name:(document.getElementById("profile-fullname")||{}).value||"",phone:(document.getElementById("profile-phone")||{}).value||"",country:(document.getElementById("profile-country")||{}).value||"TH",line_id:(document.getElementById("profile-line")||{}).value||""},s=await apiPut("/api/me/profile",o);if(s&&s.ok){n&&(n.textContent=t("msg-saved")||"已保存");try{const i=await apiGet("/api/me");_userInfo=i;try{window._userInfo=i}catch{}renderBrandWorkspace()}catch{}}else throw new Error("save failed")}catch{n&&(n.textContent=t("msg-save-failed")||"保存失败",n.classList.add("error"))}finally{e.disabled=!1,e.innerHTML=a,setTimeout(()=>{n&&(n.textContent="")},3e3)}}async function zn(){const e=document.getElementById("btn-save-company"),n=document.getElementById("company-save-msg");if(!e)return;const a=e.innerHTML;e.disabled=!0,e.innerHTML=`<span>${t("msg-saving")||"保存中..."}</span>`,n&&(n.textContent="",n.classList.remove("error"));try{const o={company_name:(document.getElementById("company-name")||{}).value||"",monthly_volume:(document.getElementById("company-volume")||{}).value||"",role:(document.getElementById("company-role")||{}).value||""},s=await apiPut("/api/me/profile",o);if(s&&s.ok){n&&(n.textContent=t("msg-saved")||"已保存");try{const i=await apiGet("/api/me");_userInfo=i;try{window._userInfo=i}catch{}renderBrandWorkspace()}catch{}}else throw new Error("save failed")}catch{n&&(n.textContent=t("msg-save-failed")||"保存失败",n.classList.add("error"))}finally{e.disabled=!1,e.innerHTML=a,setTimeout(()=>{n&&(n.textContent="")},3e3)}}function pt(){if(!_userInfo)return;typeof window.loadAboutPanel=="function"&&window.loadAboutPanel(),typeof window.loadPrefsSettings=="function"&&window.loadPrefsSettings();const e=document.getElementById("settings-info");if(!e)return;const n=_userInfo;if(n.is_super_admin){e.innerHTML=`
        ...
        `;const o=document.getElementById("api-key-card");o&&(o.style.display="");return}On(n,e);const a=document.getElementById("api-key-card");if(a){const o=tt==="byo_api"||_userInfo&&_userInfo.is_super_admin;a.style.display=o?"":"none"}}function On(e,n){const a=escapeHtml(e.username||e.email||"");n.innerHTML=`
        <table style="width:100%; font-size:13px; border-collapse: collapse;">
            <tr>
    ...
    `}window.switchSettingsTab=Rn;window.fillSettingsForms=Nn;window.saveProfile=Fn;window.saveCompany=zn;window.renderSettings=pt;function Qe(e){return e=e||_userInfo,!!(e&&e.is_super_admin)}function gt(e){return e=e||_userInfo,!!e&&(e.role==="owner"||Qe(e))}function Dt(e){return e=e||_userInfo,!!e&&e.role==="member"&&!Qe(e)}function Vn(e){return e=e||_userInfo,!!e&&(e.effective_plan==="trial"||e.plan==="trial")&&!Qe(e)}function qt(e){return e=e||_userInfo,!!e&&e.tenant_type==="byo_api"}function Rt(e){return Dt(e)}function Un(e){return gt(e)}function Gn(e){return gt(e)&&qt(e)}window.isMoneyHidden=Rt;window.isSuperAdmin=Qe;window.isOwner=gt;window.isEmployee=Dt;window.isTrial=Vn;window.isLifetime=qt;window.shouldHideMoney=Rt;window.canManageTeam=Un;window.canManageApiKey=Gn;function Kn(){const e=document.getElementById("quota-banner");if(!e)return;if(!_userInfo){e.style.display="none";return}if(_userInfo.is_super_admin||_userInfo.tenant_type==="admin"||_userInfo.tenant_type==="byo_api"){e.style.display="none";return}let n=0,a=0;if(_userInfo.plan==="free"&&_quota&&_quota.ip_daily_limit)n=_quota.ip_used_today||0,a=_quota.ip_daily_limit;else if(_userInfo.tenant_quota!=null&&_userInfo.tenant_quota>0)n=_userInfo.tenant_used||0,a=_userInfo.tenant_quota;else if(_userInfo.monthly_quota&&_userInfo.monthly_quota>0)n=_userInfo.used_this_month||0,a=_userInfo.monthly_quota;else{e.style.display="none";return}if(a<=0){e.style.display="none";return}const o=Math.max(0,a-n),s=n/a*100,i="quota_banner_dismiss_"+new Date().toISOString().slice(0,10);if(localStorage.getItem(i)){e.style.display="none";return}let r,f;if(o===0)r="danger",f=t("quota-banner-exhausted");else if(s>=90)r="danger",f=t("quota-banner-very-low",{n:o});else if(s>=70)r="warn",f=t("quota-banner-low",{n:o});else{e.style.display="none";return}e.className="quota-banner "+r,e.innerHTML=`
    ...
    `,e.style.display="flex";const l=e.querySelector(".quota-banner-close");l&&l.addEventListener("click",()=>{localStorage.setItem(i,"1"),e.style.display="none"})}function Yn(){const e=_userInfo;if(!e)return;const n=shouldHideMoney(e),a=canManageTeam(e),o=canManageApiKey(e),s=document.querySelector('.nav-item[data-route="templates"]');s&&(s.classList.remove("locked-for-plan"),s.removeAttribute("data-locked-target"));const i=document.querySelector('.nav-item[data-route="api-keys"]');i&&(i.classList.remove("locked-for-plan"),i.removeAttribute("data-locked-target"));const r=document.getElementById("btn-custom-template");r&&(r.style.display="",r.classList.remove("locked-for-plan"));const f=document.querySelector('.settings-tab[data-tab="team"]');f&&(f.style.display=a?"":"none");const l=document.querySelector('.settings-panel[data-settings-panel="team"]');l&&(l.dataset.permHidden=a?"0":"1");const d=document.querySelector('.settings-tab[data-tab="api"]');d&&(d.style.display=o||isSuperAdmin(e)?"":"none");const c=document.querySelector('.settings-tab[data-tab="plan"]');c&&(c.style.display=n?"none":"");const p=document.querySelector('.settings-tab[data-tab="company"]');p&&(p.style.display=n?"none":"");const u=document.getElementById("info-bar");u&&(u.style.display=n?"none":"");const v=document.getElementById("trial-banner");v&&n&&(v.style.display="none");const _=document.getElementById("plan-banner");_&&n&&(_.style.display="none",document.body.classList.remove("has-plan-banner")),document.querySelectorAll("[data-upgrade-cta], .btn-upgrade, .topbar-upgrade").forEach(M=>{M.style.display="none"}),document.body.classList.toggle("role-employee",isEmployee(e)),document.body.classList.toggle("role-owner",isOwner(e)),document.body.classList.toggle("role-super",isSuperAdmin(e));try{const M=document.querySelector(".settings-tab.active");M&&M.style.display==="none"&&(typeof window.switchSettingsTab=="function"?window.switchSettingsTab("profile"):typeof switchSettingsTab=="function"&&switchSettingsTab("profile"))}catch(M){console.warn("[v118.12.3] failed to fix active tab:",M)}if(window.PEARNLY_ADMIN_MODE){const M=document.getElementById("admin-mode-banner");M&&(M.style.display="flex"),document.querySelectorAll(".nav-item").forEach(b=>{b.classList.contains("nav-admin-only")||(b.style.display="none")}),document.querySelectorAll(".nav-group").forEach(b=>{b.classList.contains("nav-group-admin-only")||(b.style.display="none")});const I=document.getElementById("client-switcher");I&&(I.style.display="none"),document.body.classList.add("admin-mode");const x=["profile","security","notifications","about"];document.querySelectorAll(".settings-tab").forEach(b=>{const $=b.dataset.tab;$&&!x.includes($)&&(b.style.display="none")}),document.querySelectorAll(".settings-pane").forEach(b=>{const $=b.dataset.pane;$&&!x.includes($)&&(b.style.display="none")}),document.querySelectorAll(".settings-nav-group").forEach(b=>{const $=b.querySelectorAll(".settings-tab");Array.from($).some(F=>F.style.display!=="none")||(b.style.display="none")})}}function Jn(){const e=_userInfo,n=document.getElementById("info-bar");if(!e||shouldHideMoney(e)){n&&(n.innerHTML="");return}let a="";const o=e.tenant_type;if(o==="byo_api")e.has_own_gemini_key?a=`
        ...
        `;else{const s=e.tenant_used!=null?e.tenant_used:e.used_this_month||0,i=e.tenant_quota!=null&&e.tenant_quota>0?e.tenant_quota:e.monthly_quota||0,r=i>0?Math.min(100,s/i*100):0;let f="";r>=95?f="danger":r>=80&&(f="warn"),i>0?a=`
                <div class="info-chip">
            ...
            `:a=""}n&&(n.innerHTML=a)}window.renderQuotaBanner=Kn;window.applySidebarVisibility=Yn;window.renderInfoBar=Jn;async function Nt(e,n){try{const a=await fetch(e,{method:"POST",headers:{Authorization:"Bearer "+token,"Content-Type":"application/json"},body:JSON.stringify(n)});if(a.status===401){localStorage.removeItem("mrpilot_token");const o=await a.json().catch(()=>({}));return(typeof o.detail=="string"?o.detail:o.detail&&o.detail.code||"")==="auth.session_revoked"?(_showSessionRevokedModal(),null):(window.location.href="/",null)}return await a.json()}catch{return{ok:!1,error:"network"}}}function Ft(e){return{invalid_format:"rd-err-format",not_found:"rd-err-not-found",rd_unreachable:"rd-err-unreachable",parse_error:"rd-err-unknown",network:"rd-err-unreachable"}[e]||"rd-err-unknown"}function Ge(e){const n=document.querySelector(`[data-field="${e}"]`);return n?(n.value||"").trim():""}function Ce(e,n,a){const o=document.querySelector(`[data-rd-status="${e}"]`);o&&(o.innerHTML=n,o.className="rd-status"+(a?" "+a:""))}async function Wn(e){const a=Ge(e==="seller"?"seller_tax":"buyer_tax");Ce(e,t("rd-verifying"),"loading");const o=await Nt("/api/rd/verify",{tax_id:a});if(!o)return;if(!o.ok){Ce(e,t(Ft(o.error)),"error");return}o.data&&o.data.valid?Ce(e,`<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="2"><path d="M3 8l3 3 7-7"/></svg> ${escapeHtml(t("rd-status-valid"))}`,"valid"):Ce(e,t("rd-status-invalid"),"invalid")}async function Xn(e){const a=Ge(e==="seller"?"seller_tax":"buyer_tax");Ce(e,t("rd-syncing"),"loading");const o=await Nt("/api/rd/lookup",{tax_id:a,branch:0});if(o){if(!o.ok){Ce(e,t(Ft(o.error)),"error");return}Ce(e,`<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="2"><path d="M3 8l3 3 7-7"/></svg> ${escapeHtml(t("rd-status-valid"))}`,"valid"),Zn(e,o.data)}}function Zn(e,n){const a=e==="seller"?"seller_name":"buyer_name",o=e==="seller"?"seller_addr":"buyer_addr",s=Ge(a),i=Ge(o),r=[];n.name&&n.name!==s&&r.push({field:a,label:t("rd-field-name"),current:s,official:n.name}),n.address&&n.address!==i&&r.push({field:o,label:t("rd-field-address"),current:i,official:n.address});const f=[];n.branch_label&&f.push(`<strong>${t("rd-field-branch")}:</strong> ${escapeHtml(n.branch_label)}`),n.post_code&&f.push(`<strong>${t("rd-field-postcode")}:</strong> ${escapeHtml(n.post_code)}`);let l=document.getElementById("rd-sync-modal");if(l||(l=document.createElement("div"),l.id="rd-sync-modal",l.className="rd-modal-mask",document.body.appendChild(l)),r.length===0)l.innerHTML=`
            <div class="rd-modal">
        ...
        `}l.classList.add("show");const d=()=>l.classList.remove("show");l.querySelector(".rd-modal-close").addEventListener("click",d),l.querySelectorAll("[data-rd-modal-close]").forEach(p=>p.addEventListener("click",d)),l.addEventListener("click",p=>{p.target===l&&d()});const c=l.querySelector("[data-rd-modal-apply]");c&&c.addEventListener("click",()=>{const p=_results[_drawerIdx];if(!p){d();return}l.querySelectorAll("[data-rd-apply]:checked").forEach(u=>{const v=u.dataset.field,_=u.dataset.value;p.edits[v]=_,p.merged_fields[v]=_;const M=document.querySelector(`[data-field="${v}"]`);M&&(M.value=_);const I=document.querySelector(`[data-field-wrap="${v}"]`);I&&I.classList.add("edited")}),updateDrawerEditCount(),renderResults(),d()})}window.callRdVerify=Wn;window.callRdSync=Xn;function Qn(e){const n={invoice_number:null,date:null,total_amount:null,tax_ids:[],seller_name:"",seller_tax:"",seller_addr:"",buyer_name:"",buyer_tax:"",buyer_addr:"",subtotal:"",vat:"",notes:"",items:[]},a=e.filter(s=>!s.is_duplicate&&!s.is_copy),o=a.length>0?a:e;for(const s of o){const i=s.fields||{};!n.invoice_number&&i.invoice_number&&(n.invoice_number=i.invoice_number),!n.date&&i.date&&(n.date=i.date),!n.total_amount&&i.total_amount&&(n.total_amount=i.total_amount),!n.subtotal&&i.subtotal&&(n.subtotal=i.subtotal),!n.vat&&i.vat&&(n.vat=i.vat),!n.seller_name&&i.seller_name&&(n.seller_name=i.seller_name),!n.seller_tax&&i.seller_tax&&(n.seller_tax=i.seller_tax),!n.seller_addr&&i.seller_addr&&(n.seller_addr=i.seller_addr),!n.buyer_name&&i.buyer_name&&(n.buyer_name=i.buyer_name),!n.buyer_tax&&i.buyer_tax&&(n.buyer_tax=i.buyer_tax),!n.buyer_addr&&i.buyer_addr&&(n.buyer_addr=i.buyer_addr),!n.notes&&i.notes&&(n.notes=i.notes),Array.isArray(i.items)&&i.items.length&&n.items.push(...i.items),Array.isArray(i.tax_ids)&&n.tax_ids.push(...i.tax_ids)}return n.tax_ids=[...new Set(n.tax_ids)],!n.seller_tax&&n.tax_ids[0]&&(n.seller_tax=n.tax_ids[0]),!n.buyer_tax&&n.tax_ids[1]&&(n.buyer_tax=n.tax_ids[1]),n}function ea(e){const n=e.target.dataset.field,a=e.target.value,o=_results[_drawerIdx],s=o.merged_fields[n];a===(s??"")?delete o.edits[n]:(o.edits[n]=a,o.merged_fields[n]=a);const i=document.querySelector(`[data-field-wrap="${n}"]`);i&&i.classList.toggle("edited",o.edits[n]!==void 0),zt(),renderResults()}function zt(){const e=_results[_drawerIdx],n=e?Object.keys(e.edits).length:0,a=document.getElementById("drawer-edit-count-sub");a&&(a.textContent=n>0?t("drawer-edit-count",{n}):"")}window.mergeFields=Qn;window.onFieldEdit=ea;window.updateDrawerEditCount=zt;function ta(){document.querySelectorAll(".force-pw-overlay").forEach(a=>a.remove());const e=document.createElement("div");e.className="force-pw-overlay",e.innerHTML=`
    ...
    `;let s=_results.map((r,f)=>({...r,_idx:f}));if(_searchKeyword){const r=_searchKeyword.toLowerCase();s=s.filter(f=>(f.filename||"").toLowerCase().includes(r)||(f.merged_fields.invoice_number||"").toLowerCase().includes(r))}_sortKey&&s.sort((r,f)=>{let l,d;return _sortKey==="filename"?(l=r.filename,d=f.filename):_sortKey==="invoice_no"?(l=r.merged_fields.invoice_number,d=f.merged_fields.invoice_number):_sortKey==="invoice_date"?(l=r.merged_fields.date,d=f.merged_fields.date):_sortKey==="total"?(l=parseFloat(r.merged_fields.total_amount)||0,d=parseFloat(f.merged_fields.total_amount)||0):_sortKey==="confidence"?(l=r.confidence,d=f.confidence):(l="",d=""),l<d?_sortDir==="asc"?-1:1:l>d?_sortDir==="asc"?1:-1:0});const i=document.getElementById("results-tbody");i.innerHTML=s.map((r,f)=>{const l=r.merged_fields,d=`<span class="empty-cell">${t("empty-val")}</span>`,c="conf-tip-"+(r.confidence||"low"),p="conf-"+(r.confidence||"low"),u=t(c),v=t(p);return`
            <tr data-idx="${r._idx}">
                <td class="num">${f+1}</td>
        ...
        `}).join(""),document.querySelectorAll("#results-table th").forEach(r=>{r.classList.remove("sort-asc","sort-desc"),r.dataset.sort===_sortKey&&r.classList.add("sort-"+_sortDir)}),i.querySelectorAll("tr").forEach(r=>{r.addEventListener("click",()=>{const f=parseInt(r.dataset.idx,10);Vt(f)})})}document.querySelectorAll("#results-table th").forEach(e=>{e.classList.contains("no-sort")||e.addEventListener("click",()=>{const n=e.dataset.sort;_sortKey===n?_sortDir=_sortDir==="asc"?"desc":"asc":(_sortKey=n,_sortDir="asc"),et()})});let Ct=null;document.getElementById("search-input").addEventListener("input",e=>{const n=e.target.value;document.getElementById("search-clear").style.display=n?"":"none",clearTimeout(Ct),Ct=setTimeout(()=>{_searchKeyword=n.trim(),et(),Ot()},200)});document.getElementById("search-clear").addEventListener("click",()=>{const e=document.getElementById("search-input");e.value="",_searchKeyword="",document.getElementById("search-clear").style.display="none",et(),Ot(),e.focus()});function Ot(){const e=document.getElementById("search-matches");if(!e)return;if(!_searchKeyword){e.textContent="";return}const n=_searchKeyword.toLowerCase();let a=0;for(const o of _results)[o.filename,o.merged_fields?.invoice_number,o.merged_fields?.seller_name,o.merged_fields?.buyer_name].filter(Boolean).join(" ").toLowerCase().includes(n)&&a++;e.textContent=t("search-matches",{n:a})}function Vt(e){_drawerIdx=e;const n=_results[e];if(!n)return;document.getElementById("drawer-title").textContent=n.filename;const a=n.engine==="cache"||n.from_cache,o=a?t("badge-cached-hint"):`${(n.elapsed_ms/1e3).toFixed(1)}s`;document.getElementById("drawer-sub").innerHTML=`
    ...
    `,updateDrawerEditCount();const s=_userInfo&&_userInfo.can_edit_fields,i=_userInfo&&_userInfo.can_verify_tax,r=n.merged_fields,f=document.getElementById("drawer-body"),l=s?"":`
    ...
    `,d=i?"":`<span class="tax-badge unverified" data-tip="${escapeHtml(t("tax-tip-unverified"))}">${t("tax-unverified")}</span>`;if(f.innerHTML=`
        ${l}
        ...
        <div class="drawer-section">
            ...
            ${r.wht_amount||r.wht_rate?`
                ${ye("wht_amount","drawer-lbl-wht-amount",r.wht_amount,"input",s,na(r.wht_rate))}
            `:""}
        </div>
        ...
        <div class="drawer-section">
            ...
            ${ye("seller_tax","drawer-lbl-tax",r.seller_tax,"input",s,d,St("seller"))}
        ...
        <div class="drawer-section">
            ...
            ${ye("buyer_tax","drawer-lbl-tax",r.buyer_tax,"input",s,d,St("buyer"))}
        ...
        <div class="drawer-section">
            ...
            ${r.items&&r.items.length>0?aa(r.items):`<div class="drawer-items-empty">${t("drawer-items-empty")}</div>`}
        </div>
...
`))}</pre>
    ...
    `,s?f.querySelectorAll("[data-field]").forEach(c=>{c.addEventListener("input",onFieldEdit)}):f.querySelectorAll("[data-field]").forEach(c=>{c.setAttribute("readonly","readonly")}),document.getElementById("drawer-mask").classList.add("show"),document.getElementById("drawer").classList.add("show"),injectOcrPushButton(),typeof window.bindDrawerClient=="function"){const c=n._historyId||n.history_id||null;window.bindDrawerClient(c,n.client_id||null)}typeof window.fillCategoryDatalist=="function"&&window.fillCategoryDatalist(),setTimeout(()=>{const c=document.getElementById("drawer-cat-input");c&&!c.value&&!c.readOnly&&c.focus()},80)}function na(e){return e?`<span class="wht-badge">${escapeHtml(e)}%</span>`:""}function ye(e,n,a,o,s,i,r){const f=_results[_drawerIdx],l=f&&f.edits[e]!==void 0?f.edits[e]:a,d=f&&f.edits[e]!==void 0&&f.edits[e]!==a,c=escapeHtml(l??""),p=s?"":"readonly",u=o==="textarea"?`<textarea data-field="${e}" rows="2">${c}</textarea>`:`<input type="text" data-field="${e}" value="${c}">`;return`
    ...
    `}function St(e){return _userInfo&&_userInfo.can_verify_tax?`
    ...
    `:`<button class="rd-btn-locked" data-upgrade="plus" type="button" title="${escapeHtml(t("rd-tip-upgrade"))}">
        ...
        `).join("")}
    `}function oa(){document.getElementById("drawer-mask").classList.remove("show"),document.getElementById("drawer").classList.remove("show");const e=document.getElementById("drawer-history-save");e&&e.remove();const n=document.getElementById("drawer-ocr-push");n&&n.remove();const a=document.getElementById("drawer-ocr-push-btn");a&&a.remove(),_drawerIdx=-1}window.renderResults=et;window.openDrawer=Vt;window.closeDrawer=oa;function sa(){const e=_results[_drawerIdx];if(!e||e._historyMode||!_userInfo||!_userInfo.can_push_erp||!e._historyId&&!e.history_id)return;const n=e._historyId||e.history_id,a=document.querySelector(".drawer-header");if(!a||document.getElementById("drawer-ocr-push-btn"))return;const o=(window._erpEndpoints||_erpEndpoints||[]).filter(function(f){return f&&f.enabled!==!1});if(o.length===0)return;const s=document.createElement("button");s.id="drawer-ocr-push-btn",s.className="drawer-push-btn";let i;if(o.length===1){const f=o[0].name||o[0].adapter||"ERP";i=t("btn-push-to-name",{name:f}),s.title=i}else i=t("btn-push-erp")+" ▾",s.title=t("btn-push-erp-pick-tip");s.innerHTML=`
        <svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
            <path d="M2 8h9M8 5l3 3-3 3"/>
            <rect x="11" y="3" width="3" height="10" rx="1"/>
        </svg>
        <span>${escapeHtml(i)}</span>
    `,s.addEventListener("click",function(f){f.preventDefault(),f.stopPropagation(),o.length===1?Ut(n,o[0].id):ia(s,n,o)});const r=a.querySelector(".drawer-diagnose");r?a.insertBefore(s,r):a.appendChild(s)}function ia(e,n,a){document.querySelectorAll(".drawer-push-picker").forEach(l=>l.remove());const o=e.getBoundingClientRect(),s=document.createElement("div");s.className="drawer-push-picker history-popover",s.style.position="fixed",s.style.top=o.bottom+6+"px",s.style.left=Math.max(8,o.right-240)+"px",s.style.minWidth="220px",s.style.zIndex="12000";const i=a.map(function(l){const d=escapeHtml(l.name||l.adapter||"ERP"),c=escapeHtml((l.adapter||"").toLowerCase()),u=l.is_default?'<span style="font-size:10px;color:#0a7a2c;background:#d6f5e0;padding:1px 6px;border-radius:999px;margin-left:6px;">'+escapeHtml(t("ep-default"))+"</span>":"";return'<button type="button" data-ep-id="'+escapeHtml(l.id)+'" style="display:flex;align-items:center;justify-content:space-between;width:100%;text-align:left;"><span><span style="color:#5d5d57;font-size:11px;margin-right:6px;">'+c+"</span>"+d+u+"</span></button>"}).join("");s.innerHTML=i,document.body.appendChild(s);const r=()=>{s.remove(),document.removeEventListener("click",f,!0)},f=l=>{!s.contains(l.target)&&l.target!==e&&!e.contains(l.target)&&r()};setTimeout(()=>document.addEventListener("click",f,!0),0),s.addEventListener("click",l=>{const d=l.target.closest("[data-ep-id]");if(!d)return;const c=d.getAttribute("data-ep-id");r(),Ut(n,c)})}async function Ut(e,n){const a=document.getElementById("drawer-ocr-push-btn");a&&(a.disabled=!0);try{const o={history_id:e};n&&(o.endpoint_id=n);const s=await fetch("/api/erp/push",{method:"POST",headers:{Authorization:"Bearer "+token,"Content-Type":"application/json"},body:JSON.stringify(o)}),i=await s.json();if(!s.ok){const r=i&&i.detail?i.detail:"err.unknown";r==="erp.no_default_endpoint"?showToast(t("erp-push-no-endpoint"),"warn"):r==="erp.endpoint_disabled"?(showToast(t("erp-push-disabled-tip")||t("card-disabled-tip")||"Endpoint disabled","warn"),typeof window._refreshErpEndpointsCache=="function"&&window._refreshErpEndpointsCache()):showToast(t("erp-push-fail",{err:r}),"fail");return}i.ok?showToast(t("erp-push-ok",{name:i.endpoint_name||""})):showToast(t("erp-push-fail",{err:i.error_msg||"unknown"}),"fail")}catch(o){showToast(t("erp-push-fail",{err:o.message}),"fail")}finally{a&&(a.disabled=!1)}}window.injectOcrPushButton=sa;const ra=[{id:"input_vat",nameKey:"tpl-input-vat",descKey:"tpl-input-vat-desc",badge:"recommended"},{id:"standard",nameKey:"tpl-standard",descKey:"tpl-standard-desc"},{id:"sales_detail_th",nameKey:"export-tpl-sales-detail",descKey:"export-tpl-sales-detail-desc",badge:"new"},{id:"print",nameKey:"tpl-print",descKey:"tpl-print-desc"}];function Gt(){try{const e=localStorage.getItem("pn_export_tpl")||"input_vat";return e==="erp"?"input_vat":e}catch{return"input_vat"}}function la(e){try{localStorage.setItem("pn_export_tpl",e||"input_vat")}catch{}}async function Kt(e){if(_results.length===0)return;e=e||"input_vat";const n=document.getElementById("btn-export");n&&(n.disabled=!0,n.classList.add("loading"));try{let a,o=`pearnly-export-${Date.now()}.xlsx`;if(e==="sales_detail_th"){const d=[];for(const c of _results){const p=c.invoices&&c.invoices.length>0?c.invoices:null;if(p&&p.length>1)for(let u=0;u<p.length;u++){const v=p[u]||{};d.push({filename:c.filename+" #"+(u+1)+"/"+p.length,engine:c.engine,merged_fields:v.fields||{}})}else d.push({filename:c.filename,engine:c.engine,merged_fields:c.merged_fields})}a=await apiPost("/api/ocr/export",{records:d,lang:currentLang,template:"sales_detail_th"})}else{const d=[];for(const p of _results)p.history_ids&&Array.isArray(p.history_ids)?d.push(...p.history_ids):p.history_id&&d.push(p.history_id);if(d.length===0){showToast(t("toast-export-error"),"error");return}const c=localStorage.getItem("mrpilot_token");a=await fetch("/api/reports/history/batch_export",{method:"POST",headers:{Authorization:"Bearer "+c,"Content-Type":"application/json"},body:JSON.stringify({template:e,lang:currentLang,history_ids:d,client_id:null})}),o=`pearnly-${e}-${Date.now()}.xlsx`}if(!a)return;if(!a.ok){let d="HTTP "+a.status;try{const p=await a.json();p&&p.detail&&(d=typeof p.detail=="string"?p.detail:JSON.stringify(p.detail))}catch(p){console.warn("[export] resp.json err.detail parse failed:",p)}const c=typeof d=="string"&&d.indexOf(".")>0?"err."+d:null;showToast(c?t(c):t("toast-export-error")+" · "+d,"error");return}const s=await a.blob();let i=o;const r=a.headers.get("X-Filename");if(r)i=r;else{const c=(a.headers.get("Content-Disposition")||"").match(/filename\*=UTF-8''([^;]+)/i);if(c)try{i=decodeURIComponent(c[1])}catch{}}const f=URL.createObjectURL(s),l=document.createElement("a");l.href=f,l.download=i,document.body.appendChild(l),l.click(),document.body.removeChild(l),URL.revokeObjectURL(f),showToast(t("toast-export-success"),"success")}catch(a){console.error(a),showToast(t("toast-export-error"),"error")}finally{n&&(n.disabled=!1,n.classList.remove("loading"))}}document.getElementById("btn-export").addEventListener("click",()=>{Kt(Gt())});function ca(){const e=document.getElementById("export-split-wrap");if(!e)return;let n=document.getElementById("export-dropdown");if(n){n.remove();return}n=document.createElement("div"),n.id="export-dropdown",n.className="export-dropdown";const a=Gt(),o=ra.map(i=>{const r=i.badge==="recommended"?`<span class="export-dd-badge badge-rec">${escapeHtml(t("report-recommended"))}</span>`:i.badge==="new"?`<span class="export-dd-badge badge-new">${escapeHtml(t("tpl-badge-new"))}</span>`:"";return`
    ...
    `;n.innerHTML=o+s,e.appendChild(n)}function ct(){const e=document.getElementById("export-dropdown");e&&e.remove()}const dt=document.getElementById("btn-export-arrow");dt&&dt.addEventListener("click",e=>{e.stopPropagation(),!dt.disabled&&ca()});document.addEventListener("click",e=>{const n=e.target.closest(".export-dd-item");if(n){const a=n.getAttribute("data-tpl");if(a==="__custom"){ct(),showToast(t("cs-coming-soon"),"info");return}la(a),ct(),Kt(a);return}e.target.closest("#btn-export-arrow")||ct()});function da(){const e=document.getElementById("btn-export-arrow"),n=document.getElementById("btn-export");e&&n&&(e.disabled=n.disabled)}setInterval(da,300);function bt(){const e=document.getElementById("history-batch-bar"),n=document.getElementById("history-batch-count"),a=document.getElementById("history-check-all");if(!e||!n)return;const o=_historySelected.size;if(o>0?(e.style.display="",n.textContent=t("history-batch-count",{n:o})):e.style.display="none",a){const s=_historyState.items||[];if(s.length===0)a.checked=!1,a.indeterminate=!1;else{const i=s.filter(r=>_historySelected.has(r.id)).length;a.checked=i===s.length,a.indeterminate=i>0&&i<s.length}}}function pa(){_historySelected.clear(),bt()}async function yt(){if(!_userInfo){setTimeout(()=>yt(),300);return}const e=document.getElementById("history-free-block"),n=document.getElementById("history-main"),a=document.getElementById("history-empty");if(!e||!n||!a){console.warn("[History] container missing");return}if(!_userInfo.can_view_history){e.style.display="",n.style.display="none",a.style.display="none";return}e.style.display="none",_historyState.loading=!0;try{const o=_historyState.page*_historyState.pageSize,s=new URLSearchParams({limit:_historyState.pageSize,offset:o});_historyState.keyword&&s.set("keyword",_historyState.keyword);const i=typeof window.getCurrentClientId=="function"?window.getCurrentClientId():null;i&&s.set("client_id",String(i));const r=await fetch(`/api/history?${s}`,{headers:{Authorization:"Bearer "+token}});if(r.status===401){localStorage.removeItem("mrpilot_token");const d=await r.json().catch(()=>({}));if((typeof d.detail=="string"?d.detail:d.detail&&d.detail.code||"")==="auth.session_revoked"){_showSessionRevokedModal();return}window.location.href="/";return}const f=await r.json();_historyState.items=f.items||[],_historyState.total=f.total||0;const l=new Set(_historyState.items.map(d=>d.id));for(const d of Array.from(_historySelected))l.has(d)||_historySelected.delete(d);Yt()}catch(o){console.error("load history failed",o)}finally{_historyState.loading=!1}}function Yt(){const e=document.getElementById("history-main"),n=document.getElementById("history-empty"),a=_historyState.items,o=document.getElementById("history-search-matches");if(o&&(o.textContent=_historyState.keyword?t("search-matches",{n:_historyState.total}):""),a.length===0&&_historyState.total===0&&!_historyState.keyword){e.style.display="none",n.style.display="";return}e.style.display="",n.style.display="none";let s=0;a.forEach(d=>{d.confidence==="high"&&s++});const i=a.length>0?Math.round(s/a.length*100):0;document.getElementById("history-stats").innerHTML=`
        <div class="rh-stat">
    ...
    `;const r=document.getElementById("history-tbody");a.length===0?r.innerHTML=`<div class="history-row-empty">${escapeHtml(t("history-empty-title"))}</div>`:r.innerHTML=a.map(d=>{const c=new Date(d.created_at),p=String(c.getMonth()+1).padStart(2,"0"),u=String(c.getDate()).padStart(2,"0"),v=String(c.getHours()).padStart(2,"0"),_=String(c.getMinutes()).padStart(2,"0"),M=`${p}-${u} ${v}:${_}`,I=escapeHtml(d.filename||""),x=I.length>50?I.substring(0,50)+"…":I,b=d.invoice_no?escapeHtml(d.invoice_no):x,$=[];d.seller_name&&$.push(escapeHtml(d.seller_name)),d.invoice_no&&d.filename&&$.push(x);const S=$.join(" · ")||"-",F=d.category_tag?`<span class="history-badge category">${escapeHtml(d.category_tag)}</span>`:"",j=d.source_total&&d.source_total>1?`<span class="history-badge multi">${escapeHtml(t("invoice-part-of",{i:d.source_index||1,n:d.source_total}))}</span>`:"",w=d.total_amount!==null&&d.total_amount!==void 0?Number(d.total_amount).toLocaleString(void 0,{minimumFractionDigits:2,maximumFractionDigits:2}):'<span class="history-cell-amount-empty">—</span>',h=[];(d.total_amount===null||d.total_amount===void 0)&&h.push(t("field-amount")),d.invoice_no||h.push(t("field-invoice-no")),d.invoice_date||h.push(t("field-invoice-date")),d.seller_name||h.push(t("field-seller-name")),h.length>0&&`${escapeHtml(d.id)}${escapeHtml(t("history-needs-review-tip")+" · "+h.join(" · "))}${escapeHtml(t("history-needs-review-tip"))}${svgIcon("alert",14)}`,d.edited&&`${escapeHtml(t("history-edited",{n:d.edit_count||1}))}`;const y=d.smart_assigned_flag?`<span class="history-badge smart-assigned" title="${escapeHtml(t("history-smart-assigned"))}">${svgIcon("sparkle",11)}</span>`:"",L=d.confidence==="high"?"high":d.confidence==="medium"?"mid":"low",C=d.confidence==="high"?t("conf-high"):d.confidence==="medium"?t("conf-medium"):t("conf-low"),D=`<span class="history-badge conf-${L}">${escapeHtml(C)}</span>`;let B="";const P=d.source||"manual";return P==="email"?B=`<span class="history-badge source source-email" title="${escapeHtml(t("history-source-email"))}">${svgIcon("mail",11)}<span>${escapeHtml(t("history-source-email"))}</span></span>`:P==="folder"?B=`<span class="history-badge source source-folder" title="${escapeHtml(t("history-source-folder"))}">${svgIcon("folder",11)}<span>${escapeHtml(t("history-source-folder"))}</span></span>`:P==="api"&&(B=`<span class="history-badge source source-api" title="${escapeHtml(t("history-source-api"))}">${svgIcon("api",11)}<span>${escapeHtml(t("history-source-api"))}</span></span>`),`
                <div class="history-row" data-hid="${escapeHtml(d.id)}">
                    ...
                    <div class="history-cell-file">
                        <div class="history-cell-filename">${b} ${F} ${j} ${B} ${y}</div>
            ...
            `}).join(""),bt();const f=a.length>0?_historyState.page*_historyState.pageSize+1:0,l=_historyState.page*_historyState.pageSize+a.length;document.getElementById("history-pager-info").textContent=t("history-pager",{from:f,to:l,total:_historyState.total}),document.getElementById("history-prev").disabled=_historyState.page===0,document.getElementById("history-next").disabled=(_historyState.page+1)*_historyState.pageSize>=_historyState.total}window.loadHistoryPage=yt;window.renderHistoryList=Yt;window.updateHistoryBatchBar=bt;window.clearHistorySelection=pa;typeof currentRoute<"u"&&currentRoute==="history"&&yt();async function Ke(e){try{const n=await fetch(`/api/history/${encodeURIComponent(e)}`,{headers:{Authorization:"Bearer "+token}});if(!n.ok)return;const a=await n.json(),o=mergeFields(a.pages||[]),s={filename:a.filename,pages:a.pages,page_count:a.page_count,elapsed_ms:a.elapsed_ms,engine:"history",merged_fields:o,edits:{},confidence:a.confidence,archive_name:a.archive_name||null,category_tag:a.category_tag||null,_historyId:a.id,_historyMode:!0,client_id:a.client_id||null};_results.push(s),_drawerIdx=_results.length-1,openDrawer(_drawerIdx),fa(),typeof window.bindDrawerClient=="function"&&window.bindDrawerClient(a.id,a.client_id||null),ma(a.id)}catch(n){console.error("open history detail failed",n)}}async function ua(e){await Ke(e),requestAnimationFrame(()=>{const n=document.querySelector('[data-field="total_amount"]');if(n){try{n.focus()}catch{}try{n.select()}catch{}try{n.scrollIntoView({block:"center",behavior:"smooth"})}catch{}}})}function fa(){const e=document.getElementById("drawer-body");if(!e||document.getElementById("drawer-history-save"))return;const n=document.createElement("div");n.id="drawer-history-save",n.className="drawer-history-save-bar",n.innerHTML=`
    ...
    `,e.appendChild(n),document.getElementById("btn-save-history").addEventListener("click",ha),document.getElementById("btn-push-erp").addEventListener("click",va)}async function ma(e){}async function va(){showToast(t("erp-push-coming-soon")||"ERP 推送即将开放，敬请期待","info")}async function ha(){const e=_results[_drawerIdx];if(!e||!e._historyId)return;const n=JSON.parse(JSON.stringify(e.pages||[]));if(n.length>0){const o=n.findIndex(f=>!f.is_duplicate&&!f.is_copy),s=o>=0?o:0,i=n[s].fields||(n[s].fields={}),r={...e.edits};r.category_tag!==void 0&&(r.category=r.category_tag,delete r.category_tag),Object.assign(i,r)}const a=document.getElementById("btn-save-history");a&&(a.disabled=!0);try{if(!(await fetch(`/api/history/${encodeURIComponent(e._historyId)}`,{method:"PUT",headers:{Authorization:"Bearer "+token,"Content-Type":"application/json"},body:JSON.stringify({pages:n})})).ok)throw new Error("save failed");showAlert("info",t("history-save-ok")),setTimeout(hideAlerts,1500),closeDrawer(),e._historyMode&&_results.pop(),loadHistoryPage()}catch{showAlert("error",t("history-save-fail")),a&&(a.disabled=!1)}}function ga(e,n){document.querySelectorAll(".history-popover").forEach(d=>d.remove());const a=n.getBoundingClientRect(),o=(_historyState.items||[]).find(d=>d.id===e),s=o&&o.invoice_no?String(o.invoice_no):"",i=o&&o.has_pdf===!0,r=document.createElement("div");r.className="history-popover",r.innerHTML=`
    ...
    `,r.style.top=a.bottom+4+"px",r.style.left=a.right-160+"px",document.body.appendChild(r);const f=()=>{r.remove(),document.removeEventListener("click",l,!0)},l=d=>{!r.contains(d.target)&&d.target!==n&&f()};setTimeout(()=>document.addEventListener("click",l,!0),0),r.addEventListener("click",async d=>{const c=d.target.closest("[data-act]");if(!c||c.disabled)return;const p=c.dataset.act;if(f(),p==="copy-invno"){if(!s)return;try{await navigator.clipboard.writeText(s),showToast(t("history-copy-invno-ok",{no:s}),"success")}catch{try{const v=document.createElement("textarea");v.value=s,v.style.position="fixed",v.style.opacity="0",document.body.appendChild(v),v.select(),document.execCommand("copy"),document.body.removeChild(v),showToast(t("history-copy-invno-ok",{no:s}),"success")}catch{showToast(t("history-copy-invno-fail"),"error")}}}else if(p==="download-pdf"){const u=showToast(t("history-download-pdf-loading"),"loading",0);try{const v=await fetch(`/api/history/${encodeURIComponent(e)}/pdf`,{headers:{Authorization:"Bearer "+token}});if(!v.ok)throw new Error("download failed");const _=await v.blob(),M=URL.createObjectURL(_),I=document.createElement("a");I.href=M,I.download=o&&o.filename?o.filename.endsWith(".pdf")?o.filename:o.filename+".pdf":"invoice.pdf",document.body.appendChild(I),I.click(),document.body.removeChild(I),setTimeout(()=>URL.revokeObjectURL(M),5e3),u(),showToast(t("history-download-pdf-ok"),"success")}catch{u(),showToast(t("history-download-pdf-fail"),"error")}}else if(p==="delete"){if(!await showConfirm(t("history-confirm-delete"),{danger:!0}))return;try{if(!(await fetch(`/api/history/${encodeURIComponent(e)}`,{method:"DELETE",headers:{Authorization:"Bearer "+token}})).ok)throw new Error;showAlert("info",t("history-delete-ok")),setTimeout(hideAlerts,1500),loadHistoryPage()}catch{showAlert("error",t("history-delete-fail"))}}})}(function(){document.addEventListener("click",r=>{const f=r.target.closest(".history-row"),l=r.target.closest("[data-hmenu]");if(l){r.stopPropagation(),ga(l.dataset.hmenu,l);return}const d=r.target.closest("[data-review]");if(d){r.stopPropagation(),Ke(d.dataset.review);return}const c=r.target.closest("[data-fill-amount]");if(c){r.stopPropagation(),ua(c.dataset.fillAmount);return}r.target.closest(".history-row-check")||r.target.closest(".history-cell-check")||f&&!r.target.closest("[data-hmenu]")&&Ke(f.dataset.hid)});const n=document.getElementById("history-tbody");n&&n.addEventListener("change",r=>{const f=r.target.closest(".history-row-check");if(!f)return;const l=f.dataset.hid;f.checked?_historySelected.add(l):_historySelected.delete(l),updateHistoryBatchBar()});const a=document.getElementById("history-check-all");a&&a.addEventListener("change",r=>{const f=r.target.checked;for(const l of _historyState.items)f?_historySelected.add(l.id):_historySelected.delete(l.id);document.querySelectorAll(".history-row-check").forEach(l=>{l.checked=f}),updateHistoryBatchBar()});const o=document.getElementById("history-batch-cancel");o&&o.addEventListener("click",()=>{clearHistorySelection(),document.querySelectorAll(".history-row-check").forEach(r=>{r.checked=!1})});const s=document.getElementById("history-batch-delete");s&&s.addEventListener("click",async()=>{const r=_historySelected.size;if(r===0||!await showConfirm(t("history-batch-confirm",{n:r}),{danger:!0}))return;const l=Array.from(_historySelected);try{const d=await fetch("/api/history/batch-delete",{method:"POST",headers:{Authorization:"Bearer "+token,"Content-Type":"application/json"},body:JSON.stringify({ids:l})});if(!d.ok)throw new Error("batch delete failed");const c=await d.json();showToast(t("history-batch-done",{n:c.deleted||0}),"success"),clearHistorySelection(),loadHistoryPage()}catch(d){console.error("batch delete",d),showToast(t("history-batch-fail"),"error")}});let i=null;document.getElementById("history-search").addEventListener("input",r=>{const f=r.target.value;document.getElementById("history-search-clear").style.display=f?"":"none",clearTimeout(i),i=setTimeout(()=>{_historyState.keyword=f.trim(),_historyState.page=0,clearHistorySelection(),loadHistoryPage()},300)}),document.getElementById("history-search-clear").addEventListener("click",()=>{const r=document.getElementById("history-search");r.value="",_historyState.keyword="",_historyState.page=0,clearHistorySelection(),document.getElementById("history-search-clear").style.display="none",loadHistoryPage(),r.focus()}),document.getElementById("history-range").addEventListener("change",r=>{_historyState.range=parseInt(r.target.value,10),_historyState.page=0,clearHistorySelection(),loadHistoryPage()}),document.getElementById("history-prev").addEventListener("click",()=>{_historyState.page>0&&(_historyState.page--,clearHistorySelection(),loadHistoryPage())}),document.getElementById("history-next").addEventListener("click",()=>{(_historyState.page+1)*_historyState.pageSize<_historyState.total&&(_historyState.page++,clearHistorySelection(),loadHistoryPage())})})();window.openHistoryDrawer=Ke;const Me=document.getElementById("drop-zone"),wt=document.getElementById("file-input");Me.addEventListener("click",()=>wt.click());wt.addEventListener("change",e=>Jt(e.target.files));["dragover","dragenter"].forEach(e=>{Me.addEventListener(e,n=>{n.preventDefault(),Me.classList.add("drag-over")})});["dragleave","drop"].forEach(e=>{Me.addEventListener(e,n=>{n.preventDefault(),Me.classList.remove("drag-over")})});Me.addEventListener("drop",e=>{e.preventDefault(),Jt(e.dataTransfer.files)});const ba=/\.(pdf|png|jpe?g|webp|tiff?|bmp|gif|xlsx?|xlsm|csv|tsv|docx?|txt)$/i;function ut(e){return e.type&&e.type.startsWith("image/")||/\.(png|jpe?g|webp|tiff?|bmp|gif)$/i.test(e.name)}function ya(e){return e.type==="application/pdf"||/\.pdf$/i.test(e.name)}function wa(e){return ya(e)||ut(e)||ba.test(e.name)}function Jt(e){hideAlerts();const n=Array.from(e),a=n.filter(wa);a.length!==n.length&&showAlert("warn",t("alert-unsupported-format"));const o=a.filter(f=>!ut(f)),s=a.filter(ut),i=new Set(_selectedFiles.map(f=>f.name+"_"+f.size));for(const f of o){const l=f.name+"_"+f.size;i.has(l)||(_selectedFiles.push({file:f,name:f.name,size:f.size,status:"waiting",errorKey:null,errorParams:null}),i.add(l))}if(s.length>0)try{handleCameraImages(s,"gallery")}catch(f){console.error("[upload] image route failed",f)}const r=getMaxFiles();_selectedFiles.length>r&&(showAlert("warn",t("alert-file-count",{n:r})),_selectedFiles=_selectedFiles.slice(0,r)),nt(),_t(),wt.value=""}let Ve=!1;function nt(){const e=document.getElementById("file-list");if(!e)return;if(_selectedFiles.length===0){e.classList.remove("has-files"),e.innerHTML="";return}e.classList.add("has-files");const n=_selectedFiles.length,a=_selectedFiles.filter(p=>p.status==="processing"||p.status==="retrying").length,o=_selectedFiles.filter(p=>p.status==="success").length,s=_selectedFiles.filter(p=>p.status==="error").length;let i=`<span class="count">${escapeHtml(t("file-list-total",{n}))}</span>`;const r=[];a&&r.push(`<span style="color: var(--accent, #111111);">${a} ${escapeHtml(t("status-processing"))}</span>`),o&&r.push(`<span style="color: var(--success, #059669);">${o} ${escapeHtml(t("status-success"))}</span>`),s&&r.push(`<span style="color: var(--danger, #dc2626);">${s} ${escapeHtml(t("status-error"))}</span>`),r.length&&(i+=" · "+r.join(" · "));const f=Ve?t("file-list-collapse"):t("file-list-expand"),l=_selectedFiles.map((p,u)=>{let v=t("status-"+p.status);p.status==="retrying"&&(v=t("status-retrying")),p.status==="error"&&p.errorKey&&(v=t(p.errorKey,p.errorParams||{}));const _=p.status==="processing"||p.status==="retrying"?'<span class="spinner"></span>':"",M=p.status==="error"&&p.canRetry?`<button class="file-retry-btn" data-retry-idx="${u}" title="${escapeHtml(t("upload-retry-btn"))}">${svgIcon("refresh",12)}<span>${escapeHtml(t("upload-retry-btn"))}</span></button>`:"",I=p.status==="success"&&p.fromCache?`<span class="file-cache-badge">${svgIcon("cache",11)}<span>${escapeHtml(t("cache-hit-badge"))}</span></span>`:"";return`
            <li class="file-item">
                ...
                ${I}
                <span class="file-status ${p.status}">${_}${v}</span>
                ${M}
            </li>
        `}).join("");e.innerHTML=`
    ...
    `;const d=document.getElementById("file-list-toggle");d&&d.addEventListener("click",()=>{Ve=!Ve,nt()});const c=document.getElementById("file-list-body");c&&!c.dataset.retryBound&&(c.dataset.retryBound="1",c.addEventListener("click",async p=>{const u=p.target.closest(".file-retry-btn");if(!u)return;const v=parseInt(u.dataset.retryIdx||"-1",10);if(v<0||v>=_selectedFiles.length)return;const _=_selectedFiles[v];!_||_.status!=="error"||typeof window._reprocessFile=="function"&&await window._reprocessFile(_,!0)}))}function _t(){const e=document.getElementById("btn-start"),n=document.getElementById("btn-clear"),a=document.getElementById("btn-export"),o=_selectedFiles.some(s=>s.status==="waiting");e.disabled=_selectedFiles.length===0||!o,n.disabled=_selectedFiles.length===0&&_results.length===0,a.disabled=_results.length===0}document.getElementById("btn-clear").addEventListener("click",()=>{_selectedFiles=[],_results=[],nt(),renderResults(),_t(),hideAlerts()});window.renderFileList=nt;window.updateStartButton=_t;(function(){const n=document.getElementById("upload-alt-row"),a=document.getElementById("gallery-input"),o=document.getElementById("camera-input");if(!n)return;n.style.display="";const s=document.getElementById("btn-scan-doc");s&&o&&(s.addEventListener("click",async()=>{!(localStorage.getItem("mrpilot_camera_tips_skip")==="1")&&!await ka()||o.click()}),o.addEventListener("change",async f=>{const l=Array.from(f.target.files||[]);if(f.target.value="",l.length!==0)for(const d of l)await ft([d],"camera")}));const i=document.getElementById("btn-upload-pic");i&&a&&i.addEventListener("click",()=>a.click());const r=f=>async l=>{const d=Array.from(l.target.files||[]);if(l.target.value="",d.length===0)return;const c=d.filter(u=>u.type==="application/pdf"||/\.pdf$/i.test(u.name)),p=d.filter(u=>!c.includes(u));c.length>0&&await _a(c),p.length>0&&await ft(p,f)};a&&a.addEventListener("change",r("gallery"))})();async function _a(e){for(const a of e)_selectedFiles.push({file:a,name:a.name,size:a.size,status:"waiting",errorKey:null,errorParams:null});const n=getMaxFiles();_selectedFiles.length>n&&(showAlert("warn",t("alert-file-count",{n})),_selectedFiles=_selectedFiles.slice(0,n)),renderFileList(),updateStartButton()}function ka(){return new Promise(e=>{const n=document.getElementById("camera-tips-modal"),a=document.getElementById("camera-tips-ok"),o=document.getElementById("camera-tips-cancel"),s=document.getElementById("camera-tips-skip");if(!n||!a){e(!0);return}s&&(s.checked=!1),n.style.display="flex";const i=f=>{n.style.display="none",s&&s.checked&&localStorage.setItem("mrpilot_camera_tips_skip","1"),a.onclick=null,o&&(o.onclick=null),n.onclick=null,document.removeEventListener("keydown",r),e(f)},r=f=>{f.key==="Escape"&&i(!1)};a.onclick=()=>i(!0),o&&(o.onclick=()=>i(!1)),n.onclick=f=>{f.target===n&&i(!1)},document.addEventListener("keydown",r),setTimeout(()=>a.focus(),50)})}async function Ye(e){return new Promise(n=>{const a=new FileReader;a.onerror=()=>n({warnings:[],width:0,height:0,brightness:128}),a.onload=()=>{const o=new Image;o.onerror=()=>n({warnings:[],width:0,height:0,brightness:128}),o.onload=()=>{const s=[],i=o.naturalWidth,r=o.naturalHeight;(i<1e3||r<1e3)&&s.push("low_res");try{const f=document.createElement("canvas");f.width=64,f.height=64;const l=f.getContext("2d");l.drawImage(o,0,0,64,64);const d=l.getImageData(0,0,64,64).data;let c=0,p=0;for(let v=0;v<d.length;v+=4)c+=.299*d[v]+.587*d[v+1]+.114*d[v+2],p++;const u=p?c/p:128;u<70?s.push("too_dark"):u>235&&s.push("too_bright"),n({warnings:s,width:i,height:r,brightness:u})}catch{n({warnings:s,width:i,height:r,brightness:128})}},o.src=a.result},a.readAsDataURL(e)})}let _e=[],Le=null;async function ft(e,n){if(hideAlerts(),!(!e||e.length===0)){if(typeof window.jspdf>"u"||!window.jspdf.jsPDF){showToast(t("camera-loading"),"info");for(let a=0;a<30&&(await new Promise(o=>setTimeout(o,100)),!(window.jspdf&&window.jspdf.jsPDF));a++);if(!window.jspdf||!window.jspdf.jsPDF){showToast(t("camera-lib-fail"),"error");return}}if(n==="camera"&&e.length===1){const a=e[0];let o={};try{o=await Ye(a)}catch{}_e.push({file:a,quality:o}),Le="camera",$e();return}if(n==="gallery"&&(e.length>=2||_e.length>0)){for(const a of e){let o={};try{o=await Ye(a)}catch{}_e.push({file:a,quality:o})}Le="gallery",$e();return}await Wt(e)}}async function xa(e){const n=new Set;for(const o of e)try{((await Ye(o)).warnings||[]).forEach(i=>n.add(i))}catch{}try{const o=await Xt(e);o&&_selectedFiles.push({file:o,name:o.name,size:o.size,status:"waiting",errorKey:null,errorParams:null})}catch(o){console.error("[camera] convert failed",o),showToast(t("camera-convert-fail"),"error");return}const a=getMaxFiles();_selectedFiles.length>a&&(showAlert("warn",t("alert-file-count",{n:a})),_selectedFiles=_selectedFiles.slice(0,a)),renderFileList(),updateStartButton(),showToast(t("camera-added-merged",{n:e.length}),"success"),n.size>0&&setTimeout(()=>{n.has("too_dark")?showToast(t("camera-quality-dark"),"warn"):n.has("low_res")?showToast(t("camera-quality-lowres"),"warn"):n.has("too_bright")&&showToast(t("camera-quality-overexposed"),"warn")},1e3)}function $e(){let e=document.getElementById("camera-buffer-bar");if(_e.length===0){e&&e.remove(),Le=null;return}e||(e=document.createElement("div"),e.id="camera-buffer-bar",e.className="camera-buffer-bar",document.body.appendChild(e));const n=_e.length,a=n>=2,o=Le==="gallery",s=o?t("camera-buffer-more-gallery"):t("camera-buffer-more");let i;a?o?i=`
    ...
    `,e.querySelector('[data-cbb-action="discard"]').onclick=()=>{_e=[],Le=null,$e()},e.querySelector('[data-cbb-action="more"]').onclick=()=>{const l=o?"gallery-input":"camera-input",d=document.getElementById(l);d&&d.click()};const r=e.querySelector('[data-cbb-action="merge"]');r&&(r.onclick=async()=>{const l=_e.map(d=>d.file);_e=[],Le=null,$e(),await xa(l)});const f=e.querySelector('[data-cbb-action="separate"]');f&&(f.onclick=async()=>{const l=_e.map(d=>d.file);_e=[],Le=null,$e(),await Wt(l)})}typeof window.subscribeI18n=="function"&&window.subscribeI18n("camera-buffer-bar",()=>{_e.length>0&&$e()});async function Wt(e){const n=new Set;let a=0;for(const s of e)try{((await Ye(s)).warnings||[]).forEach(f=>n.add(f));const r=await Xt([s]);r&&(_selectedFiles.push({file:r,name:r.name,size:r.size,status:"waiting",errorKey:null,errorParams:null}),a++)}catch(i){console.error("[camera] separate convert failed",i)}if(a===0){showToast(t("camera-convert-fail"),"error");return}const o=getMaxFiles();_selectedFiles.length>o&&(showAlert("warn",t("alert-file-count",{n:o})),_selectedFiles=_selectedFiles.slice(0,o)),renderFileList(),updateStartButton(),showToast(t("camera-added-separate",{n:a}),"success"),n.size>0&&setTimeout(()=>{n.has("too_dark")?showToast(t("camera-quality-dark"),"warn"):n.has("low_res")?showToast(t("camera-quality-lowres"),"warn"):n.has("too_bright")&&showToast(t("camera-quality-overexposed"),"warn")},1e3)}async function Xt(e){if(!e||e.length===0)return null;const{jsPDF:n}=window.jspdf,a=210,o=297,s=new n({unit:"mm",format:"a4",orientation:"p"});for(let d=0;d<e.length;d++){const c=e[d],{dataUrl:p,naturalW:u,naturalH:v}=await Ea(c);d>0&&s.addPage("a4","p");const _=u/v;let M=a-10,I=M/_;I>o-10&&(I=o-10,M=I*_);const x=(a-M)/2,b=(o-I)/2,$=c.type==="image/png"?"PNG":"JPEG";s.addImage(p,$,x,b,M,I,void 0,"FAST")}const i=s.output("blob"),r=new Date,f=r.getFullYear().toString()+String(r.getMonth()+1).padStart(2,"0")+String(r.getDate()).padStart(2,"0")+String(r.getHours()).padStart(2,"0")+String(r.getMinutes()).padStart(2,"0")+String(r.getSeconds()).padStart(2,"0"),l=e.length>1?`_${e.length}p`:"";return new File([i],`photo_${f}${l}.pdf`,{type:"application/pdf"})}function Ea(e){return new Promise((n,a)=>{const o=new FileReader;o.onerror=a,o.onload=()=>{const s=new Image;s.onerror=a,s.onload=()=>n({dataUrl:o.result,naturalW:s.naturalWidth,naturalH:s.naturalHeight}),s.src=o.result},o.readAsDataURL(e)})}window.handleCameraImages=ft;document.getElementById("btn-start").addEventListener("click",async()=>{if(hideAlerts(),document.getElementById("btn-start").disabled=!0,_userInfo&&_userInfo.plan==="free"){const c=await fetch("/api/health").then(p=>p.json()).catch(()=>null);c&&!c.ocr_ready&&(showAlert("info",t("alert-loading-engine")),startEnginePolling())}const e=_selectedFiles.filter(c=>c.status==="waiting"),n=6;async function a(c,p){if(window._ocrAborted)return c.status="cancelled",c.errorKey=null,renderFileList(),{};c.status=p?"retrying":"processing",c.canRetry=!1,renderFileList();const u=new AbortController,v=setTimeout(()=>u.abort("timeout"),9e4);window._ocrCtrls=window._ocrCtrls||new Set,window._ocrCtrls.add(u);try{const _=new FormData;_.append("file",c.file,c.name);try{if(typeof window.getCurrentClientId=="function"){const $=window.getCurrentClientId();$!=null&&_.append("client_id",String($))}}catch{}const M=await fetch("/api/ocr/recognize",{method:"POST",headers:{Authorization:"Bearer "+token},body:_,signal:u.signal});if(clearTimeout(v),window._ocrCtrls.delete(u),M.status===401||M.status===403){const S=await M.clone().json().catch(()=>({})),F=S&&S.detail,j=typeof F=="string"?F:F&&F.code||"";if(!j||j.startsWith("auth.")){if(localStorage.removeItem("mrpilot_token"),j==="auth.session_revoked")_showSessionRevokedModal();else{const w=j==="auth.password_changed_relogin"?"alert-password-changed-relogin":"alert-session";showToast(t(w),"error"),setTimeout(()=>{window.location.href="/"},1200)}return{abort:!0}}j==="quota.need_api_key"&&showToast(t("err.quota.need_api_key"),"error")}if(!M.ok){const S=(await M.json().catch(()=>({}))).detail;return typeof S=="string"?(c.errorKey="err."+S,c.errorParams=null):S&&S.code?(c.errorKey="err."+S.code,c.errorParams={...S,mb:_quota.max_file_size_mb}):(c.errorKey="err.unknown",c.errorParams=null),(c.errorKey==="err.unknown"||c.errorKey==="err.ocr.engine_error")&&(M.status===429?c.errorKey="err.rate_limit":M.status===502||M.status===503||M.status===504?c.errorKey="err.gemini_overloaded":M.status>=500&&(c.errorKey="err.server")),c.status="error",c.canRetry=!/not_pdf|invalid_pdf|file_too_large|too_many_pages|monthly_limit_exceeded|ip_limit_exceeded|plan_not_supported|need_api_key|not_invoice/.test(c.errorKey||""),renderFileList(),{}}const I=await M.json();c.status="success",c.fromCache=!!I.from_cache;const x=mergeFields(I.pages),b=I.confidence||(x.items&&x.items.length>0?"high":"low");if(_results.push({filename:I.filename,pages:I.pages,page_count:I.page_count,elapsed_ms:I.elapsed_ms,engine:I.engine,merged_fields:x,edits:{},confidence:b,history_id:I.history_id,history_ids:I.history_ids||[],invoice_count:I.invoice_count||1,invoices:I.invoices||[],archive_name:I.archive_name||null,category_tag:I.category_tag||null,auto_pushed:!!I.auto_pushed,typhoon_enhanced:!!I.typhoon_enhanced,typhoon_pages:I.typhoon_pages||[],from_cache:!!I.from_cache}),I.invoice_count&&I.invoice_count>1&&showToast(t("multi-invoice-toast",{file:I.filename,n:I.invoice_count}),"success"),I.missed_invoice_warnings&&I.missed_invoice_warnings.length){const $=I.missed_invoice_warnings.map(function(S){return S.page}).filter(function(S){return S!=null});showToast(t("missed-invoice-warn",{file:I.filename,pages:$.join(", ")}),"warn",8e3),console.warn("[OCR] possible missed invoice(s)",I.missed_invoice_warnings)}if(I.typhoon_enhanced&&I.typhoon_pages&&I.typhoon_pages.length&&showToast(t("typhoon-enhanced-toast",{file:I.filename,n:I.typhoon_pages.length}),"success"),I.fallback_used){const $=I.engine_chain||[],S=I.engine||"";let F;S==="typhoon_nvidia"?F="fallback-typhoon-nvidia-toast":S==="easyocr"?F="fallback-easyocr-toast":F="fallback-generic-toast",showToast(t(F,{file:I.filename}),"warn"),console.info("[OCR Chain]",$)}if(I.from_cache&&showToast(t("cache-hit-toast",{file:I.filename}),"info"),I.duplicate_warnings&&I.duplicate_warnings.length){window._dupQueue||(window._dupQueue=[]);for(const $ of I.duplicate_warnings)window._dupQueue.push({filename:I.filename,...$})}return I.auto_pushed&&showToast(t("auto-push-fired",{file:I.filename}),"info"),I.quota&&I.quota.used_this_month!=null&&_userInfo&&(_userInfo.used_this_month=I.quota.used_this_month,_userInfo.tenant_used=I.quota.used_this_month,renderInfoBar(),renderQuotaBanner()),renderFileList(),renderResults(),updateStartButton(),{}}catch(_){clearTimeout(v);try{window._ocrCtrls&&window._ocrCtrls.delete(u)}catch{}console.error("[Upload] failed for",c.file.name,_);const M=_&&(_.name==="AbortError"||_==="timeout"),I=M&&(u.signal.reason==="timeout"||_==="timeout"),x=_&&_.message&&/NetworkError|Failed to fetch/i.test(_.message);return M&&(u.signal.reason==="user_stop"||window._ocrAborted)?(c.status="cancelled",c.errorKey=null,c.canRetry=!1,renderFileList(),{}):(I?c.errorKey="err.timeout":M?c.errorKey="err.aborted":x?c.errorKey="err.network":(c.errorKey="err.unknown",c.errorParams={msg:_&&_.message?_.message:String(_)}),c.status="error",!p&&!window._ocrAborted&&(x||I)&&navigator.onLine!==!1&&(c.canRetry=!0,renderFileList(),await new Promise($=>setTimeout($,2e3)),c.status==="error"&&navigator.onLine!==!1&&!window._ocrAborted)?a(c,!0):(c.canRetry=!0,renderFileList(),{}))}}window._reprocessFile=a;let o=0,s=!1;async function i(){for(;o<e.length&&!s&&!window._ocrAborted;){const c=o++,p=await a(e[c]);if(p&&p.abort){s=!0;return}}}window._ocrAborted=!1,window._ocrCtrls=window._ocrCtrls||new Set;const r=document.getElementById("btn-start"),f=document.getElementById("btn-stop");r&&(r.style.display="none"),f&&(f.style.display="");try{typeof window._bigBatchStart=="function"&&window._bigBatchStart(e)}catch{}const l=[];for(let c=0;c<Math.min(n,e.length);c++)l.push(i());await Promise.all(l);try{typeof window._bigBatchStop=="function"&&window._bigBatchStop()}catch{}r&&(r.style.display=""),f&&(f.style.display="none");const d=!!window._ocrAborted;window._ocrAborted=!1,window._ocrCtrls.clear(),updateStartButton(),stopEnginePolling(),document.getElementById("alert-info").classList.contains("show")&&(showAlert("info",t("alert-engine-ready")),setTimeout(hideAlerts,2e3));try{const c={success:0,cancelled:0,network:0,timeout:0,quota:0,overloaded:0,rate:0,other:0};for(const u of e)if(u.status==="success")c.success++;else if(u.status==="cancelled")c.cancelled++;else if(u.status==="error"){const v=u.errorKey||"";v==="err.network"?c.network++:v==="err.timeout"||v==="err.aborted"?c.timeout++:v.indexOf("quota")>=0||v==="err.monthly_limit_exceeded"?c.quota++:v==="err.gemini_overloaded"||v==="err.server"?c.overloaded++:v==="err.rate_limit"?c.rate++:c.other++}const p=e.length;d?showToast(Ia(c,p),"warn",4e3):p>1&&c.network+c.timeout+c.quota+c.overloaded+c.rate+c.other>0&&showToast(Ba(c),"error",4500)}catch{}window._dupQueue&&window._dupQueue.length&&showDuplicateDialog()});function Ia(e,n){return t("ocr-summary-aborted").replace("{success}",e.success).replace("{cancelled}",e.cancelled).replace("{total}",n)}function Ba(e){const n=[];return e.success&&n.push(t("ocr-summary-success").replace("{n}",e.success)),e.network&&n.push(t("ocr-summary-network").replace("{n}",e.network)),e.timeout&&n.push(t("ocr-summary-timeout").replace("{n}",e.timeout)),e.quota&&n.push(t("ocr-summary-quota").replace("{n}",e.quota)),e.overloaded&&n.push(t("ocr-summary-overloaded").replace("{n}",e.overloaded)),e.rate&&n.push(t("ocr-summary-rate").replace("{n}",e.rate)),e.other&&n.push(t("ocr-summary-other").replace("{n}",e.other)),n.join(" · ")}document.addEventListener("click",e=>{if(!e.target.closest("#btn-stop")||window._ocrAborted)return;window._ocrAborted=!0,window._ocrCtrls&&window._ocrCtrls.size&&window._ocrCtrls.forEach(a=>{try{a.abort("user_stop")}catch{}});const n=document.getElementById("btn-stop");n&&(n.disabled=!0),typeof showToast=="function"&&showToast(t("ocr-stop-toast"),"warn",2e3),setTimeout(()=>{n&&(n.disabled=!1)},800)});function Zt(){if(!window._dupQueue||!window._dupQueue.length)return;const e=window._dupQueue.shift(),n=e.level==="exact",a=n?"dup-title-exact":"dup-title-likely",o=n?"dup-desc-exact":"dup-desc-likely",s=n?"#DC2626":"#D97706",i=n?"#FEE2E2":"#FEF3C7",r=v=>v!=null?Number(v).toLocaleString(void 0,{minimumFractionDigits:2,maximumFractionDigits:2}):"—",f=v=>v||"—",l=v=>{try{const _=new Date(v);return`${_.getFullYear()}-${String(_.getMonth()+1).padStart(2,"0")}-${String(_.getDate()).padStart(2,"0")}`}catch{return v}},d=e.invoice_total>1?` · ${t("invoice-part-of",{i:e.invoice_index,n:e.invoice_total})}`:"",c=(e.matched_fields||[]).map(v=>{const _=t("dup-field-"+v.replace("_","-"))||v;return`<span class="dup-field-chip">${escapeHtml(_)}</span>`}).join(" "),p=document.createElement("div");p.className="log-detail-modal",p.innerHTML=`
...
[`+S+" / "+F+"]")&&p(b),!1}async function p(b){const $=await d();if(typeof b=="function"&&s()!=="personal"&&$.length===1){f(Number($[0].id)),b();return}if(typeof window.openWorkspaceChooserUI=="function"){window.openWorkspaceChooserUI({clients:$,canCreate:o(),active:i(),onPersonal:l,onPick:function(S){f(Number(S)),typeof b=="function"&&b()},emptyHint:$.length?null:o()?a("ws-empty-owner","还没有工作空间。创建一个公司后,上传、对账和 ERP 推送都会归属到该公司。"):a("ws-empty-employee","你还没有可用的工作空间,请联系管理员分配。")});return}if(!$.length){const S=o()?a("ws-empty-owner","还没有工作空间。创建一个公司后,上传、对账和 ERP 推送都会归属到该公司。"):a("ws-empty-employee","你还没有可用的工作空间,请联系管理员分配。");typeof window.showToast=="function"&&window.showToast(S,"info")}}function u(b){const $=b||document.getElementById("workspace-switcher-root");if(!$)return;const S=s(),F=i();let j,w;if(S==="client"&&F!=null){const L=(window._workspaceClientsCache||[]).find(C=>Number(C.id)===Number(F));j=_("building"),w=L?L.name:a("ws-current-label","当前工作空间")}else j=_("user"),w=a("ws-personal","个人事务");$.innerHTML='<button class="ws-ctrl-btn" id="ws-ctrl-btn" type="button">'+j+'<span class="ws-ctrl-label">'+v(w)+"</span></button>";const h=$.querySelector("#ws-ctrl-btn");h&&h.addEventListener("click",()=>p(null))}function v(b){return String(b??"").replace(/[&<>"']/g,function($){return{"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"}[$]})}function _(b){const $='<svg class="ws-ic" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">';return b==="building"?$+'<rect x="2" y="7" width="20" height="14" rx="2"/><path d="M16 21V5a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v16"/></svg>':$+'<path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/></svg>'}function M(b){b=b||{};const $=b.clients||[],S=b.active,F=document.getElementById("ws-modal");F&&F.remove();const j=document.createElement("div");j.id="ws-modal",j.className="ws-modal";const h='<button type="button" class="ws-modal-item'+(s()==="personal"||S==null?" active":"")+'" data-ws-personal="1"><span class="ws-modal-item-ic">'+_("user")+'</span><span class="ws-modal-item-text" style="display:flex;flex-direction:column;align-items:flex-start;min-width:0;"><span class="ws-modal-item-name">'+v(a("ws-personal","个人事务"))+'</span><span class="ws-modal-item-desc" style="font-size:11px;color:#6b7280;font-weight:400;margin-top:2px;line-height:1.35;white-space:normal;">'+v(a("ws-personal-desc","用于临时识别、测试或处理不归属任何公司的文件。"))+"</span></span></button>";let y="";if($.length){const P=['<option value="">'+v(a("ws-select-ph","— 选择账套主体 —"))+"</option>"].concat($.map(function(J){const G=S!=null&&Number(S)===Number(J.id);return'<option value="'+v(J.id)+'"'+(G?" selected":"")+">"+v(J.name||"#"+J.id)+"</option>"}));y='<div class="ws-modal-select-row"><label class="ws-modal-select-label">'+v(a("ws-select-label","账套主体"))+'</label><select class="ws-modal-select" data-ws-select="1">'+P.join("")+"</select></div>"}const L=!$.length&&b.emptyHint?'<div class="ws-modal-empty">'+v(b.emptyHint)+"</div>":"",C=b.canCreate?'<div class="ws-modal-create"><button type="button" class="ws-modal-create-toggle" data-ws-create-toggle="1">+ '+v(a("ws-create-client","新建工作空间"))+'</button><div class="ws-modal-create-form" data-ws-create-form style="display:none;"><input type="text" class="ws-modal-create-input" data-ws-create-name placeholder="'+v(a("ws-create-ph","公司名称,例如 BAKELAB"))+'"><button type="button" class="ws-modal-create-submit" data-ws-create-submit="1">'+v(a("ws-create-submit","创建"))+"</button></div></div>":"";j.innerHTML='<div class="ws-modal-box" role="dialog" aria-modal="true"><div class="ws-modal-head"><span class="ws-modal-title">'+v(a("ws-chooser-title","选择工作空间"))+'</span><button type="button" class="ws-modal-close" data-ws-close="1" aria-label="close">✕</button></div><div class="ws-modal-subtitle" style="font-size:12px;color:#6b7280;padding:2px 4px 12px;line-height:1.45;white-space:normal;">'+v(a("ws-chooser-subtitle","账套主体 = 你的公司(发票卖方/开票方)。选择正在为哪家公司做账。"))+'</div><div class="ws-modal-list">'+h+y+"</div>"+L+C+"</div>",document.body.appendChild(j);const D=j.querySelector("[data-ws-select]");D&&D.addEventListener("change",function(){const P=D.value;P&&(typeof b.onPick=="function"&&b.onPick(P),B(),u())});function B(){j.remove()}j.addEventListener("click",function(P){if(P.target===j||P.target.closest("[data-ws-close]")){B();return}if(P.target.closest("[data-ws-personal]")){typeof b.onPersonal=="function"&&b.onPersonal(),B(),u();return}const G=P.target.closest("[data-ws-pick]");if(G){const re=G.getAttribute("data-ws-pick");typeof b.onPick=="function"&&b.onPick(re),B(),u();return}if(P.target.closest("[data-ws-create-toggle]")){const re=j.querySelector("[data-ws-create-form]");if(re){re.style.display=re.style.display==="none"?"flex":"none";const H=re.querySelector("[data-ws-create-name]");H&&H.focus()}return}if(P.target.closest("[data-ws-create-submit]")){I(j,b,B);return}})}async function I(b,$,S){const F=b.querySelector("[data-ws-create-name]"),j=F?(F.value||"").trim():"";if(!j){F&&F.focus();return}let w=null;try{if(typeof window.apiPost=="function"){const y=await window.apiPost("/api/workspace/clients",{name:j});w=y&&typeof y.json=="function"?await y.json().catch(()=>null):y}}catch{w=null}const h=w&&(w.id||w.client&&w.client.id);if(!h){typeof window.showToast=="function"&&window.showToast(a("ws-create-fail","新建工作空间失败 · 请重试"),"error");return}window._workspaceClientsCache=await d(),f(Number(h)),$.onPick,S(),u()}window.openWorkspaceChooserUI=M,window.addEventListener("pearnly:workspace-changed",function(){u()}),window.getWorkMode=s,window.getActiveWorkspaceClientId=i,window.setActiveWorkspaceClientId=f,window.enterPersonalMode=l,window.requireWorkspace=c,window.openWorkspaceChooser=p,window.renderWorkspaceControl=u,window.fetchWorkspaceClients=d;function x(){try{if(sessionStorage.getItem("pearnly_ws_login_prompted")==="1"||i()!=null||localStorage.getItem(n)==="personal")return;sessionStorage.setItem("pearnly_ws_login_prompted","1"),setTimeout(function(){p(null)},800)}catch{}}d().then(b=>{window._workspaceClientsCache=b,u(),x()}),typeof window.subscribeI18n=="function"&&window.subscribeI18n("workspace-switcher",u)})();(function(){const e=S=>document.querySelector('[data-num-target="'+S+'"]');function n(S){if(!S)return t("reconcile-last-activity-none");try{const F=new Date(S),j=new Date,w=j-F;if(w/6e4<5)return t("reconcile-last-activity-just-now");if(F.toDateString()===j.toDateString())return t("reconcile-last-activity-today");const y=Math.max(1,Math.floor(w/(24*3600*1e3)));return t("reconcile-last-activity-days-ago").replace("{n}",y)}catch{return t("reconcile-last-activity-none")}}function a(S,F,j){const w=e(S);w&&(w.textContent=j?"-":String(F),w.classList.toggle("is-empty",!!j))}function o(S){const F=document.getElementById("reconcile-error");F&&(F.style.display=S?"flex":"none")}function s(S){const F=document.getElementById("reconcile-empty");F&&(F.style.display=S?"flex":"none")}function i(S,F){const j=document.getElementById("reconcile-last-activity");j&&(j.textContent=S,j.classList.toggle("has-data",!!F))}function r(S){const F=!S||(S.total_sessions||0)===0;a("pending",S.pending||0,F),a("matched",S.matched||0,F),a("unmatched",S.unmatched||0,F),i(n(S.last_activity_at),!!S.last_activity_at),o(!1),s(F)}function f(S){const F=S.toUpperCase();return F==="KBANK"?"bank-chip-kbank":F==="SCB"?"bank-chip-scb":F==="BBL"?"bank-chip-bbl":F==="KTB"?"bank-chip-ktb":F==="TTB"?"bank-chip-ttb":"bank-chip-other"}function l(S,F){const j=w=>w?String(w).slice(0,10):"?";return!S&&!F?"":j(S)+" ~ "+j(F)}function d(S){return S==null?"":String(S).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function c(S){const F=document.getElementById("reconcile-recent"),j=document.getElementById("reconcile-recent-list");if(!F||!j)return;const w=(S||[]).slice(0,20);if(w.length===0){F.style.display="none";return}F.style.display="",s(!1),j.innerHTML=w.map(h=>{const y=h.parse_status==="parse_failed",L=h.bank_code||"OTHER",C=h.account_last4?" ···"+d(h.account_last4):"",D=l(h.period_start,h.period_end),B=d(h.source_filename||""),P=Number(h.tx_count||0),J=y?'<span class="recon-card-fail" data-i18n="reconcile-card-parse-failed">'+t("reconcile-card-parse-failed")+"</span>":'<span class="recon-card-tx">'+t("reconcile-card-tx").replace("{n}",P)+"</span>";return'<div class="recon-card" data-session-id="'+d(h.id)+'" data-session-name="'+B+'"><span class="bank-chip '+f(L)+'">'+d(L)+'</span><div class="recon-card-main"><div class="recon-card-title">'+B+C+'</div><div class="recon-card-sub">'+d(D)+'</div></div><div class="recon-card-right">'+J+'</div><button class="recon-card-trash" data-trash="'+d(h.id)+'" title="'+d(t("bank-session-delete-tip")||"删除")+'"><svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"><path d="M3 5h10M6 5V3h4v2M5 5l1 9h4l1-9"/></svg></button><svg class="recon-card-arrow" viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M6 4l4 4-4 4"/></svg></div>'}).join(""),j.querySelectorAll(".recon-card").forEach(h=>{h.addEventListener("click",y=>{y.target.closest(".recon-card-trash")||(h.dataset.sessionId,p())})}),j.querySelectorAll(".recon-card-trash").forEach(h=>{h.addEventListener("click",y=>{y.stopPropagation();const L=h.dataset.trash,C=h.closest(".recon-card"),D=C&&C.dataset.sessionName||"";typeof window._deleteBankSession=="function"&&window._deleteBankSession(L,D)})})}function p(S){typeof window.routeTo=="function"&&window.routeTo("reconcile"),setTimeout(function(){const F=document.querySelector('[data-recon-tab="bank"]');F&&F.click()},150)}function u(){o(!0),s(!1)}function v(){typeof window.routeTo=="function"&&window.routeTo("reconcile"),setTimeout(function(){const S=document.querySelector('[data-recon-tab="bank"]');S&&S.click()},150)}async function _(){a("pending",0,!0),a("matched",0,!0),a("unmatched",0,!0),i("",!1),o(!1),s(!1);const S=document.getElementById("reconcile-recent");S&&(S.style.display="none");const F={Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||"")};try{const[j,w]=await Promise.all([fetch("/api/bank-recon/stats",{headers:F}),fetch("/api/bank-recon/sessions?limit=20",{headers:F})]);if(!j.ok)throw new Error("http "+j.status);const h=await j.json(),y=w.ok?await w.json():[];r(h||{}),c(y||[])}catch(j){console.warn("[reconcile] load failed",j),u()}}function M(S){if(!S||!S.length)return;const F="Bearer "+(localStorage.getItem("mrpilot_token")||"");let j=0;const w=S.length;Array.from(S).forEach(function(h){const y=new FormData;y.append("file",h,h.name);const L=new XMLHttpRequest;L.open("POST","/api/bank-recon/upload"),L.setRequestHeader("Authorization",F),L.onload=function(){j++;try{const C=JSON.parse(L.responseText);L.status===200&&C.tx_count!==void 0?showToast((t("bank-upload-ok")||"解析成功 · 共 {n} 条流水").replace("{n}",C.tx_count),"success"):showToast(h.name+" "+(t("upload-failed")||"上传失败"),"error")}catch{showToast(h.name+" "+(t("upload-failed")||"上传失败"),"error")}j===w&&setTimeout(_,600)},L.onerror=function(){j++,showToast(h.name+" "+(t("upload-failed")||"上传失败"),"error"),j===w&&setTimeout(_,600)},L.send(y)}),showToast((t("bank-queue-status-uploading")||"上传中")+"…","info")}function I(){if(window.__reconcileBound)return;window.__reconcileBound=!0;const S=document.getElementById("reconcile-bank-file-input");S&&S.addEventListener("change",function(){M(this.files),this.value=""}),document.addEventListener("click",F=>{if(F.target.closest("#btn-reconcile-upload-top")||F.target.closest("#btn-reconcile-upload-empty")){v();return}if(F.target.closest("#btn-reconcile-retry")){_();return}if(F.target.closest("#btn-reconcile-dev-seed")){$();return}})}const x=["468b50c1-5593-4fd6-990d-515ce8085563"];function b(){const S=document.getElementById("btn-reconcile-dev-seed");if(!S)return;const F=typeof _userInfo<"u"?_userInfo:null,j=F&&F.id&&x.indexOf(String(F.id))>=0;S.style.display=j?"":"none"}async function $(){try{const S=await fetch("/api/bank-recon/_dev/seed",{method:"POST",headers:{Authorization:"Bearer "+token}});if(!S.ok)throw new Error("seed:"+S.status);const F=await S.json(),j=(t("reconcile-dev-seed-ok")||"").replace("{n}",F.tx_count||0);showToast(j,"success"),typeof window.navigateTo=="function"?window.navigateTo("automation"):location.hash="#/automation",setTimeout(()=>{const w=document.querySelector('[data-auto-tab="bank"]');w&&w.click(),F.session_id&&typeof window._openBankSession=="function"&&window._openBankSession(F.session_id)},300)}catch(S){console.warn("[reconcile] dev seed failed",S),showToast(t("reconcile-dev-seed-fail")||"Seed failed","error")}}window.loadReconcilePage=async function(){I(),b(),typeof window._bankReconV2Init=="function"&&window._bankReconV2Init();try{await _()}catch{}},window._rerenderReconcile=function(){typeof currentRoute=="string"&&currentRoute==="reconcile"&&_().catch(()=>{})},typeof window.subscribeI18n=="function"&&window.subscribeI18n("reconcile",window._rerenderReconcile)})();(function(){const e=document.getElementById("assign-clients-modal");if(!(!e||e.dataset.wbInjected==="1")){e.innerHTML=`
    <div class="modal" style="max-width:480px">
        ...
        <div class="modal-foot">
    ...
    </div>`,e.dataset.wbInjected="1";try{const n=window._currentLang||localStorage.getItem("mrpilot_lang")||"th",a=window.I18N;a&&a[n]&&e.querySelectorAll("[data-i18n]").forEach(o=>{const s=o.getAttribute("data-i18n");a[n][s]&&(o.textContent=a[n][s])})}catch{}}})();(function(){let e={employeeId:null,employeeName:"",clients:[],selected:new Set,opened:!1};function n(){return document.getElementById("assign-clients-modal")}function a(){return document.getElementById("assign-clients-list")}function o(){return document.getElementById("assign-select-all")}function s(){return document.getElementById("assign-selected-count")}function i(){return document.getElementById("assign-modal-target")}function r(){const _=a();if(_){if(!e.clients.length){_.innerHTML='<div class="assign-empty">'+escapeHtml(t("assign-no-clients")||"暂无客户 · 请先到「客户管理」添加")+"</div>";return}_.innerHTML=e.clients.map(M=>{const I=String(M.id),x=e.selected.has(I)?"checked":"",b=escapeHtml(M.name||M.label||"#"+I),$=M.code?'<span class="assign-row-code">'+escapeHtml(M.code)+"</span>":"";return'<label class="assign-row"><input type="checkbox" data-cid="'+escapeHtml(I)+'" '+x+'><span class="assign-row-name">'+b+"</span>"+$+"</label>"}).join(""),f()}}function f(){const _=s();if(_){const I=t("assign-selected-count")||"已选 {n} / {total}";_.textContent=I.replace("{n}",e.selected.size).replace("{total}",e.clients.length)}const M=o();M&&(M.checked=e.clients.length>0&&e.selected.size===e.clients.length)}function l(){const _=i();_&&(_.textContent=e.employeeName?" · "+e.employeeName:"")}async function d(_,M){e.employeeId=_,e.employeeName=M||"",e.opened=!0,e.selected=new Set,e.clients=[],l();const I=a();I&&(I.innerHTML='<div class="assign-empty">'+escapeHtml(t("assign-loading")||"加载中...")+"</div>");const x=n();x&&(x.style.display="flex");try{const[b,$]=await Promise.all([apiGet("/api/clients?include_inactive=false"),apiGet("/api/team/employees/"+encodeURIComponent(_)+"/assignments")]);e.clients=b&&b.clients||[];const S=$&&$.client_ids||[];e.selected=new Set(S.map(String)),r()}catch(b){console.error("[assign-clients] load failed",b);const $=a();$&&($.innerHTML='<div class="assign-empty">'+escapeHtml(t("assign-load-failed")||"加载失败 · 请重试")+"</div>")}}function c(){e.opened=!1;const _=n();_&&(_.style.display="none")}async function p(){if(!e.employeeId)return;const _=Array.from(e.selected).map(I=>parseInt(I,10)).filter(I=>!isNaN(I)),M=document.getElementById("assign-modal-save");M&&(M.disabled=!0);try{const I=await apiPost("/api/team/employees/"+encodeURIComponent(e.employeeId)+"/assignments",{client_ids:_});I&&I.ok!==!1?(showToast((t("assign-saved")||"已保存 {n} 个客户分配").replace("{n}",_.length),"success"),c(),typeof loadTeamList=="function"&&loadTeamList()):showToast(t("assign-save-failed")||"保存失败","error")}catch(I){console.error("[assign-clients] save failed",I),showToast(t("assign-save-failed")||"保存失败","error")}finally{M&&(M.disabled=!1)}}function u(){const _=n();if(!_||_.dataset.bound==="1")return;_.dataset.bound="1";const M=document.getElementById("assign-modal-close");M&&M.addEventListener("click",c);const I=document.getElementById("assign-modal-cancel");I&&I.addEventListener("click",c);const x=document.getElementById("assign-modal-save");x&&x.addEventListener("click",p),_.addEventListener("click",function(S){S.target===_&&c()});const b=o();b&&b.addEventListener("change",function(){b.checked?e.selected=new Set(e.clients.map(S=>String(S.id))):e.selected=new Set,r()});const $=a();$&&$.addEventListener("change",function(S){const F=S.target.closest('input[type="checkbox"][data-cid]');if(!F)return;const j=F.dataset.cid;F.checked?e.selected.add(j):e.selected.delete(j),f()})}function v(){e.opened&&(l(),r())}typeof window.subscribeI18n=="function"&&window.subscribeI18n("assign-clients-modal",v),window.openAssignClientsModal=function(_,M){u(),d(_,M)}})();(function(){const e={page:1,per_page:50,q:"",total:0,rows:[],loaded:!1};function n(c){if(!c)return"";try{return new Date(c).toLocaleString()}catch{return c}}function a(c){const p=document.getElementById("access-log-table");p&&(p.innerHTML='<div class="access-log-empty">'+escapeHtml(c)+"</div>");const u=document.getElementById("access-log-pager");u&&(u.innerHTML="")}function o(){const c=document.getElementById("access-log-table");if(!c)return;const p=e.rows||[];if(!p.length){a(t("set-access-log-empty"));return}const u=`
            <div class="access-log-row access-log-head">
                ...
                </div>`}).join("");c.innerHTML=u+v}function s(){const c=document.getElementById("access-log-pager");if(!c)return;const p=e.total||0;if(!p){c.innerHTML="";return}const u=e.page||1,v=e.per_page,_=Math.max(1,Math.ceil(p/v)),M=(t("set-access-log-pager-total")||"Total {n}").replace("{n}",p),I=(t("set-access-log-pager-page")||"Page {p} / {t}").replace("{p}",u).replace("{t}",_);c.innerHTML=`
            ...
            <div class="access-log-pager-ctrl">
                ...
                <button class="access-log-pager-btn" type="button" data-access-log-page="${u+1}" ${u>=_?"disabled":""}>${escapeHtml(t("set-access-log-pager-next"))} →</button>
            </div>`}async function i(c){const p=localStorage.getItem("mrpilot_token");if(p){e.page=c||1,a(t("set-access-log-loading"));try{const u="/api/me/access_log?page="+e.page+"&per_page="+e.per_page+"&q="+encodeURIComponent(e.q||""),v=await fetch(u,{headers:{Authorization:"Bearer "+p}});if(v.status===403){a(t("set-access-log-empty"));return}if(!v.ok)throw new Error("http_"+v.status);const _=await v.json();e.rows=_.logs||[],e.total=_.total||0,e.loaded=!0,o(),s()}catch{a(t("set-access-log-fail"))}}}async function r(){const c=localStorage.getItem("mrpilot_token");if(c)try{const p="/api/me/access_log.csv?q="+encodeURIComponent(e.q||""),u=await fetch(p,{headers:{Authorization:"Bearer "+c}});if(!u.ok){showToast(t("set-access-log-csv-fail")||"Export failed","error");return}const v=await u.blob(),_=document.createElement("a"),M=URL.createObjectURL(v);_.href=M,_.download="pearnly_access_log.csv",document.body.appendChild(_),_.click(),setTimeout(function(){URL.revokeObjectURL(M),_.remove()},100),showToast(t("set-access-log-csv-ok")||"Exported","success")}catch{showToast(t("set-access-log-csv-fail")||"Export failed","error")}}function f(){const c=document.querySelectorAll(".set-tab-owner-only"),p=!!(_userInfo&&(_userInfo.role==="owner"||_userInfo.is_super_admin));c.forEach(function(u){u.style.display=p?"":"none"})}document.addEventListener("click",function(c){if(c.target.closest('.settings-tab[data-tab="access-log"]')){setTimeout(function(){(!e.loaded||e.page!==1)&&i(1)},50);return}if(c.target.closest("#access-log-csv-btn")){c.preventDefault(),r();return}const v=c.target.closest(".access-log-pager-btn[data-access-log-page]");if(v&&!v.disabled){const _=parseInt(v.dataset.accessLogPage,10);i(_)}}),document.addEventListener("input",function(c){c.target&&c.target.id==="access-log-search"&&(clearTimeout(window.__accessLogSearchTimer),window.__accessLogSearchTimer=setTimeout(function(){e.q=(c.target.value||"").trim(),i(1)},350))});let l=0;const d=setInterval(function(){l++,_userInfo&&(f(),clearInterval(d)),l>60&&clearInterval(d)},500);typeof window.subscribeI18n=="function"&&window.subscribeI18n("me-access-log",function(){f(),e.loaded&&(o(),s())})})();(function(){const e=document.getElementById("notif-new-modal");if(!(!e||e.dataset.wbInjected==="1")){e.innerHTML=`
...
`,e.dataset.wbInjected="1";try{const n=window._currentLang||localStorage.getItem("mrpilot_lang")||"th",a=window.I18N;a&&a[n]&&(e.querySelectorAll("[data-i18n]").forEach(o=>{const s=o.getAttribute("data-i18n");a[n][s]&&(o.textContent=a[n][s])}),e.querySelectorAll("[data-i18n-placeholder]").forEach(o=>{const s=o.getAttribute("data-i18n-placeholder");a[n][s]&&(o.placeholder=a[n][s])}))}catch{}}})();(function(){const e=document.getElementById("archive-token-modal");if(!(!e||e.dataset.wbInjected==="1")){e.innerHTML=`
        ...
        `}async function c(){try{const w=await fetch("/api/settings/dup-check",{headers:{Authorization:"Bearer "+token}});if(!w.ok)return;const h=await w.json(),y=document.getElementById("pref-dup-check");y&&(y.checked=!!h.enabled)}catch(w){console.warn("load prefs failed",w)}}const p=document.getElementById("pref-dup-check");p&&!p.dataset.bound&&(p.dataset.bound="1",p.addEventListener("change",async w=>{const h=w.target.checked;try{(await fetch("/api/settings/dup-check",{method:"PUT",headers:{Authorization:"Bearer "+token,"Content-Type":"application/json"},body:JSON.stringify({enabled:h})})).ok?showToast(h?t("pref-dup-check-on-toast"):t("pref-dup-check-off-toast"),"success"):(w.target.checked=!h,showToast(t("pref-save-failed"),"error"))}catch{w.target.checked=!h,showToast(t("pref-save-failed"),"error")}}));async function u(){const w=!!(_userInfo&&_userInfo.can_customize_archive);o=!w;const h=document.getElementById("archive-upgrade-banner");h&&(h.style.display=w?"none":"");const y=document.getElementById("archive-plus-badge");y&&(y.style.display=w?"none":"");try{const L=await fetch("/api/archive/settings",{headers:{Authorization:"Bearer "+token}});if(!L.ok)throw new Error("load failed");const C=await L.json();e=Array.isArray(C.name_template)?C.name_template:[],n=C.folder_strategy||"by_month_seller"}catch(L){console.error("load archive settings failed",L),showToast(t("archive-load-failed"),"error");return}v(),_(),M(),I()}function v(){const w=document.getElementById("archive-rule-canvas");if(w){if(e.length===0){w.innerHTML=`<div class="archive-empty">${escapeHtml(t("archive-rule-empty"))}</div>`;return}w.innerHTML=e.map((h,y)=>{const L=i[h.type]||{label:h.type},C=s[h.type]||"",D=h.type==="sep"?`"${escapeHtml(h.val||"_")}"`:escapeHtml(t(L.label));return`
            ...
            `}).join("")}}function _(){const w=document.getElementById("archive-field-palette");if(!w)return;const h=["date","seller","category","amount","invoice","buyer","sep"];w.innerHTML=h.map(y=>{const L=i[y],C=s[y]||"";return`
                <button class="archive-palette-btn ${y}" data-add-field="${y}" ${o?"disabled":""}>
                    <span class="token-icon">${C}</span>
                    <span>${escapeHtml(t(L.label))}</span>
                </button>
            `}).join("")}function M(){document.querySelectorAll('input[name="folder-strategy"]').forEach(w=>{w.checked=w.value===n,w.disabled=o})}async function I(){const w=document.getElementById("archive-preview-name"),h=document.getElementById("archive-preview-hint");if(h&&(h.textContent=t("archive-preview-hint",{category:r()})),!!w){if(e.length===0){w.textContent="-";return}try{const L=await(await fetch("/api/archive/rename-preview",{method:"POST",headers:{Authorization:"Bearer "+token,"Content-Type":"application/json"},body:JSON.stringify({merged_fields:l().merged_fields,name_template:e})})).json();w.textContent=(L.name||"-")+".pdf"}catch{w.textContent="("+t("archive-preview-error")+")"}}}window._rerenderArchiveAll=function(){const w=document.getElementById("archive-rule-modal");!w||w.style.display==="none"||(v(),_(),I())};let x=-1;document.addEventListener("dragstart",w=>{const h=w.target.closest(".archive-token");!h||o||(x=parseInt(h.dataset.tokenIdx,10),h.classList.add("dragging"),w.dataTransfer.effectAllowed="move")}),document.addEventListener("dragend",w=>{document.querySelectorAll(".archive-token").forEach(h=>h.classList.remove("dragging","drop-target")),x=-1}),document.addEventListener("dragover",w=>{const h=w.target.closest(".archive-token");h&&(w.preventDefault(),w.dataTransfer.dropEffect="move",document.querySelectorAll(".archive-token").forEach(y=>y.classList.remove("drop-target")),h.classList.add("drop-target"))}),document.addEventListener("drop",w=>{const h=w.target.closest(".archive-token");if(!h||x<0||o)return;w.preventDefault();const y=parseInt(h.dataset.tokenIdx,10);if(y===x)return;const L=e.splice(x,1)[0];e.splice(y,0,L),x=-1,v(),I()}),document.addEventListener("click",w=>{if(w.target.closest("#btn-open-archive-rule")||w.target.closest("#btn-open-archive-rule-from-settings")){const C=document.getElementById("archive-rule-modal");C&&(C.style.display="",u());return}if(w.target.closest("#archive-rule-modal-close")||w.target.id==="archive-rule-modal"){const C=document.getElementById("archive-rule-modal");C&&(C.style.display="none");return}const h=w.target.closest(".settings-nav-item");if(h){switchSettingsTab(h.dataset.settingsTab);return}if(o&&w.target.closest(".archive-token, [data-add-field], #btn-archive-save, #btn-archive-reset")){showToast(t("feature-contact-us"),"info");return}const y=w.target.closest("[data-add-field]");if(y){const C=y.dataset.addField,D=i[C],B={type:C,...D.defaultCfg};e.push(B),v(),I();return}const L=w.target.closest(".archive-token");if(L&&!o){b(parseInt(L.dataset.tokenIdx,10));return}if(w.target.closest("#btn-archive-save"))return F();if(w.target.closest("#btn-archive-reset"))return j();(w.target.closest("#archive-token-close")||w.target.id==="archive-token-modal")&&(document.getElementById("archive-token-modal").style.display="none"),w.target.closest("#btn-archive-token-ok")&&$(),w.target.closest("#btn-archive-token-delete")&&S()}),document.addEventListener("change",w=>{w.target.name==="folder-strategy"&&(n=w.target.value)});function b(w){a=w;const h=e[w];if(!h)return;const y=document.getElementById("archive-token-body");let L="";h.type==="date"?L=`
                <div class="form-group">
        ...
        </div>`,c=document.createElement("div");c.innerHTML=d,document.body.appendChild(c.firstElementChild),document.getElementById("report-modal-close-x").addEventListener("click",a),document.getElementById("report-modal-cancel").addEventListener("click",a),document.getElementById("report-modal").addEventListener("click",p=>{p.target.id==="report-modal"&&a()})}function a(){const d=document.getElementById("report-modal");d&&(d.style.display="none"),o=null}let o=null;async function s(d,c){const p=d+":"+(c||"");if(e[p])return e[p];let u;try{const v=localStorage.getItem("mrpilot_token"),_=await fetch(`/api/reports/templates?lang=${encodeURIComponent(d)}`,{headers:{Authorization:"Bearer "+v}});if(!_.ok)throw new Error("templates fetch failed");u=(await _.json()).templates||[]}catch(v){console.error("fetchTemplates fail",v),u=[{code:"input_vat",name:t("tpl-input-vat"),desc:t("tpl-input-vat-desc"),recommended:!0},{code:"standard",name:t("tpl-standard"),desc:t("tpl-standard-desc"),recommended:!1},{code:"print",name:t("tpl-print"),desc:t("tpl-print-desc"),recommended:!1}]}if(u=u.filter(v=>v.code!=="erp"),c==="history-batch"){const v=u.findIndex(M=>M.code==="standard"),_=v>=0?v+1:u.length;u.splice(_,0,{code:"sales_detail_th",name:t("export-tpl-sales-detail"),desc:t("export-tpl-sales-detail-desc"),recommended:!1,is_new:!0})}return e[p]=u,u}function i(d){const c=document.getElementById("report-tpl-list"),p=d.map((v,_)=>`
            <label class="report-tpl-item${v.recommended?" is-recommended":""}">
                <input type="radio" name="report-tpl" value="${v.code}" ${v.recommended||_===0?"checked":""}>
        ...
        `;c.innerHTML=p+u}function r(d){return d==null?"":String(d).replace(/[&<>"']/g,c=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[c])}function f(d){const c=new Date,p=c.getFullYear(),u=c.getMonth()+1;if(d==="all")return"all";if(d==="this-month")return`${p}-${String(u).padStart(2,"0")}`;if(d==="last-month"){const v=new Date(p,u-2,1);return`${v.getFullYear()}-${String(v.getMonth()+1).padStart(2,"0")}`}return d==="this-year"?`${p}`:d==="this-quarter"?`${p}-Q${Math.floor((u-1)/3)+1}`:"all"}window.openReportModal=async function(d){d=d||{},n(),typeof applyLang=="function"?applyLang(currentLang):document.querySelectorAll("#report-modal [data-i18n]").forEach(M=>{const I=M.getAttribute("data-i18n");I18N[currentLang]&&I18N[currentLang][I]&&(M.textContent=I18N[currentLang][I])});const c=document.getElementById("report-period-section");c&&(c.style.display=d.mode==="client"?"":"none");const p=document.getElementById("report-tpl-list");p.innerHTML=`<div class="report-tpl-loading">${r(t("report-modal-loading"))}</div>`,document.getElementById("report-modal").style.display="";const u=await s(currentLang,d&&d.mode);i(u),o=d;const v=document.getElementById("report-modal-download"),_=v.cloneNode(!0);v.parentNode.replaceChild(_,v),_.addEventListener("click",()=>l(o))};async function l(d){if(!d)return;const c=document.querySelector('input[name="report-tpl"]:checked');if(!c){showToast(t("report-toast-no-selection"),"info");return}const p=c.value,u=document.querySelector('input[name="report-period"]:checked'),v=u?u.value:"all",_=f(v),M=document.getElementById("report-modal-download"),I=M.innerHTML;M.disabled=!0,M.innerHTML=`<span>${r(t("report-modal-loading"))}</span>`;try{const x=localStorage.getItem("mrpilot_token");let b,$;if(d.mode==="records")b=await fetch("/api/reports/export",{method:"POST",headers:{Authorization:"Bearer "+x,"Content-Type":"application/json"},body:JSON.stringify({template:p,lang:currentLang,records:d.records||[],meta:d.meta||{}})}),$=`mrpilot-${p}-${Date.now()}.xlsx`;else if(d.mode==="client"){const L=`/api/reports/clients/${d.clientId}/export?template=${encodeURIComponent(p)}&lang=${encodeURIComponent(currentLang)}&month=${encodeURIComponent(_)}`;b=await fetch(L,{headers:{Authorization:"Bearer "+x}}),$=`${(d.clientName||"client").replace(/[^a-zA-Z0-9\u0e00-\u0e7f\u4e00-\u9fff]/g,"_").slice(0,40)}-${p}.xlsx`}else if(d.mode==="history-batch")p==="sales_detail_th"?(b=await fetch("/api/ocr/export-by-history-ids",{method:"POST",headers:{Authorization:"Bearer "+x,"Content-Type":"application/json"},body:JSON.stringify({template:"sales_detail_th",lang:currentLang,history_ids:d.historyIds||[],client_id:d.clientId||null})}),$=`Pearnly_SalesDetail_${Date.now()}.xlsx`):(b=await fetch("/api/reports/history/batch_export",{method:"POST",headers:{Authorization:"Bearer "+x,"Content-Type":"application/json"},body:JSON.stringify({template:p,lang:currentLang,history_ids:d.historyIds||[],client_id:d.clientId||null})}),$=`mrpilot-batch-${p}-${Date.now()}.xlsx`);else throw new Error("unknown mode: "+d.mode);if(!b.ok){let L="HTTP "+b.status;try{const C=await b.json();C&&C.detail&&(L=C.detail)}catch(C){console.warn("[batch-export] resp.json err.detail parse failed:",C)}b.status===404?showToast(t("report-toast-empty"),"info"):showToast(t("report-toast-fail")+" · "+L,"error");return}const S=await b.blob();let F=$;const w=(b.headers.get("Content-Disposition")||"").match(/filename\*=UTF-8''([^;]+)/i);if(w)try{F=decodeURIComponent(w[1])}catch{}const h=URL.createObjectURL(S),y=document.createElement("a");y.href=h,y.download=F,document.body.appendChild(y),y.click(),document.body.removeChild(y),URL.revokeObjectURL(h),showToast(t("report-toast-success"),"success"),a()}catch(x){console.error("doDownload fail",x),showToast(t("report-toast-fail")+" · "+(x.message||""),"error")}finally{M.disabled=!1,M.innerHTML=I}}document.addEventListener("DOMContentLoaded",()=>{const d=document.getElementById("btn-export");if(d){const p=d.cloneNode(!0);d.parentNode.replaceChild(p,d),p.addEventListener("click",()=>{if(typeof _results>"u"||!_results||_results.length===0){showToast(t("report-toast-no-selection"),"info");return}openReportModal({mode:"records",records:_results.map(u=>({filename:u.filename,merged_fields:u.merged_fields||{}}))})})}const c=document.getElementById("history-batch-export");c&&c.addEventListener("click",()=>{if(typeof _historySelected>"u"||_historySelected.size===0){showToast(t("report-toast-no-selection"),"info");return}openReportModal({mode:"history-batch",historyIds:Array.from(_historySelected)})})}),window.openClientExportModal=function(d,c){openReportModal({mode:"client",clientId:d,clientName:c||""})}})();(function(){const n=typeof window<"u"&&"showDirectoryPicker"in window,a=/\.(pdf|jpe?g|png|webp)$/i,o="mrpilot_folder_watcher",s=1;let i=null,r=null,f=null,l=60,d=!1,c=!1,p=0,u=0,v=0,_=[],M=null,I=!1;function x(){return i||(i=new Promise((k,T)=>{const A=indexedDB.open(o,s);A.onupgradeneeded=U=>{const z=U.target.result;z.objectStoreNames.contains("handles")||z.createObjectStore("handles"),z.objectStoreNames.contains("seen")||z.createObjectStore("seen"),z.objectStoreNames.contains("config")||z.createObjectStore("config")},A.onsuccess=U=>k(U.target.result),A.onerror=U=>T(U.target.error)}),i)}function b(k,T){return x().then(A=>new Promise((U,z)=>{const R=A.transaction(k,"readonly").objectStore(k).get(T);R.onsuccess=()=>U(R.result),R.onerror=()=>z(R.error)}))}function $(k,T,A){return x().then(U=>new Promise((z,m)=>{const R=U.transaction(k,"readwrite");R.objectStore(k).put(A,T),R.oncomplete=()=>z(),R.onerror=()=>m(R.error)}))}function S(k,T){return x().then(A=>new Promise((U,z)=>{const m=A.transaction(k,"readwrite");m.objectStore(k).delete(T),m.oncomplete=()=>U(),m.onerror=()=>z(m.error)}))}function F(k){return x().then(T=>new Promise((A,U)=>{const z=T.transaction(k,"readwrite");z.objectStore(k).clear(),z.oncomplete=()=>A(),z.onerror=()=>U(z.error)}))}async function j(k){if(!k)return!1;try{const T={mode:"read"};let A=await k.queryPermission(T);return A==="granted"?!0:(A=await k.requestPermission(T),A==="granted")}catch(T){return console.warn("[folder] permission check failed:",T),!1}}function w(k,T){const A=document.getElementById("folder-status-summary");A&&(A.setAttribute("data-i18n",k),A.textContent=t(k),A.className="auto-status-pill"+(T?" "+T:""))}function h(k){["folder-unsupported","folder-empty","folder-active"].forEach(T=>{const A=document.getElementById(T);A&&(A.style.display=T===k?"":"none")})}function y(k){if(!k)return"-";const T=k instanceof Date?k:new Date(k),A=String(T.getHours()).padStart(2,"0"),U=String(T.getMinutes()).padStart(2,"0"),z=String(T.getSeconds()).padStart(2,"0");return`${A}:${U}:${z}`}function L(){h("folder-active");const k=document.getElementById("folder-config-path");k&&r&&(k.textContent=r.name||"-");const T=document.getElementById("folder-interval-select");T&&(T.value=String(l)),document.getElementById("folder-stat-last").textContent=M?y(M):"-",document.getElementById("folder-stat-processed").textContent=String(p),document.getElementById("folder-stat-failed").textContent=String(u),document.getElementById("folder-stat-queue").textContent=String(v);const A=document.getElementById("btn-folder-pause"),U=document.getElementById("btn-folder-resume");A&&(A.style.display=d?"none":""),U&&(U.style.display=d?"":"none"),d?w("folder-status-paused","paused"):w("folder-status-running","running");const z=document.getElementById("folder-status-text");z&&(z.setAttribute("data-i18n",d?"folder-status-paused":"folder-status-running"),z.textContent=t(d?"folder-status-paused":"folder-status-running"));const m=document.getElementById("folder-status-pulse");m&&(m.className="folder-status-pulse"+(d?" paused":"")),C()}function C(){const k=document.getElementById("folder-recent-list");if(k){if(_.length===0){k.innerHTML=`<div class="folder-recent-empty">${escapeHtml(t("folder-recent-empty"))}</div>`;return}k.innerHTML=_.slice(0,20).map(T=>{let A;T.status==="ok"?A=`<span class="folder-recent-icon ok">${svgIcon("check",12)}</span>`:T.status==="dup"?A=`<span class="folder-recent-icon dup" title="${escapeHtml(t("folder-recent-dup"))}">${svgIcon("copy",12)}</span>`:T.status==="skip"?A=`<span class="folder-recent-icon skip" title="${escapeHtml(t("folder-recent-skip"))}">${svgIcon("minus",12)}</span>`:A=`<span class="folder-recent-icon fail">${svgIcon("alert",12)}</span>`;const U=T.status==="fail"&&T.error?T.error:T.status==="dup"&&T.reason||T.status==="skip"&&T.reason?T.reason:"",z=U?`<div class="folder-recent-err">${escapeHtml(U)}</div>`:"";return`
            ...
            `}).join("")}}function D(k){_.unshift(k),_.length>50&&(_.length=50),$("config","recent_list",_).catch(()=>{})}async function B(k){const T=new FormData;T.append("file",k,k.name),T.append("source","folder");const A=await fetch("/api/ocr/recognize?source=folder",{method:"POST",headers:{Authorization:"Bearer "+token,"X-Source":"folder"},body:T});if(!A.ok){let U="http_"+A.status;try{const z=await A.json();U=z&&z.detail?typeof z.detail=="string"?z.detail:z.detail.code||JSON.stringify(z.detail):U}catch{}throw new Error(U)}return await A.json()}async function P(k){try{const A=(await k.getFile()).size;return await new Promise(z=>setTimeout(z,3e3)),(await k.getFile()).size===A&&A>0}catch{return!1}}async function J(k,T,A,U){if(U>10)return;let z;try{z=await k.queryPermission({mode:"read"})}catch{z="denied"}if(z==="granted")for await(const m of k.values()){const R=T?`${T}/${m.name}`:m.name;if(m.kind==="file"){if(!a.test(m.name))continue;let O;try{O=await m.getFile()}catch{continue}const Y=`${R}::${O.size}::${O.lastModified}`;if(await b("seen",Y))continue;A.push({entry:m,file:O,seenKey:Y,relPath:R})}else if(m.kind==="directory")try{await J(m,R,A,U+1)}catch{}}}async function G(){if(!(c||d||!r)){c=!0;try{if(await r.queryPermission({mode:"read"})!=="granted"){console.warn("[folder] permission lost · stop"),K(),showToast("warn",t("folder-permission-lost"));return}M=new Date;const T=[];await J(r,"",T,0),v=T.length,L();for(const A of T){if(d)break;if(!await P(A.entry)){v=Math.max(0,v-1),L();continue}try{let z;try{z=await A.entry.getFile()}catch{z=A.file}const m=await B(z);await $("seen",A.seenKey,{name:z.name,relPath:A.relPath,size:z.size,lastModified:z.lastModified,processed_at:Date.now()});const R=m.history_ids||(m.history_id?[m.history_id]:[]),O=m.duplicate_warnings||[],Y=A.relPath||z.name;R.length>0?(p+=R.length,D({name:Y,status:"ok",time:new Date,history_id:R[0],count:R.length}),await $("config","processed_count",p)):O.length>0?D({name:Y,status:"dup",time:new Date,reason:t("folder-recent-dup-reason")}):D({name:Y,status:"skip",time:new Date,reason:t("folder-recent-skip-reason")})}catch(z){u++,D({name:A.relPath||A.file.name,status:"fail",time:new Date,error:String(z.message||z)}),await $("config","failed_count",u)}v=Math.max(0,v-1),L()}}catch(k){console.warn("[folder] scan error:",k)}finally{c=!1,L()}}}function W(){f&&clearInterval(f),f=setInterval(G,l*1e3)}function te(){f&&(clearInterval(f),f=null)}function re(k){if(!r||d)return;const T=typeof t=="function"?t("folder-unload-warn"):"Folder watcher running · close anyway?";return k.preventDefault(),k.returnValue=T,T}function H(){window._pearnlyFolderUnloadAttached||(window._pearnlyFolderUnloadAttached=!0,window.addEventListener("beforeunload",re))}function E(){window._pearnlyFolderUnloadAttached&&(window._pearnlyFolderUnloadAttached=!1,window.removeEventListener("beforeunload",re))}function g(){d=!1,W(),H(),L(),G()}function q(){d=!0,te(),E(),L()}function N(){d=!1,W(),H(),L(),G()}function K(){d=!0,te(),E()}async function Z(){try{const k=await window.showDirectoryPicker({mode:"read",startIn:"documents"});if(!await j(k)){showToast("warn",t("folder-permission-denied"));return}r=k,await $("handles","main",k),p=0,u=0,v=0,_=[],await $("config","processed_count",0),await $("config","failed_count",0),await F("seen"),g()}catch(k){k&&k.name!=="AbortError"&&console.warn("[folder] pick failed:",k)}}async function le(){await showConfirm(t("folder-confirm-remove"),{danger:!0})&&(K(),r=null,p=0,u=0,v=0,_=[],await S("handles","main"),await S("config","processed_count"),await S("config","failed_count"),await F("seen"),h("folder-empty"),w("folder-status-empty",""))}async function ie(){_=[];try{await S("config","recent_list")}catch{}C()}async function V(){if(I)return;if(I=!0,!n){h("folder-unsupported"),w("folder-status-unsupported",""),ne();return}Q();let k=null;try{k=await b("handles","main")}catch{}if(!k){h("folder-empty"),w("folder-status-empty","");return}if(!await j(k)){h("folder-empty"),w("folder-status-empty",""),await S("handles","main"),showToast("warn",t("folder-permission-lost-restart"));return}r=k;try{p=await b("config","processed_count")||0}catch{}try{u=await b("config","failed_count")||0}catch{}try{const A=await b("config","recent_list");Array.isArray(A)&&(_=A.map(U=>({...U,time:U.time?new Date(U.time):new Date})))}catch{}g()}function Q(){const k=document.getElementById("btn-folder-pick"),T=document.getElementById("btn-folder-pause"),A=document.getElementById("btn-folder-resume"),U=document.getElementById("btn-folder-scan-now"),z=document.getElementById("btn-folder-remove"),m=document.getElementById("btn-folder-clear-recent"),R=document.getElementById("folder-interval-select");k&&k.addEventListener("click",Z),T&&T.addEventListener("click",q),A&&A.addEventListener("click",N),U&&U.addEventListener("click",()=>{G()}),z&&z.addEventListener("click",le),m&&m.addEventListener("click",ie),R&&R.addEventListener("change",O=>{l=parseInt(O.target.value,10)||60,d||W()}),ee()}function ee(){document.querySelectorAll('[data-auto-panel="folder"] [data-tab-jump]').forEach(k=>{k.dataset.tabJumpBound||(k.dataset.tabJumpBound="1",k.addEventListener("click",T=>{const A=T.currentTarget.dataset.tabJump;if(A==="email")typeof switchAutomationTab=="function"&&switchAutomationTab("email");else if(A==="upload"){const U=document.querySelector('[data-page="recognize"]')||document.querySelector('[data-page="upload"]');U&&U.click()}}))})}function ne(){ee()}window._loadFolderWatcherPanel=V;function oe(){try{if(navigator.userAgentData&&Array.isArray(navigator.userAgentData.brands))return navigator.userAgentData.brands.some(T=>/chromium|google chrome|microsoft edge/i.test(T.brand||""))}catch{}const k=navigator.userAgent||"";return!!(/Edg\//.test(k)||/Chrome\//.test(k)&&!/OPR\/|YaBrowser|Opera/.test(k))}function ue(){try{if(oe()||localStorage.getItem("pearnly_chrome_banner_dismissed")==="1")return;const k=document.getElementById("chrome-only-banner");if(!k)return;const T=k.querySelector('[data-i18n="chrome-banner-msg"]'),A=k.querySelector('[data-i18n="chrome-banner-dismiss"]');T&&typeof t=="function"&&(T.textContent=t("chrome-banner-msg")),A&&typeof t=="function"&&(A.textContent=t("chrome-banner-dismiss")),k.style.display="";const U=document.getElementById("chrome-only-banner-close");U&&!U.dataset.bound&&(U.dataset.bound="1",U.addEventListener("click",()=>{k.style.display="none";try{localStorage.setItem("pearnly_chrome_banner_dismissed","1")}catch{}}))}catch{}}typeof document<"u"&&(document.readyState==="loading"?document.addEventListener("DOMContentLoaded",ue):setTimeout(ue,0)),window._refreshChromeBanner=ue})();(function(){let e=null,n=null,a="new",o=!1,s=!1;async function i(){const B=document.getElementById("email-empty"),P=document.getElementById("email-account-card");if(document.getElementById("email-logs-section"),!(!B||!P))try{const J=await fetch("/api/email-ingest/account",{headers:{Authorization:"Bearer "+token}});if(J.status===401){localStorage.removeItem("mrpilot_token");const W=await J.json().catch(()=>({}));if((typeof W.detail=="string"?W.detail:W.detail&&W.detail.code||"")==="auth.session_revoked"){_showSessionRevokedModal();return}window.location.href="/";return}if(!J.ok){f("none");return}const G=await J.json();e=G.account||null,n=G.presets||{},o=!0,r(),e&&y()}catch(J){console.error("[email-ingest] load failed",J),f("none")}}function r(){const B=document.getElementById("email-empty"),P=document.getElementById("email-account-card"),J=document.getElementById("email-logs-section");if(!e){B.style.display="",P.style.display="none",J&&(J.style.display="none"),f("none");return}B.style.display="none",P.style.display="",J&&(J.style.display="");const G=document.getElementById("email-account-addr"),W=document.getElementById("email-account-host"),te=document.getElementById("email-account-last"),re=document.getElementById("email-last-error"),H=document.getElementById("email-enabled-toggle");if(G&&(G.textContent=e.email_address||"-"),W&&(W.textContent=`${e.imap_host||"-"}:${e.imap_port||993}`),te){const E=e.last_fetched_at;if(!E)te.textContent=t("email-last-never");else{const g=l(E),q=!e.last_error;te.textContent=q?t("email-last-ok",{time:g}):t("email-last-fail",{time:g})}}re&&(e.last_error?(re.style.display="",re.textContent=d(e.last_error)):re.style.display="none"),H&&(H.checked=!!e.enabled),e.enabled?e.last_error?f("error"):f("on"):f("off")}function f(B){const P=document.getElementById("email-status-summary");if(!P)return;P.classList.remove("none","ready","active","coming");let J="auto-status-loading";B==="none"?(J="email-status-none",P.classList.add("none")):B==="on"?(J="email-status-on",P.classList.add("active")):B==="off"?(J="email-status-off",P.classList.add("coming")):B==="error"&&(J="email-status-error",P.classList.add("none")),P.setAttribute("data-i18n",J),P.textContent=t(J)}function l(B){if(!B)return"";const P=new Date(B);if(isNaN(P.getTime()))return"";const J=G=>String(G).padStart(2,"0");return`${J(P.getMonth()+1)}-${J(P.getDate())} ${J(P.getHours())}:${J(P.getMinutes())}`}function d(B){if(!B)return"";const P=String(B);return/auth|AUTHENTICATIONFAILED|invalid credentials/i.test(P)?t("email-test-auth-fail"):/timeout|timed out/i.test(P)?t("email.timeout"):(/ENOTFOUND|getaddrinfo/i.test(P),P)}function c(B){a=B;const P=document.getElementById("email-modal");if(!P)return;const J=document.getElementById("email-preset");J.innerHTML="";const G=n||{},W=["gmail","outlook","yahoo","icloud","qq","163","custom"],te={gmail:"Gmail",outlook:"Outlook / Office365",yahoo:"Yahoo Mail",icloud:"iCloud",qq:"QQ 邮箱",163:"网易 163"};W.forEach(Q=>{if(!G[Q])return;const ee=document.createElement("option");ee.value=Q,ee.textContent=Q==="custom"?t("email-preset-custom"):te[Q]||Q,J.appendChild(ee)});const re=document.getElementById("email-modal-title"),H=document.getElementById("email-address"),E=document.getElementById("email-password"),g=document.getElementById("email-imap-host"),q=document.getElementById("email-imap-port"),N=document.getElementById("email-imap-ssl"),K=document.getElementById("email-folder"),Z=document.getElementById("email-mark-read"),le=document.getElementById("email-bind-enabled"),ie=document.getElementById("email-test-result"),V=document.getElementById("email-adv-details");if(ie&&(ie.style.display="none",ie.textContent=""),B==="edit"&&e){re.setAttribute("data-i18n","email-modal-title-edit"),re.textContent=t("email-modal-title-edit"),H.value=e.email_address||"",E.value="",E.setAttribute("data-i18n-placeholder","email-field-password-edit-ph"),E.placeholder=t("email-field-password-edit-ph"),g.value=e.imap_host||"",q.value=e.imap_port||993,N.checked=e.imap_use_ssl!==!1,K.value=e.folder||"INBOX",Z.checked=e.mark_as_read!==!1,le.checked=e.enabled!==!1;const Q=document.getElementById("email-filter-sender"),ee=document.getElementById("email-filter-subject");Q&&(Q.value=e.filter_sender||""),ee&&(ee.value=e.filter_subject||""),b(e.interval_min||15),J.value=M(e.imap_host)||"custom",V&&(V.open=!0)}else{re.setAttribute("data-i18n","email-modal-title-new"),re.textContent=t("email-modal-title-new"),H.value="",E.value="",E.setAttribute("data-i18n-placeholder","email-field-password-ph"),E.placeholder=t("email-field-password-ph"),J.value="gmail",u("gmail"),K.value="INBOX",Z.checked=!0,le.checked=!0;const Q=document.getElementById("email-filter-sender"),ee=document.getElementById("email-filter-subject");Q&&(Q.value=""),ee&&(ee.value=""),b(15),V&&(V.open=!1)}x(),P.style.display="flex",setTimeout(()=>H.focus(),60)}function p(){const B=document.getElementById("email-modal");B&&(B.style.display="none")}function u(B){const P=(n||{})[B];if(!P||B==="custom")return;const J=document.getElementById("email-imap-host"),G=document.getElementById("email-imap-port"),W=document.getElementById("email-imap-ssl");J&&(J.value=P.host||""),G&&(G.value=P.port||993),W&&(W.checked=P.ssl!==!1)}const v={"gmail.com":"gmail","googlemail.com":"gmail","outlook.com":"outlook","hotmail.com":"outlook","live.com":"outlook","office365.com":"outlook","msn.com":"outlook","yahoo.com":"yahoo","yahoo.co.jp":"yahoo","icloud.com":"icloud","me.com":"icloud","mac.com":"icloud","qq.com":"qq","foxmail.com":"qq","163.com":"163","126.com":"163","yeah.net":"163"};function _(B){if(!B||!B.includes("@"))return;const P=B.split("@")[1].toLowerCase().trim(),J=v[P];if(!J)return;const G=document.getElementById("email-preset");if(!G)return;const W=G.value;W&&W!=="custom"&&W!==""&&W===J||(G.value=J,u(J))}function M(B){if(!B)return null;const P=n||{};for(const J in P)if(J!=="custom"&&P[J]&&P[J].host===B)return J;return null}function I(){const B=document.querySelector("#email-interval-options .email-interval-btn.active"),P=B?parseInt(B.dataset.interval,10):15;return{email_address:(document.getElementById("email-address").value||"").trim(),password:document.getElementById("email-password").value||"",imap_host:(document.getElementById("email-imap-host").value||"").trim(),imap_port:parseInt(document.getElementById("email-imap-port").value||"993",10)||993,imap_use_ssl:document.getElementById("email-imap-ssl").checked,folder:(document.getElementById("email-folder").value||"INBOX").trim()||"INBOX",mark_as_read:document.getElementById("email-mark-read").checked,enabled:document.getElementById("email-bind-enabled").checked,interval_min:[5,15,60].includes(P)?P:15,filter_sender:(document.getElementById("email-filter-sender").value||"").trim()||null,filter_subject:(document.getElementById("email-filter-subject").value||"").trim()||null}}function x(){const B=document.getElementById("email-interval-options");!B||B._bound||(B._bound=!0,B.addEventListener("click",P=>{const J=P.target.closest(".email-interval-btn");J&&(B.querySelectorAll(".email-interval-btn").forEach(G=>G.classList.remove("active")),J.classList.add("active"))}))}function b(B){const P=[5,15,60].includes(B)?B:15,J=document.getElementById("email-interval-options");J&&J.querySelectorAll(".email-interval-btn").forEach(G=>{G.classList.toggle("active",parseInt(G.dataset.interval,10)===P)})}function $(B,P){const J=document.getElementById("email-test-result");J&&(J.style.display="",J.textContent=P,J.className="form-test-result "+(B==="ok"?"ok":B==="running"?"running":"fail"))}async function S(){const B=I();if(!B.email_address){$("fail",t("email-addr-required"));return}if(!B.password){$("fail",t("email-password-required"));return}if(!B.imap_host){$("fail",t("email-host-required"));return}const P=document.getElementById("btn-email-modal-test");P&&(P.disabled=!0),$("running",t("email-test-running"));try{const J=await fetch("/api/email-ingest/test",{method:"POST",headers:{Authorization:"Bearer "+token,"Content-Type":"application/json"},body:JSON.stringify({email_address:B.email_address,password:B.password,imap_host:B.imap_host,imap_port:B.imap_port,imap_use_ssl:B.imap_use_ssl,folder:B.folder})}),G=await J.json().catch(()=>({}));if(J.ok&&G.success)$("ok",t("email-test-ok",{folder:B.folder,n:G.folder_count??"?"}));else{const W=G.error_msg||"";W==="auth_failed"||/auth/i.test(W)?$("fail",t("email-test-auth-fail")):$("fail",t("email-test-fail",{msg:W||J.status}))}}catch(J){$("fail",t("email-test-fail",{msg:String(J).slice(0,120)}))}finally{P&&(P.disabled=!1)}}async function F(){const B=I();if(!B.email_address){$("fail",t("email-addr-required"));return}if(a==="new"&&!B.password){$("fail",t("email-password-required"));return}if(!B.imap_host){$("fail",t("email-host-required"));return}const P=document.getElementById("btn-email-modal-save");P&&(P.disabled=!0);const J={...B};a==="edit"&&!J.password&&delete J.password;try{const G=await fetch("/api/email-ingest/account",{method:"PUT",headers:{Authorization:"Bearer "+token,"Content-Type":"application/json"},body:JSON.stringify(J)}),W=await G.json().catch(()=>({}));if(G.ok&&W.ok)e=W.account,showToast(t("email-save-ok"),"success"),p(),r(),y();else{const re="email."+(W.detail||"").split(".").slice(-1)[0];$("fail",t(re)!==re?t(re):t("email-save-fail"))}}catch{$("fail",t("email-save-fail"))}finally{P&&(P.disabled=!1)}}async function j(){if(!(!e||!await showConfirm(t("email-unbind-confirm",{email:e.email_address}),{danger:!0,okText:t("email-btn-unbind")})))try{if((await fetch("/api/email-ingest/account",{method:"DELETE",headers:{Authorization:"Bearer "+token}})).ok){e=null,showToast(t("email-unbind-ok"),"success"),r();const J=document.getElementById("email-logs-list");J&&(J.innerHTML="")}else showToast(t("email-unbind-fail"),"error")}catch{showToast(t("email-unbind-fail"),"error")}}async function w(){if(!e||s)return;if(!e.enabled){showToast(t("email.disabled"),"error");return}s=!0;const B=document.getElementById("btn-email-trigger"),P=B?B.innerHTML:"";B&&(B.disabled=!0,B.innerHTML=`<span>${escapeHtml(t("email-trigger-running"))}</span>`);try{const J=await fetch("/api/email-ingest/trigger",{method:"POST",headers:{Authorization:"Bearer "+token}}),G=await J.json().catch(()=>({}));if(J.ok){const W=G.emails_scanned||0,te=G.ocr_succeeded||0,re=G.ocr_failed||0;W===0&&te===0&&re===0?showToast(t("email-trigger-empty"),"success"):showToast(t("email-trigger-result",{scanned:W,ok:te,fail:re}),re>0?"warn":"success")}else{const te="email."+(G.detail||"").split(".").slice(-1)[0];showToast(t(te)!==te?t(te):t("email-trigger-fail"),"error")}await i()}catch{showToast(t("email-trigger-fail"),"error")}finally{s=!1,B&&(B.disabled=!1,B.innerHTML=P)}}async function h(){if(!e)return;const B=document.getElementById("email-enabled-toggle"),P=!!(B&&B.checked),J=e.enabled;try{const G=await fetch("/api/email-ingest/account",{method:"PUT",headers:{Authorization:"Bearer "+token,"Content-Type":"application/json"},body:JSON.stringify({email_address:e.email_address,imap_host:e.imap_host,imap_port:e.imap_port,imap_use_ssl:e.imap_use_ssl,folder:e.folder||"INBOX",filter_subject:e.filter_subject||null,filter_sender:e.filter_sender||null,mark_as_read:e.mark_as_read!==!1,enabled:P})}),W=await G.json().catch(()=>({}));G.ok&&W.ok?(e=W.account,r()):(B&&(B.checked=J),showToast(t("email-toggle-fail"),"error"))}catch{B&&(B.checked=J),showToast(t("email-toggle-fail"),"error")}}async function y(){const B=document.getElementById("email-logs-list");if(B){B.innerHTML=`<div class="erp-logs-empty">${escapeHtml(t("erp-logs-loading"))}</div>`;try{const P=await fetch("/api/email-ingest/logs?limit=20",{headers:{Authorization:"Bearer "+token}});if(!P.ok){B.innerHTML=`<div class="erp-logs-empty">${escapeHtml(t("erp-logs-error"))}</div>`;return}const J=await P.json();if(!Array.isArray(J)||J.length===0){B.innerHTML=`<div class="erp-logs-empty">${escapeHtml(t("email-logs-empty"))}</div>`;return}B.innerHTML=J.map(L).join("")}catch{B.innerHTML=`<div class="erp-logs-empty">${escapeHtml(t("erp-logs-error"))}</div>`}}}function L(B){const P=l(B.created_at),J=B.status||"failed",G=J==="success"?"ok":J==="partial"?"partial":"fail",W=J==="success"?"✓":J==="partial"?"◐":"✗",te=B.trigger==="manual"?`<span class="log-tag manual">${escapeHtml(t("email-log-tag-manual"))}</span>`:`<span class="log-tag auto">${escapeHtml(t("email-log-tag-auto"))}</span>`,re=t("email-log-counts",{scanned:B.emails_scanned||0,att:B.attachments_found||0,ok:B.ocr_succeeded||0,fail:B.ocr_failed||0}),H=(B.elapsed_ms||0)+"ms";return`
        ...
        `}function C(){const B=document.getElementById("btn-email-bind");B&&B.addEventListener("click",()=>c("new"));const P=document.getElementById("btn-email-edit");P&&P.addEventListener("click",()=>c("edit"));const J=document.getElementById("btn-email-unbind");J&&J.addEventListener("click",j);const G=document.getElementById("btn-email-trigger");G&&G.addEventListener("click",w);const W=document.getElementById("email-enabled-toggle");W&&W.addEventListener("change",h);const te=document.getElementById("email-modal-close");te&&te.addEventListener("click",p);const re=document.getElementById("btn-email-modal-cancel");re&&re.addEventListener("click",p);const H=document.getElementById("btn-email-modal-test");H&&H.addEventListener("click",S);const E=document.getElementById("btn-email-modal-save");E&&E.addEventListener("click",F);const g=document.getElementById("email-preset");g&&g.addEventListener("change",K=>u(K.target.value));const q=document.getElementById("email-address");q&&!q.dataset.autoBound&&(q.dataset.autoBound="1",q.addEventListener("blur",K=>_((K.target.value||"").trim())),q.addEventListener("input",K=>{const Z=(K.target.value||"").trim();Z.includes("@")&&Z.split("@")[1].includes(".")&&_(Z)}));const N=document.getElementById("btn-email-refresh-logs");N&&N.addEventListener("click",()=>{N.classList.add("spinning"),setTimeout(()=>N.classList.remove("spinning"),600),y()})}C(),window._loadEmailIngestPanel=i,window._rerenderEmailIngest=function(){if(!o)return;r();const B=document.getElementById("email-logs-section");e&&B&&B.open&&y()};let D=null;window._startEmailLogAutoRefresh=function(){D||(D=setInterval(()=>{e&&o&&y()},3e4))},window._stopEmailLogAutoRefresh=function(){D&&(clearInterval(D),D=null)}})();(function(){let e=[],n=null,a=[],o="all",s=null,i=!1;async function r(){if(i){C();return}i=!0,f(),await l(),C()}function f(){const m=document.getElementById("bank-file-input");m&&!m._bound&&(m._bound=!0,m.addEventListener("change",_));const R=document.getElementById("btn-bank-queue-clear-done");R&&!R._bound&&(R._bound=!0,R.addEventListener("click",S));const O=document.getElementById("btn-bank-back");O&&!O._bound&&(O._bound=!0,O.addEventListener("click",()=>{n=null,a=[],te()}));const Y=document.getElementById("btn-bank-delete");Y&&!Y._bound&&(Y._bound=!0,Y.addEventListener("click",h));const X=document.getElementById("btn-bank-run-match");X&&!X._bound&&(X._bound=!0,X.addEventListener("click",w)),document.querySelectorAll(".bank-filter-btn").forEach(fe=>{fe._bound||(fe._bound=!0,fe.addEventListener("click",()=>{o=fe.dataset.bankFilter||"all",document.querySelectorAll(".bank-filter-btn").forEach(me=>{me.classList.toggle("active",me===fe)}),Z()}))}),document.querySelectorAll("[data-bank-cand-close]").forEach(fe=>{fe._bound||(fe._bound=!0,fe.addEventListener("click",ne))});const de=document.getElementById("btn-bank-cand-pane-close");de&&!de._bound&&(de._bound=!0,de.addEventListener("click",ne));const se=document.getElementById("btn-bank-cand-ignore");se&&!se._bound&&(se._bound=!0,se.addEventListener("click",y));const ce=document.getElementById("btn-bank-cand-ignore-pane");ce&&!ce._bound&&(ce._bound=!0,ce.addEventListener("click",y));const ae=document.getElementById("bank-client-badge");ae&&!ae._bound&&(ae._bound=!0,ae.addEventListener("click",E)),document.querySelectorAll("[data-bank-client-picker-close]").forEach(fe=>{fe._bound||(fe._bound=!0,fe.addEventListener("click",g))});const pe=document.getElementById("btn-bank-client-picker-save");pe&&!pe._bound&&(pe._bound=!0,pe.addEventListener("click",N)),document.querySelectorAll(".bank-sessions-chip").forEach(fe=>{fe._bound||(fe._bound=!0,fe.addEventListener("click",()=>{D=fe.dataset.sessFilter||"all",document.querySelectorAll(".bank-sessions-chip").forEach(me=>{me.classList.toggle("active",me===fe)}),B()}))})}async function l(){try{const m=await fetch("/api/bank-recon/sessions?limit=30",{headers:{Authorization:"Bearer "+token}});if(!m.ok)throw new Error("sessions:"+m.status);e=await m.json(),B()}catch(m){console.warn("[bank-recon] loadSessions failed",m),e=[],B()}}async function d(m){try{const R="/api/bank-recon/sessions/"+encodeURIComponent(m)+(o!=="all"?"?filter="+o:""),O=await fetch(R,{headers:{Authorization:"Bearer "+token}});if(!O.ok)throw new Error("detail:"+O.status);const Y=await O.json();n=Y.session,a=Y.transactions||[],W()}catch(R){console.warn("[bank-recon] loadSessionDetail failed",R),showToast(t("bank-load-failed"),"error")}}let c=[],p=0;const u=3;function v(){return p+=1,"q"+p+"_"+Date.now()}async function _(m){const R=Array.from(m.target.files||[]);if(m.target.value="",R.length!==0){for(const O of R){const Y={id:v(),file:O,name:O.name,size:O.size,status:"pending",progress:0,error_code:null,tx_count:0,session_id:null};O.name.toLowerCase().endsWith(".pdf")?O.size>20*1024*1024&&(Y.status="failed",Y.error_code="bank_recon.file_too_large"):(Y.status="failed",Y.error_code="bank_recon.only_pdf"),c.push(Y)}M(),I(),F()}}function M(){const m=document.getElementById("bank-upload-queue");m&&(m.style.display=""),oe(),ue()}function I(){const m=document.getElementById("bank-upload-queue-list"),R=document.getElementById("bank-upload-queue-summary");if(!m)return;if(c.length===0){m.innerHTML="",R&&(R.textContent="");const se=document.getElementById("bank-upload-queue");se&&(se.style.display="none");return}let O=0,Y=0,X=0,de=0;for(const se of c)se.status==="ok"?O++:se.status==="failed"?Y++:se.status==="uploading"||se.status==="parsing"?X++:de++;R&&(R.textContent=t("bank-queue-summary").replace("{ok}",O).replace("{run}",X).replace("{wait}",de).replace("{fail}",Y)),m.innerHTML=c.map(x).join(""),m.querySelectorAll("[data-q-act]").forEach(se=>{const ce=se.dataset.qAct,ae=se.dataset.qId;se.addEventListener("click",()=>{ce==="retry"&&b(ae),ce==="remove"&&$(ae)})})}function x(m){const R=(m.size/1024).toFixed(0)+" KB";let O="",Y="";if(m.status==="pending")O='<span class="bq-stat bq-wait">'+t("bank-queue-status-wait")+"</span>",Y='<button data-q-act="remove" data-q-id="'+z(m.id)+'" class="bq-act">×</button>';else if(m.status==="uploading")O='<span class="bq-stat bq-run">'+t("bank-queue-status-uploading")+'</span><div class="bq-bar"><div class="bq-bar-fill" style="width:'+(m.progress||0)+'%"></div></div>';else if(m.status==="parsing")O='<span class="bq-stat bq-run">'+t("bank-queue-status-parsing")+'</span><div class="bq-bar"><div class="bq-bar-fill bq-bar-indet"></div></div>';else if(m.status==="ok")O='<span class="bq-stat bq-ok">'+t("bank-queue-status-ok").replace("{n}",m.tx_count||0)+"</span>",Y='<button data-q-act="remove" data-q-id="'+z(m.id)+'" class="bq-act">×</button>';else if(m.status==="failed"){const X=k(m.error_code||"unknown");O='<span class="bq-stat bq-fail" title="'+z(X)+'">'+z(X)+"</span>",Y='<button data-q-act="retry" data-q-id="'+z(m.id)+'" class="bq-act bq-act-retry">'+t("bank-queue-retry")+'</button><button data-q-act="remove" data-q-id="'+z(m.id)+'" class="bq-act">×</button>'}return'<div class="bq-row" data-q-row="'+z(m.id)+'"><div class="bq-name" title="'+z(m.name)+'">'+z(m.name)+'</div><div class="bq-size">'+R+'</div><div class="bq-status">'+O+'</div><div class="bq-actions">'+Y+"</div></div>"}function b(m){const R=c.find(O=>O.id===m);R&&(R.status="pending",R.error_code=null,R.progress=0,I(),F())}function $(m){const R=c.findIndex(Y=>Y.id===m);if(R<0)return;const O=c[R];O.status==="uploading"||O.status==="parsing"||(c.splice(R,1),I())}function S(){c=c.filter(m=>m.status!=="ok"),I()}async function F(){for(;;){if(c.filter(O=>O.status==="uploading"||O.status==="parsing").length>=u)return;const R=c.find(O=>O.status==="pending");if(!R){c.every(O=>O.status==="ok"||O.status==="failed")&&(await l(),typeof window.loadReconcilePage=="function"&&window.loadReconcilePage());return}j(R).then(()=>F())}}async function j(m){m.status="uploading",m.progress=0,I();try{const R=new FormData;R.append("file",m.file,m.name);const O=await new Promise((X,de)=>{const se=new XMLHttpRequest;se.open("POST","/api/bank-recon/upload"),se.setRequestHeader("Authorization","Bearer "+token),se.upload.onprogress=ce=>{ce.lengthComputable&&(m.progress=Math.min(99,Math.round(ce.loaded/ce.total*100)),I())},se.upload.onload=()=>{m.status="parsing",I()},se.onload=()=>{se.status>=200&&se.status<300?X({status:se.status,text:se.responseText}):X({status:se.status,text:se.responseText})},se.onerror=()=>de(new Error("network")),se.send(R)});let Y={};try{Y=JSON.parse(O.text||"{}")}catch{Y={}}if(O.status>=400){m.status="failed",m.error_code=Y&&Y.detail||"unknown",I();return}if(Y.parse_status==="parse_failed"){m.status="failed",m.error_code=Y.error==="scanned_pdf_not_yet"?"bank_recon.scanned":"bank_recon.no_tx",I();return}m.status="ok",m.tx_count=Y.tx_count||0,m.session_id=Y.session_id||null,I()}catch(R){console.warn("[bank-recon] upload failed",R),m.status="failed",m.error_code="network",I()}}async function w(){if(!n)return;const m=document.getElementById("btn-bank-run-match"),R=m.innerHTML;m.disabled=!0,m.innerHTML="<span>"+t("bank-matching")+"</span>";try{const O=await fetch("/api/bank-recon/sessions/"+encodeURIComponent(n.id)+"/match",{method:"POST",headers:{Authorization:"Bearer "+token}});if(!O.ok)throw new Error("match:"+O.status);const Y=await O.json();showToast(t("bank-match-done").replace("{matched}",Y.matched).replace("{suggested}",Y.suggested).replace("{unmatched}",Y.unmatched),"success"),await d(n.id),await l()}catch(O){console.warn("[bank-recon] match failed",O),showToast(t("bank-match-failed"),"error")}finally{m.disabled=!1,m.innerHTML=R}}async function h(){if(!(!n||!await showConfirm(t("bank-delete-confirm"),{danger:!0})))try{const R=await fetch("/api/bank-recon/sessions/"+encodeURIComponent(n.id),{method:"DELETE",headers:{Authorization:"Bearer "+token}});if(!R.ok)throw new Error("delete:"+R.status);showToast(t("bank-deleted"),"success"),n=null,a=[],te(),await l()}catch(R){console.warn("[bank-recon] delete failed",R),showToast(t("bank-delete-failed"),"error")}}async function y(){if(s)try{const m=await fetch("/api/bank-recon/tx/"+encodeURIComponent(s.id)+"/override",{method:"POST",headers:{Authorization:"Bearer "+token,"Content-Type":"application/json"},body:JSON.stringify({status:"ignored"})});if(!m.ok)throw new Error("ignore:"+m.status);ne(),await d(n.id)}catch{showToast(t("bank-action-failed"),"error")}}async function L(m){if(s)try{const R=await fetch("/api/bank-recon/tx/"+encodeURIComponent(s.id)+"/override",{method:"POST",headers:{Authorization:"Bearer "+token,"Content-Type":"application/json"},body:JSON.stringify({status:"matched",history_id:m})});if(!R.ok)throw new Error("pick:"+R.status);showToast(t("bank-matched-ok"),"success"),ne(),await d(n.id)}catch{showToast(t("bank-action-failed"),"error")}}function C(){const m=document.getElementById("bank-status-summary");if(!m)return;if(e.length===0){m.textContent=t("bank-pill-none");return}let O=0;for(const Y of e)Y.parse_status==="parsed"&&(Y.unmatched_count||0)>0&&O++;m.textContent=O>0?t("bank-pill-pending").replace("{n}",O):t("bank-pill-ok")}let D="all";function B(){const m=document.getElementById("bank-sessions-list");if(!m)return;let R=e||[];if(D==="parsed"?R=R.filter(O=>O.parse_status==="parsed"):D==="failed"&&(R=R.filter(O=>O.parse_status==="parse_failed")),!e||e.length===0){m.innerHTML='<div class="bank-empty" data-i18n="bank-sessions-empty">'+t("bank-sessions-empty")+"</div>";return}if(R.length===0){m.innerHTML='<div class="bank-empty">'+t("bank-sess-filter-empty")+"</div>";return}m.innerHTML=R.map(O=>J(O)).join(""),m.querySelectorAll(".bank-session-row").forEach(O=>{O.addEventListener("click",Y=>{Y.target.closest(".bank-session-trash")||d(O.dataset.sessionId)})}),m.querySelectorAll(".bank-session-trash").forEach(O=>{O.addEventListener("click",Y=>{Y.stopPropagation();const X=O.dataset.sessionId,de=O.dataset.sessionName||"";P(X,de)})})}async function P(m,R){if(!m)return;const O=(t("bank-session-delete-confirm")||"确定删除这条对账记录吗?").replace("{name}",R||"");if(await showConfirm(O,{danger:!0}))try{const X=await fetch("/api/bank-recon/sessions/"+encodeURIComponent(m),{method:"DELETE",headers:{Authorization:"Bearer "+token}});if(!X.ok)throw new Error("delete:"+X.status);showToast(t("bank-deleted"),"success"),n&&n.id===m&&(n=null,a=[],te()),await l(),typeof window.loadReconcilePage=="function"&&window.loadReconcilePage()}catch(X){console.warn("[bank-recon] delete failed",X),showToast(t("bank-delete-failed"),"error")}}window._deleteBankSession=P;function J(m){const R=(m.bank_code||"OTHER").toUpperCase(),O=U(m.period_start,m.period_end),Y=m.account_last4?"···"+m.account_last4:"",X=G(m),de=A(m.created_at);return`
...
`,e.dataset.wbInjected="1";try{const n=window._currentLang||localStorage.getItem("mrpilot_lang")||"th",a=window.I18N;a&&a[n]&&(e.querySelectorAll("[data-i18n]").forEach(o=>{const s=o.getAttribute("data-i18n");a[n][s]&&(o.textContent=a[n][s])}),e.querySelectorAll("[data-i18n-placeholder]").forEach(o=>{const s=o.getAttribute("data-i18n-placeholder");a[n][s]&&(o.placeholder=a[n][s])}))}catch{}}})();(function(){let e=[],n=null,a="",o="seller";const s={page:0,pageSize:12,keyword:""},i=new Set;let r=[];const f={keyword:""};let l=null;function d(){return{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||"")}}async function c(g,q={}){const N=await fetch(g,{...q,headers:{"Content-Type":"application/json",...d(),...q.headers||{}}});if(!N.ok){const K=await N.json().catch(()=>({}));throw new Error(K.detail||"HTTP "+N.status)}return N.json()}async function p(){try{e=(await c("/api/clients")).clients||[],window._clientsCache=e}catch(g){console.error("loadClientsCache fail",g),e=[]}try{typeof window._refreshExcClientFilter=="function"&&window._refreshExcClientFilter()}catch{}try{typeof window._refreshClientSwitcher=="function"&&window._refreshClientSwitcher()}catch{}return e}function u(g){o=g==="buyer"?"buyer":"seller",document.querySelectorAll("[data-cust-tab]").forEach(K=>K.classList.toggle("active",K.dataset.custTab===o));const q=document.getElementById("cust-pane-seller"),N=document.getElementById("cust-pane-buyer");q&&q.classList.toggle("active",o==="seller"),N&&N.classList.toggle("active",o==="buyer")}function v(){const g=window._userInfo||{},q=String(g.role||"").toLowerCase(),N=String(g.tenant_role||"").toLowerCase();return g.is_super_admin===!0||g.is_owner===!0||q==="owner"||q==="admin"||N==="owner"||N==="admin"}function _(){window._workspaceClientsCache=r,typeof window.renderWorkspaceControl=="function"&&window.renderWorkspaceControl()}async function M(){try{const g=await c("/api/workspace/clients");r=g&&(g.clients||g.items)||[],window._workspaceClientsCache=r}catch(g){console.error("loadSellerCache fail",g),r=[]}return r}function I(){const g=f.keyword.trim().toLowerCase();return g?r.filter(q=>(q.name||"").toLowerCase().includes(g)||(q.tax_id||"").toLowerCase().includes(g)):r}function x(){const g=document.getElementById("seller-tbody");if(!g)return;const q=v(),N=document.getElementById("btn-seller-new");N&&(N.style.display=q?"":"none");const K=I(),Z=typeof window.getActiveWorkspaceClientId=="function"?window.getActiveWorkspaceClientId():null;if(!K.length){g.innerHTML=`<div class="cust-empty">${escapeHtml(t(f.keyword?"cust-no-match":"seller-empty"))}</div>`;return}g.innerHTML=K.map(le=>{const V=Z!=null&&Number(Z)===Number(le.id)?`<span class="cust-badge-current"><svg viewBox="0 0 14 14" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M2 7.5l3.2 3.2L12 4"/></svg>${escapeHtml(t("seller-current"))}</span>`:`<button class="cust-row-btn primary" data-saction="activate" data-wid="${le.id}">${escapeHtml(t("seller-set-current"))}</button>`,Q=q?`
            ...
            </div>`}).join("")}function b(g){l=g?g.id:null,document.getElementById("wsclient-modal-title").textContent=t(g?"wsclient-modal-edit":"wsclient-modal-new"),document.getElementById("wsclient-input-name").value=g&&g.name||"",document.getElementById("wsclient-input-tax").value=g&&g.tax_id||"",document.getElementById("wsclient-modal-archive").style.display=g?"":"none",document.getElementById("wsclient-modal-mask").style.display="flex",setTimeout(()=>document.getElementById("wsclient-input-name").focus(),50)}function $(){document.getElementById("wsclient-modal-mask").style.display="none",l=null}async function S(){const g=document.getElementById("wsclient-input-name").value.trim(),q=document.getElementById("wsclient-input-tax").value.trim();if(!g){showToast(t("client-msg-name-required"),"fail");return}try{l?(await c("/api/workspace/clients/"+l,{method:"PATCH",body:JSON.stringify({name:g,tax_id:q})}),showToast(t("client-msg-updated"),"success")):(await c("/api/workspace/clients",{method:"POST",body:JSON.stringify({name:g,tax_id:q||null})}),showToast(t("client-msg-created"),"success")),$(),await M(),x(),_()}catch(N){const K=N&&N.message?N.message:t("client-msg-save-fail");showToast(t("client-msg-save-fail")+" · "+K,"fail")}}async function F(){if(!l)return;const g=r.find(N=>Number(N.id)===Number(l));if(await showConfirm(t("wsclient-archive-confirm").replace("{name}",g?g.name:""),{danger:!0}))try{const N=l;await c("/api/workspace/clients/"+N,{method:"DELETE"}),showToast(t("wsclient-archived"),"success"),typeof window.getActiveWorkspaceClientId=="function"&&Number(window.getActiveWorkspaceClientId())===Number(N)&&typeof window.enterPersonalMode=="function"&&window.enterPersonalMode(),$(),await M(),x(),_()}catch{showToast(t("client-msg-save-fail"),"fail")}}function j(){const g=s.keyword.trim().toLowerCase();return g?e.filter(q=>(q.name||"").toLowerCase().includes(g)||(q.short_name||"").toLowerCase().includes(g)||(q.tax_id||"").toLowerCase().includes(g)):e}function w(){const g=j(),q=s.pageSize,N=Math.max(0,Math.ceil(g.length/q)-1);s.page>N&&(s.page=N);const K=s.page*q;return{all:g,items:g.slice(K,K+q),start:K,ps:q,total:g.length,maxPage:N}}function h(){const g=document.getElementById("buyer-tbody");if(!g)return;const{items:q,start:N,ps:K,total:Z,maxPage:le}=w();Z?g.innerHTML=q.map(ee=>{const ne=i.has(ee.id);return`<div class="cust-row buyer-grid${ne?" selected":""}" data-cid="${ee.id}">
...
`,e.dataset.wbInjected="1";try{const n=window._currentLang||localStorage.getItem("mrpilot_lang")||"th",a=window.I18N;a&&a[n]&&(e.querySelectorAll("[data-i18n]").forEach(o=>{const s=o.getAttribute("data-i18n");a[n][s]&&(o.textContent=a[n][s])}),e.querySelectorAll("[data-i18n-placeholder]").forEach(o=>{const s=o.getAttribute("data-i18n-placeholder");a[n][s]&&(o.placeholder=a[n][s])}))}catch{}}})();(function(){let e={statsCache:null,listCache:[],currentRule:null,currentClient:"",currentStatus:"pending",loading:!1,selectedIds:new Set,offset:0,pageSize:50,total:0,loadFailed:!1,listScrollY:0};function n(H,E){let g=t(H)||H;if(E)for(const q in E)g=g.replace(new RegExp("\\{"+q+"\\}","g"),String(E[q]));return g}async function a(){try{const H=e.currentClient||"",E="/api/exceptions/stats?status=pending"+(H?"&client_id="+encodeURIComponent(H):""),g=await fetch(E,{headers:{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||"")}});if(!g.ok)return;const q=await g.json(),N=document.getElementById("nav-exc-badge");if(!N)return;const K=parseInt(q.pending||0,10);K>0?(N.textContent=K>99?"99+":String(K),N.style.display=""):N.style.display="none"}catch{}}function o(H){return H==="high"?`<svg viewBox="0 0 14 14" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
        ...
        </svg>`}function i(H){if(H==null)return"—";const E=parseFloat(H);return isNaN(E)?"—":"฿ "+E.toLocaleString(void 0,{minimumFractionDigits:2,maximumFractionDigits:2})}function r(H){return H?H.slice(0,10):"—"}function f(H){document.getElementById("exc-kpi-pending").textContent=H.pending||0,document.getElementById("exc-kpi-high").textContent=H.high_severity||0,document.getElementById("exc-kpi-resolved").textContent=H.resolved||0,document.getElementById("exc-kpi-learned").textContent=H.learned_rules||0;const E=document.getElementById("exc-status-tab-count-pending"),g=document.getElementById("exc-status-tab-count-resolved"),q=document.getElementById("exc-status-tab-count-ignored");E&&(E.textContent=H.pending||0),g&&(g.textContent=H.resolved||0),q&&(q.textContent=H.ignored||0),document.querySelectorAll("#exc-status-tabs .exc-status-tab").forEach(K=>{K.classList.toggle("active",K.dataset.status===(e.currentStatus||"pending"))})}function l(H){const E=document.getElementById("exc-chips");if(!E)return;const g=H.by_rule||{},q=["confidence_low","duplicate","amount_missing","math_mismatch","tax_id_format_invalid"];let K=`<button class="exc-chip ${!e.currentRule?"active":""}" data-rule="">
            ...
            </button>`}E.innerHTML=K,E.querySelectorAll(".exc-chip").forEach(Z=>{Z.addEventListener("click",()=>{const le=Z.dataset.rule||null;e.currentRule=le,_()})})}function d(H){const E=document.getElementById("exc-list");if(!E)return;if(!H||H.length===0){E.innerHTML=`<div class="exc-empty">
                ${s()}
        ...
        `;const le=H.severity||"medium",ie=t("exc-rule-"+H.rule_code)||H.rule_code,V=y(H.rule_code,H.detail||{}),Q=w(x.history),ee=x.history===null,ne=x.history&&x.history._err,oe=new Set;H.rule_code==="math_mismatch"?(oe.add("subtotal"),oe.add("vat"),oe.add("total_amount")):H.rule_code==="tax_id_format_invalid"?oe.add("seller_tax"):H.rule_code==="amount_missing"&&(oe.add("total_amount"),oe.add("invoice_number"));const ue=!!x.editing,k=x.editFields||{},T=(ae,pe,fe)=>{if(ee)return`<div class="exc-field-row"><label>${escapeHtml(t(pe))}</label><span class="val empty">…</span></div>`;const me=ue?k[ae]!==void 0?k[ae]:Q[ae]!==void 0&&Q[ae]!==null?Q[ae]:"":Q[ae],ge=oe.has(ae)?"flagged":"";if(ue){const ze=fe?"number":"text",Te=fe?' step="0.01" inputmode="decimal"':"",He=me==null?"":String(me).replace(/"/g,"&quot;");return`<div class="exc-field-row ${ge} editing">
        ...
        `;const z=document.getElementById("exc-fld-edit");z&&z.addEventListener("click",()=>{x.editing=!0,x.editFields={...w(x.history)},L()});const m=document.getElementById("exc-fld-cancel");m&&m.addEventListener("click",()=>{x.editing=!1,x.editFields=null,L()});const R=document.getElementById("exc-fld-save");R&&R.addEventListener("click",()=>C()),document.querySelectorAll(".exc-field-input").forEach(ae=>{ae.addEventListener("input",()=>{x.editFields||(x.editFields={}),x.editFields[ae.dataset.editKey]=ae.value})});const Y=document.getElementById("exc-pdf-retry");Y&&x.openExcId&&Y.addEventListener("click",()=>{x.excRow&&$(x.excRow.history_id,x.openExcId)});const X=H.status==="pending",de=!!(H.seller_name&&H.seller_name.trim()),se=document.getElementById("exc-btn-resolve"),ce=document.getElementById("exc-btn-ignore");se.disabled=!X,ce.disabled=!X||!de,ce.title=de?t("exc-ignore-hint"):t("exc-ignore-no-seller")}async function C(){if(!x.openExcId||!x.history||!x.history.pages||x.loading)return;x.loading=!0;const H=showToast(t("exc-fld-saving"),"loading",0);try{const E=JSON.parse(JSON.stringify(x.history.pages||[]));let g=E.findIndex(ie=>!ie.is_duplicate&&!ie.is_copy);g<0&&(g=0),E[g]||(E[g]={fields:{}});const q=E[g].fields||{},N=x.editFields||{},K=new Set(["subtotal","vat","total_amount"]),Z={...q};for(const ie in N){let V=N[ie];if((V===""||V===void 0)&&(V=null),K.has(ie)&&V!==null){const Q=parseFloat(V);V=isNaN(Q)?null:Q}Z[ie]=V}E[g].fields=Z;const le=await fetch("/api/history/"+encodeURIComponent(x.history.id),{method:"PUT",headers:{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||""),"Content-Type":"application/json"},body:JSON.stringify({pages:E})});if(!le.ok)throw new Error("http "+le.status);H(),showToast(t("exc-fld-save-ok"),"success"),F(),await u(),await _(),a()}catch(E){H(),console.warn("save fields fail",E),showToast(t("exc-fld-save-fail"),"error")}finally{x.loading=!1}}async function D(){if(!(!x.openExcId||x.loading)){x.loading=!0;try{const H=await fetch("/api/exceptions/"+x.openExcId+"/resolve",{method:"POST",headers:{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||"")}});if(!H.ok)throw new Error("http "+H.status);showToast(t("exc-toast-resolved"),"success"),F(),await u(),await _(),a()}catch(H){console.warn("resolve fail",H),showToast(t("exc-toast-action-fail"),"error")}finally{x.loading=!1}}}async function B(){if(!(!x.openExcId||x.loading)){x.loading=!0;try{const H=await fetch("/api/exceptions/"+x.openExcId+"/ignore",{method:"POST",headers:{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||"")}});if(!H.ok)throw new Error("http "+H.status);showToast(t("exc-toast-ignored"),"success"),F(),await u(),await _(),a()}catch(H){console.warn("ignore fail",H),showToast(t("exc-toast-action-fail"),"error")}finally{x.loading=!1}}}let P=!1;async function J(){if(P)return;const H=Array.from(e.selectedIds);if(H.length===0||!await showConfirm(n("exc-batch-confirm-resolve",{n:H.length})))return;P=!0;const g=showToast(n("exc-batch-count",{n:H.length})+" …","loading",0);try{const q=await fetch("/api/exceptions/batch",{method:"POST",headers:{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||""),"Content-Type":"application/json"},body:JSON.stringify({ids:H,action:"resolve"})});if(!q.ok)throw new Error("http "+q.status);const N=await q.json();g(),showToast(n("exc-toast-batch-resolved",{n:N.processed||0}),"success"),e.selectedIds.clear(),await u(),await _(),a()}catch(q){g(),console.warn("batch resolve fail",q),showToast(t("exc-toast-batch-fail"),"error")}finally{P=!1}}async function G(){if(P)return;const H=Array.from(e.selectedIds);if(H.length===0||!await showConfirm(n("exc-batch-confirm-ignore",{n:H.length}),{danger:!1}))return;P=!0;const g=showToast(n("exc-batch-count",{n:H.length})+" …","loading",0);try{const q=await fetch("/api/exceptions/batch",{method:"POST",headers:{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||""),"Content-Type":"application/json"},body:JSON.stringify({ids:H,action:"ignore"})});if(!q.ok)throw new Error("http "+q.status);const N=await q.json();g(),showToast(n("exc-toast-batch-ignored",{n:N.processed||0,wl:N.whitelist_added||0}),"success"),e.selectedIds.clear(),await u(),await _(),a()}catch(q){g(),console.warn("batch ignore fail",q),showToast(t("exc-toast-batch-fail"),"error")}finally{P=!1}}function W(){e.selectedIds.clear(),d(e.listCache)}document.addEventListener("click",H=>{H.target.closest("#exc-drawer-close")&&F(),H.target.closest("#exc-drawer-mask")&&F(),H.target.closest("#exc-btn-resolve")&&D(),H.target.closest("#exc-btn-ignore")&&B(),H.target.closest("#exc-batch-resolve")&&J(),H.target.closest("#exc-batch-ignore")&&G(),H.target.closest("#exc-batch-clear")&&W(),H.target.closest("#exc-loadmore")&&M()}),document.addEventListener("keydown",H=>{H.key==="Escape"&&x.openExcId&&F()}),document.addEventListener("click",H=>{H.target.closest("#btn-exc-refresh")&&(typeof window.loadExceptionsPage=="function"&&window.loadExceptionsPage(),a())}),document.addEventListener("change",H=>{if(!H.target.closest("#exc-client-filter"))return;const E=H.target;e.currentClient=E.value||"",e.currentRule=null,e.selectedIds.clear(),e.listCache=[],typeof window.loadExceptionsPage=="function"&&window.loadExceptionsPage(),a()}),document.addEventListener("click",H=>{const E=H.target.closest("#exc-status-tabs .exc-status-tab");if(!E)return;const g=E.dataset.status||"pending";g!==e.currentStatus&&(e.currentStatus=g,e.currentRule=null,e.selectedIds.clear(),e.listCache=[],typeof window.loadExceptionsPage=="function"&&window.loadExceptionsPage())}),window.addEventListener("online",()=>{e.loadFailed&&document.getElementById("page-exceptions")?.classList.contains("show")&&window.loadExceptionsPage&&window.loadExceptionsPage()}),setTimeout(a,1500),setInterval(a,6e4);function te(H){if(!H)return"—";try{const E=new Date(H),g=q=>String(q).padStart(2,"0");return`${E.getFullYear()}-${g(E.getMonth()+1)}-${g(E.getDate())} ${g(E.getHours())}:${g(E.getMinutes())}`}catch{return H.slice(0,16).replace("T"," ")}}async function re(){const H=document.getElementById("learned-list");if(H){H.innerHTML=`<div class="learned-empty">${escapeHtml(t("set-learned-loading"))}</div>`;try{const E=await fetch("/api/exception-whitelist",{headers:{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||"")}});if(!E.ok)throw new Error("http "+E.status);const q=(await E.json()).items||[];if(q.length===0){H.innerHTML=`<div class="learned-empty">${escapeHtml(t("set-learned-empty"))}</div>`;return}const N=`<svg viewBox="0 0 14 14" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round">
            ...
            <div class="erp-exc-foot">${F}</div>`;const j=document.getElementById("erp-exc-search");if(j){if(u.focusSearch){j.focus();try{j.setSelectionRange(u.searchCaret,u.searchCaret)}catch{}}j.addEventListener("input",()=>{u.q=j.value,u.focusSearch=!0,u.searchCaret=j.selectionStart||j.value.length,clearTimeout(n),n=setTimeout(()=>l(!1),350)}),j.addEventListener("blur",()=>{u.focusSearch=!1})}p.querySelectorAll(".erp-exc-chip").forEach(y=>{y.addEventListener("click",()=>{u.cat=y.dataset.erpexcCat||"",l(!1)})}),p.querySelectorAll("[data-erpexc-retry]").forEach(y=>{y.addEventListener("click",L=>{L.stopPropagation(),r(y.dataset.erpexcRetry,y)})}),p.querySelectorAll(".erp-exc-cb").forEach(y=>{y.addEventListener("change",()=>{const L=y.dataset.erpexcCb;y.checked?u.selected.add(L):u.selected.delete(L);const C=document.getElementById("erp-exc-cb-all");C&&(C.checked=x.length>0&&x.every(D=>u.selected.has(D.id))),s()})});const w=document.getElementById("erp-exc-cb-all");w&&w.addEventListener("change",()=>{x.forEach(y=>{w.checked?u.selected.add(y.id):u.selected.delete(y.id)}),p.querySelectorAll(".erp-exc-cb").forEach(y=>{y.checked=w.checked}),s()}),p.querySelectorAll("[data-erpexc-batch]").forEach(y=>{y.addEventListener("click",()=>f(y.dataset.erpexcBatch))});const h=document.getElementById("erp-exc-more");h&&h.addEventListener("click",()=>l(!0)),p.querySelectorAll(".erp-exc-row:not(.erp-exc-row-head)").forEach(y=>{y.addEventListener("click",L=>{L.target.closest("input,button")||typeof window._erpExcOpenEdit=="function"&&window._erpExcOpenEdit(y.dataset.erpexcId)})})}async function r(p,u){if(p){u&&(u.disabled=!0,u.textContent=t("erp-exc-retrying"));try{const v=await fetch("/api/erp/logs/"+encodeURIComponent(p)+"/retry",{method:"POST",headers:{Authorization:"Bearer "+a()}}),_=await v.json().catch(()=>({}));showToast(v.ok&&_.ok?t("erp-exc-retry-ok"):t("erp-exc-retry-fail"),v.ok&&_.ok?"success":"error")}catch{showToast(t("erp-exc-retry-fail"),"error")}if(e.selected.delete(p),l(!1),typeof window.refreshExcBadge=="function")try{window.refreshExcBadge()}catch{}}}async function f(p){const u=Array.from(e.selected);if(p==="clear"){e.selected.clear(),i();return}if(u.length!==0){if(p==="delete"){if(!await showConfirm(t("erp-exc-batch-delete-confirm",{n:u.length}),{danger:!0}))return;try{const _=await fetch("/api/erp/logs/batch-delete",{method:"POST",headers:{Authorization:"Bearer "+a(),"Content-Type":"application/json"},body:JSON.stringify({log_ids:u.slice(0,200)})}),M=await _.json().catch(()=>({}));showToast(_.ok?t("erp-exc-batch-delete-ok",{n:M.deleted||0}):t("erp-exc-retry-fail"),_.ok?"success":"error")}catch{showToast(t("erp-exc-retry-fail"),"error")}}else if(p==="retry")try{const v=await fetch("/api/erp/logs/batch-retry",{method:"POST",headers:{Authorization:"Bearer "+a(),"Content-Type":"application/json"},body:JSON.stringify({log_ids:u.slice(0,50)})}),_=await v.json().catch(()=>({}));showToast(v.ok?t("erp-exc-batch-retry-ok",{ok:_.succeeded||0,fail:(_.failed||0)+(_.skipped||0)}):t("erp-exc-retry-fail"),v.ok?"success":"error")}catch{showToast(t("erp-exc-retry-fail"),"error")}if(e.selected.clear(),l(!1),typeof window.refreshExcBadge=="function")try{window.refreshExcBadge()}catch{}}}async function l(p){const u=document.getElementById("erp-exc-block");if(!(!u||e.loading)){e.loading=!0;try{const v=new URLSearchParams;e.q&&v.set("q",e.q),e.cat&&v.set("category",e.cat),v.set("limit",String(e.pageSize)),v.set("offset",String(p?e.items.length:0));const _=await fetch("/api/erp/exceptions?"+v.toString(),{headers:{Authorization:"Bearer "+a()}});if(!_.ok){p||(u.hidden=!0);return}const M=await _.json(),I=M.items||[];e.items=p?e.items.concat(I):I,e.total=M.total||0,e.categories=M.categories||{},i()}catch{p||(u.hidden=!0)}finally{e.loading=!1}}}let d={};function c(){const p=document.getElementById("erp-exc-modal");p&&p.remove()}window._erpExcOpenEdit=function(p){const u=(e.items||[]).find(S=>String(S.id)===String(p));if(!u)return;const v=!!u.history_client_id&&u.category==="customer_mismatch",_=u.category==="product_mismatch"&&!!u.history_id&&!!u.endpoint_id,M=o(u),I=u.state==="needs_action"?"needs":u.state==="retrying"?"retry":"fail",x=(S,F)=>`<div class="erp-exc-m-row"><span class="erp-exc-m-k">${escapeHtml(S)}</span><span class="erp-exc-m-v">${escapeHtml(F||"—")}</span></div>`;let b="";if(v)b=`
            ...
            <div class="erp-exc-modal" role="dialog" aria-modal="true">
                ...
                <div class="erp-exc-m-body">
                    <div class="erp-exc-m-reason"><span class="erp-exc-state ${I}">${escapeHtml(t("erp-exc-state-"+(u.state||"failed")))}</span> ${escapeHtml(M)}${u.error_code?` <span class="erp-exc-code">${escapeHtml(u.error_code)}</span>`:""}</div>
                ...
                <div class="erp-exc-m-foot">
                    ...
                    </div>`).join(""),F.querySelectorAll(".erp-exc-m-prod-sel").forEach(D=>{D.addEventListener("change",()=>{const B=D.dataset.item,P=D.options[D.selectedIndex];D.value?j[B]={code:D.value,name:P&&P.dataset.pname||""}:delete j[B],S&&(S.disabled=Object.keys(j).length===0)})})};(async()=>{try{const D=await(await fetch("/api/history/"+encodeURIComponent(u.history_id),{headers:{Authorization:"Bearer "+a()}})).json().catch(()=>({})),B=D&&D.pages||[],P=[],J={};(Array.isArray(B)?B:[]).forEach(te=>{const re=te&&te.fields&&te.fields.items||[];(Array.isArray(re)?re:[]).forEach(H=>{const E=(H&&(H.name||H.description)||"").trim();E&&!J[E]&&(J[E]=1,P.push(E))})});const G=await fetch("/api/erp/endpoints/"+encodeURIComponent(u.endpoint_id)+"/products",{headers:{Authorization:"Bearer "+a()}}),W=await G.json().catch(()=>({}));if(!G.ok||!W.ok){F.innerHTML=`<div class="erp-exc-m-empty">${escapeHtml(t("erp-exc-edit-prod-fail"))}</div>`;return}w=W.products||[],y(P)}catch{F.innerHTML=`<div class="erp-exc-m-empty">${escapeHtml(t("erp-exc-edit-prod-fail"))}</div>`}})(),S&&S.addEventListener("click",async()=>{const C=Object.entries(j);if(C.length){S.disabled=!0,S.textContent=t("erp-exc-retrying");try{for(const[D,B]of C)if(!(await fetch("/api/erp/mappings/products",{method:"POST",headers:{Authorization:"Bearer "+a(),"Content-Type":"application/json"},body:JSON.stringify({erp_type:u.endpoint_adapter,item_name:D,erp_code:B.code,erp_name:B.name})})).ok){showToast(t("erp-exc-retry-fail"),"error"),S.disabled=!1,S.textContent=t("erp-exc-edit-bind-prod-retry");return}showToast(t("erp-exc-edit-prod-bound-ok"),"success"),c(),await r(u.id,null)}catch{showToast(t("erp-exc-retry-fail"),"error"),S.disabled=!1,S.textContent=t("erp-exc-edit-bind-prod-retry")}}})}},window._rerenderErpExceptions=i,window.loadErpExceptions=l,window._erpExcState=e})();(function(){function e(p){try{if(location.search.indexOf("test_center=1")>=0||localStorage.getItem("pearnly_test_mode")==="1"||p&&p.id&&String(p.id)==="468b50c1-5593-4fd6-990d-515ce8085563")return!0}catch{}return!1}window.applyRoleVisibility=function(){var u=window._userInfo,v=!1,_=!0,M=!1,I=!1;u&&(v=typeof canManageTeam=="function"?canManageTeam(u):!!(u.role==="owner"||u.is_super_admin),_=typeof shouldHideMoney=="function"?shouldHideMoney(u):u.role==="member"&&!u.is_super_admin,M=typeof isSuperAdmin=="function"?isSuperAdmin(u):!!u.is_super_admin,I=e(u)),document.querySelectorAll("[data-show-if-team]").forEach(function(b){b.style.display=v?"":"none"}),document.querySelectorAll("[data-show-if-money]").forEach(function(b){b.style.display=_?"none":""}),document.querySelectorAll("[data-show-if-admin]").forEach(function(b){b.style.display=M?"":"none"}),document.querySelectorAll("[data-show-if-test]").forEach(function(b){b.style.display=I?"":"none"});var x=M||I;document.querySelectorAll("[data-show-if-special]").forEach(function(b){b.style.display=x?"":"none"})},window.renderAvatarMenu=function(u){if(u){var v=document.getElementById("avatar-btn"),_=document.getElementById("avatar-popup-name"),M=document.getElementById("avatar-popup-email");if(!(!v||!_||!M)){var I=(u.username||"").trim(),x=I.split("@")[0]||I||"—",b=(I.charAt(0)||"?").toUpperCase(),$=(u.avatar_url||"").trim();if($){var S=$.replace(/"/g,"&quot;"),F=b.replace(/'/g,"\\'");v.innerHTML='<img src="'+S+'" alt="'+b+`" referrerpolicy="no-referrer" onerror="this.parentNode.textContent='`+F+`'">`}else v.textContent=b;_.textContent=x,M.textContent=I||"—",v.setAttribute("title",I||"")}}};function n(){var p=document.getElementById("avatar-wrap"),u=document.getElementById("avatar-btn"),v=document.getElementById("avatar-popup");if(!p||!u||!v)return;function _(){v.classList.remove("show"),u.setAttribute("aria-expanded","false")}function M(){v.classList.add("show"),u.setAttribute("aria-expanded","true")}u.addEventListener("click",function(I){I.stopPropagation(),v.classList.contains("show")?_():M()}),document.addEventListener("click",function(I){v.classList.contains("show")&&!p.contains(I.target)&&_()}),v.addEventListener("click",function(I){var x=I.target.closest(".avatar-popup-item");if(x){var b=x.dataset.action;switch(_(),b){case"settings":typeof openSettingsModal=="function"?openSettingsModal():typeof routeTo=="function"&&routeTo("settings");break;case"team":typeof openSettingsModal=="function"?openSettingsModal():typeof routeTo=="function"&&routeTo("settings"),setTimeout(function(){typeof switchSettingsTab=="function"&&switchSettingsTab("team")},50);break;case"billing":typeof openSettingsModal=="function"?openSettingsModal():typeof routeTo=="function"&&routeTo("settings"),setTimeout(function(){typeof switchSettingsTab=="function"&&switchSettingsTab("plan")},50);break;case"shortcuts":if(typeof showToast=="function"){var $=typeof t=="function"?t("feature-coming-soon"):"即将上线";showToast($||"即将上线","info")}break;case"admin":window.location.href="/admin/cost";break;case"test-center":typeof routeTo=="function"&&routeTo("test-center");break;case"help":var S=document.getElementById("help-modal");S&&(S.style.display="flex");break;case"logout":try{localStorage.removeItem("mrpilot_token")}catch{}try{localStorage.removeItem("mrpilot_user")}catch{}window.location.href="/";break}}}),window._closeAvatarPopup=_}function a(){return[].slice.call(document.querySelectorAll(".cmdk-item")).filter(function(p){return p.style.display!=="none"})}function o(p){var u=a();u.forEach(function(v){v.classList.remove("focus")}),u[p]&&(u[p].classList.add("focus"),u[p].scrollIntoView({block:"nearest"}))}function s(p){var u=a();if(u.length){var v=u.findIndex(function(M){return M.classList.contains("focus")});v<0&&(v=0);var _=(v+p+u.length)%u.length;o(_)}}function i(p){p=(p||"").toLowerCase().trim();var u=0,v=window._userInfo,_=typeof isSuperAdmin=="function"?isSuperAdmin(v):!!(v&&v.is_super_admin),M=e(v);document.querySelectorAll(".cmdk-item").forEach(function(x){if(x.dataset.showIfAdmin==="1"&&!_){x.style.display="none";return}if(x.dataset.showIfTest==="1"&&!M){x.style.display="none";return}var b=(x.dataset.cmdkText||x.textContent||"").toLowerCase(),$=!p||b.indexOf(p)>=0;x.style.display=$?"":"none",x.classList.remove("focus"),$&&u++}),document.querySelectorAll("[data-cmdk-section]").forEach(function(x){for(var b=x.nextElementSibling,$=!1;b&&!b.hasAttribute("data-cmdk-section");){if(b.classList&&b.classList.contains("cmdk-item")&&b.style.display!=="none"){$=!0;break}b=b.nextElementSibling}x.style.display=$?"":"none"});var I=document.getElementById("cmdk-empty");I&&(I.style.display=u===0?"flex":"none"),o(0)}window.openCmdk=function(){var u=document.getElementById("cmdk-mask");u&&(typeof window._closeAvatarPopup=="function"&&window._closeAvatarPopup(),u.classList.add("show"),typeof window.applyRoleVisibility=="function"&&window.applyRoleVisibility(),setTimeout(function(){var v=document.getElementById("cmdk-input");v&&(v.value="",i(""),v.focus(),o(0))},50))},window.closeCmdk=function(){var u=document.getElementById("cmdk-mask");u&&u.classList.remove("show")};function r(p){if(p){if(p.classList.contains("cmdk-item-locked")){if(typeof showToast=="function"){var u=typeof t=="function"?t("feature-coming-soon"):"即将上线";showToast(u||"即将上线","info")}return}var v=p.dataset.cmdkRoute,_=p.dataset.cmdkAction;if(window.closeCmdk(),v){typeof routeTo=="function"&&routeTo(v);return}if(_){if(_==="open-admin"){window.location.href="/admin/cost";return}if(_.indexOf("lang-")===0){var M=_.slice(5);typeof applyLang=="function"&&applyLang(M)}}}}function f(){var p=document.getElementById("cmdk-mask"),u=document.getElementById("cmdk-input"),v=document.getElementById("cmdk-body");if(!(!p||!u||!v)){p.addEventListener("click",function(I){I.target===p&&window.closeCmdk()});var _=document.getElementById("cmdk-esc-btn");_&&_.addEventListener("click",function(){window.closeCmdk()}),u.addEventListener("input",function(I){i(I.target.value)}),u.addEventListener("keydown",function(I){I.key==="ArrowDown"?(I.preventDefault(),s(1)):I.key==="ArrowUp"?(I.preventDefault(),s(-1)):I.key==="Enter"?(I.preventDefault(),r(p.querySelector(".cmdk-item.focus"))):I.key==="Escape"&&(I.preventDefault(),window.closeCmdk())}),v.addEventListener("click",function(I){var x=I.target.closest(".cmdk-item");x&&r(x)}),v.addEventListener("mousemove",function(I){var x=I.target.closest(".cmdk-item");!x||x.style.display==="none"||x.classList.contains("cmdk-item-locked")||(a().forEach(function(b){b.classList.remove("focus")}),x.classList.add("focus"))});var M=document.getElementById("topbar-search");M&&(M.addEventListener("click",function(){window.openCmdk()}),M.addEventListener("keydown",function(I){(I.key==="Enter"||I.key===" ")&&(I.preventDefault(),window.openCmdk())}))}}document.addEventListener("keydown",function(p){if((p.metaKey||p.ctrlKey)&&(p.key==="k"||p.key==="K")){p.preventDefault(),window.openCmdk();return}if(p.key==="Escape"){var u=document.getElementById("cmdk-mask");if(u&&u.classList.contains("show")){window.closeCmdk();return}var v=document.getElementById("avatar-popup");v&&v.classList.contains("show")&&typeof window._closeAvatarPopup=="function"&&window._closeAvatarPopup()}});try{var l=(navigator.userAgent||"").toLowerCase(),d=l.indexOf("mac")>=0||l.indexOf("iphone")>=0||l.indexOf("ipad")>=0;d||document.body.classList.add("is-windows")}catch{}function c(){n(),f(),typeof window.subscribeI18n=="function"&&window.subscribeI18n("nav-ia-phase1-role",function(){try{typeof window.applyRoleVisibility=="function"&&window.applyRoleVisibility()}catch{}})}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",c):c()})();(function(){function n(_){return String(_??"").replace(/[&<>"']/g,function(M){return{"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"}[M]})}function a(_){if(!_||isNaN(_))return"";var M=Number(_);return M<1024?M+" B":M<1024*1024?(M/1024).toFixed(1)+" KB":(M/1024/1024).toFixed(1)+" MB"}document.addEventListener("click",function(_){var M=_.target.closest&&_.target.closest(".recon-collapse-head");if(M&&!(_.target.closest("button")||_.target.closest("a"))){var I=M.closest(".recon-collapse");if(I){var x=I.getAttribute("data-collapsed")==="true";I.setAttribute("data-collapsed",x?"false":"true"),x&&(I.id==="vex-summary-collapse"&&c(),I.id==="vex-detail-collapse"&&p())}}}),document.addEventListener("keydown",function(_){if(!(_.key!=="Enter"&&_.key!==" ")){var M=_.target.closest&&_.target.closest(".recon-collapse-head");M&&(_.preventDefault(),M.click())}});var o={vat:"",gl:""};window._glvClearPreviewSearch=function(){o.vat="",o.gl=""};var s='<svg class="vex-pp-fi-icon" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#111111" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/></svg>',i='<svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg>';function r(){l("vat"),l("gl")}function f(_){try{if(typeof window._glvPreviewFiles=="function")return window._glvPreviewFiles(_)||[]}catch{}var M=document.getElementById(_==="vat"?"glv-vat-input":"glv-gl-input");return M&&M.files?Array.from(M.files):[]}function l(_){var M=document.getElementById(_==="vat"?"glv-pp-vat-col":"glv-pp-gl-col");if(M){var I=f(_),x=_==="vat"?"glv-up-vat-title":"glv-up-gl-title",b=_==="vat"?"① 销项税报告":"② 总账 GL",$=window.t&&window.t(x)||b,S=n(window.t&&window.t("vex-preview-search")||"搜索文件名..."),F=n(window.t&&window.t("vex-preview-clear-all")||"全清"),j=o[_]||"",w=I.length;M.innerHTML='<div class="vex-pp-col-title"><span class="vex-pp-col-name">'+n($)+' <span class="vex-pp-col-count">'+w+'</span></span></div><div class="vex-pp-search-row"><input class="vex-pp-search" id="glv-pp-search-'+_+'" type="text" placeholder="'+S+'" value="'+n(j)+'" autocomplete="off"><button class="vex-pp-clear-btn" id="glv-pp-clearall-'+_+'" type="button">'+F+'</button></div><div class="vex-pp-file-list" id="glv-pp-'+_+'-list"></div><div class="vex-pp-pagination" id="glv-pp-'+_+'-pg"></div>';var h=document.getElementById("glv-pp-search-"+_);h&&h.addEventListener("input",function(L){o[_]=L.target.value,d(_)});var y=document.getElementById("glv-pp-clearall-"+_);y&&y.addEventListener("click",function(){window._glvRemoveFile&&window._glvRemoveFile(_)}),d(_)}}function d(_){var M=document.getElementById("glv-pp-"+_+"-list"),I=document.getElementById("glv-pp-"+_+"-pg");if(M){var x=f(_),b=(o[_]||"").toLowerCase(),$=x.map(function(j,w){return{f:j,i:w}}),S=b?$.filter(function(j){return j.f.name.toLowerCase().indexOf(b)>=0}):$;if(M.innerHTML=S.map(function(j){var w=j.f;return'<div class="vex-pp-file-row">'+s+'<span class="vex-pp-fi-name" title="'+n(w.name)+'">'+n(w.name)+'</span><span class="vex-pp-fi-size">'+a(w.size)+'</span><button class="vex-pp-fi-del" type="button" data-kind="'+_+'" data-idx="'+j.i+'" aria-label="remove">'+i+"</button></div>"}).join(""),M.querySelectorAll(".vex-pp-fi-del").forEach(function(j){j.addEventListener("click",function(){var w=j.dataset.kind,h=parseInt(j.dataset.idx,10);window._glvRemoveFile&&window._glvRemoveFile(w,isNaN(h)?null:h)})}),I){var F=window.t&&window.t("vex-preview-count")||"显示前 {n} / 共 {m}";I.textContent=F.replace("{n}",S.length).replace("{m}",S.length)}}}function c(){var _=function(I,x){var b=document.getElementById(I);b&&(b.textContent=x==null?"—":String(x))},M=window._vexLastTask||{};_("vex-sum-total",M.total),_("vex-sum-matched",M.matched),_("vex-sum-diff",M.diff),_("vex-sum-incomplete",M.incomplete),_("vex-sum-cash",M.cash),document.getElementById("vex-summary-sub")}function p(){var _=window._vexLastTask&&window._vexLastTask.diff_rows||[],M=document.getElementById("vex-detail-tbody"),I=document.getElementById("vex-detail-table"),x=document.getElementById("vex-detail-empty");if(!(!M||!I||!x)){if(_.length===0){I.style.display="none",x.style.display="";return}x.style.display="none",I.style.display="";var b=_.map(function(S){return'<tr><td class="recon-detail-cell-mono">'+n(S.invoice_no||"")+"</td><td>"+n(S.field||"")+"</td><td>"+n(S.report_value||"")+"</td><td>"+n(S.invoice_value||"")+"</td><td>"+n(S.kind||"")+"</td></tr>"}).join("");M.innerHTML=b;var $=document.getElementById("vex-detail-sub");$&&($.textContent=String(_.length))}}function u(){var _=document.getElementById("glv-toggle-preview");_&&!_._reconBound&&(_._reconBound=!0,_.addEventListener("click",function(){var M=document.getElementById("glv-preview-panel"),I=document.getElementById("glv-toggle-preview-label"),x=M&&M.style.display!=="none";M&&(M.style.display=x?"none":""),_.classList.toggle("open",!x),I&&(I.textContent=x?window.t&&window.t("vex-toggle-preview-open")||"查看清单":window.t&&window.t("vex-toggle-preview-close")||"收起清单"),x||r()})),["glv-vat-input","glv-gl-input"].forEach(function(M){var I=document.getElementById(M);!I||I._reconWatched||(I._reconWatched=!0,I.addEventListener("change",function(){var x=document.getElementById("glv-preview-panel");x&&x.style.display!=="none"&&r()}))})}function v(){var _=document.getElementById("vex-summary-collapse"),M=document.getElementById("vex-detail-collapse");_&&(_.style.display=""),M&&(M.style.display=""),c(),p()}window._fillVexSummary=c,window._fillVexDetail=p,window._onVexResultShown=v,document.addEventListener("DOMContentLoaded",function(){u()}),setTimeout(u,1500),typeof window.subscribeI18n=="function"&&window.subscribeI18n("recon-collapse",function(){var _=document.getElementById("glv-preview-panel");_&&_.style.display!=="none"&&r();var M=document.getElementById("glv-toggle-preview-label"),I=document.getElementById("glv-toggle-preview");M&&I&&(M.textContent=I.classList.contains("open")?window.t&&window.t("vex-toggle-preview-close")||"收起清单":window.t&&window.t("vex-toggle-preview-open")||"查看清单")}),window._reconCollapse={renderGlvPreview:r,fillVexSummary:c,fillVexDetail:p}})();(function(){function e(i){}function n(){const i=document.querySelectorAll("[data-recon-tab]");i.forEach(f=>{f.addEventListener("click",()=>{i.forEach(u=>u.classList.remove("active")),f.classList.add("active");const l=f.dataset.reconTab,d=document.getElementById("recon-pane-bank"),c=document.getElementById("recon-pane-sale-vat"),p=document.getElementById("recon-pane-gl-vat");d&&(d.style.display=l==="bank"?"":"none"),c&&(c.style.display=l==="sale-vat"?"":"none"),p&&(p.style.display=l==="gl-vat"?"":"none"),l==="gl-vat"&&window.GlVatRecon&&window.GlVatRecon.ensureInit(),l==="bank"&&typeof window._bankReconV2Init=="function"&&window._bankReconV2Init()})});const r=document.querySelector("[data-recon-tab].active");r&&(r.dataset.reconTab,void 0)}function a(){const i=document.getElementById("page-settings");if(!i)return null;let r=document.getElementById("settings-modal-overlay");if(r)return r;r=document.createElement("div"),r.id="settings-modal-overlay",r.className="settings-modal-overlay",r.style.display="none",i.parentElement.insertBefore(r,i),r.appendChild(i);const f=document.createElement("button");return f.id="settings-modal-close",f.className="settings-modal-close",f.setAttribute("aria-label","close"),f.innerHTML='<svg viewBox="0 0 20 20" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M5 5l10 10M15 5L5 15"/></svg>',i.insertBefore(f,i.firstChild),f.addEventListener("click",s),r.addEventListener("click",l=>{l.target===r&&s()}),r}function o(){const i=a();if(!i)return;i.style.display="flex",document.body.classList.add("settings-modal-open");const r=document.getElementById("page-settings");r&&(r.style.display="block"),setTimeout(()=>{try{typeof renderSettings=="function"&&renderSettings()}catch(l){console.warn("renderSettings:",l)}let f=document.querySelector(".settings-tab.active")||document.querySelector('.settings-tab[data-tab="profile"]');f&&f.click()},50)}function s(){const i=document.getElementById("settings-modal-overlay");i&&(i.style.display="none"),document.body.classList.remove("settings-modal-open")}window.openSettingsModal=o,window.closeSettingsModal=s,document.addEventListener("keydown",i=>{if(i.key==="Escape"){const r=document.getElementById("settings-modal-overlay");r&&r.style.display==="flex"&&s()}}),window.addEventListener("hashchange",()=>{location.hash==="#/settings"&&o()}),window.addEventListener("DOMContentLoaded",()=>{location.hash==="#/settings"&&o()}),document.readyState==="loading"?document.addEventListener("DOMContentLoaded",n):n()})();(function(){const a=/\.(pdf|jpe?g|png|webp|tiff?|xlsx?|xlsm|csv|tsv|docx?)$/i,o=V=>document.getElementById(V);function s(){return{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||"")}}function i(V){return String(V??"").replace(/[&<>"']/g,Q=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[Q])}function r(V){return V<1024?V+" B":V<1024*1024?(V/1024).toFixed(1)+" KB":(V/1024/1024).toFixed(1)+" MB"}let f=[],l=[],d=!1,c=[],p=50,u=50,v="",_="";async function M(){try{const V=await fetch("/api/vat_excel/tasks?page=1&page_size=1",{headers:s()});if(!V.ok)return;const ee=(await V.json()).kpi||{};[["vex-kpi-month-val",ee.this_month],["vex-kpi-running-val",ee.running],["vex-kpi-done-val",ee.done],["vex-kpi-failed-val",ee.failed]].forEach(([ne,oe])=>{const ue=document.getElementById(ne);ue&&(ue.textContent=oe??0)})}catch{}}async function I(){try{const V=await fetch("/api/vat_excel/tasks?page=1&page_size=100",{headers:s()});if(!V.ok)return;const Q=await V.json();S(Q.rows||[])}catch{}}const x=10;var b=1;function $(){var V=((document.getElementById("vex-task-search")||{}).value||"").trim().toLowerCase();if(b=1,S(c),!!V){var Q=document.getElementById("vex-task-tbody");Q&&Q.querySelectorAll("tr").forEach(function(ee){ee.dataset.taskId&&(ee.style.display=ee.textContent.toLowerCase().indexOf(V)>=0?"":"none")})}}function S(V){c=V||c;const Q=document.getElementById("vex-task-tbody");if(!Q)return;if(!c.length){Q.innerHTML='<tr><td colspan="9" class="vex-task-empty">'+(t("sv-empty-title")||"还没有对账任务")+"</td></tr>",F(0);return}const ee=Math.ceil(c.length/x);b>ee&&(b=ee);const ne=(b-1)*x;j(c.slice(ne,ne+x)),F(c.length)}function F(V){const Q=document.getElementById("vex-task-pager"),ee=document.getElementById("vex-task-pager-info"),ne=document.getElementById("vex-task-prev"),oe=document.getElementById("vex-task-next");if(!Q)return;if(V<=x){Q.style.display="none";return}Q.style.display="";const ue=Math.ceil(V/x);ee&&(ee.textContent=b+" / "+ue),ne&&(ne.disabled=b<=1),oe&&(oe.disabled=b>=ue)}function j(V){const Q=document.getElementById("vex-task-tbody");if(!Q)return;const ee={pending:t("vex-status-pending")||"待处理",running:t("vex-status-running")||"处理中",done:t("vex-status-done")||"已完成",failed:t("vex-status-failed")||"失败"},ne={pending:"badge-gray",running:"badge-blue",done:"badge-green",failed:"badge-red"},oe='<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M8 2v9M4 7l4 4 4-4M3 14h10"/></svg>',ue='<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M3 4h10M6 4V3h4v1M5 4v8a1 1 0 001 1h4a1 1 0 001-1V4"/></svg>';Q.innerHTML=V.map(k=>{const T=k.created_at?new Date(k.created_at).toLocaleString([],{year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",minute:"2-digit"}):"—",A=k.period||"—",U=k.matched_count!=null?k.matched_count+" ✓ · "+k.mismatched_count+" ⚠":"—",z=k.mismatch_amount!=null?"฿ "+Number(k.mismatch_amount).toLocaleString():"—",m=k.elapsed_seconds!=null?k.elapsed_seconds.toFixed(1)+" s":"—",R=k.status||"pending",O=k.client_name&&k.client_name!=="client"?k.client_name:t("vex-client-all")||"全部客户";return`<tr class="vex-task-row" data-task-id="${i(k.id)}" style="cursor:pointer">
                <td>${T}</td>
                <td>${i(O)}</td>
                <td>${i(A)}</td>
        ...
        </div>`;V&&(V.innerHTML=f.map((T,A)=>oe(T,A,"inv")).join("")||'<div class="vex-fi-empty" data-i18n="vex-no-files">还没文件</div>'),Q&&(Q.innerHTML=l.map((T,A)=>oe(T,A,"rep")).join("")||'<div class="vex-fi-empty" data-i18n="vex-no-files">还没文件</div>'),document.querySelectorAll(".vex-fi-x").forEach(T=>{T.addEventListener("click",A=>{const U=T.dataset.vexKind,z=parseInt(T.dataset.vexIdx,10);U==="inv"?D(z):B(z)})});const ue=f.length>0&&l.length>0;o("vex-build").disabled=!ue||d;const k=o("vex-action-info");k&&(!f.length||!l.length?(k.textContent=t("vex-need-both")||"需要至少 1 张发票 + 1 份 VAT 报告",k.className="vex-action-info muted"):(k.textContent=(t("vex-ready")||"已就绪 · {a} 张发票 · {b} 份报告").replace("{a}",f.length).replace("{b}",l.length),k.className="vex-action-info ok")),te()}const J='<svg class="vex-pp-fi-icon" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#6B7280" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path><polyline points="14 2 14 8 20 8"></polyline></svg>',G='<svg class="vex-pp-fi-icon" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#111111" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="4" width="18" height="18" rx="2" ry="2"></rect><line x1="16" y1="2" x2="16" y2="6"></line><line x1="8" y1="2" x2="8" y2="6"></line><line x1="3" y1="10" x2="21" y2="10"></line></svg>',W='<svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg>';function te(){const V=o("vex-preview-panel");if(!V||V.style.display==="none")return;re("inv"),re("rep");const Q=o("vex-pp-guide");Q&&(Q.style.display=f.length>100?"flex":"none")}function re(V){const Q=o(V==="inv"?"vex-pp-invoice-col":"vex-pp-report-col");if(!Q)return;const ee=V==="inv"?f:l,ne=V==="inv"?v:_,oe=t(V==="inv"?"vex-preview-invoice":"vex-preview-report")||(V==="inv"?"销售发票":"VAT 报告"),ue=i(t("vex-preview-search")||"搜索文件名..."),k=i(t("vex-preview-clear-all")||"全清");Q.innerHTML=`
            ...
            <div class="vex-pp-pagination" id="vex-pp-${V}-pg"></div>`;const T=o("vex-pp-search-"+V);T&&T.addEventListener("input",U=>{V==="inv"?(v=U.target.value,p=50):(_=U.target.value,u=50),H(V)});const A=o("vex-pp-clearall-"+V);A&&A.addEventListener("click",()=>{V==="inv"?(f=[],v="",p=50):(l=[],_="",u=50),P()}),H(V)}function H(V){const Q=o("vex-pp-"+V+"-list"),ee=o("vex-pp-"+V+"-pg");if(!Q)return;const ne=V==="inv"?f:l,oe=V==="inv"?v:_,ue=V==="inv"?p:u,k=V==="inv"?J:G,T=ne.map((z,m)=>({f:z,i:m})),A=oe?T.filter(({f:z})=>z.name.toLowerCase().includes(oe.toLowerCase())):T,U=A.slice(0,ue);if(Q.innerHTML=U.map(({f:z,i:m})=>`
            ...
            </div>`).join("")+`<div id="vex-pp-sentinel-${V}" style="height:1px;flex-shrink:0"></div>`,Q.querySelectorAll(".vex-pp-fi-del").forEach(z=>{z.addEventListener("click",()=>{const m=parseInt(z.dataset.ridx,10);z.dataset.kind==="inv"?D(m):B(m)})}),ee){const z=t("vex-preview-count")||"显示前 {n} / 共 {m}";ee.textContent=z.replace("{n}",U.length).replace("{m}",A.length)}E(V,A.length)}function E(V,Q){if((V==="inv"?p:u)>=Q)return;const ne=o("vex-pp-sentinel-"+V),oe=o("vex-pp-"+V+"-list");if(!ne||!oe)return;const ue=new IntersectionObserver(k=>{k[0].isIntersecting&&(ue.disconnect(),V==="inv"?p+=50:u+=50,H(V))},{root:oe,threshold:.8});ue.observe(ne)}function g(V,Q,ee,ne){const oe=o(V),ue=o(Q);!oe||!ue||(oe.addEventListener("click",()=>ue.click()),oe.addEventListener("keydown",k=>{(k.key==="Enter"||k.key===" ")&&(k.preventDefault(),ue.click())}),oe.addEventListener("dragover",k=>{k.preventDefault(),oe.classList.add("drag-over")}),oe.addEventListener("dragleave",()=>oe.classList.remove("drag-over")),oe.addEventListener("drop",k=>{k.preventDefault(),oe.classList.remove("drag-over");const A=Array.from(k.dataTransfer.files).filter(U=>a.test(U.name));if(!A.length){showToast(t("vex-toast-bad-ext"),"error");return}ee(A)}),ue.addEventListener("change",()=>{const k=Array.from(ue.files);ee(k),ue.value=""}))}async function q(){if(d||!f.length||!l.length)return;d=!0,o("vex-build").disabled=!0,o("vex-progress").style.display="flex";var V=document.getElementById("vex-download");V&&(V.style.display="none"),["vex-summary-collapse","vex-detail-collapse"].forEach(function(oe){var ue=document.getElementById(oe);ue&&(ue.style.display="none")});const Q=Date.now();o("vex-progress-title").textContent=t("vex-progress-running")||"AI 抽取中",o("vex-progress-sub").textContent=(t("vex-progress-sub")||"{a} 张发票 + {b} 份报告 · 并行处理").replace("{a}",f.length).replace("{b}",l.length);const ee=setInterval(()=>{const oe=Math.floor((Date.now()-Q)/1e3);o("vex-progress-sub").textContent=(t("vex-progress-elapsed")||"已 {s} 秒 · {a} 张发票 + {b} 份报告").replace("{s}",oe).replace("{a}",f.length).replace("{b}",l.length)},1e3);try{const oe=new FormData;for(const pe of f)oe.append("invoices",pe);for(const pe of l)oe.append("reports",pe);const ue=typeof currentLang=="string"&&currentLang||localStorage.getItem("mrpilot_lang")||"th";oe.append("lang",ue);const k=localStorage.getItem("mrpilot_token")||"",T=await fetch("/api/vat_excel/submit",{method:"POST",headers:s(),body:oe});let A=null;try{A=await T.json()}catch{A=null}if(!T.ok||!A||!A.ok||!A.job_id)throw clearInterval(ee),new Error(A&&A.detail||"HTTP "+T.status);const U=o("vex-progress-sub"),z=await window._reconPollJob(A.job_id,k,{onProgress:pe=>{U&&(U.textContent=window._reconProgressText(pe,ue))}});if(clearInterval(ee),!z||z.status!=="done"||!z.result_id)throw new Error(t("vex-toast-fail")||"生成失败");const m=z.result_id;let R=0;const O=await fetch("/api/vat_excel/tasks/"+encodeURIComponent(m)+"/download",{headers:s()});if(!O.ok)throw new Error("HTTP "+O.status);const X=(O.headers.get("Content-Disposition")||"").match(/filename="([^"]+)"/),de=X&&X[1]||"vat_recon_"+Date.now()+".xlsx",se=await O.blob(),ce=URL.createObjectURL(se),ae=o("vex-download");ae.href=ce,ae.download=de;try{const pe=document.createElement("a");pe.href=ce,pe.download=de,document.body.appendChild(pe),pe.click(),setTimeout(()=>pe.remove(),100)}catch{}o("vex-progress").style.display="none";var ne=document.getElementById("vex-download");ne&&(ne.style.display=""),m&&(R=await Z(m)),window._onVexResultShown&&window._onVexResultShown(),R>0?showToast((t("vex-toast-some-fail")||"有 {n} 张发票 OCR 失败").replace("{n}",R),"warn"):showToast(t("vex-toast-done")||"Excel 已生成","success"),M(),setTimeout(I,800)}catch(oe){clearInterval(ee),o("vex-progress").style.display="none";const ue=(t("vex-toast-fail")||"生成失败")+": "+(oe.message||oe);showToast(ue,"error")}finally{d=!1,o("vex-build").disabled=!1}}function N(){f=[],l=[];var V=document.getElementById("vex-download");V&&(V.style.display="none"),P()}function K(V){if(V==null)return"—";var Q=parseFloat(V);return isNaN(Q)?"—":Q.toLocaleString("th-TH",{minimumFractionDigits:2,maximumFractionDigits:2})}async function Z(V){try{var Q=await fetch("/api/vat_excel/tasks/"+encodeURIComponent(V),{headers:s()});if(!Q.ok)throw new Error(Q.status);var ee=await Q.json(),ne=ee.raw_data_json;if(typeof ne=="string")try{ne=JSON.parse(ne)}catch{ne={}}ne=ne||{};var oe=ne.rows||[],ue=[];oe.forEach(function(A){A.kind==="invoice_orphan"?ue.push({invoice_no:A.invoice_no||"",field:"仅发票有",report_value:"—",invoice_value:K(A.amount_inv),kind:A.kind}):A.kind==="report_orphan"?ue.push({invoice_no:A.invoice_no||"",field:"仅报告有",report_value:K(A.amount_rep),invoice_value:"—",kind:A.kind}):A.dims&&Object.keys(A.dims).length>0&&Object.keys(A.dims).forEach(function(U){var z=String(A.dims[U]||""),m=z.split(" ≠ ");ue.push({invoice_no:A.invoice_no||"",field:U,report_value:m[0]||z,invoice_value:m.length>1?m[1]:"—",kind:"diff"})})});var k=oe.filter(function(A){return A.kind==="matched_cash"}).length,T=Math.max(0,parseInt(ne.invoice_ocr_failed_count||0,10));return window._vexLastTask={total:ne.n_total||0,matched:ne.n_ok||0,diff:ne.n_diff||0,incomplete:T,cash:k,diff_rows:ue,task_id:V},window._fillVexSummary&&window._fillVexSummary(),window._fillVexDetail&&window._fillVexDetail(),T}catch{return 0}}function le(){const V=document.getElementById("vex-pane");V&&V.querySelectorAll("[data-i18n]").forEach(Q=>{const ee=t(Q.dataset.i18n);ee&&(Q.textContent=ee)}),P(),I()}function ie(){g("vex-drop-invoice","vex-input-invoice",L),g("vex-drop-report","vex-input-report",C);const V=o("vex-build"),Q=o("vex-reset");V&&V.addEventListener("click",q),Q&&Q.addEventListener("click",N),document.querySelectorAll('[data-recon-tab="sale-vat"]').forEach(oe=>{oe.addEventListener("click",()=>{M(),I()})}),w();const ee=document.getElementById("vex-task-search");ee&&ee.addEventListener("input",$);const ne=document.getElementById("vex-toggle-preview");ne&&ne.addEventListener("click",()=>{const oe=o("vex-preview-panel"),ue=o("vex-toggle-preview-label"),k=oe&&oe.style.display!=="none";oe&&(oe.style.display=k?"none":""),ne&&ne.classList.toggle("open",!k),ue&&(ue.textContent=k?t("vex-toggle-preview-open")||"查看清单":t("vex-toggle-preview-close")||"收起清单"),k||te()}),P(),M()}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",ie):ie(),typeof window.subscribeI18n=="function"&&(window.subscribeI18n("vex-excel",le),window.subscribeI18n("vex-preview-panel",te))})();(function(){const e=E=>document.getElementById(E),n=()=>localStorage.getItem("mrpilot_token")||"",a=()=>typeof window.currentLang=="string"&&window.currentLang?window.currentLang:localStorage.getItem("mrpilot_lang")||"th",o=()=>({Authorization:"Bearer "+n()}),s={inited:!1,glFile:[],vatFile:[],running:!1,currentTaskId:null,lastDetail:[],lastSummary:null},i={th:{not_found:"ไม่พบข้อมูล",running:"กำลังกระทบยอด…",error:"เกิดข้อผิดพลาด",need_files:"กรุณาเลือกไฟล์ทั้งสอง",done:"เสร็จสิ้น",hint_need_both:"อัปโหลด ① รายงานภาษีขาย + ② GL",hint_need_one_more:"อัปโหลดอีก 1 ไฟล์",hint_ready:"พร้อมแล้ว · กดเริ่มกระทบยอด",hist_load:"โหลด",hist_export:"ส่งออก",hist_delete:"ลบ",confirm_delete:"ยืนยันการลบงานนี้?",s_gl_total:"ยอดรวมตามบัญชีแยกประเภท",s_minus_gl_cr:"หัก : รายการเครดิตที่ไม่มีในรายงานภาษีขาย",s_plus_gl_dr:"บวก : รายการเดบิตที่ไม่มีในรายงานภาษีขาย",s_plus_vat_p:"บวก : รายการยอดขายที่ไม่มีในบัญชีแยกประเภท",s_minus_vat_n:"หัก : รายการลดหนี้ที่ไม่มีในบัญชีแยกประเภท",s_vat_total:"ยอดรวมตามรายงานภาษีขาย"},zh:{not_found:"未找到数据",running:"正在对账中...",error:"出错了",need_files:"请先选择两个文件",done:"完成",hint_need_both:"请上传① 销项税报告 + ② 总账 GL",hint_need_one_more:"还需上传 1 份文件",hint_ready:"已就绪 · 点击开始对账",hist_load:"加载",hist_export:"导出",hist_delete:"删除",confirm_delete:"确认删除此任务？",s_gl_total:"总账金额合计",s_minus_gl_cr:"减：销项税报告中未列的贷方记录",s_plus_gl_dr:"加：销项税报告中未列的借方记录",s_plus_vat_p:"加：总账中未列的销售记录",s_minus_vat_n:"减：总账中未列的贷项凭单(credit note)记录",s_vat_total:"销项税报告金额合计"},en:{not_found:"Not found",running:"Reconciling...",error:"Error",need_files:"Please select both files",done:"Done",hint_need_both:"Upload ① Output VAT report + ② GL file",hint_need_one_more:"1 more file required",hint_ready:"Ready · click Run to start",hist_load:"Load",hist_export:"Export",hist_delete:"Delete",confirm_delete:"Delete this task?",s_gl_total:"Total per General Ledger",s_minus_gl_cr:"Less: GL credits not in VAT Report",s_plus_gl_dr:"Add: GL debits not in VAT Report",s_plus_vat_p:"Add: Sales in VAT Report not in GL",s_minus_vat_n:"Less: Credit notes in VAT Report not in GL",s_vat_total:"Total per VAT Sales Report"},ja:{not_found:"データなし",running:"照合中…",error:"エラー",need_files:"両方のファイルを選択してください",done:"完了",hint_need_both:"① 売上税報告 + ② GL をアップロード",hint_need_one_more:"あと 1 ファイル必要",hint_ready:"準備完了 · 「開始」をクリック",hist_load:"読込",hist_export:"出力",hist_delete:"削除",confirm_delete:"このタスクを削除しますか?",s_gl_total:"総勘定元帳合計",s_minus_gl_cr:"減：売上税報告にないGL貸方記録",s_plus_gl_dr:"加：売上税報告にないGL借方記録",s_plus_vat_p:"加：GLにない売上記録",s_minus_vat_n:"減：GLにない赤伝記録",s_vat_total:"売上税報告合計"}},r=E=>(i[a()]||i.th)[E]||E;function f(E){const g=a(),N={gl_no_revenue_rows:{zh:"GL 中未找到收入科目行。请确认「收入科目前缀」是否正确(收入科目通常以 4 开头),改对后重试。",th:"ไม่พบรายการบัญชีรายได้ใน GL · ตรวจสอบ «คำนำหน้าบัญชีรายได้» (รายได้มักขึ้นต้นด้วย 4) แล้วลองใหม่",en:"No revenue-account rows found in the GL. Check the “revenue account prefix” (revenue usually starts with 4) and retry.",ja:"GL に収益科目の行が見つかりません。「収益科目プレフィックス」(通常 4 で始まる)を確認して再試行してください。"},gl_parse_failed:{zh:"GL 文件解析失败。请确认文件含日期/科目/借贷列,或换清晰的 Excel/CSV 重传。",th:"อ่านไฟล์ GL ไม่สำเร็จ · ตรวจสอบว่ามีคอลัมน์ วันที่/บัญชี/เดบิต-เครดิต หรืออัปโหลด Excel/CSV ที่ชัดเจน",en:"Failed to parse the GL file. Ensure it has date/account/debit-credit columns, or re-upload a clean Excel/CSV.",ja:"GL ファイルの解析に失敗しました。日付/科目/借方貸方列を確認するか、Excel/CSV を再アップロードしてください。"},vat_no_rows:{zh:"销项税报告里没有可对账的数据行。请确认上传了正确的销项税报告。",th:"ไม่พบแถวข้อมูลในรายงานภาษีขาย · ตรวจสอบว่าอัปโหลดรายงานที่ถูกต้อง",en:"No rows found in the sales-VAT report. Please check you uploaded the correct report.",ja:"売上VATレポートに行が見つかりません。正しいレポートをアップロードしたか確認してください。"},vat_parse_failed:{zh:"销项税报告解析失败。请换更清晰的版本,或转成 Excel/PDF 重传。",th:"อ่านรายงานภาษีขายไม่สำเร็จ · ลองเวอร์ชันที่ชัดเจนกว่า หรือแปลงเป็น Excel/PDF",en:"Failed to parse the sales-VAT report. Try a clearer version, or convert to Excel/PDF.",ja:"売上VATレポートの解析に失敗しました。より鮮明な版か、Excel/PDF に変換してください。"}}[E];return N?N[g]||N.th||N.en:r("error")||"Error"}const l=E=>E==null||isNaN(E)?"":Number(E).toLocaleString("en-US",{minimumFractionDigits:2,maximumFractionDigits:2});function d(E,g,q,N){const K=e(E),Z=e(g),le=e(q);if(!K||!Z||!le)return;const ie=V=>{if(!V||!V.length)return;const Q=Array.isArray(s[N])?s[N].slice():[],ee=new Set(Q.map(ne=>ne.name+"|"+ne.size));for(const ne of V){if(!ne)continue;const oe=ne.name+"|"+ne.size;ee.has(oe)||(Q.push(ne),ee.add(oe))}s[N]=Q,c(le,Q),u(),v(),window._reconCollapse&&window._reconCollapse.renderGlvPreview&&window._reconCollapse.renderGlvPreview()};K.addEventListener("click",()=>Z.click()),K.addEventListener("keydown",V=>{(V.key==="Enter"||V.key===" ")&&(V.preventDefault(),Z.click())}),Z.addEventListener("change",()=>{ie(Array.from(Z.files||[])),Z.value=""}),K.addEventListener("dragover",V=>{V.preventDefault(),K.classList.add("drag-over")}),K.addEventListener("dragleave",()=>K.classList.remove("drag-over")),K.addEventListener("drop",V=>{V.preventDefault(),K.classList.remove("drag-over");const Q=V.dataTransfer&&V.dataTransfer.files?Array.from(V.dataTransfer.files):[];ie(Q)})}function c(E,g){if(!E)return;if(!g||g.length===0){E.textContent="";return}const q=g.reduce((N,K)=>N+Math.round(K.size/1024),0);if(g.length===1)E.textContent=g[0].name+"  ("+q+" KB)";else{const N=window.t&&window.t("glv-files-count")||"{n} 个文件";E.textContent=N.replace("{n}",g.length)+"  ("+q+" KB)"}}function p(E){const g=s[E];return Array.isArray(g)?g:g?[g]:[]}function u(){const E=e("btn-glv-run");if(!E)return;const g=p("glFile").length>0&&p("vatFile").length>0;E.disabled=!g||s.running}function v(){const E=e("glv-status");if(!E||s.running)return;const g=p("vatFile").length,q=p("glFile").length;g===0&&q===0?(E.className="vex-action-info muted",E.innerHTML="<span>"+r("hint_need_both")+"</span>"):g>0&&q>0?(E.className="vex-action-info ok",E.innerHTML="<span>"+r("hint_ready")+"</span>"):(E.className="vex-action-info muted",E.innerHTML="<span>"+r("hint_need_one_more")+"</span>")}function _(E,g){const q=E==="vat"?"vatFile":"glFile",N=E==="vat"?"glv-vat-input":"glv-gl-input",K=E==="vat"?"glv-vat-name":"glv-gl-name",Z=p(q);g==null?s[q]=[]:s[q]=Z.filter((ie,V)=>V!==g);const le=e(N);le&&(le.value=""),c(e(K),p(q)),u(),v(),window._reconCollapse&&window._reconCollapse.renderGlvPreview&&window._reconCollapse.renderGlvPreview()}window._glvRemoveFile=_;function M(){s.glFile=[],s.vatFile=[],s.currentTaskId=null,s.lastDetail=[],s.lastSummary=null;const E=e("glv-vat-input");E&&(E.value="");const g=e("glv-gl-input");g&&(g.value="");const q=e("glv-vat-name");q&&(q.textContent="");const N=e("glv-gl-name");N&&(N.textContent="");const K=e("glv-result");K&&(K.style.display="none");const Z=e("glv-kpi-strip");Z&&(Z.style.display="none"),u(),v(),window._glvClearPreviewSearch&&window._glvClearPreviewSearch(),window._reconCollapse&&window._reconCollapse.renderGlvPreview&&window._reconCollapse.renderGlvPreview()}function I(E){const g=e("glv-tbody");if(!g)return;re(E.length),g.innerHTML="";const q=r("not_found"),N=document.createDocumentFragment();E.forEach(K=>{const Z=document.createElement("tr"),le=(ne,oe)=>{const ue=document.createElement("td");return oe&&(ue.className=oe),ue.textContent=ne,ue},ie=K.gl_amount===null||K.gl_amount===void 0,V=K.diff;let Q="glv-num",ee="glv-num";ie?(ee+=" glv-cell-missing",Q+=" glv-cell-missing"):Math.abs(V||0)<.005?Q+=" glv-cell-ok":Q+=" glv-cell-diff",Z.appendChild(le(K.doc_no||"","glv-doc")),Z.appendChild(le(K.date||"","")),Z.appendChild(le(K.customer_name||"","")),Z.appendChild(le(l(K.vat_amount),"glv-num")),Z.appendChild(le(ie?q:l(K.gl_amount),ee)),Z.appendChild(le(ie?q:l(K.diff),Q)),Z.appendChild(le(K.account_codes||"","glv-doc")),N.appendChild(Z)}),g.appendChild(N)}function x(E){const g=e("glv-summary-table")&&e("glv-summary-table").querySelector("tbody");if(!g)return;g.innerHTML="",[{label:r("s_gl_total"),amount:E.gl_total,emph:!0,items:[],negate:!1},{label:r("s_minus_gl_cr"),amount:-(E.gl_only_credit||0),emph:!1,items:E.gl_only_credit_items||[],negate:!0},{label:r("s_plus_gl_dr"),amount:E.gl_only_debit||0,emph:!1,items:E.gl_only_debit_items||[],negate:!1},{label:r("s_plus_vat_p"),amount:E.vat_only_positive||0,emph:!1,items:E.vat_only_positive_items||[],negate:!1},{label:r("s_minus_vat_n"),amount:E.vat_only_negative||0,emph:!1,items:E.vat_only_negative_items||[],negate:!1},{label:r("s_vat_total"),amount:E.vat_total,emph:!0,items:[],negate:!1}].forEach(({label:N,amount:K,emph:Z,items:le,negate:ie})=>{const V=document.createElement("tr");V.className=Z?"glv-summary-total":"glv-summary-sect";const Q=document.createElement("td"),ee=document.createElement("td");Q.textContent=N,ee.textContent=Z?l(K):"",V.appendChild(Q),V.appendChild(ee),g.appendChild(V),(le||[]).forEach(ne=>{const oe=document.createElement("tr");oe.className="glv-summary-item";const ue=document.createElement("td"),k=document.createElement("td"),T=[ne.doc_no,ne.date,ne.name].filter(Boolean);ue.textContent="· "+T.join("  ·  ");const A=ie?-(ne.amount||0):ne.amount||0;k.textContent=l(A),oe.appendChild(ue),oe.appendChild(k),g.appendChild(oe)})})}function b(E){e("glv-kpi-matched")&&(e("glv-kpi-matched").textContent=E&&E.matched!=null?E.matched:"—"),e("glv-kpi-diff")&&(e("glv-kpi-diff").textContent=E&&E.diff!=null?E.diff:"—"),e("glv-kpi-unmatched")&&(e("glv-kpi-unmatched").textContent=E&&E.unmatched!=null?E.unmatched:"—")}function $(E){if(!E)return"";try{const g=new Date(E);if(isNaN(g.getTime()))return E;const q=N=>String(N).padStart(2,"0");return g.getFullYear()+"-"+q(g.getMonth()+1)+"-"+q(g.getDate())+" "+q(g.getHours())+":"+q(g.getMinutes())}catch{return E}}const S=10;var F=[],j=1;function w(){j=1,h();var E=((e("glv-hist-search")||{}).value||"").trim().toLowerCase();if(E){var g=e("glv-history-tbody");g&&g.querySelectorAll("tr").forEach(function(q){q.dataset.taskId&&(q.style.display=q.textContent.toLowerCase().indexOf(E)>=0?"":"none")})}}function h(){const E=e("glv-history-table-wrap"),g=e("glv-history-empty"),q=e("glv-history-tbody"),N=e("glv-history-pager"),K=e("glv-history-pager-info"),Z=e("glv-history-prev"),le=e("glv-history-next");if(!q)return;if(q.innerHTML="",!F.length){E&&(E.style.display="none"),g&&(g.style.display=""),N&&(N.style.display="none");return}E&&(E.style.display=""),g&&(g.style.display="none");const ie=Math.ceil(F.length/S);j>ie&&(j=ie);const V=(j-1)*S,Q=F.slice(V,V+S);N&&(N.style.display=F.length>S?"":"none",K&&(K.textContent=j+" / "+ie),Z&&(Z.disabled=j<=1),le&&(le.disabled=j>=ie)),Q.forEach(ne=>{const oe=document.createElement("tr");oe.dataset.taskId=ne.id;const ue=document.createElement("td");ue.textContent=$(ne.created_at);const k=document.createElement("td");k.className="glv-history-file",k.title=(ne.vat_filename||"")+" + "+(ne.gl_filename||""),k.textContent=(ne.vat_filename||"?")+" + "+(ne.gl_filename||"?");const T=document.createElement("td");T.className="glv-num",T.textContent=(ne.vat_row_count||0)+" / "+(ne.gl_row_count||0);const A=document.createElement("td");A.className="glv-num",A.textContent=ne.matched_count||0;const U=document.createElement("td");U.className="glv-num",U.textContent=ne.diff_count||0;const z=document.createElement("td");z.className="glv-num",z.textContent=ne.unmatched_count||0;const m=document.createElement("td");m.className="glv-history-actions";const R=(de,se,ce,ae)=>{const pe=document.createElement("button");return pe.type="button",ce&&(pe.className=ce),pe.title=se,pe.setAttribute("aria-label",se),pe.innerHTML=de,pe.onclick=ae,pe},O='<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" width="14" height="14"><path d="M2 8a6 6 0 1 0 12 0A6 6 0 0 0 2 8z"/><polyline points="6 8 8 10 10 8"/><line x1="8" y1="4" x2="8" y2="10"/></svg>',Y='<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" width="14" height="14"><path d="M8 2v9M4 7l4 4 4-4M3 14h10"/></svg>',X='<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" width="14" height="14"><polyline points="3 4 13 4"/><path d="M6 4V2.5a.5.5 0 0 1 .5-.5h3a.5.5 0 0 1 .5.5V4"/><path d="M5 4l1 9a1 1 0 0 0 1 1h2a1 1 0 0 0 1-1l1-9"/></svg>';m.appendChild(R(O,r("hist_load"),"",()=>C(ne.id))),m.appendChild(R(Y,r("hist_export"),"",()=>D(ne.id))),m.appendChild(R(X,r("hist_delete"),"glv-del",()=>B(ne.id))),[ue,k,T,A,U,z,m].forEach(de=>oe.appendChild(de)),q.appendChild(oe)})}function y(){var E=e("glv-history-prev"),g=e("glv-history-next");E&&!E._glvBound&&(E._glvBound=!0,E.addEventListener("click",function(){j>1&&(j--,h())})),g&&!g._glvBound&&(g._glvBound=!0,g.addEventListener("click",function(){var q=Math.ceil(F.length/S);j<q&&(j++,h())}))}async function L(){try{const g=await(await fetch("/api/recon/gl-vat/tasks",{headers:o()})).json();F=g&&g.tasks||[],j=1,h(),y()}catch(E){console.error("[gl-vat] history load failed:",E)}}async function C(E){try{const q=await(await fetch("/api/recon/gl-vat/"+E,{headers:o()})).json();if(!q||!q.ok)throw new Error("load_failed");s.currentTaskId=E,s.lastDetail=q.detail||[],s.lastSummary=q.summary||{},b(q.stats||{}),I(s.lastDetail),x(s.lastSummary);const N=e("glv-result");N&&(N.style.display=""),W(),window.scrollTo({top:N?N.offsetTop-80:0,behavior:"smooth"})}catch(g){console.error("[gl-vat] load task failed:",g),alert(r("error")+": "+(g.message||g))}}async function D(E){try{const g="/api/recon/gl-vat/"+E+"/export?lang="+encodeURIComponent(a()),q=await fetch(g,{headers:o()});if(!q.ok)throw new Error("HTTP "+q.status);const N=await q.blob(),K=document.createElement("a");K.href=URL.createObjectURL(N),K.download="GL_VAT_recon_"+E+".xlsx",document.body.appendChild(K),K.click(),setTimeout(()=>{URL.revokeObjectURL(K.href),K.remove()},200)}catch(g){console.error("[gl-vat] exportTask failed:",g),typeof showToast=="function"&&showToast(r("error")+": "+(g.message||g),"error")}}async function B(E){let g;if(typeof window.showConfirm=="function"?g=await window.showConfirm(r("confirm_delete"),{danger:!0}):g=confirm(r("confirm_delete")),!!g)try{const q=await fetch("/api/recon/gl-vat/"+E,{method:"DELETE",headers:o()});if(!q.ok)throw new Error("HTTP "+q.status);L()}catch(q){console.error("[gl-vat] delete failed:",q),typeof showToast=="function"&&showToast(r("error")+": "+(q.message||q),"error")}}async function P(){if(!s.glFile||!s.vatFile){typeof showToast=="function"&&showToast(r("need_files"),"warn");return}s.running=!0,u();const E=e("glv-status"),g=e("glv-progress"),q=e("glv-progress-sub");E&&(E.className="vex-action-info muted",E.style.color="",E.innerHTML="<span>"+r("running")+"</span>"),g&&(g.style.display=""),q&&(q.textContent=(s.vatFile.name||"VAT")+" + "+(s.glFile.name||"GL"));const N=new FormData,K=p("vatFile"),Z=p("glFile");for(const ie of K)N.append("vat_files",ie,ie.name);for(const ie of Z)N.append("gl_files",ie,ie.name);const le=(e("glv-prefix")&&e("glv-prefix").value||"4").trim()||"4";N.append("revenue_prefix",le),N.append("lang",a());try{const ie=await fetch("/api/recon/gl-vat/submit",{method:"POST",headers:o(),body:N});let V=null;try{V=await ie.json()}catch{V=null}if(!ie.ok||!V||!V.ok||!V.job_id)throw new Error(V&&V.detail||V&&V.error||"HTTP "+ie.status);const Q=e("glv-progress-sub"),ee=await window._reconPollJob(V.job_id,n(),{onProgress:k=>{Q&&(Q.textContent=window._reconProgressText(k,a()))}});if(!ee||ee.status!=="done"||!ee.result_id)throw ee&&ee.status==="failed"&&ee.error_code?new Error(f(ee.error_code)):new Error(r("error")||"Error");const ne=await fetch("/api/recon/gl-vat/"+encodeURIComponent(ee.result_id),{headers:o()});let oe=null;try{oe=await ne.json()}catch{oe=null}if(!ne.ok||!oe||!oe.ok)throw new Error(oe&&oe.detail||oe&&oe.error||"HTTP "+ne.status);s.currentTaskId=oe.task_id,s.lastDetail=oe.detail||[],s.lastSummary=oe.summary||{},b(oe.stats||{}),I(s.lastDetail),x(s.lastSummary);const ue=e("glv-result");ue&&(ue.style.display=""),W(),E&&(E.className="vex-action-info ok",E.style.color="",E.innerHTML="<span>"+r("done")+" · GL "+(oe.gl_row_count||0)+" · VAT "+(oe.vat_row_count||0)+"</span>"),L()}catch(ie){console.error("[gl-vat] run failed:",ie),E&&(E.className="vex-action-info",E.style.color="#ef4444",E.innerHTML="<span>"+r("error")+": "+(ie.message||ie)+"</span>")}finally{s.running=!1,g&&(g.style.display="none"),u()}}async function J(){if(s.currentTaskId)try{const E="/api/recon/gl-vat/"+s.currentTaskId+"/export?lang="+encodeURIComponent(a()),g=await fetch(E,{headers:o()});if(!g.ok)throw new Error("HTTP "+g.status);const q=await g.blob(),N=document.createElement("a");N.href=URL.createObjectURL(q),N.download="GL_VAT_recon_"+s.currentTaskId+".xlsx",document.body.appendChild(N),N.click(),setTimeout(()=>{URL.revokeObjectURL(N.href),N.remove()},200)}catch(E){console.error("[gl-vat] export failed:",E),typeof showToast=="function"&&showToast(r("error")+": "+(E.message||E),"error")}}function G(){s.running||v(),L(),s.lastDetail&&s.lastDetail.length&&I(s.lastDetail),s.lastSummary&&x(s.lastSummary)}function W(){var E=e("glv-kpi-strip");E&&(E.style.display="");var g=e("glv-section-summary");g&&g.setAttribute("data-collapsed","false");var q=e("glv-section-detail");q&&q.setAttribute("data-collapsed","false")}function te(){document.querySelectorAll(".glv-section-head[data-toggle]").forEach(E=>{const g=E.getAttribute("data-toggle"),q=document.getElementById(g);if(!q)return;const N=K=>{if(K.target&&K.target.closest("button")!==null&&!K.target.classList.contains("glv-section-head"))return;const Z=q.getAttribute("data-collapsed")==="true";q.setAttribute("data-collapsed",Z?"false":"true")};E.addEventListener("click",N),E.addEventListener("keydown",K=>{(K.key==="Enter"||K.key===" ")&&(K.preventDefault(),N(K))})})}function re(E){const g=e("glv-detail-count");g&&(g.textContent=E!=null?String(E):"")}function H(){if(s.inited){L();return}s.inited=!0,d("glv-drop-gl","glv-gl-input","glv-gl-name","glFile"),d("glv-drop-vat","glv-vat-input","glv-vat-name","vatFile");const E=e("btn-glv-run");E&&E.addEventListener("click",P);const g=e("btn-glv-export");g&&g.addEventListener("click",J);const q=e("btn-glv-reset");q&&q.addEventListener("click",M);const N=e("glv-hist-search");N&&N.addEventListener("input",w),te(),b(null),v(),window._loadGlvHistory=L,L(),typeof window.subscribeI18n=="function"&&window.subscribeI18n("gl-vat-recon",G)}window.GlVatRecon={ensureInit:H},window._glvPreviewFiles=function(E){return p(E==="vat"?"vatFile":"glFile")}})();(function(){const e=["flowaccount","peak","xero","quickbooks","express"],n={flowaccount:"FlowAccount",peak:"PEAK",xero:"Xero",quickbooks:"QuickBooks",express:"Express"},a=["expense_office","expense_travel","expense_utility","asset_inventory","asset_fixed","liability_ap","revenue_sales","revenue_service","other"],o=["vat_7","vat_0","vat_exempt","wht_1","wht_3","wht_5","non_vat"],s="468b50c1-5593-4fd6-990d-515ce8085563";let i={sub:"clients",loaded:{clients:!1,accounts:!1,taxes:!1,products:!1},items:{clients:[],accounts:[],taxes:[],products:[]},clientList:[],clientLoaded:!1,addingNew:{clients:!1,accounts:!1,taxes:!1,products:!1},bound:!1};function r(){const C=typeof _userInfo<"u"?_userInfo:null;return!!(C&&(C.role==="owner"||C.is_super_admin))}function f(){const C=typeof _userInfo<"u"?_userInfo:null;return!!(C&&C.id===s)}function l(C){return typeof escapeHtml=="function"?escapeHtml(C==null?"":String(C)):String(C??"")}function d(C,D){try{typeof showToast=="function"&&showToast(C,D||"info")}catch{}}async function c(C,D){const B=localStorage.getItem("mrpilot_token");if(B&&!(i.loaded[C]&&!D))try{const P=await fetch("/api/erp/mappings/"+C,{headers:{Authorization:"Bearer "+B}});if(!P.ok)throw new Error("http_"+P.status);const J=await P.json();i.items[C]=J.items||[],i.loaded[C]=!0}catch{i.items[C]=[],i.loaded[C]=!1}}async function p(C){if(i.clientLoaded)return;const D=localStorage.getItem("mrpilot_token");if(D)try{const B=await fetch("/api/clients?include_inactive=false",{headers:{Authorization:"Bearer "+D}});if(!B.ok)throw new Error("http_"+B.status);const P=await B.json();i.clientList=(P.clients||P.items||[]).filter(J=>J.is_active!==!1),i.clientLoaded=!0}catch{i.clientList=[]}}function u(){const C=document.getElementById("erp-map-pane-wrap");if(!C)return;const D=!r();let B="";D&&(B+='<div class="erp-map-readonly-banner"><svg width="16" height="16" viewBox="0 0 20 20" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"><circle cx="10" cy="10" r="8"/><path d="M10 6v4M10 13v0.01"/></svg>'+l(t("erp-map-readonly-tip"))+"</div>"),B+='<div class="erp-map-toolbar">',!D&&i.sub!=="products"&&(B+='<button class="btn btn-primary" type="button" id="erp-map-add-btn" data-i18n="erp-map-add-row">'+l(t("erp-map-add-row"))+"</button>"),B+="</div>",B+='<div class="erp-map-table" id="erp-map-table-host"></div>',C.innerHTML=B,v();const P=document.getElementById("erp-map-dev-bar");P&&(P.style.display=r()&&f()?"":"none")}function v(){const C=document.getElementById("erp-map-table-host");if(!C)return;const D=i.sub,B=i.items[D]||[],P=i.addingNew[D],J=!r();if(!B.length&&!P){C.innerHTML='<div class="erp-map-empty"><strong>'+l(t("erp-map-empty-"+D))+"</strong>"+l(t("erp-map-empty-"+D+"-sub"))+"</div>";return}let G="";G+=_(D),P&&!J&&(G+=$(D)),B.forEach(function(W){G+=S(D,W,J)}),C.innerHTML=G}function _(C){return C==="clients"?'<div class="erp-map-row erp-map-head row-clients"><div>'+l(t("erp-map-col-client"))+"</div><div>"+l(t("erp-map-col-erp"))+"</div><div>"+l(t("erp-map-col-erp-code"))+"</div><div>"+l(t("erp-map-col-notes"))+"</div><div>"+l(t("erp-map-col-actions"))+"</div></div>":C==="accounts"?'<div class="erp-map-row erp-map-head row-accounts"><div>'+l(t("erp-map-col-erp"))+"</div><div>"+l(t("erp-map-col-category"))+"</div><div>"+l(t("erp-map-col-erp-code"))+"</div><div>"+l(t("erp-map-col-erp-name"))+"</div><div>"+l(t("erp-map-col-notes"))+"</div><div>"+l(t("erp-map-col-actions"))+"</div></div>":C==="products"?'<div class="erp-map-row erp-map-head row-products"><div>'+l(t("erp-map-col-item-name"))+"</div><div>"+l(t("erp-map-col-erp-product-code"))+"</div><div>"+l(t("erp-map-col-erp-name"))+"</div><div>"+l(t("erp-map-col-notes"))+"</div><div>"+l(t("erp-map-col-actions"))+"</div></div>":'<div class="erp-map-row erp-map-head row-taxes"><div>'+l(t("erp-map-col-erp"))+"</div><div>"+l(t("erp-map-col-tax"))+"</div><div>"+l(t("erp-map-col-erp-tax-code"))+"</div><div>"+l(t("erp-map-col-notes"))+"</div><div>"+l(t("erp-map-col-actions"))+"</div></div>"}function M(C,D){let B='<select class="form-input" data-erp-field="'+D+'">';return B+='<option value="">'+l(t("erp-map-pick-erp"))+"</option>",e.forEach(function(P){const J=P===C?" selected":"";B+='<option value="'+P+'"'+J+">"+l(n[P])+"</option>"}),B+="</select>",B}function I(C){let D='<select class="form-input" data-erp-field="client_id">';return D+='<option value="">'+l(t("erp-map-pick-client"))+"</option>",(i.clientList||[]).forEach(function(B){const P=String(B.id)===String(C)?" selected":"";D+='<option value="'+B.id+'"'+P+">"+l(B.name||"#"+B.id)+"</option>"}),D+="</select>",D}function x(C){let D='<select class="form-input" data-erp-field="pearnly_category">';return D+='<option value="">'+l(t("erp-map-pick-cat"))+"</option>",a.forEach(function(B){const P=B===C?" selected":"";D+='<option value="'+B+'"'+P+">"+l(t("erp-map-cat-"+B))+"</option>"}),D+="</select>",D}function b(C){let D='<select class="form-input" data-erp-field="pearnly_tax_kind">';return D+='<option value="">'+l(t("erp-map-pick-tax"))+"</option>",o.forEach(function(B){const P=B===C?" selected":"";D+='<option value="'+B+'"'+P+">"+l(t("erp-map-tax-"+B))+"</option>"}),D+="</select>",D}function $(C){const D='<button class="btn btn-primary" type="button" data-erp-save="new" style="padding:6px 12px;height:32px;">'+l(t("erp-map-save"))+"</button>";return C==="clients"?'<div class="erp-map-row erp-map-row-add row-clients" data-erp-row="new"><div data-label="'+l(t("erp-map-col-client"))+'">'+I("")+'</div><div data-label="'+l(t("erp-map-col-erp"))+'">'+M("","erp_type")+'</div><div data-label="'+l(t("erp-map-col-erp-code"))+'"><input type="text" class="form-input" data-erp-field="erp_code" placeholder="'+l(t("erp-map-ph-erp-code"))+'"></div><div data-label="'+l(t("erp-map-col-notes"))+'"><input type="text" class="form-input" data-erp-field="notes" placeholder="'+l(t("erp-map-ph-notes"))+'"></div><div>'+D+"</div></div>":C==="accounts"?'<div class="erp-map-row erp-map-row-add row-accounts" data-erp-row="new"><div data-label="'+l(t("erp-map-col-erp"))+'">'+M("","erp_type")+'</div><div data-label="'+l(t("erp-map-col-category"))+'">'+x("")+'</div><div data-label="'+l(t("erp-map-col-erp-code"))+'"><input type="text" class="form-input" data-erp-field="erp_code" placeholder="'+l(t("erp-map-ph-acc-code"))+'"></div><div data-label="'+l(t("erp-map-col-erp-name"))+'"><input type="text" class="form-input" data-erp-field="erp_name" placeholder="'+l(t("erp-map-ph-acc-name"))+'"></div><div data-label="'+l(t("erp-map-col-notes"))+'"><input type="text" class="form-input" data-erp-field="notes" placeholder="'+l(t("erp-map-ph-notes"))+'"></div><div>'+D+"</div></div>":'<div class="erp-map-row erp-map-row-add row-taxes" data-erp-row="new"><div data-label="'+l(t("erp-map-col-erp"))+'">'+M("","erp_type")+'</div><div data-label="'+l(t("erp-map-col-tax"))+'">'+b("")+'</div><div data-label="'+l(t("erp-map-col-erp-tax-code"))+'"><input type="text" class="form-input" data-erp-field="erp_code" placeholder="'+l(t("erp-map-ph-tax-code"))+'"></div><div data-label="'+l(t("erp-map-col-notes"))+'"><input type="text" class="form-input" data-erp-field="notes" placeholder="'+l(t("erp-map-ph-notes"))+'"></div><div>'+D+"</div></div>"}function S(C,D,B){const P=B?"":'<button class="erp-map-del-btn" type="button" data-erp-del="'+l(D.id)+'" title="'+l(t("erp-map-delete"))+'"><svg width="14" height="14" viewBox="0 0 20 20" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"><path d="M4 6h12M8 6V4h4v2M6 6l1 11h6l1-11"/></svg></button>',J='<span class="erp-map-erp-badge">'+l(n[D.erp_type]||D.erp_type)+"</span>";if(C==="clients")return'<div class="erp-map-row row-clients"><div data-label="'+l(t("erp-map-col-client"))+'" class="erp-map-cell-name">'+l(D.client_name||"#"+D.client_id)+'</div><div data-label="'+l(t("erp-map-col-erp"))+'">'+J+'</div><div data-label="'+l(t("erp-map-col-erp-code"))+'" class="erp-map-code">'+l(D.erp_code||"")+'</div><div data-label="'+l(t("erp-map-col-notes"))+'">'+l(D.notes||"")+"</div><div>"+P+"</div></div>";if(C==="accounts"){const W=t("erp-map-cat-"+(D.pearnly_category||"other"))||D.pearnly_category;return'<div class="erp-map-row row-accounts"><div data-label="'+l(t("erp-map-col-erp"))+'">'+J+'</div><div data-label="'+l(t("erp-map-col-category"))+'" class="erp-map-cell-name">'+l(W)+'</div><div data-label="'+l(t("erp-map-col-erp-code"))+'" class="erp-map-code">'+l(D.erp_code||"")+'</div><div data-label="'+l(t("erp-map-col-erp-name"))+'">'+l(D.erp_name||"")+'</div><div data-label="'+l(t("erp-map-col-notes"))+'">'+l(D.notes||"")+"</div><div>"+P+"</div></div>"}if(C==="products")return'<div class="erp-map-row row-products"><div data-label="'+l(t("erp-map-col-item-name"))+'" class="erp-map-cell-name">'+l(D.item_name||"")+'</div><div data-label="'+l(t("erp-map-col-erp-product-code"))+'" class="erp-map-code">'+l(D.erp_code||"")+'</div><div data-label="'+l(t("erp-map-col-erp-name"))+'">'+l(D.erp_name||"")+'</div><div data-label="'+l(t("erp-map-col-notes"))+'">'+l(D.notes||"")+"</div><div>"+P+"</div></div>";const G=t("erp-map-tax-"+(D.pearnly_tax_kind||""))||D.pearnly_tax_kind;return'<div class="erp-map-row row-taxes"><div data-label="'+l(t("erp-map-col-erp"))+'">'+J+'</div><div data-label="'+l(t("erp-map-col-tax"))+'" class="erp-map-cell-name"><span class="erp-map-tax-badge">'+l(G)+'</span></div><div data-label="'+l(t("erp-map-col-erp-tax-code"))+'" class="erp-map-code">'+l(D.erp_code||"")+'</div><div data-label="'+l(t("erp-map-col-notes"))+'">'+l(D.notes||"")+"</div><div>"+P+"</div></div>"}async function F(C){const D=i.sub,B={};C.querySelectorAll("[data-erp-field]").forEach(function(W){B[W.dataset.erpField]=(W.value||"").trim()});const P=localStorage.getItem("mrpilot_token");if(!P)return;let J={},G="/api/erp/mappings/"+D;if(D==="clients"){if(!B.client_id||!B.erp_type||!B.erp_code){d(t("erp-map-save-fail"),"error");return}J={client_id:parseInt(B.client_id,10),erp_type:B.erp_type,erp_code:B.erp_code,notes:B.notes||""}}else if(D==="accounts"){if(!B.erp_type||!B.pearnly_category||!B.erp_code){d(t("erp-map-save-fail"),"error");return}J={erp_type:B.erp_type,pearnly_category:B.pearnly_category,erp_code:B.erp_code,erp_name:B.erp_name||"",notes:B.notes||""}}else{if(!B.erp_type||!B.pearnly_tax_kind||!B.erp_code){d(t("erp-map-save-fail"),"error");return}J={erp_type:B.erp_type,pearnly_tax_kind:B.pearnly_tax_kind,erp_code:B.erp_code,notes:B.notes||""}}try{const W=await fetch(G,{method:"POST",headers:{"Content-Type":"application/json",Authorization:"Bearer "+P},body:JSON.stringify(J)});if(!W.ok)throw new Error("http_"+W.status);i.addingNew[D]=!1,await c(D,!0),v(),d(t("erp-map-saved-toast"),"success")}catch{d(t("erp-map-save-fail"),"error")}}async function j(C){if(!await window.pearnlyConfirm(t("erp-map-confirm-delete")))return;const B=i.sub,P=localStorage.getItem("mrpilot_token");try{const J=await fetch("/api/erp/mappings/"+B+"/"+encodeURIComponent(C),{method:"DELETE",headers:{Authorization:"Bearer "+P}});if(!J.ok)throw new Error("http_"+J.status);await c(B,!0),v(),d(t("erp-map-deleted-toast"),"success")}catch{d(t("erp-map-delete-fail"),"error")}}async function w(){await p(),await c(i.sub,!1),u()}function h(C){C!==i.sub&&(i.sub=C,i.addingNew[C]=!1,["clients","accounts","taxes","products"].forEach(function(D){D!==C&&(i.addingNew[D]=!1)}),document.querySelectorAll(".erp-map-subtab").forEach(function(D){D.classList.toggle("active",D.dataset.erpSubtab===C)}),c(C,!1).then(function(){u()}))}function y(){i.bound||(i.bound=!0,document.addEventListener("click",function(C){const D=C.target.closest(".erp-subtab[data-erp-subtab]");if(D){C.preventDefault();const W=D.dataset.erpSubtab;document.querySelectorAll(".erp-subtab").forEach(function(te){te.classList.toggle("active",te.dataset.erpSubtab===W)}),document.querySelectorAll(".erp-subpanel").forEach(function(te){te.classList.toggle("active",te.dataset.erpSubpanel===W)}),W==="mappings"&&setTimeout(w,50);return}const B=C.target.closest(".erp-map-subtab[data-erp-subtab]");if(B){C.preventDefault(),h(B.dataset.erpSubtab);return}if(C.target.closest("#erp-map-add-btn")){if(C.preventDefault(),!r())return;i.addingNew[i.sub]=!0,v();return}const J=C.target.closest('[data-erp-save="new"]');if(J){C.preventDefault();const W=J.closest('[data-erp-row="new"]');W&&F(W);return}const G=C.target.closest("[data-erp-del]");if(G){C.preventDefault(),j(G.dataset.erpDel);return}}))}function L(){const C=document.getElementById("erp-map-pane-wrap");C&&C.children.length>0&&u(),document.querySelectorAll(".erp-map-subtab").forEach(function(D){const B="erp-map-subtab-"+D.dataset.erpSubtab,P=t(B);P&&P!==B&&(D.textContent=P)})}y(),typeof window.subscribeI18n=="function"&&window.subscribeI18n("erp-mappings",L)})();(function(){let e=null,n=0,a=!1;function o(w){return typeof escapeHtml=="function"?escapeHtml(w==null?"":String(w)):String(w??"")}function s(w,h){try{typeof showToast=="function"&&showToast(w,h||"info")}catch{}}async function i(w){const h=Date.now();if(e&&h-n<3e4)return e;const y=localStorage.getItem("mrpilot_token");if(!y)return[];try{const L=await fetch("/api/erp/connectors/status",{headers:{Authorization:"Bearer "+y}});if(!L.ok)return[];const C=await L.json();return e=C&&C.connectors||[],n=h,e}catch{return[]}}function r(){try{return localStorage.getItem("pn_push_default_connector")||""}catch{return""}}function f(w){try{localStorage.setItem("pn_push_default_connector",w||"")}catch{}}function l(w){if(!w||!w.length)return null;const h=r();if(h){const L=w.find(C=>C.id===h);if(L)return L}const y=w.find(L=>L.is_default);return y||w[0]}function d(w){if(!w)return!1;const h=String(w.status||"").toLowerCase();return h==="exception"||h==="exception_pending"||h==="rejected"}function c(){try{return(typeof _results<"u"?_results:[])[typeof _drawerIdx<"u"?_drawerIdx:-1]||null}catch{return null}}function p(w){const h=w&&(w.type||w.id);return h==="xero"?'<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"><circle cx="8" cy="8" r="6"/><path d="M5.5 8l2 2 3-3.5"/></svg>':h==="webhook"?'<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"><circle cx="5" cy="11.5" r="1.8"/><circle cx="11" cy="4.5" r="1.8"/><path d="M6.4 10l3.2-4M5 9.6V5.5a3 3 0 016 0"/></svg>':'<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"><path d="M2 8h9M8 5l3 3-3 3"/><rect x="11" y="3" width="3" height="10" rx="1"/></svg>'}async function u(w,h){if(!w||!h)return!1;const y=document.getElementById("btn-push-default");y&&(y.disabled=!0,y.classList.add("loading"));const L=localStorage.getItem("mrpilot_token");try{let C,D={method:"POST",headers:{Authorization:"Bearer "+L}};w.type==="xero"?C="/api/erp/xero/push/"+encodeURIComponent(h):(C="/api/erp/push",D.headers["Content-Type"]="application/json",D.body=JSON.stringify({history_id:h,endpoint_id:w.endpoint_id||void 0}));const B=await fetch(C,D);let P={};try{P=await B.json()}catch{}if(!B.ok){let J=P&&P.detail||"unknown";typeof J=="object"&&(J=J.code||JSON.stringify(J));let G=String(J||"unknown");if(w.type==="xero"){const W=G.replace(/^xero\./,"").toLowerCase(),te=t("xero-"+W);te&&te!=="xero-"+W&&(G=te)}return s(t("unified-push-fail").replace("{name}",w.name).replace("{err}",G),"error"),!1}if(P&&P.ok===!1){let J=P.error_msg||P.error_code||"unknown";return J=String(J).slice(0,200),s(t("unified-push-fail").replace("{name}",w.name).replace("{err}",J),"error"),!1}return s(t("unified-push-ok").replace("{name}",w.name),"success"),!0}catch(C){return s(t("unified-push-fail").replace("{name}",w.name).replace("{err}",C.message||"network"),"error"),!1}finally{y&&(y.disabled=!1,y.classList.remove("loading"))}}async function v(w,h){for(const y of w)await u(y,h)}function _(w,h){const y=document.createElement("div");y.className="pn-push-dropdown",y.id="pn-push-dropdown";const L=(w||[]).map(D=>{const B=!!(h&&D.id===h.id),P=D.method==="download"?t("unified-push-tag-download"):B?t("unified-push-tag-default"):"";return'<div class="pn-pd-item" data-cid="'+o(D.id)+'"><span class="pn-pd-icon">'+p(D)+'</span><span class="pn-pd-name">'+o(D.name)+"</span>"+(P?'<span class="pn-pd-tag">'+o(P)+"</span>":"")+(B?'<span class="pn-pd-check">✓</span>':"")+"</div>"}).join(""),C=w&&w.length>1?'<div class="pn-pd-divider"></div><div class="pn-pd-item pn-pd-all" data-cid="__all__"><span class="pn-pd-icon"><svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"><path d="M3 6h10M3 10h10M3 13.5h6"/></svg></span><span class="pn-pd-name">'+o(t("unified-push-all").replace("{n}",w.length))+"</span></div>":"";return y.innerHTML=L+C,y}function M(){const w=document.getElementById("pn-push-dropdown");w&&w.remove()}async function I(){if(document.getElementById("pn-push-dropdown")){M();return}const w=await i()||[],h=l(w),y=_(w,h),L=document.getElementById("pn-push-wrap");L&&L.appendChild(y)}async function x(){const w=await i()||[],h=l(w);if(!h)return;const y=c(),L=y&&(y._historyId||y.history_id);if(L){if(d(y)){s(t("unified-push-disabled-exc"),"warn");return}await u(h,L)}}async function b(w){M();const h=await i()||[],y=c(),L=y&&(y._historyId||y.history_id);if(!L)return;if(d(y)){s(t("unified-push-disabled-exc"),"warn");return}if(w==="__all__"){await v(h,L);return}const C=h.find(D=>D.id===w);C&&(f(w),await u(C,L),S())}async function $(){const w=document.getElementById("drawer-history-save");if(!w||w.querySelector("#pn-push-wrap"))return;const h=document.createElement("div");h.id="pn-push-wrap",h.className="pn-push-wrap",h.dataset.loading="1",w.insertBefore(h,w.firstChild),["btn-push-erp","btn-xero-push"].forEach(P=>{w.querySelectorAll("#"+P).forEach(J=>{J.style.display="none"})});const y=await i()||[],L=l(y),C=y.length>0;if(!C)h.innerHTML='<button type="button" class="btn btn-ghost pn-push-empty" id="btn-push-default" disabled title="'+o(t("unified-push-empty-tip"))+'"><svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"><path d="M2 8h9M8 5l3 3-3 3"/></svg><span style="margin-left:4px;">'+o(t("unified-push-empty"))+"</span></button>";else{const P=y.length>1;h.innerHTML='<div class="pn-push-split"><button type="button" class="pn-push-main" id="btn-push-default" title="'+o(t("unified-push-tip"))+'">'+p(L)+"<span>"+o(t("unified-push-to").replace("{name}",L?L.name:""))+"</span></button>"+(P?'<button type="button" class="pn-push-arrow" id="btn-push-arrow" title="'+o(t("unified-push-other"))+'"><svg viewBox="0 0 12 12" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M3 5l3 3 3-3"/></svg></button>':"")+"</div>"}delete h.dataset.loading;const D=h.querySelector("#btn-push-default");D&&C&&D.addEventListener("click",x);const B=h.querySelector("#btn-push-arrow");B&&B.addEventListener("click",function(P){P.stopPropagation(),I()}),a||(a=!0,document.addEventListener("click",function(P){const J=P.target.closest(".pn-pd-item");if(J){const G=J.getAttribute("data-cid");b(G);return}P.target.closest("#btn-push-arrow")||M()}),typeof window.subscribeI18n=="function"&&window.subscribeI18n("unified-push",S))}function S(){const w=document.getElementById("pn-push-wrap");w&&(w.remove(),e=null,n=0,$())}function F(){const w=document.getElementById("drawer-history-save");if(!w||!w.querySelector("#pn-push-wrap"))return;["btn-push-erp","btn-xero-push"].forEach(y=>{w.querySelectorAll("#"+y).forEach(L=>{L.style.display!=="none"&&(L.style.display="none")})});const h=w.querySelectorAll("#pn-push-wrap");if(h.length>1)for(let y=1;y<h.length;y++)h[y].remove()}function j(){try{const w=function(){return document.getElementById("drawer-body")},h=new MutationObserver(function(){document.getElementById("drawer-history-save")&&!document.getElementById("pn-push-wrap")&&$(),F()}),y=w();if(y)h.observe(y,{childList:!0,subtree:!0});else{const L=new MutationObserver(function(){const C=w();C&&(h.observe(C,{childList:!0,subtree:!0}),L.disconnect())});L.observe(document.body,{childList:!0,subtree:!0})}setTimeout(function(){document.getElementById("drawer-history-save")&&!document.getElementById("pn-push-wrap")&&$(),F()},200)}catch{}}j()})();(function(){function e(){const a=document.getElementById("erp-map-show-advanced-btn");if(!a)return;const o=document.getElementById("erp-map-subtabs");if(!o)return;const s=o.classList.contains("show-advanced"),i=a.querySelector(".erp-map-adv-btn-label");if(i&&typeof t=="function"){const r=s?"erp-map-hide-advanced":"erp-map-show-advanced",f=t(r);f&&f!==r&&(i.textContent=f)}a.setAttribute("aria-pressed",s?"true":"false")}document.addEventListener("click",function(a){if(!a.target.closest("#erp-map-show-advanced-btn"))return;a.preventDefault();const s=document.getElementById("erp-map-subtabs");if(s&&(s.classList.toggle("show-advanced"),e(),!s.classList.contains("show-advanced")&&s.querySelector(".erp-map-subtab.active.erp-map-subtab-advanced"))){const r=s.querySelector('.erp-map-subtab[data-erp-subtab="clients"]');r&&r.click()}});function n(){e()}typeof window.subscribeI18n=="function"&&window.subscribeI18n("erp-map-advanced-toggle",n)})();(function(){const e="pearnly_erp_onboard_shown";let n=!1;function a(){try{return Array.isArray(window._erpEndpoints)&&window._erpEndpoints.length>0}catch{return!1}}function o(){if(document.getElementById("erp-onboard-mask"))return;const i=document.createElement("div");i.id="erp-onboard-mask",i.className="erp-onboard-mask",i.innerHTML='<div class="erp-onboard-modal" role="dialog" aria-modal="true"><div class="erp-onboard-icon"><svg viewBox="0 0 32 32" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><rect x="4" y="6" width="24" height="20" rx="3"/><path d="M9 13h14M9 18h10"/><path d="M22 22l3 3 5-5"/></svg></div><div class="erp-onboard-title" id="erp-onboard-title"></div><div class="erp-onboard-body" id="erp-onboard-body"></div><div class="erp-onboard-btns"><button type="button" class="btn btn-secondary" id="erp-onboard-later"></button><button type="button" class="btn btn-primary" id="erp-onboard-ok"></button></div></div>',document.body.appendChild(i);function r(){const l=document.getElementById("erp-onboard-title"),d=document.getElementById("erp-onboard-body"),c=document.getElementById("erp-onboard-ok"),p=document.getElementById("erp-onboard-later");l&&(l.textContent=t("erp-onboard-title")),d&&(d.textContent=t("erp-onboard-body")),c&&(c.textContent=t("erp-onboard-ok")),p&&(p.textContent=t("erp-onboard-later"))}r();function f(){i.style.display="none"}document.getElementById("erp-onboard-ok").addEventListener("click",function(){try{localStorage.setItem(e,"1")}catch{}f();try{const l=document.querySelector('#btn-add-endpoint, [data-action="erp-add-endpoint"]');l&&l.scrollIntoView({behavior:"smooth",block:"center"})}catch{}}),document.getElementById("erp-onboard-later").addEventListener("click",function(){try{localStorage.setItem(e,"1")}catch{}f()}),i.addEventListener("click",function(l){l.target===i&&f()}),typeof window.subscribeI18n=="function"&&window.subscribeI18n("erp-onboard-modal",function(){i.style.display!=="none"&&r()})}function s(){if(!n){try{if(localStorage.getItem(e)==="1")return}catch{}a()||(n=!0,o(),requestAnimationFrame(function(){requestAnimationFrame(function(){if(a())return;const i=document.getElementById("erp-onboard-mask");i&&(i.style.display="flex")})}))}}document.addEventListener("click",function(i){const r=i.target.closest('.auto-nav-item[data-auto-tab="erp"]'),f=i.target.closest('.erp-subtab[data-erp-subtab="connect"]');(r||f)&&setTimeout(s,700)})})();(function(){const e={parse:{zh:"解析文件中",th:"กำลังอ่านไฟล์",en:"Parsing files",ja:"ファイル解析中"},report:{zh:"读取报告中",th:"กำลังอ่านรายงาน",en:"Reading report",ja:"レポート読込中"},reconcile:{zh:"对账中",th:"กำลังกระทบยอด",en:"Reconciling",ja:"照合中"},build:{zh:"生成中",th:"กำลังสร้างไฟล์",en:"Building",ja:"作成中"},persist:{zh:"保存中",th:"กำลังบันทึก",en:"Saving",ja:"保存中"},done:{zh:"完成",th:"เสร็จสิ้น",en:"Done",ja:"完了"}};window._reconProgressText=function(n,a){n=n||{},a=window._currentLang||a||localStorage.getItem("mrpilot_lang")||"th",e.parse[a]||(a="th");const o=n.stage||"parse",s=e[o]||e.parse,i=s[a]||s.th||s.en,r=n.stage_total,f=n.stage_done;if(o==="parse"&&Number.isFinite(r)&&r>0){const l={zh:"共 {d}/{t} 个文件",th:"{d}/{t} ไฟล์",en:"{d}/{t} files",ja:"{d}/{t} ファイル"}[a]||"{d}/{t} files";return i+" · "+l.replace("{d}",f||0).replace("{t}",r)}return i},window._reconPollJob=async function(n,a,o){o=o||{};const s=o.intervalMs||1500,i=o.maxMs||1200*1e3,r=Date.now();let f=0;for(;;){let l=null;try{const d=await fetch("/api/recon/jobs/"+encodeURIComponent(n),{headers:{Authorization:"Bearer "+a}});try{l=await d.json()}catch{l=null}(!d.ok||!l||!l.ok)&&(l=null)}catch{l=null}if(l){if(f=0,o.onProgress)try{o.onProgress(l.progress||{},l)}catch{}if(l.status==="done"||l.status==="failed"||l.status==="needs_review"||l.status==="needs_mapping")return l}else if(++f>=10)return{ok:!1,status:"failed",error_code:"poll_unreachable"};if(Date.now()-r>i)return{ok:!1,status:"timeout",error_code:"timeout"};await new Promise(d=>setTimeout(d,s))}}})();(function(){let e=!1,n=[],a=[],o=null,s="all",i=[],r={stmt:"",gl:""},f=[];const l=k=>document.getElementById(k);function d(k){if(k==null)return"—";const T=Number(k);return isNaN(T)?"—":T.toLocaleString("en-US",{minimumFractionDigits:2,maximumFractionDigits:2})}function c(k){return k?String(k).slice(0,10).split("-").reverse().join("/"):"—"}function p(k){return String(k||"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}function u(k,T){T=window._currentLang||T||"th";const A={stmt_headers_not_found:{zh:"认不出银行账单表头 · 请确认文件含日期/金额/余额列,或转成清晰的 Excel/CSV 重传",th:"หาหัวตารางบัญชีธนาคารไม่เจอ · ตรวจสอบว่ามีคอลัมน์ วันที่/จำนวนเงิน/ยอดคงเหลือ หรือแปลงเป็น Excel/CSV แล้วอัปโหลดใหม่",en:"Cannot detect bank statement headers · ensure the file has date/amount/balance columns, or re-upload as a clean Excel/CSV",ja:"銀行明細のヘッダーを認識できません · 日付/金額/残高列を確認するか、Excel/CSVに変換して再アップロードしてください"},gl_headers_not_found:{zh:"认不出总账表头 · 请确认文件含日期/科目/借方/贷方列,或转成清晰的 Excel/CSV 重传",th:"หาหัวตาราง GL ไม่เจอ · ตรวจสอบว่ามีคอลัมน์ วันที่/บัญชี/เดบิต/เครดิต หรือแปลงเป็น Excel/CSV แล้วอัปโหลดใหม่",en:"Cannot detect GL headers · ensure the file has date/account/debit/credit columns, or re-upload as a clean Excel/CSV",ja:"GLのヘッダーを認識できません · 日付/科目/借方/貸方列を確認するか、Excel/CSVに変換して再アップロードしてください"},stmt_no_rows:{zh:"文件里没有交易数据 · 请确认上传了正确的银行流水,或换更清晰的版本重传",th:"ไม่พบรายการธุรกรรมในไฟล์ · ตรวจสอบว่าอัปโหลด statement ที่ถูกต้อง หรือใช้เวอร์ชันที่ชัดเจนกว่า",en:"No transaction rows found · please upload the correct statement, or try a clearer version",ja:"取引データが見つかりません · 正しい明細をアップロードするか、より鮮明なファイルでお試しください"},no_rows:{zh:"解析后没有可对账的数据行 · 请确认文件内容完整,或换清晰版本重传",th:"ไม่มีแถวข้อมูลให้กระทบยอดหลังการอ่าน · ตรวจสอบความสมบูรณ์ของไฟล์ หรืออัปโหลดใหม่",en:"No reconcilable rows after parsing · check the file is complete, or re-upload a clearer version",ja:"解析後に照合可能な行がありません · ファイルの完全性を確認するか再アップロードしてください"},file_unreadable:{zh:"文件无法读取 · 可能已损坏或被加密 · 请换文件或转 PDF/Excel 重传",th:"อ่านไฟล์ไม่ได้ · อาจเสียหายหรือถูกเข้ารหัส · ลองไฟล์อื่นหรือแปลงเป็น PDF/Excel",en:"File cannot be read · may be corrupted or encrypted · try another file or convert to PDF/Excel",ja:"ファイルを読み取れません · 破損または暗号化の可能性 · 別ファイルまたはPDF/Excelに変換してください"},file_not_supported:{zh:"不支持此文件类型 · 请上传 PDF / 图片 / Excel / CSV",th:"ไม่รองรับไฟล์ประเภทนี้ · กรุณาอัปโหลด PDF / รูปภาพ / Excel / CSV",en:"File type not supported · please upload PDF / image / Excel / CSV",ja:"このファイル形式は非対応 · PDF / 画像 / Excel / CSV をアップロードしてください"},ocr_failed:{zh:"文件识别失败 · 请尝试更清晰的版本,或转成 PDF / Excel / CSV 重传",th:"อ่านไฟล์ไม่ออก · ลองเวอร์ชันที่ชัดเจนกว่า หรือแปลงเป็น PDF / Excel / CSV",en:"Could not read the file · try a clearer version, or convert to PDF / Excel / CSV",ja:"読み取りに失敗 · より鮮明なファイルか、PDF / Excel / CSV に変換して再試行してください"}},U={zh:"解析失败 · 请换更清晰的文件,或转成 Excel / CSV 后重新上传",th:"อ่านไฟล์ไม่สำเร็จ · ลองไฟล์ที่ชัดเจนกว่า หรือแปลงเป็น Excel / CSV แล้วอัปโหลดใหม่",en:"Parsing failed · try a clearer file, or convert to Excel / CSV and re-upload",ja:"解析に失敗しました · より鮮明なファイルか、Excel / CSV に変換して再アップロードしてください"},z=A[k]||U;return z[T]||z.th||z.en}function v(k){const T=k==="stmt"?n:a,A=l(`brv2-${k}-name`);if(A)if(T.length===0)A.textContent="";else{const z=window._currentLang||"zh",m={zh:"个文件",th:" ไฟล์",en:" file(s)",ja:" ファイル"};A.textContent=T.length+(m[z]||" 个文件")}const U=l("brv2-preview-panel");U&&U.style.display!=="none"&&I(k),_()}function _(){const k=l("brv2-toggle-preview"),T=l("brv2-preview-panel"),A=n.length+a.length>0;k&&(k.style.display=A?"":"none"),!A&&T&&(T.style.display="none",k&&k.classList.remove("open"))}function M(){I("stmt"),I("gl")}function I(k){const T=l(k==="stmt"?"brv2-pp-stmt-col":"brv2-pp-gl-col");if(!T)return;const A=k==="stmt"?n:a,U=window._currentLang||"zh",z={stmt:{zh:"① 银行账单",th:"① บัญชีธนาคาร",en:"① Bank Stmt",ja:"① 銀行明細"},gl:{zh:"② 总账 GL",th:"② GL รายงาน",en:"② GL Report",ja:"② GL帳簿"}},m=(z[k]||{})[U]||z[k].zh,R=p(window.t&&window.t("vex-preview-search")||"搜索文件名..."),O=p(window.t&&window.t("vex-preview-clear-all")||"全清"),Y=r[k]||"";T.innerHTML='<div class="vex-pp-col-title"><span class="vex-pp-col-name">'+p(m)+' <span class="vex-pp-col-count">'+A.length+'</span></span></div><div class="vex-pp-search-row"><input class="vex-pp-search" id="brv2-pp-search-'+k+'" type="text" placeholder="'+R+'" value="'+p(Y)+'" autocomplete="off"><button class="vex-pp-clear-btn" id="brv2-pp-clearall-'+k+'" type="button">'+O+'</button></div><div class="vex-pp-file-list" id="brv2-pp-'+k+'-list"></div><div class="vex-pp-pagination" id="brv2-pp-'+k+'-pg"></div>';const X=l("brv2-pp-search-"+k);X&&X.addEventListener("input",function(se){r[k]=se.target.value,x(k)});const de=l("brv2-pp-clearall-"+k);de&&de.addEventListener("click",function(){k==="stmt"?n.length=0:a.length=0,v(k),P()}),x(k)}function x(k){const T=l("brv2-pp-"+k+"-list"),A=l("brv2-pp-"+k+"-pg");if(!T)return;const U=k==="stmt"?n:a,z=(r[k]||"").toLowerCase(),m=z?U.filter(Y=>Y.name.toLowerCase().includes(z)):U.slice(),R='<svg class="vex-pp-fi-ico" viewBox="0 0 14 16" fill="none" stroke="currentColor" stroke-width="1.4" width="12" height="14"><path d="M3 1h6l3 3v11H3V1z"/><path d="M9 1v3h3"/></svg>',O='<svg viewBox="0 0 14 14" fill="none" stroke="currentColor" stroke-width="1.6" width="11" height="11"><path d="M2 4h10M5 4V2h4v2M5.5 7v4M8.5 7v4M3 4l1 8h6l1-8"/></svg>';if(T.innerHTML=m.map((Y,X)=>'<div class="vex-pp-file-row">'+R+'<span class="vex-pp-fi-name" title="'+p(Y.name)+'">'+p(Y.name)+'</span><span class="vex-pp-fi-size">'+b(Y.size)+'</span><button class="vex-pp-fi-del" type="button" data-zone="'+k+'" data-idx="'+U.indexOf(Y)+'" aria-label="remove">'+O+"</button></div>").join(""),T.querySelectorAll(".vex-pp-fi-del").forEach(function(Y){Y.addEventListener("click",function(){const X=parseInt(Y.dataset.idx,10);Y.dataset.zone==="stmt"?n.splice(X,1):a.splice(X,1),v(Y.dataset.zone),P()})}),A){const Y=window.t&&window.t("vex-preview-count")||"显示 {n} / 共 {m}";A.textContent=Y.replace("{n}",m.length).replace("{m}",U.length)}}function b(k){return k?k<1024?k+" B":k<1048576?(k/1024).toFixed(1)+" KB":(k/1048576).toFixed(1)+" MB":""}var $="pearnly.brv2.lastAnchorOcr";function S(k){try{var T=k&&k._anchor_ocr;if(!T||typeof T!="object")return;var A={stmt_opening:Number.isFinite(+T.stmt_opening)?+T.stmt_opening:null,gl_opening:Number.isFinite(+T.gl_opening)?+T.gl_opening:null,gl_closing:Number.isFinite(+T.gl_closing)?+T.gl_closing:null,stmt_closing:Number.isFinite(+T.stmt_closing)?+T.stmt_closing:null,ts:Date.now()};localStorage.setItem($,JSON.stringify(A))}catch{}}function F(){try{var k=localStorage.getItem($);if(!k)return null;var T=JSON.parse(k);return!T||typeof T!="object"?null:T}catch{return null}}function j(){var k=F();if(k){var T={"brv2-anchor-stmt-opening":k.stmt_opening,"brv2-anchor-gl-opening":k.gl_opening,"brv2-anchor-gl-closing":k.gl_closing,"brv2-anchor-stmt-closing":k.stmt_closing},A=0;Object.keys(T).forEach(function(O){var Y=document.getElementById(O);if(Y&&Y.value===""){var X=T[O];if(Number.isFinite(X)){Y.value=X.toFixed(2);var de=Y.closest&&Y.closest(".brv2-anchor-cell");de&&de.classList.add("is-prefilled"),A+=1}}});var U=document.getElementById("brv2-anchor-eq"),z=document.getElementById("brv2-anchor-eq-val");if(U&&z&&Number.isFinite(k.stmt_opening)&&Number.isFinite(k.gl_opening)){var m=k.stmt_opening-k.gl_opening;z.textContent=m.toLocaleString(void 0,{minimumFractionDigits:2,maximumFractionDigits:2}),U.style.display=""}if(A>0){var R=document.getElementById("brv2-anchor-prefill-banner");R&&R.classList.add("show")}}}function w(){var k=document.getElementById("brv2-anchor-prefill-banner");if(k){var T=!1;["brv2-anchor-gl-closing","brv2-anchor-stmt-closing","brv2-anchor-stmt-opening","brv2-anchor-gl-opening"].forEach(function(A){var U=document.getElementById(A);if(U){var z=U.closest&&U.closest(".brv2-anchor-cell");z&&z.classList.contains("is-prefilled")&&(T=!0)}}),k.classList.toggle("show",T)}}var h=[["stmt_opening","brv2-anchor-stmt-opening"],["gl_opening","brv2-anchor-gl-opening"],["gl_closing","brv2-anchor-gl-closing"],["stmt_closing","brv2-anchor-stmt-closing"]];function y(k,T){return window.t&&window.t(k)||T}function L(k){return String(k??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function C(k){return Number.isFinite(+k)?(+k).toLocaleString(void 0,{minimumFractionDigits:2,maximumFractionDigits:2}):"—"}function D(k){var T=document.getElementById("brv2-summary-collapse");if(!(!T||!T.parentNode)){var A=document.getElementById("brv2-anchor-audit"),U=k&&k._anchor_overrides;if(!U||typeof U!="object"||Object.keys(U).length===0){A&&A.parentNode&&A.parentNode.removeChild(A);return}A||(A=document.createElement("div"),A.id="brv2-anchor-audit",A.style.cssText="margin-top:14px;background:#fff7ed;border:1px solid #fed7aa;border-radius:8px;padding:14px 16px;",T.parentNode.insertBefore(A,T.nextSibling));var z=h.map(function(m){var R=U[m[0]];if(!R)return"";var O=+R.ocr||0,Y=+R.user||0,X=Y-O,de=X>0?"+":(X<0,""),se=Math.abs(X)<.005?"#6b7280":X>0?"#16a34a":"#dc2626";return'<tr><td style="padding:6px 10px;color:#111827;font-size:13px">'+L(y(m[1],m[0]))+'</td><td style="padding:6px 10px;color:#6b7280;font-size:13px;text-align:right;font-variant-numeric:tabular-nums">'+L(C(O))+'</td><td style="padding:6px 10px;background:#fef08a;color:#92400e;font-weight:600;font-size:13px;text-align:right;font-variant-numeric:tabular-nums">'+L(C(Y))+'</td><td style="padding:6px 10px;color:'+se+';font-weight:500;font-size:13px;text-align:right;font-variant-numeric:tabular-nums">'+L(de+C(X))+"</td></tr>"}).join("");A.innerHTML='<div style="font-weight:600;color:#92400e;font-size:13px;margin-bottom:10px">'+L(y("brv2-anchor-audit-title","⚠ This run contains manually entered anchors"))+'</div><table style="width:100%;border-collapse:collapse;font-family:inherit"><thead><tr><th style="padding:6px 10px;text-align:left;color:#6b7280;font-size:11px;font-weight:500;border-bottom:1px solid #fed7aa">'+L(y("brv2-anchor-audit-col-field","Field"))+'</th><th style="padding:6px 10px;text-align:right;color:#6b7280;font-size:11px;font-weight:500;border-bottom:1px solid #fed7aa">'+L(y("brv2-anchor-audit-col-ocr","OCR"))+'</th><th style="padding:6px 10px;text-align:right;color:#6b7280;font-size:11px;font-weight:500;border-bottom:1px solid #fed7aa">'+L(y("brv2-anchor-audit-col-user","User"))+'</th><th style="padding:6px 10px;text-align:right;color:#6b7280;font-size:11px;font-weight:500;border-bottom:1px solid #fed7aa">'+L(y("brv2-anchor-audit-col-diff","Diff"))+"</th></tr></thead><tbody>"+z+"</tbody></table>"}}function B(){const k=l("brv2-toggle-preview");k&&!k._reconBound&&(k._reconBound=!0,k.addEventListener("click",function(){const T=l("brv2-preview-panel"),A=l("brv2-toggle-preview-label"),U=T&&T.style.display!=="none";T&&(T.style.display=U?"none":""),k.classList.toggle("open",!U),A&&(A.textContent=U?window.t&&window.t("vex-toggle-preview-open")||"查看清单":window.t&&window.t("vex-toggle-preview-close")||"收起清单"),U||M()}))}function P(){const k=l("brv2-run-btn"),T=l("brv2-status"),A=n.length>0,U=a.length>0;if(k&&(k.disabled=!(A&&U)),T){const z=window._currentLang||"zh";if(!A&&!U){const m={zh:"请上传银行账单和 GL 文件",th:"กรุณาอัปโหลดบัญชีธนาคารและ GL",en:"Upload bank statement and GL files",ja:"銀行明細と GL を両方アップロードしてください"};T.textContent=m[z]||m.zh}else if(A)if(U){const m={zh:"两份文件已就绪",th:"พร้อมสอบทาน",en:"Ready to reconcile",ja:"照合を開始できます"};T.textContent=m[z]||m.zh}else{const m={zh:"还缺 GL 文件",th:"ยังขาดไฟล์ GL",en:"Missing GL file",ja:"GL ファイルが未アップロード"};T.textContent=m[z]||m.zh}else{const m={zh:"还缺银行账单 PDF",th:"ยังขาดไฟล์บัญชีธนาคาร PDF",en:"Missing bank statement PDF",ja:"銀行明細 PDF が未アップロード"};T.textContent=m[z]||m.zh}}}function J(k,T,A){const U=l(k),z=l(T);!U||!z||(U.addEventListener("click",()=>z.click()),U.addEventListener("keydown",m=>{(m.key==="Enter"||m.key===" ")&&(m.preventDefault(),z.click())}),U.addEventListener("dragover",m=>{m.preventDefault(),U.classList.add("drag-over")}),U.addEventListener("dragleave",()=>U.classList.remove("drag-over")),U.addEventListener("drop",m=>{m.preventDefault(),U.classList.remove("drag-over");const R=Array.from(m.dataTransfer.files||[]);A==="stmt"?n.push(...R):a.push(...R),v(A),P()}),z.addEventListener("change",()=>{const m=Array.from(z.files||[]);A==="stmt"?n.push(...m):a.push(...m),z.value="",v(A),P()}))}function G(k){const T=l("brv2-progress"),A=l("brv2-run-btn"),U=l("brv2-error");T&&(T.style.display=k?"":"none"),A&&(A.disabled=k),U&&(U.style.display="none")}function W(k){const T=l("brv2-error");T&&(T.textContent=k,T.style.display="",T.scrollIntoView({behavior:"smooth",block:"nearest"})),G(!1),P(),window.showToast&&window.showToast(k,"error")}async function te(){if(n.length===0||a.length===0)return;const k=localStorage.getItem("mrpilot_token")||"",T=window._currentLang||"zh",A=(l("brv2-acct-select")||{}).value||"";H(!1),G(!0);try{const U=new FormData;n.forEach(ae=>U.append("stmt_files",ae)),a.forEach(ae=>U.append("gl_files",ae)),U.append("gl_account",A),U.append("lang",T);const z=parseFloat((l("brv2-anchor-gl-closing")||{}).value),m=parseFloat((l("brv2-anchor-stmt-closing")||{}).value),R=parseFloat((l("brv2-anchor-stmt-opening")||{}).value),O=parseFloat((l("brv2-anchor-gl-opening")||{}).value);Number.isFinite(z)&&U.append("gl_closing_override",z),Number.isFinite(m)&&U.append("stmt_closing_override",m),Number.isFinite(R)&&U.append("stmt_opening_override",R),Number.isFinite(O)&&U.append("gl_opening_override",O);const Y=await fetch("/api/recon/bank-v2/submit",{method:"POST",headers:{Authorization:"Bearer "+k},body:U});let X=null;try{X=await Y.json()}catch{X=null}if(X&&X.needs_mapping){G(!1),window.ReconMapping?window.ReconMapping.show(X,{token:k,lang:T,onConfirmed:function(){te()}}):W(t("brv2-err-server")||"服务器繁忙,请稍后重试");return}if(!Y.ok||!X||!X.ok||!X.job_id){G(!1),X&&(X.detail||X.error)?W(_humanizeBackendError(X.detail||X.error,"Error "+Y.status)):W(t("brv2-err-server")||"服务器繁忙,请稍后重试");return}const de=l("brv2-progress-sub"),se=await window._reconPollJob(X.job_id,k,{onProgress:ae=>{de&&(de.textContent=window._reconProgressText(ae,T))}});if(se&&se.status==="needs_mapping"&&se.mapping){G(!1),window.ReconMapping?window.ReconMapping.show(se.mapping,{token:k,lang:T,onConfirmed:function(){te()}}):W(t("brv2-err-server")||"服务器繁忙,请稍后重试");return}if(se&&se.status==="needs_review"&&se.review){G(!1),window.ReconReview?window.ReconReview.show(se.review,{token:k,lang:T,jobId:X.job_id,onConfirmed:async function(ae){G(!0);const pe=await window._reconPollJob(ae,k,{onProgress:fe=>{de&&(de.textContent=window._reconProgressText(fe,T))}});await ce(pe)}}):W(t("brv2-err-server")||"服务器繁忙,请稍后重试");return}if(se&&se.status==="failed"){G(!1),W(u(se.error_code,T));return}await ce(se);async function ce(ae){try{if(!ae||ae.status!=="done"||!ae.result_id){G(!1),W(t("brv2-err-server")||"服务器繁忙,请稍后重试");return}const pe=await fetch("/api/recon/bank-v2/"+encodeURIComponent(ae.result_id),{headers:{Authorization:"Bearer "+k}});let fe=null;try{fe=await pe.json()}catch{fe=null}if(!pe.ok||fe===null||!fe.ok){G(!1),W(t("brv2-err-server")||"服务器繁忙,请稍后重试");return}(fe.gl_accounts||[]).length>1&&re(fe.gl_accounts),o=fe,i=fe.detail||[],s="all",document.querySelectorAll(".brv2-filter-btn").forEach(ge=>ge.classList.toggle("active",ge.dataset.filter==="all")),S(fe&&fe.summary),G(!1),N(fe),Z();const me=l("brv2-summary-collapse");me&&me.scrollIntoView({behavior:"smooth",block:"nearest"})}catch(pe){G(!1),W(pe.message||"Network error")}}}catch(U){W(U.message||"Network error")}}function re(k){const T=l("brv2-acct-select");if(!T)return;const A=window._currentLang||"zh",U={zh:"全部账户",th:"ทุกบัญชี",en:"All Accounts",ja:"すべての口座"}[A]||"全部账户";T.innerHTML=`<option value="">${U}</option>`+k.map(z=>`<option value="${p(z)}">${p(z)}</option>`).join(""),T.style.display=""}function H(k){const T=l("brv2-summary-collapse"),A=l("brv2-detail-collapse"),U=l("brv2-export-btn"),z=l("brv2-new-btn"),m=l("brv2-parse-info-wrap");T&&(T.style.display=k?"":"none"),A&&(A.style.display=k?"":"none"),U&&(U.style.display=k?"":"none"),z&&(z.style.display=k?"":"none"),!k&&m&&(m.style.display="none");const R=l("brv2-warnings");!k&&R&&(R.style.display="none",R.innerHTML="")}function E(k){const T=l("brv2-parse-info-wrap"),A=l("brv2-parse-info-body");if(!T||!A)return;const U=k.parse_info;if(!U){T.style.display="none";return}const z=window._currentLang||"zh",m={title:{zh:"文件解析状态",th:"สถานะการอ่านไฟล์",en:"File Parse Status",ja:"ファイル解析状態"},type:{zh:"类型",th:"ประเภท",en:"Type",ja:"種別"},file:{zh:"文件名",th:"ชื่อไฟล์",en:"File",ja:"ファイル"},rows:{zh:"解析行数",th:"แถวที่พบ",en:"Rows Found",ja:"解析行数"},bank:{zh:"银行/科目",th:"ธนาคาร/บัญชี",en:"Bank/Account",ja:"銀行/科目"},status:{zh:"状态",th:"สถานะ",en:"Status",ja:"状態"},stmt:{zh:"账单",th:"บัญชีธนาคาร",en:"Stmt",ja:"明細"},gl:{zh:"总账GL",th:"GL",en:"GL",ja:"GL"},ok:{zh:"✓ 成功",th:"✓ สำเร็จ",en:"✓ OK",ja:"✓ 成功"},warn:{zh:"⚠ 0行",th:"⚠ 0 แถว",en:"⚠ 0 rows",ja:"⚠ 0行"},fail:{zh:"✗ 失败",th:"✗ ล้มเหลว",en:"✗ Failed",ja:"✗ 失敗"}},R=ce=>(m[ce]||{})[z]||(m[ce]||{}).zh||ce,O=[...(U.stmt_files||[]).map(ce=>({...ce,_type:"stmt",_extra:ce.bank_code||""})),...(U.gl_files||[]).map(ce=>({...ce,_type:"gl",_extra:(ce.accounts||[]).join(", ")}))],Y={stmt_headers_not_found:{zh:"认不出表头列 · 请确认文件含日期/金额/余额列",th:"หาคอลัมน์หัวตารางไม่เจอ · ตรวจสอบไฟล์มีวันที่/จำนวนเงิน/ยอดคงเหลือ",en:"Cannot detect column headers · ensure file has date/amount/balance columns",ja:"列ヘッダーが認識できません · 日付/金額/残高列を確認してください"},stmt_no_rows:{zh:"文件里没有交易数据 · 请确认上传了正确的银行流水",th:"ไม่พบรายการธุรกรรมในไฟล์ · ตรวจสอบว่าอัปโหลด statement ที่ถูกต้อง",en:"No transaction rows found · please check the file",ja:"取引データが見つかりません · ファイルを確認してください"},file_not_supported:{zh:"不支持此文件类型 · 请上传 PDF / 图片 / Excel / CSV",th:"ไม่รองรับไฟล์ประเภทนี้ · กรุณาอัปโหลด PDF / รูปภาพ / Excel / CSV",en:"File type not supported · please upload PDF / image / Excel / CSV",ja:"このファイル形式は非対応 · PDF / 画像 / Excel / CSV をアップロード"},file_unreadable:{zh:"文件无法读取 · 可能已损坏或被加密",th:"อ่านไฟล์ไม่ได้ · อาจเสียหายหรือถูกเข้ารหัส",en:"File cannot be read · may be corrupted or encrypted",ja:"ファイルを読み取れません · 破損または暗号化の可能性"},ocr_failed:{zh:"文件识别失败 · 请尝试更清晰的版本或换 PDF 格式重传",th:"อ่านไฟล์ไม่ออก · ลองเวอร์ชันที่ชัดเจนกว่าหรือเปลี่ยนเป็น PDF",en:"Could not read file · try a clearer version or upload as PDF",ja:"読み取り失敗 · より鮮明なファイルまたは PDF 形式で再試行"},gl_headers_not_found:{zh:"认不出总账表头 · 请确认文件含科目/借方/贷方列",th:"หาหัวคอลัมน์ GL ไม่เจอ · ตรวจสอบมีคอลัมน์บัญชี/เดบิต/เครดิต",en:"Cannot detect GL column headers · ensure account/debit/credit columns exist",ja:"GL 列ヘッダー認識不可 · 科目/借方/貸方列を確認してください"}},X=ce=>{const ae=String(ce||"");return/Cannot detect bank statement column headers/i.test(ae)?"stmt_headers_not_found":/Cannot detect GL column headers/i.test(ae)?"gl_headers_not_found":/No transaction rows found|no pages parsed/i.test(ae)?"stmt_no_rows":/unsupported format/i.test(ae)?"file_not_supported":/Cannot read Excel|file_unreadable/i.test(ae)?"file_unreadable":/Gemini.*invalid JSON|Gemini.*parsed but failed|validation errors|BankStatementDocument schema|layer2:|layer1:/i.test(ae)?"ocr_failed":null},de=ce=>{const ae=ce.error_code||X(ce.error);if(ae&&Y[ae]){const pe=window._currentLang||"zh";return Y[ae][pe]||Y[ae].zh}return String(ce.error||"").slice(0,80)},se=ce=>!ce.ok&&ce.error?`<span style="color:#dc2626">${R("fail")} — ${p(de(ce))}</span>`:ce.rows?`<span style="color:#059669">${R("ok")} (${ce.rows})</span>`:`<span style="color:#d97706">${R("warn")}</span>`;A.innerHTML=`
            ...
            <table style="width:100%;border-collapse:collapse;font-size:12px;margin-bottom:4px">
            ...
            </table>`,T.style.display=""}async function g(k){const T=localStorage.getItem("mrpilot_token")||"",A=window._currentLang||"zh";try{const U=await fetch("/api/recon/bank-v2/"+k+"/export?lang="+A,{headers:{Authorization:"Bearer "+T}});if(!U.ok){const de=await U.json().catch(()=>({}));window.showToast&&window.showToast(de.detail||"Export failed","error");return}const z=await U.blob(),R=(U.headers.get("content-disposition")||"").match(/filename[^;=\n]*=((['"]).*?\2|[^;\n]*)/),O=R?R[1].replace(/['"]/g,""):"reconciliation.xlsx",Y=URL.createObjectURL(z),X=document.createElement("a");X.href=Y,X.download=O,document.body.appendChild(X),X.click(),document.body.removeChild(X),URL.revokeObjectURL(Y)}catch(U){window.showToast&&window.showToast("Export error: "+U.message,"error")}}function q(k,T){const A=l("brv2-summary-collapse");let U=l("brv2-warnings");const z=window._currentLang||"zh",m={zh:"⏭ 已跳过无法识别的文件:",th:"⏭ ข้ามไฟล์ที่อ่านไม่ได้:",en:"⏭ Skipped unreadable file:",ja:"⏭ 読み取れないファイルをスキップ:"}[z]||"⏭ ",R=[];if((T||[]).forEach(O=>R.push(m+" "+O)),(k||[]).forEach(O=>R.push(O)),!R.length){U&&(U.style.display="none");return}if(!U)if(U=document.createElement("div"),U.id="brv2-warnings",A&&A.parentNode)A.parentNode.insertBefore(U,A);else return;U.style.cssText="display:block;margin:10px 0;padding:10px 14px;background:#FEF3C7;border:1px solid #FCD34D;border-radius:8px;color:#92400E;font-size:13px;line-height:1.6",U.innerHTML=R.map(O=>"<div>"+p(O)+"</div>").join("")}function N(k){E(k),q(k.warnings||[],k.skipped_files||[]),!k.ok&&k.error&&window.showToast&&window.showToast(k.error,"error");const T=k.stats||{},A=k.summary||{},U=T.matched||0,z=(T.gl_debit_only||0)+(T.gl_credit_only||0),m=(T.stmt_withdrawal_only||0)+(T.stmt_deposit_only||0),R=Number(A.formula_diff||0),O=Math.abs(R)<.05;l("brv2-kpi-matched")&&(l("brv2-kpi-matched").textContent=U),l("brv2-kpi-diff")&&(l("brv2-kpi-diff").textContent=d(R)),l("brv2-kpi-unmatched")&&(l("brv2-kpi-unmatched").textContent=z+m);const Y=l("brv2-kpi-diff-icon");Y&&(Y.style.background=O?"#d1fae5":"#fee2e2",Y.style.color=O?"#065f46":"#b91c1c");const X=l("brv2-formula-sub");if(X){const pe=window._currentLang||"zh";X.textContent=O?{zh:"✓ 平衡",th:"✓ สมดุล",en:"✓ Balanced",ja:"✓ 一致"}[pe]||"✓ 平衡":({zh:"差 ",th:"ต่าง ",en:"Diff ",ja:"差 "}[pe]||"差 ")+d(R)}const de=l("brv2-detail-sub");if(de){const pe=window._currentLang||"zh",fe={zh:"共 {n} 行",th:"ทั้งหมด {n} แถว",en:"{n} rows",ja:"計 {n} 行"}[pe]||"共 {n} 行";de.textContent=fe.replace("{n}",i.length)}function se(pe,fe,me){const ge=l(pe);ge&&(ge.textContent=(me&&fe>0?"(":"")+d(me?-fe:fe)+(me&&fe>0?")":""))}se("brf-gl-close",A.gl_closing||0),se("brf-open-diff",A.opening_diff||0),se("brf-gl-debit-only",A.gl_debit_only_amount||0,!0),se("brf-gl-credit-only",A.gl_credit_only_amount||0),se("brf-stmt-wd-only",A.stmt_withdrawal_only_amount||0,!0),se("brf-stmt-dep-only",A.stmt_deposit_only_amount||0),se("brf-calc-close",A.formula_stmt_closing||0),se("brf-stmt-close",A.stmt_closing||0),l("brf-diff")&&(l("brf-diff").textContent=d(R));const ce=l("brv2-fcell-diff");ce&&ce.classList.toggle("brv2-fcell-diff-ok",O);const ae=l("brv2-export-btn");ae&&(ae.onclick=()=>{o&&g(o.task_id)}),D(A),H(!0),K()}function K(){const k=l("brv2-tbody");if(!k)return;const T=i.filter(m=>s==="all"?!0:s==="matched"?m.match_status==="matched":s==="gl_only"?m.match_status.startsWith("gl_"):s==="stmt_only"?m.match_status.startsWith("stmt_"):!0);if(T.length===0){const m={zh:"无记录",th:"ไม่มีรายการ",en:"No rows",ja:"行なし"}[window._currentLang||"zh"]||"无记录";k.innerHTML=`<tr><td colspan="10" style="text-align:center;padding:20px;color:var(--ink-3)">${m}</td></tr>`;return}const A=window._currentLang||"zh",U={zh:"OCR 余额验证未通过 · 上一行余额 ± 金额 ≠ 本行余额，请核对原 PDF",th:"การตรวจสอบยอดคงเหลือไม่ผ่าน · ยอดก่อนหน้า ± จำนวน ≠ ยอดบรรทัดนี้ โปรดตรวจสอบ PDF ต้นฉบับ",en:"Balance check FAILED · prev_balance ± amount ≠ this row balance — verify against the original PDF",ja:"残高検証エラー · 前残高 ± 金額 ≠ この行残高 — 元のPDFと照合してください"}[A],z={zh:"OCR 低置信度 · 数字模糊或难以辨认，请核对原 PDF",th:"OCR ความมั่นใจต่ำ · ตัวเลขเบลอหรืออ่านยาก โปรดตรวจสอบ PDF ต้นฉบับ",en:"OCR low confidence · digit was blurry or hard to read — verify against the original PDF",ja:"OCR信頼度低 · 数字がぼやけている — 元のPDFと照合してください"}[A];k.innerHTML=T.map(m=>{const R=m.match_status,O=m.match_layer;let Y="",X="";R==="matched"?(O===1&&(Y="matched",X='<span class="brv2-status-badge brv2-badge-matched">L1 ✓</span>'),O===2&&(Y="matched-l2",X='<span class="brv2-status-badge brv2-badge-matched-l2">L2 ~</span>'),O===3&&(Y="matched-l3",X='<span class="brv2-status-badge brv2-badge-matched-l3">L3 ?</span>')):R==="gl_debit_only"||R==="gl_credit_only"?(Y="gl-only",X='<span class="brv2-status-badge brv2-badge-gl-only">GL</span>'):(Y="stmt-only",X=`<span class="brv2-status-badge brv2-badge-stmt-only">${{zh:"账单",th:"บัญชี",en:"Stmt",ja:"明細"}[A]||"账单"}</span>`);let de="";return m.stmt_balance_ok===!1&&(de+=`<span class="brv2-ocr-warn brv2-ocr-warn-bal" title="${p(U)}">⚠</span>`,Y+=" brv2-row-warn"),m.stmt_confidence==="low"&&(de+=`<span class="brv2-ocr-warn brv2-ocr-warn-conf" title="${p(z)}">◌</span>`,Y.includes("brv2-row-warn")||(Y+=" brv2-row-warn-soft")),`<tr class="${Y.trim()}">
              <td>${X}${de}</td>
              ...
              <td>${O?"L"+O:"—"}</td>
            </tr>`}).join("")}async function Z(){const k=localStorage.getItem("mrpilot_token")||"";try{const A=await(await fetch("/api/recon/bank-v2/tasks",{headers:{Authorization:"Bearer "+k}})).json();ee(A.tasks||[])}catch{const A=l("brv2-history-empty"),U=window._currentLang||"zh",z={zh:"加载失败",th:"โหลดประวัติไม่ได้",en:"Load failed",ja:"読み込み失敗"}[U]||"加载失败";A&&(A.textContent=z,A.style.display="");const m=l("brv2-history-table-wrap");m&&(m.style.display="none")}}const le=10;let ie=1;function V(){const k=l("brv2-history-pager"),T=l("brv2-history-pager-info"),A=l("brv2-history-prev"),U=l("brv2-history-next");if(!k)return;if(f.length<=le){k.style.display="none";return}k.style.display="";const z=Math.ceil(f.length/le);T&&(T.textContent=ie+" / "+z),A&&(A.disabled=ie<=1),U&&(U.disabled=ie>=z)}function Q(){const k=l("brv2-history-prev"),T=l("brv2-history-next");k&&!k._brv2Bound&&(k._brv2Bound=!0,k.addEventListener("click",()=>{ie>1&&(ie--,ee(f))})),T&&!T._brv2Bound&&(T._brv2Bound=!0,T.addEventListener("click",()=>{const A=Math.ceil(f.length/le);ie<A&&(ie++,ee(f))}))}function ee(k){k!==void 0&&(f=k||[],ie=1);const T=f,A=l("brv2-history-empty"),U=l("brv2-history-table-wrap"),z=l("brv2-history-tbody");if(!z)return;const m=window._currentLang||"zh";if(!T.length){const ae={zh:"暂无对账记录",th:"ยังไม่มีประวัติ",en:"No records yet",ja:"記録なし"}[m]||"暂无对账记录";A&&(A.textContent=ae,A.style.display=""),U&&(U.style.display="none"),V();return}A&&(A.style.display="none"),U&&(U.style.display="");const R=Math.ceil(T.length/le);ie>R&&(ie=R);const O=(ie-1)*le,Y=T.slice(O,O+le),X=localStorage.getItem("mrpilot_token")||"",de='<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" width="14" height="14"><circle cx="8" cy="8" r="6"/><polyline points="6 8 8 10 10 8"/><line x1="8" y1="4" x2="8" y2="10"/></svg>',se='<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" width="14" height="14"><path d="M8 2v9M4 7l4 4 4-4M3 14h10"/></svg>',ce='<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" width="14" height="14"><polyline points="3 4 13 4"/><path d="M6 4V2.5a.5.5 0 0 1 .5-.5h3a.5.5 0 0 1 .5.5V4"/><path d="M5 4l1 9a1 1 0 0 0 1 1h2a1 1 0 0 0 1-1l1-9"/></svg>';z.innerHTML="",Y.forEach(ae=>{const pe=Number(ae.formula_diff||0),fe=Math.abs(pe)<.05,me=(ae.stmt_files||"").split(";").map(ke=>ke.trim().split(/[/\\]/).pop()).filter(Boolean).join(", "),ge=(ae.gl_files||"").split(";").map(ke=>ke.trim().split(/[/\\]/).pop()).filter(Boolean).join(", "),be=ae.created_at?String(ae.created_at).slice(0,16).replace("T"," "):"",xe=document.createElement("tr");xe.dataset.taskId=ae.id;const ze=document.createElement("td");ze.textContent=be;const Te=document.createElement("td");Te.className="glv-history-file",Te.title=me+" + "+ge,Te.textContent=me+" + "+ge;const He=document.createElement("td");He.className="glv-num",He.textContent=(ae.stmt_row_count||0)+" / "+(ae.gl_row_count||0);const st=document.createElement("td");st.className="glv-num",st.textContent=ae.matched_count||0;const it=document.createElement("td");it.className="glv-num",it.textContent=ae.unmatched_gl||0;const rt=document.createElement("td");rt.className="glv-num",rt.textContent=ae.unmatched_stmt||0;const Oe=document.createElement("td");Oe.className="glv-num",Oe.style.color=fe?"#059669":"#dc2626",Oe.textContent=fe?"✓":d(pe);const Ae=document.createElement("td");Ae.className="glv-history-actions";const lt=(ke,Bt,Lt,gn)=>{const Ie=document.createElement("button");return Ie.type="button",Ie.title=Bt,Ie.setAttribute("aria-label",Bt),Lt&&(Ie.className=Lt),Ie.innerHTML=ke,Ie.onclick=bn=>{bn.stopPropagation(),gn()},Ie},fn={zh:"删除这条记录?",th:"ลบรายการนี้?",en:"Delete this record?",ja:"この記録を削除しますか?"}[m]||"删除?",mn={zh:"加载",th:"โหลด",en:"Load",ja:"読込"}[m]||"加载",vn={zh:"导出",th:"ส่งออก",en:"Export",ja:"エクスポート"}[m]||"导出",hn={zh:"删除",th:"ลบ",en:"Delete",ja:"削除"}[m]||"删除";Ae.appendChild(lt(de,mn,"",()=>oe(ae.id,X))),Ae.appendChild(lt(se,vn,"",()=>g(ae.id))),Ae.appendChild(lt(ce,hn,"glv-del",async()=>{await showConfirm(fn,{danger:!0})&&(await fetch("/api/recon/bank-v2/"+ae.id,{method:"DELETE",headers:{Authorization:"Bearer "+X}}),Z())})),[ze,Te,He,st,it,rt,Oe,Ae].forEach(ke=>xe.appendChild(ke)),xe.style.cursor="pointer",xe.addEventListener("click",async ke=>{ke.target.closest(".glv-del")||ke.target.closest("button")||await oe(ae.id,X)}),z.appendChild(xe)}),V(),ne()}function ne(){const k=((l("brv2-hist-search")||{}).value||"").trim().toLowerCase(),T=l("brv2-history-tbody");T&&T.querySelectorAll("tr").forEach(A=>{A.dataset.taskId&&(A.style.display=!k||A.textContent.toLowerCase().includes(k)?"":"none")})}async function oe(k,T){try{const U=await(await fetch("/api/recon/bank-v2/"+k,{headers:{Authorization:"Bearer "+T}})).json();if(!U.ok)return;o={task_id:U.task_id,...U},i=U.detail||[],s="all",document.querySelectorAll(".brv2-filter-btn").forEach(z=>z.classList.toggle("active",z.dataset.filter==="all")),N(o)}catch{}}function ue(){if(e){Z();return}e=!0,J("brv2-stmt-zone","brv2-stmt-input","stmt"),J("brv2-gl-zone","brv2-gl-input","gl");const k=["brv2-anchor-gl-closing","brv2-anchor-stmt-closing","brv2-anchor-stmt-opening","brv2-anchor-gl-opening"];function T(){const O=parseFloat((l("brv2-anchor-stmt-opening")||{}).value),Y=parseFloat((l("brv2-anchor-gl-opening")||{}).value),X=l("brv2-anchor-eq"),de=l("brv2-anchor-eq-val");if(!(!X||!de))if(Number.isFinite(O)&&Number.isFinite(Y)){const se=O-Y;de.textContent=se.toLocaleString(void 0,{minimumFractionDigits:2,maximumFractionDigits:2}),X.style.display=""}else X.style.display="none"}k.forEach(O=>{const Y=l(O);Y&&(Y.addEventListener("input",T),Y.addEventListener("input",()=>{const X=Y.closest(".brv2-anchor-cell");X&&X.classList.remove("is-prefilled"),w()}))}),j();const A=l("brv2-run-btn");A&&A.addEventListener("click",te);const U=l("brv2-reset-btn");U&&U.addEventListener("click",()=>{o=null,i=[],n=[],a=[],v("stmt"),v("gl"),P(),H(!1);const O=l("brv2-acct-select");O&&(O.style.display="none"),k.forEach(de=>{const se=l(de);if(se){se.value="";const ce=se.closest&&se.closest(".brv2-anchor-cell");ce&&ce.classList.remove("is-prefilled")}});const Y=l("brv2-anchor-eq");Y&&(Y.style.display="none");const X=l("brv2-anchor-prefill-banner");X&&X.classList.remove("show")});const z=l("brv2-new-btn");z&&z.addEventListener("click",()=>{o=null,i=[],n=[],a=[],v("stmt"),v("gl"),P(),H(!1)});const m=l("brv2-filter-tabs");m&&m.addEventListener("click",O=>{O.stopPropagation();const Y=O.target.closest(".brv2-filter-btn");Y&&(s=Y.dataset.filter,m.querySelectorAll(".brv2-filter-btn").forEach(X=>X.classList.toggle("active",X===Y)),K())}),B(),Q();const R=l("brv2-hist-search");R&&R.addEventListener("input",ne),Z(),P(),window._brv2LoadHistory=Z,Array.isArray(window.__i18nSubs)||(window.__i18nSubs=[]),window.__i18nSubs=window.__i18nSubs.filter(O=>O.name!=="brv2"),window.__i18nSubs.push({name:"brv2",fn:function(){P(),v("stmt"),v("gl"),o&&N(o),ee()}})}window._loadBankReconV2Panel=function(k){const T=k?document.getElementById(k):null;T&&T.id!=="recon-pane-bank"&&(T.innerHTML=`<div style="padding:16px;font-size:13px;color:var(--ink-3)">
                银行对账 v2 · 请前往对账中心使用</div>`),ue()},document.addEventListener("DOMContentLoaded",()=>{l("brv2-run-btn")&&ue()}),window._bankReconV2Init=ue})();(function(){const e=document.getElementById("general-lang");if(!e)return;e.addEventListener("change",a=>{const o=a.target.value;o&&applyLang(o)});const n=typeof currentLang=="string"&&currentLang||localStorage.getItem("mrpilot_lang")||"th";e.value=n})();(function(){const n="pearnly_general_tz",a="pearnly_general_date_format",o="pearnly_general_number_format",s={tz:"Asia/Bangkok",date:"YYYY-MM-DD",number:"comma_dot"};function i(){const d=document.getElementById("general-tz"),c=document.getElementById("general-date"),p=document.getElementById("general-number");if(!(!d||!c||!p))try{d.value=localStorage.getItem(n)||s.tz,c.value=localStorage.getItem(a)||s.date,p.value=localStorage.getItem(o)||s.number}catch{d.value=s.tz,c.value=s.date,p.value=s.number}}async function r(){const d=document.getElementById("btn-save-general"),c=document.getElementById("general-save-msg");if(!d)return;const p=d.innerHTML;d.disabled=!0,d.innerHTML="<span>"+(t("msg-saving")||"保存中...")+"</span>",c&&(c.textContent="",c.classList.remove("error"));try{const u=(document.getElementById("general-tz")||{}).value||s.tz,v=(document.getElementById("general-date")||{}).value||s.date,_=(document.getElementById("general-number")||{}).value||s.number;try{localStorage.setItem(n,u),localStorage.setItem(a,v),localStorage.setItem(o,_)}catch{}window._pearnlyGeneral={tz:u,date_format:v,number_format:_},c&&(c.textContent=t("msg-saved")||"已保存")}catch{c&&(c.textContent=t("msg-save-failed")||"保存失败",c.classList.add("error"))}finally{d.disabled=!1,d.innerHTML=p,setTimeout(function(){c&&(c.textContent="")},3e3)}}function f(){const d=document.getElementById("btn-save-general");if(!d){setTimeout(f,200);return}d._pearnlyGenBound||(d._pearnlyGenBound=!0,d.addEventListener("click",r),i())}function l(){i();const d=document.getElementById("general-lang");if(d){const c=typeof currentLang=="string"&&currentLang||localStorage.getItem("mrpilot_lang")||"th";d.value=c}}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",f):f(),typeof window.subscribeI18n=="function"&&window.subscribeI18n("settings-general",l)})();(function(){const e="mrpilot_nav_collapsed",n={ocr:"sales",history:"sales",reconcile:"sales","sales-invoices":"sales",receivables:"sales",vouchers:"expense"};function a(){try{const r=localStorage.getItem(e);return r?JSON.parse(r):{}}catch{return{}}}function o(r){try{localStorage.setItem(e,JSON.stringify(r))}catch{}}function s(){const r=a();document.querySelectorAll(".nav-collapsible").forEach(function(f){const l=f.dataset.collapsible;r[l]?f.classList.add("collapsed"):f.classList.remove("collapsed")})}function i(r){const f=a();f[r]=!f[r],o(f),s()}(function(){const f=a();let l=!1;f.sales===void 0&&(f.sales=!1,l=!0),f.expense===void 0&&(f.expense=!0,l=!0),l&&o(f)})(),s(),document.querySelectorAll(".nav-group-toggle").forEach(function(r){r.addEventListener("click",function(){i(r.dataset.toggleGroup)})}),window.expandNavGroupForRoute=function(r){const f=n[r];if(!f)return;const l=a();l[f]&&(l[f]=!1,o(l),s())}})();const Ha=`
    <div class="modal" style="max-width:440px">
    ...
    </div>`;function $t(){const e=document.getElementById("help-modal");if(!e||e.children.length)return;e.innerHTML=Ha;const n=window._currentLang||"th",a=window.I18N&&window.I18N[n]||{};e.querySelectorAll("[data-i18n]").forEach(o=>{const s=o.getAttribute("data-i18n");a[s]&&(o.textContent=a[s])})}document.readyState,$t();(function(){function e(){const n=document.getElementById("help-modal"),a=document.getElementById("help-modal-close");n&&(a&&!a.dataset.bound&&(a.addEventListener("click",function(){n.style.display="none"}),a.dataset.bound="1"),n.dataset.maskBound||(n.addEventListener("click",function(o){o.target===n&&(n.style.display="none")}),n.dataset.maskBound="1"),window._helpModalEscBound||(document.addEventListener("keydown",function(o){o.key==="Escape"&&n.style.display==="flex"&&(n.style.display="none")}),window._helpModalEscBound=!0))}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",e):e()})();(function(){const e={line:"line",folder:"folder",gmail:"email",erp:"erp",alert:"alert"};document.addEventListener("click",function(n){const a=n.target.closest(".int-btn-configure");if(!a)return;const o=a.closest(".integration-row"),s=o?o.dataset.intAnchor:null;if(s&&e[s]){const i=o.querySelector(".int-name"),r=i?(i.textContent||i.innerText||"").trim():"配置";typeof window.openIntegrationDrawer=="function"&&window.openIntegrationDrawer(e[s],r)}})})();let we=[];window._erpEndpoints=we;let Ne=null;async function at(){try{const e=await fetch("/api/erp/endpoints",{headers:{Authorization:"Bearer "+token}});if(e.status===401){localStorage.removeItem("mrpilot_token");const a=await e.json().catch(()=>({}));if((typeof a.detail=="string"?a.detail:a.detail&&a.detail.code||"")==="auth.session_revoked"){_showSessionRevokedModal();return}window.location.href="/";return}we=(await e.json()).items||[],window._erpEndpoints=we,an()}catch(e){console.error("load endpoints failed",e)}}window._refreshErpEndpointsCache=function(){return at()};async function nn(){const e=document.getElementById("erp-today-stats");if(e){e.innerHTML="";try{const n=await fetch("/api/erp/stats/today",{headers:{Authorization:"Bearer "+token}});if(!n.ok)return;const a=await n.json(),o=a.total||0,s=a.success||0,i=a.failed||0,r=a.auto_cnt||0;if(o===0){e.innerHTML=`<span class="erp-today-empty">${escapeHtml(t("erp-today-none"))}</span>`;return}const f=[];f.push(`<span class="erp-today-item"><strong>${o}</strong> ${escapeHtml(t("erp-today-total"))}</span>`),s>0&&f.push(`<span class="erp-today-item ok"><strong>${s}</strong> ${escapeHtml(t("erp-today-success"))}</span>`),i>0&&f.push(`<span class="erp-today-item fail"><strong>${i}</strong> ${escapeHtml(t("erp-today-failed"))}</span>`),r>0&&f.push(`<span class="erp-today-item auto"><strong>${r}</strong> ${escapeHtml(t("erp-today-auto"))}</span>`),e.innerHTML=f.join("")}catch(n){console.warn("loadErpTodayStats failed",n)}}}function an(){const e=document.getElementById("erp-endpoints-list"),n=document.getElementById("erp-status-summary"),a=document.getElementById("btn-add-endpoint");if(!e){console.warn("erp-endpoints-list 容器不存在");return}if(a&&_userInfo){const s=_userInfo.endpoints_limit;s!==-1&&we.length>=s?(a.disabled=!0,a.title=t("ep-limit-reached",{limit:s}),a.classList.add("btn-disabled-plus")):(a.disabled=!1,a.title="",a.classList.remove("btn-disabled-plus"))}if(we.length===0){e.innerHTML=`<div class="erp-empty">${escapeHtml(t("ep-list-empty"))}</div>`,n&&(n.textContent=t("auto-status-none"),n.className="auto-status-pill none");return}const o=we.some(s=>s.auto_push&&s.enabled);if(n&&(n.textContent=t("auto-status-active",{n:we.length,mode:o?t("auto-status-on"):t("auto-status-off")}),n.className="auto-status-pill "+(o?"active":"ready")),nn(),e.innerHTML=we.map(s=>{const i=s.config||{},r=escapeHtml(i.url||"");i._token_set;const f=s.enabled!==!1,l=[];s.is_default&&l.push(`<span class="ep-badge default">${escapeHtml(t("ep-default"))}</span>`),s.auto_push&&l.push(`<span class="ep-badge auto">${escapeHtml(t("ep-auto-push-on"))}</span>`),f||l.push(`<span class="ep-badge disabled">${escapeHtml(t("ep-disabled"))}</span>`);const d=[];return s.success_count>0&&d.push(`<span class="ep-stat ok">${escapeHtml(t("ep-success",{n:s.success_count}))}</span>`),s.failure_count>0&&d.push(`<span class="ep-stat fail">${escapeHtml(t("ep-failure",{n:s.failure_count}))}</span>`),`
        ...
        `}).join(""),_userInfo&&_userInfo.endpoints_limit!==-1){const s=we.length,i=_userInfo.endpoints_limit,r=_userInfo.plan,f=document.createElement("div");f.className="erp-limit-hint",r==="free"?f.innerHTML=`${escapeHtml(t("ep-free-limit-hint",{used:s,limit:i}))} <a data-upgrade="plus">${escapeHtml(t("upgrade-to-plus"))}</a>`:f.textContent=t("ep-plus-limit-hint",{used:s,limit:i}),e.appendChild(f)}}function Aa(e){Ne=e||null;const n=document.getElementById("endpoint-modal"),a=document.getElementById("endpoint-modal-title");a.textContent=e?t("ep-modal-title-edit"):t("ep-modal-title-new");const o=document.getElementById("ep-name"),s=document.getElementById("ep-url"),i=document.getElementById("ep-token"),r=document.getElementById("ep-is-default"),f=document.getElementById("ep-auto-push"),l=document.getElementById("ep-test-result");l.style.display="none",l.textContent="";const d=document.getElementById("ep-save-error");if(d&&d.remove(),e){const p=we.find(u=>u.id===e);if(!p)return;o.value=p.name||"",s.value=(p.config||{}).url||"",i.value=(p.config||{})._token_set&&p.config.token||"",i.placeholder=(p.config||{})._token_set?"（已保存 · 留空保持不变）":t("ep-token-ph"),r.checked=!!p.is_default,f.checked=!!p.auto_push}else o.value="",s.value="",i.value="",i.placeholder=t("ep-token-ph"),r.checked=we.length===0,f.checked=!0;const c=f.closest(".form-switch-row");if(f.disabled=!1,c){c.classList.remove("disabled-plus"),c.title="",c.style.cursor="",c.onclick=null;const p=c.querySelector(".plus-badge");p&&p.remove()}n.style.display="",setTimeout(()=>o.focus(),50)}function on(){document.getElementById("endpoint-modal").style.display="none",Ne=null;const e=document.getElementById("ep-save-error");e&&e.remove()}function sn(e){if(!e)return"";let n=e.trim();const a=n.search(/\s/);return a>=0&&(n=n.slice(0,a)),n}function rn(){const e=document.getElementById("ep-name").value.trim(),n=sn(document.getElementById("ep-url").value),a=document.getElementById("ep-token").value,o=document.getElementById("ep-is-default").checked,s=document.getElementById("ep-auto-push").checked,i={url:n};return a&&(i.token=a),{name:e,url:n,tokenVal:a,isDefault:o,autoPush:s,config:i}}async function ja(){const{url:e,config:n}=rn(),a=document.getElementById("ep-test-result");if(!e){a.style.display="",a.className="form-test-result fail",a.textContent=t("ep-required");return}a.style.display="",a.className="form-test-result running",a.textContent=t("ep-test-running");try{const s=await(await fetch("/api/erp/test-connection",{method:"POST",headers:{Authorization:"Bearer "+token,"Content-Type":"application/json"},body:JSON.stringify({adapter:"webhook",config:n})})).json();s.success?(a.className="form-test-result ok",a.textContent=t("ep-test-ok",{status:s.http_status,ms:s.elapsed_ms})):(a.className="form-test-result fail",a.textContent=t("ep-test-fail",{err:s.error_msg||"unknown"}))}catch(o){a.className="form-test-result fail",a.textContent=t("ep-test-fail",{err:o.message})}}async function Pa(){const e=rn(),n=document.getElementById("ep-save-error");if(n&&(n.style.display="none"),!e.name||!e.url){Mt(t("ep-required"));return}const a={name:e.name,adapter:"webhook",config:e.config,is_default:e.isDefault,auto_push:e.autoPush},o=document.getElementById("btn-ep-save"),s=o.innerHTML;o.disabled=!0,o.classList.add("loading");try{let i;if(Ne?i=await fetch(`/api/erp/endpoints/${encodeURIComponent(Ne)}`,{method:"PATCH",headers:{Authorization:"Bearer "+token,"Content-Type":"application/json"},body:JSON.stringify(a)}):i=await fetch("/api/erp/endpoints",{method:"POST",headers:{Authorization:"Bearer "+token,"Content-Type":"application/json"},body:JSON.stringify(a)}),!i.ok){const f=(await i.json().catch(()=>({}))).detail||`HTTP ${i.status}`;throw new Error(typeof f=="string"?f:JSON.stringify(f))}on(),showToast(t("ep-save-ok")),at()}catch(i){Mt(`${t("ep-save-fail")} · ${i.message||"unknown"}`)}finally{o.disabled=!1,o.classList.remove("loading"),o.innerHTML=s}}function Mt(e){let n=document.getElementById("ep-save-error");if(!n){const a=document.querySelector("#endpoint-modal .modal-foot");if(!a)return;n=document.createElement("div"),n.id="ep-save-error",n.className="ep-inline-error",a.parentNode.insertBefore(n,a)}n.textContent=e,n.style.display=""}async function Da(e){const n=we.find(o=>o.id===e);if(!(!n||!await showConfirm(t("ep-delete-confirm",{name:n.name}),{danger:!0})))try{if(!(await fetch(`/api/erp/endpoints/${encodeURIComponent(e)}`,{method:"DELETE",headers:{Authorization:"Bearer "+token}})).ok)throw new Error;showToast(t("ep-delete-ok")),at()}catch{showToast(t("ep-save-fail"),"fail")}}window.loadErpEndpoints=at;window.loadErpTodayStats=nn;window.renderErpEndpointsList=an;window.openEndpointModal=Aa;window.closeEndpointModal=on;window.saveEndpoint=Pa;window.deleteEndpoint=Da;window.testEndpointConnection=ja;window._sanitizeUrl=sn;async function ln(e){if(e=(e||"").trim(),!!e)try{await navigator.clipboard.writeText(e),showToast(t("erp-doc-copy-ok",{no:e}),"success")}catch{try{const a=document.createElement("textarea");a.value=e,a.style.position="fixed",a.style.opacity="0",document.body.appendChild(a),a.select(),document.execCommand("copy"),a.remove(),showToast(t("erp-doc-copy-ok",{no:e}),"success")}catch{showToast(t("erp-doc-copy-fail"),"error")}}}async function qa(e){const n=document.createElement("div");n.className="log-detail-modal",n.innerHTML=`
        <div class="log-detail-box">
            <div class="log-detail-loading">${escapeHtml(t("log-detail-loading"))}</div>
        </div>
    `,document.body.appendChild(n),n.addEventListener("click",async a=>{if(a.target===n||a.target.classList.contains("log-detail-close")){n.remove();return}const o=a.target.closest("[data-receipt-copy]");if(o){ln(o.dataset.receiptCopy);return}const s=a.target.closest("[data-receipt-action]");if(s){const i=s.dataset.receiptAction;i==="retry"?window.retryPushLog(s.dataset.logId):i==="exceptions"?typeof routeTo=="function"&&routeTo("exceptions"):i==="mappings"&&typeof routeTo=="function"&&routeTo("integrations"),n.remove();return}});try{const a=await fetch(`/api/erp/logs/${encodeURIComponent(e)}`,{headers:{Authorization:"Bearer "+token}});if(!a.ok){n.remove();return}const o=await a.json(),s=window._erpEndpoints.find(C=>C.id===o.endpoint_id),i=o.endpoint_name||(s?s.name:o.endpoint_id?t("erp-log-endpoint-deleted"):"-"),r=(o.endpoint_adapter||s&&s.adapter||"").toLowerCase(),f=new Date(o.created_at).toLocaleString(),l=o.trigger==="auto"?t("log-tag-auto"):o.trigger==="retry"?t("log-tag-retry"):t("log-tag-manual"),d=o.request_body?JSON.stringify(o.request_body,null,2):t("erp-receipt-no-tech"),c=o.response_body||t("erp-receipt-no-tech"),p=o.status==="success";let u=typeof c=="string"?c:JSON.stringify(c,null,2);if(p)try{const C=typeof o.response_body=="string"?JSON.parse(o.response_body):o.response_body||{},D=C.row_count||(Array.isArray(C.imported_rows)?C.imported_rows.length:0);D>0&&(u=t("log-push-rows").replace("{n}",String(D)))}catch{}const v=(o.external_doc_no||"").trim(),_=(o.external_url||"").trim(),M=(o.external_doc_hint||"").trim(),I=(o.ocr_buyer_name||"").trim()||o.client_name||"-",x=o.seller_name||"-";let b="-";const $=Number(o.total_amount);o.total_amount!=null&&o.total_amount!==""&&!isNaN($)&&(b=$.toLocaleString("en-US",{minimumFractionDigits:2,maximumFractionDigits:2}));const S=p?t("erp-receipt-title-ok"):t("erp-receipt-title-fail"),F=p?"✓":"✗",j=[],w=(C,D)=>{j.push(`
                <div class="erp-receipt-row">
                    <span class="erp-receipt-key">${escapeHtml(C)}</span>
                    <span class="erp-receipt-val">${D}</span>
                </div>`)};if(w(t("erp-receipt-invoice-no"),`<strong>${escapeHtml(o.invoice_no||"-")}</strong>`),w(t("erp-receipt-erp-name"),escapeHtml(i)),p){let C;v?C=`<strong class="erp-receipt-docno">${escapeHtml(v)}</strong><button class="erp-receipt-copy-btn" type="button" data-receipt-copy="${escapeHtml(v)}" title="${escapeHtml(t("erp-doc-copy-tip"))}">${escapeHtml(t("erp-receipt-copy-btn"))}</button>`:C=`<span class="erp-receipt-docno-missing">${escapeHtml(t("erp-log-doc-missing"))}</span>`,w(t("erp-receipt-doc-no"),C)}w(t("erp-receipt-client"),escapeHtml(I)),w(t("erp-receipt-seller"),escapeHtml(x)),p&&w(t("erp-receipt-amount"),escapeHtml(b)),w(t("erp-receipt-time"),escapeHtml(f)),w(t("erp-receipt-elapsed"),escapeHtml((o.elapsed_ms!=null?o.elapsed_ms:"-")+"ms"));let h="";p&&_?h=`<a class="erp-receipt-primary-btn" href="${escapeHtml(_)}" target="_blank" rel="noopener">${escapeHtml(t("erp-receipt-open-erp"))}</a>`:p&&v&&(h=`<button class="erp-receipt-primary-btn" type="button" data-receipt-copy="${escapeHtml(v)}">${escapeHtml(t("erp-receipt-copy-docno"))}</button>`);let y="";if(p&&v&&M){const C="erp-receipt-hint-"+M,D=t(C);D&&D!==C&&(y=`<div class="erp-receipt-hint"><svg class="erp-receipt-hint-ic" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><circle cx="12" cy="12" r="9"/><line x1="12" y1="11" x2="12" y2="16"/><line x1="12" y1="8" x2="12.01" y2="8"/></svg><span>${escapeHtml(D)}</span></div>`)}let L="";if(!p){const C=(o.error_msg||"").match(/ERR_[A-Z0-9_]+/),D=C?C[0]:"",B=typeof currentLang=="string"&&currentLang||window._currentLang||"th",J=o.error_friendly&&o.error_friendly[B]||(o.error_msg?humanizeError(o.error_msg):t("erp-receipt-no-error")),G=/ERR_NO_CUSTOMER_MAPPING|ERR_NO_CLIENT|ERR_NO_SEED_CUSTOMER|ERR_NO_SEED_PRODUCT/.test(o.error_msg||""),W=!!(o.history_id&&o.endpoint_id),te=[];te.push(`<button class="erp-receipt-action-btn" type="button" data-receipt-action="exceptions">${escapeHtml(t("erp-receipt-act-exceptions"))}</button>`),G&&te.push(`<button class="erp-receipt-action-btn" type="button" data-receipt-action="mappings">${escapeHtml(t("erp-receipt-act-mapping"))}</button>`),W&&te.push(`<button class="erp-receipt-action-btn primary" type="button" data-receipt-action="retry" data-log-id="${escapeHtml(o.id)}">${escapeHtml(t("erp-receipt-act-retry"))}</button>`),L=`
        ...
        `,document.body.appendChild(v);const _=()=>v.remove();v.querySelector("#cpw-forgot-close").addEventListener("click",_),v.querySelector("#cpw-forgot-cancel").addEventListener("click",_),v.addEventListener("click",M=>{M.target===v&&_()}),v.querySelector("#cpw-forgot-send").addEventListener("click",async()=>{const M=v.querySelector("#cpw-forgot-send"),I=v.querySelector("#cpw-forgot-msg");M.disabled=!0;const x=M.textContent;M.textContent=a("cpw-forgot-sending");try{const b=await fetch("/api/auth/forgot_password",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:p})}),$=await b.json().catch(()=>({}));b.ok?(I.textContent=a("cpw-forgot-success"),I.className="cpw-forgot-msg success",M.style.display="none",v.querySelector("#cpw-forgot-cancel").textContent=a("cpw-forgot-close-btn")):(I.textContent=$.detail||a("cpw-forgot-fail"),I.className="cpw-forgot-msg error",M.disabled=!1,M.textContent=x)}catch{I.textContent=a("cpw-forgot-fail"),I.className="cpw-forgot-msg error",M.disabled=!1,M.textContent=x}})}function l(c){if(!c||!c.includes("@"))return c||"";const[p,u]=c.split("@");return p.length<=2?p+"****@"+u:p.slice(0,2)+"****@"+u}function d(c){return c==null?"":String(c).replace(/[&<>"']/g,p=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[p])}document.readyState==="complete"||document.readyState==="interactive"?r():document.addEventListener("DOMContentLoaded",r)})();(function(){let e=null,n=!1;async function a(){if(n)return;const s=localStorage.getItem("mrpilot_token");if(s){n=!0;try{const i=await fetch("/api/me",{headers:{Authorization:"Bearer "+s},cache:"no-store"});if(i.status===401){const r=await i.json().catch(()=>({})),f=r&&r.detail;let l="";if(typeof f=="string"?l=f:f&&typeof f=="object"&&(l=f.code||""),console.warn("[heartbeat] session revoked",l),localStorage.removeItem("mrpilot_token"),e&&(clearInterval(e),e=null),l==="auth.session_revoked")try{_showSessionRevokedModal()}catch{window.location.href="/"}else{const d=l==="auth.password_changed_relogin"?"alert-password-changed-relogin":"alert-session";try{typeof showToast=="function"&&typeof t=="function"?showToast(t(d),"error"):alert("Session expired")}catch{}setTimeout(()=>{window.location.href="/"},1500)}}}catch{}finally{n=!1}}}function o(){e&&clearInterval(e),e=setInterval(a,15e3)}localStorage.getItem("mrpilot_token")&&o(),window.addEventListener("focus",a),document.addEventListener("visibilitychange",function(){document.hidden||a()}),window._sessionCheck=a})();async function ot(){const e=document.getElementById("team-loading"),n=document.getElementById("team-list"),a=document.getElementById("team-empty"),o=document.getElementById("team-count");if(n){e&&(e.style.display=""),n.style.display="none",a&&(a.style.display="none");try{const s=await apiGet("/api/team/employees"),i=s&&s.employees||[];if(e&&(e.style.display="none"),o&&(o.textContent=(t("team-count")||"共 {n} 名员工").replace("{n}",i.length)),i.length===0){a&&(a.style.display="");return}n.style.display="",n.innerHTML=i.map(r=>{const f=r.last_login_at?new Date(r.last_login_at).toLocaleDateString():t("team-never-login")||"从未登录",l=r.is_active===!1?"team-status-off":"team-status-on",d=r.is_active===!1?t("team-status-disabled")||"已禁用":t("team-status-active")||"正常",c=r.email?`<span class="team-meta-sep">·</span><span>${escapeHtml(r.email)}</span>`:"";return`
            ...
            </div>`}).join("")}catch(s){console.error("loadTeamList failed:",s),e&&(e.textContent=t("team-load-failed")||"加载失败")}}}async function Ra(){document.querySelectorAll(".add-emp-overlay").forEach(o=>o.remove());const e=document.createElement("div");e.className="add-emp-overlay",e.innerHTML=`
