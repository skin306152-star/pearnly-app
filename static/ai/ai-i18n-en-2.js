...
Object.assign(window.__AI_I18N_EN__, {
    ...
    riq_signoff_stale: 'Figures were regenerated after your review — please review again.',
    ...
    riq_code_copy: 'Copy error code',
    riq_code_copied: 'Copied',
    ...
    pkg_signoff_stale: 'Figures were regenerated after your review — please review again.',
    ...
    purge_open_btn: 'Clear data',
    purge_title: 'Clear entity data',
    purge_hint: 'Pick one entity and wipe all of its data. Only the name and tax ID are kept.',
    purge_no_client: 'No entities yet',
    purge_no_tax: 'No tax ID',
    purge_cancel: 'Cancel',
    purge_next: 'Next',
    purge_back: 'Back',
    ...
    intake_excluded_title: '{n} excluded items',
    intake_excluded_assign: 'Reclassify item',
    intake_excluded_keep: 'Keep excluded',
    intake_excluded_bank: 'Bank statement',
    intake_excluded_purchase: 'Purchase invoice',
    intake_excluded_sales: 'Sales document',
    intake_excluded_reason_payment: 'Recognized as payment evidence',
    intake_excluded_reason_duplicate: 'Recognized as a duplicate',
    intake_excluded_reason_other: 'Recognized as outside this filing period',
    ...
    bill_title: 'OCR credit balance',
    bill_balance_label: 'Balance',
    bill_month_label: 'Used this month',
    bill_pages_fmt: '{n} pages',
    bill_rate_label: 'Current rate',
    bill_rate_fmt: '{r} / page',
    ...
    bill_history_empty_s: 'Tap "Top up" above — three steps and you are done',
    bill_st_pending: 'Pending review',
    bill_st_approved: 'Credited',
    bill_st_rejected: 'Rejected',
    bill_topup_title: 'Top up',
    bill_step1: 'Amount',
    bill_step2: 'Transfer',
    bill_step3: 'Slip',
    bill_amt_label: 'Amount (THB)',
    bill_amt_ph: 'Enter amount',
    bill_amt_invalid: 'Enter an amount of ฿\u200910 or more',
    bill_amt_max: 'Maximum ฿\u2009500,000 per top-up',
    bill_bank_label: 'Transfer to this account',
    bill_copy: 'Copy account no.',
    bill_copied: 'Copied',
    bill_bank_note: 'Transfer exactly {amount} — a matching amount is credited automatically',
    bill_slip_drop: 'Click or drop the transfer slip (image / PDF)',
    bill_slip_required: 'Please upload the transfer slip first',
    bill_payer_label: 'Payer name (optional)',
    bill_note_label: 'Note (optional)',
    bill_btn_next: 'Next',
    bill_btn_back: 'Back',
    bill_btn_cancel: 'Cancel',
    bill_btn_submit: 'Submit slip',
    bill_btn_close: 'Close',
    bill_uploading: 'Uploading…',
    bill_req_fail: 'Could not submit, please try again',
    bill_upload_fail: 'Upload failed, please try again',
    bill_auto_ok: 'Slip verified — balance updated',
    bill_manual: 'Slip received — credited after manual review',
});
