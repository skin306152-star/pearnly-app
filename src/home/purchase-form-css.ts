...
.pur .btn.full{width:100%;} .pur .btn.ghost{border-style:dashed;color:var(--blue);} .pur .btn.sm{height:34px;font-size:12.5px;flex:1;}
.pur .wsbar{background:var(--blue-l);border:1px solid #bfdbfe;border-radius:10px;padding:9px 13px;font-size:12.5px;color:#1e40af;margin-bottom:14px;}
.pur .wsbar .link{color:var(--blue-d);font-weight:700;cursor:pointer;text-decoration:underline;}
.pur .dupbar{background:#fef2f2;border:1px solid #fecaca;border-radius:10px;padding:9px 13px;font-size:12.5px;color:#b91c1c;margin-bottom:14px;}
...
.pur .inp{min-height:40px;border:1px solid var(--line);border-radius:10px;display:flex;align-items:center;padding:7px 12px;font-size:13.5px;background:#fff;}
.pur .inp.pick{cursor:pointer;justify-content:space-between;} .pur .inp.ro{background:#fafaf8;font-weight:700;} .pur .inp.ph{color:var(--ink3);}
.pur .inp.ai{border-color:#bbf7d0;background:#f0fdf4;} .pur .inp.todo{border-color:#fde68a;background:#fffbeb;}
...
.pur .seg .o.on{border-color:var(--blue);background:var(--blue-l);color:var(--blue-d);font-weight:700;}
.pur .seg.sm2 .o{height:34px;font-size:12px;}
.pur .aimark{font-size:10.5px;background:#dcfce7;color:#15803d;padding:1px 7px;border-radius:5px;margin-left:6px;font-weight:600;}
.pur .hint{background:#fffbeb;border:1px solid #fde68a;border-radius:9px;padding:8px 11px;font-size:12px;color:#b45309;margin-bottom:10px;}
...
.pur .docchip .pdf{background:#fee2e2;color:#dc2626;font-size:10px;font-weight:700;padding:2px 6px;border-radius:5px;}
...
.pur .iextra .link{color:var(--blue);cursor:pointer;}
.pur .pill{font-size:10.5px;padding:1px 7px;border-radius:5px;}
.pur .pill.ok{background:#dcfce7;color:#15803d;} .pur .pill.warn{background:#fef3c7;color:#b45309;}
