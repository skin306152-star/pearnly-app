...
`,e.dataset.wbInjected="1";try{const n=window._currentLang||localStorage.getItem("mrpilot_lang")||"th",a=window.I18N;a&&a[n]&&(e.querySelectorAll("[data-i18n]").forEach(o=>{const s=o.getAttribute("data-i18n");a[n][s]&&(o.textContent=a[n][s])}),e.querySelectorAll("[data-i18n-placeholder]").forEach(o=>{const s=o.getAttribute("data-i18n-placeholder");a[n][s]&&(o.placeholder=a[n][s])}))}catch{}}})();(function(){const e=document.getElementById("page-settings");if(!(!e||e.dataset.wbInjected==="1")){e.innerHTML=`
        ...
        <!-- /settings-layout -->
`,e.dataset.wbInjected="1";try{const n=window._currentLang||localStorage.getItem("mrpilot_lang")||"th",a=window.I18N;a&&a[n]&&(e.querySelectorAll("[data-i18n]").forEach(o=>{const s=o.getAttribute("data-i18n");a[n][s]&&(o.textContent=a[n][s])}),e.querySelectorAll("[data-i18n-placeholder]").forEach(o=>{const s=o.getAttribute("data-i18n-placeholder");a[n][s]&&(o.placeholder=a[n][s])}))}catch{}}})();const Gs=`
        <div class="page-head-clean">
            <div class="page-head-icon">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
...
`,Ks=`                    <!-- Tab: 邮箱抓取 (v0.17 · M6 · v93 在 Vultr 复活) -->
...
`;(function(){const e=document.getElementById("page-automation");if(!(!e||e.dataset.wbInjected==="1")){e.innerHTML=Gs+Ks,e.dataset.wbInjected="1";try{const n=window._currentLang||localStorage.getItem("mrpilot_lang")||"th",a=window.I18N;a&&a[n]&&(e.querySelectorAll("[data-i18n]").forEach(o=>{const s=o.getAttribute("data-i18n");s&&a[n][s]&&(o.textContent=a[n][s])}),e.querySelectorAll("[data-i18n-placeholder]").forEach(o=>{const s=o.getAttribute("data-i18n-placeholder");s&&a[n][s]&&(o.placeholder=a[n][s])}))}catch{}}})();(function(){const e={"page-integration":`
        <div class="coming-soon">
            <svg class="cs-icon" viewBox="0 0 48 48" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
...
`,e.dataset.wbInjected="1";try{const n=window._currentLang||localStorage.getItem("mrpilot_lang")||"th",a=window.I18N;a&&a[n]&&e.querySelectorAll("[data-i18n]").forEach(o=>{const s=o.getAttribute("data-i18n");a[n][s]&&(o.textContent=a[n][s])})}catch{}}})();function Js(e,n){const a=document.getElementById("alert-"+e);a&&(document.getElementById("alert-"+e+"-text").textContent=n,a.classList.add("show"))}function Ws(){["info","warn","error"].forEach(e=>{document.getElementById("alert-"+e).classList.remove("show")})}function Ys(e,n){if(e==null)return n||"操作失败";if(typeof e=="string")return e;if(Array.isArray(e)){const a=e[0]||{};return a.msg?a.msg:n||"请求格式错误"}if(typeof e=="object"){if(e.code){const a="err."+e.code;try{const o=t(a,e);if(o&&o!==a)return o}catch(o){console.warn("[i18n] t() failed for key:",a,o)}return e.code}if(e.message)return e.message;if(e.error)return e.error;if(e.detail&&typeof e.detail=="string")return e.detail;try{return JSON.stringify(e).slice(0,160)}catch{}}return n||String(e)}function Xs(e){if(!e)return"";const n=String(e);return/ECONNREFUSED|Connection refused/i.test(n)?"连接被拒绝 · ERP 地址可能错了,或服务没启动":/listing fetch failed|wait_for_selector/i.test(n)?"拉取 MR.ERP 客户/商品列表超时 · 已重试 3 次仍不通 · 可能 MR.ERP 响应慢 · 稍后再试":/ETIMEDOUT|timeout/i.test(n)?"连接超时 · MR.ERP 响应慢 · 稍后再试":/ENOTFOUND|getaddrinfo/i.test(n)?"域名解析失败 · ERP 地址拼错了":/certificate|SSL/i.test(n)?"SSL 证书问题 · ERP 站点证书异常":/401|Unauthorized/i.test(n)?"HTTP 401 · 认证失败,检查 Token 是否正确":/403|Forbidden/i.test(n)?"HTTP 403 · 权限不足,ERP 拒绝访问":/404|Not Found/i.test(n)?"HTTP 404 · URL 路径不存在":/^5\d\d/.test(n)||/500|502|503|504/.test(n)?"ERP 服务器错误 · 不是你的问题,等会儿再试":n}function Zs(e,n,a){let o=document.getElementById("mp-toast-wrap");o||(o=document.createElement("div"),o.id="mp-toast-wrap",document.body.appendChild(o)),n=n||"success",n==="ok"&&(n="success"),n==="warning"&&(n="warn"),n==="danger"&&(n="error");const s={success:'<path d="M3 8l3 3 7-7"/>',error:'<circle cx="8" cy="8" r="6"/><path d="M5.5 5.5l5 5M10.5 5.5l-5 5"/>',warn:'<path d="M8 2L1.5 13h13L8 2z"/><path d="M8 7v3M8 12v.01"/>',info:'<circle cx="8" cy="8" r="6"/><path d="M8 5.5v.01M8 8v3"/>',loading:'<path d="M8 1a7 7 0 017 7" stroke-linecap="round" class="mp-toast-spin"/>'},i=document.createElement("div");i.className="mp-toast "+n,i.innerHTML=`
    ...
    `,o.appendChild(i),requestAnimationFrame(()=>i.classList.add("show"));const r=typeof a=="number"?a:2500;let c=null;const f=()=>{c&&(clearTimeout(c),c=null),i.classList.remove("show"),setTimeout(()=>{try{i.remove()}catch{}},300)};return r>0&&(c=setTimeout(f,r)),f}window.showAlert=Js;window.hideAlerts=Ws;window._humanizeBackendError=Ys;window.humanizeError=Xs;window.showToast=Zs;function Qs(e,n){return n=n||{},new Promise(a=>{const o=document.getElementById("confirm-modal"),s=document.getElementById("confirm-modal-body"),i=document.getElementById("confirm-modal-ok"),r=document.getElementById("confirm-modal-cancel"),c=document.getElementById("confirm-modal-close"),f=document.getElementById("confirm-modal-title");if(!o||!s||!i||!r){a(!1);return}f.textContent=n.title||t("confirm-default-title");const d=n.promptInput?"cm_in_"+Date.now():null;if(n.promptInput){const m=(e||"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;"),v=(n.placeholder||"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;");s.innerHTML=`
        ...
        `;const o=document.getElementById("api-key-card");o&&(o.style.display="");return}oi(n,e);const a=document.getElementById("api-key-card");if(a){const o=tt==="byo_api"||_userInfo&&_userInfo.is_super_admin;a.style.display=o?"":"none"}}function oi(e,n){const a=escapeHtml(e.username||e.email||"");n.innerHTML=`
        <table style="width:100%; font-size:13px; border-collapse: collapse;">
            <tr>
    ...
    `}window.switchSettingsTab=ei;window.fillSettingsForms=ti;window.saveProfile=ni;window.saveCompany=ai;window.renderSettings=Dn;function vn(e){return e=e||_userInfo,!!(e&&e.is_super_admin)}function Yn(e){return e=e||_userInfo,!!e&&(e.role==="owner"||vn(e))}function wo(e){return e=e||_userInfo,!!e&&e.role==="member"&&!vn(e)}function si(e){return e=e||_userInfo,!!e&&(e.effective_plan==="trial"||e.plan==="trial")&&!vn(e)}function ko(e){return e=e||_userInfo,!!e&&e.tenant_type==="byo_api"}function xo(e){return wo(e)}function ii(e){return Yn(e)}function ri(e){return Yn(e)&&ko(e)}window.isMoneyHidden=xo;window.isSuperAdmin=vn;window.isOwner=Yn;window.isEmployee=wo;window.isTrial=si;window.isLifetime=ko;window.shouldHideMoney=xo;window.canManageTeam=ii;window.canManageApiKey=ri;function li(){const e=document.getElementById("quota-banner");if(!e)return;if(!_userInfo){e.style.display="none";return}if(_userInfo.is_super_admin||_userInfo.tenant_type==="admin"||_userInfo.tenant_type==="byo_api"){e.style.display="none";return}let n=0,a=0;if(_userInfo.plan==="free"&&_quota&&_quota.ip_daily_limit)n=_quota.ip_used_today||0,a=_quota.ip_daily_limit;else if(_userInfo.tenant_quota!=null&&_userInfo.tenant_quota>0)n=_userInfo.tenant_used||0,a=_userInfo.tenant_quota;else if(_userInfo.monthly_quota&&_userInfo.monthly_quota>0)n=_userInfo.used_this_month||0,a=_userInfo.monthly_quota;else{e.style.display="none";return}if(a<=0){e.style.display="none";return}const o=Math.max(0,a-n),s=n/a*100,i="quota_banner_dismiss_"+new Date().toISOString().slice(0,10);if(localStorage.getItem(i)){e.style.display="none";return}let r,c;if(o===0)r="danger",c=t("quota-banner-exhausted");else if(s>=90)r="danger",c=t("quota-banner-very-low",{n:o});else if(s>=70)r="warn",c=t("quota-banner-low",{n:o});else{e.style.display="none";return}e.className="quota-banner "+r,e.innerHTML=`
    ...
    `,e.style.display="flex";const f=e.querySelector(".quota-banner-close");f&&f.addEventListener("click",()=>{localStorage.setItem(i,"1"),e.style.display="none"})}function ci(){const e=_userInfo;if(!e)return;const n=shouldHideMoney(e),a=canManageTeam(e),o=canManageApiKey(e),s=document.querySelector('.nav-item[data-route="templates"]');s&&(s.classList.remove("locked-for-plan"),s.removeAttribute("data-locked-target"));const i=document.querySelector('.nav-item[data-route="api-keys"]');i&&(i.classList.remove("locked-for-plan"),i.removeAttribute("data-locked-target"));const r=document.getElementById("btn-custom-template");r&&(r.style.display="",r.classList.remove("locked-for-plan"));const c=document.querySelector('.settings-tab[data-tab="team"]');c&&(c.style.display=a?"":"none");const f=document.querySelector('.settings-panel[data-settings-panel="team"]');f&&(f.dataset.permHidden=a?"0":"1");const d=document.querySelector('.settings-tab[data-tab="api"]');d&&(d.style.display=o||isSuperAdmin(e)?"":"none");const u=document.querySelector('.settings-tab[data-tab="plan"]');u&&(u.style.display=n?"none":"");const l=document.querySelector('.settings-tab[data-tab="company"]');l&&(l.style.display=n?"none":"");const p=document.getElementById("info-bar");p&&(p.style.display=n?"none":"");const m=document.getElementById("trial-banner");m&&n&&(m.style.display="none");const v=document.getElementById("plan-banner");v&&n&&(v.style.display="none",document.body.classList.remove("has-plan-banner")),document.querySelectorAll("[data-upgrade-cta], .btn-upgrade, .topbar-upgrade").forEach(w=>{w.style.display="none"}),document.body.classList.toggle("role-employee",isEmployee(e)),document.body.classList.toggle("role-owner",isOwner(e)),document.body.classList.toggle("role-super",isSuperAdmin(e));try{const w=document.querySelector(".settings-tab.active");w&&w.style.display==="none"&&(typeof window.switchSettingsTab=="function"?window.switchSettingsTab("profile"):typeof switchSettingsTab=="function"&&switchSettingsTab("profile"))}catch(w){console.warn("[v118.12.3] failed to fix active tab:",w)}if(window.PEARNLY_ADMIN_MODE){const w=document.getElementById("admin-mode-banner");w&&(w.style.display="flex"),document.querySelectorAll(".nav-item").forEach(h=>{h.classList.contains("nav-admin-only")||(h.style.display="none")}),document.querySelectorAll(".nav-group").forEach(h=>{h.classList.contains("nav-group-admin-only")||(h.style.display="none")});const b=document.getElementById("client-switcher");b&&(b.style.display="none"),document.body.classList.add("admin-mode");const g=["profile","security","notifications","about"];document.querySelectorAll(".settings-tab").forEach(h=>{const _=h.dataset.tab;_&&!g.includes(_)&&(h.style.display="none")}),document.querySelectorAll(".settings-pane").forEach(h=>{const _=h.dataset.pane;_&&!g.includes(_)&&(h.style.display="none")}),document.querySelectorAll(".settings-nav-group").forEach(h=>{const _=h.querySelectorAll(".settings-tab");Array.from(_).some(k=>k.style.display!=="none")||(h.style.display="none")})}}function di(){const e=_userInfo,n=document.getElementById("info-bar");if(!e||shouldHideMoney(e)){n&&(n.innerHTML="");return}let a="";const o=e.tenant_type;if(o==="byo_api")e.has_own_gemini_key?a=`
        ...
        `;else{const s=e.tenant_used!=null?e.tenant_used:e.used_this_month||0,i=e.tenant_quota!=null&&e.tenant_quota>0?e.tenant_quota:e.monthly_quota||0,r=i>0?Math.min(100,s/i*100):0;let c="";r>=95?c="danger":r>=80&&(c="warn"),i>0?a=`
            ...
            `:a=""}n&&(n.innerHTML=a)}window.renderQuotaBanner=li;window.applySidebarVisibility=ci;window.renderInfoBar=di;async function _o(e,n){try{const a=await fetch(e,{method:"POST",headers:{Authorization:"Bearer "+token,"Content-Type":"application/json"},body:JSON.stringify(n)});if(a.status===401){localStorage.removeItem("mrpilot_token");const o=await a.json().catch(()=>({}));return(typeof o.detail=="string"?o.detail:o.detail&&o.detail.code||"")==="auth.session_revoked"?(_showSessionRevokedModal(),null):(window.location.href="/",null)}return await a.json()}catch{return{ok:!1,error:"network"}}}function Eo(e){return{invalid_format:"rd-err-format",not_found:"rd-err-not-found",rd_unreachable:"rd-err-unreachable",parse_error:"rd-err-unknown",network:"rd-err-unreachable"}[e]||"rd-err-unknown"}function tn(e){const n=document.querySelector(`[data-field="${e}"]`);return n?(n.value||"").trim():""}function Ze(e,n,a){const o=document.querySelector(`[data-rd-status="${e}"]`);o&&(o.innerHTML=n,o.className="rd-status"+(a?" "+a:""))}async function pi(e){const a=tn(e==="seller"?"seller_tax":"buyer_tax");Ze(e,t("rd-verifying"),"loading");const o=await _o("/api/rd/verify",{tax_id:a});if(!o)return;if(!o.ok){Ze(e,t(Eo(o.error)),"error");return}o.data&&o.data.valid?Ze(e,`<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="2"><path d="M3 8l3 3 7-7"/></svg> ${escapeHtml(t("rd-status-valid"))}`,"valid"):Ze(e,t("rd-status-invalid"),"invalid")}async function ui(e){const a=tn(e==="seller"?"seller_tax":"buyer_tax");Ze(e,t("rd-syncing"),"loading");const o=await _o("/api/rd/lookup",{tax_id:a,branch:0});if(o){if(!o.ok){Ze(e,t(Eo(o.error)),"error");return}Ze(e,`<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="2"><path d="M3 8l3 3 7-7"/></svg> ${escapeHtml(t("rd-status-valid"))}`,"valid"),mi(e,o.data)}}function mi(e,n){const a=e==="seller"?"seller_name":"buyer_name",o=e==="seller"?"seller_addr":"buyer_addr",s=tn(a),i=tn(o),r=[];n.name&&n.name!==s&&r.push({field:a,label:t("rd-field-name"),current:s,official:n.name}),n.address&&n.address!==i&&r.push({field:o,label:t("rd-field-address"),current:i,official:n.address});const c=[];n.branch_label&&c.push(`<strong>${t("rd-field-branch")}:</strong> ${escapeHtml(n.branch_label)}`),n.post_code&&c.push(`<strong>${t("rd-field-postcode")}:</strong> ${escapeHtml(n.post_code)}`);let f=document.getElementById("rd-sync-modal");if(f||(f=document.createElement("div"),f.id="rd-sync-modal",f.className="rd-modal-mask",document.body.appendChild(f)),r.length===0)f.innerHTML=`
            <div class="rd-modal">
    ...
    `;let s=_results.map((r,c)=>({...r,_idx:c}));if(_searchKeyword){const r=_searchKeyword.toLowerCase();s=s.filter(c=>(c.filename||"").toLowerCase().includes(r)||(c.merged_fields.invoice_number||"").toLowerCase().includes(r))}_sortKey&&s.sort((r,c)=>{let f,d;return _sortKey==="filename"?(f=r.filename,d=c.filename):_sortKey==="invoice_no"?(f=r.merged_fields.invoice_number,d=c.merged_fields.invoice_number):_sortKey==="invoice_date"?(f=r.merged_fields.date,d=c.merged_fields.date):_sortKey==="total"?(f=parseFloat(r.merged_fields.total_amount)||0,d=parseFloat(c.merged_fields.total_amount)||0):_sortKey==="confidence"?(f=r.confidence,d=c.confidence):(f="",d=""),f<d?_sortDir==="asc"?-1:1:f>d?_sortDir==="asc"?1:-1:0});const i=document.getElementById("results-tbody");i.innerHTML=s.map((r,c)=>{const f=r.merged_fields,d=`<span class="empty-cell">${t("empty-val")}</span>`,u="conf-tip-"+(r.confidence||"low"),l="conf-"+(r.confidence||"low"),p=t(u),m=t(l);return`
        ...
        `}).join(""),document.querySelectorAll("#results-table th").forEach(r=>{r.classList.remove("sort-asc","sort-desc"),r.dataset.sort===_sortKey&&r.classList.add("sort-"+_sortDir)}),i.querySelectorAll("tr").forEach(r=>{r.addEventListener("click",()=>{const c=parseInt(r.dataset.idx,10);Lo(c)})})}document.querySelectorAll("#results-table th").forEach(e=>{e.classList.contains("no-sort")||e.addEventListener("click",()=>{const n=e.dataset.sort;_sortKey===n?_sortDir=_sortDir==="asc"?"desc":"asc":(_sortKey=n,_sortDir="asc"),hn()})});let Sa=null;document.getElementById("search-input").addEventListener("input",e=>{const n=e.target.value;document.getElementById("search-clear").style.display=n?"":"none",clearTimeout(Sa),Sa=setTimeout(()=>{_searchKeyword=n.trim(),hn(),Bo()},200)});document.getElementById("search-clear").addEventListener("click",()=>{const e=document.getElementById("search-input");e.value="",_searchKeyword="",document.getElementById("search-clear").style.display="none",hn(),Bo(),e.focus()});function Bo(){const e=document.getElementById("search-matches");if(!e)return;if(!_searchKeyword){e.textContent="";return}const n=_searchKeyword.toLowerCase();let a=0;for(const o of _results)[o.filename,o.merged_fields?.invoice_number,o.merged_fields?.seller_name,o.merged_fields?.buyer_name].filter(Boolean).join(" ").toLowerCase().includes(n)&&a++;e.textContent=t("search-matches",{n:a})}function Lo(e){_drawerIdx=e;const n=_results[e];if(!n)return;document.getElementById("drawer-title").textContent=n.filename;const a=n.engine==="cache"||n.from_cache,o=a?t("badge-cached-hint"):`${(n.elapsed_ms/1e3).toFixed(1)}s`;document.getElementById("drawer-sub").innerHTML=`
    ...
    `,d=i?"":`<span class="tax-badge unverified" data-tip="${escapeHtml(t("tax-tip-unverified"))}">${t("tax-unverified")}</span>`;if(c.innerHTML=`
        ...
        <div class="drawer-section">
            ...
            ${r.wht_amount||r.wht_rate?`
                ${ve("wht_amount","drawer-lbl-wht-amount",r.wht_amount,"input",s,gi(r.wht_rate))}
            `:""}
        </div>
        ...
        <div class="drawer-section">
            ...
            ${ve("seller_tax","drawer-lbl-tax",r.seller_tax,"input",s,d,Ta("seller"))}
        ...
        <div class="drawer-section">
            ...
            ${ve("buyer_tax","drawer-lbl-tax",r.buyer_tax,"input",s,d,Ta("buyer"))}
        ...
        <div class="drawer-section">
            ...
            ${r.items&&r.items.length>0?bi(r.items):`<div class="drawer-items-empty">${t("drawer-items-empty")}</div>`}
        </div>
...
`))}</pre>
    ...
    `}function Ta(e){return _userInfo&&_userInfo.can_verify_tax?`
    ...
    `;n.innerHTML=o+s,e.appendChild(n)}function Bn(){const e=document.getElementById("export-dropdown");e&&e.remove()}const Ln=document.getElementById("btn-export-arrow");Ln&&Ln.addEventListener("click",e=>{e.stopPropagation(),!Ln.disabled&&Ei()});document.addEventListener("click",e=>{const n=e.target.closest(".export-dd-item");if(n){const a=n.getAttribute("data-tpl");if(a==="__custom"){Bn(),showToast(t("cs-coming-soon"),"info");return}_i(a),Bn(),To(a);return}e.target.closest("#btn-export-arrow")||Bn()});function Ii(){const e=document.getElementById("btn-export-arrow"),n=document.getElementById("btn-export");e&&n&&(e.disabled=n.disabled)}setInterval(Ii,300);const Bi=`
        <div class="page-head-clean">
            <div class="page-head-icon">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
...
`;(function(){const e=document.getElementById("page-history");if(!(!e||e.dataset.wbInjected==="1")){e.innerHTML=Bi,e.dataset.wbInjected="1";try{const n=window._currentLang||localStorage.getItem("mrpilot_lang")||"th",a=window.I18N;a&&a[n]&&(e.querySelectorAll("[data-i18n]").forEach(o=>{const s=o.getAttribute("data-i18n");a[n][s]&&(o.textContent=a[n][s])}),e.querySelectorAll("[data-i18n-placeholder]").forEach(o=>{const s=o.getAttribute("data-i18n-placeholder");a[n][s]&&(o.placeholder=a[n][s])}))}catch{}}})();function Xn(){const e=document.getElementById("history-batch-bar"),n=document.getElementById("history-batch-count"),a=document.getElementById("history-check-all");if(!e||!n)return;const o=_historySelected.size;if(o>0?(e.style.display="",n.textContent=t("history-batch-count",{n:o})):e.style.display="none",a){const s=_historyState.items||[];if(s.length===0)a.checked=!1,a.indeterminate=!1;else{const i=s.filter(r=>_historySelected.has(r.id)).length;a.checked=i===s.length,a.indeterminate=i>0&&i<s.length}}}function Li(){_historySelected.clear(),Xn()}async function Zn(){if(!_userInfo){setTimeout(()=>Zn(),300);return}const e=document.getElementById("history-free-block"),n=document.getElementById("history-main"),a=document.getElementById("history-empty");if(!e||!n||!a){console.warn("[History] container missing");return}if(!_userInfo.can_view_history){e.style.display="",n.style.display="none",a.style.display="none";return}e.style.display="none",_historyState.loading=!0;try{const o=_historyState.page*_historyState.pageSize,s=new URLSearchParams({limit:_historyState.pageSize,offset:o});_historyState.keyword&&s.set("keyword",_historyState.keyword);const i=typeof window.getCurrentClientId=="function"?window.getCurrentClientId():null;i&&s.set("client_id",String(i));const r=await fetch(`/api/history?${s}`,{headers:{Authorization:"Bearer "+token}});if(r.status===401){localStorage.removeItem("mrpilot_token");const d=await r.json().catch(()=>({}));if((typeof d.detail=="string"?d.detail:d.detail&&d.detail.code||"")==="auth.session_revoked"){_showSessionRevokedModal();return}window.location.href="/";return}const c=await r.json();_historyState.items=c.items||[],_historyState.total=c.total||0;const f=new Set(_historyState.items.map(d=>d.id));for(const d of Array.from(_historySelected))f.has(d)||_historySelected.delete(d);Mo()}catch(o){console.error("load history failed",o)}finally{_historyState.loading=!1}}function Mo(){const e=document.getElementById("history-main"),n=document.getElementById("history-empty"),a=_historyState.items,o=document.getElementById("history-search-matches");if(o&&(o.textContent=_historyState.keyword?t("search-matches",{n:_historyState.total}):""),a.length===0&&_historyState.total===0&&!_historyState.keyword){e.style.display="none",n.style.display="";return}e.style.display="",n.style.display="none";let s=0;a.forEach(d=>{d.confidence==="high"&&s++});const i=a.length>0?Math.round(s/a.length*100):0;document.getElementById("history-stats").innerHTML=`
    ...
    `,e.appendChild(n),document.getElementById("btn-save-history").addEventListener("click",$i),document.getElementById("btn-push-erp").addEventListener("click",Mi)}async function Ti(e){}async function Mi(){showToast(t("erp-push-coming-soon")||"ERP 推送即将开放，敬请期待","info")}async function $i(){const e=_results[_drawerIdx];if(!e||!e._historyId)return;const n=JSON.parse(JSON.stringify(e.pages||[]));if(n.length>0){const o=n.findIndex(c=>!c.is_duplicate&&!c.is_copy),s=o>=0?o:0,i=n[s].fields||(n[s].fields={}),r={...e.edits};r.category_tag!==void 0&&(r.category=r.category_tag,delete r.category_tag),Object.assign(i,r)}const a=document.getElementById("btn-save-history");a&&(a.disabled=!0);try{if(!(await fetch(`/api/history/${encodeURIComponent(e._historyId)}`,{method:"PUT",headers:{Authorization:"Bearer "+token,"Content-Type":"application/json"},body:JSON.stringify({pages:n})})).ok)throw new Error("save failed");showAlert("info",t("history-save-ok")),setTimeout(hideAlerts,1500),closeDrawer(),e._historyMode&&_results.pop(),loadHistoryPage()}catch{showAlert("error",t("history-save-fail")),a&&(a.disabled=!1)}}function Hi(e,n){document.querySelectorAll(".history-popover").forEach(d=>d.remove());const a=n.getBoundingClientRect(),o=(_historyState.items||[]).find(d=>d.id===e),s=o&&o.invoice_no?String(o.invoice_no):"",i=o&&o.has_pdf===!0,r=document.createElement("div");r.className="history-popover",r.innerHTML=`
...
`;fe("camera-tips-modal",Di);async function an(e){return new Promise(n=>{const a=new FileReader;a.onerror=()=>n({warnings:[],width:0,height:0,brightness:128}),a.onload=()=>{const o=new Image;o.onerror=()=>n({warnings:[],width:0,height:0,brightness:128}),o.onload=()=>{const s=[],i=o.naturalWidth,r=o.naturalHeight;(i<1e3||r<1e3)&&s.push("low_res");try{const c=document.createElement("canvas");c.width=64,c.height=64;const f=c.getContext("2d");f.drawImage(o,0,0,64,64);const d=f.getImageData(0,0,64,64).data;let u=0,l=0;for(let m=0;m<d.length;m+=4)u+=.299*d[m]+.587*d[m+1]+.114*d[m+2],l++;const p=l?u/l:128;p<70?s.push("too_dark"):p>235&&s.push("too_bright"),n({warnings:s,width:i,height:r,brightness:p})}catch{n({warnings:s,width:i,height:r,brightness:128})}},o.src=a.result},a.readAsDataURL(e)})}async function Ho(e){if(!e||e.length===0)return null;const{jsPDF:n}=window.jspdf,a=210,o=297,s=new n({unit:"mm",format:"a4",orientation:"p"});for(let d=0;d<e.length;d++){const u=e[d],{dataUrl:l,naturalW:p,naturalH:m}=await Ri(u);d>0&&s.addPage("a4","p");const v=p/m;let w=a-10,b=w/v;b>o-10&&(b=o-10,w=b*v);const g=(a-w)/2,h=(o-b)/2,_=u.type==="image/png"?"PNG":"JPEG";s.addImage(l,_,g,h,w,b,void 0,"FAST")}const i=s.output("blob"),r=new Date,c=r.getFullYear().toString()+String(r.getMonth()+1).padStart(2,"0")+String(r.getDate()).padStart(2,"0")+String(r.getHours()).padStart(2,"0")+String(r.getMinutes()).padStart(2,"0")+String(r.getSeconds()).padStart(2,"0"),f=e.length>1?`_${e.length}p`:"";return new File([i],`photo_${c}${f}.pdf`,{type:"application/pdf"})}function Ri(e){return new Promise((n,a)=>{const o=new FileReader;o.onerror=a,o.onload=()=>{const s=new Image;s.onerror=a,s.onload=()=>n({dataUrl:o.result,naturalW:s.naturalWidth,naturalH:s.naturalHeight}),s.src=o.result},o.readAsDataURL(e)})}(function(){const n=document.getElementById("upload-alt-row"),a=document.getElementById("gallery-input"),o=document.getElementById("camera-input");if(!n)return;n.style.display="";const s=document.getElementById("btn-scan-doc");s&&o&&(s.addEventListener("click",async()=>{!(localStorage.getItem("mrpilot_camera_tips_skip")==="1")&&!await qi()||o.click()}),o.addEventListener("change",async c=>{const f=Array.from(c.target.files||[]);if(c.target.value="",f.length!==0)for(const d of f)await Fn([d],"camera")}));const i=document.getElementById("btn-upload-pic");i&&a&&i.addEventListener("click",()=>a.click());const r=c=>async f=>{const d=Array.from(f.target.files||[]);if(f.target.value="",d.length===0)return;const u=d.filter(p=>p.type==="application/pdf"||/\.pdf$/i.test(p.name)),l=d.filter(p=>!u.includes(p));u.length>0&&await Fi(u),l.length>0&&await Fn(l,c)};a&&a.addEventListener("change",r("gallery"))})();async function Fi(e){for(const a of e)_selectedFiles.push({file:a,name:a.name,size:a.size,status:"waiting",errorKey:null,errorParams:null});const n=getMaxFiles();_selectedFiles.length>n&&(showAlert("warn",t("alert-file-count",{n})),_selectedFiles=_selectedFiles.slice(0,n)),renderFileList(),updateStartButton()}function qi(){return new Promise(e=>{const n=document.getElementById("camera-tips-modal"),a=document.getElementById("camera-tips-ok"),o=document.getElementById("camera-tips-cancel"),s=document.getElementById("camera-tips-skip");if(!n||!a){e(!0);return}s&&(s.checked=!1),n.style.display="flex";const i=c=>{n.style.display="none",s&&s.checked&&localStorage.setItem("mrpilot_camera_tips_skip","1"),a.onclick=null,o&&(o.onclick=null),n.onclick=null,document.removeEventListener("keydown",r),e(c)},r=c=>{c.key==="Escape"&&i(!1)};a.onclick=()=>i(!0),o&&(o.onclick=()=>i(!1)),n.onclick=c=>{c.target===n&&i(!1)},document.addEventListener("keydown",r),setTimeout(()=>a.focus(),50)})}let Ie=[],Xe=null;async function Fn(e,n){if(hideAlerts(),!(!e||e.length===0)){var a=typeof window.getOcrDocumentMode=="function"?window.getOcrDocumentMode():"invoice";if(a==="thai_id_card"){for(const s of e)_selectedFiles.push({file:s,name:s.name,size:s.size,status:"waiting",errorKey:null,errorParams:null});const o=getMaxFiles();_selectedFiles.length>o&&(showAlert("warn",t("alert-file-count",{n:o})),_selectedFiles=_selectedFiles.slice(0,o)),renderFileList(),updateStartButton();return}if(typeof window.jspdf>"u"||!window.jspdf.jsPDF){showToast(t("camera-loading"),"info");for(let o=0;o<30&&(await new Promise(s=>setTimeout(s,100)),!(window.jspdf&&window.jspdf.jsPDF));o++);if(!window.jspdf||!window.jspdf.jsPDF){showToast(t("camera-lib-fail"),"error");return}}if(n==="camera"&&e.length===1){const o=e[0];let s={};try{s=await an(o)}catch{}Ie.push({file:o,quality:s}),Xe="camera",dt();return}if(n==="gallery"&&(e.length>=2||Ie.length>0)){for(const o of e){let s={};try{s=await an(o)}catch{}Ie.push({file:o,quality:s})}Xe="gallery",dt();return}await Ao(e)}}async function zi(e){const n=new Set;for(const o of e)try{((await an(o)).warnings||[]).forEach(i=>n.add(i))}catch{}try{const o=await Ho(e);o&&_selectedFiles.push({file:o,name:o.name,size:o.size,status:"waiting",errorKey:null,errorParams:null})}catch(o){console.error("[camera] convert failed",o),showToast(t("camera-convert-fail"),"error");return}const a=getMaxFiles();_selectedFiles.length>a&&(showAlert("warn",t("alert-file-count",{n:a})),_selectedFiles=_selectedFiles.slice(0,a)),renderFileList(),updateStartButton(),showToast(t("camera-added-merged",{n:e.length}),"success"),n.size>0&&setTimeout(()=>{n.has("too_dark")?showToast(t("camera-quality-dark"),"warn"):n.has("low_res")?showToast(t("camera-quality-lowres"),"warn"):n.has("too_bright")&&showToast(t("camera-quality-overexposed"),"warn")},1e3)}function dt(){let e=document.getElementById("camera-buffer-bar");if(Ie.length===0){e&&e.remove(),Xe=null;return}e||(e=document.createElement("div"),e.id="camera-buffer-bar",e.className="camera-buffer-bar",document.body.appendChild(e));const n=Ie.length,a=n>=2,o=Xe==="gallery",s=o?t("camera-buffer-more-gallery"):t("camera-buffer-more");let i;a?o?i=`
    ...
    `,document.body.appendChild(l);const p=()=>{l.remove(),window._dupQueue&&window._dupQueue.length&&setTimeout(Po,200)};l.querySelector(".dup-close").addEventListener("click",p),l.querySelector('[data-action="view"]').addEventListener("click",()=>{const m=e.match.id;window.location.hash="#/history",setTimeout(()=>{typeof openHistoryDrawer=="function"&&openHistoryDrawer(m)},400),p()}),l.querySelector('[data-action="delete"]').addEventListener("click",async()=>{const m=e.new_history_id;if(!m){p();return}try{(await fetch(`/api/history/${encodeURIComponent(m)}`,{method:"DELETE",headers:{Authorization:"Bearer "+token}})).ok?showToast(t("dup-deleted-toast"),"success"):showToast(t("dup-delete-failed"),"error")}catch{showToast(t("dup-delete-failed"),"error")}p()}),l.querySelector('[data-action="keep"]').addEventListener("click",p)}window.showDuplicateDialog=Po;function Qe(e,n){try{return typeof window.t=="function"?window.t(e):n}catch{return n}}function It(e){if(e==null||isNaN(e))return"—";try{return String(e).replace(/\B(?=(\d{3})+(?!\d))/g,",")}catch{return String(e)}}function Vi(e){if(!e)return"";try{const n=new Date(e).getTime();if(!n)return"";const a=Math.floor((Date.now()-n)/1e3);return a<60?Qe("time-just-now","刚刚"):a<3600?Math.floor(a/60)+Qe("time-min-ago-suffix"," 分钟前"):a<86400?Math.floor(a/3600)+Qe("time-hour-ago-suffix"," 小时前"):Math.floor(a/86400)+Qe("time-day-ago-suffix"," 天前")}catch{return""}}async function ta(){Do();const e=document.getElementById("dash-kpi-invoices"),n=document.getElementById("dash-kpi-pending"),a=document.getElementById("dash-kpi-exceptions"),o=document.getElementById("dash-kpi-plan"),s=document.getElementById("dash-kpi-plan-sub"),i=document.getElementById("dash-recent-list"),r=document.getElementById("dash-quick-exc-badge");try{const c={Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||"")},[f,d,u]=await Promise.all([fetch("/api/me/tenant-usage",{headers:c}).then(b=>b.ok?b.json():null).catch(()=>null),fetch("/api/history?limit=20",{headers:c}).then(b=>b.ok?b.json():null).catch(()=>null),fetch("/api/exceptions/stats?status=pending",{headers:c}).then(b=>b.ok?b.json():null).catch(()=>null)]),l=f&&f.ocr_this_month||0;let p=0;const m=d&&(d.items||d.history||d)||[],v=Array.isArray(m)?m:[];v.forEach(b=>{(b.status==="pending"||b.status==="reviewing")&&p++});const w=u&&(u.total||u.count||u.pending||0)||0;if(e&&(e.textContent=It(l)),n&&(n.textContent=It(p)),a&&(a.textContent=It(w)),r&&(w>0?(r.style.display="",r.textContent=w):r.style.display="none"),o&&f){const b=f.ocr_this_month||0,g=f.quota||0;o.textContent=It(b),s&&(s.textContent=g?b+" / "+It(g)+" 张":Qe("dash-kpi-plan-sub","本月用量"))}if(i)if(v.length===0)i.innerHTML='<div class="dash-recent-empty">'+Qe("dash-recent-empty","还没有识别记录 · 去上传第一张吧")+"</div>";else{const b=v.slice(0,5).map(g=>{const h=(g.invoice_no||g.filename||g.id||"").toString(),_=(g.supplier_name||g.buyer_name||g.client_name||g.notes||"").toString(),y=Vi(g.created_at||g.upload_time||g.date),k=x=>String(x).replace(/[&<>"']/g,E=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[E]);return'<div class="dash-recent-row"><span class="dash-recent-key" title="'+k(h)+'">'+k(h)+'</span><span class="dash-recent-mid" title="'+k(_)+'">'+k(_)+'</span><span class="dash-recent-time">'+k(y)+"</span></div>"}).join("");i.innerHTML=b}}catch{i&&(i.innerHTML='<div class="dash-recent-empty">'+Qe("dash-recent-empty","还没有识别记录 · 去上传第一张吧")+"</div>")}}window.loadDashboard=ta;async function Do(){const e=document.getElementById("dash-kpi-balance-card"),n=document.getElementById("dash-kpi-usage-card"),a=document.getElementById("dash-kpi-balance"),o=document.getElementById("dash-kpi-balance-sub"),s=document.getElementById("dash-kpi-usage"),i=document.getElementById("dash-kpi-usage-sub");if(!(!e||!n))try{const r={Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||"")},c=await fetch("/api/me/credits",{headers:r,cache:"no-store"});if(!c.ok){e.style.display="none",s&&(s.textContent="—"),i&&(i.textContent="");return}const f=await c.json(),d=!!f.is_owner,u=!!f.is_billing_exempt;if(!d)e.style.display="none";else if(e.style.display="",u)a&&(a.textContent="∞",a.className="dash-kpi-val dash-green"),o&&(o.textContent=typeof window.t=="function"?window.t("dash-kpi-balance-exempt"):"Billing exempt");else{const p=typeof f.balance_thb=="number"?f.balance_thb:0;if(a&&(a.textContent="฿"+p.toFixed(2),a.className=p<50?"dash-kpi-val dash-red":"dash-kpi-val"),o){const m=typeof window.t=="function"?window.t("dash-kpi-balance-topup"):"Top up →",v=p<50?"#dc2626":"#6b7280",w=b=>typeof window.escapeHtml=="function"?window.escapeHtml(b):String(b).replace(/[&<>"']/g,g=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[g]);o.innerHTML='<a href="#" id="kpi-balance-topup-link" style="color:'+v+';text-decoration:underline;cursor:pointer;" onclick="event.preventDefault();window._openTopupModal&&window._openTopupModal();return false;">'+w(m)+"</a>"}}const l=typeof f.pages_this_month=="number"?f.pages_this_month:typeof f.my_invoice_count=="number"?f.my_invoice_count:0;if(n.style.display="",s&&(s.textContent=String(l)),i){const p=l>=200?"dash-kpi-usage-sub-high":"dash-kpi-usage-sub-low",m=typeof window.t=="function"?window.t(p,{used:l}):l+" pages";i.textContent=m}}catch(r){console.warn("[credits] loadCreditsCard failed:",r),e.style.display="none",s&&(s.textContent="—")}}window.loadCreditsCard=Do;document.addEventListener("DOMContentLoaded",function(){(location.hash||"").replace(/^#\//,"")==="dashboard"&&setTimeout(ta,500)});typeof window.subscribeI18n=="function"&&window.subscribeI18n("dashboard",function(){(location.hash||"").replace(/^#\//,"")==="dashboard"&&ta()});function Z(e){return(typeof window.t=="function"?window.t(e):null)||e}function na(){return localStorage.getItem("mrpilot_token")||""}function J(e){return document.getElementById(e)}var Xt=null,Mt=null;function Ro(){Mt||(Mt=setInterval(function(){if(!document.hidden){var e=na();e&&(window._userInfo&&window._userInfo.is_billing_exempt||fetch("/api/me/credits",{headers:{Authorization:"Bearer "+e},cache:"no-store"}).then(function(n){return n.ok?n.json():null}).then(function(n){if(n){var a=n.balance_thb!=null?Number(n.balance_thb):0;Xt!==null&&a>Xt&&(window.showToast&&window.showToast(Z("credits-updated"),"success"),typeof window.loadDashboard=="function"&&window.loadDashboard(),typeof window._refreshBalanceAlerts=="function"&&window._refreshBalanceAlerts()),Xt=a}}).catch(function(){}))}},3e4))}function Ui(){Mt&&(clearInterval(Mt),Mt=null),Xt=null}window._startCreditsPoll=Ro;window._stopCreditsPoll=Ui;Ro();var aa=null,oa=0;function Gi(){if(!J("topup-v2-ov")){var e=document.createElement("div");e.id="topup-v2-ov",e.className="topup-v2-ov",e.style.cssText="display:none;position:fixed;inset:0;background:rgba(15,23,42,.5);z-index:9500;align-items:center;justify-content:center;padding:16px",e.innerHTML=['<div class="topup-v2-box">','  <div class="topup-v2-head">','    <div class="topup-v2-title" id="tv2-title"></div>','    <button class="topup-v2-close" id="tv2-close" aria-label="close">','      <svg viewBox="0 0 20 20" width="16" height="16" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"><line x1="4" y1="4" x2="16" y2="16"/><line x1="16" y1="4" x2="4" y2="16"/></svg>',"    </button>","  </div>",'  <div class="topup-v2-steps">','    <div class="topup-v2-step" id="tv2-d1"><span class="topup-v2-dot">1</span><span class="topup-v2-slabel" id="tv2-sl1"></span></div>','    <div class="topup-v2-line"></div>','    <div class="topup-v2-step" id="tv2-d2"><span class="topup-v2-dot">2</span><span class="topup-v2-slabel" id="tv2-sl2"></span></div>','    <div class="topup-v2-line"></div>','    <div class="topup-v2-step" id="tv2-d3"><span class="topup-v2-dot">3</span><span class="topup-v2-slabel" id="tv2-sl3"></span></div>',"  </div>",'  <div class="topup-v2-body">','    <div id="tv2-s1">','      <label class="topup-v2-label" id="tv2-al"></label>','      <div class="topup-v2-qamts">','        <button class="topup-v2-qamt" data-val="100">฿100</button>','        <button class="topup-v2-qamt" data-val="500">฿500</button>','        <button class="topup-v2-qamt" data-val="1000">฿1,000</button>','        <button class="topup-v2-qamt" data-val="2000">฿2,000</button>',"      </div>",'      <input id="tv2-amt" type="number" min="10" step="1" class="topup-v2-input" placeholder="฿ ...">','      <div id="tv2-ae" class="topup-v2-err" style="display:none"></div>',"    </div>",'    <div id="tv2-s2" style="display:none">','      <p class="topup-v2-bank-label" id="tv2-bl"></p>','      <div class="topup-v2-bank-card">','        <div class="topup-v2-bank-name">ธนาคาร กรุงเทพ</div>','        <div class="topup-v2-bank-branch">สาขาโชคชัย 4 ลาดพร้าว</div>','        <div class="topup-v2-bank-acct">230-0-91368-4</div>','        <div class="topup-v2-bank-holder">บจ. มิสเตอร์ อี อาร์ พี</div>','        <button class="topup-v2-copy" id="tv2-copy"></button>',"      </div>",'      <div class="topup-v2-warn" id="tv2-bn"></div>',"    </div>",'    <div id="tv2-s3" style="display:none">','      <div class="topup-v2-drop" id="tv2-drop">','        <input type="file" id="tv2-file" accept="image/*,.pdf" style="display:none">','        <svg viewBox="0 0 24 24" width="28" height="28" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M21 15v4a2 2 0 01-2 2H5a2 2 0 01-2-2v-4"/><polyline points="17 8 12 3 7 8"/><line x1="12" y1="3" x2="12" y2="15"/></svg>','        <span class="topup-v2-drop-text" id="tv2-dt"></span>',"      </div>",'      <div id="tv2-se" class="topup-v2-err" style="display:none"></div>','      <label class="topup-v2-label" id="tv2-pl"></label>','      <input id="tv2-payer" type="text" maxlength="200" class="topup-v2-input">','      <label class="topup-v2-label" id="tv2-nl"></label>','      <input id="tv2-note" type="text" maxlength="500" class="topup-v2-input">','      <div id="tv2-ue" class="topup-v2-err" style="display:none"></div>',"    </div>","  </div>",'  <div class="topup-v2-foot">','    <button class="btn btn-ghost" id="tv2-back" style="display:none"></button>','    <button class="btn btn-primary" id="tv2-next"></button>',"  </div>","</div>"].join(""),document.body.appendChild(e),Ki()}}function Fo(){var e=function(n,a){var o=J(n);o&&(o.textContent=a)};e("tv2-title",Z("topup-title")),e("tv2-sl1",Z("topup-step1")),e("tv2-sl2",Z("topup-step2")),e("tv2-sl3",Z("topup-step3")),e("tv2-al",Z("topup-amount-label")),e("tv2-bl",Z("topup-bank-label")),e("tv2-copy",Z("topup-copy-account")),e("tv2-dt",Z("topup-slip-drop")),e("tv2-pl",Z("topup-payer-label")),e("tv2-nl",Z("topup-note-label"))}function Ft(e){[1,2,3].forEach(function(s){var i=J("tv2-s"+s);i&&(i.style.display=s===e?"":"none");var r=J("tv2-d"+s);r&&r.classList.toggle("active",s<=e)});var n=J("tv2-back"),a=J("tv2-next");if(e===1?n&&(n.style.display="",n.textContent=Z("topup-btn-cancel")):n&&(n.style.display="",n.textContent=Z("topup-btn-back")),a&&(a.textContent=Z(e===3?"topup-btn-submit":"topup-btn-next")),e===2){var o=J("tv2-bn");o&&(o.innerHTML=Z("topup-bank-note").replace("{amount}","<strong>฿"+Number(oa).toLocaleString()+"</strong>"))}}function qn(){for(var e=1;e<=3;e++){var n=J("tv2-s"+e);if(n&&n.style.display!=="none")return e}return 1}function on(e){var n=J(e);n&&(n.textContent="",n.style.display="none")}function $t(e,n){var a=J(e);a&&(a.textContent=n,a.style.display="")}function Ma(e){var n=J("tv2-dt");n&&(n.textContent=e.name);var a=J("tv2-drop");a&&a.classList.add("has-file"),on("tv2-se")}function Ki(){var e=J("topup-v2-ov");J("tv2-close").addEventListener("click",Lt),e.addEventListener("click",function(i){i.target===e&&Lt()}),document.addEventListener("keydown",function(i){i.key==="Escape"&&e&&e.style.display!=="none"&&Lt()}),e.addEventListener("click",function(i){var r=i.target.closest(".topup-v2-qamt");if(r){e.querySelectorAll(".topup-v2-qamt").forEach(function(f){f.classList.remove("active")}),r.classList.add("active");var c=J("tv2-amt");c&&(c.value=r.dataset.val,on("tv2-ae"))}});var n=J("tv2-amt");n&&n.addEventListener("input",function(){e.querySelectorAll(".topup-v2-qamt").forEach(function(i){i.classList.remove("active")}),on("tv2-ae")});var a=J("tv2-copy");a&&a.addEventListener("click",function(){navigator.clipboard&&navigator.clipboard.writeText("2300913684").then(function(){var i=a.textContent;a.textContent=Z("topup-copied"),setTimeout(function(){a.textContent=i},1500)})});var o=J("tv2-drop"),s=J("tv2-file");o&&(o.addEventListener("click",function(){s&&s.click()}),o.addEventListener("dragover",function(i){i.preventDefault(),o.classList.add("drag-over")}),o.addEventListener("dragleave",function(){o.classList.remove("drag-over")}),o.addEventListener("drop",function(i){i.preventDefault(),o.classList.remove("drag-over");var r=i.dataTransfer&&i.dataTransfer.files[0];r&&Ma(r)})),s&&s.addEventListener("change",function(){s.files[0]&&Ma(s.files[0])}),J("tv2-back").addEventListener("click",function(){var i=qn();if(i<=1){Lt();return}Ft(i-1)}),J("tv2-next").addEventListener("click",function(){var i=qn();i===1?Ji():i===2?Ft(3):Wi()})}async function Ji(){var e=J("tv2-amt"),n=e?parseFloat(e.value):0;if(!n||n<10){$t("tv2-ae",Z("topup-amount-invalid"));return}if(n>5e5){$t("tv2-ae",Z("topup-amount-too-large"));return}oa=n;var a=J("tv2-next");a&&(a.disabled=!0,a.textContent="…");try{var o=await fetch("/api/credits/topup/request",{method:"POST",headers:{"Content-Type":"application/json",Authorization:"Bearer "+na()},body:JSON.stringify({amount_thb:n})});if(!o.ok){var s=await o.text(),i=Z("topup-submit-fail");try{var r=JSON.parse(s),c=r.detail;if(Array.isArray(c)&&c.length){var f=c[0]&&c[0].type||"";f.indexOf("less_than")>=0?i=Z("topup-amount-too-large"):(f.indexOf("greater_than")>=0||f.indexOf("parsing")>=0)&&(i=Z("topup-amount-invalid"))}else typeof c=="string"&&(i=c)}catch{}throw new Error(i)}var d=await o.json();aa=d.request_id,Ft(2)}catch(u){$t("tv2-ae",u.message||Z("topup-submit-fail"))}finally{a&&(a.disabled=!1,a.textContent=Z("topup-btn-next"))}}async function Wi(){var e=J("tv2-file");if(!e||!e.files||!e.files[0]){$t("tv2-se",Z("topup-slip-required"));return}var n=J("tv2-next");n&&(n.disabled=!0,n.textContent="…");try{var a=new FormData;a.append("file",e.files[0]);var o=J("tv2-payer"),s=J("tv2-note");o&&o.value.trim()&&a.append("payer_name",o.value.trim()),s&&s.value.trim()&&a.append("note",s.value.trim());var i=await fetch("/api/credits/topup/upload-slip/"+aa,{method:"POST",headers:{Authorization:"Bearer "+na()},body:a});if(!i.ok)throw new Error(await i.text());var r=await i.json();r.auto_approved?(window.showToast&&window.showToast(Z("topup-auto-approved"),"success"),typeof window.loadDashboard=="function"&&window.loadDashboard()):window.showToast&&window.showToast(Z("topup-pending"),"info"),Lt()}catch(c){$t("tv2-ue",Z("topup-upload-fail")+" · "+c.message),n&&(n.disabled=!1,n.textContent=Z("topup-btn-submit"))}}function Lt(){var e=J("topup-v2-ov");e&&(e.style.display="none"),typeof window.loadDashboard=="function"&&window.loadDashboard()}window._openTopupModal=function(){Gi(),aa=null,oa=0,["tv2-amt","tv2-payer","tv2-note"].forEach(function(a){var o=J(a);o&&(o.value="")});var e=J("tv2-file");e&&(e.value="");var n=J("tv2-drop");n&&n.classList.remove("has-file","drag-over"),J("topup-v2-ov").querySelectorAll(".topup-v2-qamt").forEach(function(a){a.classList.remove("active")}),["tv2-ae","tv2-se","tv2-ue"].forEach(function(a){on(a)}),Fo(),Ft(1),J("topup-v2-ov").style.display="flex"};typeof window.subscribeI18n=="function"&&window.subscribeI18n("topup-v2",function(){var e=J("topup-v2-ov");e&&e.style.display!=="none"&&e.style.display!==""&&(Fo(),Ft(qn()))});const Yi=`
        <div class="page-head">
            <div class="page-head-icon">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
    ...
    <div class="modal" style="max-width:480px">
        ...
        <div class="modal-foot">
            ...
            <div class="access-log-row access-log-head">
                ...
                </div>`}).join("");u.innerHTML=p+m}function s(){const u=document.getElementById("access-log-pager");if(!u)return;const l=e.total||0;if(!l){u.innerHTML="";return}const p=e.page||1,m=e.per_page,v=Math.max(1,Math.ceil(l/m)),w=(t("set-access-log-pager-total")||"Total {n}").replace("{n}",l),b=(t("set-access-log-pager-page")||"Page {p} / {t}").replace("{p}",p).replace("{t}",v);u.innerHTML=`
...
`,e.dataset.wbInjected="1";try{const n=window._currentLang||localStorage.getItem("mrpilot_lang")||"th",a=window.I18N;a&&a[n]&&(e.querySelectorAll("[data-i18n]").forEach(o=>{const s=o.getAttribute("data-i18n");s&&a[n][s]&&(o.textContent=a[n][s])}),e.querySelectorAll("[data-i18n-placeholder]").forEach(o=>{const s=o.getAttribute("data-i18n-placeholder");s&&a[n][s]&&(o.placeholder=a[n][s])}))}catch{}}})();(function(){const e=document.getElementById("archive-token-modal");if(!(!e||e.dataset.wbInjected==="1")){e.innerHTML=`
        ...
        `}async function n(){try{const o=await fetch("/api/settings/dup-check",{headers:{Authorization:"Bearer "+token}});if(!o.ok)return;const s=await o.json(),i=document.getElementById("pref-dup-check");i&&(i.checked=!!s.enabled)}catch(o){console.warn("load prefs failed",o)}}const a=document.getElementById("pref-dup-check");a&&!a.dataset.bound&&(a.dataset.bound="1",a.addEventListener("change",async o=>{const s=o.target.checked;try{(await fetch("/api/settings/dup-check",{method:"PUT",headers:{Authorization:"Bearer "+token,"Content-Type":"application/json"},body:JSON.stringify({enabled:s})})).ok?showToast(s?t("pref-dup-check-on-toast"):t("pref-dup-check-off-toast"),"success"):(o.target.checked=!s,showToast(t("pref-save-failed"),"error"))}catch{o.target.checked=!s,showToast(t("pref-save-failed"),"error")}}))})();(function(){const o="pearnly_big_batch_tip_shown";let s=null,i=null,r=0,c=0,f=!1;function d(h){const _=typeof t=="function"?t("big-batch-unload-warn"):"Batch OCR running · close anyway?";return h.preventDefault(),h.returnValue=_,_}function u(){f||(f=!0,window.addEventListener("beforeunload",d))}function l(){f&&(f=!1,window.removeEventListener("beforeunload",d))}function p(){if(document.getElementById("big-batch-progress"))return;const h=document.getElementById("file-list");if(!h||!h.parentNode)return;const _=document.createElement("div");_.id="big-batch-progress",_.className="big-batch-progress",_.innerHTML='<div class="bbp-row"><svg class="bbp-icon" viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><circle cx="8" cy="8" r="6.5"/><path d="M8 4.5v3.5l2.5 1.5"/></svg><span class="bbp-text" id="bbp-text"></span></div><div class="bbp-track"><div class="bbp-fill" id="bbp-fill" style="width:0%"></div></div>',h.parentNode.insertBefore(_,h);const y=document.getElementById("bbp-text");y&&(y.textContent=typeof t=="function"?t("big-batch-progress-init"):"Starting...")}function m(){const h=document.getElementById("big-batch-progress");h&&h.remove()}function v(){if(!i)return;let h=0;for(let L=0;L<i.length;L++){const C=i[L].status;(C==="success"||C==="error"||C==="cancelled")&&h++}const _=r,y=_>0?Math.min(100,Math.floor(100*h/_)):0,k=(Date.now()-c)/1e3;let x;if(h>=3&&k>1){const L=k/h;x=(_-h)*L}else x=(_-h)*6/6;const E=Math.max(1,Math.ceil(x/60)),I=document.getElementById("bbp-fill"),B=document.getElementById("bbp-text");I&&(I.style.width=y+"%"),B&&(h>=_?B.textContent=t("big-batch-progress-done").replace("{total}",_):B.textContent=t("big-batch-progress-running").replace("{done}",h).replace("{total}",_).replace("{min}",E))}function w(h){try{if(localStorage.getItem(o)==="1")return}catch{}const _=Math.max(1,Math.ceil(h*6/6/60)),y=t("big-batch-first-tip").replace("{n}",h).replace("{min}",_);typeof showToast=="function"&&showToast(y,"info",8e3);try{localStorage.setItem(o,"1")}catch{}}function b(h){!h||h.length<100||(i=h,r=h.length,c=Date.now(),p(),u(),w(r),s&&clearInterval(s),s=setInterval(v,250),v())}function g(){s&&(clearInterval(s),s=null),l(),i&&r>=100?(v(),setTimeout(m,1200)):m(),i=null,r=0}window._bigBatchStart=b,window._bigBatchStop=g,typeof window.subscribeI18n=="function"&&window.subscribeI18n("big-batch-progress",function(){i&&v()})})();const pe={status:null,statusLoaded:!1,bound:!1};function le(e){return typeof escapeHtml=="function"?escapeHtml(e==null?"":String(e)):String(e??"")}function me(e,n){try{typeof showToast=="function"&&showToast(e,n||"info")}catch{}}function Aa(){const e=typeof _userInfo<"u"?_userInfo:null;return!!(e&&(e.role==="owner"||e.is_super_admin))}function zo(){try{return(typeof _results<"u"?_results:[])[typeof _drawerIdx<"u"?_drawerIdx:-1]||null}catch{return null}}function er(e){if(!e)return!1;const n=String(e.status||"").toLowerCase();return n==="exception"||n==="exception_pending"||n==="rejected"}async function lt(e){if(pe.statusLoaded&&!e)return pe.status;const n=localStorage.getItem("mrpilot_token");if(!n)return null;try{const a=await fetch("/api/erp/xero/status",{headers:{Authorization:"Bearer "+n}});if(!a.ok)throw new Error("http_"+a.status);pe.status=await a.json(),pe.statusLoaded=!0}catch{pe.status={configured:!1,connected:!1,organisations:[]},pe.statusLoaded=!1}return pe.status}async function tr(){const e=document.getElementById("drawer-history-save");if(!e||e.querySelector("#btn-xero-push")||e.querySelector("#pn-push-wrap")||(await lt(!1),e.querySelector("#pn-push-wrap"))||e.querySelector("#btn-xero-push"))return;const n=zo();if(!(n&&(n._historyId||n.history_id)))return;let o=!1,s="xero-push-tip";!pe.status||!pe.status.configured?(o=!0,s="xero-err-not_configured"):pe.status.connected?er(n)&&(o=!0,s="xero-push-disabled-exc"):(o=!0,s="xero-push-disabled-no-conn");const i=document.createElement("button");i.type="button",i.id="btn-xero-push",i.className="btn btn-ghost"+(o?" disabled":""),i.disabled=o,i.title=t(s)||"",i.innerHTML='<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"><circle cx="8" cy="8" r="6"/><path d="M5 8l2 2 4-4"/></svg><span style="margin-left:4px;">'+le(t("xero-push-btn"))+"</span>",i.addEventListener("click",nr);const r=document.getElementById("btn-push-erp");r&&r.parentNode?r.parentNode.insertBefore(i,r.nextSibling):e.insertBefore(i,e.firstChild)}async function nr(){const e=zo(),n=e&&(e._historyId||e.history_id);if(!n)return;const a=document.getElementById("btn-xero-push");a&&(a.disabled=!0,a.classList.add("loading"));const o=localStorage.getItem("mrpilot_token");try{const s=await fetch("/api/erp/xero/push/"+encodeURIComponent(n),{method:"POST",headers:{Authorization:"Bearer "+o}});if(!s.ok){let i="unknown";try{i=(await s.json()).detail||"unknown"}catch{}const r=String(i).replace(/^xero\./,"").toLowerCase(),c=t("xero-"+r),f=c&&c!=="xero-"+r?c:i;me(t("xero-push-fail").replace("{err}",f),"error");return}me(t("xero-push-ok"),"success")}catch(s){me(t("xero-push-fail").replace("{err}",s.message||"network"),"error")}finally{a&&(a.disabled=!1,a.classList.remove("loading"))}}async function ar(){const e=document.getElementById("erp-global-push-mode");if(!e)return;const n=localStorage.getItem("mrpilot_token");if(n)try{const a=await fetch("/api/settings/erp-push-mode",{headers:{Authorization:"Bearer "+n}});if(a.ok){const o=await a.json();o.mode&&(e.value=o.mode,e.dataset.prev=o.mode)}}catch{}}async function or(e){const n=e.value,a=localStorage.getItem("mrpilot_token");try{(await fetch("/api/settings/erp-push-mode",{method:"PUT",headers:{Authorization:"Bearer "+a,"Content-Type":"application/json"},body:JSON.stringify({mode:n})})).ok?(e.dataset.prev=n,me(t("pref-erp-mode-saved"),"success")):(e.value=e.dataset.prev||"smart",me(t("pref-save-failed"),"error"))}catch{e.value=e.dataset.prev||"smart",me(t("pref-save-failed"),"error")}}(function(){function e(){const l=document.getElementById("erp-connect-cards");if(!l)return;const p=pe.status;let m,v=!1;p?p.configured?p.connected?(v=!0,m='<span class="mrerp-card-pill mrerp-pill-ok">'+le(t("xero-card-connected"))+"</span>"):m='<span class="mrerp-card-pill mrerp-pill-neutral">'+le(t("xero-card-not-connected"))+"</span>":m='<span class="mrerp-card-pill mrerp-pill-neutral">'+le(t("xero-card-not-configured"))+"</span>":m='<span class="mrerp-card-pill mrerp-pill-neutral">'+le(t("xero-card-not-connected"))+"</span>";let w="";if(!p||!p.configured)w='<button type="button" class="int-btn-configure" id="btn-xero-connect">'+le(t("xero-connect-btn"))+"</button>";else if(!p.connected)Aa()&&(w='<button type="button" class="int-btn-configure" id="btn-xero-connect">'+le(t("xero-connect-btn"))+"</button>");else{const I=!!p.auto_push,B=I?t("card-btn-disable"):t("card-btn-enable");w='<button type="button" class="'+(I?"mrerp-card-toggle mrerp-card-toggle-disable":"mrerp-card-toggle mrerp-card-toggle-enable")+'" id="btn-xero-toggle-enabled" data-xero-enabled="'+(I?"1":"0")+'" title="'+le(I?t("erp-auto-push-on-tip"):t("erp-auto-push-off-tip"))+'">'+le(B)+'</button><button type="button" class="int-btn-configure" id="btn-xero-edit-toggle">'+le(t("card-btn-edit"))+"</button>"}const b=p&&p.connected?"xero-card-desc-connected":"xero-card-desc-default",g=p&&p.connected?t("xero-card-connected")||"Connected · default org will receive pushes":"Cloud accounting · push invoices to your default Xero org",h=(function(){const I=t(b);return I===b?g:I})();let _='<div class="integration-row erp-connect-xero'+(v?" connected":"")+'"><div class="int-icon ic-xero"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="9"/><circle cx="9" cy="10" r="1.3" fill="currentColor"/><circle cx="15" cy="14" r="1.3" fill="currentColor"/><path d="M9 14l6-4"/></svg></div><div class="int-info"><div class="int-name"><span>'+le(t("xero-card-title")||"Xero")+"</span>"+m+'</div><div class="int-desc">'+le(h)+'</div></div><div class="int-actions">'+w+"</div></div>";if(p&&p.configured&&p.connected&&Aa()){const I=p.organisations||[];let B="";if(I.length>0){B+='<div class="erp-cc-meta">'+le((t("xero-org-count")||"").replace("{n}",String(I.length)))+"</div>",B+='<div class="erp-cc-org-label">'+le(t("xero-default-org"))+":</div>",B+='<div class="erp-cc-orgs">',I.forEach(function(S){B+='<label class="erp-cc-org-row"><input type="radio" name="xero-default-org" value="'+le(S.id)+'"'+(S.is_default?" checked":"")+'><span class="erp-cc-org-name">'+le(S.organisation_name||S.organisation_id)+"</span></label>"}),B+="</div>";const L=!!p.auto_push,C=L?t("erp-auto-push-on-tip"):t("erp-auto-push-off-tip");B+='<div class="erp-cc-auto-push" title="'+le(C)+'"><label class="erp-cc-toggle"><input type="checkbox" id="xero-auto-push-toggle"'+(L?" checked":"")+'><span class="erp-cc-toggle-slider"></span><span class="erp-cc-toggle-label">'+le(t("erp-auto-push-label"))+"</span></label></div>",B+='<div class="erp-cc-actions"><button class="btn btn-ghost btn-tiny" type="button" id="btn-xero-disconnect">'+le(t("xero-disconnect-btn"))+"</button></div>"}_+='<div class="erp-xero-details" id="erp-xero-details" style="display:none; margin:8px 0 16px; padding:12px 14px; border:1px solid var(--line); border-radius:8px; background:var(--bg);">'+B+"</div>"}const y=l.querySelector(".erp-connect-xero"),k=l.querySelector("#erp-xero-details");k&&k.remove(),y?y.outerHTML=_:l.insertAdjacentHTML("afterbegin",_);const x=document.getElementById("btn-xero-edit-toggle");x&&x.addEventListener("click",function(I){I.preventDefault();const B=document.getElementById("erp-xero-details");B&&(B.style.display=B.style.display==="none"?"":"none")});const E=document.getElementById("btn-xero-toggle-enabled");E&&E.addEventListener("click",async function(I){if(I.preventDefault(),E.disabled)return;const L=!(E.getAttribute("data-xero-enabled")==="1");if(!L)try{if(!await window.pearnlyConfirm(t("card-toggle-disable-confirm")))return}catch{}E.disabled=!0,await s(L,null)})}async function n(){const l=localStorage.getItem("mrpilot_token");if(l)try{const p=await fetch("/api/erp/xero/auth/start",{method:"GET",headers:{Authorization:"Bearer "+l}});if(!p.ok){let v="unknown";try{v=(await p.json()).detail||"unknown"}catch{}const w=String(v).replace(/^xero\./,"").toLowerCase();me(t("xero-push-fail").replace("{err}",t("xero-err-"+w)||v),"error");return}const m=await p.json();m.redirect_url&&(window.location.href=m.redirect_url)}catch(p){me(t("xero-push-fail").replace("{err}",p.message||"network"),"error")}}async function a(){if(!await window.pearnlyConfirm(t("xero-disconnect-confirm")))return;const p=localStorage.getItem("mrpilot_token");try{const m=await fetch("/api/erp/xero/disconnect",{method:"POST",headers:{Authorization:"Bearer "+p}});if(!m.ok)throw new Error("http_"+m.status);await lt(!0),e()}catch(m){me(t("xero-push-fail").replace("{err}",m.message),"error")}}async function o(l){const p=localStorage.getItem("mrpilot_token");try{const m=await fetch("/api/erp/xero/select_org",{method:"POST",headers:{Authorization:"Bearer "+p,"Content-Type":"application/json"},body:JSON.stringify({token_id:l})});if(!m.ok)throw new Error("http_"+m.status);await lt(!0),e()}catch(m){me(t("xero-push-fail").replace("{err}",m.message),"error")}}async function s(l,p){const m=localStorage.getItem("mrpilot_token");p&&(p.disabled=!0);try{const v=await fetch("/api/erp/xero/auto-push",{method:"POST",headers:{Authorization:"Bearer "+m,"Content-Type":"application/json"},body:JSON.stringify({on:!!l})});if(!v.ok){let w="unknown";try{w=(await v.json()).detail||"unknown"}catch{}throw new Error(w)}me(l?t("erp-auto-push-toggled-on"):t("erp-auto-push-toggled-off"),"success"),pe.statusLoaded=!1,await lt(!0),e()}catch(v){p&&(p.checked=!l),me(t("erp-auto-push-toggle-fail").replace("{err}",v.message||"network"),"error")}finally{p&&(p.disabled=!1)}}async function i(){await lt(!0),e(),ar()}function r(){try{const l=String(window.location.hash||"");if(l.indexOf("xero=ok")>=0){const p=l.match(/n=(\d+)/),m=p?p[1]:"1";me((t("xero-toast-redirected-ok")||"").replace("{n}",m),"success"),history.replaceState(null,"",window.location.pathname+"#automation"),lt(!0).then(e)}else l.indexOf("xero=err")>=0&&(me(t("xero-toast-redirected-err"),"error"),history.replaceState(null,"",window.location.pathname+"#automation"))}catch{}}function c(){if(pe.bound)return;pe.bound=!0,document.addEventListener("click",function(p){if(p.target.closest('.erp-subtab[data-erp-subtab="connect"]')){setTimeout(i,50);return}if(p.target.closest('.auto-nav-item[data-auto-tab="erp"]')){setTimeout(i,80);return}if(p.target.closest("#btn-xero-connect")){p.preventDefault(),n();return}if(p.target.closest("#btn-xero-disconnect")){p.preventDefault(),a();return}}),document.addEventListener("change",function(p){p.target&&p.target.matches('input[name="xero-default-org"]')&&o(p.target.value),p.target&&p.target.id==="xero-auto-push-toggle"&&s(p.target.checked,p.target),p.target&&p.target.id==="erp-global-push-mode"&&or(p.target)});const l=function(){return document.getElementById("drawer-body")};try{const p=new MutationObserver(function(){document.getElementById("drawer-history-save")&&!document.getElementById("btn-xero-push")&&tr()}),m=l();if(m)p.observe(m,{childList:!0,subtree:!0});else{const v=new MutationObserver(function(){const w=l();w&&(p.observe(w,{childList:!0,subtree:!0}),v.disconnect())});v.observe(document.body,{childList:!0,subtree:!0})}}catch{}setTimeout(r,500)}function f(){pe.status&&e();const l=document.getElementById("btn-xero-push");if(l){const p=l.querySelector("span");p&&(p.textContent=t("xero-push-btn"))}}c(),typeof window.subscribeI18n=="function"&&window.subscribeI18n("xero-adapter",f);async function d(l){const p=Date.now();for(;Date.now()-p<l;){if(typeof _userInfo<"u"&&_userInfo&&_userInfo.id)return _userInfo;await new Promise(m=>setTimeout(m,80))}return null}async function u(){await d(5e3);const l=document.querySelector('.auto-nav-item.active[data-auto-tab="erp"]'),p=document.querySelector('.erp-subtab.active[data-erp-subtab="connect"]');l&&p&&await i()}setTimeout(u,200)})();(function(){var e="https://www.mrerp4sme.com/dms/index.php",n=null,a=!1;function o(b){return typeof escapeHtml=="function"?escapeHtml(b==null?"":String(b)):String(b??"")}function s(b,g){try{typeof showToast=="function"&&showToast(b,g||"info")}catch{}}function i(){return localStorage.getItem("mrpilot_token")}async function r(b){var g=i();if(!g)return null;try{var h=await fetch("/api/erp/endpoints",{headers:{Authorization:"Bearer "+g}});if(!h.ok)throw new Error("http_"+h.status);var _=await h.json(),y=_&&_.items||[];n=y.find(function(k){return k&&(k.adapter||"").toLowerCase()==="mrerp_dms"})||null,a=!0}catch{n=null,a=!1}return n}function c(){var b=document.getElementById("erp-connect-cards");if(b){var g=b.querySelector("[data-mrerp-dms-zone]");g||(g=document.createElement("div"),g.setAttribute("data-mrerp-dms-zone","1"),b.appendChild(g));var h=n,_=!!(h&&h.enabled!==!1),y;h?_?y='<span class="mrerp-card-pill mrerp-pill-ok">'+o(t("dms-card-connected"))+"</span>":y='<span class="mrerp-card-pill mrerp-pill-neutral">'+o(t("dms-card-disabled-pill"))+"</span>":y='<span class="mrerp-card-pill mrerp-pill-neutral">'+o(t("dms-card-not-connected"))+"</span>";var k;if(!h)k='<button type="button" class="int-btn-configure" id="btn-dms-connect">'+o(t("dms-card-connect"))+"</button>";else{var x=_?t("dms-card-disable"):t("dms-card-enable");k='<button type="button" class="int-btn-configure" id="btn-dms-edit">'+o(t("dms-card-edit"))+'</button><button type="button" class="int-btn-configure" id="btn-dms-test">'+o(t("dms-card-test"))+'</button><button type="button" class="int-btn-configure" id="btn-dms-toggle">'+o(x)+"</button>"}g.innerHTML='<div class="integration-row erp-connect-mrerp-dms'+(_?" connected":"")+'"><div class="int-icon ic-mrerp-dms" style="background:#0a5c8a;color:#fff;"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M3 13l2-5a2 2 0 011.9-1.4h10.2A2 2 0 0119 8l2 5"/><path d="M3 13h18v4a1 1 0 01-1 1h-1a1 1 0 01-1-1v-1H6v1a1 1 0 01-1 1H4a1 1 0 01-1-1z"/><circle cx="7" cy="15.5" r="1"/><circle cx="17" cy="15.5" r="1"/></svg></div><div class="int-info"><div class="int-name"><span>'+o(t("dms-card-title"))+"</span>"+y+'</div><div class="int-desc">'+o(t("dms-card-desc"))+'</div></div><div class="int-actions">'+k+"</div></div>"}}function f(){var b=document.getElementById("dms-wizard-overlay");b&&b.remove(),document.removeEventListener("keydown",d)}function d(b){b.key==="Escape"&&f()}function u(){f();var b=n,g=b&&b.config&&b.config.booking_defaults&&b.config.booking_defaults.booking_prefix||"PN",h=function(k,x,E,I,B){return'<label style="display:block;margin-bottom:12px;"><span style="display:block;font-size:13px;color:var(--muted,#6b6b66);margin-bottom:5px;">'+o(t(k))+'</span><input id="'+x+'" type="'+E+'" value="'+o(I||"")+'" placeholder="'+o(B||"")+'" autocomplete="new-password" style="width:100%;box-sizing:border-box;padding:9px 11px;border:1px solid var(--line,#ddd);border-radius:8px;font-size:14px;"></label>'},_=document.createElement("div");_.id="dms-wizard-overlay",_.style.cssText="position:fixed;inset:0;z-index:13000;background:rgba(0,0,0,.42);display:flex;align-items:center;justify-content:center;padding:16px;",_.innerHTML='<div class="dms-wizard mrerp-wizard" role="dialog" aria-modal="true" style="background:var(--card,#fff);border-radius:14px;max-width:440px;width:100%;padding:24px;box-shadow:0 12px 40px rgba(0,0,0,.18);max-height:90vh;overflow:auto;"><div style="font-size:17px;font-weight:700;margin-bottom:4px;">'+o(t("dms-wizard-title"))+'</div><div style="font-size:13px;color:var(--muted,#6b6b66);margin-bottom:18px;">'+o(t("dms-card-desc"))+"</div>"+h("dms-wizard-username","dms-w-user","text","","")+h("dms-wizard-password","dms-w-pass","password","","")+h("dms-wizard-prefix","dms-w-prefix","text",g,"PN")+'<div id="dms-w-err" style="display:none;color:#b3261e;font-size:13px;margin:4px 0 12px;"></div><div style="display:flex;gap:10px;justify-content:flex-end;margin-top:8px;"><button type="button" class="btn btn-ghost" id="dms-w-cancel">'+o(t("dms-wizard-cancel"))+'</button><button type="button" class="btn btn-primary" id="dms-w-save">'+o(t("dms-wizard-save"))+"</button></div></div>",document.body.appendChild(_),document.addEventListener("keydown",d),_.addEventListener("click",function(k){k.target===_&&f()});var y=document.getElementById("dms-w-user");y&&y.focus()}function l(b){var g=document.getElementById("dms-w-err");g&&(g.textContent=b,g.style.display=b?"":"none")}async function p(){var b=n&&n.config&&n.config.system_url||e,g=(document.getElementById("dms-w-user")||{}).value||"",h=(document.getElementById("dms-w-pass")||{}).value||"",_=(document.getElementById("dms-w-prefix")||{}).value||"PN";if(b=b.trim(),g=g.trim(),!b||!g||!h){l(t("dms-wizard-required"));return}var y=document.getElementById("dms-w-save");y&&(y.disabled=!0,y.textContent=t("dms-wizard-saving")),l("");var k=i();try{var x=await fetch("/api/erp/test-connection",{method:"POST",headers:{Authorization:"Bearer "+k,"Content-Type":"application/json"},body:JSON.stringify({adapter:"mrerp_dms",config:{system_url:b,username:g,password:h}})}),E=await x.json().catch(function(){return{}});if(!x.ok||!E.ok){var I=E.error_friendly&&(E.error_friendly[window.currentLang]||E.error_friendly.en)||t("dms-connect-fail-generic");l(I),y&&(y.disabled=!1,y.textContent=t("dms-wizard-save"));return}var B={system_url:b,username_enc:g,password_enc:h,id_card_auto_push:!0,booking_defaults:{booking_prefix:_.trim()||"PN"}},L,C;n&&n.id?(L="PATCH",C="/api/erp/endpoints/"+encodeURIComponent(n.id)):(L="POST",C="/api/erp/endpoints");var S=L==="POST"?{name:"MR.ERP DMS",adapter:"mrerp_dms",config:B,is_default:!1,auto_push:!1}:{config:B,auto_push:!1},$=await fetch(C,{method:L,headers:{Authorization:"Bearer "+k,"Content-Type":"application/json"},body:JSON.stringify(S)});if(!$.ok){var j=await $.json().catch(function(){return{}}),N=j&&j.detail&&(j.detail.code||j.detail)||"save_failed";l(t("dms-save-fail")+" ("+o(String(N))+")"),y&&(y.disabled=!1,y.textContent=t("dms-wizard-save"));return}f(),s(t("dms-connect-ok"),"success"),await r(!0),c(),typeof window._refreshOcrDocMode=="function"&&window._refreshOcrDocMode()}catch{l(t("dms-connect-fail-generic")),y&&(y.disabled=!1,y.textContent=t("dms-wizard-save"))}}async function m(){if(!(!n||!n.id)){s(t("dms-test-running"),"info");var b=i();try{var g=await fetch("/api/erp/endpoints/"+encodeURIComponent(n.id)+"/test-connection?refresh=1",{method:"POST",headers:{Authorization:"Bearer "+b}}),h=await g.json().catch(function(){return{}});s(h&&h.ok?t("dms-test-ok"):t("dms-test-fail"),h&&h.ok?"success":"error")}catch{s(t("dms-test-fail"),"error")}}}async function v(){if(!(!n||!n.id)){var b=n.enabled===!1;if(!b)try{var g=await window.pearnlyConfirm(t("dms-confirm-disable"));if(!g)return}catch{}var h=i();try{var _=await fetch("/api/erp/endpoints/"+encodeURIComponent(n.id),{method:"PATCH",headers:{Authorization:"Bearer "+h,"Content-Type":"application/json"},body:JSON.stringify({enabled:b})});if(!_.ok)throw new Error("http_"+_.status);s(b?t("dms-enabled-toast"):t("dms-disabled-toast"),"success"),await r(!0),c(),typeof window._refreshOcrDocMode=="function"&&window._refreshOcrDocMode()}catch{s(t("dms-save-fail"),"error")}}}function w(){r().then(c)}document.addEventListener("click",function(b){if(b.target.closest('.erp-subtab[data-erp-subtab="connect"]')){setTimeout(w,60);return}if(b.target.closest('.auto-nav-item[data-auto-tab="erp"]')){setTimeout(w,90);return}if(b.target.closest("#btn-dms-connect")||b.target.closest("#btn-dms-edit")){b.preventDefault(),u();return}if(b.target.closest("#dms-w-cancel")){b.preventDefault(),f();return}if(b.target.closest("#dms-w-save")){b.preventDefault(),p();return}if(b.target.closest("#btn-dms-test")){b.preventDefault(),m();return}if(b.target.closest("#btn-dms-toggle")){b.preventDefault(),v();return}}),typeof window.subscribeI18n=="function"&&window.subscribeI18n("mrerp-dms-adapter",c),setTimeout(function(){var b=document.querySelector('.auto-nav-item.active[data-auto-tab="erp"]'),g=document.querySelector('.erp-subtab.active[data-erp-subtab="connect"]');b&&g&&w()},250)})();(function(){const e={};function n(){if(document.getElementById("report-modal"))return;const d=`
        ...
        `;u.innerHTML=l+p}function r(d){return d==null?"":String(d).replace(/[&<>"']/g,u=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[u])}function c(d){const u=new Date,l=u.getFullYear(),p=u.getMonth()+1;if(d==="all")return"all";if(d==="this-month")return`${l}-${String(p).padStart(2,"0")}`;if(d==="last-month"){const m=new Date(l,p-2,1);return`${m.getFullYear()}-${String(m.getMonth()+1).padStart(2,"0")}`}return d==="this-year"?`${l}`:d==="this-quarter"?`${l}-Q${Math.floor((p-1)/3)+1}`:"all"}window.openReportModal=async function(d){d=d||{},n(),typeof applyLang=="function"?applyLang(currentLang):document.querySelectorAll("#report-modal [data-i18n]").forEach(w=>{const b=w.getAttribute("data-i18n");I18N[currentLang]&&I18N[currentLang][b]&&(w.textContent=I18N[currentLang][b])});const u=document.getElementById("report-period-section");u&&(u.style.display=d.mode==="client"?"":"none");const l=document.getElementById("report-tpl-list");l.innerHTML=`<div class="report-tpl-loading">${r(t("report-modal-loading"))}</div>`,document.getElementById("report-modal").style.display="";const p=await s(currentLang,d&&d.mode);i(p),o=d;const m=document.getElementById("report-modal-download"),v=m.cloneNode(!0);m.parentNode.replaceChild(v,m),v.addEventListener("click",()=>f(o))};async function f(d){if(!d)return;const u=document.querySelector('input[name="report-tpl"]:checked');if(!u){showToast(t("report-toast-no-selection"),"info");return}const l=u.value,p=document.querySelector('input[name="report-period"]:checked'),m=p?p.value:"all",v=c(m),w=document.getElementById("report-modal-download"),b=w.innerHTML;w.disabled=!0,w.innerHTML=`<span>${r(t("report-modal-loading"))}</span>`;try{const g=localStorage.getItem("mrpilot_token");let h,_;if(d.mode==="records")h=await fetch("/api/reports/export",{method:"POST",headers:{Authorization:"Bearer "+g,"Content-Type":"application/json"},body:JSON.stringify({template:l,lang:currentLang,records:d.records||[],meta:d.meta||{}})}),_=`mrpilot-${l}-${Date.now()}.xlsx`;else if(d.mode==="client"){const L=`/api/reports/clients/${d.clientId}/export?template=${encodeURIComponent(l)}&lang=${encodeURIComponent(currentLang)}&month=${encodeURIComponent(v)}`;h=await fetch(L,{headers:{Authorization:"Bearer "+g}}),_=`${(d.clientName||"client").replace(/[^a-zA-Z0-9\u0e00-\u0e7f\u4e00-\u9fff]/g,"_").slice(0,40)}-${l}.xlsx`}else if(d.mode==="history-batch")l==="sales_detail_th"?(h=await fetch("/api/ocr/export-by-history-ids",{method:"POST",headers:{Authorization:"Bearer "+g,"Content-Type":"application/json"},body:JSON.stringify({template:"sales_detail_th",lang:currentLang,history_ids:d.historyIds||[],client_id:d.clientId||null})}),_=`Pearnly_SalesDetail_${Date.now()}.xlsx`):(h=await fetch("/api/reports/history/batch_export",{method:"POST",headers:{Authorization:"Bearer "+g,"Content-Type":"application/json"},body:JSON.stringify({template:l,lang:currentLang,history_ids:d.historyIds||[],client_id:d.clientId||null})}),_=`mrpilot-batch-${l}-${Date.now()}.xlsx`);else throw new Error("unknown mode: "+d.mode);if(!h.ok){let L="HTTP "+h.status;try{const C=await h.json();C&&C.detail&&(L=C.detail)}catch(C){console.warn("[batch-export] resp.json err.detail parse failed:",C)}h.status===404?showToast(t("report-toast-empty"),"info"):showToast(t("report-toast-fail")+" · "+L,"error");return}const y=await h.blob();let k=_;const E=(h.headers.get("Content-Disposition")||"").match(/filename\*=UTF-8''([^;]+)/i);if(E)try{k=decodeURIComponent(E[1])}catch{}const I=URL.createObjectURL(y),B=document.createElement("a");B.href=I,B.download=k,document.body.appendChild(B),B.click(),document.body.removeChild(B),URL.revokeObjectURL(I),showToast(t("report-toast-success"),"success"),a()}catch(g){console.error("doDownload fail",g),showToast(t("report-toast-fail")+" · "+(g.message||""),"error")}finally{w.disabled=!1,w.innerHTML=b}}document.addEventListener("DOMContentLoaded",()=>{const d=document.getElementById("btn-export");if(d){const l=d.cloneNode(!0);d.parentNode.replaceChild(l,d),l.addEventListener("click",()=>{if(typeof _results>"u"||!_results||_results.length===0){showToast(t("report-toast-no-selection"),"info");return}openReportModal({mode:"records",records:_results.map(p=>({filename:p.filename,merged_fields:p.merged_fields||{}}))})})}const u=document.getElementById("history-batch-export");u&&u.addEventListener("click",()=>{if(typeof _historySelected>"u"||_historySelected.size===0){showToast(t("report-toast-no-selection"),"info");return}openReportModal({mode:"history-batch",historyIds:Array.from(_historySelected)})})}),window.openClientExportModal=function(d,u){openReportModal({mode:"client",clientId:d,clientName:u||""})}})();const sr=/\.(pdf|jpe?g|png|webp)$/i,ir="mrpilot_folder_watcher",rr=1;let Ut=null;function bn(){return Ut||(Ut=new Promise((e,n)=>{const a=indexedDB.open(ir,rr);a.onupgradeneeded=o=>{const s=o.target.result;s.objectStoreNames.contains("handles")||s.createObjectStore("handles"),s.objectStoreNames.contains("seen")||s.createObjectStore("seen"),s.objectStoreNames.contains("config")||s.createObjectStore("config")},a.onsuccess=o=>e(o.target.result),a.onerror=o=>n(o.target.error)}),Ut)}function Ct(e,n){return bn().then(a=>new Promise((o,s)=>{const r=a.transaction(e,"readonly").objectStore(e).get(n);r.onsuccess=()=>o(r.result),r.onerror=()=>s(r.error)}))}function Je(e,n,a){return bn().then(o=>new Promise((s,i)=>{const r=o.transaction(e,"readwrite");r.objectStore(e).put(a,n),r.oncomplete=()=>s(),r.onerror=()=>i(r.error)}))}function Bt(e,n){return bn().then(a=>new Promise((o,s)=>{const i=a.transaction(e,"readwrite");i.objectStore(e).delete(n),i.oncomplete=()=>o(),i.onerror=()=>s(i.error)}))}function ja(e){return bn().then(n=>new Promise((a,o)=>{const s=n.transaction(e,"readwrite");s.objectStore(e).clear(),s.oncomplete=()=>a(),s.onerror=()=>o(s.error)}))}async function Pa(e){if(!e)return!1;try{const n={mode:"read"};let a=await e.queryPermission(n);return a==="granted"?!0:(a=await e.requestPermission(n),a==="granted")}catch(n){return console.warn("[folder] permission check failed:",n),!1}}async function lr(e){const n=new FormData;n.append("file",e,e.name),n.append("source","folder");const a=await fetch("/api/ocr/recognize?source=folder",{method:"POST",headers:{Authorization:"Bearer "+token,"X-Source":"folder"},body:n});if(!a.ok){let o="http_"+a.status;try{const s=await a.json();o=s&&s.detail?typeof s.detail=="string"?s.detail:s.detail.code||JSON.stringify(s.detail):o}catch{}throw new Error(o)}return await a.json()}async function cr(e){try{const a=(await e.getFile()).size;return await new Promise(s=>setTimeout(s,3e3)),(await e.getFile()).size===a&&a>0}catch{return!1}}async function No(e,n,a,o){if(o>10)return;let s;try{s=await e.queryPermission({mode:"read"})}catch{s="denied"}if(s==="granted")for await(const i of e.values()){const r=n?`${n}/${i.name}`:i.name;if(i.kind==="file"){if(!sr.test(i.name))continue;let c;try{c=await i.getFile()}catch{continue}const f=`${r}::${c.size}::${c.lastModified}`;if(await Ct("seen",f))continue;a.push({entry:i,file:c,seenKey:f,relPath:r})}else if(i.kind==="directory")try{await No(i,r,a,o+1)}catch{}}}(function(){const n=typeof window<"u"&&"showDirectoryPicker"in window;let a=null,o=null,s=60,i=!1,r=!1,c=0,f=0,d=0,u=[],l=null,p=!1;function m(z,q){const U=document.getElementById("folder-status-summary");U&&(U.setAttribute("data-i18n",z),U.textContent=t(z),U.className="auto-status-pill"+(q?" "+q:""))}function v(z){["folder-unsupported","folder-empty","folder-active"].forEach(q=>{const U=document.getElementById(q);U&&(U.style.display=q===z?"":"none")})}function w(z){if(!z)return"-";const q=z instanceof Date?z:new Date(z),U=String(q.getHours()).padStart(2,"0"),ie=String(q.getMinutes()).padStart(2,"0"),oe=String(q.getSeconds()).padStart(2,"0");return`${U}:${ie}:${oe}`}function b(){v("folder-active");const z=document.getElementById("folder-config-path");z&&a&&(z.textContent=a.name||"-");const q=document.getElementById("folder-interval-select");q&&(q.value=String(s)),document.getElementById("folder-stat-last").textContent=l?w(l):"-",document.getElementById("folder-stat-processed").textContent=String(c),document.getElementById("folder-stat-failed").textContent=String(f),document.getElementById("folder-stat-queue").textContent=String(d);const U=document.getElementById("btn-folder-pause"),ie=document.getElementById("btn-folder-resume");U&&(U.style.display=i?"none":""),ie&&(ie.style.display=i?"":"none"),i?m("folder-status-paused","paused"):m("folder-status-running","running");const oe=document.getElementById("folder-status-text");oe&&(oe.setAttribute("data-i18n",i?"folder-status-paused":"folder-status-running"),oe.textContent=t(i?"folder-status-paused":"folder-status-running"));const _e=document.getElementById("folder-status-pulse");_e&&(_e.className="folder-status-pulse"+(i?" paused":"")),g()}function g(){const z=document.getElementById("folder-recent-list");if(z){if(u.length===0){z.innerHTML=`<div class="folder-recent-empty">${escapeHtml(t("folder-recent-empty"))}</div>`;return}z.innerHTML=u.slice(0,20).map(q=>{let U;q.status==="ok"?U=`<span class="folder-recent-icon ok">${svgIcon("check",12)}</span>`:q.status==="dup"?U=`<span class="folder-recent-icon dup" title="${escapeHtml(t("folder-recent-dup"))}">${svgIcon("copy",12)}</span>`:q.status==="skip"?U=`<span class="folder-recent-icon skip" title="${escapeHtml(t("folder-recent-skip"))}">${svgIcon("minus",12)}</span>`:U=`<span class="folder-recent-icon fail">${svgIcon("alert",12)}</span>`;const ie=q.status==="fail"&&q.error?q.error:q.status==="dup"&&q.reason||q.status==="skip"&&q.reason?q.reason:"",oe=ie?`<div class="folder-recent-err">${escapeHtml(ie)}</div>`:"";return`
            ...
            `}).join("")}}function h(z){u.unshift(z),u.length>50&&(u.length=50),Je("config","recent_list",u).catch(()=>{})}async function _(){if(!(r||i||!a)){r=!0;try{if(await a.queryPermission({mode:"read"})!=="granted"){console.warn("[folder] permission lost · stop"),S(),showToast("warn",t("folder-permission-lost"));return}l=new Date;const q=[];await No(a,"",q,0),d=q.length,b();for(const U of q){if(i)break;if(!await cr(U.entry)){d=Math.max(0,d-1),b();continue}try{let oe;try{oe=await U.entry.getFile()}catch{oe=U.file}const _e=await lr(oe);await Je("seen",U.seenKey,{name:oe.name,relPath:U.relPath,size:oe.size,lastModified:oe.lastModified,processed_at:Date.now()});const Ke=_e.history_ids||(_e.history_id?[_e.history_id]:[]),En=_e.duplicate_warnings||[],In=U.relPath||oe.name;Ke.length>0?(c+=Ke.length,h({name:In,status:"ok",time:new Date,history_id:Ke[0],count:Ke.length}),await Je("config","processed_count",c)):En.length>0?h({name:In,status:"dup",time:new Date,reason:t("folder-recent-dup-reason")}):h({name:In,status:"skip",time:new Date,reason:t("folder-recent-skip-reason")})}catch(oe){f++,h({name:U.relPath||U.file.name,status:"fail",time:new Date,error:String(oe.message||oe)}),await Je("config","failed_count",f)}d=Math.max(0,d-1),b()}}catch(z){console.warn("[folder] scan error:",z)}finally{r=!1,b()}}}function y(){o&&clearInterval(o),o=setInterval(_,s*1e3)}function k(){o&&(clearInterval(o),o=null)}function x(z){if(!a||i)return;const q=typeof t=="function"?t("folder-unload-warn"):"Folder watcher running · close anyway?";return z.preventDefault(),z.returnValue=q,q}function E(){window._pearnlyFolderUnloadAttached||(window._pearnlyFolderUnloadAttached=!0,window.addEventListener("beforeunload",x))}function I(){window._pearnlyFolderUnloadAttached&&(window._pearnlyFolderUnloadAttached=!1,window.removeEventListener("beforeunload",x))}function B(){i=!1,y(),E(),b(),_()}function L(){i=!0,k(),I(),b()}function C(){i=!1,y(),E(),b(),_()}function S(){i=!0,k(),I()}async function $(){try{const z=await window.showDirectoryPicker({mode:"read",startIn:"documents"});if(!await Pa(z)){showToast("warn",t("folder-permission-denied"));return}a=z,await Je("handles","main",z),c=0,f=0,d=0,u=[],await Je("config","processed_count",0),await Je("config","failed_count",0),await ja("seen"),B()}catch(z){z&&z.name!=="AbortError"&&console.warn("[folder] pick failed:",z)}}async function j(){await showConfirm(t("folder-confirm-remove"),{danger:!0})&&(S(),a=null,c=0,f=0,d=0,u=[],await Bt("handles","main"),await Bt("config","processed_count"),await Bt("config","failed_count"),await ja("seen"),v("folder-empty"),m("folder-status-empty",""))}async function N(){u=[];try{await Bt("config","recent_list")}catch{}g()}async function X(){if(p)return;if(p=!0,!n){v("folder-unsupported"),m("folder-status-unsupported",""),ae();return}ne();let z=null;try{z=await Ct("handles","main")}catch{}if(!z){v("folder-empty"),m("folder-status-empty","");return}if(!await Pa(z)){v("folder-empty"),m("folder-status-empty",""),await Bt("handles","main"),showToast("warn",t("folder-permission-lost-restart"));return}a=z;try{c=await Ct("config","processed_count")||0}catch{}try{f=await Ct("config","failed_count")||0}catch{}try{const U=await Ct("config","recent_list");Array.isArray(U)&&(u=U.map(ie=>({...ie,time:ie.time?new Date(ie.time):new Date})))}catch{}B()}function ne(){const z=document.getElementById("btn-folder-pick"),q=document.getElementById("btn-folder-pause"),U=document.getElementById("btn-folder-resume"),ie=document.getElementById("btn-folder-scan-now"),oe=document.getElementById("btn-folder-remove"),_e=document.getElementById("btn-folder-clear-recent"),Ke=document.getElementById("folder-interval-select");z&&z.addEventListener("click",$),q&&q.addEventListener("click",L),U&&U.addEventListener("click",C),ie&&ie.addEventListener("click",()=>{_()}),oe&&oe.addEventListener("click",j),_e&&_e.addEventListener("click",N),Ke&&Ke.addEventListener("change",En=>{s=parseInt(En.target.value,10)||60,i||y()}),de()}function de(){document.querySelectorAll('[data-auto-panel="folder"] [data-tab-jump]').forEach(z=>{z.dataset.tabJumpBound||(z.dataset.tabJumpBound="1",z.addEventListener("click",q=>{const U=q.currentTarget.dataset.tabJump;if(U==="email")typeof switchAutomationTab=="function"&&switchAutomationTab("email");else if(U==="upload"){const ie=document.querySelector('[data-page="recognize"]')||document.querySelector('[data-page="upload"]');ie&&ie.click()}}))})}function ae(){de()}window._loadFolderWatcherPanel=X})();function dr(){try{if(navigator.userAgentData&&Array.isArray(navigator.userAgentData.brands))return navigator.userAgentData.brands.some(n=>/chromium|google chrome|microsoft edge/i.test(n.brand||""))}catch{}const e=navigator.userAgent||"";return!!(/Edg\//.test(e)||/Chrome\//.test(e)&&!/OPR\/|YaBrowser|Opera/.test(e))}function zn(){try{if(dr()||localStorage.getItem("pearnly_chrome_banner_dismissed")==="1")return;const e=document.getElementById("chrome-only-banner");if(!e)return;const n=e.querySelector('[data-i18n="chrome-banner-msg"]'),a=e.querySelector('[data-i18n="chrome-banner-dismiss"]');n&&typeof t=="function"&&(n.textContent=t("chrome-banner-msg")),a&&typeof t=="function"&&(a.textContent=t("chrome-banner-dismiss")),e.style.display="";const o=document.getElementById("chrome-only-banner-close");o&&!o.dataset.bound&&(o.dataset.bound="1",o.addEventListener("click",()=>{e.style.display="none";try{localStorage.setItem("pearnly_chrome_banner_dismissed","1")}catch{}}))}catch{}}typeof document<"u"&&(document.readyState==="loading"?document.addEventListener("DOMContentLoaded",zn):setTimeout(zn,0));window._refreshChromeBanner=zn;const pr=`
        <div class="modal">
            <div class="modal-head">
    ...
    `;fe("email-modal",pr);const F={account:null,presets:null,modalMode:"new",loaded:!1,triggering:!1,autoRefreshTimer:null};function Da(e){F.modalMode=e;const n=document.getElementById("email-modal");if(!n)return;const a=document.getElementById("email-preset");a.innerHTML="";const o=F.presets||{},s=["gmail","outlook","yahoo","icloud","qq","163","custom"],i={gmail:"Gmail",outlook:"Outlook / Office365",yahoo:"Yahoo Mail",icloud:"iCloud",qq:"QQ 邮箱",163:"网易 163"};s.forEach(g=>{if(!o[g])return;const h=document.createElement("option");h.value=g,h.textContent=g==="custom"?t("email-preset-custom"):i[g]||g,a.appendChild(h)});const r=document.getElementById("email-modal-title"),c=document.getElementById("email-address"),f=document.getElementById("email-password"),d=document.getElementById("email-imap-host"),u=document.getElementById("email-imap-port"),l=document.getElementById("email-imap-ssl"),p=document.getElementById("email-folder"),m=document.getElementById("email-mark-read"),v=document.getElementById("email-bind-enabled"),w=document.getElementById("email-test-result"),b=document.getElementById("email-adv-details");if(w&&(w.style.display="none",w.textContent=""),e==="edit"&&F.account){r.setAttribute("data-i18n","email-modal-title-edit"),r.textContent=t("email-modal-title-edit"),c.value=F.account.email_address||"",f.value="",f.setAttribute("data-i18n-placeholder","email-field-password-edit-ph"),f.placeholder=t("email-field-password-edit-ph"),d.value=F.account.imap_host||"",u.value=F.account.imap_port||993,l.checked=F.account.imap_use_ssl!==!1,p.value=F.account.folder||"INBOX",m.checked=F.account.mark_as_read!==!1,v.checked=F.account.enabled!==!1;const g=document.getElementById("email-filter-sender"),h=document.getElementById("email-filter-subject");g&&(g.value=F.account.filter_sender||""),h&&(h.value=F.account.filter_subject||""),Fa(F.account.interval_min||15),a.value=mr(F.account.imap_host)||"custom",b&&(b.open=!0)}else{r.setAttribute("data-i18n","email-modal-title-new"),r.textContent=t("email-modal-title-new"),c.value="",f.value="",f.setAttribute("data-i18n-placeholder","email-field-password-ph"),f.placeholder=t("email-field-password-ph"),a.value="gmail",ra("gmail"),p.value="INBOX",m.checked=!0,v.checked=!0;const g=document.getElementById("email-filter-sender"),h=document.getElementById("email-filter-subject");g&&(g.value=""),h&&(h.value=""),Fa(15),b&&(b.open=!1)}fr(),n.style.display="flex",setTimeout(()=>c.focus(),60)}function Sn(){const e=document.getElementById("email-modal");e&&(e.style.display="none")}function ra(e){const n=(F.presets||{})[e];if(!n||e==="custom")return;const a=document.getElementById("email-imap-host"),o=document.getElementById("email-imap-port"),s=document.getElementById("email-imap-ssl");a&&(a.value=n.host||""),o&&(o.value=n.port||993),s&&(s.checked=n.ssl!==!1)}const ur={"gmail.com":"gmail","googlemail.com":"gmail","outlook.com":"outlook","hotmail.com":"outlook","live.com":"outlook","office365.com":"outlook","msn.com":"outlook","yahoo.com":"yahoo","yahoo.co.jp":"yahoo","icloud.com":"icloud","me.com":"icloud","mac.com":"icloud","qq.com":"qq","foxmail.com":"qq","163.com":"163","126.com":"163","yeah.net":"163"};function Ra(e){if(!e||!e.includes("@"))return;const n=e.split("@")[1].toLowerCase().trim(),a=ur[n];if(!a)return;const o=document.getElementById("email-preset");if(!o)return;const s=o.value;s&&s!=="custom"&&s!==""&&s===a||(o.value=a,ra(a))}function mr(e){if(!e)return null;const n=F.presets||{};for(const a in n)if(a!=="custom"&&n[a]&&n[a].host===e)return a;return null}function Oo(){const e=document.querySelector("#email-interval-options .email-interval-btn.active"),n=e?parseInt(e.dataset.interval,10):15;return{email_address:(document.getElementById("email-address").value||"").trim(),password:document.getElementById("email-password").value||"",imap_host:(document.getElementById("email-imap-host").value||"").trim(),imap_port:parseInt(document.getElementById("email-imap-port").value||"993",10)||993,imap_use_ssl:document.getElementById("email-imap-ssl").checked,folder:(document.getElementById("email-folder").value||"INBOX").trim()||"INBOX",mark_as_read:document.getElementById("email-mark-read").checked,enabled:document.getElementById("email-bind-enabled").checked,interval_min:[5,15,60].includes(n)?n:15,filter_sender:(document.getElementById("email-filter-sender").value||"").trim()||null,filter_subject:(document.getElementById("email-filter-subject").value||"").trim()||null}}function fr(){const e=document.getElementById("email-interval-options");!e||e._bound||(e._bound=!0,e.addEventListener("click",n=>{const a=n.target.closest(".email-interval-btn");a&&(e.querySelectorAll(".email-interval-btn").forEach(o=>o.classList.remove("active")),a.classList.add("active"))}))}function Fa(e){const n=[5,15,60].includes(e)?e:15,a=document.getElementById("email-interval-options");a&&a.querySelectorAll(".email-interval-btn").forEach(o=>{o.classList.toggle("active",parseInt(o.dataset.interval,10)===n)})}function he(e,n){const a=document.getElementById("email-test-result");a&&(a.style.display="",a.textContent=n,a.className="form-test-result "+(e==="ok"?"ok":e==="running"?"running":"fail"))}async function vr(){const e=Oo();if(!e.email_address){he("fail",t("email-addr-required"));return}if(!e.password){he("fail",t("email-password-required"));return}if(!e.imap_host){he("fail",t("email-host-required"));return}const n=document.getElementById("btn-email-modal-test");n&&(n.disabled=!0),he("running",t("email-test-running"));try{const a=await fetch("/api/email-ingest/test",{method:"POST",headers:{Authorization:"Bearer "+token,"Content-Type":"application/json"},body:JSON.stringify({email_address:e.email_address,password:e.password,imap_host:e.imap_host,imap_port:e.imap_port,imap_use_ssl:e.imap_use_ssl,folder:e.folder})}),o=await a.json().catch(()=>({}));if(a.ok&&o.success)he("ok",t("email-test-ok",{folder:e.folder,n:o.folder_count??"?"}));else{const s=o.error_msg||"";s==="auth_failed"||/auth/i.test(s)?he("fail",t("email-test-auth-fail")):he("fail",t("email-test-fail",{msg:s||a.status}))}}catch(a){he("fail",t("email-test-fail",{msg:String(a).slice(0,120)}))}finally{n&&(n.disabled=!1)}}(function(){async function e(){const p=document.getElementById("email-empty"),m=document.getElementById("email-account-card");if(document.getElementById("email-logs-section"),!(!p||!m))try{const v=await fetch("/api/email-ingest/account",{headers:{Authorization:"Bearer "+token}});if(v.status===401){localStorage.removeItem("mrpilot_token");const b=await v.json().catch(()=>({}));if((typeof b.detail=="string"?b.detail:b.detail&&b.detail.code||"")==="auth.session_revoked"){_showSessionRevokedModal();return}window.location.href="/";return}if(!v.ok){a("none");return}const w=await v.json();F.account=w.account||null,F.presets=w.presets||{},F.loaded=!0,n(),F.account&&d()}catch(v){console.error("[email-ingest] load failed",v),a("none")}}function n(){const p=document.getElementById("email-empty"),m=document.getElementById("email-account-card"),v=document.getElementById("email-logs-section");if(!F.account){p.style.display="",m.style.display="none",v&&(v.style.display="none"),a("none");return}p.style.display="none",m.style.display="",v&&(v.style.display="");const w=document.getElementById("email-account-addr"),b=document.getElementById("email-account-host"),g=document.getElementById("email-account-last"),h=document.getElementById("email-last-error"),_=document.getElementById("email-enabled-toggle");if(w&&(w.textContent=F.account.email_address||"-"),b&&(b.textContent=`${F.account.imap_host||"-"}:${F.account.imap_port||993}`),g){const y=F.account.last_fetched_at;if(!y)g.textContent=t("email-last-never");else{const k=o(y),x=!F.account.last_error;g.textContent=x?t("email-last-ok",{time:k}):t("email-last-fail",{time:k})}}h&&(F.account.last_error?(h.style.display="",h.textContent=s(F.account.last_error)):h.style.display="none"),_&&(_.checked=!!F.account.enabled),F.account.enabled?F.account.last_error?a("error"):a("on"):a("off")}function a(p){const m=document.getElementById("email-status-summary");if(!m)return;m.classList.remove("none","ready","active","coming");let v="auto-status-loading";p==="none"?(v="email-status-none",m.classList.add("none")):p==="on"?(v="email-status-on",m.classList.add("active")):p==="off"?(v="email-status-off",m.classList.add("coming")):p==="error"&&(v="email-status-error",m.classList.add("none")),m.setAttribute("data-i18n",v),m.textContent=t(v)}function o(p){if(!p)return"";const m=new Date(p);if(isNaN(m.getTime()))return"";const v=w=>String(w).padStart(2,"0");return`${v(m.getMonth()+1)}-${v(m.getDate())} ${v(m.getHours())}:${v(m.getMinutes())}`}function s(p){if(!p)return"";const m=String(p);return/auth|AUTHENTICATIONFAILED|invalid credentials/i.test(m)?t("email-test-auth-fail"):/timeout|timed out/i.test(m)?t("email.timeout"):(/ENOTFOUND|getaddrinfo/i.test(m),m)}async function i(){const p=Oo();if(!p.email_address){he("fail",t("email-addr-required"));return}if(F.modalMode==="new"&&!p.password){he("fail",t("email-password-required"));return}if(!p.imap_host){he("fail",t("email-host-required"));return}const m=document.getElementById("btn-email-modal-save");m&&(m.disabled=!0);const v={...p};F.modalMode==="edit"&&!v.password&&delete v.password;try{const w=await fetch("/api/email-ingest/account",{method:"PUT",headers:{Authorization:"Bearer "+token,"Content-Type":"application/json"},body:JSON.stringify(v)}),b=await w.json().catch(()=>({}));if(w.ok&&b.ok)F.account=b.account,showToast(t("email-save-ok"),"success"),Sn(),n(),d();else{const h="email."+(b.detail||"").split(".").slice(-1)[0];he("fail",t(h)!==h?t(h):t("email-save-fail"))}}catch{he("fail",t("email-save-fail"))}finally{m&&(m.disabled=!1)}}async function r(){if(!(!F.account||!await showConfirm(t("email-unbind-confirm",{email:F.account.email_address}),{danger:!0,okText:t("email-btn-unbind")})))try{if((await fetch("/api/email-ingest/account",{method:"DELETE",headers:{Authorization:"Bearer "+token}})).ok){F.account=null,showToast(t("email-unbind-ok"),"success"),n();const v=document.getElementById("email-logs-list");v&&(v.innerHTML="")}else showToast(t("email-unbind-fail"),"error")}catch{showToast(t("email-unbind-fail"),"error")}}async function c(){if(!F.account||F.triggering)return;if(!F.account.enabled){showToast(t("email.disabled"),"error");return}F.triggering=!0;const p=document.getElementById("btn-email-trigger"),m=p?p.innerHTML:"";p&&(p.disabled=!0,p.innerHTML=`<span>${escapeHtml(t("email-trigger-running"))}</span>`);try{const v=await fetch("/api/email-ingest/trigger",{method:"POST",headers:{Authorization:"Bearer "+token}}),w=await v.json().catch(()=>({}));if(v.ok){const b=w.emails_scanned||0,g=w.ocr_succeeded||0,h=w.ocr_failed||0;b===0&&g===0&&h===0?showToast(t("email-trigger-empty"),"success"):showToast(t("email-trigger-result",{scanned:b,ok:g,fail:h}),h>0?"warn":"success")}else{const g="email."+(w.detail||"").split(".").slice(-1)[0];showToast(t(g)!==g?t(g):t("email-trigger-fail"),"error")}await e()}catch{showToast(t("email-trigger-fail"),"error")}finally{F.triggering=!1,p&&(p.disabled=!1,p.innerHTML=m)}}async function f(){if(!F.account)return;const p=document.getElementById("email-enabled-toggle"),m=!!(p&&p.checked),v=F.account.enabled;try{const w=await fetch("/api/email-ingest/account",{method:"PUT",headers:{Authorization:"Bearer "+token,"Content-Type":"application/json"},body:JSON.stringify({email_address:F.account.email_address,imap_host:F.account.imap_host,imap_port:F.account.imap_port,imap_use_ssl:F.account.imap_use_ssl,folder:F.account.folder||"INBOX",filter_subject:F.account.filter_subject||null,filter_sender:F.account.filter_sender||null,mark_as_read:F.account.mark_as_read!==!1,enabled:m})}),b=await w.json().catch(()=>({}));w.ok&&b.ok?(F.account=b.account,n()):(p&&(p.checked=v),showToast(t("email-toggle-fail"),"error"))}catch{p&&(p.checked=v),showToast(t("email-toggle-fail"),"error")}}async function d(){const p=document.getElementById("email-logs-list");if(p){p.innerHTML=`<div class="erp-logs-empty">${escapeHtml(t("erp-logs-loading"))}</div>`;try{const m=await fetch("/api/email-ingest/logs?limit=20",{headers:{Authorization:"Bearer "+token}});if(!m.ok){p.innerHTML=`<div class="erp-logs-empty">${escapeHtml(t("erp-logs-error"))}</div>`;return}const v=await m.json();if(!Array.isArray(v)||v.length===0){p.innerHTML=`<div class="erp-logs-empty">${escapeHtml(t("email-logs-empty"))}</div>`;return}p.innerHTML=v.map(u).join("")}catch{p.innerHTML=`<div class="erp-logs-empty">${escapeHtml(t("erp-logs-error"))}</div>`}}}function u(p){const m=o(p.created_at),v=p.status||"failed",w=v==="success"?"ok":v==="partial"?"partial":"fail",b=v==="success"?"✓":v==="partial"?"◐":"✗",g=p.trigger==="manual"?`<span class="log-tag manual">${escapeHtml(t("email-log-tag-manual"))}</span>`:`<span class="log-tag auto">${escapeHtml(t("email-log-tag-auto"))}</span>`,h=t("email-log-counts",{scanned:p.emails_scanned||0,att:p.attachments_found||0,ok:p.ocr_succeeded||0,fail:p.ocr_failed||0}),_=(p.elapsed_ms||0)+"ms";return`
        ...
        `}function l(){const p=document.getElementById("btn-email-bind");p&&p.addEventListener("click",()=>Da("new"));const m=document.getElementById("btn-email-edit");m&&m.addEventListener("click",()=>Da("edit"));const v=document.getElementById("btn-email-unbind");v&&v.addEventListener("click",r);const w=document.getElementById("btn-email-trigger");w&&w.addEventListener("click",c);const b=document.getElementById("email-enabled-toggle");b&&b.addEventListener("change",f);const g=document.getElementById("email-modal-close");g&&g.addEventListener("click",Sn);const h=document.getElementById("btn-email-modal-cancel");h&&h.addEventListener("click",Sn);const _=document.getElementById("btn-email-modal-test");_&&_.addEventListener("click",vr);const y=document.getElementById("btn-email-modal-save");y&&y.addEventListener("click",i);const k=document.getElementById("email-preset");k&&k.addEventListener("change",I=>ra(I.target.value));const x=document.getElementById("email-address");x&&!x.dataset.autoBound&&(x.dataset.autoBound="1",x.addEventListener("blur",I=>Ra((I.target.value||"").trim())),x.addEventListener("input",I=>{const B=(I.target.value||"").trim();B.includes("@")&&B.split("@")[1].includes(".")&&Ra(B)}));const E=document.getElementById("btn-email-refresh-logs");E&&E.addEventListener("click",()=>{E.classList.add("spinning"),setTimeout(()=>E.classList.remove("spinning"),600),d()})}l(),window._loadEmailIngestPanel=e,window._rerenderEmailIngest=function(){if(!F.loaded)return;n();const p=document.getElementById("email-logs-section");F.account&&p&&p.open&&d()},window._startEmailLogAutoRefresh=function(){F.autoRefreshTimer||(F.autoRefreshTimer=setInterval(()=>{F.account&&F.loaded&&d()},3e4))},window._stopEmailLogAutoRefresh=function(){F.autoRefreshTimer&&(clearInterval(F.autoRefreshTimer),F.autoRefreshTimer=null)}})();const hr=`
...
`;fe("bank-cand-drawer",hr);const gr=`
    <div class="modal" style="max-width: 420px;">
        <div class="modal-head">
...
`;fe("bank-client-picker-modal",gr);const M={sessions:[],currentSession:null,currentTxs:[],currentFilter:"all",currentTxForDrawer:null,loaded:!1,queue:[],qSeq:0,sessionFilter:"all",pickerSelected:null};function br(e){const n=Number(e||0);let a="score-low";return n>=85?a="score-high":n>=60&&(a="score-mid"),'<span class="bank-cand-score '+a+'">'+n.toFixed(0)+" "+t("bank-cand-score-unit")+"</span>"}function yr(e){const n=document.getElementById("bank-upload-progress");n&&(n.style.display="none")}function wr(){const e=document.getElementById("bank-upload-error");e&&(e.style.display="none")}function kr(e){return{"bank_recon.only_pdf":t("bank-err-only-pdf"),"bank_recon.empty_file":t("bank-err-empty"),"bank_recon.file_too_large":t("bank-err-too-large"),"bank_recon.save_failed":t("bank-err-server"),"bank_recon.scanned":t("bank-err-scanned"),"bank_recon.no_tx":t("bank-err-no-tx"),network:t("bank-err-network")}[e]||t("bank-err-unknown")+" ("+e+")"}function et(e){if(e==null)return"-";const n=Number(e);return isNaN(n)?"-":n.toLocaleString("en-US",{minimumFractionDigits:2,maximumFractionDigits:2})}function gt(e){if(!e)return"-";const n=String(e);return n.length>=10?n.slice(0,10):n}function Vo(e,n){return!e&&!n?"":(gt(e)||"?")+" ~ "+(gt(n)||"?")}function K(e){return e==null?"":String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}async function xr(e){M.currentTxForDrawer=e;const n=document.getElementById("bank-detail-body");n&&n.classList.add("has-pane");const a=document.getElementById("bank-cand-pane-title"),o=document.getElementById("bank-cand-pane-sub"),s=document.getElementById("bank-cand-pane-foot");if(a&&(a.textContent=t("bank-cand-pane-current")),o){const r=e.direction==="OUT"?"-":"+",c=e.direction==="OUT"?"bank-out":"bank-in";o.innerHTML=`${K(gt(e.tx_date))}
    ...
    `}function $r(e){if(e.parse_status==="parse_failed")return`<span class="bank-session-count cnt-failed">${t("bank-count-parse-failed")}</span>`;if(e.parse_status!=="parsed")return`<span class="bank-session-count">${t("bank-count-parsing")}</span>`;const n=e.tx_count||0,a=e.matched_count||0,o=e.unmatched_count||0,s=[`<span class="bank-session-count">${n} ${t("bank-count-tx")}</span>`];return a>0&&s.push(`<span class="bank-session-count cnt-matched">${a} ${t("bank-count-matched")}</span>`),o>0&&s.push(`<span class="bank-session-count cnt-unmatched">${o} ${t("bank-count-unmatched")}</span>`),s.join("")}function Hr(){document.getElementById("bank-detail").style.display="",document.querySelector(".bank-sessions-section").style.display="none",Uo(),la(),ca()}function da(){document.getElementById("bank-detail").style.display="none",document.querySelector(".bank-sessions-section").style.display="";const e=document.getElementById("bank-detail-body");e&&e.classList.remove("has-pane"),M.currentTxForDrawer=null}const Ar=3;function jr(){return M.qSeq+=1,"q"+M.qSeq+"_"+Date.now()}async function Pr(e){const n=Array.from(e.target.files||[]);if(e.target.value="",n.length!==0){for(const a of n){const o={id:jr(),file:a,name:a.name,size:a.size,status:"pending",progress:0,error_code:null,tx_count:0,session_id:null};a.name.toLowerCase().endsWith(".pdf")?a.size>20*1024*1024&&(o.status="failed",o.error_code="bank_recon.file_too_large"):(o.status="failed",o.error_code="bank_recon.only_pdf"),M.queue.push(o)}Dr(),we(),pa()}}function Dr(){const e=document.getElementById("bank-upload-queue");e&&(e.style.display=""),yr(),wr()}function we(){const e=document.getElementById("bank-upload-queue-list"),n=document.getElementById("bank-upload-queue-summary");if(!e)return;if(M.queue.length===0){e.innerHTML="",n&&(n.textContent="");const r=document.getElementById("bank-upload-queue");r&&(r.style.display="none");return}let a=0,o=0,s=0,i=0;for(const r of M.queue)r.status==="ok"?a++:r.status==="failed"?o++:r.status==="uploading"||r.status==="parsing"?s++:i++;n&&(n.textContent=t("bank-queue-summary").replace("{ok}",a).replace("{run}",s).replace("{wait}",i).replace("{fail}",o)),e.innerHTML=M.queue.map(Rr).join(""),e.querySelectorAll("[data-q-act]").forEach(r=>{const c=r.dataset.qAct,f=r.dataset.qId;r.addEventListener("click",()=>{c==="retry"&&Fr(f),c==="remove"&&qr(f)})})}function Rr(e){const n=(e.size/1024).toFixed(0)+" KB";let a="",o="";if(e.status==="pending")a='<span class="bq-stat bq-wait">'+t("bank-queue-status-wait")+"</span>",o='<button data-q-act="remove" data-q-id="'+K(e.id)+'" class="bq-act">×</button>';else if(e.status==="uploading")a='<span class="bq-stat bq-run">'+t("bank-queue-status-uploading")+'</span><div class="bq-bar"><div class="bq-bar-fill" style="width:'+(e.progress||0)+'%"></div></div>';else if(e.status==="parsing")a='<span class="bq-stat bq-run">'+t("bank-queue-status-parsing")+'</span><div class="bq-bar"><div class="bq-bar-fill bq-bar-indet"></div></div>';else if(e.status==="ok")a='<span class="bq-stat bq-ok">'+t("bank-queue-status-ok").replace("{n}",e.tx_count||0)+"</span>",o='<button data-q-act="remove" data-q-id="'+K(e.id)+'" class="bq-act">×</button>';else if(e.status==="failed"){const s=kr(e.error_code||"unknown");a='<span class="bq-stat bq-fail" title="'+K(s)+'">'+K(s)+"</span>",o='<button data-q-act="retry" data-q-id="'+K(e.id)+'" class="bq-act bq-act-retry">'+t("bank-queue-retry")+'</button><button data-q-act="remove" data-q-id="'+K(e.id)+'" class="bq-act">×</button>'}return'<div class="bq-row" data-q-row="'+K(e.id)+'"><div class="bq-name" title="'+K(e.name)+'">'+K(e.name)+'</div><div class="bq-size">'+n+'</div><div class="bq-status">'+a+'</div><div class="bq-actions">'+o+"</div></div>"}function Fr(e){const n=M.queue.find(a=>a.id===e);n&&(n.status="pending",n.error_code=null,n.progress=0,we(),pa())}function qr(e){const n=M.queue.findIndex(o=>o.id===e);if(n<0)return;const a=M.queue[n];a.status==="uploading"||a.status==="parsing"||(M.queue.splice(n,1),we())}function zr(){M.queue=M.queue.filter(e=>e.status!=="ok"),we()}async function pa(){for(;;){if(M.queue.filter(a=>a.status==="uploading"||a.status==="parsing").length>=Ar)return;const n=M.queue.find(a=>a.status==="pending");if(!n){M.queue.every(a=>a.status==="ok"||a.status==="failed")&&(await xt(),typeof window.loadReconcilePage=="function"&&window.loadReconcilePage());return}Nr(n).then(()=>pa())}}async function Nr(e){e.status="uploading",e.progress=0,we();try{const n=new FormData;n.append("file",e.file,e.name);const a=await new Promise((s,i)=>{const r=new XMLHttpRequest;r.open("POST","/api/bank-recon/upload"),r.setRequestHeader("Authorization","Bearer "+token),r.upload.onprogress=c=>{c.lengthComputable&&(e.progress=Math.min(99,Math.round(c.loaded/c.total*100)),we())},r.upload.onload=()=>{e.status="parsing",we()},r.onload=()=>{r.status>=200&&r.status<300?s({status:r.status,text:r.responseText}):s({status:r.status,text:r.responseText})},r.onerror=()=>i(new Error("network")),r.send(n)});let o={};try{o=JSON.parse(a.text||"{}")}catch{o={}}if(a.status>=400){e.status="failed",e.error_code=o&&o.detail||"unknown",we();return}if(o.parse_status==="parse_failed"){e.status="failed",e.error_code=o.error==="scanned_pdf_not_yet"?"bank_recon.scanned":"bank_recon.no_tx",we();return}e.status="ok",e.tx_count=o.tx_count||0,e.session_id=o.session_id||null,we()}catch(n){console.warn("[bank-recon] upload failed",n),e.status="failed",e.error_code="network",we()}}async function Wo(){if(M.loaded){za();return}M.loaded=!0,Or(),await xt(),za()}function Or(){const e=document.getElementById("bank-file-input");e&&!e._bound&&(e._bound=!0,e.addEventListener("change",Pr));const n=document.getElementById("btn-bank-queue-clear-done");n&&!n._bound&&(n._bound=!0,n.addEventListener("click",zr));const a=document.getElementById("btn-bank-back");a&&!a._bound&&(a._bound=!0,a.addEventListener("click",()=>{M.currentSession=null,M.currentTxs=[],da()}));const o=document.getElementById("btn-bank-delete");o&&!o._bound&&(o._bound=!0,o.addEventListener("click",Br));const s=document.getElementById("btn-bank-run-match");s&&!s._bound&&(s._bound=!0,s.addEventListener("click",Ir)),document.querySelectorAll(".bank-filter-btn").forEach(u=>{u._bound||(u._bound=!0,u.addEventListener("click",()=>{M.currentFilter=u.dataset.bankFilter||"all",document.querySelectorAll(".bank-filter-btn").forEach(l=>{l.classList.toggle("active",l===u)}),la()}))}),document.querySelectorAll("[data-bank-cand-close]").forEach(u=>{u._bound||(u._bound=!0,u.addEventListener("click",qt))});const i=document.getElementById("btn-bank-cand-pane-close");i&&!i._bound&&(i._bound=!0,i.addEventListener("click",qt));const r=document.getElementById("btn-bank-cand-ignore");r&&!r._bound&&(r._bound=!0,r.addEventListener("click",qa));const c=document.getElementById("btn-bank-cand-ignore-pane");c&&!c._bound&&(c._bound=!0,c.addEventListener("click",qa));const f=document.getElementById("bank-client-badge");f&&!f._bound&&(f._bound=!0,f.addEventListener("click",Sr)),document.querySelectorAll("[data-bank-client-picker-close]").forEach(u=>{u._bound||(u._bound=!0,u.addEventListener("click",Go))});const d=document.getElementById("btn-bank-client-picker-save");d&&!d._bound&&(d._bound=!0,d.addEventListener("click",Tr)),document.querySelectorAll(".bank-sessions-chip").forEach(u=>{u._bound||(u._bound=!0,u.addEventListener("click",()=>{M.sessionFilter=u.dataset.sessFilter||"all",document.querySelectorAll(".bank-sessions-chip").forEach(l=>{l.classList.toggle("active",l===u)}),sn()}))})}window._deleteBankSession=Jo;window._loadBankReconPanel=Wo;window._rerenderBankRecon=function(){if(currentRoute==="automation"){if(sn(),M.currentSession&&(Uo(),la(),ca(),!M.currentTxForDrawer)){const e=document.getElementById("bank-cand-pane-title"),n=document.getElementById("bank-cand-pane-sub");e&&(e.textContent=t("bank-cand-pane-empty-title")),n&&(n.textContent=t("bank-cand-pane-empty-sub"))}we()}};typeof window.subscribeI18n=="function"&&window.subscribeI18n("bank-recon",window._rerenderBankRecon);window._openBankSession=async function(e){e&&(M.loaded||await Wo(),await kt(e))};(function(){const e=document.getElementById("page-clients");if(!(!e||e.dataset.wbInjected==="1")){e.innerHTML=`
        <div class="page-head">
            <div class="page-head-icon">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
...
`,e.dataset.wbInjected="1";try{const n=window._currentLang||localStorage.getItem("mrpilot_lang")||"th",a=window.I18N;a&&a[n]&&(e.querySelectorAll("[data-i18n]").forEach(o=>{const s=o.getAttribute("data-i18n");a[n][s]&&(o.textContent=a[n][s])}),e.querySelectorAll("[data-i18n-placeholder]").forEach(o=>{const s=o.getAttribute("data-i18n-placeholder");a[n][s]&&(o.placeholder=a[n][s])}))}catch{}}})();const Vr=`
    ...
    `;fe("client-modal-mask",Vr);fe("wsclient-modal-mask",Ur);const O={clients:[],editingClientId:null,historyClientFilter:"",custTab:"seller",sellerClients:[],editingWsClientId:null,catCache:{fetched:0,items:[],supplier_count:0}},ue={page:0,pageSize:12,keyword:""},$e=new Set,rn={keyword:""};function Gr(){return{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||"")}}async function Le(e,n={}){const a=await fetch(e,{...n,headers:{"Content-Type":"application/json",...Gr(),...n.headers||{}}});if(!a.ok){const o=await a.json().catch(()=>({}));throw new Error(o.detail||"HTTP "+a.status)}return a.json()}function Kr(){const e=document.querySelector("#client-color-picker .color-swatch.active");return e?e.dataset.color:"#111111"}function Na(e){const n=document.getElementById("drawer-cat-learned-tag");n&&e>0&&(n.textContent=(t("drawer-suggest-learned-with-count")||"已学 {n}").replace("{n}",String(e)))}async function _t(){try{const e=await Le("/api/clients");O.clients=e.clients||[],window._clientsCache=O.clients}catch(e){console.error("loadClientsCache fail",e),O.clients=[]}try{typeof window._refreshExcClientFilter=="function"&&window._refreshExcClientFilter()}catch{}try{typeof window._refreshClientSwitcher=="function"&&window._refreshClientSwitcher()}catch{}return O.clients}function Jr(){const e=ue.keyword.trim().toLowerCase();return e?O.clients.filter(n=>(n.name||"").toLowerCase().includes(e)||(n.short_name||"").toLowerCase().includes(e)||(n.tax_id||"").toLowerCase().includes(e)):O.clients}function ua(){const e=Jr(),n=ue.pageSize,a=Math.max(0,Math.ceil(e.length/n)-1);ue.page>a&&(ue.page=a);const o=ue.page*n;return{all:e,items:e.slice(o,o+n),start:o,ps:n,total:e.length,maxPage:a}}function Te(){const e=document.getElementById("buyer-tbody");if(!e)return;const{items:n,start:a,ps:o,total:s,maxPage:i}=ua();s?e.innerHTML=n.map(d=>{const u=$e.has(d.id);return`<div class="cust-row buyer-grid${u?" selected":""}" data-cid="${d.id}">
        ...
        </div>`}).join("")}function Oa(e){O.editingWsClientId=e?e.id:null,document.getElementById("wsclient-modal-title").textContent=t(e?"wsclient-modal-edit":"wsclient-modal-new"),document.getElementById("wsclient-input-name").value=e&&e.name||"",document.getElementById("wsclient-input-tax").value=e&&e.tax_id||"",document.getElementById("wsclient-modal-archive").style.display=e?"":"none",document.getElementById("wsclient-modal-mask").style.display="flex",setTimeout(()=>document.getElementById("wsclient-input-name").focus(),50)}function jt(){document.getElementById("wsclient-modal-mask").style.display="none",O.editingWsClientId=null}async function al(){const e=document.getElementById("wsclient-input-name").value.trim(),n=document.getElementById("wsclient-input-tax").value.trim();if(!e){showToast(t("client-msg-name-required"),"fail");return}try{O.editingWsClientId?(await Le("/api/workspace/clients/"+O.editingWsClientId,{method:"PATCH",body:JSON.stringify({name:e,tax_id:n})}),showToast(t("client-msg-updated"),"success")):(await Le("/api/workspace/clients",{method:"POST",body:JSON.stringify({name:e,tax_id:n||null})}),showToast(t("client-msg-created"),"success")),jt(),await fa(),at(),Xo()}catch(a){const o=a&&a.message?a.message:t("client-msg-save-fail");showToast(t("client-msg-save-fail")+" · "+o,"fail")}}async function Va(){if(!O.editingWsClientId)return;const e=O.sellerClients.find(a=>Number(a.id)===Number(O.editingWsClientId));if(await showConfirm(t("wsclient-archive-confirm").replace("{name}",e?e.name:""),{danger:!0}))try{const a=O.editingWsClientId;await Le("/api/workspace/clients/"+a,{method:"DELETE"}),showToast(t("wsclient-archived"),"success"),typeof window.getActiveWorkspaceClientId=="function"&&Number(window.getActiveWorkspaceClientId())===Number(a)&&typeof window.enterPersonalMode=="function"&&window.enterPersonalMode(),jt(),await fa(),at(),Xo()}catch{showToast(t("client-msg-save-fail"),"fail")}}window.loadClientsPage=async function(){const e=document.getElementById("seller-tbody");e&&(e.innerHTML=`<div class="cust-loading">${escapeHtml(t("clients-loading"))}</div>`);const n=document.getElementById("buyer-tbody");n&&(n.innerHTML=`<div class="cust-loading">${escapeHtml(t("clients-loading"))}</div>`),await Promise.all([fa(),_t()]),at(),Te()};window.addEventListener("pearnly:workspace-changed",function(){typeof currentRoute<"u"&&currentRoute==="clients"&&at()});window.bindDrawerClient=function(e,n){const a=document.getElementById("drawer-client-select");if(!a)return;if(yn(),a.value=n?String(n):"",!e){a.onchange=null;const s=document.getElementById("drawer-client-add");s&&(s.onclick=()=>Ht(null));return}a.onchange=async()=>{const s=a.value?parseInt(a.value,10):null;try{await Le(`/api/history/${e}/assign_client`,{method:"POST",body:JSON.stringify({client_id:s})}),showToast(t("client-msg-updated"),"success");const i=_results[_drawerIdx];i&&(i.client_id=s),await _t()}catch(i){console.error(i),showToast(t("client-msg-save-fail"),"fail"),a.value=n?String(n):""}};const o=document.getElementById("drawer-client-add");o&&(o.onclick=()=>Ht(null))};window.fillCategoryDatalist=async function(){try{const e=document.getElementById("drawer-cat-datalist"),n=Date.now();if(n-O.catCache.fetched<300*1e3){e&&(e.innerHTML=O.catCache.items.map(o=>`<option value="${escapeHtml(o)}">`).join("")),Na(O.catCache.supplier_count);return}const a=await Le("/api/categories",{method:"GET"});O.catCache.fetched=n,O.catCache.items=a&&a.categories||[],O.catCache.supplier_count=a&&a.supplier_count||0,e&&(e.innerHTML=O.catCache.items.map(o=>`<option value="${escapeHtml(o)}">`).join("")),Na(O.catCache.supplier_count)}catch(e){console.warn("fillCategoryDatalist failed",e)}};window.getHistoryClientFilter=function(){return O.historyClientFilter};document.addEventListener("DOMContentLoaded",()=>{const e=document.querySelector(".cust-tab-bar");e&&e.addEventListener("click",L=>{const C=L.target.closest("[data-cust-tab]");C&&el(C.dataset.custTab)});const n=document.getElementById("btn-buyer-new");n&&n.addEventListener("click",()=>Ht(null));const a=document.getElementById("buyer-tbody");a&&a.addEventListener("click",L=>{const C=L.target.closest(".buyer-row-check");if(C){const j=parseInt(C.dataset.cid,10);C.checked?$e.add(j):$e.delete(j);const N=C.closest(".cust-row");N&&N.classList.toggle("selected",C.checked),Yo();return}const S=L.target.closest(".cust-row-btn");if(S){L.stopPropagation();const j=parseInt(S.dataset.cid,10);if(S.dataset.action==="edit"){const N=O.clients.find(X=>X.id===j);N&&Ht(N)}else S.dataset.action==="export"&&Qr(j);return}const $=L.target.closest(".cust-row");if($&&!L.target.closest(".cust-cell-check")){const j=O.clients.find(N=>N.id===parseInt($.dataset.cid,10));j&&Ht(j)}});const o=document.getElementById("buyer-check-all");o&&o.addEventListener("change",()=>{const{items:L}=ua();L.forEach(C=>{o.checked?$e.add(C.id):$e.delete(C.id)}),Te()});const s=document.getElementById("buyer-batch-cancel");s&&s.addEventListener("click",Wr);const i=document.getElementById("buyer-batch-delete");i&&i.addEventListener("click",Yr);const r=document.getElementById("buyer-prev");r&&r.addEventListener("click",()=>{ue.page>0&&(ue.page--,Te())});const c=document.getElementById("buyer-next");c&&c.addEventListener("click",()=>{ue.page++,Te()});const f=document.getElementById("buyer-search");if(f){let L;f.addEventListener("input",()=>{clearTimeout(L),L=setTimeout(()=>{ue.keyword=f.value,ue.page=0;const C=document.getElementById("buyer-search-clear");C&&(C.style.display=f.value?"":"none"),Te()},200)})}const d=document.getElementById("buyer-search-clear");d&&d.addEventListener("click",()=>{const L=document.getElementById("buyer-search");L&&(L.value=""),ue.keyword="",ue.page=0,d.style.display="none",Te()});const u=document.getElementById("btn-seller-new");u&&u.addEventListener("click",()=>Oa(null));const l=document.getElementById("seller-tbody");l&&l.addEventListener("click",L=>{const C=L.target.closest("[data-saction]");if(!C)return;L.stopPropagation();const S=parseInt(C.dataset.wid,10),$=C.dataset.saction,j=O.sellerClients.find(N=>Number(N.id)===S);$==="activate"?(typeof window.setActiveWorkspaceClientId=="function"&&window.setActiveWorkspaceClientId(S),at(),typeof window.renderWorkspaceControl=="function"&&window.renderWorkspaceControl(),showToast(t("seller-activated").replace("{name}",j?j.name:""),"success")):$==="edit"?j&&Oa(j):$==="archive"&&(O.editingWsClientId=S,Va())});const p=document.getElementById("seller-search");if(p){let L;p.addEventListener("input",()=>{clearTimeout(L),L=setTimeout(()=>{rn.keyword=p.value;const C=document.getElementById("seller-search-clear");C&&(C.style.display=p.value?"":"none"),at()},200)})}const m=document.getElementById("seller-search-clear");m&&m.addEventListener("click",()=>{const L=document.getElementById("seller-search");L&&(L.value=""),rn.keyword="",m.style.display="none",at()});const v=document.getElementById("wsclient-modal-close");v&&v.addEventListener("click",jt);const w=document.getElementById("wsclient-modal-cancel");w&&w.addEventListener("click",jt);const b=document.getElementById("wsclient-modal-save");b&&b.addEventListener("click",al);const g=document.getElementById("wsclient-modal-archive");g&&g.addEventListener("click",Va);const h=document.getElementById("wsclient-modal-mask");h&&h.addEventListener("click",L=>{L.target===h&&jt()});const _=document.getElementById("client-modal-close");_&&_.addEventListener("click",At);const y=document.getElementById("client-modal-cancel");y&&y.addEventListener("click",At);const k=document.getElementById("client-modal-save");k&&k.addEventListener("click",Xr);const x=document.getElementById("client-modal-delete");x&&x.addEventListener("click",Zr);const E=document.getElementById("client-modal-mask");E&&E.addEventListener("click",L=>{L.target===E&&At()});const I=document.getElementById("client-color-picker");I&&I.addEventListener("click",L=>{const C=L.target.closest(".color-swatch");C&&(I.querySelectorAll(".color-swatch").forEach(S=>S.classList.remove("active")),C.classList.add("active"))});const B=document.getElementById("history-client-filter");B&&B.addEventListener("change",()=>{O.historyClientFilter=B.value,typeof renderHistoryList=="function"&&renderHistoryList()})});setTimeout(()=>_t(),1e3);(function(){const e=document.getElementById("page-exceptions");if(!(!e||e.dataset.wbInjected==="1")){e.innerHTML=`
        <div class="page-head">
            <div class="page-head-icon">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round">
...
`,e.dataset.wbInjected="1";try{const n=window._currentLang||localStorage.getItem("mrpilot_lang")||"th",a=window.I18N;a&&a[n]&&(e.querySelectorAll("[data-i18n]").forEach(o=>{const s=o.getAttribute("data-i18n");a[n][s]&&(o.textContent=a[n][s])}),e.querySelectorAll("[data-i18n-placeholder]").forEach(o=>{const s=o.getAttribute("data-i18n-placeholder");a[n][s]&&(o.placeholder=a[n][s])}))}catch{}}})();const R={statsCache:null,listCache:[],currentRule:null,currentClient:"",currentStatus:"pending",loading:!1,selectedIds:new Set,offset:0,pageSize:50,total:0,loadFailed:!1,listScrollY:0},D={openExcId:null,excRow:null,history:null,loading:!1,pdfUrl:null,pdfStatus:"idle",editing:!1,editFields:null},pt={batchLoading:!1};function Ve(e,n){let a=t(e)||e;if(n)for(const o in n)a=a.replace(new RegExp("\\{"+o+"\\}","g"),String(n[o]));return a}function ol(e){return e==="high"?`<svg viewBox="0 0 14 14" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
    ...
    `;const c=e.severity||"medium",f=va(e),d=ul(e.rule_code,e.detail||{}),u=Ua(D.history),l=D.history===null,p=D.history&&D.history._err,m=new Set,v=e.rule_code||"";["math_mismatch","R-VAT-01","R-VAT-02","R-SUM-01","R-LINE-01"].includes(v)?(m.add("subtotal"),m.add("vat"),m.add("total_amount")):v==="R-MULTIPAGE-01"||v==="R-LIMIT-01"?m.add("total_amount"):v==="tax_id_format_invalid"||v==="R-TAXID-01"?m.add("seller_tax"):v==="R-TAXID-02"?m.add("buyer_tax"):v==="R-TAXID-03"?(m.add("seller_tax"),m.add("buyer_tax")):v==="R-DATE-01"||v==="R-DATE-02"?m.add("date"):v==="R-DUP-01"||v==="R-DUP-02"?m.add("invoice_number"):v==="R-SUP-01"||v==="R-SUP-02"?(m.add("seller_name"),m.add("seller_tax")):v==="amount_missing"&&(m.add("total_amount"),m.add("invoice_number"));const w=!!D.editing,b=D.editFields||{},g=($,j,N)=>{if(l)return`<div class="exc-field-row"><label>${escapeHtml(t(j))}</label><span class="val empty">…</span></div>`;const X=w?b[$]!==void 0?b[$]:u[$]!==void 0&&u[$]!==null?u[$]:"":u[$],ne=m.has($)?"flagged":"";if(w){const z=N?"number":"text",q=N?' step="0.01" inputmode="decimal"':"",U=X==null?"":String(X).replace(/"/g,"&quot;");return`<div class="exc-field-row ${ne} editing">
                <label>${escapeHtml(t(j))}</label>
                <input class="exc-field-input" type="${z}"${q} data-edit-key="${escapeHtml($)}" value="${U}">
            </div>`}const de=N?De(X):X||"",ae=X==null||X===""?`<span class="val empty">${escapeHtml(t("exc-empty-val"))}</span>`:`<span class="val">${escapeHtml(de)}</span>`;return`<div class="exc-field-row ${ne}"><label>${escapeHtml(t(j))}</label>${ae}</div>`};let h="";p?h=`<div class="exc-drawer-error">${escapeHtml(t("exc-drawer-error"))}</div>`:h=`
    ...
    `;const y=document.getElementById("exc-fld-edit");y&&y.addEventListener("click",()=>{D.editing=!0,D.editFields={...Ua(D.history)},Fe()});const k=document.getElementById("exc-fld-cancel");k&&k.addEventListener("click",()=>{D.editing=!1,D.editFields=null,Fe()});const x=document.getElementById("exc-fld-save");x&&x.addEventListener("click",()=>vl()),document.querySelectorAll(".exc-field-input").forEach($=>{$.addEventListener("input",()=>{D.editFields||(D.editFields={}),D.editFields[$.dataset.editKey]=$.value})});const I=document.getElementById("exc-pdf-retry");I&&D.openExcId&&I.addEventListener("click",()=>{D.excRow&&Zo(D.excRow.history_id,D.openExcId)});const B=e.status==="pending",L=!!(e.seller_name&&e.seller_name.trim()),C=document.getElementById("exc-btn-resolve"),S=document.getElementById("exc-btn-ignore");C.disabled=!B,S.disabled=!B||!L,S.title=L?t("exc-ignore-hint"):t("exc-ignore-no-seller")}function ha(){if(D.pdfUrl){try{URL.revokeObjectURL(D.pdfUrl)}catch{}D.pdfUrl=null}D.pdfStatus="idle"}async function Zo(e,n){D.pdfStatus="loading",Fe();try{const a=await fetch("/api/history/"+encodeURIComponent(e)+"/pdf",{headers:{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||"")}});if(D.openExcId!==n)return;if(a.status===404){D.pdfStatus="empty",Fe();return}if(!a.ok)throw new Error("http "+a.status);const o=await a.blob();if(D.openExcId!==n)return;ha(),D.pdfUrl=URL.createObjectURL(o),D.pdfStatus="ready",Fe()}catch(a){if(D.openExcId!==n)return;console.warn("loadDrawerPdf fail",a),D.pdfStatus="error",Fe()}}function ml(e){const n=(R.listCache||[]).find(a=>a.id===e);if(!n){showToast(t("exc-drawer-error"),"error");return}R.listScrollY=window.scrollY||document.documentElement.scrollTop||0,ha(),D.editing=!1,D.editFields=null,D.openExcId=e,D.excRow=n,D.history=null,document.getElementById("exc-drawer-mask").classList.add("show"),document.getElementById("exc-drawer").classList.add("show"),Fe(),fl(n.history_id),Zo(n.history_id,e)}function bt(){ha(),D.editing=!1,D.editFields=null,D.openExcId=null,D.excRow=null,D.history=null,document.getElementById("exc-drawer-mask").classList.remove("show"),document.getElementById("exc-drawer").classList.remove("show");const e=R.listScrollY||0;e>0&&requestAnimationFrame(()=>window.scrollTo(0,e))}async function fl(e){try{const n=await fetch("/api/history/"+encodeURIComponent(e),{headers:{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||"")}});if(!n.ok)throw new Error("http "+n.status);D.history=await n.json()}catch(n){console.warn("loadHistoryDetail fail",n),D.history={_err:!0}}D.excRow&&Fe()}function Ua(e){if(!e||!e.pages)return{};const n=e.pages,a=n.find(o=>!o.is_duplicate&&!o.is_copy)||n[0];return a&&a.fields||{}}async function vl(){if(!D.openExcId||!D.history||!D.history.pages||D.loading)return;D.loading=!0;const e=showToast(t("exc-fld-saving"),"loading",0);try{const n=JSON.parse(JSON.stringify(D.history.pages||[]));let a=n.findIndex(f=>!f.is_duplicate&&!f.is_copy);a<0&&(a=0),n[a]||(n[a]={fields:{}});const o=n[a].fields||{},s=D.editFields||{},i=new Set(["subtotal","vat","total_amount"]),r={...o};for(const f in s){let d=s[f];if((d===""||d===void 0)&&(d=null),i.has(f)&&d!==null){const u=parseFloat(d);d=isNaN(u)?null:u}r[f]=d}n[a].fields=r;const c=await fetch("/api/history/"+encodeURIComponent(D.history.id),{method:"PUT",headers:{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||""),"Content-Type":"application/json"},body:JSON.stringify({pages:n})});if(!c.ok)throw new Error("http "+c.status);e(),showToast(t("exc-fld-save-ok"),"success"),bt(),await Et(),await Ge(),He()}catch(n){e(),console.warn("save fields fail",n),showToast(t("exc-fld-save-fail"),"error")}finally{D.loading=!1}}async function hl(){if(!(!D.openExcId||D.loading)){D.loading=!0;try{const e=await fetch("/api/exceptions/"+D.openExcId+"/resolve",{method:"POST",headers:{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||"")}});if(!e.ok)throw new Error("http "+e.status);showToast(t("exc-toast-resolved"),"success"),bt(),await Et(),await Ge(),He()}catch(e){console.warn("resolve fail",e),showToast(t("exc-toast-action-fail"),"error")}finally{D.loading=!1}}}async function gl(){if(!(!D.openExcId||D.loading)){D.loading=!0;try{const e=await fetch("/api/exceptions/"+D.openExcId+"/ignore",{method:"POST",headers:{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||"")}});if(!e.ok)throw new Error("http "+e.status);showToast(t("exc-toast-ignored"),"success"),bt(),await Et(),await Ge(),He()}catch(e){console.warn("ignore fail",e),showToast(t("exc-toast-action-fail"),"error")}finally{D.loading=!1}}}async function He(){try{const e=R.currentClient||"",n="/api/exceptions/stats?status=pending"+(e?"&client_id="+encodeURIComponent(e):""),a=await fetch(n,{headers:{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||"")}});if(!a.ok)return;const o=await a.json(),s=document.getElementById("nav-exc-badge");if(!s)return;const i=parseInt(o.pending||0,10);i>0?(s.textContent=i>99?"99+":String(i),s.style.display=""):s.style.display="none"}catch{}}function Qo(e){document.getElementById("exc-kpi-pending").textContent=e.pending||0,document.getElementById("exc-kpi-high").textContent=e.high_severity||0,document.getElementById("exc-kpi-resolved").textContent=e.resolved||0,document.getElementById("exc-kpi-learned").textContent=e.learned_rules||0;const n=document.getElementById("exc-status-tab-count-pending"),a=document.getElementById("exc-status-tab-count-resolved"),o=document.getElementById("exc-status-tab-count-ignored");n&&(n.textContent=e.pending||0),a&&(a.textContent=e.resolved||0),o&&(o.textContent=e.ignored||0),document.querySelectorAll("#exc-status-tabs .exc-status-tab").forEach(i=>{i.classList.toggle("active",i.dataset.status===(R.currentStatus||"pending"))})}function es(e,n){return n.split(",").reduce((a,o)=>a+(e[o]||0),0)}function ga(e){const n=document.getElementById("exc-chips");if(!n)return;const a=e.by_rule||{};let s=`<button class="exc-chip ${!R.currentRule?"active":""}" data-rule="">
        <span>${escapeHtml(t("exc-chip-all"))}</span>
        <span class="exc-chip-count">${e.pending||0}</span>
    </button>`;for(const i of cl){const r=i.codes.join(","),c=es(a,r),f=R.currentRule===r;c===0&&!f||(s+=`<button class="exc-chip ${f?"active":""}" data-rule="${escapeHtml(r)}">
        ...
        </div>`,Ka();return}const a='<svg viewBox="0 0 14 14" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M3 7l3 3 5-5"/></svg>',o=(R.currentStatus||"pending")==="pending";n.innerHTML=e.map(s=>{const i=s.severity||"medium",r=va(s),c=s.seller_name&&s.seller_name.trim()?s.seller_name:t("exc-no-seller"),f=s.filename||"—",d=rl(s.invoice_date||s.created_at),u=s.status==="pending",l=R.selectedIds.has(s.id),p=o&&u;return`
            <div class="exc-row sev-${escapeHtml(i)} ${l?"selected":""}" data-exc-id="${escapeHtml(String(s.id))}">
                ...
                <div class="exc-row-sev">${ol(i)}</div>
                ...
                <div class="exc-row-amount">${escapeHtml(il(s.total_amount))}</div>
            </div>
        `}).join(""),n.querySelectorAll(".exc-row").forEach(s=>{s.addEventListener("click",i=>{if(i.target.closest(".exc-row-check"))return;const r=s.dataset.excId;r&&ml(parseInt(r,10))})}),n.querySelectorAll(".exc-row-check").forEach(s=>{s.addEventListener("click",i=>{i.stopPropagation();const r=parseInt(s.dataset.checkId,10);r&&(R.selectedIds.has(r)?(R.selectedIds.delete(r),s.classList.remove("checked"),s.closest(".exc-row").classList.remove("selected")):(R.selectedIds.add(r),s.classList.add("checked"),s.closest(".exc-row").classList.add("selected")),Ga())})}),Ga(),Ka()}function Ga(){const e=document.getElementById("exc-batch-bar"),n=document.getElementById("exc-batch-count");if(!e||!n)return;const a=R.selectedIds.size;a===0?e.style.display="none":(e.style.display="",n.textContent=Ve("exc-batch-count",{n:a}))}function Ka(){const e=document.getElementById("exc-list-foot"),n=document.getElementById("exc-list-count"),a=document.getElementById("exc-loadmore");if(!e||!n||!a)return;const o=R.listCache.length;if(o===0){e.style.display="none";return}e.style.display="";let s=o;const i=R.statsCache;i&&(R.currentRule?s=es(i.by_rule||{},R.currentRule)||o:s=i.pending||o),R.total=s,n.textContent=Ve("exc-list-count",{shown:o,total:s});const r=o<s&&o<500;a.style.display=r?"":"none"}async function Et(){try{if(navigator.onLine===!1)throw new Error("offline");const e=R.currentClient||"",n=R.currentStatus||"pending",a=new URLSearchParams;a.set("status",n),e&&a.set("client_id",e);const o="/api/exceptions/stats?"+a.toString(),s=await fetch(o,{headers:{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||"")}});if(!s.ok)throw new Error("http "+s.status);const i=await s.json();return R.statsCache=i,Qo(i),ga(i),i}catch(e){return console.warn("loadExceptionsStats fail",e),null}}function bl(e){const n=document.getElementById("exc-list");if(!n)return;const a=`<svg class="exc-error-icon" viewBox="0 0 36 36" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round">
        <circle cx="18" cy="18" r="14"/>
        ...
        <div class="exc-error">
            ...
            <path d="M3 4h8M5.5 4V2.5h3V4M4 4l0.6 8.5h4.8L10 4"/>
                ...
                <div class="learned-row" data-wl-id="${escapeHtml(String(i.id))}">
                    ...
                    <div class="learned-date">${escapeHtml(dl(i.created_at))}</div>
                    <button class="learned-del-btn" data-del-wl="${escapeHtml(String(i.id))}" title="${escapeHtml(t("set-learned-del"))}" type="button">${s}</button>
                </div>
            `}).join("")}catch(n){console.warn("loadLearnedRules fail",n),e.innerHTML=`<div class="learned-empty">${escapeHtml(t("exc-toast-load-fail"))}</div>`}}}window.loadExceptionsPage=async function(){if(!R.loading){R.loading=!0;try{ya(),typeof window.loadErpExceptions=="function"&&window.loadErpExceptions(),await Et(),await Ge()}finally{R.loading=!1}}};window.refreshExcBadge=He;window._refreshExcClientFilter=ya;window._excState=R;window._rerenderExceptions=function(){try{ya()}catch{}R.statsCache&&(Qo(R.statsCache),ga(R.statsCache)),R.listCache&&R.listCache.length&&ba(R.listCache);try{window._erpExcState&&window._erpExcState.items&&window._erpExcState.items.length&&typeof window._rerenderErpExceptions=="function"&&window._rerenderErpExceptions()}catch{}D.openExcId&&Fe()};document.addEventListener("click",e=>{e.target.closest("#exc-drawer-close")&&bt(),e.target.closest("#exc-drawer-mask")&&bt(),e.target.closest("#exc-btn-resolve")&&hl(),e.target.closest("#exc-btn-ignore")&&gl(),e.target.closest("#exc-batch-resolve")&&wl(),e.target.closest("#exc-batch-ignore")&&kl(),e.target.closest("#exc-batch-clear")&&xl(),e.target.closest("#exc-loadmore")&&yl()});document.addEventListener("keydown",e=>{e.key==="Escape"&&D.openExcId&&bt()});document.addEventListener("click",e=>{e.target.closest("#btn-exc-refresh")&&(typeof window.loadExceptionsPage=="function"&&window.loadExceptionsPage(),He())});document.addEventListener("change",e=>{if(!e.target.closest("#exc-client-filter"))return;const n=e.target;R.currentClient=n.value||"",R.currentRule=null,R.selectedIds.clear(),R.listCache=[],typeof window.loadExceptionsPage=="function"&&window.loadExceptionsPage(),He()});document.addEventListener("click",e=>{const n=e.target.closest("#exc-status-tabs .exc-status-tab");if(!n)return;const a=n.dataset.status||"pending";a!==R.currentStatus&&(R.currentStatus=a,R.currentRule=null,R.selectedIds.clear(),R.listCache=[],typeof window.loadExceptionsPage=="function"&&window.loadExceptionsPage())});window.addEventListener("online",()=>{R.loadFailed&&document.getElementById("page-exceptions")?.classList.contains("show")&&window.loadExceptionsPage&&window.loadExceptionsPage()});setTimeout(He,1500);setInterval(He,6e4);window.loadLearnedRules=ts;document.addEventListener("click",async e=>{const n=e.target.closest("[data-del-wl]");if(!n)return;const a=parseInt(n.dataset.delWl,10);if(!a)return;const o=n.closest(".learned-row"),s=o&&o.querySelector(".learned-seller"),i=s?s.textContent.trim():"",r=t("set-learned-del-confirm").replace("{seller}",i);if(await showConfirm(r,{danger:!0}))try{const f=await fetch("/api/exception-whitelist/"+a,{method:"DELETE",headers:{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||"")}});if(!f.ok)throw new Error("http "+f.status);showToast(t("set-learned-del-ok"),"success"),ts(),typeof window.loadExceptionsPage=="function"&&document.getElementById("page-exceptions")?.classList.contains("show")&&window.loadExceptionsPage()}catch(f){console.warn("delete whitelist fail",f),showToast(t("set-learned-del-fail"),"error")}});let se={items:[],q:"",cat:"",adapter:"",selected:new Set,total:0,categories:{},pageSize:30,loading:!1,focusSearch:!1,searchCaret:0},Ja=null;function Me(){return localStorage.getItem("mrpilot_token")||""}function Wa(e){return/<!?\s*doctype|<html|<\/?[a-z]+>|\bTraceback\b|^\s*ERR_[A-Z]/i.test(e)||e.length>200}function ns(e){const n=typeof currentLang=="string"&&currentLang||window._currentLang||"th",a=e.error_friendly&&e.error_friendly[n];if(a)return a;if(typeof humanizeError=="function"&&e.error_msg&&!Wa(e.error_msg))try{const o=humanizeError(e.error_msg);if(o&&!Wa(o))return o}catch{}return t("erp-exc-reason-"+(e.category||"other"))}function Ya(){const e=document.getElementById("erp-exc-batch");if(!e)return;const n=se.selected.size;e.hidden=n===0;const a=e.querySelector(".erp-exc-batch-count");a&&(a.textContent=String(n))}function wa(){const e=document.getElementById("erp-exc-block");if(!e)return;const n=se;if(!(n.total>0||!!n.q||!!n.cat)){e.hidden=!0,e.innerHTML="";return}e.hidden=!1;const o=n.categories||{},s=Object.keys(o).reduce((x,E)=>x+o[E],0);let i=`<button class="erp-exc-chip ${n.cat===""?"active":""}" data-erpexc-cat=""><span>${escapeHtml(t("erp-exc-cat-all"))}</span><span class="erp-exc-chip-count">${s}</span></button>`;Object.keys(o).forEach(x=>{i+=`<button class="erp-exc-chip ${n.cat===x?"active":""}" data-erpexc-cat="${escapeHtml(x)}"><span>${escapeHtml(t("erp-exc-cat-"+x))}</span><span class="erp-exc-chip-count">${o[x]}</span></button>`});const r=n.items||[],c=r.length>0&&r.every(x=>n.selected.has(x.id)),f=r.map(x=>{const E=x.state==="needs_action"?"needs":x.state==="retrying"?"retry":"fail",I=t("erp-exc-state-"+(x.state||"failed")),B=ns(x),L=n.selected.has(x.id)?"checked":"",C=x.push_type==="id_card",S=C?`<span class="erp-exc-type-idcard">${escapeHtml(t("erp-log-type-idcard"))}</span> `:"",$=C?`<span class="ex-inv" title="${escapeHtml(t("erp-log-col-booking"))}">${S}${escapeHtml(x.invoice_no||"—")}</span>`:`<span class="ex-inv" title="${escapeHtml(x.invoice_no||"")}">${escapeHtml(x.invoice_no||"—")}</span>`,j=C?`<span class="ex-seller" title="${escapeHtml(t("erp-log-col-customer"))}">${escapeHtml(x.seller_name||"—")}</span>`:`<span class="ex-seller" title="${escapeHtml(x.seller_name||"")}">${escapeHtml(x.seller_name||"—")}</span>`,N=C?`<span class="ex-buyer" title="${escapeHtml(t("erp-log-col-idcard"))}">${x.id_card_tail?"••••"+escapeHtml(x.id_card_tail):"—"}</span>`:`<span class="ex-buyer" title="${escapeHtml(x.ocr_buyer_name||"")}">${escapeHtml(x.ocr_buyer_name||"—")}</span>`;return`<div class="erp-exc-row" data-erpexc-id="${escapeHtml(x.id)}">
        ...
        </div>`,document.body.appendChild(d),d.addEventListener("click",u=>{u.target===d&&it()}),document.getElementById("erp-exc-m-close").addEventListener("click",it),document.getElementById("erp-exc-m-cancel").addEventListener("click",it),document.getElementById("erp-exc-m-retry").addEventListener("click",()=>{it(),Zt(n.id,null)}),o){let u="";const l=document.getElementById("erp-exc-m-bind"),p=document.getElementById("erp-exc-m-custlist"),m=document.getElementById("erp-exc-m-search"),v=(b,g)=>{const h=(g||"").trim().toLowerCase(),_=h?b.filter(y=>(y.code||"").toLowerCase().includes(h)||(y.name||"").toLowerCase().includes(h)):b;if(_.length===0){p.innerHTML=`<div class="erp-exc-m-empty">${escapeHtml(t("erp-exc-edit-pick-empty"))}</div>`;return}p.innerHTML=_.slice(0,100).map(y=>`<div class="erp-exc-m-cust" data-cust-code="${escapeHtml(y.code||"")}">
                    <span class="erp-exc-m-cust-name">${escapeHtml(y.name||"")}</span>
                    <span class="erp-exc-m-cust-code">${escapeHtml(y.code||"")}</span>
                </div>`).join(""),p.querySelectorAll(".erp-exc-m-cust").forEach(y=>{y.addEventListener("click",()=>{u=y.dataset.custCode||"",p.querySelectorAll(".erp-exc-m-cust").forEach(k=>k.classList.remove("sel")),y.classList.add("sel"),l&&(l.disabled=!u)})})},w=async()=>{const b=n.endpoint_id;if(Gt[b]){v(Gt[b],"");return}try{const g=await fetch("/api/erp/endpoints/"+encodeURIComponent(b)+"/customers",{headers:{Authorization:"Bearer "+Me()}}),h=await g.json().catch(()=>({}));if(!g.ok||!h.ok){p.innerHTML=`<div class="erp-exc-m-empty">${escapeHtml(t("erp-exc-edit-pick-fail"))}</div>`;return}const _=h.customers||[];Gt[b]=_,v(_,"")}catch{p.innerHTML=`<div class="erp-exc-m-empty">${escapeHtml(t("erp-exc-edit-pick-fail"))}</div>`}};m&&m.addEventListener("input",()=>v(Gt[n.endpoint_id]||[],m.value)),w(),l&&l.addEventListener("click",async()=>{if(u){l.disabled=!0,l.textContent=t("erp-exc-retrying");try{if(!(await fetch("/api/erp/mappings/clients",{method:"POST",headers:{Authorization:"Bearer "+Me(),"Content-Type":"application/json"},body:JSON.stringify({client_id:n.history_client_id,erp_type:n.endpoint_adapter,erp_code:u})})).ok){showToast(t("erp-exc-retry-fail"),"error"),l.disabled=!1,l.textContent=t("erp-exc-edit-bind-retry");return}showToast(t("erp-exc-edit-bound-ok"),"success"),it(),await Zt(n.id,null)}catch{showToast(t("erp-exc-retry-fail"),"error"),l.disabled=!1,l.textContent=t("erp-exc-edit-bind-retry")}}})}if(s){const u=document.getElementById("erp-exc-m-bind-prod"),l=document.getElementById("erp-exc-m-prodlist"),p={};let m=[];const v=()=>'<option value="">'+escapeHtml(t("erp-exc-edit-prod-choose"))+"</option>"+m.slice(0,500).map(g=>`<option value="${escapeHtml(g.code||"")}" data-pname="${escapeHtml(g.name||"")}">`+escapeHtml((g.name||"")+" · "+(g.code||""))+"</option>").join(""),w=g=>{if(!g.length){l.innerHTML=`<div class="erp-exc-m-empty">${escapeHtml(t("erp-exc-edit-prod-noitems"))}</div>`;return}l.innerHTML=g.map(h=>`<div class="erp-exc-m-cust" style="cursor:default">
...
`;let Za=!1,wn=[],Nn=null,Be="amount_limit",ka="global";const Bl="/api/knowledge/rules";function Ll(){return localStorage.getItem("mrpilot_token")||""}async function yt(e,n,a){return fetch(Bl+n,{method:e,headers:{Authorization:"Bearer "+Ll(),"Content-Type":"application/json"},body:a?JSON.stringify(a):void 0})}function Cl(e){const n=Number(e);return Number.isFinite(n)?"฿ "+n.toLocaleString("en-US"):String(e)}function Sl(e){const n=ce(),a=o=>e===o?" selected":"";return`<option value="high"${a("high")}>${n.sevHigh}</option><option value="medium"${a("medium")}>${n.sevMid}</option><option value="low"${a("low")}>${n.sevLow}</option>`}function Qa(e,n){const a=n&&n.subject_key?escapeHtml(n.subject_key):"";return`<div class="rs-mlbl">${e}</div><input class="rs-field" id="rs-f-key" value="${a}"${n?" disabled":""}>`}function Tl(e){const n=ce(),a=e.subject_key?escapeHtml(e.subject_key):"";if(e.rule_type==="amount_limit"){const o=Cl(e.rule_body.limit);let s=n.gAmount;e.subject_type==="global"?s=n.anyInvoice:e.subject_type==="supplier"?s=`${n.fSupplierTax} <b>${a}</b>`:s=`「${a}」`;const i=e.rule_body.notify_line?` <span class="rs-line">${Ne("bell",12)} ${n.alsoLine}</span>`:"";return`${s} &gt; <b>${o}</b>${i}`}if(e.rule_type==="supplier_force_review")return`<b>${a}</b> · ${n.tForceDesc}`;if(e.rule_type==="no_auto_push_category")return`「${a}」 · ${n.tCategoryDesc}`;if(e.rule_type==="accounting_period"){const s=e.rule_body.mode==="prev_month"?n.pmPrev:n.pmCurrent;return`${n.gPeriodDesc} · <b>${s}</b>`}return e.rule_type}function Ml(e){const n=ce(),a=e.severity||"medium",o=a==="high"?n.sevHigh:a==="low"?n.sevLow:n.sevMid;return`<div class="rs-rule"><div class="rs-rm"><div class="rs-rt">${Tl(e)}</div></div><span class="rs-sev ${a}">${o}</span><button class="rs-sw${e.is_active?"":" off"}" data-toggle="${e.id}" aria-label="toggle"></button><button class="rs-icobtn" data-edit="${e.id}" aria-label="edit">${Ne("pencil",14)}</button><button class="rs-icobtn" data-del="${e.id}" aria-label="delete">${Ne("trash",14)}</button></div>`}function Kt(e,n,a,o,s){const i=ce(),c=wn.filter(f=>s.includes(f.rule_type)).map(Ml).join("")||`<div class="rs-empty">${i.empty}</div>`;return`<div class="rs-group"><div class="rs-ghead"><div class="rs-gico">${Ne(e,17)}</div><div><div class="rs-gt">${n}</div><div class="rs-gd">${a}</div></div><button class="rs-addbtn" data-add-type="${o}">${Ne("plus",14)} ${i.add}</button></div><div class="rs-gbody">${c}</div></div>`}function as(){const e=ce(),n=document.querySelector("#rules-settings-modal .rs-head h2");n&&(n.textContent=e.title);const a=document.getElementById("rs-body");a&&(a.innerHTML=`<p class="rs-lead">${e.lead}</p>`+Kt("building",e.gSupplier,e.gSupplierDesc,"supplier_force_review",["supplier_force_review"])+Kt("wallet",e.gAmount,e.gAmountDesc,"amount_limit",["amount_limit"])+Kt("calendar",e.gPeriod,e.gPeriodDesc,"accounting_period",["accounting_period"])+Kt("octagon",e.gCategory,e.gCategoryDesc,"no_auto_push_category",["no_auto_push_category"]))}async function kn(){try{const e=await yt("GET","?include_inactive=1");if(!e.ok)throw new Error("http "+e.status);wn=(await e.json()).rules||[],as()}catch{showToast(ce().loadFail,"error")}}function On(e){const n=ce(),a=e?e.severity:Be==="supplier_force_review"?"high":"medium",o=`<div class="rs-mlbl">${n.fSeverity}</div><select class="rs-field" id="rs-f-sev">${Sl(a)}</select>`;if(Be==="amount_limit"){const i=e?e.subject_type:ka,r=e&&e.subject_key?escapeHtml(e.subject_key):"",c=e?String(e.rule_body.limit??""):"",f=e?!!e.rule_body.notify_line:!0,d=i==="global"?"":`<div class="rs-mlbl">${i==="category"?n.fCategory:n.fSupplierTax}</div><input class="rs-field" id="rs-f-key" value="${r}">`;return`<div class="rs-mlbl">${n.gAmountDesc}</div><select class="rs-field" id="rs-f-scope"${e?" disabled":""}><option value="global"${i==="global"?" selected":""}>${n.anyInvoice}</option><option value="supplier"${i==="supplier"?" selected":""}>${n.tForce}</option><option value="category"${i==="category"?" selected":""}>${n.fCategory}</option></select><div id="rs-f-subj">${d}</div><div class="rs-two"><div><div class="rs-mlbl">${n.fAmountLimit}</div><input class="rs-field" id="rs-f-limit" type="number" min="1" value="${c}"></div><div>${o}</div></div><label class="rs-check"><input type="checkbox" id="rs-f-line"${f?" checked":""}>${Ne("bell",14)} ${n.fAlsoLine}</label>`}if(Be==="supplier_force_review")return Qa(n.fSupplierTax,e)+o;if(Be==="no_auto_push_category")return Qa(n.fCategory,e)+o;const s=e?e.rule_body.mode:"current_month";return`<div class="rs-mlbl">${n.fPeriodMode}</div><select class="rs-field" id="rs-f-mode"><option value="current_month"${s==="current_month"?" selected":""}>${n.pmCurrent}</option><option value="prev_month"${s==="prev_month"?" selected":""}>${n.pmPrev}</option></select>`+o}function Jt(e,n,a){return`<button class="rs-type${Be===e?" on":""}" data-type-pick="${e}"><div class="tt">${n}</div><div class="td">${a}</div></button>`}function $l(e){const n=ce(),a=document.getElementById("rs-add-modal");if(!a)return;const o=e?"":`<div class="rs-mlbl">${n.rType}</div><div class="rs-types">`+Jt("supplier_force_review",n.tForce,n.tForceDesc)+Jt("amount_limit",n.tAmount,n.tAmountDesc)+Jt("accounting_period",n.tPeriod,n.tPeriodDesc)+Jt("no_auto_push_category",n.tCategory,n.tCategoryDesc)+"</div>";a.innerHTML=`<div class="rs-pop" style="max-width:460px;"><div class="rs-head"><h2>${e?n.editTitle:n.addTitle}</h2><button class="rs-close" id="rs-add-close">${Ne("x",18)}</button></div><div class="rs-body">${o}<div id="rs-add-fields">${On(e)}</div></div><div class="rs-foot" style="gap:10px;"><button class="rs-btn rs-btn-ghost" id="rs-add-cancel">${n.cancel}</button><button class="rs-btn rs-btn-primary" id="rs-add-save">${n.save}</button></div></div>`,a.classList.add("rs-open")}function We(e){const n=document.getElementById(e);return n?String(n.value).trim():""}function Hl(){const e=ce(),n=We("rs-f-sev")||"medium";if(Be==="amount_limit"){const a=We("rs-f-scope")||"global",o=Number(We("rs-f-limit"));if(!Number.isFinite(o)||o<=0)return showToast(e.needAmount,"error"),{ok:!1};const s=a==="global"?null:We("rs-f-key");if(a!=="global"&&!s)return showToast(a==="category"?e.needCategory:e.needSupplier,"error"),{ok:!1};const i=document.getElementById("rs-f-line")?.checked;return{ok:!0,payload:{rule_type:"amount_limit",subject_type:a,subject_key:s,severity:n,rule_body:{limit:o,basis:"total",period:"per_invoice",notify_line:!!i}}}}if(Be==="supplier_force_review"){const a=We("rs-f-key");return a?{ok:!0,payload:{rule_type:"supplier_force_review",subject_type:"supplier",subject_key:a,severity:n,rule_body:{}}}:(showToast(e.needSupplier,"error"),{ok:!1})}if(Be==="no_auto_push_category"){const a=We("rs-f-key");return a?{ok:!0,payload:{rule_type:"no_auto_push_category",subject_type:"category",subject_key:a,severity:n,rule_body:{}}}:(showToast(e.needCategory,"error"),{ok:!1})}return{ok:!0,payload:{rule_type:"accounting_period",subject_type:"global",subject_key:null,severity:n,rule_body:{mode:We("rs-f-mode")||"current_month"}}}}async function Al(){const e=Hl();if(!(!e.ok||!e.payload))try{let n;if(Nn!==null){const a=e.payload;n=await yt("PATCH","/"+Nn,{rule_body:a.rule_body,severity:a.severity})}else n=await yt("POST","",e.payload);if(!n.ok)throw new Error("http "+n.status);showToast(ce().saved,"success"),document.getElementById("rs-add-modal")?.classList.remove("rs-open"),await kn()}catch{showToast(ce().saveFail,"error")}}async function jl(e){const n=wn.find(a=>a.id===e);if(n)try{const a=await yt("PATCH","/"+e,{is_active:!n.is_active});if(!a.ok)throw new Error("http "+a.status);await kn()}catch{showToast(ce().saveFail,"error")}}async function Pl(e){if(await showConfirm(ce().delConfirm,{danger:!0}))try{const a=await yt("DELETE","/"+e);if(!a.ok)throw new Error("http "+a.status);showToast(ce().deleted,"success"),await kn()}catch{showToast(ce().saveFail,"error")}}function eo(e,n){Be=e,ka="global",Nn=n?n.id:null,$l(n)}function Dl(){if(Za)return;const e=document.createElement("style");e.textContent=Il,document.head.appendChild(e);const n=ce(),a=document.createElement("div");a.id="rules-settings-modal",a.innerHTML=`<div class="rs-pop"><div class="rs-head"><h2>${n.title}</h2><span class="rs-tag">●</span><button class="rs-close" id="rs-main-close">${Ne("x",18)}</button></div><div class="rs-body" id="rs-body"></div><div class="rs-foot"><button class="rs-btn rs-btn-primary" id="rs-done">${n.done}</button></div></div>`,document.body.appendChild(a);const o=document.createElement("div");o.id="rs-add-modal",document.body.appendChild(o),document.addEventListener("click",s=>{const i=s.target;(i.id==="rules-settings-modal"||i.closest("#rs-main-close")||i.closest("#rs-done"))&&a.classList.remove("rs-open"),(i.id==="rs-add-modal"||i.closest("#rs-add-close")||i.closest("#rs-add-cancel"))&&o.classList.remove("rs-open");const r=i.closest("[data-add-type]");r&&eo(r.dataset.addType);const c=i.closest("[data-edit]");if(c){const l=wn.find(p=>p.id===Number(c.dataset.edit));l&&eo(l.rule_type,l)}const f=i.closest("[data-del]");f&&Pl(Number(f.dataset.del));const d=i.closest("[data-toggle]");d&&jl(Number(d.dataset.toggle));const u=i.closest("[data-type-pick]");if(u){Be=u.dataset.typePick,document.querySelectorAll("#rs-add-modal .rs-type").forEach(p=>p.classList.toggle("on",p.dataset.typePick===Be));const l=document.getElementById("rs-add-fields");l&&(l.innerHTML=On())}i.closest("#rs-add-save")&&Al()}),document.addEventListener("change",s=>{const i=s.target;if(i.id==="rs-f-scope"){ka=i.value;const r=document.getElementById("rs-add-fields");r&&(r.innerHTML=On())}}),document.addEventListener("keydown",s=>{s.key==="Escape"&&(o.classList.contains("rs-open")?o.classList.remove("rs-open"):a.classList.contains("rs-open")&&a.classList.remove("rs-open"))}),Za=!0}window.openRulesSettings=function(){Dl(),document.getElementById("rules-settings-modal").classList.add("rs-open"),kn()};function Rl(){const e=document.querySelector("#page-exceptions .page-head-actions");if(!e||document.getElementById("exc-rules-btn"))return;const n=document.createElement("button");n.id="exc-rules-btn",n.type="button",n.className="btn btn-ghost",n.innerHTML=Ne("settings",16)+`<span class="rs-btn-label">${ce().btn}</span>`,n.addEventListener("click",()=>window.openRulesSettings&&window.openRulesSettings()),e.insertBefore(n,e.firstChild)}let to=!1;async function Fl(){if(!to){to=!0;try{(await yt("GET","")).ok&&Rl()}catch{}}}const no=window.loadExceptionsPage;window.loadExceptionsPage=function(){Fl(),no&&no()};Array.isArray(window.__i18nSubs)||(window.__i18nSubs=[]);window.__i18nSubs.push({name:"rules-settings",fn:()=>{const e=document.querySelector("#exc-rules-btn .rs-btn-label");e&&(e.textContent=ce().btn),document.getElementById("rules-settings-modal")?.classList.contains("rs-open")&&as()}});const ql=`
    <div class="cmdk">
...
`;fe("cmdk-mask",ql);(function(){function e(l){try{if(location.search.indexOf("test_center=1")>=0||localStorage.getItem("pearnly_test_mode")==="1"||l&&l.id&&String(l.id)==="468b50c1-5593-4fd6-990d-515ce8085563")return!0}catch{}return!1}window.applyRoleVisibility=function(){var p=window._userInfo,m=!1,v=!0,w=!1,b=!1;p&&(m=typeof canManageTeam=="function"?canManageTeam(p):!!(p.role==="owner"||p.is_super_admin),v=typeof shouldHideMoney=="function"?shouldHideMoney(p):p.role==="member"&&!p.is_super_admin,w=typeof isSuperAdmin=="function"?isSuperAdmin(p):!!p.is_super_admin,b=e(p)),document.querySelectorAll("[data-show-if-team]").forEach(function(h){h.style.display=m?"":"none"}),document.querySelectorAll("[data-show-if-money]").forEach(function(h){h.style.display=v?"none":""}),document.querySelectorAll("[data-show-if-admin]").forEach(function(h){h.style.display=w?"":"none"}),document.querySelectorAll("[data-show-if-test]").forEach(function(h){h.style.display=b?"":"none"});var g=w||b;document.querySelectorAll("[data-show-if-special]").forEach(function(h){h.style.display=g?"":"none"})},window.renderAvatarMenu=function(p){if(p){var m=document.getElementById("avatar-btn"),v=document.getElementById("avatar-popup-name"),w=document.getElementById("avatar-popup-email");if(!(!m||!v||!w)){var b=(p.username||"").trim(),g=b.split("@")[0]||b||"—",h=(b.charAt(0)||"?").toUpperCase(),_=(p.avatar_url||"").trim();if(_){var y=_.replace(/"/g,"&quot;"),k=h.replace(/'/g,"\\'");m.innerHTML='<img src="'+y+'" alt="'+h+`" referrerpolicy="no-referrer" onerror="this.parentNode.textContent='`+k+`'">`}else m.textContent=h;v.textContent=g,w.textContent=b||"—",m.setAttribute("title",b||"")}}};function n(){var l=document.getElementById("avatar-wrap"),p=document.getElementById("avatar-btn"),m=document.getElementById("avatar-popup");if(!l||!p||!m)return;function v(){m.classList.remove("show"),p.setAttribute("aria-expanded","false")}function w(){m.classList.add("show"),p.setAttribute("aria-expanded","true")}p.addEventListener("click",function(b){b.stopPropagation(),m.classList.contains("show")?v():w()}),document.addEventListener("click",function(b){m.classList.contains("show")&&!l.contains(b.target)&&v()}),m.addEventListener("click",function(b){var g=b.target.closest(".avatar-popup-item");if(g){var h=g.dataset.action;switch(v(),h){case"settings":typeof openSettingsModal=="function"?openSettingsModal():typeof routeTo=="function"&&routeTo("settings");break;case"team":typeof openSettingsModal=="function"?openSettingsModal():typeof routeTo=="function"&&routeTo("settings"),setTimeout(function(){typeof switchSettingsTab=="function"&&switchSettingsTab("team")},50);break;case"billing":typeof openSettingsModal=="function"?openSettingsModal():typeof routeTo=="function"&&routeTo("settings"),setTimeout(function(){typeof switchSettingsTab=="function"&&switchSettingsTab("plan")},50);break;case"shortcuts":if(typeof showToast=="function"){var _=typeof t=="function"?t("feature-coming-soon"):"即将上线";showToast(_||"即将上线","info")}break;case"admin":window.location.href="/admin/cost";break;case"test-center":typeof routeTo=="function"&&routeTo("test-center");break;case"help":var y=document.getElementById("help-modal");y&&(y.style.display="flex");break;case"logout":try{localStorage.removeItem("mrpilot_token")}catch{}try{localStorage.removeItem("mrpilot_user")}catch{}window.location.href="/";break}}}),window._closeAvatarPopup=v}function a(){return[].slice.call(document.querySelectorAll(".cmdk-item")).filter(function(l){return l.style.display!=="none"})}function o(l){var p=a();p.forEach(function(m){m.classList.remove("focus")}),p[l]&&(p[l].classList.add("focus"),p[l].scrollIntoView({block:"nearest"}))}function s(l){var p=a();if(p.length){var m=p.findIndex(function(w){return w.classList.contains("focus")});m<0&&(m=0);var v=(m+l+p.length)%p.length;o(v)}}function i(l){l=(l||"").toLowerCase().trim();var p=0,m=window._userInfo,v=typeof isSuperAdmin=="function"?isSuperAdmin(m):!!(m&&m.is_super_admin),w=e(m);document.querySelectorAll(".cmdk-item").forEach(function(g){if(g.dataset.showIfAdmin==="1"&&!v){g.style.display="none";return}if(g.dataset.showIfTest==="1"&&!w){g.style.display="none";return}var h=(g.dataset.cmdkText||g.textContent||"").toLowerCase(),_=!l||h.indexOf(l)>=0;g.style.display=_?"":"none",g.classList.remove("focus"),_&&p++}),document.querySelectorAll("[data-cmdk-section]").forEach(function(g){for(var h=g.nextElementSibling,_=!1;h&&!h.hasAttribute("data-cmdk-section");){if(h.classList&&h.classList.contains("cmdk-item")&&h.style.display!=="none"){_=!0;break}h=h.nextElementSibling}g.style.display=_?"":"none"});var b=document.getElementById("cmdk-empty");b&&(b.style.display=p===0?"flex":"none"),o(0)}window.openCmdk=function(){var p=document.getElementById("cmdk-mask");p&&(typeof window._closeAvatarPopup=="function"&&window._closeAvatarPopup(),p.classList.add("show"),typeof window.applyRoleVisibility=="function"&&window.applyRoleVisibility(),setTimeout(function(){var m=document.getElementById("cmdk-input");m&&(m.value="",i(""),m.focus(),o(0))},50))},window.closeCmdk=function(){var p=document.getElementById("cmdk-mask");p&&p.classList.remove("show")};function r(l){if(l){if(l.classList.contains("cmdk-item-locked")){if(typeof showToast=="function"){var p=typeof t=="function"?t("feature-coming-soon"):"即将上线";showToast(p||"即将上线","info")}return}var m=l.dataset.cmdkRoute,v=l.dataset.cmdkAction;if(window.closeCmdk(),m){typeof routeTo=="function"&&routeTo(m);return}if(v){if(v==="open-admin"){window.location.href="/admin/cost";return}if(v.indexOf("lang-")===0){var w=v.slice(5);typeof applyLang=="function"&&applyLang(w)}}}}function c(){var l=document.getElementById("cmdk-mask"),p=document.getElementById("cmdk-input"),m=document.getElementById("cmdk-body");if(!(!l||!p||!m)){l.addEventListener("click",function(b){b.target===l&&window.closeCmdk()});var v=document.getElementById("cmdk-esc-btn");v&&v.addEventListener("click",function(){window.closeCmdk()}),p.addEventListener("input",function(b){i(b.target.value)}),p.addEventListener("keydown",function(b){b.key==="ArrowDown"?(b.preventDefault(),s(1)):b.key==="ArrowUp"?(b.preventDefault(),s(-1)):b.key==="Enter"?(b.preventDefault(),r(l.querySelector(".cmdk-item.focus"))):b.key==="Escape"&&(b.preventDefault(),window.closeCmdk())}),m.addEventListener("click",function(b){var g=b.target.closest(".cmdk-item");g&&r(g)}),m.addEventListener("mousemove",function(b){var g=b.target.closest(".cmdk-item");!g||g.style.display==="none"||g.classList.contains("cmdk-item-locked")||(a().forEach(function(h){h.classList.remove("focus")}),g.classList.add("focus"))});var w=document.getElementById("topbar-search");w&&(w.addEventListener("click",function(){window.openCmdk()}),w.addEventListener("keydown",function(b){(b.key==="Enter"||b.key===" ")&&(b.preventDefault(),window.openCmdk())}))}}document.addEventListener("keydown",function(l){if((l.metaKey||l.ctrlKey)&&(l.key==="k"||l.key==="K")){l.preventDefault(),window.openCmdk();return}if(l.key==="Escape"){var p=document.getElementById("cmdk-mask");if(p&&p.classList.contains("show")){window.closeCmdk();return}var m=document.getElementById("avatar-popup");m&&m.classList.contains("show")&&typeof window._closeAvatarPopup=="function"&&window._closeAvatarPopup()}});try{var f=(navigator.userAgent||"").toLowerCase(),d=f.indexOf("mac")>=0||f.indexOf("iphone")>=0||f.indexOf("ipad")>=0;d||document.body.classList.add("is-windows")}catch{}function u(){n(),c(),typeof window.subscribeI18n=="function"&&window.subscribeI18n("nav-ia-phase1-role",function(){try{typeof window.applyRoleVisibility=="function"&&window.applyRoleVisibility()}catch{}})}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",u):u()})();(function(){function n(v){return String(v??"").replace(/[&<>"']/g,function(w){return{"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"}[w]})}function a(v){if(!v||isNaN(v))return"";var w=Number(v);return w<1024?w+" B":w<1024*1024?(w/1024).toFixed(1)+" KB":(w/1024/1024).toFixed(1)+" MB"}document.addEventListener("click",function(v){var w=v.target.closest&&v.target.closest(".recon-collapse-head");if(w&&!(v.target.closest("button")||v.target.closest("a"))){var b=w.closest(".recon-collapse");if(b){var g=b.getAttribute("data-collapsed")==="true";b.setAttribute("data-collapsed",g?"false":"true"),g&&(b.id==="vex-summary-collapse"&&u(),b.id==="vex-detail-collapse"&&l())}}}),document.addEventListener("keydown",function(v){if(!(v.key!=="Enter"&&v.key!==" ")){var w=v.target.closest&&v.target.closest(".recon-collapse-head");w&&(v.preventDefault(),w.click())}});var o={vat:"",gl:""};window._glvClearPreviewSearch=function(){o.vat="",o.gl=""};var s='<svg class="vex-pp-fi-icon" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#111111" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/></svg>',i='<svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg>';function r(){f("vat"),f("gl")}function c(v){try{if(typeof window._glvPreviewFiles=="function")return window._glvPreviewFiles(v)||[]}catch{}var w=document.getElementById(v==="vat"?"glv-vat-input":"glv-gl-input");return w&&w.files?Array.from(w.files):[]}function f(v){var w=document.getElementById(v==="vat"?"glv-pp-vat-col":"glv-pp-gl-col");if(w){var b=c(v),g=v==="vat"?"glv-up-vat-title":"glv-up-gl-title",h=v==="vat"?"① 销项税报告":"② 总账 GL",_=window.t&&window.t(g)||h,y=n(window.t&&window.t("vex-preview-search")||"搜索文件名..."),k=n(window.t&&window.t("vex-preview-clear-all")||"全清"),x=o[v]||"",E=b.length;w.innerHTML='<div class="vex-pp-col-title"><span class="vex-pp-col-name">'+n(_)+' <span class="vex-pp-col-count">'+E+'</span></span></div><div class="vex-pp-search-row"><input class="vex-pp-search" id="glv-pp-search-'+v+'" type="text" placeholder="'+y+'" value="'+n(x)+'" autocomplete="off"><button class="vex-pp-clear-btn" id="glv-pp-clearall-'+v+'" type="button">'+k+'</button></div><div class="vex-pp-file-list" id="glv-pp-'+v+'-list"></div><div class="vex-pp-pagination" id="glv-pp-'+v+'-pg"></div>';var I=document.getElementById("glv-pp-search-"+v);I&&I.addEventListener("input",function(L){o[v]=L.target.value,d(v)});var B=document.getElementById("glv-pp-clearall-"+v);B&&B.addEventListener("click",function(){window._glvRemoveFile&&window._glvRemoveFile(v)}),d(v)}}function d(v){var w=document.getElementById("glv-pp-"+v+"-list"),b=document.getElementById("glv-pp-"+v+"-pg");if(w){var g=c(v),h=(o[v]||"").toLowerCase(),_=g.map(function(x,E){return{f:x,i:E}}),y=h?_.filter(function(x){return x.f.name.toLowerCase().indexOf(h)>=0}):_;if(w.innerHTML=y.map(function(x){var E=x.f;return'<div class="vex-pp-file-row">'+s+'<span class="vex-pp-fi-name" title="'+n(E.name)+'">'+n(E.name)+'</span><span class="vex-pp-fi-size">'+a(E.size)+'</span><button class="vex-pp-fi-del" type="button" data-kind="'+v+'" data-idx="'+x.i+'" aria-label="remove">'+i+"</button></div>"}).join(""),w.querySelectorAll(".vex-pp-fi-del").forEach(function(x){x.addEventListener("click",function(){var E=x.dataset.kind,I=parseInt(x.dataset.idx,10);window._glvRemoveFile&&window._glvRemoveFile(E,isNaN(I)?null:I)})}),b){var k=window.t&&window.t("vex-preview-count")||"显示前 {n} / 共 {m}";b.textContent=k.replace("{n}",y.length).replace("{m}",y.length)}}}function u(){var v=function(b,g){var h=document.getElementById(b);h&&(h.textContent=g==null?"—":String(g))},w=window._vexLastTask||{};v("vex-sum-total",w.total),v("vex-sum-matched",w.matched),v("vex-sum-diff",w.diff),v("vex-sum-incomplete",w.incomplete),v("vex-sum-cash",w.cash),document.getElementById("vex-summary-sub")}function l(){var v=window._vexLastTask&&window._vexLastTask.diff_rows||[],w=document.getElementById("vex-detail-tbody"),b=document.getElementById("vex-detail-table"),g=document.getElementById("vex-detail-empty");if(!(!w||!b||!g)){if(v.length===0){b.style.display="none",g.style.display="";return}g.style.display="none",b.style.display="";var h=v.map(function(y){return'<tr><td class="recon-detail-cell-mono">'+n(y.invoice_no||"")+"</td><td>"+n(y.field||"")+"</td><td>"+n(y.report_value||"")+"</td><td>"+n(y.invoice_value||"")+"</td><td>"+n(y.kind||"")+"</td></tr>"}).join("");w.innerHTML=h;var _=document.getElementById("vex-detail-sub");_&&(_.textContent=String(v.length))}}function p(){var v=document.getElementById("glv-toggle-preview");v&&!v._reconBound&&(v._reconBound=!0,v.addEventListener("click",function(){var w=document.getElementById("glv-preview-panel"),b=document.getElementById("glv-toggle-preview-label"),g=w&&w.style.display!=="none";w&&(w.style.display=g?"none":""),v.classList.toggle("open",!g),b&&(b.textContent=g?window.t&&window.t("vex-toggle-preview-open")||"查看清单":window.t&&window.t("vex-toggle-preview-close")||"收起清单"),g||r()})),["glv-vat-input","glv-gl-input"].forEach(function(w){var b=document.getElementById(w);!b||b._reconWatched||(b._reconWatched=!0,b.addEventListener("change",function(){var g=document.getElementById("glv-preview-panel");g&&g.style.display!=="none"&&r()}))})}function m(){var v=document.getElementById("vex-summary-collapse"),w=document.getElementById("vex-detail-collapse");v&&(v.style.display=""),w&&(w.style.display=""),u(),l()}window._fillVexSummary=u,window._fillVexDetail=l,window._onVexResultShown=m,document.addEventListener("DOMContentLoaded",function(){p()}),setTimeout(p,1500),typeof window.subscribeI18n=="function"&&window.subscribeI18n("recon-collapse",function(){var v=document.getElementById("glv-preview-panel");v&&v.style.display!=="none"&&r();var w=document.getElementById("glv-toggle-preview-label"),b=document.getElementById("glv-toggle-preview");w&&b&&(w.textContent=b.classList.contains("open")?window.t&&window.t("vex-toggle-preview-close")||"收起清单":window.t&&window.t("vex-toggle-preview-open")||"查看清单")}),window._reconCollapse={renderGlvPreview:r,fillVexSummary:u,fillVexDetail:l}})();(function(){function e(i){}function n(){const i=document.querySelectorAll("[data-recon-tab]");i.forEach(c=>{c.addEventListener("click",()=>{i.forEach(p=>p.classList.remove("active")),c.classList.add("active");const f=c.dataset.reconTab,d=document.getElementById("recon-pane-bank"),u=document.getElementById("recon-pane-sale-vat"),l=document.getElementById("recon-pane-gl-vat");d&&(d.style.display=f==="bank"?"":"none"),u&&(u.style.display=f==="sale-vat"?"":"none"),l&&(l.style.display=f==="gl-vat"?"":"none"),f==="gl-vat"&&window.GlVatRecon&&window.GlVatRecon.ensureInit(),f==="bank"&&typeof window._bankReconV2Init=="function"&&window._bankReconV2Init()})});const r=document.querySelector("[data-recon-tab].active");r&&(r.dataset.reconTab,void 0)}function a(){const i=document.getElementById("page-settings");if(!i)return null;let r=document.getElementById("settings-modal-overlay");if(r)return r;r=document.createElement("div"),r.id="settings-modal-overlay",r.className="settings-modal-overlay",r.style.display="none",i.parentElement.insertBefore(r,i),r.appendChild(i);const c=document.createElement("button");return c.id="settings-modal-close",c.className="settings-modal-close",c.setAttribute("aria-label","close"),c.innerHTML='<svg viewBox="0 0 20 20" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M5 5l10 10M15 5L5 15"/></svg>',i.insertBefore(c,i.firstChild),c.addEventListener("click",s),r.addEventListener("click",f=>{f.target===r&&s()}),r}function o(){const i=a();if(!i)return;i.style.display="flex",document.body.classList.add("settings-modal-open");const r=document.getElementById("page-settings");r&&(r.style.display="block"),setTimeout(()=>{try{typeof renderSettings=="function"&&renderSettings()}catch(f){console.warn("renderSettings:",f)}let c=document.querySelector(".settings-tab.active")||document.querySelector('.settings-tab[data-tab="profile"]');c&&c.click()},50)}function s(){const i=document.getElementById("settings-modal-overlay");i&&(i.style.display="none"),document.body.classList.remove("settings-modal-open")}window.openSettingsModal=o,window.closeSettingsModal=s,document.addEventListener("keydown",i=>{if(i.key==="Escape"){const r=document.getElementById("settings-modal-overlay");r&&r.style.display==="flex"&&s()}}),window.addEventListener("hashchange",()=>{location.hash==="#/settings"&&o()}),window.addEventListener("DOMContentLoaded",()=>{location.hash==="#/settings"&&o()}),document.readyState==="loading"?document.addEventListener("DOMContentLoaded",n):n()})();const Mn=1e3,$n=30,xa=/\.(pdf|jpe?g|png|webp|tiff?|xlsx?|xlsm|csv|tsv|docx?)$/i,Y=e=>document.getElementById(e);function ot(){return{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||"")}}function ge(e){const n={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"};return String(e??"").replace(/[&<>"']/g,a=>n[a])}function os(e){return e<1024?e+" B":e<1024*1024?(e/1024).toFixed(1)+" KB":(e/1024/1024).toFixed(1)+" MB"}const H={invoiceFiles:[],reportFiles:[],running:!1,vexAllRows:[],previewLimitInv:50,previewLimitRep:50,previewSearchInv:"",previewSearchRep:"",vexPage:1};async function Qt(){try{const e=await fetch("/api/vat_excel/tasks?page=1&page_size=1",{headers:ot()});if(!e.ok)return;const a=(await e.json()).kpi||{};[["vex-kpi-month-val",a.this_month],["vex-kpi-running-val",a.running],["vex-kpi-done-val",a.done],["vex-kpi-failed-val",a.failed]].forEach(([o,s])=>{const i=document.getElementById(o);i&&(i.textContent=s??0)})}catch{}}async function en(){try{const e=await fetch("/api/vat_excel/tasks?page=1&page_size=100",{headers:ot()});if(!e.ok)return;const n=await e.json();ln(n.rows||[])}catch{}}const ut=10;function ss(){var e=((document.getElementById("vex-task-search")||{}).value||"").trim().toLowerCase();if(H.vexPage=1,ln(H.vexAllRows),!!e){var n=document.getElementById("vex-task-tbody");n&&n.querySelectorAll("tr").forEach(function(a){a.dataset.taskId&&(a.style.display=a.textContent.toLowerCase().indexOf(e)>=0?"":"none")})}}function ln(e){H.vexAllRows=e||H.vexAllRows;const n=document.getElementById("vex-task-tbody");if(!n)return;if(!H.vexAllRows.length){n.innerHTML='<tr><td colspan="9" class="vex-task-empty">'+(t("sv-empty-title")||"还没有对账任务")+"</td></tr>",ao(0);return}const a=Math.ceil(H.vexAllRows.length/ut);H.vexPage>a&&(H.vexPage=a);const o=(H.vexPage-1)*ut;zl(H.vexAllRows.slice(o,o+ut)),ao(H.vexAllRows.length)}function ao(e){const n=document.getElementById("vex-task-pager"),a=document.getElementById("vex-task-pager-info"),o=document.getElementById("vex-task-prev"),s=document.getElementById("vex-task-next");if(!n)return;if(e<=ut){n.style.display="none";return}n.style.display="";const i=Math.ceil(e/ut);a&&(a.textContent=H.vexPage+" / "+i),o&&(o.disabled=H.vexPage<=1),s&&(s.disabled=H.vexPage>=i)}function zl(e){const n=document.getElementById("vex-task-tbody");if(!n)return;const a={pending:t("vex-status-pending")||"待处理",running:t("vex-status-running")||"处理中",done:t("vex-status-done")||"已完成",failed:t("vex-status-failed")||"失败"},o={pending:"badge-gray",running:"badge-blue",done:"badge-green",failed:"badge-red"},s='<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M8 2v9M4 7l4 4 4-4M3 14h10"/></svg>',i='<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M3 4h10M6 4V3h4v1M5 4v8a1 1 0 001 1h4a1 1 0 001-1V4"/></svg>';n.innerHTML=e.map(r=>{const c=r.created_at?new Date(r.created_at).toLocaleString([],{year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",minute:"2-digit"}):"—",f=r.period||"—",d=r.matched_count!=null?r.matched_count+" ✓ · "+r.mismatched_count+" ⚠":"—",u=r.mismatch_amount!=null?"฿ "+Number(r.mismatch_amount).toLocaleString():"—",l=r.elapsed_seconds!=null?r.elapsed_seconds.toFixed(1)+" s":"—",p=r.status||"pending",m=r.client_name&&r.client_name!=="client"?r.client_name:t("vex-client-all")||"全部客户";return`<tr class="vex-task-row" data-task-id="${ge(r.id)}" style="cursor:pointer">
        ...
        </tr>`}).join(""),n.querySelectorAll(".vex-task-dl-btn").forEach(r=>{r.addEventListener("click",async c=>{c.stopPropagation();const f=r.dataset.taskId;try{const d=await fetch("/api/vat_excel/tasks/"+encodeURIComponent(f)+"/download",{credentials:"include",headers:ot()});if(d.status===410){showToast(t("vex-toast-expired")||"数据已过期 · 请重新对账","warn");return}if(!d.ok){showToast(t("vex-toast-dl-fail")||"下载失败 · 请重试","error");return}const u=await d.blob(),p=(d.headers.get("Content-Disposition")||"").match(/filename\*?=(?:UTF-8''|")?([^";]+)/i),m=p?decodeURIComponent(p[1]):"vat_recon_"+f+".xlsx",v=URL.createObjectURL(u),w=document.createElement("a");w.href=v,w.download=m,w.click(),setTimeout(()=>URL.revokeObjectURL(v),1e3)}catch{showToast(t("vex-toast-dl-fail")||"下载失败 · 请重试","error")}})}),n.querySelectorAll(".vex-task-del-btn").forEach(r=>{r.addEventListener("click",c=>{c.stopPropagation(),Ol(r.dataset.taskId)})}),ss()}function Nl(){var e=document.getElementById("vex-task-prev"),n=document.getElementById("vex-task-next");e&&!e._vexBound&&(e._vexBound=!0,e.addEventListener("click",function(){H.vexPage>1&&(H.vexPage--,ln())})),n&&!n._vexBound&&(n._vexBound=!0,n.addEventListener("click",function(){var a=Math.ceil(H.vexAllRows.length/ut);H.vexPage<a&&(H.vexPage++,ln())}))}async function Ol(e){const n=t("vex-task-delete-confirm-title")||"删除对账任务?",a=t("vex-task-delete-confirm-body")||"同时清掉对应的发票识别缓存 · 不可恢复";if(await showConfirm(a,{title:n,danger:!0,okText:t("vex-task-delete-confirm-title")||"确认删除"}))try{const s=await fetch("/api/vat_excel/tasks/"+encodeURIComponent(e),{method:"DELETE",credentials:"include",headers:ot()});if(!s.ok)throw new Error(s.status);showToast(t("vex-task-delete-ok")||"已删除","success"),en(),Qt()}catch{showToast(t("vex-task-delete-fail")||"删除失败","error")}}function is(e){const n=window._currentLang||"th",a={zh:`已忽略 ${e} 个不支持的文件 · 仅支持 PDF / 图片 / Excel / CSV / Word`,th:`ข้ามไฟล์ที่ไม่รองรับ ${e} ไฟล์ · รองรับเฉพาะ PDF / รูปภาพ / Excel / CSV / Word`,en:`Ignored ${e} unsupported file(s) · only PDF / image / Excel / CSV / Word are supported`,ja:`非対応ファイル ${e} 件をスキップ · 対応形式は PDF / 画像 / Excel / CSV / Word のみ`};showToast(a[n]||a.th,"warn")}function Vl(e){const n=new Set(H.invoiceFiles.map(o=>o.name+"|"+o.size));let a=0;for(const o of e){if(!xa.test(o.name)){a++;continue}const s=o.name+"|"+o.size;if(!n.has(s)&&(n.add(s),H.invoiceFiles.push(o),H.invoiceFiles.length>=Mn))break}a>0&&is(a),H.invoiceFiles.length>Mn&&(H.invoiceFiles=H.invoiceFiles.slice(0,Mn),showToast(t("vex-toast-cap-inv"),"warn")),Ue()}function Ul(e){const n=new Set(H.reportFiles.map(o=>o.name+"|"+o.size));let a=0;for(const o of e){if(!xa.test(o.name)){a++;continue}const s=o.name+"|"+o.size;if(!n.has(s)&&(n.add(s),H.reportFiles.push(o),H.reportFiles.length>=$n))break}a>0&&is(a),H.reportFiles.length>$n&&(H.reportFiles=H.reportFiles.slice(0,$n),showToast(t("vex-toast-cap-rep"),"warn")),Ue()}function rs(e){H.invoiceFiles.splice(e,1),Ue()}function ls(e){H.reportFiles.splice(e,1),Ue()}function Ue(){const e=Y("vex-list-invoice"),n=Y("vex-list-report"),a=Y("vex-count-invoice"),o=Y("vex-count-report");a&&(a.textContent=H.invoiceFiles.length),o&&(o.textContent=H.reportFiles.length);const s=(c,f,d)=>`<div class="vex-fi">
        ...
        <span class="vex-fi-s">${os(c.size)}</span>
        <button class="vex-fi-x" type="button" data-vex-kind="${d}" data-vex-idx="${f}" aria-label="remove">×</button>
    </div>`;e&&(e.innerHTML=H.invoiceFiles.map((c,f)=>s(c,f,"inv")).join("")||'<div class="vex-fi-empty" data-i18n="vex-no-files">还没文件</div>'),n&&(n.innerHTML=H.reportFiles.map((c,f)=>s(c,f,"rep")).join("")||'<div class="vex-fi-empty" data-i18n="vex-no-files">还没文件</div>'),document.querySelectorAll(".vex-fi-x").forEach(c=>{c.addEventListener("click",f=>{const d=c.dataset.vexKind,u=parseInt(c.dataset.vexIdx,10);d==="inv"?rs(u):ls(u)})});const i=H.invoiceFiles.length>0&&H.reportFiles.length>0;Y("vex-build").disabled=!i||H.running;const r=Y("vex-action-info");r&&(!H.invoiceFiles.length||!H.reportFiles.length?(r.textContent=t("vex-need-both")||"需要至少 1 张发票 + 1 份 VAT 报告",r.className="vex-action-info muted"):(r.textContent=(t("vex-ready")||"已就绪 · {a} 张发票 · {b} 份报告").replace("{a}",H.invoiceFiles.length).replace("{b}",H.reportFiles.length),r.className="vex-action-info ok")),Vn()}const Gl='<svg class="vex-pp-fi-icon" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#6B7280" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path><polyline points="14 2 14 8 20 8"></polyline></svg>',Kl='<svg class="vex-pp-fi-icon" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#111111" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="4" width="18" height="18" rx="2" ry="2"></rect><line x1="16" y1="2" x2="16" y2="6"></line><line x1="8" y1="2" x2="8" y2="6"></line><line x1="3" y1="10" x2="21" y2="10"></line></svg>',Jl='<svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg>';function Vn(){const e=Y("vex-preview-panel");if(!e||e.style.display==="none")return;oo("inv"),oo("rep");const n=Y("vex-pp-guide");n&&(n.style.display=H.invoiceFiles.length>100?"flex":"none")}function oo(e){const n=Y(e==="inv"?"vex-pp-invoice-col":"vex-pp-report-col");if(!n)return;const a=e==="inv"?H.invoiceFiles:H.reportFiles,o=e==="inv"?H.previewSearchInv:H.previewSearchRep,s=t(e==="inv"?"vex-preview-invoice":"vex-preview-report")||(e==="inv"?"销售发票":"VAT 报告"),i=ge(t("vex-preview-search")||"搜索文件名..."),r=ge(t("vex-preview-clear-all")||"全清");n.innerHTML=`
        ...
        <div class="vex-pp-pagination" id="vex-pp-${e}-pg"></div>`;const c=Y("vex-pp-search-"+e);c&&c.addEventListener("input",d=>{e==="inv"?(H.previewSearchInv=d.target.value,H.previewLimitInv=50):(H.previewSearchRep=d.target.value,H.previewLimitRep=50),Un(e)});const f=Y("vex-pp-clearall-"+e);f&&f.addEventListener("click",()=>{e==="inv"?(H.invoiceFiles=[],H.previewSearchInv="",H.previewLimitInv=50):(H.reportFiles=[],H.previewSearchRep="",H.previewLimitRep=50),Ue()}),Un(e)}function Un(e){const n=Y("vex-pp-"+e+"-list"),a=Y("vex-pp-"+e+"-pg");if(!n)return;const o=e==="inv"?H.invoiceFiles:H.reportFiles,s=e==="inv"?H.previewSearchInv:H.previewSearchRep,i=e==="inv"?H.previewLimitInv:H.previewLimitRep,r=e==="inv"?Gl:Kl,c=o.map((u,l)=>({f:u,i:l})),f=s?c.filter(({f:u})=>u.name.toLowerCase().includes(s.toLowerCase())):c,d=f.slice(0,i);if(n.innerHTML=d.map(({f:u,i:l})=>`
        <div class="vex-pp-file-row">
            ${r}
            <span class="vex-pp-fi-name" title="${ge(u.name)}">${ge(u.name)}</span>
            <span class="vex-pp-fi-size">${os(u.size)}</span>
            <button class="vex-pp-fi-del" type="button" data-kind="${e}" data-ridx="${l}" aria-label="remove">${Jl}</button>
        </div>`).join("")+`<div id="vex-pp-sentinel-${e}" style="height:1px;flex-shrink:0"></div>`,n.querySelectorAll(".vex-pp-fi-del").forEach(u=>{u.addEventListener("click",()=>{const l=parseInt(u.dataset.ridx,10);u.dataset.kind==="inv"?rs(l):ls(l)})}),a){const u=t("vex-preview-count")||"显示前 {n} / 共 {m}";a.textContent=u.replace("{n}",d.length).replace("{m}",f.length)}Wl(e,f.length)}function Wl(e,n){if((e==="inv"?H.previewLimitInv:H.previewLimitRep)>=n)return;const o=Y("vex-pp-sentinel-"+e),s=Y("vex-pp-"+e+"-list");if(!o||!s)return;const i=new IntersectionObserver(r=>{r[0].isIntersecting&&(i.disconnect(),e==="inv"?H.previewLimitInv+=50:H.previewLimitRep+=50,Un(e))},{root:s,threshold:.8});i.observe(o)}function so(e,n,a,o){const s=Y(e),i=Y(n);!s||!i||(s.addEventListener("click",()=>i.click()),s.addEventListener("keydown",r=>{(r.key==="Enter"||r.key===" ")&&(r.preventDefault(),i.click())}),s.addEventListener("dragover",r=>{r.preventDefault(),s.classList.add("drag-over")}),s.addEventListener("dragleave",()=>s.classList.remove("drag-over")),s.addEventListener("drop",r=>{r.preventDefault(),s.classList.remove("drag-over");const f=Array.from(r.dataTransfer.files).filter(d=>xa.test(d.name));if(!f.length){showToast(t("vex-toast-bad-ext"),"error");return}a(f)}),i.addEventListener("change",()=>{const r=Array.from(i.files);a(r),i.value=""}))}(function(){async function e(){if(H.running||!H.invoiceFiles.length||!H.reportFiles.length)return;H.running=!0,Y("vex-build").disabled=!0,Y("vex-progress").style.display="flex";var r=document.getElementById("vex-download");r&&(r.style.display="none"),["vex-summary-collapse","vex-detail-collapse"].forEach(function(u){var l=document.getElementById(u);l&&(l.style.display="none")});const c=Date.now();Y("vex-progress-title").textContent=t("vex-progress-running")||"AI 抽取中",Y("vex-progress-sub").textContent=(t("vex-progress-sub")||"{a} 张发票 + {b} 份报告 · 并行处理").replace("{a}",H.invoiceFiles.length).replace("{b}",H.reportFiles.length);const f=setInterval(()=>{const u=Math.floor((Date.now()-c)/1e3);Y("vex-progress-sub").textContent=(t("vex-progress-elapsed")||"已 {s} 秒 · {a} 张发票 + {b} 份报告").replace("{s}",u).replace("{a}",H.invoiceFiles.length).replace("{b}",H.reportFiles.length)},1e3);try{const u=new FormData;for(const L of H.invoiceFiles)u.append("invoices",L);for(const L of H.reportFiles)u.append("reports",L);const l=typeof currentLang=="string"&&currentLang||localStorage.getItem("mrpilot_lang")||"th";u.append("lang",l);const p=localStorage.getItem("mrpilot_token")||"",m=await fetch("/api/vat_excel/submit",{method:"POST",headers:ot(),body:u});let v=null;try{v=await m.json()}catch{v=null}if(!m.ok||!v||!v.ok||!v.job_id)throw clearInterval(f),new Error(v&&v.detail||"HTTP "+m.status);const w=Y("vex-progress-sub"),b=await window._reconPollJob(v.job_id,p,{onProgress:L=>{w&&(w.textContent=window._reconProgressText(L,l))}});if(clearInterval(f),!b||b.status!=="done"||!b.result_id)throw new Error(t("vex-toast-fail")||"生成失败");const g=b.result_id;let h=0;const _=await fetch("/api/vat_excel/tasks/"+encodeURIComponent(g)+"/download",{headers:ot()});if(!_.ok)throw new Error("HTTP "+_.status);const k=(_.headers.get("Content-Disposition")||"").match(/filename="([^"]+)"/),x=k&&k[1]||"vat_recon_"+Date.now()+".xlsx",E=await _.blob(),I=URL.createObjectURL(E),B=Y("vex-download");B.href=I,B.download=x;try{const L=document.createElement("a");L.href=I,L.download=x,document.body.appendChild(L),L.click(),setTimeout(()=>L.remove(),100)}catch{}Y("vex-progress").style.display="none";var d=document.getElementById("vex-download");d&&(d.style.display=""),g&&(h=await o(g)),window._onVexResultShown&&window._onVexResultShown(),h>0?showToast((t("vex-toast-some-fail")||"有 {n} 张发票 OCR 失败").replace("{n}",h),"warn"):showToast(t("vex-toast-done")||"Excel 已生成","success"),Qt(),setTimeout(en,800)}catch(u){clearInterval(f),Y("vex-progress").style.display="none";const l=(t("vex-toast-fail")||"生成失败")+": "+(u.message||u);showToast(l,"error")}finally{H.running=!1,Y("vex-build").disabled=!1}}function n(){H.invoiceFiles=[],H.reportFiles=[];var r=document.getElementById("vex-download");r&&(r.style.display="none"),Ue()}function a(r){if(r==null)return"—";var c=parseFloat(r);return isNaN(c)?"—":c.toLocaleString("th-TH",{minimumFractionDigits:2,maximumFractionDigits:2})}async function o(r){try{var c=await fetch("/api/vat_excel/tasks/"+encodeURIComponent(r),{headers:ot()});if(!c.ok)throw new Error(c.status);var f=await c.json(),d=f.raw_data_json;if(typeof d=="string")try{d=JSON.parse(d)}catch{d={}}d=d||{};var u=d.rows||[],l=[];u.forEach(function(v){v.kind==="invoice_orphan"?l.push({invoice_no:v.invoice_no||"",field:"仅发票有",report_value:"—",invoice_value:a(v.amount_inv),kind:v.kind}):v.kind==="report_orphan"?l.push({invoice_no:v.invoice_no||"",field:"仅报告有",report_value:a(v.amount_rep),invoice_value:"—",kind:v.kind}):v.dims&&Object.keys(v.dims).length>0&&Object.keys(v.dims).forEach(function(w){var b=String(v.dims[w]||""),g=b.split(" ≠ ");l.push({invoice_no:v.invoice_no||"",field:w,report_value:g[0]||b,invoice_value:g.length>1?g[1]:"—",kind:"diff"})})});var p=u.filter(function(v){return v.kind==="matched_cash"}).length,m=Math.max(0,parseInt(d.invoice_ocr_failed_count||0,10));return window._vexLastTask={total:d.n_total||0,matched:d.n_ok||0,diff:d.n_diff||0,incomplete:m,cash:p,diff_rows:l,task_id:r},window._fillVexSummary&&window._fillVexSummary(),window._fillVexDetail&&window._fillVexDetail(),m}catch{return 0}}function s(){const r=document.getElementById("vex-pane");r&&r.querySelectorAll("[data-i18n]").forEach(c=>{const f=t(c.dataset.i18n);f&&(c.textContent=f)}),Ue(),en()}function i(){so("vex-drop-invoice","vex-input-invoice",Vl),so("vex-drop-report","vex-input-report",Ul);const r=Y("vex-build"),c=Y("vex-reset");r&&r.addEventListener("click",e),c&&c.addEventListener("click",n),document.querySelectorAll('[data-recon-tab="sale-vat"]').forEach(u=>{u.addEventListener("click",()=>{Qt(),en()})}),Nl();const f=document.getElementById("vex-task-search");f&&f.addEventListener("input",ss);const d=document.getElementById("vex-toggle-preview");d&&d.addEventListener("click",()=>{const u=Y("vex-preview-panel"),l=Y("vex-toggle-preview-label"),p=u&&u.style.display!=="none";u&&(u.style.display=p?"none":""),d&&d.classList.toggle("open",!p),l&&(l.textContent=p?t("vex-toggle-preview-open")||"查看清单":t("vex-toggle-preview-close")||"收起清单"),p||Vn()}),Ue(),Qt()}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",i):i(),typeof window.subscribeI18n=="function"&&(window.subscribeI18n("vex-excel",s),window.subscribeI18n("vex-preview-panel",Vn))})();const G={inited:!1,glFile:[],vatFile:[],running:!1,currentTaskId:null,lastDetail:[],lastSummary:null},V=e=>document.getElementById(e),cs=()=>localStorage.getItem("mrpilot_token")||"",wt=()=>typeof window.currentLang=="string"&&window.currentLang?window.currentLang:localStorage.getItem("mrpilot_lang")||"th",st=()=>({Authorization:"Bearer "+cs()}),io={th:{not_found:"ไม่พบข้อมูล",running:"กำลังกระทบยอด…",error:"เกิดข้อผิดพลาด",need_files:"กรุณาเลือกไฟล์ทั้งสอง",done:"เสร็จสิ้น",hint_need_both:"อัปโหลด ① รายงานภาษีขาย + ② GL",hint_need_one_more:"อัปโหลดอีก 1 ไฟล์",hint_ready:"พร้อมแล้ว · กดเริ่มกระทบยอด",hist_load:"โหลด",hist_export:"ส่งออก",hist_delete:"ลบ",confirm_delete:"ยืนยันการลบงานนี้?",s_gl_total:"ยอดรวมตามบัญชีแยกประเภท",s_minus_gl_cr:"หัก : รายการเครดิตที่ไม่มีในรายงานภาษีขาย",s_plus_gl_dr:"บวก : รายการเดบิตที่ไม่มีในรายงานภาษีขาย",s_plus_vat_p:"บวก : รายการยอดขายที่ไม่มีในบัญชีแยกประเภท",s_minus_vat_n:"หัก : รายการลดหนี้ที่ไม่มีในบัญชีแยกประเภท",s_vat_total:"ยอดรวมตามรายงานภาษีขาย"},zh:{not_found:"未找到数据",running:"正在对账中...",error:"出错了",need_files:"请先选择两个文件",done:"完成",hint_need_both:"请上传① 销项税报告 + ② 总账 GL",hint_need_one_more:"还需上传 1 份文件",hint_ready:"已就绪 · 点击开始对账",hist_load:"加载",hist_export:"导出",hist_delete:"删除",confirm_delete:"确认删除此任务？",s_gl_total:"总账金额合计",s_minus_gl_cr:"减：销项税报告中未列的贷方记录",s_plus_gl_dr:"加：销项税报告中未列的借方记录",s_plus_vat_p:"加：总账中未列的销售记录",s_minus_vat_n:"减：总账中未列的贷项凭单(credit note)记录",s_vat_total:"销项税报告金额合计"},en:{not_found:"Not found",running:"Reconciling...",error:"Error",need_files:"Please select both files",done:"Done",hint_need_both:"Upload ① Output VAT report + ② GL file",hint_need_one_more:"1 more file required",hint_ready:"Ready · click Run to start",hist_load:"Load",hist_export:"Export",hist_delete:"Delete",confirm_delete:"Delete this task?",s_gl_total:"Total per General Ledger",s_minus_gl_cr:"Less: GL credits not in VAT Report",s_plus_gl_dr:"Add: GL debits not in VAT Report",s_plus_vat_p:"Add: Sales in VAT Report not in GL",s_minus_vat_n:"Less: Credit notes in VAT Report not in GL",s_vat_total:"Total per VAT Sales Report"},ja:{not_found:"データなし",running:"照合中…",error:"エラー",need_files:"両方のファイルを選択してください",done:"完了",hint_need_both:"① 売上税報告 + ② GL をアップロード",hint_need_one_more:"あと 1 ファイル必要",hint_ready:"準備完了 · 「開始」をクリック",hist_load:"読込",hist_export:"出力",hist_delete:"削除",confirm_delete:"このタスクを削除しますか?",s_gl_total:"総勘定元帳合計",s_minus_gl_cr:"減：売上税報告にないGL貸方記録",s_plus_gl_dr:"加：売上税報告にないGL借方記録",s_plus_vat_p:"加：GLにない売上記録",s_minus_vat_n:"減：GLにない赤伝記録",s_vat_total:"売上税報告合計"}},te=e=>(io[wt()]||io.th)[e]||e;function Yl(e){const n=wt(),o={gl_no_revenue_rows:{zh:"GL 中未找到收入科目行。请确认「收入科目前缀」是否正确(收入科目通常以 4 开头),改对后重试。",th:"ไม่พบรายการบัญชีรายได้ใน GL · ตรวจสอบ «คำนำหน้าบัญชีรายได้» (รายได้มักขึ้นต้นด้วย 4) แล้วลองใหม่",en:"No revenue-account rows found in the GL. Check the “revenue account prefix” (revenue usually starts with 4) and retry.",ja:"GL に収益科目の行が見つかりません。「収益科目プレフィックス」(通常 4 で始まる)を確認して再試行してください。"},gl_parse_failed:{zh:"GL 文件解析失败。请确认文件含日期/科目/借贷列,或换清晰的 Excel/CSV 重传。",th:"อ่านไฟล์ GL ไม่สำเร็จ · ตรวจสอบว่ามีคอลัมน์ วันที่/บัญชี/เดบิต-เครดิต หรืออัปโหลด Excel/CSV ที่ชัดเจน",en:"Failed to parse the GL file. Ensure it has date/account/debit-credit columns, or re-upload a clean Excel/CSV.",ja:"GL ファイルの解析に失敗しました。日付/科目/借方貸方列を確認するか、Excel/CSV を再アップロードしてください。"},vat_no_rows:{zh:"销项税报告里没有可对账的数据行。请确认上传了正确的销项税报告。",th:"ไม่พบแถวข้อมูลในรายงานภาษีขาย · ตรวจสอบว่าอัปโหลดรายงานที่ถูกต้อง",en:"No rows found in the sales-VAT report. Please check you uploaded the correct report.",ja:"売上VATレポートに行が見つかりません。正しいレポートをアップロードしたか確認してください。"},vat_parse_failed:{zh:"销项税报告解析失败。请换更清晰的版本,或转成 Excel/PDF 重传。",th:"อ่านรายงานภาษีขายไม่สำเร็จ · ลองเวอร์ชันที่ชัดเจนกว่า หรือแปลงเป็น Excel/PDF",en:"Failed to parse the sales-VAT report. Try a clearer version, or convert to Excel/PDF.",ja:"売上VATレポートの解析に失敗しました。より鮮明な版か、Excel/PDF に変換してください。"}}[e];return o?o[n]||o.th||o.en:te("error")||"Error"}const Pt=e=>e==null||isNaN(e)?"":Number(e).toLocaleString("en-US",{minimumFractionDigits:2,maximumFractionDigits:2});function _a(e){V("glv-kpi-matched")&&(V("glv-kpi-matched").textContent=e&&e.matched!=null?e.matched:"—"),V("glv-kpi-diff")&&(V("glv-kpi-diff").textContent=e&&e.diff!=null?e.diff:"—"),V("glv-kpi-unmatched")&&(V("glv-kpi-unmatched").textContent=e&&e.unmatched!=null?e.unmatched:"—")}function Xl(e){if(!e)return"";try{const n=new Date(e);if(isNaN(n.getTime()))return e;const a=o=>String(o).padStart(2,"0");return n.getFullYear()+"-"+a(n.getMonth()+1)+"-"+a(n.getDate())+" "+a(n.getHours())+":"+a(n.getMinutes())}catch{return e}}function ro(e,n,a,o){const s=V(e),i=V(n),r=V(a);if(!s||!i||!r)return;const c=f=>{if(!f||!f.length)return;const d=Array.isArray(G[o])?G[o].slice():[],u=new Set(d.map(l=>l.name+"|"+l.size));for(const l of f){if(!l)continue;const p=l.name+"|"+l.size;u.has(p)||(d.push(l),u.add(p))}G[o]=d,ds(r,d),zt(),Ot(),window._reconCollapse&&window._reconCollapse.renderGlvPreview&&window._reconCollapse.renderGlvPreview()};s.addEventListener("click",()=>i.click()),s.addEventListener("keydown",f=>{(f.key==="Enter"||f.key===" ")&&(f.preventDefault(),i.click())}),i.addEventListener("change",()=>{c(Array.from(i.files||[])),i.value=""}),s.addEventListener("dragover",f=>{f.preventDefault(),s.classList.add("drag-over")}),s.addEventListener("dragleave",()=>s.classList.remove("drag-over")),s.addEventListener("drop",f=>{f.preventDefault(),s.classList.remove("drag-over");const d=f.dataTransfer&&f.dataTransfer.files?Array.from(f.dataTransfer.files):[];c(d)})}function ds(e,n){if(!e)return;if(!n||n.length===0){e.textContent="";return}const a=n.reduce((o,s)=>o+Math.round(s.size/1024),0);if(n.length===1)e.textContent=n[0].name+"  ("+a+" KB)";else{const o=window.t&&window.t("glv-files-count")||"{n} 个文件";e.textContent=o.replace("{n}",n.length)+"  ("+a+" KB)"}}function Oe(e){const n=G[e];return Array.isArray(n)?n:n?[n]:[]}function zt(){const e=V("btn-glv-run");if(!e)return;const n=Oe("glFile").length>0&&Oe("vatFile").length>0;e.disabled=!n||G.running}function Ot(){const e=V("glv-status");if(!e||G.running)return;const n=Oe("vatFile").length,a=Oe("glFile").length;n===0&&a===0?(e.className="vex-action-info muted",e.innerHTML="<span>"+te("hint_need_both")+"</span>"):n>0&&a>0?(e.className="vex-action-info ok",e.innerHTML="<span>"+te("hint_ready")+"</span>"):(e.className="vex-action-info muted",e.innerHTML="<span>"+te("hint_need_one_more")+"</span>")}function Zl(e,n){const a=e==="vat"?"vatFile":"glFile",o=e==="vat"?"glv-vat-input":"glv-gl-input",s=e==="vat"?"glv-vat-name":"glv-gl-name",i=Oe(a);n==null?G[a]=[]:G[a]=i.filter((c,f)=>f!==n);const r=V(o);r&&(r.value=""),ds(V(s),Oe(a)),zt(),Ot(),window._reconCollapse&&window._reconCollapse.renderGlvPreview&&window._reconCollapse.renderGlvPreview()}function Ql(){G.glFile=[],G.vatFile=[],G.currentTaskId=null,G.lastDetail=[],G.lastSummary=null;const e=V("glv-vat-input");e&&(e.value="");const n=V("glv-gl-input");n&&(n.value="");const a=V("glv-vat-name");a&&(a.textContent="");const o=V("glv-gl-name");o&&(o.textContent="");const s=V("glv-result");s&&(s.style.display="none");const i=V("glv-kpi-strip");i&&(i.style.display="none"),zt(),Ot(),window._glvClearPreviewSearch&&window._glvClearPreviewSearch(),window._reconCollapse&&window._reconCollapse.renderGlvPreview&&window._reconCollapse.renderGlvPreview()}function Ea(e){const n=V("glv-tbody");if(!n)return;nc(e.length),n.innerHTML="";const a=te("not_found"),o=document.createDocumentFragment();e.forEach(s=>{const i=document.createElement("tr"),r=(l,p)=>{const m=document.createElement("td");return p&&(m.className=p),m.textContent=l,m},c=s.gl_amount===null||s.gl_amount===void 0,f=s.diff;let d="glv-num",u="glv-num";c?(u+=" glv-cell-missing",d+=" glv-cell-missing"):Math.abs(f||0)<.005?d+=" glv-cell-ok":d+=" glv-cell-diff",i.appendChild(r(s.doc_no||"","glv-doc")),i.appendChild(r(s.date||"","")),i.appendChild(r(s.customer_name||"","")),i.appendChild(r(Pt(s.vat_amount),"glv-num")),i.appendChild(r(c?a:Pt(s.gl_amount),u)),i.appendChild(r(c?a:Pt(s.diff),d)),i.appendChild(r(s.account_codes||"","glv-doc")),o.appendChild(i)}),n.appendChild(o)}function Ia(e){const n=V("glv-summary-table")&&V("glv-summary-table").querySelector("tbody");if(!n)return;n.innerHTML="",[{label:te("s_gl_total"),amount:e.gl_total,emph:!0,items:[],negate:!1},{label:te("s_minus_gl_cr"),amount:-(e.gl_only_credit||0),emph:!1,items:e.gl_only_credit_items||[],negate:!0},{label:te("s_plus_gl_dr"),amount:e.gl_only_debit||0,emph:!1,items:e.gl_only_debit_items||[],negate:!1},{label:te("s_plus_vat_p"),amount:e.vat_only_positive||0,emph:!1,items:e.vat_only_positive_items||[],negate:!1},{label:te("s_minus_vat_n"),amount:e.vat_only_negative||0,emph:!1,items:e.vat_only_negative_items||[],negate:!1},{label:te("s_vat_total"),amount:e.vat_total,emph:!0,items:[],negate:!1}].forEach(({label:o,amount:s,emph:i,items:r,negate:c})=>{const f=document.createElement("tr");f.className=i?"glv-summary-total":"glv-summary-sect";const d=document.createElement("td"),u=document.createElement("td");d.textContent=o,u.textContent=i?Pt(s):"",f.appendChild(d),f.appendChild(u),n.appendChild(f),(r||[]).forEach(l=>{const p=document.createElement("tr");p.className="glv-summary-item";const m=document.createElement("td"),v=document.createElement("td"),w=[l.doc_no,l.date,l.name].filter(Boolean);m.textContent="· "+w.join("  ·  ");const b=c?-(l.amount||0):l.amount||0;v.textContent=Pt(b),p.appendChild(m),p.appendChild(v),n.appendChild(p)})})}async function ec(e){try{const a=await(await fetch("/api/recon/gl-vat/"+e,{headers:st()})).json();if(!a||!a.ok)throw new Error("load_failed");G.currentTaskId=e,G.lastDetail=a.detail||[],G.lastSummary=a.summary||{},_a(a.stats||{}),Ea(G.lastDetail),Ia(G.lastSummary);const o=V("glv-result");o&&(o.style.display=""),ps(),window.scrollTo({top:o?o.offsetTop-80:0,behavior:"smooth"})}catch(n){console.error("[gl-vat] load task failed:",n),alert(te("error")+": "+(n.message||n))}}function ps(){var e=V("glv-kpi-strip");e&&(e.style.display="");var n=V("glv-section-summary");n&&n.setAttribute("data-collapsed","false");var a=V("glv-section-detail");a&&a.setAttribute("data-collapsed","false")}function tc(){document.querySelectorAll(".glv-section-head[data-toggle]").forEach(e=>{const n=e.getAttribute("data-toggle"),a=document.getElementById(n);if(!a)return;const o=s=>{if(s.target&&s.target.closest("button")!==null&&!s.target.classList.contains("glv-section-head"))return;const i=a.getAttribute("data-collapsed")==="true";a.setAttribute("data-collapsed",i?"false":"true")};e.addEventListener("click",o),e.addEventListener("keydown",s=>{(s.key==="Enter"||s.key===" ")&&(s.preventDefault(),o(s))})})}function nc(e){const n=V("glv-detail-count");n&&(n.textContent=e!=null?String(e):"")}const St=10;var ct=[],ke=1;function ac(){ke=1,cn();var e=((V("glv-hist-search")||{}).value||"").trim().toLowerCase();if(e){var n=V("glv-history-tbody");n&&n.querySelectorAll("tr").forEach(function(a){a.dataset.taskId&&(a.style.display=a.textContent.toLowerCase().indexOf(e)>=0?"":"none")})}}function cn(){const e=V("glv-history-table-wrap"),n=V("glv-history-empty"),a=V("glv-history-tbody"),o=V("glv-history-pager"),s=V("glv-history-pager-info"),i=V("glv-history-prev"),r=V("glv-history-next");if(!a)return;if(a.innerHTML="",!ct.length){e&&(e.style.display="none"),n&&(n.style.display=""),o&&(o.style.display="none");return}e&&(e.style.display=""),n&&(n.style.display="none");const c=Math.ceil(ct.length/St);ke>c&&(ke=c);const f=(ke-1)*St,d=ct.slice(f,f+St);o&&(o.style.display=ct.length>St?"":"none",s&&(s.textContent=ke+" / "+c),i&&(i.disabled=ke<=1),r&&(r.disabled=ke>=c)),d.forEach(l=>{const p=document.createElement("tr");p.dataset.taskId=l.id;const m=document.createElement("td");m.textContent=Xl(l.created_at);const v=document.createElement("td");v.className="glv-history-file",v.title=(l.vat_filename||"")+" + "+(l.gl_filename||""),v.textContent=(l.vat_filename||"?")+" + "+(l.gl_filename||"?");const w=document.createElement("td");w.className="glv-num",w.textContent=(l.vat_row_count||0)+" / "+(l.gl_row_count||0);const b=document.createElement("td");b.className="glv-num",b.textContent=l.matched_count||0;const g=document.createElement("td");g.className="glv-num",g.textContent=l.diff_count||0;const h=document.createElement("td");h.className="glv-num",h.textContent=l.unmatched_count||0;const _=document.createElement("td");_.className="glv-history-actions";const y=(I,B,L,C)=>{const S=document.createElement("button");return S.type="button",L&&(S.className=L),S.title=B,S.setAttribute("aria-label",B),S.innerHTML=I,S.onclick=C,S},k='<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" width="14" height="14"><path d="M2 8a6 6 0 1 0 12 0A6 6 0 0 0 2 8z"/><polyline points="6 8 8 10 10 8"/><line x1="8" y1="4" x2="8" y2="10"/></svg>',x='<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" width="14" height="14"><path d="M8 2v9M4 7l4 4 4-4M3 14h10"/></svg>',E='<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" width="14" height="14"><polyline points="3 4 13 4"/><path d="M6 4V2.5a.5.5 0 0 1 .5-.5h3a.5.5 0 0 1 .5.5V4"/><path d="M5 4l1 9a1 1 0 0 0 1 1h2a1 1 0 0 0 1-1l1-9"/></svg>';_.appendChild(y(k,te("hist_load"),"",()=>ec(l.id))),_.appendChild(y(x,te("hist_export"),"",()=>sc(l.id))),_.appendChild(y(E,te("hist_delete"),"glv-del",()=>ic(l.id))),[m,v,w,b,g,h,_].forEach(I=>p.appendChild(I)),a.appendChild(p)})}function oc(){var e=V("glv-history-prev"),n=V("glv-history-next");e&&!e._glvBound&&(e._glvBound=!0,e.addEventListener("click",function(){ke>1&&(ke--,cn())})),n&&!n._glvBound&&(n._glvBound=!0,n.addEventListener("click",function(){var a=Math.ceil(ct.length/St);ke<a&&(ke++,cn())}))}async function mt(){try{const n=await(await fetch("/api/recon/gl-vat/tasks",{headers:st()})).json();ct=n&&n.tasks||[],ke=1,cn(),oc()}catch(e){console.error("[gl-vat] history load failed:",e)}}async function sc(e){try{const n="/api/recon/gl-vat/"+e+"/export?lang="+encodeURIComponent(wt()),a=await fetch(n,{headers:st()});if(!a.ok)throw new Error("HTTP "+a.status);const o=await a.blob(),s=document.createElement("a");s.href=URL.createObjectURL(o),s.download="GL_VAT_recon_"+e+".xlsx",document.body.appendChild(s),s.click(),setTimeout(()=>{URL.revokeObjectURL(s.href),s.remove()},200)}catch(n){console.error("[gl-vat] exportTask failed:",n),typeof showToast=="function"&&showToast(te("error")+": "+(n.message||n),"error")}}async function ic(e){let n;if(typeof window.showConfirm=="function"?n=await window.showConfirm(te("confirm_delete"),{danger:!0}):n=confirm(te("confirm_delete")),!!n)try{const a=await fetch("/api/recon/gl-vat/"+e,{method:"DELETE",headers:st()});if(!a.ok)throw new Error("HTTP "+a.status);mt()}catch(a){console.error("[gl-vat] delete failed:",a),typeof showToast=="function"&&showToast(te("error")+": "+(a.message||a),"error")}}async function rc(){if(!G.glFile||!G.vatFile){typeof showToast=="function"&&showToast(te("need_files"),"warn");return}G.running=!0,zt();const e=V("glv-status"),n=V("glv-progress"),a=V("glv-progress-sub");e&&(e.className="vex-action-info muted",e.style.color="",e.innerHTML="<span>"+te("running")+"</span>"),n&&(n.style.display=""),a&&(a.textContent=(G.vatFile.name||"VAT")+" + "+(G.glFile.name||"GL"));const o=new FormData,s=Oe("vatFile"),i=Oe("glFile");for(const c of s)o.append("vat_files",c,c.name);for(const c of i)o.append("gl_files",c,c.name);const r=(V("glv-prefix")&&V("glv-prefix").value||"4").trim()||"4";o.append("revenue_prefix",r),o.append("lang",wt());try{const c=await fetch("/api/recon/gl-vat/submit",{method:"POST",headers:st(),body:o});let f=null;try{f=await c.json()}catch{f=null}if(!c.ok||!f||!f.ok||!f.job_id)throw new Error(f&&f.detail||f&&f.error||"HTTP "+c.status);const d=V("glv-progress-sub"),u=await window._reconPollJob(f.job_id,cs(),{onProgress:v=>{d&&(d.textContent=window._reconProgressText(v,wt()))}});if(!u||u.status!=="done"||!u.result_id)throw u&&u.status==="failed"&&u.error_code?new Error(Yl(u.error_code)):new Error(te("error")||"Error");const l=await fetch("/api/recon/gl-vat/"+encodeURIComponent(u.result_id),{headers:st()});let p=null;try{p=await l.json()}catch{p=null}if(!l.ok||!p||!p.ok)throw new Error(p&&p.detail||p&&p.error||"HTTP "+l.status);G.currentTaskId=p.task_id,G.lastDetail=p.detail||[],G.lastSummary=p.summary||{},_a(p.stats||{}),Ea(G.lastDetail),Ia(G.lastSummary);const m=V("glv-result");m&&(m.style.display=""),ps(),e&&(e.className="vex-action-info ok",e.style.color="",e.innerHTML="<span>"+te("done")+" · GL "+(p.gl_row_count||0)+" · VAT "+(p.vat_row_count||0)+"</span>"),mt()}catch(c){console.error("[gl-vat] run failed:",c),e&&(e.className="vex-action-info",e.style.color="#ef4444",e.innerHTML="<span>"+te("error")+": "+(c.message||c)+"</span>")}finally{G.running=!1,n&&(n.style.display="none"),zt()}}async function lc(){if(G.currentTaskId)try{const e="/api/recon/gl-vat/"+G.currentTaskId+"/export?lang="+encodeURIComponent(wt()),n=await fetch(e,{headers:st()});if(!n.ok)throw new Error("HTTP "+n.status);const a=await n.blob(),o=document.createElement("a");o.href=URL.createObjectURL(a),o.download="GL_VAT_recon_"+G.currentTaskId+".xlsx",document.body.appendChild(o),o.click(),setTimeout(()=>{URL.revokeObjectURL(o.href),o.remove()},200)}catch(e){console.error("[gl-vat] export failed:",e),typeof showToast=="function"&&showToast(te("error")+": "+(e.message||e),"error")}}function cc(){G.running||Ot(),mt(),G.lastDetail&&G.lastDetail.length&&Ea(G.lastDetail),G.lastSummary&&Ia(G.lastSummary)}function dc(){if(G.inited){mt();return}G.inited=!0,ro("glv-drop-gl","glv-gl-input","glv-gl-name","glFile"),ro("glv-drop-vat","glv-vat-input","glv-vat-name","vatFile");const e=V("btn-glv-run");e&&e.addEventListener("click",rc);const n=V("btn-glv-export");n&&n.addEventListener("click",lc);const a=V("btn-glv-reset");a&&a.addEventListener("click",Ql);const o=V("glv-hist-search");o&&o.addEventListener("input",ac),tc(),_a(null),Ot(),window._loadGlvHistory=mt,mt(),typeof window.subscribeI18n=="function"&&window.subscribeI18n("gl-vat-recon",cc)}window._glvRemoveFile=Zl;window.GlVatRecon={ensureInit:dc};window._glvPreviewFiles=function(e){return Oe(e==="vat"?"vatFile":"glFile")};const pc=["flowaccount","peak","xero","quickbooks","express"],us={flowaccount:"FlowAccount",peak:"PEAK",xero:"Xero",quickbooks:"QuickBooks",express:"Express"},uc=["expense_office","expense_travel","expense_utility","asset_inventory","asset_fixed","liability_ap","revenue_sales","revenue_service","other"],mc=["vat_7","vat_0","vat_exempt","wht_1","wht_3","wht_5","non_vat"],fc="468b50c1-5593-4fd6-990d-515ce8085563";let ee={sub:"clients",loaded:{clients:!1,accounts:!1,taxes:!1,products:!1},items:{clients:[],accounts:[],taxes:[],products:[]},clientList:[],clientLoaded:!1,addingNew:{clients:!1,accounts:!1,taxes:!1,products:!1},bound:!1};function Wt(){const e=typeof _userInfo<"u"?_userInfo:null;return!!(e&&(e.role==="owner"||e.is_super_admin))}function vc(){const e=typeof _userInfo<"u"?_userInfo:null;return!!(e&&e.id===fc)}function T(e){return typeof escapeHtml=="function"?escapeHtml(e==null?"":String(e)):String(e??"")}function Ye(e,n){try{typeof showToast=="function"&&showToast(e,n||"info")}catch{}}function hc(e){return e==="clients"?'<div class="erp-map-row erp-map-head row-clients"><div>'+T(t("erp-map-col-client"))+"</div><div>"+T(t("erp-map-col-erp"))+"</div><div>"+T(t("erp-map-col-erp-code"))+"</div><div>"+T(t("erp-map-col-notes"))+"</div><div>"+T(t("erp-map-col-actions"))+"</div></div>":e==="accounts"?'<div class="erp-map-row erp-map-head row-accounts"><div>'+T(t("erp-map-col-erp"))+"</div><div>"+T(t("erp-map-col-category"))+"</div><div>"+T(t("erp-map-col-erp-code"))+"</div><div>"+T(t("erp-map-col-erp-name"))+"</div><div>"+T(t("erp-map-col-notes"))+"</div><div>"+T(t("erp-map-col-actions"))+"</div></div>":e==="products"?'<div class="erp-map-row erp-map-head row-products"><div>'+T(t("erp-map-col-item-name"))+"</div><div>"+T(t("erp-map-col-erp-product-code"))+"</div><div>"+T(t("erp-map-col-erp-name"))+"</div><div>"+T(t("erp-map-col-notes"))+"</div><div>"+T(t("erp-map-col-actions"))+"</div></div>":'<div class="erp-map-row erp-map-head row-taxes"><div>'+T(t("erp-map-col-erp"))+"</div><div>"+T(t("erp-map-col-tax"))+"</div><div>"+T(t("erp-map-col-erp-tax-code"))+"</div><div>"+T(t("erp-map-col-notes"))+"</div><div>"+T(t("erp-map-col-actions"))+"</div></div>"}function Hn(e,n){let a='<select class="form-input" data-erp-field="'+n+'">';return a+='<option value="">'+T(t("erp-map-pick-erp"))+"</option>",pc.forEach(function(o){const s=o===e?" selected":"";a+='<option value="'+o+'"'+s+">"+T(us[o])+"</option>"}),a+="</select>",a}function gc(e){let n='<select class="form-input" data-erp-field="client_id">';return n+='<option value="">'+T(t("erp-map-pick-client"))+"</option>",(ee.clientList||[]).forEach(function(a){const o=String(a.id)===String(e)?" selected":"";n+='<option value="'+a.id+'"'+o+">"+T(a.name||"#"+a.id)+"</option>"}),n+="</select>",n}function bc(e){let n='<select class="form-input" data-erp-field="pearnly_category">';return n+='<option value="">'+T(t("erp-map-pick-cat"))+"</option>",uc.forEach(function(a){const o=a===e?" selected":"";n+='<option value="'+a+'"'+o+">"+T(t("erp-map-cat-"+a))+"</option>"}),n+="</select>",n}function yc(e){let n='<select class="form-input" data-erp-field="pearnly_tax_kind">';return n+='<option value="">'+T(t("erp-map-pick-tax"))+"</option>",mc.forEach(function(a){const o=a===e?" selected":"";n+='<option value="'+a+'"'+o+">"+T(t("erp-map-tax-"+a))+"</option>"}),n+="</select>",n}function wc(e){const n='<button class="btn btn-primary" type="button" data-erp-save="new" style="padding:6px 12px;height:32px;">'+T(t("erp-map-save"))+"</button>";return e==="clients"?'<div class="erp-map-row erp-map-row-add row-clients" data-erp-row="new"><div data-label="'+T(t("erp-map-col-client"))+'">'+gc("")+'</div><div data-label="'+T(t("erp-map-col-erp"))+'">'+Hn("","erp_type")+'</div><div data-label="'+T(t("erp-map-col-erp-code"))+'"><input type="text" class="form-input" data-erp-field="erp_code" placeholder="'+T(t("erp-map-ph-erp-code"))+'"></div><div data-label="'+T(t("erp-map-col-notes"))+'"><input type="text" class="form-input" data-erp-field="notes" placeholder="'+T(t("erp-map-ph-notes"))+'"></div><div>'+n+"</div></div>":e==="accounts"?'<div class="erp-map-row erp-map-row-add row-accounts" data-erp-row="new"><div data-label="'+T(t("erp-map-col-erp"))+'">'+Hn("","erp_type")+'</div><div data-label="'+T(t("erp-map-col-category"))+'">'+bc("")+'</div><div data-label="'+T(t("erp-map-col-erp-code"))+'"><input type="text" class="form-input" data-erp-field="erp_code" placeholder="'+T(t("erp-map-ph-acc-code"))+'"></div><div data-label="'+T(t("erp-map-col-erp-name"))+'"><input type="text" class="form-input" data-erp-field="erp_name" placeholder="'+T(t("erp-map-ph-acc-name"))+'"></div><div data-label="'+T(t("erp-map-col-notes"))+'"><input type="text" class="form-input" data-erp-field="notes" placeholder="'+T(t("erp-map-ph-notes"))+'"></div><div>'+n+"</div></div>":'<div class="erp-map-row erp-map-row-add row-taxes" data-erp-row="new"><div data-label="'+T(t("erp-map-col-erp"))+'">'+Hn("","erp_type")+'</div><div data-label="'+T(t("erp-map-col-tax"))+'">'+yc("")+'</div><div data-label="'+T(t("erp-map-col-erp-tax-code"))+'"><input type="text" class="form-input" data-erp-field="erp_code" placeholder="'+T(t("erp-map-ph-tax-code"))+'"></div><div data-label="'+T(t("erp-map-col-notes"))+'"><input type="text" class="form-input" data-erp-field="notes" placeholder="'+T(t("erp-map-ph-notes"))+'"></div><div>'+n+"</div></div>"}function kc(e,n,a){const o=a?"":'<button class="erp-map-del-btn" type="button" data-erp-del="'+T(n.id)+'" title="'+T(t("erp-map-delete"))+'"><svg width="14" height="14" viewBox="0 0 20 20" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"><path d="M4 6h12M8 6V4h4v2M6 6l1 11h6l1-11"/></svg></button>',s='<span class="erp-map-erp-badge">'+T(us[n.erp_type]||n.erp_type)+"</span>";if(e==="clients")return'<div class="erp-map-row row-clients"><div data-label="'+T(t("erp-map-col-client"))+'" class="erp-map-cell-name">'+T(n.client_name||"#"+n.client_id)+'</div><div data-label="'+T(t("erp-map-col-erp"))+'">'+s+'</div><div data-label="'+T(t("erp-map-col-erp-code"))+'" class="erp-map-code">'+T(n.erp_code||"")+'</div><div data-label="'+T(t("erp-map-col-notes"))+'">'+T(n.notes||"")+"</div><div>"+o+"</div></div>";if(e==="accounts"){const r=t("erp-map-cat-"+(n.pearnly_category||"other"))||n.pearnly_category;return'<div class="erp-map-row row-accounts"><div data-label="'+T(t("erp-map-col-erp"))+'">'+s+'</div><div data-label="'+T(t("erp-map-col-category"))+'" class="erp-map-cell-name">'+T(r)+'</div><div data-label="'+T(t("erp-map-col-erp-code"))+'" class="erp-map-code">'+T(n.erp_code||"")+'</div><div data-label="'+T(t("erp-map-col-erp-name"))+'">'+T(n.erp_name||"")+'</div><div data-label="'+T(t("erp-map-col-notes"))+'">'+T(n.notes||"")+"</div><div>"+o+"</div></div>"}if(e==="products")return'<div class="erp-map-row row-products"><div data-label="'+T(t("erp-map-col-item-name"))+'" class="erp-map-cell-name">'+T(n.item_name||"")+'</div><div data-label="'+T(t("erp-map-col-erp-product-code"))+'" class="erp-map-code">'+T(n.erp_code||"")+'</div><div data-label="'+T(t("erp-map-col-erp-name"))+'">'+T(n.erp_name||"")+'</div><div data-label="'+T(t("erp-map-col-notes"))+'">'+T(n.notes||"")+"</div><div>"+o+"</div></div>";const i=t("erp-map-tax-"+(n.pearnly_tax_kind||""))||n.pearnly_tax_kind;return'<div class="erp-map-row row-taxes"><div data-label="'+T(t("erp-map-col-erp"))+'">'+s+'</div><div data-label="'+T(t("erp-map-col-tax"))+'" class="erp-map-cell-name"><span class="erp-map-tax-badge">'+T(i)+'</span></div><div data-label="'+T(t("erp-map-col-erp-tax-code"))+'" class="erp-map-code">'+T(n.erp_code||"")+'</div><div data-label="'+T(t("erp-map-col-notes"))+'">'+T(n.notes||"")+"</div><div>"+o+"</div></div>"}(function(){async function e(u,l){const p=localStorage.getItem("mrpilot_token");if(p&&!(ee.loaded[u]&&!l))try{const m=await fetch("/api/erp/mappings/"+u,{headers:{Authorization:"Bearer "+p}});if(!m.ok)throw new Error("http_"+m.status);const v=await m.json();ee.items[u]=v.items||[],ee.loaded[u]=!0}catch{ee.items[u]=[],ee.loaded[u]=!1}}async function n(u){if(ee.clientLoaded)return;const l=localStorage.getItem("mrpilot_token");if(l)try{const p=await fetch("/api/clients?include_inactive=false",{headers:{Authorization:"Bearer "+l}});if(!p.ok)throw new Error("http_"+p.status);const m=await p.json();ee.clientList=(m.clients||m.items||[]).filter(v=>v.is_active!==!1),ee.clientLoaded=!0}catch{ee.clientList=[]}}function a(){const u=document.getElementById("erp-map-pane-wrap");if(!u)return;const l=!Wt();let p="";l&&(p+='<div class="erp-map-readonly-banner"><svg width="16" height="16" viewBox="0 0 20 20" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"><circle cx="10" cy="10" r="8"/><path d="M10 6v4M10 13v0.01"/></svg>'+T(t("erp-map-readonly-tip"))+"</div>"),p+='<div class="erp-map-toolbar">',!l&&ee.sub!=="products"&&(p+='<button class="btn btn-primary" type="button" id="erp-map-add-btn" data-i18n="erp-map-add-row">'+T(t("erp-map-add-row"))+"</button>"),p+="</div>",p+='<div class="erp-map-table" id="erp-map-table-host"></div>',u.innerHTML=p,o();const m=document.getElementById("erp-map-dev-bar");m&&(m.style.display=Wt()&&vc()?"":"none")}function o(){const u=document.getElementById("erp-map-table-host");if(!u)return;const l=ee.sub,p=ee.items[l]||[],m=ee.addingNew[l],v=!Wt();if(!p.length&&!m){u.innerHTML='<div class="erp-map-empty"><strong>'+T(t("erp-map-empty-"+l))+"</strong>"+T(t("erp-map-empty-"+l+"-sub"))+"</div>";return}let w="";w+=hc(l),m&&!v&&(w+=wc(l)),p.forEach(function(b){w+=kc(l,b,v)}),u.innerHTML=w}async function s(u){const l=ee.sub,p={};u.querySelectorAll("[data-erp-field]").forEach(function(b){p[b.dataset.erpField]=(b.value||"").trim()});const m=localStorage.getItem("mrpilot_token");if(!m)return;let v={},w="/api/erp/mappings/"+l;if(l==="clients"){if(!p.client_id||!p.erp_type||!p.erp_code){Ye(t("erp-map-save-fail"),"error");return}v={client_id:parseInt(p.client_id,10),erp_type:p.erp_type,erp_code:p.erp_code,notes:p.notes||""}}else if(l==="accounts"){if(!p.erp_type||!p.pearnly_category||!p.erp_code){Ye(t("erp-map-save-fail"),"error");return}v={erp_type:p.erp_type,pearnly_category:p.pearnly_category,erp_code:p.erp_code,erp_name:p.erp_name||"",notes:p.notes||""}}else{if(!p.erp_type||!p.pearnly_tax_kind||!p.erp_code){Ye(t("erp-map-save-fail"),"error");return}v={erp_type:p.erp_type,pearnly_tax_kind:p.pearnly_tax_kind,erp_code:p.erp_code,notes:p.notes||""}}try{const b=await fetch(w,{method:"POST",headers:{"Content-Type":"application/json",Authorization:"Bearer "+m},body:JSON.stringify(v)});if(!b.ok)throw new Error("http_"+b.status);ee.addingNew[l]=!1,await e(l,!0),o(),Ye(t("erp-map-saved-toast"),"success")}catch{Ye(t("erp-map-save-fail"),"error")}}async function i(u){if(!await window.pearnlyConfirm(t("erp-map-confirm-delete")))return;const p=ee.sub,m=localStorage.getItem("mrpilot_token");try{const v=await fetch("/api/erp/mappings/"+p+"/"+encodeURIComponent(u),{method:"DELETE",headers:{Authorization:"Bearer "+m}});if(!v.ok)throw new Error("http_"+v.status);await e(p,!0),o(),Ye(t("erp-map-deleted-toast"),"success")}catch{Ye(t("erp-map-delete-fail"),"error")}}async function r(){await n(),await e(ee.sub,!1),a()}function c(u){u!==ee.sub&&(ee.sub=u,ee.addingNew[u]=!1,["clients","accounts","taxes","products"].forEach(function(l){l!==u&&(ee.addingNew[l]=!1)}),document.querySelectorAll(".erp-map-subtab").forEach(function(l){l.classList.toggle("active",l.dataset.erpSubtab===u)}),e(u,!1).then(function(){a()}))}function f(){ee.bound||(ee.bound=!0,document.addEventListener("click",function(u){const l=u.target.closest(".erp-subtab[data-erp-subtab]");if(l){u.preventDefault();const b=l.dataset.erpSubtab;document.querySelectorAll(".erp-subtab").forEach(function(g){g.classList.toggle("active",g.dataset.erpSubtab===b)}),document.querySelectorAll(".erp-subpanel").forEach(function(g){g.classList.toggle("active",g.dataset.erpSubpanel===b)}),b==="mappings"&&setTimeout(r,50);return}const p=u.target.closest(".erp-map-subtab[data-erp-subtab]");if(p){u.preventDefault(),c(p.dataset.erpSubtab);return}if(u.target.closest("#erp-map-add-btn")){if(u.preventDefault(),!Wt())return;ee.addingNew[ee.sub]=!0,o();return}const v=u.target.closest('[data-erp-save="new"]');if(v){u.preventDefault();const b=v.closest('[data-erp-row="new"]');b&&s(b);return}const w=u.target.closest("[data-erp-del]");if(w){u.preventDefault(),i(w.dataset.erpDel);return}}))}function d(){const u=document.getElementById("erp-map-pane-wrap");u&&u.children.length>0&&a(),document.querySelectorAll(".erp-map-subtab").forEach(function(l){const p="erp-map-subtab-"+l.dataset.erpSubtab,m=t(p);m&&m!==p&&(l.textContent=m)})}f(),typeof window.subscribeI18n=="function"&&window.subscribeI18n("erp-mappings",d)})();(function(){let e=null,n=0,a=!1;function o(E){return typeof escapeHtml=="function"?escapeHtml(E==null?"":String(E)):String(E??"")}function s(E,I){try{typeof showToast=="function"&&showToast(E,I||"info")}catch{}}async function i(E){const I=Date.now();if(e&&I-n<3e4)return e;const B=localStorage.getItem("mrpilot_token");if(!B)return[];try{const L=await fetch("/api/erp/connectors/status",{headers:{Authorization:"Bearer "+B}});if(!L.ok)return[];const C=await L.json();return e=C&&C.connectors||[],n=I,e}catch{return[]}}function r(){try{return localStorage.getItem("pn_push_default_connector")||""}catch{return""}}function c(E){try{localStorage.setItem("pn_push_default_connector",E||"")}catch{}}function f(E){if(!E||!E.length)return null;const I=r();if(I){const L=E.find(C=>C.id===I);if(L)return L}const B=E.find(L=>L.is_default);return B||E[0]}function d(E){if(!E)return!1;const I=String(E.status||"").toLowerCase();return I==="exception"||I==="exception_pending"||I==="rejected"}function u(){try{return(typeof _results<"u"?_results:[])[typeof _drawerIdx<"u"?_drawerIdx:-1]||null}catch{return null}}function l(E){const I=E&&(E.type||E.id);return I==="xero"?'<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"><circle cx="8" cy="8" r="6"/><path d="M5.5 8l2 2 3-3.5"/></svg>':I==="webhook"?'<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"><circle cx="5" cy="11.5" r="1.8"/><circle cx="11" cy="4.5" r="1.8"/><path d="M6.4 10l3.2-4M5 9.6V5.5a3 3 0 016 0"/></svg>':'<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"><path d="M2 8h9M8 5l3 3-3 3"/><rect x="11" y="3" width="3" height="10" rx="1"/></svg>'}async function p(E,I){if(!E||!I)return!1;const B=document.getElementById("btn-push-default");B&&(B.disabled=!0,B.classList.add("loading"));const L=localStorage.getItem("mrpilot_token");try{let C,S={method:"POST",headers:{Authorization:"Bearer "+L}};E.type==="xero"?C="/api/erp/xero/push/"+encodeURIComponent(I):(C="/api/erp/push",S.headers["Content-Type"]="application/json",S.body=JSON.stringify({history_id:I,endpoint_id:E.endpoint_id||void 0}));const $=await fetch(C,S);let j={};try{j=await $.json()}catch{}if(!$.ok){let N=j&&j.detail||"unknown";typeof N=="object"&&(N=N.code||JSON.stringify(N));let X=String(N||"unknown");if(E.type==="xero"){const ne=X.replace(/^xero\./,"").toLowerCase(),de=t("xero-"+ne);de&&de!=="xero-"+ne&&(X=de)}return s(t("unified-push-fail").replace("{name}",E.name).replace("{err}",X),"error"),!1}if(j&&j.ok===!1){let N=j.error_msg||j.error_code||"unknown";return N=String(N).slice(0,200),s(t("unified-push-fail").replace("{name}",E.name).replace("{err}",N),"error"),!1}return s(t("unified-push-ok").replace("{name}",E.name),"success"),!0}catch(C){return s(t("unified-push-fail").replace("{name}",E.name).replace("{err}",C.message||"network"),"error"),!1}finally{B&&(B.disabled=!1,B.classList.remove("loading"))}}async function m(E,I){for(const B of E)await p(B,I)}function v(E,I){const B=document.createElement("div");B.className="pn-push-dropdown",B.id="pn-push-dropdown";const L=(E||[]).map(S=>{const $=!!(I&&S.id===I.id),j=S.method==="download"?t("unified-push-tag-download"):$?t("unified-push-tag-default"):"";return'<div class="pn-pd-item" data-cid="'+o(S.id)+'"><span class="pn-pd-icon">'+l(S)+'</span><span class="pn-pd-name">'+o(S.name)+"</span>"+(j?'<span class="pn-pd-tag">'+o(j)+"</span>":"")+($?'<span class="pn-pd-check">✓</span>':"")+"</div>"}).join(""),C=E&&E.length>1?'<div class="pn-pd-divider"></div><div class="pn-pd-item pn-pd-all" data-cid="__all__"><span class="pn-pd-icon"><svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"><path d="M3 6h10M3 10h10M3 13.5h6"/></svg></span><span class="pn-pd-name">'+o(t("unified-push-all").replace("{n}",E.length))+"</span></div>":"";return B.innerHTML=L+C,B}function w(){const E=document.getElementById("pn-push-dropdown");E&&E.remove()}async function b(){if(document.getElementById("pn-push-dropdown")){w();return}const E=await i()||[],I=f(E),B=v(E,I),L=document.getElementById("pn-push-wrap");L&&L.appendChild(B)}async function g(){const E=await i()||[],I=f(E);if(!I)return;const B=u(),L=B&&(B._historyId||B.history_id);if(L){if(d(B)){s(t("unified-push-disabled-exc"),"warn");return}await p(I,L)}}async function h(E){w();const I=await i()||[],B=u(),L=B&&(B._historyId||B.history_id);if(!L)return;if(d(B)){s(t("unified-push-disabled-exc"),"warn");return}if(E==="__all__"){await m(I,L);return}const C=I.find(S=>S.id===E);C&&(c(E),await p(C,L),y())}async function _(){const E=document.getElementById("drawer-history-save");if(!E||E.querySelector("#pn-push-wrap"))return;const I=document.createElement("div");I.id="pn-push-wrap",I.className="pn-push-wrap",I.dataset.loading="1",E.insertBefore(I,E.firstChild),["btn-push-erp","btn-xero-push"].forEach(j=>{E.querySelectorAll("#"+j).forEach(N=>{N.style.display="none"})});const B=await i()||[],L=f(B),C=B.length>0;if(!C)I.innerHTML='<button type="button" class="btn btn-ghost pn-push-empty" id="btn-push-default" disabled title="'+o(t("unified-push-empty-tip"))+'"><svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"><path d="M2 8h9M8 5l3 3-3 3"/></svg><span style="margin-left:4px;">'+o(t("unified-push-empty"))+"</span></button>";else{const j=B.length>1;I.innerHTML='<div class="pn-push-split"><button type="button" class="pn-push-main" id="btn-push-default" title="'+o(t("unified-push-tip"))+'">'+l(L)+"<span>"+o(t("unified-push-to").replace("{name}",L?L.name:""))+"</span></button>"+(j?'<button type="button" class="pn-push-arrow" id="btn-push-arrow" title="'+o(t("unified-push-other"))+'"><svg viewBox="0 0 12 12" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M3 5l3 3 3-3"/></svg></button>':"")+"</div>"}delete I.dataset.loading;const S=I.querySelector("#btn-push-default");S&&C&&S.addEventListener("click",g);const $=I.querySelector("#btn-push-arrow");$&&$.addEventListener("click",function(j){j.stopPropagation(),b()}),a||(a=!0,document.addEventListener("click",function(j){const N=j.target.closest(".pn-pd-item");if(N){const X=N.getAttribute("data-cid");h(X);return}j.target.closest("#btn-push-arrow")||w()}),typeof window.subscribeI18n=="function"&&window.subscribeI18n("unified-push",y))}function y(){const E=document.getElementById("pn-push-wrap");E&&(E.remove(),e=null,n=0,_())}function k(){const E=document.getElementById("drawer-history-save");if(!E||!E.querySelector("#pn-push-wrap"))return;["btn-push-erp","btn-xero-push"].forEach(B=>{E.querySelectorAll("#"+B).forEach(L=>{L.style.display!=="none"&&(L.style.display="none")})});const I=E.querySelectorAll("#pn-push-wrap");if(I.length>1)for(let B=1;B<I.length;B++)I[B].remove()}function x(){try{const E=function(){return document.getElementById("drawer-body")},I=new MutationObserver(function(){document.getElementById("drawer-history-save")&&!document.getElementById("pn-push-wrap")&&_(),k()}),B=E();if(B)I.observe(B,{childList:!0,subtree:!0});else{const L=new MutationObserver(function(){const C=E();C&&(I.observe(C,{childList:!0,subtree:!0}),L.disconnect())});L.observe(document.body,{childList:!0,subtree:!0})}setTimeout(function(){document.getElementById("drawer-history-save")&&!document.getElementById("pn-push-wrap")&&_(),k()},200)}catch{}}x()})();(function(){function e(){const a=document.getElementById("erp-map-show-advanced-btn");if(!a)return;const o=document.getElementById("erp-map-subtabs");if(!o)return;const s=o.classList.contains("show-advanced"),i=a.querySelector(".erp-map-adv-btn-label");if(i&&typeof t=="function"){const r=s?"erp-map-hide-advanced":"erp-map-show-advanced",c=t(r);c&&c!==r&&(i.textContent=c)}a.setAttribute("aria-pressed",s?"true":"false")}document.addEventListener("click",function(a){if(!a.target.closest("#erp-map-show-advanced-btn"))return;a.preventDefault();const s=document.getElementById("erp-map-subtabs");if(s&&(s.classList.toggle("show-advanced"),e(),!s.classList.contains("show-advanced")&&s.querySelector(".erp-map-subtab.active.erp-map-subtab-advanced"))){const r=s.querySelector('.erp-map-subtab[data-erp-subtab="clients"]');r&&r.click()}});function n(){e()}typeof window.subscribeI18n=="function"&&window.subscribeI18n("erp-map-advanced-toggle",n)})();(function(){const e="pearnly_erp_onboard_shown";let n=!1;function a(){try{return Array.isArray(window._erpEndpoints)&&window._erpEndpoints.length>0}catch{return!1}}function o(){if(document.getElementById("erp-onboard-mask"))return;const i=document.createElement("div");i.id="erp-onboard-mask",i.className="erp-onboard-mask",i.innerHTML='<div class="erp-onboard-modal" role="dialog" aria-modal="true"><div class="erp-onboard-icon"><svg viewBox="0 0 32 32" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><rect x="4" y="6" width="24" height="20" rx="3"/><path d="M9 13h14M9 18h10"/><path d="M22 22l3 3 5-5"/></svg></div><div class="erp-onboard-title" id="erp-onboard-title"></div><div class="erp-onboard-body" id="erp-onboard-body"></div><div class="erp-onboard-btns"><button type="button" class="btn btn-secondary" id="erp-onboard-later"></button><button type="button" class="btn btn-primary" id="erp-onboard-ok"></button></div></div>',document.body.appendChild(i);function r(){const f=document.getElementById("erp-onboard-title"),d=document.getElementById("erp-onboard-body"),u=document.getElementById("erp-onboard-ok"),l=document.getElementById("erp-onboard-later");f&&(f.textContent=t("erp-onboard-title")),d&&(d.textContent=t("erp-onboard-body")),u&&(u.textContent=t("erp-onboard-ok")),l&&(l.textContent=t("erp-onboard-later"))}r();function c(){i.style.display="none"}document.getElementById("erp-onboard-ok").addEventListener("click",function(){try{localStorage.setItem(e,"1")}catch{}c();try{const f=document.querySelector('#btn-add-endpoint, [data-action="erp-add-endpoint"]');f&&f.scrollIntoView({behavior:"smooth",block:"center"})}catch{}}),document.getElementById("erp-onboard-later").addEventListener("click",function(){try{localStorage.setItem(e,"1")}catch{}c()}),i.addEventListener("click",function(f){f.target===i&&c()}),typeof window.subscribeI18n=="function"&&window.subscribeI18n("erp-onboard-modal",function(){i.style.display!=="none"&&r()})}function s(){if(!n){try{if(localStorage.getItem(e)==="1")return}catch{}a()||(n=!0,o(),requestAnimationFrame(function(){requestAnimationFrame(function(){if(a())return;const i=document.getElementById("erp-onboard-mask");i&&(i.style.display="flex")})}))}}document.addEventListener("click",function(i){const r=i.target.closest('.auto-nav-item[data-auto-tab="erp"]'),c=i.target.closest('.erp-subtab[data-erp-subtab="connect"]');(r||c)&&setTimeout(s,700)})})();(function(){const e={parse:{zh:"解析文件中",th:"กำลังอ่านไฟล์",en:"Parsing files",ja:"ファイル解析中"},report:{zh:"读取报告中",th:"กำลังอ่านรายงาน",en:"Reading report",ja:"レポート読込中"},reconcile:{zh:"对账中",th:"กำลังกระทบยอด",en:"Reconciling",ja:"照合中"},build:{zh:"生成中",th:"กำลังสร้างไฟล์",en:"Building",ja:"作成中"},persist:{zh:"保存中",th:"กำลังบันทึก",en:"Saving",ja:"保存中"},done:{zh:"完成",th:"เสร็จสิ้น",en:"Done",ja:"完了"}};window._reconProgressText=function(n,a){n=n||{},a=window._currentLang||a||localStorage.getItem("mrpilot_lang")||"th",e.parse[a]||(a="th");const o=n.stage||"parse",s=e[o]||e.parse,i=s[a]||s.th||s.en,r=n.stage_total,c=n.stage_done;if(o==="parse"&&typeof r=="number"&&r>0){const f={zh:"共 {d}/{t} 个文件",th:"{d}/{t} ไฟล์",en:"{d}/{t} files",ja:"{d}/{t} ファイル"}[a]||"{d}/{t} files";return i+" · "+f.replace("{d}",String(c||0)).replace("{t}",String(r))}return i},window._reconPollJob=async function(n,a,o){o=o||{};const s=o.intervalMs||1500,i=o.maxMs||1200*1e3,r=Date.now();let c=0;for(;;){let f=null;try{const d=await fetch("/api/recon/jobs/"+encodeURIComponent(n),{headers:{Authorization:"Bearer "+a}});try{f=await d.json()}catch{f=null}(!d.ok||!f||!f.ok)&&(f=null)}catch{f=null}if(f){if(c=0,o.onProgress)try{o.onProgress(f.progress||{},f)}catch{}if(f.status==="done"||f.status==="failed"||f.status==="needs_review"||f.status==="needs_mapping")return f}else if(++c>=10)return{ok:!1,status:"failed",error_code:"poll_unreachable"};if(Date.now()-r>i)return{ok:!1,status:"timeout",error_code:"timeout"};await new Promise(d=>setTimeout(d,s))}}})();const P={initialized:!1,stmtFiles:[],glFiles:[],currentTask:null,currentFilter:"all",allRows:[],brv2Search:{stmt:"",gl:""},cachedHistoryTasks:[],brv2Page:1},A=e=>document.getElementById(e);function qe(e){if(e==null)return"—";const n=Number(e);return isNaN(n)?"—":n.toLocaleString("en-US",{minimumFractionDigits:2,maximumFractionDigits:2})}function lo(e){return e?String(e).slice(0,10).split("-").reverse().join("/"):"—"}function re(e){return String(e||"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}function xc(e,n){n=window._currentLang||n||"th";const a={stmt_headers_not_found:{zh:"认不出银行账单表头 · 请确认文件含日期/金额/余额列,或转成清晰的 Excel/CSV 重传",th:"หาหัวตารางบัญชีธนาคารไม่เจอ · ตรวจสอบว่ามีคอลัมน์ วันที่/จำนวนเงิน/ยอดคงเหลือ หรือแปลงเป็น Excel/CSV แล้วอัปโหลดใหม่",en:"Cannot detect bank statement headers · ensure the file has date/amount/balance columns, or re-upload as a clean Excel/CSV",ja:"銀行明細のヘッダーを認識できません · 日付/金額/残高列を確認するか、Excel/CSVに変換して再アップロードしてください"},gl_headers_not_found:{zh:"认不出总账表头 · 请确认文件含日期/科目/借方/贷方列,或转成清晰的 Excel/CSV 重传",th:"หาหัวตาราง GL ไม่เจอ · ตรวจสอบว่ามีคอลัมน์ วันที่/บัญชี/เดบิต/เครดิต หรือแปลงเป็น Excel/CSV แล้วอัปโหลดใหม่",en:"Cannot detect GL headers · ensure the file has date/account/debit/credit columns, or re-upload as a clean Excel/CSV",ja:"GLのヘッダーを認識できません · 日付/科目/借方/貸方列を確認するか、Excel/CSVに変換して再アップロードしてください"},stmt_no_rows:{zh:"文件里没有交易数据 · 请确认上传了正确的银行流水,或换更清晰的版本重传",th:"ไม่พบรายการธุรกรรมในไฟล์ · ตรวจสอบว่าอัปโหลด statement ที่ถูกต้อง หรือใช้เวอร์ชันที่ชัดเจนกว่า",en:"No transaction rows found · please upload the correct statement, or try a clearer version",ja:"取引データが見つかりません · 正しい明細をアップロードするか、より鮮明なファイルでお試しください"},no_rows:{zh:"解析后没有可对账的数据行 · 请确认文件内容完整,或换清晰版本重传",th:"ไม่มีแถวข้อมูลให้กระทบยอดหลังการอ่าน · ตรวจสอบความสมบูรณ์ของไฟล์ หรืออัปโหลดใหม่",en:"No reconcilable rows after parsing · check the file is complete, or re-upload a clearer version",ja:"解析後に照合可能な行がありません · ファイルの完全性を確認するか再アップロードしてください"},file_unreadable:{zh:"文件无法读取 · 可能已损坏或被加密 · 请换文件或转 PDF/Excel 重传",th:"อ่านไฟล์ไม่ได้ · อาจเสียหายหรือถูกเข้ารหัส · ลองไฟล์อื่นหรือแปลงเป็น PDF/Excel",en:"File cannot be read · may be corrupted or encrypted · try another file or convert to PDF/Excel",ja:"ファイルを読み取れません · 破損または暗号化の可能性 · 別ファイルまたはPDF/Excelに変換してください"},file_not_supported:{zh:"不支持此文件类型 · 请上传 PDF / 图片 / Excel / CSV",th:"ไม่รองรับไฟล์ประเภทนี้ · กรุณาอัปโหลด PDF / รูปภาพ / Excel / CSV",en:"File type not supported · please upload PDF / image / Excel / CSV",ja:"このファイル形式は非対応 · PDF / 画像 / Excel / CSV をアップロードしてください"},ocr_failed:{zh:"文件识别失败 · 请尝试更清晰的版本,或转成 PDF / Excel / CSV 重传",th:"อ่านไฟล์ไม่ออก · ลองเวอร์ชันที่ชัดเจนกว่า หรือแปลงเป็น PDF / Excel / CSV",en:"Could not read the file · try a clearer version, or convert to PDF / Excel / CSV",ja:"読み取りに失敗 · より鮮明なファイルか、PDF / Excel / CSV に変換して再試行してください"}},o={zh:"解析失败 · 请换更清晰的文件,或转成 Excel / CSV 后重新上传",th:"อ่านไฟล์ไม่สำเร็จ · ลองไฟล์ที่ชัดเจนกว่า หรือแปลงเป็น Excel / CSV แล้วอัปโหลดใหม่",en:"Parsing failed · try a clearer file, or convert to Excel / CSV and re-upload",ja:"解析に失敗しました · より鮮明なファイルか、Excel / CSV に変換して再アップロードしてください"},s=a[e]||o;return s[n]||s.th||s.en}function _c(e){return e?e<1024?e+" B":e<1048576?(e/1024).toFixed(1)+" KB":(e/1048576).toFixed(1)+" MB":""}function rt(e,n){return window.t&&window.t(e)||n}function Ae(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function An(e){const n=Number(e);return Number.isFinite(n)?n.toLocaleString(void 0,{minimumFractionDigits:2,maximumFractionDigits:2}):"—"}var ms="pearnly.brv2.lastAnchorOcr";function Ec(e){try{var n=e&&e._anchor_ocr;if(!n||typeof n!="object")return;var a={stmt_opening:Number.isFinite(+n.stmt_opening)?+n.stmt_opening:null,gl_opening:Number.isFinite(+n.gl_opening)?+n.gl_opening:null,gl_closing:Number.isFinite(+n.gl_closing)?+n.gl_closing:null,stmt_closing:Number.isFinite(+n.stmt_closing)?+n.stmt_closing:null,ts:Date.now()};localStorage.setItem(ms,JSON.stringify(a))}catch{}}function Ic(){try{var e=localStorage.getItem(ms);if(!e)return null;var n=JSON.parse(e);return!n||typeof n!="object"?null:n}catch{return null}}function Bc(){var e=Ic();if(e){var n={"brv2-anchor-stmt-opening":e.stmt_opening,"brv2-anchor-gl-opening":e.gl_opening,"brv2-anchor-gl-closing":e.gl_closing,"brv2-anchor-stmt-closing":e.stmt_closing},a=0;Object.keys(n).forEach(function(c){var f=document.getElementById(c);if(f&&f.value===""){var d=n[c];if(Number.isFinite(d)){f.value=d.toFixed(2);var u=f.closest&&f.closest(".brv2-anchor-cell");u&&u.classList.add("is-prefilled"),a+=1}}});var o=document.getElementById("brv2-anchor-eq"),s=document.getElementById("brv2-anchor-eq-val");if(o&&s&&Number.isFinite(e.stmt_opening)&&Number.isFinite(e.gl_opening)){var i=e.stmt_opening-e.gl_opening;s.textContent=i.toLocaleString(void 0,{minimumFractionDigits:2,maximumFractionDigits:2}),o.style.display=""}if(a>0){var r=document.getElementById("brv2-anchor-prefill-banner");r&&r.classList.add("show")}}}function Lc(){var e=document.getElementById("brv2-anchor-prefill-banner");if(e){var n=!1;["brv2-anchor-gl-closing","brv2-anchor-stmt-closing","brv2-anchor-stmt-opening","brv2-anchor-gl-opening"].forEach(function(a){var o=document.getElementById(a);if(o){var s=o.closest&&o.closest(".brv2-anchor-cell");s&&s.classList.contains("is-prefilled")&&(n=!0)}}),e.classList.toggle("show",n)}}var Cc=[["stmt_opening","brv2-anchor-stmt-opening"],["gl_opening","brv2-anchor-gl-opening"],["gl_closing","brv2-anchor-gl-closing"],["stmt_closing","brv2-anchor-stmt-closing"]];function Sc(e){var n=document.getElementById("brv2-summary-collapse");if(!(!n||!n.parentNode)){var a=document.getElementById("brv2-anchor-audit"),o=e&&e._anchor_overrides;if(!o||typeof o!="object"||Object.keys(o).length===0){a&&a.parentNode&&a.parentNode.removeChild(a);return}a||(a=document.createElement("div"),a.id="brv2-anchor-audit",a.style.cssText="margin-top:14px;background:#fff7ed;border:1px solid #fed7aa;border-radius:8px;padding:14px 16px;",n.parentNode.insertBefore(a,n.nextSibling));var s=Cc.map(function(i){var r=o[i[0]];if(!r)return"";var c=+r.ocr||0,f=+r.user||0,d=f-c,u=d>0?"+":(d<0,""),l=Math.abs(d)<.005?"#6b7280":d>0?"#16a34a":"#dc2626";return'<tr><td style="padding:6px 10px;color:#111827;font-size:13px">'+Ae(rt(i[1],i[0]))+'</td><td style="padding:6px 10px;color:#6b7280;font-size:13px;text-align:right;font-variant-numeric:tabular-nums">'+Ae(An(c))+'</td><td style="padding:6px 10px;background:#fef08a;color:#92400e;font-weight:600;font-size:13px;text-align:right;font-variant-numeric:tabular-nums">'+Ae(An(f))+'</td><td style="padding:6px 10px;color:'+l+';font-weight:500;font-size:13px;text-align:right;font-variant-numeric:tabular-nums">'+Ae(u+An(d))+"</td></tr>"}).join("");a.innerHTML='<div style="font-weight:600;color:#92400e;font-size:13px;margin-bottom:10px">'+Ae(rt("brv2-anchor-audit-title","⚠ This run contains manually entered anchors"))+'</div><table style="width:100%;border-collapse:collapse;font-family:inherit"><thead><tr><th style="padding:6px 10px;text-align:left;color:#6b7280;font-size:11px;font-weight:500;border-bottom:1px solid #fed7aa">'+Ae(rt("brv2-anchor-audit-col-field","Field"))+'</th><th style="padding:6px 10px;text-align:right;color:#6b7280;font-size:11px;font-weight:500;border-bottom:1px solid #fed7aa">'+Ae(rt("brv2-anchor-audit-col-ocr","OCR"))+'</th><th style="padding:6px 10px;text-align:right;color:#6b7280;font-size:11px;font-weight:500;border-bottom:1px solid #fed7aa">'+Ae(rt("brv2-anchor-audit-col-user","User"))+'</th><th style="padding:6px 10px;text-align:right;color:#6b7280;font-size:11px;font-weight:500;border-bottom:1px solid #fed7aa">'+Ae(rt("brv2-anchor-audit-col-diff","Diff"))+"</th></tr></thead><tbody>"+s+"</tbody></table>"}}function dn(e){const n=A("brv2-summary-collapse"),a=A("brv2-detail-collapse"),o=A("brv2-export-btn"),s=A("brv2-new-btn"),i=A("brv2-parse-info-wrap");n&&(n.style.display=e?"":"none"),a&&(a.style.display=e?"":"none"),o&&(o.style.display=e?"":"none"),s&&(s.style.display=e?"":"none"),!e&&i&&(i.style.display="none");const r=A("brv2-warnings");!e&&r&&(r.style.display="none",r.innerHTML="")}function Tc(e){const n=A("brv2-parse-info-wrap"),a=A("brv2-parse-info-body");if(!n||!a)return;const o=e.parse_info;if(!o){n.style.display="none";return}const s=window._currentLang||"zh",i={title:{zh:"文件解析状态",th:"สถานะการอ่านไฟล์",en:"File Parse Status",ja:"ファイル解析状態"},type:{zh:"类型",th:"ประเภท",en:"Type",ja:"種別"},file:{zh:"文件名",th:"ชื่อไฟล์",en:"File",ja:"ファイル"},rows:{zh:"解析行数",th:"แถวที่พบ",en:"Rows Found",ja:"解析行数"},bank:{zh:"银行/科目",th:"ธนาคาร/บัญชี",en:"Bank/Account",ja:"銀行/科目"},status:{zh:"状态",th:"สถานะ",en:"Status",ja:"状態"},stmt:{zh:"账单",th:"บัญชีธนาคาร",en:"Stmt",ja:"明細"},gl:{zh:"总账GL",th:"GL",en:"GL",ja:"GL"},ok:{zh:"✓ 成功",th:"✓ สำเร็จ",en:"✓ OK",ja:"✓ 成功"},warn:{zh:"⚠ 0行",th:"⚠ 0 แถว",en:"⚠ 0 rows",ja:"⚠ 0行"},fail:{zh:"✗ 失败",th:"✗ ล้มเหลว",en:"✗ Failed",ja:"✗ 失敗"}},r=p=>(i[p]||{})[s]||(i[p]||{}).zh||p,c=[...(o.stmt_files||[]).map(p=>({...p,_type:"stmt",_extra:p.bank_code||""})),...(o.gl_files||[]).map(p=>({...p,_type:"gl",_extra:(p.accounts||[]).join(", ")}))],f={stmt_headers_not_found:{zh:"认不出表头列 · 请确认文件含日期/金额/余额列",th:"หาคอลัมน์หัวตารางไม่เจอ · ตรวจสอบไฟล์มีวันที่/จำนวนเงิน/ยอดคงเหลือ",en:"Cannot detect column headers · ensure file has date/amount/balance columns",ja:"列ヘッダーが認識できません · 日付/金額/残高列を確認してください"},stmt_no_rows:{zh:"文件里没有交易数据 · 请确认上传了正确的银行流水",th:"ไม่พบรายการธุรกรรมในไฟล์ · ตรวจสอบว่าอัปโหลด statement ที่ถูกต้อง",en:"No transaction rows found · please check the file",ja:"取引データが見つかりません · ファイルを確認してください"},file_not_supported:{zh:"不支持此文件类型 · 请上传 PDF / 图片 / Excel / CSV",th:"ไม่รองรับไฟล์ประเภทนี้ · กรุณาอัปโหลด PDF / รูปภาพ / Excel / CSV",en:"File type not supported · please upload PDF / image / Excel / CSV",ja:"このファイル形式は非対応 · PDF / 画像 / Excel / CSV をアップロード"},file_unreadable:{zh:"文件无法读取 · 可能已损坏或被加密",th:"อ่านไฟล์ไม่ได้ · อาจเสียหายหรือถูกเข้ารหัส",en:"File cannot be read · may be corrupted or encrypted",ja:"ファイルを読み取れません · 破損または暗号化の可能性"},ocr_failed:{zh:"文件识别失败 · 请尝试更清晰的版本或换 PDF 格式重传",th:"อ่านไฟล์ไม่ออก · ลองเวอร์ชันที่ชัดเจนกว่าหรือเปลี่ยนเป็น PDF",en:"Could not read file · try a clearer version or upload as PDF",ja:"読み取り失敗 · より鮮明なファイルまたは PDF 形式で再試行"},gl_headers_not_found:{zh:"认不出总账表头 · 请确认文件含科目/借方/贷方列",th:"หาหัวคอลัมน์ GL ไม่เจอ · ตรวจสอบมีคอลัมน์บัญชี/เดบิต/เครดิต",en:"Cannot detect GL column headers · ensure account/debit/credit columns exist",ja:"GL 列ヘッダー認識不可 · 科目/借方/貸方列を確認してください"}},d=p=>{const m=String(p||"");return/Cannot detect bank statement column headers/i.test(m)?"stmt_headers_not_found":/Cannot detect GL column headers/i.test(m)?"gl_headers_not_found":/No transaction rows found|no pages parsed/i.test(m)?"stmt_no_rows":/unsupported format/i.test(m)?"file_not_supported":/Cannot read Excel|file_unreadable/i.test(m)?"file_unreadable":/Gemini.*invalid JSON|Gemini.*parsed but failed|validation errors|BankStatementDocument schema|layer2:|layer1:/i.test(m)?"ocr_failed":null},u=p=>{const m=p.error_code||d(p.error);if(m&&f[m]){const v=window._currentLang||"zh";return f[m][v]||f[m].zh}return String(p.error||"").slice(0,80)},l=p=>!p.ok&&p.error?`<span style="color:#dc2626">${r("fail")} — ${re(u(p))}</span>`:p.rows?`<span style="color:#059669">${r("ok")} (${p.rows})</span>`:`<span style="color:#d97706">${r("warn")}</span>`;a.innerHTML=`
        ...
        <table style="width:100%;border-collapse:collapse;font-size:12px;margin-bottom:4px">
          ...
          <td>${c?"L"+c:"—"}</td>
        </tr>`}).join("")}async function Dt(){const e=localStorage.getItem("mrpilot_token")||"";try{const a=await(await fetch("/api/recon/bank-v2/tasks",{headers:{Authorization:"Bearer "+e}})).json();pn(a.tasks||[])}catch{const a=A("brv2-history-empty"),o=window._currentLang||"zh",s={zh:"加载失败",th:"โหลดประวัติไม่ได้",en:"Load failed",ja:"読み込み失敗"}[o]||"加载失败";a&&(a.textContent=s,a.style.display="");const i=A("brv2-history-table-wrap");i&&(i.style.display="none")}}const ft=10;function co(){const e=A("brv2-history-pager"),n=A("brv2-history-pager-info"),a=A("brv2-history-prev"),o=A("brv2-history-next");if(!e)return;if(P.cachedHistoryTasks.length<=ft){e.style.display="none";return}e.style.display="";const s=Math.ceil(P.cachedHistoryTasks.length/ft);n&&(n.textContent=P.brv2Page+" / "+s),a&&(a.disabled=P.brv2Page<=1),o&&(o.disabled=P.brv2Page>=s)}function $c(){const e=A("brv2-history-prev"),n=A("brv2-history-next");e&&!e._brv2Bound&&(e._brv2Bound=!0,e.addEventListener("click",()=>{P.brv2Page>1&&(P.brv2Page--,pn(P.cachedHistoryTasks))})),n&&!n._brv2Bound&&(n._brv2Bound=!0,n.addEventListener("click",()=>{const a=Math.ceil(P.cachedHistoryTasks.length/ft);P.brv2Page<a&&(P.brv2Page++,pn(P.cachedHistoryTasks))}))}function pn(e){e!==void 0&&(P.cachedHistoryTasks=e||[],P.brv2Page=1);const n=P.cachedHistoryTasks,a=A("brv2-history-empty"),o=A("brv2-history-table-wrap"),s=A("brv2-history-tbody");if(!s)return;const i=window._currentLang||"zh";if(!n.length){const m={zh:"暂无对账记录",th:"ยังไม่มีประวัติ",en:"No records yet",ja:"記録なし"}[i]||"暂无对账记录";a&&(a.textContent=m,a.style.display=""),o&&(o.style.display="none"),co();return}a&&(a.style.display="none"),o&&(o.style.display="");const r=Math.ceil(n.length/ft);P.brv2Page>r&&(P.brv2Page=r);const c=(P.brv2Page-1)*ft,f=n.slice(c,c+ft),d=localStorage.getItem("mrpilot_token")||"",u='<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" width="14" height="14"><circle cx="8" cy="8" r="6"/><polyline points="6 8 8 10 10 8"/><line x1="8" y1="4" x2="8" y2="10"/></svg>',l='<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" width="14" height="14"><path d="M8 2v9M4 7l4 4 4-4M3 14h10"/></svg>',p='<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" width="14" height="14"><polyline points="3 4 13 4"/><path d="M6 4V2.5a.5.5 0 0 1 .5-.5h3a.5.5 0 0 1 .5.5V4"/><path d="M5 4l1 9a1 1 0 0 0 1 1h2a1 1 0 0 0 1-1l1-9"/></svg>';s.innerHTML="",f.forEach(m=>{const v=Number(m.formula_diff||0),w=Math.abs(v)<.05,b=(m.stmt_files||"").split(";").map(ne=>ne.trim().split(/[/\\]/).pop()).filter(Boolean).join(", "),g=(m.gl_files||"").split(";").map(ne=>ne.trim().split(/[/\\]/).pop()).filter(Boolean).join(", "),h=m.created_at?String(m.created_at).slice(0,16).replace("T"," "):"",_=document.createElement("tr");_.dataset.taskId=m.id;const y=document.createElement("td");y.textContent=h;const k=document.createElement("td");k.className="glv-history-file",k.title=b+" + "+g,k.textContent=b+" + "+g;const x=document.createElement("td");x.className="glv-num",x.textContent=(m.stmt_row_count||0)+" / "+(m.gl_row_count||0);const E=document.createElement("td");E.className="glv-num",E.textContent=m.matched_count||0;const I=document.createElement("td");I.className="glv-num",I.textContent=m.unmatched_gl||0;const B=document.createElement("td");B.className="glv-num",B.textContent=m.unmatched_stmt||0;const L=document.createElement("td");L.className="glv-num",L.style.color=w?"#059669":"#dc2626",L.textContent=w?"✓":qe(v);const C=document.createElement("td");C.className="glv-history-actions";const S=(ne,de,ae,z)=>{const q=document.createElement("button");return q.type="button",q.title=de,q.setAttribute("aria-label",de),ae&&(q.className=ae),q.innerHTML=ne,q.onclick=U=>{U.stopPropagation(),z()},q},$={zh:"删除这条记录?",th:"ลบรายการนี้?",en:"Delete this record?",ja:"この記録を削除しますか?"}[i]||"删除?",j={zh:"加载",th:"โหลด",en:"Load",ja:"読込"}[i]||"加载",N={zh:"导出",th:"ส่งออก",en:"Export",ja:"エクスポート"}[i]||"导出",X={zh:"删除",th:"ลบ",en:"Delete",ja:"削除"}[i]||"删除";C.appendChild(S(u,j,"",()=>po(m.id,d))),C.appendChild(S(l,N,"",()=>fs(m.id))),C.appendChild(S(p,X,"glv-del",async()=>{await showConfirm($,{danger:!0})&&(await fetch("/api/recon/bank-v2/"+m.id,{method:"DELETE",headers:{Authorization:"Bearer "+d}}),Dt())})),[y,k,x,E,I,B,L,C].forEach(ne=>_.appendChild(ne)),_.style.cursor="pointer",_.addEventListener("click",async ne=>{ne.target.closest(".glv-del")||ne.target.closest("button")||await po(m.id,d)}),s.appendChild(_)}),co(),hs()}function hs(){const e=((A("brv2-hist-search")||{}).value||"").trim().toLowerCase(),n=A("brv2-history-tbody");n&&n.querySelectorAll("tr").forEach(a=>{a.dataset.taskId&&(a.style.display=!e||a.textContent.toLowerCase().includes(e)?"":"none")})}async function po(e,n){try{const o=await(await fetch("/api/recon/bank-v2/"+e,{headers:{Authorization:"Bearer "+n}})).json();if(!o.ok)return;P.currentTask={task_id:o.task_id,...o},P.allRows=o.detail||[],P.currentFilter="all",document.querySelectorAll(".brv2-filter-btn").forEach(s=>s.classList.toggle("active",s.dataset.filter==="all")),Ba(P.currentTask)}catch{}}function Se(e){const n=e==="stmt"?P.stmtFiles:P.glFiles,a=A(`brv2-${e}-name`);if(a)if(n.length===0)a.textContent="";else{const s=window._currentLang||"zh",i={zh:"个文件",th:" ไฟล์",en:" file(s)",ja:" ファイル"};a.textContent=n.length+(i[s]||" 个文件")}const o=A("brv2-preview-panel");o&&o.style.display!=="none"&&Gn(e),Hc()}function Hc(){const e=A("brv2-toggle-preview"),n=A("brv2-preview-panel"),a=P.stmtFiles.length+P.glFiles.length>0;e&&(e.style.display=a?"":"none"),!a&&n&&(n.style.display="none",e&&e.classList.remove("open"))}function Ac(){Gn("stmt"),Gn("gl")}function Gn(e){const n=A(e==="stmt"?"brv2-pp-stmt-col":"brv2-pp-gl-col");if(!n)return;const a=e==="stmt"?P.stmtFiles:P.glFiles,o=window._currentLang||"zh",s={stmt:{zh:"① 银行账单",th:"① บัญชีธนาคาร",en:"① Bank Stmt",ja:"① 銀行明細"},gl:{zh:"② 总账 GL",th:"② GL รายงาน",en:"② GL Report",ja:"② GL帳簿"}},i=(s[e]||{})[o]||s[e].zh,r=re(window.t&&window.t("vex-preview-search")||"搜索文件名..."),c=re(window.t&&window.t("vex-preview-clear-all")||"全清"),f=P.brv2Search[e]||"";n.innerHTML='<div class="vex-pp-col-title"><span class="vex-pp-col-name">'+re(i)+' <span class="vex-pp-col-count">'+a.length+'</span></span></div><div class="vex-pp-search-row"><input class="vex-pp-search" id="brv2-pp-search-'+e+'" type="text" placeholder="'+r+'" value="'+re(f)+'" autocomplete="off"><button class="vex-pp-clear-btn" id="brv2-pp-clearall-'+e+'" type="button">'+c+'</button></div><div class="vex-pp-file-list" id="brv2-pp-'+e+'-list"></div><div class="vex-pp-pagination" id="brv2-pp-'+e+'-pg"></div>';const d=A("brv2-pp-search-"+e);d&&d.addEventListener("input",function(l){P.brv2Search[e]=l.target.value,uo(e)});const u=A("brv2-pp-clearall-"+e);u&&u.addEventListener("click",function(){e==="stmt"?P.stmtFiles.length=0:P.glFiles.length=0,Se(e),ze()}),uo(e)}function uo(e){const n=A("brv2-pp-"+e+"-list"),a=A("brv2-pp-"+e+"-pg");if(!n)return;const o=e==="stmt"?P.stmtFiles:P.glFiles,s=(P.brv2Search[e]||"").toLowerCase(),i=s?o.filter(f=>f.name.toLowerCase().includes(s)):o.slice(),r='<svg class="vex-pp-fi-ico" viewBox="0 0 14 16" fill="none" stroke="currentColor" stroke-width="1.4" width="12" height="14"><path d="M3 1h6l3 3v11H3V1z"/><path d="M9 1v3h3"/></svg>',c='<svg viewBox="0 0 14 14" fill="none" stroke="currentColor" stroke-width="1.6" width="11" height="11"><path d="M2 4h10M5 4V2h4v2M5.5 7v4M8.5 7v4M3 4l1 8h6l1-8"/></svg>';if(n.innerHTML=i.map((f,d)=>'<div class="vex-pp-file-row">'+r+'<span class="vex-pp-fi-name" title="'+re(f.name)+'">'+re(f.name)+'</span><span class="vex-pp-fi-size">'+_c(f.size)+'</span><button class="vex-pp-fi-del" type="button" data-zone="'+e+'" data-idx="'+o.indexOf(f)+'" aria-label="remove">'+c+"</button></div>").join(""),n.querySelectorAll(".vex-pp-fi-del").forEach(function(f){f.addEventListener("click",function(){const d=parseInt(f.dataset.idx,10);f.dataset.zone==="stmt"?P.stmtFiles.splice(d,1):P.glFiles.splice(d,1),Se(f.dataset.zone),ze()})}),a){const f=window.t&&window.t("vex-preview-count")||"显示 {n} / 共 {m}";a.textContent=f.replace("{n}",i.length).replace("{m}",o.length)}}function jc(){const e=A("brv2-toggle-preview");e&&!e._reconBound&&(e._reconBound=!0,e.addEventListener("click",function(){const n=A("brv2-preview-panel"),a=A("brv2-toggle-preview-label"),o=n&&n.style.display!=="none";n&&(n.style.display=o?"none":""),e.classList.toggle("open",!o),a&&(a.textContent=o?window.t&&window.t("vex-toggle-preview-open")||"查看清单":window.t&&window.t("vex-toggle-preview-close")||"收起清单"),o||Ac()}))}function ze(){const e=A("brv2-run-btn"),n=A("brv2-status"),a=P.stmtFiles.length>0,o=P.glFiles.length>0;if(e&&(e.disabled=!(a&&o)),n){const s=window._currentLang||"zh";if(!a&&!o){const i={zh:"请上传银行账单和 GL 文件",th:"กรุณาอัปโหลดบัญชีธนาคารและ GL",en:"Upload bank statement and GL files",ja:"銀行明細と GL を両方アップロードしてください"};n.textContent=i[s]||i.zh}else if(a)if(o){const i={zh:"两份文件已就绪",th:"พร้อมสอบทาน",en:"Ready to reconcile",ja:"照合を開始できます"};n.textContent=i[s]||i.zh}else{const i={zh:"还缺 GL 文件",th:"ยังขาดไฟล์ GL",en:"Missing GL file",ja:"GL ファイルが未アップロード"};n.textContent=i[s]||i.zh}else{const i={zh:"还缺银行账单 PDF",th:"ยังขาดไฟล์บัญชีธนาคาร PDF",en:"Missing bank statement PDF",ja:"銀行明細 PDF が未アップロード"};n.textContent=i[s]||i.zh}}}function mo(e,n,a){const o=A(e),s=A(n);!o||!s||(o.addEventListener("click",()=>s.click()),o.addEventListener("keydown",i=>{(i.key==="Enter"||i.key===" ")&&(i.preventDefault(),s.click())}),o.addEventListener("dragover",i=>{i.preventDefault(),o.classList.add("drag-over")}),o.addEventListener("dragleave",()=>o.classList.remove("drag-over")),o.addEventListener("drop",i=>{i.preventDefault(),o.classList.remove("drag-over");const r=Array.from(i.dataTransfer.files||[]);a==="stmt"?P.stmtFiles.push(...r):P.glFiles.push(...r),Se(a),ze()}),s.addEventListener("change",()=>{const i=Array.from(s.files||[]);a==="stmt"?P.stmtFiles.push(...i):P.glFiles.push(...i),s.value="",Se(a),ze()}))}function be(e){const n=A("brv2-progress"),a=A("brv2-run-btn"),o=A("brv2-error");n&&(n.style.display=e?"":"none"),a&&(a.disabled=e),o&&(o.style.display="none")}function Ce(e){const n=A("brv2-error");n&&(n.textContent=e,n.style.display="",n.scrollIntoView({behavior:"smooth",block:"nearest"})),be(!1),ze(),window.showToast&&window.showToast(e,"error")}async function Kn(){if(P.stmtFiles.length===0||P.glFiles.length===0)return;const e=localStorage.getItem("mrpilot_token")||"",n=window._currentLang||"zh",a=(A("brv2-acct-select")||{}).value||"";dn(!1),be(!0);try{const o=new FormData;P.stmtFiles.forEach(m=>o.append("stmt_files",m)),P.glFiles.forEach(m=>o.append("gl_files",m)),o.append("gl_account",a),o.append("lang",n);const s=parseFloat((A("brv2-anchor-gl-closing")||{}).value),i=parseFloat((A("brv2-anchor-stmt-closing")||{}).value),r=parseFloat((A("brv2-anchor-stmt-opening")||{}).value),c=parseFloat((A("brv2-anchor-gl-opening")||{}).value);Number.isFinite(s)&&o.append("gl_closing_override",s),Number.isFinite(i)&&o.append("stmt_closing_override",i),Number.isFinite(r)&&o.append("stmt_opening_override",r),Number.isFinite(c)&&o.append("gl_opening_override",c);const f=await fetch("/api/recon/bank-v2/submit",{method:"POST",headers:{Authorization:"Bearer "+e},body:o});let d=null;try{d=await f.json()}catch{d=null}if(d&&d.needs_mapping){be(!1),window.ReconMapping?window.ReconMapping.show(d,{token:e,lang:n,onConfirmed:function(){Kn()}}):Ce(t("brv2-err-server")||"服务器繁忙,请稍后重试");return}if(!f.ok||!d||!d.ok||!d.job_id){be(!1),d&&(d.detail||d.error)?Ce(_humanizeBackendError(d.detail||d.error,"Error "+f.status)):Ce(t("brv2-err-server")||"服务器繁忙,请稍后重试");return}const u=A("brv2-progress-sub"),l=await window._reconPollJob(d.job_id,e,{onProgress:m=>{u&&(u.textContent=window._reconProgressText(m,n))}});if(l&&l.status==="needs_mapping"&&l.mapping){be(!1),window.ReconMapping?window.ReconMapping.show(l.mapping,{token:e,lang:n,onConfirmed:function(){Kn()}}):Ce(t("brv2-err-server")||"服务器繁忙,请稍后重试");return}if(l&&l.status==="needs_review"&&l.review){be(!1),window.ReconReview?window.ReconReview.show(l.review,{token:e,lang:n,jobId:d.job_id,onConfirmed:async function(m){be(!0);const v=await window._reconPollJob(m,e,{onProgress:w=>{u&&(u.textContent=window._reconProgressText(w,n))}});await p(v)}}):Ce(t("brv2-err-server")||"服务器繁忙,请稍后重试");return}if(l&&l.status==="failed"){be(!1),Ce(xc(l.error_code,n));return}await p(l);async function p(m){try{if(!m||m.status!=="done"||!m.result_id){be(!1),Ce(t("brv2-err-server")||"服务器繁忙,请稍后重试");return}const v=await fetch("/api/recon/bank-v2/"+encodeURIComponent(m.result_id),{headers:{Authorization:"Bearer "+e}});let w=null;try{w=await v.json()}catch{w=null}if(!v.ok||w===null||!w.ok){be(!1),Ce(t("brv2-err-server")||"服务器繁忙,请稍后重试");return}(w.gl_accounts||[]).length>1&&Pc(w.gl_accounts),P.currentTask=w,P.allRows=w.detail||[],P.currentFilter="all",document.querySelectorAll(".brv2-filter-btn").forEach(g=>g.classList.toggle("active",g.dataset.filter==="all")),Ec(w&&w.summary),be(!1),Ba(w),Dt();const b=A("brv2-summary-collapse");b&&b.scrollIntoView({behavior:"smooth",block:"nearest"})}catch(v){be(!1),Ce(v.message||"Network error")}}}catch(o){Ce(o.message||"Network error")}}function Pc(e){const n=A("brv2-acct-select");if(!n)return;const a=window._currentLang||"zh",o={zh:"全部账户",th:"ทุกบัญชี",en:"All Accounts",ja:"すべての口座"}[a]||"全部账户";n.innerHTML=`<option value="">${o}</option>`+e.map(s=>`<option value="${re(s)}">${re(s)}</option>`).join(""),n.style.display=""}function La(){if(P.initialized){Dt();return}P.initialized=!0,mo("brv2-stmt-zone","brv2-stmt-input","stmt"),mo("brv2-gl-zone","brv2-gl-input","gl");const e=["brv2-anchor-gl-closing","brv2-anchor-stmt-closing","brv2-anchor-stmt-opening","brv2-anchor-gl-opening"];function n(){const c=parseFloat((A("brv2-anchor-stmt-opening")||{}).value),f=parseFloat((A("brv2-anchor-gl-opening")||{}).value),d=A("brv2-anchor-eq"),u=A("brv2-anchor-eq-val");if(!(!d||!u))if(Number.isFinite(c)&&Number.isFinite(f)){const l=c-f;u.textContent=l.toLocaleString(void 0,{minimumFractionDigits:2,maximumFractionDigits:2}),d.style.display=""}else d.style.display="none"}e.forEach(c=>{const f=A(c);f&&(f.addEventListener("input",n),f.addEventListener("input",()=>{const d=f.closest(".brv2-anchor-cell");d&&d.classList.remove("is-prefilled"),Lc()}))}),Bc();const a=A("brv2-run-btn");a&&a.addEventListener("click",Kn);const o=A("brv2-reset-btn");o&&o.addEventListener("click",()=>{P.currentTask=null,P.allRows=[],P.stmtFiles=[],P.glFiles=[],Se("stmt"),Se("gl"),ze(),dn(!1);const c=A("brv2-acct-select");c&&(c.style.display="none"),e.forEach(u=>{const l=A(u);if(l){l.value="";const p=l.closest&&l.closest(".brv2-anchor-cell");p&&p.classList.remove("is-prefilled")}});const f=A("brv2-anchor-eq");f&&(f.style.display="none");const d=A("brv2-anchor-prefill-banner");d&&d.classList.remove("show")});const s=A("brv2-new-btn");s&&s.addEventListener("click",()=>{P.currentTask=null,P.allRows=[],P.stmtFiles=[],P.glFiles=[],Se("stmt"),Se("gl"),ze(),dn(!1)});const i=A("brv2-filter-tabs");i&&i.addEventListener("click",c=>{c.stopPropagation();const f=c.target.closest(".brv2-filter-btn");f&&(P.currentFilter=f.dataset.filter,i.querySelectorAll(".brv2-filter-btn").forEach(d=>d.classList.toggle("active",d===f)),vs())}),jc(),$c();const r=A("brv2-hist-search");r&&r.addEventListener("input",hs),Dt(),ze(),window._brv2LoadHistory=Dt,Array.isArray(window.__i18nSubs)||(window.__i18nSubs=[]),window.__i18nSubs=window.__i18nSubs.filter(c=>c.name!=="brv2"),window.__i18nSubs.push({name:"brv2",fn:function(){ze(),Se("stmt"),Se("gl"),P.currentTask&&Ba(P.currentTask),pn()}})}window._loadBankReconV2Panel=function(e){const n=e?document.getElementById(e):null;n&&n.id!=="recon-pane-bank"&&(n.innerHTML=`<div style="padding:16px;font-size:13px;color:var(--ink-3)">
            银行对账 v2 · 请前往对账中心使用</div>`),La()};document.addEventListener("DOMContentLoaded",()=>{A("brv2-run-btn")&&La()});window._bankReconV2Init=La;(function(){const e=document.getElementById("general-lang");if(!e)return;e.addEventListener("change",a=>{const o=a.target.value;o&&applyLang(o)});const n=typeof currentLang=="string"&&currentLang||localStorage.getItem("mrpilot_lang")||"th";e.value=n})();(function(){const n="pearnly_general_tz",a="pearnly_general_date_format",o="pearnly_general_number_format",s={tz:"Asia/Bangkok",date:"YYYY-MM-DD",number:"comma_dot"};function i(){const d=document.getElementById("general-tz"),u=document.getElementById("general-date"),l=document.getElementById("general-number");if(!(!d||!u||!l))try{d.value=localStorage.getItem(n)||s.tz,u.value=localStorage.getItem(a)||s.date,l.value=localStorage.getItem(o)||s.number}catch{d.value=s.tz,u.value=s.date,l.value=s.number}}async function r(){const d=document.getElementById("btn-save-general"),u=document.getElementById("general-save-msg");if(!d)return;const l=d.innerHTML;d.disabled=!0,d.innerHTML="<span>"+(t("msg-saving")||"保存中...")+"</span>",u&&(u.textContent="",u.classList.remove("error"));try{const p=(document.getElementById("general-tz")||{}).value||s.tz,m=(document.getElementById("general-date")||{}).value||s.date,v=(document.getElementById("general-number")||{}).value||s.number;try{localStorage.setItem(n,p),localStorage.setItem(a,m),localStorage.setItem(o,v)}catch{}window._pearnlyGeneral={tz:p,date_format:m,number_format:v},u&&(u.textContent=t("msg-saved")||"已保存")}catch{u&&(u.textContent=t("msg-save-failed")||"保存失败",u.classList.add("error"))}finally{d.disabled=!1,d.innerHTML=l,setTimeout(function(){u&&(u.textContent="")},3e3)}}function c(){const d=document.getElementById("btn-save-general");if(!d){setTimeout(c,200);return}d._pearnlyGenBound||(d._pearnlyGenBound=!0,d.addEventListener("click",r),i())}function f(){i();const d=document.getElementById("general-lang");if(d){const u=typeof currentLang=="string"&&currentLang||localStorage.getItem("mrpilot_lang")||"th";d.value=u}}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",c):c(),typeof window.subscribeI18n=="function"&&window.subscribeI18n("settings-general",f)})();(function(){const e="mrpilot_nav_collapsed",n={ocr:"sales",history:"sales",reconcile:"sales","sales-invoices":"sales",receivables:"sales",vouchers:"expense"};function a(){try{const r=localStorage.getItem(e);return r?JSON.parse(r):{}}catch{return{}}}function o(r){try{localStorage.setItem(e,JSON.stringify(r))}catch{}}function s(){const r=a();document.querySelectorAll(".nav-collapsible").forEach(function(c){const f=c.dataset.collapsible;r[f]?c.classList.add("collapsed"):c.classList.remove("collapsed")})}function i(r){const c=a();c[r]=!c[r],o(c),s()}(function(){const c=a();let f=!1;c.sales===void 0&&(c.sales=!1,f=!0),c.expense===void 0&&(c.expense=!0,f=!0),f&&o(c)})(),s(),document.querySelectorAll(".nav-group-toggle").forEach(function(r){r.addEventListener("click",function(){i(r.dataset.toggleGroup)})}),window.expandNavGroupForRoute=function(r){const c=n[r];if(!c)return;const f=a();f[c]&&(f[c]=!1,o(f),s())}})();const Dc=`
    ...
    `,document.body.appendChild(n),n.addEventListener("click",async a=>{if(a.target===n||a.target.classList.contains("log-detail-close")){n.remove();return}const o=a.target.closest("[data-receipt-copy]");if(o){xs(o.dataset.receiptCopy);return}const s=a.target.closest("[data-receipt-action]");if(s){const i=s.dataset.receiptAction;i==="retry"?window.retryPushLog(s.dataset.logId):i==="exceptions"?typeof routeTo=="function"&&routeTo("exceptions"):i==="mappings"&&typeof routeTo=="function"&&routeTo("integrations"),n.remove();return}});try{const a=await fetch(`/api/erp/logs/${encodeURIComponent(e)}`,{headers:{Authorization:"Bearer "+token}});if(!a.ok){n.remove();return}const o=await a.json(),s=window._erpEndpoints.find(S=>S.id===o.endpoint_id),i=o.endpoint_name||(s?s.name:o.endpoint_id?t("erp-log-endpoint-deleted"):"-"),r=(o.endpoint_adapter||s&&s.adapter||"").toLowerCase(),c=new Date(o.created_at).toLocaleString(),f=o.trigger==="auto"?t("log-tag-auto"):o.trigger==="retry"?t("log-tag-retry"):t("log-tag-manual"),d=o.request_body?JSON.stringify(o.request_body,null,2):t("erp-receipt-no-tech"),u=o.response_body||t("erp-receipt-no-tech"),l=o.status==="success";let p=typeof u=="string"?u:JSON.stringify(u,null,2);if(l)try{const S=typeof o.response_body=="string"?JSON.parse(o.response_body):o.response_body||{},$=S.row_count||(Array.isArray(S.imported_rows)?S.imported_rows.length:0);$>0&&(p=t("log-push-rows").replace("{n}",String($)))}catch{}const m=(o.external_doc_no||"").trim(),v=(o.external_url||"").trim(),w=(o.external_doc_hint||"").trim(),b=(o.ocr_buyer_name||"").trim()||o.client_name||"-",g=o.seller_name||"-",h=o.push_type==="id_card";let _="-";const y=Number(o.total_amount);o.total_amount!=null&&o.total_amount!==""&&!isNaN(y)&&(_=y.toLocaleString("en-US",{minimumFractionDigits:2,maximumFractionDigits:2}));const k=l?t("erp-receipt-title-ok"):t("erp-receipt-title-fail"),x=l?"✓":"✗",E=[],I=(S,$)=>{E.push(`
        ...
        `}catch(a){console.error(a),n.remove()}}window.copyErpDocNo=xs;window.showLogDetail=Nc;const Oc=`
        <div class="modal">
            <div class="modal-head">
    ...
    `;fe("endpoint-modal",Oc);let Tt={key:"all",val:""},Rt="",jn=!1,Re=new Set;window._erpSelected=Re;async function Vc(){const e=document.getElementById("erp-logs-erp-select");if(!(!e||jn)){jn=!0;try{let n=window._erpEndpoints;if(!Array.isArray(n)||n.length===0){const s=await fetch("/api/erp/endpoints",{headers:{Authorization:"Bearer "+token}});if(s.ok){const i=await s.json();n=i&&(i.items||i)||[]}}Array.isArray(n)||(n=[]);const a=new Set,o=[];n.forEach(s=>{const i=(s&&s.adapter||"").toLowerCase();!i||a.has(i)||(a.add(i),o.push({val:i,label:s&&s.name||i}))}),e.innerHTML=`<option value="">${escapeHtml(t("erp-logs-erp-all"))}</option>`+o.map(s=>`<option value="${escapeHtml(s.val)}"${s.val===Rt?" selected":""}>${escapeHtml(s.label)}</option>`).join("")}catch{jn=!1}}}async function vt(e){const n=document.getElementById("erp-logs-list");if(n){e||(n.innerHTML=`<div class="erp-logs-empty">${escapeHtml(t("erp-logs-loading"))}</div>`),window.loadErpTodayStats(),Vc();try{const a=new URLSearchParams({limit:"30"});Tt.key==="status"&&a.set("status",Tt.val),Tt.key==="trigger"&&a.set("trigger",Tt.val),Rt&&a.set("adapter",Rt);const o=await fetch(`/api/erp/logs?${a}`,{headers:{Authorization:"Bearer "+token}});if(!o.ok){n.innerHTML=`<div class="erp-logs-empty">${escapeHtml(t("erp-logs-error"))}</div>`;return}const i=(await o.json()).items||[];if(window._erpLogPollTimer&&(clearTimeout(window._erpLogPollTimer),window._erpLogPollTimer=null),i.some(function(m){return m.status==="pending"})&&(window._erpLogPollTimer=setTimeout(function(){vt(!0)},4e3)),i.length===0){n.innerHTML=`<div class="erp-logs-empty">${escapeHtml(t("erp-logs-empty"))}</div>`;return}const r=i.filter(function(m){var v=m.status==="failed"&&m.next_retry_at&&new Date(m.next_retry_at).getTime()>Date.now()-6e4;return!v}).map(function(m){return m.id}),c=Rt==="mrerp_dms",f=c?t("erp-log-col-booking"):t("erp-log-col-invoice"),d=c?t("erp-log-col-customer"):t("erp-log-col-seller"),u=c?t("erp-log-col-idcard"):t("erp-log-col-client"),l='<div class="erp-log-row erp-log-row-header" data-log-header>'+(r.length>0?`<input type="checkbox" class="erp-log-cb erp-log-cb-all" data-log-select-all title="${escapeHtml(t("erp-log-select-all-tip"))}">`:'<span class="erp-log-cb-spacer"></span>')+`<span class="log-time">${escapeHtml(t("erp-log-col-time"))}</span><span class="log-status">${escapeHtml(t("erp-log-col-status"))}</span><span class="log-tag-header">${escapeHtml(t("erp-log-col-trigger"))}</span><span class="log-invoice">${escapeHtml(f)}</span><span class="log-workspace">${escapeHtml(t("erp-log-col-workspace"))}</span><span class="log-client">${escapeHtml(u)}</span><span class="log-seller">${escapeHtml(d)}</span><span class="log-erp">${escapeHtml(t("erp-log-col-erp"))}</span><span class="log-doc">${escapeHtml(t("erp-log-col-doc"))}</span><span class="log-http">${escapeHtml(t("erp-log-col-http"))}</span><span class="log-elapsed">${escapeHtml(t("erp-log-col-elapsed"))}</span><span class="log-actions"></span></div>`;n.innerHTML=l+i.map(m=>{const v=new Date(m.created_at),w=`${String(v.getMonth()+1).padStart(2,"0")}-${String(v.getDate()).padStart(2,"0")} ${String(v.getHours()).padStart(2,"0")}:${String(v.getMinutes()).padStart(2,"0")}`,b=m.status==="failed"&&m.next_retry_at&&new Date(m.next_retry_at).getTime()>Date.now()-6e4;let g,h,_;m.status==="pending"?(g="retrying",h="⟳",_=t("erp-status-pending")):m.status==="success"?(g="ok",h="✓",_=t("erp-status-success")):m.status==="skipped_dup"?(g="skipped",h="⏭",_=t("erp-status-skipped")):b?(g="retrying",h="↻",_=t("erp-status-retrying")):(g="fail",h="✗",_=t("erp-status-failed"));let y;m.trigger==="auto"?y=`<span class="log-tag auto">${escapeHtml(t("log-tag-auto"))}</span>`:m.trigger==="retry"?y=`<span class="log-tag retry">${escapeHtml(t("log-tag-retry"))}</span>`:y=`<span class="log-tag manual">${escapeHtml(t("log-tag-manual"))}</span>`;const k=m.push_type==="id_card",x=k?`<span class="log-tag log-type-idcard">${escapeHtml(t("erp-log-type-idcard"))}</span>`:"",E=m.error_friendly&&(m.error_friendly[currentLang]||m.error_friendly.en)||"";let I="";const B=m.retry_count||0,L=m.max_retries||3;if(b){const U=new Date(m.next_retry_at).getTime()-Date.now(),ie=Math.max(0,Math.round(U/6e4)),oe=ie<=0?t("erp-retry-next-soon"):t("erp-retry-next-min",{n:ie});I=`${t("erp-retry-attempt",{n:B,max:L})} · ${oe}`}else m.status==="failed"&&B>=L&&!m.next_retry_at&&(I=t("erp-retry-exhausted",{n:B}));const C=m.status==="failed"&&!b?`<button class="log-retry-btn btn btn-icon" data-log-retry="${escapeHtml(m.id)}" title="${escapeHtml(t("log-retry-title"))}">↻</button>`:"",S=!b,$=Re.has(m.id)?"checked":"",j=S?`<input type="checkbox" class="erp-log-cb" data-log-cb="${escapeHtml(m.id)}" ${$}>`:'<span class="erp-log-cb-spacer"></span>',N=(m.ocr_buyer_name||"").trim()||(m.client_name||"").trim(),X=k?`<span class="log-client" title="${escapeHtml(t("erp-log-col-idcard"))}">${m.id_card_tail?"••••"+escapeHtml(m.id_card_tail):"—"}</span>`:N?`<span class="log-client" title="${escapeHtml(N)}">${escapeHtml(N.substring(0,18))}</span>`:`<span class="log-client log-client-empty" title="${escapeHtml(t("erp-log-client-unassigned-tip"))}">${escapeHtml(t("erp-log-client-unassigned"))}</span>`,ne=k?'<span class="log-workspace log-workspace-unresolved">—</span>':m.workspace_name?`<span class="log-workspace">${escapeHtml((m.workspace_name||"").substring(0,16))}</span>`:`<span class="log-workspace log-workspace-unresolved" title="${escapeHtml(t("erp-log-ws-unresolved-tip"))}">${escapeHtml(t("erp-log-ws-unresolved"))}</span>`,de=m.endpoint_name?`<span class="log-erp">${escapeHtml((m.endpoint_name||"").substring(0,14))}</span>`:`<span class="log-erp log-erp-deleted">${escapeHtml(t("erp-log-endpoint-deleted"))}</span>`,ae=(m.external_doc_no||"").trim(),z=(m.external_url||"").trim();let q;return z?q=`<span class="log-doc"><a href="${escapeHtml(z)}" target="_blank" rel="noopener" class="log-doc-open" title="${escapeHtml(ae||"")}">${escapeHtml(t("erp-log-doc-open"))}</a></span>`:ae?q=`<span class="log-doc log-doc-copy" data-copy-doc="${escapeHtml(ae)}" title="${escapeHtml(t("erp-log-doc-copy-tip"))}">${escapeHtml(ae.substring(0,18))}</span>`:m.status==="success"?q=`<span class="log-doc log-doc-missing" title="${escapeHtml(t("erp-log-doc-missing-tip"))}">${escapeHtml(t("erp-log-doc-missing"))}</span>`:q='<span class="log-doc log-doc-empty">-</span>',`
        ...
        `,document.body.appendChild(m);const v=()=>m.remove();m.querySelector("#cpw-forgot-close").addEventListener("click",v),m.querySelector("#cpw-forgot-cancel").addEventListener("click",v),m.addEventListener("click",w=>{w.target===m&&v()}),m.querySelector("#cpw-forgot-send").addEventListener("click",async()=>{const w=m.querySelector("#cpw-forgot-send"),b=m.querySelector("#cpw-forgot-msg");w.disabled=!0;const g=w.textContent;w.textContent=a("cpw-forgot-sending");try{const h=await fetch("/api/auth/forgot_password",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:l})}),_=await h.json().catch(()=>({}));h.ok?(b.textContent=a("cpw-forgot-success"),b.className="cpw-forgot-msg success",w.style.display="none",m.querySelector("#cpw-forgot-cancel").textContent=a("cpw-forgot-close-btn")):(b.textContent=_.detail||a("cpw-forgot-fail"),b.className="cpw-forgot-msg error",w.disabled=!1,w.textContent=g)}catch{b.textContent=a("cpw-forgot-fail"),b.className="cpw-forgot-msg error",w.disabled=!1,w.textContent=g}})}function f(u){if(!u||!u.includes("@"))return u||"";const[l,p]=u.split("@");return l.length<=2?l+"****@"+p:l.slice(0,2)+"****@"+p}function d(u){return u==null?"":String(u).replace(/[&<>"']/g,l=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[l])}document.readyState==="complete"||document.readyState==="interactive"?r():document.addEventListener("DOMContentLoaded",r)})();(function(){let e=null,n=!1;async function a(){if(n)return;const s=localStorage.getItem("mrpilot_token");if(s){n=!0;try{const i=await fetch("/api/me",{headers:{Authorization:"Bearer "+s},cache:"no-store"});if(i.status===401){const r=await i.json().catch(()=>({})),c=r&&r.detail;let f="";if(typeof c=="string"?f=c:c&&typeof c=="object"&&(f=c.code||""),console.warn("[heartbeat] session revoked",f),localStorage.removeItem("mrpilot_token"),e&&(clearInterval(e),e=null),f==="auth.session_revoked")try{_showSessionRevokedModal()}catch{window.location.href="/"}else{const d=f==="auth.password_changed_relogin"?"alert-password-changed-relogin":"alert-session";try{typeof showToast=="function"&&typeof t=="function"?showToast(t(d),"error"):alert("Session expired")}catch{}setTimeout(()=>{window.location.href="/"},1500)}}}catch{}finally{n=!1}}}function o(){e&&clearInterval(e),e=setInterval(a,15e3)}localStorage.getItem("mrpilot_token")&&o(),window.addEventListener("focus",a),document.addEventListener("visibilitychange",function(){document.hidden||a()}),window._sessionCheck=a})();async function _n(){const e=document.getElementById("team-loading"),n=document.getElementById("team-list"),a=document.getElementById("team-empty"),o=document.getElementById("team-count");if(n){e&&(e.style.display=""),n.style.display="none",a&&(a.style.display="none");try{const s=await apiGet("/api/team/employees"),i=s&&s.employees||[];if(e&&(e.style.display="none"),o&&(o.textContent=(t("team-count")||"共 {n} 名员工").replace("{n}",i.length)),i.length===0){a&&(a.style.display="");return}n.style.display="",n.innerHTML=i.map(r=>{const c=r.last_login_at?new Date(r.last_login_at).toLocaleDateString():t("team-never-login")||"从未登录",f=r.is_active===!1?"team-status-off":"team-status-on",d=r.is_active===!1?t("team-status-disabled")||"已禁用":t("team-status-active")||"正常",u=r.email?`<span class="team-meta-sep">·</span><span>${escapeHtml(r.email)}</span>`:"";return`
            ...
            </div>`}).join("")}catch(s){console.error("loadTeamList failed:",s),e&&(e.textContent=t("team-load-failed")||"加载失败")}}}async function Uc(){document.querySelectorAll(".add-emp-overlay").forEach(o=>o.remove());const e=document.createElement("div");e.className="add-emp-overlay",e.innerHTML=`
