...
> **当前数字(master 全绿·工作树干净)**:home.js **6191**(-2750)· app.py **4528**(删死函数 _check_user_quota -312)· auth_signup.py **2380**(计费迁移 -337)· db.py 3371 · home.css 0 · home.html **6428** · src/home 模块 **35** 个 · 单测 **1516** · E2E **10**。`gh.exe` 路径 `C:\Program Files\GitHub CLI\gh.exe` · repo `skin306152-star/pearnly-app`。
