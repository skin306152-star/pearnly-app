// ============================================================
// REFACTOR-WB-C3 (2026-05-30) · 智能提醒「新建规则」弹窗 inner 从 home.html 抽出 · 运行期注入
//
// home.html 留空壳 <div id="notif-new-modal">(overlay · display:none)· 本模块 eval 时注入 .modal inner。
// notifications.js(main.js 内 import 在本模块之后)_bindOnce 在 eval 期绑 notif-new-close/cancel/save/template ·
// 故本模块 import 必须置 notifications.js 前(确定性 · 非竞态)· home.js 0 处引用 notif-new-*(已核)。
// i18n:注入后子树补译(镜像 applyLang)· 切语言由 applyLang 全文扫描覆盖。verbatim inner · 0 改结构。
// ============================================================
(function () {
    'use strict';
    const m = document.getElementById('notif-new-modal');
