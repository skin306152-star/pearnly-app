...
LINE_I18N = {
    "zh": {
        ...
        "exp_card_doc_type": "单据类型",
        "exp_card_inv_no": "发票号",
        "exp_card_exp_type": "支出类型",
        "exp_card_date": "日期",
        "exp_card_category": "分类",
        "exp_card_subcategory": "子分类",
        "exp_card_business": "业务主体",
        "exp_card_detail": "明细",
        "exp_card_vendor": "卖家",
        ...
        "exp_recorded_purchase": "✅ 已记入采购 · ฿{amount}\n到 pearnly.com「采购 · 待归类」查看或补全 🧾",
        "exp_query_month": "本月已确认支出合计:฿{amount}",
        "exp_dup_warn": "⚠️ 这张票可能已经记过 · 请核对后再确认",
        "exp_q_not_found": "知识库里没找到相关内容 · 完整问答见 pearnly.com 知识中心",
        "exp_q_source": "来源:{src}",
        "exp_scope_block": "我帮你记账和查账 · 试试发「ค่าน้ำ 50」记一笔,或问「本月花了多少」",
        "qr_record": "记一笔",
        "qr_query": "本月花多少",
    ...
    "en": {
        ...
        "exp_card_doc_type": "Document type",
        "exp_card_inv_no": "Invoice no.",
        "exp_card_exp_type": "Expense type",
        "exp_card_date": "Date",
        "exp_card_category": "Category",
        "exp_card_subcategory": "Subcategory",
        "exp_card_business": "Business",
        "exp_card_detail": "Detail",
        ...
        "exp_recorded_purchase": "✅ Recorded to Purchases · ฿{amount}\nReview/complete at pearnly.com Purchases 🧾",
        "exp_query_month": "Confirmed spending this month: ฿{amount}",
        "exp_dup_warn": "⚠️ This may already be recorded · please check before confirming",
        "exp_q_not_found": "Nothing found in your knowledge base · full Q&A at pearnly.com",
        "exp_q_source": "Source: {src}",
        "exp_scope_block": "I help you record and check expenses · try 'Water 50' or ask 'how much this month'",
        "qr_record": "Record",
        "qr_query": "This month",
    ...
    "th": {
        ...
        "exp_card_doc_type": "ประเภทเอกสาร",
        "exp_card_inv_no": "เลขที่ใบกำกับภาษี",
        "exp_card_exp_type": "ประเภทค่าใช้จ่าย",
        "exp_card_date": "วันที่",
        "exp_card_category": "หมวดหมู่",
        "exp_card_subcategory": "หมวดหมู่ย่อย",
        "exp_card_business": "ธุรกิจ",
        "exp_card_detail": "รายละเอียด",
        "exp_card_vendor": "ผู้ขาย/ร้านค้า",
        ...
        "exp_recorded_purchase": "✅ บันทึกเข้าจัดซื้อแล้ว · ฿{amount}\nตรวจ/เติมข้อมูลที่ pearnly.com เมนูจัดซื้อ 🧾",
        "exp_query_month": "ค่าใช้จ่ายที่ยืนยันเดือนนี้รวม: ฿{amount}",
        "exp_dup_warn": "⚠️ รายการนี้อาจบันทึกไปแล้ว · กรุณาตรวจสอบก่อนยืนยัน",
        "exp_q_not_found": "ไม่พบข้อมูลในคลังความรู้ · ดูถาม-ตอบเต็มที่ pearnly.com",
        "exp_q_source": "ที่มา: {src}",
        "exp_scope_block": "ผมช่วยบันทึกและดูค่าใช้จ่าย · ลองพิมพ์ 'ค่าน้ำ 50' หรือถาม 'เดือนนี้จ่ายไปเท่าไหร่'",
    ...
    "ja": {
        ...
        "exp_card_doc_type": "書類種別",
        "exp_card_inv_no": "請求書番号",
        "exp_card_exp_type": "費用種別",
        "exp_card_date": "日付",
        "exp_card_category": "分類",
        "exp_card_subcategory": "サブ分類",
        "exp_card_business": "事業者",
        "exp_card_detail": "明細",
        "exp_card_vendor": "取引先",
        "exp_card_confirm": "確認",
        ...
        "exp_recorded_purchase": "✅ 仕入に記録しました · ฿{amount}\npearnly.com の仕入で確認・補完 🧾",
        "exp_query_month": "今月の確定済み支出合計:฿{amount}",
        "exp_dup_warn": "⚠️ この伝票は既に記録済みかもしれません · 確認してから確定してください",
        "exp_q_not_found": "ナレッジに該当が見つかりません · 完全な Q&A は pearnly.com で",
        "exp_q_source": "出典:{src}",
        "exp_scope_block": "経費の記録と照会をお手伝いします · 「水道 50」や「今月いくら使った」をお試しください",
        "qr_record": "記録する",
        "qr_query": "今月いくら",
