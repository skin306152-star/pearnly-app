// ============================================================
// REFACTOR-WB-C1 (2026-05-30) · 自动化页壳 HTML(下半)· 从 page-automation.js 抽出为数据模块
// 纯静态 HTML 模板数据(0 逻辑 / 0 状态)· 邮箱抓取 + 文件夹监听 + LINE Bot + 智能提醒 panel + 收尾。
// ============================================================
export const AUTO_HTML_2 = `                    <!-- Tab: 邮箱抓取 (v0.17 · M6 · v93 在 Vultr 复活) -->
