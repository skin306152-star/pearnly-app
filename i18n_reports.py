...
REPORTS_I18N = {
    # ===== 模板名(4 个) =====
    "tpl-input-vat":         {"zh": "进项税明细 (ภ.พ.30)", "th": "ภาษีซื้อ (ภ.พ.30)",        "en": "Input VAT (P.P.30)",     "ja": "仕入VAT明細 (ภ.พ.30)"},
    "tpl-standard":          {"zh": "标准明细",            "th": "รายการมาตรฐาน",            "en": "Standard Detail",        "ja": "標準明細"},
    "tpl-erp":               {"zh": "ERP 录入格式",         "th": "รูปแบบนำเข้า ERP",          "en": "ERP Import Format",       "ja": "ERPインポート形式"},
    "tpl-print":             {"zh": "凭证装订清单",         "th": "ใบรายการสำหรับเย็บเล่ม",     "en": "Voucher Binding List",    "ja": "証憑綴じ込み一覧"},

    # ===== 模板描述 =====
    "tpl-input-vat-desc":    {"zh": "法定报税格式 · 直接交给 RD 税务局",              "th": "รูปแบบยื่นภาษีตามกฎหมาย · ส่งกรมสรรพากรได้ทันที", "en": "Legal tax filing format · Submit directly to RD",  "ja": "法定申告様式 · RDへ直接提出可"},
    "tpl-standard-desc":     {"zh": "全字段明细 · 给老板汇报 / 内部审核",             "th": "รายละเอียดครบ · รายงานเจ้านาย / ตรวจสอบภายใน",     "en": "Full detail · Report to manager / Internal audit",  "ja": "全項目明細 · 経営報告・内部監査向け"},
    "tpl-erp-desc":          {"zh": "ASCII 列名 + ISO 日期 · 复制到 Mr.ERP / Express",  "th": "ชื่อคอลัมน์ ASCII + วันที่ ISO · นำเข้า Mr.ERP / Express", "en": "ASCII columns + ISO dates · Paste into Mr.ERP / Express", "ja": "ASCII列名+ISO日付 · Mr.ERP/Express貼付"},
    "tpl-print-desc":        {"zh": "A4 横版 · 行高大 · 适合打印装订",                "th": "A4 แนวนอน · บรรทัดสูง · เหมาะสำหรับพิมพ์เย็บเล่ม", "en": "A4 landscape · Tall rows · Print-binding optimized", "ja": "A4横 · 行高大 · 印刷綴じ最適化"},

    # ===== 模板分类 =====
    "tpl-cat-tax":           {"zh": "税务申报",   "th": "ยื่นภาษี",          "en": "Tax Filing",      "ja": "税務申告"},
    "tpl-cat-internal":      {"zh": "内部使用",   "th": "ใช้ภายใน",          "en": "Internal Use",    "ja": "内部利用"},
    "tpl-cat-erp":           {"zh": "ERP 集成",   "th": "เชื่อมต่อ ERP",      "en": "ERP Integration", "ja": "ERP連携"},
    "tpl-cat-print":         {"zh": "打印输出",   "th": "พิมพ์เอกสาร",        "en": "Print Output",    "ja": "印刷出力"},

    # ===== 通用列头 =====
    "col-no":                {"zh": "序号",       "th": "ลำดับ",             "en": "No.",            "ja": "番号"},
    "col-invoice-date":      {"zh": "日期",       "th": "วันที่",             "en": "Date",            "ja": "日付"},
    "col-invoice-no":        {"zh": "发票号",     "th": "เลขที่ใบกำกับ",      "en": "Invoice No.",     "ja": "請求書番号"},
    "col-seller-name":       {"zh": "卖方名称",   "th": "ชื่อผู้ขาย",          "en": "Seller Name",     "ja": "売主名称"},
    "col-seller-tax-id":     {"zh": "卖方税号",   "th": "เลขประจำตัวผู้เสียภาษี", "en": "Seller Tax ID",  "ja": "売主税番号"},
    "col-seller-branch":     {"zh": "卖方分公司", "th": "สาขาผู้ขาย",         "en": "Seller Branch",   "ja": "売主支店"},
    "col-seller-addr":       {"zh": "卖方地址",   "th": "ที่อยู่ผู้ขาย",       "en": "Seller Address",  "ja": "売主住所"},
    "col-buyer-name":        {"zh": "买方名称",   "th": "ชื่อผู้ซื้อ",         "en": "Buyer Name",      "ja": "買主名称"},
    "col-buyer-tax-id":      {"zh": "买方税号",   "th": "เลขผู้เสียภาษีผู้ซื้อ","en": "Buyer Tax ID",   "ja": "買主税番号"},
    "col-buyer-addr":        {"zh": "买方地址",   "th": "ที่อยู่ผู้ซื้อ",       "en": "Buyer Address",   "ja": "買主住所"},
    "col-amount-before-vat": {"zh": "未税金额",   "th": "ยอดก่อน VAT",        "en": "Subtotal",        "ja": "税抜金額"},
    "col-vat-amount":        {"zh": "VAT 7%",     "th": "ภาษี 7%",           "en": "VAT 7%",          "ja": "VAT 7%"},
    "col-wht-rate":          {"zh": "预扣税率",   "th": "อัตราหัก ณ ที่จ่าย",  "en": "WHT %",           "ja": "源泉%"},
    "col-wht-amount":        {"zh": "预扣税额",   "th": "ภาษีหัก ณ ที่จ่าย",   "en": "WHT Amount",      "ja": "源泉額"},
    ...
    "info-doc-count":        {"zh": "共 {n} 张",  "th": "รวม {n} ฉบับ",        "en": "Total: {n} docs", "ja": "計 {n} 件"},
    "info-generated-at":     {"zh": "生成时间",   "th": "สร้างเมื่อ",           "en": "Generated at",    "ja": "作成日時"},
    "info-generated-by":     {"zh": "由 Mr.Pilot 生成", "th": "สร้างโดย Mr.Pilot", "en": "Generated by Mr.Pilot", "ja": "Mr.Pilotで作成"},
    ...
    "report-grand-total":    {"zh": "总合计",     "th": "ยอดรวมทั้งสิ้น",       "en": "Grand Total",     "ja": "総合計"},
    "report-subtotal":       {"zh": "小计",       "th": "ยอดย่อย",            "en": "Subtotal",        "ja": "小計"},

    # ===== 第二 Sheet · 汇总分析 =====
    "summary-sheet-name":    {"zh": "汇总分析",   "th": "สรุป",                "en": "Summary",         "ja": "集計分析"},
    "summary-by-seller":     {"zh": "按卖方汇总 (TOP 10)", "th": "สรุปตามผู้ขาย (TOP 10)", "en": "By Seller (TOP 10)", "ja": "売主別 (TOP 10)"},
    "summary-by-category":   {"zh": "按类目汇总", "th": "สรุปตามหมวดหมู่",      "en": "By Category",     "ja": "カテゴリ別"},
    "summary-by-source":     {"zh": "按来源汇总", "th": "สรุปตามแหล่งที่มา",    "en": "By Source",       "ja": "ソース別"},
    ...
    # ===== 默认占位 =====
    "client-default":        {"zh": "全部客户",   "th": "ลูกค้าทั้งหมด",        "en": "All Clients",     "ja": "全顧客"},
...
def _self_check():
    ...
    if missing:
        import sys
        print(f"[i18n_reports] MISSING TRANSLATIONS: {missing[:5]}... total={len(missing)}", file=sys.stderr)
