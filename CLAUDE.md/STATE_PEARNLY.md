...
## 🎯 状态卡(2026-06-01 · **整顿主线恢复**:C3 拆 home.html 1730→**1635**(抽 page-history `4d3b9e0`·prod E2E 绿)· DMS 第2轮 R5/R7+隐藏地址已修上线 `0d1c380`·交 Codex 第3轮自测)

- **模式**:整顿封锁期 · **整顿主线恢复**(Zihao 2026-06-01 拍板:DMS 交 Codex 自测,我回归整顿按计划走)。**当前 task:C3 拆 home.html(1730→<1000·还差 ~635)**。整顿剩余仅两项代码规模未达标:① **home.html 1635→1000**(C3·可自主推进)② **app.py 1731→500**(B1 安全面已到顶·剩 22 个全是登录/OAuth/JWT/OCR 高敏 @app·需 auth 专窗口 + Zihao 在场·单窗口跑不了)。db.py 344 / home.js 0 / home.css 0 均已达标。
- **C3 进度(WB-C3-R13)**:home.html 1730→**1635**(-95)· 抽 `#page-history`(96 行)→ `src/home/page-history.js` 运行期注入(R6 范式·import 置 history-list.js 前)· 注入 HTML 与原 innerHTML 字节等价(5935 chars)· prod E2E 01-login/04-history 绿 · CRLF 保真。**下个 C3 候选**(由易到难):onboarding-modal(~140·welcome-wizard 已暂下架·查是否可删)/ page-ocr(~150·识别主页·高耦合谨慎)/ bank-cand-drawer(~24)。
