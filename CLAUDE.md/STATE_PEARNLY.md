...
- **模块/测试**:src/home **38**(+line-email-modal/change-password/session-heartbeat WB) · *_routes **36** · services **104**(+playwright_bootstrap +background_loops +static_assets WA)· unit **1656** · integration **45**(+signup 注册 +VAT excel 销项税 +bank-recon 收入对账契约 WC-D3)· E2E **17** · home.js silent **0**。
