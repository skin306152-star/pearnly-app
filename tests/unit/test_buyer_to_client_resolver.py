...
class EmptyInputTests(unittest.TestCase):
    ...
    def test_empty_string_returns_none(self):
        cur = _LayeredCursor([])
        with (
            patch.object(db, "get_cursor", lambda *a, **k: _CursorCM(cur)),
            patch.object(db, "get_cursor_rls", lambda *a, **k: _CursorCM(cur)),
        ):
...
class DbExceptionTests(unittest.TestCase):
    ...
    def test_db_exception_returns_none(self):
        ...
        with (
            patch.object(db, "get_cursor", lambda *a, **k: _CursorCM(_ExplodingCursor())),
            patch.object(db, "get_cursor_rls", lambda *a, **k: _CursorCM(_ExplodingCursor())),
        ):
