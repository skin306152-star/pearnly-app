...
(function () {
    ...
    function freshState(financials, fault) {
        return {
            financials: financials,
            // 报表包没产出时分「还没跑到」/「引擎停住了」/「这步跑挂了」三种 null
            // (''|'stalled'|'degraded',见 clientWoRender.sectionFault)。
            fault: fault || '',
    ...
    function mount(financials, container, fault) {
        S = freshState(financials, fault);
