...
`,e.dataset.wbInjected="1";try{const n=window._currentLang||localStorage.getItem("mrpilot_lang")||"th",a=window.I18N;a&&a[n]&&e.querySelectorAll("[data-i18n]").forEach(o=>{const s=o.getAttribute("data-i18n");a[n][s]&&(o.textContent=a[n][s])})}catch{}}})();function mn(e,n){const a=document.getElementById("alert-"+e);a&&(document.getElementById("alert-"+e+"-text").textContent=n,a.classList.add("show"))}function vn(){["info","warn","error"].forEach(e=>{document.getElementById("alert-"+e).classList.remove("show")})}function hn(e,n){if(e==null)return n||"操作失败";if(typeof e=="string")return e;if(Array.isArray(e)){const a=e[0]||{};return a.msg?a.msg:n||"请求格式错误"}if(typeof e=="object"){if(e.code){const a="err."+e.code;try{const o=t(a,e);if(o&&o!==a)return o}catch(o){console.warn("[i18n] t() failed for key:",a,o)}return e.code}if(e.message)return e.message;if(e.error)return e.error;if(e.detail&&typeof e.detail=="string")return e.detail;try{return JSON.stringify(e).slice(0,160)}catch{}}return n||String(e)}function gn(e){if(!e)return"";const n=String(e);return/ECONNREFUSED|Connection refused/i.test(n)?"连接被拒绝 · ERP 地址可能错了,或服务没启动":/listing fetch failed|wait_for_selector/i.test(n)?"拉取 MR.ERP 客户/商品列表超时 · 已重试 3 次仍不通 · 可能 MR.ERP 响应慢 · 稍后再试":/ETIMEDOUT|timeout/i.test(n)?"连接超时 · MR.ERP 响应慢 · 稍后再试":/ENOTFOUND|getaddrinfo/i.test(n)?"域名解析失败 · ERP 地址拼错了":/certificate|SSL/i.test(n)?"SSL 证书问题 · ERP 站点证书异常":/401|Unauthorized/i.test(n)?"HTTP 401 · 认证失败,检查 Token 是否正确":/403|Forbidden/i.test(n)?"HTTP 403 · 权限不足,ERP 拒绝访问":/404|Not Found/i.test(n)?"HTTP 404 · URL 路径不存在":/^5\d\d/.test(n)||/500|502|503|504/.test(n)?"ERP 服务器错误 · 不是你的问题,等会儿再试":n}function bn(e,n,a){let o=document.getElementById("mp-toast-wrap");o||(o=document.createElement("div"),o.id="mp-toast-wrap",document.body.appendChild(o)),n=n||"success",n==="ok"&&(n="success"),n==="warning"&&(n="warn"),n==="danger"&&(n="error");const s={success:'<path d="M3 8l3 3 7-7"/>',error:'<circle cx="8" cy="8" r="6"/><path d="M5.5 5.5l5 5M10.5 5.5l-5 5"/>',warn:'<path d="M8 2L1.5 13h13L8 2z"/><path d="M8 7v3M8 12v.01"/>',info:'<circle cx="8" cy="8" r="6"/><path d="M8 5.5v.01M8 8v3"/>',loading:'<path d="M8 1a7 7 0 017 7" stroke-linecap="round" class="mp-toast-spin"/>'},c=document.createElement("div");c.className="mp-toast "+n,c.innerHTML=`
    ...
    `,e.style.display="flex";const i=e.querySelector(".quota-banner-close");i&&i.addEventListener("click",()=>{localStorage.setItem(c,"1"),e.style.display="none"})}function Cn(){const e=_userInfo;if(!e)return;const n=shouldHideMoney(e),a=canManageTeam(e),o=canManageApiKey(e),s=document.querySelector('.nav-item[data-route="templates"]');s&&(s.classList.remove("locked-for-plan"),s.removeAttribute("data-locked-target"));const c=document.querySelector('.nav-item[data-route="api-keys"]');c&&(c.classList.remove("locked-for-plan"),c.removeAttribute("data-locked-target"));const r=document.getElementById("btn-custom-template");r&&(r.style.display="",r.classList.remove("locked-for-plan"));const f=document.querySelector('.settings-tab[data-tab="team"]');f&&(f.style.display=a?"":"none");const i=document.querySelector('.settings-panel[data-settings-panel="team"]');i&&(i.dataset.permHidden=a?"0":"1");const d=document.querySelector('.settings-tab[data-tab="api"]');d&&(d.style.display=o||isSuperAdmin(e)?"":"none");const l=document.querySelector('.settings-tab[data-tab="plan"]');l&&(l.style.display=n?"none":"");const p=document.querySelector('.settings-tab[data-tab="company"]');p&&(p.style.display=n?"none":"");const u=document.getElementById("info-bar");u&&(u.style.display=n?"none":"");const g=document.getElementById("trial-banner");g&&n&&(g.style.display="none");const w=document.getElementById("plan-banner");w&&n&&(w.style.display="none",document.body.classList.remove("has-plan-banner")),document.querySelectorAll("[data-upgrade-cta], .btn-upgrade, .topbar-upgrade").forEach($=>{$.style.display="none"}),document.body.classList.toggle("role-employee",isEmployee(e)),document.body.classList.toggle("role-owner",isOwner(e)),document.body.classList.toggle("role-super",isSuperAdmin(e));try{const $=document.querySelector(".settings-tab.active");$&&$.style.display==="none"&&(typeof window.switchSettingsTab=="function"?window.switchSettingsTab("profile"):typeof switchSettingsTab=="function"&&switchSettingsTab("profile"))}catch($){console.warn("[v118.12.3] failed to fix active tab:",$)}if(window.PEARNLY_ADMIN_MODE){const $=document.getElementById("admin-mode-banner");$&&($.style.display="flex"),document.querySelectorAll(".nav-item").forEach(B=>{B.classList.contains("nav-admin-only")||(B.style.display="none")}),document.querySelectorAll(".nav-group").forEach(B=>{B.classList.contains("nav-group-admin-only")||(B.style.display="none")});const E=document.getElementById("client-switcher");E&&(E.style.display="none"),document.body.classList.add("admin-mode");const _=["profile","security","notifications","about"];document.querySelectorAll(".settings-tab").forEach(B=>{const q=B.dataset.tab;q&&!_.includes(q)&&(B.style.display="none")}),document.querySelectorAll(".settings-pane").forEach(B=>{const q=B.dataset.pane;q&&!_.includes(q)&&(B.style.display="none")}),document.querySelectorAll(".settings-nav-group").forEach(B=>{const q=B.querySelectorAll(".settings-tab");Array.from(q).some(F=>F.style.display!=="none")||(B.style.display="none")})}}function Sn(){const e=_userInfo,n=document.getElementById("info-bar");if(!e||shouldHideMoney(e)){n&&(n.innerHTML="");return}let a="";const o=e.tenant_type;if(o==="byo_api")e.has_own_gemini_key?a=`
        ...
        `}i.classList.add("show");const d=()=>i.classList.remove("show");i.querySelector(".rd-modal-close").addEventListener("click",d),i.querySelectorAll("[data-rd-modal-close]").forEach(p=>p.addEventListener("click",d)),i.addEventListener("click",p=>{p.target===i&&d()});const l=i.querySelector("[data-rd-modal-apply]");l&&l.addEventListener("click",()=>{const p=_results[_drawerIdx];if(!p){d();return}i.querySelectorAll("[data-rd-apply]:checked").forEach(u=>{const g=u.dataset.field,w=u.dataset.value;p.edits[g]=w,p.merged_fields[g]=w;const $=document.querySelector(`[data-field="${g}"]`);$&&($.value=w);const E=document.querySelector(`[data-field-wrap="${g}"]`);E&&E.classList.add("edited")}),updateDrawerEditCount(),renderResults(),d()})}window.callRdVerify=Tn;window.callRdSync=$n;function Hn(e){const n={invoice_number:null,date:null,total_amount:null,tax_ids:[],seller_name:"",seller_tax:"",seller_addr:"",buyer_name:"",buyer_tax:"",buyer_addr:"",subtotal:"",vat:"",notes:"",items:[]},a=e.filter(s=>!s.is_duplicate&&!s.is_copy),o=a.length>0?a:e;for(const s of o){const c=s.fields||{};!n.invoice_number&&c.invoice_number&&(n.invoice_number=c.invoice_number),!n.date&&c.date&&(n.date=c.date),!n.total_amount&&c.total_amount&&(n.total_amount=c.total_amount),!n.subtotal&&c.subtotal&&(n.subtotal=c.subtotal),!n.vat&&c.vat&&(n.vat=c.vat),!n.seller_name&&c.seller_name&&(n.seller_name=c.seller_name),!n.seller_tax&&c.seller_tax&&(n.seller_tax=c.seller_tax),!n.seller_addr&&c.seller_addr&&(n.seller_addr=c.seller_addr),!n.buyer_name&&c.buyer_name&&(n.buyer_name=c.buyer_name),!n.buyer_tax&&c.buyer_tax&&(n.buyer_tax=c.buyer_tax),!n.buyer_addr&&c.buyer_addr&&(n.buyer_addr=c.buyer_addr),!n.notes&&c.notes&&(n.notes=c.notes),Array.isArray(c.items)&&c.items.length&&n.items.push(...c.items),Array.isArray(c.tax_ids)&&n.tax_ids.push(...c.tax_ids)}return n.tax_ids=[...new Set(n.tax_ids)],!n.seller_tax&&n.tax_ids[0]&&(n.seller_tax=n.tax_ids[0]),!n.buyer_tax&&n.tax_ids[1]&&(n.buyer_tax=n.tax_ids[1]),n}function An(e){const n=e.target.dataset.field,a=e.target.value,o=_results[_drawerIdx],s=o.merged_fields[n];a===(s??"")?delete o.edits[n]:(o.edits[n]=a,o.merged_fields[n]=a);const c=document.querySelector(`[data-field-wrap="${n}"]`);c&&c.classList.toggle("edited",o.edits[n]!==void 0),Ht(),renderResults()}function Ht(){const e=_results[_drawerIdx],n=e?Object.keys(e.edits).length:0,a=document.getElementById("drawer-edit-count-sub");a&&(a.textContent=n>0?t("drawer-edit-count",{n}):"")}window.mergeFields=Hn;window.onFieldEdit=An;window.updateDrawerEditCount=Ht;function Xe(){const e=document.getElementById("results-card");if(_results.length===0){e.classList.remove("show");return}e.classList.add("show");let n=0;_results.forEach(r=>{const f=parseFloat(r.merged_fields.total_amount);isNaN(f)||(n+=f)}),_selectedFiles&&_selectedFiles.length||_results.length;const a=_results.length,o=n.toLocaleString(void 0,{minimumFractionDigits:2,maximumFractionDigits:2});document.getElementById("results-head-stats").innerHTML=`
        <div class="rh-stat">
    ...
    `;let s=_results.map((r,f)=>({...r,_idx:f}));if(_searchKeyword){const r=_searchKeyword.toLowerCase();s=s.filter(f=>(f.filename||"").toLowerCase().includes(r)||(f.merged_fields.invoice_number||"").toLowerCase().includes(r))}_sortKey&&s.sort((r,f)=>{let i,d;return _sortKey==="filename"?(i=r.filename,d=f.filename):_sortKey==="invoice_no"?(i=r.merged_fields.invoice_number,d=f.merged_fields.invoice_number):_sortKey==="invoice_date"?(i=r.merged_fields.date,d=f.merged_fields.date):_sortKey==="total"?(i=parseFloat(r.merged_fields.total_amount)||0,d=parseFloat(f.merged_fields.total_amount)||0):_sortKey==="confidence"?(i=r.confidence,d=f.confidence):(i="",d=""),i<d?_sortDir==="asc"?-1:1:i>d?_sortDir==="asc"?1:-1:0});const c=document.getElementById("results-tbody");c.innerHTML=s.map((r,f)=>{const i=r.merged_fields,d=`<span class="empty-cell">${t("empty-val")}</span>`,l="conf-tip-"+(r.confidence||"low"),p="conf-"+(r.confidence||"low"),u=t(l),g=t(p);return`
            <tr data-idx="${r._idx}">
                <td class="num">${f+1}</td>
    ...
    `,updateDrawerEditCount();const s=_userInfo&&_userInfo.can_edit_fields,c=_userInfo&&_userInfo.can_verify_tax,r=n.merged_fields,f=document.getElementById("drawer-body"),i=s?"":`
    ...
    `,d=c?"":`<span class="tax-badge unverified" data-tip="${escapeHtml(t("tax-tip-unverified"))}">${t("tax-unverified")}</span>`;if(f.innerHTML=`
        ${i}
        ...
        <div class="drawer-section">
            ...
            ${r.wht_amount||r.wht_rate?`
                ${ye("wht_amount","drawer-lbl-wht-amount",r.wht_amount,"input",s,jn(r.wht_rate))}
            `:""}
        </div>
        ...
        <div class="drawer-section">
            ...
            ${r.items&&r.items.length>0?Pn(r.items):`<div class="drawer-items-empty">${t("drawer-items-empty")}</div>`}
        </div>
...
`))}</pre>
    ...
    `,s?f.querySelectorAll("[data-field]").forEach(l=>{l.addEventListener("input",onFieldEdit)}):f.querySelectorAll("[data-field]").forEach(l=>{l.setAttribute("readonly","readonly")}),document.getElementById("drawer-mask").classList.add("show"),document.getElementById("drawer").classList.add("show"),injectOcrPushButton(),typeof window.bindDrawerClient=="function"){const l=n._historyId||n.history_id||null;window.bindDrawerClient(l,n.client_id||null)}typeof window.fillCategoryDatalist=="function"&&window.fillCategoryDatalist(),setTimeout(()=>{const l=document.getElementById("drawer-cat-input");l&&!l.value&&!l.readOnly&&l.focus()},80)}function jn(e){return e?`<span class="wht-badge">${escapeHtml(e)}%</span>`:""}function ye(e,n,a,o,s,c,r){const f=_results[_drawerIdx],i=f&&f.edits[e]!==void 0?f.edits[e]:a,d=f&&f.edits[e]!==void 0&&f.edits[e]!==a,l=escapeHtml(i??""),p=s?"":"readonly",u=o==="textarea"?`<textarea data-field="${e}" rows="2">${l}</textarea>`:`<input type="text" data-field="${e}" value="${l}">`;return`
    ...
    `:`<button class="rd-btn-locked" data-upgrade="plus" type="button" title="${escapeHtml(t("rd-tip-upgrade"))}">
        ...
        `).join("")}
    `}function Dn(){document.getElementById("drawer-mask").classList.remove("show"),document.getElementById("drawer").classList.remove("show");const e=document.getElementById("drawer-history-save");e&&e.remove();const n=document.getElementById("drawer-ocr-push");n&&n.remove();const a=document.getElementById("drawer-ocr-push-btn");a&&a.remove(),_drawerIdx=-1}window.renderResults=Xe;window.openDrawer=jt;window.closeDrawer=Dn;function qn(){const e=_results[_drawerIdx];if(!e||e._historyMode||!_userInfo||!_userInfo.can_push_erp||!e._historyId&&!e.history_id)return;const n=e._historyId||e.history_id,a=document.querySelector(".drawer-header");if(!a||document.getElementById("drawer-ocr-push-btn"))return;const o=(window._erpEndpoints||_erpEndpoints||[]).filter(function(f){return f&&f.enabled!==!1});if(o.length===0)return;const s=document.createElement("button");s.id="drawer-ocr-push-btn",s.className="drawer-push-btn";let c;if(o.length===1){const f=o[0].name||o[0].adapter||"ERP";c=t("btn-push-to-name",{name:f}),s.title=c}else c=t("btn-push-erp")+" ▾",s.title=t("btn-push-erp-pick-tip");s.innerHTML=`
        <svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
            <path d="M2 8h9M8 5l3 3-3 3"/>
            <rect x="11" y="3" width="3" height="10" rx="1"/>
        </svg>
        <span>${escapeHtml(c)}</span>
    `,s.addEventListener("click",function(f){f.preventDefault(),f.stopPropagation(),o.length===1?Pt(n,o[0].id):Rn(s,n,o)});const r=a.querySelector(".drawer-diagnose");r?a.insertBefore(s,r):a.appendChild(s)}function Rn(e,n,a){document.querySelectorAll(".drawer-push-picker").forEach(i=>i.remove());const o=e.getBoundingClientRect(),s=document.createElement("div");s.className="drawer-push-picker history-popover",s.style.position="fixed",s.style.top=o.bottom+6+"px",s.style.left=Math.max(8,o.right-240)+"px",s.style.minWidth="220px",s.style.zIndex="12000";const c=a.map(function(i){const d=escapeHtml(i.name||i.adapter||"ERP"),l=escapeHtml((i.adapter||"").toLowerCase()),u=i.is_default?'<span style="font-size:10px;color:#0a7a2c;background:#d6f5e0;padding:1px 6px;border-radius:999px;margin-left:6px;">'+escapeHtml(t("ep-default"))+"</span>":"";return'<button type="button" data-ep-id="'+escapeHtml(i.id)+'" style="display:flex;align-items:center;justify-content:space-between;width:100%;text-align:left;"><span><span style="color:#5d5d57;font-size:11px;margin-right:6px;">'+l+"</span>"+d+u+"</span></button>"}).join("");s.innerHTML=c,document.body.appendChild(s);const r=()=>{s.remove(),document.removeEventListener("click",f,!0)},f=i=>{!s.contains(i.target)&&i.target!==e&&!e.contains(i.target)&&r()};setTimeout(()=>document.addEventListener("click",f,!0),0),s.addEventListener("click",i=>{const d=i.target.closest("[data-ep-id]");if(!d)return;const l=d.getAttribute("data-ep-id");r(),Pt(n,l)})}async function Pt(e,n){const a=document.getElementById("drawer-ocr-push-btn");a&&(a.disabled=!0);try{const o={history_id:e};n&&(o.endpoint_id=n);const s=await fetch("/api/erp/push",{method:"POST",headers:{Authorization:"Bearer "+token,"Content-Type":"application/json"},body:JSON.stringify(o)}),c=await s.json();if(!s.ok){const r=c&&c.detail?c.detail:"err.unknown";r==="erp.no_default_endpoint"?showToast(t("erp-push-no-endpoint"),"warn"):r==="erp.endpoint_disabled"?(showToast(t("erp-push-disabled-tip")||t("card-disabled-tip")||"Endpoint disabled","warn"),typeof window._refreshErpEndpointsCache=="function"&&window._refreshErpEndpointsCache()):showToast(t("erp-push-fail",{err:r}),"fail");return}c.ok?showToast(t("erp-push-ok",{name:c.endpoint_name||""})):showToast(t("erp-push-fail",{err:c.error_msg||"unknown"}),"fail")}catch(o){showToast(t("erp-push-fail",{err:o.message}),"fail")}finally{a&&(a.disabled=!1)}}window.injectOcrPushButton=qn;const Nn=[{id:"input_vat",nameKey:"tpl-input-vat",descKey:"tpl-input-vat-desc",badge:"recommended"},{id:"standard",nameKey:"tpl-standard",descKey:"tpl-standard-desc"},{id:"sales_detail_th",nameKey:"export-tpl-sales-detail",descKey:"export-tpl-sales-detail-desc",badge:"new"},{id:"print",nameKey:"tpl-print",descKey:"tpl-print-desc"}];function Dt(){try{const e=localStorage.getItem("pn_export_tpl")||"input_vat";return e==="erp"?"input_vat":e}catch{return"input_vat"}}function Fn(e){try{localStorage.setItem("pn_export_tpl",e||"input_vat")}catch{}}async function qt(e){if(_results.length===0)return;e=e||"input_vat";const n=document.getElementById("btn-export");n&&(n.disabled=!0,n.classList.add("loading"));try{let a,o=`pearnly-export-${Date.now()}.xlsx`;if(e==="sales_detail_th"){const d=[];for(const l of _results){const p=l.invoices&&l.invoices.length>0?l.invoices:null;if(p&&p.length>1)for(let u=0;u<p.length;u++){const g=p[u]||{};d.push({filename:l.filename+" #"+(u+1)+"/"+p.length,engine:l.engine,merged_fields:g.fields||{}})}else d.push({filename:l.filename,engine:l.engine,merged_fields:l.merged_fields})}a=await apiPost("/api/ocr/export",{records:d,lang:currentLang,template:"sales_detail_th"})}else{const d=[];for(const p of _results)p.history_ids&&Array.isArray(p.history_ids)?d.push(...p.history_ids):p.history_id&&d.push(p.history_id);if(d.length===0){showToast(t("toast-export-error"),"error");return}const l=localStorage.getItem("mrpilot_token");a=await fetch("/api/reports/history/batch_export",{method:"POST",headers:{Authorization:"Bearer "+l,"Content-Type":"application/json"},body:JSON.stringify({template:e,lang:currentLang,history_ids:d,client_id:null})}),o=`pearnly-${e}-${Date.now()}.xlsx`}if(!a)return;if(!a.ok){let d="HTTP "+a.status;try{const p=await a.json();p&&p.detail&&(d=typeof p.detail=="string"?p.detail:JSON.stringify(p.detail))}catch(p){console.warn("[export] resp.json err.detail parse failed:",p)}const l=typeof d=="string"&&d.indexOf(".")>0?"err."+d:null;showToast(l?t(l):t("toast-export-error")+" · "+d,"error");return}const s=await a.blob();let c=o;const r=a.headers.get("X-Filename");if(r)c=r;else{const l=(a.headers.get("Content-Disposition")||"").match(/filename\*=UTF-8''([^;]+)/i);if(l)try{c=decodeURIComponent(l[1])}catch{}}const f=URL.createObjectURL(s),i=document.createElement("a");i.href=f,i.download=c,document.body.appendChild(i),i.click(),document.body.removeChild(i),URL.revokeObjectURL(f),showToast(t("toast-export-success"),"success")}catch(a){console.error(a),showToast(t("toast-export-error"),"error")}finally{n&&(n.disabled=!1,n.classList.remove("loading"))}}document.getElementById("btn-export").addEventListener("click",()=>{qt(Dt())});function zn(){const e=document.getElementById("export-split-wrap");if(!e)return;let n=document.getElementById("export-dropdown");if(n){n.remove();return}n=document.createElement("div"),n.id="export-dropdown",n.className="export-dropdown";const a=Dt(),o=Nn.map(c=>{const r=c.badge==="recommended"?`<span class="export-dd-badge badge-rec">${escapeHtml(t("report-recommended"))}</span>`:c.badge==="new"?`<span class="export-dd-badge badge-new">${escapeHtml(t("tpl-badge-new"))}</span>`:"";return`
            <div class="export-dd-item ${c.id===a?"active":""}" data-tpl="${c.id}">
                <div class="export-dd-row">
                    <span class="export-dd-name">${escapeHtml(t(c.nameKey))}</span>
                    ${r}
                    ${c.id===a?'<span class="export-dd-check">✓</span>':""}
                </div>
                <div class="export-dd-desc">${escapeHtml(t(c.descKey))}</div>
            </div>
        `}).join(""),s=`
    ...
    `;const d=document.getElementById("file-list-toggle");d&&d.addEventListener("click",()=>{Ve=!Ve,Qe()});const l=document.getElementById("file-list-body");l&&!l.dataset.retryBound&&(l.dataset.retryBound="1",l.addEventListener("click",async p=>{const u=p.target.closest(".file-retry-btn");if(!u)return;const g=parseInt(u.dataset.retryIdx||"-1",10);if(g<0||g>=_selectedFiles.length)return;const w=_selectedFiles[g];!w||w.status!=="error"||typeof window._reprocessFile=="function"&&await window._reprocessFile(w,!0)}))}function ht(){const e=document.getElementById("btn-start"),n=document.getElementById("btn-clear"),a=document.getElementById("btn-export"),o=_selectedFiles.some(s=>s.status==="waiting");e.disabled=_selectedFiles.length===0||!o,n.disabled=_selectedFiles.length===0&&_results.length===0,a.disabled=_results.length===0}document.getElementById("btn-clear").addEventListener("click",()=>{_selectedFiles=[],_results=[],Qe(),renderResults(),ht(),hideAlerts()});window.renderFileList=Qe;window.updateStartButton=ht;(function(){const n=document.getElementById("upload-alt-row"),a=document.getElementById("gallery-input"),o=document.getElementById("camera-input");if(!n)return;n.style.display="";const s=document.getElementById("btn-scan-doc");s&&o&&(s.addEventListener("click",async()=>{!(localStorage.getItem("mrpilot_camera_tips_skip")==="1")&&!await ta()||o.click()}),o.addEventListener("change",async f=>{const i=Array.from(f.target.files||[]);if(f.target.value="",i.length!==0)for(const d of i)await dt([d],"camera")}));const c=document.getElementById("btn-upload-pic");c&&a&&c.addEventListener("click",()=>a.click());const r=f=>async i=>{const d=Array.from(i.target.files||[]);if(i.target.value="",d.length===0)return;const l=d.filter(u=>u.type==="application/pdf"||/\.pdf$/i.test(u.name)),p=d.filter(u=>!l.includes(u));l.length>0&&await ea(l),p.length>0&&await dt(p,f)};a&&a.addEventListener("change",r("gallery"))})();async function ea(e){for(const a of e)_selectedFiles.push({file:a,name:a.name,size:a.size,status:"waiting",errorKey:null,errorParams:null});const n=getMaxFiles();_selectedFiles.length>n&&(showAlert("warn",t("alert-file-count",{n})),_selectedFiles=_selectedFiles.slice(0,n)),renderFileList(),updateStartButton()}function ta(){return new Promise(e=>{const n=document.getElementById("camera-tips-modal"),a=document.getElementById("camera-tips-ok"),o=document.getElementById("camera-tips-cancel"),s=document.getElementById("camera-tips-skip");if(!n||!a){e(!0);return}s&&(s.checked=!1),n.style.display="flex";const c=f=>{n.style.display="none",s&&s.checked&&localStorage.setItem("mrpilot_camera_tips_skip","1"),a.onclick=null,o&&(o.onclick=null),n.onclick=null,document.removeEventListener("keydown",r),e(f)},r=f=>{f.key==="Escape"&&c(!1)};a.onclick=()=>c(!0),o&&(o.onclick=()=>c(!1)),n.onclick=f=>{f.target===n&&c(!1)},document.addEventListener("keydown",r),setTimeout(()=>a.focus(),50)})}async function Je(e){return new Promise(n=>{const a=new FileReader;a.onerror=()=>n({warnings:[],width:0,height:0,brightness:128}),a.onload=()=>{const o=new Image;o.onerror=()=>n({warnings:[],width:0,height:0,brightness:128}),o.onload=()=>{const s=[],c=o.naturalWidth,r=o.naturalHeight;(c<1e3||r<1e3)&&s.push("low_res");try{const f=document.createElement("canvas");f.width=64,f.height=64;const i=f.getContext("2d");i.drawImage(o,0,0,64,64);const d=i.getImageData(0,0,64,64).data;let l=0,p=0;for(let g=0;g<d.length;g+=4)l+=.299*d[g]+.587*d[g+1]+.114*d[g+2],p++;const u=p?l/p:128;u<70?s.push("too_dark"):u>235&&s.push("too_bright"),n({warnings:s,width:c,height:r,brightness:u})}catch{n({warnings:s,width:c,height:r,brightness:128})}},o.src=a.result},a.readAsDataURL(e)})}let ke=[],Le=null;async function dt(e,n){if(hideAlerts(),!(!e||e.length===0)){if(typeof window.jspdf>"u"||!window.jspdf.jsPDF){showToast(t("camera-loading"),"info");for(let a=0;a<30&&(await new Promise(o=>setTimeout(o,100)),!(window.jspdf&&window.jspdf.jsPDF));a++);if(!window.jspdf||!window.jspdf.jsPDF){showToast(t("camera-lib-fail"),"error");return}}if(n==="camera"&&e.length===1){const a=e[0];let o={};try{o=await Je(a)}catch{}ke.push({file:a,quality:o}),Le="camera",$e();return}if(n==="gallery"&&(e.length>=2||ke.length>0)){for(const a of e){let o={};try{o=await Je(a)}catch{}ke.push({file:a,quality:o})}Le="gallery",$e();return}await Ft(e)}}async function na(e){const n=new Set;for(const o of e)try{((await Je(o)).warnings||[]).forEach(c=>n.add(c))}catch{}try{const o=await zt(e);o&&_selectedFiles.push({file:o,name:o.name,size:o.size,status:"waiting",errorKey:null,errorParams:null})}catch(o){console.error("[camera] convert failed",o),showToast(t("camera-convert-fail"),"error");return}const a=getMaxFiles();_selectedFiles.length>a&&(showAlert("warn",t("alert-file-count",{n:a})),_selectedFiles=_selectedFiles.slice(0,a)),renderFileList(),updateStartButton(),showToast(t("camera-added-merged",{n:e.length}),"success"),n.size>0&&setTimeout(()=>{n.has("too_dark")?showToast(t("camera-quality-dark"),"warn"):n.has("low_res")?showToast(t("camera-quality-lowres"),"warn"):n.has("too_bright")&&showToast(t("camera-quality-overexposed"),"warn")},1e3)}function $e(){let e=document.getElementById("camera-buffer-bar");if(ke.length===0){e&&e.remove(),Le=null;return}e||(e=document.createElement("div"),e.id="camera-buffer-bar",e.className="camera-buffer-bar",document.body.appendChild(e));const n=ke.length,a=n>=2,o=Le==="gallery",s=o?t("camera-buffer-more-gallery"):t("camera-buffer-more");let c;a?o?c=`
        ...
        `:c=`<button type="button" class="btn btn-primary btn-sm" data-cbb-action="merge">${escapeHtml(t("camera-buffer-done"))}</button>`,e.innerHTML=`
        <div class="cbb-count">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
    ...
    <div class="modal" style="max-width:480px">
        ...
        <div class="modal-foot">
            ...
            <div class="access-log-row access-log-head">
                ...
                </div>`}).join("");l.innerHTML=u+g}function s(){const l=document.getElementById("access-log-pager");if(!l)return;const p=e.total||0;if(!p){l.innerHTML="";return}const u=e.page||1,g=e.per_page,w=Math.max(1,Math.ceil(p/g)),$=(t("set-access-log-pager-total")||"Total {n}").replace("{n}",p),E=(t("set-access-log-pager-page")||"Page {p} / {t}").replace("{p}",u).replace("{t}",w);l.innerHTML=`
            ...
            </div>`}async function c(l){const p=localStorage.getItem("mrpilot_token");if(p){e.page=l||1,a(t("set-access-log-loading"));try{const u="/api/me/access_log?page="+e.page+"&per_page="+e.per_page+"&q="+encodeURIComponent(e.q||""),g=await fetch(u,{headers:{Authorization:"Bearer "+p}});if(g.status===403){a(t("set-access-log-empty"));return}if(!g.ok)throw new Error("http_"+g.status);const w=await g.json();e.rows=w.logs||[],e.total=w.total||0,e.loaded=!0,o(),s()}catch{a(t("set-access-log-fail"))}}}async function r(){const l=localStorage.getItem("mrpilot_token");if(l)try{const p="/api/me/access_log.csv?q="+encodeURIComponent(e.q||""),u=await fetch(p,{headers:{Authorization:"Bearer "+l}});if(!u.ok){showToast(t("set-access-log-csv-fail")||"Export failed","error");return}const g=await u.blob(),w=document.createElement("a"),$=URL.createObjectURL(g);w.href=$,w.download="pearnly_access_log.csv",document.body.appendChild(w),w.click(),setTimeout(function(){URL.revokeObjectURL($),w.remove()},100),showToast(t("set-access-log-csv-ok")||"Exported","success")}catch{showToast(t("set-access-log-csv-fail")||"Export failed","error")}}function f(){const l=document.querySelectorAll(".set-tab-owner-only"),p=!!(_userInfo&&(_userInfo.role==="owner"||_userInfo.is_super_admin));l.forEach(function(u){u.style.display=p?"":"none"})}document.addEventListener("click",function(l){if(l.target.closest('.settings-tab[data-tab="access-log"]')){setTimeout(function(){(!e.loaded||e.page!==1)&&c(1)},50);return}if(l.target.closest("#access-log-csv-btn")){l.preventDefault(),r();return}const g=l.target.closest(".access-log-pager-btn[data-access-log-page]");if(g&&!g.disabled){const w=parseInt(g.dataset.accessLogPage,10);c(w)}}),document.addEventListener("input",function(l){l.target&&l.target.id==="access-log-search"&&(clearTimeout(window.__accessLogSearchTimer),window.__accessLogSearchTimer=setTimeout(function(){e.q=(l.target.value||"").trim(),c(1)},350))});let i=0;const d=setInterval(function(){i++,_userInfo&&(f(),clearInterval(d)),i>60&&clearInterval(d)},500);typeof window.subscribeI18n=="function"&&window.subscribeI18n("me-access-log",function(){f(),e.loaded&&(o(),s())})})();(function(){const e=document.getElementById("notif-new-modal");if(!(!e||e.dataset.wbInjected==="1")){e.innerHTML=`
...
`,e.dataset.wbInjected="1";try{const n=window._currentLang||localStorage.getItem("mrpilot_lang")||"th",a=window.I18N;a&&a[n]&&(e.querySelectorAll("[data-i18n]").forEach(o=>{const s=o.getAttribute("data-i18n");a[n][s]&&(o.textContent=a[n][s])}),e.querySelectorAll("[data-i18n-placeholder]").forEach(o=>{const s=o.getAttribute("data-i18n-placeholder");a[n][s]&&(o.placeholder=a[n][s])}))}catch{}}})();(function(){const e=document.getElementById("archive-token-modal");if(!(!e||e.dataset.wbInjected==="1")){e.innerHTML=`
        ...
        </div>`,l=document.createElement("div");l.innerHTML=d,document.body.appendChild(l.firstElementChild),document.getElementById("report-modal-close-x").addEventListener("click",a),document.getElementById("report-modal-cancel").addEventListener("click",a),document.getElementById("report-modal").addEventListener("click",p=>{p.target.id==="report-modal"&&a()})}function a(){const d=document.getElementById("report-modal");d&&(d.style.display="none"),o=null}let o=null;async function s(d,l){const p=d+":"+(l||"");if(e[p])return e[p];let u;try{const g=localStorage.getItem("mrpilot_token"),w=await fetch(`/api/reports/templates?lang=${encodeURIComponent(d)}`,{headers:{Authorization:"Bearer "+g}});if(!w.ok)throw new Error("templates fetch failed");u=(await w.json()).templates||[]}catch(g){console.error("fetchTemplates fail",g),u=[{code:"input_vat",name:t("tpl-input-vat"),desc:t("tpl-input-vat-desc"),recommended:!0},{code:"standard",name:t("tpl-standard"),desc:t("tpl-standard-desc"),recommended:!1},{code:"print",name:t("tpl-print"),desc:t("tpl-print-desc"),recommended:!1}]}if(u=u.filter(g=>g.code!=="erp"),l==="history-batch"){const g=u.findIndex($=>$.code==="standard"),w=g>=0?g+1:u.length;u.splice(w,0,{code:"sales_detail_th",name:t("export-tpl-sales-detail"),desc:t("export-tpl-sales-detail-desc"),recommended:!1,is_new:!0})}return e[p]=u,u}function c(d){const l=document.getElementById("report-tpl-list"),p=d.map((g,w)=>`
...
`,e.dataset.wbInjected="1";try{const n=window._currentLang||localStorage.getItem("mrpilot_lang")||"th",a=window.I18N;a&&a[n]&&(e.querySelectorAll("[data-i18n]").forEach(o=>{const s=o.getAttribute("data-i18n");a[n][s]&&(o.textContent=a[n][s])}),e.querySelectorAll("[data-i18n-placeholder]").forEach(o=>{const s=o.getAttribute("data-i18n-placeholder");a[n][s]&&(o.placeholder=a[n][s])}))}catch{}}})();(function(){let e={statsCache:null,listCache:[],currentRule:null,currentClient:"",currentStatus:"pending",loading:!1,selectedIds:new Set,offset:0,pageSize:50,total:0,loadFailed:!1,listScrollY:0};function n(T,x){let h=t(T)||T;if(x)for(const D in x)h=h.replace(new RegExp("\\{"+D+"\\}","g"),String(x[D]));return h}async function a(){try{const T=e.currentClient||"",x="/api/exceptions/stats?status=pending"+(T?"&client_id="+encodeURIComponent(T):""),h=await fetch(x,{headers:{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||"")}});if(!h.ok)return;const D=await h.json(),N=document.getElementById("nav-exc-badge");if(!N)return;const K=parseInt(D.pending||0,10);K>0?(N.textContent=K>99?"99+":String(K),N.style.display=""):N.style.display="none"}catch{}}function o(T){return T==="high"?`<svg viewBox="0 0 14 14" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
        ...
        `;const z=document.getElementById("exc-fld-edit");z&&z.addEventListener("click",()=>{_.editing=!0,_.editFields={...y(_.history)},L()});const m=document.getElementById("exc-fld-cancel");m&&m.addEventListener("click",()=>{_.editing=!1,_.editFields=null,L()});const R=document.getElementById("exc-fld-save");R&&R.addEventListener("click",()=>C()),document.querySelectorAll(".exc-field-input").forEach(ae=>{ae.addEventListener("input",()=>{_.editFields||(_.editFields={}),_.editFields[ae.dataset.editKey]=ae.value})});const J=document.getElementById("exc-pdf-retry");J&&_.openExcId&&J.addEventListener("click",()=>{_.excRow&&q(_.excRow.history_id,_.openExcId)});const X=T.status==="pending",de=!!(T.seller_name&&T.seller_name.trim()),se=document.getElementById("exc-btn-resolve"),ce=document.getElementById("exc-btn-ignore");se.disabled=!X,ce.disabled=!X||!de,ce.title=de?t("exc-ignore-hint"):t("exc-ignore-no-seller")}async function C(){if(!_.openExcId||!_.history||!_.history.pages||_.loading)return;_.loading=!0;const T=showToast(t("exc-fld-saving"),"loading",0);try{const x=JSON.parse(JSON.stringify(_.history.pages||[]));let h=x.findIndex(ie=>!ie.is_duplicate&&!ie.is_copy);h<0&&(h=0),x[h]||(x[h]={fields:{}});const D=x[h].fields||{},N=_.editFields||{},K=new Set(["subtotal","vat","total_amount"]),Q={...D};for(const ie in N){let V=N[ie];if((V===""||V===void 0)&&(V=null),K.has(ie)&&V!==null){const Z=parseFloat(V);V=isNaN(Z)?null:Z}Q[ie]=V}x[h].fields=Q;const le=await fetch("/api/history/"+encodeURIComponent(_.history.id),{method:"PUT",headers:{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||""),"Content-Type":"application/json"},body:JSON.stringify({pages:x})});if(!le.ok)throw new Error("http "+le.status);T(),showToast(t("exc-fld-save-ok"),"success"),F(),await u(),await w(),a()}catch(x){T(),console.warn("save fields fail",x),showToast(t("exc-fld-save-fail"),"error")}finally{_.loading=!1}}async function P(){if(!(!_.openExcId||_.loading)){_.loading=!0;try{const T=await fetch("/api/exceptions/"+_.openExcId+"/resolve",{method:"POST",headers:{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||"")}});if(!T.ok)throw new Error("http "+T.status);showToast(t("exc-toast-resolved"),"success"),F(),await u(),await w(),a()}catch(T){console.warn("resolve fail",T),showToast(t("exc-toast-action-fail"),"error")}finally{_.loading=!1}}}async function I(){if(!(!_.openExcId||_.loading)){_.loading=!0;try{const T=await fetch("/api/exceptions/"+_.openExcId+"/ignore",{method:"POST",headers:{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||"")}});if(!T.ok)throw new Error("http "+T.status);showToast(t("exc-toast-ignored"),"success"),F(),await u(),await w(),a()}catch(T){console.warn("ignore fail",T),showToast(t("exc-toast-action-fail"),"error")}finally{_.loading=!1}}}let j=!1;async function Y(){if(j)return;const T=Array.from(e.selectedIds);if(T.length===0||!await showConfirm(n("exc-batch-confirm-resolve",{n:T.length})))return;j=!0;const h=showToast(n("exc-batch-count",{n:T.length})+" …","loading",0);try{const D=await fetch("/api/exceptions/batch",{method:"POST",headers:{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||""),"Content-Type":"application/json"},body:JSON.stringify({ids:T,action:"resolve"})});if(!D.ok)throw new Error("http "+D.status);const N=await D.json();h(),showToast(n("exc-toast-batch-resolved",{n:N.processed||0}),"success"),e.selectedIds.clear(),await u(),await w(),a()}catch(D){h(),console.warn("batch resolve fail",D),showToast(t("exc-toast-batch-fail"),"error")}finally{j=!1}}async function G(){if(j)return;const T=Array.from(e.selectedIds);if(T.length===0||!await showConfirm(n("exc-batch-confirm-ignore",{n:T.length}),{danger:!1}))return;j=!0;const h=showToast(n("exc-batch-count",{n:T.length})+" …","loading",0);try{const D=await fetch("/api/exceptions/batch",{method:"POST",headers:{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||""),"Content-Type":"application/json"},body:JSON.stringify({ids:T,action:"ignore"})});if(!D.ok)throw new Error("http "+D.status);const N=await D.json();h(),showToast(n("exc-toast-batch-ignored",{n:N.processed||0,wl:N.whitelist_added||0}),"success"),e.selectedIds.clear(),await u(),await w(),a()}catch(D){h(),console.warn("batch ignore fail",D),showToast(t("exc-toast-batch-fail"),"error")}finally{j=!1}}function W(){e.selectedIds.clear(),d(e.listCache)}document.addEventListener("click",T=>{T.target.closest("#exc-drawer-close")&&F(),T.target.closest("#exc-drawer-mask")&&F(),T.target.closest("#exc-btn-resolve")&&P(),T.target.closest("#exc-btn-ignore")&&I(),T.target.closest("#exc-batch-resolve")&&Y(),T.target.closest("#exc-batch-ignore")&&G(),T.target.closest("#exc-batch-clear")&&W(),T.target.closest("#exc-loadmore")&&$()}),document.addEventListener("keydown",T=>{T.key==="Escape"&&_.openExcId&&F()}),document.addEventListener("click",T=>{T.target.closest("#btn-exc-refresh")&&(typeof window.loadExceptionsPage=="function"&&window.loadExceptionsPage(),a())}),document.addEventListener("change",T=>{if(!T.target.closest("#exc-client-filter"))return;const x=T.target;e.currentClient=x.value||"",e.currentRule=null,e.selectedIds.clear(),e.listCache=[],typeof window.loadExceptionsPage=="function"&&window.loadExceptionsPage(),a()}),document.addEventListener("click",T=>{const x=T.target.closest("#exc-status-tabs .exc-status-tab");if(!x)return;const h=x.dataset.status||"pending";h!==e.currentStatus&&(e.currentStatus=h,e.currentRule=null,e.selectedIds.clear(),e.listCache=[],typeof window.loadExceptionsPage=="function"&&window.loadExceptionsPage())}),window.addEventListener("online",()=>{e.loadFailed&&document.getElementById("page-exceptions")?.classList.contains("show")&&window.loadExceptionsPage&&window.loadExceptionsPage()}),setTimeout(a,1500),setInterval(a,6e4);function te(T){if(!T)return"—";try{const x=new Date(T),h=D=>String(D).padStart(2,"0");return`${x.getFullYear()}-${h(x.getMonth()+1)}-${h(x.getDate())} ${h(x.getHours())}:${h(x.getMinutes())}`}catch{return T.slice(0,16).replace("T"," ")}}async function re(){const T=document.getElementById("learned-list");if(T){T.innerHTML=`<div class="learned-empty">${escapeHtml(t("set-learned-loading"))}</div>`;try{const x=await fetch("/api/exception-whitelist",{headers:{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||"")}});if(!x.ok)throw new Error("http "+x.status);const D=(await x.json()).items||[];if(D.length===0){T.innerHTML=`<div class="learned-empty">${escapeHtml(t("set-learned-empty"))}</div>`;return}const N=`<svg viewBox="0 0 14 14" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round">
            ...
            <div class="erp-exc-modal" role="dialog" aria-modal="true">
                ...
                <td><div class="vex-task-actions">
                    <button class="vex-task-dl-btn" data-task-id="${c(k.id)}" title="${t("hist_export")||"导出"}">${oe}</button>
                    <button class="vex-task-del-btn" data-task-id="${c(k.id)}" title="${t("vex-task-delete-confirm-title")||"删除"}">${ue}</button>
                </div></td>
            ...
            <span class="vex-fi-n" title="${c(S.name)}">${c(S.name)}</span>
            ...
            <div class="vex-pp-file-row">
                ${k}
                <span class="vex-pp-fi-name" title="${c(z.name)}">${c(z.name)}</span>
    ...
    `,document.body.appendChild(n),n.addEventListener("click",async a=>{if(a.target===n||a.target.classList.contains("log-detail-close")){n.remove();return}const o=a.target.closest("[data-receipt-copy]");if(o){Qt(o.dataset.receiptCopy);return}const s=a.target.closest("[data-receipt-action]");if(s){const c=s.dataset.receiptAction;c==="retry"?window.retryPushLog(s.dataset.logId):c==="exceptions"?typeof routeTo=="function"&&routeTo("exceptions"):c==="mappings"&&typeof routeTo=="function"&&routeTo("integrations"),n.remove();return}});try{const a=await fetch(`/api/erp/logs/${encodeURIComponent(e)}`,{headers:{Authorization:"Bearer "+token}});if(!a.ok){n.remove();return}const o=await a.json(),s=window._erpEndpoints.find(C=>C.id===o.endpoint_id),c=o.endpoint_name||(s?s.name:o.endpoint_id?t("erp-log-endpoint-deleted"):"-"),r=(o.endpoint_adapter||s&&s.adapter||"").toLowerCase(),f=new Date(o.created_at).toLocaleString(),i=o.trigger==="auto"?t("log-tag-auto"):o.trigger==="retry"?t("log-tag-retry"):t("log-tag-manual"),d=o.request_body?JSON.stringify(o.request_body,null,2):t("erp-receipt-no-tech"),l=o.response_body||t("erp-receipt-no-tech"),p=o.status==="success";let u=typeof l=="string"?l:JSON.stringify(l,null,2);if(p)try{const C=typeof o.response_body=="string"?JSON.parse(o.response_body):o.response_body||{},P=C.row_count||(Array.isArray(C.imported_rows)?C.imported_rows.length:0);P>0&&(u=t("log-push-rows").replace("{n}",String(P)))}catch{}const g=(o.external_doc_no||"").trim(),w=(o.external_url||"").trim(),$=(o.external_doc_hint||"").trim(),E=(o.ocr_buyer_name||"").trim()||o.client_name||"-",_=o.seller_name||"-";let B="-";const q=Number(o.total_amount);o.total_amount!=null&&o.total_amount!==""&&!isNaN(q)&&(B=q.toLocaleString("en-US",{minimumFractionDigits:2,maximumFractionDigits:2}));const H=p?t("erp-receipt-title-ok"):t("erp-receipt-title-fail"),F=p?"✓":"✗",A=[],y=(C,P)=>{A.push(`
        ...
        `,document.body.appendChild(f),e=f;const i=f.querySelector("#line-email-input"),d=f.querySelector("#line-email-submit-btn"),l=f.querySelector("#line-email-err");async function p(){l.textContent="";const u=(i.value||"").trim().toLowerCase();if(!u||u.indexOf("@")<0||u.split("@")[1].indexOf(".")<0){l.textContent=t("line-email-err-invalid");return}d.disabled=!0,d.style.opacity="0.6";try{const g=await fetch("/api/me/line_complete_email",{method:"POST",headers:{"Content-Type":"application/json",Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||"")},body:JSON.stringify({email:u})});if(!g.ok)throw new Error("http_"+g.status);const w=await g.json();w.token&&localStorage.setItem("mrpilot_token",w.token),typeof showToast=="function"&&showToast(w.merged?t("line-email-merged-toast"):t("line-email-saved-toast"),"success"),setTimeout(function(){window.location.reload()},600)}catch{l.textContent=t("line-email-err-failed"),d.disabled=!1,d.style.opacity="1"}}return d.addEventListener("click",p),i.addEventListener("keydown",function(u){u.key==="Enter"&&p()}),f}function o(){if(!e)return;const f=e.querySelector("#line-email-title-h"),i=e.querySelector("#line-email-sub-p"),d=e.querySelector("#line-email-input"),l=e.querySelector("#line-email-submit-btn");f&&(f.textContent=t("line-email-title")),i&&(i.textContent=t("line-email-sub")),d&&(d.placeholder=t("line-email-placeholder")),l&&(l.textContent=t("line-email-submit"))}function s(){a(),o(),e.style.display="flex",n=!0;const f=e.querySelector("#line-email-input");f&&setTimeout(function(){f.focus()},100)}async function c(){const f=localStorage.getItem("mrpilot_token");if(f)try{const i=await fetch("/api/me/needs_email",{headers:{Authorization:"Bearer "+f}});if(!i.ok)return;const d=await i.json();d&&d.needs_email&&s()}catch{}}function r(){setTimeout(c,800)}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",r):r(),typeof window.subscribeI18n=="function"&&window.subscribeI18n("line-email-modal",function(){n&&o()})})();(function(){function e(l){let p=0;return l.length>=8&&p++,l.length>=12&&p++,/[a-zA-Z]/.test(l)&&/\d/.test(l)&&p++,/[^a-zA-Z0-9]/.test(l)&&p++,Math.min(3,p)}function n(l,p){const u=document.getElementById("cpw-msg");u&&(u.textContent=l,u.className="cpw-msg "+(p||""))}function a(l){return typeof t=="function"?t(l):l}let o=!1;function s(){["cpw-old","cpw-new","cpw-confirm"].forEach(p=>{const u=document.getElementById(p);u&&(u.value="",u.setAttribute("readonly","readonly"))});const l=document.getElementById("cpw-strength-bar");l&&(l.style.width="0%",l.className="cpw-strength-bar"),n("","")}async function c(){const l=document.getElementById("btn-change-pw"),p=document.getElementById("cpw-old"),u=document.getElementById("cpw-new"),g=document.getElementById("cpw-confirm"),w=document.getElementById("cpw-strength-bar");if(!l||!p||!u||!g)return;const $=p.value,E=u.value,_=g.value;if(!$||!E||!_){n(a("settings-change-pw-empty"),"error");return}if(E.length<8){n(a("settings-change-pw-too-short"),"error");return}if(!(/[a-zA-Z]/.test(E)&&/\d/.test(E))){n(a("settings-change-pw-too-weak"),"error");return}if(E!==_){n(a("settings-change-pw-mismatch"),"error");return}l.disabled=!0;const B=l.textContent;l.textContent=a("settings-change-pw-submitting"),n("","");try{const q=localStorage.getItem("mrpilot_token"),H=await fetch("/api/me/change_password",{method:"POST",headers:{"Content-Type":"application/json",Authorization:"Bearer "+q},body:JSON.stringify({old_password:$,new_password:E})}),F=await H.json().catch(()=>({}));if(H.ok&&F.ok)n(a("settings-change-pw-success"),"success"),typeof showToast=="function"&&showToast(a("settings-change-pw-success"),"success"),p.value="",u.value="",g.value="",w&&(w.style.width="0%",w.className="cpw-strength-bar");else{const A=F.detail||"";let y=a("settings-change-pw-success");A==="wrong_old_password"?y=a("settings-change-pw-wrong-old"):A==="password_too_short"?y=a("settings-change-pw-too-short"):A==="password_too_weak"?y=a("settings-change-pw-too-weak"):y=A||"Error",n(y,"error")}}catch(q){console.error("change_password",q),n("Network error","error")}finally{l.disabled=!1,l.textContent=B}}function r(){o||(o=!0,document.addEventListener("click",l=>{if(!l.target||!l.target.closest)return;const p=l.target.closest(".cpw-eye");if(p){const u=document.getElementById(p.dataset.target);u&&(u.type=u.type==="password"?"text":"password");return}if(l.target.closest("#cpw-forgot-link")){l.preventDefault(),f();return}if(l.target.closest("#btn-change-pw")){c();return}l.target.closest('.settings-nav-item[data-settings-tab="account"], .settings-nav-item[data-tab="account"], .settings-nav-item[data-tab="security"]')&&setTimeout(s,100)}),document.addEventListener("input",l=>{if(l.target&&l.target.id==="cpw-new"){const p=document.getElementById("cpw-strength-bar");if(!p)return;const u=e(l.target.value),g=["0%","33%","66%","100%"],w=["","weak","medium","strong"];p.style.width=g[u],p.className="cpw-strength-bar "+w[u]}}),document.addEventListener("focusin",l=>{l.target&&["cpw-old","cpw-new","cpw-confirm"].includes(l.target.id)&&l.target.removeAttribute("readonly")}),document.getElementById("cpw-old")&&s())}function f(){const l=window._userInfo||(typeof _userInfo<"u"?_userInfo:null),p=l&&l.username?l.username:"",u=i(p);let g=document.getElementById("cpw-forgot-overlay");g&&g.remove(),g=document.createElement("div"),g.id="cpw-forgot-overlay",g.className="cpw-forgot-overlay",g.innerHTML=`
        ...
        `,document.body.appendChild(g);const w=()=>g.remove();g.querySelector("#cpw-forgot-close").addEventListener("click",w),g.querySelector("#cpw-forgot-cancel").addEventListener("click",w),g.addEventListener("click",$=>{$.target===g&&w()}),g.querySelector("#cpw-forgot-send").addEventListener("click",async()=>{const $=g.querySelector("#cpw-forgot-send"),E=g.querySelector("#cpw-forgot-msg");$.disabled=!0;const _=$.textContent;$.textContent=a("cpw-forgot-sending");try{const B=await fetch("/api/auth/forgot_password",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:p})}),q=await B.json().catch(()=>({}));B.ok?(E.textContent=a("cpw-forgot-success"),E.className="cpw-forgot-msg success",$.style.display="none",g.querySelector("#cpw-forgot-cancel").textContent=a("cpw-forgot-close-btn")):(E.textContent=q.detail||a("cpw-forgot-fail"),E.className="cpw-forgot-msg error",$.disabled=!1,$.textContent=_)}catch{E.textContent=a("cpw-forgot-fail"),E.className="cpw-forgot-msg error",$.disabled=!1,$.textContent=_}})}function i(l){if(!l||!l.includes("@"))return l||"";const[p,u]=l.split("@");return p.length<=2?p+"****@"+u:p.slice(0,2)+"****@"+u}function d(l){return l==null?"":String(l).replace(/[&<>"']/g,p=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[p])}document.readyState==="complete"||document.readyState==="interactive"?r():document.addEventListener("DOMContentLoaded",r)})();(function(){let e=null,n=!1;async function a(){if(n)return;const s=localStorage.getItem("mrpilot_token");if(s){n=!0;try{const c=await fetch("/api/me",{headers:{Authorization:"Bearer "+s},cache:"no-store"});if(c.status===401){const r=await c.json().catch(()=>({})),f=r&&r.detail;let i="";if(typeof f=="string"?i=f:f&&typeof f=="object"&&(i=f.code||""),console.warn("[heartbeat] session revoked",i),localStorage.removeItem("mrpilot_token"),e&&(clearInterval(e),e=null),i==="auth.session_revoked")try{_showSessionRevokedModal()}catch{window.location.href="/"}else{const d=i==="auth.password_changed_relogin"?"alert-password-changed-relogin":"alert-session";try{typeof showToast=="function"&&typeof t=="function"?showToast(t(d),"error"):alert("Session expired")}catch{}setTimeout(()=>{window.location.href="/"},1500)}}}catch{}finally{n=!1}}}function o(){e&&clearInterval(e),e=setInterval(a,15e3)}localStorage.getItem("mrpilot_token")&&o(),window.addEventListener("focus",a),document.addEventListener("visibilitychange",function(){document.hidden||a()}),window._sessionCheck=a})();async function et(){const e=document.getElementById("team-loading"),n=document.getElementById("team-list"),a=document.getElementById("team-empty"),o=document.getElementById("team-count");if(n){e&&(e.style.display=""),n.style.display="none",a&&(a.style.display="none");try{const s=await apiGet("/api/team/employees"),c=s&&s.employees||[];if(e&&(e.style.display="none"),o&&(o.textContent=(t("team-count")||"共 {n} 名员工").replace("{n}",c.length)),c.length===0){a&&(a.style.display="");return}n.style.display="",n.innerHTML=c.map(r=>{const f=r.last_login_at?new Date(r.last_login_at).toLocaleDateString():t("team-never-login")||"从未登录",i=r.is_active===!1?"team-status-off":"team-status-on",d=r.is_active===!1?t("team-status-disabled")||"已禁用":t("team-status-active")||"正常",l=r.email?`<span class="team-meta-sep">·</span><span>${escapeHtml(r.email)}</span>`:"";return`
            ...
            </div>`}).join("")}catch(s){console.error("loadTeamList failed:",s),e&&(e.textContent=t("team-load-failed")||"加载失败")}}}async function ba(){document.querySelectorAll(".add-emp-overlay").forEach(o=>o.remove());const e=document.createElement("div");e.className="add-emp-overlay",e.innerHTML=`
    ...
    `,document.body.appendChild(e),requestAnimationFrame(()=>e.classList.add("show")),setTimeout(()=>{const o=document.getElementById("add-emp-username");o&&o.focus()},200);function n(){e.classList.remove("show"),setTimeout(()=>e.remove(),220)}e.querySelector(".add-emp-close").addEventListener("click",n),e.querySelector("#add-emp-cancel").addEventListener("click",n),e.addEventListener("click",o=>{o.target===e&&n()}),e.querySelector("#add-emp-submit").addEventListener("click",async()=>{const o=document.getElementById("add-emp-username"),s=document.getElementById("add-emp-email"),c=document.getElementById("add-emp-password"),r=document.getElementById("add-emp-msg"),f=document.getElementById("add-emp-submit"),i=(o.value||"").trim(),d=(s.value||"").trim(),l=c.value||"";if(r.textContent="",r.classList.remove("error"),!i||i.length<3){r.textContent=t("team-modal-err-username")||"用户名至少 3 位",r.classList.add("error");return}if(!/^[a-zA-Z0-9_.\-]+$/.test(i)){r.textContent=t("team-modal-err-username-fmt")||"只能用字母 / 数字 / 下划线 / 点 / 横线",r.classList.add("error");return}if(d&&!/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(d)){r.textContent=t("msg-email-invalid")||"邮箱格式不对",r.classList.add("error");return}if(l.length<8){r.textContent=t("pwd-too-short")||"密码至少 8 位",r.classList.add("error");return}if(/^\d+$/.test(l)){r.textContent=t("pwd-too-weak-numeric")||"不能是纯数字 · 请加入字母",r.classList.add("error");return}if(!(/[a-zA-Z]/.test(l)&&/\d/.test(l))){r.textContent=t("pwd-too-weak")||"密码至少 8 位 · 字母 + 数字",r.classList.add("error");return}f.disabled=!0,f.textContent=t("msg-saving")||"保存中...";try{const p={username:i,password:l};d&&(p.email=d);const u=await apiPost("/api/team/employees",p),g=u?await u.json().catch(()=>({})):{};if(u&&u.ok&&g&&g.ok){showToast(t("team-added")||"员工已添加","success"),n(),et();return}const w=g&&g.detail||"unknown",$={"team.username_exists":t("team-username-exists")||"用户名已被占用","team.email_exists":t("team-email-exists")||"邮箱已被占用","team.create_failed":t("team-create-failed")||"创建失败","team.only_owner_or_super":t("team-no-permission")||"无权限","team.no_tenant":t("team-no-tenant")||"请先升级账号","pwd.too_short":t("pwd-too-short")||"密码至少 8 位","pwd.too_weak_numeric":t("pwd-too-weak-numeric")||"不能是纯数字","pwd.too_weak_common":t("pwd-too-weak-common")||"这个密码太常见 · 请换一个","pwd.too_weak":t("pwd-too-weak")||"密码至少 8 位 · 字母 + 数字"};r.textContent=$[w]||(t("team-create-failed")||"创建失败")+" ("+w+")",r.classList.add("error")}catch{r.textContent=t("team-create-failed")||"创建失败",r.classList.add("error")}finally{f.disabled=!1,f.textContent=t("team-add")||"添加员工"}});function a(o){o.key==="Escape"&&(n(),document.removeEventListener("keydown",a))}document.addEventListener("keydown",a)}async function ya(e,n){try{if((await fetch(`/api/team/employees/${encodeURIComponent(e)}/active`,{method:"PATCH",headers:{Authorization:"Bearer "+token,"Content-Type":"application/json"},body:JSON.stringify({is_active:!!n})})).ok){et();return}showToast(t("team-toggle-failed")||"操作失败","error")}catch{showToast(t("team-toggle-failed")||"操作失败","error")}}async function wa(e,n){const o=(t("team-confirm-remove")||"确认移除员工「{name}」?他的所有识别记录会保留 · 但他将无法登录").replace("{name}",n).replace("{n}",n);if(await showConfirm(o,{danger:!0,okText:t("team-remove")}))try{if((await fetch(`/api/team/employees/${encodeURIComponent(e)}`,{method:"DELETE",headers:{Authorization:"Bearer "+token}})).ok){showToast(t("team-removed")||"已移除","success"),et();return}showToast(t("team-remove-failed")||"移除失败","error")}catch{showToast(t("team-remove-failed")||"移除失败","error")}}async function ka(e,n){const o=(t("team-reset-pwd-confirm")||"给员工「{name}」发送改密链接?系统将通过员工的邮箱或 LINE 发送一个 15 分钟内有效的链接 · 员工自己点链接改密码 · 您看不到密码").replace("{name}",n).replace("{n}",n);if(await showConfirm(o,{okText:t("team-reset-link-send-btn")||"发送链接"}))try{const c=await fetch(`/api/team/employees/${encodeURIComponent(e)}/reset-password`,{method:"POST",headers:{Authorization:"Bearer "+token}}),r=await c.json().catch(()=>({}));if(c.status===400&&r.detail==="team.reset_no_channel"){showToast(t("team-reset-no-channel")||"员工尚未绑定邮箱或 LINE · 请先帮员工补充邮箱再重置","error");return}if(!c.ok){showToast(t("team-reset-pwd-fail")||"发送失败","error");return}if(r.channel==="line"||r.channel==="email"){const f=t("team-reset-link-sent")||"改密链接已通过 {ch} 发送给员工 · 链接 15 分钟内有效",i=r.channel==="line"?"LINE":t("team-reset-via-email")||"邮箱";showToast(f.replace("{ch}",i),"success");return}showToast(t("team-reset-pwd-fail")||"发送失败","error")}catch{showToast(t("team-reset-pwd-fail")||"发送失败","error")}}document.addEventListener("click",e=>{if(e.target.closest("#btn-add-employee")){e.preventDefault(),ba();return}const n=e.target.closest("[data-toggle-employee]");if(n){e.preventDefault(),ya(n.dataset.toggleEmployee,n.dataset.active==="false");return}const a=e.target.closest("[data-remove-employee]");if(a){e.preventDefault(),wa(a.dataset.removeEmployee,a.dataset.name||"");return}const o=e.target.closest("[data-reset-pwd-employee]");if(o){e.preventDefault(),ka(o.dataset.resetPwdEmployee,o.dataset.name||"");return}const s=e.target.closest("[data-assign-clients]");if(s){e.preventDefault(),typeof window.openAssignClientsModal=="function"&&window.openAssignClientsModal(s.dataset.assignClients,s.dataset.name||"");return}});window.loadTeamList=et;function _a(e){document.querySelectorAll(".auto-nav-item").forEach(n=>{n.classList.toggle("active",n.dataset.autoTab===e)}),document.querySelectorAll(".auto-panel").forEach(n=>{n.classList.toggle("active",n.dataset.autoPanel===e)}),e==="email"&&typeof window._loadEmailIngestPanel=="function"?(window._loadEmailIngestPanel(),typeof window._startEmailLogAutoRefresh=="function"&&window._startEmailLogAutoRefresh()):typeof window._stopEmailLogAutoRefresh=="function"&&window._stopEmailLogAutoRefresh(),e==="bank"&&typeof window._loadBankReconPanel=="function"&&window._loadBankReconPanel(),e==="linebot"&&typeof window._loadLineBotPanel=="function"&&window._loadLineBotPanel(),e==="alert"&&typeof window._loadNotificationsPanel=="function"&&window._loadNotificationsPanel(),e==="folder"&&typeof window._loadFolderWatcherPanel=="function"&&window._loadFolderWatcherPanel()}window.switchAutomationTab=_a;typeof console<"u"&&typeof console.info=="function"&&console.info("[pearnly] vite bundle loaded · dashboard + billing + test-center + workspace-switcher + recon-center + assign-clients + access-log + notifications + recon-batch + welcome-wizard + archive-settings");
