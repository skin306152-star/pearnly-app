...
`;we("pearnly-confirm-modal",ko);we("confirm-modal",xo);window.pearnlyConfirm=function(e,n){return new Promise(function(a){const o=document.getElementById("pearnly-confirm-modal"),s=document.getElementById("pearnly-confirm-title"),i=document.getElementById("pearnly-confirm-msg"),r=document.getElementById("pearnly-confirm-ok"),c=document.getElementById("pearnly-confirm-cancel"),l=document.getElementById("pearnly-confirm-close");if(!o||!i||!r||!c){a(window.confirm(e));return}s&&(s.textContent=n||(typeof t=="function"?t("confirm-default-title"):"Please confirm")),i.textContent=e||"",o.style.display="flex";function p(h){o.style.display="none",r.removeEventListener("click",m),c.removeEventListener("click",d),l&&l.removeEventListener("click",d),o.removeEventListener("click",u),document.removeEventListener("keydown",f),a(h)}function m(){p(!0)}function d(){p(!1)}function u(h){h.target===o&&p(!1)}function f(h){h.key==="Escape"?p(!1):h.key==="Enter"&&p(!0)}r.addEventListener("click",m),c.addEventListener("click",d),l&&l.addEventListener("click",d),o.addEventListener("click",u),document.addEventListener("keydown",f),setTimeout(function(){try{c.focus()}catch{}},50)})};const _o=`
        <!-- 顶部 page head -->
        <div class="page-head-clean">
            <div class="page-head-icon">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
...
`,e.dataset.wbInjected="1";try{const n=window._currentLang||localStorage.getItem("mrpilot_lang")||"th",a=window.I18N;a&&a[n]&&(e.querySelectorAll("[data-i18n]").forEach(o=>{const s=o.getAttribute("data-i18n");a[n][s]&&(o.textContent=a[n][s])}),e.querySelectorAll("[data-i18n-placeholder]").forEach(o=>{const s=o.getAttribute("data-i18n-placeholder");a[n][s]&&(o.placeholder=a[n][s])}))}catch{}}})();(function(){const e=document.getElementById("page-settings");if(!(!e||e.dataset.wbInjected==="1")){e.innerHTML=`
        ...
        <!-- /settings-layout -->
`,e.dataset.wbInjected="1";try{const n=window._currentLang||localStorage.getItem("mrpilot_lang")||"th",a=window.I18N;a&&a[n]&&(e.querySelectorAll("[data-i18n]").forEach(o=>{const s=o.getAttribute("data-i18n");a[n][s]&&(o.textContent=a[n][s])}),e.querySelectorAll("[data-i18n-placeholder]").forEach(o=>{const s=o.getAttribute("data-i18n-placeholder");a[n][s]&&(o.placeholder=a[n][s])}))}catch{}}})();const Bo=`
        <div class="page-head-clean">
            <div class="page-head-icon">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
...
`,Io=`                    <!-- Tab: 邮箱抓取 (v0.17 · M6 · v93 在 Vultr 复活) -->
...
`;(function(){const e=document.getElementById("page-automation");if(!(!e||e.dataset.wbInjected==="1")){e.innerHTML=Bo+Io,e.dataset.wbInjected="1";try{const n=window._currentLang||localStorage.getItem("mrpilot_lang")||"th",a=window.I18N;a&&a[n]&&(e.querySelectorAll("[data-i18n]").forEach(o=>{const s=o.getAttribute("data-i18n");a[n][s]&&(o.textContent=a[n][s])}),e.querySelectorAll("[data-i18n-placeholder]").forEach(o=>{const s=o.getAttribute("data-i18n-placeholder");a[n][s]&&(o.placeholder=a[n][s])}))}catch{}}})();(function(){const e={"page-integration":`
        <div class="coming-soon">
            <svg class="cs-icon" viewBox="0 0 48 48" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
...
`,e.dataset.wbInjected="1";try{const n=window._currentLang||localStorage.getItem("mrpilot_lang")||"th",a=window.I18N;a&&a[n]&&e.querySelectorAll("[data-i18n]").forEach(o=>{const s=o.getAttribute("data-i18n");a[n][s]&&(o.textContent=a[n][s])})}catch{}}})();function Lo(e,n){const a=document.getElementById("alert-"+e);a&&(document.getElementById("alert-"+e+"-text").textContent=n,a.classList.add("show"))}function Co(){["info","warn","error"].forEach(e=>{document.getElementById("alert-"+e).classList.remove("show")})}function So(e,n){if(e==null)return n||"操作失败";if(typeof e=="string")return e;if(Array.isArray(e)){const a=e[0]||{};return a.msg?a.msg:n||"请求格式错误"}if(typeof e=="object"){if(e.code){const a="err."+e.code;try{const o=t(a,e);if(o&&o!==a)return o}catch(o){console.warn("[i18n] t() failed for key:",a,o)}return e.code}if(e.message)return e.message;if(e.error)return e.error;if(e.detail&&typeof e.detail=="string")return e.detail;try{return JSON.stringify(e).slice(0,160)}catch{}}return n||String(e)}function To(e){if(!e)return"";const n=String(e);return/ECONNREFUSED|Connection refused/i.test(n)?"连接被拒绝 · ERP 地址可能错了,或服务没启动":/listing fetch failed|wait_for_selector/i.test(n)?"拉取 MR.ERP 客户/商品列表超时 · 已重试 3 次仍不通 · 可能 MR.ERP 响应慢 · 稍后再试":/ETIMEDOUT|timeout/i.test(n)?"连接超时 · MR.ERP 响应慢 · 稍后再试":/ENOTFOUND|getaddrinfo/i.test(n)?"域名解析失败 · ERP 地址拼错了":/certificate|SSL/i.test(n)?"SSL 证书问题 · ERP 站点证书异常":/401|Unauthorized/i.test(n)?"HTTP 401 · 认证失败,检查 Token 是否正确":/403|Forbidden/i.test(n)?"HTTP 403 · 权限不足,ERP 拒绝访问":/404|Not Found/i.test(n)?"HTTP 404 · URL 路径不存在":/^5\d\d/.test(n)||/500|502|503|504/.test(n)?"ERP 服务器错误 · 不是你的问题,等会儿再试":n}function Mo(e,n,a){let o=document.getElementById("mp-toast-wrap");o||(o=document.createElement("div"),o.id="mp-toast-wrap",document.body.appendChild(o)),n=n||"success",n==="ok"&&(n="success"),n==="warning"&&(n="warn"),n==="danger"&&(n="error");const s={success:'<path d="M3 8l3 3 7-7"/>',error:'<circle cx="8" cy="8" r="6"/><path d="M5.5 5.5l5 5M10.5 5.5l-5 5"/>',warn:'<path d="M8 2L1.5 13h13L8 2z"/><path d="M8 7v3M8 12v.01"/>',info:'<circle cx="8" cy="8" r="6"/><path d="M8 5.5v.01M8 8v3"/>',loading:'<path d="M8 1a7 7 0 017 7" stroke-linecap="round" class="mp-toast-spin"/>'},i=document.createElement("div");i.className="mp-toast "+n,i.innerHTML=`
    ...
    `,o.appendChild(i),requestAnimationFrame(()=>i.classList.add("show"));const r=typeof a=="number"?a:2500;let c=null;const l=()=>{c&&(clearTimeout(c),c=null),i.classList.remove("show"),setTimeout(()=>{try{i.remove()}catch{}},300)};return r>0&&(c=setTimeout(l,r)),l}window.showAlert=Lo;window.hideAlerts=Co;window._humanizeBackendError=So;window.humanizeError=To;window.showToast=Mo;function $o(e,n){return n=n||{},new Promise(a=>{const o=document.getElementById("confirm-modal"),s=document.getElementById("confirm-modal-body"),i=document.getElementById("confirm-modal-ok"),r=document.getElementById("confirm-modal-cancel"),c=document.getElementById("confirm-modal-close"),l=document.getElementById("confirm-modal-title");if(!o||!s||!i||!r){a(!1);return}l.textContent=n.title||t("confirm-default-title");const p=n.promptInput?"cm_in_"+Date.now():null;if(n.promptInput){const f=(e||"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;"),h=(n.placeholder||"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;");s.innerHTML=`
            ...
            `}else s.textContent=e||"";i.className=n.danger?"btn btn-danger":"btn btn-primary",i.textContent=n.okText||t("confirm-ok"),r.textContent=n.cancelText||t("confirm-cancel"),r.style.display=n.hideCancel?"none":"",o.style.display="flex";const m=f=>{o.style.display="none",i.onclick=null,r.onclick=null,c.onclick=null,o.onclick=null,document.removeEventListener("keydown",u),n.promptInput&&(s.innerHTML=""),r.style.display="",a(f)},d=()=>{const f=p?document.getElementById(p):null;return f?f.value:""},u=f=>{f.key==="Escape"?m(n.promptInput?null:!1):f.key==="Enter"&&m(n.promptInput?d():!0)};i.onclick=()=>m(n.promptInput?d():!0),r.onclick=()=>m(n.promptInput?null:!1),c.onclick=()=>m(n.promptInput?null:!1),o.onclick=f=>{f.target===o&&m(n.promptInput?null:!1)},document.addEventListener("keydown",u),setTimeout(()=>{if(n.promptInput){const f=document.getElementById(p);f&&f.focus()}else i.focus()},50)})}window.showConfirm=$o;function Ho(e){if(e){try{if(typeof shouldHideMoney=="function"&&shouldHideMoney(_userInfo)&&["team","api","plan","company"].indexOf(e)>=0){e="profile";try{localStorage.setItem("mrpilot_settings_tab","profile")}catch{}}}catch{}document.querySelectorAll(".settings-tab").forEach(n=>{n.classList.toggle("active",n.dataset.tab===e)}),document.querySelectorAll(".settings-pane").forEach(n=>{n.classList.toggle("active",n.dataset.pane===e)});try{localStorage.setItem("mrpilot_settings_tab",e)}catch{}try{e==="about"&&typeof window.loadAboutPanel=="function"&&window.loadAboutPanel(),e==="notifications"&&typeof window.loadPrefsSettings=="function"&&window.loadPrefsSettings(),e==="team"&&loadTeamList(),e==="learned"&&typeof window.loadLearnedRules=="function"&&window.loadLearnedRules(),e==="plan"&&typeof nn=="function"&&nn()}catch(n){console.warn("settings tab side effect failed:",n)}}}function Ao(e){if(!e)return;const n=(a,o)=>{const s=document.getElementById(a);s&&(s.value=o||"")};n("profile-username",e.username||""),n("profile-email",e.username||""),n("profile-fullname",e.full_name||""),n("profile-phone",e.phone||""),n("profile-country",e.country||"TH"),n("profile-line",e.line_id||""),n("company-name",e.company_name||""),n("company-volume",e.monthly_volume||""),n("company-role",e.user_role||e.role_self||"")}async function jo(){const e=document.getElementById("btn-save-profile"),n=document.getElementById("profile-save-msg");if(!e)return;const a=e.innerHTML;e.disabled=!0,e.innerHTML=`<span>${t("msg-saving")||"保存中..."}</span>`,n&&(n.textContent="",n.classList.remove("error"));try{const o={full_name:(document.getElementById("profile-fullname")||{}).value||"",phone:(document.getElementById("profile-phone")||{}).value||"",country:(document.getElementById("profile-country")||{}).value||"TH",line_id:(document.getElementById("profile-line")||{}).value||""},s=await apiPut("/api/me/profile",o);if(s&&s.ok){n&&(n.textContent=t("msg-saved")||"已保存");try{const i=await apiGet("/api/me");_userInfo=i;try{window._userInfo=i}catch{}renderBrandWorkspace()}catch{}}else throw new Error("save failed")}catch{n&&(n.textContent=t("msg-save-failed")||"保存失败",n.classList.add("error"))}finally{e.disabled=!1,e.innerHTML=a,setTimeout(()=>{n&&(n.textContent="")},3e3)}}async function Po(){const e=document.getElementById("btn-save-company"),n=document.getElementById("company-save-msg");if(!e)return;const a=e.innerHTML;e.disabled=!0,e.innerHTML=`<span>${t("msg-saving")||"保存中..."}</span>`,n&&(n.textContent="",n.classList.remove("error"));try{const o={company_name:(document.getElementById("company-name")||{}).value||"",monthly_volume:(document.getElementById("company-volume")||{}).value||"",role:(document.getElementById("company-role")||{}).value||""},s=await apiPut("/api/me/profile",o);if(s&&s.ok){n&&(n.textContent=t("msg-saved")||"已保存");try{const i=await apiGet("/api/me");_userInfo=i;try{window._userInfo=i}catch{}renderBrandWorkspace()}catch{}}else throw new Error("save failed")}catch{n&&(n.textContent=t("msg-save-failed")||"保存失败",n.classList.add("error"))}finally{e.disabled=!1,e.innerHTML=a,setTimeout(()=>{n&&(n.textContent="")},3e3)}}function nn(){if(!_userInfo)return;typeof window.loadAboutPanel=="function"&&window.loadAboutPanel(),typeof window.loadPrefsSettings=="function"&&window.loadPrefsSettings();const e=document.getElementById("settings-info");if(!e)return;const n=_userInfo;if(n.is_super_admin){e.innerHTML=`
        ...
        `;const o=document.getElementById("api-key-card");o&&(o.style.display="");return}Do(n,e);const a=document.getElementById("api-key-card");if(a){const o=tt==="byo_api"||_userInfo&&_userInfo.is_super_admin;a.style.display=o?"":"none"}}function Do(e,n){const a=escapeHtml(e.username||e.email||"");n.innerHTML=`
        <table style="width:100%; font-size:13px; border-collapse: collapse;">
            <tr>
    ...
    `}window.switchSettingsTab=Ho;window.fillSettingsForms=Ao;window.saveProfile=jo;window.saveCompany=Po;window.renderSettings=nn;function Ut(e){return e=e||_userInfo,!!(e&&e.is_super_admin)}function pn(e){return e=e||_userInfo,!!e&&(e.role==="owner"||Ut(e))}function pa(e){return e=e||_userInfo,!!e&&e.role==="member"&&!Ut(e)}function qo(e){return e=e||_userInfo,!!e&&(e.effective_plan==="trial"||e.plan==="trial")&&!Ut(e)}function ua(e){return e=e||_userInfo,!!e&&e.tenant_type==="byo_api"}function fa(e){return pa(e)}function Ro(e){return pn(e)}function Fo(e){return pn(e)&&ua(e)}window.isMoneyHidden=fa;window.isSuperAdmin=Ut;window.isOwner=pn;window.isEmployee=pa;window.isTrial=qo;window.isLifetime=ua;window.shouldHideMoney=fa;window.canManageTeam=Ro;window.canManageApiKey=Fo;function zo(){const e=document.getElementById("quota-banner");if(!e)return;if(!_userInfo){e.style.display="none";return}if(_userInfo.is_super_admin||_userInfo.tenant_type==="admin"||_userInfo.tenant_type==="byo_api"){e.style.display="none";return}let n=0,a=0;if(_userInfo.plan==="free"&&_quota&&_quota.ip_daily_limit)n=_quota.ip_used_today||0,a=_quota.ip_daily_limit;else if(_userInfo.tenant_quota!=null&&_userInfo.tenant_quota>0)n=_userInfo.tenant_used||0,a=_userInfo.tenant_quota;else if(_userInfo.monthly_quota&&_userInfo.monthly_quota>0)n=_userInfo.used_this_month||0,a=_userInfo.monthly_quota;else{e.style.display="none";return}if(a<=0){e.style.display="none";return}const o=Math.max(0,a-n),s=n/a*100,i="quota_banner_dismiss_"+new Date().toISOString().slice(0,10);if(localStorage.getItem(i)){e.style.display="none";return}let r,c;if(o===0)r="danger",c=t("quota-banner-exhausted");else if(s>=90)r="danger",c=t("quota-banner-very-low",{n:o});else if(s>=70)r="warn",c=t("quota-banner-low",{n:o});else{e.style.display="none";return}e.className="quota-banner "+r,e.innerHTML=`
    ...
    `,e.style.display="flex";const l=e.querySelector(".quota-banner-close");l&&l.addEventListener("click",()=>{localStorage.setItem(i,"1"),e.style.display="none"})}function No(){const e=_userInfo;if(!e)return;const n=shouldHideMoney(e),a=canManageTeam(e),o=canManageApiKey(e),s=document.querySelector('.nav-item[data-route="templates"]');s&&(s.classList.remove("locked-for-plan"),s.removeAttribute("data-locked-target"));const i=document.querySelector('.nav-item[data-route="api-keys"]');i&&(i.classList.remove("locked-for-plan"),i.removeAttribute("data-locked-target"));const r=document.getElementById("btn-custom-template");r&&(r.style.display="",r.classList.remove("locked-for-plan"));const c=document.querySelector('.settings-tab[data-tab="team"]');c&&(c.style.display=a?"":"none");const l=document.querySelector('.settings-panel[data-settings-panel="team"]');l&&(l.dataset.permHidden=a?"0":"1");const p=document.querySelector('.settings-tab[data-tab="api"]');p&&(p.style.display=o||isSuperAdmin(e)?"":"none");const m=document.querySelector('.settings-tab[data-tab="plan"]');m&&(m.style.display=n?"none":"");const d=document.querySelector('.settings-tab[data-tab="company"]');d&&(d.style.display=n?"none":"");const u=document.getElementById("info-bar");u&&(u.style.display=n?"none":"");const f=document.getElementById("trial-banner");f&&n&&(f.style.display="none");const h=document.getElementById("plan-banner");h&&n&&(h.style.display="none",document.body.classList.remove("has-plan-banner")),document.querySelectorAll("[data-upgrade-cta], .btn-upgrade, .topbar-upgrade").forEach(_=>{_.style.display="none"}),document.body.classList.toggle("role-employee",isEmployee(e)),document.body.classList.toggle("role-owner",isOwner(e)),document.body.classList.toggle("role-super",isSuperAdmin(e));try{const _=document.querySelector(".settings-tab.active");_&&_.style.display==="none"&&(typeof window.switchSettingsTab=="function"?window.switchSettingsTab("profile"):typeof switchSettingsTab=="function"&&switchSettingsTab("profile"))}catch(_){console.warn("[v118.12.3] failed to fix active tab:",_)}if(window.PEARNLY_ADMIN_MODE){const _=document.getElementById("admin-mode-banner");_&&(_.style.display="flex"),document.querySelectorAll(".nav-item").forEach(v=>{v.classList.contains("nav-admin-only")||(v.style.display="none")}),document.querySelectorAll(".nav-group").forEach(v=>{v.classList.contains("nav-group-admin-only")||(v.style.display="none")});const w=document.getElementById("client-switcher");w&&(w.style.display="none"),document.body.classList.add("admin-mode");const y=["profile","security","notifications","about"];document.querySelectorAll(".settings-tab").forEach(v=>{const E=v.dataset.tab;E&&!y.includes(E)&&(v.style.display="none")}),document.querySelectorAll(".settings-pane").forEach(v=>{const E=v.dataset.pane;E&&!y.includes(E)&&(v.style.display="none")}),document.querySelectorAll(".settings-nav-group").forEach(v=>{const E=v.querySelectorAll(".settings-tab");Array.from(E).some(T=>T.style.display!=="none")||(v.style.display="none")})}}function Oo(){const e=_userInfo,n=document.getElementById("info-bar");if(!e||shouldHideMoney(e)){n&&(n.innerHTML="");return}let a="";const o=e.tenant_type;if(o==="byo_api")e.has_own_gemini_key?a=`
                <div class="info-chip">
        ...
        `;else{const s=e.tenant_used!=null?e.tenant_used:e.used_this_month||0,i=e.tenant_quota!=null&&e.tenant_quota>0?e.tenant_quota:e.monthly_quota||0,r=i>0?Math.min(100,s/i*100):0;let c="";r>=95?c="danger":r>=80&&(c="warn"),i>0?a=`
            ...
            `:a=""}n&&(n.innerHTML=a)}window.renderQuotaBanner=zo;window.applySidebarVisibility=No;window.renderInfoBar=Oo;async function ma(e,n){try{const a=await fetch(e,{method:"POST",headers:{Authorization:"Bearer "+token,"Content-Type":"application/json"},body:JSON.stringify(n)});if(a.status===401){localStorage.removeItem("mrpilot_token");const o=await a.json().catch(()=>({}));return(typeof o.detail=="string"?o.detail:o.detail&&o.detail.code||"")==="auth.session_revoked"?(_showSessionRevokedModal(),null):(window.location.href="/",null)}return await a.json()}catch{return{ok:!1,error:"network"}}}function va(e){return{invalid_format:"rd-err-format",not_found:"rd-err-not-found",rd_unreachable:"rd-err-unreachable",parse_error:"rd-err-unknown",network:"rd-err-unreachable"}[e]||"rd-err-unknown"}function Ht(e){const n=document.querySelector(`[data-field="${e}"]`);return n?(n.value||"").trim():""}function Ue(e,n,a){const o=document.querySelector(`[data-rd-status="${e}"]`);o&&(o.innerHTML=n,o.className="rd-status"+(a?" "+a:""))}async function Vo(e){const a=Ht(e==="seller"?"seller_tax":"buyer_tax");Ue(e,t("rd-verifying"),"loading");const o=await ma("/api/rd/verify",{tax_id:a});if(!o)return;if(!o.ok){Ue(e,t(va(o.error)),"error");return}o.data&&o.data.valid?Ue(e,`<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="2"><path d="M3 8l3 3 7-7"/></svg> ${escapeHtml(t("rd-status-valid"))}`,"valid"):Ue(e,t("rd-status-invalid"),"invalid")}async function Uo(e){const a=Ht(e==="seller"?"seller_tax":"buyer_tax");Ue(e,t("rd-syncing"),"loading");const o=await ma("/api/rd/lookup",{tax_id:a,branch:0});if(o){if(!o.ok){Ue(e,t(va(o.error)),"error");return}Ue(e,`<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="2"><path d="M3 8l3 3 7-7"/></svg> ${escapeHtml(t("rd-status-valid"))}`,"valid"),Go(e,o.data)}}function Go(e,n){const a=e==="seller"?"seller_name":"buyer_name",o=e==="seller"?"seller_addr":"buyer_addr",s=Ht(a),i=Ht(o),r=[];n.name&&n.name!==s&&r.push({field:a,label:t("rd-field-name"),current:s,official:n.name}),n.address&&n.address!==i&&r.push({field:o,label:t("rd-field-address"),current:i,official:n.address});const c=[];n.branch_label&&c.push(`<strong>${t("rd-field-branch")}:</strong> ${escapeHtml(n.branch_label)}`),n.post_code&&c.push(`<strong>${t("rd-field-postcode")}:</strong> ${escapeHtml(n.post_code)}`);let l=document.getElementById("rd-sync-modal");if(l||(l=document.createElement("div"),l.id="rd-sync-modal",l.className="rd-modal-mask",document.body.appendChild(l)),r.length===0)l.innerHTML=`
            <div class="rd-modal">
        ...
        `}l.classList.add("show");const p=()=>l.classList.remove("show");l.querySelector(".rd-modal-close").addEventListener("click",p),l.querySelectorAll("[data-rd-modal-close]").forEach(d=>d.addEventListener("click",p)),l.addEventListener("click",d=>{d.target===l&&p()});const m=l.querySelector("[data-rd-modal-apply]");m&&m.addEventListener("click",()=>{const d=_results[_drawerIdx];if(!d){p();return}l.querySelectorAll("[data-rd-apply]:checked").forEach(u=>{const f=u.dataset.field,h=u.dataset.value;d.edits[f]=h,d.merged_fields[f]=h;const _=document.querySelector(`[data-field="${f}"]`);_&&(_.value=h);const w=document.querySelector(`[data-field-wrap="${f}"]`);w&&w.classList.add("edited")}),updateDrawerEditCount(),renderResults(),p()})}window.callRdVerify=Vo;window.callRdSync=Uo;function Ko(e){const n={invoice_number:null,date:null,total_amount:null,tax_ids:[],seller_name:"",seller_tax:"",seller_addr:"",buyer_name:"",buyer_tax:"",buyer_addr:"",subtotal:"",vat:"",notes:"",items:[]},a=e.filter(s=>!s.is_duplicate&&!s.is_copy),o=a.length>0?a:e;for(const s of o){const i=s.fields||{};!n.invoice_number&&i.invoice_number&&(n.invoice_number=i.invoice_number),!n.date&&i.date&&(n.date=i.date),!n.total_amount&&i.total_amount&&(n.total_amount=i.total_amount),!n.subtotal&&i.subtotal&&(n.subtotal=i.subtotal),!n.vat&&i.vat&&(n.vat=i.vat),!n.seller_name&&i.seller_name&&(n.seller_name=i.seller_name),!n.seller_tax&&i.seller_tax&&(n.seller_tax=i.seller_tax),!n.seller_addr&&i.seller_addr&&(n.seller_addr=i.seller_addr),!n.buyer_name&&i.buyer_name&&(n.buyer_name=i.buyer_name),!n.buyer_tax&&i.buyer_tax&&(n.buyer_tax=i.buyer_tax),!n.buyer_addr&&i.buyer_addr&&(n.buyer_addr=i.buyer_addr),!n.notes&&i.notes&&(n.notes=i.notes),Array.isArray(i.items)&&i.items.length&&n.items.push(...i.items),Array.isArray(i.tax_ids)&&n.tax_ids.push(...i.tax_ids)}return n.tax_ids=[...new Set(n.tax_ids)],!n.seller_tax&&n.tax_ids[0]&&(n.seller_tax=n.tax_ids[0]),!n.buyer_tax&&n.tax_ids[1]&&(n.buyer_tax=n.tax_ids[1]),n}function Jo(e){const n=e.target.dataset.field,a=e.target.value,o=_results[_drawerIdx],s=o.merged_fields[n];a===(s??"")?delete o.edits[n]:(o.edits[n]=a,o.merged_fields[n]=a);const i=document.querySelector(`[data-field-wrap="${n}"]`);i&&i.classList.toggle("edited",o.edits[n]!==void 0),ha(),renderResults()}function ha(){const e=_results[_drawerIdx],n=e?Object.keys(e.edits).length:0,a=document.getElementById("drawer-edit-count-sub");a&&(a.textContent=n>0?t("drawer-edit-count",{n}):"")}window.mergeFields=Ko;window.onFieldEdit=Jo;window.updateDrawerEditCount=ha;function Wo(){document.querySelectorAll(".force-pw-overlay").forEach(a=>a.remove());const e=document.createElement("div");e.className="force-pw-overlay",e.innerHTML=`
    ...
    `;let s=_results.map((r,c)=>({...r,_idx:c}));if(_searchKeyword){const r=_searchKeyword.toLowerCase();s=s.filter(c=>(c.filename||"").toLowerCase().includes(r)||(c.merged_fields.invoice_number||"").toLowerCase().includes(r))}_sortKey&&s.sort((r,c)=>{let l,p;return _sortKey==="filename"?(l=r.filename,p=c.filename):_sortKey==="invoice_no"?(l=r.merged_fields.invoice_number,p=c.merged_fields.invoice_number):_sortKey==="invoice_date"?(l=r.merged_fields.date,p=c.merged_fields.date):_sortKey==="total"?(l=parseFloat(r.merged_fields.total_amount)||0,p=parseFloat(c.merged_fields.total_amount)||0):_sortKey==="confidence"?(l=r.confidence,p=c.confidence):(l="",p=""),l<p?_sortDir==="asc"?-1:1:l>p?_sortDir==="asc"?1:-1:0});const i=document.getElementById("results-tbody");i.innerHTML=s.map((r,c)=>{const l=r.merged_fields,p=`<span class="empty-cell">${t("empty-val")}</span>`,m="conf-tip-"+(r.confidence||"low"),d="conf-"+(r.confidence||"low"),u=t(m),f=t(d);return`
        ...
        `}).join(""),document.querySelectorAll("#results-table th").forEach(r=>{r.classList.remove("sort-asc","sort-desc"),r.dataset.sort===_sortKey&&r.classList.add("sort-"+_sortDir)}),i.querySelectorAll("tr").forEach(r=>{r.addEventListener("click",()=>{const c=parseInt(r.dataset.idx,10);ba(c)})})}document.querySelectorAll("#results-table th").forEach(e=>{e.classList.contains("no-sort")||e.addEventListener("click",()=>{const n=e.dataset.sort;_sortKey===n?_sortDir=_sortDir==="asc"?"desc":"asc":(_sortKey=n,_sortDir="asc"),Gt()})});let Fn=null;document.getElementById("search-input").addEventListener("input",e=>{const n=e.target.value;document.getElementById("search-clear").style.display=n?"":"none",clearTimeout(Fn),Fn=setTimeout(()=>{_searchKeyword=n.trim(),Gt(),ga()},200)});document.getElementById("search-clear").addEventListener("click",()=>{const e=document.getElementById("search-input");e.value="",_searchKeyword="",document.getElementById("search-clear").style.display="none",Gt(),ga(),e.focus()});function ga(){const e=document.getElementById("search-matches");if(!e)return;if(!_searchKeyword){e.textContent="";return}const n=_searchKeyword.toLowerCase();let a=0;for(const o of _results)[o.filename,o.merged_fields?.invoice_number,o.merged_fields?.seller_name,o.merged_fields?.buyer_name].filter(Boolean).join(" ").toLowerCase().includes(n)&&a++;e.textContent=t("search-matches",{n:a})}function ba(e){_drawerIdx=e;const n=_results[e];if(!n)return;document.getElementById("drawer-title").textContent=n.filename;const a=n.engine==="cache"||n.from_cache,o=a?t("badge-cached-hint"):`${(n.elapsed_ms/1e3).toFixed(1)}s`;document.getElementById("drawer-sub").innerHTML=`
    ...
    `,p=i?"":`<span class="tax-badge unverified" data-tip="${escapeHtml(t("tax-tip-unverified"))}">${t("tax-unverified")}</span>`;if(c.innerHTML=`
        ...
        <div class="drawer-section">
            ...
            ${r.wht_amount||r.wht_rate?`
                ${xe("wht_amount","drawer-lbl-wht-amount",r.wht_amount,"input",s,Yo(r.wht_rate))}
            `:""}
        </div>
        ...
        <div class="drawer-section">
            ...
            ${xe("seller_tax","drawer-lbl-tax",r.seller_tax,"input",s,p,zn("seller"))}
        ...
        <div class="drawer-section">
            ...
            ${xe("buyer_tax","drawer-lbl-tax",r.buyer_tax,"input",s,p,zn("buyer"))}
        ...
        <div class="drawer-section">
            ...
            ${r.items&&r.items.length>0?Xo(r.items):`<div class="drawer-items-empty">${t("drawer-items-empty")}</div>`}
        </div>
...
`))}</pre>
    ...
    `;n.innerHTML=o+s,e.appendChild(n)}function Xt(){const e=document.getElementById("export-dropdown");e&&e.remove()}const Zt=document.getElementById("btn-export-arrow");Zt&&Zt.addEventListener("click",e=>{e.stopPropagation(),!Zt.disabled&&as()});document.addEventListener("click",e=>{const n=e.target.closest(".export-dd-item");if(n){const a=n.getAttribute("data-tpl");if(a==="__custom"){Xt(),showToast(t("cs-coming-soon"),"info");return}ns(a),Xt(),ka(a);return}e.target.closest("#btn-export-arrow")||Xt()});function os(){const e=document.getElementById("btn-export-arrow"),n=document.getElementById("btn-export");e&&n&&(e.disabled=n.disabled)}setInterval(os,300);const ss=`
        <div class="page-head-clean">
            <div class="page-head-icon">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
...
`;(function(){const e=document.getElementById("page-history");if(!(!e||e.dataset.wbInjected==="1")){e.innerHTML=ss,e.dataset.wbInjected="1";try{const n=window._currentLang||localStorage.getItem("mrpilot_lang")||"th",a=window.I18N;a&&a[n]&&(e.querySelectorAll("[data-i18n]").forEach(o=>{const s=o.getAttribute("data-i18n");a[n][s]&&(o.textContent=a[n][s])}),e.querySelectorAll("[data-i18n-placeholder]").forEach(o=>{const s=o.getAttribute("data-i18n-placeholder");a[n][s]&&(o.placeholder=a[n][s])}))}catch{}}})();function un(){const e=document.getElementById("history-batch-bar"),n=document.getElementById("history-batch-count"),a=document.getElementById("history-check-all");if(!e||!n)return;const o=_historySelected.size;if(o>0?(e.style.display="",n.textContent=t("history-batch-count",{n:o})):e.style.display="none",a){const s=_historyState.items||[];if(s.length===0)a.checked=!1,a.indeterminate=!1;else{const i=s.filter(r=>_historySelected.has(r.id)).length;a.checked=i===s.length,a.indeterminate=i>0&&i<s.length}}}function is(){_historySelected.clear(),un()}async function fn(){if(!_userInfo){setTimeout(()=>fn(),300);return}const e=document.getElementById("history-free-block"),n=document.getElementById("history-main"),a=document.getElementById("history-empty");if(!e||!n||!a){console.warn("[History] container missing");return}if(!_userInfo.can_view_history){e.style.display="",n.style.display="none",a.style.display="none";return}e.style.display="none",_historyState.loading=!0;try{const o=_historyState.page*_historyState.pageSize,s=new URLSearchParams({limit:_historyState.pageSize,offset:o});_historyState.keyword&&s.set("keyword",_historyState.keyword);const i=typeof window.getCurrentClientId=="function"?window.getCurrentClientId():null;i&&s.set("client_id",String(i));const r=await fetch(`/api/history?${s}`,{headers:{Authorization:"Bearer "+token}});if(r.status===401){localStorage.removeItem("mrpilot_token");const p=await r.json().catch(()=>({}));if((typeof p.detail=="string"?p.detail:p.detail&&p.detail.code||"")==="auth.session_revoked"){_showSessionRevokedModal();return}window.location.href="/";return}const c=await r.json();_historyState.items=c.items||[],_historyState.total=c.total||0;const l=new Set(_historyState.items.map(p=>p.id));for(const p of Array.from(_historySelected))l.has(p)||_historySelected.delete(p);xa()}catch(o){console.error("load history failed",o)}finally{_historyState.loading=!1}}function xa(){const e=document.getElementById("history-main"),n=document.getElementById("history-empty"),a=_historyState.items,o=document.getElementById("history-search-matches");if(o&&(o.textContent=_historyState.keyword?t("search-matches",{n:_historyState.total}):""),a.length===0&&_historyState.total===0&&!_historyState.keyword){e.style.display="none",n.style.display="";return}e.style.display="",n.style.display="none";let s=0;a.forEach(p=>{p.confidence==="high"&&s++});const i=a.length>0?Math.round(s/a.length*100):0;document.getElementById("history-stats").innerHTML=`
        <div class="rh-stat">
    ...
    `;const r=document.getElementById("history-tbody");a.length===0?r.innerHTML=`<div class="history-row-empty">${escapeHtml(t("history-empty-title"))}</div>`:r.innerHTML=a.map(p=>{const m=new Date(p.created_at),d=String(m.getMonth()+1).padStart(2,"0"),u=String(m.getDate()).padStart(2,"0"),f=String(m.getHours()).padStart(2,"0"),h=String(m.getMinutes()).padStart(2,"0"),_=`${d}-${u} ${f}:${h}`,w=escapeHtml(p.filename||""),y=w.length>50?w.substring(0,50)+"…":w,v=p.invoice_no?escapeHtml(p.invoice_no):y,E=[];p.seller_name&&E.push(escapeHtml(p.seller_name)),p.invoice_no&&p.filename&&E.push(y);const B=E.join(" · ")||"-",T=p.category_tag?`<span class="history-badge category">${escapeHtml(p.category_tag)}</span>`:"",S=p.source_total&&p.source_total>1?`<span class="history-badge multi">${escapeHtml(t("invoice-part-of",{i:p.source_index||1,n:p.source_total}))}</span>`:"",b=p.total_amount!==null&&p.total_amount!==void 0?Number(p.total_amount).toLocaleString(void 0,{minimumFractionDigits:2,maximumFractionDigits:2}):'<span class="history-cell-amount-empty">—</span>',g=[];(p.total_amount===null||p.total_amount===void 0)&&g.push(t("field-amount")),p.invoice_no||g.push(t("field-invoice-no")),p.invoice_date||g.push(t("field-invoice-date")),p.seller_name||g.push(t("field-seller-name")),g.length>0&&`${escapeHtml(p.id)}${escapeHtml(t("history-needs-review-tip")+" · "+g.join(" · "))}${escapeHtml(t("history-needs-review-tip"))}${svgIcon("alert",14)}`,p.edited&&`${escapeHtml(t("history-edited",{n:p.edit_count||1}))}`;const x=p.smart_assigned_flag?`<span class="history-badge smart-assigned" title="${escapeHtml(t("history-smart-assigned"))}">${svgIcon("sparkle",11)}</span>`:"",I=p.confidence==="high"?"high":p.confidence==="medium"?"mid":"low",L=p.confidence==="high"?t("conf-high"):p.confidence==="medium"?t("conf-medium"):t("conf-low"),C=`<span class="history-badge conf-${I}">${escapeHtml(L)}</span>`;let k="";const M=p.source||"manual";return M==="email"?k=`<span class="history-badge source source-email" title="${escapeHtml(t("history-source-email"))}">${svgIcon("mail",11)}<span>${escapeHtml(t("history-source-email"))}</span></span>`:M==="folder"?k=`<span class="history-badge source source-folder" title="${escapeHtml(t("history-source-folder"))}">${svgIcon("folder",11)}<span>${escapeHtml(t("history-source-folder"))}</span></span>`:M==="api"&&(k=`<span class="history-badge source source-api" title="${escapeHtml(t("history-source-api"))}">${svgIcon("api",11)}<span>${escapeHtml(t("history-source-api"))}</span></span>`),`
                <div class="history-row" data-hid="${escapeHtml(p.id)}">
                    ...
                    <div class="history-cell-file">
                        <div class="history-cell-filename">${v} ${T} ${S} ${k} ${x}</div>
                        <div class="history-cell-subtitle">${B}</div>
                    </div>
                    <div class="history-cell-amount">${b}</div>
            ...
            `}).join(""),un();const c=a.length>0?_historyState.page*_historyState.pageSize+1:0,l=_historyState.page*_historyState.pageSize+a.length;document.getElementById("history-pager-info").textContent=t("history-pager",{from:c,to:l,total:_historyState.total}),document.getElementById("history-prev").disabled=_historyState.page===0,document.getElementById("history-next").disabled=(_historyState.page+1)*_historyState.pageSize>=_historyState.total}window.loadHistoryPage=fn;window.renderHistoryList=xa;window.updateHistoryBatchBar=un;window.clearHistorySelection=is;typeof currentRoute<"u"&&currentRoute==="history"&&fn();async function At(e){try{const n=await fetch(`/api/history/${encodeURIComponent(e)}`,{headers:{Authorization:"Bearer "+token}});if(!n.ok)return;const a=await n.json(),o=mergeFields(a.pages||[]),s={filename:a.filename,pages:a.pages,page_count:a.page_count,elapsed_ms:a.elapsed_ms,engine:"history",merged_fields:o,edits:{},confidence:a.confidence,archive_name:a.archive_name||null,category_tag:a.category_tag||null,_historyId:a.id,_historyMode:!0,client_id:a.client_id||null};_results.push(s),_drawerIdx=_results.length-1,openDrawer(_drawerIdx),ls(),typeof window.bindDrawerClient=="function"&&window.bindDrawerClient(a.id,a.client_id||null),cs(a.id)}catch(n){console.error("open history detail failed",n)}}async function rs(e){await At(e),requestAnimationFrame(()=>{const n=document.querySelector('[data-field="total_amount"]');if(n){try{n.focus()}catch{}try{n.select()}catch{}try{n.scrollIntoView({block:"center",behavior:"smooth"})}catch{}}})}function ls(){const e=document.getElementById("drawer-body");if(!e||document.getElementById("drawer-history-save"))return;const n=document.createElement("div");n.id="drawer-history-save",n.className="drawer-history-save-bar",n.innerHTML=`
    ...
    `,e.appendChild(n),document.getElementById("btn-save-history").addEventListener("click",ps),document.getElementById("btn-push-erp").addEventListener("click",ds)}async function cs(e){}async function ds(){showToast(t("erp-push-coming-soon")||"ERP 推送即将开放，敬请期待","info")}async function ps(){const e=_results[_drawerIdx];if(!e||!e._historyId)return;const n=JSON.parse(JSON.stringify(e.pages||[]));if(n.length>0){const o=n.findIndex(c=>!c.is_duplicate&&!c.is_copy),s=o>=0?o:0,i=n[s].fields||(n[s].fields={}),r={...e.edits};r.category_tag!==void 0&&(r.category=r.category_tag,delete r.category_tag),Object.assign(i,r)}const a=document.getElementById("btn-save-history");a&&(a.disabled=!0);try{if(!(await fetch(`/api/history/${encodeURIComponent(e._historyId)}`,{method:"PUT",headers:{Authorization:"Bearer "+token,"Content-Type":"application/json"},body:JSON.stringify({pages:n})})).ok)throw new Error("save failed");showAlert("info",t("history-save-ok")),setTimeout(hideAlerts,1500),closeDrawer(),e._historyMode&&_results.pop(),loadHistoryPage()}catch{showAlert("error",t("history-save-fail")),a&&(a.disabled=!1)}}function us(e,n){document.querySelectorAll(".history-popover").forEach(p=>p.remove());const a=n.getBoundingClientRect(),o=(_historyState.items||[]).find(p=>p.id===e),s=o&&o.invoice_no?String(o.invoice_no):"",i=o&&o.has_pdf===!0,r=document.createElement("div");r.className="history-popover",r.innerHTML=`
    ...
    `,r.style.top=a.bottom+4+"px",r.style.left=a.right-160+"px",document.body.appendChild(r);const c=()=>{r.remove(),document.removeEventListener("click",l,!0)},l=p=>{!r.contains(p.target)&&p.target!==n&&c()};setTimeout(()=>document.addEventListener("click",l,!0),0),r.addEventListener("click",async p=>{const m=p.target.closest("[data-act]");if(!m||m.disabled)return;const d=m.dataset.act;if(c(),d==="copy-invno"){if(!s)return;try{await navigator.clipboard.writeText(s),showToast(t("history-copy-invno-ok",{no:s}),"success")}catch{try{const f=document.createElement("textarea");f.value=s,f.style.position="fixed",f.style.opacity="0",document.body.appendChild(f),f.select(),document.execCommand("copy"),document.body.removeChild(f),showToast(t("history-copy-invno-ok",{no:s}),"success")}catch{showToast(t("history-copy-invno-fail"),"error")}}}else if(d==="download-pdf"){const u=showToast(t("history-download-pdf-loading"),"loading",0);try{const f=await fetch(`/api/history/${encodeURIComponent(e)}/pdf`,{headers:{Authorization:"Bearer "+token}});if(!f.ok)throw new Error("download failed");const h=await f.blob(),_=URL.createObjectURL(h),w=document.createElement("a");w.href=_,w.download=o&&o.filename?o.filename.endsWith(".pdf")?o.filename:o.filename+".pdf":"invoice.pdf",document.body.appendChild(w),w.click(),document.body.removeChild(w),setTimeout(()=>URL.revokeObjectURL(_),5e3),u(),showToast(t("history-download-pdf-ok"),"success")}catch{u(),showToast(t("history-download-pdf-fail"),"error")}}else if(d==="delete"){if(!await showConfirm(t("history-confirm-delete"),{danger:!0}))return;try{if(!(await fetch(`/api/history/${encodeURIComponent(e)}`,{method:"DELETE",headers:{Authorization:"Bearer "+token}})).ok)throw new Error;showAlert("info",t("history-delete-ok")),setTimeout(hideAlerts,1500),loadHistoryPage()}catch{showAlert("error",t("history-delete-fail"))}}})}(function(){document.addEventListener("click",r=>{const c=r.target.closest(".history-row"),l=r.target.closest("[data-hmenu]");if(l){r.stopPropagation(),us(l.dataset.hmenu,l);return}const p=r.target.closest("[data-review]");if(p){r.stopPropagation(),At(p.dataset.review);return}const m=r.target.closest("[data-fill-amount]");if(m){r.stopPropagation(),rs(m.dataset.fillAmount);return}r.target.closest(".history-row-check")||r.target.closest(".history-cell-check")||c&&!r.target.closest("[data-hmenu]")&&At(c.dataset.hid)});const n=document.getElementById("history-tbody");n&&n.addEventListener("change",r=>{const c=r.target.closest(".history-row-check");if(!c)return;const l=c.dataset.hid;c.checked?_historySelected.add(l):_historySelected.delete(l),updateHistoryBatchBar()});const a=document.getElementById("history-check-all");a&&a.addEventListener("change",r=>{const c=r.target.checked;for(const l of _historyState.items)c?_historySelected.add(l.id):_historySelected.delete(l.id);document.querySelectorAll(".history-row-check").forEach(l=>{l.checked=c}),updateHistoryBatchBar()});const o=document.getElementById("history-batch-cancel");o&&o.addEventListener("click",()=>{clearHistorySelection(),document.querySelectorAll(".history-row-check").forEach(r=>{r.checked=!1})});const s=document.getElementById("history-batch-delete");s&&s.addEventListener("click",async()=>{const r=_historySelected.size;if(r===0||!await showConfirm(t("history-batch-confirm",{n:r}),{danger:!0}))return;const l=Array.from(_historySelected);try{const p=await fetch("/api/history/batch-delete",{method:"POST",headers:{Authorization:"Bearer "+token,"Content-Type":"application/json"},body:JSON.stringify({ids:l})});if(!p.ok)throw new Error("batch delete failed");const m=await p.json();showToast(t("history-batch-done",{n:m.deleted||0}),"success"),clearHistorySelection(),loadHistoryPage()}catch(p){console.error("batch delete",p),showToast(t("history-batch-fail"),"error")}});let i=null;document.getElementById("history-search").addEventListener("input",r=>{const c=r.target.value;document.getElementById("history-search-clear").style.display=c?"":"none",clearTimeout(i),i=setTimeout(()=>{_historyState.keyword=c.trim(),_historyState.page=0,clearHistorySelection(),loadHistoryPage()},300)}),document.getElementById("history-search-clear").addEventListener("click",()=>{const r=document.getElementById("history-search");r.value="",_historyState.keyword="",_historyState.page=0,clearHistorySelection(),document.getElementById("history-search-clear").style.display="none",loadHistoryPage(),r.focus()}),document.getElementById("history-range").addEventListener("change",r=>{_historyState.range=parseInt(r.target.value,10),_historyState.page=0,clearHistorySelection(),loadHistoryPage()}),document.getElementById("history-prev").addEventListener("click",()=>{_historyState.page>0&&(_historyState.page--,clearHistorySelection(),loadHistoryPage())}),document.getElementById("history-next").addEventListener("click",()=>{(_historyState.page+1)*_historyState.pageSize<_historyState.total&&(_historyState.page++,clearHistorySelection(),loadHistoryPage())})})();window.openHistoryDrawer=At;const st=document.getElementById("drop-zone"),mn=document.getElementById("file-input");st.addEventListener("click",()=>mn.click());mn.addEventListener("change",e=>_a(e.target.files));["dragover","dragenter"].forEach(e=>{st.addEventListener(e,n=>{n.preventDefault(),st.classList.add("drag-over")})});["dragleave","drop"].forEach(e=>{st.addEventListener(e,n=>{n.preventDefault(),st.classList.remove("drag-over")})});st.addEventListener("drop",e=>{e.preventDefault(),_a(e.dataTransfer.files)});const fs=/\.(pdf|png|jpe?g|webp|tiff?|bmp|gif|xlsx?|xlsm|csv|tsv|docx?|txt)$/i;function an(e){return e.type&&e.type.startsWith("image/")||/\.(png|jpe?g|webp|tiff?|bmp|gif)$/i.test(e.name)}function ms(e){return e.type==="application/pdf"||/\.pdf$/i.test(e.name)}function vs(e){return ms(e)||an(e)||fs.test(e.name)}function _a(e){hideAlerts();const n=Array.from(e),a=n.filter(vs);a.length!==n.length&&showAlert("warn",t("alert-unsupported-format"));const o=a.filter(c=>!an(c)),s=a.filter(an),i=new Set(_selectedFiles.map(c=>c.name+"_"+c.size));for(const c of o){const l=c.name+"_"+c.size;i.has(l)||(_selectedFiles.push({file:c,name:c.name,size:c.size,status:"waiting",errorKey:null,errorParams:null}),i.add(l))}if(s.length>0)try{handleCameraImages(s,"gallery")}catch(c){console.error("[upload] image route failed",c)}const r=getMaxFiles();_selectedFiles.length>r&&(showAlert("warn",t("alert-file-count",{n:r})),_selectedFiles=_selectedFiles.slice(0,r)),Kt(),vn(),mn.value=""}let Tt=!1;function Kt(){const e=document.getElementById("file-list");if(!e)return;if(_selectedFiles.length===0){e.classList.remove("has-files"),e.innerHTML="";return}e.classList.add("has-files");const n=_selectedFiles.length,a=_selectedFiles.filter(d=>d.status==="processing"||d.status==="retrying").length,o=_selectedFiles.filter(d=>d.status==="success").length,s=_selectedFiles.filter(d=>d.status==="error").length;let i=`<span class="count">${escapeHtml(t("file-list-total",{n}))}</span>`;const r=[];a&&r.push(`<span style="color: var(--accent, #111111);">${a} ${escapeHtml(t("status-processing"))}</span>`),o&&r.push(`<span style="color: var(--success, #059669);">${o} ${escapeHtml(t("status-success"))}</span>`),s&&r.push(`<span style="color: var(--danger, #dc2626);">${s} ${escapeHtml(t("status-error"))}</span>`),r.length&&(i+=" · "+r.join(" · "));const c=Tt?t("file-list-collapse"):t("file-list-expand"),l=_selectedFiles.map((d,u)=>{let f=t("status-"+d.status);d.status==="retrying"&&(f=t("status-retrying")),d.status==="error"&&d.errorKey&&(f=t(d.errorKey,d.errorParams||{}));const h=d.status==="processing"||d.status==="retrying"?'<span class="spinner"></span>':"",_=d.status==="error"&&d.canRetry?`<button class="file-retry-btn" data-retry-idx="${u}" title="${escapeHtml(t("upload-retry-btn"))}">${svgIcon("refresh",12)}<span>${escapeHtml(t("upload-retry-btn"))}</span></button>`:"",w=d.status==="success"&&d.fromCache?`<span class="file-cache-badge">${svgIcon("cache",11)}<span>${escapeHtml(t("cache-hit-badge"))}</span></span>`:"";return`
            <li class="file-item">
                ...
                ${w}
                <span class="file-status ${d.status}">${h}${f}</span>
                ${_}
            </li>
        `}).join("");e.innerHTML=`
        ...
        <ul class="file-list-body${Tt?" expanded":""}" id="file-list-body">
            ${l}
        </ul>
    `;const p=document.getElementById("file-list-toggle");p&&p.addEventListener("click",()=>{Tt=!Tt,Kt()});const m=document.getElementById("file-list-body");m&&!m.dataset.retryBound&&(m.dataset.retryBound="1",m.addEventListener("click",async d=>{const u=d.target.closest(".file-retry-btn");if(!u)return;const f=parseInt(u.dataset.retryIdx||"-1",10);if(f<0||f>=_selectedFiles.length)return;const h=_selectedFiles[f];!h||h.status!=="error"||typeof window._reprocessFile=="function"&&await window._reprocessFile(h,!0)}))}function vn(){const e=document.getElementById("btn-start"),n=document.getElementById("btn-clear"),a=document.getElementById("btn-export"),o=_selectedFiles.some(s=>s.status==="waiting");e.disabled=_selectedFiles.length===0||!o,n.disabled=_selectedFiles.length===0&&_results.length===0,a.disabled=_results.length===0}document.getElementById("btn-clear").addEventListener("click",()=>{_selectedFiles=[],_results=[],Kt(),renderResults(),vn(),hideAlerts()});window.renderFileList=Kt;window.updateStartButton=vn;const hs=`
    <div class="modal" style="max-width:420px;">
        <div class="modal-head">
...
`;we("camera-tips-modal",hs);(function(){const n=document.getElementById("upload-alt-row"),a=document.getElementById("gallery-input"),o=document.getElementById("camera-input");if(!n)return;n.style.display="";const s=document.getElementById("btn-scan-doc");s&&o&&(s.addEventListener("click",async()=>{!(localStorage.getItem("mrpilot_camera_tips_skip")==="1")&&!await bs()||o.click()}),o.addEventListener("change",async c=>{const l=Array.from(c.target.files||[]);if(c.target.value="",l.length!==0)for(const p of l)await on([p],"camera")}));const i=document.getElementById("btn-upload-pic");i&&a&&i.addEventListener("click",()=>a.click());const r=c=>async l=>{const p=Array.from(l.target.files||[]);if(l.target.value="",p.length===0)return;const m=p.filter(u=>u.type==="application/pdf"||/\.pdf$/i.test(u.name)),d=p.filter(u=>!m.includes(u));m.length>0&&await gs(m),d.length>0&&await on(d,c)};a&&a.addEventListener("change",r("gallery"))})();async function gs(e){for(const a of e)_selectedFiles.push({file:a,name:a.name,size:a.size,status:"waiting",errorKey:null,errorParams:null});const n=getMaxFiles();_selectedFiles.length>n&&(showAlert("warn",t("alert-file-count",{n})),_selectedFiles=_selectedFiles.slice(0,n)),renderFileList(),updateStartButton()}function bs(){return new Promise(e=>{const n=document.getElementById("camera-tips-modal"),a=document.getElementById("camera-tips-ok"),o=document.getElementById("camera-tips-cancel"),s=document.getElementById("camera-tips-skip");if(!n||!a){e(!0);return}s&&(s.checked=!1),n.style.display="flex";const i=c=>{n.style.display="none",s&&s.checked&&localStorage.setItem("mrpilot_camera_tips_skip","1"),a.onclick=null,o&&(o.onclick=null),n.onclick=null,document.removeEventListener("keydown",r),e(c)},r=c=>{c.key==="Escape"&&i(!1)};a.onclick=()=>i(!0),o&&(o.onclick=()=>i(!1)),n.onclick=c=>{c.target===n&&i(!1)},document.addEventListener("keydown",r),setTimeout(()=>a.focus(),50)})}async function jt(e){return new Promise(n=>{const a=new FileReader;a.onerror=()=>n({warnings:[],width:0,height:0,brightness:128}),a.onload=()=>{const o=new Image;o.onerror=()=>n({warnings:[],width:0,height:0,brightness:128}),o.onload=()=>{const s=[],i=o.naturalWidth,r=o.naturalHeight;(i<1e3||r<1e3)&&s.push("low_res");try{const c=document.createElement("canvas");c.width=64,c.height=64;const l=c.getContext("2d");l.drawImage(o,0,0,64,64);const p=l.getImageData(0,0,64,64).data;let m=0,d=0;for(let f=0;f<p.length;f+=4)m+=.299*p[f]+.587*p[f+1]+.114*p[f+2],d++;const u=d?m/d:128;u<70?s.push("too_dark"):u>235&&s.push("too_bright"),n({warnings:s,width:i,height:r,brightness:u})}catch{n({warnings:s,width:i,height:r,brightness:128})}},o.src=a.result},a.readAsDataURL(e)})}let Le=[],Ve=null;async function on(e,n){if(hideAlerts(),!(!e||e.length===0)){var a=typeof window.getOcrDocumentMode=="function"?window.getOcrDocumentMode():"invoice";if(a==="thai_id_card"){for(const s of e)_selectedFiles.push({file:s,name:s.name,size:s.size,status:"waiting",errorKey:null,errorParams:null});const o=getMaxFiles();_selectedFiles.length>o&&(showAlert("warn",t("alert-file-count",{n:o})),_selectedFiles=_selectedFiles.slice(0,o)),renderFileList(),updateStartButton();return}if(typeof window.jspdf>"u"||!window.jspdf.jsPDF){showToast(t("camera-loading"),"info");for(let o=0;o<30&&(await new Promise(s=>setTimeout(s,100)),!(window.jspdf&&window.jspdf.jsPDF));o++);if(!window.jspdf||!window.jspdf.jsPDF){showToast(t("camera-lib-fail"),"error");return}}if(n==="camera"&&e.length===1){const o=e[0];let s={};try{s=await jt(o)}catch{}Le.push({file:o,quality:s}),Ve="camera",Qe();return}if(n==="gallery"&&(e.length>=2||Le.length>0)){for(const o of e){let s={};try{s=await jt(o)}catch{}Le.push({file:o,quality:s})}Ve="gallery",Qe();return}await Ea(e)}}async function ys(e){const n=new Set;for(const o of e)try{((await jt(o)).warnings||[]).forEach(i=>n.add(i))}catch{}try{const o=await Ba(e);o&&_selectedFiles.push({file:o,name:o.name,size:o.size,status:"waiting",errorKey:null,errorParams:null})}catch(o){console.error("[camera] convert failed",o),showToast(t("camera-convert-fail"),"error");return}const a=getMaxFiles();_selectedFiles.length>a&&(showAlert("warn",t("alert-file-count",{n:a})),_selectedFiles=_selectedFiles.slice(0,a)),renderFileList(),updateStartButton(),showToast(t("camera-added-merged",{n:e.length}),"success"),n.size>0&&setTimeout(()=>{n.has("too_dark")?showToast(t("camera-quality-dark"),"warn"):n.has("low_res")?showToast(t("camera-quality-lowres"),"warn"):n.has("too_bright")&&showToast(t("camera-quality-overexposed"),"warn")},1e3)}function Qe(){let e=document.getElementById("camera-buffer-bar");if(Le.length===0){e&&e.remove(),Ve=null;return}e||(e=document.createElement("div"),e.id="camera-buffer-bar",e.className="camera-buffer-bar",document.body.appendChild(e));const n=Le.length,a=n>=2,o=Ve==="gallery",s=o?t("camera-buffer-more-gallery"):t("camera-buffer-more");let i;a?o?i=`
    ...
    `,e.querySelector('[data-cbb-action="discard"]').onclick=()=>{Le=[],Ve=null,Qe()},e.querySelector('[data-cbb-action="more"]').onclick=()=>{const l=o?"gallery-input":"camera-input",p=document.getElementById(l);p&&p.click()};const r=e.querySelector('[data-cbb-action="merge"]');r&&(r.onclick=async()=>{const l=Le.map(p=>p.file);Le=[],Ve=null,Qe(),await ys(l)});const c=e.querySelector('[data-cbb-action="separate"]');c&&(c.onclick=async()=>{const l=Le.map(p=>p.file);Le=[],Ve=null,Qe(),await Ea(l)})}typeof window.subscribeI18n=="function"&&window.subscribeI18n("camera-buffer-bar",()=>{Le.length>0&&Qe()});async function Ea(e){const n=new Set;let a=0;for(const s of e)try{((await jt(s)).warnings||[]).forEach(c=>n.add(c));const r=await Ba([s]);r&&(_selectedFiles.push({file:r,name:r.name,size:r.size,status:"waiting",errorKey:null,errorParams:null}),a++)}catch(i){console.error("[camera] separate convert failed",i)}if(a===0){showToast(t("camera-convert-fail"),"error");return}const o=getMaxFiles();_selectedFiles.length>o&&(showAlert("warn",t("alert-file-count",{n:o})),_selectedFiles=_selectedFiles.slice(0,o)),renderFileList(),updateStartButton(),showToast(t("camera-added-separate",{n:a}),"success"),n.size>0&&setTimeout(()=>{n.has("too_dark")?showToast(t("camera-quality-dark"),"warn"):n.has("low_res")?showToast(t("camera-quality-lowres"),"warn"):n.has("too_bright")&&showToast(t("camera-quality-overexposed"),"warn")},1e3)}async function Ba(e){if(!e||e.length===0)return null;const{jsPDF:n}=window.jspdf,a=210,o=297,s=new n({unit:"mm",format:"a4",orientation:"p"});for(let p=0;p<e.length;p++){const m=e[p],{dataUrl:d,naturalW:u,naturalH:f}=await ws(m);p>0&&s.addPage("a4","p");const h=u/f;let _=a-10,w=_/h;w>o-10&&(w=o-10,_=w*h);const y=(a-_)/2,v=(o-w)/2,E=m.type==="image/png"?"PNG":"JPEG";s.addImage(d,E,y,v,_,w,void 0,"FAST")}const i=s.output("blob"),r=new Date,c=r.getFullYear().toString()+String(r.getMonth()+1).padStart(2,"0")+String(r.getDate()).padStart(2,"0")+String(r.getHours()).padStart(2,"0")+String(r.getMinutes()).padStart(2,"0")+String(r.getSeconds()).padStart(2,"0"),l=e.length>1?`_${e.length}p`:"";return new File([i],`photo_${c}${l}.pdf`,{type:"application/pdf"})}function ws(e){return new Promise((n,a)=>{const o=new FileReader;o.onerror=a,o.onload=()=>{const s=new Image;s.onerror=a,s.onload=()=>n({dataUrl:o.result,naturalW:s.naturalWidth,naturalH:s.naturalHeight}),s.src=o.result},o.readAsDataURL(e)})}window.handleCameraImages=on;(function(){var e="pearnly_ocr_doc_mode",n=!1,a=!1;function o(u){return typeof escapeHtml=="function"?escapeHtml(u==null?"":String(u)):String(u??"")}function s(){try{return localStorage.getItem(e)==="thai_id_card"?"thai_id_card":"invoice"}catch{return"invoice"}}window.getOcrDocumentMode=function(){return n?s():"invoice"};function i(){var u=document.getElementById("drop-zone");return u?u.closest(".card"):null}function r(){var u=i();if(!u)return null;var f=u.querySelector("#ocr-doc-mode");if(f)return f;var h=u.querySelector(".section-head");return f=document.createElement("div"),f.id="ocr-doc-mode",f.className="ocr-doc-mode",f.setAttribute("role","tablist"),f.style.cssText="display:none;gap:6px;margin:0 0 14px;padding:4px;border-radius:10px;background:var(--bg,#f5f5f3);border:1px solid var(--line,#e5e5e0);width:fit-content;",h&&h.parentNode?h.parentNode.insertBefore(f,h.nextSibling):u.insertBefore(f,u.firstChild),f}function c(u,f,h){return'<button type="button" class="ocr-doc-seg'+(h?" active":"")+'" data-doc-mode="'+u+'" role="tab" aria-selected="'+(h?"true":"false")+'" style="border:none;background:'+(h?"var(--card,#fff)":"transparent")+";color:var(--ink,#1a1a1a);font:inherit;font-size:13px;font-weight:"+(h?"600":"500")+";padding:6px 16px;border-radius:7px;cursor:pointer;box-shadow:"+(h?"0 1px 3px rgba(0,0,0,.08)":"none")+';transition:background .15s;">'+o(t(f))+"</button>"}function l(){var u=r();if(u){if(!n){u.style.display="none";return}var f=s();u.style.display="flex",u.innerHTML=c("invoice","ocr-mode-invoice",f==="invoice")+c("thai_id_card","ocr-mode-id-card",f==="thai_id_card")}}function p(u){try{localStorage.setItem(e,u==="thai_id_card"?"thai_id_card":"invoice")}catch{}l();try{document.dispatchEvent(new CustomEvent("ocr-doc-mode-change",{detail:{mode:window.getOcrDocumentMode()}}))}catch{}}async function m(u){if(!(a&&!u)){var f=localStorage.getItem("mrpilot_token");if(f)try{var h=await fetch("/api/erp/endpoints",{headers:{Authorization:"Bearer "+f}});if(!h.ok)return;var _=await h.json(),w=_&&_.items||[];n=w.some(function(y){return y&&(y.adapter||"").toLowerCase()==="mrerp_dms"&&y.enabled!==!1}),a=!0,window._dmsHasEndpoint=n,l()}catch{}}}window._refreshOcrDocMode=function(){m(!0)},document.addEventListener("click",function(u){var f=u.target.closest(".ocr-doc-seg");f&&f.getAttribute("data-doc-mode")&&(u.preventDefault(),p(f.getAttribute("data-doc-mode")))}),typeof window.subscribeI18n=="function"&&window.subscribeI18n("ocr-doc-mode",l);function d(){r(),l(),m(!1)}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",d):d(),window.addEventListener("hashchange",function(){((location.hash||"").indexOf("ocr")>=0||location.hash===""||location.hash==="#home")&&setTimeout(function(){r(),m(!1)},60)})})();(function(){function e(i){return typeof escapeHtml=="function"?escapeHtml(i==null?"":String(i)):String(i??"")}function n(){var i=(function(){var c=document.getElementById("drop-zone");return c?c.closest(".card"):null})();if(!i||!i.parentNode)return null;var r=document.getElementById("dms-id-card-result");return r||(r=document.createElement("div"),r.id="dms-id-card-result",r.className="card",r.style.cssText="display:none;margin-top:16px;",i.parentNode.insertBefore(r,i.nextSibling),r)}function a(i,r){return'<div style="display:flex;justify-content:space-between;gap:16px;padding:8px 0;border-bottom:1px solid var(--line,#eee);"><span style="color:var(--muted,#6b6b66);font-size:13px;">'+e(t(i))+'</span><span style="font-weight:600;font-size:13px;text-align:right;word-break:break-all;">'+e(r||"—")+"</span></div>"}function o(i){if(!i)return"";var r=[i.house_no,i.road,i.subdistrict,i.district,i.province,i.zipcode].filter(function(c){return c});return r.join(" ")||i.address_raw||""}function s(i){var r=i&&i.status||"failed",c,l,p;return r==="success"?(c="#0a7a2c",l="#d6f5e0",p="dms-result-status-success"):r==="needs_review"?(c="#9a6b00",l="#fdf0d0",p="dms-result-status-needs-review"):r==="skipped"?(c="#5d5d57",l="#eee",p="dms-result-status-skipped"):(c="#b3261e",l="#fbe0de",p="dms-result-status-failed"),'<span style="display:inline-block;padding:3px 12px;border-radius:999px;font-size:12px;font-weight:600;color:'+c+";background:"+l+';">'+e(t(p))+"</span>"}window.renderDmsIdCardResult=function(i){var r=n();if(r){i=i||{};var c=i.id_card||{},l=c.address||{},p=i.dms_push||{},m=p.status||(i.ok?"success":"failed"),d="";m==="success"&&(d=a("dms-result-customer",p.customer_id)+a("dms-result-booking",p.booking_no));var u=m==="failed"||m==="needs_review"?'<button type="button" class="btn btn-ghost btn-tiny" id="dms-id-card-retry" style="margin-top:12px;">'+e(t("dms-result-retry"))+"</button>":"",f="";if(m==="failed"&&p.error_code){var h="dms-err-"+String(p.error_code).toLowerCase(),_=t(h);(!_||_===h)&&(_=t("dms-err-err_dms_unexpected")),f='<div style="margin-top:8px;color:#b3261e;font-size:12px;">'+e(_)+"</div>"}r.style.display="",r.innerHTML='<div class="section-head" style="display:flex;align-items:center;justify-content:space-between;"><div class="section-title">'+e(t("dms-result-title"))+"</div>"+s(p)+'</div><div style="margin-top:8px;">'+a("dms-result-name",(c.first_name||"")+" "+(c.last_name||""))+a("dms-result-id",c.people_id_masked)+a("dms-result-birthday",c.birthday_be)+a("dms-result-address",o(l))+d+"</div>"+f+u}},window.clearDmsIdCardResult=function(){var i=document.getElementById("dms-id-card-result");i&&(i.style.display="none",i.innerHTML="")},document.addEventListener("click",function(i){i.target.closest("#dms-id-card-retry")&&(i.preventDefault(),typeof window._dmsRetryIdCard=="function"&&window._dmsRetryIdCard())})})();document.getElementById("btn-start").addEventListener("click",async()=>{if(hideAlerts(),document.getElementById("btn-start").disabled=!0,(typeof window.getOcrDocumentMode=="function"?window.getOcrDocumentMode():"invoice")==="thai_id_card"){try{await Ia()}finally{const d=document.getElementById("btn-start");d&&(d.disabled=!1)}return}if(_userInfo&&_userInfo.plan==="free"){const d=await fetch("/api/health").then(u=>u.json()).catch(()=>null);d&&!d.ocr_ready&&(showAlert("info",t("alert-loading-engine")),startEnginePolling())}const n=_selectedFiles.filter(d=>d.status==="waiting"),a=6;async function o(d,u){if(window._ocrAborted)return d.status="cancelled",d.errorKey=null,renderFileList(),{};d.status=u?"retrying":"processing",d.canRetry=!1,renderFileList();const f=new AbortController,h=setTimeout(()=>f.abort("timeout"),9e4);window._ocrCtrls=window._ocrCtrls||new Set,window._ocrCtrls.add(f);try{const _=new FormData;_.append("file",d.file,d.name);try{if(typeof window.getCurrentClientId=="function"){const B=window.getCurrentClientId();B!=null&&_.append("client_id",String(B))}}catch{}const w=await fetch("/api/ocr/recognize",{method:"POST",headers:{Authorization:"Bearer "+token},body:_,signal:f.signal});if(clearTimeout(h),window._ocrCtrls.delete(f),w.status===401||w.status===403){const T=await w.clone().json().catch(()=>({})),S=T&&T.detail,b=typeof S=="string"?S:S&&S.code||"";if(!b||b.startsWith("auth.")){if(localStorage.removeItem("mrpilot_token"),b==="auth.session_revoked")_showSessionRevokedModal();else{const g=b==="auth.password_changed_relogin"?"alert-password-changed-relogin":"alert-session";showToast(t(g),"error"),setTimeout(()=>{window.location.href="/"},1200)}return{abort:!0}}b==="quota.need_api_key"&&showToast(t("err.quota.need_api_key"),"error")}if(!w.ok){const T=(await w.json().catch(()=>({}))).detail;return typeof T=="string"?(d.errorKey="err."+T,d.errorParams=null):T&&T.code?(d.errorKey="err."+T.code,d.errorParams={...T,mb:_quota.max_file_size_mb}):(d.errorKey="err.unknown",d.errorParams=null),(d.errorKey==="err.unknown"||d.errorKey==="err.ocr.engine_error")&&(w.status===429?d.errorKey="err.rate_limit":w.status===502||w.status===503||w.status===504?d.errorKey="err.gemini_overloaded":w.status>=500&&(d.errorKey="err.server")),d.status="error",d.canRetry=!/not_pdf|invalid_pdf|file_too_large|too_many_pages|monthly_limit_exceeded|ip_limit_exceeded|plan_not_supported|need_api_key|not_invoice/.test(d.errorKey||""),renderFileList(),{}}const y=await w.json();d.status="success",d.fromCache=!!y.from_cache;const v=mergeFields(y.pages),E=y.confidence||(v.items&&v.items.length>0?"high":"low");if(_results.push({filename:y.filename,pages:y.pages,page_count:y.page_count,elapsed_ms:y.elapsed_ms,engine:y.engine,merged_fields:v,edits:{},confidence:E,history_id:y.history_id,history_ids:y.history_ids||[],invoice_count:y.invoice_count||1,invoices:y.invoices||[],archive_name:y.archive_name||null,category_tag:y.category_tag||null,auto_pushed:!!y.auto_pushed,typhoon_enhanced:!!y.typhoon_enhanced,typhoon_pages:y.typhoon_pages||[],from_cache:!!y.from_cache}),y.invoice_count&&y.invoice_count>1&&showToast(t("multi-invoice-toast",{file:y.filename,n:y.invoice_count}),"success"),y.missed_invoice_warnings&&y.missed_invoice_warnings.length){const B=y.missed_invoice_warnings.map(function(T){return T.page}).filter(function(T){return T!=null});showToast(t("missed-invoice-warn",{file:y.filename,pages:B.join(", ")}),"warn",8e3),console.warn("[OCR] possible missed invoice(s)",y.missed_invoice_warnings)}if(y.typhoon_enhanced&&y.typhoon_pages&&y.typhoon_pages.length&&showToast(t("typhoon-enhanced-toast",{file:y.filename,n:y.typhoon_pages.length}),"success"),y.fallback_used){const B=y.engine_chain||[],T=y.engine||"";let S;T==="typhoon_nvidia"?S="fallback-typhoon-nvidia-toast":T==="easyocr"?S="fallback-easyocr-toast":S="fallback-generic-toast",showToast(t(S,{file:y.filename}),"warn"),console.info("[OCR Chain]",B)}if(y.from_cache&&showToast(t("cache-hit-toast",{file:y.filename}),"info"),y.duplicate_warnings&&y.duplicate_warnings.length){window._dupQueue||(window._dupQueue=[]);for(const B of y.duplicate_warnings)window._dupQueue.push({filename:y.filename,...B})}return y.auto_pushed&&showToast(t("auto-push-fired",{file:y.filename}),"info"),y.quota&&y.quota.used_this_month!=null&&_userInfo&&(_userInfo.used_this_month=y.quota.used_this_month,_userInfo.tenant_used=y.quota.used_this_month,renderInfoBar(),renderQuotaBanner()),renderFileList(),renderResults(),updateStartButton(),{}}catch(_){clearTimeout(h);try{window._ocrCtrls&&window._ocrCtrls.delete(f)}catch{}console.error("[Upload] failed for",d.file.name,_);const w=_&&(_.name==="AbortError"||_==="timeout"),y=w&&(f.signal.reason==="timeout"||_==="timeout"),v=_&&_.message&&/NetworkError|Failed to fetch/i.test(_.message);return w&&(f.signal.reason==="user_stop"||window._ocrAborted)?(d.status="cancelled",d.errorKey=null,d.canRetry=!1,renderFileList(),{}):(y?d.errorKey="err.timeout":w?d.errorKey="err.aborted":v?d.errorKey="err.network":(d.errorKey="err.unknown",d.errorParams={msg:_&&_.message?_.message:String(_)}),d.status="error",!u&&!window._ocrAborted&&(v||y)&&navigator.onLine!==!1&&(d.canRetry=!0,renderFileList(),await new Promise(B=>setTimeout(B,2e3)),d.status==="error"&&navigator.onLine!==!1&&!window._ocrAborted)?o(d,!0):(d.canRetry=!0,renderFileList(),{}))}}window._reprocessFile=o;let s=0,i=!1;async function r(){for(;s<n.length&&!i&&!window._ocrAborted;){const d=s++,u=await o(n[d]);if(u&&u.abort){i=!0;return}}}window._ocrAborted=!1,window._ocrCtrls=window._ocrCtrls||new Set;const c=document.getElementById("btn-start"),l=document.getElementById("btn-stop");c&&(c.style.display="none"),l&&(l.style.display="");try{typeof window._bigBatchStart=="function"&&window._bigBatchStart(n)}catch{}const p=[];for(let d=0;d<Math.min(a,n.length);d++)p.push(r());await Promise.all(p);try{typeof window._bigBatchStop=="function"&&window._bigBatchStop()}catch{}c&&(c.style.display=""),l&&(l.style.display="none");const m=!!window._ocrAborted;window._ocrAborted=!1,window._ocrCtrls.clear(),updateStartButton(),stopEnginePolling(),document.getElementById("alert-info").classList.contains("show")&&(showAlert("info",t("alert-engine-ready")),setTimeout(hideAlerts,2e3));try{const d={success:0,cancelled:0,network:0,timeout:0,quota:0,overloaded:0,rate:0,other:0};for(const f of n)if(f.status==="success")d.success++;else if(f.status==="cancelled")d.cancelled++;else if(f.status==="error"){const h=f.errorKey||"";h==="err.network"?d.network++:h==="err.timeout"||h==="err.aborted"?d.timeout++:h.indexOf("quota")>=0||h==="err.monthly_limit_exceeded"?d.quota++:h==="err.gemini_overloaded"||h==="err.server"?d.overloaded++:h==="err.rate_limit"?d.rate++:d.other++}const u=n.length;m?showToast(ks(d,u),"warn",4e3):u>1&&d.network+d.timeout+d.quota+d.overloaded+d.rate+d.other>0&&showToast(xs(d),"error",4500)}catch{}window._dupQueue&&window._dupQueue.length&&showDuplicateDialog()});function ks(e,n){return t("ocr-summary-aborted").replace("{success}",e.success).replace("{cancelled}",e.cancelled).replace("{total}",n)}function xs(e){const n=[];return e.success&&n.push(t("ocr-summary-success").replace("{n}",e.success)),e.network&&n.push(t("ocr-summary-network").replace("{n}",e.network)),e.timeout&&n.push(t("ocr-summary-timeout").replace("{n}",e.timeout)),e.quota&&n.push(t("ocr-summary-quota").replace("{n}",e.quota)),e.overloaded&&n.push(t("ocr-summary-overloaded").replace("{n}",e.overloaded)),e.rate&&n.push(t("ocr-summary-rate").replace("{n}",e.rate)),e.other&&n.push(t("ocr-summary-other").replace("{n}",e.other)),n.join(" · ")}document.addEventListener("click",e=>{if(!e.target.closest("#btn-stop")||window._ocrAborted)return;window._ocrAborted=!0,window._ocrCtrls&&window._ocrCtrls.size&&window._ocrCtrls.forEach(a=>{try{a.abort("user_stop")}catch{}});const n=document.getElementById("btn-stop");n&&(n.disabled=!0),typeof showToast=="function"&&showToast(t("ocr-stop-toast"),"warn",2e3),setTimeout(()=>{n&&(n.disabled=!1)},800)});async function Ia(e){let n;if(e)n=_selectedFiles.find(a=>a.file===e)||{file:e,name:e.name,status:"waiting"};else{const a=_selectedFiles.filter(o=>o.status==="waiting");if(!a.length)return;n=a[0]}window._dmsLastFile=n.file,n.status="processing",typeof renderFileList=="function"&&renderFileList();try{const a=new FormData;a.append("file",n.file,n.name),a.append("push","true");const o=await fetch("/api/dms/id-card-booking",{method:"POST",headers:{Authorization:"Bearer "+token},body:a});if(o.status===401||o.status===403){const i=await o.clone().json().catch(()=>({})),r=i&&i.detail,c=typeof r=="string"?r:r&&r.code||"";if(!c||c.startsWith("auth.")){localStorage.removeItem("mrpilot_token"),showToast(t("alert-session"),"error"),setTimeout(()=>{window.location.href="/"},1200);return}}const s=await o.json().catch(()=>({}));if(!o.ok){n.status="error";const i=s&&s.detail&&(s.detail.code||s.detail)||"unknown";n.errorKey="err."+i,n.canRetry=!0,typeof renderFileList=="function"&&renderFileList(),typeof window.renderDmsIdCardResult=="function"&&window.renderDmsIdCardResult({ok:!1,dms_push:{status:"failed",error_code:String(i)}});return}n.status=s.ok||s.dms_push&&s.dms_push.status==="needs_review"?"success":"error",typeof renderFileList=="function"&&renderFileList(),typeof window.renderDmsIdCardResult=="function"&&window.renderDmsIdCardResult(s),typeof updateStartButton=="function"&&updateStartButton()}catch{n.status="error",n.canRetry=!0,typeof renderFileList=="function"&&renderFileList(),typeof window.renderDmsIdCardResult=="function"&&window.renderDmsIdCardResult({ok:!1,dms_push:{status:"failed",error_code:"network"}})}}window._dmsRetryIdCard=function(){window._dmsLastFile&&Ia(window._dmsLastFile)};function La(){if(!window._dupQueue||!window._dupQueue.length)return;const e=window._dupQueue.shift(),n=e.level==="exact",a=n?"dup-title-exact":"dup-title-likely",o=n?"dup-desc-exact":"dup-desc-likely",s=n?"#DC2626":"#D97706",i=n?"#FEE2E2":"#FEF3C7",r=f=>f!=null?Number(f).toLocaleString(void 0,{minimumFractionDigits:2,maximumFractionDigits:2}):"—",c=f=>f||"—",l=f=>{try{const h=new Date(f);return`${h.getFullYear()}-${String(h.getMonth()+1).padStart(2,"0")}-${String(h.getDate()).padStart(2,"0")}`}catch{return f}},p=e.invoice_total>1?` · ${t("invoice-part-of",{i:e.invoice_index,n:e.invoice_total})}`:"",m=(e.matched_fields||[]).map(f=>{const h=t("dup-field-"+f.replace("_","-"))||f;return`<span class="dup-field-chip">${escapeHtml(h)}</span>`}).join(" "),d=document.createElement("div");d.className="log-detail-modal",d.innerHTML=`
    ...
    `,document.body.appendChild(d);const u=()=>{d.remove(),window._dupQueue&&window._dupQueue.length&&setTimeout(La,200)};d.querySelector(".dup-close").addEventListener("click",u),d.querySelector('[data-action="view"]').addEventListener("click",()=>{const f=e.match.id;window.location.hash="#/history",setTimeout(()=>{typeof openHistoryDrawer=="function"&&openHistoryDrawer(f)},400),u()}),d.querySelector('[data-action="delete"]').addEventListener("click",async()=>{const f=e.new_history_id;if(!f){u();return}try{(await fetch(`/api/history/${encodeURIComponent(f)}`,{method:"DELETE",headers:{Authorization:"Bearer "+token}})).ok?showToast(t("dup-deleted-toast"),"success"):showToast(t("dup-delete-failed"),"error")}catch{showToast(t("dup-delete-failed"),"error")}u()}),d.querySelector('[data-action="keep"]').addEventListener("click",u)}window.showDuplicateDialog=La;function Ge(e,n){try{return typeof window.t=="function"?window.t(e):n}catch{return n}}function ft(e){if(e==null||isNaN(e))return"—";try{return String(e).replace(/\B(?=(\d{3})+(?!\d))/g,",")}catch{return String(e)}}function _s(e){if(!e)return"";try{const n=new Date(e).getTime();if(!n)return"";const a=Math.floor((Date.now()-n)/1e3);return a<60?Ge("time-just-now","刚刚"):a<3600?Math.floor(a/60)+Ge("time-min-ago-suffix"," 分钟前"):a<86400?Math.floor(a/3600)+Ge("time-hour-ago-suffix"," 小时前"):Math.floor(a/86400)+Ge("time-day-ago-suffix"," 天前")}catch{return""}}async function hn(){Ca();const e=document.getElementById("dash-kpi-invoices"),n=document.getElementById("dash-kpi-pending"),a=document.getElementById("dash-kpi-exceptions"),o=document.getElementById("dash-kpi-plan"),s=document.getElementById("dash-kpi-plan-sub"),i=document.getElementById("dash-recent-list"),r=document.getElementById("dash-quick-exc-badge");try{const c={Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||"")},[l,p,m]=await Promise.all([fetch("/api/me/tenant-usage",{headers:c}).then(w=>w.ok?w.json():null).catch(()=>null),fetch("/api/history?limit=20",{headers:c}).then(w=>w.ok?w.json():null).catch(()=>null),fetch("/api/exceptions/stats?status=pending",{headers:c}).then(w=>w.ok?w.json():null).catch(()=>null)]),d=l&&l.ocr_this_month||0;let u=0;const f=p&&(p.items||p.history||p)||[],h=Array.isArray(f)?f:[];h.forEach(w=>{(w.status==="pending"||w.status==="reviewing")&&u++});const _=m&&(m.total||m.count||m.pending||0)||0;if(e&&(e.textContent=ft(d)),n&&(n.textContent=ft(u)),a&&(a.textContent=ft(_)),r&&(_>0?(r.style.display="",r.textContent=_):r.style.display="none"),o&&l){const w=l.ocr_this_month||0,y=l.quota||0;o.textContent=ft(w),s&&(s.textContent=y?w+" / "+ft(y)+" 张":Ge("dash-kpi-plan-sub","本月用量"))}if(i)if(h.length===0)i.innerHTML='<div class="dash-recent-empty">'+Ge("dash-recent-empty","还没有识别记录 · 去上传第一张吧")+"</div>";else{const w=h.slice(0,5).map(y=>{const v=(y.invoice_no||y.filename||y.id||"").toString(),E=(y.supplier_name||y.buyer_name||y.client_name||y.notes||"").toString(),B=_s(y.created_at||y.upload_time||y.date),T=S=>String(S).replace(/[&<>"']/g,b=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[b]);return'<div class="dash-recent-row"><span class="dash-recent-key" title="'+T(v)+'">'+T(v)+'</span><span class="dash-recent-mid" title="'+T(E)+'">'+T(E)+'</span><span class="dash-recent-time">'+T(B)+"</span></div>"}).join("");i.innerHTML=w}}catch{i&&(i.innerHTML='<div class="dash-recent-empty">'+Ge("dash-recent-empty","还没有识别记录 · 去上传第一张吧")+"</div>")}}window.loadDashboard=hn;async function Ca(){const e=document.getElementById("dash-kpi-balance-card"),n=document.getElementById("dash-kpi-usage-card"),a=document.getElementById("dash-kpi-balance"),o=document.getElementById("dash-kpi-balance-sub"),s=document.getElementById("dash-kpi-usage"),i=document.getElementById("dash-kpi-usage-sub");if(!(!e||!n))try{const r={Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||"")},c=await fetch("/api/me/credits",{headers:r,cache:"no-store"});if(!c.ok){e.style.display="none",s&&(s.textContent="—"),i&&(i.textContent="");return}const l=await c.json(),p=!!l.is_owner,m=!!l.is_billing_exempt;if(!p)e.style.display="none";else if(e.style.display="",m)a&&(a.textContent="∞",a.className="dash-kpi-val dash-green"),o&&(o.textContent=typeof window.t=="function"?window.t("dash-kpi-balance-exempt"):"Billing exempt");else{const u=typeof l.balance_thb=="number"?l.balance_thb:0;if(a&&(a.textContent="฿"+u.toFixed(2),a.className=u<50?"dash-kpi-val dash-red":"dash-kpi-val"),o){const f=typeof window.t=="function"?window.t("dash-kpi-balance-topup"):"Top up →",h=u<50?"#dc2626":"#6b7280",_=w=>typeof window.escapeHtml=="function"?window.escapeHtml(w):String(w).replace(/[&<>"']/g,y=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[y]);o.innerHTML='<a href="#" id="kpi-balance-topup-link" style="color:'+h+';text-decoration:underline;cursor:pointer;" onclick="event.preventDefault();window._openTopupModal&&window._openTopupModal();return false;">'+_(f)+"</a>"}}const d=typeof l.pages_this_month=="number"?l.pages_this_month:typeof l.my_invoice_count=="number"?l.my_invoice_count:0;if(n.style.display="",s&&(s.textContent=String(d)),i){const u=d>=200?"dash-kpi-usage-sub-high":"dash-kpi-usage-sub-low",f=typeof window.t=="function"?window.t(u,{used:d}):d+" pages";i.textContent=f}}catch(r){console.warn("[credits] loadCreditsCard failed:",r),e.style.display="none",s&&(s.textContent="—")}}window.loadCreditsCard=Ca;document.addEventListener("DOMContentLoaded",function(){(location.hash||"").replace(/^#\//,"")==="dashboard"&&setTimeout(hn,500)});typeof window.subscribeI18n=="function"&&window.subscribeI18n("dashboard",function(){(location.hash||"").replace(/^#\//,"")==="dashboard"&&hn()});function pe(e){return(typeof window.t=="function"?window.t(e):null)||e}function gn(){return localStorage.getItem("mrpilot_token")||""}function le(e){return document.getElementById(e)}var $t=null,gt=null;function Sa(){gt||(gt=setInterval(function(){if(!document.hidden){var e=gn();e&&(window._userInfo&&window._userInfo.is_billing_exempt||fetch("/api/me/credits",{headers:{Authorization:"Bearer "+e},cache:"no-store"}).then(function(n){return n.ok?n.json():null}).then(function(n){if(n){var a=n.balance_thb!=null?Number(n.balance_thb):0;$t!==null&&a>$t&&(window.showToast&&window.showToast(pe("credits-updated"),"success"),typeof window.loadDashboard=="function"&&window.loadDashboard(),typeof window._refreshBalanceAlerts=="function"&&window._refreshBalanceAlerts()),$t=a}}).catch(function(){}))}},3e4))}function Es(){gt&&(clearInterval(gt),gt=null),$t=null}window._startCreditsPoll=Sa;window._stopCreditsPoll=Es;Sa();var bn=null,yn=0;function Bs(){if(!le("topup-v2-ov")){var e=document.createElement("div");e.id="topup-v2-ov",e.className="topup-v2-ov",e.style.cssText="display:none;position:fixed;inset:0;background:rgba(15,23,42,.5);z-index:9500;align-items:center;justify-content:center;padding:16px",e.innerHTML=['<div class="topup-v2-box">','  <div class="topup-v2-head">','    <div class="topup-v2-title" id="tv2-title"></div>','    <button class="topup-v2-close" id="tv2-close" aria-label="close">','      <svg viewBox="0 0 20 20" width="16" height="16" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"><line x1="4" y1="4" x2="16" y2="16"/><line x1="16" y1="4" x2="4" y2="16"/></svg>',"    </button>","  </div>",'  <div class="topup-v2-steps">','    <div class="topup-v2-step" id="tv2-d1"><span class="topup-v2-dot">1</span><span class="topup-v2-slabel" id="tv2-sl1"></span></div>','    <div class="topup-v2-line"></div>','    <div class="topup-v2-step" id="tv2-d2"><span class="topup-v2-dot">2</span><span class="topup-v2-slabel" id="tv2-sl2"></span></div>','    <div class="topup-v2-line"></div>','    <div class="topup-v2-step" id="tv2-d3"><span class="topup-v2-dot">3</span><span class="topup-v2-slabel" id="tv2-sl3"></span></div>',"  </div>",'  <div class="topup-v2-body">','    <div id="tv2-s1">','      <label class="topup-v2-label" id="tv2-al"></label>','      <div class="topup-v2-qamts">','        <button class="topup-v2-qamt" data-val="100">฿100</button>','        <button class="topup-v2-qamt" data-val="500">฿500</button>','        <button class="topup-v2-qamt" data-val="1000">฿1,000</button>','        <button class="topup-v2-qamt" data-val="2000">฿2,000</button>',"      </div>",'      <input id="tv2-amt" type="number" min="10" step="1" class="topup-v2-input" placeholder="฿ ...">','      <div id="tv2-ae" class="topup-v2-err" style="display:none"></div>',"    </div>",'    <div id="tv2-s2" style="display:none">','      <p class="topup-v2-bank-label" id="tv2-bl"></p>','      <div class="topup-v2-bank-card">','        <div class="topup-v2-bank-name">ธนาคาร กรุงเทพ</div>','        <div class="topup-v2-bank-branch">สาขาโชคชัย 4 ลาดพร้าว</div>','        <div class="topup-v2-bank-acct">230-0-91368-4</div>','        <div class="topup-v2-bank-holder">บจ. มิสเตอร์ อี อาร์ พี</div>','        <button class="topup-v2-copy" id="tv2-copy"></button>',"      </div>",'      <div class="topup-v2-warn" id="tv2-bn"></div>',"    </div>",'    <div id="tv2-s3" style="display:none">','      <div class="topup-v2-drop" id="tv2-drop">','        <input type="file" id="tv2-file" accept="image/*,.pdf" style="display:none">','        <svg viewBox="0 0 24 24" width="28" height="28" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M21 15v4a2 2 0 01-2 2H5a2 2 0 01-2-2v-4"/><polyline points="17 8 12 3 7 8"/><line x1="12" y1="3" x2="12" y2="15"/></svg>','        <span class="topup-v2-drop-text" id="tv2-dt"></span>',"      </div>",'      <div id="tv2-se" class="topup-v2-err" style="display:none"></div>','      <label class="topup-v2-label" id="tv2-pl"></label>','      <input id="tv2-payer" type="text" maxlength="200" class="topup-v2-input">','      <label class="topup-v2-label" id="tv2-nl"></label>','      <input id="tv2-note" type="text" maxlength="500" class="topup-v2-input">','      <div id="tv2-ue" class="topup-v2-err" style="display:none"></div>',"    </div>","  </div>",'  <div class="topup-v2-foot">','    <button class="btn btn-ghost" id="tv2-back" style="display:none"></button>','    <button class="btn btn-primary" id="tv2-next"></button>',"  </div>","</div>"].join(""),document.body.appendChild(e),Is()}}function Ta(){var e=function(n,a){var o=le(n);o&&(o.textContent=a)};e("tv2-title",pe("topup-title")),e("tv2-sl1",pe("topup-step1")),e("tv2-sl2",pe("topup-step2")),e("tv2-sl3",pe("topup-step3")),e("tv2-al",pe("topup-amount-label")),e("tv2-bl",pe("topup-bank-label")),e("tv2-copy",pe("topup-copy-account")),e("tv2-dt",pe("topup-slip-drop")),e("tv2-pl",pe("topup-payer-label")),e("tv2-nl",pe("topup-note-label"))}function Bt(e){[1,2,3].forEach(function(s){var i=le("tv2-s"+s);i&&(i.style.display=s===e?"":"none");var r=le("tv2-d"+s);r&&r.classList.toggle("active",s<=e)});var n=le("tv2-back"),a=le("tv2-next");if(e===1?n&&(n.style.display="",n.textContent=pe("topup-btn-cancel")):n&&(n.style.display="",n.textContent=pe("topup-btn-back")),a&&(a.textContent=pe(e===3?"topup-btn-submit":"topup-btn-next")),e===2){var o=le("tv2-bn");o&&(o.innerHTML=pe("topup-bank-note").replace("{amount}","<strong>฿"+Number(yn).toLocaleString()+"</strong>"))}}function sn(){for(var e=1;e<=3;e++){var n=le("tv2-s"+e);if(n&&n.style.display!=="none")return e}return 1}function Pt(e){var n=le(e);n&&(n.textContent="",n.style.display="none")}function bt(e,n){var a=le(e);a&&(a.textContent=n,a.style.display="")}function Nn(e){var n=le("tv2-dt");n&&(n.textContent=e.name);var a=le("tv2-drop");a&&a.classList.add("has-file"),Pt("tv2-se")}function Is(){var e=le("topup-v2-ov");le("tv2-close").addEventListener("click",mt),e.addEventListener("click",function(i){i.target===e&&mt()}),document.addEventListener("keydown",function(i){i.key==="Escape"&&e&&e.style.display!=="none"&&mt()}),e.addEventListener("click",function(i){var r=i.target.closest(".topup-v2-qamt");if(r){e.querySelectorAll(".topup-v2-qamt").forEach(function(l){l.classList.remove("active")}),r.classList.add("active");var c=le("tv2-amt");c&&(c.value=r.dataset.val,Pt("tv2-ae"))}});var n=le("tv2-amt");n&&n.addEventListener("input",function(){e.querySelectorAll(".topup-v2-qamt").forEach(function(i){i.classList.remove("active")}),Pt("tv2-ae")});var a=le("tv2-copy");a&&a.addEventListener("click",function(){navigator.clipboard&&navigator.clipboard.writeText("2300913684").then(function(){var i=a.textContent;a.textContent=pe("topup-copied"),setTimeout(function(){a.textContent=i},1500)})});var o=le("tv2-drop"),s=le("tv2-file");o&&(o.addEventListener("click",function(){s&&s.click()}),o.addEventListener("dragover",function(i){i.preventDefault(),o.classList.add("drag-over")}),o.addEventListener("dragleave",function(){o.classList.remove("drag-over")}),o.addEventListener("drop",function(i){i.preventDefault(),o.classList.remove("drag-over");var r=i.dataTransfer&&i.dataTransfer.files[0];r&&Nn(r)})),s&&s.addEventListener("change",function(){s.files[0]&&Nn(s.files[0])}),le("tv2-back").addEventListener("click",function(){var i=sn();if(i<=1){mt();return}Bt(i-1)}),le("tv2-next").addEventListener("click",function(){var i=sn();i===1?Ls():i===2?Bt(3):Cs()})}async function Ls(){var e=le("tv2-amt"),n=e?parseFloat(e.value):0;if(!n||n<10){bt("tv2-ae",pe("topup-amount-invalid"));return}if(n>5e5){bt("tv2-ae",pe("topup-amount-too-large"));return}yn=n;var a=le("tv2-next");a&&(a.disabled=!0,a.textContent="…");try{var o=await fetch("/api/credits/topup/request",{method:"POST",headers:{"Content-Type":"application/json",Authorization:"Bearer "+gn()},body:JSON.stringify({amount_thb:n})});if(!o.ok){var s=await o.text(),i=pe("topup-submit-fail");try{var r=JSON.parse(s),c=r.detail;if(Array.isArray(c)&&c.length){var l=c[0]&&c[0].type||"";l.indexOf("less_than")>=0?i=pe("topup-amount-too-large"):(l.indexOf("greater_than")>=0||l.indexOf("parsing")>=0)&&(i=pe("topup-amount-invalid"))}else typeof c=="string"&&(i=c)}catch{}throw new Error(i)}var p=await o.json();bn=p.request_id,Bt(2)}catch(m){bt("tv2-ae",m.message||pe("topup-submit-fail"))}finally{a&&(a.disabled=!1,a.textContent=pe("topup-btn-next"))}}async function Cs(){var e=le("tv2-file");if(!e||!e.files||!e.files[0]){bt("tv2-se",pe("topup-slip-required"));return}var n=le("tv2-next");n&&(n.disabled=!0,n.textContent="…");try{var a=new FormData;a.append("file",e.files[0]);var o=le("tv2-payer"),s=le("tv2-note");o&&o.value.trim()&&a.append("payer_name",o.value.trim()),s&&s.value.trim()&&a.append("note",s.value.trim());var i=await fetch("/api/credits/topup/upload-slip/"+bn,{method:"POST",headers:{Authorization:"Bearer "+gn()},body:a});if(!i.ok)throw new Error(await i.text());var r=await i.json();r.auto_approved?(window.showToast&&window.showToast(pe("topup-auto-approved"),"success"),typeof window.loadDashboard=="function"&&window.loadDashboard()):window.showToast&&window.showToast(pe("topup-pending"),"info"),mt()}catch(c){bt("tv2-ue",pe("topup-upload-fail")+" · "+c.message),n&&(n.disabled=!1,n.textContent=pe("topup-btn-submit"))}}function mt(){var e=le("topup-v2-ov");e&&(e.style.display="none"),typeof window.loadDashboard=="function"&&window.loadDashboard()}window._openTopupModal=function(){Bs(),bn=null,yn=0,["tv2-amt","tv2-payer","tv2-note"].forEach(function(a){var o=le(a);o&&(o.value="")});var e=le("tv2-file");e&&(e.value="");var n=le("tv2-drop");n&&n.classList.remove("has-file","drag-over"),le("topup-v2-ov").querySelectorAll(".topup-v2-qamt").forEach(function(a){a.classList.remove("active")}),["tv2-ae","tv2-se","tv2-ue"].forEach(function(a){Pt(a)}),Ta(),Bt(1),le("topup-v2-ov").style.display="flex"};typeof window.subscribeI18n=="function"&&window.subscribeI18n("topup-v2",function(){var e=le("topup-v2-ov");e&&e.style.display!=="none"&&e.style.display!==""&&(Ta(),Bt(sn()))});const Ss=`
        <div class="page-head">
            <div class="page-head-icon">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
    ...
    `;we("page-test-center",Ss);(function(){const e="v118.28.5",n="pearnly_tc_results_"+e,a=[{id:"A1",group:"A · 异常栏 page-head(BUG1)",desc:"手机宽度进异常栏 · 标题「异常栏」横排正常 · 不再每字一行"},{id:"A2",group:"A · 异常栏 page-head(BUG1)",desc:"副标题「所有被规则拦截的单据集中复核…」也横排正常 · 不竖排"},{id:"A3",group:"A · 异常栏 page-head(BUG1)",desc:"客户筛选下拉 + 刷新按钮换到新一行 · 不抢标题宽度"},{id:"B1",group:"B · 客户管理 page-head(BUG2)",desc:"手机宽度进客户管理 · 标题「客户管理」横排正常"},{id:"B2",group:"B · 客户管理 page-head(BUG2)",desc:"副标题「为每家客户单独归档发票…」横排正常 · 不竖排"},{id:"B3",group:"B · 客户管理 page-head(BUG2)",desc:"「+ 新建客户」按钮换到新一行 · 不挤标题"},{id:"C1",group:"C · 客户卡片(BUG3)",desc:"客户卡片「编辑 / 导出本月」按钮文字清晰 · 不被截断"},{id:"D1",group:"D · 历史表头(BUG4)",desc:"手机宽度进单据记录 · 表头「文件·发票号·供应商」/「金额」单行 · 不竖排"},{id:"D2",group:"D · 历史表头(BUG4)",desc:"行内 INV-TH-202605-1006 这种长发票号正常单行展示 · 不一字一行"},{id:"E1",group:"E · 对账切换器(BUG6)",desc:"手机宽度进对账中心 · 顶栏点「全部客户」chip · 下拉从右上角向下展开 · 右对齐 · 不贴左屏边"},{id:"E2",group:"E · 对账切换器(BUG6)",desc:"下拉宽度自适应屏幕 · 不超出屏幕右边"},{id:"F1",group:"F · 通用设置回归",desc:"设置 → 个人资料 · 没有「界面语言」4 按钮卡"},{id:"F2",group:"F · 通用设置回归",desc:"左侧 nav 顺序:账户 / 公司 / 工作流 / 系统 / 关于"},{id:"F3",group:"F · 通用设置回归",desc:"系统 → 通用设置 · 4 行下拉(语言/时区/日期/数字)· 改语言立即切语言 · 改其他保存后 F5 仍保留"},{id:"G1",group:"G · 移动端 settings(回归)",desc:"手机宽度设置 tabs 不重叠 · 按分组分行 · chip 风格"},{id:"H1",group:"H · 回归",desc:"OCR 上传识别 / 客户管理 / 异常栏 / 对账中心 / 测试中心 全部仍工作"},{id:"H2",group:"H · 回归",desc:"4 语切换没新增异常(测试中心异常日志「API 失败」过滤无新条目)"},{id:"I1",group:"I · 三档移动 viewport",desc:"iPhone SE 375 · 上述 BUG 1-6 都修了"},{id:"I2",group:"I · 三档移动 viewport",desc:"Galaxy S 360 · 上述 BUG 1-6 都修了"},{id:"I3",group:"I · 三档移动 viewport",desc:"iPhone 12 Pro 414 · 上述 BUG 1-6 都修了"}];let o={},s="all",i=!1,r=!1;function c(A,H,P){let F=typeof t=="function"?t(A):null;return(!F||F===A)&&(F=H),P&&Object.keys(P).forEach(function(G){F=String(F).replace("{"+G+"}",String(P[G]))}),F}function l(){try{const A=localStorage.getItem(n);o=A?JSON.parse(A):{},(typeof o!="object"||!o)&&(o={})}catch{o={}}}function p(){try{localStorage.setItem(n,JSON.stringify(o))}catch{}}function m(A){const H=new Date(A),P=function(F){return F<10?"0"+F:""+F};return P(H.getHours())+":"+P(H.getMinutes())+":"+P(H.getSeconds())}function d(A){return String(A??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function u(A,H){try{typeof showToast=="function"?showToast(A,H||"info"):alert(A)}catch{}}function f(A){try{navigator.clipboard&&navigator.clipboard.writeText?navigator.clipboard.writeText(A).then(function(){u(c("tc-toast-copied","已复制到剪贴板"),"success")}).catch(function(){h(A)}):h(A)}catch{h(A)}}function h(A){try{const H=document.createElement("textarea");H.value=A,H.style.position="fixed",H.style.opacity="0",document.body.appendChild(H),H.select();const P=document.execCommand("copy");document.body.removeChild(H),u(P?c("tc-toast-copied","已复制"):c("tc-toast-copy-fail","复制失败"),P?"success":"error")}catch{u(c("tc-toast-copy-fail","复制失败"),"error")}}function _(){const A=document.getElementById("tc-account-chip"),H=document.getElementById("tc-progress-chip");if(A&&(A.textContent=_userInfo&&(_userInfo.email||_userInfo.username)||"—"),H){const P=a.length,F=a.filter(function(G){return o[G.id]}).length;H.textContent=F+" / "+P}}function w(){const A=document.getElementById("tc-checklist-body");if(!A)return;const H={};a.forEach(function(F){H[F.group]||(H[F.group]=[]),H[F.group].push(F)});const P=[];Object.keys(H).forEach(function(F){P.push('<div class="tc-checklist-group">'),P.push('<div class="tc-checklist-group-title">'+d(F)+"</div>"),H[F].forEach(function(G){const O=o[G.id]||"",ee=O?"is-"+O:"";P.push('<div class="tc-check-item '+ee+'" data-id="'+d(G.id)+'"><div class="tc-check-id">'+d(G.id)+'</div><div class="tc-check-desc">'+d(G.desc)+'</div><div class="tc-check-actions">'+y(G.id,"pass",O)+y(G.id,"fail",O)+y(G.id,"skip",O)+"</div></div>")}),P.push("</div>")}),A.innerHTML=P.join("")}function y(A,H,P){const F=P===H,G={pass:'<svg viewBox="0 0 20 20" fill="none" stroke="currentColor" stroke-width="2.4" stroke-linecap="round" stroke-linejoin="round"><polyline points="4,11 8,15 16,5"/></svg>',fail:'<svg viewBox="0 0 20 20" fill="none" stroke="currentColor" stroke-width="2.4" stroke-linecap="round" stroke-linejoin="round"><line x1="5" y1="5" x2="15" y2="15"/><line x1="15" y1="5" x2="5" y2="15"/></svg>',skip:'<svg viewBox="0 0 20 20" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"><line x1="5" y1="10" x2="15" y2="10"/></svg>'},O={pass:c("tc-status-pass","通过"),fail:c("tc-status-fail","失败"),skip:c("tc-status-skip","跳过")};return'<button type="button" class="tc-status-btn '+(F?"is-active "+H:"")+'" data-id="'+d(A)+'" data-kind="'+H+'" title="'+d(O[H])+'">'+G[H]+"</button>"}function v(A){return s==="all"?!0:s==="js_error"?A.type==="js_error"||A.type==="promise_error":s==="api"?A.type==="api_error"||A.type==="api_fail":s==="api_slow"?A.type==="api_slow":s==="console"?A.type==="console_error"||A.type==="console_warn":!0}function E(){const A=document.getElementById("tc-logs-body"),H=document.getElementById("tc-logs-count");if(!A)return;const P=(window._pearnlyTcLogs||[]).slice().reverse(),F=P.filter(v);if(H&&(H.textContent=String(P.length)),F.length===0){A.innerHTML='<div class="tc-logs-empty">'+d(c("tc-logs-empty","暂无异常"))+"</div>";return}const G=F.slice(0,100).map(function(O){const ee=typeof O.detail=="object"?JSON.stringify(O.detail,null,2):String(O.detail||"");return'<div class="tc-log-item t-'+d(O.type)+'" data-ts="'+O.ts+'"><span class="tc-log-time">'+m(O.ts)+'</span><span class="tc-log-type">'+d(O.type)+'</span><div class="tc-log-summary">'+d(O.summary)+'<div class="tc-log-detail">'+d(ee)+"</div></div></div>"}).join("");A.innerHTML=G,document.querySelectorAll("#tc-logs-filter .tc-filter-chip").forEach(function(O){O.classList.toggle("active",O.getAttribute("data-filter")===s)})}function B(){r||(r=!0,setTimeout(function(){r=!1,currentRoute==="test-center"&&document.getElementById("page-test-center")&&document.getElementById("page-test-center").classList.contains("active")&&E(),T()},200))}window._tcOnNewLog=B;function T(){const A=document.getElementById("nav-test-badge");if(!A)return;const H=(window._pearnlyTcLogs||[]).filter(function(P){return P.type==="js_error"||P.type==="promise_error"||P.type==="api_error"||P.type==="api_fail"||P.type==="console_error"}).length;H>0?(A.style.display="",A.textContent=H>99?"99+":String(H)):A.style.display="none"}function S(){_(),w(),E(),T()}function b(){const A=[],H=new Date,P=_userInfo&&(_userInfo.email||_userInfo.username)||"—";A.push("# Pearnly "+e+" 测试结果"),A.push("- 账号:"+P),A.push("- 时间:"+H.toISOString().replace("T"," ").slice(0,19));const F=a.length,G=a.filter(function(re){return o[re.id]==="pass"}).length,O=a.filter(function(re){return o[re.id]==="fail"}).length,ee=a.filter(function(re){return o[re.id]==="skip"}).length,de=F-G-O-ee;A.push("- 进度:"+(G+O+ee)+" / "+F+" · ✅ "+G+" · ❌ "+O+" · ⏭ "+ee+" · 未测 "+de),A.push(""),A.push("| ID | 描述 | 状态 |"),A.push("|---|---|---|"),a.forEach(function(re){const ve=o[re.id],he=ve==="pass"?"✅":ve==="fail"?"❌":ve==="skip"?"⏭":"⬜";A.push("| "+re.id+" | "+re.desc.replace(/\|/g,"\\|")+" | "+he+" |")});const me=a.filter(function(re){return o[re.id]==="fail"});me.length>0&&(A.push(""),A.push("## ❌ 失败项"),me.forEach(function(re){A.push("- **"+re.id+"** · "+re.desc)}));const ue=(window._pearnlyTcLogs||[]).slice(-30).reverse();return ue.length>0&&(A.push(""),A.push("## 🔴 异常日志(最近 "+ue.length+" 条)"),ue.forEach(function(re){if(A.push("- `"+m(re.ts)+"` · **"+re.type+"** · "+re.summary),re.detail){let ve;try{ve=JSON.stringify(re.detail)}catch{ve=String(re.detail)}ve&&ve!=="{}"&&A.push("  - "+ve.slice(0,600))}})),A.join(`
`)}function g(A){const H=(window._pearnlyTcLogs||[]).slice(-30).reverse();if(H.length===0)return"(暂无异常日志)";const P=["# Pearnly 异常日志(最近 "+H.length+" 条)"],F=_userInfo&&(_userInfo.email||_userInfo.username)||"—";return P.push("- 账号:"+F),P.push("- 当前页:"+(currentRoute||"?")),P.push("- UA:"+navigator.userAgent),P.push(""),H.forEach(function(G){if(P.push("## `"+m(G.ts)+"` · "+G.type),P.push("- "+G.summary),G.detail){P.push("```");try{P.push(JSON.stringify(G.detail,null,2).slice(0,2e3))}catch{P.push(String(G.detail).slice(0,2e3))}P.push("```")}}),P.join(`
`)}function x(){const A=Date.now();fetch("/api/health").then(function(H){const P=Date.now()-A;H.ok?u(c("tc-toast-health-ok","后端健康 ✓ {ms}ms",{ms:P}),"success"):u(c("tc-toast-health-fail","后端无响应")+" ("+H.status+")","error")}).catch(function(){u(c("tc-toast-health-fail","后端无响应"),"error")})}function I(){try{localStorage.removeItem(n),localStorage.removeItem("pearnly_current_client_id"),o={},(window._pearnlyTcLogs||[]).length=0,s="all",window.setCurrentClientId}catch{}S(),u(c("tc-toast-cleared","session 状态已清空"),"success")}function L(){try{fetch("/api/clients",{headers:{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||"")}}).then(function(A){return A.json()}).then(function(A){window._clientsCache=A.clients||[],typeof window._refreshClientSwitcher=="function"&&window._refreshClientSwitcher(),typeof window._refreshExcClientFilter=="function"&&window._refreshExcClientFilter(),u("客户缓存已刷新 · "+(A.clients||[]).length+" 个客户","success")}).catch(function(){u("刷新失败","error")})}catch{}}function C(){if(i||!document.getElementById("page-test-center"))return;i=!0;const H=document.getElementById("tc-checklist-body");H&&H.addEventListener("click",function(ve){const he=ve.target.closest(".tc-status-btn");if(!he)return;const D=he.getAttribute("data-id"),z=he.getAttribute("data-kind");!D||!z||(o[D]===z?delete o[D]:o[D]=z,p(),w(),_())});const P=document.getElementById("tc-btn-reset-checklist");P&&P.addEventListener("click",function(){o={},p(),w(),_()});const F=document.getElementById("tc-btn-copy-all");F&&F.addEventListener("click",function(){f(b())});const G=document.getElementById("tc-btn-copy-logs");G&&G.addEventListener("click",function(){f(g())});const O=document.getElementById("tc-btn-clear-logs");O&&O.addEventListener("click",function(){(window._pearnlyTcLogs||[]).length=0,E(),T()});const ee=document.getElementById("tc-logs-filter");ee&&ee.addEventListener("click",function(ve){const he=ve.target.closest(".tc-filter-chip");he&&(s=he.getAttribute("data-filter")||"all",E())});const de=document.getElementById("tc-logs-body");de&&de.addEventListener("click",function(ve){const he=ve.target.closest(".tc-log-item");he&&he.classList.toggle("expanded")});const me=document.getElementById("tc-tool-health");me&&me.addEventListener("click",x);const ue=document.getElementById("tc-tool-clear-session");ue&&ue.addEventListener("click",I);const re=document.getElementById("tc-tool-reload-clients");re&&re.addEventListener("click",L)}function k(){}window._tcApplyVisibility=k;let M=0;const $=setInterval(function(){M++,_userInfo&&clearInterval($),M>60&&clearInterval($)},500);window.loadTestCenterPage=function(){l(),C(),S()},typeof window.subscribeI18n=="function"&&window.subscribeI18n("test-center",function(){T(),currentRoute==="test-center"&&document.getElementById("page-test-center")&&document.getElementById("page-test-center").classList.contains("active")&&S()})})();(function(){const e="pearnly_active_workspace_client_id",n="pearnly_work_mode";function a(v,E){if(typeof window.t=="function"){const B=window.t(v);if(B&&B!==v)return B}return E}function o(){const v=window._userInfo||{},E=String(v.role||"").toLowerCase(),B=String(v.tenant_role||"").toLowerCase();return v.is_super_admin===!0||v.is_owner===!0||E==="owner"||E==="admin"||B==="owner"||B==="admin"}function s(){return localStorage.getItem(n)==="client"?"client":"personal"}function i(){const v=localStorage.getItem(e);if(!v||v==="null"||v==="0"||v==="")return null;const E=parseInt(v,10);return isNaN(E)?null:E}function r(v){try{window.dispatchEvent(new CustomEvent("pearnly:workspace-changed",{detail:{id:v,mode:s()}}))}catch{}}function c(v){const E=i();v==null||v===0?localStorage.removeItem(e):(localStorage.setItem(e,String(v)),localStorage.setItem(n,"client")),String(E)!==String(v)&&r(v)}function l(){const v=i();localStorage.setItem(n,"personal"),localStorage.removeItem(e),v!=null&&r(null)}async function p(){try{const v=window.apiGet;if(typeof v!="function")return[];const E=await v("/api/workspace/clients");return E&&(E.clients||E.items)||[]}catch{return[]}}async function m(v){if(s()==="client"&&i()!=null)return typeof v=="function"&&v(),!0;const E=a("ws-need-client","这个功能需要先选择工作空间"),B=a("ws-btn-pick","选择工作空间"),T=a("ws-btn-cancel","取消");return typeof window.showConfirm=="function"?await window.showConfirm(E,{okText:B,cancelText:T})&&d(v):window.confirm(E+`

[`+B+" / "+T+"]")&&d(v),!1}async function d(v){const E=await p();if(typeof v=="function"&&s()!=="personal"&&E.length===1){c(Number(E[0].id)),v();return}if(typeof window.openWorkspaceChooserUI=="function"){window.openWorkspaceChooserUI({clients:E,canCreate:o(),active:i(),onPersonal:l,onPick:function(B){c(Number(B)),typeof v=="function"&&v()},emptyHint:E.length?null:o()?a("ws-empty-owner","还没有工作空间。创建一个公司后,上传、对账和 ERP 推送都会归属到该公司。"):a("ws-empty-employee","你还没有可用的工作空间,请联系管理员分配。")});return}if(!E.length){const B=o()?a("ws-empty-owner","还没有工作空间。创建一个公司后,上传、对账和 ERP 推送都会归属到该公司。"):a("ws-empty-employee","你还没有可用的工作空间,请联系管理员分配。");typeof window.showToast=="function"&&window.showToast(B,"info")}}function u(v){const E=v||document.getElementById("workspace-switcher-root");if(!E)return;const B=s(),T=i();let S,b;if(B==="client"&&T!=null){const I=(window._workspaceClientsCache||[]).find(L=>Number(L.id)===Number(T));S=h("building"),b=I?I.name:a("ws-current-label","当前工作空间")}else S=h("user"),b=a("ws-personal","个人事务");E.innerHTML='<button class="ws-ctrl-btn" id="ws-ctrl-btn" type="button">'+S+'<span class="ws-ctrl-label">'+f(b)+"</span></button>";const g=E.querySelector("#ws-ctrl-btn");g&&g.addEventListener("click",()=>d(null))}function f(v){return String(v??"").replace(/[&<>"']/g,function(E){return{"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"}[E]})}function h(v){const E='<svg class="ws-ic" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">';return v==="building"?E+'<rect x="2" y="7" width="20" height="14" rx="2"/><path d="M16 21V5a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v16"/></svg>':E+'<path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/></svg>'}function _(v){v=v||{};const E=v.clients||[],B=v.active,T=document.getElementById("ws-modal");T&&T.remove();const S=document.createElement("div");S.id="ws-modal",S.className="ws-modal";const g='<button type="button" class="ws-modal-item'+(s()==="personal"||B==null?" active":"")+'" data-ws-personal="1"><span class="ws-modal-item-ic">'+h("user")+'</span><span class="ws-modal-item-text" style="display:flex;flex-direction:column;align-items:flex-start;min-width:0;"><span class="ws-modal-item-name">'+f(a("ws-personal","个人事务"))+'</span><span class="ws-modal-item-desc" style="font-size:11px;color:#6b7280;font-weight:400;margin-top:2px;line-height:1.35;white-space:normal;">'+f(a("ws-personal-desc","用于临时识别、测试或处理不归属任何公司的文件。"))+"</span></span></button>";let x="";if(E.length){const M=['<option value="">'+f(a("ws-select-ph","— 选择账套主体 —"))+"</option>"].concat(E.map(function($){const A=B!=null&&Number(B)===Number($.id);return'<option value="'+f($.id)+'"'+(A?" selected":"")+">"+f($.name||"#"+$.id)+"</option>"}));x='<div class="ws-modal-select-row"><label class="ws-modal-select-label">'+f(a("ws-select-label","账套主体"))+'</label><select class="ws-modal-select" data-ws-select="1">'+M.join("")+"</select></div>"}const I=!E.length&&v.emptyHint?'<div class="ws-modal-empty">'+f(v.emptyHint)+"</div>":"",L=v.canCreate?'<div class="ws-modal-create"><button type="button" class="ws-modal-create-toggle" data-ws-create-toggle="1">+ '+f(a("ws-create-client","新建工作空间"))+'</button><div class="ws-modal-create-form" data-ws-create-form style="display:none;"><input type="text" class="ws-modal-create-input" data-ws-create-name placeholder="'+f(a("ws-create-ph","公司名称,例如 BAKELAB"))+'"><button type="button" class="ws-modal-create-submit" data-ws-create-submit="1">'+f(a("ws-create-submit","创建"))+"</button></div></div>":"";S.innerHTML='<div class="ws-modal-box" role="dialog" aria-modal="true"><div class="ws-modal-head"><span class="ws-modal-title">'+f(a("ws-chooser-title","选择工作空间"))+'</span><button type="button" class="ws-modal-close" data-ws-close="1" aria-label="close">✕</button></div><div class="ws-modal-subtitle" style="font-size:12px;color:#6b7280;padding:2px 4px 12px;line-height:1.45;white-space:normal;">'+f(a("ws-chooser-subtitle","账套主体 = 你的公司(发票卖方/开票方)。选择正在为哪家公司做账。"))+'</div><div class="ws-modal-list">'+g+x+"</div>"+I+L+"</div>",document.body.appendChild(S);const C=S.querySelector("[data-ws-select]");C&&C.addEventListener("change",function(){const M=C.value;M&&(typeof v.onPick=="function"&&v.onPick(M),k(),u())});function k(){S.remove()}S.addEventListener("click",function(M){if(M.target===S||M.target.closest("[data-ws-close]")){k();return}if(M.target.closest("[data-ws-personal]")){typeof v.onPersonal=="function"&&v.onPersonal(),k(),u();return}const A=M.target.closest("[data-ws-pick]");if(A){const F=A.getAttribute("data-ws-pick");typeof v.onPick=="function"&&v.onPick(F),k(),u();return}if(M.target.closest("[data-ws-create-toggle]")){const F=S.querySelector("[data-ws-create-form]");if(F){F.style.display=F.style.display==="none"?"flex":"none";const G=F.querySelector("[data-ws-create-name]");G&&G.focus()}return}if(M.target.closest("[data-ws-create-submit]")){w(S,v,k);return}})}async function w(v,E,B){const T=v.querySelector("[data-ws-create-name]"),S=T?(T.value||"").trim():"";if(!S){T&&T.focus();return}let b=null;try{if(typeof window.apiPost=="function"){const x=await window.apiPost("/api/workspace/clients",{name:S});b=x&&typeof x.json=="function"?await x.json().catch(()=>null):x}}catch{b=null}const g=b&&(b.id||b.client&&b.client.id);if(!g){typeof window.showToast=="function"&&window.showToast(a("ws-create-fail","新建工作空间失败 · 请重试"),"error");return}window._workspaceClientsCache=await p(),c(Number(g)),E.onPick,B(),u()}window.openWorkspaceChooserUI=_,window.addEventListener("pearnly:workspace-changed",function(){u()}),window.getWorkMode=s,window.getActiveWorkspaceClientId=i,window.setActiveWorkspaceClientId=c,window.enterPersonalMode=l,window.requireWorkspace=m,window.openWorkspaceChooser=d,window.renderWorkspaceControl=u,window.fetchWorkspaceClients=p;function y(){try{if(sessionStorage.getItem("pearnly_ws_login_prompted")==="1"||i()!=null||localStorage.getItem(n)==="personal")return;sessionStorage.setItem("pearnly_ws_login_prompted","1"),setTimeout(function(){d(null)},800)}catch{}}p().then(v=>{window._workspaceClientsCache=v,u(),y()}),typeof window.subscribeI18n=="function"&&window.subscribeI18n("workspace-switcher",u)})();(function(){const e=B=>document.querySelector('[data-num-target="'+B+'"]');function n(B){if(!B)return t("reconcile-last-activity-none");try{const T=new Date(B),S=new Date,b=S-T;if(b/6e4<5)return t("reconcile-last-activity-just-now");if(T.toDateString()===S.toDateString())return t("reconcile-last-activity-today");const x=Math.max(1,Math.floor(b/(24*3600*1e3)));return t("reconcile-last-activity-days-ago").replace("{n}",x)}catch{return t("reconcile-last-activity-none")}}function a(B,T,S){const b=e(B);b&&(b.textContent=S?"-":String(T),b.classList.toggle("is-empty",!!S))}function o(B){const T=document.getElementById("reconcile-error");T&&(T.style.display=B?"flex":"none")}function s(B){const T=document.getElementById("reconcile-empty");T&&(T.style.display=B?"flex":"none")}function i(B,T){const S=document.getElementById("reconcile-last-activity");S&&(S.textContent=B,S.classList.toggle("has-data",!!T))}function r(B){const T=!B||(B.total_sessions||0)===0;a("pending",B.pending||0,T),a("matched",B.matched||0,T),a("unmatched",B.unmatched||0,T),i(n(B.last_activity_at),!!B.last_activity_at),o(!1),s(T)}function c(B){const T=B.toUpperCase();return T==="KBANK"?"bank-chip-kbank":T==="SCB"?"bank-chip-scb":T==="BBL"?"bank-chip-bbl":T==="KTB"?"bank-chip-ktb":T==="TTB"?"bank-chip-ttb":"bank-chip-other"}function l(B,T){const S=b=>b?String(b).slice(0,10):"?";return!B&&!T?"":S(B)+" ~ "+S(T)}function p(B){return B==null?"":String(B).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function m(B){const T=document.getElementById("reconcile-recent"),S=document.getElementById("reconcile-recent-list");if(!T||!S)return;const b=(B||[]).slice(0,20);if(b.length===0){T.style.display="none";return}T.style.display="",s(!1),S.innerHTML=b.map(g=>{const x=g.parse_status==="parse_failed",I=g.bank_code||"OTHER",L=g.account_last4?" ···"+p(g.account_last4):"",C=l(g.period_start,g.period_end),k=p(g.source_filename||""),M=Number(g.tx_count||0),$=x?'<span class="recon-card-fail" data-i18n="reconcile-card-parse-failed">'+t("reconcile-card-parse-failed")+"</span>":'<span class="recon-card-tx">'+t("reconcile-card-tx").replace("{n}",M)+"</span>";return'<div class="recon-card" data-session-id="'+p(g.id)+'" data-session-name="'+k+'"><span class="bank-chip '+c(I)+'">'+p(I)+'</span><div class="recon-card-main"><div class="recon-card-title">'+k+L+'</div><div class="recon-card-sub">'+p(C)+'</div></div><div class="recon-card-right">'+$+'</div><button class="recon-card-trash" data-trash="'+p(g.id)+'" title="'+p(t("bank-session-delete-tip")||"删除")+'"><svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"><path d="M3 5h10M6 5V3h4v2M5 5l1 9h4l1-9"/></svg></button><svg class="recon-card-arrow" viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M6 4l4 4-4 4"/></svg></div>'}).join(""),S.querySelectorAll(".recon-card").forEach(g=>{g.addEventListener("click",x=>{x.target.closest(".recon-card-trash")||(g.dataset.sessionId,d())})}),S.querySelectorAll(".recon-card-trash").forEach(g=>{g.addEventListener("click",x=>{x.stopPropagation();const I=g.dataset.trash,L=g.closest(".recon-card"),C=L&&L.dataset.sessionName||"";typeof window._deleteBankSession=="function"&&window._deleteBankSession(I,C)})})}function d(B){typeof window.routeTo=="function"&&window.routeTo("reconcile"),setTimeout(function(){const T=document.querySelector('[data-recon-tab="bank"]');T&&T.click()},150)}function u(){o(!0),s(!1)}function f(){typeof window.routeTo=="function"&&window.routeTo("reconcile"),setTimeout(function(){const B=document.querySelector('[data-recon-tab="bank"]');B&&B.click()},150)}async function h(){a("pending",0,!0),a("matched",0,!0),a("unmatched",0,!0),i("",!1),o(!1),s(!1);const B=document.getElementById("reconcile-recent");B&&(B.style.display="none");const T={Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||"")};try{const[S,b]=await Promise.all([fetch("/api/bank-recon/stats",{headers:T}),fetch("/api/bank-recon/sessions?limit=20",{headers:T})]);if(!S.ok)throw new Error("http "+S.status);const g=await S.json(),x=b.ok?await b.json():[];r(g||{}),m(x||[])}catch(S){console.warn("[reconcile] load failed",S),u()}}function _(B){if(!B||!B.length)return;const T="Bearer "+(localStorage.getItem("mrpilot_token")||"");let S=0;const b=B.length;Array.from(B).forEach(function(g){const x=new FormData;x.append("file",g,g.name);const I=new XMLHttpRequest;I.open("POST","/api/bank-recon/upload"),I.setRequestHeader("Authorization",T),I.onload=function(){S++;try{const L=JSON.parse(I.responseText);I.status===200&&L.tx_count!==void 0?showToast((t("bank-upload-ok")||"解析成功 · 共 {n} 条流水").replace("{n}",L.tx_count),"success"):showToast(g.name+" "+(t("upload-failed")||"上传失败"),"error")}catch{showToast(g.name+" "+(t("upload-failed")||"上传失败"),"error")}S===b&&setTimeout(h,600)},I.onerror=function(){S++,showToast(g.name+" "+(t("upload-failed")||"上传失败"),"error"),S===b&&setTimeout(h,600)},I.send(x)}),showToast((t("bank-queue-status-uploading")||"上传中")+"…","info")}function w(){if(window.__reconcileBound)return;window.__reconcileBound=!0;const B=document.getElementById("reconcile-bank-file-input");B&&B.addEventListener("change",function(){_(this.files),this.value=""}),document.addEventListener("click",T=>{if(T.target.closest("#btn-reconcile-upload-top")||T.target.closest("#btn-reconcile-upload-empty")){f();return}if(T.target.closest("#btn-reconcile-retry")){h();return}if(T.target.closest("#btn-reconcile-dev-seed")){E();return}})}const y=["468b50c1-5593-4fd6-990d-515ce8085563"];function v(){const B=document.getElementById("btn-reconcile-dev-seed");if(!B)return;const T=typeof _userInfo<"u"?_userInfo:null,S=T&&T.id&&y.indexOf(String(T.id))>=0;B.style.display=S?"":"none"}async function E(){try{const B=await fetch("/api/bank-recon/_dev/seed",{method:"POST",headers:{Authorization:"Bearer "+token}});if(!B.ok)throw new Error("seed:"+B.status);const T=await B.json(),S=(t("reconcile-dev-seed-ok")||"").replace("{n}",T.tx_count||0);showToast(S,"success"),typeof window.navigateTo=="function"?window.navigateTo("automation"):location.hash="#/automation",setTimeout(()=>{const b=document.querySelector('[data-auto-tab="bank"]');b&&b.click(),T.session_id&&typeof window._openBankSession=="function"&&window._openBankSession(T.session_id)},300)}catch(B){console.warn("[reconcile] dev seed failed",B),showToast(t("reconcile-dev-seed-fail")||"Seed failed","error")}}window.loadReconcilePage=async function(){w(),v(),typeof window._bankReconV2Init=="function"&&window._bankReconV2Init();try{await h()}catch{}},window._rerenderReconcile=function(){typeof currentRoute=="string"&&currentRoute==="reconcile"&&h().catch(()=>{})},typeof window.subscribeI18n=="function"&&window.subscribeI18n("reconcile",window._rerenderReconcile)})();(function(){const e=document.getElementById("assign-clients-modal");if(!(!e||e.dataset.wbInjected==="1")){e.innerHTML=`
    <div class="modal" style="max-width:480px">
        ...
        <div class="modal-foot">
    ...
    </div>`,e.dataset.wbInjected="1";try{const n=window._currentLang||localStorage.getItem("mrpilot_lang")||"th",a=window.I18N;a&&a[n]&&e.querySelectorAll("[data-i18n]").forEach(o=>{const s=o.getAttribute("data-i18n");a[n][s]&&(o.textContent=a[n][s])})}catch{}}})();(function(){let e={employeeId:null,employeeName:"",clients:[],selected:new Set,opened:!1};function n(){return document.getElementById("assign-clients-modal")}function a(){return document.getElementById("assign-clients-list")}function o(){return document.getElementById("assign-select-all")}function s(){return document.getElementById("assign-selected-count")}function i(){return document.getElementById("assign-modal-target")}function r(){const h=a();if(h){if(!e.clients.length){h.innerHTML='<div class="assign-empty">'+escapeHtml(t("assign-no-clients")||"暂无客户 · 请先到「客户管理」添加")+"</div>";return}h.innerHTML=e.clients.map(_=>{const w=String(_.id),y=e.selected.has(w)?"checked":"",v=escapeHtml(_.name||_.label||"#"+w),E=_.code?'<span class="assign-row-code">'+escapeHtml(_.code)+"</span>":"";return'<label class="assign-row"><input type="checkbox" data-cid="'+escapeHtml(w)+'" '+y+'><span class="assign-row-name">'+v+"</span>"+E+"</label>"}).join(""),c()}}function c(){const h=s();if(h){const w=t("assign-selected-count")||"已选 {n} / {total}";h.textContent=w.replace("{n}",e.selected.size).replace("{total}",e.clients.length)}const _=o();_&&(_.checked=e.clients.length>0&&e.selected.size===e.clients.length)}function l(){const h=i();h&&(h.textContent=e.employeeName?" · "+e.employeeName:"")}async function p(h,_){e.employeeId=h,e.employeeName=_||"",e.opened=!0,e.selected=new Set,e.clients=[],l();const w=a();w&&(w.innerHTML='<div class="assign-empty">'+escapeHtml(t("assign-loading")||"加载中...")+"</div>");const y=n();y&&(y.style.display="flex");try{const[v,E]=await Promise.all([apiGet("/api/clients?include_inactive=false"),apiGet("/api/team/employees/"+encodeURIComponent(h)+"/assignments")]);e.clients=v&&v.clients||[];const B=E&&E.client_ids||[];e.selected=new Set(B.map(String)),r()}catch(v){console.error("[assign-clients] load failed",v);const E=a();E&&(E.innerHTML='<div class="assign-empty">'+escapeHtml(t("assign-load-failed")||"加载失败 · 请重试")+"</div>")}}function m(){e.opened=!1;const h=n();h&&(h.style.display="none")}async function d(){if(!e.employeeId)return;const h=Array.from(e.selected).map(w=>parseInt(w,10)).filter(w=>!isNaN(w)),_=document.getElementById("assign-modal-save");_&&(_.disabled=!0);try{const w=await apiPost("/api/team/employees/"+encodeURIComponent(e.employeeId)+"/assignments",{client_ids:h});w&&w.ok!==!1?(showToast((t("assign-saved")||"已保存 {n} 个客户分配").replace("{n}",h.length),"success"),m(),typeof loadTeamList=="function"&&loadTeamList()):showToast(t("assign-save-failed")||"保存失败","error")}catch(w){console.error("[assign-clients] save failed",w),showToast(t("assign-save-failed")||"保存失败","error")}finally{_&&(_.disabled=!1)}}function u(){const h=n();if(!h||h.dataset.bound==="1")return;h.dataset.bound="1";const _=document.getElementById("assign-modal-close");_&&_.addEventListener("click",m);const w=document.getElementById("assign-modal-cancel");w&&w.addEventListener("click",m);const y=document.getElementById("assign-modal-save");y&&y.addEventListener("click",d),h.addEventListener("click",function(B){B.target===h&&m()});const v=o();v&&v.addEventListener("change",function(){v.checked?e.selected=new Set(e.clients.map(B=>String(B.id))):e.selected=new Set,r()});const E=a();E&&E.addEventListener("change",function(B){const T=B.target.closest('input[type="checkbox"][data-cid]');if(!T)return;const S=T.dataset.cid;T.checked?e.selected.add(S):e.selected.delete(S),c()})}function f(){e.opened&&(l(),r())}typeof window.subscribeI18n=="function"&&window.subscribeI18n("assign-clients-modal",f),window.openAssignClientsModal=function(h,_){u(),p(h,_)}})();(function(){const e={page:1,per_page:50,q:"",total:0,rows:[],loaded:!1};function n(m){if(!m)return"";try{return new Date(m).toLocaleString()}catch{return m}}function a(m){const d=document.getElementById("access-log-table");d&&(d.innerHTML='<div class="access-log-empty">'+escapeHtml(m)+"</div>");const u=document.getElementById("access-log-pager");u&&(u.innerHTML="")}function o(){const m=document.getElementById("access-log-table");if(!m)return;const d=e.rows||[];if(!d.length){a(t("set-access-log-empty"));return}const u=`
            <div class="access-log-row access-log-head">
                ...
                </div>`}).join("");m.innerHTML=u+f}function s(){const m=document.getElementById("access-log-pager");if(!m)return;const d=e.total||0;if(!d){m.innerHTML="";return}const u=e.page||1,f=e.per_page,h=Math.max(1,Math.ceil(d/f)),_=(t("set-access-log-pager-total")||"Total {n}").replace("{n}",d),w=(t("set-access-log-pager-page")||"Page {p} / {t}").replace("{p}",u).replace("{t}",h);m.innerHTML=`
            ...
            </div>`}async function i(m){const d=localStorage.getItem("mrpilot_token");if(d){e.page=m||1,a(t("set-access-log-loading"));try{const u="/api/me/access_log?page="+e.page+"&per_page="+e.per_page+"&q="+encodeURIComponent(e.q||""),f=await fetch(u,{headers:{Authorization:"Bearer "+d}});if(f.status===403){a(t("set-access-log-empty"));return}if(!f.ok)throw new Error("http_"+f.status);const h=await f.json();e.rows=h.logs||[],e.total=h.total||0,e.loaded=!0,o(),s()}catch{a(t("set-access-log-fail"))}}}async function r(){const m=localStorage.getItem("mrpilot_token");if(m)try{const d="/api/me/access_log.csv?q="+encodeURIComponent(e.q||""),u=await fetch(d,{headers:{Authorization:"Bearer "+m}});if(!u.ok){showToast(t("set-access-log-csv-fail")||"Export failed","error");return}const f=await u.blob(),h=document.createElement("a"),_=URL.createObjectURL(f);h.href=_,h.download="pearnly_access_log.csv",document.body.appendChild(h),h.click(),setTimeout(function(){URL.revokeObjectURL(_),h.remove()},100),showToast(t("set-access-log-csv-ok")||"Exported","success")}catch{showToast(t("set-access-log-csv-fail")||"Export failed","error")}}function c(){const m=document.querySelectorAll(".set-tab-owner-only"),d=!!(_userInfo&&(_userInfo.role==="owner"||_userInfo.is_super_admin));m.forEach(function(u){u.style.display=d?"":"none"})}document.addEventListener("click",function(m){if(m.target.closest('.settings-tab[data-tab="access-log"]')){setTimeout(function(){(!e.loaded||e.page!==1)&&i(1)},50);return}if(m.target.closest("#access-log-csv-btn")){m.preventDefault(),r();return}const f=m.target.closest(".access-log-pager-btn[data-access-log-page]");if(f&&!f.disabled){const h=parseInt(f.dataset.accessLogPage,10);i(h)}}),document.addEventListener("input",function(m){m.target&&m.target.id==="access-log-search"&&(clearTimeout(window.__accessLogSearchTimer),window.__accessLogSearchTimer=setTimeout(function(){e.q=(m.target.value||"").trim(),i(1)},350))});let l=0;const p=setInterval(function(){l++,_userInfo&&(c(),clearInterval(p)),l>60&&clearInterval(p)},500);typeof window.subscribeI18n=="function"&&window.subscribeI18n("me-access-log",function(){c(),e.loaded&&(o(),s())})})();(function(){const e=document.getElementById("notif-new-modal");if(!(!e||e.dataset.wbInjected==="1")){e.innerHTML=`
...
`,e.dataset.wbInjected="1";try{const n=window._currentLang||localStorage.getItem("mrpilot_lang")||"th",a=window.I18N;a&&a[n]&&(e.querySelectorAll("[data-i18n]").forEach(o=>{const s=o.getAttribute("data-i18n");a[n][s]&&(o.textContent=a[n][s])}),e.querySelectorAll("[data-i18n-placeholder]").forEach(o=>{const s=o.getAttribute("data-i18n-placeholder");a[n][s]&&(o.placeholder=a[n][s])}))}catch{}}})();(function(){const e=S=>document.getElementById(S);async function n(S,b){return await fetch(S,{method:"PATCH",headers:{Authorization:"Bearer "+token,"Content-Type":"application/json"},body:JSON.stringify(b||{})})}async function a(S){return await fetch(S,{method:"DELETE",headers:{Authorization:"Bearer "+token}})}let o=null;async function s(){try{o=await apiGet("/api/line/binding")}catch{o={bound:!1}}return o}function i(S,b){if(!S)return;S.style.display="",S.className="notif-line-check "+(b?"bound":"unbound");const g=b?'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M20 6 9 17l-5-5"/></svg>':'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><path d="M12 8v4M12 16h.01"/></svg>';S.innerHTML=g+"<span>"+escapeHtml(t(b?"notif-line-bound":"notif-line-not-bound"))+"</span>"}function r(S){if(S==null)return"-";const b=Number(S);return isNaN(b)?String(S):"฿ "+b.toLocaleString("en-US",{minimumFractionDigits:2,maximumFractionDigits:2})}function c(S){if(!S)return"-";try{const b=new Date(S),g=(b.getMonth()+1).toString().padStart(2,"0"),x=b.getDate().toString().padStart(2,"0"),I=b.getHours().toString().padStart(2,"0"),L=b.getMinutes().toString().padStart(2,"0");return`${g}-${x} ${I}:${L}`}catch{return S}}function l(S){const b=e("notif-rules-list"),g=e("notif-rules-empty"),x=e("notif-rules-count");if(!(!b||!g)){if(x.textContent=String(S.length),x.className="auto-status-pill "+(S.length>0?"active":"none"),!S.length){g.style.display="",b.style.display="none",b.innerHTML="";return}g.style.display="none",b.style.display="",b.innerHTML=S.map(I=>{const L=I.template_code==="large_invoice",C=L?"notif-rule-large-tag":"notif-rule-exception-tag",k=L?"large":"";let M=[];if(L){const A=I.params&&I.params.threshold?r(I.params.threshold):"-";M.push(escapeHtml(t("notif-rule-threshold-prefix"))+" "+A)}I.enabled||M.push('<span style="color:#9ca3af;">'+escapeHtml(t("notif-rule-disabled"))+"</span>");const $=M.length?M.join(' <span class="dot"></span> '):"";return`
                ...
                </div>`}).join("")}}function p(S){const b=e("notif-logs-list");if(b){if(!S.length){b.innerHTML='<div class="notif-logs-empty">'+escapeHtml(t("notif-logs-empty"))+"</div>";return}b.innerHTML=S.map(g=>{const x=g.status==="sent",I=g.event_type==="exception_high"?"notif-event-exception-high":g.event_type==="large_invoice"?"notif-event-large-invoice":"notif-event-test-send",L=x?"":" · "+escapeHtml(g.error||"failed");return`
                <div class="notif-log-row">
                    ...
                    <div class="notif-log-main">
                        ...
                        <div class="notif-log-meta">${escapeHtml(g.template_code||"-")}${L}</div>
                    </div>
                    <div class="notif-log-time">${c(g.sent_at)}</div>
                </div>`}).join("")}}async function m(){try{const S=await apiGet("/api/notifications/rules");d=S&&S.items||[],l(d)}catch(S){console.warn("load rules fail",S)}try{const S=await apiGet("/api/notifications/logs?limit=20");u=S&&S.items||[],p(u)}catch(S){console.warn("load logs fail",S)}}let d=null,u=null;function f(){d&&l(d),u&&p(u);const S=e("notif-new-modal");S&&S.style.display!=="none"&&o&&i(e("notif-line-check"),!!(o&&o.bound))}function h(){const S=e("notif-new-modal");S&&(S.style.display="",e("notif-new-name").value="",e("notif-new-threshold").value="",e("notif-new-threshold-row").style.display="none",document.querySelectorAll('input[name="notif-template"]').forEach(b=>b.checked=!1),s().then(b=>i(e("notif-line-check"),!!(b&&b.bound))))}function _(){const S=e("notif-new-modal");S&&(S.style.display="none")}function w(){const S=document.querySelector('input[name="notif-template"]:checked'),b=e("notif-new-threshold-row");if(!S){b.style.display="none";return}b.style.display=S.value==="large_invoice"?"":"none";const g=e("notif-new-name");g&&!g.value.trim()&&(g.value=S.value==="large_invoice"?t("notif-tmpl-large-name"):t("notif-tmpl-exception-name"))}async function y(){const S=document.querySelector('input[name="notif-template"]:checked');if(!S){showToast(t("notif-new-template"),"error");return}const b=(e("notif-new-name").value||"").trim();if(!b){showToast(t("notif-name-required"),"error");return}const g={name:b,template_code:S.value,params:{},enabled:!0};if(S.value==="large_invoice"){const x=parseFloat(e("notif-new-threshold").value||"0");if(!x||x<=0){showToast(t("notif-threshold-required"),"error");return}g.params.threshold=x}try{const x=await apiPost("/api/notifications/rules",g);if(x&&x.ok)showToast(t("notif-toast-created"),"success"),_(),m();else{const I=await(x&&x.json&&x.json().catch(()=>({})))||{};showToast(I&&I.detail||"save failed","error")}}catch{showToast("save failed","error")}}async function v(S,b,g){if(S==="toggle"){const x=g.classList.contains("on"),I=await n("/api/notifications/rules/"+b,{enabled:!x});I&&I.ok?(showToast(t(x?"notif-toast-toggled-off":"notif-toast-toggled-on"),"success"),m()):showToast("toggle failed","error");return}if(S==="test"){const x=await s();if(!x||!x.bound){showToast(t("notif-line-error-bind-first"),"error");return}const I=await apiPost("/api/notifications/rules/"+b+"/test",{});if(I&&I.ok)showToast(t("notif-toast-test-sent"),"success"),m();else{const L=await(I&&I.json&&I.json().catch(()=>({})))||{},C=L&&L.detail||"";showToast(C||t("notif-toast-test-failed"),"error"),m()}return}if(S==="delete"){if(!await showConfirm(t("notif-confirm-delete"),{danger:!0}))return;const I=await a("/api/notifications/rules/"+b);I&&I.ok?(showToast(t("notif-toast-deleted"),"success"),m()):showToast("delete failed","error");return}}let E=!1;function B(){if(E)return;E=!0;const S=e("notif-btn-new");S&&S.addEventListener("click",h);const b=e("notif-btn-refresh-logs");b&&b.addEventListener("click",m);const g=e("notif-new-close");g&&g.addEventListener("click",_);const x=e("notif-new-cancel");x&&x.addEventListener("click",_);const I=e("notif-new-save");I&&I.addEventListener("click",y),document.querySelectorAll('input[name="notif-template"]').forEach(k=>{k.addEventListener("change",w)});const L=e("notif-rules-list");L&&L.addEventListener("click",k=>{const M=k.target.closest("button[data-action]");if(!M)return;const $=M.closest("[data-rule-id]");$&&v(M.getAttribute("data-action"),$.getAttribute("data-rule-id"),M)});const C=e("notif-new-modal");C&&C.addEventListener("click",k=>{k.target===C&&_()})}async function T(){B(),await m()}window._loadNotificationsPanel=T,window._rerenderNotifications=f})();(function(){function n(y,v){try{return window.t&&window.t(y)||v}catch{return v}}function a(){var y="";try{y=localStorage.getItem("mrpilot_token")||""}catch{}return y?{Authorization:"Bearer "+y}:{}}var o=[{tbody:"vex-task-tbody",api:"/api/recon/tasks/batch_delete",reload:function(){try{window.loadRecentTasks&&window.loadRecentTasks()}catch{}},kind:"vex"},{tbody:"glv-history-tbody",api:"/api/recon/gl-vat/tasks/batch_delete",reload:function(){try{window._loadGlvHistory&&window._loadGlvHistory()}catch{}},kind:"glv"},{tbody:"brv2-history-tbody",api:"/api/recon/bank-v2/tasks/batch_delete",reload:function(){try{window._brv2LoadHistory&&window._brv2LoadHistory()}catch{}},kind:"brv2"}];function s(){if(!document.getElementById("recon-batch-style")){var y=document.createElement("style");y.id="recon-batch-style",y.textContent=".recon-sel-cell{width:36px;text-align:center;padding-left:10px!important;padding-right:6px!important}.recon-sel-cb,.recon-master-cb{cursor:pointer;width:14px;height:14px;accent-color:#111;margin:0;vertical-align:middle}th.recon-time-col,td.recon-time-col{white-space:nowrap}tr.recon-thead-batch{display:none}thead.recon-batch-mode tr.recon-thead-default{display:none}thead.recon-batch-mode tr.recon-thead-batch{display:table-row}tr.recon-thead-batch th{background:#fafaf8;border-bottom:1px solid #e8e8e3;padding:8px 12px}tr.recon-thead-batch .recon-batch-inline{display:flex;align-items:center;gap:10px;font-size:12px;color:#111;font-weight:normal}tr.recon-thead-batch .recon-batch-count-inline{font-weight:600;color:#111;margin-right:4px}tr.recon-thead-batch .recon-batch-del-inline{background:#dc2626;color:#fff;border:none;border-radius:6px;padding:4px 10px;font-size:12px;font-weight:600;cursor:pointer;font-family:inherit;display:inline-flex;align-items:center;gap:4px}tr.recon-thead-batch .recon-batch-del-inline:hover{background:#b91c1c}tr.recon-thead-batch .recon-batch-clear-inline{background:transparent;border:none;color:#555;cursor:pointer;font-size:12px;font-family:inherit;text-decoration:underline;padding:4px 2px}tr.recon-thead-batch .recon-batch-clear-inline:hover{color:#111}.recon-batch-bar{display:none!important}",document.head.appendChild(y)}}function i(y){return y?y.dataset&&y.dataset.taskId?y.dataset.taskId:y.dataset&&y.dataset.taskid?y.dataset.taskid:"":""}function r(y){var v=document.getElementById(y.tbody);if(!v)return null;var E=v.closest("table");if(!E)return null;var B=E.querySelector("thead");if(!B)return null;if(B._reconReady)return B;var T=B.querySelector("tr");if(!T)return null;if(T.classList.add("recon-thead-default"),!T.querySelector(".recon-master-cb")){var S=document.createElement("th");S.className="recon-sel-cell";var b=document.createElement("input");b.type="checkbox",b.className="recon-master-cb",b.setAttribute("aria-label","select all"),b.addEventListener("change",function(){m(y,b.checked)}),S.appendChild(b),T.insertBefore(S,T.firstElementChild)}var g=T.children[1];g&&!g.classList.contains("recon-time-col")&&g.classList.add("recon-time-col");var x=T.children.length,I=document.createElement("tr");I.className="recon-thead-batch";var L=document.createElement("th");L.className="recon-sel-cell";var C=document.createElement("input");C.type="checkbox",C.className="recon-master-cb",C.checked=!0,C.setAttribute("aria-label","select all"),C.addEventListener("change",function(){m(y,C.checked)}),L.appendChild(C);var k=document.createElement("th");return k.setAttribute("colspan",String(x-1)),k.innerHTML='<div class="recon-batch-inline"><span class="recon-batch-count-inline" data-recon-count></span><button type="button" class="recon-batch-del-inline" data-recon-del><svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" width="13" height="13"><polyline points="3 4 13 4"/><path d="M6 4V2.5a.5.5 0 0 1 .5-.5h3a.5.5 0 0 1 .5.5V4"/><path d="M5 4l1 9a1 1 0 0 0 1 1h2a1 1 0 0 0 1-1l1-9"/></svg><span data-recon-del-label></span></button><button type="button" class="recon-batch-clear-inline" data-recon-clear></button></div>',I.appendChild(L),I.appendChild(k),B.appendChild(I),k.querySelector("[data-recon-del]").addEventListener("click",function(){h(y)}),k.querySelector("[data-recon-clear]").addEventListener("click",function(){f(y)}),B._reconReady=!0,u(y),B}function c(y){var v=document.getElementById(y.tbody);if(v){var E=v.querySelectorAll("tr");E.forEach(function(B){var T=i(B);if(T&&!B.querySelector(".recon-sel-cb")){var S=B.querySelector("td");if(S){var b=document.createElement("td");b.className="recon-sel-cell";var g=document.createElement("input");g.type="checkbox",g.className="recon-sel-cb",g.dataset.taskId=T,g.dataset.kind=y.kind,g.addEventListener("click",function(I){I.stopPropagation()}),g.addEventListener("change",function(){d(y)}),b.appendChild(g),B.insertBefore(b,S);var x=B.children[1];x&&!x.classList.contains("recon-time-col")&&x.classList.add("recon-time-col")}}}),d(y)}}function l(y){var v=document.getElementById(y.tbody);return v?Array.prototype.slice.call(v.querySelectorAll(".recon-sel-cb")):[]}function p(y){return l(y).filter(function(v){return v.checked}).map(function(v){return v.dataset.taskId})}function m(y,v){l(y).forEach(function(E){E.checked=!!v}),d(y)}function d(y){var v=p(y),E=l(y),B=document.getElementById(y.tbody);if(B){var T=B.closest("table"),S=T&&T.querySelector("thead");if(S){v.length>0?S.classList.add("recon-batch-mode"):S.classList.remove("recon-batch-mode"),S.querySelectorAll(".recon-master-cb").forEach(function(g){if(E.length===0){g.checked=!1,g.indeterminate=!1;return}v.length===E.length?(g.checked=!0,g.indeterminate=!1):v.length===0?(g.checked=!1,g.indeterminate=!1):(g.checked=!1,g.indeterminate=!0)});var b=S.querySelector("[data-recon-count]");b&&(b.textContent=n("recon-batch-selected-n","已选 {n} 条").replace("{n}",v.length))}}}function u(y){var v=document.getElementById(y.tbody);if(v){var E=v.closest("table"),B=E&&E.querySelector("thead");if(B){var T=B.querySelector("[data-recon-del-label]"),S=B.querySelector("[data-recon-clear]");T&&(T.textContent=n("recon-batch-delete","批量删除")),S&&(S.textContent=n("recon-batch-clear","取消")),d(y)}}}function f(y){l(y).forEach(function(v){v.checked=!1}),d(y)}async function h(y){var v=p(y);if(v.length){var E=n("recon-batch-delete-confirm","确定删除选中的 {n} 条对账任务?此操作不可恢复").replace("{n}",v.length),B=!1;try{typeof window.pearnlyConfirm=="function"?B=await window.pearnlyConfirm(E,n("recon-batch-delete-title","批量删除")):B=window.confirm(E)}catch{B=!1}if(B)try{var T=Object.assign({"Content-Type":"application/json"},a()),S=y.kind==="glv"?v.map(function(I){return parseInt(I,10)}):v,b=await fetch(y.api,{method:"POST",headers:T,body:JSON.stringify({ids:S})});if(!b.ok){typeof window.showToast=="function"&&window.showToast(n("recon-batch-delete-fail","批量删除失败"),"error");return}var g=await b.json(),x=g&&(g.deleted!=null?g.deleted:g.count)||v.length;typeof window.showToast=="function"&&window.showToast(n("recon-batch-delete-ok","已删除 {n} 条").replace("{n}",x),"success"),y.reload()}catch{typeof window.showToast=="function"&&window.showToast(n("recon-batch-delete-fail","批量删除失败"),"error")}}}function _(y){r(y),c(y);var v=document.getElementById(y.tbody);if(!(!v||v._reconBatchWatched)){v._reconBatchWatched=!0;var E=new MutationObserver(function(){c(y)});E.observe(v,{childList:!0,subtree:!1})}}function w(){s(),o.forEach(_),document.querySelectorAll(".recon-batch-bar").forEach(function(y){try{y.remove()}catch{}})}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",w):w(),setTimeout(w,1500),setTimeout(w,4e3),document.addEventListener("keydown",function(y){y.key==="Escape"&&o.forEach(function(v){p(v).length>0&&f(v)})}),typeof window.subscribeI18n=="function"&&window.subscribeI18n("recon-batch-thead",function(){o.forEach(u)})})();(function(){let e={role:"",monthly_volume:"",country:"",line_id:""},n=1;const a=4,o="pilot_ob_dismiss",s="pilot_ob_done";window.maybeShowOnboarding=function(p){};function i(p){n=p;for(let u=1;u<=a;u++){const f=document.getElementById("ob-step-"+u);f&&(f.style.display=u===p?"block":"none")}document.querySelectorAll(".ob-dot").forEach(u=>{const f=parseInt(u.dataset.step,10);u.classList.toggle("active",f===p),u.classList.toggle("done",f<p)});const m=document.getElementById("ob-step-label");m&&(m.textContent=p+" / "+a);const d=document.getElementById("ob-next");if(d&&(d.textContent=p===a?t("ob-finish"):t("ob-next")),p===4){const u=document.getElementById("ob-line-input");u&&(u.value=e.line_id||"")}}function r(p){const m=document.querySelector(".onboarding-modal");if(!m)return;let d=m.querySelector(".ob-feedback");d||(d=document.createElement("div"),d.className="ob-feedback",m.appendChild(d)),d.textContent=p,d.classList.add("show"),setTimeout(()=>d.classList.remove("show"),1800)}document.addEventListener("click",p=>{const m=p.target.closest(".ob-option");if(!m)return;const d=m.parentElement;if(!d||!d.classList.contains("ob-options"))return;d.querySelectorAll(".ob-option").forEach(f=>f.classList.remove("selected")),m.classList.add("selected");const u=m.dataset.value;d.id==="ob-role-options"?e.role=u:d.id==="ob-volume-options"?e.monthly_volume=u:d.id==="ob-country-options"&&(e.country=u)}),document.addEventListener("click",p=>{p.target.id==="ob-skip"&&c()}),document.addEventListener("click",p=>{if(p.target.id==="ob-next"){if(n===4){const m=document.getElementById("ob-line-input");e.line_id=(m&&m.value||"").trim().replace(/^@+/,"")}c()}}),document.addEventListener("click",p=>{if(p.target.closest("#ob-close")){localStorage.setItem(o,String(Date.now()));const m=document.getElementById("onboarding-modal");m&&(m.style.display="none")}});function c(){n===1&&e.role?r(t("ob-fb-role")):n===2&&e.monthly_volume?r(t("ob-fb-volume")):n===3&&e.country?r(t("ob-fb-country")):n===4&&e.line_id&&r(t("ob-fb-line")),n<a?setTimeout(()=>i(n+1),e[Object.keys(e)[n-1]]?350:0):l()}async function l(){const p=document.getElementById("onboarding-modal");localStorage.setItem(s,"1"),localStorage.removeItem(o);const m={};if(e.role&&(m.role=e.role),e.monthly_volume&&(m.monthly_volume=e.monthly_volume),e.country&&(m.country=e.country),e.line_id&&(m.line_id=e.line_id),Object.keys(m).length===0){p&&(p.style.display="none");return}try{const d=await fetch("/api/me/profile",{method:"PUT",headers:{Authorization:"Bearer "+(window.token||localStorage.getItem("mrpilot_token")),"Content-Type":"application/json"},body:JSON.stringify(m)});d.ok?(r(t("ob-fb-done")),window._userInfo&&Object.assign(window._userInfo,m),setTimeout(()=>{p&&(p.style.display="none")},1200)):(localStorage.setItem("pilot_ob_pending",JSON.stringify(m)),console.warn("onboarding profile save failed",d.status),r(t("ob-fb-saved-local")),setTimeout(()=>{p&&(p.style.display="none")},1500))}catch(d){console.error("onboarding submit",d),localStorage.setItem("pilot_ob_pending",JSON.stringify(m)),p&&(p.style.display="none")}}})();(function(){const e=document.getElementById("archive-rule-modal");if(!(!e||e.dataset.wbInjected==="1")){e.innerHTML=`
...
`,e.dataset.wbInjected="1";try{const n=window._currentLang||localStorage.getItem("mrpilot_lang")||"th",a=window.I18N;a&&a[n]&&(e.querySelectorAll("[data-i18n]").forEach(o=>{const s=o.getAttribute("data-i18n");a[n][s]&&(o.textContent=a[n][s])}),e.querySelectorAll("[data-i18n-placeholder]").forEach(o=>{const s=o.getAttribute("data-i18n-placeholder");a[n][s]&&(o.placeholder=a[n][s])}))}catch{}}})();(function(){const e=document.getElementById("archive-token-modal");if(!(!e||e.dataset.wbInjected==="1")){e.innerHTML=`
        ...
        `}async function m(){try{const b=await fetch("/api/settings/dup-check",{headers:{Authorization:"Bearer "+token}});if(!b.ok)return;const g=await b.json(),x=document.getElementById("pref-dup-check");x&&(x.checked=!!g.enabled)}catch(b){console.warn("load prefs failed",b)}}const d=document.getElementById("pref-dup-check");d&&!d.dataset.bound&&(d.dataset.bound="1",d.addEventListener("change",async b=>{const g=b.target.checked;try{(await fetch("/api/settings/dup-check",{method:"PUT",headers:{Authorization:"Bearer "+token,"Content-Type":"application/json"},body:JSON.stringify({enabled:g})})).ok?showToast(g?t("pref-dup-check-on-toast"):t("pref-dup-check-off-toast"),"success"):(b.target.checked=!g,showToast(t("pref-save-failed"),"error"))}catch{b.target.checked=!g,showToast(t("pref-save-failed"),"error")}}));async function u(){const b=!!(_userInfo&&_userInfo.can_customize_archive);o=!b;const g=document.getElementById("archive-upgrade-banner");g&&(g.style.display=b?"none":"");const x=document.getElementById("archive-plus-badge");x&&(x.style.display=b?"none":"");try{const I=await fetch("/api/archive/settings",{headers:{Authorization:"Bearer "+token}});if(!I.ok)throw new Error("load failed");const L=await I.json();e=Array.isArray(L.name_template)?L.name_template:[],n=L.folder_strategy||"by_month_seller"}catch(I){console.error("load archive settings failed",I),showToast(t("archive-load-failed"),"error");return}f(),h(),_(),w()}function f(){const b=document.getElementById("archive-rule-canvas");if(b){if(e.length===0){b.innerHTML=`<div class="archive-empty">${escapeHtml(t("archive-rule-empty"))}</div>`;return}b.innerHTML=e.map((g,x)=>{const I=i[g.type]||{label:g.type},L=s[g.type]||"",C=g.type==="sep"?`"${escapeHtml(g.val||"_")}"`:escapeHtml(t(I.label));return`
                <span class="archive-token ${g.type}"
                      data-token-idx="${x}"
                      draggable="${o?"false":"true"}">
                    <span class="token-icon">${L}</span>
                    <span class="token-label">${C}</span>
                </span>
            `}).join("")}}function h(){const b=document.getElementById("archive-field-palette");if(!b)return;const g=["date","seller","category","amount","invoice","buyer","sep"];b.innerHTML=g.map(x=>{const I=i[x],L=s[x]||"";return`
                <button class="archive-palette-btn ${x}" data-add-field="${x}" ${o?"disabled":""}>
                    <span class="token-icon">${L}</span>
                    <span>${escapeHtml(t(I.label))}</span>
                </button>
            `}).join("")}function _(){document.querySelectorAll('input[name="folder-strategy"]').forEach(b=>{b.checked=b.value===n,b.disabled=o})}async function w(){const b=document.getElementById("archive-preview-name"),g=document.getElementById("archive-preview-hint");if(g&&(g.textContent=t("archive-preview-hint",{category:r()})),!!b){if(e.length===0){b.textContent="-";return}try{const I=await(await fetch("/api/archive/rename-preview",{method:"POST",headers:{Authorization:"Bearer "+token,"Content-Type":"application/json"},body:JSON.stringify({merged_fields:l().merged_fields,name_template:e})})).json();b.textContent=(I.name||"-")+".pdf"}catch{b.textContent="("+t("archive-preview-error")+")"}}}window._rerenderArchiveAll=function(){const b=document.getElementById("archive-rule-modal");!b||b.style.display==="none"||(f(),h(),w())};let y=-1;document.addEventListener("dragstart",b=>{const g=b.target.closest(".archive-token");!g||o||(y=parseInt(g.dataset.tokenIdx,10),g.classList.add("dragging"),b.dataTransfer.effectAllowed="move")}),document.addEventListener("dragend",b=>{document.querySelectorAll(".archive-token").forEach(g=>g.classList.remove("dragging","drop-target")),y=-1}),document.addEventListener("dragover",b=>{const g=b.target.closest(".archive-token");g&&(b.preventDefault(),b.dataTransfer.dropEffect="move",document.querySelectorAll(".archive-token").forEach(x=>x.classList.remove("drop-target")),g.classList.add("drop-target"))}),document.addEventListener("drop",b=>{const g=b.target.closest(".archive-token");if(!g||y<0||o)return;b.preventDefault();const x=parseInt(g.dataset.tokenIdx,10);if(x===y)return;const I=e.splice(y,1)[0];e.splice(x,0,I),y=-1,f(),w()}),document.addEventListener("click",b=>{if(b.target.closest("#btn-open-archive-rule")||b.target.closest("#btn-open-archive-rule-from-settings")){const L=document.getElementById("archive-rule-modal");L&&(L.style.display="",u());return}if(b.target.closest("#archive-rule-modal-close")||b.target.id==="archive-rule-modal"){const L=document.getElementById("archive-rule-modal");L&&(L.style.display="none");return}const g=b.target.closest(".settings-nav-item");if(g){switchSettingsTab(g.dataset.settingsTab);return}if(o&&b.target.closest(".archive-token, [data-add-field], #btn-archive-save, #btn-archive-reset")){showToast(t("feature-contact-us"),"info");return}const x=b.target.closest("[data-add-field]");if(x){const L=x.dataset.addField,C=i[L],k={type:L,...C.defaultCfg};e.push(k),f(),w();return}const I=b.target.closest(".archive-token");if(I&&!o){v(parseInt(I.dataset.tokenIdx,10));return}if(b.target.closest("#btn-archive-save"))return T();if(b.target.closest("#btn-archive-reset"))return S();(b.target.closest("#archive-token-close")||b.target.id==="archive-token-modal")&&(document.getElementById("archive-token-modal").style.display="none"),b.target.closest("#btn-archive-token-ok")&&E(),b.target.closest("#btn-archive-token-delete")&&B()}),document.addEventListener("change",b=>{b.target.name==="folder-strategy"&&(n=b.target.value)});function v(b){a=b;const g=e[b];if(!g)return;const x=document.getElementById("archive-token-body");let I="";g.type==="date"?I=`
                <div class="form-group">
                ...
                </div>`:I=`<div class="form-hint">${escapeHtml(t("archive-token-no-option"))}</div>`,x.innerHTML=I,document.getElementById("archive-token-modal").style.display="",x.querySelectorAll(".sep-chip").forEach(L=>{L.addEventListener("click",()=>{x.querySelectorAll(".sep-chip").forEach(k=>k.classList.remove("active")),L.classList.add("active");const C=document.getElementById("token-sep-custom");C&&(C.value="")})})}function E(){const b=e[a];if(b){if(b.type==="date")b.format=document.getElementById("token-date-format").value;else if(b.type==="seller")b.short=document.getElementById("token-seller-short").checked;else if(b.type==="amount")b.with_currency=document.getElementById("token-amount-currency").checked;else if(b.type==="sep"){const g=document.querySelector("#archive-token-body .sep-chip.active"),x=document.getElementById("token-sep-custom").value;b.val=x||(g?g.dataset.sep:"_")}document.getElementById("archive-token-modal").style.display="none",f(),w()}}function B(){a<0||(e.splice(a,1),document.getElementById("archive-token-modal").style.display="none",f(),w())}async function T(){if(e.length===0){showToast(t("archive-rule-cannot-empty"),"error");return}try{if(!(await fetch("/api/archive/settings",{method:"PUT",headers:{Authorization:"Bearer "+token,"Content-Type":"application/json"},body:JSON.stringify({name_template:e,folder_strategy:n})})).ok)throw new Error("save failed");showToast(t("archive-save-ok"),"success");const g=document.getElementById("archive-rule-modal");g&&(g.style.display="none")}catch{showToast(t("archive-save-fail"),"error")}}async function S(){await showConfirm(t("archive-reset-confirm"),{danger:!0})&&(e=[{type:"date",format:"YYYY-MM-DD"},{type:"sep",val:"_"},{type:"seller",short:!0},{type:"sep",val:"_"},{type:"category"},{type:"sep",val:"_"},{type:"amount",with_currency:!0}],n="by_month_seller",f(),_(),w())}})();(function(){const o="pearnly_big_batch_tip_shown";let s=null,i=null,r=0,c=0,l=!1;function p(v){const E=typeof t=="function"?t("big-batch-unload-warn"):"Batch OCR running · close anyway?";return v.preventDefault(),v.returnValue=E,E}function m(){l||(l=!0,window.addEventListener("beforeunload",p))}function d(){l&&(l=!1,window.removeEventListener("beforeunload",p))}function u(){if(document.getElementById("big-batch-progress"))return;const v=document.getElementById("file-list");if(!v||!v.parentNode)return;const E=document.createElement("div");E.id="big-batch-progress",E.className="big-batch-progress",E.innerHTML='<div class="bbp-row"><svg class="bbp-icon" viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><circle cx="8" cy="8" r="6.5"/><path d="M8 4.5v3.5l2.5 1.5"/></svg><span class="bbp-text" id="bbp-text"></span></div><div class="bbp-track"><div class="bbp-fill" id="bbp-fill" style="width:0%"></div></div>',v.parentNode.insertBefore(E,v);const B=document.getElementById("bbp-text");B&&(B.textContent=typeof t=="function"?t("big-batch-progress-init"):"Starting...")}function f(){const v=document.getElementById("big-batch-progress");v&&v.remove()}function h(){if(!i)return;let v=0;for(let I=0;I<i.length;I++){const L=i[I].status;(L==="success"||L==="error"||L==="cancelled")&&v++}const E=r,B=E>0?Math.min(100,Math.floor(100*v/E)):0,T=(Date.now()-c)/1e3;let S;if(v>=3&&T>1){const I=T/v;S=(E-v)*I}else S=(E-v)*6/6;const b=Math.max(1,Math.ceil(S/60)),g=document.getElementById("bbp-fill"),x=document.getElementById("bbp-text");g&&(g.style.width=B+"%"),x&&(v>=E?x.textContent=t("big-batch-progress-done").replace("{total}",E):x.textContent=t("big-batch-progress-running").replace("{done}",v).replace("{total}",E).replace("{min}",b))}function _(v){try{if(localStorage.getItem(o)==="1")return}catch{}const E=Math.max(1,Math.ceil(v*6/6/60)),B=t("big-batch-first-tip").replace("{n}",v).replace("{min}",E);typeof showToast=="function"&&showToast(B,"info",8e3);try{localStorage.setItem(o,"1")}catch{}}function w(v){!v||v.length<100||(i=v,r=v.length,c=Date.now(),u(),m(),_(r),s&&clearInterval(s),s=setInterval(h,250),h())}function y(){s&&(clearInterval(s),s=null),d(),i&&r>=100?(h(),setTimeout(f,1200)):f(),i=null,r=0}window._bigBatchStart=w,window._bigBatchStop=y,typeof window.subscribeI18n=="function"&&window.subscribeI18n("big-batch-progress",function(){i&&h()})})();(function(){let e=null,n=!1,a=!1;function o(g){return typeof escapeHtml=="function"?escapeHtml(g==null?"":String(g)):String(g??"")}function s(g,x){try{typeof showToast=="function"&&showToast(g,x||"info")}catch{}}function i(){const g=typeof _userInfo<"u"?_userInfo:null;return!!(g&&(g.role==="owner"||g.is_super_admin))}function r(){try{return(typeof _results<"u"?_results:[])[typeof _drawerIdx<"u"?_drawerIdx:-1]||null}catch{return null}}function c(g){if(!g)return!1;const x=String(g.status||"").toLowerCase();return x==="exception"||x==="exception_pending"||x==="rejected"}async function l(g){if(n&&!g)return e;const x=localStorage.getItem("mrpilot_token");if(!x)return null;try{const I=await fetch("/api/erp/xero/status",{headers:{Authorization:"Bearer "+x}});if(!I.ok)throw new Error("http_"+I.status);e=await I.json(),n=!0}catch{e={configured:!1,connected:!1,organisations:[]},n=!1}return e}function p(){const g=document.getElementById("erp-connect-cards");if(!g)return;const x=e;let I,L=!1;x?x.configured?x.connected?(L=!0,I='<span class="mrerp-card-pill mrerp-pill-ok">'+o(t("xero-card-connected"))+"</span>"):I='<span class="mrerp-card-pill mrerp-pill-neutral">'+o(t("xero-card-not-connected"))+"</span>":I='<span class="mrerp-card-pill mrerp-pill-neutral">'+o(t("xero-card-not-configured"))+"</span>":I='<span class="mrerp-card-pill mrerp-pill-neutral">'+o(t("xero-card-not-connected"))+"</span>";let C="";if(!x||!x.configured)C='<button type="button" class="int-btn-configure" id="btn-xero-connect">'+o(t("xero-connect-btn"))+"</button>";else if(!x.connected)i()&&(C='<button type="button" class="int-btn-configure" id="btn-xero-connect">'+o(t("xero-connect-btn"))+"</button>");else{const O=!!x.auto_push,ee=O?t("card-btn-disable"):t("card-btn-enable");C='<button type="button" class="'+(O?"mrerp-card-toggle mrerp-card-toggle-disable":"mrerp-card-toggle mrerp-card-toggle-enable")+'" id="btn-xero-toggle-enabled" data-xero-enabled="'+(O?"1":"0")+'" title="'+o(O?t("erp-auto-push-on-tip"):t("erp-auto-push-off-tip"))+'">'+o(ee)+'</button><button type="button" class="int-btn-configure" id="btn-xero-edit-toggle">'+o(t("card-btn-edit"))+"</button>"}const k=x&&x.connected?"xero-card-desc-connected":"xero-card-desc-default",M=x&&x.connected?t("xero-card-connected")||"Connected · default org will receive pushes":"Cloud accounting · push invoices to your default Xero org",$=(function(){const O=t(k);return O===k?M:O})();let A='<div class="integration-row erp-connect-xero'+(L?" connected":"")+'"><div class="int-icon ic-xero"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="9"/><circle cx="9" cy="10" r="1.3" fill="currentColor"/><circle cx="15" cy="14" r="1.3" fill="currentColor"/><path d="M9 14l6-4"/></svg></div><div class="int-info"><div class="int-name"><span>'+o(t("xero-card-title")||"Xero")+"</span>"+I+'</div><div class="int-desc">'+o($)+'</div></div><div class="int-actions">'+C+"</div></div>";if(x&&x.configured&&x.connected&&i()){const O=x.organisations||[];let ee="";if(O.length>0){ee+='<div class="erp-cc-meta">'+o((t("xero-org-count")||"").replace("{n}",String(O.length)))+"</div>",ee+='<div class="erp-cc-org-label">'+o(t("xero-default-org"))+":</div>",ee+='<div class="erp-cc-orgs">',O.forEach(function(ue){ee+='<label class="erp-cc-org-row"><input type="radio" name="xero-default-org" value="'+o(ue.id)+'"'+(ue.is_default?" checked":"")+'><span class="erp-cc-org-name">'+o(ue.organisation_name||ue.organisation_id)+"</span></label>"}),ee+="</div>";const de=!!x.auto_push,me=de?t("erp-auto-push-on-tip"):t("erp-auto-push-off-tip");ee+='<div class="erp-cc-auto-push" title="'+o(me)+'"><label class="erp-cc-toggle"><input type="checkbox" id="xero-auto-push-toggle"'+(de?" checked":"")+'><span class="erp-cc-toggle-slider"></span><span class="erp-cc-toggle-label">'+o(t("erp-auto-push-label"))+"</span></label></div>",ee+='<div class="erp-cc-actions"><button class="btn btn-ghost btn-tiny" type="button" id="btn-xero-disconnect">'+o(t("xero-disconnect-btn"))+"</button></div>"}A+='<div class="erp-xero-details" id="erp-xero-details" style="display:none; margin:8px 0 16px; padding:12px 14px; border:1px solid var(--line); border-radius:8px; background:var(--bg);">'+ee+"</div>"}const H=g.querySelector(".erp-connect-xero"),P=g.querySelector("#erp-xero-details");P&&P.remove(),H?H.outerHTML=A:g.insertAdjacentHTML("afterbegin",A);const F=document.getElementById("btn-xero-edit-toggle");F&&F.addEventListener("click",function(O){O.preventDefault();const ee=document.getElementById("erp-xero-details");ee&&(ee.style.display=ee.style.display==="none"?"":"none")});const G=document.getElementById("btn-xero-toggle-enabled");G&&G.addEventListener("click",async function(O){if(O.preventDefault(),G.disabled)return;const de=!(G.getAttribute("data-xero-enabled")==="1");if(!de)try{if(!await window.pearnlyConfirm(t("card-toggle-disable-confirm")))return}catch{}G.disabled=!0,await f(de,null)})}async function m(){const g=localStorage.getItem("mrpilot_token");if(g)try{const x=await fetch("/api/erp/xero/auth/start",{method:"GET",headers:{Authorization:"Bearer "+g}});if(!x.ok){let L="unknown";try{L=(await x.json()).detail||"unknown"}catch{}const C=String(L).replace(/^xero\./,"").toLowerCase();s(t("xero-push-fail").replace("{err}",t("xero-err-"+C)||L),"error");return}const I=await x.json();I.redirect_url&&(window.location.href=I.redirect_url)}catch(x){s(t("xero-push-fail").replace("{err}",x.message||"network"),"error")}}async function d(){if(!await window.pearnlyConfirm(t("xero-disconnect-confirm")))return;const x=localStorage.getItem("mrpilot_token");try{const I=await fetch("/api/erp/xero/disconnect",{method:"POST",headers:{Authorization:"Bearer "+x}});if(!I.ok)throw new Error("http_"+I.status);await l(!0),p()}catch(I){s(t("xero-push-fail").replace("{err}",I.message),"error")}}async function u(g){const x=localStorage.getItem("mrpilot_token");try{const I=await fetch("/api/erp/xero/select_org",{method:"POST",headers:{Authorization:"Bearer "+x,"Content-Type":"application/json"},body:JSON.stringify({token_id:g})});if(!I.ok)throw new Error("http_"+I.status);await l(!0),p()}catch(I){s(t("xero-push-fail").replace("{err}",I.message),"error")}}async function f(g,x){const I=localStorage.getItem("mrpilot_token");x&&(x.disabled=!0);try{const L=await fetch("/api/erp/xero/auto-push",{method:"POST",headers:{Authorization:"Bearer "+I,"Content-Type":"application/json"},body:JSON.stringify({on:!!g})});if(!L.ok){let C="unknown";try{C=(await L.json()).detail||"unknown"}catch{}throw new Error(C)}s(g?t("erp-auto-push-toggled-on"):t("erp-auto-push-toggled-off"),"success"),n=!1,await l(!0),p()}catch(L){x&&(x.checked=!g),s(t("erp-auto-push-toggle-fail").replace("{err}",L.message||"network"),"error")}finally{x&&(x.disabled=!1)}}async function h(){const g=document.getElementById("drawer-history-save");if(!g||g.querySelector("#btn-xero-push")||g.querySelector("#pn-push-wrap")||(await l(!1),g.querySelector("#pn-push-wrap"))||g.querySelector("#btn-xero-push"))return;const x=r();if(!(x&&(x._historyId||x.history_id)))return;let L=!1,C="xero-push-tip";!e||!e.configured?(L=!0,C="xero-err-not_configured"):e.connected?c(x)&&(L=!0,C="xero-push-disabled-exc"):(L=!0,C="xero-push-disabled-no-conn");const k=document.createElement("button");k.type="button",k.id="btn-xero-push",k.className="btn btn-ghost"+(L?" disabled":""),k.disabled=L,k.title=t(C)||"",k.innerHTML='<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"><circle cx="8" cy="8" r="6"/><path d="M5 8l2 2 4-4"/></svg><span style="margin-left:4px;">'+o(t("xero-push-btn"))+"</span>",k.addEventListener("click",_);const M=document.getElementById("btn-push-erp");M&&M.parentNode?M.parentNode.insertBefore(k,M.nextSibling):g.insertBefore(k,g.firstChild)}async function _(){const g=r(),x=g&&(g._historyId||g.history_id);if(!x)return;const I=document.getElementById("btn-xero-push");I&&(I.disabled=!0,I.classList.add("loading"));const L=localStorage.getItem("mrpilot_token");try{const C=await fetch("/api/erp/xero/push/"+encodeURIComponent(x),{method:"POST",headers:{Authorization:"Bearer "+L}});if(!C.ok){let k="unknown";try{k=(await C.json()).detail||"unknown"}catch{}const M=String(k).replace(/^xero\./,"").toLowerCase(),$=t("xero-"+M),A=$&&$!=="xero-"+M?$:k;s(t("xero-push-fail").replace("{err}",A),"error");return}s(t("xero-push-ok"),"success")}catch(C){s(t("xero-push-fail").replace("{err}",C.message||"network"),"error")}finally{I&&(I.disabled=!1,I.classList.remove("loading"))}}async function w(){await l(!0),p(),y()}async function y(){const g=document.getElementById("erp-global-push-mode");if(!g)return;const x=localStorage.getItem("mrpilot_token");if(x)try{const I=await fetch("/api/settings/erp-push-mode",{headers:{Authorization:"Bearer "+x}});if(I.ok){const L=await I.json();L.mode&&(g.value=L.mode,g.dataset.prev=L.mode)}}catch{}}async function v(g){const x=g.value,I=localStorage.getItem("mrpilot_token");try{(await fetch("/api/settings/erp-push-mode",{method:"PUT",headers:{Authorization:"Bearer "+I,"Content-Type":"application/json"},body:JSON.stringify({mode:x})})).ok?(g.dataset.prev=x,s(t("pref-erp-mode-saved"),"success")):(g.value=g.dataset.prev||"smart",s(t("pref-save-failed"),"error"))}catch{g.value=g.dataset.prev||"smart",s(t("pref-save-failed"),"error")}}function E(){try{const g=String(window.location.hash||"");if(g.indexOf("xero=ok")>=0){const x=g.match(/n=(\d+)/),I=x?x[1]:"1";s((t("xero-toast-redirected-ok")||"").replace("{n}",I),"success"),history.replaceState(null,"",window.location.pathname+"#automation"),l(!0).then(p)}else g.indexOf("xero=err")>=0&&(s(t("xero-toast-redirected-err"),"error"),history.replaceState(null,"",window.location.pathname+"#automation"))}catch{}}function B(){if(a)return;a=!0,document.addEventListener("click",function(x){if(x.target.closest('.erp-subtab[data-erp-subtab="connect"]')){setTimeout(w,50);return}if(x.target.closest('.auto-nav-item[data-auto-tab="erp"]')){setTimeout(w,80);return}if(x.target.closest("#btn-xero-connect")){x.preventDefault(),m();return}if(x.target.closest("#btn-xero-disconnect")){x.preventDefault(),d();return}}),document.addEventListener("change",function(x){x.target&&x.target.matches('input[name="xero-default-org"]')&&u(x.target.value),x.target&&x.target.id==="xero-auto-push-toggle"&&f(x.target.checked,x.target),x.target&&x.target.id==="erp-global-push-mode"&&v(x.target)});const g=function(){return document.getElementById("drawer-body")};try{const x=new MutationObserver(function(){document.getElementById("drawer-history-save")&&!document.getElementById("btn-xero-push")&&h()}),I=g();if(I)x.observe(I,{childList:!0,subtree:!0});else{const L=new MutationObserver(function(){const C=g();C&&(x.observe(C,{childList:!0,subtree:!0}),L.disconnect())});L.observe(document.body,{childList:!0,subtree:!0})}}catch{}setTimeout(E,500)}function T(){e&&p();const g=document.getElementById("btn-xero-push");if(g){const x=g.querySelector("span");x&&(x.textContent=t("xero-push-btn"))}}B(),typeof window.subscribeI18n=="function"&&window.subscribeI18n("xero-adapter",T);async function S(g){const x=Date.now();for(;Date.now()-x<g;){if(typeof _userInfo<"u"&&_userInfo&&_userInfo.id)return _userInfo;await new Promise(I=>setTimeout(I,80))}return null}async function b(){await S(5e3);const g=document.querySelector('.auto-nav-item.active[data-auto-tab="erp"]'),x=document.querySelector('.erp-subtab.active[data-erp-subtab="connect"]');g&&x&&await w()}setTimeout(b,200)})();(function(){var e="https://www.mrerp4sme.com/dms/index.php",n=null,a=!1;function o(w){return typeof escapeHtml=="function"?escapeHtml(w==null?"":String(w)):String(w??"")}function s(w,y){try{typeof showToast=="function"&&showToast(w,y||"info")}catch{}}function i(){return localStorage.getItem("mrpilot_token")}async function r(w){var y=i();if(!y)return null;try{var v=await fetch("/api/erp/endpoints",{headers:{Authorization:"Bearer "+y}});if(!v.ok)throw new Error("http_"+v.status);var E=await v.json(),B=E&&E.items||[];n=B.find(function(T){return T&&(T.adapter||"").toLowerCase()==="mrerp_dms"})||null,a=!0}catch{n=null,a=!1}return n}function c(){var w=document.getElementById("erp-connect-cards");if(w){var y=w.querySelector("[data-mrerp-dms-zone]");y||(y=document.createElement("div"),y.setAttribute("data-mrerp-dms-zone","1"),w.appendChild(y));var v=n,E=!!(v&&v.enabled!==!1),B;v?E?B='<span class="mrerp-card-pill mrerp-pill-ok">'+o(t("dms-card-connected"))+"</span>":B='<span class="mrerp-card-pill mrerp-pill-neutral">'+o(t("dms-card-disabled-pill"))+"</span>":B='<span class="mrerp-card-pill mrerp-pill-neutral">'+o(t("dms-card-not-connected"))+"</span>";var T;if(!v)T='<button type="button" class="int-btn-configure" id="btn-dms-connect">'+o(t("dms-card-connect"))+"</button>";else{var S=E?t("dms-card-disable"):t("dms-card-enable");T='<button type="button" class="int-btn-configure" id="btn-dms-edit">'+o(t("dms-card-edit"))+'</button><button type="button" class="int-btn-configure" id="btn-dms-test">'+o(t("dms-card-test"))+'</button><button type="button" class="int-btn-configure" id="btn-dms-toggle">'+o(S)+"</button>"}y.innerHTML='<div class="integration-row erp-connect-mrerp-dms'+(E?" connected":"")+'"><div class="int-icon ic-mrerp-dms" style="background:#0a5c8a;color:#fff;"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M3 13l2-5a2 2 0 011.9-1.4h10.2A2 2 0 0119 8l2 5"/><path d="M3 13h18v4a1 1 0 01-1 1h-1a1 1 0 01-1-1v-1H6v1a1 1 0 01-1 1H4a1 1 0 01-1-1z"/><circle cx="7" cy="15.5" r="1"/><circle cx="17" cy="15.5" r="1"/></svg></div><div class="int-info"><div class="int-name"><span>'+o(t("dms-card-title"))+"</span>"+B+'</div><div class="int-desc">'+o(t("dms-card-desc"))+'</div></div><div class="int-actions">'+T+"</div></div>"}}function l(){var w=document.getElementById("dms-wizard-overlay");w&&w.remove(),document.removeEventListener("keydown",p)}function p(w){w.key==="Escape"&&l()}function m(){l();var w=n,y=w&&w.config&&w.config.booking_defaults&&w.config.booking_defaults.booking_prefix||"PN",v=function(T,S,b,g,x){return'<label style="display:block;margin-bottom:12px;"><span style="display:block;font-size:13px;color:var(--muted,#6b6b66);margin-bottom:5px;">'+o(t(T))+'</span><input id="'+S+'" type="'+b+'" value="'+o(g||"")+'" placeholder="'+o(x||"")+'" autocomplete="new-password" style="width:100%;box-sizing:border-box;padding:9px 11px;border:1px solid var(--line,#ddd);border-radius:8px;font-size:14px;"></label>'},E=document.createElement("div");E.id="dms-wizard-overlay",E.style.cssText="position:fixed;inset:0;z-index:13000;background:rgba(0,0,0,.42);display:flex;align-items:center;justify-content:center;padding:16px;",E.innerHTML='<div class="dms-wizard mrerp-wizard" role="dialog" aria-modal="true" style="background:var(--card,#fff);border-radius:14px;max-width:440px;width:100%;padding:24px;box-shadow:0 12px 40px rgba(0,0,0,.18);max-height:90vh;overflow:auto;"><div style="font-size:17px;font-weight:700;margin-bottom:4px;">'+o(t("dms-wizard-title"))+'</div><div style="font-size:13px;color:var(--muted,#6b6b66);margin-bottom:18px;">'+o(t("dms-card-desc"))+"</div>"+v("dms-wizard-username","dms-w-user","text","","")+v("dms-wizard-password","dms-w-pass","password","","")+v("dms-wizard-prefix","dms-w-prefix","text",y,"PN")+'<div id="dms-w-err" style="display:none;color:#b3261e;font-size:13px;margin:4px 0 12px;"></div><div style="display:flex;gap:10px;justify-content:flex-end;margin-top:8px;"><button type="button" class="btn btn-ghost" id="dms-w-cancel">'+o(t("dms-wizard-cancel"))+'</button><button type="button" class="btn btn-primary" id="dms-w-save">'+o(t("dms-wizard-save"))+"</button></div></div>",document.body.appendChild(E),document.addEventListener("keydown",p),E.addEventListener("click",function(T){T.target===E&&l()});var B=document.getElementById("dms-w-user");B&&B.focus()}function d(w){var y=document.getElementById("dms-w-err");y&&(y.textContent=w,y.style.display=w?"":"none")}async function u(){var w=n&&n.config&&n.config.system_url||e,y=(document.getElementById("dms-w-user")||{}).value||"",v=(document.getElementById("dms-w-pass")||{}).value||"",E=(document.getElementById("dms-w-prefix")||{}).value||"PN";if(w=w.trim(),y=y.trim(),!w||!y||!v){d(t("dms-wizard-required"));return}var B=document.getElementById("dms-w-save");B&&(B.disabled=!0,B.textContent=t("dms-wizard-saving")),d("");var T=i();try{var S=await fetch("/api/erp/test-connection",{method:"POST",headers:{Authorization:"Bearer "+T,"Content-Type":"application/json"},body:JSON.stringify({adapter:"mrerp_dms",config:{system_url:w,username:y,password:v}})}),b=await S.json().catch(function(){return{}});if(!S.ok||!b.ok){var g=b.error_friendly&&(b.error_friendly[window.currentLang]||b.error_friendly.en)||t("dms-connect-fail-generic");d(g),B&&(B.disabled=!1,B.textContent=t("dms-wizard-save"));return}var x={system_url:w,username_enc:y,password_enc:v,id_card_auto_push:!0,booking_defaults:{booking_prefix:E.trim()||"PN"}},I,L;n&&n.id?(I="PATCH",L="/api/erp/endpoints/"+encodeURIComponent(n.id)):(I="POST",L="/api/erp/endpoints");var C=I==="POST"?{name:"MR.ERP DMS",adapter:"mrerp_dms",config:x,is_default:!1,auto_push:!1}:{config:x,auto_push:!1},k=await fetch(L,{method:I,headers:{Authorization:"Bearer "+T,"Content-Type":"application/json"},body:JSON.stringify(C)});if(!k.ok){var M=await k.json().catch(function(){return{}}),$=M&&M.detail&&(M.detail.code||M.detail)||"save_failed";d(t("dms-save-fail")+" ("+o(String($))+")"),B&&(B.disabled=!1,B.textContent=t("dms-wizard-save"));return}l(),s(t("dms-connect-ok"),"success"),await r(!0),c(),typeof window._refreshOcrDocMode=="function"&&window._refreshOcrDocMode()}catch{d(t("dms-connect-fail-generic")),B&&(B.disabled=!1,B.textContent=t("dms-wizard-save"))}}async function f(){if(!(!n||!n.id)){s(t("dms-test-running"),"info");var w=i();try{var y=await fetch("/api/erp/endpoints/"+encodeURIComponent(n.id)+"/test-connection?refresh=1",{method:"POST",headers:{Authorization:"Bearer "+w}}),v=await y.json().catch(function(){return{}});s(v&&v.ok?t("dms-test-ok"):t("dms-test-fail"),v&&v.ok?"success":"error")}catch{s(t("dms-test-fail"),"error")}}}async function h(){if(!(!n||!n.id)){var w=n.enabled===!1;if(!w)try{var y=await window.pearnlyConfirm(t("dms-confirm-disable"));if(!y)return}catch{}var v=i();try{var E=await fetch("/api/erp/endpoints/"+encodeURIComponent(n.id),{method:"PATCH",headers:{Authorization:"Bearer "+v,"Content-Type":"application/json"},body:JSON.stringify({enabled:w})});if(!E.ok)throw new Error("http_"+E.status);s(w?t("dms-enabled-toast"):t("dms-disabled-toast"),"success"),await r(!0),c(),typeof window._refreshOcrDocMode=="function"&&window._refreshOcrDocMode()}catch{s(t("dms-save-fail"),"error")}}}function _(){r().then(c)}document.addEventListener("click",function(w){if(w.target.closest('.erp-subtab[data-erp-subtab="connect"]')){setTimeout(_,60);return}if(w.target.closest('.auto-nav-item[data-auto-tab="erp"]')){setTimeout(_,90);return}if(w.target.closest("#btn-dms-connect")||w.target.closest("#btn-dms-edit")){w.preventDefault(),m();return}if(w.target.closest("#dms-w-cancel")){w.preventDefault(),l();return}if(w.target.closest("#dms-w-save")){w.preventDefault(),u();return}if(w.target.closest("#btn-dms-test")){w.preventDefault(),f();return}if(w.target.closest("#btn-dms-toggle")){w.preventDefault(),h();return}}),typeof window.subscribeI18n=="function"&&window.subscribeI18n("mrerp-dms-adapter",c),setTimeout(function(){var w=document.querySelector('.auto-nav-item.active[data-auto-tab="erp"]'),y=document.querySelector('.erp-subtab.active[data-erp-subtab="connect"]');w&&y&&_()},250)})();(function(){const e={};function n(){if(document.getElementById("report-modal"))return;const p=`
        ...
        </div>`,m=document.createElement("div");m.innerHTML=p,document.body.appendChild(m.firstElementChild),document.getElementById("report-modal-close-x").addEventListener("click",a),document.getElementById("report-modal-cancel").addEventListener("click",a),document.getElementById("report-modal").addEventListener("click",d=>{d.target.id==="report-modal"&&a()})}function a(){const p=document.getElementById("report-modal");p&&(p.style.display="none"),o=null}let o=null;async function s(p,m){const d=p+":"+(m||"");if(e[d])return e[d];let u;try{const f=localStorage.getItem("mrpilot_token"),h=await fetch(`/api/reports/templates?lang=${encodeURIComponent(p)}`,{headers:{Authorization:"Bearer "+f}});if(!h.ok)throw new Error("templates fetch failed");u=(await h.json()).templates||[]}catch(f){console.error("fetchTemplates fail",f),u=[{code:"input_vat",name:t("tpl-input-vat"),desc:t("tpl-input-vat-desc"),recommended:!0},{code:"standard",name:t("tpl-standard"),desc:t("tpl-standard-desc"),recommended:!1},{code:"print",name:t("tpl-print"),desc:t("tpl-print-desc"),recommended:!1}]}if(u=u.filter(f=>f.code!=="erp"),m==="history-batch"){const f=u.findIndex(_=>_.code==="standard"),h=f>=0?f+1:u.length;u.splice(h,0,{code:"sales_detail_th",name:t("export-tpl-sales-detail"),desc:t("export-tpl-sales-detail-desc"),recommended:!1,is_new:!0})}return e[d]=u,u}function i(p){const m=document.getElementById("report-tpl-list"),d=p.map((f,h)=>`
            <label class="report-tpl-item${f.recommended?" is-recommended":""}">
                <input type="radio" name="report-tpl" value="${f.code}" ${f.recommended||h===0?"checked":""}>
        ...
        `;m.innerHTML=d+u}function r(p){return p==null?"":String(p).replace(/[&<>"']/g,m=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[m])}function c(p){const m=new Date,d=m.getFullYear(),u=m.getMonth()+1;if(p==="all")return"all";if(p==="this-month")return`${d}-${String(u).padStart(2,"0")}`;if(p==="last-month"){const f=new Date(d,u-2,1);return`${f.getFullYear()}-${String(f.getMonth()+1).padStart(2,"0")}`}return p==="this-year"?`${d}`:p==="this-quarter"?`${d}-Q${Math.floor((u-1)/3)+1}`:"all"}window.openReportModal=async function(p){p=p||{},n(),typeof applyLang=="function"?applyLang(currentLang):document.querySelectorAll("#report-modal [data-i18n]").forEach(_=>{const w=_.getAttribute("data-i18n");I18N[currentLang]&&I18N[currentLang][w]&&(_.textContent=I18N[currentLang][w])});const m=document.getElementById("report-period-section");m&&(m.style.display=p.mode==="client"?"":"none");const d=document.getElementById("report-tpl-list");d.innerHTML=`<div class="report-tpl-loading">${r(t("report-modal-loading"))}</div>`,document.getElementById("report-modal").style.display="";const u=await s(currentLang,p&&p.mode);i(u),o=p;const f=document.getElementById("report-modal-download"),h=f.cloneNode(!0);f.parentNode.replaceChild(h,f),h.addEventListener("click",()=>l(o))};async function l(p){if(!p)return;const m=document.querySelector('input[name="report-tpl"]:checked');if(!m){showToast(t("report-toast-no-selection"),"info");return}const d=m.value,u=document.querySelector('input[name="report-period"]:checked'),f=u?u.value:"all",h=c(f),_=document.getElementById("report-modal-download"),w=_.innerHTML;_.disabled=!0,_.innerHTML=`<span>${r(t("report-modal-loading"))}</span>`;try{const y=localStorage.getItem("mrpilot_token");let v,E;if(p.mode==="records")v=await fetch("/api/reports/export",{method:"POST",headers:{Authorization:"Bearer "+y,"Content-Type":"application/json"},body:JSON.stringify({template:d,lang:currentLang,records:p.records||[],meta:p.meta||{}})}),E=`mrpilot-${d}-${Date.now()}.xlsx`;else if(p.mode==="client"){const I=`/api/reports/clients/${p.clientId}/export?template=${encodeURIComponent(d)}&lang=${encodeURIComponent(currentLang)}&month=${encodeURIComponent(h)}`;v=await fetch(I,{headers:{Authorization:"Bearer "+y}}),E=`${(p.clientName||"client").replace(/[^a-zA-Z0-9\u0e00-\u0e7f\u4e00-\u9fff]/g,"_").slice(0,40)}-${d}.xlsx`}else if(p.mode==="history-batch")d==="sales_detail_th"?(v=await fetch("/api/ocr/export-by-history-ids",{method:"POST",headers:{Authorization:"Bearer "+y,"Content-Type":"application/json"},body:JSON.stringify({template:"sales_detail_th",lang:currentLang,history_ids:p.historyIds||[],client_id:p.clientId||null})}),E=`Pearnly_SalesDetail_${Date.now()}.xlsx`):(v=await fetch("/api/reports/history/batch_export",{method:"POST",headers:{Authorization:"Bearer "+y,"Content-Type":"application/json"},body:JSON.stringify({template:d,lang:currentLang,history_ids:p.historyIds||[],client_id:p.clientId||null})}),E=`mrpilot-batch-${d}-${Date.now()}.xlsx`);else throw new Error("unknown mode: "+p.mode);if(!v.ok){let I="HTTP "+v.status;try{const L=await v.json();L&&L.detail&&(I=L.detail)}catch(L){console.warn("[batch-export] resp.json err.detail parse failed:",L)}v.status===404?showToast(t("report-toast-empty"),"info"):showToast(t("report-toast-fail")+" · "+I,"error");return}const B=await v.blob();let T=E;const b=(v.headers.get("Content-Disposition")||"").match(/filename\*=UTF-8''([^;]+)/i);if(b)try{T=decodeURIComponent(b[1])}catch{}const g=URL.createObjectURL(B),x=document.createElement("a");x.href=g,x.download=T,document.body.appendChild(x),x.click(),document.body.removeChild(x),URL.revokeObjectURL(g),showToast(t("report-toast-success"),"success"),a()}catch(y){console.error("doDownload fail",y),showToast(t("report-toast-fail")+" · "+(y.message||""),"error")}finally{_.disabled=!1,_.innerHTML=w}}document.addEventListener("DOMContentLoaded",()=>{const p=document.getElementById("btn-export");if(p){const d=p.cloneNode(!0);p.parentNode.replaceChild(d,p),d.addEventListener("click",()=>{if(typeof _results>"u"||!_results||_results.length===0){showToast(t("report-toast-no-selection"),"info");return}openReportModal({mode:"records",records:_results.map(u=>({filename:u.filename,merged_fields:u.merged_fields||{}}))})})}const m=document.getElementById("history-batch-export");m&&m.addEventListener("click",()=>{if(typeof _historySelected>"u"||_historySelected.size===0){showToast(t("report-toast-no-selection"),"info");return}openReportModal({mode:"history-batch",historyIds:Array.from(_historySelected)})})}),window.openClientExportModal=function(p,m){openReportModal({mode:"client",clientId:p,clientName:m||""})}})();(function(){const n=typeof window<"u"&&"showDirectoryPicker"in window,a=/\.(pdf|jpe?g|png|webp)$/i,o="mrpilot_folder_watcher",s=1;let i=null,r=null,c=null,l=60,p=!1,m=!1,d=0,u=0,f=0,h=[],_=null,w=!1;function y(){return i||(i=new Promise((j,R)=>{const q=indexedDB.open(o,s);q.onupgradeneeded=K=>{const V=K.target.result;V.objectStoreNames.contains("handles")||V.createObjectStore("handles"),V.objectStoreNames.contains("seen")||V.createObjectStore("seen"),V.objectStoreNames.contains("config")||V.createObjectStore("config")},q.onsuccess=K=>j(K.target.result),q.onerror=K=>R(K.target.error)}),i)}function v(j,R){return y().then(q=>new Promise((K,V)=>{const ce=q.transaction(j,"readonly").objectStore(j).get(R);ce.onsuccess=()=>K(ce.result),ce.onerror=()=>V(ce.error)}))}function E(j,R,q){return y().then(K=>new Promise((V,ae)=>{const ce=K.transaction(j,"readwrite");ce.objectStore(j).put(q,R),ce.oncomplete=()=>V(),ce.onerror=()=>ae(ce.error)}))}function B(j,R){return y().then(q=>new Promise((K,V)=>{const ae=q.transaction(j,"readwrite");ae.objectStore(j).delete(R),ae.oncomplete=()=>K(),ae.onerror=()=>V(ae.error)}))}function T(j){return y().then(R=>new Promise((q,K)=>{const V=R.transaction(j,"readwrite");V.objectStore(j).clear(),V.oncomplete=()=>q(),V.onerror=()=>K(V.error)}))}async function S(j){if(!j)return!1;try{const R={mode:"read"};let q=await j.queryPermission(R);return q==="granted"?!0:(q=await j.requestPermission(R),q==="granted")}catch(R){return console.warn("[folder] permission check failed:",R),!1}}function b(j,R){const q=document.getElementById("folder-status-summary");q&&(q.setAttribute("data-i18n",j),q.textContent=t(j),q.className="auto-status-pill"+(R?" "+R:""))}function g(j){["folder-unsupported","folder-empty","folder-active"].forEach(R=>{const q=document.getElementById(R);q&&(q.style.display=R===j?"":"none")})}function x(j){if(!j)return"-";const R=j instanceof Date?j:new Date(j),q=String(R.getHours()).padStart(2,"0"),K=String(R.getMinutes()).padStart(2,"0"),V=String(R.getSeconds()).padStart(2,"0");return`${q}:${K}:${V}`}function I(){g("folder-active");const j=document.getElementById("folder-config-path");j&&r&&(j.textContent=r.name||"-");const R=document.getElementById("folder-interval-select");R&&(R.value=String(l)),document.getElementById("folder-stat-last").textContent=_?x(_):"-",document.getElementById("folder-stat-processed").textContent=String(d),document.getElementById("folder-stat-failed").textContent=String(u),document.getElementById("folder-stat-queue").textContent=String(f);const q=document.getElementById("btn-folder-pause"),K=document.getElementById("btn-folder-resume");q&&(q.style.display=p?"none":""),K&&(K.style.display=p?"":"none"),p?b("folder-status-paused","paused"):b("folder-status-running","running");const V=document.getElementById("folder-status-text");V&&(V.setAttribute("data-i18n",p?"folder-status-paused":"folder-status-running"),V.textContent=t(p?"folder-status-paused":"folder-status-running"));const ae=document.getElementById("folder-status-pulse");ae&&(ae.className="folder-status-pulse"+(p?" paused":"")),L()}function L(){const j=document.getElementById("folder-recent-list");if(j){if(h.length===0){j.innerHTML=`<div class="folder-recent-empty">${escapeHtml(t("folder-recent-empty"))}</div>`;return}j.innerHTML=h.slice(0,20).map(R=>{let q;R.status==="ok"?q=`<span class="folder-recent-icon ok">${svgIcon("check",12)}</span>`:R.status==="dup"?q=`<span class="folder-recent-icon dup" title="${escapeHtml(t("folder-recent-dup"))}">${svgIcon("copy",12)}</span>`:R.status==="skip"?q=`<span class="folder-recent-icon skip" title="${escapeHtml(t("folder-recent-skip"))}">${svgIcon("minus",12)}</span>`:q=`<span class="folder-recent-icon fail">${svgIcon("alert",12)}</span>`;const K=R.status==="fail"&&R.error?R.error:R.status==="dup"&&R.reason||R.status==="skip"&&R.reason?R.reason:"",V=K?`<div class="folder-recent-err">${escapeHtml(K)}</div>`:"";return`
                <div class="folder-recent-item">
                    ...
                    <div class="folder-recent-time">${x(R.time)}</div>
                </div>
            `}).join("")}}function C(j){h.unshift(j),h.length>50&&(h.length=50),E("config","recent_list",h).catch(()=>{})}async function k(j){const R=new FormData;R.append("file",j,j.name),R.append("source","folder");const q=await fetch("/api/ocr/recognize?source=folder",{method:"POST",headers:{Authorization:"Bearer "+token,"X-Source":"folder"},body:R});if(!q.ok){let K="http_"+q.status;try{const V=await q.json();K=V&&V.detail?typeof V.detail=="string"?V.detail:V.detail.code||JSON.stringify(V.detail):K}catch{}throw new Error(K)}return await q.json()}async function M(j){try{const q=(await j.getFile()).size;return await new Promise(V=>setTimeout(V,3e3)),(await j.getFile()).size===q&&q>0}catch{return!1}}async function $(j,R,q,K){if(K>10)return;let V;try{V=await j.queryPermission({mode:"read"})}catch{V="denied"}if(V==="granted")for await(const ae of j.values()){const ce=R?`${R}/${ae.name}`:ae.name;if(ae.kind==="file"){if(!a.test(ae.name))continue;let be;try{be=await ae.getFile()}catch{continue}const Se=`${ce}::${be.size}::${be.lastModified}`;if(await v("seen",Se))continue;q.push({entry:ae,file:be,seenKey:Se,relPath:ce})}else if(ae.kind==="directory")try{await $(ae,ce,q,K+1)}catch{}}}async function A(){if(!(m||p||!r)){m=!0;try{if(await r.queryPermission({mode:"read"})!=="granted"){console.warn("[folder] permission lost · stop"),ue(),showToast("warn",t("folder-permission-lost"));return}_=new Date;const R=[];await $(r,"",R,0),f=R.length,I();for(const q of R){if(p)break;if(!await M(q.entry)){f=Math.max(0,f-1),I();continue}try{let V;try{V=await q.entry.getFile()}catch{V=q.file}const ae=await k(V);await E("seen",q.seenKey,{name:V.name,relPath:q.relPath,size:V.size,lastModified:V.lastModified,processed_at:Date.now()});const ce=ae.history_ids||(ae.history_id?[ae.history_id]:[]),be=ae.duplicate_warnings||[],Se=q.relPath||V.name;ce.length>0?(d+=ce.length,C({name:Se,status:"ok",time:new Date,history_id:ce[0],count:ce.length}),await E("config","processed_count",d)):be.length>0?C({name:Se,status:"dup",time:new Date,reason:t("folder-recent-dup-reason")}):C({name:Se,status:"skip",time:new Date,reason:t("folder-recent-skip-reason")})}catch(V){u++,C({name:q.relPath||q.file.name,status:"fail",time:new Date,error:String(V.message||V)}),await E("config","failed_count",u)}f=Math.max(0,f-1),I()}}catch(j){console.warn("[folder] scan error:",j)}finally{m=!1,I()}}}function H(){c&&clearInterval(c),c=setInterval(A,l*1e3)}function P(){c&&(clearInterval(c),c=null)}function F(j){if(!r||p)return;const R=typeof t=="function"?t("folder-unload-warn"):"Folder watcher running · close anyway?";return j.preventDefault(),j.returnValue=R,R}function G(){window._pearnlyFolderUnloadAttached||(window._pearnlyFolderUnloadAttached=!0,window.addEventListener("beforeunload",F))}function O(){window._pearnlyFolderUnloadAttached&&(window._pearnlyFolderUnloadAttached=!1,window.removeEventListener("beforeunload",F))}function ee(){p=!1,H(),G(),I(),A()}function de(){p=!0,P(),O(),I()}function me(){p=!1,H(),G(),I(),A()}function ue(){p=!0,P(),O()}async function re(){try{const j=await window.showDirectoryPicker({mode:"read",startIn:"documents"});if(!await S(j)){showToast("warn",t("folder-permission-denied"));return}r=j,await E("handles","main",j),d=0,u=0,f=0,h=[],await E("config","processed_count",0),await E("config","failed_count",0),await T("seen"),ee()}catch(j){j&&j.name!=="AbortError"&&console.warn("[folder] pick failed:",j)}}async function ve(){await showConfirm(t("folder-confirm-remove"),{danger:!0})&&(ue(),r=null,d=0,u=0,f=0,h=[],await B("handles","main"),await B("config","processed_count"),await B("config","failed_count"),await T("seen"),g("folder-empty"),b("folder-status-empty",""))}async function he(){h=[];try{await B("config","recent_list")}catch{}L()}async function D(){if(w)return;if(w=!0,!n){g("folder-unsupported"),b("folder-status-unsupported",""),Q();return}z();let j=null;try{j=await v("handles","main")}catch{}if(!j){g("folder-empty"),b("folder-status-empty","");return}if(!await S(j)){g("folder-empty"),b("folder-status-empty",""),await B("handles","main"),showToast("warn",t("folder-permission-lost-restart"));return}r=j;try{d=await v("config","processed_count")||0}catch{}try{u=await v("config","failed_count")||0}catch{}try{const q=await v("config","recent_list");Array.isArray(q)&&(h=q.map(K=>({...K,time:K.time?new Date(K.time):new Date})))}catch{}ee()}function z(){const j=document.getElementById("btn-folder-pick"),R=document.getElementById("btn-folder-pause"),q=document.getElementById("btn-folder-resume"),K=document.getElementById("btn-folder-scan-now"),V=document.getElementById("btn-folder-remove"),ae=document.getElementById("btn-folder-clear-recent"),ce=document.getElementById("folder-interval-select");j&&j.addEventListener("click",re),R&&R.addEventListener("click",de),q&&q.addEventListener("click",me),K&&K.addEventListener("click",()=>{A()}),V&&V.addEventListener("click",ve),ae&&ae.addEventListener("click",he),ce&&ce.addEventListener("change",be=>{l=parseInt(be.target.value,10)||60,p||H()}),X()}function X(){document.querySelectorAll('[data-auto-panel="folder"] [data-tab-jump]').forEach(j=>{j.dataset.tabJumpBound||(j.dataset.tabJumpBound="1",j.addEventListener("click",R=>{const q=R.currentTarget.dataset.tabJump;if(q==="email")typeof switchAutomationTab=="function"&&switchAutomationTab("email");else if(q==="upload"){const K=document.querySelector('[data-page="recognize"]')||document.querySelector('[data-page="upload"]');K&&K.click()}}))})}function Q(){X()}window._loadFolderWatcherPanel=D;function Z(){try{if(navigator.userAgentData&&Array.isArray(navigator.userAgentData.brands))return navigator.userAgentData.brands.some(R=>/chromium|google chrome|microsoft edge/i.test(R.brand||""))}catch{}const j=navigator.userAgent||"";return!!(/Edg\//.test(j)||/Chrome\//.test(j)&&!/OPR\/|YaBrowser|Opera/.test(j))}function oe(){try{if(Z()||localStorage.getItem("pearnly_chrome_banner_dismissed")==="1")return;const j=document.getElementById("chrome-only-banner");if(!j)return;const R=j.querySelector('[data-i18n="chrome-banner-msg"]'),q=j.querySelector('[data-i18n="chrome-banner-dismiss"]');R&&typeof t=="function"&&(R.textContent=t("chrome-banner-msg")),q&&typeof t=="function"&&(q.textContent=t("chrome-banner-dismiss")),j.style.display="";const K=document.getElementById("chrome-only-banner-close");K&&!K.dataset.bound&&(K.dataset.bound="1",K.addEventListener("click",()=>{j.style.display="none";try{localStorage.setItem("pearnly_chrome_banner_dismissed","1")}catch{}}))}catch{}}typeof document<"u"&&(document.readyState==="loading"?document.addEventListener("DOMContentLoaded",oe):setTimeout(oe,0)),window._refreshChromeBanner=oe})();const Ts=`
        <div class="modal">
            <div class="modal-head">
    ...
    `;we("email-modal",Ts);(function(){let e=null,n=null,a="new",o=!1,s=!1;async function i(){const k=document.getElementById("email-empty"),M=document.getElementById("email-account-card");if(document.getElementById("email-logs-section"),!(!k||!M))try{const $=await fetch("/api/email-ingest/account",{headers:{Authorization:"Bearer "+token}});if($.status===401){localStorage.removeItem("mrpilot_token");const H=await $.json().catch(()=>({}));if((typeof H.detail=="string"?H.detail:H.detail&&H.detail.code||"")==="auth.session_revoked"){_showSessionRevokedModal();return}window.location.href="/";return}if(!$.ok){c("none");return}const A=await $.json();e=A.account||null,n=A.presets||{},o=!0,r(),e&&x()}catch($){console.error("[email-ingest] load failed",$),c("none")}}function r(){const k=document.getElementById("email-empty"),M=document.getElementById("email-account-card"),$=document.getElementById("email-logs-section");if(!e){k.style.display="",M.style.display="none",$&&($.style.display="none"),c("none");return}k.style.display="none",M.style.display="",$&&($.style.display="");const A=document.getElementById("email-account-addr"),H=document.getElementById("email-account-host"),P=document.getElementById("email-account-last"),F=document.getElementById("email-last-error"),G=document.getElementById("email-enabled-toggle");if(A&&(A.textContent=e.email_address||"-"),H&&(H.textContent=`${e.imap_host||"-"}:${e.imap_port||993}`),P){const O=e.last_fetched_at;if(!O)P.textContent=t("email-last-never");else{const ee=l(O),de=!e.last_error;P.textContent=de?t("email-last-ok",{time:ee}):t("email-last-fail",{time:ee})}}F&&(e.last_error?(F.style.display="",F.textContent=p(e.last_error)):F.style.display="none"),G&&(G.checked=!!e.enabled),e.enabled?e.last_error?c("error"):c("on"):c("off")}function c(k){const M=document.getElementById("email-status-summary");if(!M)return;M.classList.remove("none","ready","active","coming");let $="auto-status-loading";k==="none"?($="email-status-none",M.classList.add("none")):k==="on"?($="email-status-on",M.classList.add("active")):k==="off"?($="email-status-off",M.classList.add("coming")):k==="error"&&($="email-status-error",M.classList.add("none")),M.setAttribute("data-i18n",$),M.textContent=t($)}function l(k){if(!k)return"";const M=new Date(k);if(isNaN(M.getTime()))return"";const $=A=>String(A).padStart(2,"0");return`${$(M.getMonth()+1)}-${$(M.getDate())} ${$(M.getHours())}:${$(M.getMinutes())}`}function p(k){if(!k)return"";const M=String(k);return/auth|AUTHENTICATIONFAILED|invalid credentials/i.test(M)?t("email-test-auth-fail"):/timeout|timed out/i.test(M)?t("email.timeout"):(/ENOTFOUND|getaddrinfo/i.test(M),M)}function m(k){a=k;const M=document.getElementById("email-modal");if(!M)return;const $=document.getElementById("email-preset");$.innerHTML="";const A=n||{},H=["gmail","outlook","yahoo","icloud","qq","163","custom"],P={gmail:"Gmail",outlook:"Outlook / Office365",yahoo:"Yahoo Mail",icloud:"iCloud",qq:"QQ 邮箱",163:"网易 163"};H.forEach(z=>{if(!A[z])return;const X=document.createElement("option");X.value=z,X.textContent=z==="custom"?t("email-preset-custom"):P[z]||z,$.appendChild(X)});const F=document.getElementById("email-modal-title"),G=document.getElementById("email-address"),O=document.getElementById("email-password"),ee=document.getElementById("email-imap-host"),de=document.getElementById("email-imap-port"),me=document.getElementById("email-imap-ssl"),ue=document.getElementById("email-folder"),re=document.getElementById("email-mark-read"),ve=document.getElementById("email-bind-enabled"),he=document.getElementById("email-test-result"),D=document.getElementById("email-adv-details");if(he&&(he.style.display="none",he.textContent=""),k==="edit"&&e){F.setAttribute("data-i18n","email-modal-title-edit"),F.textContent=t("email-modal-title-edit"),G.value=e.email_address||"",O.value="",O.setAttribute("data-i18n-placeholder","email-field-password-edit-ph"),O.placeholder=t("email-field-password-edit-ph"),ee.value=e.imap_host||"",de.value=e.imap_port||993,me.checked=e.imap_use_ssl!==!1,ue.value=e.folder||"INBOX",re.checked=e.mark_as_read!==!1,ve.checked=e.enabled!==!1;const z=document.getElementById("email-filter-sender"),X=document.getElementById("email-filter-subject");z&&(z.value=e.filter_sender||""),X&&(X.value=e.filter_subject||""),v(e.interval_min||15),$.value=_(e.imap_host)||"custom",D&&(D.open=!0)}else{F.setAttribute("data-i18n","email-modal-title-new"),F.textContent=t("email-modal-title-new"),G.value="",O.value="",O.setAttribute("data-i18n-placeholder","email-field-password-ph"),O.placeholder=t("email-field-password-ph"),$.value="gmail",u("gmail"),ue.value="INBOX",re.checked=!0,ve.checked=!0;const z=document.getElementById("email-filter-sender"),X=document.getElementById("email-filter-subject");z&&(z.value=""),X&&(X.value=""),v(15),D&&(D.open=!1)}y(),M.style.display="flex",setTimeout(()=>G.focus(),60)}function d(){const k=document.getElementById("email-modal");k&&(k.style.display="none")}function u(k){const M=(n||{})[k];if(!M||k==="custom")return;const $=document.getElementById("email-imap-host"),A=document.getElementById("email-imap-port"),H=document.getElementById("email-imap-ssl");$&&($.value=M.host||""),A&&(A.value=M.port||993),H&&(H.checked=M.ssl!==!1)}const f={"gmail.com":"gmail","googlemail.com":"gmail","outlook.com":"outlook","hotmail.com":"outlook","live.com":"outlook","office365.com":"outlook","msn.com":"outlook","yahoo.com":"yahoo","yahoo.co.jp":"yahoo","icloud.com":"icloud","me.com":"icloud","mac.com":"icloud","qq.com":"qq","foxmail.com":"qq","163.com":"163","126.com":"163","yeah.net":"163"};function h(k){if(!k||!k.includes("@"))return;const M=k.split("@")[1].toLowerCase().trim(),$=f[M];if(!$)return;const A=document.getElementById("email-preset");if(!A)return;const H=A.value;H&&H!=="custom"&&H!==""&&H===$||(A.value=$,u($))}function _(k){if(!k)return null;const M=n||{};for(const $ in M)if($!=="custom"&&M[$]&&M[$].host===k)return $;return null}function w(){const k=document.querySelector("#email-interval-options .email-interval-btn.active"),M=k?parseInt(k.dataset.interval,10):15;return{email_address:(document.getElementById("email-address").value||"").trim(),password:document.getElementById("email-password").value||"",imap_host:(document.getElementById("email-imap-host").value||"").trim(),imap_port:parseInt(document.getElementById("email-imap-port").value||"993",10)||993,imap_use_ssl:document.getElementById("email-imap-ssl").checked,folder:(document.getElementById("email-folder").value||"INBOX").trim()||"INBOX",mark_as_read:document.getElementById("email-mark-read").checked,enabled:document.getElementById("email-bind-enabled").checked,interval_min:[5,15,60].includes(M)?M:15,filter_sender:(document.getElementById("email-filter-sender").value||"").trim()||null,filter_subject:(document.getElementById("email-filter-subject").value||"").trim()||null}}function y(){const k=document.getElementById("email-interval-options");!k||k._bound||(k._bound=!0,k.addEventListener("click",M=>{const $=M.target.closest(".email-interval-btn");$&&(k.querySelectorAll(".email-interval-btn").forEach(A=>A.classList.remove("active")),$.classList.add("active"))}))}function v(k){const M=[5,15,60].includes(k)?k:15,$=document.getElementById("email-interval-options");$&&$.querySelectorAll(".email-interval-btn").forEach(A=>{A.classList.toggle("active",parseInt(A.dataset.interval,10)===M)})}function E(k,M){const $=document.getElementById("email-test-result");$&&($.style.display="",$.textContent=M,$.className="form-test-result "+(k==="ok"?"ok":k==="running"?"running":"fail"))}async function B(){const k=w();if(!k.email_address){E("fail",t("email-addr-required"));return}if(!k.password){E("fail",t("email-password-required"));return}if(!k.imap_host){E("fail",t("email-host-required"));return}const M=document.getElementById("btn-email-modal-test");M&&(M.disabled=!0),E("running",t("email-test-running"));try{const $=await fetch("/api/email-ingest/test",{method:"POST",headers:{Authorization:"Bearer "+token,"Content-Type":"application/json"},body:JSON.stringify({email_address:k.email_address,password:k.password,imap_host:k.imap_host,imap_port:k.imap_port,imap_use_ssl:k.imap_use_ssl,folder:k.folder})}),A=await $.json().catch(()=>({}));if($.ok&&A.success)E("ok",t("email-test-ok",{folder:k.folder,n:A.folder_count??"?"}));else{const H=A.error_msg||"";H==="auth_failed"||/auth/i.test(H)?E("fail",t("email-test-auth-fail")):E("fail",t("email-test-fail",{msg:H||$.status}))}}catch($){E("fail",t("email-test-fail",{msg:String($).slice(0,120)}))}finally{M&&(M.disabled=!1)}}async function T(){const k=w();if(!k.email_address){E("fail",t("email-addr-required"));return}if(a==="new"&&!k.password){E("fail",t("email-password-required"));return}if(!k.imap_host){E("fail",t("email-host-required"));return}const M=document.getElementById("btn-email-modal-save");M&&(M.disabled=!0);const $={...k};a==="edit"&&!$.password&&delete $.password;try{const A=await fetch("/api/email-ingest/account",{method:"PUT",headers:{Authorization:"Bearer "+token,"Content-Type":"application/json"},body:JSON.stringify($)}),H=await A.json().catch(()=>({}));if(A.ok&&H.ok)e=H.account,showToast(t("email-save-ok"),"success"),d(),r(),x();else{const F="email."+(H.detail||"").split(".").slice(-1)[0];E("fail",t(F)!==F?t(F):t("email-save-fail"))}}catch{E("fail",t("email-save-fail"))}finally{M&&(M.disabled=!1)}}async function S(){if(!(!e||!await showConfirm(t("email-unbind-confirm",{email:e.email_address}),{danger:!0,okText:t("email-btn-unbind")})))try{if((await fetch("/api/email-ingest/account",{method:"DELETE",headers:{Authorization:"Bearer "+token}})).ok){e=null,showToast(t("email-unbind-ok"),"success"),r();const $=document.getElementById("email-logs-list");$&&($.innerHTML="")}else showToast(t("email-unbind-fail"),"error")}catch{showToast(t("email-unbind-fail"),"error")}}async function b(){if(!e||s)return;if(!e.enabled){showToast(t("email.disabled"),"error");return}s=!0;const k=document.getElementById("btn-email-trigger"),M=k?k.innerHTML:"";k&&(k.disabled=!0,k.innerHTML=`<span>${escapeHtml(t("email-trigger-running"))}</span>`);try{const $=await fetch("/api/email-ingest/trigger",{method:"POST",headers:{Authorization:"Bearer "+token}}),A=await $.json().catch(()=>({}));if($.ok){const H=A.emails_scanned||0,P=A.ocr_succeeded||0,F=A.ocr_failed||0;H===0&&P===0&&F===0?showToast(t("email-trigger-empty"),"success"):showToast(t("email-trigger-result",{scanned:H,ok:P,fail:F}),F>0?"warn":"success")}else{const P="email."+(A.detail||"").split(".").slice(-1)[0];showToast(t(P)!==P?t(P):t("email-trigger-fail"),"error")}await i()}catch{showToast(t("email-trigger-fail"),"error")}finally{s=!1,k&&(k.disabled=!1,k.innerHTML=M)}}async function g(){if(!e)return;const k=document.getElementById("email-enabled-toggle"),M=!!(k&&k.checked),$=e.enabled;try{const A=await fetch("/api/email-ingest/account",{method:"PUT",headers:{Authorization:"Bearer "+token,"Content-Type":"application/json"},body:JSON.stringify({email_address:e.email_address,imap_host:e.imap_host,imap_port:e.imap_port,imap_use_ssl:e.imap_use_ssl,folder:e.folder||"INBOX",filter_subject:e.filter_subject||null,filter_sender:e.filter_sender||null,mark_as_read:e.mark_as_read!==!1,enabled:M})}),H=await A.json().catch(()=>({}));A.ok&&H.ok?(e=H.account,r()):(k&&(k.checked=$),showToast(t("email-toggle-fail"),"error"))}catch{k&&(k.checked=$),showToast(t("email-toggle-fail"),"error")}}async function x(){const k=document.getElementById("email-logs-list");if(k){k.innerHTML=`<div class="erp-logs-empty">${escapeHtml(t("erp-logs-loading"))}</div>`;try{const M=await fetch("/api/email-ingest/logs?limit=20",{headers:{Authorization:"Bearer "+token}});if(!M.ok){k.innerHTML=`<div class="erp-logs-empty">${escapeHtml(t("erp-logs-error"))}</div>`;return}const $=await M.json();if(!Array.isArray($)||$.length===0){k.innerHTML=`<div class="erp-logs-empty">${escapeHtml(t("email-logs-empty"))}</div>`;return}k.innerHTML=$.map(I).join("")}catch{k.innerHTML=`<div class="erp-logs-empty">${escapeHtml(t("erp-logs-error"))}</div>`}}}function I(k){const M=l(k.created_at),$=k.status||"failed",A=$==="success"?"ok":$==="partial"?"partial":"fail",H=$==="success"?"✓":$==="partial"?"◐":"✗",P=k.trigger==="manual"?`<span class="log-tag manual">${escapeHtml(t("email-log-tag-manual"))}</span>`:`<span class="log-tag auto">${escapeHtml(t("email-log-tag-auto"))}</span>`,F=t("email-log-counts",{scanned:k.emails_scanned||0,att:k.attachments_found||0,ok:k.ocr_succeeded||0,fail:k.ocr_failed||0}),G=(k.elapsed_ms||0)+"ms";return`
            <div class="email-log-row ${A}">
                ...
                <span class="log-elapsed">${escapeHtml(G)}</span>
            </div>
        `}function L(){const k=document.getElementById("btn-email-bind");k&&k.addEventListener("click",()=>m("new"));const M=document.getElementById("btn-email-edit");M&&M.addEventListener("click",()=>m("edit"));const $=document.getElementById("btn-email-unbind");$&&$.addEventListener("click",S);const A=document.getElementById("btn-email-trigger");A&&A.addEventListener("click",b);const H=document.getElementById("email-enabled-toggle");H&&H.addEventListener("change",g);const P=document.getElementById("email-modal-close");P&&P.addEventListener("click",d);const F=document.getElementById("btn-email-modal-cancel");F&&F.addEventListener("click",d);const G=document.getElementById("btn-email-modal-test");G&&G.addEventListener("click",B);const O=document.getElementById("btn-email-modal-save");O&&O.addEventListener("click",T);const ee=document.getElementById("email-preset");ee&&ee.addEventListener("change",ue=>u(ue.target.value));const de=document.getElementById("email-address");de&&!de.dataset.autoBound&&(de.dataset.autoBound="1",de.addEventListener("blur",ue=>h((ue.target.value||"").trim())),de.addEventListener("input",ue=>{const re=(ue.target.value||"").trim();re.includes("@")&&re.split("@")[1].includes(".")&&h(re)}));const me=document.getElementById("btn-email-refresh-logs");me&&me.addEventListener("click",()=>{me.classList.add("spinning"),setTimeout(()=>me.classList.remove("spinning"),600),x()})}L(),window._loadEmailIngestPanel=i,window._rerenderEmailIngest=function(){if(!o)return;r();const k=document.getElementById("email-logs-section");e&&k&&k.open&&x()};let C=null;window._startEmailLogAutoRefresh=function(){C||(C=setInterval(()=>{e&&o&&x()},3e4))},window._stopEmailLogAutoRefresh=function(){C&&(clearInterval(C),C=null)}})();const Ms=`
...
`;we("bank-cand-drawer",Ms);const $s=`
    <div class="modal" style="max-width: 420px;">
        <div class="modal-head">
...
`;we("bank-client-picker-modal",$s);const N={sessions:[],currentSession:null,currentTxs:[],currentFilter:"all",currentTxForDrawer:null,loaded:!1,queue:[],qSeq:0,sessionFilter:"all",pickerSelected:null};function Hs(e){const n=Number(e||0);let a="score-low";return n>=85?a="score-high":n>=60&&(a="score-mid"),'<span class="bank-cand-score '+a+'">'+n.toFixed(0)+" "+t("bank-cand-score-unit")+"</span>"}function As(e){const n=document.getElementById("bank-upload-progress");n&&(n.style.display="none")}function js(){const e=document.getElementById("bank-upload-error");e&&(e.style.display="none")}function Ps(e){return{"bank_recon.only_pdf":t("bank-err-only-pdf"),"bank_recon.empty_file":t("bank-err-empty"),"bank_recon.file_too_large":t("bank-err-too-large"),"bank_recon.save_failed":t("bank-err-server"),"bank_recon.scanned":t("bank-err-scanned"),"bank_recon.no_tx":t("bank-err-no-tx"),network:t("bank-err-network")}[e]||t("bank-err-unknown")+" ("+e+")"}function Ke(e){if(e==null)return"-";const n=Number(e);return isNaN(n)?"-":n.toLocaleString("en-US",{minimumFractionDigits:2,maximumFractionDigits:2})}function it(e){if(!e)return"-";const n=String(e);return n.length>=10?n.slice(0,10):n}function Ma(e,n){return!e&&!n?"":(it(e)||"?")+" ~ "+(it(n)||"?")}function ie(e){return e==null?"":String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}async function Ds(e){N.currentTxForDrawer=e;const n=document.getElementById("bank-detail-body");n&&n.classList.add("has-pane");const a=document.getElementById("bank-cand-pane-title"),o=document.getElementById("bank-cand-pane-sub"),s=document.getElementById("bank-cand-pane-foot");if(a&&(a.textContent=t("bank-cand-pane-current")),o){const r=e.direction==="OUT"?"-":"+",c=e.direction==="OUT"?"bank-out":"bank-in";o.innerHTML=`${ie(it(e.tx_date))}
            <span style="margin:0 6px;color:#D1D5DB">·</span>
            <span>${ie(e.description||"-")}</span>
            <span style="margin:0 6px;color:#D1D5DB">·</span>
            <strong class="${c}">${r}${Ke(e.amount)}</strong>`}s&&(s.style.display="");const i=document.getElementById("bank-cand-pane-body");if(i){i.innerHTML=`<div class="bank-empty">${t("bank-cand-loading")}</div>`;try{const r=await fetch("/api/bank-recon/tx/"+encodeURIComponent(e.id)+"/candidates",{headers:{Authorization:"Bearer "+token}});if(!r.ok)throw new Error("cands:"+r.status);const c=await r.json();Rs(e,c.candidates||[])}catch{i.innerHTML=`<div class="bank-empty">${t("bank-cand-load-failed")}</div>`}}}function qs(e,n,a){const o=n.history_id,s=n.invoice_no||"-",i=n.vendor||"-",r=n.amount_total!==null&&n.amount_total!==void 0?Ke(n.amount_total):"-",c=n.invoice_date?it(n.invoice_date):"-",l=n.filename||"",p=!!a&&e.matched_history_id===o,m="bank-cand-card"+(n.is_auto_picked?" is-auto":"")+(p?" is-picked":"");let d="";return p?d='<button class="btn btn-ghost btn-small" data-act="unmatch"><span>'+t("bank-cand-unmatch")+"</span></button>":d='<button class="btn btn-primary btn-small" data-act="pick" data-hid="'+ie(o)+'"><span>'+t(n.is_auto_picked?"bank-cand-confirm":"bank-cand-pick-this")+"</span></button>",'<div class="'+m+'" data-hid="'+ie(o)+'"><div class="bank-cand-card-head"><div class="bank-cand-card-vendor">'+ie(i)+"</div>"+Hs(n.score)+'</div><div class="bank-cand-card-fields"><span class="bank-cand-field"><span class="bank-cand-flabel">'+t("bank-cand-fld-invoice-no")+"</span> "+ie(s)+'</span><span class="bank-cand-field"><span class="bank-cand-flabel">'+t("bank-cand-fld-amount")+"</span> "+r+'</span><span class="bank-cand-field"><span class="bank-cand-flabel">'+t("bank-cand-fld-date")+"</span> "+ie(c)+"</span></div>"+(l?'<div class="bank-cand-card-file" title="'+ie(l)+'">'+ie(l)+"</div>":"")+(n.reason?'<div class="bank-cand-card-reason">'+ie(n.reason)+"</div>":"")+'<div class="bank-cand-card-actions">'+d+"</div></div>"}function Rs(e,n){const a=document.getElementById("bank-cand-pane-body");if(!a)return;const o=n||[];let s="";if(e.match_status==="matched")s='<div class="bank-cand-hint hint-matched">'+t("bank-cand-hint-matched").replace("{n}",o.length)+"</div>";else if(e.match_status==="suggested")s='<div class="bank-cand-hint hint-suggested">'+t("bank-cand-hint-suggested").replace("{n}",o.length)+"</div>";else if(o.length>0)s='<div class="bank-cand-hint hint-low">'+t("bank-cand-hint-low").replace("{n}",o.length)+"</div>";else{a.innerHTML='<div class="bank-empty">'+t("bank-cand-no-match-detail")+"</div>";return}const i=e.match_status==="matched",r=o.map(c=>qs(e,c,i)).join("");a.innerHTML=s+'<div class="bank-cand-list">'+r+"</div>",a.querySelectorAll('[data-act="pick"]').forEach(c=>{c.addEventListener("click",()=>{Ns(c.dataset.hid)})}),a.querySelectorAll('[data-act="unmatch"]').forEach(c=>{c.addEventListener("click",async()=>{try{await fetch("/api/bank-recon/tx/"+encodeURIComponent(e.id)+"/override",{method:"POST",headers:{Authorization:"Bearer "+token,"Content-Type":"application/json"},body:JSON.stringify({status:"unmatched"})}),It(),await ct(N.currentSession.id)}catch{showToast(t("bank-action-failed"),"error")}})})}function It(){const e=document.getElementById("bank-detail-body");e&&e.classList.remove("has-pane");const n=document.getElementById("bank-cand-pane-title"),a=document.getElementById("bank-cand-pane-sub"),o=document.getElementById("bank-cand-pane-body"),s=document.getElementById("bank-cand-pane-foot");n&&(n.textContent=t("bank-cand-pane-empty-title")),a&&(a.textContent=t("bank-cand-pane-empty-sub")),s&&(s.style.display="none"),o&&(o.innerHTML='<div class="bank-cand-pane-empty"><svg viewBox="0 0 64 64" fill="none" stroke="currentColor" stroke-width="1.4" stroke-linecap="round" stroke-linejoin="round"><rect x="14" y="10" width="36" height="44" rx="3"/><path d="M22 22h20M22 30h20M22 38h12"/></svg><div>'+t("bank-cand-pane-empty-hint")+"</div></div>");const i=document.getElementById("bank-tx-tbody");i&&i.querySelectorAll("tr.is-selected").forEach(r=>r.classList.remove("is-selected")),N.currentTxForDrawer=null}async function ct(e){try{const n="/api/bank-recon/sessions/"+encodeURIComponent(e)+(N.currentFilter!=="all"?"?filter="+N.currentFilter:""),a=await fetch(n,{headers:{Authorization:"Bearer "+token}});if(!a.ok)throw new Error("detail:"+a.status);const o=await a.json();N.currentSession=o.session,N.currentTxs=o.transactions||[],Js()}catch(n){console.warn("[bank-recon] loadSessionDetail failed",n),showToast(t("bank-load-failed"),"error")}}async function Fs(){if(!N.currentSession)return;const e=document.getElementById("btn-bank-run-match"),n=e.innerHTML;e.disabled=!0,e.innerHTML="<span>"+t("bank-matching")+"</span>";try{const a=await fetch("/api/bank-recon/sessions/"+encodeURIComponent(N.currentSession.id)+"/match",{method:"POST",headers:{Authorization:"Bearer "+token}});if(!a.ok)throw new Error("match:"+a.status);const o=await a.json();showToast(t("bank-match-done").replace("{matched}",o.matched).replace("{suggested}",o.suggested).replace("{unmatched}",o.unmatched),"success"),await ct(N.currentSession.id),await dt()}catch(a){console.warn("[bank-recon] match failed",a),showToast(t("bank-match-failed"),"error")}finally{e.disabled=!1,e.innerHTML=n}}async function zs(){if(!(!N.currentSession||!await showConfirm(t("bank-delete-confirm"),{danger:!0})))try{const n=await fetch("/api/bank-recon/sessions/"+encodeURIComponent(N.currentSession.id),{method:"DELETE",headers:{Authorization:"Bearer "+token}});if(!n.ok)throw new Error("delete:"+n.status);showToast(t("bank-deleted"),"success"),N.currentSession=null,N.currentTxs=[],xn(),await dt()}catch(n){console.warn("[bank-recon] delete failed",n),showToast(t("bank-delete-failed"),"error")}}async function On(){if(N.currentTxForDrawer)try{const e=await fetch("/api/bank-recon/tx/"+encodeURIComponent(N.currentTxForDrawer.id)+"/override",{method:"POST",headers:{Authorization:"Bearer "+token,"Content-Type":"application/json"},body:JSON.stringify({status:"ignored"})});if(!e.ok)throw new Error("ignore:"+e.status);It(),await ct(N.currentSession.id)}catch{showToast(t("bank-action-failed"),"error")}}async function Ns(e){if(N.currentTxForDrawer)try{const n=await fetch("/api/bank-recon/tx/"+encodeURIComponent(N.currentTxForDrawer.id)+"/override",{method:"POST",headers:{Authorization:"Bearer "+token,"Content-Type":"application/json"},body:JSON.stringify({status:"matched",history_id:e})});if(!n.ok)throw new Error("pick:"+n.status);showToast(t("bank-matched-ok"),"success"),It(),await ct(N.currentSession.id)}catch{showToast(t("bank-action-failed"),"error")}}function $a(){if(!N.currentSession)return;const e=N.currentSession;document.getElementById("bank-detail-title").textContent=(e.bank_code||"-")+(e.account_last4?" ···"+e.account_last4:"")+" · "+(e.source_filename||""),document.getElementById("bank-meta-period").textContent=Ma(e.period_start,e.period_end)||"-",document.getElementById("bank-meta-opening").textContent=Ke(e.opening_balance),document.getElementById("bank-meta-inflow").textContent="+"+Ke(e.total_inflow),document.getElementById("bank-meta-outflow").textContent="-"+Ke(e.total_outflow),document.getElementById("bank-meta-closing").textContent=Ke(e.closing_balance);const n=N.currentTxs||[],a=n.length;let o=0,s=0,i=0;for(const r of n){const c=r.match_status||"unmatched";c==="matched"?o++:c==="suggested"?s++:i++}document.getElementById("bank-stat-total").textContent=a,document.getElementById("bank-stat-matched").textContent=o,document.getElementById("bank-stat-suggested").textContent=s,document.getElementById("bank-stat-unmatched").textContent=i}function wn(){const e=document.getElementById("bank-tx-tbody");if(!e)return;let n=N.currentTxs||[];if(N.currentFilter!=="all"&&(n=n.filter(a=>N.currentFilter==="matched"?a.match_status==="matched":N.currentFilter==="suggested"?a.match_status==="suggested":N.currentFilter==="unmatched"?a.match_status==="unmatched"||a.match_status==="ignored":!0)),n.length===0){e.innerHTML=`<tr><td colspan="4" class="bank-empty">${t("bank-tx-empty")}</td></tr>`;return}if(e.innerHTML=n.map(a=>Os(a)).join(""),e.querySelectorAll("tr[data-tx-id]").forEach(a=>{a.addEventListener("click",()=>{const o=a.dataset.txId,s=N.currentTxs.find(i=>i.id===o);s&&(e.querySelectorAll("tr.is-selected").forEach(i=>i.classList.remove("is-selected")),a.classList.add("is-selected"),Ds(s))})}),N.currentTxForDrawer){const a=e.querySelector('tr[data-tx-id="'+N.currentTxForDrawer.id+'"]');a&&a.classList.add("is-selected")}}function Os(e){const n=e.direction==="OUT",a=n?"-":"+",o=n?"bank-out":"bank-in",s=e.match_status||"unmatched",i=t("bank-match-"+s)||s,r=it(e.tx_date),c=e.channel?`<span class="bank-tx-channel">${ie(e.channel)}</span>`:"";return`
        <tr data-tx-id="${ie(e.id)}">
            <td class="bank-tx-date">${ie(r)}</td>
            <td class="bank-tx-desc">${c}${ie(e.description||"-")}</td>
            <td class="bank-td-amount ${o}">${a}${Ke(e.amount)}</td>
            <td><span class="bank-tx-match mt-${s}">${ie(i)}</span></td>
        </tr>
    `}function kn(){const e=document.getElementById("bank-client-badge");if(!e||!N.currentSession)return;const n=N.currentSession.client_id,a=document.getElementById("bank-client-badge-dot"),o=document.getElementById("bank-client-badge-name"),s=document.getElementById("bank-client-badge-caret"),i=typeof _userInfo<"u"?_userInfo:null,r=!(i&&i.role==="member");if(n!=null){const c=(window._clientsCache||[]).find(l=>Number(l.id)===Number(n));e.classList.remove("is-empty"),a&&(a.style.background=c&&c.color||"#111111"),o&&(o.textContent=c&&(c.short_name||c.name)||"#"+n)}else e.classList.add("is-empty"),a&&(a.style.background=""),o&&(o.textContent=t("bank-client-none"));r?(e.classList.remove("is-readonly"),e.disabled=!1,s&&(s.style.display="")):(e.classList.add("is-readonly"),e.disabled=!0,s&&(s.style.display="none")),e.style.display=""}function Vs(){if(!N.currentSession)return;const e=typeof _userInfo<"u"?_userInfo:null;if(!!(e&&e.role==="member"))return;N.pickerSelected=N.currentSession.client_id!=null?Number(N.currentSession.client_id):null,Aa();const a=document.getElementById("bank-client-picker-modal");a&&(a.style.display="")}function Ha(){const e=document.getElementById("bank-client-picker-modal");e&&(e.style.display="none"),N.pickerSelected=null}function Aa(){const e=document.getElementById("bank-client-picker-list");if(!e)return;const n=(window._clientsCache||[]).filter(o=>o&&(o.is_active===!0||o.is_active===void 0)),a=[];a.push('<div class="bank-client-picker-row is-none'+(N.pickerSelected==null?" is-selected":"")+'" data-cid=""><span class="bank-cp-dot"></span><span>'+ie(t("bank-client-picker-none"))+"</span></div>"),n.forEach(o=>{const s=Number(o.id)===Number(N.pickerSelected)?" is-selected":"";a.push('<div class="bank-client-picker-row'+s+'" data-cid="'+ie(o.id)+'"><span class="bank-cp-dot" style="background:'+ie(o.color||"#111111")+'"></span><span>'+ie(o.short_name||o.name||"#"+o.id)+"</span></div>")}),e.innerHTML=a.join(""),e.querySelectorAll(".bank-client-picker-row").forEach(o=>{o.addEventListener("click",()=>{const s=o.dataset.cid;N.pickerSelected=s?Number(s):null,Aa()})})}async function Us(){if(N.currentSession)try{const e=await fetch("/api/bank-recon/sessions/"+encodeURIComponent(N.currentSession.id)+"/client",{method:"PATCH",headers:{Authorization:"Bearer "+token,"Content-Type":"application/json"},body:JSON.stringify({client_id:N.pickerSelected})});if(!e.ok)throw new Error("client:"+e.status);N.currentSession.client_id=N.pickerSelected,kn(),showToast(t("bank-client-changed"),"success"),Ha();try{await dt()}catch{}}catch(e){console.warn("[bank-recon] save client failed",e),showToast(t("bank-client-change-failed"),"error")}}async function dt(){try{const e=await fetch("/api/bank-recon/sessions?limit=30",{headers:{Authorization:"Bearer "+token}});if(!e.ok)throw new Error("sessions:"+e.status);N.sessions=await e.json(),Dt()}catch(e){console.warn("[bank-recon] loadSessions failed",e),N.sessions=[],Dt()}}function Vn(){const e=document.getElementById("bank-status-summary");if(!e)return;if(N.sessions.length===0){e.textContent=t("bank-pill-none");return}let a=0;for(const o of N.sessions)o.parse_status==="parsed"&&(o.unmatched_count||0)>0&&a++;e.textContent=a>0?t("bank-pill-pending").replace("{n}",a):t("bank-pill-ok")}function Dt(){const e=document.getElementById("bank-sessions-list");if(!e)return;let n=N.sessions||[];if(N.sessionFilter==="parsed"?n=n.filter(a=>a.parse_status==="parsed"):N.sessionFilter==="failed"&&(n=n.filter(a=>a.parse_status==="parse_failed")),!N.sessions||N.sessions.length===0){e.innerHTML='<div class="bank-empty" data-i18n="bank-sessions-empty">'+t("bank-sessions-empty")+"</div>";return}if(n.length===0){e.innerHTML='<div class="bank-empty">'+t("bank-sess-filter-empty")+"</div>";return}e.innerHTML=n.map(a=>Gs(a)).join(""),e.querySelectorAll(".bank-session-row").forEach(a=>{a.addEventListener("click",o=>{o.target.closest(".bank-session-trash")||ct(a.dataset.sessionId)})}),e.querySelectorAll(".bank-session-trash").forEach(a=>{a.addEventListener("click",o=>{o.stopPropagation();const s=a.dataset.sessionId,i=a.dataset.sessionName||"";ja(s,i)})})}async function ja(e,n){if(!e)return;const a=(t("bank-session-delete-confirm")||"确定删除这条对账记录吗?").replace("{name}",n||"");if(await showConfirm(a,{danger:!0}))try{const s=await fetch("/api/bank-recon/sessions/"+encodeURIComponent(e),{method:"DELETE",headers:{Authorization:"Bearer "+token}});if(!s.ok)throw new Error("delete:"+s.status);showToast(t("bank-deleted"),"success"),N.currentSession&&N.currentSession.id===e&&(N.currentSession=null,N.currentTxs=[],xn()),await dt(),typeof window.loadReconcilePage=="function"&&window.loadReconcilePage()}catch(s){console.warn("[bank-recon] delete failed",s),showToast(t("bank-delete-failed"),"error")}}function Gs(e){const n=(e.bank_code||"OTHER").toUpperCase(),a=Ma(e.period_start,e.period_end),o=e.account_last4?"···"+e.account_last4:"",s=Ks(e),i=it(e.created_at);return`
    ...
    `}function Ks(e){if(e.parse_status==="parse_failed")return`<span class="bank-session-count cnt-failed">${t("bank-count-parse-failed")}</span>`;if(e.parse_status!=="parsed")return`<span class="bank-session-count">${t("bank-count-parsing")}</span>`;const n=e.tx_count||0,a=e.matched_count||0,o=e.unmatched_count||0,s=[`<span class="bank-session-count">${n} ${t("bank-count-tx")}</span>`];return a>0&&s.push(`<span class="bank-session-count cnt-matched">${a} ${t("bank-count-matched")}</span>`),o>0&&s.push(`<span class="bank-session-count cnt-unmatched">${o} ${t("bank-count-unmatched")}</span>`),s.join("")}function Js(){document.getElementById("bank-detail").style.display="",document.querySelector(".bank-sessions-section").style.display="none",$a(),wn(),kn()}function xn(){document.getElementById("bank-detail").style.display="none",document.querySelector(".bank-sessions-section").style.display="";const e=document.getElementById("bank-detail-body");e&&e.classList.remove("has-pane"),N.currentTxForDrawer=null}const Ws=3;function Ys(){return N.qSeq+=1,"q"+N.qSeq+"_"+Date.now()}async function Xs(e){const n=Array.from(e.target.files||[]);if(e.target.value="",n.length!==0){for(const a of n){const o={id:Ys(),file:a,name:a.name,size:a.size,status:"pending",progress:0,error_code:null,tx_count:0,session_id:null};a.name.toLowerCase().endsWith(".pdf")?a.size>20*1024*1024&&(o.status="failed",o.error_code="bank_recon.file_too_large"):(o.status="failed",o.error_code="bank_recon.only_pdf"),N.queue.push(o)}Zs(),Ee(),_n()}}function Zs(){const e=document.getElementById("bank-upload-queue");e&&(e.style.display=""),As(),js()}function Ee(){const e=document.getElementById("bank-upload-queue-list"),n=document.getElementById("bank-upload-queue-summary");if(!e)return;if(N.queue.length===0){e.innerHTML="",n&&(n.textContent="");const r=document.getElementById("bank-upload-queue");r&&(r.style.display="none");return}let a=0,o=0,s=0,i=0;for(const r of N.queue)r.status==="ok"?a++:r.status==="failed"?o++:r.status==="uploading"||r.status==="parsing"?s++:i++;n&&(n.textContent=t("bank-queue-summary").replace("{ok}",a).replace("{run}",s).replace("{wait}",i).replace("{fail}",o)),e.innerHTML=N.queue.map(Qs).join(""),e.querySelectorAll("[data-q-act]").forEach(r=>{const c=r.dataset.qAct,l=r.dataset.qId;r.addEventListener("click",()=>{c==="retry"&&ei(l),c==="remove"&&ti(l)})})}function Qs(e){const n=(e.size/1024).toFixed(0)+" KB";let a="",o="";if(e.status==="pending")a='<span class="bq-stat bq-wait">'+t("bank-queue-status-wait")+"</span>",o='<button data-q-act="remove" data-q-id="'+ie(e.id)+'" class="bq-act">×</button>';else if(e.status==="uploading")a='<span class="bq-stat bq-run">'+t("bank-queue-status-uploading")+'</span><div class="bq-bar"><div class="bq-bar-fill" style="width:'+(e.progress||0)+'%"></div></div>';else if(e.status==="parsing")a='<span class="bq-stat bq-run">'+t("bank-queue-status-parsing")+'</span><div class="bq-bar"><div class="bq-bar-fill bq-bar-indet"></div></div>';else if(e.status==="ok")a='<span class="bq-stat bq-ok">'+t("bank-queue-status-ok").replace("{n}",e.tx_count||0)+"</span>",o='<button data-q-act="remove" data-q-id="'+ie(e.id)+'" class="bq-act">×</button>';else if(e.status==="failed"){const s=Ps(e.error_code||"unknown");a='<span class="bq-stat bq-fail" title="'+ie(s)+'">'+ie(s)+"</span>",o='<button data-q-act="retry" data-q-id="'+ie(e.id)+'" class="bq-act bq-act-retry">'+t("bank-queue-retry")+'</button><button data-q-act="remove" data-q-id="'+ie(e.id)+'" class="bq-act">×</button>'}return'<div class="bq-row" data-q-row="'+ie(e.id)+'"><div class="bq-name" title="'+ie(e.name)+'">'+ie(e.name)+'</div><div class="bq-size">'+n+'</div><div class="bq-status">'+a+'</div><div class="bq-actions">'+o+"</div></div>"}function ei(e){const n=N.queue.find(a=>a.id===e);n&&(n.status="pending",n.error_code=null,n.progress=0,Ee(),_n())}function ti(e){const n=N.queue.findIndex(o=>o.id===e);if(n<0)return;const a=N.queue[n];a.status==="uploading"||a.status==="parsing"||(N.queue.splice(n,1),Ee())}function ni(){N.queue=N.queue.filter(e=>e.status!=="ok"),Ee()}async function _n(){for(;;){if(N.queue.filter(a=>a.status==="uploading"||a.status==="parsing").length>=Ws)return;const n=N.queue.find(a=>a.status==="pending");if(!n){N.queue.every(a=>a.status==="ok"||a.status==="failed")&&(await dt(),typeof window.loadReconcilePage=="function"&&window.loadReconcilePage());return}ai(n).then(()=>_n())}}async function ai(e){e.status="uploading",e.progress=0,Ee();try{const n=new FormData;n.append("file",e.file,e.name);const a=await new Promise((s,i)=>{const r=new XMLHttpRequest;r.open("POST","/api/bank-recon/upload"),r.setRequestHeader("Authorization","Bearer "+token),r.upload.onprogress=c=>{c.lengthComputable&&(e.progress=Math.min(99,Math.round(c.loaded/c.total*100)),Ee())},r.upload.onload=()=>{e.status="parsing",Ee()},r.onload=()=>{r.status>=200&&r.status<300?s({status:r.status,text:r.responseText}):s({status:r.status,text:r.responseText})},r.onerror=()=>i(new Error("network")),r.send(n)});let o={};try{o=JSON.parse(a.text||"{}")}catch{o={}}if(a.status>=400){e.status="failed",e.error_code=o&&o.detail||"unknown",Ee();return}if(o.parse_status==="parse_failed"){e.status="failed",e.error_code=o.error==="scanned_pdf_not_yet"?"bank_recon.scanned":"bank_recon.no_tx",Ee();return}e.status="ok",e.tx_count=o.tx_count||0,e.session_id=o.session_id||null,Ee()}catch(n){console.warn("[bank-recon] upload failed",n),e.status="failed",e.error_code="network",Ee()}}async function Pa(){if(N.loaded){Vn();return}N.loaded=!0,oi(),await dt(),Vn()}function oi(){const e=document.getElementById("bank-file-input");e&&!e._bound&&(e._bound=!0,e.addEventListener("change",Xs));const n=document.getElementById("btn-bank-queue-clear-done");n&&!n._bound&&(n._bound=!0,n.addEventListener("click",ni));const a=document.getElementById("btn-bank-back");a&&!a._bound&&(a._bound=!0,a.addEventListener("click",()=>{N.currentSession=null,N.currentTxs=[],xn()}));const o=document.getElementById("btn-bank-delete");o&&!o._bound&&(o._bound=!0,o.addEventListener("click",zs));const s=document.getElementById("btn-bank-run-match");s&&!s._bound&&(s._bound=!0,s.addEventListener("click",Fs)),document.querySelectorAll(".bank-filter-btn").forEach(m=>{m._bound||(m._bound=!0,m.addEventListener("click",()=>{N.currentFilter=m.dataset.bankFilter||"all",document.querySelectorAll(".bank-filter-btn").forEach(d=>{d.classList.toggle("active",d===m)}),wn()}))}),document.querySelectorAll("[data-bank-cand-close]").forEach(m=>{m._bound||(m._bound=!0,m.addEventListener("click",It))});const i=document.getElementById("btn-bank-cand-pane-close");i&&!i._bound&&(i._bound=!0,i.addEventListener("click",It));const r=document.getElementById("btn-bank-cand-ignore");r&&!r._bound&&(r._bound=!0,r.addEventListener("click",On));const c=document.getElementById("btn-bank-cand-ignore-pane");c&&!c._bound&&(c._bound=!0,c.addEventListener("click",On));const l=document.getElementById("bank-client-badge");l&&!l._bound&&(l._bound=!0,l.addEventListener("click",Vs)),document.querySelectorAll("[data-bank-client-picker-close]").forEach(m=>{m._bound||(m._bound=!0,m.addEventListener("click",Ha))});const p=document.getElementById("btn-bank-client-picker-save");p&&!p._bound&&(p._bound=!0,p.addEventListener("click",Us)),document.querySelectorAll(".bank-sessions-chip").forEach(m=>{m._bound||(m._bound=!0,m.addEventListener("click",()=>{N.sessionFilter=m.dataset.sessFilter||"all",document.querySelectorAll(".bank-sessions-chip").forEach(d=>{d.classList.toggle("active",d===m)}),Dt()}))})}window._deleteBankSession=ja;window._loadBankReconPanel=Pa;window._rerenderBankRecon=function(){if(currentRoute==="automation"){if(Dt(),N.currentSession&&($a(),wn(),kn(),!N.currentTxForDrawer)){const e=document.getElementById("bank-cand-pane-title"),n=document.getElementById("bank-cand-pane-sub");e&&(e.textContent=t("bank-cand-pane-empty-title")),n&&(n.textContent=t("bank-cand-pane-empty-sub"))}Ee()}};typeof window.subscribeI18n=="function"&&window.subscribeI18n("bank-recon",window._rerenderBankRecon);window._openBankSession=async function(e){e&&(N.loaded||await Pa(),await ct(e))};(function(){const e=document.getElementById("page-clients");if(!(!e||e.dataset.wbInjected==="1")){e.innerHTML=`
        <div class="page-head">
            <div class="page-head-icon">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
...
`,e.dataset.wbInjected="1";try{const n=window._currentLang||localStorage.getItem("mrpilot_lang")||"th",a=window.I18N;a&&a[n]&&(e.querySelectorAll("[data-i18n]").forEach(o=>{const s=o.getAttribute("data-i18n");a[n][s]&&(o.textContent=a[n][s])}),e.querySelectorAll("[data-i18n-placeholder]").forEach(o=>{const s=o.getAttribute("data-i18n-placeholder");a[n][s]&&(o.placeholder=a[n][s])}))}catch{}}})();const si=`
    ...
    `;we("client-modal-mask",si);we("wsclient-modal-mask",ii);const te={clients:[],editingClientId:null,historyClientFilter:"",custTab:"seller",sellerClients:[],editingWsClientId:null,catCache:{fetched:0,items:[],supplier_count:0}},ye={page:0,pageSize:12,keyword:""},He=new Set,qt={keyword:""};function ri(){return{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||"")}}async function Ce(e,n={}){const a=await fetch(e,{...n,headers:{"Content-Type":"application/json",...ri(),...n.headers||{}}});if(!a.ok){const o=await a.json().catch(()=>({}));throw new Error(o.detail||"HTTP "+a.status)}return a.json()}function li(){const e=document.querySelector("#client-color-picker .color-swatch.active");return e?e.dataset.color:"#111111"}function Un(e){const n=document.getElementById("drawer-cat-learned-tag");n&&e>0&&(n.textContent=(t("drawer-suggest-learned-with-count")||"已学 {n}").replace("{n}",e))}async function pt(){try{const e=await Ce("/api/clients");te.clients=e.clients||[],window._clientsCache=te.clients}catch(e){console.error("loadClientsCache fail",e),te.clients=[]}try{typeof window._refreshExcClientFilter=="function"&&window._refreshExcClientFilter()}catch{}try{typeof window._refreshClientSwitcher=="function"&&window._refreshClientSwitcher()}catch{}return te.clients}function ci(){const e=ye.keyword.trim().toLowerCase();return e?te.clients.filter(n=>(n.name||"").toLowerCase().includes(e)||(n.short_name||"").toLowerCase().includes(e)||(n.tax_id||"").toLowerCase().includes(e)):te.clients}function En(){const e=ci(),n=ye.pageSize,a=Math.max(0,Math.ceil(e.length/n)-1);ye.page>a&&(ye.page=a);const o=ye.page*n;return{all:e,items:e.slice(o,o+n),start:o,ps:n,total:e.length,maxPage:a}}function $e(){const e=document.getElementById("buyer-tbody");if(!e)return;const{items:n,start:a,ps:o,total:s,maxPage:i}=En();s?e.innerHTML=n.map(p=>{const m=He.has(p.id);return`<div class="cust-row buyer-grid${m?" selected":""}" data-cid="${p.id}">
                <div class="cust-cell-check"><input type="checkbox" class="buyer-row-check" data-cid="${p.id}" ${m?"checked":""}></div>
            ...
            </div>`}).join(""):e.innerHTML=`<div class="cust-empty">${escapeHtml(t(ye.keyword?"cust-no-match":"clients-empty"))}</div>`;const r=document.getElementById("buyer-pager-info");r&&(r.textContent=s?`${a+1}–${Math.min(a+o,s)} / ${s}`:"0");const c=document.getElementById("buyer-prev");c&&(c.disabled=ye.page<=0);const l=document.getElementById("buyer-next");l&&(l.disabled=ye.page>=i),Da()}function Da(){const e=He.size,n=document.getElementById("buyer-batch-bar");n&&(n.style.display=e?"flex":"none");const a=document.getElementById("buyer-batch-count");a&&(a.textContent=t("cust-selected-n").replace("{n}",e));const o=document.getElementById("buyer-check-all");if(o){const{items:s}=En(),i=s.map(c=>c.id),r=i.filter(c=>He.has(c)).length;o.checked=i.length>0&&r===i.length,o.indeterminate=r>0&&r<i.length}}function di(){He.clear(),$e()}async function pi(){const e=Array.from(He);if(!(!e.length||!await showConfirm(t("cust-batch-del-confirm").replace("{n}",e.length),{danger:!0})))try{await Ce("/api/clients/batch-delete",{method:"POST",body:JSON.stringify({ids:e})}),showToast(t("client-msg-deleted"),"success"),He.clear(),await pt(),$e(),Jt(),Bn()}catch{showToast(t("client-msg-save-fail"),"fail")}}function yt(e){te.editingClientId=e?e.id:null;const n=!!e;document.getElementById("client-modal-title").textContent=t(n?"client-modal-edit":"client-modal-new"),document.getElementById("client-input-name").value=e&&e.name||"",document.getElementById("client-input-short").value=e&&e.short_name||"",document.getElementById("client-input-tax").value=e&&e.tax_id||"",document.getElementById("client-input-address").value=e&&e.address||"",document.getElementById("client-input-contact").value=e&&e.contact_person||"",document.getElementById("client-input-phone").value=e&&e.contact_phone||"",document.getElementById("client-input-email").value=e&&e.contact_email||"",document.getElementById("client-input-notes").value=e&&e.notes||"";const a=e&&e.color||"#111111";document.querySelectorAll("#client-color-picker .color-swatch").forEach(o=>{o.classList.toggle("active",o.dataset.color===a)}),document.getElementById("client-modal-delete").style.display=n?"":"none",document.getElementById("client-modal-mask").style.display="flex",setTimeout(()=>document.getElementById("client-input-name").focus(),50)}function wt(){document.getElementById("client-modal-mask").style.display="none",te.editingClientId=null}async function ui(){const e=document.getElementById("client-input-name").value.trim();if(!e){showToast(t("client-msg-name-required"),"fail");return}const n={name:e,short_name:document.getElementById("client-input-short").value.trim()||null,tax_id:document.getElementById("client-input-tax").value.trim()||null,address:document.getElementById("client-input-address").value.trim()||null,contact_person:document.getElementById("client-input-contact").value.trim()||null,contact_phone:document.getElementById("client-input-phone").value.trim()||null,contact_email:document.getElementById("client-input-email").value.trim()||null,notes:document.getElementById("client-input-notes").value.trim()||null,color:li()};try{te.editingClientId?(await Ce(`/api/clients/${te.editingClientId}`,{method:"PATCH",body:JSON.stringify(n)}),showToast(t("client-msg-updated"),"success")):(await Ce("/api/clients",{method:"POST",body:JSON.stringify(n)}),showToast(t("client-msg-created"),"success")),wt(),await pt(),currentRoute==="clients"&&$e(),Jt(),Bn()}catch(a){console.error("saveClient fail",a);const o=a&&a.message?a.message:t("client-msg-save-fail");showToast(t("client-msg-save-fail")+" · "+o,"fail")}}async function fi(){if(!te.editingClientId)return;const e=te.clients.find(o=>o.id===te.editingClientId);if(!e)return;const n=t("client-delete-confirm").replace("{name}",e.name);if(await showConfirm(n,{danger:!0}))try{await Ce(`/api/clients/${te.editingClientId}`,{method:"DELETE"}),showToast(t("client-msg-deleted"),"success"),wt(),await pt(),currentRoute==="clients"&&$e(),Jt(),Bn()}catch(o){console.error(o),showToast(t("client-msg-save-fail"),"fail")}}async function mi(e){const n=te.clients.find(a=>a.id===e);if(typeof window.openClientExportModal=="function"){window.openClientExportModal(e,n?n.name:"");return}try{const a=localStorage.getItem("mrpilot_token"),o=await fetch(`/api/clients/${e}/export?month=all`,{headers:{Authorization:"Bearer "+a}});if(!o.ok){let l="HTTP "+o.status;try{const p=await o.json();p&&p.detail&&(l=p.detail)}catch{}throw new Error(l)}const s=await o.blob();if(s.size<200){showToast(t("client-export-month-empty"),"info");return}const i=n&&n.name?n.name.replace(/[^a-zA-Z0-9\u0e00-\u0e7f\u4e00-\u9fff]/g,"_").slice(0,40):"client",r=URL.createObjectURL(s),c=document.createElement("a");c.href=r,c.download=`${i}_export.csv`,c.click(),URL.revokeObjectURL(r)}catch(a){console.error("exportClient fail",a),showToast(t("client-msg-save-fail")+" · "+(a.message||""),"fail")}}function Jt(){const e=document.getElementById("drawer-client-select");if(!e)return;const n=e.value;e.innerHTML=`<option value="">${escapeHtml(t("drawer-client-none"))}</option>`+te.clients.map(a=>`<option value="${a.id}">${escapeHtml(a.name)}</option>`).join(""),e.value=n||""}function Bn(){const e=document.getElementById("history-client-filter");if(!e)return;const n=e.value;e.innerHTML=`<option value="">${escapeHtml(t("history-client-all"))}</option>`+te.clients.map(a=>`<option value="${a.id}">${escapeHtml(a.name)}</option>`).join(""),e.value=n||""}function vi(e){te.custTab=e==="buyer"?"buyer":"seller",document.querySelectorAll("[data-cust-tab]").forEach(o=>o.classList.toggle("active",o.dataset.custTab===te.custTab));const n=document.getElementById("cust-pane-seller"),a=document.getElementById("cust-pane-buyer");n&&n.classList.toggle("active",te.custTab==="seller"),a&&a.classList.toggle("active",te.custTab==="buyer")}function hi(){const e=window._userInfo||{},n=String(e.role||"").toLowerCase(),a=String(e.tenant_role||"").toLowerCase();return e.is_super_admin===!0||e.is_owner===!0||n==="owner"||n==="admin"||a==="owner"||a==="admin"}function qa(){window._workspaceClientsCache=te.sellerClients,typeof window.renderWorkspaceControl=="function"&&window.renderWorkspaceControl()}async function In(){try{const e=await Ce("/api/workspace/clients");te.sellerClients=e&&(e.clients||e.items)||[],window._workspaceClientsCache=te.sellerClients}catch(e){console.error("loadSellerCache fail",e),te.sellerClients=[]}return te.sellerClients}function gi(){const e=qt.keyword.trim().toLowerCase();return e?te.sellerClients.filter(n=>(n.name||"").toLowerCase().includes(e)||(n.tax_id||"").toLowerCase().includes(e)):te.sellerClients}function Je(){const e=document.getElementById("seller-tbody");if(!e)return;const n=hi(),a=document.getElementById("btn-seller-new");a&&(a.style.display=n?"":"none");const o=gi(),s=typeof window.getActiveWorkspaceClientId=="function"?window.getActiveWorkspaceClientId():null;if(!o.length){e.innerHTML=`<div class="cust-empty">${escapeHtml(t(qt.keyword?"cust-no-match":"seller-empty"))}</div>`;return}e.innerHTML=o.map(i=>{const c=s!=null&&Number(s)===Number(i.id)?`<span class="cust-badge-current"><svg viewBox="0 0 14 14" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M2 7.5l3.2 3.2L12 4"/></svg>${escapeHtml(t("seller-current"))}</span>`:`<button class="cust-row-btn primary" data-saction="activate" data-wid="${i.id}">${escapeHtml(t("seller-set-current"))}</button>`,l=n?`
        ...
        </div>`}).join("")}function Gn(e){te.editingWsClientId=e?e.id:null,document.getElementById("wsclient-modal-title").textContent=t(e?"wsclient-modal-edit":"wsclient-modal-new"),document.getElementById("wsclient-input-name").value=e&&e.name||"",document.getElementById("wsclient-input-tax").value=e&&e.tax_id||"",document.getElementById("wsclient-modal-archive").style.display=e?"":"none",document.getElementById("wsclient-modal-mask").style.display="flex",setTimeout(()=>document.getElementById("wsclient-input-name").focus(),50)}function kt(){document.getElementById("wsclient-modal-mask").style.display="none",te.editingWsClientId=null}async function bi(){const e=document.getElementById("wsclient-input-name").value.trim(),n=document.getElementById("wsclient-input-tax").value.trim();if(!e){showToast(t("client-msg-name-required"),"fail");return}try{te.editingWsClientId?(await Ce("/api/workspace/clients/"+te.editingWsClientId,{method:"PATCH",body:JSON.stringify({name:e,tax_id:n})}),showToast(t("client-msg-updated"),"success")):(await Ce("/api/workspace/clients",{method:"POST",body:JSON.stringify({name:e,tax_id:n||null})}),showToast(t("client-msg-created"),"success")),kt(),await In(),Je(),qa()}catch(a){const o=a&&a.message?a.message:t("client-msg-save-fail");showToast(t("client-msg-save-fail")+" · "+o,"fail")}}async function Kn(){if(!te.editingWsClientId)return;const e=te.sellerClients.find(a=>Number(a.id)===Number(te.editingWsClientId));if(await showConfirm(t("wsclient-archive-confirm").replace("{name}",e?e.name:""),{danger:!0}))try{const a=te.editingWsClientId;await Ce("/api/workspace/clients/"+a,{method:"DELETE"}),showToast(t("wsclient-archived"),"success"),typeof window.getActiveWorkspaceClientId=="function"&&Number(window.getActiveWorkspaceClientId())===Number(a)&&typeof window.enterPersonalMode=="function"&&window.enterPersonalMode(),kt(),await In(),Je(),qa()}catch{showToast(t("client-msg-save-fail"),"fail")}}window.loadClientsPage=async function(){const e=document.getElementById("seller-tbody");e&&(e.innerHTML=`<div class="cust-loading">${escapeHtml(t("clients-loading"))}</div>`);const n=document.getElementById("buyer-tbody");n&&(n.innerHTML=`<div class="cust-loading">${escapeHtml(t("clients-loading"))}</div>`),await Promise.all([In(),pt()]),Je(),$e()};window.addEventListener("pearnly:workspace-changed",function(){typeof currentRoute<"u"&&currentRoute==="clients"&&Je()});window.bindDrawerClient=function(e,n){const a=document.getElementById("drawer-client-select");if(!a)return;if(Jt(),a.value=n?String(n):"",!e){a.onchange=null;const s=document.getElementById("drawer-client-add");s&&(s.onclick=()=>yt(null));return}a.onchange=async()=>{const s=a.value?parseInt(a.value,10):null;try{await Ce(`/api/history/${e}/assign_client`,{method:"POST",body:JSON.stringify({client_id:s})}),showToast(t("client-msg-updated"),"success");const i=_results[_drawerIdx];i&&(i.client_id=s),await pt()}catch(i){console.error(i),showToast(t("client-msg-save-fail"),"fail"),a.value=n?String(n):""}};const o=document.getElementById("drawer-client-add");o&&(o.onclick=()=>yt(null))};window.fillCategoryDatalist=async function(){try{const e=document.getElementById("drawer-cat-datalist"),n=Date.now();if(n-te.catCache.fetched<300*1e3){e&&(e.innerHTML=te.catCache.items.map(o=>`<option value="${escapeHtml(o)}">`).join("")),Un(te.catCache.supplier_count);return}const a=await Ce("/api/categories",{method:"GET"});te.catCache.fetched=n,te.catCache.items=a&&a.categories||[],te.catCache.supplier_count=a&&a.supplier_count||0,e&&(e.innerHTML=te.catCache.items.map(o=>`<option value="${escapeHtml(o)}">`).join("")),Un(te.catCache.supplier_count)}catch(e){console.warn("fillCategoryDatalist failed",e)}};window.getHistoryClientFilter=function(){return te.historyClientFilter};document.addEventListener("DOMContentLoaded",()=>{const e=document.querySelector(".cust-tab-bar");e&&e.addEventListener("click",I=>{const L=I.target.closest("[data-cust-tab]");L&&vi(L.dataset.custTab)});const n=document.getElementById("btn-buyer-new");n&&n.addEventListener("click",()=>yt(null));const a=document.getElementById("buyer-tbody");a&&a.addEventListener("click",I=>{const L=I.target.closest(".buyer-row-check");if(L){const M=parseInt(L.dataset.cid,10);L.checked?He.add(M):He.delete(M);const $=L.closest(".cust-row");$&&$.classList.toggle("selected",L.checked),Da();return}const C=I.target.closest(".cust-row-btn");if(C){I.stopPropagation();const M=parseInt(C.dataset.cid,10);if(C.dataset.action==="edit"){const $=te.clients.find(A=>A.id===M);$&&yt($)}else C.dataset.action==="export"&&mi(M);return}const k=I.target.closest(".cust-row");if(k&&!I.target.closest(".cust-cell-check")){const M=te.clients.find($=>$.id===parseInt(k.dataset.cid,10));M&&yt(M)}});const o=document.getElementById("buyer-check-all");o&&o.addEventListener("change",()=>{const{items:I}=En();I.forEach(L=>{o.checked?He.add(L.id):He.delete(L.id)}),$e()});const s=document.getElementById("buyer-batch-cancel");s&&s.addEventListener("click",di);const i=document.getElementById("buyer-batch-delete");i&&i.addEventListener("click",pi);const r=document.getElementById("buyer-prev");r&&r.addEventListener("click",()=>{ye.page>0&&(ye.page--,$e())});const c=document.getElementById("buyer-next");c&&c.addEventListener("click",()=>{ye.page++,$e()});const l=document.getElementById("buyer-search");if(l){let I;l.addEventListener("input",()=>{clearTimeout(I),I=setTimeout(()=>{ye.keyword=l.value,ye.page=0;const L=document.getElementById("buyer-search-clear");L&&(L.style.display=l.value?"":"none"),$e()},200)})}const p=document.getElementById("buyer-search-clear");p&&p.addEventListener("click",()=>{const I=document.getElementById("buyer-search");I&&(I.value=""),ye.keyword="",ye.page=0,p.style.display="none",$e()});const m=document.getElementById("btn-seller-new");m&&m.addEventListener("click",()=>Gn(null));const d=document.getElementById("seller-tbody");d&&d.addEventListener("click",I=>{const L=I.target.closest("[data-saction]");if(!L)return;I.stopPropagation();const C=parseInt(L.dataset.wid,10),k=L.dataset.saction,M=te.sellerClients.find($=>Number($.id)===C);k==="activate"?(typeof window.setActiveWorkspaceClientId=="function"&&window.setActiveWorkspaceClientId(C),Je(),typeof window.renderWorkspaceControl=="function"&&window.renderWorkspaceControl(),showToast(t("seller-activated").replace("{name}",M?M.name:""),"success")):k==="edit"?M&&Gn(M):k==="archive"&&(te.editingWsClientId=C,Kn())});const u=document.getElementById("seller-search");if(u){let I;u.addEventListener("input",()=>{clearTimeout(I),I=setTimeout(()=>{qt.keyword=u.value;const L=document.getElementById("seller-search-clear");L&&(L.style.display=u.value?"":"none"),Je()},200)})}const f=document.getElementById("seller-search-clear");f&&f.addEventListener("click",()=>{const I=document.getElementById("seller-search");I&&(I.value=""),qt.keyword="",f.style.display="none",Je()});const h=document.getElementById("wsclient-modal-close");h&&h.addEventListener("click",kt);const _=document.getElementById("wsclient-modal-cancel");_&&_.addEventListener("click",kt);const w=document.getElementById("wsclient-modal-save");w&&w.addEventListener("click",bi);const y=document.getElementById("wsclient-modal-archive");y&&y.addEventListener("click",Kn);const v=document.getElementById("wsclient-modal-mask");v&&v.addEventListener("click",I=>{I.target===v&&kt()});const E=document.getElementById("client-modal-close");E&&E.addEventListener("click",wt);const B=document.getElementById("client-modal-cancel");B&&B.addEventListener("click",wt);const T=document.getElementById("client-modal-save");T&&T.addEventListener("click",ui);const S=document.getElementById("client-modal-delete");S&&S.addEventListener("click",fi);const b=document.getElementById("client-modal-mask");b&&b.addEventListener("click",I=>{I.target===b&&wt()});const g=document.getElementById("client-color-picker");g&&g.addEventListener("click",I=>{const L=I.target.closest(".color-swatch");L&&(g.querySelectorAll(".color-swatch").forEach(C=>C.classList.remove("active")),L.classList.add("active"))});const x=document.getElementById("history-client-filter");x&&x.addEventListener("change",()=>{te.historyClientFilter=x.value,typeof renderHistoryList=="function"&&renderHistoryList()})});setTimeout(()=>pt(),1e3);(function(){const e=document.getElementById("page-exceptions");if(!(!e||e.dataset.wbInjected==="1")){e.innerHTML=`
        <div class="page-head">
            <div class="page-head-icon">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round">
...
`,e.dataset.wbInjected="1";try{const n=window._currentLang||localStorage.getItem("mrpilot_lang")||"th",a=window.I18N;a&&a[n]&&(e.querySelectorAll("[data-i18n]").forEach(o=>{const s=o.getAttribute("data-i18n");a[n][s]&&(o.textContent=a[n][s])}),e.querySelectorAll("[data-i18n-placeholder]").forEach(o=>{const s=o.getAttribute("data-i18n-placeholder");a[n][s]&&(o.placeholder=a[n][s])}))}catch{}}})();const J={statsCache:null,listCache:[],currentRule:null,currentClient:"",currentStatus:"pending",loading:!1,selectedIds:new Set,offset:0,pageSize:50,total:0,loadFailed:!1,listScrollY:0},Y={openExcId:null,excRow:null,history:null,loading:!1,pdfUrl:null,pdfStatus:"idle",editing:!1,editFields:null},et={batchLoading:!1};function ze(e,n){let a=t(e)||e;if(n)for(const o in n)a=a.replace(new RegExp("\\{"+o+"\\}","g"),String(n[o]));return a}function yi(e){return e==="high"?`<svg viewBox="0 0 14 14" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
    ...
    </svg>`}function wi(){return`<svg class="exc-empty-icon" viewBox="0 0 40 40" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
        <path d="M11 19l5 5 13-13"/>
        <circle cx="20" cy="20" r="17"/>
    </svg>`}function ki(e){if(e==null)return"—";const n=parseFloat(e);return isNaN(n)?"—":"฿ "+n.toLocaleString(void 0,{minimumFractionDigits:2,maximumFractionDigits:2})}function xi(e){return e?e.slice(0,10):"—"}function Xe(e){if(e==null)return"—";const n=typeof e=="number"?e:parseFloat(String(e).replace(/,/g,""));return isNaN(n)?escapeHtml(String(e)):"฿ "+n.toLocaleString(void 0,{minimumFractionDigits:2,maximumFractionDigits:2})}function _i(e){if(!e)return"—";try{const n=new Date(e),a=o=>String(o).padStart(2,"0");return`${n.getFullYear()}-${a(n.getMonth()+1)}-${a(n.getDate())} ${a(n.getHours())}:${a(n.getMinutes())}`}catch{return e.slice(0,16).replace("T"," ")}}function Ei(e,n){if(n=n||{},e==="math_mismatch")return`
        ...
        `:e==="amount_missing"?`<div class="exc-why-detail-row" style="justify-content:center;color:var(--danger);"><span>${escapeHtml(t("exc-detail-missing"))}</span></div>`:`<div class="exc-why-detail-row"><span style="font-size:11px;">${escapeHtml(JSON.stringify(n))}</span></div>`}function De(){const e=Y.excRow;if(!e)return;const n=e.seller_name&&e.seller_name.trim()?e.seller_name:t("exc-no-seller"),a=e.filename||"—";document.getElementById("exc-drawer-title").textContent=a;const o="exc-status-"+(e.status||"pending"),s=t(o)||e.status,i="s-"+(e.status||"pending"),r=(e.invoice_date||e.created_at||"").slice(0,10);document.getElementById("exc-drawer-sub").innerHTML=`
        <span>${escapeHtml(n)}</span>
        ${e.invoice_no?`<span>· ${escapeHtml(e.invoice_no)}</span>`:""}
        ${r?`<span>· ${escapeHtml(r)}</span>`:""}
        <span class="exc-status-chip ${i}">${escapeHtml(s)}</span>
    `;const c=e.severity||"medium",l=t("exc-rule-"+e.rule_code)||e.rule_code,p=Ei(e.rule_code,e.detail||{}),m=Jn(Y.history),d=Y.history===null,u=Y.history&&Y.history._err,f=new Set;e.rule_code==="math_mismatch"?(f.add("subtotal"),f.add("vat"),f.add("total_amount")):e.rule_code==="tax_id_format_invalid"?f.add("seller_tax"):e.rule_code==="amount_missing"&&(f.add("total_amount"),f.add("invoice_number"));const h=!!Y.editing,_=Y.editFields||{},w=(C,k,M)=>{if(d)return`<div class="exc-field-row"><label>${escapeHtml(t(k))}</label><span class="val empty">…</span></div>`;const $=h?_[C]!==void 0?_[C]:m[C]!==void 0&&m[C]!==null?m[C]:"":m[C],A=f.has(C)?"flagged":"";if(h){const F=M?"number":"text",G=M?' step="0.01" inputmode="decimal"':"",O=$==null?"":String($).replace(/"/g,"&quot;");return`<div class="exc-field-row ${A} editing">
                <label>${escapeHtml(t(k))}</label>
                <input class="exc-field-input" type="${F}"${G} data-edit-key="${escapeHtml(C)}" value="${O}">
            </div>`}const H=M?Xe($):$||"",P=$==null||$===""?`<span class="val empty">${escapeHtml(t("exc-empty-val"))}</span>`:`<span class="val">${escapeHtml(H)}</span>`;return`<div class="exc-field-row ${A}"><label>${escapeHtml(t(k))}</label>${P}</div>`};let y="";u?y=`<div class="exc-drawer-error">${escapeHtml(t("exc-drawer-error"))}</div>`:y=`
        ...
        `;const v=(()=>{if(Y.pdfStatus==="loading"||Y.pdfStatus==="idle")return`
    ...
    `;const E=document.getElementById("exc-fld-edit");E&&E.addEventListener("click",()=>{Y.editing=!0,Y.editFields={...Jn(Y.history)},De()});const B=document.getElementById("exc-fld-cancel");B&&B.addEventListener("click",()=>{Y.editing=!1,Y.editFields=null,De()});const T=document.getElementById("exc-fld-save");T&&T.addEventListener("click",()=>Li()),document.querySelectorAll(".exc-field-input").forEach(C=>{C.addEventListener("input",()=>{Y.editFields||(Y.editFields={}),Y.editFields[C.dataset.editKey]=C.value})});const b=document.getElementById("exc-pdf-retry");b&&Y.openExcId&&b.addEventListener("click",()=>{Y.excRow&&Ra(Y.excRow.history_id,Y.openExcId)});const g=e.status==="pending",x=!!(e.seller_name&&e.seller_name.trim()),I=document.getElementById("exc-btn-resolve"),L=document.getElementById("exc-btn-ignore");I.disabled=!g,L.disabled=!g||!x,L.title=x?t("exc-ignore-hint"):t("exc-ignore-no-seller")}function Ln(){if(Y.pdfUrl){try{URL.revokeObjectURL(Y.pdfUrl)}catch{}Y.pdfUrl=null}Y.pdfStatus="idle"}async function Ra(e,n){Y.pdfStatus="loading",De();try{const a=await fetch("/api/history/"+encodeURIComponent(e)+"/pdf",{headers:{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||"")}});if(Y.openExcId!==n)return;if(a.status===404){Y.pdfStatus="empty",De();return}if(!a.ok)throw new Error("http "+a.status);const o=await a.blob();if(Y.openExcId!==n)return;Ln(),Y.pdfUrl=URL.createObjectURL(o),Y.pdfStatus="ready",De()}catch(a){if(Y.openExcId!==n)return;console.warn("loadDrawerPdf fail",a),Y.pdfStatus="error",De()}}function Bi(e){const n=(J.listCache||[]).find(a=>a.id===e);if(!n){showToast(t("exc-drawer-error"),"error");return}J.listScrollY=window.scrollY||document.documentElement.scrollTop||0,Ln(),Y.editing=!1,Y.editFields=null,Y.openExcId=e,Y.excRow=n,Y.history=null,document.getElementById("exc-drawer-mask").classList.add("show"),document.getElementById("exc-drawer").classList.add("show"),De(),Ii(n.history_id),Ra(n.history_id,e)}function rt(){Ln(),Y.editing=!1,Y.editFields=null,Y.openExcId=null,Y.excRow=null,Y.history=null,document.getElementById("exc-drawer-mask").classList.remove("show"),document.getElementById("exc-drawer").classList.remove("show");const e=J.listScrollY||0;e>0&&requestAnimationFrame(()=>window.scrollTo(0,e))}async function Ii(e){try{const n=await fetch("/api/history/"+encodeURIComponent(e),{headers:{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||"")}});if(!n.ok)throw new Error("http "+n.status);Y.history=await n.json()}catch(n){console.warn("loadHistoryDetail fail",n),Y.history={_err:!0}}Y.excRow&&De()}function Jn(e){if(!e||!e.pages)return{};const n=e.pages,a=n.find(o=>!o.is_duplicate&&!o.is_copy)||n[0];return a&&a.fields||{}}async function Li(){if(!Y.openExcId||!Y.history||!Y.history.pages||Y.loading)return;Y.loading=!0;const e=showToast(t("exc-fld-saving"),"loading",0);try{const n=JSON.parse(JSON.stringify(Y.history.pages||[]));let a=n.findIndex(l=>!l.is_duplicate&&!l.is_copy);a<0&&(a=0),n[a]||(n[a]={fields:{}});const o=n[a].fields||{},s=Y.editFields||{},i=new Set(["subtotal","vat","total_amount"]),r={...o};for(const l in s){let p=s[l];if((p===""||p===void 0)&&(p=null),i.has(l)&&p!==null){const m=parseFloat(p);p=isNaN(m)?null:m}r[l]=p}n[a].fields=r;const c=await fetch("/api/history/"+encodeURIComponent(Y.history.id),{method:"PUT",headers:{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||""),"Content-Type":"application/json"},body:JSON.stringify({pages:n})});if(!c.ok)throw new Error("http "+c.status);e(),showToast(t("exc-fld-save-ok"),"success"),rt(),await ut(),await Ne(),Ae()}catch(n){e(),console.warn("save fields fail",n),showToast(t("exc-fld-save-fail"),"error")}finally{Y.loading=!1}}async function Ci(){if(!(!Y.openExcId||Y.loading)){Y.loading=!0;try{const e=await fetch("/api/exceptions/"+Y.openExcId+"/resolve",{method:"POST",headers:{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||"")}});if(!e.ok)throw new Error("http "+e.status);showToast(t("exc-toast-resolved"),"success"),rt(),await ut(),await Ne(),Ae()}catch(e){console.warn("resolve fail",e),showToast(t("exc-toast-action-fail"),"error")}finally{Y.loading=!1}}}async function Si(){if(!(!Y.openExcId||Y.loading)){Y.loading=!0;try{const e=await fetch("/api/exceptions/"+Y.openExcId+"/ignore",{method:"POST",headers:{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||"")}});if(!e.ok)throw new Error("http "+e.status);showToast(t("exc-toast-ignored"),"success"),rt(),await ut(),await Ne(),Ae()}catch(e){console.warn("ignore fail",e),showToast(t("exc-toast-action-fail"),"error")}finally{Y.loading=!1}}}async function Ae(){try{const e=J.currentClient||"",n="/api/exceptions/stats?status=pending"+(e?"&client_id="+encodeURIComponent(e):""),a=await fetch(n,{headers:{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||"")}});if(!a.ok)return;const o=await a.json(),s=document.getElementById("nav-exc-badge");if(!s)return;const i=parseInt(o.pending||0,10);i>0?(s.textContent=i>99?"99+":String(i),s.style.display=""):s.style.display="none"}catch{}}function Fa(e){document.getElementById("exc-kpi-pending").textContent=e.pending||0,document.getElementById("exc-kpi-high").textContent=e.high_severity||0,document.getElementById("exc-kpi-resolved").textContent=e.resolved||0,document.getElementById("exc-kpi-learned").textContent=e.learned_rules||0;const n=document.getElementById("exc-status-tab-count-pending"),a=document.getElementById("exc-status-tab-count-resolved"),o=document.getElementById("exc-status-tab-count-ignored");n&&(n.textContent=e.pending||0),a&&(a.textContent=e.resolved||0),o&&(o.textContent=e.ignored||0),document.querySelectorAll("#exc-status-tabs .exc-status-tab").forEach(i=>{i.classList.toggle("active",i.dataset.status===(J.currentStatus||"pending"))})}function Cn(e){const n=document.getElementById("exc-chips");if(!n)return;const a=e.by_rule||{},o=["confidence_low","duplicate","amount_missing","math_mismatch","tax_id_format_invalid"];let i=`<button class="exc-chip ${!J.currentRule?"active":""}" data-rule="">
        <span>${escapeHtml(t("exc-chip-all"))}</span>
        <span class="exc-chip-count">${e.pending||0}</span>
    </button>`;for(const r of o){const c=a[r]||0;if(c===0&&J.currentRule!==r)continue;const l=J.currentRule===r;i+=`<button class="exc-chip ${l?"active":""}" data-rule="${escapeHtml(r)}">
            <span>${escapeHtml(t("exc-chip-"+r))}</span>
            <span class="exc-chip-count">${c}</span>
        </button>`}n.innerHTML=i,n.querySelectorAll(".exc-chip").forEach(r=>{r.addEventListener("click",()=>{const c=r.dataset.rule||null;J.currentRule=c,Ne()})})}function Sn(e){const n=document.getElementById("exc-list");if(!n)return;if(!e||e.length===0){n.innerHTML=`<div class="exc-empty">
            ${wi()}
            <div class="exc-empty-title">${escapeHtml(t("exc-empty-title"))}</div>
            <div>${escapeHtml(t("exc-empty-desc"))}</div>
        </div>`,Yn();return}const a='<svg viewBox="0 0 14 14" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M3 7l3 3 5-5"/></svg>',o=(J.currentStatus||"pending")==="pending";n.innerHTML=e.map(s=>{const i=s.severity||"medium",r=t("exc-rule-"+s.rule_code)||s.rule_code,c=s.seller_name&&s.seller_name.trim()?s.seller_name:t("exc-no-seller"),l=s.filename||"—",p=xi(s.invoice_date||s.created_at),m=s.status==="pending",d=J.selectedIds.has(s.id),u=o&&m;return`
            <div class="exc-row sev-${escapeHtml(i)} ${d?"selected":""}" data-exc-id="${escapeHtml(String(s.id))}">
                ...
                <div class="exc-row-sev">${yi(i)}</div>
                ...
                <div class="exc-row-amount">${escapeHtml(ki(s.total_amount))}</div>
            </div>
        `}).join(""),n.querySelectorAll(".exc-row").forEach(s=>{s.addEventListener("click",i=>{if(i.target.closest(".exc-row-check"))return;const r=s.dataset.excId;r&&Bi(parseInt(r,10))})}),n.querySelectorAll(".exc-row-check").forEach(s=>{s.addEventListener("click",i=>{i.stopPropagation();const r=parseInt(s.dataset.checkId,10);r&&(J.selectedIds.has(r)?(J.selectedIds.delete(r),s.classList.remove("checked"),s.closest(".exc-row").classList.remove("selected")):(J.selectedIds.add(r),s.classList.add("checked"),s.closest(".exc-row").classList.add("selected")),Wn())})}),Wn(),Yn()}function Wn(){const e=document.getElementById("exc-batch-bar"),n=document.getElementById("exc-batch-count");if(!e||!n)return;const a=J.selectedIds.size;a===0?e.style.display="none":(e.style.display="",n.textContent=ze("exc-batch-count",{n:a}))}function Yn(){const e=document.getElementById("exc-list-foot"),n=document.getElementById("exc-list-count"),a=document.getElementById("exc-loadmore");if(!e||!n||!a)return;const o=J.listCache.length;if(o===0){e.style.display="none";return}e.style.display="";let s=o;const i=J.statsCache;i&&(J.currentRule?s=(i.by_rule||{})[J.currentRule]||o:s=i.pending||o),J.total=s,n.textContent=ze("exc-list-count",{shown:o,total:s});const r=o<s&&o<500;a.style.display=r?"":"none"}async function ut(){try{if(navigator.onLine===!1)throw new Error("offline");const e=J.currentClient||"",n=J.currentStatus||"pending",a=new URLSearchParams;a.set("status",n),e&&a.set("client_id",e);const o="/api/exceptions/stats?"+a.toString(),s=await fetch(o,{headers:{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||"")}});if(!s.ok)throw new Error("http "+s.status);const i=await s.json();return J.statsCache=i,Fa(i),Cn(i),i}catch(e){return console.warn("loadExceptionsStats fail",e),null}}function Ti(e){const n=document.getElementById("exc-list");if(!n)return;const a=`<svg class="exc-error-icon" viewBox="0 0 36 36" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round">
        <circle cx="18" cy="18" r="14"/>
        ...
        <div class="exc-error">
        ...
        </div>`;const i=document.getElementById("exc-retry-btn");i&&i.addEventListener("click",()=>window.loadExceptionsPage&&window.loadExceptionsPage())}async function Ne(e){e=e||{};const n=!!e.append,a=document.getElementById("exc-list");!n&&a&&J.listCache.length===0&&(a.innerHTML=`<div class="exc-loading">${escapeHtml(t("exc-loading"))}</div>`);const o=new URLSearchParams;o.set("status",J.currentStatus||"pending"),J.currentRule&&o.set("rule_code",J.currentRule),J.currentClient&&o.set("client_id",J.currentClient);const s=n?J.listCache.length:0;o.set("limit",String(J.pageSize)),o.set("offset",String(s));try{if(navigator.onLine===!1)throw new Error("offline");const i=await fetch("/api/exceptions/list?"+o.toString(),{headers:{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||"")}});if(!i.ok)throw new Error("http "+i.status);const c=(await i.json()).items||[];n?J.listCache=J.listCache.concat(c):(J.listCache=c,J.selectedIds.clear()),J.loadFailed=!1,Sn(J.listCache),J.statsCache&&Cn(J.statsCache)}catch(i){console.warn("loadExceptionsList fail",i),J.loadFailed=!0;const r=navigator.onLine===!1||String(i.message||"").includes("offline");n?showToast(t("exc-toast-load-fail"),"error"):(Ti(r),showToast(r?t("exc-offline"):t("exc-toast-load-fail"),"error"))}}async function Mi(){if(!J.loading&&!(J.listCache.length>=500)){J.loading=!0;try{await Ne({append:!0})}finally{J.loading=!1}}}function Tn(){const e=document.getElementById("exc-client-filter");if(!e)return;const n=window._clientsCache||[],a=J.currentClient||"",o=typeof t=="function"?t("history-client-all"):"全部客户";e.innerHTML=`<option value="">${escapeHtml(o)}</option>`+n.map(s=>`<option value="${s.id}">${escapeHtml(s.name)}</option>`).join(""),e.value=a}async function $i(){if(et.batchLoading)return;const e=Array.from(J.selectedIds);if(e.length===0||!await showConfirm(ze("exc-batch-confirm-resolve",{n:e.length})))return;et.batchLoading=!0;const a=showToast(ze("exc-batch-count",{n:e.length})+" …","loading",0);try{const o=await fetch("/api/exceptions/batch",{method:"POST",headers:{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||""),"Content-Type":"application/json"},body:JSON.stringify({ids:e,action:"resolve"})});if(!o.ok)throw new Error("http "+o.status);const s=await o.json();a(),showToast(ze("exc-toast-batch-resolved",{n:s.processed||0}),"success"),J.selectedIds.clear(),await ut(),await Ne(),Ae()}catch(o){a(),console.warn("batch resolve fail",o),showToast(t("exc-toast-batch-fail"),"error")}finally{et.batchLoading=!1}}async function Hi(){if(et.batchLoading)return;const e=Array.from(J.selectedIds);if(e.length===0||!await showConfirm(ze("exc-batch-confirm-ignore",{n:e.length}),{danger:!1}))return;et.batchLoading=!0;const a=showToast(ze("exc-batch-count",{n:e.length})+" …","loading",0);try{const o=await fetch("/api/exceptions/batch",{method:"POST",headers:{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||""),"Content-Type":"application/json"},body:JSON.stringify({ids:e,action:"ignore"})});if(!o.ok)throw new Error("http "+o.status);const s=await o.json();a(),showToast(ze("exc-toast-batch-ignored",{n:s.processed||0,wl:s.whitelist_added||0}),"success"),J.selectedIds.clear(),await ut(),await Ne(),Ae()}catch(o){a(),console.warn("batch ignore fail",o),showToast(t("exc-toast-batch-fail"),"error")}finally{et.batchLoading=!1}}function Ai(){J.selectedIds.clear(),Sn(J.listCache)}async function za(){const e=document.getElementById("learned-list");if(e){e.innerHTML=`<div class="learned-empty">${escapeHtml(t("set-learned-loading"))}</div>`;try{const n=await fetch("/api/exception-whitelist",{headers:{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||"")}});if(!n.ok)throw new Error("http "+n.status);const o=(await n.json()).items||[];if(o.length===0){e.innerHTML=`<div class="learned-empty">${escapeHtml(t("set-learned-empty"))}</div>`;return}const s=`<svg viewBox="0 0 14 14" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round">
            <path d="M3 4h8M5.5 4V2.5h3V4M4 4l0.6 8.5h4.8L10 4"/>
                ...
                <div class="learned-row" data-wl-id="${escapeHtml(String(i.id))}">
                    ...
                    <div class="learned-date">${escapeHtml(_i(i.created_at))}</div>
                    <button class="learned-del-btn" data-del-wl="${escapeHtml(String(i.id))}" title="${escapeHtml(t("set-learned-del"))}" type="button">${s}</button>
                </div>
            `}).join("")}catch(n){console.warn("loadLearnedRules fail",n),e.innerHTML=`<div class="learned-empty">${escapeHtml(t("exc-toast-load-fail"))}</div>`}}}window.loadExceptionsPage=async function(){if(!J.loading){J.loading=!0;try{Tn(),typeof window.loadErpExceptions=="function"&&window.loadErpExceptions(),await ut(),await Ne()}finally{J.loading=!1}}};window.refreshExcBadge=Ae;window._refreshExcClientFilter=Tn;window._excState=J;window._rerenderExceptions=function(){try{Tn()}catch{}J.statsCache&&(Fa(J.statsCache),Cn(J.statsCache)),J.listCache&&J.listCache.length&&Sn(J.listCache);try{window._erpExcState&&window._erpExcState.items&&window._erpExcState.items.length&&typeof window._rerenderErpExceptions=="function"&&window._rerenderErpExceptions()}catch{}Y.openExcId&&De()};document.addEventListener("click",e=>{e.target.closest("#exc-drawer-close")&&rt(),e.target.closest("#exc-drawer-mask")&&rt(),e.target.closest("#exc-btn-resolve")&&Ci(),e.target.closest("#exc-btn-ignore")&&Si(),e.target.closest("#exc-batch-resolve")&&$i(),e.target.closest("#exc-batch-ignore")&&Hi(),e.target.closest("#exc-batch-clear")&&Ai(),e.target.closest("#exc-loadmore")&&Mi()});document.addEventListener("keydown",e=>{e.key==="Escape"&&Y.openExcId&&rt()});document.addEventListener("click",e=>{e.target.closest("#btn-exc-refresh")&&(typeof window.loadExceptionsPage=="function"&&window.loadExceptionsPage(),Ae())});document.addEventListener("change",e=>{if(!e.target.closest("#exc-client-filter"))return;const n=e.target;J.currentClient=n.value||"",J.currentRule=null,J.selectedIds.clear(),J.listCache=[],typeof window.loadExceptionsPage=="function"&&window.loadExceptionsPage(),Ae()});document.addEventListener("click",e=>{const n=e.target.closest("#exc-status-tabs .exc-status-tab");if(!n)return;const a=n.dataset.status||"pending";a!==J.currentStatus&&(J.currentStatus=a,J.currentRule=null,J.selectedIds.clear(),J.listCache=[],typeof window.loadExceptionsPage=="function"&&window.loadExceptionsPage())});window.addEventListener("online",()=>{J.loadFailed&&document.getElementById("page-exceptions")?.classList.contains("show")&&window.loadExceptionsPage&&window.loadExceptionsPage()});setTimeout(Ae,1500);setInterval(Ae,6e4);window.loadLearnedRules=za;document.addEventListener("click",async e=>{const n=e.target.closest("[data-del-wl]");if(!n)return;const a=parseInt(n.dataset.delWl,10);if(!a)return;const o=n.closest(".learned-row"),s=o&&o.querySelector(".learned-seller"),i=s?s.textContent.trim():"",r=t("set-learned-del-confirm").replace("{seller}",i);if(await showConfirm(r,{danger:!0}))try{const l=await fetch("/api/exception-whitelist/"+a,{method:"DELETE",headers:{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||"")}});if(!l.ok)throw new Error("http "+l.status);showToast(t("set-learned-del-ok"),"success"),za(),typeof window.loadExceptionsPage=="function"&&document.getElementById("page-exceptions")?.classList.contains("show")&&window.loadExceptionsPage()}catch(l){console.warn("delete whitelist fail",l),showToast(t("set-learned-del-fail"),"error")}});(function(){let e={items:[],q:"",cat:"",adapter:"",selected:new Set,total:0,categories:{},pageSize:30,loading:!1,focusSearch:!1,searchCaret:0},n=null;function a(){return localStorage.getItem("mrpilot_token")||""}function o(d){const u=typeof currentLang=="string"&&currentLang||window._currentLang||"th",f=d.error_friendly&&d.error_friendly[u];if(f)return f;if(typeof humanizeError=="function"&&d.error_msg)try{return humanizeError(d.error_msg)}catch{}return t("erp-exc-reason-"+(d.category||"other"))}function s(){const d=document.getElementById("erp-exc-batch");if(!d)return;const u=e.selected.size;d.hidden=u===0;const f=d.querySelector(".erp-exc-batch-count");f&&(f.textContent=String(u))}function i(){const d=document.getElementById("erp-exc-block");if(!d)return;const u=e;if(!(u.total>0||!!u.q||!!u.cat)){d.hidden=!0,d.innerHTML="";return}d.hidden=!1;const h=u.categories||{},_=Object.keys(h).reduce((H,P)=>H+h[P],0);let w=`<button class="erp-exc-chip ${u.cat===""?"active":""}" data-erpexc-cat=""><span>${escapeHtml(t("erp-exc-cat-all"))}</span><span class="erp-exc-chip-count">${_}</span></button>`;Object.keys(h).forEach(H=>{w+=`<button class="erp-exc-chip ${u.cat===H?"active":""}" data-erpexc-cat="${escapeHtml(H)}"><span>${escapeHtml(t("erp-exc-cat-"+H))}</span><span class="erp-exc-chip-count">${h[H]}</span></button>`});const y=u.items||[],v=y.length>0&&y.every(H=>u.selected.has(H.id)),E=y.map(H=>{const P=H.state==="needs_action"?"needs":H.state==="retrying"?"retry":"fail",F=t("erp-exc-state-"+(H.state||"failed")),G=o(H),O=u.selected.has(H.id)?"checked":"",ee=H.push_type==="id_card",de=ee?`<span class="erp-exc-type-idcard">${escapeHtml(t("erp-log-type-idcard"))}</span> `:"",me=ee?`<span class="ex-inv" title="${escapeHtml(t("erp-log-col-booking"))}">${de}${escapeHtml(H.invoice_no||"—")}</span>`:`<span class="ex-inv" title="${escapeHtml(H.invoice_no||"")}">${escapeHtml(H.invoice_no||"—")}</span>`,ue=ee?`<span class="ex-seller" title="${escapeHtml(t("erp-log-col-customer"))}">${escapeHtml(H.seller_name||"—")}</span>`:`<span class="ex-seller" title="${escapeHtml(H.seller_name||"")}">${escapeHtml(H.seller_name||"—")}</span>`,re=ee?`<span class="ex-buyer" title="${escapeHtml(t("erp-log-col-idcard"))}">${H.id_card_tail?"••••"+escapeHtml(H.id_card_tail):"—"}</span>`:`<span class="ex-buyer" title="${escapeHtml(H.ocr_buyer_name||"")}">${escapeHtml(H.ocr_buyer_name||"—")}</span>`;return`<div class="erp-exc-row" data-erpexc-id="${escapeHtml(H.id)}">
                <span class="ex-cb"><input type="checkbox" class="erp-exc-cb" data-erpexc-cb="${escapeHtml(H.id)}" ${O}></span>
                ${me}
                ${ue}
                ${re}
                <span class="ex-state"><span class="erp-exc-state ${P}">${escapeHtml(F)}</span></span>
                <span class="ex-reason" title="${escapeHtml(G)}">${escapeHtml(G)}${H.error_code?` <span class="erp-exc-code">${escapeHtml(H.error_code)}</span>`:""}</span>
            ...
            </div>`}).join(""),B=y.length===0?`<div class="erp-exc-empty">${escapeHtml(t("erp-exc-empty"))}</div>`:"",T=y.length<u.total?`<button class="erp-exc-more" type="button" id="erp-exc-more">${escapeHtml(t("erp-exc-load-more"))} (${y.length}/${u.total})</button>`:u.total>0?`<div class="erp-exc-count">${escapeHtml(t("erp-exc-shown",{n:y.length,total:u.total}))}</div>`:"",S=u.adapter==="mrerp_dms",b=Array.isArray(window._erpEndpoints)?window._erpEndpoints:[],g=new Set;let x=`<option value="">${escapeHtml(t("erp-logs-erp-all"))}</option>`;b.forEach(H=>{const P=(H&&H.adapter||"").toLowerCase();!P||g.has(P)||(g.add(P),x+=`<option value="${escapeHtml(P)}"${P===u.adapter?" selected":""}>${escapeHtml(H&&H.name||P)}</option>`)});const I=S?t("erp-log-col-booking"):t("erp-exc-f-invoice"),L=S?t("erp-log-col-customer"):t("erp-exc-f-seller"),C=S?t("erp-log-col-idcard"):t("erp-exc-f-buyer");d.innerHTML=`
            ...
            <div class="erp-exc-rows">
                <div class="erp-exc-row erp-exc-row-head">
                    ...
                    <span class="ex-inv">${escapeHtml(I)}</span>
                    <span class="ex-seller">${escapeHtml(L)}</span>
            ...
            <div class="erp-exc-foot">${T}</div>`;const k=document.getElementById("erp-exc-search");if(k){if(u.focusSearch){k.focus();try{k.setSelectionRange(u.searchCaret,u.searchCaret)}catch{}}k.addEventListener("input",()=>{u.q=k.value,u.focusSearch=!0,u.searchCaret=k.selectionStart||k.value.length,clearTimeout(n),n=setTimeout(()=>l(!1),350)}),k.addEventListener("blur",()=>{u.focusSearch=!1})}d.querySelectorAll(".erp-exc-chip").forEach(H=>{H.addEventListener("click",()=>{u.cat=H.dataset.erpexcCat||"",l(!1)})});const M=document.getElementById("erp-exc-erp-select");M&&M.addEventListener("change",()=>{u.adapter=M.value||"",l(!1)}),d.querySelectorAll("[data-erpexc-retry]").forEach(H=>{H.addEventListener("click",P=>{P.stopPropagation(),r(H.dataset.erpexcRetry,H)})}),d.querySelectorAll(".erp-exc-cb").forEach(H=>{H.addEventListener("change",()=>{const P=H.dataset.erpexcCb;H.checked?u.selected.add(P):u.selected.delete(P);const F=document.getElementById("erp-exc-cb-all");F&&(F.checked=y.length>0&&y.every(G=>u.selected.has(G.id))),s()})});const $=document.getElementById("erp-exc-cb-all");$&&$.addEventListener("change",()=>{y.forEach(H=>{$.checked?u.selected.add(H.id):u.selected.delete(H.id)}),d.querySelectorAll(".erp-exc-cb").forEach(H=>{H.checked=$.checked}),s()}),d.querySelectorAll("[data-erpexc-batch]").forEach(H=>{H.addEventListener("click",()=>c(H.dataset.erpexcBatch))});const A=document.getElementById("erp-exc-more");A&&A.addEventListener("click",()=>l(!0)),d.querySelectorAll(".erp-exc-row:not(.erp-exc-row-head)").forEach(H=>{H.addEventListener("click",P=>{P.target.closest("input,button")||typeof window._erpExcOpenEdit=="function"&&window._erpExcOpenEdit(H.dataset.erpexcId)})})}async function r(d,u){if(d){u&&(u.disabled=!0,u.textContent=t("erp-exc-retrying"));try{const f=await fetch("/api/erp/logs/"+encodeURIComponent(d)+"/retry",{method:"POST",headers:{Authorization:"Bearer "+a()}}),h=await f.json().catch(()=>({}));showToast(f.ok&&h.ok?t("erp-exc-retry-ok"):t("erp-exc-retry-fail"),f.ok&&h.ok?"success":"error")}catch{showToast(t("erp-exc-retry-fail"),"error")}if(e.selected.delete(d),l(!1),typeof window.refreshExcBadge=="function")try{window.refreshExcBadge()}catch{}}}async function c(d){const u=Array.from(e.selected);if(d==="clear"){e.selected.clear(),i();return}if(u.length!==0){if(d==="delete"){if(!await showConfirm(t("erp-exc-batch-delete-confirm",{n:u.length}),{danger:!0}))return;try{const h=await fetch("/api/erp/logs/batch-delete",{method:"POST",headers:{Authorization:"Bearer "+a(),"Content-Type":"application/json"},body:JSON.stringify({log_ids:u.slice(0,200)})}),_=await h.json().catch(()=>({}));showToast(h.ok?t("erp-exc-batch-delete-ok",{n:_.deleted||0}):t("erp-exc-retry-fail"),h.ok?"success":"error")}catch{showToast(t("erp-exc-retry-fail"),"error")}}else if(d==="retry")try{const f=await fetch("/api/erp/logs/batch-retry",{method:"POST",headers:{Authorization:"Bearer "+a(),"Content-Type":"application/json"},body:JSON.stringify({log_ids:u.slice(0,50)})}),h=await f.json().catch(()=>({}));showToast(f.ok?t("erp-exc-batch-retry-ok",{ok:h.succeeded||0,fail:(h.failed||0)+(h.skipped||0)}):t("erp-exc-retry-fail"),f.ok?"success":"error")}catch{showToast(t("erp-exc-retry-fail"),"error")}if(e.selected.clear(),l(!1),typeof window.refreshExcBadge=="function")try{window.refreshExcBadge()}catch{}}}async function l(d){const u=document.getElementById("erp-exc-block");if(!(!u||e.loading)){e.loading=!0;try{if(!Array.isArray(window._erpEndpoints)||!window._erpEndpoints.length)try{const y=await fetch("/api/erp/endpoints",{headers:{Authorization:"Bearer "+a()}});if(y.ok){const v=await y.json();window._erpEndpoints=v&&(v.items||v)||[]}}catch{}const f=new URLSearchParams;e.q&&f.set("q",e.q),e.cat&&f.set("category",e.cat),e.adapter&&f.set("adapter",e.adapter),f.set("limit",String(e.pageSize)),f.set("offset",String(d?e.items.length:0));const h=await fetch("/api/erp/exceptions?"+f.toString(),{headers:{Authorization:"Bearer "+a()}});if(!h.ok){d||(u.hidden=!0);return}const _=await h.json(),w=_.items||[];e.items=d?e.items.concat(w):w,e.total=_.total||0,e.categories=_.categories||{},i()}catch{d||(u.hidden=!0)}finally{e.loading=!1}}}let p={};function m(){const d=document.getElementById("erp-exc-modal");d&&d.remove()}window._erpExcOpenEdit=function(d){const u=(e.items||[]).find(T=>String(T.id)===String(d));if(!u)return;const f=u.push_type==="id_card",h=!!u.history_client_id&&u.category==="customer_mismatch",_=u.category==="product_mismatch"&&!!u.history_id&&!!u.endpoint_id,w=o(u),y=u.state==="needs_action"?"needs":u.state==="retrying"?"retry":"fail",v=(T,S)=>`<div class="erp-exc-m-row"><span class="erp-exc-m-k">${escapeHtml(T)}</span><span class="erp-exc-m-v">${escapeHtml(S||"—")}</span></div>`;let E="";if(h)E=`
                ...
                </div>`;else{const T="erp-exc-edit-hint-"+(u.category||"other");let S=t(T);(!S||S===T)&&(S=w),E=`<div class="erp-exc-m-hint">${escapeHtml(S)}</div>`}const B=document.createElement("div");if(B.id="erp-exc-modal",B.className="erp-exc-modal-overlay",B.innerHTML=`
            <div class="erp-exc-modal" role="dialog" aria-modal="true">
                ...
                <div class="erp-exc-m-body">
                    <div class="erp-exc-m-reason"><span class="erp-exc-state ${y}">${escapeHtml(t("erp-exc-state-"+(u.state||"failed")))}</span> ${escapeHtml(w)}${u.error_code&&!f?` <span class="erp-exc-code">${escapeHtml(u.error_code)}</span>`:""}</div>
                ...
                <div class="erp-exc-m-foot">
            ...
            </div>`,document.body.appendChild(B),B.addEventListener("click",T=>{T.target===B&&m()}),document.getElementById("erp-exc-m-close").addEventListener("click",m),document.getElementById("erp-exc-m-cancel").addEventListener("click",m),document.getElementById("erp-exc-m-retry").addEventListener("click",()=>{m(),r(u.id,null)}),h){let T="";const S=document.getElementById("erp-exc-m-bind"),b=document.getElementById("erp-exc-m-custlist"),g=document.getElementById("erp-exc-m-search"),x=(L,C)=>{const k=(C||"").trim().toLowerCase(),M=k?L.filter($=>($.code||"").toLowerCase().includes(k)||($.name||"").toLowerCase().includes(k)):L;if(M.length===0){b.innerHTML=`<div class="erp-exc-m-empty">${escapeHtml(t("erp-exc-edit-pick-empty"))}</div>`;return}b.innerHTML=M.slice(0,100).map($=>`<div class="erp-exc-m-cust" data-cust-code="${escapeHtml($.code||"")}">
                        <span class="erp-exc-m-cust-name">${escapeHtml($.name||"")}</span>
                        <span class="erp-exc-m-cust-code">${escapeHtml($.code||"")}</span>
                    </div>`).join(""),b.querySelectorAll(".erp-exc-m-cust").forEach($=>{$.addEventListener("click",()=>{T=$.dataset.custCode||"",b.querySelectorAll(".erp-exc-m-cust").forEach(A=>A.classList.remove("sel")),$.classList.add("sel"),S&&(S.disabled=!T)})})},I=async()=>{const L=u.endpoint_id;if(p[L]){x(p[L],"");return}try{const C=await fetch("/api/erp/endpoints/"+encodeURIComponent(L)+"/customers",{headers:{Authorization:"Bearer "+a()}}),k=await C.json().catch(()=>({}));if(!C.ok||!k.ok){b.innerHTML=`<div class="erp-exc-m-empty">${escapeHtml(t("erp-exc-edit-pick-fail"))}</div>`;return}const M=k.customers||[];p[L]=M,x(M,"")}catch{b.innerHTML=`<div class="erp-exc-m-empty">${escapeHtml(t("erp-exc-edit-pick-fail"))}</div>`}};g&&g.addEventListener("input",()=>x(p[u.endpoint_id]||[],g.value)),I(),S&&S.addEventListener("click",async()=>{if(T){S.disabled=!0,S.textContent=t("erp-exc-retrying");try{if(!(await fetch("/api/erp/mappings/clients",{method:"POST",headers:{Authorization:"Bearer "+a(),"Content-Type":"application/json"},body:JSON.stringify({client_id:u.history_client_id,erp_type:u.endpoint_adapter,erp_code:T})})).ok){showToast(t("erp-exc-retry-fail"),"error"),S.disabled=!1,S.textContent=t("erp-exc-edit-bind-retry");return}showToast(t("erp-exc-edit-bound-ok"),"success"),m(),await r(u.id,null)}catch{showToast(t("erp-exc-retry-fail"),"error"),S.disabled=!1,S.textContent=t("erp-exc-edit-bind-retry")}}})}if(_){const T=document.getElementById("erp-exc-m-bind-prod"),S=document.getElementById("erp-exc-m-prodlist"),b={};let g=[];const x=()=>'<option value="">'+escapeHtml(t("erp-exc-edit-prod-choose"))+"</option>"+g.slice(0,500).map(C=>`<option value="${escapeHtml(C.code||"")}" data-pname="${escapeHtml(C.name||"")}">`+escapeHtml((C.name||"")+" · "+(C.code||""))+"</option>").join(""),I=C=>{if(!C.length){S.innerHTML=`<div class="erp-exc-m-empty">${escapeHtml(t("erp-exc-edit-prod-noitems"))}</div>`;return}S.innerHTML=C.map(k=>`<div class="erp-exc-m-cust" style="cursor:default">
                    ...
                    </div>`).join(""),S.querySelectorAll(".erp-exc-m-prod-sel").forEach(k=>{k.addEventListener("change",()=>{const M=k.dataset.item,$=k.options[k.selectedIndex];k.value?b[M]={code:k.value,name:$&&$.dataset.pname||""}:delete b[M],T&&(T.disabled=Object.keys(b).length===0)})})};(async()=>{try{const k=await(await fetch("/api/history/"+encodeURIComponent(u.history_id),{headers:{Authorization:"Bearer "+a()}})).json().catch(()=>({})),M=k&&k.pages||[],$=[],A={};(Array.isArray(M)?M:[]).forEach(F=>{const G=F&&F.fields&&F.fields.items||[];(Array.isArray(G)?G:[]).forEach(O=>{const ee=(O&&(O.name||O.description)||"").trim();ee&&!A[ee]&&(A[ee]=1,$.push(ee))})});const H=await fetch("/api/erp/endpoints/"+encodeURIComponent(u.endpoint_id)+"/products",{headers:{Authorization:"Bearer "+a()}}),P=await H.json().catch(()=>({}));if(!H.ok||!P.ok){S.innerHTML=`<div class="erp-exc-m-empty">${escapeHtml(t("erp-exc-edit-prod-fail"))}</div>`;return}g=P.products||[],I($)}catch{S.innerHTML=`<div class="erp-exc-m-empty">${escapeHtml(t("erp-exc-edit-prod-fail"))}</div>`}})(),T&&T.addEventListener("click",async()=>{const C=Object.entries(b);if(C.length){T.disabled=!0,T.textContent=t("erp-exc-retrying");try{for(const[k,M]of C)if(!(await fetch("/api/erp/mappings/products",{method:"POST",headers:{Authorization:"Bearer "+a(),"Content-Type":"application/json"},body:JSON.stringify({erp_type:u.endpoint_adapter,item_name:k,erp_code:M.code,erp_name:M.name})})).ok){showToast(t("erp-exc-retry-fail"),"error"),T.disabled=!1,T.textContent=t("erp-exc-edit-bind-prod-retry");return}showToast(t("erp-exc-edit-prod-bound-ok"),"success"),m(),await r(u.id,null)}catch{showToast(t("erp-exc-retry-fail"),"error"),T.disabled=!1,T.textContent=t("erp-exc-edit-bind-prod-retry")}}})}},window._rerenderErpExceptions=i,window.loadErpExceptions=l,window._erpExcState=e})();const ji=`
    <div class="cmdk">
...
`;we("cmdk-mask",ji);(function(){function e(d){try{if(location.search.indexOf("test_center=1")>=0||localStorage.getItem("pearnly_test_mode")==="1"||d&&d.id&&String(d.id)==="468b50c1-5593-4fd6-990d-515ce8085563")return!0}catch{}return!1}window.applyRoleVisibility=function(){var u=window._userInfo,f=!1,h=!0,_=!1,w=!1;u&&(f=typeof canManageTeam=="function"?canManageTeam(u):!!(u.role==="owner"||u.is_super_admin),h=typeof shouldHideMoney=="function"?shouldHideMoney(u):u.role==="member"&&!u.is_super_admin,_=typeof isSuperAdmin=="function"?isSuperAdmin(u):!!u.is_super_admin,w=e(u)),document.querySelectorAll("[data-show-if-team]").forEach(function(v){v.style.display=f?"":"none"}),document.querySelectorAll("[data-show-if-money]").forEach(function(v){v.style.display=h?"none":""}),document.querySelectorAll("[data-show-if-admin]").forEach(function(v){v.style.display=_?"":"none"}),document.querySelectorAll("[data-show-if-test]").forEach(function(v){v.style.display=w?"":"none"});var y=_||w;document.querySelectorAll("[data-show-if-special]").forEach(function(v){v.style.display=y?"":"none"})},window.renderAvatarMenu=function(u){if(u){var f=document.getElementById("avatar-btn"),h=document.getElementById("avatar-popup-name"),_=document.getElementById("avatar-popup-email");if(!(!f||!h||!_)){var w=(u.username||"").trim(),y=w.split("@")[0]||w||"—",v=(w.charAt(0)||"?").toUpperCase(),E=(u.avatar_url||"").trim();if(E){var B=E.replace(/"/g,"&quot;"),T=v.replace(/'/g,"\\'");f.innerHTML='<img src="'+B+'" alt="'+v+`" referrerpolicy="no-referrer" onerror="this.parentNode.textContent='`+T+`'">`}else f.textContent=v;h.textContent=y,_.textContent=w||"—",f.setAttribute("title",w||"")}}};function n(){var d=document.getElementById("avatar-wrap"),u=document.getElementById("avatar-btn"),f=document.getElementById("avatar-popup");if(!d||!u||!f)return;function h(){f.classList.remove("show"),u.setAttribute("aria-expanded","false")}function _(){f.classList.add("show"),u.setAttribute("aria-expanded","true")}u.addEventListener("click",function(w){w.stopPropagation(),f.classList.contains("show")?h():_()}),document.addEventListener("click",function(w){f.classList.contains("show")&&!d.contains(w.target)&&h()}),f.addEventListener("click",function(w){var y=w.target.closest(".avatar-popup-item");if(y){var v=y.dataset.action;switch(h(),v){case"settings":typeof openSettingsModal=="function"?openSettingsModal():typeof routeTo=="function"&&routeTo("settings");break;case"team":typeof openSettingsModal=="function"?openSettingsModal():typeof routeTo=="function"&&routeTo("settings"),setTimeout(function(){typeof switchSettingsTab=="function"&&switchSettingsTab("team")},50);break;case"billing":typeof openSettingsModal=="function"?openSettingsModal():typeof routeTo=="function"&&routeTo("settings"),setTimeout(function(){typeof switchSettingsTab=="function"&&switchSettingsTab("plan")},50);break;case"shortcuts":if(typeof showToast=="function"){var E=typeof t=="function"?t("feature-coming-soon"):"即将上线";showToast(E||"即将上线","info")}break;case"admin":window.location.href="/admin/cost";break;case"test-center":typeof routeTo=="function"&&routeTo("test-center");break;case"help":var B=document.getElementById("help-modal");B&&(B.style.display="flex");break;case"logout":try{localStorage.removeItem("mrpilot_token")}catch{}try{localStorage.removeItem("mrpilot_user")}catch{}window.location.href="/";break}}}),window._closeAvatarPopup=h}function a(){return[].slice.call(document.querySelectorAll(".cmdk-item")).filter(function(d){return d.style.display!=="none"})}function o(d){var u=a();u.forEach(function(f){f.classList.remove("focus")}),u[d]&&(u[d].classList.add("focus"),u[d].scrollIntoView({block:"nearest"}))}function s(d){var u=a();if(u.length){var f=u.findIndex(function(_){return _.classList.contains("focus")});f<0&&(f=0);var h=(f+d+u.length)%u.length;o(h)}}function i(d){d=(d||"").toLowerCase().trim();var u=0,f=window._userInfo,h=typeof isSuperAdmin=="function"?isSuperAdmin(f):!!(f&&f.is_super_admin),_=e(f);document.querySelectorAll(".cmdk-item").forEach(function(y){if(y.dataset.showIfAdmin==="1"&&!h){y.style.display="none";return}if(y.dataset.showIfTest==="1"&&!_){y.style.display="none";return}var v=(y.dataset.cmdkText||y.textContent||"").toLowerCase(),E=!d||v.indexOf(d)>=0;y.style.display=E?"":"none",y.classList.remove("focus"),E&&u++}),document.querySelectorAll("[data-cmdk-section]").forEach(function(y){for(var v=y.nextElementSibling,E=!1;v&&!v.hasAttribute("data-cmdk-section");){if(v.classList&&v.classList.contains("cmdk-item")&&v.style.display!=="none"){E=!0;break}v=v.nextElementSibling}y.style.display=E?"":"none"});var w=document.getElementById("cmdk-empty");w&&(w.style.display=u===0?"flex":"none"),o(0)}window.openCmdk=function(){var u=document.getElementById("cmdk-mask");u&&(typeof window._closeAvatarPopup=="function"&&window._closeAvatarPopup(),u.classList.add("show"),typeof window.applyRoleVisibility=="function"&&window.applyRoleVisibility(),setTimeout(function(){var f=document.getElementById("cmdk-input");f&&(f.value="",i(""),f.focus(),o(0))},50))},window.closeCmdk=function(){var u=document.getElementById("cmdk-mask");u&&u.classList.remove("show")};function r(d){if(d){if(d.classList.contains("cmdk-item-locked")){if(typeof showToast=="function"){var u=typeof t=="function"?t("feature-coming-soon"):"即将上线";showToast(u||"即将上线","info")}return}var f=d.dataset.cmdkRoute,h=d.dataset.cmdkAction;if(window.closeCmdk(),f){typeof routeTo=="function"&&routeTo(f);return}if(h){if(h==="open-admin"){window.location.href="/admin/cost";return}if(h.indexOf("lang-")===0){var _=h.slice(5);typeof applyLang=="function"&&applyLang(_)}}}}function c(){var d=document.getElementById("cmdk-mask"),u=document.getElementById("cmdk-input"),f=document.getElementById("cmdk-body");if(!(!d||!u||!f)){d.addEventListener("click",function(w){w.target===d&&window.closeCmdk()});var h=document.getElementById("cmdk-esc-btn");h&&h.addEventListener("click",function(){window.closeCmdk()}),u.addEventListener("input",function(w){i(w.target.value)}),u.addEventListener("keydown",function(w){w.key==="ArrowDown"?(w.preventDefault(),s(1)):w.key==="ArrowUp"?(w.preventDefault(),s(-1)):w.key==="Enter"?(w.preventDefault(),r(d.querySelector(".cmdk-item.focus"))):w.key==="Escape"&&(w.preventDefault(),window.closeCmdk())}),f.addEventListener("click",function(w){var y=w.target.closest(".cmdk-item");y&&r(y)}),f.addEventListener("mousemove",function(w){var y=w.target.closest(".cmdk-item");!y||y.style.display==="none"||y.classList.contains("cmdk-item-locked")||(a().forEach(function(v){v.classList.remove("focus")}),y.classList.add("focus"))});var _=document.getElementById("topbar-search");_&&(_.addEventListener("click",function(){window.openCmdk()}),_.addEventListener("keydown",function(w){(w.key==="Enter"||w.key===" ")&&(w.preventDefault(),window.openCmdk())}))}}document.addEventListener("keydown",function(d){if((d.metaKey||d.ctrlKey)&&(d.key==="k"||d.key==="K")){d.preventDefault(),window.openCmdk();return}if(d.key==="Escape"){var u=document.getElementById("cmdk-mask");if(u&&u.classList.contains("show")){window.closeCmdk();return}var f=document.getElementById("avatar-popup");f&&f.classList.contains("show")&&typeof window._closeAvatarPopup=="function"&&window._closeAvatarPopup()}});try{var l=(navigator.userAgent||"").toLowerCase(),p=l.indexOf("mac")>=0||l.indexOf("iphone")>=0||l.indexOf("ipad")>=0;p||document.body.classList.add("is-windows")}catch{}function m(){n(),c(),typeof window.subscribeI18n=="function"&&window.subscribeI18n("nav-ia-phase1-role",function(){try{typeof window.applyRoleVisibility=="function"&&window.applyRoleVisibility()}catch{}})}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",m):m()})();(function(){function n(h){return String(h??"").replace(/[&<>"']/g,function(_){return{"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"}[_]})}function a(h){if(!h||isNaN(h))return"";var _=Number(h);return _<1024?_+" B":_<1024*1024?(_/1024).toFixed(1)+" KB":(_/1024/1024).toFixed(1)+" MB"}document.addEventListener("click",function(h){var _=h.target.closest&&h.target.closest(".recon-collapse-head");if(_&&!(h.target.closest("button")||h.target.closest("a"))){var w=_.closest(".recon-collapse");if(w){var y=w.getAttribute("data-collapsed")==="true";w.setAttribute("data-collapsed",y?"false":"true"),y&&(w.id==="vex-summary-collapse"&&m(),w.id==="vex-detail-collapse"&&d())}}}),document.addEventListener("keydown",function(h){if(!(h.key!=="Enter"&&h.key!==" ")){var _=h.target.closest&&h.target.closest(".recon-collapse-head");_&&(h.preventDefault(),_.click())}});var o={vat:"",gl:""};window._glvClearPreviewSearch=function(){o.vat="",o.gl=""};var s='<svg class="vex-pp-fi-icon" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#111111" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/></svg>',i='<svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg>';function r(){l("vat"),l("gl")}function c(h){try{if(typeof window._glvPreviewFiles=="function")return window._glvPreviewFiles(h)||[]}catch{}var _=document.getElementById(h==="vat"?"glv-vat-input":"glv-gl-input");return _&&_.files?Array.from(_.files):[]}function l(h){var _=document.getElementById(h==="vat"?"glv-pp-vat-col":"glv-pp-gl-col");if(_){var w=c(h),y=h==="vat"?"glv-up-vat-title":"glv-up-gl-title",v=h==="vat"?"① 销项税报告":"② 总账 GL",E=window.t&&window.t(y)||v,B=n(window.t&&window.t("vex-preview-search")||"搜索文件名..."),T=n(window.t&&window.t("vex-preview-clear-all")||"全清"),S=o[h]||"",b=w.length;_.innerHTML='<div class="vex-pp-col-title"><span class="vex-pp-col-name">'+n(E)+' <span class="vex-pp-col-count">'+b+'</span></span></div><div class="vex-pp-search-row"><input class="vex-pp-search" id="glv-pp-search-'+h+'" type="text" placeholder="'+B+'" value="'+n(S)+'" autocomplete="off"><button class="vex-pp-clear-btn" id="glv-pp-clearall-'+h+'" type="button">'+T+'</button></div><div class="vex-pp-file-list" id="glv-pp-'+h+'-list"></div><div class="vex-pp-pagination" id="glv-pp-'+h+'-pg"></div>';var g=document.getElementById("glv-pp-search-"+h);g&&g.addEventListener("input",function(I){o[h]=I.target.value,p(h)});var x=document.getElementById("glv-pp-clearall-"+h);x&&x.addEventListener("click",function(){window._glvRemoveFile&&window._glvRemoveFile(h)}),p(h)}}function p(h){var _=document.getElementById("glv-pp-"+h+"-list"),w=document.getElementById("glv-pp-"+h+"-pg");if(_){var y=c(h),v=(o[h]||"").toLowerCase(),E=y.map(function(S,b){return{f:S,i:b}}),B=v?E.filter(function(S){return S.f.name.toLowerCase().indexOf(v)>=0}):E;if(_.innerHTML=B.map(function(S){var b=S.f;return'<div class="vex-pp-file-row">'+s+'<span class="vex-pp-fi-name" title="'+n(b.name)+'">'+n(b.name)+'</span><span class="vex-pp-fi-size">'+a(b.size)+'</span><button class="vex-pp-fi-del" type="button" data-kind="'+h+'" data-idx="'+S.i+'" aria-label="remove">'+i+"</button></div>"}).join(""),_.querySelectorAll(".vex-pp-fi-del").forEach(function(S){S.addEventListener("click",function(){var b=S.dataset.kind,g=parseInt(S.dataset.idx,10);window._glvRemoveFile&&window._glvRemoveFile(b,isNaN(g)?null:g)})}),w){var T=window.t&&window.t("vex-preview-count")||"显示前 {n} / 共 {m}";w.textContent=T.replace("{n}",B.length).replace("{m}",B.length)}}}function m(){var h=function(w,y){var v=document.getElementById(w);v&&(v.textContent=y==null?"—":String(y))},_=window._vexLastTask||{};h("vex-sum-total",_.total),h("vex-sum-matched",_.matched),h("vex-sum-diff",_.diff),h("vex-sum-incomplete",_.incomplete),h("vex-sum-cash",_.cash),document.getElementById("vex-summary-sub")}function d(){var h=window._vexLastTask&&window._vexLastTask.diff_rows||[],_=document.getElementById("vex-detail-tbody"),w=document.getElementById("vex-detail-table"),y=document.getElementById("vex-detail-empty");if(!(!_||!w||!y)){if(h.length===0){w.style.display="none",y.style.display="";return}y.style.display="none",w.style.display="";var v=h.map(function(B){return'<tr><td class="recon-detail-cell-mono">'+n(B.invoice_no||"")+"</td><td>"+n(B.field||"")+"</td><td>"+n(B.report_value||"")+"</td><td>"+n(B.invoice_value||"")+"</td><td>"+n(B.kind||"")+"</td></tr>"}).join("");_.innerHTML=v;var E=document.getElementById("vex-detail-sub");E&&(E.textContent=String(h.length))}}function u(){var h=document.getElementById("glv-toggle-preview");h&&!h._reconBound&&(h._reconBound=!0,h.addEventListener("click",function(){var _=document.getElementById("glv-preview-panel"),w=document.getElementById("glv-toggle-preview-label"),y=_&&_.style.display!=="none";_&&(_.style.display=y?"none":""),h.classList.toggle("open",!y),w&&(w.textContent=y?window.t&&window.t("vex-toggle-preview-open")||"查看清单":window.t&&window.t("vex-toggle-preview-close")||"收起清单"),y||r()})),["glv-vat-input","glv-gl-input"].forEach(function(_){var w=document.getElementById(_);!w||w._reconWatched||(w._reconWatched=!0,w.addEventListener("change",function(){var y=document.getElementById("glv-preview-panel");y&&y.style.display!=="none"&&r()}))})}function f(){var h=document.getElementById("vex-summary-collapse"),_=document.getElementById("vex-detail-collapse");h&&(h.style.display=""),_&&(_.style.display=""),m(),d()}window._fillVexSummary=m,window._fillVexDetail=d,window._onVexResultShown=f,document.addEventListener("DOMContentLoaded",function(){u()}),setTimeout(u,1500),typeof window.subscribeI18n=="function"&&window.subscribeI18n("recon-collapse",function(){var h=document.getElementById("glv-preview-panel");h&&h.style.display!=="none"&&r();var _=document.getElementById("glv-toggle-preview-label"),w=document.getElementById("glv-toggle-preview");_&&w&&(_.textContent=w.classList.contains("open")?window.t&&window.t("vex-toggle-preview-close")||"收起清单":window.t&&window.t("vex-toggle-preview-open")||"查看清单")}),window._reconCollapse={renderGlvPreview:r,fillVexSummary:m,fillVexDetail:d}})();(function(){function e(i){}function n(){const i=document.querySelectorAll("[data-recon-tab]");i.forEach(c=>{c.addEventListener("click",()=>{i.forEach(u=>u.classList.remove("active")),c.classList.add("active");const l=c.dataset.reconTab,p=document.getElementById("recon-pane-bank"),m=document.getElementById("recon-pane-sale-vat"),d=document.getElementById("recon-pane-gl-vat");p&&(p.style.display=l==="bank"?"":"none"),m&&(m.style.display=l==="sale-vat"?"":"none"),d&&(d.style.display=l==="gl-vat"?"":"none"),l==="gl-vat"&&window.GlVatRecon&&window.GlVatRecon.ensureInit(),l==="bank"&&typeof window._bankReconV2Init=="function"&&window._bankReconV2Init()})});const r=document.querySelector("[data-recon-tab].active");r&&(r.dataset.reconTab,void 0)}function a(){const i=document.getElementById("page-settings");if(!i)return null;let r=document.getElementById("settings-modal-overlay");if(r)return r;r=document.createElement("div"),r.id="settings-modal-overlay",r.className="settings-modal-overlay",r.style.display="none",i.parentElement.insertBefore(r,i),r.appendChild(i);const c=document.createElement("button");return c.id="settings-modal-close",c.className="settings-modal-close",c.setAttribute("aria-label","close"),c.innerHTML='<svg viewBox="0 0 20 20" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M5 5l10 10M15 5L5 15"/></svg>',i.insertBefore(c,i.firstChild),c.addEventListener("click",s),r.addEventListener("click",l=>{l.target===r&&s()}),r}function o(){const i=a();if(!i)return;i.style.display="flex",document.body.classList.add("settings-modal-open");const r=document.getElementById("page-settings");r&&(r.style.display="block"),setTimeout(()=>{try{typeof renderSettings=="function"&&renderSettings()}catch(l){console.warn("renderSettings:",l)}let c=document.querySelector(".settings-tab.active")||document.querySelector('.settings-tab[data-tab="profile"]');c&&c.click()},50)}function s(){const i=document.getElementById("settings-modal-overlay");i&&(i.style.display="none"),document.body.classList.remove("settings-modal-open")}window.openSettingsModal=o,window.closeSettingsModal=s,document.addEventListener("keydown",i=>{if(i.key==="Escape"){const r=document.getElementById("settings-modal-overlay");r&&r.style.display==="flex"&&s()}}),window.addEventListener("hashchange",()=>{location.hash==="#/settings"&&o()}),window.addEventListener("DOMContentLoaded",()=>{location.hash==="#/settings"&&o()}),document.readyState==="loading"?document.addEventListener("DOMContentLoaded",n):n()})();(function(){const a=/\.(pdf|jpe?g|png|webp|tiff?|xlsx?|xlsm|csv|tsv|docx?)$/i,o=D=>document.getElementById(D);function s(){return{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||"")}}function i(D){return String(D??"").replace(/[&<>"']/g,z=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[z])}function r(D){return D<1024?D+" B":D<1024*1024?(D/1024).toFixed(1)+" KB":(D/1024/1024).toFixed(1)+" MB"}let c=[],l=[],p=!1,m=[],d=50,u=50,f="",h="";async function _(){try{const D=await fetch("/api/vat_excel/tasks?page=1&page_size=1",{headers:s()});if(!D.ok)return;const X=(await D.json()).kpi||{};[["vex-kpi-month-val",X.this_month],["vex-kpi-running-val",X.running],["vex-kpi-done-val",X.done],["vex-kpi-failed-val",X.failed]].forEach(([Q,Z])=>{const oe=document.getElementById(Q);oe&&(oe.textContent=Z??0)})}catch{}}async function w(){try{const D=await fetch("/api/vat_excel/tasks?page=1&page_size=100",{headers:s()});if(!D.ok)return;const z=await D.json();B(z.rows||[])}catch{}}const y=10;var v=1;function E(){var D=((document.getElementById("vex-task-search")||{}).value||"").trim().toLowerCase();if(v=1,B(m),!!D){var z=document.getElementById("vex-task-tbody");z&&z.querySelectorAll("tr").forEach(function(X){X.dataset.taskId&&(X.style.display=X.textContent.toLowerCase().indexOf(D)>=0?"":"none")})}}function B(D){m=D||m;const z=document.getElementById("vex-task-tbody");if(!z)return;if(!m.length){z.innerHTML='<tr><td colspan="9" class="vex-task-empty">'+(t("sv-empty-title")||"还没有对账任务")+"</td></tr>",T(0);return}const X=Math.ceil(m.length/y);v>X&&(v=X);const Q=(v-1)*y;S(m.slice(Q,Q+y)),T(m.length)}function T(D){const z=document.getElementById("vex-task-pager"),X=document.getElementById("vex-task-pager-info"),Q=document.getElementById("vex-task-prev"),Z=document.getElementById("vex-task-next");if(!z)return;if(D<=y){z.style.display="none";return}z.style.display="";const oe=Math.ceil(D/y);X&&(X.textContent=v+" / "+oe),Q&&(Q.disabled=v<=1),Z&&(Z.disabled=v>=oe)}function S(D){const z=document.getElementById("vex-task-tbody");if(!z)return;const X={pending:t("vex-status-pending")||"待处理",running:t("vex-status-running")||"处理中",done:t("vex-status-done")||"已完成",failed:t("vex-status-failed")||"失败"},Q={pending:"badge-gray",running:"badge-blue",done:"badge-green",failed:"badge-red"},Z='<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M8 2v9M4 7l4 4 4-4M3 14h10"/></svg>',oe='<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M3 4h10M6 4V3h4v1M5 4v8a1 1 0 001 1h4a1 1 0 001-1V4"/></svg>';z.innerHTML=D.map(j=>{const R=j.created_at?new Date(j.created_at).toLocaleString([],{year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",minute:"2-digit"}):"—",q=j.period||"—",K=j.matched_count!=null?j.matched_count+" ✓ · "+j.mismatched_count+" ⚠":"—",V=j.mismatch_amount!=null?"฿ "+Number(j.mismatch_amount).toLocaleString():"—",ae=j.elapsed_seconds!=null?j.elapsed_seconds.toFixed(1)+" s":"—",ce=j.status||"pending",be=j.client_name&&j.client_name!=="client"?j.client_name:t("vex-client-all")||"全部客户";return`<tr class="vex-task-row" data-task-id="${i(j.id)}" style="cursor:pointer">
                <td>${R}</td>
                <td>${i(be)}</td>
                <td>${i(q)}</td>
                <td>${(j.invoice_count||0)+" / "+(j.report_count||0)}</td>
                <td>${K}</td>
                <td>${V}</td>
                <td><span class="badge ${Q[ce]||"badge-gray"}">${X[ce]||ce}</span></td>
                <td>${ae}</td>
                <td><div class="vex-task-actions">
                    <button class="vex-task-dl-btn" data-task-id="${i(j.id)}" title="${t("hist_export")||"导出"}">${Z}</button>
                    <button class="vex-task-del-btn" data-task-id="${i(j.id)}" title="${t("vex-task-delete-confirm-title")||"删除"}">${oe}</button>
                </div></td>
            </tr>`}).join(""),z.querySelectorAll(".vex-task-dl-btn").forEach(j=>{j.addEventListener("click",async R=>{R.stopPropagation();const q=j.dataset.taskId;try{const K=await fetch("/api/vat_excel/tasks/"+encodeURIComponent(q)+"/download",{credentials:"include",headers:s()});if(K.status===410){showToast(t("vex-toast-expired")||"数据已过期 · 请重新对账","warn");return}if(!K.ok){showToast(t("vex-toast-dl-fail")||"下载失败 · 请重试","error");return}const V=await K.blob(),ce=(K.headers.get("Content-Disposition")||"").match(/filename\*?=(?:UTF-8''|")?([^";]+)/i),be=ce?decodeURIComponent(ce[1]):"vat_recon_"+q+".xlsx",Se=URL.createObjectURL(V),Oe=document.createElement("a");Oe.href=Se,Oe.download=be,Oe.click(),setTimeout(()=>URL.revokeObjectURL(Se),1e3)}catch{showToast(t("vex-toast-dl-fail")||"下载失败 · 请重试","error")}})}),z.querySelectorAll(".vex-task-del-btn").forEach(j=>{j.addEventListener("click",R=>{R.stopPropagation(),g(j.dataset.taskId)})}),E()}function b(){var D=document.getElementById("vex-task-prev"),z=document.getElementById("vex-task-next");D&&!D._vexBound&&(D._vexBound=!0,D.addEventListener("click",function(){v>1&&(v--,B())})),z&&!z._vexBound&&(z._vexBound=!0,z.addEventListener("click",function(){var X=Math.ceil(m.length/y);v<X&&(v++,B())}))}async function g(D){const z=t("vex-task-delete-confirm-title")||"删除对账任务?",X=t("vex-task-delete-confirm-body")||"同时清掉对应的发票识别缓存 · 不可恢复";if(await showConfirm(X,{title:z,danger:!0,okText:t("vex-task-delete-confirm-title")||"确认删除"}))try{const Z=await fetch("/api/vat_excel/tasks/"+encodeURIComponent(D),{method:"DELETE",credentials:"include",headers:s()});if(!Z.ok)throw new Error(Z.status);showToast(t("vex-task-delete-ok")||"已删除","success"),w(),_()}catch{showToast(t("vex-task-delete-fail")||"删除失败","error")}}function x(D){const z=window._currentLang||"th",X={zh:`已忽略 ${D} 个不支持的文件 · 仅支持 PDF / 图片 / Excel / CSV / Word`,th:`ข้ามไฟล์ที่ไม่รองรับ ${D} ไฟล์ · รองรับเฉพาะ PDF / รูปภาพ / Excel / CSV / Word`,en:`Ignored ${D} unsupported file(s) · only PDF / image / Excel / CSV / Word are supported`,ja:`非対応ファイル ${D} 件をスキップ · 対応形式は PDF / 画像 / Excel / CSV / Word のみ`};showToast(X[z]||X.th,"warn")}function I(D){const z=new Set(c.map(Q=>Q.name+"|"+Q.size));let X=0;for(const Q of D){if(!a.test(Q.name)){X++;continue}const Z=Q.name+"|"+Q.size;if(!z.has(Z)&&(z.add(Z),c.push(Q),c.length>=1e3))break}X>0&&x(X),c.length>1e3&&(c=c.slice(0,1e3),showToast(t("vex-toast-cap-inv"),"warn")),M()}function L(D){const z=new Set(l.map(Q=>Q.name+"|"+Q.size));let X=0;for(const Q of D){if(!a.test(Q.name)){X++;continue}const Z=Q.name+"|"+Q.size;if(!z.has(Z)&&(z.add(Z),l.push(Q),l.length>=30))break}X>0&&x(X),l.length>30&&(l=l.slice(0,30),showToast(t("vex-toast-cap-rep"),"warn")),M()}function C(D){c.splice(D,1),M()}function k(D){l.splice(D,1),M()}function M(){const D=o("vex-list-invoice"),z=o("vex-list-report"),X=o("vex-count-invoice"),Q=o("vex-count-report");X&&(X.textContent=c.length),Q&&(Q.textContent=l.length);const Z=(R,q,K)=>`<div class="vex-fi">
            ...
            <span class="vex-fi-n" title="${i(R.name)}">${i(R.name)}</span>
            <span class="vex-fi-s">${r(R.size)}</span>
            <button class="vex-fi-x" type="button" data-vex-kind="${K}" data-vex-idx="${q}" aria-label="remove">×</button>
        </div>`;D&&(D.innerHTML=c.map((R,q)=>Z(R,q,"inv")).join("")||'<div class="vex-fi-empty" data-i18n="vex-no-files">还没文件</div>'),z&&(z.innerHTML=l.map((R,q)=>Z(R,q,"rep")).join("")||'<div class="vex-fi-empty" data-i18n="vex-no-files">还没文件</div>'),document.querySelectorAll(".vex-fi-x").forEach(R=>{R.addEventListener("click",q=>{const K=R.dataset.vexKind,V=parseInt(R.dataset.vexIdx,10);K==="inv"?C(V):k(V)})});const oe=c.length>0&&l.length>0;o("vex-build").disabled=!oe||p;const j=o("vex-action-info");j&&(!c.length||!l.length?(j.textContent=t("vex-need-both")||"需要至少 1 张发票 + 1 份 VAT 报告",j.className="vex-action-info muted"):(j.textContent=(t("vex-ready")||"已就绪 · {a} 张发票 · {b} 份报告").replace("{a}",c.length).replace("{b}",l.length),j.className="vex-action-info ok")),P()}const $='<svg class="vex-pp-fi-icon" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#6B7280" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path><polyline points="14 2 14 8 20 8"></polyline></svg>',A='<svg class="vex-pp-fi-icon" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#111111" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="4" width="18" height="18" rx="2" ry="2"></rect><line x1="16" y1="2" x2="16" y2="6"></line><line x1="8" y1="2" x2="8" y2="6"></line><line x1="3" y1="10" x2="21" y2="10"></line></svg>',H='<svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg>';function P(){const D=o("vex-preview-panel");if(!D||D.style.display==="none")return;F("inv"),F("rep");const z=o("vex-pp-guide");z&&(z.style.display=c.length>100?"flex":"none")}function F(D){const z=o(D==="inv"?"vex-pp-invoice-col":"vex-pp-report-col");if(!z)return;const X=D==="inv"?c:l,Q=D==="inv"?f:h,Z=t(D==="inv"?"vex-preview-invoice":"vex-preview-report")||(D==="inv"?"销售发票":"VAT 报告"),oe=i(t("vex-preview-search")||"搜索文件名..."),j=i(t("vex-preview-clear-all")||"全清");z.innerHTML=`
            <div class="vex-pp-col-title">
                <span class="vex-pp-col-name">${i(Z)} <span class="vex-pp-col-count">${X.length}</span></span>
            </div>
            <div class="vex-pp-search-row">
                <input class="vex-pp-search" id="vex-pp-search-${D}" type="text"
                       placeholder="${oe}" value="${i(Q)}" autocomplete="off">
                <button class="vex-pp-clear-btn" id="vex-pp-clearall-${D}" type="button">${j}</button>
            </div>
            <div class="vex-pp-file-list" id="vex-pp-${D}-list"></div>
            <div class="vex-pp-pagination" id="vex-pp-${D}-pg"></div>`;const R=o("vex-pp-search-"+D);R&&R.addEventListener("input",K=>{D==="inv"?(f=K.target.value,d=50):(h=K.target.value,u=50),G(D)});const q=o("vex-pp-clearall-"+D);q&&q.addEventListener("click",()=>{D==="inv"?(c=[],f="",d=50):(l=[],h="",u=50),M()}),G(D)}function G(D){const z=o("vex-pp-"+D+"-list"),X=o("vex-pp-"+D+"-pg");if(!z)return;const Q=D==="inv"?c:l,Z=D==="inv"?f:h,oe=D==="inv"?d:u,j=D==="inv"?$:A,R=Q.map((V,ae)=>({f:V,i:ae})),q=Z?R.filter(({f:V})=>V.name.toLowerCase().includes(Z.toLowerCase())):R,K=q.slice(0,oe);if(z.innerHTML=K.map(({f:V,i:ae})=>`
            <div class="vex-pp-file-row">
                ${j}
                <span class="vex-pp-fi-name" title="${i(V.name)}">${i(V.name)}</span>
                <span class="vex-pp-fi-size">${r(V.size)}</span>
                <button class="vex-pp-fi-del" type="button" data-kind="${D}" data-ridx="${ae}" aria-label="remove">${H}</button>
            </div>`).join("")+`<div id="vex-pp-sentinel-${D}" style="height:1px;flex-shrink:0"></div>`,z.querySelectorAll(".vex-pp-fi-del").forEach(V=>{V.addEventListener("click",()=>{const ae=parseInt(V.dataset.ridx,10);V.dataset.kind==="inv"?C(ae):k(ae)})}),X){const V=t("vex-preview-count")||"显示前 {n} / 共 {m}";X.textContent=V.replace("{n}",K.length).replace("{m}",q.length)}O(D,q.length)}function O(D,z){if((D==="inv"?d:u)>=z)return;const Q=o("vex-pp-sentinel-"+D),Z=o("vex-pp-"+D+"-list");if(!Q||!Z)return;const oe=new IntersectionObserver(j=>{j[0].isIntersecting&&(oe.disconnect(),D==="inv"?d+=50:u+=50,G(D))},{root:Z,threshold:.8});oe.observe(Q)}function ee(D,z,X,Q){const Z=o(D),oe=o(z);!Z||!oe||(Z.addEventListener("click",()=>oe.click()),Z.addEventListener("keydown",j=>{(j.key==="Enter"||j.key===" ")&&(j.preventDefault(),oe.click())}),Z.addEventListener("dragover",j=>{j.preventDefault(),Z.classList.add("drag-over")}),Z.addEventListener("dragleave",()=>Z.classList.remove("drag-over")),Z.addEventListener("drop",j=>{j.preventDefault(),Z.classList.remove("drag-over");const q=Array.from(j.dataTransfer.files).filter(K=>a.test(K.name));if(!q.length){showToast(t("vex-toast-bad-ext"),"error");return}X(q)}),oe.addEventListener("change",()=>{const j=Array.from(oe.files);X(j),oe.value=""}))}async function de(){if(p||!c.length||!l.length)return;p=!0,o("vex-build").disabled=!0,o("vex-progress").style.display="flex";var D=document.getElementById("vex-download");D&&(D.style.display="none"),["vex-summary-collapse","vex-detail-collapse"].forEach(function(Z){var oe=document.getElementById(Z);oe&&(oe.style.display="none")});const z=Date.now();o("vex-progress-title").textContent=t("vex-progress-running")||"AI 抽取中",o("vex-progress-sub").textContent=(t("vex-progress-sub")||"{a} 张发票 + {b} 份报告 · 并行处理").replace("{a}",c.length).replace("{b}",l.length);const X=setInterval(()=>{const Z=Math.floor((Date.now()-z)/1e3);o("vex-progress-sub").textContent=(t("vex-progress-elapsed")||"已 {s} 秒 · {a} 张发票 + {b} 份报告").replace("{s}",Z).replace("{a}",c.length).replace("{b}",l.length)},1e3);try{const Z=new FormData;for(const ke of c)Z.append("invoices",ke);for(const ke of l)Z.append("reports",ke);const oe=typeof currentLang=="string"&&currentLang||localStorage.getItem("mrpilot_lang")||"th";Z.append("lang",oe);const j=localStorage.getItem("mrpilot_token")||"",R=await fetch("/api/vat_excel/submit",{method:"POST",headers:s(),body:Z});let q=null;try{q=await R.json()}catch{q=null}if(!R.ok||!q||!q.ok||!q.job_id)throw clearInterval(X),new Error(q&&q.detail||"HTTP "+R.status);const K=o("vex-progress-sub"),V=await window._reconPollJob(q.job_id,j,{onProgress:ke=>{K&&(K.textContent=window._reconProgressText(ke,oe))}});if(clearInterval(X),!V||V.status!=="done"||!V.result_id)throw new Error(t("vex-toast-fail")||"生成失败");const ae=V.result_id;let ce=0;const be=await fetch("/api/vat_excel/tasks/"+encodeURIComponent(ae)+"/download",{headers:s()});if(!be.ok)throw new Error("HTTP "+be.status);const Oe=(be.headers.get("Content-Disposition")||"").match(/filename="([^"]+)"/),Pn=Oe&&Oe[1]||"vat_recon_"+Date.now()+".xlsx",so=await be.blob(),Dn=URL.createObjectURL(so),qn=o("vex-download");qn.href=Dn,qn.download=Pn;try{const ke=document.createElement("a");ke.href=Dn,ke.download=Pn,document.body.appendChild(ke),ke.click(),setTimeout(()=>ke.remove(),100)}catch{}o("vex-progress").style.display="none";var Q=document.getElementById("vex-download");Q&&(Q.style.display=""),ae&&(ce=await re(ae)),window._onVexResultShown&&window._onVexResultShown(),ce>0?showToast((t("vex-toast-some-fail")||"有 {n} 张发票 OCR 失败").replace("{n}",ce),"warn"):showToast(t("vex-toast-done")||"Excel 已生成","success"),_(),setTimeout(w,800)}catch(Z){clearInterval(X),o("vex-progress").style.display="none";const oe=(t("vex-toast-fail")||"生成失败")+": "+(Z.message||Z);showToast(oe,"error")}finally{p=!1,o("vex-build").disabled=!1}}function me(){c=[],l=[];var D=document.getElementById("vex-download");D&&(D.style.display="none"),M()}function ue(D){if(D==null)return"—";var z=parseFloat(D);return isNaN(z)?"—":z.toLocaleString("th-TH",{minimumFractionDigits:2,maximumFractionDigits:2})}async function re(D){try{var z=await fetch("/api/vat_excel/tasks/"+encodeURIComponent(D),{headers:s()});if(!z.ok)throw new Error(z.status);var X=await z.json(),Q=X.raw_data_json;if(typeof Q=="string")try{Q=JSON.parse(Q)}catch{Q={}}Q=Q||{};var Z=Q.rows||[],oe=[];Z.forEach(function(q){q.kind==="invoice_orphan"?oe.push({invoice_no:q.invoice_no||"",field:"仅发票有",report_value:"—",invoice_value:ue(q.amount_inv),kind:q.kind}):q.kind==="report_orphan"?oe.push({invoice_no:q.invoice_no||"",field:"仅报告有",report_value:ue(q.amount_rep),invoice_value:"—",kind:q.kind}):q.dims&&Object.keys(q.dims).length>0&&Object.keys(q.dims).forEach(function(K){var V=String(q.dims[K]||""),ae=V.split(" ≠ ");oe.push({invoice_no:q.invoice_no||"",field:K,report_value:ae[0]||V,invoice_value:ae.length>1?ae[1]:"—",kind:"diff"})})});var j=Z.filter(function(q){return q.kind==="matched_cash"}).length,R=Math.max(0,parseInt(Q.invoice_ocr_failed_count||0,10));return window._vexLastTask={total:Q.n_total||0,matched:Q.n_ok||0,diff:Q.n_diff||0,incomplete:R,cash:j,diff_rows:oe,task_id:D},window._fillVexSummary&&window._fillVexSummary(),window._fillVexDetail&&window._fillVexDetail(),R}catch{return 0}}function ve(){const D=document.getElementById("vex-pane");D&&D.querySelectorAll("[data-i18n]").forEach(z=>{const X=t(z.dataset.i18n);X&&(z.textContent=X)}),M(),w()}function he(){ee("vex-drop-invoice","vex-input-invoice",I),ee("vex-drop-report","vex-input-report",L);const D=o("vex-build"),z=o("vex-reset");D&&D.addEventListener("click",de),z&&z.addEventListener("click",me),document.querySelectorAll('[data-recon-tab="sale-vat"]').forEach(Z=>{Z.addEventListener("click",()=>{_(),w()})}),b();const X=document.getElementById("vex-task-search");X&&X.addEventListener("input",E);const Q=document.getElementById("vex-toggle-preview");Q&&Q.addEventListener("click",()=>{const Z=o("vex-preview-panel"),oe=o("vex-toggle-preview-label"),j=Z&&Z.style.display!=="none";Z&&(Z.style.display=j?"none":""),Q&&Q.classList.toggle("open",!j),oe&&(oe.textContent=j?t("vex-toggle-preview-open")||"查看清单":t("vex-toggle-preview-close")||"收起清单"),j||P()}),M(),_()}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",he):he(),typeof window.subscribeI18n=="function"&&(window.subscribeI18n("vex-excel",ve),window.subscribeI18n("vex-preview-panel",P))})();const se={inited:!1,glFile:[],vatFile:[],running:!1,currentTaskId:null,lastDetail:[],lastSummary:null},ne=e=>document.getElementById(e),Na=()=>localStorage.getItem("mrpilot_token")||"",lt=()=>typeof window.currentLang=="string"&&window.currentLang?window.currentLang:localStorage.getItem("mrpilot_lang")||"th",We=()=>({Authorization:"Bearer "+Na()}),Xn={th:{not_found:"ไม่พบข้อมูล",running:"กำลังกระทบยอด…",error:"เกิดข้อผิดพลาด",need_files:"กรุณาเลือกไฟล์ทั้งสอง",done:"เสร็จสิ้น",hint_need_both:"อัปโหลด ① รายงานภาษีขาย + ② GL",hint_need_one_more:"อัปโหลดอีก 1 ไฟล์",hint_ready:"พร้อมแล้ว · กดเริ่มกระทบยอด",hist_load:"โหลด",hist_export:"ส่งออก",hist_delete:"ลบ",confirm_delete:"ยืนยันการลบงานนี้?",s_gl_total:"ยอดรวมตามบัญชีแยกประเภท",s_minus_gl_cr:"หัก : รายการเครดิตที่ไม่มีในรายงานภาษีขาย",s_plus_gl_dr:"บวก : รายการเดบิตที่ไม่มีในรายงานภาษีขาย",s_plus_vat_p:"บวก : รายการยอดขายที่ไม่มีในบัญชีแยกประเภท",s_minus_vat_n:"หัก : รายการลดหนี้ที่ไม่มีในบัญชีแยกประเภท",s_vat_total:"ยอดรวมตามรายงานภาษีขาย"},zh:{not_found:"未找到数据",running:"正在对账中...",error:"出错了",need_files:"请先选择两个文件",done:"完成",hint_need_both:"请上传① 销项税报告 + ② 总账 GL",hint_need_one_more:"还需上传 1 份文件",hint_ready:"已就绪 · 点击开始对账",hist_load:"加载",hist_export:"导出",hist_delete:"删除",confirm_delete:"确认删除此任务？",s_gl_total:"总账金额合计",s_minus_gl_cr:"减：销项税报告中未列的贷方记录",s_plus_gl_dr:"加：销项税报告中未列的借方记录",s_plus_vat_p:"加：总账中未列的销售记录",s_minus_vat_n:"减：总账中未列的贷项凭单(credit note)记录",s_vat_total:"销项税报告金额合计"},en:{not_found:"Not found",running:"Reconciling...",error:"Error",need_files:"Please select both files",done:"Done",hint_need_both:"Upload ① Output VAT report + ② GL file",hint_need_one_more:"1 more file required",hint_ready:"Ready · click Run to start",hist_load:"Load",hist_export:"Export",hist_delete:"Delete",confirm_delete:"Delete this task?",s_gl_total:"Total per General Ledger",s_minus_gl_cr:"Less: GL credits not in VAT Report",s_plus_gl_dr:"Add: GL debits not in VAT Report",s_plus_vat_p:"Add: Sales in VAT Report not in GL",s_minus_vat_n:"Less: Credit notes in VAT Report not in GL",s_vat_total:"Total per VAT Sales Report"},ja:{not_found:"データなし",running:"照合中…",error:"エラー",need_files:"両方のファイルを選択してください",done:"完了",hint_need_both:"① 売上税報告 + ② GL をアップロード",hint_need_one_more:"あと 1 ファイル必要",hint_ready:"準備完了 · 「開始」をクリック",hist_load:"読込",hist_export:"出力",hist_delete:"削除",confirm_delete:"このタスクを削除しますか?",s_gl_total:"総勘定元帳合計",s_minus_gl_cr:"減：売上税報告にないGL貸方記録",s_plus_gl_dr:"加：売上税報告にないGL借方記録",s_plus_vat_p:"加：GLにない売上記録",s_minus_vat_n:"減：GLにない赤伝記録",s_vat_total:"売上税報告合計"}},fe=e=>(Xn[lt()]||Xn.th)[e]||e;function Pi(e){const n=lt(),o={gl_no_revenue_rows:{zh:"GL 中未找到收入科目行。请确认「收入科目前缀」是否正确(收入科目通常以 4 开头),改对后重试。",th:"ไม่พบรายการบัญชีรายได้ใน GL · ตรวจสอบ «คำนำหน้าบัญชีรายได้» (รายได้มักขึ้นต้นด้วย 4) แล้วลองใหม่",en:"No revenue-account rows found in the GL. Check the “revenue account prefix” (revenue usually starts with 4) and retry.",ja:"GL に収益科目の行が見つかりません。「収益科目プレフィックス」(通常 4 で始まる)を確認して再試行してください。"},gl_parse_failed:{zh:"GL 文件解析失败。请确认文件含日期/科目/借贷列,或换清晰的 Excel/CSV 重传。",th:"อ่านไฟล์ GL ไม่สำเร็จ · ตรวจสอบว่ามีคอลัมน์ วันที่/บัญชี/เดบิต-เครดิต หรืออัปโหลด Excel/CSV ที่ชัดเจน",en:"Failed to parse the GL file. Ensure it has date/account/debit-credit columns, or re-upload a clean Excel/CSV.",ja:"GL ファイルの解析に失敗しました。日付/科目/借方貸方列を確認するか、Excel/CSV を再アップロードしてください。"},vat_no_rows:{zh:"销项税报告里没有可对账的数据行。请确认上传了正确的销项税报告。",th:"ไม่พบแถวข้อมูลในรายงานภาษีขาย · ตรวจสอบว่าอัปโหลดรายงานที่ถูกต้อง",en:"No rows found in the sales-VAT report. Please check you uploaded the correct report.",ja:"売上VATレポートに行が見つかりません。正しいレポートをアップロードしたか確認してください。"},vat_parse_failed:{zh:"销项税报告解析失败。请换更清晰的版本,或转成 Excel/PDF 重传。",th:"อ่านรายงานภาษีขายไม่สำเร็จ · ลองเวอร์ชันที่ชัดเจนกว่า หรือแปลงเป็น Excel/PDF",en:"Failed to parse the sales-VAT report. Try a clearer version, or convert to Excel/PDF.",ja:"売上VATレポートの解析に失敗しました。より鮮明な版か、Excel/PDF に変換してください。"}}[e];return o?o[n]||o.th||o.en:fe("error")||"Error"}const xt=e=>e==null||isNaN(e)?"":Number(e).toLocaleString("en-US",{minimumFractionDigits:2,maximumFractionDigits:2});function Mn(e){ne("glv-kpi-matched")&&(ne("glv-kpi-matched").textContent=e&&e.matched!=null?e.matched:"—"),ne("glv-kpi-diff")&&(ne("glv-kpi-diff").textContent=e&&e.diff!=null?e.diff:"—"),ne("glv-kpi-unmatched")&&(ne("glv-kpi-unmatched").textContent=e&&e.unmatched!=null?e.unmatched:"—")}function Di(e){if(!e)return"";try{const n=new Date(e);if(isNaN(n.getTime()))return e;const a=o=>String(o).padStart(2,"0");return n.getFullYear()+"-"+a(n.getMonth()+1)+"-"+a(n.getDate())+" "+a(n.getHours())+":"+a(n.getMinutes())}catch{return e}}function Zn(e,n,a,o){const s=ne(e),i=ne(n),r=ne(a);if(!s||!i||!r)return;const c=l=>{if(!l||!l.length)return;const p=Array.isArray(se[o])?se[o].slice():[],m=new Set(p.map(d=>d.name+"|"+d.size));for(const d of l){if(!d)continue;const u=d.name+"|"+d.size;m.has(u)||(p.push(d),m.add(u))}se[o]=p,Oa(r,p),Lt(),St(),window._reconCollapse&&window._reconCollapse.renderGlvPreview&&window._reconCollapse.renderGlvPreview()};s.addEventListener("click",()=>i.click()),s.addEventListener("keydown",l=>{(l.key==="Enter"||l.key===" ")&&(l.preventDefault(),i.click())}),i.addEventListener("change",()=>{c(Array.from(i.files||[])),i.value=""}),s.addEventListener("dragover",l=>{l.preventDefault(),s.classList.add("drag-over")}),s.addEventListener("dragleave",()=>s.classList.remove("drag-over")),s.addEventListener("drop",l=>{l.preventDefault(),s.classList.remove("drag-over");const p=l.dataTransfer&&l.dataTransfer.files?Array.from(l.dataTransfer.files):[];c(p)})}function Oa(e,n){if(!e)return;if(!n||n.length===0){e.textContent="";return}const a=n.reduce((o,s)=>o+Math.round(s.size/1024),0);if(n.length===1)e.textContent=n[0].name+"  ("+a+" KB)";else{const o=window.t&&window.t("glv-files-count")||"{n} 个文件";e.textContent=o.replace("{n}",n.length)+"  ("+a+" KB)"}}function Fe(e){const n=se[e];return Array.isArray(n)?n:n?[n]:[]}function Lt(){const e=ne("btn-glv-run");if(!e)return;const n=Fe("glFile").length>0&&Fe("vatFile").length>0;e.disabled=!n||se.running}function St(){const e=ne("glv-status");if(!e||se.running)return;const n=Fe("vatFile").length,a=Fe("glFile").length;n===0&&a===0?(e.className="vex-action-info muted",e.innerHTML="<span>"+fe("hint_need_both")+"</span>"):n>0&&a>0?(e.className="vex-action-info ok",e.innerHTML="<span>"+fe("hint_ready")+"</span>"):(e.className="vex-action-info muted",e.innerHTML="<span>"+fe("hint_need_one_more")+"</span>")}function qi(e,n){const a=e==="vat"?"vatFile":"glFile",o=e==="vat"?"glv-vat-input":"glv-gl-input",s=e==="vat"?"glv-vat-name":"glv-gl-name",i=Fe(a);n==null?se[a]=[]:se[a]=i.filter((c,l)=>l!==n);const r=ne(o);r&&(r.value=""),Oa(ne(s),Fe(a)),Lt(),St(),window._reconCollapse&&window._reconCollapse.renderGlvPreview&&window._reconCollapse.renderGlvPreview()}function Ri(){se.glFile=[],se.vatFile=[],se.currentTaskId=null,se.lastDetail=[],se.lastSummary=null;const e=ne("glv-vat-input");e&&(e.value="");const n=ne("glv-gl-input");n&&(n.value="");const a=ne("glv-vat-name");a&&(a.textContent="");const o=ne("glv-gl-name");o&&(o.textContent="");const s=ne("glv-result");s&&(s.style.display="none");const i=ne("glv-kpi-strip");i&&(i.style.display="none"),Lt(),St(),window._glvClearPreviewSearch&&window._glvClearPreviewSearch(),window._reconCollapse&&window._reconCollapse.renderGlvPreview&&window._reconCollapse.renderGlvPreview()}function $n(e){const n=ne("glv-tbody");if(!n)return;Ni(e.length),n.innerHTML="";const a=fe("not_found"),o=document.createDocumentFragment();e.forEach(s=>{const i=document.createElement("tr"),r=(d,u)=>{const f=document.createElement("td");return u&&(f.className=u),f.textContent=d,f},c=s.gl_amount===null||s.gl_amount===void 0,l=s.diff;let p="glv-num",m="glv-num";c?(m+=" glv-cell-missing",p+=" glv-cell-missing"):Math.abs(l||0)<.005?p+=" glv-cell-ok":p+=" glv-cell-diff",i.appendChild(r(s.doc_no||"","glv-doc")),i.appendChild(r(s.date||"","")),i.appendChild(r(s.customer_name||"","")),i.appendChild(r(xt(s.vat_amount),"glv-num")),i.appendChild(r(c?a:xt(s.gl_amount),m)),i.appendChild(r(c?a:xt(s.diff),p)),i.appendChild(r(s.account_codes||"","glv-doc")),o.appendChild(i)}),n.appendChild(o)}function Hn(e){const n=ne("glv-summary-table")&&ne("glv-summary-table").querySelector("tbody");if(!n)return;n.innerHTML="",[{label:fe("s_gl_total"),amount:e.gl_total,emph:!0,items:[],negate:!1},{label:fe("s_minus_gl_cr"),amount:-(e.gl_only_credit||0),emph:!1,items:e.gl_only_credit_items||[],negate:!0},{label:fe("s_plus_gl_dr"),amount:e.gl_only_debit||0,emph:!1,items:e.gl_only_debit_items||[],negate:!1},{label:fe("s_plus_vat_p"),amount:e.vat_only_positive||0,emph:!1,items:e.vat_only_positive_items||[],negate:!1},{label:fe("s_minus_vat_n"),amount:e.vat_only_negative||0,emph:!1,items:e.vat_only_negative_items||[],negate:!1},{label:fe("s_vat_total"),amount:e.vat_total,emph:!0,items:[],negate:!1}].forEach(({label:o,amount:s,emph:i,items:r,negate:c})=>{const l=document.createElement("tr");l.className=i?"glv-summary-total":"glv-summary-sect";const p=document.createElement("td"),m=document.createElement("td");p.textContent=o,m.textContent=i?xt(s):"",l.appendChild(p),l.appendChild(m),n.appendChild(l),(r||[]).forEach(d=>{const u=document.createElement("tr");u.className="glv-summary-item";const f=document.createElement("td"),h=document.createElement("td"),_=[d.doc_no,d.date,d.name].filter(Boolean);f.textContent="· "+_.join("  ·  ");const w=c?-(d.amount||0):d.amount||0;h.textContent=xt(w),u.appendChild(f),u.appendChild(h),n.appendChild(u)})})}async function Fi(e){try{const a=await(await fetch("/api/recon/gl-vat/"+e,{headers:We()})).json();if(!a||!a.ok)throw new Error("load_failed");se.currentTaskId=e,se.lastDetail=a.detail||[],se.lastSummary=a.summary||{},Mn(a.stats||{}),$n(se.lastDetail),Hn(se.lastSummary);const o=ne("glv-result");o&&(o.style.display=""),Va(),window.scrollTo({top:o?o.offsetTop-80:0,behavior:"smooth"})}catch(n){console.error("[gl-vat] load task failed:",n),alert(fe("error")+": "+(n.message||n))}}function Va(){var e=ne("glv-kpi-strip");e&&(e.style.display="");var n=ne("glv-section-summary");n&&n.setAttribute("data-collapsed","false");var a=ne("glv-section-detail");a&&a.setAttribute("data-collapsed","false")}function zi(){document.querySelectorAll(".glv-section-head[data-toggle]").forEach(e=>{const n=e.getAttribute("data-toggle"),a=document.getElementById(n);if(!a)return;const o=s=>{if(s.target&&s.target.closest("button")!==null&&!s.target.classList.contains("glv-section-head"))return;const i=a.getAttribute("data-collapsed")==="true";a.setAttribute("data-collapsed",i?"false":"true")};e.addEventListener("click",o),e.addEventListener("keydown",s=>{(s.key==="Enter"||s.key===" ")&&(s.preventDefault(),o(s))})})}function Ni(e){const n=ne("glv-detail-count");n&&(n.textContent=e!=null?String(e):"")}const vt=10;var Ze=[],Be=1;function Oi(){Be=1,Rt();var e=((ne("glv-hist-search")||{}).value||"").trim().toLowerCase();if(e){var n=ne("glv-history-tbody");n&&n.querySelectorAll("tr").forEach(function(a){a.dataset.taskId&&(a.style.display=a.textContent.toLowerCase().indexOf(e)>=0?"":"none")})}}function Rt(){const e=ne("glv-history-table-wrap"),n=ne("glv-history-empty"),a=ne("glv-history-tbody"),o=ne("glv-history-pager"),s=ne("glv-history-pager-info"),i=ne("glv-history-prev"),r=ne("glv-history-next");if(!a)return;if(a.innerHTML="",!Ze.length){e&&(e.style.display="none"),n&&(n.style.display=""),o&&(o.style.display="none");return}e&&(e.style.display=""),n&&(n.style.display="none");const c=Math.ceil(Ze.length/vt);Be>c&&(Be=c);const l=(Be-1)*vt,p=Ze.slice(l,l+vt);o&&(o.style.display=Ze.length>vt?"":"none",s&&(s.textContent=Be+" / "+c),i&&(i.disabled=Be<=1),r&&(r.disabled=Be>=c)),p.forEach(d=>{const u=document.createElement("tr");u.dataset.taskId=d.id;const f=document.createElement("td");f.textContent=Di(d.created_at);const h=document.createElement("td");h.className="glv-history-file",h.title=(d.vat_filename||"")+" + "+(d.gl_filename||""),h.textContent=(d.vat_filename||"?")+" + "+(d.gl_filename||"?");const _=document.createElement("td");_.className="glv-num",_.textContent=(d.vat_row_count||0)+" / "+(d.gl_row_count||0);const w=document.createElement("td");w.className="glv-num",w.textContent=d.matched_count||0;const y=document.createElement("td");y.className="glv-num",y.textContent=d.diff_count||0;const v=document.createElement("td");v.className="glv-num",v.textContent=d.unmatched_count||0;const E=document.createElement("td");E.className="glv-history-actions";const B=(g,x,I,L)=>{const C=document.createElement("button");return C.type="button",I&&(C.className=I),C.title=x,C.setAttribute("aria-label",x),C.innerHTML=g,C.onclick=L,C},T='<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" width="14" height="14"><path d="M2 8a6 6 0 1 0 12 0A6 6 0 0 0 2 8z"/><polyline points="6 8 8 10 10 8"/><line x1="8" y1="4" x2="8" y2="10"/></svg>',S='<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" width="14" height="14"><path d="M8 2v9M4 7l4 4 4-4M3 14h10"/></svg>',b='<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" width="14" height="14"><polyline points="3 4 13 4"/><path d="M6 4V2.5a.5.5 0 0 1 .5-.5h3a.5.5 0 0 1 .5.5V4"/><path d="M5 4l1 9a1 1 0 0 0 1 1h2a1 1 0 0 0 1-1l1-9"/></svg>';E.appendChild(B(T,fe("hist_load"),"",()=>Fi(d.id))),E.appendChild(B(S,fe("hist_export"),"",()=>Ui(d.id))),E.appendChild(B(b,fe("hist_delete"),"glv-del",()=>Gi(d.id))),[f,h,_,w,y,v,E].forEach(g=>u.appendChild(g)),a.appendChild(u)})}function Vi(){var e=ne("glv-history-prev"),n=ne("glv-history-next");e&&!e._glvBound&&(e._glvBound=!0,e.addEventListener("click",function(){Be>1&&(Be--,Rt())})),n&&!n._glvBound&&(n._glvBound=!0,n.addEventListener("click",function(){var a=Math.ceil(Ze.length/vt);Be<a&&(Be++,Rt())}))}async function nt(){try{const n=await(await fetch("/api/recon/gl-vat/tasks",{headers:We()})).json();Ze=n&&n.tasks||[],Be=1,Rt(),Vi()}catch(e){console.error("[gl-vat] history load failed:",e)}}async function Ui(e){try{const n="/api/recon/gl-vat/"+e+"/export?lang="+encodeURIComponent(lt()),a=await fetch(n,{headers:We()});if(!a.ok)throw new Error("HTTP "+a.status);const o=await a.blob(),s=document.createElement("a");s.href=URL.createObjectURL(o),s.download="GL_VAT_recon_"+e+".xlsx",document.body.appendChild(s),s.click(),setTimeout(()=>{URL.revokeObjectURL(s.href),s.remove()},200)}catch(n){console.error("[gl-vat] exportTask failed:",n),typeof showToast=="function"&&showToast(fe("error")+": "+(n.message||n),"error")}}async function Gi(e){let n;if(typeof window.showConfirm=="function"?n=await window.showConfirm(fe("confirm_delete"),{danger:!0}):n=confirm(fe("confirm_delete")),!!n)try{const a=await fetch("/api/recon/gl-vat/"+e,{method:"DELETE",headers:We()});if(!a.ok)throw new Error("HTTP "+a.status);nt()}catch(a){console.error("[gl-vat] delete failed:",a),typeof showToast=="function"&&showToast(fe("error")+": "+(a.message||a),"error")}}async function Ki(){if(!se.glFile||!se.vatFile){typeof showToast=="function"&&showToast(fe("need_files"),"warn");return}se.running=!0,Lt();const e=ne("glv-status"),n=ne("glv-progress"),a=ne("glv-progress-sub");e&&(e.className="vex-action-info muted",e.style.color="",e.innerHTML="<span>"+fe("running")+"</span>"),n&&(n.style.display=""),a&&(a.textContent=(se.vatFile.name||"VAT")+" + "+(se.glFile.name||"GL"));const o=new FormData,s=Fe("vatFile"),i=Fe("glFile");for(const c of s)o.append("vat_files",c,c.name);for(const c of i)o.append("gl_files",c,c.name);const r=(ne("glv-prefix")&&ne("glv-prefix").value||"4").trim()||"4";o.append("revenue_prefix",r),o.append("lang",lt());try{const c=await fetch("/api/recon/gl-vat/submit",{method:"POST",headers:We(),body:o});let l=null;try{l=await c.json()}catch{l=null}if(!c.ok||!l||!l.ok||!l.job_id)throw new Error(l&&l.detail||l&&l.error||"HTTP "+c.status);const p=ne("glv-progress-sub"),m=await window._reconPollJob(l.job_id,Na(),{onProgress:h=>{p&&(p.textContent=window._reconProgressText(h,lt()))}});if(!m||m.status!=="done"||!m.result_id)throw m&&m.status==="failed"&&m.error_code?new Error(Pi(m.error_code)):new Error(fe("error")||"Error");const d=await fetch("/api/recon/gl-vat/"+encodeURIComponent(m.result_id),{headers:We()});let u=null;try{u=await d.json()}catch{u=null}if(!d.ok||!u||!u.ok)throw new Error(u&&u.detail||u&&u.error||"HTTP "+d.status);se.currentTaskId=u.task_id,se.lastDetail=u.detail||[],se.lastSummary=u.summary||{},Mn(u.stats||{}),$n(se.lastDetail),Hn(se.lastSummary);const f=ne("glv-result");f&&(f.style.display=""),Va(),e&&(e.className="vex-action-info ok",e.style.color="",e.innerHTML="<span>"+fe("done")+" · GL "+(u.gl_row_count||0)+" · VAT "+(u.vat_row_count||0)+"</span>"),nt()}catch(c){console.error("[gl-vat] run failed:",c),e&&(e.className="vex-action-info",e.style.color="#ef4444",e.innerHTML="<span>"+fe("error")+": "+(c.message||c)+"</span>")}finally{se.running=!1,n&&(n.style.display="none"),Lt()}}async function Ji(){if(se.currentTaskId)try{const e="/api/recon/gl-vat/"+se.currentTaskId+"/export?lang="+encodeURIComponent(lt()),n=await fetch(e,{headers:We()});if(!n.ok)throw new Error("HTTP "+n.status);const a=await n.blob(),o=document.createElement("a");o.href=URL.createObjectURL(a),o.download="GL_VAT_recon_"+se.currentTaskId+".xlsx",document.body.appendChild(o),o.click(),setTimeout(()=>{URL.revokeObjectURL(o.href),o.remove()},200)}catch(e){console.error("[gl-vat] export failed:",e),typeof showToast=="function"&&showToast(fe("error")+": "+(e.message||e),"error")}}function Wi(){se.running||St(),nt(),se.lastDetail&&se.lastDetail.length&&$n(se.lastDetail),se.lastSummary&&Hn(se.lastSummary)}function Yi(){if(se.inited){nt();return}se.inited=!0,Zn("glv-drop-gl","glv-gl-input","glv-gl-name","glFile"),Zn("glv-drop-vat","glv-vat-input","glv-vat-name","vatFile");const e=ne("btn-glv-run");e&&e.addEventListener("click",Ki);const n=ne("btn-glv-export");n&&n.addEventListener("click",Ji);const a=ne("btn-glv-reset");a&&a.addEventListener("click",Ri);const o=ne("glv-hist-search");o&&o.addEventListener("input",Oi),zi(),Mn(null),St(),window._loadGlvHistory=nt,nt(),typeof window.subscribeI18n=="function"&&window.subscribeI18n("gl-vat-recon",Wi)}window._glvRemoveFile=qi;window.GlVatRecon={ensureInit:Yi};window._glvPreviewFiles=function(e){return Fe(e==="vat"?"vatFile":"glFile")};(function(){const e=["flowaccount","peak","xero","quickbooks","express"],n={flowaccount:"FlowAccount",peak:"PEAK",xero:"Xero",quickbooks:"QuickBooks",express:"Express"},a=["expense_office","expense_travel","expense_utility","asset_inventory","asset_fixed","liability_ap","revenue_sales","revenue_service","other"],o=["vat_7","vat_0","vat_exempt","wht_1","wht_3","wht_5","non_vat"],s="468b50c1-5593-4fd6-990d-515ce8085563";let i={sub:"clients",loaded:{clients:!1,accounts:!1,taxes:!1,products:!1},items:{clients:[],accounts:[],taxes:[],products:[]},clientList:[],clientLoaded:!1,addingNew:{clients:!1,accounts:!1,taxes:!1,products:!1},bound:!1};function r(){const L=typeof _userInfo<"u"?_userInfo:null;return!!(L&&(L.role==="owner"||L.is_super_admin))}function c(){const L=typeof _userInfo<"u"?_userInfo:null;return!!(L&&L.id===s)}function l(L){return typeof escapeHtml=="function"?escapeHtml(L==null?"":String(L)):String(L??"")}function p(L,C){try{typeof showToast=="function"&&showToast(L,C||"info")}catch{}}async function m(L,C){const k=localStorage.getItem("mrpilot_token");if(k&&!(i.loaded[L]&&!C))try{const M=await fetch("/api/erp/mappings/"+L,{headers:{Authorization:"Bearer "+k}});if(!M.ok)throw new Error("http_"+M.status);const $=await M.json();i.items[L]=$.items||[],i.loaded[L]=!0}catch{i.items[L]=[],i.loaded[L]=!1}}async function d(L){if(i.clientLoaded)return;const C=localStorage.getItem("mrpilot_token");if(C)try{const k=await fetch("/api/clients?include_inactive=false",{headers:{Authorization:"Bearer "+C}});if(!k.ok)throw new Error("http_"+k.status);const M=await k.json();i.clientList=(M.clients||M.items||[]).filter($=>$.is_active!==!1),i.clientLoaded=!0}catch{i.clientList=[]}}function u(){const L=document.getElementById("erp-map-pane-wrap");if(!L)return;const C=!r();let k="";C&&(k+='<div class="erp-map-readonly-banner"><svg width="16" height="16" viewBox="0 0 20 20" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"><circle cx="10" cy="10" r="8"/><path d="M10 6v4M10 13v0.01"/></svg>'+l(t("erp-map-readonly-tip"))+"</div>"),k+='<div class="erp-map-toolbar">',!C&&i.sub!=="products"&&(k+='<button class="btn btn-primary" type="button" id="erp-map-add-btn" data-i18n="erp-map-add-row">'+l(t("erp-map-add-row"))+"</button>"),k+="</div>",k+='<div class="erp-map-table" id="erp-map-table-host"></div>',L.innerHTML=k,f();const M=document.getElementById("erp-map-dev-bar");M&&(M.style.display=r()&&c()?"":"none")}function f(){const L=document.getElementById("erp-map-table-host");if(!L)return;const C=i.sub,k=i.items[C]||[],M=i.addingNew[C],$=!r();if(!k.length&&!M){L.innerHTML='<div class="erp-map-empty"><strong>'+l(t("erp-map-empty-"+C))+"</strong>"+l(t("erp-map-empty-"+C+"-sub"))+"</div>";return}let A="";A+=h(C),M&&!$&&(A+=E(C)),k.forEach(function(H){A+=B(C,H,$)}),L.innerHTML=A}function h(L){return L==="clients"?'<div class="erp-map-row erp-map-head row-clients"><div>'+l(t("erp-map-col-client"))+"</div><div>"+l(t("erp-map-col-erp"))+"</div><div>"+l(t("erp-map-col-erp-code"))+"</div><div>"+l(t("erp-map-col-notes"))+"</div><div>"+l(t("erp-map-col-actions"))+"</div></div>":L==="accounts"?'<div class="erp-map-row erp-map-head row-accounts"><div>'+l(t("erp-map-col-erp"))+"</div><div>"+l(t("erp-map-col-category"))+"</div><div>"+l(t("erp-map-col-erp-code"))+"</div><div>"+l(t("erp-map-col-erp-name"))+"</div><div>"+l(t("erp-map-col-notes"))+"</div><div>"+l(t("erp-map-col-actions"))+"</div></div>":L==="products"?'<div class="erp-map-row erp-map-head row-products"><div>'+l(t("erp-map-col-item-name"))+"</div><div>"+l(t("erp-map-col-erp-product-code"))+"</div><div>"+l(t("erp-map-col-erp-name"))+"</div><div>"+l(t("erp-map-col-notes"))+"</div><div>"+l(t("erp-map-col-actions"))+"</div></div>":'<div class="erp-map-row erp-map-head row-taxes"><div>'+l(t("erp-map-col-erp"))+"</div><div>"+l(t("erp-map-col-tax"))+"</div><div>"+l(t("erp-map-col-erp-tax-code"))+"</div><div>"+l(t("erp-map-col-notes"))+"</div><div>"+l(t("erp-map-col-actions"))+"</div></div>"}function _(L,C){let k='<select class="form-input" data-erp-field="'+C+'">';return k+='<option value="">'+l(t("erp-map-pick-erp"))+"</option>",e.forEach(function(M){const $=M===L?" selected":"";k+='<option value="'+M+'"'+$+">"+l(n[M])+"</option>"}),k+="</select>",k}function w(L){let C='<select class="form-input" data-erp-field="client_id">';return C+='<option value="">'+l(t("erp-map-pick-client"))+"</option>",(i.clientList||[]).forEach(function(k){const M=String(k.id)===String(L)?" selected":"";C+='<option value="'+k.id+'"'+M+">"+l(k.name||"#"+k.id)+"</option>"}),C+="</select>",C}function y(L){let C='<select class="form-input" data-erp-field="pearnly_category">';return C+='<option value="">'+l(t("erp-map-pick-cat"))+"</option>",a.forEach(function(k){const M=k===L?" selected":"";C+='<option value="'+k+'"'+M+">"+l(t("erp-map-cat-"+k))+"</option>"}),C+="</select>",C}function v(L){let C='<select class="form-input" data-erp-field="pearnly_tax_kind">';return C+='<option value="">'+l(t("erp-map-pick-tax"))+"</option>",o.forEach(function(k){const M=k===L?" selected":"";C+='<option value="'+k+'"'+M+">"+l(t("erp-map-tax-"+k))+"</option>"}),C+="</select>",C}function E(L){const C='<button class="btn btn-primary" type="button" data-erp-save="new" style="padding:6px 12px;height:32px;">'+l(t("erp-map-save"))+"</button>";return L==="clients"?'<div class="erp-map-row erp-map-row-add row-clients" data-erp-row="new"><div data-label="'+l(t("erp-map-col-client"))+'">'+w("")+'</div><div data-label="'+l(t("erp-map-col-erp"))+'">'+_("","erp_type")+'</div><div data-label="'+l(t("erp-map-col-erp-code"))+'"><input type="text" class="form-input" data-erp-field="erp_code" placeholder="'+l(t("erp-map-ph-erp-code"))+'"></div><div data-label="'+l(t("erp-map-col-notes"))+'"><input type="text" class="form-input" data-erp-field="notes" placeholder="'+l(t("erp-map-ph-notes"))+'"></div><div>'+C+"</div></div>":L==="accounts"?'<div class="erp-map-row erp-map-row-add row-accounts" data-erp-row="new"><div data-label="'+l(t("erp-map-col-erp"))+'">'+_("","erp_type")+'</div><div data-label="'+l(t("erp-map-col-category"))+'">'+y("")+'</div><div data-label="'+l(t("erp-map-col-erp-code"))+'"><input type="text" class="form-input" data-erp-field="erp_code" placeholder="'+l(t("erp-map-ph-acc-code"))+'"></div><div data-label="'+l(t("erp-map-col-erp-name"))+'"><input type="text" class="form-input" data-erp-field="erp_name" placeholder="'+l(t("erp-map-ph-acc-name"))+'"></div><div data-label="'+l(t("erp-map-col-notes"))+'"><input type="text" class="form-input" data-erp-field="notes" placeholder="'+l(t("erp-map-ph-notes"))+'"></div><div>'+C+"</div></div>":'<div class="erp-map-row erp-map-row-add row-taxes" data-erp-row="new"><div data-label="'+l(t("erp-map-col-erp"))+'">'+_("","erp_type")+'</div><div data-label="'+l(t("erp-map-col-tax"))+'">'+v("")+'</div><div data-label="'+l(t("erp-map-col-erp-tax-code"))+'"><input type="text" class="form-input" data-erp-field="erp_code" placeholder="'+l(t("erp-map-ph-tax-code"))+'"></div><div data-label="'+l(t("erp-map-col-notes"))+'"><input type="text" class="form-input" data-erp-field="notes" placeholder="'+l(t("erp-map-ph-notes"))+'"></div><div>'+C+"</div></div>"}function B(L,C,k){const M=k?"":'<button class="erp-map-del-btn" type="button" data-erp-del="'+l(C.id)+'" title="'+l(t("erp-map-delete"))+'"><svg width="14" height="14" viewBox="0 0 20 20" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"><path d="M4 6h12M8 6V4h4v2M6 6l1 11h6l1-11"/></svg></button>',$='<span class="erp-map-erp-badge">'+l(n[C.erp_type]||C.erp_type)+"</span>";if(L==="clients")return'<div class="erp-map-row row-clients"><div data-label="'+l(t("erp-map-col-client"))+'" class="erp-map-cell-name">'+l(C.client_name||"#"+C.client_id)+'</div><div data-label="'+l(t("erp-map-col-erp"))+'">'+$+'</div><div data-label="'+l(t("erp-map-col-erp-code"))+'" class="erp-map-code">'+l(C.erp_code||"")+'</div><div data-label="'+l(t("erp-map-col-notes"))+'">'+l(C.notes||"")+"</div><div>"+M+"</div></div>";if(L==="accounts"){const H=t("erp-map-cat-"+(C.pearnly_category||"other"))||C.pearnly_category;return'<div class="erp-map-row row-accounts"><div data-label="'+l(t("erp-map-col-erp"))+'">'+$+'</div><div data-label="'+l(t("erp-map-col-category"))+'" class="erp-map-cell-name">'+l(H)+'</div><div data-label="'+l(t("erp-map-col-erp-code"))+'" class="erp-map-code">'+l(C.erp_code||"")+'</div><div data-label="'+l(t("erp-map-col-erp-name"))+'">'+l(C.erp_name||"")+'</div><div data-label="'+l(t("erp-map-col-notes"))+'">'+l(C.notes||"")+"</div><div>"+M+"</div></div>"}if(L==="products")return'<div class="erp-map-row row-products"><div data-label="'+l(t("erp-map-col-item-name"))+'" class="erp-map-cell-name">'+l(C.item_name||"")+'</div><div data-label="'+l(t("erp-map-col-erp-product-code"))+'" class="erp-map-code">'+l(C.erp_code||"")+'</div><div data-label="'+l(t("erp-map-col-erp-name"))+'">'+l(C.erp_name||"")+'</div><div data-label="'+l(t("erp-map-col-notes"))+'">'+l(C.notes||"")+"</div><div>"+M+"</div></div>";const A=t("erp-map-tax-"+(C.pearnly_tax_kind||""))||C.pearnly_tax_kind;return'<div class="erp-map-row row-taxes"><div data-label="'+l(t("erp-map-col-erp"))+'">'+$+'</div><div data-label="'+l(t("erp-map-col-tax"))+'" class="erp-map-cell-name"><span class="erp-map-tax-badge">'+l(A)+'</span></div><div data-label="'+l(t("erp-map-col-erp-tax-code"))+'" class="erp-map-code">'+l(C.erp_code||"")+'</div><div data-label="'+l(t("erp-map-col-notes"))+'">'+l(C.notes||"")+"</div><div>"+M+"</div></div>"}async function T(L){const C=i.sub,k={};L.querySelectorAll("[data-erp-field]").forEach(function(H){k[H.dataset.erpField]=(H.value||"").trim()});const M=localStorage.getItem("mrpilot_token");if(!M)return;let $={},A="/api/erp/mappings/"+C;if(C==="clients"){if(!k.client_id||!k.erp_type||!k.erp_code){p(t("erp-map-save-fail"),"error");return}$={client_id:parseInt(k.client_id,10),erp_type:k.erp_type,erp_code:k.erp_code,notes:k.notes||""}}else if(C==="accounts"){if(!k.erp_type||!k.pearnly_category||!k.erp_code){p(t("erp-map-save-fail"),"error");return}$={erp_type:k.erp_type,pearnly_category:k.pearnly_category,erp_code:k.erp_code,erp_name:k.erp_name||"",notes:k.notes||""}}else{if(!k.erp_type||!k.pearnly_tax_kind||!k.erp_code){p(t("erp-map-save-fail"),"error");return}$={erp_type:k.erp_type,pearnly_tax_kind:k.pearnly_tax_kind,erp_code:k.erp_code,notes:k.notes||""}}try{const H=await fetch(A,{method:"POST",headers:{"Content-Type":"application/json",Authorization:"Bearer "+M},body:JSON.stringify($)});if(!H.ok)throw new Error("http_"+H.status);i.addingNew[C]=!1,await m(C,!0),f(),p(t("erp-map-saved-toast"),"success")}catch{p(t("erp-map-save-fail"),"error")}}async function S(L){if(!await window.pearnlyConfirm(t("erp-map-confirm-delete")))return;const k=i.sub,M=localStorage.getItem("mrpilot_token");try{const $=await fetch("/api/erp/mappings/"+k+"/"+encodeURIComponent(L),{method:"DELETE",headers:{Authorization:"Bearer "+M}});if(!$.ok)throw new Error("http_"+$.status);await m(k,!0),f(),p(t("erp-map-deleted-toast"),"success")}catch{p(t("erp-map-delete-fail"),"error")}}async function b(){await d(),await m(i.sub,!1),u()}function g(L){L!==i.sub&&(i.sub=L,i.addingNew[L]=!1,["clients","accounts","taxes","products"].forEach(function(C){C!==L&&(i.addingNew[C]=!1)}),document.querySelectorAll(".erp-map-subtab").forEach(function(C){C.classList.toggle("active",C.dataset.erpSubtab===L)}),m(L,!1).then(function(){u()}))}function x(){i.bound||(i.bound=!0,document.addEventListener("click",function(L){const C=L.target.closest(".erp-subtab[data-erp-subtab]");if(C){L.preventDefault();const H=C.dataset.erpSubtab;document.querySelectorAll(".erp-subtab").forEach(function(P){P.classList.toggle("active",P.dataset.erpSubtab===H)}),document.querySelectorAll(".erp-subpanel").forEach(function(P){P.classList.toggle("active",P.dataset.erpSubpanel===H)}),H==="mappings"&&setTimeout(b,50);return}const k=L.target.closest(".erp-map-subtab[data-erp-subtab]");if(k){L.preventDefault(),g(k.dataset.erpSubtab);return}if(L.target.closest("#erp-map-add-btn")){if(L.preventDefault(),!r())return;i.addingNew[i.sub]=!0,f();return}const $=L.target.closest('[data-erp-save="new"]');if($){L.preventDefault();const H=$.closest('[data-erp-row="new"]');H&&T(H);return}const A=L.target.closest("[data-erp-del]");if(A){L.preventDefault(),S(A.dataset.erpDel);return}}))}function I(){const L=document.getElementById("erp-map-pane-wrap");L&&L.children.length>0&&u(),document.querySelectorAll(".erp-map-subtab").forEach(function(C){const k="erp-map-subtab-"+C.dataset.erpSubtab,M=t(k);M&&M!==k&&(C.textContent=M)})}x(),typeof window.subscribeI18n=="function"&&window.subscribeI18n("erp-mappings",I)})();(function(){let e=null,n=0,a=!1;function o(b){return typeof escapeHtml=="function"?escapeHtml(b==null?"":String(b)):String(b??"")}function s(b,g){try{typeof showToast=="function"&&showToast(b,g||"info")}catch{}}async function i(b){const g=Date.now();if(e&&g-n<3e4)return e;const x=localStorage.getItem("mrpilot_token");if(!x)return[];try{const I=await fetch("/api/erp/connectors/status",{headers:{Authorization:"Bearer "+x}});if(!I.ok)return[];const L=await I.json();return e=L&&L.connectors||[],n=g,e}catch{return[]}}function r(){try{return localStorage.getItem("pn_push_default_connector")||""}catch{return""}}function c(b){try{localStorage.setItem("pn_push_default_connector",b||"")}catch{}}function l(b){if(!b||!b.length)return null;const g=r();if(g){const I=b.find(L=>L.id===g);if(I)return I}const x=b.find(I=>I.is_default);return x||b[0]}function p(b){if(!b)return!1;const g=String(b.status||"").toLowerCase();return g==="exception"||g==="exception_pending"||g==="rejected"}function m(){try{return(typeof _results<"u"?_results:[])[typeof _drawerIdx<"u"?_drawerIdx:-1]||null}catch{return null}}function d(b){const g=b&&(b.type||b.id);return g==="xero"?'<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"><circle cx="8" cy="8" r="6"/><path d="M5.5 8l2 2 3-3.5"/></svg>':g==="webhook"?'<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"><circle cx="5" cy="11.5" r="1.8"/><circle cx="11" cy="4.5" r="1.8"/><path d="M6.4 10l3.2-4M5 9.6V5.5a3 3 0 016 0"/></svg>':'<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"><path d="M2 8h9M8 5l3 3-3 3"/><rect x="11" y="3" width="3" height="10" rx="1"/></svg>'}async function u(b,g){if(!b||!g)return!1;const x=document.getElementById("btn-push-default");x&&(x.disabled=!0,x.classList.add("loading"));const I=localStorage.getItem("mrpilot_token");try{let L,C={method:"POST",headers:{Authorization:"Bearer "+I}};b.type==="xero"?L="/api/erp/xero/push/"+encodeURIComponent(g):(L="/api/erp/push",C.headers["Content-Type"]="application/json",C.body=JSON.stringify({history_id:g,endpoint_id:b.endpoint_id||void 0}));const k=await fetch(L,C);let M={};try{M=await k.json()}catch{}if(!k.ok){let $=M&&M.detail||"unknown";typeof $=="object"&&($=$.code||JSON.stringify($));let A=String($||"unknown");if(b.type==="xero"){const H=A.replace(/^xero\./,"").toLowerCase(),P=t("xero-"+H);P&&P!=="xero-"+H&&(A=P)}return s(t("unified-push-fail").replace("{name}",b.name).replace("{err}",A),"error"),!1}if(M&&M.ok===!1){let $=M.error_msg||M.error_code||"unknown";return $=String($).slice(0,200),s(t("unified-push-fail").replace("{name}",b.name).replace("{err}",$),"error"),!1}return s(t("unified-push-ok").replace("{name}",b.name),"success"),!0}catch(L){return s(t("unified-push-fail").replace("{name}",b.name).replace("{err}",L.message||"network"),"error"),!1}finally{x&&(x.disabled=!1,x.classList.remove("loading"))}}async function f(b,g){for(const x of b)await u(x,g)}function h(b,g){const x=document.createElement("div");x.className="pn-push-dropdown",x.id="pn-push-dropdown";const I=(b||[]).map(C=>{const k=!!(g&&C.id===g.id),M=C.method==="download"?t("unified-push-tag-download"):k?t("unified-push-tag-default"):"";return'<div class="pn-pd-item" data-cid="'+o(C.id)+'"><span class="pn-pd-icon">'+d(C)+'</span><span class="pn-pd-name">'+o(C.name)+"</span>"+(M?'<span class="pn-pd-tag">'+o(M)+"</span>":"")+(k?'<span class="pn-pd-check">✓</span>':"")+"</div>"}).join(""),L=b&&b.length>1?'<div class="pn-pd-divider"></div><div class="pn-pd-item pn-pd-all" data-cid="__all__"><span class="pn-pd-icon"><svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"><path d="M3 6h10M3 10h10M3 13.5h6"/></svg></span><span class="pn-pd-name">'+o(t("unified-push-all").replace("{n}",b.length))+"</span></div>":"";return x.innerHTML=I+L,x}function _(){const b=document.getElementById("pn-push-dropdown");b&&b.remove()}async function w(){if(document.getElementById("pn-push-dropdown")){_();return}const b=await i()||[],g=l(b),x=h(b,g),I=document.getElementById("pn-push-wrap");I&&I.appendChild(x)}async function y(){const b=await i()||[],g=l(b);if(!g)return;const x=m(),I=x&&(x._historyId||x.history_id);if(I){if(p(x)){s(t("unified-push-disabled-exc"),"warn");return}await u(g,I)}}async function v(b){_();const g=await i()||[],x=m(),I=x&&(x._historyId||x.history_id);if(!I)return;if(p(x)){s(t("unified-push-disabled-exc"),"warn");return}if(b==="__all__"){await f(g,I);return}const L=g.find(C=>C.id===b);L&&(c(b),await u(L,I),B())}async function E(){const b=document.getElementById("drawer-history-save");if(!b||b.querySelector("#pn-push-wrap"))return;const g=document.createElement("div");g.id="pn-push-wrap",g.className="pn-push-wrap",g.dataset.loading="1",b.insertBefore(g,b.firstChild),["btn-push-erp","btn-xero-push"].forEach(M=>{b.querySelectorAll("#"+M).forEach($=>{$.style.display="none"})});const x=await i()||[],I=l(x),L=x.length>0;if(!L)g.innerHTML='<button type="button" class="btn btn-ghost pn-push-empty" id="btn-push-default" disabled title="'+o(t("unified-push-empty-tip"))+'"><svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"><path d="M2 8h9M8 5l3 3-3 3"/></svg><span style="margin-left:4px;">'+o(t("unified-push-empty"))+"</span></button>";else{const M=x.length>1;g.innerHTML='<div class="pn-push-split"><button type="button" class="pn-push-main" id="btn-push-default" title="'+o(t("unified-push-tip"))+'">'+d(I)+"<span>"+o(t("unified-push-to").replace("{name}",I?I.name:""))+"</span></button>"+(M?'<button type="button" class="pn-push-arrow" id="btn-push-arrow" title="'+o(t("unified-push-other"))+'"><svg viewBox="0 0 12 12" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M3 5l3 3 3-3"/></svg></button>':"")+"</div>"}delete g.dataset.loading;const C=g.querySelector("#btn-push-default");C&&L&&C.addEventListener("click",y);const k=g.querySelector("#btn-push-arrow");k&&k.addEventListener("click",function(M){M.stopPropagation(),w()}),a||(a=!0,document.addEventListener("click",function(M){const $=M.target.closest(".pn-pd-item");if($){const A=$.getAttribute("data-cid");v(A);return}M.target.closest("#btn-push-arrow")||_()}),typeof window.subscribeI18n=="function"&&window.subscribeI18n("unified-push",B))}function B(){const b=document.getElementById("pn-push-wrap");b&&(b.remove(),e=null,n=0,E())}function T(){const b=document.getElementById("drawer-history-save");if(!b||!b.querySelector("#pn-push-wrap"))return;["btn-push-erp","btn-xero-push"].forEach(x=>{b.querySelectorAll("#"+x).forEach(I=>{I.style.display!=="none"&&(I.style.display="none")})});const g=b.querySelectorAll("#pn-push-wrap");if(g.length>1)for(let x=1;x<g.length;x++)g[x].remove()}function S(){try{const b=function(){return document.getElementById("drawer-body")},g=new MutationObserver(function(){document.getElementById("drawer-history-save")&&!document.getElementById("pn-push-wrap")&&E(),T()}),x=b();if(x)g.observe(x,{childList:!0,subtree:!0});else{const I=new MutationObserver(function(){const L=b();L&&(g.observe(L,{childList:!0,subtree:!0}),I.disconnect())});I.observe(document.body,{childList:!0,subtree:!0})}setTimeout(function(){document.getElementById("drawer-history-save")&&!document.getElementById("pn-push-wrap")&&E(),T()},200)}catch{}}S()})();(function(){function e(){const a=document.getElementById("erp-map-show-advanced-btn");if(!a)return;const o=document.getElementById("erp-map-subtabs");if(!o)return;const s=o.classList.contains("show-advanced"),i=a.querySelector(".erp-map-adv-btn-label");if(i&&typeof t=="function"){const r=s?"erp-map-hide-advanced":"erp-map-show-advanced",c=t(r);c&&c!==r&&(i.textContent=c)}a.setAttribute("aria-pressed",s?"true":"false")}document.addEventListener("click",function(a){if(!a.target.closest("#erp-map-show-advanced-btn"))return;a.preventDefault();const s=document.getElementById("erp-map-subtabs");if(s&&(s.classList.toggle("show-advanced"),e(),!s.classList.contains("show-advanced")&&s.querySelector(".erp-map-subtab.active.erp-map-subtab-advanced"))){const r=s.querySelector('.erp-map-subtab[data-erp-subtab="clients"]');r&&r.click()}});function n(){e()}typeof window.subscribeI18n=="function"&&window.subscribeI18n("erp-map-advanced-toggle",n)})();(function(){const e="pearnly_erp_onboard_shown";let n=!1;function a(){try{return Array.isArray(window._erpEndpoints)&&window._erpEndpoints.length>0}catch{return!1}}function o(){if(document.getElementById("erp-onboard-mask"))return;const i=document.createElement("div");i.id="erp-onboard-mask",i.className="erp-onboard-mask",i.innerHTML='<div class="erp-onboard-modal" role="dialog" aria-modal="true"><div class="erp-onboard-icon"><svg viewBox="0 0 32 32" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><rect x="4" y="6" width="24" height="20" rx="3"/><path d="M9 13h14M9 18h10"/><path d="M22 22l3 3 5-5"/></svg></div><div class="erp-onboard-title" id="erp-onboard-title"></div><div class="erp-onboard-body" id="erp-onboard-body"></div><div class="erp-onboard-btns"><button type="button" class="btn btn-secondary" id="erp-onboard-later"></button><button type="button" class="btn btn-primary" id="erp-onboard-ok"></button></div></div>',document.body.appendChild(i);function r(){const l=document.getElementById("erp-onboard-title"),p=document.getElementById("erp-onboard-body"),m=document.getElementById("erp-onboard-ok"),d=document.getElementById("erp-onboard-later");l&&(l.textContent=t("erp-onboard-title")),p&&(p.textContent=t("erp-onboard-body")),m&&(m.textContent=t("erp-onboard-ok")),d&&(d.textContent=t("erp-onboard-later"))}r();function c(){i.style.display="none"}document.getElementById("erp-onboard-ok").addEventListener("click",function(){try{localStorage.setItem(e,"1")}catch{}c();try{const l=document.querySelector('#btn-add-endpoint, [data-action="erp-add-endpoint"]');l&&l.scrollIntoView({behavior:"smooth",block:"center"})}catch{}}),document.getElementById("erp-onboard-later").addEventListener("click",function(){try{localStorage.setItem(e,"1")}catch{}c()}),i.addEventListener("click",function(l){l.target===i&&c()}),typeof window.subscribeI18n=="function"&&window.subscribeI18n("erp-onboard-modal",function(){i.style.display!=="none"&&r()})}function s(){if(!n){try{if(localStorage.getItem(e)==="1")return}catch{}a()||(n=!0,o(),requestAnimationFrame(function(){requestAnimationFrame(function(){if(a())return;const i=document.getElementById("erp-onboard-mask");i&&(i.style.display="flex")})}))}}document.addEventListener("click",function(i){const r=i.target.closest('.auto-nav-item[data-auto-tab="erp"]'),c=i.target.closest('.erp-subtab[data-erp-subtab="connect"]');(r||c)&&setTimeout(s,700)})})();(function(){const e={parse:{zh:"解析文件中",th:"กำลังอ่านไฟล์",en:"Parsing files",ja:"ファイル解析中"},report:{zh:"读取报告中",th:"กำลังอ่านรายงาน",en:"Reading report",ja:"レポート読込中"},reconcile:{zh:"对账中",th:"กำลังกระทบยอด",en:"Reconciling",ja:"照合中"},build:{zh:"生成中",th:"กำลังสร้างไฟล์",en:"Building",ja:"作成中"},persist:{zh:"保存中",th:"กำลังบันทึก",en:"Saving",ja:"保存中"},done:{zh:"完成",th:"เสร็จสิ้น",en:"Done",ja:"完了"}};window._reconProgressText=function(n,a){n=n||{},a=window._currentLang||a||localStorage.getItem("mrpilot_lang")||"th",e.parse[a]||(a="th");const o=n.stage||"parse",s=e[o]||e.parse,i=s[a]||s.th||s.en,r=n.stage_total,c=n.stage_done;if(o==="parse"&&Number.isFinite(r)&&r>0){const l={zh:"共 {d}/{t} 个文件",th:"{d}/{t} ไฟล์",en:"{d}/{t} files",ja:"{d}/{t} ファイル"}[a]||"{d}/{t} files";return i+" · "+l.replace("{d}",c||0).replace("{t}",r)}return i},window._reconPollJob=async function(n,a,o){o=o||{};const s=o.intervalMs||1500,i=o.maxMs||1200*1e3,r=Date.now();let c=0;for(;;){let l=null;try{const p=await fetch("/api/recon/jobs/"+encodeURIComponent(n),{headers:{Authorization:"Bearer "+a}});try{l=await p.json()}catch{l=null}(!p.ok||!l||!l.ok)&&(l=null)}catch{l=null}if(l){if(c=0,o.onProgress)try{o.onProgress(l.progress||{},l)}catch{}if(l.status==="done"||l.status==="failed"||l.status==="needs_review"||l.status==="needs_mapping")return l}else if(++c>=10)return{ok:!1,status:"failed",error_code:"poll_unreachable"};if(Date.now()-r>i)return{ok:!1,status:"timeout",error_code:"timeout"};await new Promise(p=>setTimeout(p,s))}}})();const W={initialized:!1,stmtFiles:[],glFiles:[],currentTask:null,currentFilter:"all",allRows:[],brv2Search:{stmt:"",gl:""},cachedHistoryTasks:[],brv2Page:1},U=e=>document.getElementById(e);function qe(e){if(e==null)return"—";const n=Number(e);return isNaN(n)?"—":n.toLocaleString("en-US",{minimumFractionDigits:2,maximumFractionDigits:2})}function Qn(e){return e?String(e).slice(0,10).split("-").reverse().join("/"):"—"}function ge(e){return String(e||"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}function Xi(e,n){n=window._currentLang||n||"th";const a={stmt_headers_not_found:{zh:"认不出银行账单表头 · 请确认文件含日期/金额/余额列,或转成清晰的 Excel/CSV 重传",th:"หาหัวตารางบัญชีธนาคารไม่เจอ · ตรวจสอบว่ามีคอลัมน์ วันที่/จำนวนเงิน/ยอดคงเหลือ หรือแปลงเป็น Excel/CSV แล้วอัปโหลดใหม่",en:"Cannot detect bank statement headers · ensure the file has date/amount/balance columns, or re-upload as a clean Excel/CSV",ja:"銀行明細のヘッダーを認識できません · 日付/金額/残高列を確認するか、Excel/CSVに変換して再アップロードしてください"},gl_headers_not_found:{zh:"认不出总账表头 · 请确认文件含日期/科目/借方/贷方列,或转成清晰的 Excel/CSV 重传",th:"หาหัวตาราง GL ไม่เจอ · ตรวจสอบว่ามีคอลัมน์ วันที่/บัญชี/เดบิต/เครดิต หรือแปลงเป็น Excel/CSV แล้วอัปโหลดใหม่",en:"Cannot detect GL headers · ensure the file has date/account/debit/credit columns, or re-upload as a clean Excel/CSV",ja:"GLのヘッダーを認識できません · 日付/科目/借方/貸方列を確認するか、Excel/CSVに変換して再アップロードしてください"},stmt_no_rows:{zh:"文件里没有交易数据 · 请确认上传了正确的银行流水,或换更清晰的版本重传",th:"ไม่พบรายการธุรกรรมในไฟล์ · ตรวจสอบว่าอัปโหลด statement ที่ถูกต้อง หรือใช้เวอร์ชันที่ชัดเจนกว่า",en:"No transaction rows found · please upload the correct statement, or try a clearer version",ja:"取引データが見つかりません · 正しい明細をアップロードするか、より鮮明なファイルでお試しください"},no_rows:{zh:"解析后没有可对账的数据行 · 请确认文件内容完整,或换清晰版本重传",th:"ไม่มีแถวข้อมูลให้กระทบยอดหลังการอ่าน · ตรวจสอบความสมบูรณ์ของไฟล์ หรืออัปโหลดใหม่",en:"No reconcilable rows after parsing · check the file is complete, or re-upload a clearer version",ja:"解析後に照合可能な行がありません · ファイルの完全性を確認するか再アップロードしてください"},file_unreadable:{zh:"文件无法读取 · 可能已损坏或被加密 · 请换文件或转 PDF/Excel 重传",th:"อ่านไฟล์ไม่ได้ · อาจเสียหายหรือถูกเข้ารหัส · ลองไฟล์อื่นหรือแปลงเป็น PDF/Excel",en:"File cannot be read · may be corrupted or encrypted · try another file or convert to PDF/Excel",ja:"ファイルを読み取れません · 破損または暗号化の可能性 · 別ファイルまたはPDF/Excelに変換してください"},file_not_supported:{zh:"不支持此文件类型 · 请上传 PDF / 图片 / Excel / CSV",th:"ไม่รองรับไฟล์ประเภทนี้ · กรุณาอัปโหลด PDF / รูปภาพ / Excel / CSV",en:"File type not supported · please upload PDF / image / Excel / CSV",ja:"このファイル形式は非対応 · PDF / 画像 / Excel / CSV をアップロードしてください"},ocr_failed:{zh:"文件识别失败 · 请尝试更清晰的版本,或转成 PDF / Excel / CSV 重传",th:"อ่านไฟล์ไม่ออก · ลองเวอร์ชันที่ชัดเจนกว่า หรือแปลงเป็น PDF / Excel / CSV",en:"Could not read the file · try a clearer version, or convert to PDF / Excel / CSV",ja:"読み取りに失敗 · より鮮明なファイルか、PDF / Excel / CSV に変換して再試行してください"}},o={zh:"解析失败 · 请换更清晰的文件,或转成 Excel / CSV 后重新上传",th:"อ่านไฟล์ไม่สำเร็จ · ลองไฟล์ที่ชัดเจนกว่า หรือแปลงเป็น Excel / CSV แล้วอัปโหลดใหม่",en:"Parsing failed · try a clearer file, or convert to Excel / CSV and re-upload",ja:"解析に失敗しました · より鮮明なファイルか、Excel / CSV に変換して再アップロードしてください"},s=a[e]||o;return s[n]||s.th||s.en}function Zi(e){return e?e<1024?e+" B":e<1048576?(e/1024).toFixed(1)+" KB":(e/1048576).toFixed(1)+" MB":""}function Ye(e,n){return window.t&&window.t(e)||n}function je(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function Qt(e){return Number.isFinite(+e)?(+e).toLocaleString(void 0,{minimumFractionDigits:2,maximumFractionDigits:2}):"—"}var Ua="pearnly.brv2.lastAnchorOcr";function Qi(e){try{var n=e&&e._anchor_ocr;if(!n||typeof n!="object")return;var a={stmt_opening:Number.isFinite(+n.stmt_opening)?+n.stmt_opening:null,gl_opening:Number.isFinite(+n.gl_opening)?+n.gl_opening:null,gl_closing:Number.isFinite(+n.gl_closing)?+n.gl_closing:null,stmt_closing:Number.isFinite(+n.stmt_closing)?+n.stmt_closing:null,ts:Date.now()};localStorage.setItem(Ua,JSON.stringify(a))}catch{}}function er(){try{var e=localStorage.getItem(Ua);if(!e)return null;var n=JSON.parse(e);return!n||typeof n!="object"?null:n}catch{return null}}function tr(){var e=er();if(e){var n={"brv2-anchor-stmt-opening":e.stmt_opening,"brv2-anchor-gl-opening":e.gl_opening,"brv2-anchor-gl-closing":e.gl_closing,"brv2-anchor-stmt-closing":e.stmt_closing},a=0;Object.keys(n).forEach(function(c){var l=document.getElementById(c);if(l&&l.value===""){var p=n[c];if(Number.isFinite(p)){l.value=p.toFixed(2);var m=l.closest&&l.closest(".brv2-anchor-cell");m&&m.classList.add("is-prefilled"),a+=1}}});var o=document.getElementById("brv2-anchor-eq"),s=document.getElementById("brv2-anchor-eq-val");if(o&&s&&Number.isFinite(e.stmt_opening)&&Number.isFinite(e.gl_opening)){var i=e.stmt_opening-e.gl_opening;s.textContent=i.toLocaleString(void 0,{minimumFractionDigits:2,maximumFractionDigits:2}),o.style.display=""}if(a>0){var r=document.getElementById("brv2-anchor-prefill-banner");r&&r.classList.add("show")}}}function nr(){var e=document.getElementById("brv2-anchor-prefill-banner");if(e){var n=!1;["brv2-anchor-gl-closing","brv2-anchor-stmt-closing","brv2-anchor-stmt-opening","brv2-anchor-gl-opening"].forEach(function(a){var o=document.getElementById(a);if(o){var s=o.closest&&o.closest(".brv2-anchor-cell");s&&s.classList.contains("is-prefilled")&&(n=!0)}}),e.classList.toggle("show",n)}}var ar=[["stmt_opening","brv2-anchor-stmt-opening"],["gl_opening","brv2-anchor-gl-opening"],["gl_closing","brv2-anchor-gl-closing"],["stmt_closing","brv2-anchor-stmt-closing"]];function or(e){var n=document.getElementById("brv2-summary-collapse");if(!(!n||!n.parentNode)){var a=document.getElementById("brv2-anchor-audit"),o=e&&e._anchor_overrides;if(!o||typeof o!="object"||Object.keys(o).length===0){a&&a.parentNode&&a.parentNode.removeChild(a);return}a||(a=document.createElement("div"),a.id="brv2-anchor-audit",a.style.cssText="margin-top:14px;background:#fff7ed;border:1px solid #fed7aa;border-radius:8px;padding:14px 16px;",n.parentNode.insertBefore(a,n.nextSibling));var s=ar.map(function(i){var r=o[i[0]];if(!r)return"";var c=+r.ocr||0,l=+r.user||0,p=l-c,m=p>0?"+":(p<0,""),d=Math.abs(p)<.005?"#6b7280":p>0?"#16a34a":"#dc2626";return'<tr><td style="padding:6px 10px;color:#111827;font-size:13px">'+je(Ye(i[1],i[0]))+'</td><td style="padding:6px 10px;color:#6b7280;font-size:13px;text-align:right;font-variant-numeric:tabular-nums">'+je(Qt(c))+'</td><td style="padding:6px 10px;background:#fef08a;color:#92400e;font-weight:600;font-size:13px;text-align:right;font-variant-numeric:tabular-nums">'+je(Qt(l))+'</td><td style="padding:6px 10px;color:'+d+';font-weight:500;font-size:13px;text-align:right;font-variant-numeric:tabular-nums">'+je(m+Qt(p))+"</td></tr>"}).join("");a.innerHTML='<div style="font-weight:600;color:#92400e;font-size:13px;margin-bottom:10px">'+je(Ye("brv2-anchor-audit-title","⚠ This run contains manually entered anchors"))+'</div><table style="width:100%;border-collapse:collapse;font-family:inherit"><thead><tr><th style="padding:6px 10px;text-align:left;color:#6b7280;font-size:11px;font-weight:500;border-bottom:1px solid #fed7aa">'+je(Ye("brv2-anchor-audit-col-field","Field"))+'</th><th style="padding:6px 10px;text-align:right;color:#6b7280;font-size:11px;font-weight:500;border-bottom:1px solid #fed7aa">'+je(Ye("brv2-anchor-audit-col-ocr","OCR"))+'</th><th style="padding:6px 10px;text-align:right;color:#6b7280;font-size:11px;font-weight:500;border-bottom:1px solid #fed7aa">'+je(Ye("brv2-anchor-audit-col-user","User"))+'</th><th style="padding:6px 10px;text-align:right;color:#6b7280;font-size:11px;font-weight:500;border-bottom:1px solid #fed7aa">'+je(Ye("brv2-anchor-audit-col-diff","Diff"))+"</th></tr></thead><tbody>"+s+"</tbody></table>"}}function Ft(e){const n=U("brv2-summary-collapse"),a=U("brv2-detail-collapse"),o=U("brv2-export-btn"),s=U("brv2-new-btn"),i=U("brv2-parse-info-wrap");n&&(n.style.display=e?"":"none"),a&&(a.style.display=e?"":"none"),o&&(o.style.display=e?"":"none"),s&&(s.style.display=e?"":"none"),!e&&i&&(i.style.display="none");const r=U("brv2-warnings");!e&&r&&(r.style.display="none",r.innerHTML="")}function sr(e){const n=U("brv2-parse-info-wrap"),a=U("brv2-parse-info-body");if(!n||!a)return;const o=e.parse_info;if(!o){n.style.display="none";return}const s=window._currentLang||"zh",i={title:{zh:"文件解析状态",th:"สถานะการอ่านไฟล์",en:"File Parse Status",ja:"ファイル解析状態"},type:{zh:"类型",th:"ประเภท",en:"Type",ja:"種別"},file:{zh:"文件名",th:"ชื่อไฟล์",en:"File",ja:"ファイル"},rows:{zh:"解析行数",th:"แถวที่พบ",en:"Rows Found",ja:"解析行数"},bank:{zh:"银行/科目",th:"ธนาคาร/บัญชี",en:"Bank/Account",ja:"銀行/科目"},status:{zh:"状态",th:"สถานะ",en:"Status",ja:"状態"},stmt:{zh:"账单",th:"บัญชีธนาคาร",en:"Stmt",ja:"明細"},gl:{zh:"总账GL",th:"GL",en:"GL",ja:"GL"},ok:{zh:"✓ 成功",th:"✓ สำเร็จ",en:"✓ OK",ja:"✓ 成功"},warn:{zh:"⚠ 0行",th:"⚠ 0 แถว",en:"⚠ 0 rows",ja:"⚠ 0行"},fail:{zh:"✗ 失败",th:"✗ ล้มเหลว",en:"✗ Failed",ja:"✗ 失敗"}},r=u=>(i[u]||{})[s]||(i[u]||{}).zh||u,c=[...(o.stmt_files||[]).map(u=>({...u,_type:"stmt",_extra:u.bank_code||""})),...(o.gl_files||[]).map(u=>({...u,_type:"gl",_extra:(u.accounts||[]).join(", ")}))],l={stmt_headers_not_found:{zh:"认不出表头列 · 请确认文件含日期/金额/余额列",th:"หาคอลัมน์หัวตารางไม่เจอ · ตรวจสอบไฟล์มีวันที่/จำนวนเงิน/ยอดคงเหลือ",en:"Cannot detect column headers · ensure file has date/amount/balance columns",ja:"列ヘッダーが認識できません · 日付/金額/残高列を確認してください"},stmt_no_rows:{zh:"文件里没有交易数据 · 请确认上传了正确的银行流水",th:"ไม่พบรายการธุรกรรมในไฟล์ · ตรวจสอบว่าอัปโหลด statement ที่ถูกต้อง",en:"No transaction rows found · please check the file",ja:"取引データが見つかりません · ファイルを確認してください"},file_not_supported:{zh:"不支持此文件类型 · 请上传 PDF / 图片 / Excel / CSV",th:"ไม่รองรับไฟล์ประเภทนี้ · กรุณาอัปโหลด PDF / รูปภาพ / Excel / CSV",en:"File type not supported · please upload PDF / image / Excel / CSV",ja:"このファイル形式は非対応 · PDF / 画像 / Excel / CSV をアップロード"},file_unreadable:{zh:"文件无法读取 · 可能已损坏或被加密",th:"อ่านไฟล์ไม่ได้ · อาจเสียหายหรือถูกเข้ารหัส",en:"File cannot be read · may be corrupted or encrypted",ja:"ファイルを読み取れません · 破損または暗号化の可能性"},ocr_failed:{zh:"文件识别失败 · 请尝试更清晰的版本或换 PDF 格式重传",th:"อ่านไฟล์ไม่ออก · ลองเวอร์ชันที่ชัดเจนกว่าหรือเปลี่ยนเป็น PDF",en:"Could not read file · try a clearer version or upload as PDF",ja:"読み取り失敗 · より鮮明なファイルまたは PDF 形式で再試行"},gl_headers_not_found:{zh:"认不出总账表头 · 请确认文件含科目/借方/贷方列",th:"หาหัวคอลัมน์ GL ไม่เจอ · ตรวจสอบมีคอลัมน์บัญชี/เดบิต/เครดิต",en:"Cannot detect GL column headers · ensure account/debit/credit columns exist",ja:"GL 列ヘッダー認識不可 · 科目/借方/貸方列を確認してください"}},p=u=>{const f=String(u||"");return/Cannot detect bank statement column headers/i.test(f)?"stmt_headers_not_found":/Cannot detect GL column headers/i.test(f)?"gl_headers_not_found":/No transaction rows found|no pages parsed/i.test(f)?"stmt_no_rows":/unsupported format/i.test(f)?"file_not_supported":/Cannot read Excel|file_unreadable/i.test(f)?"file_unreadable":/Gemini.*invalid JSON|Gemini.*parsed but failed|validation errors|BankStatementDocument schema|layer2:|layer1:/i.test(f)?"ocr_failed":null},m=u=>{const f=u.error_code||p(u.error);if(f&&l[f]){const h=window._currentLang||"zh";return l[f][h]||l[f].zh}return String(u.error||"").slice(0,80)},d=u=>!u.ok&&u.error?`<span style="color:#dc2626">${r("fail")} — ${ge(m(u))}</span>`:u.rows?`<span style="color:#059669">${r("ok")} (${u.rows})</span>`:`<span style="color:#d97706">${r("warn")}</span>`;a.innerHTML=`
        ...
        <table style="width:100%;border-collapse:collapse;font-size:12px;margin-bottom:4px">
          ...
          <td>${c?"L"+c:"—"}</td>
        </tr>`}).join("")}async function _t(){const e=localStorage.getItem("mrpilot_token")||"";try{const a=await(await fetch("/api/recon/bank-v2/tasks",{headers:{Authorization:"Bearer "+e}})).json();zt(a.tasks||[])}catch{const a=U("brv2-history-empty"),o=window._currentLang||"zh",s={zh:"加载失败",th:"โหลดประวัติไม่ได้",en:"Load failed",ja:"読み込み失敗"}[o]||"加载失败";a&&(a.textContent=s,a.style.display="");const i=U("brv2-history-table-wrap");i&&(i.style.display="none")}}const at=10;function ea(){const e=U("brv2-history-pager"),n=U("brv2-history-pager-info"),a=U("brv2-history-prev"),o=U("brv2-history-next");if(!e)return;if(W.cachedHistoryTasks.length<=at){e.style.display="none";return}e.style.display="";const s=Math.ceil(W.cachedHistoryTasks.length/at);n&&(n.textContent=W.brv2Page+" / "+s),a&&(a.disabled=W.brv2Page<=1),o&&(o.disabled=W.brv2Page>=s)}function rr(){const e=U("brv2-history-prev"),n=U("brv2-history-next");e&&!e._brv2Bound&&(e._brv2Bound=!0,e.addEventListener("click",()=>{W.brv2Page>1&&(W.brv2Page--,zt(W.cachedHistoryTasks))})),n&&!n._brv2Bound&&(n._brv2Bound=!0,n.addEventListener("click",()=>{const a=Math.ceil(W.cachedHistoryTasks.length/at);W.brv2Page<a&&(W.brv2Page++,zt(W.cachedHistoryTasks))}))}function zt(e){e!==void 0&&(W.cachedHistoryTasks=e||[],W.brv2Page=1);const n=W.cachedHistoryTasks,a=U("brv2-history-empty"),o=U("brv2-history-table-wrap"),s=U("brv2-history-tbody");if(!s)return;const i=window._currentLang||"zh";if(!n.length){const f={zh:"暂无对账记录",th:"ยังไม่มีประวัติ",en:"No records yet",ja:"記録なし"}[i]||"暂无对账记录";a&&(a.textContent=f,a.style.display=""),o&&(o.style.display="none"),ea();return}a&&(a.style.display="none"),o&&(o.style.display="");const r=Math.ceil(n.length/at);W.brv2Page>r&&(W.brv2Page=r);const c=(W.brv2Page-1)*at,l=n.slice(c,c+at),p=localStorage.getItem("mrpilot_token")||"",m='<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" width="14" height="14"><circle cx="8" cy="8" r="6"/><polyline points="6 8 8 10 10 8"/><line x1="8" y1="4" x2="8" y2="10"/></svg>',d='<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" width="14" height="14"><path d="M8 2v9M4 7l4 4 4-4M3 14h10"/></svg>',u='<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" width="14" height="14"><polyline points="3 4 13 4"/><path d="M6 4V2.5a.5.5 0 0 1 .5-.5h3a.5.5 0 0 1 .5.5V4"/><path d="M5 4l1 9a1 1 0 0 0 1 1h2a1 1 0 0 0 1-1l1-9"/></svg>';s.innerHTML="",l.forEach(f=>{const h=Number(f.formula_diff||0),_=Math.abs(h)<.05,w=(f.stmt_files||"").split(";").map(H=>H.trim().split(/[/\\]/).pop()).filter(Boolean).join(", "),y=(f.gl_files||"").split(";").map(H=>H.trim().split(/[/\\]/).pop()).filter(Boolean).join(", "),v=f.created_at?String(f.created_at).slice(0,16).replace("T"," "):"",E=document.createElement("tr");E.dataset.taskId=f.id;const B=document.createElement("td");B.textContent=v;const T=document.createElement("td");T.className="glv-history-file",T.title=w+" + "+y,T.textContent=w+" + "+y;const S=document.createElement("td");S.className="glv-num",S.textContent=(f.stmt_row_count||0)+" / "+(f.gl_row_count||0);const b=document.createElement("td");b.className="glv-num",b.textContent=f.matched_count||0;const g=document.createElement("td");g.className="glv-num",g.textContent=f.unmatched_gl||0;const x=document.createElement("td");x.className="glv-num",x.textContent=f.unmatched_stmt||0;const I=document.createElement("td");I.className="glv-num",I.style.color=_?"#059669":"#dc2626",I.textContent=_?"✓":qe(h);const L=document.createElement("td");L.className="glv-history-actions";const C=(H,P,F,G)=>{const O=document.createElement("button");return O.type="button",O.title=P,O.setAttribute("aria-label",P),F&&(O.className=F),O.innerHTML=H,O.onclick=ee=>{ee.stopPropagation(),G()},O},k={zh:"删除这条记录?",th:"ลบรายการนี้?",en:"Delete this record?",ja:"この記録を削除しますか?"}[i]||"删除?",M={zh:"加载",th:"โหลด",en:"Load",ja:"読込"}[i]||"加载",$={zh:"导出",th:"ส่งออก",en:"Export",ja:"エクスポート"}[i]||"导出",A={zh:"删除",th:"ลบ",en:"Delete",ja:"削除"}[i]||"删除";L.appendChild(C(m,M,"",()=>ta(f.id,p))),L.appendChild(C(d,$,"",()=>Ga(f.id))),L.appendChild(C(u,A,"glv-del",async()=>{await showConfirm(k,{danger:!0})&&(await fetch("/api/recon/bank-v2/"+f.id,{method:"DELETE",headers:{Authorization:"Bearer "+p}}),_t())})),[B,T,S,b,g,x,I,L].forEach(H=>E.appendChild(H)),E.style.cursor="pointer",E.addEventListener("click",async H=>{H.target.closest(".glv-del")||H.target.closest("button")||await ta(f.id,p)}),s.appendChild(E)}),ea(),Ja()}function Ja(){const e=((U("brv2-hist-search")||{}).value||"").trim().toLowerCase(),n=U("brv2-history-tbody");n&&n.querySelectorAll("tr").forEach(a=>{a.dataset.taskId&&(a.style.display=!e||a.textContent.toLowerCase().includes(e)?"":"none")})}async function ta(e,n){try{const o=await(await fetch("/api/recon/bank-v2/"+e,{headers:{Authorization:"Bearer "+n}})).json();if(!o.ok)return;W.currentTask={task_id:o.task_id,...o},W.allRows=o.detail||[],W.currentFilter="all",document.querySelectorAll(".brv2-filter-btn").forEach(s=>s.classList.toggle("active",s.dataset.filter==="all")),An(W.currentTask)}catch{}}function Me(e){const n=e==="stmt"?W.stmtFiles:W.glFiles,a=U(`brv2-${e}-name`);if(a)if(n.length===0)a.textContent="";else{const s=window._currentLang||"zh",i={zh:"个文件",th:" ไฟล์",en:" file(s)",ja:" ファイル"};a.textContent=n.length+(i[s]||" 个文件")}const o=U("brv2-preview-panel");o&&o.style.display!=="none"&&rn(e),lr()}function lr(){const e=U("brv2-toggle-preview"),n=U("brv2-preview-panel"),a=W.stmtFiles.length+W.glFiles.length>0;e&&(e.style.display=a?"":"none"),!a&&n&&(n.style.display="none",e&&e.classList.remove("open"))}function cr(){rn("stmt"),rn("gl")}function rn(e){const n=U(e==="stmt"?"brv2-pp-stmt-col":"brv2-pp-gl-col");if(!n)return;const a=e==="stmt"?W.stmtFiles:W.glFiles,o=window._currentLang||"zh",s={stmt:{zh:"① 银行账单",th:"① บัญชีธนาคาร",en:"① Bank Stmt",ja:"① 銀行明細"},gl:{zh:"② 总账 GL",th:"② GL รายงาน",en:"② GL Report",ja:"② GL帳簿"}},i=(s[e]||{})[o]||s[e].zh,r=ge(window.t&&window.t("vex-preview-search")||"搜索文件名..."),c=ge(window.t&&window.t("vex-preview-clear-all")||"全清"),l=W.brv2Search[e]||"";n.innerHTML='<div class="vex-pp-col-title"><span class="vex-pp-col-name">'+ge(i)+' <span class="vex-pp-col-count">'+a.length+'</span></span></div><div class="vex-pp-search-row"><input class="vex-pp-search" id="brv2-pp-search-'+e+'" type="text" placeholder="'+r+'" value="'+ge(l)+'" autocomplete="off"><button class="vex-pp-clear-btn" id="brv2-pp-clearall-'+e+'" type="button">'+c+'</button></div><div class="vex-pp-file-list" id="brv2-pp-'+e+'-list"></div><div class="vex-pp-pagination" id="brv2-pp-'+e+'-pg"></div>';const p=U("brv2-pp-search-"+e);p&&p.addEventListener("input",function(d){W.brv2Search[e]=d.target.value,na(e)});const m=U("brv2-pp-clearall-"+e);m&&m.addEventListener("click",function(){e==="stmt"?W.stmtFiles.length=0:W.glFiles.length=0,Me(e),Re()}),na(e)}function na(e){const n=U("brv2-pp-"+e+"-list"),a=U("brv2-pp-"+e+"-pg");if(!n)return;const o=e==="stmt"?W.stmtFiles:W.glFiles,s=(W.brv2Search[e]||"").toLowerCase(),i=s?o.filter(l=>l.name.toLowerCase().includes(s)):o.slice(),r='<svg class="vex-pp-fi-ico" viewBox="0 0 14 16" fill="none" stroke="currentColor" stroke-width="1.4" width="12" height="14"><path d="M3 1h6l3 3v11H3V1z"/><path d="M9 1v3h3"/></svg>',c='<svg viewBox="0 0 14 14" fill="none" stroke="currentColor" stroke-width="1.6" width="11" height="11"><path d="M2 4h10M5 4V2h4v2M5.5 7v4M8.5 7v4M3 4l1 8h6l1-8"/></svg>';if(n.innerHTML=i.map((l,p)=>'<div class="vex-pp-file-row">'+r+'<span class="vex-pp-fi-name" title="'+ge(l.name)+'">'+ge(l.name)+'</span><span class="vex-pp-fi-size">'+Zi(l.size)+'</span><button class="vex-pp-fi-del" type="button" data-zone="'+e+'" data-idx="'+o.indexOf(l)+'" aria-label="remove">'+c+"</button></div>").join(""),n.querySelectorAll(".vex-pp-fi-del").forEach(function(l){l.addEventListener("click",function(){const p=parseInt(l.dataset.idx,10);l.dataset.zone==="stmt"?W.stmtFiles.splice(p,1):W.glFiles.splice(p,1),Me(l.dataset.zone),Re()})}),a){const l=window.t&&window.t("vex-preview-count")||"显示 {n} / 共 {m}";a.textContent=l.replace("{n}",i.length).replace("{m}",o.length)}}function dr(){const e=U("brv2-toggle-preview");e&&!e._reconBound&&(e._reconBound=!0,e.addEventListener("click",function(){const n=U("brv2-preview-panel"),a=U("brv2-toggle-preview-label"),o=n&&n.style.display!=="none";n&&(n.style.display=o?"none":""),e.classList.toggle("open",!o),a&&(a.textContent=o?window.t&&window.t("vex-toggle-preview-open")||"查看清单":window.t&&window.t("vex-toggle-preview-close")||"收起清单"),o||cr()}))}function Re(){const e=U("brv2-run-btn"),n=U("brv2-status"),a=W.stmtFiles.length>0,o=W.glFiles.length>0;if(e&&(e.disabled=!(a&&o)),n){const s=window._currentLang||"zh";if(!a&&!o){const i={zh:"请上传银行账单和 GL 文件",th:"กรุณาอัปโหลดบัญชีธนาคารและ GL",en:"Upload bank statement and GL files",ja:"銀行明細と GL を両方アップロードしてください"};n.textContent=i[s]||i.zh}else if(a)if(o){const i={zh:"两份文件已就绪",th:"พร้อมสอบทาน",en:"Ready to reconcile",ja:"照合を開始できます"};n.textContent=i[s]||i.zh}else{const i={zh:"还缺 GL 文件",th:"ยังขาดไฟล์ GL",en:"Missing GL file",ja:"GL ファイルが未アップロード"};n.textContent=i[s]||i.zh}else{const i={zh:"还缺银行账单 PDF",th:"ยังขาดไฟล์บัญชีธนาคาร PDF",en:"Missing bank statement PDF",ja:"銀行明細 PDF が未アップロード"};n.textContent=i[s]||i.zh}}}function aa(e,n,a){const o=U(e),s=U(n);!o||!s||(o.addEventListener("click",()=>s.click()),o.addEventListener("keydown",i=>{(i.key==="Enter"||i.key===" ")&&(i.preventDefault(),s.click())}),o.addEventListener("dragover",i=>{i.preventDefault(),o.classList.add("drag-over")}),o.addEventListener("dragleave",()=>o.classList.remove("drag-over")),o.addEventListener("drop",i=>{i.preventDefault(),o.classList.remove("drag-over");const r=Array.from(i.dataTransfer.files||[]);a==="stmt"?W.stmtFiles.push(...r):W.glFiles.push(...r),Me(a),Re()}),s.addEventListener("change",()=>{const i=Array.from(s.files||[]);a==="stmt"?W.stmtFiles.push(...i):W.glFiles.push(...i),s.value="",Me(a),Re()}))}function _e(e){const n=U("brv2-progress"),a=U("brv2-run-btn"),o=U("brv2-error");n&&(n.style.display=e?"":"none"),a&&(a.disabled=e),o&&(o.style.display="none")}function Te(e){const n=U("brv2-error");n&&(n.textContent=e,n.style.display="",n.scrollIntoView({behavior:"smooth",block:"nearest"})),_e(!1),Re(),window.showToast&&window.showToast(e,"error")}async function ln(){if(W.stmtFiles.length===0||W.glFiles.length===0)return;const e=localStorage.getItem("mrpilot_token")||"",n=window._currentLang||"zh",a=(U("brv2-acct-select")||{}).value||"";Ft(!1),_e(!0);try{const o=new FormData;W.stmtFiles.forEach(f=>o.append("stmt_files",f)),W.glFiles.forEach(f=>o.append("gl_files",f)),o.append("gl_account",a),o.append("lang",n);const s=parseFloat((U("brv2-anchor-gl-closing")||{}).value),i=parseFloat((U("brv2-anchor-stmt-closing")||{}).value),r=parseFloat((U("brv2-anchor-stmt-opening")||{}).value),c=parseFloat((U("brv2-anchor-gl-opening")||{}).value);Number.isFinite(s)&&o.append("gl_closing_override",s),Number.isFinite(i)&&o.append("stmt_closing_override",i),Number.isFinite(r)&&o.append("stmt_opening_override",r),Number.isFinite(c)&&o.append("gl_opening_override",c);const l=await fetch("/api/recon/bank-v2/submit",{method:"POST",headers:{Authorization:"Bearer "+e},body:o});let p=null;try{p=await l.json()}catch{p=null}if(p&&p.needs_mapping){_e(!1),window.ReconMapping?window.ReconMapping.show(p,{token:e,lang:n,onConfirmed:function(){ln()}}):Te(t("brv2-err-server")||"服务器繁忙,请稍后重试");return}if(!l.ok||!p||!p.ok||!p.job_id){_e(!1),p&&(p.detail||p.error)?Te(_humanizeBackendError(p.detail||p.error,"Error "+l.status)):Te(t("brv2-err-server")||"服务器繁忙,请稍后重试");return}const m=U("brv2-progress-sub"),d=await window._reconPollJob(p.job_id,e,{onProgress:f=>{m&&(m.textContent=window._reconProgressText(f,n))}});if(d&&d.status==="needs_mapping"&&d.mapping){_e(!1),window.ReconMapping?window.ReconMapping.show(d.mapping,{token:e,lang:n,onConfirmed:function(){ln()}}):Te(t("brv2-err-server")||"服务器繁忙,请稍后重试");return}if(d&&d.status==="needs_review"&&d.review){_e(!1),window.ReconReview?window.ReconReview.show(d.review,{token:e,lang:n,jobId:p.job_id,onConfirmed:async function(f){_e(!0);const h=await window._reconPollJob(f,e,{onProgress:_=>{m&&(m.textContent=window._reconProgressText(_,n))}});await u(h)}}):Te(t("brv2-err-server")||"服务器繁忙,请稍后重试");return}if(d&&d.status==="failed"){_e(!1),Te(Xi(d.error_code,n));return}await u(d);async function u(f){try{if(!f||f.status!=="done"||!f.result_id){_e(!1),Te(t("brv2-err-server")||"服务器繁忙,请稍后重试");return}const h=await fetch("/api/recon/bank-v2/"+encodeURIComponent(f.result_id),{headers:{Authorization:"Bearer "+e}});let _=null;try{_=await h.json()}catch{_=null}if(!h.ok||_===null||!_.ok){_e(!1),Te(t("brv2-err-server")||"服务器繁忙,请稍后重试");return}(_.gl_accounts||[]).length>1&&pr(_.gl_accounts),W.currentTask=_,W.allRows=_.detail||[],W.currentFilter="all",document.querySelectorAll(".brv2-filter-btn").forEach(y=>y.classList.toggle("active",y.dataset.filter==="all")),Qi(_&&_.summary),_e(!1),An(_),_t();const w=U("brv2-summary-collapse");w&&w.scrollIntoView({behavior:"smooth",block:"nearest"})}catch(h){_e(!1),Te(h.message||"Network error")}}}catch(o){Te(o.message||"Network error")}}function pr(e){const n=U("brv2-acct-select");if(!n)return;const a=window._currentLang||"zh",o={zh:"全部账户",th:"ทุกบัญชี",en:"All Accounts",ja:"すべての口座"}[a]||"全部账户";n.innerHTML=`<option value="">${o}</option>`+e.map(s=>`<option value="${ge(s)}">${ge(s)}</option>`).join(""),n.style.display=""}function jn(){if(W.initialized){_t();return}W.initialized=!0,aa("brv2-stmt-zone","brv2-stmt-input","stmt"),aa("brv2-gl-zone","brv2-gl-input","gl");const e=["brv2-anchor-gl-closing","brv2-anchor-stmt-closing","brv2-anchor-stmt-opening","brv2-anchor-gl-opening"];function n(){const c=parseFloat((U("brv2-anchor-stmt-opening")||{}).value),l=parseFloat((U("brv2-anchor-gl-opening")||{}).value),p=U("brv2-anchor-eq"),m=U("brv2-anchor-eq-val");if(!(!p||!m))if(Number.isFinite(c)&&Number.isFinite(l)){const d=c-l;m.textContent=d.toLocaleString(void 0,{minimumFractionDigits:2,maximumFractionDigits:2}),p.style.display=""}else p.style.display="none"}e.forEach(c=>{const l=U(c);l&&(l.addEventListener("input",n),l.addEventListener("input",()=>{const p=l.closest(".brv2-anchor-cell");p&&p.classList.remove("is-prefilled"),nr()}))}),tr();const a=U("brv2-run-btn");a&&a.addEventListener("click",ln);const o=U("brv2-reset-btn");o&&o.addEventListener("click",()=>{W.currentTask=null,W.allRows=[],W.stmtFiles=[],W.glFiles=[],Me("stmt"),Me("gl"),Re(),Ft(!1);const c=U("brv2-acct-select");c&&(c.style.display="none"),e.forEach(m=>{const d=U(m);if(d){d.value="";const u=d.closest&&d.closest(".brv2-anchor-cell");u&&u.classList.remove("is-prefilled")}});const l=U("brv2-anchor-eq");l&&(l.style.display="none");const p=U("brv2-anchor-prefill-banner");p&&p.classList.remove("show")});const s=U("brv2-new-btn");s&&s.addEventListener("click",()=>{W.currentTask=null,W.allRows=[],W.stmtFiles=[],W.glFiles=[],Me("stmt"),Me("gl"),Re(),Ft(!1)});const i=U("brv2-filter-tabs");i&&i.addEventListener("click",c=>{c.stopPropagation();const l=c.target.closest(".brv2-filter-btn");l&&(W.currentFilter=l.dataset.filter,i.querySelectorAll(".brv2-filter-btn").forEach(p=>p.classList.toggle("active",p===l)),Ka())}),dr(),rr();const r=U("brv2-hist-search");r&&r.addEventListener("input",Ja),_t(),Re(),window._brv2LoadHistory=_t,Array.isArray(window.__i18nSubs)||(window.__i18nSubs=[]),window.__i18nSubs=window.__i18nSubs.filter(c=>c.name!=="brv2"),window.__i18nSubs.push({name:"brv2",fn:function(){Re(),Me("stmt"),Me("gl"),W.currentTask&&An(W.currentTask),zt()}})}window._loadBankReconV2Panel=function(e){const n=e?document.getElementById(e):null;n&&n.id!=="recon-pane-bank"&&(n.innerHTML=`<div style="padding:16px;font-size:13px;color:var(--ink-3)">
            银行对账 v2 · 请前往对账中心使用</div>`),jn()};document.addEventListener("DOMContentLoaded",()=>{U("brv2-run-btn")&&jn()});window._bankReconV2Init=jn;(function(){const e=document.getElementById("general-lang");if(!e)return;e.addEventListener("change",a=>{const o=a.target.value;o&&applyLang(o)});const n=typeof currentLang=="string"&&currentLang||localStorage.getItem("mrpilot_lang")||"th";e.value=n})();(function(){const n="pearnly_general_tz",a="pearnly_general_date_format",o="pearnly_general_number_format",s={tz:"Asia/Bangkok",date:"YYYY-MM-DD",number:"comma_dot"};function i(){const p=document.getElementById("general-tz"),m=document.getElementById("general-date"),d=document.getElementById("general-number");if(!(!p||!m||!d))try{p.value=localStorage.getItem(n)||s.tz,m.value=localStorage.getItem(a)||s.date,d.value=localStorage.getItem(o)||s.number}catch{p.value=s.tz,m.value=s.date,d.value=s.number}}async function r(){const p=document.getElementById("btn-save-general"),m=document.getElementById("general-save-msg");if(!p)return;const d=p.innerHTML;p.disabled=!0,p.innerHTML="<span>"+(t("msg-saving")||"保存中...")+"</span>",m&&(m.textContent="",m.classList.remove("error"));try{const u=(document.getElementById("general-tz")||{}).value||s.tz,f=(document.getElementById("general-date")||{}).value||s.date,h=(document.getElementById("general-number")||{}).value||s.number;try{localStorage.setItem(n,u),localStorage.setItem(a,f),localStorage.setItem(o,h)}catch{}window._pearnlyGeneral={tz:u,date_format:f,number_format:h},m&&(m.textContent=t("msg-saved")||"已保存")}catch{m&&(m.textContent=t("msg-save-failed")||"保存失败",m.classList.add("error"))}finally{p.disabled=!1,p.innerHTML=d,setTimeout(function(){m&&(m.textContent="")},3e3)}}function c(){const p=document.getElementById("btn-save-general");if(!p){setTimeout(c,200);return}p._pearnlyGenBound||(p._pearnlyGenBound=!0,p.addEventListener("click",r),i())}function l(){i();const p=document.getElementById("general-lang");if(p){const m=typeof currentLang=="string"&&currentLang||localStorage.getItem("mrpilot_lang")||"th";p.value=m}}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",c):c(),typeof window.subscribeI18n=="function"&&window.subscribeI18n("settings-general",l)})();(function(){const e="mrpilot_nav_collapsed",n={ocr:"sales",history:"sales",reconcile:"sales","sales-invoices":"sales",receivables:"sales",vouchers:"expense"};function a(){try{const r=localStorage.getItem(e);return r?JSON.parse(r):{}}catch{return{}}}function o(r){try{localStorage.setItem(e,JSON.stringify(r))}catch{}}function s(){const r=a();document.querySelectorAll(".nav-collapsible").forEach(function(c){const l=c.dataset.collapsible;r[l]?c.classList.add("collapsed"):c.classList.remove("collapsed")})}function i(r){const c=a();c[r]=!c[r],o(c),s()}(function(){const c=a();let l=!1;c.sales===void 0&&(c.sales=!1,l=!0),c.expense===void 0&&(c.expense=!0,l=!0),l&&o(c)})(),s(),document.querySelectorAll(".nav-group-toggle").forEach(function(r){r.addEventListener("click",function(){i(r.dataset.toggleGroup)})}),window.expandNavGroupForRoute=function(r){const c=n[r];if(!c)return;const l=a();l[c]&&(l[c]=!1,o(l),s())}})();const ur=`
    <div class="modal" style="max-width:440px">
        ...
        `}).join(""),_userInfo&&_userInfo.endpoints_limit!==-1){const s=Ie.length,i=_userInfo.endpoints_limit,r=_userInfo.plan,c=document.createElement("div");c.className="erp-limit-hint",r==="free"?c.innerHTML=`${escapeHtml(t("ep-free-limit-hint",{used:s,limit:i}))} <a data-upgrade="plus">${escapeHtml(t("upgrade-to-plus"))}</a>`:c.textContent=t("ep-plus-limit-hint",{used:s,limit:i}),e.appendChild(c)}}function fr(e){Ct=e||null;const n=document.getElementById("endpoint-modal"),a=document.getElementById("endpoint-modal-title");a.textContent=e?t("ep-modal-title-edit"):t("ep-modal-title-new");const o=document.getElementById("ep-name"),s=document.getElementById("ep-url"),i=document.getElementById("ep-token"),r=document.getElementById("ep-is-default"),c=document.getElementById("ep-auto-push"),l=document.getElementById("ep-test-result");l.style.display="none",l.textContent="";const p=document.getElementById("ep-save-error");if(p&&p.remove(),e){const d=Ie.find(u=>u.id===e);if(!d)return;o.value=d.name||"",s.value=(d.config||{}).url||"",i.value=(d.config||{})._token_set&&d.config.token||"",i.placeholder=(d.config||{})._token_set?"（已保存 · 留空保持不变）":t("ep-token-ph"),r.checked=!!d.is_default,c.checked=!!d.auto_push}else o.value="",s.value="",i.value="",i.placeholder=t("ep-token-ph"),r.checked=Ie.length===0,c.checked=!0;const m=c.closest(".form-switch-row");if(c.disabled=!1,m){m.classList.remove("disabled-plus"),m.title="",m.style.cursor="",m.onclick=null;const d=m.querySelector(".plus-badge");d&&d.remove()}n.style.display="",setTimeout(()=>o.focus(),50)}function Xa(){document.getElementById("endpoint-modal").style.display="none",Ct=null;const e=document.getElementById("ep-save-error");e&&e.remove()}function Za(e){if(!e)return"";let n=e.trim();const a=n.search(/\s/);return a>=0&&(n=n.slice(0,a)),n}function Qa(){const e=document.getElementById("ep-name").value.trim(),n=Za(document.getElementById("ep-url").value),a=document.getElementById("ep-token").value,o=document.getElementById("ep-is-default").checked,s=document.getElementById("ep-auto-push").checked,i={url:n};return a&&(i.token=a),{name:e,url:n,tokenVal:a,isDefault:o,autoPush:s,config:i}}async function mr(){const{url:e,config:n}=Qa(),a=document.getElementById("ep-test-result");if(!e){a.style.display="",a.className="form-test-result fail",a.textContent=t("ep-required");return}a.style.display="",a.className="form-test-result running",a.textContent=t("ep-test-running");try{const s=await(await fetch("/api/erp/test-connection",{method:"POST",headers:{Authorization:"Bearer "+token,"Content-Type":"application/json"},body:JSON.stringify({adapter:"webhook",config:n})})).json();s.success?(a.className="form-test-result ok",a.textContent=t("ep-test-ok",{status:s.http_status,ms:s.elapsed_ms})):(a.className="form-test-result fail",a.textContent=t("ep-test-fail",{err:s.error_msg||"unknown"}))}catch(o){a.className="form-test-result fail",a.textContent=t("ep-test-fail",{err:o.message})}}async function vr(){const e=Qa(),n=document.getElementById("ep-save-error");if(n&&(n.style.display="none"),!e.name||!e.url){sa(t("ep-required"));return}const a={name:e.name,adapter:"webhook",config:e.config,is_default:e.isDefault,auto_push:e.autoPush},o=document.getElementById("btn-ep-save"),s=o.innerHTML;o.disabled=!0,o.classList.add("loading");try{let i;if(Ct?i=await fetch(`/api/erp/endpoints/${encodeURIComponent(Ct)}`,{method:"PATCH",headers:{Authorization:"Bearer "+token,"Content-Type":"application/json"},body:JSON.stringify(a)}):i=await fetch("/api/erp/endpoints",{method:"POST",headers:{Authorization:"Bearer "+token,"Content-Type":"application/json"},body:JSON.stringify(a)}),!i.ok){const c=(await i.json().catch(()=>({}))).detail||`HTTP ${i.status}`;throw new Error(typeof c=="string"?c:JSON.stringify(c))}Xa(),showToast(t("ep-save-ok")),Wt()}catch(i){sa(`${t("ep-save-fail")} · ${i.message||"unknown"}`)}finally{o.disabled=!1,o.classList.remove("loading"),o.innerHTML=s}}function sa(e){let n=document.getElementById("ep-save-error");if(!n){const a=document.querySelector("#endpoint-modal .modal-foot");if(!a)return;n=document.createElement("div"),n.id="ep-save-error",n.className="ep-inline-error",a.parentNode.insertBefore(n,a)}n.textContent=e,n.style.display=""}async function hr(e){const n=Ie.find(o=>o.id===e);if(!(!n||!await showConfirm(t("ep-delete-confirm",{name:n.name}),{danger:!0})))try{if(!(await fetch(`/api/erp/endpoints/${encodeURIComponent(e)}`,{method:"DELETE",headers:{Authorization:"Bearer "+token}})).ok)throw new Error;showToast(t("ep-delete-ok")),Wt()}catch{showToast(t("ep-save-fail"),"fail")}}window.loadErpEndpoints=Wt;window.loadErpTodayStats=Wa;window.renderErpEndpointsList=Ya;window.openEndpointModal=fr;window.closeEndpointModal=Xa;window.saveEndpoint=vr;window.deleteEndpoint=hr;window.testEndpointConnection=mr;window._sanitizeUrl=Za;async function eo(e){if(e=(e||"").trim(),!!e)try{await navigator.clipboard.writeText(e),showToast(t("erp-doc-copy-ok",{no:e}),"success")}catch{try{const a=document.createElement("textarea");a.value=e,a.style.position="fixed",a.style.opacity="0",document.body.appendChild(a),a.select(),document.execCommand("copy"),a.remove(),showToast(t("erp-doc-copy-ok",{no:e}),"success")}catch{showToast(t("erp-doc-copy-fail"),"error")}}}async function gr(e){const n=document.createElement("div");n.className="log-detail-modal",n.innerHTML=`
        <div class="log-detail-box">
            <div class="log-detail-loading">${escapeHtml(t("log-detail-loading"))}</div>
        </div>
    `,document.body.appendChild(n),n.addEventListener("click",async a=>{if(a.target===n||a.target.classList.contains("log-detail-close")){n.remove();return}const o=a.target.closest("[data-receipt-copy]");if(o){eo(o.dataset.receiptCopy);return}const s=a.target.closest("[data-receipt-action]");if(s){const i=s.dataset.receiptAction;i==="retry"?window.retryPushLog(s.dataset.logId):i==="exceptions"?typeof routeTo=="function"&&routeTo("exceptions"):i==="mappings"&&typeof routeTo=="function"&&routeTo("integrations"),n.remove();return}});try{const a=await fetch(`/api/erp/logs/${encodeURIComponent(e)}`,{headers:{Authorization:"Bearer "+token}});if(!a.ok){n.remove();return}const o=await a.json(),s=window._erpEndpoints.find(C=>C.id===o.endpoint_id),i=o.endpoint_name||(s?s.name:o.endpoint_id?t("erp-log-endpoint-deleted"):"-"),r=(o.endpoint_adapter||s&&s.adapter||"").toLowerCase(),c=new Date(o.created_at).toLocaleString(),l=o.trigger==="auto"?t("log-tag-auto"):o.trigger==="retry"?t("log-tag-retry"):t("log-tag-manual"),p=o.request_body?JSON.stringify(o.request_body,null,2):t("erp-receipt-no-tech"),m=o.response_body||t("erp-receipt-no-tech"),d=o.status==="success";let u=typeof m=="string"?m:JSON.stringify(m,null,2);if(d)try{const C=typeof o.response_body=="string"?JSON.parse(o.response_body):o.response_body||{},k=C.row_count||(Array.isArray(C.imported_rows)?C.imported_rows.length:0);k>0&&(u=t("log-push-rows").replace("{n}",String(k)))}catch{}const f=(o.external_doc_no||"").trim(),h=(o.external_url||"").trim(),_=(o.external_doc_hint||"").trim(),w=(o.ocr_buyer_name||"").trim()||o.client_name||"-",y=o.seller_name||"-",v=o.push_type==="id_card";let E="-";const B=Number(o.total_amount);o.total_amount!=null&&o.total_amount!==""&&!isNaN(B)&&(E=B.toLocaleString("en-US",{minimumFractionDigits:2,maximumFractionDigits:2}));const T=d?t("erp-receipt-title-ok"):t("erp-receipt-title-fail"),S=d?"✓":"✗",b=[],g=(C,k)=>{b.push(`
                <div class="erp-receipt-row">
                    <span class="erp-receipt-key">${escapeHtml(C)}</span>
                    <span class="erp-receipt-val">${k}</span>
                </div>`)};if(g(v?t("erp-log-col-booking"):t("erp-receipt-invoice-no"),`<strong>${escapeHtml(o.invoice_no||"-")}</strong>`),g(t("erp-receipt-erp-name"),escapeHtml(i)),d){let C;f?C=`<strong class="erp-receipt-docno">${escapeHtml(f)}</strong><button class="erp-receipt-copy-btn" type="button" data-receipt-copy="${escapeHtml(f)}" title="${escapeHtml(t("erp-doc-copy-tip"))}">${escapeHtml(t("erp-receipt-copy-btn"))}</button>`:C=`<span class="erp-receipt-docno-missing">${escapeHtml(t("erp-log-doc-missing"))}</span>`,g(t("erp-receipt-doc-no"),C)}v||g(t("erp-receipt-client"),escapeHtml(w)),g(v?t("erp-log-col-customer"):t("erp-receipt-seller"),escapeHtml(y)),d&&g(t("erp-receipt-amount"),escapeHtml(E)),g(t("erp-receipt-time"),escapeHtml(c)),g(t("erp-receipt-elapsed"),escapeHtml((o.elapsed_ms!=null?o.elapsed_ms:"-")+"ms"));let x="";d&&h?x=`<a class="erp-receipt-primary-btn" href="${escapeHtml(h)}" target="_blank" rel="noopener">${escapeHtml(t("erp-receipt-open-erp"))}</a>`:d&&f&&(x=`<button class="erp-receipt-primary-btn" type="button" data-receipt-copy="${escapeHtml(f)}">${escapeHtml(t("erp-receipt-copy-docno"))}</button>`);let I="";if(d&&f&&_){const C="erp-receipt-hint-"+_,k=t(C);k&&k!==C&&(I=`<div class="erp-receipt-hint"><svg class="erp-receipt-hint-ic" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><circle cx="12" cy="12" r="9"/><line x1="12" y1="11" x2="12" y2="16"/><line x1="12" y1="8" x2="12.01" y2="8"/></svg><span>${escapeHtml(k)}</span></div>`)}let L="";if(!d){const C=(o.error_msg||"").match(/ERR_[A-Z0-9_]+/),k=C?C[0]:"",M=typeof currentLang=="string"&&currentLang||window._currentLang||"th",A=o.error_friendly&&o.error_friendly[M]||(o.error_msg?humanizeError(o.error_msg):t("erp-receipt-no-error")),H=/ERR_NO_CUSTOMER_MAPPING|ERR_NO_CLIENT|ERR_NO_SEED_CUSTOMER|ERR_NO_SEED_PRODUCT/.test(o.error_msg||""),P=!!(o.history_id&&o.endpoint_id),F=[];F.push(`<button class="erp-receipt-action-btn" type="button" data-receipt-action="exceptions">${escapeHtml(t("erp-receipt-act-exceptions"))}</button>`),H&&F.push(`<button class="erp-receipt-action-btn" type="button" data-receipt-action="mappings">${escapeHtml(t("erp-receipt-act-mapping"))}</button>`),P&&F.push(`<button class="erp-receipt-action-btn primary" type="button" data-receipt-action="retry" data-log-id="${escapeHtml(o.id)}">${escapeHtml(t("erp-receipt-act-retry"))}</button>`),L=`
            ...
            <div class="log-detail-head">
                <div class="log-detail-title">
                    <span class="log-detail-status-icon ${d?"ok":"fail"}">${S}</span>
                    ${escapeHtml(T)}
        ...
        `}catch(a){console.error(a),n.remove()}}window.copyErpDocNo=eo;window.showLogDetail=gr;const br=`
        <div class="modal">
            <div class="modal-head">
    ...
    `;we("endpoint-modal",br);let ht={key:"all",val:""},Et="",en=!1,Pe=new Set;window._erpSelected=Pe;async function yr(){const e=document.getElementById("erp-logs-erp-select");if(!(!e||en)){en=!0;try{let n=window._erpEndpoints;if(!Array.isArray(n)||n.length===0){const s=await fetch("/api/erp/endpoints",{headers:{Authorization:"Bearer "+token}});if(s.ok){const i=await s.json();n=i&&(i.items||i)||[]}}Array.isArray(n)||(n=[]);const a=new Set,o=[];n.forEach(s=>{const i=(s&&s.adapter||"").toLowerCase();!i||a.has(i)||(a.add(i),o.push({val:i,label:s&&s.name||i}))}),e.innerHTML=`<option value="">${escapeHtml(t("erp-logs-erp-all"))}</option>`+o.map(s=>`<option value="${escapeHtml(s.val)}"${s.val===Et?" selected":""}>${escapeHtml(s.label)}</option>`).join("")}catch{en=!1}}}async function ot(e){const n=document.getElementById("erp-logs-list");if(n){e||(n.innerHTML=`<div class="erp-logs-empty">${escapeHtml(t("erp-logs-loading"))}</div>`),window.loadErpTodayStats(),yr();try{const a=new URLSearchParams({limit:"30"});ht.key==="status"&&a.set("status",ht.val),ht.key==="trigger"&&a.set("trigger",ht.val),Et&&a.set("adapter",Et);const o=await fetch(`/api/erp/logs?${a}`,{headers:{Authorization:"Bearer "+token}});if(!o.ok){n.innerHTML=`<div class="erp-logs-empty">${escapeHtml(t("erp-logs-error"))}</div>`;return}const i=(await o.json()).items||[];if(window._erpLogPollTimer&&(clearTimeout(window._erpLogPollTimer),window._erpLogPollTimer=null),i.some(function(f){return f.status==="pending"})&&(window._erpLogPollTimer=setTimeout(function(){ot(!0)},4e3)),i.length===0){n.innerHTML=`<div class="erp-logs-empty">${escapeHtml(t("erp-logs-empty"))}</div>`;return}const r=i.filter(function(f){var h=f.status==="failed"&&f.next_retry_at&&new Date(f.next_retry_at).getTime()>Date.now()-6e4;return!h}).map(function(f){return f.id}),c=Et==="mrerp_dms",l=c?t("erp-log-col-booking"):t("erp-log-col-invoice"),p=c?t("erp-log-col-customer"):t("erp-log-col-seller"),m=c?t("erp-log-col-idcard"):t("erp-log-col-client"),d='<div class="erp-log-row erp-log-row-header" data-log-header>'+(r.length>0?`<input type="checkbox" class="erp-log-cb erp-log-cb-all" data-log-select-all title="${escapeHtml(t("erp-log-select-all-tip"))}">`:'<span class="erp-log-cb-spacer"></span>')+`<span class="log-time">${escapeHtml(t("erp-log-col-time"))}</span><span class="log-status">${escapeHtml(t("erp-log-col-status"))}</span><span class="log-tag-header">${escapeHtml(t("erp-log-col-trigger"))}</span><span class="log-invoice">${escapeHtml(l)}</span><span class="log-workspace">${escapeHtml(t("erp-log-col-workspace"))}</span><span class="log-client">${escapeHtml(m)}</span><span class="log-seller">${escapeHtml(p)}</span><span class="log-erp">${escapeHtml(t("erp-log-col-erp"))}</span><span class="log-doc">${escapeHtml(t("erp-log-col-doc"))}</span><span class="log-http">${escapeHtml(t("erp-log-col-http"))}</span><span class="log-elapsed">${escapeHtml(t("erp-log-col-elapsed"))}</span><span class="log-actions"></span></div>`;n.innerHTML=d+i.map(f=>{const h=new Date(f.created_at),_=`${String(h.getMonth()+1).padStart(2,"0")}-${String(h.getDate()).padStart(2,"0")} ${String(h.getHours()).padStart(2,"0")}:${String(h.getMinutes()).padStart(2,"0")}`,w=f.status==="failed"&&f.next_retry_at&&new Date(f.next_retry_at).getTime()>Date.now()-6e4;let y,v,E;f.status==="pending"?(y="retrying",v="⟳",E=t("erp-status-pending")):f.status==="success"?(y="ok",v="✓",E=t("erp-status-success")):f.status==="skipped_dup"?(y="skipped",v="⏭",E=t("erp-status-skipped")):w?(y="retrying",v="↻",E=t("erp-status-retrying")):(y="fail",v="✗",E=t("erp-status-failed"));let B;f.trigger==="auto"?B=`<span class="log-tag auto">${escapeHtml(t("log-tag-auto"))}</span>`:f.trigger==="retry"?B=`<span class="log-tag retry">${escapeHtml(t("log-tag-retry"))}</span>`:B=`<span class="log-tag manual">${escapeHtml(t("log-tag-manual"))}</span>`;const T=f.push_type==="id_card",S=T?`<span class="log-tag log-type-idcard">${escapeHtml(t("erp-log-type-idcard"))}</span>`:"",b=f.error_friendly&&(f.error_friendly[currentLang]||f.error_friendly.en)||"";let g="";const x=f.retry_count||0,I=f.max_retries||3;if(w){const ee=new Date(f.next_retry_at).getTime()-Date.now(),de=Math.max(0,Math.round(ee/6e4)),me=de<=0?t("erp-retry-next-soon"):t("erp-retry-next-min",{n:de});g=`${t("erp-retry-attempt",{n:x,max:I})} · ${me}`}else f.status==="failed"&&x>=I&&!f.next_retry_at&&(g=t("erp-retry-exhausted",{n:x}));const L=f.status==="failed"&&!w?`<button class="log-retry-btn btn btn-icon" data-log-retry="${escapeHtml(f.id)}" title="${escapeHtml(t("log-retry-title"))}">↻</button>`:"",C=!w,k=Pe.has(f.id)?"checked":"",M=C?`<input type="checkbox" class="erp-log-cb" data-log-cb="${escapeHtml(f.id)}" ${k}>`:'<span class="erp-log-cb-spacer"></span>',$=(f.ocr_buyer_name||"").trim()||(f.client_name||"").trim(),A=T?`<span class="log-client" title="${escapeHtml(t("erp-log-col-idcard"))}">${f.id_card_tail?"••••"+escapeHtml(f.id_card_tail):"—"}</span>`:$?`<span class="log-client" title="${escapeHtml($)}">${escapeHtml($.substring(0,18))}</span>`:`<span class="log-client log-client-empty" title="${escapeHtml(t("erp-log-client-unassigned-tip"))}">${escapeHtml(t("erp-log-client-unassigned"))}</span>`,H=T?'<span class="log-workspace log-workspace-unresolved">—</span>':f.workspace_name?`<span class="log-workspace">${escapeHtml((f.workspace_name||"").substring(0,16))}</span>`:`<span class="log-workspace log-workspace-unresolved" title="${escapeHtml(t("erp-log-ws-unresolved-tip"))}">${escapeHtml(t("erp-log-ws-unresolved"))}</span>`,P=f.endpoint_name?`<span class="log-erp">${escapeHtml((f.endpoint_name||"").substring(0,14))}</span>`:`<span class="log-erp log-erp-deleted">${escapeHtml(t("erp-log-endpoint-deleted"))}</span>`,F=(f.external_doc_no||"").trim(),G=(f.external_url||"").trim();let O;return G?O=`<span class="log-doc"><a href="${escapeHtml(G)}" target="_blank" rel="noopener" class="log-doc-open" title="${escapeHtml(F||"")}">${escapeHtml(t("erp-log-doc-open"))}</a></span>`:F?O=`<span class="log-doc log-doc-copy" data-copy-doc="${escapeHtml(F)}" title="${escapeHtml(t("erp-log-doc-copy-tip"))}">${escapeHtml(F.substring(0,18))}</span>`:f.status==="success"?O=`<span class="log-doc log-doc-missing" title="${escapeHtml(t("erp-log-doc-missing-tip"))}">${escapeHtml(t("erp-log-doc-missing"))}</span>`:O='<span class="log-doc log-doc-empty">-</span>',`
                <div class="erp-log-row ${y}" data-log-detail="${escapeHtml(f.id)}">
                    ${M}
                    <span class="log-time">${_}</span>
                    <span class="log-status" title="${escapeHtml(E+(g?" · "+g:"")+(b?" · "+b:""))}">${v}</span>
                    ${B}${S}
        ...
        `,document.body.appendChild(c),e=c;const l=c.querySelector("#line-email-input"),p=c.querySelector("#line-email-submit-btn"),m=c.querySelector("#line-email-err");async function d(){m.textContent="";const u=(l.value||"").trim().toLowerCase();if(!u||u.indexOf("@")<0||u.split("@")[1].indexOf(".")<0){m.textContent=t("line-email-err-invalid");return}p.disabled=!0,p.style.opacity="0.6";try{const f=await fetch("/api/me/line_complete_email",{method:"POST",headers:{"Content-Type":"application/json",Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||"")},body:JSON.stringify({email:u})});if(!f.ok)throw new Error("http_"+f.status);const h=await f.json();h.token&&localStorage.setItem("mrpilot_token",h.token),typeof showToast=="function"&&showToast(h.merged?t("line-email-merged-toast"):t("line-email-saved-toast"),"success"),setTimeout(function(){window.location.reload()},600)}catch{m.textContent=t("line-email-err-failed"),p.disabled=!1,p.style.opacity="1"}}return p.addEventListener("click",d),l.addEventListener("keydown",function(u){u.key==="Enter"&&d()}),c}function o(){if(!e)return;const c=e.querySelector("#line-email-title-h"),l=e.querySelector("#line-email-sub-p"),p=e.querySelector("#line-email-input"),m=e.querySelector("#line-email-submit-btn");c&&(c.textContent=t("line-email-title")),l&&(l.textContent=t("line-email-sub")),p&&(p.placeholder=t("line-email-placeholder")),m&&(m.textContent=t("line-email-submit"))}function s(){a(),o(),e.style.display="flex",n=!0;const c=e.querySelector("#line-email-input");c&&setTimeout(function(){c.focus()},100)}async function i(){const c=localStorage.getItem("mrpilot_token");if(c)try{const l=await fetch("/api/me/needs_email",{headers:{Authorization:"Bearer "+c}});if(!l.ok)return;const p=await l.json();p&&p.needs_email&&s()}catch{}}function r(){setTimeout(i,800)}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",r):r(),typeof window.subscribeI18n=="function"&&window.subscribeI18n("line-email-modal",function(){n&&o()})})();(function(){function e(m){let d=0;return m.length>=8&&d++,m.length>=12&&d++,/[a-zA-Z]/.test(m)&&/\d/.test(m)&&d++,/[^a-zA-Z0-9]/.test(m)&&d++,Math.min(3,d)}function n(m,d){const u=document.getElementById("cpw-msg");u&&(u.textContent=m,u.className="cpw-msg "+(d||""))}function a(m){return typeof t=="function"?t(m):m}let o=!1;function s(){["cpw-old","cpw-new","cpw-confirm"].forEach(d=>{const u=document.getElementById(d);u&&(u.value="",u.setAttribute("readonly","readonly"))});const m=document.getElementById("cpw-strength-bar");m&&(m.style.width="0%",m.className="cpw-strength-bar"),n("","")}async function i(){const m=document.getElementById("btn-change-pw"),d=document.getElementById("cpw-old"),u=document.getElementById("cpw-new"),f=document.getElementById("cpw-confirm"),h=document.getElementById("cpw-strength-bar");if(!m||!d||!u||!f)return;const _=d.value,w=u.value,y=f.value;if(!_||!w||!y){n(a("settings-change-pw-empty"),"error");return}if(w.length<8){n(a("settings-change-pw-too-short"),"error");return}if(!(/[a-zA-Z]/.test(w)&&/\d/.test(w))){n(a("settings-change-pw-too-weak"),"error");return}if(w!==y){n(a("settings-change-pw-mismatch"),"error");return}m.disabled=!0;const v=m.textContent;m.textContent=a("settings-change-pw-submitting"),n("","");try{const E=localStorage.getItem("mrpilot_token"),B=await fetch("/api/me/change_password",{method:"POST",headers:{"Content-Type":"application/json",Authorization:"Bearer "+E},body:JSON.stringify({old_password:_,new_password:w})}),T=await B.json().catch(()=>({}));if(B.ok&&T.ok)n(a("settings-change-pw-success"),"success"),typeof showToast=="function"&&showToast(a("settings-change-pw-success"),"success"),d.value="",u.value="",f.value="",h&&(h.style.width="0%",h.className="cpw-strength-bar");else{const S=T.detail||"";let b=a("settings-change-pw-success");S==="wrong_old_password"?b=a("settings-change-pw-wrong-old"):S==="password_too_short"?b=a("settings-change-pw-too-short"):S==="password_too_weak"?b=a("settings-change-pw-too-weak"):b=S||"Error",n(b,"error")}}catch(E){console.error("change_password",E),n("Network error","error")}finally{m.disabled=!1,m.textContent=v}}function r(){o||(o=!0,document.addEventListener("click",m=>{if(!m.target||!m.target.closest)return;const d=m.target.closest(".cpw-eye");if(d){const u=document.getElementById(d.dataset.target);u&&(u.type=u.type==="password"?"text":"password");return}if(m.target.closest("#cpw-forgot-link")){m.preventDefault(),c();return}if(m.target.closest("#btn-change-pw")){i();return}m.target.closest('.settings-nav-item[data-settings-tab="account"], .settings-nav-item[data-tab="account"], .settings-nav-item[data-tab="security"]')&&setTimeout(s,100)}),document.addEventListener("input",m=>{if(m.target&&m.target.id==="cpw-new"){const d=document.getElementById("cpw-strength-bar");if(!d)return;const u=e(m.target.value),f=["0%","33%","66%","100%"],h=["","weak","medium","strong"];d.style.width=f[u],d.className="cpw-strength-bar "+h[u]}}),document.addEventListener("focusin",m=>{m.target&&["cpw-old","cpw-new","cpw-confirm"].includes(m.target.id)&&m.target.removeAttribute("readonly")}),document.getElementById("cpw-old")&&s())}function c(){const m=window._userInfo||(typeof _userInfo<"u"?_userInfo:null),d=m&&m.username?m.username:"",u=l(d);let f=document.getElementById("cpw-forgot-overlay");f&&f.remove(),f=document.createElement("div"),f.id="cpw-forgot-overlay",f.className="cpw-forgot-overlay",f.innerHTML=`
        ...
        `,document.body.appendChild(f);const h=()=>f.remove();f.querySelector("#cpw-forgot-close").addEventListener("click",h),f.querySelector("#cpw-forgot-cancel").addEventListener("click",h),f.addEventListener("click",_=>{_.target===f&&h()}),f.querySelector("#cpw-forgot-send").addEventListener("click",async()=>{const _=f.querySelector("#cpw-forgot-send"),w=f.querySelector("#cpw-forgot-msg");_.disabled=!0;const y=_.textContent;_.textContent=a("cpw-forgot-sending");try{const v=await fetch("/api/auth/forgot_password",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:d})}),E=await v.json().catch(()=>({}));v.ok?(w.textContent=a("cpw-forgot-success"),w.className="cpw-forgot-msg success",_.style.display="none",f.querySelector("#cpw-forgot-cancel").textContent=a("cpw-forgot-close-btn")):(w.textContent=E.detail||a("cpw-forgot-fail"),w.className="cpw-forgot-msg error",_.disabled=!1,_.textContent=y)}catch{w.textContent=a("cpw-forgot-fail"),w.className="cpw-forgot-msg error",_.disabled=!1,_.textContent=y}})}function l(m){if(!m||!m.includes("@"))return m||"";const[d,u]=m.split("@");return d.length<=2?d+"****@"+u:d.slice(0,2)+"****@"+u}function p(m){return m==null?"":String(m).replace(/[&<>"']/g,d=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[d])}document.readyState==="complete"||document.readyState==="interactive"?r():document.addEventListener("DOMContentLoaded",r)})();(function(){let e=null,n=!1;async function a(){if(n)return;const s=localStorage.getItem("mrpilot_token");if(s){n=!0;try{const i=await fetch("/api/me",{headers:{Authorization:"Bearer "+s},cache:"no-store"});if(i.status===401){const r=await i.json().catch(()=>({})),c=r&&r.detail;let l="";if(typeof c=="string"?l=c:c&&typeof c=="object"&&(l=c.code||""),console.warn("[heartbeat] session revoked",l),localStorage.removeItem("mrpilot_token"),e&&(clearInterval(e),e=null),l==="auth.session_revoked")try{_showSessionRevokedModal()}catch{window.location.href="/"}else{const p=l==="auth.password_changed_relogin"?"alert-password-changed-relogin":"alert-session";try{typeof showToast=="function"&&typeof t=="function"?showToast(t(p),"error"):alert("Session expired")}catch{}setTimeout(()=>{window.location.href="/"},1500)}}}catch{}finally{n=!1}}}function o(){e&&clearInterval(e),e=setInterval(a,15e3)}localStorage.getItem("mrpilot_token")&&o(),window.addEventListener("focus",a),document.addEventListener("visibilitychange",function(){document.hidden||a()}),window._sessionCheck=a})();async function Yt(){const e=document.getElementById("team-loading"),n=document.getElementById("team-list"),a=document.getElementById("team-empty"),o=document.getElementById("team-count");if(n){e&&(e.style.display=""),n.style.display="none",a&&(a.style.display="none");try{const s=await apiGet("/api/team/employees"),i=s&&s.employees||[];if(e&&(e.style.display="none"),o&&(o.textContent=(t("team-count")||"共 {n} 名员工").replace("{n}",i.length)),i.length===0){a&&(a.style.display="");return}n.style.display="",n.innerHTML=i.map(r=>{const c=r.last_login_at?new Date(r.last_login_at).toLocaleDateString():t("team-never-login")||"从未登录",l=r.is_active===!1?"team-status-off":"team-status-on",p=r.is_active===!1?t("team-status-disabled")||"已禁用":t("team-status-active")||"正常",m=r.email?`<span class="team-meta-sep">·</span><span>${escapeHtml(r.email)}</span>`:"";return`
            ...
            </div>`}).join("")}catch(s){console.error("loadTeamList failed:",s),e&&(e.textContent=t("team-load-failed")||"加载失败")}}}async function wr(){document.querySelectorAll(".add-emp-overlay").forEach(o=>o.remove());const e=document.createElement("div");e.className="add-emp-overlay",e.innerHTML=`
