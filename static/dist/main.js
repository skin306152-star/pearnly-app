...
`,e.dataset.wbInjected="1";try{const n=window._currentLang||localStorage.getItem("mrpilot_lang")||"th",a=window.I18N;a&&a[n]&&(e.querySelectorAll("[data-i18n]").forEach(o=>{const s=o.getAttribute("data-i18n");a[n][s]&&(o.textContent=a[n][s])}),e.querySelectorAll("[data-i18n-placeholder]").forEach(o=>{const s=o.getAttribute("data-i18n-placeholder");a[n][s]&&(o.placeholder=a[n][s])}))}catch{}}})();(function(){const e=document.getElementById("page-settings");if(!(!e||e.dataset.wbInjected==="1")){e.innerHTML=`
        ...
        <!-- /settings-layout -->
`,e.dataset.wbInjected="1";try{const n=window._currentLang||localStorage.getItem("mrpilot_lang")||"th",a=window.I18N;a&&a[n]&&(e.querySelectorAll("[data-i18n]").forEach(o=>{const s=o.getAttribute("data-i18n");a[n][s]&&(o.textContent=a[n][s])}),e.querySelectorAll("[data-i18n-placeholder]").forEach(o=>{const s=o.getAttribute("data-i18n-placeholder");a[n][s]&&(o.placeholder=a[n][s])}))}catch{}}})();const Hi=`
        <div class="page-head-clean">
            <div class="page-head-icon">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
...
`,Ai=`                    <!-- Tab: 邮箱抓取 (v0.17 · M6 · v93 在 Vultr 复活) -->
...
`;(function(){const e=document.getElementById("page-automation");if(!(!e||e.dataset.wbInjected==="1")){e.innerHTML=Hi+Ai,e.dataset.wbInjected="1";try{const n=window._currentLang||localStorage.getItem("mrpilot_lang")||"th",a=window.I18N;a&&a[n]&&(e.querySelectorAll("[data-i18n]").forEach(o=>{const s=o.getAttribute("data-i18n");s&&a[n][s]&&(o.textContent=a[n][s])}),e.querySelectorAll("[data-i18n-placeholder]").forEach(o=>{const s=o.getAttribute("data-i18n-placeholder");s&&a[n][s]&&(o.placeholder=a[n][s])}))}catch{}}})();(function(){const e={"page-integration":`
        <div class="coming-soon">
            <svg class="cs-icon" viewBox="0 0 48 48" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
...
`,e.dataset.wbInjected="1";try{const n=window._currentLang||localStorage.getItem("mrpilot_lang")||"th",a=window.I18N;a&&a[n]&&e.querySelectorAll("[data-i18n]").forEach(o=>{const s=o.getAttribute("data-i18n");a[n][s]&&(o.textContent=a[n][s])})}catch{}}})();function ji(e,n){const a=document.getElementById("alert-"+e);a&&(document.getElementById("alert-"+e+"-text").textContent=n,a.classList.add("show"))}function Pi(){["info","warn","error"].forEach(e=>{document.getElementById("alert-"+e).classList.remove("show")})}function Di(e,n){if(e==null)return n||"操作失败";if(typeof e=="string")return e;if(Array.isArray(e)){const a=e[0]||{};return a.msg?a.msg:n||"请求格式错误"}if(typeof e=="object"){if(e.code){const a="err."+e.code;try{const o=t(a,e);if(o&&o!==a)return o}catch(o){console.warn("[i18n] t() failed for key:",a,o)}return e.code}if(e.message)return e.message;if(e.error)return e.error;if(e.detail&&typeof e.detail=="string")return e.detail;try{return JSON.stringify(e).slice(0,160)}catch{}}return n||String(e)}function Ri(e){if(!e)return"";const n=String(e);return/ECONNREFUSED|Connection refused/i.test(n)?"连接被拒绝 · ERP 地址可能错了,或服务没启动":/listing fetch failed|wait_for_selector/i.test(n)?"拉取 MR.ERP 客户/商品列表超时 · 已重试 3 次仍不通 · 可能 MR.ERP 响应慢 · 稍后再试":/ETIMEDOUT|timeout/i.test(n)?"连接超时 · MR.ERP 响应慢 · 稍后再试":/ENOTFOUND|getaddrinfo/i.test(n)?"域名解析失败 · ERP 地址拼错了":/certificate|SSL/i.test(n)?"SSL 证书问题 · ERP 站点证书异常":/401|Unauthorized/i.test(n)?"HTTP 401 · 认证失败,检查 Token 是否正确":/403|Forbidden/i.test(n)?"HTTP 403 · 权限不足,ERP 拒绝访问":/404|Not Found/i.test(n)?"HTTP 404 · URL 路径不存在":/^5\d\d/.test(n)||/500|502|503|504/.test(n)?"ERP 服务器错误 · 不是你的问题,等会儿再试":n}function qi(e,n,a){let o=document.getElementById("mp-toast-wrap");o||(o=document.createElement("div"),o.id="mp-toast-wrap",document.body.appendChild(o)),n=n||"success",n==="ok"&&(n="success"),n==="warning"&&(n="warn"),n==="danger"&&(n="error");const s={success:'<path d="M3 8l3 3 7-7"/>',error:'<circle cx="8" cy="8" r="6"/><path d="M5.5 5.5l5 5M10.5 5.5l-5 5"/>',warn:'<path d="M8 2L1.5 13h13L8 2z"/><path d="M8 7v3M8 12v.01"/>',info:'<circle cx="8" cy="8" r="6"/><path d="M8 5.5v.01M8 8v3"/>',loading:'<path d="M8 1a7 7 0 017 7" stroke-linecap="round" class="mp-toast-spin"/>'},i=document.createElement("div");i.className="mp-toast "+n,i.innerHTML=`
    ...
    `,o.appendChild(i),requestAnimationFrame(()=>i.classList.add("show"));const r=typeof a=="number"?a:2500;let c=null;const m=()=>{c&&(clearTimeout(c),c=null),i.classList.remove("show"),setTimeout(()=>{try{i.remove()}catch{}},300)};return r>0&&(c=setTimeout(m,r)),m}window.showAlert=ji;window.hideAlerts=Pi;window._humanizeBackendError=Di;window.humanizeError=Ri;window.showToast=qi;function Fi(e,n){return n=n||{},new Promise(a=>{const o=document.getElementById("confirm-modal"),s=document.getElementById("confirm-modal-body"),i=document.getElementById("confirm-modal-ok"),r=document.getElementById("confirm-modal-cancel"),c=document.getElementById("confirm-modal-close"),m=document.getElementById("confirm-modal-title");if(!o||!s||!i||!r){a(!1);return}m.textContent=n.title||t("confirm-default-title");const d=n.promptInput?"cm_in_"+Date.now():null;if(n.promptInput){const f=(e||"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;"),v=(n.placeholder||"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;");s.innerHTML=`
        ...
        `;const o=document.getElementById("api-key-card");o&&(o.style.display="");return}Ui(n,e);const a=document.getElementById("api-key-card");if(a){const o=tt==="byo_api"||_userInfo&&_userInfo.is_super_admin;a.style.display=o?"":"none"}}function Ui(e,n){const a=escapeHtml(e.username||e.email||"");n.innerHTML=`
        <table style="width:100%; font-size:13px; border-collapse: collapse;">
            <tr>
    ...
    `}window.switchSettingsTab=zi;window.fillSettingsForms=Ni;window.saveProfile=Oi;window.saveCompany=Vi;window.renderSettings=ea;function Tn(e){return e=e||_userInfo,!!(e&&e.is_super_admin)}function ga(e){return e=e||_userInfo,!!e&&(e.role==="owner"||Tn(e))}function Qo(e){return e=e||_userInfo,!!e&&e.role==="member"&&!Tn(e)}function Gi(e){return e=e||_userInfo,!!e&&(e.effective_plan==="trial"||e.plan==="trial")&&!Tn(e)}function es(e){return e=e||_userInfo,!!e&&e.tenant_type==="byo_api"}function ts(e){return Qo(e)}function Ki(e){return ga(e)}function Wi(e){return ga(e)&&es(e)}window.isMoneyHidden=ts;window.isSuperAdmin=Tn;window.isOwner=ga;window.isEmployee=Qo;window.isTrial=Gi;window.isLifetime=es;window.shouldHideMoney=ts;window.canManageTeam=Ki;window.canManageApiKey=Wi;function Yi(){const e=document.getElementById("quota-banner");if(!e)return;if(!_userInfo){e.style.display="none";return}if(_userInfo.is_super_admin||_userInfo.tenant_type==="admin"||_userInfo.tenant_type==="byo_api"){e.style.display="none";return}let n=0,a=0;if(_userInfo.plan==="free"&&_quota&&_quota.ip_daily_limit)n=_quota.ip_used_today||0,a=_quota.ip_daily_limit;else if(_userInfo.tenant_quota!=null&&_userInfo.tenant_quota>0)n=_userInfo.tenant_used||0,a=_userInfo.tenant_quota;else if(_userInfo.monthly_quota&&_userInfo.monthly_quota>0)n=_userInfo.used_this_month||0,a=_userInfo.monthly_quota;else{e.style.display="none";return}if(a<=0){e.style.display="none";return}const o=Math.max(0,a-n),s=n/a*100,i="quota_banner_dismiss_"+new Date().toISOString().slice(0,10);if(localStorage.getItem(i)){e.style.display="none";return}let r,c;if(o===0)r="danger",c=t("quota-banner-exhausted");else if(s>=90)r="danger",c=t("quota-banner-very-low",{n:o});else if(s>=70)r="warn",c=t("quota-banner-low",{n:o});else{e.style.display="none";return}e.className="quota-banner "+r,e.innerHTML=`
    ...
    `,e.style.display="flex";const m=e.querySelector(".quota-banner-close");m&&m.addEventListener("click",()=>{localStorage.setItem(i,"1"),e.style.display="none"})}function Ji(){const e=_userInfo;if(!e)return;const n=shouldHideMoney(e),a=canManageTeam(e),o=canManageApiKey(e),s=document.querySelector('.nav-item[data-route="templates"]');s&&(s.classList.remove("locked-for-plan"),s.removeAttribute("data-locked-target"));const i=document.querySelector('.nav-item[data-route="api-keys"]');i&&(i.classList.remove("locked-for-plan"),i.removeAttribute("data-locked-target"));const r=document.getElementById("btn-custom-template");r&&(r.style.display="",r.classList.remove("locked-for-plan"));const c=document.querySelector('.settings-tab[data-tab="team"]');c&&(c.style.display=a?"":"none");const m=document.querySelector('.settings-panel[data-settings-panel="team"]');m&&(m.dataset.permHidden=a?"0":"1");const d=document.querySelector('.settings-tab[data-tab="api"]');d&&(d.style.display=o||isSuperAdmin(e)?"":"none");const u=document.querySelector('.settings-tab[data-tab="plan"]');u&&(u.style.display=n?"none":"");const l=document.querySelector('.settings-tab[data-tab="company"]');l&&(l.style.display=n?"none":"");const p=document.getElementById("info-bar");p&&(p.style.display=n?"none":"");const f=document.getElementById("trial-banner");f&&n&&(f.style.display="none");const v=document.getElementById("plan-banner");v&&n&&(v.style.display="none",document.body.classList.remove("has-plan-banner")),document.querySelectorAll("[data-upgrade-cta], .btn-upgrade, .topbar-upgrade").forEach(w=>{w.style.display="none"}),document.body.classList.toggle("role-employee",isEmployee(e)),document.body.classList.toggle("role-owner",isOwner(e)),document.body.classList.toggle("role-super",isSuperAdmin(e));try{const w=document.querySelector(".settings-tab.active");w&&w.style.display==="none"&&(typeof window.switchSettingsTab=="function"?window.switchSettingsTab("profile"):typeof switchSettingsTab=="function"&&switchSettingsTab("profile"))}catch(w){console.warn("[v118.12.3] failed to fix active tab:",w)}if(window.PEARNLY_ADMIN_MODE){const w=document.getElementById("admin-mode-banner");w&&(w.style.display="flex"),document.querySelectorAll(".nav-item").forEach(h=>{h.classList.contains("nav-admin-only")||(h.style.display="none")}),document.querySelectorAll(".nav-group").forEach(h=>{h.classList.contains("nav-group-admin-only")||(h.style.display="none")});const b=document.getElementById("client-switcher");b&&(b.style.display="none"),document.body.classList.add("admin-mode");const g=["profile","security","notifications","about"];document.querySelectorAll(".settings-tab").forEach(h=>{const _=h.dataset.tab;_&&!g.includes(_)&&(h.style.display="none")}),document.querySelectorAll(".settings-pane").forEach(h=>{const _=h.dataset.pane;_&&!g.includes(_)&&(h.style.display="none")}),document.querySelectorAll(".settings-nav-group").forEach(h=>{const _=h.querySelectorAll(".settings-tab");Array.from(_).some(k=>k.style.display!=="none")||(h.style.display="none")})}}function Xi(){const e=_userInfo,n=document.getElementById("info-bar");if(!e||shouldHideMoney(e)){n&&(n.innerHTML="");return}let a="";const o=e.tenant_type;if(o==="byo_api")e.has_own_gemini_key?a=`
        ...
        `;else{const s=e.tenant_used!=null?e.tenant_used:e.used_this_month||0,i=e.tenant_quota!=null&&e.tenant_quota>0?e.tenant_quota:e.monthly_quota||0,r=i>0?Math.min(100,s/i*100):0;let c="";r>=95?c="danger":r>=80&&(c="warn"),i>0?a=`
            ...
            `:a=""}n&&(n.innerHTML=a)}window.renderQuotaBanner=Yi;window.applySidebarVisibility=Ji;window.renderInfoBar=Xi;async function ns(e,n){try{const a=await fetch(e,{method:"POST",headers:{Authorization:"Bearer "+token,"Content-Type":"application/json"},body:JSON.stringify(n)});if(a.status===401){localStorage.removeItem("mrpilot_token");const o=await a.json().catch(()=>({}));return(typeof o.detail=="string"?o.detail:o.detail&&o.detail.code||"")==="auth.session_revoked"?(_showSessionRevokedModal(),null):(window.location.href="/",null)}return await a.json()}catch{return{ok:!1,error:"network"}}}function as(e){return{invalid_format:"rd-err-format",not_found:"rd-err-not-found",rd_unreachable:"rd-err-unreachable",parse_error:"rd-err-unknown",network:"rd-err-unreachable"}[e]||"rd-err-unknown"}function gn(e){const n=document.querySelector(`[data-field="${e}"]`);return n?(n.value||"").trim():""}function ct(e,n,a){const o=document.querySelector(`[data-rd-status="${e}"]`);o&&(o.innerHTML=n,o.className="rd-status"+(a?" "+a:""))}async function Zi(e){const a=gn(e==="seller"?"seller_tax":"buyer_tax");ct(e,t("rd-verifying"),"loading");const o=await ns("/api/rd/verify",{tax_id:a});if(!o)return;if(!o.ok){ct(e,t(as(o.error)),"error");return}o.data&&o.data.valid?ct(e,`<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="2"><path d="M3 8l3 3 7-7"/></svg> ${escapeHtml(t("rd-status-valid"))}`,"valid"):ct(e,t("rd-status-invalid"),"invalid")}async function Qi(e){const a=gn(e==="seller"?"seller_tax":"buyer_tax");ct(e,t("rd-syncing"),"loading");const o=await ns("/api/rd/lookup",{tax_id:a,branch:0});if(o){if(!o.ok){ct(e,t(as(o.error)),"error");return}ct(e,`<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="2"><path d="M3 8l3 3 7-7"/></svg> ${escapeHtml(t("rd-status-valid"))}`,"valid"),er(e,o.data)}}function er(e,n){const a=e==="seller"?"seller_name":"buyer_name",o=e==="seller"?"seller_addr":"buyer_addr",s=gn(a),i=gn(o),r=[];n.name&&n.name!==s&&r.push({field:a,label:t("rd-field-name"),current:s,official:n.name}),n.address&&n.address!==i&&r.push({field:o,label:t("rd-field-address"),current:i,official:n.address});const c=[];n.branch_label&&c.push(`<strong>${t("rd-field-branch")}:</strong> ${escapeHtml(n.branch_label)}`),n.post_code&&c.push(`<strong>${t("rd-field-postcode")}:</strong> ${escapeHtml(n.post_code)}`);let m=document.getElementById("rd-sync-modal");if(m||(m=document.createElement("div"),m.id="rd-sync-modal",m.className="rd-modal-mask",document.body.appendChild(m)),r.length===0)m.innerHTML=`
            <div class="rd-modal">
    ...
    `,d=i?"":`<span class="tax-badge unverified" data-tip="${escapeHtml(t("tax-tip-unverified"))}">${t("tax-unverified")}</span>`;if(c.innerHTML=`
        ...
        <div class="drawer-section">
            ...
            ${r.wht_amount||r.wht_rate?`
                ${ye("wht_amount","drawer-lbl-wht-amount",r.wht_amount,"input",s,or(r.wht_rate))}
            `:""}
        </div>
        ...
        <div class="drawer-section">
            ...
            ${ye("seller_tax","drawer-lbl-tax",r.seller_tax,"input",s,d,eo("seller"))}
        ...
        <div class="drawer-section">
            ...
            ${ye("buyer_tax","drawer-lbl-tax",r.buyer_tax,"input",s,d,eo("buyer"))}
        ...
        <div class="drawer-section">
            ...
            ${r.items&&r.items.length>0?sr(r.items):`<div class="drawer-items-empty">${t("drawer-items-empty")}</div>`}
        </div>
...
`))}</pre>
    ...
    `,s?c.querySelectorAll("[data-field]").forEach(u=>{u.addEventListener("input",onFieldEdit)}):c.querySelectorAll("[data-field]").forEach(u=>{u.setAttribute("readonly","readonly")}),document.getElementById("drawer-mask").classList.add("show"),document.getElementById("drawer").classList.add("show"),injectOcrPushButton(),typeof window.bindDrawerClient=="function"){const u=n._historyId||n.history_id||null;window.bindDrawerClient(u,n.client_id||null)}typeof window.fillCategoryDatalist=="function"&&window.fillCategoryDatalist(),setTimeout(()=>{const u=document.getElementById("drawer-cat-input");u&&!u.value&&!u.readOnly&&u.focus()},80)}function or(e){return e?`<span class="wht-badge">${escapeHtml(e)}%</span>`:""}function ye(e,n,a,o,s,i,r){const c=_results[_drawerIdx],m=c&&c.edits[e]!==void 0?c.edits[e]:a,d=c&&c.edits[e]!==void 0&&c.edits[e]!==a,u=escapeHtml(m??""),l=s?"":"readonly",p=o==="textarea"?`<textarea data-field="${e}" rows="2">${u}</textarea>`:`<input type="text" data-field="${e}" value="${u}">`;return`
    ...
    `;n.innerHTML=o+s,e.appendChild(n)}function Nn(){const e=document.getElementById("export-dropdown");e&&e.remove()}const On=document.getElementById("btn-export-arrow");On&&On.addEventListener("click",e=>{e.stopPropagation(),!On.disabled&&pr()});document.addEventListener("click",e=>{const n=e.target.closest(".export-dd-item");if(n){const a=n.getAttribute("data-tpl");if(a==="__custom"){Nn(),showToast(t("cs-coming-soon"),"info");return}dr(a),Nn(),cs(a);return}e.target.closest("#btn-export-arrow")||Nn()});function ur(){const e=document.getElementById("btn-export-arrow"),n=document.getElementById("btn-export");e&&n&&(e.disabled=n.disabled)}setInterval(ur,300);const fr=`
        <div class="page-head-clean">
            <div class="page-head-icon">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
...
`;(function(){const e=document.getElementById("page-history");if(!(!e||e.dataset.wbInjected==="1")){e.innerHTML=fr,e.dataset.wbInjected="1";try{const n=window._currentLang||localStorage.getItem("mrpilot_lang")||"th",a=window.I18N;a&&a[n]&&(e.querySelectorAll("[data-i18n]").forEach(o=>{const s=o.getAttribute("data-i18n");a[n][s]&&(o.textContent=a[n][s])}),e.querySelectorAll("[data-i18n-placeholder]").forEach(o=>{const s=o.getAttribute("data-i18n-placeholder");a[n][s]&&(o.placeholder=a[n][s])}))}catch{}}})();function ba(){const e=document.getElementById("history-batch-bar"),n=document.getElementById("history-batch-count"),a=document.getElementById("history-check-all");if(!e||!n)return;const o=_historySelected.size;if(o>0?(e.style.display="",n.textContent=t("history-batch-count",{n:o})):e.style.display="none",a){const s=_historyState.items||[];if(s.length===0)a.checked=!1,a.indeterminate=!1;else{const i=s.filter(r=>_historySelected.has(r.id)).length;a.checked=i===s.length,a.indeterminate=i>0&&i<s.length}}}function mr(){_historySelected.clear(),ba()}async function ya(){if(!_userInfo){setTimeout(()=>ya(),300);return}const e=document.getElementById("history-free-block"),n=document.getElementById("history-main"),a=document.getElementById("history-empty");if(!e||!n||!a){console.warn("[History] container missing");return}if(!_userInfo.can_view_history){e.style.display="",n.style.display="none",a.style.display="none";return}e.style.display="none",_historyState.loading=!0;try{const o=_historyState.page*_historyState.pageSize,s=new URLSearchParams({limit:_historyState.pageSize,offset:o});_historyState.keyword&&s.set("keyword",_historyState.keyword);const i=typeof window.getCurrentClientId=="function"?window.getCurrentClientId():null;i&&s.set("client_id",String(i));const r=await fetch(`/api/history?${s}`,{headers:{Authorization:"Bearer "+token}});if(r.status===401){localStorage.removeItem("mrpilot_token");const d=await r.json().catch(()=>({}));if((typeof d.detail=="string"?d.detail:d.detail&&d.detail.code||"")==="auth.session_revoked"){_showSessionRevokedModal();return}window.location.href="/";return}const c=await r.json();_historyState.items=c.items||[],_historyState.total=c.total||0;const m=new Set(_historyState.items.map(d=>d.id));for(const d of Array.from(_historySelected))m.has(d)||_historySelected.delete(d);ds()}catch(o){console.error("load history failed",o)}finally{_historyState.loading=!1}}function ds(){const e=document.getElementById("history-main"),n=document.getElementById("history-empty"),a=_historyState.items,o=document.getElementById("history-search-matches");if(o&&(o.textContent=_historyState.keyword?t("search-matches",{n:_historyState.total}):""),a.length===0&&_historyState.total===0&&!_historyState.keyword){e.style.display="none",n.style.display="";return}e.style.display="",n.style.display="none";let s=0;a.forEach(d=>{d.confidence==="high"&&s++});const i=a.length>0?Math.round(s/a.length*100):0;document.getElementById("history-stats").innerHTML=`
    ...
    `;const r=document.getElementById("history-tbody");a.length===0?r.innerHTML=`<div class="history-row-empty">${escapeHtml(t("history-empty-title"))}</div>`:r.innerHTML=a.map(d=>{const u=new Date(d.created_at),l=String(u.getMonth()+1).padStart(2,"0"),p=String(u.getDate()).padStart(2,"0"),f=String(u.getHours()).padStart(2,"0"),v=String(u.getMinutes()).padStart(2,"0"),w=`${l}-${p} ${f}:${v}`,b=escapeHtml(d.filename||""),g=b.length>50?b.substring(0,50)+"…":b,h=d.invoice_no?escapeHtml(d.invoice_no):g,_=[];d.seller_name&&_.push(escapeHtml(d.seller_name)),d.invoice_no&&d.filename&&_.push(g);const y=_.join(" · ")||"-",k=d.category_tag?`<span class="history-badge category">${escapeHtml(d.category_tag)}</span>`:"",x=d.source_total&&d.source_total>1?`<span class="history-badge multi">${escapeHtml(t("invoice-part-of",{i:d.source_index||1,n:d.source_total}))}</span>`:"",E=d.total_amount!==null&&d.total_amount!==void 0?Number(d.total_amount).toLocaleString(void 0,{minimumFractionDigits:2,maximumFractionDigits:2}):'<span class="history-cell-amount-empty">—</span>',L=[];(d.total_amount===null||d.total_amount===void 0)&&L.push(t("field-amount")),d.invoice_no||L.push(t("field-invoice-no")),d.invoice_date||L.push(t("field-invoice-date")),d.seller_name||L.push(t("field-seller-name")),L.length>0&&`${escapeHtml(d.id)}${escapeHtml(t("history-needs-review-tip")+" · "+L.join(" · "))}${escapeHtml(t("history-needs-review-tip"))}${svgIcon("alert",14)}`,d.edited&&`${escapeHtml(t("history-edited",{n:d.edit_count||1}))}`;const I=d.smart_assigned_flag?`<span class="history-badge smart-assigned" title="${escapeHtml(t("history-smart-assigned"))}">${svgIcon("sparkle",11)}</span>`:"",B=d.confidence==="high"?"high":d.confidence==="medium"?"mid":"low",C=d.confidence==="high"?t("conf-high"):d.confidence==="medium"?t("conf-medium"):t("conf-low"),S=`<span class="history-badge conf-${B}">${escapeHtml(C)}</span>`;let $="";const j=d.source||"manual";return j==="email"?$=`<span class="history-badge source source-email" title="${escapeHtml(t("history-source-email"))}">${svgIcon("mail",11)}<span>${escapeHtml(t("history-source-email"))}</span></span>`:j==="folder"?$=`<span class="history-badge source source-folder" title="${escapeHtml(t("history-source-folder"))}">${svgIcon("folder",11)}<span>${escapeHtml(t("history-source-folder"))}</span></span>`:j==="api"&&($=`<span class="history-badge source source-api" title="${escapeHtml(t("history-source-api"))}">${svgIcon("api",11)}<span>${escapeHtml(t("history-source-api"))}</span></span>`),`
            ...
            `}).join(""),ba();const c=a.length>0?_historyState.page*_historyState.pageSize+1:0,m=_historyState.page*_historyState.pageSize+a.length;document.getElementById("history-pager-info").textContent=t("history-pager",{from:c,to:m,total:_historyState.total}),document.getElementById("history-prev").disabled=_historyState.page===0,document.getElementById("history-next").disabled=(_historyState.page+1)*_historyState.pageSize>=_historyState.total}window.loadHistoryPage=ya;window.renderHistoryList=ds;window.updateHistoryBatchBar=ba;window.clearHistorySelection=mr;typeof currentRoute<"u"&&currentRoute==="history"&&ya();async function bn(e){try{const n=await fetch(`/api/history/${encodeURIComponent(e)}`,{headers:{Authorization:"Bearer "+token}});if(!n.ok)return;const a=await n.json(),o=mergeFields(a.pages||[]),s={filename:a.filename,pages:a.pages,page_count:a.page_count,elapsed_ms:a.elapsed_ms,engine:"history",merged_fields:o,edits:{},confidence:a.confidence,archive_name:a.archive_name||null,category_tag:a.category_tag||null,_historyId:a.id,_historyMode:!0,client_id:a.client_id||null};_results.push(s),_drawerIdx=_results.length-1,openDrawer(_drawerIdx),hr(),typeof window.bindDrawerClient=="function"&&window.bindDrawerClient(a.id,a.client_id||null),gr(a.id)}catch(n){console.error("open history detail failed",n)}}async function vr(e){await bn(e),requestAnimationFrame(()=>{const n=document.querySelector('[data-field="total_amount"]');if(n){try{n.focus()}catch{}try{n.select()}catch{}try{n.scrollIntoView({block:"center",behavior:"smooth"})}catch{}}})}function hr(){const e=document.getElementById("drawer-body");if(!e||document.getElementById("drawer-history-save"))return;const n=document.createElement("div");n.id="drawer-history-save",n.className="drawer-history-save-bar",n.innerHTML=`
    ...
    `,e.appendChild(n),document.getElementById("btn-save-history").addEventListener("click",yr),document.getElementById("btn-push-erp").addEventListener("click",br)}async function gr(e){}async function br(){showToast(t("erp-push-coming-soon")||"ERP 推送即将开放，敬请期待","info")}async function yr(){const e=_results[_drawerIdx];if(!e||!e._historyId)return;const n=JSON.parse(JSON.stringify(e.pages||[]));if(n.length>0){const o=n.findIndex(c=>!c.is_duplicate&&!c.is_copy),s=o>=0?o:0,i=n[s].fields||(n[s].fields={}),r={...e.edits};r.category_tag!==void 0&&(r.category=r.category_tag,delete r.category_tag),Object.assign(i,r)}const a=document.getElementById("btn-save-history");a&&(a.disabled=!0);try{if(!(await fetch(`/api/history/${encodeURIComponent(e._historyId)}`,{method:"PUT",headers:{Authorization:"Bearer "+token,"Content-Type":"application/json"},body:JSON.stringify({pages:n})})).ok)throw new Error("save failed");showAlert("info",t("history-save-ok")),setTimeout(hideAlerts,1500),closeDrawer(),e._historyMode&&_results.pop(),loadHistoryPage()}catch{showAlert("error",t("history-save-fail")),a&&(a.disabled=!1)}}function wr(e,n){document.querySelectorAll(".history-popover").forEach(d=>d.remove());const a=n.getBoundingClientRect(),o=(_historyState.items||[]).find(d=>d.id===e),s=o&&o.invoice_no?String(o.invoice_no):"",i=o&&o.has_pdf===!0,r=document.createElement("div");r.className="history-popover",r.innerHTML=`
...
`;be("camera-tips-modal",Er);async function yn(e){return new Promise(n=>{const a=new FileReader;a.onerror=()=>n({warnings:[],width:0,height:0,brightness:128}),a.onload=()=>{const o=new Image;o.onerror=()=>n({warnings:[],width:0,height:0,brightness:128}),o.onload=()=>{const s=[],i=o.naturalWidth,r=o.naturalHeight;(i<1e3||r<1e3)&&s.push("low_res");try{const c=document.createElement("canvas");c.width=64,c.height=64;const m=c.getContext("2d");m.drawImage(o,0,0,64,64);const d=m.getImageData(0,0,64,64).data;let u=0,l=0;for(let f=0;f<d.length;f+=4)u+=.299*d[f]+.587*d[f+1]+.114*d[f+2],l++;const p=l?u/l:128;p<70?s.push("too_dark"):p>235&&s.push("too_bright"),n({warnings:s,width:i,height:r,brightness:p})}catch{n({warnings:s,width:i,height:r,brightness:128})}},o.src=a.result},a.readAsDataURL(e)})}async function us(e){if(!e||e.length===0)return null;const{jsPDF:n}=window.jspdf,a=210,o=297,s=new n({unit:"mm",format:"a4",orientation:"p"});for(let d=0;d<e.length;d++){const u=e[d],{dataUrl:l,naturalW:p,naturalH:f}=await Lr(u);d>0&&s.addPage("a4","p");const v=p/f;let w=a-10,b=w/v;b>o-10&&(b=o-10,w=b*v);const g=(a-w)/2,h=(o-b)/2,_=u.type==="image/png"?"PNG":"JPEG";s.addImage(l,_,g,h,w,b,void 0,"FAST")}const i=s.output("blob"),r=new Date,c=r.getFullYear().toString()+String(r.getMonth()+1).padStart(2,"0")+String(r.getDate()).padStart(2,"0")+String(r.getHours()).padStart(2,"0")+String(r.getMinutes()).padStart(2,"0")+String(r.getSeconds()).padStart(2,"0"),m=e.length>1?`_${e.length}p`:"";return new File([i],`photo_${c}${m}.pdf`,{type:"application/pdf"})}function Lr(e){return new Promise((n,a)=>{const o=new FileReader;o.onerror=a,o.onload=()=>{const s=new Image;s.onerror=a,s.onload=()=>n({dataUrl:o.result,naturalW:s.naturalWidth,naturalH:s.naturalHeight}),s.src=o.result},o.readAsDataURL(e)})}(function(){const n=document.getElementById("upload-alt-row"),a=document.getElementById("gallery-input"),o=document.getElementById("camera-input");if(!n)return;n.style.display="";const s=document.getElementById("btn-scan-doc");s&&o&&(s.addEventListener("click",async()=>{!(localStorage.getItem("mrpilot_camera_tips_skip")==="1")&&!await Br()||o.click()}),o.addEventListener("change",async c=>{const m=Array.from(c.target.files||[]);if(c.target.value="",m.length!==0)for(const d of m)await na([d],"camera")}));const i=document.getElementById("btn-upload-pic");i&&a&&i.addEventListener("click",()=>a.click());const r=c=>async m=>{const d=Array.from(m.target.files||[]);if(m.target.value="",d.length===0)return;const u=d.filter(p=>p.type==="application/pdf"||/\.pdf$/i.test(p.name)),l=d.filter(p=>!u.includes(p));u.length>0&&await Ir(u),l.length>0&&await na(l,c)};a&&a.addEventListener("change",r("gallery"))})();async function Ir(e){for(const a of e)_selectedFiles.push({file:a,name:a.name,size:a.size,status:"waiting",errorKey:null,errorParams:null});const n=getMaxFiles();_selectedFiles.length>n&&(showAlert("warn",t("alert-file-count",{n})),_selectedFiles=_selectedFiles.slice(0,n)),renderFileList(),updateStartButton()}function Br(){return new Promise(e=>{const n=document.getElementById("camera-tips-modal"),a=document.getElementById("camera-tips-ok"),o=document.getElementById("camera-tips-cancel"),s=document.getElementById("camera-tips-skip");if(!n||!a){e(!0);return}s&&(s.checked=!1),n.style.display="flex";const i=c=>{n.style.display="none",s&&s.checked&&localStorage.setItem("mrpilot_camera_tips_skip","1"),a.onclick=null,o&&(o.onclick=null),n.onclick=null,document.removeEventListener("keydown",r),e(c)},r=c=>{c.key==="Escape"&&i(!1)};a.onclick=()=>i(!0),o&&(o.onclick=()=>i(!1)),n.onclick=c=>{c.target===n&&i(!1)},document.addEventListener("keydown",r),setTimeout(()=>a.focus(),50)})}let Me=[],lt=null;async function na(e,n){if(hideAlerts(),!(!e||e.length===0)){var a=typeof window.getOcrDocumentMode=="function"?window.getOcrDocumentMode():"invoice";if(a==="thai_id_card"){for(const s of e)_selectedFiles.push({file:s,name:s.name,size:s.size,status:"waiting",errorKey:null,errorParams:null});const o=getMaxFiles();_selectedFiles.length>o&&(showAlert("warn",t("alert-file-count",{n:o})),_selectedFiles=_selectedFiles.slice(0,o)),renderFileList(),updateStartButton();return}if(typeof window.jspdf>"u"||!window.jspdf.jsPDF){showToast(t("camera-loading"),"info");for(let o=0;o<30&&(await new Promise(s=>setTimeout(s,100)),!(window.jspdf&&window.jspdf.jsPDF));o++);if(!window.jspdf||!window.jspdf.jsPDF){showToast(t("camera-lib-fail"),"error");return}}if(n==="camera"&&e.length===1){const o=e[0];let s={};try{s=await yn(o)}catch{}Me.push({file:o,quality:s}),lt="camera",xt();return}if(n==="gallery"&&(e.length>=2||Me.length>0)){for(const o of e){let s={};try{s=await yn(o)}catch{}Me.push({file:o,quality:s})}lt="gallery",xt();return}await fs(e)}}async function Cr(e){const n=new Set;for(const o of e)try{((await yn(o)).warnings||[]).forEach(i=>n.add(i))}catch{}try{const o=await us(e);o&&_selectedFiles.push({file:o,name:o.name,size:o.size,status:"waiting",errorKey:null,errorParams:null})}catch(o){console.error("[camera] convert failed",o),showToast(t("camera-convert-fail"),"error");return}const a=getMaxFiles();_selectedFiles.length>a&&(showAlert("warn",t("alert-file-count",{n:a})),_selectedFiles=_selectedFiles.slice(0,a)),renderFileList(),updateStartButton(),showToast(t("camera-added-merged",{n:e.length}),"success"),n.size>0&&setTimeout(()=>{n.has("too_dark")?showToast(t("camera-quality-dark"),"warn"):n.has("low_res")?showToast(t("camera-quality-lowres"),"warn"):n.has("too_bright")&&showToast(t("camera-quality-overexposed"),"warn")},1e3)}function xt(){let e=document.getElementById("camera-buffer-bar");if(Me.length===0){e&&e.remove(),lt=null;return}e||(e=document.createElement("div"),e.id="camera-buffer-bar",e.className="camera-buffer-bar",document.body.appendChild(e));const n=Me.length,a=n>=2,o=lt==="gallery",s=o?t("camera-buffer-more-gallery"):t("camera-buffer-more");let i;a?o?i=`
...
`,e.dataset.wbInjected="1";try{const n=window._currentLang||localStorage.getItem("mrpilot_lang")||"th",a=window.I18N;a&&a[n]&&(e.querySelectorAll("[data-i18n]").forEach(o=>{const s=o.getAttribute("data-i18n");s&&a[n][s]&&(o.textContent=a[n][s])}),e.querySelectorAll("[data-i18n-placeholder]").forEach(o=>{const s=o.getAttribute("data-i18n-placeholder");s&&a[n][s]&&(o.placeholder=a[n][s])}))}catch{}}})();(function(){const e=document.getElementById("archive-token-modal");if(!(!e||e.dataset.wbInjected==="1")){e.innerHTML=`
        ...
        `;u.innerHTML=l+p}function r(d){return d==null?"":String(d).replace(/[&<>"']/g,u=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[u])}function c(d){const u=new Date,l=u.getFullYear(),p=u.getMonth()+1;if(d==="all")return"all";if(d==="this-month")return`${l}-${String(p).padStart(2,"0")}`;if(d==="last-month"){const f=new Date(l,p-2,1);return`${f.getFullYear()}-${String(f.getMonth()+1).padStart(2,"0")}`}return d==="this-year"?`${l}`:d==="this-quarter"?`${l}-Q${Math.floor((p-1)/3)+1}`:"all"}window.openReportModal=async function(d){d=d||{},n(),typeof applyLang=="function"?applyLang(currentLang):document.querySelectorAll("#report-modal [data-i18n]").forEach(w=>{const b=w.getAttribute("data-i18n");I18N[currentLang]&&I18N[currentLang][b]&&(w.textContent=I18N[currentLang][b])});const u=document.getElementById("report-period-section");u&&(u.style.display=d.mode==="client"?"":"none");const l=document.getElementById("report-tpl-list");l.innerHTML=`<div class="report-tpl-loading">${r(t("report-modal-loading"))}</div>`,document.getElementById("report-modal").style.display="";const p=await s(currentLang,d&&d.mode);i(p),o=d;const f=document.getElementById("report-modal-download"),v=f.cloneNode(!0);f.parentNode.replaceChild(v,f),v.addEventListener("click",()=>m(o))};async function m(d){if(!d)return;const u=document.querySelector('input[name="report-tpl"]:checked');if(!u){showToast(t("report-toast-no-selection"),"info");return}const l=u.value,p=document.querySelector('input[name="report-period"]:checked'),f=p?p.value:"all",v=c(f),w=document.getElementById("report-modal-download"),b=w.innerHTML;w.disabled=!0,w.innerHTML=`<span>${r(t("report-modal-loading"))}</span>`;try{const g=localStorage.getItem("mrpilot_token");let h,_;if(d.mode==="records")h=await fetch("/api/reports/export",{method:"POST",headers:{Authorization:"Bearer "+g,"Content-Type":"application/json"},body:JSON.stringify({template:l,lang:currentLang,records:d.records||[],meta:d.meta||{}})}),_=`mrpilot-${l}-${Date.now()}.xlsx`;else if(d.mode==="client"){const B=`/api/reports/clients/${d.clientId}/export?template=${encodeURIComponent(l)}&lang=${encodeURIComponent(currentLang)}&month=${encodeURIComponent(v)}`;h=await fetch(B,{headers:{Authorization:"Bearer "+g}}),_=`${(d.clientName||"client").replace(/[^a-zA-Z0-9\u0e00-\u0e7f\u4e00-\u9fff]/g,"_").slice(0,40)}-${l}.xlsx`}else if(d.mode==="history-batch")l==="sales_detail_th"?(h=await fetch("/api/ocr/export-by-history-ids",{method:"POST",headers:{Authorization:"Bearer "+g,"Content-Type":"application/json"},body:JSON.stringify({template:"sales_detail_th",lang:currentLang,history_ids:d.historyIds||[],client_id:d.clientId||null})}),_=`Pearnly_SalesDetail_${Date.now()}.xlsx`):(h=await fetch("/api/reports/history/batch_export",{method:"POST",headers:{Authorization:"Bearer "+g,"Content-Type":"application/json"},body:JSON.stringify({template:l,lang:currentLang,history_ids:d.historyIds||[],client_id:d.clientId||null})}),_=`mrpilot-batch-${l}-${Date.now()}.xlsx`);else throw new Error("unknown mode: "+d.mode);if(!h.ok){let B="HTTP "+h.status;try{const C=await h.json();C&&C.detail&&(B=C.detail)}catch(C){console.warn("[batch-export] resp.json err.detail parse failed:",C)}h.status===404?showToast(t("report-toast-empty"),"info"):showToast(t("report-toast-fail")+" · "+B,"error");return}const y=await h.blob();let k=_;const E=(h.headers.get("Content-Disposition")||"").match(/filename\*=UTF-8''([^;]+)/i);if(E)try{k=decodeURIComponent(E[1])}catch{}const L=URL.createObjectURL(y),I=document.createElement("a");I.href=L,I.download=k,document.body.appendChild(I),I.click(),document.body.removeChild(I),URL.revokeObjectURL(L),showToast(t("report-toast-success"),"success"),a()}catch(g){console.error("doDownload fail",g),showToast(t("report-toast-fail")+" · "+(g.message||""),"error")}finally{w.disabled=!1,w.innerHTML=b}}document.addEventListener("DOMContentLoaded",()=>{const d=document.getElementById("btn-export");if(d){const l=d.cloneNode(!0);d.parentNode.replaceChild(l,d),l.addEventListener("click",()=>{if(typeof _results>"u"||!_results||_results.length===0){showToast(t("report-toast-no-selection"),"info");return}openReportModal({mode:"records",records:_results.map(p=>({filename:p.filename,merged_fields:p.merged_fields||{}}))})})}const u=document.getElementById("history-batch-export");u&&u.addEventListener("click",()=>{if(typeof _historySelected>"u"||_historySelected.size===0){showToast(t("report-toast-no-selection"),"info");return}openReportModal({mode:"history-batch",historyIds:Array.from(_historySelected)})})}),window.openClientExportModal=function(d,u){openReportModal({mode:"client",clientId:d,clientName:u||""})}})();const Gr=/\.(pdf|jpe?g|png|webp)$/i,Kr="mrpilot_folder_watcher",Wr=1;let on=null;function Hn(){return on||(on=new Promise((e,n)=>{const a=indexedDB.open(Kr,Wr);a.onupgradeneeded=o=>{const s=o.target.result;s.objectStoreNames.contains("handles")||s.createObjectStore("handles"),s.objectStoreNames.contains("seen")||s.createObjectStore("seen"),s.objectStoreNames.contains("config")||s.createObjectStore("config")},a.onsuccess=o=>e(o.target.result),a.onerror=o=>n(o.target.error)}),on)}function Ft(e,n){return Hn().then(a=>new Promise((o,s)=>{const r=a.transaction(e,"readonly").objectStore(e).get(n);r.onsuccess=()=>o(r.result),r.onerror=()=>s(r.error)}))}function st(e,n,a){return Hn().then(o=>new Promise((s,i)=>{const r=o.transaction(e,"readwrite");r.objectStore(e).put(a,n),r.oncomplete=()=>s(),r.onerror=()=>i(r.error)}))}function Rt(e,n){return Hn().then(a=>new Promise((o,s)=>{const i=a.transaction(e,"readwrite");i.objectStore(e).delete(n),i.oncomplete=()=>o(),i.onerror=()=>s(i.error)}))}function so(e){return Hn().then(n=>new Promise((a,o)=>{const s=n.transaction(e,"readwrite");s.objectStore(e).clear(),s.oncomplete=()=>a(),s.onerror=()=>o(s.error)}))}async function io(e){if(!e)return!1;try{const n={mode:"read"};let a=await e.queryPermission(n);return a==="granted"?!0:(a=await e.requestPermission(n),a==="granted")}catch(n){return console.warn("[folder] permission check failed:",n),!1}}async function Yr(e){const n=new FormData;n.append("file",e,e.name),n.append("source","folder");const a=await fetch("/api/ocr/recognize?source=folder",{method:"POST",headers:{Authorization:"Bearer "+token,"X-Source":"folder"},body:n});if(!a.ok){let o="http_"+a.status;try{const s=await a.json();o=s&&s.detail?typeof s.detail=="string"?s.detail:s.detail.code||JSON.stringify(s.detail):o}catch{}throw new Error(o)}return await a.json()}async function Jr(e){try{const a=(await e.getFile()).size;return await new Promise(s=>setTimeout(s,3e3)),(await e.getFile()).size===a&&a>0}catch{return!1}}async function ks(e,n,a,o){if(o>10)return;let s;try{s=await e.queryPermission({mode:"read"})}catch{s="denied"}if(s==="granted")for await(const i of e.values()){const r=n?`${n}/${i.name}`:i.name;if(i.kind==="file"){if(!Gr.test(i.name))continue;let c;try{c=await i.getFile()}catch{continue}const m=`${r}::${c.size}::${c.lastModified}`;if(await Ft("seen",m))continue;a.push({entry:i,file:c,seenKey:m,relPath:r})}else if(i.kind==="directory")try{await ks(i,r,a,o+1)}catch{}}}(function(){const n=typeof window<"u"&&"showDirectoryPicker"in window;let a=null,o=null,s=60,i=!1,r=!1,c=0,m=0,d=0,u=[],l=null,p=!1;function f(z,F){const U=document.getElementById("folder-status-summary");U&&(U.setAttribute("data-i18n",z),U.textContent=t(z),U.className="auto-status-pill"+(F?" "+F:""))}function v(z){["folder-unsupported","folder-empty","folder-active"].forEach(F=>{const U=document.getElementById(F);U&&(U.style.display=F===z?"":"none")})}function w(z){if(!z)return"-";const F=z instanceof Date?z:new Date(z),U=String(F.getHours()).padStart(2,"0"),re=String(F.getMinutes()).padStart(2,"0"),se=String(F.getSeconds()).padStart(2,"0");return`${U}:${re}:${se}`}function b(){v("folder-active");const z=document.getElementById("folder-config-path");z&&a&&(z.textContent=a.name||"-");const F=document.getElementById("folder-interval-select");F&&(F.value=String(s)),document.getElementById("folder-stat-last").textContent=l?w(l):"-",document.getElementById("folder-stat-processed").textContent=String(c),document.getElementById("folder-stat-failed").textContent=String(m),document.getElementById("folder-stat-queue").textContent=String(d);const U=document.getElementById("btn-folder-pause"),re=document.getElementById("btn-folder-resume");U&&(U.style.display=i?"none":""),re&&(re.style.display=i?"":"none"),i?f("folder-status-paused","paused"):f("folder-status-running","running");const se=document.getElementById("folder-status-text");se&&(se.setAttribute("data-i18n",i?"folder-status-paused":"folder-status-running"),se.textContent=t(i?"folder-status-paused":"folder-status-running"));const Se=document.getElementById("folder-status-pulse");Se&&(Se.className="folder-status-pulse"+(i?" paused":"")),g()}function g(){const z=document.getElementById("folder-recent-list");if(z){if(u.length===0){z.innerHTML=`<div class="folder-recent-empty">${escapeHtml(t("folder-recent-empty"))}</div>`;return}z.innerHTML=u.slice(0,20).map(F=>{let U;F.status==="ok"?U=`<span class="folder-recent-icon ok">${svgIcon("check",12)}</span>`:F.status==="dup"?U=`<span class="folder-recent-icon dup" title="${escapeHtml(t("folder-recent-dup"))}">${svgIcon("copy",12)}</span>`:F.status==="skip"?U=`<span class="folder-recent-icon skip" title="${escapeHtml(t("folder-recent-skip"))}">${svgIcon("minus",12)}</span>`:U=`<span class="folder-recent-icon fail">${svgIcon("alert",12)}</span>`;const re=F.status==="fail"&&F.error?F.error:F.status==="dup"&&F.reason||F.status==="skip"&&F.reason?F.reason:"",se=re?`<div class="folder-recent-err">${escapeHtml(re)}</div>`:"";return`
            ...
            `}).join("")}}function h(z){u.unshift(z),u.length>50&&(u.length=50),st("config","recent_list",u).catch(()=>{})}async function _(){if(!(r||i||!a)){r=!0;try{if(await a.queryPermission({mode:"read"})!=="granted"){console.warn("[folder] permission lost · stop"),S(),showToast("warn",t("folder-permission-lost"));return}l=new Date;const F=[];await ks(a,"",F,0),d=F.length,b();for(const U of F){if(i)break;if(!await Jr(U.entry)){d=Math.max(0,d-1),b();continue}try{let se;try{se=await U.entry.getFile()}catch{se=U.file}const Se=await Yr(se);await st("seen",U.seenKey,{name:se.name,relPath:U.relPath,size:se.size,lastModified:se.lastModified,processed_at:Date.now()});const ot=Se.history_ids||(Se.history_id?[Se.history_id]:[]),Fn=Se.duplicate_warnings||[],zn=U.relPath||se.name;ot.length>0?(c+=ot.length,h({name:zn,status:"ok",time:new Date,history_id:ot[0],count:ot.length}),await st("config","processed_count",c)):Fn.length>0?h({name:zn,status:"dup",time:new Date,reason:t("folder-recent-dup-reason")}):h({name:zn,status:"skip",time:new Date,reason:t("folder-recent-skip-reason")})}catch(se){m++,h({name:U.relPath||U.file.name,status:"fail",time:new Date,error:String(se.message||se)}),await st("config","failed_count",m)}d=Math.max(0,d-1),b()}}catch(z){console.warn("[folder] scan error:",z)}finally{r=!1,b()}}}function y(){o&&clearInterval(o),o=setInterval(_,s*1e3)}function k(){o&&(clearInterval(o),o=null)}function x(z){if(!a||i)return;const F=typeof t=="function"?t("folder-unload-warn"):"Folder watcher running · close anyway?";return z.preventDefault(),z.returnValue=F,F}function E(){window._pearnlyFolderUnloadAttached||(window._pearnlyFolderUnloadAttached=!0,window.addEventListener("beforeunload",x))}function L(){window._pearnlyFolderUnloadAttached&&(window._pearnlyFolderUnloadAttached=!1,window.removeEventListener("beforeunload",x))}function I(){i=!1,y(),E(),b(),_()}function B(){i=!0,k(),L(),b()}function C(){i=!1,y(),E(),b(),_()}function S(){i=!0,k(),L()}async function $(){try{const z=await window.showDirectoryPicker({mode:"read",startIn:"documents"});if(!await io(z)){showToast("warn",t("folder-permission-denied"));return}a=z,await st("handles","main",z),c=0,m=0,d=0,u=[],await st("config","processed_count",0),await st("config","failed_count",0),await so("seen"),I()}catch(z){z&&z.name!=="AbortError"&&console.warn("[folder] pick failed:",z)}}async function j(){await showConfirm(t("folder-confirm-remove"),{danger:!0})&&(S(),a=null,c=0,m=0,d=0,u=[],await Rt("handles","main"),await Rt("config","processed_count"),await Rt("config","failed_count"),await so("seen"),v("folder-empty"),f("folder-status-empty",""))}async function N(){u=[];try{await Rt("config","recent_list")}catch{}g()}async function Z(){if(p)return;if(p=!0,!n){v("folder-unsupported"),f("folder-status-unsupported",""),oe();return}ae();let z=null;try{z=await Ft("handles","main")}catch{}if(!z){v("folder-empty"),f("folder-status-empty","");return}if(!await io(z)){v("folder-empty"),f("folder-status-empty",""),await Rt("handles","main"),showToast("warn",t("folder-permission-lost-restart"));return}a=z;try{c=await Ft("config","processed_count")||0}catch{}try{m=await Ft("config","failed_count")||0}catch{}try{const U=await Ft("config","recent_list");Array.isArray(U)&&(u=U.map(re=>({...re,time:re.time?new Date(re.time):new Date})))}catch{}I()}function ae(){const z=document.getElementById("btn-folder-pick"),F=document.getElementById("btn-folder-pause"),U=document.getElementById("btn-folder-resume"),re=document.getElementById("btn-folder-scan-now"),se=document.getElementById("btn-folder-remove"),Se=document.getElementById("btn-folder-clear-recent"),ot=document.getElementById("folder-interval-select");z&&z.addEventListener("click",$),F&&F.addEventListener("click",B),U&&U.addEventListener("click",C),re&&re.addEventListener("click",()=>{_()}),se&&se.addEventListener("click",j),Se&&Se.addEventListener("click",N),ot&&ot.addEventListener("change",Fn=>{s=parseInt(Fn.target.value,10)||60,i||y()}),ue()}function ue(){document.querySelectorAll('[data-auto-panel="folder"] [data-tab-jump]').forEach(z=>{z.dataset.tabJumpBound||(z.dataset.tabJumpBound="1",z.addEventListener("click",F=>{const U=F.currentTarget.dataset.tabJump;if(U==="email")typeof switchAutomationTab=="function"&&switchAutomationTab("email");else if(U==="upload"){const re=document.querySelector('[data-page="recognize"]')||document.querySelector('[data-page="upload"]');re&&re.click()}}))})}function oe(){ue()}window._loadFolderWatcherPanel=Z})();function Xr(){try{if(navigator.userAgentData&&Array.isArray(navigator.userAgentData.brands))return navigator.userAgentData.brands.some(n=>/chromium|google chrome|microsoft edge/i.test(n.brand||""))}catch{}const e=navigator.userAgent||"";return!!(/Edg\//.test(e)||/Chrome\//.test(e)&&!/OPR\/|YaBrowser|Opera/.test(e))}function oa(){try{if(Xr()||localStorage.getItem("pearnly_chrome_banner_dismissed")==="1")return;const e=document.getElementById("chrome-only-banner");if(!e)return;const n=e.querySelector('[data-i18n="chrome-banner-msg"]'),a=e.querySelector('[data-i18n="chrome-banner-dismiss"]');n&&typeof t=="function"&&(n.textContent=t("chrome-banner-msg")),a&&typeof t=="function"&&(a.textContent=t("chrome-banner-dismiss")),e.style.display="";const o=document.getElementById("chrome-only-banner-close");o&&!o.dataset.bound&&(o.dataset.bound="1",o.addEventListener("click",()=>{e.style.display="none";try{localStorage.setItem("pearnly_chrome_banner_dismissed","1")}catch{}}))}catch{}}typeof document<"u"&&(document.readyState==="loading"?document.addEventListener("DOMContentLoaded",oa):setTimeout(oa,0));window._refreshChromeBanner=oa;const Zr=`
        <div class="modal">
            <div class="modal-head">
    ...
    `;be("email-modal",Zr);const q={account:null,presets:null,modalMode:"new",loaded:!1,triggering:!1,autoRefreshTimer:null};function ro(e){q.modalMode=e;const n=document.getElementById("email-modal");if(!n)return;const a=document.getElementById("email-preset");a.innerHTML="";const o=q.presets||{},s=["gmail","outlook","yahoo","icloud","qq","163","custom"],i={gmail:"Gmail",outlook:"Outlook / Office365",yahoo:"Yahoo Mail",icloud:"iCloud",qq:"QQ 邮箱",163:"网易 163"};s.forEach(g=>{if(!o[g])return;const h=document.createElement("option");h.value=g,h.textContent=g==="custom"?t("email-preset-custom"):i[g]||g,a.appendChild(h)});const r=document.getElementById("email-modal-title"),c=document.getElementById("email-address"),m=document.getElementById("email-password"),d=document.getElementById("email-imap-host"),u=document.getElementById("email-imap-port"),l=document.getElementById("email-imap-ssl"),p=document.getElementById("email-folder"),f=document.getElementById("email-mark-read"),v=document.getElementById("email-bind-enabled"),w=document.getElementById("email-test-result"),b=document.getElementById("email-adv-details");if(w&&(w.style.display="none",w.textContent=""),e==="edit"&&q.account){r.setAttribute("data-i18n","email-modal-title-edit"),r.textContent=t("email-modal-title-edit"),c.value=q.account.email_address||"",m.value="",m.setAttribute("data-i18n-placeholder","email-field-password-edit-ph"),m.placeholder=t("email-field-password-edit-ph"),d.value=q.account.imap_host||"",u.value=q.account.imap_port||993,l.checked=q.account.imap_use_ssl!==!1,p.value=q.account.folder||"INBOX",f.checked=q.account.mark_as_read!==!1,v.checked=q.account.enabled!==!1;const g=document.getElementById("email-filter-sender"),h=document.getElementById("email-filter-subject");g&&(g.value=q.account.filter_sender||""),h&&(h.value=q.account.filter_subject||""),co(q.account.interval_min||15),a.value=el(q.account.imap_host)||"custom",b&&(b.open=!0)}else{r.setAttribute("data-i18n","email-modal-title-new"),r.textContent=t("email-modal-title-new"),c.value="",m.value="",m.setAttribute("data-i18n-placeholder","email-field-password-ph"),m.placeholder=t("email-field-password-ph"),a.value="gmail",Ca("gmail"),p.value="INBOX",f.checked=!0,v.checked=!0;const g=document.getElementById("email-filter-sender"),h=document.getElementById("email-filter-subject");g&&(g.value=""),h&&(h.value=""),co(15),b&&(b.open=!1)}tl(),n.style.display="flex",setTimeout(()=>c.focus(),60)}function Un(){const e=document.getElementById("email-modal");e&&(e.style.display="none")}function Ca(e){const n=(q.presets||{})[e];if(!n||e==="custom")return;const a=document.getElementById("email-imap-host"),o=document.getElementById("email-imap-port"),s=document.getElementById("email-imap-ssl");a&&(a.value=n.host||""),o&&(o.value=n.port||993),s&&(s.checked=n.ssl!==!1)}const Qr={"gmail.com":"gmail","googlemail.com":"gmail","outlook.com":"outlook","hotmail.com":"outlook","live.com":"outlook","office365.com":"outlook","msn.com":"outlook","yahoo.com":"yahoo","yahoo.co.jp":"yahoo","icloud.com":"icloud","me.com":"icloud","mac.com":"icloud","qq.com":"qq","foxmail.com":"qq","163.com":"163","126.com":"163","yeah.net":"163"};function lo(e){if(!e||!e.includes("@"))return;const n=e.split("@")[1].toLowerCase().trim(),a=Qr[n];if(!a)return;const o=document.getElementById("email-preset");if(!o)return;const s=o.value;s&&s!=="custom"&&s!==""&&s===a||(o.value=a,Ca(a))}function el(e){if(!e)return null;const n=q.presets||{};for(const a in n)if(a!=="custom"&&n[a]&&n[a].host===e)return a;return null}function xs(){const e=document.querySelector("#email-interval-options .email-interval-btn.active"),n=e?parseInt(e.dataset.interval,10):15;return{email_address:(document.getElementById("email-address").value||"").trim(),password:document.getElementById("email-password").value||"",imap_host:(document.getElementById("email-imap-host").value||"").trim(),imap_port:parseInt(document.getElementById("email-imap-port").value||"993",10)||993,imap_use_ssl:document.getElementById("email-imap-ssl").checked,folder:(document.getElementById("email-folder").value||"INBOX").trim()||"INBOX",mark_as_read:document.getElementById("email-mark-read").checked,enabled:document.getElementById("email-bind-enabled").checked,interval_min:[5,15,60].includes(n)?n:15,filter_sender:(document.getElementById("email-filter-sender").value||"").trim()||null,filter_subject:(document.getElementById("email-filter-subject").value||"").trim()||null}}function tl(){const e=document.getElementById("email-interval-options");!e||e._bound||(e._bound=!0,e.addEventListener("click",n=>{const a=n.target.closest(".email-interval-btn");a&&(e.querySelectorAll(".email-interval-btn").forEach(o=>o.classList.remove("active")),a.classList.add("active"))}))}function co(e){const n=[5,15,60].includes(e)?e:15,a=document.getElementById("email-interval-options");a&&a.querySelectorAll(".email-interval-btn").forEach(o=>{o.classList.toggle("active",parseInt(o.dataset.interval,10)===n)})}function we(e,n){const a=document.getElementById("email-test-result");a&&(a.style.display="",a.textContent=n,a.className="form-test-result "+(e==="ok"?"ok":e==="running"?"running":"fail"))}async function nl(){const e=xs();if(!e.email_address){we("fail",t("email-addr-required"));return}if(!e.password){we("fail",t("email-password-required"));return}if(!e.imap_host){we("fail",t("email-host-required"));return}const n=document.getElementById("btn-email-modal-test");n&&(n.disabled=!0),we("running",t("email-test-running"));try{const a=await fetch("/api/email-ingest/test",{method:"POST",headers:{Authorization:"Bearer "+token,"Content-Type":"application/json"},body:JSON.stringify({email_address:e.email_address,password:e.password,imap_host:e.imap_host,imap_port:e.imap_port,imap_use_ssl:e.imap_use_ssl,folder:e.folder})}),o=await a.json().catch(()=>({}));if(a.ok&&o.success)we("ok",t("email-test-ok",{folder:e.folder,n:o.folder_count??"?"}));else{const s=o.error_msg||"";s==="auth_failed"||/auth/i.test(s)?we("fail",t("email-test-auth-fail")):we("fail",t("email-test-fail",{msg:s||a.status}))}}catch(a){we("fail",t("email-test-fail",{msg:String(a).slice(0,120)}))}finally{n&&(n.disabled=!1)}}(function(){async function e(){const p=document.getElementById("email-empty"),f=document.getElementById("email-account-card");if(document.getElementById("email-logs-section"),!(!p||!f))try{const v=await fetch("/api/email-ingest/account",{headers:{Authorization:"Bearer "+token}});if(v.status===401){localStorage.removeItem("mrpilot_token");const b=await v.json().catch(()=>({}));if((typeof b.detail=="string"?b.detail:b.detail&&b.detail.code||"")==="auth.session_revoked"){_showSessionRevokedModal();return}window.location.href="/";return}if(!v.ok){a("none");return}const w=await v.json();q.account=w.account||null,q.presets=w.presets||{},q.loaded=!0,n(),q.account&&d()}catch(v){console.error("[email-ingest] load failed",v),a("none")}}function n(){const p=document.getElementById("email-empty"),f=document.getElementById("email-account-card"),v=document.getElementById("email-logs-section");if(!q.account){p.style.display="",f.style.display="none",v&&(v.style.display="none"),a("none");return}p.style.display="none",f.style.display="",v&&(v.style.display="");const w=document.getElementById("email-account-addr"),b=document.getElementById("email-account-host"),g=document.getElementById("email-account-last"),h=document.getElementById("email-last-error"),_=document.getElementById("email-enabled-toggle");if(w&&(w.textContent=q.account.email_address||"-"),b&&(b.textContent=`${q.account.imap_host||"-"}:${q.account.imap_port||993}`),g){const y=q.account.last_fetched_at;if(!y)g.textContent=t("email-last-never");else{const k=o(y),x=!q.account.last_error;g.textContent=x?t("email-last-ok",{time:k}):t("email-last-fail",{time:k})}}h&&(q.account.last_error?(h.style.display="",h.textContent=s(q.account.last_error)):h.style.display="none"),_&&(_.checked=!!q.account.enabled),q.account.enabled?q.account.last_error?a("error"):a("on"):a("off")}function a(p){const f=document.getElementById("email-status-summary");if(!f)return;f.classList.remove("none","ready","active","coming");let v="auto-status-loading";p==="none"?(v="email-status-none",f.classList.add("none")):p==="on"?(v="email-status-on",f.classList.add("active")):p==="off"?(v="email-status-off",f.classList.add("coming")):p==="error"&&(v="email-status-error",f.classList.add("none")),f.setAttribute("data-i18n",v),f.textContent=t(v)}function o(p){if(!p)return"";const f=new Date(p);if(isNaN(f.getTime()))return"";const v=w=>String(w).padStart(2,"0");return`${v(f.getMonth()+1)}-${v(f.getDate())} ${v(f.getHours())}:${v(f.getMinutes())}`}function s(p){if(!p)return"";const f=String(p);return/auth|AUTHENTICATIONFAILED|invalid credentials/i.test(f)?t("email-test-auth-fail"):/timeout|timed out/i.test(f)?t("email.timeout"):(/ENOTFOUND|getaddrinfo/i.test(f),f)}async function i(){const p=xs();if(!p.email_address){we("fail",t("email-addr-required"));return}if(q.modalMode==="new"&&!p.password){we("fail",t("email-password-required"));return}if(!p.imap_host){we("fail",t("email-host-required"));return}const f=document.getElementById("btn-email-modal-save");f&&(f.disabled=!0);const v={...p};q.modalMode==="edit"&&!v.password&&delete v.password;try{const w=await fetch("/api/email-ingest/account",{method:"PUT",headers:{Authorization:"Bearer "+token,"Content-Type":"application/json"},body:JSON.stringify(v)}),b=await w.json().catch(()=>({}));if(w.ok&&b.ok)q.account=b.account,showToast(t("email-save-ok"),"success"),Un(),n(),d();else{const h="email."+(b.detail||"").split(".").slice(-1)[0];we("fail",t(h)!==h?t(h):t("email-save-fail"))}}catch{we("fail",t("email-save-fail"))}finally{f&&(f.disabled=!1)}}async function r(){if(!(!q.account||!await showConfirm(t("email-unbind-confirm",{email:q.account.email_address}),{danger:!0,okText:t("email-btn-unbind")})))try{if((await fetch("/api/email-ingest/account",{method:"DELETE",headers:{Authorization:"Bearer "+token}})).ok){q.account=null,showToast(t("email-unbind-ok"),"success"),n();const v=document.getElementById("email-logs-list");v&&(v.innerHTML="")}else showToast(t("email-unbind-fail"),"error")}catch{showToast(t("email-unbind-fail"),"error")}}async function c(){if(!q.account||q.triggering)return;if(!q.account.enabled){showToast(t("email.disabled"),"error");return}q.triggering=!0;const p=document.getElementById("btn-email-trigger"),f=p?p.innerHTML:"";p&&(p.disabled=!0,p.innerHTML=`<span>${escapeHtml(t("email-trigger-running"))}</span>`);try{const v=await fetch("/api/email-ingest/trigger",{method:"POST",headers:{Authorization:"Bearer "+token}}),w=await v.json().catch(()=>({}));if(v.ok){const b=w.emails_scanned||0,g=w.ocr_succeeded||0,h=w.ocr_failed||0;b===0&&g===0&&h===0?showToast(t("email-trigger-empty"),"success"):showToast(t("email-trigger-result",{scanned:b,ok:g,fail:h}),h>0?"warn":"success")}else{const g="email."+(w.detail||"").split(".").slice(-1)[0];showToast(t(g)!==g?t(g):t("email-trigger-fail"),"error")}await e()}catch{showToast(t("email-trigger-fail"),"error")}finally{q.triggering=!1,p&&(p.disabled=!1,p.innerHTML=f)}}async function m(){if(!q.account)return;const p=document.getElementById("email-enabled-toggle"),f=!!(p&&p.checked),v=q.account.enabled;try{const w=await fetch("/api/email-ingest/account",{method:"PUT",headers:{Authorization:"Bearer "+token,"Content-Type":"application/json"},body:JSON.stringify({email_address:q.account.email_address,imap_host:q.account.imap_host,imap_port:q.account.imap_port,imap_use_ssl:q.account.imap_use_ssl,folder:q.account.folder||"INBOX",filter_subject:q.account.filter_subject||null,filter_sender:q.account.filter_sender||null,mark_as_read:q.account.mark_as_read!==!1,enabled:f})}),b=await w.json().catch(()=>({}));w.ok&&b.ok?(q.account=b.account,n()):(p&&(p.checked=v),showToast(t("email-toggle-fail"),"error"))}catch{p&&(p.checked=v),showToast(t("email-toggle-fail"),"error")}}async function d(){const p=document.getElementById("email-logs-list");if(p){p.innerHTML=`<div class="erp-logs-empty">${escapeHtml(t("erp-logs-loading"))}</div>`;try{const f=await fetch("/api/email-ingest/logs?limit=20",{headers:{Authorization:"Bearer "+token}});if(!f.ok){p.innerHTML=`<div class="erp-logs-empty">${escapeHtml(t("erp-logs-error"))}</div>`;return}const v=await f.json();if(!Array.isArray(v)||v.length===0){p.innerHTML=`<div class="erp-logs-empty">${escapeHtml(t("email-logs-empty"))}</div>`;return}p.innerHTML=v.map(u).join("")}catch{p.innerHTML=`<div class="erp-logs-empty">${escapeHtml(t("erp-logs-error"))}</div>`}}}function u(p){const f=o(p.created_at),v=p.status||"failed",w=v==="success"?"ok":v==="partial"?"partial":"fail",b=v==="success"?"✓":v==="partial"?"◐":"✗",g=p.trigger==="manual"?`<span class="log-tag manual">${escapeHtml(t("email-log-tag-manual"))}</span>`:`<span class="log-tag auto">${escapeHtml(t("email-log-tag-auto"))}</span>`,h=t("email-log-counts",{scanned:p.emails_scanned||0,att:p.attachments_found||0,ok:p.ocr_succeeded||0,fail:p.ocr_failed||0}),_=(p.elapsed_ms||0)+"ms";return`
        ...
        `}function l(){const p=document.getElementById("btn-email-bind");p&&p.addEventListener("click",()=>ro("new"));const f=document.getElementById("btn-email-edit");f&&f.addEventListener("click",()=>ro("edit"));const v=document.getElementById("btn-email-unbind");v&&v.addEventListener("click",r);const w=document.getElementById("btn-email-trigger");w&&w.addEventListener("click",c);const b=document.getElementById("email-enabled-toggle");b&&b.addEventListener("change",m);const g=document.getElementById("email-modal-close");g&&g.addEventListener("click",Un);const h=document.getElementById("btn-email-modal-cancel");h&&h.addEventListener("click",Un);const _=document.getElementById("btn-email-modal-test");_&&_.addEventListener("click",nl);const y=document.getElementById("btn-email-modal-save");y&&y.addEventListener("click",i);const k=document.getElementById("email-preset");k&&k.addEventListener("change",L=>Ca(L.target.value));const x=document.getElementById("email-address");x&&!x.dataset.autoBound&&(x.dataset.autoBound="1",x.addEventListener("blur",L=>lo((L.target.value||"").trim())),x.addEventListener("input",L=>{const I=(L.target.value||"").trim();I.includes("@")&&I.split("@")[1].includes(".")&&lo(I)}));const E=document.getElementById("btn-email-refresh-logs");E&&E.addEventListener("click",()=>{E.classList.add("spinning"),setTimeout(()=>E.classList.remove("spinning"),600),d()})}l(),window._loadEmailIngestPanel=e,window._rerenderEmailIngest=function(){if(!q.loaded)return;n();const p=document.getElementById("email-logs-section");q.account&&p&&p.open&&d()},window._startEmailLogAutoRefresh=function(){q.autoRefreshTimer||(q.autoRefreshTimer=setInterval(()=>{q.account&&q.loaded&&d()},3e4))},window._stopEmailLogAutoRefresh=function(){q.autoRefreshTimer&&(clearInterval(q.autoRefreshTimer),q.autoRefreshTimer=null)}})();const al=`
...
`;be("bank-cand-drawer",al);const ol=`
    <div class="modal" style="max-width: 420px;">
        <div class="modal-head">
...
`;be("bank-client-picker-modal",ol);const M={sessions:[],currentSession:null,currentTxs:[],currentFilter:"all",currentTxForDrawer:null,loaded:!1,queue:[],qSeq:0,sessionFilter:"all",pickerSelected:null};function sl(e){const n=Number(e||0);let a="score-low";return n>=85?a="score-high":n>=60&&(a="score-mid"),'<span class="bank-cand-score '+a+'">'+n.toFixed(0)+" "+t("bank-cand-score-unit")+"</span>"}function il(e){const n=document.getElementById("bank-upload-progress");n&&(n.style.display="none")}function rl(){const e=document.getElementById("bank-upload-error");e&&(e.style.display="none")}function ll(e){return{"bank_recon.only_pdf":t("bank-err-only-pdf"),"bank_recon.empty_file":t("bank-err-empty"),"bank_recon.file_too_large":t("bank-err-too-large"),"bank_recon.save_failed":t("bank-err-server"),"bank_recon.scanned":t("bank-err-scanned"),"bank_recon.no_tx":t("bank-err-no-tx"),network:t("bank-err-network")}[e]||t("bank-err-unknown")+" ("+e+")"}function pt(e){if(e==null)return"-";const n=Number(e);return isNaN(n)?"-":n.toLocaleString("en-US",{minimumFractionDigits:2,maximumFractionDigits:2})}function St(e){if(!e)return"-";const n=String(e);return n.length>=10?n.slice(0,10):n}function _s(e,n){return!e&&!n?"":(St(e)||"?")+" ~ "+(St(n)||"?")}function K(e){return e==null?"":String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}async function cl(e){M.currentTxForDrawer=e;const n=document.getElementById("bank-detail-body");n&&n.classList.add("has-pane");const a=document.getElementById("bank-cand-pane-title"),o=document.getElementById("bank-cand-pane-sub"),s=document.getElementById("bank-cand-pane-foot");if(a&&(a.textContent=t("bank-cand-pane-current")),o){const r=e.direction==="OUT"?"-":"+",c=e.direction==="OUT"?"bank-out":"bank-in";o.innerHTML=`${K(St(e.tx_date))}
            <span style="margin:0 6px;color:#D1D5DB">·</span>
            <span>${K(e.description||"-")}</span>
            <span style="margin:0 6px;color:#D1D5DB">·</span>
            <strong class="${c}">${r}${pt(e.amount)}</strong>`}s&&(s.style.display="");const i=document.getElementById("bank-cand-pane-body");if(i){i.innerHTML=`<div class="bank-empty">${t("bank-cand-loading")}</div>`;try{const r=await fetch("/api/bank-recon/tx/"+encodeURIComponent(e.id)+"/candidates",{headers:{Authorization:"Bearer "+token}});if(!r.ok)throw new Error("cands:"+r.status);const c=await r.json();pl(e,c.candidates||[])}catch{i.innerHTML=`<div class="bank-empty">${t("bank-cand-load-failed")}</div>`}}}function dl(e,n,a){const o=n.history_id,s=n.invoice_no||"-",i=n.vendor||"-",r=n.amount_total!==null&&n.amount_total!==void 0?pt(n.amount_total):"-",c=n.invoice_date?St(n.invoice_date):"-",m=n.filename||"",d=!!a&&e.matched_history_id===o,u="bank-cand-card"+(n.is_auto_picked?" is-auto":"")+(d?" is-picked":"");let l="";return d?l='<button class="btn btn-ghost btn-small" data-act="unmatch"><span>'+t("bank-cand-unmatch")+"</span></button>":l='<button class="btn btn-primary btn-small" data-act="pick" data-hid="'+K(o)+'"><span>'+t(n.is_auto_picked?"bank-cand-confirm":"bank-cand-pick-this")+"</span></button>",'<div class="'+u+'" data-hid="'+K(o)+'"><div class="bank-cand-card-head"><div class="bank-cand-card-vendor">'+K(i)+"</div>"+sl(n.score)+'</div><div class="bank-cand-card-fields"><span class="bank-cand-field"><span class="bank-cand-flabel">'+t("bank-cand-fld-invoice-no")+"</span> "+K(s)+'</span><span class="bank-cand-field"><span class="bank-cand-flabel">'+t("bank-cand-fld-amount")+"</span> "+r+'</span><span class="bank-cand-field"><span class="bank-cand-flabel">'+t("bank-cand-fld-date")+"</span> "+K(c)+"</span></div>"+(m?'<div class="bank-cand-card-file" title="'+K(m)+'">'+K(m)+"</div>":"")+(n.reason?'<div class="bank-cand-card-reason">'+K(n.reason)+"</div>":"")+'<div class="bank-cand-card-actions">'+l+"</div></div>"}function pl(e,n){const a=document.getElementById("bank-cand-pane-body");if(!a)return;const o=n||[];let s="";if(e.match_status==="matched")s='<div class="bank-cand-hint hint-matched">'+t("bank-cand-hint-matched").replace("{n}",o.length)+"</div>";else if(e.match_status==="suggested")s='<div class="bank-cand-hint hint-suggested">'+t("bank-cand-hint-suggested").replace("{n}",o.length)+"</div>";else if(o.length>0)s='<div class="bank-cand-hint hint-low">'+t("bank-cand-hint-low").replace("{n}",o.length)+"</div>";else{a.innerHTML='<div class="bank-empty">'+t("bank-cand-no-match-detail")+"</div>";return}const i=e.match_status==="matched",r=o.map(c=>dl(e,c,i)).join("");a.innerHTML=s+'<div class="bank-cand-list">'+r+"</div>",a.querySelectorAll('[data-act="pick"]').forEach(c=>{c.addEventListener("click",()=>{ml(c.dataset.hid)})}),a.querySelectorAll('[data-act="unmatch"]').forEach(c=>{c.addEventListener("click",async()=>{try{await fetch("/api/bank-recon/tx/"+encodeURIComponent(e.id)+"/override",{method:"POST",headers:{Authorization:"Bearer "+token,"Content-Type":"application/json"},body:JSON.stringify({status:"unmatched"})}),Zt(),await Ht(M.currentSession.id)}catch{showToast(t("bank-action-failed"),"error")}})})}function Zt(){const e=document.getElementById("bank-detail-body");e&&e.classList.remove("has-pane");const n=document.getElementById("bank-cand-pane-title"),a=document.getElementById("bank-cand-pane-sub"),o=document.getElementById("bank-cand-pane-body"),s=document.getElementById("bank-cand-pane-foot");n&&(n.textContent=t("bank-cand-pane-empty-title")),a&&(a.textContent=t("bank-cand-pane-empty-sub")),s&&(s.style.display="none"),o&&(o.innerHTML='<div class="bank-cand-pane-empty"><svg viewBox="0 0 64 64" fill="none" stroke="currentColor" stroke-width="1.4" stroke-linecap="round" stroke-linejoin="round"><rect x="14" y="10" width="36" height="44" rx="3"/><path d="M22 22h20M22 30h20M22 38h12"/></svg><div>'+t("bank-cand-pane-empty-hint")+"</div></div>");const i=document.getElementById("bank-tx-tbody");i&&i.querySelectorAll("tr.is-selected").forEach(r=>r.classList.remove("is-selected")),M.currentTxForDrawer=null}async function Ht(e){try{const n="/api/bank-recon/sessions/"+encodeURIComponent(e)+(M.currentFilter!=="all"?"?filter="+M.currentFilter:""),a=await fetch(n,{headers:{Authorization:"Bearer "+token}});if(!a.ok)throw new Error("detail:"+a.status);const o=await a.json();M.currentSession=o.session,M.currentTxs=o.transactions||[],wl()}catch(n){console.warn("[bank-recon] loadSessionDetail failed",n),showToast(t("bank-load-failed"),"error")}}async function ul(){if(!M.currentSession)return;const e=document.getElementById("btn-bank-run-match"),n=e.innerHTML;e.disabled=!0,e.innerHTML="<span>"+t("bank-matching")+"</span>";try{const a=await fetch("/api/bank-recon/sessions/"+encodeURIComponent(M.currentSession.id)+"/match",{method:"POST",headers:{Authorization:"Bearer "+token}});if(!a.ok)throw new Error("match:"+a.status);const o=await a.json();showToast(t("bank-match-done").replace("{matched}",o.matched).replace("{suggested}",o.suggested).replace("{unmatched}",o.unmatched),"success"),await Ht(M.currentSession.id),await At()}catch(a){console.warn("[bank-recon] match failed",a),showToast(t("bank-match-failed"),"error")}finally{e.disabled=!1,e.innerHTML=n}}async function fl(){if(!(!M.currentSession||!await showConfirm(t("bank-delete-confirm"),{danger:!0})))try{const n=await fetch("/api/bank-recon/sessions/"+encodeURIComponent(M.currentSession.id),{method:"DELETE",headers:{Authorization:"Bearer "+token}});if(!n.ok)throw new Error("delete:"+n.status);showToast(t("bank-deleted"),"success"),M.currentSession=null,M.currentTxs=[],Ma(),await At()}catch(n){console.warn("[bank-recon] delete failed",n),showToast(t("bank-delete-failed"),"error")}}async function po(){if(M.currentTxForDrawer)try{const e=await fetch("/api/bank-recon/tx/"+encodeURIComponent(M.currentTxForDrawer.id)+"/override",{method:"POST",headers:{Authorization:"Bearer "+token,"Content-Type":"application/json"},body:JSON.stringify({status:"ignored"})});if(!e.ok)throw new Error("ignore:"+e.status);Zt(),await Ht(M.currentSession.id)}catch{showToast(t("bank-action-failed"),"error")}}async function ml(e){if(M.currentTxForDrawer)try{const n=await fetch("/api/bank-recon/tx/"+encodeURIComponent(M.currentTxForDrawer.id)+"/override",{method:"POST",headers:{Authorization:"Bearer "+token,"Content-Type":"application/json"},body:JSON.stringify({status:"matched",history_id:e})});if(!n.ok)throw new Error("pick:"+n.status);showToast(t("bank-matched-ok"),"success"),Zt(),await Ht(M.currentSession.id)}catch{showToast(t("bank-action-failed"),"error")}}function Es(){if(!M.currentSession)return;const e=M.currentSession;document.getElementById("bank-detail-title").textContent=(e.bank_code||"-")+(e.account_last4?" ···"+e.account_last4:"")+" · "+(e.source_filename||""),document.getElementById("bank-meta-period").textContent=_s(e.period_start,e.period_end)||"-",document.getElementById("bank-meta-opening").textContent=pt(e.opening_balance),document.getElementById("bank-meta-inflow").textContent="+"+pt(e.total_inflow),document.getElementById("bank-meta-outflow").textContent="-"+pt(e.total_outflow),document.getElementById("bank-meta-closing").textContent=pt(e.closing_balance);const n=M.currentTxs||[],a=n.length;let o=0,s=0,i=0;for(const r of n){const c=r.match_status||"unmatched";c==="matched"?o++:c==="suggested"?s++:i++}document.getElementById("bank-stat-total").textContent=a,document.getElementById("bank-stat-matched").textContent=o,document.getElementById("bank-stat-suggested").textContent=s,document.getElementById("bank-stat-unmatched").textContent=i}function Sa(){const e=document.getElementById("bank-tx-tbody");if(!e)return;let n=M.currentTxs||[];if(M.currentFilter!=="all"&&(n=n.filter(a=>M.currentFilter==="matched"?a.match_status==="matched":M.currentFilter==="suggested"?a.match_status==="suggested":M.currentFilter==="unmatched"?a.match_status==="unmatched"||a.match_status==="ignored":!0)),n.length===0){e.innerHTML=`<tr><td colspan="4" class="bank-empty">${t("bank-tx-empty")}</td></tr>`;return}if(e.innerHTML=n.map(a=>vl(a)).join(""),e.querySelectorAll("tr[data-tx-id]").forEach(a=>{a.addEventListener("click",()=>{const o=a.dataset.txId,s=M.currentTxs.find(i=>i.id===o);s&&(e.querySelectorAll("tr.is-selected").forEach(i=>i.classList.remove("is-selected")),a.classList.add("is-selected"),cl(s))})}),M.currentTxForDrawer){const a=e.querySelector('tr[data-tx-id="'+M.currentTxForDrawer.id+'"]');a&&a.classList.add("is-selected")}}function vl(e){const n=e.direction==="OUT",a=n?"-":"+",o=n?"bank-out":"bank-in",s=e.match_status||"unmatched",i=t("bank-match-"+s)||s,r=St(e.tx_date),c=e.channel?`<span class="bank-tx-channel">${K(e.channel)}</span>`:"";return`
        <tr data-tx-id="${K(e.id)}">
            <td class="bank-tx-date">${K(r)}</td>
            <td class="bank-tx-desc">${c}${K(e.description||"-")}</td>
            <td class="bank-td-amount ${o}">${a}${pt(e.amount)}</td>
            <td><span class="bank-tx-match mt-${s}">${K(i)}</span></td>
        </tr>
    `}function Ta(){const e=document.getElementById("bank-client-badge");if(!e||!M.currentSession)return;const n=M.currentSession.client_id,a=document.getElementById("bank-client-badge-dot"),o=document.getElementById("bank-client-badge-name"),s=document.getElementById("bank-client-badge-caret"),i=typeof _userInfo<"u"?_userInfo:null,r=!(i&&i.role==="member");if(n!=null){const c=(window._clientsCache||[]).find(m=>Number(m.id)===Number(n));e.classList.remove("is-empty"),a&&(a.style.background=c&&c.color||"#111111"),o&&(o.textContent=c&&(c.short_name||c.name)||"#"+n)}else e.classList.add("is-empty"),a&&(a.style.background=""),o&&(o.textContent=t("bank-client-none"));r?(e.classList.remove("is-readonly"),e.disabled=!1,s&&(s.style.display="")):(e.classList.add("is-readonly"),e.disabled=!0,s&&(s.style.display="none")),e.style.display=""}function hl(){if(!M.currentSession)return;const e=typeof _userInfo<"u"?_userInfo:null;if(!!(e&&e.role==="member"))return;M.pickerSelected=M.currentSession.client_id!=null?Number(M.currentSession.client_id):null,Is();const a=document.getElementById("bank-client-picker-modal");a&&(a.style.display="")}function Ls(){const e=document.getElementById("bank-client-picker-modal");e&&(e.style.display="none"),M.pickerSelected=null}function Is(){const e=document.getElementById("bank-client-picker-list");if(!e)return;const n=(window._clientsCache||[]).filter(o=>o&&(o.is_active===!0||o.is_active===void 0)),a=[];a.push('<div class="bank-client-picker-row is-none'+(M.pickerSelected==null?" is-selected":"")+'" data-cid=""><span class="bank-cp-dot"></span><span>'+K(t("bank-client-picker-none"))+"</span></div>"),n.forEach(o=>{const s=Number(o.id)===Number(M.pickerSelected)?" is-selected":"";a.push('<div class="bank-client-picker-row'+s+'" data-cid="'+K(o.id)+'"><span class="bank-cp-dot" style="background:'+K(o.color||"#111111")+'"></span><span>'+K(o.short_name||o.name||"#"+o.id)+"</span></div>")}),e.innerHTML=a.join(""),e.querySelectorAll(".bank-client-picker-row").forEach(o=>{o.addEventListener("click",()=>{const s=o.dataset.cid;M.pickerSelected=s?Number(s):null,Is()})})}async function gl(){if(M.currentSession)try{const e=await fetch("/api/bank-recon/sessions/"+encodeURIComponent(M.currentSession.id)+"/client",{method:"PATCH",headers:{Authorization:"Bearer "+token,"Content-Type":"application/json"},body:JSON.stringify({client_id:M.pickerSelected})});if(!e.ok)throw new Error("client:"+e.status);M.currentSession.client_id=M.pickerSelected,Ta(),showToast(t("bank-client-changed"),"success"),Ls();try{await At()}catch{}}catch(e){console.warn("[bank-recon] save client failed",e),showToast(t("bank-client-change-failed"),"error")}}async function At(){try{const e=await fetch("/api/bank-recon/sessions?limit=30",{headers:{Authorization:"Bearer "+token}});if(!e.ok)throw new Error("sessions:"+e.status);M.sessions=await e.json(),kn()}catch(e){console.warn("[bank-recon] loadSessions failed",e),M.sessions=[],kn()}}function uo(){const e=document.getElementById("bank-status-summary");if(!e)return;if(M.sessions.length===0){e.textContent=t("bank-pill-none");return}let a=0;for(const o of M.sessions)o.parse_status==="parsed"&&(o.unmatched_count||0)>0&&a++;e.textContent=a>0?t("bank-pill-pending").replace("{n}",a):t("bank-pill-ok")}function kn(){const e=document.getElementById("bank-sessions-list");if(!e)return;let n=M.sessions||[];if(M.sessionFilter==="parsed"?n=n.filter(a=>a.parse_status==="parsed"):M.sessionFilter==="failed"&&(n=n.filter(a=>a.parse_status==="parse_failed")),!M.sessions||M.sessions.length===0){e.innerHTML='<div class="bank-empty" data-i18n="bank-sessions-empty">'+t("bank-sessions-empty")+"</div>";return}if(n.length===0){e.innerHTML='<div class="bank-empty">'+t("bank-sess-filter-empty")+"</div>";return}e.innerHTML=n.map(a=>bl(a)).join(""),e.querySelectorAll(".bank-session-row").forEach(a=>{a.addEventListener("click",o=>{o.target.closest(".bank-session-trash")||Ht(a.dataset.sessionId)})}),e.querySelectorAll(".bank-session-trash").forEach(a=>{a.addEventListener("click",o=>{o.stopPropagation();const s=a.dataset.sessionId,i=a.dataset.sessionName||"";Bs(s,i)})})}async function Bs(e,n){if(!e)return;const a=(t("bank-session-delete-confirm")||"确定删除这条对账记录吗?").replace("{name}",n||"");if(await showConfirm(a,{danger:!0}))try{const s=await fetch("/api/bank-recon/sessions/"+encodeURIComponent(e),{method:"DELETE",headers:{Authorization:"Bearer "+token}});if(!s.ok)throw new Error("delete:"+s.status);showToast(t("bank-deleted"),"success"),M.currentSession&&M.currentSession.id===e&&(M.currentSession=null,M.currentTxs=[],Ma()),await At(),typeof window.loadReconcilePage=="function"&&window.loadReconcilePage()}catch(s){console.warn("[bank-recon] delete failed",s),showToast(t("bank-delete-failed"),"error")}}function bl(e){const n=(e.bank_code||"OTHER").toUpperCase(),a=_s(e.period_start,e.period_end),o=e.account_last4?"···"+e.account_last4:"",s=yl(e),i=St(e.created_at);return`
    ...
    `}function yl(e){if(e.parse_status==="parse_failed")return`<span class="bank-session-count cnt-failed">${t("bank-count-parse-failed")}</span>`;if(e.parse_status!=="parsed")return`<span class="bank-session-count">${t("bank-count-parsing")}</span>`;const n=e.tx_count||0,a=e.matched_count||0,o=e.unmatched_count||0,s=[`<span class="bank-session-count">${n} ${t("bank-count-tx")}</span>`];return a>0&&s.push(`<span class="bank-session-count cnt-matched">${a} ${t("bank-count-matched")}</span>`),o>0&&s.push(`<span class="bank-session-count cnt-unmatched">${o} ${t("bank-count-unmatched")}</span>`),s.join("")}function wl(){document.getElementById("bank-detail").style.display="",document.querySelector(".bank-sessions-section").style.display="none",Es(),Sa(),Ta()}function Ma(){document.getElementById("bank-detail").style.display="none",document.querySelector(".bank-sessions-section").style.display="";const e=document.getElementById("bank-detail-body");e&&e.classList.remove("has-pane"),M.currentTxForDrawer=null}const kl=3;function xl(){return M.qSeq+=1,"q"+M.qSeq+"_"+Date.now()}async function _l(e){const n=Array.from(e.target.files||[]);if(e.target.value="",n.length!==0){for(const a of n){const o={id:xl(),file:a,name:a.name,size:a.size,status:"pending",progress:0,error_code:null,tx_count:0,session_id:null};a.name.toLowerCase().endsWith(".pdf")?a.size>20*1024*1024&&(o.status="failed",o.error_code="bank_recon.file_too_large"):(o.status="failed",o.error_code="bank_recon.only_pdf"),M.queue.push(o)}El(),Ie(),$a()}}function El(){const e=document.getElementById("bank-upload-queue");e&&(e.style.display=""),il(),rl()}function Ie(){const e=document.getElementById("bank-upload-queue-list"),n=document.getElementById("bank-upload-queue-summary");if(!e)return;if(M.queue.length===0){e.innerHTML="",n&&(n.textContent="");const r=document.getElementById("bank-upload-queue");r&&(r.style.display="none");return}let a=0,o=0,s=0,i=0;for(const r of M.queue)r.status==="ok"?a++:r.status==="failed"?o++:r.status==="uploading"||r.status==="parsing"?s++:i++;n&&(n.textContent=t("bank-queue-summary").replace("{ok}",a).replace("{run}",s).replace("{wait}",i).replace("{fail}",o)),e.innerHTML=M.queue.map(Ll).join(""),e.querySelectorAll("[data-q-act]").forEach(r=>{const c=r.dataset.qAct,m=r.dataset.qId;r.addEventListener("click",()=>{c==="retry"&&Il(m),c==="remove"&&Bl(m)})})}function Ll(e){const n=(e.size/1024).toFixed(0)+" KB";let a="",o="";if(e.status==="pending")a='<span class="bq-stat bq-wait">'+t("bank-queue-status-wait")+"</span>",o='<button data-q-act="remove" data-q-id="'+K(e.id)+'" class="bq-act">×</button>';else if(e.status==="uploading")a='<span class="bq-stat bq-run">'+t("bank-queue-status-uploading")+'</span><div class="bq-bar"><div class="bq-bar-fill" style="width:'+(e.progress||0)+'%"></div></div>';else if(e.status==="parsing")a='<span class="bq-stat bq-run">'+t("bank-queue-status-parsing")+'</span><div class="bq-bar"><div class="bq-bar-fill bq-bar-indet"></div></div>';else if(e.status==="ok")a='<span class="bq-stat bq-ok">'+t("bank-queue-status-ok").replace("{n}",e.tx_count||0)+"</span>",o='<button data-q-act="remove" data-q-id="'+K(e.id)+'" class="bq-act">×</button>';else if(e.status==="failed"){const s=ll(e.error_code||"unknown");a='<span class="bq-stat bq-fail" title="'+K(s)+'">'+K(s)+"</span>",o='<button data-q-act="retry" data-q-id="'+K(e.id)+'" class="bq-act bq-act-retry">'+t("bank-queue-retry")+'</button><button data-q-act="remove" data-q-id="'+K(e.id)+'" class="bq-act">×</button>'}return'<div class="bq-row" data-q-row="'+K(e.id)+'"><div class="bq-name" title="'+K(e.name)+'">'+K(e.name)+'</div><div class="bq-size">'+n+'</div><div class="bq-status">'+a+'</div><div class="bq-actions">'+o+"</div></div>"}function Il(e){const n=M.queue.find(a=>a.id===e);n&&(n.status="pending",n.error_code=null,n.progress=0,Ie(),$a())}function Bl(e){const n=M.queue.findIndex(o=>o.id===e);if(n<0)return;const a=M.queue[n];a.status==="uploading"||a.status==="parsing"||(M.queue.splice(n,1),Ie())}function Cl(){M.queue=M.queue.filter(e=>e.status!=="ok"),Ie()}async function $a(){for(;;){if(M.queue.filter(a=>a.status==="uploading"||a.status==="parsing").length>=kl)return;const n=M.queue.find(a=>a.status==="pending");if(!n){M.queue.every(a=>a.status==="ok"||a.status==="failed")&&(await At(),typeof window.loadReconcilePage=="function"&&window.loadReconcilePage());return}Sl(n).then(()=>$a())}}async function Sl(e){e.status="uploading",e.progress=0,Ie();try{const n=new FormData;n.append("file",e.file,e.name);const a=await new Promise((s,i)=>{const r=new XMLHttpRequest;r.open("POST","/api/bank-recon/upload"),r.setRequestHeader("Authorization","Bearer "+token),r.upload.onprogress=c=>{c.lengthComputable&&(e.progress=Math.min(99,Math.round(c.loaded/c.total*100)),Ie())},r.upload.onload=()=>{e.status="parsing",Ie()},r.onload=()=>{r.status>=200&&r.status<300?s({status:r.status,text:r.responseText}):s({status:r.status,text:r.responseText})},r.onerror=()=>i(new Error("network")),r.send(n)});let o={};try{o=JSON.parse(a.text||"{}")}catch{o={}}if(a.status>=400){e.status="failed",e.error_code=o&&o.detail||"unknown",Ie();return}if(o.parse_status==="parse_failed"){e.status="failed",e.error_code=o.error==="scanned_pdf_not_yet"?"bank_recon.scanned":"bank_recon.no_tx",Ie();return}e.status="ok",e.tx_count=o.tx_count||0,e.session_id=o.session_id||null,Ie()}catch(n){console.warn("[bank-recon] upload failed",n),e.status="failed",e.error_code="network",Ie()}}async function Cs(){if(M.loaded){uo();return}M.loaded=!0,Tl(),await At(),uo()}function Tl(){const e=document.getElementById("bank-file-input");e&&!e._bound&&(e._bound=!0,e.addEventListener("change",_l));const n=document.getElementById("btn-bank-queue-clear-done");n&&!n._bound&&(n._bound=!0,n.addEventListener("click",Cl));const a=document.getElementById("btn-bank-back");a&&!a._bound&&(a._bound=!0,a.addEventListener("click",()=>{M.currentSession=null,M.currentTxs=[],Ma()}));const o=document.getElementById("btn-bank-delete");o&&!o._bound&&(o._bound=!0,o.addEventListener("click",fl));const s=document.getElementById("btn-bank-run-match");s&&!s._bound&&(s._bound=!0,s.addEventListener("click",ul)),document.querySelectorAll(".bank-filter-btn").forEach(u=>{u._bound||(u._bound=!0,u.addEventListener("click",()=>{M.currentFilter=u.dataset.bankFilter||"all",document.querySelectorAll(".bank-filter-btn").forEach(l=>{l.classList.toggle("active",l===u)}),Sa()}))}),document.querySelectorAll("[data-bank-cand-close]").forEach(u=>{u._bound||(u._bound=!0,u.addEventListener("click",Zt))});const i=document.getElementById("btn-bank-cand-pane-close");i&&!i._bound&&(i._bound=!0,i.addEventListener("click",Zt));const r=document.getElementById("btn-bank-cand-ignore");r&&!r._bound&&(r._bound=!0,r.addEventListener("click",po));const c=document.getElementById("btn-bank-cand-ignore-pane");c&&!c._bound&&(c._bound=!0,c.addEventListener("click",po));const m=document.getElementById("bank-client-badge");m&&!m._bound&&(m._bound=!0,m.addEventListener("click",hl)),document.querySelectorAll("[data-bank-client-picker-close]").forEach(u=>{u._bound||(u._bound=!0,u.addEventListener("click",Ls))});const d=document.getElementById("btn-bank-client-picker-save");d&&!d._bound&&(d._bound=!0,d.addEventListener("click",gl)),document.querySelectorAll(".bank-sessions-chip").forEach(u=>{u._bound||(u._bound=!0,u.addEventListener("click",()=>{M.sessionFilter=u.dataset.sessFilter||"all",document.querySelectorAll(".bank-sessions-chip").forEach(l=>{l.classList.toggle("active",l===u)}),kn()}))})}window._deleteBankSession=Bs;window._loadBankReconPanel=Cs;window._rerenderBankRecon=function(){if(currentRoute==="automation"){if(kn(),M.currentSession&&(Es(),Sa(),Ta(),!M.currentTxForDrawer)){const e=document.getElementById("bank-cand-pane-title"),n=document.getElementById("bank-cand-pane-sub");e&&(e.textContent=t("bank-cand-pane-empty-title")),n&&(n.textContent=t("bank-cand-pane-empty-sub"))}Ie()}};typeof window.subscribeI18n=="function"&&window.subscribeI18n("bank-recon",window._rerenderBankRecon);window._openBankSession=async function(e){e&&(M.loaded||await Cs(),await Ht(e))};(function(){const e=document.getElementById("page-clients");if(!(!e||e.dataset.wbInjected==="1")){e.innerHTML=`
        <div class="page-head">
            <div class="page-head-icon">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
...
`,e.dataset.wbInjected="1";try{const n=window._currentLang||localStorage.getItem("mrpilot_lang")||"th",a=window.I18N;a&&a[n]&&(e.querySelectorAll("[data-i18n]").forEach(o=>{const s=o.getAttribute("data-i18n");a[n][s]&&(o.textContent=a[n][s])}),e.querySelectorAll("[data-i18n-placeholder]").forEach(o=>{const s=o.getAttribute("data-i18n-placeholder");a[n][s]&&(o.placeholder=a[n][s])}))}catch{}}})();const Ml=`
    ...
    `;be("client-modal-mask",Ml);be("wsclient-modal-mask",$l);const O={clients:[],editingClientId:null,historyClientFilter:"",custTab:"seller",sellerClients:[],editingWsClientId:null,catCache:{fetched:0,items:[],supplier_count:0}},ve={page:0,pageSize:12,keyword:""},qe=new Set,xn={keyword:""};function Hl(){return{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||"")}}async function Ae(e,n={}){const a=await fetch(e,{...n,headers:{"Content-Type":"application/json",...Hl(),...n.headers||{}}});if(!a.ok){const o=await a.json().catch(()=>({}));throw new Error(o.detail||"HTTP "+a.status)}return a.json()}function Al(){const e=document.querySelector("#client-color-picker .color-swatch.active");return e?e.dataset.color:"#111111"}function fo(e){const n=document.getElementById("drawer-cat-learned-tag");n&&e>0&&(n.textContent=(t("drawer-suggest-learned-with-count")||"已学 {n}").replace("{n}",String(e)))}async function jt(){try{const e=await Ae("/api/clients");O.clients=e.clients||[],window._clientsCache=O.clients}catch(e){console.error("loadClientsCache fail",e),O.clients=[]}try{typeof window._refreshExcClientFilter=="function"&&window._refreshExcClientFilter()}catch{}try{typeof window._refreshClientSwitcher=="function"&&window._refreshClientSwitcher()}catch{}return O.clients}function jl(){const e=ve.keyword.trim().toLowerCase();return e?O.clients.filter(n=>(n.name||"").toLowerCase().includes(e)||(n.short_name||"").toLowerCase().includes(e)||(n.tax_id||"").toLowerCase().includes(e)):O.clients}function Ha(){const e=jl(),n=ve.pageSize,a=Math.max(0,Math.ceil(e.length/n)-1);ve.page>a&&(ve.page=a);const o=ve.page*n;return{all:e,items:e.slice(o,o+n),start:o,ps:n,total:e.length,maxPage:a}}function De(){const e=document.getElementById("buyer-tbody");if(!e)return;const{items:n,start:a,ps:o,total:s,maxPage:i}=Ha();s?e.innerHTML=n.map(d=>{const u=qe.has(d.id);return`<div class="cust-row buyer-grid${u?" selected":""}" data-cid="${d.id}">
            ...
            </div>`}).join(""):e.innerHTML=`<div class="cust-empty">${escapeHtml(t(ve.keyword?"cust-no-match":"clients-empty"))}</div>`;const r=document.getElementById("buyer-pager-info");r&&(r.textContent=s?`${a+1}–${Math.min(a+o,s)} / ${s}`:"0");const c=document.getElementById("buyer-prev");c&&(c.disabled=ve.page<=0);const m=document.getElementById("buyer-next");m&&(m.disabled=ve.page>=i),Ss()}function Ss(){const e=qe.size,n=document.getElementById("buyer-batch-bar");n&&(n.style.display=e?"flex":"none");const a=document.getElementById("buyer-batch-count");a&&(a.textContent=t("cust-selected-n").replace("{n}",e));const o=document.getElementById("buyer-check-all");if(o){const{items:s}=Ha(),i=s.map(c=>c.id),r=i.filter(c=>qe.has(c)).length;o.checked=i.length>0&&r===i.length,o.indeterminate=r>0&&r<i.length}}function Pl(){qe.clear(),De()}async function Dl(){const e=Array.from(qe);if(!(!e.length||!await showConfirm(t("cust-batch-del-confirm").replace("{n}",e.length),{danger:!0})))try{await Ae("/api/clients/batch-delete",{method:"POST",body:JSON.stringify({ids:e})}),showToast(t("client-msg-deleted"),"success"),qe.clear(),await jt(),De(),An(),Aa()}catch{showToast(t("client-msg-save-fail"),"fail")}}function Ut(e){O.editingClientId=e?e.id:null;const n=!!e;document.getElementById("client-modal-title").textContent=t(n?"client-modal-edit":"client-modal-new"),document.getElementById("client-input-name").value=e&&e.name||"",document.getElementById("client-input-short").value=e&&e.short_name||"",document.getElementById("client-input-tax").value=e&&e.tax_id||"",document.getElementById("client-input-address").value=e&&e.address||"",document.getElementById("client-input-contact").value=e&&e.contact_person||"",document.getElementById("client-input-phone").value=e&&e.contact_phone||"",document.getElementById("client-input-email").value=e&&e.contact_email||"",document.getElementById("client-input-notes").value=e&&e.notes||"";const a=e&&e.color||"#111111";document.querySelectorAll("#client-color-picker .color-swatch").forEach(o=>{o.classList.toggle("active",o.dataset.color===a)}),document.getElementById("client-modal-delete").style.display=n?"":"none",document.getElementById("client-modal-mask").style.display="flex",setTimeout(()=>document.getElementById("client-input-name").focus(),50)}function Gt(){document.getElementById("client-modal-mask").style.display="none",O.editingClientId=null}async function Rl(){const e=document.getElementById("client-input-name").value.trim();if(!e){showToast(t("client-msg-name-required"),"fail");return}const n={name:e,short_name:document.getElementById("client-input-short").value.trim()||null,tax_id:document.getElementById("client-input-tax").value.trim()||null,address:document.getElementById("client-input-address").value.trim()||null,contact_person:document.getElementById("client-input-contact").value.trim()||null,contact_phone:document.getElementById("client-input-phone").value.trim()||null,contact_email:document.getElementById("client-input-email").value.trim()||null,notes:document.getElementById("client-input-notes").value.trim()||null,color:Al()};try{O.editingClientId?(await Ae(`/api/clients/${O.editingClientId}`,{method:"PATCH",body:JSON.stringify(n)}),showToast(t("client-msg-updated"),"success")):(await Ae("/api/clients",{method:"POST",body:JSON.stringify(n)}),showToast(t("client-msg-created"),"success")),Gt(),await jt(),currentRoute==="clients"&&De(),An(),Aa()}catch(a){console.error("saveClient fail",a);const o=a&&a.message?a.message:t("client-msg-save-fail");showToast(t("client-msg-save-fail")+" · "+o,"fail")}}async function ql(){if(!O.editingClientId)return;const e=O.clients.find(o=>o.id===O.editingClientId);if(!e)return;const n=t("client-delete-confirm").replace("{name}",e.name);if(await showConfirm(n,{danger:!0}))try{await Ae(`/api/clients/${O.editingClientId}`,{method:"DELETE"}),showToast(t("client-msg-deleted"),"success"),Gt(),await jt(),currentRoute==="clients"&&De(),An(),Aa()}catch(o){console.error(o),showToast(t("client-msg-save-fail"),"fail")}}async function Fl(e){const n=O.clients.find(a=>a.id===e);if(typeof window.openClientExportModal=="function"){window.openClientExportModal(e,n?n.name:"");return}try{const a=localStorage.getItem("mrpilot_token"),o=await fetch(`/api/clients/${e}/export?month=all`,{headers:{Authorization:"Bearer "+a}});if(!o.ok){let m="HTTP "+o.status;try{const d=await o.json();d&&d.detail&&(m=d.detail)}catch{}throw new Error(m)}const s=await o.blob();if(s.size<200){showToast(t("client-export-month-empty"),"info");return}const i=n&&n.name?n.name.replace(/[^a-zA-Z0-9\u0e00-\u0e7f\u4e00-\u9fff]/g,"_").slice(0,40):"client",r=URL.createObjectURL(s),c=document.createElement("a");c.href=r,c.download=`${i}_export.csv`,c.click(),URL.revokeObjectURL(r)}catch(a){console.error("exportClient fail",a),showToast(t("client-msg-save-fail")+" · "+(a.message||""),"fail")}}function An(){const e=document.getElementById("drawer-client-select");if(!e)return;const n=e.value;e.innerHTML=`<option value="">${escapeHtml(t("drawer-client-none"))}</option>`+O.clients.map(a=>`<option value="${a.id}">${escapeHtml(a.name)}</option>`).join(""),e.value=n||""}function Aa(){const e=document.getElementById("history-client-filter");if(!e)return;const n=e.value;e.innerHTML=`<option value="">${escapeHtml(t("history-client-all"))}</option>`+O.clients.map(a=>`<option value="${a.id}">${escapeHtml(a.name)}</option>`).join(""),e.value=n||""}function zl(e){O.custTab=e==="buyer"?"buyer":"seller",document.querySelectorAll("[data-cust-tab]").forEach(o=>o.classList.toggle("active",o.dataset.custTab===O.custTab));const n=document.getElementById("cust-pane-seller"),a=document.getElementById("cust-pane-buyer");n&&n.classList.toggle("active",O.custTab==="seller"),a&&a.classList.toggle("active",O.custTab==="buyer")}function Nl(){const e=window._userInfo||{},n=String(e.role||"").toLowerCase(),a=String(e.tenant_role||"").toLowerCase();return e.is_super_admin===!0||e.is_owner===!0||n==="owner"||n==="admin"||a==="owner"||a==="admin"}function Ts(){window._workspaceClientsCache=O.sellerClients,typeof window.renderWorkspaceControl=="function"&&window.renderWorkspaceControl()}async function ja(){try{const e=await Ae("/api/workspace/clients");O.sellerClients=e&&(e.clients||e.items)||[],window._workspaceClientsCache=O.sellerClients}catch(e){console.error("loadSellerCache fail",e),O.sellerClients=[]}return O.sellerClients}function Ol(){const e=xn.keyword.trim().toLowerCase();return e?O.sellerClients.filter(n=>(n.name||"").toLowerCase().includes(e)||(n.tax_id||"").toLowerCase().includes(e)):O.sellerClients}function ft(){const e=document.getElementById("seller-tbody");if(!e)return;const n=Nl(),a=document.getElementById("btn-seller-new");a&&(a.style.display=n?"":"none");const o=Ol(),s=typeof window.getActiveWorkspaceClientId=="function"?window.getActiveWorkspaceClientId():null;if(!o.length){e.innerHTML=`<div class="cust-empty">${escapeHtml(t(xn.keyword?"cust-no-match":"seller-empty"))}</div>`;return}e.innerHTML=o.map(i=>{const c=s!=null&&Number(s)===Number(i.id)?`<span class="cust-badge-current"><svg viewBox="0 0 14 14" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M2 7.5l3.2 3.2L12 4"/></svg>${escapeHtml(t("seller-current"))}</span>`:`<button class="cust-row-btn primary" data-saction="activate" data-wid="${i.id}">${escapeHtml(t("seller-set-current"))}</button>`,m=n?`
        ...
        </div>`}).join("")}function mo(e){O.editingWsClientId=e?e.id:null,document.getElementById("wsclient-modal-title").textContent=t(e?"wsclient-modal-edit":"wsclient-modal-new"),document.getElementById("wsclient-input-name").value=e&&e.name||"",document.getElementById("wsclient-input-tax").value=e&&e.tax_id||"",document.getElementById("wsclient-modal-archive").style.display=e?"":"none",document.getElementById("wsclient-modal-mask").style.display="flex",setTimeout(()=>document.getElementById("wsclient-input-name").focus(),50)}function Kt(){document.getElementById("wsclient-modal-mask").style.display="none",O.editingWsClientId=null}async function Vl(){const e=document.getElementById("wsclient-input-name").value.trim(),n=document.getElementById("wsclient-input-tax").value.trim();if(!e){showToast(t("client-msg-name-required"),"fail");return}try{O.editingWsClientId?(await Ae("/api/workspace/clients/"+O.editingWsClientId,{method:"PATCH",body:JSON.stringify({name:e,tax_id:n})}),showToast(t("client-msg-updated"),"success")):(await Ae("/api/workspace/clients",{method:"POST",body:JSON.stringify({name:e,tax_id:n||null})}),showToast(t("client-msg-created"),"success")),Kt(),await ja(),ft(),Ts()}catch(a){const o=a&&a.message?a.message:t("client-msg-save-fail");showToast(t("client-msg-save-fail")+" · "+o,"fail")}}async function vo(){if(!O.editingWsClientId)return;const e=O.sellerClients.find(a=>Number(a.id)===Number(O.editingWsClientId));if(await showConfirm(t("wsclient-archive-confirm").replace("{name}",e?e.name:""),{danger:!0}))try{const a=O.editingWsClientId;await Ae("/api/workspace/clients/"+a,{method:"DELETE"}),showToast(t("wsclient-archived"),"success"),typeof window.getActiveWorkspaceClientId=="function"&&Number(window.getActiveWorkspaceClientId())===Number(a)&&typeof window.enterPersonalMode=="function"&&window.enterPersonalMode(),Kt(),await ja(),ft(),Ts()}catch{showToast(t("client-msg-save-fail"),"fail")}}window.loadClientsPage=async function(){const e=document.getElementById("seller-tbody");e&&(e.innerHTML=`<div class="cust-loading">${escapeHtml(t("clients-loading"))}</div>`);const n=document.getElementById("buyer-tbody");n&&(n.innerHTML=`<div class="cust-loading">${escapeHtml(t("clients-loading"))}</div>`),await Promise.all([ja(),jt()]),ft(),De()};window.addEventListener("pearnly:workspace-changed",function(){typeof currentRoute<"u"&&currentRoute==="clients"&&ft()});window.bindDrawerClient=function(e,n){const a=document.getElementById("drawer-client-select");if(!a)return;if(An(),a.value=n?String(n):"",!e){a.onchange=null;const s=document.getElementById("drawer-client-add");s&&(s.onclick=()=>Ut(null));return}a.onchange=async()=>{const s=a.value?parseInt(a.value,10):null;try{await Ae(`/api/history/${e}/assign_client`,{method:"POST",body:JSON.stringify({client_id:s})}),showToast(t("client-msg-updated"),"success");const i=_results[_drawerIdx];i&&(i.client_id=s),await jt()}catch(i){console.error(i),showToast(t("client-msg-save-fail"),"fail"),a.value=n?String(n):""}};const o=document.getElementById("drawer-client-add");o&&(o.onclick=()=>Ut(null))};window.fillCategoryDatalist=async function(){try{const e=document.getElementById("drawer-cat-datalist"),n=Date.now();if(n-O.catCache.fetched<300*1e3){e&&(e.innerHTML=O.catCache.items.map(o=>`<option value="${escapeHtml(o)}">`).join("")),fo(O.catCache.supplier_count);return}const a=await Ae("/api/categories",{method:"GET"});O.catCache.fetched=n,O.catCache.items=a&&a.categories||[],O.catCache.supplier_count=a&&a.supplier_count||0,e&&(e.innerHTML=O.catCache.items.map(o=>`<option value="${escapeHtml(o)}">`).join("")),fo(O.catCache.supplier_count)}catch(e){console.warn("fillCategoryDatalist failed",e)}};window.getHistoryClientFilter=function(){return O.historyClientFilter};document.addEventListener("DOMContentLoaded",()=>{const e=document.querySelector(".cust-tab-bar");e&&e.addEventListener("click",B=>{const C=B.target.closest("[data-cust-tab]");C&&zl(C.dataset.custTab)});const n=document.getElementById("btn-buyer-new");n&&n.addEventListener("click",()=>Ut(null));const a=document.getElementById("buyer-tbody");a&&a.addEventListener("click",B=>{const C=B.target.closest(".buyer-row-check");if(C){const j=parseInt(C.dataset.cid,10);C.checked?qe.add(j):qe.delete(j);const N=C.closest(".cust-row");N&&N.classList.toggle("selected",C.checked),Ss();return}const S=B.target.closest(".cust-row-btn");if(S){B.stopPropagation();const j=parseInt(S.dataset.cid,10);if(S.dataset.action==="edit"){const N=O.clients.find(Z=>Z.id===j);N&&Ut(N)}else S.dataset.action==="export"&&Fl(j);return}const $=B.target.closest(".cust-row");if($&&!B.target.closest(".cust-cell-check")){const j=O.clients.find(N=>N.id===parseInt($.dataset.cid,10));j&&Ut(j)}});const o=document.getElementById("buyer-check-all");o&&o.addEventListener("change",()=>{const{items:B}=Ha();B.forEach(C=>{o.checked?qe.add(C.id):qe.delete(C.id)}),De()});const s=document.getElementById("buyer-batch-cancel");s&&s.addEventListener("click",Pl);const i=document.getElementById("buyer-batch-delete");i&&i.addEventListener("click",Dl);const r=document.getElementById("buyer-prev");r&&r.addEventListener("click",()=>{ve.page>0&&(ve.page--,De())});const c=document.getElementById("buyer-next");c&&c.addEventListener("click",()=>{ve.page++,De()});const m=document.getElementById("buyer-search");if(m){let B;m.addEventListener("input",()=>{clearTimeout(B),B=setTimeout(()=>{ve.keyword=m.value,ve.page=0;const C=document.getElementById("buyer-search-clear");C&&(C.style.display=m.value?"":"none"),De()},200)})}const d=document.getElementById("buyer-search-clear");d&&d.addEventListener("click",()=>{const B=document.getElementById("buyer-search");B&&(B.value=""),ve.keyword="",ve.page=0,d.style.display="none",De()});const u=document.getElementById("btn-seller-new");u&&u.addEventListener("click",()=>mo(null));const l=document.getElementById("seller-tbody");l&&l.addEventListener("click",B=>{const C=B.target.closest("[data-saction]");if(!C)return;B.stopPropagation();const S=parseInt(C.dataset.wid,10),$=C.dataset.saction,j=O.sellerClients.find(N=>Number(N.id)===S);$==="activate"?(typeof window.setActiveWorkspaceClientId=="function"&&window.setActiveWorkspaceClientId(S),ft(),typeof window.renderWorkspaceControl=="function"&&window.renderWorkspaceControl(),showToast(t("seller-activated").replace("{name}",j?j.name:""),"success")):$==="edit"?j&&mo(j):$==="archive"&&(O.editingWsClientId=S,vo())});const p=document.getElementById("seller-search");if(p){let B;p.addEventListener("input",()=>{clearTimeout(B),B=setTimeout(()=>{xn.keyword=p.value;const C=document.getElementById("seller-search-clear");C&&(C.style.display=p.value?"":"none"),ft()},200)})}const f=document.getElementById("seller-search-clear");f&&f.addEventListener("click",()=>{const B=document.getElementById("seller-search");B&&(B.value=""),xn.keyword="",f.style.display="none",ft()});const v=document.getElementById("wsclient-modal-close");v&&v.addEventListener("click",Kt);const w=document.getElementById("wsclient-modal-cancel");w&&w.addEventListener("click",Kt);const b=document.getElementById("wsclient-modal-save");b&&b.addEventListener("click",Vl);const g=document.getElementById("wsclient-modal-archive");g&&g.addEventListener("click",vo);const h=document.getElementById("wsclient-modal-mask");h&&h.addEventListener("click",B=>{B.target===h&&Kt()});const _=document.getElementById("client-modal-close");_&&_.addEventListener("click",Gt);const y=document.getElementById("client-modal-cancel");y&&y.addEventListener("click",Gt);const k=document.getElementById("client-modal-save");k&&k.addEventListener("click",Rl);const x=document.getElementById("client-modal-delete");x&&x.addEventListener("click",ql);const E=document.getElementById("client-modal-mask");E&&E.addEventListener("click",B=>{B.target===E&&Gt()});const L=document.getElementById("client-color-picker");L&&L.addEventListener("click",B=>{const C=B.target.closest(".color-swatch");C&&(L.querySelectorAll(".color-swatch").forEach(S=>S.classList.remove("active")),C.classList.add("active"))});const I=document.getElementById("history-client-filter");I&&I.addEventListener("change",()=>{O.historyClientFilter=I.value,typeof renderHistoryList=="function"&&renderHistoryList()})});setTimeout(()=>jt(),1e3);(function(){const e=document.getElementById("page-exceptions");if(!(!e||e.dataset.wbInjected==="1")){e.innerHTML=`
        <div class="page-head">
            <div class="page-head-icon">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round">
...
`,e.dataset.wbInjected="1";try{const n=window._currentLang||localStorage.getItem("mrpilot_lang")||"th",a=window.I18N;a&&a[n]&&(e.querySelectorAll("[data-i18n]").forEach(o=>{const s=o.getAttribute("data-i18n");a[n][s]&&(o.textContent=a[n][s])}),e.querySelectorAll("[data-i18n-placeholder]").forEach(o=>{const s=o.getAttribute("data-i18n-placeholder");a[n][s]&&(o.placeholder=a[n][s])}))}catch{}}})();const R={statsCache:null,listCache:[],currentRule:null,currentClient:"",currentStatus:"pending",loading:!1,selectedIds:new Set,offset:0,pageSize:50,total:0,loadFailed:!1,listScrollY:0},D={openExcId:null,excRow:null,history:null,loading:!1,pdfUrl:null,pdfStatus:"idle",editing:!1,editFields:null},_t={batchLoading:!1};function et(e,n){let a=t(e)||e;if(n)for(const o in n)a=a.replace(new RegExp("\\{"+o+"\\}","g"),String(n[o]));return a}function Ul(e){return e==="high"?`<svg viewBox="0 0 14 14" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
    ...
    </svg>`}function Gl(){return`<svg class="exc-empty-icon" viewBox="0 0 40 40" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
        <path d="M11 19l5 5 13-13"/>
        <circle cx="20" cy="20" r="17"/>
    </svg>`}function Kl(e){if(e==null)return"—";const n=parseFloat(String(e));return isNaN(n)?"—":"฿ "+n.toLocaleString(void 0,{minimumFractionDigits:2,maximumFractionDigits:2})}function Wl(e){return e?e.slice(0,10):"—"}function Ve(e){if(e==null)return"—";const n=typeof e=="number"?e:parseFloat(String(e).replace(/,/g,""));return isNaN(n)?escapeHtml(String(e)):"฿ "+n.toLocaleString(void 0,{minimumFractionDigits:2,maximumFractionDigits:2})}const Yl={"R-VAT-01":"risk.vat_mismatch","R-VAT-02":"risk.total_mismatch","R-SUM-01":"risk.line_sum_mismatch","R-LINE-01":"risk.line_amount_mismatch","R-MULTIPAGE-01":"risk.multipage_mismatch","R-TAXID-01":"risk.seller_tax_id_invalid","R-TAXID-02":"risk.buyer_tax_id_invalid","R-TAXID-03":"risk.tax_id_placeholder","R-DUP-01":"risk.duplicate_exact","R-DUP-02":"risk.duplicate_suspected","R-DATE-01":"risk.invoice_date_unparseable","R-DATE-02":"risk.invoice_date_out_of_period","R-SUP-01":"risk.supplier_not_allowlisted","R-SUP-02":"risk.supplier_force_review","R-LIMIT-01":"risk.amount_over_limit","R-CAT-01":"risk.category_no_auto_push"};function Gn(e,n){const a=t(e);return a&&a!==e?a:n}function Pa(e){const n=e.rule_code||"",a=e.detail&&e.detail.message_key;if(a){const i=Gn(a,"");if(i)return i}const o=Gn("exc-rule-"+n,"");if(o)return o;const s=Yl[n];if(s){const i=Gn(s,"");if(i)return i}return n}const Jl=[{labelKey:"exc-grp-arithmetic",codes:["R-VAT-01","R-VAT-02","R-SUM-01","R-LINE-01","R-MULTIPAGE-01","math_mismatch"]},{labelKey:"exc-grp-taxid",codes:["R-TAXID-01","R-TAXID-02","R-TAXID-03","tax_id_format_invalid"]},{labelKey:"exc-grp-dup",codes:["R-DUP-01","R-DUP-02","duplicate"]},{labelKey:"exc-grp-date",codes:["R-DATE-01","R-DATE-02"]},{labelKey:"exc-grp-customer",codes:["R-SUP-01","R-SUP-02","R-LIMIT-01","R-CAT-01"]},{labelKey:"exc-grp-fields",codes:["amount_missing"]},{labelKey:"exc-chip-confidence_low",codes:["confidence_low"]}];function Xl(e){if(!e)return"—";try{const n=new Date(e),a=o=>String(o).padStart(2,"0");return`${n.getFullYear()}-${a(n.getMonth()+1)}-${a(n.getDate())} ${a(n.getHours())}:${a(n.getMinutes())}`}catch{return e.slice(0,16).replace("T"," ")}}function ee(e,n,a){return`<div class="exc-why-detail-row"><b>${escapeHtml(t(e))}</b><span class="${a||""}">${escapeHtml(n)}</span></div>`}function Zl(e,n){const a=s=>Ve(n[s]),o=s=>n[s]===null||n[s]===void 0?"—":String(n[s]);switch(e){case"risk.vat_mismatch":return ee("exc-fld-subtotal",a("net_amount"))+ee("exc-fld-vat",a("vat_amount"),"v-bad")+ee("exc-detail-expected",a("expected_vat"),"v-good");case"risk.total_mismatch":{const s=Number(n.net_amount)||0,i=Number(n.vat_amount)||0;return ee("exc-fld-subtotal",a("net_amount"))+ee("exc-fld-vat",a("vat_amount"))+ee("exc-fld-total",a("total_amount"),"v-bad")+ee("exc-detail-expected",Ve(s+i),"v-good")}case"risk.line_sum_mismatch":return ee("exc-ev-lines-sum",a("lines_sum"),"v-bad")+ee("exc-fld-subtotal",a("net_amount"),"v-good");case"risk.line_amount_mismatch":{const s=Number(n.qty)||0,i=Number(n.unit_price)||0;return ee("exc-ev-amount",a("amount"),"v-bad")+ee("exc-detail-expected",Ve(s*i),"v-good")}case"risk.multipage_mismatch":return ee("exc-ev-pages",o("pages"));case"risk.seller_tax_id_invalid":return ee("exc-fld-seller-tax",o("seller_tax_id"),"v-bad");case"risk.buyer_tax_id_invalid":return ee("exc-fld-buyer-tax",o("buyer_tax_id"),"v-bad");case"risk.tax_id_placeholder":return ee("exc-ev-value",o("value"),"v-bad");case"risk.invoice_date_unparseable":case"risk.invoice_date_future":return ee("exc-fld-date",o("invoice_date"),"v-bad");case"risk.invoice_date_out_of_period":return ee("exc-fld-date",o("invoice_date"),"v-bad")+ee("exc-ev-period-start",o("period_start"))+ee("exc-ev-period-end",o("period_end"));case"risk.duplicate_exact":return(n.invoice_no?ee("exc-fld-invoice-no",o("invoice_no")):"")+ee("exc-fld-seller-tax",o("seller_tax_id"));case"risk.duplicate_suspected":{const s=Array.isArray(n.candidate_history_ids)?n.candidate_history_ids.length:0;return ee("exc-ev-dup-count",String(s))}case"risk.supplier_not_allowlisted":return ee("exc-fld-seller",o("seller_name"))+ee("exc-fld-seller-tax",o("seller_tax_id"));case"risk.supplier_force_review":return ee("exc-ev-reason",o("reason"),"v-bad")+ee("exc-fld-seller-tax",o("seller_tax_id"));case"risk.amount_over_limit":return ee("exc-ev-amount",a("value"),"v-bad")+ee("exc-ev-limit",a("limit"),"v-good");case"risk.category_no_auto_push":return ee("exc-ev-category",o("category"));default:return`<div class="exc-why-detail-row"><span style="font-size:11px;">${escapeHtml(JSON.stringify(n))}</span></div>`}}function Ql(e,n){if(n=n||{},n.message_key)return Zl(n.message_key,n.evidence||{});if(e==="math_mismatch")return`
            <div class="exc-why-detail-row"><b>${escapeHtml(t("exc-fld-subtotal"))}</b><span>${escapeHtml(Ve(n.subtotal))}</span></div>
            <div class="exc-why-detail-row"><b>${escapeHtml(t("exc-fld-vat"))}</b><span>${escapeHtml(Ve(n.vat))}</span></div>
            <div class="exc-why-detail-row"><b>${escapeHtml(t("exc-detail-expected"))}</b><span class="v-good">${escapeHtml(Ve(n.total_expected))}</span></div>
            <div class="exc-why-detail-row"><b>${escapeHtml(t("exc-detail-actual"))}</b><span class="v-bad">${escapeHtml(Ve(n.total_actual))}</span></div>
            <div class="exc-why-detail-row"><b>${escapeHtml(t("exc-detail-diff"))}</b><span class="v-bad">${escapeHtml(Ve(n.diff))}</span></div>
        ...
        `:e==="amount_missing"?`<div class="exc-why-detail-row" style="justify-content:center;color:var(--danger);"><span>${escapeHtml(t("exc-detail-missing"))}</span></div>`:`<div class="exc-why-detail-row"><span style="font-size:11px;">${escapeHtml(JSON.stringify(n))}</span></div>`}function Ge(){const e=D.excRow;if(!e)return;const n=e.seller_name&&e.seller_name.trim()?e.seller_name:t("exc-no-seller"),a=e.filename||"—";document.getElementById("exc-drawer-title").textContent=a;const o="exc-status-"+(e.status||"pending"),s=t(o)||e.status,i="s-"+(e.status||"pending"),r=(e.invoice_date||e.created_at||"").slice(0,10);document.getElementById("exc-drawer-sub").innerHTML=`
        <span>${escapeHtml(n)}</span>
        ${e.invoice_no?`<span>· ${escapeHtml(e.invoice_no)}</span>`:""}
        ${r?`<span>· ${escapeHtml(r)}</span>`:""}
        <span class="exc-status-chip ${i}">${escapeHtml(s)}</span>
    `;const c=e.severity||"medium",m=Pa(e),d=Ql(e.rule_code,e.detail||{}),u=ho(D.history),l=D.history===null,p=D.history&&D.history._err,f=new Set,v=e.rule_code||"";["math_mismatch","R-VAT-01","R-VAT-02","R-SUM-01","R-LINE-01"].includes(v)?(f.add("subtotal"),f.add("vat"),f.add("total_amount")):v==="R-MULTIPAGE-01"||v==="R-LIMIT-01"?f.add("total_amount"):v==="tax_id_format_invalid"||v==="R-TAXID-01"?f.add("seller_tax"):v==="R-TAXID-02"?f.add("buyer_tax"):v==="R-TAXID-03"?(f.add("seller_tax"),f.add("buyer_tax")):v==="R-DATE-01"||v==="R-DATE-02"?f.add("date"):v==="R-DUP-01"||v==="R-DUP-02"?f.add("invoice_number"):v==="R-SUP-01"||v==="R-SUP-02"?(f.add("seller_name"),f.add("seller_tax")):v==="amount_missing"&&(f.add("total_amount"),f.add("invoice_number"));const w=!!D.editing,b=D.editFields||{},g=($,j,N)=>{if(l)return`<div class="exc-field-row"><label>${escapeHtml(t(j))}</label><span class="val empty">…</span></div>`;const Z=w?b[$]!==void 0?b[$]:u[$]!==void 0&&u[$]!==null?u[$]:"":u[$],ae=f.has($)?"flagged":"";if(w){const z=N?"number":"text",F=N?' step="0.01" inputmode="decimal"':"",U=Z==null?"":String(Z).replace(/"/g,"&quot;");return`<div class="exc-field-row ${ae} editing">
                <label>${escapeHtml(t(j))}</label>
                <input class="exc-field-input" type="${z}"${F} data-edit-key="${escapeHtml($)}" value="${U}">
            </div>`}const ue=N?Ve(Z):Z||"",oe=Z==null||Z===""?`<span class="val empty">${escapeHtml(t("exc-empty-val"))}</span>`:`<span class="val">${escapeHtml(ue)}</span>`;return`<div class="exc-field-row ${ae}"><label>${escapeHtml(t(j))}</label>${oe}</div>`};let h="";p?h=`<div class="exc-drawer-error">${escapeHtml(t("exc-drawer-error"))}</div>`:h=`
    ...
    `;const y=document.getElementById("exc-fld-edit");y&&y.addEventListener("click",()=>{D.editing=!0,D.editFields={...ho(D.history)},Ge()});const k=document.getElementById("exc-fld-cancel");k&&k.addEventListener("click",()=>{D.editing=!1,D.editFields=null,Ge()});const x=document.getElementById("exc-fld-save");x&&x.addEventListener("click",()=>nc()),document.querySelectorAll(".exc-field-input").forEach($=>{$.addEventListener("input",()=>{D.editFields||(D.editFields={}),D.editFields[$.dataset.editKey]=$.value})});const L=document.getElementById("exc-pdf-retry");L&&D.openExcId&&L.addEventListener("click",()=>{D.excRow&&Ms(D.excRow.history_id,D.openExcId)});const I=e.status==="pending",B=!!(e.seller_name&&e.seller_name.trim()),C=document.getElementById("exc-btn-resolve"),S=document.getElementById("exc-btn-ignore");C.disabled=!I,S.disabled=!I||!B,S.title=B?t("exc-ignore-hint"):t("exc-ignore-no-seller")}function Da(){if(D.pdfUrl){try{URL.revokeObjectURL(D.pdfUrl)}catch{}D.pdfUrl=null}D.pdfStatus="idle"}async function Ms(e,n){D.pdfStatus="loading",Ge();try{const a=await fetch("/api/history/"+encodeURIComponent(e)+"/pdf",{headers:{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||"")}});if(D.openExcId!==n)return;if(a.status===404){D.pdfStatus="empty",Ge();return}if(!a.ok)throw new Error("http "+a.status);const o=await a.blob();if(D.openExcId!==n)return;Da(),D.pdfUrl=URL.createObjectURL(o),D.pdfStatus="ready",Ge()}catch(a){if(D.openExcId!==n)return;console.warn("loadDrawerPdf fail",a),D.pdfStatus="error",Ge()}}function ec(e){const n=(R.listCache||[]).find(a=>a.id===e);if(!n){showToast(t("exc-drawer-error"),"error");return}R.listScrollY=window.scrollY||document.documentElement.scrollTop||0,Da(),D.editing=!1,D.editFields=null,D.openExcId=e,D.excRow=n,D.history=null,document.getElementById("exc-drawer-mask").classList.add("show"),document.getElementById("exc-drawer").classList.add("show"),Ge(),tc(n.history_id),Ms(n.history_id,e)}function Tt(){Da(),D.editing=!1,D.editFields=null,D.openExcId=null,D.excRow=null,D.history=null,document.getElementById("exc-drawer-mask").classList.remove("show"),document.getElementById("exc-drawer").classList.remove("show");const e=R.listScrollY||0;e>0&&requestAnimationFrame(()=>window.scrollTo(0,e))}async function tc(e){try{const n=await fetch("/api/history/"+encodeURIComponent(e),{headers:{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||"")}});if(!n.ok)throw new Error("http "+n.status);D.history=await n.json()}catch(n){console.warn("loadHistoryDetail fail",n),D.history={_err:!0}}D.excRow&&Ge()}function ho(e){if(!e||!e.pages)return{};const n=e.pages,a=n.find(o=>!o.is_duplicate&&!o.is_copy)||n[0];return a&&a.fields||{}}async function nc(){if(!D.openExcId||!D.history||!D.history.pages||D.loading)return;D.loading=!0;const e=showToast(t("exc-fld-saving"),"loading",0);try{const n=JSON.parse(JSON.stringify(D.history.pages||[]));let a=n.findIndex(m=>!m.is_duplicate&&!m.is_copy);a<0&&(a=0),n[a]||(n[a]={fields:{}});const o=n[a].fields||{},s=D.editFields||{},i=new Set(["subtotal","vat","total_amount"]),r={...o};for(const m in s){let d=s[m];if((d===""||d===void 0)&&(d=null),i.has(m)&&d!==null){const u=parseFloat(d);d=isNaN(u)?null:u}r[m]=d}n[a].fields=r;const c=await fetch("/api/history/"+encodeURIComponent(D.history.id),{method:"PUT",headers:{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||""),"Content-Type":"application/json"},body:JSON.stringify({pages:n})});if(!c.ok)throw new Error("http "+c.status);e(),showToast(t("exc-fld-save-ok"),"success"),Tt(),await Pt(),await at(),Fe()}catch(n){e(),console.warn("save fields fail",n),showToast(t("exc-fld-save-fail"),"error")}finally{D.loading=!1}}async function ac(){if(!(!D.openExcId||D.loading)){D.loading=!0;try{const e=await fetch("/api/exceptions/"+D.openExcId+"/resolve",{method:"POST",headers:{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||"")}});if(!e.ok)throw new Error("http "+e.status);showToast(t("exc-toast-resolved"),"success"),Tt(),await Pt(),await at(),Fe()}catch(e){console.warn("resolve fail",e),showToast(t("exc-toast-action-fail"),"error")}finally{D.loading=!1}}}async function oc(){if(!(!D.openExcId||D.loading)){D.loading=!0;try{const e=await fetch("/api/exceptions/"+D.openExcId+"/ignore",{method:"POST",headers:{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||"")}});if(!e.ok)throw new Error("http "+e.status);showToast(t("exc-toast-ignored"),"success"),Tt(),await Pt(),await at(),Fe()}catch(e){console.warn("ignore fail",e),showToast(t("exc-toast-action-fail"),"error")}finally{D.loading=!1}}}async function Fe(){try{const e=R.currentClient||"",n="/api/exceptions/stats?status=pending"+(e?"&client_id="+encodeURIComponent(e):""),a=await fetch(n,{headers:{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||"")}});if(!a.ok)return;const o=await a.json(),s=document.getElementById("nav-exc-badge");if(!s)return;const i=parseInt(o.pending||0,10);i>0?(s.textContent=i>99?"99+":String(i),s.style.display=""):s.style.display="none"}catch{}}function $s(e){document.getElementById("exc-kpi-pending").textContent=e.pending||0,document.getElementById("exc-kpi-high").textContent=e.high_severity||0,document.getElementById("exc-kpi-resolved").textContent=e.resolved||0,document.getElementById("exc-kpi-learned").textContent=e.learned_rules||0;const n=document.getElementById("exc-status-tab-count-pending"),a=document.getElementById("exc-status-tab-count-resolved"),o=document.getElementById("exc-status-tab-count-ignored");n&&(n.textContent=e.pending||0),a&&(a.textContent=e.resolved||0),o&&(o.textContent=e.ignored||0),document.querySelectorAll("#exc-status-tabs .exc-status-tab").forEach(i=>{i.classList.toggle("active",i.dataset.status===(R.currentStatus||"pending"))})}function Hs(e,n){return n.split(",").reduce((a,o)=>a+(e[o]||0),0)}function Ra(e){const n=document.getElementById("exc-chips");if(!n)return;const a=e.by_rule||{};let s=`<button class="exc-chip ${!R.currentRule?"active":""}" data-rule="">
        <span>${escapeHtml(t("exc-chip-all"))}</span>
        <span class="exc-chip-count">${e.pending||0}</span>
    </button>`;for(const i of Jl){const r=i.codes.join(","),c=Hs(a,r),m=R.currentRule===r;c===0&&!m||(s+=`<button class="exc-chip ${m?"active":""}" data-rule="${escapeHtml(r)}">
            <span>${escapeHtml(t(i.labelKey))}</span>
            <span class="exc-chip-count">${c}</span>
        </button>`)}n.innerHTML=s,n.querySelectorAll(".exc-chip").forEach(i=>{i.addEventListener("click",()=>{const r=i.dataset.rule||null;R.currentRule=r,at()})})}function qa(e){const n=document.getElementById("exc-list");if(!n)return;if(!e||e.length===0){n.innerHTML=`<div class="exc-empty">
            ${Gl()}
            <div class="exc-empty-title">${escapeHtml(t("exc-empty-title"))}</div>
            <div>${escapeHtml(t("exc-empty-desc"))}</div>
        </div>`,bo();return}const a='<svg viewBox="0 0 14 14" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M3 7l3 3 5-5"/></svg>',o=(R.currentStatus||"pending")==="pending";n.innerHTML=e.map(s=>{const i=s.severity||"medium",r=Pa(s),c=s.seller_name&&s.seller_name.trim()?s.seller_name:t("exc-no-seller"),m=s.filename||"—",d=Wl(s.invoice_date||s.created_at),u=s.status==="pending",l=R.selectedIds.has(s.id),p=o&&u;return`
            <div class="exc-row sev-${escapeHtml(i)} ${l?"selected":""}" data-exc-id="${escapeHtml(String(s.id))}">
                ...
                <div class="exc-row-sev">${Ul(i)}</div>
                ...
                <div class="exc-row-amount">${escapeHtml(Kl(s.total_amount))}</div>
            </div>
        `}).join(""),n.querySelectorAll(".exc-row").forEach(s=>{s.addEventListener("click",i=>{if(i.target.closest(".exc-row-check"))return;const r=s.dataset.excId;r&&ec(parseInt(r,10))})}),n.querySelectorAll(".exc-row-check").forEach(s=>{s.addEventListener("click",i=>{i.stopPropagation();const r=parseInt(s.dataset.checkId,10);r&&(R.selectedIds.has(r)?(R.selectedIds.delete(r),s.classList.remove("checked"),s.closest(".exc-row").classList.remove("selected")):(R.selectedIds.add(r),s.classList.add("checked"),s.closest(".exc-row").classList.add("selected")),go())})}),go(),bo()}function go(){const e=document.getElementById("exc-batch-bar"),n=document.getElementById("exc-batch-count");if(!e||!n)return;const a=R.selectedIds.size;a===0?e.style.display="none":(e.style.display="",n.textContent=et("exc-batch-count",{n:a}))}function bo(){const e=document.getElementById("exc-list-foot"),n=document.getElementById("exc-list-count"),a=document.getElementById("exc-loadmore");if(!e||!n||!a)return;const o=R.listCache.length;if(o===0){e.style.display="none";return}e.style.display="";let s=o;const i=R.statsCache;i&&(R.currentRule?s=Hs(i.by_rule||{},R.currentRule)||o:s=i.pending||o),R.total=s,n.textContent=et("exc-list-count",{shown:o,total:s});const r=o<s&&o<500;a.style.display=r?"":"none"}async function Pt(){try{if(navigator.onLine===!1)throw new Error("offline");const e=R.currentClient||"",n=R.currentStatus||"pending",a=new URLSearchParams;a.set("status",n),e&&a.set("client_id",e);const o="/api/exceptions/stats?"+a.toString(),s=await fetch(o,{headers:{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||"")}});if(!s.ok)throw new Error("http "+s.status);const i=await s.json();return R.statsCache=i,$s(i),Ra(i),i}catch(e){return console.warn("loadExceptionsStats fail",e),null}}function sc(e){const n=document.getElementById("exc-list");if(!n)return;const a=`<svg class="exc-error-icon" viewBox="0 0 36 36" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round">
        <circle cx="18" cy="18" r="14"/>
        ...
        <div class="exc-error">
        ...
        </div>`;const i=document.getElementById("exc-retry-btn");i&&i.addEventListener("click",()=>window.loadExceptionsPage&&window.loadExceptionsPage())}async function at(e){e=e||{};const n=!!e.append,a=document.getElementById("exc-list");!n&&a&&R.listCache.length===0&&(a.innerHTML=`<div class="exc-loading">${escapeHtml(t("exc-loading"))}</div>`);const o=new URLSearchParams;o.set("status",R.currentStatus||"pending"),R.currentRule&&o.set("rule_code",R.currentRule),R.currentClient&&o.set("client_id",R.currentClient);const s=n?R.listCache.length:0;o.set("limit",String(R.pageSize)),o.set("offset",String(s));try{if(navigator.onLine===!1)throw new Error("offline");const i=await fetch("/api/exceptions/list?"+o.toString(),{headers:{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||"")}});if(!i.ok)throw new Error("http "+i.status);const c=(await i.json()).items||[];n?R.listCache=R.listCache.concat(c):(R.listCache=c,R.selectedIds.clear()),R.loadFailed=!1,qa(R.listCache),R.statsCache&&Ra(R.statsCache)}catch(i){console.warn("loadExceptionsList fail",i),R.loadFailed=!0;const r=navigator.onLine===!1||String(i.message||"").includes("offline");n?showToast(t("exc-toast-load-fail"),"error"):(sc(r),showToast(r?t("exc-offline"):t("exc-toast-load-fail"),"error"))}}async function ic(){if(!R.loading&&!(R.listCache.length>=500)){R.loading=!0;try{await at({append:!0})}finally{R.loading=!1}}}function Fa(){const e=document.getElementById("exc-client-filter");if(!e)return;const n=window._clientsCache||[],a=R.currentClient||"",o=typeof t=="function"?t("history-client-all"):"全部客户";e.innerHTML=`<option value="">${escapeHtml(o)}</option>`+n.map(s=>`<option value="${s.id}">${escapeHtml(s.name)}</option>`).join(""),e.value=a}async function rc(){if(_t.batchLoading)return;const e=Array.from(R.selectedIds);if(e.length===0||!await showConfirm(et("exc-batch-confirm-resolve",{n:e.length})))return;_t.batchLoading=!0;const a=showToast(et("exc-batch-count",{n:e.length})+" …","loading",0);try{const o=await fetch("/api/exceptions/batch",{method:"POST",headers:{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||""),"Content-Type":"application/json"},body:JSON.stringify({ids:e,action:"resolve"})});if(!o.ok)throw new Error("http "+o.status);const s=await o.json();a(),showToast(et("exc-toast-batch-resolved",{n:s.processed||0}),"success"),R.selectedIds.clear(),await Pt(),await at(),Fe()}catch(o){a(),console.warn("batch resolve fail",o),showToast(t("exc-toast-batch-fail"),"error")}finally{_t.batchLoading=!1}}async function lc(){if(_t.batchLoading)return;const e=Array.from(R.selectedIds);if(e.length===0||!await showConfirm(et("exc-batch-confirm-ignore",{n:e.length}),{danger:!1}))return;_t.batchLoading=!0;const a=showToast(et("exc-batch-count",{n:e.length})+" …","loading",0);try{const o=await fetch("/api/exceptions/batch",{method:"POST",headers:{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||""),"Content-Type":"application/json"},body:JSON.stringify({ids:e,action:"ignore"})});if(!o.ok)throw new Error("http "+o.status);const s=await o.json();a(),showToast(et("exc-toast-batch-ignored",{n:s.processed||0,wl:s.whitelist_added||0}),"success"),R.selectedIds.clear(),await Pt(),await at(),Fe()}catch(o){a(),console.warn("batch ignore fail",o),showToast(t("exc-toast-batch-fail"),"error")}finally{_t.batchLoading=!1}}function cc(){R.selectedIds.clear(),qa(R.listCache)}async function As(){const e=document.getElementById("learned-list");if(e){e.innerHTML=`<div class="learned-empty">${escapeHtml(t("set-learned-loading"))}</div>`;try{const n=await fetch("/api/exception-whitelist",{headers:{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||"")}});if(!n.ok)throw new Error("http "+n.status);const o=(await n.json()).items||[];if(o.length===0){e.innerHTML=`<div class="learned-empty">${escapeHtml(t("set-learned-empty"))}</div>`;return}const s=`<svg viewBox="0 0 14 14" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round">
            <path d="M3 4h8M5.5 4V2.5h3V4M4 4l0.6 8.5h4.8L10 4"/>
                ...
                <div class="learned-row" data-wl-id="${escapeHtml(String(i.id))}">
                    ...
                    <div class="learned-date">${escapeHtml(Xl(i.created_at))}</div>
                    <button class="learned-del-btn" data-del-wl="${escapeHtml(String(i.id))}" title="${escapeHtml(t("set-learned-del"))}" type="button">${s}</button>
                </div>
            `}).join("")}catch(n){console.warn("loadLearnedRules fail",n),e.innerHTML=`<div class="learned-empty">${escapeHtml(t("exc-toast-load-fail"))}</div>`}}}window.loadExceptionsPage=async function(){if(!R.loading){R.loading=!0;try{Fa(),await Pt(),await at()}finally{R.loading=!1}}};window.refreshExcBadge=Fe;window._refreshExcClientFilter=Fa;window._excState=R;window._rerenderExceptions=function(){try{Fa()}catch{}R.statsCache&&($s(R.statsCache),Ra(R.statsCache)),R.listCache&&R.listCache.length&&qa(R.listCache);try{window._erpExcState&&window._erpExcState.items&&window._erpExcState.items.length&&typeof window._rerenderErpExceptions=="function"&&window._rerenderErpExceptions()}catch{}D.openExcId&&Ge()};document.addEventListener("click",e=>{e.target.closest("#exc-drawer-close")&&Tt(),e.target.closest("#exc-drawer-mask")&&Tt(),e.target.closest("#exc-btn-resolve")&&ac(),e.target.closest("#exc-btn-ignore")&&oc(),e.target.closest("#exc-batch-resolve")&&rc(),e.target.closest("#exc-batch-ignore")&&lc(),e.target.closest("#exc-batch-clear")&&cc(),e.target.closest("#exc-loadmore")&&ic()});document.addEventListener("keydown",e=>{e.key==="Escape"&&D.openExcId&&Tt()});document.addEventListener("click",e=>{e.target.closest("#btn-exc-refresh")&&(typeof window.loadExceptionsPage=="function"&&window.loadExceptionsPage(),Fe())});document.addEventListener("change",e=>{if(!e.target.closest("#exc-client-filter"))return;const n=e.target;R.currentClient=n.value||"",R.currentRule=null,R.selectedIds.clear(),R.listCache=[],typeof window.loadExceptionsPage=="function"&&window.loadExceptionsPage(),Fe()});document.addEventListener("click",e=>{const n=e.target.closest("#exc-status-tabs .exc-status-tab");if(!n)return;const a=n.dataset.status||"pending";a!==R.currentStatus&&(R.currentStatus=a,R.currentRule=null,R.selectedIds.clear(),R.listCache=[],typeof window.loadExceptionsPage=="function"&&window.loadExceptionsPage())});window.addEventListener("online",()=>{R.loadFailed&&document.getElementById("page-exceptions")?.classList.contains("show")&&window.loadExceptionsPage&&window.loadExceptionsPage()});setTimeout(Fe,1500);setInterval(Fe,6e4);window.loadLearnedRules=As;document.addEventListener("click",async e=>{const n=e.target.closest("[data-del-wl]");if(!n)return;const a=parseInt(n.dataset.delWl,10);if(!a)return;const o=n.closest(".learned-row"),s=o&&o.querySelector(".learned-seller"),i=s?s.textContent.trim():"",r=t("set-learned-del-confirm").replace("{seller}",i);if(await showConfirm(r,{danger:!0}))try{const m=await fetch("/api/exception-whitelist/"+a,{method:"DELETE",headers:{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||"")}});if(!m.ok)throw new Error("http "+m.status);showToast(t("set-learned-del-ok"),"success"),As(),typeof window.loadExceptionsPage=="function"&&document.getElementById("page-exceptions")?.classList.contains("show")&&window.loadExceptionsPage()}catch(m){console.warn("delete whitelist fail",m),showToast(t("set-learned-del-fail"),"error")}});let ie={items:[],q:"",cat:"",adapter:"",selected:new Set,total:0,categories:{},pageSize:30,loading:!1,focusSearch:!1,searchCaret:0},yo=null;function Re(){return localStorage.getItem("mrpilot_token")||""}function wo(e){return/<!?\s*doctype|<html|<\/?[a-z]+>|\bTraceback\b|^\s*ERR_[A-Z]/i.test(e)||e.length>200}function js(e){const n=typeof currentLang=="string"&&currentLang||window._currentLang||"th",a=e.error_friendly&&e.error_friendly[n];if(a)return a;if(typeof humanizeError=="function"&&e.error_msg&&!wo(e.error_msg))try{const o=humanizeError(e.error_msg);if(o&&!wo(o))return o}catch{}return t("erp-exc-reason-"+(e.category||"other"))}function ko(){const e=document.getElementById("erp-exc-batch");if(!e)return;const n=ie.selected.size;e.hidden=n===0;const a=e.querySelector(".erp-exc-batch-count");a&&(a.textContent=String(n))}function za(){const e=document.getElementById("erp-exc-block");if(!e)return;const n=ie;if(!(n.total>0||!!n.q||!!n.cat)){e.hidden=!0,e.innerHTML="";return}e.hidden=!1;const o=n.categories||{},s=Object.keys(o).reduce((x,E)=>x+o[E],0);let i=`<button class="erp-exc-chip ${n.cat===""?"active":""}" data-erpexc-cat=""><span>${escapeHtml(t("erp-exc-cat-all"))}</span><span class="erp-exc-chip-count">${s}</span></button>`;Object.keys(o).forEach(x=>{i+=`<button class="erp-exc-chip ${n.cat===x?"active":""}" data-erpexc-cat="${escapeHtml(x)}"><span>${escapeHtml(t("erp-exc-cat-"+x))}</span><span class="erp-exc-chip-count">${o[x]}</span></button>`});const r=n.items||[],c=r.length>0&&r.every(x=>n.selected.has(x.id)),m=r.map(x=>{const E=x.state==="needs_action"?"needs":x.state==="retrying"?"retry":"fail",L=t("erp-exc-state-"+(x.state||"failed")),I=js(x),B=n.selected.has(x.id)?"checked":"",C=x.push_type==="id_card",S=C?`<span class="erp-exc-type-idcard">${escapeHtml(t("erp-log-type-idcard"))}</span> `:"",$=C?`<span class="ex-inv" title="${escapeHtml(t("erp-log-col-booking"))}">${S}${escapeHtml(x.invoice_no||"—")}</span>`:`<span class="ex-inv" title="${escapeHtml(x.invoice_no||"")}">${escapeHtml(x.invoice_no||"—")}</span>`,j=C?`<span class="ex-seller" title="${escapeHtml(t("erp-log-col-customer"))}">${escapeHtml(x.seller_name||"—")}</span>`:`<span class="ex-seller" title="${escapeHtml(x.seller_name||"")}">${escapeHtml(x.seller_name||"—")}</span>`,N=C?`<span class="ex-buyer" title="${escapeHtml(t("erp-log-col-idcard"))}">${x.id_card_tail?"••••"+escapeHtml(x.id_card_tail):"—"}</span>`:`<span class="ex-buyer" title="${escapeHtml(x.ocr_buyer_name||"")}">${escapeHtml(x.ocr_buyer_name||"—")}</span>`;return`<div class="erp-exc-row" data-erpexc-id="${escapeHtml(x.id)}">
        ...
        <div class="erp-exc-foot">${u}</div>`;const h=document.getElementById("erp-exc-search");if(h){if(n.focusSearch){h.focus();try{h.setSelectionRange(n.searchCaret,n.searchCaret)}catch{}}h.addEventListener("input",()=>{n.q=h.value,n.focusSearch=!0,n.searchCaret=h.selectionStart||h.value.length,clearTimeout(yo),yo=setTimeout(()=>ut(!1),350)}),h.addEventListener("blur",()=>{n.focusSearch=!1})}e.querySelectorAll(".erp-exc-chip").forEach(x=>{x.addEventListener("click",()=>{n.cat=x.dataset.erpexcCat||"",ut(!1)})});const _=document.getElementById("erp-exc-erp-select");_&&_.addEventListener("change",()=>{n.adapter=_.value||"",ut(!1)}),e.querySelectorAll("[data-erpexc-retry]").forEach(x=>{x.addEventListener("click",E=>{E.stopPropagation(),fn(x.dataset.erpexcRetry,x)})}),e.querySelectorAll(".erp-exc-cb").forEach(x=>{x.addEventListener("change",()=>{const E=x.dataset.erpexcCb;x.checked?n.selected.add(E):n.selected.delete(E);const L=document.getElementById("erp-exc-cb-all");L&&(L.checked=r.length>0&&r.every(I=>n.selected.has(I.id))),ko()})});const y=document.getElementById("erp-exc-cb-all");y&&y.addEventListener("change",()=>{r.forEach(x=>{y.checked?n.selected.add(x.id):n.selected.delete(x.id)}),e.querySelectorAll(".erp-exc-cb").forEach(x=>{x.checked=y.checked}),ko()}),e.querySelectorAll("[data-erpexc-batch]").forEach(x=>{x.addEventListener("click",()=>dc(x.dataset.erpexcBatch))});const k=document.getElementById("erp-exc-more");k&&k.addEventListener("click",()=>ut(!0)),e.querySelectorAll(".erp-exc-row:not(.erp-exc-row-head)").forEach(x=>{x.addEventListener("click",E=>{E.target.closest("input,button")||typeof window._erpExcOpenEdit=="function"&&window._erpExcOpenEdit(x.dataset.erpexcId)})})}async function fn(e,n){if(e){n&&(n.disabled=!0,n.textContent=t("erp-exc-retrying"));try{const a=await fetch("/api/erp/logs/"+encodeURIComponent(e)+"/retry",{method:"POST",headers:{Authorization:"Bearer "+Re()}}),o=await a.json().catch(()=>({}));showToast(a.ok&&o.ok?t("erp-exc-retry-ok"):t("erp-exc-retry-fail"),a.ok&&o.ok?"success":"error")}catch{showToast(t("erp-exc-retry-fail"),"error")}if(ie.selected.delete(e),ut(!1),typeof window.refreshExcBadge=="function")try{window.refreshExcBadge()}catch{}}}async function dc(e){const n=Array.from(ie.selected);if(e==="clear"){ie.selected.clear(),za();return}if(n.length!==0){if(e==="delete"){if(!await showConfirm(t("erp-exc-batch-delete-confirm",{n:n.length}),{danger:!0}))return;try{const o=await fetch("/api/erp/logs/batch-delete",{method:"POST",headers:{Authorization:"Bearer "+Re(),"Content-Type":"application/json"},body:JSON.stringify({log_ids:n.slice(0,200)})}),s=await o.json().catch(()=>({}));showToast(o.ok?t("erp-exc-batch-delete-ok",{n:s.deleted||0}):t("erp-exc-retry-fail"),o.ok?"success":"error")}catch{showToast(t("erp-exc-retry-fail"),"error")}}else if(e==="retry")try{const a=await fetch("/api/erp/logs/batch-retry",{method:"POST",headers:{Authorization:"Bearer "+Re(),"Content-Type":"application/json"},body:JSON.stringify({log_ids:n.slice(0,50)})}),o=await a.json().catch(()=>({}));showToast(a.ok?t("erp-exc-batch-retry-ok",{ok:o.succeeded||0,fail:(o.failed||0)+(o.skipped||0)}):t("erp-exc-retry-fail"),a.ok?"success":"error")}catch{showToast(t("erp-exc-retry-fail"),"error")}if(ie.selected.clear(),ut(!1),typeof window.refreshExcBadge=="function")try{window.refreshExcBadge()}catch{}}}async function ut(e){const n=document.getElementById("erp-exc-block");if(!(!n||ie.loading)){ie.loading=!0;try{if(!Array.isArray(window._erpEndpoints)||!window._erpEndpoints.length)try{const r=await fetch("/api/erp/endpoints",{headers:{Authorization:"Bearer "+Re()}});if(r.ok){const c=await r.json();window._erpEndpoints=c&&(c.items||c)||[]}}catch{}const a=new URLSearchParams;ie.q&&a.set("q",ie.q),ie.cat&&a.set("category",ie.cat),ie.adapter&&a.set("adapter",ie.adapter),a.set("limit",String(ie.pageSize)),a.set("offset",String(e?ie.items.length:0));const o=await fetch("/api/erp/exceptions?"+a.toString(),{headers:{Authorization:"Bearer "+Re()}});if(!o.ok){e||(n.hidden=!0);return}const s=await o.json(),i=s.items||[];ie.items=e?ie.items.concat(i):i,ie.total=s.total||0,ie.categories=s.categories||{},za()}catch{e||(n.hidden=!0)}finally{ie.loading=!1}}}window._rerenderErpExceptions=za;window.loadErpExceptions=ut;window._erpExcState=ie;let sn={};function ht(){const e=document.getElementById("erp-exc-modal");e&&e.remove()}window._erpExcOpenEdit=function(e){const n=(ie.items||[]).find(u=>String(u.id)===String(e));if(!n)return;const a=n.push_type==="id_card",o=!!n.history_client_id&&n.category==="customer_mismatch",s=n.category==="product_mismatch"&&!!n.history_id&&!!n.endpoint_id,i=js(n),r=n.state==="needs_action"?"needs":n.state==="retrying"?"retry":"fail",c=(u,l)=>`<div class="erp-exc-m-row"><span class="erp-exc-m-k">${escapeHtml(u)}</span><span class="erp-exc-m-v">${escapeHtml(l||"—")}</span></div>`;let m="";if(o)m=`
        ...
        </div>`,document.body.appendChild(d),d.addEventListener("click",u=>{u.target===d&&ht()}),document.getElementById("erp-exc-m-close").addEventListener("click",ht),document.getElementById("erp-exc-m-cancel").addEventListener("click",ht),document.getElementById("erp-exc-m-retry").addEventListener("click",()=>{ht(),fn(n.id,null)}),o){let u="";const l=document.getElementById("erp-exc-m-bind"),p=document.getElementById("erp-exc-m-custlist"),f=document.getElementById("erp-exc-m-search"),v=(b,g)=>{const h=(g||"").trim().toLowerCase(),_=h?b.filter(y=>(y.code||"").toLowerCase().includes(h)||(y.name||"").toLowerCase().includes(h)):b;if(_.length===0){p.innerHTML=`<div class="erp-exc-m-empty">${escapeHtml(t("erp-exc-edit-pick-empty"))}</div>`;return}p.innerHTML=_.slice(0,100).map(y=>`<div class="erp-exc-m-cust" data-cust-code="${escapeHtml(y.code||"")}">
                    <span class="erp-exc-m-cust-name">${escapeHtml(y.name||"")}</span>
                    <span class="erp-exc-m-cust-code">${escapeHtml(y.code||"")}</span>
                </div>`).join(""),p.querySelectorAll(".erp-exc-m-cust").forEach(y=>{y.addEventListener("click",()=>{u=y.dataset.custCode||"",p.querySelectorAll(".erp-exc-m-cust").forEach(k=>k.classList.remove("sel")),y.classList.add("sel"),l&&(l.disabled=!u)})})},w=async()=>{const b=n.endpoint_id;if(sn[b]){v(sn[b],"");return}try{const g=await fetch("/api/erp/endpoints/"+encodeURIComponent(b)+"/customers",{headers:{Authorization:"Bearer "+Re()}}),h=await g.json().catch(()=>({}));if(!g.ok||!h.ok){p.innerHTML=`<div class="erp-exc-m-empty">${escapeHtml(t("erp-exc-edit-pick-fail"))}</div>`;return}const _=h.customers||[];sn[b]=_,v(_,"")}catch{p.innerHTML=`<div class="erp-exc-m-empty">${escapeHtml(t("erp-exc-edit-pick-fail"))}</div>`}};f&&f.addEventListener("input",()=>v(sn[n.endpoint_id]||[],f.value)),w(),l&&l.addEventListener("click",async()=>{if(u){l.disabled=!0,l.textContent=t("erp-exc-retrying");try{if(!(await fetch("/api/erp/mappings/clients",{method:"POST",headers:{Authorization:"Bearer "+Re(),"Content-Type":"application/json"},body:JSON.stringify({client_id:n.history_client_id,erp_type:n.endpoint_adapter,erp_code:u})})).ok){showToast(t("erp-exc-retry-fail"),"error"),l.disabled=!1,l.textContent=t("erp-exc-edit-bind-retry");return}showToast(t("erp-exc-edit-bound-ok"),"success"),ht(),await fn(n.id,null)}catch{showToast(t("erp-exc-retry-fail"),"error"),l.disabled=!1,l.textContent=t("erp-exc-edit-bind-retry")}}})}if(s){const u=document.getElementById("erp-exc-m-bind-prod"),l=document.getElementById("erp-exc-m-prodlist"),p={};let f=[];const v=()=>'<option value="">'+escapeHtml(t("erp-exc-edit-prod-choose"))+"</option>"+f.slice(0,500).map(g=>`<option value="${escapeHtml(g.code||"")}" data-pname="${escapeHtml(g.name||"")}">`+escapeHtml((g.name||"")+" · "+(g.code||""))+"</option>").join(""),w=g=>{if(!g.length){l.innerHTML=`<div class="erp-exc-m-empty">${escapeHtml(t("erp-exc-edit-prod-noitems"))}</div>`;return}l.innerHTML=g.map(h=>`<div class="erp-exc-m-cust" style="cursor:default">
...
`;let _o=!1,jn=[],sa=null,$e="amount_limit",Na="global";const fc="/api/knowledge/rules";function mc(){return localStorage.getItem("mrpilot_token")||""}async function Mt(e,n,a){return fetch(fc+n,{method:e,headers:{Authorization:"Bearer "+mc(),"Content-Type":"application/json"},body:a?JSON.stringify(a):void 0})}function vc(e){const n=Number(e);return Number.isFinite(n)?"฿ "+n.toLocaleString("en-US"):String(e)}function hc(e){const n=ce(),a=o=>e===o?" selected":"";return`<option value="high"${a("high")}>${n.sevHigh}</option><option value="medium"${a("medium")}>${n.sevMid}</option><option value="low"${a("low")}>${n.sevLow}</option>`}function Eo(e,n){const a=n&&n.subject_key?escapeHtml(n.subject_key):"";return`<div class="rs-mlbl">${e}</div><input class="rs-field" id="rs-f-key" value="${a}"${n?" disabled":""}>`}function gc(e){const n=ce(),a=e.subject_key?escapeHtml(e.subject_key):"";if(e.rule_type==="amount_limit"){const o=vc(e.rule_body.limit);let s=n.gAmount;e.subject_type==="global"?s=n.anyInvoice:e.subject_type==="supplier"?s=`${n.fSupplierTax} <b>${a}</b>`:s=`「${a}」`;const i=e.rule_body.notify_line?` <span class="rs-line">${Xe("bell",12)} ${n.alsoLine}</span>`:"";return`${s} &gt; <b>${o}</b>${i}`}if(e.rule_type==="supplier_force_review")return`<b>${a}</b> · ${n.tForceDesc}`;if(e.rule_type==="no_auto_push_category")return`「${a}」 · ${n.tCategoryDesc}`;if(e.rule_type==="accounting_period"){const s=e.rule_body.mode==="prev_month"?n.pmPrev:n.pmCurrent;return`${n.gPeriodDesc} · <b>${s}</b>`}return e.rule_type}function bc(e){const n=ce(),a=e.severity||"medium",o=a==="high"?n.sevHigh:a==="low"?n.sevLow:n.sevMid;return`<div class="rs-rule"><div class="rs-rm"><div class="rs-rt">${gc(e)}</div></div><span class="rs-sev ${a}">${o}</span><button class="rs-sw${e.is_active?"":" off"}" data-toggle="${e.id}" aria-label="toggle"></button><button class="rs-icobtn" data-edit="${e.id}" aria-label="edit">${Xe("pencil",14)}</button><button class="rs-icobtn" data-del="${e.id}" aria-label="delete">${Xe("trash",14)}</button></div>`}function rn(e,n,a,o,s){const i=ce(),c=jn.filter(m=>s.includes(m.rule_type)).map(bc).join("")||`<div class="rs-empty">${i.empty}</div>`;return`<div class="rs-group"><div class="rs-ghead"><div class="rs-gico">${Xe(e,17)}</div><div><div class="rs-gt">${n}</div><div class="rs-gd">${a}</div></div><button class="rs-addbtn" data-add-type="${o}">${Xe("plus",14)} ${i.add}</button></div><div class="rs-gbody">${c}</div></div>`}function Ps(){const e=ce(),n=document.querySelector("#rules-settings-modal .rs-head h2");n&&(n.textContent=e.title);const a=document.getElementById("rs-body");a&&(a.innerHTML=`<p class="rs-lead">${e.lead}</p>`+rn("building",e.gSupplier,e.gSupplierDesc,"supplier_force_review",["supplier_force_review"])+rn("wallet",e.gAmount,e.gAmountDesc,"amount_limit",["amount_limit"])+rn("calendar",e.gPeriod,e.gPeriodDesc,"accounting_period",["accounting_period"])+rn("octagon",e.gCategory,e.gCategoryDesc,"no_auto_push_category",["no_auto_push_category"]))}async function Oa(){try{const e=await Mt("GET","?include_inactive=1");if(!e.ok)throw new Error("http "+e.status);jn=(await e.json()).rules||[],Ps()}catch{showToast(ce().loadFail,"error")}}function ia(e){const n=ce(),a=e?e.severity:$e==="supplier_force_review"?"high":"medium",o=`<div class="rs-mlbl">${n.fSeverity}</div><select class="rs-field" id="rs-f-sev">${hc(a)}</select>`;if($e==="amount_limit"){const i=e?e.subject_type:Na,r=e&&e.subject_key?escapeHtml(e.subject_key):"",c=e?String(e.rule_body.limit??""):"",m=e?!!e.rule_body.notify_line:!0,d=i==="global"?"":`<div class="rs-mlbl">${i==="category"?n.fCategory:n.fSupplierTax}</div><input class="rs-field" id="rs-f-key" value="${r}">`;return`<div class="rs-mlbl">${n.gAmountDesc}</div><select class="rs-field" id="rs-f-scope"${e?" disabled":""}><option value="global"${i==="global"?" selected":""}>${n.anyInvoice}</option><option value="supplier"${i==="supplier"?" selected":""}>${n.tForce}</option><option value="category"${i==="category"?" selected":""}>${n.fCategory}</option></select><div id="rs-f-subj">${d}</div><div class="rs-two"><div><div class="rs-mlbl">${n.fAmountLimit}</div><input class="rs-field" id="rs-f-limit" type="number" min="1" value="${c}"></div><div>${o}</div></div><label class="rs-check"><input type="checkbox" id="rs-f-line"${m?" checked":""}>${Xe("bell",14)} ${n.fAlsoLine}</label>`}if($e==="supplier_force_review")return Eo(n.fSupplierTax,e)+o;if($e==="no_auto_push_category")return Eo(n.fCategory,e)+o;const s=e?e.rule_body.mode:"current_month";return`<div class="rs-mlbl">${n.fPeriodMode}</div><select class="rs-field" id="rs-f-mode"><option value="current_month"${s==="current_month"?" selected":""}>${n.pmCurrent}</option><option value="prev_month"${s==="prev_month"?" selected":""}>${n.pmPrev}</option></select>`+o}function ln(e,n,a){return`<button class="rs-type${$e===e?" on":""}" data-type-pick="${e}"><div class="tt">${n}</div><div class="td">${a}</div></button>`}function yc(e){const n=ce(),a=document.getElementById("rs-add-modal");if(!a)return;const o=e?"":`<div class="rs-mlbl">${n.rType}</div><div class="rs-types">`+ln("supplier_force_review",n.tForce,n.tForceDesc)+ln("amount_limit",n.tAmount,n.tAmountDesc)+ln("accounting_period",n.tPeriod,n.tPeriodDesc)+ln("no_auto_push_category",n.tCategory,n.tCategoryDesc)+"</div>";a.innerHTML=`<div class="rs-pop" style="max-width:460px;"><div class="rs-head"><h2>${e?n.editTitle:n.addTitle}</h2><button class="rs-close" id="rs-add-close">${Xe("x",18)}</button></div><div class="rs-body">${o}<div id="rs-add-fields">${ia(e)}</div></div><div class="rs-foot" style="gap:10px;"><button class="rs-btn rs-btn-ghost" id="rs-add-cancel">${n.cancel}</button><button class="rs-btn rs-btn-primary" id="rs-add-save">${n.save}</button></div></div>`,a.classList.add("rs-open")}function it(e){const n=document.getElementById(e);return n?String(n.value).trim():""}function wc(){const e=ce(),n=it("rs-f-sev")||"medium";if($e==="amount_limit"){const a=it("rs-f-scope")||"global",o=Number(it("rs-f-limit"));if(!Number.isFinite(o)||o<=0)return showToast(e.needAmount,"error"),{ok:!1};const s=a==="global"?null:it("rs-f-key");if(a!=="global"&&!s)return showToast(a==="category"?e.needCategory:e.needSupplier,"error"),{ok:!1};const i=document.getElementById("rs-f-line")?.checked;return{ok:!0,payload:{rule_type:"amount_limit",subject_type:a,subject_key:s,severity:n,rule_body:{limit:o,basis:"total",period:"per_invoice",notify_line:!!i}}}}if($e==="supplier_force_review"){const a=it("rs-f-key");return a?{ok:!0,payload:{rule_type:"supplier_force_review",subject_type:"supplier",subject_key:a,severity:n,rule_body:{}}}:(showToast(e.needSupplier,"error"),{ok:!1})}if($e==="no_auto_push_category"){const a=it("rs-f-key");return a?{ok:!0,payload:{rule_type:"no_auto_push_category",subject_type:"category",subject_key:a,severity:n,rule_body:{}}}:(showToast(e.needCategory,"error"),{ok:!1})}return{ok:!0,payload:{rule_type:"accounting_period",subject_type:"global",subject_key:null,severity:n,rule_body:{mode:it("rs-f-mode")||"current_month"}}}}async function kc(){const e=wc();if(!(!e.ok||!e.payload))try{let n;if(sa!==null){const a=e.payload;n=await Mt("PATCH","/"+sa,{rule_body:a.rule_body,severity:a.severity})}else n=await Mt("POST","",e.payload);if(!n.ok)throw new Error("http "+n.status);showToast(ce().saved,"success"),document.getElementById("rs-add-modal")?.classList.remove("rs-open"),await Oa()}catch{showToast(ce().saveFail,"error")}}async function xc(e){const n=jn.find(s=>s.id===e);if(!n)return;const a=!n.is_active;n.is_active=a;const o=document.querySelector(`#rules-settings-modal [data-toggle="${e}"]`);o&&o.classList.toggle("off",!a);try{const s=await Mt("PATCH","/"+e,{is_active:a});if(!s.ok)throw new Error("http "+s.status);showToast(a?ce().enabled:ce().disabled,"success")}catch{n.is_active=!a,o&&o.classList.toggle("off",a),showToast(ce().saveFail,"error")}}async function _c(e){if(await showConfirm(ce().delConfirm,{danger:!0}))try{const a=await Mt("DELETE","/"+e);if(!a.ok)throw new Error("http "+a.status);showToast(ce().deleted,"success"),await Oa()}catch{showToast(ce().saveFail,"error")}}function Lo(e,n){$e=e,Na="global",sa=n?n.id:null,yc(n)}function Ec(){if(_o)return;const e=document.createElement("style");e.textContent=uc,document.head.appendChild(e);const n=ce(),a=document.createElement("div");a.id="rules-settings-modal",a.innerHTML=`<div class="rs-pop"><div class="rs-head"><h2>${n.title}</h2><span class="rs-tag">●</span><button class="rs-close" id="rs-main-close">${Xe("x",18)}</button></div><div class="rs-body" id="rs-body"></div><div class="rs-foot"><button class="rs-btn rs-btn-primary" id="rs-done">${n.done}</button></div></div>`,document.body.appendChild(a);const o=document.createElement("div");o.id="rs-add-modal",document.body.appendChild(o),document.addEventListener("click",s=>{const i=s.target;(i.id==="rules-settings-modal"||i.closest("#rs-main-close")||i.closest("#rs-done"))&&a.classList.remove("rs-open"),(i.id==="rs-add-modal"||i.closest("#rs-add-close")||i.closest("#rs-add-cancel"))&&o.classList.remove("rs-open");const r=i.closest("[data-add-type]");r&&Lo(r.dataset.addType);const c=i.closest("[data-edit]");if(c){const l=jn.find(p=>p.id===Number(c.dataset.edit));l&&Lo(l.rule_type,l)}const m=i.closest("[data-del]");m&&_c(Number(m.dataset.del));const d=i.closest("[data-toggle]");d&&xc(Number(d.dataset.toggle));const u=i.closest("[data-type-pick]");if(u){$e=u.dataset.typePick,document.querySelectorAll("#rs-add-modal .rs-type").forEach(p=>p.classList.toggle("on",p.dataset.typePick===$e));const l=document.getElementById("rs-add-fields");l&&(l.innerHTML=ia())}i.closest("#rs-add-save")&&kc()}),document.addEventListener("change",s=>{const i=s.target;if(i.id==="rs-f-scope"){Na=i.value;const r=document.getElementById("rs-add-fields");r&&(r.innerHTML=ia())}}),document.addEventListener("keydown",s=>{s.key==="Escape"&&(o.classList.contains("rs-open")?o.classList.remove("rs-open"):a.classList.contains("rs-open")&&a.classList.remove("rs-open"))}),_o=!0}window.openRulesSettings=function(){Ec(),document.getElementById("rules-settings-modal").classList.add("rs-open"),Oa()};function Lc(){const e=document.querySelector("#page-exceptions .page-head-actions");if(!e||document.getElementById("exc-rules-btn"))return;const n=document.createElement("button");n.id="exc-rules-btn",n.type="button",n.className="btn btn-ghost",n.innerHTML=Xe("settings",16)+`<span class="rs-btn-label">${ce().btn}</span>`,n.addEventListener("click",()=>window.openRulesSettings&&window.openRulesSettings()),e.insertBefore(n,e.firstChild)}let Io=!1;async function Ic(){if(!Io){Io=!0;try{(await Mt("GET","")).ok&&Lc()}catch{}}}const Bo=window.loadExceptionsPage;window.loadExceptionsPage=function(){Ic(),Bo&&Bo()};Array.isArray(window.__i18nSubs)||(window.__i18nSubs=[]);window.__i18nSubs.push({name:"rules-settings",fn:()=>{const e=document.querySelector("#exc-rules-btn .rs-btn-label");e&&(e.textContent=ce().btn),document.getElementById("rules-settings-modal")?.classList.contains("rs-open")&&Ps()}});(function(){const e=document.getElementById("page-knowledge");if(!(!e||e.dataset.wbInjected==="1")){if(!document.getElementById("kb-center-style")){const n=document.createElement("style");n.id="kb-center-style",n.textContent=`
...
`,e.dataset.wbInjected="1";try{const n=window._currentLang||localStorage.getItem("mrpilot_lang")||"th",a=window.I18N;a&&a[n]&&e.querySelectorAll("[data-i18n]").forEach(o=>{const s=o.getAttribute("data-i18n");a[n][s]&&(o.textContent=a[n][s])})}catch{}}})();const Bc="/api/knowledge";function Cc(){return localStorage.getItem("mrpilot_token")||""}function Pn(){const e=window.getActiveWorkspaceClientId;if(typeof e!="function")return null;const n=e(),a=Number(n);return Number.isFinite(a)&&a>0?a:null}function Ds(){const e=Pn();if(!e)return"";const a=(window._workspaceClientsCache||[]).find(o=>Number(o.id)===e);return a&&a.name?String(a.name):"#"+e}async function tn(e,n,a,o={}){const s=new URL(Bc+n,location.origin),i=Pn();if(o.query)for(const[d,u]of Object.entries(o.query))u!=null&&s.searchParams.set(d,String(u));const r=o.withWorkspace!==!1&&i!=null;r&&(e==="GET"||e==="DELETE")&&s.searchParams.set("workspace_client_id",String(i));const c={Authorization:"Bearer "+Cc()};let m=o.raw;if(!o.raw&&a!==void 0){const d=r?{workspace_client_id:i,...a}:a;c["Content-Type"]="application/json",m=JSON.stringify(d)}try{const d=await fetch(s.toString(),{method:e,headers:c,body:m});let u=null,l;const p=await d.text();if(p)try{const f=JSON.parse(p);d.ok?u=f:l=f?.detail?.error_code||f?.message_key||f?.detail||void 0}catch{}return{ok:d.ok,status:d.status,data:u,error:l}}catch{return{ok:!1,status:0,data:null,error:"network"}}}async function Sc(e,n){const a=new FormData;a.append("file",e);const o=Pn();return o!=null&&a.append("workspace_client_id",String(o)),tn("POST","/documents",void 0,{raw:a,withWorkspace:!1})}let cn=null;async function Rs(){if(cn!==null)return cn;const e=await tn("GET","/bases",void 0,{withWorkspace:!1});return cn=e.status===200||e.status===401||e.status===403,cn}let Co=!1;function So(e,n){if(typeof window.t=="function"){const a=window.t(e);if(a&&a!==e)return a}return n}function qs(){const e=document.getElementById("kb-ws-bar"),n=document.getElementById("kb-ws-label");if(!e||!n)return;Pn()?(e.classList.remove("kb-ws-empty"),n.innerHTML=So("kb-ws-current","账套主体")+"：<b>"+Tc(Ds())+"</b>"):(e.classList.add("kb-ws-empty"),n.textContent=So("kb-ws-none","请先在右上角选择账套主体,再使用客户私有文档与问答。"))}function Tc(e){return typeof escapeHtml=="function"?escapeHtml(e):e}function Mc(e){document.querySelectorAll(".kb-tab-bar .recon-tab-btn").forEach(n=>{n.classList.toggle("active",n.dataset.kbTab===e)}),document.querySelectorAll(".kb-pane").forEach(n=>{n.classList.toggle("active",n.id==="kb-pane-"+e)}),e==="docs"&&typeof window._kbRenderDocs=="function"&&window._kbRenderDocs(),e==="qa"&&typeof window._kbRenderAsk=="function"&&window._kbRenderAsk()}function $c(){if(Co)return;const e=document.querySelector(".kb-tab-bar");if(!e)return;e.addEventListener("click",a=>{const o=a.target.closest(".recon-tab-btn");o&&o.dataset.kbTab&&Mc(o.dataset.kbTab)});const n=document.getElementById("kb-open-rules");n&&n.addEventListener("click",()=>{typeof window.openRulesSettings=="function"&&window.openRulesSettings()}),Co=!0}window.loadKnowledgePage=function(){$c(),qs(),document.querySelector('.kb-tab-bar .recon-tab-btn[data-kb-tab="docs"]')?.classList.contains("active")&&typeof window._kbRenderDocs=="function"&&window._kbRenderDocs()};async function To(){if(!window._knowledgeProbed){window._knowledgeProbed=!0;try{if(await Rs()){const e=document.getElementById("nav-knowledge");e&&(e.style.display="")}}catch{}}}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",To):To();Array.isArray(window.__i18nSubs)||(window.__i18nSubs=[]);window.__i18nSubs.push({name:"knowledge-center",fn:qs});let ra=!1,He=[];function pe(e,n){if(typeof window.t=="function"){const a=window.t(e);if(a&&a!==e)return a}return n}function he(e){return typeof escapeHtml=="function"?escapeHtml(String(e??"")):String(e??"")}function Hc(e){return e.status==="ready"?`<span class="kb-badge ready"><span class="kb-bdot"></span>${he(pe("kb-doc-ready","已就绪"))}</span>`:e.status==="failed"?`<span class="kb-badge failed"><span class="kb-bdot"></span>${he(pe("kb-doc-failed","失败"))}</span>`:`<span class="kb-badge parsing"><span class="kb-bdot"></span>${he(pe("kb-doc-parsing","解析中"))}</span>`}function Ac(e){return e==="unsupported_document"?pe("kb-err-unsupported_document","不支持的文件类型"):e==="embedding_failed"?pe("kb-err-embedding_failed","向量化失败，可重试"):e?pe("kb-doc-failed","失败"):""}function jc(e){return(e||"").slice(0,10)}function Pc(e){const n=e.status==="failed"&&e.error_code?`<div class="kb-doc-sub err">${he(Ac(e.error_code))}</div>`:`<div class="kb-doc-sub">${he((e.source_type||"").toUpperCase())} · ${he(jc(e.created_at))}</div>`,a=`<button class="btn btn-sm btn-ghost kb-doc-del" data-id="${e.id}">${he(pe("kb-doc-delete","删除"))}</button>`;return`<div class="kb-doc-row" data-id="${e.id}">
        <div class="kb-doc-ic">${Fs(e.source_type)}</div>
        <div class="kb-doc-meta"><div class="kb-doc-name">${he(e.filename)}</div>${n}</div>
        ${Hc(e)}${a}
    </div>`}function Fs(e){const n=(e||"").toLowerCase();return n==="pdf"?"📄":n==="doc"||n==="docx"?"📘":n==="xls"||n==="xlsx"||n==="csv"?"📊":["png","jpg","jpeg","webp"].includes(n)?"🖼️":"📄"}function Va(){return document.getElementById("kb-doc-list")}function Dn(){const e=Va();if(e){if(!He.length){e.innerHTML=`<div class="kb-empty">
        ...
        </div>`;return}e.innerHTML=He.map(Pc).join("")}}function Mo(e){const n=Va();n&&(n.innerHTML=e)}async function zs(){Mo('<div class="kb-skel"><div class="kb-skrow"></div><div class="kb-skrow"></div><div class="kb-skrow"></div></div>');const e=await tn("GET","/documents");if(!e.ok){Mo(`<div class="kb-empty err">
            <div>${he(pe("kb-doc-error","加载失败"))}</div>
            <button class="btn btn-sm kb-doc-reload" style="margin-top:12px">${he(pe("kb-doc-retry","重试"))}</button>
        </div>`);return}He=(e.data?.documents||[]).filter(n=>n.status!=="deleted"),Dn()}async function $o(e){const n=Array.from(e);if(n.length)for(const a of n){const o=-Date.now()-Math.floor(Math.random()*1e3);He.unshift({id:o,filename:a.name,source_type:(a.name.split(".").pop()||"").toLowerCase(),status:"uploading",error_code:null,created_at:new Date().toISOString()}),Dc(o);const s=await Sc(a),i=He.findIndex(r=>r.id===o);i<0||(s.ok&&s.data?.document?(He[i]=s.data.document,s.data.document.status==="failed"&&showToast(pe("kb-doc-failed","失败")+"："+a.name,"error")):(He.splice(i,1),showToast(pe("kb-upload-fail","上传失败")+"："+a.name,"error")),Dn())}}function Dc(e){const n=Va();if(!n)return;const a=He.find(s=>s.id===e);if(!a)return;He.length===1&&(n.innerHTML="");const o=document.createElement("div");o.innerHTML=`<div class="kb-doc-row" data-id="${e}">
        <div class="kb-doc-ic">${Fs(a.source_type)}</div>
    ...
    </div>`,n.insertBefore(o.firstElementChild,n.firstChild)}async function Rc(e){if(!(typeof showConfirm=="function"?await showConfirm(pe("kb-doc-del-confirm","确定删除这份文档？删除后 AI 将不再引用它。")):!0))return;(await tn("DELETE","/documents/"+e)).ok?(He=He.filter(o=>o.id!==e),Dn()):showToast(pe("kb-doc-del-fail","删除失败"),"error")}function qc(){const e=document.getElementById("kb-pane-docs");if(!e||ra&&e.querySelector("#kb-doc-list"))return;if(!document.getElementById("kb-docs-style")){const o=document.createElement("style");o.id="kb-docs-style",o.textContent=`
...
`,document.head.appendChild(e);const n=document.createElement("div");n.id="kb-src-mask",n.className="kb-src-mask",n.innerHTML='<div class="kb-src-modal" id="kb-src-modal" role="dialog" aria-modal="true"></div>',document.body.appendChild(n),n.addEventListener("click",a=>{(a.target===n||a.target.closest("[data-kb-src-close]"))&&Ho()}),document.addEventListener("keydown",a=>{a.key==="Escape"&&n.classList.contains("open")&&Ho()})}function Ho(){document.getElementById("kb-src-mask")?.classList.remove("open")}function Nc(e){zc();const n=document.getElementById("kb-src-modal");if(!n)return;const a=e.filename||gt("kb-src-unknown","未知来源"),o=typeof e.score=="number"?Math.round(Math.max(0,Math.min(1,e.score))*100):null;n.innerHTML=`
        <div class="kb-src-head">
            <span class="ic">📄</span>
            <div>
                <h3>${bt(gt("kb-src-title","来源出处"))}</h3>
                <div class="sub">${bt(gt("kb-src-from","此结论引用自以下文档"))}</div>
            </div>
        ...
        <div class="kb-src-body">
            <div class="kb-src-doc">
                <span class="di">📄</span>
                <div><div class="dn">${bt(a)}</div>
                <div class="dm">${bt(gt("kb-src-doc-note","已就绪 · 已建立向量索引"))}</div></div>
            </div>
            ${o!==null?`<div class="kb-src-rel">🎯 ${bt(gt("kb-src-relevance","相关度"))} ${o}%</div>`:""}
            <div class="kb-src-note">${bt(gt("kb-src-explain","AI 据此份文档作答 · 你可在文档库打开原件核对。原文片段高亮预览即将上线。"))}</div>
        </div>
    `,document.getElementById("kb-src-mask")?.classList.add("open")}window._kbOpenSource=Nc;function ke(e,n){if(typeof window.t=="function"){const a=window.t(e);if(a&&a!==e)return a}return n}function fe(e){return typeof escapeHtml=="function"?escapeHtml(String(e??"")):String(e??"")}function Oc(e){return`<div class="kb-msg user"><div class="kb-bub">${fe(e)}</div></div>`}function Vc(e){const n=e.filename||ke("kb-src-unknown","未知来源");return`<button class="kb-cite" data-cite='${fe(JSON.stringify(e))}'>
        ...
        ${fe(n)}<span class="ch">›</span></button>`}function Uc(e){if(e.no_answer){const a=ke(e.message_key||"ask.no_source","资料不足，无法判断。");return`<div class="kb-msg ai"><div class="kb-ava">🐱</div>
            <div class="kb-bub no-src">${fe(a)}</div></div>`}const n=(e.citations||[]).map(a=>Vc(a)).join("");return`<div class="kb-msg ai"><div class="kb-ava">🐱</div>
        <div class="kb-bub">${fe(e.answer)}${n?`<div class="kb-cites">${n}</div>`:""}</div></div>`}async function Gc(e){const n=await tn("POST","/ask",{question:e});return!n.ok||!n.data?null:n.data}function Ns(e,n,a){if(e.dataset.kbWired==="1")return;e.dataset.kbWired="1";let o=!1;function s(r){const c=document.createElement("div");c.innerHTML=r;const m=c.firstElementChild;return e.appendChild(m),e.scrollTop=e.scrollHeight,m}async function i(){const r=n.value.trim();if(!r||o)return;o=!0,n.value="",s(Oc(r));const c=s(`<div class="kb-msg ai"><div class="kb-ava">🐱</div><div class="kb-bub kb-thinking">${fe(ke("kb-ask-thinking","思考中…"))}</div></div>`),m=await Gc(r);c.remove(),m?s(Uc(m)):(s(`<div class="kb-msg ai"><div class="kb-ava">🐱</div><div class="kb-bub no-src">${fe(ke("kb-ask-error","出错了，请稍后重试。"))}</div></div>`),typeof showToast=="function"&&showToast(ke("kb-ask-error","出错了，请稍后重试。"),"error")),o=!1}a.addEventListener("click",i),n.addEventListener("keydown",r=>{r.key==="Enter"&&!r.shiftKey&&(r.preventDefault(),i())}),e.addEventListener("click",r=>{const c=r.target.closest(".kb-cite");if(!(!c||!c.dataset.cite))try{const m=JSON.parse(c.dataset.cite);typeof window._kbOpenSource=="function"&&window._kbOpenSource(m)}catch{}})}window._kbWireAsk=Ns;function Kc(){if(document.getElementById("kb-ask-style"))return;const e=document.createElement("style");e.id="kb-ask-style",e.textContent=`
...
`,document.head.appendChild(e)}function Wc(){const e=document.getElementById("kb-pane-qa");if(!e||e.dataset.kbBuilt==="1")return;Kc();const n=fe(ke("kb-ask-ex1","这家客户有金额上限吗？")),a=fe(ke("kb-ask-ex2","合同约定的付款周期是多久？")),o=fe(ke("kb-ask-ex3","哪些供应商需要人工复核？")),s=typeof window._kbFabEnabled=="function"&&window._kbFabEnabled();e.innerHTML=`
        <div class="kb-ft">
    ...
    `,e.dataset.kbBuilt="1";const i=e.querySelector("#kb-qa-thread"),r=e.querySelector("#kb-qa-input"),c=e.querySelector("#kb-qa-send");Ns(i,r,c),e.querySelectorAll(".kb-chip").forEach(d=>{d.addEventListener("click",()=>{r.value=d.dataset.q||"",c.click()})});const m=e.querySelector("#kb-fab-switch");m?.addEventListener("click",()=>{const d=!m.classList.contains("on");m.classList.toggle("on",d),m.setAttribute("aria-checked",String(d)),typeof window._kbFabSetEnabled=="function"&&window._kbFabSetEnabled(d)})}window._kbRenderAsk=Wc;const Ua="pearnly_kb_fab",la="/static/brand/kb-cat.png",Ke=14;let ca=!1,Ao=!1;function Qe(e,n){if(typeof window.t=="function"){const a=window.t(e);if(a&&a!==e)return a}return n}function Yc(){if(document.getElementById("kb-fab-style"))return;const e=document.createElement("style");e.id="kb-fab-style",e.textContent=`
...
`,document.head.appendChild(e)}let W,Je,mn,xe;function Jc(){ca||(Yc(),W=document.createElement("div"),W.className="kb-fab",W.id="kb-fab",W.innerHTML=`
        <span class="kb-say" id="kb-say">${Qe("kb-fab-hi","喵~")}</span>
        <button class="kb-fab-btn" id="kb-fab-btn" aria-label="${Qe("kb-fab-aria","问 AI")}"><img src="${la}" alt=""></button>`,document.body.appendChild(W),xe=document.createElement("div"),xe.className="kb-card",xe.id="kb-card",xe.innerHTML=`
        <div class="kb-card-top">
            <div class="tt"><span class="mini"><img src="${la}" alt=""></span> ${Qe("kb-fab-title","客户知识助手")}</div>
        ...
        <div class="kb-qa-input">
            <input id="kb-card-input" placeholder="${Qe("kb-fab-ph","随处可问，不跳页…")}">
            <button class="kb-send" id="kb-card-send"><svg viewBox="0 0 24 24"><path d="M12 19V5M5 12l7-7 7 7"/></svg></button>
        </div>`,document.body.appendChild(xe),Je=W.querySelector("#kb-fab-btn"),mn=W.querySelector("#kb-say"),document.getElementById("kb-card-x")?.addEventListener("click",da),document.addEventListener("keydown",e=>{e.key==="Escape"&&da()}),od(),nd(),ad(),ca=!0)}function Xc(){const e=document.getElementById("kb-card-thread"),n=document.getElementById("kb-card-input"),a=document.getElementById("kb-card-send");!Ao&&typeof window._kbWireAsk=="function"&&(e.innerHTML=`<div class="kb-msg ai"><div class="kb-ava"><img src="${la}" alt=""></div><div class="kb-bub">${Qe("kb-ask-empty","问点关于这家客户的事，答案都带出处；查不到时如实说「资料不足」。")}</div></div>`,window._kbWireAsk(e,n,a),Ao=!0);const o=document.getElementById("kb-card-ws");o&&(o.textContent=Ds()||Qe("kb-fab-no-ws","未选账套")),Zc(),xe.classList.add("open"),ed(),Os(["💛","✨","💙","🐾"])}function da(){xe?.classList.remove("open")}function Zc(){const e=W.getBoundingClientRect(),n=520,a=e.left+e.width/2<window.innerWidth/2,o=Math.min(Math.max(Ke,e.top+e.height/2-n/2),window.innerHeight-n-Ke);xe.style.top=o+"px",a?(xe.style.left=e.right+12+"px",xe.style.right="auto"):(xe.style.right=window.innerWidth-e.left+12+"px",xe.style.left="auto")}let jo;function Qc(e,n=1500){mn.textContent=e,mn.classList.add("show"),clearTimeout(jo),jo=setTimeout(()=>mn.classList.remove("show"),n)}function ed(){Je.classList.remove("jump"),Je.classList.add("cheer"),setTimeout(()=>Je.classList.remove("cheer"),650)}function td(){W.classList.contains("lifted")||(Je.classList.remove("cheer"),Je.classList.add("jump"),setTimeout(()=>Je.classList.remove("jump"),720))}function Os(e){for(let n=0;n<5;n++){const a=document.createElement("span");a.className="kb-spark",a.textContent=e[n%e.length],a.style.setProperty("--dx",n*14-28+"px"),a.style.left=30+n*10+"%",a.style.animationDelay=n*40+"ms",W.appendChild(a),setTimeout(()=>a.remove(),1100)}}function nd(){const e=[Qe("kb-fab-hi","喵?"),Qe("kb-fab-ask","问我呀!"),"🐾"];Je.addEventListener("mouseenter",()=>{W.classList.contains("lifted")||Qc(e[(Date.now()/1e3|0)%e.length],1400)}),setInterval(()=>{!W.classList.contains("on")||W.classList.contains("lifted")||xe.classList.contains("open")||(Date.now()/1e3|0)%2===0&&(td(),Os(["✨","🐾"]))},5400)}function Kn(e){return Math.min(Math.max(Ke,e),window.innerHeight-W.offsetHeight-Ke)}function ad(){W.classList.add("snapping"),W.style.left=window.innerWidth-56-Ke+"px",W.style.top="62%"}function od(){let e,n=!1,a=!1,o=0,s=0,i=0,r=0;function c(l){o=l.clientX,s=l.clientY,a=!1,n=!1;const p=W.getBoundingClientRect();i=p.left,r=p.top,W.classList.remove("snapping"),e=setTimeout(()=>{W.classList.add("lifted")},180),window.addEventListener("pointermove",m),window.addEventListener("pointerup",d),l.preventDefault()}function m(l){const p=l.clientX-o,f=l.clientY-s;!n&&Math.hypot(p,f)>6&&(n=!0,W.classList.add("lifted"),clearTimeout(e)),n&&(a=!0,W.style.left=i+p+"px",W.style.top=Kn(r+f)+"px")}function d(){if(clearTimeout(e),window.removeEventListener("pointermove",m),window.removeEventListener("pointerup",d),W.classList.remove("lifted"),!a){Xc();return}u()}function u(){const l=W.getBoundingClientRect();W.classList.add("snapping"),W.style.top=Kn(l.top)+"px",W.style.left=(l.left+l.width/2<window.innerWidth/2?Ke:window.innerWidth-W.offsetWidth-Ke)+"px"}Je.addEventListener("pointerdown",c),window.addEventListener("resize",()=>{if(!ca)return;const l=W.getBoundingClientRect();W.style.top=Kn(l.top)+"px",W.style.left=(l.left+l.width/2<window.innerWidth/2?Ke:window.innerWidth-W.offsetWidth-Ke)+"px"})}function Vs(e){Jc(),localStorage.setItem(Ua,e?"1":"0"),W.classList.toggle("on",e),e||da()}window._kbFabSetEnabled=Vs;window._kbFabEnabled=()=>localStorage.getItem(Ua)==="1";async function Po(){if(localStorage.getItem(Ua)==="1")try{await Rs()&&Vs(!0)}catch{}}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",Po):Po();const sd=`
    <div class="cmdk">
...
`;be("cmdk-mask",sd);(function(){function e(l){try{if(location.search.indexOf("test_center=1")>=0||localStorage.getItem("pearnly_test_mode")==="1"||l&&l.id&&String(l.id)==="468b50c1-5593-4fd6-990d-515ce8085563")return!0}catch{}return!1}window.applyRoleVisibility=function(){var p=window._userInfo,f=!1,v=!0,w=!1,b=!1;p&&(f=typeof canManageTeam=="function"?canManageTeam(p):!!(p.role==="owner"||p.is_super_admin),v=typeof shouldHideMoney=="function"?shouldHideMoney(p):p.role==="member"&&!p.is_super_admin,w=typeof isSuperAdmin=="function"?isSuperAdmin(p):!!p.is_super_admin,b=e(p)),document.querySelectorAll("[data-show-if-team]").forEach(function(h){h.style.display=f?"":"none"}),document.querySelectorAll("[data-show-if-money]").forEach(function(h){h.style.display=v?"none":""}),document.querySelectorAll("[data-show-if-admin]").forEach(function(h){h.style.display=w?"":"none"}),document.querySelectorAll("[data-show-if-test]").forEach(function(h){h.style.display=b?"":"none"});var g=w||b;document.querySelectorAll("[data-show-if-special]").forEach(function(h){h.style.display=g?"":"none"})},window.renderAvatarMenu=function(p){if(p){var f=document.getElementById("avatar-btn"),v=document.getElementById("avatar-popup-name"),w=document.getElementById("avatar-popup-email");if(!(!f||!v||!w)){var b=(p.username||"").trim(),g=b.split("@")[0]||b||"—",h=(b.charAt(0)||"?").toUpperCase(),_=(p.avatar_url||"").trim();if(_){var y=_.replace(/"/g,"&quot;"),k=h.replace(/'/g,"\\'");f.innerHTML='<img src="'+y+'" alt="'+h+`" referrerpolicy="no-referrer" onerror="this.parentNode.textContent='`+k+`'">`}else f.textContent=h;v.textContent=g,w.textContent=b||"—",f.setAttribute("title",b||"")}}};function n(){var l=document.getElementById("avatar-wrap"),p=document.getElementById("avatar-btn"),f=document.getElementById("avatar-popup");if(!l||!p||!f)return;function v(){f.classList.remove("show"),p.setAttribute("aria-expanded","false")}function w(){f.classList.add("show"),p.setAttribute("aria-expanded","true")}p.addEventListener("click",function(b){b.stopPropagation(),f.classList.contains("show")?v():w()}),document.addEventListener("click",function(b){f.classList.contains("show")&&!l.contains(b.target)&&v()}),f.addEventListener("click",function(b){var g=b.target.closest(".avatar-popup-item");if(g){var h=g.dataset.action;switch(v(),h){case"settings":typeof openSettingsModal=="function"?openSettingsModal():typeof routeTo=="function"&&routeTo("settings");break;case"team":typeof openSettingsModal=="function"?openSettingsModal():typeof routeTo=="function"&&routeTo("settings"),setTimeout(function(){typeof switchSettingsTab=="function"&&switchSettingsTab("team")},50);break;case"billing":typeof openSettingsModal=="function"?openSettingsModal():typeof routeTo=="function"&&routeTo("settings"),setTimeout(function(){typeof switchSettingsTab=="function"&&switchSettingsTab("plan")},50);break;case"shortcuts":if(typeof showToast=="function"){var _=typeof t=="function"?t("feature-coming-soon"):"即将上线";showToast(_||"即将上线","info")}break;case"admin":window.location.href="/admin/cost";break;case"test-center":typeof routeTo=="function"&&routeTo("test-center");break;case"help":var y=document.getElementById("help-modal");y&&(y.style.display="flex");break;case"logout":try{localStorage.removeItem("mrpilot_token")}catch{}try{localStorage.removeItem("mrpilot_user")}catch{}window.location.href="/";break}}}),window._closeAvatarPopup=v}function a(){return[].slice.call(document.querySelectorAll(".cmdk-item")).filter(function(l){return l.style.display!=="none"})}function o(l){var p=a();p.forEach(function(f){f.classList.remove("focus")}),p[l]&&(p[l].classList.add("focus"),p[l].scrollIntoView({block:"nearest"}))}function s(l){var p=a();if(p.length){var f=p.findIndex(function(w){return w.classList.contains("focus")});f<0&&(f=0);var v=(f+l+p.length)%p.length;o(v)}}function i(l){l=(l||"").toLowerCase().trim();var p=0,f=window._userInfo,v=typeof isSuperAdmin=="function"?isSuperAdmin(f):!!(f&&f.is_super_admin),w=e(f);document.querySelectorAll(".cmdk-item").forEach(function(g){if(g.dataset.showIfAdmin==="1"&&!v){g.style.display="none";return}if(g.dataset.showIfTest==="1"&&!w){g.style.display="none";return}var h=(g.dataset.cmdkText||g.textContent||"").toLowerCase(),_=!l||h.indexOf(l)>=0;g.style.display=_?"":"none",g.classList.remove("focus"),_&&p++}),document.querySelectorAll("[data-cmdk-section]").forEach(function(g){for(var h=g.nextElementSibling,_=!1;h&&!h.hasAttribute("data-cmdk-section");){if(h.classList&&h.classList.contains("cmdk-item")&&h.style.display!=="none"){_=!0;break}h=h.nextElementSibling}g.style.display=_?"":"none"});var b=document.getElementById("cmdk-empty");b&&(b.style.display=p===0?"flex":"none"),o(0)}window.openCmdk=function(){var p=document.getElementById("cmdk-mask");p&&(typeof window._closeAvatarPopup=="function"&&window._closeAvatarPopup(),p.classList.add("show"),typeof window.applyRoleVisibility=="function"&&window.applyRoleVisibility(),setTimeout(function(){var f=document.getElementById("cmdk-input");f&&(f.value="",i(""),f.focus(),o(0))},50))},window.closeCmdk=function(){var p=document.getElementById("cmdk-mask");p&&p.classList.remove("show")};function r(l){if(l){if(l.classList.contains("cmdk-item-locked")){if(typeof showToast=="function"){var p=typeof t=="function"?t("feature-coming-soon"):"即将上线";showToast(p||"即将上线","info")}return}var f=l.dataset.cmdkRoute,v=l.dataset.cmdkAction;if(window.closeCmdk(),f){typeof routeTo=="function"&&routeTo(f);return}if(v){if(v==="open-admin"){window.location.href="/admin/cost";return}if(v.indexOf("lang-")===0){var w=v.slice(5);typeof applyLang=="function"&&applyLang(w)}}}}function c(){var l=document.getElementById("cmdk-mask"),p=document.getElementById("cmdk-input"),f=document.getElementById("cmdk-body");if(!(!l||!p||!f)){l.addEventListener("click",function(b){b.target===l&&window.closeCmdk()});var v=document.getElementById("cmdk-esc-btn");v&&v.addEventListener("click",function(){window.closeCmdk()}),p.addEventListener("input",function(b){i(b.target.value)}),p.addEventListener("keydown",function(b){b.key==="ArrowDown"?(b.preventDefault(),s(1)):b.key==="ArrowUp"?(b.preventDefault(),s(-1)):b.key==="Enter"?(b.preventDefault(),r(l.querySelector(".cmdk-item.focus"))):b.key==="Escape"&&(b.preventDefault(),window.closeCmdk())}),f.addEventListener("click",function(b){var g=b.target.closest(".cmdk-item");g&&r(g)}),f.addEventListener("mousemove",function(b){var g=b.target.closest(".cmdk-item");!g||g.style.display==="none"||g.classList.contains("cmdk-item-locked")||(a().forEach(function(h){h.classList.remove("focus")}),g.classList.add("focus"))});var w=document.getElementById("topbar-search");w&&(w.addEventListener("click",function(){window.openCmdk()}),w.addEventListener("keydown",function(b){(b.key==="Enter"||b.key===" ")&&(b.preventDefault(),window.openCmdk())}))}}document.addEventListener("keydown",function(l){if((l.metaKey||l.ctrlKey)&&(l.key==="k"||l.key==="K")){l.preventDefault(),window.openCmdk();return}if(l.key==="Escape"){var p=document.getElementById("cmdk-mask");if(p&&p.classList.contains("show")){window.closeCmdk();return}var f=document.getElementById("avatar-popup");f&&f.classList.contains("show")&&typeof window._closeAvatarPopup=="function"&&window._closeAvatarPopup()}});try{var m=(navigator.userAgent||"").toLowerCase(),d=m.indexOf("mac")>=0||m.indexOf("iphone")>=0||m.indexOf("ipad")>=0;d||document.body.classList.add("is-windows")}catch{}function u(){n(),c(),typeof window.subscribeI18n=="function"&&window.subscribeI18n("nav-ia-phase1-role",function(){try{typeof window.applyRoleVisibility=="function"&&window.applyRoleVisibility()}catch{}})}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",u):u()})();(function(){function n(v){return String(v??"").replace(/[&<>"']/g,function(w){return{"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"}[w]})}function a(v){if(!v||isNaN(v))return"";var w=Number(v);return w<1024?w+" B":w<1024*1024?(w/1024).toFixed(1)+" KB":(w/1024/1024).toFixed(1)+" MB"}document.addEventListener("click",function(v){var w=v.target.closest&&v.target.closest(".recon-collapse-head");if(w&&!(v.target.closest("button")||v.target.closest("a"))){var b=w.closest(".recon-collapse");if(b){var g=b.getAttribute("data-collapsed")==="true";b.setAttribute("data-collapsed",g?"false":"true"),g&&(b.id==="vex-summary-collapse"&&u(),b.id==="vex-detail-collapse"&&l())}}}),document.addEventListener("keydown",function(v){if(!(v.key!=="Enter"&&v.key!==" ")){var w=v.target.closest&&v.target.closest(".recon-collapse-head");w&&(v.preventDefault(),w.click())}});var o={vat:"",gl:""};window._glvClearPreviewSearch=function(){o.vat="",o.gl=""};var s='<svg class="vex-pp-fi-icon" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#111111" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/></svg>',i='<svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg>';function r(){m("vat"),m("gl")}function c(v){try{if(typeof window._glvPreviewFiles=="function")return window._glvPreviewFiles(v)||[]}catch{}var w=document.getElementById(v==="vat"?"glv-vat-input":"glv-gl-input");return w&&w.files?Array.from(w.files):[]}function m(v){var w=document.getElementById(v==="vat"?"glv-pp-vat-col":"glv-pp-gl-col");if(w){var b=c(v),g=v==="vat"?"glv-up-vat-title":"glv-up-gl-title",h=v==="vat"?"① 销项税报告":"② 总账 GL",_=window.t&&window.t(g)||h,y=n(window.t&&window.t("vex-preview-search")||"搜索文件名..."),k=n(window.t&&window.t("vex-preview-clear-all")||"全清"),x=o[v]||"",E=b.length;w.innerHTML='<div class="vex-pp-col-title"><span class="vex-pp-col-name">'+n(_)+' <span class="vex-pp-col-count">'+E+'</span></span></div><div class="vex-pp-search-row"><input class="vex-pp-search" id="glv-pp-search-'+v+'" type="text" placeholder="'+y+'" value="'+n(x)+'" autocomplete="off"><button class="vex-pp-clear-btn" id="glv-pp-clearall-'+v+'" type="button">'+k+'</button></div><div class="vex-pp-file-list" id="glv-pp-'+v+'-list"></div><div class="vex-pp-pagination" id="glv-pp-'+v+'-pg"></div>';var L=document.getElementById("glv-pp-search-"+v);L&&L.addEventListener("input",function(B){o[v]=B.target.value,d(v)});var I=document.getElementById("glv-pp-clearall-"+v);I&&I.addEventListener("click",function(){window._glvRemoveFile&&window._glvRemoveFile(v)}),d(v)}}function d(v){var w=document.getElementById("glv-pp-"+v+"-list"),b=document.getElementById("glv-pp-"+v+"-pg");if(w){var g=c(v),h=(o[v]||"").toLowerCase(),_=g.map(function(x,E){return{f:x,i:E}}),y=h?_.filter(function(x){return x.f.name.toLowerCase().indexOf(h)>=0}):_;if(w.innerHTML=y.map(function(x){var E=x.f;return'<div class="vex-pp-file-row">'+s+'<span class="vex-pp-fi-name" title="'+n(E.name)+'">'+n(E.name)+'</span><span class="vex-pp-fi-size">'+a(E.size)+'</span><button class="vex-pp-fi-del" type="button" data-kind="'+v+'" data-idx="'+x.i+'" aria-label="remove">'+i+"</button></div>"}).join(""),w.querySelectorAll(".vex-pp-fi-del").forEach(function(x){x.addEventListener("click",function(){var E=x.dataset.kind,L=parseInt(x.dataset.idx,10);window._glvRemoveFile&&window._glvRemoveFile(E,isNaN(L)?null:L)})}),b){var k=window.t&&window.t("vex-preview-count")||"显示前 {n} / 共 {m}";b.textContent=k.replace("{n}",y.length).replace("{m}",y.length)}}}function u(){var v=function(b,g){var h=document.getElementById(b);h&&(h.textContent=g==null?"—":String(g))},w=window._vexLastTask||{};v("vex-sum-total",w.total),v("vex-sum-matched",w.matched),v("vex-sum-diff",w.diff),v("vex-sum-incomplete",w.incomplete),v("vex-sum-cash",w.cash),document.getElementById("vex-summary-sub")}function l(){var v=window._vexLastTask&&window._vexLastTask.diff_rows||[],w=document.getElementById("vex-detail-tbody"),b=document.getElementById("vex-detail-table"),g=document.getElementById("vex-detail-empty");if(!(!w||!b||!g)){if(v.length===0){b.style.display="none",g.style.display="";return}g.style.display="none",b.style.display="";var h=v.map(function(y){return'<tr><td class="recon-detail-cell-mono">'+n(y.invoice_no||"")+"</td><td>"+n(y.field||"")+"</td><td>"+n(y.report_value||"")+"</td><td>"+n(y.invoice_value||"")+"</td><td>"+n(y.kind||"")+"</td></tr>"}).join("");w.innerHTML=h;var _=document.getElementById("vex-detail-sub");_&&(_.textContent=String(v.length))}}function p(){var v=document.getElementById("glv-toggle-preview");v&&!v._reconBound&&(v._reconBound=!0,v.addEventListener("click",function(){var w=document.getElementById("glv-preview-panel"),b=document.getElementById("glv-toggle-preview-label"),g=w&&w.style.display!=="none";w&&(w.style.display=g?"none":""),v.classList.toggle("open",!g),b&&(b.textContent=g?window.t&&window.t("vex-toggle-preview-open")||"查看清单":window.t&&window.t("vex-toggle-preview-close")||"收起清单"),g||r()})),["glv-vat-input","glv-gl-input"].forEach(function(w){var b=document.getElementById(w);!b||b._reconWatched||(b._reconWatched=!0,b.addEventListener("change",function(){var g=document.getElementById("glv-preview-panel");g&&g.style.display!=="none"&&r()}))})}function f(){var v=document.getElementById("vex-summary-collapse"),w=document.getElementById("vex-detail-collapse");v&&(v.style.display=""),w&&(w.style.display=""),u(),l()}window._fillVexSummary=u,window._fillVexDetail=l,window._onVexResultShown=f,document.addEventListener("DOMContentLoaded",function(){p()}),setTimeout(p,1500),typeof window.subscribeI18n=="function"&&window.subscribeI18n("recon-collapse",function(){var v=document.getElementById("glv-preview-panel");v&&v.style.display!=="none"&&r();var w=document.getElementById("glv-toggle-preview-label"),b=document.getElementById("glv-toggle-preview");w&&b&&(w.textContent=b.classList.contains("open")?window.t&&window.t("vex-toggle-preview-close")||"收起清单":window.t&&window.t("vex-toggle-preview-open")||"查看清单")}),window._reconCollapse={renderGlvPreview:r,fillVexSummary:u,fillVexDetail:l}})();(function(){function e(i){}function n(){const i=document.querySelectorAll("[data-recon-tab]");i.forEach(c=>{c.addEventListener("click",()=>{i.forEach(p=>p.classList.remove("active")),c.classList.add("active");const m=c.dataset.reconTab,d=document.getElementById("recon-pane-bank"),u=document.getElementById("recon-pane-sale-vat"),l=document.getElementById("recon-pane-gl-vat");d&&(d.style.display=m==="bank"?"":"none"),u&&(u.style.display=m==="sale-vat"?"":"none"),l&&(l.style.display=m==="gl-vat"?"":"none"),m==="gl-vat"&&window.GlVatRecon&&window.GlVatRecon.ensureInit(),m==="bank"&&typeof window._bankReconV2Init=="function"&&window._bankReconV2Init()})});const r=document.querySelector("[data-recon-tab].active");r&&(r.dataset.reconTab,void 0)}function a(){const i=document.getElementById("page-settings");if(!i)return null;let r=document.getElementById("settings-modal-overlay");if(r)return r;r=document.createElement("div"),r.id="settings-modal-overlay",r.className="settings-modal-overlay",r.style.display="none",i.parentElement.insertBefore(r,i),r.appendChild(i);const c=document.createElement("button");return c.id="settings-modal-close",c.className="settings-modal-close",c.setAttribute("aria-label","close"),c.innerHTML='<svg viewBox="0 0 20 20" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M5 5l10 10M15 5L5 15"/></svg>',i.insertBefore(c,i.firstChild),c.addEventListener("click",s),r.addEventListener("click",m=>{m.target===r&&s()}),r}function o(){const i=a();if(!i)return;i.style.display="flex",document.body.classList.add("settings-modal-open");const r=document.getElementById("page-settings");r&&(r.style.display="block"),setTimeout(()=>{try{typeof renderSettings=="function"&&renderSettings()}catch(m){console.warn("renderSettings:",m)}let c=document.querySelector(".settings-tab.active")||document.querySelector('.settings-tab[data-tab="profile"]');c&&c.click()},50)}function s(){const i=document.getElementById("settings-modal-overlay");i&&(i.style.display="none"),document.body.classList.remove("settings-modal-open")}window.openSettingsModal=o,window.closeSettingsModal=s,document.addEventListener("keydown",i=>{if(i.key==="Escape"){const r=document.getElementById("settings-modal-overlay");r&&r.style.display==="flex"&&s()}}),window.addEventListener("hashchange",()=>{location.hash==="#/settings"&&o()}),window.addEventListener("DOMContentLoaded",()=>{location.hash==="#/settings"&&o()}),document.readyState==="loading"?document.addEventListener("DOMContentLoaded",n):n()})();const Wn=1e3,Yn=30,Ga=/\.(pdf|jpe?g|png|webp|tiff?|xlsx?|xlsm|csv|tsv|docx?)$/i,X=e=>document.getElementById(e);function mt(){return{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||"")}}function _e(e){const n={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"};return String(e??"").replace(/[&<>"']/g,a=>n[a])}function Us(e){return e<1024?e+" B":e<1024*1024?(e/1024).toFixed(1)+" KB":(e/1024/1024).toFixed(1)+" MB"}const H={invoiceFiles:[],reportFiles:[],running:!1,vexAllRows:[],previewLimitInv:50,previewLimitRep:50,previewSearchInv:"",previewSearchRep:"",vexPage:1};async function vn(){try{const e=await fetch("/api/vat_excel/tasks?page=1&page_size=1",{headers:mt()});if(!e.ok)return;const a=(await e.json()).kpi||{};[["vex-kpi-month-val",a.this_month],["vex-kpi-running-val",a.running],["vex-kpi-done-val",a.done],["vex-kpi-failed-val",a.failed]].forEach(([o,s])=>{const i=document.getElementById(o);i&&(i.textContent=s??0)})}catch{}}async function hn(){try{const e=await fetch("/api/vat_excel/tasks?page=1&page_size=100",{headers:mt()});if(!e.ok)return;const n=await e.json();_n(n.rows||[])}catch{}}const Et=10;function Gs(){var e=((document.getElementById("vex-task-search")||{}).value||"").trim().toLowerCase();if(H.vexPage=1,_n(H.vexAllRows),!!e){var n=document.getElementById("vex-task-tbody");n&&n.querySelectorAll("tr").forEach(function(a){a.dataset.taskId&&(a.style.display=a.textContent.toLowerCase().indexOf(e)>=0?"":"none")})}}function _n(e){H.vexAllRows=e||H.vexAllRows;const n=document.getElementById("vex-task-tbody");if(!n)return;if(!H.vexAllRows.length){n.innerHTML='<tr><td colspan="9" class="vex-task-empty">'+(t("sv-empty-title")||"还没有对账任务")+"</td></tr>",Do(0);return}const a=Math.ceil(H.vexAllRows.length/Et);H.vexPage>a&&(H.vexPage=a);const o=(H.vexPage-1)*Et;id(H.vexAllRows.slice(o,o+Et)),Do(H.vexAllRows.length)}function Do(e){const n=document.getElementById("vex-task-pager"),a=document.getElementById("vex-task-pager-info"),o=document.getElementById("vex-task-prev"),s=document.getElementById("vex-task-next");if(!n)return;if(e<=Et){n.style.display="none";return}n.style.display="";const i=Math.ceil(e/Et);a&&(a.textContent=H.vexPage+" / "+i),o&&(o.disabled=H.vexPage<=1),s&&(s.disabled=H.vexPage>=i)}function id(e){const n=document.getElementById("vex-task-tbody");if(!n)return;const a={pending:t("vex-status-pending")||"待处理",running:t("vex-status-running")||"处理中",done:t("vex-status-done")||"已完成",failed:t("vex-status-failed")||"失败"},o={pending:"badge-gray",running:"badge-blue",done:"badge-green",failed:"badge-red"},s='<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M8 2v9M4 7l4 4 4-4M3 14h10"/></svg>',i='<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M3 4h10M6 4V3h4v1M5 4v8a1 1 0 001 1h4a1 1 0 001-1V4"/></svg>';n.innerHTML=e.map(r=>{const c=r.created_at?new Date(r.created_at).toLocaleString([],{year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",minute:"2-digit"}):"—",m=r.period||"—",d=r.matched_count!=null?r.matched_count+" ✓ · "+r.mismatched_count+" ⚠":"—",u=r.mismatch_amount!=null?"฿ "+Number(r.mismatch_amount).toLocaleString():"—",l=r.elapsed_seconds!=null?r.elapsed_seconds.toFixed(1)+" s":"—",p=r.status||"pending",f=r.client_name&&r.client_name!=="client"?r.client_name:t("vex-client-all")||"全部客户";return`<tr class="vex-task-row" data-task-id="${_e(r.id)}" style="cursor:pointer">
        ...
        </tr>`}).join(""),n.querySelectorAll(".vex-task-dl-btn").forEach(r=>{r.addEventListener("click",async c=>{c.stopPropagation();const m=r.dataset.taskId;try{const d=await fetch("/api/vat_excel/tasks/"+encodeURIComponent(m)+"/download",{credentials:"include",headers:mt()});if(d.status===410){showToast(t("vex-toast-expired")||"数据已过期 · 请重新对账","warn");return}if(!d.ok){showToast(t("vex-toast-dl-fail")||"下载失败 · 请重试","error");return}const u=await d.blob(),p=(d.headers.get("Content-Disposition")||"").match(/filename\*?=(?:UTF-8''|")?([^";]+)/i),f=p?decodeURIComponent(p[1]):"vat_recon_"+m+".xlsx",v=URL.createObjectURL(u),w=document.createElement("a");w.href=v,w.download=f,w.click(),setTimeout(()=>URL.revokeObjectURL(v),1e3)}catch{showToast(t("vex-toast-dl-fail")||"下载失败 · 请重试","error")}})}),n.querySelectorAll(".vex-task-del-btn").forEach(r=>{r.addEventListener("click",c=>{c.stopPropagation(),ld(r.dataset.taskId)})}),Gs()}function rd(){var e=document.getElementById("vex-task-prev"),n=document.getElementById("vex-task-next");e&&!e._vexBound&&(e._vexBound=!0,e.addEventListener("click",function(){H.vexPage>1&&(H.vexPage--,_n())})),n&&!n._vexBound&&(n._vexBound=!0,n.addEventListener("click",function(){var a=Math.ceil(H.vexAllRows.length/Et);H.vexPage<a&&(H.vexPage++,_n())}))}async function ld(e){const n=t("vex-task-delete-confirm-title")||"删除对账任务?",a=t("vex-task-delete-confirm-body")||"同时清掉对应的发票识别缓存 · 不可恢复";if(await showConfirm(a,{title:n,danger:!0,okText:t("vex-task-delete-confirm-title")||"确认删除"}))try{const s=await fetch("/api/vat_excel/tasks/"+encodeURIComponent(e),{method:"DELETE",credentials:"include",headers:mt()});if(!s.ok)throw new Error(s.status);showToast(t("vex-task-delete-ok")||"已删除","success"),hn(),vn()}catch{showToast(t("vex-task-delete-fail")||"删除失败","error")}}function Ks(e){const n=window._currentLang||"th",a={zh:`已忽略 ${e} 个不支持的文件 · 仅支持 PDF / 图片 / Excel / CSV / Word`,th:`ข้ามไฟล์ที่ไม่รองรับ ${e} ไฟล์ · รองรับเฉพาะ PDF / รูปภาพ / Excel / CSV / Word`,en:`Ignored ${e} unsupported file(s) · only PDF / image / Excel / CSV / Word are supported`,ja:`非対応ファイル ${e} 件をスキップ · 対応形式は PDF / 画像 / Excel / CSV / Word のみ`};showToast(a[n]||a.th,"warn")}function cd(e){const n=new Set(H.invoiceFiles.map(o=>o.name+"|"+o.size));let a=0;for(const o of e){if(!Ga.test(o.name)){a++;continue}const s=o.name+"|"+o.size;if(!n.has(s)&&(n.add(s),H.invoiceFiles.push(o),H.invoiceFiles.length>=Wn))break}a>0&&Ks(a),H.invoiceFiles.length>Wn&&(H.invoiceFiles=H.invoiceFiles.slice(0,Wn),showToast(t("vex-toast-cap-inv"),"warn")),nt()}function dd(e){const n=new Set(H.reportFiles.map(o=>o.name+"|"+o.size));let a=0;for(const o of e){if(!Ga.test(o.name)){a++;continue}const s=o.name+"|"+o.size;if(!n.has(s)&&(n.add(s),H.reportFiles.push(o),H.reportFiles.length>=Yn))break}a>0&&Ks(a),H.reportFiles.length>Yn&&(H.reportFiles=H.reportFiles.slice(0,Yn),showToast(t("vex-toast-cap-rep"),"warn")),nt()}function Ws(e){H.invoiceFiles.splice(e,1),nt()}function Ys(e){H.reportFiles.splice(e,1),nt()}function nt(){const e=X("vex-list-invoice"),n=X("vex-list-report"),a=X("vex-count-invoice"),o=X("vex-count-report");a&&(a.textContent=H.invoiceFiles.length),o&&(o.textContent=H.reportFiles.length);const s=(c,m,d)=>`<div class="vex-fi">
        ...
        <span class="vex-fi-s">${Us(c.size)}</span>
        <button class="vex-fi-x" type="button" data-vex-kind="${d}" data-vex-idx="${m}" aria-label="remove">×</button>
    </div>`;e&&(e.innerHTML=H.invoiceFiles.map((c,m)=>s(c,m,"inv")).join("")||'<div class="vex-fi-empty" data-i18n="vex-no-files">还没文件</div>'),n&&(n.innerHTML=H.reportFiles.map((c,m)=>s(c,m,"rep")).join("")||'<div class="vex-fi-empty" data-i18n="vex-no-files">还没文件</div>'),document.querySelectorAll(".vex-fi-x").forEach(c=>{c.addEventListener("click",m=>{const d=c.dataset.vexKind,u=parseInt(c.dataset.vexIdx,10);d==="inv"?Ws(u):Ys(u)})});const i=H.invoiceFiles.length>0&&H.reportFiles.length>0;X("vex-build").disabled=!i||H.running;const r=X("vex-action-info");r&&(!H.invoiceFiles.length||!H.reportFiles.length?(r.textContent=t("vex-need-both")||"需要至少 1 张发票 + 1 份 VAT 报告",r.className="vex-action-info muted"):(r.textContent=(t("vex-ready")||"已就绪 · {a} 张发票 · {b} 份报告").replace("{a}",H.invoiceFiles.length).replace("{b}",H.reportFiles.length),r.className="vex-action-info ok")),pa()}const pd='<svg class="vex-pp-fi-icon" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#6B7280" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path><polyline points="14 2 14 8 20 8"></polyline></svg>',ud='<svg class="vex-pp-fi-icon" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#111111" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="4" width="18" height="18" rx="2" ry="2"></rect><line x1="16" y1="2" x2="16" y2="6"></line><line x1="8" y1="2" x2="8" y2="6"></line><line x1="3" y1="10" x2="21" y2="10"></line></svg>',fd='<svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg>';function pa(){const e=X("vex-preview-panel");if(!e||e.style.display==="none")return;Ro("inv"),Ro("rep");const n=X("vex-pp-guide");n&&(n.style.display=H.invoiceFiles.length>100?"flex":"none")}function Ro(e){const n=X(e==="inv"?"vex-pp-invoice-col":"vex-pp-report-col");if(!n)return;const a=e==="inv"?H.invoiceFiles:H.reportFiles,o=e==="inv"?H.previewSearchInv:H.previewSearchRep,s=t(e==="inv"?"vex-preview-invoice":"vex-preview-report")||(e==="inv"?"销售发票":"VAT 报告"),i=_e(t("vex-preview-search")||"搜索文件名..."),r=_e(t("vex-preview-clear-all")||"全清");n.innerHTML=`
        ...
        <table style="width:100%;border-collapse:collapse;font-size:12px;margin-bottom:4px">
          ...
          <td class="num">${i.stmt_withdrawal?We(i.stmt_withdrawal):""}</td>
          <td class="num">${i.stmt_deposit?We(i.stmt_deposit):""}</td>
          <td>${le(No(i.gl_date))}</td>
          ...
          <td class="num">${i.gl_debit?We(i.gl_debit):""}</td>
          <td class="num">${i.gl_credit?We(i.gl_credit):""}</td>
          <td>${c?"L"+c:"—"}</td>
        </tr>`}).join("")}async function Yt(){const e=localStorage.getItem("mrpilot_token")||"";try{const a=await(await fetch("/api/recon/bank-v2/tasks",{headers:{Authorization:"Bearer "+e}})).json();In(a.tasks||[])}catch{const a=A("brv2-history-empty"),o=window._currentLang||"zh",s={zh:"加载失败",th:"โหลดประวัติไม่ได้",en:"Load failed",ja:"読み込み失敗"}[o]||"加载失败";a&&(a.textContent=s,a.style.display="");const i=A("brv2-history-table-wrap");i&&(i.style.display="none")}}const It=10;function Oo(){const e=A("brv2-history-pager"),n=A("brv2-history-pager-info"),a=A("brv2-history-prev"),o=A("brv2-history-next");if(!e)return;if(P.cachedHistoryTasks.length<=It){e.style.display="none";return}e.style.display="";const s=Math.ceil(P.cachedHistoryTasks.length/It);n&&(n.textContent=P.brv2Page+" / "+s),a&&(a.disabled=P.brv2Page<=1),o&&(o.disabled=P.brv2Page>=s)}function Xd(){const e=A("brv2-history-prev"),n=A("brv2-history-next");e&&!e._brv2Bound&&(e._brv2Bound=!0,e.addEventListener("click",()=>{P.brv2Page>1&&(P.brv2Page--,In(P.cachedHistoryTasks))})),n&&!n._brv2Bound&&(n._brv2Bound=!0,n.addEventListener("click",()=>{const a=Math.ceil(P.cachedHistoryTasks.length/It);P.brv2Page<a&&(P.brv2Page++,In(P.cachedHistoryTasks))}))}function In(e){e!==void 0&&(P.cachedHistoryTasks=e||[],P.brv2Page=1);const n=P.cachedHistoryTasks,a=A("brv2-history-empty"),o=A("brv2-history-table-wrap"),s=A("brv2-history-tbody");if(!s)return;const i=window._currentLang||"zh";if(!n.length){const f={zh:"暂无对账记录",th:"ยังไม่มีประวัติ",en:"No records yet",ja:"記録なし"}[i]||"暂无对账记录";a&&(a.textContent=f,a.style.display=""),o&&(o.style.display="none"),Oo();return}a&&(a.style.display="none"),o&&(o.style.display="");const r=Math.ceil(n.length/It);P.brv2Page>r&&(P.brv2Page=r);const c=(P.brv2Page-1)*It,m=n.slice(c,c+It),d=localStorage.getItem("mrpilot_token")||"",u='<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" width="14" height="14"><circle cx="8" cy="8" r="6"/><polyline points="6 8 8 10 10 8"/><line x1="8" y1="4" x2="8" y2="10"/></svg>',l='<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" width="14" height="14"><path d="M8 2v9M4 7l4 4 4-4M3 14h10"/></svg>',p='<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" width="14" height="14"><polyline points="3 4 13 4"/><path d="M6 4V2.5a.5.5 0 0 1 .5-.5h3a.5.5 0 0 1 .5.5V4"/><path d="M5 4l1 9a1 1 0 0 0 1 1h2a1 1 0 0 0 1-1l1-9"/></svg>';s.innerHTML="",m.forEach(f=>{const v=Number(f.formula_diff||0),w=Math.abs(v)<.05,b=(f.stmt_files||"").split(";").map(ae=>ae.trim().split(/[/\\]/).pop()).filter(Boolean).join(", "),g=(f.gl_files||"").split(";").map(ae=>ae.trim().split(/[/\\]/).pop()).filter(Boolean).join(", "),h=f.created_at?String(f.created_at).slice(0,16).replace("T"," "):"",_=document.createElement("tr");_.dataset.taskId=f.id;const y=document.createElement("td");y.textContent=h;const k=document.createElement("td");k.className="glv-history-file",k.title=b+" + "+g,k.textContent=b+" + "+g;const x=document.createElement("td");x.className="glv-num",x.textContent=(f.stmt_row_count||0)+" / "+(f.gl_row_count||0);const E=document.createElement("td");E.className="glv-num",E.textContent=f.matched_count||0;const L=document.createElement("td");L.className="glv-num",L.textContent=f.unmatched_gl||0;const I=document.createElement("td");I.className="glv-num",I.textContent=f.unmatched_stmt||0;const B=document.createElement("td");B.className="glv-num",B.style.color=w?"#059669":"#dc2626",B.textContent=w?"✓":We(v);const C=document.createElement("td");C.className="glv-history-actions";const S=(ae,ue,oe,z)=>{const F=document.createElement("button");return F.type="button",F.title=ue,F.setAttribute("aria-label",ue),oe&&(F.className=oe),F.innerHTML=ae,F.onclick=U=>{U.stopPropagation(),z()},F},$={zh:"删除这条记录?",th:"ลบรายการนี้?",en:"Delete this record?",ja:"この記録を削除しますか?"}[i]||"删除?",j={zh:"加载",th:"โหลด",en:"Load",ja:"読込"}[i]||"加载",N={zh:"导出",th:"ส่งออก",en:"Export",ja:"エクスポート"}[i]||"导出",Z={zh:"删除",th:"ลบ",en:"Delete",ja:"削除"}[i]||"删除";C.appendChild(S(u,j,"",()=>Vo(f.id,d))),C.appendChild(S(l,N,"",()=>ti(f.id))),C.appendChild(S(p,Z,"glv-del",async()=>{await showConfirm($,{danger:!0})&&(await fetch("/api/recon/bank-v2/"+f.id,{method:"DELETE",headers:{Authorization:"Bearer "+d}}),Yt())})),[y,k,x,E,L,I,B,C].forEach(ae=>_.appendChild(ae)),_.style.cursor="pointer",_.addEventListener("click",async ae=>{ae.target.closest(".glv-del")||ae.target.closest("button")||await Vo(f.id,d)}),s.appendChild(_)}),Oo(),ai()}function ai(){const e=((A("brv2-hist-search")||{}).value||"").trim().toLowerCase(),n=A("brv2-history-tbody");n&&n.querySelectorAll("tr").forEach(a=>{a.dataset.taskId&&(a.style.display=!e||a.textContent.toLowerCase().includes(e)?"":"none")})}async function Vo(e,n){try{const o=await(await fetch("/api/recon/bank-v2/"+e,{headers:{Authorization:"Bearer "+n}})).json();if(!o.ok)return;P.currentTask={task_id:o.task_id,...o},P.allRows=o.detail||[],P.currentFilter="all",document.querySelectorAll(".brv2-filter-btn").forEach(s=>s.classList.toggle("active",s.dataset.filter==="all")),Ja(P.currentTask)}catch{}}function Pe(e){const n=e==="stmt"?P.stmtFiles:P.glFiles,a=A(`brv2-${e}-name`);if(a)if(n.length===0)a.textContent="";else{const s=window._currentLang||"zh",i={zh:"个文件",th:" ไฟล์",en:" file(s)",ja:" ファイル"};a.textContent=n.length+(i[s]||" 个文件")}const o=A("brv2-preview-panel");o&&o.style.display!=="none"&&fa(e),Zd()}function Zd(){const e=A("brv2-toggle-preview"),n=A("brv2-preview-panel"),a=P.stmtFiles.length+P.glFiles.length>0;e&&(e.style.display=a?"":"none"),!a&&n&&(n.style.display="none",e&&e.classList.remove("open"))}function Qd(){fa("stmt"),fa("gl")}function fa(e){const n=A(e==="stmt"?"brv2-pp-stmt-col":"brv2-pp-gl-col");if(!n)return;const a=e==="stmt"?P.stmtFiles:P.glFiles,o=window._currentLang||"zh",s={stmt:{zh:"① 银行账单",th:"① บัญชีธนาคาร",en:"① Bank Stmt",ja:"① 銀行明細"},gl:{zh:"② 总账 GL",th:"② GL รายงาน",en:"② GL Report",ja:"② GL帳簿"}},i=(s[e]||{})[o]||s[e].zh,r=le(window.t&&window.t("vex-preview-search")||"搜索文件名..."),c=le(window.t&&window.t("vex-preview-clear-all")||"全清"),m=P.brv2Search[e]||"";n.innerHTML='<div class="vex-pp-col-title"><span class="vex-pp-col-name">'+le(i)+' <span class="vex-pp-col-count">'+a.length+'</span></span></div><div class="vex-pp-search-row"><input class="vex-pp-search" id="brv2-pp-search-'+e+'" type="text" placeholder="'+r+'" value="'+le(m)+'" autocomplete="off"><button class="vex-pp-clear-btn" id="brv2-pp-clearall-'+e+'" type="button">'+c+'</button></div><div class="vex-pp-file-list" id="brv2-pp-'+e+'-list"></div><div class="vex-pp-pagination" id="brv2-pp-'+e+'-pg"></div>';const d=A("brv2-pp-search-"+e);d&&d.addEventListener("input",function(l){P.brv2Search[e]=l.target.value,Uo(e)});const u=A("brv2-pp-clearall-"+e);u&&u.addEventListener("click",function(){e==="stmt"?P.stmtFiles.length=0:P.glFiles.length=0,Pe(e),Ye()}),Uo(e)}function Uo(e){const n=A("brv2-pp-"+e+"-list"),a=A("brv2-pp-"+e+"-pg");if(!n)return;const o=e==="stmt"?P.stmtFiles:P.glFiles,s=(P.brv2Search[e]||"").toLowerCase(),i=s?o.filter(m=>m.name.toLowerCase().includes(s)):o.slice(),r='<svg class="vex-pp-fi-ico" viewBox="0 0 14 16" fill="none" stroke="currentColor" stroke-width="1.4" width="12" height="14"><path d="M3 1h6l3 3v11H3V1z"/><path d="M9 1v3h3"/></svg>',c='<svg viewBox="0 0 14 14" fill="none" stroke="currentColor" stroke-width="1.6" width="11" height="11"><path d="M2 4h10M5 4V2h4v2M5.5 7v4M8.5 7v4M3 4l1 8h6l1-8"/></svg>';if(n.innerHTML=i.map((m,d)=>'<div class="vex-pp-file-row">'+r+'<span class="vex-pp-fi-name" title="'+le(m.name)+'">'+le(m.name)+'</span><span class="vex-pp-fi-size">'+Nd(m.size)+'</span><button class="vex-pp-fi-del" type="button" data-zone="'+e+'" data-idx="'+o.indexOf(m)+'" aria-label="remove">'+c+"</button></div>").join(""),n.querySelectorAll(".vex-pp-fi-del").forEach(function(m){m.addEventListener("click",function(){const d=parseInt(m.dataset.idx,10);m.dataset.zone==="stmt"?P.stmtFiles.splice(d,1):P.glFiles.splice(d,1),Pe(m.dataset.zone),Ye()})}),a){const m=window.t&&window.t("vex-preview-count")||"显示 {n} / 共 {m}";a.textContent=m.replace("{n}",i.length).replace("{m}",o.length)}}function ep(){const e=A("brv2-toggle-preview");e&&!e._reconBound&&(e._reconBound=!0,e.addEventListener("click",function(){const n=A("brv2-preview-panel"),a=A("brv2-toggle-preview-label"),o=n&&n.style.display!=="none";n&&(n.style.display=o?"none":""),e.classList.toggle("open",!o),a&&(a.textContent=o?window.t&&window.t("vex-toggle-preview-open")||"查看清单":window.t&&window.t("vex-toggle-preview-close")||"收起清单"),o||Qd()}))}function Ye(){const e=A("brv2-run-btn"),n=A("brv2-status"),a=P.stmtFiles.length>0,o=P.glFiles.length>0;if(e&&(e.disabled=!(a&&o)),n){const s=window._currentLang||"zh";if(!a&&!o){const i={zh:"请上传银行账单和 GL 文件",th:"กรุณาอัปโหลดบัญชีธนาคารและ GL",en:"Upload bank statement and GL files",ja:"銀行明細と GL を両方アップロードしてください"};n.textContent=i[s]||i.zh}else if(a)if(o){const i={zh:"两份文件已就绪",th:"พร้อมสอบทาน",en:"Ready to reconcile",ja:"照合を開始できます"};n.textContent=i[s]||i.zh}else{const i={zh:"还缺 GL 文件",th:"ยังขาดไฟล์ GL",en:"Missing GL file",ja:"GL ファイルが未アップロード"};n.textContent=i[s]||i.zh}else{const i={zh:"还缺银行账单 PDF",th:"ยังขาดไฟล์บัญชีธนาคาร PDF",en:"Missing bank statement PDF",ja:"銀行明細 PDF が未アップロード"};n.textContent=i[s]||i.zh}}}function Go(e,n,a){const o=A(e),s=A(n);!o||!s||(o.addEventListener("click",()=>s.click()),o.addEventListener("keydown",i=>{(i.key==="Enter"||i.key===" ")&&(i.preventDefault(),s.click())}),o.addEventListener("dragover",i=>{i.preventDefault(),o.classList.add("drag-over")}),o.addEventListener("dragleave",()=>o.classList.remove("drag-over")),o.addEventListener("drop",i=>{i.preventDefault(),o.classList.remove("drag-over");const r=Array.from(i.dataTransfer.files||[]);a==="stmt"?P.stmtFiles.push(...r):P.glFiles.push(...r),Pe(a),Ye()}),s.addEventListener("change",()=>{const i=Array.from(s.files||[]);a==="stmt"?P.stmtFiles.push(...i):P.glFiles.push(...i),s.value="",Pe(a),Ye()}))}function Ee(e){const n=A("brv2-progress"),a=A("brv2-run-btn"),o=A("brv2-error");n&&(n.style.display=e?"":"none"),a&&(a.disabled=e),o&&(o.style.display="none")}function je(e){const n=A("brv2-error");n&&(n.textContent=e,n.style.display="",n.scrollIntoView({behavior:"smooth",block:"nearest"})),Ee(!1),Ye(),window.showToast&&window.showToast(e,"error")}async function ma(){if(P.stmtFiles.length===0||P.glFiles.length===0)return;const e=localStorage.getItem("mrpilot_token")||"",n=window._currentLang||"zh",a=(A("brv2-acct-select")||{}).value||"";Ln(!1),Ee(!0);try{const o=new FormData;P.stmtFiles.forEach(f=>o.append("stmt_files",f)),P.glFiles.forEach(f=>o.append("gl_files",f)),o.append("gl_account",a),o.append("lang",n);const s=parseFloat((A("brv2-anchor-gl-closing")||{}).value),i=parseFloat((A("brv2-anchor-stmt-closing")||{}).value),r=parseFloat((A("brv2-anchor-stmt-opening")||{}).value),c=parseFloat((A("brv2-anchor-gl-opening")||{}).value);Number.isFinite(s)&&o.append("gl_closing_override",s),Number.isFinite(i)&&o.append("stmt_closing_override",i),Number.isFinite(r)&&o.append("stmt_opening_override",r),Number.isFinite(c)&&o.append("gl_opening_override",c);const m=await fetch("/api/recon/bank-v2/submit",{method:"POST",headers:{Authorization:"Bearer "+e},body:o});let d=null;try{d=await m.json()}catch{d=null}if(d&&d.needs_mapping){Ee(!1),window.ReconMapping?window.ReconMapping.show(d,{token:e,lang:n,onConfirmed:function(){ma()}}):je(t("brv2-err-server")||"服务器繁忙,请稍后重试");return}if(!m.ok||!d||!d.ok||!d.job_id){Ee(!1),d&&(d.detail||d.error)?je(_humanizeBackendError(d.detail||d.error,"Error "+m.status)):je(t("brv2-err-server")||"服务器繁忙,请稍后重试");return}const u=A("brv2-progress-sub"),l=await window._reconPollJob(d.job_id,e,{onProgress:f=>{u&&(u.textContent=window._reconProgressText(f,n))}});if(l&&l.status==="needs_mapping"&&l.mapping){Ee(!1),window.ReconMapping?window.ReconMapping.show(l.mapping,{token:e,lang:n,onConfirmed:function(){ma()}}):je(t("brv2-err-server")||"服务器繁忙,请稍后重试");return}if(l&&l.status==="needs_review"&&l.review){Ee(!1),window.ReconReview?window.ReconReview.show(l.review,{token:e,lang:n,jobId:d.job_id,onConfirmed:async function(f){Ee(!0);const v=await window._reconPollJob(f,e,{onProgress:w=>{u&&(u.textContent=window._reconProgressText(w,n))}});await p(v)}}):je(t("brv2-err-server")||"服务器繁忙,请稍后重试");return}if(l&&l.status==="failed"){Ee(!1),je(zd(l.error_code,n));return}await p(l);async function p(f){try{if(!f||f.status!=="done"||!f.result_id){Ee(!1),je(t("brv2-err-server")||"服务器繁忙,请稍后重试");return}const v=await fetch("/api/recon/bank-v2/"+encodeURIComponent(f.result_id),{headers:{Authorization:"Bearer "+e}});let w=null;try{w=await v.json()}catch{w=null}if(!v.ok||w===null||!w.ok){Ee(!1),je(t("brv2-err-server")||"服务器繁忙,请稍后重试");return}(w.gl_accounts||[]).length>1&&tp(w.gl_accounts),P.currentTask=w,P.allRows=w.detail||[],P.currentFilter="all",document.querySelectorAll(".brv2-filter-btn").forEach(g=>g.classList.toggle("active",g.dataset.filter==="all")),Od(w&&w.summary),Ee(!1),Ja(w),Yt();const b=A("brv2-summary-collapse");b&&b.scrollIntoView({behavior:"smooth",block:"nearest"})}catch(v){Ee(!1),je(v.message||"Network error")}}}catch(o){je(o.message||"Network error")}}function tp(e){const n=A("brv2-acct-select");if(!n)return;const a=window._currentLang||"zh",o={zh:"全部账户",th:"ทุกบัญชี",en:"All Accounts",ja:"すべての口座"}[a]||"全部账户";n.innerHTML=`<option value="">${o}</option>`+e.map(s=>`<option value="${le(s)}">${le(s)}</option>`).join(""),n.style.display=""}function Xa(){if(P.initialized){Yt();return}P.initialized=!0,Go("brv2-stmt-zone","brv2-stmt-input","stmt"),Go("brv2-gl-zone","brv2-gl-input","gl");const e=["brv2-anchor-gl-closing","brv2-anchor-stmt-closing","brv2-anchor-stmt-opening","brv2-anchor-gl-opening"];function n(){const c=parseFloat((A("brv2-anchor-stmt-opening")||{}).value),m=parseFloat((A("brv2-anchor-gl-opening")||{}).value),d=A("brv2-anchor-eq"),u=A("brv2-anchor-eq-val");if(!(!d||!u))if(Number.isFinite(c)&&Number.isFinite(m)){const l=c-m;u.textContent=l.toLocaleString(void 0,{minimumFractionDigits:2,maximumFractionDigits:2}),d.style.display=""}else d.style.display="none"}e.forEach(c=>{const m=A(c);m&&(m.addEventListener("input",n),m.addEventListener("input",()=>{const d=m.closest(".brv2-anchor-cell");d&&d.classList.remove("is-prefilled"),Gd()}))}),Ud();const a=A("brv2-run-btn");a&&a.addEventListener("click",ma);const o=A("brv2-reset-btn");o&&o.addEventListener("click",()=>{P.currentTask=null,P.allRows=[],P.stmtFiles=[],P.glFiles=[],Pe("stmt"),Pe("gl"),Ye(),Ln(!1);const c=A("brv2-acct-select");c&&(c.style.display="none"),e.forEach(u=>{const l=A(u);if(l){l.value="";const p=l.closest&&l.closest(".brv2-anchor-cell");p&&p.classList.remove("is-prefilled")}});const m=A("brv2-anchor-eq");m&&(m.style.display="none");const d=A("brv2-anchor-prefill-banner");d&&d.classList.remove("show")});const s=A("brv2-new-btn");s&&s.addEventListener("click",()=>{P.currentTask=null,P.allRows=[],P.stmtFiles=[],P.glFiles=[],Pe("stmt"),Pe("gl"),Ye(),Ln(!1)});const i=A("brv2-filter-tabs");i&&i.addEventListener("click",c=>{c.stopPropagation();const m=c.target.closest(".brv2-filter-btn");m&&(P.currentFilter=m.dataset.filter,i.querySelectorAll(".brv2-filter-btn").forEach(d=>d.classList.toggle("active",d===m)),ni())}),ep(),Xd();const r=A("brv2-hist-search");r&&r.addEventListener("input",ai),Yt(),Ye(),window._brv2LoadHistory=Yt,Array.isArray(window.__i18nSubs)||(window.__i18nSubs=[]),window.__i18nSubs=window.__i18nSubs.filter(c=>c.name!=="brv2"),window.__i18nSubs.push({name:"brv2",fn:function(){Ye(),Pe("stmt"),Pe("gl"),P.currentTask&&Ja(P.currentTask),In()}})}window._loadBankReconV2Panel=function(e){const n=e?document.getElementById(e):null;n&&n.id!=="recon-pane-bank"&&(n.innerHTML=`<div style="padding:16px;font-size:13px;color:var(--ink-3)">
            银行对账 v2 · 请前往对账中心使用</div>`),Xa()};document.addEventListener("DOMContentLoaded",()=>{A("brv2-run-btn")&&Xa()});window._bankReconV2Init=Xa;(function(){const e=document.getElementById("general-lang");if(!e)return;e.addEventListener("change",a=>{const o=a.target.value;o&&applyLang(o)});const n=typeof currentLang=="string"&&currentLang||localStorage.getItem("mrpilot_lang")||"th";e.value=n})();(function(){const n="pearnly_general_tz",a="pearnly_general_date_format",o="pearnly_general_number_format",s={tz:"Asia/Bangkok",date:"YYYY-MM-DD",number:"comma_dot"};function i(){const d=document.getElementById("general-tz"),u=document.getElementById("general-date"),l=document.getElementById("general-number");if(!(!d||!u||!l))try{d.value=localStorage.getItem(n)||s.tz,u.value=localStorage.getItem(a)||s.date,l.value=localStorage.getItem(o)||s.number}catch{d.value=s.tz,u.value=s.date,l.value=s.number}}async function r(){const d=document.getElementById("btn-save-general"),u=document.getElementById("general-save-msg");if(!d)return;const l=d.innerHTML;d.disabled=!0,d.innerHTML="<span>"+(t("msg-saving")||"保存中...")+"</span>",u&&(u.textContent="",u.classList.remove("error"));try{const p=(document.getElementById("general-tz")||{}).value||s.tz,f=(document.getElementById("general-date")||{}).value||s.date,v=(document.getElementById("general-number")||{}).value||s.number;try{localStorage.setItem(n,p),localStorage.setItem(a,f),localStorage.setItem(o,v)}catch{}window._pearnlyGeneral={tz:p,date_format:f,number_format:v},u&&(u.textContent=t("msg-saved")||"已保存")}catch{u&&(u.textContent=t("msg-save-failed")||"保存失败",u.classList.add("error"))}finally{d.disabled=!1,d.innerHTML=l,setTimeout(function(){u&&(u.textContent="")},3e3)}}function c(){const d=document.getElementById("btn-save-general");if(!d){setTimeout(c,200);return}d._pearnlyGenBound||(d._pearnlyGenBound=!0,d.addEventListener("click",r),i())}function m(){i();const d=document.getElementById("general-lang");if(d){const u=typeof currentLang=="string"&&currentLang||localStorage.getItem("mrpilot_lang")||"th";d.value=u}}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",c):c(),typeof window.subscribeI18n=="function"&&window.subscribeI18n("settings-general",m)})();(function(){const e="mrpilot_nav_collapsed",n={ocr:"sales",history:"sales",reconcile:"sales","sales-invoices":"sales",receivables:"sales",vouchers:"expense"};function a(){try{const r=localStorage.getItem(e);return r?JSON.parse(r):{}}catch{return{}}}function o(r){try{localStorage.setItem(e,JSON.stringify(r))}catch{}}function s(){const r=a();document.querySelectorAll(".nav-collapsible").forEach(function(c){const m=c.dataset.collapsible;r[m]?c.classList.add("collapsed"):c.classList.remove("collapsed")})}function i(r){const c=a();c[r]=!c[r],o(c),s()}(function(){const c=a();let m=!1;c.sales===void 0&&(c.sales=!1,m=!0),c.expense===void 0&&(c.expense=!0,m=!0),m&&o(c)})(),s(),document.querySelectorAll(".nav-group-toggle").forEach(function(r){r.addEventListener("click",function(){i(r.dataset.toggleGroup)})}),window.expandNavGroupForRoute=function(r){const c=n[r];if(!c)return;const m=a();m[c]&&(m[c]=!1,o(m),s())}})();const np=`
    ...
    `,document.body.appendChild(n),n.addEventListener("click",async a=>{if(a.target===n||a.target.classList.contains("log-detail-close")){n.remove();return}const o=a.target.closest("[data-receipt-copy]");if(o){ci(o.dataset.receiptCopy);return}const s=a.target.closest("[data-receipt-action]");if(s){const i=s.dataset.receiptAction;i==="retry"?window.retryPushLog(s.dataset.logId):i==="exceptions"?typeof routeTo=="function"&&routeTo("exceptions"):i==="mappings"&&typeof routeTo=="function"&&routeTo("integrations"),n.remove();return}});try{const a=await fetch(`/api/erp/logs/${encodeURIComponent(e)}`,{headers:{Authorization:"Bearer "+token}});if(!a.ok){n.remove();return}const o=await a.json(),s=window._erpEndpoints.find(S=>S.id===o.endpoint_id),i=o.endpoint_name||(s?s.name:o.endpoint_id?t("erp-log-endpoint-deleted"):"-"),r=(o.endpoint_adapter||s&&s.adapter||"").toLowerCase(),c=new Date(o.created_at).toLocaleString(),m=o.trigger==="auto"?t("log-tag-auto"):o.trigger==="retry"?t("log-tag-retry"):t("log-tag-manual"),d=o.request_body?JSON.stringify(o.request_body,null,2):t("erp-receipt-no-tech"),u=o.response_body||t("erp-receipt-no-tech"),l=o.status==="success";let p=typeof u=="string"?u:JSON.stringify(u,null,2);if(l)try{const S=typeof o.response_body=="string"?JSON.parse(o.response_body):o.response_body||{},$=S.row_count||(Array.isArray(S.imported_rows)?S.imported_rows.length:0);$>0&&(p=t("log-push-rows").replace("{n}",String($)))}catch{}const f=(o.external_doc_no||"").trim(),v=(o.external_url||"").trim(),w=(o.external_doc_hint||"").trim(),b=(o.ocr_buyer_name||"").trim()||o.client_name||"-",g=o.seller_name||"-",h=o.push_type==="id_card";let _="-";const y=Number(o.total_amount);o.total_amount!=null&&o.total_amount!==""&&!isNaN(y)&&(_=y.toLocaleString("en-US",{minimumFractionDigits:2,maximumFractionDigits:2}));const k=l?t("erp-receipt-title-ok"):t("erp-receipt-title-fail"),x=l?"✓":"✗",E=[],L=(S,$)=>{E.push(`
        ...
        `}catch(a){console.error(a),n.remove()}}window.copyErpDocNo=ci;window.showLogDetail=rp;const lp=`
        <div class="modal">
            <div class="modal-head">
    ...
    `;be("endpoint-modal",lp);let Nt={key:"all",val:""},Jt="",Zn=!1,Ue=new Set;window._erpSelected=Ue;async function cp(){const e=document.getElementById("erp-logs-erp-select");if(!(!e||Zn)){Zn=!0;try{let n=window._erpEndpoints;if(!Array.isArray(n)||n.length===0){const s=await fetch("/api/erp/endpoints",{headers:{Authorization:"Bearer "+token}});if(s.ok){const i=await s.json();n=i&&(i.items||i)||[]}}Array.isArray(n)||(n=[]);const a=new Set,o=[];n.forEach(s=>{const i=(s&&s.adapter||"").toLowerCase();!i||a.has(i)||(a.add(i),o.push({val:i,label:s&&s.name||i}))}),e.innerHTML=`<option value="">${escapeHtml(t("erp-logs-erp-all"))}</option>`+o.map(s=>`<option value="${escapeHtml(s.val)}"${s.val===Jt?" selected":""}>${escapeHtml(s.label)}</option>`).join("")}catch{Zn=!1}}}async function Bt(e){const n=document.getElementById("erp-logs-list");if(n){e||(n.innerHTML=`<div class="erp-logs-empty">${escapeHtml(t("erp-logs-loading"))}</div>`),window.loadErpTodayStats(),cp();try{const a=new URLSearchParams({limit:"30"});Nt.key==="status"&&a.set("status",Nt.val),Nt.key==="trigger"&&a.set("trigger",Nt.val),Jt&&a.set("adapter",Jt);const o=await fetch(`/api/erp/logs?${a}`,{headers:{Authorization:"Bearer "+token}});if(!o.ok){n.innerHTML=`<div class="erp-logs-empty">${escapeHtml(t("erp-logs-error"))}</div>`;return}const i=(await o.json()).items||[];if(window._erpLogPollTimer&&(clearTimeout(window._erpLogPollTimer),window._erpLogPollTimer=null),i.some(function(f){return f.status==="pending"})&&(window._erpLogPollTimer=setTimeout(function(){Bt(!0)},4e3)),i.length===0){n.innerHTML=`<div class="erp-logs-empty">${escapeHtml(t("erp-logs-empty"))}</div>`;return}const r=i.filter(function(f){var v=f.status==="failed"&&f.next_retry_at&&new Date(f.next_retry_at).getTime()>Date.now()-6e4;return!v}).map(function(f){return f.id}),c=Jt==="mrerp_dms",m=c?t("erp-log-col-booking"):t("erp-log-col-invoice"),d=c?t("erp-log-col-customer"):t("erp-log-col-seller"),u=c?t("erp-log-col-idcard"):t("erp-log-col-client"),l='<div class="erp-log-row erp-log-row-header" data-log-header>'+(r.length>0?`<input type="checkbox" class="erp-log-cb erp-log-cb-all" data-log-select-all title="${escapeHtml(t("erp-log-select-all-tip"))}">`:'<span class="erp-log-cb-spacer"></span>')+`<span class="log-time">${escapeHtml(t("erp-log-col-time"))}</span><span class="log-status">${escapeHtml(t("erp-log-col-status"))}</span><span class="log-tag-header">${escapeHtml(t("erp-log-col-trigger"))}</span><span class="log-invoice">${escapeHtml(m)}</span><span class="log-workspace">${escapeHtml(t("erp-log-col-workspace"))}</span><span class="log-client">${escapeHtml(u)}</span><span class="log-seller">${escapeHtml(d)}</span><span class="log-erp">${escapeHtml(t("erp-log-col-erp"))}</span><span class="log-doc">${escapeHtml(t("erp-log-col-doc"))}</span><span class="log-http">${escapeHtml(t("erp-log-col-http"))}</span><span class="log-elapsed">${escapeHtml(t("erp-log-col-elapsed"))}</span><span class="log-actions"></span></div>`;n.innerHTML=l+i.map(f=>{const v=new Date(f.created_at),w=`${String(v.getMonth()+1).padStart(2,"0")}-${String(v.getDate()).padStart(2,"0")} ${String(v.getHours()).padStart(2,"0")}:${String(v.getMinutes()).padStart(2,"0")}`,b=f.status==="failed"&&f.next_retry_at&&new Date(f.next_retry_at).getTime()>Date.now()-6e4;let g,h,_;f.status==="pending"?(g="retrying",h="⟳",_=t("erp-status-pending")):f.status==="success"?(g="ok",h="✓",_=t("erp-status-success")):f.status==="skipped_dup"?(g="skipped",h="⏭",_=t("erp-status-skipped")):b?(g="retrying",h="↻",_=t("erp-status-retrying")):(g="fail",h="✗",_=t("erp-status-failed"));let y;f.trigger==="auto"?y=`<span class="log-tag auto">${escapeHtml(t("log-tag-auto"))}</span>`:f.trigger==="retry"?y=`<span class="log-tag retry">${escapeHtml(t("log-tag-retry"))}</span>`:y=`<span class="log-tag manual">${escapeHtml(t("log-tag-manual"))}</span>`;const k=f.push_type==="id_card",x=k?`<span class="log-tag log-type-idcard">${escapeHtml(t("erp-log-type-idcard"))}</span>`:"",E=f.error_friendly&&(f.error_friendly[currentLang]||f.error_friendly.en)||"";let L="";const I=f.retry_count||0,B=f.max_retries||3;if(b){const U=new Date(f.next_retry_at).getTime()-Date.now(),re=Math.max(0,Math.round(U/6e4)),se=re<=0?t("erp-retry-next-soon"):t("erp-retry-next-min",{n:re});L=`${t("erp-retry-attempt",{n:I,max:B})} · ${se}`}else f.status==="failed"&&I>=B&&!f.next_retry_at&&(L=t("erp-retry-exhausted",{n:I}));const C=f.status==="failed"&&!b?`<button class="log-retry-btn btn btn-icon" data-log-retry="${escapeHtml(f.id)}" title="${escapeHtml(t("log-retry-title"))}">↻</button>`:"",S=!b,$=Ue.has(f.id)?"checked":"",j=S?`<input type="checkbox" class="erp-log-cb" data-log-cb="${escapeHtml(f.id)}" ${$}>`:'<span class="erp-log-cb-spacer"></span>',N=(f.ocr_buyer_name||"").trim()||(f.client_name||"").trim(),Z=k?`<span class="log-client" title="${escapeHtml(t("erp-log-col-idcard"))}">${f.id_card_tail?"••••"+escapeHtml(f.id_card_tail):"—"}</span>`:N?`<span class="log-client" title="${escapeHtml(N)}">${escapeHtml(N.substring(0,18))}</span>`:`<span class="log-client log-client-empty" title="${escapeHtml(t("erp-log-client-unassigned-tip"))}">${escapeHtml(t("erp-log-client-unassigned"))}</span>`,ae=k?'<span class="log-workspace log-workspace-unresolved">—</span>':f.workspace_name?`<span class="log-workspace">${escapeHtml((f.workspace_name||"").substring(0,16))}</span>`:`<span class="log-workspace log-workspace-unresolved" title="${escapeHtml(t("erp-log-ws-unresolved-tip"))}">${escapeHtml(t("erp-log-ws-unresolved"))}</span>`,ue=f.endpoint_name?`<span class="log-erp">${escapeHtml((f.endpoint_name||"").substring(0,14))}</span>`:`<span class="log-erp log-erp-deleted">${escapeHtml(t("erp-log-endpoint-deleted"))}</span>`,oe=(f.external_doc_no||"").trim(),z=(f.external_url||"").trim();let F;return z?F=`<span class="log-doc"><a href="${escapeHtml(z)}" target="_blank" rel="noopener" class="log-doc-open" title="${escapeHtml(oe||"")}">${escapeHtml(t("erp-log-doc-open"))}</a></span>`:oe?F=`<span class="log-doc log-doc-copy" data-copy-doc="${escapeHtml(oe)}" title="${escapeHtml(t("erp-log-doc-copy-tip"))}">${escapeHtml(oe.substring(0,18))}</span>`:f.status==="success"?F=`<span class="log-doc log-doc-missing" title="${escapeHtml(t("erp-log-doc-missing-tip"))}">${escapeHtml(t("erp-log-doc-missing"))}</span>`:F='<span class="log-doc log-doc-empty">-</span>',`
        ...
        `,document.body.appendChild(f);const v=()=>f.remove();f.querySelector("#cpw-forgot-close").addEventListener("click",v),f.querySelector("#cpw-forgot-cancel").addEventListener("click",v),f.addEventListener("click",w=>{w.target===f&&v()}),f.querySelector("#cpw-forgot-send").addEventListener("click",async()=>{const w=f.querySelector("#cpw-forgot-send"),b=f.querySelector("#cpw-forgot-msg");w.disabled=!0;const g=w.textContent;w.textContent=a("cpw-forgot-sending");try{const h=await fetch("/api/auth/forgot_password",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:l})}),_=await h.json().catch(()=>({}));h.ok?(b.textContent=a("cpw-forgot-success"),b.className="cpw-forgot-msg success",w.style.display="none",f.querySelector("#cpw-forgot-cancel").textContent=a("cpw-forgot-close-btn")):(b.textContent=_.detail||a("cpw-forgot-fail"),b.className="cpw-forgot-msg error",w.disabled=!1,w.textContent=g)}catch{b.textContent=a("cpw-forgot-fail"),b.className="cpw-forgot-msg error",w.disabled=!1,w.textContent=g}})}function m(u){if(!u||!u.includes("@"))return u||"";const[l,p]=u.split("@");return l.length<=2?l+"****@"+p:l.slice(0,2)+"****@"+p}function d(u){return u==null?"":String(u).replace(/[&<>"']/g,l=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[l])}document.readyState==="complete"||document.readyState==="interactive"?r():document.addEventListener("DOMContentLoaded",r)})();(function(){let e=null,n=!1;async function a(){if(n)return;const s=localStorage.getItem("mrpilot_token");if(s){n=!0;try{const i=await fetch("/api/me",{headers:{Authorization:"Bearer "+s},cache:"no-store"});if(i.status===401){const r=await i.json().catch(()=>({})),c=r&&r.detail;let m="";if(typeof c=="string"?m=c:c&&typeof c=="object"&&(m=c.code||""),console.warn("[heartbeat] session revoked",m),localStorage.removeItem("mrpilot_token"),e&&(clearInterval(e),e=null),m==="auth.session_revoked")try{_showSessionRevokedModal()}catch{window.location.href="/"}else{const d=m==="auth.password_changed_relogin"?"alert-password-changed-relogin":"alert-session";try{typeof showToast=="function"&&typeof t=="function"?showToast(t(d),"error"):alert("Session expired")}catch{}setTimeout(()=>{window.location.href="/"},1500)}}}catch{}finally{n=!1}}}function o(){e&&clearInterval(e),e=setInterval(a,15e3)}localStorage.getItem("mrpilot_token")&&o(),window.addEventListener("focus",a),document.addEventListener("visibilitychange",function(){document.hidden||a()}),window._sessionCheck=a})();async function qn(){const e=document.getElementById("team-loading"),n=document.getElementById("team-list"),a=document.getElementById("team-empty"),o=document.getElementById("team-count");if(n){e&&(e.style.display=""),n.style.display="none",a&&(a.style.display="none");try{const s=await apiGet("/api/team/employees"),i=s&&s.employees||[];if(e&&(e.style.display="none"),o&&(o.textContent=(t("team-count")||"共 {n} 名员工").replace("{n}",i.length)),i.length===0){a&&(a.style.display="");return}n.style.display="",n.innerHTML=i.map(r=>{const c=r.last_login_at?new Date(r.last_login_at).toLocaleDateString():t("team-never-login")||"从未登录",m=r.is_active===!1?"team-status-off":"team-status-on",d=r.is_active===!1?t("team-status-disabled")||"已禁用":t("team-status-active")||"正常",u=r.email?`<span class="team-meta-sep">·</span><span>${escapeHtml(r.email)}</span>`:"";return`
            ...
            </div>`}).join("")}catch(s){console.error("loadTeamList failed:",s),e&&(e.textContent=t("team-load-failed")||"加载失败")}}}async function dp(){document.querySelectorAll(".add-emp-overlay").forEach(o=>o.remove());const e=document.createElement("div");e.className="add-emp-overlay",e.innerHTML=`
