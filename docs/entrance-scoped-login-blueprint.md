...
>
> ⚠️ **2026-08-27 口径更新**:本文 §1"单会话保留"与 §4"单会话 active_jti…不做 per-entry 会话"
...
- **单会话保留**（Zihao 拍板）：切入口 = 重新登录，不要求两线同时在线 → active_jti 机制不动。 **（2026-08-27 口径澄清：本条描述的是"同一账号"单活，仍有效；与"不同账号分入口并存"不冲突。）**
...
6. 单会话 active_jti：同账号切门会互踢——Zihao 选保留（切门=重登），不做 per-entry 会话。 **（2026-08-27 口径澄清：本条描述的是"同一账号"单活，仍有效；"不同账号分入口并存"是另一层关系，不与之冲突。）**
