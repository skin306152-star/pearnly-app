...
_STALL = {
    "zh": "我试了几步没做出来:{tried}。你能不能换个说法,或者直接告诉我是哪一家、哪一期?",
    "th": "ลองไปหลายขั้นแล้วยังไม่ได้: {tried} ลองบอกใหม่อีกทีได้ไหม หรือระบุลูกค้ากับงวดมาเลยก็ได้",
}
_CAPPED = {
    "zh": "查到这里就先说结论了(这条问题的预算用完了,再问一句我接着查)。",
    "th": "ขอสรุปเท่าที่หาได้ก่อนนะ (งบของคำถามนี้หมดแล้ว ถามอีกครั้งเดี๋ยวหาต่อให้)",
}
_NO_RESULT = {
    "zh": "这几步都没查出东西来。换个说法,或者告诉我具体是哪一家、哪一期?",
    "th": "หลายขั้นที่ลองไปไม่เจอข้อมูลเลย ลองบอกใหม่ หรือระบุลูกค้ากับงวดมาก็ได้",
}
_OPTIONS = {"zh": "候选:{options}", "th": "ตัวเลือก: {options}"}
_TRIED_NONE = {"zh": "几步查询", "th": "หลายขั้นตอน"}
_RESUMED = {"zh": "好,按你说的接着办。", "th": "ได้ค่ะ เดี๋ยวทำต่อตามที่บอกเลย"}
