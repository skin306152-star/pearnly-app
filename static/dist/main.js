...
このデバイスは自動的にログアウトされました。`},o={zh:"确定，去登录",en:"OK, Sign in",th:"ตกลง เข้าสู่ระบบ",ja:"OK、ログイン"},s=n[e]?e:"th",i=document.createElement("div");i.id="pn-session-revoked-modal",i.style.cssText="position:fixed;inset:0;z-index:99999;background:rgba(0,0,0,.5);display:flex;align-items:center;justify-content:center;padding:16px;",i.innerHTML='<div style="background:#fff;border-radius:14px;padding:32px 24px 24px;max-width:360px;width:100%;box-shadow:0 12px 40px rgba(0,0,0,.2);text-align:center;"><div style="width:52px;height:52px;border-radius:50%;background:#FEF2F2;display:flex;align-items:center;justify-content:center;margin:0 auto 18px;flex-shrink:0;"><svg width="26" height="26" fill="none" stroke="#DC2626" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" viewBox="0 0 24 24"><circle cx="12" cy="12" r="10"/><line x1="12" y1="8" x2="12" y2="12"/><circle cx="12" cy="16" r=".5" fill="#DC2626"/></svg></div><div style="font-size:16px;font-weight:700;color:#111827;margin-bottom:10px;line-height:1.4;">'+n[s]+'</div><div style="font-size:13px;color:#6B7280;line-height:1.7;margin-bottom:24px;white-space:pre-line;">'+a[s]+'</div><button id="pn-srm-ok" style="width:100%;padding:11px 0;background:#111111;color:#fff;border:none;border-radius:8px;font-size:14px;font-weight:600;cursor:pointer;">'+o[s]+"</button></div>",document.body.appendChild(i),document.getElementById("pn-srm-ok").addEventListener("click",function(){window.location.href="/"})}}function Tn(){try{if(typeof window.getActiveWorkspaceClientId=="function"){const e=window.getActiveWorkspaceClientId();if(e!=null)return{"X-Workspace-Client-Id":String(e)}}}catch{}return{}}async function wi(e){const n=await fetch(e,{headers:{Authorization:"Bearer "+token,...Tn()}});if(n.status===401||n.status===403){const a=await n.json().catch(()=>({})),o=a&&a.detail;let s="";if(typeof o=="string"?s=o:o&&typeof o=="object"&&(s=o.code||""),n.status===401||typeof s=="string"&&s.indexOf("auth.")>=0){if(console.warn("[auth-fail-redirect]",e,n.status,o),localStorage.removeItem("mrpilot_token"),s==="auth.session_revoked")Sn();else{const c=s==="auth.password_changed_relogin"?"alert-password-changed-relogin":"alert-session";showToast(Cn(c),"error"),setTimeout(()=>{window.location.href="/"},1500)}return null}const r=new Error("biz_403");throw r.detail=o,r}if(!n.ok)throw new Error("fetch failed");return await n.json()}async function ki(e,n){const a=await fetch(e,{method:"POST",headers:{Authorization:"Bearer "+token,"Content-Type":"application/json",...Tn()},body:JSON.stringify(n)});if(a.status===401||a.status===403){const s=await a.clone().json().catch(()=>({})),i=s&&s.detail;let r="";if(typeof i=="string"?r=i:i&&typeof i=="object"&&(r=i.code||""),a.status===401||typeof r=="string"&&r.indexOf("auth.")>=0){if(console.warn("[auth-fail-redirect]",e,a.status,i),localStorage.removeItem("mrpilot_token"),r==="auth.session_revoked")Sn();else{const f=r==="auth.password_changed_relogin"?"alert-password-changed-relogin":"alert-session";showToast(Cn(f),"error"),setTimeout(()=>{window.location.href="/"},1500)}return null}return a}return a}async function xi(e,n){try{const a=await fetch(e,{method:"PUT",headers:{Authorization:"Bearer "+token,"Content-Type":"application/json",...Tn()},body:JSON.stringify(n)});if(a.status===401||a.status===403){const s=await a.json().catch(()=>({})),i=s&&s.detail;let r="";if(typeof i=="string"?r=i:i&&typeof i=="object"&&(r=i.code||""),a.status===401||typeof r=="string"&&r.indexOf("auth.")>=0){if(console.warn("[auth-fail-redirect]",e,a.status,i),localStorage.removeItem("mrpilot_token"),r==="auth.session_revoked")Sn();else{const f=r==="auth.password_changed_relogin"?"alert-password-changed-relogin":"alert-session";showToast(Cn(f),"error"),setTimeout(()=>{window.location.href="/"},1500)}return{ok:!1}}return{ok:!1,status:a.status,detail:i}}const o=await a.json().catch(()=>({}));return{ok:a.ok&&o.ok!==!1,...o}}catch(a){return{ok:!1,error:String(a)}}}window.apiGet=wi;window.apiPost=ki;window.t=Cn;window.escapeHtml=bi;window.svgIcon=yi;window._showSessionRevokedModal=Sn;window._wsHeader=Tn;window.apiPut=xi;window.getMaxFiles=vi;window.getMaxPagesPerFile=hi;window.getMaxMbPerFile=gi;function ge(e,n){const a=document.getElementById(e);if(!(!a||a.dataset.wbInjected==="1")){a.innerHTML=n,a.dataset.wbInjected="1";try{const o=window._currentLang||localStorage.getItem("mrpilot_lang")||"th",s=window.I18N;if(!s||!s[o])return;a.querySelectorAll("[data-i18n]").forEach(i=>{const r=i.getAttribute("data-i18n");r&&s[o][r]&&(i.textContent=s[o][r])}),a.querySelectorAll("[data-i18n-placeholder]").forEach(i=>{const r=i.getAttribute("data-i18n-placeholder");r&&s[o][r]&&(i.placeholder=s[o][r])})}catch{}}}const _i=`
        <!-- v85 · 模块头 · 视觉对齐其他页 -->
...
`;ge("pearnly-confirm-modal",Ti);ge("confirm-modal",Mi);window.pearnlyConfirm=function(e,n){return new Promise(function(a){const o=document.getElementById("pearnly-confirm-modal"),s=document.getElementById("pearnly-confirm-title"),i=document.getElementById("pearnly-confirm-msg"),r=document.getElementById("pearnly-confirm-ok"),c=document.getElementById("pearnly-confirm-cancel"),f=document.getElementById("pearnly-confirm-close");if(!o||!i||!r||!c){a(window.confirm(e));return}s&&(s.textContent=n||(typeof t=="function"?t("confirm-default-title"):"Please confirm")),i.textContent=e||"",o.style.display="flex";function d(v){o.style.display="none",r.removeEventListener("click",u),c.removeEventListener("click",l),f&&f.removeEventListener("click",l),o.removeEventListener("click",p),document.removeEventListener("keydown",m),a(v)}function u(){d(!0)}function l(){d(!1)}function p(v){v.target===o&&d(!1)}function m(v){v.key==="Escape"?d(!1):v.key==="Enter"&&d(!0)}r.addEventListener("click",u),c.addEventListener("click",l),f&&f.addEventListener("click",l),o.addEventListener("click",p),document.addEventListener("keydown",m),setTimeout(function(){try{c.focus()}catch{}},50)})};const $i=`
        <!-- 顶部 page head -->
        <div class="page-head-clean">
            <div class="page-head-icon">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
...
`,e.dataset.wbInjected="1";try{const n=window._currentLang||localStorage.getItem("mrpilot_lang")||"th",a=window.I18N;a&&a[n]&&(e.querySelectorAll("[data-i18n]").forEach(o=>{const s=o.getAttribute("data-i18n");a[n][s]&&(o.textContent=a[n][s])}),e.querySelectorAll("[data-i18n-placeholder]").forEach(o=>{const s=o.getAttribute("data-i18n-placeholder");a[n][s]&&(o.placeholder=a[n][s])}))}catch{}}})();(function(){const e=document.getElementById("page-settings");if(!(!e||e.dataset.wbInjected==="1")){e.innerHTML=`
        ...
        <!-- /settings-layout -->
`,e.dataset.wbInjected="1";try{const n=window._currentLang||localStorage.getItem("mrpilot_lang")||"th",a=window.I18N;a&&a[n]&&(e.querySelectorAll("[data-i18n]").forEach(o=>{const s=o.getAttribute("data-i18n");a[n][s]&&(o.textContent=a[n][s])}),e.querySelectorAll("[data-i18n-placeholder]").forEach(o=>{const s=o.getAttribute("data-i18n-placeholder");a[n][s]&&(o.placeholder=a[n][s])}))}catch{}}})();const Ai=`
        <div class="page-head-clean">
            <div class="page-head-icon">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
...
`,ji=`                    <!-- Tab: 邮箱抓取 (v0.17 · M6 · v93 在 Vultr 复活) -->
...
`;(function(){const e=document.getElementById("page-automation");if(!(!e||e.dataset.wbInjected==="1")){e.innerHTML=Ai+ji,e.dataset.wbInjected="1";try{const n=window._currentLang||localStorage.getItem("mrpilot_lang")||"th",a=window.I18N;a&&a[n]&&(e.querySelectorAll("[data-i18n]").forEach(o=>{const s=o.getAttribute("data-i18n");s&&a[n][s]&&(o.textContent=a[n][s])}),e.querySelectorAll("[data-i18n-placeholder]").forEach(o=>{const s=o.getAttribute("data-i18n-placeholder");s&&a[n][s]&&(o.placeholder=a[n][s])}))}catch{}}})();(function(){const e={"page-integration":`
        <div class="coming-soon">
            <svg class="cs-icon" viewBox="0 0 48 48" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
...
`,e.dataset.wbInjected="1";try{const n=window._currentLang||localStorage.getItem("mrpilot_lang")||"th",a=window.I18N;a&&a[n]&&e.querySelectorAll("[data-i18n]").forEach(o=>{const s=o.getAttribute("data-i18n");a[n][s]&&(o.textContent=a[n][s])})}catch{}}})();function Pi(e,n){const a=document.getElementById("alert-"+e);a&&(document.getElementById("alert-"+e+"-text").textContent=n,a.classList.add("show"))}function Di(){["info","warn","error"].forEach(e=>{document.getElementById("alert-"+e).classList.remove("show")})}function Ri(e,n){if(e==null)return n||"操作失败";if(typeof e=="string")return e;if(Array.isArray(e)){const a=e[0]||{};return a.msg?a.msg:n||"请求格式错误"}if(typeof e=="object"){if(e.code){const a="err."+e.code;try{const o=t(a,e);if(o&&o!==a)return o}catch(o){console.warn("[i18n] t() failed for key:",a,o)}return e.code}if(e.message)return e.message;if(e.error)return e.error;if(e.detail&&typeof e.detail=="string")return e.detail;try{return JSON.stringify(e).slice(0,160)}catch{}}return n||String(e)}function Fi(e){if(!e)return"";const n=String(e);return/ECONNREFUSED|Connection refused/i.test(n)?"连接被拒绝 · ERP 地址可能错了,或服务没启动":/listing fetch failed|wait_for_selector/i.test(n)?"拉取 MR.ERP 客户/商品列表超时 · 已重试 3 次仍不通 · 可能 MR.ERP 响应慢 · 稍后再试":/ETIMEDOUT|timeout/i.test(n)?"连接超时 · MR.ERP 响应慢 · 稍后再试":/ENOTFOUND|getaddrinfo/i.test(n)?"域名解析失败 · ERP 地址拼错了":/certificate|SSL/i.test(n)?"SSL 证书问题 · ERP 站点证书异常":/401|Unauthorized/i.test(n)?"HTTP 401 · 认证失败,检查 Token 是否正确":/403|Forbidden/i.test(n)?"HTTP 403 · 权限不足,ERP 拒绝访问":/404|Not Found/i.test(n)?"HTTP 404 · URL 路径不存在":/^5\d\d/.test(n)||/500|502|503|504/.test(n)?"ERP 服务器错误 · 不是你的问题,等会儿再试":n}function qi(e,n,a){let o=document.getElementById("mp-toast-wrap");o||(o=document.createElement("div"),o.id="mp-toast-wrap",document.body.appendChild(o)),n=n||"success",n==="ok"&&(n="success"),n==="warning"&&(n="warn"),n==="danger"&&(n="error");const s={success:'<path d="M3 8l3 3 7-7"/>',error:'<circle cx="8" cy="8" r="6"/><path d="M5.5 5.5l5 5M10.5 5.5l-5 5"/>',warn:'<path d="M8 2L1.5 13h13L8 2z"/><path d="M8 7v3M8 12v.01"/>',info:'<circle cx="8" cy="8" r="6"/><path d="M8 5.5v.01M8 8v3"/>',loading:'<path d="M8 1a7 7 0 017 7" stroke-linecap="round" class="mp-toast-spin"/>'},i=document.createElement("div");i.className="mp-toast "+n,i.innerHTML=`
        <svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
            ${s[n]||s.success}
        </svg>
        <span>${escapeHtml(e)}</span>
    `,o.appendChild(i),requestAnimationFrame(()=>i.classList.add("show"));const r=typeof a=="number"?a:2500;let c=null;const f=()=>{c&&(clearTimeout(c),c=null),i.classList.remove("show"),setTimeout(()=>{try{i.remove()}catch{}},300)};return r>0&&(c=setTimeout(f,r)),f}window.showAlert=Pi;window.hideAlerts=Di;window._humanizeBackendError=Ri;window.humanizeError=Fi;window.showToast=qi;function zi(e,n){return n=n||{},new Promise(a=>{const o=document.getElementById("confirm-modal"),s=document.getElementById("confirm-modal-body"),i=document.getElementById("confirm-modal-ok"),r=document.getElementById("confirm-modal-cancel"),c=document.getElementById("confirm-modal-close"),f=document.getElementById("confirm-modal-title");if(!o||!s||!i||!r){a(!1);return}f.textContent=n.title||t("confirm-default-title");const d=n.promptInput?"cm_in_"+Date.now():null;if(n.promptInput){const m=(e||"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;"),v=(n.placeholder||"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;");s.innerHTML=`
            ...
            `}else s.textContent=e||"";i.className=n.danger?"btn btn-danger":"btn btn-primary",i.textContent=n.okText||t("confirm-ok"),r.textContent=n.cancelText||t("confirm-cancel"),r.style.display=n.hideCancel?"none":"",o.style.display="flex";const u=m=>{o.style.display="none",i.onclick=null,r.onclick=null,c.onclick=null,o.onclick=null,document.removeEventListener("keydown",p),n.promptInput&&(s.innerHTML=""),r.style.display="",a(m)},l=()=>{const m=d?document.getElementById(d):null;return m?m.value:""},p=m=>{m.key==="Escape"?u(n.promptInput?null:!1):m.key==="Enter"&&u(n.promptInput?l():!0)};i.onclick=()=>u(n.promptInput?l():!0),r.onclick=()=>u(n.promptInput?null:!1),c.onclick=()=>u(n.promptInput?null:!1),o.onclick=m=>{m.target===o&&u(n.promptInput?null:!1)},document.addEventListener("keydown",p),setTimeout(()=>{if(n.promptInput){const m=document.getElementById(d);m&&m.focus()}else i.focus()},50)})}window.showConfirm=zi;function Ni(e){if(e){try{if(typeof shouldHideMoney=="function"&&shouldHideMoney(_userInfo)&&["team","api","plan","company"].indexOf(e)>=0){e="profile";try{localStorage.setItem("mrpilot_settings_tab","profile")}catch{}}}catch{}document.querySelectorAll(".settings-tab").forEach(n=>{n.classList.toggle("active",n.dataset.tab===e)}),document.querySelectorAll(".settings-pane").forEach(n=>{n.classList.toggle("active",n.dataset.pane===e)});try{localStorage.setItem("mrpilot_settings_tab",e)}catch{}try{e==="about"&&typeof window.loadAboutPanel=="function"&&window.loadAboutPanel(),e==="notifications"&&typeof window.loadPrefsSettings=="function"&&window.loadPrefsSettings(),e==="team"&&loadTeamList(),e==="learned"&&typeof window.loadLearnedRules=="function"&&window.loadLearnedRules(),e==="plan"&&typeof ta=="function"&&ta()}catch(n){console.warn("settings tab side effect failed:",n)}}}function Oi(e){if(!e)return;const n=(a,o)=>{const s=document.getElementById(a);s&&(s.value=o||"")};n("profile-username",e.username||""),n("profile-email",e.username||""),n("profile-fullname",e.full_name||""),n("profile-phone",e.phone||""),n("profile-country",e.country||"TH"),n("profile-line",e.line_id||""),n("company-name",e.company_name||""),n("company-volume",e.monthly_volume||""),n("company-role",e.user_role||e.role_self||"")}async function Vi(){const e=document.getElementById("btn-save-profile"),n=document.getElementById("profile-save-msg");if(!e)return;const a=e.innerHTML;e.disabled=!0,e.innerHTML=`<span>${t("msg-saving")||"保存中..."}</span>`,n&&(n.textContent="",n.classList.remove("error"));try{const o={full_name:(document.getElementById("profile-fullname")||{}).value||"",phone:(document.getElementById("profile-phone")||{}).value||"",country:(document.getElementById("profile-country")||{}).value||"TH",line_id:(document.getElementById("profile-line")||{}).value||""},s=await apiPut("/api/me/profile",o);if(s&&s.ok){n&&(n.textContent=t("msg-saved")||"已保存");try{const i=await apiGet("/api/me");_userInfo=i;try{window._userInfo=i}catch{}renderBrandWorkspace()}catch{}}else throw new Error("save failed")}catch{n&&(n.textContent=t("msg-save-failed")||"保存失败",n.classList.add("error"))}finally{e.disabled=!1,e.innerHTML=a,setTimeout(()=>{n&&(n.textContent="")},3e3)}}async function Ui(){const e=document.getElementById("btn-save-company"),n=document.getElementById("company-save-msg");if(!e)return;const a=e.innerHTML;e.disabled=!0,e.innerHTML=`<span>${t("msg-saving")||"保存中..."}</span>`,n&&(n.textContent="",n.classList.remove("error"));try{const o={company_name:(document.getElementById("company-name")||{}).value||"",monthly_volume:(document.getElementById("company-volume")||{}).value||"",role:(document.getElementById("company-role")||{}).value||""},s=await apiPut("/api/me/profile",o);if(s&&s.ok){n&&(n.textContent=t("msg-saved")||"已保存");try{const i=await apiGet("/api/me");_userInfo=i;try{window._userInfo=i}catch{}renderBrandWorkspace()}catch{}}else throw new Error("save failed")}catch{n&&(n.textContent=t("msg-save-failed")||"保存失败",n.classList.add("error"))}finally{e.disabled=!1,e.innerHTML=a,setTimeout(()=>{n&&(n.textContent="")},3e3)}}function ta(){if(!_userInfo)return;typeof window.loadAboutPanel=="function"&&window.loadAboutPanel(),typeof window.loadPrefsSettings=="function"&&window.loadPrefsSettings();const e=document.getElementById("settings-info");if(!e)return;const n=_userInfo;if(n.is_super_admin){e.innerHTML=`
        ...
        `;const o=document.getElementById("api-key-card");o&&(o.style.display="");return}Gi(n,e);const a=document.getElementById("api-key-card");if(a){const o=tt==="byo_api"||_userInfo&&_userInfo.is_super_admin;a.style.display=o?"":"none"}}function Gi(e,n){const a=escapeHtml(e.username||e.email||"");n.innerHTML=`
        <table style="width:100%; font-size:13px; border-collapse: collapse;">
            <tr>
    ...
    `}window.switchSettingsTab=Ni;window.fillSettingsForms=Oi;window.saveProfile=Vi;window.saveCompany=Ui;window.renderSettings=ta;function Mn(e){return e=e||_userInfo,!!(e&&e.is_super_admin)}function ba(e){return e=e||_userInfo,!!e&&(e.role==="owner"||Mn(e))}function Qo(e){return e=e||_userInfo,!!e&&e.role==="member"&&!Mn(e)}function Ki(e){return e=e||_userInfo,!!e&&(e.effective_plan==="trial"||e.plan==="trial")&&!Mn(e)}function es(e){return e=e||_userInfo,!!e&&e.tenant_type==="byo_api"}function ts(e){return Qo(e)}function Wi(e){return ba(e)}function Yi(e){return ba(e)&&es(e)}window.isMoneyHidden=ts;window.isSuperAdmin=Mn;window.isOwner=ba;window.isEmployee=Qo;window.isTrial=Ki;window.isLifetime=es;window.shouldHideMoney=ts;window.canManageTeam=Wi;window.canManageApiKey=Yi;function Ji(){const e=document.getElementById("quota-banner");if(!e)return;if(!_userInfo){e.style.display="none";return}if(_userInfo.is_super_admin||_userInfo.tenant_type==="admin"||_userInfo.tenant_type==="byo_api"){e.style.display="none";return}let n=0,a=0;if(_userInfo.plan==="free"&&_quota&&_quota.ip_daily_limit)n=_quota.ip_used_today||0,a=_quota.ip_daily_limit;else if(_userInfo.tenant_quota!=null&&_userInfo.tenant_quota>0)n=_userInfo.tenant_used||0,a=_userInfo.tenant_quota;else if(_userInfo.monthly_quota&&_userInfo.monthly_quota>0)n=_userInfo.used_this_month||0,a=_userInfo.monthly_quota;else{e.style.display="none";return}if(a<=0){e.style.display="none";return}const o=Math.max(0,a-n),s=n/a*100,i="quota_banner_dismiss_"+new Date().toISOString().slice(0,10);if(localStorage.getItem(i)){e.style.display="none";return}let r,c;if(o===0)r="danger",c=t("quota-banner-exhausted");else if(s>=90)r="danger",c=t("quota-banner-very-low",{n:o});else if(s>=70)r="warn",c=t("quota-banner-low",{n:o});else{e.style.display="none";return}e.className="quota-banner "+r,e.innerHTML=`
    ...
    `,e.style.display="flex";const f=e.querySelector(".quota-banner-close");f&&f.addEventListener("click",()=>{localStorage.setItem(i,"1"),e.style.display="none"})}function Xi(){const e=_userInfo;if(!e)return;const n=shouldHideMoney(e),a=canManageTeam(e),o=canManageApiKey(e),s=document.querySelector('.nav-item[data-route="templates"]');s&&(s.classList.remove("locked-for-plan"),s.removeAttribute("data-locked-target"));const i=document.querySelector('.nav-item[data-route="api-keys"]');i&&(i.classList.remove("locked-for-plan"),i.removeAttribute("data-locked-target"));const r=document.getElementById("btn-custom-template");r&&(r.style.display="",r.classList.remove("locked-for-plan"));const c=document.querySelector('.settings-tab[data-tab="team"]');c&&(c.style.display=a?"":"none");const f=document.querySelector('.settings-panel[data-settings-panel="team"]');f&&(f.dataset.permHidden=a?"0":"1");const d=document.querySelector('.settings-tab[data-tab="api"]');d&&(d.style.display=o||isSuperAdmin(e)?"":"none");const u=document.querySelector('.settings-tab[data-tab="plan"]');u&&(u.style.display=n?"none":"");const l=document.querySelector('.settings-tab[data-tab="company"]');l&&(l.style.display=n?"none":"");const p=document.getElementById("info-bar");p&&(p.style.display=n?"none":"");const m=document.getElementById("trial-banner");m&&n&&(m.style.display="none");const v=document.getElementById("plan-banner");v&&n&&(v.style.display="none",document.body.classList.remove("has-plan-banner")),document.querySelectorAll("[data-upgrade-cta], .btn-upgrade, .topbar-upgrade").forEach(y=>{y.style.display="none"}),document.body.classList.toggle("role-employee",isEmployee(e)),document.body.classList.toggle("role-owner",isOwner(e)),document.body.classList.toggle("role-super",isSuperAdmin(e));try{const y=document.querySelector(".settings-tab.active");y&&y.style.display==="none"&&(typeof window.switchSettingsTab=="function"?window.switchSettingsTab("profile"):typeof switchSettingsTab=="function"&&switchSettingsTab("profile"))}catch(y){console.warn("[v118.12.3] failed to fix active tab:",y)}if(window.PEARNLY_ADMIN_MODE){const y=document.getElementById("admin-mode-banner");y&&(y.style.display="flex"),document.querySelectorAll(".nav-item").forEach(g=>{g.classList.contains("nav-admin-only")||(g.style.display="none")}),document.querySelectorAll(".nav-group").forEach(g=>{g.classList.contains("nav-group-admin-only")||(g.style.display="none")});const b=document.getElementById("client-switcher");b&&(b.style.display="none"),document.body.classList.add("admin-mode");const h=["profile","security","notifications","about"];document.querySelectorAll(".settings-tab").forEach(g=>{const _=g.dataset.tab;_&&!h.includes(_)&&(g.style.display="none")}),document.querySelectorAll(".settings-pane").forEach(g=>{const _=g.dataset.pane;_&&!h.includes(_)&&(g.style.display="none")}),document.querySelectorAll(".settings-nav-group").forEach(g=>{const _=g.querySelectorAll(".settings-tab");Array.from(_).some(k=>k.style.display!=="none")||(g.style.display="none")})}}function Zi(){const e=_userInfo,n=document.getElementById("info-bar");if(!e||shouldHideMoney(e)){n&&(n.innerHTML="");return}let a="";const o=e.tenant_type;if(o==="byo_api")e.has_own_gemini_key?a=`
        ...
        `;else{const s=e.tenant_used!=null?e.tenant_used:e.used_this_month||0,i=e.tenant_quota!=null&&e.tenant_quota>0?e.tenant_quota:e.monthly_quota||0,r=i>0?Math.min(100,s/i*100):0;let c="";r>=95?c="danger":r>=80&&(c="warn"),i>0?a=`
            ...
            `:a=""}n&&(n.innerHTML=a)}window.renderQuotaBanner=Ji;window.applySidebarVisibility=Xi;window.renderInfoBar=Zi;async function ns(e,n){try{const a=await fetch(e,{method:"POST",headers:{Authorization:"Bearer "+token,"Content-Type":"application/json"},body:JSON.stringify(n)});if(a.status===401){localStorage.removeItem("mrpilot_token");const o=await a.json().catch(()=>({}));return(typeof o.detail=="string"?o.detail:o.detail&&o.detail.code||"")==="auth.session_revoked"?(_showSessionRevokedModal(),null):(window.location.href="/",null)}return await a.json()}catch{return{ok:!1,error:"network"}}}function as(e){return{invalid_format:"rd-err-format",not_found:"rd-err-not-found",rd_unreachable:"rd-err-unreachable",parse_error:"rd-err-unknown",network:"rd-err-unreachable"}[e]||"rd-err-unknown"}function hn(e){const n=document.querySelector(`[data-field="${e}"]`);return n?(n.value||"").trim():""}function lt(e,n,a){const o=document.querySelector(`[data-rd-status="${e}"]`);o&&(o.innerHTML=n,o.className="rd-status"+(a?" "+a:""))}async function Qi(e){const a=hn(e==="seller"?"seller_tax":"buyer_tax");lt(e,t("rd-verifying"),"loading");const o=await ns("/api/rd/verify",{tax_id:a});if(!o)return;if(!o.ok){lt(e,t(as(o.error)),"error");return}o.data&&o.data.valid?lt(e,`<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="2"><path d="M3 8l3 3 7-7"/></svg> ${escapeHtml(t("rd-status-valid"))}`,"valid"):lt(e,t("rd-status-invalid"),"invalid")}async function er(e){const a=hn(e==="seller"?"seller_tax":"buyer_tax");lt(e,t("rd-syncing"),"loading");const o=await ns("/api/rd/lookup",{tax_id:a,branch:0});if(o){if(!o.ok){lt(e,t(as(o.error)),"error");return}lt(e,`<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="2"><path d="M3 8l3 3 7-7"/></svg> ${escapeHtml(t("rd-status-valid"))}`,"valid"),tr(e,o.data)}}function tr(e,n){const a=e==="seller"?"seller_name":"buyer_name",o=e==="seller"?"seller_addr":"buyer_addr",s=hn(a),i=hn(o),r=[];n.name&&n.name!==s&&r.push({field:a,label:t("rd-field-name"),current:s,official:n.name}),n.address&&n.address!==i&&r.push({field:o,label:t("rd-field-address"),current:i,official:n.address});const c=[];n.branch_label&&c.push(`<strong>${t("rd-field-branch")}:</strong> ${escapeHtml(n.branch_label)}`),n.post_code&&c.push(`<strong>${t("rd-field-postcode")}:</strong> ${escapeHtml(n.post_code)}`);let f=document.getElementById("rd-sync-modal");if(f||(f=document.createElement("div"),f.id="rd-sync-modal",f.className="rd-modal-mask",document.body.appendChild(f)),r.length===0)f.innerHTML=`
            <div class="rd-modal">
        ...
        `}f.classList.add("show");const d=()=>f.classList.remove("show");f.querySelector(".rd-modal-close").addEventListener("click",d),f.querySelectorAll("[data-rd-modal-close]").forEach(l=>l.addEventListener("click",d)),f.addEventListener("click",l=>{l.target===f&&d()});const u=f.querySelector("[data-rd-modal-apply]");u&&u.addEventListener("click",()=>{const l=_results[_drawerIdx];if(!l){d();return}f.querySelectorAll("[data-rd-apply]:checked").forEach(p=>{const m=p.dataset.field,v=p.dataset.value;l.edits[m]=v,l.merged_fields[m]=v;const y=document.querySelector(`[data-field="${m}"]`);y&&(y.value=v);const b=document.querySelector(`[data-field-wrap="${m}"]`);b&&b.classList.add("edited")}),updateDrawerEditCount(),renderResults(),d()})}window.callRdVerify=Qi;window.callRdSync=er;function nr(e){const n={invoice_number:null,date:null,total_amount:null,tax_ids:[],seller_name:"",seller_tax:"",seller_addr:"",buyer_name:"",buyer_tax:"",buyer_addr:"",subtotal:"",vat:"",notes:"",items:[]},a=e.filter(s=>!s.is_duplicate&&!s.is_copy),o=a.length>0?a:e;for(const s of o){const i=s.fields||{};!n.invoice_number&&i.invoice_number&&(n.invoice_number=i.invoice_number),!n.date&&i.date&&(n.date=i.date),!n.total_amount&&i.total_amount&&(n.total_amount=i.total_amount),!n.subtotal&&i.subtotal&&(n.subtotal=i.subtotal),!n.vat&&i.vat&&(n.vat=i.vat),!n.seller_name&&i.seller_name&&(n.seller_name=i.seller_name),!n.seller_tax&&i.seller_tax&&(n.seller_tax=i.seller_tax),!n.seller_addr&&i.seller_addr&&(n.seller_addr=i.seller_addr),!n.buyer_name&&i.buyer_name&&(n.buyer_name=i.buyer_name),!n.buyer_tax&&i.buyer_tax&&(n.buyer_tax=i.buyer_tax),!n.buyer_addr&&i.buyer_addr&&(n.buyer_addr=i.buyer_addr),!n.notes&&i.notes&&(n.notes=i.notes),Array.isArray(i.items)&&i.items.length&&n.items.push(...i.items),Array.isArray(i.tax_ids)&&n.tax_ids.push(...i.tax_ids)}return n.tax_ids=[...new Set(n.tax_ids)],!n.seller_tax&&n.tax_ids[0]&&(n.seller_tax=n.tax_ids[0]),!n.buyer_tax&&n.tax_ids[1]&&(n.buyer_tax=n.tax_ids[1]),n}function ar(e){const n=e.target,a=n.dataset.field,o=n.value,s=_results[_drawerIdx],i=s.merged_fields[a];o===(i??"")?delete s.edits[a]:(s.edits[a]=o,s.merged_fields[a]=o);const r=document.querySelector(`[data-field-wrap="${a}"]`);r&&r.classList.toggle("edited",s.edits[a]!==void 0),os(),renderResults()}function os(){const e=_results[_drawerIdx],n=e?Object.keys(e.edits).length:0,a=document.getElementById("drawer-edit-count-sub");a&&(a.textContent=n>0?t("drawer-edit-count",{n}):"")}window.mergeFields=nr;window.onFieldEdit=ar;window.updateDrawerEditCount=os;function or(){document.querySelectorAll(".force-pw-overlay").forEach(a=>a.remove());const e=document.createElement("div");e.className="force-pw-overlay",e.innerHTML=`
    ...
    `,document.body.appendChild(e),requestAnimationFrame(()=>e.classList.add("show")),setTimeout(()=>{const a=document.getElementById("force-pw-old");a&&a.focus()},200);const n=e.querySelector("#force-pw-submit");n.addEventListener("click",async()=>{const a=document.getElementById("force-pw-old").value,o=document.getElementById("force-pw-new").value,s=document.getElementById("force-pw-new2").value,i=document.getElementById("force-pw-msg");if(i.textContent="",i.classList.remove("error"),!a||!o){i.textContent=t("msg-fill-all")||"请填写所有字段",i.classList.add("error");return}if(o!==s){i.textContent=t("force-pw-mismatch")||"两次密码不一致",i.classList.add("error");return}if(o.length<8){i.textContent=t("pwd-too-short")||"密码至少 8 位",i.classList.add("error");return}if(/^\d+$/.test(o)){i.textContent=t("pwd-too-weak-numeric")||"不能是纯数字 · 请加入字母",i.classList.add("error");return}if(!(/[a-zA-Z]/.test(o)&&/\d/.test(o))){i.textContent=t("pwd-too-weak")||"密码至少 8 位 · 字母 + 数字",i.classList.add("error");return}if(o===a){i.textContent=t("pwd-same-as-old")||"新密码不能和临时密码相同",i.classList.add("error");return}n.disabled=!0,n.textContent=t("msg-saving")||"保存中...";try{const r=await fetch("/api/me/change_password",{method:"POST",headers:{Authorization:"Bearer "+token,"Content-Type":"application/json"},body:JSON.stringify({old_password:a,new_password:o})}),c=await r.json().catch(()=>({}));if(!r.ok){const f=c&&c.detail||"unknown",d={wrong_old_password:t("force-pw-wrong-old")||"临时密码不对",password_too_short:t("pwd-too-short")||"密码至少 8 位",password_too_weak:t("pwd-too-weak")||"密码至少 8 位 · 字母 + 数字"};i.textContent=d[f]||t("force-pw-fail")||"修改失败",i.classList.add("error"),n.disabled=!1,n.textContent=t("force-pw-submit")||"修改并继续";return}try{sessionStorage.removeItem("pearnly_must_change_pw")}catch{}showToast(t("force-pw-success")||"密码修改成功","success"),e.classList.remove("show"),setTimeout(()=>{e.remove(),location.reload()},600)}catch{i.textContent=t("force-pw-fail")||"修改失败",i.classList.add("error"),n.disabled=!1,n.textContent=t("force-pw-submit")||"修改并继续"}}),e.addEventListener("click",a=>{a.target===e&&a.stopPropagation()})}window.showForceChangePasswordModal=or;(function(){let e=null,n=null,a=null,o=null;function s(g){return document.getElementById(g)}async function i(){v(),b(),await r()}async function r(){try{const g=localStorage.getItem("mrpilot_token"),_=await fetch("/api/line/binding",{headers:{Authorization:"Bearer "+g}});if(!_.ok){y(t("linebot-err-status"));return}const w=await _.json();w.bound?c(w):await f()}catch{y(t("linebot-err-status"))}}function c(g){m(),s("linebot-unbound").style.display="none",s("linebot-bound").style.display="block";const _=s("linebot-status-summary");_&&(_.textContent=t("linebot-status-bound"),_.style.background="#D1FAE5",_.style.color="#065F46");const w=s("linebot-bound-name");w&&(w.textContent=g.line_display_name||"(LINE User)");const k=s("linebot-avatar");k&&(g.line_picture_url?(k.src=g.line_picture_url,k.style.display=""):k.style.display="none");const x=s("linebot-bound-since");x&&g.bound_at&&(x.textContent=new Date(g.bound_at).toLocaleString())}async function f(){s("linebot-bound").style.display="none",s("linebot-unbound").style.display="block";const g=s("linebot-status-summary");g&&(g.textContent=t("linebot-status-unbound"),g.style.background="#FEE2E2",g.style.color="#B91C1C"),await d(),p()}async function d(){try{const g=localStorage.getItem("mrpilot_token"),_=await fetch("/api/line/binding-code",{method:"POST",headers:{Authorization:"Bearer "+g}});if(!_.ok){y(t("linebot-err-code"));return}const w=await _.json();a=w.code,o=new Date(w.expires_at).getTime(),u(w)}catch{y(t("linebot-err-code"))}}function u(g){const _=s("linebot-code");_&&(_.textContent=g.code);const w=s("linebot-bot-id");w&&(w.textContent=g.bot_basic_id||t("linebot-bot-id-missing"));const k=s("linebot-qr");if(k)if(g.bot_friend_url){const x="https://api.qrserver.com/v1/create-qr-code/?size=140x140&margin=0&data="+encodeURIComponent(g.bot_friend_url);k.classList.remove("empty"),k.innerHTML='<img src="'+x+'" alt="LINE Bot QR">'}else k.classList.add("empty"),k.innerHTML="";l()}function l(){e&&clearInterval(e);const g=s("linebot-code-expires");function _(){if(!o)return;const w=o-Date.now();if(w<=0){g&&(g.textContent=t("linebot-code-expired"),g.classList.add("expiring"));const I=s("linebot-code");I&&(I.style.opacity="0.4"),clearInterval(e),e=null;return}const k=Math.floor(w/1e3),x=Math.floor(k/60),E=k%60;g&&(g.textContent=t("linebot-code-expires-in").replace("{m}",x).replace("{s}",String(E).padStart(2,"0")),w<6e4?g.classList.add("expiring"):g.classList.remove("expiring"))}_(),e=setInterval(_,1e3)}function p(){m(),n=setInterval(async()=>{try{const g=localStorage.getItem("mrpilot_token"),_=await fetch("/api/line/binding",{headers:{Authorization:"Bearer "+g}});if(!_.ok)return;const w=await _.json();w.bound&&c(w)}catch{}},4e3)}function m(){n&&(clearInterval(n),n=null)}function v(){e&&(clearInterval(e),e=null),m()}function y(g){const _=s("linebot-error");_&&(_.textContent=g,_.style.display="block")}function b(){const g=s("linebot-error");g&&(g.style.display="none")}async function h(){if(await showConfirm(t("linebot-unbind-confirm"),{danger:!0}))try{const _=localStorage.getItem("mrpilot_token");if(!(await fetch("/api/line/binding",{method:"DELETE",headers:{Authorization:"Bearer "+_}})).ok){y(t("linebot-err-unbind"));return}await i()}catch{y(t("linebot-err-unbind"))}}document.addEventListener("click",g=>{if(g.target.closest("#linebot-code-refresh")){g.preventDefault(),b(),d();return}if(g.target.closest("#linebot-unbind")){g.preventDefault(),h();return}}),window._loadLineBotPanel=i})();function $n(){const e=document.getElementById("results-card");if(_results.length===0){e.classList.remove("show");return}e.classList.add("show");let n=0;_results.forEach(r=>{const c=parseFloat(r.merged_fields.total_amount);isNaN(c)||(n+=c)}),_selectedFiles&&_selectedFiles.length||_results.length;const a=_results.length,o=n.toLocaleString(void 0,{minimumFractionDigits:2,maximumFractionDigits:2});document.getElementById("results-head-stats").innerHTML=`
        <div class="rh-stat">
    ...
    `;let s=_results.map((r,c)=>({...r,_idx:c}));if(_searchKeyword){const r=_searchKeyword.toLowerCase();s=s.filter(c=>(c.filename||"").toLowerCase().includes(r)||(c.merged_fields.invoice_number||"").toLowerCase().includes(r))}_sortKey&&s.sort((r,c)=>{let f,d;return _sortKey==="filename"?(f=r.filename,d=c.filename):_sortKey==="invoice_no"?(f=r.merged_fields.invoice_number,d=c.merged_fields.invoice_number):_sortKey==="invoice_date"?(f=r.merged_fields.date,d=c.merged_fields.date):_sortKey==="total"?(f=parseFloat(r.merged_fields.total_amount)||0,d=parseFloat(c.merged_fields.total_amount)||0):_sortKey==="confidence"?(f=r.confidence,d=c.confidence):(f="",d=""),f<d?_sortDir==="asc"?-1:1:f>d?_sortDir==="asc"?1:-1:0});const i=document.getElementById("results-tbody");i.innerHTML=s.map((r,c)=>{const f=r.merged_fields,d=`<span class="empty-cell">${t("empty-val")}</span>`,u="conf-tip-"+(r.confidence||"low"),l="conf-"+(r.confidence||"low"),p=t(u),m=t(l);return`
            <tr data-idx="${r._idx}">
                <td class="num">${c+1}</td>
                <td class="fname" title="${escapeHtml(r.filename)}">${escapeHtml(r.filename)}</td>
                <td class="inv">${f.invoice_number?escapeHtml(f.invoice_number):d}</td>
                <td class="date">${f.date?escapeHtml(f.date):d}</td>
                <td class="amount">${f.total_amount?Number(f.total_amount).toLocaleString("en-US",{minimumFractionDigits:2,maximumFractionDigits:2}):d}</td>
                <td><span class="conf-badge ${r.confidence}" data-tip="${escapeHtml(p)}">${m}</span></td>
            </tr>
        `}).join(""),document.querySelectorAll("#results-table th").forEach(r=>{r.classList.remove("sort-asc","sort-desc"),r.dataset.sort===_sortKey&&r.classList.add("sort-"+_sortDir)}),i.querySelectorAll("tr").forEach(r=>{r.addEventListener("click",()=>{const c=parseInt(r.dataset.idx,10);is(c)})})}document.querySelectorAll("#results-table th").forEach(e=>{e.classList.contains("no-sort")||e.addEventListener("click",()=>{const n=e.dataset.sort;_sortKey===n?_sortDir=_sortDir==="asc"?"desc":"asc":(_sortKey=n,_sortDir="asc"),$n()})});let Qa=null;document.getElementById("search-input").addEventListener("input",e=>{const n=e.target.value;document.getElementById("search-clear").style.display=n?"":"none",clearTimeout(Qa),Qa=setTimeout(()=>{_searchKeyword=n.trim(),$n(),ss()},200)});document.getElementById("search-clear").addEventListener("click",()=>{const e=document.getElementById("search-input");e.value="",_searchKeyword="",document.getElementById("search-clear").style.display="none",$n(),ss(),e.focus()});function ss(){const e=document.getElementById("search-matches");if(!e)return;if(!_searchKeyword){e.textContent="";return}const n=_searchKeyword.toLowerCase();let a=0;for(const o of _results)[o.filename,o.merged_fields?.invoice_number,o.merged_fields?.seller_name,o.merged_fields?.buyer_name].filter(Boolean).join(" ").toLowerCase().includes(n)&&a++;e.textContent=t("search-matches",{n:a})}function is(e){_drawerIdx=e;const n=_results[e];if(!n)return;document.getElementById("drawer-title").textContent=n.filename;const a=n.engine==="cache"||n.from_cache,o=a?t("badge-cached-hint"):`${(n.elapsed_ms/1e3).toFixed(1)}s`;document.getElementById("drawer-sub").innerHTML=`
    ...
    `,updateDrawerEditCount();const s=_userInfo&&_userInfo.can_edit_fields,i=_userInfo&&_userInfo.can_verify_tax,r=n.merged_fields,c=document.getElementById("drawer-body"),f=s?"":`
    ...
    `,d=i?"":`<span class="tax-badge unverified" data-tip="${escapeHtml(t("tax-tip-unverified"))}">${t("tax-unverified")}</span>`;if(c.innerHTML=`
        ...
        <div class="drawer-section">
            ...
            ${r.wht_amount||r.wht_rate?`
                ${be("wht_amount","drawer-lbl-wht-amount",r.wht_amount,"input",s,sr(r.wht_rate))}
            `:""}
        </div>
        ...
        <div class="drawer-section">
            ...
            ${r.items&&r.items.length>0?ir(r.items):`<div class="drawer-items-empty">${t("drawer-items-empty")}</div>`}
        </div>
...
`))}</pre>
    ...
    `,s?c.querySelectorAll("[data-field]").forEach(u=>{u.addEventListener("input",onFieldEdit)}):c.querySelectorAll("[data-field]").forEach(u=>{u.setAttribute("readonly","readonly")}),document.getElementById("drawer-mask").classList.add("show"),document.getElementById("drawer").classList.add("show"),injectOcrPushButton(),typeof window.bindDrawerClient=="function"){const u=n._historyId||n.history_id||null;window.bindDrawerClient(u,n.client_id||null)}typeof window.fillCategoryDatalist=="function"&&window.fillCategoryDatalist(),setTimeout(()=>{const u=document.getElementById("drawer-cat-input");u&&!u.value&&!u.readOnly&&u.focus()},80)}function sr(e){return e?`<span class="wht-badge">${escapeHtml(e)}%</span>`:""}function be(e,n,a,o,s,i,r){const c=_results[_drawerIdx],f=c&&c.edits[e]!==void 0?c.edits[e]:a,d=c&&c.edits[e]!==void 0&&c.edits[e]!==a,u=escapeHtml(f??""),l=s?"":"readonly",p=o==="textarea"?`<textarea data-field="${e}" rows="2">${u}</textarea>`:`<input type="text" data-field="${e}" value="${u}">`;return`
    ...
    `:`<button class="rd-btn-locked" data-upgrade="plus" type="button" title="${escapeHtml(t("rd-tip-upgrade"))}">
        ...
        `).join("")}
    `}function rr(){document.getElementById("drawer-mask").classList.remove("show"),document.getElementById("drawer").classList.remove("show");const e=document.getElementById("drawer-history-save");e&&e.remove();const n=document.getElementById("drawer-ocr-push");n&&n.remove();const a=document.getElementById("drawer-ocr-push-btn");a&&a.remove(),_drawerIdx=-1}window.renderResults=$n;window.openDrawer=is;window.closeDrawer=rr;function lr(){const e=_results[_drawerIdx];if(!e||e._historyMode||!_userInfo||!_userInfo.can_push_erp||!e._historyId&&!e.history_id)return;const n=e._historyId||e.history_id,a=document.querySelector(".drawer-header");if(!a||document.getElementById("drawer-ocr-push-btn"))return;const o=(window._erpEndpoints||_erpEndpoints||[]).filter(function(c){return c&&c.enabled!==!1&&(c.adapter||"").toLowerCase()!=="mrerp_dms"});if(o.length===0)return;const s=document.createElement("button");s.id="drawer-ocr-push-btn",s.className="drawer-push-btn";let i;if(o.length===1){const c=o[0].name||o[0].adapter||"ERP";i=t("btn-push-to-name",{name:c}),s.title=i}else i=t("btn-push-erp")+" ▾",s.title=t("btn-push-erp-pick-tip");s.innerHTML=`
        <svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
            <path d="M2 8h9M8 5l3 3-3 3"/>
            <rect x="11" y="3" width="3" height="10" rx="1"/>
        </svg>
        <span>${escapeHtml(i)}</span>
    `,s.addEventListener("click",function(c){c.preventDefault(),c.stopPropagation(),o.length===1?rs(n,o[0].id):cr(s,n,o)});const r=a.querySelector(".drawer-diagnose");r?a.insertBefore(s,r):a.appendChild(s)}function cr(e,n,a){document.querySelectorAll(".drawer-push-picker").forEach(f=>f.remove());const o=e.getBoundingClientRect(),s=document.createElement("div");s.className="drawer-push-picker history-popover",s.style.position="fixed",s.style.top=o.bottom+6+"px",s.style.left=Math.max(8,o.right-240)+"px",s.style.minWidth="220px",s.style.zIndex="12000";const i=a.map(function(f){const d=escapeHtml(f.name||f.adapter||"ERP"),u=escapeHtml((f.adapter||"").toLowerCase()),p=f.is_default?'<span style="font-size:10px;color:#0a7a2c;background:#d6f5e0;padding:1px 6px;border-radius:999px;margin-left:6px;">'+escapeHtml(t("ep-default"))+"</span>":"";return'<button type="button" data-ep-id="'+escapeHtml(f.id)+'" style="display:flex;align-items:center;justify-content:space-between;width:100%;text-align:left;"><span><span style="color:#5d5d57;font-size:11px;margin-right:6px;">'+u+"</span>"+d+p+"</span></button>"}).join("");s.innerHTML=i,document.body.appendChild(s);const r=()=>{s.remove(),document.removeEventListener("click",c,!0)},c=f=>{!s.contains(f.target)&&f.target!==e&&!e.contains(f.target)&&r()};setTimeout(()=>document.addEventListener("click",c,!0),0),s.addEventListener("click",f=>{const d=f.target.closest("[data-ep-id]");if(!d)return;const u=d.getAttribute("data-ep-id");r(),rs(n,u)})}async function rs(e,n){const a=document.getElementById("drawer-ocr-push-btn");a&&(a.disabled=!0);try{const o={history_id:e};n&&(o.endpoint_id=n);const s=await fetch("/api/erp/push",{method:"POST",headers:{Authorization:"Bearer "+token,"Content-Type":"application/json"},body:JSON.stringify(o)}),i=await s.json();if(!s.ok){const r=i&&i.detail?i.detail:"err.unknown";r==="erp.no_default_endpoint"?showToast(t("erp-push-no-endpoint"),"warn"):r==="erp.endpoint_disabled"?(showToast(t("erp-push-disabled-tip")||t("card-disabled-tip")||"Endpoint disabled","warn"),typeof window._refreshErpEndpointsCache=="function"&&window._refreshErpEndpointsCache()):showToast(t("erp-push-fail",{err:r}),"fail");return}i.ok?showToast(t("erp-push-ok",{name:i.endpoint_name||""})):showToast(t("erp-push-fail",{err:i.error_msg||"unknown"}),"fail")}catch(o){showToast(t("erp-push-fail",{err:o.message}),"fail")}finally{a&&(a.disabled=!1)}}window.injectOcrPushButton=lr;const dr=[{id:"input_vat",nameKey:"tpl-input-vat",descKey:"tpl-input-vat-desc",badge:"recommended"},{id:"standard",nameKey:"tpl-standard",descKey:"tpl-standard-desc"},{id:"sales_detail_th",nameKey:"export-tpl-sales-detail",descKey:"export-tpl-sales-detail-desc",badge:"new"},{id:"print",nameKey:"tpl-print",descKey:"tpl-print-desc"}];function ls(){try{const e=localStorage.getItem("pn_export_tpl")||"input_vat";return e==="erp"?"input_vat":e}catch{return"input_vat"}}function pr(e){try{localStorage.setItem("pn_export_tpl",e||"input_vat")}catch{}}async function cs(e){if(_results.length===0)return;e=e||"input_vat";const n=document.getElementById("btn-export");n&&(n.disabled=!0,n.classList.add("loading"));try{let a,o=`pearnly-export-${Date.now()}.xlsx`;if(e==="sales_detail_th"){const d=[];for(const u of _results){const l=u.invoices&&u.invoices.length>0?u.invoices:null;if(l&&l.length>1)for(let p=0;p<l.length;p++){const m=l[p]||{};d.push({filename:u.filename+" #"+(p+1)+"/"+l.length,engine:u.engine,merged_fields:m.fields||{}})}else d.push({filename:u.filename,engine:u.engine,merged_fields:u.merged_fields})}a=await apiPost("/api/ocr/export",{records:d,lang:currentLang,template:"sales_detail_th"})}else{const d=[];for(const l of _results)l.history_ids&&Array.isArray(l.history_ids)?d.push(...l.history_ids):l.history_id&&d.push(l.history_id);if(d.length===0){showToast(t("toast-export-error"),"error");return}const u=localStorage.getItem("mrpilot_token");a=await fetch("/api/reports/history/batch_export",{method:"POST",headers:{Authorization:"Bearer "+u,"Content-Type":"application/json"},body:JSON.stringify({template:e,lang:currentLang,history_ids:d,client_id:null})}),o=`pearnly-${e}-${Date.now()}.xlsx`}if(!a)return;if(!a.ok){let d="HTTP "+a.status;try{const l=await a.json();l&&l.detail&&(d=typeof l.detail=="string"?l.detail:JSON.stringify(l.detail))}catch(l){console.warn("[export] resp.json err.detail parse failed:",l)}const u=typeof d=="string"&&d.indexOf(".")>0?"err."+d:null;showToast(u?t(u):t("toast-export-error")+" · "+d,"error");return}const s=await a.blob();let i=o;const r=a.headers.get("X-Filename");if(r)i=r;else{const u=(a.headers.get("Content-Disposition")||"").match(/filename\*=UTF-8''([^;]+)/i);if(u)try{i=decodeURIComponent(u[1])}catch{}}const c=URL.createObjectURL(s),f=document.createElement("a");f.href=c,f.download=i,document.body.appendChild(f),f.click(),document.body.removeChild(f),URL.revokeObjectURL(c),showToast(t("toast-export-success"),"success")}catch(a){console.error(a),showToast(t("toast-export-error"),"error")}finally{n&&(n.disabled=!1,n.classList.remove("loading"))}}document.getElementById("btn-export").addEventListener("click",()=>{cs(ls())});function ur(){const e=document.getElementById("export-split-wrap");if(!e)return;let n=document.getElementById("export-dropdown");if(n){n.remove();return}n=document.createElement("div"),n.id="export-dropdown",n.className="export-dropdown";const a=ls(),o=dr.map(i=>{const r=i.badge==="recommended"?`<span class="export-dd-badge badge-rec">${escapeHtml(t("report-recommended"))}</span>`:i.badge==="new"?`<span class="export-dd-badge badge-new">${escapeHtml(t("tpl-badge-new"))}</span>`:"";return`
    ...
    `;n.innerHTML=o+s,e.appendChild(n)}function Nn(){const e=document.getElementById("export-dropdown");e&&e.remove()}const On=document.getElementById("btn-export-arrow");On&&On.addEventListener("click",e=>{e.stopPropagation(),!On.disabled&&ur()});document.addEventListener("click",e=>{const n=e.target.closest(".export-dd-item");if(n){const a=n.getAttribute("data-tpl");if(a==="__custom"){Nn(),showToast(t("cs-coming-soon"),"info");return}pr(a),Nn(),cs(a);return}e.target.closest("#btn-export-arrow")||Nn()});function fr(){const e=document.getElementById("btn-export-arrow"),n=document.getElementById("btn-export");e&&n&&(e.disabled=n.disabled)}setInterval(fr,300);const mr=`
        <div class="page-head-clean">
            <div class="page-head-icon">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
...
`;(function(){const e=document.getElementById("page-history");if(!(!e||e.dataset.wbInjected==="1")){e.innerHTML=mr,e.dataset.wbInjected="1";try{const n=window._currentLang||localStorage.getItem("mrpilot_lang")||"th",a=window.I18N;a&&a[n]&&(e.querySelectorAll("[data-i18n]").forEach(o=>{const s=o.getAttribute("data-i18n");a[n][s]&&(o.textContent=a[n][s])}),e.querySelectorAll("[data-i18n-placeholder]").forEach(o=>{const s=o.getAttribute("data-i18n-placeholder");a[n][s]&&(o.placeholder=a[n][s])}))}catch{}}})();function ya(){const e=document.getElementById("history-batch-bar"),n=document.getElementById("history-batch-count"),a=document.getElementById("history-check-all");if(!e||!n)return;const o=_historySelected.size;if(o>0?(e.style.display="",n.textContent=t("history-batch-count",{n:o})):e.style.display="none",a){const s=_historyState.items||[];if(s.length===0)a.checked=!1,a.indeterminate=!1;else{const i=s.filter(r=>_historySelected.has(r.id)).length;a.checked=i===s.length,a.indeterminate=i>0&&i<s.length}}}function vr(){_historySelected.clear(),ya()}async function wa(){if(!_userInfo){setTimeout(()=>wa(),300);return}const e=document.getElementById("history-free-block"),n=document.getElementById("history-main"),a=document.getElementById("history-empty");if(!e||!n||!a){console.warn("[History] container missing");return}if(!_userInfo.can_view_history){e.style.display="",n.style.display="none",a.style.display="none";return}e.style.display="none",_historyState.loading=!0;try{const o=_historyState.page*_historyState.pageSize,s=new URLSearchParams({limit:_historyState.pageSize,offset:o});_historyState.keyword&&s.set("keyword",_historyState.keyword);const i=typeof window.getCurrentClientId=="function"?window.getCurrentClientId():null;i&&s.set("client_id",String(i));const r=await fetch(`/api/history?${s}`,{headers:{Authorization:"Bearer "+token}});if(r.status===401){localStorage.removeItem("mrpilot_token");const d=await r.json().catch(()=>({}));if((typeof d.detail=="string"?d.detail:d.detail&&d.detail.code||"")==="auth.session_revoked"){_showSessionRevokedModal();return}window.location.href="/";return}const c=await r.json();_historyState.items=c.items||[],_historyState.total=c.total||0;const f=new Set(_historyState.items.map(d=>d.id));for(const d of Array.from(_historySelected))f.has(d)||_historySelected.delete(d);ds()}catch(o){console.error("load history failed",o)}finally{_historyState.loading=!1}}function ds(){const e=document.getElementById("history-main"),n=document.getElementById("history-empty"),a=_historyState.items,o=document.getElementById("history-search-matches");if(o&&(o.textContent=_historyState.keyword?t("search-matches",{n:_historyState.total}):""),a.length===0&&_historyState.total===0&&!_historyState.keyword){e.style.display="none",n.style.display="";return}e.style.display="",n.style.display="none";let s=0;a.forEach(d=>{d.confidence==="high"&&s++});const i=a.length>0?Math.round(s/a.length*100):0;document.getElementById("history-stats").innerHTML=`
        <div class="rh-stat">
    ...
    `;const r=document.getElementById("history-tbody");a.length===0?r.innerHTML=`<div class="history-row-empty">${escapeHtml(t("history-empty-title"))}</div>`:r.innerHTML=a.map(d=>{const u=new Date(d.created_at),l=String(u.getMonth()+1).padStart(2,"0"),p=String(u.getDate()).padStart(2,"0"),m=String(u.getHours()).padStart(2,"0"),v=String(u.getMinutes()).padStart(2,"0"),y=`${l}-${p} ${m}:${v}`,b=escapeHtml(d.filename||""),h=b.length>50?b.substring(0,50)+"…":b,g=d.invoice_no?escapeHtml(d.invoice_no):h,_=[];d.seller_name&&_.push(escapeHtml(d.seller_name)),d.invoice_no&&d.filename&&_.push(h);const w=_.join(" · ")||"-",k=d.category_tag?`<span class="history-badge category">${escapeHtml(d.category_tag)}</span>`:"",x=d.source_total&&d.source_total>1?`<span class="history-badge multi">${escapeHtml(t("invoice-part-of",{i:d.source_index||1,n:d.source_total}))}</span>`:"",E=d.total_amount!==null&&d.total_amount!==void 0?Number(d.total_amount).toLocaleString(void 0,{minimumFractionDigits:2,maximumFractionDigits:2}):'<span class="history-cell-amount-empty">—</span>',I=[];(d.total_amount===null||d.total_amount===void 0)&&I.push(t("field-amount")),d.invoice_no||I.push(t("field-invoice-no")),d.invoice_date||I.push(t("field-invoice-date")),d.seller_name||I.push(t("field-seller-name")),I.length>0&&`${escapeHtml(d.id)}${escapeHtml(t("history-needs-review-tip")+" · "+I.join(" · "))}${escapeHtml(t("history-needs-review-tip"))}${svgIcon("alert",14)}`,d.edited&&`${escapeHtml(t("history-edited",{n:d.edit_count||1}))}`;const L=d.smart_assigned_flag?`<span class="history-badge smart-assigned" title="${escapeHtml(t("history-smart-assigned"))}">${svgIcon("sparkle",11)}</span>`:"",B=d.confidence==="high"?"high":d.confidence==="medium"?"mid":"low",C=d.confidence==="high"?t("conf-high"):d.confidence==="medium"?t("conf-medium"):t("conf-low"),S=`<span class="history-badge conf-${B}">${escapeHtml(C)}</span>`;let M="";const R=d.source||"manual";return R==="email"?M=`<span class="history-badge source source-email" title="${escapeHtml(t("history-source-email"))}">${svgIcon("mail",11)}<span>${escapeHtml(t("history-source-email"))}</span></span>`:R==="folder"?M=`<span class="history-badge source source-folder" title="${escapeHtml(t("history-source-folder"))}">${svgIcon("folder",11)}<span>${escapeHtml(t("history-source-folder"))}</span></span>`:R==="api"&&(M=`<span class="history-badge source source-api" title="${escapeHtml(t("history-source-api"))}">${svgIcon("api",11)}<span>${escapeHtml(t("history-source-api"))}</span></span>`),`
                <div class="history-row" data-hid="${escapeHtml(d.id)}">
                    ...
                    <div class="history-cell-file">
                        <div class="history-cell-filename">${g} ${k} ${x} ${M} ${L}</div>
            ...
            `}).join(""),ya();const c=a.length>0?_historyState.page*_historyState.pageSize+1:0,f=_historyState.page*_historyState.pageSize+a.length;document.getElementById("history-pager-info").textContent=t("history-pager",{from:c,to:f,total:_historyState.total}),document.getElementById("history-prev").disabled=_historyState.page===0,document.getElementById("history-next").disabled=(_historyState.page+1)*_historyState.pageSize>=_historyState.total}window.loadHistoryPage=wa;window.renderHistoryList=ds;window.updateHistoryBatchBar=ya;window.clearHistorySelection=vr;typeof currentRoute<"u"&&currentRoute==="history"&&wa();async function gn(e){try{const n=await fetch(`/api/history/${encodeURIComponent(e)}`,{headers:{Authorization:"Bearer "+token}});if(!n.ok)return;const a=await n.json(),o=mergeFields(a.pages||[]),s={filename:a.filename,pages:a.pages,page_count:a.page_count,elapsed_ms:a.elapsed_ms,engine:"history",merged_fields:o,edits:{},confidence:a.confidence,archive_name:a.archive_name||null,category_tag:a.category_tag||null,_historyId:a.id,_historyMode:!0,client_id:a.client_id||null};_results.push(s),_drawerIdx=_results.length-1,openDrawer(_drawerIdx),gr(),typeof window.bindDrawerClient=="function"&&window.bindDrawerClient(a.id,a.client_id||null),br(a.id)}catch(n){console.error("open history detail failed",n)}}async function hr(e){await gn(e),requestAnimationFrame(()=>{const n=document.querySelector('[data-field="total_amount"]');if(n){try{n.focus()}catch{}try{n.select()}catch{}try{n.scrollIntoView({block:"center",behavior:"smooth"})}catch{}}})}function gr(){const e=document.getElementById("drawer-body");if(!e||document.getElementById("drawer-history-save"))return;const n=document.createElement("div");n.id="drawer-history-save",n.className="drawer-history-save-bar",n.innerHTML=`
    ...
    `,e.appendChild(n),document.getElementById("btn-save-history").addEventListener("click",wr),document.getElementById("btn-push-erp").addEventListener("click",yr)}async function br(e){}async function yr(){showToast(t("erp-push-coming-soon")||"ERP 推送即将开放，敬请期待","info")}async function wr(){const e=_results[_drawerIdx];if(!e||!e._historyId)return;const n=JSON.parse(JSON.stringify(e.pages||[]));if(n.length>0){const o=n.findIndex(c=>!c.is_duplicate&&!c.is_copy),s=o>=0?o:0,i=n[s].fields||(n[s].fields={}),r={...e.edits};r.category_tag!==void 0&&(r.category=r.category_tag,delete r.category_tag),Object.assign(i,r)}const a=document.getElementById("btn-save-history");a&&(a.disabled=!0);try{if(!(await fetch(`/api/history/${encodeURIComponent(e._historyId)}`,{method:"PUT",headers:{Authorization:"Bearer "+token,"Content-Type":"application/json"},body:JSON.stringify({pages:n})})).ok)throw new Error("save failed");showAlert("info",t("history-save-ok")),setTimeout(hideAlerts,1500),closeDrawer(),e._historyMode&&_results.pop(),loadHistoryPage()}catch{showAlert("error",t("history-save-fail")),a&&(a.disabled=!1)}}function kr(e,n){document.querySelectorAll(".history-popover").forEach(d=>d.remove());const a=n.getBoundingClientRect(),o=(_historyState.items||[]).find(d=>d.id===e),s=o&&o.invoice_no?String(o.invoice_no):"",i=o&&o.has_pdf===!0,r=document.createElement("div");r.className="history-popover",r.innerHTML=`
    ...
    `,r.style.top=a.bottom+4+"px",r.style.left=a.right-160+"px",document.body.appendChild(r);const c=()=>{r.remove(),document.removeEventListener("click",f,!0)},f=d=>{!r.contains(d.target)&&d.target!==n&&c()};setTimeout(()=>document.addEventListener("click",f,!0),0),r.addEventListener("click",async d=>{const u=d.target.closest("[data-act]");if(!u||u.disabled)return;const l=u.dataset.act;if(c(),l==="copy-invno"){if(!s)return;try{await navigator.clipboard.writeText(s),showToast(t("history-copy-invno-ok",{no:s}),"success")}catch{try{const m=document.createElement("textarea");m.value=s,m.style.position="fixed",m.style.opacity="0",document.body.appendChild(m),m.select(),document.execCommand("copy"),document.body.removeChild(m),showToast(t("history-copy-invno-ok",{no:s}),"success")}catch{showToast(t("history-copy-invno-fail"),"error")}}}else if(l==="download-pdf"){const p=showToast(t("history-download-pdf-loading"),"loading",0);try{const m=await fetch(`/api/history/${encodeURIComponent(e)}/pdf`,{headers:{Authorization:"Bearer "+token}});if(!m.ok)throw new Error("download failed");const v=await m.blob(),y=URL.createObjectURL(v),b=document.createElement("a");b.href=y,b.download=o&&o.filename?o.filename.endsWith(".pdf")?o.filename:o.filename+".pdf":"invoice.pdf",document.body.appendChild(b),b.click(),document.body.removeChild(b),setTimeout(()=>URL.revokeObjectURL(y),5e3),p(),showToast(t("history-download-pdf-ok"),"success")}catch{p(),showToast(t("history-download-pdf-fail"),"error")}}else if(l==="delete"){if(!await showConfirm(t("history-confirm-delete"),{danger:!0}))return;try{if(!(await fetch(`/api/history/${encodeURIComponent(e)}`,{method:"DELETE",headers:{Authorization:"Bearer "+token}})).ok)throw new Error;showAlert("info",t("history-delete-ok")),setTimeout(hideAlerts,1500),loadHistoryPage()}catch{showAlert("error",t("history-delete-fail"))}}})}(function(){document.addEventListener("click",r=>{const c=r.target.closest(".history-row"),f=r.target.closest("[data-hmenu]");if(f){r.stopPropagation(),kr(f.dataset.hmenu,f);return}const d=r.target.closest("[data-review]");if(d){r.stopPropagation(),gn(d.dataset.review);return}const u=r.target.closest("[data-fill-amount]");if(u){r.stopPropagation(),hr(u.dataset.fillAmount);return}r.target.closest(".history-row-check")||r.target.closest(".history-cell-check")||c&&!r.target.closest("[data-hmenu]")&&gn(c.dataset.hid)});const n=document.getElementById("history-tbody");n&&n.addEventListener("change",r=>{const c=r.target.closest(".history-row-check");if(!c)return;const f=c.dataset.hid;c.checked?_historySelected.add(f):_historySelected.delete(f),updateHistoryBatchBar()});const a=document.getElementById("history-check-all");a&&a.addEventListener("change",r=>{const c=r.target.checked;for(const f of _historyState.items)c?_historySelected.add(f.id):_historySelected.delete(f.id);document.querySelectorAll(".history-row-check").forEach(f=>{f.checked=c}),updateHistoryBatchBar()});const o=document.getElementById("history-batch-cancel");o&&o.addEventListener("click",()=>{clearHistorySelection(),document.querySelectorAll(".history-row-check").forEach(r=>{r.checked=!1})});const s=document.getElementById("history-batch-delete");s&&s.addEventListener("click",async()=>{const r=_historySelected.size;if(r===0||!await showConfirm(t("history-batch-confirm",{n:r}),{danger:!0}))return;const f=Array.from(_historySelected);try{const d=await fetch("/api/history/batch-delete",{method:"POST",headers:{Authorization:"Bearer "+token,"Content-Type":"application/json"},body:JSON.stringify({ids:f})});if(!d.ok)throw new Error("batch delete failed");const u=await d.json();showToast(t("history-batch-done",{n:u.deleted||0}),"success"),clearHistorySelection(),loadHistoryPage()}catch(d){console.error("batch delete",d),showToast(t("history-batch-fail"),"error")}});let i=null;document.getElementById("history-search").addEventListener("input",r=>{const c=r.target.value;document.getElementById("history-search-clear").style.display=c?"":"none",clearTimeout(i),i=setTimeout(()=>{_historyState.keyword=c.trim(),_historyState.page=0,clearHistorySelection(),loadHistoryPage()},300)}),document.getElementById("history-search-clear").addEventListener("click",()=>{const r=document.getElementById("history-search");r.value="",_historyState.keyword="",_historyState.page=0,clearHistorySelection(),document.getElementById("history-search-clear").style.display="none",loadHistoryPage(),r.focus()}),document.getElementById("history-range").addEventListener("change",r=>{_historyState.range=parseInt(r.target.value,10),_historyState.page=0,clearHistorySelection(),loadHistoryPage()}),document.getElementById("history-prev").addEventListener("click",()=>{_historyState.page>0&&(_historyState.page--,clearHistorySelection(),loadHistoryPage())}),document.getElementById("history-next").addEventListener("click",()=>{(_historyState.page+1)*_historyState.pageSize<_historyState.total&&(_historyState.page++,clearHistorySelection(),loadHistoryPage())})})();window.openHistoryDrawer=gn;const It=document.getElementById("drop-zone"),ka=document.getElementById("file-input");It.addEventListener("click",()=>ka.click());ka.addEventListener("change",e=>ps(e.target.files));["dragover","dragenter"].forEach(e=>{It.addEventListener(e,n=>{n.preventDefault(),It.classList.add("drag-over")})});["dragleave","drop"].forEach(e=>{It.addEventListener(e,n=>{n.preventDefault(),It.classList.remove("drag-over")})});It.addEventListener("drop",e=>{e.preventDefault(),ps(e.dataTransfer.files)});const xr=/\.(pdf|png|jpe?g|webp|tiff?|bmp|gif|xlsx?|xlsm|csv|tsv|docx?|txt)$/i;function na(e){return e.type&&e.type.startsWith("image/")||/\.(png|jpe?g|webp|tiff?|bmp|gif)$/i.test(e.name)}function _r(e){return e.type==="application/pdf"||/\.pdf$/i.test(e.name)}function Er(e){return _r(e)||na(e)||xr.test(e.name)}function ps(e){hideAlerts();const n=Array.from(e),a=n.filter(Er);a.length!==n.length&&showAlert("warn",t("alert-unsupported-format"));const o=a.filter(c=>!na(c)),s=a.filter(na),i=new Set(_selectedFiles.map(c=>c.name+"_"+c.size));for(const c of o){const f=c.name+"_"+c.size;i.has(f)||(_selectedFiles.push({file:c,name:c.name,size:c.size,status:"waiting",errorKey:null,errorParams:null}),i.add(f))}if(s.length>0)try{handleCameraImages(s,"gallery")}catch(c){console.error("[upload] image route failed",c)}const r=getMaxFiles();_selectedFiles.length>r&&(showAlert("warn",t("alert-file-count",{n:r})),_selectedFiles=_selectedFiles.slice(0,r)),Hn(),xa(),ka.value=""}let tn=!1;function Hn(){const e=document.getElementById("file-list");if(!e)return;if(_selectedFiles.length===0){e.classList.remove("has-files"),e.innerHTML="";return}e.classList.add("has-files");const n=_selectedFiles.length,a=_selectedFiles.filter(l=>l.status==="processing"||l.status==="retrying").length,o=_selectedFiles.filter(l=>l.status==="success").length,s=_selectedFiles.filter(l=>l.status==="error").length;let i=`<span class="count">${escapeHtml(t("file-list-total",{n}))}</span>`;const r=[];a&&r.push(`<span style="color: var(--accent, #111111);">${a} ${escapeHtml(t("status-processing"))}</span>`),o&&r.push(`<span style="color: var(--success, #059669);">${o} ${escapeHtml(t("status-success"))}</span>`),s&&r.push(`<span style="color: var(--danger, #dc2626);">${s} ${escapeHtml(t("status-error"))}</span>`),r.length&&(i+=" · "+r.join(" · "));const c=tn?t("file-list-collapse"):t("file-list-expand"),f=_selectedFiles.map((l,p)=>{let m=t("status-"+l.status);l.status==="retrying"&&(m=t("status-retrying")),l.status==="error"&&l.errorKey&&(m=t(l.errorKey,l.errorParams||{}));const v=l.status==="processing"||l.status==="retrying"?'<span class="spinner"></span>':"",y=l.status==="error"&&l.canRetry?`<button class="file-retry-btn" data-retry-idx="${p}" title="${escapeHtml(t("upload-retry-btn"))}">${svgIcon("refresh",12)}<span>${escapeHtml(t("upload-retry-btn"))}</span></button>`:"",b=l.status==="success"&&l.fromCache?`<span class="file-cache-badge">${svgIcon("cache",11)}<span>${escapeHtml(t("cache-hit-badge"))}</span></span>`:"";return`
            <li class="file-item">
                ...
                ${b}
                <span class="file-status ${l.status}">${v}${m}</span>
                ${y}
            </li>
        `}).join("");e.innerHTML=`
        ...
        <ul class="file-list-body${tn?" expanded":""}" id="file-list-body">
            ${f}
        </ul>
    `;const d=document.getElementById("file-list-toggle");d&&d.addEventListener("click",()=>{tn=!tn,Hn()});const u=document.getElementById("file-list-body");u&&!u.dataset.retryBound&&(u.dataset.retryBound="1",u.addEventListener("click",async l=>{const p=l.target.closest(".file-retry-btn");if(!p)return;const m=parseInt(p.dataset.retryIdx||"-1",10);if(m<0||m>=_selectedFiles.length)return;const v=_selectedFiles[m];!v||v.status!=="error"||typeof window._reprocessFile=="function"&&await window._reprocessFile(v,!0)}))}function xa(){const e=document.getElementById("btn-start"),n=document.getElementById("btn-clear"),a=document.getElementById("btn-export"),o=_selectedFiles.some(s=>s.status==="waiting");e.disabled=_selectedFiles.length===0||!o,n.disabled=_selectedFiles.length===0&&_results.length===0,a.disabled=_results.length===0}document.getElementById("btn-clear").addEventListener("click",()=>{_selectedFiles=[],_results=[],Hn(),renderResults(),xa(),hideAlerts()});window.renderFileList=Hn;window.updateStartButton=xa;const Ir=`
    <div class="modal" style="max-width:420px;">
        <div class="modal-head">
...
`;ge("camera-tips-modal",Ir);async function bn(e){return new Promise(n=>{const a=new FileReader;a.onerror=()=>n({warnings:[],width:0,height:0,brightness:128}),a.onload=()=>{const o=new Image;o.onerror=()=>n({warnings:[],width:0,height:0,brightness:128}),o.onload=()=>{const s=[],i=o.naturalWidth,r=o.naturalHeight;(i<1e3||r<1e3)&&s.push("low_res");try{const c=document.createElement("canvas");c.width=64,c.height=64;const f=c.getContext("2d");f.drawImage(o,0,0,64,64);const d=f.getImageData(0,0,64,64).data;let u=0,l=0;for(let m=0;m<d.length;m+=4)u+=.299*d[m]+.587*d[m+1]+.114*d[m+2],l++;const p=l?u/l:128;p<70?s.push("too_dark"):p>235&&s.push("too_bright"),n({warnings:s,width:i,height:r,brightness:p})}catch{n({warnings:s,width:i,height:r,brightness:128})}},o.src=a.result},a.readAsDataURL(e)})}async function us(e){if(!e||e.length===0)return null;const{jsPDF:n}=window.jspdf,a=210,o=297,s=new n({unit:"mm",format:"a4",orientation:"p"});for(let d=0;d<e.length;d++){const u=e[d],{dataUrl:l,naturalW:p,naturalH:m}=await Lr(u);d>0&&s.addPage("a4","p");const v=p/m;let y=a-10,b=y/v;b>o-10&&(b=o-10,y=b*v);const h=(a-y)/2,g=(o-b)/2,_=u.type==="image/png"?"PNG":"JPEG";s.addImage(l,_,h,g,y,b,void 0,"FAST")}const i=s.output("blob"),r=new Date,c=r.getFullYear().toString()+String(r.getMonth()+1).padStart(2,"0")+String(r.getDate()).padStart(2,"0")+String(r.getHours()).padStart(2,"0")+String(r.getMinutes()).padStart(2,"0")+String(r.getSeconds()).padStart(2,"0"),f=e.length>1?`_${e.length}p`:"";return new File([i],`photo_${c}${f}.pdf`,{type:"application/pdf"})}function Lr(e){return new Promise((n,a)=>{const o=new FileReader;o.onerror=a,o.onload=()=>{const s=new Image;s.onerror=a,s.onload=()=>n({dataUrl:o.result,naturalW:s.naturalWidth,naturalH:s.naturalHeight}),s.src=o.result},o.readAsDataURL(e)})}(function(){const n=document.getElementById("upload-alt-row"),a=document.getElementById("gallery-input"),o=document.getElementById("camera-input");if(!n)return;n.style.display="";const s=document.getElementById("btn-scan-doc");s&&o&&(s.addEventListener("click",async()=>{!(localStorage.getItem("mrpilot_camera_tips_skip")==="1")&&!await Cr()||o.click()}),o.addEventListener("change",async c=>{const f=Array.from(c.target.files||[]);if(c.target.value="",f.length!==0)for(const d of f)await aa([d],"camera")}));const i=document.getElementById("btn-upload-pic");i&&a&&i.addEventListener("click",()=>a.click());const r=c=>async f=>{const d=Array.from(f.target.files||[]);if(f.target.value="",d.length===0)return;const u=d.filter(p=>p.type==="application/pdf"||/\.pdf$/i.test(p.name)),l=d.filter(p=>!u.includes(p));u.length>0&&await Br(u),l.length>0&&await aa(l,c)};a&&a.addEventListener("change",r("gallery"))})();async function Br(e){for(const a of e)_selectedFiles.push({file:a,name:a.name,size:a.size,status:"waiting",errorKey:null,errorParams:null});const n=getMaxFiles();_selectedFiles.length>n&&(showAlert("warn",t("alert-file-count",{n})),_selectedFiles=_selectedFiles.slice(0,n)),renderFileList(),updateStartButton()}function Cr(){return new Promise(e=>{const n=document.getElementById("camera-tips-modal"),a=document.getElementById("camera-tips-ok"),o=document.getElementById("camera-tips-cancel"),s=document.getElementById("camera-tips-skip");if(!n||!a){e(!0);return}s&&(s.checked=!1),n.style.display="flex";const i=c=>{n.style.display="none",s&&s.checked&&localStorage.setItem("mrpilot_camera_tips_skip","1"),a.onclick=null,o&&(o.onclick=null),n.onclick=null,document.removeEventListener("keydown",r),e(c)},r=c=>{c.key==="Escape"&&i(!1)};a.onclick=()=>i(!0),o&&(o.onclick=()=>i(!1)),n.onclick=c=>{c.target===n&&i(!1)},document.addEventListener("keydown",r),setTimeout(()=>a.focus(),50)})}let Se=[],rt=null;async function aa(e,n){if(hideAlerts(),!(!e||e.length===0)){var a=typeof window.getOcrDocumentMode=="function"?window.getOcrDocumentMode():"invoice";if(a==="thai_id_card"){for(const s of e)_selectedFiles.push({file:s,name:s.name,size:s.size,status:"waiting",errorKey:null,errorParams:null});const o=getMaxFiles();_selectedFiles.length>o&&(showAlert("warn",t("alert-file-count",{n:o})),_selectedFiles=_selectedFiles.slice(0,o)),renderFileList(),updateStartButton();return}if(typeof window.jspdf>"u"||!window.jspdf.jsPDF){showToast(t("camera-loading"),"info");for(let o=0;o<30&&(await new Promise(s=>setTimeout(s,100)),!(window.jspdf&&window.jspdf.jsPDF));o++);if(!window.jspdf||!window.jspdf.jsPDF){showToast(t("camera-lib-fail"),"error");return}}if(n==="camera"&&e.length===1){const o=e[0];let s={};try{s=await bn(o)}catch{}Se.push({file:o,quality:s}),rt="camera",yt();return}if(n==="gallery"&&(e.length>=2||Se.length>0)){for(const o of e){let s={};try{s=await bn(o)}catch{}Se.push({file:o,quality:s})}rt="gallery",yt();return}await fs(e)}}async function Sr(e){const n=new Set;for(const o of e)try{((await bn(o)).warnings||[]).forEach(i=>n.add(i))}catch{}try{const o=await us(e);o&&_selectedFiles.push({file:o,name:o.name,size:o.size,status:"waiting",errorKey:null,errorParams:null})}catch(o){console.error("[camera] convert failed",o),showToast(t("camera-convert-fail"),"error");return}const a=getMaxFiles();_selectedFiles.length>a&&(showAlert("warn",t("alert-file-count",{n:a})),_selectedFiles=_selectedFiles.slice(0,a)),renderFileList(),updateStartButton(),showToast(t("camera-added-merged",{n:e.length}),"success"),n.size>0&&setTimeout(()=>{n.has("too_dark")?showToast(t("camera-quality-dark"),"warn"):n.has("low_res")?showToast(t("camera-quality-lowres"),"warn"):n.has("too_bright")&&showToast(t("camera-quality-overexposed"),"warn")},1e3)}function yt(){let e=document.getElementById("camera-buffer-bar");if(Se.length===0){e&&e.remove(),rt=null;return}e||(e=document.createElement("div"),e.id="camera-buffer-bar",e.className="camera-buffer-bar",document.body.appendChild(e));const n=Se.length,a=n>=2,o=rt==="gallery",s=o?t("camera-buffer-more-gallery"):t("camera-buffer-more");let i;a?o?i=`
    ...
    `,e.querySelector('[data-cbb-action="discard"]').onclick=()=>{Se=[],rt=null,yt()},e.querySelector('[data-cbb-action="more"]').onclick=()=>{const f=o?"gallery-input":"camera-input",d=document.getElementById(f);d&&d.click()};const r=e.querySelector('[data-cbb-action="merge"]');r&&(r.onclick=async()=>{const f=Se.map(d=>d.file);Se=[],rt=null,yt(),await Sr(f)});const c=e.querySelector('[data-cbb-action="separate"]');c&&(c.onclick=async()=>{const f=Se.map(d=>d.file);Se=[],rt=null,yt(),await fs(f)})}typeof window.subscribeI18n=="function"&&window.subscribeI18n("camera-buffer-bar",()=>{Se.length>0&&yt()});async function fs(e){const n=new Set;let a=0;for(const s of e)try{((await bn(s)).warnings||[]).forEach(c=>n.add(c));const r=await us([s]);r&&(_selectedFiles.push({file:r,name:r.name,size:r.size,status:"waiting",errorKey:null,errorParams:null}),a++)}catch(i){console.error("[camera] separate convert failed",i)}if(a===0){showToast(t("camera-convert-fail"),"error");return}const o=getMaxFiles();_selectedFiles.length>o&&(showAlert("warn",t("alert-file-count",{n:o})),_selectedFiles=_selectedFiles.slice(0,o)),renderFileList(),updateStartButton(),showToast(t("camera-added-separate",{n:a}),"success"),n.size>0&&setTimeout(()=>{n.has("too_dark")?showToast(t("camera-quality-dark"),"warn"):n.has("low_res")?showToast(t("camera-quality-lowres"),"warn"):n.has("too_bright")&&showToast(t("camera-quality-overexposed"),"warn")},1e3)}window.handleCameraImages=aa;(function(){var e="pearnly_ocr_doc_mode",n=!1,a=!1;function o(p){return typeof escapeHtml=="function"?escapeHtml(p==null?"":String(p)):String(p??"")}function s(){try{return localStorage.getItem(e)==="thai_id_card"?"thai_id_card":"invoice"}catch{return"invoice"}}window.getOcrDocumentMode=function(){return n?s():"invoice"};function i(){var p=document.getElementById("drop-zone");return p?p.closest(".card"):null}function r(){var p=i();if(!p)return null;var m=p.querySelector("#ocr-doc-mode");if(m)return m;var v=p.querySelector(".section-head");return m=document.createElement("div"),m.id="ocr-doc-mode",m.className="ocr-doc-mode",m.setAttribute("role","tablist"),m.style.cssText="display:none;gap:6px;margin:0 0 14px;padding:4px;border-radius:10px;background:var(--bg,#f5f5f3);border:1px solid var(--line,#e5e5e0);width:fit-content;",v&&v.parentNode?v.parentNode.insertBefore(m,v.nextSibling):p.insertBefore(m,p.firstChild),m}function c(p,m,v){return'<button type="button" class="ocr-doc-seg'+(v?" active":"")+'" data-doc-mode="'+p+'" role="tab" aria-selected="'+(v?"true":"false")+'" style="border:none;background:'+(v?"var(--card,#fff)":"transparent")+";color:var(--ink,#1a1a1a);font:inherit;font-size:13px;font-weight:"+(v?"600":"500")+";padding:6px 16px;border-radius:7px;cursor:pointer;box-shadow:"+(v?"0 1px 3px rgba(0,0,0,.08)":"none")+';transition:background .15s;">'+o(t(m))+"</button>"}function f(){var p=r();if(p){if(!n){p.style.display="none";return}var m=s();p.style.display="flex",p.innerHTML=c("invoice","ocr-mode-invoice",m==="invoice")+c("thai_id_card","ocr-mode-id-card",m==="thai_id_card")}}function d(p){try{localStorage.setItem(e,p==="thai_id_card"?"thai_id_card":"invoice")}catch{}f();try{document.dispatchEvent(new CustomEvent("ocr-doc-mode-change",{detail:{mode:window.getOcrDocumentMode()}}))}catch{}}async function u(p){if(!(a&&!p)){var m=localStorage.getItem("mrpilot_token");if(m)try{var v=await fetch("/api/erp/endpoints",{headers:{Authorization:"Bearer "+m}});if(!v.ok)return;var y=await v.json(),b=y&&y.items||[];n=b.some(function(h){return h&&(h.adapter||"").toLowerCase()==="mrerp_dms"&&h.enabled!==!1}),a=!0,window._dmsHasEndpoint=n,f()}catch{}}}window._refreshOcrDocMode=function(){u(!0)},document.addEventListener("click",function(p){var m=p.target.closest(".ocr-doc-seg");m&&m.getAttribute("data-doc-mode")&&(p.preventDefault(),d(m.getAttribute("data-doc-mode")))}),typeof window.subscribeI18n=="function"&&window.subscribeI18n("ocr-doc-mode",f);function l(){r(),f(),u(!1)}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",l):l(),window.addEventListener("hashchange",function(){((location.hash||"").indexOf("ocr")>=0||location.hash===""||location.hash==="#home")&&setTimeout(function(){r(),u(!1)},60)})})();(function(){function e(i){return typeof escapeHtml=="function"?escapeHtml(i==null?"":String(i)):String(i??"")}function n(){var i=(function(){var c=document.getElementById("drop-zone");return c?c.closest(".card"):null})();if(!i||!i.parentNode)return null;var r=document.getElementById("dms-id-card-result");return r||(r=document.createElement("div"),r.id="dms-id-card-result",r.className="card",r.style.cssText="display:none;margin-top:16px;",i.parentNode.insertBefore(r,i.nextSibling),r)}function a(i,r){return'<div style="display:flex;justify-content:space-between;gap:16px;padding:8px 0;border-bottom:1px solid var(--line,#eee);"><span style="color:var(--muted,#6b6b66);font-size:13px;">'+e(t(i))+'</span><span style="font-weight:600;font-size:13px;text-align:right;word-break:break-all;">'+e(r||"—")+"</span></div>"}function o(i){if(!i)return"";var r=[i.house_no,i.road,i.subdistrict,i.district,i.province,i.zipcode].filter(function(c){return c});return r.join(" ")||i.address_raw||""}function s(i){var r=i&&i.status||"failed",c,f,d;return r==="success"?(c="#0a7a2c",f="#d6f5e0",d="dms-result-status-success"):r==="needs_review"?(c="#9a6b00",f="#fdf0d0",d="dms-result-status-needs-review"):r==="skipped"?(c="#5d5d57",f="#eee",d="dms-result-status-skipped"):(c="#b3261e",f="#fbe0de",d="dms-result-status-failed"),'<span style="display:inline-block;padding:3px 12px;border-radius:999px;font-size:12px;font-weight:600;color:'+c+";background:"+f+';">'+e(t(d))+"</span>"}window.renderDmsIdCardResult=function(i){var r=n();if(r){i=i||{};var c=i.id_card||{},f=c.address||{},d=i.dms_push||{},u=d.status||(i.ok?"success":"failed"),l="";u==="success"&&(l=a("dms-result-customer",d.customer_id)+a("dms-result-booking",d.booking_no));var p=u==="failed"||u==="needs_review"?'<button type="button" class="btn btn-ghost btn-tiny" id="dms-id-card-retry" style="margin-top:12px;">'+e(t("dms-result-retry"))+"</button>":"",m="";if(u==="failed"&&d.error_code){var v="dms-err-"+String(d.error_code).toLowerCase(),y=t(v);(!y||y===v)&&(y=t("dms-err-err_dms_unexpected")),m='<div style="margin-top:8px;color:#b3261e;font-size:12px;">'+e(y)+"</div>"}r.style.display="",r.innerHTML='<div class="section-head" style="display:flex;align-items:center;justify-content:space-between;"><div class="section-title">'+e(t("dms-result-title"))+"</div>"+s(d)+'</div><div style="margin-top:8px;">'+a("dms-result-name",(c.first_name||"")+" "+(c.last_name||""))+a("dms-result-id",c.people_id_masked)+a("dms-result-birthday",c.birthday_be)+a("dms-result-address",o(f))+l+"</div>"+m+p}},window.clearDmsIdCardResult=function(){var i=document.getElementById("dms-id-card-result");i&&(i.style.display="none",i.innerHTML="")},document.addEventListener("click",function(i){i.target.closest("#dms-id-card-retry")&&(i.preventDefault(),typeof window._dmsRetryIdCard=="function"&&window._dmsRetryIdCard())})})();async function ms(e){let n;if(e)n=_selectedFiles.find(a=>a.file===e)||{file:e,name:e.name,status:"waiting"};else{const a=_selectedFiles.filter(o=>o.status==="waiting");if(!a.length)return;n=a[0]}window._dmsLastFile=n.file,n.status="processing",typeof renderFileList=="function"&&renderFileList();try{const a=new FormData;a.append("file",n.file,n.name),a.append("push","true");const o=await fetch("/api/dms/id-card-booking",{method:"POST",headers:{Authorization:"Bearer "+token},body:a});if(o.status===401||o.status===403){const i=await o.clone().json().catch(()=>({})),r=i&&i.detail,c=typeof r=="string"?r:r&&r.code||"";if(!c||c.startsWith("auth.")){localStorage.removeItem("mrpilot_token"),showToast(t("alert-session"),"error"),setTimeout(()=>{window.location.href="/"},1200);return}}const s=await o.json().catch(()=>({}));if(!o.ok){n.status="error";const i=s&&s.detail&&(s.detail.code||s.detail)||"unknown";n.errorKey="err."+i,n.canRetry=!0,typeof renderFileList=="function"&&renderFileList(),typeof window.renderDmsIdCardResult=="function"&&window.renderDmsIdCardResult({ok:!1,dms_push:{status:"failed",error_code:String(i)}});return}n.status=s.ok||s.dms_push&&s.dms_push.status==="needs_review"?"success":"error",typeof renderFileList=="function"&&renderFileList(),typeof window.renderDmsIdCardResult=="function"&&window.renderDmsIdCardResult(s),typeof updateStartButton=="function"&&updateStartButton()}catch{n.status="error",n.canRetry=!0,typeof renderFileList=="function"&&renderFileList(),typeof window.renderDmsIdCardResult=="function"&&window.renderDmsIdCardResult({ok:!1,dms_push:{status:"failed",error_code:"network"}})}}window._dmsRetryIdCard=function(){window._dmsLastFile&&ms(window._dmsLastFile)};document.getElementById("btn-start").addEventListener("click",async()=>{if(hideAlerts(),document.getElementById("btn-start").disabled=!0,(typeof window.getOcrDocumentMode=="function"?window.getOcrDocumentMode():"invoice")==="thai_id_card"){try{await ms()}finally{const l=document.getElementById("btn-start");l&&(l.disabled=!1)}return}if(_userInfo&&_userInfo.plan==="free"){const l=await fetch("/api/health").then(p=>p.json()).catch(()=>null);l&&!l.ocr_ready&&(showAlert("info",t("alert-loading-engine")),startEnginePolling())}const n=_selectedFiles.filter(l=>l.status==="waiting"),a=6;async function o(l,p){if(window._ocrAborted)return l.status="cancelled",l.errorKey=null,renderFileList(),{};l.status=p?"retrying":"processing",l.canRetry=!1,renderFileList();const m=new AbortController,v=setTimeout(()=>m.abort("timeout"),9e4);window._ocrCtrls=window._ocrCtrls||new Set,window._ocrCtrls.add(m);try{const y=new FormData;y.append("file",l.file,l.name);try{if(typeof window.getCurrentClientId=="function"){const w=window.getCurrentClientId();w!=null&&y.append("client_id",String(w))}}catch{}const b=await fetch("/api/ocr/recognize",{method:"POST",headers:{Authorization:"Bearer "+token},body:y,signal:m.signal});if(clearTimeout(v),window._ocrCtrls.delete(m),b.status===401||b.status===403){const k=await b.clone().json().catch(()=>({})),x=k&&k.detail,E=typeof x=="string"?x:x&&x.code||"";if(!E||E.startsWith("auth.")){if(localStorage.removeItem("mrpilot_token"),E==="auth.session_revoked")_showSessionRevokedModal();else{const I=E==="auth.password_changed_relogin"?"alert-password-changed-relogin":"alert-session";showToast(t(I),"error"),setTimeout(()=>{window.location.href="/"},1200)}return{abort:!0}}E==="quota.need_api_key"&&showToast(t("err.quota.need_api_key"),"error")}if(!b.ok){const k=(await b.json().catch(()=>({}))).detail;return typeof k=="string"?(l.errorKey="err."+k,l.errorParams=null):k&&k.code?(l.errorKey="err."+k.code,l.errorParams={...k,mb:_quota.max_file_size_mb}):(l.errorKey="err.unknown",l.errorParams=null),(l.errorKey==="err.unknown"||l.errorKey==="err.ocr.engine_error")&&(b.status===429?l.errorKey="err.rate_limit":b.status===502||b.status===503||b.status===504?l.errorKey="err.gemini_overloaded":b.status>=500&&(l.errorKey="err.server")),l.status="error",l.canRetry=!/not_pdf|invalid_pdf|file_too_large|too_many_pages|monthly_limit_exceeded|ip_limit_exceeded|plan_not_supported|need_api_key|not_invoice/.test(l.errorKey||""),renderFileList(),{}}const h=await b.json();l.status="success",l.fromCache=!!h.from_cache;const g=mergeFields(h.pages),_=h.confidence||(g.items&&g.items.length>0?"high":"low");if(_results.push({filename:h.filename,pages:h.pages,page_count:h.page_count,elapsed_ms:h.elapsed_ms,engine:h.engine,merged_fields:g,edits:{},confidence:_,history_id:h.history_id,history_ids:h.history_ids||[],invoice_count:h.invoice_count||1,invoices:h.invoices||[],archive_name:h.archive_name||null,category_tag:h.category_tag||null,auto_pushed:!!h.auto_pushed,typhoon_enhanced:!!h.typhoon_enhanced,typhoon_pages:h.typhoon_pages||[],from_cache:!!h.from_cache}),h.invoice_count&&h.invoice_count>1&&showToast(t("multi-invoice-toast",{file:h.filename,n:h.invoice_count}),"success"),h.missed_invoice_warnings&&h.missed_invoice_warnings.length){const w=h.missed_invoice_warnings.map(function(k){return k.page}).filter(function(k){return k!=null});showToast(t("missed-invoice-warn",{file:h.filename,pages:w.join(", ")}),"warn",8e3),console.warn("[OCR] possible missed invoice(s)",h.missed_invoice_warnings)}if(h.typhoon_enhanced&&h.typhoon_pages&&h.typhoon_pages.length&&showToast(t("typhoon-enhanced-toast",{file:h.filename,n:h.typhoon_pages.length}),"success"),h.fallback_used){const w=h.engine_chain||[],k=h.engine||"";let x;k==="typhoon_nvidia"?x="fallback-typhoon-nvidia-toast":k==="easyocr"?x="fallback-easyocr-toast":x="fallback-generic-toast",showToast(t(x,{file:h.filename}),"warn"),console.info("[OCR Chain]",w)}if(h.from_cache&&showToast(t("cache-hit-toast",{file:h.filename}),"info"),h.duplicate_warnings&&h.duplicate_warnings.length){window._dupQueue||(window._dupQueue=[]);for(const w of h.duplicate_warnings)window._dupQueue.push({filename:h.filename,...w})}return h.auto_pushed&&showToast(t("auto-push-fired",{file:h.filename}),"info"),h.quota&&h.quota.used_this_month!=null&&_userInfo&&(_userInfo.used_this_month=h.quota.used_this_month,_userInfo.tenant_used=h.quota.used_this_month,renderInfoBar(),renderQuotaBanner()),renderFileList(),renderResults(),updateStartButton(),{}}catch(y){clearTimeout(v);try{window._ocrCtrls&&window._ocrCtrls.delete(m)}catch{}console.error("[Upload] failed for",l.file.name,y);const b=y&&(y.name==="AbortError"||y==="timeout"),h=b&&(m.signal.reason==="timeout"||y==="timeout"),g=y&&y.message&&/NetworkError|Failed to fetch/i.test(y.message);return b&&(m.signal.reason==="user_stop"||window._ocrAborted)?(l.status="cancelled",l.errorKey=null,l.canRetry=!1,renderFileList(),{}):(h?l.errorKey="err.timeout":b?l.errorKey="err.aborted":g?l.errorKey="err.network":(l.errorKey="err.unknown",l.errorParams={msg:y&&y.message?y.message:String(y)}),l.status="error",!p&&!window._ocrAborted&&(g||h)&&navigator.onLine!==!1&&(l.canRetry=!0,renderFileList(),await new Promise(w=>setTimeout(w,2e3)),l.status==="error"&&navigator.onLine!==!1&&!window._ocrAborted)?o(l,!0):(l.canRetry=!0,renderFileList(),{}))}}window._reprocessFile=o;let s=0,i=!1;async function r(){for(;s<n.length&&!i&&!window._ocrAborted;){const l=s++,p=await o(n[l]);if(p&&p.abort){i=!0;return}}}window._ocrAborted=!1,window._ocrCtrls=window._ocrCtrls||new Set;const c=document.getElementById("btn-start"),f=document.getElementById("btn-stop");c&&(c.style.display="none"),f&&(f.style.display="");try{typeof window._bigBatchStart=="function"&&window._bigBatchStart(n)}catch{}const d=[];for(let l=0;l<Math.min(a,n.length);l++)d.push(r());await Promise.all(d);try{typeof window._bigBatchStop=="function"&&window._bigBatchStop()}catch{}c&&(c.style.display=""),f&&(f.style.display="none");const u=!!window._ocrAborted;window._ocrAborted=!1,window._ocrCtrls.clear(),updateStartButton(),stopEnginePolling(),document.getElementById("alert-info").classList.contains("show")&&(showAlert("info",t("alert-engine-ready")),setTimeout(hideAlerts,2e3));try{const l={success:0,cancelled:0,network:0,timeout:0,quota:0,overloaded:0,rate:0,other:0};for(const m of n)if(m.status==="success")l.success++;else if(m.status==="cancelled")l.cancelled++;else if(m.status==="error"){const v=m.errorKey||"";v==="err.network"?l.network++:v==="err.timeout"||v==="err.aborted"?l.timeout++:v.indexOf("quota")>=0||v==="err.monthly_limit_exceeded"?l.quota++:v==="err.gemini_overloaded"||v==="err.server"?l.overloaded++:v==="err.rate_limit"?l.rate++:l.other++}const p=n.length;u?showToast(Tr(l,p),"warn",4e3):p>1&&l.network+l.timeout+l.quota+l.overloaded+l.rate+l.other>0&&showToast(Mr(l),"error",4500)}catch{}window._dupQueue&&window._dupQueue.length&&showDuplicateDialog()});function Tr(e,n){return t("ocr-summary-aborted").replace("{success}",e.success).replace("{cancelled}",e.cancelled).replace("{total}",n)}function Mr(e){const n=[];return e.success&&n.push(t("ocr-summary-success").replace("{n}",e.success)),e.network&&n.push(t("ocr-summary-network").replace("{n}",e.network)),e.timeout&&n.push(t("ocr-summary-timeout").replace("{n}",e.timeout)),e.quota&&n.push(t("ocr-summary-quota").replace("{n}",e.quota)),e.overloaded&&n.push(t("ocr-summary-overloaded").replace("{n}",e.overloaded)),e.rate&&n.push(t("ocr-summary-rate").replace("{n}",e.rate)),e.other&&n.push(t("ocr-summary-other").replace("{n}",e.other)),n.join(" · ")}document.addEventListener("click",e=>{if(!e.target.closest("#btn-stop")||window._ocrAborted)return;window._ocrAborted=!0,window._ocrCtrls&&window._ocrCtrls.size&&window._ocrCtrls.forEach(a=>{try{a.abort("user_stop")}catch{}});const n=document.getElementById("btn-stop");n&&(n.disabled=!0),typeof showToast=="function"&&showToast(t("ocr-stop-toast"),"warn",2e3),setTimeout(()=>{n&&(n.disabled=!1)},800)});function vs(){if(!window._dupQueue||!window._dupQueue.length)return;const e=window._dupQueue.shift(),n=e.level==="exact",a=n?"dup-title-exact":"dup-title-likely",o=n?"dup-desc-exact":"dup-desc-likely",s=n?"#DC2626":"#D97706",i=n?"#FEE2E2":"#FEF3C7",r=m=>m!=null?Number(m).toLocaleString(void 0,{minimumFractionDigits:2,maximumFractionDigits:2}):"—",c=m=>m||"—",f=m=>{try{const v=new Date(m);return`${v.getFullYear()}-${String(v.getMonth()+1).padStart(2,"0")}-${String(v.getDate()).padStart(2,"0")}`}catch{return m}},d=e.invoice_total>1?` · ${t("invoice-part-of",{i:e.invoice_index,n:e.invoice_total})}`:"",u=(e.matched_fields||[]).map(m=>{const v=t("dup-field-"+m.replace("_","-"))||m;return`<span class="dup-field-chip">${escapeHtml(v)}</span>`}).join(" "),l=document.createElement("div");l.className="log-detail-modal",l.innerHTML=`
            ...
            <div class="dup-body">
                ...
                <table class="dup-compare">
                    ...
                    <tbody>
                        ...
                        <tr><td>${escapeHtml(t("dup-field-uploaded-at"))}</td><td>—</td><td>${escapeHtml(f(e.match.created_at))}</td></tr>
                    </tbody>
                </table>
            </div>
    ...
    `,document.body.appendChild(l);const p=()=>{l.remove(),window._dupQueue&&window._dupQueue.length&&setTimeout(vs,200)};l.querySelector(".dup-close").addEventListener("click",p),l.querySelector('[data-action="view"]').addEventListener("click",()=>{const m=e.match.id;window.location.hash="#/history",setTimeout(()=>{typeof openHistoryDrawer=="function"&&openHistoryDrawer(m)},400),p()}),l.querySelector('[data-action="delete"]').addEventListener("click",async()=>{const m=e.new_history_id;if(!m){p();return}try{(await fetch(`/api/history/${encodeURIComponent(m)}`,{method:"DELETE",headers:{Authorization:"Bearer "+token}})).ok?showToast(t("dup-deleted-toast"),"success"):showToast(t("dup-delete-failed"),"error")}catch{showToast(t("dup-delete-failed"),"error")}p()}),l.querySelector('[data-action="keep"]').addEventListener("click",p)}window.showDuplicateDialog=vs;function ct(e,n){try{return typeof window.t=="function"?window.t(e):n}catch{return n}}function jt(e){if(e==null||isNaN(e))return"—";try{return String(e).replace(/\B(?=(\d{3})+(?!\d))/g,",")}catch{return String(e)}}function $r(e){if(!e)return"";try{const n=new Date(e).getTime();if(!n)return"";const a=Math.floor((Date.now()-n)/1e3);return a<60?ct("time-just-now","刚刚"):a<3600?Math.floor(a/60)+ct("time-min-ago-suffix"," 分钟前"):a<86400?Math.floor(a/3600)+ct("time-hour-ago-suffix"," 小时前"):Math.floor(a/86400)+ct("time-day-ago-suffix"," 天前")}catch{return""}}async function _a(){hs();const e=document.getElementById("dash-kpi-invoices"),n=document.getElementById("dash-kpi-pending"),a=document.getElementById("dash-kpi-exceptions"),o=document.getElementById("dash-kpi-plan"),s=document.getElementById("dash-kpi-plan-sub"),i=document.getElementById("dash-recent-list"),r=document.getElementById("dash-quick-exc-badge");try{const c={Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||"")},[f,d,u]=await Promise.all([fetch("/api/me/tenant-usage",{headers:c}).then(b=>b.ok?b.json():null).catch(()=>null),fetch("/api/history?limit=20",{headers:c}).then(b=>b.ok?b.json():null).catch(()=>null),fetch("/api/exceptions/stats?status=pending",{headers:c}).then(b=>b.ok?b.json():null).catch(()=>null)]),l=f&&f.ocr_this_month||0;let p=0;const m=d&&(d.items||d.history||d)||[],v=Array.isArray(m)?m:[];v.forEach(b=>{(b.status==="pending"||b.status==="reviewing")&&p++});const y=u&&(u.total||u.count||u.pending||0)||0;if(e&&(e.textContent=jt(l)),n&&(n.textContent=jt(p)),a&&(a.textContent=jt(y)),r&&(y>0?(r.style.display="",r.textContent=y):r.style.display="none"),o&&f){const b=f.ocr_this_month||0,h=f.quota||0;o.textContent=jt(b),s&&(s.textContent=h?b+" / "+jt(h)+" 张":ct("dash-kpi-plan-sub","本月用量"))}if(i)if(v.length===0)i.innerHTML='<div class="dash-recent-empty">'+ct("dash-recent-empty","还没有识别记录 · 去上传第一张吧")+"</div>";else{const b=v.slice(0,5).map(h=>{const g=(h.invoice_no||h.filename||h.id||"").toString(),_=(h.supplier_name||h.buyer_name||h.client_name||h.notes||"").toString(),w=$r(h.created_at||h.upload_time||h.date),k=x=>String(x).replace(/[&<>"']/g,E=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[E]);return'<div class="dash-recent-row"><span class="dash-recent-key" title="'+k(g)+'">'+k(g)+'</span><span class="dash-recent-mid" title="'+k(_)+'">'+k(_)+'</span><span class="dash-recent-time">'+k(w)+"</span></div>"}).join("");i.innerHTML=b}}catch{i&&(i.innerHTML='<div class="dash-recent-empty">'+ct("dash-recent-empty","还没有识别记录 · 去上传第一张吧")+"</div>")}}window.loadDashboard=_a;async function hs(){const e=document.getElementById("dash-kpi-balance-card"),n=document.getElementById("dash-kpi-usage-card"),a=document.getElementById("dash-kpi-balance"),o=document.getElementById("dash-kpi-balance-sub"),s=document.getElementById("dash-kpi-usage"),i=document.getElementById("dash-kpi-usage-sub");if(!(!e||!n))try{const r={Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||"")},c=await fetch("/api/me/credits",{headers:r,cache:"no-store"});if(!c.ok){e.style.display="none",s&&(s.textContent="—"),i&&(i.textContent="");return}const f=await c.json(),d=!!f.is_owner,u=!!f.is_billing_exempt;if(!d)e.style.display="none";else if(e.style.display="",u)a&&(a.textContent="∞",a.className="dash-kpi-val dash-green"),o&&(o.textContent=typeof window.t=="function"?window.t("dash-kpi-balance-exempt"):"Billing exempt");else{const p=typeof f.balance_thb=="number"?f.balance_thb:0;if(a&&(a.textContent="฿"+p.toFixed(2),a.className=p<50?"dash-kpi-val dash-red":"dash-kpi-val"),o){const m=typeof window.t=="function"?window.t("dash-kpi-balance-topup"):"Top up →",v=p<50?"#dc2626":"#6b7280",y=b=>typeof window.escapeHtml=="function"?window.escapeHtml(b):String(b).replace(/[&<>"']/g,h=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[h]);o.innerHTML='<a href="#" id="kpi-balance-topup-link" style="color:'+v+';text-decoration:underline;cursor:pointer;" onclick="event.preventDefault();window._openTopupModal&&window._openTopupModal();return false;">'+y(m)+"</a>"}}const l=typeof f.pages_this_month=="number"?f.pages_this_month:typeof f.my_invoice_count=="number"?f.my_invoice_count:0;if(n.style.display="",s&&(s.textContent=String(l)),i){const p=l>=200?"dash-kpi-usage-sub-high":"dash-kpi-usage-sub-low",m=typeof window.t=="function"?window.t(p,{used:l}):l+" pages";i.textContent=m}}catch(r){console.warn("[credits] loadCreditsCard failed:",r),e.style.display="none",s&&(s.textContent="—")}}window.loadCreditsCard=hs;document.addEventListener("DOMContentLoaded",function(){(location.hash||"").replace(/^#\//,"")==="dashboard"&&setTimeout(_a,500)});typeof window.subscribeI18n=="function"&&window.subscribeI18n("dashboard",function(){(location.hash||"").replace(/^#\//,"")==="dashboard"&&_a()});function ee(e){return(typeof window.t=="function"?window.t(e):null)||e}function Ea(){return localStorage.getItem("mrpilot_token")||""}function X(e){return document.getElementById(e)}var pn=null,zt=null;function gs(){zt||(zt=setInterval(function(){if(!document.hidden){var e=Ea();e&&(window._userInfo&&window._userInfo.is_billing_exempt||fetch("/api/me/credits",{headers:{Authorization:"Bearer "+e},cache:"no-store"}).then(function(n){return n.ok?n.json():null}).then(function(n){if(n){var a=n.balance_thb!=null?Number(n.balance_thb):0;pn!==null&&a>pn&&(window.showToast&&window.showToast(ee("credits-updated"),"success"),typeof window.loadDashboard=="function"&&window.loadDashboard(),typeof window._refreshBalanceAlerts=="function"&&window._refreshBalanceAlerts()),pn=a}}).catch(function(){}))}},3e4))}function Hr(){zt&&(clearInterval(zt),zt=null),pn=null}window._startCreditsPoll=gs;window._stopCreditsPoll=Hr;gs();var Ia=null,La=0;function Ar(){if(!X("topup-v2-ov")){var e=document.createElement("div");e.id="topup-v2-ov",e.className="topup-v2-ov",e.style.cssText="display:none;position:fixed;inset:0;background:rgba(15,23,42,.5);z-index:9500;align-items:center;justify-content:center;padding:16px",e.innerHTML=['<div class="topup-v2-box">','  <div class="topup-v2-head">','    <div class="topup-v2-title" id="tv2-title"></div>','    <button class="topup-v2-close" id="tv2-close" aria-label="close">','      <svg viewBox="0 0 20 20" width="16" height="16" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"><line x1="4" y1="4" x2="16" y2="16"/><line x1="16" y1="4" x2="4" y2="16"/></svg>',"    </button>","  </div>",'  <div class="topup-v2-steps">','    <div class="topup-v2-step" id="tv2-d1"><span class="topup-v2-dot">1</span><span class="topup-v2-slabel" id="tv2-sl1"></span></div>','    <div class="topup-v2-line"></div>','    <div class="topup-v2-step" id="tv2-d2"><span class="topup-v2-dot">2</span><span class="topup-v2-slabel" id="tv2-sl2"></span></div>','    <div class="topup-v2-line"></div>','    <div class="topup-v2-step" id="tv2-d3"><span class="topup-v2-dot">3</span><span class="topup-v2-slabel" id="tv2-sl3"></span></div>',"  </div>",'  <div class="topup-v2-body">','    <div id="tv2-s1">','      <label class="topup-v2-label" id="tv2-al"></label>','      <div class="topup-v2-qamts">','        <button class="topup-v2-qamt" data-val="100">฿100</button>','        <button class="topup-v2-qamt" data-val="500">฿500</button>','        <button class="topup-v2-qamt" data-val="1000">฿1,000</button>','        <button class="topup-v2-qamt" data-val="2000">฿2,000</button>',"      </div>",'      <input id="tv2-amt" type="number" min="10" step="1" class="topup-v2-input" placeholder="฿ ...">','      <div id="tv2-ae" class="topup-v2-err" style="display:none"></div>',"    </div>",'    <div id="tv2-s2" style="display:none">','      <p class="topup-v2-bank-label" id="tv2-bl"></p>','      <div class="topup-v2-bank-card">','        <div class="topup-v2-bank-name">ธนาคาร กรุงเทพ</div>','        <div class="topup-v2-bank-branch">สาขาโชคชัย 4 ลาดพร้าว</div>','        <div class="topup-v2-bank-acct">230-0-91368-4</div>','        <div class="topup-v2-bank-holder">บจ. มิสเตอร์ อี อาร์ พี</div>','        <button class="topup-v2-copy" id="tv2-copy"></button>',"      </div>",'      <div class="topup-v2-warn" id="tv2-bn"></div>',"    </div>",'    <div id="tv2-s3" style="display:none">','      <div class="topup-v2-drop" id="tv2-drop">','        <input type="file" id="tv2-file" accept="image/*,.pdf" style="display:none">','        <svg viewBox="0 0 24 24" width="28" height="28" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M21 15v4a2 2 0 01-2 2H5a2 2 0 01-2-2v-4"/><polyline points="17 8 12 3 7 8"/><line x1="12" y1="3" x2="12" y2="15"/></svg>','        <span class="topup-v2-drop-text" id="tv2-dt"></span>',"      </div>",'      <div id="tv2-se" class="topup-v2-err" style="display:none"></div>','      <label class="topup-v2-label" id="tv2-pl"></label>','      <input id="tv2-payer" type="text" maxlength="200" class="topup-v2-input">','      <label class="topup-v2-label" id="tv2-nl"></label>','      <input id="tv2-note" type="text" maxlength="500" class="topup-v2-input">','      <div id="tv2-ue" class="topup-v2-err" style="display:none"></div>',"    </div>","  </div>",'  <div class="topup-v2-foot">','    <button class="btn btn-ghost" id="tv2-back" style="display:none"></button>','    <button class="btn btn-primary" id="tv2-next"></button>',"  </div>","</div>"].join(""),document.body.appendChild(e),jr()}}function bs(){var e=function(n,a){var o=X(n);o&&(o.textContent=a)};e("tv2-title",ee("topup-title")),e("tv2-sl1",ee("topup-step1")),e("tv2-sl2",ee("topup-step2")),e("tv2-sl3",ee("topup-step3")),e("tv2-al",ee("topup-amount-label")),e("tv2-bl",ee("topup-bank-label")),e("tv2-copy",ee("topup-copy-account")),e("tv2-dt",ee("topup-slip-drop")),e("tv2-pl",ee("topup-payer-label")),e("tv2-nl",ee("topup-note-label"))}function Yt(e){[1,2,3].forEach(function(s){var i=X("tv2-s"+s);i&&(i.style.display=s===e?"":"none");var r=X("tv2-d"+s);r&&r.classList.toggle("active",s<=e)});var n=X("tv2-back"),a=X("tv2-next");if(e===1?n&&(n.style.display="",n.textContent=ee("topup-btn-cancel")):n&&(n.style.display="",n.textContent=ee("topup-btn-back")),a&&(a.textContent=ee(e===3?"topup-btn-submit":"topup-btn-next")),e===2){var o=X("tv2-bn");o&&(o.innerHTML=ee("topup-bank-note").replace("{amount}","<strong>฿"+Number(La).toLocaleString()+"</strong>"))}}function oa(){for(var e=1;e<=3;e++){var n=X("tv2-s"+e);if(n&&n.style.display!=="none")return e}return 1}function yn(e){var n=X(e);n&&(n.textContent="",n.style.display="none")}function Nt(e,n){var a=X(e);a&&(a.textContent=n,a.style.display="")}function to(e){var n=X("tv2-dt");n&&(n.textContent=e.name);var a=X("tv2-drop");a&&a.classList.add("has-file"),yn("tv2-se")}function jr(){var e=X("topup-v2-ov");X("tv2-close").addEventListener("click",Dt),e.addEventListener("click",function(i){i.target===e&&Dt()}),document.addEventListener("keydown",function(i){i.key==="Escape"&&e&&e.style.display!=="none"&&Dt()}),e.addEventListener("click",function(i){var r=i.target.closest(".topup-v2-qamt");if(r){e.querySelectorAll(".topup-v2-qamt").forEach(function(f){f.classList.remove("active")}),r.classList.add("active");var c=X("tv2-amt");c&&(c.value=r.dataset.val,yn("tv2-ae"))}});var n=X("tv2-amt");n&&n.addEventListener("input",function(){e.querySelectorAll(".topup-v2-qamt").forEach(function(i){i.classList.remove("active")}),yn("tv2-ae")});var a=X("tv2-copy");a&&a.addEventListener("click",function(){navigator.clipboard&&navigator.clipboard.writeText("2300913684").then(function(){var i=a.textContent;a.textContent=ee("topup-copied"),setTimeout(function(){a.textContent=i},1500)})});var o=X("tv2-drop"),s=X("tv2-file");o&&(o.addEventListener("click",function(){s&&s.click()}),o.addEventListener("dragover",function(i){i.preventDefault(),o.classList.add("drag-over")}),o.addEventListener("dragleave",function(){o.classList.remove("drag-over")}),o.addEventListener("drop",function(i){i.preventDefault(),o.classList.remove("drag-over");var r=i.dataTransfer&&i.dataTransfer.files[0];r&&to(r)})),s&&s.addEventListener("change",function(){s.files[0]&&to(s.files[0])}),X("tv2-back").addEventListener("click",function(){var i=oa();if(i<=1){Dt();return}Yt(i-1)}),X("tv2-next").addEventListener("click",function(){var i=oa();i===1?Pr():i===2?Yt(3):Dr()})}async function Pr(){var e=X("tv2-amt"),n=e?parseFloat(e.value):0;if(!n||n<10){Nt("tv2-ae",ee("topup-amount-invalid"));return}if(n>5e5){Nt("tv2-ae",ee("topup-amount-too-large"));return}La=n;var a=X("tv2-next");a&&(a.disabled=!0,a.textContent="…");try{var o=await fetch("/api/credits/topup/request",{method:"POST",headers:{"Content-Type":"application/json",Authorization:"Bearer "+Ea()},body:JSON.stringify({amount_thb:n})});if(!o.ok){var s=await o.text(),i=ee("topup-submit-fail");try{var r=JSON.parse(s),c=r.detail;if(Array.isArray(c)&&c.length){var f=c[0]&&c[0].type||"";f.indexOf("less_than")>=0?i=ee("topup-amount-too-large"):(f.indexOf("greater_than")>=0||f.indexOf("parsing")>=0)&&(i=ee("topup-amount-invalid"))}else typeof c=="string"&&(i=c)}catch{}throw new Error(i)}var d=await o.json();Ia=d.request_id,Yt(2)}catch(u){Nt("tv2-ae",u.message||ee("topup-submit-fail"))}finally{a&&(a.disabled=!1,a.textContent=ee("topup-btn-next"))}}async function Dr(){var e=X("tv2-file");if(!e||!e.files||!e.files[0]){Nt("tv2-se",ee("topup-slip-required"));return}var n=X("tv2-next");n&&(n.disabled=!0,n.textContent="…");try{var a=new FormData;a.append("file",e.files[0]);var o=X("tv2-payer"),s=X("tv2-note");o&&o.value.trim()&&a.append("payer_name",o.value.trim()),s&&s.value.trim()&&a.append("note",s.value.trim());var i=await fetch("/api/credits/topup/upload-slip/"+Ia,{method:"POST",headers:{Authorization:"Bearer "+Ea()},body:a});if(!i.ok)throw new Error(await i.text());var r=await i.json();r.auto_approved?(window.showToast&&window.showToast(ee("topup-auto-approved"),"success"),typeof window.loadDashboard=="function"&&window.loadDashboard()):window.showToast&&window.showToast(ee("topup-pending"),"info"),Dt()}catch(c){Nt("tv2-ue",ee("topup-upload-fail")+" · "+c.message),n&&(n.disabled=!1,n.textContent=ee("topup-btn-submit"))}}function Dt(){var e=X("topup-v2-ov");e&&(e.style.display="none"),typeof window.loadDashboard=="function"&&window.loadDashboard()}window._openTopupModal=function(){Ar(),Ia=null,La=0,["tv2-amt","tv2-payer","tv2-note"].forEach(function(a){var o=X(a);o&&(o.value="")});var e=X("tv2-file");e&&(e.value="");var n=X("tv2-drop");n&&n.classList.remove("has-file","drag-over"),X("topup-v2-ov").querySelectorAll(".topup-v2-qamt").forEach(function(a){a.classList.remove("active")}),["tv2-ae","tv2-se","tv2-ue"].forEach(function(a){yn(a)}),bs(),Yt(1),X("topup-v2-ov").style.display="flex"};typeof window.subscribeI18n=="function"&&window.subscribeI18n("topup-v2",function(){var e=X("topup-v2-ov");e&&e.style.display!=="none"&&e.style.display!==""&&(bs(),Yt(oa()))});const Rr=`
        <div class="page-head">
            <div class="page-head-icon">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
    ...
    `;ge("page-test-center",Rr);const ys="v118.28.5",Ba="pearnly_tc_results_"+ys,qe=[{id:"A1",group:"A · 异常栏 page-head(BUG1)",desc:"手机宽度进异常栏 · 标题「异常栏」横排正常 · 不再每字一行"},{id:"A2",group:"A · 异常栏 page-head(BUG1)",desc:"副标题「所有被规则拦截的单据集中复核…」也横排正常 · 不竖排"},{id:"A3",group:"A · 异常栏 page-head(BUG1)",desc:"客户筛选下拉 + 刷新按钮换到新一行 · 不抢标题宽度"},{id:"B1",group:"B · 客户管理 page-head(BUG2)",desc:"手机宽度进客户管理 · 标题「客户管理」横排正常"},{id:"B2",group:"B · 客户管理 page-head(BUG2)",desc:"副标题「为每家客户单独归档发票…」横排正常 · 不竖排"},{id:"B3",group:"B · 客户管理 page-head(BUG2)",desc:"「+ 新建客户」按钮换到新一行 · 不挤标题"},{id:"C1",group:"C · 客户卡片(BUG3)",desc:"客户卡片「编辑 / 导出本月」按钮文字清晰 · 不被截断"},{id:"D1",group:"D · 历史表头(BUG4)",desc:"手机宽度进单据记录 · 表头「文件·发票号·供应商」/「金额」单行 · 不竖排"},{id:"D2",group:"D · 历史表头(BUG4)",desc:"行内 INV-TH-202605-1006 这种长发票号正常单行展示 · 不一字一行"},{id:"E1",group:"E · 对账切换器(BUG6)",desc:"手机宽度进对账中心 · 顶栏点「全部客户」chip · 下拉从右上角向下展开 · 右对齐 · 不贴左屏边"},{id:"E2",group:"E · 对账切换器(BUG6)",desc:"下拉宽度自适应屏幕 · 不超出屏幕右边"},{id:"F1",group:"F · 通用设置回归",desc:"设置 → 个人资料 · 没有「界面语言」4 按钮卡"},{id:"F2",group:"F · 通用设置回归",desc:"左侧 nav 顺序:账户 / 公司 / 工作流 / 系统 / 关于"},{id:"F3",group:"F · 通用设置回归",desc:"系统 → 通用设置 · 4 行下拉(语言/时区/日期/数字)· 改语言立即切语言 · 改其他保存后 F5 仍保留"},{id:"G1",group:"G · 移动端 settings(回归)",desc:"手机宽度设置 tabs 不重叠 · 按分组分行 · chip 风格"},{id:"H1",group:"H · 回归",desc:"OCR 上传识别 / 客户管理 / 异常栏 / 对账中心 / 测试中心 全部仍工作"},{id:"H2",group:"H · 回归",desc:"4 语切换没新增异常(测试中心异常日志「API 失败」过滤无新条目)"},{id:"I1",group:"I · 三档移动 viewport",desc:"iPhone SE 375 · 上述 BUG 1-6 都修了"},{id:"I2",group:"I · 三档移动 viewport",desc:"Galaxy S 360 · 上述 BUG 1-6 都修了"},{id:"I3",group:"I · 三档移动 viewport",desc:"iPhone 12 Pro 414 · 上述 BUG 1-6 都修了"}],Z={results:{},logFilter:"all",bound:!1,renderScheduled:!1,checkN:0};function _e(e,n,a){let o=typeof t=="function"?t(e):null;return(!o||o===e)&&(o=n),a&&Object.keys(a).forEach(function(s){o=String(o).replace("{"+s+"}",String(a[s]))}),o}function Fr(){try{const e=localStorage.getItem(Ba);Z.results=e?JSON.parse(e):{},(typeof Z.results!="object"||!Z.results)&&(Z.results={})}catch{Z.results={}}}function no(){try{localStorage.setItem(Ba,JSON.stringify(Z.results))}catch{}}function Ca(e){const n=new Date(e),a=function(o){return o<10?"0"+o:""+o};return a(n.getHours())+":"+a(n.getMinutes())+":"+a(n.getSeconds())}function Ce(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function ze(e,n){try{typeof showToast=="function"?showToast(e,n||"info"):alert(e)}catch{}}function ao(e){try{navigator.clipboard&&navigator.clipboard.writeText?navigator.clipboard.writeText(e).then(function(){ze(_e("tc-toast-copied","已复制到剪贴板"),"success")}).catch(function(){Vn(e)}):Vn(e)}catch{Vn(e)}}function Vn(e){try{const n=document.createElement("textarea");n.value=e,n.style.position="fixed",n.style.opacity="0",document.body.appendChild(n),n.select();const a=document.execCommand("copy");document.body.removeChild(n),ze(a?_e("tc-toast-copied","已复制"):_e("tc-toast-copy-fail","复制失败"),a?"success":"error")}catch{ze(_e("tc-toast-copy-fail","复制失败"),"error")}}function qr(){const e=[],n=new Date,a=_userInfo&&(_userInfo.email||_userInfo.username)||"—";e.push("# Pearnly "+ys+" 测试结果"),e.push("- 账号:"+a),e.push("- 时间:"+n.toISOString().replace("T"," ").slice(0,19));const o=qe.length,s=qe.filter(function(u){return Z.results[u.id]==="pass"}).length,i=qe.filter(function(u){return Z.results[u.id]==="fail"}).length,r=qe.filter(function(u){return Z.results[u.id]==="skip"}).length,c=o-s-i-r;e.push("- 进度:"+(s+i+r)+" / "+o+" · ✅ "+s+" · ❌ "+i+" · ⏭ "+r+" · 未测 "+c),e.push(""),e.push("| ID | 描述 | 状态 |"),e.push("|---|---|---|"),qe.forEach(function(u){const l=Z.results[u.id],p=l==="pass"?"✅":l==="fail"?"❌":l==="skip"?"⏭":"⬜";e.push("| "+u.id+" | "+u.desc.replace(/\|/g,"\\|")+" | "+p+" |")});const f=qe.filter(function(u){return Z.results[u.id]==="fail"});f.length>0&&(e.push(""),e.push("## ❌ 失败项"),f.forEach(function(u){e.push("- **"+u.id+"** · "+u.desc)}));const d=(window._pearnlyTcLogs||[]).slice(-30).reverse();return d.length>0&&(e.push(""),e.push("## 🔴 异常日志(最近 "+d.length+" 条)"),d.forEach(function(u){if(e.push("- `"+Ca(u.ts)+"` · **"+u.type+"** · "+u.summary),u.detail){let l;try{l=JSON.stringify(u.detail)}catch{l=String(u.detail)}l&&l!=="{}"&&e.push("  - "+l.slice(0,600))}})),e.join(`
`)}function zr(e){const n=(window._pearnlyTcLogs||[]).slice(-30).reverse();if(n.length===0)return"(暂无异常日志)";const a=["# Pearnly 异常日志(最近 "+n.length+" 条)"],o=_userInfo&&(_userInfo.email||_userInfo.username)||"—";return a.push("- 账号:"+o),a.push("- 当前页:"+(currentRoute||"?")),a.push("- UA:"+navigator.userAgent),a.push(""),n.forEach(function(s){if(a.push("## `"+Ca(s.ts)+"` · "+s.type),a.push("- "+s.summary),s.detail){a.push("```");try{a.push(JSON.stringify(s.detail,null,2).slice(0,2e3))}catch{a.push(String(s.detail).slice(0,2e3))}a.push("```")}}),a.join(`
`)}(function(){function e(){const v=document.getElementById("tc-account-chip"),y=document.getElementById("tc-progress-chip");if(v&&(v.textContent=_userInfo&&(_userInfo.email||_userInfo.username)||"—"),y){const b=qe.length,h=qe.filter(function(g){return Z.results[g.id]}).length;y.textContent=h+" / "+b}}function n(){const v=document.getElementById("tc-checklist-body");if(!v)return;const y={};qe.forEach(function(h){y[h.group]||(y[h.group]=[]),y[h.group].push(h)});const b=[];Object.keys(y).forEach(function(h){b.push('<div class="tc-checklist-group">'),b.push('<div class="tc-checklist-group-title">'+Ce(h)+"</div>"),y[h].forEach(function(g){const _=Z.results[g.id]||"",w=_?"is-"+_:"";b.push('<div class="tc-check-item '+w+'" data-id="'+Ce(g.id)+'"><div class="tc-check-id">'+Ce(g.id)+'</div><div class="tc-check-desc">'+Ce(g.desc)+'</div><div class="tc-check-actions">'+a(g.id,"pass",_)+a(g.id,"fail",_)+a(g.id,"skip",_)+"</div></div>")}),b.push("</div>")}),v.innerHTML=b.join("")}function a(v,y,b){const h=b===y,g={pass:'<svg viewBox="0 0 20 20" fill="none" stroke="currentColor" stroke-width="2.4" stroke-linecap="round" stroke-linejoin="round"><polyline points="4,11 8,15 16,5"/></svg>',fail:'<svg viewBox="0 0 20 20" fill="none" stroke="currentColor" stroke-width="2.4" stroke-linecap="round" stroke-linejoin="round"><line x1="5" y1="5" x2="15" y2="15"/><line x1="15" y1="5" x2="5" y2="15"/></svg>',skip:'<svg viewBox="0 0 20 20" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"><line x1="5" y1="10" x2="15" y2="10"/></svg>'},_={pass:_e("tc-status-pass","通过"),fail:_e("tc-status-fail","失败"),skip:_e("tc-status-skip","跳过")};return'<button type="button" class="tc-status-btn '+(h?"is-active "+y:"")+'" data-id="'+Ce(v)+'" data-kind="'+y+'" title="'+Ce(_[y])+'">'+g[y]+"</button>"}function o(v){return Z.logFilter==="all"?!0:Z.logFilter==="js_error"?v.type==="js_error"||v.type==="promise_error":Z.logFilter==="api"?v.type==="api_error"||v.type==="api_fail":Z.logFilter==="api_slow"?v.type==="api_slow":Z.logFilter==="console"?v.type==="console_error"||v.type==="console_warn":!0}function s(){const v=document.getElementById("tc-logs-body"),y=document.getElementById("tc-logs-count");if(!v)return;const b=(window._pearnlyTcLogs||[]).slice().reverse(),h=b.filter(o);if(y&&(y.textContent=String(b.length)),h.length===0){v.innerHTML='<div class="tc-logs-empty">'+Ce(_e("tc-logs-empty","暂无异常"))+"</div>";return}const g=h.slice(0,100).map(function(_){const w=typeof _.detail=="object"?JSON.stringify(_.detail,null,2):String(_.detail||"");return'<div class="tc-log-item t-'+Ce(_.type)+'" data-ts="'+_.ts+'"><span class="tc-log-time">'+Ca(_.ts)+'</span><span class="tc-log-type">'+Ce(_.type)+'</span><div class="tc-log-summary">'+Ce(_.summary)+'<div class="tc-log-detail">'+Ce(w)+"</div></div></div>"}).join("");v.innerHTML=g,document.querySelectorAll("#tc-logs-filter .tc-filter-chip").forEach(function(_){_.classList.toggle("active",_.getAttribute("data-filter")===Z.logFilter)})}function i(){Z.renderScheduled||(Z.renderScheduled=!0,setTimeout(function(){Z.renderScheduled=!1,currentRoute==="test-center"&&document.getElementById("page-test-center")&&document.getElementById("page-test-center").classList.contains("active")&&s(),r()},200))}window._tcOnNewLog=i;function r(){const v=document.getElementById("nav-test-badge");if(!v)return;const y=(window._pearnlyTcLogs||[]).filter(function(b){return b.type==="js_error"||b.type==="promise_error"||b.type==="api_error"||b.type==="api_fail"||b.type==="console_error"}).length;y>0?(v.style.display="",v.textContent=y>99?"99+":String(y)):v.style.display="none"}function c(){e(),n(),s(),r()}function f(){const v=Date.now();fetch("/api/health").then(function(y){const b=Date.now()-v;y.ok?ze(_e("tc-toast-health-ok","后端健康 ✓ {ms}ms",{ms:b}),"success"):ze(_e("tc-toast-health-fail","后端无响应")+" ("+y.status+")","error")}).catch(function(){ze(_e("tc-toast-health-fail","后端无响应"),"error")})}function d(){try{localStorage.removeItem(Ba),localStorage.removeItem("pearnly_current_client_id"),Z.results={},(window._pearnlyTcLogs||[]).length=0,Z.logFilter="all",window.setCurrentClientId}catch{}c(),ze(_e("tc-toast-cleared","session 状态已清空"),"success")}function u(){try{fetch("/api/clients",{headers:{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||"")}}).then(function(v){return v.json()}).then(function(v){window._clientsCache=v.clients||[],typeof window._refreshClientSwitcher=="function"&&window._refreshClientSwitcher(),typeof window._refreshExcClientFilter=="function"&&window._refreshExcClientFilter(),ze("客户缓存已刷新 · "+(v.clients||[]).length+" 个客户","success")}).catch(function(){ze("刷新失败","error")})}catch{}}function l(){if(Z.bound||!document.getElementById("page-test-center"))return;Z.bound=!0;const y=document.getElementById("tc-checklist-body");y&&y.addEventListener("click",function(L){const B=L.target.closest(".tc-status-btn");if(!B)return;const C=B.getAttribute("data-id"),S=B.getAttribute("data-kind");!C||!S||(Z.results[C]===S?delete Z.results[C]:Z.results[C]=S,no(),n(),e())});const b=document.getElementById("tc-btn-reset-checklist");b&&b.addEventListener("click",function(){Z.results={},no(),n(),e()});const h=document.getElementById("tc-btn-copy-all");h&&h.addEventListener("click",function(){ao(qr())});const g=document.getElementById("tc-btn-copy-logs");g&&g.addEventListener("click",function(){ao(zr())});const _=document.getElementById("tc-btn-clear-logs");_&&_.addEventListener("click",function(){(window._pearnlyTcLogs||[]).length=0,s(),r()});const w=document.getElementById("tc-logs-filter");w&&w.addEventListener("click",function(L){const B=L.target.closest(".tc-filter-chip");B&&(Z.logFilter=B.getAttribute("data-filter")||"all",s())});const k=document.getElementById("tc-logs-body");k&&k.addEventListener("click",function(L){const B=L.target.closest(".tc-log-item");B&&B.classList.toggle("expanded")});const x=document.getElementById("tc-tool-health");x&&x.addEventListener("click",f);const E=document.getElementById("tc-tool-clear-session");E&&E.addEventListener("click",d);const I=document.getElementById("tc-tool-reload-clients");I&&I.addEventListener("click",u)}function p(){}window._tcApplyVisibility=p;const m=setInterval(function(){Z.checkN++,_userInfo&&clearInterval(m),Z.checkN>60&&clearInterval(m)},500);window.loadTestCenterPage=function(){Fr(),l(),c()},typeof window.subscribeI18n=="function"&&window.subscribeI18n("test-center",function(){r(),currentRoute==="test-center"&&document.getElementById("page-test-center")&&document.getElementById("page-test-center").classList.contains("active")&&c()})})();(function(){const e="pearnly_active_workspace_client_id",n="pearnly_work_mode";function a(h,g){if(typeof window.t=="function"){const _=window.t(h);if(_&&_!==h)return _}return g}function o(){const h=window._userInfo||{},g=String(h.role||"").toLowerCase(),_=String(h.tenant_role||"").toLowerCase();return h.is_super_admin===!0||h.is_owner===!0||g==="owner"||g==="admin"||_==="owner"||_==="admin"}function s(){return localStorage.getItem(n)==="client"?"client":"personal"}function i(){const h=localStorage.getItem(e);if(!h||h==="null"||h==="0"||h==="")return null;const g=parseInt(h,10);return isNaN(g)?null:g}function r(h){try{window.dispatchEvent(new CustomEvent("pearnly:workspace-changed",{detail:{id:h,mode:s()}}))}catch{}}function c(h){const g=i();h==null||h===0?localStorage.removeItem(e):(localStorage.setItem(e,String(h)),localStorage.setItem(n,"client")),String(g)!==String(h)&&r(h)}function f(){const h=i();localStorage.setItem(n,"personal"),localStorage.removeItem(e),h!=null&&r(null)}async function d(){try{const h=window.apiGet;if(typeof h!="function")return[];const g=await h("/api/workspace/clients");return g&&(g.clients||g.items)||[]}catch{return[]}}async function u(h){if(s()==="client"&&i()!=null)return typeof h=="function"&&h(),!0;const g=a("ws-need-client","这个功能需要先选择工作空间"),_=a("ws-btn-pick","选择工作空间"),w=a("ws-btn-cancel","取消");return typeof window.showConfirm=="function"?await window.showConfirm(g,{okText:_,cancelText:w})&&l(h):window.confirm(g+`

[`+_+" / "+w+"]")&&l(h),!1}async function l(h){const g=await d();if(typeof h=="function"&&s()!=="personal"&&g.length===1){c(Number(g[0].id)),h();return}if(typeof window.openWorkspaceChooserUI=="function"){window.openWorkspaceChooserUI({clients:g,active:i(),onPersonal:f,onPick:function(_){c(Number(_)),typeof h=="function"&&h()},emptyHint:g.length?null:o()?a("ws-empty-owner","还没有工作空间。创建一个公司后,上传、对账和 ERP 推送都会归属到该公司。"):a("ws-empty-employee","你还没有可用的工作空间,请联系管理员分配。")});return}if(!g.length){const _=o()?a("ws-empty-owner","还没有工作空间。创建一个公司后,上传、对账和 ERP 推送都会归属到该公司。"):a("ws-empty-employee","你还没有可用的工作空间,请联系管理员分配。");typeof window.showToast=="function"&&window.showToast(_,"info")}}function p(h){const g=h||document.getElementById("workspace-switcher-root");if(!g)return;const _=s(),w=i();let k,x;if(_==="client"&&w!=null){const L=(window._workspaceClientsCache||[]).find(B=>Number(B.id)===Number(w));k=v("building"),x=L?L.name:a("ws-current-label","当前工作空间")}else k=v("user"),x=a("ws-personal","个人事务");g.innerHTML='<button class="ws-ctrl-btn" id="ws-ctrl-btn" type="button">'+k+'<span class="ws-ctrl-label">'+m(x)+"</span></button>";const E=g.querySelector("#ws-ctrl-btn");E&&E.addEventListener("click",()=>l(null))}function m(h){return String(h??"").replace(/[&<>"']/g,function(g){return{"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"}[g]})}function v(h){const g='<svg class="ws-ic" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">';return h==="building"?g+'<rect x="2" y="7" width="20" height="14" rx="2"/><path d="M16 21V5a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v16"/></svg>':g+'<path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/></svg>'}function y(h){h=h||{};const g=h.clients||[],_=h.active,w=document.getElementById("ws-modal");w&&w.remove();const k=document.createElement("div");k.id="ws-modal",k.className="ws-modal";const E='<button type="button" class="ws-modal-item'+(s()==="personal"||_==null?" active":"")+'" data-ws-personal="1"><span class="ws-modal-item-ic">'+v("user")+'</span><span class="ws-modal-item-text" style="display:flex;flex-direction:column;align-items:flex-start;min-width:0;"><span class="ws-modal-item-name">'+m(a("ws-personal","个人事务"))+'</span><span class="ws-modal-item-desc" style="font-size:11px;color:#6b7280;font-weight:400;margin-top:2px;line-height:1.35;white-space:normal;">'+m(a("ws-personal-desc","用于临时识别、测试或处理不归属任何公司的文件。"))+"</span></span></button>";let I="";if(g.length){const M=['<option value="">'+m(a("ws-select-ph","— 选择账套主体 —"))+"</option>"].concat(g.map(function(R){const V=_!=null&&Number(_)===Number(R.id);return'<option value="'+m(R.id)+'"'+(V?" selected":"")+">"+m(R.name||"#"+R.id)+"</option>"}));I='<div class="ws-modal-item ws-modal-item-account"><span class="ws-modal-item-ic">'+v("building")+'</span><span class="ws-modal-item-text" style="display:flex;flex-direction:column;align-items:flex-start;min-width:0;flex:1;"><span class="ws-modal-item-name">'+m(a("ws-select-label","账套主体"))+'</span><select class="ws-modal-select" data-ws-select="1" style="margin-top:6px;width:100%;">'+M.join("")+"</select></span></div>"}const L=!g.length&&h.emptyHint?'<div class="ws-modal-empty">'+m(h.emptyHint)+"</div>":"",B='<div class="ws-modal-hint" style="font-size:12px;color:#6b7280;padding:10px 4px 2px;line-height:1.5;white-space:normal;">'+m(a("ws-add-hint","如需新增账套主体,请前往「客户管理」添加"))+"</div>";k.innerHTML='<div class="ws-modal-box" role="dialog" aria-modal="true"><div class="ws-modal-head"><span class="ws-modal-title">'+m(a("ws-chooser-title","选择工作空间"))+'</span><button type="button" class="ws-modal-close" data-ws-close="1" aria-label="close">✕</button></div><div class="ws-modal-subtitle" style="font-size:12px;color:#6b7280;padding:2px 4px 12px;line-height:1.45;white-space:normal;">'+m(a("ws-chooser-subtitle","账套主体 = 你的公司(发票卖方/开票方)。选择正在为哪家公司做账。"))+'</div><div class="ws-modal-list">'+E+I+"</div>"+L+B+"</div>",document.body.appendChild(k);const C=k.querySelector("[data-ws-select]");C&&C.addEventListener("change",function(){const M=C.value;M&&(typeof h.onPick=="function"&&h.onPick(M),S(),p())});function S(){k.remove()}k.addEventListener("click",function(M){if(M.target===k||M.target.closest("[data-ws-close]")){S();return}if(M.target.closest("[data-ws-personal]")){typeof h.onPersonal=="function"&&h.onPersonal(),S(),p();return}const V=M.target.closest("[data-ws-pick]");if(V){const ne=V.getAttribute("data-ws-pick");typeof h.onPick=="function"&&h.onPick(ne),S(),p();return}})}window.openWorkspaceChooserUI=y,window.addEventListener("pearnly:workspace-changed",function(){p()}),window.getWorkMode=s,window.getActiveWorkspaceClientId=i,window.setActiveWorkspaceClientId=c,window.enterPersonalMode=f,window.requireWorkspace=u,window.openWorkspaceChooser=l,window.renderWorkspaceControl=p,window.fetchWorkspaceClients=d;function b(){try{if(sessionStorage.getItem("pearnly_ws_login_prompted")==="1"||i()!=null||localStorage.getItem(n)==="personal")return;sessionStorage.setItem("pearnly_ws_login_prompted","1"),setTimeout(function(){l(null)},800)}catch{}}d().then(h=>{window._workspaceClientsCache=h,p(),b()}),typeof window.subscribeI18n=="function"&&window.subscribeI18n("workspace-switcher",p)})();(function(){const e=w=>document.querySelector('[data-num-target="'+w+'"]');function n(w){if(!w)return t("reconcile-last-activity-none");try{const k=new Date(w),x=new Date,E=x-k;if(E/6e4<5)return t("reconcile-last-activity-just-now");if(k.toDateString()===x.toDateString())return t("reconcile-last-activity-today");const L=Math.max(1,Math.floor(E/(24*3600*1e3)));return t("reconcile-last-activity-days-ago").replace("{n}",L)}catch{return t("reconcile-last-activity-none")}}function a(w,k,x){const E=e(w);E&&(E.textContent=x?"-":String(k),E.classList.toggle("is-empty",!!x))}function o(w){const k=document.getElementById("reconcile-error");k&&(k.style.display=w?"flex":"none")}function s(w){const k=document.getElementById("reconcile-empty");k&&(k.style.display=w?"flex":"none")}function i(w,k){const x=document.getElementById("reconcile-last-activity");x&&(x.textContent=w,x.classList.toggle("has-data",!!k))}function r(w){const k=!w||(w.total_sessions||0)===0;a("pending",w.pending||0,k),a("matched",w.matched||0,k),a("unmatched",w.unmatched||0,k),i(n(w.last_activity_at),!!w.last_activity_at),o(!1),s(k)}function c(w){const k=w.toUpperCase();return k==="KBANK"?"bank-chip-kbank":k==="SCB"?"bank-chip-scb":k==="BBL"?"bank-chip-bbl":k==="KTB"?"bank-chip-ktb":k==="TTB"?"bank-chip-ttb":"bank-chip-other"}function f(w,k){const x=E=>E?String(E).slice(0,10):"?";return!w&&!k?"":x(w)+" ~ "+x(k)}function d(w){return w==null?"":String(w).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function u(w){const k=document.getElementById("reconcile-recent"),x=document.getElementById("reconcile-recent-list");if(!k||!x)return;const E=(w||[]).slice(0,20);if(E.length===0){k.style.display="none";return}k.style.display="",s(!1),x.innerHTML=E.map(I=>{const L=I.parse_status==="parse_failed",B=I.bank_code||"OTHER",C=I.account_last4?" ···"+d(I.account_last4):"",S=f(I.period_start,I.period_end),M=d(I.source_filename||""),R=Number(I.tx_count||0),V=L?'<span class="recon-card-fail" data-i18n="reconcile-card-parse-failed">'+t("reconcile-card-parse-failed")+"</span>":'<span class="recon-card-tx">'+t("reconcile-card-tx").replace("{n}",R)+"</span>";return'<div class="recon-card" data-session-id="'+d(I.id)+'" data-session-name="'+M+'"><span class="bank-chip '+c(B)+'">'+d(B)+'</span><div class="recon-card-main"><div class="recon-card-title">'+M+C+'</div><div class="recon-card-sub">'+d(S)+'</div></div><div class="recon-card-right">'+V+'</div><button class="recon-card-trash" data-trash="'+d(I.id)+'" title="'+d(t("bank-session-delete-tip")||"删除")+'"><svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"><path d="M3 5h10M6 5V3h4v2M5 5l1 9h4l1-9"/></svg></button><svg class="recon-card-arrow" viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M6 4l4 4-4 4"/></svg></div>'}).join(""),x.querySelectorAll(".recon-card").forEach(I=>{I.addEventListener("click",L=>{L.target.closest(".recon-card-trash")||(I.dataset.sessionId,l())})}),x.querySelectorAll(".recon-card-trash").forEach(I=>{I.addEventListener("click",L=>{L.stopPropagation();const B=I.dataset.trash,C=I.closest(".recon-card"),S=C&&C.dataset.sessionName||"";typeof window._deleteBankSession=="function"&&window._deleteBankSession(B,S)})})}function l(w){typeof window.routeTo=="function"&&window.routeTo("reconcile"),setTimeout(function(){const k=document.querySelector('[data-recon-tab="bank"]');k&&k.click()},150)}function p(){o(!0),s(!1)}function m(){typeof window.routeTo=="function"&&window.routeTo("reconcile"),setTimeout(function(){const w=document.querySelector('[data-recon-tab="bank"]');w&&w.click()},150)}async function v(){a("pending",0,!0),a("matched",0,!0),a("unmatched",0,!0),i("",!1),o(!1),s(!1);const w=document.getElementById("reconcile-recent");w&&(w.style.display="none");const k={Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||"")};try{const[x,E]=await Promise.all([fetch("/api/bank-recon/stats",{headers:k}),fetch("/api/bank-recon/sessions?limit=20",{headers:k})]);if(!x.ok)throw new Error("http "+x.status);const I=await x.json(),L=E.ok?await E.json():[];r(I||{}),u(L||[])}catch(x){console.warn("[reconcile] load failed",x),p()}}function y(w){if(!w||!w.length)return;const k="Bearer "+(localStorage.getItem("mrpilot_token")||"");let x=0;const E=w.length;Array.from(w).forEach(function(I){const L=new FormData;L.append("file",I,I.name);const B=new XMLHttpRequest;B.open("POST","/api/bank-recon/upload"),B.setRequestHeader("Authorization",k),B.onload=function(){x++;try{const C=JSON.parse(B.responseText);B.status===200&&C.tx_count!==void 0?showToast((t("bank-upload-ok")||"解析成功 · 共 {n} 条流水").replace("{n}",C.tx_count),"success"):showToast(I.name+" "+(t("upload-failed")||"上传失败"),"error")}catch{showToast(I.name+" "+(t("upload-failed")||"上传失败"),"error")}x===E&&setTimeout(v,600)},B.onerror=function(){x++,showToast(I.name+" "+(t("upload-failed")||"上传失败"),"error"),x===E&&setTimeout(v,600)},B.send(L)}),showToast((t("bank-queue-status-uploading")||"上传中")+"…","info")}function b(){if(window.__reconcileBound)return;window.__reconcileBound=!0;const w=document.getElementById("reconcile-bank-file-input");w&&w.addEventListener("change",function(){y(this.files),this.value=""}),document.addEventListener("click",k=>{if(k.target.closest("#btn-reconcile-upload-top")||k.target.closest("#btn-reconcile-upload-empty")){m();return}if(k.target.closest("#btn-reconcile-retry")){v();return}if(k.target.closest("#btn-reconcile-dev-seed")){_();return}})}const h=["468b50c1-5593-4fd6-990d-515ce8085563"];function g(){const w=document.getElementById("btn-reconcile-dev-seed");if(!w)return;const k=typeof _userInfo<"u"?_userInfo:null,x=k&&k.id&&h.indexOf(String(k.id))>=0;w.style.display=x?"":"none"}async function _(){try{const w=await fetch("/api/bank-recon/_dev/seed",{method:"POST",headers:{Authorization:"Bearer "+token}});if(!w.ok)throw new Error("seed:"+w.status);const k=await w.json(),x=(t("reconcile-dev-seed-ok")||"").replace("{n}",k.tx_count||0);showToast(x,"success"),typeof window.navigateTo=="function"?window.navigateTo("automation"):location.hash="#/automation",setTimeout(()=>{const E=document.querySelector('[data-auto-tab="bank"]');E&&E.click(),k.session_id&&typeof window._openBankSession=="function"&&window._openBankSession(k.session_id)},300)}catch(w){console.warn("[reconcile] dev seed failed",w),showToast(t("reconcile-dev-seed-fail")||"Seed failed","error")}}window.loadReconcilePage=async function(){b(),g(),typeof window._bankReconV2Init=="function"&&window._bankReconV2Init();try{await v()}catch{}},window._rerenderReconcile=function(){typeof currentRoute=="string"&&currentRoute==="reconcile"&&v().catch(()=>{})},typeof window.subscribeI18n=="function"&&window.subscribeI18n("reconcile",window._rerenderReconcile)})();(function(){const e=document.getElementById("assign-clients-modal");if(!(!e||e.dataset.wbInjected==="1")){e.innerHTML=`
    <div class="modal" style="max-width:480px">
        ...
        <div class="modal-foot">
    ...
    </div>`,e.dataset.wbInjected="1";try{const n=window._currentLang||localStorage.getItem("mrpilot_lang")||"th",a=window.I18N;a&&a[n]&&e.querySelectorAll("[data-i18n]").forEach(o=>{const s=o.getAttribute("data-i18n");s&&a[n][s]&&(o.textContent=a[n][s])})}catch{}}})();(function(){let e={employeeId:null,employeeName:"",clients:[],selected:new Set,opened:!1};function n(){return document.getElementById("assign-clients-modal")}function a(){return document.getElementById("assign-clients-list")}function o(){return document.getElementById("assign-select-all")}function s(){return document.getElementById("assign-selected-count")}function i(){return document.getElementById("assign-modal-target")}function r(){const v=a();if(v){if(!e.clients.length){v.innerHTML='<div class="assign-empty">'+escapeHtml(t("assign-no-clients")||"暂无客户 · 请先到「客户管理」添加")+"</div>";return}v.innerHTML=e.clients.map(y=>{const b=String(y.id),h=e.selected.has(b)?"checked":"",g=escapeHtml(y.name||y.label||"#"+b),_=y.code?'<span class="assign-row-code">'+escapeHtml(y.code)+"</span>":"";return'<label class="assign-row"><input type="checkbox" data-cid="'+escapeHtml(b)+'" '+h+'><span class="assign-row-name">'+g+"</span>"+_+"</label>"}).join(""),c()}}function c(){const v=s();if(v){const b=t("assign-selected-count")||"已选 {n} / {total}";v.textContent=b.replace("{n}",e.selected.size).replace("{total}",e.clients.length)}const y=o();y&&(y.checked=e.clients.length>0&&e.selected.size===e.clients.length)}function f(){const v=i();v&&(v.textContent=e.employeeName?" · "+e.employeeName:"")}async function d(v,y){e.employeeId=v,e.employeeName=y||"",e.opened=!0,e.selected=new Set,e.clients=[],f();const b=a();b&&(b.innerHTML='<div class="assign-empty">'+escapeHtml(t("assign-loading")||"加载中...")+"</div>");const h=n();h&&(h.style.display="flex");try{const[g,_]=await Promise.all([apiGet("/api/clients?include_inactive=false"),apiGet("/api/team/employees/"+encodeURIComponent(v)+"/assignments")]);e.clients=g&&g.clients||[];const w=_&&_.client_ids||[];e.selected=new Set(w.map(String)),r()}catch(g){console.error("[assign-clients] load failed",g);const _=a();_&&(_.innerHTML='<div class="assign-empty">'+escapeHtml(t("assign-load-failed")||"加载失败 · 请重试")+"</div>")}}function u(){e.opened=!1;const v=n();v&&(v.style.display="none")}async function l(){if(!e.employeeId)return;const v=Array.from(e.selected).map(b=>parseInt(b,10)).filter(b=>!isNaN(b)),y=document.getElementById("assign-modal-save");y&&(y.disabled=!0);try{const b=await apiPost("/api/team/employees/"+encodeURIComponent(e.employeeId)+"/assignments",{client_ids:v});b&&b.ok!==!1?(showToast((t("assign-saved")||"已保存 {n} 个客户分配").replace("{n}",v.length),"success"),u(),typeof loadTeamList=="function"&&loadTeamList()):showToast(t("assign-save-failed")||"保存失败","error")}catch(b){console.error("[assign-clients] save failed",b),showToast(t("assign-save-failed")||"保存失败","error")}finally{y&&(y.disabled=!1)}}function p(){const v=n();if(!v||v.dataset.bound==="1")return;v.dataset.bound="1";const y=document.getElementById("assign-modal-close");y&&y.addEventListener("click",u);const b=document.getElementById("assign-modal-cancel");b&&b.addEventListener("click",u);const h=document.getElementById("assign-modal-save");h&&h.addEventListener("click",l),v.addEventListener("click",function(w){w.target===v&&u()});const g=o();g&&g.addEventListener("change",function(){g.checked?e.selected=new Set(e.clients.map(w=>String(w.id))):e.selected=new Set,r()});const _=a();_&&_.addEventListener("change",function(w){const k=w.target.closest('input[type="checkbox"][data-cid]');if(!k)return;const x=k.dataset.cid;k.checked?e.selected.add(x):e.selected.delete(x),c()})}function m(){e.opened&&(f(),r())}typeof window.subscribeI18n=="function"&&window.subscribeI18n("assign-clients-modal",m),window.openAssignClientsModal=function(v,y){p(),d(v,y)}})();(function(){const e={page:1,per_page:50,q:"",total:0,rows:[],loaded:!1};function n(u){if(!u)return"";try{return new Date(u).toLocaleString()}catch{return u}}function a(u){const l=document.getElementById("access-log-table");l&&(l.innerHTML='<div class="access-log-empty">'+escapeHtml(u)+"</div>");const p=document.getElementById("access-log-pager");p&&(p.innerHTML="")}function o(){const u=document.getElementById("access-log-table");if(!u)return;const l=e.rows||[];if(!l.length){a(t("set-access-log-empty"));return}const p=`
            <div class="access-log-row access-log-head">
                ...
                </div>`}).join("");u.innerHTML=p+m}function s(){const u=document.getElementById("access-log-pager");if(!u)return;const l=e.total||0;if(!l){u.innerHTML="";return}const p=e.page||1,m=e.per_page,v=Math.max(1,Math.ceil(l/m)),y=(t("set-access-log-pager-total")||"Total {n}").replace("{n}",l),b=(t("set-access-log-pager-page")||"Page {p} / {t}").replace("{p}",p).replace("{t}",v);u.innerHTML=`
            ...
            </div>`}async function i(u){const l=localStorage.getItem("mrpilot_token");if(l){e.page=u||1,a(t("set-access-log-loading"));try{const p="/api/me/access_log?page="+e.page+"&per_page="+e.per_page+"&q="+encodeURIComponent(e.q||""),m=await fetch(p,{headers:{Authorization:"Bearer "+l}});if(m.status===403){a(t("set-access-log-empty"));return}if(!m.ok)throw new Error("http_"+m.status);const v=await m.json();e.rows=v.logs||[],e.total=v.total||0,e.loaded=!0,o(),s()}catch{a(t("set-access-log-fail"))}}}async function r(){const u=localStorage.getItem("mrpilot_token");if(u)try{const l="/api/me/access_log.csv?q="+encodeURIComponent(e.q||""),p=await fetch(l,{headers:{Authorization:"Bearer "+u}});if(!p.ok){showToast(t("set-access-log-csv-fail")||"Export failed","error");return}const m=await p.blob(),v=document.createElement("a"),y=URL.createObjectURL(m);v.href=y,v.download="pearnly_access_log.csv",document.body.appendChild(v),v.click(),setTimeout(function(){URL.revokeObjectURL(y),v.remove()},100),showToast(t("set-access-log-csv-ok")||"Exported","success")}catch{showToast(t("set-access-log-csv-fail")||"Export failed","error")}}function c(){const u=document.querySelectorAll(".set-tab-owner-only"),l=!!(_userInfo&&(_userInfo.role==="owner"||_userInfo.is_super_admin));u.forEach(function(p){p.style.display=l?"":"none"})}document.addEventListener("click",function(u){if(u.target.closest('.settings-tab[data-tab="access-log"]')){setTimeout(function(){(!e.loaded||e.page!==1)&&i(1)},50);return}if(u.target.closest("#access-log-csv-btn")){u.preventDefault(),r();return}const m=u.target.closest(".access-log-pager-btn[data-access-log-page]");if(m&&!m.disabled){const v=parseInt(m.dataset.accessLogPage,10);i(v)}}),document.addEventListener("input",function(u){u.target&&u.target.id==="access-log-search"&&(clearTimeout(window.__accessLogSearchTimer),window.__accessLogSearchTimer=setTimeout(function(){e.q=(u.target.value||"").trim(),i(1)},350))});let f=0;const d=setInterval(function(){f++,_userInfo&&(c(),clearInterval(d)),f>60&&clearInterval(d)},500);typeof window.subscribeI18n=="function"&&window.subscribeI18n("me-access-log",function(){c(),e.loaded&&(o(),s())})})();(function(){const e=document.getElementById("notif-new-modal");if(!(!e||e.dataset.wbInjected==="1")){e.innerHTML=`
...
`,e.dataset.wbInjected="1";try{const n=window._currentLang||localStorage.getItem("mrpilot_lang")||"th",a=window.I18N;a&&a[n]&&(e.querySelectorAll("[data-i18n]").forEach(o=>{const s=o.getAttribute("data-i18n");s&&a[n][s]&&(o.textContent=a[n][s])}),e.querySelectorAll("[data-i18n-placeholder]").forEach(o=>{const s=o.getAttribute("data-i18n-placeholder");s&&a[n][s]&&(o.placeholder=a[n][s])}))}catch{}}})();(function(){const e=k=>document.getElementById(k);async function n(k,x){return await fetch(k,{method:"PATCH",headers:{Authorization:"Bearer "+token,"Content-Type":"application/json"},body:JSON.stringify(x||{})})}async function a(k){return await fetch(k,{method:"DELETE",headers:{Authorization:"Bearer "+token}})}let o=null;async function s(){try{o=await apiGet("/api/line/binding")}catch{o={bound:!1}}return o}function i(k,x){if(!k)return;k.style.display="",k.className="notif-line-check "+(x?"bound":"unbound");const E=x?'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M20 6 9 17l-5-5"/></svg>':'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><path d="M12 8v4M12 16h.01"/></svg>';k.innerHTML=E+"<span>"+escapeHtml(t(x?"notif-line-bound":"notif-line-not-bound"))+"</span>"}function r(k){if(!k)return"-";try{const x=new Date(k),E=(x.getMonth()+1).toString().padStart(2,"0"),I=x.getDate().toString().padStart(2,"0"),L=x.getHours().toString().padStart(2,"0"),B=x.getMinutes().toString().padStart(2,"0");return`${E}-${I} ${L}:${B}`}catch{return k}}function c(k){const x=e("notif-rules-list"),E=e("notif-rules-empty"),I=e("notif-rules-count");if(!(!x||!E)){if(I.textContent=String(k.length),I.className="auto-status-pill "+(k.length>0?"active":"none"),!k.length){E.style.display="",x.style.display="none",x.innerHTML="";return}E.style.display="none",x.style.display="",x.innerHTML=k.map(L=>{const B="notif-rule-exception-tag";let S=[];L.enabled||S.push('<span style="color:#9ca3af;">'+escapeHtml(t("notif-rule-disabled"))+"</span>");const M=S.length?S.join(' <span class="dot"></span> '):"";return`
                <div class="notif-rule-row${L.enabled?"":" disabled"}" data-rule-id="${L.id}">
                    ...
                    <div class="notif-rule-main">
                        ...
                        <div class="notif-rule-meta">${M}</div>
                    </div>
                ...
                </div>`}).join("")}}function f(k){const x=e("notif-logs-list");if(x){if(!k.length){x.innerHTML='<div class="notif-logs-empty">'+escapeHtml(t("notif-logs-empty"))+"</div>";return}x.innerHTML=k.map(E=>{const I=E.status==="sent",L=E.event_type==="exception_high"?"notif-event-exception-high":"notif-event-test-send",B=I?"":" · "+escapeHtml(E.error||"failed");return`
                ...
                </div>`}).join("")}}async function d(){try{const k=await apiGet("/api/notifications/rules");u=k&&k.items||[],c(u)}catch(k){console.warn("load rules fail",k)}try{const k=await apiGet("/api/notifications/logs?limit=20");l=k&&k.items||[],f(l)}catch(k){console.warn("load logs fail",k)}}let u=null,l=null;function p(){u&&c(u),l&&f(l);const k=e("notif-new-modal");k&&k.style.display!=="none"&&o&&i(e("notif-line-check"),!!(o&&o.bound))}function m(){const k=e("notif-new-modal");k&&(k.style.display="",e("notif-new-name").value="",document.querySelectorAll('input[name="notif-template"]').forEach(x=>x.checked=!1),s().then(x=>i(e("notif-line-check"),!!(x&&x.bound))))}function v(){const k=e("notif-new-modal");k&&(k.style.display="none")}function y(){if(!document.querySelector('input[name="notif-template"]:checked'))return;const x=e("notif-new-name");x&&!x.value.trim()&&(x.value=t("notif-tmpl-exception-name"))}async function b(){const k=document.querySelector('input[name="notif-template"]:checked');if(!k){showToast(t("notif-new-template"),"error");return}const x=(e("notif-new-name").value||"").trim();if(!x){showToast(t("notif-name-required"),"error");return}const E={name:x,template_code:k.value,params:{},enabled:!0};try{const I=await apiPost("/api/notifications/rules",E);if(I&&I.ok)showToast(t("notif-toast-created"),"success"),v(),d();else{const L=await(I&&I.json&&I.json().catch(()=>({})))||{};showToast(L&&L.detail||"save failed","error")}}catch{showToast("save failed","error")}}async function h(k,x,E){if(k==="toggle"){const I=E.classList.contains("on"),L=await n("/api/notifications/rules/"+x,{enabled:!I});L&&L.ok?(showToast(t(I?"notif-toast-toggled-off":"notif-toast-toggled-on"),"success"),d()):showToast("toggle failed","error");return}if(k==="test"){const I=await s();if(!I||!I.bound){showToast(t("notif-line-error-bind-first"),"error");return}const L=await apiPost("/api/notifications/rules/"+x+"/test",{});if(L&&L.ok)showToast(t("notif-toast-test-sent"),"success"),d();else{const B=await(L&&L.json&&L.json().catch(()=>({})))||{},C=B&&B.detail||"";showToast(C||t("notif-toast-test-failed"),"error"),d()}return}if(k==="delete"){if(!await showConfirm(t("notif-confirm-delete"),{danger:!0}))return;const L=await a("/api/notifications/rules/"+x);L&&L.ok?(showToast(t("notif-toast-deleted"),"success"),d()):showToast("delete failed","error");return}}let g=!1;function _(){if(g)return;g=!0;const k=e("notif-btn-new");k&&k.addEventListener("click",m);const x=e("notif-btn-refresh-logs");x&&x.addEventListener("click",d);const E=e("notif-new-close");E&&E.addEventListener("click",v);const I=e("notif-new-cancel");I&&I.addEventListener("click",v);const L=e("notif-new-save");L&&L.addEventListener("click",b),document.querySelectorAll('input[name="notif-template"]').forEach(S=>{S.addEventListener("change",y)});const B=e("notif-rules-list");B&&B.addEventListener("click",S=>{const M=S.target.closest("button[data-action]");if(!M)return;const R=M.closest("[data-rule-id]");R&&h(M.getAttribute("data-action"),R.getAttribute("data-rule-id"),M)});const C=e("notif-new-modal");C&&C.addEventListener("click",S=>{S.target===C&&v()})}async function w(){_(),await d()}window._loadNotificationsPanel=w,window._rerenderNotifications=p})();(function(){function n(h,g){try{return window.t&&window.t(h)||g}catch{return g}}function a(){var h="";try{h=localStorage.getItem("mrpilot_token")||""}catch{}return h?{Authorization:"Bearer "+h}:{}}var o=[{tbody:"vex-task-tbody",api:"/api/recon/tasks/batch_delete",reload:function(){try{window.loadRecentTasks&&window.loadRecentTasks()}catch{}},kind:"vex"},{tbody:"glv-history-tbody",api:"/api/recon/gl-vat/tasks/batch_delete",reload:function(){try{window._loadGlvHistory&&window._loadGlvHistory()}catch{}},kind:"glv"},{tbody:"brv2-history-tbody",api:"/api/recon/bank-v2/tasks/batch_delete",reload:function(){try{window._brv2LoadHistory&&window._brv2LoadHistory()}catch{}},kind:"brv2"}];function s(){if(!document.getElementById("recon-batch-style")){var h=document.createElement("style");h.id="recon-batch-style",h.textContent=".recon-sel-cell{width:36px;text-align:center;padding-left:10px!important;padding-right:6px!important}.recon-sel-cb,.recon-master-cb{cursor:pointer;width:14px;height:14px;accent-color:#111;margin:0;vertical-align:middle}th.recon-time-col,td.recon-time-col{white-space:nowrap}tr.recon-thead-batch{display:none}thead.recon-batch-mode tr.recon-thead-default{display:none}thead.recon-batch-mode tr.recon-thead-batch{display:table-row}tr.recon-thead-batch th{background:#fafaf8;border-bottom:1px solid #e8e8e3;padding:8px 12px}tr.recon-thead-batch .recon-batch-inline{display:flex;align-items:center;gap:10px;font-size:12px;color:#111;font-weight:normal}tr.recon-thead-batch .recon-batch-count-inline{font-weight:600;color:#111;margin-right:4px}tr.recon-thead-batch .recon-batch-del-inline{background:#dc2626;color:#fff;border:none;border-radius:6px;padding:4px 10px;font-size:12px;font-weight:600;cursor:pointer;font-family:inherit;display:inline-flex;align-items:center;gap:4px}tr.recon-thead-batch .recon-batch-del-inline:hover{background:#b91c1c}tr.recon-thead-batch .recon-batch-clear-inline{background:transparent;border:none;color:#555;cursor:pointer;font-size:12px;font-family:inherit;text-decoration:underline;padding:4px 2px}tr.recon-thead-batch .recon-batch-clear-inline:hover{color:#111}.recon-batch-bar{display:none!important}",document.head.appendChild(h)}}function i(h){return h?h.dataset&&h.dataset.taskId?h.dataset.taskId:h.dataset&&h.dataset.taskid?h.dataset.taskid:"":""}function r(h){var g=document.getElementById(h.tbody);if(!g)return null;var _=g.closest("table");if(!_)return null;var w=_.querySelector("thead");if(!w)return null;if(w._reconReady)return w;var k=w.querySelector("tr");if(!k)return null;if(k.classList.add("recon-thead-default"),!k.querySelector(".recon-master-cb")){var x=document.createElement("th");x.className="recon-sel-cell";var E=document.createElement("input");E.type="checkbox",E.className="recon-master-cb",E.setAttribute("aria-label","select all"),E.addEventListener("change",function(){u(h,E.checked)}),x.appendChild(E),k.insertBefore(x,k.firstElementChild)}var I=k.children[1];I&&!I.classList.contains("recon-time-col")&&I.classList.add("recon-time-col");var L=k.children.length,B=document.createElement("tr");B.className="recon-thead-batch";var C=document.createElement("th");C.className="recon-sel-cell";var S=document.createElement("input");S.type="checkbox",S.className="recon-master-cb",S.checked=!0,S.setAttribute("aria-label","select all"),S.addEventListener("change",function(){u(h,S.checked)}),C.appendChild(S);var M=document.createElement("th");return M.setAttribute("colspan",String(L-1)),M.innerHTML='<div class="recon-batch-inline"><span class="recon-batch-count-inline" data-recon-count></span><button type="button" class="recon-batch-del-inline" data-recon-del><svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" width="13" height="13"><polyline points="3 4 13 4"/><path d="M6 4V2.5a.5.5 0 0 1 .5-.5h3a.5.5 0 0 1 .5.5V4"/><path d="M5 4l1 9a1 1 0 0 0 1 1h2a1 1 0 0 0 1-1l1-9"/></svg><span data-recon-del-label></span></button><button type="button" class="recon-batch-clear-inline" data-recon-clear></button></div>',B.appendChild(C),B.appendChild(M),w.appendChild(B),M.querySelector("[data-recon-del]").addEventListener("click",function(){v(h)}),M.querySelector("[data-recon-clear]").addEventListener("click",function(){m(h)}),w._reconReady=!0,p(h),w}function c(h){var g=document.getElementById(h.tbody);if(g){var _=g.querySelectorAll("tr");_.forEach(function(w){var k=i(w);if(k&&!w.querySelector(".recon-sel-cb")){var x=w.querySelector("td");if(x){var E=document.createElement("td");E.className="recon-sel-cell";var I=document.createElement("input");I.type="checkbox",I.className="recon-sel-cb",I.dataset.taskId=k,I.dataset.kind=h.kind,I.addEventListener("click",function(B){B.stopPropagation()}),I.addEventListener("change",function(){l(h)}),E.appendChild(I),w.insertBefore(E,x);var L=w.children[1];L&&!L.classList.contains("recon-time-col")&&L.classList.add("recon-time-col")}}}),l(h)}}function f(h){var g=document.getElementById(h.tbody);return g?Array.prototype.slice.call(g.querySelectorAll(".recon-sel-cb")):[]}function d(h){return f(h).filter(function(g){return g.checked}).map(function(g){return g.dataset.taskId})}function u(h,g){f(h).forEach(function(_){_.checked=!!g}),l(h)}function l(h){var g=d(h),_=f(h),w=document.getElementById(h.tbody);if(w){var k=w.closest("table"),x=k&&k.querySelector("thead");if(x){g.length>0?x.classList.add("recon-batch-mode"):x.classList.remove("recon-batch-mode"),x.querySelectorAll(".recon-master-cb").forEach(function(I){if(_.length===0){I.checked=!1,I.indeterminate=!1;return}g.length===_.length?(I.checked=!0,I.indeterminate=!1):g.length===0?(I.checked=!1,I.indeterminate=!1):(I.checked=!1,I.indeterminate=!0)});var E=x.querySelector("[data-recon-count]");E&&(E.textContent=n("recon-batch-selected-n","已选 {n} 条").replace("{n}",g.length))}}}function p(h){var g=document.getElementById(h.tbody);if(g){var _=g.closest("table"),w=_&&_.querySelector("thead");if(w){var k=w.querySelector("[data-recon-del-label]"),x=w.querySelector("[data-recon-clear]");k&&(k.textContent=n("recon-batch-delete","批量删除")),x&&(x.textContent=n("recon-batch-clear","取消")),l(h)}}}function m(h){f(h).forEach(function(g){g.checked=!1}),l(h)}async function v(h){var g=d(h);if(g.length){var _=n("recon-batch-delete-confirm","确定删除选中的 {n} 条对账任务?此操作不可恢复").replace("{n}",g.length),w=!1;try{typeof window.pearnlyConfirm=="function"?w=await window.pearnlyConfirm(_,n("recon-batch-delete-title","批量删除")):w=window.confirm(_)}catch{w=!1}if(w)try{var k=Object.assign({"Content-Type":"application/json"},a()),x=h.kind==="glv"?g.map(function(B){return parseInt(B,10)}):g,E=await fetch(h.api,{method:"POST",headers:k,body:JSON.stringify({ids:x})});if(!E.ok){typeof window.showToast=="function"&&window.showToast(n("recon-batch-delete-fail","批量删除失败"),"error");return}var I=await E.json(),L=I&&(I.deleted!=null?I.deleted:I.count)||g.length;typeof window.showToast=="function"&&window.showToast(n("recon-batch-delete-ok","已删除 {n} 条").replace("{n}",L),"success"),h.reload()}catch{typeof window.showToast=="function"&&window.showToast(n("recon-batch-delete-fail","批量删除失败"),"error")}}}function y(h){r(h),c(h);var g=document.getElementById(h.tbody);if(!(!g||g._reconBatchWatched)){g._reconBatchWatched=!0;var _=new MutationObserver(function(){c(h)});_.observe(g,{childList:!0,subtree:!1})}}function b(){s(),o.forEach(y),document.querySelectorAll(".recon-batch-bar").forEach(function(h){try{h.remove()}catch{}})}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",b):b(),setTimeout(b,1500),setTimeout(b,4e3),document.addEventListener("keydown",function(h){h.key==="Escape"&&o.forEach(function(g){d(g).length>0&&m(g)})}),typeof window.subscribeI18n=="function"&&window.subscribeI18n("recon-batch-thead",function(){o.forEach(p)})})();(function(){let e={role:"",monthly_volume:"",country:"",line_id:""},n=1;const a=4,o="pilot_ob_dismiss",s="pilot_ob_done";window.maybeShowOnboarding=function(d){};function i(d){n=d;for(let p=1;p<=a;p++){const m=document.getElementById("ob-step-"+p);m&&(m.style.display=p===d?"block":"none")}document.querySelectorAll(".ob-dot").forEach(p=>{const m=parseInt(p.dataset.step,10);p.classList.toggle("active",m===d),p.classList.toggle("done",m<d)});const u=document.getElementById("ob-step-label");u&&(u.textContent=d+" / "+a);const l=document.getElementById("ob-next");if(l&&(l.textContent=d===a?t("ob-finish"):t("ob-next")),d===4){const p=document.getElementById("ob-line-input");p&&(p.value=e.line_id||"")}}function r(d){const u=document.querySelector(".onboarding-modal");if(!u)return;let l=u.querySelector(".ob-feedback");l||(l=document.createElement("div"),l.className="ob-feedback",u.appendChild(l)),l.textContent=d,l.classList.add("show"),setTimeout(()=>l.classList.remove("show"),1800)}document.addEventListener("click",d=>{const u=d.target.closest(".ob-option");if(!u)return;const l=u.parentElement;if(!l||!l.classList.contains("ob-options"))return;l.querySelectorAll(".ob-option").forEach(m=>m.classList.remove("selected")),u.classList.add("selected");const p=u.dataset.value;l.id==="ob-role-options"?e.role=p:l.id==="ob-volume-options"?e.monthly_volume=p:l.id==="ob-country-options"&&(e.country=p)}),document.addEventListener("click",d=>{d.target.id==="ob-skip"&&c()}),document.addEventListener("click",d=>{if(d.target.id==="ob-next"){if(n===4){const u=document.getElementById("ob-line-input");e.line_id=(u&&u.value||"").trim().replace(/^@+/,"")}c()}}),document.addEventListener("click",d=>{if(d.target.closest("#ob-close")){localStorage.setItem(o,String(Date.now()));const u=document.getElementById("onboarding-modal");u&&(u.style.display="none")}});function c(){n===1&&e.role?r(t("ob-fb-role")):n===2&&e.monthly_volume?r(t("ob-fb-volume")):n===3&&e.country?r(t("ob-fb-country")):n===4&&e.line_id&&r(t("ob-fb-line")),n<a?setTimeout(()=>i(n+1),e[Object.keys(e)[n-1]]?350:0):f()}async function f(){const d=document.getElementById("onboarding-modal");localStorage.setItem(s,"1"),localStorage.removeItem(o);const u={};if(e.role&&(u.role=e.role),e.monthly_volume&&(u.monthly_volume=e.monthly_volume),e.country&&(u.country=e.country),e.line_id&&(u.line_id=e.line_id),Object.keys(u).length===0){d&&(d.style.display="none");return}try{const l=await fetch("/api/me/profile",{method:"PUT",headers:{Authorization:"Bearer "+(window.token||localStorage.getItem("mrpilot_token")),"Content-Type":"application/json"},body:JSON.stringify(u)});l.ok?(r(t("ob-fb-done")),window._userInfo&&Object.assign(window._userInfo,u),setTimeout(()=>{d&&(d.style.display="none")},1200)):(localStorage.setItem("pilot_ob_pending",JSON.stringify(u)),console.warn("onboarding profile save failed",l.status),r(t("ob-fb-saved-local")),setTimeout(()=>{d&&(d.style.display="none")},1500))}catch(l){console.error("onboarding submit",l),localStorage.setItem("pilot_ob_pending",JSON.stringify(u)),d&&(d.style.display="none")}}})();(function(){const e=document.getElementById("archive-rule-modal");if(!(!e||e.dataset.wbInjected==="1")){e.innerHTML=`
...
`,e.dataset.wbInjected="1";try{const n=window._currentLang||localStorage.getItem("mrpilot_lang")||"th",a=window.I18N;a&&a[n]&&(e.querySelectorAll("[data-i18n]").forEach(o=>{const s=o.getAttribute("data-i18n");s&&a[n][s]&&(o.textContent=a[n][s])}),e.querySelectorAll("[data-i18n-placeholder]").forEach(o=>{const s=o.getAttribute("data-i18n-placeholder");s&&a[n][s]&&(o.placeholder=a[n][s])}))}catch{}}})();(function(){const e=document.getElementById("archive-token-modal");if(!(!e||e.dataset.wbInjected==="1")){e.innerHTML=`
        <div class="modal" style="max-width:420px;">
            ...
            `}).join("")}}function l(){const w=document.getElementById("archive-field-palette");if(!w)return;const k=["date","seller","category","amount","invoice","buyer","sep"];w.innerHTML=k.map(x=>{const E=i[x],I=s[x]||"";return`
                <button class="archive-palette-btn ${x}" data-add-field="${x}" ${o?"disabled":""}>
                    <span class="token-icon">${I}</span>
                    <span>${escapeHtml(t(E.label))}</span>
                </button>
            `}).join("")}function p(){document.querySelectorAll('input[name="folder-strategy"]').forEach(w=>{w.checked=w.value===n,w.disabled=o})}async function m(){const w=document.getElementById("archive-preview-name"),k=document.getElementById("archive-preview-hint");if(k&&(k.textContent=t("archive-preview-hint",{category:r()})),!!w){if(e.length===0){w.textContent="-";return}try{const E=await(await fetch("/api/archive/rename-preview",{method:"POST",headers:{Authorization:"Bearer "+token,"Content-Type":"application/json"},body:JSON.stringify({merged_fields:f().merged_fields,name_template:e})})).json();w.textContent=(E.name||"-")+".pdf"}catch{w.textContent="("+t("archive-preview-error")+")"}}}window._rerenderArchiveAll=function(){const w=document.getElementById("archive-rule-modal");!w||w.style.display==="none"||(u(),l(),m())};let v=-1;document.addEventListener("dragstart",w=>{const k=w.target.closest(".archive-token");!k||o||(v=parseInt(k.dataset.tokenIdx,10),k.classList.add("dragging"),w.dataTransfer.effectAllowed="move")}),document.addEventListener("dragend",w=>{document.querySelectorAll(".archive-token").forEach(k=>k.classList.remove("dragging","drop-target")),v=-1}),document.addEventListener("dragover",w=>{const k=w.target.closest(".archive-token");k&&(w.preventDefault(),w.dataTransfer.dropEffect="move",document.querySelectorAll(".archive-token").forEach(x=>x.classList.remove("drop-target")),k.classList.add("drop-target"))}),document.addEventListener("drop",w=>{const k=w.target.closest(".archive-token");if(!k||v<0||o)return;w.preventDefault();const x=parseInt(k.dataset.tokenIdx,10);if(x===v)return;const E=e.splice(v,1)[0];e.splice(x,0,E),v=-1,u(),m()}),document.addEventListener("click",w=>{if(w.target.closest("#btn-open-archive-rule")||w.target.closest("#btn-open-archive-rule-from-settings")){const I=document.getElementById("archive-rule-modal");I&&(I.style.display="",d());return}if(w.target.closest("#archive-rule-modal-close")||w.target.id==="archive-rule-modal"){const I=document.getElementById("archive-rule-modal");I&&(I.style.display="none");return}const k=w.target.closest(".settings-nav-item");if(k){switchSettingsTab(k.dataset.settingsTab);return}if(o&&w.target.closest(".archive-token, [data-add-field], #btn-archive-save, #btn-archive-reset")){showToast(t("feature-contact-us"),"info");return}const x=w.target.closest("[data-add-field]");if(x){const I=x.dataset.addField,L=i[I],B={type:I,...L.defaultCfg};e.push(B),u(),m();return}const E=w.target.closest(".archive-token");if(E&&!o){y(parseInt(E.dataset.tokenIdx,10));return}if(w.target.closest("#btn-archive-save"))return g();if(w.target.closest("#btn-archive-reset"))return _();(w.target.closest("#archive-token-close")||w.target.id==="archive-token-modal")&&(document.getElementById("archive-token-modal").style.display="none"),w.target.closest("#btn-archive-token-ok")&&b(),w.target.closest("#btn-archive-token-delete")&&h()}),document.addEventListener("change",w=>{w.target.name==="folder-strategy"&&(n=w.target.value)});function y(w){a=w;const k=e[w];if(!k)return;const x=document.getElementById("archive-token-body");let E="";k.type==="date"?E=`
                <div class="form-group">
        ...
        `}async function n(){try{const o=await fetch("/api/settings/dup-check",{headers:{Authorization:"Bearer "+token}});if(!o.ok)return;const s=await o.json(),i=document.getElementById("pref-dup-check");i&&(i.checked=!!s.enabled)}catch(o){console.warn("load prefs failed",o)}}const a=document.getElementById("pref-dup-check");a&&!a.dataset.bound&&(a.dataset.bound="1",a.addEventListener("change",async o=>{const s=o.target.checked;try{(await fetch("/api/settings/dup-check",{method:"PUT",headers:{Authorization:"Bearer "+token,"Content-Type":"application/json"},body:JSON.stringify({enabled:s})})).ok?showToast(s?t("pref-dup-check-on-toast"):t("pref-dup-check-off-toast"),"success"):(o.target.checked=!s,showToast(t("pref-save-failed"),"error"))}catch{o.target.checked=!s,showToast(t("pref-save-failed"),"error")}}))})();(function(){const o="pearnly_big_batch_tip_shown";let s=null,i=null,r=0,c=0,f=!1;function d(g){const _=typeof t=="function"?t("big-batch-unload-warn"):"Batch OCR running · close anyway?";return g.preventDefault(),g.returnValue=_,_}function u(){f||(f=!0,window.addEventListener("beforeunload",d))}function l(){f&&(f=!1,window.removeEventListener("beforeunload",d))}function p(){if(document.getElementById("big-batch-progress"))return;const g=document.getElementById("file-list");if(!g||!g.parentNode)return;const _=document.createElement("div");_.id="big-batch-progress",_.className="big-batch-progress",_.innerHTML='<div class="bbp-row"><svg class="bbp-icon" viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><circle cx="8" cy="8" r="6.5"/><path d="M8 4.5v3.5l2.5 1.5"/></svg><span class="bbp-text" id="bbp-text"></span></div><div class="bbp-track"><div class="bbp-fill" id="bbp-fill" style="width:0%"></div></div>',g.parentNode.insertBefore(_,g);const w=document.getElementById("bbp-text");w&&(w.textContent=typeof t=="function"?t("big-batch-progress-init"):"Starting...")}function m(){const g=document.getElementById("big-batch-progress");g&&g.remove()}function v(){if(!i)return;let g=0;for(let B=0;B<i.length;B++){const C=i[B].status;(C==="success"||C==="error"||C==="cancelled")&&g++}const _=r,w=_>0?Math.min(100,Math.floor(100*g/_)):0,k=(Date.now()-c)/1e3;let x;if(g>=3&&k>1){const B=k/g;x=(_-g)*B}else x=(_-g)*6/6;const E=Math.max(1,Math.ceil(x/60)),I=document.getElementById("bbp-fill"),L=document.getElementById("bbp-text");I&&(I.style.width=w+"%"),L&&(g>=_?L.textContent=t("big-batch-progress-done").replace("{total}",_):L.textContent=t("big-batch-progress-running").replace("{done}",g).replace("{total}",_).replace("{min}",E))}function y(g){try{if(localStorage.getItem(o)==="1")return}catch{}const _=Math.max(1,Math.ceil(g*6/6/60)),w=t("big-batch-first-tip").replace("{n}",g).replace("{min}",_);typeof showToast=="function"&&showToast(w,"info",8e3);try{localStorage.setItem(o,"1")}catch{}}function b(g){!g||g.length<100||(i=g,r=g.length,c=Date.now(),p(),u(),y(r),s&&clearInterval(s),s=setInterval(v,250),v())}function h(){s&&(clearInterval(s),s=null),l(),i&&r>=100?(v(),setTimeout(m,1200)):m(),i=null,r=0}window._bigBatchStart=b,window._bigBatchStop=h,typeof window.subscribeI18n=="function"&&window.subscribeI18n("big-batch-progress",function(){i&&v()})})();const me={status:null,statusLoaded:!1,bound:!1};function pe(e){return typeof escapeHtml=="function"?escapeHtml(e==null?"":String(e)):String(e??"")}function he(e,n){try{typeof showToast=="function"&&showToast(e,n||"info")}catch{}}function oo(){const e=typeof _userInfo<"u"?_userInfo:null;return!!(e&&(e.role==="owner"||e.is_super_admin))}function ws(){try{return(typeof _results<"u"?_results:[])[typeof _drawerIdx<"u"?_drawerIdx:-1]||null}catch{return null}}function Nr(e){if(!e)return!1;const n=String(e.status||"").toLowerCase();return n==="exception"||n==="exception_pending"||n==="rejected"}async function gt(e){if(me.statusLoaded&&!e)return me.status;const n=localStorage.getItem("mrpilot_token");if(!n)return null;try{const a=await fetch("/api/erp/xero/status",{headers:{Authorization:"Bearer "+n}});if(!a.ok)throw new Error("http_"+a.status);me.status=await a.json(),me.statusLoaded=!0}catch{me.status={configured:!1,connected:!1,organisations:[]},me.statusLoaded=!1}return me.status}async function Or(){const e=document.getElementById("drawer-history-save");if(!e||e.querySelector("#btn-xero-push")||e.querySelector("#pn-push-wrap")||(await gt(!1),e.querySelector("#pn-push-wrap"))||e.querySelector("#btn-xero-push"))return;const n=ws();if(!(n&&(n._historyId||n.history_id)))return;let o=!1,s="xero-push-tip";!me.status||!me.status.configured?(o=!0,s="xero-err-not_configured"):me.status.connected?Nr(n)&&(o=!0,s="xero-push-disabled-exc"):(o=!0,s="xero-push-disabled-no-conn");const i=document.createElement("button");i.type="button",i.id="btn-xero-push",i.className="btn btn-ghost"+(o?" disabled":""),i.disabled=o,i.title=t(s)||"",i.innerHTML='<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"><circle cx="8" cy="8" r="6"/><path d="M5 8l2 2 4-4"/></svg><span style="margin-left:4px;">'+pe(t("xero-push-btn"))+"</span>",i.addEventListener("click",Vr);const r=document.getElementById("btn-push-erp");r&&r.parentNode?r.parentNode.insertBefore(i,r.nextSibling):e.insertBefore(i,e.firstChild)}async function Vr(){const e=ws(),n=e&&(e._historyId||e.history_id);if(!n)return;const a=document.getElementById("btn-xero-push");a&&(a.disabled=!0,a.classList.add("loading"));const o=localStorage.getItem("mrpilot_token");try{const s=await fetch("/api/erp/xero/push/"+encodeURIComponent(n),{method:"POST",headers:{Authorization:"Bearer "+o}});if(!s.ok){let i="unknown";try{i=(await s.json()).detail||"unknown"}catch{}const r=String(i).replace(/^xero\./,"").toLowerCase(),c=t("xero-"+r),f=c&&c!=="xero-"+r?c:i;he(t("xero-push-fail").replace("{err}",f),"error");return}he(t("xero-push-ok"),"success")}catch(s){he(t("xero-push-fail").replace("{err}",s.message||"network"),"error")}finally{a&&(a.disabled=!1,a.classList.remove("loading"))}}async function Ur(){const e=document.getElementById("erp-global-push-mode");if(!e)return;const n=localStorage.getItem("mrpilot_token");if(n)try{const a=await fetch("/api/settings/erp-push-mode",{headers:{Authorization:"Bearer "+n}});if(a.ok){const o=await a.json();o.mode&&(e.value=o.mode,e.dataset.prev=o.mode)}}catch{}}async function Gr(e){const n=e.value,a=localStorage.getItem("mrpilot_token");try{(await fetch("/api/settings/erp-push-mode",{method:"PUT",headers:{Authorization:"Bearer "+a,"Content-Type":"application/json"},body:JSON.stringify({mode:n})})).ok?(e.dataset.prev=n,he(t("pref-erp-mode-saved"),"success")):(e.value=e.dataset.prev||"smart",he(t("pref-save-failed"),"error"))}catch{e.value=e.dataset.prev||"smart",he(t("pref-save-failed"),"error")}}(function(){function e(){const l=document.getElementById("erp-connect-cards");if(!l)return;const p=me.status;let m,v=!1;p?p.configured?p.connected?(v=!0,m='<span class="mrerp-card-pill mrerp-pill-ok">'+pe(t("xero-card-connected"))+"</span>"):m='<span class="mrerp-card-pill mrerp-pill-neutral">'+pe(t("xero-card-not-connected"))+"</span>":m='<span class="mrerp-card-pill mrerp-pill-neutral">'+pe(t("xero-card-not-configured"))+"</span>":m='<span class="mrerp-card-pill mrerp-pill-neutral">'+pe(t("xero-card-not-connected"))+"</span>";let y="";if(!p||!p.configured)y='<button type="button" class="int-btn-configure" id="btn-xero-connect">'+pe(t("xero-connect-btn"))+"</button>";else if(!p.connected)oo()&&(y='<button type="button" class="int-btn-configure" id="btn-xero-connect">'+pe(t("xero-connect-btn"))+"</button>");else{const I=!!p.auto_push,L=I?t("card-btn-disable"):t("card-btn-enable");y='<button type="button" class="'+(I?"mrerp-card-toggle mrerp-card-toggle-disable":"mrerp-card-toggle mrerp-card-toggle-enable")+'" id="btn-xero-toggle-enabled" data-xero-enabled="'+(I?"1":"0")+'" title="'+pe(I?t("erp-auto-push-on-tip"):t("erp-auto-push-off-tip"))+'">'+pe(L)+'</button><button type="button" class="int-btn-configure" id="btn-xero-edit-toggle">'+pe(t("card-btn-edit"))+"</button>"}const b=p&&p.connected?"xero-card-desc-connected":"xero-card-desc-default",h=p&&p.connected?t("xero-card-connected")||"Connected · default org will receive pushes":"Cloud accounting · push invoices to your default Xero org",g=(function(){const I=t(b);return I===b?h:I})();let _='<div class="integration-row erp-connect-xero'+(v?" connected":"")+'"><div class="int-icon ic-xero"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="9"/><circle cx="9" cy="10" r="1.3" fill="currentColor"/><circle cx="15" cy="14" r="1.3" fill="currentColor"/><path d="M9 14l6-4"/></svg></div><div class="int-info"><div class="int-name"><span>'+pe(t("xero-card-title")||"Xero")+"</span>"+m+'</div><div class="int-desc">'+pe(g)+'</div></div><div class="int-actions">'+y+"</div></div>";if(p&&p.configured&&p.connected&&oo()){const I=p.organisations||[];let L="";if(I.length>0){L+='<div class="erp-cc-meta">'+pe((t("xero-org-count")||"").replace("{n}",String(I.length)))+"</div>",L+='<div class="erp-cc-org-label">'+pe(t("xero-default-org"))+":</div>",L+='<div class="erp-cc-orgs">',I.forEach(function(S){L+='<label class="erp-cc-org-row"><input type="radio" name="xero-default-org" value="'+pe(S.id)+'"'+(S.is_default?" checked":"")+'><span class="erp-cc-org-name">'+pe(S.organisation_name||S.organisation_id)+"</span></label>"}),L+="</div>";const B=!!p.auto_push,C=B?t("erp-auto-push-on-tip"):t("erp-auto-push-off-tip");L+='<div class="erp-cc-auto-push" title="'+pe(C)+'"><label class="erp-cc-toggle"><input type="checkbox" id="xero-auto-push-toggle"'+(B?" checked":"")+'><span class="erp-cc-toggle-slider"></span><span class="erp-cc-toggle-label">'+pe(t("erp-auto-push-label"))+"</span></label></div>",L+='<div class="erp-cc-actions"><button class="btn btn-ghost btn-tiny" type="button" id="btn-xero-disconnect">'+pe(t("xero-disconnect-btn"))+"</button></div>"}_+='<div class="erp-xero-details" id="erp-xero-details" style="display:none; margin:8px 0 16px; padding:12px 14px; border:1px solid var(--line); border-radius:8px; background:var(--bg);">'+L+"</div>"}const w=l.querySelector(".erp-connect-xero"),k=l.querySelector("#erp-xero-details");k&&k.remove(),w?w.outerHTML=_:l.insertAdjacentHTML("afterbegin",_);const x=document.getElementById("btn-xero-edit-toggle");x&&x.addEventListener("click",function(I){I.preventDefault();const L=document.getElementById("erp-xero-details");L&&(L.style.display=L.style.display==="none"?"":"none")});const E=document.getElementById("btn-xero-toggle-enabled");E&&E.addEventListener("click",async function(I){if(I.preventDefault(),E.disabled)return;const B=!(E.getAttribute("data-xero-enabled")==="1");if(!B)try{if(!await window.pearnlyConfirm(t("card-toggle-disable-confirm")))return}catch{}E.disabled=!0,await s(B,null)})}async function n(){const l=localStorage.getItem("mrpilot_token");if(l)try{const p=await fetch("/api/erp/xero/auth/start",{method:"GET",headers:{Authorization:"Bearer "+l}});if(!p.ok){let v="unknown";try{v=(await p.json()).detail||"unknown"}catch{}const y=String(v).replace(/^xero\./,"").toLowerCase();he(t("xero-push-fail").replace("{err}",t("xero-err-"+y)||v),"error");return}const m=await p.json();m.redirect_url&&(window.location.href=m.redirect_url)}catch(p){he(t("xero-push-fail").replace("{err}",p.message||"network"),"error")}}async function a(){if(!await window.pearnlyConfirm(t("xero-disconnect-confirm")))return;const p=localStorage.getItem("mrpilot_token");try{const m=await fetch("/api/erp/xero/disconnect",{method:"POST",headers:{Authorization:"Bearer "+p}});if(!m.ok)throw new Error("http_"+m.status);await gt(!0),e()}catch(m){he(t("xero-push-fail").replace("{err}",m.message),"error")}}async function o(l){const p=localStorage.getItem("mrpilot_token");try{const m=await fetch("/api/erp/xero/select_org",{method:"POST",headers:{Authorization:"Bearer "+p,"Content-Type":"application/json"},body:JSON.stringify({token_id:l})});if(!m.ok)throw new Error("http_"+m.status);await gt(!0),e()}catch(m){he(t("xero-push-fail").replace("{err}",m.message),"error")}}async function s(l,p){const m=localStorage.getItem("mrpilot_token");p&&(p.disabled=!0);try{const v=await fetch("/api/erp/xero/auto-push",{method:"POST",headers:{Authorization:"Bearer "+m,"Content-Type":"application/json"},body:JSON.stringify({on:!!l})});if(!v.ok){let y="unknown";try{y=(await v.json()).detail||"unknown"}catch{}throw new Error(y)}he(l?t("erp-auto-push-toggled-on"):t("erp-auto-push-toggled-off"),"success"),me.statusLoaded=!1,await gt(!0),e()}catch(v){p&&(p.checked=!l),he(t("erp-auto-push-toggle-fail").replace("{err}",v.message||"network"),"error")}finally{p&&(p.disabled=!1)}}async function i(){await gt(!0),e(),Ur()}function r(){try{const l=String(window.location.hash||"");if(l.indexOf("xero=ok")>=0){const p=l.match(/n=(\d+)/),m=p?p[1]:"1";he((t("xero-toast-redirected-ok")||"").replace("{n}",m),"success"),history.replaceState(null,"",window.location.pathname+"#automation"),gt(!0).then(e)}else l.indexOf("xero=err")>=0&&(he(t("xero-toast-redirected-err"),"error"),history.replaceState(null,"",window.location.pathname+"#automation"))}catch{}}function c(){if(me.bound)return;me.bound=!0,document.addEventListener("click",function(p){if(p.target.closest('.erp-subtab[data-erp-subtab="connect"]')){setTimeout(i,50);return}if(p.target.closest('.auto-nav-item[data-auto-tab="erp"]')){setTimeout(i,80);return}if(p.target.closest("#btn-xero-connect")){p.preventDefault(),n();return}if(p.target.closest("#btn-xero-disconnect")){p.preventDefault(),a();return}}),document.addEventListener("change",function(p){p.target&&p.target.matches('input[name="xero-default-org"]')&&o(p.target.value),p.target&&p.target.id==="xero-auto-push-toggle"&&s(p.target.checked,p.target),p.target&&p.target.id==="erp-global-push-mode"&&Gr(p.target)});const l=function(){return document.getElementById("drawer-body")};try{const p=new MutationObserver(function(){document.getElementById("drawer-history-save")&&!document.getElementById("btn-xero-push")&&Or()}),m=l();if(m)p.observe(m,{childList:!0,subtree:!0});else{const v=new MutationObserver(function(){const y=l();y&&(p.observe(y,{childList:!0,subtree:!0}),v.disconnect())});v.observe(document.body,{childList:!0,subtree:!0})}}catch{}setTimeout(r,500)}function f(){me.status&&e();const l=document.getElementById("btn-xero-push");if(l){const p=l.querySelector("span");p&&(p.textContent=t("xero-push-btn"))}}c(),typeof window.subscribeI18n=="function"&&window.subscribeI18n("xero-adapter",f);async function d(l){const p=Date.now();for(;Date.now()-p<l;){if(typeof _userInfo<"u"&&_userInfo&&_userInfo.id)return _userInfo;await new Promise(m=>setTimeout(m,80))}return null}async function u(){await d(5e3);const l=document.querySelector('.auto-nav-item.active[data-auto-tab="erp"]'),p=document.querySelector('.erp-subtab.active[data-erp-subtab="connect"]');l&&p&&await i()}setTimeout(u,200)})();(function(){var e="https://www.mrerp4sme.com/dms/index.php",n=null,a=!1;function o(b){return typeof escapeHtml=="function"?escapeHtml(b==null?"":String(b)):String(b??"")}function s(b,h){try{typeof showToast=="function"&&showToast(b,h||"info")}catch{}}function i(){return localStorage.getItem("mrpilot_token")}async function r(b){var h=i();if(!h)return null;try{var g=await fetch("/api/erp/endpoints",{headers:{Authorization:"Bearer "+h}});if(!g.ok)throw new Error("http_"+g.status);var _=await g.json(),w=_&&_.items||[];n=w.find(function(k){return k&&(k.adapter||"").toLowerCase()==="mrerp_dms"})||null,a=!0}catch{n=null,a=!1}return n}function c(){var b=document.getElementById("erp-connect-cards");if(b){var h=b.querySelector("[data-mrerp-dms-zone]");h||(h=document.createElement("div"),h.setAttribute("data-mrerp-dms-zone","1"),b.appendChild(h));var g=n,_=!!(g&&g.enabled!==!1),w;g?_?w='<span class="mrerp-card-pill mrerp-pill-ok">'+o(t("dms-card-connected"))+"</span>":w='<span class="mrerp-card-pill mrerp-pill-neutral">'+o(t("dms-card-disabled-pill"))+"</span>":w='<span class="mrerp-card-pill mrerp-pill-neutral">'+o(t("dms-card-not-connected"))+"</span>";var k;if(!g)k='<button type="button" class="int-btn-configure" id="btn-dms-connect">'+o(t("dms-card-connect"))+"</button>";else{var x=_?t("dms-card-disable"):t("dms-card-enable");k='<button type="button" class="int-btn-configure" id="btn-dms-edit">'+o(t("dms-card-edit"))+'</button><button type="button" class="int-btn-configure" id="btn-dms-test">'+o(t("dms-card-test"))+'</button><button type="button" class="int-btn-configure" id="btn-dms-toggle">'+o(x)+"</button>"}h.innerHTML='<div class="integration-row erp-connect-mrerp-dms'+(_?" connected":"")+'"><div class="int-icon ic-mrerp-dms" style="background:#0a5c8a;color:#fff;"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M3 13l2-5a2 2 0 011.9-1.4h10.2A2 2 0 0119 8l2 5"/><path d="M3 13h18v4a1 1 0 01-1 1h-1a1 1 0 01-1-1v-1H6v1a1 1 0 01-1 1H4a1 1 0 01-1-1z"/><circle cx="7" cy="15.5" r="1"/><circle cx="17" cy="15.5" r="1"/></svg></div><div class="int-info"><div class="int-name"><span>'+o(t("dms-card-title"))+"</span>"+w+'</div><div class="int-desc">'+o(t("dms-card-desc"))+'</div></div><div class="int-actions">'+k+"</div></div>"}}function f(){var b=document.getElementById("dms-wizard-overlay");b&&b.remove(),document.removeEventListener("keydown",d)}function d(b){b.key==="Escape"&&f()}function u(){f();var b=n,h=b&&b.config&&b.config.booking_defaults&&b.config.booking_defaults.booking_prefix||"PN",g=function(k,x,E,I,L){return'<label style="display:block;margin-bottom:12px;"><span style="display:block;font-size:13px;color:var(--muted,#6b6b66);margin-bottom:5px;">'+o(t(k))+'</span><input id="'+x+'" type="'+E+'" value="'+o(I||"")+'" placeholder="'+o(L||"")+'" autocomplete="new-password" style="width:100%;box-sizing:border-box;padding:9px 11px;border:1px solid var(--line,#ddd);border-radius:8px;font-size:14px;"></label>'},_=document.createElement("div");_.id="dms-wizard-overlay",_.style.cssText="position:fixed;inset:0;z-index:13000;background:rgba(0,0,0,.42);display:flex;align-items:center;justify-content:center;padding:16px;",_.innerHTML='<div class="dms-wizard mrerp-wizard" role="dialog" aria-modal="true" style="background:var(--card,#fff);border-radius:14px;max-width:440px;width:100%;padding:24px;box-shadow:0 12px 40px rgba(0,0,0,.18);max-height:90vh;overflow:auto;"><div style="font-size:17px;font-weight:700;margin-bottom:4px;">'+o(t("dms-wizard-title"))+'</div><div style="font-size:13px;color:var(--muted,#6b6b66);margin-bottom:18px;">'+o(t("dms-card-desc"))+"</div>"+g("dms-wizard-username","dms-w-user","text","","")+g("dms-wizard-password","dms-w-pass","password","","")+g("dms-wizard-prefix","dms-w-prefix","text",h,"PN")+'<div id="dms-w-err" style="display:none;color:#b3261e;font-size:13px;margin:4px 0 12px;"></div><div style="display:flex;gap:10px;justify-content:flex-end;margin-top:8px;"><button type="button" class="btn btn-ghost" id="dms-w-cancel">'+o(t("dms-wizard-cancel"))+'</button><button type="button" class="btn btn-primary" id="dms-w-save">'+o(t("dms-wizard-save"))+"</button></div></div>",document.body.appendChild(_),document.addEventListener("keydown",d),_.addEventListener("click",function(k){k.target===_&&f()});var w=document.getElementById("dms-w-user");w&&w.focus()}function l(b){var h=document.getElementById("dms-w-err");h&&(h.textContent=b,h.style.display=b?"":"none")}async function p(){var b=n&&n.config&&n.config.system_url||e,h=(document.getElementById("dms-w-user")||{}).value||"",g=(document.getElementById("dms-w-pass")||{}).value||"",_=(document.getElementById("dms-w-prefix")||{}).value||"PN";if(b=b.trim(),h=h.trim(),!b||!h||!g){l(t("dms-wizard-required"));return}var w=document.getElementById("dms-w-save");w&&(w.disabled=!0,w.textContent=t("dms-wizard-saving")),l("");var k=i();try{var x=await fetch("/api/erp/test-connection",{method:"POST",headers:{Authorization:"Bearer "+k,"Content-Type":"application/json"},body:JSON.stringify({adapter:"mrerp_dms",config:{system_url:b,username:h,password:g}})}),E=await x.json().catch(function(){return{}});if(!x.ok||!E.ok){var I=E.error_friendly&&(E.error_friendly[window.currentLang]||E.error_friendly.en)||t("dms-connect-fail-generic");l(I),w&&(w.disabled=!1,w.textContent=t("dms-wizard-save"));return}var L={system_url:b,username_enc:h,password_enc:g,id_card_auto_push:!0,booking_defaults:{booking_prefix:_.trim()||"PN"}},B,C;n&&n.id?(B="PATCH",C="/api/erp/endpoints/"+encodeURIComponent(n.id)):(B="POST",C="/api/erp/endpoints");var S=B==="POST"?{name:"MR.ERP DMS",adapter:"mrerp_dms",config:L,is_default:!1,auto_push:!1}:{config:L,auto_push:!1},M=await fetch(C,{method:B,headers:{Authorization:"Bearer "+k,"Content-Type":"application/json"},body:JSON.stringify(S)});if(!M.ok){var R=await M.json().catch(function(){return{}}),V=R&&R.detail&&(R.detail.code||R.detail)||"save_failed";l(t("dms-save-fail")+" ("+o(String(V))+")"),w&&(w.disabled=!1,w.textContent=t("dms-wizard-save"));return}f(),s(t("dms-connect-ok"),"success"),await r(!0),c(),typeof window._refreshOcrDocMode=="function"&&window._refreshOcrDocMode()}catch{l(t("dms-connect-fail-generic")),w&&(w.disabled=!1,w.textContent=t("dms-wizard-save"))}}async function m(){if(!(!n||!n.id)){s(t("dms-test-running"),"info");var b=i();try{var h=await fetch("/api/erp/endpoints/"+encodeURIComponent(n.id)+"/test-connection?refresh=1",{method:"POST",headers:{Authorization:"Bearer "+b}}),g=await h.json().catch(function(){return{}});s(g&&g.ok?t("dms-test-ok"):t("dms-test-fail"),g&&g.ok?"success":"error")}catch{s(t("dms-test-fail"),"error")}}}async function v(){if(!(!n||!n.id)){var b=n.enabled===!1;if(!b)try{var h=await window.pearnlyConfirm(t("dms-confirm-disable"));if(!h)return}catch{}var g=i();try{var _=await fetch("/api/erp/endpoints/"+encodeURIComponent(n.id),{method:"PATCH",headers:{Authorization:"Bearer "+g,"Content-Type":"application/json"},body:JSON.stringify({enabled:b})});if(!_.ok)throw new Error("http_"+_.status);s(b?t("dms-enabled-toast"):t("dms-disabled-toast"),"success"),await r(!0),c(),typeof window._refreshOcrDocMode=="function"&&window._refreshOcrDocMode()}catch{s(t("dms-save-fail"),"error")}}}function y(){r().then(c)}document.addEventListener("click",function(b){if(b.target.closest('.erp-subtab[data-erp-subtab="connect"]')){setTimeout(y,60);return}if(b.target.closest('.auto-nav-item[data-auto-tab="erp"]')){setTimeout(y,90);return}if(b.target.closest("#btn-dms-connect")||b.target.closest("#btn-dms-edit")){b.preventDefault(),u();return}if(b.target.closest("#dms-w-cancel")){b.preventDefault(),f();return}if(b.target.closest("#dms-w-save")){b.preventDefault(),p();return}if(b.target.closest("#btn-dms-test")){b.preventDefault(),m();return}if(b.target.closest("#btn-dms-toggle")){b.preventDefault(),v();return}}),typeof window.subscribeI18n=="function"&&window.subscribeI18n("mrerp-dms-adapter",c),setTimeout(function(){var b=document.querySelector('.auto-nav-item.active[data-auto-tab="erp"]'),h=document.querySelector('.erp-subtab.active[data-erp-subtab="connect"]');b&&h&&y()},250)})();(function(){const e={};function n(){if(document.getElementById("report-modal"))return;const d=`
        ...
        </div>`,u=document.createElement("div");u.innerHTML=d,document.body.appendChild(u.firstElementChild),document.getElementById("report-modal-close-x").addEventListener("click",a),document.getElementById("report-modal-cancel").addEventListener("click",a),document.getElementById("report-modal").addEventListener("click",l=>{l.target.id==="report-modal"&&a()})}function a(){const d=document.getElementById("report-modal");d&&(d.style.display="none"),o=null}let o=null;async function s(d,u){const l=d+":"+(u||"");if(e[l])return e[l];let p;try{const m=localStorage.getItem("mrpilot_token"),v=await fetch(`/api/reports/templates?lang=${encodeURIComponent(d)}`,{headers:{Authorization:"Bearer "+m}});if(!v.ok)throw new Error("templates fetch failed");p=(await v.json()).templates||[]}catch(m){console.error("fetchTemplates fail",m),p=[{code:"input_vat",name:t("tpl-input-vat"),desc:t("tpl-input-vat-desc"),recommended:!0},{code:"standard",name:t("tpl-standard"),desc:t("tpl-standard-desc"),recommended:!1},{code:"print",name:t("tpl-print"),desc:t("tpl-print-desc"),recommended:!1}]}if(p=p.filter(m=>m.code!=="erp"),u==="history-batch"){const m=p.findIndex(y=>y.code==="standard"),v=m>=0?m+1:p.length;p.splice(v,0,{code:"sales_detail_th",name:t("export-tpl-sales-detail"),desc:t("export-tpl-sales-detail-desc"),recommended:!1,is_new:!0})}return e[l]=p,p}function i(d){const u=document.getElementById("report-tpl-list"),l=d.map((m,v)=>`
            <label class="report-tpl-item${m.recommended?" is-recommended":""}">
                <input type="radio" name="report-tpl" value="${m.code}" ${m.recommended||v===0?"checked":""}>
        ...
        `;u.innerHTML=l+p}function r(d){return d==null?"":String(d).replace(/[&<>"']/g,u=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[u])}function c(d){const u=new Date,l=u.getFullYear(),p=u.getMonth()+1;if(d==="all")return"all";if(d==="this-month")return`${l}-${String(p).padStart(2,"0")}`;if(d==="last-month"){const m=new Date(l,p-2,1);return`${m.getFullYear()}-${String(m.getMonth()+1).padStart(2,"0")}`}return d==="this-year"?`${l}`:d==="this-quarter"?`${l}-Q${Math.floor((p-1)/3)+1}`:"all"}window.openReportModal=async function(d){d=d||{},n(),typeof applyLang=="function"?applyLang(currentLang):document.querySelectorAll("#report-modal [data-i18n]").forEach(y=>{const b=y.getAttribute("data-i18n");I18N[currentLang]&&I18N[currentLang][b]&&(y.textContent=I18N[currentLang][b])});const u=document.getElementById("report-period-section");u&&(u.style.display=d.mode==="client"?"":"none");const l=document.getElementById("report-tpl-list");l.innerHTML=`<div class="report-tpl-loading">${r(t("report-modal-loading"))}</div>`,document.getElementById("report-modal").style.display="";const p=await s(currentLang,d&&d.mode);i(p),o=d;const m=document.getElementById("report-modal-download"),v=m.cloneNode(!0);m.parentNode.replaceChild(v,m),v.addEventListener("click",()=>f(o))};async function f(d){if(!d)return;const u=document.querySelector('input[name="report-tpl"]:checked');if(!u){showToast(t("report-toast-no-selection"),"info");return}const l=u.value,p=document.querySelector('input[name="report-period"]:checked'),m=p?p.value:"all",v=c(m),y=document.getElementById("report-modal-download"),b=y.innerHTML;y.disabled=!0,y.innerHTML=`<span>${r(t("report-modal-loading"))}</span>`;try{const h=localStorage.getItem("mrpilot_token");let g,_;if(d.mode==="records")g=await fetch("/api/reports/export",{method:"POST",headers:{Authorization:"Bearer "+h,"Content-Type":"application/json"},body:JSON.stringify({template:l,lang:currentLang,records:d.records||[],meta:d.meta||{}})}),_=`mrpilot-${l}-${Date.now()}.xlsx`;else if(d.mode==="client"){const B=`/api/reports/clients/${d.clientId}/export?template=${encodeURIComponent(l)}&lang=${encodeURIComponent(currentLang)}&month=${encodeURIComponent(v)}`;g=await fetch(B,{headers:{Authorization:"Bearer "+h}}),_=`${(d.clientName||"client").replace(/[^a-zA-Z0-9\u0e00-\u0e7f\u4e00-\u9fff]/g,"_").slice(0,40)}-${l}.xlsx`}else if(d.mode==="history-batch")l==="sales_detail_th"?(g=await fetch("/api/ocr/export-by-history-ids",{method:"POST",headers:{Authorization:"Bearer "+h,"Content-Type":"application/json"},body:JSON.stringify({template:"sales_detail_th",lang:currentLang,history_ids:d.historyIds||[],client_id:d.clientId||null})}),_=`Pearnly_SalesDetail_${Date.now()}.xlsx`):(g=await fetch("/api/reports/history/batch_export",{method:"POST",headers:{Authorization:"Bearer "+h,"Content-Type":"application/json"},body:JSON.stringify({template:l,lang:currentLang,history_ids:d.historyIds||[],client_id:d.clientId||null})}),_=`mrpilot-batch-${l}-${Date.now()}.xlsx`);else throw new Error("unknown mode: "+d.mode);if(!g.ok){let B="HTTP "+g.status;try{const C=await g.json();C&&C.detail&&(B=C.detail)}catch(C){console.warn("[batch-export] resp.json err.detail parse failed:",C)}g.status===404?showToast(t("report-toast-empty"),"info"):showToast(t("report-toast-fail")+" · "+B,"error");return}const w=await g.blob();let k=_;const E=(g.headers.get("Content-Disposition")||"").match(/filename\*=UTF-8''([^;]+)/i);if(E)try{k=decodeURIComponent(E[1])}catch{}const I=URL.createObjectURL(w),L=document.createElement("a");L.href=I,L.download=k,document.body.appendChild(L),L.click(),document.body.removeChild(L),URL.revokeObjectURL(I),showToast(t("report-toast-success"),"success"),a()}catch(h){console.error("doDownload fail",h),showToast(t("report-toast-fail")+" · "+(h.message||""),"error")}finally{y.disabled=!1,y.innerHTML=b}}document.addEventListener("DOMContentLoaded",()=>{const d=document.getElementById("btn-export");if(d){const l=d.cloneNode(!0);d.parentNode.replaceChild(l,d),l.addEventListener("click",()=>{if(typeof _results>"u"||!_results||_results.length===0){showToast(t("report-toast-no-selection"),"info");return}openReportModal({mode:"records",records:_results.map(p=>({filename:p.filename,merged_fields:p.merged_fields||{}}))})})}const u=document.getElementById("history-batch-export");u&&u.addEventListener("click",()=>{if(typeof _historySelected>"u"||_historySelected.size===0){showToast(t("report-toast-no-selection"),"info");return}openReportModal({mode:"history-batch",historyIds:Array.from(_historySelected)})})}),window.openClientExportModal=function(d,u){openReportModal({mode:"client",clientId:d,clientName:u||""})}})();const Kr=/\.(pdf|jpe?g|png|webp)$/i,Wr="mrpilot_folder_watcher",Yr=1;let nn=null;function An(){return nn||(nn=new Promise((e,n)=>{const a=indexedDB.open(Wr,Yr);a.onupgradeneeded=o=>{const s=o.target.result;s.objectStoreNames.contains("handles")||s.createObjectStore("handles"),s.objectStoreNames.contains("seen")||s.createObjectStore("seen"),s.objectStoreNames.contains("config")||s.createObjectStore("config")},a.onsuccess=o=>e(o.target.result),a.onerror=o=>n(o.target.error)}),nn)}function Rt(e,n){return An().then(a=>new Promise((o,s)=>{const r=a.transaction(e,"readonly").objectStore(e).get(n);r.onsuccess=()=>o(r.result),r.onerror=()=>s(r.error)}))}function ot(e,n,a){return An().then(o=>new Promise((s,i)=>{const r=o.transaction(e,"readwrite");r.objectStore(e).put(a,n),r.oncomplete=()=>s(),r.onerror=()=>i(r.error)}))}function Pt(e,n){return An().then(a=>new Promise((o,s)=>{const i=a.transaction(e,"readwrite");i.objectStore(e).delete(n),i.oncomplete=()=>o(),i.onerror=()=>s(i.error)}))}function so(e){return An().then(n=>new Promise((a,o)=>{const s=n.transaction(e,"readwrite");s.objectStore(e).clear(),s.oncomplete=()=>a(),s.onerror=()=>o(s.error)}))}async function io(e){if(!e)return!1;try{const n={mode:"read"};let a=await e.queryPermission(n);return a==="granted"?!0:(a=await e.requestPermission(n),a==="granted")}catch(n){return console.warn("[folder] permission check failed:",n),!1}}async function Jr(e){const n=new FormData;n.append("file",e,e.name),n.append("source","folder");const a=await fetch("/api/ocr/recognize?source=folder",{method:"POST",headers:{Authorization:"Bearer "+token,"X-Source":"folder"},body:n});if(!a.ok){let o="http_"+a.status;try{const s=await a.json();o=s&&s.detail?typeof s.detail=="string"?s.detail:s.detail.code||JSON.stringify(s.detail):o}catch{}throw new Error(o)}return await a.json()}async function Xr(e){try{const a=(await e.getFile()).size;return await new Promise(s=>setTimeout(s,3e3)),(await e.getFile()).size===a&&a>0}catch{return!1}}async function ks(e,n,a,o){if(o>10)return;let s;try{s=await e.queryPermission({mode:"read"})}catch{s="denied"}if(s==="granted")for await(const i of e.values()){const r=n?`${n}/${i.name}`:i.name;if(i.kind==="file"){if(!Kr.test(i.name))continue;let c;try{c=await i.getFile()}catch{continue}const f=`${r}::${c.size}::${c.lastModified}`;if(await Rt("seen",f))continue;a.push({entry:i,file:c,seenKey:f,relPath:r})}else if(i.kind==="directory")try{await ks(i,r,a,o+1)}catch{}}}(function(){const n=typeof window<"u"&&"showDirectoryPicker"in window;let a=null,o=null,s=60,i=!1,r=!1,c=0,f=0,d=0,u=[],l=null,p=!1;function m(N,z){const K=document.getElementById("folder-status-summary");K&&(K.setAttribute("data-i18n",N),K.textContent=t(N),K.className="auto-status-pill"+(z?" "+z:""))}function v(N){["folder-unsupported","folder-empty","folder-active"].forEach(z=>{const K=document.getElementById(z);K&&(K.style.display=z===N?"":"none")})}function y(N){if(!N)return"-";const z=N instanceof Date?N:new Date(N),K=String(z.getHours()).padStart(2,"0"),le=String(z.getMinutes()).padStart(2,"0"),se=String(z.getSeconds()).padStart(2,"0");return`${K}:${le}:${se}`}function b(){v("folder-active");const N=document.getElementById("folder-config-path");N&&a&&(N.textContent=a.name||"-");const z=document.getElementById("folder-interval-select");z&&(z.value=String(s)),document.getElementById("folder-stat-last").textContent=l?y(l):"-",document.getElementById("folder-stat-processed").textContent=String(c),document.getElementById("folder-stat-failed").textContent=String(f),document.getElementById("folder-stat-queue").textContent=String(d);const K=document.getElementById("btn-folder-pause"),le=document.getElementById("btn-folder-resume");K&&(K.style.display=i?"none":""),le&&(le.style.display=i?"":"none"),i?m("folder-status-paused","paused"):m("folder-status-running","running");const se=document.getElementById("folder-status-text");se&&(se.setAttribute("data-i18n",i?"folder-status-paused":"folder-status-running"),se.textContent=t(i?"folder-status-paused":"folder-status-running"));const Be=document.getElementById("folder-status-pulse");Be&&(Be.className="folder-status-pulse"+(i?" paused":"")),h()}function h(){const N=document.getElementById("folder-recent-list");if(N){if(u.length===0){N.innerHTML=`<div class="folder-recent-empty">${escapeHtml(t("folder-recent-empty"))}</div>`;return}N.innerHTML=u.slice(0,20).map(z=>{let K;z.status==="ok"?K=`<span class="folder-recent-icon ok">${svgIcon("check",12)}</span>`:z.status==="dup"?K=`<span class="folder-recent-icon dup" title="${escapeHtml(t("folder-recent-dup"))}">${svgIcon("copy",12)}</span>`:z.status==="skip"?K=`<span class="folder-recent-icon skip" title="${escapeHtml(t("folder-recent-skip"))}">${svgIcon("minus",12)}</span>`:K=`<span class="folder-recent-icon fail">${svgIcon("alert",12)}</span>`;const le=z.status==="fail"&&z.error?z.error:z.status==="dup"&&z.reason||z.status==="skip"&&z.reason?z.reason:"",se=le?`<div class="folder-recent-err">${escapeHtml(le)}</div>`:"";return`
                <div class="folder-recent-item">
                    ...
                    <div class="folder-recent-time">${y(z.time)}</div>
                </div>
            `}).join("")}}function g(N){u.unshift(N),u.length>50&&(u.length=50),ot("config","recent_list",u).catch(()=>{})}async function _(){if(!(r||i||!a)){r=!0;try{if(await a.queryPermission({mode:"read"})!=="granted"){console.warn("[folder] permission lost · stop"),S(),showToast("warn",t("folder-permission-lost"));return}l=new Date;const z=[];await ks(a,"",z,0),d=z.length,b();for(const K of z){if(i)break;if(!await Xr(K.entry)){d=Math.max(0,d-1),b();continue}try{let se;try{se=await K.entry.getFile()}catch{se=K.file}const Be=await Jr(se);await ot("seen",K.seenKey,{name:se.name,relPath:K.relPath,size:se.size,lastModified:se.lastModified,processed_at:Date.now()});const at=Be.history_ids||(Be.history_id?[Be.history_id]:[]),qn=Be.duplicate_warnings||[],zn=K.relPath||se.name;at.length>0?(c+=at.length,g({name:zn,status:"ok",time:new Date,history_id:at[0],count:at.length}),await ot("config","processed_count",c)):qn.length>0?g({name:zn,status:"dup",time:new Date,reason:t("folder-recent-dup-reason")}):g({name:zn,status:"skip",time:new Date,reason:t("folder-recent-skip-reason")})}catch(se){f++,g({name:K.relPath||K.file.name,status:"fail",time:new Date,error:String(se.message||se)}),await ot("config","failed_count",f)}d=Math.max(0,d-1),b()}}catch(N){console.warn("[folder] scan error:",N)}finally{r=!1,b()}}}function w(){o&&clearInterval(o),o=setInterval(_,s*1e3)}function k(){o&&(clearInterval(o),o=null)}function x(N){if(!a||i)return;const z=typeof t=="function"?t("folder-unload-warn"):"Folder watcher running · close anyway?";return N.preventDefault(),N.returnValue=z,z}function E(){window._pearnlyFolderUnloadAttached||(window._pearnlyFolderUnloadAttached=!0,window.addEventListener("beforeunload",x))}function I(){window._pearnlyFolderUnloadAttached&&(window._pearnlyFolderUnloadAttached=!1,window.removeEventListener("beforeunload",x))}function L(){i=!1,w(),E(),b(),_()}function B(){i=!0,k(),I(),b()}function C(){i=!1,w(),E(),b(),_()}function S(){i=!0,k(),I()}async function M(){try{const N=await window.showDirectoryPicker({mode:"read",startIn:"documents"});if(!await io(N)){showToast("warn",t("folder-permission-denied"));return}a=N,await ot("handles","main",N),c=0,f=0,d=0,u=[],await ot("config","processed_count",0),await ot("config","failed_count",0),await so("seen"),L()}catch(N){N&&N.name!=="AbortError"&&console.warn("[folder] pick failed:",N)}}async function R(){await showConfirm(t("folder-confirm-remove"),{danger:!0})&&(S(),a=null,c=0,f=0,d=0,u=[],await Pt("handles","main"),await Pt("config","processed_count"),await Pt("config","failed_count"),await so("seen"),v("folder-empty"),m("folder-status-empty",""))}async function V(){u=[];try{await Pt("config","recent_list")}catch{}h()}async function ne(){if(p)return;if(p=!0,!n){v("folder-unsupported"),m("folder-status-unsupported",""),ue();return}re();let N=null;try{N=await Rt("handles","main")}catch{}if(!N){v("folder-empty"),m("folder-status-empty","");return}if(!await io(N)){v("folder-empty"),m("folder-status-empty",""),await Pt("handles","main"),showToast("warn",t("folder-permission-lost-restart"));return}a=N;try{c=await Rt("config","processed_count")||0}catch{}try{f=await Rt("config","failed_count")||0}catch{}try{const K=await Rt("config","recent_list");Array.isArray(K)&&(u=K.map(le=>({...le,time:le.time?new Date(le.time):new Date})))}catch{}L()}function re(){const N=document.getElementById("btn-folder-pick"),z=document.getElementById("btn-folder-pause"),K=document.getElementById("btn-folder-resume"),le=document.getElementById("btn-folder-scan-now"),se=document.getElementById("btn-folder-remove"),Be=document.getElementById("btn-folder-clear-recent"),at=document.getElementById("folder-interval-select");N&&N.addEventListener("click",M),z&&z.addEventListener("click",B),K&&K.addEventListener("click",C),le&&le.addEventListener("click",()=>{_()}),se&&se.addEventListener("click",R),Be&&Be.addEventListener("click",V),at&&at.addEventListener("change",qn=>{s=parseInt(qn.target.value,10)||60,i||w()}),fe()}function fe(){document.querySelectorAll('[data-auto-panel="folder"] [data-tab-jump]').forEach(N=>{N.dataset.tabJumpBound||(N.dataset.tabJumpBound="1",N.addEventListener("click",z=>{const K=z.currentTarget.dataset.tabJump;if(K==="email")typeof switchAutomationTab=="function"&&switchAutomationTab("email");else if(K==="upload"){const le=document.querySelector('[data-page="recognize"]')||document.querySelector('[data-page="upload"]');le&&le.click()}}))})}function ue(){fe()}window._loadFolderWatcherPanel=ne})();function Zr(){try{if(navigator.userAgentData&&Array.isArray(navigator.userAgentData.brands))return navigator.userAgentData.brands.some(n=>/chromium|google chrome|microsoft edge/i.test(n.brand||""))}catch{}const e=navigator.userAgent||"";return!!(/Edg\//.test(e)||/Chrome\//.test(e)&&!/OPR\/|YaBrowser|Opera/.test(e))}function sa(){try{if(Zr()||localStorage.getItem("pearnly_chrome_banner_dismissed")==="1")return;const e=document.getElementById("chrome-only-banner");if(!e)return;const n=e.querySelector('[data-i18n="chrome-banner-msg"]'),a=e.querySelector('[data-i18n="chrome-banner-dismiss"]');n&&typeof t=="function"&&(n.textContent=t("chrome-banner-msg")),a&&typeof t=="function"&&(a.textContent=t("chrome-banner-dismiss")),e.style.display="";const o=document.getElementById("chrome-only-banner-close");o&&!o.dataset.bound&&(o.dataset.bound="1",o.addEventListener("click",()=>{e.style.display="none";try{localStorage.setItem("pearnly_chrome_banner_dismissed","1")}catch{}}))}catch{}}typeof document<"u"&&(document.readyState==="loading"?document.addEventListener("DOMContentLoaded",sa):setTimeout(sa,0));window._refreshChromeBanner=sa;const Qr=`
        <div class="modal">
            <div class="modal-head">
    ...
    `;ge("email-modal",Qr);const F={account:null,presets:null,modalMode:"new",loaded:!1,triggering:!1,autoRefreshTimer:null};function ro(e){F.modalMode=e;const n=document.getElementById("email-modal");if(!n)return;const a=document.getElementById("email-preset");a.innerHTML="";const o=F.presets||{},s=["gmail","outlook","yahoo","icloud","qq","163","custom"],i={gmail:"Gmail",outlook:"Outlook / Office365",yahoo:"Yahoo Mail",icloud:"iCloud",qq:"QQ 邮箱",163:"网易 163"};s.forEach(h=>{if(!o[h])return;const g=document.createElement("option");g.value=h,g.textContent=h==="custom"?t("email-preset-custom"):i[h]||h,a.appendChild(g)});const r=document.getElementById("email-modal-title"),c=document.getElementById("email-address"),f=document.getElementById("email-password"),d=document.getElementById("email-imap-host"),u=document.getElementById("email-imap-port"),l=document.getElementById("email-imap-ssl"),p=document.getElementById("email-folder"),m=document.getElementById("email-mark-read"),v=document.getElementById("email-bind-enabled"),y=document.getElementById("email-test-result"),b=document.getElementById("email-adv-details");if(y&&(y.style.display="none",y.textContent=""),e==="edit"&&F.account){r.setAttribute("data-i18n","email-modal-title-edit"),r.textContent=t("email-modal-title-edit"),c.value=F.account.email_address||"",f.value="",f.setAttribute("data-i18n-placeholder","email-field-password-edit-ph"),f.placeholder=t("email-field-password-edit-ph"),d.value=F.account.imap_host||"",u.value=F.account.imap_port||993,l.checked=F.account.imap_use_ssl!==!1,p.value=F.account.folder||"INBOX",m.checked=F.account.mark_as_read!==!1,v.checked=F.account.enabled!==!1;const h=document.getElementById("email-filter-sender"),g=document.getElementById("email-filter-subject");h&&(h.value=F.account.filter_sender||""),g&&(g.value=F.account.filter_subject||""),co(F.account.interval_min||15),a.value=tl(F.account.imap_host)||"custom",b&&(b.open=!0)}else{r.setAttribute("data-i18n","email-modal-title-new"),r.textContent=t("email-modal-title-new"),c.value="",f.value="",f.setAttribute("data-i18n-placeholder","email-field-password-ph"),f.placeholder=t("email-field-password-ph"),a.value="gmail",Sa("gmail"),p.value="INBOX",m.checked=!0,v.checked=!0;const h=document.getElementById("email-filter-sender"),g=document.getElementById("email-filter-subject");h&&(h.value=""),g&&(g.value=""),co(15),b&&(b.open=!1)}nl(),n.style.display="flex",setTimeout(()=>c.focus(),60)}function Un(){const e=document.getElementById("email-modal");e&&(e.style.display="none")}function Sa(e){const n=(F.presets||{})[e];if(!n||e==="custom")return;const a=document.getElementById("email-imap-host"),o=document.getElementById("email-imap-port"),s=document.getElementById("email-imap-ssl");a&&(a.value=n.host||""),o&&(o.value=n.port||993),s&&(s.checked=n.ssl!==!1)}const el={"gmail.com":"gmail","googlemail.com":"gmail","outlook.com":"outlook","hotmail.com":"outlook","live.com":"outlook","office365.com":"outlook","msn.com":"outlook","yahoo.com":"yahoo","yahoo.co.jp":"yahoo","icloud.com":"icloud","me.com":"icloud","mac.com":"icloud","qq.com":"qq","foxmail.com":"qq","163.com":"163","126.com":"163","yeah.net":"163"};function lo(e){if(!e||!e.includes("@"))return;const n=e.split("@")[1].toLowerCase().trim(),a=el[n];if(!a)return;const o=document.getElementById("email-preset");if(!o)return;const s=o.value;s&&s!=="custom"&&s!==""&&s===a||(o.value=a,Sa(a))}function tl(e){if(!e)return null;const n=F.presets||{};for(const a in n)if(a!=="custom"&&n[a]&&n[a].host===e)return a;return null}function xs(){const e=document.querySelector("#email-interval-options .email-interval-btn.active"),n=e?parseInt(e.dataset.interval,10):15;return{email_address:(document.getElementById("email-address").value||"").trim(),password:document.getElementById("email-password").value||"",imap_host:(document.getElementById("email-imap-host").value||"").trim(),imap_port:parseInt(document.getElementById("email-imap-port").value||"993",10)||993,imap_use_ssl:document.getElementById("email-imap-ssl").checked,folder:(document.getElementById("email-folder").value||"INBOX").trim()||"INBOX",mark_as_read:document.getElementById("email-mark-read").checked,enabled:document.getElementById("email-bind-enabled").checked,interval_min:[5,15,60].includes(n)?n:15,filter_sender:(document.getElementById("email-filter-sender").value||"").trim()||null,filter_subject:(document.getElementById("email-filter-subject").value||"").trim()||null}}function nl(){const e=document.getElementById("email-interval-options");!e||e._bound||(e._bound=!0,e.addEventListener("click",n=>{const a=n.target.closest(".email-interval-btn");a&&(e.querySelectorAll(".email-interval-btn").forEach(o=>o.classList.remove("active")),a.classList.add("active"))}))}function co(e){const n=[5,15,60].includes(e)?e:15,a=document.getElementById("email-interval-options");a&&a.querySelectorAll(".email-interval-btn").forEach(o=>{o.classList.toggle("active",parseInt(o.dataset.interval,10)===n)})}function ye(e,n){const a=document.getElementById("email-test-result");a&&(a.style.display="",a.textContent=n,a.className="form-test-result "+(e==="ok"?"ok":e==="running"?"running":"fail"))}async function al(){const e=xs();if(!e.email_address){ye("fail",t("email-addr-required"));return}if(!e.password){ye("fail",t("email-password-required"));return}if(!e.imap_host){ye("fail",t("email-host-required"));return}const n=document.getElementById("btn-email-modal-test");n&&(n.disabled=!0),ye("running",t("email-test-running"));try{const a=await fetch("/api/email-ingest/test",{method:"POST",headers:{Authorization:"Bearer "+token,"Content-Type":"application/json"},body:JSON.stringify({email_address:e.email_address,password:e.password,imap_host:e.imap_host,imap_port:e.imap_port,imap_use_ssl:e.imap_use_ssl,folder:e.folder})}),o=await a.json().catch(()=>({}));if(a.ok&&o.success)ye("ok",t("email-test-ok",{folder:e.folder,n:o.folder_count??"?"}));else{const s=o.error_msg||"";s==="auth_failed"||/auth/i.test(s)?ye("fail",t("email-test-auth-fail")):ye("fail",t("email-test-fail",{msg:s||a.status}))}}catch(a){ye("fail",t("email-test-fail",{msg:String(a).slice(0,120)}))}finally{n&&(n.disabled=!1)}}(function(){async function e(){const p=document.getElementById("email-empty"),m=document.getElementById("email-account-card");if(document.getElementById("email-logs-section"),!(!p||!m))try{const v=await fetch("/api/email-ingest/account",{headers:{Authorization:"Bearer "+token}});if(v.status===401){localStorage.removeItem("mrpilot_token");const b=await v.json().catch(()=>({}));if((typeof b.detail=="string"?b.detail:b.detail&&b.detail.code||"")==="auth.session_revoked"){_showSessionRevokedModal();return}window.location.href="/";return}if(!v.ok){a("none");return}const y=await v.json();F.account=y.account||null,F.presets=y.presets||{},F.loaded=!0,n(),F.account&&d()}catch(v){console.error("[email-ingest] load failed",v),a("none")}}function n(){const p=document.getElementById("email-empty"),m=document.getElementById("email-account-card"),v=document.getElementById("email-logs-section");if(!F.account){p.style.display="",m.style.display="none",v&&(v.style.display="none"),a("none");return}p.style.display="none",m.style.display="",v&&(v.style.display="");const y=document.getElementById("email-account-addr"),b=document.getElementById("email-account-host"),h=document.getElementById("email-account-last"),g=document.getElementById("email-last-error"),_=document.getElementById("email-enabled-toggle");if(y&&(y.textContent=F.account.email_address||"-"),b&&(b.textContent=`${F.account.imap_host||"-"}:${F.account.imap_port||993}`),h){const w=F.account.last_fetched_at;if(!w)h.textContent=t("email-last-never");else{const k=o(w),x=!F.account.last_error;h.textContent=x?t("email-last-ok",{time:k}):t("email-last-fail",{time:k})}}g&&(F.account.last_error?(g.style.display="",g.textContent=s(F.account.last_error)):g.style.display="none"),_&&(_.checked=!!F.account.enabled),F.account.enabled?F.account.last_error?a("error"):a("on"):a("off")}function a(p){const m=document.getElementById("email-status-summary");if(!m)return;m.classList.remove("none","ready","active","coming");let v="auto-status-loading";p==="none"?(v="email-status-none",m.classList.add("none")):p==="on"?(v="email-status-on",m.classList.add("active")):p==="off"?(v="email-status-off",m.classList.add("coming")):p==="error"&&(v="email-status-error",m.classList.add("none")),m.setAttribute("data-i18n",v),m.textContent=t(v)}function o(p){if(!p)return"";const m=new Date(p);if(isNaN(m.getTime()))return"";const v=y=>String(y).padStart(2,"0");return`${v(m.getMonth()+1)}-${v(m.getDate())} ${v(m.getHours())}:${v(m.getMinutes())}`}function s(p){if(!p)return"";const m=String(p);return/auth|AUTHENTICATIONFAILED|invalid credentials/i.test(m)?t("email-test-auth-fail"):/timeout|timed out/i.test(m)?t("email.timeout"):(/ENOTFOUND|getaddrinfo/i.test(m),m)}async function i(){const p=xs();if(!p.email_address){ye("fail",t("email-addr-required"));return}if(F.modalMode==="new"&&!p.password){ye("fail",t("email-password-required"));return}if(!p.imap_host){ye("fail",t("email-host-required"));return}const m=document.getElementById("btn-email-modal-save");m&&(m.disabled=!0);const v={...p};F.modalMode==="edit"&&!v.password&&delete v.password;try{const y=await fetch("/api/email-ingest/account",{method:"PUT",headers:{Authorization:"Bearer "+token,"Content-Type":"application/json"},body:JSON.stringify(v)}),b=await y.json().catch(()=>({}));if(y.ok&&b.ok)F.account=b.account,showToast(t("email-save-ok"),"success"),Un(),n(),d();else{const g="email."+(b.detail||"").split(".").slice(-1)[0];ye("fail",t(g)!==g?t(g):t("email-save-fail"))}}catch{ye("fail",t("email-save-fail"))}finally{m&&(m.disabled=!1)}}async function r(){if(!(!F.account||!await showConfirm(t("email-unbind-confirm",{email:F.account.email_address}),{danger:!0,okText:t("email-btn-unbind")})))try{if((await fetch("/api/email-ingest/account",{method:"DELETE",headers:{Authorization:"Bearer "+token}})).ok){F.account=null,showToast(t("email-unbind-ok"),"success"),n();const v=document.getElementById("email-logs-list");v&&(v.innerHTML="")}else showToast(t("email-unbind-fail"),"error")}catch{showToast(t("email-unbind-fail"),"error")}}async function c(){if(!F.account||F.triggering)return;if(!F.account.enabled){showToast(t("email.disabled"),"error");return}F.triggering=!0;const p=document.getElementById("btn-email-trigger"),m=p?p.innerHTML:"";p&&(p.disabled=!0,p.innerHTML=`<span>${escapeHtml(t("email-trigger-running"))}</span>`);try{const v=await fetch("/api/email-ingest/trigger",{method:"POST",headers:{Authorization:"Bearer "+token}}),y=await v.json().catch(()=>({}));if(v.ok){const b=y.emails_scanned||0,h=y.ocr_succeeded||0,g=y.ocr_failed||0;b===0&&h===0&&g===0?showToast(t("email-trigger-empty"),"success"):showToast(t("email-trigger-result",{scanned:b,ok:h,fail:g}),g>0?"warn":"success")}else{const h="email."+(y.detail||"").split(".").slice(-1)[0];showToast(t(h)!==h?t(h):t("email-trigger-fail"),"error")}await e()}catch{showToast(t("email-trigger-fail"),"error")}finally{F.triggering=!1,p&&(p.disabled=!1,p.innerHTML=m)}}async function f(){if(!F.account)return;const p=document.getElementById("email-enabled-toggle"),m=!!(p&&p.checked),v=F.account.enabled;try{const y=await fetch("/api/email-ingest/account",{method:"PUT",headers:{Authorization:"Bearer "+token,"Content-Type":"application/json"},body:JSON.stringify({email_address:F.account.email_address,imap_host:F.account.imap_host,imap_port:F.account.imap_port,imap_use_ssl:F.account.imap_use_ssl,folder:F.account.folder||"INBOX",filter_subject:F.account.filter_subject||null,filter_sender:F.account.filter_sender||null,mark_as_read:F.account.mark_as_read!==!1,enabled:m})}),b=await y.json().catch(()=>({}));y.ok&&b.ok?(F.account=b.account,n()):(p&&(p.checked=v),showToast(t("email-toggle-fail"),"error"))}catch{p&&(p.checked=v),showToast(t("email-toggle-fail"),"error")}}async function d(){const p=document.getElementById("email-logs-list");if(p){p.innerHTML=`<div class="erp-logs-empty">${escapeHtml(t("erp-logs-loading"))}</div>`;try{const m=await fetch("/api/email-ingest/logs?limit=20",{headers:{Authorization:"Bearer "+token}});if(!m.ok){p.innerHTML=`<div class="erp-logs-empty">${escapeHtml(t("erp-logs-error"))}</div>`;return}const v=await m.json();if(!Array.isArray(v)||v.length===0){p.innerHTML=`<div class="erp-logs-empty">${escapeHtml(t("email-logs-empty"))}</div>`;return}p.innerHTML=v.map(u).join("")}catch{p.innerHTML=`<div class="erp-logs-empty">${escapeHtml(t("erp-logs-error"))}</div>`}}}function u(p){const m=o(p.created_at),v=p.status||"failed",y=v==="success"?"ok":v==="partial"?"partial":"fail",b=v==="success"?"✓":v==="partial"?"◐":"✗",h=p.trigger==="manual"?`<span class="log-tag manual">${escapeHtml(t("email-log-tag-manual"))}</span>`:`<span class="log-tag auto">${escapeHtml(t("email-log-tag-auto"))}</span>`,g=t("email-log-counts",{scanned:p.emails_scanned||0,att:p.attachments_found||0,ok:p.ocr_succeeded||0,fail:p.ocr_failed||0}),_=(p.elapsed_ms||0)+"ms";return`
        ...
        `}function l(){const p=document.getElementById("btn-email-bind");p&&p.addEventListener("click",()=>ro("new"));const m=document.getElementById("btn-email-edit");m&&m.addEventListener("click",()=>ro("edit"));const v=document.getElementById("btn-email-unbind");v&&v.addEventListener("click",r);const y=document.getElementById("btn-email-trigger");y&&y.addEventListener("click",c);const b=document.getElementById("email-enabled-toggle");b&&b.addEventListener("change",f);const h=document.getElementById("email-modal-close");h&&h.addEventListener("click",Un);const g=document.getElementById("btn-email-modal-cancel");g&&g.addEventListener("click",Un);const _=document.getElementById("btn-email-modal-test");_&&_.addEventListener("click",al);const w=document.getElementById("btn-email-modal-save");w&&w.addEventListener("click",i);const k=document.getElementById("email-preset");k&&k.addEventListener("change",I=>Sa(I.target.value));const x=document.getElementById("email-address");x&&!x.dataset.autoBound&&(x.dataset.autoBound="1",x.addEventListener("blur",I=>lo((I.target.value||"").trim())),x.addEventListener("input",I=>{const L=(I.target.value||"").trim();L.includes("@")&&L.split("@")[1].includes(".")&&lo(L)}));const E=document.getElementById("btn-email-refresh-logs");E&&E.addEventListener("click",()=>{E.classList.add("spinning"),setTimeout(()=>E.classList.remove("spinning"),600),d()})}l(),window._loadEmailIngestPanel=e,window._rerenderEmailIngest=function(){if(!F.loaded)return;n();const p=document.getElementById("email-logs-section");F.account&&p&&p.open&&d()},window._startEmailLogAutoRefresh=function(){F.autoRefreshTimer||(F.autoRefreshTimer=setInterval(()=>{F.account&&F.loaded&&d()},3e4))},window._stopEmailLogAutoRefresh=function(){F.autoRefreshTimer&&(clearInterval(F.autoRefreshTimer),F.autoRefreshTimer=null)}})();const ol=`
...
`;ge("bank-cand-drawer",ol);const sl=`
    <div class="modal" style="max-width: 420px;">
        <div class="modal-head">
...
`;ge("bank-client-picker-modal",sl);const $={sessions:[],currentSession:null,currentTxs:[],currentFilter:"all",currentTxForDrawer:null,loaded:!1,queue:[],qSeq:0,sessionFilter:"all",pickerSelected:null};function il(e){const n=Number(e||0);let a="score-low";return n>=85?a="score-high":n>=60&&(a="score-mid"),'<span class="bank-cand-score '+a+'">'+n.toFixed(0)+" "+t("bank-cand-score-unit")+"</span>"}function rl(e){const n=document.getElementById("bank-upload-progress");n&&(n.style.display="none")}function ll(){const e=document.getElementById("bank-upload-error");e&&(e.style.display="none")}function cl(e){return{"bank_recon.only_pdf":t("bank-err-only-pdf"),"bank_recon.empty_file":t("bank-err-empty"),"bank_recon.file_too_large":t("bank-err-too-large"),"bank_recon.save_failed":t("bank-err-server"),"bank_recon.scanned":t("bank-err-scanned"),"bank_recon.no_tx":t("bank-err-no-tx"),network:t("bank-err-network")}[e]||t("bank-err-unknown")+" ("+e+")"}function dt(e){if(e==null)return"-";const n=Number(e);return isNaN(n)?"-":n.toLocaleString("en-US",{minimumFractionDigits:2,maximumFractionDigits:2})}function Lt(e){if(!e)return"-";const n=String(e);return n.length>=10?n.slice(0,10):n}function _s(e,n){return!e&&!n?"":(Lt(e)||"?")+" ~ "+(Lt(n)||"?")}function Y(e){return e==null?"":String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}async function dl(e){$.currentTxForDrawer=e;const n=document.getElementById("bank-detail-body");n&&n.classList.add("has-pane");const a=document.getElementById("bank-cand-pane-title"),o=document.getElementById("bank-cand-pane-sub"),s=document.getElementById("bank-cand-pane-foot");if(a&&(a.textContent=t("bank-cand-pane-current")),o){const r=e.direction==="OUT"?"-":"+",c=e.direction==="OUT"?"bank-out":"bank-in";o.innerHTML=`${Y(Lt(e.tx_date))}
            <span style="margin:0 6px;color:#D1D5DB">·</span>
            <span>${Y(e.description||"-")}</span>
            <span style="margin:0 6px;color:#D1D5DB">·</span>
            <strong class="${c}">${r}${dt(e.amount)}</strong>`}s&&(s.style.display="");const i=document.getElementById("bank-cand-pane-body");if(i){i.innerHTML=`<div class="bank-empty">${t("bank-cand-loading")}</div>`;try{const r=await fetch("/api/bank-recon/tx/"+encodeURIComponent(e.id)+"/candidates",{headers:{Authorization:"Bearer "+token}});if(!r.ok)throw new Error("cands:"+r.status);const c=await r.json();ul(e,c.candidates||[])}catch{i.innerHTML=`<div class="bank-empty">${t("bank-cand-load-failed")}</div>`}}}function pl(e,n,a){const o=n.history_id,s=n.invoice_no||"-",i=n.vendor||"-",r=n.amount_total!==null&&n.amount_total!==void 0?dt(n.amount_total):"-",c=n.invoice_date?Lt(n.invoice_date):"-",f=n.filename||"",d=!!a&&e.matched_history_id===o,u="bank-cand-card"+(n.is_auto_picked?" is-auto":"")+(d?" is-picked":"");let l="";return d?l='<button class="btn btn-ghost btn-small" data-act="unmatch"><span>'+t("bank-cand-unmatch")+"</span></button>":l='<button class="btn btn-primary btn-small" data-act="pick" data-hid="'+Y(o)+'"><span>'+t(n.is_auto_picked?"bank-cand-confirm":"bank-cand-pick-this")+"</span></button>",'<div class="'+u+'" data-hid="'+Y(o)+'"><div class="bank-cand-card-head"><div class="bank-cand-card-vendor">'+Y(i)+"</div>"+il(n.score)+'</div><div class="bank-cand-card-fields"><span class="bank-cand-field"><span class="bank-cand-flabel">'+t("bank-cand-fld-invoice-no")+"</span> "+Y(s)+'</span><span class="bank-cand-field"><span class="bank-cand-flabel">'+t("bank-cand-fld-amount")+"</span> "+r+'</span><span class="bank-cand-field"><span class="bank-cand-flabel">'+t("bank-cand-fld-date")+"</span> "+Y(c)+"</span></div>"+(f?'<div class="bank-cand-card-file" title="'+Y(f)+'">'+Y(f)+"</div>":"")+(n.reason?'<div class="bank-cand-card-reason">'+Y(n.reason)+"</div>":"")+'<div class="bank-cand-card-actions">'+l+"</div></div>"}function ul(e,n){const a=document.getElementById("bank-cand-pane-body");if(!a)return;const o=n||[];let s="";if(e.match_status==="matched")s='<div class="bank-cand-hint hint-matched">'+t("bank-cand-hint-matched").replace("{n}",o.length)+"</div>";else if(e.match_status==="suggested")s='<div class="bank-cand-hint hint-suggested">'+t("bank-cand-hint-suggested").replace("{n}",o.length)+"</div>";else if(o.length>0)s='<div class="bank-cand-hint hint-low">'+t("bank-cand-hint-low").replace("{n}",o.length)+"</div>";else{a.innerHTML='<div class="bank-empty">'+t("bank-cand-no-match-detail")+"</div>";return}const i=e.match_status==="matched",r=o.map(c=>pl(e,c,i)).join("");a.innerHTML=s+'<div class="bank-cand-list">'+r+"</div>",a.querySelectorAll('[data-act="pick"]').forEach(c=>{c.addEventListener("click",()=>{vl(c.dataset.hid)})}),a.querySelectorAll('[data-act="unmatch"]').forEach(c=>{c.addEventListener("click",async()=>{try{await fetch("/api/bank-recon/tx/"+encodeURIComponent(e.id)+"/override",{method:"POST",headers:{Authorization:"Bearer "+token,"Content-Type":"application/json"},body:JSON.stringify({status:"unmatched"})}),Jt(),await Tt($.currentSession.id)}catch{showToast(t("bank-action-failed"),"error")}})})}function Jt(){const e=document.getElementById("bank-detail-body");e&&e.classList.remove("has-pane");const n=document.getElementById("bank-cand-pane-title"),a=document.getElementById("bank-cand-pane-sub"),o=document.getElementById("bank-cand-pane-body"),s=document.getElementById("bank-cand-pane-foot");n&&(n.textContent=t("bank-cand-pane-empty-title")),a&&(a.textContent=t("bank-cand-pane-empty-sub")),s&&(s.style.display="none"),o&&(o.innerHTML='<div class="bank-cand-pane-empty"><svg viewBox="0 0 64 64" fill="none" stroke="currentColor" stroke-width="1.4" stroke-linecap="round" stroke-linejoin="round"><rect x="14" y="10" width="36" height="44" rx="3"/><path d="M22 22h20M22 30h20M22 38h12"/></svg><div>'+t("bank-cand-pane-empty-hint")+"</div></div>");const i=document.getElementById("bank-tx-tbody");i&&i.querySelectorAll("tr.is-selected").forEach(r=>r.classList.remove("is-selected")),$.currentTxForDrawer=null}async function Tt(e){try{const n="/api/bank-recon/sessions/"+encodeURIComponent(e)+($.currentFilter!=="all"?"?filter="+$.currentFilter:""),a=await fetch(n,{headers:{Authorization:"Bearer "+token}});if(!a.ok)throw new Error("detail:"+a.status);const o=await a.json();$.currentSession=o.session,$.currentTxs=o.transactions||[],kl()}catch(n){console.warn("[bank-recon] loadSessionDetail failed",n),showToast(t("bank-load-failed"),"error")}}async function fl(){if(!$.currentSession)return;const e=document.getElementById("btn-bank-run-match"),n=e.innerHTML;e.disabled=!0,e.innerHTML="<span>"+t("bank-matching")+"</span>";try{const a=await fetch("/api/bank-recon/sessions/"+encodeURIComponent($.currentSession.id)+"/match",{method:"POST",headers:{Authorization:"Bearer "+token}});if(!a.ok)throw new Error("match:"+a.status);const o=await a.json();showToast(t("bank-match-done").replace("{matched}",o.matched).replace("{suggested}",o.suggested).replace("{unmatched}",o.unmatched),"success"),await Tt($.currentSession.id),await Mt()}catch(a){console.warn("[bank-recon] match failed",a),showToast(t("bank-match-failed"),"error")}finally{e.disabled=!1,e.innerHTML=n}}async function ml(){if(!(!$.currentSession||!await showConfirm(t("bank-delete-confirm"),{danger:!0})))try{const n=await fetch("/api/bank-recon/sessions/"+encodeURIComponent($.currentSession.id),{method:"DELETE",headers:{Authorization:"Bearer "+token}});if(!n.ok)throw new Error("delete:"+n.status);showToast(t("bank-deleted"),"success"),$.currentSession=null,$.currentTxs=[],$a(),await Mt()}catch(n){console.warn("[bank-recon] delete failed",n),showToast(t("bank-delete-failed"),"error")}}async function po(){if($.currentTxForDrawer)try{const e=await fetch("/api/bank-recon/tx/"+encodeURIComponent($.currentTxForDrawer.id)+"/override",{method:"POST",headers:{Authorization:"Bearer "+token,"Content-Type":"application/json"},body:JSON.stringify({status:"ignored"})});if(!e.ok)throw new Error("ignore:"+e.status);Jt(),await Tt($.currentSession.id)}catch{showToast(t("bank-action-failed"),"error")}}async function vl(e){if($.currentTxForDrawer)try{const n=await fetch("/api/bank-recon/tx/"+encodeURIComponent($.currentTxForDrawer.id)+"/override",{method:"POST",headers:{Authorization:"Bearer "+token,"Content-Type":"application/json"},body:JSON.stringify({status:"matched",history_id:e})});if(!n.ok)throw new Error("pick:"+n.status);showToast(t("bank-matched-ok"),"success"),Jt(),await Tt($.currentSession.id)}catch{showToast(t("bank-action-failed"),"error")}}function Es(){if(!$.currentSession)return;const e=$.currentSession;document.getElementById("bank-detail-title").textContent=(e.bank_code||"-")+(e.account_last4?" ···"+e.account_last4:"")+" · "+(e.source_filename||""),document.getElementById("bank-meta-period").textContent=_s(e.period_start,e.period_end)||"-",document.getElementById("bank-meta-opening").textContent=dt(e.opening_balance),document.getElementById("bank-meta-inflow").textContent="+"+dt(e.total_inflow),document.getElementById("bank-meta-outflow").textContent="-"+dt(e.total_outflow),document.getElementById("bank-meta-closing").textContent=dt(e.closing_balance);const n=$.currentTxs||[],a=n.length;let o=0,s=0,i=0;for(const r of n){const c=r.match_status||"unmatched";c==="matched"?o++:c==="suggested"?s++:i++}document.getElementById("bank-stat-total").textContent=a,document.getElementById("bank-stat-matched").textContent=o,document.getElementById("bank-stat-suggested").textContent=s,document.getElementById("bank-stat-unmatched").textContent=i}function Ta(){const e=document.getElementById("bank-tx-tbody");if(!e)return;let n=$.currentTxs||[];if($.currentFilter!=="all"&&(n=n.filter(a=>$.currentFilter==="matched"?a.match_status==="matched":$.currentFilter==="suggested"?a.match_status==="suggested":$.currentFilter==="unmatched"?a.match_status==="unmatched"||a.match_status==="ignored":!0)),n.length===0){e.innerHTML=`<tr><td colspan="4" class="bank-empty">${t("bank-tx-empty")}</td></tr>`;return}if(e.innerHTML=n.map(a=>hl(a)).join(""),e.querySelectorAll("tr[data-tx-id]").forEach(a=>{a.addEventListener("click",()=>{const o=a.dataset.txId,s=$.currentTxs.find(i=>i.id===o);s&&(e.querySelectorAll("tr.is-selected").forEach(i=>i.classList.remove("is-selected")),a.classList.add("is-selected"),dl(s))})}),$.currentTxForDrawer){const a=e.querySelector('tr[data-tx-id="'+$.currentTxForDrawer.id+'"]');a&&a.classList.add("is-selected")}}function hl(e){const n=e.direction==="OUT",a=n?"-":"+",o=n?"bank-out":"bank-in",s=e.match_status||"unmatched",i=t("bank-match-"+s)||s,r=Lt(e.tx_date),c=e.channel?`<span class="bank-tx-channel">${Y(e.channel)}</span>`:"";return`
        <tr data-tx-id="${Y(e.id)}">
            <td class="bank-tx-date">${Y(r)}</td>
            <td class="bank-tx-desc">${c}${Y(e.description||"-")}</td>
            <td class="bank-td-amount ${o}">${a}${dt(e.amount)}</td>
            <td><span class="bank-tx-match mt-${s}">${Y(i)}</span></td>
        </tr>
    `}function Ma(){const e=document.getElementById("bank-client-badge");if(!e||!$.currentSession)return;const n=$.currentSession.client_id,a=document.getElementById("bank-client-badge-dot"),o=document.getElementById("bank-client-badge-name"),s=document.getElementById("bank-client-badge-caret"),i=typeof _userInfo<"u"?_userInfo:null,r=!(i&&i.role==="member");if(n!=null){const c=(window._clientsCache||[]).find(f=>Number(f.id)===Number(n));e.classList.remove("is-empty"),a&&(a.style.background=c&&c.color||"#111111"),o&&(o.textContent=c&&(c.short_name||c.name)||"#"+n)}else e.classList.add("is-empty"),a&&(a.style.background=""),o&&(o.textContent=t("bank-client-none"));r?(e.classList.remove("is-readonly"),e.disabled=!1,s&&(s.style.display="")):(e.classList.add("is-readonly"),e.disabled=!0,s&&(s.style.display="none")),e.style.display=""}function gl(){if(!$.currentSession)return;const e=typeof _userInfo<"u"?_userInfo:null;if(!!(e&&e.role==="member"))return;$.pickerSelected=$.currentSession.client_id!=null?Number($.currentSession.client_id):null,Ls();const a=document.getElementById("bank-client-picker-modal");a&&(a.style.display="")}function Is(){const e=document.getElementById("bank-client-picker-modal");e&&(e.style.display="none"),$.pickerSelected=null}function Ls(){const e=document.getElementById("bank-client-picker-list");if(!e)return;const n=(window._clientsCache||[]).filter(o=>o&&(o.is_active===!0||o.is_active===void 0)),a=[];a.push('<div class="bank-client-picker-row is-none'+($.pickerSelected==null?" is-selected":"")+'" data-cid=""><span class="bank-cp-dot"></span><span>'+Y(t("bank-client-picker-none"))+"</span></div>"),n.forEach(o=>{const s=Number(o.id)===Number($.pickerSelected)?" is-selected":"";a.push('<div class="bank-client-picker-row'+s+'" data-cid="'+Y(o.id)+'"><span class="bank-cp-dot" style="background:'+Y(o.color||"#111111")+'"></span><span>'+Y(o.short_name||o.name||"#"+o.id)+"</span></div>")}),e.innerHTML=a.join(""),e.querySelectorAll(".bank-client-picker-row").forEach(o=>{o.addEventListener("click",()=>{const s=o.dataset.cid;$.pickerSelected=s?Number(s):null,Ls()})})}async function bl(){if($.currentSession)try{const e=await fetch("/api/bank-recon/sessions/"+encodeURIComponent($.currentSession.id)+"/client",{method:"PATCH",headers:{Authorization:"Bearer "+token,"Content-Type":"application/json"},body:JSON.stringify({client_id:$.pickerSelected})});if(!e.ok)throw new Error("client:"+e.status);$.currentSession.client_id=$.pickerSelected,Ma(),showToast(t("bank-client-changed"),"success"),Is();try{await Mt()}catch{}}catch(e){console.warn("[bank-recon] save client failed",e),showToast(t("bank-client-change-failed"),"error")}}async function Mt(){try{const e=await fetch("/api/bank-recon/sessions?limit=30",{headers:{Authorization:"Bearer "+token}});if(!e.ok)throw new Error("sessions:"+e.status);$.sessions=await e.json(),wn()}catch(e){console.warn("[bank-recon] loadSessions failed",e),$.sessions=[],wn()}}function uo(){const e=document.getElementById("bank-status-summary");if(!e)return;if($.sessions.length===0){e.textContent=t("bank-pill-none");return}let a=0;for(const o of $.sessions)o.parse_status==="parsed"&&(o.unmatched_count||0)>0&&a++;e.textContent=a>0?t("bank-pill-pending").replace("{n}",a):t("bank-pill-ok")}function wn(){const e=document.getElementById("bank-sessions-list");if(!e)return;let n=$.sessions||[];if($.sessionFilter==="parsed"?n=n.filter(a=>a.parse_status==="parsed"):$.sessionFilter==="failed"&&(n=n.filter(a=>a.parse_status==="parse_failed")),!$.sessions||$.sessions.length===0){e.innerHTML='<div class="bank-empty" data-i18n="bank-sessions-empty">'+t("bank-sessions-empty")+"</div>";return}if(n.length===0){e.innerHTML='<div class="bank-empty">'+t("bank-sess-filter-empty")+"</div>";return}e.innerHTML=n.map(a=>yl(a)).join(""),e.querySelectorAll(".bank-session-row").forEach(a=>{a.addEventListener("click",o=>{o.target.closest(".bank-session-trash")||Tt(a.dataset.sessionId)})}),e.querySelectorAll(".bank-session-trash").forEach(a=>{a.addEventListener("click",o=>{o.stopPropagation();const s=a.dataset.sessionId,i=a.dataset.sessionName||"";Bs(s,i)})})}async function Bs(e,n){if(!e)return;const a=(t("bank-session-delete-confirm")||"确定删除这条对账记录吗?").replace("{name}",n||"");if(await showConfirm(a,{danger:!0}))try{const s=await fetch("/api/bank-recon/sessions/"+encodeURIComponent(e),{method:"DELETE",headers:{Authorization:"Bearer "+token}});if(!s.ok)throw new Error("delete:"+s.status);showToast(t("bank-deleted"),"success"),$.currentSession&&$.currentSession.id===e&&($.currentSession=null,$.currentTxs=[],$a()),await Mt(),typeof window.loadReconcilePage=="function"&&window.loadReconcilePage()}catch(s){console.warn("[bank-recon] delete failed",s),showToast(t("bank-delete-failed"),"error")}}function yl(e){const n=(e.bank_code||"OTHER").toUpperCase(),a=_s(e.period_start,e.period_end),o=e.account_last4?"···"+e.account_last4:"",s=wl(e),i=Lt(e.created_at);return`
    ...
    `}function wl(e){if(e.parse_status==="parse_failed")return`<span class="bank-session-count cnt-failed">${t("bank-count-parse-failed")}</span>`;if(e.parse_status!=="parsed")return`<span class="bank-session-count">${t("bank-count-parsing")}</span>`;const n=e.tx_count||0,a=e.matched_count||0,o=e.unmatched_count||0,s=[`<span class="bank-session-count">${n} ${t("bank-count-tx")}</span>`];return a>0&&s.push(`<span class="bank-session-count cnt-matched">${a} ${t("bank-count-matched")}</span>`),o>0&&s.push(`<span class="bank-session-count cnt-unmatched">${o} ${t("bank-count-unmatched")}</span>`),s.join("")}function kl(){document.getElementById("bank-detail").style.display="",document.querySelector(".bank-sessions-section").style.display="none",Es(),Ta(),Ma()}function $a(){document.getElementById("bank-detail").style.display="none",document.querySelector(".bank-sessions-section").style.display="";const e=document.getElementById("bank-detail-body");e&&e.classList.remove("has-pane"),$.currentTxForDrawer=null}const xl=3;function _l(){return $.qSeq+=1,"q"+$.qSeq+"_"+Date.now()}async function El(e){const n=Array.from(e.target.files||[]);if(e.target.value="",n.length!==0){for(const a of n){const o={id:_l(),file:a,name:a.name,size:a.size,status:"pending",progress:0,error_code:null,tx_count:0,session_id:null};a.name.toLowerCase().endsWith(".pdf")?a.size>20*1024*1024&&(o.status="failed",o.error_code="bank_recon.file_too_large"):(o.status="failed",o.error_code="bank_recon.only_pdf"),$.queue.push(o)}Il(),Ee(),Ha()}}function Il(){const e=document.getElementById("bank-upload-queue");e&&(e.style.display=""),rl(),ll()}function Ee(){const e=document.getElementById("bank-upload-queue-list"),n=document.getElementById("bank-upload-queue-summary");if(!e)return;if($.queue.length===0){e.innerHTML="",n&&(n.textContent="");const r=document.getElementById("bank-upload-queue");r&&(r.style.display="none");return}let a=0,o=0,s=0,i=0;for(const r of $.queue)r.status==="ok"?a++:r.status==="failed"?o++:r.status==="uploading"||r.status==="parsing"?s++:i++;n&&(n.textContent=t("bank-queue-summary").replace("{ok}",a).replace("{run}",s).replace("{wait}",i).replace("{fail}",o)),e.innerHTML=$.queue.map(Ll).join(""),e.querySelectorAll("[data-q-act]").forEach(r=>{const c=r.dataset.qAct,f=r.dataset.qId;r.addEventListener("click",()=>{c==="retry"&&Bl(f),c==="remove"&&Cl(f)})})}function Ll(e){const n=(e.size/1024).toFixed(0)+" KB";let a="",o="";if(e.status==="pending")a='<span class="bq-stat bq-wait">'+t("bank-queue-status-wait")+"</span>",o='<button data-q-act="remove" data-q-id="'+Y(e.id)+'" class="bq-act">×</button>';else if(e.status==="uploading")a='<span class="bq-stat bq-run">'+t("bank-queue-status-uploading")+'</span><div class="bq-bar"><div class="bq-bar-fill" style="width:'+(e.progress||0)+'%"></div></div>';else if(e.status==="parsing")a='<span class="bq-stat bq-run">'+t("bank-queue-status-parsing")+'</span><div class="bq-bar"><div class="bq-bar-fill bq-bar-indet"></div></div>';else if(e.status==="ok")a='<span class="bq-stat bq-ok">'+t("bank-queue-status-ok").replace("{n}",e.tx_count||0)+"</span>",o='<button data-q-act="remove" data-q-id="'+Y(e.id)+'" class="bq-act">×</button>';else if(e.status==="failed"){const s=cl(e.error_code||"unknown");a='<span class="bq-stat bq-fail" title="'+Y(s)+'">'+Y(s)+"</span>",o='<button data-q-act="retry" data-q-id="'+Y(e.id)+'" class="bq-act bq-act-retry">'+t("bank-queue-retry")+'</button><button data-q-act="remove" data-q-id="'+Y(e.id)+'" class="bq-act">×</button>'}return'<div class="bq-row" data-q-row="'+Y(e.id)+'"><div class="bq-name" title="'+Y(e.name)+'">'+Y(e.name)+'</div><div class="bq-size">'+n+'</div><div class="bq-status">'+a+'</div><div class="bq-actions">'+o+"</div></div>"}function Bl(e){const n=$.queue.find(a=>a.id===e);n&&(n.status="pending",n.error_code=null,n.progress=0,Ee(),Ha())}function Cl(e){const n=$.queue.findIndex(o=>o.id===e);if(n<0)return;const a=$.queue[n];a.status==="uploading"||a.status==="parsing"||($.queue.splice(n,1),Ee())}function Sl(){$.queue=$.queue.filter(e=>e.status!=="ok"),Ee()}async function Ha(){for(;;){if($.queue.filter(a=>a.status==="uploading"||a.status==="parsing").length>=xl)return;const n=$.queue.find(a=>a.status==="pending");if(!n){$.queue.every(a=>a.status==="ok"||a.status==="failed")&&(await Mt(),typeof window.loadReconcilePage=="function"&&window.loadReconcilePage());return}Tl(n).then(()=>Ha())}}async function Tl(e){e.status="uploading",e.progress=0,Ee();try{const n=new FormData;n.append("file",e.file,e.name);const a=await new Promise((s,i)=>{const r=new XMLHttpRequest;r.open("POST","/api/bank-recon/upload"),r.setRequestHeader("Authorization","Bearer "+token),r.upload.onprogress=c=>{c.lengthComputable&&(e.progress=Math.min(99,Math.round(c.loaded/c.total*100)),Ee())},r.upload.onload=()=>{e.status="parsing",Ee()},r.onload=()=>{r.status>=200&&r.status<300?s({status:r.status,text:r.responseText}):s({status:r.status,text:r.responseText})},r.onerror=()=>i(new Error("network")),r.send(n)});let o={};try{o=JSON.parse(a.text||"{}")}catch{o={}}if(a.status>=400){e.status="failed",e.error_code=o&&o.detail||"unknown",Ee();return}if(o.parse_status==="parse_failed"){e.status="failed",e.error_code=o.error==="scanned_pdf_not_yet"?"bank_recon.scanned":"bank_recon.no_tx",Ee();return}e.status="ok",e.tx_count=o.tx_count||0,e.session_id=o.session_id||null,Ee()}catch(n){console.warn("[bank-recon] upload failed",n),e.status="failed",e.error_code="network",Ee()}}async function Cs(){if($.loaded){uo();return}$.loaded=!0,Ml(),await Mt(),uo()}function Ml(){const e=document.getElementById("bank-file-input");e&&!e._bound&&(e._bound=!0,e.addEventListener("change",El));const n=document.getElementById("btn-bank-queue-clear-done");n&&!n._bound&&(n._bound=!0,n.addEventListener("click",Sl));const a=document.getElementById("btn-bank-back");a&&!a._bound&&(a._bound=!0,a.addEventListener("click",()=>{$.currentSession=null,$.currentTxs=[],$a()}));const o=document.getElementById("btn-bank-delete");o&&!o._bound&&(o._bound=!0,o.addEventListener("click",ml));const s=document.getElementById("btn-bank-run-match");s&&!s._bound&&(s._bound=!0,s.addEventListener("click",fl)),document.querySelectorAll(".bank-filter-btn").forEach(u=>{u._bound||(u._bound=!0,u.addEventListener("click",()=>{$.currentFilter=u.dataset.bankFilter||"all",document.querySelectorAll(".bank-filter-btn").forEach(l=>{l.classList.toggle("active",l===u)}),Ta()}))}),document.querySelectorAll("[data-bank-cand-close]").forEach(u=>{u._bound||(u._bound=!0,u.addEventListener("click",Jt))});const i=document.getElementById("btn-bank-cand-pane-close");i&&!i._bound&&(i._bound=!0,i.addEventListener("click",Jt));const r=document.getElementById("btn-bank-cand-ignore");r&&!r._bound&&(r._bound=!0,r.addEventListener("click",po));const c=document.getElementById("btn-bank-cand-ignore-pane");c&&!c._bound&&(c._bound=!0,c.addEventListener("click",po));const f=document.getElementById("bank-client-badge");f&&!f._bound&&(f._bound=!0,f.addEventListener("click",gl)),document.querySelectorAll("[data-bank-client-picker-close]").forEach(u=>{u._bound||(u._bound=!0,u.addEventListener("click",Is))});const d=document.getElementById("btn-bank-client-picker-save");d&&!d._bound&&(d._bound=!0,d.addEventListener("click",bl)),document.querySelectorAll(".bank-sessions-chip").forEach(u=>{u._bound||(u._bound=!0,u.addEventListener("click",()=>{$.sessionFilter=u.dataset.sessFilter||"all",document.querySelectorAll(".bank-sessions-chip").forEach(l=>{l.classList.toggle("active",l===u)}),wn()}))})}window._deleteBankSession=Bs;window._loadBankReconPanel=Cs;window._rerenderBankRecon=function(){if(currentRoute==="automation"){if(wn(),$.currentSession&&(Es(),Ta(),Ma(),!$.currentTxForDrawer)){const e=document.getElementById("bank-cand-pane-title"),n=document.getElementById("bank-cand-pane-sub");e&&(e.textContent=t("bank-cand-pane-empty-title")),n&&(n.textContent=t("bank-cand-pane-empty-sub"))}Ee()}};typeof window.subscribeI18n=="function"&&window.subscribeI18n("bank-recon",window._rerenderBankRecon);window._openBankSession=async function(e){e&&($.loaded||await Cs(),await Tt(e))};(function(){const e=document.getElementById("page-clients");if(!(!e||e.dataset.wbInjected==="1")){e.innerHTML=`
        <div class="page-head">
            <div class="page-head-icon">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
...
`,e.dataset.wbInjected="1";try{const n=window._currentLang||localStorage.getItem("mrpilot_lang")||"th",a=window.I18N;a&&a[n]&&(e.querySelectorAll("[data-i18n]").forEach(o=>{const s=o.getAttribute("data-i18n");a[n][s]&&(o.textContent=a[n][s])}),e.querySelectorAll("[data-i18n-placeholder]").forEach(o=>{const s=o.getAttribute("data-i18n-placeholder");a[n][s]&&(o.placeholder=a[n][s])}))}catch{}}})();const $l=`
    ...
    `;ge("client-modal-mask",$l);ge("wsclient-modal-mask",Hl);const O={clients:[],editingClientId:null,historyClientFilter:"",custTab:"seller",sellerClients:[],editingWsClientId:null,catCache:{fetched:0,items:[],supplier_count:0}},ve={page:0,pageSize:12,keyword:""},De=new Set,kn={keyword:""};function Al(){return{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||"")}}async function $e(e,n={}){const a=await fetch(e,{...n,headers:{"Content-Type":"application/json",...Al(),...n.headers||{}}});if(!a.ok){const o=await a.json().catch(()=>({}));throw new Error(o.detail||"HTTP "+a.status)}return a.json()}function jl(){const e=document.querySelector("#client-color-picker .color-swatch.active");return e?e.dataset.color:"#111111"}function fo(e){const n=document.getElementById("drawer-cat-learned-tag");n&&e>0&&(n.textContent=(t("drawer-suggest-learned-with-count")||"已学 {n}").replace("{n}",String(e)))}async function $t(){try{const e=await $e("/api/clients");O.clients=e.clients||[],window._clientsCache=O.clients}catch(e){console.error("loadClientsCache fail",e),O.clients=[]}try{typeof window._refreshExcClientFilter=="function"&&window._refreshExcClientFilter()}catch{}try{typeof window._refreshClientSwitcher=="function"&&window._refreshClientSwitcher()}catch{}return O.clients}function Pl(){const e=ve.keyword.trim().toLowerCase();return e?O.clients.filter(n=>(n.name||"").toLowerCase().includes(e)||(n.short_name||"").toLowerCase().includes(e)||(n.tax_id||"").toLowerCase().includes(e)):O.clients}function Aa(){const e=Pl(),n=ve.pageSize,a=Math.max(0,Math.ceil(e.length/n)-1);ve.page>a&&(ve.page=a);const o=ve.page*n;return{all:e,items:e.slice(o,o+n),start:o,ps:n,total:e.length,maxPage:a}}function je(){const e=document.getElementById("buyer-tbody");if(!e)return;const{items:n,start:a,ps:o,total:s,maxPage:i}=Aa();s?e.innerHTML=n.map(d=>{const u=De.has(d.id);return`<div class="cust-row buyer-grid${u?" selected":""}" data-cid="${d.id}">
            ...
            </div>`}).join(""):e.innerHTML=`<div class="cust-empty">${escapeHtml(t(ve.keyword?"cust-no-match":"clients-empty"))}</div>`;const r=document.getElementById("buyer-pager-info");r&&(r.textContent=s?`${a+1}–${Math.min(a+o,s)} / ${s}`:"0");const c=document.getElementById("buyer-prev");c&&(c.disabled=ve.page<=0);const f=document.getElementById("buyer-next");f&&(f.disabled=ve.page>=i),Ss()}function Ss(){const e=De.size,n=document.getElementById("buyer-batch-bar");n&&(n.style.display=e?"flex":"none");const a=document.getElementById("buyer-batch-count");a&&(a.textContent=t("cust-selected-n").replace("{n}",e));const o=document.getElementById("buyer-check-all");if(o){const{items:s}=Aa(),i=s.map(c=>c.id),r=i.filter(c=>De.has(c)).length;o.checked=i.length>0&&r===i.length,o.indeterminate=r>0&&r<i.length}}function Dl(){De.clear(),je()}async function Rl(){const e=Array.from(De);if(!(!e.length||!await showConfirm(t("cust-batch-del-confirm").replace("{n}",e.length),{danger:!0})))try{await $e("/api/clients/batch-delete",{method:"POST",body:JSON.stringify({ids:e})}),showToast(t("client-msg-deleted"),"success"),De.clear(),await $t(),je(),jn(),ja()}catch{showToast(t("client-msg-save-fail"),"fail")}}function Ot(e){O.editingClientId=e?e.id:null;const n=!!e;document.getElementById("client-modal-title").textContent=t(n?"client-modal-edit":"client-modal-new"),document.getElementById("client-input-name").value=e&&e.name||"",document.getElementById("client-input-short").value=e&&e.short_name||"",document.getElementById("client-input-tax").value=e&&e.tax_id||"",document.getElementById("client-input-address").value=e&&e.address||"",document.getElementById("client-input-contact").value=e&&e.contact_person||"",document.getElementById("client-input-phone").value=e&&e.contact_phone||"",document.getElementById("client-input-email").value=e&&e.contact_email||"",document.getElementById("client-input-notes").value=e&&e.notes||"";const a=e&&e.color||"#111111";document.querySelectorAll("#client-color-picker .color-swatch").forEach(o=>{o.classList.toggle("active",o.dataset.color===a)}),document.getElementById("client-modal-delete").style.display=n?"":"none",document.getElementById("client-modal-mask").style.display="flex",setTimeout(()=>document.getElementById("client-input-name").focus(),50)}function Vt(){document.getElementById("client-modal-mask").style.display="none",O.editingClientId=null}async function Fl(){const e=document.getElementById("client-input-name").value.trim();if(!e){showToast(t("client-msg-name-required"),"fail");return}const n={name:e,short_name:document.getElementById("client-input-short").value.trim()||null,tax_id:document.getElementById("client-input-tax").value.trim()||null,address:document.getElementById("client-input-address").value.trim()||null,contact_person:document.getElementById("client-input-contact").value.trim()||null,contact_phone:document.getElementById("client-input-phone").value.trim()||null,contact_email:document.getElementById("client-input-email").value.trim()||null,notes:document.getElementById("client-input-notes").value.trim()||null,color:jl()};try{O.editingClientId?(await $e(`/api/clients/${O.editingClientId}`,{method:"PATCH",body:JSON.stringify(n)}),showToast(t("client-msg-updated"),"success")):(await $e("/api/clients",{method:"POST",body:JSON.stringify(n)}),showToast(t("client-msg-created"),"success")),Vt(),await $t(),currentRoute==="clients"&&je(),jn(),ja()}catch(a){console.error("saveClient fail",a);const o=a&&a.message?a.message:t("client-msg-save-fail");showToast(t("client-msg-save-fail")+" · "+o,"fail")}}async function ql(){if(!O.editingClientId)return;const e=O.clients.find(o=>o.id===O.editingClientId);if(!e)return;const n=t("client-delete-confirm").replace("{name}",e.name);if(await showConfirm(n,{danger:!0}))try{await $e(`/api/clients/${O.editingClientId}`,{method:"DELETE"}),showToast(t("client-msg-deleted"),"success"),Vt(),await $t(),currentRoute==="clients"&&je(),jn(),ja()}catch(o){console.error(o),showToast(t("client-msg-save-fail"),"fail")}}async function zl(e){const n=O.clients.find(a=>a.id===e);if(typeof window.openClientExportModal=="function"){window.openClientExportModal(e,n?n.name:"");return}try{const a=localStorage.getItem("mrpilot_token"),o=await fetch(`/api/clients/${e}/export?month=all`,{headers:{Authorization:"Bearer "+a}});if(!o.ok){let f="HTTP "+o.status;try{const d=await o.json();d&&d.detail&&(f=d.detail)}catch{}throw new Error(f)}const s=await o.blob();if(s.size<200){showToast(t("client-export-month-empty"),"info");return}const i=n&&n.name?n.name.replace(/[^a-zA-Z0-9\u0e00-\u0e7f\u4e00-\u9fff]/g,"_").slice(0,40):"client",r=URL.createObjectURL(s),c=document.createElement("a");c.href=r,c.download=`${i}_export.csv`,c.click(),URL.revokeObjectURL(r)}catch(a){console.error("exportClient fail",a),showToast(t("client-msg-save-fail")+" · "+(a.message||""),"fail")}}function jn(){const e=document.getElementById("drawer-client-select");if(!e)return;const n=e.value;e.innerHTML=`<option value="">${escapeHtml(t("drawer-client-none"))}</option>`+O.clients.map(a=>`<option value="${a.id}">${escapeHtml(a.name)}</option>`).join(""),e.value=n||""}function ja(){const e=document.getElementById("history-client-filter");if(!e)return;const n=e.value;e.innerHTML=`<option value="">${escapeHtml(t("history-client-all"))}</option>`+O.clients.map(a=>`<option value="${a.id}">${escapeHtml(a.name)}</option>`).join(""),e.value=n||""}function Nl(e){O.custTab=e==="buyer"?"buyer":"seller",document.querySelectorAll("[data-cust-tab]").forEach(o=>o.classList.toggle("active",o.dataset.custTab===O.custTab));const n=document.getElementById("cust-pane-seller"),a=document.getElementById("cust-pane-buyer");n&&n.classList.toggle("active",O.custTab==="seller"),a&&a.classList.toggle("active",O.custTab==="buyer")}function Ol(){const e=window._userInfo||{},n=String(e.role||"").toLowerCase(),a=String(e.tenant_role||"").toLowerCase();return e.is_super_admin===!0||e.is_owner===!0||n==="owner"||n==="admin"||a==="owner"||a==="admin"}function Ts(){window._workspaceClientsCache=O.sellerClients,typeof window.renderWorkspaceControl=="function"&&window.renderWorkspaceControl()}async function Pa(){try{const e=await $e("/api/workspace/clients");O.sellerClients=e&&(e.clients||e.items)||[],window._workspaceClientsCache=O.sellerClients}catch(e){console.error("loadSellerCache fail",e),O.sellerClients=[]}return O.sellerClients}function Vl(){const e=kn.keyword.trim().toLowerCase();return e?O.sellerClients.filter(n=>(n.name||"").toLowerCase().includes(e)||(n.tax_id||"").toLowerCase().includes(e)):O.sellerClients}function ut(){const e=document.getElementById("seller-tbody");if(!e)return;const n=Ol(),a=document.getElementById("btn-seller-new");a&&(a.style.display=n?"":"none");const o=Vl(),s=typeof window.getActiveWorkspaceClientId=="function"?window.getActiveWorkspaceClientId():null;if(!o.length){e.innerHTML=`<div class="cust-empty">${escapeHtml(t(kn.keyword?"cust-no-match":"seller-empty"))}</div>`;return}e.innerHTML=o.map(i=>{const c=s!=null&&Number(s)===Number(i.id)?`<span class="cust-badge-current"><svg viewBox="0 0 14 14" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M2 7.5l3.2 3.2L12 4"/></svg>${escapeHtml(t("seller-current"))}</span>`:`<button class="cust-row-btn primary" data-saction="activate" data-wid="${i.id}">${escapeHtml(t("seller-set-current"))}</button>`,f=n?`
            ...
            <div class="cust-row-actions">${c}${f}</div>
        </div>`}).join("")}function mo(e){O.editingWsClientId=e?e.id:null,document.getElementById("wsclient-modal-title").textContent=t(e?"wsclient-modal-edit":"wsclient-modal-new"),document.getElementById("wsclient-input-name").value=e&&e.name||"",document.getElementById("wsclient-input-tax").value=e&&e.tax_id||"",document.getElementById("wsclient-input-address").value=e&&e.address||"",document.getElementById("wsclient-input-branch").value=e&&e.branch||"",document.getElementById("wsclient-input-phone").value=e&&e.phone||"",document.getElementById("wsclient-input-vat").checked=e?e.vat_registered!==!1:!0,document.getElementById("wsclient-modal-archive").style.display=e?"":"none",document.getElementById("wsclient-modal-mask").style.display="flex",setTimeout(()=>document.getElementById("wsclient-input-name").focus(),50)}function Ut(){document.getElementById("wsclient-modal-mask").style.display="none",O.editingWsClientId=null}async function Ul(){const e=document.getElementById("wsclient-input-name").value.trim(),n=document.getElementById("wsclient-input-tax").value.trim(),a=document.getElementById("wsclient-input-address").value.trim(),o=document.getElementById("wsclient-input-branch").value.trim(),s=document.getElementById("wsclient-input-phone").value.trim(),i=document.getElementById("wsclient-input-vat").checked;if(!e){showToast(t("client-msg-name-required"),"fail");return}const r={address:a||null,branch:o||null,phone:s||null,vat_registered:i};try{O.editingWsClientId?(await $e("/api/workspace/clients/"+O.editingWsClientId,{method:"PATCH",body:JSON.stringify({name:e,tax_id:n,...r})}),showToast(t("client-msg-updated"),"success")):(await $e("/api/workspace/clients",{method:"POST",body:JSON.stringify({name:e,tax_id:n||null,...r})}),showToast(t("client-msg-created"),"success")),Ut(),await Pa(),ut(),Ts()}catch(c){const f=c&&c.message?c.message:t("client-msg-save-fail");showToast(t("client-msg-save-fail")+" · "+f,"fail")}}async function vo(){if(!O.editingWsClientId)return;const e=O.sellerClients.find(a=>Number(a.id)===Number(O.editingWsClientId));if(await showConfirm(t("wsclient-archive-confirm").replace("{name}",e?e.name:""),{danger:!0}))try{const a=O.editingWsClientId;await $e("/api/workspace/clients/"+a,{method:"DELETE"}),showToast(t("wsclient-archived"),"success"),typeof window.getActiveWorkspaceClientId=="function"&&Number(window.getActiveWorkspaceClientId())===Number(a)&&typeof window.enterPersonalMode=="function"&&window.enterPersonalMode(),Ut(),await Pa(),ut(),Ts()}catch{showToast(t("client-msg-save-fail"),"fail")}}window.loadClientsPage=async function(){const e=document.getElementById("seller-tbody");e&&(e.innerHTML=`<div class="cust-loading">${escapeHtml(t("clients-loading"))}</div>`);const n=document.getElementById("buyer-tbody");n&&(n.innerHTML=`<div class="cust-loading">${escapeHtml(t("clients-loading"))}</div>`),await Promise.all([Pa(),$t()]),ut(),je()};window.addEventListener("pearnly:workspace-changed",function(){typeof currentRoute<"u"&&currentRoute==="clients"&&ut()});window.bindDrawerClient=function(e,n){const a=document.getElementById("drawer-client-select");if(!a)return;if(jn(),a.value=n?String(n):"",!e){a.onchange=null;const s=document.getElementById("drawer-client-add");s&&(s.onclick=()=>Ot(null));return}a.onchange=async()=>{const s=a.value?parseInt(a.value,10):null;try{await $e(`/api/history/${e}/assign_client`,{method:"POST",body:JSON.stringify({client_id:s})}),showToast(t("client-msg-updated"),"success");const i=_results[_drawerIdx];i&&(i.client_id=s),await $t()}catch(i){console.error(i),showToast(t("client-msg-save-fail"),"fail"),a.value=n?String(n):""}};const o=document.getElementById("drawer-client-add");o&&(o.onclick=()=>Ot(null))};window.fillCategoryDatalist=async function(){try{const e=document.getElementById("drawer-cat-datalist"),n=Date.now();if(n-O.catCache.fetched<300*1e3){e&&(e.innerHTML=O.catCache.items.map(o=>`<option value="${escapeHtml(o)}">`).join("")),fo(O.catCache.supplier_count);return}const a=await $e("/api/categories",{method:"GET"});O.catCache.fetched=n,O.catCache.items=a&&a.categories||[],O.catCache.supplier_count=a&&a.supplier_count||0,e&&(e.innerHTML=O.catCache.items.map(o=>`<option value="${escapeHtml(o)}">`).join("")),fo(O.catCache.supplier_count)}catch(e){console.warn("fillCategoryDatalist failed",e)}};window.getHistoryClientFilter=function(){return O.historyClientFilter};document.addEventListener("DOMContentLoaded",()=>{const e=document.querySelector(".cust-tab-bar");e&&e.addEventListener("click",B=>{const C=B.target.closest("[data-cust-tab]");C&&Nl(C.dataset.custTab)});const n=document.getElementById("btn-buyer-new");n&&n.addEventListener("click",()=>Ot(null));const a=document.getElementById("buyer-tbody");a&&a.addEventListener("click",B=>{const C=B.target.closest(".buyer-row-check");if(C){const R=parseInt(C.dataset.cid,10);C.checked?De.add(R):De.delete(R);const V=C.closest(".cust-row");V&&V.classList.toggle("selected",C.checked),Ss();return}const S=B.target.closest(".cust-row-btn");if(S){B.stopPropagation();const R=parseInt(S.dataset.cid,10);if(S.dataset.action==="edit"){const V=O.clients.find(ne=>ne.id===R);V&&Ot(V)}else S.dataset.action==="export"&&zl(R);return}const M=B.target.closest(".cust-row");if(M&&!B.target.closest(".cust-cell-check")){const R=O.clients.find(V=>V.id===parseInt(M.dataset.cid,10));R&&Ot(R)}});const o=document.getElementById("buyer-check-all");o&&o.addEventListener("change",()=>{const{items:B}=Aa();B.forEach(C=>{o.checked?De.add(C.id):De.delete(C.id)}),je()});const s=document.getElementById("buyer-batch-cancel");s&&s.addEventListener("click",Dl);const i=document.getElementById("buyer-batch-delete");i&&i.addEventListener("click",Rl);const r=document.getElementById("buyer-prev");r&&r.addEventListener("click",()=>{ve.page>0&&(ve.page--,je())});const c=document.getElementById("buyer-next");c&&c.addEventListener("click",()=>{ve.page++,je()});const f=document.getElementById("buyer-search");if(f){let B;f.addEventListener("input",()=>{clearTimeout(B),B=setTimeout(()=>{ve.keyword=f.value,ve.page=0;const C=document.getElementById("buyer-search-clear");C&&(C.style.display=f.value?"":"none"),je()},200)})}const d=document.getElementById("buyer-search-clear");d&&d.addEventListener("click",()=>{const B=document.getElementById("buyer-search");B&&(B.value=""),ve.keyword="",ve.page=0,d.style.display="none",je()});const u=document.getElementById("btn-seller-new");u&&u.addEventListener("click",()=>mo(null));const l=document.getElementById("seller-tbody");l&&l.addEventListener("click",B=>{const C=B.target.closest("[data-saction]");if(!C)return;B.stopPropagation();const S=parseInt(C.dataset.wid,10),M=C.dataset.saction,R=O.sellerClients.find(V=>Number(V.id)===S);M==="activate"?(typeof window.setActiveWorkspaceClientId=="function"&&window.setActiveWorkspaceClientId(S),ut(),typeof window.renderWorkspaceControl=="function"&&window.renderWorkspaceControl(),showToast(t("seller-activated").replace("{name}",R?R.name:""),"success")):M==="edit"?R&&mo(R):M==="archive"&&(O.editingWsClientId=S,vo())});const p=document.getElementById("seller-search");if(p){let B;p.addEventListener("input",()=>{clearTimeout(B),B=setTimeout(()=>{kn.keyword=p.value;const C=document.getElementById("seller-search-clear");C&&(C.style.display=p.value?"":"none"),ut()},200)})}const m=document.getElementById("seller-search-clear");m&&m.addEventListener("click",()=>{const B=document.getElementById("seller-search");B&&(B.value=""),kn.keyword="",m.style.display="none",ut()});const v=document.getElementById("wsclient-modal-close");v&&v.addEventListener("click",Ut);const y=document.getElementById("wsclient-modal-cancel");y&&y.addEventListener("click",Ut);const b=document.getElementById("wsclient-modal-save");b&&b.addEventListener("click",Ul);const h=document.getElementById("wsclient-modal-archive");h&&h.addEventListener("click",vo);const g=document.getElementById("wsclient-modal-mask");g&&g.addEventListener("click",B=>{B.target===g&&Ut()});const _=document.getElementById("client-modal-close");_&&_.addEventListener("click",Vt);const w=document.getElementById("client-modal-cancel");w&&w.addEventListener("click",Vt);const k=document.getElementById("client-modal-save");k&&k.addEventListener("click",Fl);const x=document.getElementById("client-modal-delete");x&&x.addEventListener("click",ql);const E=document.getElementById("client-modal-mask");E&&E.addEventListener("click",B=>{B.target===E&&Vt()});const I=document.getElementById("client-color-picker");I&&I.addEventListener("click",B=>{const C=B.target.closest(".color-swatch");C&&(I.querySelectorAll(".color-swatch").forEach(S=>S.classList.remove("active")),C.classList.add("active"))});const L=document.getElementById("history-client-filter");L&&L.addEventListener("change",()=>{O.historyClientFilter=L.value,typeof renderHistoryList=="function"&&renderHistoryList()})});setTimeout(()=>$t(),1e3);(function(){const e=document.getElementById("page-exceptions");if(!(!e||e.dataset.wbInjected==="1")){e.innerHTML=`
        <div class="page-head">
            <div class="page-head-icon">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round">
...
`,e.dataset.wbInjected="1";try{const n=window._currentLang||localStorage.getItem("mrpilot_lang")||"th",a=window.I18N;a&&a[n]&&(e.querySelectorAll("[data-i18n]").forEach(o=>{const s=o.getAttribute("data-i18n");a[n][s]&&(o.textContent=a[n][s])}),e.querySelectorAll("[data-i18n-placeholder]").forEach(o=>{const s=o.getAttribute("data-i18n-placeholder");a[n][s]&&(o.placeholder=a[n][s])}))}catch{}}})();const D={statsCache:null,listCache:[],currentRule:null,currentClient:"",currentStatus:"pending",loading:!1,selectedIds:new Set,offset:0,pageSize:50,total:0,loadFailed:!1,listScrollY:0},P={openExcId:null,excRow:null,history:null,loading:!1,pdfUrl:null,pdfStatus:"idle",editing:!1,editFields:null},wt={batchLoading:!1};function Ze(e,n){let a=t(e)||e;if(n)for(const o in n)a=a.replace(new RegExp("\\{"+o+"\\}","g"),String(n[o]));return a}function Gl(e){return e==="high"?`<svg viewBox="0 0 14 14" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
    ...
    </svg>`}function Kl(){return`<svg class="exc-empty-icon" viewBox="0 0 40 40" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
        <path d="M11 19l5 5 13-13"/>
        <circle cx="20" cy="20" r="17"/>
    </svg>`}function Wl(e){if(e==null)return"—";const n=parseFloat(String(e));return isNaN(n)?"—":"฿ "+n.toLocaleString(void 0,{minimumFractionDigits:2,maximumFractionDigits:2})}function Yl(e){return e?e.slice(0,10):"—"}function Ne(e){if(e==null)return"—";const n=typeof e=="number"?e:parseFloat(String(e).replace(/,/g,""));return isNaN(n)?escapeHtml(String(e)):"฿ "+n.toLocaleString(void 0,{minimumFractionDigits:2,maximumFractionDigits:2})}const Jl={"R-VAT-01":"risk.vat_mismatch","R-VAT-02":"risk.total_mismatch","R-SUM-01":"risk.line_sum_mismatch","R-LINE-01":"risk.line_amount_mismatch","R-MULTIPAGE-01":"risk.multipage_mismatch","R-TAXID-01":"risk.seller_tax_id_invalid","R-TAXID-02":"risk.buyer_tax_id_invalid","R-TAXID-03":"risk.tax_id_placeholder","R-DUP-01":"risk.duplicate_exact","R-DUP-02":"risk.duplicate_suspected","R-DATE-01":"risk.invoice_date_unparseable","R-DATE-02":"risk.invoice_date_out_of_period","R-SUP-01":"risk.supplier_not_allowlisted","R-SUP-02":"risk.supplier_force_review","R-LIMIT-01":"risk.amount_over_limit","R-CAT-01":"risk.category_no_auto_push"};function Gn(e,n){const a=t(e);return a&&a!==e?a:n}function Da(e){const n=e.rule_code||"",a=e.detail&&e.detail.message_key;if(a){const i=Gn(a,"");if(i)return i}const o=Gn("exc-rule-"+n,"");if(o)return o;const s=Jl[n];if(s){const i=Gn(s,"");if(i)return i}return n}const Xl=[{labelKey:"exc-grp-arithmetic",codes:["R-VAT-01","R-VAT-02","R-SUM-01","R-LINE-01","R-MULTIPAGE-01","math_mismatch"]},{labelKey:"exc-grp-taxid",codes:["R-TAXID-01","R-TAXID-02","R-TAXID-03","tax_id_format_invalid"]},{labelKey:"exc-grp-dup",codes:["R-DUP-01","R-DUP-02","duplicate"]},{labelKey:"exc-grp-date",codes:["R-DATE-01","R-DATE-02"]},{labelKey:"exc-grp-customer",codes:["R-SUP-01","R-SUP-02","R-LIMIT-01","R-CAT-01"]},{labelKey:"exc-grp-fields",codes:["amount_missing"]},{labelKey:"exc-chip-confidence_low",codes:["confidence_low"]}];function Zl(e){if(!e)return"—";try{const n=new Date(e),a=o=>String(o).padStart(2,"0");return`${n.getFullYear()}-${a(n.getMonth()+1)}-${a(n.getDate())} ${a(n.getHours())}:${a(n.getMinutes())}`}catch{return e.slice(0,16).replace("T"," ")}}function te(e,n,a){return`<div class="exc-why-detail-row"><b>${escapeHtml(t(e))}</b><span class="${a||""}">${escapeHtml(n)}</span></div>`}function Ql(e,n){const a=s=>Ne(n[s]),o=s=>n[s]===null||n[s]===void 0?"—":String(n[s]);switch(e){case"risk.vat_mismatch":return te("exc-fld-subtotal",a("net_amount"))+te("exc-fld-vat",a("vat_amount"),"v-bad")+te("exc-detail-expected",a("expected_vat"),"v-good");case"risk.total_mismatch":{const s=Number(n.net_amount)||0,i=Number(n.vat_amount)||0;return te("exc-fld-subtotal",a("net_amount"))+te("exc-fld-vat",a("vat_amount"))+te("exc-fld-total",a("total_amount"),"v-bad")+te("exc-detail-expected",Ne(s+i),"v-good")}case"risk.line_sum_mismatch":return te("exc-ev-lines-sum",a("lines_sum"),"v-bad")+te("exc-fld-subtotal",a("net_amount"),"v-good");case"risk.line_amount_mismatch":{const s=Number(n.qty)||0,i=Number(n.unit_price)||0;return te("exc-ev-amount",a("amount"),"v-bad")+te("exc-detail-expected",Ne(s*i),"v-good")}case"risk.multipage_mismatch":return te("exc-ev-pages",o("pages"));case"risk.seller_tax_id_invalid":return te("exc-fld-seller-tax",o("seller_tax_id"),"v-bad");case"risk.buyer_tax_id_invalid":return te("exc-fld-buyer-tax",o("buyer_tax_id"),"v-bad");case"risk.tax_id_placeholder":return te("exc-ev-value",o("value"),"v-bad");case"risk.invoice_date_unparseable":case"risk.invoice_date_future":return te("exc-fld-date",o("invoice_date"),"v-bad");case"risk.invoice_date_out_of_period":return te("exc-fld-date",o("invoice_date"),"v-bad")+te("exc-ev-period-start",o("period_start"))+te("exc-ev-period-end",o("period_end"));case"risk.duplicate_exact":return(n.invoice_no?te("exc-fld-invoice-no",o("invoice_no")):"")+te("exc-fld-seller-tax",o("seller_tax_id"));case"risk.duplicate_suspected":{const s=Array.isArray(n.candidate_history_ids)?n.candidate_history_ids.length:0;return te("exc-ev-dup-count",String(s))}case"risk.supplier_not_allowlisted":return te("exc-fld-seller",o("seller_name"))+te("exc-fld-seller-tax",o("seller_tax_id"));case"risk.supplier_force_review":return te("exc-ev-reason",o("reason"),"v-bad")+te("exc-fld-seller-tax",o("seller_tax_id"));case"risk.amount_over_limit":return te("exc-ev-amount",a("value"),"v-bad")+te("exc-ev-limit",a("limit"),"v-good");case"risk.category_no_auto_push":return te("exc-ev-category",o("category"));default:return`<div class="exc-why-detail-row"><span style="font-size:11px;">${escapeHtml(JSON.stringify(n))}</span></div>`}}function ec(e,n){if(n=n||{},n.message_key)return Ql(n.message_key,n.evidence||{});if(e==="math_mismatch")return`
        ...
        `:e==="amount_missing"?`<div class="exc-why-detail-row" style="justify-content:center;color:var(--danger);"><span>${escapeHtml(t("exc-detail-missing"))}</span></div>`:`<div class="exc-why-detail-row"><span style="font-size:11px;">${escapeHtml(JSON.stringify(n))}</span></div>`}function Ve(){const e=P.excRow;if(!e)return;const n=e.seller_name&&e.seller_name.trim()?e.seller_name:t("exc-no-seller"),a=e.filename||"—";document.getElementById("exc-drawer-title").textContent=a;const o="exc-status-"+(e.status||"pending"),s=t(o)||e.status,i="s-"+(e.status||"pending"),r=(e.invoice_date||e.created_at||"").slice(0,10);document.getElementById("exc-drawer-sub").innerHTML=`
        <span>${escapeHtml(n)}</span>
        ${e.invoice_no?`<span>· ${escapeHtml(e.invoice_no)}</span>`:""}
        ${r?`<span>· ${escapeHtml(r)}</span>`:""}
        <span class="exc-status-chip ${i}">${escapeHtml(s)}</span>
    `;const c=e.severity||"medium",f=Da(e),d=ec(e.rule_code,e.detail||{}),u=ho(P.history),l=P.history===null,p=P.history&&P.history._err,m=new Set,v=e.rule_code||"";["math_mismatch","R-VAT-01","R-VAT-02","R-SUM-01","R-LINE-01"].includes(v)?(m.add("subtotal"),m.add("vat"),m.add("total_amount")):v==="R-MULTIPAGE-01"||v==="R-LIMIT-01"?m.add("total_amount"):v==="tax_id_format_invalid"||v==="R-TAXID-01"?m.add("seller_tax"):v==="R-TAXID-02"?m.add("buyer_tax"):v==="R-TAXID-03"?(m.add("seller_tax"),m.add("buyer_tax")):v==="R-DATE-01"||v==="R-DATE-02"?m.add("date"):v==="R-DUP-01"||v==="R-DUP-02"?m.add("invoice_number"):v==="R-SUP-01"||v==="R-SUP-02"?(m.add("seller_name"),m.add("seller_tax")):v==="amount_missing"&&(m.add("total_amount"),m.add("invoice_number"));const y=!!P.editing,b=P.editFields||{},h=(M,R,V)=>{if(l)return`<div class="exc-field-row"><label>${escapeHtml(t(R))}</label><span class="val empty">…</span></div>`;const ne=y?b[M]!==void 0?b[M]:u[M]!==void 0&&u[M]!==null?u[M]:"":u[M],re=m.has(M)?"flagged":"";if(y){const N=V?"number":"text",z=V?' step="0.01" inputmode="decimal"':"",K=ne==null?"":String(ne).replace(/"/g,"&quot;");return`<div class="exc-field-row ${re} editing">
                <label>${escapeHtml(t(R))}</label>
                <input class="exc-field-input" type="${N}"${z} data-edit-key="${escapeHtml(M)}" value="${K}">
            </div>`}const fe=V?Ne(ne):ne||"",ue=ne==null||ne===""?`<span class="val empty">${escapeHtml(t("exc-empty-val"))}</span>`:`<span class="val">${escapeHtml(fe)}</span>`;return`<div class="exc-field-row ${re}"><label>${escapeHtml(t(R))}</label>${ue}</div>`};let g="";p?g=`<div class="exc-drawer-error">${escapeHtml(t("exc-drawer-error"))}</div>`:g=`
        ...
        `;const _=(()=>{if(P.pdfStatus==="loading"||P.pdfStatus==="idle")return`
            ...
            `;const M=P.pdfUrl;return`
            <div class="exc-pdf-toolbar">
                <span class="exc-pdf-toolbar-title">${escapeHtml(a)}</span>
                <div class="exc-pdf-toolbar-actions">
                    <a class="exc-pdf-icon-btn" id="exc-pdf-open-tab" href="${M}" target="_blank" rel="noopener" title="${escapeHtml(t("exc-pdf-open-tab"))}">
                        <svg viewBox="0 0 14 14" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
                            <path d="M8 2h4v4M12 2L7 7"/>
                            <path d="M11 8v3a1 1 0 01-1 1H3a1 1 0 01-1-1V4a1 1 0 011-1h3"/>
                        </svg>
                    </a>
                    <a class="exc-pdf-icon-btn" id="exc-pdf-download" href="${M}" download="${escapeHtml(a)}" title="${escapeHtml(t("exc-pdf-download"))}">
                        <svg viewBox="0 0 14 14" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
            ...
            <iframe class="exc-pdf-frame" src="${M}#toolbar=0&navpanes=0" title="PDF preview"></iframe>
        ...
        <div class="exc-fields-pane">
            <div class="exc-section">
                ...
                <div class="exc-why sev-${escapeHtml(c)}">
                    <div class="exc-why-rule">${escapeHtml(f)}</div>
    ...
    `;const w=document.getElementById("exc-fld-edit");w&&w.addEventListener("click",()=>{P.editing=!0,P.editFields={...ho(P.history)},Ve()});const k=document.getElementById("exc-fld-cancel");k&&k.addEventListener("click",()=>{P.editing=!1,P.editFields=null,Ve()});const x=document.getElementById("exc-fld-save");x&&x.addEventListener("click",()=>ac()),document.querySelectorAll(".exc-field-input").forEach(M=>{M.addEventListener("input",()=>{P.editFields||(P.editFields={}),P.editFields[M.dataset.editKey]=M.value})});const I=document.getElementById("exc-pdf-retry");I&&P.openExcId&&I.addEventListener("click",()=>{P.excRow&&Ms(P.excRow.history_id,P.openExcId)});const L=e.status==="pending",B=!!(e.seller_name&&e.seller_name.trim()),C=document.getElementById("exc-btn-resolve"),S=document.getElementById("exc-btn-ignore");C.disabled=!L,S.disabled=!L||!B,S.title=B?t("exc-ignore-hint"):t("exc-ignore-no-seller")}function Ra(){if(P.pdfUrl){try{URL.revokeObjectURL(P.pdfUrl)}catch{}P.pdfUrl=null}P.pdfStatus="idle"}async function Ms(e,n){P.pdfStatus="loading",Ve();try{const a=await fetch("/api/history/"+encodeURIComponent(e)+"/pdf",{headers:{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||"")}});if(P.openExcId!==n)return;if(a.status===404){P.pdfStatus="empty",Ve();return}if(!a.ok)throw new Error("http "+a.status);const o=await a.blob();if(P.openExcId!==n)return;Ra(),P.pdfUrl=URL.createObjectURL(o),P.pdfStatus="ready",Ve()}catch(a){if(P.openExcId!==n)return;console.warn("loadDrawerPdf fail",a),P.pdfStatus="error",Ve()}}function tc(e){const n=(D.listCache||[]).find(a=>a.id===e);if(!n){showToast(t("exc-drawer-error"),"error");return}D.listScrollY=window.scrollY||document.documentElement.scrollTop||0,Ra(),P.editing=!1,P.editFields=null,P.openExcId=e,P.excRow=n,P.history=null,document.getElementById("exc-drawer-mask").classList.add("show"),document.getElementById("exc-drawer").classList.add("show"),Ve(),nc(n.history_id),Ms(n.history_id,e)}function Bt(){Ra(),P.editing=!1,P.editFields=null,P.openExcId=null,P.excRow=null,P.history=null,document.getElementById("exc-drawer-mask").classList.remove("show"),document.getElementById("exc-drawer").classList.remove("show");const e=D.listScrollY||0;e>0&&requestAnimationFrame(()=>window.scrollTo(0,e))}async function nc(e){try{const n=await fetch("/api/history/"+encodeURIComponent(e),{headers:{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||"")}});if(!n.ok)throw new Error("http "+n.status);P.history=await n.json()}catch(n){console.warn("loadHistoryDetail fail",n),P.history={_err:!0}}P.excRow&&Ve()}function ho(e){if(!e||!e.pages)return{};const n=e.pages,a=n.find(o=>!o.is_duplicate&&!o.is_copy)||n[0];return a&&a.fields||{}}async function ac(){if(!P.openExcId||!P.history||!P.history.pages||P.loading)return;P.loading=!0;const e=showToast(t("exc-fld-saving"),"loading",0);try{const n=JSON.parse(JSON.stringify(P.history.pages||[]));let a=n.findIndex(f=>!f.is_duplicate&&!f.is_copy);a<0&&(a=0),n[a]||(n[a]={fields:{}});const o=n[a].fields||{},s=P.editFields||{},i=new Set(["subtotal","vat","total_amount"]),r={...o};for(const f in s){let d=s[f];if((d===""||d===void 0)&&(d=null),i.has(f)&&d!==null){const u=parseFloat(d);d=isNaN(u)?null:u}r[f]=d}n[a].fields=r;const c=await fetch("/api/history/"+encodeURIComponent(P.history.id),{method:"PUT",headers:{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||""),"Content-Type":"application/json"},body:JSON.stringify({pages:n})});if(!c.ok)throw new Error("http "+c.status);e(),showToast(t("exc-fld-save-ok"),"success"),Bt(),await Ht(),await nt(),Re()}catch(n){e(),console.warn("save fields fail",n),showToast(t("exc-fld-save-fail"),"error")}finally{P.loading=!1}}async function oc(){if(!(!P.openExcId||P.loading)){P.loading=!0;try{const e=await fetch("/api/exceptions/"+P.openExcId+"/resolve",{method:"POST",headers:{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||"")}});if(!e.ok)throw new Error("http "+e.status);showToast(t("exc-toast-resolved"),"success"),Bt(),await Ht(),await nt(),Re()}catch(e){console.warn("resolve fail",e),showToast(t("exc-toast-action-fail"),"error")}finally{P.loading=!1}}}async function sc(){if(!(!P.openExcId||P.loading)){P.loading=!0;try{const e=await fetch("/api/exceptions/"+P.openExcId+"/ignore",{method:"POST",headers:{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||"")}});if(!e.ok)throw new Error("http "+e.status);showToast(t("exc-toast-ignored"),"success"),Bt(),await Ht(),await nt(),Re()}catch(e){console.warn("ignore fail",e),showToast(t("exc-toast-action-fail"),"error")}finally{P.loading=!1}}}async function Re(){try{const e=D.currentClient||"",n="/api/exceptions/stats?status=pending"+(e?"&client_id="+encodeURIComponent(e):""),a=await fetch(n,{headers:{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||"")}});if(!a.ok)return;const o=await a.json(),s=document.getElementById("nav-exc-badge");if(!s)return;const i=parseInt(o.pending||0,10);i>0?(s.textContent=i>99?"99+":String(i),s.style.display=""):s.style.display="none"}catch{}}function $s(e){document.getElementById("exc-kpi-pending").textContent=e.pending||0,document.getElementById("exc-kpi-high").textContent=e.high_severity||0,document.getElementById("exc-kpi-resolved").textContent=e.resolved||0,document.getElementById("exc-kpi-learned").textContent=e.learned_rules||0;const n=document.getElementById("exc-status-tab-count-pending"),a=document.getElementById("exc-status-tab-count-resolved"),o=document.getElementById("exc-status-tab-count-ignored");n&&(n.textContent=e.pending||0),a&&(a.textContent=e.resolved||0),o&&(o.textContent=e.ignored||0),document.querySelectorAll("#exc-status-tabs .exc-status-tab").forEach(i=>{i.classList.toggle("active",i.dataset.status===(D.currentStatus||"pending"))})}function Hs(e,n){return n.split(",").reduce((a,o)=>a+(e[o]||0),0)}function Fa(e){const n=document.getElementById("exc-chips");if(!n)return;const a=e.by_rule||{};let s=`<button class="exc-chip ${!D.currentRule?"active":""}" data-rule="">
        <span>${escapeHtml(t("exc-chip-all"))}</span>
        <span class="exc-chip-count">${e.pending||0}</span>
    </button>`;for(const i of Xl){const r=i.codes.join(","),c=Hs(a,r),f=D.currentRule===r;c===0&&!f||(s+=`<button class="exc-chip ${f?"active":""}" data-rule="${escapeHtml(r)}">
            <span>${escapeHtml(t(i.labelKey))}</span>
            <span class="exc-chip-count">${c}</span>
        </button>`)}n.innerHTML=s,n.querySelectorAll(".exc-chip").forEach(i=>{i.addEventListener("click",()=>{const r=i.dataset.rule||null;D.currentRule=r,nt()})})}function qa(e){const n=document.getElementById("exc-list");if(!n)return;if(!e||e.length===0){n.innerHTML=`<div class="exc-empty">
            ${Kl()}
            <div class="exc-empty-title">${escapeHtml(t("exc-empty-title"))}</div>
            <div>${escapeHtml(t("exc-empty-desc"))}</div>
        </div>`,bo();return}const a='<svg viewBox="0 0 14 14" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M3 7l3 3 5-5"/></svg>',o=(D.currentStatus||"pending")==="pending";n.innerHTML=e.map(s=>{const i=s.severity||"medium",r=Da(s),c=s.seller_name&&s.seller_name.trim()?s.seller_name:t("exc-no-seller"),f=s.filename||"—",d=Yl(s.invoice_date||s.created_at),u=s.status==="pending",l=D.selectedIds.has(s.id),p=o&&u;return`
            <div class="exc-row sev-${escapeHtml(i)} ${l?"selected":""}" data-exc-id="${escapeHtml(String(s.id))}">
                ...
                <div class="exc-row-sev">${Gl(i)}</div>
                <div class="exc-row-main">
                    <div class="exc-row-title">${escapeHtml(c)} · ${escapeHtml(f)}</div>
                ...
                <div class="exc-row-amount">${escapeHtml(Wl(s.total_amount))}</div>
            </div>
        `}).join(""),n.querySelectorAll(".exc-row").forEach(s=>{s.addEventListener("click",i=>{if(i.target.closest(".exc-row-check"))return;const r=s.dataset.excId;r&&tc(parseInt(r,10))})}),n.querySelectorAll(".exc-row-check").forEach(s=>{s.addEventListener("click",i=>{i.stopPropagation();const r=parseInt(s.dataset.checkId,10);r&&(D.selectedIds.has(r)?(D.selectedIds.delete(r),s.classList.remove("checked"),s.closest(".exc-row").classList.remove("selected")):(D.selectedIds.add(r),s.classList.add("checked"),s.closest(".exc-row").classList.add("selected")),go())})}),go(),bo()}function go(){const e=document.getElementById("exc-batch-bar"),n=document.getElementById("exc-batch-count");if(!e||!n)return;const a=D.selectedIds.size;a===0?e.style.display="none":(e.style.display="",n.textContent=Ze("exc-batch-count",{n:a}))}function bo(){const e=document.getElementById("exc-list-foot"),n=document.getElementById("exc-list-count"),a=document.getElementById("exc-loadmore");if(!e||!n||!a)return;const o=D.listCache.length;if(o===0){e.style.display="none";return}e.style.display="";let s=o;const i=D.statsCache;i&&(D.currentRule?s=Hs(i.by_rule||{},D.currentRule)||o:s=i.pending||o),D.total=s,n.textContent=Ze("exc-list-count",{shown:o,total:s});const r=o<s&&o<500;a.style.display=r?"":"none"}async function Ht(){try{if(navigator.onLine===!1)throw new Error("offline");const e=D.currentClient||"",n=D.currentStatus||"pending",a=new URLSearchParams;a.set("status",n),e&&a.set("client_id",e);const o="/api/exceptions/stats?"+a.toString(),s=await fetch(o,{headers:{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||"")}});if(!s.ok)throw new Error("http "+s.status);const i=await s.json();return D.statsCache=i,$s(i),Fa(i),i}catch(e){return console.warn("loadExceptionsStats fail",e),null}}function ic(e){const n=document.getElementById("exc-list");if(!n)return;const a=`<svg class="exc-error-icon" viewBox="0 0 36 36" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round">
        <circle cx="18" cy="18" r="14"/>
        ...
        <div class="exc-error">
        ...
        </div>`;const i=document.getElementById("exc-retry-btn");i&&i.addEventListener("click",()=>window.loadExceptionsPage&&window.loadExceptionsPage())}async function nt(e){e=e||{};const n=!!e.append,a=document.getElementById("exc-list");!n&&a&&D.listCache.length===0&&(a.innerHTML=`<div class="exc-loading">${escapeHtml(t("exc-loading"))}</div>`);const o=new URLSearchParams;o.set("status",D.currentStatus||"pending"),D.currentRule&&o.set("rule_code",D.currentRule),D.currentClient&&o.set("client_id",D.currentClient);const s=n?D.listCache.length:0;o.set("limit",String(D.pageSize)),o.set("offset",String(s));try{if(navigator.onLine===!1)throw new Error("offline");const i=await fetch("/api/exceptions/list?"+o.toString(),{headers:{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||"")}});if(!i.ok)throw new Error("http "+i.status);const c=(await i.json()).items||[];n?D.listCache=D.listCache.concat(c):(D.listCache=c,D.selectedIds.clear()),D.loadFailed=!1,qa(D.listCache),D.statsCache&&Fa(D.statsCache)}catch(i){console.warn("loadExceptionsList fail",i),D.loadFailed=!0;const r=navigator.onLine===!1||String(i.message||"").includes("offline");n?showToast(t("exc-toast-load-fail"),"error"):(ic(r),showToast(r?t("exc-offline"):t("exc-toast-load-fail"),"error"))}}async function rc(){if(!D.loading&&!(D.listCache.length>=500)){D.loading=!0;try{await nt({append:!0})}finally{D.loading=!1}}}function za(){const e=document.getElementById("exc-client-filter");if(!e)return;const n=window._clientsCache||[],a=D.currentClient||"",o=typeof t=="function"?t("history-client-all"):"全部客户";e.innerHTML=`<option value="">${escapeHtml(o)}</option>`+n.map(s=>`<option value="${s.id}">${escapeHtml(s.name)}</option>`).join(""),e.value=a}async function lc(){if(wt.batchLoading)return;const e=Array.from(D.selectedIds);if(e.length===0||!await showConfirm(Ze("exc-batch-confirm-resolve",{n:e.length})))return;wt.batchLoading=!0;const a=showToast(Ze("exc-batch-count",{n:e.length})+" …","loading",0);try{const o=await fetch("/api/exceptions/batch",{method:"POST",headers:{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||""),"Content-Type":"application/json"},body:JSON.stringify({ids:e,action:"resolve"})});if(!o.ok)throw new Error("http "+o.status);const s=await o.json();a(),showToast(Ze("exc-toast-batch-resolved",{n:s.processed||0}),"success"),D.selectedIds.clear(),await Ht(),await nt(),Re()}catch(o){a(),console.warn("batch resolve fail",o),showToast(t("exc-toast-batch-fail"),"error")}finally{wt.batchLoading=!1}}async function cc(){if(wt.batchLoading)return;const e=Array.from(D.selectedIds);if(e.length===0||!await showConfirm(Ze("exc-batch-confirm-ignore",{n:e.length}),{danger:!1}))return;wt.batchLoading=!0;const a=showToast(Ze("exc-batch-count",{n:e.length})+" …","loading",0);try{const o=await fetch("/api/exceptions/batch",{method:"POST",headers:{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||""),"Content-Type":"application/json"},body:JSON.stringify({ids:e,action:"ignore"})});if(!o.ok)throw new Error("http "+o.status);const s=await o.json();a(),showToast(Ze("exc-toast-batch-ignored",{n:s.processed||0,wl:s.whitelist_added||0}),"success"),D.selectedIds.clear(),await Ht(),await nt(),Re()}catch(o){a(),console.warn("batch ignore fail",o),showToast(t("exc-toast-batch-fail"),"error")}finally{wt.batchLoading=!1}}function dc(){D.selectedIds.clear(),qa(D.listCache)}async function As(){const e=document.getElementById("learned-list");if(e){e.innerHTML=`<div class="learned-empty">${escapeHtml(t("set-learned-loading"))}</div>`;try{const n=await fetch("/api/exception-whitelist",{headers:{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||"")}});if(!n.ok)throw new Error("http "+n.status);const o=(await n.json()).items||[];if(o.length===0){e.innerHTML=`<div class="learned-empty">${escapeHtml(t("set-learned-empty"))}</div>`;return}const s=`<svg viewBox="0 0 14 14" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round">
            <path d="M3 4h8M5.5 4V2.5h3V4M4 4l0.6 8.5h4.8L10 4"/>
        </svg>`;e.innerHTML=o.map(i=>{const r=Da(i);return`
                <div class="learned-row" data-wl-id="${escapeHtml(String(i.id))}">
                    ...
                    <div class="learned-date">${escapeHtml(Zl(i.created_at))}</div>
                    <button class="learned-del-btn" data-del-wl="${escapeHtml(String(i.id))}" title="${escapeHtml(t("set-learned-del"))}" type="button">${s}</button>
                </div>
            `}).join("")}catch(n){console.warn("loadLearnedRules fail",n),e.innerHTML=`<div class="learned-empty">${escapeHtml(t("exc-toast-load-fail"))}</div>`}}}window.loadExceptionsPage=async function(){if(!D.loading){D.loading=!0;try{za(),await Ht(),await nt()}finally{D.loading=!1}}};window.refreshExcBadge=Re;window._refreshExcClientFilter=za;window._excState=D;window._rerenderExceptions=function(){try{za()}catch{}D.statsCache&&($s(D.statsCache),Fa(D.statsCache)),D.listCache&&D.listCache.length&&qa(D.listCache);try{window._erpExcState&&window._erpExcState.items&&window._erpExcState.items.length&&typeof window._rerenderErpExceptions=="function"&&window._rerenderErpExceptions()}catch{}P.openExcId&&Ve()};document.addEventListener("click",e=>{e.target.closest("#exc-drawer-close")&&Bt(),e.target.closest("#exc-drawer-mask")&&Bt(),e.target.closest("#exc-btn-resolve")&&oc(),e.target.closest("#exc-btn-ignore")&&sc(),e.target.closest("#exc-batch-resolve")&&lc(),e.target.closest("#exc-batch-ignore")&&cc(),e.target.closest("#exc-batch-clear")&&dc(),e.target.closest("#exc-loadmore")&&rc()});document.addEventListener("keydown",e=>{e.key==="Escape"&&P.openExcId&&Bt()});document.addEventListener("click",e=>{e.target.closest("#btn-exc-refresh")&&(typeof window.loadExceptionsPage=="function"&&window.loadExceptionsPage(),Re())});document.addEventListener("change",e=>{if(!e.target.closest("#exc-client-filter"))return;const n=e.target;D.currentClient=n.value||"",D.currentRule=null,D.selectedIds.clear(),D.listCache=[],typeof window.loadExceptionsPage=="function"&&window.loadExceptionsPage(),Re()});document.addEventListener("click",e=>{const n=e.target.closest("#exc-status-tabs .exc-status-tab");if(!n)return;const a=n.dataset.status||"pending";a!==D.currentStatus&&(D.currentStatus=a,D.currentRule=null,D.selectedIds.clear(),D.listCache=[],typeof window.loadExceptionsPage=="function"&&window.loadExceptionsPage())});window.addEventListener("online",()=>{D.loadFailed&&document.getElementById("page-exceptions")?.classList.contains("show")&&window.loadExceptionsPage&&window.loadExceptionsPage()});setTimeout(Re,1500);setInterval(Re,6e4);window.loadLearnedRules=As;document.addEventListener("click",async e=>{const n=e.target.closest("[data-del-wl]");if(!n)return;const a=parseInt(n.dataset.delWl,10);if(!a)return;const o=n.closest(".learned-row"),s=o&&o.querySelector(".learned-seller"),i=s?s.textContent.trim():"",r=t("set-learned-del-confirm").replace("{seller}",i);if(await showConfirm(r,{danger:!0}))try{const f=await fetch("/api/exception-whitelist/"+a,{method:"DELETE",headers:{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||"")}});if(!f.ok)throw new Error("http "+f.status);showToast(t("set-learned-del-ok"),"success"),As(),typeof window.loadExceptionsPage=="function"&&document.getElementById("page-exceptions")?.classList.contains("show")&&window.loadExceptionsPage()}catch(f){console.warn("delete whitelist fail",f),showToast(t("set-learned-del-fail"),"error")}});let ie={items:[],q:"",cat:"",adapter:"",selected:new Set,total:0,categories:{},pageSize:30,loading:!1,focusSearch:!1,searchCaret:0},yo=null;function Pe(){return localStorage.getItem("mrpilot_token")||""}function wo(e){return/<!?\s*doctype|<html|<\/?[a-z]+>|\bTraceback\b|^\s*ERR_[A-Z]/i.test(e)||e.length>200}function js(e){const n=typeof currentLang=="string"&&currentLang||window._currentLang||"th",a=e.error_friendly&&e.error_friendly[n];if(a)return a;if(typeof humanizeError=="function"&&e.error_msg&&!wo(e.error_msg))try{const o=humanizeError(e.error_msg);if(o&&!wo(o))return o}catch{}return t("erp-exc-reason-"+(e.category||"other"))}function ko(){const e=document.getElementById("erp-exc-batch");if(!e)return;const n=ie.selected.size;e.hidden=n===0;const a=e.querySelector(".erp-exc-batch-count");a&&(a.textContent=String(n))}function Na(){const e=document.getElementById("erp-exc-block");if(!e)return;const n=ie;if(!(n.total>0||!!n.q||!!n.cat)){e.hidden=!0,e.innerHTML="";return}e.hidden=!1;const o=n.categories||{},s=Object.keys(o).reduce((x,E)=>x+o[E],0);let i=`<button class="erp-exc-chip ${n.cat===""?"active":""}" data-erpexc-cat=""><span>${escapeHtml(t("erp-exc-cat-all"))}</span><span class="erp-exc-chip-count">${s}</span></button>`;Object.keys(o).forEach(x=>{i+=`<button class="erp-exc-chip ${n.cat===x?"active":""}" data-erpexc-cat="${escapeHtml(x)}"><span>${escapeHtml(t("erp-exc-cat-"+x))}</span><span class="erp-exc-chip-count">${o[x]}</span></button>`});const r=n.items||[],c=r.length>0&&r.every(x=>n.selected.has(x.id)),f=r.map(x=>{const E=x.state==="needs_action"?"needs":x.state==="retrying"?"retry":"fail",I=t("erp-exc-state-"+(x.state||"failed")),L=js(x),B=n.selected.has(x.id)?"checked":"",C=x.push_type==="id_card",S=C?`<span class="erp-exc-type-idcard">${escapeHtml(t("erp-log-type-idcard"))}</span> `:"",M=C?`<span class="ex-inv" title="${escapeHtml(t("erp-log-col-booking"))}">${S}${escapeHtml(x.invoice_no||"—")}</span>`:`<span class="ex-inv" title="${escapeHtml(x.invoice_no||"")}">${escapeHtml(x.invoice_no||"—")}</span>`,R=C?`<span class="ex-seller" title="${escapeHtml(t("erp-log-col-customer"))}">${escapeHtml(x.seller_name||"—")}</span>`:`<span class="ex-seller" title="${escapeHtml(x.seller_name||"")}">${escapeHtml(x.seller_name||"—")}</span>`,V=C?`<span class="ex-buyer" title="${escapeHtml(t("erp-log-col-idcard"))}">${x.id_card_tail?"••••"+escapeHtml(x.id_card_tail):"—"}</span>`:`<span class="ex-buyer" title="${escapeHtml(x.ocr_buyer_name||"")}">${escapeHtml(x.ocr_buyer_name||"—")}</span>`;return`<div class="erp-exc-row" data-erpexc-id="${escapeHtml(x.id)}">
            ...
            <span class="ex-reason" title="${escapeHtml(L)}${x.error_code?" ("+escapeHtml(x.error_code)+")":""}">${escapeHtml(L)}</span>
        ...
        </div>`}).join(""),d=r.length===0?`<div class="erp-exc-empty">${escapeHtml(t("erp-exc-empty"))}</div>`:"",u=r.length<n.total?`<button class="erp-exc-more" type="button" id="erp-exc-more">${escapeHtml(t("erp-exc-load-more"))} (${r.length}/${n.total})</button>`:n.total>0?`<div class="erp-exc-count">${escapeHtml(t("erp-exc-shown",{n:r.length,total:n.total}))}</div>`:"",l=n.adapter==="mrerp_dms",p=Array.isArray(window._erpEndpoints)?window._erpEndpoints:[],m=new Set;let v=`<option value="">${escapeHtml(t("erp-logs-erp-all"))}</option>`;p.forEach(x=>{const E=(x&&x.adapter||"").toLowerCase();!E||m.has(E)||(m.add(E),v+=`<option value="${escapeHtml(E)}"${E===n.adapter?" selected":""}>${escapeHtml(x&&x.name||E)}</option>`)});const y=l?t("erp-log-col-booking"):t("erp-exc-f-invoice"),b=l?t("erp-log-col-customer"):t("erp-exc-f-seller"),h=l?t("erp-log-col-idcard"):t("erp-exc-f-buyer");e.innerHTML=`
        ...
        <div class="erp-exc-foot">${u}</div>`;const g=document.getElementById("erp-exc-search");if(g){if(n.focusSearch){g.focus();try{g.setSelectionRange(n.searchCaret,n.searchCaret)}catch{}}g.addEventListener("input",()=>{n.q=g.value,n.focusSearch=!0,n.searchCaret=g.selectionStart||g.value.length,clearTimeout(yo),yo=setTimeout(()=>pt(!1),350)}),g.addEventListener("blur",()=>{n.focusSearch=!1})}e.querySelectorAll(".erp-exc-chip").forEach(x=>{x.addEventListener("click",()=>{n.cat=x.dataset.erpexcCat||"",pt(!1)})});const _=document.getElementById("erp-exc-erp-select");_&&_.addEventListener("change",()=>{n.adapter=_.value||"",pt(!1)}),e.querySelectorAll("[data-erpexc-retry]").forEach(x=>{x.addEventListener("click",E=>{E.stopPropagation(),un(x.dataset.erpexcRetry,x)})}),e.querySelectorAll(".erp-exc-cb").forEach(x=>{x.addEventListener("change",()=>{const E=x.dataset.erpexcCb;x.checked?n.selected.add(E):n.selected.delete(E);const I=document.getElementById("erp-exc-cb-all");I&&(I.checked=r.length>0&&r.every(L=>n.selected.has(L.id))),ko()})});const w=document.getElementById("erp-exc-cb-all");w&&w.addEventListener("change",()=>{r.forEach(x=>{w.checked?n.selected.add(x.id):n.selected.delete(x.id)}),e.querySelectorAll(".erp-exc-cb").forEach(x=>{x.checked=w.checked}),ko()}),e.querySelectorAll("[data-erpexc-batch]").forEach(x=>{x.addEventListener("click",()=>pc(x.dataset.erpexcBatch))});const k=document.getElementById("erp-exc-more");k&&k.addEventListener("click",()=>pt(!0)),e.querySelectorAll(".erp-exc-row:not(.erp-exc-row-head)").forEach(x=>{x.addEventListener("click",E=>{E.target.closest("input,button")||typeof window._erpExcOpenEdit=="function"&&window._erpExcOpenEdit(x.dataset.erpexcId)})})}async function un(e,n){if(e){n&&(n.disabled=!0,n.textContent=t("erp-exc-retrying"));try{const a=await fetch("/api/erp/logs/"+encodeURIComponent(e)+"/retry",{method:"POST",headers:{Authorization:"Bearer "+Pe()}}),o=await a.json().catch(()=>({}));showToast(a.ok&&o.ok?t("erp-exc-retry-ok"):t("erp-exc-retry-fail"),a.ok&&o.ok?"success":"error")}catch{showToast(t("erp-exc-retry-fail"),"error")}if(ie.selected.delete(e),pt(!1),typeof window.refreshExcBadge=="function")try{window.refreshExcBadge()}catch{}}}async function pc(e){const n=Array.from(ie.selected);if(e==="clear"){ie.selected.clear(),Na();return}if(n.length!==0){if(e==="delete"){if(!await showConfirm(t("erp-exc-batch-delete-confirm",{n:n.length}),{danger:!0}))return;try{const o=await fetch("/api/erp/logs/batch-delete",{method:"POST",headers:{Authorization:"Bearer "+Pe(),"Content-Type":"application/json"},body:JSON.stringify({log_ids:n.slice(0,200)})}),s=await o.json().catch(()=>({}));showToast(o.ok?t("erp-exc-batch-delete-ok",{n:s.deleted||0}):t("erp-exc-retry-fail"),o.ok?"success":"error")}catch{showToast(t("erp-exc-retry-fail"),"error")}}else if(e==="retry")try{const a=await fetch("/api/erp/logs/batch-retry",{method:"POST",headers:{Authorization:"Bearer "+Pe(),"Content-Type":"application/json"},body:JSON.stringify({log_ids:n.slice(0,50)})}),o=await a.json().catch(()=>({}));showToast(a.ok?t("erp-exc-batch-retry-ok",{ok:o.succeeded||0,fail:(o.failed||0)+(o.skipped||0)}):t("erp-exc-retry-fail"),a.ok?"success":"error")}catch{showToast(t("erp-exc-retry-fail"),"error")}if(ie.selected.clear(),pt(!1),typeof window.refreshExcBadge=="function")try{window.refreshExcBadge()}catch{}}}async function pt(e){const n=document.getElementById("erp-exc-block");if(!(!n||ie.loading)){ie.loading=!0;try{if(!Array.isArray(window._erpEndpoints)||!window._erpEndpoints.length)try{const r=await fetch("/api/erp/endpoints",{headers:{Authorization:"Bearer "+Pe()}});if(r.ok){const c=await r.json();window._erpEndpoints=c&&(c.items||c)||[]}}catch{}const a=new URLSearchParams;ie.q&&a.set("q",ie.q),ie.cat&&a.set("category",ie.cat),ie.adapter&&a.set("adapter",ie.adapter),a.set("limit",String(ie.pageSize)),a.set("offset",String(e?ie.items.length:0));const o=await fetch("/api/erp/exceptions?"+a.toString(),{headers:{Authorization:"Bearer "+Pe()}});if(!o.ok){e||(n.hidden=!0);return}const s=await o.json(),i=s.items||[];ie.items=e?ie.items.concat(i):i,ie.total=s.total||0,ie.categories=s.categories||{},Na()}catch{e||(n.hidden=!0)}finally{ie.loading=!1}}}window._rerenderErpExceptions=Na;window.loadErpExceptions=pt;window._erpExcState=ie;let an={};function vt(){const e=document.getElementById("erp-exc-modal");e&&e.remove()}window._erpExcOpenEdit=function(e){const n=(ie.items||[]).find(u=>String(u.id)===String(e));if(!n)return;const a=n.push_type==="id_card",o=!!n.history_client_id&&n.category==="customer_mismatch",s=n.category==="product_mismatch"&&!!n.history_id&&!!n.endpoint_id,i=js(n),r=n.state==="needs_action"?"needs":n.state==="retrying"?"retry":"fail",c=(u,l)=>`<div class="erp-exc-m-row"><span class="erp-exc-m-k">${escapeHtml(u)}</span><span class="erp-exc-m-v">${escapeHtml(l||"—")}</span></div>`;let f="";if(o)f=`
            ...
            </div>`;else{const u="erp-exc-edit-hint-"+(n.category||"other");let l=t(u);(!l||l===u)&&(l=i),f=`<div class="erp-exc-m-hint">${escapeHtml(l)}</div>`}const d=document.createElement("div");if(d.id="erp-exc-modal",d.className="erp-exc-modal-overlay",d.innerHTML=`
...
`;let _o=!1,Pn=[],ia=null,Te="amount_limit",Oa="global";const mc="/api/knowledge/rules";function vc(){return localStorage.getItem("mrpilot_token")||""}async function Ct(e,n,a){return fetch(mc+n,{method:e,headers:{Authorization:"Bearer "+vc(),"Content-Type":"application/json"},body:a?JSON.stringify(a):void 0})}function hc(e){const n=Number(e);return Number.isFinite(n)?"฿ "+n.toLocaleString("en-US"):String(e)}function gc(e){const n=de(),a=o=>e===o?" selected":"";return`<option value="high"${a("high")}>${n.sevHigh}</option><option value="medium"${a("medium")}>${n.sevMid}</option><option value="low"${a("low")}>${n.sevLow}</option>`}function Eo(e,n){const a=n&&n.subject_key?escapeHtml(n.subject_key):"";return`<div class="rs-mlbl">${e}</div><input class="rs-field" id="rs-f-key" value="${a}"${n?" disabled":""}>`}function bc(e){const n=de(),a=e.subject_key?escapeHtml(e.subject_key):"";if(e.rule_type==="amount_limit"){const o=hc(e.rule_body.limit);let s=n.gAmount;e.subject_type==="global"?s=n.anyInvoice:e.subject_type==="supplier"?s=`${n.fSupplierTax} <b>${a}</b>`:s=`「${a}」`;const i=e.rule_body.notify_line?` <span class="rs-line">${Je("bell",12)} ${n.alsoLine}</span>`:"";return`${s} &gt; <b>${o}</b>${i}`}if(e.rule_type==="supplier_force_review")return`<b>${a}</b> · ${n.tForceDesc}`;if(e.rule_type==="no_auto_push_category")return`「${a}」 · ${n.tCategoryDesc}`;if(e.rule_type==="accounting_period"){const s=e.rule_body.mode==="prev_month"?n.pmPrev:n.pmCurrent;return`${n.gPeriodDesc} · <b>${s}</b>`}return e.rule_type}function yc(e){const n=de(),a=e.severity||"medium",o=a==="high"?n.sevHigh:a==="low"?n.sevLow:n.sevMid;return`<div class="rs-rule"><div class="rs-rm"><div class="rs-rt">${bc(e)}</div></div><span class="rs-sev ${a}">${o}</span><button class="rs-sw${e.is_active?"":" off"}" data-toggle="${e.id}" aria-label="toggle"></button><button class="rs-icobtn" data-edit="${e.id}" aria-label="edit">${Je("pencil",14)}</button><button class="rs-icobtn" data-del="${e.id}" aria-label="delete">${Je("trash",14)}</button></div>`}function on(e,n,a,o,s){const i=de(),c=Pn.filter(f=>s.includes(f.rule_type)).map(yc).join("")||`<div class="rs-empty">${i.empty}</div>`;return`<div class="rs-group"><div class="rs-ghead"><div class="rs-gico">${Je(e,17)}</div><div><div class="rs-gt">${n}</div><div class="rs-gd">${a}</div></div><button class="rs-addbtn" data-add-type="${o}">${Je("plus",14)} ${i.add}</button></div><div class="rs-gbody">${c}</div></div>`}function Ps(){const e=de(),n=document.querySelector("#rules-settings-modal .rs-head h2");n&&(n.textContent=e.title);const a=document.getElementById("rs-body");a&&(a.innerHTML=`<p class="rs-lead">${e.lead}</p>`+on("building",e.gSupplier,e.gSupplierDesc,"supplier_force_review",["supplier_force_review"])+on("wallet",e.gAmount,e.gAmountDesc,"amount_limit",["amount_limit"])+on("calendar",e.gPeriod,e.gPeriodDesc,"accounting_period",["accounting_period"])+on("octagon",e.gCategory,e.gCategoryDesc,"no_auto_push_category",["no_auto_push_category"]))}async function Va(){try{const e=await Ct("GET","?include_inactive=1");if(!e.ok)throw new Error("http "+e.status);Pn=(await e.json()).rules||[],Ps()}catch{showToast(de().loadFail,"error")}}function ra(e){const n=de(),a=e?e.severity:Te==="supplier_force_review"?"high":"medium",o=`<div class="rs-mlbl">${n.fSeverity}</div><select class="rs-field" id="rs-f-sev">${gc(a)}</select>`;if(Te==="amount_limit"){const i=e?e.subject_type:Oa,r=e&&e.subject_key?escapeHtml(e.subject_key):"",c=e?String(e.rule_body.limit??""):"",f=e?!!e.rule_body.notify_line:!0,d=i==="global"?"":`<div class="rs-mlbl">${i==="category"?n.fCategory:n.fSupplierTax}</div><input class="rs-field" id="rs-f-key" value="${r}">`;return`<div class="rs-mlbl">${n.gAmountDesc}</div><select class="rs-field" id="rs-f-scope"${e?" disabled":""}><option value="global"${i==="global"?" selected":""}>${n.anyInvoice}</option><option value="supplier"${i==="supplier"?" selected":""}>${n.tForce}</option><option value="category"${i==="category"?" selected":""}>${n.fCategory}</option></select><div id="rs-f-subj">${d}</div><div class="rs-two"><div><div class="rs-mlbl">${n.fAmountLimit}</div><input class="rs-field" id="rs-f-limit" type="number" min="1" value="${c}"></div><div>${o}</div></div><label class="rs-check"><input type="checkbox" id="rs-f-line"${f?" checked":""}>${Je("bell",14)} ${n.fAlsoLine}</label>`}if(Te==="supplier_force_review")return Eo(n.fSupplierTax,e)+o;if(Te==="no_auto_push_category")return Eo(n.fCategory,e)+o;const s=e?e.rule_body.mode:"current_month";return`<div class="rs-mlbl">${n.fPeriodMode}</div><select class="rs-field" id="rs-f-mode"><option value="current_month"${s==="current_month"?" selected":""}>${n.pmCurrent}</option><option value="prev_month"${s==="prev_month"?" selected":""}>${n.pmPrev}</option></select>`+o}function sn(e,n,a){return`<button class="rs-type${Te===e?" on":""}" data-type-pick="${e}"><div class="tt">${n}</div><div class="td">${a}</div></button>`}function wc(e){const n=de(),a=document.getElementById("rs-add-modal");if(!a)return;const o=e?"":`<div class="rs-mlbl">${n.rType}</div><div class="rs-types">`+sn("supplier_force_review",n.tForce,n.tForceDesc)+sn("amount_limit",n.tAmount,n.tAmountDesc)+sn("accounting_period",n.tPeriod,n.tPeriodDesc)+sn("no_auto_push_category",n.tCategory,n.tCategoryDesc)+"</div>";a.innerHTML=`<div class="rs-pop" style="max-width:460px;"><div class="rs-head"><h2>${e?n.editTitle:n.addTitle}</h2><button class="rs-close" id="rs-add-close">${Je("x",18)}</button></div><div class="rs-body">${o}<div id="rs-add-fields">${ra(e)}</div></div><div class="rs-foot" style="gap:10px;"><button class="rs-btn rs-btn-ghost" id="rs-add-cancel">${n.cancel}</button><button class="rs-btn rs-btn-primary" id="rs-add-save">${n.save}</button></div></div>`,a.classList.add("rs-open")}function st(e){const n=document.getElementById(e);return n?String(n.value).trim():""}function kc(){const e=de(),n=st("rs-f-sev")||"medium";if(Te==="amount_limit"){const a=st("rs-f-scope")||"global",o=Number(st("rs-f-limit"));if(!Number.isFinite(o)||o<=0)return showToast(e.needAmount,"error"),{ok:!1};const s=a==="global"?null:st("rs-f-key");if(a!=="global"&&!s)return showToast(a==="category"?e.needCategory:e.needSupplier,"error"),{ok:!1};const i=document.getElementById("rs-f-line")?.checked;return{ok:!0,payload:{rule_type:"amount_limit",subject_type:a,subject_key:s,severity:n,rule_body:{limit:o,basis:"total",period:"per_invoice",notify_line:!!i}}}}if(Te==="supplier_force_review"){const a=st("rs-f-key");return a?{ok:!0,payload:{rule_type:"supplier_force_review",subject_type:"supplier",subject_key:a,severity:n,rule_body:{}}}:(showToast(e.needSupplier,"error"),{ok:!1})}if(Te==="no_auto_push_category"){const a=st("rs-f-key");return a?{ok:!0,payload:{rule_type:"no_auto_push_category",subject_type:"category",subject_key:a,severity:n,rule_body:{}}}:(showToast(e.needCategory,"error"),{ok:!1})}return{ok:!0,payload:{rule_type:"accounting_period",subject_type:"global",subject_key:null,severity:n,rule_body:{mode:st("rs-f-mode")||"current_month"}}}}async function xc(){const e=kc();if(!(!e.ok||!e.payload))try{let n;if(ia!==null){const a=e.payload;n=await Ct("PATCH","/"+ia,{rule_body:a.rule_body,severity:a.severity})}else n=await Ct("POST","",e.payload);if(!n.ok)throw new Error("http "+n.status);showToast(de().saved,"success"),document.getElementById("rs-add-modal")?.classList.remove("rs-open"),await Va()}catch{showToast(de().saveFail,"error")}}async function _c(e){const n=Pn.find(s=>s.id===e);if(!n)return;const a=!n.is_active;n.is_active=a;const o=document.querySelector(`#rules-settings-modal [data-toggle="${e}"]`);o&&o.classList.toggle("off",!a);try{const s=await Ct("PATCH","/"+e,{is_active:a});if(!s.ok)throw new Error("http "+s.status);showToast(a?de().enabled:de().disabled,"success")}catch{n.is_active=!a,o&&o.classList.toggle("off",a),showToast(de().saveFail,"error")}}async function Ec(e){if(await showConfirm(de().delConfirm,{danger:!0}))try{const a=await Ct("DELETE","/"+e);if(!a.ok)throw new Error("http "+a.status);showToast(de().deleted,"success"),await Va()}catch{showToast(de().saveFail,"error")}}function Io(e,n){Te=e,Oa="global",ia=n?n.id:null,wc(n)}function Ic(){if(_o)return;const e=document.createElement("style");e.textContent=fc,document.head.appendChild(e);const n=de(),a=document.createElement("div");a.id="rules-settings-modal",a.innerHTML=`<div class="rs-pop"><div class="rs-head"><h2>${n.title}</h2><span class="rs-tag">●</span><button class="rs-close" id="rs-main-close">${Je("x",18)}</button></div><div class="rs-body" id="rs-body"></div><div class="rs-foot"><button class="rs-btn rs-btn-primary" id="rs-done">${n.done}</button></div></div>`,document.body.appendChild(a);const o=document.createElement("div");o.id="rs-add-modal",document.body.appendChild(o),document.addEventListener("click",s=>{const i=s.target;(i.id==="rules-settings-modal"||i.closest("#rs-main-close")||i.closest("#rs-done"))&&a.classList.remove("rs-open"),(i.id==="rs-add-modal"||i.closest("#rs-add-close")||i.closest("#rs-add-cancel"))&&o.classList.remove("rs-open");const r=i.closest("[data-add-type]");r&&Io(r.dataset.addType);const c=i.closest("[data-edit]");if(c){const l=Pn.find(p=>p.id===Number(c.dataset.edit));l&&Io(l.rule_type,l)}const f=i.closest("[data-del]");f&&Ec(Number(f.dataset.del));const d=i.closest("[data-toggle]");d&&_c(Number(d.dataset.toggle));const u=i.closest("[data-type-pick]");if(u){Te=u.dataset.typePick,document.querySelectorAll("#rs-add-modal .rs-type").forEach(p=>p.classList.toggle("on",p.dataset.typePick===Te));const l=document.getElementById("rs-add-fields");l&&(l.innerHTML=ra())}i.closest("#rs-add-save")&&xc()}),document.addEventListener("change",s=>{const i=s.target;if(i.id==="rs-f-scope"){Oa=i.value;const r=document.getElementById("rs-add-fields");r&&(r.innerHTML=ra())}}),document.addEventListener("keydown",s=>{s.key==="Escape"&&(o.classList.contains("rs-open")?o.classList.remove("rs-open"):a.classList.contains("rs-open")&&a.classList.remove("rs-open"))}),_o=!0}window.openRulesSettings=function(){Ic(),document.getElementById("rules-settings-modal").classList.add("rs-open"),Va()};function Lc(){const e=document.querySelector("#page-exceptions .page-head-actions");if(!e||document.getElementById("exc-rules-btn"))return;const n=document.createElement("button");n.id="exc-rules-btn",n.type="button",n.className="btn btn-ghost",n.innerHTML=Je("settings",16)+`<span class="rs-btn-label">${de().btn}</span>`,n.addEventListener("click",()=>window.openRulesSettings&&window.openRulesSettings()),e.insertBefore(n,e.firstChild)}let Lo=!1;async function Bc(){if(!Lo){Lo=!0;try{(await Ct("GET","")).ok&&Lc()}catch{}}}const Bo=window.loadExceptionsPage;window.loadExceptionsPage=function(){Bc(),Bo&&Bo()};Array.isArray(window.__i18nSubs)||(window.__i18nSubs=[]);window.__i18nSubs.push({name:"rules-settings",fn:()=>{const e=document.querySelector("#exc-rules-btn .rs-btn-label");e&&(e.textContent=de().btn),document.getElementById("rules-settings-modal")?.classList.contains("rs-open")&&Ps()}});(function(){const e=document.getElementById("page-knowledge");if(!(!e||e.dataset.wbInjected==="1")){if(!document.getElementById("kb-center-style")){const n=document.createElement("style");n.id="kb-center-style",n.textContent=`
...
`,e.dataset.wbInjected="1";try{const n=window._currentLang||localStorage.getItem("mrpilot_lang")||"th",a=window.I18N;a&&a[n]&&e.querySelectorAll("[data-i18n]").forEach(o=>{const s=o.getAttribute("data-i18n");a[n][s]&&(o.textContent=a[n][s])})}catch{}}})();const Cc="/api/knowledge",et="/static/brand/kb-cat.png?v=2";function Sc(){return localStorage.getItem("mrpilot_token")||""}function q(e,n){if(typeof window.t=="function"){const a=window.t(e);if(a&&a!==e)return a}return n}function G(e){return typeof escapeHtml=="function"?escapeHtml(String(e??"")):String(e??"")}const Co={file:'<path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><path d="M14 2v6h6"/>',"file-text":'<path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><path d="M14 2v6h6"/><path d="M16 13H8"/><path d="M16 17H8"/><path d="M10 9H8"/>',sheet:'<rect width="18" height="18" x="3" y="3" rx="2"/><path d="M3 9h18"/><path d="M3 15h18"/><path d="M9 3v18"/><path d="M15 3v18"/>',image:'<rect width="18" height="18" x="3" y="3" rx="2"/><circle cx="9" cy="9" r="2"/><path d="m21 15-3.1-3.1a2 2 0 0 0-2.8 0L6 21"/>',upload:'<path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><path d="M14 2v6h6"/><path d="M12 18v-6"/><path d="m9 15 3-3 3 3"/>',message:'<path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/>',"shield-check":'<path d="M20 13c0 5-3.5 7.5-7.7 9a1 1 0 0 1-.7 0C7.5 20.5 4 18 4 13V6a1 1 0 0 1 1-1c2 0 4.5-1.2 6.2-2.7a1.2 1.2 0 0 1 1.6 0C14.5 3.8 17 5 19 5a1 1 0 0 1 1 1z"/><path d="m9 12 2 2 4-4"/>',check:'<path d="M20 6 9 17l-5-5"/>',x:'<path d="M18 6 6 18"/><path d="M6 6l12 12"/>'};function Me(e){return`<svg class="kb-ic" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round">${Co[e]||Co.file}</svg>`}function Ds(e){const n=`kb-${e}-mask`,a=`kb-${e}-modal`,o=()=>document.getElementById(n)?.classList.add("open"),s=()=>document.getElementById(n)?.classList.remove("open");let i=document.getElementById(n);if(!i){i=document.createElement("div"),i.id=n,i.className=`kb-${e}-mask`,i.innerHTML=`<div class="kb-${e}-modal" id="${a}" role="dialog" aria-modal="true"></div>`,document.body.appendChild(i);const r=i;r.addEventListener("click",c=>{(c.target===r||c.target.closest(`[data-kb-${e}-close]`))&&s()}),document.addEventListener("keydown",c=>{c.key==="Escape"&&r.classList.contains("open")&&s()})}return{modal:document.getElementById(a),open:o,close:s}}function Dn(){const e=window.getActiveWorkspaceClientId;if(typeof e!="function")return null;const n=e(),a=Number(n);return Number.isFinite(a)&&a>0?a:null}function Rs(){const e=Dn();if(!e)return"";const a=(window._workspaceClientsCache||[]).find(o=>Number(o.id)===e);return a&&a.name?String(a.name):"#"+e}async function At(e,n,a,o={}){const s=new URL(Cc+n,location.origin),i=Dn();if(o.query)for(const[d,u]of Object.entries(o.query))u!=null&&s.searchParams.set(d,String(u));const r=o.withWorkspace!==!1&&i!=null;r&&(e==="GET"||e==="DELETE")&&s.searchParams.set("workspace_client_id",String(i));const c={Authorization:"Bearer "+Sc()};let f=o.raw;if(!o.raw&&a!==void 0){const d=r?{workspace_client_id:i,...a}:a;c["Content-Type"]="application/json",f=JSON.stringify(d)}try{const d=await fetch(s.toString(),{method:e,headers:c,body:f});let u=null,l;const p=await d.text();if(p)try{const m=JSON.parse(p);d.ok?u=m:l=m?.detail?.error_code||m?.message_key||m?.detail||void 0}catch{}return{ok:d.ok,status:d.status,data:u,error:l}}catch{return{ok:!1,status:0,data:null,error:"network"}}}async function Tc(e,n){const a=new FormData;a.append("file",e);const o=Dn();return o!=null&&a.append("workspace_client_id",String(o)),At("POST","/documents",void 0,{raw:a,withWorkspace:!1})}let rn=null;async function Fs(){if(rn!==null)return rn;const e=await At("GET","/bases",void 0,{withWorkspace:!1});return rn=e.status===200||e.status===401||e.status===403,rn}let So=!1;function qs(){const e=document.getElementById("kb-ws-bar"),n=document.getElementById("kb-ws-label");if(!e||!n)return;Dn()?(e.classList.remove("kb-ws-empty"),n.innerHTML=q("kb-ws-current","账套主体")+"：<b>"+G(Rs())+"</b>"):(e.classList.add("kb-ws-empty"),n.textContent=q("kb-ws-none","请先在右上角选择账套主体,再使用客户私有文档与问答。"))}function Mc(e){document.querySelectorAll(".kb-tab-bar .recon-tab-btn").forEach(n=>{n.classList.toggle("active",n.dataset.kbTab===e)}),document.querySelectorAll(".kb-pane").forEach(n=>{n.classList.toggle("active",n.id==="kb-pane-"+e)}),e==="docs"&&typeof window._kbRenderDocs=="function"&&window._kbRenderDocs(),e==="qa"&&typeof window._kbRenderAsk=="function"&&window._kbRenderAsk()}function $c(){if(So)return;const e=document.querySelector(".kb-tab-bar");if(!e)return;e.addEventListener("click",o=>{const s=o.target.closest(".recon-tab-btn");s&&s.dataset.kbTab&&Mc(s.dataset.kbTab)});const n=document.getElementById("kb-open-rules");n&&n.addEventListener("click",()=>{typeof window.openRulesSettings=="function"&&window.openRulesSettings()});const a=document.getElementById("kb-info-btn");a&&a.addEventListener("click",()=>{typeof window._kbOpenInfo=="function"&&window._kbOpenInfo()}),So=!0}window.loadKnowledgePage=function(){$c(),qs(),document.querySelector('.kb-tab-bar .recon-tab-btn[data-kb-tab="docs"]')?.classList.contains("active")&&typeof window._kbRenderDocs=="function"&&window._kbRenderDocs()};async function To(){if(!window._knowledgeProbed){window._knowledgeProbed=!0;try{if(await Fs()){const e=document.getElementById("nav-knowledge");e&&(e.style.display="")}}catch{}}}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",To):To();Array.isArray(window.__i18nSubs)||(window.__i18nSubs=[]);window.__i18nSubs.push({name:"knowledge-center",fn:qs});let la=!1,Ue=[];function Hc(e){if(e.status==="ready")return`<span class="kb-badge ready"><span class="kb-bdot"></span>${G(q("kb-doc-ready","已就绪"))}</span>`;if(e.status==="failed")return`<span class="kb-badge failed"><span class="kb-bdot"></span>${G(q("kb-doc-failed","失败"))}</span>`;const n=e.status==="uploading"?q("kb-doc-uploading","上传中…"):q("kb-doc-parsing","解析中");return`<span class="kb-badge parsing"><span class="kb-bdot"></span>${G(n)}</span>`}function Ac(e){return e==="unsupported_document"?q("kb-err-unsupported_document","不支持的文件类型"):e==="embedding_failed"?q("kb-err-embedding_failed","向量化失败，可重试"):e==="processing_failed"?q("kb-err-processing_failed","文件无法解析，可能已损坏或加密"):e?q("kb-doc-failed","失败"):""}function jc(e){return(e||"").slice(0,10)}function Pc(e){let n;e.status==="failed"&&e.error_code?n=`<div class="kb-doc-sub err">${G(Ac(e.error_code))}</div>`:e.status==="uploading"?n=`<div class="kb-doc-sub">${G(q("kb-doc-uploading","上传中…"))}</div>`:n=`<div class="kb-doc-sub">${G((e.source_type||"").toUpperCase())} · ${G(jc(e.created_at))}</div>`;const a=e.status==="uploading"?"":`<button class="btn btn-sm btn-ghost kb-doc-del" data-id="${e.id}">${G(q("kb-doc-delete","删除"))}</button>`;return`<div class="kb-doc-row" data-id="${e.id}">
        <div class="kb-doc-ic">${Dc(e.source_type)}</div>
        <div class="kb-doc-meta"><div class="kb-doc-name">${G(e.filename)}</div>${n}</div>
        ${Hc(e)}${a}
    </div>`}function Dc(e){const n=(e||"").toLowerCase();return n==="doc"||n==="docx"?Me("file-text"):n==="xls"||n==="xlsx"||n==="csv"?Me("sheet"):["png","jpg","jpeg","webp"].includes(n)?Me("image"):Me("file")}function zs(){return document.getElementById("kb-doc-list")}function Xt(){const e=zs();if(e){if(!Ue.length){e.innerHTML=`<div class="kb-empty">
            ...
            <h4>${G(q("kb-doc-empty-title","还没有文档"))}</h4>
            <div>${G(q("kb-doc-empty","上传客户合同、采购政策、税务登记等资料，AI 检查发票和问答时引用。"))}</div>
        </div>`;return}e.innerHTML=Ue.map(Pc).join("")}}function Mo(e){const n=zs();n&&(n.innerHTML=e)}async function Ns(){Mo('<div class="kb-skel"><div class="kb-skrow"></div><div class="kb-skrow"></div><div class="kb-skrow"></div></div>');const e=await At("GET","/documents");if(!e.ok){Mo(`<div class="kb-empty err">
            <div>${G(q("kb-doc-error","加载失败"))}</div>
            <button class="btn btn-sm kb-doc-reload" style="margin-top:12px">${G(q("kb-doc-retry","重试"))}</button>
        </div>`);return}Ue=(e.data?.documents||[]).filter(n=>n.status!=="deleted"),Xt()}async function $o(e){const n=Array.from(e);if(n.length)for(const a of n){const o=-Date.now()-Math.floor(Math.random()*1e3);Ue.unshift({id:o,filename:a.name,source_type:(a.name.split(".").pop()||"").toLowerCase(),status:"uploading",error_code:null,created_at:new Date().toISOString()}),Xt();const s=await Tc(a),i=Ue.findIndex(r=>r.id===o);i<0||(s.ok&&s.data?.document?(Ue[i]=s.data.document,s.data.document.status==="failed"&&showToast(q("kb-doc-failed","失败")+"："+a.name,"error")):(Ue.splice(i,1),showToast(q("kb-upload-fail","上传失败")+"："+a.name,"error")),Xt())}}async function Rc(e){if(!(typeof showConfirm=="function"?await showConfirm(q("kb-doc-del-confirm","确定删除这份文档？删除后 AI 将不再引用它。")):!0))return;(await At("DELETE","/documents/"+e)).ok?(Ue=Ue.filter(o=>o.id!==e),Xt()):showToast(q("kb-doc-del-fail","删除失败"),"error")}function Fc(){const e=document.getElementById("kb-pane-docs");if(!e||la&&e.querySelector("#kb-doc-list"))return;if(!document.getElementById("kb-docs-style")){const o=document.createElement("style");o.id="kb-docs-style",o.textContent=`
...
`,document.head.appendChild(o)}e.innerHTML=`
    ...
    `;try{const o=window._currentLang||localStorage.getItem("mrpilot_lang")||"th",s=window.I18N;s&&s[o]&&e.querySelectorAll("[data-i18n]").forEach(i=>{const r=i.getAttribute("data-i18n");s[o][r]&&(i.textContent=s[o][r])})}catch{}const n=e.querySelector("#kb-up"),a=e.querySelector("#kb-file");n.addEventListener("click",o=>{o.target.closest("input")||a.click()}),a.addEventListener("change",()=>{a.files&&$o(a.files),a.value=""}),["dragenter","dragover"].forEach(o=>n.addEventListener(o,s=>{s.preventDefault(),n.classList.add("drag")})),["dragleave","drop"].forEach(o=>n.addEventListener(o,s=>{s.preventDefault(),n.classList.remove("drag")})),n.addEventListener("drop",o=>{const s=o.dataTransfer;s?.files?.length&&$o(s.files)}),e.addEventListener("click",o=>{const s=o.target,i=s.closest(".kb-doc-del");if(i?.dataset.id){Rc(Number(i.dataset.id));return}s.closest(".kb-doc-reload")&&Ns()}),la=!0}function qc(){Fc(),Ns()}window._kbRenderDocs=qc;Array.isArray(window.__i18nSubs)||(window.__i18nSubs=[]);window.__i18nSubs.push({name:"knowledge-documents",fn:()=>{la&&Xt()}});let xn=null;function zc(){if(xn)return;const e=document.createElement("style");e.id="kb-src-style",e.textContent=`
...
`,document.head.appendChild(e),xn=Ds("src")}function Nc(e){const n=G(e.text).replace(/\n/g,"<br>");return`<span class="seg${e.matched?" hit":""}">${n}</span>`}function Oc(e){return e.segments.map(Nc).join("<br><br>")}async function Vc(e){zc();const n=xn?.modal;if(!n)return;const a=e.filename||q("kb-src-unknown","未知来源"),o=typeof e.score=="number"?Math.round(Math.max(0,Math.min(1,e.score))*100):null,s=typeof e.chunk_id=="number";if(n.innerHTML=`
        <div class="kb-src-head">
            <span class="ic">${Me("file")}</span>
            <div>
                <h3>${G(a)}</h3>
                <div class="sub">${G(q(s?"kb-src-hit":"kb-src-from",s?"命中片段已高亮":"此结论引用自以下文档"))}</div>
            </div>
            <button class="x" data-kb-src-close aria-label="close">${Me("x")}</button>
        </div>
        <div class="kb-src-body">
            ${o!==null?`<div class="kb-src-rel">${G(q("kb-src-relevance","相关度"))} ${o}%</div>`:""}
            <div class="kb-src-preview" id="kb-src-preview">${s?`<div class="kb-src-loading">${G(q("kb-src-loading","正在取原文…"))}</div>`:`<div class="kb-src-fail">${G(q("kb-src-no-chunk","可在文档库打开原件核对。"))}</div>`}</div>
            <p class="kb-src-foot">${G(q("kb-src-verifiable","这就是「可核对」:AI 说的每句话都能点回原文这一句,会计自己一眼能确认,不用盲信。"))}</p>
        </div>
    `,xn?.open(),!s)return;const i=await At("GET","/chunks/"+e.chunk_id),r=n.querySelector("#kb-src-preview");r&&(i.ok&&i.data?.segments?.length?r.innerHTML=Oc(i.data):r.innerHTML=`<div class="kb-src-fail">${G(q("kb-src-load-fail","原文片段暂时取不到,可在文档库打开原件核对。"))}</div>`)}window._kbOpenSource=e=>{Vc(e)};function Uc(e){return`<div class="kb-msg user"><div class="kb-bub">${G(e)}</div></div>`}function Gc(e){const n=e.filename||q("kb-src-unknown","未知来源");return`<button class="kb-cite" data-cite='${G(JSON.stringify(e))}'>
        ...
        ${G(n)}<span class="ch">›</span></button>`}function Kc(e){if(e.no_answer){const a=q(e.message_key||"ask.no_source","资料不足，无法判断。");return`<div class="kb-msg ai"><div class="kb-ava"><img src="${et}" alt=""></div>
            <div class="kb-bub no-src">${G(a)}</div></div>`}const n=(e.citations||[]).map(a=>Gc(a)).join("");return`<div class="kb-msg ai"><div class="kb-ava"><img src="${et}" alt=""></div>
        <div class="kb-bub">${G(e.answer)}${n?`<div class="kb-cites">${n}</div>`:""}</div></div>`}function Wc(e){return At("POST","/ask",{question:e})}function Ho(e){return`<div class="kb-msg ai"><div class="kb-ava"><img src="${et}" alt=""></div><div class="kb-bub no-src">${G(e)}</div></div>`}function Os(e,n,a){if(e.dataset.kbWired==="1")return;e.dataset.kbWired="1";let o=!1;function s(r){const c=document.createElement("div");c.innerHTML=r;const f=c.firstElementChild;return e.appendChild(f),e.scrollTop=e.scrollHeight,f}async function i(){const r=n.value.trim();if(!r||o)return;o=!0,n.value="",s(Uc(r));const c=s(`<div class="kb-msg ai"><div class="kb-ava"><img src="${et}" alt=""></div><div class="kb-bub kb-thinking">${G(q("kb-ask-thinking","思考中…"))}</div></div>`),f=await Wc(r);if(c.remove(),f.status===402){const d=q("kb-ask-low-balance","余额不足，请先充值后再提问。");s(Ho(d)),typeof showToast=="function"&&showToast(d,"error")}else if(!f.ok||!f.data){const d=q("kb-ask-error","出错了，请稍后重试。");s(Ho(d)),typeof showToast=="function"&&showToast(d,"error")}else s(Kc(f.data));o=!1}a.addEventListener("click",i),n.addEventListener("keydown",r=>{r.key==="Enter"&&!r.shiftKey&&(r.preventDefault(),i())}),e.addEventListener("click",r=>{const c=r.target.closest(".kb-cite");if(!(!c||!c.dataset.cite))try{const f=JSON.parse(c.dataset.cite);typeof window._kbOpenSource=="function"&&window._kbOpenSource(f)}catch{}})}window._kbWireAsk=Os;function Yc(){if(document.getElementById("kb-ask-style"))return;const e=document.createElement("style");e.id="kb-ask-style",e.textContent=`
...
`,document.head.appendChild(e)}function Jc(){const e=document.getElementById("kb-pane-qa");if(!e||e.dataset.kbBuilt==="1")return;Yc();const n=G(q("kb-ask-ex1","这家客户有金额上限吗？")),a=G(q("kb-ask-ex2","合同约定的付款周期是多久？")),o=G(q("kb-ask-ex3","哪些供应商需要人工复核？")),s=typeof window._kbFabEnabled=="function"&&window._kbFabEnabled();e.innerHTML=`
        <div class="kb-ft">
            <span class="ft-cat"><img src="${et}" alt=""></span>
            <div class="ft-txt">
                <b>${G(q("kb-fab-toggle","桌面悬浮问答助手"))}</b>
                <div class="sub">${G(q("kb-fab-toggle-sub","打开后任意页面右下角常驻一只猫，随手就能问，可长按拖到屏幕任意一边。"))}</div>
            </div>
            <button class="kb-switch${s?" on":""}" id="kb-fab-switch" role="switch" aria-checked="${s}"></button>
        </div>
        <div class="kb-qa">
            <div class="kb-qa-thread" id="kb-qa-thread">
                <div class="kb-msg ai"><div class="kb-ava"><img src="${et}" alt=""></div>
                <div class="kb-bub">${G(q("kb-ask-empty","问点关于这家客户的事，答案都带合同原文出处；查不到时如实说「资料不足」。"))}</div></div>
            </div>
            <div class="kb-qa-foot">
                ...
                <div class="kb-qa-input">
                    <input id="kb-qa-input" data-i18n-placeholder="kb-ask-placeholder" placeholder="${G(q("kb-ask-placeholder","问点关于这家客户的事…"))}">
                    <button class="kb-send" id="kb-qa-send"><svg viewBox="0 0 24 24"><path d="M12 19V5M5 12l7-7 7 7"/></svg></button>
                </div>
            </div>
        </div>
        <p class="kb-qa-hint">${G(q("kb-ask-disclaimer","AI 的每个结论都带可点开的出处；查不到依据时固定回答「资料不足」，绝不编。"))}</p>
    `,e.dataset.kbBuilt="1";const i=e.querySelector("#kb-qa-thread"),r=e.querySelector("#kb-qa-input"),c=e.querySelector("#kb-qa-send");Os(i,r,c),e.querySelectorAll(".kb-chip").forEach(d=>{d.addEventListener("click",()=>{r.value=d.dataset.q||"",c.click()})});const f=e.querySelector("#kb-fab-switch");f?.addEventListener("click",()=>{const d=!f.classList.contains("on");f.classList.toggle("on",d),f.setAttribute("aria-checked",String(d)),typeof window._kbFabSetEnabled=="function"&&window._kbFabSetEnabled(d)})}window._kbRenderAsk=Jc;const Ua="pearnly_kb_fab",ca=et,Ge=14;let da=!1,Ao=!1;function Xc(){if(document.getElementById("kb-fab-style"))return;const e=document.createElement("style");e.id="kb-fab-style",e.textContent=`
...
`,document.head.appendChild(e)}let J,Ye,fn,we;function Zc(){da||(Xc(),J=document.createElement("div"),J.className="kb-fab",J.id="kb-fab",J.innerHTML=`
        <span class="kb-say" id="kb-say">${q("kb-fab-hi","喵~")}</span>
        <button class="kb-fab-btn" id="kb-fab-btn" aria-label="${q("kb-fab-aria","问 AI")}"><img src="${ca}" alt=""></button>`,document.body.appendChild(J),we=document.createElement("div"),we.className="kb-card",we.id="kb-card",we.innerHTML=`
        <div class="kb-card-top">
            <div class="tt"><span class="mini"><img src="${ca}" alt=""></span> ${q("kb-fab-title","客户知识助手")}</div>
        ...
        <div class="kb-qa-input">
            <input id="kb-card-input" placeholder="${q("kb-fab-ph","随处可问，不跳页…")}">
            <button class="kb-send" id="kb-card-send"><svg viewBox="0 0 24 24"><path d="M12 19V5M5 12l7-7 7 7"/></svg></button>
        </div>`,document.body.appendChild(we),Ye=J.querySelector("#kb-fab-btn"),fn=J.querySelector("#kb-say"),document.getElementById("kb-card-x")?.addEventListener("click",pa),document.addEventListener("keydown",e=>{e.key==="Escape"&&pa()}),id(),od(),sd(),da=!0)}function Qc(){const e=document.getElementById("kb-card-thread"),n=document.getElementById("kb-card-input"),a=document.getElementById("kb-card-send");!Ao&&typeof window._kbWireAsk=="function"&&(e.innerHTML=`<div class="kb-msg ai"><div class="kb-ava"><img src="${ca}" alt=""></div><div class="kb-bub">${q("kb-ask-empty","问点关于这家客户的事，答案都带出处；查不到时如实说「资料不足」。")}</div></div>`,window._kbWireAsk(e,n,a),Ao=!0);const o=document.getElementById("kb-card-ws");o&&(o.textContent=Rs()||q("kb-fab-no-ws","未选账套")),ed(),we.classList.add("open"),nd(),Vs(["💛","✨","💙","🐾"])}function pa(){we?.classList.remove("open")}function ed(){const e=J.getBoundingClientRect(),n=520,a=e.left+e.width/2<window.innerWidth/2,o=Math.min(Math.max(Ge,e.top+e.height/2-n/2),window.innerHeight-n-Ge);we.style.top=o+"px",a?(we.style.left=e.right+12+"px",we.style.right="auto"):(we.style.right=window.innerWidth-e.left+12+"px",we.style.left="auto")}let jo;function td(e,n=1500){fn.textContent=e,fn.classList.add("show"),clearTimeout(jo),jo=setTimeout(()=>fn.classList.remove("show"),n)}function nd(){Ye.classList.remove("jump"),Ye.classList.add("cheer"),setTimeout(()=>Ye.classList.remove("cheer"),650)}function ad(){J.classList.contains("lifted")||(Ye.classList.remove("cheer"),Ye.classList.add("jump"),setTimeout(()=>Ye.classList.remove("jump"),720))}function Vs(e){for(let n=0;n<5;n++){const a=document.createElement("span");a.className="kb-spark",a.textContent=e[n%e.length],a.style.setProperty("--dx",n*14-28+"px"),a.style.left=30+n*10+"%",a.style.animationDelay=n*40+"ms",J.appendChild(a),setTimeout(()=>a.remove(),1100)}}function od(){const e=[q("kb-fab-hi","喵?"),q("kb-fab-ask","问我呀!"),"🐾"];Ye.addEventListener("mouseenter",()=>{J.classList.contains("lifted")||td(e[(Date.now()/1e3|0)%e.length],1400)}),setInterval(()=>{!J.classList.contains("on")||J.classList.contains("lifted")||we.classList.contains("open")||(Date.now()/1e3|0)%2===0&&(ad(),Vs(["✨","🐾"]))},5400)}function Kn(e){return Math.min(Math.max(Ge,e),window.innerHeight-J.offsetHeight-Ge)}function sd(){J.classList.add("snapping"),J.style.left=window.innerWidth-56-Ge+"px",J.style.top="62%"}function id(){let e,n=!1,a=!1,o=0,s=0,i=0,r=0;function c(l){o=l.clientX,s=l.clientY,a=!1,n=!1;const p=J.getBoundingClientRect();i=p.left,r=p.top,J.classList.remove("snapping"),e=setTimeout(()=>{J.classList.add("lifted")},180),window.addEventListener("pointermove",f),window.addEventListener("pointerup",d),l.preventDefault()}function f(l){const p=l.clientX-o,m=l.clientY-s;!n&&Math.hypot(p,m)>6&&(n=!0,J.classList.add("lifted"),clearTimeout(e)),n&&(a=!0,J.style.left=i+p+"px",J.style.top=Kn(r+m)+"px")}function d(){if(clearTimeout(e),window.removeEventListener("pointermove",f),window.removeEventListener("pointerup",d),J.classList.remove("lifted"),!a){Qc();return}u()}function u(){const l=J.getBoundingClientRect();J.classList.add("snapping"),J.style.top=Kn(l.top)+"px",J.style.left=(l.left+l.width/2<window.innerWidth/2?Ge:window.innerWidth-J.offsetWidth-Ge)+"px"}Ye.addEventListener("pointerdown",c),window.addEventListener("resize",()=>{if(!da)return;const l=J.getBoundingClientRect();J.style.top=Kn(l.top)+"px",J.style.left=(l.left+l.width/2<window.innerWidth/2?Ge:window.innerWidth-J.offsetWidth-Ge)+"px"})}function Us(e){Zc(),localStorage.setItem(Ua,e?"1":"0"),J.classList.toggle("on",e),e||pa()}window._kbFabSetEnabled=Us;window._kbFabEnabled=()=>localStorage.getItem(Ua)==="1";async function Po(){if(localStorage.getItem(Ua)==="1")try{await Fs()&&Us(!0)}catch{}}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",Po):Po();let _n=null;function rd(){if(_n)return;const e=document.createElement("style");e.id="kb-info-style",e.textContent=`
...
`,document.head.appendChild(e),_n=Ds("info")}function ln(e,n){return`<li><span class="ck">${Me("check")}</span><span>${G(q(e,n))}</span></li>`}function Wn(e,n,a,o,s,i,r){return`<div class="row"><div class="pi">${e}</div>
        <div class="pm"><b>${G(q(n,a))}</b><div class="d">${G(q(o,s))}</div></div>
        <span class="amt">${G(q(i,r))}</span></div>`}function ld(){const e=_n?.modal;e&&(e.innerHTML=`
        <div class="kb-info-head">
            <span class="ic"><img src="${et}" alt=""></span>
            <div>
                <h2>${G(q("kb-info-title","客户知识助手是什么"))}</h2>
                <div class="lead">${G(q("kb-info-lead","把每家客户的合同与规矩，变成系统记得住、能自动执行、还能随时问的「活资料」。"))}</div>
            </div>
            <button class="x" data-kb-info-close aria-label="close">${Me("x")}</button>
        </div>
        <div class="kb-info-body">
            <div class="kb-info-h"><span class="l"></span>${G(q("kb-info-use-h","它真正帮你省什么"))}</div>
            <ul class="kb-info-use">
                ${ln("kb-info-use1","把客户的合同、采购政策、内部规矩上传一次，AI 读懂后建成可检索的资料库 —— 不用再翻文件夹找合同。")}
                ${ln("kb-info-use2","做账时 AI 自动按这家客户的规矩检查发票：金额超上限、供应商要不要人工复核、差旅超标…… 异常当场标出来。")}
                ${ln("kb-info-use3","任意页面右下角随手问「这家客户能不能这样报」，答案都带合同原文出处，点一下就能核对，AI 不瞎编。")}
                ${ln("kb-info-use4","把老会计脑子里记的客户规矩，变成系统记住、新人也能直接上手 —— 给多家公司做账的事务所尤其值。")}
            </ul>
            <div class="kb-info-h"><span class="l"></span>${G(q("kb-info-cost-h","费用怎么算"))}</div>
            <p style="font-size:12.5px;color:var(--ink-2,#555);margin:0 0 11px;line-height:1.55">${G(q("kb-info-cost-lead","从你的泰铢余额按用量扣，不用不花，跟 OCR 共用一个余额池："))}</p>
            <div class="kb-info-price">
                ${Wn(Me("upload"),"kb-info-c1-n","上传建库","kb-info-c1-d","PDF / 图片按页、文档按字符 —— 跟现在 OCR 同价","kb-info-c1-amt","฿1.50/页起")}
                ${Wn(Me("message"),"kb-info-c2-n","AI 问答","kb-info-c2-d","每次带合同原文出处的回答","kb-info-c2-amt","฿0.50/次")}
                ${Wn(Me("shield-check"),"kb-info-c3-n","自动发票检查","kb-info-c3-d","死规则:算术 / 税号 / 查重 / 客户规矩","kb-info-c3-amt","免费")}
            </div>
            <div class="kb-info-tbd"><span>${G(q("kb-info-note","充值与扣费跟现有 OCR 共用同一个泰铢余额；问答按真实成本加合理毛利定价（与 OCR 同档）。"))}</span></div>
        </div>
        <div class="kb-info-foot"><button class="btn btn-primary" data-kb-info-close>${G(q("kb-info-close","知道了"))}</button></div>
    `)}function cd(){rd(),ld(),_n?.open()}window._kbOpenInfo=cd;const dd=`
    <div class="cmdk">
...
`;ge("cmdk-mask",dd);(function(){function e(l){try{if(location.search.indexOf("test_center=1")>=0||localStorage.getItem("pearnly_test_mode")==="1"||l&&l.id&&String(l.id)==="468b50c1-5593-4fd6-990d-515ce8085563")return!0}catch{}return!1}window.applyRoleVisibility=function(){var p=window._userInfo,m=!1,v=!0,y=!1,b=!1;p&&(m=typeof canManageTeam=="function"?canManageTeam(p):!!(p.role==="owner"||p.is_super_admin),v=typeof shouldHideMoney=="function"?shouldHideMoney(p):p.role==="member"&&!p.is_super_admin,y=typeof isSuperAdmin=="function"?isSuperAdmin(p):!!p.is_super_admin,b=e(p)),document.querySelectorAll("[data-show-if-team]").forEach(function(g){g.style.display=m?"":"none"}),document.querySelectorAll("[data-show-if-money]").forEach(function(g){g.style.display=v?"none":""}),document.querySelectorAll("[data-show-if-admin]").forEach(function(g){g.style.display=y?"":"none"}),document.querySelectorAll("[data-show-if-test]").forEach(function(g){g.style.display=b?"":"none"});var h=y||b;document.querySelectorAll("[data-show-if-special]").forEach(function(g){g.style.display=h?"":"none"})},window.renderAvatarMenu=function(p){if(p){var m=document.getElementById("avatar-btn"),v=document.getElementById("avatar-popup-name"),y=document.getElementById("avatar-popup-email");if(!(!m||!v||!y)){var b=(p.username||"").trim(),h=b.split("@")[0]||b||"—",g=(b.charAt(0)||"?").toUpperCase(),_=(p.avatar_url||"").trim();if(_){var w=_.replace(/"/g,"&quot;"),k=g.replace(/'/g,"\\'");m.innerHTML='<img src="'+w+'" alt="'+g+`" referrerpolicy="no-referrer" onerror="this.parentNode.textContent='`+k+`'">`}else m.textContent=g;v.textContent=h,y.textContent=b||"—",m.setAttribute("title",b||"")}}};function n(){var l=document.getElementById("avatar-wrap"),p=document.getElementById("avatar-btn"),m=document.getElementById("avatar-popup");if(!l||!p||!m)return;function v(){m.classList.remove("show"),p.setAttribute("aria-expanded","false")}function y(){m.classList.add("show"),p.setAttribute("aria-expanded","true")}p.addEventListener("click",function(b){b.stopPropagation(),m.classList.contains("show")?v():y()}),document.addEventListener("click",function(b){m.classList.contains("show")&&!l.contains(b.target)&&v()}),m.addEventListener("click",function(b){var h=b.target.closest(".avatar-popup-item");if(h){var g=h.dataset.action;switch(v(),g){case"settings":typeof openSettingsModal=="function"?openSettingsModal():typeof routeTo=="function"&&routeTo("settings");break;case"team":typeof openSettingsModal=="function"?openSettingsModal():typeof routeTo=="function"&&routeTo("settings"),setTimeout(function(){typeof switchSettingsTab=="function"&&switchSettingsTab("team")},50);break;case"billing":typeof openSettingsModal=="function"?openSettingsModal():typeof routeTo=="function"&&routeTo("settings"),setTimeout(function(){typeof switchSettingsTab=="function"&&switchSettingsTab("plan")},50);break;case"shortcuts":if(typeof showToast=="function"){var _=typeof t=="function"?t("feature-coming-soon"):"即将上线";showToast(_||"即将上线","info")}break;case"admin":window.location.href="/admin/cost";break;case"test-center":typeof routeTo=="function"&&routeTo("test-center");break;case"help":var w=document.getElementById("help-modal");w&&(w.style.display="flex");break;case"logout":try{localStorage.removeItem("mrpilot_token")}catch{}try{localStorage.removeItem("mrpilot_user")}catch{}window.location.href="/";break}}}),window._closeAvatarPopup=v}function a(){return[].slice.call(document.querySelectorAll(".cmdk-item")).filter(function(l){return l.style.display!=="none"})}function o(l){var p=a();p.forEach(function(m){m.classList.remove("focus")}),p[l]&&(p[l].classList.add("focus"),p[l].scrollIntoView({block:"nearest"}))}function s(l){var p=a();if(p.length){var m=p.findIndex(function(y){return y.classList.contains("focus")});m<0&&(m=0);var v=(m+l+p.length)%p.length;o(v)}}function i(l){l=(l||"").toLowerCase().trim();var p=0,m=window._userInfo,v=typeof isSuperAdmin=="function"?isSuperAdmin(m):!!(m&&m.is_super_admin),y=e(m);document.querySelectorAll(".cmdk-item").forEach(function(h){if(h.dataset.showIfAdmin==="1"&&!v){h.style.display="none";return}if(h.dataset.showIfTest==="1"&&!y){h.style.display="none";return}var g=(h.dataset.cmdkText||h.textContent||"").toLowerCase(),_=!l||g.indexOf(l)>=0;h.style.display=_?"":"none",h.classList.remove("focus"),_&&p++}),document.querySelectorAll("[data-cmdk-section]").forEach(function(h){for(var g=h.nextElementSibling,_=!1;g&&!g.hasAttribute("data-cmdk-section");){if(g.classList&&g.classList.contains("cmdk-item")&&g.style.display!=="none"){_=!0;break}g=g.nextElementSibling}h.style.display=_?"":"none"});var b=document.getElementById("cmdk-empty");b&&(b.style.display=p===0?"flex":"none"),o(0)}window.openCmdk=function(){var p=document.getElementById("cmdk-mask");p&&(typeof window._closeAvatarPopup=="function"&&window._closeAvatarPopup(),p.classList.add("show"),typeof window.applyRoleVisibility=="function"&&window.applyRoleVisibility(),setTimeout(function(){var m=document.getElementById("cmdk-input");m&&(m.value="",i(""),m.focus(),o(0))},50))},window.closeCmdk=function(){var p=document.getElementById("cmdk-mask");p&&p.classList.remove("show")};function r(l){if(l){if(l.classList.contains("cmdk-item-locked")){if(typeof showToast=="function"){var p=typeof t=="function"?t("feature-coming-soon"):"即将上线";showToast(p||"即将上线","info")}return}var m=l.dataset.cmdkRoute,v=l.dataset.cmdkAction;if(window.closeCmdk(),m){typeof routeTo=="function"&&routeTo(m);return}if(v){if(v==="open-admin"){window.location.href="/admin/cost";return}if(v.indexOf("lang-")===0){var y=v.slice(5);typeof applyLang=="function"&&applyLang(y)}}}}function c(){var l=document.getElementById("cmdk-mask"),p=document.getElementById("cmdk-input"),m=document.getElementById("cmdk-body");if(!(!l||!p||!m)){l.addEventListener("click",function(b){b.target===l&&window.closeCmdk()});var v=document.getElementById("cmdk-esc-btn");v&&v.addEventListener("click",function(){window.closeCmdk()}),p.addEventListener("input",function(b){i(b.target.value)}),p.addEventListener("keydown",function(b){b.key==="ArrowDown"?(b.preventDefault(),s(1)):b.key==="ArrowUp"?(b.preventDefault(),s(-1)):b.key==="Enter"?(b.preventDefault(),r(l.querySelector(".cmdk-item.focus"))):b.key==="Escape"&&(b.preventDefault(),window.closeCmdk())}),m.addEventListener("click",function(b){var h=b.target.closest(".cmdk-item");h&&r(h)}),m.addEventListener("mousemove",function(b){var h=b.target.closest(".cmdk-item");!h||h.style.display==="none"||h.classList.contains("cmdk-item-locked")||(a().forEach(function(g){g.classList.remove("focus")}),h.classList.add("focus"))});var y=document.getElementById("topbar-search");y&&(y.addEventListener("click",function(){window.openCmdk()}),y.addEventListener("keydown",function(b){(b.key==="Enter"||b.key===" ")&&(b.preventDefault(),window.openCmdk())}))}}document.addEventListener("keydown",function(l){if((l.metaKey||l.ctrlKey)&&(l.key==="k"||l.key==="K")){l.preventDefault(),window.openCmdk();return}if(l.key==="Escape"){var p=document.getElementById("cmdk-mask");if(p&&p.classList.contains("show")){window.closeCmdk();return}var m=document.getElementById("avatar-popup");m&&m.classList.contains("show")&&typeof window._closeAvatarPopup=="function"&&window._closeAvatarPopup()}});try{var f=(navigator.userAgent||"").toLowerCase(),d=f.indexOf("mac")>=0||f.indexOf("iphone")>=0||f.indexOf("ipad")>=0;d||document.body.classList.add("is-windows")}catch{}function u(){n(),c(),typeof window.subscribeI18n=="function"&&window.subscribeI18n("nav-ia-phase1-role",function(){try{typeof window.applyRoleVisibility=="function"&&window.applyRoleVisibility()}catch{}})}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",u):u()})();(function(){function n(v){return String(v??"").replace(/[&<>"']/g,function(y){return{"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"}[y]})}function a(v){if(!v||isNaN(v))return"";var y=Number(v);return y<1024?y+" B":y<1024*1024?(y/1024).toFixed(1)+" KB":(y/1024/1024).toFixed(1)+" MB"}document.addEventListener("click",function(v){var y=v.target.closest&&v.target.closest(".recon-collapse-head");if(y&&!(v.target.closest("button")||v.target.closest("a"))){var b=y.closest(".recon-collapse");if(b){var h=b.getAttribute("data-collapsed")==="true";b.setAttribute("data-collapsed",h?"false":"true"),h&&(b.id==="vex-summary-collapse"&&u(),b.id==="vex-detail-collapse"&&l())}}}),document.addEventListener("keydown",function(v){if(!(v.key!=="Enter"&&v.key!==" ")){var y=v.target.closest&&v.target.closest(".recon-collapse-head");y&&(v.preventDefault(),y.click())}});var o={vat:"",gl:""};window._glvClearPreviewSearch=function(){o.vat="",o.gl=""};var s='<svg class="vex-pp-fi-icon" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#111111" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/></svg>',i='<svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg>';function r(){f("vat"),f("gl")}function c(v){try{if(typeof window._glvPreviewFiles=="function")return window._glvPreviewFiles(v)||[]}catch{}var y=document.getElementById(v==="vat"?"glv-vat-input":"glv-gl-input");return y&&y.files?Array.from(y.files):[]}function f(v){var y=document.getElementById(v==="vat"?"glv-pp-vat-col":"glv-pp-gl-col");if(y){var b=c(v),h=v==="vat"?"glv-up-vat-title":"glv-up-gl-title",g=v==="vat"?"① 销项税报告":"② 总账 GL",_=window.t&&window.t(h)||g,w=n(window.t&&window.t("vex-preview-search")||"搜索文件名..."),k=n(window.t&&window.t("vex-preview-clear-all")||"全清"),x=o[v]||"",E=b.length;y.innerHTML='<div class="vex-pp-col-title"><span class="vex-pp-col-name">'+n(_)+' <span class="vex-pp-col-count">'+E+'</span></span></div><div class="vex-pp-search-row"><input class="vex-pp-search" id="glv-pp-search-'+v+'" type="text" placeholder="'+w+'" value="'+n(x)+'" autocomplete="off"><button class="vex-pp-clear-btn" id="glv-pp-clearall-'+v+'" type="button">'+k+'</button></div><div class="vex-pp-file-list" id="glv-pp-'+v+'-list"></div><div class="vex-pp-pagination" id="glv-pp-'+v+'-pg"></div>';var I=document.getElementById("glv-pp-search-"+v);I&&I.addEventListener("input",function(B){o[v]=B.target.value,d(v)});var L=document.getElementById("glv-pp-clearall-"+v);L&&L.addEventListener("click",function(){window._glvRemoveFile&&window._glvRemoveFile(v)}),d(v)}}function d(v){var y=document.getElementById("glv-pp-"+v+"-list"),b=document.getElementById("glv-pp-"+v+"-pg");if(y){var h=c(v),g=(o[v]||"").toLowerCase(),_=h.map(function(x,E){return{f:x,i:E}}),w=g?_.filter(function(x){return x.f.name.toLowerCase().indexOf(g)>=0}):_;if(y.innerHTML=w.map(function(x){var E=x.f;return'<div class="vex-pp-file-row">'+s+'<span class="vex-pp-fi-name" title="'+n(E.name)+'">'+n(E.name)+'</span><span class="vex-pp-fi-size">'+a(E.size)+'</span><button class="vex-pp-fi-del" type="button" data-kind="'+v+'" data-idx="'+x.i+'" aria-label="remove">'+i+"</button></div>"}).join(""),y.querySelectorAll(".vex-pp-fi-del").forEach(function(x){x.addEventListener("click",function(){var E=x.dataset.kind,I=parseInt(x.dataset.idx,10);window._glvRemoveFile&&window._glvRemoveFile(E,isNaN(I)?null:I)})}),b){var k=window.t&&window.t("vex-preview-count")||"显示前 {n} / 共 {m}";b.textContent=k.replace("{n}",w.length).replace("{m}",w.length)}}}function u(){var v=function(b,h){var g=document.getElementById(b);g&&(g.textContent=h==null?"—":String(h))},y=window._vexLastTask||{};v("vex-sum-total",y.total),v("vex-sum-matched",y.matched),v("vex-sum-diff",y.diff),v("vex-sum-incomplete",y.incomplete),v("vex-sum-cash",y.cash),document.getElementById("vex-summary-sub")}function l(){var v=window._vexLastTask&&window._vexLastTask.diff_rows||[],y=document.getElementById("vex-detail-tbody"),b=document.getElementById("vex-detail-table"),h=document.getElementById("vex-detail-empty");if(!(!y||!b||!h)){if(v.length===0){b.style.display="none",h.style.display="";return}h.style.display="none",b.style.display="";var g=v.map(function(w){return'<tr><td class="recon-detail-cell-mono">'+n(w.invoice_no||"")+"</td><td>"+n(w.field||"")+"</td><td>"+n(w.report_value||"")+"</td><td>"+n(w.invoice_value||"")+"</td><td>"+n(w.kind||"")+"</td></tr>"}).join("");y.innerHTML=g;var _=document.getElementById("vex-detail-sub");_&&(_.textContent=String(v.length))}}function p(){var v=document.getElementById("glv-toggle-preview");v&&!v._reconBound&&(v._reconBound=!0,v.addEventListener("click",function(){var y=document.getElementById("glv-preview-panel"),b=document.getElementById("glv-toggle-preview-label"),h=y&&y.style.display!=="none";y&&(y.style.display=h?"none":""),v.classList.toggle("open",!h),b&&(b.textContent=h?window.t&&window.t("vex-toggle-preview-open")||"查看清单":window.t&&window.t("vex-toggle-preview-close")||"收起清单"),h||r()})),["glv-vat-input","glv-gl-input"].forEach(function(y){var b=document.getElementById(y);!b||b._reconWatched||(b._reconWatched=!0,b.addEventListener("change",function(){var h=document.getElementById("glv-preview-panel");h&&h.style.display!=="none"&&r()}))})}function m(){var v=document.getElementById("vex-summary-collapse"),y=document.getElementById("vex-detail-collapse");v&&(v.style.display=""),y&&(y.style.display=""),u(),l()}window._fillVexSummary=u,window._fillVexDetail=l,window._onVexResultShown=m,document.addEventListener("DOMContentLoaded",function(){p()}),setTimeout(p,1500),typeof window.subscribeI18n=="function"&&window.subscribeI18n("recon-collapse",function(){var v=document.getElementById("glv-preview-panel");v&&v.style.display!=="none"&&r();var y=document.getElementById("glv-toggle-preview-label"),b=document.getElementById("glv-toggle-preview");y&&b&&(y.textContent=b.classList.contains("open")?window.t&&window.t("vex-toggle-preview-close")||"收起清单":window.t&&window.t("vex-toggle-preview-open")||"查看清单")}),window._reconCollapse={renderGlvPreview:r,fillVexSummary:u,fillVexDetail:l}})();(function(){function e(i){}function n(){const i=document.querySelectorAll("[data-recon-tab]");i.forEach(c=>{c.addEventListener("click",()=>{i.forEach(p=>p.classList.remove("active")),c.classList.add("active");const f=c.dataset.reconTab,d=document.getElementById("recon-pane-bank"),u=document.getElementById("recon-pane-sale-vat"),l=document.getElementById("recon-pane-gl-vat");d&&(d.style.display=f==="bank"?"":"none"),u&&(u.style.display=f==="sale-vat"?"":"none"),l&&(l.style.display=f==="gl-vat"?"":"none"),f==="gl-vat"&&window.GlVatRecon&&window.GlVatRecon.ensureInit(),f==="bank"&&typeof window._bankReconV2Init=="function"&&window._bankReconV2Init()})});const r=document.querySelector("[data-recon-tab].active");r&&(r.dataset.reconTab,void 0)}function a(){const i=document.getElementById("page-settings");if(!i)return null;let r=document.getElementById("settings-modal-overlay");if(r)return r;r=document.createElement("div"),r.id="settings-modal-overlay",r.className="settings-modal-overlay",r.style.display="none",i.parentElement.insertBefore(r,i),r.appendChild(i);const c=document.createElement("button");return c.id="settings-modal-close",c.className="settings-modal-close",c.setAttribute("aria-label","close"),c.innerHTML='<svg viewBox="0 0 20 20" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M5 5l10 10M15 5L5 15"/></svg>',i.insertBefore(c,i.firstChild),c.addEventListener("click",s),r.addEventListener("click",f=>{f.target===r&&s()}),r}function o(){const i=a();if(!i)return;i.style.display="flex",document.body.classList.add("settings-modal-open");const r=document.getElementById("page-settings");r&&(r.style.display="block"),setTimeout(()=>{try{typeof renderSettings=="function"&&renderSettings()}catch(f){console.warn("renderSettings:",f)}let c=document.querySelector(".settings-tab.active")||document.querySelector('.settings-tab[data-tab="profile"]');c&&c.click()},50)}function s(){const i=document.getElementById("settings-modal-overlay");i&&(i.style.display="none"),document.body.classList.remove("settings-modal-open")}window.openSettingsModal=o,window.closeSettingsModal=s,document.addEventListener("keydown",i=>{if(i.key==="Escape"){const r=document.getElementById("settings-modal-overlay");r&&r.style.display==="flex"&&s()}}),window.addEventListener("hashchange",()=>{location.hash==="#/settings"&&o()}),window.addEventListener("DOMContentLoaded",()=>{location.hash==="#/settings"&&o()}),document.readyState==="loading"?document.addEventListener("DOMContentLoaded",n):n()})();const Yn=1e3,Jn=30,Ga=/\.(pdf|jpe?g|png|webp|tiff?|xlsx?|xlsm|csv|tsv|docx?)$/i,Q=e=>document.getElementById(e);function ft(){return{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||"")}}function ke(e){const n={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"};return String(e??"").replace(/[&<>"']/g,a=>n[a])}function Gs(e){return e<1024?e+" B":e<1024*1024?(e/1024).toFixed(1)+" KB":(e/1024/1024).toFixed(1)+" MB"}const H={invoiceFiles:[],reportFiles:[],running:!1,vexAllRows:[],previewLimitInv:50,previewLimitRep:50,previewSearchInv:"",previewSearchRep:"",vexPage:1};async function mn(){try{const e=await fetch("/api/vat_excel/tasks?page=1&page_size=1",{headers:ft()});if(!e.ok)return;const a=(await e.json()).kpi||{};[["vex-kpi-month-val",a.this_month],["vex-kpi-running-val",a.running],["vex-kpi-done-val",a.done],["vex-kpi-failed-val",a.failed]].forEach(([o,s])=>{const i=document.getElementById(o);i&&(i.textContent=s??0)})}catch{}}async function vn(){try{const e=await fetch("/api/vat_excel/tasks?page=1&page_size=100",{headers:ft()});if(!e.ok)return;const n=await e.json();En(n.rows||[])}catch{}}const kt=10;function Ks(){var e=((document.getElementById("vex-task-search")||{}).value||"").trim().toLowerCase();if(H.vexPage=1,En(H.vexAllRows),!!e){var n=document.getElementById("vex-task-tbody");n&&n.querySelectorAll("tr").forEach(function(a){a.dataset.taskId&&(a.style.display=a.textContent.toLowerCase().indexOf(e)>=0?"":"none")})}}function En(e){H.vexAllRows=e||H.vexAllRows;const n=document.getElementById("vex-task-tbody");if(!n)return;if(!H.vexAllRows.length){n.innerHTML='<tr><td colspan="9" class="vex-task-empty">'+(t("sv-empty-title")||"还没有对账任务")+"</td></tr>",Do(0);return}const a=Math.ceil(H.vexAllRows.length/kt);H.vexPage>a&&(H.vexPage=a);const o=(H.vexPage-1)*kt;pd(H.vexAllRows.slice(o,o+kt)),Do(H.vexAllRows.length)}function Do(e){const n=document.getElementById("vex-task-pager"),a=document.getElementById("vex-task-pager-info"),o=document.getElementById("vex-task-prev"),s=document.getElementById("vex-task-next");if(!n)return;if(e<=kt){n.style.display="none";return}n.style.display="";const i=Math.ceil(e/kt);a&&(a.textContent=H.vexPage+" / "+i),o&&(o.disabled=H.vexPage<=1),s&&(s.disabled=H.vexPage>=i)}function pd(e){const n=document.getElementById("vex-task-tbody");if(!n)return;const a={pending:t("vex-status-pending")||"待处理",running:t("vex-status-running")||"处理中",done:t("vex-status-done")||"已完成",failed:t("vex-status-failed")||"失败"},o={pending:"badge-gray",running:"badge-blue",done:"badge-green",failed:"badge-red"},s='<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M8 2v9M4 7l4 4 4-4M3 14h10"/></svg>',i='<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M3 4h10M6 4V3h4v1M5 4v8a1 1 0 001 1h4a1 1 0 001-1V4"/></svg>';n.innerHTML=e.map(r=>{const c=r.created_at?new Date(r.created_at).toLocaleString([],{year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",minute:"2-digit"}):"—",f=r.period||"—",d=r.matched_count!=null?r.matched_count+" ✓ · "+r.mismatched_count+" ⚠":"—",u=r.mismatch_amount!=null?"฿ "+Number(r.mismatch_amount).toLocaleString():"—",l=r.elapsed_seconds!=null?r.elapsed_seconds.toFixed(1)+" s":"—",p=r.status||"pending",m=r.client_name&&r.client_name!=="client"?r.client_name:t("vex-client-all")||"全部客户";return`<tr class="vex-task-row" data-task-id="${ke(r.id)}" style="cursor:pointer">
            <td>${c}</td>
            <td>${ke(m)}</td>
            <td>${ke(f)}</td>
        ...
        </tr>`}).join(""),n.querySelectorAll(".vex-task-dl-btn").forEach(r=>{r.addEventListener("click",async c=>{c.stopPropagation();const f=r.dataset.taskId;try{const d=await fetch("/api/vat_excel/tasks/"+encodeURIComponent(f)+"/download",{credentials:"include",headers:ft()});if(d.status===410){showToast(t("vex-toast-expired")||"数据已过期 · 请重新对账","warn");return}if(!d.ok){showToast(t("vex-toast-dl-fail")||"下载失败 · 请重试","error");return}const u=await d.blob(),p=(d.headers.get("Content-Disposition")||"").match(/filename\*?=(?:UTF-8''|")?([^";]+)/i),m=p?decodeURIComponent(p[1]):"vat_recon_"+f+".xlsx",v=URL.createObjectURL(u),y=document.createElement("a");y.href=v,y.download=m,y.click(),setTimeout(()=>URL.revokeObjectURL(v),1e3)}catch{showToast(t("vex-toast-dl-fail")||"下载失败 · 请重试","error")}})}),n.querySelectorAll(".vex-task-del-btn").forEach(r=>{r.addEventListener("click",c=>{c.stopPropagation(),fd(r.dataset.taskId)})}),Ks()}function ud(){var e=document.getElementById("vex-task-prev"),n=document.getElementById("vex-task-next");e&&!e._vexBound&&(e._vexBound=!0,e.addEventListener("click",function(){H.vexPage>1&&(H.vexPage--,En())})),n&&!n._vexBound&&(n._vexBound=!0,n.addEventListener("click",function(){var a=Math.ceil(H.vexAllRows.length/kt);H.vexPage<a&&(H.vexPage++,En())}))}async function fd(e){const n=t("vex-task-delete-confirm-title")||"删除对账任务?",a=t("vex-task-delete-confirm-body")||"同时清掉对应的发票识别缓存 · 不可恢复";if(await showConfirm(a,{title:n,danger:!0,okText:t("vex-task-delete-confirm-title")||"确认删除"}))try{const s=await fetch("/api/vat_excel/tasks/"+encodeURIComponent(e),{method:"DELETE",credentials:"include",headers:ft()});if(!s.ok)throw new Error(s.status);showToast(t("vex-task-delete-ok")||"已删除","success"),vn(),mn()}catch{showToast(t("vex-task-delete-fail")||"删除失败","error")}}function Ws(e){const n=window._currentLang||"th",a={zh:`已忽略 ${e} 个不支持的文件 · 仅支持 PDF / 图片 / Excel / CSV / Word`,th:`ข้ามไฟล์ที่ไม่รองรับ ${e} ไฟล์ · รองรับเฉพาะ PDF / รูปภาพ / Excel / CSV / Word`,en:`Ignored ${e} unsupported file(s) · only PDF / image / Excel / CSV / Word are supported`,ja:`非対応ファイル ${e} 件をスキップ · 対応形式は PDF / 画像 / Excel / CSV / Word のみ`};showToast(a[n]||a.th,"warn")}function md(e){const n=new Set(H.invoiceFiles.map(o=>o.name+"|"+o.size));let a=0;for(const o of e){if(!Ga.test(o.name)){a++;continue}const s=o.name+"|"+o.size;if(!n.has(s)&&(n.add(s),H.invoiceFiles.push(o),H.invoiceFiles.length>=Yn))break}a>0&&Ws(a),H.invoiceFiles.length>Yn&&(H.invoiceFiles=H.invoiceFiles.slice(0,Yn),showToast(t("vex-toast-cap-inv"),"warn")),Qe()}function vd(e){const n=new Set(H.reportFiles.map(o=>o.name+"|"+o.size));let a=0;for(const o of e){if(!Ga.test(o.name)){a++;continue}const s=o.name+"|"+o.size;if(!n.has(s)&&(n.add(s),H.reportFiles.push(o),H.reportFiles.length>=Jn))break}a>0&&Ws(a),H.reportFiles.length>Jn&&(H.reportFiles=H.reportFiles.slice(0,Jn),showToast(t("vex-toast-cap-rep"),"warn")),Qe()}function Ys(e){H.invoiceFiles.splice(e,1),Qe()}function Js(e){H.reportFiles.splice(e,1),Qe()}function Qe(){const e=Q("vex-list-invoice"),n=Q("vex-list-report"),a=Q("vex-count-invoice"),o=Q("vex-count-report");a&&(a.textContent=H.invoiceFiles.length),o&&(o.textContent=H.reportFiles.length);const s=(c,f,d)=>`<div class="vex-fi">
        ...
        <span class="vex-fi-s">${Gs(c.size)}</span>
        <button class="vex-fi-x" type="button" data-vex-kind="${d}" data-vex-idx="${f}" aria-label="remove">×</button>
    </div>`;e&&(e.innerHTML=H.invoiceFiles.map((c,f)=>s(c,f,"inv")).join("")||'<div class="vex-fi-empty" data-i18n="vex-no-files">还没文件</div>'),n&&(n.innerHTML=H.reportFiles.map((c,f)=>s(c,f,"rep")).join("")||'<div class="vex-fi-empty" data-i18n="vex-no-files">还没文件</div>'),document.querySelectorAll(".vex-fi-x").forEach(c=>{c.addEventListener("click",f=>{const d=c.dataset.vexKind,u=parseInt(c.dataset.vexIdx,10);d==="inv"?Ys(u):Js(u)})});const i=H.invoiceFiles.length>0&&H.reportFiles.length>0;Q("vex-build").disabled=!i||H.running;const r=Q("vex-action-info");r&&(!H.invoiceFiles.length||!H.reportFiles.length?(r.textContent=t("vex-need-both")||"需要至少 1 张发票 + 1 份 VAT 报告",r.className="vex-action-info muted"):(r.textContent=(t("vex-ready")||"已就绪 · {a} 张发票 · {b} 份报告").replace("{a}",H.invoiceFiles.length).replace("{b}",H.reportFiles.length),r.className="vex-action-info ok")),ua()}const hd='<svg class="vex-pp-fi-icon" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#6B7280" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path><polyline points="14 2 14 8 20 8"></polyline></svg>',gd='<svg class="vex-pp-fi-icon" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#111111" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="4" width="18" height="18" rx="2" ry="2"></rect><line x1="16" y1="2" x2="16" y2="6"></line><line x1="8" y1="2" x2="8" y2="6"></line><line x1="3" y1="10" x2="21" y2="10"></line></svg>',bd='<svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg>';function ua(){const e=Q("vex-preview-panel");if(!e||e.style.display==="none")return;Ro("inv"),Ro("rep");const n=Q("vex-pp-guide");n&&(n.style.display=H.invoiceFiles.length>100?"flex":"none")}function Ro(e){const n=Q(e==="inv"?"vex-pp-invoice-col":"vex-pp-report-col");if(!n)return;const a=e==="inv"?H.invoiceFiles:H.reportFiles,o=e==="inv"?H.previewSearchInv:H.previewSearchRep,s=t(e==="inv"?"vex-preview-invoice":"vex-preview-report")||(e==="inv"?"销售发票":"VAT 报告"),i=ke(t("vex-preview-search")||"搜索文件名..."),r=ke(t("vex-preview-clear-all")||"全清");n.innerHTML=`
        ...
        <div class="vex-pp-pagination" id="vex-pp-${e}-pg"></div>`;const c=Q("vex-pp-search-"+e);c&&c.addEventListener("input",d=>{e==="inv"?(H.previewSearchInv=d.target.value,H.previewLimitInv=50):(H.previewSearchRep=d.target.value,H.previewLimitRep=50),fa(e)});const f=Q("vex-pp-clearall-"+e);f&&f.addEventListener("click",()=>{e==="inv"?(H.invoiceFiles=[],H.previewSearchInv="",H.previewLimitInv=50):(H.reportFiles=[],H.previewSearchRep="",H.previewLimitRep=50),Qe()}),fa(e)}function fa(e){const n=Q("vex-pp-"+e+"-list"),a=Q("vex-pp-"+e+"-pg");if(!n)return;const o=e==="inv"?H.invoiceFiles:H.reportFiles,s=e==="inv"?H.previewSearchInv:H.previewSearchRep,i=e==="inv"?H.previewLimitInv:H.previewLimitRep,r=e==="inv"?hd:gd,c=o.map((u,l)=>({f:u,i:l})),f=s?c.filter(({f:u})=>u.name.toLowerCase().includes(s.toLowerCase())):c,d=f.slice(0,i);if(n.innerHTML=d.map(({f:u,i:l})=>`
        <div class="vex-pp-file-row">
            ${r}
            <span class="vex-pp-fi-name" title="${ke(u.name)}">${ke(u.name)}</span>
            <span class="vex-pp-fi-size">${Gs(u.size)}</span>
            <button class="vex-pp-fi-del" type="button" data-kind="${e}" data-ridx="${l}" aria-label="remove">${bd}</button>
        </div>`).join("")+`<div id="vex-pp-sentinel-${e}" style="height:1px;flex-shrink:0"></div>`,n.querySelectorAll(".vex-pp-fi-del").forEach(u=>{u.addEventListener("click",()=>{const l=parseInt(u.dataset.ridx,10);u.dataset.kind==="inv"?Ys(l):Js(l)})}),a){const u=t("vex-preview-count")||"显示前 {n} / 共 {m}";a.textContent=u.replace("{n}",d.length).replace("{m}",f.length)}yd(e,f.length)}function yd(e,n){if((e==="inv"?H.previewLimitInv:H.previewLimitRep)>=n)return;const o=Q("vex-pp-sentinel-"+e),s=Q("vex-pp-"+e+"-list");if(!o||!s)return;const i=new IntersectionObserver(r=>{r[0].isIntersecting&&(i.disconnect(),e==="inv"?H.previewLimitInv+=50:H.previewLimitRep+=50,fa(e))},{root:s,threshold:.8});i.observe(o)}function Fo(e,n,a,o){const s=Q(e),i=Q(n);!s||!i||(s.addEventListener("click",()=>i.click()),s.addEventListener("keydown",r=>{(r.key==="Enter"||r.key===" ")&&(r.preventDefault(),i.click())}),s.addEventListener("dragover",r=>{r.preventDefault(),s.classList.add("drag-over")}),s.addEventListener("dragleave",()=>s.classList.remove("drag-over")),s.addEventListener("drop",r=>{r.preventDefault(),s.classList.remove("drag-over");const f=Array.from(r.dataTransfer.files).filter(d=>Ga.test(d.name));if(!f.length){showToast(t("vex-toast-bad-ext"),"error");return}a(f)}),i.addEventListener("change",()=>{const r=Array.from(i.files);a(r),i.value=""}))}(function(){async function e(){if(H.running||!H.invoiceFiles.length||!H.reportFiles.length)return;H.running=!0,Q("vex-build").disabled=!0,Q("vex-progress").style.display="flex";var r=document.getElementById("vex-download");r&&(r.style.display="none"),["vex-summary-collapse","vex-detail-collapse"].forEach(function(u){var l=document.getElementById(u);l&&(l.style.display="none")});const c=Date.now();Q("vex-progress-title").textContent=t("vex-progress-running")||"AI 抽取中",Q("vex-progress-sub").textContent=(t("vex-progress-sub")||"{a} 张发票 + {b} 份报告 · 并行处理").replace("{a}",H.invoiceFiles.length).replace("{b}",H.reportFiles.length);const f=setInterval(()=>{const u=Math.floor((Date.now()-c)/1e3);Q("vex-progress-sub").textContent=(t("vex-progress-elapsed")||"已 {s} 秒 · {a} 张发票 + {b} 份报告").replace("{s}",u).replace("{a}",H.invoiceFiles.length).replace("{b}",H.reportFiles.length)},1e3);try{const u=new FormData;for(const B of H.invoiceFiles)u.append("invoices",B);for(const B of H.reportFiles)u.append("reports",B);const l=typeof currentLang=="string"&&currentLang||localStorage.getItem("mrpilot_lang")||"th";u.append("lang",l);const p=localStorage.getItem("mrpilot_token")||"",m=await fetch("/api/vat_excel/submit",{method:"POST",headers:ft(),body:u});let v=null;try{v=await m.json()}catch{v=null}if(!m.ok||!v||!v.ok||!v.job_id)throw clearInterval(f),new Error(v&&v.detail||"HTTP "+m.status);const y=Q("vex-progress-sub"),b=await window._reconPollJob(v.job_id,p,{onProgress:B=>{y&&(y.textContent=window._reconProgressText(B,l))}});if(clearInterval(f),!b||b.status!=="done"||!b.result_id)throw new Error(t("vex-toast-fail")||"生成失败");const h=b.result_id;let g=0;const _=await fetch("/api/vat_excel/tasks/"+encodeURIComponent(h)+"/download",{headers:ft()});if(!_.ok)throw new Error("HTTP "+_.status);const k=(_.headers.get("Content-Disposition")||"").match(/filename="([^"]+)"/),x=k&&k[1]||"vat_recon_"+Date.now()+".xlsx",E=await _.blob(),I=URL.createObjectURL(E),L=Q("vex-download");L.href=I,L.download=x;try{const B=document.createElement("a");B.href=I,B.download=x,document.body.appendChild(B),B.click(),setTimeout(()=>B.remove(),100)}catch{}Q("vex-progress").style.display="none";var d=document.getElementById("vex-download");d&&(d.style.display=""),h&&(g=await o(h)),window._onVexResultShown&&window._onVexResultShown(),g>0?showToast((t("vex-toast-some-fail")||"有 {n} 张发票 OCR 失败").replace("{n}",g),"warn"):showToast(t("vex-toast-done")||"Excel 已生成","success"),mn(),setTimeout(vn,800)}catch(u){clearInterval(f),Q("vex-progress").style.display="none";const l=(t("vex-toast-fail")||"生成失败")+": "+(u.message||u);showToast(l,"error")}finally{H.running=!1,Q("vex-build").disabled=!1}}function n(){H.invoiceFiles=[],H.reportFiles=[];var r=document.getElementById("vex-download");r&&(r.style.display="none"),Qe()}function a(r){if(r==null)return"—";var c=parseFloat(r);return isNaN(c)?"—":c.toLocaleString("th-TH",{minimumFractionDigits:2,maximumFractionDigits:2})}async function o(r){try{var c=await fetch("/api/vat_excel/tasks/"+encodeURIComponent(r),{headers:ft()});if(!c.ok)throw new Error(c.status);var f=await c.json(),d=f.raw_data_json;if(typeof d=="string")try{d=JSON.parse(d)}catch{d={}}d=d||{};var u=d.rows||[],l=[];u.forEach(function(v){v.kind==="invoice_orphan"?l.push({invoice_no:v.invoice_no||"",field:"仅发票有",report_value:"—",invoice_value:a(v.amount_inv),kind:v.kind}):v.kind==="report_orphan"?l.push({invoice_no:v.invoice_no||"",field:"仅报告有",report_value:a(v.amount_rep),invoice_value:"—",kind:v.kind}):v.dims&&Object.keys(v.dims).length>0&&Object.keys(v.dims).forEach(function(y){var b=String(v.dims[y]||""),h=b.split(" ≠ ");l.push({invoice_no:v.invoice_no||"",field:y,report_value:h[0]||b,invoice_value:h.length>1?h[1]:"—",kind:"diff"})})});var p=u.filter(function(v){return v.kind==="matched_cash"}).length,m=Math.max(0,parseInt(d.invoice_ocr_failed_count||0,10));return window._vexLastTask={total:d.n_total||0,matched:d.n_ok||0,diff:d.n_diff||0,incomplete:m,cash:p,diff_rows:l,task_id:r},window._fillVexSummary&&window._fillVexSummary(),window._fillVexDetail&&window._fillVexDetail(),m}catch{return 0}}function s(){const r=document.getElementById("vex-pane");r&&r.querySelectorAll("[data-i18n]").forEach(c=>{const f=t(c.dataset.i18n);f&&(c.textContent=f)}),Qe(),vn()}function i(){Fo("vex-drop-invoice","vex-input-invoice",md),Fo("vex-drop-report","vex-input-report",vd);const r=Q("vex-build"),c=Q("vex-reset");r&&r.addEventListener("click",e),c&&c.addEventListener("click",n),document.querySelectorAll('[data-recon-tab="sale-vat"]').forEach(u=>{u.addEventListener("click",()=>{mn(),vn()})}),ud();const f=document.getElementById("vex-task-search");f&&f.addEventListener("input",Ks);const d=document.getElementById("vex-toggle-preview");d&&d.addEventListener("click",()=>{const u=Q("vex-preview-panel"),l=Q("vex-toggle-preview-label"),p=u&&u.style.display!=="none";u&&(u.style.display=p?"none":""),d&&d.classList.toggle("open",!p),l&&(l.textContent=p?t("vex-toggle-preview-open")||"查看清单":t("vex-toggle-preview-close")||"收起清单"),p||ua()}),Qe(),mn()}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",i):i(),typeof window.subscribeI18n=="function"&&(window.subscribeI18n("vex-excel",s),window.subscribeI18n("vex-preview-panel",ua))})();const W={inited:!1,glFile:[],vatFile:[],running:!1,currentTaskId:null,lastDetail:[],lastSummary:null},U=e=>document.getElementById(e),Xs=()=>localStorage.getItem("mrpilot_token")||"",St=()=>typeof window.currentLang=="string"&&window.currentLang?window.currentLang:localStorage.getItem("mrpilot_lang")||"th",mt=()=>({Authorization:"Bearer "+Xs()}),qo={th:{not_found:"ไม่พบข้อมูล",running:"กำลังกระทบยอด…",error:"เกิดข้อผิดพลาด",need_files:"กรุณาเลือกไฟล์ทั้งสอง",done:"เสร็จสิ้น",hint_need_both:"อัปโหลด ① รายงานภาษีขาย + ② GL",hint_need_one_more:"อัปโหลดอีก 1 ไฟล์",hint_ready:"พร้อมแล้ว · กดเริ่มกระทบยอด",hist_load:"โหลด",hist_export:"ส่งออก",hist_delete:"ลบ",confirm_delete:"ยืนยันการลบงานนี้?",s_gl_total:"ยอดรวมตามบัญชีแยกประเภท",s_minus_gl_cr:"หัก : รายการเครดิตที่ไม่มีในรายงานภาษีขาย",s_plus_gl_dr:"บวก : รายการเดบิตที่ไม่มีในรายงานภาษีขาย",s_plus_vat_p:"บวก : รายการยอดขายที่ไม่มีในบัญชีแยกประเภท",s_minus_vat_n:"หัก : รายการลดหนี้ที่ไม่มีในบัญชีแยกประเภท",s_vat_total:"ยอดรวมตามรายงานภาษีขาย"},zh:{not_found:"未找到数据",running:"正在对账中...",error:"出错了",need_files:"请先选择两个文件",done:"完成",hint_need_both:"请上传① 销项税报告 + ② 总账 GL",hint_need_one_more:"还需上传 1 份文件",hint_ready:"已就绪 · 点击开始对账",hist_load:"加载",hist_export:"导出",hist_delete:"删除",confirm_delete:"确认删除此任务？",s_gl_total:"总账金额合计",s_minus_gl_cr:"减：销项税报告中未列的贷方记录",s_plus_gl_dr:"加：销项税报告中未列的借方记录",s_plus_vat_p:"加：总账中未列的销售记录",s_minus_vat_n:"减：总账中未列的贷项凭单(credit note)记录",s_vat_total:"销项税报告金额合计"},en:{not_found:"Not found",running:"Reconciling...",error:"Error",need_files:"Please select both files",done:"Done",hint_need_both:"Upload ① Output VAT report + ② GL file",hint_need_one_more:"1 more file required",hint_ready:"Ready · click Run to start",hist_load:"Load",hist_export:"Export",hist_delete:"Delete",confirm_delete:"Delete this task?",s_gl_total:"Total per General Ledger",s_minus_gl_cr:"Less: GL credits not in VAT Report",s_plus_gl_dr:"Add: GL debits not in VAT Report",s_plus_vat_p:"Add: Sales in VAT Report not in GL",s_minus_vat_n:"Less: Credit notes in VAT Report not in GL",s_vat_total:"Total per VAT Sales Report"},ja:{not_found:"データなし",running:"照合中…",error:"エラー",need_files:"両方のファイルを選択してください",done:"完了",hint_need_both:"① 売上税報告 + ② GL をアップロード",hint_need_one_more:"あと 1 ファイル必要",hint_ready:"準備完了 · 「開始」をクリック",hist_load:"読込",hist_export:"出力",hist_delete:"削除",confirm_delete:"このタスクを削除しますか?",s_gl_total:"総勘定元帳合計",s_minus_gl_cr:"減：売上税報告にないGL貸方記録",s_plus_gl_dr:"加：売上税報告にないGL借方記録",s_plus_vat_p:"加：GLにない売上記録",s_minus_vat_n:"減：GLにない赤伝記録",s_vat_total:"売上税報告合計"}},oe=e=>(qo[St()]||qo.th)[e]||e;function wd(e){const n=St(),o={gl_no_revenue_rows:{zh:"GL 中未找到收入科目行。请确认「收入科目前缀」是否正确(收入科目通常以 4 开头),改对后重试。",th:"ไม่พบรายการบัญชีรายได้ใน GL · ตรวจสอบ «คำนำหน้าบัญชีรายได้» (รายได้มักขึ้นต้นด้วย 4) แล้วลองใหม่",en:"No revenue-account rows found in the GL. Check the “revenue account prefix” (revenue usually starts with 4) and retry.",ja:"GL に収益科目の行が見つかりません。「収益科目プレフィックス」(通常 4 で始まる)を確認して再試行してください。"},gl_parse_failed:{zh:"GL 文件解析失败。请确认文件含日期/科目/借贷列,或换清晰的 Excel/CSV 重传。",th:"อ่านไฟล์ GL ไม่สำเร็จ · ตรวจสอบว่ามีคอลัมน์ วันที่/บัญชี/เดบิต-เครดิต หรืออัปโหลด Excel/CSV ที่ชัดเจน",en:"Failed to parse the GL file. Ensure it has date/account/debit-credit columns, or re-upload a clean Excel/CSV.",ja:"GL ファイルの解析に失敗しました。日付/科目/借方貸方列を確認するか、Excel/CSV を再アップロードしてください。"},vat_no_rows:{zh:"销项税报告里没有可对账的数据行。请确认上传了正确的销项税报告。",th:"ไม่พบแถวข้อมูลในรายงานภาษีขาย · ตรวจสอบว่าอัปโหลดรายงานที่ถูกต้อง",en:"No rows found in the sales-VAT report. Please check you uploaded the correct report.",ja:"売上VATレポートに行が見つかりません。正しいレポートをアップロードしたか確認してください。"},vat_parse_failed:{zh:"销项税报告解析失败。请换更清晰的版本,或转成 Excel/PDF 重传。",th:"อ่านรายงานภาษีขายไม่สำเร็จ · ลองเวอร์ชันที่ชัดเจนกว่า หรือแปลงเป็น Excel/PDF",en:"Failed to parse the sales-VAT report. Try a clearer version, or convert to Excel/PDF.",ja:"売上VATレポートの解析に失敗しました。より鮮明な版か、Excel/PDF に変換してください。"}}[e];return o?o[n]||o.th||o.en:oe("error")||"Error"}const Gt=e=>e==null||isNaN(e)?"":Number(e).toLocaleString("en-US",{minimumFractionDigits:2,maximumFractionDigits:2});function Ka(e){U("glv-kpi-matched")&&(U("glv-kpi-matched").textContent=e&&e.matched!=null?e.matched:"—"),U("glv-kpi-diff")&&(U("glv-kpi-diff").textContent=e&&e.diff!=null?e.diff:"—"),U("glv-kpi-unmatched")&&(U("glv-kpi-unmatched").textContent=e&&e.unmatched!=null?e.unmatched:"—")}function kd(e){if(!e)return"";try{const n=new Date(e);if(isNaN(n.getTime()))return e;const a=o=>String(o).padStart(2,"0");return n.getFullYear()+"-"+a(n.getMonth()+1)+"-"+a(n.getDate())+" "+a(n.getHours())+":"+a(n.getMinutes())}catch{return e}}function zo(e,n,a,o){const s=U(e),i=U(n),r=U(a);if(!s||!i||!r)return;const c=f=>{if(!f||!f.length)return;const d=Array.isArray(W[o])?W[o].slice():[],u=new Set(d.map(l=>l.name+"|"+l.size));for(const l of f){if(!l)continue;const p=l.name+"|"+l.size;u.has(p)||(d.push(l),u.add(p))}W[o]=d,Zs(r,d),Zt(),en(),window._reconCollapse&&window._reconCollapse.renderGlvPreview&&window._reconCollapse.renderGlvPreview()};s.addEventListener("click",()=>i.click()),s.addEventListener("keydown",f=>{(f.key==="Enter"||f.key===" ")&&(f.preventDefault(),i.click())}),i.addEventListener("change",()=>{c(Array.from(i.files||[])),i.value=""}),s.addEventListener("dragover",f=>{f.preventDefault(),s.classList.add("drag-over")}),s.addEventListener("dragleave",()=>s.classList.remove("drag-over")),s.addEventListener("drop",f=>{f.preventDefault(),s.classList.remove("drag-over");const d=f.dataTransfer&&f.dataTransfer.files?Array.from(f.dataTransfer.files):[];c(d)})}function Zs(e,n){if(!e)return;if(!n||n.length===0){e.textContent="";return}const a=n.reduce((o,s)=>o+Math.round(s.size/1024),0);if(n.length===1)e.textContent=n[0].name+"  ("+a+" KB)";else{const o=window.t&&window.t("glv-files-count")||"{n} 个文件";e.textContent=o.replace("{n}",n.length)+"  ("+a+" KB)"}}function Xe(e){const n=W[e];return Array.isArray(n)?n:n?[n]:[]}function Zt(){const e=U("btn-glv-run");if(!e)return;const n=Xe("glFile").length>0&&Xe("vatFile").length>0;e.disabled=!n||W.running}function en(){const e=U("glv-status");if(!e||W.running)return;const n=Xe("vatFile").length,a=Xe("glFile").length;n===0&&a===0?(e.className="vex-action-info muted",e.innerHTML="<span>"+oe("hint_need_both")+"</span>"):n>0&&a>0?(e.className="vex-action-info ok",e.innerHTML="<span>"+oe("hint_ready")+"</span>"):(e.className="vex-action-info muted",e.innerHTML="<span>"+oe("hint_need_one_more")+"</span>")}function xd(e,n){const a=e==="vat"?"vatFile":"glFile",o=e==="vat"?"glv-vat-input":"glv-gl-input",s=e==="vat"?"glv-vat-name":"glv-gl-name",i=Xe(a);n==null?W[a]=[]:W[a]=i.filter((c,f)=>f!==n);const r=U(o);r&&(r.value=""),Zs(U(s),Xe(a)),Zt(),en(),window._reconCollapse&&window._reconCollapse.renderGlvPreview&&window._reconCollapse.renderGlvPreview()}function _d(){W.glFile=[],W.vatFile=[],W.currentTaskId=null,W.lastDetail=[],W.lastSummary=null;const e=U("glv-vat-input");e&&(e.value="");const n=U("glv-gl-input");n&&(n.value="");const a=U("glv-vat-name");a&&(a.textContent="");const o=U("glv-gl-name");o&&(o.textContent="");const s=U("glv-result");s&&(s.style.display="none");const i=U("glv-kpi-strip");i&&(i.style.display="none"),Zt(),en(),window._glvClearPreviewSearch&&window._glvClearPreviewSearch(),window._reconCollapse&&window._reconCollapse.renderGlvPreview&&window._reconCollapse.renderGlvPreview()}function Wa(e){const n=U("glv-tbody");if(!n)return;Ld(e.length),n.innerHTML="";const a=oe("not_found"),o=document.createDocumentFragment();e.forEach(s=>{const i=document.createElement("tr"),r=(l,p)=>{const m=document.createElement("td");return p&&(m.className=p),m.textContent=l,m},c=s.gl_amount===null||s.gl_amount===void 0,f=s.diff;let d="glv-num",u="glv-num";c?(u+=" glv-cell-missing",d+=" glv-cell-missing"):Math.abs(f||0)<.005?d+=" glv-cell-ok":d+=" glv-cell-diff",i.appendChild(r(s.doc_no||"","glv-doc")),i.appendChild(r(s.date||"","")),i.appendChild(r(s.customer_name||"","")),i.appendChild(r(Gt(s.vat_amount),"glv-num")),i.appendChild(r(c?a:Gt(s.gl_amount),u)),i.appendChild(r(c?a:Gt(s.diff),d)),i.appendChild(r(s.account_codes||"","glv-doc")),o.appendChild(i)}),n.appendChild(o)}function Ya(e){const n=U("glv-summary-table")&&U("glv-summary-table").querySelector("tbody");if(!n)return;n.innerHTML="",[{label:oe("s_gl_total"),amount:e.gl_total,emph:!0,items:[],negate:!1},{label:oe("s_minus_gl_cr"),amount:-(e.gl_only_credit||0),emph:!1,items:e.gl_only_credit_items||[],negate:!0},{label:oe("s_plus_gl_dr"),amount:e.gl_only_debit||0,emph:!1,items:e.gl_only_debit_items||[],negate:!1},{label:oe("s_plus_vat_p"),amount:e.vat_only_positive||0,emph:!1,items:e.vat_only_positive_items||[],negate:!1},{label:oe("s_minus_vat_n"),amount:e.vat_only_negative||0,emph:!1,items:e.vat_only_negative_items||[],negate:!1},{label:oe("s_vat_total"),amount:e.vat_total,emph:!0,items:[],negate:!1}].forEach(({label:o,amount:s,emph:i,items:r,negate:c})=>{const f=document.createElement("tr");f.className=i?"glv-summary-total":"glv-summary-sect";const d=document.createElement("td"),u=document.createElement("td");d.textContent=o,u.textContent=i?Gt(s):"",f.appendChild(d),f.appendChild(u),n.appendChild(f),(r||[]).forEach(l=>{const p=document.createElement("tr");p.className="glv-summary-item";const m=document.createElement("td"),v=document.createElement("td"),y=[l.doc_no,l.date,l.name].filter(Boolean);m.textContent="· "+y.join("  ·  ");const b=c?-(l.amount||0):l.amount||0;v.textContent=Gt(b),p.appendChild(m),p.appendChild(v),n.appendChild(p)})})}async function Ed(e){try{const a=await(await fetch("/api/recon/gl-vat/"+e,{headers:mt()})).json();if(!a||!a.ok)throw new Error("load_failed");W.currentTaskId=e,W.lastDetail=a.detail||[],W.lastSummary=a.summary||{},Ka(a.stats||{}),Wa(W.lastDetail),Ya(W.lastSummary);const o=U("glv-result");o&&(o.style.display=""),Qs(),window.scrollTo({top:o?o.offsetTop-80:0,behavior:"smooth"})}catch(n){console.error("[gl-vat] load task failed:",n),alert(oe("error")+": "+(n.message||n))}}function Qs(){var e=U("glv-kpi-strip");e&&(e.style.display="");var n=U("glv-section-summary");n&&n.setAttribute("data-collapsed","false");var a=U("glv-section-detail");a&&a.setAttribute("data-collapsed","false")}function Id(){document.querySelectorAll(".glv-section-head[data-toggle]").forEach(e=>{const n=e.getAttribute("data-toggle"),a=document.getElementById(n);if(!a)return;const o=s=>{if(s.target&&s.target.closest("button")!==null&&!s.target.classList.contains("glv-section-head"))return;const i=a.getAttribute("data-collapsed")==="true";a.setAttribute("data-collapsed",i?"false":"true")};e.addEventListener("click",o),e.addEventListener("keydown",s=>{(s.key==="Enter"||s.key===" ")&&(s.preventDefault(),o(s))})})}function Ld(e){const n=U("glv-detail-count");n&&(n.textContent=e!=null?String(e):"")}const Ft=10;var bt=[],Ie=1;function Bd(){Ie=1,In();var e=((U("glv-hist-search")||{}).value||"").trim().toLowerCase();if(e){var n=U("glv-history-tbody");n&&n.querySelectorAll("tr").forEach(function(a){a.dataset.taskId&&(a.style.display=a.textContent.toLowerCase().indexOf(e)>=0?"":"none")})}}function In(){const e=U("glv-history-table-wrap"),n=U("glv-history-empty"),a=U("glv-history-tbody"),o=U("glv-history-pager"),s=U("glv-history-pager-info"),i=U("glv-history-prev"),r=U("glv-history-next");if(!a)return;if(a.innerHTML="",!bt.length){e&&(e.style.display="none"),n&&(n.style.display=""),o&&(o.style.display="none");return}e&&(e.style.display=""),n&&(n.style.display="none");const c=Math.ceil(bt.length/Ft);Ie>c&&(Ie=c);const f=(Ie-1)*Ft,d=bt.slice(f,f+Ft);o&&(o.style.display=bt.length>Ft?"":"none",s&&(s.textContent=Ie+" / "+c),i&&(i.disabled=Ie<=1),r&&(r.disabled=Ie>=c)),d.forEach(l=>{const p=document.createElement("tr");p.dataset.taskId=l.id;const m=document.createElement("td");m.textContent=kd(l.created_at);const v=document.createElement("td");v.className="glv-history-file",v.title=(l.vat_filename||"")+" + "+(l.gl_filename||""),v.textContent=(l.vat_filename||"?")+" + "+(l.gl_filename||"?");const y=document.createElement("td");y.className="glv-num",y.textContent=(l.vat_row_count||0)+" / "+(l.gl_row_count||0);const b=document.createElement("td");b.className="glv-num",b.textContent=l.matched_count||0;const h=document.createElement("td");h.className="glv-num",h.textContent=l.diff_count||0;const g=document.createElement("td");g.className="glv-num",g.textContent=l.unmatched_count||0;const _=document.createElement("td");_.className="glv-history-actions";const w=(I,L,B,C)=>{const S=document.createElement("button");return S.type="button",B&&(S.className=B),S.title=L,S.setAttribute("aria-label",L),S.innerHTML=I,S.onclick=C,S},k='<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" width="14" height="14"><path d="M2 8a6 6 0 1 0 12 0A6 6 0 0 0 2 8z"/><polyline points="6 8 8 10 10 8"/><line x1="8" y1="4" x2="8" y2="10"/></svg>',x='<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" width="14" height="14"><path d="M8 2v9M4 7l4 4 4-4M3 14h10"/></svg>',E='<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" width="14" height="14"><polyline points="3 4 13 4"/><path d="M6 4V2.5a.5.5 0 0 1 .5-.5h3a.5.5 0 0 1 .5.5V4"/><path d="M5 4l1 9a1 1 0 0 0 1 1h2a1 1 0 0 0 1-1l1-9"/></svg>';_.appendChild(w(k,oe("hist_load"),"",()=>Ed(l.id))),_.appendChild(w(x,oe("hist_export"),"",()=>Sd(l.id))),_.appendChild(w(E,oe("hist_delete"),"glv-del",()=>Td(l.id))),[m,v,y,b,h,g,_].forEach(I=>p.appendChild(I)),a.appendChild(p)})}function Cd(){var e=U("glv-history-prev"),n=U("glv-history-next");e&&!e._glvBound&&(e._glvBound=!0,e.addEventListener("click",function(){Ie>1&&(Ie--,In())})),n&&!n._glvBound&&(n._glvBound=!0,n.addEventListener("click",function(){var a=Math.ceil(bt.length/Ft);Ie<a&&(Ie++,In())}))}async function xt(){try{const n=await(await fetch("/api/recon/gl-vat/tasks",{headers:mt()})).json();bt=n&&n.tasks||[],Ie=1,In(),Cd()}catch(e){console.error("[gl-vat] history load failed:",e)}}async function Sd(e){try{const n="/api/recon/gl-vat/"+e+"/export?lang="+encodeURIComponent(St()),a=await fetch(n,{headers:mt()});if(!a.ok)throw new Error("HTTP "+a.status);const o=await a.blob(),s=document.createElement("a");s.href=URL.createObjectURL(o),s.download="GL_VAT_recon_"+e+".xlsx",document.body.appendChild(s),s.click(),setTimeout(()=>{URL.revokeObjectURL(s.href),s.remove()},200)}catch(n){console.error("[gl-vat] exportTask failed:",n),typeof showToast=="function"&&showToast(oe("error")+": "+(n.message||n),"error")}}async function Td(e){let n;if(typeof window.showConfirm=="function"?n=await window.showConfirm(oe("confirm_delete"),{danger:!0}):n=confirm(oe("confirm_delete")),!!n)try{const a=await fetch("/api/recon/gl-vat/"+e,{method:"DELETE",headers:mt()});if(!a.ok)throw new Error("HTTP "+a.status);xt()}catch(a){console.error("[gl-vat] delete failed:",a),typeof showToast=="function"&&showToast(oe("error")+": "+(a.message||a),"error")}}async function Md(){if(!W.glFile||!W.vatFile){typeof showToast=="function"&&showToast(oe("need_files"),"warn");return}W.running=!0,Zt();const e=U("glv-status"),n=U("glv-progress"),a=U("glv-progress-sub");e&&(e.className="vex-action-info muted",e.style.color="",e.innerHTML="<span>"+oe("running")+"</span>"),n&&(n.style.display=""),a&&(a.textContent=(W.vatFile.name||"VAT")+" + "+(W.glFile.name||"GL"));const o=new FormData,s=Xe("vatFile"),i=Xe("glFile");for(const c of s)o.append("vat_files",c,c.name);for(const c of i)o.append("gl_files",c,c.name);const r=(U("glv-prefix")&&U("glv-prefix").value||"4").trim()||"4";o.append("revenue_prefix",r),o.append("lang",St());try{const c=await fetch("/api/recon/gl-vat/submit",{method:"POST",headers:mt(),body:o});let f=null;try{f=await c.json()}catch{f=null}if(!c.ok||!f||!f.ok||!f.job_id)throw new Error(f&&f.detail||f&&f.error||"HTTP "+c.status);const d=U("glv-progress-sub"),u=await window._reconPollJob(f.job_id,Xs(),{onProgress:v=>{d&&(d.textContent=window._reconProgressText(v,St()))}});if(!u||u.status!=="done"||!u.result_id)throw u&&u.status==="failed"&&u.error_code?new Error(wd(u.error_code)):new Error(oe("error")||"Error");const l=await fetch("/api/recon/gl-vat/"+encodeURIComponent(u.result_id),{headers:mt()});let p=null;try{p=await l.json()}catch{p=null}if(!l.ok||!p||!p.ok)throw new Error(p&&p.detail||p&&p.error||"HTTP "+l.status);W.currentTaskId=p.task_id,W.lastDetail=p.detail||[],W.lastSummary=p.summary||{},Ka(p.stats||{}),Wa(W.lastDetail),Ya(W.lastSummary);const m=U("glv-result");m&&(m.style.display=""),Qs(),e&&(e.className="vex-action-info ok",e.style.color="",e.innerHTML="<span>"+oe("done")+" · GL "+(p.gl_row_count||0)+" · VAT "+(p.vat_row_count||0)+"</span>"),xt()}catch(c){console.error("[gl-vat] run failed:",c),e&&(e.className="vex-action-info",e.style.color="#ef4444",e.innerHTML="<span>"+oe("error")+": "+(c.message||c)+"</span>")}finally{W.running=!1,n&&(n.style.display="none"),Zt()}}async function $d(){if(W.currentTaskId)try{const e="/api/recon/gl-vat/"+W.currentTaskId+"/export?lang="+encodeURIComponent(St()),n=await fetch(e,{headers:mt()});if(!n.ok)throw new Error("HTTP "+n.status);const a=await n.blob(),o=document.createElement("a");o.href=URL.createObjectURL(a),o.download="GL_VAT_recon_"+W.currentTaskId+".xlsx",document.body.appendChild(o),o.click(),setTimeout(()=>{URL.revokeObjectURL(o.href),o.remove()},200)}catch(e){console.error("[gl-vat] export failed:",e),typeof showToast=="function"&&showToast(oe("error")+": "+(e.message||e),"error")}}function Hd(){W.running||en(),xt(),W.lastDetail&&W.lastDetail.length&&Wa(W.lastDetail),W.lastSummary&&Ya(W.lastSummary)}function Ad(){if(W.inited){xt();return}W.inited=!0,zo("glv-drop-gl","glv-gl-input","glv-gl-name","glFile"),zo("glv-drop-vat","glv-vat-input","glv-vat-name","vatFile");const e=U("btn-glv-run");e&&e.addEventListener("click",Md);const n=U("btn-glv-export");n&&n.addEventListener("click",$d);const a=U("btn-glv-reset");a&&a.addEventListener("click",_d);const o=U("glv-hist-search");o&&o.addEventListener("input",Bd),Id(),Ka(null),en(),window._loadGlvHistory=xt,xt(),typeof window.subscribeI18n=="function"&&window.subscribeI18n("gl-vat-recon",Hd)}window._glvRemoveFile=xd;window.GlVatRecon={ensureInit:Ad};window._glvPreviewFiles=function(e){return Xe(e==="vat"?"vatFile":"glFile")};const jd=["flowaccount","peak","xero","quickbooks","express"],ei={flowaccount:"FlowAccount",peak:"PEAK",xero:"Xero",quickbooks:"QuickBooks",express:"Express"},Pd=["expense_office","expense_travel","expense_utility","asset_inventory","asset_fixed","liability_ap","revenue_sales","revenue_service","other"],Dd=["vat_7","vat_0","vat_exempt","wht_1","wht_3","wht_5","non_vat"],Rd="468b50c1-5593-4fd6-990d-515ce8085563";let ae={sub:"clients",loaded:{clients:!1,accounts:!1,taxes:!1,products:!1},items:{clients:[],accounts:[],taxes:[],products:[]},clientList:[],clientLoaded:!1,addingNew:{clients:!1,accounts:!1,taxes:!1,products:!1},bound:!1};function cn(){const e=typeof _userInfo<"u"?_userInfo:null;return!!(e&&(e.role==="owner"||e.is_super_admin))}function Fd(){const e=typeof _userInfo<"u"?_userInfo:null;return!!(e&&e.id===Rd)}function T(e){return typeof escapeHtml=="function"?escapeHtml(e==null?"":String(e)):String(e??"")}function it(e,n){try{typeof showToast=="function"&&showToast(e,n||"info")}catch{}}function qd(e){return e==="clients"?'<div class="erp-map-row erp-map-head row-clients"><div>'+T(t("erp-map-col-client"))+"</div><div>"+T(t("erp-map-col-erp"))+"</div><div>"+T(t("erp-map-col-erp-code"))+"</div><div>"+T(t("erp-map-col-notes"))+"</div><div>"+T(t("erp-map-col-actions"))+"</div></div>":e==="accounts"?'<div class="erp-map-row erp-map-head row-accounts"><div>'+T(t("erp-map-col-erp"))+"</div><div>"+T(t("erp-map-col-category"))+"</div><div>"+T(t("erp-map-col-erp-code"))+"</div><div>"+T(t("erp-map-col-erp-name"))+"</div><div>"+T(t("erp-map-col-notes"))+"</div><div>"+T(t("erp-map-col-actions"))+"</div></div>":e==="products"?'<div class="erp-map-row erp-map-head row-products"><div>'+T(t("erp-map-col-item-name"))+"</div><div>"+T(t("erp-map-col-erp-product-code"))+"</div><div>"+T(t("erp-map-col-erp-name"))+"</div><div>"+T(t("erp-map-col-notes"))+"</div><div>"+T(t("erp-map-col-actions"))+"</div></div>":'<div class="erp-map-row erp-map-head row-taxes"><div>'+T(t("erp-map-col-erp"))+"</div><div>"+T(t("erp-map-col-tax"))+"</div><div>"+T(t("erp-map-col-erp-tax-code"))+"</div><div>"+T(t("erp-map-col-notes"))+"</div><div>"+T(t("erp-map-col-actions"))+"</div></div>"}function Xn(e,n){let a='<select class="form-input" data-erp-field="'+n+'">';return a+='<option value="">'+T(t("erp-map-pick-erp"))+"</option>",jd.forEach(function(o){const s=o===e?" selected":"";a+='<option value="'+o+'"'+s+">"+T(ei[o])+"</option>"}),a+="</select>",a}function zd(e){let n='<select class="form-input" data-erp-field="client_id">';return n+='<option value="">'+T(t("erp-map-pick-client"))+"</option>",(ae.clientList||[]).forEach(function(a){const o=String(a.id)===String(e)?" selected":"";n+='<option value="'+a.id+'"'+o+">"+T(a.name||"#"+a.id)+"</option>"}),n+="</select>",n}function Nd(e){let n='<select class="form-input" data-erp-field="pearnly_category">';return n+='<option value="">'+T(t("erp-map-pick-cat"))+"</option>",Pd.forEach(function(a){const o=a===e?" selected":"";n+='<option value="'+a+'"'+o+">"+T(t("erp-map-cat-"+a))+"</option>"}),n+="</select>",n}function Od(e){let n='<select class="form-input" data-erp-field="pearnly_tax_kind">';return n+='<option value="">'+T(t("erp-map-pick-tax"))+"</option>",Dd.forEach(function(a){const o=a===e?" selected":"";n+='<option value="'+a+'"'+o+">"+T(t("erp-map-tax-"+a))+"</option>"}),n+="</select>",n}function Vd(e){const n='<button class="btn btn-primary" type="button" data-erp-save="new" style="padding:6px 12px;height:32px;">'+T(t("erp-map-save"))+"</button>";return e==="clients"?'<div class="erp-map-row erp-map-row-add row-clients" data-erp-row="new"><div data-label="'+T(t("erp-map-col-client"))+'">'+zd("")+'</div><div data-label="'+T(t("erp-map-col-erp"))+'">'+Xn("","erp_type")+'</div><div data-label="'+T(t("erp-map-col-erp-code"))+'"><input type="text" class="form-input" data-erp-field="erp_code" placeholder="'+T(t("erp-map-ph-erp-code"))+'"></div><div data-label="'+T(t("erp-map-col-notes"))+'"><input type="text" class="form-input" data-erp-field="notes" placeholder="'+T(t("erp-map-ph-notes"))+'"></div><div>'+n+"</div></div>":e==="accounts"?'<div class="erp-map-row erp-map-row-add row-accounts" data-erp-row="new"><div data-label="'+T(t("erp-map-col-erp"))+'">'+Xn("","erp_type")+'</div><div data-label="'+T(t("erp-map-col-category"))+'">'+Nd("")+'</div><div data-label="'+T(t("erp-map-col-erp-code"))+'"><input type="text" class="form-input" data-erp-field="erp_code" placeholder="'+T(t("erp-map-ph-acc-code"))+'"></div><div data-label="'+T(t("erp-map-col-erp-name"))+'"><input type="text" class="form-input" data-erp-field="erp_name" placeholder="'+T(t("erp-map-ph-acc-name"))+'"></div><div data-label="'+T(t("erp-map-col-notes"))+'"><input type="text" class="form-input" data-erp-field="notes" placeholder="'+T(t("erp-map-ph-notes"))+'"></div><div>'+n+"</div></div>":'<div class="erp-map-row erp-map-row-add row-taxes" data-erp-row="new"><div data-label="'+T(t("erp-map-col-erp"))+'">'+Xn("","erp_type")+'</div><div data-label="'+T(t("erp-map-col-tax"))+'">'+Od("")+'</div><div data-label="'+T(t("erp-map-col-erp-tax-code"))+'"><input type="text" class="form-input" data-erp-field="erp_code" placeholder="'+T(t("erp-map-ph-tax-code"))+'"></div><div data-label="'+T(t("erp-map-col-notes"))+'"><input type="text" class="form-input" data-erp-field="notes" placeholder="'+T(t("erp-map-ph-notes"))+'"></div><div>'+n+"</div></div>"}function Ud(e,n,a){const o=a?"":'<button class="erp-map-del-btn" type="button" data-erp-del="'+T(n.id)+'" title="'+T(t("erp-map-delete"))+'"><svg width="14" height="14" viewBox="0 0 20 20" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"><path d="M4 6h12M8 6V4h4v2M6 6l1 11h6l1-11"/></svg></button>',s='<span class="erp-map-erp-badge">'+T(ei[n.erp_type]||n.erp_type)+"</span>";if(e==="clients")return'<div class="erp-map-row row-clients"><div data-label="'+T(t("erp-map-col-client"))+'" class="erp-map-cell-name">'+T(n.client_name||"#"+n.client_id)+'</div><div data-label="'+T(t("erp-map-col-erp"))+'">'+s+'</div><div data-label="'+T(t("erp-map-col-erp-code"))+'" class="erp-map-code">'+T(n.erp_code||"")+'</div><div data-label="'+T(t("erp-map-col-notes"))+'">'+T(n.notes||"")+"</div><div>"+o+"</div></div>";if(e==="accounts"){const r=t("erp-map-cat-"+(n.pearnly_category||"other"))||n.pearnly_category;return'<div class="erp-map-row row-accounts"><div data-label="'+T(t("erp-map-col-erp"))+'">'+s+'</div><div data-label="'+T(t("erp-map-col-category"))+'" class="erp-map-cell-name">'+T(r)+'</div><div data-label="'+T(t("erp-map-col-erp-code"))+'" class="erp-map-code">'+T(n.erp_code||"")+'</div><div data-label="'+T(t("erp-map-col-erp-name"))+'">'+T(n.erp_name||"")+'</div><div data-label="'+T(t("erp-map-col-notes"))+'">'+T(n.notes||"")+"</div><div>"+o+"</div></div>"}if(e==="products")return'<div class="erp-map-row row-products"><div data-label="'+T(t("erp-map-col-item-name"))+'" class="erp-map-cell-name">'+T(n.item_name||"")+'</div><div data-label="'+T(t("erp-map-col-erp-product-code"))+'" class="erp-map-code">'+T(n.erp_code||"")+'</div><div data-label="'+T(t("erp-map-col-erp-name"))+'">'+T(n.erp_name||"")+'</div><div data-label="'+T(t("erp-map-col-notes"))+'">'+T(n.notes||"")+"</div><div>"+o+"</div></div>";const i=t("erp-map-tax-"+(n.pearnly_tax_kind||""))||n.pearnly_tax_kind;return'<div class="erp-map-row row-taxes"><div data-label="'+T(t("erp-map-col-erp"))+'">'+s+'</div><div data-label="'+T(t("erp-map-col-tax"))+'" class="erp-map-cell-name"><span class="erp-map-tax-badge">'+T(i)+'</span></div><div data-label="'+T(t("erp-map-col-erp-tax-code"))+'" class="erp-map-code">'+T(n.erp_code||"")+'</div><div data-label="'+T(t("erp-map-col-notes"))+'">'+T(n.notes||"")+"</div><div>"+o+"</div></div>"}(function(){async function e(u,l){const p=localStorage.getItem("mrpilot_token");if(p&&!(ae.loaded[u]&&!l))try{const m=await fetch("/api/erp/mappings/"+u,{headers:{Authorization:"Bearer "+p}});if(!m.ok)throw new Error("http_"+m.status);const v=await m.json();ae.items[u]=v.items||[],ae.loaded[u]=!0}catch{ae.items[u]=[],ae.loaded[u]=!1}}async function n(u){if(ae.clientLoaded)return;const l=localStorage.getItem("mrpilot_token");if(l)try{const p=await fetch("/api/clients?include_inactive=false",{headers:{Authorization:"Bearer "+l}});if(!p.ok)throw new Error("http_"+p.status);const m=await p.json();ae.clientList=(m.clients||m.items||[]).filter(v=>v.is_active!==!1),ae.clientLoaded=!0}catch{ae.clientList=[]}}function a(){const u=document.getElementById("erp-map-pane-wrap");if(!u)return;const l=!cn();let p="";l&&(p+='<div class="erp-map-readonly-banner"><svg width="16" height="16" viewBox="0 0 20 20" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"><circle cx="10" cy="10" r="8"/><path d="M10 6v4M10 13v0.01"/></svg>'+T(t("erp-map-readonly-tip"))+"</div>"),p+='<div class="erp-map-toolbar">',!l&&ae.sub!=="products"&&(p+='<button class="btn btn-primary" type="button" id="erp-map-add-btn" data-i18n="erp-map-add-row">'+T(t("erp-map-add-row"))+"</button>"),p+="</div>",p+='<div class="erp-map-table" id="erp-map-table-host"></div>',u.innerHTML=p,o();const m=document.getElementById("erp-map-dev-bar");m&&(m.style.display=cn()&&Fd()?"":"none")}function o(){const u=document.getElementById("erp-map-table-host");if(!u)return;const l=ae.sub,p=ae.items[l]||[],m=ae.addingNew[l],v=!cn();if(!p.length&&!m){u.innerHTML='<div class="erp-map-empty"><strong>'+T(t("erp-map-empty-"+l))+"</strong>"+T(t("erp-map-empty-"+l+"-sub"))+"</div>";return}let y="";y+=qd(l),m&&!v&&(y+=Vd(l)),p.forEach(function(b){y+=Ud(l,b,v)}),u.innerHTML=y}async function s(u){const l=ae.sub,p={};u.querySelectorAll("[data-erp-field]").forEach(function(b){p[b.dataset.erpField]=(b.value||"").trim()});const m=localStorage.getItem("mrpilot_token");if(!m)return;let v={},y="/api/erp/mappings/"+l;if(l==="clients"){if(!p.client_id||!p.erp_type||!p.erp_code){it(t("erp-map-save-fail"),"error");return}v={client_id:parseInt(p.client_id,10),erp_type:p.erp_type,erp_code:p.erp_code,notes:p.notes||""}}else if(l==="accounts"){if(!p.erp_type||!p.pearnly_category||!p.erp_code){it(t("erp-map-save-fail"),"error");return}v={erp_type:p.erp_type,pearnly_category:p.pearnly_category,erp_code:p.erp_code,erp_name:p.erp_name||"",notes:p.notes||""}}else{if(!p.erp_type||!p.pearnly_tax_kind||!p.erp_code){it(t("erp-map-save-fail"),"error");return}v={erp_type:p.erp_type,pearnly_tax_kind:p.pearnly_tax_kind,erp_code:p.erp_code,notes:p.notes||""}}try{const b=await fetch(y,{method:"POST",headers:{"Content-Type":"application/json",Authorization:"Bearer "+m},body:JSON.stringify(v)});if(!b.ok)throw new Error("http_"+b.status);ae.addingNew[l]=!1,await e(l,!0),o(),it(t("erp-map-saved-toast"),"success")}catch{it(t("erp-map-save-fail"),"error")}}async function i(u){if(!await window.pearnlyConfirm(t("erp-map-confirm-delete")))return;const p=ae.sub,m=localStorage.getItem("mrpilot_token");try{const v=await fetch("/api/erp/mappings/"+p+"/"+encodeURIComponent(u),{method:"DELETE",headers:{Authorization:"Bearer "+m}});if(!v.ok)throw new Error("http_"+v.status);await e(p,!0),o(),it(t("erp-map-deleted-toast"),"success")}catch{it(t("erp-map-delete-fail"),"error")}}async function r(){await n(),await e(ae.sub,!1),a()}function c(u){u!==ae.sub&&(ae.sub=u,ae.addingNew[u]=!1,["clients","accounts","taxes","products"].forEach(function(l){l!==u&&(ae.addingNew[l]=!1)}),document.querySelectorAll(".erp-map-subtab").forEach(function(l){l.classList.toggle("active",l.dataset.erpSubtab===u)}),e(u,!1).then(function(){a()}))}function f(){ae.bound||(ae.bound=!0,document.addEventListener("click",function(u){const l=u.target.closest(".erp-subtab[data-erp-subtab]");if(l){u.preventDefault();const b=l.dataset.erpSubtab;document.querySelectorAll(".erp-subtab").forEach(function(h){h.classList.toggle("active",h.dataset.erpSubtab===b)}),document.querySelectorAll(".erp-subpanel").forEach(function(h){h.classList.toggle("active",h.dataset.erpSubpanel===b)}),b==="mappings"&&setTimeout(r,50);return}const p=u.target.closest(".erp-map-subtab[data-erp-subtab]");if(p){u.preventDefault(),c(p.dataset.erpSubtab);return}if(u.target.closest("#erp-map-add-btn")){if(u.preventDefault(),!cn())return;ae.addingNew[ae.sub]=!0,o();return}const v=u.target.closest('[data-erp-save="new"]');if(v){u.preventDefault();const b=v.closest('[data-erp-row="new"]');b&&s(b);return}const y=u.target.closest("[data-erp-del]");if(y){u.preventDefault(),i(y.dataset.erpDel);return}}))}function d(){const u=document.getElementById("erp-map-pane-wrap");u&&u.children.length>0&&a(),document.querySelectorAll(".erp-map-subtab").forEach(function(l){const p="erp-map-subtab-"+l.dataset.erpSubtab,m=t(p);m&&m!==p&&(l.textContent=m)})}f(),typeof window.subscribeI18n=="function"&&window.subscribeI18n("erp-mappings",d)})();(function(){let e=null,n=0,a=!1;function o(E){return typeof escapeHtml=="function"?escapeHtml(E==null?"":String(E)):String(E??"")}function s(E,I){try{typeof showToast=="function"&&showToast(E,I||"info")}catch{}}async function i(E){const I=Date.now();if(e&&I-n<3e4)return e;const L=localStorage.getItem("mrpilot_token");if(!L)return[];try{const B=await fetch("/api/erp/connectors/status",{headers:{Authorization:"Bearer "+L}});if(!B.ok)return[];const C=await B.json();return e=C&&C.connectors||[],n=I,e}catch{return[]}}function r(){try{return localStorage.getItem("pn_push_default_connector")||""}catch{return""}}function c(E){try{localStorage.setItem("pn_push_default_connector",E||"")}catch{}}function f(E){if(!E||!E.length)return null;const I=r();if(I){const B=E.find(C=>C.id===I);if(B)return B}const L=E.find(B=>B.is_default);return L||E[0]}function d(E){if(!E)return!1;const I=String(E.status||"").toLowerCase();return I==="exception"||I==="exception_pending"||I==="rejected"}function u(){try{return(typeof _results<"u"?_results:[])[typeof _drawerIdx<"u"?_drawerIdx:-1]||null}catch{return null}}function l(E){const I=E&&(E.type||E.id);return I==="xero"?'<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"><circle cx="8" cy="8" r="6"/><path d="M5.5 8l2 2 3-3.5"/></svg>':I==="webhook"?'<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"><circle cx="5" cy="11.5" r="1.8"/><circle cx="11" cy="4.5" r="1.8"/><path d="M6.4 10l3.2-4M5 9.6V5.5a3 3 0 016 0"/></svg>':'<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"><path d="M2 8h9M8 5l3 3-3 3"/><rect x="11" y="3" width="3" height="10" rx="1"/></svg>'}async function p(E,I){if(!E||!I)return!1;const L=document.getElementById("btn-push-default");L&&(L.disabled=!0,L.classList.add("loading"));const B=localStorage.getItem("mrpilot_token");try{let C,S={method:"POST",headers:{Authorization:"Bearer "+B}};E.type==="xero"?C="/api/erp/xero/push/"+encodeURIComponent(I):(C="/api/erp/push",S.headers["Content-Type"]="application/json",S.body=JSON.stringify({history_id:I,endpoint_id:E.endpoint_id||void 0}));const M=await fetch(C,S);let R={};try{R=await M.json()}catch{}if(!M.ok){let V=R&&R.detail||"unknown";typeof V=="object"&&(V=V.code||JSON.stringify(V));let ne=String(V||"unknown");if(E.type==="xero"){const re=ne.replace(/^xero\./,"").toLowerCase(),fe=t("xero-"+re);fe&&fe!=="xero-"+re&&(ne=fe)}return s(t("unified-push-fail").replace("{name}",E.name).replace("{err}",ne),"error"),!1}if(R&&R.ok===!1){let V=R.error_msg||R.error_code||"unknown";return V=String(V).slice(0,200),s(t("unified-push-fail").replace("{name}",E.name).replace("{err}",V),"error"),!1}return s(t("unified-push-ok").replace("{name}",E.name),"success"),!0}catch(C){return s(t("unified-push-fail").replace("{name}",E.name).replace("{err}",C.message||"network"),"error"),!1}finally{L&&(L.disabled=!1,L.classList.remove("loading"))}}async function m(E,I){for(const L of E)await p(L,I)}function v(E,I){const L=document.createElement("div");L.className="pn-push-dropdown",L.id="pn-push-dropdown";const B=(E||[]).map(S=>{const M=!!(I&&S.id===I.id),R=S.method==="download"?t("unified-push-tag-download"):M?t("unified-push-tag-default"):"";return'<div class="pn-pd-item" data-cid="'+o(S.id)+'"><span class="pn-pd-icon">'+l(S)+'</span><span class="pn-pd-name">'+o(S.name)+"</span>"+(R?'<span class="pn-pd-tag">'+o(R)+"</span>":"")+(M?'<span class="pn-pd-check">✓</span>':"")+"</div>"}).join(""),C=E&&E.length>1?'<div class="pn-pd-divider"></div><div class="pn-pd-item pn-pd-all" data-cid="__all__"><span class="pn-pd-icon"><svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"><path d="M3 6h10M3 10h10M3 13.5h6"/></svg></span><span class="pn-pd-name">'+o(t("unified-push-all").replace("{n}",E.length))+"</span></div>":"";return L.innerHTML=B+C,L}function y(){const E=document.getElementById("pn-push-dropdown");E&&E.remove()}async function b(){if(document.getElementById("pn-push-dropdown")){y();return}const E=await i()||[],I=f(E),L=v(E,I),B=document.getElementById("pn-push-wrap");B&&B.appendChild(L)}async function h(){const E=await i()||[],I=f(E);if(!I)return;const L=u(),B=L&&(L._historyId||L.history_id);if(B){if(d(L)){s(t("unified-push-disabled-exc"),"warn");return}await p(I,B)}}async function g(E){y();const I=await i()||[],L=u(),B=L&&(L._historyId||L.history_id);if(!B)return;if(d(L)){s(t("unified-push-disabled-exc"),"warn");return}if(E==="__all__"){await m(I,B);return}const C=I.find(S=>S.id===E);C&&(c(E),await p(C,B),w())}async function _(){const E=document.getElementById("drawer-history-save");if(!E||E.querySelector("#pn-push-wrap"))return;const I=document.createElement("div");I.id="pn-push-wrap",I.className="pn-push-wrap",I.dataset.loading="1",E.insertBefore(I,E.firstChild),["btn-push-erp","btn-xero-push"].forEach(R=>{E.querySelectorAll("#"+R).forEach(V=>{V.style.display="none"})});const L=await i()||[],B=f(L),C=L.length>0;if(!C)I.innerHTML='<button type="button" class="btn btn-ghost pn-push-empty" id="btn-push-default" disabled title="'+o(t("unified-push-empty-tip"))+'"><svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"><path d="M2 8h9M8 5l3 3-3 3"/></svg><span style="margin-left:4px;">'+o(t("unified-push-empty"))+"</span></button>";else{const R=L.length>1;I.innerHTML='<div class="pn-push-split"><button type="button" class="pn-push-main" id="btn-push-default" title="'+o(t("unified-push-tip"))+'">'+l(B)+"<span>"+o(t("unified-push-to").replace("{name}",B?B.name:""))+"</span></button>"+(R?'<button type="button" class="pn-push-arrow" id="btn-push-arrow" title="'+o(t("unified-push-other"))+'"><svg viewBox="0 0 12 12" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M3 5l3 3 3-3"/></svg></button>':"")+"</div>"}delete I.dataset.loading;const S=I.querySelector("#btn-push-default");S&&C&&S.addEventListener("click",h);const M=I.querySelector("#btn-push-arrow");M&&M.addEventListener("click",function(R){R.stopPropagation(),b()}),a||(a=!0,document.addEventListener("click",function(R){const V=R.target.closest(".pn-pd-item");if(V){const ne=V.getAttribute("data-cid");g(ne);return}R.target.closest("#btn-push-arrow")||y()}),typeof window.subscribeI18n=="function"&&window.subscribeI18n("unified-push",w))}function w(){const E=document.getElementById("pn-push-wrap");E&&(E.remove(),e=null,n=0,_())}function k(){const E=document.getElementById("drawer-history-save");if(!E||!E.querySelector("#pn-push-wrap"))return;["btn-push-erp","btn-xero-push"].forEach(L=>{E.querySelectorAll("#"+L).forEach(B=>{B.style.display!=="none"&&(B.style.display="none")})});const I=E.querySelectorAll("#pn-push-wrap");if(I.length>1)for(let L=1;L<I.length;L++)I[L].remove()}function x(){try{const E=function(){return document.getElementById("drawer-body")},I=new MutationObserver(function(){document.getElementById("drawer-history-save")&&!document.getElementById("pn-push-wrap")&&_(),k()}),L=E();if(L)I.observe(L,{childList:!0,subtree:!0});else{const B=new MutationObserver(function(){const C=E();C&&(I.observe(C,{childList:!0,subtree:!0}),B.disconnect())});B.observe(document.body,{childList:!0,subtree:!0})}setTimeout(function(){document.getElementById("drawer-history-save")&&!document.getElementById("pn-push-wrap")&&_(),k()},200)}catch{}}x()})();(function(){function e(){const a=document.getElementById("erp-map-show-advanced-btn");if(!a)return;const o=document.getElementById("erp-map-subtabs");if(!o)return;const s=o.classList.contains("show-advanced"),i=a.querySelector(".erp-map-adv-btn-label");if(i&&typeof t=="function"){const r=s?"erp-map-hide-advanced":"erp-map-show-advanced",c=t(r);c&&c!==r&&(i.textContent=c)}a.setAttribute("aria-pressed",s?"true":"false")}document.addEventListener("click",function(a){if(!a.target.closest("#erp-map-show-advanced-btn"))return;a.preventDefault();const s=document.getElementById("erp-map-subtabs");if(s&&(s.classList.toggle("show-advanced"),e(),!s.classList.contains("show-advanced")&&s.querySelector(".erp-map-subtab.active.erp-map-subtab-advanced"))){const r=s.querySelector('.erp-map-subtab[data-erp-subtab="clients"]');r&&r.click()}});function n(){e()}typeof window.subscribeI18n=="function"&&window.subscribeI18n("erp-map-advanced-toggle",n)})();(function(){const e="pearnly_erp_onboard_shown";let n=!1;function a(){try{return Array.isArray(window._erpEndpoints)&&window._erpEndpoints.length>0}catch{return!1}}function o(){if(document.getElementById("erp-onboard-mask"))return;const i=document.createElement("div");i.id="erp-onboard-mask",i.className="erp-onboard-mask",i.innerHTML='<div class="erp-onboard-modal" role="dialog" aria-modal="true"><div class="erp-onboard-icon"><svg viewBox="0 0 32 32" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><rect x="4" y="6" width="24" height="20" rx="3"/><path d="M9 13h14M9 18h10"/><path d="M22 22l3 3 5-5"/></svg></div><div class="erp-onboard-title" id="erp-onboard-title"></div><div class="erp-onboard-body" id="erp-onboard-body"></div><div class="erp-onboard-btns"><button type="button" class="btn btn-secondary" id="erp-onboard-later"></button><button type="button" class="btn btn-primary" id="erp-onboard-ok"></button></div></div>',document.body.appendChild(i);function r(){const f=document.getElementById("erp-onboard-title"),d=document.getElementById("erp-onboard-body"),u=document.getElementById("erp-onboard-ok"),l=document.getElementById("erp-onboard-later");f&&(f.textContent=t("erp-onboard-title")),d&&(d.textContent=t("erp-onboard-body")),u&&(u.textContent=t("erp-onboard-ok")),l&&(l.textContent=t("erp-onboard-later"))}r();function c(){i.style.display="none"}document.getElementById("erp-onboard-ok").addEventListener("click",function(){try{localStorage.setItem(e,"1")}catch{}c();try{const f=document.querySelector('#btn-add-endpoint, [data-action="erp-add-endpoint"]');f&&f.scrollIntoView({behavior:"smooth",block:"center"})}catch{}}),document.getElementById("erp-onboard-later").addEventListener("click",function(){try{localStorage.setItem(e,"1")}catch{}c()}),i.addEventListener("click",function(f){f.target===i&&c()}),typeof window.subscribeI18n=="function"&&window.subscribeI18n("erp-onboard-modal",function(){i.style.display!=="none"&&r()})}function s(){if(!n){try{if(localStorage.getItem(e)==="1")return}catch{}a()||(n=!0,o(),requestAnimationFrame(function(){requestAnimationFrame(function(){if(a())return;const i=document.getElementById("erp-onboard-mask");i&&(i.style.display="flex")})}))}}document.addEventListener("click",function(i){const r=i.target.closest('.auto-nav-item[data-auto-tab="erp"]'),c=i.target.closest('.erp-subtab[data-erp-subtab="connect"]');(r||c)&&setTimeout(s,700)})})();(function(){const e={parse:{zh:"解析文件中",th:"กำลังอ่านไฟล์",en:"Parsing files",ja:"ファイル解析中"},report:{zh:"读取报告中",th:"กำลังอ่านรายงาน",en:"Reading report",ja:"レポート読込中"},reconcile:{zh:"对账中",th:"กำลังกระทบยอด",en:"Reconciling",ja:"照合中"},build:{zh:"生成中",th:"กำลังสร้างไฟล์",en:"Building",ja:"作成中"},persist:{zh:"保存中",th:"กำลังบันทึก",en:"Saving",ja:"保存中"},done:{zh:"完成",th:"เสร็จสิ้น",en:"Done",ja:"完了"}};window._reconProgressText=function(n,a){n=n||{},a=window._currentLang||a||localStorage.getItem("mrpilot_lang")||"th",e.parse[a]||(a="th");const o=n.stage||"parse",s=e[o]||e.parse,i=s[a]||s.th||s.en,r=n.stage_total,c=n.stage_done;if(o==="parse"&&typeof r=="number"&&r>0){const f={zh:"共 {d}/{t} 个文件",th:"{d}/{t} ไฟล์",en:"{d}/{t} files",ja:"{d}/{t} ファイル"}[a]||"{d}/{t} files";return i+" · "+f.replace("{d}",String(c||0)).replace("{t}",String(r))}return i},window._reconPollJob=async function(n,a,o){o=o||{};const s=o.intervalMs||1500,i=o.maxMs||1200*1e3,r=Date.now();let c=0;for(;;){let f=null;try{const d=await fetch("/api/recon/jobs/"+encodeURIComponent(n),{headers:{Authorization:"Bearer "+a}});try{f=await d.json()}catch{f=null}(!d.ok||!f||!f.ok)&&(f=null)}catch{f=null}if(f){if(c=0,o.onProgress)try{o.onProgress(f.progress||{},f)}catch{}if(f.status==="done"||f.status==="failed"||f.status==="needs_review"||f.status==="needs_mapping")return f}else if(++c>=10)return{ok:!1,status:"failed",error_code:"poll_unreachable"};if(Date.now()-r>i)return{ok:!1,status:"timeout",error_code:"timeout"};await new Promise(d=>setTimeout(d,s))}}})();const j={initialized:!1,stmtFiles:[],glFiles:[],currentTask:null,currentFilter:"all",allRows:[],brv2Search:{stmt:"",gl:""},cachedHistoryTasks:[],brv2Page:1},A=e=>document.getElementById(e);function Ke(e){if(e==null)return"—";const n=Number(e);return isNaN(n)?"—":n.toLocaleString("en-US",{minimumFractionDigits:2,maximumFractionDigits:2})}function No(e){return e?String(e).slice(0,10).split("-").reverse().join("/"):"—"}function ce(e){return String(e||"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}function Gd(e,n){n=window._currentLang||n||"th";const a={stmt_headers_not_found:{zh:"认不出银行账单表头 · 请确认文件含日期/金额/余额列,或转成清晰的 Excel/CSV 重传",th:"หาหัวตารางบัญชีธนาคารไม่เจอ · ตรวจสอบว่ามีคอลัมน์ วันที่/จำนวนเงิน/ยอดคงเหลือ หรือแปลงเป็น Excel/CSV แล้วอัปโหลดใหม่",en:"Cannot detect bank statement headers · ensure the file has date/amount/balance columns, or re-upload as a clean Excel/CSV",ja:"銀行明細のヘッダーを認識できません · 日付/金額/残高列を確認するか、Excel/CSVに変換して再アップロードしてください"},gl_headers_not_found:{zh:"认不出总账表头 · 请确认文件含日期/科目/借方/贷方列,或转成清晰的 Excel/CSV 重传",th:"หาหัวตาราง GL ไม่เจอ · ตรวจสอบว่ามีคอลัมน์ วันที่/บัญชี/เดบิต/เครดิต หรือแปลงเป็น Excel/CSV แล้วอัปโหลดใหม่",en:"Cannot detect GL headers · ensure the file has date/account/debit/credit columns, or re-upload as a clean Excel/CSV",ja:"GLのヘッダーを認識できません · 日付/科目/借方/貸方列を確認するか、Excel/CSVに変換して再アップロードしてください"},stmt_no_rows:{zh:"文件里没有交易数据 · 请确认上传了正确的银行流水,或换更清晰的版本重传",th:"ไม่พบรายการธุรกรรมในไฟล์ · ตรวจสอบว่าอัปโหลด statement ที่ถูกต้อง หรือใช้เวอร์ชันที่ชัดเจนกว่า",en:"No transaction rows found · please upload the correct statement, or try a clearer version",ja:"取引データが見つかりません · 正しい明細をアップロードするか、より鮮明なファイルでお試しください"},no_rows:{zh:"解析后没有可对账的数据行 · 请确认文件内容完整,或换清晰版本重传",th:"ไม่มีแถวข้อมูลให้กระทบยอดหลังการอ่าน · ตรวจสอบความสมบูรณ์ของไฟล์ หรืออัปโหลดใหม่",en:"No reconcilable rows after parsing · check the file is complete, or re-upload a clearer version",ja:"解析後に照合可能な行がありません · ファイルの完全性を確認するか再アップロードしてください"},file_unreadable:{zh:"文件无法读取 · 可能已损坏或被加密 · 请换文件或转 PDF/Excel 重传",th:"อ่านไฟล์ไม่ได้ · อาจเสียหายหรือถูกเข้ารหัส · ลองไฟล์อื่นหรือแปลงเป็น PDF/Excel",en:"File cannot be read · may be corrupted or encrypted · try another file or convert to PDF/Excel",ja:"ファイルを読み取れません · 破損または暗号化の可能性 · 別ファイルまたはPDF/Excelに変換してください"},file_not_supported:{zh:"不支持此文件类型 · 请上传 PDF / 图片 / Excel / CSV",th:"ไม่รองรับไฟล์ประเภทนี้ · กรุณาอัปโหลด PDF / รูปภาพ / Excel / CSV",en:"File type not supported · please upload PDF / image / Excel / CSV",ja:"このファイル形式は非対応 · PDF / 画像 / Excel / CSV をアップロードしてください"},ocr_failed:{zh:"文件识别失败 · 请尝试更清晰的版本,或转成 PDF / Excel / CSV 重传",th:"อ่านไฟล์ไม่ออก · ลองเวอร์ชันที่ชัดเจนกว่า หรือแปลงเป็น PDF / Excel / CSV",en:"Could not read the file · try a clearer version, or convert to PDF / Excel / CSV",ja:"読み取りに失敗 · より鮮明なファイルか、PDF / Excel / CSV に変換して再試行してください"}},o={zh:"解析失败 · 请换更清晰的文件,或转成 Excel / CSV 后重新上传",th:"อ่านไฟล์ไม่สำเร็จ · ลองไฟล์ที่ชัดเจนกว่า หรือแปลงเป็น Excel / CSV แล้วอัปโหลดใหม่",en:"Parsing failed · try a clearer file, or convert to Excel / CSV and re-upload",ja:"解析に失敗しました · より鮮明なファイルか、Excel / CSV に変換して再アップロードしてください"},s=a[e]||o;return s[n]||s.th||s.en}function Kd(e){return e?e<1024?e+" B":e<1048576?(e/1024).toFixed(1)+" KB":(e/1048576).toFixed(1)+" MB":""}function ht(e,n){return window.t&&window.t(e)||n}function Fe(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function Zn(e){const n=Number(e);return Number.isFinite(n)?n.toLocaleString(void 0,{minimumFractionDigits:2,maximumFractionDigits:2}):"—"}var ti="pearnly.brv2.lastAnchorOcr";function Wd(e){try{var n=e&&e._anchor_ocr;if(!n||typeof n!="object")return;var a={stmt_opening:Number.isFinite(+n.stmt_opening)?+n.stmt_opening:null,gl_opening:Number.isFinite(+n.gl_opening)?+n.gl_opening:null,gl_closing:Number.isFinite(+n.gl_closing)?+n.gl_closing:null,stmt_closing:Number.isFinite(+n.stmt_closing)?+n.stmt_closing:null,ts:Date.now()};localStorage.setItem(ti,JSON.stringify(a))}catch{}}function Yd(){try{var e=localStorage.getItem(ti);if(!e)return null;var n=JSON.parse(e);return!n||typeof n!="object"?null:n}catch{return null}}function Jd(){var e=Yd();if(e){var n={"brv2-anchor-stmt-opening":e.stmt_opening,"brv2-anchor-gl-opening":e.gl_opening,"brv2-anchor-gl-closing":e.gl_closing,"brv2-anchor-stmt-closing":e.stmt_closing},a=0;Object.keys(n).forEach(function(c){var f=document.getElementById(c);if(f&&f.value===""){var d=n[c];if(Number.isFinite(d)){f.value=d.toFixed(2);var u=f.closest&&f.closest(".brv2-anchor-cell");u&&u.classList.add("is-prefilled"),a+=1}}});var o=document.getElementById("brv2-anchor-eq"),s=document.getElementById("brv2-anchor-eq-val");if(o&&s&&Number.isFinite(e.stmt_opening)&&Number.isFinite(e.gl_opening)){var i=e.stmt_opening-e.gl_opening;s.textContent=i.toLocaleString(void 0,{minimumFractionDigits:2,maximumFractionDigits:2}),o.style.display=""}if(a>0){var r=document.getElementById("brv2-anchor-prefill-banner");r&&r.classList.add("show")}}}function Xd(){var e=document.getElementById("brv2-anchor-prefill-banner");if(e){var n=!1;["brv2-anchor-gl-closing","brv2-anchor-stmt-closing","brv2-anchor-stmt-opening","brv2-anchor-gl-opening"].forEach(function(a){var o=document.getElementById(a);if(o){var s=o.closest&&o.closest(".brv2-anchor-cell");s&&s.classList.contains("is-prefilled")&&(n=!0)}}),e.classList.toggle("show",n)}}var Zd=[["stmt_opening","brv2-anchor-stmt-opening"],["gl_opening","brv2-anchor-gl-opening"],["gl_closing","brv2-anchor-gl-closing"],["stmt_closing","brv2-anchor-stmt-closing"]];function Qd(e){var n=document.getElementById("brv2-summary-collapse");if(!(!n||!n.parentNode)){var a=document.getElementById("brv2-anchor-audit"),o=e&&e._anchor_overrides;if(!o||typeof o!="object"||Object.keys(o).length===0){a&&a.parentNode&&a.parentNode.removeChild(a);return}a||(a=document.createElement("div"),a.id="brv2-anchor-audit",a.style.cssText="margin-top:14px;background:#fff7ed;border:1px solid #fed7aa;border-radius:8px;padding:14px 16px;",n.parentNode.insertBefore(a,n.nextSibling));var s=Zd.map(function(i){var r=o[i[0]];if(!r)return"";var c=+r.ocr||0,f=+r.user||0,d=f-c,u=d>0?"+":(d<0,""),l=Math.abs(d)<.005?"#6b7280":d>0?"#16a34a":"#dc2626";return'<tr><td style="padding:6px 10px;color:#111827;font-size:13px">'+Fe(ht(i[1],i[0]))+'</td><td style="padding:6px 10px;color:#6b7280;font-size:13px;text-align:right;font-variant-numeric:tabular-nums">'+Fe(Zn(c))+'</td><td style="padding:6px 10px;background:#fef08a;color:#92400e;font-weight:600;font-size:13px;text-align:right;font-variant-numeric:tabular-nums">'+Fe(Zn(f))+'</td><td style="padding:6px 10px;color:'+l+';font-weight:500;font-size:13px;text-align:right;font-variant-numeric:tabular-nums">'+Fe(u+Zn(d))+"</td></tr>"}).join("");a.innerHTML='<div style="font-weight:600;color:#92400e;font-size:13px;margin-bottom:10px">'+Fe(ht("brv2-anchor-audit-title","⚠ This run contains manually entered anchors"))+'</div><table style="width:100%;border-collapse:collapse;font-family:inherit"><thead><tr><th style="padding:6px 10px;text-align:left;color:#6b7280;font-size:11px;font-weight:500;border-bottom:1px solid #fed7aa">'+Fe(ht("brv2-anchor-audit-col-field","Field"))+'</th><th style="padding:6px 10px;text-align:right;color:#6b7280;font-size:11px;font-weight:500;border-bottom:1px solid #fed7aa">'+Fe(ht("brv2-anchor-audit-col-ocr","OCR"))+'</th><th style="padding:6px 10px;text-align:right;color:#6b7280;font-size:11px;font-weight:500;border-bottom:1px solid #fed7aa">'+Fe(ht("brv2-anchor-audit-col-user","User"))+'</th><th style="padding:6px 10px;text-align:right;color:#6b7280;font-size:11px;font-weight:500;border-bottom:1px solid #fed7aa">'+Fe(ht("brv2-anchor-audit-col-diff","Diff"))+"</th></tr></thead><tbody>"+s+"</tbody></table>"}}function Ln(e){const n=A("brv2-summary-collapse"),a=A("brv2-detail-collapse"),o=A("brv2-export-btn"),s=A("brv2-new-btn"),i=A("brv2-parse-info-wrap");n&&(n.style.display=e?"":"none"),a&&(a.style.display=e?"":"none"),o&&(o.style.display=e?"":"none"),s&&(s.style.display=e?"":"none"),!e&&i&&(i.style.display="none");const r=A("brv2-warnings");!e&&r&&(r.style.display="none",r.innerHTML="")}function ep(e){const n=A("brv2-parse-info-wrap"),a=A("brv2-parse-info-body");if(!n||!a)return;const o=e.parse_info;if(!o){n.style.display="none";return}const s=window._currentLang||"zh",i={title:{zh:"文件解析状态",th:"สถานะการอ่านไฟล์",en:"File Parse Status",ja:"ファイル解析状態"},type:{zh:"类型",th:"ประเภท",en:"Type",ja:"種別"},file:{zh:"文件名",th:"ชื่อไฟล์",en:"File",ja:"ファイル"},rows:{zh:"解析行数",th:"แถวที่พบ",en:"Rows Found",ja:"解析行数"},bank:{zh:"银行/科目",th:"ธนาคาร/บัญชี",en:"Bank/Account",ja:"銀行/科目"},status:{zh:"状态",th:"สถานะ",en:"Status",ja:"状態"},stmt:{zh:"账单",th:"บัญชีธนาคาร",en:"Stmt",ja:"明細"},gl:{zh:"总账GL",th:"GL",en:"GL",ja:"GL"},ok:{zh:"✓ 成功",th:"✓ สำเร็จ",en:"✓ OK",ja:"✓ 成功"},warn:{zh:"⚠ 0行",th:"⚠ 0 แถว",en:"⚠ 0 rows",ja:"⚠ 0行"},fail:{zh:"✗ 失败",th:"✗ ล้มเหลว",en:"✗ Failed",ja:"✗ 失敗"}},r=p=>(i[p]||{})[s]||(i[p]||{}).zh||p,c=[...(o.stmt_files||[]).map(p=>({...p,_type:"stmt",_extra:p.bank_code||""})),...(o.gl_files||[]).map(p=>({...p,_type:"gl",_extra:(p.accounts||[]).join(", ")}))],f={stmt_headers_not_found:{zh:"认不出表头列 · 请确认文件含日期/金额/余额列",th:"หาคอลัมน์หัวตารางไม่เจอ · ตรวจสอบไฟล์มีวันที่/จำนวนเงิน/ยอดคงเหลือ",en:"Cannot detect column headers · ensure file has date/amount/balance columns",ja:"列ヘッダーが認識できません · 日付/金額/残高列を確認してください"},stmt_no_rows:{zh:"文件里没有交易数据 · 请确认上传了正确的银行流水",th:"ไม่พบรายการธุรกรรมในไฟล์ · ตรวจสอบว่าอัปโหลด statement ที่ถูกต้อง",en:"No transaction rows found · please check the file",ja:"取引データが見つかりません · ファイルを確認してください"},file_not_supported:{zh:"不支持此文件类型 · 请上传 PDF / 图片 / Excel / CSV",th:"ไม่รองรับไฟล์ประเภทนี้ · กรุณาอัปโหลด PDF / รูปภาพ / Excel / CSV",en:"File type not supported · please upload PDF / image / Excel / CSV",ja:"このファイル形式は非対応 · PDF / 画像 / Excel / CSV をアップロード"},file_unreadable:{zh:"文件无法读取 · 可能已损坏或被加密",th:"อ่านไฟล์ไม่ได้ · อาจเสียหายหรือถูกเข้ารหัส",en:"File cannot be read · may be corrupted or encrypted",ja:"ファイルを読み取れません · 破損または暗号化の可能性"},ocr_failed:{zh:"文件识别失败 · 请尝试更清晰的版本或换 PDF 格式重传",th:"อ่านไฟล์ไม่ออก · ลองเวอร์ชันที่ชัดเจนกว่าหรือเปลี่ยนเป็น PDF",en:"Could not read file · try a clearer version or upload as PDF",ja:"読み取り失敗 · より鮮明なファイルまたは PDF 形式で再試行"},gl_headers_not_found:{zh:"认不出总账表头 · 请确认文件含科目/借方/贷方列",th:"หาหัวคอลัมน์ GL ไม่เจอ · ตรวจสอบมีคอลัมน์บัญชี/เดบิต/เครดิต",en:"Cannot detect GL column headers · ensure account/debit/credit columns exist",ja:"GL 列ヘッダー認識不可 · 科目/借方/貸方列を確認してください"}},d=p=>{const m=String(p||"");return/Cannot detect bank statement column headers/i.test(m)?"stmt_headers_not_found":/Cannot detect GL column headers/i.test(m)?"gl_headers_not_found":/No transaction rows found|no pages parsed/i.test(m)?"stmt_no_rows":/unsupported format/i.test(m)?"file_not_supported":/Cannot read Excel|file_unreadable/i.test(m)?"file_unreadable":/Gemini.*invalid JSON|Gemini.*parsed but failed|validation errors|BankStatementDocument schema|layer2:|layer1:/i.test(m)?"ocr_failed":null},u=p=>{const m=p.error_code||d(p.error);if(m&&f[m]){const v=window._currentLang||"zh";return f[m][v]||f[m].zh}return String(p.error||"").slice(0,80)},l=p=>!p.ok&&p.error?`<span style="color:#dc2626">${r("fail")} — ${ce(u(p))}</span>`:p.rows?`<span style="color:#059669">${r("ok")} (${p.rows})</span>`:`<span style="color:#d97706">${r("warn")}</span>`;a.innerHTML=`
        ...
        <table style="width:100%;border-collapse:collapse;font-size:12px;margin-bottom:4px">
            ...
            <tbody>
                ${c.map(p=>`<tr>
                    ...
                    <td style="padding:5px 8px;border:1px solid #e5e7eb;max-width:220px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap" title="${ce(p.file||"")}">${ce(p.file||"")}</td>
                    <td style="padding:5px 8px;border:1px solid #e5e7eb;text-align:center">${p.rows||0}</td>
                    <td style="padding:5px 8px;border:1px solid #e5e7eb;color:var(--ink-2)">${ce(p._extra||"")}</td>
                    <td style="padding:5px 8px;border:1px solid #e5e7eb">${l(p)}</td>
                </tr>`).join("")}
            </tbody>
        </table>`,n.style.display=""}async function ni(e){const n=localStorage.getItem("mrpilot_token")||"",a=window._currentLang||"zh";try{const o=await fetch("/api/recon/bank-v2/"+e+"/export?lang="+a,{headers:{Authorization:"Bearer "+n}});if(!o.ok){const u=await o.json().catch(()=>({}));window.showToast&&window.showToast(u.detail||"Export failed","error");return}const s=await o.blob(),r=(o.headers.get("content-disposition")||"").match(/filename[^;=\n]*=((['"]).*?\2|[^;\n]*)/),c=r?r[1].replace(/['"]/g,""):"reconciliation.xlsx",f=URL.createObjectURL(s),d=document.createElement("a");d.href=f,d.download=c,document.body.appendChild(d),d.click(),document.body.removeChild(d),URL.revokeObjectURL(f)}catch(o){window.showToast&&window.showToast("Export error: "+o.message,"error")}}function tp(e,n){const a=A("brv2-summary-collapse");let o=A("brv2-warnings");const s=window._currentLang||"zh",i={zh:"⏭ 已跳过无法识别的文件:",th:"⏭ ข้ามไฟล์ที่อ่านไม่ได้:",en:"⏭ Skipped unreadable file:",ja:"⏭ 読み取れないファイルをスキップ:"}[s]||"⏭ ",r=[];if((n||[]).forEach(c=>r.push(i+" "+c)),(e||[]).forEach(c=>r.push(c)),!r.length){o&&(o.style.display="none");return}if(!o)if(o=document.createElement("div"),o.id="brv2-warnings",a&&a.parentNode)a.parentNode.insertBefore(o,a);else return;o.style.cssText="display:block;margin:10px 0;padding:10px 14px;background:#FEF3C7;border:1px solid #FCD34D;border-radius:8px;color:#92400E;font-size:13px;line-height:1.6",o.innerHTML=r.map(c=>"<div>"+ce(c)+"</div>").join("")}function Ja(e){ep(e),tp(e.warnings||[],e.skipped_files||[]),!e.ok&&e.error&&window.showToast&&window.showToast(e.error,"error");const n=e.stats||{},a=e.summary||{},o=n.matched||0,s=(n.gl_debit_only||0)+(n.gl_credit_only||0),i=(n.stmt_withdrawal_only||0)+(n.stmt_deposit_only||0),r=Number(a.formula_diff||0),c=Math.abs(r)<.05;A("brv2-kpi-matched")&&(A("brv2-kpi-matched").textContent=o),A("brv2-kpi-diff")&&(A("brv2-kpi-diff").textContent=Ke(r)),A("brv2-kpi-unmatched")&&(A("brv2-kpi-unmatched").textContent=s+i);const f=A("brv2-kpi-diff-icon");f&&(f.style.background=c?"#d1fae5":"#fee2e2",f.style.color=c?"#065f46":"#b91c1c");const d=A("brv2-formula-sub");if(d){const v=window._currentLang||"zh";d.textContent=c?{zh:"✓ 平衡",th:"✓ สมดุล",en:"✓ Balanced",ja:"✓ 一致"}[v]||"✓ 平衡":({zh:"差 ",th:"ต่าง ",en:"Diff ",ja:"差 "}[v]||"差 ")+Ke(r)}const u=A("brv2-detail-sub");if(u){const v=window._currentLang||"zh",y={zh:"共 {n} 行",th:"ทั้งหมด {n} แถว",en:"{n} rows",ja:"計 {n} 行"}[v]||"共 {n} 行";u.textContent=y.replace("{n}",j.allRows.length)}function l(v,y,b){const h=A(v);h&&(h.textContent=(b&&y>0?"(":"")+Ke(b?-y:y)+(b&&y>0?")":""))}l("brf-gl-close",a.gl_closing||0),l("brf-open-diff",a.opening_diff||0),l("brf-gl-debit-only",a.gl_debit_only_amount||0,!0),l("brf-gl-credit-only",a.gl_credit_only_amount||0),l("brf-stmt-wd-only",a.stmt_withdrawal_only_amount||0,!0),l("brf-stmt-dep-only",a.stmt_deposit_only_amount||0),l("brf-calc-close",a.formula_stmt_closing||0),l("brf-stmt-close",a.stmt_closing||0),A("brf-diff")&&(A("brf-diff").textContent=Ke(r));const p=A("brv2-fcell-diff");p&&p.classList.toggle("brv2-fcell-diff-ok",c);const m=A("brv2-export-btn");m&&(m.onclick=()=>{j.currentTask&&ni(j.currentTask.task_id)}),Qd(a),Ln(!0),ai()}function ai(){const e=A("brv2-tbody");if(!e)return;const n=j.allRows.filter(i=>j.currentFilter==="all"?!0:j.currentFilter==="matched"?i.match_status==="matched":j.currentFilter==="gl_only"?i.match_status.startsWith("gl_"):j.currentFilter==="stmt_only"?i.match_status.startsWith("stmt_"):!0);if(n.length===0){const i={zh:"无记录",th:"ไม่มีรายการ",en:"No rows",ja:"行なし"}[window._currentLang||"zh"]||"无记录";e.innerHTML=`<tr><td colspan="10" style="text-align:center;padding:20px;color:var(--ink-3)">${i}</td></tr>`;return}const a=window._currentLang||"zh",o={zh:"OCR 余额验证未通过 · 上一行余额 ± 金额 ≠ 本行余额，请核对原 PDF",th:"การตรวจสอบยอดคงเหลือไม่ผ่าน · ยอดก่อนหน้า ± จำนวน ≠ ยอดบรรทัดนี้ โปรดตรวจสอบ PDF ต้นฉบับ",en:"Balance check FAILED · prev_balance ± amount ≠ this row balance — verify against the original PDF",ja:"残高検証エラー · 前残高 ± 金額 ≠ この行残高 — 元のPDFと照合してください"}[a],s={zh:"OCR 低置信度 · 数字模糊或难以辨认，请核对原 PDF",th:"OCR ความมั่นใจต่ำ · ตัวเลขเบลอหรืออ่านยาก โปรดตรวจสอบ PDF ต้นฉบับ",en:"OCR low confidence · digit was blurry or hard to read — verify against the original PDF",ja:"OCR信頼度低 · 数字がぼやけている — 元のPDFと照合してください"}[a];e.innerHTML=n.map(i=>{const r=i.match_status,c=i.match_layer;let f="",d="";r==="matched"?(c===1&&(f="matched",d='<span class="brv2-status-badge brv2-badge-matched">L1 ✓</span>'),c===2&&(f="matched-l2",d='<span class="brv2-status-badge brv2-badge-matched-l2">L2 ~</span>'),c===3&&(f="matched-l3",d='<span class="brv2-status-badge brv2-badge-matched-l3">L3 ?</span>')):r==="gl_debit_only"||r==="gl_credit_only"?(f="gl-only",d='<span class="brv2-status-badge brv2-badge-gl-only">GL</span>'):(f="stmt-only",d=`<span class="brv2-status-badge brv2-badge-stmt-only">${{zh:"账单",th:"บัญชี",en:"Stmt",ja:"明細"}[a]||"账单"}</span>`);let u="";return i.stmt_balance_ok===!1&&(u+=`<span class="brv2-ocr-warn brv2-ocr-warn-bal" title="${ce(o)}">⚠</span>`,f+=" brv2-row-warn"),i.stmt_confidence==="low"&&(u+=`<span class="brv2-ocr-warn brv2-ocr-warn-conf" title="${ce(s)}">◌</span>`,f.includes("brv2-row-warn")||(f+=" brv2-row-warn-soft")),`<tr class="${f.trim()}">
          <td>${d}${u}</td>
          <td>${ce(No(i.stmt_date))}</td>
          <td title="${ce(i.stmt_desc)}" style="max-width:180px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap">${ce(i.stmt_desc)}</td>
          <td class="num">${i.stmt_withdrawal?Ke(i.stmt_withdrawal):""}</td>
          <td class="num">${i.stmt_deposit?Ke(i.stmt_deposit):""}</td>
          <td>${ce(No(i.gl_date))}</td>
          <td title="${ce(i.gl_doc_no)}" style="max-width:120px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap">${ce(i.gl_doc_no)}</td>
          <td class="num">${i.gl_debit?Ke(i.gl_debit):""}</td>
          <td class="num">${i.gl_credit?Ke(i.gl_credit):""}</td>
          <td>${c?"L"+c:"—"}</td>
        </tr>`}).join("")}async function Kt(){const e=localStorage.getItem("mrpilot_token")||"";try{const a=await(await fetch("/api/recon/bank-v2/tasks",{headers:{Authorization:"Bearer "+e}})).json();Bn(a.tasks||[])}catch{const a=A("brv2-history-empty"),o=window._currentLang||"zh",s={zh:"加载失败",th:"โหลดประวัติไม่ได้",en:"Load failed",ja:"読み込み失敗"}[o]||"加载失败";a&&(a.textContent=s,a.style.display="");const i=A("brv2-history-table-wrap");i&&(i.style.display="none")}}const _t=10;function Oo(){const e=A("brv2-history-pager"),n=A("brv2-history-pager-info"),a=A("brv2-history-prev"),o=A("brv2-history-next");if(!e)return;if(j.cachedHistoryTasks.length<=_t){e.style.display="none";return}e.style.display="";const s=Math.ceil(j.cachedHistoryTasks.length/_t);n&&(n.textContent=j.brv2Page+" / "+s),a&&(a.disabled=j.brv2Page<=1),o&&(o.disabled=j.brv2Page>=s)}function np(){const e=A("brv2-history-prev"),n=A("brv2-history-next");e&&!e._brv2Bound&&(e._brv2Bound=!0,e.addEventListener("click",()=>{j.brv2Page>1&&(j.brv2Page--,Bn(j.cachedHistoryTasks))})),n&&!n._brv2Bound&&(n._brv2Bound=!0,n.addEventListener("click",()=>{const a=Math.ceil(j.cachedHistoryTasks.length/_t);j.brv2Page<a&&(j.brv2Page++,Bn(j.cachedHistoryTasks))}))}function Bn(e){e!==void 0&&(j.cachedHistoryTasks=e||[],j.brv2Page=1);const n=j.cachedHistoryTasks,a=A("brv2-history-empty"),o=A("brv2-history-table-wrap"),s=A("brv2-history-tbody");if(!s)return;const i=window._currentLang||"zh";if(!n.length){const m={zh:"暂无对账记录",th:"ยังไม่มีประวัติ",en:"No records yet",ja:"記録なし"}[i]||"暂无对账记录";a&&(a.textContent=m,a.style.display=""),o&&(o.style.display="none"),Oo();return}a&&(a.style.display="none"),o&&(o.style.display="");const r=Math.ceil(n.length/_t);j.brv2Page>r&&(j.brv2Page=r);const c=(j.brv2Page-1)*_t,f=n.slice(c,c+_t),d=localStorage.getItem("mrpilot_token")||"",u='<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" width="14" height="14"><circle cx="8" cy="8" r="6"/><polyline points="6 8 8 10 10 8"/><line x1="8" y1="4" x2="8" y2="10"/></svg>',l='<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" width="14" height="14"><path d="M8 2v9M4 7l4 4 4-4M3 14h10"/></svg>',p='<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" width="14" height="14"><polyline points="3 4 13 4"/><path d="M6 4V2.5a.5.5 0 0 1 .5-.5h3a.5.5 0 0 1 .5.5V4"/><path d="M5 4l1 9a1 1 0 0 0 1 1h2a1 1 0 0 0 1-1l1-9"/></svg>';s.innerHTML="",f.forEach(m=>{const v=Number(m.formula_diff||0),y=Math.abs(v)<.05,b=(m.stmt_files||"").split(";").map(re=>re.trim().split(/[/\\]/).pop()).filter(Boolean).join(", "),h=(m.gl_files||"").split(";").map(re=>re.trim().split(/[/\\]/).pop()).filter(Boolean).join(", "),g=m.created_at?String(m.created_at).slice(0,16).replace("T"," "):"",_=document.createElement("tr");_.dataset.taskId=m.id;const w=document.createElement("td");w.textContent=g;const k=document.createElement("td");k.className="glv-history-file",k.title=b+" + "+h,k.textContent=b+" + "+h;const x=document.createElement("td");x.className="glv-num",x.textContent=(m.stmt_row_count||0)+" / "+(m.gl_row_count||0);const E=document.createElement("td");E.className="glv-num",E.textContent=m.matched_count||0;const I=document.createElement("td");I.className="glv-num",I.textContent=m.unmatched_gl||0;const L=document.createElement("td");L.className="glv-num",L.textContent=m.unmatched_stmt||0;const B=document.createElement("td");B.className="glv-num",B.style.color=y?"#059669":"#dc2626",B.textContent=y?"✓":Ke(v);const C=document.createElement("td");C.className="glv-history-actions";const S=(re,fe,ue,N)=>{const z=document.createElement("button");return z.type="button",z.title=fe,z.setAttribute("aria-label",fe),ue&&(z.className=ue),z.innerHTML=re,z.onclick=K=>{K.stopPropagation(),N()},z},M={zh:"删除这条记录?",th:"ลบรายการนี้?",en:"Delete this record?",ja:"この記録を削除しますか?"}[i]||"删除?",R={zh:"加载",th:"โหลด",en:"Load",ja:"読込"}[i]||"加载",V={zh:"导出",th:"ส่งออก",en:"Export",ja:"エクスポート"}[i]||"导出",ne={zh:"删除",th:"ลบ",en:"Delete",ja:"削除"}[i]||"删除";C.appendChild(S(u,R,"",()=>Vo(m.id,d))),C.appendChild(S(l,V,"",()=>ni(m.id))),C.appendChild(S(p,ne,"glv-del",async()=>{await showConfirm(M,{danger:!0})&&(await fetch("/api/recon/bank-v2/"+m.id,{method:"DELETE",headers:{Authorization:"Bearer "+d}}),Kt())})),[w,k,x,E,I,L,B,C].forEach(re=>_.appendChild(re)),_.style.cursor="pointer",_.addEventListener("click",async re=>{re.target.closest(".glv-del")||re.target.closest("button")||await Vo(m.id,d)}),s.appendChild(_)}),Oo(),oi()}function oi(){const e=((A("brv2-hist-search")||{}).value||"").trim().toLowerCase(),n=A("brv2-history-tbody");n&&n.querySelectorAll("tr").forEach(a=>{a.dataset.taskId&&(a.style.display=!e||a.textContent.toLowerCase().includes(e)?"":"none")})}async function Vo(e,n){try{const o=await(await fetch("/api/recon/bank-v2/"+e,{headers:{Authorization:"Bearer "+n}})).json();if(!o.ok)return;j.currentTask={task_id:o.task_id,...o},j.allRows=o.detail||[],j.currentFilter="all",document.querySelectorAll(".brv2-filter-btn").forEach(s=>s.classList.toggle("active",s.dataset.filter==="all")),Ja(j.currentTask)}catch{}}function Ae(e){const n=e==="stmt"?j.stmtFiles:j.glFiles,a=A(`brv2-${e}-name`);if(a)if(n.length===0)a.textContent="";else{const s=window._currentLang||"zh",i={zh:"个文件",th:" ไฟล์",en:" file(s)",ja:" ファイル"};a.textContent=n.length+(i[s]||" 个文件")}const o=A("brv2-preview-panel");o&&o.style.display!=="none"&&ma(e),ap()}function ap(){const e=A("brv2-toggle-preview"),n=A("brv2-preview-panel"),a=j.stmtFiles.length+j.glFiles.length>0;e&&(e.style.display=a?"":"none"),!a&&n&&(n.style.display="none",e&&e.classList.remove("open"))}function op(){ma("stmt"),ma("gl")}function ma(e){const n=A(e==="stmt"?"brv2-pp-stmt-col":"brv2-pp-gl-col");if(!n)return;const a=e==="stmt"?j.stmtFiles:j.glFiles,o=window._currentLang||"zh",s={stmt:{zh:"① 银行账单",th:"① บัญชีธนาคาร",en:"① Bank Stmt",ja:"① 銀行明細"},gl:{zh:"② 总账 GL",th:"② GL รายงาน",en:"② GL Report",ja:"② GL帳簿"}},i=(s[e]||{})[o]||s[e].zh,r=ce(window.t&&window.t("vex-preview-search")||"搜索文件名..."),c=ce(window.t&&window.t("vex-preview-clear-all")||"全清"),f=j.brv2Search[e]||"";n.innerHTML='<div class="vex-pp-col-title"><span class="vex-pp-col-name">'+ce(i)+' <span class="vex-pp-col-count">'+a.length+'</span></span></div><div class="vex-pp-search-row"><input class="vex-pp-search" id="brv2-pp-search-'+e+'" type="text" placeholder="'+r+'" value="'+ce(f)+'" autocomplete="off"><button class="vex-pp-clear-btn" id="brv2-pp-clearall-'+e+'" type="button">'+c+'</button></div><div class="vex-pp-file-list" id="brv2-pp-'+e+'-list"></div><div class="vex-pp-pagination" id="brv2-pp-'+e+'-pg"></div>';const d=A("brv2-pp-search-"+e);d&&d.addEventListener("input",function(l){j.brv2Search[e]=l.target.value,Uo(e)});const u=A("brv2-pp-clearall-"+e);u&&u.addEventListener("click",function(){e==="stmt"?j.stmtFiles.length=0:j.glFiles.length=0,Ae(e),We()}),Uo(e)}function Uo(e){const n=A("brv2-pp-"+e+"-list"),a=A("brv2-pp-"+e+"-pg");if(!n)return;const o=e==="stmt"?j.stmtFiles:j.glFiles,s=(j.brv2Search[e]||"").toLowerCase(),i=s?o.filter(f=>f.name.toLowerCase().includes(s)):o.slice(),r='<svg class="vex-pp-fi-ico" viewBox="0 0 14 16" fill="none" stroke="currentColor" stroke-width="1.4" width="12" height="14"><path d="M3 1h6l3 3v11H3V1z"/><path d="M9 1v3h3"/></svg>',c='<svg viewBox="0 0 14 14" fill="none" stroke="currentColor" stroke-width="1.6" width="11" height="11"><path d="M2 4h10M5 4V2h4v2M5.5 7v4M8.5 7v4M3 4l1 8h6l1-8"/></svg>';if(n.innerHTML=i.map((f,d)=>'<div class="vex-pp-file-row">'+r+'<span class="vex-pp-fi-name" title="'+ce(f.name)+'">'+ce(f.name)+'</span><span class="vex-pp-fi-size">'+Kd(f.size)+'</span><button class="vex-pp-fi-del" type="button" data-zone="'+e+'" data-idx="'+o.indexOf(f)+'" aria-label="remove">'+c+"</button></div>").join(""),n.querySelectorAll(".vex-pp-fi-del").forEach(function(f){f.addEventListener("click",function(){const d=parseInt(f.dataset.idx,10);f.dataset.zone==="stmt"?j.stmtFiles.splice(d,1):j.glFiles.splice(d,1),Ae(f.dataset.zone),We()})}),a){const f=window.t&&window.t("vex-preview-count")||"显示 {n} / 共 {m}";a.textContent=f.replace("{n}",i.length).replace("{m}",o.length)}}function sp(){const e=A("brv2-toggle-preview");e&&!e._reconBound&&(e._reconBound=!0,e.addEventListener("click",function(){const n=A("brv2-preview-panel"),a=A("brv2-toggle-preview-label"),o=n&&n.style.display!=="none";n&&(n.style.display=o?"none":""),e.classList.toggle("open",!o),a&&(a.textContent=o?window.t&&window.t("vex-toggle-preview-open")||"查看清单":window.t&&window.t("vex-toggle-preview-close")||"收起清单"),o||op()}))}function We(){const e=A("brv2-run-btn"),n=A("brv2-status"),a=j.stmtFiles.length>0,o=j.glFiles.length>0;if(e&&(e.disabled=!(a&&o)),n){const s=window._currentLang||"zh";if(!a&&!o){const i={zh:"请上传银行账单和 GL 文件",th:"กรุณาอัปโหลดบัญชีธนาคารและ GL",en:"Upload bank statement and GL files",ja:"銀行明細と GL を両方アップロードしてください"};n.textContent=i[s]||i.zh}else if(a)if(o){const i={zh:"两份文件已就绪",th:"พร้อมสอบทาน",en:"Ready to reconcile",ja:"照合を開始できます"};n.textContent=i[s]||i.zh}else{const i={zh:"还缺 GL 文件",th:"ยังขาดไฟล์ GL",en:"Missing GL file",ja:"GL ファイルが未アップロード"};n.textContent=i[s]||i.zh}else{const i={zh:"还缺银行账单 PDF",th:"ยังขาดไฟล์บัญชีธนาคาร PDF",en:"Missing bank statement PDF",ja:"銀行明細 PDF が未アップロード"};n.textContent=i[s]||i.zh}}}function Go(e,n,a){const o=A(e),s=A(n);!o||!s||(o.addEventListener("click",()=>s.click()),o.addEventListener("keydown",i=>{(i.key==="Enter"||i.key===" ")&&(i.preventDefault(),s.click())}),o.addEventListener("dragover",i=>{i.preventDefault(),o.classList.add("drag-over")}),o.addEventListener("dragleave",()=>o.classList.remove("drag-over")),o.addEventListener("drop",i=>{i.preventDefault(),o.classList.remove("drag-over");const r=Array.from(i.dataTransfer.files||[]);a==="stmt"?j.stmtFiles.push(...r):j.glFiles.push(...r),Ae(a),We()}),s.addEventListener("change",()=>{const i=Array.from(s.files||[]);a==="stmt"?j.stmtFiles.push(...i):j.glFiles.push(...i),s.value="",Ae(a),We()}))}function xe(e){const n=A("brv2-progress"),a=A("brv2-run-btn"),o=A("brv2-error");n&&(n.style.display=e?"":"none"),a&&(a.disabled=e),o&&(o.style.display="none")}function He(e){const n=A("brv2-error");n&&(n.textContent=e,n.style.display="",n.scrollIntoView({behavior:"smooth",block:"nearest"})),xe(!1),We(),window.showToast&&window.showToast(e,"error")}async function va(){if(j.stmtFiles.length===0||j.glFiles.length===0)return;const e=localStorage.getItem("mrpilot_token")||"",n=window._currentLang||"zh",a=(A("brv2-acct-select")||{}).value||"";Ln(!1),xe(!0);try{const o=new FormData;j.stmtFiles.forEach(m=>o.append("stmt_files",m)),j.glFiles.forEach(m=>o.append("gl_files",m)),o.append("gl_account",a),o.append("lang",n);const s=parseFloat((A("brv2-anchor-gl-closing")||{}).value),i=parseFloat((A("brv2-anchor-stmt-closing")||{}).value),r=parseFloat((A("brv2-anchor-stmt-opening")||{}).value),c=parseFloat((A("brv2-anchor-gl-opening")||{}).value);Number.isFinite(s)&&o.append("gl_closing_override",s),Number.isFinite(i)&&o.append("stmt_closing_override",i),Number.isFinite(r)&&o.append("stmt_opening_override",r),Number.isFinite(c)&&o.append("gl_opening_override",c);const f=await fetch("/api/recon/bank-v2/submit",{method:"POST",headers:{Authorization:"Bearer "+e},body:o});let d=null;try{d=await f.json()}catch{d=null}if(d&&d.needs_mapping){xe(!1),window.ReconMapping?window.ReconMapping.show(d,{token:e,lang:n,onConfirmed:function(){va()}}):He(t("brv2-err-server")||"服务器繁忙,请稍后重试");return}if(!f.ok||!d||!d.ok||!d.job_id){xe(!1),d&&(d.detail||d.error)?He(_humanizeBackendError(d.detail||d.error,"Error "+f.status)):He(t("brv2-err-server")||"服务器繁忙,请稍后重试");return}const u=A("brv2-progress-sub"),l=await window._reconPollJob(d.job_id,e,{onProgress:m=>{u&&(u.textContent=window._reconProgressText(m,n))}});if(l&&l.status==="needs_mapping"&&l.mapping){xe(!1),window.ReconMapping?window.ReconMapping.show(l.mapping,{token:e,lang:n,onConfirmed:function(){va()}}):He(t("brv2-err-server")||"服务器繁忙,请稍后重试");return}if(l&&l.status==="needs_review"&&l.review){xe(!1),window.ReconReview?window.ReconReview.show(l.review,{token:e,lang:n,jobId:d.job_id,onConfirmed:async function(m){xe(!0);const v=await window._reconPollJob(m,e,{onProgress:y=>{u&&(u.textContent=window._reconProgressText(y,n))}});await p(v)}}):He(t("brv2-err-server")||"服务器繁忙,请稍后重试");return}if(l&&l.status==="failed"){xe(!1),He(Gd(l.error_code,n));return}await p(l);async function p(m){try{if(!m||m.status!=="done"||!m.result_id){xe(!1),He(t("brv2-err-server")||"服务器繁忙,请稍后重试");return}const v=await fetch("/api/recon/bank-v2/"+encodeURIComponent(m.result_id),{headers:{Authorization:"Bearer "+e}});let y=null;try{y=await v.json()}catch{y=null}if(!v.ok||y===null||!y.ok){xe(!1),He(t("brv2-err-server")||"服务器繁忙,请稍后重试");return}(y.gl_accounts||[]).length>1&&ip(y.gl_accounts),j.currentTask=y,j.allRows=y.detail||[],j.currentFilter="all",document.querySelectorAll(".brv2-filter-btn").forEach(h=>h.classList.toggle("active",h.dataset.filter==="all")),Wd(y&&y.summary),xe(!1),Ja(y),Kt();const b=A("brv2-summary-collapse");b&&b.scrollIntoView({behavior:"smooth",block:"nearest"})}catch(v){xe(!1),He(v.message||"Network error")}}}catch(o){He(o.message||"Network error")}}function ip(e){const n=A("brv2-acct-select");if(!n)return;const a=window._currentLang||"zh",o={zh:"全部账户",th:"ทุกบัญชี",en:"All Accounts",ja:"すべての口座"}[a]||"全部账户";n.innerHTML=`<option value="">${o}</option>`+e.map(s=>`<option value="${ce(s)}">${ce(s)}</option>`).join(""),n.style.display=""}function Xa(){if(j.initialized){Kt();return}j.initialized=!0,Go("brv2-stmt-zone","brv2-stmt-input","stmt"),Go("brv2-gl-zone","brv2-gl-input","gl");const e=["brv2-anchor-gl-closing","brv2-anchor-stmt-closing","brv2-anchor-stmt-opening","brv2-anchor-gl-opening"];function n(){const c=parseFloat((A("brv2-anchor-stmt-opening")||{}).value),f=parseFloat((A("brv2-anchor-gl-opening")||{}).value),d=A("brv2-anchor-eq"),u=A("brv2-anchor-eq-val");if(!(!d||!u))if(Number.isFinite(c)&&Number.isFinite(f)){const l=c-f;u.textContent=l.toLocaleString(void 0,{minimumFractionDigits:2,maximumFractionDigits:2}),d.style.display=""}else d.style.display="none"}e.forEach(c=>{const f=A(c);f&&(f.addEventListener("input",n),f.addEventListener("input",()=>{const d=f.closest(".brv2-anchor-cell");d&&d.classList.remove("is-prefilled"),Xd()}))}),Jd();const a=A("brv2-run-btn");a&&a.addEventListener("click",va);const o=A("brv2-reset-btn");o&&o.addEventListener("click",()=>{j.currentTask=null,j.allRows=[],j.stmtFiles=[],j.glFiles=[],Ae("stmt"),Ae("gl"),We(),Ln(!1);const c=A("brv2-acct-select");c&&(c.style.display="none"),e.forEach(u=>{const l=A(u);if(l){l.value="";const p=l.closest&&l.closest(".brv2-anchor-cell");p&&p.classList.remove("is-prefilled")}});const f=A("brv2-anchor-eq");f&&(f.style.display="none");const d=A("brv2-anchor-prefill-banner");d&&d.classList.remove("show")});const s=A("brv2-new-btn");s&&s.addEventListener("click",()=>{j.currentTask=null,j.allRows=[],j.stmtFiles=[],j.glFiles=[],Ae("stmt"),Ae("gl"),We(),Ln(!1)});const i=A("brv2-filter-tabs");i&&i.addEventListener("click",c=>{c.stopPropagation();const f=c.target.closest(".brv2-filter-btn");f&&(j.currentFilter=f.dataset.filter,i.querySelectorAll(".brv2-filter-btn").forEach(d=>d.classList.toggle("active",d===f)),ai())}),sp(),np();const r=A("brv2-hist-search");r&&r.addEventListener("input",oi),Kt(),We(),window._brv2LoadHistory=Kt,Array.isArray(window.__i18nSubs)||(window.__i18nSubs=[]),window.__i18nSubs=window.__i18nSubs.filter(c=>c.name!=="brv2"),window.__i18nSubs.push({name:"brv2",fn:function(){We(),Ae("stmt"),Ae("gl"),j.currentTask&&Ja(j.currentTask),Bn()}})}window._loadBankReconV2Panel=function(e){const n=e?document.getElementById(e):null;n&&n.id!=="recon-pane-bank"&&(n.innerHTML=`<div style="padding:16px;font-size:13px;color:var(--ink-3)">
            银行对账 v2 · 请前往对账中心使用</div>`),Xa()};document.addEventListener("DOMContentLoaded",()=>{A("brv2-run-btn")&&Xa()});window._bankReconV2Init=Xa;(function(){const e=document.getElementById("general-lang");if(!e)return;e.addEventListener("change",a=>{const o=a.target.value;o&&applyLang(o)});const n=typeof currentLang=="string"&&currentLang||localStorage.getItem("mrpilot_lang")||"th";e.value=n})();(function(){const n="pearnly_general_tz",a="pearnly_general_date_format",o="pearnly_general_number_format",s={tz:"Asia/Bangkok",date:"YYYY-MM-DD",number:"comma_dot"};function i(){const d=document.getElementById("general-tz"),u=document.getElementById("general-date"),l=document.getElementById("general-number");if(!(!d||!u||!l))try{d.value=localStorage.getItem(n)||s.tz,u.value=localStorage.getItem(a)||s.date,l.value=localStorage.getItem(o)||s.number}catch{d.value=s.tz,u.value=s.date,l.value=s.number}}async function r(){const d=document.getElementById("btn-save-general"),u=document.getElementById("general-save-msg");if(!d)return;const l=d.innerHTML;d.disabled=!0,d.innerHTML="<span>"+(t("msg-saving")||"保存中...")+"</span>",u&&(u.textContent="",u.classList.remove("error"));try{const p=(document.getElementById("general-tz")||{}).value||s.tz,m=(document.getElementById("general-date")||{}).value||s.date,v=(document.getElementById("general-number")||{}).value||s.number;try{localStorage.setItem(n,p),localStorage.setItem(a,m),localStorage.setItem(o,v)}catch{}window._pearnlyGeneral={tz:p,date_format:m,number_format:v},u&&(u.textContent=t("msg-saved")||"已保存")}catch{u&&(u.textContent=t("msg-save-failed")||"保存失败",u.classList.add("error"))}finally{d.disabled=!1,d.innerHTML=l,setTimeout(function(){u&&(u.textContent="")},3e3)}}function c(){const d=document.getElementById("btn-save-general");if(!d){setTimeout(c,200);return}d._pearnlyGenBound||(d._pearnlyGenBound=!0,d.addEventListener("click",r),i())}function f(){i();const d=document.getElementById("general-lang");if(d){const u=typeof currentLang=="string"&&currentLang||localStorage.getItem("mrpilot_lang")||"th";d.value=u}}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",c):c(),typeof window.subscribeI18n=="function"&&window.subscribeI18n("settings-general",f)})();(function(){const e="mrpilot_nav_collapsed",n={ocr:"sales",history:"sales",reconcile:"sales","sales-invoices":"sales",receivables:"sales",vouchers:"expense"};function a(){try{const r=localStorage.getItem(e);return r?JSON.parse(r):{}}catch{return{}}}function o(r){try{localStorage.setItem(e,JSON.stringify(r))}catch{}}function s(){const r=a();document.querySelectorAll(".nav-collapsible").forEach(function(c){const f=c.dataset.collapsible;r[f]?c.classList.add("collapsed"):c.classList.remove("collapsed")})}function i(r){const c=a();c[r]=!c[r],o(c),s()}(function(){const c=a();let f=!1;c.sales===void 0&&(c.sales=!1,f=!0),c.expense===void 0&&(c.expense=!0,f=!0),f&&o(c)})(),s(),document.querySelectorAll(".nav-group-toggle").forEach(function(r){r.addEventListener("click",function(){i(r.dataset.toggleGroup)})}),window.expandNavGroupForRoute=function(r){const c=n[r];if(!c)return;const f=a();f[c]&&(f[c]=!1,o(f),s())}})();const rp=`
    <div class="modal" style="max-width:440px">
    ...
    </div>`;function Ko(){const e=document.getElementById("help-modal");if(!e||e.children.length)return;e.innerHTML=rp;const n=window._currentLang||"th",a=window.I18N&&window.I18N[n]||{};e.querySelectorAll("[data-i18n]").forEach(o=>{const s=o.getAttribute("data-i18n");s&&a[s]&&(o.textContent=a[s])})}document.readyState,Ko();(function(){function e(){const n=document.getElementById("help-modal"),a=document.getElementById("help-modal-close");n&&(a&&!a.dataset.bound&&(a.addEventListener("click",function(){n.style.display="none"}),a.dataset.bound="1"),n.dataset.maskBound||(n.addEventListener("click",function(o){o.target===n&&(n.style.display="none")}),n.dataset.maskBound="1"),window._helpModalEscBound||(document.addEventListener("keydown",function(o){o.key==="Escape"&&n.style.display==="flex"&&(n.style.display="none")}),window._helpModalEscBound=!0))}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",e):e()})();(function(){const e={line:"line",folder:"folder",gmail:"email",erp:"erp",alert:"alert"};document.addEventListener("click",function(n){const a=n.target.closest(".int-btn-configure");if(!a)return;const o=a.closest(".integration-row"),s=o?o.dataset.intAnchor:null;if(s&&e[s]){const i=o.querySelector(".int-name"),r=i?(i.textContent||i.innerText||"").trim():"配置";typeof window.openIntegrationDrawer=="function"&&window.openIntegrationDrawer(e[s],r)}})})();let Le=[];window._erpEndpoints=Le;let Qt=null;async function Rn(){try{const e=await fetch("/api/erp/endpoints",{headers:{Authorization:"Bearer "+token}});if(e.status===401){localStorage.removeItem("mrpilot_token");const a=await e.json().catch(()=>({}));if((typeof a.detail=="string"?a.detail:a.detail&&a.detail.code||"")==="auth.session_revoked"){_showSessionRevokedModal();return}window.location.href="/";return}Le=(await e.json()).items||[],window._erpEndpoints=Le,ii()}catch(e){console.error("load endpoints failed",e)}}window._refreshErpEndpointsCache=function(){return Rn()};async function si(){const e=document.getElementById("erp-today-stats");if(e){e.innerHTML="";try{const n=await fetch("/api/erp/stats/today",{headers:{Authorization:"Bearer "+token}});if(!n.ok)return;const a=await n.json(),o=a.total||0,s=a.success||0,i=a.failed||0,r=a.auto_cnt||0;if(o===0){e.innerHTML=`<span class="erp-today-empty">${escapeHtml(t("erp-today-none"))}</span>`;return}const c=[];c.push(`<span class="erp-today-item"><strong>${o}</strong> ${escapeHtml(t("erp-today-total"))}</span>`),s>0&&c.push(`<span class="erp-today-item ok"><strong>${s}</strong> ${escapeHtml(t("erp-today-success"))}</span>`),i>0&&c.push(`<span class="erp-today-item fail"><strong>${i}</strong> ${escapeHtml(t("erp-today-failed"))}</span>`),r>0&&c.push(`<span class="erp-today-item auto"><strong>${r}</strong> ${escapeHtml(t("erp-today-auto"))}</span>`),e.innerHTML=c.join("")}catch(n){console.warn("loadErpTodayStats failed",n)}}}function ii(){const e=document.getElementById("erp-endpoints-list"),n=document.getElementById("erp-status-summary"),a=document.getElementById("btn-add-endpoint");if(!e){console.warn("erp-endpoints-list 容器不存在");return}if(a&&_userInfo){const s=_userInfo.endpoints_limit;s!==-1&&Le.length>=s?(a.disabled=!0,a.title=t("ep-limit-reached",{limit:s}),a.classList.add("btn-disabled-plus")):(a.disabled=!1,a.title="",a.classList.remove("btn-disabled-plus"))}if(Le.length===0){e.innerHTML=`<div class="erp-empty">${escapeHtml(t("ep-list-empty"))}</div>`,n&&(n.textContent=t("auto-status-none"),n.className="auto-status-pill none");return}const o=Le.some(s=>s.auto_push&&s.enabled);if(n&&(n.textContent=t("auto-status-active",{n:Le.length,mode:o?t("auto-status-on"):t("auto-status-off")}),n.className="auto-status-pill "+(o?"active":"ready")),si(),e.innerHTML=Le.map(s=>{const i=s.config||{},r=escapeHtml(i.url||"");i._token_set;const c=s.enabled!==!1,f=[];s.is_default&&f.push(`<span class="ep-badge default">${escapeHtml(t("ep-default"))}</span>`),s.auto_push&&f.push(`<span class="ep-badge auto">${escapeHtml(t("ep-auto-push-on"))}</span>`),c||f.push(`<span class="ep-badge disabled">${escapeHtml(t("ep-disabled"))}</span>`);const d=[];return s.success_count>0&&d.push(`<span class="ep-stat ok">${escapeHtml(t("ep-success",{n:s.success_count}))}</span>`),s.failure_count>0&&d.push(`<span class="ep-stat fail">${escapeHtml(t("ep-failure",{n:s.failure_count}))}</span>`),`
            <div class="erp-endpoint" data-ep-id="${escapeHtml(s.id)}">
                <div class="ep-main">
                    <div class="ep-title-row">
                        <div class="ep-name">${escapeHtml(s.name)}</div>
                        <div class="ep-badges">${f.join("")}</div>
                    </div>
        ...
        `}).join(""),_userInfo&&_userInfo.endpoints_limit!==-1){const s=Le.length,i=_userInfo.endpoints_limit,r=_userInfo.plan,c=document.createElement("div");c.className="erp-limit-hint",r==="free"?c.innerHTML=`${escapeHtml(t("ep-free-limit-hint",{used:s,limit:i}))} <a data-upgrade="plus">${escapeHtml(t("upgrade-to-plus"))}</a>`:c.textContent=t("ep-plus-limit-hint",{used:s,limit:i}),e.appendChild(c)}}function lp(e){Qt=e||null;const n=document.getElementById("endpoint-modal"),a=document.getElementById("endpoint-modal-title");a.textContent=e?t("ep-modal-title-edit"):t("ep-modal-title-new");const o=document.getElementById("ep-name"),s=document.getElementById("ep-url"),i=document.getElementById("ep-token"),r=document.getElementById("ep-is-default"),c=document.getElementById("ep-auto-push"),f=document.getElementById("ep-test-result");f.style.display="none",f.textContent="";const d=document.getElementById("ep-save-error");if(d&&d.remove(),e){const l=Le.find(p=>p.id===e);if(!l)return;o.value=l.name||"",s.value=(l.config||{}).url||"",i.value=(l.config||{})._token_set&&l.config.token||"",i.placeholder=(l.config||{})._token_set?"（已保存 · 留空保持不变）":t("ep-token-ph"),r.checked=!!l.is_default,c.checked=!!l.auto_push}else o.value="",s.value="",i.value="",i.placeholder=t("ep-token-ph"),r.checked=Le.length===0,c.checked=!0;const u=c.closest(".form-switch-row");if(c.disabled=!1,u){u.classList.remove("disabled-plus"),u.title="",u.style.cursor="",u.onclick=null;const l=u.querySelector(".plus-badge");l&&l.remove()}n.style.display="",setTimeout(()=>o.focus(),50)}function ri(){document.getElementById("endpoint-modal").style.display="none",Qt=null;const e=document.getElementById("ep-save-error");e&&e.remove()}function li(e){if(!e)return"";let n=e.trim();const a=n.search(/\s/);return a>=0&&(n=n.slice(0,a)),n}function ci(){const e=document.getElementById("ep-name").value.trim(),n=li(document.getElementById("ep-url").value),a=document.getElementById("ep-token").value,o=document.getElementById("ep-is-default").checked,s=document.getElementById("ep-auto-push").checked,i={url:n};return a&&(i.token=a),{name:e,url:n,tokenVal:a,isDefault:o,autoPush:s,config:i}}async function cp(){const{url:e,config:n}=ci(),a=document.getElementById("ep-test-result");if(!e){a.style.display="",a.className="form-test-result fail",a.textContent=t("ep-required");return}a.style.display="",a.className="form-test-result running",a.textContent=t("ep-test-running");try{const s=await(await fetch("/api/erp/test-connection",{method:"POST",headers:{Authorization:"Bearer "+token,"Content-Type":"application/json"},body:JSON.stringify({adapter:"webhook",config:n})})).json();s.success?(a.className="form-test-result ok",a.textContent=t("ep-test-ok",{status:s.http_status,ms:s.elapsed_ms})):(a.className="form-test-result fail",a.textContent=t("ep-test-fail",{err:s.error_msg||"unknown"}))}catch(o){a.className="form-test-result fail",a.textContent=t("ep-test-fail",{err:o.message})}}async function dp(){const e=ci(),n=document.getElementById("ep-save-error");if(n&&(n.style.display="none"),!e.name||!e.url){Wo(t("ep-required"));return}const a={name:e.name,adapter:"webhook",config:e.config,is_default:e.isDefault,auto_push:e.autoPush},o=document.getElementById("btn-ep-save"),s=o.innerHTML;o.disabled=!0,o.classList.add("loading");try{let i;if(Qt?i=await fetch(`/api/erp/endpoints/${encodeURIComponent(Qt)}`,{method:"PATCH",headers:{Authorization:"Bearer "+token,"Content-Type":"application/json"},body:JSON.stringify(a)}):i=await fetch("/api/erp/endpoints",{method:"POST",headers:{Authorization:"Bearer "+token,"Content-Type":"application/json"},body:JSON.stringify(a)}),!i.ok){const c=(await i.json().catch(()=>({}))).detail||`HTTP ${i.status}`;throw new Error(typeof c=="string"?c:JSON.stringify(c))}ri(),showToast(t("ep-save-ok")),Rn()}catch(i){Wo(`${t("ep-save-fail")} · ${i.message||"unknown"}`)}finally{o.disabled=!1,o.classList.remove("loading"),o.innerHTML=s}}function Wo(e){let n=document.getElementById("ep-save-error");if(!n){const a=document.querySelector("#endpoint-modal .modal-foot");if(!a)return;n=document.createElement("div"),n.id="ep-save-error",n.className="ep-inline-error",a.parentNode.insertBefore(n,a)}n.textContent=e,n.style.display=""}async function pp(e){const n=Le.find(o=>o.id===e);if(!(!n||!await showConfirm(t("ep-delete-confirm",{name:n.name}),{danger:!0})))try{if(!(await fetch(`/api/erp/endpoints/${encodeURIComponent(e)}`,{method:"DELETE",headers:{Authorization:"Bearer "+token}})).ok)throw new Error;showToast(t("ep-delete-ok")),Rn()}catch{showToast(t("ep-save-fail"),"fail")}}window.loadErpEndpoints=Rn;window.loadErpTodayStats=si;window.renderErpEndpointsList=ii;window.openEndpointModal=lp;window.closeEndpointModal=ri;window.saveEndpoint=dp;window.deleteEndpoint=pp;window.testEndpointConnection=cp;window._sanitizeUrl=li;async function di(e){if(e=(e||"").trim(),!!e)try{await navigator.clipboard.writeText(e),showToast(t("erp-doc-copy-ok",{no:e}),"success")}catch{try{const a=document.createElement("textarea");a.value=e,a.style.position="fixed",a.style.opacity="0",document.body.appendChild(a),a.select(),document.execCommand("copy"),a.remove(),showToast(t("erp-doc-copy-ok",{no:e}),"success")}catch{showToast(t("erp-doc-copy-fail"),"error")}}}async function up(e){const n=document.createElement("div");n.className="log-detail-modal",n.innerHTML=`
        <div class="log-detail-box">
            <div class="log-detail-loading">${escapeHtml(t("log-detail-loading"))}</div>
        </div>
    `,document.body.appendChild(n),n.addEventListener("click",async a=>{if(a.target===n||a.target.classList.contains("log-detail-close")){n.remove();return}const o=a.target.closest("[data-receipt-copy]");if(o){di(o.dataset.receiptCopy);return}const s=a.target.closest("[data-receipt-action]");if(s){const i=s.dataset.receiptAction;i==="retry"?window.retryPushLog(s.dataset.logId):i==="exceptions"?typeof routeTo=="function"&&routeTo("exceptions"):i==="mappings"&&typeof routeTo=="function"&&routeTo("integrations"),n.remove();return}});try{const a=await fetch(`/api/erp/logs/${encodeURIComponent(e)}`,{headers:{Authorization:"Bearer "+token}});if(!a.ok){n.remove();return}const o=await a.json(),s=window._erpEndpoints.find(S=>S.id===o.endpoint_id),i=o.endpoint_name||(s?s.name:o.endpoint_id?t("erp-log-endpoint-deleted"):"-"),r=(o.endpoint_adapter||s&&s.adapter||"").toLowerCase(),c=new Date(o.created_at).toLocaleString(),f=o.trigger==="auto"?t("log-tag-auto"):o.trigger==="retry"?t("log-tag-retry"):t("log-tag-manual"),d=o.request_body?JSON.stringify(o.request_body,null,2):t("erp-receipt-no-tech"),u=o.response_body||t("erp-receipt-no-tech"),l=o.status==="success";let p=typeof u=="string"?u:JSON.stringify(u,null,2);if(l)try{const S=typeof o.response_body=="string"?JSON.parse(o.response_body):o.response_body||{},M=S.row_count||(Array.isArray(S.imported_rows)?S.imported_rows.length:0);M>0&&(p=t("log-push-rows").replace("{n}",String(M)))}catch{}const m=(o.external_doc_no||"").trim(),v=(o.external_url||"").trim(),y=(o.external_doc_hint||"").trim(),b=(o.ocr_buyer_name||"").trim()||o.client_name||"-",h=o.seller_name||"-",g=o.push_type==="id_card";let _="-";const w=Number(o.total_amount);o.total_amount!=null&&o.total_amount!==""&&!isNaN(w)&&(_=w.toLocaleString("en-US",{minimumFractionDigits:2,maximumFractionDigits:2}));const k=l?t("erp-receipt-title-ok"):t("erp-receipt-title-fail"),x=l?"✓":"✗",E=[],I=(S,M)=>{E.push(`
                <div class="erp-receipt-row">
                    <span class="erp-receipt-key">${escapeHtml(S)}</span>
                    <span class="erp-receipt-val">${M}</span>
                </div>`)};if(I(g?t("erp-log-col-booking"):t("erp-receipt-invoice-no"),`<strong>${escapeHtml(o.invoice_no||"-")}</strong>`),I(t("erp-receipt-erp-name"),escapeHtml(i)),l){let S;m?S=`<strong class="erp-receipt-docno">${escapeHtml(m)}</strong><button class="erp-receipt-copy-btn" type="button" data-receipt-copy="${escapeHtml(m)}" title="${escapeHtml(t("erp-doc-copy-tip"))}">${escapeHtml(t("erp-receipt-copy-btn"))}</button>`:S=`<span class="erp-receipt-docno-missing">${escapeHtml(t("erp-log-doc-missing"))}</span>`,I(t("erp-receipt-doc-no"),S)}g||I(t("erp-receipt-client"),escapeHtml(b)),I(g?t("erp-log-col-customer"):t("erp-receipt-seller"),escapeHtml(h)),l&&I(t("erp-receipt-amount"),escapeHtml(_)),I(t("erp-receipt-time"),escapeHtml(c)),I(t("erp-receipt-elapsed"),escapeHtml((o.elapsed_ms!=null?o.elapsed_ms:"-")+"ms"));let L="";l&&v?L=`<a class="erp-receipt-primary-btn" href="${escapeHtml(v)}" target="_blank" rel="noopener">${escapeHtml(t("erp-receipt-open-erp"))}</a>`:l&&m&&(L=`<button class="erp-receipt-primary-btn" type="button" data-receipt-copy="${escapeHtml(m)}">${escapeHtml(t("erp-receipt-copy-docno"))}</button>`);let B="";if(l&&m&&y){const S="erp-receipt-hint-"+y,M=t(S);M&&M!==S&&(B=`<div class="erp-receipt-hint"><svg class="erp-receipt-hint-ic" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><circle cx="12" cy="12" r="9"/><line x1="12" y1="11" x2="12" y2="16"/><line x1="12" y1="8" x2="12.01" y2="8"/></svg><span>${escapeHtml(M)}</span></div>`)}let C="";if(!l){const S=(o.error_msg||"").match(/ERR_[A-Z0-9_]+/),M=S?S[0]:"",R=typeof currentLang=="string"&&currentLang||window._currentLang||"th",ne=o.error_friendly&&o.error_friendly[R]||(o.error_msg?humanizeError(o.error_msg):t("erp-receipt-no-error")),re=/ERR_NO_CUSTOMER_MAPPING|ERR_NO_CLIENT|ERR_NO_SEED_CUSTOMER|ERR_NO_SEED_PRODUCT/.test(o.error_msg||""),fe=!!(o.history_id&&o.endpoint_id),ue=[];ue.push(`<button class="erp-receipt-action-btn" type="button" data-receipt-action="exceptions">${escapeHtml(t("erp-receipt-act-exceptions"))}</button>`),re&&ue.push(`<button class="erp-receipt-action-btn" type="button" data-receipt-action="mappings">${escapeHtml(t("erp-receipt-act-mapping"))}</button>`),fe&&ue.push(`<button class="erp-receipt-action-btn primary" type="button" data-receipt-action="retry" data-log-id="${escapeHtml(o.id)}">${escapeHtml(t("erp-receipt-act-retry"))}</button>`),C=`
                ...
                <div class="erp-receipt-fail-box">
                    ...
                    <div class="erp-receipt-friendly">${escapeHtml(ne)}</div>
                </div>
                <div class="erp-receipt-actions-label">${escapeHtml(t("erp-receipt-suggest"))}</div>
                <div class="erp-receipt-actions">${ue.join("")}</div>`}n.querySelector(".log-detail-box").innerHTML=`
            <div class="log-detail-head">
                <div class="log-detail-title">
                    <span class="log-detail-status-icon ${l?"ok":"fail"}">${x}</span>
                    ${escapeHtml(k)}
                    <span class="log-tag ${o.trigger}">${escapeHtml(f)}</span>
                </div>
        ...
        `}catch(a){console.error(a),n.remove()}}window.copyErpDocNo=di;window.showLogDetail=up;const fp=`
        <div class="modal">
            <div class="modal-head">
    ...
    `;ge("endpoint-modal",fp);let qt={key:"all",val:""},Wt="",Qn=!1,Oe=new Set;window._erpSelected=Oe;async function mp(){const e=document.getElementById("erp-logs-erp-select");if(!(!e||Qn)){Qn=!0;try{let n=window._erpEndpoints;if(!Array.isArray(n)||n.length===0){const s=await fetch("/api/erp/endpoints",{headers:{Authorization:"Bearer "+token}});if(s.ok){const i=await s.json();n=i&&(i.items||i)||[]}}Array.isArray(n)||(n=[]);const a=new Set,o=[];n.forEach(s=>{const i=(s&&s.adapter||"").toLowerCase();!i||a.has(i)||(a.add(i),o.push({val:i,label:s&&s.name||i}))}),e.innerHTML=`<option value="">${escapeHtml(t("erp-logs-erp-all"))}</option>`+o.map(s=>`<option value="${escapeHtml(s.val)}"${s.val===Wt?" selected":""}>${escapeHtml(s.label)}</option>`).join("")}catch{Qn=!1}}}async function Et(e){const n=document.getElementById("erp-logs-list");if(n){e||(n.innerHTML=`<div class="erp-logs-empty">${escapeHtml(t("erp-logs-loading"))}</div>`),window.loadErpTodayStats(),mp();try{const a=new URLSearchParams({limit:"30"});qt.key==="status"&&a.set("status",qt.val),qt.key==="trigger"&&a.set("trigger",qt.val),Wt&&a.set("adapter",Wt);const o=await fetch(`/api/erp/logs?${a}`,{headers:{Authorization:"Bearer "+token}});if(!o.ok){n.innerHTML=`<div class="erp-logs-empty">${escapeHtml(t("erp-logs-error"))}</div>`;return}const i=(await o.json()).items||[];if(window._erpLogPollTimer&&(clearTimeout(window._erpLogPollTimer),window._erpLogPollTimer=null),i.some(function(m){return m.status==="pending"})&&(window._erpLogPollTimer=setTimeout(function(){Et(!0)},4e3)),i.length===0){n.innerHTML=`<div class="erp-logs-empty">${escapeHtml(t("erp-logs-empty"))}</div>`;return}const r=i.filter(function(m){var v=m.status==="failed"&&m.next_retry_at&&new Date(m.next_retry_at).getTime()>Date.now()-6e4;return!v}).map(function(m){return m.id}),c=Wt==="mrerp_dms",f=c?t("erp-log-col-booking"):t("erp-log-col-invoice"),d=c?t("erp-log-col-customer"):t("erp-log-col-seller"),u=c?t("erp-log-col-idcard"):t("erp-log-col-client"),l='<div class="erp-log-row erp-log-row-header" data-log-header>'+(r.length>0?`<input type="checkbox" class="erp-log-cb erp-log-cb-all" data-log-select-all title="${escapeHtml(t("erp-log-select-all-tip"))}">`:'<span class="erp-log-cb-spacer"></span>')+`<span class="log-time">${escapeHtml(t("erp-log-col-time"))}</span><span class="log-status">${escapeHtml(t("erp-log-col-status"))}</span><span class="log-tag-header">${escapeHtml(t("erp-log-col-trigger"))}</span><span class="log-invoice">${escapeHtml(f)}</span><span class="log-workspace">${escapeHtml(t("erp-log-col-workspace"))}</span><span class="log-client">${escapeHtml(u)}</span><span class="log-seller">${escapeHtml(d)}</span><span class="log-erp">${escapeHtml(t("erp-log-col-erp"))}</span><span class="log-doc">${escapeHtml(t("erp-log-col-doc"))}</span><span class="log-http">${escapeHtml(t("erp-log-col-http"))}</span><span class="log-elapsed">${escapeHtml(t("erp-log-col-elapsed"))}</span><span class="log-actions"></span></div>`;n.innerHTML=l+i.map(m=>{const v=new Date(m.created_at),y=`${String(v.getMonth()+1).padStart(2,"0")}-${String(v.getDate()).padStart(2,"0")} ${String(v.getHours()).padStart(2,"0")}:${String(v.getMinutes()).padStart(2,"0")}`,b=m.status==="failed"&&m.next_retry_at&&new Date(m.next_retry_at).getTime()>Date.now()-6e4;let h,g,_;m.status==="pending"?(h="retrying",g="⟳",_=t("erp-status-pending")):m.status==="success"?(h="ok",g="✓",_=t("erp-status-success")):m.status==="skipped_dup"?(h="skipped",g="⏭",_=t("erp-status-skipped")):b?(h="retrying",g="↻",_=t("erp-status-retrying")):(h="fail",g="✗",_=t("erp-status-failed"));let w;m.trigger==="auto"?w=`<span class="log-tag auto">${escapeHtml(t("log-tag-auto"))}</span>`:m.trigger==="retry"?w=`<span class="log-tag retry">${escapeHtml(t("log-tag-retry"))}</span>`:w=`<span class="log-tag manual">${escapeHtml(t("log-tag-manual"))}</span>`;const k=m.push_type==="id_card",x=k?`<span class="log-tag log-type-idcard">${escapeHtml(t("erp-log-type-idcard"))}</span>`:"",E=m.error_friendly&&(m.error_friendly[currentLang]||m.error_friendly.en)||"";let I="";const L=m.retry_count||0,B=m.max_retries||3;if(b){const K=new Date(m.next_retry_at).getTime()-Date.now(),le=Math.max(0,Math.round(K/6e4)),se=le<=0?t("erp-retry-next-soon"):t("erp-retry-next-min",{n:le});I=`${t("erp-retry-attempt",{n:L,max:B})} · ${se}`}else m.status==="failed"&&L>=B&&!m.next_retry_at&&(I=t("erp-retry-exhausted",{n:L}));const C=m.status==="failed"&&!b?`<button class="log-retry-btn btn btn-icon" data-log-retry="${escapeHtml(m.id)}" title="${escapeHtml(t("log-retry-title"))}">↻</button>`:"",S=!b,M=Oe.has(m.id)?"checked":"",R=S?`<input type="checkbox" class="erp-log-cb" data-log-cb="${escapeHtml(m.id)}" ${M}>`:'<span class="erp-log-cb-spacer"></span>',V=(m.ocr_buyer_name||"").trim()||(m.client_name||"").trim(),ne=k?`<span class="log-client" title="${escapeHtml(t("erp-log-col-idcard"))}">${m.id_card_tail?"••••"+escapeHtml(m.id_card_tail):"—"}</span>`:V?`<span class="log-client" title="${escapeHtml(V)}">${escapeHtml(V.substring(0,18))}</span>`:`<span class="log-client log-client-empty" title="${escapeHtml(t("erp-log-client-unassigned-tip"))}">${escapeHtml(t("erp-log-client-unassigned"))}</span>`,re=k?'<span class="log-workspace log-workspace-unresolved">—</span>':m.workspace_name?`<span class="log-workspace">${escapeHtml((m.workspace_name||"").substring(0,16))}</span>`:`<span class="log-workspace log-workspace-unresolved" title="${escapeHtml(t("erp-log-ws-unresolved-tip"))}">${escapeHtml(t("erp-log-ws-unresolved"))}</span>`,fe=m.endpoint_name?`<span class="log-erp">${escapeHtml((m.endpoint_name||"").substring(0,14))}</span>`:`<span class="log-erp log-erp-deleted">${escapeHtml(t("erp-log-endpoint-deleted"))}</span>`,ue=(m.external_doc_no||"").trim(),N=(m.external_url||"").trim();let z;return N?z=`<span class="log-doc"><a href="${escapeHtml(N)}" target="_blank" rel="noopener" class="log-doc-open" title="${escapeHtml(ue||"")}">${escapeHtml(t("erp-log-doc-open"))}</a></span>`:ue?z=`<span class="log-doc log-doc-copy" data-copy-doc="${escapeHtml(ue)}" title="${escapeHtml(t("erp-log-doc-copy-tip"))}">${escapeHtml(ue.substring(0,18))}</span>`:m.status==="success"?z=`<span class="log-doc log-doc-missing" title="${escapeHtml(t("erp-log-doc-missing-tip"))}">${escapeHtml(t("erp-log-doc-missing"))}</span>`:z='<span class="log-doc log-doc-empty">-</span>',`
                <div class="erp-log-row ${h}" data-log-detail="${escapeHtml(m.id)}">
                    ${R}
                    <span class="log-time">${y}</span>
                    <span class="log-status" title="${escapeHtml(_+(I?" · "+I:"")+(E?" · "+E:""))}">${g}</span>
                    ${w}${x}
                    <span class="log-invoice"${k?` title="${escapeHtml(t("erp-log-col-booking"))}"`:""}>${escapeHtml(m.invoice_no||"-")}</span>
                    ${re}
                    ${ne}
                    <span class="log-seller"${k?` title="${escapeHtml(t("erp-log-col-customer"))}"`:""}>${escapeHtml((m.seller_name||"").substring(0,20))}</span>
                    ${fe}
                    ${z}
        ...
        `,document.body.appendChild(c),e=c;const f=c.querySelector("#line-email-input"),d=c.querySelector("#line-email-submit-btn"),u=c.querySelector("#line-email-err");async function l(){u.textContent="";const p=(f.value||"").trim().toLowerCase();if(!p||p.indexOf("@")<0||p.split("@")[1].indexOf(".")<0){u.textContent=t("line-email-err-invalid");return}d.disabled=!0,d.style.opacity="0.6";try{const m=await fetch("/api/me/line_complete_email",{method:"POST",headers:{"Content-Type":"application/json",Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||"")},body:JSON.stringify({email:p})});if(!m.ok)throw new Error("http_"+m.status);const v=await m.json();v.token&&localStorage.setItem("mrpilot_token",v.token),typeof showToast=="function"&&showToast(v.merged?t("line-email-merged-toast"):t("line-email-saved-toast"),"success"),setTimeout(function(){window.location.reload()},600)}catch{u.textContent=t("line-email-err-failed"),d.disabled=!1,d.style.opacity="1"}}return d.addEventListener("click",l),f.addEventListener("keydown",function(p){p.key==="Enter"&&l()}),c}function o(){if(!e)return;const c=e.querySelector("#line-email-title-h"),f=e.querySelector("#line-email-sub-p"),d=e.querySelector("#line-email-input"),u=e.querySelector("#line-email-submit-btn");c&&(c.textContent=t("line-email-title")),f&&(f.textContent=t("line-email-sub")),d&&(d.placeholder=t("line-email-placeholder")),u&&(u.textContent=t("line-email-submit"))}function s(){a(),o(),e.style.display="flex",n=!0;const c=e.querySelector("#line-email-input");c&&setTimeout(function(){c.focus()},100)}async function i(){const c=localStorage.getItem("mrpilot_token");if(c)try{const f=await fetch("/api/me/needs_email",{headers:{Authorization:"Bearer "+c}});if(!f.ok)return;const d=await f.json();d&&d.needs_email&&s()}catch{}}function r(){setTimeout(i,800)}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",r):r(),typeof window.subscribeI18n=="function"&&window.subscribeI18n("line-email-modal",function(){n&&o()})})();(function(){function e(u){let l=0;return u.length>=8&&l++,u.length>=12&&l++,/[a-zA-Z]/.test(u)&&/\d/.test(u)&&l++,/[^a-zA-Z0-9]/.test(u)&&l++,Math.min(3,l)}function n(u,l){const p=document.getElementById("cpw-msg");p&&(p.textContent=u,p.className="cpw-msg "+(l||""))}function a(u){return typeof t=="function"?t(u):u}let o=!1;function s(){["cpw-old","cpw-new","cpw-confirm"].forEach(l=>{const p=document.getElementById(l);p&&(p.value="",p.setAttribute("readonly","readonly"))});const u=document.getElementById("cpw-strength-bar");u&&(u.style.width="0%",u.className="cpw-strength-bar"),n("","")}async function i(){const u=document.getElementById("btn-change-pw"),l=document.getElementById("cpw-old"),p=document.getElementById("cpw-new"),m=document.getElementById("cpw-confirm"),v=document.getElementById("cpw-strength-bar");if(!u||!l||!p||!m)return;const y=l.value,b=p.value,h=m.value;if(!y||!b||!h){n(a("settings-change-pw-empty"),"error");return}if(b.length<8){n(a("settings-change-pw-too-short"),"error");return}if(!(/[a-zA-Z]/.test(b)&&/\d/.test(b))){n(a("settings-change-pw-too-weak"),"error");return}if(b!==h){n(a("settings-change-pw-mismatch"),"error");return}u.disabled=!0;const g=u.textContent;u.textContent=a("settings-change-pw-submitting"),n("","");try{const _=localStorage.getItem("mrpilot_token"),w=await fetch("/api/me/change_password",{method:"POST",headers:{"Content-Type":"application/json",Authorization:"Bearer "+_},body:JSON.stringify({old_password:y,new_password:b})}),k=await w.json().catch(()=>({}));if(w.ok&&k.ok)n(a("settings-change-pw-success"),"success"),typeof showToast=="function"&&showToast(a("settings-change-pw-success"),"success"),l.value="",p.value="",m.value="",v&&(v.style.width="0%",v.className="cpw-strength-bar");else{const x=k.detail||"";let E=a("settings-change-pw-success");x==="wrong_old_password"?E=a("settings-change-pw-wrong-old"):x==="password_too_short"?E=a("settings-change-pw-too-short"):x==="password_too_weak"?E=a("settings-change-pw-too-weak"):E=x||"Error",n(E,"error")}}catch(_){console.error("change_password",_),n("Network error","error")}finally{u.disabled=!1,u.textContent=g}}function r(){o||(o=!0,document.addEventListener("click",u=>{if(!u.target||!u.target.closest)return;const l=u.target.closest(".cpw-eye");if(l){const p=document.getElementById(l.dataset.target);p&&(p.type=p.type==="password"?"text":"password");return}if(u.target.closest("#cpw-forgot-link")){u.preventDefault(),c();return}if(u.target.closest("#btn-change-pw")){i();return}u.target.closest('.settings-nav-item[data-settings-tab="account"], .settings-nav-item[data-tab="account"], .settings-nav-item[data-tab="security"]')&&setTimeout(s,100)}),document.addEventListener("input",u=>{if(u.target&&u.target.id==="cpw-new"){const l=document.getElementById("cpw-strength-bar");if(!l)return;const p=e(u.target.value),m=["0%","33%","66%","100%"],v=["","weak","medium","strong"];l.style.width=m[p],l.className="cpw-strength-bar "+v[p]}}),document.addEventListener("focusin",u=>{u.target&&["cpw-old","cpw-new","cpw-confirm"].includes(u.target.id)&&u.target.removeAttribute("readonly")}),document.getElementById("cpw-old")&&s())}function c(){const u=window._userInfo||(typeof _userInfo<"u"?_userInfo:null),l=u&&u.username?u.username:"",p=f(l);let m=document.getElementById("cpw-forgot-overlay");m&&m.remove(),m=document.createElement("div"),m.id="cpw-forgot-overlay",m.className="cpw-forgot-overlay",m.innerHTML=`
        ...
        `,document.body.appendChild(m);const v=()=>m.remove();m.querySelector("#cpw-forgot-close").addEventListener("click",v),m.querySelector("#cpw-forgot-cancel").addEventListener("click",v),m.addEventListener("click",y=>{y.target===m&&v()}),m.querySelector("#cpw-forgot-send").addEventListener("click",async()=>{const y=m.querySelector("#cpw-forgot-send"),b=m.querySelector("#cpw-forgot-msg");y.disabled=!0;const h=y.textContent;y.textContent=a("cpw-forgot-sending");try{const g=await fetch("/api/auth/forgot_password",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:l})}),_=await g.json().catch(()=>({}));g.ok?(b.textContent=a("cpw-forgot-success"),b.className="cpw-forgot-msg success",y.style.display="none",m.querySelector("#cpw-forgot-cancel").textContent=a("cpw-forgot-close-btn")):(b.textContent=_.detail||a("cpw-forgot-fail"),b.className="cpw-forgot-msg error",y.disabled=!1,y.textContent=h)}catch{b.textContent=a("cpw-forgot-fail"),b.className="cpw-forgot-msg error",y.disabled=!1,y.textContent=h}})}function f(u){if(!u||!u.includes("@"))return u||"";const[l,p]=u.split("@");return l.length<=2?l+"****@"+p:l.slice(0,2)+"****@"+p}function d(u){return u==null?"":String(u).replace(/[&<>"']/g,l=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[l])}document.readyState==="complete"||document.readyState==="interactive"?r():document.addEventListener("DOMContentLoaded",r)})();(function(){let e=null,n=!1;async function a(){if(n)return;const s=localStorage.getItem("mrpilot_token");if(s){n=!0;try{const i=await fetch("/api/me",{headers:{Authorization:"Bearer "+s},cache:"no-store"});if(i.status===401){const r=await i.json().catch(()=>({})),c=r&&r.detail;let f="";if(typeof c=="string"?f=c:c&&typeof c=="object"&&(f=c.code||""),console.warn("[heartbeat] session revoked",f),localStorage.removeItem("mrpilot_token"),e&&(clearInterval(e),e=null),f==="auth.session_revoked")try{_showSessionRevokedModal()}catch{window.location.href="/"}else{const d=f==="auth.password_changed_relogin"?"alert-password-changed-relogin":"alert-session";try{typeof showToast=="function"&&typeof t=="function"?showToast(t(d),"error"):alert("Session expired")}catch{}setTimeout(()=>{window.location.href="/"},1500)}}}catch{}finally{n=!1}}}function o(){e&&clearInterval(e),e=setInterval(a,15e3)}localStorage.getItem("mrpilot_token")&&o(),window.addEventListener("focus",a),document.addEventListener("visibilitychange",function(){document.hidden||a()}),window._sessionCheck=a})();async function Fn(){const e=document.getElementById("team-loading"),n=document.getElementById("team-list"),a=document.getElementById("team-empty"),o=document.getElementById("team-count");if(n){e&&(e.style.display=""),n.style.display="none",a&&(a.style.display="none");try{const s=await apiGet("/api/team/employees"),i=s&&s.employees||[];if(e&&(e.style.display="none"),o&&(o.textContent=(t("team-count")||"共 {n} 名员工").replace("{n}",i.length)),i.length===0){a&&(a.style.display="");return}n.style.display="",n.innerHTML=i.map(r=>{const c=r.last_login_at?new Date(r.last_login_at).toLocaleDateString():t("team-never-login")||"从未登录",f=r.is_active===!1?"team-status-off":"team-status-on",d=r.is_active===!1?t("team-status-disabled")||"已禁用":t("team-status-active")||"正常",u=r.email?`<span class="team-meta-sep">·</span><span>${escapeHtml(r.email)}</span>`:"";return`
            <div class="team-card" data-employee-id="${escapeHtml(r.id)}">
                <div class="team-card-main">
                    ...
                    <div class="team-info">
                        ...
                        <div class="team-meta">
                            <span class="team-status-dot ${f}"></span>
                            <span>${escapeHtml(d)}</span>
            ...
            </div>`}).join("")}catch(s){console.error("loadTeamList failed:",s),e&&(e.textContent=t("team-load-failed")||"加载失败")}}}async function vp(){document.querySelectorAll(".add-emp-overlay").forEach(o=>o.remove());const e=document.createElement("div");e.className="add-emp-overlay",e.innerHTML=`
    ...
    `,document.body.appendChild(e),requestAnimationFrame(()=>e.classList.add("show")),setTimeout(()=>{const o=document.getElementById("add-emp-username");o&&o.focus()},200);function n(){e.classList.remove("show"),setTimeout(()=>e.remove(),220)}e.querySelector(".add-emp-close").addEventListener("click",n),e.querySelector("#add-emp-cancel").addEventListener("click",n),e.addEventListener("click",o=>{o.target===e&&n()}),e.querySelector("#add-emp-submit").addEventListener("click",async()=>{const o=document.getElementById("add-emp-username"),s=document.getElementById("add-emp-email"),i=document.getElementById("add-emp-password"),r=document.getElementById("add-emp-msg"),c=document.getElementById("add-emp-submit"),f=(o.value||"").trim(),d=(s.value||"").trim(),u=i.value||"";if(r.textContent="",r.classList.remove("error"),!f||f.length<3){r.textContent=t("team-modal-err-username")||"用户名至少 3 位",r.classList.add("error");return}if(!/^[a-zA-Z0-9_.\-]+$/.test(f)){r.textContent=t("team-modal-err-username-fmt")||"只能用字母 / 数字 / 下划线 / 点 / 横线",r.classList.add("error");return}if(d&&!/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(d)){r.textContent=t("msg-email-invalid")||"邮箱格式不对",r.classList.add("error");return}if(u.length<8){r.textContent=t("pwd-too-short")||"密码至少 8 位",r.classList.add("error");return}if(/^\d+$/.test(u)){r.textContent=t("pwd-too-weak-numeric")||"不能是纯数字 · 请加入字母",r.classList.add("error");return}if(!(/[a-zA-Z]/.test(u)&&/\d/.test(u))){r.textContent=t("pwd-too-weak")||"密码至少 8 位 · 字母 + 数字",r.classList.add("error");return}c.disabled=!0,c.textContent=t("msg-saving")||"保存中...";try{const l={username:f,password:u};d&&(l.email=d);const p=await apiPost("/api/team/employees",l),m=p?await p.json().catch(()=>({})):{};if(p&&p.ok&&m&&m.ok){showToast(t("team-added")||"员工已添加","success"),n(),Fn();return}const v=m&&m.detail||"unknown",y={"team.username_exists":t("team-username-exists")||"用户名已被占用","team.email_exists":t("team-email-exists")||"邮箱已被占用","team.create_failed":t("team-create-failed")||"创建失败","team.only_owner_or_super":t("team-no-permission")||"无权限","team.no_tenant":t("team-no-tenant")||"请先升级账号","pwd.too_short":t("pwd-too-short")||"密码至少 8 位","pwd.too_weak_numeric":t("pwd-too-weak-numeric")||"不能是纯数字","pwd.too_weak_common":t("pwd-too-weak-common")||"这个密码太常见 · 请换一个","pwd.too_weak":t("pwd-too-weak")||"密码至少 8 位 · 字母 + 数字"};r.textContent=y[v]||(t("team-create-failed")||"创建失败")+" ("+v+")",r.classList.add("error")}catch{r.textContent=t("team-create-failed")||"创建失败",r.classList.add("error")}finally{c.disabled=!1,c.textContent=t("team-add")||"添加员工"}});function a(o){o.key==="Escape"&&(n(),document.removeEventListener("keydown",a))}document.addEventListener("keydown",a)}async function hp(e,n){try{if((await fetch(`/api/team/employees/${encodeURIComponent(e)}/active`,{method:"PATCH",headers:{Authorization:"Bearer "+token,"Content-Type":"application/json"},body:JSON.stringify({is_active:!!n})})).ok){Fn();return}showToast(t("team-toggle-failed")||"操作失败","error")}catch{showToast(t("team-toggle-failed")||"操作失败","error")}}async function gp(e,n){const o=(t("team-confirm-remove")||"确认移除员工「{name}」?他的所有识别记录会保留 · 但他将无法登录").replace("{name}",n).replace("{n}",n);if(await showConfirm(o,{danger:!0,okText:t("team-remove")}))try{if((await fetch(`/api/team/employees/${encodeURIComponent(e)}`,{method:"DELETE",headers:{Authorization:"Bearer "+token}})).ok){showToast(t("team-removed")||"已移除","success"),Fn();return}showToast(t("team-remove-failed")||"移除失败","error")}catch{showToast(t("team-remove-failed")||"移除失败","error")}}async function bp(e,n){const o=(t("team-reset-pwd-confirm")||"给员工「{name}」发送改密链接?系统将通过员工的邮箱或 LINE 发送一个 15 分钟内有效的链接 · 员工自己点链接改密码 · 您看不到密码").replace("{name}",n).replace("{n}",n);if(await showConfirm(o,{okText:t("team-reset-link-send-btn")||"发送链接"}))try{const i=await fetch(`/api/team/employees/${encodeURIComponent(e)}/reset-password`,{method:"POST",headers:{Authorization:"Bearer "+token}}),r=await i.json().catch(()=>({}));if(i.status===400&&r.detail==="team.reset_no_channel"){showToast(t("team-reset-no-channel")||"员工尚未绑定邮箱或 LINE · 请先帮员工补充邮箱再重置","error");return}if(!i.ok){showToast(t("team-reset-pwd-fail")||"发送失败","error");return}if(r.channel==="line"||r.channel==="email"){const c=t("team-reset-link-sent")||"改密链接已通过 {ch} 发送给员工 · 链接 15 分钟内有效",f=r.channel==="line"?"LINE":t("team-reset-via-email")||"邮箱";showToast(c.replace("{ch}",f),"success");return}showToast(t("team-reset-pwd-fail")||"发送失败","error")}catch{showToast(t("team-reset-pwd-fail")||"发送失败","error")}}document.addEventListener("click",e=>{if(e.target.closest("#btn-add-employee")){e.preventDefault(),vp();return}const n=e.target.closest("[data-toggle-employee]");if(n){e.preventDefault(),hp(n.dataset.toggleEmployee,n.dataset.active==="false");return}const a=e.target.closest("[data-remove-employee]");if(a){e.preventDefault(),gp(a.dataset.removeEmployee,a.dataset.name||"");return}const o=e.target.closest("[data-reset-pwd-employee]");if(o){e.preventDefault(),bp(o.dataset.resetPwdEmployee,o.dataset.name||"");return}const s=e.target.closest("[data-assign-clients]");if(s){e.preventDefault(),typeof window.openAssignClientsModal=="function"&&window.openAssignClientsModal(s.dataset.assignClients,s.dataset.name||"");return}});window.loadTeamList=Fn;function yp(e){document.querySelectorAll(".auto-nav-item").forEach(n=>{n.classList.toggle("active",n.dataset.autoTab===e)}),document.querySelectorAll(".auto-panel").forEach(n=>{n.classList.toggle("active",n.dataset.autoPanel===e)}),e==="email"&&typeof window._loadEmailIngestPanel=="function"?(window._loadEmailIngestPanel(),typeof window._startEmailLogAutoRefresh=="function"&&window._startEmailLogAutoRefresh()):typeof window._stopEmailLogAutoRefresh=="function"&&window._stopEmailLogAutoRefresh(),e==="bank"&&typeof window._loadBankReconPanel=="function"&&window._loadBankReconPanel(),e==="linebot"&&typeof window._loadLineBotPanel=="function"&&window._loadLineBotPanel(),e==="alert"&&typeof window._loadNotificationsPanel=="function"&&window._loadNotificationsPanel(),e==="folder"&&typeof window._loadFolderWatcherPanel=="function"&&window._loadFolderWatcherPanel()}window.switchAutomationTab=yp;typeof console<"u"&&typeof console.info=="function"&&console.info("[pearnly] vite bundle loaded · dashboard + billing + test-center + workspace-switcher + recon-center + assign-clients + access-log + notifications + recon-batch + welcome-wizard + archive-settings");
