...
## 🎯 状态卡（2026-06-27 · **B8 RLS · 孤儿 re-enroll sales 域(`8a7d8485`)+ suppliers 域(`4cc03b42`)enroll 上线**· CI 6 闸全绿 + prod 金丝雀 PASS · companion 未动 · 交接 `docs/refactor/b8-rls-HANDOFF-2026-06-25.md` §7.11/§7.12）
