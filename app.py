...
async def get_frontend_version():
    ...
    return {
        ...
        "ts": int(_t.time()),
        "release_notes": {
            "zh": "系统已优化『银行对账』模块的余额录入功能。\n\n根据用户反馈,在原有 GL 期末、Statement 期初、GL 期初 3 个余额录入框基础上新增『Statement 期末余额』录入框,共 4 个锚点字段可手动覆盖系统识别值,适用于 OCR 识别不稳定时的兜底场景。\n\n导出的 Excel 文件标题、表头、对照表语言始终跟随当前界面语言(中文 / 英文 / 泰文 / 日文)。\n\n即日生效。",
            "th": "ระบบได้ปรับปรุงฟังก์ชันกรอกยอดในโมดูล『กระทบยอดบัญชีธนาคาร』\n\nตามที่ผู้ใช้แจ้ง ได้เพิ่มช่องกรอก『ยอดยกไป STATEMENT』 ทำให้ฟิลด์แอนเคอร์ที่กรอกได้รวมเป็น 4 ช่อง (ยอดยกไป GL / ยอดยกไป STATEMENT / ยอดยกมา STATEMENT / ยอดยกมา GL) สำหรับใช้แทนค่าที่ระบบตรวจพบในกรณีที่ OCR อ่านไม่แม่นยำ\n\nหัวข้อ ส่วนหัวตาราง และตารางเปรียบเทียบในไฟล์ Excel ที่ส่งออก จะตรงกับภาษาที่เลือกในหน้าจอเสมอ (ไทย / อังกฤษ / จีน / ญี่ปุ่น)\n\nมีผลทันที",
            "en": "The『Bank Reconciliation』balance input feature has been improved.\n\nBased on user feedback, a『Statement Closing Balance』input field has been added. Together with the existing GL Closing, Statement Opening, and GL Opening fields, all 4 anchor values can now be manually overridden when OCR detection is unstable.\n\nThe exported Excel file's title, headers, and comparison tables consistently follow the current interface language (Chinese / English / Thai / Japanese).\n\nEffective immediately.",
            "ja": "『銀行照合』モジュールの残高入力機能を改善しました。\n\nユーザーからのフィードバックに基づき、既存の GL 期末、Statement 期首、GL 期首の 3 つの残高入力欄に加え、『Statement 期末残高』入力欄を追加しました。合計 4 つのアンカー値を手動で上書きでき、OCR 検出が不安定な場合のバックアップとして利用できます。\n\n出力される Excel ファイルのタイトル、ヘッダー、比較表は、常に現在のインターフェース言語(中国語 / 英語 / タイ語 / 日本語)に従います。\n\n即日有効。"
