...
(function (root) {
    ...
    function monthOptions(now) {
        ...
        for (var i = 12; i >= 0; i--) {
            ...
            out.push({
                id: monthId(d.getFullYear(), d.getMonth() + 1),
                year: d.getFullYear(),
                month: d.getMonth() + 1,
            });
        }
    ...
    function monthName(lang, year, month) {
        return new Intl.DateTimeFormat(localeOf(lang), { month: 'long' }).format(
    ...
    function api(path, opts) {
        ...
        return fetch(
            ...
            Object.assign({}, opts, {
                headers: headers,
                body: opts && opts.json != null ? JSON.stringify(opts.json) : opts && opts.body,
            })
        )
            .then(function (resp) {
                return resp
