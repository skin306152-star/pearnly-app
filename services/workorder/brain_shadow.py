...
brain_shadow_log 建表走 ensure 首用自愈(照 line_anchor_store 先例·prod alembic 指针停
0020 迁移路不通,0077 仅留档)——此 ensure_* 属经评审的必要新增,豁免见引入 commit 的
NEW-DEBT-EXEMPT(9b3a68e5 漏挂·随补记 commit 补齐)。
