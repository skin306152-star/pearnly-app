...
_TASK_ACK = {
    "zh": "「{title}」已开始,进度在左侧,结果会回到这里。",
    "th": "เริ่ม「{title}」แล้ว ดูความคืบหน้าทางซ้าย ผลลัพธ์จะแจ้งในแชทนี้",
}

# 写工具入队的应承(confirm-first):活没开跑,先出授权卡等人批 —— 措辞不冒领「开跑了」。
_AUTHZ_ACK = {
    "zh": "「{title}」会改数据,已出授权卡。左侧批准后才执行,拒绝则不执行任何操作。",
    "th": "「{title}」จะแก้ข้อมูล ออกการ์ดขออนุมัติแล้ว กดอนุมัติทางซ้ายจึงจะทำ ถ้าปฏิเสธจะไม่ทำอะไรเลย",
}
...
_DEGRADED = {
    "zh": "暂时无法处理指令,这句没查成。稍后再说一次,或直接看上方矩阵。",
    "th": "ตอนนี้ประมวลผลคำสั่งไม่ได้ คำถามนี้จึงยังไม่ได้ค้น ลองใหม่อีกครั้ง หรือดูที่ตารางงวดด้านบน",
}
_ERROR = {
