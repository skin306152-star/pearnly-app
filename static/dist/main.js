...
`,e.dataset.wbInjected="1";try{const a=window._currentLang||localStorage.getItem("mrpilot_lang")||"th",n=window.I18N;n&&n[a]&&(e.querySelectorAll("[data-i18n]").forEach(o=>{const i=o.getAttribute("data-i18n");n[a][i]&&(o.textContent=n[a][i])}),e.querySelectorAll("[data-i18n-placeholder]").forEach(o=>{const i=o.getAttribute("data-i18n-placeholder");n[a][i]&&(o.placeholder=n[a][i])}))}catch{}}})();(function(){const e=document.getElementById("page-settings");if(!(!e||e.dataset.wbInjected==="1")){e.innerHTML=`
        ...
        <!-- /settings-layout -->
`,e.dataset.wbInjected="1";try{const a=window._currentLang||localStorage.getItem("mrpilot_lang")||"th",n=window.I18N;n&&n[a]&&(e.querySelectorAll("[data-i18n]").forEach(o=>{const i=o.getAttribute("data-i18n");n[a][i]&&(o.textContent=n[a][i])}),e.querySelectorAll("[data-i18n-placeholder]").forEach(o=>{const i=o.getAttribute("data-i18n-placeholder");n[a][i]&&(o.placeholder=n[a][i])}))}catch{}}})();const xt=`
        <div class="page-head-clean">
            <div class="page-head-icon">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
...
`,_t=`                    <!-- Tab: 邮箱抓取 (v0.17 · M6 · v93 在 Vultr 复活) -->
...
`;(function(){const e=document.getElementById("page-automation");if(!(!e||e.dataset.wbInjected==="1")){e.innerHTML=xt+_t,e.dataset.wbInjected="1";try{const a=window._currentLang||localStorage.getItem("mrpilot_lang")||"th",n=window.I18N;n&&n[a]&&(e.querySelectorAll("[data-i18n]").forEach(o=>{const i=o.getAttribute("data-i18n");n[a][i]&&(o.textContent=n[a][i])}),e.querySelectorAll("[data-i18n-placeholder]").forEach(o=>{const i=o.getAttribute("data-i18n-placeholder");n[a][i]&&(o.placeholder=n[a][i])}))}catch{}}})();(function(){const e={"page-integration":`
        <div class="coming-soon">
            <svg class="cs-icon" viewBox="0 0 48 48" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
...
`,e.dataset.wbInjected="1";try{const a=window._currentLang||localStorage.getItem("mrpilot_lang")||"th",n=window.I18N;n&&n[a]&&e.querySelectorAll("[data-i18n]").forEach(o=>{const i=o.getAttribute("data-i18n");n[a][i]&&(o.textContent=n[a][i])})}catch{}}})();function Be(e,a){try{return typeof window.t=="function"?window.t(e):a}catch{return a}}function Se(e){if(e==null||isNaN(e))return"—";try{return String(e).replace(/\B(?=(\d{3})+(?!\d))/g,",")}catch{return String(e)}}function Et(e){if(!e)return"";try{const a=new Date(e).getTime();if(!a)return"";const n=Math.floor((Date.now()-a)/1e3);return n<60?Be("time-just-now","刚刚"):n<3600?Math.floor(n/60)+Be("time-min-ago-suffix"," 分钟前"):n<86400?Math.floor(n/3600)+Be("time-hour-ago-suffix"," 小时前"):Math.floor(n/86400)+Be("time-day-ago-suffix"," 天前")}catch{return""}}async function Ye(){tt();const e=document.getElementById("dash-kpi-invoices"),a=document.getElementById("dash-kpi-pending"),n=document.getElementById("dash-kpi-exceptions"),o=document.getElementById("dash-kpi-plan"),i=document.getElementById("dash-kpi-plan-sub"),h=document.getElementById("dash-recent-list"),b=document.getElementById("dash-quick-exc-badge");try{const _={Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||"")},[s,f,w]=await Promise.all([fetch("/api/me/tenant-usage",{headers:_}).then(q=>q.ok?q.json():null).catch(()=>null),fetch("/api/history?limit=20",{headers:_}).then(q=>q.ok?q.json():null).catch(()=>null),fetch("/api/exceptions/stats?status=pending",{headers:_}).then(q=>q.ok?q.json():null).catch(()=>null)]),u=s&&s.ocr_this_month||0;let d=0;const E=f&&(f.items||f.history||f)||[],k=Array.isArray(E)?E:[];k.forEach(q=>{(q.status==="pending"||q.status==="reviewing")&&d++});const R=w&&(w.total||w.count||w.pending||0)||0;if(e&&(e.textContent=Se(u)),a&&(a.textContent=Se(d)),n&&(n.textContent=Se(R)),b&&(R>0?(b.style.display="",b.textContent=R):b.style.display="none"),o&&s){const q=s.ocr_this_month||0,y=s.quota||0;o.textContent=Se(q),i&&(i.textContent=y?q+" / "+Se(y)+" 张":Be("dash-kpi-plan-sub","本月用量"))}if(h)if(k.length===0)h.innerHTML='<div class="dash-recent-empty">'+Be("dash-recent-empty","还没有识别记录 · 去上传第一张吧")+"</div>";else{const q=k.slice(0,5).map(y=>{const B=(y.invoice_no||y.filename||y.id||"").toString(),O=(y.supplier_name||y.buyer_name||y.client_name||y.notes||"").toString(),D=Et(y.created_at||y.upload_time||y.date),F=A=>String(A).replace(/[&<>"']/g,v=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[v]);return'<div class="dash-recent-row"><span class="dash-recent-key" title="'+F(B)+'">'+F(B)+'</span><span class="dash-recent-mid" title="'+F(O)+'">'+F(O)+'</span><span class="dash-recent-time">'+F(D)+"</span></div>"}).join("");h.innerHTML=q}}catch{h&&(h.innerHTML='<div class="dash-recent-empty">'+Be("dash-recent-empty","还没有识别记录 · 去上传第一张吧")+"</div>")}}window.loadDashboard=Ye;async function tt(){const e=document.getElementById("dash-kpi-balance-card"),a=document.getElementById("dash-kpi-usage-card"),n=document.getElementById("dash-kpi-balance"),o=document.getElementById("dash-kpi-balance-sub"),i=document.getElementById("dash-kpi-usage"),h=document.getElementById("dash-kpi-usage-sub");if(!(!e||!a))try{const b={Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||"")},_=await fetch("/api/me/credits",{headers:b,cache:"no-store"});if(!_.ok){e.style.display="none",i&&(i.textContent="—"),h&&(h.textContent="");return}const s=await _.json(),f=!!s.is_owner,w=!!s.is_billing_exempt;if(!f)e.style.display="none";else if(e.style.display="",w)n&&(n.textContent="∞",n.className="dash-kpi-val dash-green"),o&&(o.textContent=typeof window.t=="function"?window.t("dash-kpi-balance-exempt"):"Billing exempt");else{const d=typeof s.balance_thb=="number"?s.balance_thb:0;if(n&&(n.textContent="฿"+d.toFixed(2),n.className=d<50?"dash-kpi-val dash-red":"dash-kpi-val"),o){const E=typeof window.t=="function"?window.t("dash-kpi-balance-topup"):"Top up →",k=d<50?"#dc2626":"#6b7280",R=q=>typeof window.escapeHtml=="function"?window.escapeHtml(q):String(q).replace(/[&<>"']/g,y=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[y]);o.innerHTML='<a href="#" id="kpi-balance-topup-link" style="color:'+k+';text-decoration:underline;cursor:pointer;" onclick="event.preventDefault();window._openTopupModal&&window._openTopupModal();return false;">'+R(E)+"</a>"}}const u=typeof s.pages_this_month=="number"?s.pages_this_month:typeof s.my_invoice_count=="number"?s.my_invoice_count:0;if(a.style.display="",i&&(i.textContent=String(u)),h){const d=u>=200?"dash-kpi-usage-sub-high":"dash-kpi-usage-sub-low",E=typeof window.t=="function"?window.t(d,{used:u}):u+" pages";h.textContent=E}}catch(b){console.warn("[credits] loadCreditsCard failed:",b),e.style.display="none",i&&(i.textContent="—")}}window.loadCreditsCard=tt;document.addEventListener("DOMContentLoaded",function(){(location.hash||"").replace(/^#\//,"")==="dashboard"&&setTimeout(Ye,500)});typeof window.subscribeI18n=="function"&&window.subscribeI18n("dashboard",function(){(location.hash||"").replace(/^#\//,"")==="dashboard"&&Ye()});function he(e){return(typeof window.t=="function"?window.t(e):null)||e}function Je(){return localStorage.getItem("mrpilot_token")||""}function me(e){return document.getElementById(e)}var qe=null,Me=null;function nt(){Me||(Me=setInterval(function(){if(!document.hidden){var e=Je();e&&(window._userInfo&&window._userInfo.is_billing_exempt||fetch("/api/me/credits",{headers:{Authorization:"Bearer "+e},cache:"no-store"}).then(function(a){return a.ok?a.json():null}).then(function(a){if(a){var n=a.balance_thb!=null?Number(a.balance_thb):0;qe!==null&&n>qe&&(window.showToast&&window.showToast(he("credits-updated"),"success"),typeof window.loadDashboard=="function"&&window.loadDashboard(),typeof window._refreshBalanceAlerts=="function"&&window._refreshBalanceAlerts()),qe=n}}).catch(function(){}))}},3e4))}function Bt(){Me&&(clearInterval(Me),Me=null),qe=null}window._startCreditsPoll=nt;window._stopCreditsPoll=Bt;nt();var We=null,Ke=0;function It(){if(!me("topup-v2-ov")){var e=document.createElement("div");e.id="topup-v2-ov",e.className="topup-v2-ov",e.style.cssText="display:none;position:fixed;inset:0;background:rgba(15,23,42,.5);z-index:9500;align-items:center;justify-content:center;padding:16px",e.innerHTML=['<div class="topup-v2-box">','  <div class="topup-v2-head">','    <div class="topup-v2-title" id="tv2-title"></div>','    <button class="topup-v2-close" id="tv2-close" aria-label="close">','      <svg viewBox="0 0 20 20" width="16" height="16" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"><line x1="4" y1="4" x2="16" y2="16"/><line x1="16" y1="4" x2="4" y2="16"/></svg>',"    </button>","  </div>",'  <div class="topup-v2-steps">','    <div class="topup-v2-step" id="tv2-d1"><span class="topup-v2-dot">1</span><span class="topup-v2-slabel" id="tv2-sl1"></span></div>','    <div class="topup-v2-line"></div>','    <div class="topup-v2-step" id="tv2-d2"><span class="topup-v2-dot">2</span><span class="topup-v2-slabel" id="tv2-sl2"></span></div>','    <div class="topup-v2-line"></div>','    <div class="topup-v2-step" id="tv2-d3"><span class="topup-v2-dot">3</span><span class="topup-v2-slabel" id="tv2-sl3"></span></div>',"  </div>",'  <div class="topup-v2-body">','    <div id="tv2-s1">','      <label class="topup-v2-label" id="tv2-al"></label>','      <div class="topup-v2-qamts">','        <button class="topup-v2-qamt" data-val="100">฿100</button>','        <button class="topup-v2-qamt" data-val="500">฿500</button>','        <button class="topup-v2-qamt" data-val="1000">฿1,000</button>','        <button class="topup-v2-qamt" data-val="2000">฿2,000</button>',"      </div>",'      <input id="tv2-amt" type="number" min="10" step="1" class="topup-v2-input" placeholder="฿ ...">','      <div id="tv2-ae" class="topup-v2-err" style="display:none"></div>',"    </div>",'    <div id="tv2-s2" style="display:none">','      <p class="topup-v2-bank-label" id="tv2-bl"></p>','      <div class="topup-v2-bank-card">','        <div class="topup-v2-bank-name">ธนาคาร กรุงเทพ</div>','        <div class="topup-v2-bank-branch">สาขาโชคชัย 4 ลาดพร้าว</div>','        <div class="topup-v2-bank-acct">230-0-91368-4</div>','        <div class="topup-v2-bank-holder">บจ. มิสเตอร์ อี อาร์ พี</div>','        <button class="topup-v2-copy" id="tv2-copy"></button>',"      </div>",'      <div class="topup-v2-warn" id="tv2-bn"></div>',"    </div>",'    <div id="tv2-s3" style="display:none">','      <div class="topup-v2-drop" id="tv2-drop">','        <input type="file" id="tv2-file" accept="image/*,.pdf" style="display:none">','        <svg viewBox="0 0 24 24" width="28" height="28" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M21 15v4a2 2 0 01-2 2H5a2 2 0 01-2-2v-4"/><polyline points="17 8 12 3 7 8"/><line x1="12" y1="3" x2="12" y2="15"/></svg>','        <span class="topup-v2-drop-text" id="tv2-dt"></span>',"      </div>",'      <div id="tv2-se" class="topup-v2-err" style="display:none"></div>','      <label class="topup-v2-label" id="tv2-pl"></label>','      <input id="tv2-payer" type="text" maxlength="200" class="topup-v2-input">','      <label class="topup-v2-label" id="tv2-nl"></label>','      <input id="tv2-note" type="text" maxlength="500" class="topup-v2-input">','      <div id="tv2-ue" class="topup-v2-err" style="display:none"></div>',"    </div>","  </div>",'  <div class="topup-v2-foot">','    <button class="btn btn-ghost" id="tv2-back" style="display:none"></button>','    <button class="btn btn-primary" id="tv2-next"></button>',"  </div>","</div>"].join(""),document.body.appendChild(e),Lt()}}function at(){var e=function(a,n){var o=me(a);o&&(o.textContent=n)};e("tv2-title",he("topup-title")),e("tv2-sl1",he("topup-step1")),e("tv2-sl2",he("topup-step2")),e("tv2-sl3",he("topup-step3")),e("tv2-al",he("topup-amount-label")),e("tv2-bl",he("topup-bank-label")),e("tv2-copy",he("topup-copy-account")),e("tv2-dt",he("topup-slip-drop")),e("tv2-pl",he("topup-payer-label")),e("tv2-nl",he("topup-note-label"))}function $e(e){[1,2,3].forEach(function(i){var h=me("tv2-s"+i);h&&(h.style.display=i===e?"":"none");var b=me("tv2-d"+i);b&&b.classList.toggle("active",i<=e)});var a=me("tv2-back"),n=me("tv2-next");if(e===1?a&&(a.style.display="",a.textContent=he("topup-btn-cancel")):a&&(a.style.display="",a.textContent=he("topup-btn-back")),n&&(n.textContent=he(e===3?"topup-btn-submit":"topup-btn-next")),e===2){var o=me("tv2-bn");o&&(o.innerHTML=he("topup-bank-note").replace("{amount}","<strong>฿"+Number(Ke).toLocaleString()+"</strong>"))}}function Ge(){for(var e=1;e<=3;e++){var a=me("tv2-s"+e);if(a&&a.style.display!=="none")return e}return 1}function Re(e){var a=me(e);a&&(a.textContent="",a.style.display="none")}function He(e,a){var n=me(e);n&&(n.textContent=a,n.style.display="")}function Qe(e){var a=me("tv2-dt");a&&(a.textContent=e.name);var n=me("tv2-drop");n&&n.classList.add("has-file"),Re("tv2-se")}function Lt(){var e=me("topup-v2-ov");me("tv2-close").addEventListener("click",Te),e.addEventListener("click",function(h){h.target===e&&Te()}),document.addEventListener("keydown",function(h){h.key==="Escape"&&e&&e.style.display!=="none"&&Te()}),e.addEventListener("click",function(h){var b=h.target.closest(".topup-v2-qamt");if(b){e.querySelectorAll(".topup-v2-qamt").forEach(function(s){s.classList.remove("active")}),b.classList.add("active");var _=me("tv2-amt");_&&(_.value=b.dataset.val,Re("tv2-ae"))}});var a=me("tv2-amt");a&&a.addEventListener("input",function(){e.querySelectorAll(".topup-v2-qamt").forEach(function(h){h.classList.remove("active")}),Re("tv2-ae")});var n=me("tv2-copy");n&&n.addEventListener("click",function(){navigator.clipboard&&navigator.clipboard.writeText("2300913684").then(function(){var h=n.textContent;n.textContent=he("topup-copied"),setTimeout(function(){n.textContent=h},1500)})});var o=me("tv2-drop"),i=me("tv2-file");o&&(o.addEventListener("click",function(){i&&i.click()}),o.addEventListener("dragover",function(h){h.preventDefault(),o.classList.add("drag-over")}),o.addEventListener("dragleave",function(){o.classList.remove("drag-over")}),o.addEventListener("drop",function(h){h.preventDefault(),o.classList.remove("drag-over");var b=h.dataTransfer&&h.dataTransfer.files[0];b&&Qe(b)})),i&&i.addEventListener("change",function(){i.files[0]&&Qe(i.files[0])}),me("tv2-back").addEventListener("click",function(){var h=Ge();if(h<=1){Te();return}$e(h-1)}),me("tv2-next").addEventListener("click",function(){var h=Ge();h===1?Ct():h===2?$e(3):St()})}async function Ct(){var e=me("tv2-amt"),a=e?parseFloat(e.value):0;if(!a||a<10){He("tv2-ae",he("topup-amount-invalid"));return}if(a>5e5){He("tv2-ae",he("topup-amount-too-large"));return}Ke=a;var n=me("tv2-next");n&&(n.disabled=!0,n.textContent="…");try{var o=await fetch("/api/credits/topup/request",{method:"POST",headers:{"Content-Type":"application/json",Authorization:"Bearer "+Je()},body:JSON.stringify({amount_thb:a})});if(!o.ok){var i=await o.text(),h=he("topup-submit-fail");try{var b=JSON.parse(i),_=b.detail;if(Array.isArray(_)&&_.length){var s=_[0]&&_[0].type||"";s.indexOf("less_than")>=0?h=he("topup-amount-too-large"):(s.indexOf("greater_than")>=0||s.indexOf("parsing")>=0)&&(h=he("topup-amount-invalid"))}else typeof _=="string"&&(h=_)}catch{}throw new Error(h)}var f=await o.json();We=f.request_id,$e(2)}catch(w){He("tv2-ae",w.message||he("topup-submit-fail"))}finally{n&&(n.disabled=!1,n.textContent=he("topup-btn-next"))}}async function St(){var e=me("tv2-file");if(!e||!e.files||!e.files[0]){He("tv2-se",he("topup-slip-required"));return}var a=me("tv2-next");a&&(a.disabled=!0,a.textContent="…");try{var n=new FormData;n.append("file",e.files[0]);var o=me("tv2-payer"),i=me("tv2-note");o&&o.value.trim()&&n.append("payer_name",o.value.trim()),i&&i.value.trim()&&n.append("note",i.value.trim());var h=await fetch("/api/credits/topup/upload-slip/"+We,{method:"POST",headers:{Authorization:"Bearer "+Je()},body:n});if(!h.ok)throw new Error(await h.text());var b=await h.json();b.auto_approved?(window.showToast&&window.showToast(he("topup-auto-approved"),"success"),typeof window.loadDashboard=="function"&&window.loadDashboard()):window.showToast&&window.showToast(he("topup-pending"),"info"),Te()}catch(_){He("tv2-ue",he("topup-upload-fail")+" · "+_.message),a&&(a.disabled=!1,a.textContent=he("topup-btn-submit"))}}function Te(){var e=me("topup-v2-ov");e&&(e.style.display="none"),typeof window.loadDashboard=="function"&&window.loadDashboard()}window._openTopupModal=function(){It(),We=null,Ke=0,["tv2-amt","tv2-payer","tv2-note"].forEach(function(n){var o=me(n);o&&(o.value="")});var e=me("tv2-file");e&&(e.value="");var a=me("tv2-drop");a&&a.classList.remove("has-file","drag-over"),me("topup-v2-ov").querySelectorAll(".topup-v2-qamt").forEach(function(n){n.classList.remove("active")}),["tv2-ae","tv2-se","tv2-ue"].forEach(function(n){Re(n)}),at(),$e(1),me("topup-v2-ov").style.display="flex"};typeof window.subscribeI18n=="function"&&window.subscribeI18n("topup-v2",function(){var e=me("topup-v2-ov");e&&e.style.display!=="none"&&e.style.display!==""&&(at(),$e(Ge()))});(function(){const e="v118.28.5",a="pearnly_tc_results_"+e,n=[{id:"A1",group:"A · 异常栏 page-head(BUG1)",desc:"手机宽度进异常栏 · 标题「异常栏」横排正常 · 不再每字一行"},{id:"A2",group:"A · 异常栏 page-head(BUG1)",desc:"副标题「所有被规则拦截的单据集中复核…」也横排正常 · 不竖排"},{id:"A3",group:"A · 异常栏 page-head(BUG1)",desc:"客户筛选下拉 + 刷新按钮换到新一行 · 不抢标题宽度"},{id:"B1",group:"B · 客户管理 page-head(BUG2)",desc:"手机宽度进客户管理 · 标题「客户管理」横排正常"},{id:"B2",group:"B · 客户管理 page-head(BUG2)",desc:"副标题「为每家客户单独归档发票…」横排正常 · 不竖排"},{id:"B3",group:"B · 客户管理 page-head(BUG2)",desc:"「+ 新建客户」按钮换到新一行 · 不挤标题"},{id:"C1",group:"C · 客户卡片(BUG3)",desc:"客户卡片「编辑 / 导出本月」按钮文字清晰 · 不被截断"},{id:"D1",group:"D · 历史表头(BUG4)",desc:"手机宽度进单据记录 · 表头「文件·发票号·供应商」/「金额」单行 · 不竖排"},{id:"D2",group:"D · 历史表头(BUG4)",desc:"行内 INV-TH-202605-1006 这种长发票号正常单行展示 · 不一字一行"},{id:"E1",group:"E · 对账切换器(BUG6)",desc:"手机宽度进对账中心 · 顶栏点「全部客户」chip · 下拉从右上角向下展开 · 右对齐 · 不贴左屏边"},{id:"E2",group:"E · 对账切换器(BUG6)",desc:"下拉宽度自适应屏幕 · 不超出屏幕右边"},{id:"F1",group:"F · 通用设置回归",desc:"设置 → 个人资料 · 没有「界面语言」4 按钮卡"},{id:"F2",group:"F · 通用设置回归",desc:"左侧 nav 顺序:账户 / 公司 / 工作流 / 系统 / 关于"},{id:"F3",group:"F · 通用设置回归",desc:"系统 → 通用设置 · 4 行下拉(语言/时区/日期/数字)· 改语言立即切语言 · 改其他保存后 F5 仍保留"},{id:"G1",group:"G · 移动端 settings(回归)",desc:"手机宽度设置 tabs 不重叠 · 按分组分行 · chip 风格"},{id:"H1",group:"H · 回归",desc:"OCR 上传识别 / 客户管理 / 异常栏 / 对账中心 / 测试中心 全部仍工作"},{id:"H2",group:"H · 回归",desc:"4 语切换没新增异常(测试中心异常日志「API 失败」过滤无新条目)"},{id:"I1",group:"I · 三档移动 viewport",desc:"iPhone SE 375 · 上述 BUG 1-6 都修了"},{id:"I2",group:"I · 三档移动 viewport",desc:"Galaxy S 360 · 上述 BUG 1-6 都修了"},{id:"I3",group:"I · 三档移动 viewport",desc:"iPhone 12 Pro 414 · 上述 BUG 1-6 都修了"}];let o={},i="all",h=!1,b=!1;function _(G,K,te){let re=typeof t=="function"?t(G):null;return(!re||re===G)&&(re=K),te&&Object.keys(te).forEach(function(S){re=String(re).replace("{"+S+"}",String(te[S]))}),re}function s(){try{const G=localStorage.getItem(a);o=G?JSON.parse(G):{},(typeof o!="object"||!o)&&(o={})}catch{o={}}}function f(){try{localStorage.setItem(a,JSON.stringify(o))}catch{}}function w(G){const K=new Date(G),te=function(re){return re<10?"0"+re:""+re};return te(K.getHours())+":"+te(K.getMinutes())+":"+te(K.getSeconds())}function u(G){return String(G??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function d(G,K){try{typeof showToast=="function"?showToast(G,K||"info"):alert(G)}catch{}}function E(G){try{navigator.clipboard&&navigator.clipboard.writeText?navigator.clipboard.writeText(G).then(function(){d(_("tc-toast-copied","已复制到剪贴板"),"success")}).catch(function(){k(G)}):k(G)}catch{k(G)}}function k(G){try{const K=document.createElement("textarea");K.value=G,K.style.position="fixed",K.style.opacity="0",document.body.appendChild(K),K.select();const te=document.execCommand("copy");document.body.removeChild(K),d(te?_("tc-toast-copied","已复制"):_("tc-toast-copy-fail","复制失败"),te?"success":"error")}catch{d(_("tc-toast-copy-fail","复制失败"),"error")}}function R(){const G=document.getElementById("tc-account-chip"),K=document.getElementById("tc-progress-chip");if(G&&(G.textContent=_userInfo&&(_userInfo.email||_userInfo.username)||"—"),K){const te=n.length,re=n.filter(function(S){return o[S.id]}).length;K.textContent=re+" / "+te}}function q(){const G=document.getElementById("tc-checklist-body");if(!G)return;const K={};n.forEach(function(re){K[re.group]||(K[re.group]=[]),K[re.group].push(re)});const te=[];Object.keys(K).forEach(function(re){te.push('<div class="tc-checklist-group">'),te.push('<div class="tc-checklist-group-title">'+u(re)+"</div>"),K[re].forEach(function(S){const g=o[S.id]||"",c=g?"is-"+g:"";te.push('<div class="tc-check-item '+c+'" data-id="'+u(S.id)+'"><div class="tc-check-id">'+u(S.id)+'</div><div class="tc-check-desc">'+u(S.desc)+'</div><div class="tc-check-actions">'+y(S.id,"pass",g)+y(S.id,"fail",g)+y(S.id,"skip",g)+"</div></div>")}),te.push("</div>")}),G.innerHTML=te.join("")}function y(G,K,te){const re=te===K,S={pass:'<svg viewBox="0 0 20 20" fill="none" stroke="currentColor" stroke-width="2.4" stroke-linecap="round" stroke-linejoin="round"><polyline points="4,11 8,15 16,5"/></svg>',fail:'<svg viewBox="0 0 20 20" fill="none" stroke="currentColor" stroke-width="2.4" stroke-linecap="round" stroke-linejoin="round"><line x1="5" y1="5" x2="15" y2="15"/><line x1="15" y1="5" x2="5" y2="15"/></svg>',skip:'<svg viewBox="0 0 20 20" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"><line x1="5" y1="10" x2="15" y2="10"/></svg>'},g={pass:_("tc-status-pass","通过"),fail:_("tc-status-fail","失败"),skip:_("tc-status-skip","跳过")};return'<button type="button" class="tc-status-btn '+(re?"is-active "+K:"")+'" data-id="'+u(G)+'" data-kind="'+K+'" title="'+u(g[K])+'">'+S[K]+"</button>"}function B(G){return i==="all"?!0:i==="js_error"?G.type==="js_error"||G.type==="promise_error":i==="api"?G.type==="api_error"||G.type==="api_fail":i==="api_slow"?G.type==="api_slow":i==="console"?G.type==="console_error"||G.type==="console_warn":!0}function O(){const G=document.getElementById("tc-logs-body"),K=document.getElementById("tc-logs-count");if(!G)return;const te=(window._pearnlyTcLogs||[]).slice().reverse(),re=te.filter(B);if(K&&(K.textContent=String(te.length)),re.length===0){G.innerHTML='<div class="tc-logs-empty">'+u(_("tc-logs-empty","暂无异常"))+"</div>";return}const S=re.slice(0,100).map(function(g){const c=typeof g.detail=="object"?JSON.stringify(g.detail,null,2):String(g.detail||"");return'<div class="tc-log-item t-'+u(g.type)+'" data-ts="'+g.ts+'"><span class="tc-log-time">'+w(g.ts)+'</span><span class="tc-log-type">'+u(g.type)+'</span><div class="tc-log-summary">'+u(g.summary)+'<div class="tc-log-detail">'+u(c)+"</div></div></div>"}).join("");G.innerHTML=S,document.querySelectorAll("#tc-logs-filter .tc-filter-chip").forEach(function(g){g.classList.toggle("active",g.getAttribute("data-filter")===i)})}function D(){b||(b=!0,setTimeout(function(){b=!1,currentRoute==="test-center"&&document.getElementById("page-test-center")&&document.getElementById("page-test-center").classList.contains("active")&&O(),F()},200))}window._tcOnNewLog=D;function F(){const G=document.getElementById("nav-test-badge");if(!G)return;const K=(window._pearnlyTcLogs||[]).filter(function(te){return te.type==="js_error"||te.type==="promise_error"||te.type==="api_error"||te.type==="api_fail"||te.type==="console_error"}).length;K>0?(G.style.display="",G.textContent=K>99?"99+":String(K)):G.style.display="none"}function A(){R(),q(),O(),F()}function v(){const G=[],K=new Date,te=_userInfo&&(_userInfo.email||_userInfo.username)||"—";G.push("# Pearnly "+e+" 测试结果"),G.push("- 账号:"+te),G.push("- 时间:"+K.toISOString().replace("T"," ").slice(0,19));const re=n.length,S=n.filter(function(Z){return o[Z.id]==="pass"}).length,g=n.filter(function(Z){return o[Z.id]==="fail"}).length,c=n.filter(function(Z){return o[Z.id]==="skip"}).length,H=re-S-g-c;G.push("- 进度:"+(S+g+c)+" / "+re+" · ✅ "+S+" · ❌ "+g+" · ⏭ "+c+" · 未测 "+H),G.push(""),G.push("| ID | 描述 | 状态 |"),G.push("|---|---|---|"),n.forEach(function(Z){const le=o[Z.id],ie=le==="pass"?"✅":le==="fail"?"❌":le==="skip"?"⏭":"⬜";G.push("| "+Z.id+" | "+Z.desc.replace(/\|/g,"\\|")+" | "+ie+" |")});const P=n.filter(function(Z){return o[Z.id]==="fail"});P.length>0&&(G.push(""),G.push("## ❌ 失败项"),P.forEach(function(Z){G.push("- **"+Z.id+"** · "+Z.desc)}));const Y=(window._pearnlyTcLogs||[]).slice(-30).reverse();return Y.length>0&&(G.push(""),G.push("## 🔴 异常日志(最近 "+Y.length+" 条)"),Y.forEach(function(Z){if(G.push("- `"+w(Z.ts)+"` · **"+Z.type+"** · "+Z.summary),Z.detail){let le;try{le=JSON.stringify(Z.detail)}catch{le=String(Z.detail)}le&&le!=="{}"&&G.push("  - "+le.slice(0,600))}})),G.join(`
...
`)}function p(){const G=Date.now();fetch("/api/health").then(function(K){const te=Date.now()-G;K.ok?d(_("tc-toast-health-ok","后端健康 ✓ {ms}ms",{ms:te}),"success"):d(_("tc-toast-health-fail","后端无响应")+" ("+K.status+")","error")}).catch(function(){d(_("tc-toast-health-fail","后端无响应"),"error")})}function I(){try{localStorage.removeItem(a),localStorage.removeItem("pearnly_current_client_id"),o={},(window._pearnlyTcLogs||[]).length=0,i="all",window.setCurrentClientId}catch{}A(),d(_("tc-toast-cleared","session 状态已清空"),"success")}function L(){try{fetch("/api/clients",{headers:{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||"")}}).then(function(G){return G.json()}).then(function(G){window._clientsCache=G.clients||[],typeof window._refreshClientSwitcher=="function"&&window._refreshClientSwitcher(),typeof window._refreshExcClientFilter=="function"&&window._refreshExcClientFilter(),d("客户缓存已刷新 · "+(G.clients||[]).length+" 个客户","success")}).catch(function(){d("刷新失败","error")})}catch{}}function $(){if(h||!document.getElementById("page-test-center"))return;h=!0;const K=document.getElementById("tc-checklist-body");K&&K.addEventListener("click",function(le){const ie=le.target.closest(".tc-status-btn");if(!ie)return;const V=ie.getAttribute("data-id"),Q=ie.getAttribute("data-kind");!V||!Q||(o[V]===Q?delete o[V]:o[V]=Q,f(),q(),R())});const te=document.getElementById("tc-btn-reset-checklist");te&&te.addEventListener("click",function(){o={},f(),q(),R()});const re=document.getElementById("tc-btn-copy-all");re&&re.addEventListener("click",function(){E(v())});const S=document.getElementById("tc-btn-copy-logs");S&&S.addEventListener("click",function(){E(l())});const g=document.getElementById("tc-btn-clear-logs");g&&g.addEventListener("click",function(){(window._pearnlyTcLogs||[]).length=0,O(),F()});const c=document.getElementById("tc-logs-filter");c&&c.addEventListener("click",function(le){const ie=le.target.closest(".tc-filter-chip");ie&&(i=ie.getAttribute("data-filter")||"all",O())});const H=document.getElementById("tc-logs-body");H&&H.addEventListener("click",function(le){const ie=le.target.closest(".tc-log-item");ie&&ie.classList.toggle("expanded")});const P=document.getElementById("tc-tool-health");P&&P.addEventListener("click",p);const Y=document.getElementById("tc-tool-clear-session");Y&&Y.addEventListener("click",I);const Z=document.getElementById("tc-tool-reload-clients");Z&&Z.addEventListener("click",L)}function x(){}window._tcApplyVisibility=x;let M=0;const W=setInterval(function(){M++,_userInfo&&clearInterval(W),M>60&&clearInterval(W)},500);window.loadTestCenterPage=function(){s(),$(),A()},typeof window.subscribeI18n=="function"&&window.subscribeI18n("test-center",function(){F(),currentRoute==="test-center"&&document.getElementById("page-test-center")&&document.getElementById("page-test-center").classList.contains("active")&&A()})})();(function(){const e="pearnly_active_workspace_client_id",a="pearnly_work_mode";function n(B,O){if(typeof window.t=="function"){const D=window.t(B);if(D&&D!==B)return D}return O}function o(){const B=window._userInfo||{},O=String(B.role||"").toLowerCase(),D=String(B.tenant_role||"").toLowerCase();return B.is_super_admin===!0||B.is_owner===!0||O==="owner"||O==="admin"||D==="owner"||D==="admin"}function i(){return localStorage.getItem(a)==="client"?"client":"personal"}function h(){const B=localStorage.getItem(e);if(!B||B==="null"||B==="0"||B==="")return null;const O=parseInt(B,10);return isNaN(O)?null:O}function b(B){try{window.dispatchEvent(new CustomEvent("pearnly:workspace-changed",{detail:{id:B,mode:i()}}))}catch{}}function _(B){const O=h();B==null||B===0?localStorage.removeItem(e):(localStorage.setItem(e,String(B)),localStorage.setItem(a,"client")),String(O)!==String(B)&&b(B)}function s(){const B=h();localStorage.setItem(a,"personal"),localStorage.removeItem(e),B!=null&&b(null)}async function f(){try{const B=window.apiGet;if(typeof B!="function")return[];const O=await B("/api/workspace/clients");return O&&(O.clients||O.items)||[]}catch{return[]}}async function w(B){if(i()==="client"&&h()!=null)return typeof B=="function"&&B(),!0;const O=n("ws-need-client","这个功能需要先选择工作空间"),D=n("ws-btn-pick","选择工作空间"),F=n("ws-btn-cancel","取消");return typeof window.showConfirm=="function"?await window.showConfirm(O,{okText:D,cancelText:F})&&u(B):window.confirm(O+`

[`+D+" / "+F+"]")&&u(B),!1}async function u(B){const O=await f();if(typeof B=="function"&&i()!=="personal"&&O.length===1){_(Number(O[0].id)),B();return}if(typeof window.openWorkspaceChooserUI=="function"){window.openWorkspaceChooserUI({clients:O,canCreate:o(),active:h(),onPersonal:s,onPick:function(D){_(Number(D)),typeof B=="function"&&B()},emptyHint:O.length?null:o()?n("ws-empty-owner","还没有工作空间。创建一个公司后,上传、对账和 ERP 推送都会归属到该公司。"):n("ws-empty-employee","你还没有可用的工作空间,请联系管理员分配。")});return}if(!O.length){const D=o()?n("ws-empty-owner","还没有工作空间。创建一个公司后,上传、对账和 ERP 推送都会归属到该公司。"):n("ws-empty-employee","你还没有可用的工作空间,请联系管理员分配。");typeof window.showToast=="function"&&window.showToast(D,"info")}}function d(B){const O=B||document.getElementById("workspace-switcher-root");if(!O)return;const D=i(),F=h();let A,v;if(D==="client"&&F!=null){const I=(window._workspaceClientsCache||[]).find(L=>Number(L.id)===Number(F));A=k("building"),v=I?I.name:n("ws-current-label","当前工作空间")}else A=k("user"),v=n("ws-personal","个人事务");O.innerHTML='<button class="ws-ctrl-btn" id="ws-ctrl-btn" type="button">'+A+'<span class="ws-ctrl-label">'+E(v)+"</span></button>";const l=O.querySelector("#ws-ctrl-btn");l&&l.addEventListener("click",()=>u(null))}function E(B){return String(B??"").replace(/[&<>"']/g,function(O){return{"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"}[O]})}function k(B){const O='<svg class="ws-ic" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">';return B==="building"?O+'<rect x="2" y="7" width="20" height="14" rx="2"/><path d="M16 21V5a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v16"/></svg>':O+'<path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/></svg>'}function R(B){B=B||{};const O=B.clients||[],D=B.active,F=document.getElementById("ws-modal");F&&F.remove();const A=document.createElement("div");A.id="ws-modal",A.className="ws-modal";const l='<button type="button" class="ws-modal-item'+(i()==="personal"||D==null?" active":"")+'" data-ws-personal="1"><span class="ws-modal-item-ic">'+k("user")+'</span><span class="ws-modal-item-text" style="display:flex;flex-direction:column;align-items:flex-start;min-width:0;"><span class="ws-modal-item-name">'+E(n("ws-personal","个人事务"))+'</span><span class="ws-modal-item-desc" style="font-size:11px;color:#6b7280;font-weight:400;margin-top:2px;line-height:1.35;white-space:normal;">'+E(n("ws-personal-desc","用于临时识别、测试或处理不归属任何公司的文件。"))+"</span></span></button>";let p="";if(O.length){const M=['<option value="">'+E(n("ws-select-ph","— 选择账套主体 —"))+"</option>"].concat(O.map(function(W){const G=D!=null&&Number(D)===Number(W.id);return'<option value="'+E(W.id)+'"'+(G?" selected":"")+">"+E(W.name||"#"+W.id)+"</option>"}));p='<div class="ws-modal-select-row"><label class="ws-modal-select-label">'+E(n("ws-select-label","账套主体"))+'</label><select class="ws-modal-select" data-ws-select="1">'+M.join("")+"</select></div>"}const I=!O.length&&B.emptyHint?'<div class="ws-modal-empty">'+E(B.emptyHint)+"</div>":"",L=B.canCreate?'<div class="ws-modal-create"><button type="button" class="ws-modal-create-toggle" data-ws-create-toggle="1">+ '+E(n("ws-create-client","新建工作空间"))+'</button><div class="ws-modal-create-form" data-ws-create-form style="display:none;"><input type="text" class="ws-modal-create-input" data-ws-create-name placeholder="'+E(n("ws-create-ph","公司名称,例如 BAKELAB"))+'"><button type="button" class="ws-modal-create-submit" data-ws-create-submit="1">'+E(n("ws-create-submit","创建"))+"</button></div></div>":"";A.innerHTML='<div class="ws-modal-box" role="dialog" aria-modal="true"><div class="ws-modal-head"><span class="ws-modal-title">'+E(n("ws-chooser-title","选择工作空间"))+'</span><button type="button" class="ws-modal-close" data-ws-close="1" aria-label="close">✕</button></div><div class="ws-modal-subtitle" style="font-size:12px;color:#6b7280;padding:2px 4px 12px;line-height:1.45;white-space:normal;">'+E(n("ws-chooser-subtitle","账套主体 = 你的公司(发票卖方/开票方)。选择正在为哪家公司做账。"))+'</div><div class="ws-modal-list">'+l+p+"</div>"+I+L+"</div>",document.body.appendChild(A);const $=A.querySelector("[data-ws-select]");$&&$.addEventListener("change",function(){const M=$.value;M&&(typeof B.onPick=="function"&&B.onPick(M),x(),d())});function x(){A.remove()}A.addEventListener("click",function(M){if(M.target===A||M.target.closest("[data-ws-close]")){x();return}if(M.target.closest("[data-ws-personal]")){typeof B.onPersonal=="function"&&B.onPersonal(),x(),d();return}const G=M.target.closest("[data-ws-pick]");if(G){const re=G.getAttribute("data-ws-pick");typeof B.onPick=="function"&&B.onPick(re),x(),d();return}if(M.target.closest("[data-ws-create-toggle]")){const re=A.querySelector("[data-ws-create-form]");if(re){re.style.display=re.style.display==="none"?"flex":"none";const S=re.querySelector("[data-ws-create-name]");S&&S.focus()}return}if(M.target.closest("[data-ws-create-submit]")){q(A,B,x);return}})}async function q(B,O,D){const F=B.querySelector("[data-ws-create-name]"),A=F?(F.value||"").trim():"";if(!A){F&&F.focus();return}let v=null;try{if(typeof window.apiPost=="function"){const p=await window.apiPost("/api/workspace/clients",{name:A});v=p&&typeof p.json=="function"?await p.json().catch(()=>null):p}}catch{v=null}const l=v&&(v.id||v.client&&v.client.id);if(!l){typeof window.showToast=="function"&&window.showToast(n("ws-create-fail","新建工作空间失败 · 请重试"),"error");return}window._workspaceClientsCache=await f(),_(Number(l)),O.onPick,D(),d()}window.openWorkspaceChooserUI=R,window.addEventListener("pearnly:workspace-changed",function(){d()}),window.getWorkMode=i,window.getActiveWorkspaceClientId=h,window.setActiveWorkspaceClientId=_,window.enterPersonalMode=s,window.requireWorkspace=w,window.openWorkspaceChooser=u,window.renderWorkspaceControl=d,window.fetchWorkspaceClients=f;function y(){try{if(sessionStorage.getItem("pearnly_ws_login_prompted")==="1"||h()!=null||localStorage.getItem(a)==="personal")return;sessionStorage.setItem("pearnly_ws_login_prompted","1"),setTimeout(function(){u(null)},800)}catch{}}f().then(B=>{window._workspaceClientsCache=B,d(),y()}),typeof window.subscribeI18n=="function"&&window.subscribeI18n("workspace-switcher",d)})();(function(){const e=D=>document.querySelector('[data-num-target="'+D+'"]');function a(D){if(!D)return t("reconcile-last-activity-none");try{const F=new Date(D),A=new Date,v=A-F;if(v/6e4<5)return t("reconcile-last-activity-just-now");if(F.toDateString()===A.toDateString())return t("reconcile-last-activity-today");const p=Math.max(1,Math.floor(v/(24*3600*1e3)));return t("reconcile-last-activity-days-ago").replace("{n}",p)}catch{return t("reconcile-last-activity-none")}}function n(D,F,A){const v=e(D);v&&(v.textContent=A?"-":String(F),v.classList.toggle("is-empty",!!A))}function o(D){const F=document.getElementById("reconcile-error");F&&(F.style.display=D?"flex":"none")}function i(D){const F=document.getElementById("reconcile-empty");F&&(F.style.display=D?"flex":"none")}function h(D,F){const A=document.getElementById("reconcile-last-activity");A&&(A.textContent=D,A.classList.toggle("has-data",!!F))}function b(D){const F=!D||(D.total_sessions||0)===0;n("pending",D.pending||0,F),n("matched",D.matched||0,F),n("unmatched",D.unmatched||0,F),h(a(D.last_activity_at),!!D.last_activity_at),o(!1),i(F)}function _(D){const F=D.toUpperCase();return F==="KBANK"?"bank-chip-kbank":F==="SCB"?"bank-chip-scb":F==="BBL"?"bank-chip-bbl":F==="KTB"?"bank-chip-ktb":F==="TTB"?"bank-chip-ttb":"bank-chip-other"}function s(D,F){const A=v=>v?String(v).slice(0,10):"?";return!D&&!F?"":A(D)+" ~ "+A(F)}function f(D){return D==null?"":String(D).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function w(D){const F=document.getElementById("reconcile-recent"),A=document.getElementById("reconcile-recent-list");if(!F||!A)return;const v=(D||[]).slice(0,20);if(v.length===0){F.style.display="none";return}F.style.display="",i(!1),A.innerHTML=v.map(l=>{const p=l.parse_status==="parse_failed",I=l.bank_code||"OTHER",L=l.account_last4?" ···"+f(l.account_last4):"",$=s(l.period_start,l.period_end),x=f(l.source_filename||""),M=Number(l.tx_count||0),W=p?'<span class="recon-card-fail" data-i18n="reconcile-card-parse-failed">'+t("reconcile-card-parse-failed")+"</span>":'<span class="recon-card-tx">'+t("reconcile-card-tx").replace("{n}",M)+"</span>";return'<div class="recon-card" data-session-id="'+f(l.id)+'" data-session-name="'+x+'"><span class="bank-chip '+_(I)+'">'+f(I)+'</span><div class="recon-card-main"><div class="recon-card-title">'+x+L+'</div><div class="recon-card-sub">'+f($)+'</div></div><div class="recon-card-right">'+W+'</div><button class="recon-card-trash" data-trash="'+f(l.id)+'" title="'+f(t("bank-session-delete-tip")||"删除")+'"><svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"><path d="M3 5h10M6 5V3h4v2M5 5l1 9h4l1-9"/></svg></button><svg class="recon-card-arrow" viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M6 4l4 4-4 4"/></svg></div>'}).join(""),A.querySelectorAll(".recon-card").forEach(l=>{l.addEventListener("click",p=>{p.target.closest(".recon-card-trash")||(l.dataset.sessionId,u())})}),A.querySelectorAll(".recon-card-trash").forEach(l=>{l.addEventListener("click",p=>{p.stopPropagation();const I=l.dataset.trash,L=l.closest(".recon-card"),$=L&&L.dataset.sessionName||"";typeof window._deleteBankSession=="function"&&window._deleteBankSession(I,$)})})}function u(D){typeof window.routeTo=="function"&&window.routeTo("reconcile"),setTimeout(function(){const F=document.querySelector('[data-recon-tab="bank"]');F&&F.click()},150)}function d(){o(!0),i(!1)}function E(){typeof window.routeTo=="function"&&window.routeTo("reconcile"),setTimeout(function(){const D=document.querySelector('[data-recon-tab="bank"]');D&&D.click()},150)}async function k(){n("pending",0,!0),n("matched",0,!0),n("unmatched",0,!0),h("",!1),o(!1),i(!1);const D=document.getElementById("reconcile-recent");D&&(D.style.display="none");const F={Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||"")};try{const[A,v]=await Promise.all([fetch("/api/bank-recon/stats",{headers:F}),fetch("/api/bank-recon/sessions?limit=20",{headers:F})]);if(!A.ok)throw new Error("http "+A.status);const l=await A.json(),p=v.ok?await v.json():[];b(l||{}),w(p||[])}catch(A){console.warn("[reconcile] load failed",A),d()}}function R(D){if(!D||!D.length)return;const F="Bearer "+(localStorage.getItem("mrpilot_token")||"");let A=0;const v=D.length;Array.from(D).forEach(function(l){const p=new FormData;p.append("file",l,l.name);const I=new XMLHttpRequest;I.open("POST","/api/bank-recon/upload"),I.setRequestHeader("Authorization",F),I.onload=function(){A++;try{const L=JSON.parse(I.responseText);I.status===200&&L.tx_count!==void 0?showToast((t("bank-upload-ok")||"解析成功 · 共 {n} 条流水").replace("{n}",L.tx_count),"success"):showToast(l.name+" "+(t("upload-failed")||"上传失败"),"error")}catch{showToast(l.name+" "+(t("upload-failed")||"上传失败"),"error")}A===v&&setTimeout(k,600)},I.onerror=function(){A++,showToast(l.name+" "+(t("upload-failed")||"上传失败"),"error"),A===v&&setTimeout(k,600)},I.send(p)}),showToast((t("bank-queue-status-uploading")||"上传中")+"…","info")}function q(){if(window.__reconcileBound)return;window.__reconcileBound=!0;const D=document.getElementById("reconcile-bank-file-input");D&&D.addEventListener("change",function(){R(this.files),this.value=""}),document.addEventListener("click",F=>{if(F.target.closest("#btn-reconcile-upload-top")||F.target.closest("#btn-reconcile-upload-empty")){E();return}if(F.target.closest("#btn-reconcile-retry")){k();return}if(F.target.closest("#btn-reconcile-dev-seed")){O();return}})}const y=["468b50c1-5593-4fd6-990d-515ce8085563"];function B(){const D=document.getElementById("btn-reconcile-dev-seed");if(!D)return;const F=typeof _userInfo<"u"?_userInfo:null,A=F&&F.id&&y.indexOf(String(F.id))>=0;D.style.display=A?"":"none"}async function O(){try{const D=await fetch("/api/bank-recon/_dev/seed",{method:"POST",headers:{Authorization:"Bearer "+token}});if(!D.ok)throw new Error("seed:"+D.status);const F=await D.json(),A=(t("reconcile-dev-seed-ok")||"").replace("{n}",F.tx_count||0);showToast(A,"success"),typeof window.navigateTo=="function"?window.navigateTo("automation"):location.hash="#/automation",setTimeout(()=>{const v=document.querySelector('[data-auto-tab="bank"]');v&&v.click(),F.session_id&&typeof window._openBankSession=="function"&&window._openBankSession(F.session_id)},300)}catch(D){console.warn("[reconcile] dev seed failed",D),showToast(t("reconcile-dev-seed-fail")||"Seed failed","error")}}window.loadReconcilePage=async function(){q(),B(),typeof window._bankReconV2Init=="function"&&window._bankReconV2Init();try{await k()}catch{}},window._rerenderReconcile=function(){typeof currentRoute=="string"&&currentRoute==="reconcile"&&k().catch(()=>{})},typeof window.subscribeI18n=="function"&&window.subscribeI18n("reconcile",window._rerenderReconcile)})();(function(){let e={employeeId:null,employeeName:"",clients:[],selected:new Set,opened:!1};function a(){return document.getElementById("assign-clients-modal")}function n(){return document.getElementById("assign-clients-list")}function o(){return document.getElementById("assign-select-all")}function i(){return document.getElementById("assign-selected-count")}function h(){return document.getElementById("assign-modal-target")}function b(){const k=n();if(k){if(!e.clients.length){k.innerHTML='<div class="assign-empty">'+escapeHtml(t("assign-no-clients")||"暂无客户 · 请先到「客户管理」添加")+"</div>";return}k.innerHTML=e.clients.map(R=>{const q=String(R.id),y=e.selected.has(q)?"checked":"",B=escapeHtml(R.name||R.label||"#"+q),O=R.code?'<span class="assign-row-code">'+escapeHtml(R.code)+"</span>":"";return'<label class="assign-row"><input type="checkbox" data-cid="'+escapeHtml(q)+'" '+y+'><span class="assign-row-name">'+B+"</span>"+O+"</label>"}).join(""),_()}}function _(){const k=i();if(k){const q=t("assign-selected-count")||"已选 {n} / {total}";k.textContent=q.replace("{n}",e.selected.size).replace("{total}",e.clients.length)}const R=o();R&&(R.checked=e.clients.length>0&&e.selected.size===e.clients.length)}function s(){const k=h();k&&(k.textContent=e.employeeName?" · "+e.employeeName:"")}async function f(k,R){e.employeeId=k,e.employeeName=R||"",e.opened=!0,e.selected=new Set,e.clients=[],s();const q=n();q&&(q.innerHTML='<div class="assign-empty">'+escapeHtml(t("assign-loading")||"加载中...")+"</div>");const y=a();y&&(y.style.display="flex");try{const[B,O]=await Promise.all([apiGet("/api/clients?include_inactive=false"),apiGet("/api/team/employees/"+encodeURIComponent(k)+"/assignments")]);e.clients=B&&B.clients||[];const D=O&&O.client_ids||[];e.selected=new Set(D.map(String)),b()}catch(B){console.error("[assign-clients] load failed",B);const O=n();O&&(O.innerHTML='<div class="assign-empty">'+escapeHtml(t("assign-load-failed")||"加载失败 · 请重试")+"</div>")}}function w(){e.opened=!1;const k=a();k&&(k.style.display="none")}async function u(){if(!e.employeeId)return;const k=Array.from(e.selected).map(q=>parseInt(q,10)).filter(q=>!isNaN(q)),R=document.getElementById("assign-modal-save");R&&(R.disabled=!0);try{const q=await apiPost("/api/team/employees/"+encodeURIComponent(e.employeeId)+"/assignments",{client_ids:k});q&&q.ok!==!1?(showToast((t("assign-saved")||"已保存 {n} 个客户分配").replace("{n}",k.length),"success"),w(),typeof loadTeamList=="function"&&loadTeamList()):showToast(t("assign-save-failed")||"保存失败","error")}catch(q){console.error("[assign-clients] save failed",q),showToast(t("assign-save-failed")||"保存失败","error")}finally{R&&(R.disabled=!1)}}function d(){const k=a();if(!k||k.dataset.bound==="1")return;k.dataset.bound="1";const R=document.getElementById("assign-modal-close");R&&R.addEventListener("click",w);const q=document.getElementById("assign-modal-cancel");q&&q.addEventListener("click",w);const y=document.getElementById("assign-modal-save");y&&y.addEventListener("click",u),k.addEventListener("click",function(D){D.target===k&&w()});const B=o();B&&B.addEventListener("change",function(){B.checked?e.selected=new Set(e.clients.map(D=>String(D.id))):e.selected=new Set,b()});const O=n();O&&O.addEventListener("change",function(D){const F=D.target.closest('input[type="checkbox"][data-cid]');if(!F)return;const A=F.dataset.cid;F.checked?e.selected.add(A):e.selected.delete(A),_()})}function E(){e.opened&&(s(),b())}typeof window.subscribeI18n=="function"&&window.subscribeI18n("assign-clients-modal",E),window.openAssignClientsModal=function(k,R){d(),f(k,R)}})();(function(){const e={page:1,per_page:50,q:"",total:0,rows:[],loaded:!1};function a(w){if(!w)return"";try{return new Date(w).toLocaleString()}catch{return w}}function n(w){const u=document.getElementById("access-log-table");u&&(u.innerHTML='<div class="access-log-empty">'+escapeHtml(w)+"</div>");const d=document.getElementById("access-log-pager");d&&(d.innerHTML="")}function o(){const w=document.getElementById("access-log-table");if(!w)return;const u=e.rows||[];if(!u.length){n(t("set-access-log-empty"));return}const d=`
            <div class="access-log-row access-log-head">
                ...
                </div>`}).join("");w.innerHTML=d+E}function i(){const w=document.getElementById("access-log-pager");if(!w)return;const u=e.total||0;if(!u){w.innerHTML="";return}const d=e.page||1,E=e.per_page,k=Math.max(1,Math.ceil(u/E)),R=(t("set-access-log-pager-total")||"Total {n}").replace("{n}",u),q=(t("set-access-log-pager-page")||"Page {p} / {t}").replace("{p}",d).replace("{t}",k);w.innerHTML=`
            ...
            <div class="access-log-pager-ctrl">
                ...
                <span class="access-log-pager-page">${escapeHtml(q)}</span>
            ...
            </div>`}async function h(w){const u=localStorage.getItem("mrpilot_token");if(u){e.page=w||1,n(t("set-access-log-loading"));try{const d="/api/me/access_log?page="+e.page+"&per_page="+e.per_page+"&q="+encodeURIComponent(e.q||""),E=await fetch(d,{headers:{Authorization:"Bearer "+u}});if(E.status===403){n(t("set-access-log-empty"));return}if(!E.ok)throw new Error("http_"+E.status);const k=await E.json();e.rows=k.logs||[],e.total=k.total||0,e.loaded=!0,o(),i()}catch{n(t("set-access-log-fail"))}}}async function b(){const w=localStorage.getItem("mrpilot_token");if(w)try{const u="/api/me/access_log.csv?q="+encodeURIComponent(e.q||""),d=await fetch(u,{headers:{Authorization:"Bearer "+w}});if(!d.ok){showToast(t("set-access-log-csv-fail")||"Export failed","error");return}const E=await d.blob(),k=document.createElement("a"),R=URL.createObjectURL(E);k.href=R,k.download="pearnly_access_log.csv",document.body.appendChild(k),k.click(),setTimeout(function(){URL.revokeObjectURL(R),k.remove()},100),showToast(t("set-access-log-csv-ok")||"Exported","success")}catch{showToast(t("set-access-log-csv-fail")||"Export failed","error")}}function _(){const w=document.querySelectorAll(".set-tab-owner-only"),u=!!(_userInfo&&(_userInfo.role==="owner"||_userInfo.is_super_admin));w.forEach(function(d){d.style.display=u?"":"none"})}document.addEventListener("click",function(w){if(w.target.closest('.settings-tab[data-tab="access-log"]')){setTimeout(function(){(!e.loaded||e.page!==1)&&h(1)},50);return}if(w.target.closest("#access-log-csv-btn")){w.preventDefault(),b();return}const E=w.target.closest(".access-log-pager-btn[data-access-log-page]");if(E&&!E.disabled){const k=parseInt(E.dataset.accessLogPage,10);h(k)}}),document.addEventListener("input",function(w){w.target&&w.target.id==="access-log-search"&&(clearTimeout(window.__accessLogSearchTimer),window.__accessLogSearchTimer=setTimeout(function(){e.q=(w.target.value||"").trim(),h(1)},350))});let s=0;const f=setInterval(function(){s++,_userInfo&&(_(),clearInterval(f)),s>60&&clearInterval(f)},500);typeof window.subscribeI18n=="function"&&window.subscribeI18n("me-access-log",function(){_(),e.loaded&&(o(),i())})})();(function(){const e=document.getElementById("notif-new-modal");if(!(!e||e.dataset.wbInjected==="1")){e.innerHTML=`
...
`,e.dataset.wbInjected="1";try{const a=window._currentLang||localStorage.getItem("mrpilot_lang")||"th",n=window.I18N;n&&n[a]&&(e.querySelectorAll("[data-i18n]").forEach(o=>{const i=o.getAttribute("data-i18n");n[a][i]&&(o.textContent=n[a][i])}),e.querySelectorAll("[data-i18n-placeholder]").forEach(o=>{const i=o.getAttribute("data-i18n-placeholder");n[a][i]&&(o.placeholder=n[a][i])}))}catch{}}})();(function(){const e=A=>document.getElementById(A);async function a(A,v){return await fetch(A,{method:"PATCH",headers:{Authorization:"Bearer "+token,"Content-Type":"application/json"},body:JSON.stringify(v||{})})}async function n(A){return await fetch(A,{method:"DELETE",headers:{Authorization:"Bearer "+token}})}let o=null;async function i(){try{o=await apiGet("/api/line/binding")}catch{o={bound:!1}}return o}function h(A,v){if(!A)return;A.style.display="",A.className="notif-line-check "+(v?"bound":"unbound");const l=v?'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M20 6 9 17l-5-5"/></svg>':'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><path d="M12 8v4M12 16h.01"/></svg>';A.innerHTML=l+"<span>"+escapeHtml(t(v?"notif-line-bound":"notif-line-not-bound"))+"</span>"}function b(A){if(A==null)return"-";const v=Number(A);return isNaN(v)?String(A):"฿ "+v.toLocaleString("en-US",{minimumFractionDigits:2,maximumFractionDigits:2})}function _(A){if(!A)return"-";try{const v=new Date(A),l=(v.getMonth()+1).toString().padStart(2,"0"),p=v.getDate().toString().padStart(2,"0"),I=v.getHours().toString().padStart(2,"0"),L=v.getMinutes().toString().padStart(2,"0");return`${l}-${p} ${I}:${L}`}catch{return A}}function s(A){const v=e("notif-rules-list"),l=e("notif-rules-empty"),p=e("notif-rules-count");if(!(!v||!l)){if(p.textContent=String(A.length),p.className="auto-status-pill "+(A.length>0?"active":"none"),!A.length){l.style.display="",v.style.display="none",v.innerHTML="";return}l.style.display="none",v.style.display="",v.innerHTML=A.map(I=>{const L=I.template_code==="large_invoice",$=L?"notif-rule-large-tag":"notif-rule-exception-tag",x=L?"large":"";let M=[];if(L){const G=I.params&&I.params.threshold?b(I.params.threshold):"-";M.push(escapeHtml(t("notif-rule-threshold-prefix"))+" "+G)}I.enabled||M.push('<span style="color:#9ca3af;">'+escapeHtml(t("notif-rule-disabled"))+"</span>");const W=M.length?M.join(' <span class="dot"></span> '):"";return`
                ...
                </div>`}).join("")}}async function w(){try{const A=await apiGet("/api/notifications/rules");u=A&&A.items||[],s(u)}catch(A){console.warn("load rules fail",A)}try{const A=await apiGet("/api/notifications/logs?limit=20");d=A&&A.items||[],f(d)}catch(A){console.warn("load logs fail",A)}}let u=null,d=null;function E(){u&&s(u),d&&f(d);const A=e("notif-new-modal");A&&A.style.display!=="none"&&o&&h(e("notif-line-check"),!!(o&&o.bound))}function k(){const A=e("notif-new-modal");A&&(A.style.display="",e("notif-new-name").value="",e("notif-new-threshold").value="",e("notif-new-threshold-row").style.display="none",document.querySelectorAll('input[name="notif-template"]').forEach(v=>v.checked=!1),i().then(v=>h(e("notif-line-check"),!!(v&&v.bound))))}function R(){const A=e("notif-new-modal");A&&(A.style.display="none")}function q(){const A=document.querySelector('input[name="notif-template"]:checked'),v=e("notif-new-threshold-row");if(!A){v.style.display="none";return}v.style.display=A.value==="large_invoice"?"":"none";const l=e("notif-new-name");l&&!l.value.trim()&&(l.value=A.value==="large_invoice"?t("notif-tmpl-large-name"):t("notif-tmpl-exception-name"))}async function y(){const A=document.querySelector('input[name="notif-template"]:checked');if(!A){showToast(t("notif-new-template"),"error");return}const v=(e("notif-new-name").value||"").trim();if(!v){showToast(t("notif-name-required"),"error");return}const l={name:v,template_code:A.value,params:{},enabled:!0};if(A.value==="large_invoice"){const p=parseFloat(e("notif-new-threshold").value||"0");if(!p||p<=0){showToast(t("notif-threshold-required"),"error");return}l.params.threshold=p}try{const p=await apiPost("/api/notifications/rules",l);if(p&&p.ok)showToast(t("notif-toast-created"),"success"),R(),w();else{const I=await(p&&p.json&&p.json().catch(()=>({})))||{};showToast(I&&I.detail||"save failed","error")}}catch{showToast("save failed","error")}}async function B(A,v,l){if(A==="toggle"){const p=l.classList.contains("on"),I=await a("/api/notifications/rules/"+v,{enabled:!p});I&&I.ok?(showToast(t(p?"notif-toast-toggled-off":"notif-toast-toggled-on"),"success"),w()):showToast("toggle failed","error");return}if(A==="test"){const p=await i();if(!p||!p.bound){showToast(t("notif-line-error-bind-first"),"error");return}const I=await apiPost("/api/notifications/rules/"+v+"/test",{});if(I&&I.ok)showToast(t("notif-toast-test-sent"),"success"),w();else{const L=await(I&&I.json&&I.json().catch(()=>({})))||{},$=L&&L.detail||"";showToast($||t("notif-toast-test-failed"),"error"),w()}return}if(A==="delete"){if(!await showConfirm(t("notif-confirm-delete"),{danger:!0}))return;const I=await n("/api/notifications/rules/"+v);I&&I.ok?(showToast(t("notif-toast-deleted"),"success"),w()):showToast("delete failed","error");return}}let O=!1;function D(){if(O)return;O=!0;const A=e("notif-btn-new");A&&A.addEventListener("click",k);const v=e("notif-btn-refresh-logs");v&&v.addEventListener("click",w);const l=e("notif-new-close");l&&l.addEventListener("click",R);const p=e("notif-new-cancel");p&&p.addEventListener("click",R);const I=e("notif-new-save");I&&I.addEventListener("click",y),document.querySelectorAll('input[name="notif-template"]').forEach(x=>{x.addEventListener("change",q)});const L=e("notif-rules-list");L&&L.addEventListener("click",x=>{const M=x.target.closest("button[data-action]");if(!M)return;const W=M.closest("[data-rule-id]");W&&B(M.getAttribute("data-action"),W.getAttribute("data-rule-id"),M)});const $=e("notif-new-modal");$&&$.addEventListener("click",x=>{x.target===$&&R()})}async function F(){D(),await w()}window._loadNotificationsPanel=F,window._rerenderNotifications=E})();(function(){function a(y,B){try{return window.t&&window.t(y)||B}catch{return B}}function n(){var y="";try{y=localStorage.getItem("mrpilot_token")||""}catch{}return y?{Authorization:"Bearer "+y}:{}}var o=[{tbody:"vex-task-tbody",api:"/api/recon/tasks/batch_delete",reload:function(){try{window.loadRecentTasks&&window.loadRecentTasks()}catch{}},kind:"vex"},{tbody:"glv-history-tbody",api:"/api/recon/gl-vat/tasks/batch_delete",reload:function(){try{window._loadGlvHistory&&window._loadGlvHistory()}catch{}},kind:"glv"},{tbody:"brv2-history-tbody",api:"/api/recon/bank-v2/tasks/batch_delete",reload:function(){try{window._brv2LoadHistory&&window._brv2LoadHistory()}catch{}},kind:"brv2"}];function i(){if(!document.getElementById("recon-batch-style")){var y=document.createElement("style");y.id="recon-batch-style",y.textContent=".recon-sel-cell{width:36px;text-align:center;padding-left:10px!important;padding-right:6px!important}.recon-sel-cb,.recon-master-cb{cursor:pointer;width:14px;height:14px;accent-color:#111;margin:0;vertical-align:middle}th.recon-time-col,td.recon-time-col{white-space:nowrap}tr.recon-thead-batch{display:none}thead.recon-batch-mode tr.recon-thead-default{display:none}thead.recon-batch-mode tr.recon-thead-batch{display:table-row}tr.recon-thead-batch th{background:#fafaf8;border-bottom:1px solid #e8e8e3;padding:8px 12px}tr.recon-thead-batch .recon-batch-inline{display:flex;align-items:center;gap:10px;font-size:12px;color:#111;font-weight:normal}tr.recon-thead-batch .recon-batch-count-inline{font-weight:600;color:#111;margin-right:4px}tr.recon-thead-batch .recon-batch-del-inline{background:#dc2626;color:#fff;border:none;border-radius:6px;padding:4px 10px;font-size:12px;font-weight:600;cursor:pointer;font-family:inherit;display:inline-flex;align-items:center;gap:4px}tr.recon-thead-batch .recon-batch-del-inline:hover{background:#b91c1c}tr.recon-thead-batch .recon-batch-clear-inline{background:transparent;border:none;color:#555;cursor:pointer;font-size:12px;font-family:inherit;text-decoration:underline;padding:4px 2px}tr.recon-thead-batch .recon-batch-clear-inline:hover{color:#111}.recon-batch-bar{display:none!important}",document.head.appendChild(y)}}function h(y){return y?y.dataset&&y.dataset.taskId?y.dataset.taskId:y.dataset&&y.dataset.taskid?y.dataset.taskid:"":""}function b(y){var B=document.getElementById(y.tbody);if(!B)return null;var O=B.closest("table");if(!O)return null;var D=O.querySelector("thead");if(!D)return null;if(D._reconReady)return D;var F=D.querySelector("tr");if(!F)return null;if(F.classList.add("recon-thead-default"),!F.querySelector(".recon-master-cb")){var A=document.createElement("th");A.className="recon-sel-cell";var v=document.createElement("input");v.type="checkbox",v.className="recon-master-cb",v.setAttribute("aria-label","select all"),v.addEventListener("change",function(){w(y,v.checked)}),A.appendChild(v),F.insertBefore(A,F.firstElementChild)}var l=F.children[1];l&&!l.classList.contains("recon-time-col")&&l.classList.add("recon-time-col");var p=F.children.length,I=document.createElement("tr");I.className="recon-thead-batch";var L=document.createElement("th");L.className="recon-sel-cell";var $=document.createElement("input");$.type="checkbox",$.className="recon-master-cb",$.checked=!0,$.setAttribute("aria-label","select all"),$.addEventListener("change",function(){w(y,$.checked)}),L.appendChild($);var x=document.createElement("th");return x.setAttribute("colspan",String(p-1)),x.innerHTML='<div class="recon-batch-inline"><span class="recon-batch-count-inline" data-recon-count></span><button type="button" class="recon-batch-del-inline" data-recon-del><svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" width="13" height="13"><polyline points="3 4 13 4"/><path d="M6 4V2.5a.5.5 0 0 1 .5-.5h3a.5.5 0 0 1 .5.5V4"/><path d="M5 4l1 9a1 1 0 0 0 1 1h2a1 1 0 0 0 1-1l1-9"/></svg><span data-recon-del-label></span></button><button type="button" class="recon-batch-clear-inline" data-recon-clear></button></div>',I.appendChild(L),I.appendChild(x),D.appendChild(I),x.querySelector("[data-recon-del]").addEventListener("click",function(){k(y)}),x.querySelector("[data-recon-clear]").addEventListener("click",function(){E(y)}),D._reconReady=!0,d(y),D}function _(y){var B=document.getElementById(y.tbody);if(B){var O=B.querySelectorAll("tr");O.forEach(function(D){var F=h(D);if(F&&!D.querySelector(".recon-sel-cb")){var A=D.querySelector("td");if(A){var v=document.createElement("td");v.className="recon-sel-cell";var l=document.createElement("input");l.type="checkbox",l.className="recon-sel-cb",l.dataset.taskId=F,l.dataset.kind=y.kind,l.addEventListener("click",function(I){I.stopPropagation()}),l.addEventListener("change",function(){u(y)}),v.appendChild(l),D.insertBefore(v,A);var p=D.children[1];p&&!p.classList.contains("recon-time-col")&&p.classList.add("recon-time-col")}}}),u(y)}}function s(y){var B=document.getElementById(y.tbody);return B?Array.prototype.slice.call(B.querySelectorAll(".recon-sel-cb")):[]}function f(y){return s(y).filter(function(B){return B.checked}).map(function(B){return B.dataset.taskId})}function w(y,B){s(y).forEach(function(O){O.checked=!!B}),u(y)}function u(y){var B=f(y),O=s(y),D=document.getElementById(y.tbody);if(D){var F=D.closest("table"),A=F&&F.querySelector("thead");if(A){B.length>0?A.classList.add("recon-batch-mode"):A.classList.remove("recon-batch-mode"),A.querySelectorAll(".recon-master-cb").forEach(function(l){if(O.length===0){l.checked=!1,l.indeterminate=!1;return}B.length===O.length?(l.checked=!0,l.indeterminate=!1):B.length===0?(l.checked=!1,l.indeterminate=!1):(l.checked=!1,l.indeterminate=!0)});var v=A.querySelector("[data-recon-count]");v&&(v.textContent=a("recon-batch-selected-n","已选 {n} 条").replace("{n}",B.length))}}}function d(y){var B=document.getElementById(y.tbody);if(B){var O=B.closest("table"),D=O&&O.querySelector("thead");if(D){var F=D.querySelector("[data-recon-del-label]"),A=D.querySelector("[data-recon-clear]");F&&(F.textContent=a("recon-batch-delete","批量删除")),A&&(A.textContent=a("recon-batch-clear","取消")),u(y)}}}function E(y){s(y).forEach(function(B){B.checked=!1}),u(y)}async function k(y){var B=f(y);if(B.length){var O=a("recon-batch-delete-confirm","确定删除选中的 {n} 条对账任务?此操作不可恢复").replace("{n}",B.length),D=!1;try{typeof window.pearnlyConfirm=="function"?D=await window.pearnlyConfirm(O,a("recon-batch-delete-title","批量删除")):D=window.confirm(O)}catch{D=!1}if(D)try{var F=Object.assign({"Content-Type":"application/json"},n()),A=y.kind==="glv"?B.map(function(I){return parseInt(I,10)}):B,v=await fetch(y.api,{method:"POST",headers:F,body:JSON.stringify({ids:A})});if(!v.ok){typeof window.showToast=="function"&&window.showToast(a("recon-batch-delete-fail","批量删除失败"),"error");return}var l=await v.json(),p=l&&(l.deleted!=null?l.deleted:l.count)||B.length;typeof window.showToast=="function"&&window.showToast(a("recon-batch-delete-ok","已删除 {n} 条").replace("{n}",p),"success"),y.reload()}catch{typeof window.showToast=="function"&&window.showToast(a("recon-batch-delete-fail","批量删除失败"),"error")}}}function R(y){b(y),_(y);var B=document.getElementById(y.tbody);if(!(!B||B._reconBatchWatched)){B._reconBatchWatched=!0;var O=new MutationObserver(function(){_(y)});O.observe(B,{childList:!0,subtree:!1})}}function q(){i(),o.forEach(R),document.querySelectorAll(".recon-batch-bar").forEach(function(y){try{y.remove()}catch{}})}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",q):q(),setTimeout(q,1500),setTimeout(q,4e3),document.addEventListener("keydown",function(y){y.key==="Escape"&&o.forEach(function(B){f(B).length>0&&E(B)})}),typeof window.subscribeI18n=="function"&&window.subscribeI18n("recon-batch-thead",function(){o.forEach(d)})})();(function(){let e={role:"",monthly_volume:"",country:"",line_id:""},a=1;const n=4,o="pilot_ob_dismiss",i="pilot_ob_done";window.maybeShowOnboarding=function(f){};function h(f){a=f;for(let d=1;d<=n;d++){const E=document.getElementById("ob-step-"+d);E&&(E.style.display=d===f?"block":"none")}document.querySelectorAll(".ob-dot").forEach(d=>{const E=parseInt(d.dataset.step,10);d.classList.toggle("active",E===f),d.classList.toggle("done",E<f)});const w=document.getElementById("ob-step-label");w&&(w.textContent=f+" / "+n);const u=document.getElementById("ob-next");if(u&&(u.textContent=f===n?t("ob-finish"):t("ob-next")),f===4){const d=document.getElementById("ob-line-input");d&&(d.value=e.line_id||"")}}function b(f){const w=document.querySelector(".onboarding-modal");if(!w)return;let u=w.querySelector(".ob-feedback");u||(u=document.createElement("div"),u.className="ob-feedback",w.appendChild(u)),u.textContent=f,u.classList.add("show"),setTimeout(()=>u.classList.remove("show"),1800)}document.addEventListener("click",f=>{const w=f.target.closest(".ob-option");if(!w)return;const u=w.parentElement;if(!u||!u.classList.contains("ob-options"))return;u.querySelectorAll(".ob-option").forEach(E=>E.classList.remove("selected")),w.classList.add("selected");const d=w.dataset.value;u.id==="ob-role-options"?e.role=d:u.id==="ob-volume-options"?e.monthly_volume=d:u.id==="ob-country-options"&&(e.country=d)}),document.addEventListener("click",f=>{f.target.id==="ob-skip"&&_()}),document.addEventListener("click",f=>{if(f.target.id==="ob-next"){if(a===4){const w=document.getElementById("ob-line-input");e.line_id=(w&&w.value||"").trim().replace(/^@+/,"")}_()}}),document.addEventListener("click",f=>{if(f.target.closest("#ob-close")){localStorage.setItem(o,String(Date.now()));const w=document.getElementById("onboarding-modal");w&&(w.style.display="none")}});function _(){a===1&&e.role?b(t("ob-fb-role")):a===2&&e.monthly_volume?b(t("ob-fb-volume")):a===3&&e.country?b(t("ob-fb-country")):a===4&&e.line_id&&b(t("ob-fb-line")),a<n?setTimeout(()=>h(a+1),e[Object.keys(e)[a-1]]?350:0):s()}async function s(){const f=document.getElementById("onboarding-modal");localStorage.setItem(i,"1"),localStorage.removeItem(o);const w={};if(e.role&&(w.role=e.role),e.monthly_volume&&(w.monthly_volume=e.monthly_volume),e.country&&(w.country=e.country),e.line_id&&(w.line_id=e.line_id),Object.keys(w).length===0){f&&(f.style.display="none");return}try{const u=await fetch("/api/me/profile",{method:"PUT",headers:{Authorization:"Bearer "+(window.token||localStorage.getItem("mrpilot_token")),"Content-Type":"application/json"},body:JSON.stringify(w)});u.ok?(b(t("ob-fb-done")),window._userInfo&&Object.assign(window._userInfo,w),setTimeout(()=>{f&&(f.style.display="none")},1200)):(localStorage.setItem("pilot_ob_pending",JSON.stringify(w)),console.warn("onboarding profile save failed",u.status),b(t("ob-fb-saved-local")),setTimeout(()=>{f&&(f.style.display="none")},1500))}catch(u){console.error("onboarding submit",u),localStorage.setItem("pilot_ob_pending",JSON.stringify(w)),f&&(f.style.display="none")}}})();(function(){const e=document.getElementById("archive-rule-modal");if(!(!e||e.dataset.wbInjected==="1")){e.innerHTML=`
...
`,e.dataset.wbInjected="1";try{const a=window._currentLang||localStorage.getItem("mrpilot_lang")||"th",n=window.I18N;n&&n[a]&&(e.querySelectorAll("[data-i18n]").forEach(o=>{const i=o.getAttribute("data-i18n");n[a][i]&&(o.textContent=n[a][i])}),e.querySelectorAll("[data-i18n-placeholder]").forEach(o=>{const i=o.getAttribute("data-i18n-placeholder");n[a][i]&&(o.placeholder=n[a][i])}))}catch{}}})();(function(){let e=[],a="by_month_seller",n=-1,o=!1;const i={date:'<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><rect x="2.5" y="3.5" width="11" height="10" rx="1.5"/><path d="M2.5 6.5h11M5.5 2v3M10.5 2v3"/></svg>',seller:'<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M3 13.5V4a1 1 0 011-1h5a1 1 0 011 1v9.5"/><path d="M10 7h2.5a.5.5 0 01.5.5v6"/><path d="M5 6h1M5 9h1M5 12h1M13.5 13.5h-12"/></svg>',category:'<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M3.5 2h6L13 5.5v7.5a1 1 0 01-1 1H3.5a1 1 0 01-1-1V3a1 1 0 011-1z"/><path d="M9 2v4h4"/><path d="M5 9h6M5 11.5h4"/></svg>',amount:'<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><circle cx="8" cy="8" r="6"/><path d="M8 4.5v7M10 6.3a1.8 1.8 0 00-4 0c0 .9.7 1.3 2 1.6s2 .8 2 1.6a1.8 1.8 0 01-4 0"/></svg>',invoice:'<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M3 3.5l1.5 10.5 1.5-1 1.5 1 1.5-1 1.5 1 1.5-1 1.5 1L13 3.5z"/><path d="M5.5 6.5h5M5.5 9h5M5.5 11.5h3"/></svg>',buyer:'<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><circle cx="8" cy="6" r="2.5"/><path d="M3 13.5c0-2.5 2.2-4.5 5-4.5s5 2 5 4.5"/></svg>',sep:'<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M8 3v10"/></svg>'},h={date:{label:"field-date",defaultCfg:{format:"YYYY-MM-DD"}},seller:{label:"field-seller",defaultCfg:{short:!0}},category:{label:"field-category",defaultCfg:{}},amount:{label:"field-amount",defaultCfg:{with_currency:!0}},invoice:{label:"field-invoice",defaultCfg:{}},buyer:{label:"field-buyer",defaultCfg:{}},sep:{label:"field-sep",defaultCfg:{val:"_"}}};function b(){return{zh:"运费",en:"Shipping",th:"ค่าขนส่ง",ja:"送料"}[currentLang]||"Shipping"}function _(){return"DHL Express (Thailand) Co., Ltd."}function s(){return{merged_fields:{invoice_date:"2026-04-15",seller_name:_(),category:b(),total_amount:1250,currency:"THB",invoice_no:"INV-2026030002",buyer_name:"Mr.ERP Co., Ltd."}}}window.loadAboutPanel=()=>f(),window.loadPrefsSettings=()=>w(),window.loadArchiveSettings=()=>d();function f(){const v=document.getElementById("settings-contact-grid");if(!v)return;const l=_contact?.phone||"086-889-2228",p=_contact?.line_id||"@Pearnly",I=_contact?.line_url||"https://line.me/R/ti/p/@059oupmg",L=_contact?.email||"hello@pearnly.com",$=_contact?.address||"Bangkok, Thailand";v.innerHTML=`
        ...
        `}async function w(){try{const v=await fetch("/api/settings/dup-check",{headers:{Authorization:"Bearer "+token}});if(!v.ok)return;const l=await v.json(),p=document.getElementById("pref-dup-check");p&&(p.checked=!!l.enabled)}catch(v){console.warn("load prefs failed",v)}}const u=document.getElementById("pref-dup-check");u&&!u.dataset.bound&&(u.dataset.bound="1",u.addEventListener("change",async v=>{const l=v.target.checked;try{(await fetch("/api/settings/dup-check",{method:"PUT",headers:{Authorization:"Bearer "+token,"Content-Type":"application/json"},body:JSON.stringify({enabled:l})})).ok?showToast(l?t("pref-dup-check-on-toast"):t("pref-dup-check-off-toast"),"success"):(v.target.checked=!l,showToast(t("pref-save-failed"),"error"))}catch{v.target.checked=!l,showToast(t("pref-save-failed"),"error")}}));async function d(){const v=!!(_userInfo&&_userInfo.can_customize_archive);o=!v;const l=document.getElementById("archive-upgrade-banner");l&&(l.style.display=v?"none":"");const p=document.getElementById("archive-plus-badge");p&&(p.style.display=v?"none":"");try{const I=await fetch("/api/archive/settings",{headers:{Authorization:"Bearer "+token}});if(!I.ok)throw new Error("load failed");const L=await I.json();e=Array.isArray(L.name_template)?L.name_template:[],a=L.folder_strategy||"by_month_seller"}catch(I){console.error("load archive settings failed",I),showToast(t("archive-load-failed"),"error");return}E(),k(),R(),q()}function E(){const v=document.getElementById("archive-rule-canvas");if(v){if(e.length===0){v.innerHTML=`<div class="archive-empty">${escapeHtml(t("archive-rule-empty"))}</div>`;return}v.innerHTML=e.map((l,p)=>{const I=h[l.type]||{label:l.type},L=i[l.type]||"",$=l.type==="sep"?`"${escapeHtml(l.val||"_")}"`:escapeHtml(t(I.label));return`
            ...
            `}).join("")}}function k(){const v=document.getElementById("archive-field-palette");if(!v)return;const l=["date","seller","category","amount","invoice","buyer","sep"];v.innerHTML=l.map(p=>{const I=h[p],L=i[p]||"";return`
                <button class="archive-palette-btn ${p}" data-add-field="${p}" ${o?"disabled":""}>
                    <span class="token-icon">${L}</span>
                    <span>${escapeHtml(t(I.label))}</span>
                </button>
            `}).join("")}function R(){document.querySelectorAll('input[name="folder-strategy"]').forEach(v=>{v.checked=v.value===a,v.disabled=o})}async function q(){const v=document.getElementById("archive-preview-name"),l=document.getElementById("archive-preview-hint");if(l&&(l.textContent=t("archive-preview-hint",{category:b()})),!!v){if(e.length===0){v.textContent="-";return}try{const I=await(await fetch("/api/archive/rename-preview",{method:"POST",headers:{Authorization:"Bearer "+token,"Content-Type":"application/json"},body:JSON.stringify({merged_fields:s().merged_fields,name_template:e})})).json();v.textContent=(I.name||"-")+".pdf"}catch{v.textContent="("+t("archive-preview-error")+")"}}}window._rerenderArchiveAll=function(){const v=document.getElementById("archive-rule-modal");!v||v.style.display==="none"||(E(),k(),q())};let y=-1;document.addEventListener("dragstart",v=>{const l=v.target.closest(".archive-token");!l||o||(y=parseInt(l.dataset.tokenIdx,10),l.classList.add("dragging"),v.dataTransfer.effectAllowed="move")}),document.addEventListener("dragend",v=>{document.querySelectorAll(".archive-token").forEach(l=>l.classList.remove("dragging","drop-target")),y=-1}),document.addEventListener("dragover",v=>{const l=v.target.closest(".archive-token");l&&(v.preventDefault(),v.dataTransfer.dropEffect="move",document.querySelectorAll(".archive-token").forEach(p=>p.classList.remove("drop-target")),l.classList.add("drop-target"))}),document.addEventListener("drop",v=>{const l=v.target.closest(".archive-token");if(!l||y<0||o)return;v.preventDefault();const p=parseInt(l.dataset.tokenIdx,10);if(p===y)return;const I=e.splice(y,1)[0];e.splice(p,0,I),y=-1,E(),q()}),document.addEventListener("click",v=>{if(v.target.closest("#btn-open-archive-rule")||v.target.closest("#btn-open-archive-rule-from-settings")){const L=document.getElementById("archive-rule-modal");L&&(L.style.display="",d());return}if(v.target.closest("#archive-rule-modal-close")||v.target.id==="archive-rule-modal"){const L=document.getElementById("archive-rule-modal");L&&(L.style.display="none");return}const l=v.target.closest(".settings-nav-item");if(l){switchSettingsTab(l.dataset.settingsTab);return}if(o&&v.target.closest(".archive-token, [data-add-field], #btn-archive-save, #btn-archive-reset")){showToast(t("feature-contact-us"),"info");return}const p=v.target.closest("[data-add-field]");if(p){const L=p.dataset.addField,$=h[L],x={type:L,...$.defaultCfg};e.push(x),E(),q();return}const I=v.target.closest(".archive-token");if(I&&!o){B(parseInt(I.dataset.tokenIdx,10));return}if(v.target.closest("#btn-archive-save"))return F();if(v.target.closest("#btn-archive-reset"))return A();(v.target.closest("#archive-token-close")||v.target.id==="archive-token-modal")&&(document.getElementById("archive-token-modal").style.display="none"),v.target.closest("#btn-archive-token-ok")&&O(),v.target.closest("#btn-archive-token-delete")&&D()}),document.addEventListener("change",v=>{v.target.name==="folder-strategy"&&(a=v.target.value)});function B(v){n=v;const l=e[v];if(!l)return;const p=document.getElementById("archive-token-body");let I="";l.type==="date"?I=`
                <div class="form-group">
                ...
                </div>`:I=`<div class="form-hint">${escapeHtml(t("archive-token-no-option"))}</div>`,p.innerHTML=I,document.getElementById("archive-token-modal").style.display="",p.querySelectorAll(".sep-chip").forEach(L=>{L.addEventListener("click",()=>{p.querySelectorAll(".sep-chip").forEach(x=>x.classList.remove("active")),L.classList.add("active");const $=document.getElementById("token-sep-custom");$&&($.value="")})})}function O(){const v=e[n];if(v){if(v.type==="date")v.format=document.getElementById("token-date-format").value;else if(v.type==="seller")v.short=document.getElementById("token-seller-short").checked;else if(v.type==="amount")v.with_currency=document.getElementById("token-amount-currency").checked;else if(v.type==="sep"){const l=document.querySelector("#archive-token-body .sep-chip.active"),p=document.getElementById("token-sep-custom").value;v.val=p||(l?l.dataset.sep:"_")}document.getElementById("archive-token-modal").style.display="none",E(),q()}}function D(){n<0||(e.splice(n,1),document.getElementById("archive-token-modal").style.display="none",E(),q())}async function F(){if(e.length===0){showToast(t("archive-rule-cannot-empty"),"error");return}try{if(!(await fetch("/api/archive/settings",{method:"PUT",headers:{Authorization:"Bearer "+token,"Content-Type":"application/json"},body:JSON.stringify({name_template:e,folder_strategy:a})})).ok)throw new Error("save failed");showToast(t("archive-save-ok"),"success");const l=document.getElementById("archive-rule-modal");l&&(l.style.display="none")}catch{showToast(t("archive-save-fail"),"error")}}async function A(){await showConfirm(t("archive-reset-confirm"),{danger:!0})&&(e=[{type:"date",format:"YYYY-MM-DD"},{type:"sep",val:"_"},{type:"seller",short:!0},{type:"sep",val:"_"},{type:"category"},{type:"sep",val:"_"},{type:"amount",with_currency:!0}],a="by_month_seller",E(),R(),q())}})();(function(){const o="pearnly_big_batch_tip_shown";let i=null,h=null,b=0,_=0,s=!1;function f(B){const O=typeof t=="function"?t("big-batch-unload-warn"):"Batch OCR running · close anyway?";return B.preventDefault(),B.returnValue=O,O}function w(){s||(s=!0,window.addEventListener("beforeunload",f))}function u(){s&&(s=!1,window.removeEventListener("beforeunload",f))}function d(){if(document.getElementById("big-batch-progress"))return;const B=document.getElementById("file-list");if(!B||!B.parentNode)return;const O=document.createElement("div");O.id="big-batch-progress",O.className="big-batch-progress",O.innerHTML='<div class="bbp-row"><svg class="bbp-icon" viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><circle cx="8" cy="8" r="6.5"/><path d="M8 4.5v3.5l2.5 1.5"/></svg><span class="bbp-text" id="bbp-text"></span></div><div class="bbp-track"><div class="bbp-fill" id="bbp-fill" style="width:0%"></div></div>',B.parentNode.insertBefore(O,B);const D=document.getElementById("bbp-text");D&&(D.textContent=typeof t=="function"?t("big-batch-progress-init"):"Starting...")}function E(){const B=document.getElementById("big-batch-progress");B&&B.remove()}function k(){if(!h)return;let B=0;for(let I=0;I<h.length;I++){const L=h[I].status;(L==="success"||L==="error"||L==="cancelled")&&B++}const O=b,D=O>0?Math.min(100,Math.floor(100*B/O)):0,F=(Date.now()-_)/1e3;let A;if(B>=3&&F>1){const I=F/B;A=(O-B)*I}else A=(O-B)*6/6;const v=Math.max(1,Math.ceil(A/60)),l=document.getElementById("bbp-fill"),p=document.getElementById("bbp-text");l&&(l.style.width=D+"%"),p&&(B>=O?p.textContent=t("big-batch-progress-done").replace("{total}",O):p.textContent=t("big-batch-progress-running").replace("{done}",B).replace("{total}",O).replace("{min}",v))}function R(B){try{if(localStorage.getItem(o)==="1")return}catch{}const O=Math.max(1,Math.ceil(B*6/6/60)),D=t("big-batch-first-tip").replace("{n}",B).replace("{min}",O);typeof showToast=="function"&&showToast(D,"info",8e3);try{localStorage.setItem(o,"1")}catch{}}function q(B){!B||B.length<100||(h=B,b=B.length,_=Date.now(),d(),w(),R(b),i&&clearInterval(i),i=setInterval(k,250),k())}function y(){i&&(clearInterval(i),i=null),u(),h&&b>=100?(k(),setTimeout(E,1200)):E(),h=null,b=0}window._bigBatchStart=q,window._bigBatchStop=y,typeof window.subscribeI18n=="function"&&window.subscribeI18n("big-batch-progress",function(){h&&k()})})();(function(){let e=null,a=!1,n=!1;function o(l){return typeof escapeHtml=="function"?escapeHtml(l==null?"":String(l)):String(l??"")}function i(l,p){try{typeof showToast=="function"&&showToast(l,p||"info")}catch{}}function h(){const l=typeof _userInfo<"u"?_userInfo:null;return!!(l&&(l.role==="owner"||l.is_super_admin))}function b(){try{return(typeof _results<"u"?_results:[])[typeof _drawerIdx<"u"?_drawerIdx:-1]||null}catch{return null}}function _(l){if(!l)return!1;const p=String(l.status||"").toLowerCase();return p==="exception"||p==="exception_pending"||p==="rejected"}async function s(l){if(a&&!l)return e;const p=localStorage.getItem("mrpilot_token");if(!p)return null;try{const I=await fetch("/api/erp/xero/status",{headers:{Authorization:"Bearer "+p}});if(!I.ok)throw new Error("http_"+I.status);e=await I.json(),a=!0}catch{e={configured:!1,connected:!1,organisations:[]},a=!1}return e}function f(){const l=document.getElementById("erp-connect-cards");if(!l)return;const p=e;let I,L=!1;p?p.configured?p.connected?(L=!0,I='<span class="mrerp-card-pill mrerp-pill-ok">'+o(t("xero-card-connected"))+"</span>"):I='<span class="mrerp-card-pill mrerp-pill-neutral">'+o(t("xero-card-not-connected"))+"</span>":I='<span class="mrerp-card-pill mrerp-pill-neutral">'+o(t("xero-card-not-configured"))+"</span>":I='<span class="mrerp-card-pill mrerp-pill-neutral">'+o(t("xero-card-not-connected"))+"</span>";let $="";if(!p||!p.configured)$='<button type="button" class="int-btn-configure" id="btn-xero-connect">'+o(t("xero-connect-btn"))+"</button>";else if(!p.connected)h()&&($='<button type="button" class="int-btn-configure" id="btn-xero-connect">'+o(t("xero-connect-btn"))+"</button>");else{const g=!!p.auto_push,c=g?t("card-btn-disable"):t("card-btn-enable");$='<button type="button" class="'+(g?"mrerp-card-toggle mrerp-card-toggle-disable":"mrerp-card-toggle mrerp-card-toggle-enable")+'" id="btn-xero-toggle-enabled" data-xero-enabled="'+(g?"1":"0")+'" title="'+o(g?t("erp-auto-push-on-tip"):t("erp-auto-push-off-tip"))+'">'+o(c)+'</button><button type="button" class="int-btn-configure" id="btn-xero-edit-toggle">'+o(t("card-btn-edit"))+"</button>"}const x=p&&p.connected?"xero-card-desc-connected":"xero-card-desc-default",M=p&&p.connected?t("xero-card-connected")||"Connected · default org will receive pushes":"Cloud accounting · push invoices to your default Xero org",W=(function(){const g=t(x);return g===x?M:g})();let G='<div class="integration-row erp-connect-xero'+(L?" connected":"")+'"><div class="int-icon ic-xero"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="9"/><circle cx="9" cy="10" r="1.3" fill="currentColor"/><circle cx="15" cy="14" r="1.3" fill="currentColor"/><path d="M9 14l6-4"/></svg></div><div class="int-info"><div class="int-name"><span>'+o(t("xero-card-title")||"Xero")+"</span>"+I+'</div><div class="int-desc">'+o(W)+'</div></div><div class="int-actions">'+$+"</div></div>";if(p&&p.configured&&p.connected&&h()){const g=p.organisations||[];let c="";if(g.length>0){c+='<div class="erp-cc-meta">'+o((t("xero-org-count")||"").replace("{n}",String(g.length)))+"</div>",c+='<div class="erp-cc-org-label">'+o(t("xero-default-org"))+":</div>",c+='<div class="erp-cc-orgs">',g.forEach(function(Y){c+='<label class="erp-cc-org-row"><input type="radio" name="xero-default-org" value="'+o(Y.id)+'"'+(Y.is_default?" checked":"")+'><span class="erp-cc-org-name">'+o(Y.organisation_name||Y.organisation_id)+"</span></label>"}),c+="</div>";const H=!!p.auto_push,P=H?t("erp-auto-push-on-tip"):t("erp-auto-push-off-tip");c+='<div class="erp-cc-auto-push" title="'+o(P)+'"><label class="erp-cc-toggle"><input type="checkbox" id="xero-auto-push-toggle"'+(H?" checked":"")+'><span class="erp-cc-toggle-slider"></span><span class="erp-cc-toggle-label">'+o(t("erp-auto-push-label"))+"</span></label></div>",c+='<div class="erp-cc-actions"><button class="btn btn-ghost btn-tiny" type="button" id="btn-xero-disconnect">'+o(t("xero-disconnect-btn"))+"</button></div>"}G+='<div class="erp-xero-details" id="erp-xero-details" style="display:none; margin:8px 0 16px; padding:12px 14px; border:1px solid var(--line); border-radius:8px; background:var(--bg);">'+c+"</div>"}const K=l.querySelector(".erp-connect-xero"),te=l.querySelector("#erp-xero-details");te&&te.remove(),K?K.outerHTML=G:l.insertAdjacentHTML("afterbegin",G);const re=document.getElementById("btn-xero-edit-toggle");re&&re.addEventListener("click",function(g){g.preventDefault();const c=document.getElementById("erp-xero-details");c&&(c.style.display=c.style.display==="none"?"":"none")});const S=document.getElementById("btn-xero-toggle-enabled");S&&S.addEventListener("click",async function(g){if(g.preventDefault(),S.disabled)return;const H=!(S.getAttribute("data-xero-enabled")==="1");if(!H)try{if(!await window.pearnlyConfirm(t("card-toggle-disable-confirm")))return}catch{}S.disabled=!0,await E(H,null)})}async function w(){const l=localStorage.getItem("mrpilot_token");if(l)try{const p=await fetch("/api/erp/xero/auth/start",{method:"GET",headers:{Authorization:"Bearer "+l}});if(!p.ok){let L="unknown";try{L=(await p.json()).detail||"unknown"}catch{}const $=String(L).replace(/^xero\./,"").toLowerCase();i(t("xero-push-fail").replace("{err}",t("xero-err-"+$)||L),"error");return}const I=await p.json();I.redirect_url&&(window.location.href=I.redirect_url)}catch(p){i(t("xero-push-fail").replace("{err}",p.message||"network"),"error")}}async function u(){if(!await window.pearnlyConfirm(t("xero-disconnect-confirm")))return;const p=localStorage.getItem("mrpilot_token");try{const I=await fetch("/api/erp/xero/disconnect",{method:"POST",headers:{Authorization:"Bearer "+p}});if(!I.ok)throw new Error("http_"+I.status);await s(!0),f()}catch(I){i(t("xero-push-fail").replace("{err}",I.message),"error")}}async function d(l){const p=localStorage.getItem("mrpilot_token");try{const I=await fetch("/api/erp/xero/select_org",{method:"POST",headers:{Authorization:"Bearer "+p,"Content-Type":"application/json"},body:JSON.stringify({token_id:l})});if(!I.ok)throw new Error("http_"+I.status);await s(!0),f()}catch(I){i(t("xero-push-fail").replace("{err}",I.message),"error")}}async function E(l,p){const I=localStorage.getItem("mrpilot_token");p&&(p.disabled=!0);try{const L=await fetch("/api/erp/xero/auto-push",{method:"POST",headers:{Authorization:"Bearer "+I,"Content-Type":"application/json"},body:JSON.stringify({on:!!l})});if(!L.ok){let $="unknown";try{$=(await L.json()).detail||"unknown"}catch{}throw new Error($)}i(l?t("erp-auto-push-toggled-on"):t("erp-auto-push-toggled-off"),"success"),a=!1,await s(!0),f()}catch(L){p&&(p.checked=!l),i(t("erp-auto-push-toggle-fail").replace("{err}",L.message||"network"),"error")}finally{p&&(p.disabled=!1)}}async function k(){const l=document.getElementById("drawer-history-save");if(!l||l.querySelector("#btn-xero-push")||l.querySelector("#pn-push-wrap")||(await s(!1),l.querySelector("#pn-push-wrap"))||l.querySelector("#btn-xero-push"))return;const p=b();if(!(p&&(p._historyId||p.history_id)))return;let L=!1,$="xero-push-tip";!e||!e.configured?(L=!0,$="xero-err-not_configured"):e.connected?_(p)&&(L=!0,$="xero-push-disabled-exc"):(L=!0,$="xero-push-disabled-no-conn");const x=document.createElement("button");x.type="button",x.id="btn-xero-push",x.className="btn btn-ghost"+(L?" disabled":""),x.disabled=L,x.title=t($)||"",x.innerHTML='<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"><circle cx="8" cy="8" r="6"/><path d="M5 8l2 2 4-4"/></svg><span style="margin-left:4px;">'+o(t("xero-push-btn"))+"</span>",x.addEventListener("click",R);const M=document.getElementById("btn-push-erp");M&&M.parentNode?M.parentNode.insertBefore(x,M.nextSibling):l.insertBefore(x,l.firstChild)}async function R(){const l=b(),p=l&&(l._historyId||l.history_id);if(!p)return;const I=document.getElementById("btn-xero-push");I&&(I.disabled=!0,I.classList.add("loading"));const L=localStorage.getItem("mrpilot_token");try{const $=await fetch("/api/erp/xero/push/"+encodeURIComponent(p),{method:"POST",headers:{Authorization:"Bearer "+L}});if(!$.ok){let x="unknown";try{x=(await $.json()).detail||"unknown"}catch{}const M=String(x).replace(/^xero\./,"").toLowerCase(),W=t("xero-"+M),G=W&&W!=="xero-"+M?W:x;i(t("xero-push-fail").replace("{err}",G),"error");return}i(t("xero-push-ok"),"success")}catch($){i(t("xero-push-fail").replace("{err}",$.message||"network"),"error")}finally{I&&(I.disabled=!1,I.classList.remove("loading"))}}async function q(){await s(!0),f(),y()}async function y(){const l=document.getElementById("erp-global-push-mode");if(!l)return;const p=localStorage.getItem("mrpilot_token");if(p)try{const I=await fetch("/api/settings/erp-push-mode",{headers:{Authorization:"Bearer "+p}});if(I.ok){const L=await I.json();L.mode&&(l.value=L.mode,l.dataset.prev=L.mode)}}catch{}}async function B(l){const p=l.value,I=localStorage.getItem("mrpilot_token");try{(await fetch("/api/settings/erp-push-mode",{method:"PUT",headers:{Authorization:"Bearer "+I,"Content-Type":"application/json"},body:JSON.stringify({mode:p})})).ok?(l.dataset.prev=p,i(t("pref-erp-mode-saved"),"success")):(l.value=l.dataset.prev||"smart",i(t("pref-save-failed"),"error"))}catch{l.value=l.dataset.prev||"smart",i(t("pref-save-failed"),"error")}}function O(){try{const l=String(window.location.hash||"");if(l.indexOf("xero=ok")>=0){const p=l.match(/n=(\d+)/),I=p?p[1]:"1";i((t("xero-toast-redirected-ok")||"").replace("{n}",I),"success"),history.replaceState(null,"",window.location.pathname+"#automation"),s(!0).then(f)}else l.indexOf("xero=err")>=0&&(i(t("xero-toast-redirected-err"),"error"),history.replaceState(null,"",window.location.pathname+"#automation"))}catch{}}function D(){if(n)return;n=!0,document.addEventListener("click",function(p){if(p.target.closest('.erp-subtab[data-erp-subtab="connect"]')){setTimeout(q,50);return}if(p.target.closest('.auto-nav-item[data-auto-tab="erp"]')){setTimeout(q,80);return}if(p.target.closest("#btn-xero-connect")){p.preventDefault(),w();return}if(p.target.closest("#btn-xero-disconnect")){p.preventDefault(),u();return}}),document.addEventListener("change",function(p){p.target&&p.target.matches('input[name="xero-default-org"]')&&d(p.target.value),p.target&&p.target.id==="xero-auto-push-toggle"&&E(p.target.checked,p.target),p.target&&p.target.id==="erp-global-push-mode"&&B(p.target)});const l=function(){return document.getElementById("drawer-body")};try{const p=new MutationObserver(function(){document.getElementById("drawer-history-save")&&!document.getElementById("btn-xero-push")&&k()}),I=l();if(I)p.observe(I,{childList:!0,subtree:!0});else{const L=new MutationObserver(function(){const $=l();$&&(p.observe($,{childList:!0,subtree:!0}),L.disconnect())});L.observe(document.body,{childList:!0,subtree:!0})}}catch{}setTimeout(O,500)}function F(){e&&f();const l=document.getElementById("btn-xero-push");if(l){const p=l.querySelector("span");p&&(p.textContent=t("xero-push-btn"))}}D(),typeof window.subscribeI18n=="function"&&window.subscribeI18n("xero-adapter",F);async function A(l){const p=Date.now();for(;Date.now()-p<l;){if(typeof _userInfo<"u"&&_userInfo&&_userInfo.id)return _userInfo;await new Promise(I=>setTimeout(I,80))}return null}async function v(){await A(5e3);const l=document.querySelector('.auto-nav-item.active[data-auto-tab="erp"]'),p=document.querySelector('.erp-subtab.active[data-erp-subtab="connect"]');l&&p&&await q()}setTimeout(v,200)})();(function(){const e={};function a(){if(document.getElementById("report-modal"))return;const f=`
        ...
        </div>`,w=document.createElement("div");w.innerHTML=f,document.body.appendChild(w.firstElementChild),document.getElementById("report-modal-close-x").addEventListener("click",n),document.getElementById("report-modal-cancel").addEventListener("click",n),document.getElementById("report-modal").addEventListener("click",u=>{u.target.id==="report-modal"&&n()})}function n(){const f=document.getElementById("report-modal");f&&(f.style.display="none"),o=null}let o=null;async function i(f,w){const u=f+":"+(w||"");if(e[u])return e[u];let d;try{const E=localStorage.getItem("mrpilot_token"),k=await fetch(`/api/reports/templates?lang=${encodeURIComponent(f)}`,{headers:{Authorization:"Bearer "+E}});if(!k.ok)throw new Error("templates fetch failed");d=(await k.json()).templates||[]}catch(E){console.error("fetchTemplates fail",E),d=[{code:"input_vat",name:t("tpl-input-vat"),desc:t("tpl-input-vat-desc"),recommended:!0},{code:"standard",name:t("tpl-standard"),desc:t("tpl-standard-desc"),recommended:!1},{code:"print",name:t("tpl-print"),desc:t("tpl-print-desc"),recommended:!1}]}if(d=d.filter(E=>E.code!=="erp"),w==="history-batch"){const E=d.findIndex(R=>R.code==="standard"),k=E>=0?E+1:d.length;d.splice(k,0,{code:"sales_detail_th",name:t("export-tpl-sales-detail"),desc:t("export-tpl-sales-detail-desc"),recommended:!1,is_new:!0})}return e[u]=d,d}function h(f){const w=document.getElementById("report-tpl-list"),u=f.map((E,k)=>`
        ...
        `;w.innerHTML=u+d}function b(f){return f==null?"":String(f).replace(/[&<>"']/g,w=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[w])}function _(f){const w=new Date,u=w.getFullYear(),d=w.getMonth()+1;if(f==="all")return"all";if(f==="this-month")return`${u}-${String(d).padStart(2,"0")}`;if(f==="last-month"){const E=new Date(u,d-2,1);return`${E.getFullYear()}-${String(E.getMonth()+1).padStart(2,"0")}`}return f==="this-year"?`${u}`:f==="this-quarter"?`${u}-Q${Math.floor((d-1)/3)+1}`:"all"}window.openReportModal=async function(f){f=f||{},a(),typeof applyLang=="function"?applyLang(currentLang):document.querySelectorAll("#report-modal [data-i18n]").forEach(R=>{const q=R.getAttribute("data-i18n");I18N[currentLang]&&I18N[currentLang][q]&&(R.textContent=I18N[currentLang][q])});const w=document.getElementById("report-period-section");w&&(w.style.display=f.mode==="client"?"":"none");const u=document.getElementById("report-tpl-list");u.innerHTML=`<div class="report-tpl-loading">${b(t("report-modal-loading"))}</div>`,document.getElementById("report-modal").style.display="";const d=await i(currentLang,f&&f.mode);h(d),o=f;const E=document.getElementById("report-modal-download"),k=E.cloneNode(!0);E.parentNode.replaceChild(k,E),k.addEventListener("click",()=>s(o))};async function s(f){if(!f)return;const w=document.querySelector('input[name="report-tpl"]:checked');if(!w){showToast(t("report-toast-no-selection"),"info");return}const u=w.value,d=document.querySelector('input[name="report-period"]:checked'),E=d?d.value:"all",k=_(E),R=document.getElementById("report-modal-download"),q=R.innerHTML;R.disabled=!0,R.innerHTML=`<span>${b(t("report-modal-loading"))}</span>`;try{const y=localStorage.getItem("mrpilot_token");let B,O;if(f.mode==="records")B=await fetch("/api/reports/export",{method:"POST",headers:{Authorization:"Bearer "+y,"Content-Type":"application/json"},body:JSON.stringify({template:u,lang:currentLang,records:f.records||[],meta:f.meta||{}})}),O=`mrpilot-${u}-${Date.now()}.xlsx`;else if(f.mode==="client"){const I=`/api/reports/clients/${f.clientId}/export?template=${encodeURIComponent(u)}&lang=${encodeURIComponent(currentLang)}&month=${encodeURIComponent(k)}`;B=await fetch(I,{headers:{Authorization:"Bearer "+y}}),O=`${(f.clientName||"client").replace(/[^a-zA-Z0-9\u0e00-\u0e7f\u4e00-\u9fff]/g,"_").slice(0,40)}-${u}.xlsx`}else if(f.mode==="history-batch")u==="sales_detail_th"?(B=await fetch("/api/ocr/export-by-history-ids",{method:"POST",headers:{Authorization:"Bearer "+y,"Content-Type":"application/json"},body:JSON.stringify({template:"sales_detail_th",lang:currentLang,history_ids:f.historyIds||[],client_id:f.clientId||null})}),O=`Pearnly_SalesDetail_${Date.now()}.xlsx`):(B=await fetch("/api/reports/history/batch_export",{method:"POST",headers:{Authorization:"Bearer "+y,"Content-Type":"application/json"},body:JSON.stringify({template:u,lang:currentLang,history_ids:f.historyIds||[],client_id:f.clientId||null})}),O=`mrpilot-batch-${u}-${Date.now()}.xlsx`);else throw new Error("unknown mode: "+f.mode);if(!B.ok){let I="HTTP "+B.status;try{const L=await B.json();L&&L.detail&&(I=L.detail)}catch(L){console.warn("[batch-export] resp.json err.detail parse failed:",L)}B.status===404?showToast(t("report-toast-empty"),"info"):showToast(t("report-toast-fail")+" · "+I,"error");return}const D=await B.blob();let F=O;const v=(B.headers.get("Content-Disposition")||"").match(/filename\*=UTF-8''([^;]+)/i);if(v)try{F=decodeURIComponent(v[1])}catch{}const l=URL.createObjectURL(D),p=document.createElement("a");p.href=l,p.download=F,document.body.appendChild(p),p.click(),document.body.removeChild(p),URL.revokeObjectURL(l),showToast(t("report-toast-success"),"success"),n()}catch(y){console.error("doDownload fail",y),showToast(t("report-toast-fail")+" · "+(y.message||""),"error")}finally{R.disabled=!1,R.innerHTML=q}}document.addEventListener("DOMContentLoaded",()=>{const f=document.getElementById("btn-export");if(f){const u=f.cloneNode(!0);f.parentNode.replaceChild(u,f),u.addEventListener("click",()=>{if(typeof _results>"u"||!_results||_results.length===0){showToast(t("report-toast-no-selection"),"info");return}openReportModal({mode:"records",records:_results.map(d=>({filename:d.filename,merged_fields:d.merged_fields||{}}))})})}const w=document.getElementById("history-batch-export");w&&w.addEventListener("click",()=>{if(typeof _historySelected>"u"||_historySelected.size===0){showToast(t("report-toast-no-selection"),"info");return}openReportModal({mode:"history-batch",historyIds:Array.from(_historySelected)})})}),window.openClientExportModal=function(f,w){openReportModal({mode:"client",clientId:f,clientName:w||""})}})();(function(){const a=typeof window<"u"&&"showDirectoryPicker"in window,n=/\.(pdf|jpe?g|png|webp)$/i,o="mrpilot_folder_watcher",i=1;let h=null,b=null,_=null,s=60,f=!1,w=!1,u=0,d=0,E=0,k=[],R=null,q=!1;function y(){return h||(h=new Promise((m,C)=>{const T=indexedDB.open(o,i);T.onupgradeneeded=U=>{const N=U.target.result;N.objectStoreNames.contains("handles")||N.createObjectStore("handles"),N.objectStoreNames.contains("seen")||N.createObjectStore("seen"),N.objectStoreNames.contains("config")||N.createObjectStore("config")},T.onsuccess=U=>m(U.target.result),T.onerror=U=>C(U.target.error)}),h)}function B(m,C){return y().then(T=>new Promise((U,N)=>{const j=T.transaction(m,"readonly").objectStore(m).get(C);j.onsuccess=()=>U(j.result),j.onerror=()=>N(j.error)}))}function O(m,C,T){return y().then(U=>new Promise((N,r)=>{const j=U.transaction(m,"readwrite");j.objectStore(m).put(T,C),j.oncomplete=()=>N(),j.onerror=()=>r(j.error)}))}function D(m,C){return y().then(T=>new Promise((U,N)=>{const r=T.transaction(m,"readwrite");r.objectStore(m).delete(C),r.oncomplete=()=>U(),r.onerror=()=>N(r.error)}))}function F(m){return y().then(C=>new Promise((T,U)=>{const N=C.transaction(m,"readwrite");N.objectStore(m).clear(),N.oncomplete=()=>T(),N.onerror=()=>U(N.error)}))}async function A(m){if(!m)return!1;try{const C={mode:"read"};let T=await m.queryPermission(C);return T==="granted"?!0:(T=await m.requestPermission(C),T==="granted")}catch(C){return console.warn("[folder] permission check failed:",C),!1}}function v(m,C){const T=document.getElementById("folder-status-summary");T&&(T.setAttribute("data-i18n",m),T.textContent=t(m),T.className="auto-status-pill"+(C?" "+C:""))}function l(m){["folder-unsupported","folder-empty","folder-active"].forEach(C=>{const T=document.getElementById(C);T&&(T.style.display=C===m?"":"none")})}function p(m){if(!m)return"-";const C=m instanceof Date?m:new Date(m),T=String(C.getHours()).padStart(2,"0"),U=String(C.getMinutes()).padStart(2,"0"),N=String(C.getSeconds()).padStart(2,"0");return`${T}:${U}:${N}`}function I(){l("folder-active");const m=document.getElementById("folder-config-path");m&&b&&(m.textContent=b.name||"-");const C=document.getElementById("folder-interval-select");C&&(C.value=String(s)),document.getElementById("folder-stat-last").textContent=R?p(R):"-",document.getElementById("folder-stat-processed").textContent=String(u),document.getElementById("folder-stat-failed").textContent=String(d),document.getElementById("folder-stat-queue").textContent=String(E);const T=document.getElementById("btn-folder-pause"),U=document.getElementById("btn-folder-resume");T&&(T.style.display=f?"none":""),U&&(U.style.display=f?"":"none"),f?v("folder-status-paused","paused"):v("folder-status-running","running");const N=document.getElementById("folder-status-text");N&&(N.setAttribute("data-i18n",f?"folder-status-paused":"folder-status-running"),N.textContent=t(f?"folder-status-paused":"folder-status-running"));const r=document.getElementById("folder-status-pulse");r&&(r.className="folder-status-pulse"+(f?" paused":"")),L()}function L(){const m=document.getElementById("folder-recent-list");if(m){if(k.length===0){m.innerHTML=`<div class="folder-recent-empty">${escapeHtml(t("folder-recent-empty"))}</div>`;return}m.innerHTML=k.slice(0,20).map(C=>{let T;C.status==="ok"?T=`<span class="folder-recent-icon ok">${svgIcon("check",12)}</span>`:C.status==="dup"?T=`<span class="folder-recent-icon dup" title="${escapeHtml(t("folder-recent-dup"))}">${svgIcon("copy",12)}</span>`:C.status==="skip"?T=`<span class="folder-recent-icon skip" title="${escapeHtml(t("folder-recent-skip"))}">${svgIcon("minus",12)}</span>`:T=`<span class="folder-recent-icon fail">${svgIcon("alert",12)}</span>`;const U=C.status==="fail"&&C.error?C.error:C.status==="dup"&&C.reason||C.status==="skip"&&C.reason?C.reason:"",N=U?`<div class="folder-recent-err">${escapeHtml(U)}</div>`:"";return`
        ...
        `}function L(){const x=document.getElementById("btn-email-bind");x&&x.addEventListener("click",()=>w("new"));const M=document.getElementById("btn-email-edit");M&&M.addEventListener("click",()=>w("edit"));const W=document.getElementById("btn-email-unbind");W&&W.addEventListener("click",A);const G=document.getElementById("btn-email-trigger");G&&G.addEventListener("click",v);const K=document.getElementById("email-enabled-toggle");K&&K.addEventListener("change",l);const te=document.getElementById("email-modal-close");te&&te.addEventListener("click",u);const re=document.getElementById("btn-email-modal-cancel");re&&re.addEventListener("click",u);const S=document.getElementById("btn-email-modal-test");S&&S.addEventListener("click",D);const g=document.getElementById("btn-email-modal-save");g&&g.addEventListener("click",F);const c=document.getElementById("email-preset");c&&c.addEventListener("change",Y=>d(Y.target.value));const H=document.getElementById("email-address");H&&!H.dataset.autoBound&&(H.dataset.autoBound="1",H.addEventListener("blur",Y=>k((Y.target.value||"").trim())),H.addEventListener("input",Y=>{const Z=(Y.target.value||"").trim();Z.includes("@")&&Z.split("@")[1].includes(".")&&k(Z)}));const P=document.getElementById("btn-email-refresh-logs");P&&P.addEventListener("click",()=>{P.classList.add("spinning"),setTimeout(()=>P.classList.remove("spinning"),600),p()})}L(),window._loadEmailIngestPanel=h,window._rerenderEmailIngest=function(){if(!o)return;b();const x=document.getElementById("email-logs-section");e&&x&&x.open&&p()};let $=null;window._startEmailLogAutoRefresh=function(){$||($=setInterval(()=>{e&&o&&p()},3e4))},window._stopEmailLogAutoRefresh=function(){$&&(clearInterval($),$=null)}})();(function(){let e=[],a=null,n=[],o="all",i=null,h=!1;async function b(){if(h){L();return}h=!0,_(),await s(),L()}function _(){const r=document.getElementById("bank-file-input");r&&!r._bound&&(r._bound=!0,r.addEventListener("change",k));const j=document.getElementById("btn-bank-queue-clear-done");j&&!j._bound&&(j._bound=!0,j.addEventListener("click",D));const z=document.getElementById("btn-bank-back");z&&!z._bound&&(z._bound=!0,z.addEventListener("click",()=>{a=null,n=[],te()}));const J=document.getElementById("btn-bank-delete");J&&!J._bound&&(J._bound=!0,J.addEventListener("click",l));const X=document.getElementById("btn-bank-run-match");X&&!X._bound&&(X._bound=!0,X.addEventListener("click",v)),document.querySelectorAll(".bank-filter-btn").forEach(ve=>{ve._bound||(ve._bound=!0,ve.addEventListener("click",()=>{o=ve.dataset.bankFilter||"all",document.querySelectorAll(".bank-filter-btn").forEach(fe=>{fe.classList.toggle("active",fe===ve)}),Z()}))}),document.querySelectorAll("[data-bank-cand-close]").forEach(ve=>{ve._bound||(ve._bound=!0,ve.addEventListener("click",ne))});const de=document.getElementById("btn-bank-cand-pane-close");de&&!de._bound&&(de._bound=!0,de.addEventListener("click",ne));const se=document.getElementById("btn-bank-cand-ignore");se&&!se._bound&&(se._bound=!0,se.addEventListener("click",p));const ce=document.getElementById("btn-bank-cand-ignore-pane");ce&&!ce._bound&&(ce._bound=!0,ce.addEventListener("click",p));const ae=document.getElementById("bank-client-badge");ae&&!ae._bound&&(ae._bound=!0,ae.addEventListener("click",g)),document.querySelectorAll("[data-bank-client-picker-close]").forEach(ve=>{ve._bound||(ve._bound=!0,ve.addEventListener("click",c))});const pe=document.getElementById("btn-bank-client-picker-save");pe&&!pe._bound&&(pe._bound=!0,pe.addEventListener("click",P)),document.querySelectorAll(".bank-sessions-chip").forEach(ve=>{ve._bound||(ve._bound=!0,ve.addEventListener("click",()=>{$=ve.dataset.sessFilter||"all",document.querySelectorAll(".bank-sessions-chip").forEach(fe=>{fe.classList.toggle("active",fe===ve)}),x()}))})}async function s(){try{const r=await fetch("/api/bank-recon/sessions?limit=30",{headers:{Authorization:"Bearer "+token}});if(!r.ok)throw new Error("sessions:"+r.status);e=await r.json(),x()}catch(r){console.warn("[bank-recon] loadSessions failed",r),e=[],x()}}async function f(r){try{const j="/api/bank-recon/sessions/"+encodeURIComponent(r)+(o!=="all"?"?filter="+o:""),z=await fetch(j,{headers:{Authorization:"Bearer "+token}});if(!z.ok)throw new Error("detail:"+z.status);const J=await z.json();a=J.session,n=J.transactions||[],K()}catch(j){console.warn("[bank-recon] loadSessionDetail failed",j),showToast(t("bank-load-failed"),"error")}}let w=[],u=0;const d=3;function E(){return u+=1,"q"+u+"_"+Date.now()}async function k(r){const j=Array.from(r.target.files||[]);if(r.target.value="",j.length!==0){for(const z of j){const J={id:E(),file:z,name:z.name,size:z.size,status:"pending",progress:0,error_code:null,tx_count:0,session_id:null};z.name.toLowerCase().endsWith(".pdf")?z.size>20*1024*1024&&(J.status="failed",J.error_code="bank_recon.file_too_large"):(J.status="failed",J.error_code="bank_recon.only_pdf"),w.push(J)}R(),q(),F()}}function R(){const r=document.getElementById("bank-upload-queue");r&&(r.style.display=""),oe(),ue()}function q(){const r=document.getElementById("bank-upload-queue-list"),j=document.getElementById("bank-upload-queue-summary");if(!r)return;if(w.length===0){r.innerHTML="",j&&(j.textContent="");const se=document.getElementById("bank-upload-queue");se&&(se.style.display="none");return}let z=0,J=0,X=0,de=0;for(const se of w)se.status==="ok"?z++:se.status==="failed"?J++:se.status==="uploading"||se.status==="parsing"?X++:de++;j&&(j.textContent=t("bank-queue-summary").replace("{ok}",z).replace("{run}",X).replace("{wait}",de).replace("{fail}",J)),r.innerHTML=w.map(y).join(""),r.querySelectorAll("[data-q-act]").forEach(se=>{const ce=se.dataset.qAct,ae=se.dataset.qId;se.addEventListener("click",()=>{ce==="retry"&&B(ae),ce==="remove"&&O(ae)})})}function y(r){const j=(r.size/1024).toFixed(0)+" KB";let z="",J="";if(r.status==="pending")z='<span class="bq-stat bq-wait">'+t("bank-queue-status-wait")+"</span>",J='<button data-q-act="remove" data-q-id="'+N(r.id)+'" class="bq-act">×</button>';else if(r.status==="uploading")z='<span class="bq-stat bq-run">'+t("bank-queue-status-uploading")+'</span><div class="bq-bar"><div class="bq-bar-fill" style="width:'+(r.progress||0)+'%"></div></div>';else if(r.status==="parsing")z='<span class="bq-stat bq-run">'+t("bank-queue-status-parsing")+'</span><div class="bq-bar"><div class="bq-bar-fill bq-bar-indet"></div></div>';else if(r.status==="ok")z='<span class="bq-stat bq-ok">'+t("bank-queue-status-ok").replace("{n}",r.tx_count||0)+"</span>",J='<button data-q-act="remove" data-q-id="'+N(r.id)+'" class="bq-act">×</button>';else if(r.status==="failed"){const X=m(r.error_code||"unknown");z='<span class="bq-stat bq-fail" title="'+N(X)+'">'+N(X)+"</span>",J='<button data-q-act="retry" data-q-id="'+N(r.id)+'" class="bq-act bq-act-retry">'+t("bank-queue-retry")+'</button><button data-q-act="remove" data-q-id="'+N(r.id)+'" class="bq-act">×</button>'}return'<div class="bq-row" data-q-row="'+N(r.id)+'"><div class="bq-name" title="'+N(r.name)+'">'+N(r.name)+'</div><div class="bq-size">'+j+'</div><div class="bq-status">'+z+'</div><div class="bq-actions">'+J+"</div></div>"}function B(r){const j=w.find(z=>z.id===r);j&&(j.status="pending",j.error_code=null,j.progress=0,q(),F())}function O(r){const j=w.findIndex(J=>J.id===r);if(j<0)return;const z=w[j];z.status==="uploading"||z.status==="parsing"||(w.splice(j,1),q())}function D(){w=w.filter(r=>r.status!=="ok"),q()}async function F(){for(;;){if(w.filter(z=>z.status==="uploading"||z.status==="parsing").length>=d)return;const j=w.find(z=>z.status==="pending");if(!j){w.every(z=>z.status==="ok"||z.status==="failed")&&(await s(),typeof window.loadReconcilePage=="function"&&window.loadReconcilePage());return}A(j).then(()=>F())}}async function A(r){r.status="uploading",r.progress=0,q();try{const j=new FormData;j.append("file",r.file,r.name);const z=await new Promise((X,de)=>{const se=new XMLHttpRequest;se.open("POST","/api/bank-recon/upload"),se.setRequestHeader("Authorization","Bearer "+token),se.upload.onprogress=ce=>{ce.lengthComputable&&(r.progress=Math.min(99,Math.round(ce.loaded/ce.total*100)),q())},se.upload.onload=()=>{r.status="parsing",q()},se.onload=()=>{se.status>=200&&se.status<300?X({status:se.status,text:se.responseText}):X({status:se.status,text:se.responseText})},se.onerror=()=>de(new Error("network")),se.send(j)});let J={};try{J=JSON.parse(z.text||"{}")}catch{J={}}if(z.status>=400){r.status="failed",r.error_code=J&&J.detail||"unknown",q();return}if(J.parse_status==="parse_failed"){r.status="failed",r.error_code=J.error==="scanned_pdf_not_yet"?"bank_recon.scanned":"bank_recon.no_tx",q();return}r.status="ok",r.tx_count=J.tx_count||0,r.session_id=J.session_id||null,q()}catch(j){console.warn("[bank-recon] upload failed",j),r.status="failed",r.error_code="network",q()}}async function v(){if(!a)return;const r=document.getElementById("btn-bank-run-match"),j=r.innerHTML;r.disabled=!0,r.innerHTML="<span>"+t("bank-matching")+"</span>";try{const z=await fetch("/api/bank-recon/sessions/"+encodeURIComponent(a.id)+"/match",{method:"POST",headers:{Authorization:"Bearer "+token}});if(!z.ok)throw new Error("match:"+z.status);const J=await z.json();showToast(t("bank-match-done").replace("{matched}",J.matched).replace("{suggested}",J.suggested).replace("{unmatched}",J.unmatched),"success"),await f(a.id),await s()}catch(z){console.warn("[bank-recon] match failed",z),showToast(t("bank-match-failed"),"error")}finally{r.disabled=!1,r.innerHTML=j}}async function l(){if(!(!a||!await showConfirm(t("bank-delete-confirm"),{danger:!0})))try{const j=await fetch("/api/bank-recon/sessions/"+encodeURIComponent(a.id),{method:"DELETE",headers:{Authorization:"Bearer "+token}});if(!j.ok)throw new Error("delete:"+j.status);showToast(t("bank-deleted"),"success"),a=null,n=[],te(),await s()}catch(j){console.warn("[bank-recon] delete failed",j),showToast(t("bank-delete-failed"),"error")}}async function p(){if(i)try{const r=await fetch("/api/bank-recon/tx/"+encodeURIComponent(i.id)+"/override",{method:"POST",headers:{Authorization:"Bearer "+token,"Content-Type":"application/json"},body:JSON.stringify({status:"ignored"})});if(!r.ok)throw new Error("ignore:"+r.status);ne(),await f(a.id)}catch{showToast(t("bank-action-failed"),"error")}}async function I(r){if(i)try{const j=await fetch("/api/bank-recon/tx/"+encodeURIComponent(i.id)+"/override",{method:"POST",headers:{Authorization:"Bearer "+token,"Content-Type":"application/json"},body:JSON.stringify({status:"matched",history_id:r})});if(!j.ok)throw new Error("pick:"+j.status);showToast(t("bank-matched-ok"),"success"),ne(),await f(a.id)}catch{showToast(t("bank-action-failed"),"error")}}function L(){const r=document.getElementById("bank-status-summary");if(!r)return;if(e.length===0){r.textContent=t("bank-pill-none");return}let z=0;for(const J of e)J.parse_status==="parsed"&&(J.unmatched_count||0)>0&&z++;r.textContent=z>0?t("bank-pill-pending").replace("{n}",z):t("bank-pill-ok")}let $="all";function x(){const r=document.getElementById("bank-sessions-list");if(!r)return;let j=e||[];if($==="parsed"?j=j.filter(z=>z.parse_status==="parsed"):$==="failed"&&(j=j.filter(z=>z.parse_status==="parse_failed")),!e||e.length===0){r.innerHTML='<div class="bank-empty" data-i18n="bank-sessions-empty">'+t("bank-sessions-empty")+"</div>";return}if(j.length===0){r.innerHTML='<div class="bank-empty">'+t("bank-sess-filter-empty")+"</div>";return}r.innerHTML=j.map(z=>W(z)).join(""),r.querySelectorAll(".bank-session-row").forEach(z=>{z.addEventListener("click",J=>{J.target.closest(".bank-session-trash")||f(z.dataset.sessionId)})}),r.querySelectorAll(".bank-session-trash").forEach(z=>{z.addEventListener("click",J=>{J.stopPropagation();const X=z.dataset.sessionId,de=z.dataset.sessionName||"";M(X,de)})})}async function M(r,j){if(!r)return;const z=(t("bank-session-delete-confirm")||"确定删除这条对账记录吗?").replace("{name}",j||"");if(await showConfirm(z,{danger:!0}))try{const X=await fetch("/api/bank-recon/sessions/"+encodeURIComponent(r),{method:"DELETE",headers:{Authorization:"Bearer "+token}});if(!X.ok)throw new Error("delete:"+X.status);showToast(t("bank-deleted"),"success"),a&&a.id===r&&(a=null,n=[],te()),await s(),typeof window.loadReconcilePage=="function"&&window.loadReconcilePage()}catch(X){console.warn("[bank-recon] delete failed",X),showToast(t("bank-delete-failed"),"error")}}window._deleteBankSession=M;function W(r){const j=(r.bank_code||"OTHER").toUpperCase(),z=U(r.period_start,r.period_end),J=r.account_last4?"···"+r.account_last4:"",X=G(r),de=T(r.created_at);return`
...
`,e.dataset.wbInjected="1";try{const a=window._currentLang||localStorage.getItem("mrpilot_lang")||"th",n=window.I18N;n&&n[a]&&(e.querySelectorAll("[data-i18n]").forEach(o=>{const i=o.getAttribute("data-i18n");n[a][i]&&(o.textContent=n[a][i])}),e.querySelectorAll("[data-i18n-placeholder]").forEach(o=>{const i=o.getAttribute("data-i18n-placeholder");n[a][i]&&(o.placeholder=n[a][i])}))}catch{}}})();(function(){let e=[],a=null,n="",o="seller";const i={page:0,pageSize:12,keyword:""},h=new Set;let b=[];const _={keyword:""};let s=null;function f(){return{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||"")}}async function w(c,H={}){const P=await fetch(c,{...H,headers:{"Content-Type":"application/json",...f(),...H.headers||{}}});if(!P.ok){const Y=await P.json().catch(()=>({}));throw new Error(Y.detail||"HTTP "+P.status)}return P.json()}async function u(){try{e=(await w("/api/clients")).clients||[],window._clientsCache=e}catch(c){console.error("loadClientsCache fail",c),e=[]}try{typeof window._refreshExcClientFilter=="function"&&window._refreshExcClientFilter()}catch{}try{typeof window._refreshClientSwitcher=="function"&&window._refreshClientSwitcher()}catch{}return e}function d(c){o=c==="buyer"?"buyer":"seller",document.querySelectorAll("[data-cust-tab]").forEach(Y=>Y.classList.toggle("active",Y.dataset.custTab===o));const H=document.getElementById("cust-pane-seller"),P=document.getElementById("cust-pane-buyer");H&&H.classList.toggle("active",o==="seller"),P&&P.classList.toggle("active",o==="buyer")}function E(){const c=window._userInfo||{},H=String(c.role||"").toLowerCase(),P=String(c.tenant_role||"").toLowerCase();return c.is_super_admin===!0||c.is_owner===!0||H==="owner"||H==="admin"||P==="owner"||P==="admin"}function k(){window._workspaceClientsCache=b,typeof window.renderWorkspaceControl=="function"&&window.renderWorkspaceControl()}async function R(){try{const c=await w("/api/workspace/clients");b=c&&(c.clients||c.items)||[],window._workspaceClientsCache=b}catch(c){console.error("loadSellerCache fail",c),b=[]}return b}function q(){const c=_.keyword.trim().toLowerCase();return c?b.filter(H=>(H.name||"").toLowerCase().includes(c)||(H.tax_id||"").toLowerCase().includes(c)):b}function y(){const c=document.getElementById("seller-tbody");if(!c)return;const H=E(),P=document.getElementById("btn-seller-new");P&&(P.style.display=H?"":"none");const Y=q(),Z=typeof window.getActiveWorkspaceClientId=="function"?window.getActiveWorkspaceClientId():null;if(!Y.length){c.innerHTML=`<div class="cust-empty">${escapeHtml(t(_.keyword?"cust-no-match":"seller-empty"))}</div>`;return}c.innerHTML=Y.map(le=>{const V=Z!=null&&Number(Z)===Number(le.id)?`<span class="cust-badge-current"><svg viewBox="0 0 14 14" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M2 7.5l3.2 3.2L12 4"/></svg>${escapeHtml(t("seller-current"))}</span>`:`<button class="cust-row-btn primary" data-saction="activate" data-wid="${le.id}">${escapeHtml(t("seller-set-current"))}</button>`,Q=H?`
            ...
            </div>`}).join("")}function B(c){s=c?c.id:null,document.getElementById("wsclient-modal-title").textContent=t(c?"wsclient-modal-edit":"wsclient-modal-new"),document.getElementById("wsclient-input-name").value=c&&c.name||"",document.getElementById("wsclient-input-tax").value=c&&c.tax_id||"",document.getElementById("wsclient-modal-archive").style.display=c?"":"none",document.getElementById("wsclient-modal-mask").style.display="flex",setTimeout(()=>document.getElementById("wsclient-input-name").focus(),50)}function O(){document.getElementById("wsclient-modal-mask").style.display="none",s=null}async function D(){const c=document.getElementById("wsclient-input-name").value.trim(),H=document.getElementById("wsclient-input-tax").value.trim();if(!c){showToast(t("client-msg-name-required"),"fail");return}try{s?(await w("/api/workspace/clients/"+s,{method:"PATCH",body:JSON.stringify({name:c,tax_id:H})}),showToast(t("client-msg-updated"),"success")):(await w("/api/workspace/clients",{method:"POST",body:JSON.stringify({name:c,tax_id:H||null})}),showToast(t("client-msg-created"),"success")),O(),await R(),y(),k()}catch(P){const Y=P&&P.message?P.message:t("client-msg-save-fail");showToast(t("client-msg-save-fail")+" · "+Y,"fail")}}async function F(){if(!s)return;const c=b.find(P=>Number(P.id)===Number(s));if(await showConfirm(t("wsclient-archive-confirm").replace("{name}",c?c.name:""),{danger:!0}))try{const P=s;await w("/api/workspace/clients/"+P,{method:"DELETE"}),showToast(t("wsclient-archived"),"success"),typeof window.getActiveWorkspaceClientId=="function"&&Number(window.getActiveWorkspaceClientId())===Number(P)&&typeof window.enterPersonalMode=="function"&&window.enterPersonalMode(),O(),await R(),y(),k()}catch{showToast(t("client-msg-save-fail"),"fail")}}function A(){const c=i.keyword.trim().toLowerCase();return c?e.filter(H=>(H.name||"").toLowerCase().includes(c)||(H.short_name||"").toLowerCase().includes(c)||(H.tax_id||"").toLowerCase().includes(c)):e}function v(){const c=A(),H=i.pageSize,P=Math.max(0,Math.ceil(c.length/H)-1);i.page>P&&(i.page=P);const Y=i.page*H;return{all:c,items:c.slice(Y,Y+H),start:Y,ps:H,total:c.length,maxPage:P}}function l(){const c=document.getElementById("buyer-tbody");if(!c)return;const{items:H,start:P,ps:Y,total:Z,maxPage:le}=v();Z?c.innerHTML=H.map(ee=>{const ne=h.has(ee.id);return`<div class="cust-row buyer-grid${ne?" selected":""}" data-cid="${ee.id}">
                ...
                </div>`}).join(""):c.innerHTML=`<div class="cust-empty">${escapeHtml(t(i.keyword?"cust-no-match":"clients-empty"))}</div>`;const ie=document.getElementById("buyer-pager-info");ie&&(ie.textContent=Z?`${P+1}–${Math.min(P+Y,Z)} / ${Z}`:"0");const V=document.getElementById("buyer-prev");V&&(V.disabled=i.page<=0);const Q=document.getElementById("buyer-next");Q&&(Q.disabled=i.page>=le),p()}function p(){const c=h.size,H=document.getElementById("buyer-batch-bar");H&&(H.style.display=c?"flex":"none");const P=document.getElementById("buyer-batch-count");P&&(P.textContent=t("cust-selected-n").replace("{n}",c));const Y=document.getElementById("buyer-check-all");if(Y){const{items:Z}=v(),le=Z.map(V=>V.id),ie=le.filter(V=>h.has(V)).length;Y.checked=le.length>0&&ie===le.length,Y.indeterminate=ie>0&&ie<le.length}}function I(){h.clear(),l()}async function L(){const c=Array.from(h);if(!(!c.length||!await showConfirm(t("cust-batch-del-confirm").replace("{n}",c.length),{danger:!0})))try{await w("/api/clients/batch-delete",{method:"POST",body:JSON.stringify({ids:c})}),showToast(t("client-msg-deleted"),"success"),h.clear(),await u(),l(),te(),g()}catch{showToast(t("client-msg-save-fail"),"fail")}}window.loadClientsPage=async function(){const c=document.getElementById("seller-tbody");c&&(c.innerHTML=`<div class="cust-loading">${escapeHtml(t("clients-loading"))}</div>`);const H=document.getElementById("buyer-tbody");H&&(H.innerHTML=`<div class="cust-loading">${escapeHtml(t("clients-loading"))}</div>`),await Promise.all([R(),u()]),y(),l()},window.addEventListener("pearnly:workspace-changed",function(){typeof currentRoute<"u"&&currentRoute==="clients"&&y()});function $(c){a=c?c.id:null;const H=!!c;document.getElementById("client-modal-title").textContent=t(H?"client-modal-edit":"client-modal-new"),document.getElementById("client-input-name").value=c&&c.name||"",document.getElementById("client-input-short").value=c&&c.short_name||"",document.getElementById("client-input-tax").value=c&&c.tax_id||"",document.getElementById("client-input-address").value=c&&c.address||"",document.getElementById("client-input-contact").value=c&&c.contact_person||"",document.getElementById("client-input-phone").value=c&&c.contact_phone||"",document.getElementById("client-input-email").value=c&&c.contact_email||"",document.getElementById("client-input-notes").value=c&&c.notes||"";const P=c&&c.color||"#111111";document.querySelectorAll("#client-color-picker .color-swatch").forEach(Y=>{Y.classList.toggle("active",Y.dataset.color===P)}),document.getElementById("client-modal-delete").style.display=H?"":"none",document.getElementById("client-modal-mask").style.display="flex",setTimeout(()=>document.getElementById("client-input-name").focus(),50)}function x(){document.getElementById("client-modal-mask").style.display="none",a=null}function M(){const c=document.querySelector("#client-color-picker .color-swatch.active");return c?c.dataset.color:"#111111"}async function W(){const c=document.getElementById("client-input-name").value.trim();if(!c){showToast(t("client-msg-name-required"),"fail");return}const H={name:c,short_name:document.getElementById("client-input-short").value.trim()||null,tax_id:document.getElementById("client-input-tax").value.trim()||null,address:document.getElementById("client-input-address").value.trim()||null,contact_person:document.getElementById("client-input-contact").value.trim()||null,contact_phone:document.getElementById("client-input-phone").value.trim()||null,contact_email:document.getElementById("client-input-email").value.trim()||null,notes:document.getElementById("client-input-notes").value.trim()||null,color:M()};try{a?(await w(`/api/clients/${a}`,{method:"PATCH",body:JSON.stringify(H)}),showToast(t("client-msg-updated"),"success")):(await w("/api/clients",{method:"POST",body:JSON.stringify(H)}),showToast(t("client-msg-created"),"success")),x(),await u(),currentRoute==="clients"&&l(),te(),g()}catch(P){console.error("saveClient fail",P);const Y=P&&P.message?P.message:t("client-msg-save-fail");showToast(t("client-msg-save-fail")+" · "+Y,"fail")}}async function G(){if(!a)return;const c=e.find(Y=>Y.id===a);if(!c)return;const H=t("client-delete-confirm").replace("{name}",c.name);if(await showConfirm(H,{danger:!0}))try{await w(`/api/clients/${a}`,{method:"DELETE"}),showToast(t("client-msg-deleted"),"success"),x(),await u(),currentRoute==="clients"&&l(),te(),g()}catch(Y){console.error(Y),showToast(t("client-msg-save-fail"),"fail")}}async function K(c){const H=e.find(P=>P.id===c);if(typeof window.openClientExportModal=="function"){window.openClientExportModal(c,H?H.name:"");return}try{const P=localStorage.getItem("mrpilot_token"),Y=await fetch(`/api/clients/${c}/export?month=all`,{headers:{Authorization:"Bearer "+P}});if(!Y.ok){let Q="HTTP "+Y.status;try{const ee=await Y.json();ee&&ee.detail&&(Q=ee.detail)}catch{}throw new Error(Q)}const Z=await Y.blob();if(Z.size<200){showToast(t("client-export-month-empty"),"info");return}const le=H&&H.name?H.name.replace(/[^a-zA-Z0-9\u0e00-\u0e7f\u4e00-\u9fff]/g,"_").slice(0,40):"client",ie=URL.createObjectURL(Z),V=document.createElement("a");V.href=ie,V.download=`${le}_export.csv`,V.click(),URL.revokeObjectURL(ie)}catch(P){console.error("exportClient fail",P),showToast(t("client-msg-save-fail")+" · "+(P.message||""),"fail")}}function te(){const c=document.getElementById("drawer-client-select");if(!c)return;const H=c.value;c.innerHTML=`<option value="">${escapeHtml(t("drawer-client-none"))}</option>`+e.map(P=>`<option value="${P.id}">${escapeHtml(P.name)}</option>`).join(""),c.value=H||""}window.bindDrawerClient=function(c,H){const P=document.getElementById("drawer-client-select");if(!P)return;if(te(),P.value=H?String(H):"",!c){P.onchange=null;const Z=document.getElementById("drawer-client-add");Z&&(Z.onclick=()=>$(null));return}P.onchange=async()=>{const Z=P.value?parseInt(P.value,10):null;try{await w(`/api/history/${c}/assign_client`,{method:"POST",body:JSON.stringify({client_id:Z})}),showToast(t("client-msg-updated"),"success");const le=_results[_drawerIdx];le&&(le.client_id=Z),await u()}catch(le){console.error(le),showToast(t("client-msg-save-fail"),"fail"),P.value=H?String(H):""}};const Y=document.getElementById("drawer-client-add");Y&&(Y.onclick=()=>$(null))};let re={fetched:0,items:[],supplier_count:0};window.fillCategoryDatalist=async function(){try{const c=document.getElementById("drawer-cat-datalist"),H=Date.now();if(H-re.fetched<300*1e3){c&&(c.innerHTML=re.items.map(Y=>`<option value="${escapeHtml(Y)}">`).join("")),S(re.supplier_count);return}const P=await w("/api/categories",{method:"GET"});re.fetched=H,re.items=P&&P.categories||[],re.supplier_count=P&&P.supplier_count||0,c&&(c.innerHTML=re.items.map(Y=>`<option value="${escapeHtml(Y)}">`).join("")),S(re.supplier_count)}catch(c){console.warn("fillCategoryDatalist failed",c)}};function S(c){const H=document.getElementById("drawer-cat-learned-tag");H&&c>0&&(H.textContent=(t("drawer-suggest-learned-with-count")||"已学 {n}").replace("{n}",c))}function g(){const c=document.getElementById("history-client-filter");if(!c)return;const H=c.value;c.innerHTML=`<option value="">${escapeHtml(t("history-client-all"))}</option>`+e.map(P=>`<option value="${P.id}">${escapeHtml(P.name)}</option>`).join(""),c.value=H||""}window.getHistoryClientFilter=function(){return n},document.addEventListener("DOMContentLoaded",()=>{const c=document.querySelector(".cust-tab-bar");c&&c.addEventListener("click",ae=>{const pe=ae.target.closest("[data-cust-tab]");pe&&d(pe.dataset.custTab)});const H=document.getElementById("btn-buyer-new");H&&H.addEventListener("click",()=>$(null));const P=document.getElementById("buyer-tbody");P&&P.addEventListener("click",ae=>{const pe=ae.target.closest(".buyer-row-check");if(pe){const ge=parseInt(pe.dataset.cid,10);pe.checked?h.add(ge):h.delete(ge);const be=pe.closest(".cust-row");be&&be.classList.toggle("selected",pe.checked),p();return}const ve=ae.target.closest(".cust-row-btn");if(ve){ae.stopPropagation();const ge=parseInt(ve.dataset.cid,10);if(ve.dataset.action==="edit"){const be=e.find(ke=>ke.id===ge);be&&$(be)}else ve.dataset.action==="export"&&K(ge);return}const fe=ae.target.closest(".cust-row");if(fe&&!ae.target.closest(".cust-cell-check")){const ge=e.find(be=>be.id===parseInt(fe.dataset.cid,10));ge&&$(ge)}});const Y=document.getElementById("buyer-check-all");Y&&Y.addEventListener("change",()=>{const{items:ae}=v();ae.forEach(pe=>{Y.checked?h.add(pe.id):h.delete(pe.id)}),l()});const Z=document.getElementById("buyer-batch-cancel");Z&&Z.addEventListener("click",I);const le=document.getElementById("buyer-batch-delete");le&&le.addEventListener("click",L);const ie=document.getElementById("buyer-prev");ie&&ie.addEventListener("click",()=>{i.page>0&&(i.page--,l())});const V=document.getElementById("buyer-next");V&&V.addEventListener("click",()=>{i.page++,l()});const Q=document.getElementById("buyer-search");if(Q){let ae;Q.addEventListener("input",()=>{clearTimeout(ae),ae=setTimeout(()=>{i.keyword=Q.value,i.page=0;const pe=document.getElementById("buyer-search-clear");pe&&(pe.style.display=Q.value?"":"none"),l()},200)})}const ee=document.getElementById("buyer-search-clear");ee&&ee.addEventListener("click",()=>{const ae=document.getElementById("buyer-search");ae&&(ae.value=""),i.keyword="",i.page=0,ee.style.display="none",l()});const ne=document.getElementById("btn-seller-new");ne&&ne.addEventListener("click",()=>B(null));const oe=document.getElementById("seller-tbody");oe&&oe.addEventListener("click",ae=>{const pe=ae.target.closest("[data-saction]");if(!pe)return;ae.stopPropagation();const ve=parseInt(pe.dataset.wid,10),fe=pe.dataset.saction,ge=b.find(be=>Number(be.id)===ve);fe==="activate"?(typeof window.setActiveWorkspaceClientId=="function"&&window.setActiveWorkspaceClientId(ve),y(),typeof window.renderWorkspaceControl=="function"&&window.renderWorkspaceControl(),showToast(t("seller-activated").replace("{name}",ge?ge.name:""),"success")):fe==="edit"?ge&&B(ge):fe==="archive"&&(s=ve,F())});const ue=document.getElementById("seller-search");if(ue){let ae;ue.addEventListener("input",()=>{clearTimeout(ae),ae=setTimeout(()=>{_.keyword=ue.value;const pe=document.getElementById("seller-search-clear");pe&&(pe.style.display=ue.value?"":"none"),y()},200)})}const m=document.getElementById("seller-search-clear");m&&m.addEventListener("click",()=>{const ae=document.getElementById("seller-search");ae&&(ae.value=""),_.keyword="",m.style.display="none",y()});const C=document.getElementById("wsclient-modal-close");C&&C.addEventListener("click",O);const T=document.getElementById("wsclient-modal-cancel");T&&T.addEventListener("click",O);const U=document.getElementById("wsclient-modal-save");U&&U.addEventListener("click",D);const N=document.getElementById("wsclient-modal-archive");N&&N.addEventListener("click",F);const r=document.getElementById("wsclient-modal-mask");r&&r.addEventListener("click",ae=>{ae.target===r&&O()});const j=document.getElementById("client-modal-close");j&&j.addEventListener("click",x);const z=document.getElementById("client-modal-cancel");z&&z.addEventListener("click",x);const J=document.getElementById("client-modal-save");J&&J.addEventListener("click",W);const X=document.getElementById("client-modal-delete");X&&X.addEventListener("click",G);const de=document.getElementById("client-modal-mask");de&&de.addEventListener("click",ae=>{ae.target===de&&x()});const se=document.getElementById("client-color-picker");se&&se.addEventListener("click",ae=>{const pe=ae.target.closest(".color-swatch");pe&&(se.querySelectorAll(".color-swatch").forEach(ve=>ve.classList.remove("active")),pe.classList.add("active"))});const ce=document.getElementById("history-client-filter");ce&&ce.addEventListener("change",()=>{n=ce.value,typeof renderHistoryList=="function"&&renderHistoryList()})}),setTimeout(()=>u(),1e3)})();(function(){const e=document.getElementById("page-exceptions");if(!(!e||e.dataset.wbInjected==="1")){e.innerHTML=`
        <div class="page-head">
            <div class="page-head-icon">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round">
...
`,e.dataset.wbInjected="1";try{const a=window._currentLang||localStorage.getItem("mrpilot_lang")||"th",n=window.I18N;n&&n[a]&&(e.querySelectorAll("[data-i18n]").forEach(o=>{const i=o.getAttribute("data-i18n");n[a][i]&&(o.textContent=n[a][i])}),e.querySelectorAll("[data-i18n-placeholder]").forEach(o=>{const i=o.getAttribute("data-i18n-placeholder");n[a][i]&&(o.placeholder=n[a][i])}))}catch{}}})();(function(){let e={statsCache:null,listCache:[],currentRule:null,currentClient:"",currentStatus:"pending",loading:!1,selectedIds:new Set,offset:0,pageSize:50,total:0,loadFailed:!1,listScrollY:0};function a(S,g){let c=t(S)||S;if(g)for(const H in g)c=c.replace(new RegExp("\\{"+H+"\\}","g"),String(g[H]));return c}async function n(){try{const S=e.currentClient||"",g="/api/exceptions/stats?status=pending"+(S?"&client_id="+encodeURIComponent(S):""),c=await fetch(g,{headers:{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||"")}});if(!c.ok)return;const H=await c.json(),P=document.getElementById("nav-exc-badge");if(!P)return;const Y=parseInt(H.pending||0,10);Y>0?(P.textContent=Y>99?"99+":String(Y),P.style.display=""):P.style.display="none"}catch{}}function o(S){return S==="high"?`<svg viewBox="0 0 14 14" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
        ...
        </svg>`}function h(S){if(S==null)return"—";const g=parseFloat(S);return isNaN(g)?"—":"฿ "+g.toLocaleString(void 0,{minimumFractionDigits:2,maximumFractionDigits:2})}function b(S){return S?S.slice(0,10):"—"}function _(S){document.getElementById("exc-kpi-pending").textContent=S.pending||0,document.getElementById("exc-kpi-high").textContent=S.high_severity||0,document.getElementById("exc-kpi-resolved").textContent=S.resolved||0,document.getElementById("exc-kpi-learned").textContent=S.learned_rules||0;const g=document.getElementById("exc-status-tab-count-pending"),c=document.getElementById("exc-status-tab-count-resolved"),H=document.getElementById("exc-status-tab-count-ignored");g&&(g.textContent=S.pending||0),c&&(c.textContent=S.resolved||0),H&&(H.textContent=S.ignored||0),document.querySelectorAll("#exc-status-tabs .exc-status-tab").forEach(Y=>{Y.classList.toggle("active",Y.dataset.status===(e.currentStatus||"pending"))})}function s(S){const g=document.getElementById("exc-chips");if(!g)return;const c=S.by_rule||{},H=["confidence_low","duplicate","amount_missing","math_mismatch","tax_id_format_invalid"];let Y=`<button class="exc-chip ${!e.currentRule?"active":""}" data-rule="">
            <span>${escapeHtml(t("exc-chip-all"))}</span>
            <span class="exc-chip-count">${S.pending||0}</span>
        </button>`;for(const Z of H){const le=c[Z]||0;if(le===0&&e.currentRule!==Z)continue;const ie=e.currentRule===Z;Y+=`<button class="exc-chip ${ie?"active":""}" data-rule="${escapeHtml(Z)}">
                <span>${escapeHtml(t("exc-chip-"+Z))}</span>
                <span class="exc-chip-count">${le}</span>
            </button>`}g.innerHTML=Y,g.querySelectorAll(".exc-chip").forEach(Z=>{Z.addEventListener("click",()=>{const le=Z.dataset.rule||null;e.currentRule=le,k()})})}function f(S){const g=document.getElementById("exc-list");if(!g)return;if(!S||S.length===0){g.innerHTML=`<div class="exc-empty">
                ${i()}
                <div class="exc-empty-title">${escapeHtml(t("exc-empty-title"))}</div>
                <div>${escapeHtml(t("exc-empty-desc"))}</div>
            </div>`,u();return}const c='<svg viewBox="0 0 14 14" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M3 7l3 3 5-5"/></svg>',H=(e.currentStatus||"pending")==="pending";g.innerHTML=S.map(P=>{const Y=P.severity||"medium",Z=t("exc-rule-"+P.rule_code)||P.rule_code,le=P.seller_name&&P.seller_name.trim()?P.seller_name:t("exc-no-seller"),ie=P.filename||"—",V=b(P.invoice_date||P.created_at),Q=P.status==="pending",ee=e.selectedIds.has(P.id),ne=H&&Q;return`
            ...
            `}).join(""),g.querySelectorAll(".exc-row").forEach(P=>{P.addEventListener("click",Y=>{if(Y.target.closest(".exc-row-check"))return;const Z=P.dataset.excId;Z&&D(parseInt(Z,10))})}),g.querySelectorAll(".exc-row-check").forEach(P=>{P.addEventListener("click",Y=>{Y.stopPropagation();const Z=parseInt(P.dataset.checkId,10);Z&&(e.selectedIds.has(Z)?(e.selectedIds.delete(Z),P.classList.remove("checked"),P.closest(".exc-row").classList.remove("selected")):(e.selectedIds.add(Z),P.classList.add("checked"),P.closest(".exc-row").classList.add("selected")),w())})}),w(),u()}function w(){const S=document.getElementById("exc-batch-bar"),g=document.getElementById("exc-batch-count");if(!S||!g)return;const c=e.selectedIds.size;c===0?S.style.display="none":(S.style.display="",g.textContent=a("exc-batch-count",{n:c}))}function u(){const S=document.getElementById("exc-list-foot"),g=document.getElementById("exc-list-count"),c=document.getElementById("exc-loadmore");if(!S||!g||!c)return;const H=e.listCache.length;if(H===0){S.style.display="none";return}S.style.display="";let P=H;const Y=e.statsCache;Y&&(e.currentRule?P=(Y.by_rule||{})[e.currentRule]||H:P=Y.pending||H),e.total=P,g.textContent=a("exc-list-count",{shown:H,total:P});const Z=H<P&&H<500;c.style.display=Z?"":"none"}async function d(){try{if(navigator.onLine===!1)throw new Error("offline");const S=e.currentClient||"",g=e.currentStatus||"pending",c=new URLSearchParams;c.set("status",g),S&&c.set("client_id",S);const H="/api/exceptions/stats?"+c.toString(),P=await fetch(H,{headers:{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||"")}});if(!P.ok)throw new Error("http "+P.status);const Y=await P.json();return e.statsCache=Y,_(Y),s(Y),Y}catch(S){return console.warn("loadExceptionsStats fail",S),null}}function E(S){const g=document.getElementById("exc-list");if(!g)return;const c=`<svg class="exc-error-icon" viewBox="0 0 36 36" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round">
            ...
            </div>`;const Y=document.getElementById("exc-retry-btn");Y&&Y.addEventListener("click",()=>window.loadExceptionsPage&&window.loadExceptionsPage())}async function k(S){S=S||{};const g=!!S.append,c=document.getElementById("exc-list");!g&&c&&e.listCache.length===0&&(c.innerHTML=`<div class="exc-loading">${escapeHtml(t("exc-loading"))}</div>`);const H=new URLSearchParams;H.set("status",e.currentStatus||"pending"),e.currentRule&&H.set("rule_code",e.currentRule),e.currentClient&&H.set("client_id",e.currentClient);const P=g?e.listCache.length:0;H.set("limit",String(e.pageSize)),H.set("offset",String(P));try{if(navigator.onLine===!1)throw new Error("offline");const Y=await fetch("/api/exceptions/list?"+H.toString(),{headers:{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||"")}});if(!Y.ok)throw new Error("http "+Y.status);const le=(await Y.json()).items||[];g?e.listCache=e.listCache.concat(le):(e.listCache=le,e.selectedIds.clear()),e.loadFailed=!1,f(e.listCache),e.statsCache&&s(e.statsCache)}catch(Y){console.warn("loadExceptionsList fail",Y),e.loadFailed=!0;const Z=navigator.onLine===!1||String(Y.message||"").includes("offline");g?showToast(t("exc-toast-load-fail"),"error"):(E(Z),showToast(Z?t("exc-offline"):t("exc-toast-load-fail"),"error"))}}async function R(){if(!e.loading&&!(e.listCache.length>=500)){e.loading=!0;try{await k({append:!0})}finally{e.loading=!1}}}function q(){const S=document.getElementById("exc-client-filter");if(!S)return;const g=window._clientsCache||[],c=e.currentClient||"",H=typeof t=="function"?t("history-client-all"):"全部客户";S.innerHTML=`<option value="">${escapeHtml(H)}</option>`+g.map(P=>`<option value="${P.id}">${escapeHtml(P.name)}</option>`).join(""),S.value=c}window.loadExceptionsPage=async function(){if(!e.loading){e.loading=!0;try{q(),typeof window.loadErpExceptions=="function"&&window.loadErpExceptions(),await d(),await k()}finally{e.loading=!1}}},window.refreshExcBadge=n,window._refreshExcClientFilter=q,window._excState=e,window._rerenderExceptions=function(){try{q()}catch{}e.statsCache&&(_(e.statsCache),s(e.statsCache)),e.listCache&&e.listCache.length&&f(e.listCache);try{window._erpExcState&&window._erpExcState.items&&window._erpExcState.items.length&&typeof window._rerenderErpExceptions=="function"&&window._rerenderErpExceptions()}catch{}y.openExcId&&I()};let y={openExcId:null,excRow:null,history:null,loading:!1,pdfUrl:null,pdfStatus:"idle",editing:!1,editFields:null};function B(){if(y.pdfUrl){try{URL.revokeObjectURL(y.pdfUrl)}catch{}y.pdfUrl=null}y.pdfStatus="idle"}async function O(S,g){y.pdfStatus="loading",I();try{const c=await fetch("/api/history/"+encodeURIComponent(S)+"/pdf",{headers:{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||"")}});if(y.openExcId!==g)return;if(c.status===404){y.pdfStatus="empty",I();return}if(!c.ok)throw new Error("http "+c.status);const H=await c.blob();if(y.openExcId!==g)return;B(),y.pdfUrl=URL.createObjectURL(H),y.pdfStatus="ready",I()}catch(c){if(y.openExcId!==g)return;console.warn("loadDrawerPdf fail",c),y.pdfStatus="error",I()}}function D(S){const g=(e.listCache||[]).find(c=>c.id===S);if(!g){showToast(t("exc-drawer-error"),"error");return}e.listScrollY=window.scrollY||document.documentElement.scrollTop||0,B(),y.editing=!1,y.editFields=null,y.openExcId=S,y.excRow=g,y.history=null,document.getElementById("exc-drawer-mask").classList.add("show"),document.getElementById("exc-drawer").classList.add("show"),I(),A(g.history_id),O(g.history_id,S)}function F(){B(),y.editing=!1,y.editFields=null,y.openExcId=null,y.excRow=null,y.history=null,document.getElementById("exc-drawer-mask").classList.remove("show"),document.getElementById("exc-drawer").classList.remove("show");const S=e.listScrollY||0;S>0&&requestAnimationFrame(()=>window.scrollTo(0,S))}async function A(S){try{const g=await fetch("/api/history/"+encodeURIComponent(S),{headers:{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||"")}});if(!g.ok)throw new Error("http "+g.status);y.history=await g.json()}catch(g){console.warn("loadHistoryDetail fail",g),y.history={_err:!0}}y.excRow&&I()}function v(S){if(!S||!S.pages)return{};const g=S.pages,c=g.find(H=>!H.is_duplicate&&!H.is_copy)||g[0];return c&&c.fields||{}}function l(S){if(S==null)return"—";const g=typeof S=="number"?S:parseFloat(String(S).replace(/,/g,""));return isNaN(g)?escapeHtml(String(S)):"฿ "+g.toLocaleString(void 0,{minimumFractionDigits:2,maximumFractionDigits:2})}function p(S,g){if(g=g||{},S==="math_mismatch")return`
                <div class="exc-why-detail-row"><b>${escapeHtml(t("exc-fld-subtotal"))}</b><span>${escapeHtml(l(g.subtotal))}</span></div>
                <div class="exc-why-detail-row"><b>${escapeHtml(t("exc-fld-vat"))}</b><span>${escapeHtml(l(g.vat))}</span></div>
                <div class="exc-why-detail-row"><b>${escapeHtml(t("exc-detail-expected"))}</b><span class="v-good">${escapeHtml(l(g.total_expected))}</span></div>
                <div class="exc-why-detail-row"><b>${escapeHtml(t("exc-detail-actual"))}</b><span class="v-bad">${escapeHtml(l(g.total_actual))}</span></div>
                <div class="exc-why-detail-row"><b>${escapeHtml(t("exc-detail-diff"))}</b><span class="v-bad">${escapeHtml(l(g.diff))}</span></div>
            ...
            `;if(S==="duplicate"){const c=g.level==="exact"?t("exc-detail-dup-level-exact"):t("exc-detail-dup-level-likely");return`
            ...
            `:S==="amount_missing"?`<div class="exc-why-detail-row" style="justify-content:center;color:var(--danger);"><span>${escapeHtml(t("exc-detail-missing"))}</span></div>`:`<div class="exc-why-detail-row"><span style="font-size:11px;">${escapeHtml(JSON.stringify(g))}</span></div>`}function I(){const S=y.excRow;if(!S)return;const g=S.seller_name&&S.seller_name.trim()?S.seller_name:t("exc-no-seller"),c=S.filename||"—";document.getElementById("exc-drawer-title").textContent=c;const H="exc-status-"+(S.status||"pending"),P=t(H)||S.status,Y="s-"+(S.status||"pending"),Z=(S.invoice_date||S.created_at||"").slice(0,10);document.getElementById("exc-drawer-sub").innerHTML=`
            <span>${escapeHtml(g)}</span>
            ${S.invoice_no?`<span>· ${escapeHtml(S.invoice_no)}</span>`:""}
            ${Z?`<span>· ${escapeHtml(Z)}</span>`:""}
            <span class="exc-status-chip ${Y}">${escapeHtml(P)}</span>
        `;const le=S.severity||"medium",ie=t("exc-rule-"+S.rule_code)||S.rule_code,V=p(S.rule_code,S.detail||{}),Q=v(y.history),ee=y.history===null,ne=y.history&&y.history._err,oe=new Set;S.rule_code==="math_mismatch"?(oe.add("subtotal"),oe.add("vat"),oe.add("total_amount")):S.rule_code==="tax_id_format_invalid"?oe.add("seller_tax"):S.rule_code==="amount_missing"&&(oe.add("total_amount"),oe.add("invoice_number"));const ue=!!y.editing,m=y.editFields||{},C=(ae,pe,ve)=>{if(ee)return`<div class="exc-field-row"><label>${escapeHtml(t(pe))}</label><span class="val empty">…</span></div>`;const fe=ue?m[ae]!==void 0?m[ae]:Q[ae]!==void 0&&Q[ae]!==null?Q[ae]:"":Q[ae],ge=oe.has(ae)?"flagged":"";if(ue){const Pe=ve?"number":"text",Ie=ve?' step="0.01" inputmode="decimal"':"",Le=fe==null?"":String(fe).replace(/"/g,"&quot;");return`<div class="exc-field-row ${ge} editing">
                    <label>${escapeHtml(t(pe))}</label>
                    <input class="exc-field-input" type="${Pe}"${Ie} data-edit-key="${escapeHtml(ae)}" value="${Le}">
                </div>`}const be=ve?l(fe):fe||"",ke=fe==null||fe===""?`<span class="val empty">${escapeHtml(t("exc-empty-val"))}</span>`:`<span class="val">${escapeHtml(be)}</span>`;return`<div class="exc-field-row ${ge}"><label>${escapeHtml(t(pe))}</label>${ke}</div>`};let T="";ne?T=`<div class="exc-drawer-error">${escapeHtml(t("exc-drawer-error"))}</div>`:T=`
        ...
        `;const N=document.getElementById("exc-fld-edit");N&&N.addEventListener("click",()=>{y.editing=!0,y.editFields={...v(y.history)},I()});const r=document.getElementById("exc-fld-cancel");r&&r.addEventListener("click",()=>{y.editing=!1,y.editFields=null,I()});const j=document.getElementById("exc-fld-save");j&&j.addEventListener("click",()=>L()),document.querySelectorAll(".exc-field-input").forEach(ae=>{ae.addEventListener("input",()=>{y.editFields||(y.editFields={}),y.editFields[ae.dataset.editKey]=ae.value})});const J=document.getElementById("exc-pdf-retry");J&&y.openExcId&&J.addEventListener("click",()=>{y.excRow&&O(y.excRow.history_id,y.openExcId)});const X=S.status==="pending",de=!!(S.seller_name&&S.seller_name.trim()),se=document.getElementById("exc-btn-resolve"),ce=document.getElementById("exc-btn-ignore");se.disabled=!X,ce.disabled=!X||!de,ce.title=de?t("exc-ignore-hint"):t("exc-ignore-no-seller")}async function L(){if(!y.openExcId||!y.history||!y.history.pages||y.loading)return;y.loading=!0;const S=showToast(t("exc-fld-saving"),"loading",0);try{const g=JSON.parse(JSON.stringify(y.history.pages||[]));let c=g.findIndex(ie=>!ie.is_duplicate&&!ie.is_copy);c<0&&(c=0),g[c]||(g[c]={fields:{}});const H=g[c].fields||{},P=y.editFields||{},Y=new Set(["subtotal","vat","total_amount"]),Z={...H};for(const ie in P){let V=P[ie];if((V===""||V===void 0)&&(V=null),Y.has(ie)&&V!==null){const Q=parseFloat(V);V=isNaN(Q)?null:Q}Z[ie]=V}g[c].fields=Z;const le=await fetch("/api/history/"+encodeURIComponent(y.history.id),{method:"PUT",headers:{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||""),"Content-Type":"application/json"},body:JSON.stringify({pages:g})});if(!le.ok)throw new Error("http "+le.status);S(),showToast(t("exc-fld-save-ok"),"success"),F(),await d(),await k(),n()}catch(g){S(),console.warn("save fields fail",g),showToast(t("exc-fld-save-fail"),"error")}finally{y.loading=!1}}async function $(){if(!(!y.openExcId||y.loading)){y.loading=!0;try{const S=await fetch("/api/exceptions/"+y.openExcId+"/resolve",{method:"POST",headers:{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||"")}});if(!S.ok)throw new Error("http "+S.status);showToast(t("exc-toast-resolved"),"success"),F(),await d(),await k(),n()}catch(S){console.warn("resolve fail",S),showToast(t("exc-toast-action-fail"),"error")}finally{y.loading=!1}}}async function x(){if(!(!y.openExcId||y.loading)){y.loading=!0;try{const S=await fetch("/api/exceptions/"+y.openExcId+"/ignore",{method:"POST",headers:{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||"")}});if(!S.ok)throw new Error("http "+S.status);showToast(t("exc-toast-ignored"),"success"),F(),await d(),await k(),n()}catch(S){console.warn("ignore fail",S),showToast(t("exc-toast-action-fail"),"error")}finally{y.loading=!1}}}let M=!1;async function W(){if(M)return;const S=Array.from(e.selectedIds);if(S.length===0||!await showConfirm(a("exc-batch-confirm-resolve",{n:S.length})))return;M=!0;const c=showToast(a("exc-batch-count",{n:S.length})+" …","loading",0);try{const H=await fetch("/api/exceptions/batch",{method:"POST",headers:{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||""),"Content-Type":"application/json"},body:JSON.stringify({ids:S,action:"resolve"})});if(!H.ok)throw new Error("http "+H.status);const P=await H.json();c(),showToast(a("exc-toast-batch-resolved",{n:P.processed||0}),"success"),e.selectedIds.clear(),await d(),await k(),n()}catch(H){c(),console.warn("batch resolve fail",H),showToast(t("exc-toast-batch-fail"),"error")}finally{M=!1}}async function G(){if(M)return;const S=Array.from(e.selectedIds);if(S.length===0||!await showConfirm(a("exc-batch-confirm-ignore",{n:S.length}),{danger:!1}))return;M=!0;const c=showToast(a("exc-batch-count",{n:S.length})+" …","loading",0);try{const H=await fetch("/api/exceptions/batch",{method:"POST",headers:{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||""),"Content-Type":"application/json"},body:JSON.stringify({ids:S,action:"ignore"})});if(!H.ok)throw new Error("http "+H.status);const P=await H.json();c(),showToast(a("exc-toast-batch-ignored",{n:P.processed||0,wl:P.whitelist_added||0}),"success"),e.selectedIds.clear(),await d(),await k(),n()}catch(H){c(),console.warn("batch ignore fail",H),showToast(t("exc-toast-batch-fail"),"error")}finally{M=!1}}function K(){e.selectedIds.clear(),f(e.listCache)}document.addEventListener("click",S=>{S.target.closest("#exc-drawer-close")&&F(),S.target.closest("#exc-drawer-mask")&&F(),S.target.closest("#exc-btn-resolve")&&$(),S.target.closest("#exc-btn-ignore")&&x(),S.target.closest("#exc-batch-resolve")&&W(),S.target.closest("#exc-batch-ignore")&&G(),S.target.closest("#exc-batch-clear")&&K(),S.target.closest("#exc-loadmore")&&R()}),document.addEventListener("keydown",S=>{S.key==="Escape"&&y.openExcId&&F()}),document.addEventListener("click",S=>{S.target.closest("#btn-exc-refresh")&&(typeof window.loadExceptionsPage=="function"&&window.loadExceptionsPage(),n())}),document.addEventListener("change",S=>{if(!S.target.closest("#exc-client-filter"))return;const g=S.target;e.currentClient=g.value||"",e.currentRule=null,e.selectedIds.clear(),e.listCache=[],typeof window.loadExceptionsPage=="function"&&window.loadExceptionsPage(),n()}),document.addEventListener("click",S=>{const g=S.target.closest("#exc-status-tabs .exc-status-tab");if(!g)return;const c=g.dataset.status||"pending";c!==e.currentStatus&&(e.currentStatus=c,e.currentRule=null,e.selectedIds.clear(),e.listCache=[],typeof window.loadExceptionsPage=="function"&&window.loadExceptionsPage())}),window.addEventListener("online",()=>{e.loadFailed&&document.getElementById("page-exceptions")?.classList.contains("show")&&window.loadExceptionsPage&&window.loadExceptionsPage()}),setTimeout(n,1500),setInterval(n,6e4);function te(S){if(!S)return"—";try{const g=new Date(S),c=H=>String(H).padStart(2,"0");return`${g.getFullYear()}-${c(g.getMonth()+1)}-${c(g.getDate())} ${c(g.getHours())}:${c(g.getMinutes())}`}catch{return S.slice(0,16).replace("T"," ")}}async function re(){const S=document.getElementById("learned-list");if(S){S.innerHTML=`<div class="learned-empty">${escapeHtml(t("set-learned-loading"))}</div>`;try{const g=await fetch("/api/exception-whitelist",{headers:{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||"")}});if(!g.ok)throw new Error("http "+g.status);const H=(await g.json()).items||[];if(H.length===0){S.innerHTML=`<div class="learned-empty">${escapeHtml(t("set-learned-empty"))}</div>`;return}const P=`<svg viewBox="0 0 14 14" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round">
                ...
                `}).join("")}catch(g){console.warn("loadLearnedRules fail",g),S.innerHTML=`<div class="learned-empty">${escapeHtml(t("exc-toast-load-fail"))}</div>`}}}window.loadLearnedRules=re,document.addEventListener("click",async S=>{const g=S.target.closest("[data-del-wl]");if(!g)return;const c=parseInt(g.dataset.delWl,10);if(!c)return;const H=g.closest(".learned-row"),P=H&&H.querySelector(".learned-seller"),Y=P?P.textContent.trim():"",Z=t("set-learned-del-confirm").replace("{seller}",Y);if(await showConfirm(Z,{danger:!0}))try{const ie=await fetch("/api/exception-whitelist/"+c,{method:"DELETE",headers:{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||"")}});if(!ie.ok)throw new Error("http "+ie.status);showToast(t("set-learned-del-ok"),"success"),re(),typeof window.loadExceptionsPage=="function"&&document.getElementById("page-exceptions")?.classList.contains("show")&&window.loadExceptionsPage()}catch(ie){console.warn("delete whitelist fail",ie),showToast(t("set-learned-del-fail"),"error")}})})();(function(){let e={items:[],q:"",cat:"",selected:new Set,total:0,categories:{},pageSize:30,loading:!1,focusSearch:!1,searchCaret:0},a=null;function n(){return localStorage.getItem("mrpilot_token")||""}function o(u){const d=typeof currentLang=="string"&&currentLang||window._currentLang||"th",E=u.error_friendly&&u.error_friendly[d];if(E)return E;if(typeof humanizeError=="function"&&u.error_msg)try{return humanizeError(u.error_msg)}catch{}return t("erp-exc-reason-"+(u.category||"other"))}function i(){const u=document.getElementById("erp-exc-batch");if(!u)return;const d=e.selected.size;u.hidden=d===0;const E=u.querySelector(".erp-exc-batch-count");E&&(E.textContent=String(d))}function h(){const u=document.getElementById("erp-exc-block");if(!u)return;const d=e;if(!(d.total>0||!!d.q||!!d.cat)){u.hidden=!0,u.innerHTML="";return}u.hidden=!1;const k=d.categories||{},R=Object.keys(k).reduce((p,I)=>p+k[I],0);let q=`<button class="erp-exc-chip ${d.cat===""?"active":""}" data-erpexc-cat=""><span>${escapeHtml(t("erp-exc-cat-all"))}</span><span class="erp-exc-chip-count">${R}</span></button>`;Object.keys(k).forEach(p=>{q+=`<button class="erp-exc-chip ${d.cat===p?"active":""}" data-erpexc-cat="${escapeHtml(p)}"><span>${escapeHtml(t("erp-exc-cat-"+p))}</span><span class="erp-exc-chip-count">${k[p]}</span></button>`});const y=d.items||[],B=y.length>0&&y.every(p=>d.selected.has(p.id)),O=y.map(p=>{const I=p.state==="needs_action"?"needs":p.state==="retrying"?"retry":"fail",L=t("erp-exc-state-"+(p.state||"failed")),$=o(p),x=d.selected.has(p.id)?"checked":"";return`<div class="erp-exc-row" data-erpexc-id="${escapeHtml(p.id)}">
                ...
                <span class="ex-reason" title="${escapeHtml($)}">${escapeHtml($)}${p.error_code?` <span class="erp-exc-code">${escapeHtml(p.error_code)}</span>`:""}</span>
            ...
            <div class="erp-exc-foot">${F}</div>`;const A=document.getElementById("erp-exc-search");if(A){if(d.focusSearch){A.focus();try{A.setSelectionRange(d.searchCaret,d.searchCaret)}catch{}}A.addEventListener("input",()=>{d.q=A.value,d.focusSearch=!0,d.searchCaret=A.selectionStart||A.value.length,clearTimeout(a),a=setTimeout(()=>s(!1),350)}),A.addEventListener("blur",()=>{d.focusSearch=!1})}u.querySelectorAll(".erp-exc-chip").forEach(p=>{p.addEventListener("click",()=>{d.cat=p.dataset.erpexcCat||"",s(!1)})}),u.querySelectorAll("[data-erpexc-retry]").forEach(p=>{p.addEventListener("click",I=>{I.stopPropagation(),b(p.dataset.erpexcRetry,p)})}),u.querySelectorAll(".erp-exc-cb").forEach(p=>{p.addEventListener("change",()=>{const I=p.dataset.erpexcCb;p.checked?d.selected.add(I):d.selected.delete(I);const L=document.getElementById("erp-exc-cb-all");L&&(L.checked=y.length>0&&y.every($=>d.selected.has($.id))),i()})});const v=document.getElementById("erp-exc-cb-all");v&&v.addEventListener("change",()=>{y.forEach(p=>{v.checked?d.selected.add(p.id):d.selected.delete(p.id)}),u.querySelectorAll(".erp-exc-cb").forEach(p=>{p.checked=v.checked}),i()}),u.querySelectorAll("[data-erpexc-batch]").forEach(p=>{p.addEventListener("click",()=>_(p.dataset.erpexcBatch))});const l=document.getElementById("erp-exc-more");l&&l.addEventListener("click",()=>s(!0)),u.querySelectorAll(".erp-exc-row:not(.erp-exc-row-head)").forEach(p=>{p.addEventListener("click",I=>{I.target.closest("input,button")||typeof window._erpExcOpenEdit=="function"&&window._erpExcOpenEdit(p.dataset.erpexcId)})})}async function b(u,d){if(u){d&&(d.disabled=!0,d.textContent=t("erp-exc-retrying"));try{const E=await fetch("/api/erp/logs/"+encodeURIComponent(u)+"/retry",{method:"POST",headers:{Authorization:"Bearer "+n()}}),k=await E.json().catch(()=>({}));showToast(E.ok&&k.ok?t("erp-exc-retry-ok"):t("erp-exc-retry-fail"),E.ok&&k.ok?"success":"error")}catch{showToast(t("erp-exc-retry-fail"),"error")}if(e.selected.delete(u),s(!1),typeof window.refreshExcBadge=="function")try{window.refreshExcBadge()}catch{}}}async function _(u){const d=Array.from(e.selected);if(u==="clear"){e.selected.clear(),h();return}if(d.length!==0){if(u==="delete"){if(!await showConfirm(t("erp-exc-batch-delete-confirm",{n:d.length}),{danger:!0}))return;try{const k=await fetch("/api/erp/logs/batch-delete",{method:"POST",headers:{Authorization:"Bearer "+n(),"Content-Type":"application/json"},body:JSON.stringify({log_ids:d.slice(0,200)})}),R=await k.json().catch(()=>({}));showToast(k.ok?t("erp-exc-batch-delete-ok",{n:R.deleted||0}):t("erp-exc-retry-fail"),k.ok?"success":"error")}catch{showToast(t("erp-exc-retry-fail"),"error")}}else if(u==="retry")try{const E=await fetch("/api/erp/logs/batch-retry",{method:"POST",headers:{Authorization:"Bearer "+n(),"Content-Type":"application/json"},body:JSON.stringify({log_ids:d.slice(0,50)})}),k=await E.json().catch(()=>({}));showToast(E.ok?t("erp-exc-batch-retry-ok",{ok:k.succeeded||0,fail:(k.failed||0)+(k.skipped||0)}):t("erp-exc-retry-fail"),E.ok?"success":"error")}catch{showToast(t("erp-exc-retry-fail"),"error")}if(e.selected.clear(),s(!1),typeof window.refreshExcBadge=="function")try{window.refreshExcBadge()}catch{}}}async function s(u){const d=document.getElementById("erp-exc-block");if(!(!d||e.loading)){e.loading=!0;try{const E=new URLSearchParams;e.q&&E.set("q",e.q),e.cat&&E.set("category",e.cat),E.set("limit",String(e.pageSize)),E.set("offset",String(u?e.items.length:0));const k=await fetch("/api/erp/exceptions?"+E.toString(),{headers:{Authorization:"Bearer "+n()}});if(!k.ok){u||(d.hidden=!0);return}const R=await k.json(),q=R.items||[];e.items=u?e.items.concat(q):q,e.total=R.total||0,e.categories=R.categories||{},h()}catch{u||(d.hidden=!0)}finally{e.loading=!1}}}let f={};function w(){const u=document.getElementById("erp-exc-modal");u&&u.remove()}window._erpExcOpenEdit=function(u){const d=(e.items||[]).find(D=>String(D.id)===String(u));if(!d)return;const E=!!d.history_client_id&&d.category==="customer_mismatch",k=d.category==="product_mismatch"&&!!d.history_id&&!!d.endpoint_id,R=o(d),q=d.state==="needs_action"?"needs":d.state==="retrying"?"retry":"fail",y=(D,F)=>`<div class="erp-exc-m-row"><span class="erp-exc-m-k">${escapeHtml(D)}</span><span class="erp-exc-m-v">${escapeHtml(F||"—")}</span></div>`;let B="";if(E)B=`
                ...
                </div>`;else{const D="erp-exc-edit-hint-"+(d.category||"other");let F=t(D);(!F||F===D)&&(F=R),B=`<div class="erp-exc-m-hint">${escapeHtml(F)}</div>`}const O=document.createElement("div");if(O.id="erp-exc-modal",O.className="erp-exc-modal-overlay",O.innerHTML=`
            <div class="erp-exc-modal" role="dialog" aria-modal="true">
                ...
                <div class="erp-exc-m-body">
                    <div class="erp-exc-m-reason"><span class="erp-exc-state ${q}">${escapeHtml(t("erp-exc-state-"+(d.state||"failed")))}</span> ${escapeHtml(R)}${d.error_code?` <span class="erp-exc-code">${escapeHtml(d.error_code)}</span>`:""}</div>
            ...
            </div>`,document.body.appendChild(O),O.addEventListener("click",D=>{D.target===O&&w()}),document.getElementById("erp-exc-m-close").addEventListener("click",w),document.getElementById("erp-exc-m-cancel").addEventListener("click",w),document.getElementById("erp-exc-m-retry").addEventListener("click",()=>{w(),b(d.id,null)}),E){let D="";const F=document.getElementById("erp-exc-m-bind"),A=document.getElementById("erp-exc-m-custlist"),v=document.getElementById("erp-exc-m-search"),l=(I,L)=>{const $=(L||"").trim().toLowerCase(),x=$?I.filter(M=>(M.code||"").toLowerCase().includes($)||(M.name||"").toLowerCase().includes($)):I;if(x.length===0){A.innerHTML=`<div class="erp-exc-m-empty">${escapeHtml(t("erp-exc-edit-pick-empty"))}</div>`;return}A.innerHTML=x.slice(0,100).map(M=>`<div class="erp-exc-m-cust" data-cust-code="${escapeHtml(M.code||"")}">
                        <span class="erp-exc-m-cust-name">${escapeHtml(M.name||"")}</span>
                        <span class="erp-exc-m-cust-code">${escapeHtml(M.code||"")}</span>
                    </div>`).join(""),A.querySelectorAll(".erp-exc-m-cust").forEach(M=>{M.addEventListener("click",()=>{D=M.dataset.custCode||"",A.querySelectorAll(".erp-exc-m-cust").forEach(W=>W.classList.remove("sel")),M.classList.add("sel"),F&&(F.disabled=!D)})})},p=async()=>{const I=d.endpoint_id;if(f[I]){l(f[I],"");return}try{const L=await fetch("/api/erp/endpoints/"+encodeURIComponent(I)+"/customers",{headers:{Authorization:"Bearer "+n()}}),$=await L.json().catch(()=>({}));if(!L.ok||!$.ok){A.innerHTML=`<div class="erp-exc-m-empty">${escapeHtml(t("erp-exc-edit-pick-fail"))}</div>`;return}const x=$.customers||[];f[I]=x,l(x,"")}catch{A.innerHTML=`<div class="erp-exc-m-empty">${escapeHtml(t("erp-exc-edit-pick-fail"))}</div>`}};v&&v.addEventListener("input",()=>l(f[d.endpoint_id]||[],v.value)),p(),F&&F.addEventListener("click",async()=>{if(D){F.disabled=!0,F.textContent=t("erp-exc-retrying");try{if(!(await fetch("/api/erp/mappings/clients",{method:"POST",headers:{Authorization:"Bearer "+n(),"Content-Type":"application/json"},body:JSON.stringify({client_id:d.history_client_id,erp_type:d.endpoint_adapter,erp_code:D})})).ok){showToast(t("erp-exc-retry-fail"),"error"),F.disabled=!1,F.textContent=t("erp-exc-edit-bind-retry");return}showToast(t("erp-exc-edit-bound-ok"),"success"),w(),await b(d.id,null)}catch{showToast(t("erp-exc-retry-fail"),"error"),F.disabled=!1,F.textContent=t("erp-exc-edit-bind-retry")}}})}if(k){const D=document.getElementById("erp-exc-m-bind-prod"),F=document.getElementById("erp-exc-m-prodlist"),A={};let v=[];const l=()=>'<option value="">'+escapeHtml(t("erp-exc-edit-prod-choose"))+"</option>"+v.slice(0,500).map(L=>`<option value="${escapeHtml(L.code||"")}" data-pname="${escapeHtml(L.name||"")}">`+escapeHtml((L.name||"")+" · "+(L.code||""))+"</option>").join(""),p=L=>{if(!L.length){F.innerHTML=`<div class="erp-exc-m-empty">${escapeHtml(t("erp-exc-edit-prod-noitems"))}</div>`;return}F.innerHTML=L.map($=>`<div class="erp-exc-m-cust" style="cursor:default">
                        <span class="erp-exc-m-cust-name" title="${escapeHtml($)}">${escapeHtml($)}</span>
                        <select class="erp-exc-m-prod-sel" data-item="${escapeHtml($)}" style="max-width:55%;flex:0 0 auto;padding:4px 6px;border:1px solid var(--border,#e5e7eb);border-radius:6px;font-size:12px">${l()}</select>
                    </div>`).join(""),F.querySelectorAll(".erp-exc-m-prod-sel").forEach($=>{$.addEventListener("change",()=>{const x=$.dataset.item,M=$.options[$.selectedIndex];$.value?A[x]={code:$.value,name:M&&M.dataset.pname||""}:delete A[x],D&&(D.disabled=Object.keys(A).length===0)})})};(async()=>{try{const $=await(await fetch("/api/history/"+encodeURIComponent(d.history_id),{headers:{Authorization:"Bearer "+n()}})).json().catch(()=>({})),x=$&&$.pages||[],M=[],W={};(Array.isArray(x)?x:[]).forEach(te=>{const re=te&&te.fields&&te.fields.items||[];(Array.isArray(re)?re:[]).forEach(S=>{const g=(S&&(S.name||S.description)||"").trim();g&&!W[g]&&(W[g]=1,M.push(g))})});const G=await fetch("/api/erp/endpoints/"+encodeURIComponent(d.endpoint_id)+"/products",{headers:{Authorization:"Bearer "+n()}}),K=await G.json().catch(()=>({}));if(!G.ok||!K.ok){F.innerHTML=`<div class="erp-exc-m-empty">${escapeHtml(t("erp-exc-edit-prod-fail"))}</div>`;return}v=K.products||[],p(M)}catch{F.innerHTML=`<div class="erp-exc-m-empty">${escapeHtml(t("erp-exc-edit-prod-fail"))}</div>`}})(),D&&D.addEventListener("click",async()=>{const L=Object.entries(A);if(L.length){D.disabled=!0,D.textContent=t("erp-exc-retrying");try{for(const[$,x]of L)if(!(await fetch("/api/erp/mappings/products",{method:"POST",headers:{Authorization:"Bearer "+n(),"Content-Type":"application/json"},body:JSON.stringify({erp_type:d.endpoint_adapter,item_name:$,erp_code:x.code,erp_name:x.name})})).ok){showToast(t("erp-exc-retry-fail"),"error"),D.disabled=!1,D.textContent=t("erp-exc-edit-bind-prod-retry");return}showToast(t("erp-exc-edit-prod-bound-ok"),"success"),w(),await b(d.id,null)}catch{showToast(t("erp-exc-retry-fail"),"error"),D.disabled=!1,D.textContent=t("erp-exc-edit-bind-prod-retry")}}})}},window._rerenderErpExceptions=h,window.loadErpExceptions=s,window._erpExcState=e})();(function(){function e(u){try{if(location.search.indexOf("test_center=1")>=0||localStorage.getItem("pearnly_test_mode")==="1"||u&&u.id&&String(u.id)==="468b50c1-5593-4fd6-990d-515ce8085563")return!0}catch{}return!1}window.applyRoleVisibility=function(){var d=window._userInfo,E=!1,k=!0,R=!1,q=!1;d&&(E=typeof canManageTeam=="function"?canManageTeam(d):!!(d.role==="owner"||d.is_super_admin),k=typeof shouldHideMoney=="function"?shouldHideMoney(d):d.role==="member"&&!d.is_super_admin,R=typeof isSuperAdmin=="function"?isSuperAdmin(d):!!d.is_super_admin,q=e(d)),document.querySelectorAll("[data-show-if-team]").forEach(function(B){B.style.display=E?"":"none"}),document.querySelectorAll("[data-show-if-money]").forEach(function(B){B.style.display=k?"none":""}),document.querySelectorAll("[data-show-if-admin]").forEach(function(B){B.style.display=R?"":"none"}),document.querySelectorAll("[data-show-if-test]").forEach(function(B){B.style.display=q?"":"none"});var y=R||q;document.querySelectorAll("[data-show-if-special]").forEach(function(B){B.style.display=y?"":"none"})},window.renderAvatarMenu=function(d){if(d){var E=document.getElementById("avatar-btn"),k=document.getElementById("avatar-popup-name"),R=document.getElementById("avatar-popup-email");if(!(!E||!k||!R)){var q=(d.username||"").trim(),y=q.split("@")[0]||q||"—",B=(q.charAt(0)||"?").toUpperCase(),O=(d.avatar_url||"").trim();if(O){var D=O.replace(/"/g,"&quot;"),F=B.replace(/'/g,"\\'");E.innerHTML='<img src="'+D+'" alt="'+B+`" referrerpolicy="no-referrer" onerror="this.parentNode.textContent='`+F+`'">`}else E.textContent=B;k.textContent=y,R.textContent=q||"—",E.setAttribute("title",q||"")}}};function a(){var u=document.getElementById("avatar-wrap"),d=document.getElementById("avatar-btn"),E=document.getElementById("avatar-popup");if(!u||!d||!E)return;function k(){E.classList.remove("show"),d.setAttribute("aria-expanded","false")}function R(){E.classList.add("show"),d.setAttribute("aria-expanded","true")}d.addEventListener("click",function(q){q.stopPropagation(),E.classList.contains("show")?k():R()}),document.addEventListener("click",function(q){E.classList.contains("show")&&!u.contains(q.target)&&k()}),E.addEventListener("click",function(q){var y=q.target.closest(".avatar-popup-item");if(y){var B=y.dataset.action;switch(k(),B){case"settings":typeof openSettingsModal=="function"?openSettingsModal():typeof routeTo=="function"&&routeTo("settings");break;case"team":typeof openSettingsModal=="function"?openSettingsModal():typeof routeTo=="function"&&routeTo("settings"),setTimeout(function(){typeof switchSettingsTab=="function"&&switchSettingsTab("team")},50);break;case"billing":typeof openSettingsModal=="function"?openSettingsModal():typeof routeTo=="function"&&routeTo("settings"),setTimeout(function(){typeof switchSettingsTab=="function"&&switchSettingsTab("plan")},50);break;case"shortcuts":if(typeof showToast=="function"){var O=typeof t=="function"?t("feature-coming-soon"):"即将上线";showToast(O||"即将上线","info")}break;case"admin":window.location.href="/admin/cost";break;case"test-center":typeof routeTo=="function"&&routeTo("test-center");break;case"help":var D=document.getElementById("help-modal");D&&(D.style.display="flex");break;case"logout":try{localStorage.removeItem("mrpilot_token")}catch{}try{localStorage.removeItem("mrpilot_user")}catch{}window.location.href="/";break}}}),window._closeAvatarPopup=k}function n(){return[].slice.call(document.querySelectorAll(".cmdk-item")).filter(function(u){return u.style.display!=="none"})}function o(u){var d=n();d.forEach(function(E){E.classList.remove("focus")}),d[u]&&(d[u].classList.add("focus"),d[u].scrollIntoView({block:"nearest"}))}function i(u){var d=n();if(d.length){var E=d.findIndex(function(R){return R.classList.contains("focus")});E<0&&(E=0);var k=(E+u+d.length)%d.length;o(k)}}function h(u){u=(u||"").toLowerCase().trim();var d=0,E=window._userInfo,k=typeof isSuperAdmin=="function"?isSuperAdmin(E):!!(E&&E.is_super_admin),R=e(E);document.querySelectorAll(".cmdk-item").forEach(function(y){if(y.dataset.showIfAdmin==="1"&&!k){y.style.display="none";return}if(y.dataset.showIfTest==="1"&&!R){y.style.display="none";return}var B=(y.dataset.cmdkText||y.textContent||"").toLowerCase(),O=!u||B.indexOf(u)>=0;y.style.display=O?"":"none",y.classList.remove("focus"),O&&d++}),document.querySelectorAll("[data-cmdk-section]").forEach(function(y){for(var B=y.nextElementSibling,O=!1;B&&!B.hasAttribute("data-cmdk-section");){if(B.classList&&B.classList.contains("cmdk-item")&&B.style.display!=="none"){O=!0;break}B=B.nextElementSibling}y.style.display=O?"":"none"});var q=document.getElementById("cmdk-empty");q&&(q.style.display=d===0?"flex":"none"),o(0)}window.openCmdk=function(){var d=document.getElementById("cmdk-mask");d&&(typeof window._closeAvatarPopup=="function"&&window._closeAvatarPopup(),d.classList.add("show"),typeof window.applyRoleVisibility=="function"&&window.applyRoleVisibility(),setTimeout(function(){var E=document.getElementById("cmdk-input");E&&(E.value="",h(""),E.focus(),o(0))},50))},window.closeCmdk=function(){var d=document.getElementById("cmdk-mask");d&&d.classList.remove("show")};function b(u){if(u){if(u.classList.contains("cmdk-item-locked")){if(typeof showToast=="function"){var d=typeof t=="function"?t("feature-coming-soon"):"即将上线";showToast(d||"即将上线","info")}return}var E=u.dataset.cmdkRoute,k=u.dataset.cmdkAction;if(window.closeCmdk(),E){typeof routeTo=="function"&&routeTo(E);return}if(k){if(k==="open-admin"){window.location.href="/admin/cost";return}if(k.indexOf("lang-")===0){var R=k.slice(5);typeof applyLang=="function"&&applyLang(R)}}}}function _(){var u=document.getElementById("cmdk-mask"),d=document.getElementById("cmdk-input"),E=document.getElementById("cmdk-body");if(!(!u||!d||!E)){u.addEventListener("click",function(q){q.target===u&&window.closeCmdk()});var k=document.getElementById("cmdk-esc-btn");k&&k.addEventListener("click",function(){window.closeCmdk()}),d.addEventListener("input",function(q){h(q.target.value)}),d.addEventListener("keydown",function(q){q.key==="ArrowDown"?(q.preventDefault(),i(1)):q.key==="ArrowUp"?(q.preventDefault(),i(-1)):q.key==="Enter"?(q.preventDefault(),b(u.querySelector(".cmdk-item.focus"))):q.key==="Escape"&&(q.preventDefault(),window.closeCmdk())}),E.addEventListener("click",function(q){var y=q.target.closest(".cmdk-item");y&&b(y)}),E.addEventListener("mousemove",function(q){var y=q.target.closest(".cmdk-item");!y||y.style.display==="none"||y.classList.contains("cmdk-item-locked")||(n().forEach(function(B){B.classList.remove("focus")}),y.classList.add("focus"))});var R=document.getElementById("topbar-search");R&&(R.addEventListener("click",function(){window.openCmdk()}),R.addEventListener("keydown",function(q){(q.key==="Enter"||q.key===" ")&&(q.preventDefault(),window.openCmdk())}))}}document.addEventListener("keydown",function(u){if((u.metaKey||u.ctrlKey)&&(u.key==="k"||u.key==="K")){u.preventDefault(),window.openCmdk();return}if(u.key==="Escape"){var d=document.getElementById("cmdk-mask");if(d&&d.classList.contains("show")){window.closeCmdk();return}var E=document.getElementById("avatar-popup");E&&E.classList.contains("show")&&typeof window._closeAvatarPopup=="function"&&window._closeAvatarPopup()}});try{var s=(navigator.userAgent||"").toLowerCase(),f=s.indexOf("mac")>=0||s.indexOf("iphone")>=0||s.indexOf("ipad")>=0;f||document.body.classList.add("is-windows")}catch{}function w(){a(),_(),typeof window.subscribeI18n=="function"&&window.subscribeI18n("nav-ia-phase1-role",function(){try{typeof window.applyRoleVisibility=="function"&&window.applyRoleVisibility()}catch{}})}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",w):w()})();(function(){function a(k){return String(k??"").replace(/[&<>"']/g,function(R){return{"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"}[R]})}function n(k){if(!k||isNaN(k))return"";var R=Number(k);return R<1024?R+" B":R<1024*1024?(R/1024).toFixed(1)+" KB":(R/1024/1024).toFixed(1)+" MB"}document.addEventListener("click",function(k){var R=k.target.closest&&k.target.closest(".recon-collapse-head");if(R&&!(k.target.closest("button")||k.target.closest("a"))){var q=R.closest(".recon-collapse");if(q){var y=q.getAttribute("data-collapsed")==="true";q.setAttribute("data-collapsed",y?"false":"true"),y&&(q.id==="vex-summary-collapse"&&w(),q.id==="vex-detail-collapse"&&u())}}}),document.addEventListener("keydown",function(k){if(!(k.key!=="Enter"&&k.key!==" ")){var R=k.target.closest&&k.target.closest(".recon-collapse-head");R&&(k.preventDefault(),R.click())}});var o={vat:"",gl:""};window._glvClearPreviewSearch=function(){o.vat="",o.gl=""};var i='<svg class="vex-pp-fi-icon" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#111111" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/></svg>',h='<svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg>';function b(){s("vat"),s("gl")}function _(k){try{if(typeof window._glvPreviewFiles=="function")return window._glvPreviewFiles(k)||[]}catch{}var R=document.getElementById(k==="vat"?"glv-vat-input":"glv-gl-input");return R&&R.files?Array.from(R.files):[]}function s(k){var R=document.getElementById(k==="vat"?"glv-pp-vat-col":"glv-pp-gl-col");if(R){var q=_(k),y=k==="vat"?"glv-up-vat-title":"glv-up-gl-title",B=k==="vat"?"① 销项税报告":"② 总账 GL",O=window.t&&window.t(y)||B,D=a(window.t&&window.t("vex-preview-search")||"搜索文件名..."),F=a(window.t&&window.t("vex-preview-clear-all")||"全清"),A=o[k]||"",v=q.length;R.innerHTML='<div class="vex-pp-col-title"><span class="vex-pp-col-name">'+a(O)+' <span class="vex-pp-col-count">'+v+'</span></span></div><div class="vex-pp-search-row"><input class="vex-pp-search" id="glv-pp-search-'+k+'" type="text" placeholder="'+D+'" value="'+a(A)+'" autocomplete="off"><button class="vex-pp-clear-btn" id="glv-pp-clearall-'+k+'" type="button">'+F+'</button></div><div class="vex-pp-file-list" id="glv-pp-'+k+'-list"></div><div class="vex-pp-pagination" id="glv-pp-'+k+'-pg"></div>';var l=document.getElementById("glv-pp-search-"+k);l&&l.addEventListener("input",function(I){o[k]=I.target.value,f(k)});var p=document.getElementById("glv-pp-clearall-"+k);p&&p.addEventListener("click",function(){window._glvRemoveFile&&window._glvRemoveFile(k)}),f(k)}}function f(k){var R=document.getElementById("glv-pp-"+k+"-list"),q=document.getElementById("glv-pp-"+k+"-pg");if(R){var y=_(k),B=(o[k]||"").toLowerCase(),O=y.map(function(A,v){return{f:A,i:v}}),D=B?O.filter(function(A){return A.f.name.toLowerCase().indexOf(B)>=0}):O;if(R.innerHTML=D.map(function(A){var v=A.f;return'<div class="vex-pp-file-row">'+i+'<span class="vex-pp-fi-name" title="'+a(v.name)+'">'+a(v.name)+'</span><span class="vex-pp-fi-size">'+n(v.size)+'</span><button class="vex-pp-fi-del" type="button" data-kind="'+k+'" data-idx="'+A.i+'" aria-label="remove">'+h+"</button></div>"}).join(""),R.querySelectorAll(".vex-pp-fi-del").forEach(function(A){A.addEventListener("click",function(){var v=A.dataset.kind,l=parseInt(A.dataset.idx,10);window._glvRemoveFile&&window._glvRemoveFile(v,isNaN(l)?null:l)})}),q){var F=window.t&&window.t("vex-preview-count")||"显示前 {n} / 共 {m}";q.textContent=F.replace("{n}",D.length).replace("{m}",D.length)}}}function w(){var k=function(q,y){var B=document.getElementById(q);B&&(B.textContent=y==null?"—":String(y))},R=window._vexLastTask||{};k("vex-sum-total",R.total),k("vex-sum-matched",R.matched),k("vex-sum-diff",R.diff),k("vex-sum-incomplete",R.incomplete),k("vex-sum-cash",R.cash),document.getElementById("vex-summary-sub")}function u(){var k=window._vexLastTask&&window._vexLastTask.diff_rows||[],R=document.getElementById("vex-detail-tbody"),q=document.getElementById("vex-detail-table"),y=document.getElementById("vex-detail-empty");if(!(!R||!q||!y)){if(k.length===0){q.style.display="none",y.style.display="";return}y.style.display="none",q.style.display="";var B=k.map(function(D){return'<tr><td class="recon-detail-cell-mono">'+a(D.invoice_no||"")+"</td><td>"+a(D.field||"")+"</td><td>"+a(D.report_value||"")+"</td><td>"+a(D.invoice_value||"")+"</td><td>"+a(D.kind||"")+"</td></tr>"}).join("");R.innerHTML=B;var O=document.getElementById("vex-detail-sub");O&&(O.textContent=String(k.length))}}function d(){var k=document.getElementById("glv-toggle-preview");k&&!k._reconBound&&(k._reconBound=!0,k.addEventListener("click",function(){var R=document.getElementById("glv-preview-panel"),q=document.getElementById("glv-toggle-preview-label"),y=R&&R.style.display!=="none";R&&(R.style.display=y?"none":""),k.classList.toggle("open",!y),q&&(q.textContent=y?window.t&&window.t("vex-toggle-preview-open")||"查看清单":window.t&&window.t("vex-toggle-preview-close")||"收起清单"),y||b()})),["glv-vat-input","glv-gl-input"].forEach(function(R){var q=document.getElementById(R);!q||q._reconWatched||(q._reconWatched=!0,q.addEventListener("change",function(){var y=document.getElementById("glv-preview-panel");y&&y.style.display!=="none"&&b()}))})}function E(){var k=document.getElementById("vex-summary-collapse"),R=document.getElementById("vex-detail-collapse");k&&(k.style.display=""),R&&(R.style.display=""),w(),u()}window._fillVexSummary=w,window._fillVexDetail=u,window._onVexResultShown=E,document.addEventListener("DOMContentLoaded",function(){d()}),setTimeout(d,1500),typeof window.subscribeI18n=="function"&&window.subscribeI18n("recon-collapse",function(){var k=document.getElementById("glv-preview-panel");k&&k.style.display!=="none"&&b();var R=document.getElementById("glv-toggle-preview-label"),q=document.getElementById("glv-toggle-preview");R&&q&&(R.textContent=q.classList.contains("open")?window.t&&window.t("vex-toggle-preview-close")||"收起清单":window.t&&window.t("vex-toggle-preview-open")||"查看清单")}),window._reconCollapse={renderGlvPreview:b,fillVexSummary:w,fillVexDetail:u}})();(function(){function e(h){}function a(){const h=document.querySelectorAll("[data-recon-tab]");h.forEach(_=>{_.addEventListener("click",()=>{h.forEach(d=>d.classList.remove("active")),_.classList.add("active");const s=_.dataset.reconTab,f=document.getElementById("recon-pane-bank"),w=document.getElementById("recon-pane-sale-vat"),u=document.getElementById("recon-pane-gl-vat");f&&(f.style.display=s==="bank"?"":"none"),w&&(w.style.display=s==="sale-vat"?"":"none"),u&&(u.style.display=s==="gl-vat"?"":"none"),s==="gl-vat"&&window.GlVatRecon&&window.GlVatRecon.ensureInit(),s==="bank"&&typeof window._bankReconV2Init=="function"&&window._bankReconV2Init()})});const b=document.querySelector("[data-recon-tab].active");b&&(b.dataset.reconTab,void 0)}function n(){const h=document.getElementById("page-settings");if(!h)return null;let b=document.getElementById("settings-modal-overlay");if(b)return b;b=document.createElement("div"),b.id="settings-modal-overlay",b.className="settings-modal-overlay",b.style.display="none",h.parentElement.insertBefore(b,h),b.appendChild(h);const _=document.createElement("button");return _.id="settings-modal-close",_.className="settings-modal-close",_.setAttribute("aria-label","close"),_.innerHTML='<svg viewBox="0 0 20 20" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M5 5l10 10M15 5L5 15"/></svg>',h.insertBefore(_,h.firstChild),_.addEventListener("click",i),b.addEventListener("click",s=>{s.target===b&&i()}),b}function o(){const h=n();if(!h)return;h.style.display="flex",document.body.classList.add("settings-modal-open");const b=document.getElementById("page-settings");b&&(b.style.display="block"),setTimeout(()=>{try{typeof renderSettings=="function"&&renderSettings()}catch(s){console.warn("renderSettings:",s)}let _=document.querySelector(".settings-tab.active")||document.querySelector('.settings-tab[data-tab="profile"]');_&&_.click()},50)}function i(){const h=document.getElementById("settings-modal-overlay");h&&(h.style.display="none"),document.body.classList.remove("settings-modal-open")}window.openSettingsModal=o,window.closeSettingsModal=i,document.addEventListener("keydown",h=>{if(h.key==="Escape"){const b=document.getElementById("settings-modal-overlay");b&&b.style.display==="flex"&&i()}}),window.addEventListener("hashchange",()=>{location.hash==="#/settings"&&o()}),window.addEventListener("DOMContentLoaded",()=>{location.hash==="#/settings"&&o()}),document.readyState==="loading"?document.addEventListener("DOMContentLoaded",a):a()})();(function(){const n=/\.(pdf|jpe?g|png|webp|tiff?|xlsx?|xlsm|csv|tsv|docx?)$/i,o=V=>document.getElementById(V);function i(){return{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||"")}}function h(V){return String(V??"").replace(/[&<>"']/g,Q=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[Q])}function b(V){return V<1024?V+" B":V<1024*1024?(V/1024).toFixed(1)+" KB":(V/1024/1024).toFixed(1)+" MB"}let _=[],s=[],f=!1,w=[],u=50,d=50,E="",k="";async function R(){try{const V=await fetch("/api/vat_excel/tasks?page=1&page_size=1",{headers:i()});if(!V.ok)return;const ee=(await V.json()).kpi||{};[["vex-kpi-month-val",ee.this_month],["vex-kpi-running-val",ee.running],["vex-kpi-done-val",ee.done],["vex-kpi-failed-val",ee.failed]].forEach(([ne,oe])=>{const ue=document.getElementById(ne);ue&&(ue.textContent=oe??0)})}catch{}}async function q(){try{const V=await fetch("/api/vat_excel/tasks?page=1&page_size=100",{headers:i()});if(!V.ok)return;const Q=await V.json();D(Q.rows||[])}catch{}}const y=10;var B=1;function O(){var V=((document.getElementById("vex-task-search")||{}).value||"").trim().toLowerCase();if(B=1,D(w),!!V){var Q=document.getElementById("vex-task-tbody");Q&&Q.querySelectorAll("tr").forEach(function(ee){ee.dataset.taskId&&(ee.style.display=ee.textContent.toLowerCase().indexOf(V)>=0?"":"none")})}}function D(V){w=V||w;const Q=document.getElementById("vex-task-tbody");if(!Q)return;if(!w.length){Q.innerHTML='<tr><td colspan="9" class="vex-task-empty">'+(t("sv-empty-title")||"还没有对账任务")+"</td></tr>",F(0);return}const ee=Math.ceil(w.length/y);B>ee&&(B=ee);const ne=(B-1)*y;A(w.slice(ne,ne+y)),F(w.length)}function F(V){const Q=document.getElementById("vex-task-pager"),ee=document.getElementById("vex-task-pager-info"),ne=document.getElementById("vex-task-prev"),oe=document.getElementById("vex-task-next");if(!Q)return;if(V<=y){Q.style.display="none";return}Q.style.display="";const ue=Math.ceil(V/y);ee&&(ee.textContent=B+" / "+ue),ne&&(ne.disabled=B<=1),oe&&(oe.disabled=B>=ue)}function A(V){const Q=document.getElementById("vex-task-tbody");if(!Q)return;const ee={pending:t("vex-status-pending")||"待处理",running:t("vex-status-running")||"处理中",done:t("vex-status-done")||"已完成",failed:t("vex-status-failed")||"失败"},ne={pending:"badge-gray",running:"badge-blue",done:"badge-green",failed:"badge-red"},oe='<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M8 2v9M4 7l4 4 4-4M3 14h10"/></svg>',ue='<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M3 4h10M6 4V3h4v1M5 4v8a1 1 0 001 1h4a1 1 0 001-1V4"/></svg>';Q.innerHTML=V.map(m=>{const C=m.created_at?new Date(m.created_at).toLocaleString([],{year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",minute:"2-digit"}):"—",T=m.period||"—",U=m.matched_count!=null?m.matched_count+" ✓ · "+m.mismatched_count+" ⚠":"—",N=m.mismatch_amount!=null?"฿ "+Number(m.mismatch_amount).toLocaleString():"—",r=m.elapsed_seconds!=null?m.elapsed_seconds.toFixed(1)+" s":"—",j=m.status||"pending",z=m.client_name&&m.client_name!=="client"?m.client_name:t("vex-client-all")||"全部客户";return`<tr class="vex-task-row" data-task-id="${h(m.id)}" style="cursor:pointer">
                <td>${C}</td>
                <td>${h(z)}</td>
                <td>${h(T)}</td>
            ...
            <span class="vex-fi-n" title="${h(C.name)}">${h(C.name)}</span>
            ...
            <div class="vex-pp-pagination" id="vex-pp-${V}-pg"></div>`;const C=o("vex-pp-search-"+V);C&&C.addEventListener("input",U=>{V==="inv"?(E=U.target.value,u=50):(k=U.target.value,d=50),S(V)});const T=o("vex-pp-clearall-"+V);T&&T.addEventListener("click",()=>{V==="inv"?(_=[],E="",u=50):(s=[],k="",d=50),M()}),S(V)}function S(V){const Q=o("vex-pp-"+V+"-list"),ee=o("vex-pp-"+V+"-pg");if(!Q)return;const ne=V==="inv"?_:s,oe=V==="inv"?E:k,ue=V==="inv"?u:d,m=V==="inv"?W:G,C=ne.map((N,r)=>({f:N,i:r})),T=oe?C.filter(({f:N})=>N.name.toLowerCase().includes(oe.toLowerCase())):C,U=T.slice(0,ue);if(Q.innerHTML=U.map(({f:N,i:r})=>`
            ...
            </div>`).join("")+`<div id="vex-pp-sentinel-${V}" style="height:1px;flex-shrink:0"></div>`,Q.querySelectorAll(".vex-pp-fi-del").forEach(N=>{N.addEventListener("click",()=>{const r=parseInt(N.dataset.ridx,10);N.dataset.kind==="inv"?$(r):x(r)})}),ee){const N=t("vex-preview-count")||"显示前 {n} / 共 {m}";ee.textContent=N.replace("{n}",U.length).replace("{m}",T.length)}g(V,T.length)}function g(V,Q){if((V==="inv"?u:d)>=Q)return;const ne=o("vex-pp-sentinel-"+V),oe=o("vex-pp-"+V+"-list");if(!ne||!oe)return;const ue=new IntersectionObserver(m=>{m[0].isIntersecting&&(ue.disconnect(),V==="inv"?u+=50:d+=50,S(V))},{root:oe,threshold:.8});ue.observe(ne)}function c(V,Q,ee,ne){const oe=o(V),ue=o(Q);!oe||!ue||(oe.addEventListener("click",()=>ue.click()),oe.addEventListener("keydown",m=>{(m.key==="Enter"||m.key===" ")&&(m.preventDefault(),ue.click())}),oe.addEventListener("dragover",m=>{m.preventDefault(),oe.classList.add("drag-over")}),oe.addEventListener("dragleave",()=>oe.classList.remove("drag-over")),oe.addEventListener("drop",m=>{m.preventDefault(),oe.classList.remove("drag-over");const T=Array.from(m.dataTransfer.files).filter(U=>n.test(U.name));if(!T.length){showToast(t("vex-toast-bad-ext"),"error");return}ee(T)}),ue.addEventListener("change",()=>{const m=Array.from(ue.files);ee(m),ue.value=""}))}async function H(){if(f||!_.length||!s.length)return;f=!0,o("vex-build").disabled=!0,o("vex-progress").style.display="flex";var V=document.getElementById("vex-download");V&&(V.style.display="none"),["vex-summary-collapse","vex-detail-collapse"].forEach(function(oe){var ue=document.getElementById(oe);ue&&(ue.style.display="none")});const Q=Date.now();o("vex-progress-title").textContent=t("vex-progress-running")||"AI 抽取中",o("vex-progress-sub").textContent=(t("vex-progress-sub")||"{a} 张发票 + {b} 份报告 · 并行处理").replace("{a}",_.length).replace("{b}",s.length);const ee=setInterval(()=>{const oe=Math.floor((Date.now()-Q)/1e3);o("vex-progress-sub").textContent=(t("vex-progress-elapsed")||"已 {s} 秒 · {a} 张发票 + {b} 份报告").replace("{s}",oe).replace("{a}",_.length).replace("{b}",s.length)},1e3);try{const oe=new FormData;for(const pe of _)oe.append("invoices",pe);for(const pe of s)oe.append("reports",pe);const ue=typeof currentLang=="string"&&currentLang||localStorage.getItem("mrpilot_lang")||"th";oe.append("lang",ue);const m=localStorage.getItem("mrpilot_token")||"",C=await fetch("/api/vat_excel/submit",{method:"POST",headers:i(),body:oe});let T=null;try{T=await C.json()}catch{T=null}if(!C.ok||!T||!T.ok||!T.job_id)throw clearInterval(ee),new Error(T&&T.detail||"HTTP "+C.status);const U=o("vex-progress-sub"),N=await window._reconPollJob(T.job_id,m,{onProgress:pe=>{U&&(U.textContent=window._reconProgressText(pe,ue))}});if(clearInterval(ee),!N||N.status!=="done"||!N.result_id)throw new Error(t("vex-toast-fail")||"生成失败");const r=N.result_id;let j=0;const z=await fetch("/api/vat_excel/tasks/"+encodeURIComponent(r)+"/download",{headers:i()});if(!z.ok)throw new Error("HTTP "+z.status);const X=(z.headers.get("Content-Disposition")||"").match(/filename="([^"]+)"/),de=X&&X[1]||"vat_recon_"+Date.now()+".xlsx",se=await z.blob(),ce=URL.createObjectURL(se),ae=o("vex-download");ae.href=ce,ae.download=de;try{const pe=document.createElement("a");pe.href=ce,pe.download=de,document.body.appendChild(pe),pe.click(),setTimeout(()=>pe.remove(),100)}catch{}o("vex-progress").style.display="none";var ne=document.getElementById("vex-download");ne&&(ne.style.display=""),r&&(j=await Z(r)),window._onVexResultShown&&window._onVexResultShown(),j>0?showToast((t("vex-toast-some-fail")||"有 {n} 张发票 OCR 失败").replace("{n}",j),"warn"):showToast(t("vex-toast-done")||"Excel 已生成","success"),R(),setTimeout(q,800)}catch(oe){clearInterval(ee),o("vex-progress").style.display="none";const ue=(t("vex-toast-fail")||"生成失败")+": "+(oe.message||oe);showToast(ue,"error")}finally{f=!1,o("vex-build").disabled=!1}}function P(){_=[],s=[];var V=document.getElementById("vex-download");V&&(V.style.display="none"),M()}function Y(V){if(V==null)return"—";var Q=parseFloat(V);return isNaN(Q)?"—":Q.toLocaleString("th-TH",{minimumFractionDigits:2,maximumFractionDigits:2})}async function Z(V){try{var Q=await fetch("/api/vat_excel/tasks/"+encodeURIComponent(V),{headers:i()});if(!Q.ok)throw new Error(Q.status);var ee=await Q.json(),ne=ee.raw_data_json;if(typeof ne=="string")try{ne=JSON.parse(ne)}catch{ne={}}ne=ne||{};var oe=ne.rows||[],ue=[];oe.forEach(function(T){T.kind==="invoice_orphan"?ue.push({invoice_no:T.invoice_no||"",field:"仅发票有",report_value:"—",invoice_value:Y(T.amount_inv),kind:T.kind}):T.kind==="report_orphan"?ue.push({invoice_no:T.invoice_no||"",field:"仅报告有",report_value:Y(T.amount_rep),invoice_value:"—",kind:T.kind}):T.dims&&Object.keys(T.dims).length>0&&Object.keys(T.dims).forEach(function(U){var N=String(T.dims[U]||""),r=N.split(" ≠ ");ue.push({invoice_no:T.invoice_no||"",field:U,report_value:r[0]||N,invoice_value:r.length>1?r[1]:"—",kind:"diff"})})});var m=oe.filter(function(T){return T.kind==="matched_cash"}).length,C=Math.max(0,parseInt(ne.invoice_ocr_failed_count||0,10));return window._vexLastTask={total:ne.n_total||0,matched:ne.n_ok||0,diff:ne.n_diff||0,incomplete:C,cash:m,diff_rows:ue,task_id:V},window._fillVexSummary&&window._fillVexSummary(),window._fillVexDetail&&window._fillVexDetail(),C}catch{return 0}}function le(){const V=document.getElementById("vex-pane");V&&V.querySelectorAll("[data-i18n]").forEach(Q=>{const ee=t(Q.dataset.i18n);ee&&(Q.textContent=ee)}),M(),q()}function ie(){c("vex-drop-invoice","vex-input-invoice",I),c("vex-drop-report","vex-input-report",L);const V=o("vex-build"),Q=o("vex-reset");V&&V.addEventListener("click",H),Q&&Q.addEventListener("click",P),document.querySelectorAll('[data-recon-tab="sale-vat"]').forEach(oe=>{oe.addEventListener("click",()=>{R(),q()})}),v();const ee=document.getElementById("vex-task-search");ee&&ee.addEventListener("input",O);const ne=document.getElementById("vex-toggle-preview");ne&&ne.addEventListener("click",()=>{const oe=o("vex-preview-panel"),ue=o("vex-toggle-preview-label"),m=oe&&oe.style.display!=="none";oe&&(oe.style.display=m?"none":""),ne&&ne.classList.toggle("open",!m),ue&&(ue.textContent=m?t("vex-toggle-preview-open")||"查看清单":t("vex-toggle-preview-close")||"收起清单"),m||te()}),M(),R()}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",ie):ie(),typeof window.subscribeI18n=="function"&&(window.subscribeI18n("vex-excel",le),window.subscribeI18n("vex-preview-panel",te))})();(function(){const e=g=>document.getElementById(g),a=()=>localStorage.getItem("mrpilot_token")||"",n=()=>typeof window.currentLang=="string"&&window.currentLang?window.currentLang:localStorage.getItem("mrpilot_lang")||"th",o=()=>({Authorization:"Bearer "+a()}),i={inited:!1,glFile:[],vatFile:[],running:!1,currentTaskId:null,lastDetail:[],lastSummary:null},h={th:{not_found:"ไม่พบข้อมูล",running:"กำลังกระทบยอด…",error:"เกิดข้อผิดพลาด",need_files:"กรุณาเลือกไฟล์ทั้งสอง",done:"เสร็จสิ้น",hint_need_both:"อัปโหลด ① รายงานภาษีขาย + ② GL",hint_need_one_more:"อัปโหลดอีก 1 ไฟล์",hint_ready:"พร้อมแล้ว · กดเริ่มกระทบยอด",hist_load:"โหลด",hist_export:"ส่งออก",hist_delete:"ลบ",confirm_delete:"ยืนยันการลบงานนี้?",s_gl_total:"ยอดรวมตามบัญชีแยกประเภท",s_minus_gl_cr:"หัก : รายการเครดิตที่ไม่มีในรายงานภาษีขาย",s_plus_gl_dr:"บวก : รายการเดบิตที่ไม่มีในรายงานภาษีขาย",s_plus_vat_p:"บวก : รายการยอดขายที่ไม่มีในบัญชีแยกประเภท",s_minus_vat_n:"หัก : รายการลดหนี้ที่ไม่มีในบัญชีแยกประเภท",s_vat_total:"ยอดรวมตามรายงานภาษีขาย"},zh:{not_found:"未找到数据",running:"正在对账中...",error:"出错了",need_files:"请先选择两个文件",done:"完成",hint_need_both:"请上传① 销项税报告 + ② 总账 GL",hint_need_one_more:"还需上传 1 份文件",hint_ready:"已就绪 · 点击开始对账",hist_load:"加载",hist_export:"导出",hist_delete:"删除",confirm_delete:"确认删除此任务？",s_gl_total:"总账金额合计",s_minus_gl_cr:"减：销项税报告中未列的贷方记录",s_plus_gl_dr:"加：销项税报告中未列的借方记录",s_plus_vat_p:"加：总账中未列的销售记录",s_minus_vat_n:"减：总账中未列的贷项凭单(credit note)记录",s_vat_total:"销项税报告金额合计"},en:{not_found:"Not found",running:"Reconciling...",error:"Error",need_files:"Please select both files",done:"Done",hint_need_both:"Upload ① Output VAT report + ② GL file",hint_need_one_more:"1 more file required",hint_ready:"Ready · click Run to start",hist_load:"Load",hist_export:"Export",hist_delete:"Delete",confirm_delete:"Delete this task?",s_gl_total:"Total per General Ledger",s_minus_gl_cr:"Less: GL credits not in VAT Report",s_plus_gl_dr:"Add: GL debits not in VAT Report",s_plus_vat_p:"Add: Sales in VAT Report not in GL",s_minus_vat_n:"Less: Credit notes in VAT Report not in GL",s_vat_total:"Total per VAT Sales Report"},ja:{not_found:"データなし",running:"照合中…",error:"エラー",need_files:"両方のファイルを選択してください",done:"完了",hint_need_both:"① 売上税報告 + ② GL をアップロード",hint_need_one_more:"あと 1 ファイル必要",hint_ready:"準備完了 · 「開始」をクリック",hist_load:"読込",hist_export:"出力",hist_delete:"削除",confirm_delete:"このタスクを削除しますか?",s_gl_total:"総勘定元帳合計",s_minus_gl_cr:"減：売上税報告にないGL貸方記録",s_plus_gl_dr:"加：売上税報告にないGL借方記録",s_plus_vat_p:"加：GLにない売上記録",s_minus_vat_n:"減：GLにない赤伝記録",s_vat_total:"売上税報告合計"}},b=g=>(h[n()]||h.th)[g]||g;function _(g){const c=n(),P={gl_no_revenue_rows:{zh:"GL 中未找到收入科目行。请确认「收入科目前缀」是否正确(收入科目通常以 4 开头),改对后重试。",th:"ไม่พบรายการบัญชีรายได้ใน GL · ตรวจสอบ «คำนำหน้าบัญชีรายได้» (รายได้มักขึ้นต้นด้วย 4) แล้วลองใหม่",en:"No revenue-account rows found in the GL. Check the “revenue account prefix” (revenue usually starts with 4) and retry.",ja:"GL に収益科目の行が見つかりません。「収益科目プレフィックス」(通常 4 で始まる)を確認して再試行してください。"},gl_parse_failed:{zh:"GL 文件解析失败。请确认文件含日期/科目/借贷列,或换清晰的 Excel/CSV 重传。",th:"อ่านไฟล์ GL ไม่สำเร็จ · ตรวจสอบว่ามีคอลัมน์ วันที่/บัญชี/เดบิต-เครดิต หรืออัปโหลด Excel/CSV ที่ชัดเจน",en:"Failed to parse the GL file. Ensure it has date/account/debit-credit columns, or re-upload a clean Excel/CSV.",ja:"GL ファイルの解析に失敗しました。日付/科目/借方貸方列を確認するか、Excel/CSV を再アップロードしてください。"},vat_no_rows:{zh:"销项税报告里没有可对账的数据行。请确认上传了正确的销项税报告。",th:"ไม่พบแถวข้อมูลในรายงานภาษีขาย · ตรวจสอบว่าอัปโหลดรายงานที่ถูกต้อง",en:"No rows found in the sales-VAT report. Please check you uploaded the correct report.",ja:"売上VATレポートに行が見つかりません。正しいレポートをアップロードしたか確認してください。"},vat_parse_failed:{zh:"销项税报告解析失败。请换更清晰的版本,或转成 Excel/PDF 重传。",th:"อ่านรายงานภาษีขายไม่สำเร็จ · ลองเวอร์ชันที่ชัดเจนกว่า หรือแปลงเป็น Excel/PDF",en:"Failed to parse the sales-VAT report. Try a clearer version, or convert to Excel/PDF.",ja:"売上VATレポートの解析に失敗しました。より鮮明な版か、Excel/PDF に変換してください。"}}[g];return P?P[c]||P.th||P.en:b("error")||"Error"}const s=g=>g==null||isNaN(g)?"":Number(g).toLocaleString("en-US",{minimumFractionDigits:2,maximumFractionDigits:2});function f(g,c,H,P){const Y=e(g),Z=e(c),le=e(H);if(!Y||!Z||!le)return;const ie=V=>{if(!V||!V.length)return;const Q=Array.isArray(i[P])?i[P].slice():[],ee=new Set(Q.map(ne=>ne.name+"|"+ne.size));for(const ne of V){if(!ne)continue;const oe=ne.name+"|"+ne.size;ee.has(oe)||(Q.push(ne),ee.add(oe))}i[P]=Q,w(le,Q),d(),E(),window._reconCollapse&&window._reconCollapse.renderGlvPreview&&window._reconCollapse.renderGlvPreview()};Y.addEventListener("click",()=>Z.click()),Y.addEventListener("keydown",V=>{(V.key==="Enter"||V.key===" ")&&(V.preventDefault(),Z.click())}),Z.addEventListener("change",()=>{ie(Array.from(Z.files||[])),Z.value=""}),Y.addEventListener("dragover",V=>{V.preventDefault(),Y.classList.add("drag-over")}),Y.addEventListener("dragleave",()=>Y.classList.remove("drag-over")),Y.addEventListener("drop",V=>{V.preventDefault(),Y.classList.remove("drag-over");const Q=V.dataTransfer&&V.dataTransfer.files?Array.from(V.dataTransfer.files):[];ie(Q)})}function w(g,c){if(!g)return;if(!c||c.length===0){g.textContent="";return}const H=c.reduce((P,Y)=>P+Math.round(Y.size/1024),0);if(c.length===1)g.textContent=c[0].name+"  ("+H+" KB)";else{const P=window.t&&window.t("glv-files-count")||"{n} 个文件";g.textContent=P.replace("{n}",c.length)+"  ("+H+" KB)"}}function u(g){const c=i[g];return Array.isArray(c)?c:c?[c]:[]}function d(){const g=e("btn-glv-run");if(!g)return;const c=u("glFile").length>0&&u("vatFile").length>0;g.disabled=!c||i.running}function E(){const g=e("glv-status");if(!g||i.running)return;const c=u("vatFile").length,H=u("glFile").length;c===0&&H===0?(g.className="vex-action-info muted",g.innerHTML="<span>"+b("hint_need_both")+"</span>"):c>0&&H>0?(g.className="vex-action-info ok",g.innerHTML="<span>"+b("hint_ready")+"</span>"):(g.className="vex-action-info muted",g.innerHTML="<span>"+b("hint_need_one_more")+"</span>")}function k(g,c){const H=g==="vat"?"vatFile":"glFile",P=g==="vat"?"glv-vat-input":"glv-gl-input",Y=g==="vat"?"glv-vat-name":"glv-gl-name",Z=u(H);c==null?i[H]=[]:i[H]=Z.filter((ie,V)=>V!==c);const le=e(P);le&&(le.value=""),w(e(Y),u(H)),d(),E(),window._reconCollapse&&window._reconCollapse.renderGlvPreview&&window._reconCollapse.renderGlvPreview()}window._glvRemoveFile=k;function R(){i.glFile=[],i.vatFile=[],i.currentTaskId=null,i.lastDetail=[],i.lastSummary=null;const g=e("glv-vat-input");g&&(g.value="");const c=e("glv-gl-input");c&&(c.value="");const H=e("glv-vat-name");H&&(H.textContent="");const P=e("glv-gl-name");P&&(P.textContent="");const Y=e("glv-result");Y&&(Y.style.display="none");const Z=e("glv-kpi-strip");Z&&(Z.style.display="none"),d(),E(),window._glvClearPreviewSearch&&window._glvClearPreviewSearch(),window._reconCollapse&&window._reconCollapse.renderGlvPreview&&window._reconCollapse.renderGlvPreview()}function q(g){const c=e("glv-tbody");if(!c)return;re(g.length),c.innerHTML="";const H=b("not_found"),P=document.createDocumentFragment();g.forEach(Y=>{const Z=document.createElement("tr"),le=(ne,oe)=>{const ue=document.createElement("td");return oe&&(ue.className=oe),ue.textContent=ne,ue},ie=Y.gl_amount===null||Y.gl_amount===void 0,V=Y.diff;let Q="glv-num",ee="glv-num";ie?(ee+=" glv-cell-missing",Q+=" glv-cell-missing"):Math.abs(V||0)<.005?Q+=" glv-cell-ok":Q+=" glv-cell-diff",Z.appendChild(le(Y.doc_no||"","glv-doc")),Z.appendChild(le(Y.date||"","")),Z.appendChild(le(Y.customer_name||"","")),Z.appendChild(le(s(Y.vat_amount),"glv-num")),Z.appendChild(le(ie?H:s(Y.gl_amount),ee)),Z.appendChild(le(ie?H:s(Y.diff),Q)),Z.appendChild(le(Y.account_codes||"","glv-doc")),P.appendChild(Z)}),c.appendChild(P)}function y(g){const c=e("glv-summary-table")&&e("glv-summary-table").querySelector("tbody");if(!c)return;c.innerHTML="",[{label:b("s_gl_total"),amount:g.gl_total,emph:!0,items:[],negate:!1},{label:b("s_minus_gl_cr"),amount:-(g.gl_only_credit||0),emph:!1,items:g.gl_only_credit_items||[],negate:!0},{label:b("s_plus_gl_dr"),amount:g.gl_only_debit||0,emph:!1,items:g.gl_only_debit_items||[],negate:!1},{label:b("s_plus_vat_p"),amount:g.vat_only_positive||0,emph:!1,items:g.vat_only_positive_items||[],negate:!1},{label:b("s_minus_vat_n"),amount:g.vat_only_negative||0,emph:!1,items:g.vat_only_negative_items||[],negate:!1},{label:b("s_vat_total"),amount:g.vat_total,emph:!0,items:[],negate:!1}].forEach(({label:P,amount:Y,emph:Z,items:le,negate:ie})=>{const V=document.createElement("tr");V.className=Z?"glv-summary-total":"glv-summary-sect";const Q=document.createElement("td"),ee=document.createElement("td");Q.textContent=P,ee.textContent=Z?s(Y):"",V.appendChild(Q),V.appendChild(ee),c.appendChild(V),(le||[]).forEach(ne=>{const oe=document.createElement("tr");oe.className="glv-summary-item";const ue=document.createElement("td"),m=document.createElement("td"),C=[ne.doc_no,ne.date,ne.name].filter(Boolean);ue.textContent="· "+C.join("  ·  ");const T=ie?-(ne.amount||0):ne.amount||0;m.textContent=s(T),oe.appendChild(ue),oe.appendChild(m),c.appendChild(oe)})})}function B(g){e("glv-kpi-matched")&&(e("glv-kpi-matched").textContent=g&&g.matched!=null?g.matched:"—"),e("glv-kpi-diff")&&(e("glv-kpi-diff").textContent=g&&g.diff!=null?g.diff:"—"),e("glv-kpi-unmatched")&&(e("glv-kpi-unmatched").textContent=g&&g.unmatched!=null?g.unmatched:"—")}function O(g){if(!g)return"";try{const c=new Date(g);if(isNaN(c.getTime()))return g;const H=P=>String(P).padStart(2,"0");return c.getFullYear()+"-"+H(c.getMonth()+1)+"-"+H(c.getDate())+" "+H(c.getHours())+":"+H(c.getMinutes())}catch{return g}}const D=10;var F=[],A=1;function v(){A=1,l();var g=((e("glv-hist-search")||{}).value||"").trim().toLowerCase();if(g){var c=e("glv-history-tbody");c&&c.querySelectorAll("tr").forEach(function(H){H.dataset.taskId&&(H.style.display=H.textContent.toLowerCase().indexOf(g)>=0?"":"none")})}}function l(){const g=e("glv-history-table-wrap"),c=e("glv-history-empty"),H=e("glv-history-tbody"),P=e("glv-history-pager"),Y=e("glv-history-pager-info"),Z=e("glv-history-prev"),le=e("glv-history-next");if(!H)return;if(H.innerHTML="",!F.length){g&&(g.style.display="none"),c&&(c.style.display=""),P&&(P.style.display="none");return}g&&(g.style.display=""),c&&(c.style.display="none");const ie=Math.ceil(F.length/D);A>ie&&(A=ie);const V=(A-1)*D,Q=F.slice(V,V+D);P&&(P.style.display=F.length>D?"":"none",Y&&(Y.textContent=A+" / "+ie),Z&&(Z.disabled=A<=1),le&&(le.disabled=A>=ie)),Q.forEach(ne=>{const oe=document.createElement("tr");oe.dataset.taskId=ne.id;const ue=document.createElement("td");ue.textContent=O(ne.created_at);const m=document.createElement("td");m.className="glv-history-file",m.title=(ne.vat_filename||"")+" + "+(ne.gl_filename||""),m.textContent=(ne.vat_filename||"?")+" + "+(ne.gl_filename||"?");const C=document.createElement("td");C.className="glv-num",C.textContent=(ne.vat_row_count||0)+" / "+(ne.gl_row_count||0);const T=document.createElement("td");T.className="glv-num",T.textContent=ne.matched_count||0;const U=document.createElement("td");U.className="glv-num",U.textContent=ne.diff_count||0;const N=document.createElement("td");N.className="glv-num",N.textContent=ne.unmatched_count||0;const r=document.createElement("td");r.className="glv-history-actions";const j=(de,se,ce,ae)=>{const pe=document.createElement("button");return pe.type="button",ce&&(pe.className=ce),pe.title=se,pe.setAttribute("aria-label",se),pe.innerHTML=de,pe.onclick=ae,pe},z='<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" width="14" height="14"><path d="M2 8a6 6 0 1 0 12 0A6 6 0 0 0 2 8z"/><polyline points="6 8 8 10 10 8"/><line x1="8" y1="4" x2="8" y2="10"/></svg>',J='<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" width="14" height="14"><path d="M8 2v9M4 7l4 4 4-4M3 14h10"/></svg>',X='<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" width="14" height="14"><polyline points="3 4 13 4"/><path d="M6 4V2.5a.5.5 0 0 1 .5-.5h3a.5.5 0 0 1 .5.5V4"/><path d="M5 4l1 9a1 1 0 0 0 1 1h2a1 1 0 0 0 1-1l1-9"/></svg>';r.appendChild(j(z,b("hist_load"),"",()=>L(ne.id))),r.appendChild(j(J,b("hist_export"),"",()=>$(ne.id))),r.appendChild(j(X,b("hist_delete"),"glv-del",()=>x(ne.id))),[ue,m,C,T,U,N,r].forEach(de=>oe.appendChild(de)),H.appendChild(oe)})}function p(){var g=e("glv-history-prev"),c=e("glv-history-next");g&&!g._glvBound&&(g._glvBound=!0,g.addEventListener("click",function(){A>1&&(A--,l())})),c&&!c._glvBound&&(c._glvBound=!0,c.addEventListener("click",function(){var H=Math.ceil(F.length/D);A<H&&(A++,l())}))}async function I(){try{const c=await(await fetch("/api/recon/gl-vat/tasks",{headers:o()})).json();F=c&&c.tasks||[],A=1,l(),p()}catch(g){console.error("[gl-vat] history load failed:",g)}}async function L(g){try{const H=await(await fetch("/api/recon/gl-vat/"+g,{headers:o()})).json();if(!H||!H.ok)throw new Error("load_failed");i.currentTaskId=g,i.lastDetail=H.detail||[],i.lastSummary=H.summary||{},B(H.stats||{}),q(i.lastDetail),y(i.lastSummary);const P=e("glv-result");P&&(P.style.display=""),K(),window.scrollTo({top:P?P.offsetTop-80:0,behavior:"smooth"})}catch(c){console.error("[gl-vat] load task failed:",c),alert(b("error")+": "+(c.message||c))}}async function $(g){try{const c="/api/recon/gl-vat/"+g+"/export?lang="+encodeURIComponent(n()),H=await fetch(c,{headers:o()});if(!H.ok)throw new Error("HTTP "+H.status);const P=await H.blob(),Y=document.createElement("a");Y.href=URL.createObjectURL(P),Y.download="GL_VAT_recon_"+g+".xlsx",document.body.appendChild(Y),Y.click(),setTimeout(()=>{URL.revokeObjectURL(Y.href),Y.remove()},200)}catch(c){console.error("[gl-vat] exportTask failed:",c),typeof showToast=="function"&&showToast(b("error")+": "+(c.message||c),"error")}}async function x(g){let c;if(typeof window.showConfirm=="function"?c=await window.showConfirm(b("confirm_delete"),{danger:!0}):c=confirm(b("confirm_delete")),!!c)try{const H=await fetch("/api/recon/gl-vat/"+g,{method:"DELETE",headers:o()});if(!H.ok)throw new Error("HTTP "+H.status);I()}catch(H){console.error("[gl-vat] delete failed:",H),typeof showToast=="function"&&showToast(b("error")+": "+(H.message||H),"error")}}async function M(){if(!i.glFile||!i.vatFile){typeof showToast=="function"&&showToast(b("need_files"),"warn");return}i.running=!0,d();const g=e("glv-status"),c=e("glv-progress"),H=e("glv-progress-sub");g&&(g.className="vex-action-info muted",g.style.color="",g.innerHTML="<span>"+b("running")+"</span>"),c&&(c.style.display=""),H&&(H.textContent=(i.vatFile.name||"VAT")+" + "+(i.glFile.name||"GL"));const P=new FormData,Y=u("vatFile"),Z=u("glFile");for(const ie of Y)P.append("vat_files",ie,ie.name);for(const ie of Z)P.append("gl_files",ie,ie.name);const le=(e("glv-prefix")&&e("glv-prefix").value||"4").trim()||"4";P.append("revenue_prefix",le),P.append("lang",n());try{const ie=await fetch("/api/recon/gl-vat/submit",{method:"POST",headers:o(),body:P});let V=null;try{V=await ie.json()}catch{V=null}if(!ie.ok||!V||!V.ok||!V.job_id)throw new Error(V&&V.detail||V&&V.error||"HTTP "+ie.status);const Q=e("glv-progress-sub"),ee=await window._reconPollJob(V.job_id,a(),{onProgress:m=>{Q&&(Q.textContent=window._reconProgressText(m,n()))}});if(!ee||ee.status!=="done"||!ee.result_id)throw ee&&ee.status==="failed"&&ee.error_code?new Error(_(ee.error_code)):new Error(b("error")||"Error");const ne=await fetch("/api/recon/gl-vat/"+encodeURIComponent(ee.result_id),{headers:o()});let oe=null;try{oe=await ne.json()}catch{oe=null}if(!ne.ok||!oe||!oe.ok)throw new Error(oe&&oe.detail||oe&&oe.error||"HTTP "+ne.status);i.currentTaskId=oe.task_id,i.lastDetail=oe.detail||[],i.lastSummary=oe.summary||{},B(oe.stats||{}),q(i.lastDetail),y(i.lastSummary);const ue=e("glv-result");ue&&(ue.style.display=""),K(),g&&(g.className="vex-action-info ok",g.style.color="",g.innerHTML="<span>"+b("done")+" · GL "+(oe.gl_row_count||0)+" · VAT "+(oe.vat_row_count||0)+"</span>"),I()}catch(ie){console.error("[gl-vat] run failed:",ie),g&&(g.className="vex-action-info",g.style.color="#ef4444",g.innerHTML="<span>"+b("error")+": "+(ie.message||ie)+"</span>")}finally{i.running=!1,c&&(c.style.display="none"),d()}}async function W(){if(i.currentTaskId)try{const g="/api/recon/gl-vat/"+i.currentTaskId+"/export?lang="+encodeURIComponent(n()),c=await fetch(g,{headers:o()});if(!c.ok)throw new Error("HTTP "+c.status);const H=await c.blob(),P=document.createElement("a");P.href=URL.createObjectURL(H),P.download="GL_VAT_recon_"+i.currentTaskId+".xlsx",document.body.appendChild(P),P.click(),setTimeout(()=>{URL.revokeObjectURL(P.href),P.remove()},200)}catch(g){console.error("[gl-vat] export failed:",g),typeof showToast=="function"&&showToast(b("error")+": "+(g.message||g),"error")}}function G(){i.running||E(),I(),i.lastDetail&&i.lastDetail.length&&q(i.lastDetail),i.lastSummary&&y(i.lastSummary)}function K(){var g=e("glv-kpi-strip");g&&(g.style.display="");var c=e("glv-section-summary");c&&c.setAttribute("data-collapsed","false");var H=e("glv-section-detail");H&&H.setAttribute("data-collapsed","false")}function te(){document.querySelectorAll(".glv-section-head[data-toggle]").forEach(g=>{const c=g.getAttribute("data-toggle"),H=document.getElementById(c);if(!H)return;const P=Y=>{if(Y.target&&Y.target.closest("button")!==null&&!Y.target.classList.contains("glv-section-head"))return;const Z=H.getAttribute("data-collapsed")==="true";H.setAttribute("data-collapsed",Z?"false":"true")};g.addEventListener("click",P),g.addEventListener("keydown",Y=>{(Y.key==="Enter"||Y.key===" ")&&(Y.preventDefault(),P(Y))})})}function re(g){const c=e("glv-detail-count");c&&(c.textContent=g!=null?String(g):"")}function S(){if(i.inited){I();return}i.inited=!0,f("glv-drop-gl","glv-gl-input","glv-gl-name","glFile"),f("glv-drop-vat","glv-vat-input","glv-vat-name","vatFile");const g=e("btn-glv-run");g&&g.addEventListener("click",M);const c=e("btn-glv-export");c&&c.addEventListener("click",W);const H=e("btn-glv-reset");H&&H.addEventListener("click",R);const P=e("glv-hist-search");P&&P.addEventListener("input",v),te(),B(null),E(),window._loadGlvHistory=I,I(),typeof window.subscribeI18n=="function"&&window.subscribeI18n("gl-vat-recon",G)}window.GlVatRecon={ensureInit:S},window._glvPreviewFiles=function(g){return u(g==="vat"?"vatFile":"glFile")}})();(function(){const e=["flowaccount","peak","xero","quickbooks","express"],a={flowaccount:"FlowAccount",peak:"PEAK",xero:"Xero",quickbooks:"QuickBooks",express:"Express"},n=["expense_office","expense_travel","expense_utility","asset_inventory","asset_fixed","liability_ap","revenue_sales","revenue_service","other"],o=["vat_7","vat_0","vat_exempt","wht_1","wht_3","wht_5","non_vat"],i="468b50c1-5593-4fd6-990d-515ce8085563";let h={sub:"clients",loaded:{clients:!1,accounts:!1,taxes:!1,products:!1},items:{clients:[],accounts:[],taxes:[],products:[]},clientList:[],clientLoaded:!1,addingNew:{clients:!1,accounts:!1,taxes:!1,products:!1},bound:!1};function b(){const L=typeof _userInfo<"u"?_userInfo:null;return!!(L&&(L.role==="owner"||L.is_super_admin))}function _(){const L=typeof _userInfo<"u"?_userInfo:null;return!!(L&&L.id===i)}function s(L){return typeof escapeHtml=="function"?escapeHtml(L==null?"":String(L)):String(L??"")}function f(L,$){try{typeof showToast=="function"&&showToast(L,$||"info")}catch{}}async function w(L,$){const x=localStorage.getItem("mrpilot_token");if(x&&!(h.loaded[L]&&!$))try{const M=await fetch("/api/erp/mappings/"+L,{headers:{Authorization:"Bearer "+x}});if(!M.ok)throw new Error("http_"+M.status);const W=await M.json();h.items[L]=W.items||[],h.loaded[L]=!0}catch{h.items[L]=[],h.loaded[L]=!1}}async function u(L){if(h.clientLoaded)return;const $=localStorage.getItem("mrpilot_token");if($)try{const x=await fetch("/api/clients?include_inactive=false",{headers:{Authorization:"Bearer "+$}});if(!x.ok)throw new Error("http_"+x.status);const M=await x.json();h.clientList=(M.clients||M.items||[]).filter(W=>W.is_active!==!1),h.clientLoaded=!0}catch{h.clientList=[]}}function d(){const L=document.getElementById("erp-map-pane-wrap");if(!L)return;const $=!b();let x="";$&&(x+='<div class="erp-map-readonly-banner"><svg width="16" height="16" viewBox="0 0 20 20" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"><circle cx="10" cy="10" r="8"/><path d="M10 6v4M10 13v0.01"/></svg>'+s(t("erp-map-readonly-tip"))+"</div>"),x+='<div class="erp-map-toolbar">',!$&&h.sub!=="products"&&(x+='<button class="btn btn-primary" type="button" id="erp-map-add-btn" data-i18n="erp-map-add-row">'+s(t("erp-map-add-row"))+"</button>"),x+="</div>",x+='<div class="erp-map-table" id="erp-map-table-host"></div>',L.innerHTML=x,E();const M=document.getElementById("erp-map-dev-bar");M&&(M.style.display=b()&&_()?"":"none")}function E(){const L=document.getElementById("erp-map-table-host");if(!L)return;const $=h.sub,x=h.items[$]||[],M=h.addingNew[$],W=!b();if(!x.length&&!M){L.innerHTML='<div class="erp-map-empty"><strong>'+s(t("erp-map-empty-"+$))+"</strong>"+s(t("erp-map-empty-"+$+"-sub"))+"</div>";return}let G="";G+=k($),M&&!W&&(G+=O($)),x.forEach(function(K){G+=D($,K,W)}),L.innerHTML=G}function k(L){return L==="clients"?'<div class="erp-map-row erp-map-head row-clients"><div>'+s(t("erp-map-col-client"))+"</div><div>"+s(t("erp-map-col-erp"))+"</div><div>"+s(t("erp-map-col-erp-code"))+"</div><div>"+s(t("erp-map-col-notes"))+"</div><div>"+s(t("erp-map-col-actions"))+"</div></div>":L==="accounts"?'<div class="erp-map-row erp-map-head row-accounts"><div>'+s(t("erp-map-col-erp"))+"</div><div>"+s(t("erp-map-col-category"))+"</div><div>"+s(t("erp-map-col-erp-code"))+"</div><div>"+s(t("erp-map-col-erp-name"))+"</div><div>"+s(t("erp-map-col-notes"))+"</div><div>"+s(t("erp-map-col-actions"))+"</div></div>":L==="products"?'<div class="erp-map-row erp-map-head row-products"><div>'+s(t("erp-map-col-item-name"))+"</div><div>"+s(t("erp-map-col-erp-product-code"))+"</div><div>"+s(t("erp-map-col-erp-name"))+"</div><div>"+s(t("erp-map-col-notes"))+"</div><div>"+s(t("erp-map-col-actions"))+"</div></div>":'<div class="erp-map-row erp-map-head row-taxes"><div>'+s(t("erp-map-col-erp"))+"</div><div>"+s(t("erp-map-col-tax"))+"</div><div>"+s(t("erp-map-col-erp-tax-code"))+"</div><div>"+s(t("erp-map-col-notes"))+"</div><div>"+s(t("erp-map-col-actions"))+"</div></div>"}function R(L,$){let x='<select class="form-input" data-erp-field="'+$+'">';return x+='<option value="">'+s(t("erp-map-pick-erp"))+"</option>",e.forEach(function(M){const W=M===L?" selected":"";x+='<option value="'+M+'"'+W+">"+s(a[M])+"</option>"}),x+="</select>",x}function q(L){let $='<select class="form-input" data-erp-field="client_id">';return $+='<option value="">'+s(t("erp-map-pick-client"))+"</option>",(h.clientList||[]).forEach(function(x){const M=String(x.id)===String(L)?" selected":"";$+='<option value="'+x.id+'"'+M+">"+s(x.name||"#"+x.id)+"</option>"}),$+="</select>",$}function y(L){let $='<select class="form-input" data-erp-field="pearnly_category">';return $+='<option value="">'+s(t("erp-map-pick-cat"))+"</option>",n.forEach(function(x){const M=x===L?" selected":"";$+='<option value="'+x+'"'+M+">"+s(t("erp-map-cat-"+x))+"</option>"}),$+="</select>",$}function B(L){let $='<select class="form-input" data-erp-field="pearnly_tax_kind">';return $+='<option value="">'+s(t("erp-map-pick-tax"))+"</option>",o.forEach(function(x){const M=x===L?" selected":"";$+='<option value="'+x+'"'+M+">"+s(t("erp-map-tax-"+x))+"</option>"}),$+="</select>",$}function O(L){const $='<button class="btn btn-primary" type="button" data-erp-save="new" style="padding:6px 12px;height:32px;">'+s(t("erp-map-save"))+"</button>";return L==="clients"?'<div class="erp-map-row erp-map-row-add row-clients" data-erp-row="new"><div data-label="'+s(t("erp-map-col-client"))+'">'+q("")+'</div><div data-label="'+s(t("erp-map-col-erp"))+'">'+R("","erp_type")+'</div><div data-label="'+s(t("erp-map-col-erp-code"))+'"><input type="text" class="form-input" data-erp-field="erp_code" placeholder="'+s(t("erp-map-ph-erp-code"))+'"></div><div data-label="'+s(t("erp-map-col-notes"))+'"><input type="text" class="form-input" data-erp-field="notes" placeholder="'+s(t("erp-map-ph-notes"))+'"></div><div>'+$+"</div></div>":L==="accounts"?'<div class="erp-map-row erp-map-row-add row-accounts" data-erp-row="new"><div data-label="'+s(t("erp-map-col-erp"))+'">'+R("","erp_type")+'</div><div data-label="'+s(t("erp-map-col-category"))+'">'+y("")+'</div><div data-label="'+s(t("erp-map-col-erp-code"))+'"><input type="text" class="form-input" data-erp-field="erp_code" placeholder="'+s(t("erp-map-ph-acc-code"))+'"></div><div data-label="'+s(t("erp-map-col-erp-name"))+'"><input type="text" class="form-input" data-erp-field="erp_name" placeholder="'+s(t("erp-map-ph-acc-name"))+'"></div><div data-label="'+s(t("erp-map-col-notes"))+'"><input type="text" class="form-input" data-erp-field="notes" placeholder="'+s(t("erp-map-ph-notes"))+'"></div><div>'+$+"</div></div>":'<div class="erp-map-row erp-map-row-add row-taxes" data-erp-row="new"><div data-label="'+s(t("erp-map-col-erp"))+'">'+R("","erp_type")+'</div><div data-label="'+s(t("erp-map-col-tax"))+'">'+B("")+'</div><div data-label="'+s(t("erp-map-col-erp-tax-code"))+'"><input type="text" class="form-input" data-erp-field="erp_code" placeholder="'+s(t("erp-map-ph-tax-code"))+'"></div><div data-label="'+s(t("erp-map-col-notes"))+'"><input type="text" class="form-input" data-erp-field="notes" placeholder="'+s(t("erp-map-ph-notes"))+'"></div><div>'+$+"</div></div>"}function D(L,$,x){const M=x?"":'<button class="erp-map-del-btn" type="button" data-erp-del="'+s($.id)+'" title="'+s(t("erp-map-delete"))+'"><svg width="14" height="14" viewBox="0 0 20 20" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"><path d="M4 6h12M8 6V4h4v2M6 6l1 11h6l1-11"/></svg></button>',W='<span class="erp-map-erp-badge">'+s(a[$.erp_type]||$.erp_type)+"</span>";if(L==="clients")return'<div class="erp-map-row row-clients"><div data-label="'+s(t("erp-map-col-client"))+'" class="erp-map-cell-name">'+s($.client_name||"#"+$.client_id)+'</div><div data-label="'+s(t("erp-map-col-erp"))+'">'+W+'</div><div data-label="'+s(t("erp-map-col-erp-code"))+'" class="erp-map-code">'+s($.erp_code||"")+'</div><div data-label="'+s(t("erp-map-col-notes"))+'">'+s($.notes||"")+"</div><div>"+M+"</div></div>";if(L==="accounts"){const K=t("erp-map-cat-"+($.pearnly_category||"other"))||$.pearnly_category;return'<div class="erp-map-row row-accounts"><div data-label="'+s(t("erp-map-col-erp"))+'">'+W+'</div><div data-label="'+s(t("erp-map-col-category"))+'" class="erp-map-cell-name">'+s(K)+'</div><div data-label="'+s(t("erp-map-col-erp-code"))+'" class="erp-map-code">'+s($.erp_code||"")+'</div><div data-label="'+s(t("erp-map-col-erp-name"))+'">'+s($.erp_name||"")+'</div><div data-label="'+s(t("erp-map-col-notes"))+'">'+s($.notes||"")+"</div><div>"+M+"</div></div>"}if(L==="products")return'<div class="erp-map-row row-products"><div data-label="'+s(t("erp-map-col-item-name"))+'" class="erp-map-cell-name">'+s($.item_name||"")+'</div><div data-label="'+s(t("erp-map-col-erp-product-code"))+'" class="erp-map-code">'+s($.erp_code||"")+'</div><div data-label="'+s(t("erp-map-col-erp-name"))+'">'+s($.erp_name||"")+'</div><div data-label="'+s(t("erp-map-col-notes"))+'">'+s($.notes||"")+"</div><div>"+M+"</div></div>";const G=t("erp-map-tax-"+($.pearnly_tax_kind||""))||$.pearnly_tax_kind;return'<div class="erp-map-row row-taxes"><div data-label="'+s(t("erp-map-col-erp"))+'">'+W+'</div><div data-label="'+s(t("erp-map-col-tax"))+'" class="erp-map-cell-name"><span class="erp-map-tax-badge">'+s(G)+'</span></div><div data-label="'+s(t("erp-map-col-erp-tax-code"))+'" class="erp-map-code">'+s($.erp_code||"")+'</div><div data-label="'+s(t("erp-map-col-notes"))+'">'+s($.notes||"")+"</div><div>"+M+"</div></div>"}async function F(L){const $=h.sub,x={};L.querySelectorAll("[data-erp-field]").forEach(function(K){x[K.dataset.erpField]=(K.value||"").trim()});const M=localStorage.getItem("mrpilot_token");if(!M)return;let W={},G="/api/erp/mappings/"+$;if($==="clients"){if(!x.client_id||!x.erp_type||!x.erp_code){f(t("erp-map-save-fail"),"error");return}W={client_id:parseInt(x.client_id,10),erp_type:x.erp_type,erp_code:x.erp_code,notes:x.notes||""}}else if($==="accounts"){if(!x.erp_type||!x.pearnly_category||!x.erp_code){f(t("erp-map-save-fail"),"error");return}W={erp_type:x.erp_type,pearnly_category:x.pearnly_category,erp_code:x.erp_code,erp_name:x.erp_name||"",notes:x.notes||""}}else{if(!x.erp_type||!x.pearnly_tax_kind||!x.erp_code){f(t("erp-map-save-fail"),"error");return}W={erp_type:x.erp_type,pearnly_tax_kind:x.pearnly_tax_kind,erp_code:x.erp_code,notes:x.notes||""}}try{const K=await fetch(G,{method:"POST",headers:{"Content-Type":"application/json",Authorization:"Bearer "+M},body:JSON.stringify(W)});if(!K.ok)throw new Error("http_"+K.status);h.addingNew[$]=!1,await w($,!0),E(),f(t("erp-map-saved-toast"),"success")}catch{f(t("erp-map-save-fail"),"error")}}async function A(L){if(!await window.pearnlyConfirm(t("erp-map-confirm-delete")))return;const x=h.sub,M=localStorage.getItem("mrpilot_token");try{const W=await fetch("/api/erp/mappings/"+x+"/"+encodeURIComponent(L),{method:"DELETE",headers:{Authorization:"Bearer "+M}});if(!W.ok)throw new Error("http_"+W.status);await w(x,!0),E(),f(t("erp-map-deleted-toast"),"success")}catch{f(t("erp-map-delete-fail"),"error")}}async function v(){await u(),await w(h.sub,!1),d()}function l(L){L!==h.sub&&(h.sub=L,h.addingNew[L]=!1,["clients","accounts","taxes","products"].forEach(function($){$!==L&&(h.addingNew[$]=!1)}),document.querySelectorAll(".erp-map-subtab").forEach(function($){$.classList.toggle("active",$.dataset.erpSubtab===L)}),w(L,!1).then(function(){d()}))}function p(){h.bound||(h.bound=!0,document.addEventListener("click",function(L){const $=L.target.closest(".erp-subtab[data-erp-subtab]");if($){L.preventDefault();const K=$.dataset.erpSubtab;document.querySelectorAll(".erp-subtab").forEach(function(te){te.classList.toggle("active",te.dataset.erpSubtab===K)}),document.querySelectorAll(".erp-subpanel").forEach(function(te){te.classList.toggle("active",te.dataset.erpSubpanel===K)}),K==="mappings"&&setTimeout(v,50);return}const x=L.target.closest(".erp-map-subtab[data-erp-subtab]");if(x){L.preventDefault(),l(x.dataset.erpSubtab);return}if(L.target.closest("#erp-map-add-btn")){if(L.preventDefault(),!b())return;h.addingNew[h.sub]=!0,E();return}const W=L.target.closest('[data-erp-save="new"]');if(W){L.preventDefault();const K=W.closest('[data-erp-row="new"]');K&&F(K);return}const G=L.target.closest("[data-erp-del]");if(G){L.preventDefault(),A(G.dataset.erpDel);return}}))}function I(){const L=document.getElementById("erp-map-pane-wrap");L&&L.children.length>0&&d(),document.querySelectorAll(".erp-map-subtab").forEach(function($){const x="erp-map-subtab-"+$.dataset.erpSubtab,M=t(x);M&&M!==x&&($.textContent=M)})}p(),typeof window.subscribeI18n=="function"&&window.subscribeI18n("erp-mappings",I)})();(function(){let e=null,a=0,n=!1;function o(v){return typeof escapeHtml=="function"?escapeHtml(v==null?"":String(v)):String(v??"")}function i(v,l){try{typeof showToast=="function"&&showToast(v,l||"info")}catch{}}async function h(v){const l=Date.now();if(e&&l-a<3e4)return e;const p=localStorage.getItem("mrpilot_token");if(!p)return[];try{const I=await fetch("/api/erp/connectors/status",{headers:{Authorization:"Bearer "+p}});if(!I.ok)return[];const L=await I.json();return e=L&&L.connectors||[],a=l,e}catch{return[]}}function b(){try{return localStorage.getItem("pn_push_default_connector")||""}catch{return""}}function _(v){try{localStorage.setItem("pn_push_default_connector",v||"")}catch{}}function s(v){if(!v||!v.length)return null;const l=b();if(l){const I=v.find(L=>L.id===l);if(I)return I}const p=v.find(I=>I.is_default);return p||v[0]}function f(v){if(!v)return!1;const l=String(v.status||"").toLowerCase();return l==="exception"||l==="exception_pending"||l==="rejected"}function w(){try{return(typeof _results<"u"?_results:[])[typeof _drawerIdx<"u"?_drawerIdx:-1]||null}catch{return null}}function u(v){const l=v&&(v.type||v.id);return l==="xero"?'<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"><circle cx="8" cy="8" r="6"/><path d="M5.5 8l2 2 3-3.5"/></svg>':l==="webhook"?'<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"><circle cx="5" cy="11.5" r="1.8"/><circle cx="11" cy="4.5" r="1.8"/><path d="M6.4 10l3.2-4M5 9.6V5.5a3 3 0 016 0"/></svg>':'<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"><path d="M2 8h9M8 5l3 3-3 3"/><rect x="11" y="3" width="3" height="10" rx="1"/></svg>'}async function d(v,l){if(!v||!l)return!1;const p=document.getElementById("btn-push-default");p&&(p.disabled=!0,p.classList.add("loading"));const I=localStorage.getItem("mrpilot_token");try{let L,$={method:"POST",headers:{Authorization:"Bearer "+I}};v.type==="xero"?L="/api/erp/xero/push/"+encodeURIComponent(l):(L="/api/erp/push",$.headers["Content-Type"]="application/json",$.body=JSON.stringify({history_id:l,endpoint_id:v.endpoint_id||void 0}));const x=await fetch(L,$);let M={};try{M=await x.json()}catch{}if(!x.ok){let W=M&&M.detail||"unknown";typeof W=="object"&&(W=W.code||JSON.stringify(W));let G=String(W||"unknown");if(v.type==="xero"){const K=G.replace(/^xero\./,"").toLowerCase(),te=t("xero-"+K);te&&te!=="xero-"+K&&(G=te)}return i(t("unified-push-fail").replace("{name}",v.name).replace("{err}",G),"error"),!1}if(M&&M.ok===!1){let W=M.error_msg||M.error_code||"unknown";return W=String(W).slice(0,200),i(t("unified-push-fail").replace("{name}",v.name).replace("{err}",W),"error"),!1}return i(t("unified-push-ok").replace("{name}",v.name),"success"),!0}catch(L){return i(t("unified-push-fail").replace("{name}",v.name).replace("{err}",L.message||"network"),"error"),!1}finally{p&&(p.disabled=!1,p.classList.remove("loading"))}}async function E(v,l){for(const p of v)await d(p,l)}function k(v,l){const p=document.createElement("div");p.className="pn-push-dropdown",p.id="pn-push-dropdown";const I=(v||[]).map($=>{const x=!!(l&&$.id===l.id),M=$.method==="download"?t("unified-push-tag-download"):x?t("unified-push-tag-default"):"";return'<div class="pn-pd-item" data-cid="'+o($.id)+'"><span class="pn-pd-icon">'+u($)+'</span><span class="pn-pd-name">'+o($.name)+"</span>"+(M?'<span class="pn-pd-tag">'+o(M)+"</span>":"")+(x?'<span class="pn-pd-check">✓</span>':"")+"</div>"}).join(""),L=v&&v.length>1?'<div class="pn-pd-divider"></div><div class="pn-pd-item pn-pd-all" data-cid="__all__"><span class="pn-pd-icon"><svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"><path d="M3 6h10M3 10h10M3 13.5h6"/></svg></span><span class="pn-pd-name">'+o(t("unified-push-all").replace("{n}",v.length))+"</span></div>":"";return p.innerHTML=I+L,p}function R(){const v=document.getElementById("pn-push-dropdown");v&&v.remove()}async function q(){if(document.getElementById("pn-push-dropdown")){R();return}const v=await h()||[],l=s(v),p=k(v,l),I=document.getElementById("pn-push-wrap");I&&I.appendChild(p)}async function y(){const v=await h()||[],l=s(v);if(!l)return;const p=w(),I=p&&(p._historyId||p.history_id);if(I){if(f(p)){i(t("unified-push-disabled-exc"),"warn");return}await d(l,I)}}async function B(v){R();const l=await h()||[],p=w(),I=p&&(p._historyId||p.history_id);if(!I)return;if(f(p)){i(t("unified-push-disabled-exc"),"warn");return}if(v==="__all__"){await E(l,I);return}const L=l.find($=>$.id===v);L&&(_(v),await d(L,I),D())}async function O(){const v=document.getElementById("drawer-history-save");if(!v||v.querySelector("#pn-push-wrap"))return;const l=document.createElement("div");l.id="pn-push-wrap",l.className="pn-push-wrap",l.dataset.loading="1",v.insertBefore(l,v.firstChild),["btn-push-erp","btn-xero-push"].forEach(M=>{v.querySelectorAll("#"+M).forEach(W=>{W.style.display="none"})});const p=await h()||[],I=s(p),L=p.length>0;if(!L)l.innerHTML='<button type="button" class="btn btn-ghost pn-push-empty" id="btn-push-default" disabled title="'+o(t("unified-push-empty-tip"))+'"><svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"><path d="M2 8h9M8 5l3 3-3 3"/></svg><span style="margin-left:4px;">'+o(t("unified-push-empty"))+"</span></button>";else{const M=p.length>1;l.innerHTML='<div class="pn-push-split"><button type="button" class="pn-push-main" id="btn-push-default" title="'+o(t("unified-push-tip"))+'">'+u(I)+"<span>"+o(t("unified-push-to").replace("{name}",I?I.name:""))+"</span></button>"+(M?'<button type="button" class="pn-push-arrow" id="btn-push-arrow" title="'+o(t("unified-push-other"))+'"><svg viewBox="0 0 12 12" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M3 5l3 3 3-3"/></svg></button>':"")+"</div>"}delete l.dataset.loading;const $=l.querySelector("#btn-push-default");$&&L&&$.addEventListener("click",y);const x=l.querySelector("#btn-push-arrow");x&&x.addEventListener("click",function(M){M.stopPropagation(),q()}),n||(n=!0,document.addEventListener("click",function(M){const W=M.target.closest(".pn-pd-item");if(W){const G=W.getAttribute("data-cid");B(G);return}M.target.closest("#btn-push-arrow")||R()}),typeof window.subscribeI18n=="function"&&window.subscribeI18n("unified-push",D))}function D(){const v=document.getElementById("pn-push-wrap");v&&(v.remove(),e=null,a=0,O())}function F(){const v=document.getElementById("drawer-history-save");if(!v||!v.querySelector("#pn-push-wrap"))return;["btn-push-erp","btn-xero-push"].forEach(p=>{v.querySelectorAll("#"+p).forEach(I=>{I.style.display!=="none"&&(I.style.display="none")})});const l=v.querySelectorAll("#pn-push-wrap");if(l.length>1)for(let p=1;p<l.length;p++)l[p].remove()}function A(){try{const v=function(){return document.getElementById("drawer-body")},l=new MutationObserver(function(){document.getElementById("drawer-history-save")&&!document.getElementById("pn-push-wrap")&&O(),F()}),p=v();if(p)l.observe(p,{childList:!0,subtree:!0});else{const I=new MutationObserver(function(){const L=v();L&&(l.observe(L,{childList:!0,subtree:!0}),I.disconnect())});I.observe(document.body,{childList:!0,subtree:!0})}setTimeout(function(){document.getElementById("drawer-history-save")&&!document.getElementById("pn-push-wrap")&&O(),F()},200)}catch{}}A()})();(function(){function e(){const n=document.getElementById("erp-map-show-advanced-btn");if(!n)return;const o=document.getElementById("erp-map-subtabs");if(!o)return;const i=o.classList.contains("show-advanced"),h=n.querySelector(".erp-map-adv-btn-label");if(h&&typeof t=="function"){const b=i?"erp-map-hide-advanced":"erp-map-show-advanced",_=t(b);_&&_!==b&&(h.textContent=_)}n.setAttribute("aria-pressed",i?"true":"false")}document.addEventListener("click",function(n){if(!n.target.closest("#erp-map-show-advanced-btn"))return;n.preventDefault();const i=document.getElementById("erp-map-subtabs");if(i&&(i.classList.toggle("show-advanced"),e(),!i.classList.contains("show-advanced")&&i.querySelector(".erp-map-subtab.active.erp-map-subtab-advanced"))){const b=i.querySelector('.erp-map-subtab[data-erp-subtab="clients"]');b&&b.click()}});function a(){e()}typeof window.subscribeI18n=="function"&&window.subscribeI18n("erp-map-advanced-toggle",a)})();(function(){const e="pearnly_erp_onboard_shown";let a=!1;function n(){try{return Array.isArray(window._erpEndpoints)&&window._erpEndpoints.length>0}catch{return!1}}function o(){if(document.getElementById("erp-onboard-mask"))return;const h=document.createElement("div");h.id="erp-onboard-mask",h.className="erp-onboard-mask",h.innerHTML='<div class="erp-onboard-modal" role="dialog" aria-modal="true"><div class="erp-onboard-icon"><svg viewBox="0 0 32 32" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><rect x="4" y="6" width="24" height="20" rx="3"/><path d="M9 13h14M9 18h10"/><path d="M22 22l3 3 5-5"/></svg></div><div class="erp-onboard-title" id="erp-onboard-title"></div><div class="erp-onboard-body" id="erp-onboard-body"></div><div class="erp-onboard-btns"><button type="button" class="btn btn-secondary" id="erp-onboard-later"></button><button type="button" class="btn btn-primary" id="erp-onboard-ok"></button></div></div>',document.body.appendChild(h);function b(){const s=document.getElementById("erp-onboard-title"),f=document.getElementById("erp-onboard-body"),w=document.getElementById("erp-onboard-ok"),u=document.getElementById("erp-onboard-later");s&&(s.textContent=t("erp-onboard-title")),f&&(f.textContent=t("erp-onboard-body")),w&&(w.textContent=t("erp-onboard-ok")),u&&(u.textContent=t("erp-onboard-later"))}b();function _(){h.style.display="none"}document.getElementById("erp-onboard-ok").addEventListener("click",function(){try{localStorage.setItem(e,"1")}catch{}_();try{const s=document.querySelector('#btn-add-endpoint, [data-action="erp-add-endpoint"]');s&&s.scrollIntoView({behavior:"smooth",block:"center"})}catch{}}),document.getElementById("erp-onboard-later").addEventListener("click",function(){try{localStorage.setItem(e,"1")}catch{}_()}),h.addEventListener("click",function(s){s.target===h&&_()}),typeof window.subscribeI18n=="function"&&window.subscribeI18n("erp-onboard-modal",function(){h.style.display!=="none"&&b()})}function i(){if(!a){try{if(localStorage.getItem(e)==="1")return}catch{}n()||(a=!0,o(),requestAnimationFrame(function(){requestAnimationFrame(function(){if(n())return;const h=document.getElementById("erp-onboard-mask");h&&(h.style.display="flex")})}))}}document.addEventListener("click",function(h){const b=h.target.closest('.auto-nav-item[data-auto-tab="erp"]'),_=h.target.closest('.erp-subtab[data-erp-subtab="connect"]');(b||_)&&setTimeout(i,700)})})();(function(){const e={parse:{zh:"解析文件中",th:"กำลังอ่านไฟล์",en:"Parsing files",ja:"ファイル解析中"},report:{zh:"读取报告中",th:"กำลังอ่านรายงาน",en:"Reading report",ja:"レポート読込中"},reconcile:{zh:"对账中",th:"กำลังกระทบยอด",en:"Reconciling",ja:"照合中"},build:{zh:"生成中",th:"กำลังสร้างไฟล์",en:"Building",ja:"作成中"},persist:{zh:"保存中",th:"กำลังบันทึก",en:"Saving",ja:"保存中"},done:{zh:"完成",th:"เสร็จสิ้น",en:"Done",ja:"完了"}};window._reconProgressText=function(a,n){a=a||{},n=window._currentLang||n||localStorage.getItem("mrpilot_lang")||"th",e.parse[n]||(n="th");const o=a.stage||"parse",i=e[o]||e.parse,h=i[n]||i.th||i.en,b=a.stage_total,_=a.stage_done;if(o==="parse"&&Number.isFinite(b)&&b>0){const s={zh:"共 {d}/{t} 个文件",th:"{d}/{t} ไฟล์",en:"{d}/{t} files",ja:"{d}/{t} ファイル"}[n]||"{d}/{t} files";return h+" · "+s.replace("{d}",_||0).replace("{t}",b)}return h},window._reconPollJob=async function(a,n,o){o=o||{};const i=o.intervalMs||1500,h=o.maxMs||1200*1e3,b=Date.now();let _=0;for(;;){let s=null;try{const f=await fetch("/api/recon/jobs/"+encodeURIComponent(a),{headers:{Authorization:"Bearer "+n}});try{s=await f.json()}catch{s=null}(!f.ok||!s||!s.ok)&&(s=null)}catch{s=null}if(s){if(_=0,o.onProgress)try{o.onProgress(s.progress||{},s)}catch{}if(s.status==="done"||s.status==="failed"||s.status==="needs_review"||s.status==="needs_mapping")return s}else if(++_>=10)return{ok:!1,status:"failed",error_code:"poll_unreachable"};if(Date.now()-b>h)return{ok:!1,status:"timeout",error_code:"timeout"};await new Promise(f=>setTimeout(f,i))}}})();(function(){let e=!1,a=[],n=[],o=null,i="all",h=[],b={stmt:"",gl:""},_=[];const s=m=>document.getElementById(m);function f(m){if(m==null)return"—";const C=Number(m);return isNaN(C)?"—":C.toLocaleString("en-US",{minimumFractionDigits:2,maximumFractionDigits:2})}function w(m){return m?String(m).slice(0,10).split("-").reverse().join("/"):"—"}function u(m){return String(m||"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}function d(m,C){C=window._currentLang||C||"th";const T={stmt_headers_not_found:{zh:"认不出银行账单表头 · 请确认文件含日期/金额/余额列,或转成清晰的 Excel/CSV 重传",th:"หาหัวตารางบัญชีธนาคารไม่เจอ · ตรวจสอบว่ามีคอลัมน์ วันที่/จำนวนเงิน/ยอดคงเหลือ หรือแปลงเป็น Excel/CSV แล้วอัปโหลดใหม่",en:"Cannot detect bank statement headers · ensure the file has date/amount/balance columns, or re-upload as a clean Excel/CSV",ja:"銀行明細のヘッダーを認識できません · 日付/金額/残高列を確認するか、Excel/CSVに変換して再アップロードしてください"},gl_headers_not_found:{zh:"认不出总账表头 · 请确认文件含日期/科目/借方/贷方列,或转成清晰的 Excel/CSV 重传",th:"หาหัวตาราง GL ไม่เจอ · ตรวจสอบว่ามีคอลัมน์ วันที่/บัญชี/เดบิต/เครดิต หรือแปลงเป็น Excel/CSV แล้วอัปโหลดใหม่",en:"Cannot detect GL headers · ensure the file has date/account/debit/credit columns, or re-upload as a clean Excel/CSV",ja:"GLのヘッダーを認識できません · 日付/科目/借方/貸方列を確認するか、Excel/CSVに変換して再アップロードしてください"},stmt_no_rows:{zh:"文件里没有交易数据 · 请确认上传了正确的银行流水,或换更清晰的版本重传",th:"ไม่พบรายการธุรกรรมในไฟล์ · ตรวจสอบว่าอัปโหลด statement ที่ถูกต้อง หรือใช้เวอร์ชันที่ชัดเจนกว่า",en:"No transaction rows found · please upload the correct statement, or try a clearer version",ja:"取引データが見つかりません · 正しい明細をアップロードするか、より鮮明なファイルでお試しください"},no_rows:{zh:"解析后没有可对账的数据行 · 请确认文件内容完整,或换清晰版本重传",th:"ไม่มีแถวข้อมูลให้กระทบยอดหลังการอ่าน · ตรวจสอบความสมบูรณ์ของไฟล์ หรืออัปโหลดใหม่",en:"No reconcilable rows after parsing · check the file is complete, or re-upload a clearer version",ja:"解析後に照合可能な行がありません · ファイルの完全性を確認するか再アップロードしてください"},file_unreadable:{zh:"文件无法读取 · 可能已损坏或被加密 · 请换文件或转 PDF/Excel 重传",th:"อ่านไฟล์ไม่ได้ · อาจเสียหายหรือถูกเข้ารหัส · ลองไฟล์อื่นหรือแปลงเป็น PDF/Excel",en:"File cannot be read · may be corrupted or encrypted · try another file or convert to PDF/Excel",ja:"ファイルを読み取れません · 破損または暗号化の可能性 · 別ファイルまたはPDF/Excelに変換してください"},file_not_supported:{zh:"不支持此文件类型 · 请上传 PDF / 图片 / Excel / CSV",th:"ไม่รองรับไฟล์ประเภทนี้ · กรุณาอัปโหลด PDF / รูปภาพ / Excel / CSV",en:"File type not supported · please upload PDF / image / Excel / CSV",ja:"このファイル形式は非対応 · PDF / 画像 / Excel / CSV をアップロードしてください"},ocr_failed:{zh:"文件识别失败 · 请尝试更清晰的版本,或转成 PDF / Excel / CSV 重传",th:"อ่านไฟล์ไม่ออก · ลองเวอร์ชันที่ชัดเจนกว่า หรือแปลงเป็น PDF / Excel / CSV",en:"Could not read the file · try a clearer version, or convert to PDF / Excel / CSV",ja:"読み取りに失敗 · より鮮明なファイルか、PDF / Excel / CSV に変換して再試行してください"}},U={zh:"解析失败 · 请换更清晰的文件,或转成 Excel / CSV 后重新上传",th:"อ่านไฟล์ไม่สำเร็จ · ลองไฟล์ที่ชัดเจนกว่า หรือแปลงเป็น Excel / CSV แล้วอัปโหลดใหม่",en:"Parsing failed · try a clearer file, or convert to Excel / CSV and re-upload",ja:"解析に失敗しました · より鮮明なファイルか、Excel / CSV に変換して再アップロードしてください"},N=T[m]||U;return N[C]||N.th||N.en}function E(m){const C=m==="stmt"?a:n,T=s(`brv2-${m}-name`);if(T)if(C.length===0)T.textContent="";else{const N=window._currentLang||"zh",r={zh:"个文件",th:" ไฟล์",en:" file(s)",ja:" ファイル"};T.textContent=C.length+(r[N]||" 个文件")}const U=s("brv2-preview-panel");U&&U.style.display!=="none"&&q(m),k()}function k(){const m=s("brv2-toggle-preview"),C=s("brv2-preview-panel"),T=a.length+n.length>0;m&&(m.style.display=T?"":"none"),!T&&C&&(C.style.display="none",m&&m.classList.remove("open"))}function R(){q("stmt"),q("gl")}function q(m){const C=s(m==="stmt"?"brv2-pp-stmt-col":"brv2-pp-gl-col");if(!C)return;const T=m==="stmt"?a:n,U=window._currentLang||"zh",N={stmt:{zh:"① 银行账单",th:"① บัญชีธนาคาร",en:"① Bank Stmt",ja:"① 銀行明細"},gl:{zh:"② 总账 GL",th:"② GL รายงาน",en:"② GL Report",ja:"② GL帳簿"}},r=(N[m]||{})[U]||N[m].zh,j=u(window.t&&window.t("vex-preview-search")||"搜索文件名..."),z=u(window.t&&window.t("vex-preview-clear-all")||"全清"),J=b[m]||"";C.innerHTML='<div class="vex-pp-col-title"><span class="vex-pp-col-name">'+u(r)+' <span class="vex-pp-col-count">'+T.length+'</span></span></div><div class="vex-pp-search-row"><input class="vex-pp-search" id="brv2-pp-search-'+m+'" type="text" placeholder="'+j+'" value="'+u(J)+'" autocomplete="off"><button class="vex-pp-clear-btn" id="brv2-pp-clearall-'+m+'" type="button">'+z+'</button></div><div class="vex-pp-file-list" id="brv2-pp-'+m+'-list"></div><div class="vex-pp-pagination" id="brv2-pp-'+m+'-pg"></div>';const X=s("brv2-pp-search-"+m);X&&X.addEventListener("input",function(se){b[m]=se.target.value,y(m)});const de=s("brv2-pp-clearall-"+m);de&&de.addEventListener("click",function(){m==="stmt"?a.length=0:n.length=0,E(m),M()}),y(m)}function y(m){const C=s("brv2-pp-"+m+"-list"),T=s("brv2-pp-"+m+"-pg");if(!C)return;const U=m==="stmt"?a:n,N=(b[m]||"").toLowerCase(),r=N?U.filter(J=>J.name.toLowerCase().includes(N)):U.slice(),j='<svg class="vex-pp-fi-ico" viewBox="0 0 14 16" fill="none" stroke="currentColor" stroke-width="1.4" width="12" height="14"><path d="M3 1h6l3 3v11H3V1z"/><path d="M9 1v3h3"/></svg>',z='<svg viewBox="0 0 14 14" fill="none" stroke="currentColor" stroke-width="1.6" width="11" height="11"><path d="M2 4h10M5 4V2h4v2M5.5 7v4M8.5 7v4M3 4l1 8h6l1-8"/></svg>';if(C.innerHTML=r.map((J,X)=>'<div class="vex-pp-file-row">'+j+'<span class="vex-pp-fi-name" title="'+u(J.name)+'">'+u(J.name)+'</span><span class="vex-pp-fi-size">'+B(J.size)+'</span><button class="vex-pp-fi-del" type="button" data-zone="'+m+'" data-idx="'+U.indexOf(J)+'" aria-label="remove">'+z+"</button></div>").join(""),C.querySelectorAll(".vex-pp-fi-del").forEach(function(J){J.addEventListener("click",function(){const X=parseInt(J.dataset.idx,10);J.dataset.zone==="stmt"?a.splice(X,1):n.splice(X,1),E(J.dataset.zone),M()})}),T){const J=window.t&&window.t("vex-preview-count")||"显示 {n} / 共 {m}";T.textContent=J.replace("{n}",r.length).replace("{m}",U.length)}}function B(m){return m?m<1024?m+" B":m<1048576?(m/1024).toFixed(1)+" KB":(m/1048576).toFixed(1)+" MB":""}var O="pearnly.brv2.lastAnchorOcr";function D(m){try{var C=m&&m._anchor_ocr;if(!C||typeof C!="object")return;var T={stmt_opening:Number.isFinite(+C.stmt_opening)?+C.stmt_opening:null,gl_opening:Number.isFinite(+C.gl_opening)?+C.gl_opening:null,gl_closing:Number.isFinite(+C.gl_closing)?+C.gl_closing:null,stmt_closing:Number.isFinite(+C.stmt_closing)?+C.stmt_closing:null,ts:Date.now()};localStorage.setItem(O,JSON.stringify(T))}catch{}}function F(){try{var m=localStorage.getItem(O);if(!m)return null;var C=JSON.parse(m);return!C||typeof C!="object"?null:C}catch{return null}}function A(){var m=F();if(m){var C={"brv2-anchor-stmt-opening":m.stmt_opening,"brv2-anchor-gl-opening":m.gl_opening,"brv2-anchor-gl-closing":m.gl_closing,"brv2-anchor-stmt-closing":m.stmt_closing},T=0;Object.keys(C).forEach(function(z){var J=document.getElementById(z);if(J&&J.value===""){var X=C[z];if(Number.isFinite(X)){J.value=X.toFixed(2);var de=J.closest&&J.closest(".brv2-anchor-cell");de&&de.classList.add("is-prefilled"),T+=1}}});var U=document.getElementById("brv2-anchor-eq"),N=document.getElementById("brv2-anchor-eq-val");if(U&&N&&Number.isFinite(m.stmt_opening)&&Number.isFinite(m.gl_opening)){var r=m.stmt_opening-m.gl_opening;N.textContent=r.toLocaleString(void 0,{minimumFractionDigits:2,maximumFractionDigits:2}),U.style.display=""}if(T>0){var j=document.getElementById("brv2-anchor-prefill-banner");j&&j.classList.add("show")}}}function v(){var m=document.getElementById("brv2-anchor-prefill-banner");if(m){var C=!1;["brv2-anchor-gl-closing","brv2-anchor-stmt-closing","brv2-anchor-stmt-opening","brv2-anchor-gl-opening"].forEach(function(T){var U=document.getElementById(T);if(U){var N=U.closest&&U.closest(".brv2-anchor-cell");N&&N.classList.contains("is-prefilled")&&(C=!0)}}),m.classList.toggle("show",C)}}var l=[["stmt_opening","brv2-anchor-stmt-opening"],["gl_opening","brv2-anchor-gl-opening"],["gl_closing","brv2-anchor-gl-closing"],["stmt_closing","brv2-anchor-stmt-closing"]];function p(m,C){return window.t&&window.t(m)||C}function I(m){return String(m??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function L(m){return Number.isFinite(+m)?(+m).toLocaleString(void 0,{minimumFractionDigits:2,maximumFractionDigits:2}):"—"}function $(m){var C=document.getElementById("brv2-summary-collapse");if(!(!C||!C.parentNode)){var T=document.getElementById("brv2-anchor-audit"),U=m&&m._anchor_overrides;if(!U||typeof U!="object"||Object.keys(U).length===0){T&&T.parentNode&&T.parentNode.removeChild(T);return}T||(T=document.createElement("div"),T.id="brv2-anchor-audit",T.style.cssText="margin-top:14px;background:#fff7ed;border:1px solid #fed7aa;border-radius:8px;padding:14px 16px;",C.parentNode.insertBefore(T,C.nextSibling));var N=l.map(function(r){var j=U[r[0]];if(!j)return"";var z=+j.ocr||0,J=+j.user||0,X=J-z,de=X>0?"+":(X<0,""),se=Math.abs(X)<.005?"#6b7280":X>0?"#16a34a":"#dc2626";return'<tr><td style="padding:6px 10px;color:#111827;font-size:13px">'+I(p(r[1],r[0]))+'</td><td style="padding:6px 10px;color:#6b7280;font-size:13px;text-align:right;font-variant-numeric:tabular-nums">'+I(L(z))+'</td><td style="padding:6px 10px;background:#fef08a;color:#92400e;font-weight:600;font-size:13px;text-align:right;font-variant-numeric:tabular-nums">'+I(L(J))+'</td><td style="padding:6px 10px;color:'+se+';font-weight:500;font-size:13px;text-align:right;font-variant-numeric:tabular-nums">'+I(de+L(X))+"</td></tr>"}).join("");T.innerHTML='<div style="font-weight:600;color:#92400e;font-size:13px;margin-bottom:10px">'+I(p("brv2-anchor-audit-title","⚠ This run contains manually entered anchors"))+'</div><table style="width:100%;border-collapse:collapse;font-family:inherit"><thead><tr><th style="padding:6px 10px;text-align:left;color:#6b7280;font-size:11px;font-weight:500;border-bottom:1px solid #fed7aa">'+I(p("brv2-anchor-audit-col-field","Field"))+'</th><th style="padding:6px 10px;text-align:right;color:#6b7280;font-size:11px;font-weight:500;border-bottom:1px solid #fed7aa">'+I(p("brv2-anchor-audit-col-ocr","OCR"))+'</th><th style="padding:6px 10px;text-align:right;color:#6b7280;font-size:11px;font-weight:500;border-bottom:1px solid #fed7aa">'+I(p("brv2-anchor-audit-col-user","User"))+'</th><th style="padding:6px 10px;text-align:right;color:#6b7280;font-size:11px;font-weight:500;border-bottom:1px solid #fed7aa">'+I(p("brv2-anchor-audit-col-diff","Diff"))+"</th></tr></thead><tbody>"+N+"</tbody></table>"}}function x(){const m=s("brv2-toggle-preview");m&&!m._reconBound&&(m._reconBound=!0,m.addEventListener("click",function(){const C=s("brv2-preview-panel"),T=s("brv2-toggle-preview-label"),U=C&&C.style.display!=="none";C&&(C.style.display=U?"none":""),m.classList.toggle("open",!U),T&&(T.textContent=U?window.t&&window.t("vex-toggle-preview-open")||"查看清单":window.t&&window.t("vex-toggle-preview-close")||"收起清单"),U||R()}))}function M(){const m=s("brv2-run-btn"),C=s("brv2-status"),T=a.length>0,U=n.length>0;if(m&&(m.disabled=!(T&&U)),C){const N=window._currentLang||"zh";if(!T&&!U){const r={zh:"请上传银行账单和 GL 文件",th:"กรุณาอัปโหลดบัญชีธนาคารและ GL",en:"Upload bank statement and GL files",ja:"銀行明細と GL を両方アップロードしてください"};C.textContent=r[N]||r.zh}else if(T)if(U){const r={zh:"两份文件已就绪",th:"พร้อมสอบทาน",en:"Ready to reconcile",ja:"照合を開始できます"};C.textContent=r[N]||r.zh}else{const r={zh:"还缺 GL 文件",th:"ยังขาดไฟล์ GL",en:"Missing GL file",ja:"GL ファイルが未アップロード"};C.textContent=r[N]||r.zh}else{const r={zh:"还缺银行账单 PDF",th:"ยังขาดไฟล์บัญชีธนาคาร PDF",en:"Missing bank statement PDF",ja:"銀行明細 PDF が未アップロード"};C.textContent=r[N]||r.zh}}}function W(m,C,T){const U=s(m),N=s(C);!U||!N||(U.addEventListener("click",()=>N.click()),U.addEventListener("keydown",r=>{(r.key==="Enter"||r.key===" ")&&(r.preventDefault(),N.click())}),U.addEventListener("dragover",r=>{r.preventDefault(),U.classList.add("drag-over")}),U.addEventListener("dragleave",()=>U.classList.remove("drag-over")),U.addEventListener("drop",r=>{r.preventDefault(),U.classList.remove("drag-over");const j=Array.from(r.dataTransfer.files||[]);T==="stmt"?a.push(...j):n.push(...j),E(T),M()}),N.addEventListener("change",()=>{const r=Array.from(N.files||[]);T==="stmt"?a.push(...r):n.push(...r),N.value="",E(T),M()}))}function G(m){const C=s("brv2-progress"),T=s("brv2-run-btn"),U=s("brv2-error");C&&(C.style.display=m?"":"none"),T&&(T.disabled=m),U&&(U.style.display="none")}function K(m){const C=s("brv2-error");C&&(C.textContent=m,C.style.display="",C.scrollIntoView({behavior:"smooth",block:"nearest"})),G(!1),M(),window.showToast&&window.showToast(m,"error")}async function te(){if(a.length===0||n.length===0)return;const m=localStorage.getItem("mrpilot_token")||"",C=window._currentLang||"zh",T=(s("brv2-acct-select")||{}).value||"";S(!1),G(!0);try{const U=new FormData;a.forEach(ae=>U.append("stmt_files",ae)),n.forEach(ae=>U.append("gl_files",ae)),U.append("gl_account",T),U.append("lang",C);const N=parseFloat((s("brv2-anchor-gl-closing")||{}).value),r=parseFloat((s("brv2-anchor-stmt-closing")||{}).value),j=parseFloat((s("brv2-anchor-stmt-opening")||{}).value),z=parseFloat((s("brv2-anchor-gl-opening")||{}).value);Number.isFinite(N)&&U.append("gl_closing_override",N),Number.isFinite(r)&&U.append("stmt_closing_override",r),Number.isFinite(j)&&U.append("stmt_opening_override",j),Number.isFinite(z)&&U.append("gl_opening_override",z);const J=await fetch("/api/recon/bank-v2/submit",{method:"POST",headers:{Authorization:"Bearer "+m},body:U});let X=null;try{X=await J.json()}catch{X=null}if(X&&X.needs_mapping){G(!1),window.ReconMapping?window.ReconMapping.show(X,{token:m,lang:C,onConfirmed:function(){te()}}):K(t("brv2-err-server")||"服务器繁忙,请稍后重试");return}if(!J.ok||!X||!X.ok||!X.job_id){G(!1),X&&(X.detail||X.error)?K(_humanizeBackendError(X.detail||X.error,"Error "+J.status)):K(t("brv2-err-server")||"服务器繁忙,请稍后重试");return}const de=s("brv2-progress-sub"),se=await window._reconPollJob(X.job_id,m,{onProgress:ae=>{de&&(de.textContent=window._reconProgressText(ae,C))}});if(se&&se.status==="needs_mapping"&&se.mapping){G(!1),window.ReconMapping?window.ReconMapping.show(se.mapping,{token:m,lang:C,onConfirmed:function(){te()}}):K(t("brv2-err-server")||"服务器繁忙,请稍后重试");return}if(se&&se.status==="needs_review"&&se.review){G(!1),window.ReconReview?window.ReconReview.show(se.review,{token:m,lang:C,jobId:X.job_id,onConfirmed:async function(ae){G(!0);const pe=await window._reconPollJob(ae,m,{onProgress:ve=>{de&&(de.textContent=window._reconProgressText(ve,C))}});await ce(pe)}}):K(t("brv2-err-server")||"服务器繁忙,请稍后重试");return}if(se&&se.status==="failed"){G(!1),K(d(se.error_code,C));return}await ce(se);async function ce(ae){try{if(!ae||ae.status!=="done"||!ae.result_id){G(!1),K(t("brv2-err-server")||"服务器繁忙,请稍后重试");return}const pe=await fetch("/api/recon/bank-v2/"+encodeURIComponent(ae.result_id),{headers:{Authorization:"Bearer "+m}});let ve=null;try{ve=await pe.json()}catch{ve=null}if(!pe.ok||ve===null||!ve.ok){G(!1),K(t("brv2-err-server")||"服务器繁忙,请稍后重试");return}(ve.gl_accounts||[]).length>1&&re(ve.gl_accounts),o=ve,h=ve.detail||[],i="all",document.querySelectorAll(".brv2-filter-btn").forEach(ge=>ge.classList.toggle("active",ge.dataset.filter==="all")),D(ve&&ve.summary),G(!1),P(ve),Z();const fe=s("brv2-summary-collapse");fe&&fe.scrollIntoView({behavior:"smooth",block:"nearest"})}catch(pe){G(!1),K(pe.message||"Network error")}}}catch(U){K(U.message||"Network error")}}function re(m){const C=s("brv2-acct-select");if(!C)return;const T=window._currentLang||"zh",U={zh:"全部账户",th:"ทุกบัญชี",en:"All Accounts",ja:"すべての口座"}[T]||"全部账户";C.innerHTML=`<option value="">${U}</option>`+m.map(N=>`<option value="${u(N)}">${u(N)}</option>`).join(""),C.style.display=""}function S(m){const C=s("brv2-summary-collapse"),T=s("brv2-detail-collapse"),U=s("brv2-export-btn"),N=s("brv2-new-btn"),r=s("brv2-parse-info-wrap");C&&(C.style.display=m?"":"none"),T&&(T.style.display=m?"":"none"),U&&(U.style.display=m?"":"none"),N&&(N.style.display=m?"":"none"),!m&&r&&(r.style.display="none");const j=s("brv2-warnings");!m&&j&&(j.style.display="none",j.innerHTML="")}function g(m){const C=s("brv2-parse-info-wrap"),T=s("brv2-parse-info-body");if(!C||!T)return;const U=m.parse_info;if(!U){C.style.display="none";return}const N=window._currentLang||"zh",r={title:{zh:"文件解析状态",th:"สถานะการอ่านไฟล์",en:"File Parse Status",ja:"ファイル解析状態"},type:{zh:"类型",th:"ประเภท",en:"Type",ja:"種別"},file:{zh:"文件名",th:"ชื่อไฟล์",en:"File",ja:"ファイル"},rows:{zh:"解析行数",th:"แถวที่พบ",en:"Rows Found",ja:"解析行数"},bank:{zh:"银行/科目",th:"ธนาคาร/บัญชี",en:"Bank/Account",ja:"銀行/科目"},status:{zh:"状态",th:"สถานะ",en:"Status",ja:"状態"},stmt:{zh:"账单",th:"บัญชีธนาคาร",en:"Stmt",ja:"明細"},gl:{zh:"总账GL",th:"GL",en:"GL",ja:"GL"},ok:{zh:"✓ 成功",th:"✓ สำเร็จ",en:"✓ OK",ja:"✓ 成功"},warn:{zh:"⚠ 0行",th:"⚠ 0 แถว",en:"⚠ 0 rows",ja:"⚠ 0行"},fail:{zh:"✗ 失败",th:"✗ ล้มเหลว",en:"✗ Failed",ja:"✗ 失敗"}},j=ce=>(r[ce]||{})[N]||(r[ce]||{}).zh||ce,z=[...(U.stmt_files||[]).map(ce=>({...ce,_type:"stmt",_extra:ce.bank_code||""})),...(U.gl_files||[]).map(ce=>({...ce,_type:"gl",_extra:(ce.accounts||[]).join(", ")}))],J={stmt_headers_not_found:{zh:"认不出表头列 · 请确认文件含日期/金额/余额列",th:"หาคอลัมน์หัวตารางไม่เจอ · ตรวจสอบไฟล์มีวันที่/จำนวนเงิน/ยอดคงเหลือ",en:"Cannot detect column headers · ensure file has date/amount/balance columns",ja:"列ヘッダーが認識できません · 日付/金額/残高列を確認してください"},stmt_no_rows:{zh:"文件里没有交易数据 · 请确认上传了正确的银行流水",th:"ไม่พบรายการธุรกรรมในไฟล์ · ตรวจสอบว่าอัปโหลด statement ที่ถูกต้อง",en:"No transaction rows found · please check the file",ja:"取引データが見つかりません · ファイルを確認してください"},file_not_supported:{zh:"不支持此文件类型 · 请上传 PDF / 图片 / Excel / CSV",th:"ไม่รองรับไฟล์ประเภทนี้ · กรุณาอัปโหลด PDF / รูปภาพ / Excel / CSV",en:"File type not supported · please upload PDF / image / Excel / CSV",ja:"このファイル形式は非対応 · PDF / 画像 / Excel / CSV をアップロード"},file_unreadable:{zh:"文件无法读取 · 可能已损坏或被加密",th:"อ่านไฟล์ไม่ได้ · อาจเสียหายหรือถูกเข้ารหัส",en:"File cannot be read · may be corrupted or encrypted",ja:"ファイルを読み取れません · 破損または暗号化の可能性"},ocr_failed:{zh:"文件识别失败 · 请尝试更清晰的版本或换 PDF 格式重传",th:"อ่านไฟล์ไม่ออก · ลองเวอร์ชันที่ชัดเจนกว่าหรือเปลี่ยนเป็น PDF",en:"Could not read file · try a clearer version or upload as PDF",ja:"読み取り失敗 · より鮮明なファイルまたは PDF 形式で再試行"},gl_headers_not_found:{zh:"认不出总账表头 · 请确认文件含科目/借方/贷方列",th:"หาหัวคอลัมน์ GL ไม่เจอ · ตรวจสอบมีคอลัมน์บัญชี/เดบิต/เครดิต",en:"Cannot detect GL column headers · ensure account/debit/credit columns exist",ja:"GL 列ヘッダー認識不可 · 科目/借方/貸方列を確認してください"}},X=ce=>{const ae=String(ce||"");return/Cannot detect bank statement column headers/i.test(ae)?"stmt_headers_not_found":/Cannot detect GL column headers/i.test(ae)?"gl_headers_not_found":/No transaction rows found|no pages parsed/i.test(ae)?"stmt_no_rows":/unsupported format/i.test(ae)?"file_not_supported":/Cannot read Excel|file_unreadable/i.test(ae)?"file_unreadable":/Gemini.*invalid JSON|Gemini.*parsed but failed|validation errors|BankStatementDocument schema|layer2:|layer1:/i.test(ae)?"ocr_failed":null},de=ce=>{const ae=ce.error_code||X(ce.error);if(ae&&J[ae]){const pe=window._currentLang||"zh";return J[ae][pe]||J[ae].zh}return String(ce.error||"").slice(0,80)},se=ce=>!ce.ok&&ce.error?`<span style="color:#dc2626">${j("fail")} — ${u(de(ce))}</span>`:ce.rows?`<span style="color:#059669">${j("ok")} (${ce.rows})</span>`:`<span style="color:#d97706">${j("warn")}</span>`;T.innerHTML=`
            ...
            <table style="width:100%;border-collapse:collapse;font-size:12px;margin-bottom:4px">
              ...
              <td>${z?"L"+z:"—"}</td>
            </tr>`}).join("")}async function Z(){const m=localStorage.getItem("mrpilot_token")||"";try{const T=await(await fetch("/api/recon/bank-v2/tasks",{headers:{Authorization:"Bearer "+m}})).json();ee(T.tasks||[])}catch{const T=s("brv2-history-empty"),U=window._currentLang||"zh",N={zh:"加载失败",th:"โหลดประวัติไม่ได้",en:"Load failed",ja:"読み込み失敗"}[U]||"加载失败";T&&(T.textContent=N,T.style.display="");const r=s("brv2-history-table-wrap");r&&(r.style.display="none")}}const le=10;let ie=1;function V(){const m=s("brv2-history-pager"),C=s("brv2-history-pager-info"),T=s("brv2-history-prev"),U=s("brv2-history-next");if(!m)return;if(_.length<=le){m.style.display="none";return}m.style.display="";const N=Math.ceil(_.length/le);C&&(C.textContent=ie+" / "+N),T&&(T.disabled=ie<=1),U&&(U.disabled=ie>=N)}function Q(){const m=s("brv2-history-prev"),C=s("brv2-history-next");m&&!m._brv2Bound&&(m._brv2Bound=!0,m.addEventListener("click",()=>{ie>1&&(ie--,ee(_))})),C&&!C._brv2Bound&&(C._brv2Bound=!0,C.addEventListener("click",()=>{const T=Math.ceil(_.length/le);ie<T&&(ie++,ee(_))}))}function ee(m){m!==void 0&&(_=m||[],ie=1);const C=_,T=s("brv2-history-empty"),U=s("brv2-history-table-wrap"),N=s("brv2-history-tbody");if(!N)return;const r=window._currentLang||"zh";if(!C.length){const ae={zh:"暂无对账记录",th:"ยังไม่มีประวัติ",en:"No records yet",ja:"記録なし"}[r]||"暂无对账记录";T&&(T.textContent=ae,T.style.display=""),U&&(U.style.display="none"),V();return}T&&(T.style.display="none"),U&&(U.style.display="");const j=Math.ceil(C.length/le);ie>j&&(ie=j);const z=(ie-1)*le,J=C.slice(z,z+le),X=localStorage.getItem("mrpilot_token")||"",de='<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" width="14" height="14"><circle cx="8" cy="8" r="6"/><polyline points="6 8 8 10 10 8"/><line x1="8" y1="4" x2="8" y2="10"/></svg>',se='<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" width="14" height="14"><path d="M8 2v9M4 7l4 4 4-4M3 14h10"/></svg>',ce='<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" width="14" height="14"><polyline points="3 4 13 4"/><path d="M6 4V2.5a.5.5 0 0 1 .5-.5h3a.5.5 0 0 1 .5.5V4"/><path d="M5 4l1 9a1 1 0 0 0 1 1h2a1 1 0 0 0 1-1l1-9"/></svg>';N.innerHTML="",J.forEach(ae=>{const pe=Number(ae.formula_diff||0),ve=Math.abs(pe)<.05,fe=(ae.stmt_files||"").split(";").map(we=>we.trim().split(/[/\\]/).pop()).filter(Boolean).join(", "),ge=(ae.gl_files||"").split(";").map(we=>we.trim().split(/[/\\]/).pop()).filter(Boolean).join(", "),be=ae.created_at?String(ae.created_at).slice(0,16).replace("T"," "):"",ke=document.createElement("tr");ke.dataset.taskId=ae.id;const Pe=document.createElement("td");Pe.textContent=be;const Ie=document.createElement("td");Ie.className="glv-history-file",Ie.title=fe+" + "+ge,Ie.textContent=fe+" + "+ge;const Le=document.createElement("td");Le.className="glv-num",Le.textContent=(ae.stmt_row_count||0)+" / "+(ae.gl_row_count||0);const Oe=document.createElement("td");Oe.className="glv-num",Oe.textContent=ae.matched_count||0;const Fe=document.createElement("td");Fe.className="glv-num",Fe.textContent=ae.unmatched_gl||0;const Ve=document.createElement("td");Ve.className="glv-num",Ve.textContent=ae.unmatched_stmt||0;const De=document.createElement("td");De.className="glv-num",De.style.color=ve?"#059669":"#dc2626",De.textContent=ve?"✓":f(pe);const Ce=document.createElement("td");Ce.className="glv-history-actions";const Ue=(we,Xe,Ze,bt)=>{const _e=document.createElement("button");return _e.type="button",_e.title=Xe,_e.setAttribute("aria-label",Xe),Ze&&(_e.className=Ze),_e.innerHTML=we,_e.onclick=yt=>{yt.stopPropagation(),bt()},_e},ft={zh:"删除这条记录?",th:"ลบรายการนี้?",en:"Delete this record?",ja:"この記録を削除しますか?"}[r]||"删除?",mt={zh:"加载",th:"โหลด",en:"Load",ja:"読込"}[r]||"加载",ht={zh:"导出",th:"ส่งออก",en:"Export",ja:"エクスポート"}[r]||"导出",gt={zh:"删除",th:"ลบ",en:"Delete",ja:"削除"}[r]||"删除";Ce.appendChild(Ue(de,mt,"",()=>oe(ae.id,X))),Ce.appendChild(Ue(se,ht,"",()=>c(ae.id))),Ce.appendChild(Ue(ce,gt,"glv-del",async()=>{await showConfirm(ft,{danger:!0})&&(await fetch("/api/recon/bank-v2/"+ae.id,{method:"DELETE",headers:{Authorization:"Bearer "+X}}),Z())})),[Pe,Ie,Le,Oe,Fe,Ve,De,Ce].forEach(we=>ke.appendChild(we)),ke.style.cursor="pointer",ke.addEventListener("click",async we=>{we.target.closest(".glv-del")||we.target.closest("button")||await oe(ae.id,X)}),N.appendChild(ke)}),V(),ne()}function ne(){const m=((s("brv2-hist-search")||{}).value||"").trim().toLowerCase(),C=s("brv2-history-tbody");C&&C.querySelectorAll("tr").forEach(T=>{T.dataset.taskId&&(T.style.display=!m||T.textContent.toLowerCase().includes(m)?"":"none")})}async function oe(m,C){try{const U=await(await fetch("/api/recon/bank-v2/"+m,{headers:{Authorization:"Bearer "+C}})).json();if(!U.ok)return;o={task_id:U.task_id,...U},h=U.detail||[],i="all",document.querySelectorAll(".brv2-filter-btn").forEach(N=>N.classList.toggle("active",N.dataset.filter==="all")),P(o)}catch{}}function ue(){if(e){Z();return}e=!0,W("brv2-stmt-zone","brv2-stmt-input","stmt"),W("brv2-gl-zone","brv2-gl-input","gl");const m=["brv2-anchor-gl-closing","brv2-anchor-stmt-closing","brv2-anchor-stmt-opening","brv2-anchor-gl-opening"];function C(){const z=parseFloat((s("brv2-anchor-stmt-opening")||{}).value),J=parseFloat((s("brv2-anchor-gl-opening")||{}).value),X=s("brv2-anchor-eq"),de=s("brv2-anchor-eq-val");if(!(!X||!de))if(Number.isFinite(z)&&Number.isFinite(J)){const se=z-J;de.textContent=se.toLocaleString(void 0,{minimumFractionDigits:2,maximumFractionDigits:2}),X.style.display=""}else X.style.display="none"}m.forEach(z=>{const J=s(z);J&&(J.addEventListener("input",C),J.addEventListener("input",()=>{const X=J.closest(".brv2-anchor-cell");X&&X.classList.remove("is-prefilled"),v()}))}),A();const T=s("brv2-run-btn");T&&T.addEventListener("click",te);const U=s("brv2-reset-btn");U&&U.addEventListener("click",()=>{o=null,h=[],a=[],n=[],E("stmt"),E("gl"),M(),S(!1);const z=s("brv2-acct-select");z&&(z.style.display="none"),m.forEach(de=>{const se=s(de);if(se){se.value="";const ce=se.closest&&se.closest(".brv2-anchor-cell");ce&&ce.classList.remove("is-prefilled")}});const J=s("brv2-anchor-eq");J&&(J.style.display="none");const X=s("brv2-anchor-prefill-banner");X&&X.classList.remove("show")});const N=s("brv2-new-btn");N&&N.addEventListener("click",()=>{o=null,h=[],a=[],n=[],E("stmt"),E("gl"),M(),S(!1)});const r=s("brv2-filter-tabs");r&&r.addEventListener("click",z=>{z.stopPropagation();const J=z.target.closest(".brv2-filter-btn");J&&(i=J.dataset.filter,r.querySelectorAll(".brv2-filter-btn").forEach(X=>X.classList.toggle("active",X===J)),Y())}),x(),Q();const j=s("brv2-hist-search");j&&j.addEventListener("input",ne),Z(),M(),window._brv2LoadHistory=Z,Array.isArray(window.__i18nSubs)||(window.__i18nSubs=[]),window.__i18nSubs=window.__i18nSubs.filter(z=>z.name!=="brv2"),window.__i18nSubs.push({name:"brv2",fn:function(){M(),E("stmt"),E("gl"),o&&P(o),ee()}})}window._loadBankReconV2Panel=function(m){const C=m?document.getElementById(m):null;C&&C.id!=="recon-pane-bank"&&(C.innerHTML=`<div style="padding:16px;font-size:13px;color:var(--ink-3)">
                银行对账 v2 · 请前往对账中心使用</div>`),ue()},document.addEventListener("DOMContentLoaded",()=>{s("brv2-run-btn")&&ue()}),window._bankReconV2Init=ue})();(function(){const e=document.getElementById("general-lang");if(!e)return;e.addEventListener("change",n=>{const o=n.target.value;o&&applyLang(o)});const a=typeof currentLang=="string"&&currentLang||localStorage.getItem("mrpilot_lang")||"th";e.value=a})();(function(){const a="pearnly_general_tz",n="pearnly_general_date_format",o="pearnly_general_number_format",i={tz:"Asia/Bangkok",date:"YYYY-MM-DD",number:"comma_dot"};function h(){const f=document.getElementById("general-tz"),w=document.getElementById("general-date"),u=document.getElementById("general-number");if(!(!f||!w||!u))try{f.value=localStorage.getItem(a)||i.tz,w.value=localStorage.getItem(n)||i.date,u.value=localStorage.getItem(o)||i.number}catch{f.value=i.tz,w.value=i.date,u.value=i.number}}async function b(){const f=document.getElementById("btn-save-general"),w=document.getElementById("general-save-msg");if(!f)return;const u=f.innerHTML;f.disabled=!0,f.innerHTML="<span>"+(t("msg-saving")||"保存中...")+"</span>",w&&(w.textContent="",w.classList.remove("error"));try{const d=(document.getElementById("general-tz")||{}).value||i.tz,E=(document.getElementById("general-date")||{}).value||i.date,k=(document.getElementById("general-number")||{}).value||i.number;try{localStorage.setItem(a,d),localStorage.setItem(n,E),localStorage.setItem(o,k)}catch{}window._pearnlyGeneral={tz:d,date_format:E,number_format:k},w&&(w.textContent=t("msg-saved")||"已保存")}catch{w&&(w.textContent=t("msg-save-failed")||"保存失败",w.classList.add("error"))}finally{f.disabled=!1,f.innerHTML=u,setTimeout(function(){w&&(w.textContent="")},3e3)}}function _(){const f=document.getElementById("btn-save-general");if(!f){setTimeout(_,200);return}f._pearnlyGenBound||(f._pearnlyGenBound=!0,f.addEventListener("click",b),h())}function s(){h();const f=document.getElementById("general-lang");if(f){const w=typeof currentLang=="string"&&currentLang||localStorage.getItem("mrpilot_lang")||"th";f.value=w}}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",_):_(),typeof window.subscribeI18n=="function"&&window.subscribeI18n("settings-general",s)})();(function(){const e="mrpilot_nav_collapsed",a={ocr:"sales",history:"sales",reconcile:"sales","sales-invoices":"sales",receivables:"sales",vouchers:"expense"};function n(){try{const b=localStorage.getItem(e);return b?JSON.parse(b):{}}catch{return{}}}function o(b){try{localStorage.setItem(e,JSON.stringify(b))}catch{}}function i(){const b=n();document.querySelectorAll(".nav-collapsible").forEach(function(_){const s=_.dataset.collapsible;b[s]?_.classList.add("collapsed"):_.classList.remove("collapsed")})}function h(b){const _=n();_[b]=!_[b],o(_),i()}(function(){const _=n();let s=!1;_.sales===void 0&&(_.sales=!1,s=!0),_.expense===void 0&&(_.expense=!0,s=!0),s&&o(_)})(),i(),document.querySelectorAll(".nav-group-toggle").forEach(function(b){b.addEventListener("click",function(){h(b.dataset.toggleGroup)})}),window.expandNavGroupForRoute=function(b){const _=a[b];if(!_)return;const s=n();s[_]&&(s[_]=!1,o(s),i())}})();(function(){function e(){const a=document.getElementById("help-modal"),n=document.getElementById("help-modal-close");a&&(n&&!n.dataset.bound&&(n.addEventListener("click",function(){a.style.display="none"}),n.dataset.bound="1"),a.dataset.maskBound||(a.addEventListener("click",function(o){o.target===a&&(a.style.display="none")}),a.dataset.maskBound="1"),window._helpModalEscBound||(document.addEventListener("keydown",function(o){o.key==="Escape"&&a.style.display==="flex"&&(a.style.display="none")}),window._helpModalEscBound=!0))}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",e):e()})();(function(){const e={line:"line",folder:"folder",gmail:"email",erp:"erp",alert:"alert"};document.addEventListener("click",function(a){const n=a.target.closest(".int-btn-configure");if(!n)return;const o=n.closest(".integration-row"),i=o?o.dataset.intAnchor:null;if(i&&e[i]){const h=o.querySelector(".int-name"),b=h?(h.textContent||h.innerText||"").trim():"配置";typeof window.openIntegrationDrawer=="function"&&window.openIntegrationDrawer(e[i],b)}})})();let ye=[];window._erpEndpoints=ye;let Ae=null;async function Ne(){try{const e=await fetch("/api/erp/endpoints",{headers:{Authorization:"Bearer "+token}});if(e.status===401){localStorage.removeItem("mrpilot_token");const n=await e.json().catch(()=>({}));if((typeof n.detail=="string"?n.detail:n.detail&&n.detail.code||"")==="auth.session_revoked"){_showSessionRevokedModal();return}window.location.href="/";return}ye=(await e.json()).items||[],window._erpEndpoints=ye,st()}catch(e){console.error("load endpoints failed",e)}}window._refreshErpEndpointsCache=function(){return Ne()};async function ot(){const e=document.getElementById("erp-today-stats");if(e){e.innerHTML="";try{const a=await fetch("/api/erp/stats/today",{headers:{Authorization:"Bearer "+token}});if(!a.ok)return;const n=await a.json(),o=n.total||0,i=n.success||0,h=n.failed||0,b=n.auto_cnt||0;if(o===0){e.innerHTML=`<span class="erp-today-empty">${escapeHtml(t("erp-today-none"))}</span>`;return}const _=[];_.push(`<span class="erp-today-item"><strong>${o}</strong> ${escapeHtml(t("erp-today-total"))}</span>`),i>0&&_.push(`<span class="erp-today-item ok"><strong>${i}</strong> ${escapeHtml(t("erp-today-success"))}</span>`),h>0&&_.push(`<span class="erp-today-item fail"><strong>${h}</strong> ${escapeHtml(t("erp-today-failed"))}</span>`),b>0&&_.push(`<span class="erp-today-item auto"><strong>${b}</strong> ${escapeHtml(t("erp-today-auto"))}</span>`),e.innerHTML=_.join("")}catch(a){console.warn("loadErpTodayStats failed",a)}}}function st(){const e=document.getElementById("erp-endpoints-list"),a=document.getElementById("erp-status-summary"),n=document.getElementById("btn-add-endpoint");if(!e){console.warn("erp-endpoints-list 容器不存在");return}if(n&&_userInfo){const i=_userInfo.endpoints_limit;i!==-1&&ye.length>=i?(n.disabled=!0,n.title=t("ep-limit-reached",{limit:i}),n.classList.add("btn-disabled-plus")):(n.disabled=!1,n.title="",n.classList.remove("btn-disabled-plus"))}if(ye.length===0){e.innerHTML=`<div class="erp-empty">${escapeHtml(t("ep-list-empty"))}</div>`,a&&(a.textContent=t("auto-status-none"),a.className="auto-status-pill none");return}const o=ye.some(i=>i.auto_push&&i.enabled);if(a&&(a.textContent=t("auto-status-active",{n:ye.length,mode:o?t("auto-status-on"):t("auto-status-off")}),a.className="auto-status-pill "+(o?"active":"ready")),ot(),e.innerHTML=ye.map(i=>{const h=i.config||{},b=escapeHtml(h.url||"");h._token_set;const _=i.enabled!==!1,s=[];i.is_default&&s.push(`<span class="ep-badge default">${escapeHtml(t("ep-default"))}</span>`),i.auto_push&&s.push(`<span class="ep-badge auto">${escapeHtml(t("ep-auto-push-on"))}</span>`),_||s.push(`<span class="ep-badge disabled">${escapeHtml(t("ep-disabled"))}</span>`);const f=[];return i.success_count>0&&f.push(`<span class="ep-stat ok">${escapeHtml(t("ep-success",{n:i.success_count}))}</span>`),i.failure_count>0&&f.push(`<span class="ep-stat fail">${escapeHtml(t("ep-failure",{n:i.failure_count}))}</span>`),`
        ...
        `}).join(""),_userInfo&&_userInfo.endpoints_limit!==-1){const i=ye.length,h=_userInfo.endpoints_limit,b=_userInfo.plan,_=document.createElement("div");_.className="erp-limit-hint",b==="free"?_.innerHTML=`${escapeHtml(t("ep-free-limit-hint",{used:i,limit:h}))} <a data-upgrade="plus">${escapeHtml(t("upgrade-to-plus"))}</a>`:_.textContent=t("ep-plus-limit-hint",{used:i,limit:h}),e.appendChild(_)}}function Tt(e){Ae=e||null;const a=document.getElementById("endpoint-modal"),n=document.getElementById("endpoint-modal-title");n.textContent=e?t("ep-modal-title-edit"):t("ep-modal-title-new");const o=document.getElementById("ep-name"),i=document.getElementById("ep-url"),h=document.getElementById("ep-token"),b=document.getElementById("ep-is-default"),_=document.getElementById("ep-auto-push"),s=document.getElementById("ep-test-result");s.style.display="none",s.textContent="";const f=document.getElementById("ep-save-error");if(f&&f.remove(),e){const u=ye.find(d=>d.id===e);if(!u)return;o.value=u.name||"",i.value=(u.config||{}).url||"",h.value=(u.config||{})._token_set&&u.config.token||"",h.placeholder=(u.config||{})._token_set?"（已保存 · 留空保持不变）":t("ep-token-ph"),b.checked=!!u.is_default,_.checked=!!u.auto_push}else o.value="",i.value="",h.value="",h.placeholder=t("ep-token-ph"),b.checked=ye.length===0,_.checked=!0;const w=_.closest(".form-switch-row");if(_.disabled=!1,w){w.classList.remove("disabled-plus"),w.title="",w.style.cursor="",w.onclick=null;const u=w.querySelector(".plus-badge");u&&u.remove()}a.style.display="",setTimeout(()=>o.focus(),50)}function it(){document.getElementById("endpoint-modal").style.display="none",Ae=null;const e=document.getElementById("ep-save-error");e&&e.remove()}function rt(e){if(!e)return"";let a=e.trim();const n=a.search(/\s/);return n>=0&&(a=a.slice(0,n)),a}function lt(){const e=document.getElementById("ep-name").value.trim(),a=rt(document.getElementById("ep-url").value),n=document.getElementById("ep-token").value,o=document.getElementById("ep-is-default").checked,i=document.getElementById("ep-auto-push").checked,h={url:a};return n&&(h.token=n),{name:e,url:a,tokenVal:n,isDefault:o,autoPush:i,config:h}}async function Mt(){const{url:e,config:a}=lt(),n=document.getElementById("ep-test-result");if(!e){n.style.display="",n.className="form-test-result fail",n.textContent=t("ep-required");return}n.style.display="",n.className="form-test-result running",n.textContent=t("ep-test-running");try{const i=await(await fetch("/api/erp/test-connection",{method:"POST",headers:{Authorization:"Bearer "+token,"Content-Type":"application/json"},body:JSON.stringify({adapter:"webhook",config:a})})).json();i.success?(n.className="form-test-result ok",n.textContent=t("ep-test-ok",{status:i.http_status,ms:i.elapsed_ms})):(n.className="form-test-result fail",n.textContent=t("ep-test-fail",{err:i.error_msg||"unknown"}))}catch(o){n.className="form-test-result fail",n.textContent=t("ep-test-fail",{err:o.message})}}async function Ht(){const e=lt(),a=document.getElementById("ep-save-error");if(a&&(a.style.display="none"),!e.name||!e.url){et(t("ep-required"));return}const n={name:e.name,adapter:"webhook",config:e.config,is_default:e.isDefault,auto_push:e.autoPush},o=document.getElementById("btn-ep-save"),i=o.innerHTML;o.disabled=!0,o.classList.add("loading");try{let h;if(Ae?h=await fetch(`/api/erp/endpoints/${encodeURIComponent(Ae)}`,{method:"PATCH",headers:{Authorization:"Bearer "+token,"Content-Type":"application/json"},body:JSON.stringify(n)}):h=await fetch("/api/erp/endpoints",{method:"POST",headers:{Authorization:"Bearer "+token,"Content-Type":"application/json"},body:JSON.stringify(n)}),!h.ok){const _=(await h.json().catch(()=>({}))).detail||`HTTP ${h.status}`;throw new Error(typeof _=="string"?_:JSON.stringify(_))}it(),showToast(t("ep-save-ok")),Ne()}catch(h){et(`${t("ep-save-fail")} · ${h.message||"unknown"}`)}finally{o.disabled=!1,o.classList.remove("loading"),o.innerHTML=i}}function et(e){let a=document.getElementById("ep-save-error");if(!a){const n=document.querySelector("#endpoint-modal .modal-foot");if(!n)return;a=document.createElement("div"),a.id="ep-save-error",a.className="ep-inline-error",n.parentNode.insertBefore(a,n)}a.textContent=e,a.style.display=""}async function $t(e){const a=ye.find(o=>o.id===e);if(!(!a||!await showConfirm(t("ep-delete-confirm",{name:a.name}),{danger:!0})))try{if(!(await fetch(`/api/erp/endpoints/${encodeURIComponent(e)}`,{method:"DELETE",headers:{Authorization:"Bearer "+token}})).ok)throw new Error;showToast(t("ep-delete-ok")),Ne()}catch{showToast(t("ep-save-fail"),"fail")}}window.loadErpEndpoints=Ne;window.loadErpTodayStats=ot;window.renderErpEndpointsList=st;window.openEndpointModal=Tt;window.closeEndpointModal=it;window.saveEndpoint=Ht;window.deleteEndpoint=$t;window.testEndpointConnection=Mt;window._sanitizeUrl=rt;async function ct(e){if(e=(e||"").trim(),!!e)try{await navigator.clipboard.writeText(e),showToast(t("erp-doc-copy-ok",{no:e}),"success")}catch{try{const n=document.createElement("textarea");n.value=e,n.style.position="fixed",n.style.opacity="0",document.body.appendChild(n),n.select(),document.execCommand("copy"),n.remove(),showToast(t("erp-doc-copy-ok",{no:e}),"success")}catch{showToast(t("erp-doc-copy-fail"),"error")}}}async function At(e){const a=document.createElement("div");a.className="log-detail-modal",a.innerHTML=`
        <div class="log-detail-box">
            <div class="log-detail-loading">${escapeHtml(t("log-detail-loading"))}</div>
        </div>
    `,document.body.appendChild(a),a.addEventListener("click",async n=>{if(n.target===a||n.target.classList.contains("log-detail-close")){a.remove();return}const o=n.target.closest("[data-receipt-copy]");if(o){ct(o.dataset.receiptCopy);return}const i=n.target.closest("[data-receipt-action]");if(i){const h=i.dataset.receiptAction;h==="retry"?window.retryPushLog(i.dataset.logId):h==="exceptions"?typeof routeTo=="function"&&routeTo("exceptions"):h==="mappings"&&typeof routeTo=="function"&&routeTo("integrations"),a.remove();return}});try{const n=await fetch(`/api/erp/logs/${encodeURIComponent(e)}`,{headers:{Authorization:"Bearer "+token}});if(!n.ok){a.remove();return}const o=await n.json(),i=window._erpEndpoints.find(L=>L.id===o.endpoint_id),h=o.endpoint_name||(i?i.name:o.endpoint_id?t("erp-log-endpoint-deleted"):"-"),b=(o.endpoint_adapter||i&&i.adapter||"").toLowerCase(),_=new Date(o.created_at).toLocaleString(),s=o.trigger==="auto"?t("log-tag-auto"):o.trigger==="retry"?t("log-tag-retry"):t("log-tag-manual"),f=o.request_body?JSON.stringify(o.request_body,null,2):t("erp-receipt-no-tech"),w=o.response_body||t("erp-receipt-no-tech"),u=o.status==="success";let d=typeof w=="string"?w:JSON.stringify(w,null,2);if(u)try{const L=typeof o.response_body=="string"?JSON.parse(o.response_body):o.response_body||{},$=L.row_count||(Array.isArray(L.imported_rows)?L.imported_rows.length:0);$>0&&(d=t("log-push-rows").replace("{n}",String($)))}catch{}const E=(o.external_doc_no||"").trim(),k=(o.external_url||"").trim(),R=(o.external_doc_hint||"").trim(),q=(o.ocr_buyer_name||"").trim()||o.client_name||"-",y=o.seller_name||"-";let B="-";const O=Number(o.total_amount);o.total_amount!=null&&o.total_amount!==""&&!isNaN(O)&&(B=O.toLocaleString("en-US",{minimumFractionDigits:2,maximumFractionDigits:2}));const D=u?t("erp-receipt-title-ok"):t("erp-receipt-title-fail"),F=u?"✓":"✗",A=[],v=(L,$)=>{A.push(`
                <div class="erp-receipt-row">
                    <span class="erp-receipt-key">${escapeHtml(L)}</span>
                    <span class="erp-receipt-val">${$}</span>
                </div>`)};if(v(t("erp-receipt-invoice-no"),`<strong>${escapeHtml(o.invoice_no||"-")}</strong>`),v(t("erp-receipt-erp-name"),escapeHtml(h)),u){let L;E?L=`<strong class="erp-receipt-docno">${escapeHtml(E)}</strong><button class="erp-receipt-copy-btn" type="button" data-receipt-copy="${escapeHtml(E)}" title="${escapeHtml(t("erp-doc-copy-tip"))}">${escapeHtml(t("erp-receipt-copy-btn"))}</button>`:L=`<span class="erp-receipt-docno-missing">${escapeHtml(t("erp-log-doc-missing"))}</span>`,v(t("erp-receipt-doc-no"),L)}v(t("erp-receipt-client"),escapeHtml(q)),v(t("erp-receipt-seller"),escapeHtml(y)),u&&v(t("erp-receipt-amount"),escapeHtml(B)),v(t("erp-receipt-time"),escapeHtml(_)),v(t("erp-receipt-elapsed"),escapeHtml((o.elapsed_ms!=null?o.elapsed_ms:"-")+"ms"));let l="";u&&k?l=`<a class="erp-receipt-primary-btn" href="${escapeHtml(k)}" target="_blank" rel="noopener">${escapeHtml(t("erp-receipt-open-erp"))}</a>`:u&&E&&(l=`<button class="erp-receipt-primary-btn" type="button" data-receipt-copy="${escapeHtml(E)}">${escapeHtml(t("erp-receipt-copy-docno"))}</button>`);let p="";if(u&&E&&R){const L="erp-receipt-hint-"+R,$=t(L);$&&$!==L&&(p=`<div class="erp-receipt-hint"><svg class="erp-receipt-hint-ic" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><circle cx="12" cy="12" r="9"/><line x1="12" y1="11" x2="12" y2="16"/><line x1="12" y1="8" x2="12.01" y2="8"/></svg><span>${escapeHtml($)}</span></div>`)}let I="";if(!u){const L=(o.error_msg||"").match(/ERR_[A-Z0-9_]+/),$=L?L[0]:"",x=typeof currentLang=="string"&&currentLang||window._currentLang||"th",W=o.error_friendly&&o.error_friendly[x]||(o.error_msg?humanizeError(o.error_msg):t("erp-receipt-no-error")),G=/ERR_NO_CUSTOMER_MAPPING|ERR_NO_CLIENT|ERR_NO_SEED_CUSTOMER|ERR_NO_SEED_PRODUCT/.test(o.error_msg||""),K=!!(o.history_id&&o.endpoint_id),te=[];te.push(`<button class="erp-receipt-action-btn" type="button" data-receipt-action="exceptions">${escapeHtml(t("erp-receipt-act-exceptions"))}</button>`),G&&te.push(`<button class="erp-receipt-action-btn" type="button" data-receipt-action="mappings">${escapeHtml(t("erp-receipt-act-mapping"))}</button>`),K&&te.push(`<button class="erp-receipt-action-btn primary" type="button" data-receipt-action="retry" data-log-id="${escapeHtml(o.id)}">${escapeHtml(t("erp-receipt-act-retry"))}</button>`),I=`
        ...
        `}catch(n){console.error(n),a.remove()}}window.copyErpDocNo=ct;window.showLogDetail=At;let Ee={key:"all",val:""},xe=new Set;window._erpSelected=xe;async function je(e){const a=document.getElementById("erp-logs-list");if(a){e||(a.innerHTML=`<div class="erp-logs-empty">${escapeHtml(t("erp-logs-loading"))}</div>`),window.loadErpTodayStats();try{const n=new URLSearchParams({limit:"30"});Ee.key==="status"&&n.set("status",Ee.val),Ee.key==="trigger"&&n.set("trigger",Ee.val),Ee.key==="adapter"&&n.set("adapter",Ee.val);const o=await fetch(`/api/erp/logs?${n}`,{headers:{Authorization:"Bearer "+token}});if(!o.ok){a.innerHTML=`<div class="erp-logs-empty">${escapeHtml(t("erp-logs-error"))}</div>`;return}const h=(await o.json()).items||[];if(window._erpLogPollTimer&&(clearTimeout(window._erpLogPollTimer),window._erpLogPollTimer=null),h.some(function(f){return f.status==="pending"})&&(window._erpLogPollTimer=setTimeout(function(){je(!0)},4e3)),h.length===0){a.innerHTML=`<div class="erp-logs-empty">${escapeHtml(t("erp-logs-empty"))}</div>`;return}const _='<div class="erp-log-row erp-log-row-header" data-log-header>'+(h.filter(function(f){var w=f.status==="failed"&&f.next_retry_at&&new Date(f.next_retry_at).getTime()>Date.now()-6e4;return!w}).map(function(f){return f.id}).length>0?`<input type="checkbox" class="erp-log-cb erp-log-cb-all" data-log-select-all title="${escapeHtml(t("erp-log-select-all-tip"))}">`:'<span class="erp-log-cb-spacer"></span>')+`<span class="log-time">${escapeHtml(t("erp-log-col-time"))}</span><span class="log-status">${escapeHtml(t("erp-log-col-status"))}</span><span class="log-tag-header">${escapeHtml(t("erp-log-col-trigger"))}</span><span class="log-invoice">${escapeHtml(t("erp-log-col-invoice"))}</span><span class="log-workspace">${escapeHtml(t("erp-log-col-workspace"))}</span><span class="log-client">${escapeHtml(t("erp-log-col-client"))}</span><span class="log-seller">${escapeHtml(t("erp-log-col-seller"))}</span><span class="log-erp">${escapeHtml(t("erp-log-col-erp"))}</span><span class="log-doc">${escapeHtml(t("erp-log-col-doc"))}</span><span class="log-http">${escapeHtml(t("erp-log-col-http"))}</span><span class="log-elapsed">${escapeHtml(t("erp-log-col-elapsed"))}</span><span class="log-actions"></span></div>`;a.innerHTML=_+h.map(f=>{const w=new Date(f.created_at),u=`${String(w.getMonth()+1).padStart(2,"0")}-${String(w.getDate()).padStart(2,"0")} ${String(w.getHours()).padStart(2,"0")}:${String(w.getMinutes()).padStart(2,"0")}`,d=f.status==="failed"&&f.next_retry_at&&new Date(f.next_retry_at).getTime()>Date.now()-6e4;let E,k,R;f.status==="pending"?(E="retrying",k="⟳",R=t("erp-status-pending")):f.status==="success"?(E="ok",k="✓",R=t("erp-status-success")):f.status==="skipped_dup"?(E="skipped",k="⏭",R=t("erp-status-skipped")):d?(E="retrying",k="↻",R=t("erp-status-retrying")):(E="fail",k="✗",R=t("erp-status-failed"));let q;f.trigger==="auto"?q=`<span class="log-tag auto">${escapeHtml(t("log-tag-auto"))}</span>`:f.trigger==="retry"?q=`<span class="log-tag retry">${escapeHtml(t("log-tag-retry"))}</span>`:q=`<span class="log-tag manual">${escapeHtml(t("log-tag-manual"))}</span>`;let y="";const B=f.retry_count||0,O=f.max_retries||3;if(d){const W=new Date(f.next_retry_at).getTime()-Date.now(),G=Math.max(0,Math.round(W/6e4)),K=G<=0?t("erp-retry-next-soon"):t("erp-retry-next-min",{n:G});y=`${t("erp-retry-attempt",{n:B,max:O})} · ${K}`}else f.status==="failed"&&B>=O&&!f.next_retry_at&&(y=t("erp-retry-exhausted",{n:B}));const D=f.status==="failed"&&!d?`<button class="log-retry-btn" data-log-retry="${escapeHtml(f.id)}" title="${escapeHtml(t("log-retry-title"))}">↻</button>`:"",F=!d,A=xe.has(f.id)?"checked":"",v=F?`<input type="checkbox" class="erp-log-cb" data-log-cb="${escapeHtml(f.id)}" ${A}>`:'<span class="erp-log-cb-spacer"></span>',l=(f.ocr_buyer_name||"").trim()||(f.client_name||"").trim(),p=l?`<span class="log-client" title="${escapeHtml(l)}">${escapeHtml(l.substring(0,18))}</span>`:`<span class="log-client log-client-empty" title="${escapeHtml(t("erp-log-client-unassigned-tip"))}">${escapeHtml(t("erp-log-client-unassigned"))}</span>`,I=f.workspace_name?`<span class="log-workspace">${escapeHtml((f.workspace_name||"").substring(0,16))}</span>`:`<span class="log-workspace log-workspace-unresolved" title="${escapeHtml(t("erp-log-ws-unresolved-tip"))}">${escapeHtml(t("erp-log-ws-unresolved"))}</span>`,L=f.endpoint_name?`<span class="log-erp">${escapeHtml((f.endpoint_name||"").substring(0,14))}</span>`:`<span class="log-erp log-erp-deleted">${escapeHtml(t("erp-log-endpoint-deleted"))}</span>`,$=(f.external_doc_no||"").trim(),x=(f.external_url||"").trim();let M;return x?M=`<span class="log-doc"><a href="${escapeHtml(x)}" target="_blank" rel="noopener" class="log-doc-open" title="${escapeHtml($||"")}">${escapeHtml(t("erp-log-doc-open"))}</a></span>`:$?M=`<span class="log-doc log-doc-copy" data-copy-doc="${escapeHtml($)}" title="${escapeHtml(t("erp-log-doc-copy-tip"))}">${escapeHtml($.substring(0,18))}</span>`:f.status==="success"?M=`<span class="log-doc log-doc-missing" title="${escapeHtml(t("erp-log-doc-missing-tip"))}">${escapeHtml(t("erp-log-doc-missing"))}</span>`:M='<span class="log-doc log-doc-empty">-</span>',`
        ...
        `,document.body.appendChild(_),e=_;const s=_.querySelector("#line-email-input"),f=_.querySelector("#line-email-submit-btn"),w=_.querySelector("#line-email-err");async function u(){w.textContent="";const d=(s.value||"").trim().toLowerCase();if(!d||d.indexOf("@")<0||d.split("@")[1].indexOf(".")<0){w.textContent=t("line-email-err-invalid");return}f.disabled=!0,f.style.opacity="0.6";try{const E=await fetch("/api/me/line_complete_email",{method:"POST",headers:{"Content-Type":"application/json",Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||"")},body:JSON.stringify({email:d})});if(!E.ok)throw new Error("http_"+E.status);const k=await E.json();k.token&&localStorage.setItem("mrpilot_token",k.token),typeof showToast=="function"&&showToast(k.merged?t("line-email-merged-toast"):t("line-email-saved-toast"),"success"),setTimeout(function(){window.location.reload()},600)}catch{w.textContent=t("line-email-err-failed"),f.disabled=!1,f.style.opacity="1"}}return f.addEventListener("click",u),s.addEventListener("keydown",function(d){d.key==="Enter"&&u()}),_}function o(){if(!e)return;const _=e.querySelector("#line-email-title-h"),s=e.querySelector("#line-email-sub-p"),f=e.querySelector("#line-email-input"),w=e.querySelector("#line-email-submit-btn");_&&(_.textContent=t("line-email-title")),s&&(s.textContent=t("line-email-sub")),f&&(f.placeholder=t("line-email-placeholder")),w&&(w.textContent=t("line-email-submit"))}function i(){n(),o(),e.style.display="flex",a=!0;const _=e.querySelector("#line-email-input");_&&setTimeout(function(){_.focus()},100)}async function h(){const _=localStorage.getItem("mrpilot_token");if(_)try{const s=await fetch("/api/me/needs_email",{headers:{Authorization:"Bearer "+_}});if(!s.ok)return;const f=await s.json();f&&f.needs_email&&i()}catch{}}function b(){setTimeout(h,800)}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",b):b(),typeof window.subscribeI18n=="function"&&window.subscribeI18n("line-email-modal",function(){a&&o()})})();(function(){function e(_){let s=0;return _.length>=8&&s++,_.length>=12&&s++,/[a-zA-Z]/.test(_)&&/\d/.test(_)&&s++,/[^a-zA-Z0-9]/.test(_)&&s++,Math.min(3,s)}function a(_,s){const f=document.getElementById("cpw-msg");f&&(f.textContent=_,f.className="cpw-msg "+(s||""))}function n(_){return typeof t=="function"?t(_):_}function o(){const _=["cpw-old","cpw-new","cpw-confirm"];_.forEach(d=>{const E=document.getElementById(d);E&&(E.value="",E.setAttribute("readonly","readonly"),E.addEventListener("focus",function(){this.removeAttribute("readonly")}))}),document.querySelectorAll('.settings-nav-item[data-settings-tab="account"]').forEach(d=>{d.addEventListener("click",()=>{setTimeout(()=>{_.forEach(k=>{const R=document.getElementById(k);R&&(R.value="",R.setAttribute("readonly","readonly"))});const E=document.getElementById("cpw-strength-bar");E&&(E.style.width="0%",E.className="cpw-strength-bar"),a("","")},100)})}),document.querySelectorAll(".cpw-eye").forEach(d=>{d.addEventListener("click",()=>{const E=d.dataset.target,k=document.getElementById(E);k&&(k.type=k.type==="password"?"text":"password")})});const s=document.getElementById("cpw-new"),f=document.getElementById("cpw-strength-bar");s&&f&&s.addEventListener("input",()=>{const d=e(s.value),E=["0%","33%","66%","100%"],k=["","weak","medium","strong"];f.style.width=E[d],f.className="cpw-strength-bar "+k[d]});const w=document.getElementById("cpw-forgot-link");w&&w.addEventListener("click",()=>i());const u=document.getElementById("btn-change-pw");u&&u.addEventListener("click",async()=>{const d=document.getElementById("cpw-old"),E=document.getElementById("cpw-new"),k=document.getElementById("cpw-confirm");if(!d||!E||!k)return;const R=d.value,q=E.value,y=k.value;if(!R||!q||!y){a(n("settings-change-pw-empty"),"error");return}if(q.length<8){a(n("settings-change-pw-too-short"),"error");return}if(!(/[a-zA-Z]/.test(q)&&/\d/.test(q))){a(n("settings-change-pw-too-weak"),"error");return}if(q!==y){a(n("settings-change-pw-mismatch"),"error");return}u.disabled=!0;const B=u.textContent;u.textContent=n("settings-change-pw-submitting"),a("","");try{const O=localStorage.getItem("mrpilot_token"),D=await fetch("/api/me/change_password",{method:"POST",headers:{"Content-Type":"application/json",Authorization:"Bearer "+O},body:JSON.stringify({old_password:R,new_password:q})}),F=await D.json().catch(()=>({}));if(D.ok&&F.ok)a(n("settings-change-pw-success"),"success"),typeof showToast=="function"&&showToast(n("settings-change-pw-success"),"success"),d.value="",E.value="",k.value="",f&&(f.style.width="0%",f.className="cpw-strength-bar");else{const A=F.detail||"";let v=n("settings-change-pw-success");A==="wrong_old_password"?v=n("settings-change-pw-wrong-old"):A==="password_too_short"?v=n("settings-change-pw-too-short"):A==="password_too_weak"?v=n("settings-change-pw-too-weak"):v=A||"Error",a(v,"error")}}catch(O){console.error("change_password",O),a("Network error","error")}finally{u.disabled=!1,u.textContent=B}})}function i(){const _=window._userInfo||(typeof _userInfo<"u"?_userInfo:null),s=_&&_.username?_.username:"",f=h(s);let w=document.getElementById("cpw-forgot-overlay");w&&w.remove(),w=document.createElement("div"),w.id="cpw-forgot-overlay",w.className="cpw-forgot-overlay",w.innerHTML=`
            <div class="cpw-forgot-modal">
                ...
                <div class="cpw-forgot-body">
                    ...
                    <div class="cpw-forgot-email">${b(f)}</div>
        ...
        `,document.body.appendChild(w);const u=()=>w.remove();w.querySelector("#cpw-forgot-close").addEventListener("click",u),w.querySelector("#cpw-forgot-cancel").addEventListener("click",u),w.addEventListener("click",d=>{d.target===w&&u()}),w.querySelector("#cpw-forgot-send").addEventListener("click",async()=>{const d=w.querySelector("#cpw-forgot-send"),E=w.querySelector("#cpw-forgot-msg");d.disabled=!0;const k=d.textContent;d.textContent=n("cpw-forgot-sending");try{const R=await fetch("/api/auth/forgot_password",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:s})}),q=await R.json().catch(()=>({}));R.ok?(E.textContent=n("cpw-forgot-success"),E.className="cpw-forgot-msg success",d.style.display="none",w.querySelector("#cpw-forgot-cancel").textContent=n("cpw-forgot-close-btn")):(E.textContent=q.detail||n("cpw-forgot-fail"),E.className="cpw-forgot-msg error",d.disabled=!1,d.textContent=k)}catch{E.textContent=n("cpw-forgot-fail"),E.className="cpw-forgot-msg error",d.disabled=!1,d.textContent=k}})}function h(_){if(!_||!_.includes("@"))return _||"";const[s,f]=_.split("@");return s.length<=2?s+"****@"+f:s.slice(0,2)+"****@"+f}function b(_){return _==null?"":String(_).replace(/[&<>"']/g,s=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[s])}document.readyState==="complete"||document.readyState==="interactive"?o():document.addEventListener("DOMContentLoaded",o)})();(function(){let e=null,a=!1;async function n(){if(a)return;const i=localStorage.getItem("mrpilot_token");if(i){a=!0;try{const h=await fetch("/api/me",{headers:{Authorization:"Bearer "+i},cache:"no-store"});if(h.status===401){const b=await h.json().catch(()=>({})),_=b&&b.detail;let s="";if(typeof _=="string"?s=_:_&&typeof _=="object"&&(s=_.code||""),console.warn("[heartbeat] session revoked",s),localStorage.removeItem("mrpilot_token"),e&&(clearInterval(e),e=null),s==="auth.session_revoked")try{_showSessionRevokedModal()}catch{window.location.href="/"}else{const f=s==="auth.password_changed_relogin"?"alert-password-changed-relogin":"alert-session";try{typeof showToast=="function"&&typeof t=="function"?showToast(t(f),"error"):alert("Session expired")}catch{}setTimeout(()=>{window.location.href="/"},1500)}}}catch{}finally{a=!1}}}function o(){e&&clearInterval(e),e=setInterval(n,15e3)}localStorage.getItem("mrpilot_token")&&o(),window.addEventListener("focus",n),document.addEventListener("visibilitychange",function(){document.hidden||n()}),window._sessionCheck=n})();async function ze(){const e=document.getElementById("team-loading"),a=document.getElementById("team-list"),n=document.getElementById("team-empty"),o=document.getElementById("team-count");if(a){e&&(e.style.display=""),a.style.display="none",n&&(n.style.display="none");try{const i=await apiGet("/api/team/employees"),h=i&&i.employees||[];if(e&&(e.style.display="none"),o&&(o.textContent=(t("team-count")||"共 {n} 名员工").replace("{n}",h.length)),h.length===0){n&&(n.style.display="");return}a.style.display="",a.innerHTML=h.map(b=>{const _=b.last_login_at?new Date(b.last_login_at).toLocaleDateString():t("team-never-login")||"从未登录",s=b.is_active===!1?"team-status-off":"team-status-on",f=b.is_active===!1?t("team-status-disabled")||"已禁用":t("team-status-active")||"正常",w=b.email?`<span class="team-meta-sep">·</span><span>${escapeHtml(b.email)}</span>`:"";return`
            ...
            </div>`}).join("")}catch(i){console.error("loadTeamList failed:",i),e&&(e.textContent=t("team-load-failed")||"加载失败")}}}async function jt(){document.querySelectorAll(".add-emp-overlay").forEach(o=>o.remove());const e=document.createElement("div");e.className="add-emp-overlay",e.innerHTML=`
    ...
    `,document.body.appendChild(e),requestAnimationFrame(()=>e.classList.add("show")),setTimeout(()=>{const o=document.getElementById("add-emp-username");o&&o.focus()},200);function a(){e.classList.remove("show"),setTimeout(()=>e.remove(),220)}e.querySelector(".add-emp-close").addEventListener("click",a),e.querySelector("#add-emp-cancel").addEventListener("click",a),e.addEventListener("click",o=>{o.target===e&&a()}),e.querySelector("#add-emp-submit").addEventListener("click",async()=>{const o=document.getElementById("add-emp-username"),i=document.getElementById("add-emp-email"),h=document.getElementById("add-emp-password"),b=document.getElementById("add-emp-msg"),_=document.getElementById("add-emp-submit"),s=(o.value||"").trim(),f=(i.value||"").trim(),w=h.value||"";if(b.textContent="",b.classList.remove("error"),!s||s.length<3){b.textContent=t("team-modal-err-username")||"用户名至少 3 位",b.classList.add("error");return}if(!/^[a-zA-Z0-9_.\-]+$/.test(s)){b.textContent=t("team-modal-err-username-fmt")||"只能用字母 / 数字 / 下划线 / 点 / 横线",b.classList.add("error");return}if(f&&!/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(f)){b.textContent=t("msg-email-invalid")||"邮箱格式不对",b.classList.add("error");return}if(w.length<8){b.textContent=t("pwd-too-short")||"密码至少 8 位",b.classList.add("error");return}if(/^\d+$/.test(w)){b.textContent=t("pwd-too-weak-numeric")||"不能是纯数字 · 请加入字母",b.classList.add("error");return}if(!(/[a-zA-Z]/.test(w)&&/\d/.test(w))){b.textContent=t("pwd-too-weak")||"密码至少 8 位 · 字母 + 数字",b.classList.add("error");return}_.disabled=!0,_.textContent=t("msg-saving")||"保存中...";try{const u={username:s,password:w};f&&(u.email=f);const d=await apiPost("/api/team/employees",u),E=d?await d.json().catch(()=>({})):{};if(d&&d.ok&&E&&E.ok){showToast(t("team-added")||"员工已添加","success"),a(),ze();return}const k=E&&E.detail||"unknown",R={"team.username_exists":t("team-username-exists")||"用户名已被占用","team.email_exists":t("team-email-exists")||"邮箱已被占用","team.create_failed":t("team-create-failed")||"创建失败","team.only_owner_or_super":t("team-no-permission")||"无权限","team.no_tenant":t("team-no-tenant")||"请先升级账号","pwd.too_short":t("pwd-too-short")||"密码至少 8 位","pwd.too_weak_numeric":t("pwd-too-weak-numeric")||"不能是纯数字","pwd.too_weak_common":t("pwd-too-weak-common")||"这个密码太常见 · 请换一个","pwd.too_weak":t("pwd-too-weak")||"密码至少 8 位 · 字母 + 数字"};b.textContent=R[k]||(t("team-create-failed")||"创建失败")+" ("+k+")",b.classList.add("error")}catch{b.textContent=t("team-create-failed")||"创建失败",b.classList.add("error")}finally{_.disabled=!1,_.textContent=t("team-add")||"添加员工"}});function n(o){o.key==="Escape"&&(a(),document.removeEventListener("keydown",n))}document.addEventListener("keydown",n)}async function Pt(e,a){try{if((await fetch(`/api/team/employees/${encodeURIComponent(e)}/active`,{method:"PATCH",headers:{Authorization:"Bearer "+token,"Content-Type":"application/json"},body:JSON.stringify({is_active:!!a})})).ok){ze();return}showToast(t("team-toggle-failed")||"操作失败","error")}catch{showToast(t("team-toggle-failed")||"操作失败","error")}}async function Dt(e,a){const o=(t("team-confirm-remove")||"确认移除员工「{name}」?他的所有识别记录会保留 · 但他将无法登录").replace("{name}",a).replace("{n}",a);if(await showConfirm(o,{danger:!0,okText:t("team-remove")}))try{if((await fetch(`/api/team/employees/${encodeURIComponent(e)}`,{method:"DELETE",headers:{Authorization:"Bearer "+token}})).ok){showToast(t("team-removed")||"已移除","success"),ze();return}showToast(t("team-remove-failed")||"移除失败","error")}catch{showToast(t("team-remove-failed")||"移除失败","error")}}async function qt(e,a){const o=(t("team-reset-pwd-confirm")||"给员工「{name}」发送改密链接?系统将通过员工的邮箱或 LINE 发送一个 15 分钟内有效的链接 · 员工自己点链接改密码 · 您看不到密码").replace("{name}",a).replace("{n}",a);if(await showConfirm(o,{okText:t("team-reset-link-send-btn")||"发送链接"}))try{const h=await fetch(`/api/team/employees/${encodeURIComponent(e)}/reset-password`,{method:"POST",headers:{Authorization:"Bearer "+token}}),b=await h.json().catch(()=>({}));if(h.status===400&&b.detail==="team.reset_no_channel"){showToast(t("team-reset-no-channel")||"员工尚未绑定邮箱或 LINE · 请先帮员工补充邮箱再重置","error");return}if(!h.ok){showToast(t("team-reset-pwd-fail")||"发送失败","error");return}if(b.channel==="line"||b.channel==="email"){const _=t("team-reset-link-sent")||"改密链接已通过 {ch} 发送给员工 · 链接 15 分钟内有效",s=b.channel==="line"?"LINE":t("team-reset-via-email")||"邮箱";showToast(_.replace("{ch}",s),"success");return}showToast(t("team-reset-pwd-fail")||"发送失败","error")}catch{showToast(t("team-reset-pwd-fail")||"发送失败","error")}}document.addEventListener("click",e=>{if(e.target.closest("#btn-add-employee")){e.preventDefault(),jt();return}const a=e.target.closest("[data-toggle-employee]");if(a){e.preventDefault(),Pt(a.dataset.toggleEmployee,a.dataset.active==="false");return}const n=e.target.closest("[data-remove-employee]");if(n){e.preventDefault(),Dt(n.dataset.removeEmployee,n.dataset.name||"");return}const o=e.target.closest("[data-reset-pwd-employee]");if(o){e.preventDefault(),qt(o.dataset.resetPwdEmployee,o.dataset.name||"");return}const i=e.target.closest("[data-assign-clients]");if(i){e.preventDefault(),typeof window.openAssignClientsModal=="function"&&window.openAssignClientsModal(i.dataset.assignClients,i.dataset.name||"");return}});window.loadTeamList=ze;function Rt(e){document.querySelectorAll(".auto-nav-item").forEach(a=>{a.classList.toggle("active",a.dataset.autoTab===e)}),document.querySelectorAll(".auto-panel").forEach(a=>{a.classList.toggle("active",a.dataset.autoPanel===e)}),e==="email"&&typeof window._loadEmailIngestPanel=="function"?(window._loadEmailIngestPanel(),typeof window._startEmailLogAutoRefresh=="function"&&window._startEmailLogAutoRefresh()):typeof window._stopEmailLogAutoRefresh=="function"&&window._stopEmailLogAutoRefresh(),e==="bank"&&typeof window._loadBankReconPanel=="function"&&window._loadBankReconPanel(),e==="linebot"&&typeof window._loadLineBotPanel=="function"&&window._loadLineBotPanel(),e==="alert"&&typeof window._loadNotificationsPanel=="function"&&window._loadNotificationsPanel(),e==="folder"&&typeof window._loadFolderWatcherPanel=="function"&&window._loadFolderWatcherPanel()}window.switchAutomationTab=Rt;typeof console<"u"&&typeof console.info=="function"&&console.info("[pearnly] vite bundle loaded · dashboard + billing + test-center + workspace-switcher + recon-center + assign-clients + access-log + notifications + recon-batch + welcome-wizard + archive-settings");
