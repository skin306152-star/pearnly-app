...
锁定(防搬迁回归):
  ...
  6. 边界:自动推送后台 helper(_auto_push_history / _trigger_auto_push_all)必须留在
...
class ErpRoutesContractTests(unittest.TestCase):
    def test_router_registers_expected_routes(self):
        ...
        self.assertEqual(len(router.routes), 17)
    ...
    def test_auto_push_cluster_stays_in_app(self):
        ...
        self.assertTrue(hasattr(app, "_trigger_auto_push_all"))
        self.assertFalse(hasattr(erp_routes, "_auto_push_history"))
        self.assertFalse(hasattr(erp_routes, "_trigger_auto_push_all"))
