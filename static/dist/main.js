...
このデバイスは自動的にログアウトされました。`},s={zh:"确定，去登录",en:"OK, Sign in",th:"ตกลง เข้าสู่ระบบ",ja:"OK、ログイン"},o=n[e]?e:"th",i=document.createElement("div");i.id="pn-session-revoked-modal",i.style.cssText="position:fixed;inset:0;z-index:99999;background:rgba(0,0,0,.5);display:flex;align-items:center;justify-content:center;padding:16px;",i.innerHTML='<div style="background:#fff;border-radius:14px;padding:32px 24px 24px;max-width:360px;width:100%;box-shadow:0 12px 40px rgba(0,0,0,.2);text-align:center;"><div style="width:52px;height:52px;border-radius:50%;background:#FEF2F2;display:flex;align-items:center;justify-content:center;margin:0 auto 18px;flex-shrink:0;"><svg width="26" height="26" fill="none" stroke="#DC2626" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" viewBox="0 0 24 24"><circle cx="12" cy="12" r="10"/><line x1="12" y1="8" x2="12" y2="12"/><circle cx="12" cy="16" r=".5" fill="#DC2626"/></svg></div><div style="font-size:16px;font-weight:700;color:#111827;margin-bottom:10px;line-height:1.4;">'+n[o]+'</div><div style="font-size:13px;color:#6B7280;line-height:1.7;margin-bottom:24px;white-space:pre-line;">'+a[o]+'</div><button id="pn-srm-ok" style="width:100%;padding:11px 0;background:#111111;color:#fff;border:none;border-radius:8px;font-size:14px;font-weight:600;cursor:pointer;">'+s[o]+"</button></div>",document.body.appendChild(i),document.getElementById("pn-srm-ok").addEventListener("click",function(){window.location.href="/"})}}function ca(){try{if(typeof window.getActiveWorkspaceClientId=="function"){const e=window.getActiveWorkspaceClientId();if(e!=null)return{"X-Workspace-Client-Id":String(e)}}}catch{}return{}}async function Qr(e){const n=await fetch(e,{headers:{Authorization:"Bearer "+token,...ca()}});if(n.status===401||n.status===403){const a=await n.json().catch(()=>({})),s=a&&a.detail;let o="";if(typeof s=="string"?o=s:s&&typeof s=="object"&&(o=s.code||""),n.status===401||typeof o=="string"&&o.indexOf("auth.")>=0){if(console.warn("[auth-fail-redirect]",e,n.status,s),localStorage.removeItem("mrpilot_token"),o==="auth.session_revoked")la();else{const l=o==="auth.password_changed_relogin"?"alert-password-changed-relogin":"alert-session";showToast(ra(l),"error"),setTimeout(()=>{window.location.href="/"},1500)}return null}const r=new Error("biz_403");throw r.detail=s,r}if(!n.ok)throw new Error("fetch failed");return await n.json()}async function el(e,n){const a=await fetch(e,{method:"POST",headers:{Authorization:"Bearer "+token,"Content-Type":"application/json",...ca()},body:JSON.stringify(n)});if(a.status===401||a.status===403){const o=await a.clone().json().catch(()=>({})),i=o&&o.detail;let r="";if(typeof i=="string"?r=i:i&&typeof i=="object"&&(r=i.code||""),a.status===401||typeof r=="string"&&r.indexOf("auth.")>=0){if(console.warn("[auth-fail-redirect]",e,a.status,i),localStorage.removeItem("mrpilot_token"),r==="auth.session_revoked")la();else{const m=r==="auth.password_changed_relogin"?"alert-password-changed-relogin":"alert-session";showToast(ra(m),"error"),setTimeout(()=>{window.location.href="/"},1500)}return null}return a}return a}async function tl(e,n){try{const a=await fetch(e,{method:"PUT",headers:{Authorization:"Bearer "+token,"Content-Type":"application/json",...ca()},body:JSON.stringify(n)});if(a.status===401||a.status===403){const o=await a.json().catch(()=>({})),i=o&&o.detail;let r="";if(typeof i=="string"?r=i:i&&typeof i=="object"&&(r=i.code||""),a.status===401||typeof r=="string"&&r.indexOf("auth.")>=0){if(console.warn("[auth-fail-redirect]",e,a.status,i),localStorage.removeItem("mrpilot_token"),r==="auth.session_revoked")la();else{const m=r==="auth.password_changed_relogin"?"alert-password-changed-relogin":"alert-session";showToast(ra(m),"error"),setTimeout(()=>{window.location.href="/"},1500)}return{ok:!1}}return{ok:!1,status:a.status,detail:i}}const s=await a.json().catch(()=>({}));return{ok:a.ok&&s.ok!==!1,...s}}catch(a){return{ok:!1,error:String(a)}}}window.apiGet=Qr;window.apiPost=el;window.t=ra;window.escapeHtml=Xr;window.svgIcon=Zr;window._showSessionRevokedModal=la;window._wsHeader=ca;window.apiPut=tl;window.getMaxFiles=Kr;window.getMaxPagesPerFile=Yr;window.getMaxMbPerFile=Jr;function Be(e,n){const a=document.getElementById(e);if(!(!a||a.dataset.wbInjected==="1")){a.innerHTML=n,a.dataset.wbInjected="1";try{const s=window._currentLang||localStorage.getItem("mrpilot_lang")||"th",o=window.I18N;if(!o||!o[s])return;a.querySelectorAll("[data-i18n]").forEach(i=>{const r=i.getAttribute("data-i18n");r&&o[s][r]&&(i.textContent=o[s][r])}),a.querySelectorAll("[data-i18n-placeholder]").forEach(i=>{const r=i.getAttribute("data-i18n-placeholder");r&&o[s][r]&&(i.placeholder=o[s][r])})}catch{}}}const nl=`
        <!-- v85 · 模块头 · 视觉对齐其他页 -->
...
`;Be("pearnly-confirm-modal",cl);Be("confirm-modal",dl);window.pearnlyConfirm=function(e,n){return new Promise(function(a){const s=document.getElementById("pearnly-confirm-modal"),o=document.getElementById("pearnly-confirm-title"),i=document.getElementById("pearnly-confirm-msg"),r=document.getElementById("pearnly-confirm-ok"),l=document.getElementById("pearnly-confirm-cancel"),m=document.getElementById("pearnly-confirm-close");if(!s||!i||!r||!l){a(window.confirm(e));return}o&&(o.textContent=n||(typeof t=="function"?t("confirm-default-title"):"Please confirm")),i.textContent=e||"",s.style.display="flex";function d(v){s.style.display="none",r.removeEventListener("click",p),l.removeEventListener("click",c),m&&m.removeEventListener("click",c),s.removeEventListener("click",u),document.removeEventListener("keydown",f),a(v)}function p(){d(!0)}function c(){d(!1)}function u(v){v.target===s&&d(!1)}function f(v){v.key==="Escape"?d(!1):v.key==="Enter"&&d(!0)}r.addEventListener("click",p),l.addEventListener("click",c),m&&m.addEventListener("click",c),s.addEventListener("click",u),document.addEventListener("keydown",f),setTimeout(function(){try{l.focus()}catch{}},50)})};const pl=`
        <!-- 顶部 page head -->
        <div class="page-head-clean">
            <div class="page-head-icon">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
...
`,e.dataset.wbInjected="1";try{const n=window._currentLang||localStorage.getItem("mrpilot_lang")||"th",a=window.I18N;a&&a[n]&&(e.querySelectorAll("[data-i18n]").forEach(s=>{const o=s.getAttribute("data-i18n");a[n][o]&&(s.textContent=a[n][o])}),e.querySelectorAll("[data-i18n-placeholder]").forEach(s=>{const o=s.getAttribute("data-i18n-placeholder");a[n][o]&&(s.placeholder=a[n][o])}))}catch{}}})();(function(){const e=document.getElementById("page-settings");if(!(!e||e.dataset.wbInjected==="1")){e.innerHTML=`
        ...
        <!-- /settings-layout -->
`,e.dataset.wbInjected="1";try{const n=window._currentLang||localStorage.getItem("mrpilot_lang")||"th",a=window.I18N;a&&a[n]&&(e.querySelectorAll("[data-i18n]").forEach(s=>{const o=s.getAttribute("data-i18n");a[n][o]&&(s.textContent=a[n][o])}),e.querySelectorAll("[data-i18n-placeholder]").forEach(s=>{const o=s.getAttribute("data-i18n-placeholder");a[n][o]&&(s.placeholder=a[n][o])}))}catch{}}})();const ml=`
        <div class="page-head-clean">
            <div class="page-head-icon">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
...
`,fl=`                    <!-- Tab: 邮箱抓取 (v0.17 · M6 · v93 在 Vultr 复活) -->
...
`;(function(){const e=document.getElementById("page-automation");if(!(!e||e.dataset.wbInjected==="1")){e.innerHTML=ml+fl,e.dataset.wbInjected="1";try{const n=window._currentLang||localStorage.getItem("mrpilot_lang")||"th",a=window.I18N;a&&a[n]&&(e.querySelectorAll("[data-i18n]").forEach(s=>{const o=s.getAttribute("data-i18n");o&&a[n][o]&&(s.textContent=a[n][o])}),e.querySelectorAll("[data-i18n-placeholder]").forEach(s=>{const o=s.getAttribute("data-i18n-placeholder");o&&a[n][o]&&(s.placeholder=a[n][o])}))}catch{}}})();(function(){const e={"page-integration":`
        <div class="coming-soon">
            <svg class="cs-icon" viewBox="0 0 48 48" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
...
`,e.dataset.wbInjected="1";try{const n=window._currentLang||localStorage.getItem("mrpilot_lang")||"th",a=window.I18N;a&&a[n]&&e.querySelectorAll("[data-i18n]").forEach(s=>{const o=s.getAttribute("data-i18n");a[n][o]&&(s.textContent=a[n][o])})}catch{}}})();function vl(e,n){const a=document.getElementById("alert-"+e);a&&(document.getElementById("alert-"+e+"-text").textContent=n,a.classList.add("show"))}function hl(){["info","warn","error"].forEach(e=>{document.getElementById("alert-"+e).classList.remove("show")})}function gl(e,n){if(e==null)return n||"操作失败";if(typeof e=="string")return e;if(Array.isArray(e)){const a=e[0]||{};return a.msg?a.msg:n||"请求格式错误"}if(typeof e=="object"){if(e.code){const a="err."+e.code;try{const s=t(a,e);if(s&&s!==a)return s}catch(s){console.warn("[i18n] t() failed for key:",a,s)}return e.code}if(e.message)return e.message;if(e.error)return e.error;if(e.detail&&typeof e.detail=="string")return e.detail;try{return JSON.stringify(e).slice(0,160)}catch{}}return n||String(e)}function bl(e){if(!e)return"";const n=String(e);return/ECONNREFUSED|Connection refused/i.test(n)?"连接被拒绝 · ERP 地址可能错了,或服务没启动":/listing fetch failed|wait_for_selector/i.test(n)?"拉取 MR.ERP 客户/商品列表超时 · 已重试 3 次仍不通 · 可能 MR.ERP 响应慢 · 稍后再试":/ETIMEDOUT|timeout/i.test(n)?"连接超时 · MR.ERP 响应慢 · 稍后再试":/ENOTFOUND|getaddrinfo/i.test(n)?"域名解析失败 · ERP 地址拼错了":/certificate|SSL/i.test(n)?"SSL 证书问题 · ERP 站点证书异常":/401|Unauthorized/i.test(n)?"HTTP 401 · 认证失败,检查 Token 是否正确":/403|Forbidden/i.test(n)?"HTTP 403 · 权限不足,ERP 拒绝访问":/404|Not Found/i.test(n)?"HTTP 404 · URL 路径不存在":/^5\d\d/.test(n)||/500|502|503|504/.test(n)?"ERP 服务器错误 · 不是你的问题,等会儿再试":n}function yl(e,n,a){let s=document.getElementById("mp-toast-wrap");s||(s=document.createElement("div"),s.id="mp-toast-wrap",document.body.appendChild(s)),n=n||"success",n==="ok"&&(n="success"),n==="warning"&&(n="warn"),n==="danger"&&(n="error");const o={success:'<path d="M3 8l3 3 7-7"/>',error:'<circle cx="8" cy="8" r="6"/><path d="M5.5 5.5l5 5M10.5 5.5l-5 5"/>',warn:'<path d="M8 2L1.5 13h13L8 2z"/><path d="M8 7v3M8 12v.01"/>',info:'<circle cx="8" cy="8" r="6"/><path d="M8 5.5v.01M8 8v3"/>',loading:'<path d="M8 1a7 7 0 017 7" stroke-linecap="round" class="mp-toast-spin"/>'},i=document.createElement("div");i.className="mp-toast "+n,i.innerHTML=`
    ...
    `,s.appendChild(i),requestAnimationFrame(()=>i.classList.add("show"));const r=typeof a=="number"?a:2500;let l=null;const m=()=>{l&&(clearTimeout(l),l=null),i.classList.remove("show"),setTimeout(()=>{try{i.remove()}catch{}},300)};return r>0&&(l=setTimeout(m,r)),m}window.showAlert=vl;window.hideAlerts=hl;window._humanizeBackendError=gl;window.humanizeError=bl;window.showToast=yl;function wl(e,n){return n=n||{},new Promise(a=>{const s=document.getElementById("confirm-modal"),o=document.getElementById("confirm-modal-body"),i=document.getElementById("confirm-modal-ok"),r=document.getElementById("confirm-modal-cancel"),l=document.getElementById("confirm-modal-close"),m=document.getElementById("confirm-modal-title");if(!s||!o||!i||!r){a(!1);return}m.textContent=n.title||t("confirm-default-title");const d=n.promptInput?"cm_in_"+Date.now():null;if(n.promptInput){const f=(e||"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;"),v=(n.placeholder||"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;");o.innerHTML=`
            ...
            `}else o.textContent=e||"";i.className=n.danger?"btn btn-danger":"btn btn-primary",i.textContent=n.okText||t("confirm-ok"),r.textContent=n.cancelText||t("confirm-cancel"),r.style.display=n.hideCancel?"none":"",s.style.display="flex";const p=f=>{s.style.display="none",i.onclick=null,r.onclick=null,l.onclick=null,s.onclick=null,document.removeEventListener("keydown",u),n.promptInput&&(o.innerHTML=""),r.style.display="",a(f)},c=()=>{const f=d?document.getElementById(d):null;return f?f.value:""},u=f=>{f.key==="Escape"?p(n.promptInput?null:!1):f.key==="Enter"&&p(n.promptInput?c():!0)};i.onclick=()=>p(n.promptInput?c():!0),r.onclick=()=>p(n.promptInput?null:!1),l.onclick=()=>p(n.promptInput?null:!1),s.onclick=f=>{f.target===s&&p(n.promptInput?null:!1)},document.addEventListener("keydown",u),setTimeout(()=>{if(n.promptInput){const f=document.getElementById(d);f&&f.focus()}else i.focus()},50)})}window.showConfirm=wl;function kl(e){if(e){try{if(typeof shouldHideMoney=="function"&&shouldHideMoney(_userInfo)&&["team","api","plan","company"].indexOf(e)>=0){e="profile";try{localStorage.setItem("mrpilot_settings_tab","profile")}catch{}}}catch{}document.querySelectorAll(".settings-tab").forEach(n=>{n.classList.toggle("active",n.dataset.tab===e)}),document.querySelectorAll(".settings-pane").forEach(n=>{n.classList.toggle("active",n.dataset.pane===e)});try{localStorage.setItem("mrpilot_settings_tab",e)}catch{}try{e==="about"&&typeof window.loadAboutPanel=="function"&&window.loadAboutPanel(),e==="notifications"&&typeof window.loadPrefsSettings=="function"&&window.loadPrefsSettings(),e==="team"&&loadTeamList(),e==="learned"&&typeof window.loadLearnedRules=="function"&&window.loadLearnedRules(),e==="plan"&&typeof qa=="function"&&qa()}catch(n){console.warn("settings tab side effect failed:",n)}}}function xl(e){if(!e)return;const n=(a,s)=>{const o=document.getElementById(a);o&&(o.value=s||"")};n("profile-username",e.username||""),n("profile-email",e.username||""),n("profile-fullname",e.full_name||""),n("profile-phone",e.phone||""),n("profile-country",e.country||"TH"),n("profile-line",e.line_id||""),n("company-name",e.company_name||""),n("company-volume",e.monthly_volume||""),n("company-role",e.user_role||e.role_self||"")}async function _l(){const e=document.getElementById("btn-save-profile"),n=document.getElementById("profile-save-msg");if(!e)return;const a=e.innerHTML;e.disabled=!0,e.innerHTML=`<span>${t("msg-saving")||"保存中..."}</span>`,n&&(n.textContent="",n.classList.remove("error"));try{const s={full_name:(document.getElementById("profile-fullname")||{}).value||"",phone:(document.getElementById("profile-phone")||{}).value||"",country:(document.getElementById("profile-country")||{}).value||"TH",line_id:(document.getElementById("profile-line")||{}).value||""},o=await apiPut("/api/me/profile",s);if(o&&o.ok){n&&(n.textContent=t("msg-saved")||"已保存");try{const i=await apiGet("/api/me");_userInfo=i;try{window._userInfo=i}catch{}renderBrandWorkspace()}catch{}}else throw new Error("save failed")}catch{n&&(n.textContent=t("msg-save-failed")||"保存失败",n.classList.add("error"))}finally{e.disabled=!1,e.innerHTML=a,setTimeout(()=>{n&&(n.textContent="")},3e3)}}async function El(){const e=document.getElementById("btn-save-company"),n=document.getElementById("company-save-msg");if(!e)return;const a=e.innerHTML;e.disabled=!0,e.innerHTML=`<span>${t("msg-saving")||"保存中..."}</span>`,n&&(n.textContent="",n.classList.remove("error"));try{const s={company_name:(document.getElementById("company-name")||{}).value||"",monthly_volume:(document.getElementById("company-volume")||{}).value||"",role:(document.getElementById("company-role")||{}).value||""},o=await apiPut("/api/me/profile",s);if(o&&o.ok){n&&(n.textContent=t("msg-saved")||"已保存");try{const i=await apiGet("/api/me");_userInfo=i;try{window._userInfo=i}catch{}renderBrandWorkspace()}catch{}}else throw new Error("save failed")}catch{n&&(n.textContent=t("msg-save-failed")||"保存失败",n.classList.add("error"))}finally{e.disabled=!1,e.innerHTML=a,setTimeout(()=>{n&&(n.textContent="")},3e3)}}function qa(){if(!_userInfo)return;typeof window.loadAboutPanel=="function"&&window.loadAboutPanel(),typeof window.loadPrefsSettings=="function"&&window.loadPrefsSettings();const e=document.getElementById("settings-info");if(!e)return;const n=_userInfo;if(n.is_super_admin){e.innerHTML=`
        ...
        `;const s=document.getElementById("api-key-card");s&&(s.style.display="");return}Il(n,e);const a=document.getElementById("api-key-card");if(a){const s=tt==="byo_api"||_userInfo&&_userInfo.is_super_admin;a.style.display=s?"":"none"}}function Il(e,n){const a=escapeHtml(e.username||e.email||"");n.innerHTML=`
        <table style="width:100%; font-size:13px; border-collapse: collapse;">
            <tr>
    ...
    `}window.switchSettingsTab=kl;window.fillSettingsForms=xl;window.saveProfile=_l;window.saveCompany=El;window.renderSettings=qa;function da(e){return e=e||_userInfo,!!(e&&e.is_super_admin)}function is(e){return e=e||_userInfo,!!e&&(e.role==="owner"||da(e))}function li(e){return e=e||_userInfo,!!e&&e.role==="member"&&!da(e)}function Bl(e){return e=e||_userInfo,!!e&&(e.effective_plan==="trial"||e.plan==="trial")&&!da(e)}function ci(e){return e=e||_userInfo,!!e&&e.tenant_type==="byo_api"}function di(e){return li(e)}function Ll(e){return is(e)}function $l(e){return is(e)&&ci(e)}window.isMoneyHidden=di;window.isSuperAdmin=da;window.isOwner=is;window.isEmployee=li;window.isTrial=Bl;window.isLifetime=ci;window.shouldHideMoney=di;window.canManageTeam=Ll;window.canManageApiKey=$l;function Sl(){const e=document.getElementById("quota-banner");if(!e)return;if(!_userInfo){e.style.display="none";return}if(_userInfo.is_super_admin||_userInfo.tenant_type==="admin"||_userInfo.tenant_type==="byo_api"){e.style.display="none";return}let n=0,a=0;if(_userInfo.plan==="free"&&_quota&&_quota.ip_daily_limit)n=_quota.ip_used_today||0,a=_quota.ip_daily_limit;else if(_userInfo.tenant_quota!=null&&_userInfo.tenant_quota>0)n=_userInfo.tenant_used||0,a=_userInfo.tenant_quota;else if(_userInfo.monthly_quota&&_userInfo.monthly_quota>0)n=_userInfo.used_this_month||0,a=_userInfo.monthly_quota;else{e.style.display="none";return}if(a<=0){e.style.display="none";return}const s=Math.max(0,a-n),o=n/a*100,i="quota_banner_dismiss_"+new Date().toISOString().slice(0,10);if(localStorage.getItem(i)){e.style.display="none";return}let r,l;if(s===0)r="danger",l=t("quota-banner-exhausted");else if(o>=90)r="danger",l=t("quota-banner-very-low",{n:s});else if(o>=70)r="warn",l=t("quota-banner-low",{n:s});else{e.style.display="none";return}e.className="quota-banner "+r,e.innerHTML=`
    ...
    `,e.style.display="flex";const m=e.querySelector(".quota-banner-close");m&&m.addEventListener("click",()=>{localStorage.setItem(i,"1"),e.style.display="none"})}function Cl(){const e=_userInfo;if(!e)return;const n=shouldHideMoney(e),a=canManageTeam(e),s=canManageApiKey(e),o=document.querySelector('.nav-item[data-route="templates"]');o&&(o.classList.remove("locked-for-plan"),o.removeAttribute("data-locked-target"));const i=document.querySelector('.nav-item[data-route="api-keys"]');i&&(i.classList.remove("locked-for-plan"),i.removeAttribute("data-locked-target"));const r=document.getElementById("btn-custom-template");r&&(r.style.display="",r.classList.remove("locked-for-plan"));const l=document.querySelector('.settings-tab[data-tab="team"]');l&&(l.style.display=a?"":"none");const m=document.querySelector('.settings-panel[data-settings-panel="team"]');m&&(m.dataset.permHidden=a?"0":"1");const d=document.querySelector('.settings-tab[data-tab="api"]');d&&(d.style.display=s||isSuperAdmin(e)?"":"none");const p=document.querySelector('.settings-tab[data-tab="plan"]');p&&(p.style.display=n?"none":"");const c=document.querySelector('.settings-tab[data-tab="company"]');c&&(c.style.display=n?"none":"");const u=document.getElementById("info-bar");u&&(u.style.display=n?"none":"");const f=document.getElementById("trial-banner");f&&n&&(f.style.display="none");const v=document.getElementById("plan-banner");v&&n&&(v.style.display="none",document.body.classList.remove("has-plan-banner")),document.querySelectorAll("[data-upgrade-cta], .btn-upgrade, .topbar-upgrade").forEach(y=>{y.style.display="none"}),document.body.classList.toggle("role-employee",isEmployee(e)),document.body.classList.toggle("role-owner",isOwner(e)),document.body.classList.toggle("role-super",isSuperAdmin(e));try{const y=document.querySelector(".settings-tab.active");y&&y.style.display==="none"&&(typeof window.switchSettingsTab=="function"?window.switchSettingsTab("profile"):typeof switchSettingsTab=="function"&&switchSettingsTab("profile"))}catch(y){console.warn("[v118.12.3] failed to fix active tab:",y)}if(window.PEARNLY_ADMIN_MODE){const y=document.getElementById("admin-mode-banner");y&&(y.style.display="flex"),document.querySelectorAll(".nav-item").forEach(g=>{g.classList.contains("nav-admin-only")||(g.style.display="none")}),document.querySelectorAll(".nav-group").forEach(g=>{g.classList.contains("nav-group-admin-only")||(g.style.display="none")});const b=document.getElementById("client-switcher");b&&(b.style.display="none"),document.body.classList.add("admin-mode");const h=["profile","security","notifications","about"];document.querySelectorAll(".settings-tab").forEach(g=>{const _=g.dataset.tab;_&&!h.includes(_)&&(g.style.display="none")}),document.querySelectorAll(".settings-pane").forEach(g=>{const _=g.dataset.pane;_&&!h.includes(_)&&(g.style.display="none")}),document.querySelectorAll(".settings-nav-group").forEach(g=>{const _=g.querySelectorAll(".settings-tab");Array.from(_).some(k=>k.style.display!=="none")||(g.style.display="none")})}}function Tl(){const e=_userInfo,n=document.getElementById("info-bar");if(!e||shouldHideMoney(e)){n&&(n.innerHTML="");return}let a="";const s=e.tenant_type;if(s==="byo_api")e.has_own_gemini_key?a=`
        ...
        `;else{const o=e.tenant_used!=null?e.tenant_used:e.used_this_month||0,i=e.tenant_quota!=null&&e.tenant_quota>0?e.tenant_quota:e.monthly_quota||0,r=i>0?Math.min(100,o/i*100):0;let l="";r>=95?l="danger":r>=80&&(l="warn"),i>0?a=`
            ...
            `:a=""}n&&(n.innerHTML=a)}window.renderQuotaBanner=Sl;window.applySidebarVisibility=Cl;window.renderInfoBar=Tl;async function pi(e,n){try{const a=await fetch(e,{method:"POST",headers:{Authorization:"Bearer "+token,"Content-Type":"application/json"},body:JSON.stringify(n)});if(a.status===401){localStorage.removeItem("mrpilot_token");const s=await a.json().catch(()=>({}));return(typeof s.detail=="string"?s.detail:s.detail&&s.detail.code||"")==="auth.session_revoked"?(_showSessionRevokedModal(),null):(window.location.href="/",null)}return await a.json()}catch{return{ok:!1,error:"network"}}}function ui(e){return{invalid_format:"rd-err-format",not_found:"rd-err-not-found",rd_unreachable:"rd-err-unreachable",parse_error:"rd-err-unknown",network:"rd-err-unreachable"}[e]||"rd-err-unknown"}function Un(e){const n=document.querySelector(`[data-field="${e}"]`);return n?(n.value||"").trim():""}function Bt(e,n,a){const s=document.querySelector(`[data-rd-status="${e}"]`);s&&(s.innerHTML=n,s.className="rd-status"+(a?" "+a:""))}async function Ml(e){const a=Un(e==="seller"?"seller_tax":"buyer_tax");Bt(e,t("rd-verifying"),"loading");const s=await pi("/api/rd/verify",{tax_id:a});if(!s)return;if(!s.ok){Bt(e,t(ui(s.error)),"error");return}s.data&&s.data.valid?Bt(e,`<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="2"><path d="M3 8l3 3 7-7"/></svg> ${escapeHtml(t("rd-status-valid"))}`,"valid"):Bt(e,t("rd-status-invalid"),"invalid")}async function Hl(e){const a=Un(e==="seller"?"seller_tax":"buyer_tax");Bt(e,t("rd-syncing"),"loading");const s=await pi("/api/rd/lookup",{tax_id:a,branch:0});if(s){if(!s.ok){Bt(e,t(ui(s.error)),"error");return}Bt(e,`<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="2"><path d="M3 8l3 3 7-7"/></svg> ${escapeHtml(t("rd-status-valid"))}`,"valid"),Al(e,s.data)}}function Al(e,n){const a=e==="seller"?"seller_name":"buyer_name",s=e==="seller"?"seller_addr":"buyer_addr",o=Un(a),i=Un(s),r=[];n.name&&n.name!==o&&r.push({field:a,label:t("rd-field-name"),current:o,official:n.name}),n.address&&n.address!==i&&r.push({field:s,label:t("rd-field-address"),current:i,official:n.address});const l=[];n.branch_label&&l.push(`<strong>${t("rd-field-branch")}:</strong> ${escapeHtml(n.branch_label)}`),n.post_code&&l.push(`<strong>${t("rd-field-postcode")}:</strong> ${escapeHtml(n.post_code)}`);let m=document.getElementById("rd-sync-modal");if(m||(m=document.createElement("div"),m.id="rd-sync-modal",m.className="rd-modal-mask",document.body.appendChild(m)),r.length===0)m.innerHTML=`
            <div class="rd-modal">
        ...
        `}m.classList.add("show");const d=()=>m.classList.remove("show");m.querySelector(".rd-modal-close").addEventListener("click",d),m.querySelectorAll("[data-rd-modal-close]").forEach(c=>c.addEventListener("click",d)),m.addEventListener("click",c=>{c.target===m&&d()});const p=m.querySelector("[data-rd-modal-apply]");p&&p.addEventListener("click",()=>{const c=_results[_drawerIdx];if(!c){d();return}m.querySelectorAll("[data-rd-apply]:checked").forEach(u=>{const f=u.dataset.field,v=u.dataset.value;c.edits[f]=v,c.merged_fields[f]=v;const y=document.querySelector(`[data-field="${f}"]`);y&&(y.value=v);const b=document.querySelector(`[data-field-wrap="${f}"]`);b&&b.classList.add("edited")}),updateDrawerEditCount(),renderResults(),d()})}window.callRdVerify=Ml;window.callRdSync=Hl;function jl(e){const n={invoice_number:null,date:null,total_amount:null,tax_ids:[],seller_name:"",seller_tax:"",seller_addr:"",buyer_name:"",buyer_tax:"",buyer_addr:"",subtotal:"",vat:"",notes:"",items:[]},a=e.filter(o=>!o.is_duplicate&&!o.is_copy),s=a.length>0?a:e;for(const o of s){const i=o.fields||{};!n.invoice_number&&i.invoice_number&&(n.invoice_number=i.invoice_number),!n.date&&i.date&&(n.date=i.date),!n.total_amount&&i.total_amount&&(n.total_amount=i.total_amount),!n.subtotal&&i.subtotal&&(n.subtotal=i.subtotal),!n.vat&&i.vat&&(n.vat=i.vat),!n.seller_name&&i.seller_name&&(n.seller_name=i.seller_name),!n.seller_tax&&i.seller_tax&&(n.seller_tax=i.seller_tax),!n.seller_addr&&i.seller_addr&&(n.seller_addr=i.seller_addr),!n.buyer_name&&i.buyer_name&&(n.buyer_name=i.buyer_name),!n.buyer_tax&&i.buyer_tax&&(n.buyer_tax=i.buyer_tax),!n.buyer_addr&&i.buyer_addr&&(n.buyer_addr=i.buyer_addr),!n.notes&&i.notes&&(n.notes=i.notes),Array.isArray(i.items)&&i.items.length&&n.items.push(...i.items),Array.isArray(i.tax_ids)&&n.tax_ids.push(...i.tax_ids)}return n.tax_ids=[...new Set(n.tax_ids)],!n.seller_tax&&n.tax_ids[0]&&(n.seller_tax=n.tax_ids[0]),!n.buyer_tax&&n.tax_ids[1]&&(n.buyer_tax=n.tax_ids[1]),n}function Pl(e){const n=e.target,a=n.dataset.field,s=n.value,o=_results[_drawerIdx],i=o.merged_fields[a];s===(i??"")?delete o.edits[a]:(o.edits[a]=s,o.merged_fields[a]=s);const r=document.querySelector(`[data-field-wrap="${a}"]`);r&&r.classList.toggle("edited",o.edits[a]!==void 0),mi(),renderResults()}function mi(){const e=_results[_drawerIdx],n=e?Object.keys(e.edits).length:0,a=document.getElementById("drawer-edit-count-sub");a&&(a.textContent=n>0?t("drawer-edit-count",{n}):"")}window.mergeFields=jl;window.onFieldEdit=Pl;window.updateDrawerEditCount=mi;function Dl(){document.querySelectorAll(".force-pw-overlay").forEach(a=>a.remove());const e=document.createElement("div");e.className="force-pw-overlay",e.innerHTML=`
    ...
    `;let o=_results.map((r,l)=>({...r,_idx:l}));if(_searchKeyword){const r=_searchKeyword.toLowerCase();o=o.filter(l=>(l.filename||"").toLowerCase().includes(r)||(l.merged_fields.invoice_number||"").toLowerCase().includes(r))}_sortKey&&o.sort((r,l)=>{let m,d;return _sortKey==="filename"?(m=r.filename,d=l.filename):_sortKey==="invoice_no"?(m=r.merged_fields.invoice_number,d=l.merged_fields.invoice_number):_sortKey==="invoice_date"?(m=r.merged_fields.date,d=l.merged_fields.date):_sortKey==="total"?(m=parseFloat(r.merged_fields.total_amount)||0,d=parseFloat(l.merged_fields.total_amount)||0):_sortKey==="confidence"?(m=r.confidence,d=l.confidence):(m="",d=""),m<d?_sortDir==="asc"?-1:1:m>d?_sortDir==="asc"?1:-1:0});const i=document.getElementById("results-tbody");i.innerHTML=o.map((r,l)=>{const m=r.merged_fields,d=`<span class="empty-cell">${t("empty-val")}</span>`,p="conf-tip-"+(r.confidence||"low"),c="conf-"+(r.confidence||"low"),u=t(p),f=t(c);return`
        ...
        `}).join(""),document.querySelectorAll("#results-table th").forEach(r=>{r.classList.remove("sort-asc","sort-desc"),r.dataset.sort===_sortKey&&r.classList.add("sort-"+_sortDir)}),i.querySelectorAll("tr").forEach(r=>{r.addEventListener("click",()=>{const l=parseInt(r.dataset.idx,10);vi(l)})})}document.querySelectorAll("#results-table th").forEach(e=>{e.classList.contains("no-sort")||e.addEventListener("click",()=>{const n=e.dataset.sort;_sortKey===n?_sortDir=_sortDir==="asc"?"desc":"asc":(_sortKey=n,_sortDir="asc"),pa()})});let Zs=null;document.getElementById("search-input").addEventListener("input",e=>{const n=e.target.value;document.getElementById("search-clear").style.display=n?"":"none",clearTimeout(Zs),Zs=setTimeout(()=>{_searchKeyword=n.trim(),pa(),fi()},200)});document.getElementById("search-clear").addEventListener("click",()=>{const e=document.getElementById("search-input");e.value="",_searchKeyword="",document.getElementById("search-clear").style.display="none",pa(),fi(),e.focus()});function fi(){const e=document.getElementById("search-matches");if(!e)return;if(!_searchKeyword){e.textContent="";return}const n=_searchKeyword.toLowerCase();let a=0;for(const s of _results)[s.filename,s.merged_fields?.invoice_number,s.merged_fields?.seller_name,s.merged_fields?.buyer_name].filter(Boolean).join(" ").toLowerCase().includes(n)&&a++;e.textContent=t("search-matches",{n:a})}function vi(e){_drawerIdx=e;const n=_results[e];if(!n)return;document.getElementById("drawer-title").textContent=n.filename;const a=n.engine==="cache"||n.from_cache,s=a?t("badge-cached-hint"):`${(n.elapsed_ms/1e3).toFixed(1)}s`;document.getElementById("drawer-sub").innerHTML=`
    ...
    `,d=i?"":`<span class="tax-badge unverified" data-tip="${escapeHtml(t("tax-tip-unverified"))}">${t("tax-unverified")}</span>`;if(l.innerHTML=`
        ...
        <div class="drawer-section">
            ...
            ${Le("invoice_number","drawer-lbl-invoice",r.invoice_number,"input",o)}
            ${Le("date","drawer-lbl-date",r.date,"input",o)}
            ...
            ${Le("subtotal","drawer-lbl-subtotal",r.subtotal,"input",o)}
            ${Le("vat","drawer-lbl-vat",r.vat,"input",o)}
            ${Le("total_amount","drawer-lbl-total",r.total_amount,"input",o)}
            ${r.wht_amount||r.wht_rate?`
                ${Le("wht_amount","drawer-lbl-wht-amount",r.wht_amount,"input",o,ql(r.wht_rate))}
            `:""}
        </div>
        ...
        <div class="drawer-section">
            ...
            ${Le("seller_name","drawer-lbl-name",r.seller_name,"input",o)}
            ${Le("seller_tax","drawer-lbl-tax",r.seller_tax,"input",o,d,Qs("seller"))}
            ${Le("seller_addr","drawer-lbl-addr",r.seller_addr,"textarea",o)}
        </div>
        ...
        <div class="drawer-section">
            ...
            ${Le("buyer_name","drawer-lbl-name",r.buyer_name,"input",o)}
            ${Le("buyer_tax","drawer-lbl-tax",r.buyer_tax,"input",o,d,Qs("buyer"))}
            ${Le("buyer_addr","drawer-lbl-addr",r.buyer_addr,"textarea",o)}
        </div>
        ...
        <div class="drawer-section">
            ...
            ${r.items&&r.items.length>0?Rl(r.items):`<div class="drawer-items-empty">${t("drawer-items-empty")}</div>`}
        </div>

        <div class="drawer-section">
            ${Le("notes","drawer-lbl-notes",r.notes,"textarea",o)}
        </div>
...
`))}</pre>
    ...
    `,o?l.querySelectorAll("[data-field]").forEach(p=>{p.addEventListener("input",onFieldEdit)}):l.querySelectorAll("[data-field]").forEach(p=>{p.setAttribute("readonly","readonly")}),document.getElementById("drawer-mask").classList.add("show"),document.getElementById("drawer").classList.add("show"),injectOcrPushButton(),typeof window.bindDrawerClient=="function"){const p=n._historyId||n.history_id||null;window.bindDrawerClient(p,n.client_id||null)}typeof window.fillCategoryDatalist=="function"&&window.fillCategoryDatalist(),setTimeout(()=>{const p=document.getElementById("drawer-cat-input");p&&!p.value&&!p.readOnly&&p.focus()},80)}function ql(e){return e?`<span class="wht-badge">${escapeHtml(e)}%</span>`:""}function Le(e,n,a,s,o,i,r){const l=_results[_drawerIdx],m=l&&l.edits[e]!==void 0?l.edits[e]:a,d=l&&l.edits[e]!==void 0&&l.edits[e]!==a,p=escapeHtml(m??""),c=o?"":"readonly",u=s==="textarea"?`<textarea data-field="${e}" rows="2">${p}</textarea>`:`<input type="text" data-field="${e}" value="${p}">`;return`
    ...
    `}function Qs(e){return _userInfo&&_userInfo.can_verify_tax?`
    ...
    `;n.innerHTML=s+o,e.appendChild(n)}function _a(){const e=document.getElementById("export-dropdown");e&&e.remove()}const Ea=document.getElementById("btn-export-arrow");Ea&&Ea.addEventListener("click",e=>{e.stopPropagation(),!Ea.disabled&&Ul()});document.addEventListener("click",e=>{const n=e.target.closest(".export-dd-item");if(n){const a=n.getAttribute("data-tpl");if(a==="__custom"){_a(),showToast(t("cs-coming-soon"),"info");return}Vl(a),_a(),bi(a);return}e.target.closest("#btn-export-arrow")||_a()});function Gl(){const e=document.getElementById("btn-export-arrow"),n=document.getElementById("btn-export");e&&n&&(e.disabled=n.disabled)}setInterval(Gl,300);const Wl=`
        <div class="page-head-clean">
            <div class="page-head-icon">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
...
`;(function(){const e=document.getElementById("page-history");if(!(!e||e.dataset.wbInjected==="1")){e.innerHTML=Wl,e.dataset.wbInjected="1";try{const n=window._currentLang||localStorage.getItem("mrpilot_lang")||"th",a=window.I18N;a&&a[n]&&(e.querySelectorAll("[data-i18n]").forEach(s=>{const o=s.getAttribute("data-i18n");a[n][o]&&(s.textContent=a[n][o])}),e.querySelectorAll("[data-i18n-placeholder]").forEach(s=>{const o=s.getAttribute("data-i18n-placeholder");a[n][o]&&(s.placeholder=a[n][o])}))}catch{}}})();function rs(){const e=document.getElementById("history-batch-bar"),n=document.getElementById("history-batch-count"),a=document.getElementById("history-check-all");if(!e||!n)return;const s=_historySelected.size;if(s>0?(e.style.display="",n.textContent=t("history-batch-count",{n:s})):e.style.display="none",a){const o=_historyState.items||[];if(o.length===0)a.checked=!1,a.indeterminate=!1;else{const i=o.filter(r=>_historySelected.has(r.id)).length;a.checked=i===o.length,a.indeterminate=i>0&&i<o.length}}}function Kl(){_historySelected.clear(),rs()}async function ls(){if(!_userInfo){setTimeout(()=>ls(),300);return}const e=document.getElementById("history-free-block"),n=document.getElementById("history-main"),a=document.getElementById("history-empty");if(!e||!n||!a){console.warn("[History] container missing");return}if(!_userInfo.can_view_history){e.style.display="",n.style.display="none",a.style.display="none";return}e.style.display="none",_historyState.loading=!0;try{const s=_historyState.page*_historyState.pageSize,o=new URLSearchParams({limit:_historyState.pageSize,offset:s});_historyState.keyword&&o.set("keyword",_historyState.keyword);const i=typeof window.getCurrentClientId=="function"?window.getCurrentClientId():null;i&&o.set("client_id",String(i));const r=await fetch(`/api/history?${o}`,{headers:{Authorization:"Bearer "+token}});if(r.status===401){localStorage.removeItem("mrpilot_token");const d=await r.json().catch(()=>({}));if((typeof d.detail=="string"?d.detail:d.detail&&d.detail.code||"")==="auth.session_revoked"){_showSessionRevokedModal();return}window.location.href="/";return}const l=await r.json();_historyState.items=l.items||[],_historyState.total=l.total||0;const m=new Set(_historyState.items.map(d=>d.id));for(const d of Array.from(_historySelected))m.has(d)||_historySelected.delete(d);yi()}catch(s){console.error("load history failed",s)}finally{_historyState.loading=!1}}function yi(){const e=document.getElementById("history-main"),n=document.getElementById("history-empty"),a=_historyState.items,s=document.getElementById("history-search-matches");if(s&&(s.textContent=_historyState.keyword?t("search-matches",{n:_historyState.total}):""),a.length===0&&_historyState.total===0&&!_historyState.keyword){e.style.display="none",n.style.display="";return}e.style.display="",n.style.display="none";let o=0;a.forEach(d=>{d.confidence==="high"&&o++});const i=a.length>0?Math.round(o/a.length*100):0;document.getElementById("history-stats").innerHTML=`
    ...
    `;const r=document.getElementById("history-tbody");a.length===0?r.innerHTML=`<div class="history-row-empty">${escapeHtml(t("history-empty-title"))}</div>`:r.innerHTML=a.map(d=>{const p=new Date(d.created_at),c=String(p.getMonth()+1).padStart(2,"0"),u=String(p.getDate()).padStart(2,"0"),f=String(p.getHours()).padStart(2,"0"),v=String(p.getMinutes()).padStart(2,"0"),y=`${c}-${u} ${f}:${v}`,b=escapeHtml(d.filename||""),h=b.length>50?b.substring(0,50)+"…":b,g=d.invoice_no?escapeHtml(d.invoice_no):h,_=[];d.seller_name&&_.push(escapeHtml(d.seller_name)),d.invoice_no&&d.filename&&_.push(h);const w=_.join(" · ")||"-",k=d.category_tag?`<span class="history-badge category">${escapeHtml(d.category_tag)}</span>`:"",x=d.source_total&&d.source_total>1?`<span class="history-badge multi">${escapeHtml(t("invoice-part-of",{i:d.source_index||1,n:d.source_total}))}</span>`:"",E=d.total_amount!==null&&d.total_amount!==void 0?Number(d.total_amount).toLocaleString(void 0,{minimumFractionDigits:2,maximumFractionDigits:2}):'<span class="history-cell-amount-empty">—</span>',I=[];(d.total_amount===null||d.total_amount===void 0)&&I.push(t("field-amount")),d.invoice_no||I.push(t("field-invoice-no")),d.invoice_date||I.push(t("field-invoice-date")),d.seller_name||I.push(t("field-seller-name")),I.length>0&&`${escapeHtml(d.id)}${escapeHtml(t("history-needs-review-tip")+" · "+I.join(" · "))}${escapeHtml(t("history-needs-review-tip"))}${svgIcon("alert",14)}`,d.edited&&`${escapeHtml(t("history-edited",{n:d.edit_count||1}))}`;const B=d.smart_assigned_flag?`<span class="history-badge smart-assigned" title="${escapeHtml(t("history-smart-assigned"))}">${svgIcon("sparkle",11)}</span>`:"",L=d.confidence==="high"?"high":d.confidence==="medium"?"mid":"low",$=d.confidence==="high"?t("conf-high"):d.confidence==="medium"?t("conf-medium"):t("conf-low"),S=`<span class="history-badge conf-${L}">${escapeHtml($)}</span>`;let M="";const F=d.source||"manual";return F==="email"?M=`<span class="history-badge source source-email" title="${escapeHtml(t("history-source-email"))}">${svgIcon("mail",11)}<span>${escapeHtml(t("history-source-email"))}</span></span>`:F==="folder"?M=`<span class="history-badge source source-folder" title="${escapeHtml(t("history-source-folder"))}">${svgIcon("folder",11)}<span>${escapeHtml(t("history-source-folder"))}</span></span>`:F==="api"&&(M=`<span class="history-badge source source-api" title="${escapeHtml(t("history-source-api"))}">${svgIcon("api",11)}<span>${escapeHtml(t("history-source-api"))}</span></span>`),`
                <div class="history-row" data-hid="${escapeHtml(d.id)}">
                    ...
                    <div class="history-cell-file">
                        <div class="history-cell-filename">${g} ${k} ${x} ${M} ${B}</div>
            ...
            `}).join(""),rs();const l=a.length>0?_historyState.page*_historyState.pageSize+1:0,m=_historyState.page*_historyState.pageSize+a.length;document.getElementById("history-pager-info").textContent=t("history-pager",{from:l,to:m,total:_historyState.total}),document.getElementById("history-prev").disabled=_historyState.page===0,document.getElementById("history-next").disabled=(_historyState.page+1)*_historyState.pageSize>=_historyState.total}window.loadHistoryPage=ls;window.renderHistoryList=yi;window.updateHistoryBatchBar=rs;window.clearHistorySelection=Kl;typeof currentRoute<"u"&&currentRoute==="history"&&ls();async function Gn(e){try{const n=await fetch(`/api/history/${encodeURIComponent(e)}`,{headers:{Authorization:"Bearer "+token}});if(!n.ok)return;const a=await n.json(),s=mergeFields(a.pages||[]),o={filename:a.filename,pages:a.pages,page_count:a.page_count,elapsed_ms:a.elapsed_ms,engine:"history",merged_fields:s,edits:{},confidence:a.confidence,archive_name:a.archive_name||null,category_tag:a.category_tag||null,_historyId:a.id,_historyMode:!0,client_id:a.client_id||null};_results.push(o),_drawerIdx=_results.length-1,openDrawer(_drawerIdx),Jl(),typeof window.bindDrawerClient=="function"&&window.bindDrawerClient(a.id,a.client_id||null),Xl(a.id)}catch(n){console.error("open history detail failed",n)}}async function Yl(e){await Gn(e),requestAnimationFrame(()=>{const n=document.querySelector('[data-field="total_amount"]');if(n){try{n.focus()}catch{}try{n.select()}catch{}try{n.scrollIntoView({block:"center",behavior:"smooth"})}catch{}}})}function Jl(){const e=document.getElementById("drawer-body");if(!e||document.getElementById("drawer-history-save"))return;const n=document.createElement("div");n.id="drawer-history-save",n.className="drawer-history-save-bar",n.innerHTML=`
    ...
    `,e.appendChild(n),document.getElementById("btn-save-history").addEventListener("click",Ql),document.getElementById("btn-push-erp").addEventListener("click",Zl)}async function Xl(e){}async function Zl(){showToast(t("erp-push-coming-soon")||"ERP 推送即将开放，敬请期待","info")}async function Ql(){const e=_results[_drawerIdx];if(!e||!e._historyId)return;const n=JSON.parse(JSON.stringify(e.pages||[]));if(n.length>0){const s=n.findIndex(l=>!l.is_duplicate&&!l.is_copy),o=s>=0?s:0,i=n[o].fields||(n[o].fields={}),r={...e.edits};r.category_tag!==void 0&&(r.category=r.category_tag,delete r.category_tag),Object.assign(i,r)}const a=document.getElementById("btn-save-history");a&&(a.disabled=!0);try{if(!(await fetch(`/api/history/${encodeURIComponent(e._historyId)}`,{method:"PUT",headers:{Authorization:"Bearer "+token,"Content-Type":"application/json"},body:JSON.stringify({pages:n})})).ok)throw new Error("save failed");showAlert("info",t("history-save-ok")),setTimeout(hideAlerts,1500),closeDrawer(),e._historyMode&&_results.pop(),loadHistoryPage()}catch{showAlert("error",t("history-save-fail")),a&&(a.disabled=!1)}}function ec(e,n){document.querySelectorAll(".history-popover").forEach(d=>d.remove());const a=n.getBoundingClientRect(),s=(_historyState.items||[]).find(d=>d.id===e),o=s&&s.invoice_no?String(s.invoice_no):"",i=s&&s.has_pdf===!0,r=document.createElement("div");r.className="history-popover",r.innerHTML=`
    ...
    `,r.style.top=a.bottom+4+"px",r.style.left=a.right-160+"px",document.body.appendChild(r);const l=()=>{r.remove(),document.removeEventListener("click",m,!0)},m=d=>{!r.contains(d.target)&&d.target!==n&&l()};setTimeout(()=>document.addEventListener("click",m,!0),0),r.addEventListener("click",async d=>{const p=d.target.closest("[data-act]");if(!p||p.disabled)return;const c=p.dataset.act;if(l(),c==="copy-invno"){if(!o)return;try{await navigator.clipboard.writeText(o),showToast(t("history-copy-invno-ok",{no:o}),"success")}catch{try{const f=document.createElement("textarea");f.value=o,f.style.position="fixed",f.style.opacity="0",document.body.appendChild(f),f.select(),document.execCommand("copy"),document.body.removeChild(f),showToast(t("history-copy-invno-ok",{no:o}),"success")}catch{showToast(t("history-copy-invno-fail"),"error")}}}else if(c==="download-pdf"){const u=showToast(t("history-download-pdf-loading"),"loading",0);try{const f=await fetch(`/api/history/${encodeURIComponent(e)}/pdf`,{headers:{Authorization:"Bearer "+token}});if(!f.ok)throw new Error("download failed");const v=await f.blob(),y=URL.createObjectURL(v),b=document.createElement("a");b.href=y,b.download=s&&s.filename?s.filename.endsWith(".pdf")?s.filename:s.filename+".pdf":"invoice.pdf",document.body.appendChild(b),b.click(),document.body.removeChild(b),setTimeout(()=>URL.revokeObjectURL(y),5e3),u(),showToast(t("history-download-pdf-ok"),"success")}catch{u(),showToast(t("history-download-pdf-fail"),"error")}}else if(c==="delete"){if(!await showConfirm(t("history-confirm-delete"),{danger:!0}))return;try{if(!(await fetch(`/api/history/${encodeURIComponent(e)}`,{method:"DELETE",headers:{Authorization:"Bearer "+token}})).ok)throw new Error;showAlert("info",t("history-delete-ok")),setTimeout(hideAlerts,1500),loadHistoryPage()}catch{showAlert("error",t("history-delete-fail"))}}})}(function(){document.addEventListener("click",r=>{const l=r.target.closest(".history-row"),m=r.target.closest("[data-hmenu]");if(m){r.stopPropagation(),ec(m.dataset.hmenu,m);return}const d=r.target.closest("[data-review]");if(d){r.stopPropagation(),Gn(d.dataset.review);return}const p=r.target.closest("[data-fill-amount]");if(p){r.stopPropagation(),Yl(p.dataset.fillAmount);return}r.target.closest(".history-row-check")||r.target.closest(".history-cell-check")||l&&!r.target.closest("[data-hmenu]")&&Gn(l.dataset.hid)});const n=document.getElementById("history-tbody");n&&n.addEventListener("change",r=>{const l=r.target.closest(".history-row-check");if(!l)return;const m=l.dataset.hid;l.checked?_historySelected.add(m):_historySelected.delete(m),updateHistoryBatchBar()});const a=document.getElementById("history-check-all");a&&a.addEventListener("change",r=>{const l=r.target.checked;for(const m of _historyState.items)l?_historySelected.add(m.id):_historySelected.delete(m.id);document.querySelectorAll(".history-row-check").forEach(m=>{m.checked=l}),updateHistoryBatchBar()});const s=document.getElementById("history-batch-cancel");s&&s.addEventListener("click",()=>{clearHistorySelection(),document.querySelectorAll(".history-row-check").forEach(r=>{r.checked=!1})});const o=document.getElementById("history-batch-delete");o&&o.addEventListener("click",async()=>{const r=_historySelected.size;if(r===0||!await showConfirm(t("history-batch-confirm",{n:r}),{danger:!0}))return;const m=Array.from(_historySelected);try{const d=await fetch("/api/history/batch-delete",{method:"POST",headers:{Authorization:"Bearer "+token,"Content-Type":"application/json"},body:JSON.stringify({ids:m})});if(!d.ok)throw new Error("batch delete failed");const p=await d.json();showToast(t("history-batch-done",{n:p.deleted||0}),"success"),clearHistorySelection(),loadHistoryPage()}catch(d){console.error("batch delete",d),showToast(t("history-batch-fail"),"error")}});let i=null;document.getElementById("history-search").addEventListener("input",r=>{const l=r.target.value;document.getElementById("history-search-clear").style.display=l?"":"none",clearTimeout(i),i=setTimeout(()=>{_historyState.keyword=l.trim(),_historyState.page=0,clearHistorySelection(),loadHistoryPage()},300)}),document.getElementById("history-search-clear").addEventListener("click",()=>{const r=document.getElementById("history-search");r.value="",_historyState.keyword="",_historyState.page=0,clearHistorySelection(),document.getElementById("history-search-clear").style.display="none",loadHistoryPage(),r.focus()}),document.getElementById("history-range").addEventListener("change",r=>{_historyState.range=parseInt(r.target.value,10),_historyState.page=0,clearHistorySelection(),loadHistoryPage()}),document.getElementById("history-prev").addEventListener("click",()=>{_historyState.page>0&&(_historyState.page--,clearHistorySelection(),loadHistoryPage())}),document.getElementById("history-next").addEventListener("click",()=>{(_historyState.page+1)*_historyState.pageSize<_historyState.total&&(_historyState.page++,clearHistorySelection(),loadHistoryPage())})})();window.openHistoryDrawer=Gn;const Wt=document.getElementById("drop-zone"),cs=document.getElementById("file-input");Wt.addEventListener("click",()=>cs.click());cs.addEventListener("change",e=>wi(e.target.files));["dragover","dragenter"].forEach(e=>{Wt.addEventListener(e,n=>{n.preventDefault(),Wt.classList.add("drag-over")})});["dragleave","drop"].forEach(e=>{Wt.addEventListener(e,n=>{n.preventDefault(),Wt.classList.remove("drag-over")})});Wt.addEventListener("drop",e=>{e.preventDefault(),wi(e.dataTransfer.files)});const tc=/\.(pdf|png|jpe?g|webp|tiff?|bmp|gif|xlsx?|xlsm|csv|tsv|docx?|txt)$/i;function Ra(e){return e.type&&e.type.startsWith("image/")||/\.(png|jpe?g|webp|tiff?|bmp|gif)$/i.test(e.name)}function nc(e){return e.type==="application/pdf"||/\.pdf$/i.test(e.name)}function ac(e){return nc(e)||Ra(e)||tc.test(e.name)}function wi(e){hideAlerts();const n=Array.from(e),a=n.filter(ac);a.length!==n.length&&showAlert("warn",t("alert-unsupported-format"));const s=a.filter(l=>!Ra(l)),o=a.filter(Ra),i=new Set(_selectedFiles.map(l=>l.name+"_"+l.size));for(const l of s){const m=l.name+"_"+l.size;i.has(m)||(_selectedFiles.push({file:l,name:l.name,size:l.size,status:"waiting",errorKey:null,errorParams:null}),i.add(m))}if(o.length>0)try{handleCameraImages(o,"gallery")}catch(l){console.error("[upload] image route failed",l)}const r=getMaxFiles();_selectedFiles.length>r&&(showAlert("warn",t("alert-file-count",{n:r})),_selectedFiles=_selectedFiles.slice(0,r)),ua(),ds(),cs.value=""}let Sn=!1;function ua(){const e=document.getElementById("file-list");if(!e)return;if(_selectedFiles.length===0){e.classList.remove("has-files"),e.innerHTML="";return}e.classList.add("has-files");const n=_selectedFiles.length,a=_selectedFiles.filter(c=>c.status==="processing"||c.status==="retrying").length,s=_selectedFiles.filter(c=>c.status==="success").length,o=_selectedFiles.filter(c=>c.status==="error").length;let i=`<span class="count">${escapeHtml(t("file-list-total",{n}))}</span>`;const r=[];a&&r.push(`<span style="color: var(--accent, #111111);">${a} ${escapeHtml(t("status-processing"))}</span>`),s&&r.push(`<span style="color: var(--success, #059669);">${s} ${escapeHtml(t("status-success"))}</span>`),o&&r.push(`<span style="color: var(--danger, #dc2626);">${o} ${escapeHtml(t("status-error"))}</span>`),r.length&&(i+=" · "+r.join(" · "));const l=Sn?t("file-list-collapse"):t("file-list-expand"),m=_selectedFiles.map((c,u)=>{let f=t("status-"+c.status);c.status==="retrying"&&(f=t("status-retrying")),c.status==="error"&&c.errorKey&&(f=t(c.errorKey,c.errorParams||{}));const v=c.status==="processing"||c.status==="retrying"?'<span class="spinner"></span>':"",y=c.status==="error"&&c.canRetry?`<button class="file-retry-btn" data-retry-idx="${u}" title="${escapeHtml(t("upload-retry-btn"))}">${svgIcon("refresh",12)}<span>${escapeHtml(t("upload-retry-btn"))}</span></button>`:"",b=c.status==="success"&&c.fromCache?`<span class="file-cache-badge">${svgIcon("cache",11)}<span>${escapeHtml(t("cache-hit-badge"))}</span></span>`:"";return`
            <li class="file-item">
                ...
                ${b}
                <span class="file-status ${c.status}">${v}${f}</span>
                ${y}
            </li>
        `}).join("");e.innerHTML=`
...
`;Be("camera-tips-modal",sc);async function Wn(e){return new Promise(n=>{const a=new FileReader;a.onerror=()=>n({warnings:[],width:0,height:0,brightness:128}),a.onload=()=>{const s=new Image;s.onerror=()=>n({warnings:[],width:0,height:0,brightness:128}),s.onload=()=>{const o=[],i=s.naturalWidth,r=s.naturalHeight;(i<1e3||r<1e3)&&o.push("low_res");try{const l=document.createElement("canvas");l.width=64,l.height=64;const m=l.getContext("2d");m.drawImage(s,0,0,64,64);const d=m.getImageData(0,0,64,64).data;let p=0,c=0;for(let f=0;f<d.length;f+=4)p+=.299*d[f]+.587*d[f+1]+.114*d[f+2],c++;const u=c?p/c:128;u<70?o.push("too_dark"):u>235&&o.push("too_bright"),n({warnings:o,width:i,height:r,brightness:u})}catch{n({warnings:o,width:i,height:r,brightness:128})}},s.src=a.result},a.readAsDataURL(e)})}async function ki(e){if(!e||e.length===0)return null;const{jsPDF:n}=window.jspdf,a=210,s=297,o=new n({unit:"mm",format:"a4",orientation:"p"});for(let d=0;d<e.length;d++){const p=e[d],{dataUrl:c,naturalW:u,naturalH:f}=await oc(p);d>0&&o.addPage("a4","p");const v=u/f;let y=a-10,b=y/v;b>s-10&&(b=s-10,y=b*v);const h=(a-y)/2,g=(s-b)/2,_=p.type==="image/png"?"PNG":"JPEG";o.addImage(c,_,h,g,y,b,void 0,"FAST")}const i=o.output("blob"),r=new Date,l=r.getFullYear().toString()+String(r.getMonth()+1).padStart(2,"0")+String(r.getDate()).padStart(2,"0")+String(r.getHours()).padStart(2,"0")+String(r.getMinutes()).padStart(2,"0")+String(r.getSeconds()).padStart(2,"0"),m=e.length>1?`_${e.length}p`:"";return new File([i],`photo_${l}${m}.pdf`,{type:"application/pdf"})}function oc(e){return new Promise((n,a)=>{const s=new FileReader;s.onerror=a,s.onload=()=>{const o=new Image;o.onerror=a,o.onload=()=>n({dataUrl:s.result,naturalW:o.naturalWidth,naturalH:o.naturalHeight}),o.src=s.result},s.readAsDataURL(e)})}(function(){const n=document.getElementById("upload-alt-row"),a=document.getElementById("gallery-input"),s=document.getElementById("camera-input");if(!n)return;n.style.display="";const o=document.getElementById("btn-scan-doc");o&&s&&(o.addEventListener("click",async()=>{!(localStorage.getItem("mrpilot_camera_tips_skip")==="1")&&!await rc()||s.click()}),s.addEventListener("change",async l=>{const m=Array.from(l.target.files||[]);if(l.target.value="",m.length!==0)for(const d of m)await Fa([d],"camera")}));const i=document.getElementById("btn-upload-pic");i&&a&&i.addEventListener("click",()=>a.click());const r=l=>async m=>{const d=Array.from(m.target.files||[]);if(m.target.value="",d.length===0)return;const p=d.filter(u=>u.type==="application/pdf"||/\.pdf$/i.test(u.name)),c=d.filter(u=>!p.includes(u));p.length>0&&await ic(p),c.length>0&&await Fa(c,l)};a&&a.addEventListener("change",r("gallery"))})();async function ic(e){for(const a of e)_selectedFiles.push({file:a,name:a.name,size:a.size,status:"waiting",errorKey:null,errorParams:null});const n=getMaxFiles();_selectedFiles.length>n&&(showAlert("warn",t("alert-file-count",{n})),_selectedFiles=_selectedFiles.slice(0,n)),renderFileList(),updateStartButton()}function rc(){return new Promise(e=>{const n=document.getElementById("camera-tips-modal"),a=document.getElementById("camera-tips-ok"),s=document.getElementById("camera-tips-cancel"),o=document.getElementById("camera-tips-skip");if(!n||!a){e(!0);return}o&&(o.checked=!1),n.style.display="flex";const i=l=>{n.style.display="none",o&&o.checked&&localStorage.setItem("mrpilot_camera_tips_skip","1"),a.onclick=null,s&&(s.onclick=null),n.onclick=null,document.removeEventListener("keydown",r),e(l)},r=l=>{l.key==="Escape"&&i(!1)};a.onclick=()=>i(!0),s&&(s.onclick=()=>i(!1)),n.onclick=l=>{l.target===n&&i(!1)},document.addEventListener("keydown",r),setTimeout(()=>a.focus(),50)})}let Ve=[],It=null;async function Fa(e,n){if(hideAlerts(),!(!e||e.length===0)){var a=typeof window.getOcrDocumentMode=="function"?window.getOcrDocumentMode():"invoice";if(a==="thai_id_card"){for(const o of e)_selectedFiles.push({file:o,name:o.name,size:o.size,status:"waiting",errorKey:null,errorParams:null});const s=getMaxFiles();_selectedFiles.length>s&&(showAlert("warn",t("alert-file-count",{n:s})),_selectedFiles=_selectedFiles.slice(0,s)),renderFileList(),updateStartButton();return}if(typeof window.jspdf>"u"||!window.jspdf.jsPDF){showToast(t("camera-loading"),"info");for(let s=0;s<30&&(await new Promise(o=>setTimeout(o,100)),!(window.jspdf&&window.jspdf.jsPDF));s++);if(!window.jspdf||!window.jspdf.jsPDF){showToast(t("camera-lib-fail"),"error");return}}if(n==="camera"&&e.length===1){const s=e[0];let o={};try{o=await Wn(s)}catch{}Ve.push({file:s,quality:o}),It="camera",zt();return}if(n==="gallery"&&(e.length>=2||Ve.length>0)){for(const s of e){let o={};try{o=await Wn(s)}catch{}Ve.push({file:s,quality:o})}It="gallery",zt();return}await xi(e)}}async function lc(e){const n=new Set;for(const s of e)try{((await Wn(s)).warnings||[]).forEach(i=>n.add(i))}catch{}try{const s=await ki(e);s&&_selectedFiles.push({file:s,name:s.name,size:s.size,status:"waiting",errorKey:null,errorParams:null})}catch(s){console.error("[camera] convert failed",s),showToast(t("camera-convert-fail"),"error");return}const a=getMaxFiles();_selectedFiles.length>a&&(showAlert("warn",t("alert-file-count",{n:a})),_selectedFiles=_selectedFiles.slice(0,a)),renderFileList(),updateStartButton(),showToast(t("camera-added-merged",{n:e.length}),"success"),n.size>0&&setTimeout(()=>{n.has("too_dark")?showToast(t("camera-quality-dark"),"warn"):n.has("low_res")?showToast(t("camera-quality-lowres"),"warn"):n.has("too_bright")&&showToast(t("camera-quality-overexposed"),"warn")},1e3)}function zt(){let e=document.getElementById("camera-buffer-bar");if(Ve.length===0){e&&e.remove(),It=null;return}e||(e=document.createElement("div"),e.id="camera-buffer-bar",e.className="camera-buffer-bar",document.body.appendChild(e));const n=Ve.length,a=n>=2,s=It==="gallery",o=s?t("camera-buffer-more-gallery"):t("camera-buffer-more");let i;a?s?i=`
    ...
    `,document.body.appendChild(c);const u=()=>{c.remove(),window._dupQueue&&window._dupQueue.length&&setTimeout(Ei,200)};c.querySelector(".dup-close").addEventListener("click",u),c.querySelector('[data-action="view"]').addEventListener("click",()=>{const f=e.match.id;window.location.hash="#/history",setTimeout(()=>{typeof openHistoryDrawer=="function"&&openHistoryDrawer(f)},400),u()}),c.querySelector('[data-action="delete"]').addEventListener("click",async()=>{const f=e.new_history_id;if(!f){u();return}try{(await fetch(`/api/history/${encodeURIComponent(f)}`,{method:"DELETE",headers:{Authorization:"Bearer "+token}})).ok?showToast(t("dup-deleted-toast"),"success"):showToast(t("dup-delete-failed"),"error")}catch{showToast(t("dup-delete-failed"),"error")}u()}),c.querySelector('[data-action="keep"]').addEventListener("click",u)}window.showDuplicateDialog=Ei;function Lt(e,n){try{return typeof window.t=="function"?window.t(e):n}catch{return n}}function an(e){if(e==null||isNaN(e))return"—";try{return String(e).replace(/\B(?=(\d{3})+(?!\d))/g,",")}catch{return String(e)}}function pc(e){if(!e)return"";try{const n=new Date(e).getTime();if(!n)return"";const a=Math.floor((Date.now()-n)/1e3);return a<60?Lt("time-just-now","刚刚"):a<3600?Math.floor(a/60)+Lt("time-min-ago-suffix"," 分钟前"):a<86400?Math.floor(a/3600)+Lt("time-hour-ago-suffix"," 小时前"):Math.floor(a/86400)+Lt("time-day-ago-suffix"," 天前")}catch{return""}}async function ps(){Ii();const e=document.getElementById("dash-kpi-invoices"),n=document.getElementById("dash-kpi-pending"),a=document.getElementById("dash-kpi-exceptions"),s=document.getElementById("dash-kpi-plan"),o=document.getElementById("dash-kpi-plan-sub"),i=document.getElementById("dash-recent-list"),r=document.getElementById("dash-quick-exc-badge");try{const l={Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||"")},[m,d,p]=await Promise.all([fetch("/api/me/tenant-usage",{headers:l}).then(b=>b.ok?b.json():null).catch(()=>null),fetch("/api/history?limit=20",{headers:l}).then(b=>b.ok?b.json():null).catch(()=>null),fetch("/api/exceptions/stats?status=pending",{headers:l}).then(b=>b.ok?b.json():null).catch(()=>null)]),c=m&&m.ocr_this_month||0;let u=0;const f=d&&(d.items||d.history||d)||[],v=Array.isArray(f)?f:[];v.forEach(b=>{(b.status==="pending"||b.status==="reviewing")&&u++});const y=p&&(p.total||p.count||p.pending||0)||0;if(e&&(e.textContent=an(c)),n&&(n.textContent=an(u)),a&&(a.textContent=an(y)),r&&(y>0?(r.style.display="",r.textContent=y):r.style.display="none"),s&&m){const b=m.ocr_this_month||0,h=m.quota||0;s.textContent=an(b),o&&(o.textContent=h?b+" / "+an(h)+" 张":Lt("dash-kpi-plan-sub","本月用量"))}if(i)if(v.length===0)i.innerHTML='<div class="dash-recent-empty">'+Lt("dash-recent-empty","还没有识别记录 · 去上传第一张吧")+"</div>";else{const b=v.slice(0,5).map(h=>{const g=(h.invoice_no||h.filename||h.id||"").toString(),_=(h.supplier_name||h.buyer_name||h.client_name||h.notes||"").toString(),w=pc(h.created_at||h.upload_time||h.date),k=x=>String(x).replace(/[&<>"']/g,E=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[E]);return'<div class="dash-recent-row"><span class="dash-recent-key" title="'+k(g)+'">'+k(g)+'</span><span class="dash-recent-mid" title="'+k(_)+'">'+k(_)+'</span><span class="dash-recent-time">'+k(w)+"</span></div>"}).join("");i.innerHTML=b}}catch{i&&(i.innerHTML='<div class="dash-recent-empty">'+Lt("dash-recent-empty","还没有识别记录 · 去上传第一张吧")+"</div>")}}window.loadDashboard=ps;async function Ii(){const e=document.getElementById("dash-kpi-balance-card"),n=document.getElementById("dash-kpi-usage-card"),a=document.getElementById("dash-kpi-balance"),s=document.getElementById("dash-kpi-balance-sub"),o=document.getElementById("dash-kpi-usage"),i=document.getElementById("dash-kpi-usage-sub");if(!(!e||!n))try{const r={Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||"")},l=await fetch("/api/me/credits",{headers:r,cache:"no-store"});if(!l.ok){e.style.display="none",o&&(o.textContent="—"),i&&(i.textContent="");return}const m=await l.json(),d=!!m.is_owner,p=!!m.is_billing_exempt;if(!d)e.style.display="none";else if(e.style.display="",p)a&&(a.textContent="∞",a.className="dash-kpi-val dash-green"),s&&(s.textContent=typeof window.t=="function"?window.t("dash-kpi-balance-exempt"):"Billing exempt");else{const u=typeof m.balance_thb=="number"?m.balance_thb:0;if(a&&(a.textContent="฿"+u.toFixed(2),a.className=u<50?"dash-kpi-val dash-red":"dash-kpi-val"),s){const f=typeof window.t=="function"?window.t("dash-kpi-balance-topup"):"Top up →",v=u<50?"#dc2626":"#6b7280",y=b=>typeof window.escapeHtml=="function"?window.escapeHtml(b):String(b).replace(/[&<>"']/g,h=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[h]);s.innerHTML='<a href="#" id="kpi-balance-topup-link" style="color:'+v+';text-decoration:underline;cursor:pointer;" onclick="event.preventDefault();window._openTopupModal&&window._openTopupModal();return false;">'+y(f)+"</a>"}}const c=typeof m.pages_this_month=="number"?m.pages_this_month:typeof m.my_invoice_count=="number"?m.my_invoice_count:0;if(n.style.display="",o&&(o.textContent=String(c)),i){const u=c>=200?"dash-kpi-usage-sub-high":"dash-kpi-usage-sub-low",f=typeof window.t=="function"?window.t(u,{used:c}):c+" pages";i.textContent=f}}catch(r){console.warn("[credits] loadCreditsCard failed:",r),e.style.display="none",o&&(o.textContent="—")}}window.loadCreditsCard=Ii;document.addEventListener("DOMContentLoaded",function(){(location.hash||"").replace(/^#\//,"")==="dashboard"&&setTimeout(ps,500)});typeof window.subscribeI18n=="function"&&window.subscribeI18n("dashboard",function(){(location.hash||"").replace(/^#\//,"")==="dashboard"&&ps()});function ne(e){return(typeof window.t=="function"?window.t(e):null)||e}function us(){return localStorage.getItem("mrpilot_token")||""}function Q(e){return document.getElementById(e)}var qn=null,pn=null;function Bi(){pn||(pn=setInterval(function(){if(!document.hidden){var e=us();e&&(window._userInfo&&window._userInfo.is_billing_exempt||fetch("/api/me/credits",{headers:{Authorization:"Bearer "+e},cache:"no-store"}).then(function(n){return n.ok?n.json():null}).then(function(n){if(n){var a=n.balance_thb!=null?Number(n.balance_thb):0;qn!==null&&a>qn&&(window.showToast&&window.showToast(ne("credits-updated"),"success"),typeof window.loadDashboard=="function"&&window.loadDashboard(),typeof window._refreshBalanceAlerts=="function"&&window._refreshBalanceAlerts()),qn=a}}).catch(function(){}))}},3e4))}function uc(){pn&&(clearInterval(pn),pn=null),qn=null}window._startCreditsPoll=Bi;window._stopCreditsPoll=uc;Bi();var ms=null,fs=0;function mc(){if(!Q("topup-v2-ov")){var e=document.createElement("div");e.id="topup-v2-ov",e.className="topup-v2-ov",e.style.cssText="display:none;position:fixed;inset:0;background:rgba(15,23,42,.5);z-index:9500;align-items:center;justify-content:center;padding:16px",e.innerHTML=['<div class="topup-v2-box">','  <div class="topup-v2-head">','    <div class="topup-v2-title" id="tv2-title"></div>','    <button class="topup-v2-close" id="tv2-close" aria-label="close">','      <svg viewBox="0 0 20 20" width="16" height="16" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"><line x1="4" y1="4" x2="16" y2="16"/><line x1="16" y1="4" x2="4" y2="16"/></svg>',"    </button>","  </div>",'  <div class="topup-v2-steps">','    <div class="topup-v2-step" id="tv2-d1"><span class="topup-v2-dot">1</span><span class="topup-v2-slabel" id="tv2-sl1"></span></div>','    <div class="topup-v2-line"></div>','    <div class="topup-v2-step" id="tv2-d2"><span class="topup-v2-dot">2</span><span class="topup-v2-slabel" id="tv2-sl2"></span></div>','    <div class="topup-v2-line"></div>','    <div class="topup-v2-step" id="tv2-d3"><span class="topup-v2-dot">3</span><span class="topup-v2-slabel" id="tv2-sl3"></span></div>',"  </div>",'  <div class="topup-v2-body">','    <div id="tv2-s1">','      <label class="topup-v2-label" id="tv2-al"></label>','      <div class="topup-v2-qamts">','        <button class="topup-v2-qamt" data-val="100">฿100</button>','        <button class="topup-v2-qamt" data-val="500">฿500</button>','        <button class="topup-v2-qamt" data-val="1000">฿1,000</button>','        <button class="topup-v2-qamt" data-val="2000">฿2,000</button>',"      </div>",'      <input id="tv2-amt" type="number" min="10" step="1" class="topup-v2-input" placeholder="฿ ...">','      <div id="tv2-ae" class="topup-v2-err" style="display:none"></div>',"    </div>",'    <div id="tv2-s2" style="display:none">','      <p class="topup-v2-bank-label" id="tv2-bl"></p>','      <div class="topup-v2-bank-card">','        <div class="topup-v2-bank-name">ธนาคาร กรุงเทพ</div>','        <div class="topup-v2-bank-branch">สาขาโชคชัย 4 ลาดพร้าว</div>','        <div class="topup-v2-bank-acct">230-0-91368-4</div>','        <div class="topup-v2-bank-holder">บจ. มิสเตอร์ อี อาร์ พี</div>','        <button class="topup-v2-copy" id="tv2-copy"></button>',"      </div>",'      <div class="topup-v2-warn" id="tv2-bn"></div>',"    </div>",'    <div id="tv2-s3" style="display:none">','      <div class="topup-v2-drop" id="tv2-drop">','        <input type="file" id="tv2-file" accept="image/*,.pdf" style="display:none">','        <svg viewBox="0 0 24 24" width="28" height="28" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M21 15v4a2 2 0 01-2 2H5a2 2 0 01-2-2v-4"/><polyline points="17 8 12 3 7 8"/><line x1="12" y1="3" x2="12" y2="15"/></svg>','        <span class="topup-v2-drop-text" id="tv2-dt"></span>',"      </div>",'      <div id="tv2-se" class="topup-v2-err" style="display:none"></div>','      <label class="topup-v2-label" id="tv2-pl"></label>','      <input id="tv2-payer" type="text" maxlength="200" class="topup-v2-input">','      <label class="topup-v2-label" id="tv2-nl"></label>','      <input id="tv2-note" type="text" maxlength="500" class="topup-v2-input">','      <div id="tv2-ue" class="topup-v2-err" style="display:none"></div>',"    </div>","  </div>",'  <div class="topup-v2-foot">','    <button class="btn btn-ghost" id="tv2-back" style="display:none"></button>','    <button class="btn btn-primary" id="tv2-next"></button>',"  </div>","</div>"].join(""),document.body.appendChild(e),fc()}}function Li(){var e=function(n,a){var s=Q(n);s&&(s.textContent=a)};e("tv2-title",ne("topup-title")),e("tv2-sl1",ne("topup-step1")),e("tv2-sl2",ne("topup-step2")),e("tv2-sl3",ne("topup-step3")),e("tv2-al",ne("topup-amount-label")),e("tv2-bl",ne("topup-bank-label")),e("tv2-copy",ne("topup-copy-account")),e("tv2-dt",ne("topup-slip-drop")),e("tv2-pl",ne("topup-payer-label")),e("tv2-nl",ne("topup-note-label"))}function yn(e){[1,2,3].forEach(function(o){var i=Q("tv2-s"+o);i&&(i.style.display=o===e?"":"none");var r=Q("tv2-d"+o);r&&r.classList.toggle("active",o<=e)});var n=Q("tv2-back"),a=Q("tv2-next");if(e===1?n&&(n.style.display="",n.textContent=ne("topup-btn-cancel")):n&&(n.style.display="",n.textContent=ne("topup-btn-back")),a&&(a.textContent=ne(e===3?"topup-btn-submit":"topup-btn-next")),e===2){var s=Q("tv2-bn");s&&(s.innerHTML=ne("topup-bank-note").replace("{amount}","<strong>฿"+Number(fs).toLocaleString()+"</strong>"))}}function za(){for(var e=1;e<=3;e++){var n=Q("tv2-s"+e);if(n&&n.style.display!=="none")return e}return 1}function Kn(e){var n=Q(e);n&&(n.textContent="",n.style.display="none")}function un(e,n){var a=Q(e);a&&(a.textContent=n,a.style.display="")}function eo(e){var n=Q("tv2-dt");n&&(n.textContent=e.name);var a=Q("tv2-drop");a&&a.classList.add("has-file"),Kn("tv2-se")}function fc(){var e=Q("topup-v2-ov");Q("tv2-close").addEventListener("click",on),e.addEventListener("click",function(i){i.target===e&&on()}),document.addEventListener("keydown",function(i){i.key==="Escape"&&e&&e.style.display!=="none"&&on()}),e.addEventListener("click",function(i){var r=i.target.closest(".topup-v2-qamt");if(r){e.querySelectorAll(".topup-v2-qamt").forEach(function(m){m.classList.remove("active")}),r.classList.add("active");var l=Q("tv2-amt");l&&(l.value=r.dataset.val,Kn("tv2-ae"))}});var n=Q("tv2-amt");n&&n.addEventListener("input",function(){e.querySelectorAll(".topup-v2-qamt").forEach(function(i){i.classList.remove("active")}),Kn("tv2-ae")});var a=Q("tv2-copy");a&&a.addEventListener("click",function(){navigator.clipboard&&navigator.clipboard.writeText("2300913684").then(function(){var i=a.textContent;a.textContent=ne("topup-copied"),setTimeout(function(){a.textContent=i},1500)})});var s=Q("tv2-drop"),o=Q("tv2-file");s&&(s.addEventListener("click",function(){o&&o.click()}),s.addEventListener("dragover",function(i){i.preventDefault(),s.classList.add("drag-over")}),s.addEventListener("dragleave",function(){s.classList.remove("drag-over")}),s.addEventListener("drop",function(i){i.preventDefault(),s.classList.remove("drag-over");var r=i.dataTransfer&&i.dataTransfer.files[0];r&&eo(r)})),o&&o.addEventListener("change",function(){o.files[0]&&eo(o.files[0])}),Q("tv2-back").addEventListener("click",function(){var i=za();if(i<=1){on();return}yn(i-1)}),Q("tv2-next").addEventListener("click",function(){var i=za();i===1?vc():i===2?yn(3):hc()})}async function vc(){var e=Q("tv2-amt"),n=e?parseFloat(e.value):0;if(!n||n<10){un("tv2-ae",ne("topup-amount-invalid"));return}if(n>5e5){un("tv2-ae",ne("topup-amount-too-large"));return}fs=n;var a=Q("tv2-next");a&&(a.disabled=!0,a.textContent="…");try{var s=await fetch("/api/credits/topup/request",{method:"POST",headers:{"Content-Type":"application/json",Authorization:"Bearer "+us()},body:JSON.stringify({amount_thb:n})});if(!s.ok){var o=await s.text(),i=ne("topup-submit-fail");try{var r=JSON.parse(o),l=r.detail;if(Array.isArray(l)&&l.length){var m=l[0]&&l[0].type||"";m.indexOf("less_than")>=0?i=ne("topup-amount-too-large"):(m.indexOf("greater_than")>=0||m.indexOf("parsing")>=0)&&(i=ne("topup-amount-invalid"))}else typeof l=="string"&&(i=l)}catch{}throw new Error(i)}var d=await s.json();ms=d.request_id,yn(2)}catch(p){un("tv2-ae",p.message||ne("topup-submit-fail"))}finally{a&&(a.disabled=!1,a.textContent=ne("topup-btn-next"))}}async function hc(){var e=Q("tv2-file");if(!e||!e.files||!e.files[0]){un("tv2-se",ne("topup-slip-required"));return}var n=Q("tv2-next");n&&(n.disabled=!0,n.textContent="…");try{var a=new FormData;a.append("file",e.files[0]);var s=Q("tv2-payer"),o=Q("tv2-note");s&&s.value.trim()&&a.append("payer_name",s.value.trim()),o&&o.value.trim()&&a.append("note",o.value.trim());var i=await fetch("/api/credits/topup/upload-slip/"+ms,{method:"POST",headers:{Authorization:"Bearer "+us()},body:a});if(!i.ok)throw new Error(await i.text());var r=await i.json();r.auto_approved?(window.showToast&&window.showToast(ne("topup-auto-approved"),"success"),typeof window.loadDashboard=="function"&&window.loadDashboard()):window.showToast&&window.showToast(ne("topup-pending"),"info"),on()}catch(l){un("tv2-ue",ne("topup-upload-fail")+" · "+l.message),n&&(n.disabled=!1,n.textContent=ne("topup-btn-submit"))}}function on(){var e=Q("topup-v2-ov");e&&(e.style.display="none"),typeof window.loadDashboard=="function"&&window.loadDashboard()}window._openTopupModal=function(){mc(),ms=null,fs=0,["tv2-amt","tv2-payer","tv2-note"].forEach(function(a){var s=Q(a);s&&(s.value="")});var e=Q("tv2-file");e&&(e.value="");var n=Q("tv2-drop");n&&n.classList.remove("has-file","drag-over"),Q("topup-v2-ov").querySelectorAll(".topup-v2-qamt").forEach(function(a){a.classList.remove("active")}),["tv2-ae","tv2-se","tv2-ue"].forEach(function(a){Kn(a)}),Li(),yn(1),Q("topup-v2-ov").style.display="flex"};typeof window.subscribeI18n=="function"&&window.subscribeI18n("topup-v2",function(){var e=Q("topup-v2-ov");e&&e.style.display!=="none"&&e.style.display!==""&&(Li(),yn(za()))});const gc=`
        <div class="page-head">
            <div class="page-head-icon">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
...
[`+_+" / "+w+"]")&&c(h),!1}async function c(h){const g=await d();if(typeof h=="function"&&o()!=="personal"&&g.length===1){l(Number(g[0].id)),h();return}if(typeof window.openWorkspaceChooserUI=="function"){window.openWorkspaceChooserUI({clients:g,active:i(),onPersonal:m,onPick:function(_){l(Number(_)),typeof h=="function"&&h()},emptyHint:g.length?null:s()?a("ws-empty-owner","还没有工作空间。创建一个公司后,上传、对账和 ERP 推送都会归属到该公司。"):a("ws-empty-employee","你还没有可用的工作空间,请联系管理员分配。")});return}if(!g.length){const _=s()?a("ws-empty-owner","还没有工作空间。创建一个公司后,上传、对账和 ERP 推送都会归属到该公司。"):a("ws-empty-employee","你还没有可用的工作空间,请联系管理员分配。");typeof window.showToast=="function"&&window.showToast(_,"info")}}function u(h){const g=h||document.getElementById("workspace-switcher-root");if(!g)return;const _=o(),w=i();let k,x;if(_==="client"&&w!=null){const B=(window._workspaceClientsCache||[]).find(L=>Number(L.id)===Number(w));k=v("building"),x=B?B.name:a("ws-current-label","当前工作空间")}else k=v("user"),x=a("ws-personal","个人事务");g.innerHTML='<button class="ws-ctrl-btn" id="ws-ctrl-btn" type="button">'+k+'<span class="ws-ctrl-label">'+f(x)+"</span></button>";const E=g.querySelector("#ws-ctrl-btn");E&&E.addEventListener("click",()=>c(null))}function f(h){return String(h??"").replace(/[&<>"']/g,function(g){return{"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"}[g]})}function v(h){const g='<svg class="ws-ic" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">';return h==="building"?g+'<rect x="2" y="7" width="20" height="14" rx="2"/><path d="M16 21V5a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v16"/></svg>':g+'<path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/></svg>'}function y(h){h=h||{};const g=h.clients||[],_=h.active,w=document.getElementById("ws-modal");w&&w.remove();const k=document.createElement("div");k.id="ws-modal",k.className="ws-modal";const E='<button type="button" class="ws-modal-item'+(o()==="personal"||_==null?" active":"")+'" data-ws-personal="1"><span class="ws-modal-item-ic">'+v("user")+'</span><span class="ws-modal-item-text" style="display:flex;flex-direction:column;align-items:flex-start;min-width:0;"><span class="ws-modal-item-name">'+f(a("ws-personal","个人事务"))+'</span><span class="ws-modal-item-desc" style="font-size:11px;color:#6b7280;font-weight:400;margin-top:2px;line-height:1.35;white-space:normal;">'+f(a("ws-personal-desc","用于临时识别、测试或处理不归属任何公司的文件。"))+"</span></span></button>";let I="";if(g.length){const M=['<option value="">'+f(a("ws-select-ph","— 选择账套主体 —"))+"</option>"].concat(g.map(function(F){const G=_!=null&&Number(_)===Number(F.id);return'<option value="'+f(F.id)+'"'+(G?" selected":"")+">"+f(F.name||"#"+F.id)+"</option>"}));I='<div class="ws-modal-item ws-modal-item-account"><span class="ws-modal-item-ic">'+v("building")+'</span><span class="ws-modal-item-text" style="display:flex;flex-direction:column;align-items:flex-start;min-width:0;flex:1;"><span class="ws-modal-item-name">'+f(a("ws-select-label","账套主体"))+'</span><select class="ws-modal-select" data-ws-select="1" style="margin-top:6px;width:100%;">'+M.join("")+"</select></span></div>"}const B=!g.length&&h.emptyHint?'<div class="ws-modal-empty">'+f(h.emptyHint)+"</div>":"",L='<div class="ws-modal-hint" style="font-size:12px;color:#6b7280;padding:10px 4px 2px;line-height:1.5;white-space:normal;">'+f(a("ws-add-hint","如需新增账套主体,请前往「客户管理」添加"))+"</div>";k.innerHTML='<div class="ws-modal-box" role="dialog" aria-modal="true"><div class="ws-modal-head"><span class="ws-modal-title">'+f(a("ws-chooser-title","选择工作空间"))+'</span><button type="button" class="ws-modal-close" data-ws-close="1" aria-label="close">✕</button></div><div class="ws-modal-subtitle" style="font-size:12px;color:#6b7280;padding:2px 4px 12px;line-height:1.45;white-space:normal;">'+f(a("ws-chooser-subtitle","账套主体 = 你的公司(发票卖方/开票方)。选择正在为哪家公司做账。"))+'</div><div class="ws-modal-list">'+E+I+"</div>"+B+L+"</div>",document.body.appendChild(k);const $=k.querySelector("[data-ws-select]");$&&$.addEventListener("change",function(){const M=$.value;M&&(typeof h.onPick=="function"&&h.onPick(M),S(),u())});function S(){k.remove()}k.addEventListener("click",function(M){if(M.target===k||M.target.closest("[data-ws-close]")){S();return}if(M.target.closest("[data-ws-personal]")){typeof h.onPersonal=="function"&&h.onPersonal(),S(),u();return}const G=M.target.closest("[data-ws-pick]");if(G){const se=G.getAttribute("data-ws-pick");typeof h.onPick=="function"&&h.onPick(se),S(),u();return}})}window.openWorkspaceChooserUI=y,window.addEventListener("pearnly:workspace-changed",function(){u()}),window.getWorkMode=o,window.getActiveWorkspaceClientId=i,window.setActiveWorkspaceClientId=l,window.enterPersonalMode=m,window.requireWorkspace=p,window.openWorkspaceChooser=c,window.renderWorkspaceControl=u,window.fetchWorkspaceClients=d;function b(){try{if(sessionStorage.getItem("pearnly_ws_login_prompted")==="1"||i()!=null||localStorage.getItem(n)==="personal")return;sessionStorage.setItem("pearnly_ws_login_prompted","1"),setTimeout(function(){c(null)},800)}catch{}}d().then(h=>{window._workspaceClientsCache=h,u(),b()}),typeof window.subscribeI18n=="function"&&window.subscribeI18n("workspace-switcher",u)})();(function(){const e=w=>document.querySelector('[data-num-target="'+w+'"]');function n(w){if(!w)return t("reconcile-last-activity-none");try{const k=new Date(w),x=new Date,E=x-k;if(E/6e4<5)return t("reconcile-last-activity-just-now");if(k.toDateString()===x.toDateString())return t("reconcile-last-activity-today");const B=Math.max(1,Math.floor(E/(24*3600*1e3)));return t("reconcile-last-activity-days-ago").replace("{n}",B)}catch{return t("reconcile-last-activity-none")}}function a(w,k,x){const E=e(w);E&&(E.textContent=x?"-":String(k),E.classList.toggle("is-empty",!!x))}function s(w){const k=document.getElementById("reconcile-error");k&&(k.style.display=w?"flex":"none")}function o(w){const k=document.getElementById("reconcile-empty");k&&(k.style.display=w?"flex":"none")}function i(w,k){const x=document.getElementById("reconcile-last-activity");x&&(x.textContent=w,x.classList.toggle("has-data",!!k))}function r(w){const k=!w||(w.total_sessions||0)===0;a("pending",w.pending||0,k),a("matched",w.matched||0,k),a("unmatched",w.unmatched||0,k),i(n(w.last_activity_at),!!w.last_activity_at),s(!1),o(k)}function l(w){const k=w.toUpperCase();return k==="KBANK"?"bank-chip-kbank":k==="SCB"?"bank-chip-scb":k==="BBL"?"bank-chip-bbl":k==="KTB"?"bank-chip-ktb":k==="TTB"?"bank-chip-ttb":"bank-chip-other"}function m(w,k){const x=E=>E?String(E).slice(0,10):"?";return!w&&!k?"":x(w)+" ~ "+x(k)}function d(w){return w==null?"":String(w).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function p(w){const k=document.getElementById("reconcile-recent"),x=document.getElementById("reconcile-recent-list");if(!k||!x)return;const E=(w||[]).slice(0,20);if(E.length===0){k.style.display="none";return}k.style.display="",o(!1),x.innerHTML=E.map(I=>{const B=I.parse_status==="parse_failed",L=I.bank_code||"OTHER",$=I.account_last4?" ···"+d(I.account_last4):"",S=m(I.period_start,I.period_end),M=d(I.source_filename||""),F=Number(I.tx_count||0),G=B?'<span class="recon-card-fail" data-i18n="reconcile-card-parse-failed">'+t("reconcile-card-parse-failed")+"</span>":'<span class="recon-card-tx">'+t("reconcile-card-tx").replace("{n}",F)+"</span>";return'<div class="recon-card" data-session-id="'+d(I.id)+'" data-session-name="'+M+'"><span class="bank-chip '+l(L)+'">'+d(L)+'</span><div class="recon-card-main"><div class="recon-card-title">'+M+$+'</div><div class="recon-card-sub">'+d(S)+'</div></div><div class="recon-card-right">'+G+'</div><button class="recon-card-trash" data-trash="'+d(I.id)+'" title="'+d(t("bank-session-delete-tip")||"删除")+'"><svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"><path d="M3 5h10M6 5V3h4v2M5 5l1 9h4l1-9"/></svg></button><svg class="recon-card-arrow" viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M6 4l4 4-4 4"/></svg></div>'}).join(""),x.querySelectorAll(".recon-card").forEach(I=>{I.addEventListener("click",B=>{B.target.closest(".recon-card-trash")||(I.dataset.sessionId,c())})}),x.querySelectorAll(".recon-card-trash").forEach(I=>{I.addEventListener("click",B=>{B.stopPropagation();const L=I.dataset.trash,$=I.closest(".recon-card"),S=$&&$.dataset.sessionName||"";typeof window._deleteBankSession=="function"&&window._deleteBankSession(L,S)})})}function c(w){typeof window.routeTo=="function"&&window.routeTo("reconcile"),setTimeout(function(){const k=document.querySelector('[data-recon-tab="bank"]');k&&k.click()},150)}function u(){s(!0),o(!1)}function f(){typeof window.routeTo=="function"&&window.routeTo("reconcile"),setTimeout(function(){const w=document.querySelector('[data-recon-tab="bank"]');w&&w.click()},150)}async function v(){a("pending",0,!0),a("matched",0,!0),a("unmatched",0,!0),i("",!1),s(!1),o(!1);const w=document.getElementById("reconcile-recent");w&&(w.style.display="none");const k={Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||"")};try{const[x,E]=await Promise.all([fetch("/api/bank-recon/stats",{headers:k}),fetch("/api/bank-recon/sessions?limit=20",{headers:k})]);if(!x.ok)throw new Error("http "+x.status);const I=await x.json(),B=E.ok?await E.json():[];r(I||{}),p(B||[])}catch(x){console.warn("[reconcile] load failed",x),u()}}function y(w){if(!w||!w.length)return;const k="Bearer "+(localStorage.getItem("mrpilot_token")||"");let x=0;const E=w.length;Array.from(w).forEach(function(I){const B=new FormData;B.append("file",I,I.name);const L=new XMLHttpRequest;L.open("POST","/api/bank-recon/upload"),L.setRequestHeader("Authorization",k),L.onload=function(){x++;try{const $=JSON.parse(L.responseText);L.status===200&&$.tx_count!==void 0?showToast((t("bank-upload-ok")||"解析成功 · 共 {n} 条流水").replace("{n}",$.tx_count),"success"):showToast(I.name+" "+(t("upload-failed")||"上传失败"),"error")}catch{showToast(I.name+" "+(t("upload-failed")||"上传失败"),"error")}x===E&&setTimeout(v,600)},L.onerror=function(){x++,showToast(I.name+" "+(t("upload-failed")||"上传失败"),"error"),x===E&&setTimeout(v,600)},L.send(B)}),showToast((t("bank-queue-status-uploading")||"上传中")+"…","info")}function b(){if(window.__reconcileBound)return;window.__reconcileBound=!0;const w=document.getElementById("reconcile-bank-file-input");w&&w.addEventListener("change",function(){y(this.files),this.value=""}),document.addEventListener("click",k=>{if(k.target.closest("#btn-reconcile-upload-top")||k.target.closest("#btn-reconcile-upload-empty")){f();return}if(k.target.closest("#btn-reconcile-retry")){v();return}if(k.target.closest("#btn-reconcile-dev-seed")){_();return}})}const h=["468b50c1-5593-4fd6-990d-515ce8085563"];function g(){const w=document.getElementById("btn-reconcile-dev-seed");if(!w)return;const k=typeof _userInfo<"u"?_userInfo:null,x=k&&k.id&&h.indexOf(String(k.id))>=0;w.style.display=x?"":"none"}async function _(){try{const w=await fetch("/api/bank-recon/_dev/seed",{method:"POST",headers:{Authorization:"Bearer "+token}});if(!w.ok)throw new Error("seed:"+w.status);const k=await w.json(),x=(t("reconcile-dev-seed-ok")||"").replace("{n}",k.tx_count||0);showToast(x,"success"),typeof window.navigateTo=="function"?window.navigateTo("automation"):location.hash="#/automation",setTimeout(()=>{const E=document.querySelector('[data-auto-tab="bank"]');E&&E.click(),k.session_id&&typeof window._openBankSession=="function"&&window._openBankSession(k.session_id)},300)}catch(w){console.warn("[reconcile] dev seed failed",w),showToast(t("reconcile-dev-seed-fail")||"Seed failed","error")}}window.loadReconcilePage=async function(){b(),g(),typeof window._bankReconV2Init=="function"&&window._bankReconV2Init();try{await v()}catch{}},window._rerenderReconcile=function(){typeof currentRoute=="string"&&currentRoute==="reconcile"&&v().catch(()=>{})},typeof window.subscribeI18n=="function"&&window.subscribeI18n("reconcile",window._rerenderReconcile)})();(function(){const e=document.getElementById("assign-clients-modal");if(!(!e||e.dataset.wbInjected==="1")){e.innerHTML=`
    <div class="modal" style="max-width:480px">
        ...
        <div class="modal-foot">
    ...
    </div>`,e.dataset.wbInjected="1";try{const n=window._currentLang||localStorage.getItem("mrpilot_lang")||"th",a=window.I18N;a&&a[n]&&e.querySelectorAll("[data-i18n]").forEach(s=>{const o=s.getAttribute("data-i18n");o&&a[n][o]&&(s.textContent=a[n][o])})}catch{}}})();(function(){let e={employeeId:null,employeeName:"",clients:[],selected:new Set,opened:!1};function n(){return document.getElementById("assign-clients-modal")}function a(){return document.getElementById("assign-clients-list")}function s(){return document.getElementById("assign-select-all")}function o(){return document.getElementById("assign-selected-count")}function i(){return document.getElementById("assign-modal-target")}function r(){const v=a();if(v){if(!e.clients.length){v.innerHTML='<div class="assign-empty">'+escapeHtml(t("assign-no-clients")||"暂无客户 · 请先到「客户管理」添加")+"</div>";return}v.innerHTML=e.clients.map(y=>{const b=String(y.id),h=e.selected.has(b)?"checked":"",g=escapeHtml(y.name||y.label||"#"+b),_=y.code?'<span class="assign-row-code">'+escapeHtml(y.code)+"</span>":"";return'<label class="assign-row"><input type="checkbox" data-cid="'+escapeHtml(b)+'" '+h+'><span class="assign-row-name">'+g+"</span>"+_+"</label>"}).join(""),l()}}function l(){const v=o();if(v){const b=t("assign-selected-count")||"已选 {n} / {total}";v.textContent=b.replace("{n}",e.selected.size).replace("{total}",e.clients.length)}const y=s();y&&(y.checked=e.clients.length>0&&e.selected.size===e.clients.length)}function m(){const v=i();v&&(v.textContent=e.employeeName?" · "+e.employeeName:"")}async function d(v,y){e.employeeId=v,e.employeeName=y||"",e.opened=!0,e.selected=new Set,e.clients=[],m();const b=a();b&&(b.innerHTML='<div class="assign-empty">'+escapeHtml(t("assign-loading")||"加载中...")+"</div>");const h=n();h&&(h.style.display="flex");try{const[g,_]=await Promise.all([apiGet("/api/clients?include_inactive=false"),apiGet("/api/team/employees/"+encodeURIComponent(v)+"/assignments")]);e.clients=g&&g.clients||[];const w=_&&_.client_ids||[];e.selected=new Set(w.map(String)),r()}catch(g){console.error("[assign-clients] load failed",g);const _=a();_&&(_.innerHTML='<div class="assign-empty">'+escapeHtml(t("assign-load-failed")||"加载失败 · 请重试")+"</div>")}}function p(){e.opened=!1;const v=n();v&&(v.style.display="none")}async function c(){if(!e.employeeId)return;const v=Array.from(e.selected).map(b=>parseInt(b,10)).filter(b=>!isNaN(b)),y=document.getElementById("assign-modal-save");y&&(y.disabled=!0);try{const b=await apiPost("/api/team/employees/"+encodeURIComponent(e.employeeId)+"/assignments",{client_ids:v});b&&b.ok!==!1?(showToast((t("assign-saved")||"已保存 {n} 个客户分配").replace("{n}",v.length),"success"),p(),typeof loadTeamList=="function"&&loadTeamList()):showToast(t("assign-save-failed")||"保存失败","error")}catch(b){console.error("[assign-clients] save failed",b),showToast(t("assign-save-failed")||"保存失败","error")}finally{y&&(y.disabled=!1)}}function u(){const v=n();if(!v||v.dataset.bound==="1")return;v.dataset.bound="1";const y=document.getElementById("assign-modal-close");y&&y.addEventListener("click",p);const b=document.getElementById("assign-modal-cancel");b&&b.addEventListener("click",p);const h=document.getElementById("assign-modal-save");h&&h.addEventListener("click",c),v.addEventListener("click",function(w){w.target===v&&p()});const g=s();g&&g.addEventListener("change",function(){g.checked?e.selected=new Set(e.clients.map(w=>String(w.id))):e.selected=new Set,r()});const _=a();_&&_.addEventListener("change",function(w){const k=w.target.closest('input[type="checkbox"][data-cid]');if(!k)return;const x=k.dataset.cid;k.checked?e.selected.add(x):e.selected.delete(x),l()})}function f(){e.opened&&(m(),r())}typeof window.subscribeI18n=="function"&&window.subscribeI18n("assign-clients-modal",f),window.openAssignClientsModal=function(v,y){u(),d(v,y)}})();(function(){const e={page:1,per_page:50,q:"",total:0,rows:[],loaded:!1};function n(p){if(!p)return"";try{return new Date(p).toLocaleString()}catch{return p}}function a(p){const c=document.getElementById("access-log-table");c&&(c.innerHTML='<div class="access-log-empty">'+escapeHtml(p)+"</div>");const u=document.getElementById("access-log-pager");u&&(u.innerHTML="")}function s(){const p=document.getElementById("access-log-table");if(!p)return;const c=e.rows||[];if(!c.length){a(t("set-access-log-empty"));return}const u=`
            <div class="access-log-row access-log-head">
                ...
                </div>`}).join("");p.innerHTML=u+f}function o(){const p=document.getElementById("access-log-pager");if(!p)return;const c=e.total||0;if(!c){p.innerHTML="";return}const u=e.page||1,f=e.per_page,v=Math.max(1,Math.ceil(c/f)),y=(t("set-access-log-pager-total")||"Total {n}").replace("{n}",c),b=(t("set-access-log-pager-page")||"Page {p} / {t}").replace("{p}",u).replace("{t}",v);p.innerHTML=`
            ...
            </div>`}async function i(p){const c=localStorage.getItem("mrpilot_token");if(c){e.page=p||1,a(t("set-access-log-loading"));try{const u="/api/me/access_log?page="+e.page+"&per_page="+e.per_page+"&q="+encodeURIComponent(e.q||""),f=await fetch(u,{headers:{Authorization:"Bearer "+c}});if(f.status===403){a(t("set-access-log-empty"));return}if(!f.ok)throw new Error("http_"+f.status);const v=await f.json();e.rows=v.logs||[],e.total=v.total||0,e.loaded=!0,s(),o()}catch{a(t("set-access-log-fail"))}}}async function r(){const p=localStorage.getItem("mrpilot_token");if(p)try{const c="/api/me/access_log.csv?q="+encodeURIComponent(e.q||""),u=await fetch(c,{headers:{Authorization:"Bearer "+p}});if(!u.ok){showToast(t("set-access-log-csv-fail")||"Export failed","error");return}const f=await u.blob(),v=document.createElement("a"),y=URL.createObjectURL(f);v.href=y,v.download="pearnly_access_log.csv",document.body.appendChild(v),v.click(),setTimeout(function(){URL.revokeObjectURL(y),v.remove()},100),showToast(t("set-access-log-csv-ok")||"Exported","success")}catch{showToast(t("set-access-log-csv-fail")||"Export failed","error")}}function l(){const p=document.querySelectorAll(".set-tab-owner-only"),c=!!(_userInfo&&(_userInfo.role==="owner"||_userInfo.is_super_admin));p.forEach(function(u){u.style.display=c?"":"none"})}document.addEventListener("click",function(p){if(p.target.closest('.settings-tab[data-tab="access-log"]')){setTimeout(function(){(!e.loaded||e.page!==1)&&i(1)},50);return}if(p.target.closest("#access-log-csv-btn")){p.preventDefault(),r();return}const f=p.target.closest(".access-log-pager-btn[data-access-log-page]");if(f&&!f.disabled){const v=parseInt(f.dataset.accessLogPage,10);i(v)}}),document.addEventListener("input",function(p){p.target&&p.target.id==="access-log-search"&&(clearTimeout(window.__accessLogSearchTimer),window.__accessLogSearchTimer=setTimeout(function(){e.q=(p.target.value||"").trim(),i(1)},350))});let m=0;const d=setInterval(function(){m++,_userInfo&&(l(),clearInterval(d)),m>60&&clearInterval(d)},500);typeof window.subscribeI18n=="function"&&window.subscribeI18n("me-access-log",function(){l(),e.loaded&&(s(),o())})})();(function(){const e=document.getElementById("notif-new-modal");if(!(!e||e.dataset.wbInjected==="1")){e.innerHTML=`
...
`,e.dataset.wbInjected="1";try{const n=window._currentLang||localStorage.getItem("mrpilot_lang")||"th",a=window.I18N;a&&a[n]&&(e.querySelectorAll("[data-i18n]").forEach(s=>{const o=s.getAttribute("data-i18n");o&&a[n][o]&&(s.textContent=a[n][o])}),e.querySelectorAll("[data-i18n-placeholder]").forEach(s=>{const o=s.getAttribute("data-i18n-placeholder");o&&a[n][o]&&(s.placeholder=a[n][o])}))}catch{}}})();(function(){const e=document.getElementById("archive-token-modal");if(!(!e||e.dataset.wbInjected==="1")){e.innerHTML=`
        ...
        `;p.innerHTML=c+u}function r(d){return d==null?"":String(d).replace(/[&<>"']/g,p=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[p])}function l(d){const p=new Date,c=p.getFullYear(),u=p.getMonth()+1;if(d==="all")return"all";if(d==="this-month")return`${c}-${String(u).padStart(2,"0")}`;if(d==="last-month"){const f=new Date(c,u-2,1);return`${f.getFullYear()}-${String(f.getMonth()+1).padStart(2,"0")}`}return d==="this-year"?`${c}`:d==="this-quarter"?`${c}-Q${Math.floor((u-1)/3)+1}`:"all"}window.openReportModal=async function(d){d=d||{},n(),typeof applyLang=="function"?applyLang(currentLang):document.querySelectorAll("#report-modal [data-i18n]").forEach(y=>{const b=y.getAttribute("data-i18n");I18N[currentLang]&&I18N[currentLang][b]&&(y.textContent=I18N[currentLang][b])});const p=document.getElementById("report-period-section");p&&(p.style.display=d.mode==="client"?"":"none");const c=document.getElementById("report-tpl-list");c.innerHTML=`<div class="report-tpl-loading">${r(t("report-modal-loading"))}</div>`,document.getElementById("report-modal").style.display="";const u=await o(currentLang,d&&d.mode);i(u),s=d;const f=document.getElementById("report-modal-download"),v=f.cloneNode(!0);f.parentNode.replaceChild(v,f),v.addEventListener("click",()=>m(s))};async function m(d){if(!d)return;const p=document.querySelector('input[name="report-tpl"]:checked');if(!p){showToast(t("report-toast-no-selection"),"info");return}const c=p.value,u=document.querySelector('input[name="report-period"]:checked'),f=u?u.value:"all",v=l(f),y=document.getElementById("report-modal-download"),b=y.innerHTML;y.disabled=!0,y.innerHTML=`<span>${r(t("report-modal-loading"))}</span>`;try{const h=localStorage.getItem("mrpilot_token");let g,_;if(d.mode==="records")g=await fetch("/api/reports/export",{method:"POST",headers:{Authorization:"Bearer "+h,"Content-Type":"application/json"},body:JSON.stringify({template:c,lang:currentLang,records:d.records||[],meta:d.meta||{}})}),_=`mrpilot-${c}-${Date.now()}.xlsx`;else if(d.mode==="client"){const L=`/api/reports/clients/${d.clientId}/export?template=${encodeURIComponent(c)}&lang=${encodeURIComponent(currentLang)}&month=${encodeURIComponent(v)}`;g=await fetch(L,{headers:{Authorization:"Bearer "+h}}),_=`${(d.clientName||"client").replace(/[^a-zA-Z0-9\u0e00-\u0e7f\u4e00-\u9fff]/g,"_").slice(0,40)}-${c}.xlsx`}else if(d.mode==="history-batch")c==="sales_detail_th"?(g=await fetch("/api/ocr/export-by-history-ids",{method:"POST",headers:{Authorization:"Bearer "+h,"Content-Type":"application/json"},body:JSON.stringify({template:"sales_detail_th",lang:currentLang,history_ids:d.historyIds||[],client_id:d.clientId||null})}),_=`Pearnly_SalesDetail_${Date.now()}.xlsx`):(g=await fetch("/api/reports/history/batch_export",{method:"POST",headers:{Authorization:"Bearer "+h,"Content-Type":"application/json"},body:JSON.stringify({template:c,lang:currentLang,history_ids:d.historyIds||[],client_id:d.clientId||null})}),_=`mrpilot-batch-${c}-${Date.now()}.xlsx`);else throw new Error("unknown mode: "+d.mode);if(!g.ok){let L="HTTP "+g.status;try{const $=await g.json();$&&$.detail&&(L=$.detail)}catch($){console.warn("[batch-export] resp.json err.detail parse failed:",$)}g.status===404?showToast(t("report-toast-empty"),"info"):showToast(t("report-toast-fail")+" · "+L,"error");return}const w=await g.blob();let k=_;const E=(g.headers.get("Content-Disposition")||"").match(/filename\*=UTF-8''([^;]+)/i);if(E)try{k=decodeURIComponent(E[1])}catch{}const I=URL.createObjectURL(w),B=document.createElement("a");B.href=I,B.download=k,document.body.appendChild(B),B.click(),document.body.removeChild(B),URL.revokeObjectURL(I),showToast(t("report-toast-success"),"success"),a()}catch(h){console.error("doDownload fail",h),showToast(t("report-toast-fail")+" · "+(h.message||""),"error")}finally{y.disabled=!1,y.innerHTML=b}}document.addEventListener("DOMContentLoaded",()=>{const d=document.getElementById("btn-export");if(d){const c=d.cloneNode(!0);d.parentNode.replaceChild(c,d),c.addEventListener("click",()=>{if(typeof _results>"u"||!_results||_results.length===0){showToast(t("report-toast-no-selection"),"info");return}openReportModal({mode:"records",records:_results.map(u=>({filename:u.filename,merged_fields:u.merged_fields||{}}))})})}const p=document.getElementById("history-batch-export");p&&p.addEventListener("click",()=>{if(typeof _historySelected>"u"||_historySelected.size===0){showToast(t("report-toast-no-selection"),"info");return}openReportModal({mode:"history-batch",historyIds:Array.from(_historySelected)})})}),window.openClientExportModal=function(d,p){openReportModal({mode:"client",clientId:d,clientName:p||""})}})();const Bc=/\.(pdf|jpe?g|png|webp)$/i,Lc="mrpilot_folder_watcher",$c=1;let Cn=null;function ma(){return Cn||(Cn=new Promise((e,n)=>{const a=indexedDB.open(Lc,$c);a.onupgradeneeded=s=>{const o=s.target.result;o.objectStoreNames.contains("handles")||o.createObjectStore("handles"),o.objectStoreNames.contains("seen")||o.createObjectStore("seen"),o.objectStoreNames.contains("config")||o.createObjectStore("config")},a.onsuccess=s=>e(s.target.result),a.onerror=s=>n(s.target.error)}),Cn)}function rn(e,n){return ma().then(a=>new Promise((s,o)=>{const r=a.transaction(e,"readonly").objectStore(e).get(n);r.onsuccess=()=>s(r.result),r.onerror=()=>o(r.error)}))}function xt(e,n,a){return ma().then(s=>new Promise((o,i)=>{const r=s.transaction(e,"readwrite");r.objectStore(e).put(a,n),r.oncomplete=()=>o(),r.onerror=()=>i(r.error)}))}function sn(e,n){return ma().then(a=>new Promise((s,o)=>{const i=a.transaction(e,"readwrite");i.objectStore(e).delete(n),i.oncomplete=()=>s(),i.onerror=()=>o(i.error)}))}function so(e){return ma().then(n=>new Promise((a,s)=>{const o=n.transaction(e,"readwrite");o.objectStore(e).clear(),o.oncomplete=()=>a(),o.onerror=()=>s(o.error)}))}async function oo(e){if(!e)return!1;try{const n={mode:"read"};let a=await e.queryPermission(n);return a==="granted"?!0:(a=await e.requestPermission(n),a==="granted")}catch(n){return console.warn("[folder] permission check failed:",n),!1}}async function Sc(e){const n=new FormData;n.append("file",e,e.name),n.append("source","folder");const a=await fetch("/api/ocr/recognize?source=folder",{method:"POST",headers:{Authorization:"Bearer "+token,"X-Source":"folder"},body:n});if(!a.ok){let s="http_"+a.status;try{const o=await a.json();s=o&&o.detail?typeof o.detail=="string"?o.detail:o.detail.code||JSON.stringify(o.detail):s}catch{}throw new Error(s)}return await a.json()}async function Cc(e){try{const a=(await e.getFile()).size;return await new Promise(o=>setTimeout(o,3e3)),(await e.getFile()).size===a&&a>0}catch{return!1}}async function Ci(e,n,a,s){if(s>10)return;let o;try{o=await e.queryPermission({mode:"read"})}catch{o="denied"}if(o==="granted")for await(const i of e.values()){const r=n?`${n}/${i.name}`:i.name;if(i.kind==="file"){if(!Bc.test(i.name))continue;let l;try{l=await i.getFile()}catch{continue}const m=`${r}::${l.size}::${l.lastModified}`;if(await rn("seen",m))continue;a.push({entry:i,file:l,seenKey:m,relPath:r})}else if(i.kind==="directory")try{await Ci(i,r,a,s+1)}catch{}}}(function(){const n=typeof window<"u"&&"showDirectoryPicker"in window;let a=null,s=null,o=60,i=!1,r=!1,l=0,m=0,d=0,p=[],c=null,u=!1;function f(V,O){const Y=document.getElementById("folder-status-summary");Y&&(Y.setAttribute("data-i18n",V),Y.textContent=t(V),Y.className="auto-status-pill"+(O?" "+O:""))}function v(V){["folder-unsupported","folder-empty","folder-active"].forEach(O=>{const Y=document.getElementById(O);Y&&(Y.style.display=O===V?"":"none")})}function y(V){if(!V)return"-";const O=V instanceof Date?V:new Date(V),Y=String(O.getHours()).padStart(2,"0"),de=String(O.getMinutes()).padStart(2,"0"),re=String(O.getSeconds()).padStart(2,"0");return`${Y}:${de}:${re}`}function b(){v("folder-active");const V=document.getElementById("folder-config-path");V&&a&&(V.textContent=a.name||"-");const O=document.getElementById("folder-interval-select");O&&(O.value=String(o)),document.getElementById("folder-stat-last").textContent=c?y(c):"-",document.getElementById("folder-stat-processed").textContent=String(l),document.getElementById("folder-stat-failed").textContent=String(m),document.getElementById("folder-stat-queue").textContent=String(d);const Y=document.getElementById("btn-folder-pause"),de=document.getElementById("btn-folder-resume");Y&&(Y.style.display=i?"none":""),de&&(de.style.display=i?"":"none"),i?f("folder-status-paused","paused"):f("folder-status-running","running");const re=document.getElementById("folder-status-text");re&&(re.setAttribute("data-i18n",i?"folder-status-paused":"folder-status-running"),re.textContent=t(i?"folder-status-paused":"folder-status-running"));const ze=document.getElementById("folder-status-pulse");ze&&(ze.className="folder-status-pulse"+(i?" paused":"")),h()}function h(){const V=document.getElementById("folder-recent-list");if(V){if(p.length===0){V.innerHTML=`<div class="folder-recent-empty">${escapeHtml(t("folder-recent-empty"))}</div>`;return}V.innerHTML=p.slice(0,20).map(O=>{let Y;O.status==="ok"?Y=`<span class="folder-recent-icon ok">${svgIcon("check",12)}</span>`:O.status==="dup"?Y=`<span class="folder-recent-icon dup" title="${escapeHtml(t("folder-recent-dup"))}">${svgIcon("copy",12)}</span>`:O.status==="skip"?Y=`<span class="folder-recent-icon skip" title="${escapeHtml(t("folder-recent-skip"))}">${svgIcon("minus",12)}</span>`:Y=`<span class="folder-recent-icon fail">${svgIcon("alert",12)}</span>`;const de=O.status==="fail"&&O.error?O.error:O.status==="dup"&&O.reason||O.status==="skip"&&O.reason?O.reason:"",re=de?`<div class="folder-recent-err">${escapeHtml(de)}</div>`:"";return`
                <div class="folder-recent-item">
                    ${Y}
                    <div class="folder-recent-body">
                        <div class="folder-recent-name">${escapeHtml(O.name)}</div>
                        ${re}
                    </div>
                    <div class="folder-recent-time">${y(O.time)}</div>
                </div>
            `}).join("")}}function g(V){p.unshift(V),p.length>50&&(p.length=50),xt("config","recent_list",p).catch(()=>{})}async function _(){if(!(r||i||!a)){r=!0;try{if(await a.queryPermission({mode:"read"})!=="granted"){console.warn("[folder] permission lost · stop"),S(),showToast("warn",t("folder-permission-lost"));return}c=new Date;const O=[];await Ci(a,"",O,0),d=O.length,b();for(const Y of O){if(i)break;if(!await Cc(Y.entry)){d=Math.max(0,d-1),b();continue}try{let re;try{re=await Y.entry.getFile()}catch{re=Y.file}const ze=await Sc(re);await xt("seen",Y.seenKey,{name:re.name,relPath:Y.relPath,size:re.size,lastModified:re.lastModified,processed_at:Date.now()});const kt=ze.history_ids||(ze.history_id?[ze.history_id]:[]),ka=ze.duplicate_warnings||[],xa=Y.relPath||re.name;kt.length>0?(l+=kt.length,g({name:xa,status:"ok",time:new Date,history_id:kt[0],count:kt.length}),await xt("config","processed_count",l)):ka.length>0?g({name:xa,status:"dup",time:new Date,reason:t("folder-recent-dup-reason")}):g({name:xa,status:"skip",time:new Date,reason:t("folder-recent-skip-reason")})}catch(re){m++,g({name:Y.relPath||Y.file.name,status:"fail",time:new Date,error:String(re.message||re)}),await xt("config","failed_count",m)}d=Math.max(0,d-1),b()}}catch(V){console.warn("[folder] scan error:",V)}finally{r=!1,b()}}}function w(){s&&clearInterval(s),s=setInterval(_,o*1e3)}function k(){s&&(clearInterval(s),s=null)}function x(V){if(!a||i)return;const O=typeof t=="function"?t("folder-unload-warn"):"Folder watcher running · close anyway?";return V.preventDefault(),V.returnValue=O,O}function E(){window._pearnlyFolderUnloadAttached||(window._pearnlyFolderUnloadAttached=!0,window.addEventListener("beforeunload",x))}function I(){window._pearnlyFolderUnloadAttached&&(window._pearnlyFolderUnloadAttached=!1,window.removeEventListener("beforeunload",x))}function B(){i=!1,w(),E(),b(),_()}function L(){i=!0,k(),I(),b()}function $(){i=!1,w(),E(),b(),_()}function S(){i=!0,k(),I()}async function M(){try{const V=await window.showDirectoryPicker({mode:"read",startIn:"documents"});if(!await oo(V)){showToast("warn",t("folder-permission-denied"));return}a=V,await xt("handles","main",V),l=0,m=0,d=0,p=[],await xt("config","processed_count",0),await xt("config","failed_count",0),await so("seen"),B()}catch(V){V&&V.name!=="AbortError"&&console.warn("[folder] pick failed:",V)}}async function F(){await showConfirm(t("folder-confirm-remove"),{danger:!0})&&(S(),a=null,l=0,m=0,d=0,p=[],await sn("handles","main"),await sn("config","processed_count"),await sn("config","failed_count"),await so("seen"),v("folder-empty"),f("folder-status-empty",""))}async function G(){p=[];try{await sn("config","recent_list")}catch{}h()}async function se(){if(u)return;if(u=!0,!n){v("folder-unsupported"),f("folder-status-unsupported",""),ye();return}ce();let V=null;try{V=await rn("handles","main")}catch{}if(!V){v("folder-empty"),f("folder-status-empty","");return}if(!await oo(V)){v("folder-empty"),f("folder-status-empty",""),await sn("handles","main"),showToast("warn",t("folder-permission-lost-restart"));return}a=V;try{l=await rn("config","processed_count")||0}catch{}try{m=await rn("config","failed_count")||0}catch{}try{const Y=await rn("config","recent_list");Array.isArray(Y)&&(p=Y.map(de=>({...de,time:de.time?new Date(de.time):new Date})))}catch{}B()}function ce(){const V=document.getElementById("btn-folder-pick"),O=document.getElementById("btn-folder-pause"),Y=document.getElementById("btn-folder-resume"),de=document.getElementById("btn-folder-scan-now"),re=document.getElementById("btn-folder-remove"),ze=document.getElementById("btn-folder-clear-recent"),kt=document.getElementById("folder-interval-select");V&&V.addEventListener("click",M),O&&O.addEventListener("click",L),Y&&Y.addEventListener("click",$),de&&de.addEventListener("click",()=>{_()}),re&&re.addEventListener("click",F),ze&&ze.addEventListener("click",G),kt&&kt.addEventListener("change",ka=>{o=parseInt(ka.target.value,10)||60,i||w()}),xe()}function xe(){document.querySelectorAll('[data-auto-panel="folder"] [data-tab-jump]').forEach(V=>{V.dataset.tabJumpBound||(V.dataset.tabJumpBound="1",V.addEventListener("click",O=>{const Y=O.currentTarget.dataset.tabJump;if(Y==="email")typeof switchAutomationTab=="function"&&switchAutomationTab("email");else if(Y==="upload"){const de=document.querySelector('[data-page="recognize"]')||document.querySelector('[data-page="upload"]');de&&de.click()}}))})}function ye(){xe()}window._loadFolderWatcherPanel=se})();function Tc(){try{if(navigator.userAgentData&&Array.isArray(navigator.userAgentData.brands))return navigator.userAgentData.brands.some(n=>/chromium|google chrome|microsoft edge/i.test(n.brand||""))}catch{}const e=navigator.userAgent||"";return!!(/Edg\//.test(e)||/Chrome\//.test(e)&&!/OPR\/|YaBrowser|Opera/.test(e))}function Na(){try{if(Tc()||localStorage.getItem("pearnly_chrome_banner_dismissed")==="1")return;const e=document.getElementById("chrome-only-banner");if(!e)return;const n=e.querySelector('[data-i18n="chrome-banner-msg"]'),a=e.querySelector('[data-i18n="chrome-banner-dismiss"]');n&&typeof t=="function"&&(n.textContent=t("chrome-banner-msg")),a&&typeof t=="function"&&(a.textContent=t("chrome-banner-dismiss")),e.style.display="";const s=document.getElementById("chrome-only-banner-close");s&&!s.dataset.bound&&(s.dataset.bound="1",s.addEventListener("click",()=>{e.style.display="none";try{localStorage.setItem("pearnly_chrome_banner_dismissed","1")}catch{}}))}catch{}}typeof document<"u"&&(document.readyState==="loading"?document.addEventListener("DOMContentLoaded",Na):setTimeout(Na,0));window._refreshChromeBanner=Na;const Mc=`
        <div class="modal">
            <div class="modal-head">
    ...
    `;Be("email-modal",Mc);const z={account:null,presets:null,modalMode:"new",loaded:!1,triggering:!1,autoRefreshTimer:null};function io(e){z.modalMode=e;const n=document.getElementById("email-modal");if(!n)return;const a=document.getElementById("email-preset");a.innerHTML="";const s=z.presets||{},o=["gmail","outlook","yahoo","icloud","qq","163","custom"],i={gmail:"Gmail",outlook:"Outlook / Office365",yahoo:"Yahoo Mail",icloud:"iCloud",qq:"QQ 邮箱",163:"网易 163"};o.forEach(h=>{if(!s[h])return;const g=document.createElement("option");g.value=h,g.textContent=h==="custom"?t("email-preset-custom"):i[h]||h,a.appendChild(g)});const r=document.getElementById("email-modal-title"),l=document.getElementById("email-address"),m=document.getElementById("email-password"),d=document.getElementById("email-imap-host"),p=document.getElementById("email-imap-port"),c=document.getElementById("email-imap-ssl"),u=document.getElementById("email-folder"),f=document.getElementById("email-mark-read"),v=document.getElementById("email-bind-enabled"),y=document.getElementById("email-test-result"),b=document.getElementById("email-adv-details");if(y&&(y.style.display="none",y.textContent=""),e==="edit"&&z.account){r.setAttribute("data-i18n","email-modal-title-edit"),r.textContent=t("email-modal-title-edit"),l.value=z.account.email_address||"",m.value="",m.setAttribute("data-i18n-placeholder","email-field-password-edit-ph"),m.placeholder=t("email-field-password-edit-ph"),d.value=z.account.imap_host||"",p.value=z.account.imap_port||993,c.checked=z.account.imap_use_ssl!==!1,u.value=z.account.folder||"INBOX",f.checked=z.account.mark_as_read!==!1,v.checked=z.account.enabled!==!1;const h=document.getElementById("email-filter-sender"),g=document.getElementById("email-filter-subject");h&&(h.value=z.account.filter_sender||""),g&&(g.value=z.account.filter_subject||""),lo(z.account.interval_min||15),a.value=Ac(z.account.imap_host)||"custom",b&&(b.open=!0)}else{r.setAttribute("data-i18n","email-modal-title-new"),r.textContent=t("email-modal-title-new"),l.value="",m.value="",m.setAttribute("data-i18n-placeholder","email-field-password-ph"),m.placeholder=t("email-field-password-ph"),a.value="gmail",gs("gmail"),u.value="INBOX",f.checked=!0,v.checked=!0;const h=document.getElementById("email-filter-sender"),g=document.getElementById("email-filter-subject");h&&(h.value=""),g&&(g.value=""),lo(15),b&&(b.open=!1)}jc(),n.style.display="flex",setTimeout(()=>l.focus(),60)}function Ba(){const e=document.getElementById("email-modal");e&&(e.style.display="none")}function gs(e){const n=(z.presets||{})[e];if(!n||e==="custom")return;const a=document.getElementById("email-imap-host"),s=document.getElementById("email-imap-port"),o=document.getElementById("email-imap-ssl");a&&(a.value=n.host||""),s&&(s.value=n.port||993),o&&(o.checked=n.ssl!==!1)}const Hc={"gmail.com":"gmail","googlemail.com":"gmail","outlook.com":"outlook","hotmail.com":"outlook","live.com":"outlook","office365.com":"outlook","msn.com":"outlook","yahoo.com":"yahoo","yahoo.co.jp":"yahoo","icloud.com":"icloud","me.com":"icloud","mac.com":"icloud","qq.com":"qq","foxmail.com":"qq","163.com":"163","126.com":"163","yeah.net":"163"};function ro(e){if(!e||!e.includes("@"))return;const n=e.split("@")[1].toLowerCase().trim(),a=Hc[n];if(!a)return;const s=document.getElementById("email-preset");if(!s)return;const o=s.value;o&&o!=="custom"&&o!==""&&o===a||(s.value=a,gs(a))}function Ac(e){if(!e)return null;const n=z.presets||{};for(const a in n)if(a!=="custom"&&n[a]&&n[a].host===e)return a;return null}function Ti(){const e=document.querySelector("#email-interval-options .email-interval-btn.active"),n=e?parseInt(e.dataset.interval,10):15;return{email_address:(document.getElementById("email-address").value||"").trim(),password:document.getElementById("email-password").value||"",imap_host:(document.getElementById("email-imap-host").value||"").trim(),imap_port:parseInt(document.getElementById("email-imap-port").value||"993",10)||993,imap_use_ssl:document.getElementById("email-imap-ssl").checked,folder:(document.getElementById("email-folder").value||"INBOX").trim()||"INBOX",mark_as_read:document.getElementById("email-mark-read").checked,enabled:document.getElementById("email-bind-enabled").checked,interval_min:[5,15,60].includes(n)?n:15,filter_sender:(document.getElementById("email-filter-sender").value||"").trim()||null,filter_subject:(document.getElementById("email-filter-subject").value||"").trim()||null}}function jc(){const e=document.getElementById("email-interval-options");!e||e._bound||(e._bound=!0,e.addEventListener("click",n=>{const a=n.target.closest(".email-interval-btn");a&&(e.querySelectorAll(".email-interval-btn").forEach(s=>s.classList.remove("active")),a.classList.add("active"))}))}function lo(e){const n=[5,15,60].includes(e)?e:15,a=document.getElementById("email-interval-options");a&&a.querySelectorAll(".email-interval-btn").forEach(s=>{s.classList.toggle("active",parseInt(s.dataset.interval,10)===n)})}function $e(e,n){const a=document.getElementById("email-test-result");a&&(a.style.display="",a.textContent=n,a.className="form-test-result "+(e==="ok"?"ok":e==="running"?"running":"fail"))}async function Pc(){const e=Ti();if(!e.email_address){$e("fail",t("email-addr-required"));return}if(!e.password){$e("fail",t("email-password-required"));return}if(!e.imap_host){$e("fail",t("email-host-required"));return}const n=document.getElementById("btn-email-modal-test");n&&(n.disabled=!0),$e("running",t("email-test-running"));try{const a=await fetch("/api/email-ingest/test",{method:"POST",headers:{Authorization:"Bearer "+token,"Content-Type":"application/json"},body:JSON.stringify({email_address:e.email_address,password:e.password,imap_host:e.imap_host,imap_port:e.imap_port,imap_use_ssl:e.imap_use_ssl,folder:e.folder})}),s=await a.json().catch(()=>({}));if(a.ok&&s.success)$e("ok",t("email-test-ok",{folder:e.folder,n:s.folder_count??"?"}));else{const o=s.error_msg||"";o==="auth_failed"||/auth/i.test(o)?$e("fail",t("email-test-auth-fail")):$e("fail",t("email-test-fail",{msg:o||a.status}))}}catch(a){$e("fail",t("email-test-fail",{msg:String(a).slice(0,120)}))}finally{n&&(n.disabled=!1)}}(function(){async function e(){const u=document.getElementById("email-empty"),f=document.getElementById("email-account-card");if(document.getElementById("email-logs-section"),!(!u||!f))try{const v=await fetch("/api/email-ingest/account",{headers:{Authorization:"Bearer "+token}});if(v.status===401){localStorage.removeItem("mrpilot_token");const b=await v.json().catch(()=>({}));if((typeof b.detail=="string"?b.detail:b.detail&&b.detail.code||"")==="auth.session_revoked"){_showSessionRevokedModal();return}window.location.href="/";return}if(!v.ok){a("none");return}const y=await v.json();z.account=y.account||null,z.presets=y.presets||{},z.loaded=!0,n(),z.account&&d()}catch(v){console.error("[email-ingest] load failed",v),a("none")}}function n(){const u=document.getElementById("email-empty"),f=document.getElementById("email-account-card"),v=document.getElementById("email-logs-section");if(!z.account){u.style.display="",f.style.display="none",v&&(v.style.display="none"),a("none");return}u.style.display="none",f.style.display="",v&&(v.style.display="");const y=document.getElementById("email-account-addr"),b=document.getElementById("email-account-host"),h=document.getElementById("email-account-last"),g=document.getElementById("email-last-error"),_=document.getElementById("email-enabled-toggle");if(y&&(y.textContent=z.account.email_address||"-"),b&&(b.textContent=`${z.account.imap_host||"-"}:${z.account.imap_port||993}`),h){const w=z.account.last_fetched_at;if(!w)h.textContent=t("email-last-never");else{const k=s(w),x=!z.account.last_error;h.textContent=x?t("email-last-ok",{time:k}):t("email-last-fail",{time:k})}}g&&(z.account.last_error?(g.style.display="",g.textContent=o(z.account.last_error)):g.style.display="none"),_&&(_.checked=!!z.account.enabled),z.account.enabled?z.account.last_error?a("error"):a("on"):a("off")}function a(u){const f=document.getElementById("email-status-summary");if(!f)return;f.classList.remove("none","ready","active","coming");let v="auto-status-loading";u==="none"?(v="email-status-none",f.classList.add("none")):u==="on"?(v="email-status-on",f.classList.add("active")):u==="off"?(v="email-status-off",f.classList.add("coming")):u==="error"&&(v="email-status-error",f.classList.add("none")),f.setAttribute("data-i18n",v),f.textContent=t(v)}function s(u){if(!u)return"";const f=new Date(u);if(isNaN(f.getTime()))return"";const v=y=>String(y).padStart(2,"0");return`${v(f.getMonth()+1)}-${v(f.getDate())} ${v(f.getHours())}:${v(f.getMinutes())}`}function o(u){if(!u)return"";const f=String(u);return/auth|AUTHENTICATIONFAILED|invalid credentials/i.test(f)?t("email-test-auth-fail"):/timeout|timed out/i.test(f)?t("email.timeout"):(/ENOTFOUND|getaddrinfo/i.test(f),f)}async function i(){const u=Ti();if(!u.email_address){$e("fail",t("email-addr-required"));return}if(z.modalMode==="new"&&!u.password){$e("fail",t("email-password-required"));return}if(!u.imap_host){$e("fail",t("email-host-required"));return}const f=document.getElementById("btn-email-modal-save");f&&(f.disabled=!0);const v={...u};z.modalMode==="edit"&&!v.password&&delete v.password;try{const y=await fetch("/api/email-ingest/account",{method:"PUT",headers:{Authorization:"Bearer "+token,"Content-Type":"application/json"},body:JSON.stringify(v)}),b=await y.json().catch(()=>({}));if(y.ok&&b.ok)z.account=b.account,showToast(t("email-save-ok"),"success"),Ba(),n(),d();else{const g="email."+(b.detail||"").split(".").slice(-1)[0];$e("fail",t(g)!==g?t(g):t("email-save-fail"))}}catch{$e("fail",t("email-save-fail"))}finally{f&&(f.disabled=!1)}}async function r(){if(!(!z.account||!await showConfirm(t("email-unbind-confirm",{email:z.account.email_address}),{danger:!0,okText:t("email-btn-unbind")})))try{if((await fetch("/api/email-ingest/account",{method:"DELETE",headers:{Authorization:"Bearer "+token}})).ok){z.account=null,showToast(t("email-unbind-ok"),"success"),n();const v=document.getElementById("email-logs-list");v&&(v.innerHTML="")}else showToast(t("email-unbind-fail"),"error")}catch{showToast(t("email-unbind-fail"),"error")}}async function l(){if(!z.account||z.triggering)return;if(!z.account.enabled){showToast(t("email.disabled"),"error");return}z.triggering=!0;const u=document.getElementById("btn-email-trigger"),f=u?u.innerHTML:"";u&&(u.disabled=!0,u.innerHTML=`<span>${escapeHtml(t("email-trigger-running"))}</span>`);try{const v=await fetch("/api/email-ingest/trigger",{method:"POST",headers:{Authorization:"Bearer "+token}}),y=await v.json().catch(()=>({}));if(v.ok){const b=y.emails_scanned||0,h=y.ocr_succeeded||0,g=y.ocr_failed||0;b===0&&h===0&&g===0?showToast(t("email-trigger-empty"),"success"):showToast(t("email-trigger-result",{scanned:b,ok:h,fail:g}),g>0?"warn":"success")}else{const h="email."+(y.detail||"").split(".").slice(-1)[0];showToast(t(h)!==h?t(h):t("email-trigger-fail"),"error")}await e()}catch{showToast(t("email-trigger-fail"),"error")}finally{z.triggering=!1,u&&(u.disabled=!1,u.innerHTML=f)}}async function m(){if(!z.account)return;const u=document.getElementById("email-enabled-toggle"),f=!!(u&&u.checked),v=z.account.enabled;try{const y=await fetch("/api/email-ingest/account",{method:"PUT",headers:{Authorization:"Bearer "+token,"Content-Type":"application/json"},body:JSON.stringify({email_address:z.account.email_address,imap_host:z.account.imap_host,imap_port:z.account.imap_port,imap_use_ssl:z.account.imap_use_ssl,folder:z.account.folder||"INBOX",filter_subject:z.account.filter_subject||null,filter_sender:z.account.filter_sender||null,mark_as_read:z.account.mark_as_read!==!1,enabled:f})}),b=await y.json().catch(()=>({}));y.ok&&b.ok?(z.account=b.account,n()):(u&&(u.checked=v),showToast(t("email-toggle-fail"),"error"))}catch{u&&(u.checked=v),showToast(t("email-toggle-fail"),"error")}}async function d(){const u=document.getElementById("email-logs-list");if(u){u.innerHTML=`<div class="erp-logs-empty">${escapeHtml(t("erp-logs-loading"))}</div>`;try{const f=await fetch("/api/email-ingest/logs?limit=20",{headers:{Authorization:"Bearer "+token}});if(!f.ok){u.innerHTML=`<div class="erp-logs-empty">${escapeHtml(t("erp-logs-error"))}</div>`;return}const v=await f.json();if(!Array.isArray(v)||v.length===0){u.innerHTML=`<div class="erp-logs-empty">${escapeHtml(t("email-logs-empty"))}</div>`;return}u.innerHTML=v.map(p).join("")}catch{u.innerHTML=`<div class="erp-logs-empty">${escapeHtml(t("erp-logs-error"))}</div>`}}}function p(u){const f=s(u.created_at),v=u.status||"failed",y=v==="success"?"ok":v==="partial"?"partial":"fail",b=v==="success"?"✓":v==="partial"?"◐":"✗",h=u.trigger==="manual"?`<span class="log-tag manual">${escapeHtml(t("email-log-tag-manual"))}</span>`:`<span class="log-tag auto">${escapeHtml(t("email-log-tag-auto"))}</span>`,g=t("email-log-counts",{scanned:u.emails_scanned||0,att:u.attachments_found||0,ok:u.ocr_succeeded||0,fail:u.ocr_failed||0}),_=(u.elapsed_ms||0)+"ms";return`
        ...
        `}function c(){const u=document.getElementById("btn-email-bind");u&&u.addEventListener("click",()=>io("new"));const f=document.getElementById("btn-email-edit");f&&f.addEventListener("click",()=>io("edit"));const v=document.getElementById("btn-email-unbind");v&&v.addEventListener("click",r);const y=document.getElementById("btn-email-trigger");y&&y.addEventListener("click",l);const b=document.getElementById("email-enabled-toggle");b&&b.addEventListener("change",m);const h=document.getElementById("email-modal-close");h&&h.addEventListener("click",Ba);const g=document.getElementById("btn-email-modal-cancel");g&&g.addEventListener("click",Ba);const _=document.getElementById("btn-email-modal-test");_&&_.addEventListener("click",Pc);const w=document.getElementById("btn-email-modal-save");w&&w.addEventListener("click",i);const k=document.getElementById("email-preset");k&&k.addEventListener("change",I=>gs(I.target.value));const x=document.getElementById("email-address");x&&!x.dataset.autoBound&&(x.dataset.autoBound="1",x.addEventListener("blur",I=>ro((I.target.value||"").trim())),x.addEventListener("input",I=>{const B=(I.target.value||"").trim();B.includes("@")&&B.split("@")[1].includes(".")&&ro(B)}));const E=document.getElementById("btn-email-refresh-logs");E&&E.addEventListener("click",()=>{E.classList.add("spinning"),setTimeout(()=>E.classList.remove("spinning"),600),d()})}c(),window._loadEmailIngestPanel=e,window._rerenderEmailIngest=function(){if(!z.loaded)return;n();const u=document.getElementById("email-logs-section");z.account&&u&&u.open&&d()},window._startEmailLogAutoRefresh=function(){z.autoRefreshTimer||(z.autoRefreshTimer=setInterval(()=>{z.account&&z.loaded&&d()},3e4))},window._stopEmailLogAutoRefresh=function(){z.autoRefreshTimer&&(clearInterval(z.autoRefreshTimer),z.autoRefreshTimer=null)}})();const Dc=`
...
`;Be("bank-cand-drawer",Dc);const qc=`
    <div class="modal" style="max-width: 420px;">
        <div class="modal-head">
...
`;Be("bank-client-picker-modal",qc);const H={sessions:[],currentSession:null,currentTxs:[],currentFilter:"all",currentTxForDrawer:null,loaded:!1,queue:[],qSeq:0,sessionFilter:"all",pickerSelected:null};function Rc(e){const n=Number(e||0);let a="score-low";return n>=85?a="score-high":n>=60&&(a="score-mid"),'<span class="bank-cand-score '+a+'">'+n.toFixed(0)+" "+t("bank-cand-score-unit")+"</span>"}function Fc(e){const n=document.getElementById("bank-upload-progress");n&&(n.style.display="none")}function zc(){const e=document.getElementById("bank-upload-error");e&&(e.style.display="none")}function Nc(e){return{"bank_recon.only_pdf":t("bank-err-only-pdf"),"bank_recon.empty_file":t("bank-err-empty"),"bank_recon.file_too_large":t("bank-err-too-large"),"bank_recon.save_failed":t("bank-err-server"),"bank_recon.scanned":t("bank-err-scanned"),"bank_recon.no_tx":t("bank-err-no-tx"),network:t("bank-err-network")}[e]||t("bank-err-unknown")+" ("+e+")"}function $t(e){if(e==null)return"-";const n=Number(e);return isNaN(n)?"-":n.toLocaleString("en-US",{minimumFractionDigits:2,maximumFractionDigits:2})}function Kt(e){if(!e)return"-";const n=String(e);return n.length>=10?n.slice(0,10):n}function Mi(e,n){return!e&&!n?"":(Kt(e)||"?")+" ~ "+(Kt(n)||"?")}function X(e){return e==null?"":String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}async function Oc(e){H.currentTxForDrawer=e;const n=document.getElementById("bank-detail-body");n&&n.classList.add("has-pane");const a=document.getElementById("bank-cand-pane-title"),s=document.getElementById("bank-cand-pane-sub"),o=document.getElementById("bank-cand-pane-foot");if(a&&(a.textContent=t("bank-cand-pane-current")),s){const r=e.direction==="OUT"?"-":"+",l=e.direction==="OUT"?"bank-out":"bank-in";s.innerHTML=`${X(Kt(e.tx_date))}
            <span style="margin:0 6px;color:#D1D5DB">·</span>
            <span>${X(e.description||"-")}</span>
            <span style="margin:0 6px;color:#D1D5DB">·</span>
            <strong class="${l}">${r}${$t(e.amount)}</strong>`}o&&(o.style.display="");const i=document.getElementById("bank-cand-pane-body");if(i){i.innerHTML=`<div class="bank-empty">${t("bank-cand-loading")}</div>`;try{const r=await fetch("/api/bank-recon/tx/"+encodeURIComponent(e.id)+"/candidates",{headers:{Authorization:"Bearer "+token}});if(!r.ok)throw new Error("cands:"+r.status);const l=await r.json();Uc(e,l.candidates||[])}catch{i.innerHTML=`<div class="bank-empty">${t("bank-cand-load-failed")}</div>`}}}function Vc(e,n,a){const s=n.history_id,o=n.invoice_no||"-",i=n.vendor||"-",r=n.amount_total!==null&&n.amount_total!==void 0?$t(n.amount_total):"-",l=n.invoice_date?Kt(n.invoice_date):"-",m=n.filename||"",d=!!a&&e.matched_history_id===s,p="bank-cand-card"+(n.is_auto_picked?" is-auto":"")+(d?" is-picked":"");let c="";return d?c='<button class="btn btn-ghost btn-small" data-act="unmatch"><span>'+t("bank-cand-unmatch")+"</span></button>":c='<button class="btn btn-primary btn-small" data-act="pick" data-hid="'+X(s)+'"><span>'+t(n.is_auto_picked?"bank-cand-confirm":"bank-cand-pick-this")+"</span></button>",'<div class="'+p+'" data-hid="'+X(s)+'"><div class="bank-cand-card-head"><div class="bank-cand-card-vendor">'+X(i)+"</div>"+Rc(n.score)+'</div><div class="bank-cand-card-fields"><span class="bank-cand-field"><span class="bank-cand-flabel">'+t("bank-cand-fld-invoice-no")+"</span> "+X(o)+'</span><span class="bank-cand-field"><span class="bank-cand-flabel">'+t("bank-cand-fld-amount")+"</span> "+r+'</span><span class="bank-cand-field"><span class="bank-cand-flabel">'+t("bank-cand-fld-date")+"</span> "+X(l)+"</span></div>"+(m?'<div class="bank-cand-card-file" title="'+X(m)+'">'+X(m)+"</div>":"")+(n.reason?'<div class="bank-cand-card-reason">'+X(n.reason)+"</div>":"")+'<div class="bank-cand-card-actions">'+c+"</div></div>"}function Uc(e,n){const a=document.getElementById("bank-cand-pane-body");if(!a)return;const s=n||[];let o="";if(e.match_status==="matched")o='<div class="bank-cand-hint hint-matched">'+t("bank-cand-hint-matched").replace("{n}",s.length)+"</div>";else if(e.match_status==="suggested")o='<div class="bank-cand-hint hint-suggested">'+t("bank-cand-hint-suggested").replace("{n}",s.length)+"</div>";else if(s.length>0)o='<div class="bank-cand-hint hint-low">'+t("bank-cand-hint-low").replace("{n}",s.length)+"</div>";else{a.innerHTML='<div class="bank-empty">'+t("bank-cand-no-match-detail")+"</div>";return}const i=e.match_status==="matched",r=s.map(l=>Vc(e,l,i)).join("");a.innerHTML=o+'<div class="bank-cand-list">'+r+"</div>",a.querySelectorAll('[data-act="pick"]').forEach(l=>{l.addEventListener("click",()=>{Kc(l.dataset.hid)})}),a.querySelectorAll('[data-act="unmatch"]').forEach(l=>{l.addEventListener("click",async()=>{try{await fetch("/api/bank-recon/tx/"+encodeURIComponent(e.id)+"/override",{method:"POST",headers:{Authorization:"Bearer "+token,"Content-Type":"application/json"},body:JSON.stringify({status:"unmatched"})}),wn(),await Zt(H.currentSession.id)}catch{showToast(t("bank-action-failed"),"error")}})})}function wn(){const e=document.getElementById("bank-detail-body");e&&e.classList.remove("has-pane");const n=document.getElementById("bank-cand-pane-title"),a=document.getElementById("bank-cand-pane-sub"),s=document.getElementById("bank-cand-pane-body"),o=document.getElementById("bank-cand-pane-foot");n&&(n.textContent=t("bank-cand-pane-empty-title")),a&&(a.textContent=t("bank-cand-pane-empty-sub")),o&&(o.style.display="none"),s&&(s.innerHTML='<div class="bank-cand-pane-empty"><svg viewBox="0 0 64 64" fill="none" stroke="currentColor" stroke-width="1.4" stroke-linecap="round" stroke-linejoin="round"><rect x="14" y="10" width="36" height="44" rx="3"/><path d="M22 22h20M22 30h20M22 38h12"/></svg><div>'+t("bank-cand-pane-empty-hint")+"</div></div>");const i=document.getElementById("bank-tx-tbody");i&&i.querySelectorAll("tr.is-selected").forEach(r=>r.classList.remove("is-selected")),H.currentTxForDrawer=null}async function Zt(e){try{const n="/api/bank-recon/sessions/"+encodeURIComponent(e)+(H.currentFilter!=="all"?"?filter="+H.currentFilter:""),a=await fetch(n,{headers:{Authorization:"Bearer "+token}});if(!a.ok)throw new Error("detail:"+a.status);const s=await a.json();H.currentSession=s.session,H.currentTxs=s.transactions||[],ed()}catch(n){console.warn("[bank-recon] loadSessionDetail failed",n),showToast(t("bank-load-failed"),"error")}}async function Gc(){if(!H.currentSession)return;const e=document.getElementById("btn-bank-run-match"),n=e.innerHTML;e.disabled=!0,e.innerHTML="<span>"+t("bank-matching")+"</span>";try{const a=await fetch("/api/bank-recon/sessions/"+encodeURIComponent(H.currentSession.id)+"/match",{method:"POST",headers:{Authorization:"Bearer "+token}});if(!a.ok)throw new Error("match:"+a.status);const s=await a.json();showToast(t("bank-match-done").replace("{matched}",s.matched).replace("{suggested}",s.suggested).replace("{unmatched}",s.unmatched),"success"),await Zt(H.currentSession.id),await Qt()}catch(a){console.warn("[bank-recon] match failed",a),showToast(t("bank-match-failed"),"error")}finally{e.disabled=!1,e.innerHTML=n}}async function Wc(){if(!(!H.currentSession||!await showConfirm(t("bank-delete-confirm"),{danger:!0})))try{const n=await fetch("/api/bank-recon/sessions/"+encodeURIComponent(H.currentSession.id),{method:"DELETE",headers:{Authorization:"Bearer "+token}});if(!n.ok)throw new Error("delete:"+n.status);showToast(t("bank-deleted"),"success"),H.currentSession=null,H.currentTxs=[],ws(),await Qt()}catch(n){console.warn("[bank-recon] delete failed",n),showToast(t("bank-delete-failed"),"error")}}async function co(){if(H.currentTxForDrawer)try{const e=await fetch("/api/bank-recon/tx/"+encodeURIComponent(H.currentTxForDrawer.id)+"/override",{method:"POST",headers:{Authorization:"Bearer "+token,"Content-Type":"application/json"},body:JSON.stringify({status:"ignored"})});if(!e.ok)throw new Error("ignore:"+e.status);wn(),await Zt(H.currentSession.id)}catch{showToast(t("bank-action-failed"),"error")}}async function Kc(e){if(H.currentTxForDrawer)try{const n=await fetch("/api/bank-recon/tx/"+encodeURIComponent(H.currentTxForDrawer.id)+"/override",{method:"POST",headers:{Authorization:"Bearer "+token,"Content-Type":"application/json"},body:JSON.stringify({status:"matched",history_id:e})});if(!n.ok)throw new Error("pick:"+n.status);showToast(t("bank-matched-ok"),"success"),wn(),await Zt(H.currentSession.id)}catch{showToast(t("bank-action-failed"),"error")}}function Hi(){if(!H.currentSession)return;const e=H.currentSession;document.getElementById("bank-detail-title").textContent=(e.bank_code||"-")+(e.account_last4?" ···"+e.account_last4:"")+" · "+(e.source_filename||""),document.getElementById("bank-meta-period").textContent=Mi(e.period_start,e.period_end)||"-",document.getElementById("bank-meta-opening").textContent=$t(e.opening_balance),document.getElementById("bank-meta-inflow").textContent="+"+$t(e.total_inflow),document.getElementById("bank-meta-outflow").textContent="-"+$t(e.total_outflow),document.getElementById("bank-meta-closing").textContent=$t(e.closing_balance);const n=H.currentTxs||[],a=n.length;let s=0,o=0,i=0;for(const r of n){const l=r.match_status||"unmatched";l==="matched"?s++:l==="suggested"?o++:i++}document.getElementById("bank-stat-total").textContent=a,document.getElementById("bank-stat-matched").textContent=s,document.getElementById("bank-stat-suggested").textContent=o,document.getElementById("bank-stat-unmatched").textContent=i}function bs(){const e=document.getElementById("bank-tx-tbody");if(!e)return;let n=H.currentTxs||[];if(H.currentFilter!=="all"&&(n=n.filter(a=>H.currentFilter==="matched"?a.match_status==="matched":H.currentFilter==="suggested"?a.match_status==="suggested":H.currentFilter==="unmatched"?a.match_status==="unmatched"||a.match_status==="ignored":!0)),n.length===0){e.innerHTML=`<tr><td colspan="4" class="bank-empty">${t("bank-tx-empty")}</td></tr>`;return}if(e.innerHTML=n.map(a=>Yc(a)).join(""),e.querySelectorAll("tr[data-tx-id]").forEach(a=>{a.addEventListener("click",()=>{const s=a.dataset.txId,o=H.currentTxs.find(i=>i.id===s);o&&(e.querySelectorAll("tr.is-selected").forEach(i=>i.classList.remove("is-selected")),a.classList.add("is-selected"),Oc(o))})}),H.currentTxForDrawer){const a=e.querySelector('tr[data-tx-id="'+H.currentTxForDrawer.id+'"]');a&&a.classList.add("is-selected")}}function Yc(e){const n=e.direction==="OUT",a=n?"-":"+",s=n?"bank-out":"bank-in",o=e.match_status||"unmatched",i=t("bank-match-"+o)||o,r=Kt(e.tx_date),l=e.channel?`<span class="bank-tx-channel">${X(e.channel)}</span>`:"";return`
        <tr data-tx-id="${X(e.id)}">
            <td class="bank-tx-date">${X(r)}</td>
            <td class="bank-tx-desc">${l}${X(e.description||"-")}</td>
            <td class="bank-td-amount ${s}">${a}${$t(e.amount)}</td>
            <td><span class="bank-tx-match mt-${o}">${X(i)}</span></td>
        </tr>
    `}function ys(){const e=document.getElementById("bank-client-badge");if(!e||!H.currentSession)return;const n=H.currentSession.client_id,a=document.getElementById("bank-client-badge-dot"),s=document.getElementById("bank-client-badge-name"),o=document.getElementById("bank-client-badge-caret"),i=typeof _userInfo<"u"?_userInfo:null,r=!(i&&i.role==="member");if(n!=null){const l=(window._clientsCache||[]).find(m=>Number(m.id)===Number(n));e.classList.remove("is-empty"),a&&(a.style.background=l&&l.color||"#111111"),s&&(s.textContent=l&&(l.short_name||l.name)||"#"+n)}else e.classList.add("is-empty"),a&&(a.style.background=""),s&&(s.textContent=t("bank-client-none"));r?(e.classList.remove("is-readonly"),e.disabled=!1,o&&(o.style.display="")):(e.classList.add("is-readonly"),e.disabled=!0,o&&(o.style.display="none")),e.style.display=""}function Jc(){if(!H.currentSession)return;const e=typeof _userInfo<"u"?_userInfo:null;if(!!(e&&e.role==="member"))return;H.pickerSelected=H.currentSession.client_id!=null?Number(H.currentSession.client_id):null,ji();const a=document.getElementById("bank-client-picker-modal");a&&(a.style.display="")}function Ai(){const e=document.getElementById("bank-client-picker-modal");e&&(e.style.display="none"),H.pickerSelected=null}function ji(){const e=document.getElementById("bank-client-picker-list");if(!e)return;const n=(window._clientsCache||[]).filter(s=>s&&(s.is_active===!0||s.is_active===void 0)),a=[];a.push('<div class="bank-client-picker-row is-none'+(H.pickerSelected==null?" is-selected":"")+'" data-cid=""><span class="bank-cp-dot"></span><span>'+X(t("bank-client-picker-none"))+"</span></div>"),n.forEach(s=>{const o=Number(s.id)===Number(H.pickerSelected)?" is-selected":"";a.push('<div class="bank-client-picker-row'+o+'" data-cid="'+X(s.id)+'"><span class="bank-cp-dot" style="background:'+X(s.color||"#111111")+'"></span><span>'+X(s.short_name||s.name||"#"+s.id)+"</span></div>")}),e.innerHTML=a.join(""),e.querySelectorAll(".bank-client-picker-row").forEach(s=>{s.addEventListener("click",()=>{const o=s.dataset.cid;H.pickerSelected=o?Number(o):null,ji()})})}async function Xc(){if(H.currentSession)try{const e=await fetch("/api/bank-recon/sessions/"+encodeURIComponent(H.currentSession.id)+"/client",{method:"PATCH",headers:{Authorization:"Bearer "+token,"Content-Type":"application/json"},body:JSON.stringify({client_id:H.pickerSelected})});if(!e.ok)throw new Error("client:"+e.status);H.currentSession.client_id=H.pickerSelected,ys(),showToast(t("bank-client-changed"),"success"),Ai();try{await Qt()}catch{}}catch(e){console.warn("[bank-recon] save client failed",e),showToast(t("bank-client-change-failed"),"error")}}async function Qt(){try{const e=await fetch("/api/bank-recon/sessions?limit=30",{headers:{Authorization:"Bearer "+token}});if(!e.ok)throw new Error("sessions:"+e.status);H.sessions=await e.json(),Yn()}catch(e){console.warn("[bank-recon] loadSessions failed",e),H.sessions=[],Yn()}}function po(){const e=document.getElementById("bank-status-summary");if(!e)return;if(H.sessions.length===0){e.textContent=t("bank-pill-none");return}let a=0;for(const s of H.sessions)s.parse_status==="parsed"&&(s.unmatched_count||0)>0&&a++;e.textContent=a>0?t("bank-pill-pending").replace("{n}",a):t("bank-pill-ok")}function Yn(){const e=document.getElementById("bank-sessions-list");if(!e)return;let n=H.sessions||[];if(H.sessionFilter==="parsed"?n=n.filter(a=>a.parse_status==="parsed"):H.sessionFilter==="failed"&&(n=n.filter(a=>a.parse_status==="parse_failed")),!H.sessions||H.sessions.length===0){e.innerHTML='<div class="bank-empty" data-i18n="bank-sessions-empty">'+t("bank-sessions-empty")+"</div>";return}if(n.length===0){e.innerHTML='<div class="bank-empty">'+t("bank-sess-filter-empty")+"</div>";return}e.innerHTML=n.map(a=>Zc(a)).join(""),e.querySelectorAll(".bank-session-row").forEach(a=>{a.addEventListener("click",s=>{s.target.closest(".bank-session-trash")||Zt(a.dataset.sessionId)})}),e.querySelectorAll(".bank-session-trash").forEach(a=>{a.addEventListener("click",s=>{s.stopPropagation();const o=a.dataset.sessionId,i=a.dataset.sessionName||"";Pi(o,i)})})}async function Pi(e,n){if(!e)return;const a=(t("bank-session-delete-confirm")||"确定删除这条对账记录吗?").replace("{name}",n||"");if(await showConfirm(a,{danger:!0}))try{const o=await fetch("/api/bank-recon/sessions/"+encodeURIComponent(e),{method:"DELETE",headers:{Authorization:"Bearer "+token}});if(!o.ok)throw new Error("delete:"+o.status);showToast(t("bank-deleted"),"success"),H.currentSession&&H.currentSession.id===e&&(H.currentSession=null,H.currentTxs=[],ws()),await Qt(),typeof window.loadReconcilePage=="function"&&window.loadReconcilePage()}catch(o){console.warn("[bank-recon] delete failed",o),showToast(t("bank-delete-failed"),"error")}}function Zc(e){const n=(e.bank_code||"OTHER").toUpperCase(),a=Mi(e.period_start,e.period_end),s=e.account_last4?"···"+e.account_last4:"",o=Qc(e),i=Kt(e.created_at);return`
    ...
    `}function Qc(e){if(e.parse_status==="parse_failed")return`<span class="bank-session-count cnt-failed">${t("bank-count-parse-failed")}</span>`;if(e.parse_status!=="parsed")return`<span class="bank-session-count">${t("bank-count-parsing")}</span>`;const n=e.tx_count||0,a=e.matched_count||0,s=e.unmatched_count||0,o=[`<span class="bank-session-count">${n} ${t("bank-count-tx")}</span>`];return a>0&&o.push(`<span class="bank-session-count cnt-matched">${a} ${t("bank-count-matched")}</span>`),s>0&&o.push(`<span class="bank-session-count cnt-unmatched">${s} ${t("bank-count-unmatched")}</span>`),o.join("")}function ed(){document.getElementById("bank-detail").style.display="",document.querySelector(".bank-sessions-section").style.display="none",Hi(),bs(),ys()}function ws(){document.getElementById("bank-detail").style.display="none",document.querySelector(".bank-sessions-section").style.display="";const e=document.getElementById("bank-detail-body");e&&e.classList.remove("has-pane"),H.currentTxForDrawer=null}const td=3;function nd(){return H.qSeq+=1,"q"+H.qSeq+"_"+Date.now()}async function ad(e){const n=Array.from(e.target.files||[]);if(e.target.value="",n.length!==0){for(const a of n){const s={id:nd(),file:a,name:a.name,size:a.size,status:"pending",progress:0,error_code:null,tx_count:0,session_id:null};a.name.toLowerCase().endsWith(".pdf")?a.size>20*1024*1024&&(s.status="failed",s.error_code="bank_recon.file_too_large"):(s.status="failed",s.error_code="bank_recon.only_pdf"),H.queue.push(s)}sd(),Ae(),ks()}}function sd(){const e=document.getElementById("bank-upload-queue");e&&(e.style.display=""),Fc(),zc()}function Ae(){const e=document.getElementById("bank-upload-queue-list"),n=document.getElementById("bank-upload-queue-summary");if(!e)return;if(H.queue.length===0){e.innerHTML="",n&&(n.textContent="");const r=document.getElementById("bank-upload-queue");r&&(r.style.display="none");return}let a=0,s=0,o=0,i=0;for(const r of H.queue)r.status==="ok"?a++:r.status==="failed"?s++:r.status==="uploading"||r.status==="parsing"?o++:i++;n&&(n.textContent=t("bank-queue-summary").replace("{ok}",a).replace("{run}",o).replace("{wait}",i).replace("{fail}",s)),e.innerHTML=H.queue.map(od).join(""),e.querySelectorAll("[data-q-act]").forEach(r=>{const l=r.dataset.qAct,m=r.dataset.qId;r.addEventListener("click",()=>{l==="retry"&&id(m),l==="remove"&&rd(m)})})}function od(e){const n=(e.size/1024).toFixed(0)+" KB";let a="",s="";if(e.status==="pending")a='<span class="bq-stat bq-wait">'+t("bank-queue-status-wait")+"</span>",s='<button data-q-act="remove" data-q-id="'+X(e.id)+'" class="bq-act">×</button>';else if(e.status==="uploading")a='<span class="bq-stat bq-run">'+t("bank-queue-status-uploading")+'</span><div class="bq-bar"><div class="bq-bar-fill" style="width:'+(e.progress||0)+'%"></div></div>';else if(e.status==="parsing")a='<span class="bq-stat bq-run">'+t("bank-queue-status-parsing")+'</span><div class="bq-bar"><div class="bq-bar-fill bq-bar-indet"></div></div>';else if(e.status==="ok")a='<span class="bq-stat bq-ok">'+t("bank-queue-status-ok").replace("{n}",e.tx_count||0)+"</span>",s='<button data-q-act="remove" data-q-id="'+X(e.id)+'" class="bq-act">×</button>';else if(e.status==="failed"){const o=Nc(e.error_code||"unknown");a='<span class="bq-stat bq-fail" title="'+X(o)+'">'+X(o)+"</span>",s='<button data-q-act="retry" data-q-id="'+X(e.id)+'" class="bq-act bq-act-retry">'+t("bank-queue-retry")+'</button><button data-q-act="remove" data-q-id="'+X(e.id)+'" class="bq-act">×</button>'}return'<div class="bq-row" data-q-row="'+X(e.id)+'"><div class="bq-name" title="'+X(e.name)+'">'+X(e.name)+'</div><div class="bq-size">'+n+'</div><div class="bq-status">'+a+'</div><div class="bq-actions">'+s+"</div></div>"}function id(e){const n=H.queue.find(a=>a.id===e);n&&(n.status="pending",n.error_code=null,n.progress=0,Ae(),ks())}function rd(e){const n=H.queue.findIndex(s=>s.id===e);if(n<0)return;const a=H.queue[n];a.status==="uploading"||a.status==="parsing"||(H.queue.splice(n,1),Ae())}function ld(){H.queue=H.queue.filter(e=>e.status!=="ok"),Ae()}async function ks(){for(;;){if(H.queue.filter(a=>a.status==="uploading"||a.status==="parsing").length>=td)return;const n=H.queue.find(a=>a.status==="pending");if(!n){H.queue.every(a=>a.status==="ok"||a.status==="failed")&&(await Qt(),typeof window.loadReconcilePage=="function"&&window.loadReconcilePage());return}cd(n).then(()=>ks())}}async function cd(e){e.status="uploading",e.progress=0,Ae();try{const n=new FormData;n.append("file",e.file,e.name);const a=await new Promise((o,i)=>{const r=new XMLHttpRequest;r.open("POST","/api/bank-recon/upload"),r.setRequestHeader("Authorization","Bearer "+token),r.upload.onprogress=l=>{l.lengthComputable&&(e.progress=Math.min(99,Math.round(l.loaded/l.total*100)),Ae())},r.upload.onload=()=>{e.status="parsing",Ae()},r.onload=()=>{r.status>=200&&r.status<300?o({status:r.status,text:r.responseText}):o({status:r.status,text:r.responseText})},r.onerror=()=>i(new Error("network")),r.send(n)});let s={};try{s=JSON.parse(a.text||"{}")}catch{s={}}if(a.status>=400){e.status="failed",e.error_code=s&&s.detail||"unknown",Ae();return}if(s.parse_status==="parse_failed"){e.status="failed",e.error_code=s.error==="scanned_pdf_not_yet"?"bank_recon.scanned":"bank_recon.no_tx",Ae();return}e.status="ok",e.tx_count=s.tx_count||0,e.session_id=s.session_id||null,Ae()}catch(n){console.warn("[bank-recon] upload failed",n),e.status="failed",e.error_code="network",Ae()}}async function Di(){if(H.loaded){po();return}H.loaded=!0,dd(),await Qt(),po()}function dd(){const e=document.getElementById("bank-file-input");e&&!e._bound&&(e._bound=!0,e.addEventListener("change",ad));const n=document.getElementById("btn-bank-queue-clear-done");n&&!n._bound&&(n._bound=!0,n.addEventListener("click",ld));const a=document.getElementById("btn-bank-back");a&&!a._bound&&(a._bound=!0,a.addEventListener("click",()=>{H.currentSession=null,H.currentTxs=[],ws()}));const s=document.getElementById("btn-bank-delete");s&&!s._bound&&(s._bound=!0,s.addEventListener("click",Wc));const o=document.getElementById("btn-bank-run-match");o&&!o._bound&&(o._bound=!0,o.addEventListener("click",Gc)),document.querySelectorAll(".bank-filter-btn").forEach(p=>{p._bound||(p._bound=!0,p.addEventListener("click",()=>{H.currentFilter=p.dataset.bankFilter||"all",document.querySelectorAll(".bank-filter-btn").forEach(c=>{c.classList.toggle("active",c===p)}),bs()}))}),document.querySelectorAll("[data-bank-cand-close]").forEach(p=>{p._bound||(p._bound=!0,p.addEventListener("click",wn))});const i=document.getElementById("btn-bank-cand-pane-close");i&&!i._bound&&(i._bound=!0,i.addEventListener("click",wn));const r=document.getElementById("btn-bank-cand-ignore");r&&!r._bound&&(r._bound=!0,r.addEventListener("click",co));const l=document.getElementById("btn-bank-cand-ignore-pane");l&&!l._bound&&(l._bound=!0,l.addEventListener("click",co));const m=document.getElementById("bank-client-badge");m&&!m._bound&&(m._bound=!0,m.addEventListener("click",Jc)),document.querySelectorAll("[data-bank-client-picker-close]").forEach(p=>{p._bound||(p._bound=!0,p.addEventListener("click",Ai))});const d=document.getElementById("btn-bank-client-picker-save");d&&!d._bound&&(d._bound=!0,d.addEventListener("click",Xc)),document.querySelectorAll(".bank-sessions-chip").forEach(p=>{p._bound||(p._bound=!0,p.addEventListener("click",()=>{H.sessionFilter=p.dataset.sessFilter||"all",document.querySelectorAll(".bank-sessions-chip").forEach(c=>{c.classList.toggle("active",c===p)}),Yn()}))})}window._deleteBankSession=Pi;window._loadBankReconPanel=Di;window._rerenderBankRecon=function(){if(currentRoute==="automation"){if(Yn(),H.currentSession&&(Hi(),bs(),ys(),!H.currentTxForDrawer)){const e=document.getElementById("bank-cand-pane-title"),n=document.getElementById("bank-cand-pane-sub");e&&(e.textContent=t("bank-cand-pane-empty-title")),n&&(n.textContent=t("bank-cand-pane-empty-sub"))}Ae()}};typeof window.subscribeI18n=="function"&&window.subscribeI18n("bank-recon",window._rerenderBankRecon);window._openBankSession=async function(e){e&&(H.loaded||await Di(),await Zt(e))};(function(){const e=document.getElementById("page-clients");if(!(!e||e.dataset.wbInjected==="1")){e.innerHTML=`
        <div class="page-head">
            <div class="page-head-icon">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
...
`,e.dataset.wbInjected="1";try{const n=window._currentLang||localStorage.getItem("mrpilot_lang")||"th",a=window.I18N;a&&a[n]&&(e.querySelectorAll("[data-i18n]").forEach(s=>{const o=s.getAttribute("data-i18n");a[n][o]&&(s.textContent=a[n][o])}),e.querySelectorAll("[data-i18n-placeholder]").forEach(s=>{const o=s.getAttribute("data-i18n-placeholder");a[n][o]&&(s.placeholder=a[n][o])}))}catch{}}})();const pd=`
    ...
    `;Be("client-modal-mask",pd);Be("wsclient-modal-mask",ud);const U={clients:[],editingClientId:null,historyClientFilter:"",custTab:"seller",sellerClients:[],editingWsClientId:null,catCache:{fetched:0,items:[],supplier_count:0}},Ee={page:0,pageSize:12,keyword:""},et=new Set,Jn={keyword:""};function md(){return{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||"")}}async function We(e,n={}){const a=await fetch(e,{...n,headers:{"Content-Type":"application/json",...md(),...n.headers||{}}});if(!a.ok){const s=await a.json().catch(()=>({}));throw new Error(s.detail||"HTTP "+a.status)}return a.json()}function fd(){const e=document.querySelector("#client-color-picker .color-swatch.active");return e?e.dataset.color:"#111111"}function uo(e){const n=document.getElementById("drawer-cat-learned-tag");n&&e>0&&(n.textContent=(t("drawer-suggest-learned-with-count")||"已学 {n}").replace("{n}",String(e)))}async function en(){try{const e=await We("/api/clients");U.clients=e.clients||[],window._clientsCache=U.clients}catch(e){console.error("loadClientsCache fail",e),U.clients=[]}try{typeof window._refreshExcClientFilter=="function"&&window._refreshExcClientFilter()}catch{}try{typeof window._refreshClientSwitcher=="function"&&window._refreshClientSwitcher()}catch{}return U.clients}function vd(){const e=Ee.keyword.trim().toLowerCase();return e?U.clients.filter(n=>(n.name||"").toLowerCase().includes(e)||(n.short_name||"").toLowerCase().includes(e)||(n.tax_id||"").toLowerCase().includes(e)):U.clients}function xs(){const e=vd(),n=Ee.pageSize,a=Math.max(0,Math.ceil(e.length/n)-1);Ee.page>a&&(Ee.page=a);const s=Ee.page*n;return{all:e,items:e.slice(s,s+n),start:s,ps:n,total:e.length,maxPage:a}}function Xe(){const e=document.getElementById("buyer-tbody");if(!e)return;const{items:n,start:a,ps:s,total:o,maxPage:i}=xs();o?e.innerHTML=n.map(d=>{const p=et.has(d.id);return`<div class="cust-row buyer-grid${p?" selected":""}" data-cid="${d.id}">
            ...
            </div>`}).join(""):e.innerHTML=`<div class="cust-empty">${escapeHtml(t(Ee.keyword?"cust-no-match":"clients-empty"))}</div>`;const r=document.getElementById("buyer-pager-info");r&&(r.textContent=o?`${a+1}–${Math.min(a+s,o)} / ${o}`:"0");const l=document.getElementById("buyer-prev");l&&(l.disabled=Ee.page<=0);const m=document.getElementById("buyer-next");m&&(m.disabled=Ee.page>=i),qi()}function qi(){const e=et.size,n=document.getElementById("buyer-batch-bar");n&&(n.style.display=e?"flex":"none");const a=document.getElementById("buyer-batch-count");a&&(a.textContent=t("cust-selected-n").replace("{n}",e));const s=document.getElementById("buyer-check-all");if(s){const{items:o}=xs(),i=o.map(l=>l.id),r=i.filter(l=>et.has(l)).length;s.checked=i.length>0&&r===i.length,s.indeterminate=r>0&&r<i.length}}function hd(){et.clear(),Xe()}async function gd(){const e=Array.from(et);if(!(!e.length||!await showConfirm(t("cust-batch-del-confirm").replace("{n}",e.length),{danger:!0})))try{await We("/api/clients/batch-delete",{method:"POST",body:JSON.stringify({ids:e})}),showToast(t("client-msg-deleted"),"success"),et.clear(),await en(),Xe(),fa(),_s()}catch{showToast(t("client-msg-save-fail"),"fail")}}function mn(e){U.editingClientId=e?e.id:null;const n=!!e;document.getElementById("client-modal-title").textContent=t(n?"client-modal-edit":"client-modal-new"),document.getElementById("client-input-name").value=e&&e.name||"",document.getElementById("client-input-short").value=e&&e.short_name||"",document.getElementById("client-input-tax").value=e&&e.tax_id||"",document.getElementById("client-input-address").value=e&&e.address||"",document.getElementById("client-input-contact").value=e&&e.contact_person||"",document.getElementById("client-input-phone").value=e&&e.contact_phone||"",document.getElementById("client-input-email").value=e&&e.contact_email||"",document.getElementById("client-input-notes").value=e&&e.notes||"",document.getElementById("client-input-party-type").value=e&&e.party_type||"",document.getElementById("client-input-branch").value=e&&e.branch||"",document.getElementById("client-input-promptpay").value=e&&e.promptpay_id||"";const a=e&&e.color||"#111111";document.querySelectorAll("#client-color-picker .color-swatch").forEach(s=>{s.classList.toggle("active",s.dataset.color===a)}),document.getElementById("client-modal-delete").style.display=n?"":"none",document.getElementById("client-modal-mask").style.display="flex",setTimeout(()=>document.getElementById("client-input-name").focus(),50)}function fn(){document.getElementById("client-modal-mask").style.display="none",U.editingClientId=null}async function bd(){const e=document.getElementById("client-input-name").value.trim();if(!e){showToast(t("client-msg-name-required"),"fail");return}const n={name:e,short_name:document.getElementById("client-input-short").value.trim()||null,tax_id:document.getElementById("client-input-tax").value.trim()||null,address:document.getElementById("client-input-address").value.trim()||null,contact_person:document.getElementById("client-input-contact").value.trim()||null,contact_phone:document.getElementById("client-input-phone").value.trim()||null,contact_email:document.getElementById("client-input-email").value.trim()||null,notes:document.getElementById("client-input-notes").value.trim()||null,color:fd(),party_type:document.getElementById("client-input-party-type").value||null,branch:document.getElementById("client-input-branch").value.trim()||null,promptpay_id:document.getElementById("client-input-promptpay").value.trim()||null};try{U.editingClientId?(await We(`/api/clients/${U.editingClientId}`,{method:"PATCH",body:JSON.stringify(n)}),showToast(t("client-msg-updated"),"success")):(await We("/api/clients",{method:"POST",body:JSON.stringify(n)}),showToast(t("client-msg-created"),"success")),fn(),await en(),currentRoute==="clients"&&Xe(),fa(),_s()}catch(a){console.error("saveClient fail",a);const s=a&&a.message?a.message:t("client-msg-save-fail");showToast(t("client-msg-save-fail")+" · "+s,"fail")}}async function yd(){if(!U.editingClientId)return;const e=U.clients.find(s=>s.id===U.editingClientId);if(!e)return;const n=t("client-delete-confirm").replace("{name}",e.name);if(await showConfirm(n,{danger:!0}))try{await We(`/api/clients/${U.editingClientId}`,{method:"DELETE"}),showToast(t("client-msg-deleted"),"success"),fn(),await en(),currentRoute==="clients"&&Xe(),fa(),_s()}catch(s){console.error(s),showToast(t("client-msg-save-fail"),"fail")}}async function wd(e){const n=U.clients.find(a=>a.id===e);if(typeof window.openClientExportModal=="function"){window.openClientExportModal(e,n?n.name:"");return}try{const a=localStorage.getItem("mrpilot_token"),s=await fetch(`/api/clients/${e}/export?month=all`,{headers:{Authorization:"Bearer "+a}});if(!s.ok){let m="HTTP "+s.status;try{const d=await s.json();d&&d.detail&&(m=d.detail)}catch{}throw new Error(m)}const o=await s.blob();if(o.size<200){showToast(t("client-export-month-empty"),"info");return}const i=n&&n.name?n.name.replace(/[^a-zA-Z0-9\u0e00-\u0e7f\u4e00-\u9fff]/g,"_").slice(0,40):"client",r=URL.createObjectURL(o),l=document.createElement("a");l.href=r,l.download=`${i}_export.csv`,l.click(),URL.revokeObjectURL(r)}catch(a){console.error("exportClient fail",a),showToast(t("client-msg-save-fail")+" · "+(a.message||""),"fail")}}function fa(){const e=document.getElementById("drawer-client-select");if(!e)return;const n=e.value;e.innerHTML=`<option value="">${escapeHtml(t("drawer-client-none"))}</option>`+U.clients.map(a=>`<option value="${a.id}">${escapeHtml(a.name)}</option>`).join(""),e.value=n||""}function _s(){const e=document.getElementById("history-client-filter");if(!e)return;const n=e.value;e.innerHTML=`<option value="">${escapeHtml(t("history-client-all"))}</option>`+U.clients.map(a=>`<option value="${a.id}">${escapeHtml(a.name)}</option>`).join(""),e.value=n||""}function kd(e){U.custTab=e==="buyer"?"buyer":"seller",document.querySelectorAll("[data-cust-tab]").forEach(s=>s.classList.toggle("active",s.dataset.custTab===U.custTab));const n=document.getElementById("cust-pane-seller"),a=document.getElementById("cust-pane-buyer");n&&n.classList.toggle("active",U.custTab==="seller"),a&&a.classList.toggle("active",U.custTab==="buyer")}function xd(){const e=window._userInfo||{},n=String(e.role||"").toLowerCase(),a=String(e.tenant_role||"").toLowerCase();return e.is_super_admin===!0||e.is_owner===!0||n==="owner"||n==="admin"||a==="owner"||a==="admin"}function Ri(){window._workspaceClientsCache=U.sellerClients,typeof window.renderWorkspaceControl=="function"&&window.renderWorkspaceControl()}async function Es(){try{const e=await We("/api/workspace/clients");U.sellerClients=e&&(e.clients||e.items)||[],window._workspaceClientsCache=U.sellerClients}catch(e){console.error("loadSellerCache fail",e),U.sellerClients=[]}return U.sellerClients}function _d(){const e=Jn.keyword.trim().toLowerCase();return e?U.sellerClients.filter(n=>(n.name||"").toLowerCase().includes(e)||(n.tax_id||"").toLowerCase().includes(e)):U.sellerClients}function Ct(){const e=document.getElementById("seller-tbody");if(!e)return;const n=xd(),a=document.getElementById("btn-seller-new");a&&(a.style.display=n?"":"none");const s=_d(),o=typeof window.getActiveWorkspaceClientId=="function"?window.getActiveWorkspaceClientId():null;if(!s.length){e.innerHTML=`<div class="cust-empty">${escapeHtml(t(Jn.keyword?"cust-no-match":"seller-empty"))}</div>`;return}e.innerHTML=s.map(i=>{const l=o!=null&&Number(o)===Number(i.id)?`<span class="cust-badge-current"><svg viewBox="0 0 14 14" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M2 7.5l3.2 3.2L12 4"/></svg>${escapeHtml(t("seller-current"))}</span>`:`<button class="cust-row-btn primary" data-saction="activate" data-wid="${i.id}">${escapeHtml(t("seller-set-current"))}</button>`,m=n?`
        ...
        </div>`}).join("")}function mo(e){U.editingWsClientId=e?e.id:null,document.getElementById("wsclient-modal-title").textContent=t(e?"wsclient-modal-edit":"wsclient-modal-new"),document.getElementById("wsclient-input-name").value=e&&e.name||"",document.getElementById("wsclient-input-tax").value=e&&e.tax_id||"",document.getElementById("wsclient-input-address").value=e&&e.address||"",document.getElementById("wsclient-input-branch").value=e&&e.branch||"",document.getElementById("wsclient-input-phone").value=e&&e.phone||"",document.getElementById("wsclient-input-vat").checked=e?e.vat_registered!==!1:!0,document.getElementById("wsclient-modal-archive").style.display=e?"":"none",document.getElementById("wsclient-modal-mask").style.display="flex",setTimeout(()=>document.getElementById("wsclient-input-name").focus(),50)}function vn(){document.getElementById("wsclient-modal-mask").style.display="none",U.editingWsClientId=null}async function Ed(){const e=document.getElementById("wsclient-input-name").value.trim(),n=document.getElementById("wsclient-input-tax").value.trim(),a=document.getElementById("wsclient-input-address").value.trim(),s=document.getElementById("wsclient-input-branch").value.trim(),o=document.getElementById("wsclient-input-phone").value.trim(),i=document.getElementById("wsclient-input-vat").checked;if(!e){showToast(t("client-msg-name-required"),"fail");return}const r={address:a||null,branch:s||null,phone:o||null,vat_registered:i};try{U.editingWsClientId?(await We("/api/workspace/clients/"+U.editingWsClientId,{method:"PATCH",body:JSON.stringify({name:e,tax_id:n,...r})}),showToast(t("client-msg-updated"),"success")):(await We("/api/workspace/clients",{method:"POST",body:JSON.stringify({name:e,tax_id:n||null,...r})}),showToast(t("client-msg-created"),"success")),vn(),await Es(),Ct(),Ri()}catch(l){const m=l&&l.message?l.message:t("client-msg-save-fail");showToast(t("client-msg-save-fail")+" · "+m,"fail")}}async function fo(){if(!U.editingWsClientId)return;const e=U.sellerClients.find(a=>Number(a.id)===Number(U.editingWsClientId));if(await showConfirm(t("wsclient-archive-confirm").replace("{name}",e?e.name:""),{danger:!0}))try{const a=U.editingWsClientId;await We("/api/workspace/clients/"+a,{method:"DELETE"}),showToast(t("wsclient-archived"),"success"),typeof window.getActiveWorkspaceClientId=="function"&&Number(window.getActiveWorkspaceClientId())===Number(a)&&typeof window.enterPersonalMode=="function"&&window.enterPersonalMode(),vn(),await Es(),Ct(),Ri()}catch{showToast(t("client-msg-save-fail"),"fail")}}window.loadClientsPage=async function(){const e=document.getElementById("seller-tbody");e&&(e.innerHTML=`<div class="cust-loading">${escapeHtml(t("clients-loading"))}</div>`);const n=document.getElementById("buyer-tbody");n&&(n.innerHTML=`<div class="cust-loading">${escapeHtml(t("clients-loading"))}</div>`),await Promise.all([Es(),en()]),Ct(),Xe()};window.addEventListener("pearnly:workspace-changed",function(){typeof currentRoute<"u"&&currentRoute==="clients"&&Ct()});window.bindDrawerClient=function(e,n){const a=document.getElementById("drawer-client-select");if(!a)return;if(fa(),a.value=n?String(n):"",!e){a.onchange=null;const o=document.getElementById("drawer-client-add");o&&(o.onclick=()=>mn(null));return}a.onchange=async()=>{const o=a.value?parseInt(a.value,10):null;try{await We(`/api/history/${e}/assign_client`,{method:"POST",body:JSON.stringify({client_id:o})}),showToast(t("client-msg-updated"),"success");const i=_results[_drawerIdx];i&&(i.client_id=o),await en()}catch(i){console.error(i),showToast(t("client-msg-save-fail"),"fail"),a.value=n?String(n):""}};const s=document.getElementById("drawer-client-add");s&&(s.onclick=()=>mn(null))};window.fillCategoryDatalist=async function(){try{const e=document.getElementById("drawer-cat-datalist"),n=Date.now();if(n-U.catCache.fetched<300*1e3){e&&(e.innerHTML=U.catCache.items.map(s=>`<option value="${escapeHtml(s)}">`).join("")),uo(U.catCache.supplier_count);return}const a=await We("/api/categories",{method:"GET"});U.catCache.fetched=n,U.catCache.items=a&&a.categories||[],U.catCache.supplier_count=a&&a.supplier_count||0,e&&(e.innerHTML=U.catCache.items.map(s=>`<option value="${escapeHtml(s)}">`).join("")),uo(U.catCache.supplier_count)}catch(e){console.warn("fillCategoryDatalist failed",e)}};window.getHistoryClientFilter=function(){return U.historyClientFilter};document.addEventListener("DOMContentLoaded",()=>{const e=document.querySelector(".cust-tab-bar");e&&e.addEventListener("click",L=>{const $=L.target.closest("[data-cust-tab]");$&&kd($.dataset.custTab)});const n=document.getElementById("btn-buyer-new");n&&n.addEventListener("click",()=>mn(null));const a=document.getElementById("buyer-tbody");a&&a.addEventListener("click",L=>{const $=L.target.closest(".buyer-row-check");if($){const F=parseInt($.dataset.cid,10);$.checked?et.add(F):et.delete(F);const G=$.closest(".cust-row");G&&G.classList.toggle("selected",$.checked),qi();return}const S=L.target.closest(".cust-row-btn");if(S){L.stopPropagation();const F=parseInt(S.dataset.cid,10);if(S.dataset.action==="edit"){const G=U.clients.find(se=>se.id===F);G&&mn(G)}else S.dataset.action==="export"&&wd(F);return}const M=L.target.closest(".cust-row");if(M&&!L.target.closest(".cust-cell-check")){const F=U.clients.find(G=>G.id===parseInt(M.dataset.cid,10));F&&mn(F)}});const s=document.getElementById("buyer-check-all");s&&s.addEventListener("change",()=>{const{items:L}=xs();L.forEach($=>{s.checked?et.add($.id):et.delete($.id)}),Xe()});const o=document.getElementById("buyer-batch-cancel");o&&o.addEventListener("click",hd);const i=document.getElementById("buyer-batch-delete");i&&i.addEventListener("click",gd);const r=document.getElementById("buyer-prev");r&&r.addEventListener("click",()=>{Ee.page>0&&(Ee.page--,Xe())});const l=document.getElementById("buyer-next");l&&l.addEventListener("click",()=>{Ee.page++,Xe()});const m=document.getElementById("buyer-search");if(m){let L;m.addEventListener("input",()=>{clearTimeout(L),L=setTimeout(()=>{Ee.keyword=m.value,Ee.page=0;const $=document.getElementById("buyer-search-clear");$&&($.style.display=m.value?"":"none"),Xe()},200)})}const d=document.getElementById("buyer-search-clear");d&&d.addEventListener("click",()=>{const L=document.getElementById("buyer-search");L&&(L.value=""),Ee.keyword="",Ee.page=0,d.style.display="none",Xe()});const p=document.getElementById("btn-seller-new");p&&p.addEventListener("click",()=>mo(null));const c=document.getElementById("seller-tbody");c&&c.addEventListener("click",L=>{const $=L.target.closest("[data-saction]");if(!$)return;L.stopPropagation();const S=parseInt($.dataset.wid,10),M=$.dataset.saction,F=U.sellerClients.find(G=>Number(G.id)===S);M==="activate"?(typeof window.setActiveWorkspaceClientId=="function"&&window.setActiveWorkspaceClientId(S),Ct(),typeof window.renderWorkspaceControl=="function"&&window.renderWorkspaceControl(),showToast(t("seller-activated").replace("{name}",F?F.name:""),"success")):M==="edit"?F&&mo(F):M==="archive"&&(U.editingWsClientId=S,fo())});const u=document.getElementById("seller-search");if(u){let L;u.addEventListener("input",()=>{clearTimeout(L),L=setTimeout(()=>{Jn.keyword=u.value;const $=document.getElementById("seller-search-clear");$&&($.style.display=u.value?"":"none"),Ct()},200)})}const f=document.getElementById("seller-search-clear");f&&f.addEventListener("click",()=>{const L=document.getElementById("seller-search");L&&(L.value=""),Jn.keyword="",f.style.display="none",Ct()});const v=document.getElementById("wsclient-modal-close");v&&v.addEventListener("click",vn);const y=document.getElementById("wsclient-modal-cancel");y&&y.addEventListener("click",vn);const b=document.getElementById("wsclient-modal-save");b&&b.addEventListener("click",Ed);const h=document.getElementById("wsclient-modal-archive");h&&h.addEventListener("click",fo);const g=document.getElementById("wsclient-modal-mask");g&&g.addEventListener("click",L=>{L.target===g&&vn()});const _=document.getElementById("client-modal-close");_&&_.addEventListener("click",fn);const w=document.getElementById("client-modal-cancel");w&&w.addEventListener("click",fn);const k=document.getElementById("client-modal-save");k&&k.addEventListener("click",bd);const x=document.getElementById("client-modal-delete");x&&x.addEventListener("click",yd);const E=document.getElementById("client-modal-mask");E&&E.addEventListener("click",L=>{L.target===E&&fn()});const I=document.getElementById("client-color-picker");I&&I.addEventListener("click",L=>{const $=L.target.closest(".color-swatch");$&&(I.querySelectorAll(".color-swatch").forEach(S=>S.classList.remove("active")),$.classList.add("active"))});const B=document.getElementById("history-client-filter");B&&B.addEventListener("change",()=>{U.historyClientFilter=B.value,typeof renderHistoryList=="function"&&renderHistoryList()})});setTimeout(()=>en(),1e3);(function(){const e=document.getElementById("page-exceptions");if(!(!e||e.dataset.wbInjected==="1")){e.innerHTML=`
        <div class="page-head">
            <div class="page-head-icon">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round">
...
`,e.dataset.wbInjected="1";try{const n=window._currentLang||localStorage.getItem("mrpilot_lang")||"th",a=window.I18N;a&&a[n]&&(e.querySelectorAll("[data-i18n]").forEach(s=>{const o=s.getAttribute("data-i18n");a[n][o]&&(s.textContent=a[n][o])}),e.querySelectorAll("[data-i18n-placeholder]").forEach(s=>{const o=s.getAttribute("data-i18n-placeholder");a[n][o]&&(s.placeholder=a[n][o])}))}catch{}}})();const q={statsCache:null,listCache:[],currentRule:null,currentClient:"",currentStatus:"pending",loading:!1,selectedIds:new Set,offset:0,pageSize:50,total:0,loadFailed:!1,listScrollY:0},D={openExcId:null,excRow:null,history:null,loading:!1,pdfUrl:null,pdfStatus:"idle",editing:!1,editFields:null},Nt={batchLoading:!1};function ht(e,n){let a=t(e)||e;if(n)for(const s in n)a=a.replace(new RegExp("\\{"+s+"\\}","g"),String(n[s]));return a}function Id(e){return e==="high"?`<svg viewBox="0 0 14 14" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
    ...
    </svg>`}function Bd(){return`<svg class="exc-empty-icon" viewBox="0 0 40 40" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
        <path d="M11 19l5 5 13-13"/>
        <circle cx="20" cy="20" r="17"/>
    </svg>`}function Ld(e){if(e==null)return"—";const n=parseFloat(String(e));return isNaN(n)?"—":"฿ "+n.toLocaleString(void 0,{minimumFractionDigits:2,maximumFractionDigits:2})}function $d(e){return e?e.slice(0,10):"—"}function it(e){if(e==null)return"—";const n=typeof e=="number"?e:parseFloat(String(e).replace(/,/g,""));return isNaN(n)?escapeHtml(String(e)):"฿ "+n.toLocaleString(void 0,{minimumFractionDigits:2,maximumFractionDigits:2})}const Sd={"R-VAT-01":"risk.vat_mismatch","R-VAT-02":"risk.total_mismatch","R-SUM-01":"risk.line_sum_mismatch","R-LINE-01":"risk.line_amount_mismatch","R-MULTIPAGE-01":"risk.multipage_mismatch","R-TAXID-01":"risk.seller_tax_id_invalid","R-TAXID-02":"risk.buyer_tax_id_invalid","R-TAXID-03":"risk.tax_id_placeholder","R-DUP-01":"risk.duplicate_exact","R-DUP-02":"risk.duplicate_suspected","R-DATE-01":"risk.invoice_date_unparseable","R-DATE-02":"risk.invoice_date_out_of_period","R-SUP-01":"risk.supplier_not_allowlisted","R-SUP-02":"risk.supplier_force_review","R-LIMIT-01":"risk.amount_over_limit","R-CAT-01":"risk.category_no_auto_push"};function La(e,n){const a=t(e);return a&&a!==e?a:n}function Is(e){const n=e.rule_code||"",a=e.detail&&e.detail.message_key;if(a){const i=La(a,"");if(i)return i}const s=La("exc-rule-"+n,"");if(s)return s;const o=Sd[n];if(o){const i=La(o,"");if(i)return i}return n}const Cd=[{labelKey:"exc-grp-arithmetic",codes:["R-VAT-01","R-VAT-02","R-SUM-01","R-LINE-01","R-MULTIPAGE-01","math_mismatch"]},{labelKey:"exc-grp-taxid",codes:["R-TAXID-01","R-TAXID-02","R-TAXID-03","tax_id_format_invalid"]},{labelKey:"exc-grp-dup",codes:["R-DUP-01","R-DUP-02","duplicate"]},{labelKey:"exc-grp-date",codes:["R-DATE-01","R-DATE-02"]},{labelKey:"exc-grp-customer",codes:["R-SUP-01","R-SUP-02","R-LIMIT-01","R-CAT-01"]},{labelKey:"exc-grp-fields",codes:["amount_missing"]},{labelKey:"exc-chip-confidence_low",codes:["confidence_low"]}];function Td(e){if(!e)return"—";try{const n=new Date(e),a=s=>String(s).padStart(2,"0");return`${n.getFullYear()}-${a(n.getMonth()+1)}-${a(n.getDate())} ${a(n.getHours())}:${a(n.getMinutes())}`}catch{return e.slice(0,16).replace("T"," ")}}function ae(e,n,a){return`<div class="exc-why-detail-row"><b>${escapeHtml(t(e))}</b><span class="${a||""}">${escapeHtml(n)}</span></div>`}function Md(e,n){const a=o=>it(n[o]),s=o=>n[o]===null||n[o]===void 0?"—":String(n[o]);switch(e){case"risk.vat_mismatch":return ae("exc-fld-subtotal",a("net_amount"))+ae("exc-fld-vat",a("vat_amount"),"v-bad")+ae("exc-detail-expected",a("expected_vat"),"v-good");case"risk.total_mismatch":{const o=Number(n.net_amount)||0,i=Number(n.vat_amount)||0;return ae("exc-fld-subtotal",a("net_amount"))+ae("exc-fld-vat",a("vat_amount"))+ae("exc-fld-total",a("total_amount"),"v-bad")+ae("exc-detail-expected",it(o+i),"v-good")}case"risk.line_sum_mismatch":return ae("exc-ev-lines-sum",a("lines_sum"),"v-bad")+ae("exc-fld-subtotal",a("net_amount"),"v-good");case"risk.line_amount_mismatch":{const o=Number(n.qty)||0,i=Number(n.unit_price)||0;return ae("exc-ev-amount",a("amount"),"v-bad")+ae("exc-detail-expected",it(o*i),"v-good")}case"risk.multipage_mismatch":return ae("exc-ev-pages",s("pages"));case"risk.seller_tax_id_invalid":return ae("exc-fld-seller-tax",s("seller_tax_id"),"v-bad");case"risk.buyer_tax_id_invalid":return ae("exc-fld-buyer-tax",s("buyer_tax_id"),"v-bad");case"risk.tax_id_placeholder":return ae("exc-ev-value",s("value"),"v-bad");case"risk.invoice_date_unparseable":case"risk.invoice_date_future":return ae("exc-fld-date",s("invoice_date"),"v-bad");case"risk.invoice_date_out_of_period":return ae("exc-fld-date",s("invoice_date"),"v-bad")+ae("exc-ev-period-start",s("period_start"))+ae("exc-ev-period-end",s("period_end"));case"risk.duplicate_exact":return(n.invoice_no?ae("exc-fld-invoice-no",s("invoice_no")):"")+ae("exc-fld-seller-tax",s("seller_tax_id"));case"risk.duplicate_suspected":{const o=Array.isArray(n.candidate_history_ids)?n.candidate_history_ids.length:0;return ae("exc-ev-dup-count",String(o))}case"risk.supplier_not_allowlisted":return ae("exc-fld-seller",s("seller_name"))+ae("exc-fld-seller-tax",s("seller_tax_id"));case"risk.supplier_force_review":return ae("exc-ev-reason",s("reason"),"v-bad")+ae("exc-fld-seller-tax",s("seller_tax_id"));case"risk.amount_over_limit":return ae("exc-ev-amount",a("value"),"v-bad")+ae("exc-ev-limit",a("limit"),"v-good");case"risk.category_no_auto_push":return ae("exc-ev-category",s("category"));default:return`<div class="exc-why-detail-row"><span style="font-size:11px;">${escapeHtml(JSON.stringify(n))}</span></div>`}}function Hd(e,n){if(n=n||{},n.message_key)return Md(n.message_key,n.evidence||{});if(e==="math_mismatch")return`
            <div class="exc-why-detail-row"><b>${escapeHtml(t("exc-fld-subtotal"))}</b><span>${escapeHtml(it(n.subtotal))}</span></div>
            <div class="exc-why-detail-row"><b>${escapeHtml(t("exc-fld-vat"))}</b><span>${escapeHtml(it(n.vat))}</span></div>
            <div class="exc-why-detail-row"><b>${escapeHtml(t("exc-detail-expected"))}</b><span class="v-good">${escapeHtml(it(n.total_expected))}</span></div>
            <div class="exc-why-detail-row"><b>${escapeHtml(t("exc-detail-actual"))}</b><span class="v-bad">${escapeHtml(it(n.total_actual))}</span></div>
            <div class="exc-why-detail-row"><b>${escapeHtml(t("exc-detail-diff"))}</b><span class="v-bad">${escapeHtml(it(n.diff))}</span></div>
        ...
        `:e==="amount_missing"?`<div class="exc-why-detail-row" style="justify-content:center;color:var(--danger);"><span>${escapeHtml(t("exc-detail-missing"))}</span></div>`:`<div class="exc-why-detail-row"><span style="font-size:11px;">${escapeHtml(JSON.stringify(n))}</span></div>`}function lt(){const e=D.excRow;if(!e)return;const n=e.seller_name&&e.seller_name.trim()?e.seller_name:t("exc-no-seller"),a=e.filename||"—";document.getElementById("exc-drawer-title").textContent=a;const s="exc-status-"+(e.status||"pending"),o=t(s)||e.status,i="s-"+(e.status||"pending"),r=(e.invoice_date||e.created_at||"").slice(0,10);document.getElementById("exc-drawer-sub").innerHTML=`
        <span>${escapeHtml(n)}</span>
        ${e.invoice_no?`<span>· ${escapeHtml(e.invoice_no)}</span>`:""}
        ${r?`<span>· ${escapeHtml(r)}</span>`:""}
        <span class="exc-status-chip ${i}">${escapeHtml(o)}</span>
    `;const l=e.severity||"medium",m=Is(e),d=Hd(e.rule_code,e.detail||{}),p=vo(D.history),c=D.history===null,u=D.history&&D.history._err,f=new Set,v=e.rule_code||"";["math_mismatch","R-VAT-01","R-VAT-02","R-SUM-01","R-LINE-01"].includes(v)?(f.add("subtotal"),f.add("vat"),f.add("total_amount")):v==="R-MULTIPAGE-01"||v==="R-LIMIT-01"?f.add("total_amount"):v==="tax_id_format_invalid"||v==="R-TAXID-01"?f.add("seller_tax"):v==="R-TAXID-02"?f.add("buyer_tax"):v==="R-TAXID-03"?(f.add("seller_tax"),f.add("buyer_tax")):v==="R-DATE-01"||v==="R-DATE-02"?f.add("date"):v==="R-DUP-01"||v==="R-DUP-02"?f.add("invoice_number"):v==="R-SUP-01"||v==="R-SUP-02"?(f.add("seller_name"),f.add("seller_tax")):v==="amount_missing"&&(f.add("total_amount"),f.add("invoice_number"));const y=!!D.editing,b=D.editFields||{},h=(M,F,G)=>{if(c)return`<div class="exc-field-row"><label>${escapeHtml(t(F))}</label><span class="val empty">…</span></div>`;const se=y?b[M]!==void 0?b[M]:p[M]!==void 0&&p[M]!==null?p[M]:"":p[M],ce=f.has(M)?"flagged":"";if(y){const V=G?"number":"text",O=G?' step="0.01" inputmode="decimal"':"",Y=se==null?"":String(se).replace(/"/g,"&quot;");return`<div class="exc-field-row ${ce} editing">
                <label>${escapeHtml(t(F))}</label>
                <input class="exc-field-input" type="${V}"${O} data-edit-key="${escapeHtml(M)}" value="${Y}">
            </div>`}const xe=G?it(se):se||"",ye=se==null||se===""?`<span class="val empty">${escapeHtml(t("exc-empty-val"))}</span>`:`<span class="val">${escapeHtml(xe)}</span>`;return`<div class="exc-field-row ${ce}"><label>${escapeHtml(t(F))}</label>${ye}</div>`};let g="";u?g=`<div class="exc-drawer-error">${escapeHtml(t("exc-drawer-error"))}</div>`:g=`
    ...
    `;const w=document.getElementById("exc-fld-edit");w&&w.addEventListener("click",()=>{D.editing=!0,D.editFields={...vo(D.history)},lt()});const k=document.getElementById("exc-fld-cancel");k&&k.addEventListener("click",()=>{D.editing=!1,D.editFields=null,lt()});const x=document.getElementById("exc-fld-save");x&&x.addEventListener("click",()=>Pd()),document.querySelectorAll(".exc-field-input").forEach(M=>{M.addEventListener("input",()=>{D.editFields||(D.editFields={}),D.editFields[M.dataset.editKey]=M.value})});const I=document.getElementById("exc-pdf-retry");I&&D.openExcId&&I.addEventListener("click",()=>{D.excRow&&Fi(D.excRow.history_id,D.openExcId)});const B=e.status==="pending",L=!!(e.seller_name&&e.seller_name.trim()),$=document.getElementById("exc-btn-resolve"),S=document.getElementById("exc-btn-ignore");$.disabled=!B,S.disabled=!B||!L,S.title=L?t("exc-ignore-hint"):t("exc-ignore-no-seller")}function Bs(){if(D.pdfUrl){try{URL.revokeObjectURL(D.pdfUrl)}catch{}D.pdfUrl=null}D.pdfStatus="idle"}async function Fi(e,n){D.pdfStatus="loading",lt();try{const a=await fetch("/api/history/"+encodeURIComponent(e)+"/pdf",{headers:{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||"")}});if(D.openExcId!==n)return;if(a.status===404){D.pdfStatus="empty",lt();return}if(!a.ok)throw new Error("http "+a.status);const s=await a.blob();if(D.openExcId!==n)return;Bs(),D.pdfUrl=URL.createObjectURL(s),D.pdfStatus="ready",lt()}catch(a){if(D.openExcId!==n)return;console.warn("loadDrawerPdf fail",a),D.pdfStatus="error",lt()}}function Ad(e){const n=(q.listCache||[]).find(a=>a.id===e);if(!n){showToast(t("exc-drawer-error"),"error");return}q.listScrollY=window.scrollY||document.documentElement.scrollTop||0,Bs(),D.editing=!1,D.editFields=null,D.openExcId=e,D.excRow=n,D.history=null,document.getElementById("exc-drawer-mask").classList.add("show"),document.getElementById("exc-drawer").classList.add("show"),lt(),jd(n.history_id),Fi(n.history_id,e)}function Yt(){Bs(),D.editing=!1,D.editFields=null,D.openExcId=null,D.excRow=null,D.history=null,document.getElementById("exc-drawer-mask").classList.remove("show"),document.getElementById("exc-drawer").classList.remove("show");const e=q.listScrollY||0;e>0&&requestAnimationFrame(()=>window.scrollTo(0,e))}async function jd(e){try{const n=await fetch("/api/history/"+encodeURIComponent(e),{headers:{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||"")}});if(!n.ok)throw new Error("http "+n.status);D.history=await n.json()}catch(n){console.warn("loadHistoryDetail fail",n),D.history={_err:!0}}D.excRow&&lt()}function vo(e){if(!e||!e.pages)return{};const n=e.pages,a=n.find(s=>!s.is_duplicate&&!s.is_copy)||n[0];return a&&a.fields||{}}async function Pd(){if(!D.openExcId||!D.history||!D.history.pages||D.loading)return;D.loading=!0;const e=showToast(t("exc-fld-saving"),"loading",0);try{const n=JSON.parse(JSON.stringify(D.history.pages||[]));let a=n.findIndex(m=>!m.is_duplicate&&!m.is_copy);a<0&&(a=0),n[a]||(n[a]={fields:{}});const s=n[a].fields||{},o=D.editFields||{},i=new Set(["subtotal","vat","total_amount"]),r={...s};for(const m in o){let d=o[m];if((d===""||d===void 0)&&(d=null),i.has(m)&&d!==null){const p=parseFloat(d);d=isNaN(p)?null:p}r[m]=d}n[a].fields=r;const l=await fetch("/api/history/"+encodeURIComponent(D.history.id),{method:"PUT",headers:{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||""),"Content-Type":"application/json"},body:JSON.stringify({pages:n})});if(!l.ok)throw new Error("http "+l.status);e(),showToast(t("exc-fld-save-ok"),"success"),Yt(),await tn(),await yt(),nt()}catch(n){e(),console.warn("save fields fail",n),showToast(t("exc-fld-save-fail"),"error")}finally{D.loading=!1}}async function Dd(){if(!(!D.openExcId||D.loading)){D.loading=!0;try{const e=await fetch("/api/exceptions/"+D.openExcId+"/resolve",{method:"POST",headers:{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||"")}});if(!e.ok)throw new Error("http "+e.status);showToast(t("exc-toast-resolved"),"success"),Yt(),await tn(),await yt(),nt()}catch(e){console.warn("resolve fail",e),showToast(t("exc-toast-action-fail"),"error")}finally{D.loading=!1}}}async function qd(){if(!(!D.openExcId||D.loading)){D.loading=!0;try{const e=await fetch("/api/exceptions/"+D.openExcId+"/ignore",{method:"POST",headers:{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||"")}});if(!e.ok)throw new Error("http "+e.status);showToast(t("exc-toast-ignored"),"success"),Yt(),await tn(),await yt(),nt()}catch(e){console.warn("ignore fail",e),showToast(t("exc-toast-action-fail"),"error")}finally{D.loading=!1}}}async function nt(){try{const e=q.currentClient||"",n="/api/exceptions/stats?status=pending"+(e?"&client_id="+encodeURIComponent(e):""),a=await fetch(n,{headers:{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||"")}});if(!a.ok)return;const s=await a.json(),o=document.getElementById("nav-exc-badge");if(!o)return;const i=parseInt(s.pending||0,10);i>0?(o.textContent=i>99?"99+":String(i),o.style.display=""):o.style.display="none"}catch{}}function zi(e){document.getElementById("exc-kpi-pending").textContent=e.pending||0,document.getElementById("exc-kpi-high").textContent=e.high_severity||0,document.getElementById("exc-kpi-resolved").textContent=e.resolved||0,document.getElementById("exc-kpi-learned").textContent=e.learned_rules||0;const n=document.getElementById("exc-status-tab-count-pending"),a=document.getElementById("exc-status-tab-count-resolved"),s=document.getElementById("exc-status-tab-count-ignored");n&&(n.textContent=e.pending||0),a&&(a.textContent=e.resolved||0),s&&(s.textContent=e.ignored||0),document.querySelectorAll("#exc-status-tabs .exc-status-tab").forEach(i=>{i.classList.toggle("active",i.dataset.status===(q.currentStatus||"pending"))})}function Ni(e,n){return n.split(",").reduce((a,s)=>a+(e[s]||0),0)}function Ls(e){const n=document.getElementById("exc-chips");if(!n)return;const a=e.by_rule||{};let o=`<button class="exc-chip ${!q.currentRule?"active":""}" data-rule="">
        <span>${escapeHtml(t("exc-chip-all"))}</span>
        <span class="exc-chip-count">${e.pending||0}</span>
    </button>`;for(const i of Cd){const r=i.codes.join(","),l=Ni(a,r),m=q.currentRule===r;l===0&&!m||(o+=`<button class="exc-chip ${m?"active":""}" data-rule="${escapeHtml(r)}">
            <span>${escapeHtml(t(i.labelKey))}</span>
            <span class="exc-chip-count">${l}</span>
        </button>`)}n.innerHTML=o,n.querySelectorAll(".exc-chip").forEach(i=>{i.addEventListener("click",()=>{const r=i.dataset.rule||null;q.currentRule=r,yt()})})}function $s(e){const n=document.getElementById("exc-list");if(!n)return;if(!e||e.length===0){n.innerHTML=`<div class="exc-empty">
            ${Bd()}
            <div class="exc-empty-title">${escapeHtml(t("exc-empty-title"))}</div>
            <div>${escapeHtml(t("exc-empty-desc"))}</div>
        </div>`,go();return}const a='<svg viewBox="0 0 14 14" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M3 7l3 3 5-5"/></svg>',s=(q.currentStatus||"pending")==="pending";n.innerHTML=e.map(o=>{const i=o.severity||"medium",r=Is(o),l=o.seller_name&&o.seller_name.trim()?o.seller_name:t("exc-no-seller"),m=o.filename||"—",d=$d(o.invoice_date||o.created_at),p=o.status==="pending",c=q.selectedIds.has(o.id),u=s&&p;return`
            <div class="exc-row sev-${escapeHtml(i)} ${c?"selected":""}" data-exc-id="${escapeHtml(String(o.id))}">
                ...
                <div class="exc-row-sev">${Id(i)}</div>
                ...
                <div class="exc-row-amount">${escapeHtml(Ld(o.total_amount))}</div>
            </div>
        `}).join(""),n.querySelectorAll(".exc-row").forEach(o=>{o.addEventListener("click",i=>{if(i.target.closest(".exc-row-check"))return;const r=o.dataset.excId;r&&Ad(parseInt(r,10))})}),n.querySelectorAll(".exc-row-check").forEach(o=>{o.addEventListener("click",i=>{i.stopPropagation();const r=parseInt(o.dataset.checkId,10);r&&(q.selectedIds.has(r)?(q.selectedIds.delete(r),o.classList.remove("checked"),o.closest(".exc-row").classList.remove("selected")):(q.selectedIds.add(r),o.classList.add("checked"),o.closest(".exc-row").classList.add("selected")),ho())})}),ho(),go()}function ho(){const e=document.getElementById("exc-batch-bar"),n=document.getElementById("exc-batch-count");if(!e||!n)return;const a=q.selectedIds.size;a===0?e.style.display="none":(e.style.display="",n.textContent=ht("exc-batch-count",{n:a}))}function go(){const e=document.getElementById("exc-list-foot"),n=document.getElementById("exc-list-count"),a=document.getElementById("exc-loadmore");if(!e||!n||!a)return;const s=q.listCache.length;if(s===0){e.style.display="none";return}e.style.display="";let o=s;const i=q.statsCache;i&&(q.currentRule?o=Ni(i.by_rule||{},q.currentRule)||s:o=i.pending||s),q.total=o,n.textContent=ht("exc-list-count",{shown:s,total:o});const r=s<o&&s<500;a.style.display=r?"":"none"}async function tn(){try{if(navigator.onLine===!1)throw new Error("offline");const e=q.currentClient||"",n=q.currentStatus||"pending",a=new URLSearchParams;a.set("status",n),e&&a.set("client_id",e);const s="/api/exceptions/stats?"+a.toString(),o=await fetch(s,{headers:{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||"")}});if(!o.ok)throw new Error("http "+o.status);const i=await o.json();return q.statsCache=i,zi(i),Ls(i),i}catch(e){return console.warn("loadExceptionsStats fail",e),null}}function Rd(e){const n=document.getElementById("exc-list");if(!n)return;const a=`<svg class="exc-error-icon" viewBox="0 0 36 36" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round">
        <circle cx="18" cy="18" r="14"/>
        ...
        </div>`;const i=document.getElementById("exc-retry-btn");i&&i.addEventListener("click",()=>window.loadExceptionsPage&&window.loadExceptionsPage())}async function yt(e){e=e||{};const n=!!e.append,a=document.getElementById("exc-list");!n&&a&&q.listCache.length===0&&(a.innerHTML=`<div class="exc-loading">${escapeHtml(t("exc-loading"))}</div>`);const s=new URLSearchParams;s.set("status",q.currentStatus||"pending"),q.currentRule&&s.set("rule_code",q.currentRule),q.currentClient&&s.set("client_id",q.currentClient);const o=n?q.listCache.length:0;s.set("limit",String(q.pageSize)),s.set("offset",String(o));try{if(navigator.onLine===!1)throw new Error("offline");const i=await fetch("/api/exceptions/list?"+s.toString(),{headers:{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||"")}});if(!i.ok)throw new Error("http "+i.status);const l=(await i.json()).items||[];n?q.listCache=q.listCache.concat(l):(q.listCache=l,q.selectedIds.clear()),q.loadFailed=!1,$s(q.listCache),q.statsCache&&Ls(q.statsCache)}catch(i){console.warn("loadExceptionsList fail",i),q.loadFailed=!0;const r=navigator.onLine===!1||String(i.message||"").includes("offline");n?showToast(t("exc-toast-load-fail"),"error"):(Rd(r),showToast(r?t("exc-offline"):t("exc-toast-load-fail"),"error"))}}async function Fd(){if(!q.loading&&!(q.listCache.length>=500)){q.loading=!0;try{await yt({append:!0})}finally{q.loading=!1}}}function Ss(){const e=document.getElementById("exc-client-filter");if(!e)return;const n=window._clientsCache||[],a=q.currentClient||"",s=typeof t=="function"?t("history-client-all"):"全部客户";e.innerHTML=`<option value="">${escapeHtml(s)}</option>`+n.map(o=>`<option value="${o.id}">${escapeHtml(o.name)}</option>`).join(""),e.value=a}async function zd(){if(Nt.batchLoading)return;const e=Array.from(q.selectedIds);if(e.length===0||!await showConfirm(ht("exc-batch-confirm-resolve",{n:e.length})))return;Nt.batchLoading=!0;const a=showToast(ht("exc-batch-count",{n:e.length})+" …","loading",0);try{const s=await fetch("/api/exceptions/batch",{method:"POST",headers:{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||""),"Content-Type":"application/json"},body:JSON.stringify({ids:e,action:"resolve"})});if(!s.ok)throw new Error("http "+s.status);const o=await s.json();a(),showToast(ht("exc-toast-batch-resolved",{n:o.processed||0}),"success"),q.selectedIds.clear(),await tn(),await yt(),nt()}catch(s){a(),console.warn("batch resolve fail",s),showToast(t("exc-toast-batch-fail"),"error")}finally{Nt.batchLoading=!1}}async function Nd(){if(Nt.batchLoading)return;const e=Array.from(q.selectedIds);if(e.length===0||!await showConfirm(ht("exc-batch-confirm-ignore",{n:e.length}),{danger:!1}))return;Nt.batchLoading=!0;const a=showToast(ht("exc-batch-count",{n:e.length})+" …","loading",0);try{const s=await fetch("/api/exceptions/batch",{method:"POST",headers:{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||""),"Content-Type":"application/json"},body:JSON.stringify({ids:e,action:"ignore"})});if(!s.ok)throw new Error("http "+s.status);const o=await s.json();a(),showToast(ht("exc-toast-batch-ignored",{n:o.processed||0,wl:o.whitelist_added||0}),"success"),q.selectedIds.clear(),await tn(),await yt(),nt()}catch(s){a(),console.warn("batch ignore fail",s),showToast(t("exc-toast-batch-fail"),"error")}finally{Nt.batchLoading=!1}}function Od(){q.selectedIds.clear(),$s(q.listCache)}async function Oi(){const e=document.getElementById("learned-list");if(e){e.innerHTML=`<div class="learned-empty">${escapeHtml(t("set-learned-loading"))}</div>`;try{const n=await fetch("/api/exception-whitelist",{headers:{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||"")}});if(!n.ok)throw new Error("http "+n.status);const s=(await n.json()).items||[];if(s.length===0){e.innerHTML=`<div class="learned-empty">${escapeHtml(t("set-learned-empty"))}</div>`;return}const o=`<svg viewBox="0 0 14 14" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round">
            <path d="M3 4h8M5.5 4V2.5h3V4M4 4l0.6 8.5h4.8L10 4"/>
        </svg>`;e.innerHTML=s.map(i=>{const r=Is(i);return`
                <div class="learned-row" data-wl-id="${escapeHtml(String(i.id))}">
                    ...
                    <div class="learned-date">${escapeHtml(Td(i.created_at))}</div>
                    <button class="learned-del-btn" data-del-wl="${escapeHtml(String(i.id))}" title="${escapeHtml(t("set-learned-del"))}" type="button">${o}</button>
                </div>
            `}).join("")}catch(n){console.warn("loadLearnedRules fail",n),e.innerHTML=`<div class="learned-empty">${escapeHtml(t("exc-toast-load-fail"))}</div>`}}}window.loadExceptionsPage=async function(){if(!q.loading){q.loading=!0;try{Ss(),await tn(),await yt()}finally{q.loading=!1}}};window.refreshExcBadge=nt;window._refreshExcClientFilter=Ss;window._excState=q;window._rerenderExceptions=function(){try{Ss()}catch{}q.statsCache&&(zi(q.statsCache),Ls(q.statsCache)),q.listCache&&q.listCache.length&&$s(q.listCache);try{window._erpExcState&&window._erpExcState.items&&window._erpExcState.items.length&&typeof window._rerenderErpExceptions=="function"&&window._rerenderErpExceptions()}catch{}D.openExcId&&lt()};document.addEventListener("click",e=>{e.target.closest("#exc-drawer-close")&&Yt(),e.target.closest("#exc-drawer-mask")&&Yt(),e.target.closest("#exc-btn-resolve")&&Dd(),e.target.closest("#exc-btn-ignore")&&qd(),e.target.closest("#exc-batch-resolve")&&zd(),e.target.closest("#exc-batch-ignore")&&Nd(),e.target.closest("#exc-batch-clear")&&Od(),e.target.closest("#exc-loadmore")&&Fd()});document.addEventListener("keydown",e=>{e.key==="Escape"&&D.openExcId&&Yt()});document.addEventListener("click",e=>{e.target.closest("#btn-exc-refresh")&&(typeof window.loadExceptionsPage=="function"&&window.loadExceptionsPage(),nt())});document.addEventListener("change",e=>{if(!e.target.closest("#exc-client-filter"))return;const n=e.target;q.currentClient=n.value||"",q.currentRule=null,q.selectedIds.clear(),q.listCache=[],typeof window.loadExceptionsPage=="function"&&window.loadExceptionsPage(),nt()});document.addEventListener("click",e=>{const n=e.target.closest("#exc-status-tabs .exc-status-tab");if(!n)return;const a=n.dataset.status||"pending";a!==q.currentStatus&&(q.currentStatus=a,q.currentRule=null,q.selectedIds.clear(),q.listCache=[],typeof window.loadExceptionsPage=="function"&&window.loadExceptionsPage())});window.addEventListener("online",()=>{q.loadFailed&&document.getElementById("page-exceptions")?.classList.contains("show")&&window.loadExceptionsPage&&window.loadExceptionsPage()});setTimeout(nt,1500);setInterval(nt,6e4);window.loadLearnedRules=Oi;document.addEventListener("click",async e=>{const n=e.target.closest("[data-del-wl]");if(!n)return;const a=parseInt(n.dataset.delWl,10);if(!a)return;const s=n.closest(".learned-row"),o=s&&s.querySelector(".learned-seller"),i=o?o.textContent.trim():"",r=t("set-learned-del-confirm").replace("{seller}",i);if(await showConfirm(r,{danger:!0}))try{const m=await fetch("/api/exception-whitelist/"+a,{method:"DELETE",headers:{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||"")}});if(!m.ok)throw new Error("http "+m.status);showToast(t("set-learned-del-ok"),"success"),Oi(),typeof window.loadExceptionsPage=="function"&&document.getElementById("page-exceptions")?.classList.contains("show")&&window.loadExceptionsPage()}catch(m){console.warn("delete whitelist fail",m),showToast(t("set-learned-del-fail"),"error")}});let le={items:[],q:"",cat:"",adapter:"",selected:new Set,total:0,categories:{},pageSize:30,loading:!1,focusSearch:!1,searchCaret:0},bo=null;function Ze(){return localStorage.getItem("mrpilot_token")||""}function yo(e){return/<!?\s*doctype|<html|<\/?[a-z]+>|\bTraceback\b|^\s*ERR_[A-Z]/i.test(e)||e.length>200}function Vi(e){const n=typeof currentLang=="string"&&currentLang||window._currentLang||"th",a=e.error_friendly&&e.error_friendly[n];if(a)return a;if(typeof humanizeError=="function"&&e.error_msg&&!yo(e.error_msg))try{const s=humanizeError(e.error_msg);if(s&&!yo(s))return s}catch{}return t("erp-exc-reason-"+(e.category||"other"))}function wo(){const e=document.getElementById("erp-exc-batch");if(!e)return;const n=le.selected.size;e.hidden=n===0;const a=e.querySelector(".erp-exc-batch-count");a&&(a.textContent=String(n))}function Cs(){const e=document.getElementById("erp-exc-block");if(!e)return;const n=le;if(!(n.total>0||!!n.q||!!n.cat)){e.hidden=!0,e.innerHTML="";return}e.hidden=!1;const s=n.categories||{},o=Object.keys(s).reduce((x,E)=>x+s[E],0);let i=`<button class="erp-exc-chip ${n.cat===""?"active":""}" data-erpexc-cat=""><span>${escapeHtml(t("erp-exc-cat-all"))}</span><span class="erp-exc-chip-count">${o}</span></button>`;Object.keys(s).forEach(x=>{i+=`<button class="erp-exc-chip ${n.cat===x?"active":""}" data-erpexc-cat="${escapeHtml(x)}"><span>${escapeHtml(t("erp-exc-cat-"+x))}</span><span class="erp-exc-chip-count">${s[x]}</span></button>`});const r=n.items||[],l=r.length>0&&r.every(x=>n.selected.has(x.id)),m=r.map(x=>{const E=x.state==="needs_action"?"needs":x.state==="retrying"?"retry":"fail",I=t("erp-exc-state-"+(x.state||"failed")),B=Vi(x),L=n.selected.has(x.id)?"checked":"",$=x.push_type==="id_card",S=$?`<span class="erp-exc-type-idcard">${escapeHtml(t("erp-log-type-idcard"))}</span> `:"",M=$?`<span class="ex-inv" title="${escapeHtml(t("erp-log-col-booking"))}">${S}${escapeHtml(x.invoice_no||"—")}</span>`:`<span class="ex-inv" title="${escapeHtml(x.invoice_no||"")}">${escapeHtml(x.invoice_no||"—")}</span>`,F=$?`<span class="ex-seller" title="${escapeHtml(t("erp-log-col-customer"))}">${escapeHtml(x.seller_name||"—")}</span>`:`<span class="ex-seller" title="${escapeHtml(x.seller_name||"")}">${escapeHtml(x.seller_name||"—")}</span>`,G=$?`<span class="ex-buyer" title="${escapeHtml(t("erp-log-col-idcard"))}">${x.id_card_tail?"••••"+escapeHtml(x.id_card_tail):"—"}</span>`:`<span class="ex-buyer" title="${escapeHtml(x.ocr_buyer_name||"")}">${escapeHtml(x.ocr_buyer_name||"—")}</span>`;return`<div class="erp-exc-row" data-erpexc-id="${escapeHtml(x.id)}">
        ...
        <div class="erp-exc-foot">${p}</div>`;const g=document.getElementById("erp-exc-search");if(g){if(n.focusSearch){g.focus();try{g.setSelectionRange(n.searchCaret,n.searchCaret)}catch{}}g.addEventListener("input",()=>{n.q=g.value,n.focusSearch=!0,n.searchCaret=g.selectionStart||g.value.length,clearTimeout(bo),bo=setTimeout(()=>St(!1),350)}),g.addEventListener("blur",()=>{n.focusSearch=!1})}e.querySelectorAll(".erp-exc-chip").forEach(x=>{x.addEventListener("click",()=>{n.cat=x.dataset.erpexcCat||"",St(!1)})});const _=document.getElementById("erp-exc-erp-select");_&&_.addEventListener("change",()=>{n.adapter=_.value||"",St(!1)}),e.querySelectorAll("[data-erpexc-retry]").forEach(x=>{x.addEventListener("click",E=>{E.stopPropagation(),Rn(x.dataset.erpexcRetry,x)})}),e.querySelectorAll(".erp-exc-cb").forEach(x=>{x.addEventListener("change",()=>{const E=x.dataset.erpexcCb;x.checked?n.selected.add(E):n.selected.delete(E);const I=document.getElementById("erp-exc-cb-all");I&&(I.checked=r.length>0&&r.every(B=>n.selected.has(B.id))),wo()})});const w=document.getElementById("erp-exc-cb-all");w&&w.addEventListener("change",()=>{r.forEach(x=>{w.checked?n.selected.add(x.id):n.selected.delete(x.id)}),e.querySelectorAll(".erp-exc-cb").forEach(x=>{x.checked=w.checked}),wo()}),e.querySelectorAll("[data-erpexc-batch]").forEach(x=>{x.addEventListener("click",()=>Vd(x.dataset.erpexcBatch))});const k=document.getElementById("erp-exc-more");k&&k.addEventListener("click",()=>St(!0)),e.querySelectorAll(".erp-exc-row:not(.erp-exc-row-head)").forEach(x=>{x.addEventListener("click",E=>{E.target.closest("input,button")||typeof window._erpExcOpenEdit=="function"&&window._erpExcOpenEdit(x.dataset.erpexcId)})})}async function Rn(e,n){if(e){n&&(n.disabled=!0,n.textContent=t("erp-exc-retrying"));try{const a=await fetch("/api/erp/logs/"+encodeURIComponent(e)+"/retry",{method:"POST",headers:{Authorization:"Bearer "+Ze()}}),s=await a.json().catch(()=>({}));showToast(a.ok&&s.ok?t("erp-exc-retry-ok"):t("erp-exc-retry-fail"),a.ok&&s.ok?"success":"error")}catch{showToast(t("erp-exc-retry-fail"),"error")}if(le.selected.delete(e),St(!1),typeof window.refreshExcBadge=="function")try{window.refreshExcBadge()}catch{}}}async function Vd(e){const n=Array.from(le.selected);if(e==="clear"){le.selected.clear(),Cs();return}if(n.length!==0){if(e==="delete"){if(!await showConfirm(t("erp-exc-batch-delete-confirm",{n:n.length}),{danger:!0}))return;try{const s=await fetch("/api/erp/logs/batch-delete",{method:"POST",headers:{Authorization:"Bearer "+Ze(),"Content-Type":"application/json"},body:JSON.stringify({log_ids:n.slice(0,200)})}),o=await s.json().catch(()=>({}));showToast(s.ok?t("erp-exc-batch-delete-ok",{n:o.deleted||0}):t("erp-exc-retry-fail"),s.ok?"success":"error")}catch{showToast(t("erp-exc-retry-fail"),"error")}}else if(e==="retry")try{const a=await fetch("/api/erp/logs/batch-retry",{method:"POST",headers:{Authorization:"Bearer "+Ze(),"Content-Type":"application/json"},body:JSON.stringify({log_ids:n.slice(0,50)})}),s=await a.json().catch(()=>({}));showToast(a.ok?t("erp-exc-batch-retry-ok",{ok:s.succeeded||0,fail:(s.failed||0)+(s.skipped||0)}):t("erp-exc-retry-fail"),a.ok?"success":"error")}catch{showToast(t("erp-exc-retry-fail"),"error")}if(le.selected.clear(),St(!1),typeof window.refreshExcBadge=="function")try{window.refreshExcBadge()}catch{}}}async function St(e){const n=document.getElementById("erp-exc-block");if(!(!n||le.loading)){le.loading=!0;try{if(!Array.isArray(window._erpEndpoints)||!window._erpEndpoints.length)try{const r=await fetch("/api/erp/endpoints",{headers:{Authorization:"Bearer "+Ze()}});if(r.ok){const l=await r.json();window._erpEndpoints=l&&(l.items||l)||[]}}catch{}const a=new URLSearchParams;le.q&&a.set("q",le.q),le.cat&&a.set("category",le.cat),le.adapter&&a.set("adapter",le.adapter),a.set("limit",String(le.pageSize)),a.set("offset",String(e?le.items.length:0));const s=await fetch("/api/erp/exceptions?"+a.toString(),{headers:{Authorization:"Bearer "+Ze()}});if(!s.ok){e||(n.hidden=!0);return}const o=await s.json(),i=o.items||[];le.items=e?le.items.concat(i):i,le.total=o.total||0,le.categories=o.categories||{},Cs()}catch{e||(n.hidden=!0)}finally{le.loading=!1}}}window._rerenderErpExceptions=Cs;window.loadErpExceptions=St;window._erpExcState=le;let Tn={};function jt(){const e=document.getElementById("erp-exc-modal");e&&e.remove()}window._erpExcOpenEdit=function(e){const n=(le.items||[]).find(p=>String(p.id)===String(e));if(!n)return;const a=n.push_type==="id_card",s=!!n.history_client_id&&n.category==="customer_mismatch",o=n.category==="product_mismatch"&&!!n.history_id&&!!n.endpoint_id,i=Vi(n),r=n.state==="needs_action"?"needs":n.state==="retrying"?"retry":"fail",l=(p,c)=>`<div class="erp-exc-m-row"><span class="erp-exc-m-k">${escapeHtml(p)}</span><span class="erp-exc-m-v">${escapeHtml(c||"—")}</span></div>`;let m="";if(s)m=`
        ...
        </div>`,document.body.appendChild(d),d.addEventListener("click",p=>{p.target===d&&jt()}),document.getElementById("erp-exc-m-close").addEventListener("click",jt),document.getElementById("erp-exc-m-cancel").addEventListener("click",jt),document.getElementById("erp-exc-m-retry").addEventListener("click",()=>{jt(),Rn(n.id,null)}),s){let p="";const c=document.getElementById("erp-exc-m-bind"),u=document.getElementById("erp-exc-m-custlist"),f=document.getElementById("erp-exc-m-search"),v=(b,h)=>{const g=(h||"").trim().toLowerCase(),_=g?b.filter(w=>(w.code||"").toLowerCase().includes(g)||(w.name||"").toLowerCase().includes(g)):b;if(_.length===0){u.innerHTML=`<div class="erp-exc-m-empty">${escapeHtml(t("erp-exc-edit-pick-empty"))}</div>`;return}u.innerHTML=_.slice(0,100).map(w=>`<div class="erp-exc-m-cust" data-cust-code="${escapeHtml(w.code||"")}">
                    <span class="erp-exc-m-cust-name">${escapeHtml(w.name||"")}</span>
                    <span class="erp-exc-m-cust-code">${escapeHtml(w.code||"")}</span>
                </div>`).join(""),u.querySelectorAll(".erp-exc-m-cust").forEach(w=>{w.addEventListener("click",()=>{p=w.dataset.custCode||"",u.querySelectorAll(".erp-exc-m-cust").forEach(k=>k.classList.remove("sel")),w.classList.add("sel"),c&&(c.disabled=!p)})})},y=async()=>{const b=n.endpoint_id;if(Tn[b]){v(Tn[b],"");return}try{const h=await fetch("/api/erp/endpoints/"+encodeURIComponent(b)+"/customers",{headers:{Authorization:"Bearer "+Ze()}}),g=await h.json().catch(()=>({}));if(!h.ok||!g.ok){u.innerHTML=`<div class="erp-exc-m-empty">${escapeHtml(t("erp-exc-edit-pick-fail"))}</div>`;return}const _=g.customers||[];Tn[b]=_,v(_,"")}catch{u.innerHTML=`<div class="erp-exc-m-empty">${escapeHtml(t("erp-exc-edit-pick-fail"))}</div>`}};f&&f.addEventListener("input",()=>v(Tn[n.endpoint_id]||[],f.value)),y(),c&&c.addEventListener("click",async()=>{if(p){c.disabled=!0,c.textContent=t("erp-exc-retrying");try{if(!(await fetch("/api/erp/mappings/clients",{method:"POST",headers:{Authorization:"Bearer "+Ze(),"Content-Type":"application/json"},body:JSON.stringify({client_id:n.history_client_id,erp_type:n.endpoint_adapter,erp_code:p})})).ok){showToast(t("erp-exc-retry-fail"),"error"),c.disabled=!1,c.textContent=t("erp-exc-edit-bind-retry");return}showToast(t("erp-exc-edit-bound-ok"),"success"),jt(),await Rn(n.id,null)}catch{showToast(t("erp-exc-retry-fail"),"error"),c.disabled=!1,c.textContent=t("erp-exc-edit-bind-retry")}}})}if(o){const p=document.getElementById("erp-exc-m-bind-prod"),c=document.getElementById("erp-exc-m-prodlist"),u={};let f=[];const v=()=>'<option value="">'+escapeHtml(t("erp-exc-edit-prod-choose"))+"</option>"+f.slice(0,500).map(h=>`<option value="${escapeHtml(h.code||"")}" data-pname="${escapeHtml(h.name||"")}">`+escapeHtml((h.name||"")+" · "+(h.code||""))+"</option>").join(""),y=h=>{if(!h.length){c.innerHTML=`<div class="erp-exc-m-empty">${escapeHtml(t("erp-exc-edit-prod-noitems"))}</div>`;return}c.innerHTML=h.map(g=>`<div class="erp-exc-m-cust" style="cursor:default">
...
`;let xo=!1,va=[],Oa=null,Ue="amount_limit",Ts="global";const Wd="/api/knowledge/rules";function Kd(){return localStorage.getItem("mrpilot_token")||""}async function Jt(e,n,a){return fetch(Wd+n,{method:e,headers:{Authorization:"Bearer "+Kd(),"Content-Type":"application/json"},body:a?JSON.stringify(a):void 0})}function Yd(e){const n=Number(e);return Number.isFinite(n)?"฿ "+n.toLocaleString("en-US"):String(e)}function Jd(e){const n=ve(),a=s=>e===s?" selected":"";return`<option value="high"${a("high")}>${n.sevHigh}</option><option value="medium"${a("medium")}>${n.sevMid}</option><option value="low"${a("low")}>${n.sevLow}</option>`}function _o(e,n){const a=n&&n.subject_key?escapeHtml(n.subject_key):"";return`<div class="rs-mlbl">${e}</div><input class="rs-field" id="rs-f-key" value="${a}"${n?" disabled":""}>`}function Xd(e){const n=ve(),a=e.subject_key?escapeHtml(e.subject_key):"";if(e.rule_type==="amount_limit"){const s=Yd(e.rule_body.limit);let o=n.gAmount;e.subject_type==="global"?o=n.anyInvoice:e.subject_type==="supplier"?o=`${n.fSupplierTax} <b>${a}</b>`:o=`「${a}」`;const i=e.rule_body.notify_line?` <span class="rs-line">${ft("bell",12)} ${n.alsoLine}</span>`:"";return`${o} &gt; <b>${s}</b>${i}`}if(e.rule_type==="supplier_force_review")return`<b>${a}</b> · ${n.tForceDesc}`;if(e.rule_type==="no_auto_push_category")return`「${a}」 · ${n.tCategoryDesc}`;if(e.rule_type==="accounting_period"){const o=e.rule_body.mode==="prev_month"?n.pmPrev:n.pmCurrent;return`${n.gPeriodDesc} · <b>${o}</b>`}return e.rule_type}function Zd(e){const n=ve(),a=e.severity||"medium",s=a==="high"?n.sevHigh:a==="low"?n.sevLow:n.sevMid;return`<div class="rs-rule"><div class="rs-rm"><div class="rs-rt">${Xd(e)}</div></div><span class="rs-sev ${a}">${s}</span><button class="rs-sw${e.is_active?"":" off"}" data-toggle="${e.id}" aria-label="toggle"></button><button class="rs-icobtn" data-edit="${e.id}" aria-label="edit">${ft("pencil",14)}</button><button class="rs-icobtn" data-del="${e.id}" aria-label="delete">${ft("trash",14)}</button></div>`}function Mn(e,n,a,s,o){const i=ve(),l=va.filter(m=>o.includes(m.rule_type)).map(Zd).join("")||`<div class="rs-empty">${i.empty}</div>`;return`<div class="rs-group"><div class="rs-ghead"><div class="rs-gico">${ft(e,17)}</div><div><div class="rs-gt">${n}</div><div class="rs-gd">${a}</div></div><button class="rs-addbtn" data-add-type="${s}">${ft("plus",14)} ${i.add}</button></div><div class="rs-gbody">${l}</div></div>`}function Ui(){const e=ve(),n=document.querySelector("#rules-settings-modal .rs-head h2");n&&(n.textContent=e.title);const a=document.getElementById("rs-body");a&&(a.innerHTML=`<p class="rs-lead">${e.lead}</p>`+Mn("building",e.gSupplier,e.gSupplierDesc,"supplier_force_review",["supplier_force_review"])+Mn("wallet",e.gAmount,e.gAmountDesc,"amount_limit",["amount_limit"])+Mn("calendar",e.gPeriod,e.gPeriodDesc,"accounting_period",["accounting_period"])+Mn("octagon",e.gCategory,e.gCategoryDesc,"no_auto_push_category",["no_auto_push_category"]))}async function Ms(){try{const e=await Jt("GET","?include_inactive=1");if(!e.ok)throw new Error("http "+e.status);va=(await e.json()).rules||[],Ui()}catch{showToast(ve().loadFail,"error")}}function Va(e){const n=ve(),a=e?e.severity:Ue==="supplier_force_review"?"high":"medium",s=`<div class="rs-mlbl">${n.fSeverity}</div><select class="rs-field" id="rs-f-sev">${Jd(a)}</select>`;if(Ue==="amount_limit"){const i=e?e.subject_type:Ts,r=e&&e.subject_key?escapeHtml(e.subject_key):"",l=e?String(e.rule_body.limit??""):"",m=e?!!e.rule_body.notify_line:!0,d=i==="global"?"":`<div class="rs-mlbl">${i==="category"?n.fCategory:n.fSupplierTax}</div><input class="rs-field" id="rs-f-key" value="${r}">`;return`<div class="rs-mlbl">${n.gAmountDesc}</div><select class="rs-field" id="rs-f-scope"${e?" disabled":""}><option value="global"${i==="global"?" selected":""}>${n.anyInvoice}</option><option value="supplier"${i==="supplier"?" selected":""}>${n.tForce}</option><option value="category"${i==="category"?" selected":""}>${n.fCategory}</option></select><div id="rs-f-subj">${d}</div><div class="rs-two"><div><div class="rs-mlbl">${n.fAmountLimit}</div><input class="rs-field" id="rs-f-limit" type="number" min="1" value="${l}"></div><div>${s}</div></div><label class="rs-check"><input type="checkbox" id="rs-f-line"${m?" checked":""}>${ft("bell",14)} ${n.fAlsoLine}</label>`}if(Ue==="supplier_force_review")return _o(n.fSupplierTax,e)+s;if(Ue==="no_auto_push_category")return _o(n.fCategory,e)+s;const o=e?e.rule_body.mode:"current_month";return`<div class="rs-mlbl">${n.fPeriodMode}</div><select class="rs-field" id="rs-f-mode"><option value="current_month"${o==="current_month"?" selected":""}>${n.pmCurrent}</option><option value="prev_month"${o==="prev_month"?" selected":""}>${n.pmPrev}</option></select>`+s}function Hn(e,n,a){return`<button class="rs-type${Ue===e?" on":""}" data-type-pick="${e}"><div class="tt">${n}</div><div class="td">${a}</div></button>`}function Qd(e){const n=ve(),a=document.getElementById("rs-add-modal");if(!a)return;const s=e?"":`<div class="rs-mlbl">${n.rType}</div><div class="rs-types">`+Hn("supplier_force_review",n.tForce,n.tForceDesc)+Hn("amount_limit",n.tAmount,n.tAmountDesc)+Hn("accounting_period",n.tPeriod,n.tPeriodDesc)+Hn("no_auto_push_category",n.tCategory,n.tCategoryDesc)+"</div>";a.innerHTML=`<div class="rs-pop" style="max-width:460px;"><div class="rs-head"><h2>${e?n.editTitle:n.addTitle}</h2><button class="rs-close" id="rs-add-close">${ft("x",18)}</button></div><div class="rs-body">${s}<div id="rs-add-fields">${Va(e)}</div></div><div class="rs-foot" style="gap:10px;"><button class="rs-btn rs-btn-ghost" id="rs-add-cancel">${n.cancel}</button><button class="rs-btn rs-btn-primary" id="rs-add-save">${n.save}</button></div></div>`,a.classList.add("rs-open")}function _t(e){const n=document.getElementById(e);return n?String(n.value).trim():""}function ep(){const e=ve(),n=_t("rs-f-sev")||"medium";if(Ue==="amount_limit"){const a=_t("rs-f-scope")||"global",s=Number(_t("rs-f-limit"));if(!Number.isFinite(s)||s<=0)return showToast(e.needAmount,"error"),{ok:!1};const o=a==="global"?null:_t("rs-f-key");if(a!=="global"&&!o)return showToast(a==="category"?e.needCategory:e.needSupplier,"error"),{ok:!1};const i=document.getElementById("rs-f-line")?.checked;return{ok:!0,payload:{rule_type:"amount_limit",subject_type:a,subject_key:o,severity:n,rule_body:{limit:s,basis:"total",period:"per_invoice",notify_line:!!i}}}}if(Ue==="supplier_force_review"){const a=_t("rs-f-key");return a?{ok:!0,payload:{rule_type:"supplier_force_review",subject_type:"supplier",subject_key:a,severity:n,rule_body:{}}}:(showToast(e.needSupplier,"error"),{ok:!1})}if(Ue==="no_auto_push_category"){const a=_t("rs-f-key");return a?{ok:!0,payload:{rule_type:"no_auto_push_category",subject_type:"category",subject_key:a,severity:n,rule_body:{}}}:(showToast(e.needCategory,"error"),{ok:!1})}return{ok:!0,payload:{rule_type:"accounting_period",subject_type:"global",subject_key:null,severity:n,rule_body:{mode:_t("rs-f-mode")||"current_month"}}}}async function tp(){const e=ep();if(!(!e.ok||!e.payload))try{let n;if(Oa!==null){const a=e.payload;n=await Jt("PATCH","/"+Oa,{rule_body:a.rule_body,severity:a.severity})}else n=await Jt("POST","",e.payload);if(!n.ok)throw new Error("http "+n.status);showToast(ve().saved,"success"),document.getElementById("rs-add-modal")?.classList.remove("rs-open"),await Ms()}catch{showToast(ve().saveFail,"error")}}async function np(e){const n=va.find(o=>o.id===e);if(!n)return;const a=!n.is_active;n.is_active=a;const s=document.querySelector(`#rules-settings-modal [data-toggle="${e}"]`);s&&s.classList.toggle("off",!a);try{const o=await Jt("PATCH","/"+e,{is_active:a});if(!o.ok)throw new Error("http "+o.status);showToast(a?ve().enabled:ve().disabled,"success")}catch{n.is_active=!a,s&&s.classList.toggle("off",a),showToast(ve().saveFail,"error")}}async function ap(e){if(await showConfirm(ve().delConfirm,{danger:!0}))try{const a=await Jt("DELETE","/"+e);if(!a.ok)throw new Error("http "+a.status);showToast(ve().deleted,"success"),await Ms()}catch{showToast(ve().saveFail,"error")}}function Eo(e,n){Ue=e,Ts="global",Oa=n?n.id:null,Qd(n)}function sp(){if(xo)return;const e=document.createElement("style");e.textContent=Gd,document.head.appendChild(e);const n=ve(),a=document.createElement("div");a.id="rules-settings-modal",a.innerHTML=`<div class="rs-pop"><div class="rs-head"><h2>${n.title}</h2><span class="rs-tag">●</span><button class="rs-close" id="rs-main-close">${ft("x",18)}</button></div><div class="rs-body" id="rs-body"></div><div class="rs-foot"><button class="rs-btn rs-btn-primary" id="rs-done">${n.done}</button></div></div>`,document.body.appendChild(a);const s=document.createElement("div");s.id="rs-add-modal",document.body.appendChild(s),document.addEventListener("click",o=>{const i=o.target;(i.id==="rules-settings-modal"||i.closest("#rs-main-close")||i.closest("#rs-done"))&&a.classList.remove("rs-open"),(i.id==="rs-add-modal"||i.closest("#rs-add-close")||i.closest("#rs-add-cancel"))&&s.classList.remove("rs-open");const r=i.closest("[data-add-type]");r&&Eo(r.dataset.addType);const l=i.closest("[data-edit]");if(l){const c=va.find(u=>u.id===Number(l.dataset.edit));c&&Eo(c.rule_type,c)}const m=i.closest("[data-del]");m&&ap(Number(m.dataset.del));const d=i.closest("[data-toggle]");d&&np(Number(d.dataset.toggle));const p=i.closest("[data-type-pick]");if(p){Ue=p.dataset.typePick,document.querySelectorAll("#rs-add-modal .rs-type").forEach(u=>u.classList.toggle("on",u.dataset.typePick===Ue));const c=document.getElementById("rs-add-fields");c&&(c.innerHTML=Va())}i.closest("#rs-add-save")&&tp()}),document.addEventListener("change",o=>{const i=o.target;if(i.id==="rs-f-scope"){Ts=i.value;const r=document.getElementById("rs-add-fields");r&&(r.innerHTML=Va())}}),document.addEventListener("keydown",o=>{o.key==="Escape"&&(s.classList.contains("rs-open")?s.classList.remove("rs-open"):a.classList.contains("rs-open")&&a.classList.remove("rs-open"))}),xo=!0}window.openRulesSettings=function(){sp(),document.getElementById("rules-settings-modal").classList.add("rs-open"),Ms()};function op(){const e=document.querySelector("#page-exceptions .page-head-actions");if(!e||document.getElementById("exc-rules-btn"))return;const n=document.createElement("button");n.id="exc-rules-btn",n.type="button",n.className="btn btn-ghost",n.innerHTML=ft("settings",16)+`<span class="rs-btn-label">${ve().btn}</span>`,n.addEventListener("click",()=>window.openRulesSettings&&window.openRulesSettings()),e.insertBefore(n,e.firstChild)}let Io=!1;async function ip(){if(!Io){Io=!0;try{(await Jt("GET","")).ok&&op()}catch{}}}const Bo=window.loadExceptionsPage;window.loadExceptionsPage=function(){ip(),Bo&&Bo()};Array.isArray(window.__i18nSubs)||(window.__i18nSubs=[]);window.__i18nSubs.push({name:"rules-settings",fn:()=>{const e=document.querySelector("#exc-rules-btn .rs-btn-label");e&&(e.textContent=ve().btn),document.getElementById("rules-settings-modal")?.classList.contains("rs-open")&&Ui()}});(function(){const e=document.getElementById("page-knowledge");if(!(!e||e.dataset.wbInjected==="1")){if(!document.getElementById("kb-center-style")){const n=document.createElement("style");n.id="kb-center-style",n.textContent=`
...
`,e.dataset.wbInjected="1";try{const n=window._currentLang||localStorage.getItem("mrpilot_lang")||"th",a=window.I18N;a&&a[n]&&e.querySelectorAll("[data-i18n]").forEach(s=>{const o=s.getAttribute("data-i18n");a[n][o]&&(s.textContent=a[n][o])})}catch{}}})();const rp="/api/knowledge",bt="/static/brand/kb-cat.png?v=2";function lp(){return localStorage.getItem("mrpilot_token")||""}function N(e,n){if(typeof window.t=="function"){const a=window.t(e);if(a&&a!==e)return a}return n}function K(e){return typeof escapeHtml=="function"?escapeHtml(String(e??"")):String(e??"")}const Lo={file:'<path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><path d="M14 2v6h6"/>',"file-text":'<path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><path d="M14 2v6h6"/><path d="M16 13H8"/><path d="M16 17H8"/><path d="M10 9H8"/>',sheet:'<rect width="18" height="18" x="3" y="3" rx="2"/><path d="M3 9h18"/><path d="M3 15h18"/><path d="M9 3v18"/><path d="M15 3v18"/>',image:'<rect width="18" height="18" x="3" y="3" rx="2"/><circle cx="9" cy="9" r="2"/><path d="m21 15-3.1-3.1a2 2 0 0 0-2.8 0L6 21"/>',upload:'<path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><path d="M14 2v6h6"/><path d="M12 18v-6"/><path d="m9 15 3-3 3 3"/>',message:'<path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/>',"shield-check":'<path d="M20 13c0 5-3.5 7.5-7.7 9a1 1 0 0 1-.7 0C7.5 20.5 4 18 4 13V6a1 1 0 0 1 1-1c2 0 4.5-1.2 6.2-2.7a1.2 1.2 0 0 1 1.6 0C14.5 3.8 17 5 19 5a1 1 0 0 1 1 1z"/><path d="m9 12 2 2 4-4"/>',check:'<path d="M20 6 9 17l-5-5"/>',x:'<path d="M18 6 6 18"/><path d="M6 6l12 12"/>'};function Ge(e){return`<svg class="kb-ic" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round">${Lo[e]||Lo.file}</svg>`}function Gi(e){const n=`kb-${e}-mask`,a=`kb-${e}-modal`,s=()=>document.getElementById(n)?.classList.add("open"),o=()=>document.getElementById(n)?.classList.remove("open");let i=document.getElementById(n);if(!i){i=document.createElement("div"),i.id=n,i.className=`kb-${e}-mask`,i.innerHTML=`<div class="kb-${e}-modal" id="${a}" role="dialog" aria-modal="true"></div>`,document.body.appendChild(i);const r=i;r.addEventListener("click",l=>{(l.target===r||l.target.closest(`[data-kb-${e}-close]`))&&o()}),document.addEventListener("keydown",l=>{l.key==="Escape"&&r.classList.contains("open")&&o()})}return{modal:document.getElementById(a),open:s,close:o}}function ha(){const e=window.getActiveWorkspaceClientId;if(typeof e!="function")return null;const n=e(),a=Number(n);return Number.isFinite(a)&&a>0?a:null}function Wi(){const e=ha();if(!e)return"";const a=(window._workspaceClientsCache||[]).find(s=>Number(s.id)===e);return a&&a.name?String(a.name):"#"+e}async function nn(e,n,a,s={}){const o=new URL(rp+n,location.origin),i=ha();if(s.query)for(const[d,p]of Object.entries(s.query))p!=null&&o.searchParams.set(d,String(p));const r=s.withWorkspace!==!1&&i!=null;r&&(e==="GET"||e==="DELETE")&&o.searchParams.set("workspace_client_id",String(i));const l={Authorization:"Bearer "+lp()};let m=s.raw;if(!s.raw&&a!==void 0){const d=r?{workspace_client_id:i,...a}:a;l["Content-Type"]="application/json",m=JSON.stringify(d)}try{const d=await fetch(o.toString(),{method:e,headers:l,body:m});let p=null,c;const u=await d.text();if(u)try{const f=JSON.parse(u);d.ok?p=f:c=f?.detail?.error_code||f?.message_key||f?.detail||void 0}catch{}return{ok:d.ok,status:d.status,data:p,error:c}}catch{return{ok:!1,status:0,data:null,error:"network"}}}async function cp(e,n){const a=new FormData;a.append("file",e);const s=ha();return s!=null&&a.append("workspace_client_id",String(s)),nn("POST","/documents",void 0,{raw:a,withWorkspace:!1})}let An=null;async function Ki(){if(An!==null)return An;const e=await nn("GET","/bases",void 0,{withWorkspace:!1});return An=e.status===200||e.status===401||e.status===403,An}let $o=!1;function Yi(){const e=document.getElementById("kb-ws-bar"),n=document.getElementById("kb-ws-label");if(!e||!n)return;ha()?(e.classList.remove("kb-ws-empty"),n.innerHTML=N("kb-ws-current","账套主体")+"：<b>"+K(Wi())+"</b>"):(e.classList.add("kb-ws-empty"),n.textContent=N("kb-ws-none","请先在右上角选择账套主体,再使用客户私有文档与问答。"))}function dp(e){document.querySelectorAll(".kb-tab-bar .recon-tab-btn").forEach(n=>{n.classList.toggle("active",n.dataset.kbTab===e)}),document.querySelectorAll(".kb-pane").forEach(n=>{n.classList.toggle("active",n.id==="kb-pane-"+e)}),e==="docs"&&typeof window._kbRenderDocs=="function"&&window._kbRenderDocs(),e==="qa"&&typeof window._kbRenderAsk=="function"&&window._kbRenderAsk()}function pp(){if($o)return;const e=document.querySelector(".kb-tab-bar");if(!e)return;e.addEventListener("click",s=>{const o=s.target.closest(".recon-tab-btn");o&&o.dataset.kbTab&&dp(o.dataset.kbTab)});const n=document.getElementById("kb-open-rules");n&&n.addEventListener("click",()=>{typeof window.openRulesSettings=="function"&&window.openRulesSettings()});const a=document.getElementById("kb-info-btn");a&&a.addEventListener("click",()=>{typeof window._kbOpenInfo=="function"&&window._kbOpenInfo()}),$o=!0}window.loadKnowledgePage=function(){pp(),Yi(),document.querySelector('.kb-tab-bar .recon-tab-btn[data-kb-tab="docs"]')?.classList.contains("active")&&typeof window._kbRenderDocs=="function"&&window._kbRenderDocs()};async function So(){if(!window._knowledgeProbed){window._knowledgeProbed=!0;try{if(await Ki()){const e=document.getElementById("nav-knowledge");e&&(e.style.display="")}}catch{}}}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",So):So();Array.isArray(window.__i18nSubs)||(window.__i18nSubs=[]);window.__i18nSubs.push({name:"knowledge-center",fn:Yi});let Ua=!1,ct=[];function up(e){if(e.status==="ready")return`<span class="kb-badge ready"><span class="kb-bdot"></span>${K(N("kb-doc-ready","已就绪"))}</span>`;if(e.status==="failed")return`<span class="kb-badge failed"><span class="kb-bdot"></span>${K(N("kb-doc-failed","失败"))}</span>`;const n=e.status==="uploading"?N("kb-doc-uploading","上传中…"):N("kb-doc-parsing","解析中");return`<span class="kb-badge parsing"><span class="kb-bdot"></span>${K(n)}</span>`}function mp(e){return e==="unsupported_document"?N("kb-err-unsupported_document","不支持的文件类型"):e==="embedding_failed"?N("kb-err-embedding_failed","向量化失败，可重试"):e==="processing_failed"?N("kb-err-processing_failed","文件无法解析，可能已损坏或加密"):e?N("kb-doc-failed","失败"):""}function fp(e){return(e||"").slice(0,10)}function vp(e){let n;e.status==="failed"&&e.error_code?n=`<div class="kb-doc-sub err">${K(mp(e.error_code))}</div>`:e.status==="uploading"?n=`<div class="kb-doc-sub">${K(N("kb-doc-uploading","上传中…"))}</div>`:n=`<div class="kb-doc-sub">${K((e.source_type||"").toUpperCase())} · ${K(fp(e.created_at))}</div>`;const a=e.status==="uploading"?"":`<button class="btn btn-sm btn-ghost kb-doc-del" data-id="${e.id}">${K(N("kb-doc-delete","删除"))}</button>`;return`<div class="kb-doc-row" data-id="${e.id}">
        <div class="kb-doc-ic">${hp(e.source_type)}</div>
        <div class="kb-doc-meta"><div class="kb-doc-name">${K(e.filename)}</div>${n}</div>
        ${up(e)}${a}
    </div>`}function hp(e){const n=(e||"").toLowerCase();return n==="doc"||n==="docx"?Ge("file-text"):n==="xls"||n==="xlsx"||n==="csv"?Ge("sheet"):["png","jpg","jpeg","webp"].includes(n)?Ge("image"):Ge("file")}function Ji(){return document.getElementById("kb-doc-list")}function kn(){const e=Ji();if(e){if(!ct.length){e.innerHTML=`<div class="kb-empty">
            ...
            <h4>${K(N("kb-doc-empty-title","还没有文档"))}</h4>
            <div>${K(N("kb-doc-empty","上传客户合同、采购政策、税务登记等资料，AI 检查发票和问答时引用。"))}</div>
        </div>`;return}e.innerHTML=ct.map(vp).join("")}}function Co(e){const n=Ji();n&&(n.innerHTML=e)}async function Xi(){Co('<div class="kb-skel"><div class="kb-skrow"></div><div class="kb-skrow"></div><div class="kb-skrow"></div></div>');const e=await nn("GET","/documents");if(!e.ok){Co(`<div class="kb-empty err">
            <div>${K(N("kb-doc-error","加载失败"))}</div>
            <button class="btn btn-sm kb-doc-reload" style="margin-top:12px">${K(N("kb-doc-retry","重试"))}</button>
        </div>`);return}ct=(e.data?.documents||[]).filter(n=>n.status!=="deleted"),kn()}async function To(e){const n=Array.from(e);if(n.length)for(const a of n){const s=-Date.now()-Math.floor(Math.random()*1e3);ct.unshift({id:s,filename:a.name,source_type:(a.name.split(".").pop()||"").toLowerCase(),status:"uploading",error_code:null,created_at:new Date().toISOString()}),kn();const o=await cp(a),i=ct.findIndex(r=>r.id===s);i<0||(o.ok&&o.data?.document?(ct[i]=o.data.document,o.data.document.status==="failed"&&showToast(N("kb-doc-failed","失败")+"："+a.name,"error")):(ct.splice(i,1),showToast(N("kb-upload-fail","上传失败")+"："+a.name,"error")),kn())}}async function gp(e){if(!(typeof showConfirm=="function"?await showConfirm(N("kb-doc-del-confirm","确定删除这份文档？删除后 AI 将不再引用它。")):!0))return;(await nn("DELETE","/documents/"+e)).ok?(ct=ct.filter(s=>s.id!==e),kn()):showToast(N("kb-doc-del-fail","删除失败"),"error")}function bp(){const e=document.getElementById("kb-pane-docs");if(!e||Ua&&e.querySelector("#kb-doc-list"))return;if(!document.getElementById("kb-docs-style")){const s=document.createElement("style");s.id="kb-docs-style",s.textContent=`
...
`,document.head.appendChild(s)}e.innerHTML=`
    ...
    `;try{const s=window._currentLang||localStorage.getItem("mrpilot_lang")||"th",o=window.I18N;o&&o[s]&&e.querySelectorAll("[data-i18n]").forEach(i=>{const r=i.getAttribute("data-i18n");o[s][r]&&(i.textContent=o[s][r])})}catch{}const n=e.querySelector("#kb-up"),a=e.querySelector("#kb-file");n.addEventListener("click",s=>{s.target.closest("input")||a.click()}),a.addEventListener("change",()=>{a.files&&To(a.files),a.value=""}),["dragenter","dragover"].forEach(s=>n.addEventListener(s,o=>{o.preventDefault(),n.classList.add("drag")})),["dragleave","drop"].forEach(s=>n.addEventListener(s,o=>{o.preventDefault(),n.classList.remove("drag")})),n.addEventListener("drop",s=>{const o=s.dataTransfer;o?.files?.length&&To(o.files)}),e.addEventListener("click",s=>{const o=s.target,i=o.closest(".kb-doc-del");if(i?.dataset.id){gp(Number(i.dataset.id));return}o.closest(".kb-doc-reload")&&Xi()}),Ua=!0}function yp(){bp(),Xi()}window._kbRenderDocs=yp;Array.isArray(window.__i18nSubs)||(window.__i18nSubs=[]);window.__i18nSubs.push({name:"knowledge-documents",fn:()=>{Ua&&kn()}});let Xn=null;function wp(){if(Xn)return;const e=document.createElement("style");e.id="kb-src-style",e.textContent=`
...
`,document.head.appendChild(e),Xn=Gi("src")}function kp(e){const n=K(e.text).replace(/\n/g,"<br>");return`<span class="seg${e.matched?" hit":""}">${n}</span>`}function xp(e){return e.segments.map(kp).join("<br><br>")}async function _p(e){wp();const n=Xn?.modal;if(!n)return;const a=e.filename||N("kb-src-unknown","未知来源"),s=typeof e.score=="number"?Math.round(Math.max(0,Math.min(1,e.score))*100):null,o=typeof e.chunk_id=="number";if(n.innerHTML=`
        <div class="kb-src-head">
            <span class="ic">${Ge("file")}</span>
            <div>
                <h3>${K(a)}</h3>
                <div class="sub">${K(N(o?"kb-src-hit":"kb-src-from",o?"命中片段已高亮":"此结论引用自以下文档"))}</div>
            </div>
            <button class="x" data-kb-src-close aria-label="close">${Ge("x")}</button>
        </div>
        <div class="kb-src-body">
            ${s!==null?`<div class="kb-src-rel">${K(N("kb-src-relevance","相关度"))} ${s}%</div>`:""}
            <div class="kb-src-preview" id="kb-src-preview">${o?`<div class="kb-src-loading">${K(N("kb-src-loading","正在取原文…"))}</div>`:`<div class="kb-src-fail">${K(N("kb-src-no-chunk","可在文档库打开原件核对。"))}</div>`}</div>
            <p class="kb-src-foot">${K(N("kb-src-verifiable","这就是「可核对」:AI 说的每句话都能点回原文这一句,会计自己一眼能确认,不用盲信。"))}</p>
        </div>
    `,Xn?.open(),!o)return;const i=await nn("GET","/chunks/"+e.chunk_id),r=n.querySelector("#kb-src-preview");r&&(i.ok&&i.data?.segments?.length?r.innerHTML=xp(i.data):r.innerHTML=`<div class="kb-src-fail">${K(N("kb-src-load-fail","原文片段暂时取不到,可在文档库打开原件核对。"))}</div>`)}window._kbOpenSource=e=>{_p(e)};function Ep(e){return`<div class="kb-msg user"><div class="kb-bub">${K(e)}</div></div>`}function Ip(e){const n=e.filename||N("kb-src-unknown","未知来源");return`<button class="kb-cite" data-cite='${K(JSON.stringify(e))}'>
        ...
        ${K(n)}<span class="ch">›</span></button>`}function Bp(e){if(e.no_answer){const a=N(e.message_key||"ask.no_source","资料不足，无法判断。");return`<div class="kb-msg ai"><div class="kb-ava"><img src="${bt}" alt=""></div>
            <div class="kb-bub no-src">${K(a)}</div></div>`}const n=(e.citations||[]).map(a=>Ip(a)).join("");return`<div class="kb-msg ai"><div class="kb-ava"><img src="${bt}" alt=""></div>
        <div class="kb-bub">${K(e.answer)}${n?`<div class="kb-cites">${n}</div>`:""}</div></div>`}function Lp(e){return nn("POST","/ask",{question:e})}function Mo(e){return`<div class="kb-msg ai"><div class="kb-ava"><img src="${bt}" alt=""></div><div class="kb-bub no-src">${K(e)}</div></div>`}function Zi(e,n,a){if(e.dataset.kbWired==="1")return;e.dataset.kbWired="1";let s=!1;function o(r){const l=document.createElement("div");l.innerHTML=r;const m=l.firstElementChild;return e.appendChild(m),e.scrollTop=e.scrollHeight,m}async function i(){const r=n.value.trim();if(!r||s)return;s=!0,n.value="",o(Ep(r));const l=o(`<div class="kb-msg ai"><div class="kb-ava"><img src="${bt}" alt=""></div><div class="kb-bub kb-thinking">${K(N("kb-ask-thinking","思考中…"))}</div></div>`),m=await Lp(r);if(l.remove(),m.status===402){const d=N("kb-ask-low-balance","余额不足，请先充值后再提问。");o(Mo(d)),typeof showToast=="function"&&showToast(d,"error")}else if(!m.ok||!m.data){const d=N("kb-ask-error","出错了，请稍后重试。");o(Mo(d)),typeof showToast=="function"&&showToast(d,"error")}else o(Bp(m.data));s=!1}a.addEventListener("click",i),n.addEventListener("keydown",r=>{r.key==="Enter"&&!r.shiftKey&&(r.preventDefault(),i())}),e.addEventListener("click",r=>{const l=r.target.closest(".kb-cite");if(!(!l||!l.dataset.cite))try{const m=JSON.parse(l.dataset.cite);typeof window._kbOpenSource=="function"&&window._kbOpenSource(m)}catch{}})}window._kbWireAsk=Zi;function $p(){if(document.getElementById("kb-ask-style"))return;const e=document.createElement("style");e.id="kb-ask-style",e.textContent=`
...
`,document.head.appendChild(e)}function Sp(){const e=document.getElementById("kb-pane-qa");if(!e||e.dataset.kbBuilt==="1")return;$p();const n=K(N("kb-ask-ex1","这家客户有金额上限吗？")),a=K(N("kb-ask-ex2","合同约定的付款周期是多久？")),s=K(N("kb-ask-ex3","哪些供应商需要人工复核？")),o=typeof window._kbFabEnabled=="function"&&window._kbFabEnabled();e.innerHTML=`
        <div class="kb-ft">
            <span class="ft-cat"><img src="${bt}" alt=""></span>
            <div class="ft-txt">
                <b>${K(N("kb-fab-toggle","桌面悬浮问答助手"))}</b>
                <div class="sub">${K(N("kb-fab-toggle-sub","打开后任意页面右下角常驻一只猫，随手就能问，可长按拖到屏幕任意一边。"))}</div>
            </div>
            <button class="kb-switch${o?" on":""}" id="kb-fab-switch" role="switch" aria-checked="${o}"></button>
        </div>
        <div class="kb-qa">
            <div class="kb-qa-thread" id="kb-qa-thread">
                <div class="kb-msg ai"><div class="kb-ava"><img src="${bt}" alt=""></div>
                <div class="kb-bub">${K(N("kb-ask-empty","问点关于这家客户的事，答案都带合同原文出处；查不到时如实说「资料不足」。"))}</div></div>
            </div>
            <div class="kb-qa-foot">
                ...
                <div class="kb-qa-input">
                    <input id="kb-qa-input" data-i18n-placeholder="kb-ask-placeholder" placeholder="${K(N("kb-ask-placeholder","问点关于这家客户的事…"))}">
                    <button class="kb-send" id="kb-qa-send"><svg viewBox="0 0 24 24"><path d="M12 19V5M5 12l7-7 7 7"/></svg></button>
                </div>
            </div>
        </div>
        <p class="kb-qa-hint">${K(N("kb-ask-disclaimer","AI 的每个结论都带可点开的出处；查不到依据时固定回答「资料不足」，绝不编。"))}</p>
    `,e.dataset.kbBuilt="1";const i=e.querySelector("#kb-qa-thread"),r=e.querySelector("#kb-qa-input"),l=e.querySelector("#kb-qa-send");Zi(i,r,l),e.querySelectorAll(".kb-chip").forEach(d=>{d.addEventListener("click",()=>{r.value=d.dataset.q||"",l.click()})});const m=e.querySelector("#kb-fab-switch");m?.addEventListener("click",()=>{const d=!m.classList.contains("on");m.classList.toggle("on",d),m.setAttribute("aria-checked",String(d)),typeof window._kbFabSetEnabled=="function"&&window._kbFabSetEnabled(d)})}window._kbRenderAsk=Sp;const Hs="pearnly_kb_fab",Ga=bt,dt=14;let Wa=!1,Ho=!1;function Cp(){if(document.getElementById("kb-fab-style"))return;const e=document.createElement("style");e.id="kb-fab-style",e.textContent=`
...
`,document.head.appendChild(e)}let Z,mt,Fn,Ce;function Tp(){Wa||(Cp(),Z=document.createElement("div"),Z.className="kb-fab",Z.id="kb-fab",Z.innerHTML=`
        <span class="kb-say" id="kb-say">${N("kb-fab-hi","喵~")}</span>
        <button class="kb-fab-btn" id="kb-fab-btn" aria-label="${N("kb-fab-aria","问 AI")}"><img src="${Ga}" alt=""></button>`,document.body.appendChild(Z),Ce=document.createElement("div"),Ce.className="kb-card",Ce.id="kb-card",Ce.innerHTML=`
        <div class="kb-card-top">
            <div class="tt"><span class="mini"><img src="${Ga}" alt=""></span> ${N("kb-fab-title","客户知识助手")}</div>
        ...
        <div class="kb-qa-input">
            <input id="kb-card-input" placeholder="${N("kb-fab-ph","随处可问，不跳页…")}">
            <button class="kb-send" id="kb-card-send"><svg viewBox="0 0 24 24"><path d="M12 19V5M5 12l7-7 7 7"/></svg></button>
        </div>`,document.body.appendChild(Ce),mt=Z.querySelector("#kb-fab-btn"),Fn=Z.querySelector("#kb-say"),document.getElementById("kb-card-x")?.addEventListener("click",Ka),document.addEventListener("keydown",e=>{e.key==="Escape"&&Ka()}),Rp(),Dp(),qp(),Wa=!0)}function Mp(){const e=document.getElementById("kb-card-thread"),n=document.getElementById("kb-card-input"),a=document.getElementById("kb-card-send");!Ho&&typeof window._kbWireAsk=="function"&&(e.innerHTML=`<div class="kb-msg ai"><div class="kb-ava"><img src="${Ga}" alt=""></div><div class="kb-bub">${N("kb-ask-empty","问点关于这家客户的事，答案都带出处；查不到时如实说「资料不足」。")}</div></div>`,window._kbWireAsk(e,n,a),Ho=!0);const s=document.getElementById("kb-card-ws");s&&(s.textContent=Wi()||N("kb-fab-no-ws","未选账套")),Hp(),Ce.classList.add("open"),jp(),Qi(["💛","✨","💙","🐾"])}function Ka(){Ce?.classList.remove("open")}function Hp(){const e=Z.getBoundingClientRect(),n=520,a=e.left+e.width/2<window.innerWidth/2,s=Math.min(Math.max(dt,e.top+e.height/2-n/2),window.innerHeight-n-dt);Ce.style.top=s+"px",a?(Ce.style.left=e.right+12+"px",Ce.style.right="auto"):(Ce.style.right=window.innerWidth-e.left+12+"px",Ce.style.left="auto")}let Ao;function Ap(e,n=1500){Fn.textContent=e,Fn.classList.add("show"),clearTimeout(Ao),Ao=setTimeout(()=>Fn.classList.remove("show"),n)}function jp(){mt.classList.remove("jump"),mt.classList.add("cheer"),setTimeout(()=>mt.classList.remove("cheer"),650)}function Pp(){Z.classList.contains("lifted")||(mt.classList.remove("cheer"),mt.classList.add("jump"),setTimeout(()=>mt.classList.remove("jump"),720))}function Qi(e){for(let n=0;n<5;n++){const a=document.createElement("span");a.className="kb-spark",a.textContent=e[n%e.length],a.style.setProperty("--dx",n*14-28+"px"),a.style.left=30+n*10+"%",a.style.animationDelay=n*40+"ms",Z.appendChild(a),setTimeout(()=>a.remove(),1100)}}function Dp(){const e=[N("kb-fab-hi","喵?"),N("kb-fab-ask","问我呀!"),"🐾"];mt.addEventListener("mouseenter",()=>{Z.classList.contains("lifted")||Ap(e[(Date.now()/1e3|0)%e.length],1400)}),setInterval(()=>{!Z.classList.contains("on")||Z.classList.contains("lifted")||Ce.classList.contains("open")||(Date.now()/1e3|0)%2===0&&(Pp(),Qi(["✨","🐾"]))},5400)}function $a(e){return Math.min(Math.max(dt,e),window.innerHeight-Z.offsetHeight-dt)}function qp(){Z.classList.add("snapping"),Z.style.left=window.innerWidth-56-dt+"px",Z.style.top="62%"}function Rp(){let e,n=!1,a=!1,s=0,o=0,i=0,r=0;function l(c){s=c.clientX,o=c.clientY,a=!1,n=!1;const u=Z.getBoundingClientRect();i=u.left,r=u.top,Z.classList.remove("snapping"),e=setTimeout(()=>{Z.classList.add("lifted")},180),window.addEventListener("pointermove",m),window.addEventListener("pointerup",d),c.preventDefault()}function m(c){const u=c.clientX-s,f=c.clientY-o;!n&&Math.hypot(u,f)>6&&(n=!0,Z.classList.add("lifted"),clearTimeout(e)),n&&(a=!0,Z.style.left=i+u+"px",Z.style.top=$a(r+f)+"px")}function d(){if(clearTimeout(e),window.removeEventListener("pointermove",m),window.removeEventListener("pointerup",d),Z.classList.remove("lifted"),!a){Mp();return}p()}function p(){const c=Z.getBoundingClientRect();Z.classList.add("snapping"),Z.style.top=$a(c.top)+"px",Z.style.left=(c.left+c.width/2<window.innerWidth/2?dt:window.innerWidth-Z.offsetWidth-dt)+"px"}mt.addEventListener("pointerdown",l),window.addEventListener("resize",()=>{if(!Wa)return;const c=Z.getBoundingClientRect();Z.style.top=$a(c.top)+"px",Z.style.left=(c.left+c.width/2<window.innerWidth/2?dt:window.innerWidth-Z.offsetWidth-dt)+"px"})}function er(e){Tp(),localStorage.setItem(Hs,e?"1":"0"),Z.classList.toggle("on",e),e||Ka()}window._kbFabSetEnabled=er;window._kbFabEnabled=()=>localStorage.getItem(Hs)==="1";async function jo(){if(localStorage.getItem(Hs)==="1")try{await Ki()&&er(!0)}catch{}}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",jo):jo();let Zn=null;function Fp(){if(Zn)return;const e=document.createElement("style");e.id="kb-info-style",e.textContent=`
...
`,document.head.appendChild(e),Zn=Gi("info")}function jn(e,n){return`<li><span class="ck">${Ge("check")}</span><span>${K(N(e,n))}</span></li>`}function Sa(e,n,a,s,o,i,r){return`<div class="row"><div class="pi">${e}</div>
        <div class="pm"><b>${K(N(n,a))}</b><div class="d">${K(N(s,o))}</div></div>
        <span class="amt">${K(N(i,r))}</span></div>`}function zp(){const e=Zn?.modal;e&&(e.innerHTML=`
        <div class="kb-info-head">
            <span class="ic"><img src="${bt}" alt=""></span>
            <div>
                <h2>${K(N("kb-info-title","客户知识助手是什么"))}</h2>
                <div class="lead">${K(N("kb-info-lead","把每家客户的合同与规矩，变成系统记得住、能自动执行、还能随时问的「活资料」。"))}</div>
            </div>
            <button class="x" data-kb-info-close aria-label="close">${Ge("x")}</button>
        </div>
        <div class="kb-info-body">
            <div class="kb-info-h"><span class="l"></span>${K(N("kb-info-use-h","它真正帮你省什么"))}</div>
            <ul class="kb-info-use">
                ${jn("kb-info-use1","把客户的合同、采购政策、内部规矩上传一次，AI 读懂后建成可检索的资料库 —— 不用再翻文件夹找合同。")}
                ${jn("kb-info-use2","做账时 AI 自动按这家客户的规矩检查发票：金额超上限、供应商要不要人工复核、差旅超标…… 异常当场标出来。")}
                ${jn("kb-info-use3","任意页面右下角随手问「这家客户能不能这样报」，答案都带合同原文出处，点一下就能核对，AI 不瞎编。")}
                ${jn("kb-info-use4","把老会计脑子里记的客户规矩，变成系统记住、新人也能直接上手 —— 给多家公司做账的事务所尤其值。")}
            </ul>
            <div class="kb-info-h"><span class="l"></span>${K(N("kb-info-cost-h","费用怎么算"))}</div>
            <p style="font-size:12.5px;color:var(--ink-2,#555);margin:0 0 11px;line-height:1.55">${K(N("kb-info-cost-lead","从你的泰铢余额按用量扣，不用不花，跟 OCR 共用一个余额池："))}</p>
            <div class="kb-info-price">
                ${Sa(Ge("upload"),"kb-info-c1-n","上传建库","kb-info-c1-d","PDF / 图片按页、文档按字符 —— 跟现在 OCR 同价","kb-info-c1-amt","฿1.50/页起")}
                ${Sa(Ge("message"),"kb-info-c2-n","AI 问答","kb-info-c2-d","每次带合同原文出处的回答","kb-info-c2-amt","฿0.50/次")}
                ${Sa(Ge("shield-check"),"kb-info-c3-n","自动发票检查","kb-info-c3-d","死规则:算术 / 税号 / 查重 / 客户规矩","kb-info-c3-amt","免费")}
            </div>
            <div class="kb-info-tbd"><span>${K(N("kb-info-note","充值与扣费跟现有 OCR 共用同一个泰铢余额；问答按真实成本加合理毛利定价（与 OCR 同档）。"))}</span></div>
        </div>
        <div class="kb-info-foot"><button class="btn btn-primary" data-kb-info-close>${K(N("kb-info-close","知道了"))}</button></div>
    `)}function Np(){Fp(),zp(),Zn?.open()}window._kbOpenInfo=Np;const tr={tax_invoice:"sx-dt-tax_invoice",tax_invoice_receipt:"sx-dt-tax_invoice_receipt",tax_invoice_simple:"sx-dt-tax_invoice_simple",receipt:"sx-dt-receipt",quotation:"sx-dt-quotation",credit_note:"sx-dt-credit_note",debit_note:"sx-dt-debit_note"};function As(e){const n=e?tr[e]:null;return n?t(n):e||"—"}function je(e){return Number(e||0).toLocaleString("en-US",{minimumFractionDigits:2,maximumFractionDigits:2})}function js(e){return e?e.slice(0,10):"—"}function Op(){const e={Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||"")};try{const n=window._wsHeader&&window._wsHeader();n&&Object.assign(e,n)}catch{}return e}function wt(e,n={}){return fetch(e,{...n,headers:{...Op(),...n.headers||{}}})}const Vp=Object.freeze(Object.defineProperty({__proto__:null,DOC_TYPE_KEY:tr,docTypeLabel:As,fmtDate:js,fmtMoney:je,salesFetch:wt},Symbol.toStringTag,{value:"Module"})),Se={x:'<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.9"><path d="M18 6 6 18M6 6l12 12"/></svg>',dl:'<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.9"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4M7 10l5 5 5-5M12 15V3"/></svg>',print:'<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.9"><path d="M6 9V2h12v7M6 18H4a2 2 0 0 1-2-2v-5a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2v5a2 2 0 0 1-2 2h-2M6 14h12v8H6z"/></svg>',send:'<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.9"><path d="m22 2-7 20-4-9-9-4Z"/></svg>',ban:'<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.9"><circle cx="12" cy="12" r="9"/><path d="m5 5 14 14"/></svg>',undo:'<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.9"><path d="M3 7v6h6M3 13a9 9 0 1 0 3-7.7L3 8"/></svg>',copy:'<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.9"><path d="M9 9h11v11H9zM5 15H4V4h11v1"/></svg>',qr:'<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.9"><rect x="3" y="3" width="7" height="7"/><rect x="14" y="3" width="7" height="7"/><rect x="3" y="14" width="7" height="7"/><path d="M14 14h3v3h-3zM21 14v7M17 21h4"/></svg>'};let Ya={},Po=null;function Fe(){return document.getElementById("sales-detail-mask")}function fe(){return document.getElementById("sales-action-mask")}function Tt(){Fe().style.display="none",Fe().innerHTML=""}function ke(){fe().style.display="none",fe().innerHTML=""}async function Up(){if(!Object.keys(Ya).length)try{const e=await apiGet("/api/sales/sellers"),n=e&&(e.sellers||e.items||e)||[];if(Array.isArray(n))for(const a of n)Ya[String(a.workspace_client_id??a.id)]=a}catch{}}function Gp(e){const n=Ya[String(e.seller_workspace_client_id??"")]||{},a=(e.lines||[]).map((s,o)=>`<tr><td>${o+1}</td><td>${escapeHtml(String(s.description||"—"))}</td><td style="text-align:right">${je(s.amount??Number(s.qty||0)*Number(s.unit_price||0))}</td></tr>`).join("");return`<div class="sx-inv">
        <div class="sx-cb">ต้นฉบับ</div>
        <h4>${escapeHtml(n.name||t("sx-seller"))}</h4>
        <div class="sx-no">${escapeHtml(As(e.doc_type))} · ${escapeHtml(e.doc_number||t("sx-draft-tag"))} · ${escapeHtml(js(e.issue_date))}</div>
        <div class="sx-pp">
        ...
        <div class="sx-tot">
            <div class="sx-tr"><span>${escapeHtml(t("sx-subtotal"))}</span><span>${je(e.subtotal)}</span></div>
            <div class="sx-tr"><span>VAT ${je(e.vat_rate)}%</span><span>${je(e.vat_amount)}</span></div>
            ${Number(e.wht_amount||0)?`<div class="sx-tr"><span>WHT</span><span>-${je(e.wht_amount)}</span></div>`:""}
            <div class="sx-tr g"><span>${escapeHtml(t("sx-grand"))}</span><span>฿ ${je(e.grand_total)}</span></div>
        </div>
    </div>`}function Wp(e,n,a){return`<button class="btn btn-ghost btn-sm" data-soft="${escapeHtml(a)}">${n}<span>${escapeHtml(e)}</span></button>`}function Kp(e){const n=e.status==="void",a=e.doc_type==="quotation",s=e.status==="issued"&&(e.payment?.status||"unpaid")!=="paid",o=n?`<span style="color:var(--ink-3)">${escapeHtml(t("sx-voided-note"))}</span>`:`<button class="btn btn-ghost btn-sm" data-act="download">${Se.dl}<span>${escapeHtml(t("sx-download"))}</span></button>
           <button class="btn btn-ghost btn-sm" data-act="print">${Se.print}<span>${escapeHtml(t("sx-print"))}</span></button>
           <button class="btn btn-ghost btn-sm" data-act="send">${Se.send}<span>${escapeHtml(t("sx-send-to"))}</span></button>
           ${s?`<button class="btn btn-accent btn-sm" data-act="promptpay">${Se.qr}<span>${escapeHtml(t("sx-promptpay"))}</span></button>`:""}
           ${Wp(t("sx-copy"),Se.copy,"sx-copy-soon")}`,i=n?"":`${a?`<button class="btn btn-ghost btn-sm" data-act="convert">${escapeHtml(t("sx-convert"))}</button>`:""}
           <button class="btn btn-ghost btn-sm" data-act="credit">${Se.undo}<span>${escapeHtml(t("sx-credit"))}</span></button>
           <button class="btn btn-ghost btn-sm" data-act="debit"><span>${escapeHtml(t("sx-debit"))}</span></button>
           <button class="btn btn-danger btn-sm" data-act="void">${Se.ban}<span>${escapeHtml(t("sx-void"))}</span></button>`;Fe().innerHTML=`<div class="modal" role="dialog" style="max-width:640px">
        <div class="modal-header">
            ...
            <button class="modal-close" id="sx-detail-close">${Se.x}</button>
        </div>
        <div class="modal-body">
    ...
    </div>`,Fe().style.display="flex",Yp(e)}function Yp(e){document.getElementById("sx-detail-close").onclick=Tt,document.getElementById("sx-detail-close2").onclick=Tt,Fe().onclick=n=>{n.target===Fe()&&Tt()},Fe().querySelectorAll("[data-soft]").forEach(n=>n.onclick=()=>showToast(t(n.dataset.soft),"info")),Fe().querySelectorAll("[data-act]").forEach(n=>n.onclick=()=>tu(n.dataset.act,e))}async function Do(e,n){try{const a=await wt(`/api/sales/documents/${e.id}/pdf?page=A4&copy=original`);if(!a.ok){showToast(t("sx-pdf-fail"),"error");return}const s=URL.createObjectURL(await a.blob()),o=window.open(s,"_blank");n&&o&&o.addEventListener("load",()=>o.print()),setTimeout(()=>URL.revokeObjectURL(s),6e4)}catch{showToast(t("sx-pdf-fail"),"error")}}async function Jp(e){try{const n=await wt(`/api/sales/documents/${e.id}/promptpay-qr`);if(!n.ok){const o=await n.json().catch(()=>({})),i=String(o.detail||"").replace("sales.","");showToast(t("sx-pp-"+i)||t("sx-pp-fail"),"error");return}const a=URL.createObjectURL(await n.blob()),s=Number(e.grand_total||0)-Number(e.payment?.paid_amount||0);fe().innerHTML=`<div class="modal" role="dialog" style="max-width:380px">
            <div class="modal-header"><div class="modal-title">${escapeHtml(t("sx-promptpay"))} · PromptPay</div>
                <button class="modal-close" id="sx-pp-close">${Se.x}</button></div>
            <div class="modal-body" style="text-align:center">
                <div class="sx-qr"><img src="${a}" alt="PromptPay QR"></div>
                <div style="font-weight:700;font-size:16px">฿ ${je(s)}</div>
                <div style="color:var(--ink-3);font-size:12px;margin-top:4px">${escapeHtml(t("sx-pp-scan"))}</div>
            </div></div>`,fe().style.display="flex",document.getElementById("sx-pp-close").onclick=ke,fe().onclick=o=>{o.target===fe()&&ke()},setTimeout(()=>URL.revokeObjectURL(a),12e4)}catch{showToast(t("sx-pp-fail"),"error")}}function qo(e,n){const a=n==="credit_note"?t("sx-credit-title"):t("sx-debit-title");fe().innerHTML=`<div class="modal" role="dialog" style="max-width:460px">
        <div class="modal-header"><div class="modal-title">${escapeHtml(a)}</div>
            <button class="modal-close" id="sx-note-close">${Se.x}</button></div>
        <div class="modal-body">
        ...
        </div></div>`,fe().style.display="flex",document.getElementById("sx-note-close").onclick=ke,document.getElementById("sx-note-cancel").onclick=ke,fe().onclick=s=>{s.target===fe()&&ke()},document.getElementById("sx-note-ok").onclick=async()=>{const s=document.getElementById("sx-note-reason").value.trim(),o=Number(document.getElementById("sx-note-amount").value);if(!(o>0)){showToast(t("sx-note-amount-required"),"error");return}await Ps(`/api/sales/documents/${e.id}/${n==="credit_note"?"credit-note":"debit-note"}`,{reason:s||a,vat_rate:Number(e.vat_rate||7),wht_rate:0,lines:[{description:s||a,qty:1,unit_price:o,vat_applicable:!0}]})&&(ke(),Tt(),showToast(t("sx-done"),"success"),window.dispatchEvent(new CustomEvent("pearnly:sales-changed")))}}function Xp(e){fe().innerHTML=`<div class="modal" role="dialog" style="max-width:440px">
        <div class="modal-header"><div class="modal-title">${escapeHtml(t("sx-void-title"))}</div>
            <button class="modal-close" id="sx-void-close">${Se.x}</button></div>
        ...
        </div></div>`,fe().style.display="flex",document.getElementById("sx-void-close").onclick=ke,document.getElementById("sx-void-cancel").onclick=ke,fe().onclick=n=>{n.target===fe()&&ke()},document.getElementById("sx-void-ok").onclick=async()=>{await Ps(`/api/sales/documents/${e.id}/void`,{})&&(ke(),Tt(),showToast(t("sx-done"),"success"),window.dispatchEvent(new CustomEvent("pearnly:sales-changed")))}}async function Zp(e){await Ps(`/api/sales/documents/${e.id}/convert`,{target_doc_type:"tax_invoice"})&&(Tt(),showToast(t("sx-converted"),"success"),window.dispatchEvent(new CustomEvent("pearnly:sales-changed")))}async function Ps(e,n){try{const a=await apiPost(e,n);if(a&&a.ok)return!0;const s=a?await a.json().catch(()=>({})):{};return showToast(t("sx-action-fail")+(s.detail?" · "+s.detail:""),"error"),!1}catch{return showToast(t("sx-action-fail"),"error"),!1}}let ln="email";function Qp(e,n,a){return`<div class="sx-seg" style="width:100%">${e.map(s=>`<button type="button" data-${a}="${s[0]}" class="${n===s[0]?"on":""}" style="flex:1">${escapeHtml(s[1])}</button>`).join("")}</div>`}function nr(e){const n=ln==="email"?`<div class="sx-banner" style="margin-top:4px">${escapeHtml(t("sx-send-email-hint"))}</div>
        ...
        <div class="modal-header"><div class="modal-title">${escapeHtml(t("sx-send-to-title"))}</div>
            <button class="modal-close" id="sx-send-close">${Se.x}</button></div>
        <div class="modal-body">
            <div class="form-row"><label>${escapeHtml(t("sx-send-how"))}</label>
                ${Qp([["email",t("sx-send-opt-email")],["line",t("sx-send-opt-line")]],ln,"ch")}</div>
            ${n}
        </div>
        <div class="modal-footer" style="justify-content:flex-end;gap:8px">
            <button class="btn btn-ghost" id="sx-send-cancel">${escapeHtml(t("sx-cancel"))}</button>
            <button class="btn btn-primary" id="sx-send-do">${escapeHtml(ln==="email"?t("sx-send-do"):t("sx-send-genlink"))}</button>
        </div></div>`,fe().style.display="flex",document.getElementById("sx-send-close").onclick=ke,document.getElementById("sx-send-cancel").onclick=ke,fe().onclick=a=>{a.target===fe()&&ke()},fe().querySelectorAll("[data-ch]").forEach(a=>a.onclick=()=>(ln=a.dataset.ch,nr(e))),document.getElementById("sx-send-do").onclick=()=>eu(e)}async function eu(e){if(ln==="email"){const o=document.getElementById("sx-send-email").value.trim();if(!o)return showToast(t("sx-send-email-required"),"error");const i=await apiPost(`/api/sales/documents/${e.id}/send`,{channel:"email",to:o});i&&i.ok?(ke(),showToast(t("sx-send-email-ok"),"success")):showToast(t("sx-send-fail"),"error");return}const n=await apiPost(`/api/sales/documents/${e.id}/send`,{channel:"line"}),a=n?await n.json().catch(()=>({})):{};if(!n||!n.ok||!a.share_url)return showToast(t("sx-send-fail"),"error");const s=String(a.share_url);fe().innerHTML=`<div class="modal" role="dialog" style="max-width:480px">
        <div class="modal-header"><div class="modal-title">${escapeHtml(t("sx-send-line-title"))}</div>
            <button class="modal-close" id="sx-link-close">${Se.x}</button></div>
        <div class="modal-body">
        ...
        <div class="modal-footer" style="justify-content:flex-end;gap:8px">
            ...
            <button class="btn btn-primary" id="sx-link-copy">${escapeHtml(t("sx-send-copy"))}</button>
        </div></div>`,document.getElementById("sx-link-close").onclick=ke,document.getElementById("sx-link-done").onclick=ke,document.getElementById("sx-link-copy").onclick=()=>{document.getElementById("sx-link-url").select(),navigator.clipboard?.writeText(s).catch(()=>{}),showToast(t("sx-send-copied"),"success")}}function tu(e,n){if(e==="download")return void Do(n,!1);if(e==="print")return void Do(n,!0);if(e==="send")return nr(n);if(e==="promptpay")return void Jp(n);if(e==="credit")return qo(n,"credit_note");if(e==="debit")return qo(n,"debit_note");if(e==="void")return Xp(n);if(e==="convert")return void Zp(n)}window.openSalesDetail=async function(e){Fe().innerHTML=`<div class="modal" role="dialog" style="max-width:640px"><div class="modal-body"><div class="sx-state">${escapeHtml(t("sx-loading"))}</div></div></div>`,Fe().style.display="flex",await Up();try{const n=await apiGet(`/api/sales/documents/${e}`);if(!n)return;Po=n.document,Kp(Po)}catch{Fe().innerHTML=`<div class="modal" role="dialog" style="max-width:480px"><div class="modal-body"><div class="sx-state error">${escapeHtml(t("sx-error"))}</div></div></div>`;const a=Fe();a.onclick=s=>{s.target===a&&Tt()}}};const nu='<svg width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.4"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8Z"/><path d="M14 2v6h6M8 13h8M8 17h5"/></svg>',au='<svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.9"><circle cx="12" cy="12" r="3"/><path d="M19.4 13a7 7 0 0 0 0-2l2-1.5-2-3.5-2.3 1a7 7 0 0 0-1.7-1L15 3H9l-.4 2.5a7 7 0 0 0-1.7 1l-2.3-1-2 3.5L4.6 11a7 7 0 0 0 0 2l-2 1.5 2 3.5 2.3-1a7 7 0 0 0 1.7 1L9 21h6l.4-2.5a7 7 0 0 0 1.7-1l2.3 1 2-3.5-2-1.5Z"/></svg>',su='<svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="#fff" stroke-width="2.2"><path d="M12 5v14M5 12h14"/></svg>',ou='<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.9"><path d="m9 18 6-6-6-6"/></svg>',iu=["paid","unpaid","partial"];let Qn=[],ea="all",Ds="";function ar(e){const n=e.payment&&e.payment.status||"";return iu.indexOf(n)>=0?n:"unpaid"}function sr(e){return e.buyer&&e.buyer.name||"—"}function ru(e){if(!e)return!1;const n=new Date,a=n.getFullYear()+"-"+String(n.getMonth()+1).padStart(2,"0");return e.slice(0,7)===a}function lu(){const e=Qn.filter(i=>i.status==="issued"),n=e.filter(i=>ru(i.issue_date)),a=n.reduce((i,r)=>i+Number(r.grand_total||0),0),s=Qn.filter(i=>i.status==="draft").length,o=e.filter(i=>ar(i)!=="paid").reduce((i,r)=>i+(Number(r.grand_total||0)-Number(r.payment.paid_amount||0)),0);return{count:n.length,amount:a,drafts:s,due:o}}function cu(){let e=Qn;ea!=="all"&&(e=e.filter(a=>a.status===ea));const n=Ds.trim().toLowerCase();return n&&(e=e.filter(a=>(a.doc_number||"").toLowerCase().indexOf(n)>=0||sr(a).toLowerCase().indexOf(n)>=0)),e}function or(){const e=cu();return e.length?e.map(n=>{const a=ar(n),s=n.doc_number||t("sx-draft-tag");return`<tr class="click" data-doc="${escapeHtml(n.id)}">
                <td><b>${escapeHtml(s)}</b></td>
                <td style="color:var(--ink-3)">${escapeHtml(js(n.issue_date))}</td>
                <td>${escapeHtml(As(n.doc_type))}</td>
                <td>${escapeHtml(sr(n))}</td>
                <td class="r">${je(n.grand_total)}</td>
                ...
                <td class="r"><button class="sx-chev" data-doc="${escapeHtml(n.id)}" aria-label="${escapeHtml(t("sx-detail-title"))}">${ou}</button></td>
            </tr>`}).join(""):`<tr><td colspan="8"><div class="sx-state">${nu}<div>${escapeHtml(t("sx-empty"))}</div></div></td></tr>`}function ir(){const e=lu(),n=["all","draft","issued","void"].map(a=>`<button data-flt="${a}" class="${ea===a?"on":""}">${escapeHtml(t("sx-f-"+a))}</button>`).join("");return`<div class="sx-cards">
        ...
        <div class="sx-stat"><div class="sx-l">${escapeHtml(t("sx-card-amount"))}</div><div class="sx-v">฿ ${je(e.amount)}</div></div>
        <div class="sx-stat"><div class="sx-l">${escapeHtml(t("sx-card-draft"))}</div><div class="sx-v">${e.drafts}</div></div>
        <div class="sx-stat"><div class="sx-l">${escapeHtml(t("sx-card-due"))}</div><div class="sx-v warn">฿ ${je(e.due)}</div></div>
    </div>
    <div class="sx-toolbar">
        <div class="sx-seg">${n}</div>
        <div class="sx-search"><input type="text" id="sx-wb-search" value="${escapeHtml(Ds)}" placeholder="${escapeHtml(t("sx-search-ph"))}"></div>
    </div>
    <div class="sx-panel"><table class="sx-tbl">
        ...
        <tbody id="sx-wb-tbody">${or()}</tbody>
    </table></div>`}function du(){return`<div class="sx-page">
        <div class="sx-head">
            <h2 data-i18n="sx-wb-title">${escapeHtml(t("sx-wb-title"))}</h2>
            <span class="sx-sub">ใบกำกับภาษี</span>
            <div class="sx-actions">
                <button class="btn btn-ghost" id="sx-settings-btn">${au}<span>${escapeHtml(t("sx-settings"))}</span></button>
                <button class="btn btn-primary" id="sx-new-btn">${su}<span>${escapeHtml(t("sx-new"))}</span></button>
            </div>
        </div>
        <div id="sx-wb-body"></div>
    </div>`}function zn(e){const n=document.getElementById("sx-wb-body");n&&(n.innerHTML=e)}function pu(){const e=document.getElementById("sx-wb-tbody");e&&(e.innerHTML=or()),rr()}function rr(){document.querySelectorAll("#sx-wb-body [data-doc]").forEach(e=>{e.onclick=n=>{n.stopPropagation(),window.openSalesDetail&&window.openSalesDetail(e.dataset.doc)}})}function lr(){document.querySelectorAll("#sx-wb-body [data-flt]").forEach(n=>{n.onclick=()=>{ea=n.dataset.flt,zn(ir()),lr()}});const e=document.getElementById("sx-wb-search");e&&(e.oninput=()=>{Ds=e.value,pu()}),rr()}function uu(){const e=document.getElementById("sx-new-btn");e&&(e.onclick=()=>window.openSalesWizard?window.openSalesWizard():showToast(t("sx-wizard-soon"),"info"));const n=document.getElementById("sx-settings-btn");n&&(n.onclick=()=>window.openSalesSettings?window.openSalesSettings():showToast(t("sx-settings-soon"),"info"))}async function qs(){zn(`<div class="sx-state">${escapeHtml(t("sx-loading"))}</div>`);try{const e=await apiGet("/api/sales/documents");if(!e)return;Qn=e.documents||[],zn(ir()),lr()}catch{zn(`<div class="sx-state error">${escapeHtml(t("sx-error"))}<br><button class="btn btn-ghost" id="sx-retry">${escapeHtml(t("sx-retry"))}</button></div>`);const n=document.getElementById("sx-retry");n&&(n.onclick=()=>qs())}}window.loadSalesWorkbench=function(){const e=document.getElementById("page-sales-invoices");e&&(e.dataset.sxInit!=="1"&&(e.innerHTML=du(),e.dataset.sxInit="1",uu()),qs())};window.addEventListener("pearnly:sales-changed",()=>{typeof currentRoute<"u"&&currentRoute==="sales-invoices"&&qs()});const mu='<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6"><path d="M21 8 12 3 3 8l9 5 9-5ZM3 8v8l9 5 9-5V8"/></svg>',fu='<svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8"><path d="M11 4H4v16h16v-7M18.5 2.5a2.1 2.1 0 0 1 3 3L12 15l-4 1 1-4Z"/></svg>',vu='<svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8"><path d="M3 6h18M8 6V4h8v2M6 6l1 14h10l1-14"/></svg>',cr='<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.9"><path d="M18 6 6 18M6 6l12 12"/></svg>';let ta=[],Rs="";function dr(e){let n=document.getElementById(e);return n||(n=document.createElement("div"),n.id=e,n.className="modal-mask",n.style.display="none",document.body.appendChild(n)),n}function Mt(e){const n=document.getElementById(e);n&&(n.style.display="none",n.innerHTML="")}function hu(){const e=Rs.trim().toLowerCase();return e?ta.filter(n=>[n.code,n.name_th,n.name_en,n.name_zh,n.barcode].filter(Boolean).some(a=>a.toLowerCase().indexOf(e)>=0)):ta}function pr(){const e=hu();return e.length?e.map(n=>{const a=n.name_th||n.name_en||n.name_zh||"—";return`<tr>
                <td>${n.image_url?`<img src="${escapeHtml(n.image_url)}" alt="" style="width:34px;height:34px;border-radius:7px;object-fit:cover">`:`<div class="sx-thumb">${mu}</div>`}</td>
                <td style="color:var(--ink-3)">${escapeHtml(n.code||"—")}</td>
                <td><b>${escapeHtml(a)}</b></td>
                <td>${escapeHtml(n.unit||"—")}</td>
                <td class="r">${je(n.unit_price)}</td>
                <td>${n.vat_applicable?'<span class="sx-badge issued">7%</span>':'<span class="sx-badge draft">—</span>'}</td>
                <td class="r"><button class="sx-chev" data-edit="${escapeHtml(n.id)}">${fu}</button><button class="sx-chev" data-del="${escapeHtml(n.id)}">${vu}</button></td>
            </tr>`}).join(""):`<tr><td colspan="7"><div class="sx-state">${escapeHtml(t("sx-empty"))}</div></td></tr>`}function gu(){return`<div class="sx-toolbar">
        <div class="sx-search"><input type="text" id="sx-p-search" value="${escapeHtml(Rs)}" placeholder="${escapeHtml(t("sx-p-search-ph"))}"></div>
    ...
    <div class="sx-panel"><table class="sx-tbl">
        ...
        <tbody id="sx-p-tbody">${pr()}</tbody>
    </table></div>`}function Ca(e){const n=document.getElementById("sx-p-body");n&&(n.innerHTML=e)}function bu(){const e=document.getElementById("sx-p-search");e&&(e.oninput=()=>{Rs=e.value;const n=document.getElementById("sx-p-tbody");n&&(n.innerHTML=pr()),Ro()}),document.getElementById("sx-p-add").onclick=()=>ur(null),document.getElementById("sx-p-import").onclick=xu,Ro()}function Ro(){document.querySelectorAll("#sx-p-body [data-edit]").forEach(e=>{e.onclick=()=>ur(ta.find(n=>n.id===e.dataset.edit)||null)}),document.querySelectorAll("#sx-p-body [data-del]").forEach(e=>{e.onclick=()=>ku(e.dataset.del)})}function ur(e){const n=dr("sales-prod-mask"),a=s=>escapeHtml(s==null?"":String(s));n.innerHTML=`<div class="modal" role="dialog" style="max-width:560px">
        <div class="modal-header"><div class="modal-title">${escapeHtml(t(e?"sx-p-edit":"sx-p-new"))}</div>
            <button class="modal-close" id="sx-p-close">${cr}</button></div>
        <div class="modal-body">
            <div class="form-row form-row-2col">
                <div><label>${escapeHtml(t("sx-p-f-code"))}</label><input type="text" id="sx-pf-code" value="${a(e?.code)}" maxlength="100"></div>
                <div><label>${escapeHtml(t("sx-p-f-barcode"))}</label><input type="text" id="sx-pf-barcode" value="${a(e?.barcode)}" maxlength="100"></div>
            </div>
            <div class="form-row"><label>${escapeHtml(t("sx-p-f-name-th"))} *</label><input type="text" id="sx-pf-th" value="${a(e?.name_th)}" maxlength="300"></div>
            <div class="form-row form-row-2col">
                <div><label>${escapeHtml(t("sx-p-f-name-en"))}</label><input type="text" id="sx-pf-en" value="${a(e?.name_en)}" maxlength="300"></div>
                <div><label>${escapeHtml(t("sx-p-f-name-zh"))}</label><input type="text" id="sx-pf-zh" value="${a(e?.name_zh)}" maxlength="300"></div>
            </div>
            <div class="form-row form-row-2col">
                <div><label>${escapeHtml(t("sx-p-f-unit"))}</label><input type="text" id="sx-pf-unit" value="${a(e?.unit)}" maxlength="50"></div>
            ...
            <div class="form-row"><label>${escapeHtml(t("sx-p-f-image"))}</label><input type="text" id="sx-pf-image" value="${a(e?.image_url)}" maxlength="1000" placeholder="https://…"></div>
        </div>
        <div class="modal-footer" style="justify-content:flex-end;gap:8px">
        ...
        </div></div>`,n.style.display="flex",document.getElementById("sx-p-close").onclick=()=>Mt("sales-prod-mask"),document.getElementById("sx-p-cancel").onclick=()=>Mt("sales-prod-mask"),n.onclick=s=>{s.target===n&&Mt("sales-prod-mask")},document.getElementById("sx-p-save").onclick=()=>wu(e)}function yu(){const e=n=>document.getElementById(n).value.trim();return{name_th:e("sx-pf-th"),code:e("sx-pf-code")||null,barcode:e("sx-pf-barcode")||null,name_en:e("sx-pf-en")||null,name_zh:e("sx-pf-zh")||null,unit:e("sx-pf-unit")||null,unit_price:Number(e("sx-pf-price"))||0,vat_applicable:document.getElementById("sx-pf-vat").checked,image_url:e("sx-pf-image")||null}}async function wu(e){const n=yu();if(!n.name_th)return showToast(t("sx-p-name-required"),"error");try{if(e){if(!(await wt(`/api/sales/products/${e.id}`,{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify(n)})).ok)throw new Error}else{const a=await apiPost("/api/sales/products",n);if(!a||!a.ok)throw new Error}Mt("sales-prod-mask"),showToast(t("sx-p-saved"),"success"),await Bn()}catch{showToast(t("sx-p-save-fail"),"error")}}async function ku(e){if(window.pearnlyConfirm){if(!await window.pearnlyConfirm(t("sx-p-del-confirm")))return}else if(!confirm(t("sx-p-del-confirm")))return;try{if(!(await wt(`/api/sales/products/${e}`,{method:"DELETE"})).ok)throw new Error;showToast(t("sx-p-deleted"),"success"),await Bn()}catch{showToast(t("sx-p-del-fail"),"error")}}function xu(){const e=dr("sales-prod-mask");e.innerHTML=`<div class="modal" role="dialog" style="max-width:480px">
        <div class="modal-header"><div class="modal-title">${escapeHtml(t("sx-p-import-title"))}</div>
            <button class="modal-close" id="sx-imp-close">${cr}</button></div>
        <div class="modal-body">
        ...
        </div></div>`,e.style.display="flex",document.getElementById("sx-imp-close").onclick=()=>Mt("sales-prod-mask"),document.getElementById("sx-imp-cancel").onclick=()=>Mt("sales-prod-mask"),document.getElementById("sx-imp-go").onclick=_u}async function _u(){const e=document.getElementById("sx-imp-file").files?.[0];if(!e)return showToast(t("sx-p-import-pick"),"error");const n=new FormData;n.append("file",e);try{const a=await wt("/api/sales/products/import",{method:"POST",body:n}),s=await a.json().catch(()=>({}));if(!a.ok)throw new Error;Mt("sales-prod-mask"),showToast(t("sx-p-import-done").replace("{n}",String(s.imported??0)),"success"),await Bn()}catch{showToast(t("sx-p-import-fail"),"error")}}async function Bn(){Ca(`<div class="sx-state">${escapeHtml(t("sx-loading"))}</div>`);try{const e=await apiGet("/api/sales/products");if(!e)return;ta=e.products||[],Ca(gu()),bu()}catch{Ca(`<div class="sx-state error">${escapeHtml(t("sx-error"))}<br><button class="btn btn-ghost" id="sx-p-retry">${escapeHtml(t("sx-retry"))}</button></div>`);const n=document.getElementById("sx-p-retry");n&&(n.onclick=()=>Bn())}}window.loadSalesProducts=function(){const e=document.getElementById("page-sales-products");e&&(e.dataset.sxInit!=="1"&&(e.innerHTML=`<div class="sx-page"><div class="sx-head"><h2>${escapeHtml(t("nav-sales-products"))}</h2><span class="sx-sub">สินค้า</span></div><div id="sx-p-body"></div></div>`,e.dataset.sxInit="1"),Bn())};const Eu=["classic","clean","brand","compact","official","mono"],Iu=["#2563eb","#0f766e","#b45309","#7c3aed","#be123c","#111827"];let Fs=[],ga=0,xn="classic",_n="#2563eb";function zs(){return Fs[ga]}function Ke(e){return escapeHtml(e??"")}function Bu(){const e=zs();if(!e)return`<div class="sx-state">${escapeHtml(t("sx-acc-none"))}</div>`;const n=Fs.map((o,i)=>`<option value="${i}" ${i===ga?"selected":""}>${escapeHtml(o.name||"—")}</option>`).join(""),a=Eu.map(o=>`<div class="sx-tpl ${xn===o?"on":""}" data-tpl="${o}"><div class="sx-tpl-pv" style="border-top:3px solid ${xn===o?_n:"var(--line)"}"></div><div class="sx-tpl-nm">${escapeHtml(t("sx-acc-tpl-"+o))}</div></div>`).join(""),s=Iu.map(o=>`<span class="sx-sw ${_n===o?"on":""}" data-color="${o}" style="background:${o}"></span>`).join("");return`<div class="sx-field"><label>${escapeHtml(t("sx-acc-pick"))}</label><select id="sx-acc-sel">${n}</select></div>
    <div class="sx-acc-grid">
        <div class="sx-field"><label>${escapeHtml(t("sx-acc-name"))}</label><input type="text" id="sx-a-name" value="${Ke(e.name)}" maxlength="200"></div>
        <div class="sx-field"><label>${escapeHtml(t("sx-acc-tax"))}</label><input type="text" id="sx-a-tax" value="${Ke(e.tax_id)}" maxlength="20"></div>
    </div>
    <div class="sx-field"><label>${escapeHtml(t("sx-acc-address"))}</label><input type="text" id="sx-a-addr" value="${Ke(e.address)}" maxlength="500"></div>
    <div class="sx-acc-grid">
        <div class="sx-field"><label>${escapeHtml(t("sx-acc-branch"))}</label><input type="text" id="sx-a-branch" value="${Ke(e.branch)}" maxlength="120"></div>
        <div class="sx-field"><label>${escapeHtml(t("sx-acc-phone"))}</label><input type="text" id="sx-a-phone" value="${Ke(e.phone)}" maxlength="50"></div>
    </div>
    <div class="sx-field"><label>${escapeHtml(t("sx-acc-promptpay"))}</label><input type="text" id="sx-a-pp" value="${Ke(e.promptpay_id)}" maxlength="40" placeholder="08x-xxx-xxxx / ${escapeHtml(t("sx-acc-tax"))}"></div>

    <div class="sx-head" style="margin-top:18px"><h2 style="font-size:14px">${escapeHtml(t("sx-acc-sec-brand"))}</h2></div>
    <div class="sx-acc-grid">
        <div class="sx-field"><label>${escapeHtml(t("sx-acc-logo"))}</label><input type="text" id="sx-a-logo" value="${Ke(e.logo_url)}" maxlength="500" placeholder="https://…"></div>
        <div class="sx-field"><label>${escapeHtml(t("sx-acc-seal"))}</label><input type="text" id="sx-a-seal" value="${Ke(e.seal_url)}" maxlength="500" placeholder="https://…"></div>
    </div>
    <div class="sx-field"><label>${escapeHtml(t("sx-acc-sign"))}</label><input type="text" id="sx-a-sign" value="${Ke(e.signature_url)}" maxlength="500" placeholder="https://…"></div>
    <div class="sx-field"><label>${escapeHtml(t("sx-acc-footer"))}</label><textarea id="sx-a-footer" rows="2" maxlength="500">${Ke(e.footer_text)}</textarea></div>
    ...
    <button class="btn btn-primary" id="sx-a-save" style="margin-top:18px">${escapeHtml(t("sx-acc-save"))}</button>`}function Ja(){const e=document.getElementById("sx-acc-body");e&&(e.innerHTML=Bu(),Lu())}function mr(e){ga=e;const n=zs();xn=n&&n.template_id||"classic",_n=n&&n.brand_color||"#2563eb",Ja()}function Lu(){const e=document.getElementById("sx-acc-sel");e&&(e.onchange=()=>mr(+e.value)),document.querySelectorAll("[data-tpl]").forEach(a=>{a.onclick=()=>{xn=a.dataset.tpl,Ja()}}),document.querySelectorAll("[data-color]").forEach(a=>{a.onclick=()=>{_n=a.dataset.color,Ja()}});const n=document.getElementById("sx-a-save");n&&(n.onclick=$u)}async function $u(){const e=zs();if(!e)return;const n=s=>document.getElementById(s).value.trim(),a={name:n("sx-a-name"),tax_id:n("sx-a-tax")||null,address:n("sx-a-addr")||null,branch:n("sx-a-branch")||null,phone:n("sx-a-phone")||null,promptpay_id:n("sx-a-pp")||null,logo_url:n("sx-a-logo")||null,seal_url:n("sx-a-seal")||null,signature_url:n("sx-a-sign")||null,footer_text:document.getElementById("sx-a-footer").value.trim()||null,template_id:xn,brand_color:_n};try{if(!(await wt(`/api/sales/sellers/${e.id}`,{method:"PUT",headers:{"Content-Type":"application/json"},body:JSON.stringify(a)})).ok)throw new Error;Object.assign(e,a),showToast(t("sx-acc-saved"),"success")}catch{showToast(t("sx-acc-save-fail"),"error")}}async function fr(){const e=document.getElementById("sx-acc-body");e&&(e.innerHTML=`<div class="sx-state">${escapeHtml(t("sx-loading"))}</div>`);try{const n=await apiGet("/api/sales/sellers");if(!n)return;Fs=n.sellers||[],ga=0,mr(0)}catch{e&&(e.innerHTML=`<div class="sx-state error">${escapeHtml(t("sx-error"))}<br><button class="btn btn-ghost" id="sx-acc-retry">${escapeHtml(t("sx-retry"))}</button></div>`);const a=document.getElementById("sx-acc-retry");a&&(a.onclick=()=>fr())}}window.loadSalesAccount=function(){const e=document.getElementById("page-sales-account");e&&(e.dataset.sxInit!=="1"&&(e.innerHTML=`<div class="sx-page"><div class="sx-head"><h2>${escapeHtml(t("nav-sales-account"))}</h2><span class="sx-sub">กิจการ / ข้อมูลออกบิล</span></div><div id="sx-acc-body" style="max-width:680px"></div></div>`,e.dataset.sxInit="1"),fr())};const Su='<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.9"><path d="M18 6 6 18M6 6l12 12"/></svg>';let Pe;function Qe(){let e=document.getElementById("sales-settings-mask");return e||(e=document.createElement("div"),e.id="sales-settings-mask",e.className="modal-mask",e.style.display="none",document.body.appendChild(e)),e}function na(){const e=document.getElementById("sales-settings-mask");e&&(e.style.display="none",e.innerHTML="")}function Pt(e,n){return`<div class="sx-seg" style="width:100%">${n.map(a=>`<button type="button" data-f="${String(e)}" data-v="${a[0]}" class="${String(Pe[e])===a[0]?"on":""}" style="flex:1">${escapeHtml(a[1])}</button>`).join("")}</div>`}function vr(){Qe().innerHTML=`<div class="modal" role="dialog" style="max-width:560px">
        <div class="modal-header"><div class="modal-title">${escapeHtml(t("sx-set-title"))}</div>
            <button class="modal-close" id="sx-set-close">${Su}</button></div>
        <div class="modal-body">
            <div class="sx-set-card">
                <div class="sx-set-h">${escapeHtml(t("sx-set-num"))}</div>
                <div class="sx-acc-grid">
                    <div class="sx-field"><label>${escapeHtml(t("sx-set-prefix"))}</label><input type="text" id="sx-set-prefix" value="${escapeHtml(Pe.number_prefix||"")}" maxlength="20" placeholder="INV"></div>
                    <div class="sx-field"><label>${escapeHtml(t("sx-set-start"))}</label><input type="number" id="sx-set-start" value="${Pe.number_start||1}" min="1"></div>
                </div>
                <div class="sx-field"><label>${escapeHtml(t("sx-set-reset"))}</label>
                    ${Pt("number_reset",[["yearly",t("sx-set-reset-yearly")],["monthly",t("sx-set-reset-monthly")],["never",t("sx-set-reset-never")]])}</div>
            </div>
            <div class="sx-set-card">
                <div class="sx-set-h">${escapeHtml(t("sx-set-approval"))}</div>
                ${Pt("approval_mode",[["none",t("sx-set-appr-none")],["single",t("sx-set-appr-single")]])}
                <div class="sx-hint">${escapeHtml(t("sx-set-appr-hint"))}</div>
            </div>
            <div class="sx-set-card">
                <div class="sx-set-h">${escapeHtml(t("sx-set-vat"))}</div>
                ${Pt("price_includes_vat_default",[["false",t("sx-set-vat-ex")],["true",t("sx-set-vat-in")]])}
            </div>
            <div class="sx-set-card">
                <div class="sx-set-h">${escapeHtml(t("sx-set-wht"))}</div>
                <input type="number" id="sx-set-wht" value="${Number(Pe.default_wht_rate)||0}" min="0" max="100" step="0.5" style="max-width:160px">
            </div>
            <div class="sx-set-card">
                <div class="sx-set-h">${escapeHtml(t("sx-set-output"))}</div>
                <div class="sx-field"><label>${escapeHtml(t("sx-set-lang"))}</label>
                    ${Pt("default_doc_lang",[["th",t("sx-set-lang-th")],["th_en",t("sx-set-lang-then")],["th_zh",t("sx-set-lang-thzh")]])}</div>
                <div class="sx-field"><label>${escapeHtml(t("sx-set-paper"))}</label>
                    ${Pt("default_paper",[["A4","A4"],["A5","A5"]])}</div>
                <div class="sx-field"><label>${escapeHtml(t("sx-set-copies"))}</label>
                    ${Pt("default_copies_layout",[["separate",t("sx-set-copies-sep")],["two_up",t("sx-set-copies-2up")]])}</div>
            </div>
        </div>
        <div class="modal-footer" style="justify-content:space-between">
        ...
        </div></div>`,Qe().style.display="flex",Cu()}function Cu(){document.getElementById("sx-set-close").onclick=na,Qe().onclick=e=>{e.target===Qe()&&na()},Qe().querySelectorAll("[data-f]").forEach(e=>{e.onclick=()=>{const n=e.dataset.f,a=e.dataset.v;Pe[n]=n==="price_includes_vat_default"?a==="true":a,vr()}}),document.getElementById("sx-set-save").onclick=Tu}async function Tu(){const n={number_prefix:document.getElementById("sx-set-prefix").value.trim()||null,number_reset:Pe.number_reset,number_start:Number(document.getElementById("sx-set-start").value)||1,approval_mode:Pe.approval_mode,price_includes_vat_default:Pe.price_includes_vat_default,default_wht_rate:Number(document.getElementById("sx-set-wht").value)||0,default_doc_lang:Pe.default_doc_lang,default_paper:Pe.default_paper,default_copies_layout:Pe.default_copies_layout};try{if(!(await wt("/api/sales/settings",{method:"PUT",headers:{"Content-Type":"application/json"},body:JSON.stringify(n)})).ok)throw new Error;na(),showToast(t("sx-set-saved"),"success")}catch{showToast(t("sx-set-save-fail"),"error")}}window.openSalesSettings=async function(){Qe().innerHTML=`<div class="modal" role="dialog" style="max-width:560px"><div class="modal-body"><div class="sx-state">${escapeHtml(t("sx-loading"))}</div></div></div>`,Qe().style.display="flex";try{const e=await apiGet("/api/sales/settings");if(!e)return;Pe=e.settings,vr()}catch{Qe().innerHTML=`<div class="modal" role="dialog" style="max-width:480px"><div class="modal-body"><div class="sx-state error">${escapeHtml(t("sx-error"))}</div></div></div>`,Qe().onclick=n=>{n.target===Qe()&&na()}}};const Mu=["tax_invoice","tax_invoice_receipt"],Hu=["receipt","tax_invoice_receipt"];function Nn(e){return Hu.includes(e.docType)}function Ns(e){return e.docType!=="quotation"}function ge(e){return(Math.round(e*100)/100).toLocaleString("en-US",{minimumFractionDigits:2,maximumFractionDigits:2})}function ba(e){let n=0,a=0;e.lines.forEach(d=>{const p=Math.max(0,(+d.qty||0)*(+d.price||0)-(+d.disc||0));n+=p,d.vat&&(a+=p)});const s=Math.min(+e.hdisc||0,n),o=n>0?(n-s)/n:1;a*=o;const i=n-s,r=a*(+e.vatRate||0)/100,l=i*(+e.whtRate||0)/100,m=i+r-l;return{sub:n,hd:s,subAfter:i,vat:r,wht:l,grand:m}}function Au(e){const n=["","หนึ่ง","สอง","สาม","สี่","ห้า","หก","เจ็ด","แปด","เก้า"],a=["","สิบ","ร้อย","พัน","หมื่น","แสน"];let s="";const o=e.length;for(let i=0;i<o;i++){const r=+e[i],l=o-1-i;r!==0&&(l===1&&r===1?s+="สิบ":l===1&&r===2?s+="ยี่สิบ":l===0&&r===1&&o>1?s+="เอ็ด":s+=n[r]+a[l])}return s}function Fo(e){if(e===0)return"ศูนย์";const n=[];let a=String(e);for(;a.length>6;)n.unshift(a.slice(-6)),a=a.slice(0,-6);n.unshift(a);let s="";return n.forEach((o,i)=>{const r=+o;if(r===0)return;s+=Au(String(r));const l=n.length-1-i;for(let m=0;m<l;m++)s+="ล้าน"}),s}function ju(e){e=Math.round(e*100)/100;const n=Math.floor(e),a=Math.round((e-n)*100);let s=Fo(n)+"บาท";return s+=a===0?"ถ้วน":Fo(a)+"สตางค์",s}function Pu(e){e=Math.round(e*100)/100;const n=Math.floor(e),a=Math.round((e-n)*100),s=["零","壹","贰","叁","肆","伍","陆","柒","捌","玖"],o=["","拾","佰","仟"],i=["","万","亿"],r=d=>{let p="";const c=String(d);for(let u=0;u<c.length;u++){const f=+c[u],v=c.length-1-u;f===0?!p.endsWith("零")&&p&&(p+="零"):p+=s[f]+o[v]}return p.replace(/零+$/,"")};let m=(d=>{if(d===0)return"零";const p=[];let c=String(d);for(;c.length>4;)p.unshift(c.slice(-4)),c=c.slice(0,-4);p.unshift(c);let u="";return p.forEach((f,v)=>{const y=+f,b=p.length-1-v;y!==0?u+=r(y)+i[b]:u&&!u.endsWith("零")&&(u+="零")}),u.replace(/零+$/,"")})(n)+"泰铢";return m+=a===0?"整":s[Math.floor(a/10)]+"角"+(a%10?s[a%10]+"分":""),m}function hr(e){const n=e.buyer,a=Mu.includes(e.docType),s=a?!!(n.name&&n.addr&&n.tin&&(n.type!=="company"||n.branchType==="hq"||/^\d{5}$/.test(n.branchNo))):!0;let o=!0;["company","individual"].includes(n.type)&&n.tin&&(o=/^\d{13}$/.test(n.tin)),n.type==="foreigner"&&n.tin&&(o=/^[A-Za-z0-9]{4,20}$/.test(n.tin));const i=!Nn(e)||e.pay.status!=="unpaid",r=a||e.docType==="tax_invoice_simple";return[{key:"sw-ck-buyer",descKey:"sw-ck-buyer-d",pass:s,req:a,na:!a},{key:"sw-ck-tin",descKey:"sw-ck-tin-d",pass:o,req:a,na:e.docType==="quotation"},{key:"sw-ck-vat",descKey:"sw-ck-vat-d",pass:!0,req:r,na:!r},{key:"sw-ck-pay",descKey:"sw-ck-pay-d",pass:i,req:Nn(e),na:!Nn(e)},{key:"sw-ck-seq",descKey:"sw-ck-seq-d",pass:!0,req:!0,na:!1},{key:"sw-ck-words",descKey:"sw-ck-words-d",pass:!0,req:r,na:!r}]}const Du="modulepreload",qu=function(e){return"/"+e},zo={},Ru=function(n,a,s){let o=Promise.resolve();if(a&&a.length>0){let r=function(d){return Promise.all(d.map(p=>Promise.resolve(p).then(c=>({status:"fulfilled",value:c}),c=>({status:"rejected",reason:c}))))};document.getElementsByTagName("link");const l=document.querySelector("meta[property=csp-nonce]"),m=l?.nonce||l?.getAttribute("nonce");o=r(a.map(d=>{if(d=qu(d),d in zo)return;zo[d]=!0;const p=d.endsWith(".css"),c=p?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${d}"]${c}`))return;const u=document.createElement("link");if(u.rel=p?"stylesheet":Du,p||(u.as="script"),u.crossOrigin="",u.href=d,m&&u.setAttribute("nonce",m),document.head.appendChild(u),p)return new Promise((f,v)=>{u.addEventListener("load",f),u.addEventListener("error",()=>v(new Error(`Unable to preload CSS for ${d}`)))})}))}function i(r){const l=new Event("vite:preloadError",{cancelable:!0});if(l.payload=r,window.dispatchEvent(l),!l.defaultPrevented)throw r}return o.then(r=>{for(const l of r||[])l.status==="rejected"&&i(l.reason);return n().catch(i)})};let Os=[],gr=[];function br(){return Os}function yr(){return gr}async function Fu(){const[e,n]=await Promise.all([apiGet("/api/sales/sellers").catch(()=>null),apiGet("/api/sales/products").catch(()=>null)]);Os=e&&e.sellers||[],gr=n&&n.products||[]}async function zu(e){const n=await apiPost("/api/rd/verify",{tax_id:e});return!n||!n.ok?{valid:!1}:{valid:!!(await n.json().catch(()=>({}))).valid}}async function Nu(e,n=0){const a=await apiPost("/api/rd/lookup",{tax_id:e,branch:n});if(!a||!a.ok)return{found:!1};const s=await a.json().catch(()=>({}));return{found:!!(s.found||s.name),name:s.name||s.company_name,address:s.address||s.full_address,branch_no:s.branch_no||s.branch}}function Ou(e){const n=Os[e.sellerIdx],a=ba(e),s=e.lines.filter(i=>(i.desc||"").trim()).map(i=>({description:i.desc.trim(),product_id:i.product_id||null,qty:+i.qty||0,unit_price:+i.price||0,discount:+i.disc||0,vat_applicable:!!i.vat}));let o=null;if(Ns(e)){const i=e.pay.status==="paid"?a.grand:e.pay.status==="partial"?+(e.pay.paidAmt||0):0;o={status:e.pay.status,paid_amount:i,method:e.pay.method,date:e.pay.date}}return{doc_type:e.docType,seller_workspace_client_id:n?n.id:null,currency:"THB",vat_rate:+e.vatRate||0,wht_rate:+e.whtRate||0,header_discount_amount:+e.hdisc||0,header_discount_pct:0,price_includes_vat:!1,due_date:e.docType==="tax_invoice"&&e.dueDate?e.dueDate:null,lines:s,buyer:{type:e.buyer.type,name:e.buyer.name||null,address:e.buyer.addr||null,tax_id:e.buyer.tin||null,branch_type:e.buyer.type==="company"?e.buyer.branchType:null,branch_no:e.buyer.branchType==="branch"?e.buyer.branchNo:null},payment:o}}async function Xa(e){if(!e)return{ok:!1,error:"network"};const n=await e.json().catch(()=>({}));return e.ok?{ok:!0,id:n.document&&String(n.document.id)}:{ok:!1,error:n.detail||"http_"+e.status}}async function wr(e){const n=Ou(e);if(e.draftId){const{salesFetch:a}=await Ru(async()=>{const{salesFetch:o}=await Promise.resolve().then(()=>Vp);return{salesFetch:o}},void 0),s=await a(`/api/sales/documents/${e.draftId}`,{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify(n)});return Xa(s)}return Xa(await apiPost("/api/sales/documents",n))}async function Vu(e){const n=await wr(e);if(!n.ok||!n.id)return n;const a=await apiPost(`/api/sales/documents/${n.id}/issue`,{issue_date:e.issueDate||null}),s=await Xa(a);return s.ok?{ok:!0,id:n.id}:s}const Uu={steps:["ประเภทเอกสาร","ผู้ขาย/ผู้ซื้อ","รายการสินค้า","รับชำระ / วันที่","ตรวจ & ออก"],sc:[["ขายปลีกรับเงินสด","รวม · ลูกค้าบุคคลจ่ายสด"],["ขายเชื่อ B2B","ใบกำกับ · นิติบุคคล · เครดิต"],["บุคคลขอลดหย่อน","รวม · บุคคล+เลขบัตร"],["POS แบบย่อ","อย่างย่อ · ไม่ระบุชื่อ"]],docTypes:[["tax_invoice_receipt","ใบกำกับภาษี/ใบเสร็จรับเงิน","พบบ่อยสุด รับเงินแล้วออกทันที"],["tax_invoice","ใบกำกับภาษี (ขายเชื่อ)","ออกก่อน รับเงินทีหลัง"],["tax_invoice_simple","ใบกำกับภาษีอย่างย่อ","ขายปลีก ผู้ซื้อขอคืนภาษีไม่ได้"],["receipt","ใบเสร็จรับเงิน","หลักฐานรับเงิน"],["quotation","ใบเสนอราคา","ไม่ใช่เอกสารภาษี"]],bt:[["company","นิติบุคคล","ขอคืนภาษีซื้อได้"],["individual","บุคคลธรรมดา","คนไทย"],["foreigner","ชาวต่างชาติ","ใช้พาสปอร์ต"],["anonymous","ลูกค้าทั่วไป","ไม่ระบุ"]],methods:[["cash","เงินสด"],["transfer","โอน"],["promptpay","พร้อมเพย์"],["card","บัตร"],["cheque","เช็ค"]],s:{title:"ออกใบกำกับภาษี",sub:"· ใบกำกับขาย",back:"ย้อนกลับ",next:"ถัดไป",draft:"บันทึกร่าง",issue:"ออกใบกำกับภาษี",s1h:"เลือกประเภทเอกสาร",s1sub:"แต่ละประเภทจะให้กรอกข้อมูลต่างกัน เลือกสถานการณ์เพื่อตั้งค่าอัตโนมัติได้",scenarios:"สถานการณ์ที่พบบ่อย (กดเพื่อตั้งค่า)",orManual:"หรือเลือกประเภทเอง",s2h:"ผู้ขาย / ผู้ซื้อ",s2sub:"ผู้ขายดึงจากกิจการที่เลือก ผู้ซื้อปรับช่องตามประเภทอัตโนมัติ",seller:"ผู้ขาย (กิจการ)",sellerPick:"เลือกกิจการที่ออกบิล",buyer:"ผู้ซื้อ",buyerType:"ประเภทผู้ซื้อ",name:"ชื่อ",addr:"ที่อยู่",tin:"เลขผู้เสียภาษี",natid:"เลขบัตรประชาชน",passport:"เลขพาสปอร์ต",branch:"สำนักงานใหญ่ / สาขา",hq:"สำนักงานใหญ่",br:"สาขา",brno:"เลขสาขา",tinHintInd:"บุคคลใช้เลขบัตรประชาชนเป็นเลขผู้เสียภาษีได้",tinErr:"ต้องเป็นตัวเลข 13 หลัก",passErr:"พาสปอร์ต 4–20 ตัวอักษร/ตัวเลข",brErr:"เลขสาขาต้อง 5 หลัก",anonNote:"ลูกค้าทั่วไป: เว้นว่างได้ แต่ผู้ซื้อจะใช้ขอคืนภาษีไม่ได้",verify:"ตรวจ",verifyLookup:"ตรวจ·ดึง",verifiedCo:"ตรวจผ่าน · ดึงข้อมูลจากสรรพากร (แก้ได้)",verified:"ตรวจผ่าน",rdNeedTin:"กรอกเลขภาษีก่อน",rdCo13:"เลขภาษี 13 หลัก",lookupFail:"ไม่พบ · กรอกเอง",verifyFail:"ตรวจไม่ผ่าน / ไม่พบ",s3h:"รายการสินค้า",s3subMenu:"แตะเลือกสินค้าเหมือนสั่งอาหาร → ออกบิลอัตโนมัติ",searchPh:"ค้นหา / สแกน…",addCustom:"เพิ่มรายการเอง",cartEmpty:"แตะสินค้าทางซ้ายเพื่อเพิ่ม",saveCatalog:"บันทึกเข้าคลังสินค้า",hdisc:"ส่วนลดท้ายบิล",subtotal:"รวมเงิน",vat:"ภาษีมูลค่าเพิ่ม",whtL:"หัก ณ ที่จ่าย",grand:"ยอดสุทธิ",taxFree:"ยกเว้นภาษี",s4h:"รับชำระ & วันที่",s4sub:"ใบเสร็จ/ใบรวมต้องบันทึกการรับเงินก่อน",payStatus:"สถานะชำระ",paid:"รับเงินแล้ว",partial:"รับบางส่วน",unpaid:"ยังไม่รับ",payMethod:"วิธีรับเงิน",payDate:"วันที่รับ",paidAmt:"จำนวนที่รับ",issueDate:"วันที่ออก",dueDate:"ครบกำหนดชำระ",calendar:"ปฏิทิน",ce:"ค.ศ.",be:"พ.ศ.",payReqWarn:"เอกสารนี้เป็นใบเสร็จ/ใบรวม ต้องบันทึกรับเงินก่อนออก",payNA:"เอกสารประเภทนี้ไม่ต้องระบุการรับเงิน",s5h:"ตรวจสอบ & ออก",s5sub:"ออกแล้วเลขที่ล็อก แก้ไม่ได้ (ต้องใช้ใบลด/เพิ่มหนี้)",compliance:"ตรวจความถูกต้อง (§86/4)",preview:"ตัวอย่างเอกสาร",ckBuyer:"ข้อมูลผู้ซื้อครบ",ckBuyerD:"ใบเต็มต้องมีชื่อ/ที่อยู่/เลขภาษี",ckTin:"รูปแบบเลขภาษีถูก",ckTinD:"13 หลัก / พาสปอร์ต",ckVat:"แยกบรรทัด VAT",ckVatD:"แยกภาษีออกจากราคาสินค้า",ckPay:"บันทึกรับเงินแล้ว",ckPayD:"ใบเสร็จ/ใบรวมต้องรับเงิน",ckSeq:"เลขที่ต่อเนื่อง",ckSeqD:"ออกเลขในทรานแซกชัน",ckWords:"จำนวนเงินตัวอักษร",ckWordsD:"สร้างคำอ่านบาทแล้ว",ckNa:"ไม่เกี่ยวข้อง",output:"ตั้งค่าการออก",paper:"กระดาษ",paperA4:"A4",paperA5:"A5",paperPos:"80mm ความร้อน",docLangL:"ภาษาเอกสาร",dlTh:"ไทย",dlThEn:"ไทย+อังกฤษ",dlThZh:"ไทย+จีน",layoutL:"รูปแบบ",laySingle:"ต้นฉบับหน้าเดียว",layPair:"ต้นฉบับ+สำเนาในแผ่นเดียว (ประหยัด)",tear:"ตัดตามเส้นประ · ส่วนบนให้ลูกค้า · ส่วนล่างเก็บไว้",okTitle:"ออกเอกสารแล้ว",okSeq:"ล็อกเลขที่แล้ว",okArchived:"จัดเก็บสำเนาอัตโนมัติ (5 ปี)",dl:"ดาวน์โหลด PDF",viewSend:"ดู / ส่ง",done:"เสร็จสิ้น",newOne:"ออกใบใหม่",blockers:"ยังออกไม่ได้:",draftSaved:"บันทึกร่างแล้ว (ยังไม่กินเลขที่)",saveFail:"บันทึกไม่สำเร็จ",issueFail:"ออกไม่สำเร็จ",needLines:"เพิ่มอย่างน้อยหนึ่งรายการ"}},Gu={steps:["書類の種類","売手/買手","明細","入金 / 日付","確認 & 発行"],sc:[["小売現金","合算 · 個人が現金払い"],["B2B 掛売","税額票 · 法人 · 掛け"],["個人の控除","合算 · 個人+身分証"],["POS 簡易","簡易票 · 匿名"]],docTypes:[["tax_invoice_receipt","税額票 + 領収書","一枚で両方を兼ねる(タイで最も一般的)"],["tax_invoice","税額票(掛売)","先に発行・後で入金"],["tax_invoice_simple","簡易税額票 ABB","小売・買手は仕入税額控除不可"],["receipt","領収書","入金証憑のみ・税額票ではない"],["quotation","見積書","見積用・税務証憑ではない"]],bt:[["company","法人","仕入税額控除可"],["individual","個人","タイ国籍の個人"],["foreigner","外国人","パスポート番号"],["anonymous","匿名客","記名なし"]],methods:[["cash","現金"],["transfer","振込"],["promptpay","PromptPay"],["card","カード"],["cheque","小切手"]],s:{title:"発行",sub:"· 売上請求書",back:"戻る",next:"次へ",draft:"下書き保存",issue:"請求書を発行",s1h:"書類の種類を選択",s1sub:"種類で後の入力項目が変わります。よくある場面から自動設定も可能。",scenarios:"よくある場面(タップで設定)",orManual:"または手動で選択",s2h:"売手 / 買手",s2sub:"売手は帳簿主体から自動入力、買手は種類で項目が変化。",seller:"売手(帳簿主体)",sellerPick:"どの会社で発行するか",buyer:"買手",buyerType:"買手の種類",name:"名称 / 氏名",addr:"住所",tin:"納税番号",natid:"身分証番号",passport:"パスポート番号",branch:"本店 / 支店",hq:"本店",br:"支店",brno:"支店番号",tinHintInd:"個人は身分証番号を納税番号に使えます",tinErr:"13 桁の数字",passErr:"パスポート 4–20 桁英数",brErr:"支店番号は 5 桁",anonNote:"匿名客:買手情報は空でも可。ただし買手は仕入控除に使えません。",verify:"照合",verifyLookup:"照合・取得",verifiedCo:"照合成功 · 税務署の登録情報を取得(編集可)",verified:"納税番号 照合成功",rdNeedTin:"先に納税番号を入力",rdCo13:"法人番号は 13 桁",lookupFail:"見つかりません · 手入力",verifyFail:"照合失敗 / 見つからない",s3h:"明細",s3subMenu:"注文のように左の商品をタップ → 右に自動で明細(自由行も追加可)",searchPh:"検索 / スキャン…",addCustom:"自由行を追加(サービス/在庫外)",cartEmpty:"左の商品をタップして追加",saveCatalog:"商品マスタに保存",hdisc:"伝票全体の割引",subtotal:"小計",vat:"付加価値税 VAT",whtL:"源泉税 WHT",grand:"請求合計",taxFree:"非課税",s4h:"入金 & 日付",s4sub:"領収書/合算は先に入金記録が必要。掛売は未入金でも可。",payStatus:"入金状態",paid:"入金済",partial:"一部入金",unpaid:"未入金",payMethod:"入金方法",payDate:"入金日",paidAmt:"入金額",issueDate:"発行日",dueDate:"支払期日",calendar:"暦",ce:"西暦",be:"仏暦 (พ.ศ.)",payReqWarn:"これは領収書/合算です:発行前に入金(または一部)を記録してください。",payNA:"この種類は入金情報が不要です。",s5h:"確認して発行",s5sub:"発行後は番号がロックされ内容は変更不可(貸方/借方票で調整)。",compliance:"コンプライアンス確認(タイ §86/4)",preview:"請求書プレビュー",ckBuyer:"買手情報が完全",ckBuyerD:"完全な税額票は名称/住所/納税番号が必要(法人は支店も)",ckTin:"納税番号の形式が正しい",ckTinD:"13 桁 / パスポート",ckVat:"VAT を分離表示",ckVatD:"税額と本体価格を分離",ckPay:"入金記録済",ckPayD:"領収書/合算は入金必須",ckSeq:"連番(欠番なし)",ckSeqD:"発行時にトランザクションで採番",ckWords:"金額の文字表記",ckWordsD:"バーツ表記を生成済",ckNa:"対象外",output:"出力設定",paper:"用紙",paperA4:"A4",paperA5:"A5",paperPos:"80mm 感熱",docLangL:"書類の言語",dlTh:"タイ語",dlThEn:"タイ+英",dlThZh:"タイ+中",layoutL:"レイアウト",laySingle:"正本のみ1ページ",layPair:"正本+副本を1ページ(節約)",tear:"破線で切離 · 上を客へ · 下を控え",okTitle:"発行完了",okSeq:"番号をロック",okArchived:"副本を自動保管(5年)",dl:"PDF をダウンロード",viewSend:"表示 / 送信",done:"完了",newOne:"もう一枚",blockers:"発行にはあと:",draftSaved:"下書き保存(番号は未使用)",saveFail:"保存失敗",issueFail:"発行失敗",needLines:"明細を1行以上追加"}},Wu={steps:["单据类型","买卖双方","商品明细","收款 / 日期","核对开出"],sc:[["零售收现金","合并单 · 个人散客付现"],["B2B 赊销","税票 · 公司 · 月结"],["个人要抵税","合并单 · 个人带身份证"],["POS 简易票","简易票 · 不记名"]],docTypes:[["tax_invoice_receipt","税票 + 收据合并单","一张纸既是税票又是收据(泰国最常见,收钱当场开)"],["tax_invoice","税票(赊销)","先开票后收款,月结/账期常用"],["tax_invoice_simple","简易税票 ABB","零售小票,不记买方,买方不能抵扣"],["receipt","收据","纯收款凭证,非税票"],["quotation","报价单","报价用,不是税务凭证"]],bt:[["company","公司","法人,可抵进项"],["individual","个人","本国自然人"],["foreigner","外国个人","用护照号"],["anonymous","匿名散客","不记名"]],methods:[["cash","现金"],["transfer","转账"],["promptpay","PromptPay"],["card","刷卡"],["cheque","支票"]],s:{title:"开票",sub:"· 销项发票",back:"上一步",next:"下一步",draft:"存草稿",issue:"开出发票",s1h:"选择单据类型",s1sub:"不同单据,后面要填的内容会自动变。也可以点常见场景一键带出。",scenarios:"常见场景(点一下自动设置)",orManual:"或手动选类型",s2h:"买卖双方",s2sub:"卖方按账套主体自动带出;买方按类型动态显示该填什么。",seller:"卖方(账套主体)",sellerPick:"选择以哪家公司开票",buyer:"买方",buyerType:"买方类型",name:"名称 / 姓名",addr:"地址",tin:"税号",natid:"身份证号",passport:"护照号",branch:"总公司 / 分店",hq:"总公司",br:"分店",brno:"分店号",tinHintInd:"个人可用身份证号作为税号",tinErr:"需为 13 位数字",passErr:"护照号 4–20 位字母数字",brErr:"分店号需 5 位数字",anonNote:"匿名散客:买方信息留空也可,但买方将无法用于抵扣进项 / 个税。",verify:"验真",verifyLookup:"验真·带出",verifiedCo:"税号验真通过 · 已从税局带出登记信息(可改)",verified:"税号验真通过",rdNeedTin:"先填税号",rdCo13:"公司税号需 13 位",lookupFail:"查不到 · 请手填",verifyFail:"验真不通过 / 查不到",s3h:"商品明细",s3subMenu:"像餐厅点单:左边点商品 → 右边自动成单(没有的可加自定义行)",searchPh:"搜商品 / 扫码…",addCustom:"加自定义行(服务/不在库)",cartEmpty:"点左边商品加入 · 像点菜单",saveCatalog:"存入商品库(以后也能点)",hdisc:"整单折扣",subtotal:"小计",vat:"增值税 VAT",whtL:"预扣税 WHT",grand:"合计应付",taxFree:"免税",s4h:"收款与日期",s4sub:"收据/合并单必须先记收款;赊销税票可暂不收。",payStatus:"收款状态",paid:"已收款",partial:"部分收款",unpaid:"未收款",payMethod:"收款方式",payDate:"收款日",paidAmt:"已收金额",issueDate:"开票日期",dueDate:"付款到期日",calendar:"日期历法",ce:"公历",be:"佛历 พ.ศ.",payReqWarn:"当前单据是收据/合并单:开出前必须记为已收款(或部分收款)。",payNA:"此单据类型无需收款信息。",s5h:"核对并开出",s5sub:"确认无误后开出。开出后连号锁定、内容不可改(红冲/补开才能调整)。",compliance:"合规检查(泰国 §86/4)",preview:"发票预览",ckBuyer:"买方信息齐全",ckBuyerD:"完整税票需买方名称/地址/税号(公司还要分店)",ckTin:"税号格式正确",ckTinD:"13 位数字 / 护照号",ckVat:"VAT 单独列示",ckVatD:"税额与货值分开",ckPay:"收款已记录",ckPayD:"收据/合并单须已收款",ckSeq:"连号不跳号",ckSeqD:"开出时事务取号",ckWords:"金额大写",ckWordsD:"泰铢大写已生成",ckNa:"不适用",output:"输出设置",paper:"纸张",paperA4:"A4",paperA5:"A5",paperPos:"80mm 热敏",docLangL:"文档语言",dlTh:"泰文",dlThEn:"泰+英",dlThZh:"泰+中",layoutL:"版式 / 联数",laySingle:"正本单页",layPair:"正本+副本同页(省纸)",tear:"沿虚线裁开 · 上联给顾客 · 下联自留",okTitle:"已开出",okSeq:"连号已锁定",okArchived:"副本已自动归档(留底 5 年)",dl:"下载 PDF 正本",viewSend:"查看 / 发送",done:"完成",newOne:"再开一张",blockers:"还差这些才能开出:",draftSaved:"草稿已保存(未占连号)",saveFail:"保存失败",issueFail:"开出失败",needLines:"请至少加一行商品"}},Ku={steps:["Document type","Parties","Line items","Payment / Date","Review & issue"],sc:[["Retail cash","Combined · individual pays cash"],["B2B credit","Tax invoice · company · terms"],["Individual tax","Combined · individual w/ ID"],["POS simplified","Simplified · anonymous"]],docTypes:[["tax_invoice_receipt","Tax Invoice + Receipt","One paper that is both (most common in Thailand)"],["tax_invoice","Tax Invoice (credit)","Issued first, paid later"],["tax_invoice_simple","Simplified ABB","Retail; buyer cannot claim input VAT"],["receipt","Receipt","Payment proof only, not a tax invoice"],["quotation","Quotation","For quoting, not a tax document"]],bt:[["company","Company","Legal entity, can claim VAT"],["individual","Individual","Thai natural person"],["foreigner","Foreigner","Uses passport no."],["anonymous","Walk-in","Anonymous"]],methods:[["cash","Cash"],["transfer","Transfer"],["promptpay","PromptPay"],["card","Card"],["cheque","Cheque"]],s:{title:"New Invoice",sub:"· Sales invoice",back:"Back",next:"Next",draft:"Save draft",issue:"Issue invoice",s1h:"Choose document type",s1sub:"Each type changes later fields. Or pick a common scenario.",scenarios:"Common scenarios (tap to set)",orManual:"Or pick a type manually",s2h:"Parties",s2sub:"Seller auto-fills from your company; buyer fields adapt to type.",seller:"Seller (company)",sellerPick:"Choose which company issues",buyer:"Buyer",buyerType:"Buyer type",name:"Name",addr:"Address",tin:"Tax ID",natid:"National ID",passport:"Passport no.",branch:"HQ / Branch",hq:"HQ",br:"Branch",brno:"Branch no.",tinHintInd:"Individuals may use national ID as tax ID",tinErr:"Must be 13 digits",passErr:"Passport 4–20 alphanumeric",brErr:"Branch no. must be 5 digits",anonNote:"Walk-in: buyer info may be blank, but the buyer cannot claim input VAT / tax.",verify:"Verify",verifyLookup:"Verify & fill",verifiedCo:"Verified · pulled registration from RD (editable)",verified:"Tax ID verified",rdNeedTin:"Enter the tax ID first",rdCo13:"Company tax ID must be 13 digits",lookupFail:"Not found · enter manually",verifyFail:"Verification failed / not found",s3h:"Line items",s3subMenu:"Like ordering food: tap products on the left → cart on the right (add custom rows too)",searchPh:"Search / scan…",addCustom:"Add custom row (service / off-catalog)",cartEmpty:"Tap a product to add · like a menu",saveCatalog:"Save to product catalog",hdisc:"Whole-bill discount",subtotal:"Subtotal",vat:"VAT",whtL:"WHT",grand:"Total due",taxFree:"tax-free",s4h:"Payment & date",s4sub:"Receipts/combined must record payment first; credit invoices may stay unpaid.",payStatus:"Payment status",paid:"Paid",partial:"Partial",unpaid:"Unpaid",payMethod:"Method",payDate:"Paid date",paidAmt:"Paid amount",issueDate:"Issue date",dueDate:"Due date",calendar:"Calendar",ce:"CE",be:"BE (พ.ศ.)",payReqWarn:"This is a receipt/combined: must be marked paid (or partial) before issuing.",payNA:"This document type needs no payment info.",s5h:"Review & issue",s5sub:"Once issued, the number is locked and content cannot change (use credit/debit notes).",compliance:"Compliance check (Thailand §86/4)",preview:"Invoice preview",ckBuyer:"Buyer info complete",ckBuyerD:"Full tax invoice needs name/address/tax ID (company also branch)",ckTin:"Tax ID format valid",ckTinD:"13 digits / passport",ckVat:"VAT shown separately",ckVatD:"Tax split from goods value",ckPay:"Payment recorded",ckPayD:"Receipt/combined must be paid",ckSeq:"Sequential numbering",ckSeqD:"Number drawn in a transaction",ckWords:"Amount in words",ckWordsD:"Baht text generated",ckNa:"N/A",output:"Output settings",paper:"Paper",paperA4:"A4",paperA5:"A5",paperPos:"80mm thermal",docLangL:"Document language",dlTh:"Thai",dlThEn:"Thai+Eng",dlThZh:"Thai+Chi",layoutL:"Layout",laySingle:"Original single page",layPair:"Original+copy on one page (save paper)",tear:"Cut along the dashed line · top to customer · bottom kept",okTitle:"Issued",okSeq:"Number locked",okArchived:"Copy auto-archived (kept 5 yrs)",dl:"Download PDF",viewSend:"View / Send",done:"Done",newOne:"New invoice",blockers:"Still needed before issuing:",draftSaved:"Draft saved (no number used)",saveFail:"Save failed",issueFail:"Issue failed",needLines:"Add at least one line item"}},Za={zh:Wu,en:Ku,th:Uu,ja:Gu},Yu=["zh","en","th","ja"];let Vs="th";function kr(e){Za[e]&&(Vs=e)}function xr(){return Vs}function Ln(){return Za[Vs]||Za.th}function C(e){return Ln().s[e]||e}const Ju={no:{th:"เลขที่",en:"No.",zh:"号码"},date:{th:"วันที่",en:"Date",zh:"日期"},seller:{th:"ผู้ขาย",en:"Seller",zh:"卖方"},buyer:{th:"ผู้ซื้อ",en:"Buyer",zh:"买方"},desc:{th:"รายการ",en:"Description",zh:"商品"},qty:{th:"จำนวน",en:"Qty",zh:"数量"},price:{th:"ราคา",en:"Price",zh:"单价"},disc:{th:"ส่วนลด",en:"Discount",zh:"折扣"},amount:{th:"จำนวนเงิน",en:"Amount",zh:"金额"},subtotal:{th:"มูลค่า",en:"Subtotal",zh:"小计"},grand:{th:"รวมทั้งสิ้น",en:"Grand Total",zh:"合计"},words:{th:"ตัวอักษร",en:"In words",zh:"大写"},paid:{th:"การรับเงิน",en:"Payment",zh:"收款"},wht:{th:"หัก ณ ที่จ่าย",en:"WHT",zh:"预扣税"},signSeller:{th:"ผู้รับเงิน / ผู้มีอำนาจ",en:"Authorized",zh:"收款人/授权"},signBuyer:{th:"ผู้ซื้อ",en:"Buyer",zh:"买方签收"}};function we(e,n){const a=Ju[n];return e.docLang==="th"?a.th:a.th+" / "+(e.docLang==="th_zh"?a.zh:a.en)}const Xu={tax_invoice_receipt:"ใบกำกับภาษี/ใบเสร็จรับเงิน · Tax Invoice / Receipt",tax_invoice:"ใบกำกับภาษี · Tax Invoice",tax_invoice_simple:"ใบกำกับภาษีอย่างย่อ · Simplified",receipt:"ใบเสร็จรับเงิน · Receipt",quotation:"ใบเสนอราคา · Quotation"},Zu={cash:"เงินสด",transfer:"โอน",promptpay:"พร้อมเพย์",card:"บัตร",cheque:"เช็ค"};function No(e,n){if(!n)return"-";if(e.be){const a=n.split("-");return+a[0]+543+"-"+a[1]+"-"+a[2]}return n}function Ta(e,n){const a=br()[e.sellerIdx]||{name:"",tax_id:"",address:"",branch:""},s=e.buyer,o=ba(e),i=s.type==="individual"?"เลขบัตรประชาชน":s.type==="foreigner"?"Passport":"Tax ID",r=s.name||(s.type==="anonymous"?"ลูกค้าทั่วไป":"-"),l=s.type==="anonymous"&&!s.name?"":`<div class="sw-pl">${escapeHtml(s.addr)||""}</div><div class="sw-pl">${i}: ${escapeHtml(s.tin)||"-"}</div>
               ${s.type==="company"?`<div class="sw-pl">${s.branchType==="hq"?"สำนักงานใหญ่":"สาขาที่ "+(escapeHtml(s.branchNo)||"-")}</div>`:""}`,m=e.lines.map((f,v)=>`<tr><td>${v+1}</td><td>${escapeHtml(f.desc)||"-"}</td><td class="r">${ge(+f.qty||0)}</td><td class="r">${ge(+f.price||0)}</td><td class="r">${+f.disc>0?"-"+ge(+f.disc):"-"}</td><td class="r">${ge(Math.max(0,(+f.qty||0)*(+f.price||0)-(+f.disc||0)))}</td></tr>`).join(""),d=Ns(e)&&e.pay.status!=="unpaid"?`<div class="sw-inv-pay"><b>${we(e,"paid")}:</b> ${Zu[e.pay.method]||e.pay.method} · ${No(e,e.pay.date)} · ${e.pay.status==="partial"?"฿ "+ge(+(e.pay.paidAmt||0)):"฿ "+ge(o.grand)}</div>`:"",p=e.docLang==="th_zh"?Pu(o.grand):ju(o.grand),c=n==="copy",u=c?e.docLang==="th"?"สำเนา":"สำเนา / Copy":e.docLang==="th"?"ต้นฉบับ":"ต้นฉบับ / Original";return`<div class="sw-invoice ${e.paper==="pos"?"pos":""} ${e.layout==="pair"?"half":""}">
        <div class="sw-copybadge ${c?"copy":""}">${u}</div>
        <h3>${Xu[e.docType]}</h3>
        <div class="sw-docno">${we(e,"no")}: — &nbsp;·&nbsp; ${we(e,"date")}: ${No(e,e.issueDate)}${e.be?" (พ.ศ.)":""}</div>
        <div class="sw-inv-parties">
            <div><div class="sw-ptitle">${we(e,"seller")}</div>
            ...
            <div><div class="sw-ptitle">${we(e,"buyer")}</div>
                <div class="sw-pname">${escapeHtml(r)}</div>${l}</div>
        </div>
        <table class="sw-inv-items">
            <thead><tr><th>#</th><th>${we(e,"desc")}</th><th class="r">${we(e,"qty")}</th><th class="r">${we(e,"price")}</th><th class="r">${we(e,"disc")}</th><th class="r">${we(e,"amount")}</th></tr></thead>
            <tbody>${m}</tbody>
        </table>
        <div class="sw-inv-tot">
            <div class="sw-tr"><span>${we(e,"subtotal")}</span><span>${ge(o.subAfter)}</span></div>
            <div class="sw-tr"><span>VAT ${e.vatRate}%</span><span>${ge(o.vat)}</span></div>
            ${o.wht>0?`<div class="sw-tr"><span>${we(e,"wht")}</span><span>-${ge(o.wht)}</span></div>`:""}
            <div class="sw-tr g"><span>${we(e,"grand")}</span><span>฿ ${ge(o.grand)}</span></div>
        </div>
        <div class="sw-inv-words"><b>${we(e,"words")}:</b> ${p}</div>
        ${d}
        <div class="sw-inv-sign"><div class="s">${we(e,"signSeller")}</div><div class="s">${we(e,"signBuyer")}</div></div>
    </div>`}function Qu(e,n,a){return e.layout==="pair"&&e.paper!=="pos"?`<div class="sw-pairwrap">${Ta(e,"original")}
            <div class="sw-tear"><span>${a} ${escapeHtml(n)}</span></div>
            ${Ta(e,"copy")}</div>`:Ta(e,"original")}const be={check:'<svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="#fff" stroke-width="3"><path d="M20 6 9 17l-5-5"/></svg>',checkG:'<svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3"><path d="M20 6 9 17l-5-5"/></svg>',x:'<svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3"><path d="M18 6 6 18M6 6l12 12"/></svg>',plus:'<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2"><path d="M12 5v14M5 12h14"/></svg>',trash:'<svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.9"><path d="M3 6h18M8 6V4h8v2M6 6l1 14h10l1-14"/></svg>',info:'<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="9"/><path d="M12 11v5M12 7.5v.5"/></svg>',close:'<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.9"><path d="M18 6 6 18M6 6l12 12"/></svg>',box:'<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#fff" stroke-width="1.7"><path d="M21 8 12 3 3 8l9 5 9-5ZM3 8v8l9 5 9-5V8"/></svg>'},Oo=["#2563eb","#db2777","#16a34a","#d97706","#0891b2","#7c3aed","#92400e","#e11d48","#059669"];function _r(e){const n=xr();return n==="zh"&&(e.name_zh||e.name_th)||n==="en"&&(e.name_en||e.name_th)||e.name_th||e.name_en||e.name_zh||"—"}function em(e){const n=Ln(),a=n.sc.map((o,i)=>`<span class="sw-chip" data-sc="${i}"><b>${escapeHtml(o[0])}</b> · <span class="sw-muted">${escapeHtml(o[1])}</span></span>`).join(""),s=n.docTypes.map(o=>`<div class="sw-choice ${e.docType===o[0]?"on":""}" data-doc="${o[0]}"><div class="sw-ck">${be.check}</div><div><div class="sw-t">${escapeHtml(o[1])}</div><div class="sw-d">${escapeHtml(o[2])}</div></div></div>`).join("");return`<div class="sw-card"><h2>${escapeHtml(C("s1h"))}</h2><div class="sw-sub">${escapeHtml(C("s1sub"))}</div>
        <div class="sw-sectitle">${escapeHtml(C("scenarios"))}</div><div class="sw-chips">${a}</div>
        <div class="sw-sectitle">${escapeHtml(C("orManual"))}</div><div class="sw-choices">${s}</div></div>`}function tm(e){const n=Ln(),a=br(),s=a[e.sellerIdx],o=a.map((v,y)=>`<option value="${y}" ${y===e.sellerIdx?"selected":""}>${escapeHtml(v.name||"—")}</option>`).join(""),i=n.bt.map(v=>`<div class="sw-choice ${e.buyer.type===v[0]?"on":""}" data-bt="${v[0]}" style="padding:10px 12px"><div class="sw-ck">${be.check}</div><div><div class="sw-t">${escapeHtml(v[1])}</div><div class="sw-d">${escapeHtml(v[2])}</div></div></div>`).join(""),r=e.buyer,l=r.type==="anonymous",m=r.type==="company",d=r.type==="individual"?C("natid"):r.type==="foreigner"?C("passport"):C("tin"),p=l?"":'<span class="sw-req">*</span>';let c="";l||(r.type==="foreigner"?r.tin&&!/^[A-Za-z0-9]{4,20}$/.test(r.tin)&&(c=`<div class="sw-hint err">${escapeHtml(C("passErr"))}</div>`):r.tin&&!/^\d{13}$/.test(r.tin)?c=`<div class="sw-hint err">${escapeHtml(C("tinErr"))}</div>`:r.type==="individual"&&(c=`<div class="sw-hint info">${be.info} ${escapeHtml(C("tinHintInd"))}</div>`));const u=s?`${escapeHtml(s.name||"")} · ${escapeHtml(s.tax_id||"")} · ${escapeHtml(s.branch||"")}`:"—",f=l?`<div class="sw-banner warn">${be.info}<span>${escapeHtml(C("anonNote"))}</span></div>
           ...
           <div class="sw-field"><label>${escapeHtml(d)} ${p}</label>
             <div style="display:flex;gap:8px"><input type="text" id="sw-btin" value="${escapeHtml(r.tin)}" style="flex:1">
               <button type="button" id="sw-rd" class="btn btn-ghost" style="white-space:nowrap">${r.type==="company"?escapeHtml(C("verifyLookup")):escapeHtml(C("verify"))}</button></div>
             ${r.verified?`<div class="sw-hint ok">${be.checkG} ${escapeHtml(r.type==="company"?C("verifiedCo"):C("verified"))}</div>`:c}</div>
           ${m?nm(e):""}`;return`<div class="sw-card"><h2>${escapeHtml(C("s2h"))}</h2><div class="sw-sub">${escapeHtml(C("s2sub"))}</div>
        ...
        <div class="sw-banner">${be.info}<span>${u}</span></div>
        <div class="sw-sectitle">${escapeHtml(C("buyer"))} — ${escapeHtml(C("buyerType"))}</div>
        <div class="sw-choices">${i}</div>
        <div style="margin-top:16px">${f}</div></div>`}function nm(e){const n=e.buyer,a=n.branchNo&&!/^\d{5}$/.test(n.branchNo);return`<div class="sw-field"><label>${escapeHtml(C("branch"))} <span class="sw-req">*</span></label>
        ...
        ${n.branchType==="branch"?`<input type="text" id="sw-brno" value="${escapeHtml(n.branchNo)}" placeholder="${escapeHtml(C("brno"))} (5)">${a?`<div class="sw-hint err">${escapeHtml(C("brErr"))}</div>`:""}`:""}</div>`}function am(e){const n=ba(e),a=yr(),s=a.map((l,m)=>`<div class="sw-pcard" data-add="${m}"><div class="sw-pimg" style="background:${Oo[m%Oo.length]}">${l.image_url?`<img src="${escapeHtml(l.image_url)}" alt="">`:be.box}</div><div class="sw-pn">${escapeHtml(_r(l))}</div><div class="sw-pp">฿${ge(l.unit_price)}${l.vat_applicable?"":` <span class="sw-muted" style="font-size:10px">${escapeHtml(C("taxFree"))}</span>`}</div></div>`).join(""),o=a.length?"":'<div class="sw-muted" style="padding:20px;text-align:center">—</div>',r=e.lines.some(l=>l.desc||l.price)?e.lines.map((l,m)=>`<div class="sw-citem">
            <div class="sw-crow1"><input type="text" data-ln="${m}" data-f="desc" value="${escapeHtml(l.desc)}" placeholder="${escapeHtml(C("s3h"))}" style="border:0;font-weight:600;padding:2px;flex:1;background:transparent"><button class="sw-iconbtn" data-rm="${m}">${be.trash}</button></div>
            <div class="sw-crow2"><div class="sw-cqty"><button data-q="${m}" data-d="-1">−</button><span>${l.qty}</span><button data-q="${m}" data-d="1">+</button></div>
              <input type="number" data-ln="${m}" data-f="price" value="${l.price}" min="0" step="0.01"><input type="number" data-ln="${m}" data-f="disc" value="${l.disc}" min="0" step="0.01">
              <span class="sw-amt">฿${ge(Math.max(0,(+l.qty||0)*(+l.price||0)-(+l.disc||0)))}</span></div>
        ...
        <div class="sw-menu">
            <div><input type="text" placeholder="${escapeHtml(C("searchPh"))}" style="margin-bottom:10px" id="sw-psearch"><div class="sw-pgrid">${s}${o}</div>
              <button class="sw-addline" id="sw-addcustom">${be.plus} ${escapeHtml(C("addCustom"))}</button></div>
            <div><div class="sw-cart">${r}</div>
              ...
              <div class="sw-totals">
                <div class="sw-tr"><span>${escapeHtml(C("subtotal"))}</span><span class="v">${ge(n.sub)}</span></div>
                ${n.hd>0?`<div class="sw-tr disc"><span>${escapeHtml(C("hdisc"))}</span><span class="v">-${ge(n.hd)}</span></div>`:""}
                <div class="sw-tr"><span>${escapeHtml(C("vat"))} ${e.vatRate}%</span><span class="v">${ge(n.vat)}</span></div>
                ${n.wht>0?`<div class="sw-tr disc"><span>${escapeHtml(C("whtL"))} ${e.whtRate}%</span><span class="v">-${ge(n.wht)}</span></div>`:""}
                <div class="sw-tr grand"><span>${escapeHtml(C("grand"))}</span><span class="v">฿ ${ge(n.grand)}</span></div></div></div>
        </div></div>`}function sm(e){const n=Ln(),a=ba(e);if(!Ns(e))return`<div class="sw-card"><h2>${escapeHtml(C("s4h"))}</h2><div class="sw-sub">${escapeHtml(C("s4sub"))}</div>
            <div class="sw-banner">${be.info}<span>${escapeHtml(C("payNA"))}</span></div>${Vo(e)}</div>`;const s=e.pay,o=n.methods.map(i=>`<option value="${i[0]}" ${s.method===i[0]?"selected":""}>${escapeHtml(i[1])}</option>`).join("");return`<div class="sw-card"><h2>${escapeHtml(C("s4h"))}</h2><div class="sw-sub">${escapeHtml(C("s4sub"))}</div>
        ${Nn(e)?`<div class="sw-banner warn">${be.info}<span>${escapeHtml(C("payReqWarn"))}</span></div>`:""}
        ...
        ${s.status!=="unpaid"?`<div class="sw-row3">
            ...
            ${s.status==="partial"?`<div class="sw-field"><label>${escapeHtml(C("paidAmt"))}</label><input type="number" id="sw-paid" value="${s.paidAmt!=null?s.paidAmt:""}" placeholder="${ge(a.grand)}"></div>`:`<div class="sw-field"><label>${escapeHtml(C("paidAmt"))}</label><input type="text" value="฿ ${ge(a.grand)}" disabled></div>`}</div>`:""}
        ${Vo(e)}</div>`}function Vo(e){return`<div class="sw-sectitle">${escapeHtml(C("issueDate"))}</div><div class="sw-row3">
        ...
        <div class="sw-field"><label>${escapeHtml(C("calendar"))}</label><div class="sw-seg">
            ...
            <button type="button" data-cal="be" class="${e.be?"on":""}">${escapeHtml(C("be"))}</button></div></div></div>`}function om(e){const n=hr(e).map(o=>o.na?`<div class="sw-check"><div class="sw-ci" style="background:#eee;color:#999">${be.checkG}</div><div><div class="sw-ct">${escapeHtml(C(o.key))} <span class="sw-pill">${escapeHtml(C("ckNa"))}</span></div></div></div>`:`<div class="sw-check ${o.pass?"pass":"fail"}"><div class="sw-ci">${o.pass?be.checkG:be.x}</div><div><div class="sw-ct">${escapeHtml(C(o.key))}${o.req&&!o.pass?' <span class="sw-req">*</span>':""}</div><div class="sw-cd">${escapeHtml(C(o.descKey))}</div></div></div>`).join(""),a=["a4","a5","pos"].map(o=>`<button type="button" data-paper="${o}" class="${e.paper===o?"on":""}">${escapeHtml(C("paper"+o.toUpperCase()))}</button>`).join(""),s=["th","th_en","th_zh"].map(o=>`<button type="button" data-dlang="${o}" class="${e.docLang===o?"on":""}">${escapeHtml(C(o==="th"?"dlTh":o==="th_en"?"dlThEn":"dlThZh"))}</button>`).join("");return`<div class="sw-card"><h2>${escapeHtml(C("s5h"))}</h2><div class="sw-sub">${escapeHtml(C("s5sub"))}</div>
        <div class="sw-sectitle">${escapeHtml(C("compliance"))}</div><div>${n}</div>
        <div class="sw-sectitle" style="margin-top:22px">${escapeHtml(C("output"))}</div>
        <div class="sw-row" style="max-width:580px">
            <div class="sw-field"><label>${escapeHtml(C("paper"))}</label><div class="sw-seg">${a}</div></div>
            <div class="sw-field"><label>${escapeHtml(C("docLangL"))}</label><div class="sw-seg">${s}</div></div></div>
        ...
        <div id="sw-print">${Qu(e,C("tear"),be.info)}</div></div>`}function Rt(){const e=new Date;return e.getFullYear()+"-"+String(e.getMonth()+1).padStart(2,"0")+"-"+String(e.getDate()).padStart(2,"0")}let De=0,R;function Er(){return{docType:"tax_invoice_receipt",sellerIdx:0,buyer:{type:"company",name:"",addr:"",tin:"",branchType:"hq",branchNo:""},lines:[{desc:"",qty:1,price:0,disc:0,vat:!0}],hdisc:0,vatRate:7,whtRate:0,pay:{status:"paid",method:"transfer",date:Rt(),paidAmt:null},issueDate:Rt(),dueDate:"",be:!1,paper:"a4",docLang:"th_en",layout:"single",draftId:null}}function pe(){let e=document.getElementById("sales-wizard-mask");return e||(e=document.createElement("div"),e.id="sales-wizard-mask",e.className="sw-mask",document.body.appendChild(e)),e}function Qa(){const e=document.getElementById("sales-wizard-mask");e&&(e.style.display="none",e.innerHTML="")}function ue(){const n=Ln().steps.map((o,i)=>{const r=i===De?"active":i<De?"done":"",l=i<De?be.check:i+1;return`<div class="sw-step ${r}"><div class="sw-num">${l}</div><div class="sw-lbl">${escapeHtml(o)}</div>${i<4?'<div class="sw-bar"></div>':""}</div>`}).join(""),a=Yu.map(o=>`<button data-wl="${o}" class="${xr()===o?"on":""}">${o.toUpperCase()}</button>`).join(""),s=[em,tm,am,sm,om][De](R);pe().innerHTML=`<div class="sw-wrap">
        <div class="sw-topbar">
            <div class="sw-brand">${escapeHtml(C("title"))}<small>${escapeHtml(C("sub"))}</small></div>
            <div style="display:flex;gap:10px;align-items:center">
                <div class="sw-langtoggle">${a}</div>
                <button class="sw-x" id="sw-close" aria-label="close">${be.close}</button>
            </div>
        </div>
        <div class="sw-stepper">${n}</div>
        <div id="sw-body">${s}</div>
        <div class="sw-nav">
            <div class="sw-left">
                <button class="btn btn-ghost" id="sw-back" ${De===0?"disabled":""}>${escapeHtml(C("back"))}</button>
                <button class="btn btn-ghost" id="sw-draft">${escapeHtml(C("draft"))}</button>
            </div>
            <button class="btn btn-primary" id="sw-next">${escapeHtml(C(De===4?"issue":"next"))}</button>
        </div>
    </div>`,pe().style.display="block",im()}function Oe(e,n,a=!1){const s=document.getElementById(e);s&&(s.oninput=()=>n(s.value),a&&(s.onblur=ue))}function im(){document.getElementById("sw-close").onclick=Qa,document.getElementById("sw-back").onclick=()=>Uo(-1),document.getElementById("sw-next").onclick=()=>Uo(1),document.getElementById("sw-draft").onclick=mm,pe().querySelectorAll("[data-wl]").forEach(o=>o.onclick=()=>(kr(o.dataset.wl),ue())),pe().querySelectorAll("[data-doc]").forEach(o=>o.onclick=()=>(R.docType=o.dataset.doc,ue())),pe().querySelectorAll("[data-sc]").forEach(o=>o.onclick=()=>pm(+o.dataset.sc));const e=document.getElementById("sw-seller");e&&(e.onchange=()=>(R.sellerIdx=+e.value,ue())),pe().querySelectorAll("[data-bt]").forEach(o=>o.onclick=()=>rm(o.dataset.bt)),pe().querySelectorAll("[data-brt]").forEach(o=>o.onclick=()=>(R.buyer.branchType=o.dataset.brt,o.dataset.brt==="hq"&&(R.buyer.branchNo=""),ue())),Oe("sw-bname",o=>R.buyer.name=o),Oe("sw-baddr",o=>R.buyer.addr=o),Oe("sw-btin",o=>(R.buyer.tin=o,R.buyer.verified=!1),!0),Oe("sw-brno",o=>R.buyer.branchNo=o,!0);const n=document.getElementById("sw-rd");n&&(n.onclick=um),pe().querySelectorAll("[data-add]").forEach(o=>o.onclick=()=>lm(+o.dataset.add)),pe().querySelectorAll("[data-q]").forEach(o=>o.onclick=()=>cm(+o.dataset.q,+o.dataset.d)),pe().querySelectorAll("[data-rm]").forEach(o=>o.onclick=()=>dm(+o.dataset.rm)),pe().querySelectorAll("[data-ln]").forEach(o=>{const i=+o.dataset.ln,r=o.dataset.f;o.oninput=()=>R.lines[i][r]=o.value,o.onblur=ue});const a=document.getElementById("sw-addcustom");a&&(a.onclick=()=>(R.lines.push({desc:"",qty:1,price:0,disc:0,vat:!0,custom:!0}),ue())),pe().querySelectorAll("[data-save]").forEach(o=>o.onchange=()=>R.lines[+o.dataset.save].save=o.checked),Oe("sw-hdisc",o=>R.hdisc=o,!0),Oe("sw-vat",o=>R.vatRate=o,!0),Oe("sw-wht",o=>R.whtRate=o,!0),pe().querySelectorAll("[data-ps]").forEach(o=>o.onclick=()=>(R.pay.status=o.dataset.ps,ue()));const s=document.getElementById("sw-pm");s&&(s.onchange=()=>R.pay.method=s.value),Oe("sw-pdate",o=>R.pay.date=o),Oe("sw-paid",o=>R.pay.paidAmt=o),Oe("sw-idate",o=>R.issueDate=o),Oe("sw-ddate",o=>R.dueDate=o),pe().querySelectorAll("[data-cal]").forEach(o=>o.onclick=()=>(R.be=o.dataset.cal==="be",ue())),pe().querySelectorAll("[data-paper]").forEach(o=>o.onclick=()=>(R.paper=o.dataset.paper,ue())),pe().querySelectorAll("[data-dlang]").forEach(o=>o.onclick=()=>(R.docLang=o.dataset.dlang,ue())),pe().querySelectorAll("[data-layout]").forEach(o=>o.onclick=()=>(R.layout=o.dataset.layout,ue()))}function Uo(e){const n=De+e;if(!(n<0||n>4)){if(e>0&&De===4)return void fm();De=n,ue()}}function rm(e){R.buyer.type!==e&&(R.buyer.type=e,R.buyer.tin="",R.buyer.verified=!1,R.buyer.branchType="hq",R.buyer.branchNo="",ue())}function lm(e){const n=yr()[e];if(!n)return;const a=_r(n),s=R.lines.find(o=>o.product_id===n.id);s?s.qty=(+s.qty||0)+1:R.lines.length===1&&!R.lines[0].desc&&!R.lines[0].price?R.lines[0]={desc:a,qty:1,price:n.unit_price,disc:0,vat:n.vat_applicable,product_id:n.id}:R.lines.push({desc:a,qty:1,price:n.unit_price,disc:0,vat:n.vat_applicable,product_id:n.id}),ue()}function cm(e,n){R.lines[e].qty=Math.max(0,(+R.lines[e].qty||0)+n),+R.lines[e].qty==0&&R.lines.splice(e,1),R.lines.length||(R.lines=[{desc:"",qty:1,price:0,disc:0,vat:!0}]),ue()}function dm(e){R.lines.splice(e,1),R.lines.length||(R.lines=[{desc:"",qty:1,price:0,disc:0,vat:!0}]),ue()}function pm(e){const n={name:"",addr:"",tin:"",branchType:"hq",branchNo:""};e===0&&(R.docType="tax_invoice_receipt",R.buyer={type:"individual",...n},R.pay={status:"paid",method:"cash",date:Rt(),paidAmt:null}),e===1&&(R.docType="tax_invoice",R.buyer={type:"company",...n},R.pay={status:"unpaid",method:"transfer",date:Rt(),paidAmt:null}),e===2&&(R.docType="tax_invoice_receipt",R.buyer={type:"individual",...n},R.pay={status:"paid",method:"transfer",date:Rt(),paidAmt:null}),e===3&&(R.docType="tax_invoice_simple",R.buyer={type:"anonymous",...n},R.pay={status:"paid",method:"cash",date:Rt(),paidAmt:null}),De=0,ue()}async function um(){const e=R.buyer;if(!e.tin)return showToast(C("rdNeedTin"),"error");if(e.type==="company"){if(!/^\d{13}$/.test(e.tin))return showToast(C("rdCo13"),"error");const n=await Nu(e.tin,0);if(!n.found)return showToast(C("lookupFail"),"error");n.name&&(e.name=n.name),n.address&&(e.addr=n.address),e.branchType="hq",e.branchNo="",e.verified=!0}else{if(!(await zu(e.tin)).valid)return showToast(C("verifyFail"),"error");e.verified=!0}ue()}async function mm(){if(!R.lines.some(n=>(n.desc||"").trim()))return showToast(C("needLines"),"error");const e=await wr(R);e.ok?(R.draftId=e.id||R.draftId,showToast(C("draftSaved"),"success"),window.dispatchEvent(new CustomEvent("pearnly:sales-changed"))):showToast(C("saveFail")+(e.error?" · "+e.error:""),"error")}async function fm(){const e=hr(R).filter(a=>a.req&&!a.pass);if(e.length)return showToast(C("blockers")+" "+e.map(a=>C(a.key)).join(", "),"error");if(!R.lines.some(a=>(a.desc||"").trim()))return showToast(C("needLines"),"error");const n=await Vu(R);n.ok&&n.id?(vm(n.id),window.dispatchEvent(new CustomEvent("pearnly:sales-changed"))):showToast(C("issueFail")+(n.error?" · "+n.error:""),"error")}function vm(e){pe().innerHTML=`<div class="sw-okwrap"><div class="sw-okbox">
        <div class="sw-okic">${be.checkG}</div>
        <h3>${escapeHtml(C("okTitle"))}</h3>
        <div class="sw-okarch">${be.checkG} ${escapeHtml(C("okArchived"))}</div>
        <div class="sw-okacts">
        ...
        </div></div></div>`,pe().style.display="block",document.getElementById("sw-ok-done").onclick=Qa,document.getElementById("sw-ok-new").onclick=()=>{R=Er(),De=0,ue()},document.getElementById("sw-ok-view").onclick=()=>{Qa(),window.openSalesDetail&&window.openSalesDetail(e)}}window.openSalesWizard=async function(){R=Er(),De=0;const e=typeof currentLang<"u"&&currentLang||localStorage.getItem("mrpilot_lang")||"th";kr(e),pe().innerHTML=`<div class="sw-wrap"><div class="sw-card"><div class="sx-state">${escapeHtml(C("s1h"))}…</div></div></div>`,pe().style.display="block",await Fu(),ue()};const hm=`
    <div class="cmdk">
...
`;Be("cmdk-mask",hm);(function(){function e(c){try{if(location.search.indexOf("test_center=1")>=0||localStorage.getItem("pearnly_test_mode")==="1"||c&&c.id&&String(c.id)==="468b50c1-5593-4fd6-990d-515ce8085563")return!0}catch{}return!1}window.applyRoleVisibility=function(){var u=window._userInfo,f=!1,v=!0,y=!1,b=!1;u&&(f=typeof canManageTeam=="function"?canManageTeam(u):!!(u.role==="owner"||u.is_super_admin),v=typeof shouldHideMoney=="function"?shouldHideMoney(u):u.role==="member"&&!u.is_super_admin,y=typeof isSuperAdmin=="function"?isSuperAdmin(u):!!u.is_super_admin,b=e(u)),document.querySelectorAll("[data-show-if-team]").forEach(function(g){g.style.display=f?"":"none"}),document.querySelectorAll("[data-show-if-money]").forEach(function(g){g.style.display=v?"none":""}),document.querySelectorAll("[data-show-if-admin]").forEach(function(g){g.style.display=y?"":"none"}),document.querySelectorAll("[data-show-if-test]").forEach(function(g){g.style.display=b?"":"none"});var h=y||b;document.querySelectorAll("[data-show-if-special]").forEach(function(g){g.style.display=h?"":"none"})},window.renderAvatarMenu=function(u){if(u){var f=document.getElementById("avatar-btn"),v=document.getElementById("avatar-popup-name"),y=document.getElementById("avatar-popup-email");if(!(!f||!v||!y)){var b=(u.username||"").trim(),h=b.split("@")[0]||b||"—",g=(b.charAt(0)||"?").toUpperCase(),_=(u.avatar_url||"").trim();if(_){var w=_.replace(/"/g,"&quot;"),k=g.replace(/'/g,"\\'");f.innerHTML='<img src="'+w+'" alt="'+g+`" referrerpolicy="no-referrer" onerror="this.parentNode.textContent='`+k+`'">`}else f.textContent=g;v.textContent=h,y.textContent=b||"—",f.setAttribute("title",b||"")}}};function n(){var c=document.getElementById("avatar-wrap"),u=document.getElementById("avatar-btn"),f=document.getElementById("avatar-popup");if(!c||!u||!f)return;function v(){f.classList.remove("show"),u.setAttribute("aria-expanded","false")}function y(){f.classList.add("show"),u.setAttribute("aria-expanded","true")}u.addEventListener("click",function(b){b.stopPropagation(),f.classList.contains("show")?v():y()}),document.addEventListener("click",function(b){f.classList.contains("show")&&!c.contains(b.target)&&v()}),f.addEventListener("click",function(b){var h=b.target.closest(".avatar-popup-item");if(h){var g=h.dataset.action;switch(v(),g){case"settings":typeof openSettingsModal=="function"?openSettingsModal():typeof routeTo=="function"&&routeTo("settings");break;case"team":typeof openSettingsModal=="function"?openSettingsModal():typeof routeTo=="function"&&routeTo("settings"),setTimeout(function(){typeof switchSettingsTab=="function"&&switchSettingsTab("team")},50);break;case"billing":typeof openSettingsModal=="function"?openSettingsModal():typeof routeTo=="function"&&routeTo("settings"),setTimeout(function(){typeof switchSettingsTab=="function"&&switchSettingsTab("plan")},50);break;case"shortcuts":if(typeof showToast=="function"){var _=typeof t=="function"?t("feature-coming-soon"):"即将上线";showToast(_||"即将上线","info")}break;case"admin":window.location.href="/admin/cost";break;case"test-center":typeof routeTo=="function"&&routeTo("test-center");break;case"help":var w=document.getElementById("help-modal");w&&(w.style.display="flex");break;case"logout":try{localStorage.removeItem("mrpilot_token")}catch{}try{localStorage.removeItem("mrpilot_user")}catch{}window.location.href="/";break}}}),window._closeAvatarPopup=v}function a(){return[].slice.call(document.querySelectorAll(".cmdk-item")).filter(function(c){return c.style.display!=="none"})}function s(c){var u=a();u.forEach(function(f){f.classList.remove("focus")}),u[c]&&(u[c].classList.add("focus"),u[c].scrollIntoView({block:"nearest"}))}function o(c){var u=a();if(u.length){var f=u.findIndex(function(y){return y.classList.contains("focus")});f<0&&(f=0);var v=(f+c+u.length)%u.length;s(v)}}function i(c){c=(c||"").toLowerCase().trim();var u=0,f=window._userInfo,v=typeof isSuperAdmin=="function"?isSuperAdmin(f):!!(f&&f.is_super_admin),y=e(f);document.querySelectorAll(".cmdk-item").forEach(function(h){if(h.dataset.showIfAdmin==="1"&&!v){h.style.display="none";return}if(h.dataset.showIfTest==="1"&&!y){h.style.display="none";return}var g=(h.dataset.cmdkText||h.textContent||"").toLowerCase(),_=!c||g.indexOf(c)>=0;h.style.display=_?"":"none",h.classList.remove("focus"),_&&u++}),document.querySelectorAll("[data-cmdk-section]").forEach(function(h){for(var g=h.nextElementSibling,_=!1;g&&!g.hasAttribute("data-cmdk-section");){if(g.classList&&g.classList.contains("cmdk-item")&&g.style.display!=="none"){_=!0;break}g=g.nextElementSibling}h.style.display=_?"":"none"});var b=document.getElementById("cmdk-empty");b&&(b.style.display=u===0?"flex":"none"),s(0)}window.openCmdk=function(){var u=document.getElementById("cmdk-mask");u&&(typeof window._closeAvatarPopup=="function"&&window._closeAvatarPopup(),u.classList.add("show"),typeof window.applyRoleVisibility=="function"&&window.applyRoleVisibility(),setTimeout(function(){var f=document.getElementById("cmdk-input");f&&(f.value="",i(""),f.focus(),s(0))},50))},window.closeCmdk=function(){var u=document.getElementById("cmdk-mask");u&&u.classList.remove("show")};function r(c){if(c){if(c.classList.contains("cmdk-item-locked")){if(typeof showToast=="function"){var u=typeof t=="function"?t("feature-coming-soon"):"即将上线";showToast(u||"即将上线","info")}return}var f=c.dataset.cmdkRoute,v=c.dataset.cmdkAction;if(window.closeCmdk(),f){typeof routeTo=="function"&&routeTo(f);return}if(v){if(v==="open-admin"){window.location.href="/admin/cost";return}if(v.indexOf("lang-")===0){var y=v.slice(5);typeof applyLang=="function"&&applyLang(y)}}}}function l(){var c=document.getElementById("cmdk-mask"),u=document.getElementById("cmdk-input"),f=document.getElementById("cmdk-body");if(!(!c||!u||!f)){c.addEventListener("click",function(b){b.target===c&&window.closeCmdk()});var v=document.getElementById("cmdk-esc-btn");v&&v.addEventListener("click",function(){window.closeCmdk()}),u.addEventListener("input",function(b){i(b.target.value)}),u.addEventListener("keydown",function(b){b.key==="ArrowDown"?(b.preventDefault(),o(1)):b.key==="ArrowUp"?(b.preventDefault(),o(-1)):b.key==="Enter"?(b.preventDefault(),r(c.querySelector(".cmdk-item.focus"))):b.key==="Escape"&&(b.preventDefault(),window.closeCmdk())}),f.addEventListener("click",function(b){var h=b.target.closest(".cmdk-item");h&&r(h)}),f.addEventListener("mousemove",function(b){var h=b.target.closest(".cmdk-item");!h||h.style.display==="none"||h.classList.contains("cmdk-item-locked")||(a().forEach(function(g){g.classList.remove("focus")}),h.classList.add("focus"))});var y=document.getElementById("topbar-search");y&&(y.addEventListener("click",function(){window.openCmdk()}),y.addEventListener("keydown",function(b){(b.key==="Enter"||b.key===" ")&&(b.preventDefault(),window.openCmdk())}))}}document.addEventListener("keydown",function(c){if((c.metaKey||c.ctrlKey)&&(c.key==="k"||c.key==="K")){c.preventDefault(),window.openCmdk();return}if(c.key==="Escape"){var u=document.getElementById("cmdk-mask");if(u&&u.classList.contains("show")){window.closeCmdk();return}var f=document.getElementById("avatar-popup");f&&f.classList.contains("show")&&typeof window._closeAvatarPopup=="function"&&window._closeAvatarPopup()}});try{var m=(navigator.userAgent||"").toLowerCase(),d=m.indexOf("mac")>=0||m.indexOf("iphone")>=0||m.indexOf("ipad")>=0;d||document.body.classList.add("is-windows")}catch{}function p(){n(),l(),typeof window.subscribeI18n=="function"&&window.subscribeI18n("nav-ia-phase1-role",function(){try{typeof window.applyRoleVisibility=="function"&&window.applyRoleVisibility()}catch{}})}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",p):p()})();(function(){function n(v){return String(v??"").replace(/[&<>"']/g,function(y){return{"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"}[y]})}function a(v){if(!v||isNaN(v))return"";var y=Number(v);return y<1024?y+" B":y<1024*1024?(y/1024).toFixed(1)+" KB":(y/1024/1024).toFixed(1)+" MB"}document.addEventListener("click",function(v){var y=v.target.closest&&v.target.closest(".recon-collapse-head");if(y&&!(v.target.closest("button")||v.target.closest("a"))){var b=y.closest(".recon-collapse");if(b){var h=b.getAttribute("data-collapsed")==="true";b.setAttribute("data-collapsed",h?"false":"true"),h&&(b.id==="vex-summary-collapse"&&p(),b.id==="vex-detail-collapse"&&c())}}}),document.addEventListener("keydown",function(v){if(!(v.key!=="Enter"&&v.key!==" ")){var y=v.target.closest&&v.target.closest(".recon-collapse-head");y&&(v.preventDefault(),y.click())}});var s={vat:"",gl:""};window._glvClearPreviewSearch=function(){s.vat="",s.gl=""};var o='<svg class="vex-pp-fi-icon" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#111111" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/></svg>',i='<svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg>';function r(){m("vat"),m("gl")}function l(v){try{if(typeof window._glvPreviewFiles=="function")return window._glvPreviewFiles(v)||[]}catch{}var y=document.getElementById(v==="vat"?"glv-vat-input":"glv-gl-input");return y&&y.files?Array.from(y.files):[]}function m(v){var y=document.getElementById(v==="vat"?"glv-pp-vat-col":"glv-pp-gl-col");if(y){var b=l(v),h=v==="vat"?"glv-up-vat-title":"glv-up-gl-title",g=v==="vat"?"① 销项税报告":"② 总账 GL",_=window.t&&window.t(h)||g,w=n(window.t&&window.t("vex-preview-search")||"搜索文件名..."),k=n(window.t&&window.t("vex-preview-clear-all")||"全清"),x=s[v]||"",E=b.length;y.innerHTML='<div class="vex-pp-col-title"><span class="vex-pp-col-name">'+n(_)+' <span class="vex-pp-col-count">'+E+'</span></span></div><div class="vex-pp-search-row"><input class="vex-pp-search" id="glv-pp-search-'+v+'" type="text" placeholder="'+w+'" value="'+n(x)+'" autocomplete="off"><button class="vex-pp-clear-btn" id="glv-pp-clearall-'+v+'" type="button">'+k+'</button></div><div class="vex-pp-file-list" id="glv-pp-'+v+'-list"></div><div class="vex-pp-pagination" id="glv-pp-'+v+'-pg"></div>';var I=document.getElementById("glv-pp-search-"+v);I&&I.addEventListener("input",function(L){s[v]=L.target.value,d(v)});var B=document.getElementById("glv-pp-clearall-"+v);B&&B.addEventListener("click",function(){window._glvRemoveFile&&window._glvRemoveFile(v)}),d(v)}}function d(v){var y=document.getElementById("glv-pp-"+v+"-list"),b=document.getElementById("glv-pp-"+v+"-pg");if(y){var h=l(v),g=(s[v]||"").toLowerCase(),_=h.map(function(x,E){return{f:x,i:E}}),w=g?_.filter(function(x){return x.f.name.toLowerCase().indexOf(g)>=0}):_;if(y.innerHTML=w.map(function(x){var E=x.f;return'<div class="vex-pp-file-row">'+o+'<span class="vex-pp-fi-name" title="'+n(E.name)+'">'+n(E.name)+'</span><span class="vex-pp-fi-size">'+a(E.size)+'</span><button class="vex-pp-fi-del" type="button" data-kind="'+v+'" data-idx="'+x.i+'" aria-label="remove">'+i+"</button></div>"}).join(""),y.querySelectorAll(".vex-pp-fi-del").forEach(function(x){x.addEventListener("click",function(){var E=x.dataset.kind,I=parseInt(x.dataset.idx,10);window._glvRemoveFile&&window._glvRemoveFile(E,isNaN(I)?null:I)})}),b){var k=window.t&&window.t("vex-preview-count")||"显示前 {n} / 共 {m}";b.textContent=k.replace("{n}",w.length).replace("{m}",w.length)}}}function p(){var v=function(b,h){var g=document.getElementById(b);g&&(g.textContent=h==null?"—":String(h))},y=window._vexLastTask||{};v("vex-sum-total",y.total),v("vex-sum-matched",y.matched),v("vex-sum-diff",y.diff),v("vex-sum-incomplete",y.incomplete),v("vex-sum-cash",y.cash),document.getElementById("vex-summary-sub")}function c(){var v=window._vexLastTask&&window._vexLastTask.diff_rows||[],y=document.getElementById("vex-detail-tbody"),b=document.getElementById("vex-detail-table"),h=document.getElementById("vex-detail-empty");if(!(!y||!b||!h)){if(v.length===0){b.style.display="none",h.style.display="";return}h.style.display="none",b.style.display="";var g=v.map(function(w){return'<tr><td class="recon-detail-cell-mono">'+n(w.invoice_no||"")+"</td><td>"+n(w.field||"")+"</td><td>"+n(w.report_value||"")+"</td><td>"+n(w.invoice_value||"")+"</td><td>"+n(w.kind||"")+"</td></tr>"}).join("");y.innerHTML=g;var _=document.getElementById("vex-detail-sub");_&&(_.textContent=String(v.length))}}function u(){var v=document.getElementById("glv-toggle-preview");v&&!v._reconBound&&(v._reconBound=!0,v.addEventListener("click",function(){var y=document.getElementById("glv-preview-panel"),b=document.getElementById("glv-toggle-preview-label"),h=y&&y.style.display!=="none";y&&(y.style.display=h?"none":""),v.classList.toggle("open",!h),b&&(b.textContent=h?window.t&&window.t("vex-toggle-preview-open")||"查看清单":window.t&&window.t("vex-toggle-preview-close")||"收起清单"),h||r()})),["glv-vat-input","glv-gl-input"].forEach(function(y){var b=document.getElementById(y);!b||b._reconWatched||(b._reconWatched=!0,b.addEventListener("change",function(){var h=document.getElementById("glv-preview-panel");h&&h.style.display!=="none"&&r()}))})}function f(){var v=document.getElementById("vex-summary-collapse"),y=document.getElementById("vex-detail-collapse");v&&(v.style.display=""),y&&(y.style.display=""),p(),c()}window._fillVexSummary=p,window._fillVexDetail=c,window._onVexResultShown=f,document.addEventListener("DOMContentLoaded",function(){u()}),setTimeout(u,1500),typeof window.subscribeI18n=="function"&&window.subscribeI18n("recon-collapse",function(){var v=document.getElementById("glv-preview-panel");v&&v.style.display!=="none"&&r();var y=document.getElementById("glv-toggle-preview-label"),b=document.getElementById("glv-toggle-preview");y&&b&&(y.textContent=b.classList.contains("open")?window.t&&window.t("vex-toggle-preview-close")||"收起清单":window.t&&window.t("vex-toggle-preview-open")||"查看清单")}),window._reconCollapse={renderGlvPreview:r,fillVexSummary:p,fillVexDetail:c}})();(function(){function e(i){}function n(){const i=document.querySelectorAll("[data-recon-tab]");i.forEach(l=>{l.addEventListener("click",()=>{i.forEach(u=>u.classList.remove("active")),l.classList.add("active");const m=l.dataset.reconTab,d=document.getElementById("recon-pane-bank"),p=document.getElementById("recon-pane-sale-vat"),c=document.getElementById("recon-pane-gl-vat");d&&(d.style.display=m==="bank"?"":"none"),p&&(p.style.display=m==="sale-vat"?"":"none"),c&&(c.style.display=m==="gl-vat"?"":"none"),m==="gl-vat"&&window.GlVatRecon&&window.GlVatRecon.ensureInit(),m==="bank"&&typeof window._bankReconV2Init=="function"&&window._bankReconV2Init()})});const r=document.querySelector("[data-recon-tab].active");r&&(r.dataset.reconTab,void 0)}function a(){const i=document.getElementById("page-settings");if(!i)return null;let r=document.getElementById("settings-modal-overlay");if(r)return r;r=document.createElement("div"),r.id="settings-modal-overlay",r.className="settings-modal-overlay",r.style.display="none",i.parentElement.insertBefore(r,i),r.appendChild(i);const l=document.createElement("button");return l.id="settings-modal-close",l.className="settings-modal-close",l.setAttribute("aria-label","close"),l.innerHTML='<svg viewBox="0 0 20 20" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M5 5l10 10M15 5L5 15"/></svg>',i.insertBefore(l,i.firstChild),l.addEventListener("click",o),r.addEventListener("click",m=>{m.target===r&&o()}),r}function s(){const i=a();if(!i)return;i.style.display="flex",document.body.classList.add("settings-modal-open");const r=document.getElementById("page-settings");r&&(r.style.display="block"),setTimeout(()=>{try{typeof renderSettings=="function"&&renderSettings()}catch(m){console.warn("renderSettings:",m)}let l=document.querySelector(".settings-tab.active")||document.querySelector('.settings-tab[data-tab="profile"]');l&&l.click()},50)}function o(){const i=document.getElementById("settings-modal-overlay");i&&(i.style.display="none"),document.body.classList.remove("settings-modal-open")}window.openSettingsModal=s,window.closeSettingsModal=o,document.addEventListener("keydown",i=>{if(i.key==="Escape"){const r=document.getElementById("settings-modal-overlay");r&&r.style.display==="flex"&&o()}}),window.addEventListener("hashchange",()=>{location.hash==="#/settings"&&s()}),window.addEventListener("DOMContentLoaded",()=>{location.hash==="#/settings"&&s()}),document.readyState==="loading"?document.addEventListener("DOMContentLoaded",n):n()})();const Ma=1e3,Ha=30,Us=/\.(pdf|jpe?g|png|webp|tiff?|xlsx?|xlsm|csv|tsv|docx?)$/i,te=e=>document.getElementById(e);function Ht(){return{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||"")}}function Te(e){const n={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"};return String(e??"").replace(/[&<>"']/g,a=>n[a])}function Ir(e){return e<1024?e+" B":e<1024*1024?(e/1024).toFixed(1)+" KB":(e/1024/1024).toFixed(1)+" MB"}const A={invoiceFiles:[],reportFiles:[],running:!1,vexAllRows:[],previewLimitInv:50,previewLimitRep:50,previewSearchInv:"",previewSearchRep:"",vexPage:1};async function On(){try{const e=await fetch("/api/vat_excel/tasks?page=1&page_size=1",{headers:Ht()});if(!e.ok)return;const a=(await e.json()).kpi||{};[["vex-kpi-month-val",a.this_month],["vex-kpi-running-val",a.running],["vex-kpi-done-val",a.done],["vex-kpi-failed-val",a.failed]].forEach(([s,o])=>{const i=document.getElementById(s);i&&(i.textContent=o??0)})}catch{}}async function Vn(){try{const e=await fetch("/api/vat_excel/tasks?page=1&page_size=100",{headers:Ht()});if(!e.ok)return;const n=await e.json();aa(n.rows||[])}catch{}}const Ot=10;function Br(){var e=((document.getElementById("vex-task-search")||{}).value||"").trim().toLowerCase();if(A.vexPage=1,aa(A.vexAllRows),!!e){var n=document.getElementById("vex-task-tbody");n&&n.querySelectorAll("tr").forEach(function(a){a.dataset.taskId&&(a.style.display=a.textContent.toLowerCase().indexOf(e)>=0?"":"none")})}}function aa(e){A.vexAllRows=e||A.vexAllRows;const n=document.getElementById("vex-task-tbody");if(!n)return;if(!A.vexAllRows.length){n.innerHTML='<tr><td colspan="9" class="vex-task-empty">'+(t("sv-empty-title")||"还没有对账任务")+"</td></tr>",Go(0);return}const a=Math.ceil(A.vexAllRows.length/Ot);A.vexPage>a&&(A.vexPage=a);const s=(A.vexPage-1)*Ot;gm(A.vexAllRows.slice(s,s+Ot)),Go(A.vexAllRows.length)}function Go(e){const n=document.getElementById("vex-task-pager"),a=document.getElementById("vex-task-pager-info"),s=document.getElementById("vex-task-prev"),o=document.getElementById("vex-task-next");if(!n)return;if(e<=Ot){n.style.display="none";return}n.style.display="";const i=Math.ceil(e/Ot);a&&(a.textContent=A.vexPage+" / "+i),s&&(s.disabled=A.vexPage<=1),o&&(o.disabled=A.vexPage>=i)}function gm(e){const n=document.getElementById("vex-task-tbody");if(!n)return;const a={pending:t("vex-status-pending")||"待处理",running:t("vex-status-running")||"处理中",done:t("vex-status-done")||"已完成",failed:t("vex-status-failed")||"失败"},s={pending:"badge-gray",running:"badge-blue",done:"badge-green",failed:"badge-red"},o='<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M8 2v9M4 7l4 4 4-4M3 14h10"/></svg>',i='<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M3 4h10M6 4V3h4v1M5 4v8a1 1 0 001 1h4a1 1 0 001-1V4"/></svg>';n.innerHTML=e.map(r=>{const l=r.created_at?new Date(r.created_at).toLocaleString([],{year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",minute:"2-digit"}):"—",m=r.period||"—",d=r.matched_count!=null?r.matched_count+" ✓ · "+r.mismatched_count+" ⚠":"—",p=r.mismatch_amount!=null?"฿ "+Number(r.mismatch_amount).toLocaleString():"—",c=r.elapsed_seconds!=null?r.elapsed_seconds.toFixed(1)+" s":"—",u=r.status||"pending",f=r.client_name&&r.client_name!=="client"?r.client_name:t("vex-client-all")||"全部客户";return`<tr class="vex-task-row" data-task-id="${Te(r.id)}" style="cursor:pointer">
            <td>${l}</td>
            <td>${Te(f)}</td>
            <td>${Te(m)}</td>
            ...
            <td><div class="vex-task-actions">
                <button class="vex-task-dl-btn" data-task-id="${Te(r.id)}" title="${t("hist_export")||"导出"}">${o}</button>
                <button class="vex-task-del-btn" data-task-id="${Te(r.id)}" title="${t("vex-task-delete-confirm-title")||"删除"}">${i}</button>
            </div></td>
        </tr>`}).join(""),n.querySelectorAll(".vex-task-dl-btn").forEach(r=>{r.addEventListener("click",async l=>{l.stopPropagation();const m=r.dataset.taskId;try{const d=await fetch("/api/vat_excel/tasks/"+encodeURIComponent(m)+"/download",{credentials:"include",headers:Ht()});if(d.status===410){showToast(t("vex-toast-expired")||"数据已过期 · 请重新对账","warn");return}if(!d.ok){showToast(t("vex-toast-dl-fail")||"下载失败 · 请重试","error");return}const p=await d.blob(),u=(d.headers.get("Content-Disposition")||"").match(/filename\*?=(?:UTF-8''|")?([^";]+)/i),f=u?decodeURIComponent(u[1]):"vat_recon_"+m+".xlsx",v=URL.createObjectURL(p),y=document.createElement("a");y.href=v,y.download=f,y.click(),setTimeout(()=>URL.revokeObjectURL(v),1e3)}catch{showToast(t("vex-toast-dl-fail")||"下载失败 · 请重试","error")}})}),n.querySelectorAll(".vex-task-del-btn").forEach(r=>{r.addEventListener("click",l=>{l.stopPropagation(),ym(r.dataset.taskId)})}),Br()}function bm(){var e=document.getElementById("vex-task-prev"),n=document.getElementById("vex-task-next");e&&!e._vexBound&&(e._vexBound=!0,e.addEventListener("click",function(){A.vexPage>1&&(A.vexPage--,aa())})),n&&!n._vexBound&&(n._vexBound=!0,n.addEventListener("click",function(){var a=Math.ceil(A.vexAllRows.length/Ot);A.vexPage<a&&(A.vexPage++,aa())}))}async function ym(e){const n=t("vex-task-delete-confirm-title")||"删除对账任务?",a=t("vex-task-delete-confirm-body")||"同时清掉对应的发票识别缓存 · 不可恢复";if(await showConfirm(a,{title:n,danger:!0,okText:t("vex-task-delete-confirm-title")||"确认删除"}))try{const o=await fetch("/api/vat_excel/tasks/"+encodeURIComponent(e),{method:"DELETE",credentials:"include",headers:Ht()});if(!o.ok)throw new Error(o.status);showToast(t("vex-task-delete-ok")||"已删除","success"),Vn(),On()}catch{showToast(t("vex-task-delete-fail")||"删除失败","error")}}function Lr(e){const n=window._currentLang||"th",a={zh:`已忽略 ${e} 个不支持的文件 · 仅支持 PDF / 图片 / Excel / CSV / Word`,th:`ข้ามไฟล์ที่ไม่รองรับ ${e} ไฟล์ · รองรับเฉพาะ PDF / รูปภาพ / Excel / CSV / Word`,en:`Ignored ${e} unsupported file(s) · only PDF / image / Excel / CSV / Word are supported`,ja:`非対応ファイル ${e} 件をスキップ · 対応形式は PDF / 画像 / Excel / CSV / Word のみ`};showToast(a[n]||a.th,"warn")}function wm(e){const n=new Set(A.invoiceFiles.map(s=>s.name+"|"+s.size));let a=0;for(const s of e){if(!Us.test(s.name)){a++;continue}const o=s.name+"|"+s.size;if(!n.has(o)&&(n.add(o),A.invoiceFiles.push(s),A.invoiceFiles.length>=Ma))break}a>0&&Lr(a),A.invoiceFiles.length>Ma&&(A.invoiceFiles=A.invoiceFiles.slice(0,Ma),showToast(t("vex-toast-cap-inv"),"warn")),gt()}function km(e){const n=new Set(A.reportFiles.map(s=>s.name+"|"+s.size));let a=0;for(const s of e){if(!Us.test(s.name)){a++;continue}const o=s.name+"|"+s.size;if(!n.has(o)&&(n.add(o),A.reportFiles.push(s),A.reportFiles.length>=Ha))break}a>0&&Lr(a),A.reportFiles.length>Ha&&(A.reportFiles=A.reportFiles.slice(0,Ha),showToast(t("vex-toast-cap-rep"),"warn")),gt()}function $r(e){A.invoiceFiles.splice(e,1),gt()}function Sr(e){A.reportFiles.splice(e,1),gt()}function gt(){const e=te("vex-list-invoice"),n=te("vex-list-report"),a=te("vex-count-invoice"),s=te("vex-count-report");a&&(a.textContent=A.invoiceFiles.length),s&&(s.textContent=A.reportFiles.length);const o=(l,m,d)=>`<div class="vex-fi">
        ...
        <span class="vex-fi-n" title="${Te(l.name)}">${Te(l.name)}</span>
        <span class="vex-fi-s">${Ir(l.size)}</span>
        <button class="vex-fi-x" type="button" data-vex-kind="${d}" data-vex-idx="${m}" aria-label="remove">×</button>
    </div>`;e&&(e.innerHTML=A.invoiceFiles.map((l,m)=>o(l,m,"inv")).join("")||'<div class="vex-fi-empty" data-i18n="vex-no-files">还没文件</div>'),n&&(n.innerHTML=A.reportFiles.map((l,m)=>o(l,m,"rep")).join("")||'<div class="vex-fi-empty" data-i18n="vex-no-files">还没文件</div>'),document.querySelectorAll(".vex-fi-x").forEach(l=>{l.addEventListener("click",m=>{const d=l.dataset.vexKind,p=parseInt(l.dataset.vexIdx,10);d==="inv"?$r(p):Sr(p)})});const i=A.invoiceFiles.length>0&&A.reportFiles.length>0;te("vex-build").disabled=!i||A.running;const r=te("vex-action-info");r&&(!A.invoiceFiles.length||!A.reportFiles.length?(r.textContent=t("vex-need-both")||"需要至少 1 张发票 + 1 份 VAT 报告",r.className="vex-action-info muted"):(r.textContent=(t("vex-ready")||"已就绪 · {a} 张发票 · {b} 份报告").replace("{a}",A.invoiceFiles.length).replace("{b}",A.reportFiles.length),r.className="vex-action-info ok")),es()}const xm='<svg class="vex-pp-fi-icon" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#6B7280" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path><polyline points="14 2 14 8 20 8"></polyline></svg>',_m='<svg class="vex-pp-fi-icon" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#111111" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="4" width="18" height="18" rx="2" ry="2"></rect><line x1="16" y1="2" x2="16" y2="6"></line><line x1="8" y1="2" x2="8" y2="6"></line><line x1="3" y1="10" x2="21" y2="10"></line></svg>',Em='<svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg>';function es(){const e=te("vex-preview-panel");if(!e||e.style.display==="none")return;Wo("inv"),Wo("rep");const n=te("vex-pp-guide");n&&(n.style.display=A.invoiceFiles.length>100?"flex":"none")}function Wo(e){const n=te(e==="inv"?"vex-pp-invoice-col":"vex-pp-report-col");if(!n)return;const a=e==="inv"?A.invoiceFiles:A.reportFiles,s=e==="inv"?A.previewSearchInv:A.previewSearchRep,o=t(e==="inv"?"vex-preview-invoice":"vex-preview-report")||(e==="inv"?"销售发票":"VAT 报告"),i=Te(t("vex-preview-search")||"搜索文件名..."),r=Te(t("vex-preview-clear-all")||"全清");n.innerHTML=`
        <div class="vex-pp-col-title">
            <span class="vex-pp-col-name">${Te(o)} <span class="vex-pp-col-count">${a.length}</span></span>
        </div>
        <div class="vex-pp-search-row">
            <input class="vex-pp-search" id="vex-pp-search-${e}" type="text"
                   placeholder="${i}" value="${Te(s)}" autocomplete="off">
            <button class="vex-pp-clear-btn" id="vex-pp-clearall-${e}" type="button">${r}</button>
        </div>
        <div class="vex-pp-file-list" id="vex-pp-${e}-list"></div>
        <div class="vex-pp-pagination" id="vex-pp-${e}-pg"></div>`;const l=te("vex-pp-search-"+e);l&&l.addEventListener("input",d=>{e==="inv"?(A.previewSearchInv=d.target.value,A.previewLimitInv=50):(A.previewSearchRep=d.target.value,A.previewLimitRep=50),ts(e)});const m=te("vex-pp-clearall-"+e);m&&m.addEventListener("click",()=>{e==="inv"?(A.invoiceFiles=[],A.previewSearchInv="",A.previewLimitInv=50):(A.reportFiles=[],A.previewSearchRep="",A.previewLimitRep=50),gt()}),ts(e)}function ts(e){const n=te("vex-pp-"+e+"-list"),a=te("vex-pp-"+e+"-pg");if(!n)return;const s=e==="inv"?A.invoiceFiles:A.reportFiles,o=e==="inv"?A.previewSearchInv:A.previewSearchRep,i=e==="inv"?A.previewLimitInv:A.previewLimitRep,r=e==="inv"?xm:_m,l=s.map((p,c)=>({f:p,i:c})),m=o?l.filter(({f:p})=>p.name.toLowerCase().includes(o.toLowerCase())):l,d=m.slice(0,i);if(n.innerHTML=d.map(({f:p,i:c})=>`
        <div class="vex-pp-file-row">
            ${r}
            <span class="vex-pp-fi-name" title="${Te(p.name)}">${Te(p.name)}</span>
            <span class="vex-pp-fi-size">${Ir(p.size)}</span>
            <button class="vex-pp-fi-del" type="button" data-kind="${e}" data-ridx="${c}" aria-label="remove">${Em}</button>
        </div>`).join("")+`<div id="vex-pp-sentinel-${e}" style="height:1px;flex-shrink:0"></div>`,n.querySelectorAll(".vex-pp-fi-del").forEach(p=>{p.addEventListener("click",()=>{const c=parseInt(p.dataset.ridx,10);p.dataset.kind==="inv"?$r(c):Sr(c)})}),a){const p=t("vex-preview-count")||"显示前 {n} / 共 {m}";a.textContent=p.replace("{n}",d.length).replace("{m}",m.length)}Im(e,m.length)}function Im(e,n){if((e==="inv"?A.previewLimitInv:A.previewLimitRep)>=n)return;const s=te("vex-pp-sentinel-"+e),o=te("vex-pp-"+e+"-list");if(!s||!o)return;const i=new IntersectionObserver(r=>{r[0].isIntersecting&&(i.disconnect(),e==="inv"?A.previewLimitInv+=50:A.previewLimitRep+=50,ts(e))},{root:o,threshold:.8});i.observe(s)}function Ko(e,n,a,s){const o=te(e),i=te(n);!o||!i||(o.addEventListener("click",()=>i.click()),o.addEventListener("keydown",r=>{(r.key==="Enter"||r.key===" ")&&(r.preventDefault(),i.click())}),o.addEventListener("dragover",r=>{r.preventDefault(),o.classList.add("drag-over")}),o.addEventListener("dragleave",()=>o.classList.remove("drag-over")),o.addEventListener("drop",r=>{r.preventDefault(),o.classList.remove("drag-over");const m=Array.from(r.dataTransfer.files).filter(d=>Us.test(d.name));if(!m.length){showToast(t("vex-toast-bad-ext"),"error");return}a(m)}),i.addEventListener("change",()=>{const r=Array.from(i.files);a(r),i.value=""}))}(function(){async function e(){if(A.running||!A.invoiceFiles.length||!A.reportFiles.length)return;A.running=!0,te("vex-build").disabled=!0,te("vex-progress").style.display="flex";var r=document.getElementById("vex-download");r&&(r.style.display="none"),["vex-summary-collapse","vex-detail-collapse"].forEach(function(p){var c=document.getElementById(p);c&&(c.style.display="none")});const l=Date.now();te("vex-progress-title").textContent=t("vex-progress-running")||"AI 抽取中",te("vex-progress-sub").textContent=(t("vex-progress-sub")||"{a} 张发票 + {b} 份报告 · 并行处理").replace("{a}",A.invoiceFiles.length).replace("{b}",A.reportFiles.length);const m=setInterval(()=>{const p=Math.floor((Date.now()-l)/1e3);te("vex-progress-sub").textContent=(t("vex-progress-elapsed")||"已 {s} 秒 · {a} 张发票 + {b} 份报告").replace("{s}",p).replace("{a}",A.invoiceFiles.length).replace("{b}",A.reportFiles.length)},1e3);try{const p=new FormData;for(const L of A.invoiceFiles)p.append("invoices",L);for(const L of A.reportFiles)p.append("reports",L);const c=typeof currentLang=="string"&&currentLang||localStorage.getItem("mrpilot_lang")||"th";p.append("lang",c);const u=localStorage.getItem("mrpilot_token")||"",f=await fetch("/api/vat_excel/submit",{method:"POST",headers:Ht(),body:p});let v=null;try{v=await f.json()}catch{v=null}if(!f.ok||!v||!v.ok||!v.job_id)throw clearInterval(m),new Error(v&&v.detail||"HTTP "+f.status);const y=te("vex-progress-sub"),b=await window._reconPollJob(v.job_id,u,{onProgress:L=>{y&&(y.textContent=window._reconProgressText(L,c))}});if(clearInterval(m),!b||b.status!=="done"||!b.result_id)throw new Error(t("vex-toast-fail")||"生成失败");const h=b.result_id;let g=0;const _=await fetch("/api/vat_excel/tasks/"+encodeURIComponent(h)+"/download",{headers:Ht()});if(!_.ok)throw new Error("HTTP "+_.status);const k=(_.headers.get("Content-Disposition")||"").match(/filename="([^"]+)"/),x=k&&k[1]||"vat_recon_"+Date.now()+".xlsx",E=await _.blob(),I=URL.createObjectURL(E),B=te("vex-download");B.href=I,B.download=x;try{const L=document.createElement("a");L.href=I,L.download=x,document.body.appendChild(L),L.click(),setTimeout(()=>L.remove(),100)}catch{}te("vex-progress").style.display="none";var d=document.getElementById("vex-download");d&&(d.style.display=""),h&&(g=await s(h)),window._onVexResultShown&&window._onVexResultShown(),g>0?showToast((t("vex-toast-some-fail")||"有 {n} 张发票 OCR 失败").replace("{n}",g),"warn"):showToast(t("vex-toast-done")||"Excel 已生成","success"),On(),setTimeout(Vn,800)}catch(p){clearInterval(m),te("vex-progress").style.display="none";const c=(t("vex-toast-fail")||"生成失败")+": "+(p.message||p);showToast(c,"error")}finally{A.running=!1,te("vex-build").disabled=!1}}function n(){A.invoiceFiles=[],A.reportFiles=[];var r=document.getElementById("vex-download");r&&(r.style.display="none"),gt()}function a(r){if(r==null)return"—";var l=parseFloat(r);return isNaN(l)?"—":l.toLocaleString("th-TH",{minimumFractionDigits:2,maximumFractionDigits:2})}async function s(r){try{var l=await fetch("/api/vat_excel/tasks/"+encodeURIComponent(r),{headers:Ht()});if(!l.ok)throw new Error(l.status);var m=await l.json(),d=m.raw_data_json;if(typeof d=="string")try{d=JSON.parse(d)}catch{d={}}d=d||{};var p=d.rows||[],c=[];p.forEach(function(v){v.kind==="invoice_orphan"?c.push({invoice_no:v.invoice_no||"",field:"仅发票有",report_value:"—",invoice_value:a(v.amount_inv),kind:v.kind}):v.kind==="report_orphan"?c.push({invoice_no:v.invoice_no||"",field:"仅报告有",report_value:a(v.amount_rep),invoice_value:"—",kind:v.kind}):v.dims&&Object.keys(v.dims).length>0&&Object.keys(v.dims).forEach(function(y){var b=String(v.dims[y]||""),h=b.split(" ≠ ");c.push({invoice_no:v.invoice_no||"",field:y,report_value:h[0]||b,invoice_value:h.length>1?h[1]:"—",kind:"diff"})})});var u=p.filter(function(v){return v.kind==="matched_cash"}).length,f=Math.max(0,parseInt(d.invoice_ocr_failed_count||0,10));return window._vexLastTask={total:d.n_total||0,matched:d.n_ok||0,diff:d.n_diff||0,incomplete:f,cash:u,diff_rows:c,task_id:r},window._fillVexSummary&&window._fillVexSummary(),window._fillVexDetail&&window._fillVexDetail(),f}catch{return 0}}function o(){const r=document.getElementById("vex-pane");r&&r.querySelectorAll("[data-i18n]").forEach(l=>{const m=t(l.dataset.i18n);m&&(l.textContent=m)}),gt(),Vn()}function i(){Ko("vex-drop-invoice","vex-input-invoice",wm),Ko("vex-drop-report","vex-input-report",km);const r=te("vex-build"),l=te("vex-reset");r&&r.addEventListener("click",e),l&&l.addEventListener("click",n),document.querySelectorAll('[data-recon-tab="sale-vat"]').forEach(p=>{p.addEventListener("click",()=>{On(),Vn()})}),bm();const m=document.getElementById("vex-task-search");m&&m.addEventListener("input",Br);const d=document.getElementById("vex-toggle-preview");d&&d.addEventListener("click",()=>{const p=te("vex-preview-panel"),c=te("vex-toggle-preview-label"),u=p&&p.style.display!=="none";p&&(p.style.display=u?"none":""),d&&d.classList.toggle("open",!u),c&&(c.textContent=u?t("vex-toggle-preview-open")||"查看清单":t("vex-toggle-preview-close")||"收起清单"),u||es()}),gt(),On()}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",i):i(),typeof window.subscribeI18n=="function"&&(window.subscribeI18n("vex-excel",o),window.subscribeI18n("vex-preview-panel",es))})();const J={inited:!1,glFile:[],vatFile:[],running:!1,currentTaskId:null,lastDetail:[],lastSummary:null},W=e=>document.getElementById(e),Cr=()=>localStorage.getItem("mrpilot_token")||"",Xt=()=>typeof window.currentLang=="string"&&window.currentLang?window.currentLang:localStorage.getItem("mrpilot_lang")||"th",At=()=>({Authorization:"Bearer "+Cr()}),Yo={th:{not_found:"ไม่พบข้อมูล",running:"กำลังกระทบยอด…",error:"เกิดข้อผิดพลาด",need_files:"กรุณาเลือกไฟล์ทั้งสอง",done:"เสร็จสิ้น",hint_need_both:"อัปโหลด ① รายงานภาษีขาย + ② GL",hint_need_one_more:"อัปโหลดอีก 1 ไฟล์",hint_ready:"พร้อมแล้ว · กดเริ่มกระทบยอด",hist_load:"โหลด",hist_export:"ส่งออก",hist_delete:"ลบ",confirm_delete:"ยืนยันการลบงานนี้?",s_gl_total:"ยอดรวมตามบัญชีแยกประเภท",s_minus_gl_cr:"หัก : รายการเครดิตที่ไม่มีในรายงานภาษีขาย",s_plus_gl_dr:"บวก : รายการเดบิตที่ไม่มีในรายงานภาษีขาย",s_plus_vat_p:"บวก : รายการยอดขายที่ไม่มีในบัญชีแยกประเภท",s_minus_vat_n:"หัก : รายการลดหนี้ที่ไม่มีในบัญชีแยกประเภท",s_vat_total:"ยอดรวมตามรายงานภาษีขาย"},zh:{not_found:"未找到数据",running:"正在对账中...",error:"出错了",need_files:"请先选择两个文件",done:"完成",hint_need_both:"请上传① 销项税报告 + ② 总账 GL",hint_need_one_more:"还需上传 1 份文件",hint_ready:"已就绪 · 点击开始对账",hist_load:"加载",hist_export:"导出",hist_delete:"删除",confirm_delete:"确认删除此任务？",s_gl_total:"总账金额合计",s_minus_gl_cr:"减：销项税报告中未列的贷方记录",s_plus_gl_dr:"加：销项税报告中未列的借方记录",s_plus_vat_p:"加：总账中未列的销售记录",s_minus_vat_n:"减：总账中未列的贷项凭单(credit note)记录",s_vat_total:"销项税报告金额合计"},en:{not_found:"Not found",running:"Reconciling...",error:"Error",need_files:"Please select both files",done:"Done",hint_need_both:"Upload ① Output VAT report + ② GL file",hint_need_one_more:"1 more file required",hint_ready:"Ready · click Run to start",hist_load:"Load",hist_export:"Export",hist_delete:"Delete",confirm_delete:"Delete this task?",s_gl_total:"Total per General Ledger",s_minus_gl_cr:"Less: GL credits not in VAT Report",s_plus_gl_dr:"Add: GL debits not in VAT Report",s_plus_vat_p:"Add: Sales in VAT Report not in GL",s_minus_vat_n:"Less: Credit notes in VAT Report not in GL",s_vat_total:"Total per VAT Sales Report"},ja:{not_found:"データなし",running:"照合中…",error:"エラー",need_files:"両方のファイルを選択してください",done:"完了",hint_need_both:"① 売上税報告 + ② GL をアップロード",hint_need_one_more:"あと 1 ファイル必要",hint_ready:"準備完了 · 「開始」をクリック",hist_load:"読込",hist_export:"出力",hist_delete:"削除",confirm_delete:"このタスクを削除しますか?",s_gl_total:"総勘定元帳合計",s_minus_gl_cr:"減：売上税報告にないGL貸方記録",s_plus_gl_dr:"加：売上税報告にないGL借方記録",s_plus_vat_p:"加：GLにない売上記録",s_minus_vat_n:"減：GLにない赤伝記録",s_vat_total:"売上税報告合計"}},ie=e=>(Yo[Xt()]||Yo.th)[e]||e;function Bm(e){const n=Xt(),s={gl_no_revenue_rows:{zh:"GL 中未找到收入科目行。请确认「收入科目前缀」是否正确(收入科目通常以 4 开头),改对后重试。",th:"ไม่พบรายการบัญชีรายได้ใน GL · ตรวจสอบ «คำนำหน้าบัญชีรายได้» (รายได้มักขึ้นต้นด้วย 4) แล้วลองใหม่",en:"No revenue-account rows found in the GL. Check the “revenue account prefix” (revenue usually starts with 4) and retry.",ja:"GL に収益科目の行が見つかりません。「収益科目プレフィックス」(通常 4 で始まる)を確認して再試行してください。"},gl_parse_failed:{zh:"GL 文件解析失败。请确认文件含日期/科目/借贷列,或换清晰的 Excel/CSV 重传。",th:"อ่านไฟล์ GL ไม่สำเร็จ · ตรวจสอบว่ามีคอลัมน์ วันที่/บัญชี/เดบิต-เครดิต หรืออัปโหลด Excel/CSV ที่ชัดเจน",en:"Failed to parse the GL file. Ensure it has date/account/debit-credit columns, or re-upload a clean Excel/CSV.",ja:"GL ファイルの解析に失敗しました。日付/科目/借方貸方列を確認するか、Excel/CSV を再アップロードしてください。"},vat_no_rows:{zh:"销项税报告里没有可对账的数据行。请确认上传了正确的销项税报告。",th:"ไม่พบแถวข้อมูลในรายงานภาษีขาย · ตรวจสอบว่าอัปโหลดรายงานที่ถูกต้อง",en:"No rows found in the sales-VAT report. Please check you uploaded the correct report.",ja:"売上VATレポートに行が見つかりません。正しいレポートをアップロードしたか確認してください。"},vat_parse_failed:{zh:"销项税报告解析失败。请换更清晰的版本,或转成 Excel/PDF 重传。",th:"อ่านรายงานภาษีขายไม่สำเร็จ · ลองเวอร์ชันที่ชัดเจนกว่า หรือแปลงเป็น Excel/PDF",en:"Failed to parse the sales-VAT report. Try a clearer version, or convert to Excel/PDF.",ja:"売上VATレポートの解析に失敗しました。より鮮明な版か、Excel/PDF に変換してください。"}}[e];return s?s[n]||s.th||s.en:ie("error")||"Error"}const hn=e=>e==null||isNaN(e)?"":Number(e).toLocaleString("en-US",{minimumFractionDigits:2,maximumFractionDigits:2});function Gs(e){W("glv-kpi-matched")&&(W("glv-kpi-matched").textContent=e&&e.matched!=null?e.matched:"—"),W("glv-kpi-diff")&&(W("glv-kpi-diff").textContent=e&&e.diff!=null?e.diff:"—"),W("glv-kpi-unmatched")&&(W("glv-kpi-unmatched").textContent=e&&e.unmatched!=null?e.unmatched:"—")}function Lm(e){if(!e)return"";try{const n=new Date(e);if(isNaN(n.getTime()))return e;const a=s=>String(s).padStart(2,"0");return n.getFullYear()+"-"+a(n.getMonth()+1)+"-"+a(n.getDate())+" "+a(n.getHours())+":"+a(n.getMinutes())}catch{return e}}function Jo(e,n,a,s){const o=W(e),i=W(n),r=W(a);if(!o||!i||!r)return;const l=m=>{if(!m||!m.length)return;const d=Array.isArray(J[s])?J[s].slice():[],p=new Set(d.map(c=>c.name+"|"+c.size));for(const c of m){if(!c)continue;const u=c.name+"|"+c.size;p.has(u)||(d.push(c),p.add(u))}J[s]=d,Tr(r,d),En(),$n(),window._reconCollapse&&window._reconCollapse.renderGlvPreview&&window._reconCollapse.renderGlvPreview()};o.addEventListener("click",()=>i.click()),o.addEventListener("keydown",m=>{(m.key==="Enter"||m.key===" ")&&(m.preventDefault(),i.click())}),i.addEventListener("change",()=>{l(Array.from(i.files||[])),i.value=""}),o.addEventListener("dragover",m=>{m.preventDefault(),o.classList.add("drag-over")}),o.addEventListener("dragleave",()=>o.classList.remove("drag-over")),o.addEventListener("drop",m=>{m.preventDefault(),o.classList.remove("drag-over");const d=m.dataTransfer&&m.dataTransfer.files?Array.from(m.dataTransfer.files):[];l(d)})}function Tr(e,n){if(!e)return;if(!n||n.length===0){e.textContent="";return}const a=n.reduce((s,o)=>s+Math.round(o.size/1024),0);if(n.length===1)e.textContent=n[0].name+"  ("+a+" KB)";else{const s=window.t&&window.t("glv-files-count")||"{n} 个文件";e.textContent=s.replace("{n}",n.length)+"  ("+a+" KB)"}}function vt(e){const n=J[e];return Array.isArray(n)?n:n?[n]:[]}function En(){const e=W("btn-glv-run");if(!e)return;const n=vt("glFile").length>0&&vt("vatFile").length>0;e.disabled=!n||J.running}function $n(){const e=W("glv-status");if(!e||J.running)return;const n=vt("vatFile").length,a=vt("glFile").length;n===0&&a===0?(e.className="vex-action-info muted",e.innerHTML="<span>"+ie("hint_need_both")+"</span>"):n>0&&a>0?(e.className="vex-action-info ok",e.innerHTML="<span>"+ie("hint_ready")+"</span>"):(e.className="vex-action-info muted",e.innerHTML="<span>"+ie("hint_need_one_more")+"</span>")}function $m(e,n){const a=e==="vat"?"vatFile":"glFile",s=e==="vat"?"glv-vat-input":"glv-gl-input",o=e==="vat"?"glv-vat-name":"glv-gl-name",i=vt(a);n==null?J[a]=[]:J[a]=i.filter((l,m)=>m!==n);const r=W(s);r&&(r.value=""),Tr(W(o),vt(a)),En(),$n(),window._reconCollapse&&window._reconCollapse.renderGlvPreview&&window._reconCollapse.renderGlvPreview()}function Sm(){J.glFile=[],J.vatFile=[],J.currentTaskId=null,J.lastDetail=[],J.lastSummary=null;const e=W("glv-vat-input");e&&(e.value="");const n=W("glv-gl-input");n&&(n.value="");const a=W("glv-vat-name");a&&(a.textContent="");const s=W("glv-gl-name");s&&(s.textContent="");const o=W("glv-result");o&&(o.style.display="none");const i=W("glv-kpi-strip");i&&(i.style.display="none"),En(),$n(),window._glvClearPreviewSearch&&window._glvClearPreviewSearch(),window._reconCollapse&&window._reconCollapse.renderGlvPreview&&window._reconCollapse.renderGlvPreview()}function Ws(e){const n=W("glv-tbody");if(!n)return;Mm(e.length),n.innerHTML="";const a=ie("not_found"),s=document.createDocumentFragment();e.forEach(o=>{const i=document.createElement("tr"),r=(c,u)=>{const f=document.createElement("td");return u&&(f.className=u),f.textContent=c,f},l=o.gl_amount===null||o.gl_amount===void 0,m=o.diff;let d="glv-num",p="glv-num";l?(p+=" glv-cell-missing",d+=" glv-cell-missing"):Math.abs(m||0)<.005?d+=" glv-cell-ok":d+=" glv-cell-diff",i.appendChild(r(o.doc_no||"","glv-doc")),i.appendChild(r(o.date||"","")),i.appendChild(r(o.customer_name||"","")),i.appendChild(r(hn(o.vat_amount),"glv-num")),i.appendChild(r(l?a:hn(o.gl_amount),p)),i.appendChild(r(l?a:hn(o.diff),d)),i.appendChild(r(o.account_codes||"","glv-doc")),s.appendChild(i)}),n.appendChild(s)}function Ks(e){const n=W("glv-summary-table")&&W("glv-summary-table").querySelector("tbody");if(!n)return;n.innerHTML="",[{label:ie("s_gl_total"),amount:e.gl_total,emph:!0,items:[],negate:!1},{label:ie("s_minus_gl_cr"),amount:-(e.gl_only_credit||0),emph:!1,items:e.gl_only_credit_items||[],negate:!0},{label:ie("s_plus_gl_dr"),amount:e.gl_only_debit||0,emph:!1,items:e.gl_only_debit_items||[],negate:!1},{label:ie("s_plus_vat_p"),amount:e.vat_only_positive||0,emph:!1,items:e.vat_only_positive_items||[],negate:!1},{label:ie("s_minus_vat_n"),amount:e.vat_only_negative||0,emph:!1,items:e.vat_only_negative_items||[],negate:!1},{label:ie("s_vat_total"),amount:e.vat_total,emph:!0,items:[],negate:!1}].forEach(({label:s,amount:o,emph:i,items:r,negate:l})=>{const m=document.createElement("tr");m.className=i?"glv-summary-total":"glv-summary-sect";const d=document.createElement("td"),p=document.createElement("td");d.textContent=s,p.textContent=i?hn(o):"",m.appendChild(d),m.appendChild(p),n.appendChild(m),(r||[]).forEach(c=>{const u=document.createElement("tr");u.className="glv-summary-item";const f=document.createElement("td"),v=document.createElement("td"),y=[c.doc_no,c.date,c.name].filter(Boolean);f.textContent="· "+y.join("  ·  ");const b=l?-(c.amount||0):c.amount||0;v.textContent=hn(b),u.appendChild(f),u.appendChild(v),n.appendChild(u)})})}async function Cm(e){try{const a=await(await fetch("/api/recon/gl-vat/"+e,{headers:At()})).json();if(!a||!a.ok)throw new Error("load_failed");J.currentTaskId=e,J.lastDetail=a.detail||[],J.lastSummary=a.summary||{},Gs(a.stats||{}),Ws(J.lastDetail),Ks(J.lastSummary);const s=W("glv-result");s&&(s.style.display=""),Mr(),window.scrollTo({top:s?s.offsetTop-80:0,behavior:"smooth"})}catch(n){console.error("[gl-vat] load task failed:",n),alert(ie("error")+": "+(n.message||n))}}function Mr(){var e=W("glv-kpi-strip");e&&(e.style.display="");var n=W("glv-section-summary");n&&n.setAttribute("data-collapsed","false");var a=W("glv-section-detail");a&&a.setAttribute("data-collapsed","false")}function Tm(){document.querySelectorAll(".glv-section-head[data-toggle]").forEach(e=>{const n=e.getAttribute("data-toggle"),a=document.getElementById(n);if(!a)return;const s=o=>{if(o.target&&o.target.closest("button")!==null&&!o.target.classList.contains("glv-section-head"))return;const i=a.getAttribute("data-collapsed")==="true";a.setAttribute("data-collapsed",i?"false":"true")};e.addEventListener("click",s),e.addEventListener("keydown",o=>{(o.key==="Enter"||o.key===" ")&&(o.preventDefault(),s(o))})})}function Mm(e){const n=W("glv-detail-count");n&&(n.textContent=e!=null?String(e):"")}const cn=10;var Ft=[],qe=1;function Hm(){qe=1,sa();var e=((W("glv-hist-search")||{}).value||"").trim().toLowerCase();if(e){var n=W("glv-history-tbody");n&&n.querySelectorAll("tr").forEach(function(a){a.dataset.taskId&&(a.style.display=a.textContent.toLowerCase().indexOf(e)>=0?"":"none")})}}function sa(){const e=W("glv-history-table-wrap"),n=W("glv-history-empty"),a=W("glv-history-tbody"),s=W("glv-history-pager"),o=W("glv-history-pager-info"),i=W("glv-history-prev"),r=W("glv-history-next");if(!a)return;if(a.innerHTML="",!Ft.length){e&&(e.style.display="none"),n&&(n.style.display=""),s&&(s.style.display="none");return}e&&(e.style.display=""),n&&(n.style.display="none");const l=Math.ceil(Ft.length/cn);qe>l&&(qe=l);const m=(qe-1)*cn,d=Ft.slice(m,m+cn);s&&(s.style.display=Ft.length>cn?"":"none",o&&(o.textContent=qe+" / "+l),i&&(i.disabled=qe<=1),r&&(r.disabled=qe>=l)),d.forEach(c=>{const u=document.createElement("tr");u.dataset.taskId=c.id;const f=document.createElement("td");f.textContent=Lm(c.created_at);const v=document.createElement("td");v.className="glv-history-file",v.title=(c.vat_filename||"")+" + "+(c.gl_filename||""),v.textContent=(c.vat_filename||"?")+" + "+(c.gl_filename||"?");const y=document.createElement("td");y.className="glv-num",y.textContent=(c.vat_row_count||0)+" / "+(c.gl_row_count||0);const b=document.createElement("td");b.className="glv-num",b.textContent=c.matched_count||0;const h=document.createElement("td");h.className="glv-num",h.textContent=c.diff_count||0;const g=document.createElement("td");g.className="glv-num",g.textContent=c.unmatched_count||0;const _=document.createElement("td");_.className="glv-history-actions";const w=(I,B,L,$)=>{const S=document.createElement("button");return S.type="button",L&&(S.className=L),S.title=B,S.setAttribute("aria-label",B),S.innerHTML=I,S.onclick=$,S},k='<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" width="14" height="14"><path d="M2 8a6 6 0 1 0 12 0A6 6 0 0 0 2 8z"/><polyline points="6 8 8 10 10 8"/><line x1="8" y1="4" x2="8" y2="10"/></svg>',x='<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" width="14" height="14"><path d="M8 2v9M4 7l4 4 4-4M3 14h10"/></svg>',E='<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" width="14" height="14"><polyline points="3 4 13 4"/><path d="M6 4V2.5a.5.5 0 0 1 .5-.5h3a.5.5 0 0 1 .5.5V4"/><path d="M5 4l1 9a1 1 0 0 0 1 1h2a1 1 0 0 0 1-1l1-9"/></svg>';_.appendChild(w(k,ie("hist_load"),"",()=>Cm(c.id))),_.appendChild(w(x,ie("hist_export"),"",()=>jm(c.id))),_.appendChild(w(E,ie("hist_delete"),"glv-del",()=>Pm(c.id))),[f,v,y,b,h,g,_].forEach(I=>u.appendChild(I)),a.appendChild(u)})}function Am(){var e=W("glv-history-prev"),n=W("glv-history-next");e&&!e._glvBound&&(e._glvBound=!0,e.addEventListener("click",function(){qe>1&&(qe--,sa())})),n&&!n._glvBound&&(n._glvBound=!0,n.addEventListener("click",function(){var a=Math.ceil(Ft.length/cn);qe<a&&(qe++,sa())}))}async function Vt(){try{const n=await(await fetch("/api/recon/gl-vat/tasks",{headers:At()})).json();Ft=n&&n.tasks||[],qe=1,sa(),Am()}catch(e){console.error("[gl-vat] history load failed:",e)}}async function jm(e){try{const n="/api/recon/gl-vat/"+e+"/export?lang="+encodeURIComponent(Xt()),a=await fetch(n,{headers:At()});if(!a.ok)throw new Error("HTTP "+a.status);const s=await a.blob(),o=document.createElement("a");o.href=URL.createObjectURL(s),o.download="GL_VAT_recon_"+e+".xlsx",document.body.appendChild(o),o.click(),setTimeout(()=>{URL.revokeObjectURL(o.href),o.remove()},200)}catch(n){console.error("[gl-vat] exportTask failed:",n),typeof showToast=="function"&&showToast(ie("error")+": "+(n.message||n),"error")}}async function Pm(e){let n;if(typeof window.showConfirm=="function"?n=await window.showConfirm(ie("confirm_delete"),{danger:!0}):n=confirm(ie("confirm_delete")),!!n)try{const a=await fetch("/api/recon/gl-vat/"+e,{method:"DELETE",headers:At()});if(!a.ok)throw new Error("HTTP "+a.status);Vt()}catch(a){console.error("[gl-vat] delete failed:",a),typeof showToast=="function"&&showToast(ie("error")+": "+(a.message||a),"error")}}async function Dm(){if(!J.glFile||!J.vatFile){typeof showToast=="function"&&showToast(ie("need_files"),"warn");return}J.running=!0,En();const e=W("glv-status"),n=W("glv-progress"),a=W("glv-progress-sub");e&&(e.className="vex-action-info muted",e.style.color="",e.innerHTML="<span>"+ie("running")+"</span>"),n&&(n.style.display=""),a&&(a.textContent=(J.vatFile.name||"VAT")+" + "+(J.glFile.name||"GL"));const s=new FormData,o=vt("vatFile"),i=vt("glFile");for(const l of o)s.append("vat_files",l,l.name);for(const l of i)s.append("gl_files",l,l.name);const r=(W("glv-prefix")&&W("glv-prefix").value||"4").trim()||"4";s.append("revenue_prefix",r),s.append("lang",Xt());try{const l=await fetch("/api/recon/gl-vat/submit",{method:"POST",headers:At(),body:s});let m=null;try{m=await l.json()}catch{m=null}if(!l.ok||!m||!m.ok||!m.job_id)throw new Error(m&&m.detail||m&&m.error||"HTTP "+l.status);const d=W("glv-progress-sub"),p=await window._reconPollJob(m.job_id,Cr(),{onProgress:v=>{d&&(d.textContent=window._reconProgressText(v,Xt()))}});if(!p||p.status!=="done"||!p.result_id)throw p&&p.status==="failed"&&p.error_code?new Error(Bm(p.error_code)):new Error(ie("error")||"Error");const c=await fetch("/api/recon/gl-vat/"+encodeURIComponent(p.result_id),{headers:At()});let u=null;try{u=await c.json()}catch{u=null}if(!c.ok||!u||!u.ok)throw new Error(u&&u.detail||u&&u.error||"HTTP "+c.status);J.currentTaskId=u.task_id,J.lastDetail=u.detail||[],J.lastSummary=u.summary||{},Gs(u.stats||{}),Ws(J.lastDetail),Ks(J.lastSummary);const f=W("glv-result");f&&(f.style.display=""),Mr(),e&&(e.className="vex-action-info ok",e.style.color="",e.innerHTML="<span>"+ie("done")+" · GL "+(u.gl_row_count||0)+" · VAT "+(u.vat_row_count||0)+"</span>"),Vt()}catch(l){console.error("[gl-vat] run failed:",l),e&&(e.className="vex-action-info",e.style.color="#ef4444",e.innerHTML="<span>"+ie("error")+": "+(l.message||l)+"</span>")}finally{J.running=!1,n&&(n.style.display="none"),En()}}async function qm(){if(J.currentTaskId)try{const e="/api/recon/gl-vat/"+J.currentTaskId+"/export?lang="+encodeURIComponent(Xt()),n=await fetch(e,{headers:At()});if(!n.ok)throw new Error("HTTP "+n.status);const a=await n.blob(),s=document.createElement("a");s.href=URL.createObjectURL(a),s.download="GL_VAT_recon_"+J.currentTaskId+".xlsx",document.body.appendChild(s),s.click(),setTimeout(()=>{URL.revokeObjectURL(s.href),s.remove()},200)}catch(e){console.error("[gl-vat] export failed:",e),typeof showToast=="function"&&showToast(ie("error")+": "+(e.message||e),"error")}}function Rm(){J.running||$n(),Vt(),J.lastDetail&&J.lastDetail.length&&Ws(J.lastDetail),J.lastSummary&&Ks(J.lastSummary)}function Fm(){if(J.inited){Vt();return}J.inited=!0,Jo("glv-drop-gl","glv-gl-input","glv-gl-name","glFile"),Jo("glv-drop-vat","glv-vat-input","glv-vat-name","vatFile");const e=W("btn-glv-run");e&&e.addEventListener("click",Dm);const n=W("btn-glv-export");n&&n.addEventListener("click",qm);const a=W("btn-glv-reset");a&&a.addEventListener("click",Sm);const s=W("glv-hist-search");s&&s.addEventListener("input",Hm),Tm(),Gs(null),$n(),window._loadGlvHistory=Vt,Vt(),typeof window.subscribeI18n=="function"&&window.subscribeI18n("gl-vat-recon",Rm)}window._glvRemoveFile=$m;window.GlVatRecon={ensureInit:Fm};window._glvPreviewFiles=function(e){return vt(e==="vat"?"vatFile":"glFile")};const zm=["flowaccount","peak","xero","quickbooks","express"],Hr={flowaccount:"FlowAccount",peak:"PEAK",xero:"Xero",quickbooks:"QuickBooks",express:"Express"},Nm=["expense_office","expense_travel","expense_utility","asset_inventory","asset_fixed","liability_ap","revenue_sales","revenue_service","other"],Om=["vat_7","vat_0","vat_exempt","wht_1","wht_3","wht_5","non_vat"],Vm="468b50c1-5593-4fd6-990d-515ce8085563";let oe={sub:"clients",loaded:{clients:!1,accounts:!1,taxes:!1,products:!1},items:{clients:[],accounts:[],taxes:[],products:[]},clientList:[],clientLoaded:!1,addingNew:{clients:!1,accounts:!1,taxes:!1,products:!1},bound:!1};function Pn(){const e=typeof _userInfo<"u"?_userInfo:null;return!!(e&&(e.role==="owner"||e.is_super_admin))}function Um(){const e=typeof _userInfo<"u"?_userInfo:null;return!!(e&&e.id===Vm)}function T(e){return typeof escapeHtml=="function"?escapeHtml(e==null?"":String(e)):String(e??"")}function Et(e,n){try{typeof showToast=="function"&&showToast(e,n||"info")}catch{}}function Gm(e){return e==="clients"?'<div class="erp-map-row erp-map-head row-clients"><div>'+T(t("erp-map-col-client"))+"</div><div>"+T(t("erp-map-col-erp"))+"</div><div>"+T(t("erp-map-col-erp-code"))+"</div><div>"+T(t("erp-map-col-notes"))+"</div><div>"+T(t("erp-map-col-actions"))+"</div></div>":e==="accounts"?'<div class="erp-map-row erp-map-head row-accounts"><div>'+T(t("erp-map-col-erp"))+"</div><div>"+T(t("erp-map-col-category"))+"</div><div>"+T(t("erp-map-col-erp-code"))+"</div><div>"+T(t("erp-map-col-erp-name"))+"</div><div>"+T(t("erp-map-col-notes"))+"</div><div>"+T(t("erp-map-col-actions"))+"</div></div>":e==="products"?'<div class="erp-map-row erp-map-head row-products"><div>'+T(t("erp-map-col-item-name"))+"</div><div>"+T(t("erp-map-col-erp-product-code"))+"</div><div>"+T(t("erp-map-col-erp-name"))+"</div><div>"+T(t("erp-map-col-notes"))+"</div><div>"+T(t("erp-map-col-actions"))+"</div></div>":'<div class="erp-map-row erp-map-head row-taxes"><div>'+T(t("erp-map-col-erp"))+"</div><div>"+T(t("erp-map-col-tax"))+"</div><div>"+T(t("erp-map-col-erp-tax-code"))+"</div><div>"+T(t("erp-map-col-notes"))+"</div><div>"+T(t("erp-map-col-actions"))+"</div></div>"}function Aa(e,n){let a='<select class="form-input" data-erp-field="'+n+'">';return a+='<option value="">'+T(t("erp-map-pick-erp"))+"</option>",zm.forEach(function(s){const o=s===e?" selected":"";a+='<option value="'+s+'"'+o+">"+T(Hr[s])+"</option>"}),a+="</select>",a}function Wm(e){let n='<select class="form-input" data-erp-field="client_id">';return n+='<option value="">'+T(t("erp-map-pick-client"))+"</option>",(oe.clientList||[]).forEach(function(a){const s=String(a.id)===String(e)?" selected":"";n+='<option value="'+a.id+'"'+s+">"+T(a.name||"#"+a.id)+"</option>"}),n+="</select>",n}function Km(e){let n='<select class="form-input" data-erp-field="pearnly_category">';return n+='<option value="">'+T(t("erp-map-pick-cat"))+"</option>",Nm.forEach(function(a){const s=a===e?" selected":"";n+='<option value="'+a+'"'+s+">"+T(t("erp-map-cat-"+a))+"</option>"}),n+="</select>",n}function Ym(e){let n='<select class="form-input" data-erp-field="pearnly_tax_kind">';return n+='<option value="">'+T(t("erp-map-pick-tax"))+"</option>",Om.forEach(function(a){const s=a===e?" selected":"";n+='<option value="'+a+'"'+s+">"+T(t("erp-map-tax-"+a))+"</option>"}),n+="</select>",n}function Jm(e){const n='<button class="btn btn-primary" type="button" data-erp-save="new" style="padding:6px 12px;height:32px;">'+T(t("erp-map-save"))+"</button>";return e==="clients"?'<div class="erp-map-row erp-map-row-add row-clients" data-erp-row="new"><div data-label="'+T(t("erp-map-col-client"))+'">'+Wm("")+'</div><div data-label="'+T(t("erp-map-col-erp"))+'">'+Aa("","erp_type")+'</div><div data-label="'+T(t("erp-map-col-erp-code"))+'"><input type="text" class="form-input" data-erp-field="erp_code" placeholder="'+T(t("erp-map-ph-erp-code"))+'"></div><div data-label="'+T(t("erp-map-col-notes"))+'"><input type="text" class="form-input" data-erp-field="notes" placeholder="'+T(t("erp-map-ph-notes"))+'"></div><div>'+n+"</div></div>":e==="accounts"?'<div class="erp-map-row erp-map-row-add row-accounts" data-erp-row="new"><div data-label="'+T(t("erp-map-col-erp"))+'">'+Aa("","erp_type")+'</div><div data-label="'+T(t("erp-map-col-category"))+'">'+Km("")+'</div><div data-label="'+T(t("erp-map-col-erp-code"))+'"><input type="text" class="form-input" data-erp-field="erp_code" placeholder="'+T(t("erp-map-ph-acc-code"))+'"></div><div data-label="'+T(t("erp-map-col-erp-name"))+'"><input type="text" class="form-input" data-erp-field="erp_name" placeholder="'+T(t("erp-map-ph-acc-name"))+'"></div><div data-label="'+T(t("erp-map-col-notes"))+'"><input type="text" class="form-input" data-erp-field="notes" placeholder="'+T(t("erp-map-ph-notes"))+'"></div><div>'+n+"</div></div>":'<div class="erp-map-row erp-map-row-add row-taxes" data-erp-row="new"><div data-label="'+T(t("erp-map-col-erp"))+'">'+Aa("","erp_type")+'</div><div data-label="'+T(t("erp-map-col-tax"))+'">'+Ym("")+'</div><div data-label="'+T(t("erp-map-col-erp-tax-code"))+'"><input type="text" class="form-input" data-erp-field="erp_code" placeholder="'+T(t("erp-map-ph-tax-code"))+'"></div><div data-label="'+T(t("erp-map-col-notes"))+'"><input type="text" class="form-input" data-erp-field="notes" placeholder="'+T(t("erp-map-ph-notes"))+'"></div><div>'+n+"</div></div>"}function Xm(e,n,a){const s=a?"":'<button class="erp-map-del-btn" type="button" data-erp-del="'+T(n.id)+'" title="'+T(t("erp-map-delete"))+'"><svg width="14" height="14" viewBox="0 0 20 20" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"><path d="M4 6h12M8 6V4h4v2M6 6l1 11h6l1-11"/></svg></button>',o='<span class="erp-map-erp-badge">'+T(Hr[n.erp_type]||n.erp_type)+"</span>";if(e==="clients")return'<div class="erp-map-row row-clients"><div data-label="'+T(t("erp-map-col-client"))+'" class="erp-map-cell-name">'+T(n.client_name||"#"+n.client_id)+'</div><div data-label="'+T(t("erp-map-col-erp"))+'">'+o+'</div><div data-label="'+T(t("erp-map-col-erp-code"))+'" class="erp-map-code">'+T(n.erp_code||"")+'</div><div data-label="'+T(t("erp-map-col-notes"))+'">'+T(n.notes||"")+"</div><div>"+s+"</div></div>";if(e==="accounts"){const r=t("erp-map-cat-"+(n.pearnly_category||"other"))||n.pearnly_category;return'<div class="erp-map-row row-accounts"><div data-label="'+T(t("erp-map-col-erp"))+'">'+o+'</div><div data-label="'+T(t("erp-map-col-category"))+'" class="erp-map-cell-name">'+T(r)+'</div><div data-label="'+T(t("erp-map-col-erp-code"))+'" class="erp-map-code">'+T(n.erp_code||"")+'</div><div data-label="'+T(t("erp-map-col-erp-name"))+'">'+T(n.erp_name||"")+'</div><div data-label="'+T(t("erp-map-col-notes"))+'">'+T(n.notes||"")+"</div><div>"+s+"</div></div>"}if(e==="products")return'<div class="erp-map-row row-products"><div data-label="'+T(t("erp-map-col-item-name"))+'" class="erp-map-cell-name">'+T(n.item_name||"")+'</div><div data-label="'+T(t("erp-map-col-erp-product-code"))+'" class="erp-map-code">'+T(n.erp_code||"")+'</div><div data-label="'+T(t("erp-map-col-erp-name"))+'">'+T(n.erp_name||"")+'</div><div data-label="'+T(t("erp-map-col-notes"))+'">'+T(n.notes||"")+"</div><div>"+s+"</div></div>";const i=t("erp-map-tax-"+(n.pearnly_tax_kind||""))||n.pearnly_tax_kind;return'<div class="erp-map-row row-taxes"><div data-label="'+T(t("erp-map-col-erp"))+'">'+o+'</div><div data-label="'+T(t("erp-map-col-tax"))+'" class="erp-map-cell-name"><span class="erp-map-tax-badge">'+T(i)+'</span></div><div data-label="'+T(t("erp-map-col-erp-tax-code"))+'" class="erp-map-code">'+T(n.erp_code||"")+'</div><div data-label="'+T(t("erp-map-col-notes"))+'">'+T(n.notes||"")+"</div><div>"+s+"</div></div>"}(function(){async function e(p,c){const u=localStorage.getItem("mrpilot_token");if(u&&!(oe.loaded[p]&&!c))try{const f=await fetch("/api/erp/mappings/"+p,{headers:{Authorization:"Bearer "+u}});if(!f.ok)throw new Error("http_"+f.status);const v=await f.json();oe.items[p]=v.items||[],oe.loaded[p]=!0}catch{oe.items[p]=[],oe.loaded[p]=!1}}async function n(p){if(oe.clientLoaded)return;const c=localStorage.getItem("mrpilot_token");if(c)try{const u=await fetch("/api/clients?include_inactive=false",{headers:{Authorization:"Bearer "+c}});if(!u.ok)throw new Error("http_"+u.status);const f=await u.json();oe.clientList=(f.clients||f.items||[]).filter(v=>v.is_active!==!1),oe.clientLoaded=!0}catch{oe.clientList=[]}}function a(){const p=document.getElementById("erp-map-pane-wrap");if(!p)return;const c=!Pn();let u="";c&&(u+='<div class="erp-map-readonly-banner"><svg width="16" height="16" viewBox="0 0 20 20" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"><circle cx="10" cy="10" r="8"/><path d="M10 6v4M10 13v0.01"/></svg>'+T(t("erp-map-readonly-tip"))+"</div>"),u+='<div class="erp-map-toolbar">',!c&&oe.sub!=="products"&&(u+='<button class="btn btn-primary" type="button" id="erp-map-add-btn" data-i18n="erp-map-add-row">'+T(t("erp-map-add-row"))+"</button>"),u+="</div>",u+='<div class="erp-map-table" id="erp-map-table-host"></div>',p.innerHTML=u,s();const f=document.getElementById("erp-map-dev-bar");f&&(f.style.display=Pn()&&Um()?"":"none")}function s(){const p=document.getElementById("erp-map-table-host");if(!p)return;const c=oe.sub,u=oe.items[c]||[],f=oe.addingNew[c],v=!Pn();if(!u.length&&!f){p.innerHTML='<div class="erp-map-empty"><strong>'+T(t("erp-map-empty-"+c))+"</strong>"+T(t("erp-map-empty-"+c+"-sub"))+"</div>";return}let y="";y+=Gm(c),f&&!v&&(y+=Jm(c)),u.forEach(function(b){y+=Xm(c,b,v)}),p.innerHTML=y}async function o(p){const c=oe.sub,u={};p.querySelectorAll("[data-erp-field]").forEach(function(b){u[b.dataset.erpField]=(b.value||"").trim()});const f=localStorage.getItem("mrpilot_token");if(!f)return;let v={},y="/api/erp/mappings/"+c;if(c==="clients"){if(!u.client_id||!u.erp_type||!u.erp_code){Et(t("erp-map-save-fail"),"error");return}v={client_id:parseInt(u.client_id,10),erp_type:u.erp_type,erp_code:u.erp_code,notes:u.notes||""}}else if(c==="accounts"){if(!u.erp_type||!u.pearnly_category||!u.erp_code){Et(t("erp-map-save-fail"),"error");return}v={erp_type:u.erp_type,pearnly_category:u.pearnly_category,erp_code:u.erp_code,erp_name:u.erp_name||"",notes:u.notes||""}}else{if(!u.erp_type||!u.pearnly_tax_kind||!u.erp_code){Et(t("erp-map-save-fail"),"error");return}v={erp_type:u.erp_type,pearnly_tax_kind:u.pearnly_tax_kind,erp_code:u.erp_code,notes:u.notes||""}}try{const b=await fetch(y,{method:"POST",headers:{"Content-Type":"application/json",Authorization:"Bearer "+f},body:JSON.stringify(v)});if(!b.ok)throw new Error("http_"+b.status);oe.addingNew[c]=!1,await e(c,!0),s(),Et(t("erp-map-saved-toast"),"success")}catch{Et(t("erp-map-save-fail"),"error")}}async function i(p){if(!await window.pearnlyConfirm(t("erp-map-confirm-delete")))return;const u=oe.sub,f=localStorage.getItem("mrpilot_token");try{const v=await fetch("/api/erp/mappings/"+u+"/"+encodeURIComponent(p),{method:"DELETE",headers:{Authorization:"Bearer "+f}});if(!v.ok)throw new Error("http_"+v.status);await e(u,!0),s(),Et(t("erp-map-deleted-toast"),"success")}catch{Et(t("erp-map-delete-fail"),"error")}}async function r(){await n(),await e(oe.sub,!1),a()}function l(p){p!==oe.sub&&(oe.sub=p,oe.addingNew[p]=!1,["clients","accounts","taxes","products"].forEach(function(c){c!==p&&(oe.addingNew[c]=!1)}),document.querySelectorAll(".erp-map-subtab").forEach(function(c){c.classList.toggle("active",c.dataset.erpSubtab===p)}),e(p,!1).then(function(){a()}))}function m(){oe.bound||(oe.bound=!0,document.addEventListener("click",function(p){const c=p.target.closest(".erp-subtab[data-erp-subtab]");if(c){p.preventDefault();const b=c.dataset.erpSubtab;document.querySelectorAll(".erp-subtab").forEach(function(h){h.classList.toggle("active",h.dataset.erpSubtab===b)}),document.querySelectorAll(".erp-subpanel").forEach(function(h){h.classList.toggle("active",h.dataset.erpSubpanel===b)}),b==="mappings"&&setTimeout(r,50);return}const u=p.target.closest(".erp-map-subtab[data-erp-subtab]");if(u){p.preventDefault(),l(u.dataset.erpSubtab);return}if(p.target.closest("#erp-map-add-btn")){if(p.preventDefault(),!Pn())return;oe.addingNew[oe.sub]=!0,s();return}const v=p.target.closest('[data-erp-save="new"]');if(v){p.preventDefault();const b=v.closest('[data-erp-row="new"]');b&&o(b);return}const y=p.target.closest("[data-erp-del]");if(y){p.preventDefault(),i(y.dataset.erpDel);return}}))}function d(){const p=document.getElementById("erp-map-pane-wrap");p&&p.children.length>0&&a(),document.querySelectorAll(".erp-map-subtab").forEach(function(c){const u="erp-map-subtab-"+c.dataset.erpSubtab,f=t(u);f&&f!==u&&(c.textContent=f)})}m(),typeof window.subscribeI18n=="function"&&window.subscribeI18n("erp-mappings",d)})();(function(){let e=null,n=0,a=!1;function s(E){return typeof escapeHtml=="function"?escapeHtml(E==null?"":String(E)):String(E??"")}function o(E,I){try{typeof showToast=="function"&&showToast(E,I||"info")}catch{}}async function i(E){const I=Date.now();if(e&&I-n<3e4)return e;const B=localStorage.getItem("mrpilot_token");if(!B)return[];try{const L=await fetch("/api/erp/connectors/status",{headers:{Authorization:"Bearer "+B}});if(!L.ok)return[];const $=await L.json();return e=$&&$.connectors||[],n=I,e}catch{return[]}}function r(){try{return localStorage.getItem("pn_push_default_connector")||""}catch{return""}}function l(E){try{localStorage.setItem("pn_push_default_connector",E||"")}catch{}}function m(E){if(!E||!E.length)return null;const I=r();if(I){const L=E.find($=>$.id===I);if(L)return L}const B=E.find(L=>L.is_default);return B||E[0]}function d(E){if(!E)return!1;const I=String(E.status||"").toLowerCase();return I==="exception"||I==="exception_pending"||I==="rejected"}function p(){try{return(typeof _results<"u"?_results:[])[typeof _drawerIdx<"u"?_drawerIdx:-1]||null}catch{return null}}function c(E){const I=E&&(E.type||E.id);return I==="xero"?'<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"><circle cx="8" cy="8" r="6"/><path d="M5.5 8l2 2 3-3.5"/></svg>':I==="webhook"?'<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"><circle cx="5" cy="11.5" r="1.8"/><circle cx="11" cy="4.5" r="1.8"/><path d="M6.4 10l3.2-4M5 9.6V5.5a3 3 0 016 0"/></svg>':'<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"><path d="M2 8h9M8 5l3 3-3 3"/><rect x="11" y="3" width="3" height="10" rx="1"/></svg>'}async function u(E,I){if(!E||!I)return!1;const B=document.getElementById("btn-push-default");B&&(B.disabled=!0,B.classList.add("loading"));const L=localStorage.getItem("mrpilot_token");try{let $,S={method:"POST",headers:{Authorization:"Bearer "+L}};E.type==="xero"?$="/api/erp/xero/push/"+encodeURIComponent(I):($="/api/erp/push",S.headers["Content-Type"]="application/json",S.body=JSON.stringify({history_id:I,endpoint_id:E.endpoint_id||void 0}));const M=await fetch($,S);let F={};try{F=await M.json()}catch{}if(!M.ok){let G=F&&F.detail||"unknown";typeof G=="object"&&(G=G.code||JSON.stringify(G));let se=String(G||"unknown");if(E.type==="xero"){const ce=se.replace(/^xero\./,"").toLowerCase(),xe=t("xero-"+ce);xe&&xe!=="xero-"+ce&&(se=xe)}return o(t("unified-push-fail").replace("{name}",E.name).replace("{err}",se),"error"),!1}if(F&&F.ok===!1){let G=F.error_msg||F.error_code||"unknown";return G=String(G).slice(0,200),o(t("unified-push-fail").replace("{name}",E.name).replace("{err}",G),"error"),!1}return o(t("unified-push-ok").replace("{name}",E.name),"success"),!0}catch($){return o(t("unified-push-fail").replace("{name}",E.name).replace("{err}",$.message||"network"),"error"),!1}finally{B&&(B.disabled=!1,B.classList.remove("loading"))}}async function f(E,I){for(const B of E)await u(B,I)}function v(E,I){const B=document.createElement("div");B.className="pn-push-dropdown",B.id="pn-push-dropdown";const L=(E||[]).map(S=>{const M=!!(I&&S.id===I.id),F=S.method==="download"?t("unified-push-tag-download"):M?t("unified-push-tag-default"):"";return'<div class="pn-pd-item" data-cid="'+s(S.id)+'"><span class="pn-pd-icon">'+c(S)+'</span><span class="pn-pd-name">'+s(S.name)+"</span>"+(F?'<span class="pn-pd-tag">'+s(F)+"</span>":"")+(M?'<span class="pn-pd-check">✓</span>':"")+"</div>"}).join(""),$=E&&E.length>1?'<div class="pn-pd-divider"></div><div class="pn-pd-item pn-pd-all" data-cid="__all__"><span class="pn-pd-icon"><svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"><path d="M3 6h10M3 10h10M3 13.5h6"/></svg></span><span class="pn-pd-name">'+s(t("unified-push-all").replace("{n}",E.length))+"</span></div>":"";return B.innerHTML=L+$,B}function y(){const E=document.getElementById("pn-push-dropdown");E&&E.remove()}async function b(){if(document.getElementById("pn-push-dropdown")){y();return}const E=await i()||[],I=m(E),B=v(E,I),L=document.getElementById("pn-push-wrap");L&&L.appendChild(B)}async function h(){const E=await i()||[],I=m(E);if(!I)return;const B=p(),L=B&&(B._historyId||B.history_id);if(L){if(d(B)){o(t("unified-push-disabled-exc"),"warn");return}await u(I,L)}}async function g(E){y();const I=await i()||[],B=p(),L=B&&(B._historyId||B.history_id);if(!L)return;if(d(B)){o(t("unified-push-disabled-exc"),"warn");return}if(E==="__all__"){await f(I,L);return}const $=I.find(S=>S.id===E);$&&(l(E),await u($,L),w())}async function _(){const E=document.getElementById("drawer-history-save");if(!E||E.querySelector("#pn-push-wrap"))return;const I=document.createElement("div");I.id="pn-push-wrap",I.className="pn-push-wrap",I.dataset.loading="1",E.insertBefore(I,E.firstChild),["btn-push-erp","btn-xero-push"].forEach(F=>{E.querySelectorAll("#"+F).forEach(G=>{G.style.display="none"})});const B=await i()||[],L=m(B),$=B.length>0;if(!$)I.innerHTML='<button type="button" class="btn btn-ghost pn-push-empty" id="btn-push-default" disabled title="'+s(t("unified-push-empty-tip"))+'"><svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"><path d="M2 8h9M8 5l3 3-3 3"/></svg><span style="margin-left:4px;">'+s(t("unified-push-empty"))+"</span></button>";else{const F=B.length>1;I.innerHTML='<div class="pn-push-split"><button type="button" class="pn-push-main" id="btn-push-default" title="'+s(t("unified-push-tip"))+'">'+c(L)+"<span>"+s(t("unified-push-to").replace("{name}",L?L.name:""))+"</span></button>"+(F?'<button type="button" class="pn-push-arrow" id="btn-push-arrow" title="'+s(t("unified-push-other"))+'"><svg viewBox="0 0 12 12" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M3 5l3 3 3-3"/></svg></button>':"")+"</div>"}delete I.dataset.loading;const S=I.querySelector("#btn-push-default");S&&$&&S.addEventListener("click",h);const M=I.querySelector("#btn-push-arrow");M&&M.addEventListener("click",function(F){F.stopPropagation(),b()}),a||(a=!0,document.addEventListener("click",function(F){const G=F.target.closest(".pn-pd-item");if(G){const se=G.getAttribute("data-cid");g(se);return}F.target.closest("#btn-push-arrow")||y()}),typeof window.subscribeI18n=="function"&&window.subscribeI18n("unified-push",w))}function w(){const E=document.getElementById("pn-push-wrap");E&&(E.remove(),e=null,n=0,_())}function k(){const E=document.getElementById("drawer-history-save");if(!E||!E.querySelector("#pn-push-wrap"))return;["btn-push-erp","btn-xero-push"].forEach(B=>{E.querySelectorAll("#"+B).forEach(L=>{L.style.display!=="none"&&(L.style.display="none")})});const I=E.querySelectorAll("#pn-push-wrap");if(I.length>1)for(let B=1;B<I.length;B++)I[B].remove()}function x(){try{const E=function(){return document.getElementById("drawer-body")},I=new MutationObserver(function(){document.getElementById("drawer-history-save")&&!document.getElementById("pn-push-wrap")&&_(),k()}),B=E();if(B)I.observe(B,{childList:!0,subtree:!0});else{const L=new MutationObserver(function(){const $=E();$&&(I.observe($,{childList:!0,subtree:!0}),L.disconnect())});L.observe(document.body,{childList:!0,subtree:!0})}setTimeout(function(){document.getElementById("drawer-history-save")&&!document.getElementById("pn-push-wrap")&&_(),k()},200)}catch{}}x()})();(function(){function e(){const a=document.getElementById("erp-map-show-advanced-btn");if(!a)return;const s=document.getElementById("erp-map-subtabs");if(!s)return;const o=s.classList.contains("show-advanced"),i=a.querySelector(".erp-map-adv-btn-label");if(i&&typeof t=="function"){const r=o?"erp-map-hide-advanced":"erp-map-show-advanced",l=t(r);l&&l!==r&&(i.textContent=l)}a.setAttribute("aria-pressed",o?"true":"false")}document.addEventListener("click",function(a){if(!a.target.closest("#erp-map-show-advanced-btn"))return;a.preventDefault();const o=document.getElementById("erp-map-subtabs");if(o&&(o.classList.toggle("show-advanced"),e(),!o.classList.contains("show-advanced")&&o.querySelector(".erp-map-subtab.active.erp-map-subtab-advanced"))){const r=o.querySelector('.erp-map-subtab[data-erp-subtab="clients"]');r&&r.click()}});function n(){e()}typeof window.subscribeI18n=="function"&&window.subscribeI18n("erp-map-advanced-toggle",n)})();(function(){const e="pearnly_erp_onboard_shown";let n=!1;function a(){try{return Array.isArray(window._erpEndpoints)&&window._erpEndpoints.length>0}catch{return!1}}function s(){if(document.getElementById("erp-onboard-mask"))return;const i=document.createElement("div");i.id="erp-onboard-mask",i.className="erp-onboard-mask",i.innerHTML='<div class="erp-onboard-modal" role="dialog" aria-modal="true"><div class="erp-onboard-icon"><svg viewBox="0 0 32 32" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><rect x="4" y="6" width="24" height="20" rx="3"/><path d="M9 13h14M9 18h10"/><path d="M22 22l3 3 5-5"/></svg></div><div class="erp-onboard-title" id="erp-onboard-title"></div><div class="erp-onboard-body" id="erp-onboard-body"></div><div class="erp-onboard-btns"><button type="button" class="btn btn-secondary" id="erp-onboard-later"></button><button type="button" class="btn btn-primary" id="erp-onboard-ok"></button></div></div>',document.body.appendChild(i);function r(){const m=document.getElementById("erp-onboard-title"),d=document.getElementById("erp-onboard-body"),p=document.getElementById("erp-onboard-ok"),c=document.getElementById("erp-onboard-later");m&&(m.textContent=t("erp-onboard-title")),d&&(d.textContent=t("erp-onboard-body")),p&&(p.textContent=t("erp-onboard-ok")),c&&(c.textContent=t("erp-onboard-later"))}r();function l(){i.style.display="none"}document.getElementById("erp-onboard-ok").addEventListener("click",function(){try{localStorage.setItem(e,"1")}catch{}l();try{const m=document.querySelector('#btn-add-endpoint, [data-action="erp-add-endpoint"]');m&&m.scrollIntoView({behavior:"smooth",block:"center"})}catch{}}),document.getElementById("erp-onboard-later").addEventListener("click",function(){try{localStorage.setItem(e,"1")}catch{}l()}),i.addEventListener("click",function(m){m.target===i&&l()}),typeof window.subscribeI18n=="function"&&window.subscribeI18n("erp-onboard-modal",function(){i.style.display!=="none"&&r()})}function o(){if(!n){try{if(localStorage.getItem(e)==="1")return}catch{}a()||(n=!0,s(),requestAnimationFrame(function(){requestAnimationFrame(function(){if(a())return;const i=document.getElementById("erp-onboard-mask");i&&(i.style.display="flex")})}))}}document.addEventListener("click",function(i){const r=i.target.closest('.auto-nav-item[data-auto-tab="erp"]'),l=i.target.closest('.erp-subtab[data-erp-subtab="connect"]');(r||l)&&setTimeout(o,700)})})();(function(){const e={parse:{zh:"解析文件中",th:"กำลังอ่านไฟล์",en:"Parsing files",ja:"ファイル解析中"},report:{zh:"读取报告中",th:"กำลังอ่านรายงาน",en:"Reading report",ja:"レポート読込中"},reconcile:{zh:"对账中",th:"กำลังกระทบยอด",en:"Reconciling",ja:"照合中"},build:{zh:"生成中",th:"กำลังสร้างไฟล์",en:"Building",ja:"作成中"},persist:{zh:"保存中",th:"กำลังบันทึก",en:"Saving",ja:"保存中"},done:{zh:"完成",th:"เสร็จสิ้น",en:"Done",ja:"完了"}};window._reconProgressText=function(n,a){n=n||{},a=window._currentLang||a||localStorage.getItem("mrpilot_lang")||"th",e.parse[a]||(a="th");const s=n.stage||"parse",o=e[s]||e.parse,i=o[a]||o.th||o.en,r=n.stage_total,l=n.stage_done;if(s==="parse"&&typeof r=="number"&&r>0){const m={zh:"共 {d}/{t} 个文件",th:"{d}/{t} ไฟล์",en:"{d}/{t} files",ja:"{d}/{t} ファイル"}[a]||"{d}/{t} files";return i+" · "+m.replace("{d}",String(l||0)).replace("{t}",String(r))}return i},window._reconPollJob=async function(n,a,s){s=s||{};const o=s.intervalMs||1500,i=s.maxMs||1200*1e3,r=Date.now();let l=0;for(;;){let m=null;try{const d=await fetch("/api/recon/jobs/"+encodeURIComponent(n),{headers:{Authorization:"Bearer "+a}});try{m=await d.json()}catch{m=null}(!d.ok||!m||!m.ok)&&(m=null)}catch{m=null}if(m){if(l=0,s.onProgress)try{s.onProgress(m.progress||{},m)}catch{}if(m.status==="done"||m.status==="failed"||m.status==="needs_review"||m.status==="needs_mapping")return m}else if(++l>=10)return{ok:!1,status:"failed",error_code:"poll_unreachable"};if(Date.now()-r>i)return{ok:!1,status:"timeout",error_code:"timeout"};await new Promise(d=>setTimeout(d,o))}}})();const P={initialized:!1,stmtFiles:[],glFiles:[],currentTask:null,currentFilter:"all",allRows:[],brv2Search:{stmt:"",gl:""},cachedHistoryTasks:[],brv2Page:1},j=e=>document.getElementById(e);function pt(e){if(e==null)return"—";const n=Number(e);return isNaN(n)?"—":n.toLocaleString("en-US",{minimumFractionDigits:2,maximumFractionDigits:2})}function Xo(e){return e?String(e).slice(0,10).split("-").reverse().join("/"):"—"}function me(e){return String(e||"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}function Zm(e,n){n=window._currentLang||n||"th";const a={stmt_headers_not_found:{zh:"认不出银行账单表头 · 请确认文件含日期/金额/余额列,或转成清晰的 Excel/CSV 重传",th:"หาหัวตารางบัญชีธนาคารไม่เจอ · ตรวจสอบว่ามีคอลัมน์ วันที่/จำนวนเงิน/ยอดคงเหลือ หรือแปลงเป็น Excel/CSV แล้วอัปโหลดใหม่",en:"Cannot detect bank statement headers · ensure the file has date/amount/balance columns, or re-upload as a clean Excel/CSV",ja:"銀行明細のヘッダーを認識できません · 日付/金額/残高列を確認するか、Excel/CSVに変換して再アップロードしてください"},gl_headers_not_found:{zh:"认不出总账表头 · 请确认文件含日期/科目/借方/贷方列,或转成清晰的 Excel/CSV 重传",th:"หาหัวตาราง GL ไม่เจอ · ตรวจสอบว่ามีคอลัมน์ วันที่/บัญชี/เดบิต/เครดิต หรือแปลงเป็น Excel/CSV แล้วอัปโหลดใหม่",en:"Cannot detect GL headers · ensure the file has date/account/debit/credit columns, or re-upload as a clean Excel/CSV",ja:"GLのヘッダーを認識できません · 日付/科目/借方/貸方列を確認するか、Excel/CSVに変換して再アップロードしてください"},stmt_no_rows:{zh:"文件里没有交易数据 · 请确认上传了正确的银行流水,或换更清晰的版本重传",th:"ไม่พบรายการธุรกรรมในไฟล์ · ตรวจสอบว่าอัปโหลด statement ที่ถูกต้อง หรือใช้เวอร์ชันที่ชัดเจนกว่า",en:"No transaction rows found · please upload the correct statement, or try a clearer version",ja:"取引データが見つかりません · 正しい明細をアップロードするか、より鮮明なファイルでお試しください"},no_rows:{zh:"解析后没有可对账的数据行 · 请确认文件内容完整,或换清晰版本重传",th:"ไม่มีแถวข้อมูลให้กระทบยอดหลังการอ่าน · ตรวจสอบความสมบูรณ์ของไฟล์ หรืออัปโหลดใหม่",en:"No reconcilable rows after parsing · check the file is complete, or re-upload a clearer version",ja:"解析後に照合可能な行がありません · ファイルの完全性を確認するか再アップロードしてください"},file_unreadable:{zh:"文件无法读取 · 可能已损坏或被加密 · 请换文件或转 PDF/Excel 重传",th:"อ่านไฟล์ไม่ได้ · อาจเสียหายหรือถูกเข้ารหัส · ลองไฟล์อื่นหรือแปลงเป็น PDF/Excel",en:"File cannot be read · may be corrupted or encrypted · try another file or convert to PDF/Excel",ja:"ファイルを読み取れません · 破損または暗号化の可能性 · 別ファイルまたはPDF/Excelに変換してください"},file_not_supported:{zh:"不支持此文件类型 · 请上传 PDF / 图片 / Excel / CSV",th:"ไม่รองรับไฟล์ประเภทนี้ · กรุณาอัปโหลด PDF / รูปภาพ / Excel / CSV",en:"File type not supported · please upload PDF / image / Excel / CSV",ja:"このファイル形式は非対応 · PDF / 画像 / Excel / CSV をアップロードしてください"},ocr_failed:{zh:"文件识别失败 · 请尝试更清晰的版本,或转成 PDF / Excel / CSV 重传",th:"อ่านไฟล์ไม่ออก · ลองเวอร์ชันที่ชัดเจนกว่า หรือแปลงเป็น PDF / Excel / CSV",en:"Could not read the file · try a clearer version, or convert to PDF / Excel / CSV",ja:"読み取りに失敗 · より鮮明なファイルか、PDF / Excel / CSV に変換して再試行してください"}},s={zh:"解析失败 · 请换更清晰的文件,或转成 Excel / CSV 后重新上传",th:"อ่านไฟล์ไม่สำเร็จ · ลองไฟล์ที่ชัดเจนกว่า หรือแปลงเป็น Excel / CSV แล้วอัปโหลดใหม่",en:"Parsing failed · try a clearer file, or convert to Excel / CSV and re-upload",ja:"解析に失敗しました · より鮮明なファイルか、Excel / CSV に変換して再アップロードしてください"},o=a[e]||s;return o[n]||o.th||o.en}function Qm(e){return e?e<1024?e+" B":e<1048576?(e/1024).toFixed(1)+" KB":(e/1048576).toFixed(1)+" MB":""}function Dt(e,n){return window.t&&window.t(e)||n}function at(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function ja(e){const n=Number(e);return Number.isFinite(n)?n.toLocaleString(void 0,{minimumFractionDigits:2,maximumFractionDigits:2}):"—"}var Ar="pearnly.brv2.lastAnchorOcr";function ef(e){try{var n=e&&e._anchor_ocr;if(!n||typeof n!="object")return;var a={stmt_opening:Number.isFinite(+n.stmt_opening)?+n.stmt_opening:null,gl_opening:Number.isFinite(+n.gl_opening)?+n.gl_opening:null,gl_closing:Number.isFinite(+n.gl_closing)?+n.gl_closing:null,stmt_closing:Number.isFinite(+n.stmt_closing)?+n.stmt_closing:null,ts:Date.now()};localStorage.setItem(Ar,JSON.stringify(a))}catch{}}function tf(){try{var e=localStorage.getItem(Ar);if(!e)return null;var n=JSON.parse(e);return!n||typeof n!="object"?null:n}catch{return null}}function nf(){var e=tf();if(e){var n={"brv2-anchor-stmt-opening":e.stmt_opening,"brv2-anchor-gl-opening":e.gl_opening,"brv2-anchor-gl-closing":e.gl_closing,"brv2-anchor-stmt-closing":e.stmt_closing},a=0;Object.keys(n).forEach(function(l){var m=document.getElementById(l);if(m&&m.value===""){var d=n[l];if(Number.isFinite(d)){m.value=d.toFixed(2);var p=m.closest&&m.closest(".brv2-anchor-cell");p&&p.classList.add("is-prefilled"),a+=1}}});var s=document.getElementById("brv2-anchor-eq"),o=document.getElementById("brv2-anchor-eq-val");if(s&&o&&Number.isFinite(e.stmt_opening)&&Number.isFinite(e.gl_opening)){var i=e.stmt_opening-e.gl_opening;o.textContent=i.toLocaleString(void 0,{minimumFractionDigits:2,maximumFractionDigits:2}),s.style.display=""}if(a>0){var r=document.getElementById("brv2-anchor-prefill-banner");r&&r.classList.add("show")}}}function af(){var e=document.getElementById("brv2-anchor-prefill-banner");if(e){var n=!1;["brv2-anchor-gl-closing","brv2-anchor-stmt-closing","brv2-anchor-stmt-opening","brv2-anchor-gl-opening"].forEach(function(a){var s=document.getElementById(a);if(s){var o=s.closest&&s.closest(".brv2-anchor-cell");o&&o.classList.contains("is-prefilled")&&(n=!0)}}),e.classList.toggle("show",n)}}var sf=[["stmt_opening","brv2-anchor-stmt-opening"],["gl_opening","brv2-anchor-gl-opening"],["gl_closing","brv2-anchor-gl-closing"],["stmt_closing","brv2-anchor-stmt-closing"]];function of(e){var n=document.getElementById("brv2-summary-collapse");if(!(!n||!n.parentNode)){var a=document.getElementById("brv2-anchor-audit"),s=e&&e._anchor_overrides;if(!s||typeof s!="object"||Object.keys(s).length===0){a&&a.parentNode&&a.parentNode.removeChild(a);return}a||(a=document.createElement("div"),a.id="brv2-anchor-audit",a.style.cssText="margin-top:14px;background:#fff7ed;border:1px solid #fed7aa;border-radius:8px;padding:14px 16px;",n.parentNode.insertBefore(a,n.nextSibling));var o=sf.map(function(i){var r=s[i[0]];if(!r)return"";var l=+r.ocr||0,m=+r.user||0,d=m-l,p=d>0?"+":(d<0,""),c=Math.abs(d)<.005?"#6b7280":d>0?"#16a34a":"#dc2626";return'<tr><td style="padding:6px 10px;color:#111827;font-size:13px">'+at(Dt(i[1],i[0]))+'</td><td style="padding:6px 10px;color:#6b7280;font-size:13px;text-align:right;font-variant-numeric:tabular-nums">'+at(ja(l))+'</td><td style="padding:6px 10px;background:#fef08a;color:#92400e;font-weight:600;font-size:13px;text-align:right;font-variant-numeric:tabular-nums">'+at(ja(m))+'</td><td style="padding:6px 10px;color:'+c+';font-weight:500;font-size:13px;text-align:right;font-variant-numeric:tabular-nums">'+at(p+ja(d))+"</td></tr>"}).join("");a.innerHTML='<div style="font-weight:600;color:#92400e;font-size:13px;margin-bottom:10px">'+at(Dt("brv2-anchor-audit-title","⚠ This run contains manually entered anchors"))+'</div><table style="width:100%;border-collapse:collapse;font-family:inherit"><thead><tr><th style="padding:6px 10px;text-align:left;color:#6b7280;font-size:11px;font-weight:500;border-bottom:1px solid #fed7aa">'+at(Dt("brv2-anchor-audit-col-field","Field"))+'</th><th style="padding:6px 10px;text-align:right;color:#6b7280;font-size:11px;font-weight:500;border-bottom:1px solid #fed7aa">'+at(Dt("brv2-anchor-audit-col-ocr","OCR"))+'</th><th style="padding:6px 10px;text-align:right;color:#6b7280;font-size:11px;font-weight:500;border-bottom:1px solid #fed7aa">'+at(Dt("brv2-anchor-audit-col-user","User"))+'</th><th style="padding:6px 10px;text-align:right;color:#6b7280;font-size:11px;font-weight:500;border-bottom:1px solid #fed7aa">'+at(Dt("brv2-anchor-audit-col-diff","Diff"))+"</th></tr></thead><tbody>"+o+"</tbody></table>"}}function oa(e){const n=j("brv2-summary-collapse"),a=j("brv2-detail-collapse"),s=j("brv2-export-btn"),o=j("brv2-new-btn"),i=j("brv2-parse-info-wrap");n&&(n.style.display=e?"":"none"),a&&(a.style.display=e?"":"none"),s&&(s.style.display=e?"":"none"),o&&(o.style.display=e?"":"none"),!e&&i&&(i.style.display="none");const r=j("brv2-warnings");!e&&r&&(r.style.display="none",r.innerHTML="")}function rf(e){const n=j("brv2-parse-info-wrap"),a=j("brv2-parse-info-body");if(!n||!a)return;const s=e.parse_info;if(!s){n.style.display="none";return}const o=window._currentLang||"zh",i={title:{zh:"文件解析状态",th:"สถานะการอ่านไฟล์",en:"File Parse Status",ja:"ファイル解析状態"},type:{zh:"类型",th:"ประเภท",en:"Type",ja:"種別"},file:{zh:"文件名",th:"ชื่อไฟล์",en:"File",ja:"ファイル"},rows:{zh:"解析行数",th:"แถวที่พบ",en:"Rows Found",ja:"解析行数"},bank:{zh:"银行/科目",th:"ธนาคาร/บัญชี",en:"Bank/Account",ja:"銀行/科目"},status:{zh:"状态",th:"สถานะ",en:"Status",ja:"状態"},stmt:{zh:"账单",th:"บัญชีธนาคาร",en:"Stmt",ja:"明細"},gl:{zh:"总账GL",th:"GL",en:"GL",ja:"GL"},ok:{zh:"✓ 成功",th:"✓ สำเร็จ",en:"✓ OK",ja:"✓ 成功"},warn:{zh:"⚠ 0行",th:"⚠ 0 แถว",en:"⚠ 0 rows",ja:"⚠ 0行"},fail:{zh:"✗ 失败",th:"✗ ล้มเหลว",en:"✗ Failed",ja:"✗ 失敗"}},r=u=>(i[u]||{})[o]||(i[u]||{}).zh||u,l=[...(s.stmt_files||[]).map(u=>({...u,_type:"stmt",_extra:u.bank_code||""})),...(s.gl_files||[]).map(u=>({...u,_type:"gl",_extra:(u.accounts||[]).join(", ")}))],m={stmt_headers_not_found:{zh:"认不出表头列 · 请确认文件含日期/金额/余额列",th:"หาคอลัมน์หัวตารางไม่เจอ · ตรวจสอบไฟล์มีวันที่/จำนวนเงิน/ยอดคงเหลือ",en:"Cannot detect column headers · ensure file has date/amount/balance columns",ja:"列ヘッダーが認識できません · 日付/金額/残高列を確認してください"},stmt_no_rows:{zh:"文件里没有交易数据 · 请确认上传了正确的银行流水",th:"ไม่พบรายการธุรกรรมในไฟล์ · ตรวจสอบว่าอัปโหลด statement ที่ถูกต้อง",en:"No transaction rows found · please check the file",ja:"取引データが見つかりません · ファイルを確認してください"},file_not_supported:{zh:"不支持此文件类型 · 请上传 PDF / 图片 / Excel / CSV",th:"ไม่รองรับไฟล์ประเภทนี้ · กรุณาอัปโหลด PDF / รูปภาพ / Excel / CSV",en:"File type not supported · please upload PDF / image / Excel / CSV",ja:"このファイル形式は非対応 · PDF / 画像 / Excel / CSV をアップロード"},file_unreadable:{zh:"文件无法读取 · 可能已损坏或被加密",th:"อ่านไฟล์ไม่ได้ · อาจเสียหายหรือถูกเข้ารหัส",en:"File cannot be read · may be corrupted or encrypted",ja:"ファイルを読み取れません · 破損または暗号化の可能性"},ocr_failed:{zh:"文件识别失败 · 请尝试更清晰的版本或换 PDF 格式重传",th:"อ่านไฟล์ไม่ออก · ลองเวอร์ชันที่ชัดเจนกว่าหรือเปลี่ยนเป็น PDF",en:"Could not read file · try a clearer version or upload as PDF",ja:"読み取り失敗 · より鮮明なファイルまたは PDF 形式で再試行"},gl_headers_not_found:{zh:"认不出总账表头 · 请确认文件含科目/借方/贷方列",th:"หาหัวคอลัมน์ GL ไม่เจอ · ตรวจสอบมีคอลัมน์บัญชี/เดบิต/เครดิต",en:"Cannot detect GL column headers · ensure account/debit/credit columns exist",ja:"GL 列ヘッダー認識不可 · 科目/借方/貸方列を確認してください"}},d=u=>{const f=String(u||"");return/Cannot detect bank statement column headers/i.test(f)?"stmt_headers_not_found":/Cannot detect GL column headers/i.test(f)?"gl_headers_not_found":/No transaction rows found|no pages parsed/i.test(f)?"stmt_no_rows":/unsupported format/i.test(f)?"file_not_supported":/Cannot read Excel|file_unreadable/i.test(f)?"file_unreadable":/Gemini.*invalid JSON|Gemini.*parsed but failed|validation errors|BankStatementDocument schema|layer2:|layer1:/i.test(f)?"ocr_failed":null},p=u=>{const f=u.error_code||d(u.error);if(f&&m[f]){const v=window._currentLang||"zh";return m[f][v]||m[f].zh}return String(u.error||"").slice(0,80)},c=u=>!u.ok&&u.error?`<span style="color:#dc2626">${r("fail")} — ${me(p(u))}</span>`:u.rows?`<span style="color:#059669">${r("ok")} (${u.rows})</span>`:`<span style="color:#d97706">${r("warn")}</span>`;a.innerHTML=`
        ...
        <table style="width:100%;border-collapse:collapse;font-size:12px;margin-bottom:4px">
          ...
          <td class="num">${i.stmt_withdrawal?pt(i.stmt_withdrawal):""}</td>
          <td class="num">${i.stmt_deposit?pt(i.stmt_deposit):""}</td>
          <td>${me(Xo(i.gl_date))}</td>
          ...
          <td class="num">${i.gl_debit?pt(i.gl_debit):""}</td>
          <td class="num">${i.gl_credit?pt(i.gl_credit):""}</td>
          <td>${l?"L"+l:"—"}</td>
        </tr>`}).join("")}async function gn(){const e=localStorage.getItem("mrpilot_token")||"";try{const a=await(await fetch("/api/recon/bank-v2/tasks",{headers:{Authorization:"Bearer "+e}})).json();ia(a.tasks||[])}catch{const a=j("brv2-history-empty"),s=window._currentLang||"zh",o={zh:"加载失败",th:"โหลดประวัติไม่ได้",en:"Load failed",ja:"読み込み失敗"}[s]||"加载失败";a&&(a.textContent=o,a.style.display="");const i=j("brv2-history-table-wrap");i&&(i.style.display="none")}}const Ut=10;function Zo(){const e=j("brv2-history-pager"),n=j("brv2-history-pager-info"),a=j("brv2-history-prev"),s=j("brv2-history-next");if(!e)return;if(P.cachedHistoryTasks.length<=Ut){e.style.display="none";return}e.style.display="";const o=Math.ceil(P.cachedHistoryTasks.length/Ut);n&&(n.textContent=P.brv2Page+" / "+o),a&&(a.disabled=P.brv2Page<=1),s&&(s.disabled=P.brv2Page>=o)}function cf(){const e=j("brv2-history-prev"),n=j("brv2-history-next");e&&!e._brv2Bound&&(e._brv2Bound=!0,e.addEventListener("click",()=>{P.brv2Page>1&&(P.brv2Page--,ia(P.cachedHistoryTasks))})),n&&!n._brv2Bound&&(n._brv2Bound=!0,n.addEventListener("click",()=>{const a=Math.ceil(P.cachedHistoryTasks.length/Ut);P.brv2Page<a&&(P.brv2Page++,ia(P.cachedHistoryTasks))}))}function ia(e){e!==void 0&&(P.cachedHistoryTasks=e||[],P.brv2Page=1);const n=P.cachedHistoryTasks,a=j("brv2-history-empty"),s=j("brv2-history-table-wrap"),o=j("brv2-history-tbody");if(!o)return;const i=window._currentLang||"zh";if(!n.length){const f={zh:"暂无对账记录",th:"ยังไม่มีประวัติ",en:"No records yet",ja:"記録なし"}[i]||"暂无对账记录";a&&(a.textContent=f,a.style.display=""),s&&(s.style.display="none"),Zo();return}a&&(a.style.display="none"),s&&(s.style.display="");const r=Math.ceil(n.length/Ut);P.brv2Page>r&&(P.brv2Page=r);const l=(P.brv2Page-1)*Ut,m=n.slice(l,l+Ut),d=localStorage.getItem("mrpilot_token")||"",p='<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" width="14" height="14"><circle cx="8" cy="8" r="6"/><polyline points="6 8 8 10 10 8"/><line x1="8" y1="4" x2="8" y2="10"/></svg>',c='<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" width="14" height="14"><path d="M8 2v9M4 7l4 4 4-4M3 14h10"/></svg>',u='<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" width="14" height="14"><polyline points="3 4 13 4"/><path d="M6 4V2.5a.5.5 0 0 1 .5-.5h3a.5.5 0 0 1 .5.5V4"/><path d="M5 4l1 9a1 1 0 0 0 1 1h2a1 1 0 0 0 1-1l1-9"/></svg>';o.innerHTML="",m.forEach(f=>{const v=Number(f.formula_diff||0),y=Math.abs(v)<.05,b=(f.stmt_files||"").split(";").map(ce=>ce.trim().split(/[/\\]/).pop()).filter(Boolean).join(", "),h=(f.gl_files||"").split(";").map(ce=>ce.trim().split(/[/\\]/).pop()).filter(Boolean).join(", "),g=f.created_at?String(f.created_at).slice(0,16).replace("T"," "):"",_=document.createElement("tr");_.dataset.taskId=f.id;const w=document.createElement("td");w.textContent=g;const k=document.createElement("td");k.className="glv-history-file",k.title=b+" + "+h,k.textContent=b+" + "+h;const x=document.createElement("td");x.className="glv-num",x.textContent=(f.stmt_row_count||0)+" / "+(f.gl_row_count||0);const E=document.createElement("td");E.className="glv-num",E.textContent=f.matched_count||0;const I=document.createElement("td");I.className="glv-num",I.textContent=f.unmatched_gl||0;const B=document.createElement("td");B.className="glv-num",B.textContent=f.unmatched_stmt||0;const L=document.createElement("td");L.className="glv-num",L.style.color=y?"#059669":"#dc2626",L.textContent=y?"✓":pt(v);const $=document.createElement("td");$.className="glv-history-actions";const S=(ce,xe,ye,V)=>{const O=document.createElement("button");return O.type="button",O.title=xe,O.setAttribute("aria-label",xe),ye&&(O.className=ye),O.innerHTML=ce,O.onclick=Y=>{Y.stopPropagation(),V()},O},M={zh:"删除这条记录?",th:"ลบรายการนี้?",en:"Delete this record?",ja:"この記録を削除しますか?"}[i]||"删除?",F={zh:"加载",th:"โหลด",en:"Load",ja:"読込"}[i]||"加载",G={zh:"导出",th:"ส่งออก",en:"Export",ja:"エクスポート"}[i]||"导出",se={zh:"删除",th:"ลบ",en:"Delete",ja:"削除"}[i]||"删除";$.appendChild(S(p,F,"",()=>Qo(f.id,d))),$.appendChild(S(c,G,"",()=>jr(f.id))),$.appendChild(S(u,se,"glv-del",async()=>{await showConfirm(M,{danger:!0})&&(await fetch("/api/recon/bank-v2/"+f.id,{method:"DELETE",headers:{Authorization:"Bearer "+d}}),gn())})),[w,k,x,E,I,B,L,$].forEach(ce=>_.appendChild(ce)),_.style.cursor="pointer",_.addEventListener("click",async ce=>{ce.target.closest(".glv-del")||ce.target.closest("button")||await Qo(f.id,d)}),o.appendChild(_)}),Zo(),Dr()}function Dr(){const e=((j("brv2-hist-search")||{}).value||"").trim().toLowerCase(),n=j("brv2-history-tbody");n&&n.querySelectorAll("tr").forEach(a=>{a.dataset.taskId&&(a.style.display=!e||a.textContent.toLowerCase().includes(e)?"":"none")})}async function Qo(e,n){try{const s=await(await fetch("/api/recon/bank-v2/"+e,{headers:{Authorization:"Bearer "+n}})).json();if(!s.ok)return;P.currentTask={task_id:s.task_id,...s},P.allRows=s.detail||[],P.currentFilter="all",document.querySelectorAll(".brv2-filter-btn").forEach(o=>o.classList.toggle("active",o.dataset.filter==="all")),Ys(P.currentTask)}catch{}}function Je(e){const n=e==="stmt"?P.stmtFiles:P.glFiles,a=j(`brv2-${e}-name`);if(a)if(n.length===0)a.textContent="";else{const o=window._currentLang||"zh",i={zh:"个文件",th:" ไฟล์",en:" file(s)",ja:" ファイル"};a.textContent=n.length+(i[o]||" 个文件")}const s=j("brv2-preview-panel");s&&s.style.display!=="none"&&ns(e),df()}function df(){const e=j("brv2-toggle-preview"),n=j("brv2-preview-panel"),a=P.stmtFiles.length+P.glFiles.length>0;e&&(e.style.display=a?"":"none"),!a&&n&&(n.style.display="none",e&&e.classList.remove("open"))}function pf(){ns("stmt"),ns("gl")}function ns(e){const n=j(e==="stmt"?"brv2-pp-stmt-col":"brv2-pp-gl-col");if(!n)return;const a=e==="stmt"?P.stmtFiles:P.glFiles,s=window._currentLang||"zh",o={stmt:{zh:"① 银行账单",th:"① บัญชีธนาคาร",en:"① Bank Stmt",ja:"① 銀行明細"},gl:{zh:"② 总账 GL",th:"② GL รายงาน",en:"② GL Report",ja:"② GL帳簿"}},i=(o[e]||{})[s]||o[e].zh,r=me(window.t&&window.t("vex-preview-search")||"搜索文件名..."),l=me(window.t&&window.t("vex-preview-clear-all")||"全清"),m=P.brv2Search[e]||"";n.innerHTML='<div class="vex-pp-col-title"><span class="vex-pp-col-name">'+me(i)+' <span class="vex-pp-col-count">'+a.length+'</span></span></div><div class="vex-pp-search-row"><input class="vex-pp-search" id="brv2-pp-search-'+e+'" type="text" placeholder="'+r+'" value="'+me(m)+'" autocomplete="off"><button class="vex-pp-clear-btn" id="brv2-pp-clearall-'+e+'" type="button">'+l+'</button></div><div class="vex-pp-file-list" id="brv2-pp-'+e+'-list"></div><div class="vex-pp-pagination" id="brv2-pp-'+e+'-pg"></div>';const d=j("brv2-pp-search-"+e);d&&d.addEventListener("input",function(c){P.brv2Search[e]=c.target.value,ei(e)});const p=j("brv2-pp-clearall-"+e);p&&p.addEventListener("click",function(){e==="stmt"?P.stmtFiles.length=0:P.glFiles.length=0,Je(e),ut()}),ei(e)}function ei(e){const n=j("brv2-pp-"+e+"-list"),a=j("brv2-pp-"+e+"-pg");if(!n)return;const s=e==="stmt"?P.stmtFiles:P.glFiles,o=(P.brv2Search[e]||"").toLowerCase(),i=o?s.filter(m=>m.name.toLowerCase().includes(o)):s.slice(),r='<svg class="vex-pp-fi-ico" viewBox="0 0 14 16" fill="none" stroke="currentColor" stroke-width="1.4" width="12" height="14"><path d="M3 1h6l3 3v11H3V1z"/><path d="M9 1v3h3"/></svg>',l='<svg viewBox="0 0 14 14" fill="none" stroke="currentColor" stroke-width="1.6" width="11" height="11"><path d="M2 4h10M5 4V2h4v2M5.5 7v4M8.5 7v4M3 4l1 8h6l1-8"/></svg>';if(n.innerHTML=i.map((m,d)=>'<div class="vex-pp-file-row">'+r+'<span class="vex-pp-fi-name" title="'+me(m.name)+'">'+me(m.name)+'</span><span class="vex-pp-fi-size">'+Qm(m.size)+'</span><button class="vex-pp-fi-del" type="button" data-zone="'+e+'" data-idx="'+s.indexOf(m)+'" aria-label="remove">'+l+"</button></div>").join(""),n.querySelectorAll(".vex-pp-fi-del").forEach(function(m){m.addEventListener("click",function(){const d=parseInt(m.dataset.idx,10);m.dataset.zone==="stmt"?P.stmtFiles.splice(d,1):P.glFiles.splice(d,1),Je(m.dataset.zone),ut()})}),a){const m=window.t&&window.t("vex-preview-count")||"显示 {n} / 共 {m}";a.textContent=m.replace("{n}",i.length).replace("{m}",s.length)}}function uf(){const e=j("brv2-toggle-preview");e&&!e._reconBound&&(e._reconBound=!0,e.addEventListener("click",function(){const n=j("brv2-preview-panel"),a=j("brv2-toggle-preview-label"),s=n&&n.style.display!=="none";n&&(n.style.display=s?"none":""),e.classList.toggle("open",!s),a&&(a.textContent=s?window.t&&window.t("vex-toggle-preview-open")||"查看清单":window.t&&window.t("vex-toggle-preview-close")||"收起清单"),s||pf()}))}function ut(){const e=j("brv2-run-btn"),n=j("brv2-status"),a=P.stmtFiles.length>0,s=P.glFiles.length>0;if(e&&(e.disabled=!(a&&s)),n){const o=window._currentLang||"zh";if(!a&&!s){const i={zh:"请上传银行账单和 GL 文件",th:"กรุณาอัปโหลดบัญชีธนาคารและ GL",en:"Upload bank statement and GL files",ja:"銀行明細と GL を両方アップロードしてください"};n.textContent=i[o]||i.zh}else if(a)if(s){const i={zh:"两份文件已就绪",th:"พร้อมสอบทาน",en:"Ready to reconcile",ja:"照合を開始できます"};n.textContent=i[o]||i.zh}else{const i={zh:"还缺 GL 文件",th:"ยังขาดไฟล์ GL",en:"Missing GL file",ja:"GL ファイルが未アップロード"};n.textContent=i[o]||i.zh}else{const i={zh:"还缺银行账单 PDF",th:"ยังขาดไฟล์บัญชีธนาคาร PDF",en:"Missing bank statement PDF",ja:"銀行明細 PDF が未アップロード"};n.textContent=i[o]||i.zh}}}function ti(e,n,a){const s=j(e),o=j(n);!s||!o||(s.addEventListener("click",()=>o.click()),s.addEventListener("keydown",i=>{(i.key==="Enter"||i.key===" ")&&(i.preventDefault(),o.click())}),s.addEventListener("dragover",i=>{i.preventDefault(),s.classList.add("drag-over")}),s.addEventListener("dragleave",()=>s.classList.remove("drag-over")),s.addEventListener("drop",i=>{i.preventDefault(),s.classList.remove("drag-over");const r=Array.from(i.dataTransfer.files||[]);a==="stmt"?P.stmtFiles.push(...r):P.glFiles.push(...r),Je(a),ut()}),o.addEventListener("change",()=>{const i=Array.from(o.files||[]);a==="stmt"?P.stmtFiles.push(...i):P.glFiles.push(...i),o.value="",Je(a),ut()}))}function Me(e){const n=j("brv2-progress"),a=j("brv2-run-btn"),s=j("brv2-error");n&&(n.style.display=e?"":"none"),a&&(a.disabled=e),s&&(s.style.display="none")}function Ye(e){const n=j("brv2-error");n&&(n.textContent=e,n.style.display="",n.scrollIntoView({behavior:"smooth",block:"nearest"})),Me(!1),ut(),window.showToast&&window.showToast(e,"error")}async function as(){if(P.stmtFiles.length===0||P.glFiles.length===0)return;const e=localStorage.getItem("mrpilot_token")||"",n=window._currentLang||"zh",a=(j("brv2-acct-select")||{}).value||"";oa(!1),Me(!0);try{const s=new FormData;P.stmtFiles.forEach(f=>s.append("stmt_files",f)),P.glFiles.forEach(f=>s.append("gl_files",f)),s.append("gl_account",a),s.append("lang",n);const o=parseFloat((j("brv2-anchor-gl-closing")||{}).value),i=parseFloat((j("brv2-anchor-stmt-closing")||{}).value),r=parseFloat((j("brv2-anchor-stmt-opening")||{}).value),l=parseFloat((j("brv2-anchor-gl-opening")||{}).value);Number.isFinite(o)&&s.append("gl_closing_override",o),Number.isFinite(i)&&s.append("stmt_closing_override",i),Number.isFinite(r)&&s.append("stmt_opening_override",r),Number.isFinite(l)&&s.append("gl_opening_override",l);const m=await fetch("/api/recon/bank-v2/submit",{method:"POST",headers:{Authorization:"Bearer "+e},body:s});let d=null;try{d=await m.json()}catch{d=null}if(d&&d.needs_mapping){Me(!1),window.ReconMapping?window.ReconMapping.show(d,{token:e,lang:n,onConfirmed:function(){as()}}):Ye(t("brv2-err-server")||"服务器繁忙,请稍后重试");return}if(!m.ok||!d||!d.ok||!d.job_id){Me(!1),d&&(d.detail||d.error)?Ye(_humanizeBackendError(d.detail||d.error,"Error "+m.status)):Ye(t("brv2-err-server")||"服务器繁忙,请稍后重试");return}const p=j("brv2-progress-sub"),c=await window._reconPollJob(d.job_id,e,{onProgress:f=>{p&&(p.textContent=window._reconProgressText(f,n))}});if(c&&c.status==="needs_mapping"&&c.mapping){Me(!1),window.ReconMapping?window.ReconMapping.show(c.mapping,{token:e,lang:n,onConfirmed:function(){as()}}):Ye(t("brv2-err-server")||"服务器繁忙,请稍后重试");return}if(c&&c.status==="needs_review"&&c.review){Me(!1),window.ReconReview?window.ReconReview.show(c.review,{token:e,lang:n,jobId:d.job_id,onConfirmed:async function(f){Me(!0);const v=await window._reconPollJob(f,e,{onProgress:y=>{p&&(p.textContent=window._reconProgressText(y,n))}});await u(v)}}):Ye(t("brv2-err-server")||"服务器繁忙,请稍后重试");return}if(c&&c.status==="failed"){Me(!1),Ye(Zm(c.error_code,n));return}await u(c);async function u(f){try{if(!f||f.status!=="done"||!f.result_id){Me(!1),Ye(t("brv2-err-server")||"服务器繁忙,请稍后重试");return}const v=await fetch("/api/recon/bank-v2/"+encodeURIComponent(f.result_id),{headers:{Authorization:"Bearer "+e}});let y=null;try{y=await v.json()}catch{y=null}if(!v.ok||y===null||!y.ok){Me(!1),Ye(t("brv2-err-server")||"服务器繁忙,请稍后重试");return}(y.gl_accounts||[]).length>1&&mf(y.gl_accounts),P.currentTask=y,P.allRows=y.detail||[],P.currentFilter="all",document.querySelectorAll(".brv2-filter-btn").forEach(h=>h.classList.toggle("active",h.dataset.filter==="all")),ef(y&&y.summary),Me(!1),Ys(y),gn();const b=j("brv2-summary-collapse");b&&b.scrollIntoView({behavior:"smooth",block:"nearest"})}catch(v){Me(!1),Ye(v.message||"Network error")}}}catch(s){Ye(s.message||"Network error")}}function mf(e){const n=j("brv2-acct-select");if(!n)return;const a=window._currentLang||"zh",s={zh:"全部账户",th:"ทุกบัญชี",en:"All Accounts",ja:"すべての口座"}[a]||"全部账户";n.innerHTML=`<option value="">${s}</option>`+e.map(o=>`<option value="${me(o)}">${me(o)}</option>`).join(""),n.style.display=""}function Js(){if(P.initialized){gn();return}P.initialized=!0,ti("brv2-stmt-zone","brv2-stmt-input","stmt"),ti("brv2-gl-zone","brv2-gl-input","gl");const e=["brv2-anchor-gl-closing","brv2-anchor-stmt-closing","brv2-anchor-stmt-opening","brv2-anchor-gl-opening"];function n(){const l=parseFloat((j("brv2-anchor-stmt-opening")||{}).value),m=parseFloat((j("brv2-anchor-gl-opening")||{}).value),d=j("brv2-anchor-eq"),p=j("brv2-anchor-eq-val");if(!(!d||!p))if(Number.isFinite(l)&&Number.isFinite(m)){const c=l-m;p.textContent=c.toLocaleString(void 0,{minimumFractionDigits:2,maximumFractionDigits:2}),d.style.display=""}else d.style.display="none"}e.forEach(l=>{const m=j(l);m&&(m.addEventListener("input",n),m.addEventListener("input",()=>{const d=m.closest(".brv2-anchor-cell");d&&d.classList.remove("is-prefilled"),af()}))}),nf();const a=j("brv2-run-btn");a&&a.addEventListener("click",as);const s=j("brv2-reset-btn");s&&s.addEventListener("click",()=>{P.currentTask=null,P.allRows=[],P.stmtFiles=[],P.glFiles=[],Je("stmt"),Je("gl"),ut(),oa(!1);const l=j("brv2-acct-select");l&&(l.style.display="none"),e.forEach(p=>{const c=j(p);if(c){c.value="";const u=c.closest&&c.closest(".brv2-anchor-cell");u&&u.classList.remove("is-prefilled")}});const m=j("brv2-anchor-eq");m&&(m.style.display="none");const d=j("brv2-anchor-prefill-banner");d&&d.classList.remove("show")});const o=j("brv2-new-btn");o&&o.addEventListener("click",()=>{P.currentTask=null,P.allRows=[],P.stmtFiles=[],P.glFiles=[],Je("stmt"),Je("gl"),ut(),oa(!1)});const i=j("brv2-filter-tabs");i&&i.addEventListener("click",l=>{l.stopPropagation();const m=l.target.closest(".brv2-filter-btn");m&&(P.currentFilter=m.dataset.filter,i.querySelectorAll(".brv2-filter-btn").forEach(d=>d.classList.toggle("active",d===m)),Pr())}),uf(),cf();const r=j("brv2-hist-search");r&&r.addEventListener("input",Dr),gn(),ut(),window._brv2LoadHistory=gn,Array.isArray(window.__i18nSubs)||(window.__i18nSubs=[]),window.__i18nSubs=window.__i18nSubs.filter(l=>l.name!=="brv2"),window.__i18nSubs.push({name:"brv2",fn:function(){ut(),Je("stmt"),Je("gl"),P.currentTask&&Ys(P.currentTask),ia()}})}window._loadBankReconV2Panel=function(e){const n=e?document.getElementById(e):null;n&&n.id!=="recon-pane-bank"&&(n.innerHTML=`<div style="padding:16px;font-size:13px;color:var(--ink-3)">
            银行对账 v2 · 请前往对账中心使用</div>`),Js()};document.addEventListener("DOMContentLoaded",()=>{j("brv2-run-btn")&&Js()});window._bankReconV2Init=Js;(function(){const e=document.getElementById("general-lang");if(!e)return;e.addEventListener("change",a=>{const s=a.target.value;s&&applyLang(s)});const n=typeof currentLang=="string"&&currentLang||localStorage.getItem("mrpilot_lang")||"th";e.value=n})();(function(){const n="pearnly_general_tz",a="pearnly_general_date_format",s="pearnly_general_number_format",o={tz:"Asia/Bangkok",date:"YYYY-MM-DD",number:"comma_dot"};function i(){const d=document.getElementById("general-tz"),p=document.getElementById("general-date"),c=document.getElementById("general-number");if(!(!d||!p||!c))try{d.value=localStorage.getItem(n)||o.tz,p.value=localStorage.getItem(a)||o.date,c.value=localStorage.getItem(s)||o.number}catch{d.value=o.tz,p.value=o.date,c.value=o.number}}async function r(){const d=document.getElementById("btn-save-general"),p=document.getElementById("general-save-msg");if(!d)return;const c=d.innerHTML;d.disabled=!0,d.innerHTML="<span>"+(t("msg-saving")||"保存中...")+"</span>",p&&(p.textContent="",p.classList.remove("error"));try{const u=(document.getElementById("general-tz")||{}).value||o.tz,f=(document.getElementById("general-date")||{}).value||o.date,v=(document.getElementById("general-number")||{}).value||o.number;try{localStorage.setItem(n,u),localStorage.setItem(a,f),localStorage.setItem(s,v)}catch{}window._pearnlyGeneral={tz:u,date_format:f,number_format:v},p&&(p.textContent=t("msg-saved")||"已保存")}catch{p&&(p.textContent=t("msg-save-failed")||"保存失败",p.classList.add("error"))}finally{d.disabled=!1,d.innerHTML=c,setTimeout(function(){p&&(p.textContent="")},3e3)}}function l(){const d=document.getElementById("btn-save-general");if(!d){setTimeout(l,200);return}d._pearnlyGenBound||(d._pearnlyGenBound=!0,d.addEventListener("click",r),i())}function m(){i();const d=document.getElementById("general-lang");if(d){const p=typeof currentLang=="string"&&currentLang||localStorage.getItem("mrpilot_lang")||"th";d.value=p}}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",l):l(),typeof window.subscribeI18n=="function"&&window.subscribeI18n("settings-general",m)})();(function(){const e="mrpilot_nav_collapsed",n={ocr:"sales",history:"sales",reconcile:"sales","sales-invoices":"sales","sales-account":"sales",receivables:"sales",vouchers:"expense"};function a(){try{const r=localStorage.getItem(e);return r?JSON.parse(r):{}}catch{return{}}}function s(r){try{localStorage.setItem(e,JSON.stringify(r))}catch{}}function o(){const r=a();document.querySelectorAll(".nav-collapsible").forEach(function(l){const m=l.dataset.collapsible;r[m]?l.classList.add("collapsed"):l.classList.remove("collapsed")})}function i(r){const l=a();l[r]=!l[r],s(l),o()}(function(){const l=a();let m=!1;l.sales===void 0&&(l.sales=!1,m=!0),l.expense===void 0&&(l.expense=!0,m=!0),m&&s(l)})(),o(),document.querySelectorAll(".nav-group-toggle").forEach(function(r){r.addEventListener("click",function(){i(r.dataset.toggleGroup)})}),window.expandNavGroupForRoute=function(r){const l=n[r];if(!l)return;const m=a();m[l]&&(m[l]=!1,s(m),o())}})();const ff=`
    <div class="modal" style="max-width:440px">
    ...
    </div>`;function ni(){const e=document.getElementById("help-modal");if(!e||e.children.length)return;e.innerHTML=ff;const n=window._currentLang||"th",a=window.I18N&&window.I18N[n]||{};e.querySelectorAll("[data-i18n]").forEach(s=>{const o=s.getAttribute("data-i18n");o&&a[o]&&(s.textContent=a[o])})}document.readyState,ni();(function(){function e(){const n=document.getElementById("help-modal"),a=document.getElementById("help-modal-close");n&&(a&&!a.dataset.bound&&(a.addEventListener("click",function(){n.style.display="none"}),a.dataset.bound="1"),n.dataset.maskBound||(n.addEventListener("click",function(s){s.target===n&&(n.style.display="none")}),n.dataset.maskBound="1"),window._helpModalEscBound||(document.addEventListener("keydown",function(s){s.key==="Escape"&&n.style.display==="flex"&&(n.style.display="none")}),window._helpModalEscBound=!0))}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",e):e()})();(function(){const e={line:"line",folder:"folder",gmail:"email",erp:"erp",alert:"alert"};document.addEventListener("click",function(n){const a=n.target.closest(".int-btn-configure");if(!a)return;const s=a.closest(".integration-row"),o=s?s.dataset.intAnchor:null;if(o&&e[o]){const i=s.querySelector(".int-name"),r=i?(i.textContent||i.innerText||"").trim():"配置";typeof window.openIntegrationDrawer=="function"&&window.openIntegrationDrawer(e[o],r)}})})();let Re=[];window._erpEndpoints=Re;let In=null;async function ya(){try{const e=await fetch("/api/erp/endpoints",{headers:{Authorization:"Bearer "+token}});if(e.status===401){localStorage.removeItem("mrpilot_token");const a=await e.json().catch(()=>({}));if((typeof a.detail=="string"?a.detail:a.detail&&a.detail.code||"")==="auth.session_revoked"){_showSessionRevokedModal();return}window.location.href="/";return}Re=(await e.json()).items||[],window._erpEndpoints=Re,Rr()}catch(e){console.error("load endpoints failed",e)}}window._refreshErpEndpointsCache=function(){return ya()};async function qr(){const e=document.getElementById("erp-today-stats");if(e){e.innerHTML="";try{const n=await fetch("/api/erp/stats/today",{headers:{Authorization:"Bearer "+token}});if(!n.ok)return;const a=await n.json(),s=a.total||0,o=a.success||0,i=a.failed||0,r=a.auto_cnt||0;if(s===0){e.innerHTML=`<span class="erp-today-empty">${escapeHtml(t("erp-today-none"))}</span>`;return}const l=[];l.push(`<span class="erp-today-item"><strong>${s}</strong> ${escapeHtml(t("erp-today-total"))}</span>`),o>0&&l.push(`<span class="erp-today-item ok"><strong>${o}</strong> ${escapeHtml(t("erp-today-success"))}</span>`),i>0&&l.push(`<span class="erp-today-item fail"><strong>${i}</strong> ${escapeHtml(t("erp-today-failed"))}</span>`),r>0&&l.push(`<span class="erp-today-item auto"><strong>${r}</strong> ${escapeHtml(t("erp-today-auto"))}</span>`),e.innerHTML=l.join("")}catch(n){console.warn("loadErpTodayStats failed",n)}}}function Rr(){const e=document.getElementById("erp-endpoints-list"),n=document.getElementById("erp-status-summary"),a=document.getElementById("btn-add-endpoint");if(!e){console.warn("erp-endpoints-list 容器不存在");return}if(a&&_userInfo){const o=_userInfo.endpoints_limit;o!==-1&&Re.length>=o?(a.disabled=!0,a.title=t("ep-limit-reached",{limit:o}),a.classList.add("btn-disabled-plus")):(a.disabled=!1,a.title="",a.classList.remove("btn-disabled-plus"))}if(Re.length===0){e.innerHTML=`<div class="erp-empty">${escapeHtml(t("ep-list-empty"))}</div>`,n&&(n.textContent=t("auto-status-none"),n.className="auto-status-pill none");return}const s=Re.some(o=>o.auto_push&&o.enabled);if(n&&(n.textContent=t("auto-status-active",{n:Re.length,mode:s?t("auto-status-on"):t("auto-status-off")}),n.className="auto-status-pill "+(s?"active":"ready")),qr(),e.innerHTML=Re.map(o=>{const i=o.config||{},r=escapeHtml(i.url||"");i._token_set;const l=o.enabled!==!1,m=[];o.is_default&&m.push(`<span class="ep-badge default">${escapeHtml(t("ep-default"))}</span>`),o.auto_push&&m.push(`<span class="ep-badge auto">${escapeHtml(t("ep-auto-push-on"))}</span>`),l||m.push(`<span class="ep-badge disabled">${escapeHtml(t("ep-disabled"))}</span>`);const d=[];return o.success_count>0&&d.push(`<span class="ep-stat ok">${escapeHtml(t("ep-success",{n:o.success_count}))}</span>`),o.failure_count>0&&d.push(`<span class="ep-stat fail">${escapeHtml(t("ep-failure",{n:o.failure_count}))}</span>`),`
        ...
        `}).join(""),_userInfo&&_userInfo.endpoints_limit!==-1){const o=Re.length,i=_userInfo.endpoints_limit,r=_userInfo.plan,l=document.createElement("div");l.className="erp-limit-hint",r==="free"?l.innerHTML=`${escapeHtml(t("ep-free-limit-hint",{used:o,limit:i}))} <a data-upgrade="plus">${escapeHtml(t("upgrade-to-plus"))}</a>`:l.textContent=t("ep-plus-limit-hint",{used:o,limit:i}),e.appendChild(l)}}function vf(e){In=e||null;const n=document.getElementById("endpoint-modal"),a=document.getElementById("endpoint-modal-title");a.textContent=e?t("ep-modal-title-edit"):t("ep-modal-title-new");const s=document.getElementById("ep-name"),o=document.getElementById("ep-url"),i=document.getElementById("ep-token"),r=document.getElementById("ep-is-default"),l=document.getElementById("ep-auto-push"),m=document.getElementById("ep-test-result");m.style.display="none",m.textContent="";const d=document.getElementById("ep-save-error");if(d&&d.remove(),e){const c=Re.find(u=>u.id===e);if(!c)return;s.value=c.name||"",o.value=(c.config||{}).url||"",i.value=(c.config||{})._token_set&&c.config.token||"",i.placeholder=(c.config||{})._token_set?"（已保存 · 留空保持不变）":t("ep-token-ph"),r.checked=!!c.is_default,l.checked=!!c.auto_push}else s.value="",o.value="",i.value="",i.placeholder=t("ep-token-ph"),r.checked=Re.length===0,l.checked=!0;const p=l.closest(".form-switch-row");if(l.disabled=!1,p){p.classList.remove("disabled-plus"),p.title="",p.style.cursor="",p.onclick=null;const c=p.querySelector(".plus-badge");c&&c.remove()}n.style.display="",setTimeout(()=>s.focus(),50)}function Fr(){document.getElementById("endpoint-modal").style.display="none",In=null;const e=document.getElementById("ep-save-error");e&&e.remove()}function zr(e){if(!e)return"";let n=e.trim();const a=n.search(/\s/);return a>=0&&(n=n.slice(0,a)),n}function Nr(){const e=document.getElementById("ep-name").value.trim(),n=zr(document.getElementById("ep-url").value),a=document.getElementById("ep-token").value,s=document.getElementById("ep-is-default").checked,o=document.getElementById("ep-auto-push").checked,i={url:n};return a&&(i.token=a),{name:e,url:n,tokenVal:a,isDefault:s,autoPush:o,config:i}}async function hf(){const{url:e,config:n}=Nr(),a=document.getElementById("ep-test-result");if(!e){a.style.display="",a.className="form-test-result fail",a.textContent=t("ep-required");return}a.style.display="",a.className="form-test-result running",a.textContent=t("ep-test-running");try{const o=await(await fetch("/api/erp/test-connection",{method:"POST",headers:{Authorization:"Bearer "+token,"Content-Type":"application/json"},body:JSON.stringify({adapter:"webhook",config:n})})).json();o.success?(a.className="form-test-result ok",a.textContent=t("ep-test-ok",{status:o.http_status,ms:o.elapsed_ms})):(a.className="form-test-result fail",a.textContent=t("ep-test-fail",{err:o.error_msg||"unknown"}))}catch(s){a.className="form-test-result fail",a.textContent=t("ep-test-fail",{err:s.message})}}async function gf(){const e=Nr(),n=document.getElementById("ep-save-error");if(n&&(n.style.display="none"),!e.name||!e.url){ai(t("ep-required"));return}const a={name:e.name,adapter:"webhook",config:e.config,is_default:e.isDefault,auto_push:e.autoPush},s=document.getElementById("btn-ep-save"),o=s.innerHTML;s.disabled=!0,s.classList.add("loading");try{let i;if(In?i=await fetch(`/api/erp/endpoints/${encodeURIComponent(In)}`,{method:"PATCH",headers:{Authorization:"Bearer "+token,"Content-Type":"application/json"},body:JSON.stringify(a)}):i=await fetch("/api/erp/endpoints",{method:"POST",headers:{Authorization:"Bearer "+token,"Content-Type":"application/json"},body:JSON.stringify(a)}),!i.ok){const l=(await i.json().catch(()=>({}))).detail||`HTTP ${i.status}`;throw new Error(typeof l=="string"?l:JSON.stringify(l))}Fr(),showToast(t("ep-save-ok")),ya()}catch(i){ai(`${t("ep-save-fail")} · ${i.message||"unknown"}`)}finally{s.disabled=!1,s.classList.remove("loading"),s.innerHTML=o}}function ai(e){let n=document.getElementById("ep-save-error");if(!n){const a=document.querySelector("#endpoint-modal .modal-foot");if(!a)return;n=document.createElement("div"),n.id="ep-save-error",n.className="ep-inline-error",a.parentNode.insertBefore(n,a)}n.textContent=e,n.style.display=""}async function bf(e){const n=Re.find(s=>s.id===e);if(!(!n||!await showConfirm(t("ep-delete-confirm",{name:n.name}),{danger:!0})))try{if(!(await fetch(`/api/erp/endpoints/${encodeURIComponent(e)}`,{method:"DELETE",headers:{Authorization:"Bearer "+token}})).ok)throw new Error;showToast(t("ep-delete-ok")),ya()}catch{showToast(t("ep-save-fail"),"fail")}}window.loadErpEndpoints=ya;window.loadErpTodayStats=qr;window.renderErpEndpointsList=Rr;window.openEndpointModal=vf;window.closeEndpointModal=Fr;window.saveEndpoint=gf;window.deleteEndpoint=bf;window.testEndpointConnection=hf;window._sanitizeUrl=zr;async function Or(e){if(e=(e||"").trim(),!!e)try{await navigator.clipboard.writeText(e),showToast(t("erp-doc-copy-ok",{no:e}),"success")}catch{try{const a=document.createElement("textarea");a.value=e,a.style.position="fixed",a.style.opacity="0",document.body.appendChild(a),a.select(),document.execCommand("copy"),a.remove(),showToast(t("erp-doc-copy-ok",{no:e}),"success")}catch{showToast(t("erp-doc-copy-fail"),"error")}}}async function yf(e){const n=document.createElement("div");n.className="log-detail-modal",n.innerHTML=`
        <div class="log-detail-box">
            <div class="log-detail-loading">${escapeHtml(t("log-detail-loading"))}</div>
        </div>
    `,document.body.appendChild(n),n.addEventListener("click",async a=>{if(a.target===n||a.target.classList.contains("log-detail-close")){n.remove();return}const s=a.target.closest("[data-receipt-copy]");if(s){Or(s.dataset.receiptCopy);return}const o=a.target.closest("[data-receipt-action]");if(o){const i=o.dataset.receiptAction;i==="retry"?window.retryPushLog(o.dataset.logId):i==="exceptions"?typeof routeTo=="function"&&routeTo("exceptions"):i==="mappings"&&typeof routeTo=="function"&&routeTo("integrations"),n.remove();return}});try{const a=await fetch(`/api/erp/logs/${encodeURIComponent(e)}`,{headers:{Authorization:"Bearer "+token}});if(!a.ok){n.remove();return}const s=await a.json(),o=window._erpEndpoints.find(S=>S.id===s.endpoint_id),i=s.endpoint_name||(o?o.name:s.endpoint_id?t("erp-log-endpoint-deleted"):"-"),r=(s.endpoint_adapter||o&&o.adapter||"").toLowerCase(),l=new Date(s.created_at).toLocaleString(),m=s.trigger==="auto"?t("log-tag-auto"):s.trigger==="retry"?t("log-tag-retry"):t("log-tag-manual"),d=s.request_body?JSON.stringify(s.request_body,null,2):t("erp-receipt-no-tech"),p=s.response_body||t("erp-receipt-no-tech"),c=s.status==="success";let u=typeof p=="string"?p:JSON.stringify(p,null,2);if(c)try{const S=typeof s.response_body=="string"?JSON.parse(s.response_body):s.response_body||{},M=S.row_count||(Array.isArray(S.imported_rows)?S.imported_rows.length:0);M>0&&(u=t("log-push-rows").replace("{n}",String(M)))}catch{}const f=(s.external_doc_no||"").trim(),v=(s.external_url||"").trim(),y=(s.external_doc_hint||"").trim(),b=(s.ocr_buyer_name||"").trim()||s.client_name||"-",h=s.seller_name||"-",g=s.push_type==="id_card";let _="-";const w=Number(s.total_amount);s.total_amount!=null&&s.total_amount!==""&&!isNaN(w)&&(_=w.toLocaleString("en-US",{minimumFractionDigits:2,maximumFractionDigits:2}));const k=c?t("erp-receipt-title-ok"):t("erp-receipt-title-fail"),x=c?"✓":"✗",E=[],I=(S,M)=>{E.push(`
                <div class="erp-receipt-row">
                    <span class="erp-receipt-key">${escapeHtml(S)}</span>
                    <span class="erp-receipt-val">${M}</span>
                </div>`)};if(I(g?t("erp-log-col-booking"):t("erp-receipt-invoice-no"),`<strong>${escapeHtml(s.invoice_no||"-")}</strong>`),I(t("erp-receipt-erp-name"),escapeHtml(i)),c){let S;f?S=`<strong class="erp-receipt-docno">${escapeHtml(f)}</strong><button class="erp-receipt-copy-btn" type="button" data-receipt-copy="${escapeHtml(f)}" title="${escapeHtml(t("erp-doc-copy-tip"))}">${escapeHtml(t("erp-receipt-copy-btn"))}</button>`:S=`<span class="erp-receipt-docno-missing">${escapeHtml(t("erp-log-doc-missing"))}</span>`,I(t("erp-receipt-doc-no"),S)}g||I(t("erp-receipt-client"),escapeHtml(b)),I(g?t("erp-log-col-customer"):t("erp-receipt-seller"),escapeHtml(h)),c&&I(t("erp-receipt-amount"),escapeHtml(_)),I(t("erp-receipt-time"),escapeHtml(l)),I(t("erp-receipt-elapsed"),escapeHtml((s.elapsed_ms!=null?s.elapsed_ms:"-")+"ms"));let B="";c&&v?B=`<a class="erp-receipt-primary-btn" href="${escapeHtml(v)}" target="_blank" rel="noopener">${escapeHtml(t("erp-receipt-open-erp"))}</a>`:c&&f&&(B=`<button class="erp-receipt-primary-btn" type="button" data-receipt-copy="${escapeHtml(f)}">${escapeHtml(t("erp-receipt-copy-docno"))}</button>`);let L="";if(c&&f&&y){const S="erp-receipt-hint-"+y,M=t(S);M&&M!==S&&(L=`<div class="erp-receipt-hint"><svg class="erp-receipt-hint-ic" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><circle cx="12" cy="12" r="9"/><line x1="12" y1="11" x2="12" y2="16"/><line x1="12" y1="8" x2="12.01" y2="8"/></svg><span>${escapeHtml(M)}</span></div>`)}let $="";if(!c){const S=(s.error_msg||"").match(/ERR_[A-Z0-9_]+/),M=S?S[0]:"",F=typeof currentLang=="string"&&currentLang||window._currentLang||"th",se=s.error_friendly&&s.error_friendly[F]||(s.error_msg?humanizeError(s.error_msg):t("erp-receipt-no-error")),ce=/ERR_NO_CUSTOMER_MAPPING|ERR_NO_CLIENT|ERR_NO_SEED_CUSTOMER|ERR_NO_SEED_PRODUCT/.test(s.error_msg||""),xe=!!(s.history_id&&s.endpoint_id),ye=[];ye.push(`<button class="erp-receipt-action-btn" type="button" data-receipt-action="exceptions">${escapeHtml(t("erp-receipt-act-exceptions"))}</button>`),ce&&ye.push(`<button class="erp-receipt-action-btn" type="button" data-receipt-action="mappings">${escapeHtml(t("erp-receipt-act-mapping"))}</button>`),xe&&ye.push(`<button class="erp-receipt-action-btn primary" type="button" data-receipt-action="retry" data-log-id="${escapeHtml(s.id)}">${escapeHtml(t("erp-receipt-act-retry"))}</button>`),$=`
                ...
                <div class="erp-receipt-actions">${ye.join("")}</div>`}n.querySelector(".log-detail-box").innerHTML=`
        ...
        `}catch(a){console.error(a),n.remove()}}window.copyErpDocNo=Or;window.showLogDetail=yf;const wf=`
        <div class="modal">
            <div class="modal-head">
    ...
    `;Be("endpoint-modal",wf);let dn={key:"all",val:""},bn="",Pa=!1,rt=new Set;window._erpSelected=rt;async function kf(){const e=document.getElementById("erp-logs-erp-select");if(!(!e||Pa)){Pa=!0;try{let n=window._erpEndpoints;if(!Array.isArray(n)||n.length===0){const o=await fetch("/api/erp/endpoints",{headers:{Authorization:"Bearer "+token}});if(o.ok){const i=await o.json();n=i&&(i.items||i)||[]}}Array.isArray(n)||(n=[]);const a=new Set,s=[];n.forEach(o=>{const i=(o&&o.adapter||"").toLowerCase();!i||a.has(i)||(a.add(i),s.push({val:i,label:o&&o.name||i}))}),e.innerHTML=`<option value="">${escapeHtml(t("erp-logs-erp-all"))}</option>`+s.map(o=>`<option value="${escapeHtml(o.val)}"${o.val===bn?" selected":""}>${escapeHtml(o.label)}</option>`).join("")}catch{Pa=!1}}}async function Gt(e){const n=document.getElementById("erp-logs-list");if(n){e||(n.innerHTML=`<div class="erp-logs-empty">${escapeHtml(t("erp-logs-loading"))}</div>`),window.loadErpTodayStats(),kf();try{const a=new URLSearchParams({limit:"30"});dn.key==="status"&&a.set("status",dn.val),dn.key==="trigger"&&a.set("trigger",dn.val),bn&&a.set("adapter",bn);const s=await fetch(`/api/erp/logs?${a}`,{headers:{Authorization:"Bearer "+token}});if(!s.ok){n.innerHTML=`<div class="erp-logs-empty">${escapeHtml(t("erp-logs-error"))}</div>`;return}const i=(await s.json()).items||[];if(window._erpLogPollTimer&&(clearTimeout(window._erpLogPollTimer),window._erpLogPollTimer=null),i.some(function(f){return f.status==="pending"})&&(window._erpLogPollTimer=setTimeout(function(){Gt(!0)},4e3)),i.length===0){n.innerHTML=`<div class="erp-logs-empty">${escapeHtml(t("erp-logs-empty"))}</div>`;return}const r=i.filter(function(f){var v=f.status==="failed"&&f.next_retry_at&&new Date(f.next_retry_at).getTime()>Date.now()-6e4;return!v}).map(function(f){return f.id}),l=bn==="mrerp_dms",m=l?t("erp-log-col-booking"):t("erp-log-col-invoice"),d=l?t("erp-log-col-customer"):t("erp-log-col-seller"),p=l?t("erp-log-col-idcard"):t("erp-log-col-client"),c='<div class="erp-log-row erp-log-row-header" data-log-header>'+(r.length>0?`<input type="checkbox" class="erp-log-cb erp-log-cb-all" data-log-select-all title="${escapeHtml(t("erp-log-select-all-tip"))}">`:'<span class="erp-log-cb-spacer"></span>')+`<span class="log-time">${escapeHtml(t("erp-log-col-time"))}</span><span class="log-status">${escapeHtml(t("erp-log-col-status"))}</span><span class="log-tag-header">${escapeHtml(t("erp-log-col-trigger"))}</span><span class="log-invoice">${escapeHtml(m)}</span><span class="log-workspace">${escapeHtml(t("erp-log-col-workspace"))}</span><span class="log-client">${escapeHtml(p)}</span><span class="log-seller">${escapeHtml(d)}</span><span class="log-erp">${escapeHtml(t("erp-log-col-erp"))}</span><span class="log-doc">${escapeHtml(t("erp-log-col-doc"))}</span><span class="log-http">${escapeHtml(t("erp-log-col-http"))}</span><span class="log-elapsed">${escapeHtml(t("erp-log-col-elapsed"))}</span><span class="log-actions"></span></div>`;n.innerHTML=c+i.map(f=>{const v=new Date(f.created_at),y=`${String(v.getMonth()+1).padStart(2,"0")}-${String(v.getDate()).padStart(2,"0")} ${String(v.getHours()).padStart(2,"0")}:${String(v.getMinutes()).padStart(2,"0")}`,b=f.status==="failed"&&f.next_retry_at&&new Date(f.next_retry_at).getTime()>Date.now()-6e4;let h,g,_;f.status==="pending"?(h="retrying",g="⟳",_=t("erp-status-pending")):f.status==="success"?(h="ok",g="✓",_=t("erp-status-success")):f.status==="skipped_dup"?(h="skipped",g="⏭",_=t("erp-status-skipped")):b?(h="retrying",g="↻",_=t("erp-status-retrying")):(h="fail",g="✗",_=t("erp-status-failed"));let w;f.trigger==="auto"?w=`<span class="log-tag auto">${escapeHtml(t("log-tag-auto"))}</span>`:f.trigger==="retry"?w=`<span class="log-tag retry">${escapeHtml(t("log-tag-retry"))}</span>`:w=`<span class="log-tag manual">${escapeHtml(t("log-tag-manual"))}</span>`;const k=f.push_type==="id_card",x=k?`<span class="log-tag log-type-idcard">${escapeHtml(t("erp-log-type-idcard"))}</span>`:"",E=f.error_friendly&&(f.error_friendly[currentLang]||f.error_friendly.en)||"";let I="";const B=f.retry_count||0,L=f.max_retries||3;if(b){const Y=new Date(f.next_retry_at).getTime()-Date.now(),de=Math.max(0,Math.round(Y/6e4)),re=de<=0?t("erp-retry-next-soon"):t("erp-retry-next-min",{n:de});I=`${t("erp-retry-attempt",{n:B,max:L})} · ${re}`}else f.status==="failed"&&B>=L&&!f.next_retry_at&&(I=t("erp-retry-exhausted",{n:B}));const $=f.status==="failed"&&!b?`<button class="log-retry-btn btn btn-icon" data-log-retry="${escapeHtml(f.id)}" title="${escapeHtml(t("log-retry-title"))}">↻</button>`:"",S=!b,M=rt.has(f.id)?"checked":"",F=S?`<input type="checkbox" class="erp-log-cb" data-log-cb="${escapeHtml(f.id)}" ${M}>`:'<span class="erp-log-cb-spacer"></span>',G=(f.ocr_buyer_name||"").trim()||(f.client_name||"").trim(),se=k?`<span class="log-client" title="${escapeHtml(t("erp-log-col-idcard"))}">${f.id_card_tail?"••••"+escapeHtml(f.id_card_tail):"—"}</span>`:G?`<span class="log-client" title="${escapeHtml(G)}">${escapeHtml(G.substring(0,18))}</span>`:`<span class="log-client log-client-empty" title="${escapeHtml(t("erp-log-client-unassigned-tip"))}">${escapeHtml(t("erp-log-client-unassigned"))}</span>`,ce=k?'<span class="log-workspace log-workspace-unresolved">—</span>':f.workspace_name?`<span class="log-workspace">${escapeHtml((f.workspace_name||"").substring(0,16))}</span>`:`<span class="log-workspace log-workspace-unresolved" title="${escapeHtml(t("erp-log-ws-unresolved-tip"))}">${escapeHtml(t("erp-log-ws-unresolved"))}</span>`,xe=f.endpoint_name?`<span class="log-erp">${escapeHtml((f.endpoint_name||"").substring(0,14))}</span>`:`<span class="log-erp log-erp-deleted">${escapeHtml(t("erp-log-endpoint-deleted"))}</span>`,ye=(f.external_doc_no||"").trim(),V=(f.external_url||"").trim();let O;return V?O=`<span class="log-doc"><a href="${escapeHtml(V)}" target="_blank" rel="noopener" class="log-doc-open" title="${escapeHtml(ye||"")}">${escapeHtml(t("erp-log-doc-open"))}</a></span>`:ye?O=`<span class="log-doc log-doc-copy" data-copy-doc="${escapeHtml(ye)}" title="${escapeHtml(t("erp-log-doc-copy-tip"))}">${escapeHtml(ye.substring(0,18))}</span>`:f.status==="success"?O=`<span class="log-doc log-doc-missing" title="${escapeHtml(t("erp-log-doc-missing-tip"))}">${escapeHtml(t("erp-log-doc-missing"))}</span>`:O='<span class="log-doc log-doc-empty">-</span>',`
                <div class="erp-log-row ${h}" data-log-detail="${escapeHtml(f.id)}">
                    ${F}
        ...
        `,document.body.appendChild(f);const v=()=>f.remove();f.querySelector("#cpw-forgot-close").addEventListener("click",v),f.querySelector("#cpw-forgot-cancel").addEventListener("click",v),f.addEventListener("click",y=>{y.target===f&&v()}),f.querySelector("#cpw-forgot-send").addEventListener("click",async()=>{const y=f.querySelector("#cpw-forgot-send"),b=f.querySelector("#cpw-forgot-msg");y.disabled=!0;const h=y.textContent;y.textContent=a("cpw-forgot-sending");try{const g=await fetch("/api/auth/forgot_password",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:c})}),_=await g.json().catch(()=>({}));g.ok?(b.textContent=a("cpw-forgot-success"),b.className="cpw-forgot-msg success",y.style.display="none",f.querySelector("#cpw-forgot-cancel").textContent=a("cpw-forgot-close-btn")):(b.textContent=_.detail||a("cpw-forgot-fail"),b.className="cpw-forgot-msg error",y.disabled=!1,y.textContent=h)}catch{b.textContent=a("cpw-forgot-fail"),b.className="cpw-forgot-msg error",y.disabled=!1,y.textContent=h}})}function m(p){if(!p||!p.includes("@"))return p||"";const[c,u]=p.split("@");return c.length<=2?c+"****@"+u:c.slice(0,2)+"****@"+u}function d(p){return p==null?"":String(p).replace(/[&<>"']/g,c=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[c])}document.readyState==="complete"||document.readyState==="interactive"?r():document.addEventListener("DOMContentLoaded",r)})();(function(){let e=null,n=!1;async function a(){if(n)return;const o=localStorage.getItem("mrpilot_token");if(o){n=!0;try{const i=await fetch("/api/me",{headers:{Authorization:"Bearer "+o},cache:"no-store"});if(i.status===401){const r=await i.json().catch(()=>({})),l=r&&r.detail;let m="";if(typeof l=="string"?m=l:l&&typeof l=="object"&&(m=l.code||""),console.warn("[heartbeat] session revoked",m),localStorage.removeItem("mrpilot_token"),e&&(clearInterval(e),e=null),m==="auth.session_revoked")try{_showSessionRevokedModal()}catch{window.location.href="/"}else{const d=m==="auth.password_changed_relogin"?"alert-password-changed-relogin":"alert-session";try{typeof showToast=="function"&&typeof t=="function"?showToast(t(d),"error"):alert("Session expired")}catch{}setTimeout(()=>{window.location.href="/"},1500)}}}catch{}finally{n=!1}}}function s(){e&&clearInterval(e),e=setInterval(a,15e3)}localStorage.getItem("mrpilot_token")&&s(),window.addEventListener("focus",a),document.addEventListener("visibilitychange",function(){document.hidden||a()}),window._sessionCheck=a})();async function wa(){const e=document.getElementById("team-loading"),n=document.getElementById("team-list"),a=document.getElementById("team-empty"),s=document.getElementById("team-count");if(n){e&&(e.style.display=""),n.style.display="none",a&&(a.style.display="none");try{const o=await apiGet("/api/team/employees"),i=o&&o.employees||[];if(e&&(e.style.display="none"),s&&(s.textContent=(t("team-count")||"共 {n} 名员工").replace("{n}",i.length)),i.length===0){a&&(a.style.display="");return}n.style.display="",n.innerHTML=i.map(r=>{const l=r.last_login_at?new Date(r.last_login_at).toLocaleDateString():t("team-never-login")||"从未登录",m=r.is_active===!1?"team-status-off":"team-status-on",d=r.is_active===!1?t("team-status-disabled")||"已禁用":t("team-status-active")||"正常",p=r.email?`<span class="team-meta-sep">·</span><span>${escapeHtml(r.email)}</span>`:"";return`
            ...
            </div>`}).join("")}catch(o){console.error("loadTeamList failed:",o),e&&(e.textContent=t("team-load-failed")||"加载失败")}}}async function xf(){document.querySelectorAll(".add-emp-overlay").forEach(s=>s.remove());const e=document.createElement("div");e.className="add-emp-overlay",e.innerHTML=`
