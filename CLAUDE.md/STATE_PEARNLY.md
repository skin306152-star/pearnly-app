...
## 🎯 状态卡（2026-06-27 · **B8 RLS · 孤儿 re-enroll 连推 4 棒 12 表 enroll 上线 + /simplify 收口**:sales(`8a7d8485`)+ suppliers(`4cc03b42`)+ line 绑定(`cd3cc12d`)+ tenant 批 products/client_rules/member_scopes(`2041e719`)+ /simplify 抽 `existing_tables` helper(`77ac23be`)· CI 6 闸全绿 + 12 表 prod 金丝雀全 PASS · companion 未动 · 收尾交接 `docs/refactor/b8-rls-HANDOFF-2026-06-25.md` §7.11~§7.15（§7.15=4 棒总览+标准施工 7 步配方+剩余域打法））
