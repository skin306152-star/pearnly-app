...
async def get_frontend_version():
    ...
    return {
        ...
        "release_notes": {
            "zh": "v118.35.0.8 · 老 trial 用户全部迁到 credits + trial 横幅彻底下线:\n• 6 个老 trial 用户 DB 迁移到 plan='credits' · trial_expires_at 清空 · 钱包余额 0 待充值\n• 顶部「7 天试用还剩 X 天 · 立即升级」横幅彻底下线 · renderTrialBanner 函数永久变 noop\n• 设置页:任何残留 plan='trial' 也走 credits 渲染分支 · 只显示「按量充值」卡 · 不再显示旧套餐文案",
            "th": "v118.35.0.8 · ผู้ใช้ทดลองเก่า 6 บัญชีย้ายไป credits + แบนเนอร์ทดลองปิดถาวร:\n• 6 บัญชีทดลองเดิม DB migrate ไป plan='credits' · เคลียร์ trial_expires_at · ยอดเริ่มที่ 0 รอเติม\n• แบนเนอร์ด้านบน 'ทดลอง 7 วันเหลือ X วัน · อัพเกรดเลย' ปิดถาวร · renderTrialBanner กลายเป็น noop\n• หน้าตั้งค่า: ถ้ายังมี plan='trial' ตกค้างก็แสดงการ์ดจ่ายตามใช้แทน · ไม่แสดงข้อความแพ็กเกจเก่า",
            "en": "v118.35.0.8 · 6 legacy trial users migrated to credits + trial banner fully retired:\n• 6 trial accounts DB-migrated to plan='credits' · trial_expires_at cleared · wallet starts at 0 awaiting top-up\n• Top banner '7-day trial · X days left · upgrade now' permanently retired · renderTrialBanner now a noop\n• Settings: any straggler plan='trial' also routes through credits card · no more old plan copy",
            "ja": "v118.35.0.8 · 旧 trial ユーザー 6 名を credits に移行 + trial バナー完全廃止:\n• 6 つの旧トライアルアカウントを DB マイグレーション · plan='credits' · trial_expires_at クリア · ウォレット残高 0 から\n• 上部「7 日間トライアル残り X 日 · 今すぐアップグレード」バナーを完全廃止 · renderTrialBanner は noop に\n• 設定画面: 残留 plan='trial' があっても credits カードを表示 · 旧プラン文言は出さない",
