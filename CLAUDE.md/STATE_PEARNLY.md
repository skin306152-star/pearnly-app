...
- **模块/测试**:src/home **38**(+line-email-modal/change-password/session-heartbeat WB) · *_routes **36** · services **105**(+playwright_bootstrap +background_loops +static_assets +erp/auto_push WA)· unit **1661** · integration **46**(WC-D3 +signup +VAT excel +bank-recon +通用导入器映射 契约)· E2E **17** · home.js silent **0**。
