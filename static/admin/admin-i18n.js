...
(function () {
    window.ADMIN_I18N = {
        zh: {
            ...
            'cost-month': '本月花费',
            'cost-total': '累计花费',
            'cost-engines': '内部识别成本构成(本月)',
            'cost-engines-sub': '各识别管道的内部成本 · 非用户可选引擎',
        ...
        th: {
            ...
            'cost-month': 'เดือนนี้',
            'cost-total': 'ยอดรวม',
            'cost-engines': 'โครงสร้างต้นทุนการรู้จำภายใน (เดือนนี้)',
            'cost-engines-sub': 'ต้นทุนภายในของแต่ละสายการรู้จำ · ไม่ใช่เอนจินที่ผู้ใช้เลือก',
