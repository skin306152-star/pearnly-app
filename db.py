...
# REFACTOR-B2 · LINE 账号合并 re-export(已抽到 services/auth/account_merge · 调用点零改动)
from services.auth.account_merge import (
...
# REFACTOR-B2 · Credits schema/seed re-export(已抽到 services/billing/credits_schema ·
# 启动期 db.ensure_credits_tables 调用点零改 · auth_signup 三路径 db.ensure_tenant_credits 零改)
