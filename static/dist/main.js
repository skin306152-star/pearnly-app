...
`;we("pearnly-confirm-modal",ko);we("confirm-modal",xo);window.pearnlyConfirm=function(e,n){return new Promise(function(a){const o=document.getElementById("pearnly-confirm-modal"),s=document.getElementById("pearnly-confirm-title"),i=document.getElementById("pearnly-confirm-msg"),r=document.getElementById("pearnly-confirm-ok"),c=document.getElementById("pearnly-confirm-cancel"),l=document.getElementById("pearnly-confirm-close");if(!o||!i||!r||!c){a(window.confirm(e));return}s&&(s.textContent=n||(typeof t=="function"?t("confirm-default-title"):"Please confirm")),i.textContent=e||"",o.style.display="flex";function p(v){o.style.display="none",r.removeEventListener("click",f),c.removeEventListener("click",d),l&&l.removeEventListener("click",d),o.removeEventListener("click",u),document.removeEventListener("keydown",m),a(v)}function f(){p(!0)}function d(){p(!1)}function u(v){v.target===o&&p(!1)}function m(v){v.key==="Escape"?p(!1):v.key==="Enter"&&p(!0)}r.addEventListener("click",f),c.addEventListener("click",d),l&&l.addEventListener("click",d),o.addEventListener("click",u),document.addEventListener("keydown",m),setTimeout(function(){try{c.focus()}catch{}},50)})};const _o=`
        <!-- 顶部 page head -->
        <div class="page-head-clean">
            <div class="page-head-icon">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
...
`))}</pre>
    ...
    `,s?c.querySelectorAll("[data-field]").forEach(f=>{f.addEventListener("input",onFieldEdit)}):c.querySelectorAll("[data-field]").forEach(f=>{f.setAttribute("readonly","readonly")}),document.getElementById("drawer-mask").classList.add("show"),document.getElementById("drawer").classList.add("show"),injectOcrPushButton(),typeof window.bindDrawerClient=="function"){const f=n._historyId||n.history_id||null;window.bindDrawerClient(f,n.client_id||null)}typeof window.fillCategoryDatalist=="function"&&window.fillCategoryDatalist(),setTimeout(()=>{const f=document.getElementById("drawer-cat-input");f&&!f.value&&!f.readOnly&&f.focus()},80)}function Yo(e){return e?`<span class="wht-badge">${escapeHtml(e)}%</span>`:""}function xe(e,n,a,o,s,i,r){const c=_results[_drawerIdx],l=c&&c.edits[e]!==void 0?c.edits[e]:a,p=c&&c.edits[e]!==void 0&&c.edits[e]!==a,f=escapeHtml(l??""),d=s?"":"readonly",u=o==="textarea"?`<textarea data-field="${e}" rows="2">${f}</textarea>`:`<input type="text" data-field="${e}" value="${f}">`;return`
...
`;(function(){const e=document.getElementById("page-history");if(!(!e||e.dataset.wbInjected==="1")){e.innerHTML=ss,e.dataset.wbInjected="1";try{const n=window._currentLang||localStorage.getItem("mrpilot_lang")||"th",a=window.I18N;a&&a[n]&&(e.querySelectorAll("[data-i18n]").forEach(o=>{const s=o.getAttribute("data-i18n");a[n][s]&&(o.textContent=a[n][s])}),e.querySelectorAll("[data-i18n-placeholder]").forEach(o=>{const s=o.getAttribute("data-i18n-placeholder");a[n][s]&&(o.placeholder=a[n][s])}))}catch{}}})();function un(){const e=document.getElementById("history-batch-bar"),n=document.getElementById("history-batch-count"),a=document.getElementById("history-check-all");if(!e||!n)return;const o=_historySelected.size;if(o>0?(e.style.display="",n.textContent=t("history-batch-count",{n:o})):e.style.display="none",a){const s=_historyState.items||[];if(s.length===0)a.checked=!1,a.indeterminate=!1;else{const i=s.filter(r=>_historySelected.has(r.id)).length;a.checked=i===s.length,a.indeterminate=i>0&&i<s.length}}}function is(){_historySelected.clear(),un()}async function fn(){if(!_userInfo){setTimeout(()=>fn(),300);return}const e=document.getElementById("history-free-block"),n=document.getElementById("history-main"),a=document.getElementById("history-empty");if(!e||!n||!a){console.warn("[History] container missing");return}if(!_userInfo.can_view_history){e.style.display="",n.style.display="none",a.style.display="none";return}e.style.display="none",_historyState.loading=!0;try{const o=_historyState.page*_historyState.pageSize,s=new URLSearchParams({limit:_historyState.pageSize,offset:o});_historyState.keyword&&s.set("keyword",_historyState.keyword);const i=typeof window.getCurrentClientId=="function"?window.getCurrentClientId():null;i&&s.set("client_id",String(i));const r=await fetch(`/api/history?${s}`,{headers:{Authorization:"Bearer "+token}});if(r.status===401){localStorage.removeItem("mrpilot_token");const p=await r.json().catch(()=>({}));if((typeof p.detail=="string"?p.detail:p.detail&&p.detail.code||"")==="auth.session_revoked"){_showSessionRevokedModal();return}window.location.href="/";return}const c=await r.json();_historyState.items=c.items||[],_historyState.total=c.total||0;const l=new Set(_historyState.items.map(p=>p.id));for(const p of Array.from(_historySelected))l.has(p)||_historySelected.delete(p);xa()}catch(o){console.error("load history failed",o)}finally{_historyState.loading=!1}}function xa(){const e=document.getElementById("history-main"),n=document.getElementById("history-empty"),a=_historyState.items,o=document.getElementById("history-search-matches");if(o&&(o.textContent=_historyState.keyword?t("search-matches",{n:_historyState.total}):""),a.length===0&&_historyState.total===0&&!_historyState.keyword){e.style.display="none",n.style.display="";return}e.style.display="",n.style.display="none";let s=0;a.forEach(p=>{p.confidence==="high"&&s++});const i=a.length>0?Math.round(s/a.length*100):0;document.getElementById("history-stats").innerHTML=`
    ...
    `;const r=document.getElementById("history-tbody");a.length===0?r.innerHTML=`<div class="history-row-empty">${escapeHtml(t("history-empty-title"))}</div>`:r.innerHTML=a.map(p=>{const f=new Date(p.created_at),d=String(f.getMonth()+1).padStart(2,"0"),u=String(f.getDate()).padStart(2,"0"),m=String(f.getHours()).padStart(2,"0"),v=String(f.getMinutes()).padStart(2,"0"),_=`${d}-${u} ${m}:${v}`,y=escapeHtml(p.filename||""),b=y.length>50?y.substring(0,50)+"…":y,h=p.invoice_no?escapeHtml(p.invoice_no):b,L=[];p.seller_name&&L.push(escapeHtml(p.seller_name)),p.invoice_no&&p.filename&&L.push(b);const g=L.join(" · ")||"-",x=p.category_tag?`<span class="history-badge category">${escapeHtml(p.category_tag)}</span>`:"",B=p.source_total&&p.source_total>1?`<span class="history-badge multi">${escapeHtml(t("invoice-part-of",{i:p.source_index||1,n:p.source_total}))}</span>`:"",E=p.total_amount!==null&&p.total_amount!==void 0?Number(p.total_amount).toLocaleString(void 0,{minimumFractionDigits:2,maximumFractionDigits:2}):'<span class="history-cell-amount-empty">—</span>',w=[];(p.total_amount===null||p.total_amount===void 0)&&w.push(t("field-amount")),p.invoice_no||w.push(t("field-invoice-no")),p.invoice_date||w.push(t("field-invoice-date")),p.seller_name||w.push(t("field-seller-name")),w.length>0&&`${escapeHtml(p.id)}${escapeHtml(t("history-needs-review-tip")+" · "+w.join(" · "))}${escapeHtml(t("history-needs-review-tip"))}${svgIcon("alert",14)}`,p.edited&&`${escapeHtml(t("history-edited",{n:p.edit_count||1}))}`;const I=p.smart_assigned_flag?`<span class="history-badge smart-assigned" title="${escapeHtml(t("history-smart-assigned"))}">${svgIcon("sparkle",11)}</span>`:"",S=p.confidence==="high"?"high":p.confidence==="medium"?"mid":"low",T=p.confidence==="high"?t("conf-high"):p.confidence==="medium"?t("conf-medium"):t("conf-low"),C=`<span class="history-badge conf-${S}">${escapeHtml(T)}</span>`;let k="";const M=p.source||"manual";return M==="email"?k=`<span class="history-badge source source-email" title="${escapeHtml(t("history-source-email"))}">${svgIcon("mail",11)}<span>${escapeHtml(t("history-source-email"))}</span></span>`:M==="folder"?k=`<span class="history-badge source source-folder" title="${escapeHtml(t("history-source-folder"))}">${svgIcon("folder",11)}<span>${escapeHtml(t("history-source-folder"))}</span></span>`:M==="api"&&(k=`<span class="history-badge source source-api" title="${escapeHtml(t("history-source-api"))}">${svgIcon("api",11)}<span>${escapeHtml(t("history-source-api"))}</span></span>`),`
                <div class="history-row" data-hid="${escapeHtml(p.id)}">
                    ...
                    <div class="history-cell-file">
                        <div class="history-cell-filename">${h} ${x} ${B} ${k} ${I}</div>
    ...
    `,r.style.top=a.bottom+4+"px",r.style.left=a.right-160+"px",document.body.appendChild(r);const c=()=>{r.remove(),document.removeEventListener("click",l,!0)},l=p=>{!r.contains(p.target)&&p.target!==n&&c()};setTimeout(()=>document.addEventListener("click",l,!0),0),r.addEventListener("click",async p=>{const f=p.target.closest("[data-act]");if(!f||f.disabled)return;const d=f.dataset.act;if(c(),d==="copy-invno"){if(!s)return;try{await navigator.clipboard.writeText(s),showToast(t("history-copy-invno-ok",{no:s}),"success")}catch{try{const m=document.createElement("textarea");m.value=s,m.style.position="fixed",m.style.opacity="0",document.body.appendChild(m),m.select(),document.execCommand("copy"),document.body.removeChild(m),showToast(t("history-copy-invno-ok",{no:s}),"success")}catch{showToast(t("history-copy-invno-fail"),"error")}}}else if(d==="download-pdf"){const u=showToast(t("history-download-pdf-loading"),"loading",0);try{const m=await fetch(`/api/history/${encodeURIComponent(e)}/pdf`,{headers:{Authorization:"Bearer "+token}});if(!m.ok)throw new Error("download failed");const v=await m.blob(),_=URL.createObjectURL(v),y=document.createElement("a");y.href=_,y.download=o&&o.filename?o.filename.endsWith(".pdf")?o.filename:o.filename+".pdf":"invoice.pdf",document.body.appendChild(y),y.click(),document.body.removeChild(y),setTimeout(()=>URL.revokeObjectURL(_),5e3),u(),showToast(t("history-download-pdf-ok"),"success")}catch{u(),showToast(t("history-download-pdf-fail"),"error")}}else if(d==="delete"){if(!await showConfirm(t("history-confirm-delete"),{danger:!0}))return;try{if(!(await fetch(`/api/history/${encodeURIComponent(e)}`,{method:"DELETE",headers:{Authorization:"Bearer "+token}})).ok)throw new Error;showAlert("info",t("history-delete-ok")),setTimeout(hideAlerts,1500),loadHistoryPage()}catch{showAlert("error",t("history-delete-fail"))}}})}(function(){document.addEventListener("click",r=>{const c=r.target.closest(".history-row"),l=r.target.closest("[data-hmenu]");if(l){r.stopPropagation(),us(l.dataset.hmenu,l);return}const p=r.target.closest("[data-review]");if(p){r.stopPropagation(),At(p.dataset.review);return}const f=r.target.closest("[data-fill-amount]");if(f){r.stopPropagation(),rs(f.dataset.fillAmount);return}r.target.closest(".history-row-check")||r.target.closest(".history-cell-check")||c&&!r.target.closest("[data-hmenu]")&&At(c.dataset.hid)});const n=document.getElementById("history-tbody");n&&n.addEventListener("change",r=>{const c=r.target.closest(".history-row-check");if(!c)return;const l=c.dataset.hid;c.checked?_historySelected.add(l):_historySelected.delete(l),updateHistoryBatchBar()});const a=document.getElementById("history-check-all");a&&a.addEventListener("change",r=>{const c=r.target.checked;for(const l of _historyState.items)c?_historySelected.add(l.id):_historySelected.delete(l.id);document.querySelectorAll(".history-row-check").forEach(l=>{l.checked=c}),updateHistoryBatchBar()});const o=document.getElementById("history-batch-cancel");o&&o.addEventListener("click",()=>{clearHistorySelection(),document.querySelectorAll(".history-row-check").forEach(r=>{r.checked=!1})});const s=document.getElementById("history-batch-delete");s&&s.addEventListener("click",async()=>{const r=_historySelected.size;if(r===0||!await showConfirm(t("history-batch-confirm",{n:r}),{danger:!0}))return;const l=Array.from(_historySelected);try{const p=await fetch("/api/history/batch-delete",{method:"POST",headers:{Authorization:"Bearer "+token,"Content-Type":"application/json"},body:JSON.stringify({ids:l})});if(!p.ok)throw new Error("batch delete failed");const f=await p.json();showToast(t("history-batch-done",{n:f.deleted||0}),"success"),clearHistorySelection(),loadHistoryPage()}catch(p){console.error("batch delete",p),showToast(t("history-batch-fail"),"error")}});let i=null;document.getElementById("history-search").addEventListener("input",r=>{const c=r.target.value;document.getElementById("history-search-clear").style.display=c?"":"none",clearTimeout(i),i=setTimeout(()=>{_historyState.keyword=c.trim(),_historyState.page=0,clearHistorySelection(),loadHistoryPage()},300)}),document.getElementById("history-search-clear").addEventListener("click",()=>{const r=document.getElementById("history-search");r.value="",_historyState.keyword="",_historyState.page=0,clearHistorySelection(),document.getElementById("history-search-clear").style.display="none",loadHistoryPage(),r.focus()}),document.getElementById("history-range").addEventListener("change",r=>{_historyState.range=parseInt(r.target.value,10),_historyState.page=0,clearHistorySelection(),loadHistoryPage()}),document.getElementById("history-prev").addEventListener("click",()=>{_historyState.page>0&&(_historyState.page--,clearHistorySelection(),loadHistoryPage())}),document.getElementById("history-next").addEventListener("click",()=>{(_historyState.page+1)*_historyState.pageSize<_historyState.total&&(_historyState.page++,clearHistorySelection(),loadHistoryPage())})})();window.openHistoryDrawer=At;const st=document.getElementById("drop-zone"),mn=document.getElementById("file-input");st.addEventListener("click",()=>mn.click());mn.addEventListener("change",e=>_a(e.target.files));["dragover","dragenter"].forEach(e=>{st.addEventListener(e,n=>{n.preventDefault(),st.classList.add("drag-over")})});["dragleave","drop"].forEach(e=>{st.addEventListener(e,n=>{n.preventDefault(),st.classList.remove("drag-over")})});st.addEventListener("drop",e=>{e.preventDefault(),_a(e.dataTransfer.files)});const fs=/\.(pdf|png|jpe?g|webp|tiff?|bmp|gif|xlsx?|xlsm|csv|tsv|docx?|txt)$/i;function an(e){return e.type&&e.type.startsWith("image/")||/\.(png|jpe?g|webp|tiff?|bmp|gif)$/i.test(e.name)}function ms(e){return e.type==="application/pdf"||/\.pdf$/i.test(e.name)}function vs(e){return ms(e)||an(e)||fs.test(e.name)}function _a(e){hideAlerts();const n=Array.from(e),a=n.filter(vs);a.length!==n.length&&showAlert("warn",t("alert-unsupported-format"));const o=a.filter(c=>!an(c)),s=a.filter(an),i=new Set(_selectedFiles.map(c=>c.name+"_"+c.size));for(const c of o){const l=c.name+"_"+c.size;i.has(l)||(_selectedFiles.push({file:c,name:c.name,size:c.size,status:"waiting",errorKey:null,errorParams:null}),i.add(l))}if(s.length>0)try{handleCameraImages(s,"gallery")}catch(c){console.error("[upload] image route failed",c)}const r=getMaxFiles();_selectedFiles.length>r&&(showAlert("warn",t("alert-file-count",{n:r})),_selectedFiles=_selectedFiles.slice(0,r)),Kt(),vn(),mn.value=""}let Tt=!1;function Kt(){const e=document.getElementById("file-list");if(!e)return;if(_selectedFiles.length===0){e.classList.remove("has-files"),e.innerHTML="";return}e.classList.add("has-files");const n=_selectedFiles.length,a=_selectedFiles.filter(d=>d.status==="processing"||d.status==="retrying").length,o=_selectedFiles.filter(d=>d.status==="success").length,s=_selectedFiles.filter(d=>d.status==="error").length;let i=`<span class="count">${escapeHtml(t("file-list-total",{n}))}</span>`;const r=[];a&&r.push(`<span style="color: var(--accent, #111111);">${a} ${escapeHtml(t("status-processing"))}</span>`),o&&r.push(`<span style="color: var(--success, #059669);">${o} ${escapeHtml(t("status-success"))}</span>`),s&&r.push(`<span style="color: var(--danger, #dc2626);">${s} ${escapeHtml(t("status-error"))}</span>`),r.length&&(i+=" · "+r.join(" · "));const c=Tt?t("file-list-collapse"):t("file-list-expand"),l=_selectedFiles.map((d,u)=>{let m=t("status-"+d.status);d.status==="retrying"&&(m=t("status-retrying")),d.status==="error"&&d.errorKey&&(m=t(d.errorKey,d.errorParams||{}));const v=d.status==="processing"||d.status==="retrying"?'<span class="spinner"></span>':"",_=d.status==="error"&&d.canRetry?`<button class="file-retry-btn" data-retry-idx="${u}" title="${escapeHtml(t("upload-retry-btn"))}">${svgIcon("refresh",12)}<span>${escapeHtml(t("upload-retry-btn"))}</span></button>`:"",y=d.status==="success"&&d.fromCache?`<span class="file-cache-badge">${svgIcon("cache",11)}<span>${escapeHtml(t("cache-hit-badge"))}</span></span>`:"";return`
            <li class="file-item">
                ...
                ${y}
                <span class="file-status ${d.status}">${v}${m}</span>
                ${_}
            </li>
        `}).join("");e.innerHTML=`
    ...
    `;const p=document.getElementById("file-list-toggle");p&&p.addEventListener("click",()=>{Tt=!Tt,Kt()});const f=document.getElementById("file-list-body");f&&!f.dataset.retryBound&&(f.dataset.retryBound="1",f.addEventListener("click",async d=>{const u=d.target.closest(".file-retry-btn");if(!u)return;const m=parseInt(u.dataset.retryIdx||"-1",10);if(m<0||m>=_selectedFiles.length)return;const v=_selectedFiles[m];!v||v.status!=="error"||typeof window._reprocessFile=="function"&&await window._reprocessFile(v,!0)}))}function vn(){const e=document.getElementById("btn-start"),n=document.getElementById("btn-clear"),a=document.getElementById("btn-export"),o=_selectedFiles.some(s=>s.status==="waiting");e.disabled=_selectedFiles.length===0||!o,n.disabled=_selectedFiles.length===0&&_results.length===0,a.disabled=_results.length===0}document.getElementById("btn-clear").addEventListener("click",()=>{_selectedFiles=[],_results=[],Kt(),renderResults(),vn(),hideAlerts()});window.renderFileList=Kt;window.updateStartButton=vn;const hs=`
    <div class="modal" style="max-width:420px;">
        <div class="modal-head">
...
`;we("camera-tips-modal",hs);(function(){const n=document.getElementById("upload-alt-row"),a=document.getElementById("gallery-input"),o=document.getElementById("camera-input");if(!n)return;n.style.display="";const s=document.getElementById("btn-scan-doc");s&&o&&(s.addEventListener("click",async()=>{!(localStorage.getItem("mrpilot_camera_tips_skip")==="1")&&!await bs()||o.click()}),o.addEventListener("change",async c=>{const l=Array.from(c.target.files||[]);if(c.target.value="",l.length!==0)for(const p of l)await on([p],"camera")}));const i=document.getElementById("btn-upload-pic");i&&a&&i.addEventListener("click",()=>a.click());const r=c=>async l=>{const p=Array.from(l.target.files||[]);if(l.target.value="",p.length===0)return;const f=p.filter(u=>u.type==="application/pdf"||/\.pdf$/i.test(u.name)),d=p.filter(u=>!f.includes(u));f.length>0&&await gs(f),d.length>0&&await on(d,c)};a&&a.addEventListener("change",r("gallery"))})();async function gs(e){for(const a of e)_selectedFiles.push({file:a,name:a.name,size:a.size,status:"waiting",errorKey:null,errorParams:null});const n=getMaxFiles();_selectedFiles.length>n&&(showAlert("warn",t("alert-file-count",{n})),_selectedFiles=_selectedFiles.slice(0,n)),renderFileList(),updateStartButton()}function bs(){return new Promise(e=>{const n=document.getElementById("camera-tips-modal"),a=document.getElementById("camera-tips-ok"),o=document.getElementById("camera-tips-cancel"),s=document.getElementById("camera-tips-skip");if(!n||!a){e(!0);return}s&&(s.checked=!1),n.style.display="flex";const i=c=>{n.style.display="none",s&&s.checked&&localStorage.setItem("mrpilot_camera_tips_skip","1"),a.onclick=null,o&&(o.onclick=null),n.onclick=null,document.removeEventListener("keydown",r),e(c)},r=c=>{c.key==="Escape"&&i(!1)};a.onclick=()=>i(!0),o&&(o.onclick=()=>i(!1)),n.onclick=c=>{c.target===n&&i(!1)},document.addEventListener("keydown",r),setTimeout(()=>a.focus(),50)})}async function jt(e){return new Promise(n=>{const a=new FileReader;a.onerror=()=>n({warnings:[],width:0,height:0,brightness:128}),a.onload=()=>{const o=new Image;o.onerror=()=>n({warnings:[],width:0,height:0,brightness:128}),o.onload=()=>{const s=[],i=o.naturalWidth,r=o.naturalHeight;(i<1e3||r<1e3)&&s.push("low_res");try{const c=document.createElement("canvas");c.width=64,c.height=64;const l=c.getContext("2d");l.drawImage(o,0,0,64,64);const p=l.getImageData(0,0,64,64).data;let f=0,d=0;for(let m=0;m<p.length;m+=4)f+=.299*p[m]+.587*p[m+1]+.114*p[m+2],d++;const u=d?f/d:128;u<70?s.push("too_dark"):u>235&&s.push("too_bright"),n({warnings:s,width:i,height:r,brightness:u})}catch{n({warnings:s,width:i,height:r,brightness:128})}},o.src=a.result},a.readAsDataURL(e)})}let Le=[],Ve=null;async function on(e,n){if(hideAlerts(),!(!e||e.length===0)){var a=typeof window.getOcrDocumentMode=="function"?window.getOcrDocumentMode():"invoice";if(a==="thai_id_card"){for(const s of e)_selectedFiles.push({file:s,name:s.name,size:s.size,status:"waiting",errorKey:null,errorParams:null});const o=getMaxFiles();_selectedFiles.length>o&&(showAlert("warn",t("alert-file-count",{n:o})),_selectedFiles=_selectedFiles.slice(0,o)),renderFileList(),updateStartButton();return}if(typeof window.jspdf>"u"||!window.jspdf.jsPDF){showToast(t("camera-loading"),"info");for(let o=0;o<30&&(await new Promise(s=>setTimeout(s,100)),!(window.jspdf&&window.jspdf.jsPDF));o++);if(!window.jspdf||!window.jspdf.jsPDF){showToast(t("camera-lib-fail"),"error");return}}if(n==="camera"&&e.length===1){const o=e[0];let s={};try{s=await jt(o)}catch{}Le.push({file:o,quality:s}),Ve="camera",Qe();return}if(n==="gallery"&&(e.length>=2||Le.length>0)){for(const o of e){let s={};try{s=await jt(o)}catch{}Le.push({file:o,quality:s})}Ve="gallery",Qe();return}await Ea(e)}}async function ys(e){const n=new Set;for(const o of e)try{((await jt(o)).warnings||[]).forEach(i=>n.add(i))}catch{}try{const o=await Ba(e);o&&_selectedFiles.push({file:o,name:o.name,size:o.size,status:"waiting",errorKey:null,errorParams:null})}catch(o){console.error("[camera] convert failed",o),showToast(t("camera-convert-fail"),"error");return}const a=getMaxFiles();_selectedFiles.length>a&&(showAlert("warn",t("alert-file-count",{n:a})),_selectedFiles=_selectedFiles.slice(0,a)),renderFileList(),updateStartButton(),showToast(t("camera-added-merged",{n:e.length}),"success"),n.size>0&&setTimeout(()=>{n.has("too_dark")?showToast(t("camera-quality-dark"),"warn"):n.has("low_res")?showToast(t("camera-quality-lowres"),"warn"):n.has("too_bright")&&showToast(t("camera-quality-overexposed"),"warn")},1e3)}function Qe(){let e=document.getElementById("camera-buffer-bar");if(Le.length===0){e&&e.remove(),Ve=null;return}e||(e=document.createElement("div"),e.id="camera-buffer-bar",e.className="camera-buffer-bar",document.body.appendChild(e));const n=Le.length,a=n>=2,o=Ve==="gallery",s=o?t("camera-buffer-more-gallery"):t("camera-buffer-more");let i;a?o?i=`
    ...
    `;we("page-test-center",Ss);(function(){const e="v118.28.5",n="pearnly_tc_results_"+e,a=[{id:"A1",group:"A · 异常栏 page-head(BUG1)",desc:"手机宽度进异常栏 · 标题「异常栏」横排正常 · 不再每字一行"},{id:"A2",group:"A · 异常栏 page-head(BUG1)",desc:"副标题「所有被规则拦截的单据集中复核…」也横排正常 · 不竖排"},{id:"A3",group:"A · 异常栏 page-head(BUG1)",desc:"客户筛选下拉 + 刷新按钮换到新一行 · 不抢标题宽度"},{id:"B1",group:"B · 客户管理 page-head(BUG2)",desc:"手机宽度进客户管理 · 标题「客户管理」横排正常"},{id:"B2",group:"B · 客户管理 page-head(BUG2)",desc:"副标题「为每家客户单独归档发票…」横排正常 · 不竖排"},{id:"B3",group:"B · 客户管理 page-head(BUG2)",desc:"「+ 新建客户」按钮换到新一行 · 不挤标题"},{id:"C1",group:"C · 客户卡片(BUG3)",desc:"客户卡片「编辑 / 导出本月」按钮文字清晰 · 不被截断"},{id:"D1",group:"D · 历史表头(BUG4)",desc:"手机宽度进单据记录 · 表头「文件·发票号·供应商」/「金额」单行 · 不竖排"},{id:"D2",group:"D · 历史表头(BUG4)",desc:"行内 INV-TH-202605-1006 这种长发票号正常单行展示 · 不一字一行"},{id:"E1",group:"E · 对账切换器(BUG6)",desc:"手机宽度进对账中心 · 顶栏点「全部客户」chip · 下拉从右上角向下展开 · 右对齐 · 不贴左屏边"},{id:"E2",group:"E · 对账切换器(BUG6)",desc:"下拉宽度自适应屏幕 · 不超出屏幕右边"},{id:"F1",group:"F · 通用设置回归",desc:"设置 → 个人资料 · 没有「界面语言」4 按钮卡"},{id:"F2",group:"F · 通用设置回归",desc:"左侧 nav 顺序:账户 / 公司 / 工作流 / 系统 / 关于"},{id:"F3",group:"F · 通用设置回归",desc:"系统 → 通用设置 · 4 行下拉(语言/时区/日期/数字)· 改语言立即切语言 · 改其他保存后 F5 仍保留"},{id:"G1",group:"G · 移动端 settings(回归)",desc:"手机宽度设置 tabs 不重叠 · 按分组分行 · chip 风格"},{id:"H1",group:"H · 回归",desc:"OCR 上传识别 / 客户管理 / 异常栏 / 对账中心 / 测试中心 全部仍工作"},{id:"H2",group:"H · 回归",desc:"4 语切换没新增异常(测试中心异常日志「API 失败」过滤无新条目)"},{id:"I1",group:"I · 三档移动 viewport",desc:"iPhone SE 375 · 上述 BUG 1-6 都修了"},{id:"I2",group:"I · 三档移动 viewport",desc:"Galaxy S 360 · 上述 BUG 1-6 都修了"},{id:"I3",group:"I · 三档移动 viewport",desc:"iPhone 12 Pro 414 · 上述 BUG 1-6 都修了"}];let o={},s="all",i=!1,r=!1;function c(A,H,P){let F=typeof t=="function"?t(A):null;return(!F||F===A)&&(F=H),P&&Object.keys(P).forEach(function(G){F=String(F).replace("{"+G+"}",String(P[G]))}),F}function l(){try{const A=localStorage.getItem(n);o=A?JSON.parse(A):{},(typeof o!="object"||!o)&&(o={})}catch{o={}}}function p(){try{localStorage.setItem(n,JSON.stringify(o))}catch{}}function f(A){const H=new Date(A),P=function(F){return F<10?"0"+F:""+F};return P(H.getHours())+":"+P(H.getMinutes())+":"+P(H.getSeconds())}function d(A){return String(A??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function u(A,H){try{typeof showToast=="function"?showToast(A,H||"info"):alert(A)}catch{}}function m(A){try{navigator.clipboard&&navigator.clipboard.writeText?navigator.clipboard.writeText(A).then(function(){u(c("tc-toast-copied","已复制到剪贴板"),"success")}).catch(function(){v(A)}):v(A)}catch{v(A)}}function v(A){try{const H=document.createElement("textarea");H.value=A,H.style.position="fixed",H.style.opacity="0",document.body.appendChild(H),H.select();const P=document.execCommand("copy");document.body.removeChild(H),u(P?c("tc-toast-copied","已复制"):c("tc-toast-copy-fail","复制失败"),P?"success":"error")}catch{u(c("tc-toast-copy-fail","复制失败"),"error")}}function _(){const A=document.getElementById("tc-account-chip"),H=document.getElementById("tc-progress-chip");if(A&&(A.textContent=_userInfo&&(_userInfo.email||_userInfo.username)||"—"),H){const P=a.length,F=a.filter(function(G){return o[G.id]}).length;H.textContent=F+" / "+P}}function y(){const A=document.getElementById("tc-checklist-body");if(!A)return;const H={};a.forEach(function(F){H[F.group]||(H[F.group]=[]),H[F.group].push(F)});const P=[];Object.keys(H).forEach(function(F){P.push('<div class="tc-checklist-group">'),P.push('<div class="tc-checklist-group-title">'+d(F)+"</div>"),H[F].forEach(function(G){const O=o[G.id]||"",ee=O?"is-"+O:"";P.push('<div class="tc-check-item '+ee+'" data-id="'+d(G.id)+'"><div class="tc-check-id">'+d(G.id)+'</div><div class="tc-check-desc">'+d(G.desc)+'</div><div class="tc-check-actions">'+b(G.id,"pass",O)+b(G.id,"fail",O)+b(G.id,"skip",O)+"</div></div>")}),P.push("</div>")}),A.innerHTML=P.join("")}function b(A,H,P){const F=P===H,G={pass:'<svg viewBox="0 0 20 20" fill="none" stroke="currentColor" stroke-width="2.4" stroke-linecap="round" stroke-linejoin="round"><polyline points="4,11 8,15 16,5"/></svg>',fail:'<svg viewBox="0 0 20 20" fill="none" stroke="currentColor" stroke-width="2.4" stroke-linecap="round" stroke-linejoin="round"><line x1="5" y1="5" x2="15" y2="15"/><line x1="15" y1="5" x2="5" y2="15"/></svg>',skip:'<svg viewBox="0 0 20 20" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"><line x1="5" y1="10" x2="15" y2="10"/></svg>'},O={pass:c("tc-status-pass","通过"),fail:c("tc-status-fail","失败"),skip:c("tc-status-skip","跳过")};return'<button type="button" class="tc-status-btn '+(F?"is-active "+H:"")+'" data-id="'+d(A)+'" data-kind="'+H+'" title="'+d(O[H])+'">'+G[H]+"</button>"}function h(A){return s==="all"?!0:s==="js_error"?A.type==="js_error"||A.type==="promise_error":s==="api"?A.type==="api_error"||A.type==="api_fail":s==="api_slow"?A.type==="api_slow":s==="console"?A.type==="console_error"||A.type==="console_warn":!0}function L(){const A=document.getElementById("tc-logs-body"),H=document.getElementById("tc-logs-count");if(!A)return;const P=(window._pearnlyTcLogs||[]).slice().reverse(),F=P.filter(h);if(H&&(H.textContent=String(P.length)),F.length===0){A.innerHTML='<div class="tc-logs-empty">'+d(c("tc-logs-empty","暂无异常"))+"</div>";return}const G=F.slice(0,100).map(function(O){const ee=typeof O.detail=="object"?JSON.stringify(O.detail,null,2):String(O.detail||"");return'<div class="tc-log-item t-'+d(O.type)+'" data-ts="'+O.ts+'"><span class="tc-log-time">'+f(O.ts)+'</span><span class="tc-log-type">'+d(O.type)+'</span><div class="tc-log-summary">'+d(O.summary)+'<div class="tc-log-detail">'+d(ee)+"</div></div></div>"}).join("");A.innerHTML=G,document.querySelectorAll("#tc-logs-filter .tc-filter-chip").forEach(function(O){O.classList.toggle("active",O.getAttribute("data-filter")===s)})}function g(){r||(r=!0,setTimeout(function(){r=!1,currentRoute==="test-center"&&document.getElementById("page-test-center")&&document.getElementById("page-test-center").classList.contains("active")&&L(),x()},200))}window._tcOnNewLog=g;function x(){const A=document.getElementById("nav-test-badge");if(!A)return;const H=(window._pearnlyTcLogs||[]).filter(function(P){return P.type==="js_error"||P.type==="promise_error"||P.type==="api_error"||P.type==="api_fail"||P.type==="console_error"}).length;H>0?(A.style.display="",A.textContent=H>99?"99+":String(H)):A.style.display="none"}function B(){_(),y(),L(),x()}function E(){const A=[],H=new Date,P=_userInfo&&(_userInfo.email||_userInfo.username)||"—";A.push("# Pearnly "+e+" 测试结果"),A.push("- 账号:"+P),A.push("- 时间:"+H.toISOString().replace("T"," ").slice(0,19));const F=a.length,G=a.filter(function(re){return o[re.id]==="pass"}).length,O=a.filter(function(re){return o[re.id]==="fail"}).length,ee=a.filter(function(re){return o[re.id]==="skip"}).length,de=F-G-O-ee;A.push("- 进度:"+(G+O+ee)+" / "+F+" · ✅ "+G+" · ❌ "+O+" · ⏭ "+ee+" · 未测 "+de),A.push(""),A.push("| ID | 描述 | 状态 |"),A.push("|---|---|---|"),a.forEach(function(re){const ve=o[re.id],he=ve==="pass"?"✅":ve==="fail"?"❌":ve==="skip"?"⏭":"⬜";A.push("| "+re.id+" | "+re.desc.replace(/\|/g,"\\|")+" | "+he+" |")});const me=a.filter(function(re){return o[re.id]==="fail"});me.length>0&&(A.push(""),A.push("## ❌ 失败项"),me.forEach(function(re){A.push("- **"+re.id+"** · "+re.desc)}));const ue=(window._pearnlyTcLogs||[]).slice(-30).reverse();return ue.length>0&&(A.push(""),A.push("## 🔴 异常日志(最近 "+ue.length+" 条)"),ue.forEach(function(re){if(A.push("- `"+f(re.ts)+"` · **"+re.type+"** · "+re.summary),re.detail){let ve;try{ve=JSON.stringify(re.detail)}catch{ve=String(re.detail)}ve&&ve!=="{}"&&A.push("  - "+ve.slice(0,600))}})),A.join(`
`)}function w(A){const H=(window._pearnlyTcLogs||[]).slice(-30).reverse();if(H.length===0)return"(暂无异常日志)";const P=["# Pearnly 异常日志(最近 "+H.length+" 条)"],F=_userInfo&&(_userInfo.email||_userInfo.username)||"—";return P.push("- 账号:"+F),P.push("- 当前页:"+(currentRoute||"?")),P.push("- UA:"+navigator.userAgent),P.push(""),H.forEach(function(G){if(P.push("## `"+f(G.ts)+"` · "+G.type),P.push("- "+G.summary),G.detail){P.push("```");try{P.push(JSON.stringify(G.detail,null,2).slice(0,2e3))}catch{P.push(String(G.detail).slice(0,2e3))}P.push("```")}}),P.join(`
`)}function I(){const A=Date.now();fetch("/api/health").then(function(H){const P=Date.now()-A;H.ok?u(c("tc-toast-health-ok","后端健康 ✓ {ms}ms",{ms:P}),"success"):u(c("tc-toast-health-fail","后端无响应")+" ("+H.status+")","error")}).catch(function(){u(c("tc-toast-health-fail","后端无响应"),"error")})}function S(){try{localStorage.removeItem(n),localStorage.removeItem("pearnly_current_client_id"),o={},(window._pearnlyTcLogs||[]).length=0,s="all",window.setCurrentClientId}catch{}B(),u(c("tc-toast-cleared","session 状态已清空"),"success")}function T(){try{fetch("/api/clients",{headers:{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||"")}}).then(function(A){return A.json()}).then(function(A){window._clientsCache=A.clients||[],typeof window._refreshClientSwitcher=="function"&&window._refreshClientSwitcher(),typeof window._refreshExcClientFilter=="function"&&window._refreshExcClientFilter(),u("客户缓存已刷新 · "+(A.clients||[]).length+" 个客户","success")}).catch(function(){u("刷新失败","error")})}catch{}}function C(){if(i||!document.getElementById("page-test-center"))return;i=!0;const H=document.getElementById("tc-checklist-body");H&&H.addEventListener("click",function(ve){const he=ve.target.closest(".tc-status-btn");if(!he)return;const D=he.getAttribute("data-id"),z=he.getAttribute("data-kind");!D||!z||(o[D]===z?delete o[D]:o[D]=z,p(),y(),_())});const P=document.getElementById("tc-btn-reset-checklist");P&&P.addEventListener("click",function(){o={},p(),y(),_()});const F=document.getElementById("tc-btn-copy-all");F&&F.addEventListener("click",function(){m(E())});const G=document.getElementById("tc-btn-copy-logs");G&&G.addEventListener("click",function(){m(w())});const O=document.getElementById("tc-btn-clear-logs");O&&O.addEventListener("click",function(){(window._pearnlyTcLogs||[]).length=0,L(),x()});const ee=document.getElementById("tc-logs-filter");ee&&ee.addEventListener("click",function(ve){const he=ve.target.closest(".tc-filter-chip");he&&(s=he.getAttribute("data-filter")||"all",L())});const de=document.getElementById("tc-logs-body");de&&de.addEventListener("click",function(ve){const he=ve.target.closest(".tc-log-item");he&&he.classList.toggle("expanded")});const me=document.getElementById("tc-tool-health");me&&me.addEventListener("click",I);const ue=document.getElementById("tc-tool-clear-session");ue&&ue.addEventListener("click",S);const re=document.getElementById("tc-tool-reload-clients");re&&re.addEventListener("click",T)}function k(){}window._tcApplyVisibility=k;let M=0;const $=setInterval(function(){M++,_userInfo&&clearInterval($),M>60&&clearInterval($)},500);window.loadTestCenterPage=function(){l(),C(),B()},typeof window.subscribeI18n=="function"&&window.subscribeI18n("test-center",function(){x(),currentRoute==="test-center"&&document.getElementById("page-test-center")&&document.getElementById("page-test-center").classList.contains("active")&&B()})})();(function(){const e="pearnly_active_workspace_client_id",n="pearnly_work_mode";function a(h,L){if(typeof window.t=="function"){const g=window.t(h);if(g&&g!==h)return g}return L}function o(){const h=window._userInfo||{},L=String(h.role||"").toLowerCase(),g=String(h.tenant_role||"").toLowerCase();return h.is_super_admin===!0||h.is_owner===!0||L==="owner"||L==="admin"||g==="owner"||g==="admin"}function s(){return localStorage.getItem(n)==="client"?"client":"personal"}function i(){const h=localStorage.getItem(e);if(!h||h==="null"||h==="0"||h==="")return null;const L=parseInt(h,10);return isNaN(L)?null:L}function r(h){try{window.dispatchEvent(new CustomEvent("pearnly:workspace-changed",{detail:{id:h,mode:s()}}))}catch{}}function c(h){const L=i();h==null||h===0?localStorage.removeItem(e):(localStorage.setItem(e,String(h)),localStorage.setItem(n,"client")),String(L)!==String(h)&&r(h)}function l(){const h=i();localStorage.setItem(n,"personal"),localStorage.removeItem(e),h!=null&&r(null)}async function p(){try{const h=window.apiGet;if(typeof h!="function")return[];const L=await h("/api/workspace/clients");return L&&(L.clients||L.items)||[]}catch{return[]}}async function f(h){if(s()==="client"&&i()!=null)return typeof h=="function"&&h(),!0;const L=a("ws-need-client","这个功能需要先选择工作空间"),g=a("ws-btn-pick","选择工作空间"),x=a("ws-btn-cancel","取消");return typeof window.showConfirm=="function"?await window.showConfirm(L,{okText:g,cancelText:x})&&d(h):window.confirm(L+`

[`+g+" / "+x+"]")&&d(h),!1}async function d(h){const L=await p();if(typeof h=="function"&&s()!=="personal"&&L.length===1){c(Number(L[0].id)),h();return}if(typeof window.openWorkspaceChooserUI=="function"){window.openWorkspaceChooserUI({clients:L,canCreate:o(),active:i(),onPersonal:l,onPick:function(g){c(Number(g)),typeof h=="function"&&h()},emptyHint:L.length?null:o()?a("ws-empty-owner","还没有工作空间。创建一个公司后,上传、对账和 ERP 推送都会归属到该公司。"):a("ws-empty-employee","你还没有可用的工作空间,请联系管理员分配。")});return}if(!L.length){const g=o()?a("ws-empty-owner","还没有工作空间。创建一个公司后,上传、对账和 ERP 推送都会归属到该公司。"):a("ws-empty-employee","你还没有可用的工作空间,请联系管理员分配。");typeof window.showToast=="function"&&window.showToast(g,"info")}}function u(h){const L=h||document.getElementById("workspace-switcher-root");if(!L)return;const g=s(),x=i();let B,E;if(g==="client"&&x!=null){const S=(window._workspaceClientsCache||[]).find(T=>Number(T.id)===Number(x));B=v("building"),E=S?S.name:a("ws-current-label","当前工作空间")}else B=v("user"),E=a("ws-personal","个人事务");L.innerHTML='<button class="ws-ctrl-btn" id="ws-ctrl-btn" type="button">'+B+'<span class="ws-ctrl-label">'+m(E)+"</span></button>";const w=L.querySelector("#ws-ctrl-btn");w&&w.addEventListener("click",()=>d(null))}function m(h){return String(h??"").replace(/[&<>"']/g,function(L){return{"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"}[L]})}function v(h){const L='<svg class="ws-ic" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">';return h==="building"?L+'<rect x="2" y="7" width="20" height="14" rx="2"/><path d="M16 21V5a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v16"/></svg>':L+'<path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/></svg>'}function _(h){h=h||{};const L=h.clients||[],g=h.active,x=document.getElementById("ws-modal");x&&x.remove();const B=document.createElement("div");B.id="ws-modal",B.className="ws-modal";const w='<button type="button" class="ws-modal-item'+(s()==="personal"||g==null?" active":"")+'" data-ws-personal="1"><span class="ws-modal-item-ic">'+v("user")+'</span><span class="ws-modal-item-text" style="display:flex;flex-direction:column;align-items:flex-start;min-width:0;"><span class="ws-modal-item-name">'+m(a("ws-personal","个人事务"))+'</span><span class="ws-modal-item-desc" style="font-size:11px;color:#6b7280;font-weight:400;margin-top:2px;line-height:1.35;white-space:normal;">'+m(a("ws-personal-desc","用于临时识别、测试或处理不归属任何公司的文件。"))+"</span></span></button>";let I="";if(L.length){const M=['<option value="">'+m(a("ws-select-ph","— 选择账套主体 —"))+"</option>"].concat(L.map(function($){const A=g!=null&&Number(g)===Number($.id);return'<option value="'+m($.id)+'"'+(A?" selected":"")+">"+m($.name||"#"+$.id)+"</option>"}));I='<div class="ws-modal-select-row"><label class="ws-modal-select-label">'+m(a("ws-select-label","账套主体"))+'</label><select class="ws-modal-select" data-ws-select="1">'+M.join("")+"</select></div>"}const S=!L.length&&h.emptyHint?'<div class="ws-modal-empty">'+m(h.emptyHint)+"</div>":"",T=h.canCreate?'<div class="ws-modal-create"><button type="button" class="ws-modal-create-toggle" data-ws-create-toggle="1">+ '+m(a("ws-create-client","新建工作空间"))+'</button><div class="ws-modal-create-form" data-ws-create-form style="display:none;"><input type="text" class="ws-modal-create-input" data-ws-create-name placeholder="'+m(a("ws-create-ph","公司名称,例如 BAKELAB"))+'"><button type="button" class="ws-modal-create-submit" data-ws-create-submit="1">'+m(a("ws-create-submit","创建"))+"</button></div></div>":"";B.innerHTML='<div class="ws-modal-box" role="dialog" aria-modal="true"><div class="ws-modal-head"><span class="ws-modal-title">'+m(a("ws-chooser-title","选择工作空间"))+'</span><button type="button" class="ws-modal-close" data-ws-close="1" aria-label="close">✕</button></div><div class="ws-modal-subtitle" style="font-size:12px;color:#6b7280;padding:2px 4px 12px;line-height:1.45;white-space:normal;">'+m(a("ws-chooser-subtitle","账套主体 = 你的公司(发票卖方/开票方)。选择正在为哪家公司做账。"))+'</div><div class="ws-modal-list">'+w+I+"</div>"+S+T+"</div>",document.body.appendChild(B);const C=B.querySelector("[data-ws-select]");C&&C.addEventListener("change",function(){const M=C.value;M&&(typeof h.onPick=="function"&&h.onPick(M),k(),u())});function k(){B.remove()}B.addEventListener("click",function(M){if(M.target===B||M.target.closest("[data-ws-close]")){k();return}if(M.target.closest("[data-ws-personal]")){typeof h.onPersonal=="function"&&h.onPersonal(),k(),u();return}const A=M.target.closest("[data-ws-pick]");if(A){const F=A.getAttribute("data-ws-pick");typeof h.onPick=="function"&&h.onPick(F),k(),u();return}if(M.target.closest("[data-ws-create-toggle]")){const F=B.querySelector("[data-ws-create-form]");if(F){F.style.display=F.style.display==="none"?"flex":"none";const G=F.querySelector("[data-ws-create-name]");G&&G.focus()}return}if(M.target.closest("[data-ws-create-submit]")){y(B,h,k);return}})}async function y(h,L,g){const x=h.querySelector("[data-ws-create-name]"),B=x?(x.value||"").trim():"";if(!B){x&&x.focus();return}let E=null;try{if(typeof window.apiPost=="function"){const I=await window.apiPost("/api/workspace/clients",{name:B});E=I&&typeof I.json=="function"?await I.json().catch(()=>null):I}}catch{E=null}const w=E&&(E.id||E.client&&E.client.id);if(!w){typeof window.showToast=="function"&&window.showToast(a("ws-create-fail","新建工作空间失败 · 请重试"),"error");return}window._workspaceClientsCache=await p(),c(Number(w)),L.onPick,g(),u()}window.openWorkspaceChooserUI=_,window.addEventListener("pearnly:workspace-changed",function(){u()}),window.getWorkMode=s,window.getActiveWorkspaceClientId=i,window.setActiveWorkspaceClientId=c,window.enterPersonalMode=l,window.requireWorkspace=f,window.openWorkspaceChooser=d,window.renderWorkspaceControl=u,window.fetchWorkspaceClients=p;function b(){try{if(sessionStorage.getItem("pearnly_ws_login_prompted")==="1"||i()!=null||localStorage.getItem(n)==="personal")return;sessionStorage.setItem("pearnly_ws_login_prompted","1"),setTimeout(function(){d(null)},800)}catch{}}p().then(h=>{window._workspaceClientsCache=h,u(),b()}),typeof window.subscribeI18n=="function"&&window.subscribeI18n("workspace-switcher",u)})();(function(){const e=g=>document.querySelector('[data-num-target="'+g+'"]');function n(g){if(!g)return t("reconcile-last-activity-none");try{const x=new Date(g),B=new Date,E=B-x;if(E/6e4<5)return t("reconcile-last-activity-just-now");if(x.toDateString()===B.toDateString())return t("reconcile-last-activity-today");const I=Math.max(1,Math.floor(E/(24*3600*1e3)));return t("reconcile-last-activity-days-ago").replace("{n}",I)}catch{return t("reconcile-last-activity-none")}}function a(g,x,B){const E=e(g);E&&(E.textContent=B?"-":String(x),E.classList.toggle("is-empty",!!B))}function o(g){const x=document.getElementById("reconcile-error");x&&(x.style.display=g?"flex":"none")}function s(g){const x=document.getElementById("reconcile-empty");x&&(x.style.display=g?"flex":"none")}function i(g,x){const B=document.getElementById("reconcile-last-activity");B&&(B.textContent=g,B.classList.toggle("has-data",!!x))}function r(g){const x=!g||(g.total_sessions||0)===0;a("pending",g.pending||0,x),a("matched",g.matched||0,x),a("unmatched",g.unmatched||0,x),i(n(g.last_activity_at),!!g.last_activity_at),o(!1),s(x)}function c(g){const x=g.toUpperCase();return x==="KBANK"?"bank-chip-kbank":x==="SCB"?"bank-chip-scb":x==="BBL"?"bank-chip-bbl":x==="KTB"?"bank-chip-ktb":x==="TTB"?"bank-chip-ttb":"bank-chip-other"}function l(g,x){const B=E=>E?String(E).slice(0,10):"?";return!g&&!x?"":B(g)+" ~ "+B(x)}function p(g){return g==null?"":String(g).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function f(g){const x=document.getElementById("reconcile-recent"),B=document.getElementById("reconcile-recent-list");if(!x||!B)return;const E=(g||[]).slice(0,20);if(E.length===0){x.style.display="none";return}x.style.display="",s(!1),B.innerHTML=E.map(w=>{const I=w.parse_status==="parse_failed",S=w.bank_code||"OTHER",T=w.account_last4?" ···"+p(w.account_last4):"",C=l(w.period_start,w.period_end),k=p(w.source_filename||""),M=Number(w.tx_count||0),$=I?'<span class="recon-card-fail" data-i18n="reconcile-card-parse-failed">'+t("reconcile-card-parse-failed")+"</span>":'<span class="recon-card-tx">'+t("reconcile-card-tx").replace("{n}",M)+"</span>";return'<div class="recon-card" data-session-id="'+p(w.id)+'" data-session-name="'+k+'"><span class="bank-chip '+c(S)+'">'+p(S)+'</span><div class="recon-card-main"><div class="recon-card-title">'+k+T+'</div><div class="recon-card-sub">'+p(C)+'</div></div><div class="recon-card-right">'+$+'</div><button class="recon-card-trash" data-trash="'+p(w.id)+'" title="'+p(t("bank-session-delete-tip")||"删除")+'"><svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"><path d="M3 5h10M6 5V3h4v2M5 5l1 9h4l1-9"/></svg></button><svg class="recon-card-arrow" viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M6 4l4 4-4 4"/></svg></div>'}).join(""),B.querySelectorAll(".recon-card").forEach(w=>{w.addEventListener("click",I=>{I.target.closest(".recon-card-trash")||(w.dataset.sessionId,d())})}),B.querySelectorAll(".recon-card-trash").forEach(w=>{w.addEventListener("click",I=>{I.stopPropagation();const S=w.dataset.trash,T=w.closest(".recon-card"),C=T&&T.dataset.sessionName||"";typeof window._deleteBankSession=="function"&&window._deleteBankSession(S,C)})})}function d(g){typeof window.routeTo=="function"&&window.routeTo("reconcile"),setTimeout(function(){const x=document.querySelector('[data-recon-tab="bank"]');x&&x.click()},150)}function u(){o(!0),s(!1)}function m(){typeof window.routeTo=="function"&&window.routeTo("reconcile"),setTimeout(function(){const g=document.querySelector('[data-recon-tab="bank"]');g&&g.click()},150)}async function v(){a("pending",0,!0),a("matched",0,!0),a("unmatched",0,!0),i("",!1),o(!1),s(!1);const g=document.getElementById("reconcile-recent");g&&(g.style.display="none");const x={Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||"")};try{const[B,E]=await Promise.all([fetch("/api/bank-recon/stats",{headers:x}),fetch("/api/bank-recon/sessions?limit=20",{headers:x})]);if(!B.ok)throw new Error("http "+B.status);const w=await B.json(),I=E.ok?await E.json():[];r(w||{}),f(I||[])}catch(B){console.warn("[reconcile] load failed",B),u()}}function _(g){if(!g||!g.length)return;const x="Bearer "+(localStorage.getItem("mrpilot_token")||"");let B=0;const E=g.length;Array.from(g).forEach(function(w){const I=new FormData;I.append("file",w,w.name);const S=new XMLHttpRequest;S.open("POST","/api/bank-recon/upload"),S.setRequestHeader("Authorization",x),S.onload=function(){B++;try{const T=JSON.parse(S.responseText);S.status===200&&T.tx_count!==void 0?showToast((t("bank-upload-ok")||"解析成功 · 共 {n} 条流水").replace("{n}",T.tx_count),"success"):showToast(w.name+" "+(t("upload-failed")||"上传失败"),"error")}catch{showToast(w.name+" "+(t("upload-failed")||"上传失败"),"error")}B===E&&setTimeout(v,600)},S.onerror=function(){B++,showToast(w.name+" "+(t("upload-failed")||"上传失败"),"error"),B===E&&setTimeout(v,600)},S.send(I)}),showToast((t("bank-queue-status-uploading")||"上传中")+"…","info")}function y(){if(window.__reconcileBound)return;window.__reconcileBound=!0;const g=document.getElementById("reconcile-bank-file-input");g&&g.addEventListener("change",function(){_(this.files),this.value=""}),document.addEventListener("click",x=>{if(x.target.closest("#btn-reconcile-upload-top")||x.target.closest("#btn-reconcile-upload-empty")){m();return}if(x.target.closest("#btn-reconcile-retry")){v();return}if(x.target.closest("#btn-reconcile-dev-seed")){L();return}})}const b=["468b50c1-5593-4fd6-990d-515ce8085563"];function h(){const g=document.getElementById("btn-reconcile-dev-seed");if(!g)return;const x=typeof _userInfo<"u"?_userInfo:null,B=x&&x.id&&b.indexOf(String(x.id))>=0;g.style.display=B?"":"none"}async function L(){try{const g=await fetch("/api/bank-recon/_dev/seed",{method:"POST",headers:{Authorization:"Bearer "+token}});if(!g.ok)throw new Error("seed:"+g.status);const x=await g.json(),B=(t("reconcile-dev-seed-ok")||"").replace("{n}",x.tx_count||0);showToast(B,"success"),typeof window.navigateTo=="function"?window.navigateTo("automation"):location.hash="#/automation",setTimeout(()=>{const E=document.querySelector('[data-auto-tab="bank"]');E&&E.click(),x.session_id&&typeof window._openBankSession=="function"&&window._openBankSession(x.session_id)},300)}catch(g){console.warn("[reconcile] dev seed failed",g),showToast(t("reconcile-dev-seed-fail")||"Seed failed","error")}}window.loadReconcilePage=async function(){y(),h(),typeof window._bankReconV2Init=="function"&&window._bankReconV2Init();try{await v()}catch{}},window._rerenderReconcile=function(){typeof currentRoute=="string"&&currentRoute==="reconcile"&&v().catch(()=>{})},typeof window.subscribeI18n=="function"&&window.subscribeI18n("reconcile",window._rerenderReconcile)})();(function(){const e=document.getElementById("assign-clients-modal");if(!(!e||e.dataset.wbInjected==="1")){e.innerHTML=`
    <div class="modal" style="max-width:480px">
        ...
        <div class="modal-foot">
    ...
    </div>`,e.dataset.wbInjected="1";try{const n=window._currentLang||localStorage.getItem("mrpilot_lang")||"th",a=window.I18N;a&&a[n]&&e.querySelectorAll("[data-i18n]").forEach(o=>{const s=o.getAttribute("data-i18n");a[n][s]&&(o.textContent=a[n][s])})}catch{}}})();(function(){let e={employeeId:null,employeeName:"",clients:[],selected:new Set,opened:!1};function n(){return document.getElementById("assign-clients-modal")}function a(){return document.getElementById("assign-clients-list")}function o(){return document.getElementById("assign-select-all")}function s(){return document.getElementById("assign-selected-count")}function i(){return document.getElementById("assign-modal-target")}function r(){const v=a();if(v){if(!e.clients.length){v.innerHTML='<div class="assign-empty">'+escapeHtml(t("assign-no-clients")||"暂无客户 · 请先到「客户管理」添加")+"</div>";return}v.innerHTML=e.clients.map(_=>{const y=String(_.id),b=e.selected.has(y)?"checked":"",h=escapeHtml(_.name||_.label||"#"+y),L=_.code?'<span class="assign-row-code">'+escapeHtml(_.code)+"</span>":"";return'<label class="assign-row"><input type="checkbox" data-cid="'+escapeHtml(y)+'" '+b+'><span class="assign-row-name">'+h+"</span>"+L+"</label>"}).join(""),c()}}function c(){const v=s();if(v){const y=t("assign-selected-count")||"已选 {n} / {total}";v.textContent=y.replace("{n}",e.selected.size).replace("{total}",e.clients.length)}const _=o();_&&(_.checked=e.clients.length>0&&e.selected.size===e.clients.length)}function l(){const v=i();v&&(v.textContent=e.employeeName?" · "+e.employeeName:"")}async function p(v,_){e.employeeId=v,e.employeeName=_||"",e.opened=!0,e.selected=new Set,e.clients=[],l();const y=a();y&&(y.innerHTML='<div class="assign-empty">'+escapeHtml(t("assign-loading")||"加载中...")+"</div>");const b=n();b&&(b.style.display="flex");try{const[h,L]=await Promise.all([apiGet("/api/clients?include_inactive=false"),apiGet("/api/team/employees/"+encodeURIComponent(v)+"/assignments")]);e.clients=h&&h.clients||[];const g=L&&L.client_ids||[];e.selected=new Set(g.map(String)),r()}catch(h){console.error("[assign-clients] load failed",h);const L=a();L&&(L.innerHTML='<div class="assign-empty">'+escapeHtml(t("assign-load-failed")||"加载失败 · 请重试")+"</div>")}}function f(){e.opened=!1;const v=n();v&&(v.style.display="none")}async function d(){if(!e.employeeId)return;const v=Array.from(e.selected).map(y=>parseInt(y,10)).filter(y=>!isNaN(y)),_=document.getElementById("assign-modal-save");_&&(_.disabled=!0);try{const y=await apiPost("/api/team/employees/"+encodeURIComponent(e.employeeId)+"/assignments",{client_ids:v});y&&y.ok!==!1?(showToast((t("assign-saved")||"已保存 {n} 个客户分配").replace("{n}",v.length),"success"),f(),typeof loadTeamList=="function"&&loadTeamList()):showToast(t("assign-save-failed")||"保存失败","error")}catch(y){console.error("[assign-clients] save failed",y),showToast(t("assign-save-failed")||"保存失败","error")}finally{_&&(_.disabled=!1)}}function u(){const v=n();if(!v||v.dataset.bound==="1")return;v.dataset.bound="1";const _=document.getElementById("assign-modal-close");_&&_.addEventListener("click",f);const y=document.getElementById("assign-modal-cancel");y&&y.addEventListener("click",f);const b=document.getElementById("assign-modal-save");b&&b.addEventListener("click",d),v.addEventListener("click",function(g){g.target===v&&f()});const h=o();h&&h.addEventListener("change",function(){h.checked?e.selected=new Set(e.clients.map(g=>String(g.id))):e.selected=new Set,r()});const L=a();L&&L.addEventListener("change",function(g){const x=g.target.closest('input[type="checkbox"][data-cid]');if(!x)return;const B=x.dataset.cid;x.checked?e.selected.add(B):e.selected.delete(B),c()})}function m(){e.opened&&(l(),r())}typeof window.subscribeI18n=="function"&&window.subscribeI18n("assign-clients-modal",m),window.openAssignClientsModal=function(v,_){u(),p(v,_)}})();(function(){const e={page:1,per_page:50,q:"",total:0,rows:[],loaded:!1};function n(f){if(!f)return"";try{return new Date(f).toLocaleString()}catch{return f}}function a(f){const d=document.getElementById("access-log-table");d&&(d.innerHTML='<div class="access-log-empty">'+escapeHtml(f)+"</div>");const u=document.getElementById("access-log-pager");u&&(u.innerHTML="")}function o(){const f=document.getElementById("access-log-table");if(!f)return;const d=e.rows||[];if(!d.length){a(t("set-access-log-empty"));return}const u=`
            <div class="access-log-row access-log-head">
                ...
                </div>`}).join("");f.innerHTML=u+m}function s(){const f=document.getElementById("access-log-pager");if(!f)return;const d=e.total||0;if(!d){f.innerHTML="";return}const u=e.page||1,m=e.per_page,v=Math.max(1,Math.ceil(d/m)),_=(t("set-access-log-pager-total")||"Total {n}").replace("{n}",d),y=(t("set-access-log-pager-page")||"Page {p} / {t}").replace("{p}",u).replace("{t}",v);f.innerHTML=`
            ...
            </div>`}async function i(f){const d=localStorage.getItem("mrpilot_token");if(d){e.page=f||1,a(t("set-access-log-loading"));try{const u="/api/me/access_log?page="+e.page+"&per_page="+e.per_page+"&q="+encodeURIComponent(e.q||""),m=await fetch(u,{headers:{Authorization:"Bearer "+d}});if(m.status===403){a(t("set-access-log-empty"));return}if(!m.ok)throw new Error("http_"+m.status);const v=await m.json();e.rows=v.logs||[],e.total=v.total||0,e.loaded=!0,o(),s()}catch{a(t("set-access-log-fail"))}}}async function r(){const f=localStorage.getItem("mrpilot_token");if(f)try{const d="/api/me/access_log.csv?q="+encodeURIComponent(e.q||""),u=await fetch(d,{headers:{Authorization:"Bearer "+f}});if(!u.ok){showToast(t("set-access-log-csv-fail")||"Export failed","error");return}const m=await u.blob(),v=document.createElement("a"),_=URL.createObjectURL(m);v.href=_,v.download="pearnly_access_log.csv",document.body.appendChild(v),v.click(),setTimeout(function(){URL.revokeObjectURL(_),v.remove()},100),showToast(t("set-access-log-csv-ok")||"Exported","success")}catch{showToast(t("set-access-log-csv-fail")||"Export failed","error")}}function c(){const f=document.querySelectorAll(".set-tab-owner-only"),d=!!(_userInfo&&(_userInfo.role==="owner"||_userInfo.is_super_admin));f.forEach(function(u){u.style.display=d?"":"none"})}document.addEventListener("click",function(f){if(f.target.closest('.settings-tab[data-tab="access-log"]')){setTimeout(function(){(!e.loaded||e.page!==1)&&i(1)},50);return}if(f.target.closest("#access-log-csv-btn")){f.preventDefault(),r();return}const m=f.target.closest(".access-log-pager-btn[data-access-log-page]");if(m&&!m.disabled){const v=parseInt(m.dataset.accessLogPage,10);i(v)}}),document.addEventListener("input",function(f){f.target&&f.target.id==="access-log-search"&&(clearTimeout(window.__accessLogSearchTimer),window.__accessLogSearchTimer=setTimeout(function(){e.q=(f.target.value||"").trim(),i(1)},350))});let l=0;const p=setInterval(function(){l++,_userInfo&&(c(),clearInterval(p)),l>60&&clearInterval(p)},500);typeof window.subscribeI18n=="function"&&window.subscribeI18n("me-access-log",function(){c(),e.loaded&&(o(),s())})})();(function(){const e=document.getElementById("notif-new-modal");if(!(!e||e.dataset.wbInjected==="1")){e.innerHTML=`
...
`,e.dataset.wbInjected="1";try{const n=window._currentLang||localStorage.getItem("mrpilot_lang")||"th",a=window.I18N;a&&a[n]&&(e.querySelectorAll("[data-i18n]").forEach(o=>{const s=o.getAttribute("data-i18n");a[n][s]&&(o.textContent=a[n][s])}),e.querySelectorAll("[data-i18n-placeholder]").forEach(o=>{const s=o.getAttribute("data-i18n-placeholder");a[n][s]&&(o.placeholder=a[n][s])}))}catch{}}})();(function(){const e=B=>document.getElementById(B);async function n(B,E){return await fetch(B,{method:"PATCH",headers:{Authorization:"Bearer "+token,"Content-Type":"application/json"},body:JSON.stringify(E||{})})}async function a(B){return await fetch(B,{method:"DELETE",headers:{Authorization:"Bearer "+token}})}let o=null;async function s(){try{o=await apiGet("/api/line/binding")}catch{o={bound:!1}}return o}function i(B,E){if(!B)return;B.style.display="",B.className="notif-line-check "+(E?"bound":"unbound");const w=E?'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M20 6 9 17l-5-5"/></svg>':'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><path d="M12 8v4M12 16h.01"/></svg>';B.innerHTML=w+"<span>"+escapeHtml(t(E?"notif-line-bound":"notif-line-not-bound"))+"</span>"}function r(B){if(B==null)return"-";const E=Number(B);return isNaN(E)?String(B):"฿ "+E.toLocaleString("en-US",{minimumFractionDigits:2,maximumFractionDigits:2})}function c(B){if(!B)return"-";try{const E=new Date(B),w=(E.getMonth()+1).toString().padStart(2,"0"),I=E.getDate().toString().padStart(2,"0"),S=E.getHours().toString().padStart(2,"0"),T=E.getMinutes().toString().padStart(2,"0");return`${w}-${I} ${S}:${T}`}catch{return B}}function l(B){const E=e("notif-rules-list"),w=e("notif-rules-empty"),I=e("notif-rules-count");if(!(!E||!w)){if(I.textContent=String(B.length),I.className="auto-status-pill "+(B.length>0?"active":"none"),!B.length){w.style.display="",E.style.display="none",E.innerHTML="";return}w.style.display="none",E.style.display="",E.innerHTML=B.map(S=>{const T=S.template_code==="large_invoice",C=T?"notif-rule-large-tag":"notif-rule-exception-tag",k=T?"large":"";let M=[];if(T){const A=S.params&&S.params.threshold?r(S.params.threshold):"-";M.push(escapeHtml(t("notif-rule-threshold-prefix"))+" "+A)}S.enabled||M.push('<span style="color:#9ca3af;">'+escapeHtml(t("notif-rule-disabled"))+"</span>");const $=M.length?M.join(' <span class="dot"></span> '):"";return`
                ...
                </div>`}).join("")}}function p(B){const E=e("notif-logs-list");if(E){if(!B.length){E.innerHTML='<div class="notif-logs-empty">'+escapeHtml(t("notif-logs-empty"))+"</div>";return}E.innerHTML=B.map(w=>{const I=w.status==="sent",S=w.event_type==="exception_high"?"notif-event-exception-high":w.event_type==="large_invoice"?"notif-event-large-invoice":"notif-event-test-send",T=I?"":" · "+escapeHtml(w.error||"failed");return`
...
`,e.dataset.wbInjected="1";try{const n=window._currentLang||localStorage.getItem("mrpilot_lang")||"th",a=window.I18N;a&&a[n]&&(e.querySelectorAll("[data-i18n]").forEach(o=>{const s=o.getAttribute("data-i18n");a[n][s]&&(o.textContent=a[n][s])}),e.querySelectorAll("[data-i18n-placeholder]").forEach(o=>{const s=o.getAttribute("data-i18n-placeholder");a[n][s]&&(o.placeholder=a[n][s])}))}catch{}}})();(function(){const e=document.getElementById("archive-token-modal");if(!(!e||e.dataset.wbInjected==="1")){e.innerHTML=`
        ...
        `}async function n(){try{const o=await fetch("/api/settings/dup-check",{headers:{Authorization:"Bearer "+token}});if(!o.ok)return;const s=await o.json(),i=document.getElementById("pref-dup-check");i&&(i.checked=!!s.enabled)}catch(o){console.warn("load prefs failed",o)}}const a=document.getElementById("pref-dup-check");a&&!a.dataset.bound&&(a.dataset.bound="1",a.addEventListener("change",async o=>{const s=o.target.checked;try{(await fetch("/api/settings/dup-check",{method:"PUT",headers:{Authorization:"Bearer "+token,"Content-Type":"application/json"},body:JSON.stringify({enabled:s})})).ok?showToast(s?t("pref-dup-check-on-toast"):t("pref-dup-check-off-toast"),"success"):(o.target.checked=!s,showToast(t("pref-save-failed"),"error"))}catch{o.target.checked=!s,showToast(t("pref-save-failed"),"error")}}))})();(function(){const o="pearnly_big_batch_tip_shown";let s=null,i=null,r=0,c=0,l=!1;function p(h){const L=typeof t=="function"?t("big-batch-unload-warn"):"Batch OCR running · close anyway?";return h.preventDefault(),h.returnValue=L,L}function f(){l||(l=!0,window.addEventListener("beforeunload",p))}function d(){l&&(l=!1,window.removeEventListener("beforeunload",p))}function u(){if(document.getElementById("big-batch-progress"))return;const h=document.getElementById("file-list");if(!h||!h.parentNode)return;const L=document.createElement("div");L.id="big-batch-progress",L.className="big-batch-progress",L.innerHTML='<div class="bbp-row"><svg class="bbp-icon" viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><circle cx="8" cy="8" r="6.5"/><path d="M8 4.5v3.5l2.5 1.5"/></svg><span class="bbp-text" id="bbp-text"></span></div><div class="bbp-track"><div class="bbp-fill" id="bbp-fill" style="width:0%"></div></div>',h.parentNode.insertBefore(L,h);const g=document.getElementById("bbp-text");g&&(g.textContent=typeof t=="function"?t("big-batch-progress-init"):"Starting...")}function m(){const h=document.getElementById("big-batch-progress");h&&h.remove()}function v(){if(!i)return;let h=0;for(let S=0;S<i.length;S++){const T=i[S].status;(T==="success"||T==="error"||T==="cancelled")&&h++}const L=r,g=L>0?Math.min(100,Math.floor(100*h/L)):0,x=(Date.now()-c)/1e3;let B;if(h>=3&&x>1){const S=x/h;B=(L-h)*S}else B=(L-h)*6/6;const E=Math.max(1,Math.ceil(B/60)),w=document.getElementById("bbp-fill"),I=document.getElementById("bbp-text");w&&(w.style.width=g+"%"),I&&(h>=L?I.textContent=t("big-batch-progress-done").replace("{total}",L):I.textContent=t("big-batch-progress-running").replace("{done}",h).replace("{total}",L).replace("{min}",E))}function _(h){try{if(localStorage.getItem(o)==="1")return}catch{}const L=Math.max(1,Math.ceil(h*6/6/60)),g=t("big-batch-first-tip").replace("{n}",h).replace("{min}",L);typeof showToast=="function"&&showToast(g,"info",8e3);try{localStorage.setItem(o,"1")}catch{}}function y(h){!h||h.length<100||(i=h,r=h.length,c=Date.now(),u(),f(),_(r),s&&clearInterval(s),s=setInterval(v,250),v())}function b(){s&&(clearInterval(s),s=null),d(),i&&r>=100?(v(),setTimeout(m,1200)):m(),i=null,r=0}window._bigBatchStart=y,window._bigBatchStop=b,typeof window.subscribeI18n=="function"&&window.subscribeI18n("big-batch-progress",function(){i&&v()})})();(function(){let e=null,n=!1,a=!1;function o(w){return typeof escapeHtml=="function"?escapeHtml(w==null?"":String(w)):String(w??"")}function s(w,I){try{typeof showToast=="function"&&showToast(w,I||"info")}catch{}}function i(){const w=typeof _userInfo<"u"?_userInfo:null;return!!(w&&(w.role==="owner"||w.is_super_admin))}function r(){try{return(typeof _results<"u"?_results:[])[typeof _drawerIdx<"u"?_drawerIdx:-1]||null}catch{return null}}function c(w){if(!w)return!1;const I=String(w.status||"").toLowerCase();return I==="exception"||I==="exception_pending"||I==="rejected"}async function l(w){if(n&&!w)return e;const I=localStorage.getItem("mrpilot_token");if(!I)return null;try{const S=await fetch("/api/erp/xero/status",{headers:{Authorization:"Bearer "+I}});if(!S.ok)throw new Error("http_"+S.status);e=await S.json(),n=!0}catch{e={configured:!1,connected:!1,organisations:[]},n=!1}return e}function p(){const w=document.getElementById("erp-connect-cards");if(!w)return;const I=e;let S,T=!1;I?I.configured?I.connected?(T=!0,S='<span class="mrerp-card-pill mrerp-pill-ok">'+o(t("xero-card-connected"))+"</span>"):S='<span class="mrerp-card-pill mrerp-pill-neutral">'+o(t("xero-card-not-connected"))+"</span>":S='<span class="mrerp-card-pill mrerp-pill-neutral">'+o(t("xero-card-not-configured"))+"</span>":S='<span class="mrerp-card-pill mrerp-pill-neutral">'+o(t("xero-card-not-connected"))+"</span>";let C="";if(!I||!I.configured)C='<button type="button" class="int-btn-configure" id="btn-xero-connect">'+o(t("xero-connect-btn"))+"</button>";else if(!I.connected)i()&&(C='<button type="button" class="int-btn-configure" id="btn-xero-connect">'+o(t("xero-connect-btn"))+"</button>");else{const O=!!I.auto_push,ee=O?t("card-btn-disable"):t("card-btn-enable");C='<button type="button" class="'+(O?"mrerp-card-toggle mrerp-card-toggle-disable":"mrerp-card-toggle mrerp-card-toggle-enable")+'" id="btn-xero-toggle-enabled" data-xero-enabled="'+(O?"1":"0")+'" title="'+o(O?t("erp-auto-push-on-tip"):t("erp-auto-push-off-tip"))+'">'+o(ee)+'</button><button type="button" class="int-btn-configure" id="btn-xero-edit-toggle">'+o(t("card-btn-edit"))+"</button>"}const k=I&&I.connected?"xero-card-desc-connected":"xero-card-desc-default",M=I&&I.connected?t("xero-card-connected")||"Connected · default org will receive pushes":"Cloud accounting · push invoices to your default Xero org",$=(function(){const O=t(k);return O===k?M:O})();let A='<div class="integration-row erp-connect-xero'+(T?" connected":"")+'"><div class="int-icon ic-xero"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="9"/><circle cx="9" cy="10" r="1.3" fill="currentColor"/><circle cx="15" cy="14" r="1.3" fill="currentColor"/><path d="M9 14l6-4"/></svg></div><div class="int-info"><div class="int-name"><span>'+o(t("xero-card-title")||"Xero")+"</span>"+S+'</div><div class="int-desc">'+o($)+'</div></div><div class="int-actions">'+C+"</div></div>";if(I&&I.configured&&I.connected&&i()){const O=I.organisations||[];let ee="";if(O.length>0){ee+='<div class="erp-cc-meta">'+o((t("xero-org-count")||"").replace("{n}",String(O.length)))+"</div>",ee+='<div class="erp-cc-org-label">'+o(t("xero-default-org"))+":</div>",ee+='<div class="erp-cc-orgs">',O.forEach(function(ue){ee+='<label class="erp-cc-org-row"><input type="radio" name="xero-default-org" value="'+o(ue.id)+'"'+(ue.is_default?" checked":"")+'><span class="erp-cc-org-name">'+o(ue.organisation_name||ue.organisation_id)+"</span></label>"}),ee+="</div>";const de=!!I.auto_push,me=de?t("erp-auto-push-on-tip"):t("erp-auto-push-off-tip");ee+='<div class="erp-cc-auto-push" title="'+o(me)+'"><label class="erp-cc-toggle"><input type="checkbox" id="xero-auto-push-toggle"'+(de?" checked":"")+'><span class="erp-cc-toggle-slider"></span><span class="erp-cc-toggle-label">'+o(t("erp-auto-push-label"))+"</span></label></div>",ee+='<div class="erp-cc-actions"><button class="btn btn-ghost btn-tiny" type="button" id="btn-xero-disconnect">'+o(t("xero-disconnect-btn"))+"</button></div>"}A+='<div class="erp-xero-details" id="erp-xero-details" style="display:none; margin:8px 0 16px; padding:12px 14px; border:1px solid var(--line); border-radius:8px; background:var(--bg);">'+ee+"</div>"}const H=w.querySelector(".erp-connect-xero"),P=w.querySelector("#erp-xero-details");P&&P.remove(),H?H.outerHTML=A:w.insertAdjacentHTML("afterbegin",A);const F=document.getElementById("btn-xero-edit-toggle");F&&F.addEventListener("click",function(O){O.preventDefault();const ee=document.getElementById("erp-xero-details");ee&&(ee.style.display=ee.style.display==="none"?"":"none")});const G=document.getElementById("btn-xero-toggle-enabled");G&&G.addEventListener("click",async function(O){if(O.preventDefault(),G.disabled)return;const de=!(G.getAttribute("data-xero-enabled")==="1");if(!de)try{if(!await window.pearnlyConfirm(t("card-toggle-disable-confirm")))return}catch{}G.disabled=!0,await m(de,null)})}async function f(){const w=localStorage.getItem("mrpilot_token");if(w)try{const I=await fetch("/api/erp/xero/auth/start",{method:"GET",headers:{Authorization:"Bearer "+w}});if(!I.ok){let T="unknown";try{T=(await I.json()).detail||"unknown"}catch{}const C=String(T).replace(/^xero\./,"").toLowerCase();s(t("xero-push-fail").replace("{err}",t("xero-err-"+C)||T),"error");return}const S=await I.json();S.redirect_url&&(window.location.href=S.redirect_url)}catch(I){s(t("xero-push-fail").replace("{err}",I.message||"network"),"error")}}async function d(){if(!await window.pearnlyConfirm(t("xero-disconnect-confirm")))return;const I=localStorage.getItem("mrpilot_token");try{const S=await fetch("/api/erp/xero/disconnect",{method:"POST",headers:{Authorization:"Bearer "+I}});if(!S.ok)throw new Error("http_"+S.status);await l(!0),p()}catch(S){s(t("xero-push-fail").replace("{err}",S.message),"error")}}async function u(w){const I=localStorage.getItem("mrpilot_token");try{const S=await fetch("/api/erp/xero/select_org",{method:"POST",headers:{Authorization:"Bearer "+I,"Content-Type":"application/json"},body:JSON.stringify({token_id:w})});if(!S.ok)throw new Error("http_"+S.status);await l(!0),p()}catch(S){s(t("xero-push-fail").replace("{err}",S.message),"error")}}async function m(w,I){const S=localStorage.getItem("mrpilot_token");I&&(I.disabled=!0);try{const T=await fetch("/api/erp/xero/auto-push",{method:"POST",headers:{Authorization:"Bearer "+S,"Content-Type":"application/json"},body:JSON.stringify({on:!!w})});if(!T.ok){let C="unknown";try{C=(await T.json()).detail||"unknown"}catch{}throw new Error(C)}s(w?t("erp-auto-push-toggled-on"):t("erp-auto-push-toggled-off"),"success"),n=!1,await l(!0),p()}catch(T){I&&(I.checked=!w),s(t("erp-auto-push-toggle-fail").replace("{err}",T.message||"network"),"error")}finally{I&&(I.disabled=!1)}}async function v(){const w=document.getElementById("drawer-history-save");if(!w||w.querySelector("#btn-xero-push")||w.querySelector("#pn-push-wrap")||(await l(!1),w.querySelector("#pn-push-wrap"))||w.querySelector("#btn-xero-push"))return;const I=r();if(!(I&&(I._historyId||I.history_id)))return;let T=!1,C="xero-push-tip";!e||!e.configured?(T=!0,C="xero-err-not_configured"):e.connected?c(I)&&(T=!0,C="xero-push-disabled-exc"):(T=!0,C="xero-push-disabled-no-conn");const k=document.createElement("button");k.type="button",k.id="btn-xero-push",k.className="btn btn-ghost"+(T?" disabled":""),k.disabled=T,k.title=t(C)||"",k.innerHTML='<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"><circle cx="8" cy="8" r="6"/><path d="M5 8l2 2 4-4"/></svg><span style="margin-left:4px;">'+o(t("xero-push-btn"))+"</span>",k.addEventListener("click",_);const M=document.getElementById("btn-push-erp");M&&M.parentNode?M.parentNode.insertBefore(k,M.nextSibling):w.insertBefore(k,w.firstChild)}async function _(){const w=r(),I=w&&(w._historyId||w.history_id);if(!I)return;const S=document.getElementById("btn-xero-push");S&&(S.disabled=!0,S.classList.add("loading"));const T=localStorage.getItem("mrpilot_token");try{const C=await fetch("/api/erp/xero/push/"+encodeURIComponent(I),{method:"POST",headers:{Authorization:"Bearer "+T}});if(!C.ok){let k="unknown";try{k=(await C.json()).detail||"unknown"}catch{}const M=String(k).replace(/^xero\./,"").toLowerCase(),$=t("xero-"+M),A=$&&$!=="xero-"+M?$:k;s(t("xero-push-fail").replace("{err}",A),"error");return}s(t("xero-push-ok"),"success")}catch(C){s(t("xero-push-fail").replace("{err}",C.message||"network"),"error")}finally{S&&(S.disabled=!1,S.classList.remove("loading"))}}async function y(){await l(!0),p(),b()}async function b(){const w=document.getElementById("erp-global-push-mode");if(!w)return;const I=localStorage.getItem("mrpilot_token");if(I)try{const S=await fetch("/api/settings/erp-push-mode",{headers:{Authorization:"Bearer "+I}});if(S.ok){const T=await S.json();T.mode&&(w.value=T.mode,w.dataset.prev=T.mode)}}catch{}}async function h(w){const I=w.value,S=localStorage.getItem("mrpilot_token");try{(await fetch("/api/settings/erp-push-mode",{method:"PUT",headers:{Authorization:"Bearer "+S,"Content-Type":"application/json"},body:JSON.stringify({mode:I})})).ok?(w.dataset.prev=I,s(t("pref-erp-mode-saved"),"success")):(w.value=w.dataset.prev||"smart",s(t("pref-save-failed"),"error"))}catch{w.value=w.dataset.prev||"smart",s(t("pref-save-failed"),"error")}}function L(){try{const w=String(window.location.hash||"");if(w.indexOf("xero=ok")>=0){const I=w.match(/n=(\d+)/),S=I?I[1]:"1";s((t("xero-toast-redirected-ok")||"").replace("{n}",S),"success"),history.replaceState(null,"",window.location.pathname+"#automation"),l(!0).then(p)}else w.indexOf("xero=err")>=0&&(s(t("xero-toast-redirected-err"),"error"),history.replaceState(null,"",window.location.pathname+"#automation"))}catch{}}function g(){if(a)return;a=!0,document.addEventListener("click",function(I){if(I.target.closest('.erp-subtab[data-erp-subtab="connect"]')){setTimeout(y,50);return}if(I.target.closest('.auto-nav-item[data-auto-tab="erp"]')){setTimeout(y,80);return}if(I.target.closest("#btn-xero-connect")){I.preventDefault(),f();return}if(I.target.closest("#btn-xero-disconnect")){I.preventDefault(),d();return}}),document.addEventListener("change",function(I){I.target&&I.target.matches('input[name="xero-default-org"]')&&u(I.target.value),I.target&&I.target.id==="xero-auto-push-toggle"&&m(I.target.checked,I.target),I.target&&I.target.id==="erp-global-push-mode"&&h(I.target)});const w=function(){return document.getElementById("drawer-body")};try{const I=new MutationObserver(function(){document.getElementById("drawer-history-save")&&!document.getElementById("btn-xero-push")&&v()}),S=w();if(S)I.observe(S,{childList:!0,subtree:!0});else{const T=new MutationObserver(function(){const C=w();C&&(I.observe(C,{childList:!0,subtree:!0}),T.disconnect())});T.observe(document.body,{childList:!0,subtree:!0})}}catch{}setTimeout(L,500)}function x(){e&&p();const w=document.getElementById("btn-xero-push");if(w){const I=w.querySelector("span");I&&(I.textContent=t("xero-push-btn"))}}g(),typeof window.subscribeI18n=="function"&&window.subscribeI18n("xero-adapter",x);async function B(w){const I=Date.now();for(;Date.now()-I<w;){if(typeof _userInfo<"u"&&_userInfo&&_userInfo.id)return _userInfo;await new Promise(S=>setTimeout(S,80))}return null}async function E(){await B(5e3);const w=document.querySelector('.auto-nav-item.active[data-auto-tab="erp"]'),I=document.querySelector('.erp-subtab.active[data-erp-subtab="connect"]');w&&I&&await y()}setTimeout(E,200)})();(function(){var e="https://www.mrerp4sme.com/dms/index.php",n=null,a=!1;function o(y){return typeof escapeHtml=="function"?escapeHtml(y==null?"":String(y)):String(y??"")}function s(y,b){try{typeof showToast=="function"&&showToast(y,b||"info")}catch{}}function i(){return localStorage.getItem("mrpilot_token")}async function r(y){var b=i();if(!b)return null;try{var h=await fetch("/api/erp/endpoints",{headers:{Authorization:"Bearer "+b}});if(!h.ok)throw new Error("http_"+h.status);var L=await h.json(),g=L&&L.items||[];n=g.find(function(x){return x&&(x.adapter||"").toLowerCase()==="mrerp_dms"})||null,a=!0}catch{n=null,a=!1}return n}function c(){var y=document.getElementById("erp-connect-cards");if(y){var b=y.querySelector("[data-mrerp-dms-zone]");b||(b=document.createElement("div"),b.setAttribute("data-mrerp-dms-zone","1"),y.appendChild(b));var h=n,L=!!(h&&h.enabled!==!1),g;h?L?g='<span class="mrerp-card-pill mrerp-pill-ok">'+o(t("dms-card-connected"))+"</span>":g='<span class="mrerp-card-pill mrerp-pill-neutral">'+o(t("dms-card-disabled-pill"))+"</span>":g='<span class="mrerp-card-pill mrerp-pill-neutral">'+o(t("dms-card-not-connected"))+"</span>";var x;if(!h)x='<button type="button" class="int-btn-configure" id="btn-dms-connect">'+o(t("dms-card-connect"))+"</button>";else{var B=L?t("dms-card-disable"):t("dms-card-enable");x='<button type="button" class="int-btn-configure" id="btn-dms-edit">'+o(t("dms-card-edit"))+'</button><button type="button" class="int-btn-configure" id="btn-dms-test">'+o(t("dms-card-test"))+'</button><button type="button" class="int-btn-configure" id="btn-dms-toggle">'+o(B)+"</button>"}b.innerHTML='<div class="integration-row erp-connect-mrerp-dms'+(L?" connected":"")+'"><div class="int-icon ic-mrerp-dms" style="background:#0a5c8a;color:#fff;"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M3 13l2-5a2 2 0 011.9-1.4h10.2A2 2 0 0119 8l2 5"/><path d="M3 13h18v4a1 1 0 01-1 1h-1a1 1 0 01-1-1v-1H6v1a1 1 0 01-1 1H4a1 1 0 01-1-1z"/><circle cx="7" cy="15.5" r="1"/><circle cx="17" cy="15.5" r="1"/></svg></div><div class="int-info"><div class="int-name"><span>'+o(t("dms-card-title"))+"</span>"+g+'</div><div class="int-desc">'+o(t("dms-card-desc"))+'</div></div><div class="int-actions">'+x+"</div></div>"}}function l(){var y=document.getElementById("dms-wizard-overlay");y&&y.remove(),document.removeEventListener("keydown",p)}function p(y){y.key==="Escape"&&l()}function f(){l();var y=n,b=y&&y.config&&y.config.booking_defaults&&y.config.booking_defaults.booking_prefix||"PN",h=function(x,B,E,w,I){return'<label style="display:block;margin-bottom:12px;"><span style="display:block;font-size:13px;color:var(--muted,#6b6b66);margin-bottom:5px;">'+o(t(x))+'</span><input id="'+B+'" type="'+E+'" value="'+o(w||"")+'" placeholder="'+o(I||"")+'" autocomplete="new-password" style="width:100%;box-sizing:border-box;padding:9px 11px;border:1px solid var(--line,#ddd);border-radius:8px;font-size:14px;"></label>'},L=document.createElement("div");L.id="dms-wizard-overlay",L.style.cssText="position:fixed;inset:0;z-index:13000;background:rgba(0,0,0,.42);display:flex;align-items:center;justify-content:center;padding:16px;",L.innerHTML='<div class="dms-wizard mrerp-wizard" role="dialog" aria-modal="true" style="background:var(--card,#fff);border-radius:14px;max-width:440px;width:100%;padding:24px;box-shadow:0 12px 40px rgba(0,0,0,.18);max-height:90vh;overflow:auto;"><div style="font-size:17px;font-weight:700;margin-bottom:4px;">'+o(t("dms-wizard-title"))+'</div><div style="font-size:13px;color:var(--muted,#6b6b66);margin-bottom:18px;">'+o(t("dms-card-desc"))+"</div>"+h("dms-wizard-username","dms-w-user","text","","")+h("dms-wizard-password","dms-w-pass","password","","")+h("dms-wizard-prefix","dms-w-prefix","text",b,"PN")+'<div id="dms-w-err" style="display:none;color:#b3261e;font-size:13px;margin:4px 0 12px;"></div><div style="display:flex;gap:10px;justify-content:flex-end;margin-top:8px;"><button type="button" class="btn btn-ghost" id="dms-w-cancel">'+o(t("dms-wizard-cancel"))+'</button><button type="button" class="btn btn-primary" id="dms-w-save">'+o(t("dms-wizard-save"))+"</button></div></div>",document.body.appendChild(L),document.addEventListener("keydown",p),L.addEventListener("click",function(x){x.target===L&&l()});var g=document.getElementById("dms-w-user");g&&g.focus()}function d(y){var b=document.getElementById("dms-w-err");b&&(b.textContent=y,b.style.display=y?"":"none")}async function u(){var y=n&&n.config&&n.config.system_url||e,b=(document.getElementById("dms-w-user")||{}).value||"",h=(document.getElementById("dms-w-pass")||{}).value||"",L=(document.getElementById("dms-w-prefix")||{}).value||"PN";if(y=y.trim(),b=b.trim(),!y||!b||!h){d(t("dms-wizard-required"));return}var g=document.getElementById("dms-w-save");g&&(g.disabled=!0,g.textContent=t("dms-wizard-saving")),d("");var x=i();try{var B=await fetch("/api/erp/test-connection",{method:"POST",headers:{Authorization:"Bearer "+x,"Content-Type":"application/json"},body:JSON.stringify({adapter:"mrerp_dms",config:{system_url:y,username:b,password:h}})}),E=await B.json().catch(function(){return{}});if(!B.ok||!E.ok){var w=E.error_friendly&&(E.error_friendly[window.currentLang]||E.error_friendly.en)||t("dms-connect-fail-generic");d(w),g&&(g.disabled=!1,g.textContent=t("dms-wizard-save"));return}var I={system_url:y,username_enc:b,password_enc:h,id_card_auto_push:!0,booking_defaults:{booking_prefix:L.trim()||"PN"}},S,T;n&&n.id?(S="PATCH",T="/api/erp/endpoints/"+encodeURIComponent(n.id)):(S="POST",T="/api/erp/endpoints");var C=S==="POST"?{name:"MR.ERP DMS",adapter:"mrerp_dms",config:I,is_default:!1,auto_push:!1}:{config:I,auto_push:!1},k=await fetch(T,{method:S,headers:{Authorization:"Bearer "+x,"Content-Type":"application/json"},body:JSON.stringify(C)});if(!k.ok){var M=await k.json().catch(function(){return{}}),$=M&&M.detail&&(M.detail.code||M.detail)||"save_failed";d(t("dms-save-fail")+" ("+o(String($))+")"),g&&(g.disabled=!1,g.textContent=t("dms-wizard-save"));return}l(),s(t("dms-connect-ok"),"success"),await r(!0),c(),typeof window._refreshOcrDocMode=="function"&&window._refreshOcrDocMode()}catch{d(t("dms-connect-fail-generic")),g&&(g.disabled=!1,g.textContent=t("dms-wizard-save"))}}async function m(){if(!(!n||!n.id)){s(t("dms-test-running"),"info");var y=i();try{var b=await fetch("/api/erp/endpoints/"+encodeURIComponent(n.id)+"/test-connection?refresh=1",{method:"POST",headers:{Authorization:"Bearer "+y}}),h=await b.json().catch(function(){return{}});s(h&&h.ok?t("dms-test-ok"):t("dms-test-fail"),h&&h.ok?"success":"error")}catch{s(t("dms-test-fail"),"error")}}}async function v(){if(!(!n||!n.id)){var y=n.enabled===!1;if(!y)try{var b=await window.pearnlyConfirm(t("dms-confirm-disable"));if(!b)return}catch{}var h=i();try{var L=await fetch("/api/erp/endpoints/"+encodeURIComponent(n.id),{method:"PATCH",headers:{Authorization:"Bearer "+h,"Content-Type":"application/json"},body:JSON.stringify({enabled:y})});if(!L.ok)throw new Error("http_"+L.status);s(y?t("dms-enabled-toast"):t("dms-disabled-toast"),"success"),await r(!0),c(),typeof window._refreshOcrDocMode=="function"&&window._refreshOcrDocMode()}catch{s(t("dms-save-fail"),"error")}}}function _(){r().then(c)}document.addEventListener("click",function(y){if(y.target.closest('.erp-subtab[data-erp-subtab="connect"]')){setTimeout(_,60);return}if(y.target.closest('.auto-nav-item[data-auto-tab="erp"]')){setTimeout(_,90);return}if(y.target.closest("#btn-dms-connect")||y.target.closest("#btn-dms-edit")){y.preventDefault(),f();return}if(y.target.closest("#dms-w-cancel")){y.preventDefault(),l();return}if(y.target.closest("#dms-w-save")){y.preventDefault(),u();return}if(y.target.closest("#btn-dms-test")){y.preventDefault(),m();return}if(y.target.closest("#btn-dms-toggle")){y.preventDefault(),v();return}}),typeof window.subscribeI18n=="function"&&window.subscribeI18n("mrerp-dms-adapter",c),setTimeout(function(){var y=document.querySelector('.auto-nav-item.active[data-auto-tab="erp"]'),b=document.querySelector('.erp-subtab.active[data-erp-subtab="connect"]');y&&b&&_()},250)})();(function(){const e={};function n(){if(document.getElementById("report-modal"))return;const p=`
        ...
        </div>`,f=document.createElement("div");f.innerHTML=p,document.body.appendChild(f.firstElementChild),document.getElementById("report-modal-close-x").addEventListener("click",a),document.getElementById("report-modal-cancel").addEventListener("click",a),document.getElementById("report-modal").addEventListener("click",d=>{d.target.id==="report-modal"&&a()})}function a(){const p=document.getElementById("report-modal");p&&(p.style.display="none"),o=null}let o=null;async function s(p,f){const d=p+":"+(f||"");if(e[d])return e[d];let u;try{const m=localStorage.getItem("mrpilot_token"),v=await fetch(`/api/reports/templates?lang=${encodeURIComponent(p)}`,{headers:{Authorization:"Bearer "+m}});if(!v.ok)throw new Error("templates fetch failed");u=(await v.json()).templates||[]}catch(m){console.error("fetchTemplates fail",m),u=[{code:"input_vat",name:t("tpl-input-vat"),desc:t("tpl-input-vat-desc"),recommended:!0},{code:"standard",name:t("tpl-standard"),desc:t("tpl-standard-desc"),recommended:!1},{code:"print",name:t("tpl-print"),desc:t("tpl-print-desc"),recommended:!1}]}if(u=u.filter(m=>m.code!=="erp"),f==="history-batch"){const m=u.findIndex(_=>_.code==="standard"),v=m>=0?m+1:u.length;u.splice(v,0,{code:"sales_detail_th",name:t("export-tpl-sales-detail"),desc:t("export-tpl-sales-detail-desc"),recommended:!1,is_new:!0})}return e[d]=u,u}function i(p){const f=document.getElementById("report-tpl-list"),d=p.map((m,v)=>`
        ...
        `;f.innerHTML=d+u}function r(p){return p==null?"":String(p).replace(/[&<>"']/g,f=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[f])}function c(p){const f=new Date,d=f.getFullYear(),u=f.getMonth()+1;if(p==="all")return"all";if(p==="this-month")return`${d}-${String(u).padStart(2,"0")}`;if(p==="last-month"){const m=new Date(d,u-2,1);return`${m.getFullYear()}-${String(m.getMonth()+1).padStart(2,"0")}`}return p==="this-year"?`${d}`:p==="this-quarter"?`${d}-Q${Math.floor((u-1)/3)+1}`:"all"}window.openReportModal=async function(p){p=p||{},n(),typeof applyLang=="function"?applyLang(currentLang):document.querySelectorAll("#report-modal [data-i18n]").forEach(_=>{const y=_.getAttribute("data-i18n");I18N[currentLang]&&I18N[currentLang][y]&&(_.textContent=I18N[currentLang][y])});const f=document.getElementById("report-period-section");f&&(f.style.display=p.mode==="client"?"":"none");const d=document.getElementById("report-tpl-list");d.innerHTML=`<div class="report-tpl-loading">${r(t("report-modal-loading"))}</div>`,document.getElementById("report-modal").style.display="";const u=await s(currentLang,p&&p.mode);i(u),o=p;const m=document.getElementById("report-modal-download"),v=m.cloneNode(!0);m.parentNode.replaceChild(v,m),v.addEventListener("click",()=>l(o))};async function l(p){if(!p)return;const f=document.querySelector('input[name="report-tpl"]:checked');if(!f){showToast(t("report-toast-no-selection"),"info");return}const d=f.value,u=document.querySelector('input[name="report-period"]:checked'),m=u?u.value:"all",v=c(m),_=document.getElementById("report-modal-download"),y=_.innerHTML;_.disabled=!0,_.innerHTML=`<span>${r(t("report-modal-loading"))}</span>`;try{const b=localStorage.getItem("mrpilot_token");let h,L;if(p.mode==="records")h=await fetch("/api/reports/export",{method:"POST",headers:{Authorization:"Bearer "+b,"Content-Type":"application/json"},body:JSON.stringify({template:d,lang:currentLang,records:p.records||[],meta:p.meta||{}})}),L=`mrpilot-${d}-${Date.now()}.xlsx`;else if(p.mode==="client"){const S=`/api/reports/clients/${p.clientId}/export?template=${encodeURIComponent(d)}&lang=${encodeURIComponent(currentLang)}&month=${encodeURIComponent(v)}`;h=await fetch(S,{headers:{Authorization:"Bearer "+b}}),L=`${(p.clientName||"client").replace(/[^a-zA-Z0-9\u0e00-\u0e7f\u4e00-\u9fff]/g,"_").slice(0,40)}-${d}.xlsx`}else if(p.mode==="history-batch")d==="sales_detail_th"?(h=await fetch("/api/ocr/export-by-history-ids",{method:"POST",headers:{Authorization:"Bearer "+b,"Content-Type":"application/json"},body:JSON.stringify({template:"sales_detail_th",lang:currentLang,history_ids:p.historyIds||[],client_id:p.clientId||null})}),L=`Pearnly_SalesDetail_${Date.now()}.xlsx`):(h=await fetch("/api/reports/history/batch_export",{method:"POST",headers:{Authorization:"Bearer "+b,"Content-Type":"application/json"},body:JSON.stringify({template:d,lang:currentLang,history_ids:p.historyIds||[],client_id:p.clientId||null})}),L=`mrpilot-batch-${d}-${Date.now()}.xlsx`);else throw new Error("unknown mode: "+p.mode);if(!h.ok){let S="HTTP "+h.status;try{const T=await h.json();T&&T.detail&&(S=T.detail)}catch(T){console.warn("[batch-export] resp.json err.detail parse failed:",T)}h.status===404?showToast(t("report-toast-empty"),"info"):showToast(t("report-toast-fail")+" · "+S,"error");return}const g=await h.blob();let x=L;const E=(h.headers.get("Content-Disposition")||"").match(/filename\*=UTF-8''([^;]+)/i);if(E)try{x=decodeURIComponent(E[1])}catch{}const w=URL.createObjectURL(g),I=document.createElement("a");I.href=w,I.download=x,document.body.appendChild(I),I.click(),document.body.removeChild(I),URL.revokeObjectURL(w),showToast(t("report-toast-success"),"success"),a()}catch(b){console.error("doDownload fail",b),showToast(t("report-toast-fail")+" · "+(b.message||""),"error")}finally{_.disabled=!1,_.innerHTML=y}}document.addEventListener("DOMContentLoaded",()=>{const p=document.getElementById("btn-export");if(p){const d=p.cloneNode(!0);p.parentNode.replaceChild(d,p),d.addEventListener("click",()=>{if(typeof _results>"u"||!_results||_results.length===0){showToast(t("report-toast-no-selection"),"info");return}openReportModal({mode:"records",records:_results.map(u=>({filename:u.filename,merged_fields:u.merged_fields||{}}))})})}const f=document.getElementById("history-batch-export");f&&f.addEventListener("click",()=>{if(typeof _historySelected>"u"||_historySelected.size===0){showToast(t("report-toast-no-selection"),"info");return}openReportModal({mode:"history-batch",historyIds:Array.from(_historySelected)})})}),window.openClientExportModal=function(p,f){openReportModal({mode:"client",clientId:p,clientName:f||""})}})();(function(){const n=typeof window<"u"&&"showDirectoryPicker"in window,a=/\.(pdf|jpe?g|png|webp)$/i,o="mrpilot_folder_watcher",s=1;let i=null,r=null,c=null,l=60,p=!1,f=!1,d=0,u=0,m=0,v=[],_=null,y=!1;function b(){return i||(i=new Promise((j,R)=>{const q=indexedDB.open(o,s);q.onupgradeneeded=K=>{const V=K.target.result;V.objectStoreNames.contains("handles")||V.createObjectStore("handles"),V.objectStoreNames.contains("seen")||V.createObjectStore("seen"),V.objectStoreNames.contains("config")||V.createObjectStore("config")},q.onsuccess=K=>j(K.target.result),q.onerror=K=>R(K.target.error)}),i)}function h(j,R){return b().then(q=>new Promise((K,V)=>{const ce=q.transaction(j,"readonly").objectStore(j).get(R);ce.onsuccess=()=>K(ce.result),ce.onerror=()=>V(ce.error)}))}function L(j,R,q){return b().then(K=>new Promise((V,ae)=>{const ce=K.transaction(j,"readwrite");ce.objectStore(j).put(q,R),ce.oncomplete=()=>V(),ce.onerror=()=>ae(ce.error)}))}function g(j,R){return b().then(q=>new Promise((K,V)=>{const ae=q.transaction(j,"readwrite");ae.objectStore(j).delete(R),ae.oncomplete=()=>K(),ae.onerror=()=>V(ae.error)}))}function x(j){return b().then(R=>new Promise((q,K)=>{const V=R.transaction(j,"readwrite");V.objectStore(j).clear(),V.oncomplete=()=>q(),V.onerror=()=>K(V.error)}))}async function B(j){if(!j)return!1;try{const R={mode:"read"};let q=await j.queryPermission(R);return q==="granted"?!0:(q=await j.requestPermission(R),q==="granted")}catch(R){return console.warn("[folder] permission check failed:",R),!1}}function E(j,R){const q=document.getElementById("folder-status-summary");q&&(q.setAttribute("data-i18n",j),q.textContent=t(j),q.className="auto-status-pill"+(R?" "+R:""))}function w(j){["folder-unsupported","folder-empty","folder-active"].forEach(R=>{const q=document.getElementById(R);q&&(q.style.display=R===j?"":"none")})}function I(j){if(!j)return"-";const R=j instanceof Date?j:new Date(j),q=String(R.getHours()).padStart(2,"0"),K=String(R.getMinutes()).padStart(2,"0"),V=String(R.getSeconds()).padStart(2,"0");return`${q}:${K}:${V}`}function S(){w("folder-active");const j=document.getElementById("folder-config-path");j&&r&&(j.textContent=r.name||"-");const R=document.getElementById("folder-interval-select");R&&(R.value=String(l)),document.getElementById("folder-stat-last").textContent=_?I(_):"-",document.getElementById("folder-stat-processed").textContent=String(d),document.getElementById("folder-stat-failed").textContent=String(u),document.getElementById("folder-stat-queue").textContent=String(m);const q=document.getElementById("btn-folder-pause"),K=document.getElementById("btn-folder-resume");q&&(q.style.display=p?"none":""),K&&(K.style.display=p?"":"none"),p?E("folder-status-paused","paused"):E("folder-status-running","running");const V=document.getElementById("folder-status-text");V&&(V.setAttribute("data-i18n",p?"folder-status-paused":"folder-status-running"),V.textContent=t(p?"folder-status-paused":"folder-status-running"));const ae=document.getElementById("folder-status-pulse");ae&&(ae.className="folder-status-pulse"+(p?" paused":"")),T()}function T(){const j=document.getElementById("folder-recent-list");if(j){if(v.length===0){j.innerHTML=`<div class="folder-recent-empty">${escapeHtml(t("folder-recent-empty"))}</div>`;return}j.innerHTML=v.slice(0,20).map(R=>{let q;R.status==="ok"?q=`<span class="folder-recent-icon ok">${svgIcon("check",12)}</span>`:R.status==="dup"?q=`<span class="folder-recent-icon dup" title="${escapeHtml(t("folder-recent-dup"))}">${svgIcon("copy",12)}</span>`:R.status==="skip"?q=`<span class="folder-recent-icon skip" title="${escapeHtml(t("folder-recent-skip"))}">${svgIcon("minus",12)}</span>`:q=`<span class="folder-recent-icon fail">${svgIcon("alert",12)}</span>`;const K=R.status==="fail"&&R.error?R.error:R.status==="dup"&&R.reason||R.status==="skip"&&R.reason?R.reason:"",V=K?`<div class="folder-recent-err">${escapeHtml(K)}</div>`:"";return`
                <div class="folder-recent-item">
                    ...
                    <div class="folder-recent-time">${I(R.time)}</div>
                </div>
            `}).join("")}}function C(j){v.unshift(j),v.length>50&&(v.length=50),L("config","recent_list",v).catch(()=>{})}async function k(j){const R=new FormData;R.append("file",j,j.name),R.append("source","folder");const q=await fetch("/api/ocr/recognize?source=folder",{method:"POST",headers:{Authorization:"Bearer "+token,"X-Source":"folder"},body:R});if(!q.ok){let K="http_"+q.status;try{const V=await q.json();K=V&&V.detail?typeof V.detail=="string"?V.detail:V.detail.code||JSON.stringify(V.detail):K}catch{}throw new Error(K)}return await q.json()}async function M(j){try{const q=(await j.getFile()).size;return await new Promise(V=>setTimeout(V,3e3)),(await j.getFile()).size===q&&q>0}catch{return!1}}async function $(j,R,q,K){if(K>10)return;let V;try{V=await j.queryPermission({mode:"read"})}catch{V="denied"}if(V==="granted")for await(const ae of j.values()){const ce=R?`${R}/${ae.name}`:ae.name;if(ae.kind==="file"){if(!a.test(ae.name))continue;let be;try{be=await ae.getFile()}catch{continue}const Se=`${ce}::${be.size}::${be.lastModified}`;if(await h("seen",Se))continue;q.push({entry:ae,file:be,seenKey:Se,relPath:ce})}else if(ae.kind==="directory")try{await $(ae,ce,q,K+1)}catch{}}}async function A(){if(!(f||p||!r)){f=!0;try{if(await r.queryPermission({mode:"read"})!=="granted"){console.warn("[folder] permission lost · stop"),ue(),showToast("warn",t("folder-permission-lost"));return}_=new Date;const R=[];await $(r,"",R,0),m=R.length,S();for(const q of R){if(p)break;if(!await M(q.entry)){m=Math.max(0,m-1),S();continue}try{let V;try{V=await q.entry.getFile()}catch{V=q.file}const ae=await k(V);await L("seen",q.seenKey,{name:V.name,relPath:q.relPath,size:V.size,lastModified:V.lastModified,processed_at:Date.now()});const ce=ae.history_ids||(ae.history_id?[ae.history_id]:[]),be=ae.duplicate_warnings||[],Se=q.relPath||V.name;ce.length>0?(d+=ce.length,C({name:Se,status:"ok",time:new Date,history_id:ce[0],count:ce.length}),await L("config","processed_count",d)):be.length>0?C({name:Se,status:"dup",time:new Date,reason:t("folder-recent-dup-reason")}):C({name:Se,status:"skip",time:new Date,reason:t("folder-recent-skip-reason")})}catch(V){u++,C({name:q.relPath||q.file.name,status:"fail",time:new Date,error:String(V.message||V)}),await L("config","failed_count",u)}m=Math.max(0,m-1),S()}}catch(j){console.warn("[folder] scan error:",j)}finally{f=!1,S()}}}function H(){c&&clearInterval(c),c=setInterval(A,l*1e3)}function P(){c&&(clearInterval(c),c=null)}function F(j){if(!r||p)return;const R=typeof t=="function"?t("folder-unload-warn"):"Folder watcher running · close anyway?";return j.preventDefault(),j.returnValue=R,R}function G(){window._pearnlyFolderUnloadAttached||(window._pearnlyFolderUnloadAttached=!0,window.addEventListener("beforeunload",F))}function O(){window._pearnlyFolderUnloadAttached&&(window._pearnlyFolderUnloadAttached=!1,window.removeEventListener("beforeunload",F))}function ee(){p=!1,H(),G(),S(),A()}function de(){p=!0,P(),O(),S()}function me(){p=!1,H(),G(),S(),A()}function ue(){p=!0,P(),O()}async function re(){try{const j=await window.showDirectoryPicker({mode:"read",startIn:"documents"});if(!await B(j)){showToast("warn",t("folder-permission-denied"));return}r=j,await L("handles","main",j),d=0,u=0,m=0,v=[],await L("config","processed_count",0),await L("config","failed_count",0),await x("seen"),ee()}catch(j){j&&j.name!=="AbortError"&&console.warn("[folder] pick failed:",j)}}async function ve(){await showConfirm(t("folder-confirm-remove"),{danger:!0})&&(ue(),r=null,d=0,u=0,m=0,v=[],await g("handles","main"),await g("config","processed_count"),await g("config","failed_count"),await x("seen"),w("folder-empty"),E("folder-status-empty",""))}async function he(){v=[];try{await g("config","recent_list")}catch{}T()}async function D(){if(y)return;if(y=!0,!n){w("folder-unsupported"),E("folder-status-unsupported",""),Q();return}z();let j=null;try{j=await h("handles","main")}catch{}if(!j){w("folder-empty"),E("folder-status-empty","");return}if(!await B(j)){w("folder-empty"),E("folder-status-empty",""),await g("handles","main"),showToast("warn",t("folder-permission-lost-restart"));return}r=j;try{d=await h("config","processed_count")||0}catch{}try{u=await h("config","failed_count")||0}catch{}try{const q=await h("config","recent_list");Array.isArray(q)&&(v=q.map(K=>({...K,time:K.time?new Date(K.time):new Date})))}catch{}ee()}function z(){const j=document.getElementById("btn-folder-pick"),R=document.getElementById("btn-folder-pause"),q=document.getElementById("btn-folder-resume"),K=document.getElementById("btn-folder-scan-now"),V=document.getElementById("btn-folder-remove"),ae=document.getElementById("btn-folder-clear-recent"),ce=document.getElementById("folder-interval-select");j&&j.addEventListener("click",re),R&&R.addEventListener("click",de),q&&q.addEventListener("click",me),K&&K.addEventListener("click",()=>{A()}),V&&V.addEventListener("click",ve),ae&&ae.addEventListener("click",he),ce&&ce.addEventListener("change",be=>{l=parseInt(be.target.value,10)||60,p||H()}),X()}function X(){document.querySelectorAll('[data-auto-panel="folder"] [data-tab-jump]').forEach(j=>{j.dataset.tabJumpBound||(j.dataset.tabJumpBound="1",j.addEventListener("click",R=>{const q=R.currentTarget.dataset.tabJump;if(q==="email")typeof switchAutomationTab=="function"&&switchAutomationTab("email");else if(q==="upload"){const K=document.querySelector('[data-page="recognize"]')||document.querySelector('[data-page="upload"]');K&&K.click()}}))})}function Q(){X()}window._loadFolderWatcherPanel=D;function Z(){try{if(navigator.userAgentData&&Array.isArray(navigator.userAgentData.brands))return navigator.userAgentData.brands.some(R=>/chromium|google chrome|microsoft edge/i.test(R.brand||""))}catch{}const j=navigator.userAgent||"";return!!(/Edg\//.test(j)||/Chrome\//.test(j)&&!/OPR\/|YaBrowser|Opera/.test(j))}function oe(){try{if(Z()||localStorage.getItem("pearnly_chrome_banner_dismissed")==="1")return;const j=document.getElementById("chrome-only-banner");if(!j)return;const R=j.querySelector('[data-i18n="chrome-banner-msg"]'),q=j.querySelector('[data-i18n="chrome-banner-dismiss"]');R&&typeof t=="function"&&(R.textContent=t("chrome-banner-msg")),q&&typeof t=="function"&&(q.textContent=t("chrome-banner-dismiss")),j.style.display="";const K=document.getElementById("chrome-only-banner-close");K&&!K.dataset.bound&&(K.dataset.bound="1",K.addEventListener("click",()=>{j.style.display="none";try{localStorage.setItem("pearnly_chrome_banner_dismissed","1")}catch{}}))}catch{}}typeof document<"u"&&(document.readyState==="loading"?document.addEventListener("DOMContentLoaded",oe):setTimeout(oe,0)),window._refreshChromeBanner=oe})();const Ts=`
        <div class="modal">
            <div class="modal-head">
    ...
    `;we("email-modal",Ts);(function(){let e=null,n=null,a="new",o=!1,s=!1;async function i(){const k=document.getElementById("email-empty"),M=document.getElementById("email-account-card");if(document.getElementById("email-logs-section"),!(!k||!M))try{const $=await fetch("/api/email-ingest/account",{headers:{Authorization:"Bearer "+token}});if($.status===401){localStorage.removeItem("mrpilot_token");const H=await $.json().catch(()=>({}));if((typeof H.detail=="string"?H.detail:H.detail&&H.detail.code||"")==="auth.session_revoked"){_showSessionRevokedModal();return}window.location.href="/";return}if(!$.ok){c("none");return}const A=await $.json();e=A.account||null,n=A.presets||{},o=!0,r(),e&&I()}catch($){console.error("[email-ingest] load failed",$),c("none")}}function r(){const k=document.getElementById("email-empty"),M=document.getElementById("email-account-card"),$=document.getElementById("email-logs-section");if(!e){k.style.display="",M.style.display="none",$&&($.style.display="none"),c("none");return}k.style.display="none",M.style.display="",$&&($.style.display="");const A=document.getElementById("email-account-addr"),H=document.getElementById("email-account-host"),P=document.getElementById("email-account-last"),F=document.getElementById("email-last-error"),G=document.getElementById("email-enabled-toggle");if(A&&(A.textContent=e.email_address||"-"),H&&(H.textContent=`${e.imap_host||"-"}:${e.imap_port||993}`),P){const O=e.last_fetched_at;if(!O)P.textContent=t("email-last-never");else{const ee=l(O),de=!e.last_error;P.textContent=de?t("email-last-ok",{time:ee}):t("email-last-fail",{time:ee})}}F&&(e.last_error?(F.style.display="",F.textContent=p(e.last_error)):F.style.display="none"),G&&(G.checked=!!e.enabled),e.enabled?e.last_error?c("error"):c("on"):c("off")}function c(k){const M=document.getElementById("email-status-summary");if(!M)return;M.classList.remove("none","ready","active","coming");let $="auto-status-loading";k==="none"?($="email-status-none",M.classList.add("none")):k==="on"?($="email-status-on",M.classList.add("active")):k==="off"?($="email-status-off",M.classList.add("coming")):k==="error"&&($="email-status-error",M.classList.add("none")),M.setAttribute("data-i18n",$),M.textContent=t($)}function l(k){if(!k)return"";const M=new Date(k);if(isNaN(M.getTime()))return"";const $=A=>String(A).padStart(2,"0");return`${$(M.getMonth()+1)}-${$(M.getDate())} ${$(M.getHours())}:${$(M.getMinutes())}`}function p(k){if(!k)return"";const M=String(k);return/auth|AUTHENTICATIONFAILED|invalid credentials/i.test(M)?t("email-test-auth-fail"):/timeout|timed out/i.test(M)?t("email.timeout"):(/ENOTFOUND|getaddrinfo/i.test(M),M)}function f(k){a=k;const M=document.getElementById("email-modal");if(!M)return;const $=document.getElementById("email-preset");$.innerHTML="";const A=n||{},H=["gmail","outlook","yahoo","icloud","qq","163","custom"],P={gmail:"Gmail",outlook:"Outlook / Office365",yahoo:"Yahoo Mail",icloud:"iCloud",qq:"QQ 邮箱",163:"网易 163"};H.forEach(z=>{if(!A[z])return;const X=document.createElement("option");X.value=z,X.textContent=z==="custom"?t("email-preset-custom"):P[z]||z,$.appendChild(X)});const F=document.getElementById("email-modal-title"),G=document.getElementById("email-address"),O=document.getElementById("email-password"),ee=document.getElementById("email-imap-host"),de=document.getElementById("email-imap-port"),me=document.getElementById("email-imap-ssl"),ue=document.getElementById("email-folder"),re=document.getElementById("email-mark-read"),ve=document.getElementById("email-bind-enabled"),he=document.getElementById("email-test-result"),D=document.getElementById("email-adv-details");if(he&&(he.style.display="none",he.textContent=""),k==="edit"&&e){F.setAttribute("data-i18n","email-modal-title-edit"),F.textContent=t("email-modal-title-edit"),G.value=e.email_address||"",O.value="",O.setAttribute("data-i18n-placeholder","email-field-password-edit-ph"),O.placeholder=t("email-field-password-edit-ph"),ee.value=e.imap_host||"",de.value=e.imap_port||993,me.checked=e.imap_use_ssl!==!1,ue.value=e.folder||"INBOX",re.checked=e.mark_as_read!==!1,ve.checked=e.enabled!==!1;const z=document.getElementById("email-filter-sender"),X=document.getElementById("email-filter-subject");z&&(z.value=e.filter_sender||""),X&&(X.value=e.filter_subject||""),h(e.interval_min||15),$.value=_(e.imap_host)||"custom",D&&(D.open=!0)}else{F.setAttribute("data-i18n","email-modal-title-new"),F.textContent=t("email-modal-title-new"),G.value="",O.value="",O.setAttribute("data-i18n-placeholder","email-field-password-ph"),O.placeholder=t("email-field-password-ph"),$.value="gmail",u("gmail"),ue.value="INBOX",re.checked=!0,ve.checked=!0;const z=document.getElementById("email-filter-sender"),X=document.getElementById("email-filter-subject");z&&(z.value=""),X&&(X.value=""),h(15),D&&(D.open=!1)}b(),M.style.display="flex",setTimeout(()=>G.focus(),60)}function d(){const k=document.getElementById("email-modal");k&&(k.style.display="none")}function u(k){const M=(n||{})[k];if(!M||k==="custom")return;const $=document.getElementById("email-imap-host"),A=document.getElementById("email-imap-port"),H=document.getElementById("email-imap-ssl");$&&($.value=M.host||""),A&&(A.value=M.port||993),H&&(H.checked=M.ssl!==!1)}const m={"gmail.com":"gmail","googlemail.com":"gmail","outlook.com":"outlook","hotmail.com":"outlook","live.com":"outlook","office365.com":"outlook","msn.com":"outlook","yahoo.com":"yahoo","yahoo.co.jp":"yahoo","icloud.com":"icloud","me.com":"icloud","mac.com":"icloud","qq.com":"qq","foxmail.com":"qq","163.com":"163","126.com":"163","yeah.net":"163"};function v(k){if(!k||!k.includes("@"))return;const M=k.split("@")[1].toLowerCase().trim(),$=m[M];if(!$)return;const A=document.getElementById("email-preset");if(!A)return;const H=A.value;H&&H!=="custom"&&H!==""&&H===$||(A.value=$,u($))}function _(k){if(!k)return null;const M=n||{};for(const $ in M)if($!=="custom"&&M[$]&&M[$].host===k)return $;return null}function y(){const k=document.querySelector("#email-interval-options .email-interval-btn.active"),M=k?parseInt(k.dataset.interval,10):15;return{email_address:(document.getElementById("email-address").value||"").trim(),password:document.getElementById("email-password").value||"",imap_host:(document.getElementById("email-imap-host").value||"").trim(),imap_port:parseInt(document.getElementById("email-imap-port").value||"993",10)||993,imap_use_ssl:document.getElementById("email-imap-ssl").checked,folder:(document.getElementById("email-folder").value||"INBOX").trim()||"INBOX",mark_as_read:document.getElementById("email-mark-read").checked,enabled:document.getElementById("email-bind-enabled").checked,interval_min:[5,15,60].includes(M)?M:15,filter_sender:(document.getElementById("email-filter-sender").value||"").trim()||null,filter_subject:(document.getElementById("email-filter-subject").value||"").trim()||null}}function b(){const k=document.getElementById("email-interval-options");!k||k._bound||(k._bound=!0,k.addEventListener("click",M=>{const $=M.target.closest(".email-interval-btn");$&&(k.querySelectorAll(".email-interval-btn").forEach(A=>A.classList.remove("active")),$.classList.add("active"))}))}function h(k){const M=[5,15,60].includes(k)?k:15,$=document.getElementById("email-interval-options");$&&$.querySelectorAll(".email-interval-btn").forEach(A=>{A.classList.toggle("active",parseInt(A.dataset.interval,10)===M)})}function L(k,M){const $=document.getElementById("email-test-result");$&&($.style.display="",$.textContent=M,$.className="form-test-result "+(k==="ok"?"ok":k==="running"?"running":"fail"))}async function g(){const k=y();if(!k.email_address){L("fail",t("email-addr-required"));return}if(!k.password){L("fail",t("email-password-required"));return}if(!k.imap_host){L("fail",t("email-host-required"));return}const M=document.getElementById("btn-email-modal-test");M&&(M.disabled=!0),L("running",t("email-test-running"));try{const $=await fetch("/api/email-ingest/test",{method:"POST",headers:{Authorization:"Bearer "+token,"Content-Type":"application/json"},body:JSON.stringify({email_address:k.email_address,password:k.password,imap_host:k.imap_host,imap_port:k.imap_port,imap_use_ssl:k.imap_use_ssl,folder:k.folder})}),A=await $.json().catch(()=>({}));if($.ok&&A.success)L("ok",t("email-test-ok",{folder:k.folder,n:A.folder_count??"?"}));else{const H=A.error_msg||"";H==="auth_failed"||/auth/i.test(H)?L("fail",t("email-test-auth-fail")):L("fail",t("email-test-fail",{msg:H||$.status}))}}catch($){L("fail",t("email-test-fail",{msg:String($).slice(0,120)}))}finally{M&&(M.disabled=!1)}}async function x(){const k=y();if(!k.email_address){L("fail",t("email-addr-required"));return}if(a==="new"&&!k.password){L("fail",t("email-password-required"));return}if(!k.imap_host){L("fail",t("email-host-required"));return}const M=document.getElementById("btn-email-modal-save");M&&(M.disabled=!0);const $={...k};a==="edit"&&!$.password&&delete $.password;try{const A=await fetch("/api/email-ingest/account",{method:"PUT",headers:{Authorization:"Bearer "+token,"Content-Type":"application/json"},body:JSON.stringify($)}),H=await A.json().catch(()=>({}));if(A.ok&&H.ok)e=H.account,showToast(t("email-save-ok"),"success"),d(),r(),I();else{const F="email."+(H.detail||"").split(".").slice(-1)[0];L("fail",t(F)!==F?t(F):t("email-save-fail"))}}catch{L("fail",t("email-save-fail"))}finally{M&&(M.disabled=!1)}}async function B(){if(!(!e||!await showConfirm(t("email-unbind-confirm",{email:e.email_address}),{danger:!0,okText:t("email-btn-unbind")})))try{if((await fetch("/api/email-ingest/account",{method:"DELETE",headers:{Authorization:"Bearer "+token}})).ok){e=null,showToast(t("email-unbind-ok"),"success"),r();const $=document.getElementById("email-logs-list");$&&($.innerHTML="")}else showToast(t("email-unbind-fail"),"error")}catch{showToast(t("email-unbind-fail"),"error")}}async function E(){if(!e||s)return;if(!e.enabled){showToast(t("email.disabled"),"error");return}s=!0;const k=document.getElementById("btn-email-trigger"),M=k?k.innerHTML:"";k&&(k.disabled=!0,k.innerHTML=`<span>${escapeHtml(t("email-trigger-running"))}</span>`);try{const $=await fetch("/api/email-ingest/trigger",{method:"POST",headers:{Authorization:"Bearer "+token}}),A=await $.json().catch(()=>({}));if($.ok){const H=A.emails_scanned||0,P=A.ocr_succeeded||0,F=A.ocr_failed||0;H===0&&P===0&&F===0?showToast(t("email-trigger-empty"),"success"):showToast(t("email-trigger-result",{scanned:H,ok:P,fail:F}),F>0?"warn":"success")}else{const P="email."+(A.detail||"").split(".").slice(-1)[0];showToast(t(P)!==P?t(P):t("email-trigger-fail"),"error")}await i()}catch{showToast(t("email-trigger-fail"),"error")}finally{s=!1,k&&(k.disabled=!1,k.innerHTML=M)}}async function w(){if(!e)return;const k=document.getElementById("email-enabled-toggle"),M=!!(k&&k.checked),$=e.enabled;try{const A=await fetch("/api/email-ingest/account",{method:"PUT",headers:{Authorization:"Bearer "+token,"Content-Type":"application/json"},body:JSON.stringify({email_address:e.email_address,imap_host:e.imap_host,imap_port:e.imap_port,imap_use_ssl:e.imap_use_ssl,folder:e.folder||"INBOX",filter_subject:e.filter_subject||null,filter_sender:e.filter_sender||null,mark_as_read:e.mark_as_read!==!1,enabled:M})}),H=await A.json().catch(()=>({}));A.ok&&H.ok?(e=H.account,r()):(k&&(k.checked=$),showToast(t("email-toggle-fail"),"error"))}catch{k&&(k.checked=$),showToast(t("email-toggle-fail"),"error")}}async function I(){const k=document.getElementById("email-logs-list");if(k){k.innerHTML=`<div class="erp-logs-empty">${escapeHtml(t("erp-logs-loading"))}</div>`;try{const M=await fetch("/api/email-ingest/logs?limit=20",{headers:{Authorization:"Bearer "+token}});if(!M.ok){k.innerHTML=`<div class="erp-logs-empty">${escapeHtml(t("erp-logs-error"))}</div>`;return}const $=await M.json();if(!Array.isArray($)||$.length===0){k.innerHTML=`<div class="erp-logs-empty">${escapeHtml(t("email-logs-empty"))}</div>`;return}k.innerHTML=$.map(S).join("")}catch{k.innerHTML=`<div class="erp-logs-empty">${escapeHtml(t("erp-logs-error"))}</div>`}}}function S(k){const M=l(k.created_at),$=k.status||"failed",A=$==="success"?"ok":$==="partial"?"partial":"fail",H=$==="success"?"✓":$==="partial"?"◐":"✗",P=k.trigger==="manual"?`<span class="log-tag manual">${escapeHtml(t("email-log-tag-manual"))}</span>`:`<span class="log-tag auto">${escapeHtml(t("email-log-tag-auto"))}</span>`,F=t("email-log-counts",{scanned:k.emails_scanned||0,att:k.attachments_found||0,ok:k.ocr_succeeded||0,fail:k.ocr_failed||0}),G=(k.elapsed_ms||0)+"ms";return`
        ...
        `}function T(){const k=document.getElementById("btn-email-bind");k&&k.addEventListener("click",()=>f("new"));const M=document.getElementById("btn-email-edit");M&&M.addEventListener("click",()=>f("edit"));const $=document.getElementById("btn-email-unbind");$&&$.addEventListener("click",B);const A=document.getElementById("btn-email-trigger");A&&A.addEventListener("click",E);const H=document.getElementById("email-enabled-toggle");H&&H.addEventListener("change",w);const P=document.getElementById("email-modal-close");P&&P.addEventListener("click",d);const F=document.getElementById("btn-email-modal-cancel");F&&F.addEventListener("click",d);const G=document.getElementById("btn-email-modal-test");G&&G.addEventListener("click",g);const O=document.getElementById("btn-email-modal-save");O&&O.addEventListener("click",x);const ee=document.getElementById("email-preset");ee&&ee.addEventListener("change",ue=>u(ue.target.value));const de=document.getElementById("email-address");de&&!de.dataset.autoBound&&(de.dataset.autoBound="1",de.addEventListener("blur",ue=>v((ue.target.value||"").trim())),de.addEventListener("input",ue=>{const re=(ue.target.value||"").trim();re.includes("@")&&re.split("@")[1].includes(".")&&v(re)}));const me=document.getElementById("btn-email-refresh-logs");me&&me.addEventListener("click",()=>{me.classList.add("spinning"),setTimeout(()=>me.classList.remove("spinning"),600),I()})}T(),window._loadEmailIngestPanel=i,window._rerenderEmailIngest=function(){if(!o)return;r();const k=document.getElementById("email-logs-section");e&&k&&k.open&&I()};let C=null;window._startEmailLogAutoRefresh=function(){C||(C=setInterval(()=>{e&&o&&I()},3e4))},window._stopEmailLogAutoRefresh=function(){C&&(clearInterval(C),C=null)}})();const Ms=`
...
`,e.dataset.wbInjected="1";try{const n=window._currentLang||localStorage.getItem("mrpilot_lang")||"th",a=window.I18N;a&&a[n]&&(e.querySelectorAll("[data-i18n]").forEach(o=>{const s=o.getAttribute("data-i18n");a[n][s]&&(o.textContent=a[n][s])}),e.querySelectorAll("[data-i18n-placeholder]").forEach(o=>{const s=o.getAttribute("data-i18n-placeholder");a[n][s]&&(o.placeholder=a[n][s])}))}catch{}}})();const J={statsCache:null,listCache:[],currentRule:null,currentClient:"",currentStatus:"pending",loading:!1,selectedIds:new Set,offset:0,pageSize:50,total:0,loadFailed:!1,listScrollY:0},Y={openExcId:null,excRow:null,history:null,loading:!1,pdfUrl:null,pdfStatus:"idle",editing:!1,editFields:null},et={batchLoading:!1};function ze(e,n){let a=t(e)||e;if(n)for(const o in n)a=a.replace(new RegExp("\\{"+o+"\\}","g"),String(n[o]));return a}function yi(e){return e==="high"?`<svg viewBox="0 0 14 14" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
    ...
    `;const c=e.severity||"medium",l=t("exc-rule-"+e.rule_code)||e.rule_code,p=Ei(e.rule_code,e.detail||{}),f=Jn(Y.history),d=Y.history===null,u=Y.history&&Y.history._err,m=new Set;e.rule_code==="math_mismatch"?(m.add("subtotal"),m.add("vat"),m.add("total_amount")):e.rule_code==="tax_id_format_invalid"?m.add("seller_tax"):e.rule_code==="amount_missing"&&(m.add("total_amount"),m.add("invoice_number"));const v=!!Y.editing,_=Y.editFields||{},y=(C,k,M)=>{if(d)return`<div class="exc-field-row"><label>${escapeHtml(t(k))}</label><span class="val empty">…</span></div>`;const $=v?_[C]!==void 0?_[C]:f[C]!==void 0&&f[C]!==null?f[C]:"":f[C],A=m.has(C)?"flagged":"";if(v){const F=M?"number":"text",G=M?' step="0.01" inputmode="decimal"':"",O=$==null?"":String($).replace(/"/g,"&quot;");return`<div class="exc-field-row ${A} editing">
                <label>${escapeHtml(t(k))}</label>
                <input class="exc-field-input" type="${F}"${G} data-edit-key="${escapeHtml(C)}" value="${O}">
            </div>`}const H=M?Xe($):$||"",P=$==null||$===""?`<span class="val empty">${escapeHtml(t("exc-empty-val"))}</span>`:`<span class="val">${escapeHtml(H)}</span>`;return`<div class="exc-field-row ${A}"><label>${escapeHtml(t(k))}</label>${P}</div>`};let b="";u?b=`<div class="exc-drawer-error">${escapeHtml(t("exc-drawer-error"))}</div>`:b=`
        ...
        `;const h=(()=>{if(Y.pdfStatus==="loading"||Y.pdfStatus==="idle")return`
        ...
        <div class="exc-error">
            ...
            <div class="erp-exc-rows">
                <div class="erp-exc-row erp-exc-row-head">
                    ...
                    <span class="ex-inv">${escapeHtml(S)}</span>
            ...
            <div class="erp-exc-modal" role="dialog" aria-modal="true">
                ...
                <div class="erp-exc-m-body">
                    ...
                    ${h(m?t("erp-log-col-booking"):t("erp-exc-f-invoice"),u.invoice_no)}
                    ${h(m?t("erp-log-col-customer"):t("erp-exc-f-seller"),u.seller_name)}
                    ${m?h(t("erp-log-col-idcard"),u.id_card_tail?"••••"+u.id_card_tail:"—"):h(t("erp-exc-f-buyer"),u.ocr_buyer_name)+h(t("erp-exc-edit-field-current"),u.client_name)}
                    ${L}
                </div>
                <div class="erp-exc-m-foot">
            ...
            </div>`,document.body.appendChild(g),g.addEventListener("click",x=>{x.target===g&&f()}),document.getElementById("erp-exc-m-close").addEventListener("click",f),document.getElementById("erp-exc-m-cancel").addEventListener("click",f),document.getElementById("erp-exc-m-retry").addEventListener("click",()=>{f(),r(u.id,null)}),v){let x="";const B=document.getElementById("erp-exc-m-bind"),E=document.getElementById("erp-exc-m-custlist"),w=document.getElementById("erp-exc-m-search"),I=(T,C)=>{const k=(C||"").trim().toLowerCase(),M=k?T.filter($=>($.code||"").toLowerCase().includes(k)||($.name||"").toLowerCase().includes(k)):T;if(M.length===0){E.innerHTML=`<div class="erp-exc-m-empty">${escapeHtml(t("erp-exc-edit-pick-empty"))}</div>`;return}E.innerHTML=M.slice(0,100).map($=>`<div class="erp-exc-m-cust" data-cust-code="${escapeHtml($.code||"")}">
                        <span class="erp-exc-m-cust-name">${escapeHtml($.name||"")}</span>
                        <span class="erp-exc-m-cust-code">${escapeHtml($.code||"")}</span>
                    </div>`).join(""),E.querySelectorAll(".erp-exc-m-cust").forEach($=>{$.addEventListener("click",()=>{x=$.dataset.custCode||"",E.querySelectorAll(".erp-exc-m-cust").forEach(A=>A.classList.remove("sel")),$.classList.add("sel"),B&&(B.disabled=!x)})})},S=async()=>{const T=u.endpoint_id;if(p[T]){I(p[T],"");return}try{const C=await fetch("/api/erp/endpoints/"+encodeURIComponent(T)+"/customers",{headers:{Authorization:"Bearer "+a()}}),k=await C.json().catch(()=>({}));if(!C.ok||!k.ok){E.innerHTML=`<div class="erp-exc-m-empty">${escapeHtml(t("erp-exc-edit-pick-fail"))}</div>`;return}const M=k.customers||[];p[T]=M,I(M,"")}catch{E.innerHTML=`<div class="erp-exc-m-empty">${escapeHtml(t("erp-exc-edit-pick-fail"))}</div>`}};w&&w.addEventListener("input",()=>I(p[u.endpoint_id]||[],w.value)),S(),B&&B.addEventListener("click",async()=>{if(x){B.disabled=!0,B.textContent=t("erp-exc-retrying");try{if(!(await fetch("/api/erp/mappings/clients",{method:"POST",headers:{Authorization:"Bearer "+a(),"Content-Type":"application/json"},body:JSON.stringify({client_id:u.history_client_id,erp_type:u.endpoint_adapter,erp_code:x})})).ok){showToast(t("erp-exc-retry-fail"),"error"),B.disabled=!1,B.textContent=t("erp-exc-edit-bind-retry");return}showToast(t("erp-exc-edit-bound-ok"),"success"),f(),await r(u.id,null)}catch{showToast(t("erp-exc-retry-fail"),"error"),B.disabled=!1,B.textContent=t("erp-exc-edit-bind-retry")}}})}if(_){const x=document.getElementById("erp-exc-m-bind-prod"),B=document.getElementById("erp-exc-m-prodlist"),E={};let w=[];const I=()=>'<option value="">'+escapeHtml(t("erp-exc-edit-prod-choose"))+"</option>"+w.slice(0,500).map(C=>`<option value="${escapeHtml(C.code||"")}" data-pname="${escapeHtml(C.name||"")}">`+escapeHtml((C.name||"")+" · "+(C.code||""))+"</option>").join(""),S=C=>{if(!C.length){B.innerHTML=`<div class="erp-exc-m-empty">${escapeHtml(t("erp-exc-edit-prod-noitems"))}</div>`;return}B.innerHTML=C.map(k=>`<div class="erp-exc-m-cust" style="cursor:default">
                    ...
                    </div>`).join(""),B.querySelectorAll(".erp-exc-m-prod-sel").forEach(k=>{k.addEventListener("change",()=>{const M=k.dataset.item,$=k.options[k.selectedIndex];k.value?E[M]={code:k.value,name:$&&$.dataset.pname||""}:delete E[M],x&&(x.disabled=Object.keys(E).length===0)})})};(async()=>{try{const k=await(await fetch("/api/history/"+encodeURIComponent(u.history_id),{headers:{Authorization:"Bearer "+a()}})).json().catch(()=>({})),M=k&&k.pages||[],$=[],A={};(Array.isArray(M)?M:[]).forEach(F=>{const G=F&&F.fields&&F.fields.items||[];(Array.isArray(G)?G:[]).forEach(O=>{const ee=(O&&(O.name||O.description)||"").trim();ee&&!A[ee]&&(A[ee]=1,$.push(ee))})});const H=await fetch("/api/erp/endpoints/"+encodeURIComponent(u.endpoint_id)+"/products",{headers:{Authorization:"Bearer "+a()}}),P=await H.json().catch(()=>({}));if(!H.ok||!P.ok){B.innerHTML=`<div class="erp-exc-m-empty">${escapeHtml(t("erp-exc-edit-prod-fail"))}</div>`;return}w=P.products||[],S($)}catch{B.innerHTML=`<div class="erp-exc-m-empty">${escapeHtml(t("erp-exc-edit-prod-fail"))}</div>`}})(),x&&x.addEventListener("click",async()=>{const C=Object.entries(E);if(C.length){x.disabled=!0,x.textContent=t("erp-exc-retrying");try{for(const[k,M]of C)if(!(await fetch("/api/erp/mappings/products",{method:"POST",headers:{Authorization:"Bearer "+a(),"Content-Type":"application/json"},body:JSON.stringify({erp_type:u.endpoint_adapter,item_name:k,erp_code:M.code,erp_name:M.name})})).ok){showToast(t("erp-exc-retry-fail"),"error"),x.disabled=!1,x.textContent=t("erp-exc-edit-bind-prod-retry");return}showToast(t("erp-exc-edit-prod-bound-ok"),"success"),f(),await r(u.id,null)}catch{showToast(t("erp-exc-retry-fail"),"error"),x.disabled=!1,x.textContent=t("erp-exc-edit-bind-prod-retry")}}})}},window._rerenderErpExceptions=i,window.loadErpExceptions=l,window._erpExcState=e})();const ji=`
    <div class="cmdk">
...
`;we("cmdk-mask",ji);(function(){function e(d){try{if(location.search.indexOf("test_center=1")>=0||localStorage.getItem("pearnly_test_mode")==="1"||d&&d.id&&String(d.id)==="468b50c1-5593-4fd6-990d-515ce8085563")return!0}catch{}return!1}window.applyRoleVisibility=function(){var u=window._userInfo,m=!1,v=!0,_=!1,y=!1;u&&(m=typeof canManageTeam=="function"?canManageTeam(u):!!(u.role==="owner"||u.is_super_admin),v=typeof shouldHideMoney=="function"?shouldHideMoney(u):u.role==="member"&&!u.is_super_admin,_=typeof isSuperAdmin=="function"?isSuperAdmin(u):!!u.is_super_admin,y=e(u)),document.querySelectorAll("[data-show-if-team]").forEach(function(h){h.style.display=m?"":"none"}),document.querySelectorAll("[data-show-if-money]").forEach(function(h){h.style.display=v?"none":""}),document.querySelectorAll("[data-show-if-admin]").forEach(function(h){h.style.display=_?"":"none"}),document.querySelectorAll("[data-show-if-test]").forEach(function(h){h.style.display=y?"":"none"});var b=_||y;document.querySelectorAll("[data-show-if-special]").forEach(function(h){h.style.display=b?"":"none"})},window.renderAvatarMenu=function(u){if(u){var m=document.getElementById("avatar-btn"),v=document.getElementById("avatar-popup-name"),_=document.getElementById("avatar-popup-email");if(!(!m||!v||!_)){var y=(u.username||"").trim(),b=y.split("@")[0]||y||"—",h=(y.charAt(0)||"?").toUpperCase(),L=(u.avatar_url||"").trim();if(L){var g=L.replace(/"/g,"&quot;"),x=h.replace(/'/g,"\\'");m.innerHTML='<img src="'+g+'" alt="'+h+`" referrerpolicy="no-referrer" onerror="this.parentNode.textContent='`+x+`'">`}else m.textContent=h;v.textContent=b,_.textContent=y||"—",m.setAttribute("title",y||"")}}};function n(){var d=document.getElementById("avatar-wrap"),u=document.getElementById("avatar-btn"),m=document.getElementById("avatar-popup");if(!d||!u||!m)return;function v(){m.classList.remove("show"),u.setAttribute("aria-expanded","false")}function _(){m.classList.add("show"),u.setAttribute("aria-expanded","true")}u.addEventListener("click",function(y){y.stopPropagation(),m.classList.contains("show")?v():_()}),document.addEventListener("click",function(y){m.classList.contains("show")&&!d.contains(y.target)&&v()}),m.addEventListener("click",function(y){var b=y.target.closest(".avatar-popup-item");if(b){var h=b.dataset.action;switch(v(),h){case"settings":typeof openSettingsModal=="function"?openSettingsModal():typeof routeTo=="function"&&routeTo("settings");break;case"team":typeof openSettingsModal=="function"?openSettingsModal():typeof routeTo=="function"&&routeTo("settings"),setTimeout(function(){typeof switchSettingsTab=="function"&&switchSettingsTab("team")},50);break;case"billing":typeof openSettingsModal=="function"?openSettingsModal():typeof routeTo=="function"&&routeTo("settings"),setTimeout(function(){typeof switchSettingsTab=="function"&&switchSettingsTab("plan")},50);break;case"shortcuts":if(typeof showToast=="function"){var L=typeof t=="function"?t("feature-coming-soon"):"即将上线";showToast(L||"即将上线","info")}break;case"admin":window.location.href="/admin/cost";break;case"test-center":typeof routeTo=="function"&&routeTo("test-center");break;case"help":var g=document.getElementById("help-modal");g&&(g.style.display="flex");break;case"logout":try{localStorage.removeItem("mrpilot_token")}catch{}try{localStorage.removeItem("mrpilot_user")}catch{}window.location.href="/";break}}}),window._closeAvatarPopup=v}function a(){return[].slice.call(document.querySelectorAll(".cmdk-item")).filter(function(d){return d.style.display!=="none"})}function o(d){var u=a();u.forEach(function(m){m.classList.remove("focus")}),u[d]&&(u[d].classList.add("focus"),u[d].scrollIntoView({block:"nearest"}))}function s(d){var u=a();if(u.length){var m=u.findIndex(function(_){return _.classList.contains("focus")});m<0&&(m=0);var v=(m+d+u.length)%u.length;o(v)}}function i(d){d=(d||"").toLowerCase().trim();var u=0,m=window._userInfo,v=typeof isSuperAdmin=="function"?isSuperAdmin(m):!!(m&&m.is_super_admin),_=e(m);document.querySelectorAll(".cmdk-item").forEach(function(b){if(b.dataset.showIfAdmin==="1"&&!v){b.style.display="none";return}if(b.dataset.showIfTest==="1"&&!_){b.style.display="none";return}var h=(b.dataset.cmdkText||b.textContent||"").toLowerCase(),L=!d||h.indexOf(d)>=0;b.style.display=L?"":"none",b.classList.remove("focus"),L&&u++}),document.querySelectorAll("[data-cmdk-section]").forEach(function(b){for(var h=b.nextElementSibling,L=!1;h&&!h.hasAttribute("data-cmdk-section");){if(h.classList&&h.classList.contains("cmdk-item")&&h.style.display!=="none"){L=!0;break}h=h.nextElementSibling}b.style.display=L?"":"none"});var y=document.getElementById("cmdk-empty");y&&(y.style.display=u===0?"flex":"none"),o(0)}window.openCmdk=function(){var u=document.getElementById("cmdk-mask");u&&(typeof window._closeAvatarPopup=="function"&&window._closeAvatarPopup(),u.classList.add("show"),typeof window.applyRoleVisibility=="function"&&window.applyRoleVisibility(),setTimeout(function(){var m=document.getElementById("cmdk-input");m&&(m.value="",i(""),m.focus(),o(0))},50))},window.closeCmdk=function(){var u=document.getElementById("cmdk-mask");u&&u.classList.remove("show")};function r(d){if(d){if(d.classList.contains("cmdk-item-locked")){if(typeof showToast=="function"){var u=typeof t=="function"?t("feature-coming-soon"):"即将上线";showToast(u||"即将上线","info")}return}var m=d.dataset.cmdkRoute,v=d.dataset.cmdkAction;if(window.closeCmdk(),m){typeof routeTo=="function"&&routeTo(m);return}if(v){if(v==="open-admin"){window.location.href="/admin/cost";return}if(v.indexOf("lang-")===0){var _=v.slice(5);typeof applyLang=="function"&&applyLang(_)}}}}function c(){var d=document.getElementById("cmdk-mask"),u=document.getElementById("cmdk-input"),m=document.getElementById("cmdk-body");if(!(!d||!u||!m)){d.addEventListener("click",function(y){y.target===d&&window.closeCmdk()});var v=document.getElementById("cmdk-esc-btn");v&&v.addEventListener("click",function(){window.closeCmdk()}),u.addEventListener("input",function(y){i(y.target.value)}),u.addEventListener("keydown",function(y){y.key==="ArrowDown"?(y.preventDefault(),s(1)):y.key==="ArrowUp"?(y.preventDefault(),s(-1)):y.key==="Enter"?(y.preventDefault(),r(d.querySelector(".cmdk-item.focus"))):y.key==="Escape"&&(y.preventDefault(),window.closeCmdk())}),m.addEventListener("click",function(y){var b=y.target.closest(".cmdk-item");b&&r(b)}),m.addEventListener("mousemove",function(y){var b=y.target.closest(".cmdk-item");!b||b.style.display==="none"||b.classList.contains("cmdk-item-locked")||(a().forEach(function(h){h.classList.remove("focus")}),b.classList.add("focus"))});var _=document.getElementById("topbar-search");_&&(_.addEventListener("click",function(){window.openCmdk()}),_.addEventListener("keydown",function(y){(y.key==="Enter"||y.key===" ")&&(y.preventDefault(),window.openCmdk())}))}}document.addEventListener("keydown",function(d){if((d.metaKey||d.ctrlKey)&&(d.key==="k"||d.key==="K")){d.preventDefault(),window.openCmdk();return}if(d.key==="Escape"){var u=document.getElementById("cmdk-mask");if(u&&u.classList.contains("show")){window.closeCmdk();return}var m=document.getElementById("avatar-popup");m&&m.classList.contains("show")&&typeof window._closeAvatarPopup=="function"&&window._closeAvatarPopup()}});try{var l=(navigator.userAgent||"").toLowerCase(),p=l.indexOf("mac")>=0||l.indexOf("iphone")>=0||l.indexOf("ipad")>=0;p||document.body.classList.add("is-windows")}catch{}function f(){n(),c(),typeof window.subscribeI18n=="function"&&window.subscribeI18n("nav-ia-phase1-role",function(){try{typeof window.applyRoleVisibility=="function"&&window.applyRoleVisibility()}catch{}})}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",f):f()})();(function(){function n(v){return String(v??"").replace(/[&<>"']/g,function(_){return{"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"}[_]})}function a(v){if(!v||isNaN(v))return"";var _=Number(v);return _<1024?_+" B":_<1024*1024?(_/1024).toFixed(1)+" KB":(_/1024/1024).toFixed(1)+" MB"}document.addEventListener("click",function(v){var _=v.target.closest&&v.target.closest(".recon-collapse-head");if(_&&!(v.target.closest("button")||v.target.closest("a"))){var y=_.closest(".recon-collapse");if(y){var b=y.getAttribute("data-collapsed")==="true";y.setAttribute("data-collapsed",b?"false":"true"),b&&(y.id==="vex-summary-collapse"&&f(),y.id==="vex-detail-collapse"&&d())}}}),document.addEventListener("keydown",function(v){if(!(v.key!=="Enter"&&v.key!==" ")){var _=v.target.closest&&v.target.closest(".recon-collapse-head");_&&(v.preventDefault(),_.click())}});var o={vat:"",gl:""};window._glvClearPreviewSearch=function(){o.vat="",o.gl=""};var s='<svg class="vex-pp-fi-icon" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#111111" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/></svg>',i='<svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg>';function r(){l("vat"),l("gl")}function c(v){try{if(typeof window._glvPreviewFiles=="function")return window._glvPreviewFiles(v)||[]}catch{}var _=document.getElementById(v==="vat"?"glv-vat-input":"glv-gl-input");return _&&_.files?Array.from(_.files):[]}function l(v){var _=document.getElementById(v==="vat"?"glv-pp-vat-col":"glv-pp-gl-col");if(_){var y=c(v),b=v==="vat"?"glv-up-vat-title":"glv-up-gl-title",h=v==="vat"?"① 销项税报告":"② 总账 GL",L=window.t&&window.t(b)||h,g=n(window.t&&window.t("vex-preview-search")||"搜索文件名..."),x=n(window.t&&window.t("vex-preview-clear-all")||"全清"),B=o[v]||"",E=y.length;_.innerHTML='<div class="vex-pp-col-title"><span class="vex-pp-col-name">'+n(L)+' <span class="vex-pp-col-count">'+E+'</span></span></div><div class="vex-pp-search-row"><input class="vex-pp-search" id="glv-pp-search-'+v+'" type="text" placeholder="'+g+'" value="'+n(B)+'" autocomplete="off"><button class="vex-pp-clear-btn" id="glv-pp-clearall-'+v+'" type="button">'+x+'</button></div><div class="vex-pp-file-list" id="glv-pp-'+v+'-list"></div><div class="vex-pp-pagination" id="glv-pp-'+v+'-pg"></div>';var w=document.getElementById("glv-pp-search-"+v);w&&w.addEventListener("input",function(S){o[v]=S.target.value,p(v)});var I=document.getElementById("glv-pp-clearall-"+v);I&&I.addEventListener("click",function(){window._glvRemoveFile&&window._glvRemoveFile(v)}),p(v)}}function p(v){var _=document.getElementById("glv-pp-"+v+"-list"),y=document.getElementById("glv-pp-"+v+"-pg");if(_){var b=c(v),h=(o[v]||"").toLowerCase(),L=b.map(function(B,E){return{f:B,i:E}}),g=h?L.filter(function(B){return B.f.name.toLowerCase().indexOf(h)>=0}):L;if(_.innerHTML=g.map(function(B){var E=B.f;return'<div class="vex-pp-file-row">'+s+'<span class="vex-pp-fi-name" title="'+n(E.name)+'">'+n(E.name)+'</span><span class="vex-pp-fi-size">'+a(E.size)+'</span><button class="vex-pp-fi-del" type="button" data-kind="'+v+'" data-idx="'+B.i+'" aria-label="remove">'+i+"</button></div>"}).join(""),_.querySelectorAll(".vex-pp-fi-del").forEach(function(B){B.addEventListener("click",function(){var E=B.dataset.kind,w=parseInt(B.dataset.idx,10);window._glvRemoveFile&&window._glvRemoveFile(E,isNaN(w)?null:w)})}),y){var x=window.t&&window.t("vex-preview-count")||"显示前 {n} / 共 {m}";y.textContent=x.replace("{n}",g.length).replace("{m}",g.length)}}}function f(){var v=function(y,b){var h=document.getElementById(y);h&&(h.textContent=b==null?"—":String(b))},_=window._vexLastTask||{};v("vex-sum-total",_.total),v("vex-sum-matched",_.matched),v("vex-sum-diff",_.diff),v("vex-sum-incomplete",_.incomplete),v("vex-sum-cash",_.cash),document.getElementById("vex-summary-sub")}function d(){var v=window._vexLastTask&&window._vexLastTask.diff_rows||[],_=document.getElementById("vex-detail-tbody"),y=document.getElementById("vex-detail-table"),b=document.getElementById("vex-detail-empty");if(!(!_||!y||!b)){if(v.length===0){y.style.display="none",b.style.display="";return}b.style.display="none",y.style.display="";var h=v.map(function(g){return'<tr><td class="recon-detail-cell-mono">'+n(g.invoice_no||"")+"</td><td>"+n(g.field||"")+"</td><td>"+n(g.report_value||"")+"</td><td>"+n(g.invoice_value||"")+"</td><td>"+n(g.kind||"")+"</td></tr>"}).join("");_.innerHTML=h;var L=document.getElementById("vex-detail-sub");L&&(L.textContent=String(v.length))}}function u(){var v=document.getElementById("glv-toggle-preview");v&&!v._reconBound&&(v._reconBound=!0,v.addEventListener("click",function(){var _=document.getElementById("glv-preview-panel"),y=document.getElementById("glv-toggle-preview-label"),b=_&&_.style.display!=="none";_&&(_.style.display=b?"none":""),v.classList.toggle("open",!b),y&&(y.textContent=b?window.t&&window.t("vex-toggle-preview-open")||"查看清单":window.t&&window.t("vex-toggle-preview-close")||"收起清单"),b||r()})),["glv-vat-input","glv-gl-input"].forEach(function(_){var y=document.getElementById(_);!y||y._reconWatched||(y._reconWatched=!0,y.addEventListener("change",function(){var b=document.getElementById("glv-preview-panel");b&&b.style.display!=="none"&&r()}))})}function m(){var v=document.getElementById("vex-summary-collapse"),_=document.getElementById("vex-detail-collapse");v&&(v.style.display=""),_&&(_.style.display=""),f(),d()}window._fillVexSummary=f,window._fillVexDetail=d,window._onVexResultShown=m,document.addEventListener("DOMContentLoaded",function(){u()}),setTimeout(u,1500),typeof window.subscribeI18n=="function"&&window.subscribeI18n("recon-collapse",function(){var v=document.getElementById("glv-preview-panel");v&&v.style.display!=="none"&&r();var _=document.getElementById("glv-toggle-preview-label"),y=document.getElementById("glv-toggle-preview");_&&y&&(_.textContent=y.classList.contains("open")?window.t&&window.t("vex-toggle-preview-close")||"收起清单":window.t&&window.t("vex-toggle-preview-open")||"查看清单")}),window._reconCollapse={renderGlvPreview:r,fillVexSummary:f,fillVexDetail:d}})();(function(){function e(i){}function n(){const i=document.querySelectorAll("[data-recon-tab]");i.forEach(c=>{c.addEventListener("click",()=>{i.forEach(u=>u.classList.remove("active")),c.classList.add("active");const l=c.dataset.reconTab,p=document.getElementById("recon-pane-bank"),f=document.getElementById("recon-pane-sale-vat"),d=document.getElementById("recon-pane-gl-vat");p&&(p.style.display=l==="bank"?"":"none"),f&&(f.style.display=l==="sale-vat"?"":"none"),d&&(d.style.display=l==="gl-vat"?"":"none"),l==="gl-vat"&&window.GlVatRecon&&window.GlVatRecon.ensureInit(),l==="bank"&&typeof window._bankReconV2Init=="function"&&window._bankReconV2Init()})});const r=document.querySelector("[data-recon-tab].active");r&&(r.dataset.reconTab,void 0)}function a(){const i=document.getElementById("page-settings");if(!i)return null;let r=document.getElementById("settings-modal-overlay");if(r)return r;r=document.createElement("div"),r.id="settings-modal-overlay",r.className="settings-modal-overlay",r.style.display="none",i.parentElement.insertBefore(r,i),r.appendChild(i);const c=document.createElement("button");return c.id="settings-modal-close",c.className="settings-modal-close",c.setAttribute("aria-label","close"),c.innerHTML='<svg viewBox="0 0 20 20" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M5 5l10 10M15 5L5 15"/></svg>',i.insertBefore(c,i.firstChild),c.addEventListener("click",s),r.addEventListener("click",l=>{l.target===r&&s()}),r}function o(){const i=a();if(!i)return;i.style.display="flex",document.body.classList.add("settings-modal-open");const r=document.getElementById("page-settings");r&&(r.style.display="block"),setTimeout(()=>{try{typeof renderSettings=="function"&&renderSettings()}catch(l){console.warn("renderSettings:",l)}let c=document.querySelector(".settings-tab.active")||document.querySelector('.settings-tab[data-tab="profile"]');c&&c.click()},50)}function s(){const i=document.getElementById("settings-modal-overlay");i&&(i.style.display="none"),document.body.classList.remove("settings-modal-open")}window.openSettingsModal=o,window.closeSettingsModal=s,document.addEventListener("keydown",i=>{if(i.key==="Escape"){const r=document.getElementById("settings-modal-overlay");r&&r.style.display==="flex"&&s()}}),window.addEventListener("hashchange",()=>{location.hash==="#/settings"&&o()}),window.addEventListener("DOMContentLoaded",()=>{location.hash==="#/settings"&&o()}),document.readyState==="loading"?document.addEventListener("DOMContentLoaded",n):n()})();(function(){const a=/\.(pdf|jpe?g|png|webp|tiff?|xlsx?|xlsm|csv|tsv|docx?)$/i,o=D=>document.getElementById(D);function s(){return{Authorization:"Bearer "+(localStorage.getItem("mrpilot_token")||"")}}function i(D){return String(D??"").replace(/[&<>"']/g,z=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[z])}function r(D){return D<1024?D+" B":D<1024*1024?(D/1024).toFixed(1)+" KB":(D/1024/1024).toFixed(1)+" MB"}let c=[],l=[],p=!1,f=[],d=50,u=50,m="",v="";async function _(){try{const D=await fetch("/api/vat_excel/tasks?page=1&page_size=1",{headers:s()});if(!D.ok)return;const X=(await D.json()).kpi||{};[["vex-kpi-month-val",X.this_month],["vex-kpi-running-val",X.running],["vex-kpi-done-val",X.done],["vex-kpi-failed-val",X.failed]].forEach(([Q,Z])=>{const oe=document.getElementById(Q);oe&&(oe.textContent=Z??0)})}catch{}}async function y(){try{const D=await fetch("/api/vat_excel/tasks?page=1&page_size=100",{headers:s()});if(!D.ok)return;const z=await D.json();g(z.rows||[])}catch{}}const b=10;var h=1;function L(){var D=((document.getElementById("vex-task-search")||{}).value||"").trim().toLowerCase();if(h=1,g(f),!!D){var z=document.getElementById("vex-task-tbody");z&&z.querySelectorAll("tr").forEach(function(X){X.dataset.taskId&&(X.style.display=X.textContent.toLowerCase().indexOf(D)>=0?"":"none")})}}function g(D){f=D||f;const z=document.getElementById("vex-task-tbody");if(!z)return;if(!f.length){z.innerHTML='<tr><td colspan="9" class="vex-task-empty">'+(t("sv-empty-title")||"还没有对账任务")+"</td></tr>",x(0);return}const X=Math.ceil(f.length/b);h>X&&(h=X);const Q=(h-1)*b;B(f.slice(Q,Q+b)),x(f.length)}function x(D){const z=document.getElementById("vex-task-pager"),X=document.getElementById("vex-task-pager-info"),Q=document.getElementById("vex-task-prev"),Z=document.getElementById("vex-task-next");if(!z)return;if(D<=b){z.style.display="none";return}z.style.display="";const oe=Math.ceil(D/b);X&&(X.textContent=h+" / "+oe),Q&&(Q.disabled=h<=1),Z&&(Z.disabled=h>=oe)}function B(D){const z=document.getElementById("vex-task-tbody");if(!z)return;const X={pending:t("vex-status-pending")||"待处理",running:t("vex-status-running")||"处理中",done:t("vex-status-done")||"已完成",failed:t("vex-status-failed")||"失败"},Q={pending:"badge-gray",running:"badge-blue",done:"badge-green",failed:"badge-red"},Z='<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M8 2v9M4 7l4 4 4-4M3 14h10"/></svg>',oe='<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M3 4h10M6 4V3h4v1M5 4v8a1 1 0 001 1h4a1 1 0 001-1V4"/></svg>';z.innerHTML=D.map(j=>{const R=j.created_at?new Date(j.created_at).toLocaleString([],{year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",minute:"2-digit"}):"—",q=j.period||"—",K=j.matched_count!=null?j.matched_count+" ✓ · "+j.mismatched_count+" ⚠":"—",V=j.mismatch_amount!=null?"฿ "+Number(j.mismatch_amount).toLocaleString():"—",ae=j.elapsed_seconds!=null?j.elapsed_seconds.toFixed(1)+" s":"—",ce=j.status||"pending",be=j.client_name&&j.client_name!=="client"?j.client_name:t("vex-client-all")||"全部客户";return`<tr class="vex-task-row" data-task-id="${i(j.id)}" style="cursor:pointer">
                <td>${R}</td>
                <td>${i(be)}</td>
                <td>${i(q)}</td>
            ...
            </tr>`}).join(""),z.querySelectorAll(".vex-task-dl-btn").forEach(j=>{j.addEventListener("click",async R=>{R.stopPropagation();const q=j.dataset.taskId;try{const K=await fetch("/api/vat_excel/tasks/"+encodeURIComponent(q)+"/download",{credentials:"include",headers:s()});if(K.status===410){showToast(t("vex-toast-expired")||"数据已过期 · 请重新对账","warn");return}if(!K.ok){showToast(t("vex-toast-dl-fail")||"下载失败 · 请重试","error");return}const V=await K.blob(),ce=(K.headers.get("Content-Disposition")||"").match(/filename\*?=(?:UTF-8''|")?([^";]+)/i),be=ce?decodeURIComponent(ce[1]):"vat_recon_"+q+".xlsx",Se=URL.createObjectURL(V),Oe=document.createElement("a");Oe.href=Se,Oe.download=be,Oe.click(),setTimeout(()=>URL.revokeObjectURL(Se),1e3)}catch{showToast(t("vex-toast-dl-fail")||"下载失败 · 请重试","error")}})}),z.querySelectorAll(".vex-task-del-btn").forEach(j=>{j.addEventListener("click",R=>{R.stopPropagation(),w(j.dataset.taskId)})}),L()}function E(){var D=document.getElementById("vex-task-prev"),z=document.getElementById("vex-task-next");D&&!D._vexBound&&(D._vexBound=!0,D.addEventListener("click",function(){h>1&&(h--,g())})),z&&!z._vexBound&&(z._vexBound=!0,z.addEventListener("click",function(){var X=Math.ceil(f.length/b);h<X&&(h++,g())}))}async function w(D){const z=t("vex-task-delete-confirm-title")||"删除对账任务?",X=t("vex-task-delete-confirm-body")||"同时清掉对应的发票识别缓存 · 不可恢复";if(await showConfirm(X,{title:z,danger:!0,okText:t("vex-task-delete-confirm-title")||"确认删除"}))try{const Z=await fetch("/api/vat_excel/tasks/"+encodeURIComponent(D),{method:"DELETE",credentials:"include",headers:s()});if(!Z.ok)throw new Error(Z.status);showToast(t("vex-task-delete-ok")||"已删除","success"),y(),_()}catch{showToast(t("vex-task-delete-fail")||"删除失败","error")}}function I(D){const z=window._currentLang||"th",X={zh:`已忽略 ${D} 个不支持的文件 · 仅支持 PDF / 图片 / Excel / CSV / Word`,th:`ข้ามไฟล์ที่ไม่รองรับ ${D} ไฟล์ · รองรับเฉพาะ PDF / รูปภาพ / Excel / CSV / Word`,en:`Ignored ${D} unsupported file(s) · only PDF / image / Excel / CSV / Word are supported`,ja:`非対応ファイル ${D} 件をスキップ · 対応形式は PDF / 画像 / Excel / CSV / Word のみ`};showToast(X[z]||X.th,"warn")}function S(D){const z=new Set(c.map(Q=>Q.name+"|"+Q.size));let X=0;for(const Q of D){if(!a.test(Q.name)){X++;continue}const Z=Q.name+"|"+Q.size;if(!z.has(Z)&&(z.add(Z),c.push(Q),c.length>=1e3))break}X>0&&I(X),c.length>1e3&&(c=c.slice(0,1e3),showToast(t("vex-toast-cap-inv"),"warn")),M()}function T(D){const z=new Set(l.map(Q=>Q.name+"|"+Q.size));let X=0;for(const Q of D){if(!a.test(Q.name)){X++;continue}const Z=Q.name+"|"+Q.size;if(!z.has(Z)&&(z.add(Z),l.push(Q),l.length>=30))break}X>0&&I(X),l.length>30&&(l=l.slice(0,30),showToast(t("vex-toast-cap-rep"),"warn")),M()}function C(D){c.splice(D,1),M()}function k(D){l.splice(D,1),M()}function M(){const D=o("vex-list-invoice"),z=o("vex-list-report"),X=o("vex-count-invoice"),Q=o("vex-count-report");X&&(X.textContent=c.length),Q&&(Q.textContent=l.length);const Z=(R,q,K)=>`<div class="vex-fi">
            ...
            <div class="vex-pp-pagination" id="vex-pp-${D}-pg"></div>`;const R=o("vex-pp-search-"+D);R&&R.addEventListener("input",K=>{D==="inv"?(m=K.target.value,d=50):(v=K.target.value,u=50),G(D)});const q=o("vex-pp-clearall-"+D);q&&q.addEventListener("click",()=>{D==="inv"?(c=[],m="",d=50):(l=[],v="",u=50),M()}),G(D)}function G(D){const z=o("vex-pp-"+D+"-list"),X=o("vex-pp-"+D+"-pg");if(!z)return;const Q=D==="inv"?c:l,Z=D==="inv"?m:v,oe=D==="inv"?d:u,j=D==="inv"?$:A,R=Q.map((V,ae)=>({f:V,i:ae})),q=Z?R.filter(({f:V})=>V.name.toLowerCase().includes(Z.toLowerCase())):R,K=q.slice(0,oe);if(z.innerHTML=K.map(({f:V,i:ae})=>`
    ...
    `,document.body.appendChild(n),n.addEventListener("click",async a=>{if(a.target===n||a.target.classList.contains("log-detail-close")){n.remove();return}const o=a.target.closest("[data-receipt-copy]");if(o){eo(o.dataset.receiptCopy);return}const s=a.target.closest("[data-receipt-action]");if(s){const i=s.dataset.receiptAction;i==="retry"?window.retryPushLog(s.dataset.logId):i==="exceptions"?typeof routeTo=="function"&&routeTo("exceptions"):i==="mappings"&&typeof routeTo=="function"&&routeTo("integrations"),n.remove();return}});try{const a=await fetch(`/api/erp/logs/${encodeURIComponent(e)}`,{headers:{Authorization:"Bearer "+token}});if(!a.ok){n.remove();return}const o=await a.json(),s=window._erpEndpoints.find(C=>C.id===o.endpoint_id),i=o.endpoint_name||(s?s.name:o.endpoint_id?t("erp-log-endpoint-deleted"):"-"),r=(o.endpoint_adapter||s&&s.adapter||"").toLowerCase(),c=new Date(o.created_at).toLocaleString(),l=o.trigger==="auto"?t("log-tag-auto"):o.trigger==="retry"?t("log-tag-retry"):t("log-tag-manual"),p=o.request_body?JSON.stringify(o.request_body,null,2):t("erp-receipt-no-tech"),f=o.response_body||t("erp-receipt-no-tech"),d=o.status==="success";let u=typeof f=="string"?f:JSON.stringify(f,null,2);if(d)try{const C=typeof o.response_body=="string"?JSON.parse(o.response_body):o.response_body||{},k=C.row_count||(Array.isArray(C.imported_rows)?C.imported_rows.length:0);k>0&&(u=t("log-push-rows").replace("{n}",String(k)))}catch{}const m=(o.external_doc_no||"").trim(),v=(o.external_url||"").trim(),_=(o.external_doc_hint||"").trim(),y=(o.ocr_buyer_name||"").trim()||o.client_name||"-",b=o.seller_name||"-",h=o.push_type==="id_card";let L="-";const g=Number(o.total_amount);o.total_amount!=null&&o.total_amount!==""&&!isNaN(g)&&(L=g.toLocaleString("en-US",{minimumFractionDigits:2,maximumFractionDigits:2}));const x=d?t("erp-receipt-title-ok"):t("erp-receipt-title-fail"),B=d?"✓":"✗",E=[],w=(C,k)=>{E.push(`
                <div class="erp-receipt-row">
                    <span class="erp-receipt-key">${escapeHtml(C)}</span>
                    <span class="erp-receipt-val">${k}</span>
                </div>`)};if(w(h?t("erp-log-col-booking"):t("erp-receipt-invoice-no"),`<strong>${escapeHtml(o.invoice_no||"-")}</strong>`),w(t("erp-receipt-erp-name"),escapeHtml(i)),d){let C;m?C=`<strong class="erp-receipt-docno">${escapeHtml(m)}</strong><button class="erp-receipt-copy-btn" type="button" data-receipt-copy="${escapeHtml(m)}" title="${escapeHtml(t("erp-doc-copy-tip"))}">${escapeHtml(t("erp-receipt-copy-btn"))}</button>`:C=`<span class="erp-receipt-docno-missing">${escapeHtml(t("erp-log-doc-missing"))}</span>`,w(t("erp-receipt-doc-no"),C)}h||w(t("erp-receipt-client"),escapeHtml(y)),w(h?t("erp-log-col-customer"):t("erp-receipt-seller"),escapeHtml(b)),d&&w(t("erp-receipt-amount"),escapeHtml(L)),w(t("erp-receipt-time"),escapeHtml(c)),w(t("erp-receipt-elapsed"),escapeHtml((o.elapsed_ms!=null?o.elapsed_ms:"-")+"ms"));let I="";d&&v?I=`<a class="erp-receipt-primary-btn" href="${escapeHtml(v)}" target="_blank" rel="noopener">${escapeHtml(t("erp-receipt-open-erp"))}</a>`:d&&m&&(I=`<button class="erp-receipt-primary-btn" type="button" data-receipt-copy="${escapeHtml(m)}">${escapeHtml(t("erp-receipt-copy-docno"))}</button>`);let S="";if(d&&m&&_){const C="erp-receipt-hint-"+_,k=t(C);k&&k!==C&&(S=`<div class="erp-receipt-hint"><svg class="erp-receipt-hint-ic" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><circle cx="12" cy="12" r="9"/><line x1="12" y1="11" x2="12" y2="16"/><line x1="12" y1="8" x2="12.01" y2="8"/></svg><span>${escapeHtml(k)}</span></div>`)}let T="";if(!d){const C=(o.error_msg||"").match(/ERR_[A-Z0-9_]+/),k=C?C[0]:"",M=typeof currentLang=="string"&&currentLang||window._currentLang||"th",A=o.error_friendly&&o.error_friendly[M]||(o.error_msg?humanizeError(o.error_msg):t("erp-receipt-no-error")),H=/ERR_NO_CUSTOMER_MAPPING|ERR_NO_CLIENT|ERR_NO_SEED_CUSTOMER|ERR_NO_SEED_PRODUCT/.test(o.error_msg||""),P=!!(o.history_id&&o.endpoint_id),F=[];F.push(`<button class="erp-receipt-action-btn" type="button" data-receipt-action="exceptions">${escapeHtml(t("erp-receipt-act-exceptions"))}</button>`),H&&F.push(`<button class="erp-receipt-action-btn" type="button" data-receipt-action="mappings">${escapeHtml(t("erp-receipt-act-mapping"))}</button>`),P&&F.push(`<button class="erp-receipt-action-btn primary" type="button" data-receipt-action="retry" data-log-id="${escapeHtml(o.id)}">${escapeHtml(t("erp-receipt-act-retry"))}</button>`),T=`
