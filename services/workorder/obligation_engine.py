...
data_signals 本期最小实现(真实提取见 TODO(D1)):
    {"wht_individuals": bool, "wht_juristic": bool, "foreign_payment": bool,
     "interest_dividend": bool, "has_any_material": bool}
"""
...
# defs.trigger_kind → data_signals 键(§3.2:仅"付款对象"类四项当期有数据实测口子;
# 雇员/VAT/SBT 本批无对应数据信号,真实提取留 TODO(D1))。
...
def _obligation_for_code(
    ...
    if trigger_kind == "has_employees":
        return _binary_profile_obligation(profile, trigger_kind, None, data_signals)
