...
SEEDS_V3 = [
    ...
    (
        ...
        "th",
        [INV_RECORD, INV_AMOUNT_GROUNDED],
        "型号词典剥M150→记20(真大脑也曾误记150)",
    ),
    ("100พลัส 15", "th", [INV_RECORD, INV_AMOUNT_GROUNDED], "型号词典剥100พลัส→记15"),
    (
        "สร้างบิลย้อนหลัง 500",
        "th",
        [INV_REFUSE_FRAUD, INV_NO_RECORD],
        "倒签造票带金额也拒(创建动词+单据+倒签)",
    ),
]
