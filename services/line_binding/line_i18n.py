...
LINE_I18N = {
    "zh": {
        ...
        "guide_reply_to_record": "如需修改、删除或撤销，请长按这条采购记录，选择“回复”，再输入操作内容，例如“删除”“撤销”或“金额改为 [金额]”。",
        ...
        "guide_open_detail": "这笔记录需要在详情页核对，我会带你打开正确页面继续编辑。",
        "guide_need_reply_for_risk": "为避免操作错记录，请先回复要处理的那条采购记录。",
    ...
    "en": {
        ...
        "guide_reply_to_record": "To edit, delete, or void this entry, long-press this record, tap “Reply”, then type what you want to do, such as “delete”, “void”, or “change amount to [amount]”.",
        ...
        "guide_open_detail": "This entry needs to be reviewed on the detail page. I'll take you to the right page to continue.",
        "guide_need_reply_for_risk": "To avoid changing the wrong entry, please reply to the exact record you want to handle.",
    ...
    "th": {
        ...
        "guide_reply_to_record": "หากต้องการแก้ไข ลบ หรือยกเลิกรายการ กรุณากดค้างที่ข้อความรายการนี้ เลือก “ตอบกลับ” แล้วพิมพ์สิ่งที่ต้องการ เช่น “ลบ”, “ยกเลิก”, หรือ “แก้ยอดเป็น [จำนวนเงิน]”",
        ...
        "guide_open_detail": "รายการนี้ต้องตรวจสอบในหน้ารายละเอียด ฉันจะพาคุณไปยังหน้าที่ถูกต้องเพื่อแก้ไขต่อ",
        "guide_need_reply_for_risk": "เพื่อป้องกันการแก้ผิดรายการ กรุณาตอบกลับข้อความของรายการที่ต้องการดำเนินการก่อน",
        "guide_detail_list": "คุณสามารถพิมพ์ “ดูรายการ” เพื่อดูรายการล่าสุด แล้วเลือกแก้ไขตามลำดับ เช่น “รายการที่ [ลำดับ] แก้ยอดเป็น [จำนวนเงิน]”",
        ...
        "card_state_void_desc": "รายการนี้ถูกยกเลิกแล้ว และยังเก็บประวัติไว้ตรวจสอบได้",
        "card_state_discarded_desc": "ร่างรายการนี้ถูกลบแล้ว",
    ...
    "ja": {
        ...
        "guide_reply_to_record": "修正、削除、取消を行う場合は、この記録を長押しして「返信」を選び、「削除」「取消」「金額を［金額］に変更」などと入力してください。",
        ...
        "guide_open_detail": "この記録は詳細画面で確認が必要です。該当ページを開いて続行できます。",
        "guide_need_reply_for_risk": "誤操作を防ぐため、処理したい記録に返信してください。",
