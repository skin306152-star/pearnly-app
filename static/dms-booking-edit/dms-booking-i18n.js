(function () {
    ...
    var TEXT = {
        th: {
            ...
            destination: 'ธนาคารที่รับเงิน',
            destinationName: 'ชื่อบัญชีบริษัทที่รับเงิน',
            destinationAccount: 'เลขบัญชีที่รับเงิน',
            destinationBranch: 'สาขาธนาคารที่รับเงิน',
            chequeNo: 'เลขที่เช็ค',
            chequeBookNo: 'เล่มที่เช็ค',
            cashierNo: 'เลขที่แคชเชียร์เช็ค',
            cashierBookNo: 'เล่มที่แคชเชียร์เช็ค',
            bankName: 'ธนาคาร',
            cardType: 'ประเภทบัตร',
            detail: 'รายละเอียด',
            remove: 'ลบ',
        ...
        en: {
            ...
            destination: 'Receiving bank',
            destinationName: 'Receiving company account name',
            destinationAccount: 'Receiving account number',
            destinationBranch: 'Receiving bank branch',
            chequeNo: 'Cheque number',
            chequeBookNo: 'Cheque book number',
        ...
        zh: {
            ...
            sourceBank: '付款银行',
            sourceAccount: '付款账号',
            sourceAccountName: '付款账户名',
            sourceBranch: '付款分行',
            chooseOption: '请选择',
            chooseBank: '请选择银行',
            destination: '收款银行',
            destinationName: '公司收款户名',
            destinationAccount: '实际收款账号',
            destinationBranch: '收款银行分行',
            chequeNo: '支票号码',
            chequeBookNo: '支票簿号',
            cashierNo: '银行本票号码',
            cashierBookNo: '银行本票簿号',
            bankName: '银行',
            cardType: '卡类型',
            detail: '详情',
            remove: '删除',
        ...
        ja: {
            ...
            sourceAccountName: '振込元口座名義',
            sourceBranch: '振込元支店',
            chooseOption: '選択してください',
            chooseBank: '銀行を選択',
            destination: '受取銀行',
            destinationName: '会社の受取口座名義',
            destinationAccount: '受取口座番号',
            destinationBranch: '受取銀行支店',
            chequeNo: '小切手番号',
            chequeBookNo: '小切手帳番号',
            cashierNo: '銀行小切手番号',
            cashierBookNo: '銀行小切手帳番号',
            bankName: '銀行',
            cardType: 'カード種別',
            detail: '詳細',
            remove: '削除',
