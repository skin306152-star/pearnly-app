...
class ErpTargetReadinessTests(unittest.TestCase):
    def test_master_refresh_requires_companion_protocol_1_1_75(self):
        self.assertFalse(erp_target_projection.supports_master_refresh(None))
        self.assertFalse(erp_target_projection.supports_master_refresh("1.1.74"))
        self.assertTrue(erp_target_projection.supports_master_refresh("1.1.75"))
