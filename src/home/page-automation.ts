...
import { AUTO_HTML_2 } from './page-automation-panes-2.js'; // REFACTOR-WB-C1 · 自动化页壳 HTML 下半(邮箱+文件夹 panel)
...
// (含 .auto-content + 各 .auto-panel:folder/email/erp/bank · 这些 panel 被 integration drawer
// openIntegrationDrawer 运行期 DOM-move 进集成抽屉 · 关闭时 _returnPanel 移回 .auto-content)。
// **import 置 main.js 最前(早于 folder-watcher/email-ingest/bank-recon/integration-config/
